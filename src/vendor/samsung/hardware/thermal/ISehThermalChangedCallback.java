...
public interface ISehThermalChangedCallback extends IInterface {
    ...
    public static class Default implements ISehThermalChangedCallback {
        ...
        @Override // vendor.samsung.hardware.thermal.ISehThermalChangedCallback
        public void notifyTemperatures(SehTemperature[] sehTemperatureArr) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements ISehThermalChangedCallback {
        ...
        public static ISehThermalChangedCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ISehThermalChangedCallback)) {
                return (ISehThermalChangedCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                SehTemperature[] sehTemperatureArr = (SehTemperature[]) parcel.createTypedArray(SehTemperature.CREATOR);
                parcel.enforceNoDataAvail();
                notifyTemperatures(sehTemperatureArr);
                return true;
            }
        ...
        private static class Proxy implements ISehThermalChangedCallback {
            ...
            public void notifyTemperatures(SehTemperature[] sehTemperatureArr) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeTypedArray(sehTemperatureArr, 0);
