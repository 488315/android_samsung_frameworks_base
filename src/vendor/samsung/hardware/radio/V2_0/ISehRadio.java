...
public interface ISehRadio extends IBase {
    ...
    public static final class Proxy implements ISehRadio {
        ...
        public void setResponseFunctions(ISehRadioResponse iSehRadioResponse, ISehRadioIndication iSehRadioIndication) throws RemoteException {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    setResponseFunctions(ISehRadioResponse.asInterface(hwParcel.readStrongBinder()), ISehRadioIndication.asInterface(hwParcel.readStrongBinder()));
