...
public abstract class CallDiagnostics {
    ...
    public final void sendDeviceToDeviceMessage(int i, int i2) {
        ...
        if (listener != null) {
            listener.onSendDeviceToDeviceMessage(this, i, i2);
        }
    }

    public final void displayDiagnosticMessage(int i, CharSequence charSequence) {
        Listener listener = this.mListener;
        if (listener != null) {
            listener.onDisplayDiagnosticMessage(this, i, charSequence);
        }
    }
    ...
    public final void clearDiagnosticMessage(int i) {
        Listener listener = this.mListener;
        if (listener != null) {
            listener.onClearDiagnosticMessage(this, i);
        }
    }

    public void handleCallUpdated(Call.Details details) {
