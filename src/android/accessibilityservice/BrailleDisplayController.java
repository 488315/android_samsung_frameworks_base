...
public interface BrailleDisplayController {
    ...
    static void setTestBrailleDisplayData(AccessibilityService accessibilityService, List<Bundle> list) {
        checkApiFlagIsEnabled();
        IAccessibilityServiceConnection connection = AccessibilityInteractionClient.getConnection(accessibilityService.getConnectionId());
        if (connection != null) {
            try {
