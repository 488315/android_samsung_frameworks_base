...
public class AppHibernationManager {
    ...
    @SystemApi
    public Map<String, HibernationStats> getHibernationStatsForUser(Set<String> set) {
        try {
            return this.mIAppHibernationService.getHibernationStatsForUser(new ArrayList(set), this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
