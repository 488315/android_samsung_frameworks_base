...
public final class InputProtoEnums {
    ...
    public static final int CONSUME_TO_FINISH = 4;
    public static final int CONSUME_TO_GPU_COMPLETE = 5;
    public static final int DEFAULT = 3;
    public static final int DELIVER_TO_CONSUME = 3;
    public static final int DESKTOP_MODE = 48;
    public static final int DEVICE = 1;
    public static final int DPAD = 3;
    public static final int END_TO_END = 7;
    public static final int EVENT_TO_READ = 1;
    public static final int GAMEPAD = 4;
    public static final int GPU_COMPLETE_TO_PRESENT = 6;
    ...
    public static final int MAXIMIZE_FREEFORM_WINDOW = 54;
    public static final int MEDIA_KEY = 34;
    public static final int MINIMIZE_FREEFORM_WINDOW = 57;
    public static final int MOTION_ACTION_DOWN = 1;
    public static final int MOTION_ACTION_HOVER_MOVE = 4;
    public static final int MOTION_ACTION_MOVE = 2;
    public static final int MOTION_ACTION_SCROLL = 5;
    public static final int MOTION_ACTION_UP = 3;
    public static final int MOUSE = 6;
    public static final int MOUSE_CAPTURED = 7;
    public static final int MOVE_TO_NEXT_DISPLAY = 51;
    ...
    public static final int READ_TO_DELIVER = 2;
    public static final int RECENT_APPS = 2;
    public static final int RESTORE_FREEFORM_WINDOW_SIZE = 55;
    public static final int ROTARY_ENCODER = 10;
    public static final int SLEEP = 32;
    public static final int SNAP_LEFT_FREEFORM_WINDOW = 52;
    public static final int SNAP_RIGHT_FREEFORM_WINDOW = 53;
    ...
    public static final int TOGGLE_MAXIMIZE_FREEFORM_WINDOW = 56;
    ...
    public static final int UNKNOWN_INPUT_EVENT = 0;
    public static final int UNKNOWN_LATENCY_STAGE = 0;
