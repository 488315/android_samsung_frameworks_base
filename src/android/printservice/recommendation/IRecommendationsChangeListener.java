...
public interface IRecommendationsChangeListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRecommendationsChangeListener {
        ...
        public static IRecommendationsChangeListener asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IRecommendationsChangeListener)) {
                return (IRecommendationsChangeListener) iInterfaceQueryLocalInterface;
            }
