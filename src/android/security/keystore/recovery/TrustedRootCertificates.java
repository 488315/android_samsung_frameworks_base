...
public final class TrustedRootCertificates {
    ...
    public static X509Certificate getRootCertificate(String str) {
        return ALL_ROOT_CERTIFICATES.get(str);
    }

    private static ArrayMap<String, X509Certificate> constructRootCertificateMap() {
        ArrayMap<String, X509Certificate> arrayMap = new ArrayMap<>(1);
        arrayMap.put(GOOGLE_CLOUD_KEY_VAULT_SERVICE_V1_ALIAS, GOOGLE_CLOUD_KEY_VAULT_SERVICE_V1_CERTIFICATE);
        return arrayMap;
    }

    private static X509Certificate parseBase64Certificate(String str) {
        try {
            return X509CertificateParsingUtils.decodeBase64Cert(str);
