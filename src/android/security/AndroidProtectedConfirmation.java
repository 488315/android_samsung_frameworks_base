...
public class AndroidProtectedConfirmation {
    ...
    public int presentConfirmationPrompt(IConfirmationCallback iConfirmationCallback, String str, byte[] bArr, String str2, int i) {
        try {
    ...
    public int cancelConfirmationPrompt(IConfirmationCallback iConfirmationCallback) {
        try {
