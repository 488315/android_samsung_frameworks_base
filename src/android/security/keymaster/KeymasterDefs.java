...
public final class KeymasterDefs {
    ...
    static {
        ...
        sErrorCodeToString = map;
        map.put(0, SecureKeyConst.AT_RESPONSE_OK);
        map.put(-2, "Unsupported purpose");
        map.put(-3, "Incompatible purpose");
        map.put(-4, "Unsupported algorithm");
        map.put(-5, "Incompatible algorithm");
        map.put(-6, "Unsupported key size");
        map.put(-7, "Unsupported block mode");
        map.put(-8, "Incompatible block mode");
        map.put(-9, "Unsupported MAC or authentication tag length");
        map.put(-10, "Unsupported padding mode");
        map.put(-11, "Incompatible padding mode");
        map.put(-12, "Unsupported digest");
        map.put(-13, "Incompatible digest");
        map.put(-14, "Invalid expiration time");
        map.put(-15, "Invalid user ID");
        map.put(-16, "Invalid user authorization timeout");
        map.put(-17, "Unsupported key format");
        map.put(-18, "Incompatible key format");
        map.put(-21, "Invalid input length");
        map.put(-24, "Key not yet valid");
        map.put(-25, "Key expired");
        map.put(-26, "Key user not authenticated");
        map.put(-28, "Invalid operation handle");
        map.put(-30, "Signature/MAC verification failed");
        map.put(-31, "Too many operations");
        map.put(-33, "Invalid key blob");
        map.put(-38, "Invalid argument");
        map.put(-39, "Unsupported tag");
        map.put(-40, "Invalid tag");
        map.put(-41, "Memory allocation failed");
        map.put(-50, "Unsupported EC field");
        map.put(-51, "Required IV missing");
        map.put(-52, "Invalid IV");
        map.put(-55, "Caller-provided IV not permitted");
        map.put(-57, "Invalid MAC or authentication tag length");
        map.put(-66, "Unable to attest device ids");
        map.put(-68, "Requested security level (likely Strongbox) is not available.");
        map.put(-72, "Device locked");
        map.put(-100, "Not implemented");
        map.put(-1000, "Unknown error");
        map.put(Integer.valueOf(KM_ERROR_SAK_NOT_EXIST), "Not exist SAK");
        map.put(Integer.valueOf(KM_ERROR_GAK_NOT_EXIST), "Not exist GAK");
    }
