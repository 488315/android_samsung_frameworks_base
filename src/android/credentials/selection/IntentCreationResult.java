...
public final class IntentCreationResult {
    ...
    private IntentCreationResult(Intent intent, String str, String str2, OemUiUsageStatus oemUiUsageStatus) {
        this.mIntent = intent;
    ...
    public static final class Builder {
        ...
        public Builder setFallbackUiPackageName(String str) {
            this.mFallbackUiPackageName = str;
            return this;
        }

        public Builder setOemUiPackageName(String str) {
