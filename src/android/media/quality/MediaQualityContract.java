...
public class MediaQualityContract {
    ...
    public interface BaseParameters {
        ...
        public static final String PARAMETER_INPUT_ID = "_input_id";
        public static final String PARAMETER_NAME = "_name";
        public static final String PARAMETER_PACKAGE = "_package";
        public static final String PARAMETER_TYPE = "_type";
    }
    ...
    public static final class PictureQuality {
        public static final String PARAMETER_AUTO_PICTURE_QUALITY_ENABLED = "auto_picture_quality_enabled";
        public static final String PARAMETER_AUTO_SUPER_RESOLUTION_ENABLED = "auto_super_resolution_enabled";
        ...
        public static final String PARAMETER_COLOR_TEMPERATURE_BLUE_GAIN = "color_temperature_blue_gain";
        public static final String PARAMETER_COLOR_TEMPERATURE_BLUE_OFFSET = "color_temperature_blue_offset";
        public static final String PARAMETER_COLOR_TEMPERATURE_GREEN_GAIN = "color_temperature_green_gain";
        public static final String PARAMETER_COLOR_TEMPERATURE_GREEN_OFFSET = "color_temperature_green_offset";
        public static final String PARAMETER_COLOR_TEMPERATURE_RED_GAIN = "color_temperature_red_gain";
        public static final String PARAMETER_COLOR_TEMPERATURE_RED_OFFSET = "color_temperature_red_offset";
        ...
        public static final String PARAMETER_COLOR_TUNER_LUMINANCE_BLUE = "color_tuner_luminance_blue";
        public static final String PARAMETER_COLOR_TUNER_LUMINANCE_CYAN = "color_tuner_luminance_cyan";
        public static final String PARAMETER_COLOR_TUNER_LUMINANCE_FLESH = "color_tuner_luminance_flesh";
        public static final String PARAMETER_COLOR_TUNER_LUMINANCE_GREEN = "color_tuner_luminance_green";
        public static final String PARAMETER_COLOR_TUNER_LUMINANCE_MAGENTA = "color_tuner_luminance_magenta";
        public static final String PARAMETER_COLOR_TUNER_LUMINANCE_RED = "color_tuner_luminance_red";
        public static final String PARAMETER_COLOR_TUNER_LUMINANCE_YELLOW = "color_tuner_luminance_yellow";
        ...
        public static final String PARAMETER_COLOR_TUNER_SATURATION_BLUE = "color_tuner_saturation_blue";
        public static final String PARAMETER_COLOR_TUNER_SATURATION_CYAN = "color_tuner_saturation_cyan";
        public static final String PARAMETER_COLOR_TUNER_SATURATION_FLESH = "color_tuner_saturation_flesh";
        public static final String PARAMETER_COLOR_TUNER_SATURATION_GREEN = "color_tuner_saturation_green";
        public static final String PARAMETER_COLOR_TUNER_SATURATION_MAGENTA = "color_tuner_saturation_magenta";
        public static final String PARAMETER_COLOR_TUNER_SATURATION_RED = "color_tuner_saturation_red";
        public static final String PARAMETER_COLOR_TUNER_SATURATION_YELLOW = "color_tuner_saturation_yellow";
        ...
        public static final String PARAMETER_PANEL_INIT_MAX_LUMINCE_NITS = "panel_init_max_lumince_nits";
        public static final String PARAMETER_PANEL_INIT_MAX_LUMINCE_VALID = "panel_init_max_lumince_valid";
        public static final String PARAMETER_PC_MODE = "pc_mode";
        public static final String PARAMETER_PICTURE_QUALITY_EVENT_TYPE = "picture_quality_event_type";
    ...
    public static final class SoundQuality {
        ...
        public static final String PARAMETER_DIGITAL_OUTPUT_DELAY_MILLIS = "digital_output_delay_millis";
        ...
        public static final String PARAMETER_DOLBY_AUDIO_PROCESSING_DOLBY_ATMOS = "dolby_audio_processing_dolby_atmos";
        public static final String PARAMETER_DOLBY_AUDIO_PROCESSING_SOUND_MODE = "dolby_audio_processing_sound_mode";
        public static final String PARAMETER_DOLBY_AUDIO_PROCESSING_SURROUND_VIRTUALIZER = "dolby_audio_processing_surround_virtualizer";
        public static final String PARAMETER_DOLBY_AUDIO_PROCESSING_VOLUME_LEVELER = "dolby_audio_processing_volume_leveler";
        ...
        public static final String PARAMETER_DTS_VIRTUAL_X_DIALOG_CLARITY = "dts_virtual_x_dialog_clarity";
        ...
        public static final String PARAMETER_DTS_VIRTUAL_X_TRU_SURROUND_X = "dts_virtual_x_tru_surround_x";
        public static final String PARAMETER_DTS_VIRTUAL_X_TRU_VOLUME_HD = "dts_virtual_x_tru_volume_hd";
