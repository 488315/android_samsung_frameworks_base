...
public interface IChannelTunedListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IChannelTunedListener {
        ...
        public static IChannelTunedListener asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("android.media.tv.extension.tune.IChannelTunedListener");
            if (queryLocalInterface != null && (queryLocalInterface instanceof IChannelTunedListener)) {
                return (IChannelTunedListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                onChannelTuned(readString, bundle);
                return true;
            }
        ...
        private static class Proxy implements IChannelTunedListener {
            ...
            public void onChannelTuned(String str, Bundle bundle) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("android.media.tv.extension.tune.IChannelTunedListener");
