...
public interface ICamHostControlTuneQuietlyFlagListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICamHostControlTuneQuietlyFlagListener {
        ...
        public static ICamHostControlTuneQuietlyFlagListener asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("android.media.tv.extension.cam.ICamHostControlTuneQuietlyFlagListener");
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ICamHostControlTuneQuietlyFlagListener)) {
                return (ICamHostControlTuneQuietlyFlagListener) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                onHcTuneQuietlyFlagChanged(string, i3);
                return true;
            }
        ...
        private static class Proxy implements ICamHostControlTuneQuietlyFlagListener {
            ...
            public void onHcTuneQuietlyFlagChanged(String str, int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("android.media.tv.extension.cam.ICamHostControlTuneQuietlyFlagListener");
