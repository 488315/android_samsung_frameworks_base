...
public class IsdbtFrontendSettings extends FrontendSettings {
    ...
    private IsdbtFrontendSettings(long j, int i, int i2, int i3, int i4, IsdbtLayerSettings[] isdbtLayerSettingsArr, int i5) {
        super(j);
        this.mBandwidth = i;
        this.mMode = i2;
    ...
    public static class Builder {
        ...
        public Builder setModulation(int i) {
            ...
            if (isdbtLayerSettingsArr.length == 0) {
                ...
                builder.setCodeRate(isdbtLayerSettingsArr[0].getCodeRate());
            }
        ...
        public Builder setCodeRate(int i) {
            ...
            if (isdbtLayerSettingsArr.length == 0) {
                ...
                builder.setModulation(isdbtLayerSettingsArr[0].getModulation());
            }
            this.mLayerSettings[0] = builder.build();
            return this;
        }
