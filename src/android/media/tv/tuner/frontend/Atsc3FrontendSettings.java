...
public class Atsc3FrontendSettings extends FrontendSettings {
    ...
    private Atsc3FrontendSettings(long j, int i, int i2, Atsc3PlpSettings[] atsc3PlpSettingsArr) {
        super(j);
        this.mBandwidth = i;
    ...
    public static class Builder {
        ...
        public Builder setPlpSettings(Atsc3PlpSettings[] atsc3PlpSettingsArr) {
            this.mPlpSettings = atsc3PlpSettingsArr;
            return this;
        }
