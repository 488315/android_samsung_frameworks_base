...
public interface ITvInteractiveAppServiceCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITvInteractiveAppServiceCallback {
        ...
        public static ITvInteractiveAppServiceCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(ITvInteractiveAppServiceCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ITvInteractiveAppServiceCallback)) {
                return (ITvInteractiveAppServiceCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(ITvInteractiveAppServiceCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(ITvInteractiveAppServiceCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
        ...
        private static class Proxy implements ITvInteractiveAppServiceCallback {
            ...
            public void onStateChanged(int i, int i2, int i3) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(ITvInteractiveAppServiceCallback.DESCRIPTOR);
