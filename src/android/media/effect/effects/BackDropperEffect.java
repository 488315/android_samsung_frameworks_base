...
public class BackDropperEffect extends FilterGraphEffect {
    ...
    public BackDropperEffect(EffectContext effectContext, String str) {
        super(effectContext, str, mGraphDefinition, "foreground", "output", OneShotScheduler.class);
    ...
    public void setParameter(String str, Object obj) {
        if (str.equals(Slice.SUBTYPE_SOURCE)) {
            this.mGraph.getFilter("background").setInputValue("sourceUrl", obj);
        } else if (str.equals(SemSmartClipMetaTagType.CONTEXT)) {
            this.mGraph.getFilter("background").setInputValue(SemSmartClipMetaTagType.CONTEXT, obj);
        }
    }
