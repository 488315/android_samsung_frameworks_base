...
public final class AudioDeviceInfo {
    ...
    static boolean isValidAudioDeviceTypeOut(int i) {
        switch (i) {
            ...
            case 28:
            default:
                if (!Flags.enableMultichannelGroupDevice() || i != 32) {
                    return false;
                }
                break;
            case 1:
    ...
    public static void enforceValidAudioDeviceTypeOut(int i) {
        ...
        throw new IllegalArgumentException("Illegal output device type " + i);
    }
    ...
    public static void enforceValidAudioDeviceTypeIn(int i) {
        ...
        throw new IllegalArgumentException("Illegal input device type " + i);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(getPort(), ((AudioDeviceInfo) obj).getPort());
    }
    ...
    public AudioDeviceInfo(AudioDevicePort audioDevicePort) {
    ...
    public static int convertDeviceTypeToInternalInputDevice(int i, String str) {
        int i2 = EXT_TO_INT_INPUT_DEVICE_MAPPING.get(i, 0);
        if (i2 == -2147483644 && NavigationBarInflaterView.BACK.equals(str)) {
            return -2147483520;
        }
        return i2;
    }
    ...
    static {
        ...
        if (Flags.enableMultichannelGroupDevice()) {
            sparseIntArray2.put(32, 8388609);
        }
