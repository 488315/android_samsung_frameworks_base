...
public interface IRemoteDisplayCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRemoteDisplayCallback {
        ...
        public static IRemoteDisplayCallback asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IRemoteDisplayCallback)) {
                return (IRemoteDisplayCallback) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                RemoteDisplayState remoteDisplayState = (RemoteDisplayState) parcel.readTypedObject(RemoteDisplayState.CREATOR);
