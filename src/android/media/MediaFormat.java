...
public final class MediaFormat {
    ...
    public static final class QpOffsetRect {
        ...
        public QpOffsetRect(Rect rect, int i) {
            this.mContour = rect;
            this.mQpOffset = i;
        }

        public void set(Rect rect, int i) {
            this.mContour = rect;
            this.mQpOffset = i;
        }
        ...
        public static String flattenToString(List<QpOffsetRect> list) {
            StringBuilder sb = new StringBuilder();
            Iterator<QpOffsetRect> it = list.iterator();
            while (it.hasNext()) {
    ...
    public final int getValueTypeForKey(String str) {
    ...
    public final ByteBuffer getByteBuffer(String str, ByteBuffer byteBuffer) {
        ByteBuffer byteBuffer2 = getByteBuffer(str);
    ...
    abstract class FilteredMappedKeySet extends AbstractSet<String> {
        ...
        class KeyIterator implements Iterator<String> {
            ...
            public /* synthetic */ boolean lambda$new$0(String str) {
                return FilteredMappedKeySet.this.keepKey(str);
            }
    ...
    private class UnprefixedKeySet extends FilteredMappedKeySet {
        ...
        protected String mapItemToKey(String str) {
            return str;
        }

        @Override // android.media.MediaFormat.FilteredMappedKeySet
        protected String mapKeyToItem(String str) {
            return str;
        }

        public UnprefixedKeySet(MediaFormat mediaFormat, String str) {
            super();
            this.mPrefix = str;
        }

        @Override // android.media.MediaFormat.FilteredMappedKeySet
        protected boolean keepKey(String str) {
    ...
    private class PrefixedKeySetWithPrefixRemoved extends FilteredMappedKeySet {
        ...
        public PrefixedKeySetWithPrefixRemoved(MediaFormat mediaFormat, String str) {
            super();
            this.mPrefix = str;
    ...
    public final Set<String> getKeys() {
        return new UnprefixedKeySet(this, KEY_FEATURE_);
    }

    public final Set<String> getFeatures() {
        return new PrefixedKeySetWithPrefixRemoved(this, KEY_FEATURE_);
    }
