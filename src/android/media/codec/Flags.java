...
public final class Flags {
    ...
    public static final String FLAG_CODEC_AVAILABILITY = "android.media.codec.codec_availability";
    public static final String FLAG_CODEC_AVAILABILITY_METRICS = "android.media.codec.codec_availability_metrics";
    public static final String FLAG_CODEC_AVAILABILITY_SUPPORT = "android.media.codec.codec_availability_support";
    public static final String FLAG_CODEC_BUFFER_STATE_CLEANUP = "android.media.codec.codec_buffer_state_cleanup";
    public static final String FLAG_DATASPACE_V0_PARTIAL = "android.media.codec.dataspace_v0_partial";
    ...
    public static final String FLAG_RENDERING_DEPTH_REMOVAL = "android.media.codec.rendering_depth_removal";
    public static final String FLAG_SECURE_CODECS_REQUIRE_CRYPTO = "android.media.codec.secure_codecs_require_crypto";
    ...
    public static final String FLAG_THUMBNAIL_BLOCK_MODEL = "android.media.codec.thumbnail_block_model";
    ...
    public static boolean codecAvailability() {
        return FEATURE_FLAGS.codecAvailability();
    }

    public static boolean codecAvailabilityMetrics() {
        return FEATURE_FLAGS.codecAvailabilityMetrics();
    }

    public static boolean codecAvailabilitySupport() {
        return FEATURE_FLAGS.codecAvailabilitySupport();
    }

    public static boolean codecBufferStateCleanup() {
        return FEATURE_FLAGS.codecBufferStateCleanup();
    }

    public static boolean dataspaceV0Partial() {
        return FEATURE_FLAGS.dataspaceV0Partial();
    }
    ...
    public static boolean renderingDepthRemoval() {
        return FEATURE_FLAGS.renderingDepthRemoval();
    }

    public static boolean secureCodecsRequireCrypto() {
        return FEATURE_FLAGS.secureCodecsRequireCrypto();
    }
    ...
    public static boolean thumbnailBlockModel() {
        return FEATURE_FLAGS.thumbnailBlockModel();
    }
}
