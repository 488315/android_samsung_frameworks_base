...
public final class MicrophoneInfo {
    ...
    MicrophoneInfo(String str, int i, String str2, int i2, int i3, int i4, Coordinate3F coordinate3F, Coordinate3F coordinate3F2, List<Pair<Float, Float>> list, List<Pair<Integer, Integer>> list2, float f, float f2, float f3, int i5) {
        this.mDeviceId = str;
        this.mType = i;
        this.mAddress = str2;
        this.mLocation = i2;
    ...
    public static final class Coordinate3F {
        ...
        public boolean equals(Object obj) {
            ...
            Coordinate3F coordinate3F = (Coordinate3F) obj;
