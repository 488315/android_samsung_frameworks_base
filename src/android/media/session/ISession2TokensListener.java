...
public interface ISession2TokensListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISession2TokensListener {
        ...
        public static ISession2TokensListener asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(ISession2TokensListener.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof ISession2TokensListener)) {
                return (ISession2TokensListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ArrayList createTypedArrayList = parcel.createTypedArrayList(Session2Token.CREATOR);
        ...
        private static class Proxy implements ISession2TokensListener {
            ...
            public void onSession2TokensChanged(List<Session2Token> list) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(ISession2TokensListener.DESCRIPTOR);
