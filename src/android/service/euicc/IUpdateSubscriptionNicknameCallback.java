...
public interface IUpdateSubscriptionNicknameCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUpdateSubscriptionNicknameCallback {
        ...
        public static IUpdateSubscriptionNicknameCallback asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IUpdateSubscriptionNicknameCallback)) {
                return (IUpdateSubscriptionNicknameCallback) queryLocalInterface;
            }
