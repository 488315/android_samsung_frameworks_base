...
public interface IGetOtaStatusCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGetOtaStatusCallback {
        ...
        public static IGetOtaStatusCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IGetOtaStatusCallback)) {
                return (IGetOtaStatusCallback) iInterfaceQueryLocalInterface;
            }
