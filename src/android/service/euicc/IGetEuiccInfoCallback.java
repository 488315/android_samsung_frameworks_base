...
public interface IGetEuiccInfoCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGetEuiccInfoCallback {
        ...
        public static IGetEuiccInfoCallback asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IGetEuiccInfoCallback)) {
                return (IGetEuiccInfoCallback) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                EuiccInfo euiccInfo = (EuiccInfo) parcel.readTypedObject(EuiccInfo.CREATOR);
