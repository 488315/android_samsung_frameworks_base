...
public interface IRetainSubscriptionsForFactoryResetCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRetainSubscriptionsForFactoryResetCallback {
        ...
        public static IRetainSubscriptionsForFactoryResetCallback asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IRetainSubscriptionsForFactoryResetCallback)) {
                return (IRetainSubscriptionsForFactoryResetCallback) queryLocalInterface;
            }
