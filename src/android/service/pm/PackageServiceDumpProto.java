...
public final class PackageServiceDumpProto {
    ...
    public final class PackageShortProto {
        ...
        public PackageShortProto(PackageServiceDumpProto packageServiceDumpProto) {
        }
    }
    ...
    public final class SharedLibraryProto {
        ...
        public SharedLibraryProto(PackageServiceDumpProto packageServiceDumpProto) {
        }
    }
    ...
    public final class SharedUserProto {
        ...
        public SharedUserProto(PackageServiceDumpProto packageServiceDumpProto) {
        }
    }
}
