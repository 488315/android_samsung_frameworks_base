...
public final class PackageProto {
    ...
    public final class SplitProto {
        ...
        public SplitProto(PackageProto packageProto) {
        }
    }
    ...
    public final class UserInfoProto {
        ...
        public UserInfoProto(PackageProto packageProto) {
        }
        ...
        public final class ArchiveState {
            ...
            public ArchiveState(UserInfoProto userInfoProto) {
            }
            ...
            public final class ArchiveActivityInfo {
                ...
                public ArchiveActivityInfo(ArchiveState archiveState) {
                }
            }
        }
    }
    ...
    public final class InstallSourceProto {
        ...
        public InstallSourceProto(PackageProto packageProto) {
        }
    }
    ...
    public final class StatesProto {
        ...
        public StatesProto(PackageProto packageProto) {
        }
    }
    ...
    public final class UserPermissionsProto {
        ...
        public UserPermissionsProto(PackageProto packageProto) {
        }
    }
}
