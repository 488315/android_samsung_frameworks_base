...
public interface IControlsProviderInfoSubscriber extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IControlsProviderInfoSubscriber {
        ...
        public static IControlsProviderInfoSubscriber asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IControlsProviderInfoSubscriber.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IControlsProviderInfoSubscriber.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
