...
public interface QuickAccessWalletClient extends Closeable {
    ...
    public interface GesturePendingIntentCallback {
        void onGesturePendingIntentRetrieved(PendingIntent pendingIntent);
    }
    ...
    void getGestureTargetActivityPendingIntent(Executor executor, GesturePendingIntentCallback gesturePendingIntentCallback);
    ...
    static QuickAccessWalletClient create(Context context, Executor executor) {
        return new QuickAccessWalletClientImpl(context, executor);
    }
}
