...
public class ProvisioningManager {
    ...
    public static class Callback {
        ...
        static class CallbackBinder extends IImsConfigCallback.Stub {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onStringConfigChanged$1(int i, String str) {
    ...
    public static class RcsProvisioningCallback {
        ...
        static class CallbackBinder extends IRcsConfigCallback.Stub {
            ...
            private CallbackBinder(RcsProvisioningCallback rcsProvisioningCallback) {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onAutoConfigurationErrorReceived$1(int i, String str) {
    ...
    public void registerFeatureProvisioningChangedCallback(Executor executor, FeatureProvisioningCallback featureProvisioningCallback) throws ImsException {
    ...
    public void unregisterFeatureProvisioningChangedCallback(FeatureProvisioningCallback featureProvisioningCallback) {
        try {
    ...
    @SystemApi
    public void setRcsClientConfiguration(RcsClientConfiguration rcsClientConfiguration) throws ImsException {
        try {
    ...
    @SystemApi
    public void registerRcsProvisioningCallback(Executor executor, RcsProvisioningCallback rcsProvisioningCallback) throws ImsException {
    ...
    @SystemApi
    public void unregisterRcsProvisioningCallback(RcsProvisioningCallback rcsProvisioningCallback) {
        try {
