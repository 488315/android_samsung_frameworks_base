...
public interface IImsServiceControllerListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsServiceControllerListener {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IImsServiceControllerListener.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IImsServiceControllerListener.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
                ImsFeatureConfiguration imsFeatureConfiguration = (ImsFeatureConfiguration) parcel.readTypedObject(ImsFeatureConfiguration.CREATOR);
