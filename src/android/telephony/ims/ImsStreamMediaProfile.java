...
public final class ImsStreamMediaProfile implements Parcelable {
    ...
    public void copyFrom(ImsStreamMediaProfile imsStreamMediaProfile) {
        ...
        this.mAudioCodecAttributes = imsStreamMediaProfile.mAudioCodecAttributes;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeTypedObject(this.mAudioCodecAttributes, i);
    ...
    private void readFromParcel(Parcel parcel) {
        ...
        this.mAudioCodecAttributes = (AudioCodecAttributes) parcel.readTypedObject(AudioCodecAttributes.CREATOR);
    ...
    public void setReceivingRttAudio(boolean z) {
        this.mIsReceivingRttAudio = z;
    }
