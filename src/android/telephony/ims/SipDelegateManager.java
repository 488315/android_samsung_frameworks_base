...
public class SipDelegateManager {
    ...
    public SipDelegateManager(Context context, int i, BinderCacheManager<IImsRcsController> binderCacheManager, BinderCacheManager<ITelephony> binderCacheManager2) {
    ...
    public void registerSipDialogStateCallback(Executor executor, final SipDialogStateCallback sipDialogStateCallback) throws ImsException {
