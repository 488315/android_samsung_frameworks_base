...
public final class SecurityAlgorithmUpdate implements Parcelable {
    ...
    public static final Parcelable.Creator<SecurityAlgorithmUpdate> CREATOR = new Parcelable.Creator<SecurityAlgorithmUpdate>() { // from class: android.telephony.SecurityAlgorithmUpdate.1
        ...
        public SecurityAlgorithmUpdate createFromParcel(Parcel parcel) {
            return new SecurityAlgorithmUpdate(parcel);
        }
    ...
    private SecurityAlgorithmUpdate(Parcel parcel) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SecurityAlgorithmUpdate)) {
            return false;
        }
        SecurityAlgorithmUpdate securityAlgorithmUpdate = (SecurityAlgorithmUpdate) obj;
