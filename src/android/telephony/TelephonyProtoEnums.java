...
public final class TelephonyProtoEnums {
    ...
    public static final int CALL_STATE_DISCONNECTING = 9;
    public static final int CALL_STATE_HOLDING = 3;
    public static final int CALL_STATE_IDLE = 1;
    public static final int CALL_STATE_INCOMING = 6;
    public static final int CALL_STATE_INCOMING_SETUP = 10;
    public static final int CALL_STATE_UNKNOWN = 0;
    public static final int CALL_STATE_WAITING = 7;
