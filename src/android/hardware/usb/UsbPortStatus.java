...
public final class UsbPortStatus implements Parcelable {
    ...
    public UsbPortStatus(int i, int i2, int i3, int i4, int i5, int i6, int i7, boolean z, int i8, int[] iArr, int i9, DisplayPortAltModeInfo displayPortAltModeInfo) {
        this.mCurrentMode = i;
    ...
    public static final class Builder {
        ...
        public Builder setComplianceWarnings(int[] iArr) {
            if (iArr == null) {
                iArr = new int[0];
            }
            this.mComplianceWarnings = iArr;
