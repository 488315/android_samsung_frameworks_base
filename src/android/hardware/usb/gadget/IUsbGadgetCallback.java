...
public interface IUsbGadgetCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUsbGadgetCallback {
        ...
        public static IUsbGadgetCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IUsbGadgetCallback)) {
                return (IUsbGadgetCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                setCurrentUsbFunctionsCb(j, i3, j2);
            } else if (i == 2) {
                long j3 = parcel.readLong();
                int i4 = parcel.readInt();
                long j4 = parcel.readLong();
                parcel.enforceNoDataAvail();
                getCurrentUsbFunctionsCb(j3, i4, j4);
            } else if (i == 3) {
