...
public interface IUsbGadget extends android.hardware.usb.gadget.V1_1.IUsbGadget {
    ...
    public static final class Proxy implements IUsbGadget {
        ...
        public void setCurrentUsbFunctions(long j, android.hardware.usb.gadget.V1_0.IUsbGadgetCallback iUsbGadgetCallback, long j2) throws RemoteException {
        ...
        @Override // android.hardware.usb.gadget.V1_0.IUsbGadget
        public void getCurrentUsbFunctions(android.hardware.usb.gadget.V1_0.IUsbGadgetCallback iUsbGadgetCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.usb.gadget.V1_0.IUsbGadget.kInterfaceName);
            hwParcel.writeStrongBinder(iUsbGadgetCallback == null ? null : iUsbGadgetCallback.asBinder());
            HwParcel hwParcel2 = new HwParcel();
        ...
        public void getUsbSpeed(IUsbGadgetCallback iUsbGadgetCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IUsbGadget {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            ...
            if (i == 4) {
                ...
                getUsbSpeed(IUsbGadgetCallback.asInterface(hwParcel.readStrongBinder()));
                return;
            }
            switch (i) {
                case 256067662:
