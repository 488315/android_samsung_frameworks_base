...
public interface IUsbGadgetCallback extends android.hardware.usb.gadget.V1_0.IUsbGadgetCallback {
    ...
    static IUsbGadgetCallback asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IUsbGadgetCallback)) {
            return (IUsbGadgetCallback) iHwInterfaceQueryLocalInterface;
        }
