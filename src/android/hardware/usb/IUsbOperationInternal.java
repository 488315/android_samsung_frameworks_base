...
public interface IUsbOperationInternal extends IInterface {
    ...
    public static class Default implements IUsbOperationInternal {
        ...
        public void onOperationComplete(int i) throws RemoteException {
        }
    }
    ...
    public static abstract class Stub extends Binder implements IUsbOperationInternal {
        ...
        public static IUsbOperationInternal asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IUsbOperationInternal.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IUsbOperationInternal)) {
                return (IUsbOperationInternal) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IUsbOperationInternal.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IUsbOperationInternal.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
                int i3 = parcel.readInt();
                parcel.enforceNoDataAvail();
                onOperationComplete(i3);
                return true;
            }
        ...
        private static class Proxy implements IUsbOperationInternal {
            ...
            public void onOperationComplete(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IUsbOperationInternal.DESCRIPTOR);
