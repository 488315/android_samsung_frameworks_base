...
public class Constants {
    ...
    public final class ContaminantDetectionStatus {
        ...
        public ContaminantDetectionStatus(Constants constants) {
        }
    }
    ...
    public final class ContaminantProtectionMode {
        ...
        public ContaminantProtectionMode(Constants constants) {
        }
    }
    ...
    public final class ContaminantProtectionStatus {
        ...
        public ContaminantProtectionStatus(Constants constants) {
        }
    }
}
