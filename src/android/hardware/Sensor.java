...
public final class Sensor {
    ...
    public static final int SEM_ACCELEROMETER_SUB2 = 65701;
    public static final int SEM_ACCELEROMETER_UNCALIBRATED_SUB = 65688;
    public static final int SEM_ACCELEROMETER_UNCALIBRATED_SUB2 = 65702;
    public static final int SEM_FOLDING_ANGLE = 65686;
    public static final int SEM_GYROSCOPE_SUB = 65689;
    public static final int SEM_GYROSCOPE_SUB2 = 65703;
    public static final int SEM_GYROSCOPE_UNCALIBRATED_SUB = 65690;
    public static final int SEM_GYROSCOPE_UNCALIBRATED_SUB2 = 65704;
    public static final int SEM_MAGNETIC_SUB = 65705;
    public static final int SEM_MAGNETIC_UNCALIBRATED_SUB = 65706;
    ...
    public static final int SEM_TYPE_FOLDING_ANGLE_SUB = 65708;
    public static final int SEM_TYPE_FOLDING_STATE = 65695;
    public static final int SEM_TYPE_FOLDING_STATE_SUB = 65707;
    ...
    public static final int SEM_TYPE_LID_FOLDING_STATE_LPM_SUB = 65709;
    ...
    public static final int SEM_TYPE_SAR_FOLDING = 65711;
    public static final int SEM_TYPE_SEQ_FOLD_MON = 65710;
    ...
    private static final int[] sSamsungDualSensorReportingModes = {1, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6};
    ...
    public static int getMaxLengthValuesArray(Sensor sensor, int i) {
        ...
        if (i2 >= 65557 && i2 < length) {
            return iArr[i2 - 65557];
        }
        if (i2 < 65686 || i2 >= length2) {
            return 16;
        }
        return iArr2[i2 - 65686];
    }
    ...
    public boolean semIsOnFoldingSide() {
        String str;
        int i = this.mType;
        return (i == 8 || i == 5 || i == 65601) && (str = SystemProperties.get("ro.product.vendor.device")) != null && (str.contains("bloom") || str.contains("b2q"));
    }
