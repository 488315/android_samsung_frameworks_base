...
public final class BiometricsProtoEnums {
    ...
    public static final int EMUMERATION_RESULT_TIMEOUT = 5;
    ...
    public static final int ENUMERATION_RESULT_DANGLING_BOTH = 4;
    public static final int ENUMERATION_RESULT_DANGLING_FRAMEWORK = 3;
    public static final int ENUMERATION_RESULT_DANGLING_HAL = 2;
    public static final int ENUMERATION_RESULT_OK = 1;
    public static final int ENUMERATION_RESULT_UNKNOWN = 0;
    ...
    public static final int ISSUE_FINGERPRINTS_LOE = 5;
    ...
    public static final int UNENROLL_REASON_DANGLING_FRAMEWORK = 2;
    public static final int UNENROLL_REASON_DANGLING_HAL = 1;
    public static final int UNENROLL_REASON_UNKNOWN = 0;
    public static final int UNENROLL_REASON_USER_REQUEST = 3;
