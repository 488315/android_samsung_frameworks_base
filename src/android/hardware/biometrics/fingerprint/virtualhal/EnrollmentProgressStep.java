...
public class EnrollmentProgressStep implements Parcelable {
    public static final Parcelable.Creator<EnrollmentProgressStep> CREATOR = new Parcelable.Creator<EnrollmentProgressStep>() { // from class: android.hardware.biometrics.fingerprint.virtualhal.EnrollmentProgressStep.1
