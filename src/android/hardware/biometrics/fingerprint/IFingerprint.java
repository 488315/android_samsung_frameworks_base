...
public interface IFingerprint extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFingerprint {
        ...
        public static IFingerprint asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IFingerprint)) {
                return (IFingerprint) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                ISession iSessionCreateSession = createSession(i3, i4, iSessionCallbackAsInterface);
                parcel2.writeNoException();
        ...
        private static class Proxy implements IFingerprint {
            ...
            public SensorProps[] getSensorProps() throws RemoteException {
                ...
                try {
                    ...
                    return (SensorProps[]) parcelObtain2.createTypedArray(SensorProps.CREATOR);
                } finally {
