...
public class NextEnrollment implements Parcelable {
    public static final Parcelable.Creator<NextEnrollment> CREATOR = new Parcelable.Creator<NextEnrollment>() { // from class: android.hardware.biometrics.face.virtualhal.NextEnrollment.1
