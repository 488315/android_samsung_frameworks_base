...
public interface IDescramblerBase extends IBase {
    ...
    static IDescramblerBase asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
    ...
    static IDescramblerBase castFrom(IHwInterface iHwInterface) {
    ...
    static IDescramblerBase getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IDescramblerBase getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static IDescramblerBase getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements IDescramblerBase {
        ...
        public int setMediaCasSession(ArrayList<Byte> arrayList) throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IDescramblerBase {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IDescramblerBase.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
