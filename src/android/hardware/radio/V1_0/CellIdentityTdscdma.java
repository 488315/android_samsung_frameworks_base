...
public final class CellIdentityTdscdma {
    ...
    public final boolean equals(Object obj) {
        ...
        return HidlSupport.deepEquals(this.mcc, cellIdentityTdscdma.mcc) && HidlSupport.deepEquals(this.mnc, cellIdentityTdscdma.mnc) && this.lac == cellIdentityTdscdma.lac && this.cid == cellIdentityTdscdma.cid && this.cpid == cellIdentityTdscdma.cpid;
    }
    ...
    public static final ArrayList<CellIdentityTdscdma> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < int32; i++) {
            ...
            cellIdentityTdscdma.readEmbeddedFromParcel(hwParcel, readEmbeddedBuffer, i * 48);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        this.cpid = hwBlob.getInt32(j + 40);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        ...
        hwBlob.putInt32(j + 40, this.cpid);
    }
}
