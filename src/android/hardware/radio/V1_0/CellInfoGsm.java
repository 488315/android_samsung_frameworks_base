...
public final class CellInfoGsm {
    ...
    public final boolean equals(Object obj) {
        ...
        return HidlSupport.deepEquals(this.cellIdentityGsm, cellInfoGsm.cellIdentityGsm) && HidlSupport.deepEquals(this.signalStrengthGsm, cellInfoGsm.signalStrengthGsm);
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        this.cellIdentityGsm.readEmbeddedFromParcel(hwParcel, hwBlob, j);
        this.signalStrengthGsm.readEmbeddedFromParcel(hwParcel, hwBlob, j + 48);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        this.cellIdentityGsm.writeEmbeddedToBlob(hwBlob, j);
        this.signalStrengthGsm.writeEmbeddedToBlob(hwBlob, j + 48);
    }
}
