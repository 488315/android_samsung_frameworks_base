...
public final class CardStatus {
    ...
    public final boolean equals(Object obj) {
        ...
        return HidlSupport.deepEquals(this.base, cardStatus.base) && HidlSupport.deepEquals(this.eid, cardStatus.eid);
    }
    ...
    public static final ArrayList<CardStatus> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < int32; i++) {
            ...
            cardStatus.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 96);
