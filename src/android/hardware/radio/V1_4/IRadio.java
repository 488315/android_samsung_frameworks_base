...
public interface IRadio extends android.hardware.radio.V1_3.IRadio {
    ...
    public static final class Proxy implements IRadio {
        ...
        @Override // android.hardware.radio.V1_0.IRadio
        public void setRadioCapability(int i, android.hardware.radio.V1_0.RadioCapability radioCapability) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.radio.V1_0.IRadio.kInterfaceName);
            hwParcel.writeInt32(i);
        ...
        public void setupDataCall_1_4(int i, int i2, DataProfileInfo dataProfileInfo, boolean z, int i3, ArrayList<String> arrayList, ArrayList<String> arrayList2) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        @Override // android.hardware.radio.V1_4.IRadio
        public void setInitialAttachApn_1_4(int i, DataProfileInfo dataProfileInfo) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadio.kInterfaceName);
            hwParcel.writeInt32(i);
            dataProfileInfo.writeToParcel(hwParcel);
        ...
        @Override // android.hardware.radio.V1_4.IRadio
        public void setDataProfile_1_4(int i, ArrayList<DataProfileInfo> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadio.kInterfaceName);
            hwParcel.writeInt32(i);
        ...
        @Override // android.hardware.radio.V1_4.IRadio
        public void startNetworkScan_1_4(int i, NetworkScanRequest networkScanRequest) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadio.kInterfaceName);
            hwParcel.writeInt32(i);
            networkScanRequest.writeToParcel(hwParcel);
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 148:
                    hwParcel.enforceInterface(IRadio.kInterfaceName);
                    setDataProfile_1_4(hwParcel.readInt32(), DataProfileInfo.readVectorFromParcel(hwParcel));
                    return;
                case 149:
                    hwParcel.enforceInterface(IRadio.kInterfaceName);
