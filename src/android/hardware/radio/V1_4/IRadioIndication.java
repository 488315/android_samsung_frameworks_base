...
public interface IRadioIndication extends android.hardware.radio.V1_3.IRadioIndication {
    ...
    public static final class Proxy implements IRadioIndication {
        ...
        @Override // android.hardware.radio.V1_0.IRadioIndication
        public void radioCapabilityIndication(int i, android.hardware.radio.V1_0.RadioCapability radioCapability) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.radio.V1_0.IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
        ...
        @Override // android.hardware.radio.V1_4.IRadioIndication
        public void cellInfoList_1_4(int i, ArrayList<CellInfo> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
        ...
        @Override // android.hardware.radio.V1_4.IRadioIndication
        public void networkScanResult_1_4(int i, NetworkScanResult networkScanResult) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
            networkScanResult.writeToParcel(hwParcel);
        ...
        @Override // android.hardware.radio.V1_4.IRadioIndication
        public void currentPhysicalChannelConfigs_1_4(int i, ArrayList<PhysicalChannelConfig> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
        ...
        @Override // android.hardware.radio.V1_4.IRadioIndication
        public void dataCallListChanged_1_4(int i, ArrayList<SetupDataCallResult> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
        ...
        @Override // android.hardware.radio.V1_4.IRadioIndication
        public void currentSignalStrength_1_4(int i, SignalStrength signalStrength) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
            signalStrength.writeToParcel(hwParcel);
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndication {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 55:
                    hwParcel.enforceInterface(IRadioIndication.kInterfaceName);
                    cellInfoList_1_4(hwParcel.readInt32(), CellInfo.readVectorFromParcel(hwParcel));
                    return;
                case 56:
                    hwParcel.enforceInterface(IRadioIndication.kInterfaceName);
                    int readInt3217 = hwParcel.readInt32();
                    NetworkScanResult networkScanResult3 = new NetworkScanResult();
                    networkScanResult3.readFromParcel(hwParcel);
                    networkScanResult_1_4(readInt3217, networkScanResult3);
                    return;
                case 57:
                    hwParcel.enforceInterface(IRadioIndication.kInterfaceName);
                    currentPhysicalChannelConfigs_1_4(hwParcel.readInt32(), PhysicalChannelConfig.readVectorFromParcel(hwParcel));
                    return;
                case 58:
                    hwParcel.enforceInterface(IRadioIndication.kInterfaceName);
                    dataCallListChanged_1_4(hwParcel.readInt32(), SetupDataCallResult.readVectorFromParcel(hwParcel));
                    return;
                case 59:
                    hwParcel.enforceInterface(IRadioIndication.kInterfaceName);
