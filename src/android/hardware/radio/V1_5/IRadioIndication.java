...
public interface IRadioIndication extends android.hardware.radio.V1_4.IRadioIndication {
    ...
    public static final class Proxy implements IRadioIndication {
        ...
        @Override // android.hardware.radio.V1_5.IRadioIndication
        public void cellInfoList_1_5(int i, ArrayList<CellInfo> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
        ...
        @Override // android.hardware.radio.V1_5.IRadioIndication
        public void networkScanResult_1_5(int i, NetworkScanResult networkScanResult) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
            networkScanResult.writeToParcel(hwParcel);
        ...
        @Override // android.hardware.radio.V1_5.IRadioIndication
        public void dataCallListChanged_1_5(int i, ArrayList<SetupDataCallResult> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(i);
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndication {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 63:
                    hwParcel.enforceInterface(IRadioIndication.kInterfaceName);
                    cellInfoList_1_5(hwParcel.readInt32(), CellInfo.readVectorFromParcel(hwParcel));
                    return;
                case 64:
                    hwParcel.enforceInterface(IRadioIndication.kInterfaceName);
                    int readInt3221 = hwParcel.readInt32();
                    NetworkScanResult networkScanResult4 = new NetworkScanResult();
                    networkScanResult4.readFromParcel(hwParcel);
                    networkScanResult_1_5(readInt3221, networkScanResult4);
                    return;
                case 65:
                    hwParcel.enforceInterface(IRadioIndication.kInterfaceName);
                    dataCallListChanged_1_5(hwParcel.readInt32(), SetupDataCallResult.readVectorFromParcel(hwParcel));
                    return;
                default:
                    switch (i) {
                        case 256067662:
