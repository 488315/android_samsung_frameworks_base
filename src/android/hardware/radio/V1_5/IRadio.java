...
public interface IRadio extends android.hardware.radio.V1_4.IRadio {
    ...
    public static final class Proxy implements IRadio {
        ...
        public void setSystemSelectionChannels(int i, boolean z, ArrayList<android.hardware.radio.V1_1.RadioAccessSpecifier> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        @Override // android.hardware.radio.V1_5.IRadio
        public void setSystemSelectionChannels_1_5(int i, boolean z, ArrayList<RadioAccessSpecifier> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadio.kInterfaceName);
            hwParcel.writeInt32(i);
            hwParcel.writeBool(z);
        ...
        @Override // android.hardware.radio.V1_5.IRadio
        public void startNetworkScan_1_5(int i, NetworkScanRequest networkScanRequest) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadio.kInterfaceName);
            hwParcel.writeInt32(i);
            networkScanRequest.writeToParcel(hwParcel);
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 160:
                    hwParcel.enforceInterface(IRadio.kInterfaceName);
                    setSystemSelectionChannels_1_5(hwParcel.readInt32(), hwParcel.readBool(), RadioAccessSpecifier.readVectorFromParcel(hwParcel));
                    return;
                case 161:
                    hwParcel.enforceInterface(IRadio.kInterfaceName);
                    int readInt3234 = hwParcel.readInt32();
                    NetworkScanRequest networkScanRequest4 = new NetworkScanRequest();
                ...
                case 162:
                    ...
                    setupDataCall_1_5(readInt3235, readInt3236, dataProfileInfo6, hwParcel.readBool(), hwParcel.readInt32(), LinkAddress.readVectorFromParcel(hwParcel), hwParcel.readStringVector());
                    return;
                case 163:
                    hwParcel.enforceInterface(IRadio.kInterfaceName);
