...
public final class CellInfoLte {
    ...
    public static final ArrayList<CellInfoLte> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < int32; i++) {
            ...
            cellInfoLte.readEmbeddedFromParcel(hwParcel, readEmbeddedBuffer, i * 112);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        this.signalStrengthLte.readEmbeddedFromParcel(hwParcel, hwBlob, j + 88);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        ...
        this.signalStrengthLte.writeEmbeddedToBlob(hwBlob, j + 88);
    }
}
