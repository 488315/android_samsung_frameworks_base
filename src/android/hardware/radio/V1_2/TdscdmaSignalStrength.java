...
public final class TdscdmaSignalStrength {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || obj.getClass() != TdscdmaSignalStrength.class) {
            return false;
        }
        TdscdmaSignalStrength tdscdmaSignalStrength = (TdscdmaSignalStrength) obj;
        return this.signalStrength == tdscdmaSignalStrength.signalStrength && this.bitErrorRate == tdscdmaSignalStrength.bitErrorRate && this.rscp == tdscdmaSignalStrength.rscp;
    }
    ...
    public static final ArrayList<TdscdmaSignalStrength> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < int32; i++) {
            ...
            tdscdmaSignalStrength.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 12);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        this.signalStrength = hwBlob.getInt32(j);
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        hwBlob.putInt32(j, this.signalStrength);
