...
public class CdmaSignalStrength implements Parcelable {
    public static final Parcelable.Creator<CdmaSignalStrength> CREATOR = new Parcelable.Creator<CdmaSignalStrength>() { // from class: android.hardware.radio.network.CdmaSignalStrength.1
        ...
        public CdmaSignalStrength createFromParcel(Parcel parcel) {
            CdmaSignalStrength cdmaSignalStrength = new CdmaSignalStrength();
            cdmaSignalStrength.readFromParcel(parcel);
            return cdmaSignalStrength;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public CdmaSignalStrength[] newArray(int i) {
            return new CdmaSignalStrength[i];
        }
    };
    ...
    public String toString() {
        ...
        return "CdmaSignalStrength" + stringJoiner.toString();
    }
}
