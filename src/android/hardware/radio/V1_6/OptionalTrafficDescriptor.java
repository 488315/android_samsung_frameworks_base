...
public final class OptionalTrafficDescriptor {
    ...
    public void value(TrafficDescriptor trafficDescriptor) {
        this.hidl_d = (byte) 1;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || obj.getClass() != OptionalTrafficDescriptor.class) {
            return false;
        }
        OptionalTrafficDescriptor optionalTrafficDescriptor = (OptionalTrafficDescriptor) obj;
        return this.hidl_d == optionalTrafficDescriptor.hidl_d && HidlSupport.deepEquals(this.hidl_o, optionalTrafficDescriptor.hidl_o);
    }
    ...
    public static final ArrayList<OptionalTrafficDescriptor> readVectorFromParcel(HwParcel hwParcel) {
        ArrayList<OptionalTrafficDescriptor> arrayList = new ArrayList<>();
        ...
        for (int i = 0; i < int32; i++) {
            ...
            optionalTrafficDescriptor.readEmbeddedFromParcel(hwParcel, readEmbeddedBuffer, i * 56);
            arrayList.add(optionalTrafficDescriptor);
        }
        return arrayList;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        if (int8 == 0) {
            ...
            this.hidl_o = trafficDescriptor;
            trafficDescriptor.readEmbeddedFromParcel(hwParcel, hwBlob, j + 8);
        } else {
    ...
    public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<OptionalTrafficDescriptor> arrayList) {
