...
public final class QosBandwidth {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        this.maxBitrateKbps = hwBlob.getInt32(j);
    ...
    public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<QosBandwidth> arrayList) {
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        hwBlob.putInt32(j, this.maxBitrateKbps);
