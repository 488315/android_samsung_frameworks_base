...
public final class SetupDataCallResult {
    ...
    public static final ArrayList<SetupDataCallResult> readVectorFromParcel(HwParcel hwParcel) {
        ...
        HwBlob embeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 216, buffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            SetupDataCallResult setupDataCallResult = new SetupDataCallResult();
            setupDataCallResult.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 216);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        HwBlob embeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 40, hwBlob.handle(), j + 48, true);
        ...
        HwBlob embeddedBuffer2 = hwParcel.readEmbeddedBuffer(int322 * 16, hwBlob.handle(), j + 64, true);
        this.dnses.clear();
        ...
        HwBlob embeddedBuffer3 = hwParcel.readEmbeddedBuffer(int323 * 16, hwBlob.handle(), j + 80, true);
        this.gateways.clear();
        ...
        HwBlob embeddedBuffer4 = hwParcel.readEmbeddedBuffer(int324 * 16, hwBlob.handle(), j + 96, true);
        this.pcscf.clear();
        ...
        HwBlob embeddedBuffer5 = hwParcel.readEmbeddedBuffer(int325 * 48, hwBlob.handle(), j + 152, true);
        this.qosSessions.clear();
        for (int i8 = 0; i8 < int325; i8++) {
            QosSession qosSession = new QosSession();
            qosSession.readEmbeddedFromParcel(hwParcel, embeddedBuffer5, i8 * 48);
        ...
        HwBlob embeddedBuffer6 = hwParcel.readEmbeddedBuffer(int326 * 48, hwBlob.handle(), j + 200, true);
        this.trafficDescriptors.clear();
        for (int i9 = 0; i9 < int326; i9++) {
            TrafficDescriptor trafficDescriptor = new TrafficDescriptor();
            trafficDescriptor.readEmbeddedFromParcel(hwParcel, embeddedBuffer6, i9 * 48);
