...
public final class RadioError {
    ...
    public static final String dumpBitfield(int i) {
        ...
        if ((i & 67) == 67) {
            arrayList.add("SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED");
            i2 |= 67;
        }
        if ((i & 68) == 68) {
            arrayList.add("ACCESS_BARRED");
            i2 |= 68;
        }
        if ((i & 69) == 69) {
            arrayList.add("BLOCKED_DUE_TO_CALL");
            i2 |= 69;
        }
        if ((i & 70) == 70) {
            arrayList.add("RF_HARDWARE_ISSUE");
            i2 |= 70;
        }
        if ((i & 71) == 71) {
            arrayList.add("NO_RF_CALIBRATION_INFO");
            i2 |= 71;
        }
        if (i != i2) {
