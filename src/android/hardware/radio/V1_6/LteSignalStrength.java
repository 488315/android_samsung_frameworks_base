...
public final class LteSignalStrength {
    ...
    public final boolean equals(Object obj) {
        ...
        return HidlSupport.deepEquals(this.base, lteSignalStrength.base) && this.cqiTableIndex == lteSignalStrength.cqiTableIndex;
    }
    ...
    public static final ArrayList<LteSignalStrength> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < int32; i++) {
            ...
            lteSignalStrength.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 28);
