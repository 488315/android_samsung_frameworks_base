...
public final class OptionalOsAppId {
    ...
    public void value(OsAppId osAppId) {
        this.hidl_d = (byte) 1;
        this.hidl_o = osAppId;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || obj.getClass() != OptionalOsAppId.class) {
            return false;
        }
        OptionalOsAppId optionalOsAppId = (OptionalOsAppId) obj;
        return this.hidl_d == optionalOsAppId.hidl_d && HidlSupport.deepEquals(this.hidl_o, optionalOsAppId.hidl_o);
    }
    ...
    public static final ArrayList<OptionalOsAppId> readVectorFromParcel(HwParcel hwParcel) {
        ArrayList<OptionalOsAppId> arrayList = new ArrayList<>();
        ...
        for (int i = 0; i < int32; i++) {
            ...
            optionalOsAppId.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 24);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        if (int8 == 0) {
            ...
            this.hidl_o = osAppId;
            osAppId.readEmbeddedFromParcel(hwParcel, hwBlob, j + 8);
        } else {
    ...
    public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<OptionalOsAppId> arrayList) {
