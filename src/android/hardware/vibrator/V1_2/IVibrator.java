...
public interface IVibrator extends android.hardware.vibrator.V1_1.IVibrator {
    ...
    public static final class Proxy implements IVibrator {
        ...
        public void perform_1_2(int i, byte b, perform_1_2Callback perform_1_2callback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IVibrator {
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 5:
                    hwParcel.enforceInterface(android.hardware.vibrator.V1_0.IVibrator.kInterfaceName);
                    perform(hwParcel.readInt32(), hwParcel.readInt8(), new IVibrator.performCallback(this) { // from class: android.hardware.vibrator.V1_2.IVibrator.Stub.1
                ...
                case 6:
                    ...
                    perform_1_1(hwParcel.readInt32(), hwParcel.readInt8(), new IVibrator.perform_1_1Callback(this) { // from class: android.hardware.vibrator.V1_2.IVibrator.Stub.2
                ...
                case 7:
                    ...
                    perform_1_2(hwParcel.readInt32(), hwParcel.readInt8(), new perform_1_2Callback(this) { // from class: android.hardware.vibrator.V1_2.IVibrator.Stub.3
