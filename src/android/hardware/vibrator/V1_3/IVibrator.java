...
public interface IVibrator extends android.hardware.vibrator.V1_2.IVibrator {
    ...
    public static final class Proxy implements IVibrator {
        ...
        public void perform_1_1(int i, byte b, IVibrator.perform_1_1Callback perform_1_1callback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        public void perform_1_2(int i, byte b, IVibrator.perform_1_2Callback perform_1_2callback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        @Override // android.hardware.vibrator.V1_3.IVibrator
        public int setExternalControl(boolean z) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IVibrator.kInterfaceName);
        ...
        @Override // android.hardware.vibrator.V1_3.IVibrator
        public void perform_1_3(int i, byte b, perform_1_3Callback perform_1_3callback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IVibrator.kInterfaceName);
            hwParcel.writeInt32(i);
            hwParcel.writeInt8(b);
            ...
            try {
                ...
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                perform_1_3callback.onValues(hwParcel2.readInt32(), hwParcel2.readInt32());
            } finally {
                hwParcel2.release();
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IVibrator {
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 5:
                    hwParcel.enforceInterface(android.hardware.vibrator.V1_0.IVibrator.kInterfaceName);
                    perform(hwParcel.readInt32(), hwParcel.readInt8(), new IVibrator.performCallback(this) { // from class: android.hardware.vibrator.V1_3.IVibrator.Stub.1
                ...
                case 6:
                    ...
                    perform_1_1(hwParcel.readInt32(), hwParcel.readInt8(), new IVibrator.perform_1_1Callback(this) { // from class: android.hardware.vibrator.V1_3.IVibrator.Stub.2
                ...
                case 7:
                    ...
                    perform_1_2(hwParcel.readInt32(), hwParcel.readInt8(), new IVibrator.perform_1_2Callback(this) { // from class: android.hardware.vibrator.V1_3.IVibrator.Stub.3
                ...
                case 8:
                    ...
                    boolean zSupportsExternalControl = supportsExternalControl();
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeBool(zSupportsExternalControl);
                    hwParcel2.send();
                    return;
                case 9:
                    hwParcel.enforceInterface(IVibrator.kInterfaceName);
                    int externalControl = setExternalControl(hwParcel.readBool());
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeInt32(externalControl);
                    hwParcel2.send();
                    return;
                case 10:
                    hwParcel.enforceInterface(IVibrator.kInterfaceName);
                    perform_1_3(hwParcel.readInt32(), hwParcel.readInt8(), new perform_1_3Callback(this) { // from class: android.hardware.vibrator.V1_3.IVibrator.Stub.4
