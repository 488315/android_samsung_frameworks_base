...
public class ChannelMessage implements Parcelable {
    ...
    public static final class ChannelMessageContents implements Parcelable {
        ...
        public void readFromParcel(Parcel parcel) {
            ...
            if (readInt == 3) {
                _set(readInt, (SessionModeSetter) parcel.readTypedObject(SessionModeSetter.CREATOR));
            } else if (readInt == 4) {
                _set(readInt, (WorkDurationFixedV1) parcel.readTypedObject(WorkDurationFixedV1.CREATOR));
            } else {
