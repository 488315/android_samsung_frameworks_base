...
public interface IThermalChangedCallback extends IBase {
    ...
    static IThermalChangedCallback asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IThermalChangedCallback)) {
            return (IThermalChangedCallback) iHwInterfaceQueryLocalInterface;
        }
    ...
    static IThermalChangedCallback castFrom(IHwInterface iHwInterface) {
    ...
    static IThermalChangedCallback getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IThermalChangedCallback getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static IThermalChangedCallback getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements IThermalChangedCallback {
        ...
        public void notifyThrottling(Temperature temperature) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(IThermalChangedCallback.kInterfaceName);
            temperature.writeToParcel(hwParcel);
    ...
    public static abstract class Stub extends HwBinder implements IThermalChangedCallback {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IThermalChangedCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(IThermalChangedCallback.kInterfaceName);
                    Temperature temperature = new Temperature();
                    temperature.readFromParcel(hwParcel);
