...
public interface IThermal extends android.hardware.thermal.V1_0.IThermal {
    ...
    public static final class Proxy implements IThermal {
        ...
        public void registerThermalCallback(IThermalCallback iThermalCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IThermal.kInterfaceName);
            hwParcel.writeStrongBinder(iThermalCallback == null ? null : iThermalCallback.asBinder());
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IThermal {
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                getTemperatures(new IThermal.getTemperaturesCallback(this) { // from class: android.hardware.thermal.V1_1.IThermal.Stub.1
            ...
            if (i == 2) {
                hwParcel.enforceInterface(android.hardware.thermal.V1_0.IThermal.kInterfaceName);
                getCpuUsages(new IThermal.getCpuUsagesCallback(this) { // from class: android.hardware.thermal.V1_1.IThermal.Stub.2
            ...
            if (i == 3) {
                hwParcel.enforceInterface(android.hardware.thermal.V1_0.IThermal.kInterfaceName);
                getCoolingDevices(new IThermal.getCoolingDevicesCallback(this) { // from class: android.hardware.thermal.V1_1.IThermal.Stub.3
            ...
            if (i == 4) {
                ...
                registerThermalCallback(IThermalCallback.asInterface(hwParcel.readStrongBinder()));
                hwParcel2.writeStatus(0);
                hwParcel2.send();
                return;
            }
