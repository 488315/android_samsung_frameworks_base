...
public final class ThermalStatus {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || obj.getClass() != ThermalStatus.class) {
            return false;
        }
        ThermalStatus thermalStatus = (ThermalStatus) obj;
        return this.code == thermalStatus.code && HidlSupport.deepEquals(this.debugMessage, thermalStatus.debugMessage);
    }
    ...
    public static final ArrayList<ThermalStatus> readVectorFromParcel(HwParcel hwParcel) {
        ArrayList<ThermalStatus> arrayList = new ArrayList<>();
        ...
        for (int i = 0; i < int32; i++) {
            ...
            thermalStatus.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 24);
