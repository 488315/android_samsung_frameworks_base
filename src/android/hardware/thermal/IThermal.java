...
public interface IThermal extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IThermal {
        ...
        public static IThermal asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IThermal)) {
                return (IThermal) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    ...
                    CoolingDevice[] coolingDevicesWithType = getCoolingDevicesWithType(readInt);
                    parcel2.writeNoException();
                ...
                case 4:
                    ...
                    parcel.enforceNoDataAvail();
                    Temperature[] temperaturesWithType = getTemperaturesWithType(readInt2);
                    parcel2.writeNoException();
                ...
                case 6:
                    ...
                    parcel.enforceNoDataAvail();
                    TemperatureThreshold[] temperatureThresholdsWithType = getTemperatureThresholdsWithType(readInt3);
                    parcel2.writeNoException();
                    parcel2.writeTypedArray(temperatureThresholdsWithType, 1);
                    return true;
                case 7:
                    IThermalChangedCallback asInterface = IThermalChangedCallback.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                    registerThermalChangedCallback(asInterface);
                    parcel2.writeNoException();
                    return true;
                case 8:
                    IThermalChangedCallback asInterface2 = IThermalChangedCallback.Stub.asInterface(parcel.readStrongBinder());
                    ...
                    return true;
                case 9:
                    IThermalChangedCallback asInterface3 = IThermalChangedCallback.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                    unregisterThermalChangedCallback(asInterface3);
                    parcel2.writeNoException();
                    return true;
                case 10:
                    ICoolingDeviceChangedCallback asInterface4 = ICoolingDeviceChangedCallback.Stub.asInterface(parcel.readStrongBinder());
                    ...
                    return true;
                case 11:
                    ICoolingDeviceChangedCallback asInterface5 = ICoolingDeviceChangedCallback.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                ...
                case 12:
                    ...
                    parcel.enforceNoDataAvail();
                    float forecastSkinTemperature = forecastSkinTemperature(readInt6);
                    parcel2.writeNoException();
                    parcel2.writeFloat(forecastSkinTemperature);
                    return true;
                default:
        ...
        private static class Proxy implements IThermal {
            ...
            public TemperatureThreshold[] getTemperatureThresholds() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return (TemperatureThreshold[]) obtain2.createTypedArray(TemperatureThreshold.CREATOR);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
