...
public interface IInitializeSessionCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInitializeSessionCallback {
        ...
        public static IInitializeSessionCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IInitializeSessionCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IInitializeSessionCallback)) {
                return (IInitializeSessionCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IInitializeSessionCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IInitializeSessionCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
                onSuccess();
        ...
        private static class Proxy implements IInitializeSessionCallback {
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IInitializeSessionCallback.DESCRIPTOR);
