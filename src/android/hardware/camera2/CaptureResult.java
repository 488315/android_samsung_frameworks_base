...
public class CaptureResult extends CameraMetadata<Key<?>> {
    ...
    @PublicKey
    public static final Key<Integer> EXTENSION_NIGHT_MODE_INDICATOR = new Key<>("android.extension.nightModeIndicator", Integer.TYPE);
    ...
    public CaptureResult(String str, CameraMetadataNative cameraMetadataNative, CaptureRequest captureRequest, CaptureResultExtras captureResultExtras) {
    ...
    public CaptureResult(String str, CameraMetadataNative cameraMetadataNative, CaptureRequest captureRequest, int i, long j) {
        if (cameraMetadataNative == null) {
            throw new IllegalArgumentException("results was null");
        }
        if (captureRequest == null) {
