...
public interface ICameraInjectionSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICameraInjectionSession {
        ...
        public static ICameraInjectionSession asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(ICameraInjectionSession.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(ICameraInjectionSession.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
                stopInjection();
