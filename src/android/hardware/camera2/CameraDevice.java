...
public abstract class CameraDevice implements AutoCloseable {
    ...
    public static abstract class StateCallback {
        ...
        @SystemApi
        public void onClientSharedAccessPriorityChanged(CameraDevice cameraDevice, boolean z) {
        }
        ...
        @SystemApi
        public void onOpenedInSharedMode(CameraDevice cameraDevice, boolean z) {
        }
    }
