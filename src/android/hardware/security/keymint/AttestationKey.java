...
public class AttestationKey implements Parcelable {
    public static final Parcelable.Creator<AttestationKey> CREATOR = new Parcelable.Creator<AttestationKey>() { // from class: android.hardware.security.keymint.AttestationKey.1
        ...
        public AttestationKey createFromParcel(Parcel parcel) {
            AttestationKey attestationKey = new AttestationKey();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public AttestationKey[] newArray(int i) {
            return new AttestationKey[i];
        }
    };
    ...
    public final void readFromParcel(Parcel parcel) {
        ...
        try {
            ...
            if (parcel.dataPosition() - dataPosition < readInt) {
                ...
                if (parcel.dataPosition() - dataPosition < readInt) {
                    this.attestKeyParams = (KeyParameter[]) parcel.createTypedArray(KeyParameter.CREATOR);
                    if (parcel.dataPosition() - dataPosition < readInt) {
    ...
    public int describeContents() {
        return describeContents(this.attestKeyParams);
    }
