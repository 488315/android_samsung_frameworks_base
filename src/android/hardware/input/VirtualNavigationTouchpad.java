...
public class VirtualNavigationTouchpad extends VirtualInputDevice {
    ...
    public VirtualNavigationTouchpad(VirtualNavigationTouchpadConfig virtualNavigationTouchpadConfig, IVirtualDevice iVirtualDevice, IBinder iBinder) {
        super(virtualNavigationTouchpadConfig, iVirtualDevice, iBinder);
    }

    public void sendTouchEvent(VirtualTouchEvent virtualTouchEvent) {
        try {
