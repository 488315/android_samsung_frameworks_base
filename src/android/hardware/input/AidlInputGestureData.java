...
public class AidlInputGestureData implements Parcelable {
    ...
    public static final class Trigger implements Parcelable {
        ...
        public void readFromParcel(Parcel parcel) {
            int readInt = parcel.readInt();
            if (readInt == 0) {
                _set(readInt, (KeyTrigger) parcel.readTypedObject(KeyTrigger.CREATOR));
            } else if (readInt == 1) {
                _set(readInt, (TouchpadGestureTrigger) parcel.readTypedObject(TouchpadGestureTrigger.CREATOR));
            } else {
