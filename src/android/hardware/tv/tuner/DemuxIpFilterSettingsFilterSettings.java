...
public final class DemuxIpFilterSettingsFilterSettings implements Parcelable {
    public static final Parcelable.Creator<DemuxIpFilterSettingsFilterSettings> CREATOR = new Parcelable.Creator<DemuxIpFilterSettingsFilterSettings>() { // from class: android.hardware.tv.tuner.DemuxIpFilterSettingsFilterSettings.1
        ...
        public DemuxIpFilterSettingsFilterSettings createFromParcel(Parcel parcel) {
            return new DemuxIpFilterSettingsFilterSettings(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public DemuxIpFilterSettingsFilterSettings[] newArray(int i) {
            return new DemuxIpFilterSettingsFilterSettings[i];
        }
    };
    ...
    private DemuxIpFilterSettingsFilterSettings(Parcel parcel) {
        readFromParcel(parcel);
    }

    private DemuxIpFilterSettingsFilterSettings(int i, Object obj) {
        this._tag = i;
        this._value = obj;
    }
    ...
    public static DemuxIpFilterSettingsFilterSettings noinit(boolean z) {
        return new DemuxIpFilterSettingsFilterSettings(0, Boolean.valueOf(z));
    }
    ...
    public static DemuxIpFilterSettingsFilterSettings section(DemuxFilterSectionSettings demuxFilterSectionSettings) {
        return new DemuxIpFilterSettingsFilterSettings(1, demuxFilterSectionSettings);
    }
    ...
    public static DemuxIpFilterSettingsFilterSettings bPassthrough(boolean z) {
        return new DemuxIpFilterSettingsFilterSettings(2, Boolean.valueOf(z));
    }
