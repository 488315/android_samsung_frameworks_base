...
public final class FrontendGuardInterval implements Parcelable {
    public static final Parcelable.Creator<FrontendGuardInterval> CREATOR = new Parcelable.Creator<FrontendGuardInterval>() { // from class: android.hardware.tv.tuner.FrontendGuardInterval.1
        ...
        public FrontendGuardInterval createFromParcel(Parcel parcel) {
            return new FrontendGuardInterval(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public FrontendGuardInterval[] newArray(int i) {
            return new FrontendGuardInterval[i];
        }
    };
    ...
    private FrontendGuardInterval(Parcel parcel) {
        readFromParcel(parcel);
    }

    private FrontendGuardInterval(int i, Object obj) {
        this._tag = i;
        this._value = obj;
    }
    ...
    public static FrontendGuardInterval dvbt(int i) {
        return new FrontendGuardInterval(0, Integer.valueOf(i));
    }
    ...
    public static FrontendGuardInterval isdbt(int i) {
        return new FrontendGuardInterval(1, Integer.valueOf(i));
    }
    ...
    public static FrontendGuardInterval dtmb(int i) {
        return new FrontendGuardInterval(2, Integer.valueOf(i));
    }
