...
public interface IMeasurementCorrectionsCallback extends IBase {
    ...
    static IMeasurementCorrectionsCallback asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IMeasurementCorrectionsCallback)) {
            return (IMeasurementCorrectionsCallback) iHwInterfaceQueryLocalInterface;
        }
    ...
    static IMeasurementCorrectionsCallback castFrom(IHwInterface iHwInterface) {
    ...
    static IMeasurementCorrectionsCallback getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IMeasurementCorrectionsCallback getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static IMeasurementCorrectionsCallback getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements IMeasurementCorrectionsCallback {
        ...
        public void setCapabilitiesCb(int i) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(IMeasurementCorrectionsCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IMeasurementCorrectionsCallback {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IMeasurementCorrectionsCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(IMeasurementCorrectionsCallback.kInterfaceName);
