...
public interface IMeasurementCorrectionsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMeasurementCorrectionsCallback {
        ...
        public static IMeasurementCorrectionsCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IMeasurementCorrectionsCallback)) {
                return (IMeasurementCorrectionsCallback) iInterfaceQueryLocalInterface;
            }
