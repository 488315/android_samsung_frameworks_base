...
public interface IGnssMeasurement extends android.hardware.gnss.V2_0.IGnssMeasurement {
    ...
    static IGnssMeasurement asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IGnssMeasurement)) {
            return (IGnssMeasurement) iHwInterfaceQueryLocalInterface;
        }
    ...
    public static final class Proxy implements IGnssMeasurement {
        ...
        public int setCallback_2_0(android.hardware.gnss.V2_0.IGnssMeasurementCallback iGnssMeasurementCallback, boolean z) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_0.IGnssMeasurement.kInterfaceName);
            hwParcel.writeStrongBinder(iGnssMeasurementCallback == null ? null : iGnssMeasurementCallback.asBinder());
            hwParcel.writeBool(z);
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        public int setCallback_2_1(IGnssMeasurementCallback iGnssMeasurementCallback, boolean z) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IGnssMeasurement {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            ...
            if (i == 4) {
                hwParcel.enforceInterface(android.hardware.gnss.V2_0.IGnssMeasurement.kInterfaceName);
                int callback_2_0 = setCallback_2_0(android.hardware.gnss.V2_0.IGnssMeasurementCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readBool());
                hwParcel2.writeStatus(0);
            ...
            if (i == 5) {
                ...
                int callback_2_1 = setCallback_2_1(IGnssMeasurementCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readBool());
                hwParcel2.writeStatus(0);
                hwParcel2.writeInt32(callback_2_1);
                hwParcel2.send();
                return;
            }
            switch (i) {
