...
public interface IGnssMeasurementCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGnssMeasurementCallback {
        ...
        public static IGnssMeasurementCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                GnssData gnssData = (GnssData) parcel.readTypedObject(GnssData.CREATOR);
        ...
        private static class Proxy implements IGnssMeasurementCallback {
            ...
            public void gnssMeasurementCb(GnssData gnssData) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeTypedObject(gnssData, 0);
