...
public interface IGnssPowerIndication extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGnssPowerIndication {
        ...
        public static IGnssPowerIndication asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IGnssPowerIndication)) {
                return (IGnssPowerIndication) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                IGnssPowerIndicationCallback asInterface = IGnssPowerIndicationCallback.Stub.asInterface(parcel.readStrongBinder());
