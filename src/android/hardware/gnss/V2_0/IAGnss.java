...
public interface IAGnss extends IBase {
    ...
    static IAGnss asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IAGnss)) {
            return (IAGnss) iHwInterfaceQueryLocalInterface;
        }
    ...
    public static final class Proxy implements IAGnss {
        ...
        @Override // android.hardware.gnss.V2_0.IAGnss
        public boolean dataConnOpen(long j, String str, byte b) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IAGnss.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IAGnss {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            ...
            if (i == 2) {
                hwParcel.enforceInterface(IAGnss.kInterfaceName);
                boolean zDataConnClosed = dataConnClosed();
                hwParcel2.writeStatus(0);
                hwParcel2.writeBool(zDataConnClosed);
                hwParcel2.send();
                return;
            }
            if (i == 3) {
                hwParcel.enforceInterface(IAGnss.kInterfaceName);
                boolean zDataConnFailed = dataConnFailed();
                hwParcel2.writeStatus(0);
                hwParcel2.writeBool(zDataConnFailed);
                hwParcel2.send();
                return;
            }
            if (i == 4) {
            ...
            if (i == 5) {
                hwParcel.enforceInterface(IAGnss.kInterfaceName);
                boolean zDataConnOpen = dataConnOpen(hwParcel.readInt64(), hwParcel.readString(), hwParcel.readInt8());
                hwParcel2.writeStatus(0);
                hwParcel2.writeBool(zDataConnOpen);
                hwParcel2.send();
                return;
            }
            switch (i) {
