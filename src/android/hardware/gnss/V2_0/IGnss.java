...
public interface IGnss extends android.hardware.gnss.V1_1.IGnss {
    ...
    public static final class Proxy implements IGnss {
        ...
        @Override // android.hardware.gnss.V1_1.IGnss
        public boolean injectBestLocation(android.hardware.gnss.V1_0.GnssLocation gnssLocation) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V1_1.IGnss.kInterfaceName);
        ...
        public boolean setCallback_2_0(IGnssCallback iGnssCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        @Override // android.hardware.gnss.V2_0.IGnss
        public boolean injectBestLocation_2_0(GnssLocation gnssLocation) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IGnss.kInterfaceName);
            gnssLocation.writeToParcel(hwParcel);
            HwParcel hwParcel2 = new HwParcel();
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 24:
                    ...
                    boolean callback_2_0 = setCallback_2_0(IGnssCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                ...
                case 25:
                    hwParcel.enforceInterface(IGnss.kInterfaceName);
                    IGnssConfiguration extensionGnssConfiguration_2_0 = getExtensionGnssConfiguration_2_0();
                    hwParcel2.writeStatus(0);
                ...
                case 26:
                    hwParcel.enforceInterface(IGnss.kInterfaceName);
                    IGnssDebug extensionGnssDebug_2_0 = getExtensionGnssDebug_2_0();
                    hwParcel2.writeStatus(0);
                ...
                case 27:
                    hwParcel.enforceInterface(IGnss.kInterfaceName);
                    IAGnss extensionAGnss_2_0 = getExtensionAGnss_2_0();
                    hwParcel2.writeStatus(0);
                ...
                case 28:
                    hwParcel.enforceInterface(IGnss.kInterfaceName);
                    IAGnssRil extensionAGnssRil_2_0 = getExtensionAGnssRil_2_0();
                    hwParcel2.writeStatus(0);
                ...
                case 29:
                    hwParcel.enforceInterface(IGnss.kInterfaceName);
                    IGnssMeasurement extensionGnssMeasurement_2_0 = getExtensionGnssMeasurement_2_0();
                    hwParcel2.writeStatus(0);
                ...
                case 30:
                    hwParcel.enforceInterface(IGnss.kInterfaceName);
                    IMeasurementCorrections extensionMeasurementCorrections = getExtensionMeasurementCorrections();
                    hwParcel2.writeStatus(0);
                ...
                case 32:
                    hwParcel.enforceInterface(IGnss.kInterfaceName);
                    IGnssBatching extensionGnssBatching_2_0 = getExtensionGnssBatching_2_0();
                    hwParcel2.writeStatus(0);
