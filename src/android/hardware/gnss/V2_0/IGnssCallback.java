...
public interface IGnssCallback extends android.hardware.gnss.V1_1.IGnssCallback {
    ...
    public static final class GnssSvInfo {
        ...
        public final boolean equals(Object obj) {
            ...
            return HidlSupport.deepEquals(this.v1_0, gnssSvInfo.v1_0) && this.constellation == gnssSvInfo.constellation;
        }
        ...
        public static final ArrayList<GnssSvInfo> readVectorFromParcel(HwParcel hwParcel) {
            ...
            for (int i = 0; i < int32; i++) {
                ...
                gnssSvInfo.readEmbeddedFromParcel(hwParcel, readEmbeddedBuffer, i * 28);
        ...
        public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
            ...
            this.constellation = hwBlob.getInt8(j + 24);
        }
        ...
        public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
            ...
            hwBlob.putInt8(j + 24, this.constellation);
        }
    }
    ...
    public static final class Proxy implements IGnssCallback {
        ...
        public void gnssLocationCb(android.hardware.gnss.V1_0.GnssLocation gnssLocation) throws RemoteException {
        ...
        @Override // android.hardware.gnss.V2_0.IGnssCallback
        public void gnssLocationCb_2_0(GnssLocation gnssLocation) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IGnssCallback.kInterfaceName);
            gnssLocation.writeToParcel(hwParcel);
            HwParcel hwParcel2 = new HwParcel();
        ...
        @Override // android.hardware.gnss.V2_0.IGnssCallback
        public void gnssSvStatusCb_2_0(ArrayList<GnssSvInfo> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IGnssCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IGnssCallback {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 15:
                    hwParcel.enforceInterface(IGnssCallback.kInterfaceName);
                    gnssSvStatusCb_2_0(GnssSvInfo.readVectorFromParcel(hwParcel));
                    hwParcel2.writeStatus(0);
                    hwParcel2.send();
                    return;
                default:
