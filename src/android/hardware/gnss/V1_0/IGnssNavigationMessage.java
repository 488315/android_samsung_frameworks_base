...
public interface IGnssNavigationMessage extends IBase {
    ...
    static IGnssNavigationMessage asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IGnssNavigationMessage)) {
            return (IGnssNavigationMessage) iHwInterfaceQueryLocalInterface;
        }
    ...
    static IGnssNavigationMessage castFrom(IHwInterface iHwInterface) {
    ...
    static IGnssNavigationMessage getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IGnssNavigationMessage getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static IGnssNavigationMessage getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements IGnssNavigationMessage {
        ...
        public int setCallback(IGnssNavigationMessageCallback iGnssNavigationMessageCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IGnssNavigationMessage.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IGnssNavigationMessage {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IGnssNavigationMessage.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            if (i == 1) {
                hwParcel.enforceInterface(IGnssNavigationMessage.kInterfaceName);
                int callback = setCallback(IGnssNavigationMessageCallback.asInterface(hwParcel.readStrongBinder()));
