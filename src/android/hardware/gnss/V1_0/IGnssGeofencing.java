...
public interface IGnssGeofencing extends IBase {
    ...
    static IGnssGeofencing asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IGnssGeofencing)) {
            return (IGnssGeofencing) iHwInterfaceQueryLocalInterface;
        }
    ...
    static IGnssGeofencing castFrom(IHwInterface iHwInterface) {
    ...
    static IGnssGeofencing getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IGnssGeofencing getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static IGnssGeofencing getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements IGnssGeofencing {
        ...
        public void setCallback(IGnssGeofenceCallback iGnssGeofenceCallback) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(IGnssGeofencing.kInterfaceName);
            hwParcel.writeStrongBinder(iGnssGeofenceCallback == null ? null : iGnssGeofenceCallback.asBinder());
    ...
    public static abstract class Stub extends HwBinder implements IGnssGeofencing {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IGnssGeofencing.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            if (i == 1) {
                hwParcel.enforceInterface(IGnssGeofencing.kInterfaceName);
                setCallback(IGnssGeofenceCallback.asInterface(hwParcel.readStrongBinder()));
            ...
            if (i == 2) {
                hwParcel.enforceInterface(IGnssGeofencing.kInterfaceName);
                addGeofence(hwParcel.readInt32(), hwParcel.readDouble(), hwParcel.readDouble(), hwParcel.readDouble(), hwParcel.readInt32(), hwParcel.readInt32(), hwParcel.readInt32(), hwParcel.readInt32());
                hwParcel2.writeStatus(0);
                hwParcel2.send();
                return;
            }
            if (i == 3) {
                hwParcel.enforceInterface(IGnssGeofencing.kInterfaceName);
                pauseGeofence(hwParcel.readInt32());
                hwParcel2.writeStatus(0);
                hwParcel2.send();
                return;
            }
            if (i == 4) {
                hwParcel.enforceInterface(IGnssGeofencing.kInterfaceName);
                resumeGeofence(hwParcel.readInt32(), hwParcel.readInt32());
                hwParcel2.writeStatus(0);
                hwParcel2.send();
                return;
            }
            if (i == 5) {
                hwParcel.enforceInterface(IGnssGeofencing.kInterfaceName);
                removeGeofence(hwParcel.readInt32());
                hwParcel2.writeStatus(0);
                hwParcel2.send();
                return;
            }
