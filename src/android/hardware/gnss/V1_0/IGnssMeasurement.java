...
public interface IGnssMeasurement extends IBase {
    ...
    public static final class Proxy implements IGnssMeasurement {
        ...
        public int setCallback(IGnssMeasurementCallback iGnssMeasurementCallback) throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IGnssMeasurement {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                int callback = setCallback(IGnssMeasurementCallback.asInterface(hwParcel.readStrongBinder()));
