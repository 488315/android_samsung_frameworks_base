...
public interface IGnssBatching extends IBase {
    ...
    static IGnssBatching asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
    ...
    static IGnssBatching castFrom(IHwInterface iHwInterface) {
    ...
    static IGnssBatching getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IGnssBatching getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static IGnssBatching getService(String str) throws RemoteException {
    ...
    public static final class Options {
        ...
        public final boolean equals(Object obj) {
            ...
            if (obj == null || obj.getClass() != Options.class) {
                return false;
            }
            Options options = (Options) obj;
            return this.periodNanos == options.periodNanos && HidlSupport.deepEquals(Byte.valueOf(this.flags), Byte.valueOf(options.flags));
        }
        ...
        public static final ArrayList<Options> readVectorFromParcel(HwParcel hwParcel) {
            ...
            for (int i = 0; i < int32; i++) {
                ...
                options.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 16);
        ...
        public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
            this.periodNanos = hwBlob.getInt64(j);
        ...
        public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<Options> arrayList) {
            HwBlob hwBlob = new HwBlob(16);
        ...
        public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
            hwBlob.putInt64(j, this.periodNanos);
    ...
    public static final class Proxy implements IGnssBatching {
        ...
        public boolean init(IGnssBatchingCallback iGnssBatchingCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IGnssBatching.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IGnssBatching {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IGnssBatching.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    boolean zInit = init(IGnssBatchingCallback.asInterface(hwParcel.readStrongBinder()));
