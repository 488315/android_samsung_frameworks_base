...
public interface IGnssConfiguration extends android.hardware.gnss.V1_0.IGnssConfiguration {
    ...
    public static final class Proxy implements IGnssConfiguration {
        ...
        public boolean setBlacklist(ArrayList<BlacklistedSource> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 8:
                    ...
                    boolean blacklist = setBlacklist(BlacklistedSource.readVectorFromParcel(hwParcel));
                    hwParcel2.writeStatus(0);
