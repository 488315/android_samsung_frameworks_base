...
public interface IGnssMeasurement extends android.hardware.gnss.V1_0.IGnssMeasurement {
    ...
    public static final class Proxy implements IGnssMeasurement {
        ...
        public int setCallback_1_1(IGnssMeasurementCallback iGnssMeasurementCallback, boolean z) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IGnssMeasurement {
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            ...
            if (i == 3) {
                ...
                int callback_1_1 = setCallback_1_1(IGnssMeasurementCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readBool());
                hwParcel2.writeStatus(0);
