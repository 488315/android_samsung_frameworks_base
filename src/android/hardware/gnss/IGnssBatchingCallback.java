...
public interface IGnssBatchingCallback extends IInterface {
    ...
    public static class Default implements IGnssBatchingCallback {
        ...
        @Override // android.hardware.gnss.IGnssBatchingCallback
        public void gnssLocationBatchCb(GnssLocation[] gnssLocationArr) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IGnssBatchingCallback {
        ...
        public static IGnssBatchingCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IGnssBatchingCallback)) {
                return (IGnssBatchingCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                GnssLocation[] gnssLocationArr = (GnssLocation[]) parcel.createTypedArray(GnssLocation.CREATOR);
        ...
        private static class Proxy implements IGnssBatchingCallback {
            ...
            public void gnssLocationBatchCb(GnssLocation[] gnssLocationArr) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeTypedArray(gnssLocationArr, 0);
