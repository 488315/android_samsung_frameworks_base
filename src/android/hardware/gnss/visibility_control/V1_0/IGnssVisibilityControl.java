...
public interface IGnssVisibilityControl extends IBase {
    ...
    static IGnssVisibilityControl asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IGnssVisibilityControl)) {
            return (IGnssVisibilityControl) iHwInterfaceQueryLocalInterface;
        }
    ...
    static IGnssVisibilityControl castFrom(IHwInterface iHwInterface) {
    ...
    static IGnssVisibilityControl getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IGnssVisibilityControl getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static IGnssVisibilityControl getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements IGnssVisibilityControl {
        ...
        public boolean enableNfwLocationAccess(ArrayList<String> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IGnssVisibilityControl.kInterfaceName);
        ...
        @Override // android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl
        public boolean setCallback(IGnssVisibilityControlCallback iGnssVisibilityControlCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IGnssVisibilityControl.kInterfaceName);
            hwParcel.writeStrongBinder(iGnssVisibilityControlCallback == null ? null : iGnssVisibilityControlCallback.asBinder());
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IGnssVisibilityControl {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IGnssVisibilityControl.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            if (i == 1) {
                hwParcel.enforceInterface(IGnssVisibilityControl.kInterfaceName);
                boolean zEnableNfwLocationAccess = enableNfwLocationAccess(hwParcel.readStringVector());
                hwParcel2.writeStatus(0);
                hwParcel2.writeBool(zEnableNfwLocationAccess);
                hwParcel2.send();
                return;
            }
            if (i == 2) {
                hwParcel.enforceInterface(IGnssVisibilityControl.kInterfaceName);
                boolean callback = setCallback(IGnssVisibilityControlCallback.asInterface(hwParcel.readStrongBinder()));
                hwParcel2.writeStatus(0);
