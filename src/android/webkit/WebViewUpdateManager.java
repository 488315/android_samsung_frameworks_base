...
public final class WebViewUpdateManager {
    ...
    public WebViewUpdateManager(IWebViewUpdateService iWebViewUpdateService) {
        this.mService = iWebViewUpdateService;
    }

    public static WebViewUpdateManager getInstance() {
        WebViewUpdateManager webViewUpdateManager = (WebViewUpdateManager) SystemServiceRegistry.getSystemServiceWithNoContext(Context.WEBVIEW_UPDATE_SERVICE);
