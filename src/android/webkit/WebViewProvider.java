...
public interface WebViewProvider {
    ...
    public interface ViewDelegate {
        ...
        default void dispatchCreateViewTranslationRequest(Map<AutofillId, long[]> map, int[] iArr, TranslationCapability translationCapability, List<ViewTranslationRequest> list) {
        }
        ...
        default WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
            return null;
        }
        ...
        default void onCreateVirtualViewTranslationRequests(long[] jArr, int[] iArr, Consumer<ViewTranslationRequest> consumer) {
        }
        ...
        default void onProvideContentCaptureStructure(ViewStructure viewStructure, int i) {
        }

        void onProvideVirtualStructure(ViewStructure viewStructure);

        default PointerIcon onResolvePointerIcon(MotionEvent motionEvent, int i) {
            return null;
        }
        ...
        default void onVirtualViewTranslationResponses(LongSparseArray<ViewTranslationResponse> longSparseArray) {
        }
