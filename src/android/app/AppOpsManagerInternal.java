...
public abstract class AppOpsManagerInternal {
    ...
    public interface CheckOpsDelegate {
        ...
        SyncNotedAppOp noteOperation(int i, int i2, String str, String str2, int i3, boolean z, String str3, boolean z2, int i4, NonaFunction<Integer, Integer, String, String, Integer, Boolean, String, Boolean, Integer, SyncNotedAppOp> nonaFunction);
    ...
    public abstract void onPackageAdded(String str, int i);
