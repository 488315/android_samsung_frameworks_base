...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet = new HashSet(Arrays.asList(Flags.FLAG_DISABLE_IDLE_CHECK, Flags.FLAG_FILTER_BASED_EVENT_QUERY_API, Flags.FLAG_GET_APP_ART_MANAGED_BYTES, Flags.FLAG_GET_APP_BYTES_BY_DATA_TYPE_API, Flags.FLAG_REPORT_USAGE_STATS_PERMISSION, Flags.FLAG_USE_DEDICATED_HANDLER_THREAD, Flags.FLAG_USE_PARCELED_LIST, Flags.FLAG_USER_INTERACTION_TYPE_API, ""));
    ...
    public boolean getAppArtManagedBytes() {
        return getValue(Flags.FLAG_GET_APP_ART_MANAGED_BYTES, new Predicate() { // from class: android.app.usage.CustomFeatureFlags$$ExternalSyntheticLambda6
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ((FeatureFlags) obj).getAppArtManagedBytes();
            }
        });
    }
    ...
    public boolean reportUsageStatsPermission() {
        return getValue(Flags.FLAG_REPORT_USAGE_STATS_PERMISSION, new Predicate() { // from class: android.app.usage.CustomFeatureFlags$$ExternalSyntheticLambda7
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public List<String> getFlagNames() {
        return Arrays.asList(Flags.FLAG_DISABLE_IDLE_CHECK, Flags.FLAG_FILTER_BASED_EVENT_QUERY_API, Flags.FLAG_GET_APP_ART_MANAGED_BYTES, Flags.FLAG_GET_APP_BYTES_BY_DATA_TYPE_API, Flags.FLAG_REPORT_USAGE_STATS_PERMISSION, Flags.FLAG_USE_DEDICATED_HANDLER_THREAD, Flags.FLAG_USE_PARCELED_LIST, Flags.FLAG_USER_INTERACTION_TYPE_API);
    }
}
