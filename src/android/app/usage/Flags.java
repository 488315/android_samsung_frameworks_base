...
public final class Flags {
    ...
    public static final String FLAG_GET_APP_ART_MANAGED_BYTES = "android.app.usage.get_app_art_managed_bytes";
    ...
    public static boolean getAppArtManagedBytes() {
        return FEATURE_FLAGS.getAppArtManagedBytes();
    }
