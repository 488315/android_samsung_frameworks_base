...
public abstract class ActivityManagerInternal {
    ...
    public static final int OOM_ADJ_REASON_BINDER_BUFFER_FULL = 27;
    ...
    public static final int OOM_ADJ_REASON_FGSFILTER = 26;
    ...
    public static final int OOM_ADJ_REASON_PROCESS_BLOCK = 28;
    ...
    public static final int OOM_ADJ_REASON_SLOWDOWN = 25;
    ...
    public interface AppBackgroundRestrictionListener {
        ...
        default void onRestrictionLevelChanged(int i, String str, int i2) {
        }
    }
    ...
    public interface FrozenProcessListener {
        void onProcessFrozen(int i);

        void onProcessUnfrozen(int i);
    }
    ...
    public abstract void addCreatorToken(Intent intent, String str);

    public abstract void addForegroundServiceStateListener(ForegroundServiceStateListener foregroundServiceStateListener);

    public abstract void addFrozenProcessListener(int i, Executor executor, FrozenProcessListener frozenProcessListener);
    ...
    public abstract void getExecutableMethodFileOffsets(String str, int i, int i2, MethodDescriptor methodDescriptor, IOffsetCallback iOffsetCallback);
    ...
    public abstract boolean isEarlyPackageKillEnabledForUserSwitch(int i, int i2);
    ...
    public abstract void notifyActiveMediaForegroundService(String str, int i, int i2);

    public abstract void notifyInactiveMediaForegroundService(String str, int i, int i2);
    ...
    public abstract void onUserRemoving(int i);
    ...
    public abstract void setSwitchingFromUserMessage(int i, String str);

    public abstract void setSwitchingToUserMessage(int i, String str);
    ...
    public abstract void updateOomAdjProcess(String str);
