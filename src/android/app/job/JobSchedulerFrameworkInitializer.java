...
public class JobSchedulerFrameworkInitializer {
    ...
    static /* synthetic */ JobScheduler lambda$registerServiceWrappers$0(Context context, IBinder iBinder) {
        return new JobSchedulerImpl(context, IJobScheduler.Stub.asInterface(iBinder));
    }

    static /* synthetic */ DeviceIdleManager lambda$registerServiceWrappers$1(Context context, IBinder iBinder) {
