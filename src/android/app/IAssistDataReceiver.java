...
public interface IAssistDataReceiver extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAssistDataReceiver {
        ...
        public static IAssistDataReceiver asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IAssistDataReceiver)) {
                return (IAssistDataReceiver) iInterfaceQueryLocalInterface;
            }
