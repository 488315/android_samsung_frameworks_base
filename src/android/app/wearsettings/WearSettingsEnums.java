...
public final class WearSettingsEnums {
    ...
    public static final int APP_DETAILS_ALLOW_RESTRICTED_SETTINGS = 511;
    ...
    public static final int BLUETOOTH_DEVICE_TYPE = 527;
    ...
    public static final int DATE_TIME_LOCATION_TIME_ZONE_DETECTION = 525;
    ...
    public static final int DISPLAY_COLOR_THEME = 526;
    ...
    public static final int FORCE_GLOBAL_AMBIACTIVE = 600;
    ...
    public static final int MAIN_PRIORITY_MODES = 512;
    ...
    public static final int PRIORITY_MODES_BEDTIME_CUSTOMIZE = 517;
    public static final int PRIORITY_MODES_BEDTIME_MODE = 516;
    public static final int PRIORITY_MODES_CUSTOMIZE_ALARMS = 523;
    public static final int PRIORITY_MODES_CUSTOMIZE_DISPLAY_CONTROL_DEFAULT = 530;
    public static final int PRIORITY_MODES_CUSTOMIZE_DISPLAY_CONTROL_GRAYSCALE = 529;
    public static final int PRIORITY_MODES_CUSTOMIZE_DISPLAY_CONTROL_NIGHTLIGHT = 528;
    public static final int PRIORITY_MODES_CUSTOMIZE_MEDIA_SOUNDS = 524;
    public static final int PRIORITY_MODES_CUSTOMIZE_REPEAT_CALLERS = 522;
    public static final int PRIORITY_MODES_CUSTOMIZE_STARRED_CALLERS = 521;
    public static final int PRIORITY_MODES_DND_CUSTOMIZE = 515;
    public static final int PRIORITY_MODES_DND_SWITCH = 514;
    public static final int PRIORITY_MODES_DO_NOT_DISTURB = 513;
    public static final int PRIORITY_MODES_THEATER_CUSTOMIZE = 519;
    public static final int PRIORITY_MODES_THEATER_MODE = 518;
    public static final int PRIORITY_MODES_THEATER_SWITCH = 520;
