...
public interface IBlobCommitCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBlobCommitCallback {
        ...
        public static IBlobCommitCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IBlobCommitCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IBlobCommitCallback)) {
                return (IBlobCommitCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements IBlobCommitCallback {
            ...
            public void onResult(int i) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IBlobCommitCallback.DESCRIPTOR);
                    obtain.writeInt(i);
