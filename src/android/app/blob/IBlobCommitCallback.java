...
public interface IBlobCommitCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBlobCommitCallback {
        ...
        public static IBlobCommitCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IBlobCommitCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IBlobCommitCallback)) {
                return (IBlobCommitCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IBlobCommitCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IBlobCommitCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
        ...
        private static class Proxy implements IBlobCommitCallback {
            ...
            public void onResult(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IBlobCommitCallback.DESCRIPTOR);
