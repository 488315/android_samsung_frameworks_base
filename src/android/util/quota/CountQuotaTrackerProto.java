...
public final class CountQuotaTrackerProto {
    ...
    public final class CountLimit {
        ...
        public CountLimit(CountQuotaTrackerProto countQuotaTrackerProto) {
        }
    }
    ...
    public final class Event {
        ...
        public Event(CountQuotaTrackerProto countQuotaTrackerProto) {
        }
    }
    ...
    public final class ExecutionStats {
        ...
        public ExecutionStats(CountQuotaTrackerProto countQuotaTrackerProto) {
        }
    }
    ...
    public final class UptcStats {
        ...
        public UptcStats(CountQuotaTrackerProto countQuotaTrackerProto) {
        }
    }
}
