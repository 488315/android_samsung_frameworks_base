...
abstract class MapCollections<K, V> {
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public final boolean equals(Object obj) {
            ...
            return Objects.equals(entry.getKey(), MapCollections.this.colGetEntry(this.mIndex, 0)) && Objects.equals(entry.getValue(), MapCollections.this.colGetEntry(this.mIndex, 1));
        }
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            ...
            return Objects.equals(MapCollections.this.colGetEntry(iColIndexOfKey, 1), entry.getValue());
        }
    ...
    final class KeySet implements Set<K> {
        ...
        public String toString() {
            return MapCollections.this.toStringHelper(0, this, "KeySet");
        }
    }
    ...
    final class ValuesCollection implements Collection<V> {
        ...
        public String toString() {
            return MapCollections.this.toStringHelper(1, this, "ValuesCollection");
        }
    }
    ...
    public String toStringHelper(int i, Object obj, String str) {
        int iColGetSize = colGetSize();
        if (iColGetSize == 0) {
            return "[]";
        }
        StringBuilder sb = new StringBuilder(iColGetSize * 14);
        sb.append('[');
        for (int i2 = 0; i2 < iColGetSize; i2++) {
            if (i2 > 0) {
                sb.append(", ");
            }
            Object objColGetEntry = colGetEntry(i2, i);
            if (objColGetEntry != obj) {
                sb.append(objColGetEntry);
            } else {
                sb.append("(this ");
                sb.append(str);
