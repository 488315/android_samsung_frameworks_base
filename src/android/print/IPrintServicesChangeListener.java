...
public interface IPrintServicesChangeListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPrintServicesChangeListener {
        ...
        public static IPrintServicesChangeListener asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IPrintServicesChangeListener)) {
                return (IPrintServicesChangeListener) iInterfaceQueryLocalInterface;
            }
