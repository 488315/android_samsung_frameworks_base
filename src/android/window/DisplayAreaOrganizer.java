...
public class DisplayAreaOrganizer extends WindowOrganizer {
    public static final int FEATURE_APP_ZOOM_OUT = 10;
    ...
    public DisplayAreaAppearedInfo createTaskDisplayArea(int i, int i2, String str) {
        try {
    ...
    class AnonymousClass1 extends IDisplayAreaOrganizer.Stub {
        ...
        public void onDisplayAreaAppeared(final DisplayAreaInfo displayAreaInfo, final SurfaceControl surfaceControl) {
        ...
        public /* synthetic */ void lambda$onDisplayAreaAppeared$0(DisplayAreaInfo displayAreaInfo, SurfaceControl surfaceControl) {
