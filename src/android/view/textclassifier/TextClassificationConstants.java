...
public final class TextClassificationConstants {
    ...
    void dump(IndentingPrintWriter indentingPrintWriter) {
        ...
        indentingPrintWriter.print(LOCAL_TEXT_CLASSIFIER_ENABLED, Boolean.valueOf(isLocalTextClassifierEnabled())).println();
        ...
        indentingPrintWriter.print(SYSTEM_TEXT_CLASSIFIER_ENABLED, Boolean.valueOf(isSystemTextClassifierEnabled())).println();
        indentingPrintWriter.print(TEXT_CLASSIFIER_SERVICE_PACKAGE_OVERRIDE, getTextClassifierServicePackageOverride()).println();
        indentingPrintWriter.print(SYSTEM_TEXT_CLASSIFIER_API_TIMEOUT_IN_SECOND, Long.valueOf(getSystemTextClassifierApiTimeoutInSecond())).println();
