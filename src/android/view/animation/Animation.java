...
public abstract class Animation implements Cloneable {
    ...
    private boolean mIsSystemAnimation = false;
    ...
    public void setIsSystemAnimation(boolean z) {
        this.mIsSystemAnimation = z;
    }

    public boolean isSystemAnimation() {
        return this.mIsSystemAnimation;
    }
    ...
    public void getTransformationAt(float f, Transformation transformation) {
    ...
    protected static class Description {
        ...
        static Description parseValue(TypedValue typedValue, Context context) {
            ...
            if (typedValue == null) {
                ...
                if (typedValue.type == 5) {
                    description.type = 0;
                    description.value = TypedValue.complexToDimension(typedValue.data, context.getResources().getDisplayMetrics());
                    return description;
                }
            }
            description.type = 0;
