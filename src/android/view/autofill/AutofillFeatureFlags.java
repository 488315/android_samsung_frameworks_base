...
public class AutofillFeatureFlags {
    ...
    public static final long DEFAULT_FILL_DIALOG_MIN_WAIT_AFTER_IME_ANIMATION_END_MS = 0;
    public static final long DEFAULT_FILL_DIALOG_TIMEOUT_MS = 400;
    ...
    public static final String DEVICE_CONFIG_ENABLE_RELATIVE_LOCATION_FOR_RELAYOUT = "enable_relative_location_for_relayout";
    public static final String DEVICE_CONFIG_ENABLE_RELAYOUT = "enable_relayout";
    public static final String DEVICE_CONFIG_FILL_DIALOG_MIN_WAIT_AFTER_IME_ANIMATION_END_MS = "fill_dialog_min_wait_after_animation_end_ms";
    ...
    public static final String DEVICE_CONFIG_SESSION_FILL_EVENT_HISTORY = "session_fill_event_history";
    ...
    public static String[] getFillDialogEnabledHints() {
        String string = DeviceConfig.getString(Context.AUTOFILL_MANAGER_SERVICE, DEVICE_CONFIG_AUTOFILL_DIALOG_HINTS, "");
        if (TextUtils.isEmpty(string)) {
            return new String[0];
        }
        return (String[]) ArrayUtils.filter(string.split(":"), new IntFunction() { // from class: android.view.autofill.AutofillFeatureFlags$$ExternalSyntheticLambda0
    ...
    static /* synthetic */ String[] lambda$getFillDialogEnabledHints$0(int i) {
        return new String[i];
    }
    ...
    public static Set<String> getNonAutofillableImeActionIdSetFromFlag() {
        return new ArraySet(Arrays.asList(DeviceConfig.getString(Context.AUTOFILL_MANAGER_SERVICE, DEVICE_CONFIG_NON_AUTOFILLABLE_IME_ACTION_IDS, DEFAULT_AFAA_NON_AUTOFILLABLE_IME_ACTIONS).split(",")));
    }
    ...
    public static boolean enableRelayoutFixes() {
        return DeviceConfig.getBoolean(Context.AUTOFILL_MANAGER_SERVICE, DEVICE_CONFIG_ENABLE_RELAYOUT, true);
    }

    public static boolean enableRelativeLocationForRelayout() {
        return DeviceConfig.getBoolean(Context.AUTOFILL_MANAGER_SERVICE, DEVICE_CONFIG_ENABLE_RELATIVE_LOCATION_FOR_RELAYOUT, true);
    }
    ...
    public static boolean isImproveFillDialogEnabled() {
        return Flags.improveFillDialogAconfig() && DeviceConfig.getBoolean(Context.AUTOFILL_MANAGER_SERVICE, DEVICE_CONFIG_IMPROVE_FILL_DIALOG_ENABLED, true);
    }

    public static long getFillDialogTimeoutMs() {
        return DeviceConfig.getLong(Context.AUTOFILL_MANAGER_SERVICE, DEVICE_CONFIG_FILL_DIALOG_TIMEOUT_MS, 400L);
    }

    public static long getFillDialogMinWaitAfterImeAnimationtEndMs() {
        return DeviceConfig.getLong(Context.AUTOFILL_MANAGER_SERVICE, DEVICE_CONFIG_FILL_DIALOG_MIN_WAIT_AFTER_IME_ANIMATION_END_MS, 0L);
    }

    public static boolean isMultipleFillEventHistoryEnabled() {
        if (Flags.multipleFillHistory()) {
            return DeviceConfig.getBoolean(Context.AUTOFILL_MANAGER_SERVICE, DEVICE_CONFIG_SESSION_FILL_EVENT_HISTORY, true);
        }
        return false;
    }
}
