...
public interface InputMethodSession {
    ...
    default void invalidateInputInternal(EditorInfo editorInfo, IRemoteInputConnection iRemoteInputConnection, int i) {
    }

    default boolean onShouldVerifyKeyEvent(KeyEvent keyEvent) {
        return false;
    }
