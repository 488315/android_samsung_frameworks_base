...
public final class InputConnectionCallProto {
    ...
    public final class GetTextBeforeCursor {
        ...
        public GetTextBeforeCursor(InputConnectionCallProto inputConnectionCallProto) {
        }
    }
    ...
    public final class GetTextAfterCursor {
        ...
        public GetTextAfterCursor(InputConnectionCallProto inputConnectionCallProto) {
        }
    }
    ...
    public final class GetSelectedText {
        ...
        public GetSelectedText(InputConnectionCallProto inputConnectionCallProto) {
        }
    }
    ...
    public final class GetSurroundingText {
        ...
        public GetSurroundingText(InputConnectionCallProto inputConnectionCallProto) {
        }
        ...
        public final class SurroundingText {
            ...
            public SurroundingText(GetSurroundingText getSurroundingText) {
            }
        }
    }
    ...
    public final class GetCursorCapsMode {
        ...
        public GetCursorCapsMode(InputConnectionCallProto inputConnectionCallProto) {
        }
    }
    ...
    public final class GetExtractedText {
        ...
        public GetExtractedText(InputConnectionCallProto inputConnectionCallProto) {
        }
        ...
        public final class ExtractedTextRequest {
            ...
            public ExtractedTextRequest(GetExtractedText getExtractedText) {
            }
        }
    }
}
