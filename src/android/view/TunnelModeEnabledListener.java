...
public abstract class TunnelModeEnabledListener {
    ...
    public static void register(TunnelModeEnabledListener tunnelModeEnabledListener) {
        long j = tunnelModeEnabledListener.mNativeListener;
        if (j == 0) {
            return;
        }
        nativeRegister(j);
    ...
    public static void dispatchOnTunnelModeEnabledChanged(final TunnelModeEnabledListener tunnelModeEnabledListener, final boolean z) {
