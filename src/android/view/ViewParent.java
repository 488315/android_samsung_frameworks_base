...
public interface ViewParent {
    ...
    default OnBackInvokedDispatcher findOnBackInvokedDispatcherForChild(View view, View view2) {
        return null;
    }
    ...
    default void subtractObscuredTouchableRegion(Region region, View view) {
    }

    default void onDescendantInvalidated(View view, View view2) {
        if (getParent() != null) {
            getParent().onDescendantInvalidated(view, view2);
        }
    }

    default boolean getChildLocalHitRegion(View view, Region region, Matrix matrix, boolean z) {
        region.setEmpty();
        return false;
    }
    ...
    default void requestSendStickyDragStartedEvent(View view) {
        if (getParent() != null) {
            getParent().requestSendStickyDragStartedEvent(view);
        }
    }
}
