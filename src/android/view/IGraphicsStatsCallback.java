...
public interface IGraphicsStatsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGraphicsStatsCallback {
        ...
        public static IGraphicsStatsCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IGraphicsStatsCallback)) {
                return (IGraphicsStatsCallback) iInterfaceQueryLocalInterface;
            }
