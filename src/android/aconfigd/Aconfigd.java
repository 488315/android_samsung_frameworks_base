...
public final class Aconfigd {
    ...
    public final class PersistStorageRecord {
        ...
        public PersistStorageRecord(Aconfigd aconfigd) {
        }
    }
    ...
    public final class PersistStorageRecords {
        ...
        public PersistStorageRecords(Aconfigd aconfigd) {
        }
    }
    ...
    public final class FlagOverride {
        ...
        public FlagOverride(Aconfigd aconfigd) {
        }
    }
    ...
    public final class LocalFlagOverrides {
        ...
        public LocalFlagOverrides(Aconfigd aconfigd) {
        }
    }
    ...
    public final class StorageRequestMessage {
        ...
        public StorageRequestMessage(Aconfigd aconfigd) {
        }
        ...
        public final class NewStorageMessage {
            ...
            public NewStorageMessage(StorageRequestMessage storageRequestMessage) {
            }
        }
        ...
        public final class FlagOverrideMessage {
            ...
            public FlagOverrideMessage(StorageRequestMessage storageRequestMessage) {
            }
        }
        ...
        public final class OTAFlagStagingMessage {
            ...
            public OTAFlagStagingMessage(StorageRequestMessage storageRequestMessage) {
            }
        }
        ...
        public final class RemoveLocalOverrideMessage {
            ...
            public RemoveLocalOverrideMessage(StorageRequestMessage storageRequestMessage) {
            }
        }
        ...
        public final class FlagQueryMessage {
            ...
            public FlagQueryMessage(StorageRequestMessage storageRequestMessage) {
            }
        }
        ...
        public final class ResetStorageMessage {
            ...
            public ResetStorageMessage(StorageRequestMessage storageRequestMessage) {
            }
        }
        ...
        public final class ListStorageMessage {
            ...
            public ListStorageMessage(StorageRequestMessage storageRequestMessage) {
            }
        }
    }
    ...
    public final class StorageRequestMessages {
        ...
        public StorageRequestMessages(Aconfigd aconfigd) {
        }
    }
    ...
    public final class StorageReturnMessage {
        ...
        public StorageReturnMessage(Aconfigd aconfigd) {
        }

        public final class NewStorageReturnMessage {
            public static final long STORAGE_UPDATED = 1133871366145L;

            public NewStorageReturnMessage(StorageReturnMessage storageReturnMessage) {
            }
        }

        public final class FlagOverrideReturnMessage {
            public FlagOverrideReturnMessage(StorageReturnMessage storageReturnMessage) {
            }
        }

        public final class OTAFlagStagingReturnMessage {
            public OTAFlagStagingReturnMessage(StorageReturnMessage storageReturnMessage) {
            }
        }
        ...
        public final class FlagQueryReturnMessage {
            ...
            public FlagQueryReturnMessage(StorageReturnMessage storageReturnMessage) {
            }
        }

        public final class RemoveLocalOverrideReturnMessage {
            public RemoveLocalOverrideReturnMessage(StorageReturnMessage storageReturnMessage) {
            }
        }

        public final class ResetStorageReturnMessage {
            public ResetStorageReturnMessage(StorageReturnMessage storageReturnMessage) {
            }
        }
        ...
        public final class ListStorageReturnMessage {
            ...
            public ListStorageReturnMessage(StorageReturnMessage storageReturnMessage) {
            }
        }
    }
    ...
    public final class StorageReturnMessages {
        ...
        public StorageReturnMessages(Aconfigd aconfigd) {
        }
    }
}
