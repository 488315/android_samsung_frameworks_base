...
class SpeechRecognizerImpl extends SpeechRecognizer {
    ...
    SpeechRecognizerImpl(Context context, ComponentName componentName) {
        this(context, componentName, false);
    }

    SpeechRecognizerImpl(Context context, boolean z) {
        this(context, null, z);
    }

    private SpeechRecognizerImpl(Context context, ComponentName componentName, boolean z) {
        this.mHandler = new Handler(Looper.getMainLooper()) { // from class: android.speech.SpeechRecognizerImpl.1
            @Override // android.os.Handler
            public void handleMessage(Message message) {
                switch (message.what) {
                    case 1:
                        SpeechRecognizerImpl.this.handleStartListening((Intent) message.obj);
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        SpeechRecognizerImpl.this.handleChangeListener((RecognitionListener) message.obj);
                        break;
                    case 5:
                        SpeechRecognizerImpl.this.handleSetTemporaryComponent((ComponentName) message.obj);
                        break;
                    case 6:
                        CheckRecognitionSupportArgs checkRecognitionSupportArgs = (CheckRecognitionSupportArgs) message.obj;
                        SpeechRecognizerImpl.this.handleCheckRecognitionSupport(checkRecognitionSupportArgs.mIntent, checkRecognitionSupportArgs.mCallbackExecutor, checkRecognitionSupportArgs.mCallback);
                        break;
                    case 7:
                        ModelDownloadListenerArgs modelDownloadListenerArgs = (ModelDownloadListenerArgs) message.obj;
    ...
    public void checkRecognitionSupport(Intent intent, Executor executor, RecognitionSupportCallback recognitionSupportCallback) {
        ...
        Objects.requireNonNull(recognitionSupportCallback, "listener must not be null");
        if (this.mService == null) {
            connectToSystemService();
        }
    ...
    public void triggerModelDownload(Intent intent, Executor executor, ModelDownloadListener modelDownloadListener) {
        ...
        putMessage(Message.obtain(this.mHandler, 7, new ModelDownloadListenerArgs(intent, executor, modelDownloadListener)));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void handleCheckRecognitionSupport(Intent intent, Executor executor, final RecognitionSupportCallback recognitionSupportCallback) {
        if (maybeInitializeManagerService() && checkOpenConnection()) {
            try {
                this.mService.checkRecognitionSupport(intent, this.mContext.getAttributionSource(), new InternalSupportCallback(executor, recognitionSupportCallback));
            } catch (Exception e) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void handleTriggerModelDownload(Intent intent, Executor executor, final ModelDownloadListener modelDownloadListener) {
        if (maybeInitializeManagerService() && checkOpenConnection()) {
            ...
            try {
                this.mService.triggerModelDownload(intent, this.mContext.getAttributionSource(), new InternalModelDownloadListener(executor, modelDownloadListener));
            } catch (Exception e2) {
    ...
    private boolean checkOpenConnection() {
        ...
        if (iRecognitionService != null && iRecognitionService.asBinder().isBinderAlive()) {
            return true;
        }
        this.mListener.onError(5);
    ...
    private void connectToSystemService() {
        if (maybeInitializeManagerService()) {
            ...
            if (!z && speechRecognizerComponentName == null) {
                this.mListener.onError(5);
                return;
            }
            try {
                this.mManagerService.createSession(speechRecognizerComponentName, this.mClientToken, z, new IRecognitionServiceManagerCallback.Stub() { // from class: android.speech.SpeechRecognizerImpl.2
                    ...
                    public void onSuccess(IRecognitionService iRecognitionService) throws RemoteException {
                        SpeechRecognizerImpl.this.mService = iRecognitionService;
                    ...
                    public void onError(int i) throws RemoteException {
                        Log.e(SpeechRecognizerImpl.TAG, "Bind to system recognition service failed with error " + i);
                        SpeechRecognizerImpl.this.mListener.onError(i);
                    }
                });
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
    ...
    private static class CheckRecognitionSupportArgs {
        ...
        private CheckRecognitionSupportArgs(Intent intent, Executor executor, RecognitionSupportCallback recognitionSupportCallback) {
            this.mIntent = intent;
    ...
    private static class InternalRecognitionListener extends IRecognitionListener.Stub {
                ...
                public void handleMessage(Message message) {
                    ...
                    switch (message.what) {
                        case 1:
                            ...
                            break;
                        case 2:
                            InternalRecognitionListener.this.mInternalListener.onBufferReceived((byte[]) message.obj);
                            break;
                        case 3:
                            InternalRecognitionListener.this.mInternalListener.onEndOfSpeech();
                            break;
                        case 4:
                            InternalRecognitionListener.this.mInternalListener.onError(((Integer) message.obj).intValue());
                            break;
                        case 5:
                            InternalRecognitionListener.this.mInternalListener.onReadyForSpeech((Bundle) message.obj);
                            break;
                        case 6:
                            InternalRecognitionListener.this.mInternalListener.onResults((Bundle) message.obj);
                            break;
                        case 7:
                            InternalRecognitionListener.this.mInternalListener.onPartialResults((Bundle) message.obj);
                            break;
                        case 8:
                            InternalRecognitionListener.this.mInternalListener.onRmsChanged(((Float) message.obj).floatValue());
                            break;
                        case 9:
                            InternalRecognitionListener.this.mInternalListener.onEvent(message.arg1, (Bundle) message.obj);
                            break;
                        case 10:
                            InternalRecognitionListener.this.mInternalListener.onSegmentResults((Bundle) message.obj);
                            break;
                        case 11:
                            InternalRecognitionListener.this.mInternalListener.onEndOfSegmentedSession();
                            break;
                        case 12:
                            InternalRecognitionListener.this.mInternalListener.onLanguageDetection((Bundle) message.obj);
                            break;
                    }
                }
            };
        ...
        public void onLanguageDetection(Bundle bundle) {
            Message.obtain(this.mInternalHandler, 12, bundle).sendToTarget();
        }
    ...
    static class InternalSupportCallback extends IRecognitionSupportCallback.Stub {
        ...
        private InternalSupportCallback(Executor executor, RecognitionSupportCallback recognitionSupportCallback) {
            this.mExecutor = executor;
            this.mCallback = recognitionSupportCallback;
        }
