...
final class RippleShader extends RuntimeShader {
    ...
    public void setProgress(float f) {
        setFloatUniform(SearchManager.CURSOR_EXTRA_KEY_IN_PROGRESS, f);
    }

    public void setNoisePhase(float f) {
        setFloatUniform("in_noisePhase", 0.001f * f);
        setFloatUniform("in_turbulencePhase", f);
        double d = f;
        double d2 = 0.01d * d;
        setFloatUniform("in_tCircle1", (float) ((Math.cos(0.8250000000000001d) * d2) + 0.75d), (float) ((d2 * Math.sin(0.8250000000000001d)) + 0.75d));
        double d3 = (-0.0066d) * d;
        setFloatUniform("in_tCircle2", (float) ((Math.cos(0.675d) * d3) + 0.30000000000000004d), (float) ((Math.sin(0.675d) * d3) + 0.30000000000000004d));
        setFloatUniform("in_tCircle3", (float) ((Math.cos(0.5249999999999999d) * d3) + 1.5d), (float) ((d3 * Math.sin(0.5249999999999999d)) + 1.5d));
        double d4 = PI_ROTATE_RIGHT * d;
        double d5 = 5.340707511102648d + d4;
        setFloatUniform("in_tRotation1", (float) Math.cos(d5), (float) Math.sin(d5));
        double d6 = (d * PI_ROTATE_LEFT) + 6.283185307179586d;
        setFloatUniform("in_tRotation2", (float) Math.cos(d6), (float) Math.sin(d6));
        double d7 = d4 + 8.63937979737193d;
        setFloatUniform("in_tRotation3", (float) Math.cos(d7), (float) Math.sin(d7));
    }
