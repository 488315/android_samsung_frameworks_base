...
public final class VirtualAudioDevice implements Closeable {
    ...
    public VirtualAudioDevice(Context context, IVirtualDevice iVirtualDevice, VirtualDisplay virtualDisplay, Executor executor, AudioConfigurationChangeCallback audioConfigurationChangeCallback, CloseListener closeListener) {
