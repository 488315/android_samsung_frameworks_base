...
public class CertificatePolicyCache {
    ...
    private static CertificatePolicyCache sInstance;
    ...
    private CertificatePolicyCache(Context context) {
        ...
        context.registerReceiver(new BroadcastReceiver() { // from class: android.sec.enterprise.certificate.CertificatePolicyCache.1
            ...
            public void onReceive(Context context2, Intent intent) {
                if (CertificatePolicyCache.ACTION_CERTIFICATE_POLICY_CHANGED_INTERNAL.equals(intent.getAction())) {
                    Log.d(CertificatePolicyCache.TAG, "Intent received to refresh cache");
                    Bundle extras = intent.getExtras();
                    if (extras != null) {
                        CertificatePolicyCache.this.readVariables(extras.getString(CertificatePolicyCache.EXTRA_CERTIFICATE_POLICY_TYPE_CHANGED_INTERNAL));
                    } else {
