...
public interface IProxyCredentialsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IProxyCredentialsCallback {
        ...
        public static IProxyCredentialsCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IProxyCredentialsCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IProxyCredentialsCallback)) {
                return (IProxyCredentialsCallback) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements IProxyCredentialsCallback {
            ...
            public void onAuthenticationResult(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IProxyCredentialsCallback.DESCRIPTOR);
