...
public class EnterpriseExchangeAccount implements Parcelable {
    ...
    public static final Parcelable.Creator<EnterpriseExchangeAccount> CREATOR = new Parcelable.Creator<EnterpriseExchangeAccount>() { // from class: android.sec.enterprise.email.EnterpriseExchangeAccount.1
        ...
        public EnterpriseExchangeAccount createFromParcel(Parcel parcel) {
            return new EnterpriseExchangeAccount(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public EnterpriseExchangeAccount[] newArray(int i) {
            return new EnterpriseExchangeAccount[i];
        }
    };
    ...
    private EnterpriseExchangeAccount(Parcel parcel) {
    ...
    private void readFromParcel(Parcel parcel) {
        ...
        this.mAllowHTMLEmail = parcel.readInt() == 0;
        this.mMinDevicePasswordLength = parcel.readInt();
        ...
        this.mMaxDevicePasswordFailedAttempts = parcel.readInt();
    }
