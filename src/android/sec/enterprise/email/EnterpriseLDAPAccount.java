...
public class EnterpriseLDAPAccount implements Parcelable {
    ...
    public static final Parcelable.Creator<EnterpriseLDAPAccount> CREATOR = new Parcelable.Creator<EnterpriseLDAPAccount>() { // from class: android.sec.enterprise.email.EnterpriseLDAPAccount.1
        ...
        public EnterpriseLDAPAccount createFromParcel(Parcel parcel) {
            return new EnterpriseLDAPAccount(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public EnterpriseLDAPAccount[] newArray(int i) {
            return new EnterpriseLDAPAccount[i];
        }
    };
    ...
    public EnterpriseLDAPAccount(Parcel parcel) {
    ...
    private void readFromParcel(Parcel parcel) {
        ...
        this.mBaseDN = parcel.readString();
        this.mTrustAll = parcel.readInt();
    }
}
