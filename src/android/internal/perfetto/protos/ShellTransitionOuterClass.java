...
public final class ShellTransitionOuterClass {
    ...
    public final class ShellTransition {
        ...
        public ShellTransition(ShellTransitionOuterClass shellTransitionOuterClass) {
        }
        ...
        public final class Target {
            ...
            public Target(ShellTransition shellTransition) {
            }
        }
    }
    ...
    public final class ShellHandlerMappings {
        ...
        public ShellHandlerMappings(ShellTransitionOuterClass shellTransitionOuterClass) {
        }
    }
    ...
    public final class ShellHandlerMapping {
        ...
        public ShellHandlerMapping(ShellTransitionOuterClass shellTransitionOuterClass) {
        }
    }
}
