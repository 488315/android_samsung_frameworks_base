...
public final class Inputmethodeditor {
    ...
    public final class InputMethodClientsTraceProto {
        ...
        public InputMethodClientsTraceProto(Inputmethodeditor inputmethodeditor) {
        }
    ...
    public final class InputMethodServiceTraceProto {
        ...
        public InputMethodServiceTraceProto(Inputmethodeditor inputmethodeditor) {
        }
    }
    ...
    public final class InputMethodManagerServiceTraceProto {
        ...
        public InputMethodManagerServiceTraceProto(Inputmethodeditor inputmethodeditor) {
        }
    }
}
