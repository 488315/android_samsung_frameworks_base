...
public final class Protolog {
    ...
    public final class ProtoLogMessage {
        ...
        public ProtoLogMessage(Protolog protolog) {
        }
    }
    ...
    public final class ProtoLogViewerConfig {
        ...
        public ProtoLogViewerConfig(Protolog protolog) {
        }
        ...
        public final class MessageData {
            ...
            public MessageData(ProtoLogViewerConfig protoLogViewerConfig) {
            }
        }
        ...
        public final class Group {
            ...
            public Group(ProtoLogViewerConfig protoLogViewerConfig) {
            }
        }
    }
}
