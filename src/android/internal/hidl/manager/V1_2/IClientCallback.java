...
public interface IClientCallback extends IBase {
    ...
    static IClientCallback asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IClientCallback)) {
            return (IClientCallback) iHwInterfaceQueryLocalInterface;
        }
