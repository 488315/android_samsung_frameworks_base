...
public final class CalendarContract {
    ...
    public static boolean startViewCalendarEventInManagedProfile(Context context, long j, long j2, long j3, boolean z, int i) {
        Preconditions.checkNotNull(context, "Context is null");
        return ((DevicePolicyManager) context.getSystemService(Context.DEVICE_POLICY_SERVICE)).startViewCalendarEventInManagedProfile(j, j2, j3, z, i);
    }
