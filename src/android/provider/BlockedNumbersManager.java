...
public final class BlockedNumbersManager {
    ...
    public int shouldSystemBlockNumber(String str, int i, boolean z) {
        ...
        try {
            ...
            Bundle bundleCall = this.mContext.getContentResolver().call(BlockedNumberContract.AUTHORITY_URI, BlockedNumberContract.SystemContract.METHOD_SHOULD_SYSTEM_BLOCK_NUMBER, str, bundle);
            int i2 = bundleCall != null ? bundleCall.getInt(BlockedNumberContract.RES_BLOCK_STATUS, 0) : 0;
    ...
    public BlockSuppressionStatus getBlockSuppressionStatus() {
        verifyBlockedNumbersPermission();
        Bundle bundleCall = this.mContext.getContentResolver().call(BlockedNumberContract.AUTHORITY_URI, BlockedNumberContract.SystemContract.METHOD_GET_BLOCK_SUPPRESSION_STATUS, (String) null, (Bundle) null);
        BlockSuppressionStatus blockSuppressionStatus = new BlockSuppressionStatus(bundleCall.getBoolean(BlockedNumberContract.SystemContract.RES_IS_BLOCKING_SUPPRESSED, false), bundleCall.getLong(BlockedNumberContract.SystemContract.RES_BLOCKING_SUPPRESSED_UNTIL_TIMESTAMP, 0L));
    ...
    public boolean shouldShowEmergencyCallNotification() {
        verifyBlockedNumbersPermission();
        try {
            Bundle bundleCall = this.mContext.getContentResolver().call(BlockedNumberContract.AUTHORITY_URI, BlockedNumberContract.SystemContract.METHOD_SHOULD_SHOW_EMERGENCY_CALL_NOTIFICATION, (String) null, (Bundle) null);
            if (bundleCall != null) {
    ...
    public boolean getBlockedNumberSetting(String str) {
        ...
        try {
            Bundle bundleCall = this.mContext.getContentResolver().call(BlockedNumberContract.AUTHORITY_URI, BlockedNumberContract.SystemContract.METHOD_GET_ENHANCED_BLOCK_SETTING, (String) null, bundle);
            if (bundleCall != null) {
