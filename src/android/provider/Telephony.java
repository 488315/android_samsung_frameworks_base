...
public final class Telephony {
    ...
    public static final class Threads implements ThreadsColumns {
        ...
        public static long getOrCreateThreadId(Context context, Set<String> set, boolean z) {
            return getOrCreateThreadId(context, set, z, 0);
        }

        public static long getOrCreateThreadId(Context context, Set<String> set, boolean z, int i) {
            return semGetOrCreateThreadId(context, set, z, i, 0);
        }
    ...
    public static final class SimInfo {
        ...
        public static final String COLUMN_SATELLITE_ENTITLEMENT_BARRED_PLMNS = "satellite_entitlement_barred_plmns";
        public static final String COLUMN_SATELLITE_ENTITLEMENT_DATA_PLAN_PLMNS = "satellite_entitlement_data_plan_plmns";
        public static final String COLUMN_SATELLITE_ENTITLEMENT_DATA_SERVICE_POLICY = "satellite_entitlement_data_service_policy";
        public static final String COLUMN_SATELLITE_ENTITLEMENT_PLMNS = "satellite_entitlement_plmns";
        public static final String COLUMN_SATELLITE_ENTITLEMENT_SERVICE_TYPE_MAP = "satellite_entitlement_service_type_map";
        public static final String COLUMN_SATELLITE_ENTITLEMENT_STATUS = "satellite_entitlement_status";
        public static final String COLUMN_SATELLITE_ENTITLEMENT_VOICE_SERVICE_POLICY = "satellite_entitlement_voice_service_policy";
