...
public final class AutofillProtoEnums {
    ...
    public static final int REASON_DELAY_AFTER_ANIMATION_END = 6;
    public static final int REASON_FILL_DIALOG_DISABLED = 1;
    public static final int REASON_LAST_TRIGGERED_ID_CHANGED = 3;
    public static final int REASON_SCREEN_HAS_CREDMAN_FIELD = 2;
    public static final int REASON_TIMEOUT_AFTER_DELAY = 7;
    public static final int REASON_TIMEOUT_SINCE_IME_ANIMATED = 5;
    public static final int REASON_UNKNOWN = 0;
    public static final int REASON_WAIT_FOR_IME_ANIMATION = 4;
