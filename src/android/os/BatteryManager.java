...
public class BatteryManager {
    ...
    public static final int SEM_BATTERY_PROPERTY_CAPACITIES = 109;
    ...
    public long[] semGetValuesAsLong(int i) {
        ...
        try {
            return iBatteryPropertiesRegistrar.semGetValuesAsLong(i);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public String[] semGetValuesAsString(int i) {
        IBatteryPropertiesRegistrar iBatteryPropertiesRegistrar = this.mBatteryPropertiesRegistrar;
        if (iBatteryPropertiesRegistrar == null) {
            return null;
        }
        try {
            return iBatteryPropertiesRegistrar.semGetValuesAsString(i);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public boolean semGetValueAsBoolean(int i) {
        IBatteryPropertiesRegistrar iBatteryPropertiesRegistrar = this.mBatteryPropertiesRegistrar;
        if (iBatteryPropertiesRegistrar == null) {
            return false;
        }
        try {
            return iBatteryPropertiesRegistrar.semGetValueAsBoolean(i);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public SemCompanionDeviceBatteryInfo[] semGetDeviceBatteryInfos() throws SecurityException {
        try {
            return this.mBatteryStats.getDeviceBatteryInfos();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public SemCompanionDeviceBatteryInfo semGetDeviceBatteryInfo(String str) throws SecurityException {
        try {
            return this.mBatteryStats.getDeviceBatteryInfo(str);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public void semRegisterDeviceBatteryInfoChanged(String str) throws SecurityException {
        try {
            this.mBatteryStats.registerDeviceBatteryInfoChanged(str);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public void semUnRegisterDeviceBatteryInfoChanged(String str) throws SecurityException {
        try {
            this.mBatteryStats.unRegisterDeviceBatteryInfoChanged(str);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public void semSetDeviceBatteryInfo(String str, SemCompanionDeviceBatteryInfo semCompanionDeviceBatteryInfo) throws SecurityException {
        try {
            this.mBatteryStats.setDeviceBatteryInfo(str, semCompanionDeviceBatteryInfo);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public void semUnsetDeviceBatteryInfo(String str) throws SecurityException {
        try {
            this.mBatteryStats.unsetDeviceBatteryInfo(str);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
