...
public abstract class HwBinder implements IHwBinder {
    ...
    public static final IHwBinder getService(String str, String str2) throws RemoteException, NoSuchElementException {
        if (!HidlSupport.isHidlSupported() && (str.equals(android.internal.hidl.manager.V1_0.IServiceManager.kInterfaceName) || str.equals(android.internal.hidl.manager.V1_1.IServiceManager.kInterfaceName) || str.equals(android.internal.hidl.manager.V1_2.IServiceManager.kInterfaceName))) {
