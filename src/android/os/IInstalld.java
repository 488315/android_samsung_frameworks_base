        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 70:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean installSpegCacheToDalvikCache = installSpegCacheToDalvikCache(readString119, readInt76, readInt77, readString120);
                    parcel2.writeNoException();
                    parcel2.writeBoolean(installSpegCacheToDalvikCache);
                    return true;
                case 71:
                    String readString121 = parcel.readString();
                    boolean readBoolean5 = parcel.readBoolean();
                    parcel.enforceNoDataAvail();
                    compressFile(readString121, readBoolean5);
                    parcel2.writeNoException();
                    return true;
                case 72:
                    String readString122 = parcel.readString();
                    int readInt78 = parcel.readInt();
                    if (readInt78 > 1000000) {
                        throw new BadParcelableException("Array too large: " + readInt78);
                    }
                    long[] jArr = readInt78 < 0 ? null : new long[readInt78];
                    parcel.enforceNoDataAvail();
                    boolean compressedStats = getCompressedStats(readString122, jArr);
                    parcel2.writeNoException();
                ...
                case 73:
                    ...
                    parcel.enforceNoDataAvail();
                    scanApkStats(readString123, readInt79);
                    parcel2.writeNoException();
                    return true;
                default:
