...
public class SELinux {
    ...
    public static boolean restorecon_with_category(String str, int i) {
        return native_recursive_restorecon_with_category(str, i);
    }

    public static String getDomain(int i, String str, String str2, boolean z) throws NullPointerException {
        if (str2 == null || str == null) {
            throw null;
        }
        return getType(i, str, str2, z, true);
    }

    public static String getFileType(int i, String str, String str2, boolean z) throws NullPointerException {
        if (str2 == null || str == null) {
            throw null;
        }
        return getType(i, str, str2, z, false);
    }
}
