...
public final class ParcelableHolder implements Parcelable {
    ...
    public void setParcelable(Parcelable parcelable) {
        if (parcelable != null && getStability() > parcelable.getStability()) {
            throw new BadParcelableException("A ParcelableHolder can only hold things at its stability or higher. The ParcelableHolder's stability is " + getStability() + ", but the parcelable's stability is " + parcelable.getStability());
        }
