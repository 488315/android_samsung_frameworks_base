...
public final class BatteryUsageStatsAtomsProto {
    ...
    public final class BatteryConsumerData {
        ...
        public BatteryConsumerData(BatteryUsageStatsAtomsProto batteryUsageStatsAtomsProto) {
        }
        ...
        public final class PowerComponentUsage {
            ...
            public PowerComponentUsage(BatteryConsumerData batteryConsumerData) {
            }
        }
        ...
        public final class PowerComponentUsageSlice {
            ...
            public PowerComponentUsageSlice(BatteryConsumerData batteryConsumerData) {
            }
        }
    }
    ...
    public final class UidBatteryConsumer {
        ...
        public UidBatteryConsumer(BatteryUsageStatsAtomsProto batteryUsageStatsAtomsProto) {
        }
        ...
        public final class TimeInState {
            ...
            public TimeInState(UidBatteryConsumer uidBatteryConsumer) {
            }
        }
    }
    ...
    public final class PowerComponentModel {
        ...
        public PowerComponentModel(BatteryUsageStatsAtomsProto batteryUsageStatsAtomsProto) {
        }
    }
}
