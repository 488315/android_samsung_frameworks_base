...
public final class WallpaperThemeConstants {
    public static final String ACTION_CHECK_ON_APPLY = "com.samsung.android.shortcutbackupservice.colorthemevalidator.action.ACTION_CHECK_ON_APPLY";
    public static final String ACTION_CHECK_ON_APPLY_THEMEPARK = "com.samsung.android.shortcutbackupservice.colorthemevalidator.action.ACTION_CHECK_ON_APPLY_THEMEPARK";
    public static final String ACTION_CHECK_ON_BOOT = "com.samsung.android.shortcutbackupservice.colorthemevalidator.action.ACTION_CHECK_ON_BOOT";
    public static final String ACTION_CHECK_ON_PACKAGE_ADDED = "com.samsung.android.shortcutbackupservice.colorthemevalidator.action.ACTION_CHECK_ON_PACKAGE_ADDED";
    public static final String ACTION_VALIDATOR_IS_DONE = "com.samsung.android.shortcutbackupservice.colorthemevalidator.action.VALIDATOR_IS_DONE";
    public static final String COLOR_THEME_VALIDATOR_PACKAGE = "com.samsung.android.shortcutbackupservice";
    public static final String COLOR_THEME_VALIDATOR_SERVICE = "com.samsung.android.shortcutbackupservice.colorthemevalidator.ValidatorService";
    ...
    public static final String EXTRA_VALIDATE_SUCCESS = "VALIDATE_SUCCESS";
    ...
    public static final String LAST_PACKAGE_LIST_FILE = "last_package_list.txt";
    ...
    public static final int RES_METADATA_SESL = 18284660;
