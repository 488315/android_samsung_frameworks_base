...
public final class SamsungThemeConstants {
    ...
    public static final String CURRENT_SEC_APPICON_THEME_PACKAGE = "current_sec_appicon_theme_package";
    ...
    public static final String PATH_OVERLAY_REMAPS = "/data/overlays/remaps";
    ...
    public static ArrayList<String> nonAdaptiveIconPkgList = new ArrayList<>(Arrays.asList("com.sec.android.app.camera", "com.samsung.knox.securefolder", SemPersonaManager.APPSEPARATION_PACKAGE));
    ...
    public static final String[] CREATE_IDMAP_SPECIAL_TARGET = {"android", AsPackageName.SYSTEMUI, AODManager.AOD_PACKAGE_NAME, AsPackageName.ROUTINE, "com.android.settings"};
}
