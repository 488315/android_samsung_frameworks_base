...
public class ContentType {
    ...
    public static boolean isImageType(String str) {
        if (str != null) {
            return str.startsWith(MessagingMessage.IMAGE_MIME_TYPE_PREFIX) || sSupportedImageTypes.contains(str);
        }
        return false;
    }
    ...
    public static boolean isAudioType(String str) {
        if (str != null) {
            return str.startsWith("audio/") || sSupportedAudioTypes.contains(str);
        }
        return false;
    }
    ...
    public static boolean isVideoType(String str) {
        if (str != null) {
            return str.startsWith(BnRConstants.VIDEO_DIR_PATH) || sSupportedVideoTypes.contains(str);
        }
        return false;
    }
    ...
    public static boolean isDrmType(String str) {
        if (str != null) {
            return str.equals(APP_DRM_CONTENT) || str.equals("application/vnd.oma.drm.message") || str.equals(APP_DRM_RIGHTS_WBXML);
        }
        return false;
    }
