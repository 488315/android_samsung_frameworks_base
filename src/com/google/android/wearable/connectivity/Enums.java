...
public final class Enums {
    ...
    public static final int BLE_ACL = 1;
    public static final int BLE_COMMS = 4;
    public static final int BLUETOOTH_CONNECTION_CHANGE_UNKNOWN = 0;
    public static final int BTC = 2;
    public static final int BTC_ACL = 2;
    public static final int BTC_COMMS = 3;
    ...
    public static final int COMPANION_CONNECTION_CHANGE_UNKNOWN = 0;
    public static final int COMPANION_CONNECTION_TYPE_UNKNOWN = 0;
    ...
    public static final int IPTABLES_RULES_SETUP_FAILURE = 2;
    public static final int IPTABLES_RULES_SETUP_SUCCESS = 1;
    public static final int IPTABLES_RULES_TEARDOWN_FAILURE = 4;
    public static final int IPTABLES_RULES_TEARDOWN_SUCCESS = 3;
    ...
    public static final int ON_MODE_MANAGER = 53;
    ...
    public static final int PROXY_ON_SOCKET_SWITCH = 30;
    ...
    public static final int SERVICE_IPTABLES_RECOVERY_ATTEMPTED = 3;
    public static final int SERVICE_SHUTDOWN_FINISHED = 2;
    public static final int SERVICE_STARTUP_FINISHED = 1;
    public static final int SERVICE_STOP_ARG_COUNT_INVALID = 19;
    public static final int SERVICE_STOP_ARG_PROTO_DECODE_FAILED = 21;
    public static final int SERVICE_STOP_ARG_VERSION_INVALID = 20;
    public static final int SERVICE_STOP_BT_DATA_CORRUPTED = 31;
    public static final int SERVICE_STOP_BT_HANDSHAKE_ERR = 28;
    public static final int SERVICE_STOP_BT_READ_EMPTY = 27;
    public static final int SERVICE_STOP_BT_READ_ERR = 26;
    public static final int SERVICE_STOP_BT_UNABLE_TO_DRAIN_WRITE_BUFFER = 24;
    public static final int SERVICE_STOP_BT_WRITE_TIMEOUT = 25;
    public static final int SERVICE_STOP_COMPANION_SHARD_REQUEST = 14;
    public static final int SERVICE_STOP_CONNECT_FAILED = 15;
    public static final int SERVICE_STOP_CREATE_CONTROL_PORT_FAILED = 16;
    public static final int SERVICE_STOP_CREATE_TCP_PORT_FAILED = 17;
    public static final int SERVICE_STOP_CREATE_UDP_PORT_FAILED = 18;
    public static final int SERVICE_STOP_REACTOR_START_FAILED = 23;
    public static final int SERVICE_STOP_SELF_TERM_REASON_UNKNOWN = 22;
    public static final int SERVICE_STOP_STOP_BY_CONTROL_SERVER = 29;
    ...
    public static final int SYSPROXY_CONNECT_NATIVE_SERVICE_FAILED = 3;
    public static final int SYSPROXY_CONNECT_NATIVE_SERVICE_TIMEOUT = 4;
    public static final int SYSPROXY_DISCONNECTED = 2;
    public static final int SYSPROXY_IPTABLES_STATE_UNKNOWN = 0;
    public static final int SYSPROXY_SERVICE_STATE_UNKNOWN = 0;
    public static final int SYSPROXY_TRANSPORT_TYPE_UNKNOWN = 0;
