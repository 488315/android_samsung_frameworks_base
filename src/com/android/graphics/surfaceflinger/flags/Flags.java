...
public final class Flags {
    ...
    public static final String FLAG_ADPF_FMQ_SF = "com.android.graphics.surfaceflinger.flags.adpf_fmq_sf";
    public static final String FLAG_ADPF_GPU_SF = "com.android.graphics.surfaceflinger.flags.adpf_gpu_sf";
    public static final String FLAG_ADPF_NATIVE_SESSION_MANAGER = "com.android.graphics.surfaceflinger.flags.adpf_native_session_manager";
    ...
    public static final String FLAG_ARR_SETFRAMERATE_GTE_ENUM = "com.android.graphics.surfaceflinger.flags.arr_setframerate_gte_enum";
    ...
    public static final String FLAG_BEGONE_BRIGHT_HLG = "com.android.graphics.surfaceflinger.flags.begone_bright_hlg";
    ...
    public static final String FLAG_CONNECTED_DISPLAY_HDR = "com.android.graphics.surfaceflinger.flags.connected_display_hdr";
    public static final String FLAG_CORRECT_DPI_WITH_DISPLAY_SIZE = "com.android.graphics.surfaceflinger.flags.correct_dpi_with_display_size";
    public static final String FLAG_DEPRECATE_FRAME_TRACKER = "com.android.graphics.surfaceflinger.flags.deprecate_frame_tracker";
    ...
    public static final String FLAG_DISPLAY_CONFIG_ERROR_HAL = "com.android.graphics.surfaceflinger.flags.display_config_error_hal";
    ...
    public static final String FLAG_FILTER_FRAMES_BEFORE_TRACE_STARTS = "com.android.graphics.surfaceflinger.flags.filter_frames_before_trace_starts";
    ...
    public static final String FLAG_GRAPHITE_RENDERENGINE_PREVIEW_ROLLOUT = "com.android.graphics.surfaceflinger.flags.graphite_renderengine_preview_rollout";
    public static final String FLAG_HDCP_LEVEL_HAL = "com.android.graphics.surfaceflinger.flags.hdcp_level_hal";
    public static final String FLAG_HDCP_NEGOTIATION = "com.android.graphics.surfaceflinger.flags.hdcp_negotiation";
    public static final String FLAG_HOTPLUG2 = "com.android.graphics.surfaceflinger.flags.hotplug2";
    public static final String FLAG_INCREASE_MISSED_FRAME_JANK_THRESHOLD = "com.android.graphics.surfaceflinger.flags.increase_missed_frame_jank_threshold";
    ...
    public static final String FLAG_MONITOR_BUFFER_FENCES = "com.android.graphics.surfaceflinger.flags.monitor_buffer_fences";
    public static final String FLAG_MULTITHREADED_PRESENT = "com.android.graphics.surfaceflinger.flags.multithreaded_present";
    public static final String FLAG_NO_VSYNCS_ON_SCREEN_OFF = "com.android.graphics.surfaceflinger.flags.no_vsyncs_on_screen_off";
    ...
    public static final String FLAG_REJECT_DUPE_LAYERSTACKS = "com.android.graphics.surfaceflinger.flags.reject_dupe_layerstacks";
    ...
    public static final String FLAG_VIEW_SET_REQUESTED_FRAME_RATE_MRR = "com.android.graphics.surfaceflinger.flags.view_set_requested_frame_rate_mrr";
    ...
    public static final String FLAG_VSYNC_PREDICTOR_RECOVERY = "com.android.graphics.surfaceflinger.flags.vsync_predictor_recovery";
    public static final String FLAG_VULKAN_RENDERENGINE = "com.android.graphics.surfaceflinger.flags.vulkan_renderengine";
    public static final String FLAG_WINDOW_BLUR_KAWASE2 = "com.android.graphics.surfaceflinger.flags.window_blur_kawase2";

    public static boolean addSfSkippedFramesToTrace() {
        return FEATURE_FLAGS.addSfSkippedFramesToTrace();
    }

    public static boolean adpfFmqSf() {
        return FEATURE_FLAGS.adpfFmqSf();
    }
    ...
    public static boolean adpfNativeSessionManager() {
        return FEATURE_FLAGS.adpfNativeSessionManager();
    }
    ...
    public static boolean arrSetframerateGteEnum() {
        return FEATURE_FLAGS.arrSetframerateGteEnum();
    }
    ...
    public static boolean begoneBrightHlg() {
        return FEATURE_FLAGS.begoneBrightHlg();
    }
    ...
    public static boolean connectedDisplayHdr() {
        return FEATURE_FLAGS.connectedDisplayHdr();
    }

    public static boolean correctDpiWithDisplaySize() {
        return FEATURE_FLAGS.correctDpiWithDisplaySize();
    }

    public static boolean deprecateFrameTracker() {
        return FEATURE_FLAGS.deprecateFrameTracker();
    }
    ...
    public static boolean displayConfigErrorHal() {
        return FEATURE_FLAGS.displayConfigErrorHal();
    }
    ...
    public static boolean filterFramesBeforeTraceStarts() {
        return FEATURE_FLAGS.filterFramesBeforeTraceStarts();
    }
    ...
    public static boolean graphiteRenderenginePreviewRollout() {
        return FEATURE_FLAGS.graphiteRenderenginePreviewRollout();
    }
    ...
    public static boolean hdcpNegotiation() {
        return FEATURE_FLAGS.hdcpNegotiation();
    }
    ...
    public static boolean increaseMissedFrameJankThreshold() {
        return FEATURE_FLAGS.increaseMissedFrameJankThreshold();
    }
    ...
    public static boolean monitorBufferFences() {
        return FEATURE_FLAGS.monitorBufferFences();
    }
    ...
    public static boolean noVsyncsOnScreenOff() {
        return FEATURE_FLAGS.noVsyncsOnScreenOff();
    }
    ...
    public static boolean rejectDupeLayerstacks() {
        return FEATURE_FLAGS.rejectDupeLayerstacks();
    }
    ...
    public static boolean skipInvisibleWindowsInInput() {
        return FEATURE_FLAGS.skipInvisibleWindowsInInput();
    }
    ...
    public static boolean syncedResolutionSwitch() {
        return FEATURE_FLAGS.syncedResolutionSwitch();
    }

    public static boolean trueHdrScreenshots() {
        return FEATURE_FLAGS.trueHdrScreenshots();
    }
    ...
    public static boolean viewSetRequestedFrameRateMrr() {
        return FEATURE_FLAGS.viewSetRequestedFrameRateMrr();
    }
    ...
    public static boolean vsyncPredictorRecovery() {
        return FEATURE_FLAGS.vsyncPredictorRecovery();
    }
    ...
    public static boolean windowBlurKawase2() {
        return FEATURE_FLAGS.windowBlurKawase2();
    }
}
