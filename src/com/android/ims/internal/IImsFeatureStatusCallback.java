...
public interface IImsFeatureStatusCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsFeatureStatusCallback {
        ...
        public static IImsFeatureStatusCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IImsFeatureStatusCallback)) {
                return (IImsFeatureStatusCallback) iInterfaceQueryLocalInterface;
            }
