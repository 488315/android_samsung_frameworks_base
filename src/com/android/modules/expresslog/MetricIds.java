...
public final class MetricIds {
    ...
    static {
        ArrayMap<String, MetricInfo> arrayMap = new ArrayMap<>();
        metricIds = arrayMap;
        arrayMap.put("accessibility.value_fab_shortcut_dismiss", new MetricInfo(-6072243364828125290L, 1));
        metricIds.put("accessibility.value_fab_shortcut_edit", new MetricInfo(4192923649436966820L, 1));
        metricIds.put("accessibility.value_full_triple_tap_first_interval", new MetricInfo(-5769223201630976113L, 2));
        metricIds.put("accessibility.value_full_triple_tap_second_interval", new MetricInfo(2036667908499563164L, 2));
        metricIds.put("accessibility.value_hct_notification_dismissed", new MetricInfo(-1412632256886419037L, 1));
        metricIds.put("accessibility.value_hct_notification_opened_settings", new MetricInfo(3711937801790773082L, 1));
        metricIds.put("accessibility.value_hct_notification_posted", new MetricInfo(-6049469170867253673L, 1));
        ...
        metricIds.put("biometric.value_biometric_scheduler_operation_state_error_count", new MetricInfo(-6181982654674033194L, 1));
        metricIds.put("biometric.value_scheduler_watchdog_triggered_count", new MetricInfo(-8949614549819407840L, 1));
        metricIds.put("bluetooth.value_aac_codec_usage_over_a2dp", new MetricInfo(5658375456408090581L, 1));
        metricIds.put("bluetooth.value_aptx_codec_usage_over_a2dp", new MetricInfo(-6068649430110206491L, 1));
        metricIds.put("bluetooth.value_aptx_codec_usage_over_hfp", new MetricInfo(7003564244080163944L, 1));
        metricIds.put("bluetooth.value_aptx_hd_codec_usage_over_a2dp", new MetricInfo(2026975900410694785L, 1));
        ...
        metricIds.put("bluetooth.value_ldac_codec_usage_over_a2dp", new MetricInfo(6570389444115753749L, 1));
        metricIds.put("bluetooth.value_msbc_codec_usage_over_hfp", new MetricInfo(-3563813040444045278L, 1));
        metricIds.put("bluetooth.value_opus_codec_usage_over_a2dp", new MetricInfo(-7449268747154765910L, 1));
        metricIds.put("bluetooth.value_sbc_codec_usage_over_a2dp", new MetricInfo(-6723572027743435796L, 1));
        metricIds.put("bluetooth.value_shutdown_latency", new MetricInfo(8011357163887109173L, 2));
        metricIds.put("content_capture.value_content_capture_wrong_thread_count", new MetricInfo(-2722617273353133449L, 1));
        metricIds.put("core_networking.value_httpengine_preload_attempt_count", new MetricInfo(-1128365609590675471L, 1));
        metricIds.put("core_networking.value_nud_failure_ignored", new MetricInfo(-7303261864432545587L, 1));
        metricIds.put("core_networking.value_nud_failure_queried", new MetricInfo(887128944902165548L, 1));
        ...
        metricIds.put("input.value_rotary_input_device_full_rotation_count", new MetricInfo(-2118077315965764430L, 1));
        metricIds.put("intents.value_explicit_uri_grant_for_image_capture_action", new MetricInfo(7354394163045472330L, 1));
        metricIds.put("intents.value_explicit_uri_grant_for_send_action", new MetricInfo(-903477753418072438L, 1));
        metricIds.put("intents.value_explicit_uri_grant_for_send_multiple_action", new MetricInfo(-4527536272976715492L, 1));
        ...
        metricIds.put("media_audio.value_audio_focus_gain_appops_denial", new MetricInfo(729127605268875991L, 3));
        metricIds.put("media_audio.value_audio_focus_gain_granted", new MetricInfo(-3733444148686340753L, 3));
        metricIds.put("media_audio.value_audio_focus_gain_transient_appops_denial", new MetricInfo(-464308720680927150L, 3));
        metricIds.put("media_audio.value_audio_focus_gain_transient_duck_appops_denial", new MetricInfo(-2000005977607407796L, 3));
        metricIds.put("media_audio.value_audio_focus_gain_transient_duck_granted", new MetricInfo(7231741203015321508L, 3));
        metricIds.put("media_audio.value_audio_focus_gain_transient_excl_appops_denial", new MetricInfo(5305799243373862024L, 3));
        metricIds.put("media_audio.value_audio_focus_gain_transient_excl_granted", new MetricInfo(1802668179972962784L, 3));
        metricIds.put("media_audio.value_audio_focus_gain_transient_granted", new MetricInfo(-5849628684548255365L, 3));
        metricIds.put("media_audio.value_audio_focus_grant_hardening_waived_by_sdk", new MetricInfo(-5543591710589068278L, 3));
        metricIds.put("media_audio.value_audio_playback_hardening_partial_restriction", new MetricInfo(3891947970397803994L, 3));
        metricIds.put("media_audio.value_audio_playback_hardening_strict_would_restrict", new MetricInfo(-2377218628165009393L, 3));
        metricIds.put("media_audio.value_audio_volume_hardening_allowed", new MetricInfo(-2339614820538485358L, 3));
        metricIds.put("media_audio.value_audio_volume_hardening_partial_restriction", new MetricInfo(5191211262850412923L, 3));
        metricIds.put("media_audio.value_audio_volume_hardening_strict_restriction", new MetricInfo(-7273314886844574175L, 3));
        metricIds.put("notifications.value_client_throttled_cancel_duplicate", new MetricInfo(6335376951243121478L, 3));
        metricIds.put("notifications.value_client_throttled_notify_update", new MetricInfo(-4527886356097752985L, 3));
        ...
        metricIds.put("vibrator.value_vibration_vendor_effect_requests", new MetricInfo(-6316400877903829348L, 3));
        metricIds.put("vibrator.value_vibration_vendor_effect_size", new MetricInfo(-5213776178362596313L, 4));
        metricIds.put("vibrator.value_vibration_vendor_session_interrupted", new MetricInfo(-739334411738181396L, 3));
        metricIds.put("vibrator.value_vibration_vendor_session_started", new MetricInfo(-5704517339245666598L, 3));
        metricIds.put("vibrator.value_vibration_vendor_session_vibrations", new MetricInfo(1583216589797227976L, 4));
        ...
        metricIds.put("virtual_devices.value_virtual_rotary_created_count", new MetricInfo(-8081505614155849697L, 3));
        ...
        metricIds.put("wear_frameworks.value_power_key_down_count", new MetricInfo(5531897575276512375L, 1));
        metricIds.put("wear_frameworks.value_stem_primary_key_down_count", new MetricInfo(6859426801987084769L, 1));
        metricIds.put("wear_notifications.value_hist_image_asset_open_latency", new MetricInfo(8781758719844294982L, 2));
        metricIds.put("wear_notifications.value_local_notification_orphan_candidates", new MetricInfo(-8941103521763827342L, 3));
        metricIds.put("wear_notifications.value_local_notification_orphans", new MetricInfo(7461818763025853260L, 3));
        metricIds.put("wear_notifications.value_local_notification_widow_candidates", new MetricInfo(-8192080907514237458L, 3));
        metricIds.put("wear_notifications.value_local_notification_widows", new MetricInfo(-3733683602254064473L, 3));
        metricIds.put("wear_notifications.value_notification_unhide", new MetricInfo(-4634188146636322553L, 3));
        metricIds.put("wear_notifications.value_notification_unhide_from_blocked", new MetricInfo(5929021748425133061L, 3));
        metricIds.put("wear_notifications.value_notification_unhide_from_dismissed", new MetricInfo(5839855729078863857L, 3));
        metricIds.put("wear_notifications.value_notification_unhide_from_filtered", new MetricInfo(4451017006058195950L, 3));
    ...
    static long getMetricIdHash(String str, int i) {
        MetricInfo metricInfo = metricIds.get(str);
        if (metricInfo == null || metricInfo.mType != i) {
            return 0L;
        }
