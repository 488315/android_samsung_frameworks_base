...
public final class BlobStatsEventProto {
    ...
    public final class BlobCommitterProto {
        ...
        public BlobCommitterProto(BlobStatsEventProto blobStatsEventProto) {
        }
    }
    ...
    public final class BlobLeaseeProto {
        ...
        public BlobLeaseeProto(BlobStatsEventProto blobStatsEventProto) {
        }
    }
    ...
    public final class BlobCommitterListProto {
        ...
        public BlobCommitterListProto(BlobStatsEventProto blobStatsEventProto) {
        }
    }
    ...
    public final class BlobLeaseeListProto {
        ...
        public BlobLeaseeListProto(BlobStatsEventProto blobStatsEventProto) {
        }
    }
}
