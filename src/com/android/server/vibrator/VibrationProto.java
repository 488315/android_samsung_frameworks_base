...
public final class VibrationProto {
    ...
    public static final int CANCELLED_ACH_NON_REPEATED = 32;
    public static final int CANCELLED_ACH_REPEATED = 31;
    public static final int CANCELLED_BINDER_DIED = 5;
    public static final int CANCELLED_BY_APP_OPS = 29;
    public static final int CANCELLED_BY_DISABLED_NOTIFICATION = 34;
    public static final int CANCELLED_BY_FOREGROUND_USER = 30;
    ...
    public static final int CANCELLED_SERVICE_RECOVERED = 33;
