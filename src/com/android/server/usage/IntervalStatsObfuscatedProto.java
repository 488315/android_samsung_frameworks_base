...
public final class IntervalStatsObfuscatedProto {
    ...
    public final class CountAndTime {
        ...
        public CountAndTime(IntervalStatsObfuscatedProto intervalStatsObfuscatedProto) {
        }
    }
    ...
    public final class Configuration {
        ...
        public Configuration(IntervalStatsObfuscatedProto intervalStatsObfuscatedProto) {
        }
    }
    ...
    public final class PackageUsage {
        ...
        public PackageUsage(IntervalStatsObfuscatedProto intervalStatsObfuscatedProto) {
        }
    }
}
