...
public final class Flags {
    ...
    public static final String FLAG_ENABLE_METRICS_SETTINGS_BACKUP_AGENTS = "com.android.server.backup.enable_metrics_settings_backup_agents";
    ...
    public static final String FLAG_ENABLE_READ_ALL_EXTERNAL_STORAGE_FILES = "com.android.server.backup.enable_read_all_external_storage_files";
    public static final String FLAG_ENABLE_RESTRICTED_MODE_CHANGES = "com.android.server.backup.enable_restricted_mode_changes";
    ...
    public static boolean enableMetricsSettingsBackupAgents() {
        return FEATURE_FLAGS.enableMetricsSettingsBackupAgents();
    }
    ...
    public static boolean enableReadAllExternalStorageFiles() {
        return FEATURE_FLAGS.enableReadAllExternalStorageFiles();
    }

    public static boolean enableRestrictedModeChanges() {
        return FEATURE_FLAGS.enableRestrictedModeChanges();
    }
