...
public final class AppErrorsProto {
    ...
    public final class ProcessCrashTime {
        ...
        public ProcessCrashTime(AppErrorsProto appErrorsProto) {
        }
        ...
        public final class Entry {
            ...
            public Entry(ProcessCrashTime processCrashTime) {
            }
        }
    }
    ...
    public final class BadProcess {
        ...
        public BadProcess(AppErrorsProto appErrorsProto) {
        }
        ...
        public final class Entry {
            ...
            public Entry(BadProcess badProcess) {
            }
        }
    }
}
