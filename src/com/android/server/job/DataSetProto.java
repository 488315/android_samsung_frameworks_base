...
public final class DataSetProto {
    ...
    public final class PackageEntryProto {
        ...
        public PackageEntryProto(DataSetProto dataSetProto) {
        }
        ...
        public final class State {
            ...
            public State(PackageEntryProto packageEntryProto) {
            }
        }
        ...
        public final class StopReasonCount {
            ...
            public StopReasonCount(PackageEntryProto packageEntryProto) {
            }
        }
    }
}
