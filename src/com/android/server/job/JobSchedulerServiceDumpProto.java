...
public final class JobSchedulerServiceDumpProto {
    ...
    public final class JobRestriction {
        ...
        public JobRestriction(JobSchedulerServiceDumpProto jobSchedulerServiceDumpProto) {
        }
    }
    ...
    public final class RegisteredJob {
        ...
        public RegisteredJob(JobSchedulerServiceDumpProto jobSchedulerServiceDumpProto) {
        }
    }
    ...
    public final class PriorityOverride {
        ...
        public PriorityOverride(JobSchedulerServiceDumpProto jobSchedulerServiceDumpProto) {
        }
    }
    ...
    public final class PendingJob {
        ...
        public PendingJob(JobSchedulerServiceDumpProto jobSchedulerServiceDumpProto) {
        }
    }
    ...
    public final class ActiveJob {
        ...
        public ActiveJob(JobSchedulerServiceDumpProto jobSchedulerServiceDumpProto) {
        }
        ...
        public final class InactiveJob {
            ...
            public InactiveJob(ActiveJob activeJob) {
            }
        }
        ...
        public final class RunningJob {
            ...
            public RunningJob(ActiveJob activeJob) {
            }
        }
    }
}
