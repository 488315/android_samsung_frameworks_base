        ...
        */
        final int partialIsValidUtf8Default(int i, ByteBuffer byteBuffer, int i2, int i3) {
            ...
            if (i != 0) {
                ...
                if (b5 <= -65 && (((b2 << SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEIN) + (b5 + SprAttributeBase.TYPE_SHADOW)) >> 30) == 0 && b <= -65) {
                    i2 = i4 + 1;
                }
                return -1;
                i2 = i5;
        ...
        int encodeUtf8(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            while (i6 < length) {
                ...
                if (cCharAt2 < 128 && i7 < i5) {
                    ...
                    int i8 = i7 + 1;
                    bArr[i7] = (byte) ((cCharAt2 >>> 6) | EncodeConstants.Resolution.MM_360_EXPORT_HEIGHT_960);
                    i7 += 2;
        ...
        */
        int partialIsValidUtf8(int i, byte[] bArr, int i2, int i3) {
            ...
            if (i != 0) {
                ...
                if (b4 <= -65 && (((b2 << SprAnimatorBase.INTERPOLATOR_TYPE_QUADEASEIN) + (b4 + SprAttributeBase.TYPE_SHADOW)) >> 30) == 0 && b <= -65) {
                    j = j2 + 1;
                }
                return -1;
                j2 = j;
        ...
        int encodeUtf8(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            while (i4 < length) {
                ...
                if (cCharAt2 < 128 && j4 < j5) {
                    ...
                    j2 = j;
                    long j8 = j4 + j2;
                    UnsafeUtil.putByte(bArr, j4, (byte) ((cCharAt2 >>> 6) | EncodeConstants.Resolution.MM_360_EXPORT_HEIGHT_960));
                    j4 += 2;
            ...
            while (i2 < length) {
                ...
                if (cCharAt2 >= c || jPosition >= jLimit) {
                    ...
                    if (cCharAt2 < 2048 && jPosition <= jLimit - 2) {
                        ...
                        UnsafeUtil.putByte(jPosition, (byte) ((cCharAt2 >>> 6) | EncodeConstants.Resolution.MM_360_EXPORT_HEIGHT_960));
                        jPosition += 2;
