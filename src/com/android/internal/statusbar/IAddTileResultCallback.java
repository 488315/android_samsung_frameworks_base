...
public interface IAddTileResultCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAddTileResultCallback {
        ...
        public static IAddTileResultCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IAddTileResultCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IAddTileResultCallback)) {
                return (IAddTileResultCallback) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements IAddTileResultCallback {
            ...
            public void onTileRequest(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IAddTileResultCallback.DESCRIPTOR);
