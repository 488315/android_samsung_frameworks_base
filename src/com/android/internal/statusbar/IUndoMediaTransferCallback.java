...
public interface IUndoMediaTransferCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUndoMediaTransferCallback {
        ...
        public static IUndoMediaTransferCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IUndoMediaTransferCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IUndoMediaTransferCallback)) {
                return (IUndoMediaTransferCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IUndoMediaTransferCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IUndoMediaTransferCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
                onUndoTriggered();
        ...
        private static class Proxy implements IUndoMediaTransferCallback {
            ...
            public void onUndoTriggered() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IUndoMediaTransferCallback.DESCRIPTOR);
