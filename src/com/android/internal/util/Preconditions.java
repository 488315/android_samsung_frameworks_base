...
public class Preconditions {
    ...
    public static float[] checkArrayElementsInRange(float[] fArr, float f, float f2, String str) {
        ...
        for (int i = 0; i < fArr.length; i++) {
            ...
            if (f3 < f) {
                throw new IllegalArgumentException(String.format("%s[%d]: %f is out of range of [%f, %f] (too low)", str, Integer.valueOf(i), Float.valueOf(f3), Float.valueOf(f), Float.valueOf(f2)));
            }
            if (f3 > f2) {
                throw new IllegalArgumentException(String.format("%s[%d]: %f is out of range of [%f, %f] (too high)", str, Integer.valueOf(i), Float.valueOf(f3), Float.valueOf(f), Float.valueOf(f2)));
            }
        }
        return fArr;
    }
    ...
    public static int[] checkArrayElementsInRange(int[] iArr, int i, int i2, String str) {
        ...
        for (int i3 = 0; i3 < iArr.length; i3++) {
            int i4 = iArr[i3];
            if (i4 < i) {
                throw new IllegalArgumentException(String.format("%s[%d]: %d is out of range of [%d, %d] (too low)", str, Integer.valueOf(i4), Integer.valueOf(i3), Integer.valueOf(i), Integer.valueOf(i2)));
            }
            if (i4 > i2) {
                throw new IllegalArgumentException(String.format("%s[%d]: %d is out of range of [%d, %d] (too high)", str, Integer.valueOf(i4), Integer.valueOf(i3), Integer.valueOf(i), Integer.valueOf(i2)));
            }
        }
        return iArr;
    }
