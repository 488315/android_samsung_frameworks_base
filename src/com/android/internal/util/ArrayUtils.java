...
public class ArrayUtils {
    ...
    public static byte[] newNonMovableByteArray(int i) {
        return (byte[]) VMRuntime.getRuntime().newNonMovableArray(Byte.TYPE, i);
    }

    public static char[] newNonMovableCharArray(int i) {
        return (char[]) VMRuntime.getRuntime().newNonMovableArray(Character.TYPE, i);
    }
    ...
    public static boolean[] appendBooleanDuplicatesAllowed(boolean[] zArr, boolean z) {
        if (zArr == null) {
