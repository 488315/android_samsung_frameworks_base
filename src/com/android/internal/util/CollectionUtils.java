...
public class CollectionUtils {
    ...
    public static <T> List<T> copyOf(List<T> list) {
        return isEmpty(list) ? Collections.EMPTY_LIST : new ArrayList(list);
    }

    public static <T> Set<T> copyOf(Set<T> set) {
        return isEmpty(set) ? Collections.EMPTY_SET : new ArraySet(set);
    }

    public static <T> Set<T> toSet(Collection<T> collection) {
        return isEmpty((Collection<?>) collection) ? Collections.EMPTY_SET : new ArraySet(collection);
    }
    ...
    public static <T> List<T> singletonOrEmpty(T t) {
        return t == null ? Collections.EMPTY_LIST : Collections.singletonList(t);
    }
}
