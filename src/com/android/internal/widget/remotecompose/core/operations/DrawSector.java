...
public class DrawSector extends DrawBase6 {
    ...
    private static final int OP_CODE = 52;
    ...
    public static void read(WireBuffer wireBuffer, List<Operation> list) {
        read(new DrawBase6.Maker() { // from class: com.android.internal.widget.remotecompose.core.operations.DrawSector$$ExternalSyntheticLambda0
            ...
            public final DrawBase6 create(float f, float f2, float f3, float f4, float f5, float f6) {
                return new DrawSector(f, f2, f3, f4, f5, f6);
            }
        }, wireBuffer, list);
    }
    ...
    public static void documentation(DocumentationBuilder documentationBuilder) {
        documentationBuilder.operation("Canvas Operations", 52, CLASS_NAME).description("Draw the specified sector (pie shape)which will be scaled to fit inside the specified oval").field(1, "left", "The left side of the Oval").field(1, GenerateXML.TOP, "The top of the Oval").field(1, "right", "The right side of the Oval").field(1, GenerateXML.BOTTOM, "The bottom of the Oval").field(1, "startAngle", "Starting angle (in degrees) where the arc begins").field(1, "sweepAngle", "Sweep angle (in degrees) measured clockwise");
    }

    public DrawSector(float f, float f2, float f3, float f4, float f5, float f6) {
    ...
    public void paint(PaintContext paintContext) {
        paintContext.drawSector(this.mV1, this.mV2, this.mV3, this.mV4, this.mV5, this.mV6);
    }
