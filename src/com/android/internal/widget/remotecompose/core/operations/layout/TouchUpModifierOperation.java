...
public class TouchUpModifierOperation extends ListActionsOperation implements TouchHandler {
    private static final int OP_CODE = 220;
    ...
    public static void apply(WireBuffer wireBuffer) {
        wireBuffer.start(220);
    }

    public static void read(WireBuffer wireBuffer, List<Operation> list) {
        list.add(new TouchUpModifierOperation());
    }

    public static void documentation(DocumentationBuilder documentationBuilder) {
        documentationBuilder.operation("Modifier Operations", 220, name()).description("Touch up modifier. This operation contains a list of action executed on Touch up");
    }
    ...
    public void serialize(MapSerializer mapSerializer) {
        ...
        mapSerializer.addType("TouchUpModifierOperation");
    }
}
