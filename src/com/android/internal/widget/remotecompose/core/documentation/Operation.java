...
public class Operation {
    ...
    public Operation(String str, int i, String str2, boolean z) {
    ...
    public Operation field(int i, String str, String str2) {
        this.mFields.add(new OperationField(i, str, str2));
        return this;
    }

    public Operation field(int i, String str, String str2, String str3) {
        this.mFields.add(new OperationField(i, str, str2, str3));
        return this;
    }

    public Operation possibleValues(String str, int i) {
    ...
    public Operation examples(String str) {
        this.mTextExamples = str;
        return this;
    }

    public Operation exampleImage(String str, String str2) {
        this.mExamples.add(new StringPair(str, str2));
        return this;
    }

    public Operation examplesDimension(int i, int i2) {
