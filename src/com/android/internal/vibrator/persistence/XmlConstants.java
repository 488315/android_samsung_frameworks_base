...
public final class XmlConstants {
    ...
    public enum PrimitiveEffectName {
        ...
        public static PrimitiveEffectName findById(int i) {
            for (PrimitiveEffectName primitiveEffectName : values()) {
        ...
        public static PrimitiveEffectName findByName(String str) {
            try {
    ...
    public enum PredefinedEffectName {
        ...
        public static PredefinedEffectName findById(int i, int i2) {
            boolean z = (i2 & 1) != 0;
            for (PredefinedEffectName predefinedEffectName : values()) {
    ...
    public enum PrimitiveDelayType {
        ...
        PrimitiveDelayType(int i) {
            this.mDelayType = i;
        }

        public static PrimitiveDelayType findByType(int i) {
            for (PrimitiveDelayType primitiveDelayType : values()) {
                if (primitiveDelayType.mDelayType == i) {
                    return primitiveDelayType;
                }
            }
            return null;
        }

        public static PrimitiveDelayType findByName(String str) {
            try {
                return valueOf(str.toUpperCase(Locale.ROOT));
            } catch (IllegalArgumentException unused) {
                return null;
