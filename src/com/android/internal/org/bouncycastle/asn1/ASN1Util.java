...
public abstract class ASN1Util {
    ...
    public static String getTagText(int i, int i2) {
        if (i == 64) {
            return "[APPLICATION " + i2 + NavigationBarInflaterView.SIZE_MOD_END;
        }
        if (i == 128) {
            return "[CONTEXT " + i2 + NavigationBarInflaterView.SIZE_MOD_END;
        }
        if (i == 192) {
            return "[PRIVATE " + i2 + NavigationBarInflaterView.SIZE_MOD_END;
        }
        return "[UNIVERSAL " + i2 + NavigationBarInflaterView.SIZE_MOD_END;
    }
