...
public class ASN1ObjectIdentifier extends ASN1Primitive {
    ...
    static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1ObjectIdentifier.class, 6) { // from class: com.android.internal.org.bouncycastle.asn1.ASN1ObjectIdentifier.1
    ...
    ASN1ObjectIdentifier(byte[] bArr, boolean z) {
        ...
        this.identifier = sb.toString().intern();
    ...
    ASN1ObjectIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        this.identifier = aSN1ObjectIdentifier.getId() + MediaMetrics.SEPARATOR + str;
    }
