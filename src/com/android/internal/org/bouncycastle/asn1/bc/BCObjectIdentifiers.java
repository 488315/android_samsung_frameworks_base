...
public interface BCObjectIdentifiers {
    ...
    static {
        ...
        xmss = branch7;
        xmss_SHA256ph = branch7.branch("1");
        xmss_SHA512ph = branch7.branch("2");
        xmss_SHAKE128_512ph = branch7.branch("3");
        xmss_SHAKE256_1024ph = branch7.branch("4");
        xmss_SHA256 = branch7.branch("5");
        xmss_SHA512 = branch7.branch("6");
        xmss_SHAKE128 = branch7.branch("7");
        xmss_SHAKE256 = branch7.branch("8");
        xmss_SHAKE128ph = branch7.branch("9");
        xmss_SHAKE256ph = branch7.branch("10");
        ASN1ObjectIdentifier branch8 = branch6.branch("3");
        xmss_mt = branch8;
        xmss_mt_SHA256ph = branch8.branch("1");
        xmss_mt_SHA512ph = branch8.branch("2");
        xmss_mt_SHAKE128_512ph = branch8.branch("3");
        xmss_mt_SHAKE256_1024ph = branch8.branch("4");
        xmss_mt_SHA256 = branch8.branch("5");
        xmss_mt_SHA512 = branch8.branch("6");
        xmss_mt_SHAKE128 = branch8.branch("7");
        xmss_mt_SHAKE256 = branch8.branch("8");
        xmss_mt_SHAKE128ph = branch8.branch("9");
        xmss_mt_SHAKE256ph = branch8.branch("10");
        ASN1ObjectIdentifier branch9 = branch6.branch("4");
        qTESLA = branch9;
        qTESLA_Rnd1_I = branch9.branch("1");
        qTESLA_Rnd1_III_size = branch9.branch("2");
        qTESLA_Rnd1_III_speed = branch9.branch("3");
        qTESLA_Rnd1_p_I = branch9.branch("4");
        qTESLA_Rnd1_p_III = branch9.branch("5");
        qTESLA_p_I = branch9.branch("11");
        qTESLA_p_III = branch9.branch(AudioParameter.VALUE_VM_CSD_500_WARNING);
        ASN1ObjectIdentifier branch10 = branch6.branch("5");
        sphincsPlus = branch10;
        sphincsPlus_sha2_128s_r3 = branch10.branch("1");
        sphincsPlus_sha2_128f_r3 = branch10.branch("2");
        sphincsPlus_shake_128s_r3 = branch10.branch("3");
        sphincsPlus_shake_128f_r3 = branch10.branch("4");
        sphincsPlus_haraka_128s_r3 = branch10.branch("5");
        sphincsPlus_haraka_128f_r3 = branch10.branch("6");
        sphincsPlus_sha2_192s_r3 = branch10.branch("7");
        sphincsPlus_sha2_192f_r3 = branch10.branch("8");
        sphincsPlus_shake_192s_r3 = branch10.branch("9");
        sphincsPlus_shake_192f_r3 = branch10.branch("10");
        sphincsPlus_haraka_192s_r3 = branch10.branch("11");
        sphincsPlus_haraka_192f_r3 = branch10.branch(AudioParameter.VALUE_VM_CSD_500_WARNING);
        sphincsPlus_sha2_256s_r3 = branch10.branch("13");
        sphincsPlus_sha2_256f_r3 = branch10.branch("14");
        sphincsPlus_shake_256s_r3 = branch10.branch("15");
        sphincsPlus_shake_256f_r3 = branch10.branch("16");
        sphincsPlus_haraka_256s_r3 = branch10.branch("17");
        sphincsPlus_haraka_256f_r3 = branch10.branch("18");
        sphincsPlus_sha2_128s_r3_simple = branch10.branch("19");
        sphincsPlus_sha2_128f_r3_simple = branch10.branch("20");
        sphincsPlus_shake_128s_r3_simple = branch10.branch("21");
        sphincsPlus_shake_128f_r3_simple = branch10.branch("22");
        sphincsPlus_haraka_128s_r3_simple = branch10.branch("23");
        sphincsPlus_haraka_128f_r3_simple = branch10.branch("24");
        sphincsPlus_sha2_192s_r3_simple = branch10.branch("25");
        sphincsPlus_sha2_192f_r3_simple = branch10.branch("26");
        sphincsPlus_shake_192s_r3_simple = branch10.branch("27");
        sphincsPlus_shake_192f_r3_simple = branch10.branch("28");
        sphincsPlus_haraka_192s_r3_simple = branch10.branch("29");
        sphincsPlus_haraka_192f_r3_simple = branch10.branch("30");
        sphincsPlus_sha2_256s_r3_simple = branch10.branch("31");
        sphincsPlus_sha2_256f_r3_simple = branch10.branch("32");
        sphincsPlus_shake_256s_r3_simple = branch10.branch("33");
        sphincsPlus_shake_256f_r3_simple = branch10.branch("34");
        sphincsPlus_haraka_256s_r3_simple = branch10.branch("35");
        sphincsPlus_haraka_256f_r3_simple = branch10.branch("36");
        ...
        ASN1ObjectIdentifier branch11 = branch6.branch("6");
        picnic = branch11;
        ASN1ObjectIdentifier branch12 = branch11.branch("1");
        picnic_key = branch12;
        picnicl1fs = branch12.branch("1");
        picnicl1ur = branch12.branch("2");
        picnicl3fs = branch12.branch("3");
        picnicl3ur = branch12.branch("4");
        picnicl5fs = branch12.branch("5");
        picnicl5ur = branch12.branch("6");
        picnic3l1 = branch12.branch("7");
        picnic3l3 = branch12.branch("8");
        picnic3l5 = branch12.branch("9");
        picnicl1full = branch12.branch("10");
        picnicl3full = branch12.branch("11");
        picnicl5full = branch12.branch(AudioParameter.VALUE_VM_CSD_500_WARNING);
        ASN1ObjectIdentifier branch13 = branch11.branch("2");
        picnic_signature = branch13;
        picnic_with_sha512 = branch13.branch("1");
        picnic_with_shake256 = branch13.branch("2");
        picnic_with_sha3_512 = branch13.branch("3");
        ...
        ASN1ObjectIdentifier branch14 = branch6.branch("9");
        rainbow = branch14;
        rainbow_III_classic = branch14.branch("1");
        rainbow_III_circumzenithal = branch14.branch("2");
        rainbow_III_compressed = branch14.branch("3");
        rainbow_V_classic = branch14.branch("4");
        rainbow_V_circumzenithal = branch14.branch("5");
        rainbow_V_compressed = branch14.branch("6");
        ASN1ObjectIdentifier branch15 = aSN1ObjectIdentifier.branch("3");
        bc_exch = branch15;
        newHope = branch15.branch("1");
        ASN1ObjectIdentifier branch16 = aSN1ObjectIdentifier.branch("4");
        bc_ext = branch16;
        linkedCertificate = branch16.branch("1");
        external_value = branch16.branch("2");
        ...
        mceliece460896f_r3 = branch18.branch("4");
        mceliece6688128_r3 = branch18.branch("5");
        mceliece6688128f_r3 = branch18.branch("6");
        ...
        frodokem976shake = branch19.branch("4");
        frodokem1344aes = branch19.branch("5");
        frodokem1344shake = branch19.branch("6");
        ...
        lightsaberkem192r3 = branch20.branch("4");
        saberkem192r3 = branch20.branch("5");
        firesaberkem192r3 = branch20.branch("6");
        ...
        ufiresaberkemr3 = branch20.branch(AudioParameter.VALUE_VM_CSD_500_WARNING);
        ...
        ASN1ObjectIdentifier branch21 = branch17.branch("4");
        pqc_kem_sike = branch21;
        sikep434 = branch21.branch("1");
        sikep503 = branch21.branch("2");
        sikep610 = branch21.branch("3");
        sikep751 = branch21.branch("4");
        sikep434_compressed = branch21.branch("5");
        sikep503_compressed = branch21.branch("6");
        sikep610_compressed = branch21.branch("7");
        sikep751_compressed = branch21.branch("8");
        ...
        ntruhrss701 = branch22.branch("4");
        ASN1ObjectIdentifier branch23 = branch17.branch("6");
        pqc_kem_kyber = branch23;
        kyber512 = branch23.branch("1");
        kyber768 = branch23.branch("2");
        kyber1024 = branch23.branch("3");
        kyber512_aes = branch23.branch("4");
        kyber768_aes = branch23.branch("5");
        kyber1024_aes = branch23.branch("6");
        ASN1ObjectIdentifier branch24 = branch17.branch("7");
        pqc_kem_ntruprime = branch24;
        ...
        ntrulpr953 = branch25.branch("4");
        ntrulpr1013 = branch25.branch("5");
        ntrulpr1277 = branch25.branch("6");
        ...
        sntrup953 = branch26.branch("4");
        sntrup1013 = branch26.branch("5");
        sntrup1277 = branch26.branch("6");
