...
public class ASN1Integer extends ASN1Primitive {
    ...
    static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1Integer.class, 2) { // from class: com.android.internal.org.bouncycastle.asn1.ASN1Integer.1
    ...
    static boolean isMalformed(byte[] bArr) {
        int length = bArr.length;
        if (length != 0) {
            return (length == 1 || bArr[0] != (bArr[1] >> 7) || Properties.isOverrideSet("com.android.internal.org.bouncycastle.asn1.allow_unsafe_integer")) ? false : true;
        }
        return true;
    }
