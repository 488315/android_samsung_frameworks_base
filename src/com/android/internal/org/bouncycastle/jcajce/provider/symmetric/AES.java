...
public final class AES {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            sb.append(str);
            sb.append("$ECB");
            configurableProvider.addAlgorithm("Cipher.AES", sb.toString());
            ...
            configurableProvider.addPrivateAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_CBC, str + "$CBC");
            configurableProvider.addPrivateAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_CBC, str + "$CBC");
            configurableProvider.addPrivateAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_CBC, str + "$CBC");
        }
    }
}
