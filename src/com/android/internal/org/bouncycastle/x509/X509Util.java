...
class X509Util {
    ...
    static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        while (true) {
            String property = provider.getProperty("Alg.Alias." + str + MediaMetrics.SEPARATOR + upperCase);
            if (property == null) {
                break;
            }
            upperCase = property;
        }
        String property2 = provider.getProperty(str + MediaMetrics.SEPARATOR + upperCase);
        if (property2 != null) {
            try {
