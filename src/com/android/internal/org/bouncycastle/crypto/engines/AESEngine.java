...
public class AESEngine extends DefaultMultiBlockCipher {
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2, int[][] iArr) {
        ...
        int i17 = ((((bArr4[(iShift10 >> 16) & 255] & 255) << 16) ^ ((bArr4[iShift12 & 255] & 255) ^ ((bArr4[(iShift9 >> 8) & 255] & 255) << 8))) ^ (bArr3[(iShift11 >> 24) & 255] << 24)) ^ iArr5[c6];
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2, int[][] iArr) {
        ...
        int i18 = ((bArr4[(iShift9 >> 24) & 255] << 24) ^ (((bArr3[iShift12 & 255] & 255) ^ ((bArr4[(iShift11 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(iShift10 >> 16) & 255] & 255) << 16))) ^ iArr5[c6];
