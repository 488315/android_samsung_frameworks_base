...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    private byte[] theD;
    private static final byte[] EK_d = {SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEIN, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT80, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, SprAnimatorBase.INTERPOLATOR_TYPE_SINEIN33, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90};
    private static final byte[] EK_d32 = {SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEIN, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT80, 37, SprAnimatorBase.INTERPOLATOR_TYPE_SINEIN33, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90};
    private static final byte[] EK_d64 = {35, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT80, SprAnimatorBase.INTERPOLATOR_TYPE_QUINTEASEINOUT, SprAnimatorBase.INTERPOLATOR_TYPE_SINEIN33, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90};
    private static final byte[] EK_d128 = {35, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT80, 37, SprAnimatorBase.INTERPOLATOR_TYPE_SINEIN33, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, SprAnimatorBase.INTERPOLATOR_TYPE_SINEINOUT90};

    private static int MAKEU31(byte b, byte b2, byte b3, byte b4) {
        return ((b & 255) << 23) | ((b2 & 255) << 16) | ((b3 & 255) << 8) | (b4 & 255);
    }

    @Override // com.android.internal.org.bouncycastle.crypto.engines.Zuc128CoreEngine
    protected int getMaxIterations() {
        return MetricsProto.MetricsEvent.PROVISIONING_ERROR;
    }
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.engines.Zuc128CoreEngine, com.android.internal.org.bouncycastle.crypto.StreamCipher
    ...
    @Override // com.android.internal.org.bouncycastle.crypto.engines.Zuc128CoreEngine, com.android.internal.org.bouncycastle.util.Memoable
