...
public final class CryptoServicesRegistrar {
    ...
    static {
        CryptoServicesConstraints cryptoServicesConstraints = new CryptoServicesConstraints() { // from class: com.android.internal.org.bouncycastle.crypto.CryptoServicesRegistrar.1
            @Override // com.android.internal.org.bouncycastle.crypto.CryptoServicesConstraints
    ...
    public static SecureRandom getSecureRandom() {
        ...
        atomicReference.compareAndSet(null, defaultRandomProviderImpl);
    ...
    public static void setSecureRandom(final SecureRandom secureRandom) {
        ...
        if (secureRandom == null) {
            ...
            defaultSecureRandomProvider.set(new SecureRandomProvider() { // from class: com.android.internal.org.bouncycastle.crypto.CryptoServicesRegistrar.2
                @Override // com.android.internal.org.bouncycastle.crypto.SecureRandomProvider
    ...
    private static void checkPermission(final Permission permission) {
        ...
        if (securityManager != null) {
            AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: com.android.internal.org.bouncycastle.crypto.CryptoServicesRegistrar.3
