...
public class FixedPointUtil {
    ...
    public static FixedPointPreCompInfo precompute(final ECPoint eCPoint) {
        ...
        return (FixedPointPreCompInfo) curve.precompute(eCPoint, PRECOMP_NAME, new PreCompCallback() { // from class: com.android.internal.org.bouncycastle.math.ec.FixedPointUtil.1
