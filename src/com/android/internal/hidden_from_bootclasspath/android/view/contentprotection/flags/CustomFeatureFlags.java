...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet = new HashSet(Arrays.asList(Flags.FLAG_BLOCKLIST_UPDATE_ENABLED, Flags.FLAG_CREATE_ACCESSIBILITY_OVERLAY_APP_OP_ENABLED, Flags.FLAG_EXPORTED_SETTINGS_ACTIVITY_ENABLED, Flags.FLAG_MANAGE_DEVICE_POLICY_ENABLED, Flags.FLAG_PARSE_GROUPS_CONFIG_ENABLED, Flags.FLAG_RAPID_CLEAR_NOTIFICATIONS_BY_LISTENER_APP_OP_ENABLED, Flags.FLAG_SETTING_UI_ENABLED, ""));
    ...
    public boolean createAccessibilityOverlayAppOpEnabled() {
        return getValue(Flags.FLAG_CREATE_ACCESSIBILITY_OVERLAY_APP_OP_ENABLED, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.android.view.contentprotection.flags.CustomFeatureFlags$$ExternalSyntheticLambda5
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public boolean exportedSettingsActivityEnabled() {
        return getValue(Flags.FLAG_EXPORTED_SETTINGS_ACTIVITY_ENABLED, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.android.view.contentprotection.flags.CustomFeatureFlags$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ((FeatureFlags) obj).exportedSettingsActivityEnabled();
            }
        });
    }
    ...
    public boolean rapidClearNotificationsByListenerAppOpEnabled() {
        return getValue(Flags.FLAG_RAPID_CLEAR_NOTIFICATIONS_BY_LISTENER_APP_OP_ENABLED, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.android.view.contentprotection.flags.CustomFeatureFlags$$ExternalSyntheticLambda6
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public List<String> getFlagNames() {
        return Arrays.asList(Flags.FLAG_BLOCKLIST_UPDATE_ENABLED, Flags.FLAG_CREATE_ACCESSIBILITY_OVERLAY_APP_OP_ENABLED, Flags.FLAG_EXPORTED_SETTINGS_ACTIVITY_ENABLED, Flags.FLAG_MANAGE_DEVICE_POLICY_ENABLED, Flags.FLAG_PARSE_GROUPS_CONFIG_ENABLED, Flags.FLAG_RAPID_CLEAR_NOTIFICATIONS_BY_LISTENER_APP_OP_ENABLED, Flags.FLAG_SETTING_UI_ENABLED);
    }
}
