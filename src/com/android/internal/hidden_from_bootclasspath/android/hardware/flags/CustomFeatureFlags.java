...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet = new HashSet(Arrays.asList(Flags.FLAG_LUTS_API, Flags.FLAG_OVERLAYPROPERTIES_CLASS_API, ""));
    ...
    public boolean lutsApi() {
        return getValue(Flags.FLAG_LUTS_API, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.android.hardware.flags.CustomFeatureFlags$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ((FeatureFlags) obj).lutsApi();
            }
        });
    }
    ...
    public List<String> getFlagNames() {
        return Arrays.asList(Flags.FLAG_LUTS_API, Flags.FLAG_OVERLAYPROPERTIES_CLASS_API);
    }
}
