...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet = new HashSet(Arrays.asList(Flags.FLAG_ASSOCIATION_DEVICE_ICON, Flags.FLAG_ASSOCIATION_FAILURE_CODE, Flags.FLAG_ASSOCIATION_TAG, Flags.FLAG_DEVICE_PRESENCE, Flags.FLAG_NEW_ASSOCIATION_BUILDER, Flags.FLAG_ONGOING_PERM_SYNC, Flags.FLAG_PERM_SYNC_USER_CONSENT, Flags.FLAG_UNPAIR_ASSOCIATED_DEVICE, ""));
    ...
    public boolean associationDeviceIcon() {
        return getValue(Flags.FLAG_ASSOCIATION_DEVICE_ICON, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.android.companion.CustomFeatureFlags$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ((FeatureFlags) obj).associationDeviceIcon();
            }
        });
    }
    ...
    public boolean associationFailureCode() {
        return getValue(Flags.FLAG_ASSOCIATION_FAILURE_CODE, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.android.companion.CustomFeatureFlags$$ExternalSyntheticLambda7
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ((FeatureFlags) obj).associationFailureCode();
            }
        });
    }
    ...
    public List<String> getFlagNames() {
        return Arrays.asList(Flags.FLAG_ASSOCIATION_DEVICE_ICON, Flags.FLAG_ASSOCIATION_FAILURE_CODE, Flags.FLAG_ASSOCIATION_TAG, Flags.FLAG_DEVICE_PRESENCE, Flags.FLAG_NEW_ASSOCIATION_BUILDER, Flags.FLAG_ONGOING_PERM_SYNC, Flags.FLAG_PERM_SYNC_USER_CONSENT, Flags.FLAG_UNPAIR_ASSOCIATED_DEVICE);
    }
}
