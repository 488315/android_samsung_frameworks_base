...
public final class Flags {
    ...
    public static final String FLAG_ANNOUNCE_SHORTCUTS_AND_SUGGESTED_APPS_LEGACY = "android.service.chooser.announce_shortcuts_and_suggested_apps_legacy";
    ...
    public static final String FLAG_NOTIFY_SINGLE_ITEM_CHANGE_ON_ICON_LOAD = "android.service.chooser.notify_single_item_change_on_icon_load";

    public static boolean announceShortcutsAndSuggestedAppsLegacy() {
        return FEATURE_FLAGS.announceShortcutsAndSuggestedAppsLegacy();
    }
    ...
    public static boolean notifySingleItemChangeOnIconLoad() {
        return FEATURE_FLAGS.notifySingleItemChangeOnIconLoad();
    }
}
