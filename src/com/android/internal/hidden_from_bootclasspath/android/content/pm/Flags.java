...
public final class Flags {
    ...
    public static final String FLAG_ALWAYS_LOAD_PAST_CERTS_V4 = "android.content.pm.always_load_past_certs_v4";
    ...
    public static final String FLAG_CACHE_SDK_SYSTEM_FEATURES = "android.content.pm.cache_sdk_system_features";
    ...
    public static final String FLAG_CLOUD_COMPILATION_VERIFICATION = "android.content.pm.cloud_compilation_verification";
    ...
    public static final String FLAG_OPTIMIZE_PARSING_IN_REGISTERED_SERVICES_CACHE = "android.content.pm.optimize_parsing_in_registered_services_cache";
    ...
    public static final String FLAG_PARALLEL_PACKAGE_PARSING_ACROSS_SYSTEM_DIRS = "android.content.pm.parallel_package_parsing_across_system_dirs";
    ...
    public static final String FLAG_REMOVE_HIDDEN_MODULE_USAGE = "android.content.pm.remove_hidden_module_usage";
    ...
    public static final String FLAG_UID_BASED_PROVIDER_LOOKUP = "android.content.pm.uid_based_provider_lookup";
    ...
    public static boolean alwaysLoadPastCertsV4() {
        return FEATURE_FLAGS.alwaysLoadPastCertsV4();
    }
    ...
    public static boolean cacheSdkSystemFeatures() {
        return FEATURE_FLAGS.cacheSdkSystemFeatures();
    }
    ...
    public static boolean cloudCompilationVerification() {
        return FEATURE_FLAGS.cloudCompilationVerification();
    }
    ...
    public static boolean optimizeParsingInRegisteredServicesCache() {
        return FEATURE_FLAGS.optimizeParsingInRegisteredServicesCache();
    }
    ...
    public static boolean parallelPackageParsingAcrossSystemDirs() {
        return FEATURE_FLAGS.parallelPackageParsingAcrossSystemDirs();
    }
    ...
    public static boolean removeHiddenModuleUsage() {
        return FEATURE_FLAGS.removeHiddenModuleUsage();
    }
    ...
    public static boolean uidBasedProviderLookup() {
        return FEATURE_FLAGS.uidBasedProviderLookup();
    }
