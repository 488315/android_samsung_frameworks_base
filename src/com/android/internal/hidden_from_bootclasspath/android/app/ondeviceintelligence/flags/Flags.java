...
public final class Flags {
    ...
    public static final String FLAG_ENABLE_ON_DEVICE_INTELLIGENCE_MODULE = "android.app.ondeviceintelligence.flags.enable_on_device_intelligence_module";

    public static boolean enableOnDeviceIntelligence() {
        return FEATURE_FLAGS.enableOnDeviceIntelligence();
    }

    public static boolean enableOnDeviceIntelligenceModule() {
        return FEATURE_FLAGS.enableOnDeviceIntelligenceModule();
    }
}
