...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    public boolean balClearAllowlistDuration() {
        return getValue(Flags.FLAG_BAL_CLEAR_ALLOWLIST_DURATION, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.com.android.window.flags.CustomFeatureFlags$$ExternalSyntheticLambda266
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public boolean enableCaptionCompatInsetForceConsumptionAlways() {
        return getValue(Flags.FLAG_ENABLE_CAPTION_COMPAT_INSET_FORCE_CONSUMPTION_ALWAYS, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.com.android.window.flags.CustomFeatureFlags$$ExternalSyntheticLambda264
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public boolean enableDesktopWindowingTaskbarRunningApps() {
        return getValue(Flags.FLAG_ENABLE_DESKTOP_WINDOWING_TASKBAR_RUNNING_APPS, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.com.android.window.flags.CustomFeatureFlags$$ExternalSyntheticLambda263
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public boolean keepAppWindowHideWhileLocked() {
        return getValue(Flags.FLAG_KEEP_APP_WINDOW_HIDE_WHILE_LOCKED, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.com.android.window.flags.CustomFeatureFlags$$ExternalSyntheticLambda261
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ((FeatureFlags) obj).keepAppWindowHideWhileLocked();
            }
        });
    }
    ...
    public boolean letterboxBackgroundWallpaper() {
        return getValue(Flags.FLAG_LETTERBOX_BACKGROUND_WALLPAPER, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.com.android.window.flags.CustomFeatureFlags$$ExternalSyntheticLambda262
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public boolean noConsecutiveVisibilityEvents() {
        return getValue(Flags.FLAG_NO_CONSECUTIVE_VISIBILITY_EVENTS, new Predicate() { // from class: com.android.internal.hidden_from_bootclasspath.com.android.window.flags.CustomFeatureFlags$$ExternalSyntheticLambda265
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
