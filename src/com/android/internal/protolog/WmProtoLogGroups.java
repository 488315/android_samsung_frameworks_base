...
public enum WmProtoLogGroups implements IProtoLogGroup {
    ...
    WM_DEBUG_ORIENTATION_CHANGE(true, true, true, "WindowManager"),
    ...
    WM_DEBUG_SLEEP_TOKEN(true, true, true, "WindowManager"),
    ...
    WM_DEBUG_PRESENTATION(true, true, false, "WindowManager"),
    ...
    WmProtoLogGroups(boolean z, boolean z2, boolean z3, String str) {
        this.mEnabled = z;
        this.mLogToProto = z2;
    ...
    private static class Consts {
        ...
        private static final int START_ID = (int) (UUID.nameUUIDFromBytes(WmProtoLogGroups.class.getName().getBytes()).getMostSignificantBits() % 2147483647L);
