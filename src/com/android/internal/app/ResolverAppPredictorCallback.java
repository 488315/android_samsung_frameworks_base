...
public class ResolverAppPredictorCallback {
    ...
    public void notifyCallback(List<AppTarget> list) {
        ...
        if (consumer != null) {
            consumer.accept((List) Objects.requireNonNullElseGet(list, new Supplier() { // from class: com.android.internal.app.ResolverAppPredictorCallback$$ExternalSyntheticLambda0
