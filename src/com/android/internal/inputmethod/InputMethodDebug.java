...
public final class InputMethodDebug {
    ...
    public static String softInputModeToString(int i) {
        ...
        if (i2 == 0) {
            ...
            stringJoiner.add("STATE_UNKNOWN(" + i2 + NavigationBarInflaterView.KEY_CODE_END);
        }
        if (i3 == 0) {
            ...
            stringJoiner.add("ADJUST_UNKNOWN(" + i3 + NavigationBarInflaterView.KEY_CODE_END);
        }
        if (z) {
    ...
    public static String softInputDisplayReasonToString(int i) {
        switch (i) {
            case 0:
                return "NOT_SET";
            case 1:
    ...
    public static String handwritingGestureTypeFlagsToString(int i) {
        StringJoiner stringJoiner = new StringJoiner(NtpTrustedTime.NTP_SETTING_SERVER_NAME_DELIMITER);
        if ((i & 1) != 0) {
        ...
        if ((i & 4) != 0) {
            stringJoiner.add(SQLiteDatabase.JOURNAL_MODE_DELETE);
        }
        if ((i & 64) != 0) {
