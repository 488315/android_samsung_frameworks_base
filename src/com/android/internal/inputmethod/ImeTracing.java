...
public abstract class ImeTracing {
    ...
    protected void sendToService(byte[] bArr, int i, String str) {
        InputMethodManagerGlobal.startProtoDump(bArr, i, str, new Consumer() { // from class: com.android.internal.inputmethod.ImeTracing$$ExternalSyntheticLambda2
    ...
    protected void logAndPrintln(PrintWriter printWriter, String str) {
        Log.i(TAG, str);
        if (printWriter != null) {
