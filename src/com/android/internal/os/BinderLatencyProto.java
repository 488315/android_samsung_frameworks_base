...
public final class BinderLatencyProto {
    ...
    public final class RepeatedApiStats {
        ...
        public RepeatedApiStats(BinderLatencyProto binderLatencyProto) {
        }
    }
    ...
    public final class Dims {
        ...
        public Dims(BinderLatencyProto binderLatencyProto) {
        }
    }
    ...
    public final class ApiStats {
        ...
        public ApiStats(BinderLatencyProto binderLatencyProto) {
        }
    }
}
