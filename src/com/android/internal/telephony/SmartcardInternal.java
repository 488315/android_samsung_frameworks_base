...
public class SmartcardInternal {
    ...
    private static volatile SmartcardInternal scInstance;
    private static volatile SmartcardInternal scInstance2;
    ...
    public static SmartcardInternal getInstance(int i) {
    ...
    private SmartcardInternal(int i) {
        this.pcscInstance = null;
        this.pcscInstance = new IccPcscProvider(i);
    ...
    public int transmit(int i, byte[] bArr, byte[] bArr2) {
        return this.pcscInstance.transmit(i, bArr, bArr2);
    }

    public int disconnect(int i) {
        return this.pcscInstance.disconnect(i);
    }

    public int getATR(byte[] bArr) {
        return this.pcscInstance.getATR(bArr);
    }
}
