...
public interface ISwitchToProfileCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISwitchToProfileCallback {
        ...
        public static ISwitchToProfileCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(ISwitchToProfileCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof ISwitchToProfileCallback)) {
                return (ISwitchToProfileCallback) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(ISwitchToProfileCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(ISwitchToProfileCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
        ...
        private static class Proxy implements ISwitchToProfileCallback {
            ...
            public void onComplete(int i, EuiccProfileInfo euiccProfileInfo) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(ISwitchToProfileCallback.DESCRIPTOR);
                    obtain.writeInt(i);
