...
public interface IResetMemoryCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IResetMemoryCallback {
        ...
        public static IResetMemoryCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IResetMemoryCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IResetMemoryCallback)) {
                return (IResetMemoryCallback) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements IResetMemoryCallback {
            ...
            public void onComplete(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IResetMemoryCallback.DESCRIPTOR);
