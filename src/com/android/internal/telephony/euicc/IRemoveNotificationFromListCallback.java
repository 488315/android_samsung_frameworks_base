...
public interface IRemoveNotificationFromListCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRemoveNotificationFromListCallback {
        ...
        public static IRemoveNotificationFromListCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IRemoveNotificationFromListCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IRemoveNotificationFromListCallback)) {
                return (IRemoveNotificationFromListCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IRemoveNotificationFromListCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IRemoveNotificationFromListCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
        ...
        private static class Proxy implements IRemoveNotificationFromListCallback {
            ...
            public void onComplete(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IRemoveNotificationFromListCallback.DESCRIPTOR);
