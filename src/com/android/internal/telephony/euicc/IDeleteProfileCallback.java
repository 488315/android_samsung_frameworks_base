...
public interface IDeleteProfileCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDeleteProfileCallback {
        ...
        public static IDeleteProfileCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IDeleteProfileCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IDeleteProfileCallback)) {
                return (IDeleteProfileCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IDeleteProfileCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IDeleteProfileCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
        ...
        private static class Proxy implements IDeleteProfileCallback {
            ...
            public void onComplete(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IDeleteProfileCallback.DESCRIPTOR);
