...
public interface IDisableProfileCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDisableProfileCallback {
        ...
        public static IDisableProfileCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IDisableProfileCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IDisableProfileCallback)) {
                return (IDisableProfileCallback) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IDisableProfileCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IDisableProfileCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
        ...
        private static class Proxy implements IDisableProfileCallback {
            ...
            public void onComplete(int i) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IDisableProfileCallback.DESCRIPTOR);
                    obtain.writeInt(i);
