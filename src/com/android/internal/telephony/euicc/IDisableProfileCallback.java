...
public interface IDisableProfileCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDisableProfileCallback {
        ...
        public static IDisableProfileCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IDisableProfileCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IDisableProfileCallback)) {
                return (IDisableProfileCallback) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements IDisableProfileCallback {
            ...
            public void onComplete(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IDisableProfileCallback.DESCRIPTOR);
