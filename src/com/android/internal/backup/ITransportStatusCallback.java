...
public interface ITransportStatusCallback extends IInterface {
    ...
    public static class Default implements ITransportStatusCallback {
        ...
        @Override // com.android.internal.backup.ITransportStatusCallback
        public void onOperationCompleteWithStatus(int i) throws RemoteException {
        }
    }
    ...
    public static abstract class Stub extends Binder implements ITransportStatusCallback {
        ...
        public static ITransportStatusCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(ITransportStatusCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ITransportStatusCallback)) {
                return (ITransportStatusCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(ITransportStatusCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(ITransportStatusCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
                int i3 = parcel.readInt();
                parcel.enforceNoDataAvail();
                onOperationCompleteWithStatus(i3);
            } else if (i == 2) {
                onOperationComplete();
            } else {
        ...
        private static class Proxy implements ITransportStatusCallback {
            ...
            public void onOperationCompleteWithStatus(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(ITransportStatusCallback.DESCRIPTOR);
