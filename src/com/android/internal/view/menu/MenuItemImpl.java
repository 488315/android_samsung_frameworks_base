...
public final class MenuItemImpl implements MenuItem, SemMenuItem {
    ...
    String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(R.string.prepend_shortcut_label));
        }
        int i = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i, 65536, resources.getString(R.string.menu_meta_shortcut_label));
        appendModifier(sb, i, 4096, resources.getString(R.string.menu_ctrl_shortcut_label));
        appendModifier(sb, i, 2, resources.getString(R.string.menu_alt_shortcut_label));
        appendModifier(sb, i, 1, resources.getString(R.string.menu_shift_shortcut_label));
        appendModifier(sb, i, 4, resources.getString(R.string.menu_sym_shortcut_label));
        appendModifier(sb, i, 8, resources.getString(R.string.menu_function_shortcut_label));
        if (shortcut == '\b') {
            sb.append(resources.getString(R.string.menu_delete_shortcut_label));
        } else if (shortcut == '\n') {
            sb.append(resources.getString(R.string.menu_enter_shortcut_label));
        } else if (shortcut == ' ') {
            sb.append(resources.getString(R.string.menu_space_shortcut_label));
        } else {
            sb.append(shortcut);
        }
        return sb.toString();
