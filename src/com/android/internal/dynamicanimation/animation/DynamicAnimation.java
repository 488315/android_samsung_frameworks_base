...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    DynamicAnimation(final FloatValueHolder floatValueHolder) {
        ...
        this.mTarget = null;
        this.mProperty = new FloatProperty(this, "FloatValueHolder") { // from class: com.android.internal.dynamicanimation.animation.DynamicAnimation.15
    ...
    <K> DynamicAnimation(K k, FloatProperty<K> floatProperty) {
        ...
        if (floatProperty == ROTATION || floatProperty == ROTATION_X || floatProperty == ROTATION_Y) {
            this.mMinVisibleChange = 0.1f;
            return;
        }
        if (floatProperty == ALPHA) {
            this.mMinVisibleChange = 0.00390625f;
        } else if (floatProperty == SCALE_X || floatProperty == SCALE_Y) {
