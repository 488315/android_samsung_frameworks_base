...
public interface ParsingPackage {
    ...
    ParsingPackage addFeatureFlag(String str, Boolean bool);
    ...
    ParsingPackage setAlternateLauncherIconResIds(int[] iArr);

    ParsingPackage setAlternateLauncherLabelResIds(int[] iArr);
    ...
    ParsingPackage setIntentMatchingFlags(int i);
    ...
    ParsingPackage setPageSizeAppCompatFlags(int i);
