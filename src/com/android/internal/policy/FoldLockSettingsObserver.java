...
public class FoldLockSettingsObserver extends ContentObserver {
    ...
    public void register() {
        this.mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(Settings.System.FOLD_LOCK_BEHAVIOR), false, this, -1);
    ...
    void setCurrentFoldSetting(String str) {
        this.mFoldLockSetting = str;
    }
