...
public class KnoxUcmKeyStoreProvider extends Provider {
    ...
    public KnoxUcmKeyStoreProvider() {
        ...
        putKeyAgreementImpl("ECDH", "com.samsung.ucm.keystore.UcmKeyStoreKeyAgreementSpi$ECDH");
        putKeyAgreementImpl(KeyProperties.KEY_ALGORITHM_XDH, "com.samsung.ucm.keystore.UcmKeyStoreKeyAgreementSpi$XDH");
    }
    ...
    private void putAsymmetricCipherImpl(String str, String str2) {
        put("Cipher." + str, str2);
        put("Cipher." + str + " SupportedKeyClasses", KEYSTORE_PRIVATE_KEY_CLASS_NAME);
    }

    private void putSignatureImpl(String str, String str2) {
        put("Signature." + str, str2);
        put("Signature." + str + " SupportedKeyClasses", KEYSTORE_PRIVATE_KEY_CLASS_NAME);
    }
    ...
    private void putKeyAgreementImpl(String str, String str2) {
        put("KeyAgreement." + str, str2);
        put("KeyAgreement." + str + " SupportedKeyClasses", KEYSTORE_PRIVATE_KEY_CLASS_NAME);
    }
}
