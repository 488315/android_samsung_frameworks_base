...
public class AASAServiceManagerImpl implements AASAServiceManager {
    ...
    public void notifyReady() {
        ...
        AASAServiceManager.Callback callback = this.callback;
        if (callback == null) {
    ...
    public void notifyPolicyUpdateCompletion() {
        ...
        synchronized (lock) {
            IAASA iaasa = aasaService;
            if (iaasa == null) {
                Slog.e(TAG, "not connected yet");
                return;
            }
            try {
                iaasa.onReceivePolicyUpdateCompletion();
    ...
    private static class AASAServiceConnection implements ServiceConnection {
        ...
        public AASAServiceConnection(AASAServiceManager.Callback callback, IBinder.DeathRecipient deathRecipient) {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            addDeathHandler(iBinder);
            synchronized (AASAServiceManagerImpl.lock) {
                AASAServiceManagerImpl.aasaService = IAASA.Stub.asInterface(iBinder);
            }
            AASAServiceManager.Callback callback = this.readyCallback;
            if (callback != null) {
                callback.onReady();
        ...
        private void addDeathHandler(IBinder iBinder) {
            try {
