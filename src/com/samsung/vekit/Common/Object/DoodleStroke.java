...
public class DoodleStroke {
    ...
    public DoodleStroke(int i, int i2, PenType penType, boolean z) {
    ...
    public DoodleStroke setStrokeColor(int i) {
        this.strokeColor = i;
        return this;
    }
    ...
    public DoodleStroke setPatternURI(String str) {
        this.patternURI = str;
        return this;
    }
    ...
    public DoodleStroke setMosaicStrength(int i) {
        this.mosaicStrength = i;
        return this;
    }
    ...
    public DoodleStroke setStrokeSize(int i) {
        this.strokeSize = i;
        return this;
    }
    ...
    public void addDoodlePointList(ArrayList<DoodlePoint> arrayList) {
