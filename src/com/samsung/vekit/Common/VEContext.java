...
import com.samsung.vekit.Manager.LogProfileManager;
...
public class VEContext extends Element implements VEStateInterface {
    ...
    private final LogProfileManager logProfileManager;
    ...
    public VEContext() {
        ...
        this.logProfileManager = new LogProfileManager(this);
    ...
    public LogProfileManager getLogProfileManager() {
        return this.logProfileManager;
    }
    ...
    @Override // com.samsung.vekit.Common.State.VEStateInterface
    public synchronized void setState(VEKitState vEKitState) {
        this.state = vEKitState;
    }
