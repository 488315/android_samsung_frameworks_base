...
public class TransformAnimation extends Animation<Matrix4> {
    public TransformAnimation(VEContext vEContext, int i, String str) {
        super(vEContext, AnimationType.TRANSFORM, i, str);
    }
    ...
    @Override // com.samsung.vekit.Animation.Animation
    public TransformAnimation setKeyFrameList(ArrayList<KeyFrame<Matrix4>> arrayList) {
        return (TransformAnimation) super.setKeyFrameList((ArrayList) arrayList);
    }

    @Override // com.samsung.vekit.Animation.Animation
    public TransformAnimation setKeyFrame(KeyFrame<Matrix4> keyFrame, KeyFrame<Matrix4> keyFrame2) {
        return (TransformAnimation) super.setKeyFrame((KeyFrame) keyFrame, (KeyFrame) keyFrame2);
    }
    ...
    @Override // com.samsung.vekit.Animation.Animation
    public TransformAnimation setTarget(Element element) {
        return (TransformAnimation) super.setTarget(element);
    }

    @Override // com.samsung.vekit.Animation.Animation
    public TransformAnimation setBezierControlPoint(float f, float f2, float f3, float f4) {
        return (TransformAnimation) super.setBezierControlPoint(f, f2, f3, f4);
    }

    @Override // com.samsung.vekit.Animation.Animation
    public TransformAnimation setStartTime(long j) {
        return (TransformAnimation) super.setStartTime(j);
    }
