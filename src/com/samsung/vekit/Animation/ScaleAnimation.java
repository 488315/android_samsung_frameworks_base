...
public class ScaleAnimation extends Animation<Vector3> {
    public ScaleAnimation(VEContext vEContext, int i, String str) {
        super(vEContext, AnimationType.SCALE, i, str);
    }
    ...
    @Override // com.samsung.vekit.Animation.Animation
    public ScaleAnimation setKeyFrameList(ArrayList<KeyFrame<Vector3>> arrayList) {
        return (ScaleAnimation) super.setKeyFrameList((ArrayList) arrayList);
    }
    ...
    @Override // com.samsung.vekit.Animation.Animation
    public ScaleAnimation setTarget(Element element) {
        return (ScaleAnimation) super.setTarget(element);
    }

    @Override // com.samsung.vekit.Animation.Animation
    public ScaleAnimation setBezierControlPoint(float f, float f2, float f3, float f4) {
        return (ScaleAnimation) super.setBezierControlPoint(f, f2, f3, f4);
    }

    @Override // com.samsung.vekit.Animation.Animation
    public ScaleAnimation setStartTime(long j) {
        return (ScaleAnimation) super.setStartTime(j);
    }
