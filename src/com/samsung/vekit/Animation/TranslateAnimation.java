...
public class TranslateAnimation extends Animation<Vector3<Float>> {
    public TranslateAnimation(VEContext vEContext, int i, String str) {
        super(vEContext, AnimationType.TRANSLATE, i, str);
    }
    ...
    @Override // com.samsung.vekit.Animation.Animation
    public TranslateAnimation setKeyFrameList(ArrayList<KeyFrame<Vector3<Float>>> arrayList) {
        return (TranslateAnimation) super.setKeyFrameList((ArrayList) arrayList);
    }
    ...
    @Override // com.samsung.vekit.Animation.Animation
    public TranslateAnimation setTarget(Element element) {
        return (TranslateAnimation) super.setTarget(element);
    }

    @Override // com.samsung.vekit.Animation.Animation
    public TranslateAnimation setBezierControlPoint(float f, float f2, float f3, float f4) {
        return (TranslateAnimation) super.setBezierControlPoint(f, f2, f3, f4);
    }

    @Override // com.samsung.vekit.Animation.Animation
    public TranslateAnimation setStartTime(long j) {
        return (TranslateAnimation) super.setStartTime(j);
    }
