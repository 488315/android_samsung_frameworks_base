...
public class Item extends Element implements ItemStatusListener {
    ...
    public Item setFilterIntensity(float f) {
        return this;
    }

    @Override // com.samsung.vekit.Common.Object.Element
    public Item setOpacity(float f) {
        return this;
    }
    ...
    protected Item(VEContext vEContext, ItemType itemType, int i, String str) {
        super(vEContext, ElementType.ITEM, i, str);
        this.speed = 1.0f;
    ...
    public Item setParent(Layer layer) {
        this.parent = layer;
        return this;
    }
    ...
    public Item setDuration(long j) {
        this.duration = j;
        return this;
    }
    ...
    public Region getRegion(int i) {
        if (this.regionList.size() <= i || i < 0) {
            Log.e(this.TAG, "failed to get region (invalid index) : " + i);
            return null;
        }
    ...
    public void checkValidAnimation(Animation animation) throws Exception {
        boolean z = animation.getAnimationType() != AnimationType.TRANSITION;
    ...
    public void onError(ItemErrorType itemErrorType) {
        ItemStatusListener itemStatusListener = this.listener;
        if (itemStatusListener != null) {
            itemStatusListener.onError(itemErrorType);
        }
    }

    public void setStatusListener(ItemStatusListener itemStatusListener) {
