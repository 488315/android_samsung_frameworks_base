...
public class DoodleItem extends Item {
    ...
    public DoodleItem(VEContext vEContext, int i, String str) {
        super(vEContext, ItemType.DOODLE, i, str);
    ...
    public void attachStroke(DoodleStroke doodleStroke) {
        this.strokeList.add(doodleStroke);
        this.currentStrokeIndex++;
        Log.d(this.TAG, "attachStroke currentStrokeIndex : " + this.currentStrokeIndex);
        this.context.getNativeInterface().attachStroke(this, doodleStroke);
    }
    ...
    public void drawDoodle(ArrayList<DoodlePoint> arrayList) {
        if (!this.isDrawing) {
        ...
        this.strokeList.get(this.currentStrokeIndex).addDoodlePointList(arrayList);
        this.context.getNativeInterface().drawDoodle(this, arrayList);
    }
    ...
    public Bitmap captureStaticDoodle(int i, int i2) {
        return this.context.getNativeInterface().captureStaticDoodle(this, i, i2);
    }

    @Override // com.samsung.vekit.Item.Item
    public DoodleItem setParent(Layer layer) {
        return (DoodleItem) super.setParent(layer);
    }
    ...
    @Override // com.samsung.vekit.Item.Item
    public DoodleItem setPadding(long j) {
        return (DoodleItem) super.setPadding(j);
    }

    @Override // com.samsung.vekit.Item.Item
    public DoodleItem setDuration(long j) {
        return (DoodleItem) super.setDuration(j);
    }
}
