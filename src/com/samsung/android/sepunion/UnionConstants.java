...
public final class UnionConstants {
    ...
    public static final boolean FW_CHINA_MINOR_MODE;
    ...
    public static final String SERVICE_DESKTOPMODE_TV = "DesktopModeServiceForTV";
    ...
    public static final String SERVICE_MM_OBSERVER = "MMObserver";
    ...
    public static final String SERVICE_SC_OBSERVER = "SCObserver";
    ...
    static {
        ...
        arrayMap.put(SERVICE_DESKTOPMODE_TV, "com.samsung.android.sepunion.DexModeManagers");
        ...
        arrayMap2.put(SERVICE_DESKTOPMODE_TV, "com.android.server.sepunion.DexModeService");
        ...
        if ("com.samsung.android.sm_cn".equals(SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_SMARTMANAGER_CONFIG_PACKAGE_NAME"))) {
            ...
            arrayMap2.put(SERVICE_SMART_MANAGER, "com.android.server.sepunion.SmartManagerService");
        } else {
            str = "com.samsung.android.sm_cn";
        }
        if (SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_COMMON_CONFIG_VDC").contains("VDCOBSERVER")) {
            charSequence = "VDCOBSERVER";
        ...
        if (SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_COMMON_CONFIG_VDC").contains("SMMTOBSERVER")) {
            ...
            arrayMap2.put(SERVICE_SMMT_OBSERVER, "com.android.server.sepunion.SmartMeetingObserverService");
        } else {
            charSequence2 = "SMMTOBSERVER";
        }
        ...
        if (SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_COMMON_CONFIG_VDC").contains("SCOBSERVER")) {
            arrayMap2.put(SERVICE_SC_OBSERVER, "com.android.server.sepunion.SocialComposerObserverService");
        }
        ...
        arrayMap3.put(SERVICE_DESKTOPMODE_TV, 0);
        arrayMap3.put(SERVICE_HERMES, 0);
        arrayMap3.put(SERVICE_ENGMODE, 0);
        arrayMap3.put(SERVICE_GOOD_CATCH, 0);
        if (str.equals(SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_SMARTMANAGER_CONFIG_PACKAGE_NAME"))) {
            arrayMap3.put(SERVICE_SMART_MANAGER, 0);
        }
        if (SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_COMMON_CONFIG_VDC").contains(charSequence)) {
        ...
        if (SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_COMMON_CONFIG_VDC").contains("SCOBSERVER")) {
            arrayMap3.put(SERVICE_SC_OBSERVER, 0);
        }
