...
public class Config {
    ...
    public static String GetPDTAM(int i, int i2) {
        ...
        String str = STRING_LANGUAGE[i];
        return DEFAULT_PDT_PATH + str + "/samsung_voicecommand_" + STRING_DOMAIN[i2] + Session.SESSION_SEPARATION_CHAR_CHILD + str;
    }

    public static String GetOEMAM(int i, int i2) {
        if (i >= 15) {
            i = 1;
        }
        if (i2 >= 11) {
        ...
        String str = STRING_LANGUAGE[i];
        return DEFAULT_OEM_PATH + str + "/samsung_voicecommand_" + STRING_DOMAIN[i2] + Session.SESSION_SEPARATION_CHAR_CHILD + str;
    }
