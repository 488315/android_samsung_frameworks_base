...
public class IntegrityControlCheckCenter {
    ...
    public synchronized int getSecureData(int i) throws RemoteException {
        ...
        return iIntegrityControlCheckCenter.getSecureData(i);
    }
    ...
    public synchronized int setSecureData(int i, int i2) throws RemoteException {
        ...
        return iIntegrityControlCheckCenter.setSecureData(i, i2);
    }
    ...
    public synchronized String getDeviceStatus(int i, String str) throws RemoteException {
        byte[] deviceStatus;
        Log.d("ICCC", "Method getDeviceStatus in IntegrityControlCheckCenter Class");
        IIntegrityControlCheckCenter iIntegrityControlCheckCenter = this.mService;
        if (iIntegrityControlCheckCenter == null || str == null || (deviceStatus = iIntegrityControlCheckCenter.getDeviceStatus(i, str.getBytes(Charset.defaultCharset()))) == null || deviceStatus.length <= 1) {
            return null;
        }
        return new String(deviceStatus, Charset.defaultCharset());
    }

    public synchronized String getDeviceInfo(String str) throws RemoteException {
        byte[] deviceInfo;
        Log.d("ICCC", "Method getDeviceInfo in IntegrityControlCheckCenter Class");
        IIntegrityControlCheckCenter iIntegrityControlCheckCenter = this.mService;
        if (iIntegrityControlCheckCenter == null || str == null || (deviceInfo = iIntegrityControlCheckCenter.getDeviceInfo(str.getBytes(Charset.defaultCharset()))) == null || deviceInfo.length <= 1) {
            return null;
        }
        return new String(deviceInfo, Charset.defaultCharset());
    }
    ...
    public synchronized byte[] getBldpData() throws RemoteException {
        ...
        IIntegrityControlCheckCenter iIntegrityControlCheckCenter = this.mService;
        if (iIntegrityControlCheckCenter != null && (bldpData = iIntegrityControlCheckCenter.getBldpData()) != null) {
            if (bldpData.length > 1) {
                return bldpData;
            }
        }
        return null;
