...
public class InputRune {
    ...
    public static final boolean IFW_ADJUST_KEYBOARD_LAYOUT_PREVIEW_TEXT_SIZE = true;
    public static final boolean IFW_AI_HOT_KEY = true;
    ...
    public static final boolean IFW_GET_INPUT_DEVICE_PATH = true;
    ...
    public static final boolean IFW_SPEN_PRESSURE_SA_LOGGING;
    ...
    public static final boolean PWM_KEY_FACTORY_MODE_POLICY;
    ...
    public static final boolean PWM_KEY_SA_LOGGING;
    ...
    public static final boolean PWM_MULTI_FOLD_REVERSE_FOLDING = false;
    ...
    public static final boolean PWM_SECURE_REMOTE_LOCK = true;
    ...
    public static final boolean PWM_SIDE_KEY_DOUBLE_PRESS;
    public static final boolean PWM_SIDE_KEY_DOUBLE_PRESS_SECURE_FOLDER;
    public static final boolean PWM_SIDE_KEY_LONG_PRESS;
    public static final boolean PWM_SIDE_KEY_POWER_OFF_MENU;
    ...
    public static final boolean PWM_SUPPORT_DESKTOP_WINDOWING_MODE = true;
    public static final boolean PWM_SUPPORT_DICTATION_SAMSUNG_KEYBOARD = true;
    ...
    public static boolean SAFE_DEBUG = false;
    ...
    public static final boolean IS_DEBUGGABLE = Build.isDebuggable();

    static {
        boolean z = CoreRune.FW_SA_LOGGING;
        IFW_SPEN_PRESSURE_SA_LOGGING = false;
        PWM_KEY_FACTORY_MODE_POLICY = FactoryTest.isFactoryMode();
        ...
        PWM_SIDE_KEY = z2;
        PWM_SIDE_KEY_DOUBLE_PRESS = z2;
        PWM_SIDE_KEY_LONG_PRESS = z2;
        PWM_SIDE_KEY_WAKE_UP_BIXBY = z2 && !SemCscFeature.getInstance().getBoolean("CscFeature_Common_DisableBixby", false);
        PWM_SIDE_KEY_POWER_OFF_MENU = z2 && SemCscFeature.getInstance().getInteger("CscFeature_Setting_ConfigLongPressType") == 1;
        boolean z3 = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_COMMON_SUPPORT_AI_AGENT");
        PWM_SIDE_SUPPORT_AI_AGENT = z3;
        PWM_SIDE_KEY_DIGITAL_ASSISTANT = z2 && z3;
        PWM_SIDE_KEY_TORCH = z2;
        ...
        PWM_SPEN_USP_LEVEL = i;
        boolean z4 = i > 0;
        PWM_SPEN = z4;
        PWM_SPEN_SCREEN_OFF_MEMO = z4;
        PWM_SPEN_HOVER = z4;
        PWM_SPEN_SMART_CLIP = z4;
        PWM_OMC_SPEN_SOUND = z4;
        PWM_OMC_SPEN_VIBRATION = z4 && SemCscFeature.getInstance().getBoolean("CscFeature_Common_SupportSpenEditionVibration");
        PWM_DOUBLE_TAP_PREMIUM_WATCH = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_CLOCK_SUPPORT_PREMIUM_WATCH");
        PWM_ACTIVE_KEY = false;
        PWM_XCOVER_KEY = false;
        PWM_ACTIVE_OR_XCOVER_KEY = false;
        PWM_XCOVER_AND_TOP_KEY = false;
