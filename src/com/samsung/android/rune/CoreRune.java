...
public class CoreRune {
    ...
    public static final boolean MD_DEX_MIRRORING_DISPLAY = false;
    ...
    public static final boolean MT_APP_COMPAT_TASK_LISTENER_BUG_FIX = true;
    ...
    static {
        ...
        FW_VRR_RESOLUTION_POLICY = z7;
        FW_VRR_RESOLUTION_POLICY_FOR_SHELL_TRANSITION = z7 && IS_SHELL_TRANSITION_ENABLED;
        ...
        FW_DYNAMIC_RESOLUTION_CONTROL = true;
        ...
        boolean equals = SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_SMARTMANAGER_CONFIG_PACKAGE_NAME").equals("com.samsung.android.sm_cn");
        FW_SUPPORT_APPLOCK = equals;
        FW_APPLOCK = equals;
        ...
        MT_NEW_DEX = false;
        MD_DEX_STANDALONE_LAUNCH_POLICY = false;
        ...
        SYSPERF_QC_TASK_BOOST_ENABLE = equalsIgnoreCase;
        SYSPERF_QC_IOP_V3_ENABLE = equalsIgnoreCase;
        ...
        boolean z31 = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_COMMON_SUPPORT_CARLIFE");
        BAIDU_CARLIFE = z31;
        CARLIFE_DISPLAY_GROUP = z31;
        CARLIFE_NAVBAR = z31;
