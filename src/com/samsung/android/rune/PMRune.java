...
public class PMRune {
    ...
    public static final boolean AM_DB_CORRUPTION = true;
    ...
    public static final boolean PERM_ALLOW_PLATFORM_SIGNED_1P_APP = false;
    ...
    public static final boolean PERM_NPE = true;
    ...
    public static final boolean PERM_RESOLVE_FLAG_UPDATE_TIMING = true;
    public static final boolean PM_32BIT_APP_RUNNING_IN_ABI64;
    public static final boolean PM_ADD_SHARED_UID_ALLOW_LIST = true;
    public static final boolean PM_ADD_SIGNAUTRE_PERMISSION_ALLOW_LIST = true;
    public static final boolean PM_ALLOW_STAGED_INSTALL = true;
    public static final boolean PM_ALLOW_TO_SET_CATEGORY = true;
    public static final boolean PM_ALLOW_UNINSTALL_WITH_CONTROL_KEYGUARD = true;
    ...
    public static final boolean PM_DESKTOP_MODE = false;
    ...
    public static final boolean PM_INSTALL_DUPLICATED_SESSIONS = false;
    ...
    public static final boolean PM_SAFE_MODE_ALLOW_LIST = true;
    ...
    public static final boolean SM_BITMAP_THREAD = true;
    public static final boolean SM_BNR = true;
    public static final boolean SM_BUG_CLEAR_DATA = true;
    public static final boolean SM_CLEAR_BITMAP_DIR = true;
    public static final boolean SM_FIX_MISSING_XML = true;
    public static final boolean SM_NEW_DEX = true;
    ...
    public static final boolean UM_FIX_DEADLOCK = true;
    ...
    static {
        PM_LDU = PmUtils.isLduSkuBinary() || "factory".equalsIgnoreCase(SystemProperties.get("ro.factory.factory_binary", LsConstants.TAG_UNKNOWN));
        isSwaRegionDevice();
    ...
    private static boolean isIndiaRegionDevice() {
        ...
        return "INS".equals(str) || "INU".equals(str) || "SUP".equals(str);
    }

    private static boolean isSwaRegionDevice() {
        return new ArraySet(Arrays.asList("INS", "INU", "NPB", "NPL", "SLK", "SLI", "BNG", "BKD")).contains(SystemProperties.get("ro.csc.sales_code"));
    }
}
