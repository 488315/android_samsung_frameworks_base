...
public interface LsConstants {
    ...
    public static final String LOCKSETTINGS_SI_CHECKER_ID = "locksettings_si_checker_id";
    public static final String LOCKSETTINGS_SI_PROTECTOR_ID = "locksettings_si_protector_id";
    ...
    public static final byte LOCK_SETTINGS_LOG_VERSION_MIN = 1;
    ...
    public static final String[] REMOTELOCK_TYPE;
    ...
    public static final String SECURITY_LOG_VERSION;
    ...
    public static final String TAG_ENROLL = "Enroll";
    public static final String TAG_EVENTS = "Events";
    public static final String TAG_KEYERR = "KeystoreErr";
    ...
    static {
        boolean z = Build.IS_USERDEBUG || Build.IS_ENG;
        DEBUG = z;
        REMOTELOCK_TYPE = new String[]{"FMM", "CarrierLock", "RmmLock", "KnoxGuard"};
        SECURITY_LOG_VERSION = Build.VERSION.INCREMENTAL;
        SECURITY_DEBUG_ON_COUNT = z ? 10 : 17;
    }
}
