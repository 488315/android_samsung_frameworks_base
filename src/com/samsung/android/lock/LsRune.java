...
public class LsRune {
    ...
    public static final boolean SECURITY_INTEGRITY = true;
    public static final boolean SECURITY_LOCK_DB_BNR = true;
    public static final boolean SECURITY_PASSWORD_HINT = true;
    public static final boolean SECURITY_POLICY = true;
    public static final boolean SECURITY_PREV_CREDENTIAL_ENABLED = true;
    public static final boolean SECURITY_REMOTE_LOCKSCREEN = true;
    public static final boolean SECURITY_SIMPLE_PIN = true;
    public static final boolean SECURITY_SMART_SWITCH = true;
    public static final boolean SECURITY_SPBLOB_BNR = true;
    public static final boolean SECURITY_SYNC_FAILURE_COUNT = true;
}
