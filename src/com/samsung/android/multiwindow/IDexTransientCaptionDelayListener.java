...
public interface IDexTransientCaptionDelayListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDexTransientCaptionDelayListener {
        ...
        public static IDexTransientCaptionDelayListener asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IDexTransientCaptionDelayListener.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IDexTransientCaptionDelayListener)) {
                return (IDexTransientCaptionDelayListener) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements IDexTransientCaptionDelayListener {
            ...
            public void onDelayChanged(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IDexTransientCaptionDelayListener.DESCRIPTOR);
