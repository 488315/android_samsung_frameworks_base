...
public class SemMobileWipsDef {
    ...
    protected static final String[] USER_RESPONSE = {"Exception", "Disconnect", "Dismiss", AppJumpBlockTool.RESULT_CANCEL, "NoAlert", "collectTS", "NoAlert_Exception_list", "NoAlert_Enterpise_AP"};
}
