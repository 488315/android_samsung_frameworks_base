...
public class SemWifiAwareManager {
    ...
    public void setClusterMergingEnabled(boolean z) {
        try {
            this.mService.setClusterMergingEnabled(z);
    ...
    public void setNanCommand(int i, byte[] bArr) {
        try {
            this.mService.setNanCommand(i, bArr);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
