...
public interface ISemInsInfCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISemInsInfCallback {
        ...
        public static ISemInsInfCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(ISemInsInfCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ISemInsInfCallback)) {
                return (ISemInsInfCallback) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements ISemInsInfCallback {
            ...
            public void onResultInfer(ResultInfer resultInfer) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(ISemInsInfCallback.DESCRIPTOR);
                    parcelObtain.writeTypedObject(resultInfer, 0);
