...
public class SemTelecomManager {
    ...
    @Deprecated
    public void addConferenceParticipants(List<Uri> list, Bundle bundle) {
    }
    ...
    public SemTelecomManager(Context context, ISamsungTelecomService iSamsungTelecomService) {
        ...
        this.mSamsungTelecomServiceOverride = iSamsungTelecomService;
    }
    ...
    @Deprecated
    public List<Bundle> getAllowedPhoneAccountInfo(boolean z, boolean z2) {
        return Collections.EMPTY_LIST;
    }

    public List<SemPhoneAccount> getAllowedPhoneAccounts(boolean z, boolean z2) {
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService != null) {
            try {
                return samsungTelecomService.getAllowedPhoneAccounts(z, z2, this.mContext.getOpPackageName(), this.mContext.getAttributionTag()).getList();
    ...
    public void silenceRinger() {
        ...
        if (samsungTelecomService != null) {
            try {
                samsungTelecomService.silenceRinger(-1, new Bundle(), this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
    ...
    public void silenceRinger(int i) {
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService != null) {
            try {
                samsungTelecomService.silenceRinger(i, new Bundle(), this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
                Log.e(TAG, "Error calling ISamsungTelecomService#silenceRinger - keyCode : " + i, e);
            }
        }
    }

    public void silenceRinger(Bundle bundle) {
        Bundle bundle2;
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService != null) {
            if (bundle == null) {
                try {
                    ...
                    Log.e(TAG, "Error calling ISamsungTelecomService#silenceRinger - reason : " + bundle, e);
                    return;
                }
            } else {
                bundle2 = bundle;
            }
            samsungTelecomService.silenceRinger(-1, bundle2, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
        }
    }
    ...
    public void endCall() {
        ...
        if (samsungTelecomService != null) {
            try {
                samsungTelecomService.endCall(-1, new Bundle(), this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
    ...
    public void endCall(int i) {
        ...
        if (samsungTelecomService != null) {
            try {
                samsungTelecomService.endCall(i, new Bundle(), this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
                Log.e(TAG, "Error calling ISamsungTelecomService#endCall - keyCode : " + i, e);
            }
        }
    }

    public void endCall(Bundle bundle) {
        Bundle bundle2;
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService != null) {
            if (bundle == null) {
                try {
                    ...
                    Log.e(TAG, "Error calling ISamsungTelecomService#endCall - reason : " + bundle, e);
                    return;
                }
            } else {
                bundle2 = bundle;
            }
            samsungTelecomService.endCall(-1, bundle2, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
        }
    }
    ...
    public void acceptRingingCall() {
        ...
        if (samsungTelecomService != null) {
            try {
                samsungTelecomService.acceptRingingCall(-1, new Bundle(), this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
    ...
    public void acceptRingingCall(int i) {
        ...
        if (samsungTelecomService != null) {
            try {
                samsungTelecomService.acceptRingingCall(i, new Bundle(), this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
                Log.e(TAG, "Error calling ISamsungTelecomService#acceptRingingCall - keyCode : " + i, e);
            }
        }
    }

    public void acceptRingingCall(Bundle bundle) {
        Bundle bundle2;
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService != null) {
            if (bundle == null) {
                try {
                    ...
                    Log.e(TAG, "Error calling ISamsungTelecomService#acceptRingingCall - reason : " + bundle, e);
                    return;
                }
            } else {
                bundle2 = bundle;
            }
            samsungTelecomService.acceptRingingCall(-1, bundle2, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
        }
    }

    public void acceptRingingCallWithVideoState(int i) {
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService != null) {
            try {
                samsungTelecomService.acceptRingingCallWithVideoState(i, -1, new Bundle(), this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
    ...
    public void acceptRingingCallWithVideoState(int i, Bundle bundle) {
        Bundle bundle2;
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService != null) {
            if (bundle == null) {
                try {
                    ...
                    Log.e(TAG, "Error calling ISamsungTelecomService#acceptRingingCallWithVideoState - reason : " + bundle, e);
                    return;
                }
            } else {
                bundle2 = bundle;
            }
            samsungTelecomService.acceptRingingCallWithVideoState(i, -1, bundle2, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
        }
    }

    public boolean isInCall(int i, boolean z) {
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService == null) {
            return false;
        }
        try {
            return samsungTelecomService.isInCall(i, z, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
        } catch (RemoteException e) {
    ...
    public void showInCallScreen(boolean z, UserHandle userHandle) {
        ISamsungTelecomService samsungTelecomService = getSamsungTelecomService();
        if (samsungTelecomService != null) {
            try {
                samsungTelecomService.showInCallScreen(z, userHandle, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
    ...
    public static boolean hasSamsungTelecomSystemFeature() {
        boolean z = !isSupportHeadlessDevice();
        Log.i(TAG, "hasSamsungTelecomSystemFeature : " + z);
        return z;
    }
}
