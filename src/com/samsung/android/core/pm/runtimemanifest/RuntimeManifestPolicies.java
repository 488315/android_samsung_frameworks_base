...
public class RuntimeManifestPolicies {
    ...
    static /* synthetic */ int lambda$getApplicationPolicies$0(PolicyInfo policyInfo, PolicyInfo policyInfo2) {
    ...
    private static List<PolicyInfo> getAndSortFromMap(Map<String, List<PolicyInfo>> map, String str) {
        ...
        if (list != null) {
            Collections.sort(list, new Comparator() { // from class: com.samsung.android.core.pm.runtimemanifest.RuntimeManifestPolicies$$ExternalSyntheticLambda2
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
    ...
    static /* synthetic */ int lambda$getAndSortFromMap$1(PolicyInfo policyInfo, PolicyInfo policyInfo2) {
        return policyInfo2.getPriority() - policyInfo.getPriority();
    }
    ...
    private static void sortMap(Map<String, List<PolicyInfo>> map) {
        ...
        while (it.hasNext()) {
            Collections.sort(it.next(), new Comparator() { // from class: com.samsung.android.core.pm.runtimemanifest.RuntimeManifestPolicies$$ExternalSyntheticLambda0
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
    ...
    static /* synthetic */ int lambda$sortMap$2(PolicyInfo policyInfo, PolicyInfo policyInfo2) {
        return policyInfo2.getPriority() - policyInfo.getPriority();
    }
