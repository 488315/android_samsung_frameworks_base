...
public class ServiceID {
    ...
    public enum Description {
        ...
        public static Description createFromId(final int i) {
            return (Description) Optional.ofNullable(SERVICE_ID_DESCRIPTION.get(Integer.valueOf(i))).orElseThrow(new Supplier() { // from class: com.samsung.android.photoremasterservice.ServiceID$Description$$ExternalSyntheticLambda0
                @Override // java.util.function.Supplier
                public final Object get() {
                    return ServiceID.Description.lambda$createFromId$0(i);
                }
            });
        }

        static /* synthetic */ IllegalArgumentException lambda$createFromId$0(int i) {
            return new IllegalArgumentException("Invalid ID : " + i);
        }
