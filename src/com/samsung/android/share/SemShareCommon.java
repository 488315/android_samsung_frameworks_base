...
public class SemShareCommon {
    ...
    private HashMap<String, Integer> getFileIconExtensionMap() {
        ...
        hashMap.put("apk", Integer.valueOf(R.drawable.sem_chooser_ic_filetype_apk));
        hashMap.put("vcf", Integer.valueOf(R.drawable.sem_chooser_ic_filetype_contact));
        ...
        hashMap.put(Telephony.Mms.Part.MSG_ID, valueOf4);
        ...
        hashMap.put("pdf", Integer.valueOf(R.drawable.sem_chooser_ic_filetype_pdf));
        ...
        hashMap.put(BnRConstants.VIDEO_FILE_EXTENSION, valueOf8);
        ...
        hashMap.put("zip", Integer.valueOf(R.drawable.sem_chooser_ic_filetype_zip));
        Integer valueOf11 = Integer.valueOf(R.drawable.sem_chooser_ic_filetype_notes);
        hashMap.put("sdoc", valueOf11);
        hashMap.put("sdocx", valueOf11);
        hashMap.put("etc", Integer.valueOf(R.drawable.sem_chooser_ic_filetype_etc));
        return hashMap;
    }
