...
public final class EyeInfo implements Parcelable {
    ...
    private EyeInfo(Parcel parcel) {
        ...
        for (int i2 = 0; i2 < this.mReflectionNum; i2++) {
            ...
            this.mReflectionInfo[i2].mRect.left = parcel.readInt();
            this.mReflectionInfo[i2].mRect.top = parcel.readInt();
            this.mReflectionInfo[i2].mRect.right = parcel.readInt();
            this.mReflectionInfo[i2].mRect.bottom = parcel.readInt();
            this.mReflectionInfo[i2].mMsgId = parcel.readInt();
        }
