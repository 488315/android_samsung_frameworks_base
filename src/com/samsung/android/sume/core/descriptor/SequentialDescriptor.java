...
public class SequentialDescriptor extends MFDescriptorBase {
    ...
    public SequentialDescriptor(SequentialFilter.Type type, List<MFDescriptor> list) {
    ...
    public SequentialDescriptor(SequentialFilter.Type type, SequentialFilter.Mode mode, List<MFDescriptor> list) {
        this.sequentialType = type;
