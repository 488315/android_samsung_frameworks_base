...
public abstract class MFDescriptorBase extends MediaFilter.Option implements MFDescriptor {
    ...
    public MFDescriptorBase setFilterId(String str) {
        getAll().put(Integer.valueOf(FILTER_ID), str);
        return this;
    }

    public MFDescriptorBase setFilterType(Class<?> cls) {
        getAll().put(Integer.valueOf(FILTER_TYPE), cls);
        return this;
    }
