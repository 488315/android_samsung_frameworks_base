...
public class CollectBufferGroup extends MediaBufferGroup {
    ...
    public static final Parcelable.Creator<CollectBufferGroup> CREATOR = new Parcelable.Creator<CollectBufferGroup>() { // from class: com.samsung.android.sume.core.buffer.CollectBufferGroup.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public CollectBufferGroup[] newArray(int i) {
            return new CollectBufferGroup[i];
        }
    };

    public CollectBufferGroup(int i, List<MediaBuffer> list) {
        super(list.isEmpty() ? MediaFormat.of(MediaType.NONE, new Object[0]) : list.get(i).getFormat(), list);
        this.primaryId = i;
    ...
    public <T> MediaBuffer convertTo(final Class<T> cls) {
