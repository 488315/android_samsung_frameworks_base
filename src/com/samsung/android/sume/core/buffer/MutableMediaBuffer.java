...
public final class MutableMediaBuffer extends MediaBufferBase implements PlaceHolder<MediaBuffer> {
    ...
    MutableMediaBuffer(MediaFormat mediaFormat) {
        super(mediaFormat);
    }

    MutableMediaBuffer(MediaBuffer mediaBuffer) {
    ...
    static /* synthetic */ boolean lambda$getMetaDataBuffers$4(MediaBuffer mediaBuffer) {
    ...
    static /* synthetic */ boolean lambda$getExifBuffer$5(MediaBuffer mediaBuffer) {
    ...
    static /* synthetic */ boolean lambda$getIccBuffer$6(MediaBuffer mediaBuffer) {
    ...
    public MediaBuffer setExifBuffer(MediaBuffer mediaBuffer) {
        List<MediaBuffer> list = (List) this.buffer.asList().stream().filter(new Predicate() { // from class: com.samsung.android.sume.core.buffer.MutableMediaBuffer$$ExternalSyntheticLambda6
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    static /* synthetic */ boolean lambda$setExifBuffer$7(MediaBuffer mediaBuffer) {
    ...
    static /* synthetic */ boolean lambda$setIccBuffer$8(MediaBuffer mediaBuffer) {
    ...
    public String contentToString(Object obj) {
        ...
        sb2.append(this.format != null ? this.format.contentToString() : "n/a");
        sb.append(Def.contentToStringln("    ", sb2.toString(), "data=" + this.buffer));
        return sb.toString();
    }
