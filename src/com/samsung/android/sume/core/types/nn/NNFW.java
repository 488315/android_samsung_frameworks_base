...
public enum NNFW implements NumericEnum {
    ...
    NNFW(int i, Vendor[] vendorArr) {
        this.value = i;
        this.f5vendor = vendorArr;
    }
    ...
    public static NNFW fromExtension(final String str) {
    ...
    static /* synthetic */ InvalidParameterException lambda$fromExtension$1(String str) {
        return new InvalidParameterException("not supported model file type: " + str);
    }
}
