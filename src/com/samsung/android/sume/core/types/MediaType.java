...
public final class MediaType implements NumericEnum {
    ...
    private static int typeValueOf(MediaType mediaType, int i) {
        Def.require(mediaType.getValue() <= _MAX_RANK_.getValue(), "1st argument is not depth: " + mediaType.getValue(), new Object[0]);
        return (mediaType.getValue() & 15) + (i << 4);
    }

    private static MediaType of(final int i) {
        return (MediaType) Arrays.stream(values()).filter(new Predicate() { // from class: com.samsung.android.sume.core.types.MediaType$$ExternalSyntheticLambda0
            ...
            public final boolean test(Object obj) {
                return MediaType.lambda$of$0(i, (MediaType) obj);
            }
            ...
            public final Object get() {
                return MediaType.lambda$of$1(i);
            }
        });
    }

    static /* synthetic */ boolean lambda$of$0(int i, MediaType mediaType) {
        return mediaType.getValue() == i;
    }

    static /* synthetic */ InvalidParameterException lambda$of$1(int i) {
        return new InvalidParameterException("invalid MediaType value: " + i);
    }

    public static MediaType of(MediaType mediaType, int i) {
        return of(typeValueOf(mediaType, i));
    }
}
