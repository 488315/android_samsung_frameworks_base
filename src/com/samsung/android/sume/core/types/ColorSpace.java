...
public final class ColorSpace implements NumericEnum {
    ...
    private ColorSpace(String str, int i, int i2) {
        this.value = i2;
    }
    ...
    private static int makeColorSpace(ColorSpace colorSpace, ColorSpaceRange colorSpaceRange) {
        Def.require((colorSpace == NONE || colorSpaceRange == ColorSpaceRange.NONE) ? false : true, "color-space is none", new Object[0]);
