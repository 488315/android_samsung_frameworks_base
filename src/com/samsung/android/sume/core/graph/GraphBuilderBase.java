...
public abstract class GraphBuilderBase<T> implements GraphBuilder<T> {
    ...
    static /* synthetic */ GraphNode lambda$addNode$0(GraphNode graphNode) {
        return graphNode;
    }

    @Override // com.samsung.android.sume.core.graph.GraphBuilder
    public GraphBuilder<T> addNode(GraphNode<? extends T>... graphNodeArr) {
        this.graphNodes.addAll((Collection) Arrays.stream(graphNodeArr).map(new Function() { // from class: com.samsung.android.sume.core.graph.GraphBuilderBase$$ExternalSyntheticLambda0
