...
public class Rune {
    ...
    public static final int FEATURE_AOD_FULLSCREEN;
    private static final boolean IS_WINNER;
    public static final boolean SUPPORT_AOD_FULLSCREEN_MAIN_DISPLAY;
    public static final boolean SUPPORT_AOD_FULLSCREEN_SUB_DISPLAY;
    ...
    public static final boolean SUPPORT_DESKTOP_MODE;
