...
public final class Style {
    ...
    static {
        ...
        TonalSpec tonalSpec3 = new TonalSpec(new Hue(d6) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
            ...
            @Override // com.samsung.android.wallpaper.colortheme.monet.Hue
            public double get(Cam cam) {
                return ColorScheme.wrapDegreesDouble(cam.getHue() + this.amountDegrees);
            }
        ...
        TonalSpec tonalSpec4 = new TonalSpec(new Hue(d12) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
            private final double amountDegrees;
        ...
        TonalSpec tonalSpec5 = new TonalSpec(new Hue() { // from class: com.samsung.android.wallpaper.colortheme.monet.HueExpressiveSecondary
        ...
        TonalSpec tonalSpec6 = new TonalSpec(new Hue() { // from class: com.samsung.android.wallpaper.colortheme.monet.HueExpressiveTertiary
        ...
        TonalSpec tonalSpec7 = new TonalSpec(new Hue(d14) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
            private final double amountDegrees;
        ...
        EXPRESSIVE = new Style("EXPRESSIVE", 3, new CoreSpec(tonalSpec4, tonalSpec5, tonalSpec6, tonalSpec7, new TonalSpec(new Hue(d14) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
            private final double amountDegrees;
        ...
        TonalSpec tonalSpec8 = new TonalSpec(new Hue() { // from class: com.samsung.android.wallpaper.colortheme.monet.HueSource
            @Override // com.samsung.android.wallpaper.colortheme.monet.Hue
            public double get(Cam cam) {
                return cam.getHue();
            }
        ...
        TonalSpec tonalSpec10 = new TonalSpec(new Hue(d19) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
            private final double amountDegrees;
        ...
        RAINBOW = new Style("RAINBOW", 4, new CoreSpec(tonalSpec8, tonalSpec9, tonalSpec10, new TonalSpec(hue, new Chroma(d20) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaConstant
            private final double chroma;
        ...
        FRUIT_SALAD = new Style("FRUIT_SALAD", 5, new CoreSpec(new TonalSpec(new Hue(d21) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueSubtract
            private final double amountDegrees;
        ...
        }), new TonalSpec(new Hue(d21) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueSubtract
            private final double amountDegrees;
