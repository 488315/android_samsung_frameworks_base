...
public class Rune {
    ...
    public static final boolean SEC_AUDIO_BT_MULTIPLE_PROFILE = false;
    ...
    static {
        ...
        SEC_AUDIO_DEFAULT_STREAM_NOTIFICATION = "wifi-only".equalsIgnoreCase(SystemProperties.get("ro.carrier", LsConstants.TAG_UNKNOWN).trim()) || "yes".equalsIgnoreCase(SystemProperties.get("ro.radio.noril", "no").trim());
        TextUtils.equals("sep_basic", "sep_basic");
        SEC_AUDIO_SUPPORT_SOUND_THEME = true;
        SEC_AUDIO_SUPPORT_ACH_RINGTONE = true;
        ...
        SEC_AUDIO_KARAOKE_LISTENBACK = true;
        ...
        SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_AUDIO_SUPPORT_SPEAKER_AEC");
        SEC_AUDIO_KARAOKE = true;
