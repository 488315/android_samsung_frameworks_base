...
final class MediaDeviceFinderImpl extends MediaDeviceFinder {
    ...
    MediaDeviceFinderImpl(IAllShareConnector iAllShareConnector) {
    ...
    static class AllShareEventHandlerForMediaDevice extends AllShareEventHandler {
        ...
        public AllShareEventHandlerForMediaDevice(Looper looper, MediaDeviceFinderImpl mediaDeviceFinderImpl) {
            super(looper);
            this.mWeakRef = new WeakReference<>(mediaDeviceFinderImpl);
        }
        ...
        public void handleEventMessage(CVMessage cVMessage) {
            ...
            MediaDeviceFinderImpl mediaDeviceFinderImpl = this.mWeakRef.get();
            if (mediaDeviceFinderImpl == null) {
                DLog.w_api(MediaDeviceFinderImpl.TAG_CLASS, "mEventHandler.handleEventMessage : mWeakRef is null");
                return;
            }
            try {
                iDeviceFinderEventListener = (DeviceFinder.IDeviceFinderEventListener) mediaDeviceFinderImpl.mDiscoveryListenerMap.get(eventID);
            } catch (Exception e) {
            ...
            Device deviceFromMap = mediaDeviceFinderImpl.getDeviceFromMap(bundle2, deviceType);
            ...
            if (ClipboardConstants.USER_ADDED.equals(string)) {
                if (iDeviceFinderEventListener != null) {
                    try {
                        ...
                        DLog.w_api(MediaDeviceFinderImpl.TAG_CLASS, "[ADDED] Error", e2);
                        return;
                    } catch (Exception e3) {
                        DLog.w_api(MediaDeviceFinderImpl.TAG_CLASS, "[ADDED] Exception", e3);
                        return;
                    }
                }
                return;
            ...
            try {
                ...
                DLog.w_api(MediaDeviceFinderImpl.TAG_CLASS, "[REMOVED] Exception", e4);
            } catch (Exception e5) {
    ...
    public void removeDeviceFromMap(Bundle bundle, Device.DeviceType deviceType) {
        ...
        try {
            int i = AnonymousClass1.$SwitchMap$com$samsung$android$allshare$Device$DeviceType[deviceType.ordinal()];
            if (i == 1) {
    ...
    public Device getDeviceFromMap(Bundle bundle, Device.DeviceType deviceType) {
        ...
        DLog.i_api(TAG_CLASS, "Getting device from maps id: " + string + " with type: " + deviceType);
        try {
            deviceImpl = new DeviceImpl(bundle);
            i = AnonymousClass1.$SwitchMap$com$samsung$android$allshare$Device$DeviceType[deviceType.ordinal()];
        } catch (Exception e) {
        ...
        if (deviceType != null) {
            ...
            if (bundleInvoke != null) {
                ...
                if (parcelableArrayList == null || parcelableArrayList.size() == 0) {
                    ...
                    DLog.d_api(TAG_CLASS, "Returned bundle list size: " + parcelableArrayList.size());
