...
public class SemPassStorageManager {
    ...
    private static SemPassStorageManager mSemPassStorageManager;
    ...
    private static boolean isPassSupport() {
        try {
            IBinder service = ServiceManager.getService(AudioParameter.VALUE_MOUNT);
            if (service != null) {
                return IStorageManager.Stub.asInterface(service).isPassSupport();
            }
            return false;
    ...
    public int create() {
        try {
            IBinder service = ServiceManager.getService(AudioParameter.VALUE_MOUNT);
            if (service != null) {
                return IStorageManager.Stub.asInterface(service).createPassStorage();
            }
            return -13;
        } catch (RemoteException e) {
            Slog.wtf(TAG, e);
    ...
    public String getPath() {
        try {
            IBinder service = ServiceManager.getService(AudioParameter.VALUE_MOUNT);
            if (service != null) {
                return IStorageManager.Stub.asInterface(service).getPassStorage();
            }
            return null;
        } catch (RemoteException e) {
            Slog.wtf(TAG, e);
    ...
    public int release() {
        try {
            IBinder service = ServiceManager.getService(AudioParameter.VALUE_MOUNT);
            if (service != null) {
                return IStorageManager.Stub.asInterface(service).destroyPassStorage();
            }
            return -13;
        } catch (RemoteException e) {
            Slog.wtf(TAG, e);
    ...
    public int unlock() {
        try {
            IBinder service = ServiceManager.getService(AudioParameter.VALUE_MOUNT);
            if (service != null) {
                return IStorageManager.Stub.asInterface(service).unlockPassStorage();
            }
            return -13;
        } catch (RemoteException e) {
            Slog.wtf(TAG, e);
    ...
    public int lock() {
        try {
            IBinder service = ServiceManager.getService(AudioParameter.VALUE_MOUNT);
            if (service != null) {
                return IStorageManager.Stub.asInterface(service).lockPassStorage();
            }
            return -13;
        } catch (RemoteException e) {
            Slog.wtf(TAG, e);
    ...
    public boolean isUnlocked() {
        try {
            IBinder service = ServiceManager.getService(AudioParameter.VALUE_MOUNT);
            if (service != null) {
                return IStorageManager.Stub.asInterface(service).isPassUnlocked();
            }
            return false;
        } catch (RemoteException e) {
            Slog.wtf(TAG, e);
