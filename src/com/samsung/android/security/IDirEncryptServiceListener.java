...
public interface IDirEncryptServiceListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDirEncryptServiceListener {
        ...
        public static IDirEncryptServiceListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IDirEncryptServiceListener)) {
                return (IDirEncryptServiceListener) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            onEncryptionStatusChanged(parcel.readString(), parcel.readInt(), parcel.readString(), parcel.readInt(), parcel.readInt());
        ...
        private static class Proxy implements IDirEncryptServiceListener {
            ...
            public void onEncryptionStatusChanged(String str, int i, String str2, int i2, int i3) throws RemoteException {
