...
public class ProtectedCommand extends ICmdList {
    ...
    protected void addATCommands() {
        ...
        putAtCommands("AT+SCAMPARA=0,4,0,*", this.cmdType);
        ...
        putAtCommands("AT+DISPTEST=2,5", this.cmdType);
        putAtCommands("AT+DISPTEST=2,6", this.cmdType);
        ...
        putAtCommands("AT+FACMTEST=0,1,4,*", this.cmdType);
        putAtCommands("AT+FACMTEST=0,3,1,0", this.cmdType);
        putAtCommands("AT+UWBDTEST=0,0,8,*", this.cmdType);
        ...
        putAtCommands("AT+COFPDATA=2,0,4,*", this.cmdType);
        putAtCommands("AT+COFPDATA=1,0,4,0", this.cmdType);
        ...
        putAtCommands("AT+BATTTEST=4,12", this.cmdType);
        ...
        putAtCommands("AT+IRTEMPSC=0,0,1", this.cmdType);
        putAtCommands("AT+IRTEMPSC=0,1,1", this.cmdType);
        putAtCommands("AT+IRTEMPSC=0,0,0", this.cmdType);
        ...
        putAtCommands("AT+DEVROOTK=0,4,0", this.cmdType);
        putAtCommands("AT+DEVROOTK=0,5,0", this.cmdType);
        ...
        putAtCommands("AT+IFPMICCN=0,0,6,5", this.cmdType);
        ...
        putAtCommands("AT+FRPUNLCK=3,0,1", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,0,0", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,0,2", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,0,3", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,0,4", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,0,5", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,0,6", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,0,7", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,5,0", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,5,2", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,5,3", this.cmdType);
        putAtCommands("AT+SPKSTEST=0,5,4", this.cmdType);
        ...
        putAtCommands("AT+FACMINFO=1,*", this.cmdType);
        putAtCommands("AT+FACMINFO=9,*", this.cmdType);
        putAtCommands("AT+CHIPIDTT=1,0,2,4", this.cmdType);
        putAtCommands("AT+DCICTEST=0,3", this.cmdType);
        ...
        putAtCommands("AT+MSLSECUR=2,*", this.cmdType);
        putAtCommands("AT+MSLSECUR=3,*", this.cmdType);
        putAtCommands("AT+MSLSECUR=7,*", this.cmdType);
        putAtCommands("AT+IMEITEST=2,*", this.cmdType);
        putAtCommands("AT+IMEITEST=3,*", this.cmdType);
        putAtCommands("AT+IMEITEST=4,*", this.cmdType);
        putAtCommands("AT+IMEITEST=5,*", this.cmdType);
