...
public interface ISemFingerprintRequestCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISemFingerprintRequestCallback {
        ...
        public static ISemFingerprintRequestCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(ISemFingerprintRequestCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ISemFingerprintRequestCallback)) {
                return (ISemFingerprintRequestCallback) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements ISemFingerprintRequestCallback {
            ...
            public void onResult(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(ISemFingerprintRequestCallback.DESCRIPTOR);
