...
public interface IRotationChangeListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRotationChangeListener {
        ...
        public static IRotationChangeListener asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IRotationChangeListener.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IRotationChangeListener)) {
                return (IRotationChangeListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                onRotationChanged(readInt, readInt2);
                return true;
            }
        ...
        private static class Proxy implements IRotationChangeListener {
            ...
            public void onRotationChanged(int i, int i2) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IRotationChangeListener.DESCRIPTOR);
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
