...
public class VibRune {
    ...
    public static final boolean SUPPORT_ACH = true;
    ...
    public static final boolean SUPPORT_SEC_PLAY_PRIORITY = true;
    ...
    public static void SET_CIRRUS_HAPTIC(boolean z) {
        mIsHapticEngineIndexSupported = z;
    }
    ...
    public static void SET_HYBRID_HAPTIC(boolean z) {
        mIsHybridHapticSupported = z;
    }
