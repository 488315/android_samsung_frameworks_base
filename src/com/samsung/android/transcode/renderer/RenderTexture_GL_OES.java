...
public class RenderTexture_GL_OES {
    ...
    public int prepare(int i, int i2, int i3, int i4, int i5, int i6, int i7, boolean z, int i8, int i9) {
        this.mMMSMode = z;
    ...
    private boolean checkcallFinish() {
        String lowerCase = SemSystemProperties.get("ro.product.board").toLowerCase();
        if (lowerCase.contains("exynos") || lowerCase.contains("s5e")) {
            LogS.d("TranscodeLib", "checkcallFinish  chipName :" + lowerCase + ", return false");
            return false;
        }
        LogS.d("TranscodeLib", "checkcallFinish  chipName :" + lowerCase + ", return true");
        return true;
    }
}
