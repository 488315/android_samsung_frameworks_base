...
public abstract class Encode {
    ...
    private static final String VERSION = "4.74";
    ...
    public void encode() throws IOException {
        ...
        try {
            ...
            LogS.d("TranscodeLib", "generated output file size : " + length);
            if (!this.mSMConvert && !this.mConvert && !this.mUserStop) {
                long j = this.mOutputMaxSizeKB;
                if (j != -1 && length / 1024.0d > j && (this instanceof EncodeVideo)) {
                    if (!file.delete()) {
                        LogS.e("TranscodeLib", "Could not clean up file: " + file.getAbsolutePath());
                    }
                    this.mSizeFraction = (((this.mSizeFraction * this.mOutputMaxSizeKB) * 1024.0f) / length) - 0.05f;
                    LogS.d("TranscodeLib", "file size(" + length + ") exceeded the expected(" + (this.mOutputMaxSizeKB * 1024) + ") size limit. new fraction :" + this.mSizeFraction);
    ...
    private void printVersionInfo() {
        LogS.e("TranscodeLib", "Transcode Framework v.4.74");
    }

    public static String getLibraryVersion() {
        LogS.e("TranscodeLib", "getLibraryVersion  : Transcode Framework v.4.74");
        return VERSION;
    }
