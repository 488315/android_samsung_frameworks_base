...
public class SemBiometricsManager {
    ...
    @Deprecated
    public void authenticate(int i, CryptoObject cryptoObject, CancellationSignal cancellationSignal, AuthenticationCallback authenticationCallback, Handler handler, int i2, Bundle bundle) {
    }
