...
public class SemMediaCaptureClient extends ClientImpl {
    ...
    public SemMediaCaptureClient(IVideoTranscodingService iVideoTranscodingService, String str, int i, Map map, SemVideoTranscodingService.ProgressCallback progressCallback) {
    ...
    public void transcode() throws IOException {
        try {
            ...
            this.mFis = new FileInputStream(new File((String) this.mArgs.get(SemVideoTranscodingService.KEY_INPUT_PATH)));
