...
public abstract class ClientImpl {
    ...
    public ClientImpl(IVideoTranscodingService iVideoTranscodingService, String str, int i, Map map, SemVideoTranscodingService.ProgressCallback progressCallback) {
        this.mTranscodingService = iVideoTranscodingService;
        this.mID = str;
        this.mMode = i;
        this.mArgs = map;
