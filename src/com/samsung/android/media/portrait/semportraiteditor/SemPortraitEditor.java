...
public class SemPortraitEditor {
    ...
    public static int create(int i) {
        return PortraitController.create(i);
    }
    ...
    public static int setParam(int i, PortraitData portraitData) {
        return PortraitController.setParam(i, portraitData);
    }

    public static int getParam(int i, PortraitData portraitData) {
        return PortraitController.getParam(i, portraitData);
    }

    public static int process(int i) {
        return PortraitController.process(i);
    }
