...
public final class Sender {
    ...
    public int send(String str, long j) {
        return sendToDsms(new DsmsMessage(str, Long.valueOf(j)));
    }

    public int send(String str, String str2, long j) {
        return sendToDsms(new DsmsMessage(str, str2, Long.valueOf(j)));
    }
    ...
    private int sendToDsms(final DsmsMessage dsmsMessage) {
        ...
        DsmsLog.d(SUBTAG, "Sending message " + dsmsMessage);
    ...
    public void sendMessage(DsmsMessage dsmsMessage) {
        ...
        bundle.putString("feature", dsmsMessage.getFeatureCode());
