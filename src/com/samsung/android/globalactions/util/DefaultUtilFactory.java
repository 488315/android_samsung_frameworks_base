...
public class DefaultUtilFactory implements UtilFactory {
    ...
    public DefaultUtilFactory(Context context, SamsungGlobalActionsManager samsungGlobalActionsManager) {
        this.mContext = context;
        LogWrapper logWrapper = new LogWrapper();
        this.mProvider.put(LogWrapper.class, logWrapper);
        this.mProvider.put(SamsungGlobalActionsManager.class, samsungGlobalActionsManager);
