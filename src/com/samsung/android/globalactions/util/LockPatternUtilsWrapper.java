...
public class LockPatternUtilsWrapper {
    ...
    public boolean isKnoxguardLockEnabled() {
        return this.mLockPatternUtils.isKnoxguardLockEnabled(ActivityManager.getCurrentUser());
    }
    ...
    public void lockDownDelayed(int i) {
