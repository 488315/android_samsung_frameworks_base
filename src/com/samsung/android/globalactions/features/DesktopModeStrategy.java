...
public class DesktopModeStrategy implements InitializationStrategy, DisposingStrategy, DefaultActionsCreationStrategy {
    ...
    public DesktopModeStrategy(Context context, ExtendableGlobalActionsView extendableGlobalActionsView, DesktopModeManagerWrapper desktopModeManagerWrapper, ConditionChecker conditionChecker) {
