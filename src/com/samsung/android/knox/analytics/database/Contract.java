...
public final class Contract {
    ...
    public static class DatabaseClean {
        ...
        public static class Extra {
            ...
            public static final int REASON_FALLBACK = 1;
        ...
        public static class Field {
            ...
            public static final String REMOVED_SIZE = "removedSize";
        }
    }
    ...
    public static class Events {
        ...
        public static class Extra {
            ...
            public static final int MAX_CACHED_EVENTS = 1000;
    ...
    public static class Debug {
        ...
        public static final Uri DUMP_CACHE_URI;
        public static final String PATH = "debug";
        public static final Uri SAVE_CACHE_URI;

        public static class Extra {
            public static final String COMMAND_DUMP_CACHE = "dumpCache";
            public static final String COMMAND_RESULT_SUCCESS = "result";
            public static final String COMMAND_SAVE_CACHE = "saveCache";
        }
