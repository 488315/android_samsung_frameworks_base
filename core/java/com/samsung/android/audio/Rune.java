  ...
  static {
    ...
    SEC_AUDIO_DEFAULT_STREAM_NOTIFICATION =
        "wifi-only".equalsIgnoreCase(SystemProperties.get("ro.carrier", "Unknown").trim())
            || "yes".equalsIgnoreCase(SystemProperties.get("ro.radio.noril", "no").trim());
    ...
    SEC_AUDIO_DOLBY_GAME_FX =
        SemFloatingFeature.getInstance()
            ...
            && SemFloatingFeature.getInstance()
                .getBoolean("SEC_FLOATING_FEATURE_AUDIO_SUPPORT_DEFAULT_ON_DOLBY_IN_GAME");
    SEC_AUDIO_TRANSITION_EFFECT =
        SemFloatingFeature.getInstance()
                .getBoolean("SEC_FLOATING_FEATURE_AUDIO_SUPPORT_TRANSITION_EFFECT")
            || Build.VERSION.DEVICE_INITIAL_SDK_INT >= 30;
    ...
    SEC_AUDIO_MIC_MODE_FOR_QUICK_PANEL_UI =
        (SemFloatingFeature.getInstance()
                    ...
                    .contains("None")
                && !SemFloatingFeature.getInstance()
                    .getBoolean("SEC_FLOATING_FEATURE_AUDIO_SUPPORT_MICMODE_QUICK_PANEL")
    ...
    boolean z2 =
        SemFloatingFeature.getInstance().getInt("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_CHIP_VENDOR")
            != 0;
    SEC_AUDIO_FM_RADIO = z2;
    SEC_AUDIO_CARLIFE =
        SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_COMMON_SUPPORT_CARLIFE");
    SEC_AUDIO_BIKE_MODE =
        SemCscFeature.getInstance()
    ...
    SEC_AUDIO_VOLUME_KEY_SUPPORT_SILENT =
        TextUtils.equals(
            SemCscFeature.getInstance().getString("CscFeature_Audio_ConfigActionVolumeKey"),
            "Silent");
