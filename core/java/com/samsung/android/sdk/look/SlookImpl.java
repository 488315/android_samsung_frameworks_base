  ...
  private static void checkCocktailLevel() {
    ...
    if (sCocktailLevel == -1 && (pm = ActivityThread.getPackageManager()) != null) {
      try {
        ...
        if (i == 0) {
          sCocktailLevel =
              pm.hasSystemFeature(PackageManager.SEM_FEATURE_COCKTAIL_PANEL, 0) ? 7 : 0;
        }
    ...
    if (sHasMetaEdgeSingle == -1) {
      ...
      try {
        ...
        if (ai != null) {
          ...
          if (metaData != null
              && (value2 = metaData.getString("com.samsung.android.cocktail.mode", "")) != null
          ...
          if (sHasMetaEdgeSingle == 0) {
            ...
            for (int i = 0; i < N; i++) {
              ...
              if ((activityInfo.applicationInfo.flags & 262144) == 0
                ...
                if (metaData2 != null
                    && (value = metaData2.getString("com.samsung.android.cocktail.mode", ""))
                        != null
