...
public interface ISemContinuityManager extends IInterface {
  ...
  void registerContinuityCopyListener(
      ISemContinuitySimpleListener iSemContinuitySimpleListener, int i) throws RemoteException;
  ...
  public static class Default implements ISemContinuityManager {
    ...
    @Override // com.samsung.android.continuity.ISemContinuityManager
    public void registerContinuityCopyListener(ISemContinuitySimpleListener listener, int userId)
        throws RemoteException {}
    ...
    @Override // com.samsung.android.continuity.ISemContinuityManager
    public boolean requestDownload(String dataId, ISemContinuitySimpleListener listener, int userId)
        throws RemoteException {
      return false;
    }
  ...
  public abstract static class Stub extends Binder implements ISemContinuityManager {
    ...
    private static class Proxy implements ISemContinuityManager {
      ...
      public boolean requestDownload(
          String dataId, ISemContinuitySimpleListener listener, int userId) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(ISemContinuityManager.DESCRIPTOR);
