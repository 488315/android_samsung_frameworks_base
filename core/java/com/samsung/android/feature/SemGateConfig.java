...
public final class SemGateConfig {
    ...
    public static void setGateEnabled(boolean gateEnabled) {
        ...
        Log.m98i(LOG_TAG, "SemGateConfig.setGateEnabled. GATE = " + sGateEnabled + ", LCDTEXT = " + sGateLcdtextEnabled);
    }

    public static void setGateLcdtextEnabled(boolean lcdTextEnabled) {
        sGateLcdtextEnabled = lcdTextEnabled;
        Log.m98i(LOG_TAG, "SemGateConfig.setGateLcdtextEnabled. GATE = " + sGateEnabled + ", LCDTEXT = " + sGateLcdtextEnabled);
    }
