...
public class SemBioFaceManager {
  ...
  public static class AuthenticationResult {
    ...
    public boolean isStrongBiometric() {
      if (SemBioFaceManager.DEBUG) {
        Log.m98i(SemBioFaceManager.TAG, "isStrong = " + this.mIsStrongBiometric);
      }
  ...
  public void authenticate(
    ...
    authenticate(
        crypto, cancel, flags, callback, handler, this.mContext.getUserId(), bundle, faceView);
  }
  ...
  public void enroll(
      ...
      View faceView) {
    Log.m96e(TAG, "enroll() : this is not used");
  }
  ...
  public long preEnroll() {
    Log.m96e(TAG, "preEnroll() : this is not used");
    return 0L;
  }
  ...
  public int postEnroll() {
    Log.m96e(TAG, "postEnroll() : this is not used.");
    return 0;
  }

  public void setActiveUser(int userId) {
    Log.m96e(TAG, "setActiveUser() : this is not used");
  }

  @Deprecated
  public void remove(SemBioFace face, int userId, RemovalCallback callback) {
    Log.m96e(TAG, "remove() : this is not used");
  }
  ...
  public void rename(int faceId, int userId, String newName) {
    Log.m96e(TAG, "rename() : this is not used");
  }
  ...
  public boolean resetAuthenticationTimeout() {
    Log.m96e(TAG, "resetAuthenticationTimeout() : this is not used");
    return false;
  }
  ...
  public static int getSepMappedAcquiredInfo(int acquireInfo, int vendorCode) {
    switch (acquireInfo) {
      ...
      default:
        Log.m94d(TAG, "getSepMappedAcquiredInfo: No data, " + acquireInfo + ", " + vendorCode);
        return acquireInfo;
    }
  }
  ...
  public static int getSepMappedError(int errCode, int vendorCode) {
    switch (errCode) {
      ...
      case 14:
        break;
      default:
        Log.m94d(TAG, "getSepMappedError: No data, " + errCode + ", " + vendorCode);
        break;
    }
    return errCode;
  }
  ...
  private class MyHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      Log.m98i(
          SemBioFaceManager.TAG, "handleMessage = " + msg.what + ", " + msg.arg1 + ", " + msg.arg2);
      switch (msg.what) {
        case 101:
        ...
        case 104:
          ...
          break;
        default:
          Log.m102w(SemBioFaceManager.TAG, "handleMessage : Unknown msg");
          break;
      }
    }
  ...
  public static void setExtraInfo(Context context, Bundle b) {
    ...
    try {
      ...
      Log.m102w(TAG, "setExtraInfo: " + e.getMessage());
    }
  }
  ...
  public class FaceManagerCompat implements BiometricAuthenticator, BiometricFaceConstants {
    ...
    FaceManagerCompat(Context ctx) {
      try {
        ...
        Log.m102w(SemBioFaceManager.TAG, "FaceManagerCompat: " + e.getMessage());
      }
    }
    ...
    public void authenticate(
      ...
      Log.m96e(SemBioFaceManager.TAG, "authenticate: No impl");
    }
    ...
    public void hAuthenticate(
      ...
      Bundle b2;
      if (!this.mHasFaceHAL) {
        Log.m102w(SemBioFaceManager.TAG, "hAuthenticate: Not support Face HAL");
        ...
        if (cancel != null) {
          if (!cancel.isCanceled()) {
            ...
            Log.m102w(SemBioFaceManager.TAG, "authentication already canceled");
            return;
          }
        }
              ...
              try {
                FaceAuthenticateOptions options =
                    new FaceAuthenticateOptions.Builder()
                        .setUserId(userId)
                        .setOpPackageName(SemBioFaceManager.this.mContext.getOpPackageName())
                        .build();
                SemBioFaceManager semBioFaceManager = SemBioFaceManager.this;
                semBioFaceManager.mAuthRequestId =
                    this.mServiceHAL.semAuthenticate(
                        semBioFaceManager.mToken,
                        sessionId,
                ...
                e = e;
                Log.m102w(SemBioFaceManager.TAG, "hAuthenticate: " + e.getMessage());
    ...
    public int hGetSecurityLevel(boolean isKeyguard) {
      if (this.mHasFaceHAL) {
        try {
          ...
          Log.m102w(SemBioFaceManager.TAG, "hGetSecurityLevel: " + e.getMessage());
          return 0;
        }
      }
      return 0;
      ...
      this.mServiceReceiverHAL =
          new IFaceServiceReceiver
            ...
            public void onAcquired(int acquireInfo, int vendorCode) {
              String helpMsg =
                  FaceManager.getHelpMessage(
                      SemBioFaceManager.this.mContext, acquireInfo, vendorCode);
              int acquireInfo2 =
                  SemBioFaceManager.getSepMappedAcquiredInfo(acquireInfo, vendorCode);
              Log.m94d(SemBioFaceManager.TAG, "help = " + helpMsg);
            ...
            public void onError(int error, int vendorCode) {
              String errMsg =
                  FaceManager.getErrorString(SemBioFaceManager.this.mContext, error, vendorCode);
              SemBioFaceManager.this
                  .mHandler
                  .obtainMessage(
                      104, SemBioFaceManager.getSepMappedError(error, vendorCode), 0, errMsg)
                  .sendToTarget();
            }
