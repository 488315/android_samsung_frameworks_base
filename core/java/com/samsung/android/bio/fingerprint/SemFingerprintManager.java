...
public class SemFingerprintManager {
    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        ...
        case 103:
          ...
          break;
        default:
          Slog.m121w(SemFingerprintManager.TAG, "handleMessage : Unknown msg");
          break;
      }
    }
  }
  ...
  private SemFingerprintManager(Context context) {
    ...
    this.mServiceReceiver =
        new IFingerprintServiceReceiver
            .Stub() { // from class: com.samsung.android.bio.fingerprint.SemFingerprintManager.1
          ...
          public void onAcquired(int acquireInfo, int vendorCode) {
            SemFingerprintManager.this
                ...
                .obtainMessage(
                    100,
                    SemFingerprintManager.this.convertAcquiredCode(acquireInfo),
                    0,
                    FingerprintManager.getAcquiredString(
                        SemFingerprintManager.this.mContext, acquireInfo, vendorCode))
                .sendToTarget();
          }
            ...
            SemFingerprintManager.this
                ...
                .obtainMessage(
                    ...
                    FingerprintManager.getErrorString(
                        SemFingerprintManager.this.mContext, fpErrorCode, vendor2))
                .sendToTarget();
          }
  ...
  public void authenticate(
    ...
    if (this.mService != null) {
          ...
          try {
            ...
            final long authId =
                this.mService.semAuthenticate(
                    this.mToken, operationId, this.mServiceReceiver, options, attr2);
            if (authId < 0) {
              this.mHandler
                  .obtainMessage(103, 5, 0, FingerprintManager.getErrorString(this.mContext, 5, 0))
                  .sendToTarget();
            }
            try {
      ...
      Slog.m121w(TAG, "authentication : Service is NULL");
      handleDefaultError(callback);
    }
  }
  ...
  public static void setExtraInfo(Context context, Bundle b) {
    ...
    try {
      ...
      Slog.m121w(TAG, "setExtraInfo: " + e.getMessage());
      displayId = 0;
    }
  ...
  public void lambda$authenticate$0(long requestId) {
    ...
    if (iFingerprintService != null) {
      try {
        ...
        Slog.m121w(TAG, "Remote exception while canceling authentication : " + e.getMessage());
      }
    }
  }
