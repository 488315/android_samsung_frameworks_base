...
public class SemFingerprintManager {
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Slog.m117i(SemFingerprintManager.TAG, "handleMessage = " + msg.what + ", " + msg.arg1 + ", " + msg.arg2);
            switch (msg.what) {
                case 100:
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        final long authId = this.mService.semAuthenticate(this.mToken, operationId, this.mServiceReceiver, options, attr2);
                        if (authId < 0) {
