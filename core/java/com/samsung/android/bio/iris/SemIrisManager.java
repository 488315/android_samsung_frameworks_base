...
public class SemIrisManager {
  ...
  private static final String MANAGE_IRIS =
  ...
  private IIrisServiceReceiver mServiceReceiver =
      new IIrisServiceReceiver.Stub() { // from class: com.samsung.android.bio.iris.SemIrisManager.4
        ...
        public void onEnrollResult(long deviceId, int irisId, int groupId, int remaining) {
          SemIrisManager.this
              .mHandler
              .obtainMessage(100, remaining, 0, new Iris(null, groupId, irisId, deviceId))
              .sendToTarget();
        }
        ...
        public void onAcquired(final long deviceId, final int acquireInfo) {
          if (SemIrisManager.this.mExecutor != null) {
            Log.m100v(SemIrisManager.TAG, "BioPrompt onAcquired 1");
            SemIrisManager.this.mExecutor.execute(
                new Runnable() { // from class: com.samsung.android.bio.iris.SemIrisManager.4.1
            ...
            Log.m100v(SemIrisManager.TAG, "BioPrompt onAcquired 2");
            SemIrisManager.this
                .mHandler
                .obtainMessage(101, acquireInfo, 0, Long.valueOf(deviceId))
                .sendToTarget();
          }
        }
        ...
        public void onAuthenticationSucceeded(
            long deviceId, final Iris ir, final byte[] fidoResultData) {
          if (SemIrisManager.this.mExecutor != null) {
            Log.m100v(SemIrisManager.TAG, "BioPrompt onAuthenticationSucceeded 1");
            SemIrisManager.this.mExecutor.execute(
                new Runnable() { // from class: com.samsung.android.bio.iris.SemIrisManager.4.2
                  @Override // java.lang.Runnable
                  public void run() {
            ...
            Log.m100v(SemIrisManager.TAG, "BioPrompt onAuthenticationSucceeded 2");
        ...
        public void onAuthenticationFailed(long deviceId) {
          if (SemIrisManager.this.mExecutor != null) {
            Log.m100v(SemIrisManager.TAG, "BioPrompt onAuthenticationFailed 1");
            SemIrisManager.this.mExecutor.execute(
                new Runnable() { // from class: com.samsung.android.bio.iris.SemIrisManager.4.3
                  @Override // java.lang.Runnable
                  public void run() {
            ...
            Log.m100v(SemIrisManager.TAG, "BioPrompt onAuthenticationFailed 2");
        ...
        public void onError(final long deviceId, final int error) {
          if (SemIrisManager.this.mExecutor != null) {
            Log.m100v(SemIrisManager.TAG, "BioPrompt onError 1");
            SemIrisManager.this.mExecutor.execute(
                new Runnable() { // from class: com.samsung.android.bio.iris.SemIrisManager.4.4
                  @Override // java.lang.Runnable
                  public void run() {
            ...
            Log.m100v(SemIrisManager.TAG, "BioPrompt onError 2");
            SemIrisManager.this
                .mHandler
                .obtainMessage(104, error, 0, Long.valueOf(deviceId))
                .sendToTarget();
          }
        }
        ...
        public void onRemoved(long deviceId, int irisId, int groupId) {
          SemIrisManager.this
              .mHandler
              .obtainMessage(105, irisId, groupId, Long.valueOf(deviceId))
              .sendToTarget();
        }
  ...
  private void cancelAuthentication() {
    ...
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        ...
        Log.m102w(TAG, "Remote exception while canceling authentication");
      }
    }
  }
    ...
    if (ensureServiceConnected() && this.mService != null) {
      try {
        ...
        try {
          ...
          Log.m102w(str, "Remote exception while authenticating");
  ...
  public void checkAuthViewWindowToken(
    ...
    if (irisView.getWindowToken() == null) {
      if (System.currentTimeMillis() - this.mAuthBegin >= TelecomManager.VERY_SHORT_CALL_TIME_MS) {
        Log.m96e(TAG, "checkAuthViewWindowToken is null");
      ...
      this.mGetterHandler.postGetterCallback(
          new Runnable() { // from class: com.samsung.android.bio.iris.SemIrisManager.1
            @Override // java.lang.Runnable
            public void run() {
              SemIrisManager.this.checkAuthViewWindowToken(
                  crypto,
                  cancel,
                  flags,
                  callback,
      ...
      try {
        ...
        if (authenticationCallback != null) {
          try {
            Log.m96e(
                TAG,
                "Invalid irisView size. IrisView's proper size:"
                    + mAuthViewSize.getWidth()
                    + "x"
                    + mAuthViewSize.getHeight()
                    + ", but app's size:"
                    + irisView.getWidth()
                    + "x"
                    + irisView.getHeight());
          } catch (RemoteException e) {
            Log.m102w(TAG, "Remote exception while authenticating");
            if (authenticationCallback != null) {
              authenticationCallback.onAuthenticationError(1, getErrorString(1));
              return;
            }
  ...
  public void enroll(
    ...
    if (cancel != null) {
      if (!cancel.isCanceled()) {
        ...
        Log.m102w(TAG, "enrollment already canceled");
        return;
      }
    }
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        ...
        try {
          ...
          Log.m102w(str, "Remote exception in enroll");
  ...
  public void checkEnrollViewWindowToken(
      ...
      final int flags,
      final int userId,
      final EnrollmentCallback callback,
      final Bundle attr,
      final View irisView) {
    ...
    if (irisView.getWindowToken() == null) {
      this.mGetterHandler.postGetterCallback(
          new Runnable() { // from class: com.samsung.android.bio.iris.SemIrisManager.2
            @Override // java.lang.Runnable
            public void run() {
              SemIrisManager.this.checkEnrollViewWindowToken(
                  token, cancel, flags, userId, callback, attr, irisView);
            }
          });
      return;
    }
    this.mGetterHandler.removeAllGetterCallbacks();
    try {
      mWindowToken = irisView.getWindowToken();
      position = new int[2];
    } catch (RemoteException e) {
    }
    try {
      ...
      Log.m102w(TAG, "Remote exception in enroll");
      if (callback != null) {
        callback.onEnrollmentError(1, getErrorString(1));
      }
    }
  ...
  public int postEnroll() {
    ...
    try {
      ...
      Log.m102w(TAG, "Remote exception in post enroll");
      return 0;
    }
  }
  ...
  public void setActiveUser(int userId) {
    ...
    if (iIrisService != null) {
      try {
        ...
        Log.m102w(TAG, "Remote exception in setActiveUser");
      }
    }
  }
  ...
  public void remove(Iris ir, int userId, RemovalCallback callback) {
    ...
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        ...
        iIrisService.remove(
            this.mToken, ir.getIrisId(), ir.getGroupId(), userId, this.mServiceReceiver);
      } catch (RemoteException e) {
        Log.m102w(TAG, "Remote exception in remove");
        if (callback != null) {
  ...
  public void rename(int irId, int userId, String newName) {
    ...
    if (iIrisService != null) {
      try {
        ...
        Log.m100v(TAG, "Remote exception in rename()");
        return;
      }
    }
    Log.m102w(TAG, "rename(): Service not connected!");
  }
  ...
  public List<Iris> getEnrolledIrises(int userId) {
    ...
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        ...
        Log.m100v(TAG, "Remote exception in getEnrolledIrises");
      }
    }
    return null;
  }
  ...
  public boolean hasEnrolledIrises() {
    ...
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        return iIrisService.hasEnrolledIrises(
            UserHandle.myUserId(), this.mContext.getOpPackageName());
      } catch (RemoteException e) {
        Log.m100v(TAG, "Remote exception in getEnrolledIrises");
      }
    }
  ...
  public boolean hasDisabledIris() {
    ...
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        return iIrisService.hasDisabledIris(
            UserHandle.myUserId(), this.mContext.getOpPackageName());
      } catch (RemoteException e) {
        Log.m100v(TAG, "Remote exception in getEnrolledFaces");
      }
    }
    return false;
  }
  ...
  public boolean hasEnrolledIrises(int userId) {
    ...
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        ...
        Log.m100v(TAG, "Remote exception in getEnrolledIrises, userId : " + userId);
      }
    }
    return false;
  }
  ...
  public boolean isHardwareDetected() {
    Log.m102w(TAG, "isIrisHardwareDetected()");
  ...
  public void setIrisViewType(int irisViewType) {
    ...
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        iIrisService.setIrisViewType(
            UserHandle.myUserId(), this.mContext.getOpPackageName(), irisViewType);
      } catch (RemoteException e) {
        Log.m100v(TAG, "Remote exception in setIrisViewType");
      }
    }
  }
  ...
  public void enableIRImageCallback(boolean enabled) {
    ...
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        if (enabled) {
          iIrisService.enableIRImageCallback(
              UserHandle.myUserId(), this.mContext.getOpPackageName(), 6);
        } else {
          iIrisService.enableIRImageCallback(
              UserHandle.myUserId(), this.mContext.getOpPackageName(), 7);
        }
      } catch (RemoteException e) {
        Log.m100v(TAG, "Remote exception in enableIRImageCallback");
      }
    }
  }
  ...
  public SparseArray getEnrolledIrisUniqueID() {
    ...
    if (iIrisService != null) {
      try {
        irisList =
            iIrisService.getEnrolledIrises(UserHandle.myUserId(), this.mContext.getOpPackageName());
      } catch (RemoteException e) {
        Log.m100v(TAG, "Remote exception in getEnrolledIrises");
      }
    }
    ...
    for (Iris ir : irisList) {
      localSparseArray.put(
          index,
          byteArrayToHex(requestGetUniqueID(ir.getIrisId(), this.mContext.getOpPackageName())));
      index++;
    }
  ...
  public int request(
      int cmd, byte[] inputBuf, byte[] outputBuf, int inParam, RequestCallback callback) {
    if (!ensureServiceConnected()) {
      return 0;
    }
    IIrisService iIrisService = this.mService;
    if (iIrisService != null) {
      if (inputBuf == null) {
        try {
          ...
          Log.m100v(TAG, "Remote exception in request()");
          return -2;
        }
      }
      if (outputBuf == null) {
    ...
    Log.m102w(TAG, "request(): Service not connected!");
    return -2;
  }
  ...
  public long getAuthenticatorId() {
    ...
    if (iIrisService != null) {
      try {
        ...
        Log.m100v(TAG, "Remote exception in getAuthenticatorId()");
      }
    } else {
      Log.m102w(TAG, "getAuthenticatorId(): Service not connected!");
    }
    return 0L;
  }
  ...
  public void resetTimeout(byte[] token) {
    ...
    if (iIrisService != null) {
      try {
        ...
        Log.m100v(TAG, "Remote exception in resetTimeout()");
        return;
      }
    }
    Log.m102w(TAG, "resetTimeout(): Service not connected!");
  }
    ...
    if (this.mService != null) {
      try {
        ...
        this.mService.addLockoutResetCallback(
            new IIrisServiceLockoutResetCallback
                .Stub() { // from class: com.samsung.android.bio.iris.SemIrisManager.3
              ...
              public void onLockoutReset(long deviceId) throws RemoteException {
                final PowerManager.WakeLock wakeLock =
                    powerManager.newWakeLock(1, "lockoutResetCallback");
                wakeLock.acquire();
                SemIrisManager.this.mHandler.post(
                    new Runnable() { // from class: com.samsung.android.bio.iris.SemIrisManager.3.1
                      @Override // java.lang.Runnable
                      public void run() {
                        try {
        ...
        Log.m100v(TAG, "Remote exception in addLockoutResetCallback()");
        return;
      }
    }
    Log.m102w(TAG, "addLockoutResetCallback(): Service not connected!");
  }
  ...
  private class MyHandler extends Handler {
    ...
    private void sendIRImage(byte[] irisImage, int width, int height) {
      Log.m102w(SemIrisManager.TAG, "sendIRImage, width : " + width + " height : " + height);
    ...
    private void sendRemovedResult(long deviceId, int irisId, int groupId) {
      if (SemIrisManager.this.mRemovalCallback != null) {
        ...
        if (irisId != reqIrisId) {
          Log.m102w(SemIrisManager.TAG, "Iris id didn't match: " + irisId + " != " + reqIrisId);
        }
        if (groupId != reqGroupId) {
          Log.m102w(SemIrisManager.TAG, "Group id didn't match: " + groupId + " != " + reqGroupId);
        }
    ...
    private void sendAuthenticatedSucceededFidoResultData(byte[] fidoResultData) {
      Log.m102w(
          SemIrisManager.TAG,
          "sendAuthenticatedSucceededFidoResultData, fidoResultData : "
              + Arrays.toString(fidoResultData));
    ...
    private void sendAuthenticatedSucceeded(Iris ir) {
      Log.m102w(SemIrisManager.TAG, "sendAuthenticatedSucceeded, ir : " + ir);
      if (SemIrisManager.this.mAuthenticationCallback != null) {
        AuthenticationResult result =
            new AuthenticationResult(SemIrisManager.this.mCryptoObject, ir);
  ...
  public void sendErrorResult(long deviceId, int errMsgId) {
    Log.m102w(TAG, "sendErrorResult, errMsgId : " + errMsgId);
    if (errMsgId == 4) {
      return;
    }
  ...
  public SemIrisManager(Context context, IIrisService service) {
    ...
    if (service == null) {
      Log.m100v(TAG, "SemIrisManagerService was null");
    }
  ...
  private int getCurrentUserId() {
    try {
      return ActivityManagerNative.getDefault().getCurrentUser().f54id;
    } catch (RemoteException e) {
      Log.m102w(TAG, "Failed to get current user id\n");
      return -10000;
    }
  }
  ...
  public void cancelEnrollment() {
    IIrisService iIrisService;
    Log.m96e(TAG, "cancelEnrollment");
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        iIrisService.cancelEnrollment(this.mToken);
      } catch (RemoteException e) {
        Log.m102w(TAG, "Remote exception while canceling enrollment");
      }
    }
  }
  ...
  public void cancelAuthentication(CryptoObject cryptoObject) {
    IIrisService iIrisService;
    Log.m96e(TAG, "cancelAuthentication");
    if (ensureServiceConnected() && (iIrisService = this.mService) != null) {
      try {
        iIrisService.cancelAuthentication(this.mToken, this.mContext.getOpPackageName());
      } catch (RemoteException e) {
  ...
  private String getErrorString(int errMsg) {
    ...
    try {
      ...
      Log.m96e(TAG, "getErrorString, Exception = " + e);
      mRes = null;
    }
    if (mRes == null) {
      Log.m96e(TAG, "mRes is null");
      return null;
    }
    try {
      switch (errMsg) {
        case 0:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_sensor_no_response", "string", "com.samsung.android.server.iris"));
        case 1:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_unable_to_process", "string", "com.samsung.android.server.iris"));
        case 2:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_timeout", "string", "com.samsung.android.server.iris"));
        case 3:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_no_space", "string", "com.samsung.android.server.iris"));
        case 4:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_canceled", "string", "com.samsung.android.server.iris"));
        case 5:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_unable_to_remove", "string", "com.samsung.android.server.iris"));
        case 6:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_lockout", "string", "com.samsung.android.server.iris"));
        case 7:
          return "";
        case 8:
          return "";
        case 9:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_eye_safety_timeout", "string", "com.samsung.android.server.iris"));
        case 10:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_auth_view_size", "string", "com.samsung.android.server.iris"));
        case 12:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_proximity_timeout", "string", "com.samsung.android.server.iris"));
        case 13:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_evicted", "string", "com.samsung.android.server.iris"));
        case 14:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_video_call_interrupt", "string", "com.samsung.android.server.iris"));
        case 15:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_no_eye_detected", "string", "com.samsung.android.server.iris"));
        case 17:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_flip_off", "string", "com.samsung.android.server.iris"));
        case 18:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_need_set_lock_type", "string", "com.samsung.android.server.iris"));
        case 19:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_while_camera_in_use", "string", "com.samsung.android.server.iris"));
        case 20:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_unsupported_orientation",
                  "string",
        ...
        case 123:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_proximity_alert", "string", "com.samsung.android.server.iris"));
        default:
          return mRes.getString(
              mRes.getIdentifier(
                  "iris_error_unable_to_process", "string", "com.samsung.android.server.iris"));
      ...
      Log.m94d(TAG, "getErrorString, NotFoundException = " + e2);
      return null;
    }
  }
  ...
  private String getAcquiredString(int acquireInfo) {
    ...
    try {
      ...
      Log.m96e(TAG, "getAcquiredString, Exception = " + e);
      mRes = null;
    }
    if (mRes == null) {
      Log.m96e(TAG, "mRes is null");
    ...
    try {
      ...
      Log.m94d(TAG, "getAcquiredString, NotFoundException = " + e2);
      return null;
    }
    return null;
  }
  ...
  private void startIrisService() {
    try {
      ...
      intent.setComponent(
          new ComponentName(
              "com.samsung.android.server.iris", "com.samsung.android.server.iris.IrisService"));
      this.mContext.startServiceAsUser(intent, UserHandle.CURRENT_OR_SELF);
    } catch (Exception e) {
      Log.m96e(TAG, "Starting startIrisService failed: " + e);
    }
  }

  private void waitForService() {
    for (int count = 1; count <= 20; count++) {
      IIrisService asInterface =
          IIrisService.Stub.asInterface(ServiceManager.getService("samsung.iris"));
      this.mService = asInterface;
      if (asInterface != null) {
        Log.m100v(TAG, "Service connected!");
        return;
      }
      try {
        Thread.sleep(50L);
