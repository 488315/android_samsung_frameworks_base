...
public class SemIrisManager {
        ...
        try {
            ...
            try {
                ...
                if (authenticationCallback != null) {
                    try {
                        Log.m96e(TAG, "Invalid irisView size. IrisView's proper size:" + mAuthViewSize.getWidth() + "x" + mAuthViewSize.getHeight() + ", but app's size:" + irisView.getWidth() + "x" + irisView.getHeight());
                    } catch (RemoteException e) {
    ...
    private class MyHandler extends Handler {
        ...
        private void sendAuthenticatedSucceededFidoResultData(byte[] fidoResultData) {
            Log.m102w(SemIrisManager.TAG, "sendAuthenticatedSucceededFidoResultData, fidoResultData : " + Arrays.toString(fidoResultData));
