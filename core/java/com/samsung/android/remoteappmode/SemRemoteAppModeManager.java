...
public final class SemRemoteAppModeManager {
  ...
  private Map<RotationChangedListener, RotationChangedListenerDelegate> mRotationChangedListeners =
      null;
  ...
  public void unregisterRotationChangeListener(RotationChangedListener listener) {
    synchronized (sLock) {
      ...
      Map<RotationChangedListener, RotationChangedListenerDelegate> map =
          this.mRotationChangedListeners;
      if (map == null) {
        return;
      }
  ...
  public void unregisterSecureAppChangedListener(SecureAppChangedListener listener) {
    synchronized (sLock) {
      ...
      Map<SecureAppChangedListener, SecureAppChangedListenerDelegate> map =
          this.mSecureAppChangedListeners;
      if (map == null) {
        return;
      }
  ...
  public void clearAll() {
    synchronized (sLock) {
      try {
        ...
        Map<SecureAppChangedListener, SecureAppChangedListenerDelegate> map2 =
            this.mSecureAppChangedListeners;
        if (map2 != null) {
          map2.clear();
        }
        Map<StartActivityInterceptedListener, StartActivityInterceptedListenerDelegate> map3 =
            this.mStartActivityInterceptedListeners;
        if (map3 != null) {
          map3.clear();
        }
      } catch (RemoteException e) {
  ...
  private static class RemoteAppModeListenerDelegate extends IRemoteAppModeListener.Stub {
    ...
    public void onRemoteAppModeStateChanged(boolean isEnabled) throws RemoteException {
      ...
      if (listener != null) {
        Log.m94d(
            SemRemoteAppModeManager.TAG,
            "onRemoteAppModeStateChanged() isEnabled=" + isEnabled + ", listener=" + listener);
