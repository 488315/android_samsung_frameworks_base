...
public final class SemRemoteAppModeManager {
    ...
    private static class VirtualDisplayAliveCheckerDelegate extends IVirtualDisplayAliveChecker.Stub {
        ...
        public void onVirtualDisplayCreated(int displayId) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onVirtualDisplayCreated() displayId=" + displayId);
        ...
        public void onVirtualDisplayReleased(int displayId) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onVirtualDisplayReleased() displayId=" + displayId);
    ...
    private static class TaskChangeListenerDelegate extends ITaskChangeListener.Stub {
        ...
        public void onTaskRemoved(int taskId) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onTaskRemoved() taskId=" + taskId + ", listener=" + listener);
        ...
        public void onTaskPlayed(int taskId, int displayId) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onTaskPlayed() taskId=" + taskId + ", listener=" + listener + ", displayId=" + displayId);
        ...
        public void onTaskTriedToGoToBackground(int taskId, int displayId) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onTaskTriedToGoToBackground() taskId=" + taskId + ", listener=" + listener + ", displayId=" + displayId);
        ...
        public void onTaskDisplayChanged(int taskId, int newDisplayId) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onTaskDisplayChanged() taskId=" + taskId + ", listener=" + listener + ", displayId=" + newDisplayId);
        ...
        public void onRecentTaskListUpdated() throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onTaskStackUpdated()");
    ...
    public void registerTaskChangeListener(TaskChangeListener listener) {
        synchronized (sLock) {
            if (listener == null) {
                Log.m102w(TAG, "registerTaskChangeListener: Listener is null");
                return;
            }
            ...
            if (this.mTaskChangeListeners.containsKey(listener)) {
                Log.m102w(TAG, "registerTaskChangeListener: " + listener + " already registered");
                return;
            }
            ...
            try {
                ...
                Log.m98i(TAG, "registerTaskChangeListener: " + listener);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
        }
    ...
    public void unregisterTaskChangeListener(TaskChangeListener listener) {
        synchronized (sLock) {
            if (listener == null) {
                Log.m102w(TAG, "unregisterTaskChangeListener: Listener is null");
                return;
            }
            ...
            if (delegate == null) {
                Log.m102w(TAG, "unregisterTaskChangeListener: " + listener + " already unregistered");
                return;
            }
            ...
            try {
                ...
                Log.m98i(TAG, "unregisterTaskChangeListener: " + listener);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
    ...
    private static class RotationChangedListenerDelegate extends IRotationChangeListener.Stub {
        ...
        public void onRotationChanged(int displayId, int rotation) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onRotationChanged() displayId=" + displayId + ", rotation=" + rotation + ", listener=" + listener);
    ...
    public void registerRotationChangeListener(RotationChangedListener listener, int displayId) {
        synchronized (sLock) {
            if (listener == null) {
                Log.m102w(TAG, "registerRotationChangeListener: Listener is null");
                return;
            }
            ...
            try {
                ...
                Log.m98i(TAG, "registerRotationChangeListener: " + listener);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
        }
    ...
    public void unregisterRotationChangeListener(RotationChangedListener listener) {
        synchronized (sLock) {
            if (listener == null) {
                Log.m102w(TAG, "unregisterRotationChangeListener: Listener is null");
                return;
            }
            ...
            if (delegate == null) {
                Log.m102w(TAG, "unregisterRotationChangeListener: " + listener + " already unregistered");
                return;
            }
            ...
            try {
                ...
                Log.m98i(TAG, "unregisterRotationChangeListener: " + listener);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
            delegate.nullOutListenerLocked();
    ...
    private static class SecureAppChangedListenerDelegate extends ISecureAppChangedListener.Stub {
        ...
        public void onSecuredAppLaunched(int taskId, String packageName) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onSecuredAppLaunched() taskId=" + taskId + ", packageName=" + packageName + ", listener=" + listener);
        ...
        public void onSecuredAppRemoved(int taskId, String packageName) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onSecuredAppRemoved() taskId=" + taskId + ", packageName=" + packageName + ", listener=" + listener);
    ...
    public void registerSecureAppChangedListener(SecureAppChangedListener listener) {
        synchronized (sLock) {
            if (listener == null) {
                Log.m102w(TAG, "registerSecureAppChangedListener: Listener is null");
                return;
            }
            ...
            if (this.mSecureAppChangedListeners.containsKey(listener)) {
                Log.m102w(TAG, "registerSecureAppChangedListener: " + listener + " already registered");
                return;
            }
            ...
            try {
                ...
                Log.m98i(TAG, "registerSecureAppChangedListener: " + listener);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
        }
    ...
    public void unregisterSecureAppChangedListener(SecureAppChangedListener listener) {
        synchronized (sLock) {
            if (listener == null) {
                Log.m102w(TAG, "unregisterSecureAppChangedListener: Listener is null");
                return;
            }
            ...
            if (delegate == null) {
                Log.m102w(TAG, "unregisterSecureAppChangedListener: " + listener + " already unregistered");
                return;
            }
            ...
            try {
                ...
                Log.m98i(TAG, "unregisterSecureAppChangedListener: " + listener);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
            delegate.nullOutListenerLocked();
    ...
    private static class StartActivityInterceptedListenerDelegate extends IStartActivityInterceptListener.Stub {
        ...
        public void onStartActivityIntercepted(Intent intent, Bundle activityOptionsBundle, ActivityInfo activityInfo, int interceptedDisplayId, boolean isVisibleTask, int runningTaskId, int runningTaskDisplayId, int interceptReason) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onStartActivityIntercepted() interceptedDisplayId=" + interceptedDisplayId + ", intent=" + intent.toString() + ", listener=" + listener);
    ...
    private static class RemoteAppModeListenerDelegate extends IRemoteAppModeListener.Stub {
        ...
        public void onRemoteAppModeStateChanged(boolean isEnabled) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemRemoteAppModeManager.TAG, "onRemoteAppModeStateChanged() isEnabled=" + isEnabled + ", listener=" + listener);
    ...
    public void registerRemoteAppModeListener(RemoteAppModeListener listener) {
        synchronized (sLock) {
            if (listener == null) {
                Log.m102w(TAG, "registerRemoteAppModeListener: Listener is null");
                return;
            }
            ...
            if (this.mRemoteAppModeListeners.containsKey(listener)) {
                Log.m102w(TAG, "registerRemoteAppModeListener: " + listener + " already registered");
                return;
            }
            ...
            try {
                ...
                Log.m98i(TAG, "registerRemoteAppModeListener: " + listener);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
        }
    ...
    public void unregisterRemoteAppModeListener(RemoteAppModeListener listener) {
        synchronized (sLock) {
            if (listener == null) {
                Log.m102w(TAG, "unregisterRemoteAppModeListener: Listener is null");
                return;
            }
            ...
            if (delegate == null) {
                Log.m102w(TAG, "unregisterRemoteAppModeListener: " + listener + " already unregistered");
                return;
            }
            ...
            try {
                ...
                Log.m98i(TAG, "unregisterRemoteAppModeListener: " + listener);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
            delegate.nullOutListenerLocked();
