...
public interface IRemoteAppMode extends IInterface {
  ...
  boolean registerRotationChangeListener(
      IRotationChangeListener iRotationChangeListener, String str, int i) throws RemoteException;
  ...
  boolean sendNotificationAction(StatusBarNotification statusBarNotification, int i, Intent intent)
      throws RemoteException;
  ...
  public static class Default implements IRemoteAppMode {
    ...
    @Override // com.samsung.android.remoteappmode.IRemoteAppMode
    public boolean registerSecureAppChangedListener(ISecureAppChangedListener listener, String name)
        throws RemoteException {
      return false;
    }
    ...
    public boolean registerRotationChangeListener(
        IRotationChangeListener listener, String name, int displayId) throws RemoteException {
      return false;
    }
    ...
    @Override // com.samsung.android.remoteappmode.IRemoteAppMode
    public boolean unregisterStartActivityInterceptListener(IStartActivityInterceptListener listner)
        throws RemoteException {
      return false;
    }
    ...
    public void transferTaskWithoutIntercept(
        int taskId, int targetDisplayId, Bundle activityOptionsBundle) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 13:
              IStartActivityInterceptListener _arg012 =
                  IStartActivityInterceptListener.Stub.asInterface(data.readStrongBinder());
            ...
            case 20:
              StatusBarNotification _arg017 =
                  (StatusBarNotification) data.readTypedObject(StatusBarNotification.CREATOR);
              data.enforceNoDataAvail();
