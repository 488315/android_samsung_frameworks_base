...
public final class SemMobileWipsScanResultAdapter implements Parcelable {
    ...
    public SemMobileWipsScanResultAdapter(SemMobileWipsWifiSsid wifiSsid, String BSSID, long hessid, int anqpDomainId, byte[] osuProviders, String caps, int level, int frequency, long tsf) {
        ...
        if (osuProviders != null) {
            this.anqpElements = new AnqpInformationElement[]{new AnqpInformationElement(5271450, 8, osuProviders)};
        }
    ...
    public static class InformationElement implements Parcelable {
        ...
        public boolean equals(Object that) {
            ...
            return this.f3091id == thatIE.f3091id && this.idExt == thatIE.idExt && Arrays.equals(this.bytes, thatIE.bytes);
        }

        public int hashCode() {
            return Objects.hash(Integer.valueOf(this.f3091id), Integer.valueOf(this.idExt), Integer.valueOf(Arrays.hashCode(this.bytes)));
        }
    }
}
