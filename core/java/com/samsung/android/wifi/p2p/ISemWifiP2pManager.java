...
public interface ISemWifiP2pManager extends IInterface {
  ...
  void setPreparedAccountPin(
      String str, String str2, String str3, ISemWifiP2pCallback iSemWifiP2pCallback)
  ...
  public static class Default implements ISemWifiP2pManager {
    ...
    public void setPreparedAccountPin(
        String pin, String hexEncData, String hexIv, ISemWifiP2pCallback callback)
        throws RemoteException {}
