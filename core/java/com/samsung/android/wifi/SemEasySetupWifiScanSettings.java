...
public class SemEasySetupWifiScanSettings implements Parcelable {
    public static final Parcelable.Creator<SemEasySetupWifiScanSettings> CREATOR =
            new Parcelable.Creator<
                ...
                public SemEasySetupWifiScanSettings createFromParcel(Parcel in) {
                    ...
                    settings.pendingIntentForIdlePopup =
                            (PendingIntent) in.readParcelable(PendingIntent.class.getClassLoader());
                    settings.pendingIntentForSettings =
                            (PendingIntent) in.readParcelable(PendingIntent.class.getClassLoader());
    ...
    public boolean isActiveSeparateNetworkList() {
        return (this.ssidPatterns.isEmpty() || this.pendingIntentForSettings == null)
                ? false
                : true;
    }

    public boolean isActiveDeviceDetectionInIdle() {
        return (this.ssidPatterns.isEmpty() || this.pendingIntentForIdlePopup == null)
                ? false
                : true;
    }
