...
public interface ISemMobileWipsPacketSender extends IInterface {
  ...
  public static class Default implements ISemMobileWipsPacketSender {
    ...
    public List<String> sendArpToSniffing(
        int timeoutMillis, byte[] gateway, byte[] myAddr, String myMac) throws RemoteException {
      return null;
    }

    @Override // com.samsung.android.wifi.ISemMobileWipsPacketSender
    public List<String> sendIcmp(int timeoutMillis, byte[] gateway, byte[] myAddr, String dstMac)
        throws RemoteException {
      return null;
    }
    ...
    @Override // com.samsung.android.wifi.ISemMobileWipsPacketSender
    public boolean pingTcp(byte[] srcAddr, byte[] dstAddr, int dstPort, int ttl, int timeoutMillis)
        throws RemoteException {
      return false;
    }
