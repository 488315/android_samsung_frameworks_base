...
public class SemWifiApCust {
  ...
  public static boolean isProvisioningNeeded() {
    ...
    if (isTablet() && !"ATT".equals(CONFIGOPBRANDINGFORMOBILEAP)) {
      Log.m94d(
          TAG,
          "isProvisioningNeeded: false, isTablet: true, operator:" + CONFIGOPBRANDINGFORMOBILEAP);
      return false;
    }
    String[] provisioningSalesCodes = {
      "VZW", "ATT", "AIO", "XAR", "TFV", "TFA", "TFN", "LLA", "DSA", "APP", "XAA"
    };
  ...
  public static void readTempConfig() {
    ...
    if (file2.exists()) {
      mMHSCustomer = "all";
      Log.m94d(
          TAG, "/data/misc/wifi_hostapd/testconf/all is exist! temp mMHSCustomer: " + mMHSCustomer);
      return;
    }
    ...
    if (file3.exists()) {
      mMHSCustomer = "TMO";
      Log.m94d(
          TAG, "/data/misc/wifi_hostapd/testconf/tmo is exist! temp mMHSCustomer: " + mMHSCustomer);
      return;
    }
    ...
    if (file4.exists()) {
      mMHSCustomer = "ATT";
      Log.m94d(
          TAG, "/data/misc/wifi_hostapd/testconf/att is exist! temp mMHSCustomer: " + mMHSCustomer);
      return;
    }
    ...
    if (file5.exists()) {
      mMHSCustomer = "SPRINT";
      Log.m94d(
          TAG, "/data/misc/wifi_hostapd/testconf/spr is exist! temp mMHSCustomer: " + mMHSCustomer);
      return;
    }
    ...
    if (file6.exists()) {
      mMHSCustomer = "LGT";
      Log.m94d(
          TAG, "/data/misc/wifi_hostapd/testconf/lgt is exist! temp mMHSCustomer: " + mMHSCustomer);
      return;
    }
    ...
    if (file7.exists()) {
      ...
      Log.m94d(
          TAG,
          "/data/misc/wifi_hostapd/testconf/newco is exist! temp mMHSCustomer: " + mMHSCustomer);
      return;
    }
    ...
    if (file8.exists()) {
      mMHSCustomer = "USC";
      Log.m94d(
          TAG, "/data/misc/wifi_hostapd/testconf/usc is exist! temp mMHSCustomer: " + mMHSCustomer);
      return;
    }
    ...
    if (file9.exists()) {
      mMHSCustomer = "VZW";
      Log.m94d(
          TAG, "/data/misc/wifi_hostapd/testconf/vzw is exist! temp mMHSCustomer: " + mMHSCustomer);
    }
  }
}
