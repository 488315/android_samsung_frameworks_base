...
public final class SemMobileWipsScanResult implements Parcelable {
  ...
  public static final Parcelable.Creator<SemMobileWipsScanResult> CREATOR =
      new Parcelable.Creator<
        ...
        public SemMobileWipsScanResult createFromParcel(Parcel in) {
          ...
          SemMobileWipsScanResult sr =
              new SemMobileWipsScanResult(
                  wifiSsid,
                  in.readString(),
                  in.readString(),
                  in.readLong(),
          ...
          if (n3 != 0) {
            ...
            for (int i3 = 0; i3 < n3; i3++) {
              ...
              sr.radioChainInfos[i3].f3090id = in.readInt();
  ...
  public void writeToParcel(Parcel parcel, int i) {
    ...
    if (radioChainInfoArr != null) {
      ...
      while (true) {
        ...
        parcel.writeInt(radioChainInfoArr2[i3].f3090id);
  ...
  public static class RadioChainInfo {
    ...
    public String toString() {
      return "RadioChainInfo: id=" + this.f3090id + ", level=" + this.level;
    }
    ...
    public boolean equals(Object otherObj) {
      ...
      return this.f3090id == other.f3090id && this.level == other.level;
    }

    public int hashCode() {
      return Objects.hash(Integer.valueOf(this.f3090id), Integer.valueOf(this.level));
    }
  }
  ...
  public static class InformationElement implements Parcelable {
    public static final Parcelable.Creator<InformationElement> CREATOR =
        new Parcelable.Creator<
          ...
          public InformationElement createFromParcel(Parcel in) {
            ...
            informationElement.f3089id = in.readInt();
    ...
    public boolean equals(Object that) {
      ...
      return this.f3089id == thatIE.f3089id
