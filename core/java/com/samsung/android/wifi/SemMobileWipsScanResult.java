...
public final class SemMobileWipsScanResult implements Parcelable {
    ...
    public static class InformationElement implements Parcelable {
        ...
        public boolean equals(Object that) {
            ...
            return this.f3089id == thatIE.f3089id && this.idExt == thatIE.idExt && Arrays.equals(this.bytes, thatIE.bytes);
        }

        public int hashCode() {
            return Objects.hash(Integer.valueOf(this.f3089id), Integer.valueOf(this.idExt), Integer.valueOf(Arrays.hashCode(this.bytes)));
        }
    }
}
