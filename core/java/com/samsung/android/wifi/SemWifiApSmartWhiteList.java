...
public class SemWifiApSmartWhiteList {
        ...
        try {
          fw =
              new OutputStreamWriter(
                  new FileOutputStream("/data/misc/wifi_hostapd/smart_tethering.accept"),
  ...
  public int addWhiteList(String mac, String name, int devicetype) {
    synchronized (mSmartWhiteList) {
      ...
      Log.m98i(this.TAG, "addWhiteList, size is " + mSmartWhiteList.size());
      writeWhiteListFile();
      return 1;
    }
  }
    ...
    synchronized (mSmartWhiteList) {
      ...
      while (it.hasNext()) {
        ...
        if (wl.getMac().equalsIgnoreCase(mac)) {
          Log.m98i(this.TAG, "removeWhiteList::" + mac.substring(9));
  ...
  public void resetWhitelist() {
    synchronized (mSmartWhiteList) {
      readWhiteListFile();
      mSmartWhiteList.clear();
      Log.m96e(this.TAG, "resetWhitelist");
      writeWhiteListFile();
    }
  }
