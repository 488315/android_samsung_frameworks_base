...
public final class SemDesktopModeManager {
    ...
    private static class DesktopModeListenerDelegate extends IDesktopModeListener.Stub {
        ...
        public void onDesktopModeStateChanged(SemDesktopModeState state) throws RemoteException {
            ...
            if (listener != null) {
                Log.m94d(SemDesktopModeManager.TAG, "onDesktopModeStateChanged() state=" + state + ", listener=" + listener);
    ...
    public static void registerListener(EventListener listener) {
        Log.m102w(TAG, "registerListener(EventListener) is removed.  Please use registerListener(DesktopModeListener) instead.");
    }
    ...
    public static void unregisterListener(EventListener listener) {
        Log.m102w(TAG, "unregisterListener(EventListener) is removed.  Please use unregisterListener(DesktopModeListener) instead.");
    }
    ...
    public static boolean isDesktopDockConnected() {
        Log.m102w(TAG, "isDesktopDockConnected() is removed. Please use Intent.ACTION_DOCK_EVENT sticky broadcast instead");
        return false;
    }

    @Deprecated
    public static boolean isDesktopMode() {
        Log.m102w(TAG, "isDesktopMode() is removed. Please check Configuration.semDesktopModeEnabled instead, or consider using getDesktopModeState() instead.");
        return false;
    }
