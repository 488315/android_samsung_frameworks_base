...
public final class EyeInfo implements Parcelable {
  public static final Parcelable.Creator<EyeInfo> CREATOR =
      new Parcelable.Creator<EyeInfo>() { // from class: com.samsung.android.camera.iris.EyeInfo.1
  ...
  public EyeInfo(
      PupilInfo[] pupilInfo, ReflectionInfo[] reflectionInfo, int acquireInfo, int reflectionNum) {
