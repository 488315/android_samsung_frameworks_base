...
public interface IIrisDaemon extends IInterface {
  ...
  public static class Default implements IIrisDaemon {
    ...
    @Override // com.samsung.android.camera.iris.IIrisDaemon
    public void sendIRProperty(String key, String currentValue, String minValue, String maxValue)
        throws RemoteException {}
    ...
    @Override // com.samsung.android.camera.iris.IIrisDaemon
    public void processFrontImage(ParcelFileDescriptor frontFd, int width, int height, int rotation)
        throws RemoteException {}
