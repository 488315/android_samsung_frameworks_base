      ...
      public GetResourceInfoReturn getResourceInfo(int type) throws RemoteException {
        ...
        try {
          ...
          GetResourceInfoReturn _result =
              (GetResourceInfoReturn) _reply.readTypedObject(GetResourceInfoReturn.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public GetCodecCapacityReturn getCodecCapacity(int param) throws RemoteException {
        ...
        try {
          ...
          GetCodecCapacityReturn _result =
              (GetCodecCapacityReturn) _reply.readTypedObject(GetCodecCapacityReturn.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
