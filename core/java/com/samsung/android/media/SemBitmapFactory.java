...
public class SemBitmapFactory {
    ...
    private static void loadLibrary() {
        if (!mLibraryLoaded) {
            try {
                ...
                Log.m96e(TAG, "Unable to load the native library : " + ule);
            }
        }
    }
    ...
    public static Bitmap decodeFile(String path, BitmapFactory.Options opts) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "decodeFile - mLibraryLoaded is false");
            return null;
        }
        Log.m94d(TAG, "decodeFile e");
        if (opts != null) {
            Log.m94d(TAG, "opts.semInApplyPhotoHdr:" + opts.semInApplyPhotoHdr + "  opts.semInCreateGainmap:" + opts.semInCreateGainmap);
            if (opts.inBitmap != null) {
                ...
                if (opts.inBitmap.hasGainmap()) {
                    Log.m94d(TAG, "set inBitmap Gainmap to null");
                    opts.inBitmap.setGainmap(null);
                }
            }
        } else {
            Log.m94d(TAG, "opts null");
        }
        if (path == null) {
            return null;
        }
        ...
        if (opts != null && opts.semInApplyPhotoHdr) {
            Log.m94d(TAG, "decodeFile opts.semInApplyPhotoHdr true");
            return decodePhotoHdrFile(path, opts);
        }
        Log.m94d(TAG, "decodeFile opts.semInApplyPhotoHdr x");
    ...
    public static Bitmap decodeFileDescriptor(FileDescriptor fd, BitmapFactory.Options opts) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "decodeFileDescriptor - mLibraryLoaded is false");
            return null;
        }
        if (fd == null) {
            return null;
    ...
    public static Bitmap decodeStream(InputStream is, BitmapFactory.Options opts) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "decodeStream - mLibraryLoaded is false");
            return null;
        }
        if (is == null) {
            return null;
    ...
    public static Bitmap decodeByteArray(byte[] data, int offset, int length, BitmapFactory.Options opts) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "decodeByteArray - mLibraryLoaded is false");
            return null;
        }
        Log.m94d(TAG, "decodeByteArray e");
        if (opts != null) {
            Log.m94d(TAG, "opts.semInApplyPhotoHdr:" + opts.semInApplyPhotoHdr + "  opts.semInCreateGainmap:" + opts.semInCreateGainmap);
            if (opts.inBitmap != null) {
                if (opts.inBitmap.getConfig() == Bitmap.Config.HARDWARE) {
        ...
        if (opts != null && opts.semInApplyPhotoHdr) {
            Log.m94d(TAG, "decodeByteArray opts.semInApplyPhotoHdr true");
            return decodePhotoHdrByteArray(data, offset, length, opts);
        }
        Log.m94d(TAG, "decodeByteArray opts.semInApplyPhotoHdr decode x");
    ...
    public static Bitmap decodeThumbnailFile(String path, BitmapFactory.Options opts) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "decodeThumbnailFile - mLibraryLoaded is false");
            return null;
        }
        if (path == null) {
            return null;
    ...
    public static Bitmap decodeThumbnailFileDescriptor(FileDescriptor fd, BitmapFactory.Options opts) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "decodeThumbnailFileDescriptor - mLibraryLoaded is false");
            return null;
        }
        if (fd == null) {
            return null;
    ...
    public static Bitmap decodeThumbnailStream(InputStream is, BitmapFactory.Options opts) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "decodeThumbnailStream - mLibraryLoaded is false");
            return null;
        }
        if (is == null) {
            return null;
    ...
    public static Bitmap decodeThumbnailByteArray(byte[] data, int offset, int length, BitmapFactory.Options opts) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "decodeThumbnailByteArray - mLibraryLoaded is false");
            return null;
        }
        if (data == null) {
            return null;
    ...
    public static byte[] getExifDataFile(String path) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "getExifDataFile - mLibraryLoaded is false");
            return null;
        }
        if (path == null) {
            return null;
    ...
    public static byte[] getExifDataFileDescriptor(FileDescriptor fd) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "getExifDataFileDescriptor - mLibraryLoaded is false");
            return null;
        }
        if (fd == null) {
            return null;
    ...
    public static byte[] getExifDataStream(InputStream is) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "getExifDataStream - mLibraryLoaded is false");
            return null;
        }
        if (is == null) {
            return null;
    ...
    public static byte[] getExifDataByteArray(byte[] data, int offset, int length) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "getExifDataByteArray - mLibraryLoaded is false");
            return null;
        }
        if (data == null) {
            return null;
    ...
    public static byte[] getIccDataFile(String path) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "getIccDataFile - mLibraryLoaded is false");
            return null;
        }
        if (path == null) {
            return null;
    ...
    public static byte[] getIccDataByteArray(byte[] data, int offset, int length) {
        if (!mLibraryLoaded) {
            Log.m96e(TAG, "getIccDataByteArray - mLibraryLoaded is false");
            return null;
        }
        if (data == null) {
            return null;
