    ...
    public static class TrackInfo implements Parcelable {
        ...
        TrackInfo(Parcel in) {
            ...
            if (readInt == 1) {
                ...
                Log.m98i(TAG, "videotype mime : " + this.mMime + ", language : " + this.mLanguage + ", rotation : " + this.mRotationDegrees + ", width : " + this.mVideoWidth + ", height : " + this.mVideoHeight + ", fps : " + this.mFrameRate);
            } else if (readInt == 2) {
                this.mSampleRate = in.readInt();
                this.mChannel = in.readInt();
                Log.m98i(TAG, "audiotype mime : " + this.mMime + ", language : " + this.mLanguage + ", samplingrate : " + this.mSampleRate + ", channel : " + this.mChannel);
