                  ...
                  try {
                    ...
                    while (true) {
                      if (VideoTranscodingService.this.mStartingTasks.size() != 0) {
                        ...
                        if (top.getState() == 0) {
                          Log.m98i(
                              VideoTranscodingService.TAG,
                              "Task(" + top.getID() + ") has been started");
                          top.start();
        ...
        task.linkToDeath(
            new IBinder
                .DeathRecipient() { // from class:
                                    // com.samsung.android.media.codec.VideoTranscodingService.2
              @Override // android.os.IBinder.DeathRecipient
              public void binderDied() {
                Log.m96e(
                    VideoTranscodingService.TAG,
                    "binderDied: task(" + task.getID() + NavigationBarInflaterView.KEY_CODE_END);
                try {
