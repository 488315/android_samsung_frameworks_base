    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (this.mVideoFrameDecoder.mNativeContext == 0) {
                Log.m102w(SemAsyncVideoFrameDecoder.TAG, "VideoFrameDecoder went away with unhandled events");
            }
            switch (msg.what) {
                case 1:
                    ...
                    break;
                case 100:
                    Log.m96e(SemAsyncVideoFrameDecoder.TAG, "Error (" + msg.arg1 + "," + msg.arg2 + NavigationBarInflaterView.KEY_CODE_END);
                    ...
                    if (!error_was_handled) {
                        Log.m98i(SemAsyncVideoFrameDecoder.TAG, "Error is not handled(" + msg.arg1 + "," + msg.arg2 + NavigationBarInflaterView.KEY_CODE_END);
                        break;
                    }
                    break;
                case 200:
