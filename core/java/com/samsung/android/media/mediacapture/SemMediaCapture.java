...
public final class SemMediaCapture {
  ...
  public abstract static class BackgroundMusic {
    ...
    protected Parcel writeToParcel() {
      ...
      Log.m98i(SemMediaCapture.TAG, "BackgroundMusic size : " + this.mBGMInfos.size());
      for (int i = 0; i < this.mBGMInfos.size(); i++) {
        p.writeFileDescriptor(this.mBGMInfos.get(i).f3031fd);
    ...
    protected BGMInfo addInfo(
      ...
      bgmInfo.f3031fd = afd.getFileDescriptor();
    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        ...
        case 100:
          ...
          break;
        default:
          Log.m96e(SemMediaCapture.TAG, "Unknown message type " + msg.what);
          break;
      }
    }
  }
