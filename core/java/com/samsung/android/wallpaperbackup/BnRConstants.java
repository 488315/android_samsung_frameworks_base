...
public class BnRConstants {
    ...
    public static final String LIVE_WALLPAPER_COMPONENT =
    ...
    public static final String RESPONSE_BACKUP_LOCKSCREEN =
            "com.samsung.android.intent.action.RESPONSE_BACKUP_LOCKSCREEN";
    public static final String RESPONSE_BACKUP_WALLPAPER =
            "com.samsung.android.intent.action.RESPONSE_BACKUP_WALLPAPER";
    public static final String RESPONSE_RESTORE_LOCKSCREEN =
            "com.samsung.android.intent.action.RESPONSE_RESTORE_LOCKSCREEN";
    public static final String RESPONSE_RESTORE_WALLPAPER =
            "com.samsung.android.intent.action.RESPONSE_RESTORE_WALLPAPER";
    ...
    public static final String SETTINGS_KEYGUARD_TRANSPARENCY_DEX =
            "dex_lockscreen_wallpaper_transparency";
    public static final String SETTINGS_KEYGUARD_TRANSPARENCY_SUB_DISPLAY =
            "sub_display_lockscreen_wallpaper_transparency";
    public static final String SETTINGS_SYSTEM_TRANSPARENCY =
            "android.wallpaper.settings_systemui_transparency";
    public static final String SETTINGS_SYSTEM_TRANSPARENCY_DEX =
            "dex_system_wallpaper_transparency";
    public static final String SETTINGS_SYSTEM_TRANSPARENCY_SUB_DISPLAY =
            "sub_display_system_wallpaper_transparency";
    ...
    public static final String SUB_DISPLAY_LOCK_XML_ORIGINAL_NAME =
            "sub_display_lock_wallpaper_original.xml";
    ...
    public static final String WALLPAPER_VIDEO_RESTORE_PATH =
            "/data/user_de/0/com.android.systemui/files";
}
