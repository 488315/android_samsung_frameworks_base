...
public class FrontLargeDisplayStrategy implements SecureConfirmStrategy, DisposingStrategy {
          ...
          sFoldStateListener =
              new SemWindowManager
                ...
                public void onFoldStateChanged(boolean isFolded) {
                  if (!isFolded) {
                    FrontLargeDisplayStrategy.this.mLogWrapper.m265i(
                        FrontLargeDisplayStrategy.TAG,
                        "registerSecureConfirm by FoldStateChangedListener-->Large");
                    FrontLargeDisplayStrategy.this.mKeyguardManagerWrapper.setRegisterState(false);
                    FrontLargeDisplayStrategy.this.mGlobalActions.registerSecureConfirmAction(
                        viewModel);
                    FrontLargeDisplayStrategy.this.mKeyguardManagerWrapper
                        .setPendingIntentAfterUnlockOnCover(extraUnlockType, false);
  ...
  public void onDispose() {
    ...
    if (sFoldStateListener != null) {
      this.mLogWrapper.m265i(TAG, "unregisterFoldStateListener");
