...
public class FrontLargeDisplayStrategy implements SecureConfirmStrategy, DisposingStrategy {
    ...
    public FrontLargeDisplayStrategy(
                ...
                if (isFoldedState()) {
                    sFoldStateListener =
                            new SemWindowManager.FoldStateListener() { // from class:
                                // com.samsung.android.globalactions.features.FrontLargeDisplayStrategy.1
                                @Override // com.samsung.android.view.SemWindowManager.FoldStateListener
                                public void onFoldStateChanged(boolean isFolded) {
                                    if (!isFolded) {
                                        FrontLargeDisplayStrategy.this.mLogWrapper.i(
                                                FrontLargeDisplayStrategy.TAG,
                                                "registerSecureConfirm by"
                                                    + " FoldStateChangedListener-->Large");
                                        FrontLargeDisplayStrategy.this.mKeyguardManagerWrapper
                                                .setRegisterState(false);
                                        FrontLargeDisplayStrategy.this.mGlobalActions
                                                .registerSecureConfirmAction(viewModel);
                                        FrontLargeDisplayStrategy.this.mKeyguardManagerWrapper
                                                .setPendingIntentAfterUnlockOnCover(
                                                        extraUnlockType, false);
                                        FrontLargeDisplayStrategy.this.mGlobalActions.dismissDialog(
                                                false);
                                    }
                                }
                    ...
                    this.mLogWrapper.i(
                            TAG, "registerSecureConfirm by doActionBeforeSecureConfirm ViewModel");
                    this.mGlobalActions.registerSecureConfirmAction(viewModel);
                    this.mKeyguardManagerWrapper.setPendingIntentAfterUnlockOnCover(
                            extraUnlockType, true);
