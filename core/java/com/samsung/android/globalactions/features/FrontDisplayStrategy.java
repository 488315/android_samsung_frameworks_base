          ...
          sFoldStateListener =
              new SemWindowManager
                ...
                public void onFoldStateChanged(boolean isFolded) {
                  if (!isFolded) {
                    FrontDisplayStrategy.this.mLogWrapper.m265i(
                        FrontDisplayStrategy.TAG,
                        "registerSecureConfirm by FoldStateChangedListener");
                    ...
                    FrontDisplayStrategy.this.mKeyguardManagerWrapper.setPendingIntentAfterUnlock(
                        extraUnlockType);
                  }
                }
