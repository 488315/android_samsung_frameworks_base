...
public class DefaultUtilFactory implements UtilFactory {
    ...
    public DefaultUtilFactory(Context context, SamsungGlobalActionsManager windowManagerFuncs) {
        ...
        this.mProvider.put(
                ...
                new BroadcastManager(this.mContext, logWrapper, new HandlerUtil()));
        this.mProvider.put(Context.class, context);
        this.mProvider.put(
                DevicePolicyManagerWrapper.class, new DevicePolicyManagerWrapper(this.mContext));
        this.mProvider.put(HandlerUtil.class, new HandlerUtil());
        this.mProvider.put(
                InputMethodManagerWrapper.class, new InputMethodManagerWrapper(this.mContext));
        this.mProvider.put(
                KeyGuardManagerWrapper.class,
                new KeyGuardManagerWrapper(this.mContext, logWrapper));
        this.mProvider.put(
                LockPatternUtilsWrapper.class,
                new LockPatternUtilsWrapper(this.mContext, logWrapper, new HandlerUtil()));
        this.mProvider.put(PackageManagerWrapper.class, new PackageManagerWrapper(this.mContext));
        this.mProvider.put(
                ResourcesWrapper.class, new ResourcesWrapper(this.mContext.getResources()));
        this.mProvider.put(
                SemEmergencyManagerWrapper.class, new SemEmergencyManagerWrapper(this.mContext));
        ...
        this.mProvider.put(
                SystemController.class, new SystemController(this.mContext, new HandlerUtil()));
        this.mProvider.put(
                SystemPropertiesWrapper.class,
                new SystemPropertiesWrapper(this.mContext, logWrapper));
        this.mProvider.put(
                TelephonyManagerWrapper.class, new TelephonyManagerWrapper(this.mContext));
        ...
        this.mProvider.put(
                WindowManagerUtils.class, new WindowManagerUtils(this.mContext, logWrapper));
        this.mProvider.put(
                ThemeChecker.class, new ThemeChecker(this.mContext, screenCaptureUtil, logWrapper));
        ...
        this.mProvider.put(
                AccessibilityManagerWrapper.class, new AccessibilityManagerWrapper(this.mContext));
        this.mProvider.put(ContentObserverWrapper.class, new ContentObserverWrapper(this.mContext));
        this.mProvider.put(
                SemReserveBatteryWrapper.class, new SemReserveBatteryWrapper(this.mContext));
        this.mProvider.put(
                BiometricPromptWrapper.class,
                new BiometricPromptWrapper(this.mContext, logWrapper));
        this.mProvider.put(
                UsageStatsWrapper.class, new UsageStatsWrapper(this.mContext, logWrapper));
        this.mProvider.put(
                DesktopModeManagerWrapper.class,
                new DesktopModeManagerWrapper(this.mContext, logWrapper));
