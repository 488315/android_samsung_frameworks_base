...
public class BroadcastManager {
    ...
    public static final String ACTION_SHOW_GLOBAL_ACTIONS =
            "android.intent.action.SHOW_GLOBAL_ACTIONS";
    public static final String ACTION_TALKBACK_TOGGLED =
            "com.samsung.settings.action.talkback_toggled";
    ...
    public void registerDismissActions(
            final Runnable dismissRunnable, final Runnable dismissVIRunnable) {
        ...
        this.mDismissBroadcastReceiver =
                new BroadcastReceiver() { // from class:
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        BroadcastManager.this.mLogWrapper.i(
                                BroadcastManager.TAG, "action = " + action);
                        switch (action.hashCode()) {
                            ...
                            case -1932656035:
                                if (action.equals(
                                        BroadcastManager.ACTION_POWER_OFF_ANIMATION_START)) {
                                    c = 5;
                                    break;
                                }
                                c = 65535;
                        ...
                        switch (c) {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                BroadcastManager.this.mHandlerUtil.postDelayed(
                                        dismissVIRunnable, 2000L);
                                break;
                        }
                    }
                };
    ...
    public void registerSecureConfirmAction(final Runnable confirmRunnable) {
        ...
        this.mSecureConfirmBroadcastReceiver =
                new BroadcastReceiver() { // from class:
                                          // com.samsung.android.globalactions.util.BroadcastManager.2
                    @Override // android.content.BroadcastReceiver
                    public void onReceive(Context context, Intent intent) {
                        String action = intent.getAction();
