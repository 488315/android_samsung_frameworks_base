...
public class AlertDialogFactory {
  ...
  private void initAlertDialogBuilder() {
    ...
    this.mAlertDialogBuilder =
        new AlertDialog.Builder(
            z ? new ContextThemeWrapper(this.mContext, 16974120) : this.mContext);
  }
  ...
  public AlertDialog getProKioskModeDialog(
    ...
    this.mAlertDialogBuilder.setTitle(C4337R.string.global_action_pro_kiosk_mode_title);
    this.mAlertDialogBuilder.setMessage(C4337R.string.global_action_pro_kiosk_mode_enter_passcode);
    ...
    EditText editText =
        new EditText(
            this.mIsNightMode ? new ContextThemeWrapper(this.mContext, 16974120) : this.mContext);
  ...
  public AlertDialog getInsertSimCardDialog() {
    initAlertDialogBuilder();
    this.mAlertDialogBuilder.setTitle(C4337R.string.global_action_insert_sim_card);
    this.mAlertDialogBuilder.setMessage(C4337R.string.global_action_insert_sim_card_message);
