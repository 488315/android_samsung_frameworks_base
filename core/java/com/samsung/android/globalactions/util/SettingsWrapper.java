...
public class SettingsWrapper {
    ...
    public boolean isTaskBarEnabled() {
        boolean value =
                Settings.Global.getInt(this.mResolver, Settings.Global.SEM_TASK_BAR, 0) == 1;
    ...
    public boolean isShopDemo() {
        int value =
                Settings.Secure.getInt(this.mContext.getContentResolver(), "shopdemo", State.OFF);
    ...
    public boolean isLockNetworkAndSecurityOn() {
        return Settings.Secure.getInt(
                        ...
                        Settings.Secure.LOCK_NOTI_AND_SECURITY,
                        0)
                != 0;
    }
    ...
    public boolean isMinimalBatteryUse() {
        return Settings.System.getInt(this.mResolver, Settings.System.SEM_MINIMAL_BATTERY_USE, 0)
                == 1;
    }

    public boolean isBikeMode() {
        int value =
                Settings.Secure.getInt(this.mResolver, AudioConstants.SETTING_BIKE_MODE, State.OFF);
