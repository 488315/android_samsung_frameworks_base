...
public class SamsungGlobalActionsPresenter implements SamsungGlobalActions {
    ...
    public void addAction(ActionViewModel action) {
        if (action != null) {
            ...
            this.mLogWrapper.m265i(TAG, "addAction (" + action.getActionInfo().getName() + NavigationBarInflaterView.KEY_CODE_END);
        }
    }
    ...
    public void hideQuickPanel(String sender) {
        this.mLogWrapper.m266v(TAG, "hideQuickPanelBackground(" + sender + NavigationBarInflaterView.KEY_CODE_END);
