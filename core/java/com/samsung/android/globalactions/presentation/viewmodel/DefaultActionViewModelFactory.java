    ...
    public ActionViewModel createActionViewModel(SamsungGlobalActions globalActions, String type) {
        ...
        switch (c) {
            case 0:
                ...
                int descriptionResID = isTabletDevice ? C4337R.string.global_action_confirm_msg_poweroff_tablet : C4337R.string.global_action_confirm_msg_poweroff;
            ...
            case 1:
                ...
                int descriptionResID2 = isTabletDevice ? C4337R.string.global_action_confirm_msg_safemode_tablet : C4337R.string.global_action_confirm_msg_safemode;
            ...
            case 2:
                ...
                int descriptionResID3 = isTabletDevice ? C4337R.string.global_action_confirm_msg_restart_tablet : C4337R.string.global_action_confirm_msg_restart;
            ...
            case 7:
                ...
                actionInfo.setStateLabel(getResString(C4337R.string.global_action_force_restart_message, this.mResourceFactory.get(ResourceType.INTEGER_FORCE_RESTART_TIME)));
                actionInfo.setIcon(-1);
