...
public class GlobalActionsContentItemView {
  ...
  public View inflateView() {
    if (this.mViewModel.getActionInfo().getViewType() == ViewType.TOP_VIEW) {
      View view =
          LayoutInflater.from(this.mContext)
              .inflate(
                  this.mResourceFactory.get(ResourceType.LAYOUT_TOP_VIEW), this.mParent, false);
      return view;
    }
    ...
    if (this.mViewModel.getActionInfo().getViewType() == ViewType.KEY_SETTINGS_VIEW) {
      View view3 =
          LayoutInflater.from(this.mContext)
              .inflate(
                  this.mResourceFactory.get(ResourceType.LAYOUT_SIDEKEY_SETTINGS_VIEW),
                  this.mParent,
                  false);
      ...
      if (this.mWhiteTheme) {
        view3.setBackground(
            this.mContext.getDrawable(
                this.mResourceFactory.get(ResourceType.DRAWABLE_BG_RAISED_BTN_LIGHT)));
        view3.setForeground(
            this.mContext.getDrawable(
                this.mResourceFactory.get(ResourceType.DRAWABLE_SIDEKEY_SETTINGS_RIPPLE_LIGHT)));
        return view3;
      }
      view3.setBackground(
          this.mContext.getDrawable(
      ...
      view3.setForeground(
          this.mContext.getDrawable(
              this.mResourceFactory.get(ResourceType.DRAWABLE_SIDEKEY_SETTINGS_RIPPLE_DARK)));
      return view3;
    }
    if (this.mViewModel.getActionInfo().getViewType() == ViewType.BOTTOM_FORCE_RESTART_MSG_VIEW) {
      View view4 =
          LayoutInflater.from(this.mContext)
              .inflate(
                  this.mResourceFactory.get(ResourceType.LAYOUT_FORCE_RESTART_TEXT_VIEW),
                  this.mParent,
                  false);
      return view4;
    }
    View view5 =
        LayoutInflater.from(this.mContext)
            .inflate(
                this.mResourceFactory.get(ResourceType.LAYOUT_ITEM_LIST_VIEW), this.mParent, false);
    return view5;
  }
  ...
  public void setViewAttrs(View view, boolean isForConfirming) {
    ...
    if (imageView != null) {
      ...
      if (this.mVoiceAssistantMode) {
        imageView.setForeground(
            this.mContext
                .getResources()
                .getDrawable(this.mResourceFactory.get(ResourceType.DRAWABLE_ICON_RIPPLE), null));
      } else {
        imageView.setForeground(
            this.mContext
                .getResources()
                .getDrawable(
                    this.mResourceFactory.get(ResourceType.DRAWABLE_ICON_BG_FOCUSED), null));
      }
    }
    if (labelView != null) {
      ...
      if (this.mViewModel.getActionInfo().getViewType() != ViewType.BOTTOM_BTN_LIST_VIEW) {
        labelView.setTextColor(
            this.mWhiteTheme ? Color.parseColor("#252528") : Color.parseColor("#fafaff"));
    ...
    if (stateView != null) {
      ...
      if (imageView != null) {
        imageView.setContentDescription(
            ((Object) imageView.getContentDescription()) + "," + ((Object) stateView.getText()));
      }
      if (this.mViewModel.getActionInfo().getViewType() == ViewType.KEY_SETTINGS_VIEW) {
        ...
        stateView.setTextColor(
            this.mWhiteTheme ? Color.parseColor("#8C8C91") : Color.parseColor("#99999E"));
    ...
    if (isForConfirming) {
      TextView descriptionView =
          (TextView) view.findViewById(this.mResourceFactory.get(ResourceType.ID_DESCRIPTION_TEXT));
  ...
  private void checkSingleLine(TextView view) {
    ...
    if (viewGroup instanceof GlobalActionsContentView.SamsungGlobalActionsGridView) {
      boolean isVertical =
          ((GlobalActionsContentView.SamsungGlobalActionsGridView) viewGroup).isVerticalMode();
      if (isVertical) {
