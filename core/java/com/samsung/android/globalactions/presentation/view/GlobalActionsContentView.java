...
public class GlobalActionsContentView implements ContentView, ViewStateController {
    ...
    public void initDimens() {
        if (this.mConditionChecker.isEnabled(SystemConditions.IS_TABLET_DEVICE)) {
            this.mItemHorizontalSpacing = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_horizontal_spacing_tablet);
            this.mItemVerticalSpacingPort = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_vertical_spacing_port_tablet);
        } else {
            this.mItemHorizontalSpacing = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_horizontal_spacing);
            this.mItemVerticalSpacingPort = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_vertical_spacing_port);
        }
        this.mItemVerticalSpacingLand = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_vertical_spacing_land);
        this.mItemWidthLand = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_width_land);
        this.mItemWidthPort = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_width_port);
    }
    ...
    public void initLayouts() {
        ...
        listViewParent.setContentDescription(this.mContext.getResources().getText(C4337R.string.global_action_power_off_menu));
    ...
    public class SamsungGlobalActionsRootView extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            if (changed || GlobalActionsContentView.this.mNeedToForceUpdate) {
                GlobalActionsContentView.this.mLogWrapper.m265i(GlobalActionsContentView.TAG, "RootView onLayout");
                setRootViewPadding();
        ...
        private void setRootViewPadding() {
            ...
            int delta = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.navigation_bar_height);
            ...
            if (GlobalActionsContentView.this.mConditionChecker.isEnabled(SystemConditions.IS_TABLET_DEVICE)) {
                delta = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.navigation_bar_frame_height);
        ...
        private void setGridViewMargin() {
            if (GlobalActionsContentView.this.mBottomMsgView != null && GlobalActionsContentView.this.mBottomButtonView.getChildCount() != 0) {
                int bottomViewMarginBottom = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_bottom_view_margin_bottom);
                int bottomViewHeight = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_vertical_spacing_port_only_4_buttons);
            ...
            if (bugreportView != null) {
                ...
                if (isPortrait) {
                    ...
                    if (GlobalActionsContentView.this.mConditionChecker.isEnabled(SystemConditions.IS_TABLET_DEVICE) && GlobalActionsContentView.this.mConditionChecker.isEnabled(SystemConditions.IS_DESKTOP_MODE_STANDALONE)) {
                        margin += this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.navigation_bar_frame_height);
                    }
        ...
        private void setVerticalSpacing() {
            if (!GlobalActionsContentView.this.mConditionChecker.isEnabled(SystemConditions.IS_TABLET_DEVICE)) {
                if (GlobalActionsContentView.this.mListView.getChildCount() == 4) {
                    GlobalActionsContentView.this.mListView.setVerticalSpacing(this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sec_global_actions_items_vertical_spacing_port_only_4_buttons));
                } else {
    ...
    class C50212 implements SamsungGlobalActionsAnimator.ViewUpdateCallback {
        ...
        public ViewGroup getPowerOffViewForSafeModeVI(GlobalActionsContentItemView item) {
            ...
            powerOffLabelView.setText(GlobalActionsContentView.this.mContext.getResources().getText(C4337R.string.samsung_global_action_power_off));
