...
public class CoreRune {
  ...
  /* renamed from: AM */
  public static final boolean f3035AM = true;
  ...
  /* renamed from: FW */
  public static final boolean f3036FW = true;
  ...
  public static final String FW_BIXBY_ONBOARDING_SERVICE_COMPONENT =
  ...
  /* renamed from: MD */
  public static final boolean f3037MD = true;
  ...
  /* renamed from: MT */
  public static final boolean f3038MT = true;
  ...
  /* renamed from: MW */
  public static final boolean f3039MW = true;
  ...
  static {
    ...
    FW_VIEW_DEBUG_DISABLE_HWRENDERING =
    ...
    FW_SUPPORT_DOWNLOADABLE_RESERVE_BATTERY_MODE =
        string.contains("downloadable_spowerplanning") && z5;
    ...
    FW_SUPPORT_QUICK_SWITCH_PRIVATE_MODE =
        z3 && SemCscFeature.getInstance().getBoolean("CscFeature_Common_SupportPrivateMode");
    boolean equalsIgnoreCase =
        "PanicMode"
            .equalsIgnoreCase(
                SemCscFeature.getInstance()
                    .getString("CscFeature_Framework_ConfigActionForMultiPowerPress"));
    ...
    FW_DOUBLE_PRESS_POWER_ATT_TV_MODE =
        SemCscFeature.getInstance()
    ...
    boolean z12 =
        z11
            && SemFloatingFeature.getInstance()
                .getString("SEC_FLOATING_FEATURE_FRAMEWORK_SUPPORT_TSP_STATE_MANAGER")
                .contains("deadzone");
    FW_TSP_DEADZONE = z12;
    ...
    FW_TSP_DEADZONEHOLE_LAND =
        z12 && "bsxasm1".equals(SystemProperties.get("ro.com.google.cdb.spa1"));
    ...
    FW_VRR_HRR_CHINA_DELTA =
        z16 && "CHINA".equalsIgnoreCase(SystemProperties.get("ro.csc.country_code"));
    FW_VRR_LOW_REFRESH_RATE_LIST =
        z13 && SystemProperties.getBoolean("persist.debug.lrr.enabled", true);
    ...
    FW_CUSTOM_SHELL_TRANSITION_MERGE_TRANSFER =
        z26 && SystemProperties.getBoolean("persist.wm.enable.merge_transfer.transit", true);
    FW_CUSTOM_SHELL_TRANSITION_RECENTS = z25;
    FW_CUSTOM_SHELL_TRANSITION_RAPID_RECENTS_TRANSIT =
        z25 && SystemProperties.getBoolean("persist.wm.rapid.recents_transit", true);
    FW_CUSTOM_SHELL_TRANSITION_SEPARATE_RECENTS = z25;
    FW_CUSTOM_SHELL_TRANSITION_LATE_TRANSIENT_LAUNCH =
        z25 && SystemProperties.getBoolean("persist.wm.late.transient_launch", false);
    FW_CUSTOM_SHELL_TRANSITION_TRANSIENT_LAUNCH_OVERLAY =
        z25 && SystemProperties.getBoolean("persist.wm.transient_launch.overlay", true);
    ...
    FW_DEFAULT_HIGH_RESOLUTION_DEVICE =
        equals3
            && "HIGH"
                .equals(
                    SemFloatingFeature.getInstance()
                        .getString("SEC_FLOATING_FEATURE_COMMON_CONFIG_DEF_PERFORMANCE_MODE"));
    ...
    FW_AOD_FACE_WIDGET =
        SemFloatingFeature.getInstance()
            ...
            .contains("aodversion");
    FW_LOCK_ONLY_LIVE_WALLPAPER =
        !SystemProperties.getBoolean("persist.wm.debug.lockscreen_live_wallpaper", false);
    FW_SELF_POKE_DRAW_LOCK =
        SystemProperties.getBoolean("persist.enable.self.poke.draw_lock", true);
    FW_INFINITY_WALLPAPER_IN_AOD =
        ONE_UI_6_1
            && SemFloatingFeature.getInstance()
                    .getInt("SEC_FLOATING_FEATURE_LCD_CONFIG_AOD_FULLSCREEN", -1)
                == 1;
    FW_INFORM_SCREEN_ROTATION_ANIMATION_STARTED_FOR_CAPTURED_BLUR =
        SemFloatingFeature.getInstance()
    ...
    boolean z33 =
        SemFloatingFeature.getInstance()
            .getBoolean("SEC_FLOATING_FEATURE_GRAPHICS_SUPPORT_3D_SURFACE_TRANSITION_FLAG");
    ...
    MW_SUPPORT_DRAG_AND_DROP_CAPTURED_BLUR =
        !z33
            ...
            && SemFloatingFeature.getInstance()
                .getBoolean("SEC_FLOATING_FEATURE_GRAPHICS_SUPPORT_CAPTURED_BLUR");
    boolean z35 =
        MW_MULTI_SPLIT_COUNT_STR.equals(MW_MULTI_SPLIT_COUNT_STR)
            || "23".equals(MW_MULTI_SPLIT_COUNT_STR);
    MW_MULTI_SPLIT = z35;
    ...
    boolean z39 =
        ViewRootImpl.CAPTION_ON_SHELL && SystemProperties.getBoolean("captiononshell.debug", true);
    MW_CAPTION_SHELL = z39;
    MW_CAPTION_SHELL_BUG_FIX = z39;
    MW_CAPTION_SHELL_INSETS =
        z39 && SystemProperties.getBoolean("persist.debug.caption.insets", true);
    ...
    MW_CAPTION_SHELL_SUPPORT_WINDOW_OPACITY =
        z39
            && (SystemProperties.get("ro.surface_flinger.protected_contents", "").contains("true")
                || SystemProperties.get("ro.surface_flinger.protected_contents", "").contains("1"));
    ...
    MW_CAPTION_SHELL_MOVE_DISPLAY =
        z39 && SystemProperties.getBoolean("persist.debug.caption.display", false);
    ...
    MT_NEW_DEX = z46;
    boolean z47 =
        z46 && SystemProperties.getBoolean("persist.wm.debug.support_external_desktop_mode", false);
    ...
    MT_NEW_DEX_USE_DESKTOP_MODE_WINDOW_DECOR_VIEW_MODEL =
        z46
            && SystemProperties.getBoolean(
                "persist.wm.debug.use_desktop_mode_window_decor_view_model", false);
    ...
    MT_NEW_DEX_PIP_ON_FREEFORM =
        z46 && SystemProperties.getBoolean("persist.debug.pip.newdex", false);
    boolean z48 = z46;
    ...
    EM_SUPPORTED =
        SemFloatingFeature.getInstance()
            ...
            || FW_SUPPORT_RESERVE_BATTERY_MODE;
    ...
    SYSPERF_BOOST_DISABLE_WHEN_FOLDED =
        "b2q".equalsIgnoreCase(str2)
            || "b4q".equalsIgnoreCase(str2)
            || "b5q".equalsIgnoreCase(str2)
            || "b6q".equalsIgnoreCase(str2);
    ...
    SYSPERF_SLUGGISH_BIGDATA_REPORT =
        SemFloatingFeature.getInstance()
            .getBoolean("SEC_FLOATING_FEATURE_CONTEXTSERVICE_ENABLE_SURVEY_MODE");
    ...
    MNO_TMO_DEVICE_REPORTING =
        SemCscFeature.getInstance().getBoolean("CscFeature_Common_SupportDeviceReporting");
    SUPPORT_TRAFFIC_MANAGER =
        SemCscFeature.getInstance()
            .getString("CscFeature_SmartManager_ConfigSubFeatures")
            .contains("trafficmanager");
    SM_SUPPORT_RISK_CONTROL =
        SemCscFeature.getInstance()
            .getString("CscFeature_SmartManager_ConfigSubFeatures")
            .contains("riskcontrol");
    boolean z49 =
    ...
    SYSFW_APP_SPEG = z50;
    SYSFW_APP_PREL =
        z50 && !SystemProperties.getBoolean("com.samsung.speg.prelauncher.disable", false);
    SYSFW_APP_PREL_ROTATION =
        z50 && !SystemProperties.getBoolean("com.samsung.speg.prelauncher.rotation.disable", false);
  }
