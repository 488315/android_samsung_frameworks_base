...
class AudioTask implements Runnable {
        ...
        if (result == 2 && (mMUIRecognizer = this.aMMUIRecognizer) != null) {
            ...
            if (this.isOEMCameraBargeIn && this.isEnableSamsungOOVResult) {
                if (this.isOEMResult) {
                    ...
                    Log.m98i(this.mTAG, "isOEMCameraBargeIn is true and keyword is not detected by OEM and keyword or non-keyword is detected by embeddedEngine.");
    ...
    protected AudioRecord getAudioRecord(int source) {
        ...
        try {
            ...
            Log.m96e(this.mTAG, "got IllegalArgumentException using source=" + source + ", also 16000 16 2 8192");
            if (0 != 0) {
