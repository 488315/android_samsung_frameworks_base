  ...
  public boolean isEnabled(int commandType, int language) {
    ...
    if (isOEMModel()) {
      ...
      if (isBargeInFile(OEMModelPath + ".bin")) {
        Log.m98i(
            TAG,
            "isEnabled: OEMBargeIn is available in commandType ("
                + commandType
                + ") uselanguage("
                + language
                + NavigationBarInflaterView.KEY_CODE_END);
    ...
    if (isSamsungModel()) {
      ...
      String samsungNameList =
          Config.GetSamsungPath(language) + Config.GetSamsungNameList(commandType);
      if (isBargeInFile(samsungModelPath) && isBargeInFile(samsungNameList)) {
        Log.m98i(
            TAG,
            "isEnabled: SamsungBargeIn is available in commandType ("
                + commandType
                + ") uselanguage("
                + language
                + NavigationBarInflaterView.KEY_CODE_END);
    ...
    Log.m102w(
        samsungModelPath2,
        "isEnabled: BargeIn is not available in commandType ("
            + commandType
            + ") uselanguage("
            + language
            + NavigationBarInflaterView.KEY_CODE_END);
