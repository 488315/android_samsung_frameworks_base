...
public class SemEmergencyConstants {
    ...
    @Deprecated public static final int BATTERY_CONSERVING_MODE = 2048;
    ...
    @Deprecated public static final int DEFAULT_ALLOW = 1;
    public static final int DETECT = 128;
    public static final int DISASTER = 256;

    @Deprecated public static final String EMERGENCY_CALL = "emcall";
    public static final String EMERGENCY_CHECK_ABNORMAL_STATE =
            "com.samsung.intent.action.EMERGENCY_CHECK_ABNORMAL_STATE";
    public static final String EMERGENCY_FINISHED_SENDING_PACKAGE_CHANGED =
            "com.samsung.intent.action.EMERGENCY_FINISHED_SENDING_PACKAGE_CHANGED";
    ...
    public static final String EMERGENCY_LAUNCHER_CLASS =
            "com.sec.android.emergencylauncher.LauncherActivity";
    public static final String EMERGENCY_MANAGER_SERVICE =
            "com.sec.android.emergency_manager_service";

    @Deprecated public static final int EMERGENCY_MODE = 16;
    ...
    public static final String EMERGENCY_START_EMERGENCY_CHOICE_POPUP =
            "com.samsung.intent.action.EMERGENCY_START_CHOICE_POPUP";
    ...
    @Deprecated public static final int ERROR_USER_CANCELED = -8;
    ...
    @Deprecated public static final int FIND_MY_MOBILE = 64;
    public static final int FIND_MY_MOBILE_ALL = 1088;
    public static final String GPS_ACCURACY = "GPS_ACCURACY";

    @Deprecated public static final String GPS_LATITUDE = "GPS_LATITUDE";

    @Deprecated public static final String GPS_LONGITUDE = "GPS_LONGITUDE";
    public static final String HEATSENSING = "heatsensing";
    public static final String MCC = "mcc";
    public static final int MINIMAL_BATTERY_USE_LAUNCHER = 3;

    @Deprecated public static final int MODE_DISABLED = 5;

    @Deprecated public static final int MODE_DISABLING = 4;

    @Deprecated public static final int MODE_ENABLED = 3;

    @Deprecated public static final int MODE_ENABLING = 2;
    ...
    @Deprecated public static final int ULTRA_POWER_SAVING_MODE = 512;
    public static final int ULTRA_POWER_SAVING_MODE_ALL = 1536;

    @Deprecated public static final int ULTRA_POWER_SAVING_MODE_FIND_MY_MOBILE = 1024;
    public static final int ULTRA_POWER_SAVING_MODE_LAUNCHER = 1;
    public static final int USER_ALLOW = 2;
    public static final String VALUE = "value";
    public static final int[] RGBCMYArray = {
        19635, 19635, 19635, 38505, 38505, 38505, 7650, 7650, 7650
    };
    public static final Uri URI_WHITELIST =
            Uri.parse("content://com.samsung.android.max.power.saving/userallow");
    public static final Uri URI_PREFSETTINGS =
            Uri.parse("content://com.samsung.android.max.power.saving/prefsettings");
    public static final Uri URI_DISABLEDPKG =
            Uri.parse("content://com.samsung.android.max.power.saving/blocklist");
    public static final Uri URI_ALARM =
            Uri.parse("content://com.samsung.android.max.power.saving/alarm");
    public static final Uri URI_ECCLIST =
            Uri.parse("content://com.samsung.android.max.power.saving/ecclist");
    public static final Uri URI_UPDATE_TABLE =
            Uri.parse("content://com.samsung.android.max.power.saving/updatetable");
