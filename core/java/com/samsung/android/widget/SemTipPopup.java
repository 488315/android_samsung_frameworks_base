...
public class SemTipPopup {
    ...
    public SemTipPopup(View parentView, int mode) {
        ...
        this.mType = 0;
        this.mMode = mode;
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C4337R.styleable.SemTipPopup);
        this.mBackgroundColor = a.getColor(0, -16777216);
        a.recycle();
        initInterpolator();
        LayoutInflater inflater = LayoutInflater.from(context);
        this.mBubbleView = inflater.inflate(C4337R.layout.sem_tip_popup_bubble, (ViewGroup) null);
        View inflate = inflater.inflate(C4337R.layout.sem_tip_popup_balloon, (ViewGroup) null);
        this.mBalloonView = inflate;
        initBubblePopup(mode);
        initBalloonPopup(mode);
        TextView textView = (TextView) inflate.findViewById(C4337R.id.sem_tip_popup_message);
        this.mMessageView = textView;
        Button button = (Button) inflate.findViewById(C4337R.id.sem_tip_popup_action);
        ...
        this.mBalloonX = -1;
        if (mode == 1) {
            textView.setTextColor(resources.getColor(C4337R.color.sem_tip_popup_text_color_translucent, null));
            button.setTextColor(resources.getColor(C4337R.color.sem_tip_popup_text_color_translucent, null));
        }
        this.mScaleMargin = resources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_scale_margin);
        this.mSideMargin = resources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_side_margin);
        this.mArrowHeight = resources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_balloon_arrow_height);
        this.mArrowWidth = resources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_balloon_arrow_width);
        this.mHorizontalTextMargin = resources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_balloon_message_margin_horizontal);
        this.mVerticalTextMargin = resources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_balloon_message_margin_vertical);
        ...
        inflate.setAccessibilityDelegate(new View.AccessibilityDelegate() { // from class: com.samsung.android.widget.SemTipPopup.3
            ...
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfo info) {
                ...
                info.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, SemTipPopup.this.mContext.getString(C4337R.string.close)));
            }
        });
    }
    ...
    private void initInterpolator() {
        if (INTERPOLATOR_SINE_IN_OUT_33 == null) {
            INTERPOLATOR_SINE_IN_OUT_33 = AnimationUtils.loadInterpolator(this.mContext, C4337R.interpolator.sine_in_out_33);
        }
        if (INTERPOLATOR_SINE_IN_OUT_70 == null) {
            INTERPOLATOR_SINE_IN_OUT_70 = AnimationUtils.loadInterpolator(this.mContext, C4337R.interpolator.sine_in_out_70);
        }
    ...
    private void initBubblePopup(int mode) {
        this.mBubbleBackground = (ImageView) this.mBubbleView.findViewById(C4337R.id.sem_tip_popup_bubble_bg);
        this.mBubbleIcon = (ImageView) this.mBubbleView.findViewById(C4337R.id.sem_tip_popup_bubble_icon);
        if (mode == 1) {
            this.mBubbleBackground.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_translucent);
            this.mBubbleBackground.setImageTintList(null);
            if (isRTL() && !getLocale().equals("iw_IL")) {
                this.mBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon_translucent_rtl);
            } else {
                this.mBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon_translucent);
            }
            this.mBubbleIcon.setImageTintList(null);
            this.mBubbleWidth = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_width_translucent);
            this.mBubbleHeight = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_height_translucent);
        } else {
            this.mBubbleWidth = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_width);
            this.mBubbleHeight = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_height);
        }
    ...
    private void initBalloonPopup(int mode) {
        this.mBalloonBubble = (FrameLayout) this.mBalloonView.findViewById(C4337R.id.sem_tip_popup_balloon_bubble);
        this.mBalloonBubbleHint = (ImageView) this.mBalloonView.findViewById(C4337R.id.sem_tip_popup_balloon_bubble_hint);
        this.mBalloonBubbleIcon = (ImageView) this.mBalloonView.findViewById(C4337R.id.sem_tip_popup_balloon_bubble_icon);
        this.mBalloonPanel = (FrameLayout) this.mBalloonView.findViewById(C4337R.id.sem_tip_popup_balloon_panel);
        this.mBalloonContent = (FrameLayout) this.mBalloonView.findViewById(C4337R.id.sem_tip_popup_balloon_content);
        this.mBalloonBg1 = (ImageView) this.mBalloonView.findViewById(C4337R.id.sem_tip_popup_balloon_bg_01);
        this.mBalloonBg2 = (ImageView) this.mBalloonView.findViewById(C4337R.id.sem_tip_popup_balloon_bg_02);
        if (mode == 1) {
            this.mBalloonBg1.setBackgroundResource(C4337R.drawable.sem_tip_popup_balloon_background_left_translucent);
            this.mBalloonBg1.setBackgroundTintList(null);
            this.mBalloonBg2.setBackgroundResource(C4337R.drawable.sem_tip_popup_balloon_background_right_translucent);
    ...
    public void setExpanded(boolean expanded) {
        if (expanded) {
            ...
            this.mScaleMargin = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_scale_margin);
        }
    }
    ...
    public void setPopupWindowClippingEnabled(boolean enabled) {
        ...
        this.mSideMargin = enabled ? this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_side_margin) : 0;
    ...
    private void setInternal() {
        ...
        int messageTextSize = this.mResources.getDimensionPixelOffset(C4337R.dimen.sem_tip_popup_balloon_message_text_size);
        int actionTextSize = this.mResources.getDimensionPixelOffset(C4337R.dimen.sem_tip_popup_balloon_action_text_size);
    ...
    private void setBubblePanel() {
        ...
        if (this.mMode == 1) {
            paramBubblePanel.width = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_width_translucent);
            paramBubblePanel.height = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_height_translucent);
        }
        switch (this.mArrowDirection) {
            case 0:
                ...
                if (this.mMode == 0) {
                    this.mBubbleBackground.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_03);
                    if (isRTL() && !getLocale().equals("iw_IL")) {
                        this.mBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon_rtl);
                        break;
                    } else {
                        this.mBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon);
                        break;
                    }
                } else {
            ...
            case 1:
                ...
                if (this.mMode == 0) {
                    this.mBubbleBackground.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_04);
                    if (isRTL() && !getLocale().equals("iw_IL")) {
                        this.mBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon_rtl);
                        break;
                    } else {
            ...
            case 2:
                ...
                if (this.mMode == 0) {
                    this.mBubbleBackground.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_01);
                    if (isRTL() && !getLocale().equals("iw_IL")) {
                        this.mBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon_rtl);
                        break;
                    } else {
            ...
            case 3:
                ...
                this.mBubblePopupY = this.mBubbleY;
                if (this.mMode == 0) {
                    this.mBubbleBackground.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_02);
                    if (isRTL() && !getLocale().equals("iw_IL")) {
                        this.mBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon_rtl);
                        break;
                    } else {
    ...
    private void setBalloonPanel() {
        ...
        if (this.mBalloonPopup != null) {
            ...
            int minBackgroundWidth = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_balloon_background_minwidth);
            ...
            int horizontalContentMargin = this.mHorizontalTextMargin - this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_button_padding_horizontal);
            int verticalButtonPadding = this.mActionView.getVisibility() == 0 ? this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_button_padding_vertical) : 0;
            ...
            if (this.mMode == 1) {
                this.mBalloonBubbleHint.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_translucent);
                this.mBalloonBubbleHint.setImageTintList(null);
                if (isRTL() && !getLocale().equals("iw_IL")) {
                    this.mBalloonBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon_translucent_rtl);
                } else {
                    this.mBalloonBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon_translucent);
                }
                this.mBalloonBubbleIcon.setImageTintList(null);
                paramBalloonBubble.width = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_width_translucent);
                paramBalloonBubble.height = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_height_translucent);
                scaleFactor = 0;
            ...
            switch (this.mArrowDirection) {
                case 0:
                    ...
                    if (this.mMode == 0) {
                        this.mBalloonBubbleHint.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_03);
                        this.mBalloonBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon);
                        f = 180.0f;
                    } else {
                        f = 180.0f;
                ...
                case 1:
                    ...
                    if (this.mMode == 0) {
                        this.mBalloonBubbleHint.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_04);
                        this.mBalloonBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon);
                        f2 = 180.0f;
                    } else {
                        f2 = 180.0f;
                ...
                case 2:
                    ...
                    if (this.mMode == 0) {
                        this.mBalloonBubbleHint.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_01);
                        this.mBalloonBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon);
                    }
                ...
                case 3:
                    ...
                    if (this.mMode == 0) {
                        this.mBalloonBubbleHint.setImageResource(C4337R.drawable.sem_tip_popup_hint_background_02);
                        this.mBalloonBubbleIcon.setImageResource(C4337R.drawable.sem_tip_popup_hint_icon);
                    } else {
    ...
    private void calculatePopupSize() {
        ...
        if (this.mType == 1) {
            ...
            if (this.mBalloonWidth < this.mActionView.getMeasuredWidth()) {
                this.mBalloonWidth = this.mActionView.getMeasuredWidth() + (this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_button_padding_horizontal) * 2);
            }
            this.mBalloonHeight += this.mActionView.getMeasuredHeight() - this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_button_padding_vertical);
        }
    }
    ...
    private void animateBaloonScaleUp() {
        ...
        int questionHeight = this.mResources.getDimensionPixelSize(C4337R.dimen.sem_tip_popup_bubble_height);
    ...
    private static class TipWindowBalloon extends TipWindow {
        ...
        protected void animateViewOut() {
            ...
            View messageView = bubbleView.findViewById(C4337R.id.sem_tip_popup_message);
