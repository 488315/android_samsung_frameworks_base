...
public class SemIndexScrollView extends FrameLayout implements AbsListView.OnScrollListener {
  ...
  public SemIndexScrollView(Context context) {
    ...
    this.mPreviewDelayRunnable =
        new Runnable() { // from class: com.samsung.android.widget.SemIndexScrollView.1
  ...
  protected void dispatchDraw(Canvas canvas) {
    ...
    if (str != null
        && str.length() != 0
        && (indexScrollPreview = this.mIndexScrollPreview) != null) {
      indexScrollPreview.setLayout(0, 0, getWidth(), getHeight());
  ...
  public void setIndexer(SemAbstractIndexer indexer) {
    ...
    if (this.mIndexScroll.mScrollThumbBgDrawable != null) {
      this.mIndexScroll.mScrollThumbBgDrawable.setColorFilter(
          this.mIndexScroll.mThumbColor, PorterDuff.Mode.MULTIPLY);
    }
    this.mIndexer.cacheIndexInfo();
    this.mIndexScroll.setAlphabetArray(
        this.mIndexer.getAlphabetArray(),
        getFirstAlphabetCharacterIndex(),
        getLastAlphabetCharacterIndex());
    if (!this.mIsSimpleIndexScroll
        && (semAbstractIndexer = this.mIndexer) != null
        && semAbstractIndexer.getLangAlphabetArray() != null) {
  ...
  public void setSimpleIndexScroll(String[] indexBarChar, int width) {
    ...
    setSimpleIndexWidth((int) rsrc.getDimension(C4337R.dimen.sem_indexbar_simpleindex_width));
    if (width != 0) {
  ...
  public void setIndexBarPressedTextColor(int pressedTextColor) {
    this.mIndexScroll.mScrollThumbBgDrawable.setColorFilter(
        pressedTextColor, PorterDuff.Mode.MULTIPLY);
  ...
  public void setEffectBackgroundColor(int effectBackgroundColor) {
    this.mIndexScrollPreview.setBackgroundColor(
        this.mIndexScroll.getColorWithAlpha(effectBackgroundColor, 0.8f));
  }
    ...
    switch (action) {
      case 0:
        ...
        if (this.mCurrentIndex != null) {
          if (this.mIndexScroll.isAlphabetInit()
              && (str = this.mCurrentIndex) != null
              && str.length() != 0) {
      ...
      case 2:
        ...
        if (str3 != null && calculatedIndexStr == null && !this.mIsSimpleIndexScroll) {
          ...
          if (position4 != -1) {
            ...
            && calculatedIndexStr != null
            && calculatedIndexStr.length() < this.mCurrentIndex.length()) {
  ...
  class IndexerObserver extends DataSetObserver {
    ...
    Runnable mUpdateIndex =
        new Runnable() { // from class:
                         // com.samsung.android.widget.SemIndexScrollView.IndexerObserver.1
          @Override // java.lang.Runnable
          public void run() {
  ...
  class IndexScroll {
    ...
    class LangAttributeValues {
      ...
      public LangAttributeValues(
          int indexCount, int dotCount, int totalCount, float height, float separatorHeight) {
    ...
    public void setDimensions(int width, int height) {
      if (this.mIsAlphabetInit) {
        ...
        int i =
            height
                - (((this.mScrollTop + this.mScrollBottom) + this.mScrollTopMargin)
                    + this.mScrollBottomMargin);
        this.mHeight = i;
    ...
    private void init() {
      ...
      this.mBgRectWidth = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_width);
      this.mTextSize = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_textsize);
      this.mScrollTop = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_top_margin);
      this.mScrollBottom = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_bottom_margin);
      this.mWidthShift = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_side_margin);
      this.mContentPadding = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_content_padding);
      this.mContentMinHeight = rsrc.getDimension(C4337R.dimen.sem_indexbar_content_min_height);
      this.mAdditionalSpace =
          (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_additional_touch_boundary);
      this.mIndexScrollPreviewRadius =
          rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_radius);
      this.mPreviewLimitY = rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_ypos_limit);
      TypedValue outValue = new TypedValue();
      this.mContext.getTheme().resolveAttribute(16843827, outValue, true);
      int colorPrimary =
          outValue.resourceId != 0 ? rsrc.getColor(outValue.resourceId, null) : outValue.data;
      this.mFirstLang = new LangAttributeValues(0, 0, 0, 0.0f, 0.0f);
      this.mSecondLang = new LangAttributeValues(0, 0, 0, 0.0f, 0.0f);
      this.mScrollThumbBgRectPadding =
          (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_thumb_padding);
      this.mScrollThumbAdditionalHeight =
          (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_thumb_additional_height);
      this.mDotHeight = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_dot_separator_height);
      SemIndexScrollView.this.mIndexScrollPreview.setBackgroundColor(
          getColorWithAlpha(colorPrimary, 0.8f));
      Drawable drawable = rsrc.getDrawable(C4337R.drawable.sem_indexbar_thumb_mtrl_shape);
      ...
      if (outValue.data != 0) {
        this.mTextColorDimmed = rsrc.getColor(C4337R.color.sem_indexbar_text_color, null);
        this.mBgTintColor = rsrc.getColor(C4337R.color.sem_indexbar_bg_tint_color, null);
      } else {
        this.mTextColorDimmed = rsrc.getColor(C4337R.color.sem_indexbar_text_color_dark, null);
        this.mBgTintColor = rsrc.getColor(C4337R.color.sem_indexbar_bg_tint_color_dark, null);
      }
      Drawable drawable2 = rsrc.getDrawable(C4337R.drawable.sem_indexbar_bg_mtrl);
    ...
    public void setAlphabetArray(
        String[] alphabetArray,
        int alphabetArrayFirstLetterIndex,
        int alphabetArrayLastLetterIndex) {
    ...
    private void adjustSeparatorHeight() {
      if (SemIndexScrollView.this.mNumberOfLanguages == 1) {
        this.mFirstLang.separatorHeight =
            (this.mHeight - (this.mDotHeight * r0.dotCount)) / this.mFirstLang.indexCount;
      ...
      if (f > i * 0.6f) {
        this.mFirstLang.separatorHeight =
            ((i * 0.6f) - (this.mDotHeight * r0.dotCount)) / this.mFirstLang.indexCount;
        this.mSecondLang.separatorHeight =
            ((this.mHeight * 0.4f) - (this.mDotHeight * r0.dotCount)) / this.mSecondLang.indexCount;
        ...
        if (f2 <= i2 * 0.5f) {
          this.mFirstLang.separatorHeight =
              ((i2 * 0.5f) - (this.mDotHeight * r0.dotCount)) / this.mFirstLang.indexCount;
          this.mSecondLang.separatorHeight =
              ((this.mHeight * 0.5f) - (this.mDotHeight * r0.dotCount))
                  / this.mSecondLang.indexCount;
          LangAttributeValues langAttributeValues = this.mFirstLang;
          ...
          langAttributeValues2.separatorHeight =
              (langAttributeValues2.height - (this.mDotHeight * this.mFirstLang.dotCount))
                  / this.mFirstLang.indexCount;
          LangAttributeValues langAttributeValues3 = this.mSecondLang;
          langAttributeValues3.separatorHeight =
              (langAttributeValues3.height - (this.mDotHeight * this.mSecondLang.dotCount))
                  / this.mSecondLang.indexCount;
        }
      }
      ...
      if (this.mFirstLang.totalCount == 0) {
        this.mSecondLang.separatorHeight =
            (this.mHeight - (this.mDotHeight * r0.dotCount)) / this.mSecondLang.indexCount;
    ...
    private void manageIndexScrollHeight() {
      ...
      if (this.mAlphabetArrayFirstLetterIndex > 0
          && SemIndexScrollView.this.mIndexer.isUseDigitIndex()) {
        digitIndexCount = 1;
      }
      if (SemIndexScrollView.this.mNumberOfLanguages == 1) {
        ...
        calcDotPosition(
            this.mSecondLang,
            0,
            this.mAlphabetSize - this.mAlphabetArrayLastLetterIndex,
            digitIndexCount);
      }
    }

    private void calcDotPosition(
        LangAttributeValues language,
        int specialIndexCount,
      ...
      System.arraycopy(
          this.mAlphabetArray,
          startIndexPosition,
          language.alphabetArray,
          0,
          endIndexPosition2 - startIndexPosition);
      ...
      while (language.separatorHeight < this.mContentMinHeight
          && this.mAlphabetArrayToDraw.length > 0) {
        ...
        if (language.dotCount >= fullDotCount || isFullCountState) {
          ...
          switch ((language.totalCount - numberOfMissingElements2) - digitIndexCount2) {
            ...
            case 3:
              ...
              break;
            default:
              if (((language.indexCount - language.dotCount) - numberOfMissingElements2)
                      - digitIndexCount2
                  != 1) {
                language.indexCount--;
                language.totalCount--;
          ...
          if (language.totalCount > 0 && language.dotCount >= 0) {
            if (language.indexCount >= 0) {
              ...
              System.arraycopy(
                  this.mAlphabetArray, 0, alphabetArrWithDots, 0, numberOfMissingElements2);
              ...
              while (specialIndexCount3 < indexCount) {
                ...
                if (targetIndex < strArr.length - digitIndexCount2) {
                  if (!isDotPosition) {
                    alphabetArrWithDots[specialIndexCount3] =
                        strArr[targetIndex + startIndexPosition];
                    targetIndex++;
        ...
        while (remainDotCount != 0) {
          ...
          System.arraycopy(
              this.mAlphabetArray, startIndexPosition, alphabetArrWithDots2, 0, earlyLangCount3);
    ...
    public String getIndexByPosition(int x, int y) {
      ...
      if ((this.mPosition == 0 && x < rect.left - this.mAdditionalSpace)
          || (this.mPosition == 1 && x > this.mBgRect.right + this.mAdditionalSpace)) {
        return "";
      }
      if (x >= this.mBgRect.left - this.mAdditionalSpace
          && x <= this.mBgRect.right + this.mAdditionalSpace) {
        if (isInSelectedIndexRect(y)) {
          String[] strArr = this.mAlphabetArrayToDraw;
          return (strArr == null || (i2 = this.mSelectedIndex) < 0 || i2 >= strArr.length)
              ? ""
              : getIndexByY(y);
        }
      ...
      if (i3 == 1
          && x <= (this.mWidth - this.mWidthShift) - (this.mItemWidth + this.mItemWidthGap)) {
        return null;
      }
      if (isInSelectedIndexRect(y)) {
        String[] strArr2 = this.mAlphabetArrayToDraw;
        return (strArr2 == null || (i = this.mSelectedIndex) < 0 || i >= strArr2.length)
            ? ""
            : strArr2[i];
      }
      return getIndexByY(y);
    ...
    private int getIndex(int y) {
      ...
      if (y < this.mScrollTop + this.mScrollTopMargin + this.mFirstLang.height) {
        ...
        int index2 =
            (int)
                ((((y - this.mScrollTop) - this.mScrollTopMargin) - this.mFirstLang.height)
                    / indexTouchBoundary2);
    ...
    private String getIndexByY(int y) {
      int i;
      if (y <= this.mBgRect.top - this.mAdditionalSpace
          || y >= this.mBgRect.bottom + this.mAdditionalSpace) {
        return "";
      }
    ...
    private boolean isInSelectedIndexRect(int y) {
      ...
      return y >= ((int) (((float) (i2 + i3)) + (((float) i) * f)))
          && y <= ((int) (((float) (i2 + i3)) + (f * ((float) (i + 1)))));
    }
    ...
    public void drawEffect(float effectPositionY) {
      ...
      if (i != -1) {
        ...
        if (i3 <= (f2 * 2.0f) + f + i2 + i4) {
          ...
          bottomDrawY =
              ((((this.mScrollTop + this.mScrollTopMargin) - this.mScrollBottomMargin)
                          + this.mFirstLang.height)
                      + this.mSecondLang.height)
                  - ((float) (this.mFirstLang.separatorHeight * 0.5d));
        }
    ...
    private void allocateBgRectangle() {
      ...
      this.mScrollThumbBgRectHeight =
          ((int) (this.mContentMinHeight * 3.0f)) + this.mScrollThumbAdditionalHeight;
      ...
      if ((top < this.mBgRect.top + this.mScrollThumbBgRectPadding
              && bottom > this.mBgRect.bottom - this.mScrollThumbBgRectPadding)
          || this.mScrollThumbBgRectHeight
              >= (this.mBgRect.bottom - this.mBgRect.top) - (this.mScrollThumbBgRectPadding * 2)) {
  ...
  class IndexScrollPreview extends View {
    ...
    private void init(Context context) {
      ...
      this.mTextSize = (int) rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_text_size);
      this.mTextWidhtLimit =
          (int) rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_text_width_limit);
      ...
      this.mTextPaint.setColor(
          rsrc.getColor(C4337R.color.sem_index_scroll_preview_text_color, null));
      this.mTextBounds = new Rect();
      this.mPreviewRadius = rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_radius);
      this.mPreviewCenterMargin =
          rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_center_margin);
      this.mIsOpen = false;
    }
      ...
      if (!this.mIsOpen) {
        anim =
            ObjectAnimator.ofFloat(
                SemIndexScrollView.this.mIndexScrollPreview, "alpha", 0.0f, 1.0f);
      } else {
        anim =
            ObjectAnimator.ofFloat(
                SemIndexScrollView.this.mIndexScrollPreview, "alpha", 1.0f, 0.0f);
      }
    ...
    protected void onDraw(Canvas canvas) {
      ...
      if (this.mIsOpen) {
        canvas.drawCircle(
            this.mPreviewCenterX, this.mPreviewCenterY, this.mPreviewRadius, this.mShapePaint);
        this.mTextPaint.getTextBounds(this.mPreviewText, 0, r1.length() - 1, this.mTextBounds);
        float textY =
            this.mPreviewCenterY - ((this.mTextPaint.descent() + this.mTextPaint.ascent()) / 2.0f);
