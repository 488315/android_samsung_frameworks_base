...
public class SemIndexScrollView extends FrameLayout implements AbsListView.OnScrollListener {
    ...
    class IndexScroll {
        ...
        private void init() {
            ...
            this.mAdditionalSpace = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_additional_touch_boundary);
            this.mIndexScrollPreviewRadius = rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_radius);
            ...
            this.mScrollThumbBgRectPadding = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_thumb_padding);
            this.mScrollThumbAdditionalHeight = (int) rsrc.getDimension(C4337R.dimen.sem_indexbar_thumb_additional_height);
    ...
    class IndexScrollPreview extends View {
        ...
        private void init(Context context) {
            ...
            this.mTextWidhtLimit = (int) rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_text_width_limit);
            ...
            this.mTextPaint.setColor(rsrc.getColor(C4337R.color.sem_index_scroll_preview_text_color, null));
            this.mTextBounds = new Rect();
            this.mPreviewRadius = rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_radius);
            this.mPreviewCenterMargin = rsrc.getDimension(C4337R.dimen.sem_index_scroll_preview_center_margin);
            this.mIsOpen = false;
        }
