...
public class UnknownSourceConfirmActivity extends AlertActivity
  ...
  private void initAlertParams(final int installType) {
    boolean isTablet =
        SystemProperties.get("ro.build.characteristics").contains(BnRConstants.DEVICETYPE_TABLET);
    switch (installType) {
      case 1:
      ...
      case 100:
        ...
        this.mAlertParams.mPositiveButtonText =
            getString(C4337R.string.unknown_install_dlg_negative_button);
        this.mAlertParams.mNegativeButtonText =
            getString(C4337R.string.unknown_install_dlg_positive_button);
      ...
      case 101:
        ...
        if (isTablet) {
          this.mAlertParams.mMessage =
              getString(C4337R.string.unknown_install_publicsign_dlg_desc_tablet);
        } else {
          this.mAlertParams.mMessage =
              getString(C4337R.string.unknown_install_publicsign_dlg_desc_phone);
        }
        this.mAlertParams.mPositiveButtonText =
            getString(C4337R.string.unknown_install_dlg_negative_button);
        this.mAlertParams.mNegativeButtonText =
      ...
      case 141:
        ...
        if (isTablet) {
          this.mAlertParams.mMessage =
              getString(C4337R.string.unknown_install_dlg_desc_phishing_tablet);
        } else {
          this.mAlertParams.mMessage =
              getString(C4337R.string.unknown_install_dlg_desc_phishing_phone);
        }
        this.mAlertParams.mPositiveButtonText =
            getString(C4337R.string.unknown_install_dlg_negative_button);
        this.mAlertParams.mNegativeButtonText =
      ...
      case 127:
        ...
        if (isChinaDevice()) {
          if (isTablet) {
            this.mAlertParams.mMessage =
                getString(C4337R.string.unknown_install_blocked_esm_desc_tablet_china);
          } else {
            this.mAlertParams.mMessage =
                getString(C4337R.string.unknown_install_blocked_esm_desc_phone_china);
          }
        } else if (isTablet) {
          this.mAlertParams.mMessage =
              getString(C4337R.string.unknown_install_blocked_esm_desc_tablet);
        } else {
          this.mAlertParams.mMessage =
              getString(C4337R.string.unknown_install_blocked_esm_desc_phone);
        }
        this.mAlertParams.mPositiveButtonText = getString(17039370);
        this.mAlertParams.mPositiveButtonListener = this;
        break;
