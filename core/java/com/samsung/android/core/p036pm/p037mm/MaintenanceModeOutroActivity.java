...
import com.samsung.android.core.p036pm.p037mm.MaintenanceModeOutroActivity;
...
public class MaintenanceModeOutroActivity extends Activity {
    ...
    private void setContentView(Configuration config) {
        ActionBar actionBar;
        MaintenanceModeUtils.configureLayout(this, this.mResources, config, this.mIsTablet, this.mIsFold, C4337R.layout.activity_maintenance_mode_outro, C4337R.layout.activity_maintenance_mode_outro_land, C4337R.id.maintenance_mode_outro_body_container);
        ...
        this.mExitButton.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_common_button_text_size));
    ...
    private void prepareProgressView() {
        ...
        this.mProgressView = LayoutInflater.from(this).inflate(C4337R.layout.view_maintenance_mode_dump, (ViewGroup) null);
    }
    ...
    private void showDialog() {
        ...
        AlertDialog.Builder builder2 = builder.setMessage(i).setPositiveButton(C4337R.string.maintenance_mode_dialog_button_text_restart, new DialogInterface.OnClickListener() { // from class: com.samsung.android.core.pm.mm.MaintenanceModeOutroActivity$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
                MaintenanceModeOutroActivity.this.lambda$showDialog$1(dialogInterface, i2);
            }
        }).setNegativeButton(C4337R.string.maintenance_mode_dialog_button_text_cancel, new DialogInterface.OnClickListener() { // from class: com.samsung.android.core.pm.mm.MaintenanceModeOutroActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
