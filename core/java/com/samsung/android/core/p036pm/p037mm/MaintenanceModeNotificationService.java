...
public class MaintenanceModeNotificationService extends Service {
    ...
    public void onCreate() {
        ...
        Notification.Builder smallIcon = new Notification.Builder(getApplicationContext(), CHANNEL_ID).setSmallIcon(C4337R.drawable.ic_maintenance_mode_notification);
        if (isTablet) {
        ...
        Notification.Builder builder = smallIcon.setContentTitle(string).setContentText(getResources().getString(C4337R.string.maintenance_mode_notification_message)).setOngoing(true).setContentIntent(pendingIntent);
