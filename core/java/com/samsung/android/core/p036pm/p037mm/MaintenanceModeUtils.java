...
public class MaintenanceModeUtils {
    ...
    static void configureLayout(Activity context, Resources r, Configuration config, boolean isTablet, boolean isFold, int resIdLayoutPortrait, int resIdLayoutLandscape, int resIdContainer) {
        ...
        int breakpointLargeWidth = r.getDimensionPixelSize(C4337R.dimen.maintenance_mode_breakpoint_screen_width_large);
        int breakpointMiddleWidth = r.getDimensionPixelSize(C4337R.dimen.maintenance_mode_breakpoint_screen_width_middle);
        int breakpointMiddleHeight = r.getDimensionPixelSize(C4337R.dimen.maintenance_mode_breakpoint_screen_height_middle);
        int maxWidth = 0;
    ...
    static void sendLoggingDataToSA(Context context, String eventId, String eventValue) {
        try {
            ...
            Log.m94d(TAG, Session.EXTERNAL_INDICATOR + eventId + (eventValue == null ? "" : NativeLibraryHelper.CLEAR_ABI_OVERRIDE + eventValue));
