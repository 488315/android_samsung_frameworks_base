...
import com.samsung.android.core.p036pm.p037mm.MaintenanceModeIntroActivity;
...
public class MaintenanceModeIntroActivity extends Activity {
    ...
    private void setContentView(Configuration config) {
        MaintenanceModeUtils.configureLayout(this, this.mResources, config, this.mIsTablet, this.mIsFold, C4337R.layout.activity_maintenance_mode_intro, C4337R.layout.activity_maintenance_mode_intro_land, C4337R.id.maintenance_mode_intro_body_container);
        ...
        if (this.mIsTablet) {
            ...
            imageView.setMaxWidth(this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_image_max_width_tablet));
            TextView summaryTextView = (TextView) findViewById(C4337R.id.maintenance_mode_intro_summary_textview);
            String summaryTextViewMessage = this.mResources.getString(C4337R.string.maintenance_mode_intro_summary_textview_message_tablet);
            summaryTextView.setText(summaryTextViewMessage);
            TextView descriptionNeedToUnlockTextView = (TextView) findViewById(C4337R.id.maintenance_mode_intro_description_need_to_unlock_textview);
            String descriptionNeedToUnlockTextViewMessage = this.mResources.getString(C4337R.string.maintenance_mode_intro_description_need_to_unlock_tablet);
            descriptionNeedToUnlockTextView.setText(descriptionNeedToUnlockTextViewMessage);
            TextView recommendationTextView = (TextView) findViewById(C4337R.id.maintenance_mode_intro_recommendation_textview);
            String recommendationTextViewMessage = this.mResources.getString(C4337R.string.maintenance_mode_intro_recommendation_textview_message_tablet);
        ...
        TextView cloudBackupMenuMainTextView = (TextView) findViewById(C4337R.id.maintenance_mode_intro_backup_menu_cloud_main_textview);
        cloudBackupMenuMainTextView.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_focus_block_main_text_size));
        TextView textView = (TextView) findViewById(C4337R.id.maintenance_mode_intro_backup_menu_cloud_sub_textview);
        this.mColudBackupMenuSubTextView = textView;
        textView.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_focus_block_sub_text_size));
        this.mColudBackupMenuDivider = findViewById(C4337R.id.maintenance_mode_intro_backup_menu_divider_cloud);
        View findViewById2 = findViewById(C4337R.id.maintenance_mode_intro_backup_menu_external_storage);
        ...
        TextView externalStorageBackupMenuMainTextView = (TextView) findViewById(C4337R.id.f640xcc0fee66);
        externalStorageBackupMenuMainTextView.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_focus_block_main_text_size));
        TextView externalStorageBackupMenuSubTextView = (TextView) findViewById(C4337R.id.maintenance_mode_intro_backup_menu_external_storage_sub_textview);
        externalStorageBackupMenuSubTextView.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_focus_block_sub_text_size));
        ...
        if (this.mIsTablet) {
            button.setWidth(this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_body_button_width_tablet));
        }
        this.mTurnOnButton.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_common_button_text_size));
    ...
    private void prepareWaitingView() {
        ...
        View inflate = LayoutInflater.from(this).inflate(C4337R.layout.view_maintenance_mode_waiting, (ViewGroup) null);
        this.mWaitingView = inflate;
        TextView waitingTextView = (TextView) inflate.findViewById(C4337R.id.maintenance_mode_view_waiting_textview);
        ...
        waitingTextView.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_common_text_size));
        View inflate2 = LayoutInflater.from(this).inflate(C4337R.layout.view_maintenance_mode_dump, (ViewGroup) null);
        this.mDumpView = inflate2;
        TextView dumpTextView = (TextView) inflate2.findViewById(C4337R.id.maintenance_mode_view_dump_textview);
        StringBuilder append = new StringBuilder().append(this.mResources.getString(C4337R.string.maintenance_mode_view_dump_textview_message_creating)).append("\n\n");
        ...
        dumpTextView.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_common_text_size));
        if (this.mIsTablet) {
            int padding = this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_body_padding_left_right_tablet);
            View waitingViewContainer = this.mWaitingView.findViewById(C4337R.id.maintenance_mode_view_waiting_container);
            waitingViewContainer.setPadding(padding, 0, padding, 0);
            View dumpViewContainer = this.mDumpView.findViewById(C4337R.id.maintenance_mode_view_dump_container);
    ...
    protected void onResume() {
        ...
        this.mTimer.schedule(c50031, JobInfo.DEFAULT_INITIAL_BACKOFF_MILLIS, JobInfo.DEFAULT_INITIAL_BACKOFF_MILLIS);
    }
    ...
    private void updateCloudBackupMenuVisibility() {
        ...
        if (this.mIsCloudBackupSupported) {
            ...
            this.mExternalStorageBackupMenu.setBackgroundResource(C4337R.drawable.shape_maintenance_mode_focus_block_bottom);
        } else {
            view.setVisibility(8);
            this.mColudBackupMenuDivider.setVisibility(8);
            this.mExternalStorageBackupMenu.setBackgroundResource(C4337R.drawable.shape_maintenance_mode_focus_block_alone);
        }
    }
    ...
    public void updateCloudBackupMenuSubText() {
        ...
        switch (c) {
            case 0:
                this.mColudBackupMenuSubTextView.setText(this.mResources.getString(C4337R.string.f649x59b6181c));
                break;
            case 1:
                this.mColudBackupMenuSubTextView.setText(this.mResources.getString(C4337R.string.f648xdfc881d9));
                break;
            case 2:
                this.mColudBackupMenuSubTextView.setText(this.mResources.getString(C4337R.string.f647x6cb9c7c5));
                break;
            default:
                if (!TextUtils.isEmpty(this.mCloudBackupIntroDescription)) {
                    ...
                    textView.setText(resources.getQuantityString(C4337R.plurals.maintenance_mode_backup_cloud_menu_sub_textview_message_default, i, Integer.valueOf(i)));
                    break;
                }
        }
    }
    ...
    private void showDialogToInformSecureLockIsNeeded() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setMessage(C4337R.string.maintenance_mode_intro_dialog_message_set_screen_lock_first).setPositiveButton(C4337R.string.maintenance_mode_intro_dialog_button_text_set_screen_lock, new DialogInterface.OnClickListener() { // from class: com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda8
        ...
        }).setNegativeButton(C4337R.string.maintenance_mode_dialog_button_text_cancel, new DialogInterface.OnClickListener() { // from class: com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda9
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showDialogToNotifyLowOnStorage() {
        ...
        AlertDialog.Builder title = new AlertDialog.Builder(this).setTitle(C4337R.string.maintenance_mode_intro_low_storage_dialog_title);
        if (this.mIsTablet) {
        ...
        AlertDialog.Builder builder = title.setMessage(i).setPositiveButton(C4337R.string.maintenance_mode_intro_low_storage_dialog_button_text, new DialogInterface.OnClickListener() { // from class: com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda11
            @Override // android.content.DialogInterface.OnClickListener
    ...
    private void showDialogToReconfirmCancelingBackup(String backupStatus) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setMessage(messageResId).setPositiveButton(C4337R.string.maintenance_mode_dialog_button_text_ok, new DialogInterface.OnClickListener() { // from class: com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda25
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                MaintenanceModeIntroActivity.this.lambda$showDialogToReconfirmCancelingBackup$16(needToLaunchCloudApp, dialogInterface, i);
            }
        }).setNegativeButton(C4337R.string.maintenance_mode_dialog_button_text_cancel, new DialogInterface.OnClickListener() { // from class: com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda26
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showDialogToConfirmRestart() {
        int i;
        int i2;
        this.mDialogView = LayoutInflater.from(this).inflate(C4337R.layout.dialog_maintenance_mode_intro, (ViewGroup) null);
        adjustDialogLayout(getResources().getConfiguration());
        final CheckedTextView checkedTextView = (CheckedTextView) this.mDialogView.findViewById(C4337R.id.maintenance_mode_intro_dialog_checked_textview);
        ...
        checkedTextView.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_common_checkbox_text_size, 1.1f));
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setView(this.mDialogView).setPositiveButton(C4337R.string.maintenance_mode_dialog_button_text_restart, new DialogInterface.OnClickListener() { // from class: com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda5
            @Override // android.content.DialogInterface.OnClickListener
        ...
        AlertDialog dialog = builder.create();
        dialog.getWindow().setGravity(80);
        TextView dialogTextView = (TextView) this.mDialogView.findViewById(C4337R.id.maintenance_mode_intro_dialog_textview);
        ...
        dialogTextView.setTextSize(0, MaintenanceModeUtils.getFontSize(this.mContext, C4337R.dimen.maintenance_mode_common_text_size));
        dialog.show();
    }
    ...
    private void adjustDialogLayout(Configuration config) {
        ...
        if ((!this.mIsFold || config.semDisplayDeviceType == 5) && (view = this.mDialogView) != null) {
            ScrollView dialogScrollView = (ScrollView) view.findViewById(C4337R.id.maintenance_mode_intro_dialog_scrollview);
            ViewGroup.MarginLayoutParams dialogScrollViewLayoutParams = (ViewGroup.MarginLayoutParams) dialogScrollView.getLayoutParams();
            View checkBoxLayout = this.mDialogView.findViewById(C4337R.id.maintenance_mode_intro_dialog_checkbox_layout);
            ViewGroup.MarginLayoutParams checkBoxLayoutParams = (ViewGroup.MarginLayoutParams) checkBoxLayout.getLayoutParams();
            if (config.orientation == 2) {
                dialogScrollViewLayoutParams.topMargin = this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_dialog_margin_top_land);
                int checkBoxPadding = this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_dialog_checkbox_padding_top_bottom_land);
                checkBoxLayout.setPadding(0, checkBoxPadding, 0, checkBoxPadding);
                checkBoxLayoutParams.bottomMargin = this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_dialog_checkbox_margin_bottom_land);
            } else {
                dialogScrollViewLayoutParams.topMargin = this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_dialog_margin_top);
                int checkBoxPadding2 = this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_dialog_checkbox_padding_top_bottom);
                checkBoxLayout.setPadding(0, checkBoxPadding2, 0, checkBoxPadding2);
                checkBoxLayoutParams.bottomMargin = this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_dialog_checkbox_margin_bottom);
            }
