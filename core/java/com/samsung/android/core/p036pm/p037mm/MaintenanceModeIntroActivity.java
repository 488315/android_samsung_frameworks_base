...
public class MaintenanceModeIntroActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (!MaintenanceModeUtils.hasSystemFeature()
        || MaintenanceModeUtils.doesMaintenanceModeUserIdExist(this.mContext)
  ...
  private void setContentView(Configuration config) {
    MaintenanceModeUtils.configureLayout(
        ...
        this.mIsTablet,
        this.mIsFold,
        C4337R.layout.activity_maintenance_mode_intro,
        C4337R.layout.activity_maintenance_mode_intro_land,
        C4337R.id.maintenance_mode_intro_body_container);
    ActionBar actionBar = getActionBar();
    if (actionBar != null) {
      actionBar.setDisplayHomeAsUpEnabled(true);
    }
    if (this.mIsTablet) {
      ImageView imageView = (ImageView) findViewById(C4337R.id.maintenance_mode_intro_imageview);
      imageView.setMaxWidth(
          this.mResources.getDimensionPixelSize(
              C4337R.dimen.maintenance_mode_image_max_width_tablet));
      TextView summaryTextView =
          (TextView) findViewById(C4337R.id.maintenance_mode_intro_summary_textview);
      String summaryTextViewMessage =
          this.mResources.getString(
              C4337R.string.maintenance_mode_intro_summary_textview_message_tablet);
      summaryTextView.setText(summaryTextViewMessage);
      TextView descriptionNeedToUnlockTextView =
          (TextView)
              findViewById(C4337R.id.maintenance_mode_intro_description_need_to_unlock_textview);
      String descriptionNeedToUnlockTextViewMessage =
          this.mResources.getString(
              C4337R.string.maintenance_mode_intro_description_need_to_unlock_tablet);
      descriptionNeedToUnlockTextView.setText(descriptionNeedToUnlockTextViewMessage);
      TextView recommendationTextView =
          (TextView) findViewById(C4337R.id.maintenance_mode_intro_recommendation_textview);
      String recommendationTextViewMessage =
          this.mResources.getString(
              C4337R.string.maintenance_mode_intro_recommendation_textview_message_tablet);
      recommendationTextView.setText(recommendationTextViewMessage);
    }
    View findViewById = findViewById(C4337R.id.maintenance_mode_intro_backup_menu_cloud);
    this.mColudBackupMenu = findViewById;
    findViewById.setBackgroundResource(C4337R.drawable.shape_maintenance_mode_focus_block_top);
    this.mColudBackupMenu.setOnClickListener(
        new View
            .OnClickListener() { // from class:
                                 // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda29
          @Override // android.view.View.OnClickListener
          public final void onClick(View view) {
            MaintenanceModeIntroActivity.this.lambda$setContentView$2(view);
          }
        });
    TextView cloudBackupMenuMainTextView =
        (TextView) findViewById(C4337R.id.maintenance_mode_intro_backup_menu_cloud_main_textview);
    cloudBackupMenuMainTextView.setTextSize(
        0,
        MaintenanceModeUtils.getFontSize(
            this.mContext, C4337R.dimen.maintenance_mode_focus_block_main_text_size));
    TextView textView =
        (TextView) findViewById(C4337R.id.maintenance_mode_intro_backup_menu_cloud_sub_textview);
    this.mColudBackupMenuSubTextView = textView;
    textView.setTextSize(
        0,
        MaintenanceModeUtils.getFontSize(
            this.mContext, C4337R.dimen.maintenance_mode_focus_block_sub_text_size));
    this.mColudBackupMenuDivider =
        findViewById(C4337R.id.maintenance_mode_intro_backup_menu_divider_cloud);
    View findViewById2 =
        findViewById(C4337R.id.maintenance_mode_intro_backup_menu_external_storage);
    this.mExternalStorageBackupMenu = findViewById2;
    findViewById2.setBackgroundResource(C4337R.drawable.shape_maintenance_mode_focus_block_alone);
    this.mExternalStorageBackupMenu.setOnClickListener(
        new View
            .OnClickListener() { // from class:
                                 // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda30
          @Override // android.view.View.OnClickListener
          public final void onClick(View view) {
            MaintenanceModeIntroActivity.this.lambda$setContentView$4(view);
          }
        });
    TextView externalStorageBackupMenuMainTextView =
        (TextView) findViewById(C4337R.id.f640xcc0fee66);
    externalStorageBackupMenuMainTextView.setTextSize(
        0,
        MaintenanceModeUtils.getFontSize(
            this.mContext, C4337R.dimen.maintenance_mode_focus_block_main_text_size));
    TextView externalStorageBackupMenuSubTextView =
        (TextView)
            findViewById(
                C4337R.id.maintenance_mode_intro_backup_menu_external_storage_sub_textview);
    externalStorageBackupMenuSubTextView.setTextSize(
        0,
        MaintenanceModeUtils.getFontSize(
            this.mContext, C4337R.dimen.maintenance_mode_focus_block_sub_text_size));
    updateCloudBackupMenuSubText();
    updateCloudBackupMenuVisibility();
    Button button = (Button) findViewById(C4337R.id.maintenance_mode_intro_turnon_button);
    ...
    this.mTurnOnButton.setTextSize(
        0,
        MaintenanceModeUtils.getFontSize(
            this.mContext, C4337R.dimen.maintenance_mode_common_button_text_size));
    this.mTurnOnButton.setOnClickListener(
        new View
            .OnClickListener() { // from class:
                                 // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda31
          @Override // android.view.View.OnClickListener
          public final void onClick(View view) {
  ...
  public /* synthetic */ void lambda$setContentView$2(View v) {
    this.mButtonExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda18
    ...
    this.mLoggingExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda19
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$setContentView$4(View v) {
    ...
    this.mLoggingExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda17
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$setContentView$8(View v) {
    if (!MaintenanceModeUtils.isSecureLockSet(this.mContext)) {
      ...
      this.mButtonExecutor.submit(
          new Runnable() { // from class:
                           // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
      ...
      this.mLoggingExecutor.submit(
          new Runnable() { // from class:
                           // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public /* synthetic */ void lambda$setContentView$6() {
    ...
    runOnUiThread(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda7
          @Override // java.lang.Runnable
          public final void run() {
  ...
  private void prepareWaitingView() {
    ...
    View inflate =
        LayoutInflater.from(this)
            .inflate(C4337R.layout.view_maintenance_mode_waiting, (ViewGroup) null);
    this.mWaitingView = inflate;
    TextView waitingTextView =
        (TextView) inflate.findViewById(C4337R.id.maintenance_mode_view_waiting_textview);
    Resources resources = this.mResources;
    if (this.mIsTablet) {
      i = C4337R.string.maintenance_mode_view_waiting_textview_message_tablet;
    } else {
      i = C4337R.string.maintenance_mode_view_waiting_textview_message_phone;
    }
    String waitingTextViewMessage = resources.getString(i);
    waitingTextView.setText(waitingTextViewMessage);
    waitingTextView.setTextSize(
        0,
        MaintenanceModeUtils.getFontSize(
            this.mContext, C4337R.dimen.maintenance_mode_common_text_size));
    View inflate2 =
        LayoutInflater.from(this)
            .inflate(C4337R.layout.view_maintenance_mode_dump, (ViewGroup) null);
    this.mDumpView = inflate2;
    TextView dumpTextView =
        (TextView) inflate2.findViewById(C4337R.id.maintenance_mode_view_dump_textview);
    StringBuilder append =
        new StringBuilder()
            .append(
                this.mResources.getString(
                    C4337R.string.maintenance_mode_view_dump_textview_message_creating))
            .append("\n\n");
    Resources resources2 = this.mResources;
    if (this.mIsTablet) {
      i2 = C4337R.string.maintenance_mode_view_dump_textview_message_tablet;
    } else {
      i2 = C4337R.string.maintenance_mode_view_dump_textview_message_phone;
    }
    String dumpTextViewMessage = append.append(resources2.getString(i2)).toString();
    dumpTextView.setText(dumpTextViewMessage);
    dumpTextView.setTextSize(
        0,
        MaintenanceModeUtils.getFontSize(
            this.mContext, C4337R.dimen.maintenance_mode_common_text_size));
    if (this.mIsTablet) {
      int padding =
          this.mResources.getDimensionPixelSize(
              C4337R.dimen.maintenance_mode_body_padding_left_right_tablet);
      View waitingViewContainer =
          this.mWaitingView.findViewById(C4337R.id.maintenance_mode_view_waiting_container);
      waitingViewContainer.setPadding(padding, 0, padding, 0);
      View dumpViewContainer =
          this.mDumpView.findViewById(C4337R.id.maintenance_mode_view_dump_container);
  ...
  protected void onResume() {
    ...
    checkAndUpdateCloudBackupMenu();
    C50031 c50031 = new C50031();
    this.mCloudBackupTimerTask = c50031;
    this.mTimer.schedule(
        c50031, JobInfo.DEFAULT_INITIAL_BACKOFF_MILLIS, JobInfo.DEFAULT_INITIAL_BACKOFF_MILLIS);
  }

  /* renamed from: com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$1 */
  class C50031 extends TimerTask {
    C50031() {}
    ...
    public void run() {
      if (MaintenanceModeIntroActivity.this.mIsCloudBackupSupported) {
        try {
          MaintenanceModeIntroActivity.this.mSingleThreadExecutor.submit(
              new Runnable() { // from class:
                               // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                  MaintenanceModeIntroActivity.C50031.this.lambda$run$0();
                }
              });
        } catch (Exception e) {
        }
  ...
  private void checkAndUpdateCloudBackupMenu() {
    this.mSingleThreadExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda10
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$checkAndUpdateCloudBackupMenu$10() {
    ...
    MaintenanceModeUtils.CloudInfo cloudInfo =
        MaintenanceModeUtils.checkCloudBackupSupport(this.mContext);
    ...
    runOnUiThread(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  private void updateCloudBackupMenuVisibility() {
    ...
    if (view == null
        || this.mColudBackupMenuDivider == null
        || this.mExternalStorageBackupMenu == null) {
      return;
    }
    if (this.mIsCloudBackupSupported) {
      view.setVisibility(0);
      this.mColudBackupMenuDivider.setVisibility(0);
      this.mExternalStorageBackupMenu.setBackgroundResource(
          C4337R.drawable.shape_maintenance_mode_focus_block_bottom);
    } else {
      view.setVisibility(8);
      this.mColudBackupMenuDivider.setVisibility(8);
      this.mExternalStorageBackupMenu.setBackgroundResource(
          C4337R.drawable.shape_maintenance_mode_focus_block_alone);
    }
  }
  ...
  public void updateCloudBackupMenuSubText() {
    ...
    switch (c) {
      case 0:
        this.mColudBackupMenuSubTextView.setText(
            this.mResources.getString(C4337R.string.f649x59b6181c));
        break;
      case 1:
        this.mColudBackupMenuSubTextView.setText(
            this.mResources.getString(C4337R.string.f648xdfc881d9));
        break;
      case 2:
        this.mColudBackupMenuSubTextView.setText(
            this.mResources.getString(C4337R.string.f647x6cb9c7c5));
        break;
      default:
        if (!TextUtils.isEmpty(this.mCloudBackupIntroDescription)) {
          ...
          textView.setText(
              resources.getQuantityString(
                  C4337R.plurals.maintenance_mode_backup_cloud_menu_sub_textview_message_default,
                  i,
                  Integer.valueOf(i)));
          break;
        }
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (action != null) {
        try {
          MaintenanceModeIntroActivity.this.mSingleThreadExecutor.submit(
              new Runnable() { // from class:
                               // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$CloudBackupReceiver$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
      ...
      Log.m98i("MaintenanceMode", "onReceive: " + action);
    }
  ...
  private void showDialogToInformSecureLockIsNeeded() {
    AlertDialog.Builder builder =
        new AlertDialog.Builder(this)
            .setMessage(C4337R.string.maintenance_mode_intro_dialog_message_set_screen_lock_first)
            .setPositiveButton(
                C4337R.string.maintenance_mode_intro_dialog_button_text_set_screen_lock,
                new DialogInterface
                    .OnClickListener() { // from class:
                                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda8
                  @Override // android.content.DialogInterface.OnClickListener
                  public final void onClick(DialogInterface dialogInterface, int i) {
                    MaintenanceModeIntroActivity.this
                        .lambda$showDialogToInformSecureLockIsNeeded$11(dialogInterface, i);
                  }
                })
            .setNegativeButton(
                ...
                new DialogInterface
                    .OnClickListener() { // from class:
                                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda9
                  @Override // android.content.DialogInterface.OnClickListener
                  public final void onClick(DialogInterface dialogInterface, int i) {
                    MaintenanceModeIntroActivity.lambda$showDialogToInformSecureLockIsNeeded$12(
                        dialogInterface, i);
                  }
                });
  ...
  static /* synthetic */ void lambda$showDialogToInformSecureLockIsNeeded$12(
      DialogInterface dialog, int which) {}

  private void showDialogToNotifyLowOnStorage() {
    int i;
    Log.m98i("MaintenanceMode", "Low on storage");
    AlertDialog.Builder title =
        new AlertDialog.Builder(this)
            .setTitle(C4337R.string.maintenance_mode_intro_low_storage_dialog_title);
    if (this.mIsTablet) {
      i = C4337R.string.maintenance_mode_intro_low_storage_dialog_message_tablet;
    } else {
      i = C4337R.string.maintenance_mode_intro_low_storage_dialog_message_phone;
    }
    AlertDialog.Builder builder =
        title
            .setMessage(i)
            .setPositiveButton(
                C4337R.string.maintenance_mode_intro_low_storage_dialog_button_text,
                new DialogInterface
                    .OnClickListener() { // from class:
                                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda11
                  @Override // android.content.DialogInterface.OnClickListener
                  public final void onClick(DialogInterface dialogInterface, int i2) {
                    MaintenanceModeIntroActivity.this.lambda$showDialogToNotifyLowOnStorage$13(
                        dialogInterface, i2);
                  }
                });
    AlertDialog dialog = builder.create();
  ...
  private void showDialogToReconfirmCancelingBackup(String backupStatus) {
    char c;
    int messageResId = C4337R.string.maintenance_mode_stop_backup_dialog_message;
    ...
    if (backupStatus != null) {
      ...
      switch (c) {
        case 0:
          messageResId = C4337R.string.maintenance_mode_stop_backup_dialog_message_backing_up;
          isCloudBackupInProgress = true;
          break;
        case 1:
          messageResId = C4337R.string.maintenance_mode_stop_backup_dialog_message_backed_up_failed;
          isCloudBackupInProgress = true;
          break;
        case 2:
          messageResId = C4337R.string.maintenance_mode_stop_backup_dialog_message_restoring;
          isCloudBackupInProgress = true;
          break;
      }
    }
    ...
    AlertDialog.Builder builder =
        new AlertDialog.Builder(this)
            ...
            .setPositiveButton(
                C4337R.string.maintenance_mode_dialog_button_text_ok,
                new DialogInterface
                    .OnClickListener() { // from class:
                                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda25
                  @Override // android.content.DialogInterface.OnClickListener
                  public final void onClick(DialogInterface dialogInterface, int i) {
                    MaintenanceModeIntroActivity.this
                        .lambda$showDialogToReconfirmCancelingBackup$16(
                            needToLaunchCloudApp, dialogInterface, i);
                  }
                })
            .setNegativeButton(
                C4337R.string.maintenance_mode_dialog_button_text_cancel,
                new DialogInterface
                    .OnClickListener() { // from class:
                                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda26
                  @Override // android.content.DialogInterface.OnClickListener
                  public final void onClick(DialogInterface dialogInterface, int i) {
                    MaintenanceModeIntroActivity.this
                        .lambda$showDialogToReconfirmCancelingBackup$18(dialogInterface, i);
                  }
                })
            .setOnCancelListener(
                new DialogInterface
                    .OnCancelListener() { // from class:
                                          // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda27
                  @Override // android.content.DialogInterface.OnCancelListener
                  public final void onCancel(DialogInterface dialogInterface) {
                    MaintenanceModeIntroActivity.this
                        .lambda$showDialogToReconfirmCancelingBackup$20(dialogInterface);
                  }
                });
    AlertDialog dialog = builder.create();
    dialog.getWindow().setGravity(80);
  ...
  public /* synthetic */ void lambda$showDialogToReconfirmCancelingBackup$16(
    ...
    if (needToLaunchCloudApp) {
      this.mButtonExecutor.submit(
          new Runnable() { // from class:
                           // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
    ...
    this.mLoggingExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda13
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$showDialogToReconfirmCancelingBackup$18(
    ...
    this.mLoggingExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda20
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$showDialogToReconfirmCancelingBackup$20(
    ...
    this.mLoggingExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda22
          @Override // java.lang.Runnable
          public final void run() {
  ...
  private void showDialogToConfirmRestart() {
    ...
    this.mDialogView =
        LayoutInflater.from(this)
            .inflate(C4337R.layout.dialog_maintenance_mode_intro, (ViewGroup) null);
    adjustDialogLayout(getResources().getConfiguration());
    final CheckedTextView checkedTextView =
        (CheckedTextView)
            this.mDialogView.findViewById(C4337R.id.maintenance_mode_intro_dialog_checked_textview);
    checkedTextView.setOnClickListener(
        new View
            .OnClickListener() { // from class:
                                 // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda4
          @Override // android.view.View.OnClickListener
          public final void onClick(View view) {
            CheckedTextView.this.toggle();
          }
        });
    checkedTextView.setTextSize(
        0,
        MaintenanceModeUtils.getFontSize(
            this.mContext, C4337R.dimen.maintenance_mode_common_checkbox_text_size, 1.1f));
    AlertDialog.Builder builder =
        new AlertDialog.Builder(this)
            ...
            .setPositiveButton(
                ...
                new DialogInterface
                    .OnClickListener() { // from class:
                                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda5
                  @Override // android.content.DialogInterface.OnClickListener
                  public final void onClick(DialogInterface dialogInterface, int i3) {
                    MaintenanceModeIntroActivity.this.lambda$showDialogToConfirmRestart$26(
                        checkedTextView, dialogInterface, i3);
                  }
                });
    AlertDialog dialog = builder.create();
    dialog.getWindow().setGravity(80);
    TextView dialogTextView =
        (TextView) this.mDialogView.findViewById(C4337R.id.maintenance_mode_intro_dialog_textview);
    StringBuilder sb = new StringBuilder();
    Resources resources = this.mResources;
    if (this.mIsTablet) {
      i = C4337R.string.maintenance_mode_intro_dialog_message_tablet;
    } else {
      i = C4337R.string.maintenance_mode_intro_dialog_message_phone;
    }
    StringBuilder append = sb.append(resources.getString(i)).append("\n\n");
    Resources resources2 = this.mResources;
    if (this.mIsTablet) {
      i2 = C4337R.string.maintenance_mode_intro_dialog_textview_message_tablet;
    } else {
      i2 = C4337R.string.maintenance_mode_intro_dialog_textview_message_phone;
    }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$showDialogToConfirmRestart$26(
    ...
    if (isChecked) {
      ...
      new Thread(
              new Runnable() { // from class:
                               // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda14
                @Override // java.lang.Runnable
                public final void run() {
    ...
    this.mLoggingExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda15
          @Override // java.lang.Runnable
          public final void run() {
    ...
    this.mLoggingExecutor.submit(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda16
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$showDialogToConfirmRestart$23() {
    ...
    if (userInfo == null) {
      ...
      runOnUiThread(
          new Runnable() { // from class:
                           // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda28
            @Override // java.lang.Runnable
            public final void run() {
  ...
  private void adjustDialogLayout(Configuration config) {
    ...
    if ((!this.mIsFold || config.semDisplayDeviceType == 5) && (view = this.mDialogView) != null) {
      ScrollView dialogScrollView =
          (ScrollView) view.findViewById(C4337R.id.maintenance_mode_intro_dialog_scrollview);
      ViewGroup.MarginLayoutParams dialogScrollViewLayoutParams =
          (ViewGroup.MarginLayoutParams) dialogScrollView.getLayoutParams();
      View checkBoxLayout =
          this.mDialogView.findViewById(C4337R.id.maintenance_mode_intro_dialog_checkbox_layout);
      ViewGroup.MarginLayoutParams checkBoxLayoutParams =
          (ViewGroup.MarginLayoutParams) checkBoxLayout.getLayoutParams();
      if (config.orientation == 2) {
        dialogScrollViewLayoutParams.topMargin =
            this.mResources.getDimensionPixelSize(
                C4337R.dimen.maintenance_mode_dialog_margin_top_land);
        int checkBoxPadding =
            this.mResources.getDimensionPixelSize(
                C4337R.dimen.maintenance_mode_dialog_checkbox_padding_top_bottom_land);
        checkBoxLayout.setPadding(0, checkBoxPadding, 0, checkBoxPadding);
        checkBoxLayoutParams.bottomMargin =
            this.mResources.getDimensionPixelSize(
                C4337R.dimen.maintenance_mode_dialog_checkbox_margin_bottom_land);
      } else {
        dialogScrollViewLayoutParams.topMargin =
            this.mResources.getDimensionPixelSize(C4337R.dimen.maintenance_mode_dialog_margin_top);
        int checkBoxPadding2 =
            this.mResources.getDimensionPixelSize(
                C4337R.dimen.maintenance_mode_dialog_checkbox_padding_top_bottom);
        checkBoxLayout.setPadding(0, checkBoxPadding2, 0, checkBoxPadding2);
        checkBoxLayoutParams.bottomMargin =
            this.mResources.getDimensionPixelSize(
                C4337R.dimen.maintenance_mode_dialog_checkbox_margin_bottom);
      }
  ...
  private void triggerDump() {
    ...
    this.mRootView.postDelayed(
        new Runnable() { // from class:
                         // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda21
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void lambda$triggerDump$27() {
    if (isDumpRunning() && !isDumpTimeout()) {
      this.mRootView.postDelayed(
          new Runnable() { // from class:
                           // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda23
            @Override // java.lang.Runnable
            public final void run() {
      ...
      new Thread(
              new Runnable() { // from class:
                               // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda24
                @Override // java.lang.Runnable
                public final void run() {
  ...
  public /* synthetic */ void lambda$checkPendingDump$30() {
    ...
    if (userInfo == null) {
      ...
      runOnUiThread(
          new Runnable() { // from class:
                           // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
  ...
  private boolean isDumpTimeout() {
    ...
    if (remainingTime <= 0) {
      Log.m98i("MaintenanceMode", "Dumpstate wait timed out");
      return true;
    }
    return false;
  }
  ...
  private UserInfo enterMaintenanceMode() {
    ...
    try {
      ...
      return um.createUser(this.mResources.getString(C4337R.string.maintenance_mode_name), 525312);
    } catch (Exception e) {
