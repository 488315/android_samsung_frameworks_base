    ...
    private void initAlertParams(final int installType) {
        ...
        switch (installType) {
            ...
            case 100:
                ...
                if (isTablet) {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_dlg_desc_tablet);
                } else {
                    this.mAlertParams.mMessage = getString(R.string.unknown_install_dlg_desc_phone);
                }
                this.mAlertParams.mPositiveButtonText =
                        getString(R.string.unknown_install_dlg_negative_button);
                this.mAlertParams.mNegativeButtonText =
                        getString(R.string.unknown_install_dlg_positive_button);
            ...
            case 101:
                ...
                if (isTablet) {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_dlg_desc_global_tablet);
                } else {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_dlg_desc_global_phone);
                }
                this.mAlertParams.mPositiveButtonText =
                        getString(R.string.unknown_install_dlg_negative_button);
                this.mAlertParams.mNegativeButtonText =
            ...
            case 102:
                ...
                if (isTablet) {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_publicsign_dlg_desc_tablet);
                } else {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_publicsign_dlg_desc_phone);
                }
                this.mAlertParams.mPositiveButtonText =
                        getString(R.string.unknown_install_dlg_negative_button);
                this.mAlertParams.mNegativeButtonText =
                ...
                break;
            case 127:
                this.mAlertParams.mCustomTitleView =
                        LayoutInflater.from(this)
                                .inflate(
                                        R.layout.dialog_unknownsource_autoblocker,
                                        (ViewGroup) null);
                if (isChinaDevice()) {
                    if (isTablet) {
                        this.mAlertParams.mMessage =
                                getString(R.string.unknown_install_blocked_esm_desc_tablet_china);
                    } else {
                        this.mAlertParams.mMessage =
                                getString(R.string.unknown_install_blocked_esm_desc_phone_china);
                    }
                } else if (isTablet) {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_blocked_esm_desc_tablet);
                } else {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_blocked_esm_desc_phone);
                }
                this.mAlertParams.mPositiveButtonText = getString(17039370);
                this.mAlertParams.mPositiveButtonListener = this;
                break;
            case 140:
                ...
                if (isTablet) {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_dlg_desc_phishing_tablet);
                } else {
                    this.mAlertParams.mMessage =
                            getString(R.string.unknown_install_dlg_desc_phishing_phone);
                }
                this.mAlertParams.mPositiveButtonText =
                        getString(R.string.unknown_install_dlg_negative_button);
                this.mAlertParams.mNegativeButtonText =
                        getString(R.string.unknown_install_dlg_positive_button);
                this.mAlertParams.mNegativeButtonListener =
                        new DialogInterface
                                .OnClickListener() { // from class:
                                                     // com.samsung.android.core.pm.install.UnknownSourceConfirmActivity$$ExternalSyntheticLambda0
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i) {
                                UnknownSourceConfirmActivity.this.lambda$initAlertParams$0(
                                        installType, dialogInterface, i);
                            }
                        };
                break;
            default:
