...
public class MaintenanceModeIntroActivity extends Activity {
    ...
    private void setContentView(Configuration config) {
        MaintenanceModeUtils.configureLayout(
                ...
                this.mIsTablet,
                this.mIsFold,
                R.layout.activity_maintenance_mode_intro,
                R.layout.activity_maintenance_mode_intro_land,
                R.id.maintenance_mode_intro_body_container);
        ...
        if (this.mIsTablet) {
            ...
            TextView summaryTextView =
                    (TextView) findViewById(R.id.maintenance_mode_intro_summary_textview);
            String summaryTextViewMessage =
                    this.mResources.getString(
                            R.string.maintenance_mode_intro_summary_textview_message_tablet);
            summaryTextView.lambda$setTextAsync$0(summaryTextViewMessage);
            TextView descriptionNeedToUnlockTextView =
                    (TextView)
                            findViewById(
                                    R.id
                                            .maintenance_mode_intro_description_need_to_unlock_textview);
            String descriptionNeedToUnlockTextViewMessage =
                    this.mResources.getString(
                            R.string.maintenance_mode_intro_description_need_to_unlock_tablet);
            descriptionNeedToUnlockTextView.lambda$setTextAsync$0(
                    descriptionNeedToUnlockTextViewMessage);
            TextView recommendationTextView =
                    (TextView) findViewById(R.id.maintenance_mode_intro_recommendation_textview);
            String recommendationTextViewMessage =
                    this.mResources.getString(
                            R.string.maintenance_mode_intro_recommendation_textview_message_tablet);
        ...
        this.mColudBackupMenu.setBackgroundResource(
                R.drawable.shape_maintenance_mode_focus_block_top);
        this.mColudBackupMenu.setOnClickListener(
                new View
                        .OnClickListener() { // from class:
                                             // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda0
        ...
        TextView cloudBackupMenuMainTextView =
                (TextView)
                        findViewById(R.id.maintenance_mode_intro_backup_menu_cloud_main_textview);
        cloudBackupMenuMainTextView.setTextSize(
                0,
                MaintenanceModeUtils.getFontSize(
                        this.mContext, R.dimen.maintenance_mode_focus_block_main_text_size));
        this.mColudBackupMenuSubTextView =
                (TextView) findViewById(R.id.maintenance_mode_intro_backup_menu_cloud_sub_textview);
        this.mColudBackupMenuSubTextView.setTextSize(
                0,
                MaintenanceModeUtils.getFontSize(
                        this.mContext, R.dimen.maintenance_mode_focus_block_sub_text_size));
        this.mColudBackupMenuDivider =
                findViewById(R.id.maintenance_mode_intro_backup_menu_divider_cloud);
        this.mExternalStorageBackupMenu =
                findViewById(R.id.maintenance_mode_intro_backup_menu_external_storage);
        this.mExternalStorageBackupMenu.setBackgroundResource(
                R.drawable.shape_maintenance_mode_focus_block_alone);
        ...
        TextView externalStorageBackupMenuMainTextView =
                (TextView)
                        findViewById(
                                R.id
                                        .maintenance_mode_intro_backup_menu_external_storage_main_textview);
        ...
        TextView externalStorageBackupMenuSubTextView =
                (TextView)
                        findViewById(
                                R.id
                                        .maintenance_mode_intro_backup_menu_external_storage_sub_textview);
    ...
    private void prepareWaitingView() {
        ...
        this.mWaitingView
                .findViewById(R.id.maintenance_mode_view_dump_progressbar_container)
                .setVisibility(8);
        TextView waitingTextView =
                (TextView) this.mWaitingView.findViewById(R.id.maintenance_mode_view_dump_textview);
        ...
        waitingTextView.setTextSize(
                0,
                MaintenanceModeUtils.getFontSize(
                        this.mContext, R.dimen.maintenance_mode_common_text_size));
        this.mDumpView =
                LayoutInflater.from(this)
                        .inflate(R.layout.view_maintenance_mode_dump, (ViewGroup) null);
        TextView dumpTextView =
                (TextView) this.mDumpView.findViewById(R.id.maintenance_mode_view_dump_textview);
        StringBuilder append =
                new StringBuilder()
                        .append(
                                this.mResources.getString(
                                        R.string
                                                .maintenance_mode_view_dump_textview_message_creating))
                        .append("\n\n");
        ...
        if (this.mIsTablet) {
            int padding =
                    this.mResources.getDimensionPixelSize(
                            R.dimen.maintenance_mode_body_padding_left_right_tablet);
            View waitingViewContainer =
                    this.mWaitingView.findViewById(R.id.maintenance_mode_view_dump_container);
            waitingViewContainer.setPadding(padding, 0, padding, 0);
            View dumpViewContainer =
                    this.mDumpView.findViewById(R.id.maintenance_mode_view_dump_container);
                ...
                try {
                    MaintenanceModeIntroActivity.this.mSingleThreadExecutor.submit(
                            new Runnable() { // from class:
                                ...
                                @Override // java.lang.Runnable
                                public final void run() {
                                    MaintenanceModeIntroActivity.AnonymousClass1.this
                                            .lambda$run$0();
                                }
                            });
                } catch (Exception e) {
    ...
    private void checkAndUpdateCloudBackupMenu() {
        this.mSingleThreadExecutor.submit(
                new Runnable() { // from class:
                                 // com.samsung.android.core.pm.mm.MaintenanceModeIntroActivity$$ExternalSyntheticLambda32
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    private void updateCloudBackupMenuVisibility() {
        ...
        if (this.mIsCloudBackupSupported) {
            ...
            this.mExternalStorageBackupMenu.setBackgroundResource(
                    R.drawable.shape_maintenance_mode_focus_block_bottom);
        } else {
    ...
    public void updateCloudBackupMenuSubText() {
        ...
        switch (c) {
            case 0:
                this.mColudBackupMenuSubTextView.lambda$setTextAsync$0(
                        this.mResources.getString(
                                R.string
                                        .maintenance_mode_backup_cloud_menu_sub_textview_message_backing_up));
                break;
            case 1:
                this.mColudBackupMenuSubTextView.lambda$setTextAsync$0(
                        this.mResources.getString(
                                R.string
                                        .maintenance_mode_backup_cloud_menu_sub_textview_message_backed_up_succeeded));
                break;
            case 2:
                this.mColudBackupMenuSubTextView.lambda$setTextAsync$0(
                        this.mResources.getString(
                                R.string
                                        .maintenance_mode_backup_cloud_menu_sub_textview_message_backed_up_failed));
                break;
            default:
                if (!TextUtils.isEmpty(this.mCloudBackupIntroDescription)) {
                    this.mColudBackupMenuSubTextView.lambda$setTextAsync$0(
                            this.mCloudBackupIntroDescription);
                    break;
                } else {
                    this.mColudBackupMenuSubTextView.lambda$setTextAsync$0(
                            this.mResources.getQuantityString(
                                    R.plurals
                                            .maintenance_mode_backup_cloud_menu_sub_textview_message_default,
                                    this.mCloudBackupRetentionPeriod,
                                    Integer.valueOf(this.mCloudBackupRetentionPeriod)));
                    break;
                }
        }
    }
                ...
                try {
                    MaintenanceModeIntroActivity.this.mSingleThreadExecutor.submit(
                            new Runnable() { // from class:
                                ...
                                @Override // java.lang.Runnable
                                public final void run() {
                                    MaintenanceModeIntroActivity.CloudBackupReceiver.this
                                            .lambda$onReceive$0(action);
                                }
                            });
                } catch (Exception e) {
                }
    ...
    private void showDialogToInformSecureLockIsNeeded() {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(this)
                        .setMessage(
                                R.string
                                        .maintenance_mode_intro_dialog_message_set_screen_lock_first)
                        .setPositiveButton(
                                R.string.maintenance_mode_intro_dialog_button_text_set_screen_lock,
                                new DialogInterface
                                        .OnClickListener() { // from class:
                                    ...
                                    public final void onClick(
                                        ...
                                        MaintenanceModeIntroActivity.this
                                                .lambda$showDialogToInformSecureLockIsNeeded$11(
                                                        dialogInterface, i);
                                    }
                                })
                        .setNegativeButton(
                                ...
                                new DialogInterface
                                    ...
                                    public final void onClick(
                                        ...
                                        MaintenanceModeIntroActivity
                                                .lambda$showDialogToInformSecureLockIsNeeded$12(
                                                        dialogInterface, i);
                                    }
                                });
    ...
    private void showDialogToNotifyLowOnStorage() {
        ...
        AlertDialog.Builder title =
                new AlertDialog.Builder(this)
                        .setTitle(R.string.maintenance_mode_intro_low_storage_dialog_title);
        if (this.mIsTablet) {
        ...
        AlertDialog.Builder builder =
                title.setMessage(i)
                        .setPositiveButton(
                                R.string.maintenance_mode_intro_low_storage_dialog_button_text,
                                new DialogInterface
                                        .OnClickListener() { // from class:
                                    ...
                                    public final void onClick(
                                        ...
                                        MaintenanceModeIntroActivity.this
                                                .lambda$showDialogToNotifyLowOnStorage$13(
                                                        dialogInterface, i2);
                                    }
                                });
        AlertDialog dialog = builder.create();
    ...
    private void showDialogToReconfirmCancelingBackup(String backupStatus) {
        ...
        if (backupStatus != null) {
            ...
            switch (c) {
                ...
                case 1:
                    messageResId =
                            R.string.maintenance_mode_stop_backup_dialog_message_backed_up_failed;
                    isCloudBackupInProgress = true;
                    break;
                case 2:
        ...
        AlertDialog.Builder builder =
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(
                                R.string.maintenance_mode_dialog_button_text_ok,
                                new DialogInterface
                                        .OnClickListener() { // from class:
                        ...
                        .setNegativeButton(
                                ...
                                new DialogInterface
                                    ...
                                    public final void onClick(
                                            DialogInterface dialogInterface, int i) {
                                        MaintenanceModeIntroActivity.this
                                                .lambda$showDialogToReconfirmCancelingBackup$18(
                                                        dialogInterface, i);
                                    }
                                })
                        .setOnCancelListener(
                                new DialogInterface
                                    ...
                                    public final void onCancel(DialogInterface dialogInterface) {
                                        MaintenanceModeIntroActivity.this
                                                .lambda$showDialogToReconfirmCancelingBackup$20(
                                                        dialogInterface);
                                    }
                                });
        AlertDialog dialog = builder.create();
    ...
    public /* synthetic */ void lambda$showDialogToReconfirmCancelingBackup$16(
        ...
        if (needToLaunchCloudApp) {
            this.mButtonExecutor.submit(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            MaintenanceModeIntroActivity.this
                                    .lambda$showDialogToReconfirmCancelingBackup$14();
                        }
                    });
        } else {
            showDialogToConfirmRestart();
        ...
        this.mLoggingExecutor.submit(
                new Runnable() { // from class:
                    ...
                    public final void run() {
                        MaintenanceModeIntroActivity.this
                                .lambda$showDialogToReconfirmCancelingBackup$15();
                    }
                });
    }
    ...
    public /* synthetic */ void lambda$showDialogToReconfirmCancelingBackup$18(
        ...
        this.mLoggingExecutor.submit(
                new Runnable() { // from class:
                    ...
                    public final void run() {
                        MaintenanceModeIntroActivity.this
                                .lambda$showDialogToReconfirmCancelingBackup$17();
                    }
                });
    }
    ...
    public /* synthetic */ void lambda$showDialogToReconfirmCancelingBackup$20(
        ...
        this.mLoggingExecutor.submit(
                new Runnable() { // from class:
                    ...
                    public final void run() {
                        MaintenanceModeIntroActivity.this
                                .lambda$showDialogToReconfirmCancelingBackup$19();
                    }
                });
    }
    ...
    private void showDialogToConfirmRestart() {
        ...
        this.mDialogView =
                LayoutInflater.from(this)
                        .inflate(R.layout.dialog_maintenance_mode_intro, (ViewGroup) null);
        adjustDialogLayout(getResources().getConfiguration());
        final CheckedTextView checkedTextView =
                (CheckedTextView)
                        this.mDialogView.findViewById(
                                R.id.maintenance_mode_intro_dialog_checked_textview);
        ...
        checkedTextView.setTextSize(
                0,
                MaintenanceModeUtils.getFontSize(
                        this.mContext, R.dimen.maintenance_mode_common_checkbox_text_size, 1.1f));
        AlertDialog.Builder builder =
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(
                                ...
                                new DialogInterface
                                    ...
                                    public final void onClick(
                                        ...
                                        MaintenanceModeIntroActivity.this
                                                .lambda$showDialogToConfirmRestart$27(
        ...
        TextView dialogTextView =
                (TextView)
                        this.mDialogView.findViewById(R.id.maintenance_mode_intro_dialog_textview);
    ...
    public /* synthetic */ void lambda$showDialogToConfirmRestart$26(final boolean skipDump) {
        ...
        if (skipDump) {
            ...
            new Thread(
                            new Runnable() { // from class:
                                ...
                                public final void run() {
                                    MaintenanceModeIntroActivity.this
                                            .lambda$showDialogToConfirmRestart$23();
                                }
                            })
                    .start();
        } else {
        ...
        this.mLoggingExecutor.submit(
                new Runnable() { // from class:
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        MaintenanceModeIntroActivity.this.lambda$showDialogToConfirmRestart$24(
                                skipDump);
                    }
                });
        this.mLoggingExecutor.submit(
        ...
        if (userInfo == null) {
            ...
            runOnUiThread(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            MaintenanceModeIntroActivity.this
                                    .lambda$showDialogToConfirmRestart$22();
                        }
                    });
        }
    }
        ...
        if ((!this.mIsFold || config.semDisplayDeviceType == 5) && this.mDialogView != null) {
            ...
            if (config.orientation == 2) {
                dialogScrollViewLayoutParams.topMargin =
                        this.mResources.getDimensionPixelSize(
                                R.dimen.maintenance_mode_dialog_margin_top_land);
                int checkBoxPadding =
                        this.mResources.getDimensionPixelSize(
                                R.dimen.maintenance_mode_dialog_checkbox_padding_top_bottom_land);
                checkBoxLayout.setPadding(0, checkBoxPadding, 0, checkBoxPadding);
                checkBoxLayoutParams.bottomMargin =
                        this.mResources.getDimensionPixelSize(
                                R.dimen.maintenance_mode_dialog_checkbox_margin_bottom_land);
            } else {
                dialogScrollViewLayoutParams.topMargin =
                        this.mResources.getDimensionPixelSize(
                                R.dimen.maintenance_mode_dialog_margin_top);
                int checkBoxPadding2 =
                        this.mResources.getDimensionPixelSize(
                                R.dimen.maintenance_mode_dialog_checkbox_padding_top_bottom);
                checkBoxLayout.setPadding(0, checkBoxPadding2, 0, checkBoxPadding2);
                checkBoxLayoutParams.bottomMargin =
                        this.mResources.getDimensionPixelSize(
                                R.dimen.maintenance_mode_dialog_checkbox_margin_bottom);
            }
    ...
    private UserInfo enterMaintenanceMode() {
        if (!MaintenanceModeUtils.isSecureLockSet(this.mContext)
                || MaintenanceModeUtils.checkRequiredConditions(this.mContext, true) != 0) {
            return null;
        }
        try {
            ...
            return um.createUser(
                    ...
                    MaintenanceModeUtils.USER_TYPE_FULL_MAINTENANCE_MODE,
                    1024);
        } catch (Exception e) {
