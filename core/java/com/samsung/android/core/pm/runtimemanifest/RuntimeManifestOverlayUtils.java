...
public class RuntimeManifestOverlayUtils {
    ...
    public static <Component extends ParsedMainComponentImpl> void modifyMainComponent(
    ...
    static <Component extends ParsedComponentImpl> void modifyComponent(
            Component component, RuntimeManifestPolicies.PolicyInfo policy) {
        if (policy.hasIcon()) {
    ...
    public static void modifyPackage(
            ParsingPackage pkg, RuntimeManifestPolicies.PolicyInfo policy) {
        ...
        try {
            ...
            if (parser != null) {
                ...
                applyComponentRuntimeManifest(
                        packageName, pkg.getActivities(), overlay.getActivityPolicies());
                applyComponentRuntimeManifest(
                        packageName, pkg.getServices(), overlay.getServicePolicies());
                applyComponentRuntimeManifest(
                        packageName, pkg.getProviders(), overlay.getProviderPolicies());
                applyComponentRuntimeManifest(
                        packageName, pkg.getReceivers(), overlay.getReceiverPolicies());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static <Component extends ParsedMainComponent> void applyComponentRuntimeManifest(
            String packageName,
        ...
        for (Map.Entry<String, List<RuntimeManifestPolicies.PolicyInfo>> entry :
            ...
            if (targetName != null && policies != null) {
                ...
                ParsedMainComponent matchingComponent =
                        getMatchingComponent(targetName2, components);
    ...
    public static <Component extends ParsedMainComponent> Component getMatchingComponent(
    ...
    public static void applyPackageRuntimeManifest(
            ParsingPackage pkg, List<RuntimeManifestPolicies.PolicyInfo> policies) {
        RuntimeManifestPolicies.PolicyInfo matched;
        if (pkg != null
                && policies != null
