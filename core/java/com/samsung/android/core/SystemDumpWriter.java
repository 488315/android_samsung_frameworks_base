    ...
    try {
      try {
        try {
          ...
          String startContent =
              tag + " #" + sTagCountMap.get(tag) + " " + this.mFormat.format(new Date());
          fos.write(startContent);
          fos.close();
        } catch (IOException e) {
          Slog.m116e(this.mTag, "close exception, ", e);
          if (fos != null) {
            fos.close();
          }
        }
        ...
        if (fos != null) {
          try {
            ...
            Slog.m116e(this.mTag, "close exception, ", e2);
          }
        }
        throw th;
      }
    } catch (IOException e3) {
      Slog.m116e(this.mTag, "close exception, ", e3);
    }
  }
  ...
  public void close() throws Exception {
    ...
    try {
      ...
      try {
        ...
        Slog.m113d(this.mTag, "Successful to save dumpsys to " + this.mFileTitle);
        out.close();
      } finally {
      }
    } catch (IOException e) {
      Slog.m115e(this.mTag, "close exception, " + e);
    }
    Slog.m113d(
        this.mTag, "save dumpsys, duration=" + (SystemClock.uptimeMillis() - creationStartTime));
  }
