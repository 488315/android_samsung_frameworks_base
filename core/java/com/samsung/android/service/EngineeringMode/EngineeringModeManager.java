...
public final class EngineeringModeManager {
    ...
    private class EngineeringModeNative {
        ...
        public int _getStatus(int mode, String packageName) {
            Log.m98i(EngineeringModeManager.TAG, packageName + NavigationBarInflaterView.KEY_CODE_START + EngineeringModeManager.this.mCallerUid + ", " + EngineeringModeManager.this.mSignature + ") call em(" + mode + NavigationBarInflaterView.KEY_CODE_END);
    ...
    public EngineeringModeManager(Context context) {
        ...
        if (this.mNative.isSupport()) {
            Log.m98i(TAG, this.mPkgName + NavigationBarInflaterView.KEY_CODE_START + this.mCallerUid + ", " + this.mSignature + ") connects to EngineeringModeNative");
        } else {
            Log.m96e(TAG, this.mPkgName + NavigationBarInflaterView.KEY_CODE_START + this.mCallerUid + ", " + this.mSignature + ") can't be connect..");
        }
    }
    ...
    static class EmPacketManager {
        ...
        public EngineeringModeToken parseToken(byte[] buf) {
            ...
            Log.m94d(EngineeringModeManager.TAG, "Prefix : " + prefix + ", Type : " + type + ", Version : " + version);
