...
public final class ReactiveServiceManager {
    ...
    public int removeString() {
        try {
            ...
            if (ret < 0) {
                Log.m96e(TAG, "removeString() : error code[" + ret + NavigationBarInflaterView.SIZE_MOD_END);
            } else {
    ...
    public int sessionComplete(byte[] input) {
        ...
        try {
            ...
            if (ret != 0) {
                Log.m96e(TAG, "sessionComplete() : error code[" + ret + NavigationBarInflaterView.SIZE_MOD_END);
            }
            return ret;
        } catch (NullPointerException e) {
            return -9;
    ...
    public int disableWithAccountId(String id) {
        ...
        try {
            ...
            if (ret != 0) {
                Log.m96e(TAG, "disableWithAccountId() : error code[" + ret + NavigationBarInflaterView.SIZE_MOD_END);
            }
            return ret;
        } catch (NullPointerException e) {
            return -9;
    ...
    public int verifyWithAccountId(String id) {
        ...
        try {
            ...
            if (ret < 0) {
                Log.m96e(TAG, "verifyWithAccountId() : error code[" + ret + NavigationBarInflaterView.SIZE_MOD_END);
            } else {
