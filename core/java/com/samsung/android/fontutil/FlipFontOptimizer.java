...
public class FlipFontOptimizer {
    ...
    private static final String FONT_PACKAGE_ARIAL_NARROW =
            "com.monotype.android.font.ArialNarrowProRegular";
    ...
    public void applyFlipFonts(Context context, String flipfontsPackageName) {
        ...
        intent.setClassName(
                "com.android.settings", "com.samsung.android.settings.flipfont.FlipFontReceiver");
