...
public class TypefaceFinder {
    ...
    */
    public void getSansEntries(Context context, PackageManager packageManager, ArrayList entries, ArrayList entryValues, ArrayList fontPackageName) {
        ...
        while (isExistSamsungOneSystemFont) {
            ...
            if (s == null) {
                ...
                try {
                    ...
                    Log.m94d(TAG, "getSansEntries - Typeface.createFromAsset caused an exception for - fonts/" + loadTypeface2 + FONT_EXTENSION);
                    e.printStackTrace();
                }
                if (packageName != null) {
