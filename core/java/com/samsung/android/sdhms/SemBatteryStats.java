...
public class SemBatteryStats implements Cloneable, Parcelable {
  ...
  public SemBatteryStats m9119clone() {
    SemBatteryStats result = null;
    try {
      result = (SemBatteryStats) super.clone();
      if (result.getAppDetailUsages() != null) {
        result.appDetailList =
            (List)
                result.getAppDetailUsages().stream()
                    .map(
                        new Function() { // from class:
                                         // com.samsung.android.sdhms.SemBatteryStats$$ExternalSyntheticLambda0
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            return ((SemBatteryStats.AppDetailUsage) obj).m9120clone();
                          }
                        })
                    .collect(Collectors.toList());
      }
      if (result.getSysDetailUsages() != null) {
        result.sysDetailList =
            (List)
                result.getSysDetailUsages().stream()
                    .map(
                        new Function() { // from class:
                                         // com.samsung.android.sdhms.SemBatteryStats$$ExternalSyntheticLambda1
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            return ((SemBatteryStats.SysDetailUsage) obj).m9148clone();
                          }
                        })
                    .collect(Collectors.toList());
      }
  ...
  public static class AppDetailUsage implements Cloneable, Parcelable {
    ...
    public void calculateDelta(AppDetailUsage prev) {
      ...
      this.power =
          Math.max(SContextConstants.ENVIRONMENT_VALUE_UNKNOWN, this.power - prev.getPowerUsage());
      this.screenPower =
          Math.max(
              SContextConstants.ENVIRONMENT_VALUE_UNKNOWN,
    ...
    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public AppDetailUsage m9120clone() {
      try {
  ...
  public static class SysDetailUsage implements Cloneable, Parcelable {
    ...
    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public SysDetailUsage m9148clone() {
      try {
