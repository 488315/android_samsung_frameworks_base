    ...
    public static class OnCocktailClickHandler {
        public boolean onClickHandler(View view, PendingIntent pendingIntent) {
            try {
                ...
                Log.m97e(AbsCocktailLoadablePanel.TAG, "Cannot send pending intent: ", e);
                return false;
            } catch (Exception e2) {
                Log.m97e(AbsCocktailLoadablePanel.TAG, "Cannot send pending intent due to unknown exception: ", e2);
                return false;
            }
        }
    }
