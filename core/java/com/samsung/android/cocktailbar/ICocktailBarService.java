...
public interface ICocktailBarService extends IInterface {
  ...
  public static class Default implements ICocktailBarService {
    ...
    public void partiallyUpdateCocktail(
        String callingPackage, RemoteViews contentView, int cocktailId) throws RemoteException {}

    @Override // com.samsung.android.cocktailbar.ICocktailBarService
    public void partiallyUpdateHelpView(String callingPackage, RemoteViews helpView, int cocktailId)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements ICocktailBarService {
        ...
        default:
          switch (code) {
            ...
            case 21:
              ...
              data.enforceNoDataAvail();
              boolean _result9 =
                  bindRemoteViewsService(_arg019, _arg116, _arg29, _arg32, _arg4, _arg5, _arg6);
              reply.writeNoException();
    ...
    private static class Proxy implements ICocktailBarService {
      ...
      public void partiallyUpdateHelpView(
          String callingPackage, RemoteViews helpView, int cocktailId) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(ICocktailBarService.DESCRIPTOR);
      ...
      public CocktailBarStateInfo getCocktailBarStateInfo() throws RemoteException {
        ...
        try {
          ...
          CocktailBarStateInfo _result =
              (CocktailBarStateInfo) _reply.readTypedObject(CocktailBarStateInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
