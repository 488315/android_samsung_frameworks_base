...
public class MediaInfoChecker {
  ...
  public static boolean isSupportedResolution(
      MediaFormat inputformat, int inputwidth, int inputheight, int outputwidth, int outputheight) {
    int codecSize;
    LogS.m473d(
        "TranscodeLib",
  ...
  public static boolean isSupportedCodecType(MediaFormat inputFormat) {
    ...
    LogS.m474e(
        "TranscodeLib", "isSupportedCodecType support codec  : " + codec + ", mime : " + mime);
    return true;
  }
