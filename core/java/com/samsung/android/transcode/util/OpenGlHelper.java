...
public class OpenGlHelper {
    ...
    private static int compileShader(int shaderType, String shaderSource) {
        ...
        if (compileStatus[0] == 0) {
            LogS.m474e("TranscodeLib", "Could not compile shader " + shaderType + " " + GLES20.glGetShaderInfoLog(shaderId));
    ...
    private static int linkProgram(int vertexShaderId, int fragmentShaderId) {
        ...
        if (linkStatus[0] == 0) {
            LogS.m474e("TranscodeLib", "Couldn't link program :" + GLES20.glGetProgramInfoLog(programId));
    ...
    public static int loadTextureOES() {
        ...
        if (textureObjectIds[0] == 0) {
            LogS.m474e("TranscodeLib", "Could not create new opengl oes texture object");
            return 0;
        }
    ...
    public static int checkGLError(String operation) {
        while (true) {
            ...
            LogS.m474e("TranscodeLib", operation + ": glError " + error);
        }
    }
}
