...
public class CodecsHelper {
  ...
  public static MediaExtractor createExtractor(FileDescriptor descriptor, long offset, long length)
      throws IOException {
    MediaExtractor extractor = newMediaExtractor();
    extractor.semSetRunningMode(1);
    ...
    if (codec == null) {
      ...
      for (int i = 0; i < numCodecs; i++) {
        ...
        if ((!isEncoder || codecInfo.isEncoder())
            && ((isEncoder || !codecInfo.isEncoder()) && isSupportCodec(mimeType, codecInfo))) {
          return codecInfo;
        }
      }
    }
  ...
  public static int suggestBitrate(ExportMediaInfo outputInfo, MediaInfo.MediaFileInfo sourceInfo) {
    ...
    LogS.m473d(
        "TranscodeLib",
        "[1] get from table. bitrate: " + bitrate + ", isHighBitrateMode: " + isHighBitrateMode);
    ...
    if (sourceInfo.Bitrate != 0) {
      ...
      LogS.m473d(
          "TranscodeLib",
          "[4] sourceBitrate : " + sourceInfo.Bitrate + ", originalBitrate: " + originalBitrate);
                ...
                .map(
                    new Function() { // from class:
                      ...
                      public final Object apply(Object obj) {
                        ...
                        valueOf =
                            Boolean.valueOf(
                                ((MediaCodecInfo) obj).getName().toLowerCase().contains("omx"));
                        return valueOf;
                      }
                    })
                .orElse(false))
