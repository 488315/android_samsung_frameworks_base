    ...
    public void silenceRinger(int keyCode) {
        ...
        if (service != null) {
            try {
                ...
                Log.m97e(TAG, "Error calling ISamsungTelecomService#silenceRinger - keyCode : " + keyCode, e);
            }
        }
    }
        ...
        if (service != null) {
            if (reason != null) {
                ...
                try {
                    ...
                    Log.m97e(TAG, "Error calling ISamsungTelecomService#silenceRinger - reason : " + reason, e);
                    return;
                }
            }
    ...
    public void acceptRingingCall(int keyCode) {
        ...
        if (service != null) {
            try {
                ...
                Log.m97e(TAG, "Error calling ISamsungTelecomService#acceptRingingCall - keyCode : " + keyCode, e);
            }
        }
    }
        ...
        if (service != null) {
            if (reason != null) {
                ...
                try {
                    ...
                    Log.m97e(TAG, "Error calling ISamsungTelecomService#acceptRingingCall - reason : " + reason, e);
                    return;
                }
            }
    ...
    public void acceptRingingCallWithVideoState(int videoState, int keyCode) {
        ...
        if (service != null) {
            try {
                ...
                Log.m97e(TAG, "Error calling ISamsungTelecomService#acceptRingingCallWithVideoState - keyCode : " + keyCode, e);
            }
        }
    }
        ...
        if (service != null) {
            if (reason != null) {
                ...
                try {
                    ...
                    Log.m97e(TAG, "Error calling ISamsungTelecomService#acceptRingingCallWithVideoState - reason : " + reason, e);
                    return;
                }
            }
