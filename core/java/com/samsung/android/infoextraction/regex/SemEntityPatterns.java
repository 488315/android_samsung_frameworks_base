...
public class SemEntityPatterns {
  public static final String DEFAULT_DATE_STRING_TYPE1 =
  ...
  public static final String DEFAULT_DATE_STRING_TYPE2 =
  ...
  private static final String HOST_NAME =
      "([a-zA-Z0-9 -⿿\u3040-䷿龦-\ud7ff豈-﷏ﷰ-\ufeff]([a-zA-Z0-9"
          + " -⿿\u3040-䷿龦-\ud7ff豈-﷏ﷰ-\ufeff\\-]{0,61}[a-zA-Z0-9"
          + " -⿿\u3040-䷿龦-\ud7ff豈-﷏ﷰ-\ufeff]){0,1}\\.)+[a-zA-Z"
          + " -⿿\u3040-䷿龦-\ud7ff豈-﷏ﷰ-\ufeff]{2,63}";
  ...
  public static final Pattern PHONE_NUMBER =
      Pattern.compile(
          "([[:space:]](\\+[0-9]+[\\- \\.\u00ad]*)?(\\([0-9]+\\)[\\- \\.\u00ad]*)?([0-9][0-9\\-"
              + " \\.\u00ad][0-9\\- \\.\u00ad]+[0-9])[[:space:]])");
  public static final Pattern PHONE_NUMBER_WEAK =
      Pattern.compile(
          "((\\+[0-9]+[[[:space:]]?\\-\\.\u00ad]*)?(\\([0-9]+\\)[[[:space:]]?\\-\\.\u00ad]*)?([0-9][0-9[[:space:]]?\\-\\.\u00ad][0-9[[:space:]]?\\-\\.\u00ad]+[0-9]))");
  public static final Pattern REFACTORING_PHONE_NUMBER =
      Pattern.compile(
          "((\\+[0-9]+[[[:space:]]?\\-\\.\u00ad]*)?(\\([0-9]+\\)[[[:space:]]?\\-\\.\u00ad]*)?([0-9][0-9[[:space:]]?\\-\\.\u00ad][0-9[[:space:]]?\\-\\.\u00ad]+[0-9]))");
  ...
  public static final Pattern EMAIL_ADDRESS_WEAK =
      Pattern.compile(
          "([a-zA-Z0-9\\+\\.\\_\\%\\-\\+\u00ad]{1,256}[[:space:]]?\\@[[:space:]]?[a-zA-Z0-9][a-zA-Z0-9\\-\u00ad]{0,64}([[:space:]]?\\.[[:space:]]?[a-zA-Z0-9][a-zA-Z0-9\\-\u00ad]{0,25})+)");
  ...
  static {
    ...
    URL =
        Pattern.compile(
            "((?:(http|https|Http|Https|rtsp|Rtsp|ftp):\\/\\/(?:(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)\\,\\;\\?\\&\\=]|(?:\\%[a-fA-F0-9]{2})){1,64}(?:\\:(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)\\,\\;\\?\\&\\=]|(?:\\%[a-fA-F0-9]{2})){1,25})?\\@)?)?(?:"
                + compile2
                + ")(?:\\:\\d{1,5})?)(\\/(?:(?:[a-zA-Z0-9"
                + " -\ud7ff豈-﷏ﷰ-\uffef\\;\\/\\?\\:\\@\\&\\=\\#\\~\\-\\.\\+\\!\\*\\'\\(\\)\\,\\_])|(?:\\%[a-fA-F0-9]{2}))*)?",
            2);
