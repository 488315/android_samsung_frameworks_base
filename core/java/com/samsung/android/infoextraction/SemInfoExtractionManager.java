...
public class SemInfoExtractionManager {
  ...
  public void setOnExtractionCompletedListener(
      OnExtractionCompletedListener onExtractionCompletedListener) throws IllegalArgumentException {
  ...
  class IncomingHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      ArrayList<SemExtractedInfo> semExtractedInfoList =
          msg.getData().getParcelableArrayList(SemInfoExtractionManager.EXTRACTED_INFO_DATA);
