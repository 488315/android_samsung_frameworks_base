...
public interface IDeviceInfoManager extends IInterface {
  ...
  void unregisterPendingIntentForUriAsUser(Uri uri, PendingIntent pendingIntent, String str, int i)
      throws RemoteException;
  ...
  public static class Default implements IDeviceInfoManager {
    ...
    public void registerPendingIntentForUriAsUser(
        Uri uri, PendingIntent intent, String callingPackage, int userId) throws RemoteException {}
    ...
    public void registerPendingIntentForCustomEventAsUser(
        String event, PendingIntent intent, Bundle bundle, String callingPackage, int userId)
        throws RemoteException {}
