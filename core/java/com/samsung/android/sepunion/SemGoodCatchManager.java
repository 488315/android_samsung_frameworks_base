...
public class SemGoodCatchManager {
    ...
    this.mHandler =
        new Handler(
          ...
          public void handleMessage(Message msg) {
            switch (msg.what) {
              case 0:
                android.util.Log.m94d(SemGoodCatchManager.TAG, "MSG_START");
                ...
                break;
              case 1:
                android.util.Log.m94d(SemGoodCatchManager.TAG, "MSG_STOP");
                if (msg.obj instanceof String) {
  ...
  public SemGoodCatchManager(
    ...
    this.MSG_START = 0;
    this.MSG_STOP = 1;
    IGoodCatchDispatcher.Stub stub =
        new IGoodCatchDispatcher
            .Stub() { // from class: com.samsung.android.sepunion.SemGoodCatchManager.1
          @Override // com.samsung.android.sepunion.IGoodCatchDispatcher
          public void onStart(String function2) {
            SemGoodCatchManager.this.mHandler.sendMessage(
                SemGoodCatchManager.this.mHandler.obtainMessage(0, 0, 0, function2));
          }

          @Override // com.samsung.android.sepunion.IGoodCatchDispatcher
          public void onStop(String function2) {
            SemGoodCatchManager.this.mHandler.sendMessage(
                SemGoodCatchManager.this.mHandler.obtainMessage(1, 0, 0, function2));
          }
        };
    ...
    if (asInterface == null) {
      android.util.Log.m102w(TAG, "Failed to SemGoodCatchManager; no service.");
      return;
    }
    try {
    ...
    android.util.Log.m94d(TAG, "SemGoodCatchManager is created, " + this.mModule);
  }
  ...
  public void update(String function, String caller, int state, String msg, String extra) {
    ...
    if (iGoodCatchManager == null) {
      android.util.Log.m102w(TAG, "Failed to update; no service.");
      return;
    }
    try {
      iGoodCatchManager.update(
          new String[] {this.mModule, function, caller, time, Integer.toString(state), msg, extra});
    } catch (RemoteException e) {
      e.printStackTrace();
    }
  }
  ...
  public void update(String function, String caller, String state, String msg, String extra) {
    ...
    try {
      iGoodCatchManager.update(
          new String[] {this.mModule, function, caller, time, state, msg, extra});
    } catch (RemoteException e) {
      e.printStackTrace();
    }
  }
  ...
  public List<String> getSelectedSettingKey() {
    ...
    try {
      ...
      android.util.Log.m94d(TAG, "getSelectedSettingKey() : db_keys=" + db_keys);
      return db_keys;
    } catch (RemoteException e) {
      e.printStackTrace();
      return db_keys;
