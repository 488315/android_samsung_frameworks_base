...
public interface SemImsService extends IInterface {
  ...
  String registerAutoConfigurationListener(SemAutoConfigListener semAutoConfigListener, int i)
  ...
  String registerImsOngoingFtEventListener(SemImsFtListener semImsFtListener)
      throws RemoteException;

  String registerImsRegistrationListenerForSlot(SemImsRegiListener semImsRegiListener, int i)
      throws RemoteException;

  void registerSemCmcRecordingListener(ISemCmcRecordingListener iSemCmcRecordingListener, int i)
      throws RemoteException;
  ...
  void sendSemCmcRecordingEvent(SemCmcRecordingInfo semCmcRecordingInfo, int i, int i2)
      throws RemoteException;
  ...
  public static class Default implements SemImsService {
    ...
    public String registerImsRegistrationListenerForSlot(SemImsRegiListener listener, int phoneId)
        throws RemoteException {
      return null;
    }
    ...
    @Override // com.samsung.android.ims.SemImsService
    public String registerSimMobilityStatusListener(SemSimMobStatusListener listener, int phoneId)
        throws RemoteException {
      return null;
    }
    ...
    @Override // com.samsung.android.ims.SemImsService
    public String registerImsOngoingFtEventListener(SemImsFtListener listener)
        throws RemoteException {
      return null;
    }
    ...
    @Override // com.samsung.android.ims.SemImsService
    public boolean isCmcPotentialEmergencyNumber(String number, int phoneId)
        throws RemoteException {
      return false;
    }
        ...
        default:
          switch (code) {
            ...
            case 6:
              ...
              return true;
            case 7:
              SemAutoConfigListener _arg07 =
                  SemAutoConfigListener.Stub.asInterface(data.readStrongBinder());
            ...
            case 27:
              ...
              return true;
            case 28:
              SemCmcRecordingInfo _arg028 =
                  (SemCmcRecordingInfo) data.readTypedObject(SemCmcRecordingInfo.CREATOR);
              ...
              return true;
            case 29:
              ISemCmcRecordingListener _arg029 =
                  ISemCmcRecordingListener.Stub.asInterface(data.readStrongBinder());
    ...
    private static class Proxy implements SemImsService {
      ...
      public SemImsRegistration[] getRegistrationInfoByPhoneId(int phoneId) throws RemoteException {
        ...
        try {
          ...
          _reply.readException();
          SemImsRegistration[] _result =
              (SemImsRegistration[]) _reply.createTypedArray(SemImsRegistration.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
