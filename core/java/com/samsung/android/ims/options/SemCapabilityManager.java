...
public class SemCapabilityManager {
    ...
    public void connect() {
        ...
        this.mConnection = new ServiceConnection() { // from class: com.samsung.android.ims.options.SemCapabilityManager.2
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                Log.m98i(SemCapabilityManager.this.LOG_TAG, "Connected to SemCapabilityDiscoveryService.");
                ...
                if (!SemCapabilityManager.this.mQueuedCapabilityListener.isEmpty()) {
                    try {
                        ...
                        e.printStackTrace();
                        Log.m96e(SemCapabilityManager.this.LOG_TAG, "registerListener failed. RemoteException: " + e);
                    }
                }
            }
            ...
            public void onServiceDisconnected(ComponentName name) {
                Log.m98i(SemCapabilityManager.this.LOG_TAG, "Disconnected to SemCapabilityDiscoveryService.");
                if (SemCapabilityManager.this.mListener != null) {
    ...
    public void registerListener(SemCapabilityListener listener) throws RemoteException {
        Log.m98i(this.LOG_TAG, "registerListener: listener = " + listener + ", Caller = " + Binder.getCallingPid());
