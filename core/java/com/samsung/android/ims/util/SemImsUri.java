...
public class SemImsUri implements Parcelable {
  ...
  public static final Parcelable.Creator<SemImsUri> CREATOR =
      new Parcelable.Creator<SemImsUri>() { // from class: com.samsung.android.ims.util.SemImsUri.1
  ...
  public static SemImsUri parse(String str) {
    ...
    if (i < 0) {
      Log.m96e(LOG_TAG, "parse: illegal Uri - " + (DBG ? str2 : "xxxxx"));
      return null;
    }
    String scheme = str2.substring(0, i);
    try {
    } catch (Exception e) {
      Log.m96e(LOG_TAG, "parse: failured. uri=" + (DBG ? str2 : "xxxxx") + " e=" + e);
      e.printStackTrace();
    }
