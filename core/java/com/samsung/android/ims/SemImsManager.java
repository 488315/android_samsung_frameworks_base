...
public class SemImsManager {
    ...
    SemImsDmConfigListener.Stub mEventProxy = new SemImsDmConfigListener.Stub() { // from class: com.samsung.android.ims.SemImsManager.2
        ...
        public void onChangeDmValue(String uri, boolean state) throws RemoteException {
            if (SemImsManager.this.mEventRelay == null) {
                Log.m94d("semImsManager[" + SemImsManager.this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "no listener for SemImsDmConfigListener");
                throw new RemoteException();
            }
            Log.m94d("semImsManager[" + SemImsManager.this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "mEventRelay : " + SemImsManager.this.mEventRelay);
    ...
    private IBinder getSystemService(String name) {
        try {
            ...
            if (getService == null) {
                Log.m94d(LOG_TAG, "Failed to reflect method getService");
            } else {
                Object result = getService.invoke(sm, name);
                if (result == null) {
                    Log.m94d(LOG_TAG, "Failed to getService " + name);
                } else {
    ...
    public void registerPreviousListeners(SemImsService imsService) {
        Log.m94d(LOG_TAG, "registerPreviousListeners:  mRegListeners: " + this.mRegListeners.size() + " mEpdgListeners: " + this.mEpdgListeners.size());
    ...
    public void connectService() {
        ...
        if (this.mRestartReceiver == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Register Receiver for Restart");
            this.mRestartReceiver = new BroadcastReceiver() { // from class: com.samsung.android.ims.SemImsManager.1
                @Override // android.content.BroadcastReceiver
                public void onReceive(Context context, Intent intent) {
                    Log.m94d("semImsManager[" + SemImsManager.this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "onReceive " + intent.getAction());
                    if (TextUtils.equals(intent.getAction(), SemImsManager.INTENT_ACTION_IMSSERVICE_RESTART)) {
                        ...
                        if (imsService == null) {
                            Log.m96e("semImsManager[" + SemImsManager.this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "ImsService not found, this should not happen!");
                            return;
                        }
    ...
    public void disconnectService() {
        ...
        if (broadcastReceiver != null) {
            try {
                ...
                Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "unregisterReceiver " + e.getMessage());
            }
    ...
    public SemImsRegistration[] getRegistrationInfo() {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getRegistrationInfo");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getRegistrationInfo: Not initialized.");
            return null;
        }
        try {
    ...
    public boolean isRcsEnabled(boolean needAutoConfigCheck) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isRcsEnabled: ");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isRcsEnabled: not connected.");
            return false;
        }
        try {
    ...
    public void enableIpme(boolean enable) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "enableIpme: " + enable);
        enableRcs(enable);
    }

    public boolean isIpmeEnabled() {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isIpmeEnabled");
        return isRcsEnabled();
    }

    public void sendTryRegister() {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "sendTryRegister");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "sendTryRegister: Not initialized.");
            return;
        }
        try {
    ...
    public void enableRcs(boolean enable) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "enableRcs: " + enable);
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "enableRcs: Not initialized.");
            return;
        }
        try {
    ...
    public void registerImsRegistrationListener(SemImsRegistrationListener listener) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "registerImsRegistrationListener");
        if (listener == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "registerImsRegistrationListener : listener is null");
            return;
        }
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Not initialized.");
            return;
        }
    ...
    public void unregisterImsRegistrationListener(SemImsRegistrationListener listener) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "unregisterImsRegistrationListener");
        if (listener == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "unregisterImsRegistrationListener : listener is null");
            return;
        }
        ImsRegistrationListenerDelegate delegate = this.mRegListeners.remove(listener);
        if (delegate == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "unregisterImsRegistrationListener : cannot find the listener");
            return;
        }
        SemImsService imsService = getImsService();
        if (imsService == null) {
    ...
    public boolean registerEpdgListener(SemEpdgListener listener) {
        Log.m94d(LOG_TAG, "registerEpdgListener");
        if (listener == null) {
            Log.m96e(LOG_TAG, "registerEpdgListener listener null");
            return false;
        }
        ...
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e(LOG_TAG, "Not initialized.");
            return false;
        }
    ...
    public void registerImsOngoingFtEventListener(SemImsOngoingFtEventListener listener) {
        if (listener == null) {
            Log.m96e(LOG_TAG, "registerImsOngoingFtEventListener : wrong instance");
            return;
        }
    ...
    public void unregisterImsOngoingFtEventListener(SemImsOngoingFtEventListener listener) {
        if (listener == null) {
            Log.m94d(LOG_TAG, "unregisterImsOngoingFtEventListener : listener is null");
            return;
        }
        ImsOngoingFtEventListenerDelegate delegate = this.mOngoingFtEventListeners.remove(listener);
        if (delegate == null) {
            Log.m94d(LOG_TAG, "unregisterImsOngoingFtEventListener : cannot find the listener");
            return;
        }
        SemImsService imsService = getImsService();
        if (imsService == null) {
    ...
    public void registerSimMobilityStatusListener(SemSimMobilityStatusListener listener) {
        if (listener == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "registerSimMobilityStatusListener : wrong instance");
            return;
        }
    ...
    public void unregisterSimMobilityStatusListener(SemSimMobilityStatusListener listener) {
        if (listener == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "unregisterSimMobilityStatusListener : listener is null");
            return;
        }
        SimMobilityStatusListenerDelegate delegate = this.mSimMobilityStatusListeners.remove(listener);
        if (delegate == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "unregisterSimMobilityStatusListener : cannot find the listener");
            return;
        }
        SemImsService imsService = getImsService();
        if (imsService == null) {
    ...
    public boolean unRegisterEpdgListener(SemEpdgListener listener) {
        Log.m94d(LOG_TAG, "unRegisterEpdgListener");
        if (listener == null) {
            return false;
        }
        SemEpdgListenerDelegate delegate = this.mEpdgListeners.remove(listener);
        if (delegate == null) {
            Log.m94d(LOG_TAG, "unRegisterEpdgListener : cannot find the listener");
            return false;
        }
        SemImsService imsService = getImsService();
        if (imsService == null) {
    ...
    public SemImsRegistration getRegistrationInfoByServiceType(String serviceType) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getRegistrationInfoByServiceType");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getRegistrationInfoByServiceType: Not initialized.");
            return null;
        }
        try {
    ...
    public SemImsRegistration getImsRegistration() {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getImsRegistration");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getImsRegistration: Not initialized.");
            return null;
        }
        try {
    ...
    public ContentValues getConfigValues(String[] fields) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getConfigValues");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Not initialized.");
            return null;
    ...
    public boolean isSimMobilityActivated() {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isSimMobilityActivated:");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isSimMobilityActivated: not connected.");
            return false;
        }
        try {
    ...
    public boolean isForbidden() {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isForbidden");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Not initialized.");
            return false;
    ...
    public boolean isServiceAvailable(String service) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isServiceAvailable: " + service);
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isServiceAvailable: not connected.");
            return false;
        }
        try {
    ...
    public boolean isServiceAvailable(String service, int rat) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isServiceAvailable: " + service + ", " + rat);
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isServiceAvailable: not connected.");
            return false;
    ...
    public boolean isImsFeatureEnabled(String feature, int network) throws IllegalArgumentException {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isImsFeatureEnabled: " + feature + ", " + network);
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isImsFeatureEnabled: not connected.");
            return false;
        }
    ...
    public String getRcsProfileType() {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getRcsProfileType");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Not initialized.");
            return "";
        ...
        try {
            ...
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "fail to get profile");
            return "";
        }
    }
    ...
    public void unregisterAutoConfigurationListener(SemAutoConfigurationListener listener) {
        if (listener == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "listener is null.");
            return;
        }
        AutoConfigurationListenerDelegate delegate = this.mAutoConfigListeners.remove(listener);
        if (delegate == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "unregisterAutoConfigurationListener : cannot find the listener");
            return;
        }
        SemImsService imsService = getImsService();
        if (imsService == null) {
    ...
    public boolean isVoLteAvailable() {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isVoLteAvailable");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isVoLteAvailable : not connected.");
            return false;
        }
        try {
    ...
    public boolean isImsFeatureProvisioned(String feature) throws IllegalArgumentException {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isImsFeatureProvisioned: " + feature);
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "isImsFeatureProvisioned: not connected.");
            return false;
        }
        if (!SemImsProfile.ImsFeature.isValidImsFeature(feature)) {
            throw new IllegalArgumentException("invalid feature : " + feature);
    ...
    public void sendVerificationCode(String value) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "sendVerificationCode");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Not initialized.");
            return;
    ...
    public void sendMsisdnNumber(String value) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "sendMsisdnNumber");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Not initialized.");
            return;
    ...
    public void sendIidToken(String value) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "sendIidToken");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Not initialized.");
            return;
    ...
    public SemImsProfile[] getCurrentProfile(int phoneId) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "getCurrentProfile");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "Not initialized.");
            return null;
        ...
        try {
            ...
            Log.m96e("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "fail to get profiles");
            return null;
        }
    }

    public void setRttMode(int mode) {
        Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "setRttMode: " + mode);
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d("semImsManager[" + this.mPhoneId + NavigationBarInflaterView.SIZE_MOD_END, "setRttMode: not connected.");
            return;
        }
        try {
    ...
    public boolean isCmcEmergencyCallSupported() {
        Log.m94d(LOG_TAG, "isCmcEmergencyCallSupported");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d(LOG_TAG, "isCmcEmergencyCallSupported: not connected.");
            return false;
        }
        try {
    ...
    public boolean isCmcEmergencyNumber(String number) {
        Log.m94d(LOG_TAG, "isCmcEmergencyNumber");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d(LOG_TAG, "isCmcEmergencyNumber: not connected.");
            return false;
        }
        try {
    ...
    public boolean isCmcPotentialEmergencyNumber(String number) {
        Log.m94d(LOG_TAG, "isCmcPotentialEmergencyNumber");
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d(LOG_TAG, "isCmcPotentialEmergencyNumber: not connected.");
            return false;
        }
        try {
    ...
    public SemCmcMediaRecorder newSemCmcMediaRecorder() throws IllegalStateException {
        SemImsService imsService = getImsService();
        if (imsService == null) {
            Log.m94d(LOG_TAG, "newSemCmcMediaRecorder: not connected.");
            return null;
        }
    ...
    private static class SemEpdgListenerDelegate extends ISemEpdgListener.Stub {
        ...
        public void onEpdgAvailable(int phoneId, boolean isAvailable, int wifiState) {
            Log.m94d(SemImsManager.LOG_TAG, "onEpdgAvailable phoneId " + phoneId);
        ...
        public void onHandoverResult(int phoneId, int isL2WHandover, int result, String apnType) {
            Log.m94d(SemImsManager.LOG_TAG, "onHandoverResult.phoneId " + phoneId);
            SemEpdgListener epdgListener = getListener();
            if (epdgListener != null) {
        ...
        public void onIpsecConnection(int phoneId, String apnType, int ikeError, int throttleCount) {
            Log.m94d(SemImsManager.LOG_TAG, "onIpsecConnection phoneId " + phoneId);
            SemEpdgListener epdgListener = getListener();
            if (epdgListener != null) {
        ...
        public void onIpsecDisconnection(int phoneId, String apnType) {
            Log.m94d(SemImsManager.LOG_TAG, "onIpsecDisconnection phoneId " + phoneId);
            SemEpdgListener epdgListener = getListener();
            if (epdgListener != null) {
        ...
        public void onEpdgShowPopup(int phoneId, int popupType) {
            Log.m94d(SemImsManager.LOG_TAG, "onEpdgShowPopup phoneId " + phoneId);
            SemEpdgListener epdgListener = getListener();
            if (epdgListener != null) {
    ...
    private static class ImsOngoingFtEventListenerDelegate extends SemImsFtListener.Stub {
    ...
    private static class AutoConfigurationListenerDelegate extends SemAutoConfigListener.Stub {
