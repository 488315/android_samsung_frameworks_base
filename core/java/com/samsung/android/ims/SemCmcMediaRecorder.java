        ...
        try {
            imsService.registerSemCmcRecordingListener(new ISemCmcRecordingListener.Stub() { // from class: com.samsung.android.ims.SemCmcMediaRecorder.1
                ...
                public void onInfo(int what, int extra) {
                    Log.m94d(SemCmcMediaRecorder.LOG_TAG, "ISemCmcRecordingListener onInfo : " + what + " " + extra);
                ...
                public void onError(int what, int extra) {
                    Log.m94d(SemCmcMediaRecorder.LOG_TAG, "ISemCmcRecordingListener onError : " + what + " " + extra);
