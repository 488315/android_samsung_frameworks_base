...
final class AuthenticatorService {
    ...
    static int getVersion() {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "getVersion failed : " + e.getMessage());
    ...
    static boolean initialize(ParcelFileDescriptor fd, long offset, long len) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "initialize failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static boolean setChallenge(byte[] challenge) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "setChallenge failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static byte[] getWrappedObject(byte[] challenge) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "getWrappedObject failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return result;
        }
    }
    ...
    static boolean initializeDrk() {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "initializeDrk failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static boolean terminateDrk() {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "terminateDrk failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static byte[] getDrkKeyHandle() {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "getDrkKeyHandle failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return result;
        }
    }
    ...
    static boolean writeFile(byte[] data, String path) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "writeFile failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static boolean deleteFile(String path) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "deleteFile failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static List<String> getFiles(String path, String filter) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "getFiles failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return result;
        }
    }
    ...
    static boolean initializeWithPreloadedTa() {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "initializeWithPreloadedTa failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static boolean terminateWithPreloadedTa() {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "terminateWithPreloadedTa failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static byte[] processWithPreloadedTa(byte[] command, String appId) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "processWithPreloadedTa failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return result;
        }
    }
    ...
    static String readFile(String path) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "readFile failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return "";
        }
    }
    ...
    static List<String> getMatchedFilePaths(String path, String filter) {
        ...
        try {
            ...
            AuthenticatorLog.m250e(TAG, "getMatchedFilePaths failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return result;
        }
    }
    ...
    static boolean initializePreloadedTa(int trustedAppType) {
        AuthenticatorLog.m249d(TAG, "static boolean initializePreloadedTa(int trustedAppType)");
        ISemAuthnrService service = (ISemAuthnrService) checkNotNullState(getService());
        try {
            boolean result = service.initializePreloadedTa(trustedAppType);
            return result;
        } catch (RemoteException e) {
            AuthenticatorLog.m250e(TAG, "initializeWithPreloadedTap failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static boolean terminatePreloadedTa(int trustedAppType) {
        AuthenticatorLog.m249d(TAG, "static boolean terminatePreloadedTa(int trustedAppType)");
        ISemAuthnrService service = (ISemAuthnrService) checkNotNullState(getService());
        try {
            boolean result = service.terminatePreloadedTa(trustedAppType);
            return result;
        } catch (RemoteException e) {
            AuthenticatorLog.m250e(TAG, "terminateWithPreloadedTap failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return false;
        }
    }
    ...
    static byte[] processPreloadedTa(int trustedAppType, byte[] command) {
        AuthenticatorLog.m249d(TAG, "static byte[] processPreloadedTa(int trustedAppType, byte[] command)");
        byte[] result = new byte[0];
        ISemAuthnrService service = (ISemAuthnrService) checkNotNullState(getService());
        try {
            ...
            AuthenticatorLog.m250e(TAG, "processWithPreloadedTap failed : " + e.getMessage());
            e.rethrowFromSystemServer();
            return result;
        }
    }
