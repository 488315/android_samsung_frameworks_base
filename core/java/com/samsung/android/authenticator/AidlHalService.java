...
final class AidlHalService implements XidlHalService, IBinder.DeathRecipient {
    ...
    private byte[] execute(int type, byte[] command) {
        ...
        try {
            ...
            AuthenticatorLog.m251i(TAG, "ret: " + sehResult.status + ", " + (sehResult.data == null ? -1 : sehResult.data.length));
    ...
    static /* synthetic */ class C49521 {
        ...
        static {
            ...
            try {
                f2961x5660cfb4[SemTrustedApplicationExecutor.TrustedAppType.DEVICE_ROOT_KEY_TRUSTED_APP.ordinal()] = 2;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f2961x5660cfb4[SemTrustedApplicationExecutor.TrustedAppType.ASSET_DOWNLOADER_TRUSTED_APP.ordinal()] = 3;
