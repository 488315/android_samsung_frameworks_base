...
public class ColorPaletteCreator5 extends ColorPaletteCreator {
    ...
    static float findRatio(float hue, int r) {
        ...
        if (ratio > 1.0f || ratio < 0.0f) {
            Log.m96e(TAG, "findRatio : ratio is more than 1");
            Log.m100v(TAG, "findRatio : hue = " + hue + " range[r] = " + iArr[r] + " range[r+1] = " + iArr[r + 1] + " ratio = " + ratio);
        }
        return ratio;
    }
    ...
    private void populateStyles() {
        ...
        Log.m100v(TAG, "populateStyles : seedsColor length" + this.mSeedColors.length);
        ...
        for (int i = 0; i < this.mSeedColors.length; i++) {
            ...
            Log.m100v(TAG, "populateStyles : seed = " + this.mSeedColors[i] + " C" + (i + 1) + " = " + this.mColorHsl[i][0]);
        }
    ...
    public float getExpressiveHue(float hue, int order) {
        ...
        Log.m100v(TAG, "getExpressiveHue : leftHue = " + leftHue + " rightHue = " + rightHue + " C" + (order + 1) + " case");
        if (leftHue > rightHue) {
            Log.m100v(TAG, "getExpressiveHue : leftHue(" + leftHue + ") > c1, c2, c3, c4 > rightHue(" + rightHue + NavigationBarInflaterView.KEY_CODE_END);
            int i = 0;
            while (true) {
                ...
                if (i != order) {
                    ...
                    if (rightHue < targetHue2 && targetHue2 < leftHue) {
                        Log.m100v(TAG, "getExpressiveHue : return seeds C" + (i + 1) + " " + targetHue2);
                        return targetHue2;
                    }
                }
                i++;
            ...
            Log.m100v(TAG, "getExpressiveHue : 360 > c1,c2,c3,c4 > rightHue(" + rightHue + ") || 0 < c1,c2,c3,c4 < leftHue(" + leftHue + NavigationBarInflaterView.KEY_CODE_END);
            int i2 = 0;
            while (true) {
            ...
            Log.m100v(TAG, "getExpressiveHue : return seeds C" + (i2 + 1) + " " + targetHue);
            return targetHue;
        }
