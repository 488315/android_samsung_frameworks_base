...
public final class Style {
  ...
  static {
    ...
    SPRITZ =
        new Style(
            ...
            new CoreSpec(
                new TonalSpec(
                    new Hue() { // from class:
                                // com.samsung.android.wallpaper.colortheme.monet.HueSource
                    ...
                    new Chroma(
                        d) { // from class:
                             // com.samsung.android.wallpaper.colortheme.monet.ChromaConstant
    ...
    TonalSpec tonalSpec =
        new TonalSpec(
            new Hue() { // from class: com.samsung.android.wallpaper.colortheme.monet.HueSource
              @Override // com.samsung.android.wallpaper.colortheme.monet.Hue
              public double get(Cam sourceColor) {
                return sourceColor.getHue();
              }
            ...
            new Chroma(
                d5) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaConstant
              private final double chroma;
    ...
    TonalSpec tonalSpec2 =
        new TonalSpec(
            ...
            new Chroma(
                d3) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaConstant
              private final double chroma;
    ...
    TonalSpec tonalSpec3 =
        new TonalSpec(
            new Hue(d6) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
            ...
            new Chroma(
                d7) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaConstant
              private final double chroma;
    ...
    TONAL_SPOT =
        new Style(
            WallpaperThemeConstants.DYNAMIC_COLOR_THEME_STYLE_DEFAULT,
            1,
            new CoreSpec(
                tonalSpec,
                tonalSpec2,
        ...
        new Style(
            ...
            new CoreSpec(
                new TonalSpec(
                    ...
                    new Chroma() { // from class:
                                   // com.samsung.android.wallpaper.colortheme.monet.ChromaMaxOut
                      @Override // com.samsung.android.wallpaper.colortheme.monet.Chroma
                      public double get(Cam sourceColor) {
                        return 130.0d;
                      }
                ...
                new TonalSpec(
                    new Hue() { // from class:
                                // com.samsung.android.wallpaper.colortheme.monet.HueVibrantSecondary
                      private final List<Pair> hueToRotations =
                          Arrays.asList(
                              new Pair(0, 18),
                              new Pair(41, 15),
                              new Pair(61, 10),
                ...
                new TonalSpec(
                    new Hue() { // from class:
                                // com.samsung.android.wallpaper.colortheme.monet.HueVibrantTertiary
                      private final List<Pair> hueToRotations =
                          Arrays.asList(
                              new Pair(0, 35),
                              new Pair(41, 30),
    ...
    EXPRESSIVE =
        new Style(
            ...
            new CoreSpec(
                new TonalSpec(
                    new Hue(
                        d12) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
                      private final double amountDegrees;

                      @Override // com.samsung.android.wallpaper.colortheme.monet.Hue
                      public double get(Cam sourceColor) {
                        return ColorScheme.wrapDegreesDouble(
                            sourceColor.getHue() + this.amountDegrees);
                      }
                ...
                new TonalSpec(
                    new Hue() { // from class:
                                // com.samsung.android.wallpaper.colortheme.monet.HueExpressiveSecondary
                      private final List<Pair> hueToRotations =
                          Arrays.asList(
                              new Pair(0, 45),
                              new Pair(21, 95),
                ...
                new TonalSpec(
                    new Hue() { // from class:
                                // com.samsung.android.wallpaper.colortheme.monet.HueExpressiveTertiary
                      private final List<Pair> hueToRotations =
                          Arrays.asList(
                              new Pair(0, 120),
                              new Pair(21, 120),
                ...
                new TonalSpec(
                    new Hue(
                        d14) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
                      private final double amountDegrees;
    ...
    TonalSpec tonalSpec4 =
        new TonalSpec(
            ...
            new Chroma(
                d17) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaConstant
              private final double chroma;
    ...
    TonalSpec tonalSpec5 =
        new TonalSpec(
            ...
            new Chroma(
                d18) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaConstant
              private final double chroma;
    ...
    TonalSpec tonalSpec6 =
        new TonalSpec(
            new Hue(d19) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueAdd
              private final double amountDegrees;
    ...
    TonalSpec tonalSpec7 =
        new TonalSpec(
            new Hue(d21) { // from class: com.samsung.android.wallpaper.colortheme.monet.HueSubtract
              private final double amountDegrees;
    ...
    TonalSpec tonalSpec8 =
        new TonalSpec(
            ...
            new Chroma(
                d22) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaConstant
              private final double chroma;
    ...
    TonalSpec tonalSpec10 =
        new TonalSpec(
            ...
            new Chroma() { // from class:
                           // com.samsung.android.wallpaper.colortheme.monet.ChromaSource
              @Override // com.samsung.android.wallpaper.colortheme.monet.Chroma
              public double get(Cam sourceColor) {
    ...
    TonalSpec tonalSpec11 =
        new TonalSpec(
            ...
            new Chroma(
                d25) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaMultiple
    ...
    TonalSpec tonalSpec12 =
        new TonalSpec(
            ...
            new Chroma(
                d26) { // from class: com.samsung.android.wallpaper.colortheme.monet.ChromaMultiple
              private final double multiple;
        ...
        new Style(
            ...
            new CoreSpec(
                ...
                new TonalSpec(
                    ...
                    new Chroma(
                        d27) { // from class:
                               // com.samsung.android.wallpaper.colortheme.monet.ChromaMultiple
                      private final double multiple;
