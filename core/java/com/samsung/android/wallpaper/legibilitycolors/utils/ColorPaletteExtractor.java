...
public class ColorPaletteExtractor extends ColorExtractor {
                        ...
                        while (true) {
                            if (colorA2 < size3) {
                                ...
                                if (dominantColorResultB.percentage == 0.0f) {
                                    ...
                                    switch (C53212.f3080xac33c33a[colorSpace.ordinal()]) {
                                        case 1:
                                            minIndex2 = minIndex3;
                                            float hueA7 = hueA2;
    ...
    static /* synthetic */ class C53212 {

        /* renamed from: $SwitchMap$com$samsung$android$wallpaper$legibilitycolors$utils$ColorPaletteExtractor$ColorSpace */
        static final /* synthetic */ int[] f3080xac33c33a;
        ...
        static {
            ...
            try {
                f3080xac33c33a[ColorSpace.RGB.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f3080xac33c33a[ColorSpace.HSV.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f3080xac33c33a[ColorSpace.LAB.ordinal()] = 4;
    ...
    public static ColorExtractor.DominantColorResult[] kMeansHsv(Bitmap bitmap, int[] clusterGroups, boolean isGettingExtraData) {
        ...
        Log.m98i(TAG, "kMeansHsv input bitmap size = " + bitmapWidth + " x " + bitmapHeight + " | ClusterGroups Num = " + clusterGroups.length);
    ...
    public static ColorExtractor.DominantColorResult[] kMeansHsv(int[] pixels, int[] clusterGroups, boolean isGettingExtraData, int bitmapWidth, int bitmapHeight) {
        ...
        while (true) {
            ...
            if (A_MASK == i5) {
                ...
                Log.m98i(TAG, "ColorExtractor Memory Usage " + (currentMemoryUsage - prevMemoryUsage) + " length: " + pixels.length);
            } else {
                A_MASK++;
