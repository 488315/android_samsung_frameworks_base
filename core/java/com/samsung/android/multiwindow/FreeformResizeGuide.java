...
public class FreeformResizeGuide {
    ...
    /* renamed from: mH */
    private final HandlerC5200H f3034mH;
    ...
    public FreeformResizeGuide(Context context, int dexDockingState, String packageName) {
        ...
        this.f3034mH = new HandlerC5200H();
        FreeformResizeGuideView freeformResizeGuideView = (FreeformResizeGuideView) LayoutInflater.from(systemUiContext).inflate(C4337R.layout.freeform_resize_guide, (ViewGroup) null);
    ...
    private WindowManager.LayoutParams generateLayoutParam() {
        ...
        lp.windowAnimations = C4337R.style.freeform_resize_guide_window_animation;
    ...
    public void dismiss() {
        ...
        HandlerC5200H handlerC5200H = this.f3034mH;
        if (!this.mDismissed && timeout > 0) {
            j = 10 + timeout;
        }
        handlerC5200H.sendEmptyMessageDelayed(0, j);
    }
    ...
    public void updateMinMaxSizeIfNeeded(ActivityManager.RunningTaskInfo taskInfo, Rect displaySize, boolean startOrientationWasLandscape) {
        ...
        if (CoreRune.SAFE_DEBUG) {
            Slog.m117i(TAG, "startDrag: taskOrientation=" + taskOrientation + ", Min=(" + this.mMinWidth + "," + this.mMinHeight + ") Max=(" + this.mMaxWidth + "," + this.mMaxHeight + NavigationBarInflaterView.KEY_CODE_END);
        }
    }
    ...
    public void updateResizeGestureInfo(Rect displayFrame, Rect stableBounds) {
        ...
        this.mFreeformGuideViewFullscreenMargin = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.freeform_resize_guide_view_fullscreen_margin);
        this.mMinimizeFreeformPadding = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.minimize_freeform_padding);
    }
    ...
    /* renamed from: com.samsung.android.multiwindow.FreeformResizeGuide$H */
    final class HandlerC5200H extends Handler {
