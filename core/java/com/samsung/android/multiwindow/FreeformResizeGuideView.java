...
public class FreeformResizeGuideView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.mDimViewMargin = getResources().getDimensionPixelSize(C4337R.dimen.freeform_resize_guide_view_dim_margin);
        this.mFullscreenDimViewMargin = getResources().getDimensionPixelSize(C4337R.dimen.freeform_resize_guide_view_fullscreen_dim_margin);
        this.mAppIconSize = getResources().getDimensionPixelSize(C4337R.dimen.freeform_resize_guide_view_app_icon_size);
    }
    ...
    void startShowAppIconAnimation() {
        ...
        animatorSet2.setInterpolator(AnimationUtils.loadInterpolator(this.mContext, C4337R.interpolator.sine_in_out_33));
