...
public class SemAnimatorUtils {
  public static final TypeEvaluator<Rect> BOUNDS_EVALUATOR =
      new TypeEvaluator<Rect>() { // from class: com.samsung.android.animation.SemAnimatorUtils.1
  ...
  public static boolean isTalkBackEnabled(Context context) {
    ...
    Log.m94d("SemAnimatorUtils", "isTalkBackEnabled = " + isTalkBackEnabled);
