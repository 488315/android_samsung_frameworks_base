        ...
        this.mDeleteRunnable = new Runnable() { // from class: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator.2
            ...
            */
            public void run() {
                ...
                int oldX;
                float translationX4;
                SemHorizontalListView listview3 = SemAddDeleteHorizontalListAnimator.this.mHorizontalListView;
                ...
                if (childCountAfter3 > headerViewsCount2) {
                    singleItemWidth2 = SemAddDeleteHorizontalListAnimator.this.getChildMaxWidth() + listview3.getDividerHeight();
                ...
                int newlyAppearingViewOldPositionFromRight = i3 + (lastVisiblePosAfter2 - childCountAfter3);
                int i4 = 0;
                while (i4 < childCountAfter3) {
                    ...
                    if (itemId == -1) {
                        ...
                        viewInfo = SemAddDeleteHorizontalListAnimator.this.mOldHeaderFooterViewCache.remove(Long.valueOf(itemId));
                    } else {
                        headerViewsCount = headerViewsCount2;
                        top3 = top;
                        height2 = height;
                        viewInfo = SemAddDeleteHorizontalListAnimator.this.mOldViewCache.remove(Long.valueOf(itemId));
                    }
                    if (viewInfo != null) {
                    ...
                    animations.add(SemAddDeleteHorizontalListAnimator.this.getTranslateAnim(child, translationX4, 0.0f));
                ...
                while (entrySetIterator.hasNext()) {
                    ...
                    Rect startValue = new Rect(viewInfo2.left, footerViewsCount3, viewInfo2.right, top4 + height3);
                    int newPosition = SemAddDeleteHorizontalListAnimator.this.getNewPosition(viewInfo2.oldPosition, deletedItems);
                    ...
                    if (destinationViewIndex >= 0) {
                        ...
                        if (destinationViewIndex >= childCountAfter) {
                            ...
                            if (isDeletedItem) {
                                ...
                                endValue = new Rect(i5, singleItemWidth3 + vertOffset, endValue.right - horizOffset, endValue.bottom - vertOffset);
                            }
                            ...
                            if (updateListenerAdded) {
                                anim.addUpdateListener(SemAddDeleteHorizontalListAnimator.this.mBitmapUpdateListener);
                ...
                animSet.addListener(new AnimatorListenerAdapter() { // from class: com.samsung.android.animation.SemAddDeleteHorizontalListAnimator.2.1
            ...
            public void run() {
                ...
                while (i3 < top2) {
                    ...
                    if (itemId2 == -1) {
                        ...
                        if (viewInfo == null) {
                            Log.m96e(SemAddDeleteHorizontalListAnimator.TAG, "AFTER header/footer SOMETHING WENT WRONG, in the new layout, header/footer is appearing that was not present before!");
                        } else {
                            viewInfo.recycleBitmap();
                            if (viewInfo.left == newX2) {
                                Log.m96e(SemAddDeleteHorizontalListAnimator.TAG, "AFTER header/footer something strange is happening, the coordinates are same after layout, viewInfo.left=" + viewInfo.left + ", newX=" + newX2);
                            } else {
