...
public class SemAddDeleteHorizontalListAnimator extends SemAbsAddDeleteAnimator {
                ...
                .addOnPreDrawListener(
                        new ViewTreeObserver
                            ...
                            public boolean onPreDraw() {
                                ...
                                if (SemAddDeleteHorizontalListAnimator.this.mDeleteRunnable
                                        != null) {
    ...
    private void prepareDelete(ArrayList<Integer> deletingItemPositions) {
        ...
        if (this.mHorizontalListView.getChildAt(this.mHorizontalListView.getHeaderViewsCount())
                != null) {
            int defaultHeight2 =
                    this.mHorizontalListView
                            .getChildAt(this.mHorizontalListView.getHeaderViewsCount())
                            .getHeight();
                        ...
                        */
                        throw new UnsupportedOperationException(
                                "Method not decompiled:"
                                    + " com.samsung.android.animation.SemAddDeleteHorizontalListAnimator.AnonymousClass2.run():void");
                    }
                };
    }
                        ...
                        new ViewTreeObserver
                            ...
                            public boolean onPreDraw() {
                                SemAddDeleteHorizontalListAnimator.this
                                        ...
                                        .getViewTreeObserver()
                                        .removeOnPreDrawListener(this);
                                if (SemAddDeleteHorizontalListAnimator.this.mInsertRunnable
                                        != null) {
                ...
                new Runnable() { // from class:
                    ...
                    public void run() {
                        ...
                        while (i3 < top2) {
                            ...
                            if (itemId2 == -1) {
                                ...
                                SemAbsAddDeleteAnimator.ViewInfo viewInfo =
                                        SemAddDeleteHorizontalListAnimator.this
                                                .mOldHeaderFooterViewCache.remove(
                                ...
                                SemAbsAddDeleteAnimator.ViewInfo viewInfo2 =
                                        SemAddDeleteHorizontalListAnimator.this.mOldViewCache
                                ...
                                if (viewInfo2 != null) {
                                    ...
                                    firstVisiblePos2 = firstVisiblePos3;
                                    if (SemAddDeleteHorizontalListAnimator.this.mHorizontalListView
                                            .isLayoutRtl()) {
                        ...
                        while (entrySetIterator.hasNext()) {
                            ...
                            if (!insertedItems.contains(Integer.valueOf(currentPos3))) {
                                ...
                                if (newPosition < listview2.getFirstVisiblePosition()) {
                                    ...
                                    int childLeft =
                                            top2 != 0
                                                    ? listview2.getChildAt(0).getLeft()
                                                    : listview2.getLeft();
                                    if (SemAddDeleteHorizontalListAnimator.this.mHorizontalListView
                                            .isLayoutRtl()) {
                                ...
                                SemAddDeleteHorizontalListAnimator.this.mGhostViewSnapshots.add(
                                        viewinfo);
                        ...
                        for (Map.Entry<Long, SemAbsAddDeleteAnimator.ViewInfo> viewEntry2 :
                                SemAddDeleteHorizontalListAnimator.this.mOldHeaderFooterViewCache
                                        .entrySet()) {
                        ...
                        animSet.addListener(
                                new AnimatorListenerAdapter() { // from class:
                                    ...
                                    public void onAnimationStart(Animator animation) {
                                        SemAddDeleteHorizontalListAnimator.this.mHorizontalListView
                                                .setEnabled(false);
                                        if (SemAddDeleteHorizontalListAnimator.this
                                                        .mOnAddDeleteListener
                                                != null) {
                                            SemAddDeleteHorizontalListAnimator.this
                                                    .mOnAddDeleteListener.onAnimationStart(true);
                                        }
                                    }
                                    ...
                                    public void onAnimationEnd(Animator animation) {
                                        SemAddDeleteHorizontalListAnimator.this.mGhostViewSnapshots
                                                .clear();
                                        SemAddDeleteHorizontalListAnimator.this.mHorizontalListView
                                                .invalidate();
                                        SemAddDeleteHorizontalListAnimator.this.mHorizontalListView
                                        ...
                                        if (SemAddDeleteHorizontalListAnimator.this
                                                ...
                                                != null) {
                                            SemAddDeleteHorizontalListAnimator.this
                                                    .mOnAddDeleteListener.onAnimationEnd(true);
                                        }
                                    }
                        ...
                        animSet.setDuration(
                                SemAddDeleteHorizontalListAnimator.this.mTranslationDuration);
                        animSet.start();
                    }
                };
    }
