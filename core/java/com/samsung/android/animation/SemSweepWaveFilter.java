...
public class SemSweepWaveFilter extends SemAbsSweepAnimationFilter {
  ...
  private Canvas drawWaveToBitmapCanvas(View view, float sweepProgress) {
    ...
    if (parentView != null && (parentView instanceof ViewGroup)) {
      viewTop =
          parentView instanceof ListView ? view.getTop() : view.getTop() + parentView.getTop();
    }
    ...
    ofFloat.addUpdateListener(
        new ValueAnimator
          ...
          public void onAnimationUpdate(ValueAnimator animation) {
            ...
            semSweepWaveFilter3.doDrawWaveEffect(
                semSweepWaveFilter3.mViewForeground, SemSweepWaveFilter.this.mDeltaX, itemIndex);
          }
        });
  ...
  private void drawWaveInto(
    ...
    path.cubicTo(
        f, startYdown + f2, startXdown, (startYdown + f3) - f2, startXdown, startYdown + f3);
    ...
    path3.cubicTo(
        f7,
        (f8 * 2.0f) + startYdown + f9,
        startXdown,
        ((f8 * 3.0f) + startYdown) - f9,
        startXdown,
        startYdown + (f8 * 3.0f));
    ...
    path4.cubicTo(
        startXdown,
        (f10 * 3.0f) + startYdown + f11,
        startXdown + f12,
        ((f10 * 4.0f) + startYdown) - f11,
        startXdown + f12,
        startYdown + (f10 * 4.0f));
    ...
    path5.cubicTo(
        f13, startYdown + f14, startXdown, (startYdown + f15) - f14, startXdown, startYdown + f15);
    ...
    path7.cubicTo(
        f19,
        (2.0f * f20) + startYdown + f21,
        startXdown,
        ((f20 * 3.0f) + startYdown) - f21,
        startXdown,
        startYdown + (f20 * 3.0f));
    ...
    path8.cubicTo(
        startXdown,
        startYdown + (3.0f * f22) + f23,
        startXdown + f24,
        ((f22 * 4.0f) + startYdown) - f23,
        startXdown + f24,
        (f22 * 4.0f) + startYdown);
