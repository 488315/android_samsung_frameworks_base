            ...
            */
            public void run() {
                ...
                if (childCountAfter2 > headerViewsCount2) {
                    singleItemHeight2 = SemAddDeleteListAnimator.this.getChildMaxHeight() + listview3.getDividerHeight();
                ...
                int newlyAppearingViewOldPositionFromBottom = i + (lastVisiblePosAfter2 - childCountAfter2);
                int i2 = 0;
                while (i2 < childCountAfter2) {
                    ...
                    if (itemId == -1) {
                        ...
                        viewInfo = SemAddDeleteListAnimator.this.mOldHeaderFooterViewCache.remove(Long.valueOf(itemId));
                    } else {
                        headerViewsCount = headerViewsCount2;
                        left2 = left3;
                        width2 = width;
                    ...
                    animations.add(SemAddDeleteListAnimator.this.getTranslateAnim(child, 0.0f, translationY3));
                ...
                while (entrySetIterator.hasNext()) {
                    ...
                    Rect startValue = new Rect(footerViewsCount3, viewInfo2.top, left4 + width3, viewInfo2.bottom);
                    int newPosition = SemAddDeleteListAnimator.this.getNewPosition(viewInfo2.oldPosition, deletedItems);
                    boolean isDeletedItem = deletedItemPosHash.contains(Integer.valueOf(viewInfo2.oldPosition));
                    ...
                    if (destinationViewIndex >= 0) {
                        ...
                        if (destinationViewIndex >= childCountAfter) {
                            ...
                            if (isDeletedItem) {
                                ...
                                endValue = new Rect(i3, singleItemHeight3 + vertOffset, endValue.right - horizOffset, endValue.bottom - vertOffset);
                            }
                            PropertyValuesHolder pvhBounds = PropertyValuesHolder.ofObject("bounds", SemAnimatorUtils.BOUNDS_EVALUATOR, startValue, endValue);
                            PropertyValuesHolder pvhAlpha = PropertyValuesHolder.ofInt("alpha", 255, 0);
                            ObjectAnimator anim = ObjectAnimator.ofPropertyValuesHolder(viewInfo2.viewSnapshot, pvhBounds, pvhAlpha);
                    ...
                    PropertyValuesHolder pvhBounds2 = PropertyValuesHolder.ofObject("bounds", SemAnimatorUtils.BOUNDS_EVALUATOR, startValue, endValue2);
                    PropertyValuesHolder pvhAlpha2 = PropertyValuesHolder.ofInt("alpha", 255, 0);
                    ObjectAnimator anim2 = ObjectAnimator.ofPropertyValuesHolder(viewInfo2.viewSnapshot, pvhBounds2, pvhAlpha2);
                    if (updateListenerAdded) {
                    }
                ...
                animSet.addListener(new AnimatorListenerAdapter() { // from class: com.samsung.android.animation.SemAddDeleteListAnimator.3.1
                ...
                animSet.start();
                Log.m98i(SemAddDeleteListAnimator.TAG, "postDelayed #1 mAniTimeoutRunnable delay = " + (SemAddDeleteListAnimator.this.mTranslationDuration + 100));
            ...
            public void run() {
                ...
                while (i3 < childCount3) {
                    ...
                    if (itemId2 == -1) {
                        ...
                        if (viewInfo == null) {
                            Log.m96e(SemAddDeleteListAnimator.TAG, "AFTER header/footer SOMETHING WENT WRONG, in the new layout, header/footer is appearing that was not present before!");
                        } else {
                            viewInfo.recycleBitmap();
                            if (viewInfo.top == newY2) {
                                Log.m96e(SemAddDeleteListAnimator.TAG, "AFTER header/footer something strange is happening, the coordinates are same after layout, viewInfo.top=" + viewInfo.top + ", newY=" + newY2);
                            } else {
                ...
                animSet.setDuration(SemAddDeleteListAnimator.this.mTranslationDuration);
                animSet.start();
                Log.m98i(SemAddDeleteListAnimator.TAG, "postDelayed #2 mAniTimeoutRunnable delay = " + (SemAddDeleteListAnimator.this.mTranslationDuration + 100));
                SemAddDeleteListAnimator.this.mHandler.postDelayed(SemAddDeleteListAnimator.this.mAniTimeoutRunnable, SemAddDeleteListAnimator.this.mTranslationDuration + 100);
            }
        };
    }
    ...
    private void prepareInsertDelete(ArrayList<Integer> insertedItemPositions, ArrayList<Integer> deletingItemPositions) {
        ...
        this.mInsertDeleteRunnable = new Runnable() { // from class: com.samsung.android.animation.SemAddDeleteListAnimator.7
            ...
            public void run() {
                ...
                while (i5 < childCount) {
                    ...
                    if (itemId2 == -1) {
                        ...
                        if (viewInfo == null) {
                            ...
                            viewInfo.recycleBitmap();
                            if (viewInfo.top == newY) {
                                Log.m96e(SemAddDeleteListAnimator.TAG, "AFTER header/footer something strange is happening, the coordinates are same after layout, viewInfo.top=" + viewInfo.top + ", newY=" + newY);
                                headerViewsCount2 = headerViewsCount3;
                                adapterCount2 = adapterCount3;
                            } else {
                ...
                animSet.setDuration(SemAddDeleteListAnimator.this.mTranslationDuration);
                animSet.start();
                Log.m98i(SemAddDeleteListAnimator.TAG, "postDelayed #3 mAniTimeoutRunnable delay = " + (SemAddDeleteListAnimator.this.mTranslationDuration + 100));
                SemAddDeleteListAnimator.this.mHandler.postDelayed(SemAddDeleteListAnimator.this.mAniTimeoutRunnable, SemAddDeleteListAnimator.this.mTranslationDuration + 100);
            }
        };
    }
