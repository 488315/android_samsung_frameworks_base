...
public class SemAddDeleteListAnimator extends SemAbsAddDeleteAnimator {
  ...
  private final Runnable mAniTimeoutRunnable =
      new Runnable() { // from class: com.samsung.android.animation.SemAddDeleteListAnimator.1
        @Override // java.lang.Runnable
        public void run() {
          Log.m98i(SemAddDeleteListAnimator.TAG, "mAniTimeoutRunnable.run");
          if (SemAddDeleteListAnimator.this.mGhostViewSnapshots.size() > 0) {
            Iterator<SemAbsAddDeleteAnimator.ViewInfo> it =
                SemAddDeleteListAnimator.this.mGhostViewSnapshots.iterator();
            while (it.hasNext()) {
        ...
        .addOnPreDrawListener(
            new ViewTreeObserver
                .OnPreDrawListener() { // from class:
                                       // com.samsung.android.animation.SemAddDeleteListAnimator.2
              @Override // android.view.ViewTreeObserver.OnPreDrawListener
              public boolean onPreDraw() {
                SemAddDeleteListAnimator.this
                    .mListView
                    .getViewTreeObserver()
  ...
  private void prepareDelete(ArrayList<Integer> deletingItemPositions) {
    ...
    this.mDeleteRunnable =
        new Runnable() { // from class: com.samsung.android.animation.SemAddDeleteListAnimator.3
          ...
          */
          public void run() {
            ...
            int rowShift;
            float translationY3;
            ListView listview3 = SemAddDeleteListAnimator.this.mListView;
            int childCountAfter2 = listview3.getChildCount();
            ...
            int singleItemHeight2 = 0;
            int left3 = 0;
            if (childCountAfter2 > headerViewsCount2) {
              singleItemHeight2 =
                  SemAddDeleteListAnimator.this.getChildMaxHeight() + listview3.getDividerHeight();
              left3 = listview3.getChildAt(headerViewsCount2).getLeft();
              width = listview3.getChildAt(headerViewsCount2).getWidth();
            } else {
              width = listview3.getWidth();
            }
            boolean newItemsComingFromTop = true;
            int newItemsComingFromTopCount = firstVisiblePosBefore - firstVisiblePosAfter;
            int newItemsFromTopRemaining = newItemsComingFromTopCount;
            int i = lastVisiblePosAfter + 1;
            int lastVisiblePosAfter2 = childCountBefore;
            int newlyAppearingViewOldPositionFromBottom =
                i + (lastVisiblePosAfter2 - childCountAfter2);
            int i2 = 0;
            while (i2 < childCountAfter2) {
              float translationY5 = translationY4;
              View child = listview3.getChildAt(i2);
              ListView listview4 = listview3;
              int position = i2 + firstVisiblePosAfter;
              int childCountAfter3 = childCountAfter2;
              long itemId = adapter.getItemId(position);
              float newY = child.getTop();
              if (itemId == -1) {
                ...
                viewInfo =
                    SemAddDeleteListAnimator.this.mOldHeaderFooterViewCache.remove(
                        Long.valueOf(itemId));
              } else {
                headerViewsCount = headerViewsCount2;
                left2 = left3;
                width2 = width;
                viewInfo = SemAddDeleteListAnimator.this.mOldViewCache.remove(Long.valueOf(itemId));
              }
              if (viewInfo != null) {
                viewInfo.recycleBitmap();
                newItemsComingFromTop = false;
                if (viewInfo.top == newY) {
                  translationY4 = translationY5;
                  i2++;
                  listview3 = listview4;
                  childCountAfter2 = childCountAfter3;
                  headerViewsCount2 = headerViewsCount;
                  left3 = left2;
                  width = width2;
                } else {
                  translationY3 = viewInfo.top - newY;
                }
              } else {
                if (newItemsFromTopRemaining > 0 && newItemsComingFromTop) {
                  rowShift = -newItemsComingFromTopCount;
                  newItemsFromTopRemaining--;
                } else {
                  rowShift = newlyAppearingViewOldPositionFromBottom - position;
                  newlyAppearingViewOldPositionFromBottom++;
                }
                int oldY = child.getTop() + (rowShift * singleItemHeight2);
                translationY3 = oldY - newY;
              }
              animations.add(
                  SemAddDeleteListAnimator.this.getTranslateAnim(child, 0.0f, translationY3));
              translationY4 = translationY3;
              i2++;
              listview3 = listview4;
              childCountAfter2 = childCountAfter3;
              headerViewsCount2 = headerViewsCount;
            ...
            int childCountAfter4 = childCountAfter2;
            int left4 = left3;
            int width3 = width;
            Iterator<Map.Entry<Long, SemAbsAddDeleteAnimator.ViewInfo>> entrySetIterator =
                SemAddDeleteListAnimator.this.mOldViewCache.entrySet().iterator();
            ...
            while (entrySetIterator.hasNext()) {
              ...
              int footerViewsCount3 = left4;
              Rect startValue =
                  new Rect(footerViewsCount3, viewInfo2.top, left4 + width3, viewInfo2.bottom);
              int newPosition =
                  SemAddDeleteListAnimator.this.getNewPosition(viewInfo2.oldPosition, deletedItems);
              ...
              if (destinationViewIndex >= 0) {
                childCountAfter = childCountAfter4;
                if (destinationViewIndex >= childCountAfter) {
                  left = footerViewsCount3;
                  listview = listview5;
                  adapterCount = adapterCount2;
                } else {
                  listview = listview5;
                  left = footerViewsCount3;
                  int left5 = listview.getChildAt(destinationViewIndex).getTop();
                  float referenceY = left5;
                  adapterCount = adapterCount2;
                  translationY = referenceY - viewInfo2.top;
                  Rect endValue = new Rect(startValue);
                  int childCountAfter5 = childCountAfter;
                  endValue.offset(0, (int) translationY);
                  if (isDeletedItem) {
                    listview2 = listview;
                    translationY2 = translationY;
                    singleItemHeight = singleItemHeight2;
                  } else {
                    int horizOffset =
                        (int)
                    ...
                    int vertOffset =
                        (int)
                            (((1.0f - SemAbsAddDeleteAnimator.START_SCALE_FACTOR) / 2.0f)
                                * endValue.height());
                    translationY2 = translationY;
                    int i3 = endValue.left + horizOffset;
                    singleItemHeight = singleItemHeight2;
                    int singleItemHeight3 = endValue.top;
                    endValue =
                        new Rect(
                            i3,
                            singleItemHeight3 + vertOffset,
                  ...
                  left4 = left;
                  childCountAfter4 = childCountAfter5;
                  listview5 = listview2;
                  singleItemHeight2 = singleItemHeight;
                }
              } else {
                left = footerViewsCount3;
                childCountAfter = childCountAfter4;
              ...
              if (childCountAfter == 0) {
                firstChildTop = listview.getPaddingTop();
              } else {
                firstChildTop = listview.getChildAt(0).getTop();
              }
              float translationY6 = firstChildTop - viewInfo2.top;
              translationY = translationY6 - ((-destinationViewIndex) * singleItemHeight2);
              Rect endValue2 = new Rect(startValue);
              int childCountAfter52 = childCountAfter;
              endValue2.offset(0, (int) translationY);
              if (isDeletedItem) {}
              ...
              firstVisiblePosAfter = firstVisiblePosAfter2;
              left4 = left;
              childCountAfter4 = childCountAfter52;
              listview5 = listview2;
              singleItemHeight2 = singleItemHeight;
            }
            ...
            animSet.addListener(
                new AnimatorListenerAdapter() { // from class:
                                                // com.samsung.android.animation.SemAddDeleteListAnimator.3.1
                  @Override // android.animation.AnimatorListenerAdapter,
                            // android.animation.Animator.AnimatorListener
                  public void onAnimationStart(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationStart #1");
                  ...
                  public void onAnimationEnd(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationEnd #1");
                    SemAddDeleteListAnimator.this.mHandler.removeCallbacks(
                        SemAddDeleteListAnimator.this.mAniTimeoutRunnable);
                    if (SemAddDeleteListAnimator.this.mGhostViewSnapshots.size() > 0) {
                      Iterator<SemAbsAddDeleteAnimator.ViewInfo> it =
                          SemAddDeleteListAnimator.this.mGhostViewSnapshots.iterator();
                      while (it.hasNext()) {
                  ...
                  public void onAnimationCancel(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationCancel #1");
                    SemAddDeleteListAnimator.this.mHandler.removeCallbacks(
                        SemAddDeleteListAnimator.this.mAniTimeoutRunnable);
                    if (SemAddDeleteListAnimator.this.mGhostViewSnapshots.size() > 0) {
                      Iterator<SemAbsAddDeleteAnimator.ViewInfo> it =
            ...
            animSet.start();
            Log.m98i(
                SemAddDeleteListAnimator.TAG,
                "postDelayed #1 mAniTimeoutRunnable delay = "
                    + (SemAddDeleteListAnimator.this.mTranslationDuration + 100));
            SemAddDeleteListAnimator.this.mHandler.postDelayed(
                SemAddDeleteListAnimator.this.mAniTimeoutRunnable,
                SemAddDeleteListAnimator.this.mTranslationDuration + 100);
          }
        };
        ...
        if (itemId2 == -1) {
          ...
          this.mOldHeaderFooterViewCache.put(
              ...
              new SemAbsAddDeleteAnimator.ViewInfo(
                  snapshot, position, 0, child.getTop(), 0, child.getBottom()));
        } else {
          listview = listview2;
          this.mOldViewCache.put(
              Long.valueOf(itemId2),
              new SemAbsAddDeleteAnimator.ViewInfo(
                  snapshot, i + firstVisiblePosBefore, 0, child.getTop(), 0, child.getBottom()));
        }
        i++;
        listview2 = listview;
      }
  ...
  public int getChildMaxHeight() {
    ...
    for (int i = 0; i < childCount; i++) {
      ...
      if (pos >= this.mListView.getHeaderViewsCount()
          && pos < adapterCount - this.mListView.getFooterViewsCount()
          && (height = this.mListView.getChildAt(i).getHeight()) > childHeight) {
        childHeight = height;
      }
    }
    return childHeight;
  ...
  public void insertIntoAdapterCompleted() {
    ...
    this.mListView
        ...
        .addOnPreDrawListener(
            new ViewTreeObserver
                .OnPreDrawListener() { // from class:
                                       // com.samsung.android.animation.SemAddDeleteListAnimator.4
              @Override // android.view.ViewTreeObserver.OnPreDrawListener
              public boolean onPreDraw() {
                SemAddDeleteListAnimator.this
                    .mListView
    ...
    for (int j = 0; j < insertedItems.size(); j++) {
      ...
      if (refView != null) {
        upcomingViewsStartCoords.put(
            Integer.valueOf(insertedItemPos), Integer.valueOf(refView.getTop()));
      }
    }
    this.mInsertRunnable =
        new Runnable() { // from class: com.samsung.android.animation.SemAddDeleteListAnimator.5
          @Override // java.lang.Runnable
          public void run() {
            int width;
            int newY;
            ...
            if (childCount3 > headerViewsCount) {
              singleItemHeight =
                  SemAddDeleteListAnimator.this.getChildMaxHeight() + listview2.getDividerHeight();
            ...
            while (i3 < childCount3) {
              ...
              if (itemId2 == -1) {
                  ...
                  if (viewInfo.top == newY2) {
                    Log.m96e(
                        ...
                        "AFTER header/footer something strange is happening, the coordinates are"
                            + " same after layout, viewInfo.top="
                            + viewInfo.top
                            + ", newY="
                            + newY2);
                  } else {
                    ObjectAnimator anim2 =
                        SemAddDeleteListAnimator.this.getTranslateAnim(
                            child2, 0.0f, viewInfo.top - newY2);
                    animations.add(anim2);
                ...
                SemAbsAddDeleteAnimator.ViewInfo viewInfo2 =
                    SemAddDeleteListAnimator.this.mOldViewCache.remove(Long.valueOf(itemId2));
                if (viewInfo2 != null) {
                  viewInfo2.recycleBitmap();
                  if (viewInfo2.top != newY2) {
                    ObjectAnimator anim3 =
                        SemAddDeleteListAnimator.this.getTranslateAnim(
                            child2, 0.0f, viewInfo2.top - newY2);
                  ...
                  ObjectAnimator anim4 =
                      SemAddDeleteListAnimator.this.getInsertTranslateAlphaScaleAnim(
                          child2, 0.0f, startPos.intValue() - newY2);
                  animations.add(anim4);
                  firstVisiblePos2 = firstVisiblePos3;
                } else {
                  int currentPos = i3 + firstVisiblePos3;
                  int shiftCount =
                      SemAddDeleteListAnimator.this.getShiftCount(currentPos, insertedItems);
                  ...
                  if (insertedItemPosHash.contains(Integer.valueOf(currentPos))) {
                    anim =
                        SemAddDeleteListAnimator.this.getInsertTranslateAlphaScaleAnim(
                            child2, 0.0f, translationY);
                  } else {
                    anim =
                        SemAddDeleteListAnimator.this.getTranslateAnim(child2, 0.0f, translationY);
                  }
                  animations.add(anim);
                }
                i3++;
            ...
            while (entrySetIterator.hasNext()) {
              ...
              if (!insertedItems.contains(Integer.valueOf(currentPos2))) {
                ...
                int newPosition =
                    SemAddDeleteListAnimator.this.getNewPositionForInsert(
                ...
                Rect oldViewBounds =
                    new Rect(currentPos4, viewinfo.top, left3 + width3, viewinfo.bottom);
                Rect newViewBounds =
                    new Rect(
                        currentPos4,
                        newY,
                        oldViewBounds.width() + currentPos4,
                        oldViewBounds.height() + newY);
            ...
            for (Map.Entry<Long, SemAbsAddDeleteAnimator.ViewInfo> viewEntry2 :
                SemAddDeleteListAnimator.this.mOldHeaderFooterViewCache.entrySet()) {
              ...
              Rect oldViewBounds2 =
                  new Rect(currentPos5, viewinfo2.top, currentPos5 + width3, viewinfo2.bottom);
              Rect newViewBounds2 =
                  new Rect(
                      currentPos5,
                      newY3,
                      oldViewBounds2.width() + currentPos5,
                      oldViewBounds2.height() + newY3);
              SemAddDeleteListAnimator.this.mGhostViewSnapshots.add(viewinfo2);
            ...
            animSet.addListener(
                new AnimatorListenerAdapter() { // from class:
                  // com.samsung.android.animation.SemAddDeleteListAnimator.5.1
                  @Override // android.animation.AnimatorListenerAdapter,
                  // android.animation.Animator.AnimatorListener
                  public void onAnimationStart(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationStart #2");
                    if (SemAddDeleteListAnimator.this.mListView.isPressed()) {
                      SemAddDeleteListAnimator.this.mListView.setPressed(false);
                    }
                    SemAddDeleteListAnimator.this.mListView.setEnabled(false);
                  ...
                  // android.animation.Animator.AnimatorListener
                  public void onAnimationEnd(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationEnd #2");
                    SemAddDeleteListAnimator.this.mHandler.removeCallbacks(
                        SemAddDeleteListAnimator.this.mAniTimeoutRunnable);
                    SemAddDeleteListAnimator.this.mGhostViewSnapshots.clear();
                    SemAddDeleteListAnimator.this.mListView.invalidate();
                  ...
                  // android.animation.Animator.AnimatorListener
                  public void onAnimationCancel(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationCancel #2");
                    SemAddDeleteListAnimator.this.mHandler.removeCallbacks(
                        SemAddDeleteListAnimator.this.mAniTimeoutRunnable);
                    SemAddDeleteListAnimator.this.mGhostViewSnapshots.clear();
                    SemAddDeleteListAnimator.this.mListView.invalidate();
            ...
            Log.m98i(
                SemAddDeleteListAnimator.TAG,
                "postDelayed #2 mAniTimeoutRunnable delay = "
                    + (SemAddDeleteListAnimator.this.mTranslationDuration + 100));
            SemAddDeleteListAnimator.this.mHandler.postDelayed(
                SemAddDeleteListAnimator.this.mAniTimeoutRunnable,
                SemAddDeleteListAnimator.this.mTranslationDuration + 100);
  ...
  public void setInsertDelete(
      ArrayList<Integer> insertedItemPositions, ArrayList<Integer> deletingItemPositions) {
  ...
  public void setInsertDeletePending(
      ArrayList<Integer> insertedItemPositions, ArrayList<Integer> deletingItemPositions) {
    if (insertedItemPositions.size() == 0 && deletingItemPositions.size() == 0) {
      return;
    }
  ...
  public void insertDeleteFromAdapterCompleted() {
    ...
    this.mListView
        ...
        .addOnPreDrawListener(
            new ViewTreeObserver
                .OnPreDrawListener() { // from class:
                                       // com.samsung.android.animation.SemAddDeleteListAnimator.6
              @Override // android.view.ViewTreeObserver.OnPreDrawListener
              public boolean onPreDraw() {
                SemAddDeleteListAnimator.this
                    .mListView
  ...
  private void prepareInsertDelete(
      ArrayList<Integer> insertedItemPositions, ArrayList<Integer> deletingItemPositions) {
    int i;
    int i2;
    int i3;
      ...
      if (child.getHeight() == 0) {
        ...
        if (itemId != -1) {
          this.mOldViewCache.put(
              Long.valueOf(itemId),
              new SemAbsAddDeleteAnimator.ViewInfo(
                  snapshot, position2, 0, child.getTop(), 0, child.getBottom()));
          i2 = i4;
        } else {
    ...
    this.mInsertDeleteRunnable =
        new Runnable() { // from class: com.samsung.android.animation.SemAddDeleteListAnimator.7
          @Override // java.lang.Runnable
          public void run() {
            int width;
            int firstVisiblePos;
            ...
            int newItemsFromTopRemaining = newItemsComingFromTopCount;
            int newlyAppearingViewOldPositionFromBottom =
                lastVisiblePos + 1 + (childCountBefore - childCount);
            int i5 = 0;
            while (i5 < childCount) {
              ...
              if (itemId2 == -1) {
                ...
                if (viewInfo == null) {
                  ...
                  if (viewInfo.top == newY) {
                    ...
                    ObjectAnimator anim2 =
                        SemAddDeleteListAnimator.this.getTranslateAnim(child2, 0.0f, translationY6);
                    animations.add(anim2);
                    headerViewsCount2 = headerViewsCount3;
                ...
                width2 = width;
                Integer startPos =
                    (Integer) upcomingViewsStartCoords.remove(Integer.valueOf(lastVisiblePos3));
                SemAbsAddDeleteAnimator.ViewInfo viewInfo2 =
                    SemAddDeleteListAnimator.this.mOldViewCache.remove(Long.valueOf(itemId2));
                if (viewInfo2 != null) {
                  viewInfo2.recycleBitmap();
                  if (viewInfo2.top == newY) {
                    ...
                    headerViewsCount2 = headerViewsCount5;
                    ObjectAnimator anim3 =
                        SemAddDeleteListAnimator.this.getTranslateAnim(child2, 0.0f, translationY7);
                    animations.add(anim3);
                    adapterCount2 = adapterCount3;
                    newItemsComingFromTop2 = false;
                  ...
                  if (startPos != null) {
                    ...
                    if (insertedItemPosHash.contains(Integer.valueOf(currentPos))) {
                      int shiftCount =
                          SemAddDeleteListAnimator.this.getShiftCount(
                              currentPos, insertedItems, deletedItems);
                      int oldPos = currentPos - shiftCount;
                      ...
                      ObjectAnimator anim5 =
                          SemAddDeleteListAnimator.this.getInsertTranslateAlphaScaleAnim(
                              child2, 0.0f, translationYInsert);
            ...
            while (entrySetIterator.hasNext()) {
              ...
              int newPosition =
                  SemAddDeleteListAnimator.this.getNewPosition(
                      viewInfo3.oldPosition, insertedItems, deletedItems);
              boolean isDeletedItem =
                  deletedItemPosHash.contains(Integer.valueOf(viewInfo3.oldPosition));
              ...
              if (destinationViewIndex < 0) {
                ...
                if (destinationViewIndex >= childCount) {
                  ...
                  translationY =
                      translationY2
                          + (((destinationViewIndex - childCount) + 1) * singleItemHeight);
                } else {
              ...
              if (isDeletedItem) {
                ...
                PropertyValuesHolder pvhBounds =
                    PropertyValuesHolder.ofObject(
                        ...
                        startValue,
                        new Rect(
                            endValue.left + horizOffset,
                            endValue.top + vertOffset,
                            endValue.right - horizOffset,
                            endValue.bottom - vertOffset));
                PropertyValuesHolder pvhAlpha = PropertyValuesHolder.ofInt("alpha", 255, 0);
                anim =
                    ObjectAnimator.ofPropertyValuesHolder(
                        viewInfo3.viewSnapshot, pvhBounds, pvhAlpha);
              } else {
                translationY3 = translationY;
                newItemsComingFromTop = newItemsComingFromTop2;
                anim =
                    ObjectAnimator.ofObject(
                        viewInfo3.viewSnapshot,
                        "bounds",
                        SemAnimatorUtils.BOUNDS_EVALUATOR,
                        startValue,
                        endValue);
            ...
            int left5 = left3;
            for (Map.Entry<Long, SemAbsAddDeleteAnimator.ViewInfo> viewEntry :
                SemAddDeleteListAnimator.this.mOldHeaderFooterViewCache.entrySet()) {
              SemAbsAddDeleteAnimator.ViewInfo viewinfo = viewEntry.getValue();
              ...
              Rect newViewBounds =
                  new Rect(
                      left5, newY2, oldViewBounds.width() + left5, oldViewBounds.height() + newY2);
              SemAddDeleteListAnimator.this.mGhostViewSnapshots.add(viewinfo);
              int left6 = left5;
              ObjectAnimator animBounds =
                  ObjectAnimator.ofObject(
            ...
            animSet.addListener(
                new AnimatorListenerAdapter() { // from class:
                  // com.samsung.android.animation.SemAddDeleteListAnimator.7.1
                  @Override // android.animation.AnimatorListenerAdapter,
                  // android.animation.Animator.AnimatorListener
                  public void onAnimationStart(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationStart #3");
                    if (SemAddDeleteListAnimator.this.mListView.isPressed()) {
                      SemAddDeleteListAnimator.this.mListView.setPressed(false);
                    }
                    SemAddDeleteListAnimator.this.mListView.setEnabled(false);
                  ...
                  // android.animation.Animator.AnimatorListener
                  public void onAnimationEnd(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationEnd #3");
                    SemAddDeleteListAnimator.this.mHandler.removeCallbacks(
                        SemAddDeleteListAnimator.this.mAniTimeoutRunnable);
                    SemAddDeleteListAnimator.this.mGhostViewSnapshots.clear();
                    SemAddDeleteListAnimator.this.mListView.invalidate();
                  ...
                  // android.animation.Animator.AnimatorListener
                  public void onAnimationCancel(Animator animation) {
                    Log.m98i(SemAddDeleteListAnimator.TAG, "onAnimationCancel #3");
                    SemAddDeleteListAnimator.this.mHandler.removeCallbacks(
                        SemAddDeleteListAnimator.this.mAniTimeoutRunnable);
                    SemAddDeleteListAnimator.this.mGhostViewSnapshots.clear();
                    SemAddDeleteListAnimator.this.mListView.invalidate();
            ...
            Log.m98i(
                SemAddDeleteListAnimator.TAG,
                "postDelayed #3 mAniTimeoutRunnable delay = "
                    + (SemAddDeleteListAnimator.this.mTranslationDuration + 100));
            SemAddDeleteListAnimator.this.mHandler.postDelayed(
                SemAddDeleteListAnimator.this.mAniTimeoutRunnable,
                SemAddDeleteListAnimator.this.mTranslationDuration + 100);
  ...
  private void ensureAdapterAndListener() {
    ...
    if (!adapter.hasStableIds()) {
      throw new IllegalStateException(
          "SemAddDeleteListAnimator requires an adapter that has stable ids");
    }
