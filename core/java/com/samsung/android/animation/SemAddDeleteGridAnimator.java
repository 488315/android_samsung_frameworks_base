            ...
            */
            public void run() {
                ...
                if (childCountAfter2 > numColumns) {
                    singleRowHeight = gridView.getChildAt(numColumns).getTop() - gridView.getChildAt(0).getTop();
                } else {
                ...
                while (i4 < childCountAfter2) {
                    ...
                    if (viewInfo != null) {
                        ...
                        if (newItemsFromTopRemaining2 > 0 && singleRowHeight2 != 0) {
                            ...
                            i2 = singleRowHeight2;
                            int oldPosition2 = SemAddDeleteGridAnimator.this.getNextAppearingViewPosition(deletedItemPosHash, lastNewlyAppearingViewPosition2);
                        ...
                        if (childCountAfter2 > refPosForLeftCoordinate) {
                            ...
                            newItemsComingFromTopCount = newItemsComingFromTopCount3;
                            oldX = gridView.getChildAt(0).getLeft() + (gridView.getChildAt(0).getWidth() * refPosForLeftCoordinate);
                        }
                    ...
                    animations.add(SemAddDeleteGridAnimator.this.getTranslateAnim(child2, translationX, translationY));
                    singleRowHeight2 = currentPos;
                    i4 = i3 + 1;
                    newItemsComingFromTopCount2 = newItemsComingFromTopCount;
                }
                ...
                while (entrySetIterator.hasNext()) {
                    ...
                    Rect startValue = new Rect(viewInfo2.left, viewInfo2.top, viewInfo2.right, viewInfo2.bottom);
                    int newPosition = SemAddDeleteGridAnimator.this.getNewPosition(viewInfo2.oldPosition, deletedItems);
                    ...
                    if (destinationViewIndex < 0) {
                        ...
                        if (isDeletedItem) {
                            ...
                            endValue = new Rect(i5, newItemsFromTopRemaining4 + vertOffset, lastNewlyAppearingViewPosition4 - horizOffset, endValue.bottom - vertOffset);
                        }
                ...
                animSet.addListener(new AnimatorListenerAdapter() { // from class: com.samsung.android.animation.SemAddDeleteGridAnimator.2.1
