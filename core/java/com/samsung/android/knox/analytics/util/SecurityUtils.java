...
public class SecurityUtils {
    ...
    public static void enforceCallingPermissionForLog(
        ...
        if (callingPid == Process.myPid()) {
            ...
            if (context.checkCallingOrSelfPermission(Manifest.permission.KNOX_ANALYTICS_INTERNAL)
                            == 0
                    || context.checkCallingOrSelfPermission(Manifest.permission.KNOX_SOLUTION_SDK)
                            == 0) {
                return;
            }
