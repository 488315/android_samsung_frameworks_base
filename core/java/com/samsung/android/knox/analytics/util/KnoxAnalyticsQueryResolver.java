...
public class KnoxAnalyticsQueryResolver {
  ...
  public static long addBulkEvents(Context context, long id, Bundle data, int type) {
    ...
    Bundle result =
        contentResolver.call(
            Contract.CONTENT_URI, Contract.Events.Extra.INSERT_BULK_EVENTS, (String) null, data);
  ...
  public static long getLastEventId(Context context) {
    ...
    try {
      ...
      Log.m287e(
          TAG, "getLastEventId(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
      throw ex;
    }
  }
  ...
  public static long getEventCount(Context context) {
    ...
    try {
      ...
      Log.m287e(
          TAG, "getEventCount(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
      return -1L;
    }
  }
  ...
  public static List<BlacklistedFeature> getFeaturesBlacklist(Context context) {
    ...
    try {
      ...
      Log.m287e(
          TAG,
          "getFeaturesBlacklist(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
      return null;
    }
  }
  ...
  public static long getDatabaseSize(Context context) {
    ...
    try {
      ...
      Log.m287e(
          TAG, "getDatabaseSize(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
      throw ex;
    }
  }
  ...
  public static List<WhitelistedFeature> getFeaturesWhitelist(Context context) {
    ...
    try {
              ...
              WhitelistedFeature feature =
                  new WhitelistedFeature(
                      ...
                      cursor.isNull(columnEnableType)
                          ? null
                          : Integer.valueOf(cursor.getInt(columnEnableType)));
      ...
      Log.m287e(
          TAG,
          "getFeaturesWhitelist(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
  ...
  public static List<String> getB2CFeaturePackageList(Context context) {
    ...
    try {
      ...
      Log.m287e(
          TAG,
          "getB2CFeaturePackages(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
      return Collections.emptyList();
    }
  }
