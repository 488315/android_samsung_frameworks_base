...
public class KnoxAnalyticsQueryResolver {
    ...
    public static long addEvent(Context context, long id, String data, int type) {
        ...
        if (uri == null) {
            Log.m286d(str, "addEvent(): null ret uri");
            return -1L;
        }
        ...
        try {
            ...
            Log.m287e(TAG, "addEvent(): error parsing return id - " + ex.getMessage());
        }
        Log.m286d(TAG, "addEvent(): actualId = " + actualId);
        return actualId;
    }
    ...
    public static long addBulkEvents(Context context, long id, Bundle data, int type) {
        ...
        Log.m286d(str, "addBulkEvents(): lastId = " + lastId);
        return lastId;
    }
                ...
                if (cursor.getCount() > 0) {
                    while (cursor.moveToNext()) {
                        ...
                        try {
                            ...
                            Log.m288e(TAG, "Could not parse JSON. Invalid format", e);
                        }
                        if (event != null) {
                            events.put(event);
                        }
    ...
    public static Bundle performCompressedEventsTransaction(Context ctx, EventList events) {
        ...
        if (result == null) {
            Log.m286d(TAG, "performCompressedEventsTransaction(): null input data");
            return null;
        }
        ...
        extras.putParcelable(Contract.CompressedEvents.Keys.f3016CV, cv);
        ContentResolver contentResolver = ctx.getContentResolver();
    ...
    private static Uri getUriFromType(int type) {
        switch (type) {
            ...
            case 1:
                ...
                return uri2;
            default:
                Log.m287e(TAG, "getUriFromType(): not URI associated with this log type");
                return null;
        }
    }
    ...
    public static long getLastEventId(Context context) {
        ...
        try {
            ...
            Log.m286d(str, "getLastEventId(): empty cursor");
            if (cursor != null) {
                cursor.close();
                return -1L;
            }
            ...
            Log.m287e(TAG, "getLastEventId(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
            throw ex;
        }
    }
    ...
    public static long getEventCount(Context context) {
        ...
        try {
            ...
            Log.m286d(str, "getEventCount(): empty cursor");
            if (cursor != null) {
                cursor.close();
            }
            return -1L;
        } catch (IllegalStateException ex) {
            Log.m287e(TAG, "getEventCount(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
            return -1L;
        }
    }
    ...
    public static List<BlacklistedFeature> getFeaturesBlacklist(Context context) {
        String str = TAG;
        Log.m286d(str, "getFeaturesBlacklist()");
        ContentResolver contentResolver = context.getContentResolver();
        try {
            ...
            Log.m286d(str, "getFeaturesBlacklist(): empty cursor");
            ...
            Log.m287e(TAG, "getFeaturesBlacklist(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
            return null;
        }
    }
    ...
    public static String[] getVersioningBlob(Context context) {
        String str = TAG;
        Log.m286d(str, "getVersioningBlob()");
        ContentResolver contentResolver = context.getContentResolver();
        try {
            ...
            try {
                ...
                if (cursor != null && cursor.getCount() != 0) {
                    if (cursor.moveToLast()) {
                        ...
                        Log.m286d(str, "getVersioningBlob() - id = " + res[0] + ", data = " + res[1]);
                    }
                    if (cursor != null) {
                        cursor.close();
                    }
                ...
                Log.m286d(str, "getVersioningBlob(): empty cursor");
                if (cursor != null) {
                    cursor.close();
                }
                return res;
            ...
            Log.m287e(TAG, "getFeaturesBlacklist(): ERROR READING CONTENT PROVIDER! ");
            return null;
        }
    }
    ...
    public static long addVersioningBlob(Context context, int id, String data, long eventId) {
        ...
        if (ret == null) {
            Log.m286d(str, "addVersioningBlob(): null ret uri");
            return -1L;
        }
        try {
            ...
            Log.m287e(TAG, "addVersioningBlob(): error parsing return id");
            return -1L;
        }
    }
    ...
    public static long getDatabaseSize(Context context) {
        ...
        try {
            ...
            Log.m286d(str, "getDatabaseSize(): empty cursor");
            if (cursor != null) {
                cursor.close();
                return -1L;
            }
            ...
            Log.m287e(TAG, "getDatabaseSize(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
            throw ex;
        }
    }

    public static void callNotifyVersioningCompleted(Context context) {
        Log.m286d(TAG, "callNotifyVersioningCompleted()");
        ContentResolver contentResolver = context.getContentResolver();
    ...
    public static List<WhitelistedFeature> getFeaturesWhitelist(Context context) {
        String str = TAG;
        Log.m286d(str, "getFeaturesWhitelist()");
        ContentResolver contentResolver = context.getContentResolver();
        try {
            ...
            Log.m286d(str, "getFeaturesWhitelist(): empty cursor");
            ...
            Log.m287e(TAG, "getFeaturesWhitelist(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
    ...
    public static List<String> getB2CFeaturePackageList(Context context) {
        String str = TAG;
        Log.m286d(str, "getB2CFeaturePackages()");
        ContentResolver contentResolver = context.getContentResolver();
        try {
            ...
            Log.m286d(str, "getB2CFeaturePackages(): empty cursor");
            ...
            Log.m287e(TAG, "getB2CFeaturePackages(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
            return Collections.emptyList();
        }
    }
    ...
    public static List<String> getB2CFeaturesList(Context context) {
        String str = TAG;
        Log.m286d(str, "getB2CFeatureFeaturesList()");
        ContentResolver contentResolver = context.getContentResolver();
        try {
            Cursor cursor = contentResolver.query(Contract.B2CFeatures.CONTENT_URI, null, null, null);
            if (cursor != null) {
            ...
            Log.m286d(str, "getB2CFeatureFeaturesList(): empty cursor");
            List<String> emptyList = Collections.emptyList();
            if (cursor != null) {
                cursor.close();
            }
            ...
            Log.m287e(TAG, "getB2CFeatureFeaturesList(): ERROR READING CONTENT PROVIDER! " + ex.getLocalizedMessage());
            return Collections.emptyList();
        }
    }
