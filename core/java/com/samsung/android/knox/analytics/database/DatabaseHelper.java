...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.m286d(TAG, String.format("oldVersion=%d, newVersion=%d", Integer.valueOf(oldVersion), Integer.valueOf(newVersion)));
        if (oldVersion < 2) {
    ...
    public Cursor getTotalCompressedEventCursor(String limit) {
        String str = TAG;
        Log.m286d(str, "getTotalCompressedEventCursor(" + limit + NavigationBarInflaterView.KEY_CODE_END);
        SQLiteDatabase db = getReadableDatabase();
    ...
    public void deleteEventsUpToSyntheticId() {
        ...
        if (rows > 1) {
            Log.m286d(TAG, "deleteEventsUpToSyntheticId(): " + rows + " events, up to " + synId + "have been deleted");
            ContentValues cv = new ContentValues();
            cv.put("row_id", "-1");
