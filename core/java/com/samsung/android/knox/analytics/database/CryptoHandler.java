...
class CryptoHandler {
    ...
    private SecretKey getCBCKey() throws KeyStoreException, UnrecoverableEntryException, NoSuchAlgorithmException {
        ...
        if (!ks.containsAlias("synthetic_password_knox.analytics.service.compression.cryptokey")) {
            Log.m286d(TAG, "getCBCKey() - synthetic_password_knox.analytics.service.compression.cryptokey is not on Keystore");
            return null;
        }
        ...
        if (secretKeyEntry == null) {
            Log.m286d(TAG, "getCBCKey() - null synthetic_password_knox.analytics.service.compression.cryptokey");
            return null;
        }
