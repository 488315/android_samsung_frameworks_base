...
public final class DualDarManager {
  ...
  public boolean enableOnDeviceOwner(Bundle params) {
    ...
    if (!isKnoxCore(uid)) {
      Log.m96e(TAG, "enableOnDeviceOwner - Operation not permitted");
      return false;
    }
    if (isOnDeviceOwnerEnabled()) {
      Log.m96e(TAG, "enableOnDeviceOwner - Already enabled");
      return false;
    }
    ...
    Log.m94d(TAG, "enableOnDeviceOwner - result : " + result);
    return result;
  }

  private boolean isKnoxCore(int uid) {
    Log.m94d(TAG, "isKnoxCore - UID : " + uid);
    return uid == 5250;
  }
  ...
  public boolean isInnerLayerUnlocked(int userId) {
    ...
    Log.m94d(TAG, "isInnerLayerUnlocked - userId : " + userId + ", ret : " + result);
    return result;
  }
                  ...
                  .map(
                      new Function() { // from class:
                        ...
                        public final Object apply(Object obj) {
                          return DualDarManager.lambda$isInnerAuthRequired$0(
  ...
  static /* synthetic */ Boolean lambda$isInnerAuthRequired$0(int userId, IDarManagerService s) {
    try {
      ...
      Log.m97e(TAG, "failed to check secondary lock req.", e);
      e.printStackTrace();
      return false;
    }
  }
  ...
  static /* synthetic */ Boolean lambda$setDualDarInfo$1(
    ...
    try {
      ...
      Log.m97e(TAG, "failed to set dualdar info", e);
      e.printStackTrace();
      return false;
    }
  }
  ...
  public void ensureDataUnlockedIfRequired() {
    ...
    Log.m94d(TAG, "ensureDataUnlockedIfRequired - response : " + bResponse);
  }
