...
public class KnoxProxyManager {
  ...
  public Bundle relayMessageSecurely(
      String agentName, String svcName, String command, Bundle args, SecureClient secureClient) {
    try {
      IProxyService service = getService();
      if (service != null) {
        if (args == null) {
  ...
  public synchronized SecureClient initializeSecureSession(
      String initClientAlias, String endClientAgentName, String endClientSvcName) throws Exception {
    ...
    try {
      ...
      Bundle ret =
          relayMessage(endClientAgentName, endClientSvcName, INITIALIZE_SECURE_SESSION, input);
      if (ret != null) {
