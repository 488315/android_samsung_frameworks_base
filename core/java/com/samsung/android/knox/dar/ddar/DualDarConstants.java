...
public interface DualDarConstants {
    ...
    public static final String ACTION_DAR_DUAL_COMPLETED_PROVISIONING_ERROR =
            "com.android.dualdar.completed.error";
    public static final String ACTION_DAR_DUAL_COMPLETED_PROVISIONING_SUCCESS =
            "com.android.dualdar.completed.provisioning_success";
    public static final String ACTION_DAR_DUAL_STARTED_PROVISIONING_CANCELLED =
            "com.android.dualdar.started.cancelled";
    public static final String ACTION_DAR_DUAL_STARTED_PROVISIONING_ERROR =
            "com.android.dualdar.started.error";
    public static final String ACTION_DAR_DUAL_STARTED_PROVISIONING_SUCCESS =
            "com.android.dualdar.started.provisioning_success";
    ...
    public static final String IS_DUAL_DAR_CREATION_CRYPTO_TYPE =
            "IS_DUAL_DAR_CREATION_CRYPTO_TYPE";
    ...
    public static final String IS_DUAL_DAR_PROVISIONED_WITHOUT_LICENSE =
            "IS_DUAL_DAR_PROVISIONED_WITHOUT_LICENSE";
    ...
    public static final String PROP_PERSIST_SYS_DUAL_DAR_INFO_UPDATE =
            "persist.sys.dualdarinfo.update";
