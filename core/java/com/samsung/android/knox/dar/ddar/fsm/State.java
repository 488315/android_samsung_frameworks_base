...
public enum State {
  ...
  static /* synthetic */ class C51421 {
    ...
    static {
      ...
      try {
        $SwitchMap$com$samsung$android$knox$dar$ddar$fsm$State[
                State.DEVICE_UNLOCK_DATA_UNLOCK.ordinal()] =
            2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        $SwitchMap$com$samsung$android$knox$dar$ddar$fsm$State[
                State.DEVICE_LOCK_DATA_UNLOCK.ordinal()] =
            3;
      } catch (NoSuchFieldError e3) {
      }
      try {
        $SwitchMap$com$samsung$android$knox$dar$ddar$fsm$State[
                State.DEVICE_LOCK_DATA_LOCK.ordinal()] =
            4;
      } catch (NoSuchFieldError e4) {
      }
      try {
        $SwitchMap$com$samsung$android$knox$dar$ddar$fsm$State[
                State.DEVICE_UNLOCK_DATA_LOCK.ordinal()] =
            5;
  ...
  public String toString() {
    switch (C51421.$SwitchMap$com$samsung$android$knox$dar$ddar$fsm$State[ordinal()]) {
      case 1:
        return "IDLE";
      case 2:
