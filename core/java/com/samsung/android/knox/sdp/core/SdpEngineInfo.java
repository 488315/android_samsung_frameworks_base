...
public class SdpEngineInfo implements Parcelable {
  ...
  public static final Parcelable.Creator<SdpEngineInfo> CREATOR =
      new Parcelable.Creator<
          SdpEngineInfo>() { // from class: com.samsung.android.knox.sdp.core.SdpEngineInfo.1
  ...
  public SdpEngineInfo(
      String alias, int id, int userId, int state, int flags, int version, boolean isMigrating) {
    int i;
    String str;
