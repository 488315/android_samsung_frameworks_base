...
public class SemClipboardManager {
    ...
    public void filterClip(int type, OnPasteListener listener) {
        if (isEnabled("filterClip") && getSemService() != null) {
            try {
                ...
                Log.m61i(TAG, "updateFilter - Format(" + type + "), " + listener + " by " + this.mContext.getOpPackageName());
            } catch (RemoteException e) {
    ...
    public void dismissDialog() {
        Log.m59d(TAG, "deprecated dismissDialog, calling package : " + this.mContext.getOpPackageName());
    }
    ...
    public boolean paste(String id) {
        Log.m59d(TAG, "deprecated paste(String id), calling package : " + this.mContext.getOpPackageName());
        return false;
    }
