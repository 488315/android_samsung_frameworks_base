...
public class SemImageClipDataProvider extends ContentProvider {
  ...
  static final String CREATE_TABLE =
      " CREATE TABLE ClipboardImageTable (id INTEGER PRIMARY KEY AUTOINCREMENT,  _data TEXT NOT"
          + " NULL);";
  ...
  private static class DBHelper extends SQLiteOpenHelper {
    public DBHelper(Context context) {
      super(
          context, SemImageClipDataProvider.DATABASE_NAME, (SQLiteDatabase.CursorFactory) null, 1);
    }
