...
public class SemSmartClipViewHelper {
  ...
  public static boolean addMetaTag(View view, SemSmartClipMetaTag metaTag) {
    if (view == null || metaTag == null || metaTag.getType() == null) {
      Log.m96e(TAG, "addMetaTag : Have null parameter");
      return false;
    }
    ...
    Log.m96e(TAG, "addMetaTag : Invalid metatag");
    return false;
  }
  ...
  public static int removeMetaTag(View view, String tagType) {
    ...
    if (view == null
        || tagType == null
        || (tagArray = view.semGetSmartClipTags()) == null
        || tagType == null) {
      return 0;
    }
  ...
  public static int extractDefaultSmartClipData(
    ...
    if (view == null) {
      Log.m96e(TAG, "extractDefaultSmartClipData : The view is null!");
      return 0;
    }
