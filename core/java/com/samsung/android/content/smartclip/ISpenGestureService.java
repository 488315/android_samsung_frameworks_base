...
public interface ISpenGestureService extends IInterface {
  ...
  SemSmartClipDataRepository getSmartClipDataByScreenRect(Rect rect, IBinder iBinder, int i, int i2)
  ...
  public static class Default implements ISpenGestureService {
    ...
    @Override // com.samsung.android.content.smartclip.ISpenGestureService
    public void setPenHoverIcon(String pkgName, FileDescriptor fd, float hotspotX, float hotspotY)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 24:
              IBleSpenChargeLockStateChangedListener _arg018 =
                  IBleSpenChargeLockStateChangedListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 31:
              IInputMethodInfoChangeListener _arg024 =
                  IInputMethodInfoChangeListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
