...
class ReflectionUtils {
    ...
    public static void dumpObjectFieldsWithClassTypeFilter(Object objToDump, String objName, int maxDepth, String classTypeFilter) {
        ...
        Log.m96e(TAG, "-------- Field list dump start : " + objToDump.toString() + " / Object type filter : " + classTypeFilter + " ----------");
    ...
    public static void dumpObjectFieldsWithValueFilter(Object objToDump, String objName, int maxDepth, String valueFilter) {
        ArrayList<Object> objList = new ArrayList<>();
        Log.m96e(TAG, "-------- Field list dump start : " + objToDump.toString() + " / Value filter : " + valueFilter + " ----------");
    ...
    */
    protected static void dumpObjectFields(Object objToDump, ArrayList<Object> dumpedObj, String fieldNamePrefix, Field fieldInfo, String fullPath, int depth, int maxDepth, String classTypeFilter, String valueFilter) {
        ...
        if (curObjClass3.isArray()) {
            objectValueStr2 = objectValueStr + " [arraySize = " + getArraySize(objToDump, objectTypeStr) + NavigationBarInflaterView.SIZE_MOD_END;
        } else {
            objectValueStr2 = objectValueStr;
        }
        String indent4 = getIndentString(depth);
        String fieldTypeStr3 = (fieldInfo != null ? fieldInfo.getType().getName() : "").replace("[L", "");
        ...
        if (classTypeFilter != null) {
            ...
            if (!classTypeFilter.equals(objectTypeStr)) {
                ...
                String fullPath3 = fullPath2 + fieldName2 + NavigationBarInflaterView.KEY_CODE_START + extractClassNameFromFullClassPath(objectTypeStr) + NavigationBarInflaterView.KEY_CODE_END;
                if (alreadyDumpedObj) {
                    if (depth + 1 >= maxDepth) {
                        obj = objToDump;
                    } else {
                    ...
                    if (curObjClass3.isArray()) {
                        ...
                        while (i4 < arrayLength && i4 < 100) {
                            ...
                            if (o == null) {
                                ...
                                str2 = str3;
                                fieldName = fieldName2;
                                dumpObjectFields(o, dumpedObj, NavigationBarInflaterView.SIZE_MOD_START + i4 + str3, null, fullPath3, depth + 1, maxDepth, classTypeFilter, valueFilter);
                            }
                            i4 = i3 + 1;
                            ...
                            while (curObjClass != null) {
                                ...
                                while (i5 < length) {
                                    ...
                                    if (!isEnumField) {
                                        ...
                                        i2 = length;
                                        indent = indent6;
                                        dumpObjectFields(fieldObject, dumpedObj, null, field, fullPath3, depth + 1, maxDepth, classTypeFilter, valueFilter);
                                    } else {
                                        i = i5;
                                        i2 = length;
                                        indent = indent6;
        ...
        if (valueFilter == null || valueFilter.equals(objectValueStr2) == z) {
            ...
            if (isPrimitive || fieldTypeStr3.equals(objectTypeStr)) {
                Log.m96e(TAG, indent4 + fieldName2 + " = " + objectValueStr2 + " (" + fieldTypeStr3 + ") : " + fullPath2);
            } else {
                Log.m96e(TAG, indent4 + fieldName2 + " = " + objectValueStr2 + " (" + fieldTypeStr3 + " / " + objectTypeStr + ") : " + fullPath2);
            }
        } else {
            fieldTypeStr = NavigationBarInflaterView.SIZE_MOD_END;
        }
        ...
        String fullPath32 = fullPath2 + fieldName2 + NavigationBarInflaterView.KEY_CODE_START + extractClassNameFromFullClassPath(objectTypeStr) + NavigationBarInflaterView.KEY_CODE_END;
        if (alreadyDumpedObj) {
        }
    }
                                ...
                                try {
                                    ...
                                    if (!haveSameObject) {
                                        try {
                                            ...
                                            i2 = length;
                                            fields = fields2;
                                            Log.m96e(TAG, "Exception occurred in getFieldObjectByObjectType : " + e.toString());
                                            i3 = i + 1;
                                            fields2 = fields;
                                            length = i2;
                                            z = true;
