...
public class PhotoRemasterServiceClient {
                ...
                public void onServiceDisconnected(ComponentName className) {
                    ...
                    if (!PhotoRemasterServiceClient.this.mDisconnectionRequested) {
                        LogUtil.e(
                                ...
                                "Unexpected disconnection with PhotoRemaster Service!"
        ...
        Handler incomingHandler =
                new Handler(
                    ...
                    public void handleMessage(Message msg) {
                        switch (msg.what) {
                            case -1:
                                PhotoRemasterServiceClient.this.mServiceReturnValue.complete(
                                        msg.getData());
                                LogUtil.e(
                                        PhotoRemasterServiceClient.TAG,
        ...
        while (true) {
            try {
                ...
                if (this.mProgressObserver.wasUpdateAndClear()) {
                    LogUtil.i(
                            TAG,
                            "Wait again service return value because there has been update"
                                + " message.");
                } else {
    ...
    public synchronized Bundle callService(final int serviceMessage, final Bundle bundle) {
                        ...
                        new Runnable() { // from class:
                            ...
                            public void run() {
                                try {
                                    ...
                                    msg.setData(bundle);
                                    msg.replyTo =
                                            PhotoRemasterServiceClient.this.mIncomingMessenger;
                                    PhotoRemasterServiceClient.this.mServiceMessenger.send(msg);
                                } catch (RemoteException e) {
                                    if (PhotoRemasterServiceClient.this.mIncomingMessenger
                                                    .getBinder()
                                            == null) {
                                        LogUtil.e(
                                                PhotoRemasterServiceClient.TAG,
                                                "mIncomingMessenger is null!");
                                    }
        ...
        Bundle retBundle =
                serviceMessage == 4 ? getServiceReturnValue(19L) : getServiceReturnValue();
        if (retBundle == null) {
