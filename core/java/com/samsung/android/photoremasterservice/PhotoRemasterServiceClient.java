    ...
    private final ServiceConnection mConnection = new ServiceConnection() { // from class: com.samsung.android.photoremasterservice.PhotoRemasterServiceClient.2
        ...
        public void onServiceDisconnected(ComponentName className) {
            ...
            if (!PhotoRemasterServiceClient.this.mDisconnectionRequested) {
                LogUtil.m292e(PhotoRemasterServiceClient.TAG, "Unexpected disconnection with PhotoRemaster Service! CancellationException will be thrown!");
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case 0:
                        ...
                        break;
                    default:
                        LogUtil.m292e(PhotoRemasterServiceClient.TAG, "Wrong Message is received." + msg.what);
        ...
        while (true) {
            try {
                ...
                if (this.mProgressObserver.wasUpdateAndClear()) {
                    LogUtil.m294i(TAG, "Wait again service return value because there has been update message.");
                } else {
