...
final class MediaDeviceFinderImpl extends MediaDeviceFinder {
  ...
  static class AllShareEventHandlerForMediaDevice extends AllShareEventHandler {
    ...
    public void handleEventMessage(CVMessage cvm) {
      ...
      if (mdfi == null) {
        DLog.w_api(
            MediaDeviceFinderImpl.TAG_CLASS, "mEventHandler.handleEventMessage : mWeakRef is null");
        return;
      }
      try {
        ...
        DLog.w_api(
            MediaDeviceFinderImpl.TAG_CLASS, "mEventHandler.handleEventMessage : Exception", e);
      }
      Device.DeviceType deviceType =
          (Device.DeviceType) MediaDeviceFinderImpl.mDeviceEventToDeviceTypeMap.get(evt_id);
      ...
      if (device == null) {
        DLog.w_api(
            MediaDeviceFinderImpl.TAG_CLASS, "mEventHandler.handleEventMessage : device is null");
        return;
      }
  ...
  public void removeDeviceFromMap(Bundle bundle, Device.DeviceType type) {
    ...
    try {
      switch (C48691.$SwitchMap$com$samsung$android$allshare$Device$DeviceType[type.ordinal()]) {
        case 1:
  ...
  private class SyncActionInvoker {
    ...
    Bundle invoke() {
      ...
      if (MediaDeviceFinderImpl.this.mAllShareConnector == null
          ...
          || (resMessage =
                  MediaDeviceFinderImpl.this.mAllShareConnector.requestCVMSync(this.mMessage))
              == null) {
        return null;
      }
