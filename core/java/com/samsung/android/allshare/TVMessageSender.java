            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case 2:
                        ...
                        if (TVMessageSender.this.mProtocol == 1) {
                            if (TVMessageSender.this.mSocket != null && TVMessageSender.this.mSocket.isConnected()) {
                                TVMessageSender.this.sendMouseProcess(mEventMouse.mType, mEventMouse.f2946mX, mEventMouse.f2947mY, mEventMouse.mDX, mEventMouse.mDY, mEventMouse.mButton);
                                break;
                            } else {
                    ...
                    case 5:
                        ...
                        if (TVMessageSender.this.mProtocol == 1) {
                            if (TVMessageSender.this.mSocket != null && TVMessageSender.this.mSocket.isConnected()) {
                                TVMessageSender.this.sendTouchGuestureEvent2012(mEvent.mType, 10, 0, mEvent.f2948mX, mEvent.f2949mY, mEvent.mDX, mEvent.mDY);
                                break;
                            } else {
                    ...
                    case 6:
                        ...
                        if (TVMessageSender.this.mProtocol == 1) {
                            if (TVMessageSender.this.mSocket != null && TVMessageSender.this.mSocket.isConnected()) {
                                TVMessageSender.this.sendTouchGestureSemanticEvent(mEvent2.mType, mEvent2.mDistance, mEvent2.mDegree, mEvent2.f2948mX, mEvent2.f2949mY);
                                break;
                            } else {
