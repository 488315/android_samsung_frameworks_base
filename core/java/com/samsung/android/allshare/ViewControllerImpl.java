...
final class ViewControllerImpl extends ViewController implements IBundleHolder {
  ...
  private AllShareEventHandler mAllShareEventHandler =
      new AllShareEventHandler(
          ServiceConnector
              .getMainLooper()) { // from class: com.samsung.android.allshare.ViewControllerImpl.1
        ...
        public void handleEventMessage(CVMessage cvm) {
          ...
          DLog.i_api(
              ViewControllerImpl.TAG, "[TVControl] mAllShareEvent : " + strEventID + " " + strXML);
          ...
          if (lastChangeEvent.getPowerOff().equalsIgnoreCase("PowerOFF")
              && ViewControllerImpl.this.mEventListener != null) {
            ViewControllerImpl.this.disconnect();
            ViewControllerImpl.this.mEventListener.onDisconnected(
                ViewControllerImpl.this, ERROR.SUCCESS);
          }
        }
      };
  private IAppControlAPI.IControlEventListener mControlEventListener =
      new IAppControlAPI
          .IControlEventListener() { // from class:
                                     // com.samsung.android.allshare.ViewControllerImpl.2
        @Override // com.samsung.android.allshare.IAppControlAPI.IControlEventListener
        public void controlEvent(EventSync event) {
          Message msg;
          if (ViewControllerImpl.this.mEventHandler != null
              && (msg = ViewControllerImpl.this.mEventHandler.obtainMessage()) != null) {
      ...
      new Handler() { // from class: com.samsung.android.allshare.ViewControllerImpl.3
        ...
        public void handleMessage(Message msg) {
          ...
          switch (msg.what) {
            case 100:
              DLog.i_api(
                  ViewControllerImpl.TAG,
                  "[ViewControl] Event : IAPP_AUTHENTICATION arg : " + msg.arg1);
              if (msg.arg1 == 0) {
                ViewControllerImpl.this.mIsConnected = false;
                if (ViewControllerImpl.this.mResponseListener != null) {
                  ViewControllerImpl.this.mResponseListener.onConnectResponseReceived(
                      ViewControllerImpl.this, ERROR.PERMISSION_NOT_ALLOWED);
                  break;
                }
            ...
            case 101:
              DLog.i_api(
                  ViewControllerImpl.TAG,
                  "[ViewControl] Event : IAPP_AUTHENTICATION_TIMEOUT arg : " + msg.arg1);
              ViewControllerImpl.this.mIsConnected = false;
              if (ViewControllerImpl.this.mResponseListener != null) {
                ViewControllerImpl.this.mResponseListener.onConnectResponseReceived(
                    ViewControllerImpl.this, ERROR.PERMISSION_NOT_ALLOWED);
            ...
            case 300:
              DLog.i_api(
                  ViewControllerImpl.TAG, "[ViewControl] Event : IAPP_EXIT arg : " + msg.arg1);
              ViewControllerImpl.this.mIsConnected = false;
              if (msg.arg1 == 0) {
              ...
              } else if (msg.arg1 == 1 && ViewControllerImpl.this.mEventListener != null) {
                ViewControllerImpl.this.mEventListener.onDisconnected(
                    ViewControllerImpl.this, ERROR.PERMISSION_NOT_ALLOWED);
                break;
              }
            ...
            case 9999:
              ...
              if (ViewControllerImpl.this.mResponseListener != null) {
                ViewControllerImpl.this.mResponseListener.onConnectResponseReceived(
                    ViewControllerImpl.this, ERROR.FAIL);
                break;
              }
              break;
            default:
  ...
  ViewControllerImpl(
      IAllShareConnector connector, DeviceImpl deviceImpl, int tvWidth, int tvHeight) {
    String str;
  ...
  public void connect() {
    ...
    if (!this.mIsConnected) {
      ...
      boolean bRet2 =
          this.mIAppComponent.startControl(this.mMACAddress, this.mIPAddress, this.mDeviceName);
      if (!bRet2) {
        this.mResponseListener.onConnectResponseReceived(this, ERROR.FAIL);
      }
    }
  ...
  public void setViewAngle(int angle) {
    ...
    if (iAllShareConnector != null
        ...
        && this.mIsConnected) {
      this.mIAppComponent.sendMultiTouchEvent(
          37, SContextConstants.ENVIRONMENT_VALUE_UNKNOWN, 0, 0, 0);
      this.mIAppComponent.sendMultiTouchEvent(39, 100.0d, angle, 0, 0);
      this.mIAppComponent.sendMultiTouchEvent(
          38, SContextConstants.ENVIRONMENT_VALUE_UNKNOWN, 0, 0, 0);
    }
  }
  ...
  public void zoom(int cx, int cy, int zoomPercent, int angle) {
    ...
    if (iAllShareConnector != null
        ...
        && this.mIsConnected) {
      this.mIAppComponent.sendMultiTouchEvent(
          37, SContextConstants.ENVIRONMENT_VALUE_UNKNOWN, 0, cx, cy);
      this.mIAppComponent.sendMultiTouchEvent(39, zoomPercent, angle, cx, cy);
      this.mIAppComponent.sendMultiTouchEvent(
          38, SContextConstants.ENVIRONMENT_VALUE_UNKNOWN, 0, cx, cy);
    }
  }
  ...
  private void calcMobileResolution() {
    ...
    this.mMobileWidth = outSize.f85x;
    float f = outSize.f86y;
  ...
  private void calcMargin() {
    if (this.mMobilePhoneRatio >= this.mImageRatio) {
      this.mMarginX =
          (int)
              ((this.mMobileWidth - ((this.mImageWidth * this.mMobileHeight) / this.mImageHeight))
                  / 2.0f);
      this.mMarginY = 0;
    } else {
      this.mMarginX = 0;
      this.mMarginY =
          (int)
              ((this.mMobileHeight - ((this.mImageHeight * this.mMobileWidth) / this.mImageWidth))
                  / 2.0f);
    }
  }
  ...
  public void zoom(int cx, int cy, int zoomPercent, int angle, int sourceWidth, int sourceHeight) {
    ...
    if (((int) this.mImageWidth) != sourceWidth
        || ((int) this.mImageHeight) != sourceHeight
    ...
    if (this.mIsConnected) {
      ...
      DLog.i_api(
          ...
          "[zoom] mMobileWidth : "
              ...
              + this.mMobileHeight
              + " mMobilePhoneRatio : "
              + this.mMobilePhoneRatio
              + " mRelativeZoomRate : "
              + this.mRelativeZoomRate);
  ...
  public void move(int cx, int cy, boolean isReleased) {
    ...
    if (iAllShareConnector == null
        || !iAllShareConnector.isAllShareServiceConnected()
        || !this.mIsConnected
        || (context = ServiceConnector.getContext()) == null) {
      return;
    }
    Display display =
        ((WindowManager) context.getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
    Point outSize = new Point();
    display.getSize(outSize);
    int mobileWidth = outSize.f85x;
    int mobileHeight = outSize.f86y;
  ...
  static class LastChangeEvent {
    ...
    public void parseFromXML(String xml) {
      ...
      if (xml == null || xml.length() <= 0) {
        DLog.w_api(
            ViewControllerImpl.TAG,
            "[ViewControl] LastChangeEvent.parseFromXML() paramter xml is null or empty!");
        return;
      }
      ...
      try {
        ...
        DLog.w_api(
            ViewControllerImpl.TAG,
            "[ViewControl] LastChangeEvent.parseFromXML() exception : " + e.toString());
      } catch (NullPointerException e2) {
      } catch (XmlPullParserException e3) {
        DLog.w_api(
            ViewControllerImpl.TAG,
            "[ViewControl] LastChangeEvent.parseFromXML() exception : " + e3.toString());
      }
    }
  }
