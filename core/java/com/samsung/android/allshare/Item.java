...
public abstract class Item implements Parcelable {
  ...
  public static class LocalContentBuilder {
    ...
    public Item build() {
      ...
      switch (C48631.$SwitchMap$com$samsung$android$allshare$Item$MediaType[type.ordinal()]) {
        case 1:
        case 2:
        case 3:
          return new BuilderGeneratedItem(
  ...
  static class BuilderGeneratedItem extends Item implements IBundleHolder {
    ...
    private BuilderGeneratedItem(
        ...
        ArrayList<Caption> captionList,
        ContentAttributeType contentAttr,
        WebContentBuilder.PlayMode playMode) {
      this.mConType = ItemCreator.ConstructorType.UNKNOWN;
      this.mDeliveryMode = WebContentBuilder.DeliveryMode.UNKNOWN;
      this.mCaptionList = null;
      this.mContentAttribute = null;
    ...
    public Bundle getBundle() {
      ...
      bundle.putString(
          AllShareKey.BUNDLE_STRING_CONTENT_ATTRIBUTE, this.mContentAttribute.enumToString());
    ...
    public ContentBuildType getContentBuildType() {
      switch (C48631.f2950xbd24f7e5[this.mConType.ordinal()]) {
      }
  ...
  static /* synthetic */ class C48631 {
    ...
    static final /* synthetic */ int[] f2950xbd24f7e5;
    ...
    static {
      ...
      try {
        f2950xbd24f7e5[ItemCreator.ConstructorType.MEDIA_SERVER.ordinal()] = 2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        f2950xbd24f7e5[ItemCreator.ConstructorType.WEB_CONTENT.ordinal()] = 3;
      } catch (NoSuchFieldError e3) {
      }
      try {
        f2950xbd24f7e5[ItemCreator.ConstructorType.UNKNOWN.ordinal()] = 4;
  ...
  public static class WebContentBuilder {
    ...
    public Item build() {
      if (this.mUri != null && this.mMimetype != null) {
        ...
        DLog.e_api(
            "Item",
            "build error! scheme == null || scheme.contains(content) || scheme.contains(file)");
        return null;
      }
