...
final class AVPlayerImpl extends AVPlayer implements IBundleHolder, IHandlerHolder {
    ...
    private AllShareEventHandler mEventHandler =
            new AllShareEventHandler(ServiceConnector.getMainLooper()) { // from class:
                // com.samsung.android.allshare.AVPlayerImpl.1
...

                {
                    this.mAVStateMap.put(
                            ...
                            AVPlayer.AVPlayerState.BUFFERING);
                    this.mAVStateMap.put(
                            AllShareEvent.EVENT_RENDERER_STATE_PAUSED,
                            AVPlayer.AVPlayerState.PAUSED);
                    this.mAVStateMap.put(
                            AllShareEvent.EVENT_RENDERER_STATE_STOPPED,
                            AVPlayer.AVPlayerState.STOPPED);
                    this.mAVStateMap.put(
                            AllShareEvent.EVENT_RENDERER_STATE_PLAYING,
                            AVPlayer.AVPlayerState.PLAYING);
                    this.mAVStateMap.put(
                            AllShareEvent.EVENT_RENDERER_STATE_FINISHED,
                            AVPlayer.AVPlayerState.FINISHED);
                    this.mAVStateMap.put(
                ...
                public void handleEventMessage(CVMessage cvm) {
                    try {
                        ...
                        if (state == null) {
                            String eventValue =
                                    resBundle.getString(
                                            AllShareKey.BUNDLE_STRING_EXTENSION_EVENT_KEY);
                        ...
                        if (state.equals(AVPlayer.AVPlayerState.CONTENT_CHANGED)) {
                            ...
                            if (currentTrackUri != null && !currentTrackUri.isEmpty()) {
                                ...
                                if (currentTrackUri.equalsIgnoreCase(
                                ...
                                if (AVPlayerImpl.this.mPlayingContentUris != null
                                    ...
                                    if (isContains(
                                        ...
                                        DLog.i_api(
                                                AVPlayerImpl.TAG_CLASS,
                                                "do not notify CONTENT_CHANGED event, this is my="
                                                        + currentTrackUri);
                                        return;
                                    } else {
                                ...
                                DLog.d_api(
                                        AVPlayerImpl.TAG_CLASS,
                                        "do not notify CONTENT_CHANGED event, mPlayingContentUris"
                                            + " is null");
                                return;
                            }
                            DLog.d_api(
                        ...
                        DLog.w_api(
                                AVPlayerImpl.TAG_CLASS,
                                "handleEventMessage Fail to notify event : Exception");
                    }
                }
                ...
                private void notifyEvent(AVPlayer.AVPlayerState state, ERROR error) {
                    if (AVPlayerImpl.this.mAVPlayerEventListener != null) {
                        try {
                            ...
                            DLog.w_api(
                                    AVPlayerImpl.TAG_CLASS, "mEventHandler.notifyEvent Error", e);
                        }
                    }
                }

                private void notifyExtensionEvent(
                        String eventName, String eventValue, ERROR error) {
                    if (AVPlayerImpl.this.mAVPlayerExtensionEventListener != null) {
                        try {
                            ...
                            DLog.w_api(
                                    AVPlayerImpl.TAG_CLASS,
                                    "mEventExtensionHandler.notifyEvent Error",
                                    e);
                        }
                    }
                }
                ...
                private boolean isContains(
                        String currentTrackUri, ArrayList<String> playingContentUris) {
                ...
                */
                    ...
                    */
                    throw new UnsupportedOperationException(
                            "Method not decompiled:"
                                + " com.samsung.android.allshare.AVPlayerImpl.AnonymousClass2.handleResponseMessage(com.sec.android.allshare.iface.CVMessage):void");
                }
                ...
                private void notifyPlaybackEvent(Bundle resBundle, ERROR error) {
                    ...
                    ContentInfo contentInfo =
                            cb.setStartingPosition(contentInfoStartingPosition).build();
                    Item item = ItemCreator.fromBundle(bundle);
                    String itemConstructor =
                            bundle.getString(AllShareKey.BUNDLE_STRING_ITEM_CONSTRUCTOR_KEY);
                    if (itemConstructor != null
                            && itemConstructor.equals("WEB_CONTENT")
                            && contentInfo != null) {
                        ContentInfo.Builder builder = new ContentInfo.Builder();
                        builder.setStartingPosition(
                                (int) (contentInfo.getStartingPosition() / 1000));
                    ...
                    if (item == null) {
                        ...
                        if (contentInfo == null) {
                            DLog.d_api(
                                    AVPlayerImpl.TAG_CLASS,
                                    "notifyPlaybackEvent : " + item + " = " + error);
                        } else {
                            DLog.d_api(
                                    AVPlayerImpl.TAG_CLASS,
                                    "notifyPlaybackEvent : "
    ...
    AVPlayerImpl(IAllShareConnector connector, DeviceImpl deviceImpl) {
        ...
        this.mSupportMove360View =
                bundle.getBoolean(AllShareKey.BUNDLE_BOOLEAN_SUPPORT_MOVE_360_VIEW);
        this.mSupportZoom360View =
                bundle.getBoolean(AllShareKey.BUNDLE_BOOLEAN_SUPPORT_ZOOM_360_VIEW);
        ...
        if (constructorKey.equals("LOCAL_CONTENT")) {
            ...
            if (scheme != null && scheme.contains("file")) {
                ...
                if (filePath == null) {
                    ...
                    if (contentInfo != null) {
                        DLog.i_api(
                                TAG_CLASS, "play position - " + contentInfo.getStartingPosition());
                    }
    ...
    public void prepare(Item item) {
        ...
        DLog.i_api(
                TAG_CLASS,
                "prepare : " + item.getTitle() + " to " + getName() + "uri : " + item.getURI());
    }
    ...
    public void stop() {
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlaybackResponseListener != null) {
                this.mAVPlaybackResponseListener.onStopResponseReceived(
    ...
    public void seek(long p) {
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlaybackResponseListener != null) {
                this.mAVPlaybackResponseListener.onSeekResponseReceived(
                        p, ERROR.SERVICE_NOT_CONNECTED);
                return;
            }
            return;
        }
    ...
    public void pause() {
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlaybackResponseListener != null) {
                this.mAVPlaybackResponseListener.onPauseResponseReceived(
                        ERROR.SERVICE_NOT_CONNECTED);
                return;
            }
            return;
    ...
    public void resume() {
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlaybackResponseListener != null) {
                this.mAVPlaybackResponseListener.onResumeResponseReceived(
                        ERROR.SERVICE_NOT_CONNECTED);
                return;
            }
            return;
    ...
    public void setVolume(int level) {
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlayerVolumeResponseListener != null) {
                this.mAVPlayerVolumeResponseListener.onSetVolumeResponseReceived(
    ...
    public void getPlayPosition() {
        if (this.mAllShareConnector == null
                || !this.mAllShareConnector.isAllShareServiceConnected()) {
            if (this.mAVPlaybackResponseListener != null) {
                this.mAVPlaybackResponseListener.onGetPlayPositionResponseReceived(
    ...
    private void playLocalContent(Uri uri, Item item, ContentInfo contentInfo, String mimeType) {
        playUri(
                ...
                contentInfo,
                mimeType,
                AllShareAction.ACTION_AV_PLAYER_PLAY_LOCAL_CONTENS_URI);
    }
    ...
    public void getMediaInfo() {
        if (this.mAllShareConnector == null
                || !this.mAllShareConnector.isAllShareServiceConnected()) {
            if (this.mAVPlaybackResponseListener != null) {
                this.mAVPlaybackResponseListener.onGetMediaInfoResponseReceived(
    ...
    public boolean isSupportDynamicBuffering() {
        ...
        try {
            boolean result =
                    res_bundle.getBoolean(AllShareKey.BUNDLE_BOOLEAN_SUPPORT_DYNAMIC_BUFFERING);
            return result;
        } catch (Exception e) {
    ...
    public void setAspectRatio(String aspectRatio) {
        ...
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlayerExtensionResponseListener != null) {
                this.mAVPlayerExtensionResponseListener.onSetAspectRatioResponseReceived(
                        ERROR.SERVICE_NOT_CONNECTED);
                return;
            }
            return;
    ...
    public void move360View(float latitudeOffset, float longitudeOffset) {
        ...
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlayerExtensionResponseListener != null) {
                this.mAVPlayerExtensionResponseListener.onMove360ViewResponseReceived(
                        ERROR.SERVICE_NOT_CONNECTED);
                return;
            }
            return;
    ...
    public void zoom360View(float ScaleFactor) {
        ...
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlayerExtensionResponseListener != null) {
                this.mAVPlayerExtensionResponseListener.onZoom360ViewResponseReceived(
                        ERROR.SERVICE_NOT_CONNECTED);
                return;
            }
            return;
    ...
    public void reset360View() {
        ...
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlayerExtensionResponseListener != null) {
                this.mAVPlayerExtensionResponseListener.onReset360ViewResponseReceived(
                        ERROR.SERVICE_NOT_CONNECTED);
                return;
            }
            return;
    ...
    public void controlCaption(Caption.CaptionOperation operation, Caption caption) {
        if (this.mAllShareConnector == null
            ...
            if (this.mAVPlayerExtensionResponseListener != null) {
                this.mAVPlayerExtensionResponseListener.onControlCaptionResponseReceived(
                        ERROR.SERVICE_NOT_CONNECTED);
                return;
            }
            return;
