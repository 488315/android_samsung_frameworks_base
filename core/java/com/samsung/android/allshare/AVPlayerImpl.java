        ...
        */
        public void handleResponseMessage(CVMessage cvm) {
            ...
            if (AVPlayerImpl.this.mAVPlaybackResponseListener != null) {
                switch (actionID) {
                    ...
                    case "com.sec.android.allshare.action.ACTION_AV_PLAYER_SEEK":
                        ...
                        AVPlayerImpl.this.mAVPlaybackResponseListener.onSeekResponseReceived(position, error);
                        break;
                    ...
                    case "com.sec.android.allshare.action.ACTION_AV_PLAYER_REQUEST_PLAY_POSITION":
                        ...
                        AVPlayerImpl.this.mAVPlaybackResponseListener.onGetPlayPositionResponseReceived(position2, error);
                        break;
                    case "com.sec.android.allshare.action.ACTION_AV_PLAYER_REQUEST_GET_MEDIA_INFO":
                        ...
                        AVPlayerImpl.this.mAVPlaybackResponseListener.onGetMediaInfoResponseReceived(mediaInfo, error);
                        break;
                    case "com.sec.android.allshare.action.ACTION_AV_PLAYER_REQUEST_GET_PLAYER_STATE":
                        ...
                        AVPlayerImpl.this.mAVPlaybackResponseListener.onGetStateResponseReceived(playerState, error);
                        break;
                }
            }
            if (AVPlayerImpl.this.mAVPlayerVolumeResponseListener != null) {
                switch (actionID) {
                    case "com.sec.android.allshare.action.ACTION_AV_PLAYER_REQUEST_GET_VOLUME":
                        ...
                        AVPlayerImpl.this.mAVPlayerVolumeResponseListener.onGetVolumeResponseReceived(level, error);
                        break;
                    case "com.sec.android.allshare.action.ACTION_AV_PLAYER_REQUEST_SET_VOLUME":
                        ...
                        AVPlayerImpl.this.mAVPlayerVolumeResponseListener.onSetVolumeResponseReceived(level2, error);
                        break;
                    case "com.sec.android.allshare.action.ACTION_AV_PLAYER_REQUEST_GET_MUTE":
                        ...
                        AVPlayerImpl.this.mAVPlayerVolumeResponseListener.onGetMuteResponseReceived(onoff, error);
                        break;
                    case "com.sec.android.allshare.action.ACTION_AV_PLAYER_REQUEST_SET_MUTE":
                        ...
                        AVPlayerImpl.this.mAVPlayerVolumeResponseListener.onSetMuteResponseReceived(onoff2, error);
                        break;
                }
            }
            if (AVPlayerImpl.this.mAVPlayerExtensionResponseListener != null) {
                ...
                switch (c) {
                    case 0:
                        AVPlayerImpl.this.mAVPlayerExtensionResponseListener.onSetAspectRatioResponseReceived(error);
                        break;
                    case 1:
                        String aspectRatio = resBundle.getString(AllShareKey.BUNDLE_STRING_ASPECT_RATIO);
                        DLog.i_api(AVPlayerImpl.TAG_CLASS, "ACTION_AV_PLAYER_GET_ASPECT_RATIO : " + aspectRatio);
                        AVPlayerImpl.this.mAVPlayerExtensionResponseListener.onAspectRatioStateResponseReceived(aspectRatio, error);
                        break;
                    case 2:
                        AVPlayerImpl.this.mAVPlayerExtensionResponseListener.onMove360ViewResponseReceived(error);
                        break;
                    case 3:
                        AVPlayerImpl.this.mAVPlayerExtensionResponseListener.onZoom360ViewResponseReceived(error);
                        break;
                    case 4:
                        AVPlayerImpl.this.mAVPlayerExtensionResponseListener.onReset360ViewResponseReceived(error);
                        break;
                    case 5:
                        AVPlayerImpl.this.mAVPlayerExtensionResponseListener.onControlCaptionResponseReceived(error);
                        break;
                    case 6:
                        String captions = resBundle.getString(AllShareKey.BUNDLE_STRING_CAPTION_CAPTIONS);
                        String enabledCaptions = resBundle.getString(AllShareKey.BUNDLE_STRING_CAPTION_ENABLEDCAPTIONS);
                        ...
                        if (tempCaptionsList != null) {
                            for (Caption caption : tempCaptionsList) {
                                String captionUri = AVPlayerImpl.this.getCaptionFilePathFromURI(caption.getCaptionUri());
                        ...
                        if (tempEnabledCaptionsList != null) {
                            for (Caption caption2 : tempEnabledCaptionsList) {
                                String captionUri2 = AVPlayerImpl.this.getCaptionFilePathFromURI(caption2.getCaptionUri());
                        ...
                        AVPlayerImpl.this.mAVPlayerExtensionResponseListener.onCaptionStateResponseReceived(captionsList, enabledCaptionsList, error);
                        break;
                }
            }
            if (AVPlayerImpl.this.mAVPlayerWHAResponseListener != null) {
                switch (actionID) {
                    case "com.sec.android.allshare.action.ACTION_WHA_GET_DEVICE_STATUS_INFO":
                        ...
                        AVPlayerImpl.this.mAVPlayerWHAResponseListener.onGetWHADeviceStatusInfo(whaDeviceInfo, error);
                        break;
