...
public class ServiceConnector {
  ...
  public static ERROR createServiceProvider(Context ctx, IServiceConnectEventListener l) {
    ...
    if (ctx == null || l == null) {
      DLog.w_api(
          TAG_CONNECTOR, "Context or ServiceConnectEventListener is null : " + ctx + " || " + l);
    ...
    Handler.Callback callback =
        new Handler.Callback(
            ctx, connector) { // from class: com.samsung.android.allshare.ServiceConnector.1
          ...
          public boolean handleMessage(Message msg) {
            ...
            switch (C48833.f2953xc58fd1b4[state.ordinal()]) {
              case 1:
  ...
  static /* synthetic */ class C48833 {

    /* renamed from: $SwitchMap$com$samsung$android$allshare$IAllShareConnector$AllShareServiceState */
    static final /* synthetic */ int[] f2953xc58fd1b4;
    ...
    static {
      ...
      try {
        f2953xc58fd1b4[
                IAllShareConnector.AllShareServiceState.ALLSHARE_SERVICE_DISCONNECTED.ordinal()] =
            2;
  ...
  public static ERROR createServiceProvider(
      Context ctx, IServiceConnectEventListener l, String serviceType) {
    ...
    if (floatingFeature != null) {
      DLog.i_api(
          TAG_CONNECTOR,
          "ALLSHARE_CONFIG : "
              + floatingFeature.getString("SEC_FLOATING_FEATURE_ALLSHARE_CONFIG_VERSION"));
    }
    DLog.setAPIVersionTag();
    mContextRef = new WeakReference<>(ctx);
    AllShareConnector connector = new AllShareConnector(ctx, null);
    Handler.Callback callback =
        new Handler.Callback(
            ctx,
            connector,
            serviceType) { // from class: com.samsung.android.allshare.ServiceConnector.2
          private IServiceConnectEventListener mListener;
          ...
          private ServiceProvider createServiceProvierImpl(
            ...
            if (serviceType2 != null && serviceType2.equals(ServiceProvider.SERVICE_FILE)) {
              connector2.setProfileConstData(
                  new ProfileConstData(com.samsung.android.allshare.file.Const.SERVICE_PACKAGE));
  ...
  private static class ServiceProviderImpl extends ServiceProvider
    ...
    public String getServiceVersion() {
      ...
      if (allShareConnector == null) {
        DLog.w_api(
            "ServiceProviderImpl", "Connection FAIL: AllShare Service Connector does not exist");
        return "";
      }
  ...
  private static class MediaServiceProviderImpl extends MediaServiceProvider
    ...
    public void setServiceState(ServiceState serviceState) {
      ...
      if (ServiceState.DISABLED == serviceState
          && (mediaDeviceFinderImpl = this.mMediaDeviceFinder) != null) {
  ...
  private static class FileServiceProviderImpl extends FileServiceProvider
      implements IServiceStateSetter, IServiceConnectorGetter {
    ...
    @Override // com.samsung.android.allshare.file.FileServiceProvider,
              // com.samsung.android.allshare.ServiceProvider
    ...
    public String getServiceVersion() {
      ...
      if (allShareConnector == null) {
        DLog.w_api(
            "FileServiceProviderImpl",
            "Connection FAIL: AllShare File Service Connector does not exist");
        return "";
      }
      return allShareConnector.getServiceVersion();
    }
  ...
  static class ProfileConstData {
    ...
    public ProfileConstData(String serviceType) {
      ...
      if (serviceType != null
          && serviceType.equals(com.samsung.android.allshare.file.Const.SERVICE_PACKAGE)) {
        this.ALLSHARE_FRAMEWORK_VERSION = 1L;
        ...
        this.SERVICE_MANAGER_NAME_VERSION_1 =
            com.samsung.android.allshare.file.Const.SERVICE_MANAGER_NAME_VERSION_1;
        this.SUBSCRIBER_FIELD = "com.sec.android.allshare.iface.subscriber";
  ...
  private static final class AllShareConnector implements IAllShareConnector {
        ...
        new ServiceConnection() { // from class:
          ...
          public void onServiceConnected(ComponentName component, IBinder binder) {
            DLog.i_api(
                ...
                "Subscriber onServiceConnected to " + AllShareConnector.this.mSubscriberTag);
          ...
          public void onServiceDisconnected(ComponentName component) {
            DLog.i_api(
                AllShareConnector.TAG,
                "Subscriber onServiceDisconnected from " + AllShareConnector.this.mSubscriberTag);
        ...
        new BroadcastReceiver() { // from class:
          ...
          public void onReceive(Context context, Intent intent) {
            ...
            if (action == null) {
              DLog.w_api(
                  AllShareConnector.TAG,
                  AllShareConnector.this.mSubscriberTag + " : intent.getAction() == null!");
              return;
            }
    ...
    public synchronized void connect() {
      ...
      if (isAllShareServiceConnected()) {
        DLog.i_api(
            TAG, this.mSubscriberTag + " is Already connected to AllShare service framework");
        return;
      }
    ...
    private boolean bindAllShareService() {
      ...
      } else if (this.mConstData.SUBSCRIPTION_MESSAGE.startsWith(
          com.samsung.android.allshare.file.Const.SERVICE_PACKAGE)) {
      ...
      if (!bindResult) {
        ...
        DLog.e_api(
            TAG,
            this.mSubscriberTag
                + " : bindAllShareService FAIL - check if app use ApplicationContext or not");
        return false;
      }
      return true;
    }
    ...
    private void unregisterSvcCastReceiver() {
      try {
        ...
        if (context == null) {
          DLog.w_api(
              TAG, this.mSubscriberTag + " unregisterSvcCastReceiver error - context is null");
        } else {
    ...
    private boolean startAllShareLauncher() {
      ...
      } else if (this.mConstData.START_SERVICE.startsWith(
          com.samsung.android.allshare.file.Const.SERVICE_PACKAGE)) {
      ...
      try {
        ...
        DLog.w_api(
            TAG, this.mSubscriberTag + " startAllShareLauncher error...SecurityException ", e);
        return false;
      } catch (Exception e2) {
    ...
    public long requestCVMAsync(CVMessage cvm, AllShareResponseHandler handler) {
      ...
      try {
        if (!this.mISubscriber.requestCVAsync(this.mID, cvm)) {
          DLog.d_api(
              TAG, this.mSubscriberTag + " requestCVMAsync fail...Maybe Invalid Action Request");
          return -1L;
        }
        return req_id;
