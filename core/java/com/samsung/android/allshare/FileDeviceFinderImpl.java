...
final class FileDeviceFinderImpl extends FileDeviceFinder {
  ...
  private AllShareEventHandler mEventHandler =
      new AllShareEventHandler(
          ServiceConnector
              .getMainLooper()) { // from class: com.samsung.android.allshare.FileDeviceFinderImpl.1
        ...
        public void handleEventMessage(CVMessage cvm) {
          ...
          try {
            listener =
                (DeviceFinder.IDeviceFinderEventListener)
                    FileDeviceFinderImpl.this.mDiscoveryListenerMap.get(evt_id);
          } catch (Exception e) {
            DLog.w_api(
                FileDeviceFinderImpl.TAG_CLASS, "mEventHandler.handleEventMessage : Exception", e);
          }
          Device.DeviceType deviceType =
              (Device.DeviceType) FileDeviceFinderImpl.mDeviceEventToDeviceTypeMap.get(evt_id);
          ...
          if (deviceBundle == null) {
            DLog.w_api(
                FileDeviceFinderImpl.TAG_CLASS,
  ...
  FileDeviceFinderImpl(IAllShareConnector connector) {
  ...
  public void removeDeviceFromMap(Bundle bundle, Device.DeviceType type) {
    ...
    try {
      switch (C48492.$SwitchMap$com$samsung$android$allshare$Device$DeviceType[type.ordinal()]) {
        case 1:
  ...
  private class SyncActionInvoker {
    ...
    Bundle invoke() {
      ...
      if (FileDeviceFinderImpl.this.mAllShareConnector == null
          || !FileDeviceFinderImpl.this.mAllShareConnector.isAllShareServiceConnected()
          || (resMessage =
                  FileDeviceFinderImpl.this.mAllShareConnector.requestCVMSync(this.mMessage))
              == null) {
        return null;
      }
