...
final class ScreenSharingDeviceImpl extends ScreenSharingDevice
                ...
                new AllShareEventHandler(
                    ...
                    public void handleEventMessage(CVMessage cvm) {
                        ...
                        try {
                            ...
                            ERROR error2 =
                                    ERROR.stringToEnum(resBundle.getString("BUNDLE_ENUM_ERROR"));
                            if (error2 == null) {
                                error2 = ERROR.FAIL;
                            }
                            ScreenSharingDeviceImpl.this.mUPnPDeviceEventListener.onEventReceived(
                                    "", "", error2);
                        } catch (Error err) {
                            DLog.w_api(
                    ...
                    public void handleResponseMessage(CVMessage cvm) {
                        ...
                        try {
                            if (ScreenSharingDeviceImpl.this.mActionResponseListener != null) {
                                if (actionID.equals(
                                        AllShareAction.ACTION_CONNECT_SCREENSHARING_MOBILE_TO_TV)) {
                                    if (err.equals(ERROR.SUCCESS)) {
                                        String tBSSID =
                                                resBundle.getString(
                                                        AllShareKey
                                                                .BUNDLE_STRING_SCREENSHARING_TV_BSSID);
                                        String tWlanFreq =
                                                resBundle.getString(
                                                        AllShareKey
                                                                .BUNDLE_STRING_SCREENSHARING_TV_WLANFREQ);
                                        String tListenFreq =
                                                resBundle.getString(
                                                        AllShareKey
                                                                .BUNDLE_STRING_SCREENSHARING_TV_LISTENFREQ);
                                        DLog.w_api(
                                                ScreenSharingDeviceImpl.TAG_CLASS,
                                                "handleResponseMessage : actionID"
                                                    + " :ACTION_CONNECT_SCREENSHARING_MOBILE_TO_TV"
                                                    + " response SUCCESS");
                                        ScreenSharingDeviceImpl.this.mActionResponseListener
                                                .onConnectScreenSharingM2TV(
                                                        tBSSID, tWlanFreq, tListenFreq);
                                    }
                                } else if (actionID.equals(
                                                AllShareAction
                                                        .ACTION_CONNECT_SCREENSHARING_TV_TO_MOBILE)
                                    ...
                                    String tWFDSourcePort =
                                            resBundle.getString(
                                                    AllShareKey
                                                            .BUNDLE_STRING_SCREENSHARING_TV_WFDSOURCEPORT);
                                    DLog.w_api(
                                            ScreenSharingDeviceImpl.TAG_CLASS,
                                            "handleResponseMessage : actionID"
                                                + " :ACTION_CONNECT_SCREENSHARING_TV_TO_MOBILE"
    ...
    @Override // com.samsung.android.allshare.ScreenSharingDevice,
              // com.samsung.android.allshare.Device
    ...
    public void connectScreenSharingM2TV(
        ...
        if (mWlanMacAddress == null
            ...
            DLog.w_api(
                    TAG_CLASS,
                    "connectScreenSharingM2TV Fail :  Address is null or port is wrong ");
            return;
        }
        ...
        bundle.putString(
                AllShareKey.BUNDLE_STRING_SCREENSHARING_MOBILE_BLUETOOTHMACADDRESS,
    ...
    public void connectScreenSharingTV2M(
        ...
        if (mWlanMacAddress == null || mP2pDeviceAddress == null || mBluetoothMacAddress == null) {
            DLog.w_api(
                    TAG_CLASS,
                    "connectScreenSharingTV2M Fail :  Address is null or port is wrong ");
            return;
        }
        CVMessage cvm = new CVMessage();
