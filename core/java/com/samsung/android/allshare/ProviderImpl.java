...
final class ProviderImpl extends Provider implements IBundleHolder, IHandlerHolder {
  ...
  private AllShareEventHandler mEventHandler =
      new AllShareEventHandler(
          ServiceConnector
              .getMainLooper()) { // from class: com.samsung.android.allshare.ProviderImpl.1
  ...
  private AllShareResponseHandler mAllShareRespHandler =
      new AllShareResponseHandler(
          ServiceConnector
              .getMainLooper()) { // from class: com.samsung.android.allshare.ProviderImpl.2
        ...
        public void handleResponseMessage(CVMessage cvm) {
          ...
          ArrayList<Bundle> itemImpleList =
              resBundle.getParcelableArrayList(
                  AllShareKey.BUNDLE_PARCELABLE_ARRAYLIST_CONTENT_BUNDLE);
          ArrayList<Bundle> itemImpleList2 =
              itemImpleList == null ? new ArrayList<>() : itemImpleList;
          ...
          ArrayList<String> itemTypeStrList =
              resBundle.getStringArrayList(AllShareKey.BUNDLE_STRING_ITEM_TYPE_ARRAYLIST);
          ...
          while (it.hasNext()) {
            ...
            if (type != null) {
              switch (C48753.$SwitchMap$com$samsung$android$allshare$Item$MediaType[
                  type.ordinal()]) {
                case 1:
          ...
          if (!actionID.equals(AllShareAction.ACTION_PROVIDER_REQUEST_SEARCH_CRITERIA_ITEMS)) {
            if (actionID.equals(AllShareAction.ACTION_PROVIDER_REQUEST_BROWSE_ITEMS)) {
              Bundle bundleFolder =
                  (Bundle) resBundle.getParcelable(AllShareKey.BUNDLE_PARCELABLE_FOLDERITEM);
              ...
              try {
                ProviderImpl.this.mBrowseResponseListener.onBrowseResponseReceived(
                    itemList,
                    requestedStartIndex,
                    reqeustedCount,
                    requestedFolderItem,
                ...
                err = e3;
                DLog.w_api(
                    ProviderImpl.TAG_CLASS,
                    "mAllShareRespHandler.handleResponseMessage Error",
                    err);
                return;
              } catch (Exception e4) {
                e = e4;
                DLog.w_api(
                    ProviderImpl.TAG_CLASS,
                    "mAllShareRespHandler.handleResponseMessage Exception",
                    e);
                return;
              }
            }
          ...
          try {
            ...
            try {
              ...
              iProviderSearchResponseListener = ProviderImpl.this.mSearchResponseListener;
              searchString = ProviderImpl.TAG_CLASS;
              str = "mAllShareRespHandler.handleResponseMessage Exception";
              str2 = "mAllShareRespHandler.handleResponseMessage Error";
            } catch (Error e9) {
          ...
          try {
            iProviderSearchResponseListener.onSearchResponseReceived(
                itemList, requestedStartIndex, reqeustedCount, criteria, endOfItem, error);
          } catch (Error e13) {
            err = e13;
            DLog.w_api(searchString, str2, err);
          } catch (Exception e14) {
  ...
  ProviderImpl(IAllShareConnector connector, DeviceImpl deviceImpl) {
    ...
    Boolean isReceiverable =
        Boolean.valueOf(bundle.getBoolean(AllShareKey.BUNDLE_BOOLEAN_RECEIVERABLE));
  ...
  static /* synthetic */ class C48753 {
    ...
    static {
      ...
      try {
        $SwitchMap$com$samsung$android$allshare$Item$MediaType[
                Item.MediaType.ITEM_IMAGE.ordinal()] =
            2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        $SwitchMap$com$samsung$android$allshare$Item$MediaType[
                Item.MediaType.ITEM_VIDEO.ordinal()] =
            3;
      } catch (NoSuchFieldError e3) {
      }
      try {
        $SwitchMap$com$samsung$android$allshare$Item$MediaType[
                Item.MediaType.ITEM_FOLDER.ordinal()] =
            4;
      } catch (NoSuchFieldError e4) {
      }
      try {
        $SwitchMap$com$samsung$android$allshare$Item$MediaType[
                Item.MediaType.ITEM_UNKNOWN.ordinal()] =
            5;
  ...
  public void browse(Item item, int startIndex, int requestCount) {
    ...
    if (iAllShareConnector == null || !iAllShareConnector.isAllShareServiceConnected()) {
      ...
      Provider.IProviderBrowseResponseListener iProviderBrowseResponseListener =
          this.mBrowseResponseListener;
      if (iProviderBrowseResponseListener != null) {
        iProviderBrowseResponseListener.onBrowseResponseReceived(
            new ArrayList<>(), -1, -1, null, false, ERROR.SERVICE_NOT_CONNECTED);
        return;
      }
      return;
    }
    if (item == 0 || startIndex == -1 || requestCount <= 0) {
      ...
      if (iProviderBrowseResponseListener2 != null) {
        iProviderBrowseResponseListener2.onBrowseResponseReceived(
            new ArrayList<>(), startIndex, requestCount, item, false, ERROR.INVALID_ARGUMENT);
        return;
      }
      return;
    }
    if (!item.getType().equals(Item.MediaType.ITEM_FOLDER)) {
      DLog.i_api(TAG_CLASS, "browse fail : INVALID_ARGUMENT");
      Provider.IProviderBrowseResponseListener iProviderBrowseResponseListener3 =
          this.mBrowseResponseListener;
      if (iProviderBrowseResponseListener3 != null) {
        iProviderBrowseResponseListener3.onBrowseResponseReceived(
            new ArrayList<>(), startIndex, requestCount, item, false, ERROR.INVALID_ARGUMENT);
        return;
      }
      return;
    ...
    DLog.i_api(
        TAG_CLASS, "browse " + getName() + ", index: " + startIndex + ", count: " + requestCount);
  ...
  public void search(SearchCriteria searchCriteria, int startIndex, int requestCount) {
    ...
    if (iAllShareConnector == null || !iAllShareConnector.isAllShareServiceConnected()) {
      ...
      Provider.IProviderSearchResponseListener iProviderSearchResponseListener =
          this.mSearchResponseListener;
      if (iProviderSearchResponseListener != null) {
        iProviderSearchResponseListener.onSearchResponseReceived(
            new ArrayList<>(), -1, -1, searchCriteria, false, ERROR.SERVICE_NOT_CONNECTED);
        return;
      }
      return;
    }
    if (searchCriteria == null) {
      ...
      if (iProviderSearchResponseListener2 != null) {
        iProviderSearchResponseListener2.onSearchResponseReceived(
            new ArrayList<>(),
            startIndex,
            requestCount,
            searchCriteria,
    ...
    if (startIndex == -1 || requestCount <= 0) {
      ...
      Provider.IProviderSearchResponseListener iProviderSearchResponseListener3 =
          this.mSearchResponseListener;
      if (iProviderSearchResponseListener3 != null) {
        iProviderSearchResponseListener3.onSearchResponseReceived(
            new ArrayList<>(),
            startIndex,
            requestCount,
            searchCriteria,
    ...
    if (searchCriteria.isMatchedItemType(Item.MediaType.ITEM_UNKNOWN)) {
      ...
      Provider.IProviderSearchResponseListener iProviderSearchResponseListener4 =
          this.mSearchResponseListener;
      if (iProviderSearchResponseListener4 != null) {
        iProviderSearchResponseListener4.onSearchResponseReceived(
            new ArrayList<>(),
            startIndex,
            requestCount,
            searchCriteria,
    ...
    DLog.i_api(
        TAG_CLASS, "search " + getName() + ", index: " + startIndex + ", count: " + requestCount);
    req_msg.setBundle(req_bundle);
    ...
    if (-1 == retVal) {
      ...
      Provider.IProviderSearchResponseListener iProviderSearchResponseListener5 =
          this.mSearchResponseListener;
      if (iProviderSearchResponseListener5 != null) {
        iProviderSearchResponseListener5.onSearchResponseReceived(
            new ArrayList<>(), startIndex, requestCount, searchCriteria, false, ERROR.FAIL);
      }
    }
  }
