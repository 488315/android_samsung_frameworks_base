  ...
  private class FlatProviderConnectionInfo implements FlatProvider.IFlatProviderConnection {
    ...
    public boolean isCurrentSearchRequest(SearchCriteria criteria, int startIndex) {
      return criteria != null
          && criteria.equals(this.mCurrentSearchCriteria)
          && this.mStartIndex == startIndex;
    }
  }
    ...
    provider.setSearchResponseListener(
        new Provider
            .IProviderSearchResponseListener() { // from class:
                                                 // com.samsung.android.allshare.extension.impl.SearchMediaGetter.1
              ...
              if (searchCriteria == null) {
                ...
                if (err4.compareTo(ERROR.SUCCESS) != 0) {
                  ...
                  if (endOfItems) {
                    ...
                    conn.setCurrentSearchRequest(
                        searchCriteria, requestedStartIndex + returnedCount);
                    SearchMediaGetter.this.mProvider.search(
