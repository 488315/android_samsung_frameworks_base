...
final class SlideShowPlayerImpl extends SlideShowPlayer implements IBundleHolder {
  ...
  AllShareResponseHandler mResponseHandler =
      new AllShareResponseHandler(
          ServiceConnector
              .getMainLooper()) { // from class: com.samsung.android.allshare.SlideShowPlayerImpl.1
        ...
        public void handleResponseMessage(CVMessage cvm) {
          ...
          if (actionID.equals(AllShareAction.ACTION_SLIDESHOW_PLAYER_SETLIST)) {
            String albumTitle =
                resBundle.getString(AllShareKey.BUNDLE_STRING_SLIDESHOW_ALBUM_TITLE);
            ArrayList<Bundle> slideUriList =
                resBundle.getParcelableArrayList(
                    AllShareKey.BUNDLE_PARCELABLE_ARRAYLIST_SLIDESHOW_IMAGE_CONTENT_URI);
            ...
            if (SlideShowPlayerImpl.this.mResponseListener != null) {
              SlideShowPlayerImpl.this.mResponseListener.onSetListResponseReceived(
                  albumTitle, itemList, error);
              return;
            }
            return;
          }
          if (actionID.equals(AllShareAction.ACTION_SLIDESHOW_PLAYER_SETBGMLIST)) {
            ArrayList<Bundle> bgmUriList =
                resBundle.getParcelableArrayList(
                    AllShareKey.BUNDLE_PARCELABLE_ARRAYLIST_SLIDESHOW_AUDIO_CONTENT_URI);
            ...
            if (SlideShowPlayerImpl.this.mResponseListener != null) {
              SlideShowPlayerImpl.this.mResponseListener.onSetBGMListResponseReceived(
                  itemList2, error);
              return;
            }
            return;
          ...
          if (actionID.equals(AllShareAction.ACTION_SLIDESHOW_PLAYER_SETBGMVOLUME)) {
            ...
            if (SlideShowPlayerImpl.this.mResponseListener != null) {
              SlideShowPlayerImpl.this.mResponseListener.onSetBGMVolumeResponseReceived(
                  level, error);
            }
          }
        }
  ...
  private AllShareEventHandler mAllShareEventHandler =
      new AllShareEventHandler(
          ServiceConnector
              .getMainLooper()) { // from class: com.samsung.android.allshare.SlideShowPlayerImpl.2
...

        {
          ...
          hashMap.put(
              ...
              SlideShowPlayer.SlideShowPlayerState.BUFFERING);
          this.mStateMap.put(
              AllShareEvent.EVENT_RENDERER_STATE_NOMEDIA,
              SlideShowPlayer.SlideShowPlayerState.STOPPED);
          this.mStateMap.put(
              AllShareEvent.EVENT_RENDERER_STATE_PAUSED,
              SlideShowPlayer.SlideShowPlayerState.PLAYING);
          this.mStateMap.put(
        ...
        private void notifyEvent(
            SlideShowPlayer.SlideShowPlayerState state, int trackNumber, ERROR error) {
          if (SlideShowPlayerImpl.this.mEventListener != null) {
            try {
              SlideShowPlayerImpl.this.mEventListener.onSlideShowPlayerStateChanged(
                  state, trackNumber, error);
            } catch (Error err) {
  ...
  SlideShowPlayerImpl(IAllShareConnector connector, DeviceImpl deviceImpl) {
  ...
  public void start(int interval) {
    ...
    if (iAllShareConnector == null || !iAllShareConnector.isAllShareServiceConnected()) {
      SlideShowPlayer.ISlideShowPlayerResponseListener iSlideShowPlayerResponseListener =
          this.mResponseListener;
      if (iSlideShowPlayerResponseListener != null) {
        iSlideShowPlayerResponseListener.onStartResponseReceived(
            interval, ERROR.SERVICE_NOT_CONNECTED);
        return;
      }
      return;
    }
  ...
  public void setList(String albumTitle, ArrayList<Item> imageItems) {
    ...
    if (iAllShareConnector == null || !iAllShareConnector.isAllShareServiceConnected()) {
      SlideShowPlayer.ISlideShowPlayerResponseListener iSlideShowPlayerResponseListener =
          this.mResponseListener;
      if (iSlideShowPlayerResponseListener != null) {
        iSlideShowPlayerResponseListener.onSetListResponseReceived(
            albumTitle, imageItems, ERROR.SERVICE_NOT_CONNECTED);
        return;
      }
      return;
    }
    ...
    while (it.hasNext()) {
      ...
      if (next != 0) {
        ...
        if (!mimeType.contains("image")) {
          SlideShowPlayer.ISlideShowPlayerResponseListener iSlideShowPlayerResponseListener2 =
              this.mResponseListener;
          if (iSlideShowPlayerResponseListener2 != null) {
            iSlideShowPlayerResponseListener2.onSetListResponseReceived(
                albumTitle, imageItems, ERROR.INVALID_OBJECT);
            return;
          }
          return;
        }
    ...
    req_bundle.putParcelableArrayList(
        AllShareKey.BUNDLE_PARCELABLE_ARRAYLIST_SLIDESHOW_IMAGE_CONTENT_URI, bundleList);
    req_msg.setBundle(req_bundle);
    this.mAllShareConnector.requestCVMAsync(req_msg, this.mResponseHandler);
  }
  ...
  public void setBGMList(ArrayList<Item> items) {
    ...
    if (iAllShareConnector == null || !iAllShareConnector.isAllShareServiceConnected()) {
      SlideShowPlayer.ISlideShowPlayerResponseListener iSlideShowPlayerResponseListener =
          this.mResponseListener;
      if (iSlideShowPlayerResponseListener != null) {
        iSlideShowPlayerResponseListener.onSetBGMListResponseReceived(
            items, ERROR.SERVICE_NOT_CONNECTED);
        return;
      }
      return;
    }
      ...
      if (next != 0) {
        ...
        if (!mimeType.contains("audio")) {
          SlideShowPlayer.ISlideShowPlayerResponseListener iSlideShowPlayerResponseListener2 =
              this.mResponseListener;
          if (iSlideShowPlayerResponseListener2 != null) {
            iSlideShowPlayerResponseListener2.onSetBGMListResponseReceived(
                items, ERROR.INVALID_OBJECT);
            return;
          }
          return;
        }
    ...
    req_bundle.putString("BUNDLE_STRING_ID", getID());
    req_bundle.putParcelableArrayList(
        AllShareKey.BUNDLE_PARCELABLE_ARRAYLIST_SLIDESHOW_AUDIO_CONTENT_URI, bundleList);
    req_msg.setBundle(req_bundle);
    this.mAllShareConnector.requestCVMAsync(req_msg, this.mResponseHandler);
  }
  ...
  public void setBGMVolume(int volume) {
    ...
    if (iAllShareConnector == null || !iAllShareConnector.isAllShareServiceConnected()) {
      SlideShowPlayer.ISlideShowPlayerResponseListener iSlideShowPlayerResponseListener =
          this.mResponseListener;
      if (iSlideShowPlayerResponseListener != null) {
        iSlideShowPlayerResponseListener.onSetBGMVolumeResponseReceived(
            volume, ERROR.SERVICE_NOT_CONNECTED);
        return;
      }
      return;
    }
