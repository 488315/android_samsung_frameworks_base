...
public abstract class Provider extends Device {
  ...
  public interface IProviderBrowseResponseListener {
    void onBrowseResponseReceived(
        ArrayList<Item> arrayList, int i, int i2, Item item, boolean z, ERROR error);
  }
  ...
  public abstract void setBrowseItemsResponseListener(
      IProviderBrowseResponseListener iProviderBrowseResponseListener);

  public abstract void setEventListener(IProviderEventListener iProviderEventListener);

  public abstract void setSearchResponseListener(
      IProviderSearchResponseListener iProviderSearchResponseListener);
