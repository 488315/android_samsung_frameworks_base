...
public class MPSurfaceReader implements AutoCloseable {
    ...
    private MPSurfaceReader(int width, int height, int format, int maxImages, long usage) {
        Log.m94d(TAG, String.format("MPSurfaceReader: w=%d, h=%d, fmt=0x%x, maxImages=%d, usg=0x%x", Integer.valueOf(width), Integer.valueOf(height), Integer.valueOf(format), Integer.valueOf(maxImages), Long.valueOf(usage)));
        this.width = width;
        this.height = height;
        this.format = format;
    ...
    /* renamed from: of */
    public static MPSurfaceReader m289of(int width, int height, int format, int maxImages, long usage) {
    ...
    public void close() throws Exception {
        String str = TAG;
        Log.m98i(str, "close MPSurfaceReader...E");
        ...
        Log.m98i(str, "close MPSurfaceReader...X");
    }
