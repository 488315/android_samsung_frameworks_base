...
public class SemContextDeviceActivityDetectorAttribute extends SemContextAttribute {
    ...
    public SemContextDeviceActivityDetectorAttribute(int activity, int duration, boolean needsRequestToUpdate) {
        ...
        Log.m94d(TAG, "SemContextDeviceActivityDetectorAttribute activity, posture : " + this.mActivity + " , " + this.mPosture);
        setAttribute();
    }
    ...
    public boolean checkAttribute() {
        ...
        if (i < 1 || i > 2) {
            Log.m96e(TAG, "SemContextDeviceActivityDetector activity is wrong.");
            return false;
        }
        if ((i == 1 && !this.mNeedsRequestToUpdate) || (i == 2 && this.mDuration > 0)) {
            Log.m96e(TAG, "This option is NOT supported, activity : " + this.mActivity + ", duration : " + this.mDuration + ", request : " + this.mNeedsRequestToUpdate);
            return false;
        }
        Log.m94d(TAG, "SemContextDeviceActivityDetector checkAttribute : " + this.mActivity);
    ...
    private void setAttribute() {
        ...
        if (i == 2 && !this.mNeedsRequestToUpdate) {
            ...
            Log.m96e(TAG, "The attribute is wrong.");
            return;
        }
