...
public interface ISemInputDeviceManager extends IInterface {
  ...
  int setProperty(SemInputConstants.Device device, SemInputConstants.Property property, String str)
      throws RemoteException;
          ...
          switch (code) {
            ...
            case 5:
              SemInputConstants.Device _arg04 =
                  (SemInputConstants.Device) data.readTypedObject(SemInputConstants.Device.CREATOR);
