...
public class SemInputDeviceManager {
  ...
  public SemInputDeviceManager(ISemInputDeviceManager service) {
    if (service == null) {
      Log.m94d(TAG, "ISemInputDeviceManager is null");
    } else {
      Log.m94d(TAG, "SemInputDeviceManager ++");
  ...
  public int getSupportDevice(int devid) {
    ...
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "getSupportDevice: service is not enabled");
      return -1;
    }
    try {
      ...
      Log.m97e(TAG, "Failed to call interface: ", e);
      return -1;
    }
  }
  ...
  private int activate(
    ...
    if (this.service == null) {
      Log.m96e(TAG, "activate: service is not enabled");
      return -1;
    }
    Log.m94d(TAG, "activate: " + device + " " + mode + "," + state);
    try {
  ...
  private int setProperty(
    ...
    if (this.service == null) {
      Log.m96e(TAG, "setProperty: service is not enabled");
      return -1;
    }
    Log.m94d(
        TAG,
    ...
    try {
      ...
      Log.m97e(TAG, "setProperty: Failed to call interface: ", e);
      return -1;
    }
  }
  ...
  private int setProperty(
    ...
    Log.m94d(TAG, "setProperty: " + device + " " + property + "," + mode);
    try {
  ...
  private String getProperty(SemInputConstants.Device device, SemInputConstants.Property property) {
    if (this.service == null) {
      Log.m96e(TAG, "getProperty: service is not enabled");
      return RESULT_STR_NG;
    }
    Log.m94d(TAG, "getProperty: " + device + " " + property);
    try {
      String retval = this.service.getProperty(device, property);
      return retval;
    } catch (Exception e) {
      Log.m97e(TAG, "getProperty: Failed to call interface: ", e);
      return RESULT_STR_NG;
    }
  }
  ...
  public String getCommandList(int devid) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "getCommandList: service is not enabled");
      return RESULT_STR_NG;
    }
    try {
      String ret =
          iSemInputDeviceManager.getCommandList(SemInputConstants.Device.getFromInt(devid));
      return ret;
    } catch (Exception e) {
      Log.m97e(TAG, "Failed to call interface: ", e);
      return RESULT_STR_NG;
  ...
  private String runCommand(SemInputConstants.Device device, String cmd) {
    if (this.service == null) {
      Log.m96e(TAG, "runCommand: service is not enabled");
      return RESULT_STR_NG;
    }
    Log.m94d(TAG, "runCommand: " + device + " " + cmd);
    try {
  ...
  public String getKeyPressStateAll() {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "getKeyPressStateAll: service is not enabled");
      return "";
    }
    try {
  ...
  public boolean isKeyPressedByKeycode(int keycode) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "isKeyPressedByKeycode: service is not enabled");
      return false;
    }
    try {
  ...
  public int setAotEnable(int mode) {
    if (this.service == null) {
      Log.m96e(TAG, "setAotEnable: service is not enabled");
      return -1;
    }
    Log.m94d(TAG, "setAotEnable: " + mode);
    try {
  ...
  public int getTspSupportFeature(int devid) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "getTspSupportFeature: service is not enabled");
      return 0;
    }
    try {
      int ret =
          iSemInputDeviceManager.getTspSupportFeature(SemInputConstants.Device.getFromInt(devid));
      return ret;
    } catch (Exception e) {
      Log.m97e(TAG, "Failed to call interface: ", e);
      return 0;
  ...
  public int setProxPowerOff(int devid, int mode) {
    return setProperty(
        SemInputConstants.Device.getFromInt(devid), SemInputConstants.Property.PROX_OFF, mode + "");
  }
  ...
  public void setCoverMode(boolean switchState, int coverType) {
    if (switchState) {
      ...
      setProperty(
          ...
          gloveMode + "");
      setProperty(
          SemInputConstants.Device.SPEN, SemInputConstants.Command.CLEAR_COVER, "0," + coverType);
      return;
    }
    setProperty(
        SemInputConstants.Device.NOT_SPECIFIED,
  ...
  public String getAodActiveArea(int devid) {
    return getProperty(
        SemInputConstants.Device.getFromInt(devid), SemInputConstants.Property.AOD_ACTIVE_AREA);
  }
  ...
  public int setSpenCoverType(int type) {
    return setProperty(
        SemInputConstants.Device.SPEN, SemInputConstants.Command.SPEN_COVER_TYPE, type + "");
  }
  ...
  public int setSpenBleChargeMode(int mode) {
    return setProperty(
        SemInputConstants.Device.SPEN, SemInputConstants.Command.SPEN_BLE_CHARGING, mode + "");
  }
  ...
  public int setSpenLowCurrentMode(int mode) {
    return setProperty(
        SemInputConstants.Device.SPEN, SemInputConstants.Command.SPEN_LOWCURRENT, mode + "");
  }

  public int setSpenPowerSavingMode(int mode) {
    return setProperty(
        SemInputConstants.Device.SPEN, SemInputConstants.Command.SPEN_SAVING_MODE, mode + "");
  }

  public int getDeviceEnabled(int devid) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "getDeviceEnabled: service is not enabled");
      return -1;
    }
    try {
  ...
  public boolean registerListener(int type, String client) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "registerListener: service is not enabled");
      return false;
    }
    try {
  ...
  public boolean unregisterListener(int type, String client) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "unregisterListener: service is not enabled");
      return false;
    }
    try {
  ...
  public int sendRawdataTsp(int devid, int[] data) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "sendRawdataTsp: service is not enabled");
      return -1;
    }
    try {
      int ret =
          iSemInputDeviceManager.sendRawdataTsp(SemInputConstants.Device.getFromInt(devid), data);
      return ret;
    } catch (Exception e) {
      Log.m97e(TAG, "Failed to call interface: ", e);
      return -1;
  ...
  public boolean isSupportMotion(String type) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "isSupportMotion: service is not enabled");
      return false;
    }
    try {
  ...
  public int enableMotion(String type, boolean enable, String client) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "enableMotion: service is not enabled");
      return -1;
    }
    try {
  ...
  public int setMotionControl(String subtype, int control, String client) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "setMotionControl: service is not enabled");
      return -1;
    }
    try {
  ...
  public int isEnableMotion(String type, String client) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "isEnableMotion: service is not enabled");
      return -1;
    }
    try {
  ...
  public int getMotionControl(String subtype, String client) {
    ISemInputDeviceManager iSemInputDeviceManager = this.service;
    if (iSemInputDeviceManager == null) {
      Log.m96e(TAG, "getMotionControl: service is not enabled");
      return -1;
    }
    try {
