...
public class SemSoundTrigger {
    ...
    public static class ModuleProperties {
        ...
        public String toString() {
            return "ModuleProperties [id=" + this.f3003id + ", uuid=" + this.uuid + ", supportsConcurrentCapture=" + this.supportsConcurrentCapture + NavigationBarInflaterView.SIZE_MOD_END;
        }
    }
    ...
    public static class Keyphrase {
        ...
        public String toString() {
            return "Keyphrase [id=" + this.f3001id + ", recognitionModes=" + this.recognitionModes + ", locale=" + this.locale + ", text=" + this.text + ", users=" + Arrays.toString(this.users) + NavigationBarInflaterView.SIZE_MOD_END;
        }
    }
    ...
    public static class KeyphraseSoundModel {
        ...
        public KeyphraseSoundModel(UUID uuid, UUID vendorUuid, byte[] data, Keyphrase[] keyphrases) {
            ...
            for (int i = 0; i < keyphrases.length; i++) {
                stKeyphrases[i] = new SoundTrigger.Keyphrase(keyphrases[i].f3001id, keyphrases[i].recognitionModes, keyphrases[i].locale, keyphrases[i].text, keyphrases[i].users);
            }
    ...
    public static class RecognitionConfig {
        ...
        public RecognitionConfig(boolean captureRequested, boolean allowMultipleTriggers, KeyphraseRecognitionExtra[] keyphrases, byte[] data) {
            ...
            for (int i = 0; i < keyphrases.length; i++) {
                ...
                stKeyphrases[i] = new SoundTrigger.KeyphraseRecognitionExtra(keyphrases[i].f3002id, keyphrases[i].recognitionModes, keyphrases[i].coarseConfidenceLevel, confidenceLevels);
            }
