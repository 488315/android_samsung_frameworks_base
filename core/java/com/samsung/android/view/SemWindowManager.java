...
public class SemWindowManager {
    ...
    public void setForcedDefaultDisplayDevice(int displayDeviceType) {
        ...
        if (deviceStateRequest != null) {
            Log.m94d(TAG, "setForcedDefaultDisplayDevice " + displayDeviceType + ", callingPid=" + callingPid);
            this.mDeviceStateManagerGlobal.requestState(deviceStateRequest, new PendingIntent$$ExternalSyntheticLambda1(), new DeviceStateRequest.Callback() { // from class: com.samsung.android.view.SemWindowManager.1
                ...
                public void onRequestCanceled(DeviceStateRequest request) {
                    Log.m94d(SemWindowManager.TAG, "onRequestCanceled,  pid=" + callingPid + " Callers=" + Debug.getCallers(5));
                }
            });
        }
    }
    ...
    public static final class KeyCustomizationInfo implements Parcelable {
        ...
        private KeyCustomizationInfo(Builder builder) {
            this(builder.press, builder.f3074id, builder.keyCode, builder.action, builder.intent, builder.dispatching, builder.userId, builder.ownerPackage);
        }
