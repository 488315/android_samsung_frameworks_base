...
public class SemUiSupportService extends Service implements Window.Callback, KeyEvent.Callback {
    ...
    public void onCreate() {
        ...
        try {
            ...
            if (packageManager != null && (appInfo = packageManager.getApplicationInfo(getPackageName(), 0)) != null) {
                ...
                Log.m98i(TAG, "loaded theme = " + appInfo.theme);
            }
        } catch (PackageManager.NameNotFoundException e) {
            Log.m97e(TAG, "Failed to get running tasks.", e);
        }
    ...
    private void removeDecorView() {
        try {
            ...
            Log.m98i(TAG, "Already remove this view : " + this.mDecor);
        }
    }
    ...
    public WindowManager.LayoutParams getWindowAttributes() {
        Log.m98i(TAG, "getWindowAttributes()");
        return this.mWindowAttributes;
    }

    public void setWindowAttributes(WindowManager.LayoutParams a) {
        Log.m98i(TAG, "setAttributes()");
        this.mWindow.setAttributes(a);
    }

    public WindowManager.LayoutParams createLayoutParams() {
        Log.m98i(TAG, "createLayoutParams");
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams(2002, C4337R.string.config_forceVoiceInteractionServicePackage, -3);
        lp.privateFlags |= 16;
        lp.softInputMode = 32;
