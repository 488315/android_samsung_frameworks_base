...
public class SprDocument implements Cloneable {
  ...
  public SprDocument(String name, InputStream is) throws IOException {
      ...
      for (int i = 0; i < n; i++) {
        ...
        switch (type) {
          case 1:
            ...
            break;
          default:
            Log.m96e(TAG, "unknown element type:" + ((int) type));
            in.skip(size);
            attribute = null;
            break;
        }
    ...
    while (i2 < n2) {
      ...
      switch (type2) {
        ...
        default:
          object = null;
          Log.m96e(TAG, "unknown element type:" + ((int) type2));
          fileTag = fileTag2;
          referenceSectionOffset = referenceSectionOffset2;
          in.skip(size2);
          break;
      ...
      while (it2.hasNext()) {
        ...
        if (attr.mType == 97) {
          ...
          animatorSet.updateAnimatorInterpolator(
              SprTimeInterpolatorFactory.get(i, duration, type, quotient));
        }
      }
    }
  }
  ...
  public SprDocument m8902clone() throws CloneNotSupportedException {
    SprDocument document = (SprDocument) super.clone();
    document.mReferenceMap = this.mReferenceMap.m5440clone();
    ...
    while (it.hasNext()) {
      ...
      document.mDocuments.add(group.mo8906clone());
  ...
  public void draw(
    ...
    float f = this.mLeft;
    float f2 = this.mTop;
    canvas.clipRect(f, f2, f + displayWidth, f2 + displayHeight, Region.EnumC0836Op.INTERSECT);
    canvas.scale(sx, sy);
