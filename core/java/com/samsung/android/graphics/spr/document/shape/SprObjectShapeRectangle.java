...
public class SprObjectShapeRectangle extends SprObjectBase {
  ...
  /* renamed from: rx */
  public float f2997rx;

  /* renamed from: ry */
  public float f2998ry;
  public float top;
  ...
  public void fromSPR(SprInputStream in) throws IOException {
    ...
    this.f2997rx = in.readFloat();
    this.f2998ry = in.readFloat();
    super.fromSPR(in);
  }
  ...
  public void toSPR(DataOutputStream out) throws IOException {
    ...
    out.writeFloat(this.f2997rx);
    out.writeFloat(this.f2998ry);
    super.toSPR(out);
  }
  ...
  public int getTotalSegmentCount() {
    if (this.f2997rx == 0.0f && this.f2998ry == 0.0f) {
      return 4;
    }
    return 8;
  }
  ...
  public void draw(SprDocument document, Canvas canvas, float sx, float sy, float alpha) {
    ...
    if (this.f2997rx != 0.0f || this.f2998ry != 0.0f) {
      if (this.isVisibleFill) {
        canvas.drawRoundRect(rect, this.f2997rx, this.f2998ry, this.fillPaint);
      }
      if (this.isVisibleStroke) {
        canvas.drawRoundRect(rect, this.f2997rx, this.f2998ry, this.strokePaint);
      }
    } else {
      if (this.isVisibleFill) {
