    ...
    while (it.hasNext()) {
      ...
      switch (attribute.mType) {
        case 1:
          ...
          canvas.clipRect(
              clip.left, clip.top, clip.right, clip.bottom, Region.EnumC0836Op.INTERSECT);
          break;
        case 3:
          ...
          if (reference == null) {
            ...
            switch (reference.mType) {
              case 1:
                Path path = new Path();
                path.addCircle(
                    ((SprObjectShapeCircle) reference).f2985cx,
                    ((SprObjectShapeCircle) reference).f2986cy,
                    ((SprObjectShapeCircle) reference).f2984cr,
                    Path.Direction.CW);
              ...
              case 4:
                canvas.clipPath(
                    ((SprObjectShapePath) reference).path, Region.EnumC0836Op.INTERSECT);
                break;
              case 5:
                canvas.clipRect(
  ...
  protected void setShadowLayer() {
    ...
    if (this.isVisibleStroke) {
      ...
      this.strokePaint.setShadowLayer(
          this.shadow.radius, this.shadow.f2975dx, this.shadow.f2976dy, this.shadow.shadowColor);
    }
  }
