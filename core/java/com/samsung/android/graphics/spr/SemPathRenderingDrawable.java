...
public class SemPathRenderingDrawable extends Drawable implements Animatable {
  ...
  /* JADX WARN: Can't wrap try/catch for region: R(7:(2:102|103)|(4:(3:128|129|(8:134|135|107|108|109|110|111|112))|110|111|112)|105|106|107|108|109) */
  ...
  */
      ...
      if (this.mState.mNinePatch) {
        ...
        synchronized (sprDocument2) {
          ...
          try {
            if (bitmap != null) {
              try {
                if (bitmap.getWidth() == scaledHeight2
                    && this.mAnimationBitmap.getHeight() == scaledHeight) {
          ...
          this.mAnimationBitmap =
              Bitmap.createBitmap(scaledHeight2, scaledHeight, Bitmap.Config.ARGB_8888);
  ...
  private static SemPathRenderingDrawable getErrorDrawable(String name) {
    ...
    return new SemPathRenderingDrawable(
        document) { // from class: com.samsung.android.graphics.spr.SemPathRenderingDrawable.1
    ...
    if (tintMode != -1) {
      try {
        this.mState.mTintMode =
            (PorterDuff.Mode)
                mParseTintMode.invoke(null, Integer.valueOf(tintMode), PorterDuff.Mode.SRC_IN);
      } catch (Exception e3) {
  ...
  */
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      ...
      try {
        try {
          a =
              (TypedArray)
                  mResolveAttributes.invoke(t, state.mThemeAttrs, mStyleableBitmapDrawable);
    ...
    try {
      canApplyTheme = ((Boolean) mCanApplyTheme.invoke(state.mTint, new Object[0])).booleanValue();
    } catch (Exception e3) {
      canApplyTheme = false;
    }
    if (state.mTint != null && canApplyTheme) {
      try {
        state.mTint = (ColorStateList) mObtainForTheme.invoke(state.mTint, t);
      } catch (Exception e4) {
      }
    }
  ...
  */
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = sprObtainAttributes(r, theme, attrs, mStyleableBitmapDrawable);
    try {
      try {
        updateStateFromTypedArray(a);
      } catch (XmlPullParserException e) {
  ...
  static final class SprState extends Drawable.ConstantState {
    ...
    public void setDocument(SprDocument document) {
      ...
      SprDocument sprDocument = this.mDocument;
      if (sprDocument == null
          || (sprDocument.mName != null && !this.mDocument.mName.equals(document.mName))) {
        this.mDocument = document;
        this.mNinePatch =
            (document.mNinePatchLeft == 0.0f
    ...
    public void createNinePatchRenderer() {
      if (this.mNinePatchRenderer == null && this.mDocument != null) {
        ...
        if (this.mNinePatch && this.mMultiNinePatch == null) {
          ...
          ByteBuffer buffer =
              getNinePatchChunk(
                  left, top, right > left ? right : left + 1, bottom > top ? bottom : top + 1);
    ...
    public int getIntrinsicWidth() {
      ...
      SprDocument sprDocument = this.mDocument;
      if (sprDocument != null) {
        return Math.round(sprDocument.mRight * densityScale)
            - Math.round(this.mDocument.mLeft * densityScale);
      }
      return 0;
    }
    ...
    public int getIntrinsicHeight() {
      ...
      SprDocument sprDocument = this.mDocument;
      if (sprDocument != null) {
        return Math.round(sprDocument.mBottom * densityScale)
            - Math.round(this.mDocument.mTop * densityScale);
      }
      return 0;
    }
    ...
    public float getDensityScale() {
      SprDocument sprDocument = this.mDocument;
      return sprDocument == null
          ? (this.mDensityDpi / 160.0f) / 3.0f
          : (this.mDensityDpi / 160.0f) / sprDocument.mDensity;
    }
    ...
    public boolean canApplyTheme() {
      ...
      try {
        canApplyTheme =
            ((Boolean) SemPathRenderingDrawable.mCanApplyTheme.invoke(this.mTint, new Object[0]))
                .booleanValue();
      } catch (Exception e) {
        canApplyTheme = false;
      }
  ...
  public void start() {
    ...
    if (sprDocument.getFrameAnimationCount() > 1) {
      ...
      if (this.mDocument.isIntrinsic()) {
        try {
          this.mDocument = this.mDocument.m8902clone();
