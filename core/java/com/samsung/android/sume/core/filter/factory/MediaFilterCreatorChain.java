...
class MediaFilterCreatorChain implements MediaFilterCreator {
                        ...
                        this.types.stream()
                                .map(
                                        new Function() { // from class:
                                                         // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda2
                                            @Override // java.util.function.Function
                                            public final Object apply(Object obj) {
                                                return MediaFilterCreatorChain.lambda$prepare$0(
                                                        registry, (Enum) obj);
                                            }
                                        })
                                .collect(Collectors.toList());
        this.descriptorFinder =
                (DescriptorFinder)
                        this.creators.stream()
                                .filter(
                                        new Predicate() { // from class:
                                                          // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda3
                                            @Override // java.util.function.Predicate
                                            public final boolean test(Object obj) {
                                                return MediaFilterCreatorChain.lambda$prepare$1(
                                                        (MediaFilterCreator) obj);
                                            }
                                        })
                                .findFirst()
                                .map(
                                        new Function() { // from class:
                                                         // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda4
                                            @Override // java.util.function.Function
                                            public final Object apply(Object obj) {
                                                return MediaFilterCreatorChain.lambda$prepare$3(
                                                        (MediaFilterCreator) obj);
                                            }
                                        })
                                .orElseGet(
                                        new Supplier() { // from class:
                                                         // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda5
    ...
    static /* synthetic */ MediaFilterCreator lambda$prepare$0(Map registry, Enum e) {
        return (MediaFilterCreator)
                ((List)
                                Optional.ofNullable((List) registry.get(e))
    ...
    static /* synthetic */ DescriptorFinder lambda$prepare$3(final MediaFilterCreator e) {
        return new DescriptorFinder() { // from class:
                                        // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda0
            ...
            public final MFDescriptor find(MFDescriptor mFDescriptor) {
                return MediaFilterCreatorChain.lambda$prepare$2(
                        MediaFilterCreator.this, mFDescriptor);
            }
        };
    }

    static /* synthetic */ MFDescriptor lambda$prepare$2(
            MediaFilterCreator e, MFDescriptor descriptor) {
        PluginStore store = ((PluginFilterCreator) e).getPluginStore();
        return (MFDescriptor)
                Optional.ofNullable(store.get(descriptor))
                        .map(
                                new Function() { // from class:
                                                 // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda8
                                    @Override // java.util.function.Function
                                    public final Object apply(Object obj) {
    ...
    static /* synthetic */ DescriptorFinder lambda$prepare$5() {
        return new DescriptorFinder() { // from class:
                                        // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda1
            @Override // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain.DescriptorFinder
            public final MFDescriptor find(MFDescriptor mFDescriptor) {
    ...
    public MediaFilter newFilter(
            final MediaFilterFactory factory,
            final MFDescriptor descriptor,
            final MediaFilter successor) {
        return (MediaFilter)
                Optional.ofNullable(this.descriptorFinder)
                        .map(
                                new Function() { // from class:
                                                 // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda6
                                    @Override // java.util.function.Function
                                    public final Object apply(Object obj) {
                                        MFDescriptor find;
                                        find =
                                                ((MediaFilterCreatorChain.DescriptorFinder) obj)
                                                        .find(MFDescriptor.this);
                                        return find;
                                    }
                                })
                        .map(
                                new Function() { // from class:
                                                 // com.samsung.android.sume.core.filter.factory.MediaFilterCreatorChain$$ExternalSyntheticLambda7
                                    @Override // java.util.function.Function
                                    public final Object apply(Object obj) {
                                        return MediaFilterCreatorChain.this.m9159xeb0b27c7(
                                                factory, successor, (MFDescriptor) obj);
                                    }
                                })
                        .orElse(null);
    }
    ...
    /* synthetic */ MediaFilter m9159xeb0b27c7(
            MediaFilterFactory factory, MediaFilter successor, MFDescriptor e) {
