...
import com.samsung.android.sume.core.descriptor.p044nn.NNFWDescriptor$$ExternalSyntheticLambda1;
...
public class PluginFilterCreator implements MediaFilterCreator {
  ...
  private MediaFilter createImgpFilter(ImgpDescriptor descriptor) {
    ...
    if (descriptor.getPluginId() == ImgpPlugin.Type.ANY) {
      final List<String> typeNames =
          (List)
              Arrays.stream(ImgpPlugin.Type.values())
                  .filter(
                      new Predicate() { // from class:
                                        // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda0
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                          return PluginFilterCreator.lambda$createImgpFilter$0(
                              (ImgpPlugin.Type) obj);
                        }
                      })
                  .map(
                      new Function() { // from class:
                                       // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda1
      ...
      List<PluginFixture<?>> plugins =
          (List)
              this.pluginStore
                  .keyStream()
                  .filter(
                      new Predicate() { // from class:
                                        // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda2
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                          boolean anyMatch;
                          anyMatch =
                              typeNames.stream()
                                  .anyMatch(
                                      new Predicate() { // from class:
                                                        // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda14
                                        @Override // java.util.function.Predicate
                  ...
                  .map(
                      new Function() { // from class:
                                       // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda3
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                          return PluginFilterCreator.this.m393x46ec1c58((String) obj);
                        }
                      })
                  .filter(
                      new Predicate() { // from class:
                                        // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda4
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                  ...
                  .map(
                      new Function() { // from class:
                                       // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda5
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                ...
                plugins.stream()
                    .reduce(
                        new BinaryOperator() { // from class:
                                               // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda6
                          @Override // java.util.function.BiFunction
                          public final Object apply(Object obj, Object obj2) {
                            PluginFixture join;
                            join =
                                ImgpPlugin.join(
                                    (ImgpPlugin) ((PluginFixture) obj),
                                    (ImgpPlugin) ((PluginFixture) obj2));
                            return join;
                          }
                        })
      ...
      PluginStore.Entry found =
          (PluginStore.Entry)
              Optional.ofNullable(this.pluginStore.get(descriptor))
                  .orElseThrow(new MutableMediaBuffer$$ExternalSyntheticLambda12());
    ...
    return (MediaFilter)
        Optional.ofNullable(plugin.getContentFilterRegister())
            .map(
                new Function() { // from class:
                                 // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda7
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
                    return PluginFilterCreator.lambda$createImgpFilter$5(
                        MediaFilter.this, (ContentFilterRegister) obj);
                  }
                })
            .orElse(imgpFilter);
  }
  ...
  /* synthetic */ Optional m393x46ec1c58(String e) {
    return Optional.ofNullable(this.pluginStore.get(new ImgpDescriptor(ImgpPlugin.Type.valueOf(e))))
        .map(
            new Function() { // from class:
                             // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda13
              @Override // java.util.function.Function
              public final Object apply(Object obj) {
  ...
  static /* synthetic */ MediaFilter lambda$createImgpFilter$5(
      MediaFilter filter, ContentFilterRegister it) {
  ...
  private MediaFilter createNNFilter(NNDescriptor descriptor, MediaFilter successor) {
    ...
    if (context == null) {
      throw new IllegalStateException(
          "NNPlugin filter require context from PluginStore, but nothing is given");
    }
    final Pair<String, Pattern> paths = plugin.getModelPathLoader().load(descriptor.getModelId());
    try {
      nnFileDescriptor =
          (List)
              Arrays.stream(context.getAssets().list(paths.first))
                  .filter(
                      new Predicate() { // from class:
                                        // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda8
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                          boolean find;
                  ...
                  .map(
                      new Function() { // from class:
                                       // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda9
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                          return PluginFilterCreator.lambda$createNNFilter$7(
                              Context.this, paths, (String) obj);
                        }
                      })
                  .filter(
                      new Predicate() { // from class:
                                        // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda10
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
      ...
      String models =
          Arrays.toString(
              nnFileDescriptor.stream()
                  .map(new NNFWDescriptor$$ExternalSyntheticLambda1())
                  .toArray(
                      new IntFunction() { // from class:
                                          // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda11
                        @Override // java.util.function.IntFunction
                        public final Object apply(int i) {
                          return PluginFilterCreator.lambda$createNNFilter$8(i);
                        }
                      }));
      Log.m94d(TAG, "success to load model file: " + paths.first + "/" + models);
    ...
    if (nnFileDescriptor.isEmpty()) {
      if (descriptor.isIgnorableFilter()) {
        ...
        throw new IllegalArgumentException(
            Def.fmtstr(
                "can't find model file: " + paths.first + ", regex=" + paths.second,
                new Object[0]));
      }
    } else {
      if (nnFileDescriptor.size() > 1) {
        ...
        Def.require(
            modelSelector != null,
            "multiple model found, but model selector is not given",
            new Object[0]);
    ...
    return (MediaFilter)
        Optional.ofNullable(plugin.getContentFilterRegister())
            .map(
                new Function() { // from class:
                                 // com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda12
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
                    return PluginFilterCreator.lambda$createNNFilter$9(
                        MediaFilter.this, (ContentFilterRegister) obj);
                  }
                })
            .orElse(filter);
  ...
  static /* synthetic */ MediaFilter lambda$createNNFilter$9(
      MediaFilter filter, ContentFilterRegister it) {
    return new ContentFilter(it, filter);
  }
}
