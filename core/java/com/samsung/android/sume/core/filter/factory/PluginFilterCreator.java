...
public class PluginFilterCreator implements MediaFilterCreator {
                                    ...
                                    .filter(
                                            new Predicate() { // from class:
                                                ...
                                                public final boolean test(Object obj) {
                                                    return PluginFilterCreator
                                                            .lambda$createImgpFilter$0(
                                                                    (ImgpPlugin.Type) obj);
                                                }
                                            })
                                    .map(
                            ...
                            this.pluginStore
                                            ...
                                            new Predicate() { // from class:
                                                ...
                                                public final boolean test(Object obj) {
                                                    ...
                                                    anyMatch =
                                                            typeNames.stream()
                                                                    .anyMatch(
                                                                            new Predicate() { // from class: com.samsung.android.sume.core.filter.factory.PluginFilterCreator$$ExternalSyntheticLambda8
                                                                                @Override // java.util.function.Predicate
                                    ...
                                    .map(
                                            new Function() { // from class:
                                                ...
                                                @Override // java.util.function.Function
                                                public final Object apply(Object obj) {
                                                    return PluginFilterCreator.this.m9164x46ec1c58(
                                                            (String) obj);
                                                }
                                            })
                                    .filter(
                ...
                plugin =
                        (ImgpPlugin)
                                plugins.stream()
                                        ...
                                        .orElseThrow(
                                                new MutableMediaBuffer$$ExternalSyntheticLambda3());
            }
        } else {
    ...
    /* synthetic */ Optional m9164x46ec1c58(String e) {
        return Optional.ofNullable(
                        this.pluginStore.get(new ImgpDescriptor(ImgpPlugin.Type.valueOf(e))))
                .map(
                        new Function() { // from class:
    ...
    private MediaFilter createNNFilter(NNDescriptor descriptor, MediaFilter successor) {
        ...
        final Pair<String, Pattern> paths =
                plugin.getModelPathLoader().load(descriptor.getModelId());
        try {
            nnFileDescriptor =
                    (List)
        ...
        if (nnFileDescriptor.isEmpty()) {
            ...
            filter =
                    new NNFilter(
                            descriptor, plugin, (MediaFilter) Objects.requireNonNull(successor));
        }
        return (MediaFilter)
                Optional.ofNullable(plugin.getContentFilterRegister())
                        .map(
