...
public class MediaFilterTracer extends DecorateFilter {
  ...
  public void prepare() {
    Log.m94d(TAG, "prepare: successor=" + this.successor);
    makeReport(511);
    super.prepare();
    makeReport(512);
  }
  ...
  public MutableMediaBuffer run(MediaBuffer ibuf, MutableMediaBuffer obuf) {
    Log.m94d(TAG, "run: successor=" + this.successor);
    makeReport(513, ibuf);
  ...
  @Override // com.samsung.android.sume.core.filter.DecorateFilter,
            // com.samsung.android.sume.core.filter.MediaFilter
  public void release() {
    Log.m94d(TAG, "release: successor=" + this.successor);
    makeReport(515);
    super.release();
    makeReport(516);
  }
  ...
  private void makeReport(int code, MediaBuffer mediaBuffer) {
    Log.m94d(TAG, "makeReport: code=" + code + ", buffer=" + mediaBuffer);
    ...
    if (mediaBuffer != null) {
      int contentId =
          ((Integer) mediaBuffer.getExtra(Message.KEY_CONTENTS_ID, Integer.valueOf(this.contentId)))
              .intValue();
      ...
      if (blockId != -1) {
        ...
        message.put(
            ...
            mediaBuffer.getExtra(Message.KEY_NUM_BLOCKS, Integer.valueOf(this.numBlocks)));
      }
          ...
          this.messageHandlers.add(
              new Consumer() { // from class:
                ...
                public final void accept(Object obj) {
                  MediaFilterTracer.this.m372x3bc8565(message, (Message) obj);
                }
              });
          break;
        }
  ...
  /* synthetic */ void m372x3bc8565(Message message, Message msg) {
    msg.put(
  ...
  private Map<String, Object> getShortDescription(MFDescriptor descriptor) {
    Log.m94d(TAG, "getShortDescription: descriptor=" + descriptor);
  ...
  public boolean onMessageReceived(Message message) throws UnsupportedOperationException {
    Log.m94d(TAG, "onMessageReceived: " + message);
