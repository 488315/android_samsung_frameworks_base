...
public class NNFWFilterGroup extends NNFWFilter implements MediaFilterGroup {
  ...
  public NNFWFilterGroup(NNFWDescriptor descriptor, List<MediaFilter> filters) {
    ...
    descriptor
        .getNNDescriptor()
        .setModelSelector(
            new ModelSelector() { // from class:
                                  // com.samsung.android.sume.core.filter.NNFWFilterGroup$$ExternalSyntheticLambda0
              ...
              public final ModelSelector.Item select(MediaBuffer mediaBuffer) {
                return NNFWFilterGroup.this.m379xd3f4c5ae(mediaBuffer);
              }
            });
  ...
  public ModelSelector.Item m379xd3f4c5ae(MediaBuffer mediaBuffer) {
    final ModelSelector.Item found = this.modelSelector.select(mediaBuffer);
    Log.m94d(TAG, "load model: " + found.name);
    this.mediaFilter =
        this.filters.stream()
            .filter(
                new Predicate() { // from class:
                                  // com.samsung.android.sume.core.filter.NNFWFilterGroup$$ExternalSyntheticLambda2
                  @Override // java.util.function.Predicate
                  public final boolean test(Object obj) {
                    boolean equals;
                    equals =
                        ((NNFWDescriptor) ((MediaFilter) obj).getDescriptor())
                            .getNNFileDescriptor()
                            .getName()
                            .equals(ModelSelector.Item.this.name);
                    return equals;
                  }
                })
            .findFirst()
            .orElseThrow(
                new Supplier() { // from class:
                                 // com.samsung.android.sume.core.filter.NNFWFilterGroup$$ExternalSyntheticLambda3
  ...
  public void prepare() {
    this.filters.forEach(
        new Consumer() { // from class:
                         // com.samsung.android.sume.core.filter.NNFWFilterGroup$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            NNFWFilterGroup.this.m380x92910fc4((MediaFilter) obj);
          }
        });
  }

  /* renamed from: lambda$prepare$3$com-samsung-android-sume-core-filter-NNFWFilterGroup */
  /* synthetic */ void m380x92910fc4(MediaFilter it) {
