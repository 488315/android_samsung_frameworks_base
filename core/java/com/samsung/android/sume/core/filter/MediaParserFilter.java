...
public class MediaParserFilter implements MediaFilter, MediaOutputStreamFilter {
  ...
  public MutableMediaBuffer run(MediaBuffer ibuf, MutableMediaBuffer obuf) {
    ...
    Log.m94d(TAG, "run: " + ibuf);
    MediaExtractor extractor2 = new MediaExtractor();
    try {
      final int contentId = ((Integer) ibuf.getExtra(Message.KEY_CONTENTS_ID)).intValue();
      final FileDescriptor inputFd =
          (FileDescriptor)
              Optional.ofNullable(ibuf.getExtra(Message.KEY_FILE_DESCRIPTOR))
                  .map(
                      new Function() { // from class:
                                       // com.samsung.android.sume.core.filter.MediaParserFilter$$ExternalSyntheticLambda0
      ...
      FileDescriptor outputFd =
          (FileDescriptor)
              Optional.ofNullable(obuf)
                  .map(
                      new Function() { // from class:
                                       // com.samsung.android.sume.core.filter.MediaParserFilter$$ExternalSyntheticLambda1
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                          Object extra;
                  ...
                  .map(
                      new Function() { // from class:
                                       // com.samsung.android.sume.core.filter.MediaParserFilter$$ExternalSyntheticLambda2
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
      ...
      long startTimeUs = ((Long) ibuf.getExtra(Message.KEY_START_TIME_US, -1L)).longValue();
      final long endTimeUs =
          ((Long) ibuf.getExtra(Message.KEY_END_TIME_US, Long.MAX_VALUE)).longValue();
      this.messageProducer
          .newMessage(
              4,
              (Map<String, Object>)
                  new HashMap<String, Object>(
                      contentId, outputFd, obuf,
                      ibuf) { // from class:
                              // com.samsung.android.sume.core.filter.MediaParserFilter.1
...

                    {
                      ...
                      put(
                          "track-count",
                          Integer.valueOf(MediaParserFilter.this.descriptor.countToParse()));
                      put(Message.KEY_OUT_FILE, outputFd);
                      if (!obuf.containsExtra(Message.KEY_CACHE_ID)
                          && ibuf.containsExtra(Message.KEY_CACHE_ID)) {
      ...
      int frameCount = Integer.parseInt(retriever.extractMetadata(32));
            ...
            .newMessage(
                ...
                (Map<String, Object>)
                    new HashMap<String, Object>(
                        ...
                        frameCount,
                        startTimeUs,
                        endTimeUs) { // from class:
                                     // com.samsung.android.sume.core.filter.MediaParserFilter.2
                      final /* synthetic */ int val$contentId;
                ...
                .newMessage(
                    ...
                    (Map<String, Object>)
                        new HashMap<String, Object>(
                            ...
                            ibuf,
                            obuf) { // from class:
                                    // com.samsung.android.sume.core.filter.MediaParserFilter.3
                          final /* synthetic */ int val$contentId;
                          final /* synthetic */ int val$frameCount;
                          final /* synthetic */ MediaBuffer val$ibuf;
                          final /* synthetic */ MutableMediaBuffer val$obuf;
            ...
            IntStream.range(0, extractor.getTrackCount())
                .forEach(
                    new IntConsumer() { // from class:
                                        // com.samsung.android.sume.core.filter.MediaParserFilter$$ExternalSyntheticLambda3
                      @Override // java.util.function.IntConsumer
                      public final void accept(int i) {
                        MediaParserFilter.this.m377xbef1d985(
                            extractor, inputFd, contentId, tracks, i);
                      }
                    });
            IntStream.range(0, extractor.getTrackCount())
                .forEach(
                    new IntConsumer() { // from class:
                                        // com.samsung.android.sume.core.filter.MediaParserFilter$$ExternalSyntheticLambda4
                      @Override // java.util.function.IntConsumer
                      public final void accept(int i) {
                        MediaParserFilter.this.m378xc0282c64(extractor, endTimeUs, i);
                      }
                    });
          } catch (IOException e) {
            e = e;
  ...
  /* synthetic */ void m377xbef1d985(
      MediaExtractor extractor, FileDescriptor inputFd, int contentId, List tracks, int idx) {
    String mimeType = extractor.getTrackFormat(idx).getString(MediaFormat.KEY_MIME);
    MediaType mediaType =
        mimeType.startsWith("video") ? MediaType.COMPRESSED_VIDEO : MediaType.COMPRESSED_AUDIO;
    if (!this.descriptor.needToParse(mediaType)) {
      Log.m94d(TAG, "descriptor has type: " + mediaType);
      return;
    }
    ...
    String str = TAG;
    Log.m94d(str, "media-format = " + mediaFormat);
    configData.put("media-format", mediaFormat);
    configData.put(Message.KEY_MEDIA_TYPE, mediaType);
    configData.put(
        mediaType == MediaType.COMPRESSED_VIDEO ? "video-format" : "audio-format", mediaFormat);
    ...
    if (mediaFormat.containsKey("rotation-degrees")) {
      configData.put(
          "rotation-degrees", Integer.valueOf(mediaFormat.getInteger("rotation-degrees")));
    }
    if (mediaFormat.containsKey(MediaFormat.KEY_BIT_RATE)) {
      configData.put(
          MediaFormat.KEY_BIT_RATE,
          Integer.valueOf(mediaFormat.getInteger(MediaFormat.KEY_BIT_RATE)));
    } else {
      int i = this.bitrate;
      if (i != 0) {
        ...
        int fileSize =
            (int)
                (((Def.getFileSize(inputFd) << 3) * 1000000)
    ...
    if (mediaFormat.containsKey(MediaFormat.KEY_FRAME_RATE)) {
      configData.put(
          ...
          Integer.valueOf(mediaFormat.getInteger(MediaFormat.KEY_FRAME_RATE)));
    }
    configData.put(
        MediaFormat.KEY_I_FRAME_INTERVAL,
        Integer.valueOf(mediaFormat.getInteger(MediaFormat.KEY_I_FRAME_INTERVAL, 1)));
    if (mediaFormat.containsKey(MediaFormat.KEY_SAMPLE_RATE)) {
      configData.put(
          MediaFormat.KEY_SAMPLE_RATE,
          Integer.valueOf(mediaFormat.getInteger(MediaFormat.KEY_SAMPLE_RATE)));
    }
    if (mediaFormat.containsKey(MediaFormat.KEY_CHANNEL_COUNT)) {
      configData.put(
          MediaFormat.KEY_CHANNEL_COUNT,
          Integer.valueOf(mediaFormat.getInteger(MediaFormat.KEY_CHANNEL_COUNT)));
    }
    Log.m94d(str, "send TRACK_FORMAT message to decoder");
  ...
  /* synthetic */ void m378xc0282c64(MediaExtractor extractor, long endTimeUs, int idx) {
    ...
    try {
      ...
      if (bufferChannel == null) {
        Log.m102w(TAG, "no buffer-channel given for " + mimeType + ", skip decoding this track");
        return;
      }
      ...
      while (!reachedEos) {
        ...
        Log.m94d(TAG, tag + "parser reached EOS");
        reachedEos = true;
