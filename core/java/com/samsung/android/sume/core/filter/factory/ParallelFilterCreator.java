...
public class ParallelFilterCreator implements MediaFilterCreator {
    ...
    public MediaFilter newFilter(
            final MediaFilterFactory factory, MFDescriptor descriptor, MediaFilter successor) {
        ...
        final List<MediaFilter> successorFilters =
                (List)
                        stream.map(new ParallelFilterCreator$$ExternalSyntheticLambda0(factory))
                                .map(
                                        new Function() { // from class:
                                                         // com.samsung.android.sume.core.filter.factory.ParallelFilterCreator$$ExternalSyntheticLambda1
                                            @Override // java.util.function.Function
                                            public final Object apply(Object obj) {
                                                MediaFilter newFilter;
                                                newFilter =
                                                        MediaFilterFactory.this.newFilter(
                                                                AsyncFilter.class,
                                                                r2.getDescriptor(),
                                                                (MediaFilter) obj);
                                                return newFilter;
        ...
        IntStream.range(0, successorFilters.size())
                .forEach(
                        new IntConsumer() { // from class:
                                            // com.samsung.android.sume.core.filter.factory.ParallelFilterCreator$$ExternalSyntheticLambda2
