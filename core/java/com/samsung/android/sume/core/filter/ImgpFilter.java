...
public class ImgpFilter extends PluginFilter<ImgpPlugin> {
  ...
  /* renamed from: of */
  public static MediaFilter m369of(
                    ...
                    new Function() { // from class:
                      ...
                      public final Object apply(Object obj) {
                        return ImgpFilter.this
                            .m9208lambda$init$0$comsamsungandroidsumecorefilterImgpFilter(obj);
                      }
                    })
  ...
  public MutableMediaBuffer run(MediaBuffer ibuf, MutableMediaBuffer obuf) {
    ...
    if (((Boolean) format.get("keep-org-ratio", false)).booleanValue()) {
      ...
      fmt.setCols(
          (int)
              (fmt.getCols()
                  / ((Float) ibuf.getExtra("scale-cols", Float.valueOf(1.0f))).floatValue()));
      fmt.setRows(
          (int)
              (fmt.getRows()
                  / ((Float) ibuf.getExtra("scale-rows", Float.valueOf(1.0f))).floatValue()));
    ...
    if (ibuf.getFormat() != null) {
      format =
          UpdatableMediaFormat.m408of(format)
              .with(ibuf.getFormat())
