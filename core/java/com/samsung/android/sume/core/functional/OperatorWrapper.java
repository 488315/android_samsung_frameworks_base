...
public class OperatorWrapper extends OpPriorityComputable implements Operator {
    ...
    class AnonymousClass1 extends HashMap<ImgpType, MediaFormatUpdater> {
        AnonymousClass1() {
            put(
                    ...
                    new MediaFormatUpdater() { // from class:
                        ...
                        public final void update(
                            ...
                            mutableMediaFormat
                                    .setRows(mediaFormat.getRows())
                                    .setCols(mediaFormat.getCols());
                        }
                    });
            put(
                    ImgpType.CROP,
                    new MediaFormatUpdater() { // from class:
                        ...
                        public final void update(
                                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
                            mutableMediaFormat.setShape(
                                    ((UpdatableMediaFormat) mediaFormat).getCroppedShape());
                        }
                    });
            put(
                    ImgpType.ROTATE,
                    new MediaFormatUpdater() { // from class:
                        ...
                        public final void update(
                                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
                            OperatorWrapper.AnonymousClass1.lambda$new$2(
                                    mediaFormat, mutableMediaFormat);
                        }
                    });
            put(
                    ImgpType.CVT_COLOR,
                    new MediaFormatUpdater() { // from class:
                        ...
                        public final void update(
                                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
                            OperatorWrapper.AnonymousClass1.lambda$new$3(
                                    mediaFormat, mutableMediaFormat);
                        }
                    });
            put(
            ...
            put(
                    ...
                    new MediaFormatUpdater() { // from class:
                        ...
                        public final void update(
                                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
                            OperatorWrapper.AnonymousClass1.lambda$new$5(
                                    mediaFormat, mutableMediaFormat);
                        }
                    });
            put(
        ...
        static /* synthetic */ void lambda$new$3(MediaFormat ifmt, MutableMediaFormat ofmt) {
            if (ifmt.getColorFormat().getChannels() != ofmt.getColorFormat().getChannels()) {
                ofmt.setDataType(
                        DataType.of(
                                ofmt.getDataType().depth(), ifmt.getColorFormat().getChannels()));
            }
    ...
    static /* synthetic */ MediaFormatUpdater lambda$new$1() {
        return new MediaFormatUpdater() { // from class:
                                          // com.samsung.android.sume.core.functional.OperatorWrapper$$ExternalSyntheticLambda1
            @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
            public final void update(
                    MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
                                    ...
                                    .stream()
                                            .map(
                                                    new Function() { // from class:
                                                        ...
                                                        @Override // java.util.function.Function
                                                        public final Object apply(Object obj) {
                                                            return OperatorWrapper.lambda$of$2(
                                                                    type, (Operator) obj);
                                                        }
                                                    })
