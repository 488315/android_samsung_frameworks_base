...
public class OperatorWrapper extends OpPriorityComputable implements Operator {
  ...
  private static final Map<ImgpType, MediaFormatUpdater> formatUpdaterMap = new C52861();
  ...
  class C52861 extends HashMap<ImgpType, MediaFormatUpdater> {
    C52861() {
      put(
          ImgpType.RESIZE,
          new MediaFormatUpdater() { // from class:
                                     // com.samsung.android.sume.core.functional.OperatorWrapper$1$$ExternalSyntheticLambda0
            @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
            public final void update(
                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
      ...
      put(
          ImgpType.CROP,
          new MediaFormatUpdater() { // from class:
                                     // com.samsung.android.sume.core.functional.OperatorWrapper$1$$ExternalSyntheticLambda1
            @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
            public final void update(
                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
      ...
      put(
          ImgpType.ROTATE,
          new MediaFormatUpdater() { // from class:
                                     // com.samsung.android.sume.core.functional.OperatorWrapper$1$$ExternalSyntheticLambda2
            @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
            public final void update(
                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
              OperatorWrapper.C52861.lambda$new$2(mediaFormat, mutableMediaFormat);
            }
          });
      put(
          ImgpType.CVT_COLOR,
          new MediaFormatUpdater() { // from class:
                                     // com.samsung.android.sume.core.functional.OperatorWrapper$1$$ExternalSyntheticLambda3
            @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
            public final void update(
                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
              OperatorWrapper.C52861.lambda$new$3(mediaFormat, mutableMediaFormat);
            }
          });
      put(
          ImgpType.CVT_DATA,
          new MediaFormatUpdater() { // from class:
                                     // com.samsung.android.sume.core.functional.OperatorWrapper$1$$ExternalSyntheticLambda4
            @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
            public final void update(
                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
      ...
      put(
          ImgpType.SPLIT,
          new MediaFormatUpdater() { // from class:
                                     // com.samsung.android.sume.core.functional.OperatorWrapper$1$$ExternalSyntheticLambda5
            @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
            public final void update(
                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
              OperatorWrapper.C52861.lambda$new$5(mediaFormat, mutableMediaFormat);
            }
          });
      put(
          ImgpType.MERGE,
          new MediaFormatUpdater() { // from class:
                                     // com.samsung.android.sume.core.functional.OperatorWrapper$1$$ExternalSyntheticLambda6
            @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
            public final void update(
                MediaFormat mediaFormat, MutableMediaFormat mutableMediaFormat) {
    ...
    static /* synthetic */ void lambda$new$3(MediaFormat ifmt, MutableMediaFormat ofmt) {
      if (ifmt.getColorFormat().getChannels() != ofmt.getColorFormat().getChannels()) {
        ofmt.setDataType(
            DataType.m467of(ofmt.getDataType().depth(), ifmt.getColorFormat().getChannels()));
      }
    ...
    static /* synthetic */ void lambda$new$5(MediaFormat ifmt, MutableMediaFormat ofmt) {
      int dim =
          ((Integer)
                  Optional.ofNullable(ifmt.getShape())
                      .map(
                          new Function() { // from class:
                                           // com.samsung.android.sume.core.functional.OperatorWrapper$1$$ExternalSyntheticLambda7
  ...
  OperatorWrapper(Enum<?> type, Operator processor) {
    ...
    this.formatUpdater =
        (MediaFormatUpdater)
            Optional.ofNullable(formatUpdaterMap.get(type))
                .orElseGet(
                    new Supplier() { // from class:
                                     // com.samsung.android.sume.core.functional.OperatorWrapper$$ExternalSyntheticLambda0
  ...
  static /* synthetic */ MediaFormatUpdater lambda$new$1() {
    return new MediaFormatUpdater() { // from class:
                                      // com.samsung.android.sume.core.functional.OperatorWrapper$$ExternalSyntheticLambda4
      @Override // com.samsung.android.sume.core.functional.MediaFormatUpdater
  ...
  /* renamed from: of */
  public static Operator m410of(final Enum<?> type, Operator processor) {
    if (processor instanceof OperatorChain) {
      return new OperatorChain(
          type,
          (List)
              ((OperatorChain) processor)
                  .stream()
                      .map(
                          new Function() { // from class:
                                           // com.samsung.android.sume.core.functional.OperatorWrapper$$ExternalSyntheticLambda3
                            @Override // java.util.function.Function
                            public final Object apply(Object obj) {
  ...
  /* renamed from: of */
  public static Operator m411of(Map<Enum<?>, Operator> map) {
    return new OperatorMap(
        (Map)
            map.entrySet().stream()
                .collect(
                    Collectors.toMap(
                        new OperatorWrapper$$ExternalSyntheticLambda1(),
                        new Function() { // from class:
                                         // com.samsung.android.sume.core.functional.OperatorWrapper$$ExternalSyntheticLambda2
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            Operator m410of;
                            m410of =
                                OperatorWrapper.m410of(
                                    (Enum) r1.getKey(), (Operator) ((Map.Entry) obj).getValue());
                            return m410of;
                          }
                        })));
  }
