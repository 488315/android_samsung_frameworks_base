...
public class RemoteServiceProxy implements ServiceProxy {
    ...
    RemoteServiceProxy(Context context, String packageName, String className, Map<Integer, Object> options) {
        ...
        this.connection = new ServiceConnection() { // from class: com.samsung.android.sume.core.service.RemoteServiceProxy.1
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                Request.m433of(905).setReceiver(RemoteServiceProxy.this.requestMessenger).setResponseReceiver(RemoteServiceProxy.this.responseMessenger).post();
    ...
    /* synthetic */ void m458x6d765b44() {
        ...
        while (true) {
            try {
                ...
                String str = TAG;
                Log.m94d(str, "take request: " + request.getCode() + "[id=" + this.mediaFilterControllerId + NavigationBarInflaterView.SIZE_MOD_END);
    ...
    /* synthetic */ Response m459xface98b3(Request request, ResponseHolder responseHolder) throws Exception {
    ...
    static /* synthetic */ void lambda$onWarn$3(Response response, ResponseHolder it) {
        String str = TAG;
        Log.m102w(str, "send response(" + response.getCode() + ") for request(" + it.getCode() + NavigationBarInflaterView.KEY_CODE_END);
    ...
    static /* synthetic */ void lambda$onError$4(Response response, Exception exception, ResponseHolder it) {
        String str = TAG;
        Log.m96e(str, "send response(" + response.getCode() + ") for request(" + it.getCode() + NavigationBarInflaterView.KEY_CODE_END);
    ...
    public synchronized void release() {
        ...
        try {
            try {
                ...
                Message msg = Request.m433of(906).setResponseReceiver(this.responseMessenger).put("id", Integer.valueOf(this.mediaFilterControllerId)).toAndroidMessage();
