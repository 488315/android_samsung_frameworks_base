...
public interface ServiceProxy {
    ...
    /* renamed from: of */
    static ServiceProxySupplier m461of(Context context, Class<?> clazz) throws IllegalArgumentException {
        return new ServiceProxySupplier(context, clazz);
    }

    /* renamed from: of */
    static ServiceProxySupplier m462of(Context context, String className) throws ClassNotFoundException {
