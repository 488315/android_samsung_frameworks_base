...
public interface GraphBuilder<T> {
  ...
  GraphBuilder<T> addNode(
      GraphNode<? extends T> graphNode,
      GraphNode<? extends T> graphNode2,
      BufferChannelDescriptor bufferChannelDescriptor);

  GraphBuilder<T> addNode(
      GraphNode<? extends T> graphNode, GraphNode<? extends T> graphNode2, Evaluator evaluator);
