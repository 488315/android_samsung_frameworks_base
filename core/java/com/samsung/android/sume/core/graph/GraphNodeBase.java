...
public abstract class GraphNodeBase<T> extends MessageSubscriberBase implements GraphNode<T> {
        ...
        if (impl instanceof MediaFilter) {
            ...
            mediaFilterRetriever.addPredicateHandler(new MediaFilterRetriever.Predictor() { // from class: com.samsung.android.sume.core.graph.GraphNodeBase$$ExternalSyntheticLambda0
                ...
                public final void onPredicate(MediaFilter mediaFilter2, MediaFilter mediaFilter3) {
                    GraphNodeBase.this.m9213lambda$new$1$comsamsungandroidsumecoregraphGraphNodeBase(mediaFilter2, mediaFilter3);
                }
            });
    ...
    /* synthetic */ void m9213lambda$new$1$comsamsungandroidsumecoregraphGraphNodeBase(MediaFilter filter, MediaFilter parent) {
    ...
    public void prepare(Graph.Option option) {
        String str = TAG;
        Log.m94d(str, "prepare[" + this.nodeId + "]: " + this.impl);
        T t = this.impl;
        if (t instanceof MediaFilter) {
            ...
            if (mediaFilter instanceof MediaInputStreamFilter) {
                if (this.inputEdges.size() > 1) {
                    ...
                    ((MediaInputStreamFilter) mediaFilter).setReceiveChannelQuery(new Function() { // from class: com.samsung.android.sume.core.graph.GraphNodeBase$$ExternalSyntheticLambda10
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                            return GraphNodeBase.this.m416x49a0da5f((Enum) obj);
                        }
                    }, 1);
                }
            ...
            if (mediaFilter instanceof MediaOutputStreamFilter) {
                if (this.outputEdges.size() > 1) {
                    ...
                    ((MediaOutputStreamFilter) mediaFilter).setSendChannelQuery(new Function() { // from class: com.samsung.android.sume.core.graph.GraphNodeBase$$ExternalSyntheticLambda12
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                            return GraphNodeBase.this.m417xd0b715e1((Enum) obj);
                        }
                    }, 1);
                }
        ...
        Log.m98i(str, "success to prepare MediaFilter");
    }
    ...
    /* synthetic */ BufferChannel m416x49a0da5f(Enum type) {
    ...
    /* synthetic */ BufferChannel m417xd0b715e1(Enum type) {
    ...
    void applyGraphOption(Graph.Option option) {
        Log.m94d(TAG, "applyGraphOption: option=" + option + " => node=" + this);
        ...
        if (option.isIgnoreFilterException()) {
            ...
            keyOfFilterToIgnoreException.forEach(new Consumer() { // from class: com.samsung.android.sume.core.graph.GraphNodeBase$$ExternalSyntheticLambda3
                ...
                public final void accept(Object obj) {
                    GraphNodeBase.this.m415x9e96944c(mediaFilterRetriever, obj);
                }
            });
        }
        if (option.isTraceMediaFilter()) {
            mediaFilterRetriever.addPredicateHandler(new MediaFilterRetriever.Predictor() { // from class: com.samsung.android.sume.core.graph.GraphNodeBase$$ExternalSyntheticLambda4
                ...
                public final void onPredicate(MediaFilter mediaFilter, MediaFilter mediaFilter2) {
                    GraphNodeBase.this.m413x2d42a2d7(mediaFilter, mediaFilter2);
                }
            });
        }
    ...
    /* synthetic */ void m415x9e96944c(MediaFilterRetriever mediaFilterRetriever, Object key) {
        if (key instanceof NNFW) {
            ...
            mediaFilterRetriever.addPredicateHandler(new MediaFilterRetriever.Predictor() { // from class: com.samsung.android.sume.core.graph.GraphNodeBase$$ExternalSyntheticLambda6
                ...
                @Override // com.samsung.android.sume.core.filter.MediaFilterRetriever.PredicateHandler
                public final void onPredicate(MediaFilter mediaFilter, MediaFilter mediaFilter2) {
                    GraphNodeBase.this.m414x5b0b768b(mediaFilter, mediaFilter2);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m414x5b0b768b(MediaFilter filter, MediaFilter parent) {
    ...
    /* synthetic */ void m413x2d42a2d7(MediaFilter filter, MediaFilter parent) {
        String str = TAG;
        Log.m94d(str, "found leaf filter=" + filter + ", parent=" + parent);
        if (filter instanceof MediaFilterPlaceHolder) {
            Log.m94d(str, "skip to trace MediaFilterPlaceHolder");
            return;
        }
    ...
    public void release() {
        String str = TAG;
        Log.m94d(str, "release...E: " + this.nodeId);
        super.release();
        ...
        Log.m94d(str, "release...X: " + this.nodeId);
    }
    ...
    static /* synthetic */ void lambda$release$12(GraphEdge it) {
        ...
        Log.m94d(TAG, NavigationBarInflaterView.SIZE_MOD_START + it.getBeginNode() + " => " + it.getEndNode() + "]cancel buffer channel" + bufferChannel);
        try {
            bufferChannel.cancel();
        } catch (CancellationException e) {
            Log.m94d(TAG, "canceled buffer-channel: " + e.getMessage());
        }
    }
