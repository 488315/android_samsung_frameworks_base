...
public abstract class GraphNodeBase<T> extends MessageSubscriberBase implements GraphNode<T> {
      ...
      mediaFilterRetriever.addPredicateHandler(
          ...
          new MediaFilterRetriever
            ...
            public final void onPredicate(MediaFilter mediaFilter2, MediaFilter mediaFilter3) {
              GraphNodeBase.this.m9213lambda$new$1$comsamsungandroidsumecoregraphGraphNodeBase(
  ...
  /* synthetic */ void m9213lambda$new$1$comsamsungandroidsumecoregraphGraphNodeBase(
            ...
            new ReceiveChannelRouter(
                (Map<Evaluator, BufferChannel>)
                    this.inputEdges.stream()
                        .collect(
                            Collectors.toMap(
                                new SendChannelRouter$$ExternalSyntheticLambda1(),
                                new SendChannelRouter$$ExternalSyntheticLambda2())),
  ...
  /* synthetic */ BufferChannel m416x49a0da5f(Enum type) {
    return (BufferChannel)
        this.inputEdges.stream()
            .findFirst()
            .map(new SendChannelRouter$$ExternalSyntheticLambda2())
  ...
  /* synthetic */ void m413x2d42a2d7(MediaFilter filter, MediaFilter parent) {
    ...
    if (parent instanceof ImgpDecorateFilter) {
      ...
      mediaFilterTracer =
          new MediaFilterTracer(filter, this.messagePublisher.getMessageProducer(), parent);
