                                ...
                                .map(
                                        new Function() { // from class:
                                            ...
                                            public final Object apply(Object obj) {
                                                return MFDescriptorGraph.lambda$new$0(
                                                        (Parcelable) obj);
                                            }
                                        })
                                .toArray(
                            ...
                            Arrays.stream(this.nodes)
                                    ...
                                    .map(
                                            new Function() { // from class:
                                                ...
                                                @Override // java.util.function.Function
                                                public final Object apply(Object obj) {
                                                    return MFDescriptorGraph
                                                            .lambda$toMediaFilterGraph$2(
                                                                    MFGraphUnitFactory.this,
                                                                    (MFDescriptorGraph
                                                                                    .DescriptorNode)
                                                                            obj);
                                                }
    ...
    public static class Builder {
        ...
        private DescriptorNode getNode(MFDescriptor descriptor) {
            if (!this.nodeMap.containsKey(descriptor)) {
                this.nodeMap.put(
                        descriptor, new DescriptorNode(this.id.getAndIncrement(), descriptor));
            }
        ...
        public Builder addNode(MFDescriptor from, MFDescriptor to) {
            return addNode(
                    getNode(from), getNode(to), (Evaluator) null, new BufferChannelDescriptor(0));
        }
