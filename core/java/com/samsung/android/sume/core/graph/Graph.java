...
public interface Graph<T> {
  ...
  default MediaBuffer run(MediaBuffer buffer) {
    ...
    run(
        new ArrayList<MediaBuffer>(
            buffer) { // from class: com.samsung.android.sume.core.graph.Graph.1
  ...
  default void run(MediaBuffer inputBuffer, MediaBuffer outputBuffer) {
    List<MediaBuffer> output =
        new ArrayList<MediaBuffer>(
            outputBuffer) { // from class: com.samsung.android.sume.core.graph.Graph.2
    ...
    run(
        new ArrayList<MediaBuffer>(
            inputBuffer) { // from class: com.samsung.android.sume.core.graph.Graph.3
  ...
  public static class Option extends OptionBase {
    ...
    public static final Parcelable.Creator<Option> CREATOR =
        new Parcelable.Creator<
            Option>() { // from class: com.samsung.android.sume.core.graph.Graph.Option.1
