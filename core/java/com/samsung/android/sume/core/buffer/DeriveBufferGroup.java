...
public class DeriveBufferGroup extends MediaBufferGroup {
    ...
    public static final Parcelable.Creator<DeriveBufferGroup> CREATOR =
    ...
    public DeriveBufferGroup(Parcel in) {
        super(in);
        this.primaryBuffer =
                (MediaBuffer) in.readParcelable(GenericMediaBuffer.class.getClassLoader());
    }

    @Override // com.samsung.android.sume.core.buffer.MediaBufferGroup,
              // com.samsung.android.sume.core.buffer.MediaBufferBase, android.os.Parcelable
    ...
    @Override // com.samsung.android.sume.core.buffer.MediaBufferGroup,
              // com.samsung.android.sume.core.buffer.MediaBufferBase,
              // com.samsung.android.sume.core.buffer.MediaBuffer
    public void release() {
        super.release();
    ...
    public String contentToString(Object obj) {
        return Def.taglnOf(obj)
                + Def.contentToStringln(
                        "    ",
                        "primary-buffer=" + this.primaryBuffer.contentToString(this.primaryBuffer),
                        "derivative-buffers=" + super.contentToString(MediaBufferGroup.class));
    }
