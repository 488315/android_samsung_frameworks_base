...
public abstract class MediaBufferGroup extends MediaBufferBase {
  ...
  public long size() {
    return ((Integer)
            Optional.ofNullable(this.buffers)
                .map(
                    new Function() { // from class:
                                     // com.samsung.android.sume.core.buffer.MediaBufferGroup$$ExternalSyntheticLambda2
        ...
        this.buffers.stream()
            .filter(
                new Predicate() { // from class:
                                  // com.samsung.android.sume.core.buffer.MediaBufferGroup$$ExternalSyntheticLambda0
  ...
  public MediaBuffer getExifBuffer() {
    return this.buffers.stream()
        .filter(
            new Predicate() { // from class:
                              // com.samsung.android.sume.core.buffer.MediaBufferGroup$$ExternalSyntheticLambda1
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
  ...
  public MediaBuffer getIccBuffer() {
    return this.buffers.stream()
        .filter(
            new Predicate() { // from class:
                              // com.samsung.android.sume.core.buffer.MediaBufferGroup$$ExternalSyntheticLambda5
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
    ...
    copied.buffers =
        (List)
            this.buffers.stream()
                .map(
                    new Function() { // from class:
                                     // com.samsung.android.sume.core.buffer.MediaBufferGroup$$ExternalSyntheticLambda7
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
  ...
  public MediaBuffer asRef() {
    ...
    this.buffers.forEach(
        new Consumer() { // from class:
                         // com.samsung.android.sume.core.buffer.MediaBufferGroup$$ExternalSyntheticLambda3
  ...
  public void release() {
    ...
    if (useCount > 0) {
      Log.m94d(
          TAG,
          "use count remained, skip release: "
              + this.sharedCount.get()
              + NavigationBarInflaterView.KEY_CODE_START
              + hashCode()
              + NavigationBarInflaterView.KEY_CODE_END);
      return;
  ...
  protected String dataToString() {
    return (String)
        IntStream.range(0, this.buffers.size())
            .mapToObj(
                new IntFunction() { // from class:
                                    // com.samsung.android.sume.core.buffer.MediaBufferGroup$$ExternalSyntheticLambda4
                  @Override // java.util.function.IntFunction
                  public final Object apply(int i) {
                    return MediaBufferGroup.this.m341xde53324e(i);
                  }
                })
  ...
  /* synthetic */ String m341xde53324e(int it) {
    return NavigationBarInflaterView.KEY_CODE_START
        + it
        + "-th)"
        + this.buffers.get(it).contentToString();
  }
            ...
            "format="
                + ((String)
                    Optional.ofNullable(this.format)
                        .map(new GenericMediaBuffer$$ExternalSyntheticLambda0())
                        .orElse("n/a")),
            "extra=" + Collections.singletonList(this.extra),
            "data[#" + this.buffers.size() + "]\n" + dataToString());
  }
