...
public class BufferExtension {
    ...
    private BufferExtension() {
        Registry registry = newRegistry().addDescribe(Number.class, new Function() { // from class: com.samsung.android.sume.core.buffer.BufferExtension$$ExternalSyntheticLambda21
            ...
            public final Object apply(Object obj) {
                ...
                mutableOf = MediaFormat.mutableOf(MediaType.NONE, Shape.m397of(1, ((ByteBuffer) obj).limit()));
                return mutableOf;
            }
    ...
    private <T1, T2> String findAvailableBinaryKey(final Class<T1> from, final Class<T2> to, final Map<String, TransformFunction> registry) {
        ...
        Optional<String> findFirst = registry.keySet().stream().filter(new Predicate() { // from class: com.samsung.android.sume.core.buffer.BufferExtension$$ExternalSyntheticLambda8
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return BufferExtension.this.m313x6a4f7af7(from, to, key, fromList, toList, (String) obj);
            }
        }).findFirst();
        ...
        TransformFunction found = (TransformFunction) findFirst.map(new Function() { // from class: com.samsung.android.sume.core.buffer.BufferExtension$$ExternalSyntheticLambda9
            ...
            @Override // java.util.function.Supplier
            public final Object get() {
                return BufferExtension.this.m316xecd8f412(fromList, toList, key, registry, from, to);
            }
        });
    ...
    /* synthetic */ boolean m313x6a4f7af7(Class from, Class to, String key, List fromList, List toList, String it) {
        try {
    ...
    /* synthetic */ TransformFunction m315xb8a1f6d4(List toList, final String key, final Map registry, final Pair it1) {
    ...
    /* synthetic */ TransformFunction m316xecd8f412(List fromList, final List toList, final String key, final Map registry, final Class from, final Class to) {
    ...
    static final class TransformFunction {
        ...
        TransformFunction(TransformFunction... transforms) {
            ...
            Arrays.asList(transforms).forEach(new Consumer() { // from class: com.samsung.android.sume.core.buffer.BufferExtension$TransformFunction$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    BufferExtension.TransformFunction.this.m322x3e8b297f((BufferExtension.TransformFunction) obj);
                }
            });
        }
