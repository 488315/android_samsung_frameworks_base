...
public final class MutableMediaBuffer extends MediaBufferBase implements PlaceHolder<MediaBuffer> {
                ...
                this.buffer.asList().stream()
                        .filter(
                                new Predicate() { // from class:
                                                  // com.samsung.android.sume.core.buffer.MutableMediaBuffer$$ExternalSyntheticLambda12
                                    @Override // java.util.function.Predicate
                                    public final boolean test(Object obj) {
                                        return MutableMediaBuffer.lambda$getMetaDataBuffers$4(
                                                (MediaBuffer) obj);
                                    }
                                })
                        ...
                        this.buffer.asList().stream()
                                .filter(
                                        new Predicate() { // from class:
                                            ...
                                            @Override // java.util.function.Predicate
                                            public final boolean test(Object obj) {
                                                return MutableMediaBuffer.lambda$setExifBuffer$7(
                                                        (MediaBuffer) obj);
                                            }
                                        })
                                .collect(Collectors.toList());
                        ...
                        this.buffer.asList().stream()
                                .filter(
                                        new Predicate() { // from class:
                                            ...
                                            @Override // java.util.function.Predicate
                                            public final boolean test(Object obj) {
                                                return MutableMediaBuffer.lambda$setIccBuffer$8(
                                                        (MediaBuffer) obj);
                                            }
                                        })
                                .collect(Collectors.toList());
    ...
    public boolean containsAnyExtra(String... keys) {
        return this.buffer != null
                ? this.buffer.containsAnyExtra(keys)
                : super.containsAnyExtra(keys);
    }
    ...
    public boolean containsAllExtra(String... keys) {
        return this.buffer != null
                ? this.buffer.containsAllExtra(keys)
                : super.containsAllExtra(keys);
    }
    ...
    public String contentToString(Object obj) {
        return Def.taglnOf(obj)
                + Def.contentToStringln(
                        "    ",
                        "format=" + (this.format != null ? this.format.contentToString() : "n/a"),
                        "data=" + this.buffer);
    }
