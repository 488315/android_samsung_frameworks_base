...
public class CollectBufferGroup extends MediaBufferGroup {
    ...
    public CollectBufferGroup(int primaryId, List<MediaBuffer> buffers) {
        super(buffers.isEmpty() ? MediaFormat.m394of(MediaType.NONE, new Object[0]) : buffers.get(primaryId).getFormat(), buffers);
    ...
    @Override // com.samsung.android.sume.core.buffer.MediaBufferGroup, com.samsung.android.sume.core.buffer.MediaBufferBase, android.p009os.Parcelable
