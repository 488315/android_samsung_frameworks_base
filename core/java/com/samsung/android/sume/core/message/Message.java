...
public class Message {
        ...
        if (publisher != null) {
            publisher.getChannels(this.code).forEach(new Consumer() { // from class: com.samsung.android.sume.core.message.Message$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    Message.this.m9217lambda$post$4$comsamsungandroidsumecoremessageMessage((MessageChannel) obj);
                }
            });
        }
        return this;
    ...
    /* synthetic */ void m9217lambda$post$4$comsamsungandroidsumecoremessageMessage(MessageChannel it) {
