...
public interface Shape extends Serializable, Parcelable, Copyable<Shape>, Comparable<Shape> {
    ...
    /* renamed from: of */
    static Shape m396of(int size) {
        return m398of(-1, 1, size, -1);
    }

    /* renamed from: of */
    static Shape m397of(int rows, int cols) {
        return m398of(-1, rows, cols, -1);
    }

    /* renamed from: of */
    static Shape m398of(int batch, int rows, int cols, int channels) {
