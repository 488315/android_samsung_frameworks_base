...
public interface MediaFormat extends Serializable, Cloneable {
  ...
  static MediaFormat imageOf(Object... args) {
    return m394of(MediaType.IMAGE, args);
  }

  static MediaFormat compressedImageOf(Object... args) {
    return m394of(MediaType.COMPRESSED_IMAGE, args);
  }

  static MediaFormat audioOf(Object... args) {
    return m394of(MediaType.AUDIO, args);
  }

  static MediaFormat compressedAudioOf(Object... args) {
    return m394of(MediaType.COMPRESSED_AUDIO, args);
  }

  static MediaFormat videoOf(Object... args) {
    return m394of(MediaType.VIDEO, args);
  }

  static MediaFormat compressedVideoOf(Object... args) {
    return m394of(MediaType.COMPRESSED_VIDEO, args);
  }
  ...
  static MediaFormat thumbnailOf(Object... args) {
    return m394of(MediaType.IMAGE, Shape.m397of(384, 512));
  }

  static MediaFormat scalarOf(Object... args) {
    return m394of(MediaType.SCALA, args);
  }

  /* renamed from: of */
  static MediaFormat m394of(MediaType mediaType, Object... args) {
  ...
  static MediaFormat mutableThumbnailOf(Object... args) {
    return mutableOf(MediaType.IMAGE, Shape.m397of(384, 512));
  }
  ...
  static List<MediaFormat> getPlanes(MediaFormat mediaFormat) {
    if (mediaFormat.getMediaType().isImage()) {
        ...
        if (mediaFormat.getColorFormat().isYuv()) {
          ...
          final Shape chromaShape =
              mediaFormat
                  ...
                  .setChannels(mediaFormat.getColorFormat().numberOfChromaChannels())
                  .toShape();
          planes.add(mutableImageOf(DataType.m467of(depth, 1), mediaFormat.getShape()));
      ...
      return new ArrayList<
          MediaFormat>() { // from class: com.samsung.android.sume.core.format.MediaFormat.1
        {
