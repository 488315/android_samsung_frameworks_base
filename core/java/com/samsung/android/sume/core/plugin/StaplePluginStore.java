...
class StaplePluginStore extends PluginStore {
    ...
    public PluginStore add(PluginFixture<?> fixture) {
        MFDescriptor descriptor = (MFDescriptor) Stream.of((Object[]) new Optional[]{Optional.ofNullable(fixture.getDescriptorLoader()).map(new Function() { // from class: com.samsung.android.sume.core.plugin.StaplePluginStore$$ExternalSyntheticLambda2
            ...
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return StaplePluginStore.this.m454xccf3d0d6((DescriptorStreamLoader) obj);
            }
    ...
    /* synthetic */ Optional m454xccf3d0d6(final DescriptorStreamLoader e) {
        return Optional.ofNullable(this.context).map(new Function() { // from class: com.samsung.android.sume.core.plugin.StaplePluginStore$$ExternalSyntheticLambda5
            ...
            public final Object apply(Object obj) {
                MFDescriptor parse;
                parse = MFDescriptorParser.m357of(MFDescriptorParser.Type.JSON).parse(DescriptorStreamLoader.this.load((Context) obj));
                return parse;
            }
        });
    }
