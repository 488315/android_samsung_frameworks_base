...
public class ImgpPlugin extends PluginFixture<ImgpPlugin> {
  ...
  public Operator getImgProcessor(Enum<?> type) {
    if (type == ImgpType.ANY) {
      return OperatorWrapper.m411of(this.processorMap);
    }
    if (this.processorMap.containsKey(type)) {
      return OperatorWrapper.m410of(type, this.processorMap.get(type));
    }
    return null;
  }
            ...
            .map(
                new Function() { // from class:
                  ...
                  public final Object apply(Object obj) {
                    return ImgpPlugin.this.m442x24c2933((Enum) obj);
                  }
                })
            .orElse(null);
  }
  ...
  /* synthetic */ Operator m442x24c2933(Enum it) {
    return OperatorWrapper.m410of(it, this.processorMap.get(it));
  }
              ...
              Arrays.stream(plugins)
                  ...
                  .collect(
                      Collectors.toMap(
                          ...
                          new OperatorMap$$ExternalSyntheticLambda1(),
                          new BinaryOperator() { // from class:
                            ...
                            public final Object apply(Object obj, Object obj2) {
                              return ImgpPlugin.ImgpPluginGroup.lambda$new$1(
                                  (Operator) obj, (Operator) obj2);
                            }
                          },
