...
public class UniImgp {
  ...
  public static class Option extends OptionBase {
    public static final Parcelable.Creator<Option> CREATOR =
        new Parcelable.Creator<
            Option>() { // from class: com.samsung.android.sume.solution.filter.UniImgp.Option.1
  ...
  public static PluginStore getGlobalStore() {
    if (globalStore == null) {
      synchronized (PluginStore.class) {
        if (globalStore == null) {
          globalStore = PluginStore.m447of();
  ...
  private UniImgp(Option option) {
    ...
    builder
        .addPluginStore(
            (PluginStore) Optional.ofNullable(option.getPluginStore()).orElse(getGlobalStore()))
        .addDefaultCreators();
    this.option = option;
  ...
  /* renamed from: of */
  public static UniImgp m470of() {
    return new UniImgp();
  }

  /* renamed from: of */
  public static UniImgp m471of(Option option) {
