    ...
    public void updateVisibleRect(int type) {
        ...
        if (resource != null) {
            if (type == 15 || type == 16 || type == 17) {
                this.mVisibleRect.left = resource.getDimensionPixelSize(C4337R.dimen.cover_clear_view_left);
                this.mVisibleRect.top = resource.getDimensionPixelSize(C4337R.dimen.cover_clear_view_top);
                this.mVisibleRect.right = resource.getDimensionPixelSize(C4337R.dimen.cover_clear_view_right);
                this.mVisibleRect.bottom = resource.getDimensionPixelSize(C4337R.dimen.cover_clear_view_bottom);
            }
            ...
            Log.m94d(TAG, "updateVisibility type= " + type + " defaultDensity= " + defaultDensity + " currentDensity= " + currentDensity + " ratio= " + ratio + " mVisibleRect left= " + this.mVisibleRect.left + " mVisibleRect top= " + this.mVisibleRect.top + " mVisibleRect right= " + this.mVisibleRect.right + " mVisibleRect bottom= " + this.mVisibleRect.bottom);
        }
    }
