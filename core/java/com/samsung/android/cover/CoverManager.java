...
public class CoverManager {
    ...
    private synchronized ICoverManager getService() {
        if (this.mService == null) {
            ...
            if (asInterface == null) {
                Slog.m121w(TAG, "warning: no COVER_MANAGER_SERVICE");
            }
        }
    ...
    public void setCoverModeToWindow(Window window, int coverMode) {
        if (!isSupportSViewCover()) {
            Log.m102w(TAG, "setSViewCoverModeToWindow : This device is not supported s view cover");
            return;
        }
    ...
    public void registerListener(StateListener listener) {
        Log.m94d(TAG, "registerListener");
        if (!isSupportCover()) {
            Log.m102w(TAG, "registerListener : This device is not supported cover");
            return;
        }
        if (Process.myUid() != 1000) {
            throw new SecurityException("CoverManager only available from system UID.");
    ...
    public void unregisterListener(StateListener listener) {
        Log.m94d(TAG, "unregisterListener");
        if (!isSupportCover()) {
            Log.m102w(TAG, "unregisterListener : This device is not supported cover");
            return;
        }
        if (Process.myUid() != 1000) {
            throw new SecurityException("CoverManager only available from system UID.");
        ...
        try {
            ...
            Log.m97e(TAG, "RemoteException in unregisterListener: ", e);
        }
    }
    ...
    public CoverState getCoverState() {
        if (!isSupportCover()) {
            Log.m102w(TAG, "getCoverState : This device is not supported cover");
            return null;
        }
        if (Process.myUid() != 1000) {
            throw new SecurityException("CoverManager only available from system UID.");
        ...
        try {
            ...
            if (svc != null) {
                ...
                Log.m96e(TAG, "getCoverState : coverState is null");
            }
        } catch (RemoteException e) {
    ...
    public void sendDataToCover(int command, byte[] data) {
        ...
        if (svc != null) {
            try {
                ...
                Log.m97e(TAG, "RemoteException in sendData : ", e);
            }
        }
    }
    ...
    public void sendDataToNfcLedCover(int command, byte[] data) {
        ...
        if (svc != null) {
            try {
                ...
                Log.m97e(TAG, "RemoteException in sendData to NFC : ", e);
            }
        }
    }
    ...
    public void sendPowerKeyToCover() {
        ...
        if (svc != null) {
            try {
                ...
                Log.m97e(TAG, "RemoteException in sendPowerKeyToCover() : ", e);
            }
        }
    }
    ...
    public boolean isCoverManagerDisabled() {
        try {
            ...
            Log.m97e(TAG, "RemoteException in isCoverManagerDisabled : ", e);
            return false;
        }
    }
    ...
    public void disableCoverManager(boolean disable) {
        try {
            ...
            Log.m97e(TAG, "RemoteException in disalbeCoverManager : ", e);
        }
    }
    ...
    public void registerNfcTouchListener(int type, NfcLedCoverTouchListener listener) {
        Log.m94d(TAG, "registerNfcTouchListener");
        if (!isSupportNfcLedCover()) {
            Log.m102w(TAG, "registerNfcTouchListener : This device does not support NFC Led cover");
            return;
        }
        if (Process.myUid() != 1000) {
            throw new SecurityException("CoverManager only available from system UID.");
        ...
        if (listener == null) {
            Log.m102w(TAG, "registerNfcTouchListener : listener is null");
            return;
        }
        ...
        try {
            ...
            Log.m97e(TAG, "RemoteException in registerNfcTouchListener: ", e);
        }
    }

    public void unregisterNfcTouchListener(NfcLedCoverTouchListener listener) {
        Log.m94d(TAG, "unregisterNfcTouchListener");
        if (!isSupportNfcLedCover()) {
            Log.m102w(TAG, "unregisterNfcTouchListener : This device does not support NFC Led cover");
            return;
        }
        if (Process.myUid() != 1000) {
            throw new SecurityException("CoverManager only available from system UID.");
        ...
        if (listener == null) {
            Log.m102w(TAG, "unregisterNfcTouchListener : listener is null");
            return;
        }
        NfcLedCoverTouchListenerDelegate nfcTouchListener = null;
        Iterator<NfcLedCoverTouchListenerDelegate> i = this.mNfcLedCoverTouchListenerDelegates.iterator();
        ...
        try {
            ...
            Log.m97e(TAG, "RemoteException in unregisterNfcTouchListener: ", e);
        }
    }

    public void addLedNotification(Bundle data) {
        Log.m94d(TAG, "addLedNotification");
        if (!isSupportNfcLedCover()) {
            Log.m102w(TAG, "addLedNotification : This device does not support NFC Led cover");
            return;
        }
        if (Process.myUid() != 1000) {
            throw new SecurityException("CoverManager only available from system UID.");
        ...
        if (data == null) {
            Log.m96e(TAG, "addLedNotification : Null notification data!");
            return;
        }
        ICoverManager svc = getService();
        if (svc != null) {
            try {
                ...
                Log.m97e(TAG, "addLedNotification in sendData to NFC : ", e);
            }
        }
    }

    public void removeLedNotification(Bundle data) {
        Log.m94d(TAG, "removeLedNotification");
        if (!isSupportNfcLedCover()) {
            Log.m102w(TAG, "removeLedNotification : This device does not support NFC Led cover");
            return;
        }
        if (Process.myUid() != 1000) {
            throw new SecurityException("CoverManager only available from system UID.");
        ...
        if (data == null) {
            Log.m96e(TAG, "removeLedNotification : Null notification data!");
            return;
        }
        ICoverManager svc = getService();
        if (svc != null) {
            try {
                ...
                Log.m97e(TAG, "removeLedNotification in sendData to NFC : ", e);
            }
        }
    }
    ...
    public void sendSystemEvent(Bundle data) {
        if (!isSupportCover()) {
            Log.m102w(TAG, "sendSystemEvent : This device does not support cover");
            return;
        }
        if (!isSupportNfcLedCover()) {
            Log.m102w(TAG, "sendSystemEvent : This device does not support NFC Led cover");
            return;
        }
        if (data == null) {
            Log.m96e(TAG, "sendSystemEvent : Null system event data!");
            return;
        }
        ICoverManager svc = getService();
        if (svc != null) {
            try {
                ...
                Log.m97e(TAG, "sendSystemEvent in sendData to NFC : ", e);
            }
        }
    }
    ...
    public void registerLedSystemListener(LedSystemEventListener listener) {
        if (!isSupportCover()) {
            Log.m102w(TAG, "registerLedSystemListener : This device does not support cover");
            return;
        }
        Log.m94d(TAG, "registerLedSystemListener");
        if (!isSupportNfcLedCover()) {
            Log.m102w(TAG, "registerLedSystemListener : This device does not support NFC Led cover");
            return;
        }
        if (listener == null) {
            Log.m102w(TAG, "registerLedSystemListener : listener is null");
            return;
        }
        ...
        try {
            ...
            Log.m97e(TAG, "RemoteException in registerLedSystemListener: ", e);
        }
    }

    public void unregisterLedSystemEventListener(LedSystemEventListener listener) {
        Log.m94d(TAG, "unregisterLedSystemEventListener");
        if (!isSupportCover()) {
            Log.m102w(TAG, "unregisterLedSystemEventListener : This device does not support cover");
            return;
        }
        if (!isSupportNfcLedCover()) {
            Log.m102w(TAG, "unregisterLedSystemEventListener : This device does not support NFC Led cover");
            return;
        }
        if (listener == null) {
            Log.m102w(TAG, "unregisterLedSystemEventListener : listener is null");
            return;
        }
        LedSystemEventListenerDelegate ledSystemEventListener = null;
        Iterator<LedSystemEventListenerDelegate> i = this.mLedSystemEventListenerDelegates.iterator();
        ...
        try {
            ...
            Log.m97e(TAG, "RemoteException in unregisterLedSystemEventListener: ", e);
        }
    }
    ...
    public void registerCoverPowerKeyListener(CoverPowerKeyListener listener) {
        if (!isSupportCover()) {
            Log.m102w(TAG, "registerCoverPowerKeyListener : This device does not support cover");
            return;
        }
        Log.m94d(TAG, "registerCoverPowerKeyListener");
        if (!isSupportFlipCover()) {
            Log.m102w(TAG, "registerLedSystemListener : This device does not support Flip cover");
            return;
        }
        if (listener == null) {
            Log.m102w(TAG, "registerCoverPowerKeyListener : listener is null");
            return;
        }
        ...
        try {
            ...
            Log.m97e(TAG, "RemoteException in registerCoverPowerKeyListener: ", e);
        }
    }

    public void unregisterCoverPowerKeyListener(CoverPowerKeyListener listener) {
        Log.m94d(TAG, "unregisterCoverPowerKeyListener");
        if (!isSupportCover()) {
            Log.m102w(TAG, "unregisterCoverPowerKeyListener : This device does not support cover");
            return;
        }
        Log.m94d(TAG, "unregisterCoverPowerKeyListener");
        if (!isSupportFlipCover()) {
            Log.m102w(TAG, "unregisterCoverPowerKeyListener : This device does not support Flip Cover");
            return;
        }
        if (listener == null) {
            Log.m102w(TAG, "unregisterCoverPowerKeyListener : listener is null");
            return;
        }
        CoverPowerKeyListenerDelegate powerKeyEventListener = null;
        Iterator<CoverPowerKeyListenerDelegate> i = this.mCoverPowerKeyListenerDelegates.iterator();
        ...
        try {
            ...
            Log.m97e(TAG, "RemoteException in unregisterCoverPowerKeyListener: ", e);
        }
    }
    ...
    public boolean disableLcdOffByCover(StateListener listener) {
        if (!isSupportCover()) {
            Log.m102w(TAG, "disableLcdOffByCover : This device does not support cover");
            return false;
        }
        if (listener == null) {
            Log.m102w(TAG, "disableLcdOffByCover : listener cannot be null");
            return false;
        }
        Log.m94d(TAG, "disableLcdOffByCover");
        CoverListenerDelegate coverListener = null;
    ...
    public boolean enableLcdOffByCover(StateListener listener) {
        if (!isSupportCover()) {
            Log.m102w(TAG, "enableLcdOffByCover : This device does not support cover");
            return false;
        }
        if (listener == null) {
            Log.m102w(TAG, "enableLcdOffByCover : listener cannot be null");
            return false;
        }
        Log.m94d(TAG, "enableLcdOffByCover");
        CoverListenerDelegate coverListener = null;
        Iterator<CoverListenerDelegate> i = this.mLcdOffDisableDelegates.iterator();
        while (true) {
            if (!i.hasNext()) {
        ...
        if (coverListener == null) {
            Log.m96e(TAG, "enableLcdOffByCover: Matching listener not found, cannot enable");
            return false;
        }
        try {
            ICoverManager svc = getService();
