...
public class VEController extends Element {
    ...
    public void handleError(int errorType, Object extension) {
        Log.m96e(this.TAG, "handleExecuteError with errorType : " + errorType + ", extension : " + extension);
        ...
        switch (C53812.$SwitchMap$com$samsung$vekit$Common$Type$ElementType[type.ordinal()]) {
            case 1:
                ...
                if (listener != null) {
                    ...
                    Log.m98i(this.TAG, "handleItemError itemErrorType : " + itemErrorType + ", elementType : " + elementType + ", elementId : " + elementId);
            ...
            case 4:
            case 5:
                Log.m98i(this.TAG, "Unsupported listener error handling ElementType : " + elementType + ", errorType : " + errorType);
                break;
            default:
    ...
    private class AnimationEventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (C53812.$SwitchMap$com$samsung$vekit$Animation$Animation$AnimationStatus[status.ordinal()]) {
                case 2:
    ...
    public void setExportInfo(ExportInfo info) {
        Log.m98i(this.TAG, "setExportInfo  width : " + info.getWidth() + " height : " + info.getHeight() + " fd : " + info.getFd());
