...
public class Panel {
  ...
  public Panel setMatrix(Matrix4 matrix) {
    ...
    Log.m94d(
        "Panel",
        "scale : " + this.scale.getX() + ", " + this.scale.getY() + ", " + this.scale.getZ());
    Log.m94d(
        "Panel",
        "position : "
            + this.position.getX()
  ...
  public Panel setRotation(Vector3<Float> rotation) {
    ...
    quaternion.setRotation(
        rotation.getX().floatValue(), rotation.getY().floatValue(), rotation.getZ().floatValue());
    updateMatrix();
    return this;
  }
  ...
  public Panel translate(Vector3<Float> position) {
    return translate(
        position.getX().floatValue(), position.getY().floatValue(), position.getZ().floatValue());
  }
