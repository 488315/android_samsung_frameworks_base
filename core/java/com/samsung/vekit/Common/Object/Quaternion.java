...
public class Quaternion {
    ...
    public Quaternion multiply(float scalar) {
        return new Quaternion(this.f3101x * scalar, this.f3102y * scalar, this.f3103z * scalar, this.f3100w * scalar);
    }
    ...
    public Quaternion add(Quaternion quaternion) {
        return new Quaternion(this.f3101x + quaternion.f3101x, this.f3102y + quaternion.f3102y, this.f3103z + quaternion.f3103z, this.f3100w + quaternion.f3100w);
    }
    ...
    public float dot(Quaternion quaternion) {
        return (float) ((this.f3101x * quaternion.f3101x) + (this.f3102y * quaternion.f3102y) + (this.f3103z * quaternion.f3103z) + (this.f3100w * quaternion.f3100w));
    }
