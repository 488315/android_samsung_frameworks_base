...
public class NativeInterfaceWrapper {
  ...
  public synchronized void createFramework(VEController controller) throws IllegalAccessException {
    ...
    if (stateInterface.getState() == VEKitState.CREATE) {
      Log.m96e(
          this.TAG, "createFramework invalid state. currentState = " + stateInterface.getState());
      return;
    }
  ...
  public synchronized void initializeFramework(
    ...
    Log.m96e(
        this.TAG, "initializeFramework invalid state. currentState = " + stateInterface.getState());
  }
  ...
  public synchronized void finalizeFramework() {
    ...
    Log.m96e(
        this.TAG, "finalizeFramework invalid state. currentState = " + stateInterface.getState());
  }
  ...
  public synchronized void releaseFramework() {
    ...
    if (stateInterface.getState() == VEKitState.DESTROY) {
      Log.m96e(
          this.TAG, "releaseFramework invalid state. currentState = " + stateInterface.getState());
      return;
    }
  ...
  public void updateViewport(int x, int y, int width, int height) {
    synchronized (this) {
      ...
      Log.m96e(
          this.TAG, "updateViewport invalid state. currentState = " + stateInterface.getState());
    }
  }
  ...
  public void attachAnimation(Element element, int animationId) {
    synchronized (this) {
      ...
      if (stateInterface.getState() == VEKitState.DESTROY) {
        Log.m96e(
            this.TAG, "attachAnimation invalid state. currentState = " + stateInterface.getState());
      } else {
  ...
  public void detachAnimation(Element element, int animationId) {
    synchronized (this) {
      ...
      if (stateInterface.getState() == VEKitState.DESTROY) {
        Log.m96e(
            this.TAG, "detachAnimation invalid state. currentState = " + stateInterface.getState());
      } else {
  ...
  public void clearAnimations(Element element) {
    synchronized (this) {
      ...
      if (stateInterface.getState() == VEKitState.DESTROY) {
        Log.m96e(
            this.TAG, "clearAnimations invalid state. currentState = " + stateInterface.getState());
      } else {
  ...
  public void cancelAnimation() {
    synchronized (this) {
      ...
      Log.m96e(
          this.TAG, "cancelAnimation  invalid state. currentState = " + stateInterface.getState());
    }
  }
  ...
  public Bitmap captureAnimatedFrame(Element element, int width, int height) {
    synchronized (this) {
      ...
      Log.m96e(
          this.TAG,
          "captureAnimatedFrame invalid state. currentState = " + stateInterface.getState());
      return null;
    }
  }
  ...
  public Bitmap captureLatestFrame(int width, int height) {
    synchronized (this) {
      ...
      Log.m96e(
          this.TAG,
          "captureLatestFrame invalid state. currentState = " + stateInterface.getState());
      return null;
    }
  }
  ...
  public Bitmap captureStaticDoodle(Element element, int width, int height) {
    synchronized (this) {
      ...
      Log.m96e(
          this.TAG,
          "captureStaticDoodle invalid state. currentState = " + stateInterface.getState());
      return null;
    }
  }
  ...
  public long getCurrentMediaPosition() {
    synchronized (this) {
      ...
      Log.m96e(
          this.TAG,
          "getCurrentMediaPosition invalid state. currentState = " + stateInterface.getState());
      return 0L;
    }
  }
  ...
  public void setExportInfo(ExportInfo info) {
    synchronized (this) {
      ...
      Log.m96e(
          this.TAG, "setExportInfo invalid state. currentState = " + stateInterface.getState());
    }
  }
  ...
  public long getExportPosition() {
    synchronized (this) {
      ...
      Log.m96e(
          this.TAG, "getExportPosition invalid state. currentState = " + stateInterface.getState());
      return 0L;
    }
  }
  ...
  public void attachStroke(Element element, DoodleStroke stroke) {
    synchronized (this) {
      ...
      if (stateInterface.getState() == VEKitState.DESTROY) {
        Log.m96e(
            this.TAG, "attachStroke invalid state. currentState = " + stateInterface.getState());
      } else {
  ...
  public void detachStroke(Element element) {
    synchronized (this) {
      ...
      if (stateInterface.getState() == VEKitState.DESTROY) {
        Log.m96e(
            this.TAG, "detachStroke invalid state. currentState = " + stateInterface.getState());
      } else {
  ...
  public FrcSupportInfo getFrcSupportInfo(int viewMode) {
    synchronized (this) {
      ...
      if (stateInterface.getState() == VEKitState.DESTROY) {
        Log.m96e(
            this.TAG,
            "getFrcSupportInfo invalid state. currentState = " + stateInterface.getState());
        return null;
      }
