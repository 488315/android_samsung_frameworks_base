...
public class Layer extends Element implements HierarchyInterface<Item> {
  ...
  public Animation<?> getAnimation(int index) {
    if (this.animationList.size() <= index || index < 0) {
      Log.m96e(this.TAG, "failed to get animation (invalid index)");
      return null;
    }
  ...
  public int getAnimationIndex(Animation<?> animation) {
    if (animation == null) {
      Log.m96e(this.TAG, "failed to getAnimationIndex (animation is null)");
      return -1;
    }
  ...
  public TransitionAnimation getTransitionAnimation(int index) {
    if (this.transitionAnimationList.size() <= index || index < 0) {
      Log.m96e(this.TAG, "failed to get transitionAnimation (invalid index)");
      return null;
    }
  ...
  public int getTransitionAnimationIndex(Animation<?> animation) {
    if (animation == null) {
      Log.m96e(this.TAG, "failed to getTransitionAnimationIndex (animation is null)");
      return -1;
    }
