    ...
    public long calculateTotalDuration() {
        ...
        while (true) {
            ...
            if (this.context.getFrameworkType() == FrameworkType.SINGLE) {
                ...
                Log.m98i(this.TAG, "total duration : " + this.totalDuration + "layerDuration : " + layerDuration);
                this.totalDuration = Math.max(this.totalDuration, layerDuration);
            }
        }
        Log.m98i(this.TAG, "Final total duration : " + this.totalDuration + ", FrameworkMode : " + this.context.getFrameworkType().toString());
