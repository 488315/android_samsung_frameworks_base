...
public class BargeInEngine {
    ...
    public static int init() {
        try {
            String str = TAG;
            Log.m98i(str, "Trying to load libVoiceCommandEngine.so");
            System.loadLibrary("VoiceCommandEngine");
            Log.m98i(str, "Loading libVoiceCommandEngine.so");
            return 0;
        } catch (Exception e) {
            Log.m96e(TAG, "WARNING: Could not load libVoiceCommandEngine.so");
            return -1;
