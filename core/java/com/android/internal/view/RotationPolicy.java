...
public final class RotationPolicy {
    ...
    public static boolean isRotationSupported(Context context) {
        ...
        return pm.hasSystemFeature(PackageManager.FEATURE_SENSOR_ACCELEROMETER)
                ...
                && context.getResources().getBoolean(R.bool.config_supportAutoRotation);
    }
    ...
    public static void setRotationLockAtAngle(
            Context context, boolean enabled, int rotation, String caller) {
    ...
    private static boolean areAllRotationsAllowed(Context context) {
        return CoreRune.FW_ALLOW_ALL_ROTATION
                || context.getResources().getBoolean(R.bool.config_allowAllRotations);
    }
    ...
    private static void setRotationLock(
            final boolean enabled, final int rotation, final String caller) {
        AsyncTask.execute(
