...
public final class RotationPolicy {
  ...
  public abstract static class RotationPolicyListener {
  ...
  public static boolean isRotationSupported(Context context) {
    ...
    return pm.hasSystemFeature(PackageManager.FEATURE_SENSOR_ACCELEROMETER)
        ...
        && context.getResources().getBoolean(C4337R.bool.config_supportAutoRotation);
  }
  ...
  public static int getRotationLockOrientation(Context context) {
    ...
    try {
      ...
      Log.m102w(TAG, "Unable to get rotation lock orientation");
  ...
  public static boolean isRotationLocked(Context context) {
    return Settings.System.getIntForUser(
            context.getContentResolver(), Settings.System.ACCELEROMETER_ROTATION, 0, -2)
        == 0;
  }
  ...
  private static boolean areAllRotationsAllowed(Context context) {
    return CoreRune.FW_ALLOW_ALL_ROTATION
        || context.getResources().getBoolean(C4337R.bool.config_allowAllRotations);
  }
  ...
  private static void setRotationLock(final boolean enabled, final int rotation) {
    AsyncTask.execute(
        new Runnable() { // from class: com.android.internal.view.RotationPolicy.1
          ...
          public void run() {
            try {
              ...
              Log.m102w(RotationPolicy.TAG, "Unable to save auto-rotate setting");
            }
          }
        });
  }

  public static void registerRotationPolicyListener(
      Context context, RotationPolicyListener listener) {
    registerRotationPolicyListener(context, listener, UserHandle.getCallingUserId());
  }

  public static void registerRotationPolicyListener(
      Context context, RotationPolicyListener listener, int userHandle) {
    context
        .getContentResolver()
    ...
    context
        .getContentResolver()
        .registerContentObserver(
            Settings.System.getUriFor(Settings.System.HIDE_ROTATION_LOCK_TOGGLE_FOR_ACCESSIBILITY),
            false,
            listener.mObserver,
            userHandle);
  }

  public static void unregisterRotationPolicyListener(
      Context context, RotationPolicyListener listener) {
