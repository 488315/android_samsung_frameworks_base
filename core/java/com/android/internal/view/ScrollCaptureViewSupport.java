...
public class ScrollCaptureViewSupport<V extends View> implements ScrollCaptureCallback {
  ...
  ScrollCaptureViewSupport(V containingView, ScrollCaptureViewHelper<V> viewHelper) {
    ...
    Log.m94d(TAG, "screenshot.scroll_capture_delay = " + j);
  }
  ...
  public final void onScrollCaptureImageRequest(
    ...
    if (signal.isCanceled()) {
      Log.m102w(TAG, "onScrollCaptureImageRequest: cancelled!");
      return;
    }
          ...
          new Consumer() { // from class:
            ...
            public final void accept(Object obj) {
              ScrollCaptureViewSupport.this.lambda$onScrollCaptureImageRequest$0(
                  view, signal, onComplete, (ScrollCaptureViewHelper.ScrollResult) obj);
            }
          });
    }
  }
  ...
  public void lambda$onScrollCaptureImageRequest$0(
      ...
      final Consumer<Rect> onComplete) {
    if (signal.isCanceled()) {
      Log.m102w(TAG, "onScrollCaptureImageRequest: cancelled! skipping render.");
    } else {
  ...
  public void lambda$onScrollResult$1(
    ...
    if (result == 0 || result == 1) {
      ...
      Log.m96e(TAG, "syncAndDraw(): SyncAndDrawResult = " + result);
      onComplete.accept(new Rect());
    }
  }
