...
public class TooltipPopup {
    ...
    View inflate =
        z
            ? LayoutInflater.from(this.mContext)
                .inflate(C4337R.layout.sem_tooltip, (ViewGroup) null)
            : LayoutInflater.from(this.mContext).inflate(C4337R.layout.tooltip, (ViewGroup) null);
  ...
  private void computePosition(
    ...
    int tooltipPreciseAnchorThreshold =
        this.mContext
            .getResources()
            .getDimensionPixelOffset(C4337R.dimen.tooltip_precise_anchor_threshold);
    ...
    if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
      int offsetExtra =
          this.mContext
              .getResources()
              .getDimensionPixelOffset(C4337R.dimen.tooltip_precise_anchor_extra_offset);
    ...
    int tooltipOffset =
        this.mContext
            ...
            .getDimensionPixelOffset(
                fromTouch
                    ? C4337R.dimen.tooltip_y_offset_touch
                    : C4337R.dimen.tooltip_y_offset_non_touch);
    View appView2 =
        WindowManagerGlobal.getInstance().getWindowView(anchorView.getApplicationWindowToken());
    if (appView2 != null) {
      appView = appView2;
    } else {
      ViewRootImpl viewRootImpl = anchorView.getViewRootImpl();
  ...
  private void semUpdateMaxWidth() {
    ...
    if (mTmpValue.type == 5) {
      ...
      tooltipMaxWidth =
          (int) mTmpValue.getFraction(displayMetrics.widthPixels, displayMetrics.widthPixels);
    }
  ...
  */
  private void semComputePositionForMultiWindow(
    ...
    int tooltipHorizontalPadding =
        this.mContext
            .getResources()
            .getDimensionPixelOffset(C4337R.dimen.sem_hover_tooltip_popup_left_margin);
    ...
    if (this.mIsDexMode) {
      SemDesktopModeManager desktopModeManager =
          (SemDesktopModeManager) applicationContext.getSystemService(SemDesktopModeManager.class);
          ...
          if (displays == null && displays.length > 0 && displays[0] != null) {
            ...
            screenHeight =
                maxBounds.height()
                    - this.mContext
                        .getResources()
                        .getDimensionPixelOffset(C4337R.dimen.task_bar_height);
          }
        }
    ...
    if (isSplitWindow()
        ...
        && appWidth
            >= this.mContext
                .getResources()
                .getDimensionPixelOffset(C4337R.dimen.default_minimal_size_resizable_task)) {
      tooltipWidth = appWidth;
    }
    ...
    if (CoreRune.MW_CAPTION_SHELL_DEX) {
      if (this.mIsDexMode && isFullScreen()) {
        yAbove =
            (this.mTmpAnchorPos[1] - tooltipHeight)
                - this.mContext
                    .getResources()
                    .getDimensionPixelOffset(
                        C4337R.dimen.sec_decor_caption_height_desktop_fullscreen);
        ...
        if (!fromTouch && !this.mIsDexMode) {
          if (anchorView.getLayoutDirection() == 0) {
            ...
            outParams.f573x =
                ((i + offsetX) - ((displayFrame.width() + tooltipWidth) / 2))
            ...
            popupRightPosX = popupLeftPosX + tooltipWidth;
            outParams.f573x =
                ((i2 + offsetX) - ((displayFrame.width() - tooltipWidth) / 2))
                    - tooltipHorizontalPadding;
          }
          if (yBelow + tooltipHeight > this.mTmpDisplayFrame.height()
              && !this.mIsCaptionMenuButton
              && !this.mIsCaptionPopupButton) {
            outParams.f574y = yAbove;
          } else {
            outParams.f574y = yBelow;
          }
        ...
        if (rotation != 3) {
          if (leftInset != 0) {
            navigationBarHeight =
                this.mContext
                    .getResources()
                    .getDimensionPixelOffset(C4337R.dimen.navigation_bar_height_landscape);
          ...
          if (rotation == 0 && !this.mIsDexMode) {
            navigationBarHeight =
                this.mContext
                    .getResources()
                    .getDimensionPixelOffset(C4337R.dimen.navigation_bar_height);
        ...
        if (!this.mIsDexMode) {
          navigationBarHeight =
              this.mContext.getResources().getDimensionPixelOffset(C4337R.dimen.task_bar_height);
          tooltipBottomOutArea += navigationBarHeight;
        ...
        if (this.mTmpDisplayFrame.width() >= tooltipWidth
            || displayFrame.height() < tooltipHeight
            || tooltipRightOutArea > 0) {
  ...
  private boolean isFullScreen() {
    ...
    return windowConfiguration.hasWindowDecorCaption()
