...
public final class FloatingActionMode extends ActionMode {
  ...
  public FloatingActionMode(
    ...
    setType(1);
    defaultShowAsAction.setCallback(
        new MenuBuilder.Callback() { // from class: com.android.internal.view.FloatingActionMode.3
    ...
    this.mBottomAllowance =
        Math.max(
            context
                .getResources()
                .getDimensionPixelSize(C4337R.dimen.content_rect_bottom_clip_allowance),
            context
                .getResources()
                .getDimensionPixelSize(C4337R.dimen.tw_edittext_field_handler_min_width));
  ...
  public void setFloatingToolbar(FloatingToolbar floatingToolbar) {
    FloatingToolbar onMenuItemClickListener =
        floatingToolbar
            .setMenu(this.mMenu)
                ...
                new MenuItem
                  ...
                  public final boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    lambda$setFloatingToolbar$0 =
                        FloatingActionMode.this.lambda$setFloatingToolbar$0(menuItem);
                    return lambda$setFloatingToolbar$0;
                  }
                });
    this.mFloatingToolbar = onMenuItemClickListener;
    FloatingToolbarVisibilityHelper floatingToolbarVisibilityHelper =
        new FloatingToolbarVisibilityHelper(onMenuItemClickListener);
  ...
  private void repositionToolbar() {
    ...
    if (isContentRectWithinBounds()) {
      ...
      rect2.set(
          Math.max(rect2.left, this.mViewRectOnScreen.left),
  ...
  private boolean isContentRectWithinBounds() {
    ...
    this.mScreenRect.set(0, 0, this.mDisplaySize.f85x, this.mDisplaySize.f86y);
  ...
  private static final class FloatingToolbarVisibilityHelper {
    ...
    public void setMoving(boolean moving) {
      boolean showingLongEnough =
          System.currentTimeMillis() - this.mLastShowTime > MIN_SHOW_DURATION_FOR_MOVE_HIDE;
  ...
  public Point getContentRectOnScreen() {
    ...
    return new Point(
        this.mContentRectOnScreen.centerX() - movedPos.f85x,
        this.mContentRectOnScreen.centerY() - movedPos.f86y);
  }
}
