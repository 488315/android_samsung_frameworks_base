...
public final class FloatingActionMode extends ActionMode {
    ...
    public FloatingActionMode(Context context, ActionMode.Callback2 callback, View originatingView, FloatingToolbar floatingToolbar) {
        ...
        this.mBottomAllowance = Math.max(context.getResources().getDimensionPixelSize(C4337R.dimen.content_rect_bottom_clip_allowance), context.getResources().getDimensionPixelSize(C4337R.dimen.tw_edittext_field_handler_min_width));
    ...
    public Point getContentRectOnScreen() {
        ...
        return new Point(this.mContentRectOnScreen.centerX() - movedPos.f85x, this.mContentRectOnScreen.centerY() - movedPos.f86y);
    }
}
