...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    ...
    public StandardMenuPopup(Context context, MenuBuilder menu, View anchorView, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        if (this.mIsParentThemeDeviceDefault) {
            ...
            this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C4337R.dimen.config_prefDialogWidth));
        }
    ...
    private boolean tryShow() {
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            if (this.mIsParentThemeDeviceDefault) {
                titleItemView = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C4337R.layout.sem_popup_menu_header_item_layout, (ViewGroup) listView, false);
            } else {
                titleItemView = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C4337R.layout.popup_menu_header_item_layout, (ViewGroup) listView, false);
            }
