...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public CascadingMenuPopup(Context context, View anchor, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        if (z) {
            ...
            this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C4337R.dimen.config_prefDialogWidth));
        }
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = this.mIsParentThemeDeviceDefault ? (FrameLayout) inflater.inflate(C4337R.layout.sem_popup_menu_header_item_layout, (ViewGroup) listView, false) : (FrameLayout) inflater.inflate(C4337R.layout.popup_menu_header_item_layout, (ViewGroup) listView, false);
