...
public class IconMenuPresenter extends BaseMenuPresenter {
  ...
  public IconMenuPresenter(Context context) {
    super(
        new ContextThemeWrapper(context, C4337R.style.Theme_IconMenu),
        C4337R.layout.icon_menu_layout,
        C4337R.layout.icon_menu_item_layout);
    this.mMaxItems = -1;
  ...
  public void updateMenuView(boolean cleared) {
    ...
    if (needsMore
        && ((iconMenuItemView2 = this.mMoreView) == null
            || iconMenuItemView2.getParent() != menuView)) {
