...
public final class MenuItemImpl implements MenuItem, SemMenuItem {
  ...
  public boolean invoke() {
    ...
    if (this.mIntent != null) {
      try {
        ...
        Log.m97e(TAG, "Can't find activity to handle intent; ignoring", e);
      }
    }
  ...
  String getShortcutLabel() {
    ...
    if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
      sb.append(res.getString(C4337R.string.prepend_shortcut_label));
    }
    int modifiers =
        this.mMenu.isQwertyMode()
            ? this.mShortcutAlphabeticModifiers
            : this.mShortcutNumericModifiers;
    appendModifier(sb, modifiers, 65536, res.getString(C4337R.string.menu_meta_shortcut_label));
    appendModifier(sb, modifiers, 4096, res.getString(C4337R.string.menu_ctrl_shortcut_label));
    appendModifier(sb, modifiers, 2, res.getString(C4337R.string.menu_alt_shortcut_label));
    appendModifier(sb, modifiers, 1, res.getString(C4337R.string.menu_shift_shortcut_label));
    appendModifier(sb, modifiers, 4, res.getString(C4337R.string.menu_sym_shortcut_label));
    appendModifier(sb, modifiers, 8, res.getString(C4337R.string.menu_function_shortcut_label));
    switch (shortcut) {
      case '\b':
        sb.append(res.getString(C4337R.string.menu_delete_shortcut_label));
        break;
      case '\n':
        sb.append(res.getString(C4337R.string.menu_enter_shortcut_label));
        break;
      case ' ':
        sb.append(res.getString(C4337R.string.menu_space_shortcut_label));
        break;
      default:
        sb.append(shortcut);
        break;
  ...
  public boolean isVisible() {
    ActionProvider actionProvider = this.mActionProvider;
    return (actionProvider == null || !actionProvider.overridesItemVisibility())
        ? (this.mFlags & 8) == 0
    ...
    switch (actionEnum & 3) {
      ...
      default:
        throw new IllegalArgumentException(
            "SHOW_AS_ACTION_ALWAYS, SHOW_AS_ACTION_IF_ROOM, and SHOW_AS_ACTION_NEVER are mutually"
                + " exclusive.");
    }
  }
  ...
  public MenuItem setActionProvider(ActionProvider actionProvider) {
    ...
    if (actionProvider3 != null) {
      actionProvider3.setVisibilityListener(
          new ActionProvider
              .VisibilityListener() { // from class: com.android.internal.view.menu.MenuItemImpl.1
