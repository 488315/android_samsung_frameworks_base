...
public class MenuPopupHelper implements MenuHelper {
  ...
  public MenuPopupHelper(
    ...
    this.mInternalOnDismissListener =
        new PopupWindow
            .OnDismissListener() { // from class: com.android.internal.view.menu.MenuPopupHelper.1
  ...
  private MenuPopup createPopup() {
    ...
    int minSmallestWidthCascading =
        this.mContext
            .getResources()
            .getDimensionPixelSize(C4337R.dimen.cascading_menus_min_smallest_width);
    ...
    if (useOffsets) {
      ...
      if (this.mIsThemeDeviceDefaultFamily && !this.mIsContextMenu) {
        ...
        xOffset -=
            this.mContext
                .getResources()
                .getDimensionPixelOffset(C4337R.dimen.sem_menu_popup_horizontal_offset);
