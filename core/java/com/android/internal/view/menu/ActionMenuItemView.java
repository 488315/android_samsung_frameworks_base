...
public class ActionMenuItemView extends TextView implements MenuView.ItemView, View.OnClickListener, View.OnLongClickListener, ActionMenuView.ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ActionMenuItemView, defStyleAttr, defStyleRes);
        ...
        if (this.mIsThemeDeviceDefaultFamily) {
            ...
            a2.recycle();
            TypedArray a3 = getContext().obtainStyledAttributes(actionMeneTextAppearnceId, C4337R.styleable.TextAppearance);
