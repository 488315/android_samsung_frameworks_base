...
public final class IconMenuView extends ViewGroup
  ...
  public IconMenuView(Context context, AttributeSet attrs) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.IconMenuView, 0, 0);
    ...
    a.recycle();
    TypedArray a2 = context.obtainStyledAttributes(attrs, C4337R.styleable.MenuView, 0, 0);
  ...
  private void layoutItems(int width) {
    ...
    for (int curNumRows = Math.min((int) Math.ceil(numItems / this.mMaxItemsPerRow), this.mMaxRows);
  ...
  IconMenuItemView createMoreItemView() {
    ...
    IconMenuItemView itemView =
        (IconMenuItemView) inflater.inflate(C4337R.layout.icon_menu_item_layout, (ViewGroup) null);
    Resources r = context.getResources();
    itemView.initialize(r.getText(C4337R.string.more_item_label), this.mMoreIcon);
    itemView.setOnClickListener(
        new View.OnClickListener() { // from class: com.android.internal.view.menu.IconMenuView.1
    ...
    while (row < numRows) {
      ...
      if (this.mHorizontalDivider != null && row < numRowsMinus1) {
        this.mHorizontalDividerRects.add(
            new Rect(0, (int) itemTop, menuWidth, (int) (this.mHorizontalDividerHeight + itemTop)));
  ...
  private static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: com.android.internal.view.menu.IconMenuView.SavedState.1
