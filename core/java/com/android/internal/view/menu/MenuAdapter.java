...
public class MenuAdapter extends BaseAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    int firstLastItemVerticalEdgePadding =
        convertView
            .getResources()
            .getDimensionPixelSize(
                C4337R.dimen.sem_popup_menu_first_last_item_vertical_edge_padding);
    ...
    convertView.setPadding(
        ...
        position == 0 ? firstItemTopPadding : this.mInitPaddingTop,
        convertView.getPaddingRight(),
        position == getCount() - 1 ? lastItemBottomPadding : this.mInitPaddingBottom);
    return convertView;
  }
