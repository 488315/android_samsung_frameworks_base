...
public class NativeLibraryHelper {
        ...
        try {
            if (handle.multiArch) {
                ...
                if (copyRet3 < 0 && copyRet3 != -114) {
                    Slog.m121w(TAG, "Failure copying native libraries [errorCode=" + copyRet3 + NavigationBarInflaterView.SIZE_MOD_END);
                    return copyRet3;
                }
            }
            return 1;
    ...
    private static String getRelativePath(File base, File target) {
        try {
            ...
            Slog.m115e(TAG, "Failed to find relative path between: " + base.getAbsolutePath() + " and: " + target.getAbsolutePath());
            return null;
        }
    }
