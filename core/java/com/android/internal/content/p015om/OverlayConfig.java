package com.android.internal.content.p015om;

import android.content.p002pm.PackagePartitions;
...
public class OverlayConfig {
  ...
  static /* synthetic */ int lambda$static$0(
      OverlayConfigParser.ParsedConfiguration c1, OverlayConfigParser.ParsedConfiguration c2) {
                  ...
                  new Function() { // from class:
                    ...
                    public final Object apply(Object obj) {
                      return OverlayConfig.lambda$new$1(
                          rootDirectory, (PackagePartitions.SystemPartition) obj);
                    }
                  }));
    }
    ...
    packageManager.forEachPackage(
        new TriConsumer() { // from class:
          ...
          public final void accept(Object obj, Object obj2, Object obj3) {
            OverlayConfig.lambda$getOverlayPackageInfos$3(
                overlays, (OverlayConfig.PackageProvider.Package) obj, (Boolean) obj2, (File) obj3);
          }
        });
    return overlays;
  }

  static /* synthetic */ void lambda$getOverlayPackageInfos$3(
      HashMap overlays, PackageProvider.Package p, Boolean isSystem, File preInstalledApexPath) {
  ...
  private static ArrayMap<Integer, List<String>> getActiveApexes(
    ...
    if (apexInfoList.exists() && apexInfoList.canRead()) {
      try {
        ...
        Log.m102w(TAG, "Error reading apex-info-list: " + e);
      }
    }
    return result;
  }
  ...
  public String[] createImmutableFrameworkIdmapsInZygote() {
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (idmaps == null) {
        Log.m102w(
            TAG,
            "'idmap2 create-multiple' failed: no mutable=\"false\" overlays targeting \"android\""
                + " will be loaded");
        return new String[0];
      }
