...
import com.android.internal.content.p015om.OverlayConfigParser;
...
public class OverlayConfig {
    ...
    static /* synthetic */ void lambda$getOverlayPackageInfos$3(HashMap overlays, PackageProvider.Package p, Boolean isSystem, File preInstalledApexPath) {
    ...
    public String[] createImmutableFrameworkIdmapsInZygote() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (idmaps == null) {
                Log.m102w(TAG, "'idmap2 create-multiple' failed: no mutable=\"false\" overlays targeting \"android\" will be loaded");
                return new String[0];
            }
