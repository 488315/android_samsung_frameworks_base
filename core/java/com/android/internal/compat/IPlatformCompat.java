...
public interface IPlatformCompat extends IInterface {
  ...
  void putOverridesOnReleaseBuilds(
      CompatibilityOverrideConfig compatibilityOverrideConfig, String str) throws RemoteException;
  ...
  public abstract static class Stub extends Binder implements IPlatformCompat {
        ...
        default:
          switch (code) {
            ...
            case 6:
              ...
              return true;
            case 7:
              CompatibilityChangeConfig _arg07 =
              ...
              return true;
            case 8:
              CompatibilityOverridesByPackageConfig _arg08 =
                  (CompatibilityOverridesByPackageConfig)
                      data.readTypedObject(CompatibilityOverridesByPackageConfig.CREATOR);
              data.enforceNoDataAvail();
              putAllOverridesOnReleaseBuilds(_arg08);
              reply.writeNoException();
              return true;
            case 9:
              CompatibilityOverrideConfig _arg09 =
              ...
              return true;
            case 10:
              CompatibilityChangeConfig _arg010 =
                  (CompatibilityChangeConfig)
                      data.readTypedObject(CompatibilityChangeConfig.CREATOR);
            ...
            case 12:
              ...
              return true;
            case 13:
              CompatibilityOverridesToRemoveByPackageConfig _arg013 =
                  (CompatibilityOverridesToRemoveByPackageConfig)
                      data.readTypedObject(CompatibilityOverridesToRemoveByPackageConfig.CREATOR);
              data.enforceNoDataAvail();
              removeAllOverridesOnReleaseBuilds(_arg013);
              reply.writeNoException();
              return true;
            case 14:
              CompatibilityOverridesToRemoveConfig _arg014 =
                  (CompatibilityOverridesToRemoveConfig)
                      data.readTypedObject(CompatibilityOverridesToRemoveConfig.CREATOR);
      ...
      public CompatibilityChangeConfig getAppConfig(ApplicationInfo appInfo)
        ...
        try {
          ...
          CompatibilityChangeConfig _result =
              (CompatibilityChangeConfig) _reply.readTypedObject(CompatibilityChangeConfig.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public CompatibilityChangeInfo[] listAllChanges() throws RemoteException {
        ...
        try {
          ...
          CompatibilityChangeInfo[] _result =
              (CompatibilityChangeInfo[]) _reply.createTypedArray(CompatibilityChangeInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
    ...
    protected void setOverrides_enforcePermission() throws SecurityException {
      this.mEnforcer.enforcePermission(
          Manifest.permission.OVERRIDE_COMPAT_CHANGE_CONFIG, getCallingPid(), getCallingUid());
    }
