...
public class LocalePickerWithRegion extends ListFragment implements SearchView.OnQueryTextListener {
  ...
  private boolean setListener(
    ...
    Log.m94d(TAG, "mLocaleList size:  " + this.mLocaleList.size());
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    boolean hasSpecificPackageName =
        localeCollectorBase != null && localeCollectorBase.hasSpecificPackageName();
    SuggestedLocaleAdapter suggestedLocaleAdapter =
        new SuggestedLocaleAdapter(
            this.mLocaleList, countryMode, hasSpecificPackageName, this.mChangeDisplayName);
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    ...
    if (outValue.data != 0) {
      this.mSubheaderColor = getResources().getColor(C4337R.color.sem_round_and_bgcolor_light);
      this.mIsLight = true;
    } else {
      this.mSubheaderColor = getResources().getColor(C4337R.color.sem_round_and_bgcolor_dark);
      this.mIsLight = false;
    }
    ...
    if (list != null) {
      ...
      View footer =
          layoutInflater.inflate(C4337R.layout.sem_language_picker_footer, (ViewGroup) null, false);
  ...
  public boolean onOptionsItemSelected(MenuItem menuItem) {
    ...
    switch (id) {
      case 16908332:
        ...
        return true;
      case C4337R.id.locale_search_menu /* 16909252 */:
        return false;
      default:
  ...
  public void onListItemClick(ListView parent, View v, int position, long id) {
    ...
    if (isSystemLocale
        || ((isRegionLocale && !mayHaveDifferentNumberingSystem) || this.mIsNumberingSystem)) {
  ...
  public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
    if ((!this.mLocalePickerCollector.hasSpecificPackageName()
      ...
      inflater.inflate(C4337R.menu.language_selection_list, menu);
      MenuItem searchMenuItem = menu.findItem(C4337R.id.locale_search_menu);
      ...
      if (searchView2 != null) {
        searchView2.setQueryHint(getText(C4337R.string.search_language_hint));
