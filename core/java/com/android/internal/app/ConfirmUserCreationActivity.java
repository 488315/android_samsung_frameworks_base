...
public class ConfirmUserCreationActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    private String checkUserCreationRequirements() {
        ...
        try {
            ...
            if (accountExists) {
                String message = getString(C4337R.string.user_creation_account_exists, appName, this.mAccountName);
                return message;
            }
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (which == -1 && this.mCanProceed && this.mIsFirstClick) {
            ...
            if (user == null) {
                ...
                this.mUserManager.setSeedAccountData(user.f54id, this.mAccountName, this.mAccountType, this.mAccountOptions);
                setResult(-1);
            }
        }
        finish();
