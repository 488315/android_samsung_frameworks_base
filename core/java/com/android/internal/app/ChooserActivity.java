...
public class ChooserActivity extends ResolverActivity implements ChooserListAdapter.ChooserListCommunicator, SelectableTargetInfo.SelectableTargetInfoCommunicator {
    ...
    class ContentPreviewCoordinator {
        ...
        public /* synthetic */ void lambda$loadUriIntoView$0(Uri uri, int imageResourceId, int extraImages) {
            int size = ChooserActivity.this.getResources().getDimensionPixelSize(C4337R.dimen.chooser_preview_image_max_dimen);
        ...
        public void maybeHideContentPreview() {
            if (!this.mAtLeastOneLoaded) {
                if (this.mHideParentOnFail) {
                    Log.m98i(ChooserActivity.TAG, "Hiding image preview area. Timed out waiting for preview to load within " + this.mImageLoadTimeoutMillis + "ms.");
                    collapseParentView();
    ...
    */
        ...
        if (targetParcelable2 instanceof Uri) {
            ...
            if (targetsParcelable == null) {
                ...
                for (int i2 = 0; i2 < targetsParcelable.length; i2++) {
                    if (!(targetsParcelable[i2] instanceof Intent)) {
                        Log.m102w(TAG, "EXTRA_ALTERNATE_INTENTS array entry #" + i2 + " is not an Intent: " + targetsParcelable[i2]);
                        finish();
                        super.onCreate(null);
                        return;
                    }
            ...
            if (target != null) {
                if (!isSendAction(target)) {
                    ...
                    this.mMaxTargetsPerRow = getResources().getInteger(C4337R.integer.config_chooser_max_targets_per_row);
                ...
                Log.m102w(TAG, "Ignoring intent's EXTRA_TITLE, deprecated in P. You may wish to set a preview title by using EXTRA_TITLE property of the wrapped EXTRA_INTENT.");
            }
            title = null;
            if (title == null) {
            }
    ...
    private void updateTabPadding() {
        if (shouldShowTabs()) {
            ...
            float padding = (((width - (i * iconSize)) / i) / 2.0f) - getResources().getDimension(C4337R.dimen.resolver_profile_tab_margin);
    ...
    protected ComponentName getEditSharingComponent() {
        String editorPackage = getApplicationContext().getString(C4337R.string.config_systemImageEditor);
    ...
    protected TargetInfo getEditSharingTarget(Intent originalIntent) {
        ...
        if (Intent.ACTION_SEND.equals(originalAction)) {
            ...
            DisplayResolveInfo dri = new DisplayResolveInfo(originalIntent, ri, getString(C4337R.string.screenshot_edit), "", resolveIntent, null);
    ...
    private Button createActionButton(Drawable icon, CharSequence title, View.OnClickListener r) {
        Button b = (Button) LayoutInflater.from(this).inflate(C4337R.layout.chooser_action_button, (ViewGroup) null);
        if (icon != null) {
    ...
    private Button createCopyButton() {
        Button b = createActionButton(getDrawable(C4337R.drawable.ic_menu_copy_material), getString(17039361), new View.OnClickListener() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda5
    ...
    private ViewGroup displayTextContentPreview(Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
        ViewGroup contentPreviewLayout = (ViewGroup) layoutInflater.inflate(C4337R.layout.chooser_grid_preview_text, parent, false);
        ViewGroup actionRow = (ViewGroup) contentPreviewLayout.findViewById(C4337R.id.chooser_action_row);
        ...
        if (sharingText == null) {
            ...
            TextView textView = (TextView) contentPreviewLayout.findViewById(C4337R.id.content_preview_text);
        ...
        if (TextUtils.isEmpty(previewTitle)) {
            ...
            TextView previewTitleView = (TextView) contentPreviewLayout.findViewById(C4337R.id.content_preview_title);
            ...
            ImageView previewThumbnailView = (ImageView) contentPreviewLayout.findViewById(C4337R.id.content_preview_thumbnail);
            if (!validForContentPreview(previewThumbnail)) {
                ...
                contentPreviewCoordinator.loadUriIntoView(C4337R.id.content_preview_thumbnail, previewThumbnail, 0);
            }
        }
    ...
    private ViewGroup displayImageContentPreview(Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
        ViewGroup contentPreviewLayout = (ViewGroup) layoutInflater.inflate(C4337R.layout.chooser_grid_preview_image, parent, false);
        ViewGroup imagePreview = (ViewGroup) contentPreviewLayout.findViewById(C4337R.id.content_preview_image_area);
        ViewGroup actionRow = (ViewGroup) contentPreviewLayout.findViewById(C4337R.id.chooser_action_row);
        if (shouldNearbyShareBeIncludedAsActionButton()) {
            addActionButton(actionRow, createNearbyButton(targetIntent));
        }
        ...
        if (Intent.ACTION_SEND.equals(action)) {
            ...
            imagePreview.findViewById(C4337R.id.content_preview_image_1_large).setTransitionName("screenshot_preview_image");
            ...
            if (imageUris.size() == 0) {
                Log.m98i(TAG, "Attempted to display image preview area with zero available images detected in EXTRA_STREAM list");
                imagePreview.setVisibility(8);
                return contentPreviewLayout;
            }
            imagePreview.findViewById(C4337R.id.content_preview_image_1_large).setTransitionName("screenshot_preview_image");
            this.mPreviewCoord.loadUriIntoView(C4337R.id.content_preview_image_1_large, imageUris.get(0), 0);
            if (imageUris.size() == 2) {
                this.mPreviewCoord.loadUriIntoView(C4337R.id.content_preview_image_2_large, imageUris.get(1), 0);
            } else if (imageUris.size() > 2) {
                this.mPreviewCoord.loadUriIntoView(C4337R.id.content_preview_image_2_small, imageUris.get(1), 0);
                this.mPreviewCoord.loadUriIntoView(C4337R.id.content_preview_image_3_small, imageUris.get(2), imageUris.size() - 3);
            }
        }
        return contentPreviewLayout;
    }
    ...
    private void logContentPreviewWarning(Uri uri) {
        Log.m102w(TAG, "Could not load (" + uri.toString() + ") thumbnail/name for preview. If desired, consider using Intent#createChooser to launch the ChooserActivity, and set your Intent's clipData and flags in accordance with that method's documentation");
    }

    private ViewGroup displayFileContentPreview(Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
        ViewGroup contentPreviewLayout = (ViewGroup) layoutInflater.inflate(C4337R.layout.chooser_grid_preview_file, parent, false);
        ViewGroup actionRow = (ViewGroup) contentPreviewLayout.findViewById(C4337R.id.chooser_action_row);
        if (shouldNearbyShareBeIncludedAsActionButton()) {
            addActionButton(actionRow, createNearbyButton(targetIntent));
        }
        ...
        if (Intent.ACTION_SEND.equals(action)) {
            ...
            if (uriCount == 1) {
                ...
                String fileName = PluralsMessageFormatter.format(getResources(), arguments, C4337R.string.file_count);
                TextView fileNameView = (TextView) contentPreviewLayout.findViewById(C4337R.id.content_preview_filename);
                fileNameView.setText(fileName);
                View thumbnailView = contentPreviewLayout.findViewById(C4337R.id.content_preview_file_thumbnail);
                thumbnailView.setVisibility(8);
                ImageView fileIconView = (ImageView) contentPreviewLayout.findViewById(C4337R.id.content_preview_file_icon);
    ...
    public void onActivityStarted(TargetInfo cti) {
        ...
        if (this.mChosenComponentSender != null && (target = cti.getResolvedComponentName()) != null) {
            ...
            try {
                ...
                Slog.m115e(TAG, "Unable to launch supplied IntentSender to report the chosen component: " + e);
            }
        }
    }
    ...
    public List<ChooserTarget> convertToChooserTarget(List<ShortcutManager.ShareShortcutInfo> matchingShortcuts, List<ShortcutManager.ShareShortcutInfo> allShortcuts, List<AppTarget> allAppTargets, int shortcutType) {
        ...
        for (int i2 = 0; i2 < matchingShortcuts.size(); i2++) {
            ...
            ChooserTarget chooserTarget = new ChooserTarget(shortcutInfo.getLabel(), null, score, matchingShortcuts.get(i2).getTargetComponent().m1270clone(), extras);
    ...
    void onRefinementResult(TargetInfo selectedTarget, Intent matchingIntent) {
        ...
        if (selectedTarget == null) {
            ...
            Log.m96e(TAG, "onRefinementResult: Selected target " + selectedTarget + " cannot match refined source intent " + matchingIntent);
        } else {
    ...
    static final class PlaceHolderTargetInfo extends NotSelectableTargetInfo {
        ...
        public Drawable getDisplayIcon(Context context) {
            AnimatedVectorDrawable avd = (AnimatedVectorDrawable) context.getDrawable(C4337R.drawable.chooser_direct_share_icon_placeholder);
            avd.start();
            return avd;
        }
    }
    ...
    private void setupScrollListener() {
        ...
        final float chooserHeaderScrollElevation = getResources().getDimensionPixelSize(C4337R.dimen.chooser_header_scroll_elevation);
    ...
    private boolean shouldShowStickyContentPreview() {
        return shouldShowStickyContentPreviewNoOrientationCheck() && !getResources().getBoolean(C4337R.bool.resolver_landscape_phone);
    }

    private boolean shouldShowStickyContentPreviewNoOrientationCheck() {
        return shouldShowTabs() && (this.mMultiProfilePagerAdapter.getListAdapterForUserHandle(UserHandle.m55of(UserHandle.myUserId())).getCount() > 0 || shouldShowContentPreviewWhenEmpty()) && shouldShowContentPreview();
    }
    ...
    private void updateStickyContentPreview() {
        if (shouldShowStickyContentPreviewNoOrientationCheck()) {
            ViewGroup contentPreviewContainer = (ViewGroup) findViewById(C4337R.id.content_preview_container);
    ...
    protected WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
        if (shouldShowTabs()) {
            ...
            this.mChooserMultiProfilePagerAdapter.setupContainerPadding(getActiveEmptyStateView().findViewById(C4337R.id.resolver_empty_state_container));
        }
    ...
    public final class ChooserGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public boolean calculateChooserTargetWidth(int width) {
            ...
            int maxWidth = ChooserActivity.this.getResources().getDimensionPixelSize(C4337R.dimen.chooser_width);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            switch (viewType) {
                ...
                case 2:
                    ...
                    return chooserActivity.new ItemViewHolder(chooserActivity.createContentPreviewView(parent), false, viewType);
                case 3:
        ...
        private View createProfileView(ViewGroup parent) {
            View profileRow = this.mLayoutInflater.inflate(C4337R.layout.chooser_profile_row, parent, false);
        ...
        ItemGroupViewHolder createItemGroupViewHolder(int viewType, ViewGroup parent) {
            if (viewType != 0) {
                ViewGroup row = (ViewGroup) this.mLayoutInflater.inflate(C4337R.layout.chooser_row, parent, false);
            ...
            ViewGroup parentGroup = (ViewGroup) this.mLayoutInflater.inflate(C4337R.layout.chooser_row_direct_share, parent, false);
            ViewGroup row1 = (ViewGroup) this.mLayoutInflater.inflate(C4337R.layout.chooser_row, parentGroup, false);
            ViewGroup row2 = (ViewGroup) this.mLayoutInflater.inflate(C4337R.layout.chooser_row, parentGroup, false);
        ...
        void bindItemGroupViewHolder(int position, ItemGroupViewHolder holder) {
            ...
            if (end == start && (this.mChooserListAdapter.getItem(start) instanceof EmptyTargetInfo)) {
                ...
                if (textView.getVisibility() != 0) {
                    ...
                    fadeAnim.setInterpolator(new DecelerateInterpolator(1.0f));
                    float translationInPx = ChooserActivity.this.getResources().getDimensionPixelSize(C4337R.dimen.chooser_row_text_option_translate);
            ...
            switch (resultCode) {
                case -1:
                    ...
                    if (intentParcelable instanceof Intent) {
                        ...
                        Log.m96e(ChooserActivity.TAG, "RefinementResultReceiver received RESULT_OK but no Intent in resultData with key Intent.EXTRA_INTENT");
                        break;
                    }
                case 0:
                    ...
                    break;
                default:
                    Log.m102w(ChooserActivity.TAG, "Unknown result code " + resultCode + " sent to RefinementResultReceiver");
                    break;
            }
        }
    ...
    public static class RoundedRectImageView extends ImageView {
        ...
        public RoundedRectImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            this.mTextPaint = new Paint(1);
            this.mExtraImageCount = null;
            this.mRadius = context.getResources().getDimensionPixelSize(C4337R.dimen.chooser_corner_radius);
            this.mOverlayPaint.setColor(-1728053248);
            this.mOverlayPaint.setStyle(Paint.Style.FILL);
            this.mRoundRectPaint.setColor(context.getResources().getColor(C4337R.color.chooser_row_divider));
            this.mRoundRectPaint.setStyle(Paint.Style.STROKE);
            this.mRoundRectPaint.setStrokeWidth(context.getResources().getDimensionPixelSize(C4337R.dimen.chooser_preview_image_border));
            this.mTextPaint.setColor(-1);
            this.mTextPaint.setTextSize(context.getResources().getDimensionPixelSize(C4337R.dimen.chooser_preview_image_font_size));
