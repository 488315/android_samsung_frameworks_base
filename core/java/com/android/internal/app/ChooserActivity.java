...
public class ChooserActivity extends ResolverActivity
  ...
  private int mMaxHashSaltDays =
      DeviceConfig.getInt("systemui", SystemUiDeviceConfigFlags.HASH_SALT_MAX_DAYS, 7);
  private boolean mIsNearbyShareFirstTargetInRankedApp =
      DeviceConfig.getBoolean(
          "systemui", SystemUiDeviceConfigFlags.IS_NEARBY_SHARE_FIRST_TARGET_IN_RANKED_APP, false);
  int mListViewUpdateDelayMs =
      DeviceConfig.getInt(
          "systemui", SystemUiDeviceConfigFlags.SHARESHEET_LIST_VIEW_UPDATE_DELAY, 0);
              ...
              case 2:
                if (!ChooserActivity.this.isFinishing()) {
                  ...
                  RoundedRectImageView imageView =
                      (RoundedRectImageView)
                          ContentPreviewCoordinator.this.mParentView.findViewById(
                  ...
                  if (task.mBmp == null) {
                    ...
                    ContentPreviewCoordinator.this.setupPreDrawForSharedElementTransition(
                        imageView);
                    break;
                  }
                }
          ...
          .addOnPreDrawListener(
              new ViewTreeObserver
                  .OnPreDrawListener() { // from class:
                                         // com.android.internal.app.ChooserActivity.ContentPreviewCoordinator.2
                @Override // android.view.ViewTreeObserver.OnPreDrawListener
                public boolean onPreDraw() {
                  v.getViewTreeObserver().removeOnPreDrawListener(this);
                  if (!ChooserActivity.this.mRemoveSharedElements
                      && ChooserActivity.this.isActivityTransitionRunning()) {
    ...
    public void loadUriIntoView(final int imageResourceId, final Uri uri, final int extraImages) {
      ...
      AsyncTask.THREAD_POOL_EXECUTOR.execute(
          new Runnable() { // from class:
                           // com.android.internal.app.ChooserActivity$ContentPreviewCoordinator$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              ChooserActivity.ContentPreviewCoordinator.this.lambda$loadUriIntoView$0(
                  uri, imageResourceId, extraImages);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$loadUriIntoView$0(
      ...
      int size =
          ChooserActivity.this
              .getResources()
              .getDimensionPixelSize(C4337R.dimen.chooser_preview_image_max_dimen);
    ...
    public void maybeHideContentPreview() {
      if (!this.mAtLeastOneLoaded) {
        if (this.mHideParentOnFail) {
          Log.m98i(
              ChooserActivity.TAG,
              "Hiding image preview area. Timed out waiting for preview to load within "
                  + this.mImageLoadTimeoutMillis
                  + "ms.");
          collapseParentView();
          if (ChooserActivity.this.shouldShowTabs()) {
            ChooserActivity.this.hideStickyContentPreview();
          } else if (ChooserActivity.this.mChooserMultiProfilePagerAdapter.getCurrentRootAdapter()
              != null) {
            ChooserActivity.this
                .mChooserMultiProfilePagerAdapter
                .getCurrentRootAdapter()
                .hideContentPreview();
          }
  ...
  private class ChooserHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      if (ChooserActivity.this.mChooserMultiProfilePagerAdapter.getActiveListAdapter() == null
          || ChooserActivity.this.isDestroyed()) {
        return;
      }
      switch (msg.what) {
        case 6:
          Log.m94d(ChooserActivity.TAG, "LIST_VIEW_UPDATE_MESSAGE; ");
          ...
          break;
        case 7:
          Log.m94d(ChooserActivity.TAG, "SHORTCUT_MANAGER_ALL_SHARE_TARGET_RESULTS");
          ...
          for (ServiceResultInfo resultInfo : resultInfos) {
            if (resultInfo.resultTargets != null
                && (adapterForUserHandle =
                        ChooserActivity.this.mChooserMultiProfilePagerAdapter
                            .getListAdapterForUserHandle(resultInfo.userHandle))
                    != null) {
              adapterForUserHandle.addServiceResults(
                  resultInfo.originalTarget,
                  resultInfo.resultTargets,
                  msg.arg1,
                  ChooserActivity.this.mDirectShareShortcutInfoCache);
            }
          }
          ChooserActivity.this.logDirectShareTargetReceived(
              MetricsProto.MetricsEvent.ACTION_DIRECT_SHARE_TARGETS_LOADED_SHORTCUT_MANAGER);
  ...
  */
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Parcelable targetParcelable2 = intent.getParcelableExtra("android.intent.extra.INTENT");
    if (targetParcelable2 instanceof Uri) {
      try {
        targetParcelable = Intent.parseUri(targetParcelable2.toString(), 1);
      } catch (URISyntaxException e) {
      }
      if (targetParcelable instanceof Intent) {
        Log.m102w(TAG, "Target is not an intent: " + targetParcelable);
        finish();
        super.onCreate(null);
        return;
      }
      ...
      if (targetsParcelable == null) {
        ...
        for (int i2 = 0; i2 < targetsParcelable.length; i2++) {
          if (!(targetsParcelable[i2] instanceof Intent)) {
            Log.m102w(
                TAG,
                "EXTRA_ALTERNATE_INTENTS array entry #"
                    + i2
                    + " is not an Intent: "
                    + targetsParcelable[i2]);
            finish();
            super.onCreate(null);
            return;
          }
      ...
      if (target != null) {
        if (!isSendAction(target)) {
          ...
          if (pa == null) {
            ...
            for (int i3 = 0; i3 < count; i3++) {
              if (!(pa[i3] instanceof Intent)) {
                Log.m102w(TAG, "Initial intent #" + i3 + " not an Intent: " + pa[i3]);
                finish();
                super.onCreate(null);
                return;
              } else {
          ...
          this.mChosenComponentSender =
              (IntentSender)
                  intent.getParcelableExtra(
                      Intent.EXTRA_CHOSEN_COMPONENT_INTENT_SENDER, IntentSender.class);
          this.mRefinementIntentSender =
              (IntentSender)
                  intent.getParcelableExtra(
                      Intent.EXTRA_CHOOSER_REFINEMENT_INTENT_SENDER, IntentSender.class);
          ...
          boolean shouldFilterNearby =
              shouldNearbyShareBeFirstInRankedRow() && nearbySharingComponent != null;
          if (pa2 == null) {
            ...
            while (true) {
              ...
              if (!(pa2[i4] instanceof ComponentName)) {
                Log.m102w(TAG, "Filtered component #" + i4 + " not a ComponentName: " + pa2[i4]);
                names = null;
                break;
              } else {
            ...
            this.mFilteredComponentNames = new ComponentName[] {nearbySharingComponent};
          }
          ...
          if (pa3 != null) {
            ...
            while (true) {
              ...
              if (!(pa3[i5] instanceof ChooserTarget)) {
                Log.m102w(TAG, "Chooser target #" + i5 + " not a ChooserTarget: " + pa3[i5]);
                targets = null;
                break;
              } else {
          ...
          this.mMaxTargetsPerRow =
              getResources().getInteger(C4337R.integer.config_chooser_max_targets_per_row);
          this.mShouldDisplayLandscape =
              shouldDisplayLandscape(getResources().getConfiguration().orientation);
          setRetainInOnStop(intent.getBooleanExtra(EXTRA_PRIVATE_RETAIN_IN_ON_STOP, false));
          initialIntents2 = initialIntents;
          Intent target4 = target;
          super.onCreate(
              savedInstanceState, target, title, defaultTitleRes, initialIntents2, null, false);
          ...
          getMetricsLogger()
              .write(
                  new LogMaker(214)
                      .setSubtype(!isWorkProfile() ? 2 : 1)
                      .addTaggedData(
                          MetricsProto.MetricsEvent.FIELD_SHARESHEET_MIMETYPE, target4.getType())
                      .addTaggedData(
                          MetricsProto.MetricsEvent.FIELD_TIME_TO_APP_TARGETS,
                          Long.valueOf(systemCost)));
          if (this.mResolverDrawerLayout == null) {
            this.mResolverDrawerLayout.addOnLayoutChangeListener(
                new View
                    .OnLayoutChangeListener() { // from class:
                                                // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda7
                  ...
                  public final void onLayoutChange(
                      ...
                      int i12,
                      int i13) {
                    ChooserActivity.this.handleLayoutChange(
                        view, i6, i7, i8, i9, i10, i11, i12, i13);
                  }
                });
            target2 = target4;
            if (isSendAction(target2)) {
              this.mResolverDrawerLayout.setOnScrollChangeListener(
                  new View
                      .OnScrollChangeListener() { // from class:
                                                  // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda8
            ...
            this.mResolverDrawerLayout.setOnCollapsedChangedListener(
                new ResolverDrawerLayout
                    .OnCollapsedChangedListener() { // from class:
          ...
          Log.m94d(TAG, "System Time Cost is " + systemCost);
          ...
          chooserActivityLogger.logShareStarted(
              259,
              referrerPackageName,
              type,
              length2,
          ...
          setEnterSharedElementCallback(
              new SharedElementCallback() { // from class:
                                            // com.android.internal.app.ChooserActivity.2
                @Override // android.app.SharedElementCallback
                public void onMapSharedElements(
                    List<String> names2, Map<String, View> sharedElements) {
                  if (ChooserActivity.this.mRemoveSharedElements) {
        ...
        Log.m102w(
            TAG,
            "Ignoring intent's EXTRA_TITLE, deprecated in P. You may wish to set a preview title by"
                + " using EXTRA_TITLE property of the wrapped EXTRA_INTENT.");
      }
      title = null;
      if (title == null) {}
      pa = intent.getParcelableArrayExtra(Intent.EXTRA_INITIAL_INTENTS);
      ...
      boolean shouldFilterNearby2 =
          shouldNearbyShareBeFirstInRankedRow() && nearbySharingComponent2 != null;
      if (pa2 == null) {}
      pa3 = intent.getParcelableArrayExtra(Intent.EXTRA_CHOOSER_TARGETS);
      if (pa3 != null) {}
      this.mMaxTargetsPerRow =
      ...
      getMetricsLogger()
          .write(
              new LogMaker(214)
                  .setSubtype(!isWorkProfile() ? 2 : 1)
                  .addTaggedData(
                      MetricsProto.MetricsEvent.FIELD_SHARESHEET_MIMETYPE, target42.getType())
                  .addTaggedData(
                      MetricsProto.MetricsEvent.FIELD_TIME_TO_APP_TARGETS,
                      Long.valueOf(systemCost2)));
      if (this.mResolverDrawerLayout == null) {}
      Log.m94d(TAG, "System Time Cost is " + systemCost2);
      ...
      if (initialIntents2 != null) {}
      chooserActivityLogger2.logShareStarted(
          259,
          referrerPackageName2,
          type2,
          length2,
          i,
          isWorkProfile(),
      ...
      this.mDirectShareShortcutInfoCache = new HashMap();
      setEnterSharedElementCallback(
          new SharedElementCallback() { // from class: com.android.internal.app.ChooserActivity.2
            @Override // android.app.SharedElementCallback
    ...
    targetParcelable = targetParcelable2;
    if (targetParcelable instanceof Intent) {}
  }

  @Override // com.android.internal.app.ResolverActivity
  protected int appliedThemeResId() {
    return C4337R.style.Theme_DeviceDefault_Chooser;
  }

  private AppPredictor setupAppPredictorForUser(
  ...
  private AppPredictor.Callback createAppPredictorCallback(
      final ChooserListAdapter chooserListAdapter) {
    return new AppPredictor
        .Callback() { // from class:
                      // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda1
  ...
  public /* synthetic */ void lambda$createAppPredictorCallback$0(
    ...
    for (AppTarget appTarget2 : shortcutResults) {
      shareShortcutInfos.add(
          new ShortcutManager.ShareShortcutInfo(
              appTarget2.getShortcutInfo(),
              new ComponentName(appTarget2.getPackageName(), appTarget2.getClassName())));
    }
  ...
  protected AbstractMultiProfilePagerAdapter createMultiProfilePagerAdapter(
    ...
    if (shouldShowTabs()) {
      ...
      this.mChooserMultiProfilePagerAdapter =
          createChooserMultiProfilePagerAdapterForOneProfile(initialIntents, rList, filterLastUsed);
    }
  ...
  protected AbstractMultiProfilePagerAdapter.EmptyStateProvider createBlockerEmptyStateProvider() {
    ...
    AbstractMultiProfilePagerAdapter.EmptyState noWorkToPersonalEmptyState =
        new NoCrossProfileEmptyStateProvider.DevicePolicyBlockerEmptyState(
            ...
            isSendAction
                ? DevicePolicyResources.Strings.Core.RESOLVER_CANT_SHARE_WITH_PERSONAL
                : DevicePolicyResources.Strings.Core.RESOLVER_CANT_ACCESS_PERSONAL,
            isSendAction ? 17042409 : 17042407,
            158,
            "intent_chooser");
    AbstractMultiProfilePagerAdapter.EmptyState noPersonalToWorkEmptyState =
        new NoCrossProfileEmptyStateProvider.DevicePolicyBlockerEmptyState(
            ...
            C4337R.string.resolver_cross_profile_blocked,
            isSendAction
                ? DevicePolicyResources.Strings.Core.RESOLVER_CANT_SHARE_WITH_WORK
                : DevicePolicyResources.Strings.Core.RESOLVER_CANT_ACCESS_WORK,
            isSendAction ? 17042410 : 17042408,
            159,
            "intent_chooser");
  ...
  protected boolean postRebuildList(boolean rebuildCompleted) {
    ...
    if (shouldShowStickyContentPreview()
        || this.mChooserMultiProfilePagerAdapter.getCurrentRootAdapter().getSystemRowCount() != 0) {
  ...
  public void onCopyButtonClicked(View v) {
    ...
    if (Intent.ACTION_SEND.equals(action)) {
      ...
      if (extraText != null) {
        ...
        Log.m102w(TAG, "No data available to copy to clipboard");
        return;
      }
      ...
      Log.m102w(TAG, "Action (" + action + ") not supported for copying to clipboard");
      return;
    }
  ...
  protected void onResume() {
    super.onResume();
    Log.m94d(TAG, "onResume: " + getComponentName().flattenToShortString());
  ...
  public void onConfigurationChanged(Configuration newConfig) {
    ...
    int integer = getResources().getInteger(C4337R.integer.config_chooser_max_targets_per_row);
  ...
  private void adjustPreviewWidth(int orientation, View parent) {
    ...
    if (this.mShouldDisplayLandscape) {
      width = getResources().getDimensionPixelSize(C4337R.dimen.chooser_preview_width);
    }
    View parent2 = parent == null ? getWindow().getDecorView() : parent;
    updateLayoutWidth(C4337R.id.content_preview_text_layout, width, parent2);
    updateLayoutWidth(C4337R.id.content_preview_title_layout, width, parent2);
    updateLayoutWidth(C4337R.id.content_preview_file_layout, width, parent2);
  }

  private void updateTabPadding() {
    if (shouldShowTabs()) {
      View tabs = findViewById(16908307);
      float iconSize = getResources().getDimension(C4337R.dimen.chooser_icon_size);
      float width = tabs.getWidth();
      int i = this.mMaxTargetsPerRow;
      float padding =
          (((width - (i * iconSize)) / i) / 2.0f)
              - getResources().getDimension(C4337R.dimen.resolver_profile_tab_margin);
  ...
  protected ComponentName getNearbySharingComponent() {
    String nearbyComponent =
        Settings.Secure.getString(getContentResolver(), Settings.Secure.NEARBY_SHARING_COMPONENT);
    if (TextUtils.isEmpty(nearbyComponent)) {
      nearbyComponent = getString(C4337R.string.config_defaultNearbySharingComponent);
    }
    if (TextUtils.isEmpty(nearbyComponent)) {
      return null;
    }
  ...
  protected ComponentName getEditSharingComponent() {
    String editorPackage =
        getApplicationContext().getString(C4337R.string.config_systemImageEditor);
  ...
  protected TargetInfo getEditSharingTarget(Intent originalIntent) {
    ...
    if (Intent.ACTION_SEND.equals(originalAction)) {
      if (resolveIntent.getData() == null
          && (uri = (Uri) resolveIntent.getParcelableExtra(Intent.EXTRA_STREAM, Uri.class))
              != null) {
      ...
      if (ri == null || ri.activityInfo == null) {
        Log.m96e(TAG, "Device-specified image edit component (" + cn + ") not available");
        return null;
      }
      DisplayResolveInfo dri =
          new DisplayResolveInfo(
              originalIntent,
              ri,
              getString(C4337R.string.screenshot_edit),
              "",
              resolveIntent,
              null);
      dri.setDisplayIcon(getDrawable(C4337R.drawable.ic_screenshot_edit));
      return dri;
    }
    Log.m96e(TAG, originalAction + " is not supported.");
    return null;
  }
  ...
  protected TargetInfo getNearbySharingTarget(Intent originalIntent) {
    ...
    ResolveInfo ri = getPackageManager().resolveActivity(resolveIntent, 128);
    if (ri == null || ri.activityInfo == null) {
      Log.m96e(TAG, "Device-specified nearby sharing component (" + cn + ") not available");
      return null;
    }
    ...
    DisplayResolveInfo dri =
        new DisplayResolveInfo(originalIntent, ri, name, "", resolveIntent, null);
    ...
    Button b =
        (Button)
            LayoutInflater.from(this)
                .inflate(C4337R.layout.chooser_action_button, (ViewGroup) null);
    if (icon != null) {
      int size = getResources().getDimensionPixelSize(C4337R.dimen.chooser_action_button_icon_size);
  ...
  private Button createCopyButton() {
    Button b =
        createActionButton(
            getDrawable(C4337R.drawable.ic_menu_copy_material),
            getString(17039361),
            new View
                .OnClickListener() { // from class:
                                     // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda5
              @Override // android.view.View.OnClickListener
              public final void onClick(View view) {
                ChooserActivity.this.onCopyButtonClicked(view);
              }
            });
    b.setId(C4337R.id.chooser_copy_button);
    return b;
  }
  ...
  private Button createNearbyButton(Intent originalIntent) {
    ...
    Button b =
        createActionButton(
            ...
            new View
                .OnClickListener() { // from class:
                                     // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda4
              @Override // android.view.View.OnClickListener
              public final void onClick(View view) {
                ChooserActivity.this.lambda$createNearbyButton$1(ti, view);
              }
            });
    b.setId(C4337R.id.chooser_nearby_button);
    return b;
  }
  ...
  private Button createEditButton(Intent originalIntent) {
    ...
    Button b =
        createActionButton(
            ...
            new View
                .OnClickListener() { // from class:
                                     // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda0
              @Override // android.view.View.OnClickListener
              public final void onClick(View view) {
                ChooserActivity.this.lambda$createEditButton$2(ti, view);
              }
            });
    b.setId(C4337R.id.chooser_edit_button);
    return b;
  }
    ...
    if (firstImgView == null) {
      ...
      ActivityOptions options =
          ActivityOptions.makeSceneTransitionAnimation(
              this, firstImgView, "screenshot_preview_image");
  ...
  private View getFirstVisibleImgPreviewView() {
    View firstImage = findViewById(C4337R.id.content_preview_image_1_large);
  ...
  private void addActionButton(ViewGroup parent, Button b) {
    ...
    int gap = getResources().getDimensionPixelSize(C4337R.dimen.resolver_icon_margin) / 2;
    lp.setMarginsRelative(gap, 0, gap, 0);
    parent.addView(b, lp);
  }

  private ViewGroup displayContentPreview(
      int previewType, Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
    ...
    switch (previewType) {
      ...
      case 3:
        ...
        break;
      default:
        Log.m96e(TAG, "Unexpected content preview type: " + previewType);
        break;
    }
    if (layout != null) {
  ...
  private ViewGroup displayTextContentPreview(
    ...
    ViewGroup contentPreviewLayout =
        (ViewGroup) layoutInflater.inflate(C4337R.layout.chooser_grid_preview_text, parent, false);
    ViewGroup actionRow =
        (ViewGroup) contentPreviewLayout.findViewById(C4337R.id.chooser_action_row);
    ...
    if (sharingText == null) {
      contentPreviewLayout.findViewById(C4337R.id.content_preview_text_layout).setVisibility(8);
    } else {
      TextView textView =
          (TextView) contentPreviewLayout.findViewById(C4337R.id.content_preview_text);
      textView.setText(sharingText);
    }
    String previewTitle = targetIntent.getStringExtra(Intent.EXTRA_TITLE);
    if (TextUtils.isEmpty(previewTitle)) {
      contentPreviewLayout.findViewById(C4337R.id.content_preview_title_layout).setVisibility(8);
    } else {
      TextView previewTitleView =
          (TextView) contentPreviewLayout.findViewById(C4337R.id.content_preview_title);
      ...
      ImageView previewThumbnailView =
          (ImageView) contentPreviewLayout.findViewById(C4337R.id.content_preview_thumbnail);
      if (!validForContentPreview(previewThumbnail)) {
        ...
        ContentPreviewCoordinator contentPreviewCoordinator =
            new ContentPreviewCoordinator(contentPreviewLayout, false);
        this.mPreviewCoord = contentPreviewCoordinator;
        contentPreviewCoordinator.loadUriIntoView(
            C4337R.id.content_preview_thumbnail, previewThumbnail, 0);
      }
    }
  ...
  private ViewGroup displayImageContentPreview(
      Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
    ViewGroup contentPreviewLayout =
        (ViewGroup) layoutInflater.inflate(C4337R.layout.chooser_grid_preview_image, parent, false);
    ViewGroup imagePreview =
        (ViewGroup) contentPreviewLayout.findViewById(C4337R.id.content_preview_image_area);
    ViewGroup actionRow =
        (ViewGroup) contentPreviewLayout.findViewById(C4337R.id.chooser_action_row);
    if (shouldNearbyShareBeIncludedAsActionButton()) {
      addActionButton(actionRow, createNearbyButton(targetIntent));
    ...
    if (Intent.ACTION_SEND.equals(action)) {
      ...
      imagePreview
          .findViewById(C4337R.id.content_preview_image_1_large)
          .setTransitionName("screenshot_preview_image");
      this.mPreviewCoord.loadUriIntoView(C4337R.id.content_preview_image_1_large, uri, 0);
    } else {
      ...
      if (imageUris.size() == 0) {
        Log.m98i(
            TAG,
            "Attempted to display image preview area with zero available images detected in"
                + " EXTRA_STREAM list");
        imagePreview.setVisibility(8);
        return contentPreviewLayout;
      }
      imagePreview
          .findViewById(C4337R.id.content_preview_image_1_large)
          .setTransitionName("screenshot_preview_image");
      this.mPreviewCoord.loadUriIntoView(
          C4337R.id.content_preview_image_1_large, imageUris.get(0), 0);
      if (imageUris.size() == 2) {
        this.mPreviewCoord.loadUriIntoView(
            C4337R.id.content_preview_image_2_large, imageUris.get(1), 0);
      } else if (imageUris.size() > 2) {
        this.mPreviewCoord.loadUriIntoView(
            C4337R.id.content_preview_image_2_small, imageUris.get(1), 0);
        this.mPreviewCoord.loadUriIntoView(
            C4337R.id.content_preview_image_3_small, imageUris.get(2), imageUris.size() - 3);
      }
    }
    return contentPreviewLayout;
  }
  ...
  private void logContentPreviewWarning(Uri uri) {
    Log.m102w(
        ...
        "Could not load ("
            + uri.toString()
            + ") thumbnail/name for preview. If desired, consider using Intent#createChooser to"
            + " launch the ChooserActivity, and set your Intent's clipData and flags in accordance"
  ...
  private ViewGroup displayFileContentPreview(
      Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
    ViewGroup contentPreviewLayout =
        (ViewGroup) layoutInflater.inflate(C4337R.layout.chooser_grid_preview_file, parent, false);
    ViewGroup actionRow =
        (ViewGroup) contentPreviewLayout.findViewById(C4337R.id.chooser_action_row);
    if (shouldNearbyShareBeIncludedAsActionButton()) {
      addActionButton(actionRow, createNearbyButton(targetIntent));
    ...
    if (Intent.ACTION_SEND.equals(action)) {
      ...
      List<Uri> uris =
          (List)
              targetIntent.getParcelableArrayListExtra(Intent.EXTRA_STREAM, Uri.class).stream()
                  .filter(
                      new Predicate() { // from class:
                                        // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda2
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                          boolean validForContentPreview;
                          validForContentPreview =
                              ChooserActivity.validForContentPreview((Uri) obj);
      ...
      if (uriCount == 0) {
        contentPreviewLayout.setVisibility(8);
        Log.m98i(TAG, "Appears to be no uris available in EXTRA_STREAM, removing preview area");
        return contentPreviewLayout;
      }
      if (uriCount == 1) {
        ...
        String fileName =
            PluralsMessageFormatter.format(getResources(), arguments, C4337R.string.file_count);
        TextView fileNameView =
            (TextView) contentPreviewLayout.findViewById(C4337R.id.content_preview_filename);
        fileNameView.setText(fileName);
        View thumbnailView =
            contentPreviewLayout.findViewById(C4337R.id.content_preview_file_thumbnail);
        thumbnailView.setVisibility(8);
        ImageView fileIconView =
            (ImageView) contentPreviewLayout.findViewById(C4337R.id.content_preview_file_icon);
        fileIconView.setVisibility(0);
        fileIconView.setImageResource(C4337R.drawable.ic_file_copy);
      }
    }
    return contentPreviewLayout;
  }
  ...
  private void loadFileUriIntoView(Uri uri, View parent) {
    ...
    TextView fileNameView = (TextView) parent.findViewById(C4337R.id.content_preview_filename);
    fileNameView.setText(fileInfo.name);
    if (fileInfo.hasThumbnail) {
      ContentPreviewCoordinator contentPreviewCoordinator =
          new ContentPreviewCoordinator(parent, false);
      this.mPreviewCoord = contentPreviewCoordinator;
      contentPreviewCoordinator.loadUriIntoView(C4337R.id.content_preview_file_thumbnail, uri, 0);
    } else {
      View thumbnailView = parent.findViewById(C4337R.id.content_preview_file_thumbnail);
      thumbnailView.setVisibility(8);
      ImageView fileIconView = (ImageView) parent.findViewById(C4337R.id.content_preview_file_icon);
      fileIconView.setVisibility(0);
      fileIconView.setImageResource(C4337R.drawable.chooser_file_generic);
    }
  }
  ...
  public static boolean validForContentPreview(Uri uri) throws SecurityException {
    ...
    if (userId != -2 && userId != UserHandle.myUserId()) {
      Log.m96e(TAG, "dropped invalid content URI belonging to user " + userId);
      return false;
    }
    return true;
  }
  ...
  private int findPreferredContentPreview(Intent targetIntent, ContentResolver resolver) {
    ...
    if (!Intent.ACTION_SEND_MULTIPLE.equals(action)
        || (uris = targetIntent.getParcelableArrayListExtra(Intent.EXTRA_STREAM, Uri.class)) == null
        || uris.isEmpty()) {
      return 3;
    }
    for (Uri uri2 : uris) {
  ...
  public Intent getReplacementIntent(ActivityInfo aInfo, Intent defIntent) {
    ...
    if (aInfo.name.equals(IntentForwarderActivity.FORWARD_INTENT_TO_PARENT)
      ...
      Intent result2 =
          Intent.createChooser(result, getIntent().getCharSequenceExtra(Intent.EXTRA_TITLE));
  ...
  public void onActivityStarted(TargetInfo cti) {
    ...
    if (this.mChosenComponentSender != null && (target = cti.getResolvedComponentName()) != null) {
      ...
      try {
        ...
        Slog.m115e(
            TAG, "Unable to launch supplied IntentSender to report the chosen component: " + e);
      }
    }
  }
  ...
  public void addUseDifferentAppLabelIfNecessary(ResolverListAdapter adapter) {
    ...
    if (chooserTargetArr != null && chooserTargetArr.length > 0) {
      this.mChooserMultiProfilePagerAdapter
          .getActiveListAdapter()
          .addServiceResults(null, Lists.newArrayList(this.mCallerChooserTargets), 0, null);
    }
  }

  @Override // com.android.internal.app.ResolverActivity
  public int getLayoutResource() {
    return C4337R.layout.chooser_grid;
  }
  ...
  public void showTargetDetails(TargetInfo targetInfo) {
    ...
    if (targetInfo instanceof SelectableTargetInfo) {
      ...
      if (selectableTargetInfo.getDisplayResolveInfo() == null
        ...
        Log.m96e(TAG, "displayResolveInfo or chooserTarget in selectableTargetInfo are null");
        return;
      }
      targetList = new ArrayList<>();
      targetList.add(selectableTargetInfo.getDisplayResolveInfo());
      bundle.putString(
          ChooserTargetActionsDialogFragment.SHORTCUT_ID_KEY,
          selectableTargetInfo
              .getChooserTarget()
              .getIntentExtras()
              .getString(Intent.EXTRA_SHORTCUT_ID));
      bundle.putBoolean(
          ChooserTargetActionsDialogFragment.IS_SHORTCUT_PINNED_KEY,
      ...
      if (selectableTargetInfo.getDisplayLabel() != null) {
        bundle.putString(
            ChooserTargetActionsDialogFragment.SHORTCUT_TITLE_KEY,
    ...
    bundle.putParcelable(
        ...
        getResolveInfoUserHandle(
            ...
            this.mChooserMultiProfilePagerAdapter.getCurrentUserHandle()));
  ...
  protected boolean onTargetSelected(TargetInfo target, boolean alwaysCheck) {
    if (this.mRefinementIntentSender != null) {
      ...
      if (!sourceIntents.isEmpty()) {
        ...
        RefinementResultReceiver refinementResultReceiver2 =
            new RefinementResultReceiver(this, target, null);
        ...
        try {
          ...
          Log.m97e(TAG, "Refinement IntentSender failed to send", e);
        }
      }
    }
  ...
  public void startSelected(int which, boolean always, boolean filtered) {
    ChooserListAdapter currentListAdapter =
        this.mChooserMultiProfilePagerAdapter.getActiveListAdapter();
      ...
      if (currentListAdapter.getCount() > 0) {
        ...
        switch (currentListAdapter.getPositionTargetType(which)) {
          ...
          case 1:
            ...
            directTargetHashed =
                HashedStringCache.getInstance()
                    .hashString(
                        this,
                        TAG,
                        target.getComponentName().getPackageName() + target.getTitle().toString(),
                        this.mMaxHashSaltDays);
            SelectableTargetInfo selectableTargetInfo = (SelectableTargetInfo) targetInfo;
          ...
          case 3:
            ...
            getChooserActivityLogger()
                .logShareTargetSelected(
                    3, targetInfo.getResolveInfo().activityInfo.processName, -1, false);
            break;
        }
        if (cat != 0) {
          ...
          if (directTargetHashed != null) {
            targetLogMaker.addTaggedData(
                MetricsProto.MetricsEvent.FIELD_HASHED_TARGET_NAME,
                directTargetHashed.hashedString);
            targetLogMaker.addTaggedData(
                MetricsProto.MetricsEvent.FIELD_HASHED_TARGET_SALT_GEN,
                Integer.valueOf(directTargetHashed.saltGeneration));
        ...
        if (this.mIsSuccessfullySelected) {
          Log.m94d(TAG, "User Selection Time Cost is " + selectionCost);
          Log.m94d(TAG, "position of selected app/service/caller is " + Integer.toString(value));
    ...
    try {
      ...
      if (intent.getType() == null) {
        if (TextUtils.isEmpty(dataString)) {
          Log.m96e(TAG, "Failed to get target intent filter: intent data and type are null");
          return null;
        }
      ...
      Log.m97e(TAG, "Failed to get target intent filter", e);
      return null;
    }
  }

  protected void queryDirectShareTargets(
      final ChooserListAdapter adapter, boolean skipAppPredictionService) {
    ...
    if (!skipAppPredictionService
        && (appPredictor = getAppPredictorForDirectShareIfEnabled(userHandle)) != null) {
    ...
    AsyncTask.execute(
        new Runnable() { // from class:
                         // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
          public final void run() {
  ...
  private boolean shouldQueryShortcutManager(UserHandle userHandle) {
    if (shouldShowTabs() && getWorkProfileUserHandle().equals(userHandle)) {
      return isUserRunning(userHandle)
    ...
    for (int i2 = 0; i2 < chooserListAdapter.getDisplayResolveInfoCount(); i2++) {
      ...
      if (!matchingShortcuts.isEmpty()) {
        List<ChooserTarget> chooserTargets =
            convertToChooserTarget(matchingShortcuts, resultList, appTargets, shortcutType);
        ServiceResultInfo resultRecord =
            new ServiceResultInfo(displayResolveInfo, chooserTargets, userHandle);
        resultRecords.add(resultRecord);
      }
    }
    sendShortcutManagerShareTargetResults(
        shortcutType, (ServiceResultInfo[]) resultRecords.toArray(new ServiceResultInfo[0]));
  }
  ...
  public List<ChooserTarget> convertToChooserTarget(
    ...
    for (int i2 = 0; i2 < matchingShortcuts.size(); i2++) {
      ...
      ChooserTarget chooserTarget =
          new ChooserTarget(
              ...
              null,
              score,
              matchingShortcuts.get(i2).getTargetComponent().m1270clone(),
              extras);
    ...
    Comparator<ChooserTarget> byScore =
        new Comparator() { // from class:
                           // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda3
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            return ChooserActivity.lambda$convertToChooserTarget$4(
                (ChooserTarget) obj, (ChooserTarget) obj2);
          }
        };
  ...
  void updateModelAndChooserCounts(TargetInfo info) {
    ...
    if (info != null) {
      ...
      if (ri == null || ri.activityInfo == null || targetIntent == null) {
        Log.m94d(TAG, "Can not log Chooser Counts of null ResovleInfo");
      } else {
        ChooserListAdapter currentListAdapter =
            this.mChooserMultiProfilePagerAdapter.getActiveListAdapter();
        if (currentListAdapter != null) {
          ...
          currentListAdapter.updateChooserCounts(
              ri.activityInfo.packageName, targetIntent.getAction(), ri.userHandle);
        }
        Log.m94d(TAG, "ResolveInfo Package is " + ri.activityInfo.packageName);
        Log.m94d(TAG, "Action to be updated is " + targetIntent.getAction());
      }
    }
  ...
  private void sendImpressionToAppPredictor(TargetInfo targetInfo, ChooserListAdapter adapter) {
    AppPredictor directShareAppPredictor =
        getAppPredictorForDirectShareIfEnabled(
            this.mChooserMultiProfilePagerAdapter.getCurrentUserHandle());
    ...
    for (ChooserTargetInfo chooserTargetInfo : surfacedTargetInfo) {
      ...
      if (this.mDirectShareShortcutInfoCache.containsKey(chooserTarget)) {
        ...
        targetIds.add(
            new AppTargetId(
                String.format(
                    "%s/%s/%s", shortcutId, componentName.flattenToString(), SHORTCUT_TARGET)));
      }
    }
  ...
  private void sendClickToAppPredictor(TargetInfo targetInfo) {
    ...
    if (appTarget != null) {
      directShareAppPredictor.notifyAppTargetEvent(
          new AppTargetEvent.Builder(appTarget, 1).setLaunchLocation("direct_share").build());
    }
  }
  ...
  private AppPredictor createAppPredictor(UserHandle userHandle) {
    ...
    AppPredictionManager appPredictionManager =
        (AppPredictionManager) contextAsUser.getSystemService(AppPredictionManager.class);
    AppPredictor appPredictionSession =
        appPredictionManager.createAppPredictionSession(appPredictionContext);
    if (getPersonalProfileUserHandle().equals(userHandle)) {
  ...
  void onRefinementResult(TargetInfo selectedTarget, Intent matchingIntent) {
    ...
    if (selectedTarget == null) {
      Log.m96e(TAG, "Refinement result intent did not match any known targets; canceling");
    } else if (!checkTargetSourceIntent(selectedTarget, matchingIntent)) {
      Log.m96e(
          TAG,
          "onRefinementResult: Selected target "
              + selectedTarget
              + " cannot match refined source intent "
              + matchingIntent);
    } else {
      ...
      this.mComparator =
          Comparator.comparing(
                  new Function() { // from class:
                                   // com.android.internal.app.ChooserActivity$AzInfoComparator$$ExternalSyntheticLambda0
              ...
              .thenComparingInt(
                  new ToIntFunction() { // from class:
                                        // com.android.internal.app.ChooserActivity$AzInfoComparator$$ExternalSyntheticLambda1
                    @Override // java.util.function.ToIntFunction
                    public final int applyAsInt(Object obj) {
                      int identifier;
                      identifier =
                          ResolverActivity.getResolveInfoUserHandle(
                                  ((DisplayResolveInfo) obj).getResolveInfo(), UserHandle.SYSTEM)
                              .getIdentifier();
                      return identifier;
                    }
                  });
  ...
  public class ChooserListController extends ResolverListController {
    ...
    public boolean isFixedAtTop(ComponentName name) {
      return name != null
          && name.equals(ChooserActivity.this.getNearbySharingComponent())
          && ChooserActivity.this.shouldNearbyShareBeFirstInRankedRow();
    }
  }
  ...
  public ChooserGridAdapter createChooserGridAdapter(
      ...
      UserHandle userHandle) {
    ChooserListAdapter chooserListAdapter =
        createChooserListAdapter(
            context, payloadIntents, initialIntents, rList, filterLastUsed, userHandle);
  ...
  protected ResolverListController createListController(UserHandle userHandle) {
    ...
    if (appPredictor != null) {
      resolverComparator =
          new AppPredictionServiceResolverComparator(
              this,
              getTargetIntent(),
    ...
    public Drawable getDisplayIcon(Context context) {
      AnimatedVectorDrawable avd =
          (AnimatedVectorDrawable)
              context.getDrawable(C4337R.drawable.chooser_direct_share_icon_placeholder);
      avd.start();
      return avd;
    }
  }
  ...
  public void handleLayoutChange(
    ...
    final ChooserGridAdapter gridAdapter =
        this.mChooserMultiProfilePagerAdapter.getCurrentRootAdapter();
    if (gridAdapter == null
        || recyclerView == null
    ...
    boolean isLayoutUpdated =
        gridAdapter.consumeLayoutRequest()
            || gridAdapter.calculateChooserTargetWidth(availableWidth)
            || recyclerView.getAdapter() == null
            || availableWidth != this.mCurrAvailableWidth;
    ...
    if (isLayoutUpdated
      ...
      getMainThreadHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                  ChooserActivity.this.lambda$handleLayoutChange$5(
                      gridAdapter, top, bottom, recyclerView);
                }
              });
    }
  }
  ...
  private int calculateDrawerOffset(
    ...
    if (rowsToShow != 0 || shouldShowStickyContentPreview()) {
      View stickyContentPreview = findViewById(C4337R.id.content_preview_container);
      ...
      if (recyclerView.getVisibility() == 0) {
        ...
        boolean isExpandable =
            getResources().getConfiguration().orientation == 1 && !isInMultiWindowMode();
        if (directShareHeight != 0 && shouldShowContentPreview() && isExpandable) {
          ...
          int minHeight =
              ((((bottom - top) - this.mResolverDrawerLayout.getAlwaysShowHeight())
    ...
    return offset + getResources().getDimensionPixelSize(C4337R.dimen.chooser_max_collapsed_height);
  }
  ...
  private boolean shouldShowExtraRow(int rowsToShow) {
    if (shouldShowTabs() && rowsToShow == 1) {
      ChooserMultiProfilePagerAdapter chooserMultiProfilePagerAdapter =
          this.mChooserMultiProfilePagerAdapter;
      if (chooserMultiProfilePagerAdapter.shouldShowEmptyStateScreen(
          chooserMultiProfilePagerAdapter.getInactiveListAdapter())) {
        return true;
      }
    }
    return false;
  ...
  public ResolverListAdapter.ActivityInfoPresentationGetter makePresentationGetter(
      ActivityInfo info) {
    return this.mChooserMultiProfilePagerAdapter
        .getActiveListAdapter()
  ...
  public void onListRebuilt(ResolverListAdapter listAdapter, boolean rebuildComplete) {
    ...
    if (chooserListAdapter
        .getUserHandle()
        .equals(this.mChooserMultiProfilePagerAdapter.getCurrentUserHandle())) {
      this.mChooserMultiProfilePagerAdapter
          .getActiveAdapterView()
          .setAdapter(this.mChooserMultiProfilePagerAdapter.getCurrentRootAdapter());
      ChooserMultiProfilePagerAdapter chooserMultiProfilePagerAdapter =
          this.mChooserMultiProfilePagerAdapter;
      chooserMultiProfilePagerAdapter.setupListAdapter(
          chooserMultiProfilePagerAdapter.getCurrentPage());
    }
  ...
  private void maybeQueryAdditionalPostProcessingTargets(ChooserListAdapter chooserListAdapter) {
    ...
    Log.m94d(TAG, "querying direct share targets from ShortcutManager");
  ...
  private void setupScrollListener() {
    ...
    int elevatedViewResId = shouldShowTabs() ? 16908307 : C4337R.id.chooser_header;
    final View elevatedView = this.mResolverDrawerLayout.findViewById(elevatedViewResId);
    final float defaultElevation = elevatedView.getElevation();
    final float chooserHeaderScrollElevation =
        getResources().getDimensionPixelSize(C4337R.dimen.chooser_header_scroll_elevation);
    this.mChooserMultiProfilePagerAdapter
        .getActiveAdapterView()
        .addOnScrollListener(
            new RecyclerView
                .OnScrollListener() { // from class: com.android.internal.app.ChooserActivity.4
              ...
              public void onScrolled(RecyclerView view, int dx, int dy) {
                ...
                if (view.getChildCount() > 0
                    && ((child = view.getLayoutManager().findViewByPosition(0)) == null
                        || child.getTop() < 0)) {
        ...
        .addOnGlobalLayoutListener(
            new ViewTreeObserver
                .OnGlobalLayoutListener() { // from class:
                                            // com.android.internal.app.ChooserActivity.5
  ...
  private boolean shouldShowStickyContentPreview() {
    return shouldShowStickyContentPreviewNoOrientationCheck()
        && !getResources().getBoolean(C4337R.bool.resolver_landscape_phone);
  }

  private boolean shouldShowStickyContentPreviewNoOrientationCheck() {
    return shouldShowTabs()
        && (this.mMultiProfilePagerAdapter
                    .getListAdapterForUserHandle(UserHandle.m55of(UserHandle.myUserId()))
                    .getCount()
                > 0
  ...
  private void updateStickyContentPreview() {
    if (shouldShowStickyContentPreviewNoOrientationCheck()) {
      ViewGroup contentPreviewContainer =
          (ViewGroup) findViewById(C4337R.id.content_preview_container);
  ...
  private void logActionShareWithPreview() {
    ...
    getMetricsLogger()
        .write(
            new LogMaker(MetricsProto.MetricsEvent.ACTION_SHARE_WITH_PREVIEW)
    ...
    ItemViewHolder(View itemView, boolean isClickable, int viewType) {
      ...
      if (isClickable) {
        itemView.setOnClickListener(
            new View
                .OnClickListener() { // from class:
                                     // com.android.internal.app.ChooserActivity$ItemViewHolder$$ExternalSyntheticLambda0
              @Override // android.view.View.OnClickListener
              public final void onClick(View view) {
        ...
        itemView.setOnLongClickListener(
            new View
                .OnLongClickListener() { // from class:
                                         // com.android.internal.app.ChooserActivity$ItemViewHolder$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ boolean lambda$new$1(View v) {
      TargetInfo ti =
          ChooserActivity.this
              .mChooserMultiProfilePagerAdapter
              .getActiveListAdapter()
              .targetInfoForPosition(this.mListPosition, true);
  ...
  public boolean shouldShowTargetDetails(TargetInfo ti) {
    ...
    boolean isNearbyShare =
        nearbyShare != null
            && nearbyShare.equals(ti.getResolvedComponentName())
  ...
  protected WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
    if (shouldShowTabs()) {
      this.mChooserMultiProfilePagerAdapter.setEmptyStateBottomOffset(
          insets.getSystemWindowInsetBottom());
      this.mChooserMultiProfilePagerAdapter.setupContainerPadding(
          getActiveEmptyStateView().findViewById(C4337R.id.resolver_empty_state_container));
    }
  ...
  public void setHorizontalScrollingEnabled(boolean enabled) {
    ResolverViewPager viewPager = (ResolverViewPager) findViewById(C4337R.id.profile_pager);
  ...
  private void setVerticalScrollEnabled(boolean enabled) {
    ChooserGridLayoutManager layoutManager =
        (ChooserGridLayoutManager)
            this.mChooserMultiProfilePagerAdapter.getActiveAdapterView().getLayoutManager();
  ...
  public final class ChooserGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ChooserGridAdapter(ChooserListAdapter wrappedAdapter) {
      ...
      wrappedAdapter.registerDataSetObserver(
          new DataSetObserver() { // from class:
                                  // com.android.internal.app.ChooserActivity.ChooserGridAdapter.1
    ...
    public boolean calculateChooserTargetWidth(int width) {
      ...
      int maxWidth =
          ChooserActivity.this.getResources().getDimensionPixelSize(C4337R.dimen.chooser_width);
    ...
    public int getRowCount() {
      return (int)
          (getSystemRowCount()
              ...
              + getAzLabelRowCount()
              + Math.ceil(
                  this.mChooserListAdapter.getAlphaTargetCount()
                      / ChooserActivity.this.mMaxTargetsPerRow));
    }

    public int getSystemRowCount() {
      ChooserListAdapter chooserListAdapter;
      return (ChooserActivity.this.shouldShowTabs()
              || !ChooserActivity.this.shouldShowContentPreview()
              || (chooserListAdapter = this.mChooserListAdapter) == null
    ...
    public int getProfileRowCount() {
      return (ChooserActivity.this.shouldShowTabs()
              || this.mChooserListAdapter.getOtherProfile() == null)
          ? 0
          : 1;
    }
    ...
    public int getCallerAndRankedTargetRowCount() {
      return (int)
          Math.ceil(
              (this.mChooserListAdapter.getCallerTargetCount()
                      + this.mChooserListAdapter.getRankedTargetCount())
                  / ChooserActivity.this.mMaxTargetsPerRow);
    }
    ...
    public int getAzLabelRowCount() {
      return (!this.mShowAzLabelIfPoss || this.mChooserListAdapter.getAlphaTargetCount() <= 0)
          ? 0
          : 1;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      switch (viewType) {
        ...
        case 1:
          return ChooserActivity.this
          .new ItemViewHolder(this.mChooserListAdapter.createView(parent), true, viewType);
        case 2:
          ChooserActivity chooserActivity = ChooserActivity.this;
          return chooserActivity
          .new ItemViewHolder(chooserActivity.createContentPreviewView(parent), false, viewType);
        case 3:
          return ChooserActivity.this
          .new ItemViewHolder(createProfileView(parent), false, viewType);
        case 4:
          return ChooserActivity.this
          .new ItemViewHolder(createAzLabelView(parent), false, viewType);
        case 6:
    ...
    private View createProfileView(ViewGroup parent) {
      View profileRow =
          this.mLayoutInflater.inflate(C4337R.layout.chooser_profile_row, parent, false);
      ChooserActivity.this.mProfileView = profileRow.findViewById(C4337R.id.profile_button);
      View view = ChooserActivity.this.mProfileView;
      final ChooserActivity chooserActivity = ChooserActivity.this;
      view.setOnClickListener(
          new View
              .OnClickListener() { // from class:
                                   // com.android.internal.app.ChooserActivity$ChooserGridAdapter$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
    ...
    private View createAzLabelView(ViewGroup parent) {
      return this.mLayoutInflater.inflate(C4337R.layout.chooser_az_label_row, parent, false);
    }
    ...
    private ItemGroupViewHolder loadViewsIntoGroup(final ItemGroupViewHolder holder) {
      ...
      for (int i = 0; i < columnCount; i++) {
        ...
        v.setOnClickListener(
            new View
                .OnClickListener() { // from class:
                                     // com.android.internal.app.ChooserActivity.ChooserGridAdapter.2
              @Override // android.view.View.OnClickListener
        ...
        v.setOnLongClickListener(
            new View
                .OnLongClickListener() { // from class:
                                         // com.android.internal.app.ChooserActivity$ChooserGridAdapter$$ExternalSyntheticLambda1
              @Override // android.view.View.OnLongClickListener
              public final boolean onLongClick(View view) {
                boolean lambda$loadViewsIntoGroup$0;
                lambda$loadViewsIntoGroup$0 =
                    ChooserActivity.ChooserGridAdapter.this.lambda$loadViewsIntoGroup$0(
                        holder, column, view);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$loadViewsIntoGroup$0(
        ItemGroupViewHolder holder, int column, View v1) {
      TargetInfo ti =
          this.mChooserListAdapter.targetInfoForPosition(holder.getItemIndex(column), true);
    ...
    ItemGroupViewHolder createItemGroupViewHolder(int viewType, ViewGroup parent) {
      if (viewType != 0) {
        ViewGroup row =
            (ViewGroup) this.mLayoutInflater.inflate(C4337R.layout.chooser_row, parent, false);
        ItemGroupViewHolder holder =
            new SingleRowViewHolder(row, ChooserActivity.this.mMaxTargetsPerRow, viewType);
        loadViewsIntoGroup(holder);
        return holder;
      }
      ViewGroup parentGroup =
          (ViewGroup)
              this.mLayoutInflater.inflate(C4337R.layout.chooser_row_direct_share, parent, false);
      ViewGroup row1 =
          (ViewGroup) this.mLayoutInflater.inflate(C4337R.layout.chooser_row, parentGroup, false);
      ViewGroup row2 =
          (ViewGroup) this.mLayoutInflater.inflate(C4337R.layout.chooser_row, parentGroup, false);
      ...
      final ChooserMultiProfilePagerAdapter chooserMultiProfilePagerAdapter =
          ChooserActivity.this.mChooserMultiProfilePagerAdapter;
      Objects.requireNonNull(chooserMultiProfilePagerAdapter);
      DirectShareViewHolder directShareViewHolder =
          new DirectShareViewHolder(
              parentGroup,
              newArrayList,
              i,
              viewType,
              new Supplier() { // from class:
                               // com.android.internal.app.ChooserActivity$ChooserGridAdapter$$ExternalSyntheticLambda0
    ...
    void bindItemGroupViewHolder(int position, ItemGroupViewHolder holder) {
      ...
      if (end == start && (this.mChooserListAdapter.getItem(start) instanceof EmptyTargetInfo)) {
        TextView textView = (TextView) viewGroup.findViewById(C4337R.id.chooser_row_text_option);
        if (textView.getVisibility() != 0) {
          textView.setAlpha(0.0f);
          textView.setVisibility(0);
          textView.setText(C4337R.string.chooser_no_direct_share_targets);
          ValueAnimator fadeAnim = ObjectAnimator.ofFloat(textView, "alpha", 0.0f, 1.0f);
          fadeAnim.setInterpolator(new DecelerateInterpolator(1.0f));
          float translationInPx =
              ChooserActivity.this
                  .getResources()
                  .getDimensionPixelSize(C4337R.dimen.chooser_row_text_option_translate);
    ...
    int getListPosition(int position) {
      ...
      return callerAndRankedCount
          + serviceCount
          + (position3 - (getAzLabelRowCount() + callerAndRankedRows));
    }
    ...
    public void handleScroll(View v, int y, int oldy) {
      ...
      if (directShareViewHolder != null && canExpandDirectShare) {
        directShareViewHolder.handleScroll(
            ChooserActivity.this.mChooserMultiProfilePagerAdapter.getActiveAdapterView(),
            y,
            oldy,
            ChooserActivity.this.mMaxTargetsPerRow);
      }
  ...
  static class DirectShareViewHolder extends ItemGroupViewHolder {
        ...
        if (zArr[i]) {
          ...
          fadeAnim.addListener(
              new AnimatorListenerAdapter() { // from class:
                                              // com.android.internal.app.ChooserActivity.DirectShareViewHolder.1
    ...
    public void handleScroll(RecyclerView view, int y, int oldy, int maxTargetsPerRow) {
      ...
      int newHeight =
          Math.max(
              Math.min(prevHeight + yDiff, this.mDirectShareMaxHeight), this.mDirectShareMinHeight);
  ...
  static class RefinementResultReceiver extends ResultReceiver {
    ...
    protected void onReceiveResult(int resultCode, Bundle resultData) {
      ...
      if (chooserActivity == null) {
        Log.m96e(ChooserActivity.TAG, "Destroyed RefinementResultReceiver received a result");
      }
      if (resultData == null) {
        Log.m96e(ChooserActivity.TAG, "RefinementResultReceiver received null resultData");
        return;
      }
      switch (resultCode) {
        case -1:
          ...
          if (intentParcelable instanceof Intent) {
            this.mChooserActivity.onRefinementResult(
                this.mSelectedTarget, (Intent) intentParcelable);
            break;
          } else {
            Log.m96e(
                ChooserActivity.TAG,
                "RefinementResultReceiver received RESULT_OK but no Intent in resultData with key"
                    + " Intent.EXTRA_INTENT");
            break;
          }
        case 0:
        ...
        default:
          Log.m102w(
              ChooserActivity.TAG,
              "Unknown result code " + resultCode + " sent to RefinementResultReceiver");
          break;
      }
    }
  ...
  public static class RoundedRectImageView extends ImageView {
    ...
    public RoundedRectImageView(
      ...
      this.mExtraImageCount = null;
      this.mRadius =
          context.getResources().getDimensionPixelSize(C4337R.dimen.chooser_corner_radius);
      this.mOverlayPaint.setColor(-1728053248);
      this.mOverlayPaint.setStyle(Paint.Style.FILL);
      this.mRoundRectPaint.setColor(
          context.getResources().getColor(C4337R.color.chooser_row_divider));
      this.mRoundRectPaint.setStyle(Paint.Style.STROKE);
      this.mRoundRectPaint.setStrokeWidth(
          context.getResources().getDimensionPixelSize(C4337R.dimen.chooser_preview_image_border));
      this.mTextPaint.setColor(-1);
      this.mTextPaint.setTextSize(
          context
              .getResources()
              .getDimensionPixelSize(C4337R.dimen.chooser_preview_image_font_size));
    ...
    private void updatePath(int width, int height) {
      ...
      this.mPath.addRoundRect(
          getPaddingLeft(), getPaddingTop(), imageWidth, imageHeight, i, i, Path.Direction.CW);
    }
  ...
  private class EnterTransitionAnimationDelegate implements View.OnLayoutChangeListener {
    ...
    private void maybeStartListenForLayout() {
      if (this.mPreviewReady
          && this.mOffsetCalculated
          && ChooserActivity.this.mResolverDrawerLayout != null) {
  ...
  private static class FinishAnimation extends AlphaAnimation
  ...
  private void semReplaceTargetInfoWithNewIntent(
      TargetInfo targetInfo,
      Intent intentToReplace,
      ChooserListAdapter chooserListAdapter,
      int which) {
