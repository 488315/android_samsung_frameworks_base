...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setButton(-2, res.getString(C4337R.string.media_route_controller_disconnect), new DialogInterface.OnClickListener() { // from class: com.android.internal.app.MediaRouteControllerDialog.1
        ...
        View customView = getLayoutInflater().inflate(C4337R.layout.media_route_controller_dialog, (ViewGroup) null);
        ...
        this.mVolumeLayout = (LinearLayout) customView.findViewById(C4337R.id.media_route_volume_layout);
        ...
        if (update()) {
            ...
            FrameLayout controlFrame = (FrameLayout) customView.findViewById(C4337R.id.media_route_control_frame);
