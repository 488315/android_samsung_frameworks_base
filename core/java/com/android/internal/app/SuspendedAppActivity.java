...
public class SuspendedAppActivity extends AlertActivity implements DialogInterface.OnClickListener {
            ...
            if (Intent.ACTION_PACKAGES_SUSPENSION_CHANGED.equals(intent.getAction())) {
                ...
                if (ArrayUtils.contains(modified, SuspendedAppActivity.this.mSuspendedPackage)) {
                    ...
                    if (!suspendedAppActivity.isPackageSuspended(suspendedAppActivity.mSuspendedPackage) && !SuspendedAppActivity.this.isFinishing()) {
                        Slog.m121w(SuspendedAppActivity.TAG, "Package " + SuspendedAppActivity.this.mSuspendedPackage + " has modified suspension conditions while dialog was visible. Finishing.");
    ...
    private String resolveDialogMessage() {
        ...
        return getString(C4337R.string.app_suspended_default_message, suspendedAppLabel, getAppLabel(this.mSuspendingPackage));
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (this.mSuppliedDialogInfo != null) {
            try {
                this.mSuspendingAppResources = createContextAsUser(UserHandle.m55of(this.mUserId), 0).getPackageManager().getResourcesForApplication(this.mSuspendingPackage);
            } catch (PackageManager.NameNotFoundException ne) {
        ...
        registerReceiverAsUser(this.mSuspendModifiedReceiver, UserHandle.m55of(this.mUserId), suspendModifiedFilter, null, null);
    }
        ...
        if (km.isKeyguardLocked()) {
            ...
            km.requestDismissKeyguard(this, dismissMessage, new KeyguardManager.KeyguardDismissCallback() { // from class: com.android.internal.app.SuspendedAppActivity.2
                ...
                public void onDismissError() {
                    Slog.m115e(SuspendedAppActivity.TAG, "Error while dismissing keyguard. Keeping the dialog visible.");
                }
