...
public final class DumpUtils {
    ...
    public static final String[] STATE_LABELS = {"Persistent", "       Top", "   Bnd Top", "       Fgs", "   Bnd Fgs", "    Imp Fg", "    Imp Bg", "    Backup", "   Service", "Service Rs", "  Receiver", " Heavy Wgt", "    (Home)", "(Last Act)", "  (Cached)", "    Frozen"};
    ...
    static final String[] STATE_TAGS = {"p", "t", "z", "g", "y", FullBackup.FILES_TREE_TOKEN, "b", XmlTags.ATTR_UID, XmlTags.TAG_SESSION, "x", "r", "w", "h", XmlTags.TAG_LEASEE, "a", SemShareConstants.DMA_SURVEY_DETAIL_SHAREVIA_VALUE_ALL_APPS};
