...
public final class AssociationState {
  ...
  static /* synthetic */ int lambda$static$0(Pair o1, Pair o2) {
    ...
    if (((SourceKey) o1.first).mProcess != ((SourceKey) o2.first).mProcess
        && (diff = ((SourceKey) o1.first).mProcess.compareTo(((SourceKey) o2.first).mProcess))
            != 0) {
      return diff;
    }
    return 0;
      ...
      if (src.mActiveDurations != null) {
        ...
        if (duration3 != 0) {
          ...
          DumpUtils.printProto(
              proto, 1159641169921L, DumpUtils.STATE_PROTO_ENUMS, src.mActiveProcState, 1);
