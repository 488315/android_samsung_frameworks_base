                ...
                new Handler(
                    ...
                    public void handleMessage(Message msg) {
                        switch (msg.what) {
                            ...
                            case 1:
                                Log.d(
                                        AbstractResolverComparator.TAG,
                                        "RANKER_RESULT_TIMEOUT; unbinding services");
                                AbstractResolverComparator.this.mHandler.removeMessages(0);
                                AbstractResolverComparator.this.afterCompute();
                                if (AbstractResolverComparator.this.mChooserActivityLogger
                                        != null) {
    ...
    class AzInfoComparator implements Comparator<ResolveInfo> {
        ...
        public int compare(ResolveInfo lhsp, ResolveInfo rhsp) {
            ...
            return this.mCollator.compare(
                    lhsp.activityInfo.packageName, rhsp.activityInfo.packageName);
        }
    }
}
