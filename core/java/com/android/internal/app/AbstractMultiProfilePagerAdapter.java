...
public abstract class AbstractMultiProfilePagerAdapter extends PagerAdapter {
        ...
        new ViewPager
          ...
          public void onPageSelected(int position) {
            ...
            if (AbstractMultiProfilePagerAdapter.this.mOnProfileSelectedListener != null) {
              AbstractMultiProfilePagerAdapter.this.mOnProfileSelectedListener.onProfileSelected(
                  position);
            }
          }
      ...
      clickListener =
          new View
            ...
            public final void onClick(View view) {
              AbstractMultiProfilePagerAdapter.this.lambda$showEmptyResolverListEmptyState$1(
        ...
        .onClick(
            new EmptyState
              ...
              public final void showSpinner() {
                AbstractMultiProfilePagerAdapter.this.lambda$showEmptyResolverListEmptyState$0(
                    listAdapter);
              }
            });
  }
              ...
              new Predicate() { // from class:
                ...
                public final boolean test(Object obj) {
                  ...
                  lambda$hasCrossProfileIntents$0 =
                      AbstractMultiProfilePagerAdapter.CrossProfileIntentsChecker.this
                          .lambda$hasCrossProfileIntents$0(
                              source, target, packageManager, (Intent) obj);
  ...
  protected void showEmptyState(
    ...
    descriptor.rootView.findViewById(C4337R.id.resolver_list).setVisibility(8);
    ViewGroup emptyStateView = descriptor.getEmptyStateView();
    resetViewVisibilitiesForEmptyState(emptyStateView);
    emptyStateView.setVisibility(0);
    View container = emptyStateView.findViewById(C4337R.id.resolver_empty_state_container);
    setupContainerPadding(container);
    TextView titleView =
        (TextView) emptyStateView.findViewById(C4337R.id.resolver_empty_state_title);
    ...
    TextView subtitleView =
        (TextView) emptyStateView.findViewById(C4337R.id.resolver_empty_state_subtitle);
    ...
    Button button = (Button) emptyStateView.findViewById(C4337R.id.resolver_empty_state_button);
  ...
  private void showSpinner(View emptyStateView) {
    emptyStateView.findViewById(C4337R.id.resolver_empty_state_title).setVisibility(4);
    emptyStateView.findViewById(C4337R.id.resolver_empty_state_button).setVisibility(4);
    emptyStateView.findViewById(C4337R.id.resolver_empty_state_progress).setVisibility(0);
    emptyStateView.findViewById(16908292).setVisibility(8);
  }

  private void resetViewVisibilitiesForEmptyState(View emptyStateView) {
    emptyStateView.findViewById(C4337R.id.resolver_empty_state_title).setVisibility(0);
    emptyStateView.findViewById(C4337R.id.resolver_empty_state_subtitle).setVisibility(0);
    emptyStateView.findViewById(C4337R.id.resolver_empty_state_button).setVisibility(4);
    emptyStateView.findViewById(C4337R.id.resolver_empty_state_progress).setVisibility(8);
    emptyStateView.findViewById(16908292).setVisibility(8);
  }
  ...
  protected void showListView(ResolverListAdapter activeListAdapter) {
    ProfileDescriptor descriptor =
        getItem(userHandleToPageIndex(activeListAdapter.getUserHandle()));
    if (descriptor.rootView.findViewById(C4337R.id.resolver_list) != null) {
      descriptor.rootView.findViewById(C4337R.id.resolver_list).setVisibility(0);
    }
    if (descriptor.rootView.findViewById(C4337R.id.sem_resolver_second_depth_recycler_view)
        != null) {
      descriptor
          .rootView
          .findViewById(C4337R.id.sem_resolver_second_depth_recycler_view)
          .setVisibility(0);
    }
    View emptyStateView = descriptor.rootView.findViewById(C4337R.id.resolver_empty_state);
  ...
  private boolean hasAppsInOtherProfile(ResolverListAdapter adapter) {
    ...
    List<ResolverActivity.ResolvedComponentInfo> resolversForIntent =
        adapter.getResolversForUser(UserHandle.m55of(UserHandle.myUserId()));
  ...
  protected class ProfileDescriptor {
    ...
    ProfileDescriptor(ViewGroup rootView) {
      ...
      this.mEmptyStateView = (ViewGroup) rootView.findViewById(C4337R.id.resolver_empty_state);
    }
