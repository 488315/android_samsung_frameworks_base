...
public abstract class AbstractMultiProfilePagerAdapter extends PagerAdapter {
    ...
    protected void showEmptyState(ResolverListAdapter activeListAdapter, EmptyState emptyState, View.OnClickListener buttonOnClick) {
        ...
        TextView titleView = (TextView) emptyStateView.findViewById(C4337R.id.resolver_empty_state_title);
        ...
        TextView subtitleView = (TextView) emptyStateView.findViewById(C4337R.id.resolver_empty_state_subtitle);
    ...
    protected void showListView(ResolverListAdapter activeListAdapter) {
        ...
        if (descriptor.rootView.findViewById(C4337R.id.sem_resolver_second_depth_recycler_view) != null) {
            descriptor.rootView.findViewById(C4337R.id.sem_resolver_second_depth_recycler_view).setVisibility(0);
        }
    ...
    private boolean hasAppsInOtherProfile(ResolverListAdapter adapter) {
        ...
        List<ResolverActivity.ResolvedComponentInfo> resolversForIntent = adapter.getResolversForUser(UserHandle.m55of(UserHandle.myUserId()));
