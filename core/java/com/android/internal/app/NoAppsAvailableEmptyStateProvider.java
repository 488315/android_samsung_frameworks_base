...
public class NoAppsAvailableEmptyStateProvider
      ...
      if (listUserHandle == this.mPersonalProfileUserHandle) {
        title =
            ((DevicePolicyManager) this.mContext.getSystemService(DevicePolicyManager.class))
                .getResources()
                .getString(
                    DevicePolicyResources.Strings.Core.RESOLVER_NO_PERSONAL_APPS,
                    new Supplier() { // from class:
                      ...
                      public final Object get() {
                        ...
                        lambda$getEmptyState$0 =
                            NoAppsAvailableEmptyStateProvider.this.lambda$getEmptyState$0();
                    ...
                    new Supplier() { // from class:
                      ...
                      public final Object get() {
                        ...
                        lambda$getEmptyState$1 =
                            NoAppsAvailableEmptyStateProvider.this.lambda$getEmptyState$1();
                        return lambda$getEmptyState$1;
                      }
                    });
      }
      return new NoAppsAvailableEmptyState(
          title, this.mMetricsCategory, listUserHandle == this.mPersonalProfileUserHandle);
    }
    if (this.mWorkProfileUserHandle == null) {
  ...
  public /* synthetic */ String lambda$getEmptyState$0() {
    return this.mContext.getString(C4337R.string.resolver_no_personal_apps_available);
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ String lambda$getEmptyState$1() {
    return this.mContext.getString(C4337R.string.resolver_no_work_apps_available);
  }
