...
public class NetInitiatedActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p.mPositiveButtonText = String.format(context.getString(C4337R.string.gpsVerifYes), new Object[0]);
        p.mPositiveButtonListener = this;
        p.mNegativeButtonText = String.format(context.getString(C4337R.string.gpsVerifNo), new Object[0]);
        ...
        Log.m94d(TAG, "onCreate() : notificationId: " + this.notificationId + " timeout: " + this.timeout + " default_response:" + this.default_response);
