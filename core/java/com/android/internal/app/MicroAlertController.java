...
public class MicroAlertController extends AlertController {
  ...
  protected void setupContent(ViewGroup contentPanel) {
    this.mScrollView = (ScrollView) this.mWindow.findViewById(C4337R.id.scrollView);
    ...
    if (this.mListView != null) {
      View topPanel = this.mScrollView.findViewById(C4337R.id.topPanel);
      ...
      View buttonPanel = this.mScrollView.findViewById(C4337R.id.buttonPanel);
