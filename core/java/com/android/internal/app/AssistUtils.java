...
public class AssistUtils {
  ...
  private boolean showSessionForActiveServiceInternal(
    ...
    try {
      ...
      if (iVoiceInteractionManagerService != null) {
        return iVoiceInteractionManagerService.showSessionForActiveService(
            args, sourceFlags, attributionTag, showCallback, activityToken);
      }
      return false;
  ...
  public void getActiveServiceSupportedActions(
    ...
    try {
      IVoiceInteractionManagerService iVoiceInteractionManagerService =
          this.mVoiceInteractionManagerService;
      if (iVoiceInteractionManagerService != null) {
        iVoiceInteractionManagerService.getActiveServiceSupportedActions(
  ...
  public static boolean allowDisablingAssistDisclosure(Context context) {
    return context.getResources().getBoolean(C4337R.bool.config_allowDisablingAssistDisclosure);
  }
}
