...
public class HarmfulAppWarningActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    private View createView(ApplicationInfo applicationInfo) {
        View view = getLayoutInflater().inflate(C4337R.layout.harmful_app_warning_dialog, (ViewGroup) null);
        ((TextView) view.findViewById(C4337R.id.app_name_text)).setText(applicationInfo.loadSafeLabel(getPackageManager(), 1000.0f, 5));
