...
public interface IBatteryStats extends IInterface {
  ...
  public static class Default implements IBatteryStats {
    ...
    public void noteStartWakelock(
        int uid, int pid, String name, String historyName, int type, boolean unimportantForLogging)
        throws RemoteException {}
    ...
    public void noteStopWakelockFromSource(
        WorkSource ws, int pid, String name, String historyName, int type) throws RemoteException {}
    ...
    public void notePhoneDataConnectionState(
        int dataType, boolean hasData, int serviceType, int nrFrequency) throws RemoteException {}
    ...
    @Override // com.android.internal.app.IBatteryStats
    public void updateForegroundAppEnergyInfo(List<ForegroundAppEnergyInfo> info)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IBatteryStats {
          ...
          switch (code) {
            ...
            case 34:
              ...
              noteChangeWakelockFromSource(
                  _arg023, _arg112, _arg27, _arg34, _arg44, _arg53, _arg6, _arg7, _arg8, _arg9,
                  _arg10);
              reply.writeNoException();
              return true;
            case 35:
            ...
            case 80:
              ...
              data.enforceNoDataAvail();
              setBatteryState(
                  _arg064, _arg132, _arg217, _arg37, _arg46, _arg54, _arg62, _arg72, _arg82, _arg92,
                  _arg102, _arg11, _arg1210, _arg133);
              reply.writeNoException();
              return true;
            case 81:
            ...
            case 93:
              ...
              return true;
            case 94:
              BluetoothActivityEnergyInfo _arg070 =
              ...
              return true;
            case 95:
              ModemActivityInfo _arg071 =
                  (ModemActivityInfo) data.readTypedObject(ModemActivityInfo.CREATOR);
              data.enforceNoDataAvail();
              noteModemControllerActivity(_arg071);
              return true;
            case 96:
              WifiActivityEnergyInfo _arg072 =
                  (WifiActivityEnergyInfo) data.readTypedObject(WifiActivityEnergyInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 103:
              ...
              return true;
            case 104:
              List<ForegroundAppEnergyInfo> _arg079 =
                  data.createTypedArrayList(ForegroundAppEnergyInfo.CREATOR);
              data.enforceNoDataAvail();
              updateForegroundAppEnergyInfo(_arg079);
              return true;
            case 105:
              SpeakerOutEnergyInfo _arg080 =
                  (SpeakerOutEnergyInfo) data.readTypedObject(SpeakerOutEnergyInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 115:
              SemModemActivityInfo _arg088 =
                  (SemModemActivityInfo) data.readTypedObject(SemModemActivityInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 122:
              ...
              SemCompanionDeviceBatteryInfo _arg144 =
    ...
    private static class Proxy implements IBatteryStats {
      ...
      public CellularBatteryStats getCellularBatteryStats() throws RemoteException {
        ...
        try {
          ...
          CellularBatteryStats _result =
              (CellularBatteryStats) _reply.readTypedObject(CellularBatteryStats.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public BluetoothBatteryStats getBluetoothBatteryStats() throws RemoteException {
        ...
        try {
          ...
          BluetoothBatteryStats _result =
              (BluetoothBatteryStats) _reply.readTypedObject(BluetoothBatteryStats.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public HealthStatsParceler takeUidSnapshot(int uid) throws RemoteException {
        ...
        try {
          ...
          HealthStatsParceler _result =
              (HealthStatsParceler) _reply.readTypedObject(HealthStatsParceler.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public HealthStatsParceler[] takeUidSnapshots(int[] uid) throws RemoteException {
        ...
        try {
          ...
          _reply.readException();
          HealthStatsParceler[] _result =
              (HealthStatsParceler[]) _reply.createTypedArray(HealthStatsParceler.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
    ...
    protected void noteNetworkInterfaceForTransports_enforcePermission() throws SecurityException {
      this.mEnforcer.enforcePermissionAnyOf(
          PERMISSIONS_noteNetworkInterfaceForTransports, getCallingPid(), getCallingUid());
    }
