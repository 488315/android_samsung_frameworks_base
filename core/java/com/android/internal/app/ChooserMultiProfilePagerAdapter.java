...
public class ChooserMultiProfilePagerAdapter extends AbstractMultiProfilePagerAdapter {
    ...
    private ChooserProfileDescriptor createProfileDescriptor(ChooserActivity.ChooserGridAdapter adapter) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(C4337R.layout.chooser_list_per_profile, (ViewGroup) null, false);
    ...
    protected void setupContainerPadding(View container) {
        int initialBottomPadding = getContext().getResources().getDimensionPixelSize(C4337R.dimen.resolver_empty_state_container_padding_bottom);
