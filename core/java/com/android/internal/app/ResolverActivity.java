...
public class ResolverActivity extends Activity implements ResolverListAdapter.ResolverListCommunicator {
    ...
    private enum ActionTitle {
        VIEW("android.intent.action.VIEW", C4337R.string.whichViewApplication, C4337R.string.whichViewApplicationNamed, C4337R.string.whichViewApplicationLabel),
        EDIT(Intent.ACTION_EDIT, C4337R.string.whichEditApplication, C4337R.string.whichEditApplicationNamed, C4337R.string.whichEditApplicationLabel),
        SEND(Intent.ACTION_SEND, C4337R.string.whichSendApplication, C4337R.string.whichSendApplicationNamed, C4337R.string.whichSendApplicationLabel),
        SENDTO(Intent.ACTION_SENDTO, C4337R.string.whichSendToApplication, C4337R.string.whichSendToApplicationNamed, C4337R.string.whichSendToApplicationLabel),
        SEND_MULTIPLE(Intent.ACTION_SEND_MULTIPLE, C4337R.string.whichSendApplication, C4337R.string.whichSendApplicationNamed, C4337R.string.whichSendApplicationLabel),
        CAPTURE_IMAGE("android.media.action.IMAGE_CAPTURE", C4337R.string.whichImageCaptureApplication, C4337R.string.whichImageCaptureApplicationNamed, C4337R.string.whichImageCaptureApplicationLabel),
        DEFAULT(null, C4337R.string.whichApplication, C4337R.string.whichApplicationNamed, C4337R.string.whichApplicationLabel),
        HOME(Intent.ACTION_MAIN, C4337R.string.whichHomeApplication, C4337R.string.whichHomeApplicationNamed, C4337R.string.whichHomeApplicationLabel);
    ...
    protected void onCreate(Bundle savedInstanceState, Intent intent, CharSequence title, int defaultTitleRes, Intent[] initialIntents, List<ResolveInfo> rList, boolean supportsAlwaysUseOption) {
        ...
        if (!supportsAlwaysUseOption) {
            ...
            if (action != null && (action.endsWith(Intent.ACTION_SEND) || action.endsWith(Intent.ACTION_SEND_MULTIPLE) || action.endsWith(Intent.ACTION_SENDTO) || action.endsWith("UNLIMITED_SHARE"))) {
                ...
                Log.m94d(TAG, "onCreate(): isShareListAllowed(" + isShareListAllowed + NavigationBarInflaterView.KEY_CODE_END);
    ...
    protected AbstractMultiProfilePagerAdapter.EmptyStateProvider createBlockerEmptyStateProvider() {
        ...
        AbstractMultiProfilePagerAdapter.EmptyState noWorkToPersonalEmptyState = new NoCrossProfileEmptyStateProvider.DevicePolicyBlockerEmptyState(this, DevicePolicyResources.Strings.Core.RESOLVER_CROSS_PROFILE_BLOCKED_TITLE, C4337R.string.resolver_cross_profile_blocked, DevicePolicyResources.Strings.Core.RESOLVER_CANT_ACCESS_PERSONAL, C4337R.string.resolver_cant_access_personal_apps_explanation, 158, METRICS_CATEGORY_RESOLVER);
        AbstractMultiProfilePagerAdapter.EmptyState noPersonalToWorkEmptyState = new NoCrossProfileEmptyStateProvider.DevicePolicyBlockerEmptyState(this, DevicePolicyResources.Strings.Core.RESOLVER_CROSS_PROFILE_BLOCKED_TITLE, C4337R.string.resolver_cross_profile_blocked, DevicePolicyResources.Strings.Core.RESOLVER_CANT_ACCESS_WORK, C4337R.string.resolver_cant_access_work_apps_explanation, 159, METRICS_CATEGORY_RESOLVER);
    ...
    protected boolean shouldAddFooterView() {
        View buttonBar;
        return useLayoutWithDefault() || (buttonBar = findViewById(C4337R.id.button_bar)) == null || buttonBar.getVisibility() == 8;
    }
    ...
    protected WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
        ...
        if (shouldUseMiniResolver()) {
            ...
            buttonContainer.setPadding(0, 0, 0, this.mSystemWindowInsets.bottom + getResources().getDimensionPixelOffset(C4337R.dimen.resolver_button_bar_spacing));
        }
    ...
    private void updateIntentPickerPaddings() {
        ...
        if (titleCont != null) {
            titleCont.setPadding(titleCont.getPaddingLeft(), titleCont.getPaddingTop(), titleCont.getPaddingRight(), getResources().getDimensionPixelSize(C4337R.dimen.resolver_title_padding_bottom));
        }
        View buttonBar = findViewById(C4337R.id.button_bar);
        if (buttonBar != null) {
            buttonBar.setPadding(buttonBar.getPaddingLeft(), getResources().getDimensionPixelSize(C4337R.dimen.resolver_button_bar_spacing), buttonBar.getPaddingRight(), getResources().getDimensionPixelSize(C4337R.dimen.resolver_button_bar_spacing));
        }
    }
    ...
    public void updateProfileViewButton() {
        ...
        if (dri != null && !shouldShowTabs()) {
            ...
            semSetTextSizeByMaxFontScale((TextView) text, C4337R.dimen.sem_resolver_pagemode_titlepanel_text_size);
            return;
        }
    ...
    public void setAlwaysButtonEnabled(boolean hasValidSelection, int checkedPos, boolean filtered) {
        ...
        if (hasValidSelection) {
            ...
            this.mAlwaysButton.setText(getResources().getString(C4337R.string.activity_resolver_use_always));
        }
        if (ri != null) {
    ...
    public void startSelected(int which, boolean always, boolean hasIndexBeenFiltered) {
        ...
        if (this.mSecondDepth) {
            ...
            Log.m98i(TAG, "lastChosenIndex : " + lastChosenIndex + ", lastChosenActivity" + lastChosenActivity);
    ...
    public final void onPostListReady(ResolverListAdapter listAdapter, boolean doPostProcessing, boolean rebuildCompleted, boolean skipAutoLaunch) {
        ...
        if (!skipAutoLaunch && rebuildCompleted && maybeAutolaunchActivity()) {
            Log.m96e(TAG, "onPostListReady return skipAutoLaunch = " + skipAutoLaunch + ", rebuildComplete = " + rebuildCompleted);
            return;
        }
        if (doPostProcessing) {
    ...
    protected void onListRebuilt(ResolverListAdapter listAdapter, boolean rebuildCompleted) {
        ...
        if (shouldShowTabs() && this.mIsIntentPicker && (rdl = (ResolverDrawerLayout) findViewById(C4337R.id.contentPanel)) != null) {
        ...
        if (intent != null && ((this.mSupportsAlwaysUseOption || this.mMultiProfilePagerAdapter.getActiveListAdapter().hasFilteredItem()) && this.mMultiProfilePagerAdapter.getActiveListAdapter().getUnfilteredResolveList() != null)) {
            ...
            if (filter != null) {
                ...
                if (!needToAddBackProfileForwardingComponent) {
                    ...
                    Log.m98i(TAG, "preferred : otherProfileMatch = " + otherProfileMatch + ", set = " + set[N]);
                    bestMatch = bestMatch2;
                }
                if (this.mSupportsAlwaysUseOption && (semShareLogging = this.mSemShareLogging) != null && semShareLogging.isSupportDMA()) {
                    ComponentName cn = intent.getComponent();
                    String packageName = cn != null ? cn.getPackageName() : "";
                    this.mSemShareLogging.insertLog(SemShareConstants.DMA_SURVEY_FEATURE_RESOLVER_PICKED_APP, packageName);
                    if (always) {
                        this.mSemShareLogging.insertLog(SemShareConstants.DMA_SURVEY_FEATURE_RESOLVER_ONCE_ALWAYS, "0");
                    } else {
                        this.mSemShareLogging.insertLog(SemShareConstants.DMA_SURVEY_FEATURE_RESOLVER_ONCE_ALWAYS, "1");
                    }
                }
                if (always) {
                    int userId = getUserId();
                    PackageManager pm = getPackageManager();
                    Log.m98i(TAG, "preferred : bestMatch = " + bestMatch + ", comp = " + intent.getComponent());
    ...
    private boolean configureContentView() {
        ...
        if (checkIfNeedFRPWorkaround()) {
            ...
            this.mMultiProfilePagerAdapter.setupViewPager((ViewPager) findViewById(C4337R.id.profile_pager));
    ...
    private void configureMiniResolverContent() {
        ...
        new ResolverListAdapter.LoadIconTask(inactiveAdapter, otherProfileResolveInfo, otherProfileResolveInfo, icon) { // from class: com.android.internal.app.ResolverActivity.5
            ...
            @Override // com.android.internal.app.ResolverListAdapter.LoadIconTask, android.p009os.AsyncTask
        ...
        if (inWorkProfile) {
            ((TextView) findViewById(C4337R.id.open_cross_profile)).setText(devicePolicyResourcesManager.getString("Core.MINIRESOLVER_OPEN_IN_PERSONAL", new Supplier() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda12
                @Override // java.util.function.Supplier
                public final Object get() {
            ...
            ((Button) findViewById(C4337R.id.use_same_profile_browser)).setText(devicePolicyResourcesManager.getString("Core.MINIRESOLVER_OPEN_IN_PERSONAL", new Supplier() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda13
                @Override // java.util.function.Supplier
                public final Object get() {
            ...
            ((TextView) findViewById(C4337R.id.open_cross_profile)).setText(devicePolicyResourcesManager.getString(DevicePolicyResources.Strings.Core.MINIRESOLVER_OPEN_IN_WORK, new Supplier() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda14
                @Override // java.util.function.Supplier
                public final Object get() {
            ...
            ((Button) findViewById(C4337R.id.use_same_profile_browser)).setText(devicePolicyResourcesManager.getString("Core.MINIRESOLVER_OPEN_IN_PERSONAL", new Supplier() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda15
                @Override // java.util.function.Supplier
                public final Object get() {
        ...
        findViewById(C4337R.id.use_same_profile_browser).setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda16
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ResolverActivity.this.lambda$configureMiniResolverContent$9(sameProfileResolveInfo, view);
            }
        });
        findViewById(C4337R.id.button_open).setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.app.ResolverActivity$$ExternalSyntheticLambda17
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void setupProfileTabs() {
        ...
        Button personalButton = (Button) getLayoutInflater().inflate(C4337R.layout.sem_resolver_profile_tab_button, (ViewGroup) tabHost.getTabWidget(), false);
        personalButton.setText(getPersonalTabLabel());
        personalButton.setContentDescription(getPersonalTabAccessibilityLabel());
        TabHost.TabSpec tabSpec = tabHost.newTabSpec("personal").setContent(C4337R.id.profile_pager).setIndicator(personalButton);
        tabHost.addTab(tabSpec);
        Button workButton = (Button) getLayoutInflater().inflate(C4337R.layout.sem_resolver_profile_tab_button, (ViewGroup) tabHost.getTabWidget(), false);
        workButton.setText(getWorkTabLabel());
        workButton.setContentDescription(getWorkTabAccessibilityLabel());
        TabHost.TabSpec tabSpec2 = tabHost.newTabSpec(TAB_TAG_WORK).setContent(C4337R.id.profile_pager).setIndicator(workButton);
    ...
    private void maybeCreateHeader(ResolverListAdapter listAdapter) {
        ...
        if (!TextUtils.isEmpty(title)) {
            ...
            setTitle(title);
            semSetTextSizeByMaxFontScale(titleView3, C4337R.dimen.sem_resolver_pagemode_titlepanel_text_size);
        }
    ...
    protected void resetButtonBar() {
        ...
        if (!useLayoutWithDefault()) {
            ...
            buttonLayout.setPadding(buttonLayout.getPaddingLeft(), buttonLayout.getPaddingTop(), buttonLayout.getPaddingRight(), getResources().getDimensionPixelSize(C4337R.dimen.resolver_button_bar_spacing) + inset);
        }
        ...
        if (button2 != null && button != null) {
            button2.setContentDescription(getString(C4337R.string.sem_resolver_button_just_once_accessibility));
            this.mAlwaysButton.setContentDescription(getString(C4337R.string.sem_resolver_button_always_accessibility));
        }
    ...
    private void resetAlwaysOrOnceButtonBar() {
        int btnTextSize = getResources().getDimensionPixelSize(C4337R.dimen.sem_dialog_button_text_size);
    ...
    class ItemClickListener implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (displayInfo != null && displayInfo.getSimilarList().size() > 1) {
                ...
                resolverActivity.mSelectTaskRecyclerView = (RecyclerView) resolverActivity.findViewById(C4337R.id.sem_resolver_second_depth_recycler_view);
                ResolverActivity resolverActivity2 = ResolverActivity.this;
                resolverActivity2.mSemSelectTaskListAdapter = resolverActivity2.new SemSelectTaskListAdapter(displayInfo.getSimilarList());
    ...
    private void semTransitionOverride(Context context, int type) {
        if (!this.mIsPopOver) {
            if (isInMultiWindowMode() || this.mIsDeskTopMode) {
                overridePendingTransition(C4337R.anim.sem_resolver_fade_in, C4337R.anim.sem_resolver_fade_out);
            } else if (type == 0) {
                overridePendingTransition(C4337R.anim.sem_resolver_panel_enter, 0);
            } else {
                overridePendingTransition(C4337R.anim.sem_resolver_finish_panel_enter, C4337R.anim.sem_resolver_exit);
            }
        }
    }
    ...
    private void semSetupAdapterListView(AbsListView listView, ItemClickListener listener) {
        ...
        if (listView instanceof GridView) {
            ...
            Log.m94d(TAG, "ActiveProfile : " + this.mMultiProfilePagerAdapter.getActiveListAdapter().toString() + "itemCount : " + itemCount);
    ...
    private void semCreateAndShowTipsPopup(View anchor) {
        ...
        this.mTipsDescriptionPopup.setTargetPosition(anchorPos[0] + (this.mTipsIcon.getWidth() / 2), anchorPos[1] + this.mTipsIcon.getHeight() + getResources().getDimensionPixelSize(C4337R.dimen.sem_resolver_tips_popup_yoffset));
    ...
    public class SemSelectTaskListAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View listItem = layoutInflater.inflate(C4337R.layout.sem_resolver_second_depth_list_item, parent, false);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View itemView) {
                super(itemView);
                this.radioButton = (RadioButton) itemView.findViewById(C4337R.id.sem_resolver_second_depth_item_button);
                this.textView = (TextView) itemView.findViewById(C4337R.id.sem_resolver_second_depth_item_text);
