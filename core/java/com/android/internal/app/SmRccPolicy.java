...
public final class SmRccPolicy {
  ...
  /* renamed from: ON */
  private static final String f662ON = "1";
  ...
  private SmRccPolicy(Context context) {
    Slog.m117i(TAG, "RccAppPolicy init");
  ...
  public void lambda$new$0() {
    try {
      ...
      Slog.m117i(TAG, "registerRccDBObserver");
    } catch (Exception e) {
      Slog.m116e(TAG, "registerRccDBObserver error", e);
    }
  }
  ...
  public void loadRccAppFromSm() {
    Slog.m117i(TAG, "loadRccAppFromSm: ");
    mRccPkgMap.clear();
    try {
      Cursor cursor =
          this.mContext.getContentResolver().query(RCC_APP_CONTENT_URI, null, null, null, null);
      if (cursor != null) {
        try {
          if (!cursor.isClosed()) {
      ...
      Slog.m116e(TAG, "loadRccAppFromSm error", e);
    }
  }
  ...
  public void addRccPackage(RccApp rccApp) {
    ...
    if (rccApp != null && (pkgName = rccApp.getPkgName()) != null) {
      ...
      Slog.m117i(TAG, "addRccPackage: " + pkgName);
    }
  }
  ...
  public void removeRccPackage(String packageName) {
    ...
    Slog.m117i(TAG, "removeRccPackage: " + packageName);
  }
  ...
  public void updateRccShow(String packageName, String show) {
    ...
    Slog.m117i(TAG, "update rcc show pkg=" + packageName + " show=" + show);
  }
  ...
  public void updateRccOpen(String packageName, String open) {
    ...
    Slog.m117i(TAG, "update rcc open pkg=" + packageName + " open=" + open);
  }
  ...
  public void updateRccRestrict(String packageName, String restrict) {
    ...
    Slog.m117i(TAG, "update rcc restrict pkg=" + packageName + " restrict=" + restrict);
  }
  ...
  public boolean isSmRccPkg(String packageName) {
    ...
    Slog.m117i(TAG, "isSmRccPkg=" + packageName + ",show=" + show + ",restrict=" + restrict);
  ...
  public boolean isSmRccOpen(String packageName) {
    ...
    Slog.m117i(TAG, "isSmRccOpen=" + packageName + ",open=" + open);
    if (!"1".equals(open)) {
      return false;
    }
    return true;
  ...
  public void callResetSmRccOpen(String packageName) {
    if (packageName != null && mRccPkgMap.containsKey(packageName)) {
      ...
      try {
        ...
        Slog.m113d(TAG, "call sm reset rcc open status");
      } catch (Exception e) {
        Slog.m116e(TAG, "call sm reset rcc open status error", e);
      }
    }
  }
  ...
  public void loadData() {
    ...
    if (handler == null) {
      Slog.m117i(TAG, "SmRcc handler is null, return");
    } else {
