...
public interface IAppOpsService extends IInterface {
  ...
  void finishProxyOperation(IBinder iBinder, int i, AttributionSource attributionSource, boolean z)
      throws RemoteException;
  ...
  SyncNotedAppOp noteProxyOperation(
      int i, AttributionSource attributionSource, boolean z, String str, boolean z2, boolean z3)
      throws RemoteException;
  ...
  public static class Default implements IAppOpsService {
    ...
    public void startWatchingModeWithFlags(
        int op, String packageName, int flags, IAppOpsCallback callback) throws RemoteException {}
    ...
    public void finishProxyOperation(
        IBinder clientId, int code, AttributionSource attributionSource, boolean skipProxyOperation)
        throws RemoteException {}
    ...
    public void collectNoteOpCallsForValidation(
        String stackTrace, int op, String packageName, long version) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 3:
              ...
              SyncNotedAppOp _result3 =
                  startOperation(
                      _arg03, _arg13, _arg23, _arg32, _arg42, _arg52, _arg62, _arg7, _arg8, _arg9,
                      _arg10);
              reply.writeNoException();
            ...
            case 13:
              ...
              SyncNotedAppOp _result8 =
                  startProxyOperation(
                      _arg013, _arg19, _arg29, _arg37, _arg45, _arg54, _arg63, _arg72, _arg82,
                      _arg92, _arg102);
              reply.writeNoException();
            ...
            case 20:
              ...
              data.enforceNoDataAvail();
              getHistoricalOps(
                  _arg019, _arg114, _arg213, _arg39, _arg46, _arg55, _arg64, _arg73, _arg83,
                  _arg93);
              reply.writeNoException();
              return true;
            case 21:
              ...
              getHistoricalOpsFromDiskRaw(
                  _arg020, _arg115, _arg214, _arg310, _arg47, _arg56, _arg65, _arg74, _arg84,
                  _arg94);
              reply.writeNoException();
              return true;
            case 22:
      ...
      public RuntimeAppOpAccessMessage collectRuntimeAppOpAccessMessage() throws RemoteException {
        ...
        try {
          ...
          RuntimeAppOpAccessMessage _result =
              (RuntimeAppOpAccessMessage) _reply.readTypedObject(RuntimeAppOpAccessMessage.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public MessageSamplingConfig reportRuntimeAppOpAccessMessageAndGetConfig(
        ...
        try {
          ...
          MessageSamplingConfig _result =
              (MessageSamplingConfig) _reply.readTypedObject(MessageSamplingConfig.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
