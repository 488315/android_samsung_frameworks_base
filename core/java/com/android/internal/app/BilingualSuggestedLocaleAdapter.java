...
public class BilingualSuggestedLocaleAdapter extends SuggestedLocaleAdapter {
  ...
  public BilingualSuggestedLocaleAdapter(
      Set<LocaleStore.LocaleInfo> localeOptions, boolean countryMode, Locale secondaryLocale) {
        ...
        if (!(convertView instanceof TextView)) {
          convertView =
              this.mInflater.inflate(
                  C4337R.layout.language_picker_bilingual_section_header, parent, false);
        }
        TextView textView = (TextView) convertView;
        if (itemType == 0) {
          setHeaderText(
              textView,
              C4337R.string.language_picker_section_suggested_bilingual,
              C4337R.string.region_picker_section_suggested_bilingual);
        } else {
          setHeaderText(
              textView,
              C4337R.string.language_picker_section_all,
              C4337R.string.region_picker_section_all);
        }
        return convertView;
      default:
        if (!(convertView instanceof ViewGroup)) {
          convertView =
              this.mInflater.inflate(C4337R.layout.language_picker_bilingual_item, parent, false);
        }
