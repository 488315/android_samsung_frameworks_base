...
public class BilingualSuggestedLocaleAdapter extends SuggestedLocaleAdapter {
        ...
        switch (itemType) {
            ...
            case 1:
                if (!(convertView instanceof TextView)) {
                    convertView = this.mInflater.inflate(C4337R.layout.language_picker_bilingual_section_header, parent, false);
                }
                TextView textView = (TextView) convertView;
                if (itemType == 0) {
                    setHeaderText(textView, C4337R.string.language_picker_section_suggested_bilingual, C4337R.string.region_picker_section_suggested_bilingual);
                } else {
                    setHeaderText(textView, C4337R.string.language_picker_section_all, C4337R.string.region_picker_section_all);
                }
                return convertView;
            default:
                if (!(convertView instanceof ViewGroup)) {
                    convertView = this.mInflater.inflate(C4337R.layout.language_picker_bilingual_item, parent, false);
                }
    ...
    private void setItemState(boolean selected, View itemView) {
        ...
        ImageView indicator = (ImageView) itemView.findViewById(C4337R.id.indicator);
        TextView textNative = (TextView) itemView.findViewById(C4337R.id.locale_native);
        TextView textSecondary = (TextView) itemView.findViewById(C4337R.id.locale_secondary);
        ...
        if (selected) {
            background.setBackgroundResource(C4337R.drawable.language_picker_item_bg_selected);
