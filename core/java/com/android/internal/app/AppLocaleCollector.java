...
public class AppLocaleCollector implements LocalePickerWithRegion.LocaleCollectorBase {
  ...
  public Set<LocaleStore.LocaleInfo> getAllAppActiveLocales() {
    ...
    if (pm != null && lm != null) {
      ...
      for (ApplicationInfo appInfo :
          pm.getInstalledApplications(PackageManager.ApplicationInfoFlags.m9of(0L))) {
        LocaleStore.LocaleInfo localeInfo =
            LocaleStore.getAppActivatedLocaleInfo(this.mContext, appInfo.packageName, false);
  ...
  public Set<LocaleStore.LocaleInfo> getSupportedLocaleList(
    ...
    boolean shouldShowList =
        result.mLocaleStatus
            ...
            || result.mLocaleStatus
                == AppLocaleStore.AppLocaleResult.LocaleStatus.GET_SUPPORTED_LANGUAGE_FROM_ASSET;
      ...
      for (LocaleStore.LocaleInfo localeInfo2 : localeInfoSet) {
        boolean isCurrentLocale =
            this.mAppCurrentLocale != null
                && localeInfo2.getLocale().equals(this.mAppCurrentLocale.getLocale());
    ...
    if (Build.isDebuggable()) {
      Log.m94d(TAG, "App locale list: " + appLocaleList);
    }
  ...
  private Set<LocaleStore.LocaleInfo> filterSameLanguageAndCountry(
      Set<LocaleStore.LocaleInfo> newLocaleList, Set<LocaleStore.LocaleInfo> existingLocaleList) {
