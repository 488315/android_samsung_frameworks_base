...
public class AlertController {
    ...
    public static final AlertController create(Context context, DialogInterface di, Window window) {
        TypedArray a = context.obtainStyledAttributes(null, C4337R.styleable.AlertDialog, 16842845, 16974371);
    ...
    private void setupView() {
        ...
        if (!hasButtonPanel2) {
            if (contentPanel != null && (spacer2 = contentPanel.findViewById(C4337R.id.textSpacerNoButtons)) != null) {
        ...
        } else if (contentPanel != null && (spacer = contentPanel.findViewById(C4337R.id.textSpacerNoTitle)) != null) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C4337R.styleable.AlertDialog, 16842845, 0);
    ...
    protected void setupTitle(ViewGroup topPanel) {
        ...
        if (hasTextTitle && this.mShowTitle) {
            ...
            semCheckMaxFontScale(this.mTitleView, this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_dialog_title_text_size));
            int i = this.mIconId;
            if (i != 0) {
    ...
    protected void setupContent(ViewGroup contentPanel) {
        ...
        if (charSequence != null) {
            ...
            semCheckMaxFontScale(this.mMessageView, this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_dialog_body_text_size));
    ...
    private void semSetupPaddings() {
        ...
        if ((hasCustomPanel && !hasTopPanel && !hasDefaultContentPanel) || hasCustomTitleView) {
            ...
            mParentPanel.setPadding(0, resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_title_padding_top), 0, 0);
        }
        if (mTitleTemplate != null) {
            if (hasCustomPanel && hasTopPanel && !hasDefaultContentPanel) {
                mTitleTemplate.setPadding(resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_padding_horizontal), 0, resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_padding_horizontal), 0);
            } else {
                mTitleTemplate.setPadding(resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_padding_horizontal), 0, resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_padding_horizontal), resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_title_padding_bottom));
            }
        }
        if (mScrollview != null) {
            mScrollview.setPadding(resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_body_text_scroll_padding_start), 0, resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_body_text_scroll_padding_end), resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_body_text_padding_bottom));
        }
        if (mButtonPanel != null) {
            mButtonPanel.setPadding(resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_button_bar_padding_horizontal), 0, resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_button_bar_padding_horizontal), resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_button_bar_padding_bottom));
        }
    }
    ...
    private void semAdjustTopPanelPadding(View parentPanel) {
        Resources resources = this.mContext.getResources();
        int paddingHorizontal = resources.getDimensionPixelSize(C4337R.dimen.sem_dialog_padding_horizontal);
    ...
    private void semAdjustContentPanelPadding(View contentPanel) {
        int topPadding = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_select_dialog_padding_top_item_material);
    ...
    private void semSetupButtonsPadding() {
        final int btnTextSize = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_dialog_button_text_size);
