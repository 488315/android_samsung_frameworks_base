...
public class IntentForwarderActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (className.equals(FORWARD_INTENT_TO_PARENT)) {
            ...
            getMetricsLogger()
                    .write(
                            new LogMaker(MetricsProto.MetricsEvent.ACTION_SWITCH_SHARE_PROFILE)
                                    .setSubtype(1));
            ...
            Slog.wtf(
                    userMessage4,
                    IntentForwarderActivity.class.getName() + " cannot be called directly");
            userMessage = null;
            targetUserId = -10000;
            managedProfile = null;
        }
        ...
        Slog.d(
                TAG,
                "forward intent from : "
                        + this.mFinalCallingUserId
                        + " to "
                        + this.mFinalTargetUserId);
        if (newIntent == null) {
            Slog.wtf(
                    TAG,
                    "the intent: "
        ...
        if (isPrivateProfile(callingUserId)) {
            buildAndExecuteForPrivateProfile(
                ...
                .thenApplyAsync(
                        new Function() { // from class:
                            ...
                            public final Object apply(Object obj) {
                                ...
                                lambda$buildAndExecute$0 =
                                        IntentForwarderActivity.this.lambda$buildAndExecute$0(
                                                callingUserId,
                                                targetUserId,
                                                newIntent,
                                                intentReceived,
                ...
                .thenAcceptAsync(
                        (Consumer<? super U>)
                                new Consumer() { // from class:
                                                 // com.android.internal.app.IntentForwarderActivity$$ExternalSyntheticLambda11
                                    @Override // java.util.function.Consumer
                                    public final void accept(Object obj) {
                                        IntentForwarderActivity.this.lambda$buildAndExecute$1(
                                                className,
                                                intentReceived,
                                                userMessage,
                                                newIntent,
    ...
    public /* synthetic */ ResolveInfo lambda$buildAndExecute$0(
        ...
        if (isResolverActivityResolveInfo(targetResolveInfo)) {
            launchResolverActivityWithCorrectTab(
                    intentReceived, className, newIntent, callingUserId, targetUserId, false);
    ...
    private void buildAndExecuteForPrivateProfile(
        ...
        CompletableFuture<ResolveInfo> targetResolveInfoFuture =
                this.mInjector.resolveActivityAsUser(newIntent, 65536, targetUserId);
        targetResolveInfoFuture.thenAcceptAsync(
                new Consumer() { // from class:
                                 // com.android.internal.app.IntentForwarderActivity$$ExternalSyntheticLambda2
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        IntentForwarderActivity.this.lambda$buildAndExecuteForPrivateProfile$2(
                                intentReceived,
                                className,
                                newIntent,
                                callingUserId,
    ...
    public /* synthetic */ void lambda$buildAndExecuteForPrivateProfile$2(
        ...
        if (isResolverActivityResolveInfo(targetResolveInfo)) {
            launchResolverActivityWithCorrectTab(
                    intentReceived, className, newIntent, callingUserId, targetUserId, true);
        } else {
    ...
    private void maybeShowUserConsentMiniResolver(
        ...
        boolean intentToLaunchProfileOwner =
                profileOwnerName != null
                        && profileOwnerName
                                .getPackageName()
                                .equals(target.getComponentInfo().packageName);
        if (privilegedCallerAskedToSkipUserConsent || intentToLaunchProfileOwner) {
            Log.i(
                    "IntentForwarderActivity",
                    String.format(
                            "Skipping user consent for redirection into the managed profile for"
                                + " intent [%s], privilegedCallerAskedToSkipUserConsent=[%s],"
        ...
        Log.i(
                "IntentForwarderActivity",
                String.format(
                        "Showing user consent for redirection into the managed profile for intent"
                            + " [%s] and  calling package [%s]",
                        launchIntent, callingPackage));
        PackageManager packageManagerForTargetUser =
                createContextAsUser(UserHandle.of(targetUserId), 0).getPackageManager();
        buildMiniResolver(
                target,
                launchIntent,
                targetUserId,
        ...
        if ((isDialerIntent(launchIntent) || isTextMessageIntent(launchIntent))
            ...
            ((TextView) findViewById(R.id.miniresolver_info_section_text))
                    .lambda$setTextAsync$0(getWorkTelephonyInfoSectionMessage(launchIntent));
        } else {
    ...
    private void maybeShowUserConsentMiniResolverPrivate(
        ...
        Log.i(
                "IntentForwarderActivity",
                String.format(
                        "Showing user consent for redirection into the main profile for intent [%s]"
                            + " and  calling package [%s]",
                        launchIntent, callingPackage));
        PackageManager packageManagerForTargetUser =
                createContextAsUser(UserHandle.of(targetUserId), 0).getPackageManager();
        buildMiniResolver(
        ...
        if (isTextMessageIntent(launchIntent)) {
            ((TextView) findViewById(R.id.miniresolver_info_section_text))
                    .setText(R.string.miniresolver_private_space_messages_information);
        } else {
            ((TextView) findViewById(R.id.miniresolver_info_section_text))
                    .setText(R.string.miniresolver_private_space_phone_information);
        }
    }

    private void buildMiniResolver(
            ResolveInfo target,
            final Intent launchIntent,
            final int targetUserId,
            String resolverTitle,
            PackageManager pmForTargetUser) {
        ...
        findViewById(R.id.button_open)
                .setOnClickListener(
                        new View
                            ...
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                IntentForwarderActivity.this.lambda$buildMiniResolver$4(
                ...
                .getString(
                        ...
                        new Supplier() { // from class:
                            ...
                            public final Object get() {
                                ...
                                lambda$getOpenInWorkMessage$7 =
                                        IntentForwarderActivity.this.lambda$getOpenInWorkMessage$7(
                                                targetLabel);
                    ...
                    .getString(
                            ...
                            new Supplier() { // from class:
                                ...
                                public final Object get() {
                                    ...
                                    lambda$getWorkTelephonyInfoSectionMessage$9 =
                                            IntentForwarderActivity.this
                                                    .lambda$getWorkTelephonyInfoSectionMessage$9();
    ...
    private String getForwardToPersonalMessageFromSecureFolder() {
        return String.format(
                getString(R.string.forward_intent_from), getString(R.string.secure_folder));
    }
                ...
                .getString(
                        ...
                        new Supplier() { // from class:
                            ...
                            public final Object get() {
                                ...
                                lambda$getForwardToPersonalMessage$10 =
                                        IntentForwarderActivity.this
                                                .lambda$getForwardToPersonalMessage$10();
                ...
                .getString(
                        ...
                        new Supplier() { // from class:
                            ...
                            public final Object get() {
                                ...
                                lambda$getForwardToWorkMessage$11 =
                                        IntentForwarderActivity.this
                                                .lambda$getForwardToWorkMessage$11();
    ...
    private boolean isResolverActivityResolveInfo(ResolveInfo resolveInfo) {
        return (resolveInfo == null
                        ...
                        || !RESOLVER_COMPONENT_NAME.equals(
                                resolveInfo.activityInfo.getComponentName()))
                ? false
                : true;
    }

    private void maybeShowDisclosure(
            Intent intentReceived, ResolveInfo resolveInfo, String message) {
    ...
    private void startActivityAsCaller(Intent newIntent, int userId) {
        ...
        try {
            ...
            if (Intent.ACTION_CHOOSER.equals(newIntent.getAction())) {
                drivingIntent =
                        (Intent) newIntent.getParcelableExtra("android.intent.extra.INTENT");
            ...
            if (drivingIntent != null
                ...
                Intent ChooserIntent =
                        Intent.createChooser(
                                drivingIntent,
                                Resources.getSystem().getText(R.string.whichSendApplication));
                Parcelable[] pa =
                        drivingIntent.getParcelableArrayExtra(Intent.EXTRA_EXCLUDE_COMPONENTS);
                ...
                if (this.mPersona != null) {
                    if (forwardfromKnox && userId == 0) {
                        policyExcludeComponents =
                                this.mPersona.getExcludeComponentList(
        ...
        Intent innerIntent =
                (Intent)
                        intentReceived.getParcelableExtra(
                                "android.intent.extra.INTENT", Intent.class);
        if (innerIntent == null) {
            Slog.wtf(
                    TAG, "Cannot start a chooser intent with no extra android.intent.extra.INTENT");
            return;
        }
    ...
    private void launchResolverActivityWithCorrectTab(
        ...
        int userId =
                isIntentForwarderResolveInfo(callingResolveInfo) ? targetUserId : callingUserId;
        int selectedProfile = findSelectedProfile(className);
        sanitizeIntent(intentReceived);
        intentReceived.putExtra(
                "com.android.internal.app.ResolverActivity.EXTRA_SELECTED_PROFILE",
                    ...
                    new Supplier() { // from class:
                        ...
                        public final Object get() {
                            ...
                            lambda$resolveActivityAsUser$0 =
                                    IntentForwarderActivity.InjectorImpl.this
                                            .lambda$resolveActivityAsUser$0(intent, flags, userId);
    ...
    private void showKeyguard(int userId) {
        ...
        this.mBroadcastReceiver =
                new BroadcastReceiver() { // from class:
                                          // com.android.internal.app.IntentForwarderActivity.1
                    ...
                    public void onReceive(Context context, Intent intent) {
                        if (intent != null) {
                            ...
                            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                                ...
                                if (IntentForwarderActivity.SYSTEM_DIALOG_REASON_HOME_KEY.equals(
                                        reason)) {
                                    IntentForwarderActivity.this.finish();
                                } else if (IntentForwarderActivity.SYSTEM_DIALOG_REASON_RECENT_APPS
                                        .equals(reason)) {
                                    IntentForwarderActivity.this.finish();
                                }
                            }
    ...
    private boolean isAbleToUsingCopyToSecureFolder(Intent intent) {
        ...
        String classNameSF =
                SemPersonaManager.SECUREFOLDER_PACKAGE + ".switcher.B2CStoreFilesActivity";
        if (pa != null) {
            for (int i = 0; i < pa.length; i++) {
                if (pa[i] instanceof ComponentName) {
                    ...
                    if (SemPersonaManager.SECUREFOLDER_PACKAGE.equals(excludeComp.getPackageName())
                        ...
                        Slog.d(
                                TAG,
                                "isWantToB2CStore | not support " + excludeComp.getPackageName());
                        return false;
                    }
                }
            }
        ...
        if (srcUris != null && srcUris.size() > 0) {
            ...
            while (true) {
                ...
                if (tempUri != null) {
                    if (tempUri.getUserInfo() != null
                            && !tempUri.getUserInfo().equals(String.valueOf(0))) {
