...
public class SuggestedLocaleAdapter extends BaseAdapter implements Filterable {
  ...
  public int getCount() {
    ...
    if (showHeaders()) {
      if (showSecHeaders()
          && this.mSuggestionCount + this.mSecSuggestionCount < this.mLocaleOptions.size()) {
        offset = 0 + 3;
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    switch (itemType) {
      ...
      case 4:
        itemView
            .findViewById(C4337R.id.language_picker_item)
            .findViewById(C4337R.id.divider)
            .setVisibility(8);
      ...
      case 5:
        ...
        title.setContentDescription(
            itemView.getContext().getResources().getString(C4337R.string.system_locale_title));
        return itemView;
    }
  }
    ...
    switch (itemType) {
      ...
      case 3:
        boolean shouldReuseView =
            (convertView instanceof TextView)
                && convertView.findViewById(C4337R.id.section_header) != null;
        if (!shouldReuseView) {
          break;
        }
        break;
      ...
      default:
        boolean shouldReuseView2 =
            (!(convertView instanceof ViewGroup)
                    || convertView.findViewById(C4337R.id.locale) == null
                    || convertView.findViewById(C4337R.id.divider) == null)
                ? false
                : true;
        if (!shouldReuseView2) {
      ...
      case 4:
        ...
        boolean shouldReuseView4 =
            shouldReuseView3 && convertView.findViewById(C4337R.id.external_divider) != null;
        if (!shouldReuseView4) {
          View updatedView2 =
              this.mInflater.inflate(
                  C4337R.layout.sec_app_language_picker_current_locale_item, parent, false);
        ...
        if (((LocaleStore.LocaleInfo) getItem(position)).isAppCurrentLocale()) {
          boolean shouldReuseView5 =
              (convertView instanceof LinearLayout)
                  && convertView.findViewById(C4337R.id.language_picker_item) != null;
          if (!shouldReuseView5) {
            View updatedView3 =
                this.mInflater.inflate(
                    C4337R.layout.sec_app_language_picker_current_locale_item, parent, false);
          ...
          if (!shouldReuseView6) {
            View updatedView4 =
                this.mInflater.inflate(C4337R.layout.language_picker_item, parent, false);
