...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C4337R.id.decor_content_parent);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C4337R.styleable.ActionBar, 16843470, 0);
