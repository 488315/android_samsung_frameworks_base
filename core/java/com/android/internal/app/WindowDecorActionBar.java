...
public class WindowDecorActionBar extends ActionBar
  ...
  final Animator.AnimatorListener mHideListener =
      new AnimatorListenerAdapter() { // from class: com.android.internal.app.WindowDecorActionBar.1
  ...
  final Animator.AnimatorListener mShowListener =
      new AnimatorListenerAdapter() { // from class: com.android.internal.app.WindowDecorActionBar.2
        @Override // android.animation.AnimatorListenerAdapter,
                  // android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animation) {
          WindowDecorActionBar.this.mCurrentShowAnim = null;
  ...
  final ValueAnimator.AnimatorUpdateListener mUpdateListener =
      new ValueAnimator
          .AnimatorUpdateListener() { // from class: com.android.internal.app.WindowDecorActionBar.3
  ...
  private void init(View decor) {
    ActionBarOverlayLayout actionBarOverlayLayout =
        (ActionBarOverlayLayout) decor.findViewById(C4337R.id.decor_content_parent);
    this.mOverlayLayout = actionBarOverlayLayout;
    if (actionBarOverlayLayout != null) {
      actionBarOverlayLayout.setActionBarVisibilityCallback(this);
    }
    this.mDecorToolbar = getDecorToolbar(decor.findViewById(C4337R.id.action_bar));
    this.mContextView = (ActionBarContextView) decor.findViewById(C4337R.id.action_context_bar);
    this.mContainerView = (ActionBarContainer) decor.findViewById(C4337R.id.action_bar_container);
    this.mSplitView = (ActionBarContainer) decor.findViewById(C4337R.id.split_action_bar);
    ...
    TypedArray a =
        this.mContext.obtainStyledAttributes(null, C4337R.styleable.ActionBar, 16843470, 0);
  ...
  public ActionMode startActionMode(ActionMode.Callback callback) {
    ...
    if (mode.dispatchOnCreate()) {
      ...
      if (actionBarContainer != null
          ...
          && actionBarContainer.getVisibility() != 0) {
  ...
  public void selectTab(ActionBar.Tab tab) {
    ...
    FragmentTransaction trans =
        this.mDecorToolbar.getViewGroup().isInEditMode()
            ? null
            : this.mActivity.getFragmentManager().beginTransaction().disallowAddToBackStack();
    TabImpl tabImpl = this.mSelectedTab;
    if (tabImpl == tab) {
      if (tabImpl != null) {
  ...
  public void setHideOnContentScrollEnabled(boolean hideOnContentScroll) {
    if (hideOnContentScroll && !this.mOverlayLayout.isInOverlayMode()) {
      throw new IllegalStateException(
          "Action bar must be in overlay mode (Window.FEATURE_OVERLAY_ACTION_BAR) to enable hide on"
              + " content scroll");
    }
  ...
  public void setHideOffset(int offset) {
    if (offset != 0 && !this.mOverlayLayout.isInOverlayMode()) {
      throw new IllegalStateException(
          "Action bar must be in overlay mode (Window.FEATURE_OVERLAY_ACTION_BAR) to set a non-zero"
              + " hide offset");
    }
    ...
    if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
      ...
      ObjectAnimator a =
          ObjectAnimator.ofFloat(
              this.mContainerView, (Property<ActionBarContainer, Float>) View.TRANSLATION_Y, 0.0f);
      ...
      if (actionBarContainer != null && this.mContextDisplayMode == 1) {
        ...
        b.with(
            ObjectAnimator.ofFloat(
                this.mSplitView, (Property<ActionBarContainer, Float>) View.TRANSLATION_Y, 0.0f));
      }
  ...
  public void setNavigationMode(int mode) {
    ...
    if (oldMode != mode
        && !this.mHasEmbeddedTabs
        && (actionBarOverlayLayout = this.mOverlayLayout) != null) {
