...
class ParsedMainComponentUtils {
    ...
    static <Component extends ParsedMainComponentImpl> ParseResult<Component> parseMainComponent(
            ...
            int roundIconAttr,
            int splitNameAttr,
            int attributionTagsAttr) {
        ParseInput parseInput;
        String attributionTags;
        CharSequence processName;
        ParseResult<Component> result =
        ...
        if (attributionTagsAttr != -1
                && (attributionTags = array.getNonConfigurationString(attributionTagsAttr, 0))
                        != null) {
