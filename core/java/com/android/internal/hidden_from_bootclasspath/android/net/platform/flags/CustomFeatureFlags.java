...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(
                    Arrays.asList(
                            Flags.FLAG_IPSEC_TRANSFORM_STATE,
                            Flags.FLAG_POWERED_OFF_FINDING_PLATFORM,
                            Flags.FLAG_REGISTER_NSD_OFFLOAD_ENGINE,
                            ""));
    ...
    public boolean ipsecTransformState() {
        return getValue(
                ...
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.net.platform.flags.CustomFeatureFlags$$ExternalSyntheticLambda2
    ...
    public boolean poweredOffFindingPlatform() {
        return getValue(
                Flags.FLAG_POWERED_OFF_FINDING_PLATFORM,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.net.platform.flags.CustomFeatureFlags$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean registerNsdOffloadEngine() {
        return getValue(
                Flags.FLAG_REGISTER_NSD_OFFLOAD_ENGINE,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.net.platform.flags.CustomFeatureFlags$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
