...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(
                    Arrays.asList(
                            Flags.FLAG_A11Y_STANDALONE_GESTURE_ENABLED,
                            Flags.FLAG_BACKUP_TASKS_SETTINGS_SCREEN,
                            Flags.FLAG_SYSTEM_SETTINGS_DEFAULT,
                            Flags.FLAG_USER_KEYS,
                            ""));
    ...
    public boolean a11yStandaloneGestureEnabled() {
        return getValue(
                ...
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.provider.CustomFeatureFlags$$ExternalSyntheticLambda3
    ...
    public boolean backupTasksSettingsScreen() {
        return getValue(
                Flags.FLAG_BACKUP_TASKS_SETTINGS_SCREEN,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.provider.CustomFeatureFlags$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean systemSettingsDefault() {
        return getValue(
                Flags.FLAG_SYSTEM_SETTINGS_DEFAULT,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.provider.CustomFeatureFlags$$ExternalSyntheticLambda2
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean userKeys() {
        return getValue(
                Flags.FLAG_USER_KEYS,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.provider.CustomFeatureFlags$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
