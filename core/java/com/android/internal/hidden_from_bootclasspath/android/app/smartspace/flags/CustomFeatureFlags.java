...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(Arrays.asList(Flags.FLAG_ACCESS_SMARTSPACE, Flags.FLAG_REMOTE_VIEWS, ""));
    ...
    public boolean accessSmartspace() {
        return getValue(
                Flags.FLAG_ACCESS_SMARTSPACE,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.app.smartspace.flags.CustomFeatureFlags$$ExternalSyntheticLambda1
    ...
    public boolean remoteViews() {
        return getValue(
                Flags.FLAG_REMOTE_VIEWS,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.app.smartspace.flags.CustomFeatureFlags$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
