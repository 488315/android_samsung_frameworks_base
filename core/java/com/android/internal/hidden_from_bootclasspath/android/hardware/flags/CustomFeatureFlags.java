...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(Arrays.asList(Flags.FLAG_OVERLAYPROPERTIES_CLASS_API, ""));
    ...
    public boolean overlaypropertiesClassApi() {
        return getValue(
                Flags.FLAG_OVERLAYPROPERTIES_CLASS_API,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.hardware.flags.CustomFeatureFlags$$ExternalSyntheticLambda0
