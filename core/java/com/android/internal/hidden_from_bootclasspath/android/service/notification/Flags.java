...
public final class Flags {
    ...
    public static final String FLAG_CALLSTYLE_CALLBACK_API =
            "android.service.notification.callstyle_callback_api";
    public static final String FLAG_RANKING_UPDATE_ASHMEM =
            "android.service.notification.ranking_update_ashmem";
    public static final String FLAG_REDACT_SENSITIVE_NOTIFICATIONS_BIG_TEXT_STYLE =
            "android.service.notification.redact_sensitive_notifications_big_text_style";
    public static final String FLAG_REDACT_SENSITIVE_NOTIFICATIONS_FROM_UNTRUSTED_LISTENERS =
