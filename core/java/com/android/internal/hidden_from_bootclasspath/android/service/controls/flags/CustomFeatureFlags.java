...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(Arrays.asList(Flags.FLAG_HOME_PANEL_DREAM, ""));
    ...
    public boolean homePanelDream() {
        return getValue(
                Flags.FLAG_HOME_PANEL_DREAM,
                new Predicate() { // from class:
                                  // com.android.internal.hidden_from_bootclasspath.android.service.controls.flags.CustomFeatureFlags$$ExternalSyntheticLambda0
