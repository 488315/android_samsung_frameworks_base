...
public final class Flags {
    ...
    public static final String FLAG_CLEAR_CREDENTIALS_FIX_ENABLED =
            "android.credentials.flags.clear_credentials_fix_enabled";
    public static final String FLAG_CLEAR_SESSION_ENABLED =
            "android.credentials.flags.clear_session_enabled";
    public static final String FLAG_CONFIGURABLE_SELECTOR_UI_ENABLED =
            "android.credentials.flags.configurable_selector_ui_enabled";
    public static final String FLAG_CREDMAN_BIOMETRIC_API_ENABLED =
            "android.credentials.flags.credman_biometric_api_enabled";
    public static final String FLAG_HYBRID_FILTER_OPT_FIX_ENABLED =
            "android.credentials.flags.hybrid_filter_opt_fix_enabled";
    public static final String FLAG_INSTANT_APPS_ENABLED =
            "android.credentials.flags.instant_apps_enabled";
    public static final String FLAG_NEW_FRAMEWORK_METRICS =
            "android.credentials.flags.new_framework_metrics";
    public static final String FLAG_NEW_SETTINGS_INTENTS =
            "android.credentials.flags.new_settings_intents";
    public static final String FLAG_NEW_SETTINGS_UI = "android.credentials.flags.new_settings_ui";
    public static final String FLAG_SELECTOR_UI_IMPROVEMENTS_ENABLED =
            "android.credentials.flags.selector_ui_improvements_enabled";
    public static final String FLAG_SETTINGS_ACTIVITY_ENABLED =
            "android.credentials.flags.settings_activity_enabled";
    public static final String FLAG_WEAR_CREDENTIAL_MANAGER_ENABLED =
            "android.credentials.flags.wear_credential_manager_enabled";
