...
public interface IBackupTransport extends IInterface {
  ...
  void getNextFullRestoreDataChunk(
      ParcelFileDescriptor parcelFileDescriptor, ITransportStatusCallback iTransportStatusCallback)
      throws RemoteException;
  ...
  public static class Default implements IBackupTransport {
    ...
    public void isAppEligibleForBackup(
        PackageInfo targetPackage, boolean isFullBackup, AndroidFuture<Boolean> resultFuture)
        throws RemoteException {}
    ...
    public void getNextFullRestoreDataChunk(
        ParcelFileDescriptor socket, ITransportStatusCallback callback) throws RemoteException {}
