...
public interface IObbBackupService extends IInterface {
  void backupObbs(
      String str, ParcelFileDescriptor parcelFileDescriptor, int i, IBackupManager iBackupManager)
  ...
  public static class Default implements IObbBackupService {
    ...
    public void backupObbs(
        String packageName, ParcelFileDescriptor data, int token, IBackupManager callbackBinder)
        throws RemoteException {}
