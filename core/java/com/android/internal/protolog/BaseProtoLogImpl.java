...
public class BaseProtoLogImpl {
  ...
  private void logToLogcat(
      String tag, LogLevel level, int messageHash, String messageString, Object[] args) {
    String message = null;
    ...
    if (messageString != null) {
      if (args != null) {
        try {
          ...
          Slog.m122w(TAG, "Invalid ProtoLog format string.", ex);
        }
      } else {
    ...
    if (message == null) {
      StringBuilder builder =
          new StringBuilder(
              "UNKNOWN MESSAGE (" + messageHash + NavigationBarInflaterView.KEY_CODE_END);
      for (Object o : args) {
  ...
  static /* synthetic */ class C46591 {
    ...
    static {
      ...
      try {
        f1002x7973bb3e[LogLevel.VERBOSE.ordinal()] = 2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        f1002x7973bb3e[LogLevel.INFO.ordinal()] = 3;
      } catch (NoSuchFieldError e3) {
      }
      try {
        f1002x7973bb3e[LogLevel.WARN.ordinal()] = 4;
      } catch (NoSuchFieldError e4) {
      }
      try {
        f1002x7973bb3e[LogLevel.ERROR.ordinal()] = 5;
      } catch (NoSuchFieldError e5) {
      }
      try {
        f1002x7973bb3e[LogLevel.WTF.ordinal()] = 6;
  ...
  public void passToLogcat(String tag, LogLevel level, String message) {
    switch (C46591.f1002x7973bb3e[level.ordinal()]) {
      case 1:
        Slog.m113d(tag, message);
        break;
      case 2:
        Slog.m119v(tag, message);
        break;
      case 3:
        Slog.m117i(tag, message);
        break;
      case 4:
        Slog.m121w(tag, message);
        break;
      case 5:
        Slog.m115e(tag, message);
        break;
      case 6:
      ...
      try {
        ...
        if (objArr != null) {
          try {
              ...
              switch (type) {
                ...
                case 3:
                  try {
                    ...
                    Slog.m116e(TAG, "Invalid ProtoLog paramsMask", ex);
                    break;
                  }
              }
              argIndex++;
            ...
            e = e;
            Slog.m116e(TAG, "Exception while logging to proto", e);
            return;
          }
        }
        os.end(token);
  ...
  protected int setLogging(
      boolean setTextLogging, boolean value, PrintWriter pw, String... groups) {
  ...
  public String getStatus() {
    StringBuilder append =
        new StringBuilder()
            .append("ProtoLog status: ")
            .append(isProtoEnabled() ? "Enabled" : "Disabled")
            .append("\nEnabled log groups: \n  Proto: ");
    ...
    return append
                ...
                treeMap.values().stream()
                    ...
                    .map(
                        new Function() { // from class:
                                         // com.android.internal.protolog.BaseProtoLogImpl$$ExternalSyntheticLambda1
        ...
        .append(
            (String)
                treeMap.values().stream()
                    .filter(
                        new Predicate() { // from class:
                                          // com.android.internal.protolog.BaseProtoLogImpl$$ExternalSyntheticLambda2
                          @Override // java.util.function.Predicate
                          public final boolean test(Object obj) {
        ...
        .append(this.mViewerConfig.knownViewerStringsNumber())
        .toString();
  }
  ...
  private void writeProtoLogToFileLocked() {
    try {
      ...
      Slog.m116e(TAG, "Unable to write buffer to file", e);
    }
  }
