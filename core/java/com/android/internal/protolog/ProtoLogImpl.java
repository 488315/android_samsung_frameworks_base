...
public class ProtoLogImpl extends BaseProtoLogImpl {
    ...
    /* renamed from: d */
    public static void m212d(IProtoLogGroup group, int messageHash, int paramsMask, String messageString, Object... args) {
        getSingleInstance().log(BaseProtoLogImpl.LogLevel.DEBUG, group, messageHash, paramsMask, messageString, args);
    }

    /* renamed from: v */
    public static void m215v(IProtoLogGroup group, int messageHash, int paramsMask, String messageString, Object... args) {
        getSingleInstance().log(BaseProtoLogImpl.LogLevel.VERBOSE, group, messageHash, paramsMask, messageString, args);
    }

    /* renamed from: i */
    public static void m214i(IProtoLogGroup group, int messageHash, int paramsMask, String messageString, Object... args) {
        getSingleInstance().log(BaseProtoLogImpl.LogLevel.INFO, group, messageHash, paramsMask, messageString, args);
    }

    /* renamed from: w */
    public static void m216w(IProtoLogGroup group, int messageHash, int paramsMask, String messageString, Object... args) {
        getSingleInstance().log(BaseProtoLogImpl.LogLevel.WARN, group, messageHash, paramsMask, messageString, args);
    }

    /* renamed from: e */
    public static void m213e(IProtoLogGroup group, int messageHash, int paramsMask, String messageString, Object... args) {
