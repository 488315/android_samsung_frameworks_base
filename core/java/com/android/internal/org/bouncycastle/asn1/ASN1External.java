...
public abstract class ASN1External extends ASN1Primitive {
  ...
  boolean asn1Equals(ASN1Primitive o) {
    ...
    if (aSN1ObjectIdentifier2 != null
        && ((aSN1ObjectIdentifier = other.directReference) == null
            || !aSN1ObjectIdentifier.equals((ASN1Primitive) aSN1ObjectIdentifier2))) {
      return false;
    }
    ASN1Integer aSN1Integer2 = this.indirectReference;
    if (aSN1Integer2 != null
        && ((aSN1Integer = other.indirectReference) == null
            || !aSN1Integer.equals((ASN1Primitive) aSN1Integer2))) {
      return false;
    }
    ASN1Primitive aSN1Primitive2 = this.dataValueDescriptor;
    if (aSN1Primitive2 == null
        || ((aSN1Primitive = other.dataValueDescriptor) != null
            && aSN1Primitive.equals(aSN1Primitive2))) {
