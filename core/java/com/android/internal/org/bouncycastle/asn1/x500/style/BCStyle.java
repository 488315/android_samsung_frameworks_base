...
public class BCStyle extends AbstractX500NameStyle {
  ...
  /* renamed from: C */
  public static final ASN1ObjectIdentifier f695C;

  /* renamed from: CN */
  public static final ASN1ObjectIdentifier f696CN;
  public static final ASN1ObjectIdentifier COUNTRY_OF_CITIZENSHIP;
  public static final ASN1ObjectIdentifier COUNTRY_OF_RESIDENCE;
  public static final ASN1ObjectIdentifier DATE_OF_BIRTH;

  /* renamed from: DC */
  public static final ASN1ObjectIdentifier f697DC;
  ...
  /* renamed from: E */
  public static final ASN1ObjectIdentifier f698E;
  ...
  /* renamed from: L */
  public static final ASN1ObjectIdentifier f699L;
  public static final ASN1ObjectIdentifier NAME;
  public static final ASN1ObjectIdentifier NAME_AT_BIRTH;

  /* renamed from: O */
  public static final ASN1ObjectIdentifier f700O;
  public static final ASN1ObjectIdentifier ORGANIZATION_IDENTIFIER;

  /* renamed from: OU */
  public static final ASN1ObjectIdentifier f701OU;
  ...
  /* renamed from: SN */
  public static final ASN1ObjectIdentifier f702SN;

  /* renamed from: ST */
  public static final ASN1ObjectIdentifier f703ST;
  public static final ASN1ObjectIdentifier STREET;
  public static final ASN1ObjectIdentifier SURNAME;

  /* renamed from: T */
  public static final ASN1ObjectIdentifier f704T;
  ...
  static {
    ...
    f696CN = intern5;
    f702SN = new ASN1ObjectIdentifier("2.5.4.5").intern();
    ...
    hashtable2.put(
        SemShareConstants.DMA_SURVEY_DETAIL_SHAREVIA_VALUE_ALL_APPS, aSN1ObjectIdentifier4);
  ...
  protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier oid, String value) {
    if (oid.equals((ASN1Primitive) EmailAddress) || oid.equals((ASN1Primitive) f697DC)) {
      return new DERIA5String(value);
    }
    if (oid.equals((ASN1Primitive) DATE_OF_BIRTH)) {
      return new ASN1GeneralizedTime(value);
    }
    if (oid.equals((ASN1Primitive) f695C)
        || oid.equals((ASN1Primitive) f702SN)
