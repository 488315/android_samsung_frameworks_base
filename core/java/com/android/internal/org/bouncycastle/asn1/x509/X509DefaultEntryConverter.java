...
public class X509DefaultEntryConverter extends X509NameEntryConverter {
    ...
    public ASN1Primitive getConvertedValue(ASN1ObjectIdentifier oid, String value) {
        ...
        if (oid.equals((ASN1Primitive) X509Name.EmailAddress) || oid.equals((ASN1Primitive) X509Name.f721DC)) {
            return new DERIA5String(value);
        }
        if (oid.equals((ASN1Primitive) X509Name.DATE_OF_BIRTH)) {
            return new DERGeneralizedTime(value);
        }
        if (oid.equals((ASN1Primitive) X509Name.f719C) || oid.equals((ASN1Primitive) X509Name.f726SN) || oid.equals((ASN1Primitive) X509Name.DN_QUALIFIER) || oid.equals((ASN1Primitive) X509Name.TELEPHONE_NUMBER)) {
