...
public class BasicConstraints extends ASN1Object {
    ...
    private BasicConstraints(ASN1Sequence seq) {
        this.f713cA = ASN1Boolean.getInstance(false);
        ...
        if (seq.getObjectAt(0) instanceof ASN1Boolean) {
            this.f713cA = ASN1Boolean.getInstance(seq.getObjectAt(0));
        } else {
            this.f713cA = null;
    ...
    public BasicConstraints(boolean cA) {
        ...
        this.pathLenConstraint = null;
        if (cA) {
            this.f713cA = ASN1Boolean.getInstance(true);
        } else {
            this.f713cA = null;
        }
        this.pathLenConstraint = null;
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f713cA;
