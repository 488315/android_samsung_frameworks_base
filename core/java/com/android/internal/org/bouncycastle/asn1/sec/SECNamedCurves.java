...
public class SECNamedCurves {
  static X9ECParametersHolder secp112r1 =
      new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.C4595Fp(p, a, b, n, h));
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve, "0409487239995A5EE76B55F9C2F098A89CE5AF8724C0A23E0E0FF77500");
  ...
  static X9ECParametersHolder secp112r2 =
      new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve, "044BA30AB5E892B4E1649DD0928643ADCD46F5882E3747DEF36E956E97");
          return new X9ECParameters(curve, G, n, h, S);
        }
      };
  static X9ECParametersHolder secp128r1 =
      new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve, "04161FF7528B899B2D0C28607CA52C5B86CF5AC8395BAFEB13C02DA292DDED7A83");
          return new X9ECParameters(curve, G, n, h, S);
        }
      };
  static X9ECParametersHolder secp128r2 =
      new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve, "047B6AA5D85E572983E6FB32A7CDEBC14027B6916A894D3AEE7106FE805FC34B44");
          return new X9ECParameters(curve, G, n, h, S);
        }
      };
          ...
          GLVTypeBParameters glv =
              new GLVTypeBParameters(
                  ...
                  new ScalarSplitParameters(
                      ...
                      176));
          ECCurve curve = SECNamedCurves.configureCurveGLV(new ECCurve.C4595Fp(p, a, b, n, h), glv);
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve,
  ...
  static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          BigInteger n =
              SECNamedCurves.fromHex("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7");
          BigInteger h = BigInteger.valueOf(1L);
          GLVTypeBParameters glv =
              new GLVTypeBParameters(
  ...
  static X9ECParametersHolder secp224r1 = new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          BigInteger a =
              SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE");
          BigInteger b =
              SECNamedCurves.fromHex("B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4");
          byte[] S = Hex.decodeStrict("BD71344799D5C7FCDC45B59FA3B9AB8F6A948BC5");
          BigInteger n =
              SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D");
          BigInteger h = BigInteger.valueOf(1L);
          ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.C4595Fp(p, a, b, n, h));
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
  ...
  static X9ECParametersHolder sect113r1 =
      new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve, "04009D73616F35F4AB1407D73562C10F00A52830277958EE84D1315ED31886");
          return new X9ECParameters(curve, G, n, h, S);
        }
      };
  static X9ECParametersHolder sect113r2 =
      new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve, "0401A57A6A7B26CA5EF52FCDB816479700B3ADC94ED1FE674C06E695BABA1D");
          return new X9ECParameters(curve, G, n, h, S);
        }
      };
  static X9ECParametersHolder sect131r1 =
      new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve, "040081BAF91FDF9833C40F9C181343638399078C6E7EA38C001F73C8134B1B4EF9E150");
          return new X9ECParameters(curve, G, n, h, S);
        }
      };
  static X9ECParametersHolder sect131r2 =
      new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
                  curve, "040356DCD8F2F95031AD652D23951BB366A80648F06D867940A5366D9E265DE9EB240F");
          return new X9ECParameters(curve, G, n, h, S);
        }
      };
  ...
  static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          BigInteger b =
              SECNamedCurves.fromHex("00FDFB49BFE6C3A89FACADAA7A1E5BBC7CC1C2E5D831478814");
  ...
  static X9ECParametersHolder sect193r2 = new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          BigInteger b =
              SECNamedCurves.fromHex("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE");
          byte[] S = Hex.decodeStrict("10B7B4D696E676875615175137C8A16FD0DA2211");
          BigInteger n =
              SECNamedCurves.fromHex("010000000000000000000000015AAB561B005413CCD4EE99D5");
          BigInteger h = BigInteger.valueOf(2L);
          ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.F2m(193, 15, a, b, n, h));
          X9ECPoint G =
              SECNamedCurves.configureBasepoint(
  ...
  static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          BigInteger b = BigInteger.valueOf(1L);
          BigInteger n =
              SECNamedCurves.fromHex("8000000000000000000000000000069D5BB915BCD46EFB1AD5F173ABDF");
          BigInteger h = BigInteger.valueOf(4L);
