...
public class SECNamedCurves {
    static X9ECParametersHolder secp112r1 =
            new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder secp128r1 = new X9ECParametersHolder() { // from class:
    ...
    static X9ECParametersHolder secp128r2 = new X9ECParametersHolder() { // from class:
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    BigInteger p =
                            SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73");
                    BigInteger a = ECConstants.ZERO;
                    BigInteger b = BigInteger.valueOf(7L);
                    BigInteger n =
                            SECNamedCurves.fromHex("0100000000000000000001B8FA16DFAB9ACA16B6B3");
                    BigInteger h = BigInteger.valueOf(1L);
                    GLVTypeBParameters glv =
                            new GLVTypeBParameters(
                                    ...
                                    new ScalarSplitParameters(
                                            ...
                                            176));
                    ECCurve curve =
                            SECNamedCurves.configureCurveGLV(new ECCurve.Fp(p, a, b, n, h), glv);
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder secp160r1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    BigInteger p =
                            SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF");
                    BigInteger a =
                            SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC");
                    BigInteger b =
                            SECNamedCurves.fromHex("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45");
                    byte[] S = Hex.decodeStrict("1053CDE42C14D696E67687561517533BF3F83345");
                    BigInteger n =
                            SECNamedCurves.fromHex("0100000000000000000001F4C8F927AED3CA752257");
                    BigInteger h = BigInteger.valueOf(1L);
                    ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.Fp(p, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
    ...
    static X9ECParametersHolder secp160r2 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    BigInteger p =
                            SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73");
                    BigInteger a =
                            SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70");
                    BigInteger b =
                    ...
                    BigInteger n =
                            SECNamedCurves.fromHex("0100000000000000000000351EE786A818F3A1A16B");
                    BigInteger h = BigInteger.valueOf(1L);
                    ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.Fp(p, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    GLVTypeBParameters glv =
                            new GLVTypeBParameters(
                                    new BigInteger(
                                            "bb85691939b869c1d087f601554b96b80cb4f55b35f433c2", 16),
                                    new BigInteger(
                    ...
                    GLVTypeBParameters glv =
                            new GLVTypeBParameters(
                                    ...
                                    new ScalarSplitParameters(
                                            new BigInteger[] {
                                                new BigInteger(
                                                        "3086d221a7d46bcde86c90e49284eb15", 16),
                                                new BigInteger(
                                                        "-e4437ed6010e88286f547fa90abfe4c3", 16)
                                            },
                                            new BigInteger[] {
                                                new BigInteger(
                                            ...
                                            new BigInteger(
                                                    "3086d221a7d46bcde86c90e49284eb153dab", 16),
                                            new BigInteger(
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    ECCurve curve =
                            SECNamedCurves.configureCurve(new ECCurve.F2m(113, 9, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder sect113r2 = new X9ECParametersHolder() { // from class:
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    BigInteger h = BigInteger.valueOf(2L);
                    ECCurve curve =
                            SECNamedCurves.configureCurve(
                                    new ECCurve.F2m(131, 2, 3, 8, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder sect131r2 = new X9ECParametersHolder() { // from class:
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    BigInteger n =
                            SECNamedCurves.fromHex("04000000000000000000020108A2E0CC0D99F8A5EF");
                    BigInteger h = BigInteger.valueOf(2L);
                    ECCurve curve =
                            SECNamedCurves.configureCurve(
                                    new ECCurve.F2m(163, 3, 6, 7, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    BigInteger a =
                            SECNamedCurves.fromHex("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2");
                    BigInteger b =
                            SECNamedCurves.fromHex("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9");
                    byte[] S = Hex.decodeStrict("24B7B137C8A14D696E6768756151756FD0DA2E5C");
                    BigInteger n =
                            SECNamedCurves.fromHex("03FFFFFFFFFFFFFFFFFFFF48AAB689C29CA710279B");
                    BigInteger h = BigInteger.valueOf(2L);
                    ECCurve curve =
                            SECNamedCurves.configureCurve(
                                    new ECCurve.F2m(163, 3, 6, 7, a, b, n, h));
    ...
    static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    BigInteger a = BigInteger.valueOf(1L);
                    BigInteger b =
                            SECNamedCurves.fromHex("020A601907B8C953CA1481EB10512F78744A3205FD");
                    byte[] S = Hex.decodeStrict("85E25BFE5C86226CDB12016F7553F9D0E693A268");
                    BigInteger n =
                            SECNamedCurves.fromHex("040000000000000000000292FE77E70C12A4234C33");
                    BigInteger h = BigInteger.valueOf(2L);
                    ECCurve curve =
                            SECNamedCurves.configureCurve(
                                    new ECCurve.F2m(163, 3, 6, 7, a, b, n, h));
    ...
    static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    BigInteger h = BigInteger.valueOf(2L);
                    ECCurve curve =
                            SECNamedCurves.configureCurve(new ECCurve.F2m(193, 15, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    BigInteger h = BigInteger.valueOf(4L);
                    ECCurve curve =
                            SECNamedCurves.configureCurve(new ECCurve.F2m(233, 74, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    BigInteger h = BigInteger.valueOf(4L);
                    ECCurve curve =
                            SECNamedCurves.configureCurve(new ECCurve.F2m(239, 158, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    ECCurve curve =
                            SECNamedCurves.configureCurve(
                                    new ECCurve.F2m(283, 5, 7, 12, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder sect409k1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    BigInteger h = BigInteger.valueOf(4L);
                    ECCurve curve =
                            SECNamedCurves.configureCurve(new ECCurve.F2m(409, 87, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
    ...
    static X9ECParametersHolder sect571k1 = new X9ECParametersHolder() { // from class:
                ...
                protected X9ECParameters createParameters() {
                    ...
                    ECCurve curve =
                            SECNamedCurves.configureCurve(
                                    new ECCurve.F2m(571, 2, 5, 10, a, b, n, h));
                    X9ECPoint G =
                            SECNamedCurves.configureBasepoint(
                                    curve,
