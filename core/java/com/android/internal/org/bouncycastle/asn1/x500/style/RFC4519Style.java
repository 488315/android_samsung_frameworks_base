...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    /* renamed from: c */
    public static final ASN1ObjectIdentifier f705c;

    /* renamed from: cn */
    public static final ASN1ObjectIdentifier f706cn;

    /* renamed from: dc */
    public static final ASN1ObjectIdentifier f707dc;
    ...
    /* renamed from: l */
    public static final ASN1ObjectIdentifier f708l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* renamed from: o */
    public static final ASN1ObjectIdentifier f709o;

    /* renamed from: ou */
    public static final ASN1ObjectIdentifier f710ou;
    ...
    /* renamed from: sn */
    public static final ASN1ObjectIdentifier f711sn;

    /* renamed from: st */
    public static final ASN1ObjectIdentifier f712st;
    ...
    protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier oid, String value) {
        if (oid.equals((ASN1Primitive) f707dc)) {
            return new DERIA5String(value);
        }
        if (oid.equals((ASN1Primitive) f705c) || oid.equals((ASN1Primitive) serialNumber) || oid.equals((ASN1Primitive) dnQualifier) || oid.equals((ASN1Primitive) telephoneNumber)) {
