...
public class SignerIdentifier extends ASN1Object implements ASN1Choice {
    ...
    public SignerIdentifier(ASN1OctetString id) {
        this.f688id = new DERTaggedObject(false, 0, id);
    }
    ...
    public boolean isTagged() {
        return this.f688id instanceof ASN1TaggedObject;
    }

    public ASN1Encodable getId() {
        ASN1Encodable aSN1Encodable = this.f688id;
    ...
    public ASN1Primitive toASN1Primitive() {
        return this.f688id.toASN1Primitive();
    }
}
