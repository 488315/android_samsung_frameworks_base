...
public class KeyPurposeId extends ASN1Object {
  ...
  /* renamed from: id */
  private ASN1ObjectIdentifier f717id;
  ...
  static {
    ...
    id_kp_scvp_responder =
        new KeyPurposeId(aSN1ObjectIdentifier.branch(AudioParameter.VALUE_VM_CSD_500_WARNING));
  ...
  public String getId() {
    return this.f717id.getId();
  }

  public String toString() {
    return this.f717id.toString();
  }
}
