...
public class Extension extends ASN1Object {
  ...
  public static Extension create(ASN1ObjectIdentifier extnId, boolean critical, ASN1Encodable value)
      throws IOException {
  ...
  public boolean equals(Object o) {
    ...
    return other.getExtnId().equals((ASN1Primitive) getExtnId())
        && other.getExtnValue().equals((ASN1Primitive) getExtnValue())
