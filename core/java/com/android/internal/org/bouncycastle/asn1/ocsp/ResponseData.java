...
public class ResponseData extends ASN1Object {
    ...
    /* renamed from: V1 */
    private static final ASN1Integer f689V1 = new ASN1Integer(0);
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime producedAt, ASN1Sequence responses, X509Extensions responseExtensions) {
        this(f689V1, responderID, ASN1GeneralizedTime.getInstance(producedAt), responses, Extensions.getInstance(responseExtensions));
    }
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime producedAt, ASN1Sequence responses, Extensions responseExtensions) {
        this(f689V1, responderID, producedAt, responses, responseExtensions);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.versionPresent || !this.version.equals((ASN1Primitive) f689V1)) {
