...
public class DLExternal extends ASN1External {
    ...
    void encode(ASN1OutputStream out, boolean withTag) throws IOException {
        ...
        if (this.directReference != null) {
            baos.write(this.directReference.getEncoded(ASN1Encoding.f685DL));
        }
        if (this.indirectReference != null) {
            baos.write(this.indirectReference.getEncoded(ASN1Encoding.f685DL));
        }
        if (this.dataValueDescriptor != null) {
            baos.write(this.dataValueDescriptor.getEncoded(ASN1Encoding.f685DL));
        }
        ASN1TaggedObject obj = new DLTaggedObject(true, this.encoding, this.externalContent);
        baos.write(obj.getEncoded(ASN1Encoding.f685DL));
