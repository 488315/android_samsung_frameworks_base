...
public class TBSCertList extends ASN1Object {
  ...
  private class RevokedCertificatesEnumeration implements Enumeration {
    ...
    /* renamed from: en */
    private final Enumeration f718en;
    ...
    public boolean hasMoreElements() {
      return this.f718en.hasMoreElements();
    }

    @Override // java.util.Enumeration
    public Object nextElement() {
      return CRLEntry.getInstance(this.f718en.nextElement());
    }
  }
    ...
    if (seqPos5 < seqPos7 && (seq.getObjectAt(seqPos5) instanceof ASN1TaggedObject)) {
      this.crlExtensions =
          Extensions.getInstance(
              ASN1Sequence.getInstance((ASN1TaggedObject) seq.getObjectAt(seqPos5), true));
    }
  }
