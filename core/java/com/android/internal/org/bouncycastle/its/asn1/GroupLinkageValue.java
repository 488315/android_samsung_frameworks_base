...
public class GroupLinkageValue extends ASN1Object {
  ...
  private GroupLinkageValue(ASN1Sequence seq) {
    ...
    this.jValue =
        Utils.octetStringFixed(ASN1OctetString.getInstance(seq.getObjectAt(0)).getOctets(), 4);
    this.value =
        Utils.octetStringFixed(ASN1OctetString.getInstance(seq.getObjectAt(1)).getOctets(), 9);
  }
