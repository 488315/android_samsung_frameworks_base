...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    /* renamed from: c */
    private TBSCertList.CRLEntry f918c;
    ...
    private Set getExtensionOIDs(boolean critical) {
        Extensions extensions = this.f918c.getExtensions();
        if (extensions != null) {
            Set set = new HashSet();
    ...
    private Extension getExtension(ASN1ObjectIdentifier oid) {
        Extensions exts = this.f918c.getExtensions();
        if (exts != null) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof X509CRLEntryObject) {
            ...
            return this.f918c.equals(other.f918c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f918c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public BigInteger getSerialNumber() {
        return this.f918c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public Date getRevocationDate() {
        return this.f918c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f918c.getExtensions() != null;
    }
