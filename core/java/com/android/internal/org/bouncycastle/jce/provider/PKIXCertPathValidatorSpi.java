    ...
    try {
      ...
      if (trust != null) {
        ...
        PKIXExtendedParameters paramsPKIX3 =
            new PKIXExtendedParameters.Builder(paramsPKIX).setTrustAnchor(trust).build();
        ...
        if (sign != null) {
          try {
            ...
            throw new ExtCertPathValidatorException(
                "Subject of trust anchor could not be (re)encoded.", ex, certPath3, -1);
          }
        } else {
          try {
        ...
        try {
          ...
          if (paramsPKIX3.getTargetConstraints() != null
              && !paramsPKIX3.getTargetConstraints().match((Certificate) certs2.get(0))) {
            throw new ExtCertPathValidatorException(
              ...
              if (i2 == n) {
                ...
                PKIXPolicyNode validPolicyTree5 =
                    RFC3280CertPathUtilities.prepareCertB(
                        certPath6, index2, policyNodes, validPolicyTree4, policyMapping4);
                RFC3280CertPathUtilities.prepareNextCertG(
                    certPath6, index2, nameConstraintValidator4);
                int explicitPolicy4 =
                    RFC3280CertPathUtilities.prepareNextCertH1(certPath6, index2, explicitPolicy3);
                int policyMapping5 =
                    RFC3280CertPathUtilities.prepareNextCertH2(certPath6, index2, policyMapping4);
                int inhibitAnyPolicy5 =
                    RFC3280CertPathUtilities.prepareNextCertH3(
                        certPath6, index2, inhibitAnyPolicy4);
                int explicitPolicy5 =
                    RFC3280CertPathUtilities.prepareNextCertI1(certPath6, index2, explicitPolicy4);
                int policyMapping6 =
                    RFC3280CertPathUtilities.prepareNextCertI2(certPath6, index2, policyMapping5);
                int inhibitAnyPolicy6 =
                    RFC3280CertPathUtilities.prepareNextCertJ(certPath6, index2, inhibitAnyPolicy5);
                ...
                try {
                  workingPublicKey2 =
                      CertPathValidatorUtilities.getNextWorkingKey(
                          certPath.getCertificates(), index2, pKIXCertPathValidatorSpi.helper);
                  AlgorithmIdentifier workingAlgId2 =
                      CertPathValidatorUtilities.getAlgorithmIdentifier(workingPublicKey2);
                  ...
                  e = e6;
                  throw new CertPathValidatorException(
                      "Next working key could not be retrieved.", e, certPath6, index2);
                }
              }
