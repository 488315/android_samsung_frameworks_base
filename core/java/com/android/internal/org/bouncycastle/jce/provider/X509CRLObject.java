...
public class X509CRLObject extends X509CRL {
  ...
  public static boolean isIndirectCRL(X509CRL crl) throws CRLException {
    try {
      ...
      if (idp != null) {
        if (IssuingDistributionPoint.getInstance(ASN1OctetString.getInstance(idp).getOctets())
            .isIndirectCRL()) {
          return true;
        }
      }
  ...
  private Set getExtensionOIDs(boolean critical) {
    ...
    if (getVersion() == 2 && (extensions = this.f919c.getTBSCertList().getExtensions()) != null) {
      Set set = new HashSet();
  ...
  public byte[] getExtensionValue(String oid) {
    Extension ext;
    Extensions exts = this.f919c.getTBSCertList().getExtensions();
  ...
  public byte[] getEncoded() throws CRLException {
    try {
      return this.f919c.getEncoded(ASN1Encoding.DER);
    } catch (IOException e) {
  ...
  private void doVerify(PublicKey key, Signature sig)
      throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
    if (!this.f919c.getSignatureAlgorithm().equals(this.f919c.getTBSCertList().getSignature())) {
  ...
  public int getVersion() {
    return this.f919c.getVersionNumber();
  }

  @Override // java.security.cert.X509CRL
  public Principal getIssuerDN() {
    return new X509Principal(X500Name.getInstance(this.f919c.getIssuer().toASN1Primitive()));
  }

  @Override // java.security.cert.X509CRL
  public X500Principal getIssuerX500Principal() {
    try {
      return new X500Principal(this.f919c.getIssuer().getEncoded());
    } catch (IOException e) {
  ...
  public Date getThisUpdate() {
    return this.f919c.getThisUpdate().getDate();
  }

  @Override // java.security.cert.X509CRL
  public Date getNextUpdate() {
    if (this.f919c.getNextUpdate() != null) {
      return this.f919c.getNextUpdate().getDate();
    }
    return null;
  }
  ...
  private Set loadCRLEntries() {
    ...
    Enumeration certs = this.f919c.getRevokedCertificateEnumeration();
  ...
  public byte[] getTBSCertList() throws CRLException {
    try {
      return this.f919c.getTBSCertList().getEncoded(ASN1Encoding.DER);
    } catch (IOException e) {
      throw new CRLException(e.toString());
    }
  }
  ...
  public byte[] getSignature() {
    return this.f919c.getSignature().getOctets();
  }
  ...
  public String getSigAlgOID() {
    return this.f919c.getSignatureAlgorithm().getAlgorithm().getId();
  }
  ...
  public String toString() {
    ...
    Extensions extensions = this.f919c.getTBSCertList().getExtensions();
    if (extensions != null) {
      Enumeration e = extensions.oids();
  ...
  public boolean isRevoked(Certificate cert) {
    ...
    Enumeration certs = this.f919c.getRevokedCertificateEnumeration();
    X500Name caName = this.f919c.getIssuer();
    if (certs != null) {
  ...
  public boolean equals(Object other) {
    ...
    if (other instanceof X509CRLObject) {
      ...
      return this.f919c.equals(crlObject.f919c);
    }
