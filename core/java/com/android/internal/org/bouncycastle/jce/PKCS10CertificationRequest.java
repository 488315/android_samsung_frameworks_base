...
public class PKCS10CertificationRequest extends CertificationRequest {
  ...
  public PKCS10CertificationRequest(
    ...
    try {
      ...
      this.reqInfo =
          new CertificationRequestInfo(subject, SubjectPublicKeyInfo.getInstance(seq), attributes);
      if (provider == null) {
  ...
  private void setSignatureParameters(Signature signature, ASN1Encodable params2)
    ...
    if (params2 != null && !DERNull.INSTANCE.equals(params2)) {
      AlgorithmParameters sigParams =
          AlgorithmParameters.getInstance(signature.getAlgorithm(), signature.getProvider());
      try {
