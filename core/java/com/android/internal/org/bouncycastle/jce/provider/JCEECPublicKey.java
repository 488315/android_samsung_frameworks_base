...
public class JCEECPublicKey implements ECPublicKey, com.android.internal.org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String algorithm, com.android.internal.org.bouncycastle.jce.spec.ECPublicKeySpec spec) {
        ...
        if (spec.getParams() != null) {
            ...
            if (this.f915q.getCurve() == null) {
                ...
                this.f915q = s.getCurve().createPoint(this.f915q.getAffineXCoord().toBigInteger(), this.f915q.getAffineYCoord().toBigInteger());
            }
            this.ecSpec = null;
        }
    }
    ...
    public String toString() {
        ...
        buf.append("            X: ").append(this.f915q.getAffineXCoord().toBigInteger().toString(16)).append(nl);
        buf.append("            Y: ").append(this.f915q.getAffineYCoord().toBigInteger().toString(16)).append(nl);
        return buf.toString();
    }
