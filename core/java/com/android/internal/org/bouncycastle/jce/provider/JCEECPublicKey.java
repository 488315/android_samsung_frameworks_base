...
import com.android.internal.org.bouncycastle.asn1.p019x9.X9IntegerConverter;
...
public class JCEECPublicKey
  ...
  public JCEECPublicKey(String algorithm, ECPublicKeySpec spec) {
    ...
    this.ecSpec = params;
    this.f915q = EC5Util.convertPoint(params, spec.getW());
  }
  ...
  public JCEECPublicKey(ECPublicKey key) {
    ...
    this.ecSpec = params;
    this.f915q = EC5Util.convertPoint(params, key.getW());
  }
  ...
  public byte[] getEncoded() {
    ...
    if (eCParameterSpec instanceof ECNamedCurveSpec) {
      ASN1ObjectIdentifier curveOid =
          ECUtil.getNamedCurveOid(((ECNamedCurveSpec) eCParameterSpec).getName());
      if (curveOid == null) {
      ...
      X9ECParameters ecP =
          new X9ECParameters(
              curve,
              new X9ECPoint(
                  EC5Util.convertPoint(curve, this.ecSpec.getGenerator()), this.withCompression),
    ...
    SubjectPublicKeyInfo info =
        new SubjectPublicKeyInfo(
            new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, params), pubKeyOctets);
  ...
  public String toString() {
    ...
    buf.append("            X: ")
        .append(this.f915q.getAffineXCoord().toBigInteger().toString(16))
        .append(nl);
    buf.append("            Y: ")
        .append(this.f915q.getAffineYCoord().toBigInteger().toString(16))
        .append(nl);
    return buf.toString();
  }
