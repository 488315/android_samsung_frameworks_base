...
import com.android.internal.org.bouncycastle.asn1.p019x9.DHDomainParameters;
...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f913y;

    JCEDHPublicKey(DHPublicKeySpec spec) {
        this.f913y = spec.getY();
    ...
    public byte[] getEncoded() {
        ...
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(this.f913y));
    }
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        this.f913y = (BigInteger) in.readObject();
