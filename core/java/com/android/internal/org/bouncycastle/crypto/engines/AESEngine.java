...
public class AESEngine implements BlockCipher {
  ...
  /* renamed from: m1 */
  private static final int f813m1 = -2139062144;

  /* renamed from: m2 */
  private static final int f814m2 = 2139062143;

  /* renamed from: m3 */
  private static final int f815m3 = 27;

  /* renamed from: m4 */
  private static final int f816m4 = -1061109568;

  /* renamed from: m5 */
  private static final int f817m5 = 1061109567;
  ...
  /* renamed from: S */
  private static final byte[] f810S = {
    99,
    124,
    119,
    123,
  ...
  /* renamed from: Si */
  private static final byte[] f811Si = {
    82,
    9,
    106,
    -43,
  ...
  private static final int[] rcon = {
    1, 2, 4, 8, 16, 32, 64, 128, 27, 54, 108, 216, 171, 77, 154, 47, 94, 188, 99, 198, 151, 53, 106,
    212, 179, 125, 250, 239, 197, 145
  };

  /* renamed from: T0 */
  private static final int[] f812T0 = {
    -1520213050,
    -2072216328,
    -1720223762,
    -1921287178,
  ...
  private static int FFmulX(int x) {
    return ((f814m2 & x) << 1) ^ (((f813m1 & x) >>> 7) * 27);
  }
  ...
  private static int subWord(int x) {
    byte[] bArr = f810S;
    return (bArr[(x >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)
        | (bArr[x & 255] & 255)
        | ((bArr[(x >> 8) & 255] & 255) << 8)
        | ((bArr[(x >> 16) & 255] & 255) << 16);
  }
  ...
  public void init(boolean forEncryption, CipherParameters params) {
    if (params instanceof KeyParameter) {
      ...
      if (forEncryption) {
        this.f822s = Arrays.clone(f810S);
        return;
      } else {
        this.f822s = Arrays.clone(f811Si);
        return;
      }
    }
  ...
  private void unpackBlock(byte[] bytes, int off) {
    ...
    this.f818C0 = i3;
    int index4 = index3 + 1;
    this.f818C0 = i3 | (bytes[index3] << 24);
    int index5 = index4 + 1;
    ...
    this.f819C1 = i6;
    int index8 = index7 + 1;
    this.f819C1 = i6 | (bytes[index7] << 24);
    int index9 = index8 + 1;
    ...
    this.f820C2 = i9 | (bytes[index11] << 24);
    ...
    this.f821C3 = i12;
    int i13 = index15 + 1;
    this.f821C3 = i12 | (bytes[index15] << 24);
  }
  ...
  private void encryptBlock(int[][] KW) {
    int r1 = 0;
    int t0 = this.f818C0 ^ KW[0][0];
    int r2 = 1;
    int t1 = this.f819C1 ^ KW[0][1];
    char c = 2;
    int t2 = this.f820C2 ^ KW[0][2];
    int r3 = 1;
    int r = this.f821C3 ^ KW[0][3];
    while (r3 < this.ROUNDS - r2) {
      int[] iArr = f812T0;
      int r0 =
          (((iArr[t0 & 255] ^ shift(iArr[(t1 >> 8) & 255], 24)) ^ shift(iArr[(t2 >> 16) & 255], 16))
                  ^ shift(iArr[(r >> 24) & 255], 8))
              ^ KW[r3][r1];
      int r12 =
          (((shift(iArr[(t2 >> 8) & 255], 24) ^ iArr[t1 & 255]) ^ shift(iArr[(r >> 16) & 255], 16))
                  ^ shift(iArr[(t0 >> 24) & 255], 8))
              ^ KW[r3][r2];
      int r22 =
          (((shift(iArr[(r >> 8) & 255], 24) ^ iArr[t2 & 255]) ^ shift(iArr[(t0 >> 16) & 255], 16))
                  ^ shift(iArr[(t1 >> 24) & 255], 8))
              ^ KW[r3][c];
      int shift =
          ((shift(iArr[(t0 >> 8) & 255], 24) ^ iArr[r & 255]) ^ shift(iArr[(t1 >> 16) & 255], 16))
              ^ shift(iArr[(t2 >> 24) & 255], 8);
      int r4 = r3 + 1;
      int r32 = KW[r3][3] ^ shift;
      t0 =
          (((iArr[r0 & 255] ^ shift(iArr[(r12 >> 8) & 255], 24))
                      ^ shift(iArr[(r22 >> 16) & 255], 16))
                  ^ shift(iArr[(r32 >> 24) & 255], 8))
              ^ KW[r4][0];
      t1 =
          (((iArr[r12 & 255] ^ shift(iArr[(r22 >> 8) & 255], 24))
                      ^ shift(iArr[(r32 >> 16) & 255], 16))
                  ^ shift(iArr[(r0 >> 24) & 255], 8))
              ^ KW[r4][1];
      t2 =
          (((iArr[r22 & 255] ^ shift(iArr[(r32 >> 8) & 255], 24))
                      ^ shift(iArr[(r0 >> 16) & 255], 16))
                  ^ shift(iArr[(r12 >> 24) & 255], 8))
              ^ KW[r4][2];
      int r33 =
          (((iArr[r32 & 255] ^ shift(iArr[(r0 >> 8) & 255], 24))
                      ^ shift(iArr[(r12 >> 16) & 255], 16))
                  ^ shift(iArr[(r22 >> 24) & 255], 8))
              ^ KW[r4][3];
      r1 = 0;
      r2 = 1;
      c = 2;
    ...
    int[] iArr2 = f812T0;
    int r02 =
        (((iArr2[t0 & 255] ^ shift(iArr2[(t1 >> 8) & 255], 24))
                    ^ shift(iArr2[(t2 >> 16) & 255], 16))
                ^ shift(iArr2[(r >> 24) & 255], 8))
            ^ KW[r3][0];
    int r13 =
        (((iArr2[t1 & 255] ^ shift(iArr2[(t2 >> 8) & 255], 24)) ^ shift(iArr2[(r >> 16) & 255], 16))
                ^ shift(iArr2[(t0 >> 24) & 255], 8))
            ^ KW[r3][1];
    int r23 =
        (((iArr2[t2 & 255] ^ shift(iArr2[(r >> 8) & 255], 24)) ^ shift(iArr2[(t0 >> 16) & 255], 16))
                ^ shift(iArr2[(t1 >> 24) & 255], 8))
            ^ KW[r3][2];
    int shift2 =
        shift(iArr2[(t2 >> 24) & 255], 8)
            ^ ((iArr2[r & 255] ^ shift(iArr2[(t0 >> 8) & 255], 24))
                ^ shift(iArr2[(t1 >> 16) & 255], 16));
    int r5 = r3 + 1;
    int r34 = shift2 ^ KW[r3][3];
    byte[] bArr = f810S;
    int i = (bArr[r02 & 255] & 255) ^ ((bArr[(r13 >> 8) & 255] & 255) << 8);
    byte[] bArr2 = this.f822s;
    this.f818C0 =
        ((i ^ ((bArr2[(r23 >> 16) & 255] & 255) << 16))
                ^ (bArr2[(r34 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT))
            ^ KW[r5][0];
    this.f819C1 =
        ((((bArr2[r13 & 255] & 255) ^ ((bArr[(r23 >> 8) & 255] & 255) << 8))
                    ^ ((bArr[(r34 >> 16) & 255] & 255) << 16))
                ^ (bArr2[(r02 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT))
            ^ KW[r5][1];
    this.f820C2 =
        ((((bArr2[r23 & 255] & 255) ^ ((bArr[(r34 >> 8) & 255] & 255) << 8))
                    ^ ((bArr[(r02 >> 16) & 255] & 255) << 16))
                ^ (bArr[(r13 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT))
            ^ KW[r5][2];
    this.f821C3 =
        ((bArr[(r23 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)
                ^ (((bArr2[r34 & 255] & 255) ^ ((bArr2[(r02 >> 8) & 255] & 255) << 8))
                    ^ ((bArr2[(r13 >> 16) & 255] & 255) << 16)))
            ^ KW[r5][3];
  }
  ...
  private void decryptBlock(int[][] KW) {
    ...
    int t0 = i ^ KW[i2][0];
    int r2 = 1;
    int t1 = this.f819C1 ^ KW[i2][1];
    int r = 2;
    int t2 = this.f820C2 ^ KW[i2][2];
    int r3 = i2 - 1;
    int r32 = KW[i2][3] ^ this.f821C3;
    while (r3 > r2) {
      int[] iArr = Tinv0;
      int r0 =
          (((iArr[t0 & 255] ^ shift(iArr[(r32 >> 8) & 255], 24))
                      ^ shift(iArr[(t2 >> 16) & 255], 16))
                  ^ shift(iArr[(t1 >> 24) & 255], 8))
              ^ KW[r3][r1];
      int r12 =
          (((shift(iArr[(t0 >> 8) & 255], 24) ^ iArr[t1 & 255])
                      ^ shift(iArr[(r32 >> 16) & 255], 16))
                  ^ shift(iArr[(t2 >> 24) & 255], 8))
              ^ KW[r3][r2];
      int r22 =
          (((shift(iArr[(t1 >> 8) & 255], 24) ^ iArr[t2 & 255]) ^ shift(iArr[(t0 >> 16) & 255], 16))
                  ^ shift(iArr[(r32 >> 24) & 255], 8))
              ^ KW[r3][r];
      int r4 = r3 - 1;
      int r33 =
          (((shift(iArr[(t2 >> 8) & 255], 24) ^ iArr[r32 & 255])
                      ^ shift(iArr[(t1 >> 16) & 255], 16))
                  ^ shift(iArr[(t0 >> 24) & 255], 8))
              ^ KW[r3][3];
      t0 =
          (((iArr[r0 & 255] ^ shift(iArr[(r33 >> 8) & 255], 24))
                      ^ shift(iArr[(r22 >> 16) & 255], 16))
                  ^ shift(iArr[(r12 >> 24) & 255], 8))
              ^ KW[r4][0];
      t1 =
          (((iArr[r12 & 255] ^ shift(iArr[(r0 >> 8) & 255], 24))
                      ^ shift(iArr[(r33 >> 16) & 255], 16))
                  ^ shift(iArr[(r22 >> 24) & 255], 8))
              ^ KW[r4][1];
      t2 =
          (((iArr[r22 & 255] ^ shift(iArr[(r12 >> 8) & 255], 24))
                      ^ shift(iArr[(r0 >> 16) & 255], 16))
                  ^ shift(iArr[(r33 >> 24) & 255], 8))
              ^ KW[r4][2];
      r32 =
          (((iArr[r33 & 255] ^ shift(iArr[(r22 >> 8) & 255], 24))
                      ^ shift(iArr[(r12 >> 16) & 255], 16))
                  ^ shift(iArr[(r0 >> 24) & 255], 8))
              ^ KW[r4][3];
      r3 = r4 - 1;
    ...
    int[] iArr2 = Tinv0;
    int r02 =
        (((iArr2[t0 & 255] ^ shift(iArr2[(r32 >> 8) & 255], 24))
                    ^ shift(iArr2[(t2 >> 16) & 255], 16))
                ^ shift(iArr2[(t1 >> 24) & 255], 8))
            ^ KW[r3][0];
    int r13 =
        (((iArr2[t1 & 255] ^ shift(iArr2[(t0 >> 8) & 255], 24))
                    ^ shift(iArr2[(r32 >> 16) & 255], 16))
                ^ shift(iArr2[(t2 >> 24) & 255], 8))
            ^ KW[r3][1];
    int r23 =
        (((iArr2[t2 & 255] ^ shift(iArr2[(t1 >> 8) & 255], 24))
                    ^ shift(iArr2[(t0 >> 16) & 255], 16))
                ^ shift(iArr2[(r32 >> 24) & 255], 8))
            ^ KW[r3][2];
    int r34 =
        (shift(iArr2[(t0 >> 24) & 255], 8)
                ^ ((iArr2[r32 & 255] ^ shift(iArr2[(t2 >> 8) & 255], 24))
                    ^ shift(iArr2[(t1 >> 16) & 255], 16)))
            ^ KW[r3][3];
    byte[] bArr = f811Si;
    ...
    byte[] bArr2 = this.f822s;
    this.f818C0 =
        (((((bArr2[(r34 >> 8) & 255] & 255) << 8) ^ i3) ^ ((bArr2[(r23 >> 16) & 255] & 255) << 16))
                ^ (bArr[(r13 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT))
            ^ KW[0][0];
    this.f819C1 =
        ((((bArr2[r13 & 255] & 255) ^ ((bArr2[(r02 >> 8) & 255] & 255) << 8))
                    ^ ((bArr[(r34 >> 16) & 255] & 255) << 16))
                ^ (bArr2[(r23 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT))
            ^ KW[0][1];
    this.f820C2 =
        ((((bArr2[r23 & 255] & 255) ^ ((bArr[(r13 >> 8) & 255] & 255) << 8))
                    ^ ((bArr[(r02 >> 16) & 255] & 255) << 16))
                ^ (bArr2[(r34 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT))
            ^ KW[0][2];
    this.f821C3 =
        ((((bArr[r34 & 255] & 255) ^ ((bArr2[(r23 >> 8) & 255] & 255) << 8))
                    ^ ((bArr2[(r13 >> 16) & 255] & 255) << 16))
                ^ (bArr2[(r02 >> 24) & 255] << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT))
            ^ KW[0][3];
  }
