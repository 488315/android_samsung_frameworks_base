...
public class DESEngine implements BlockCipher {
  ...
  private static final int[] SP4 = {
    ...
    8388736, 8388609, 1, 8192, 8388608, 8396801, 128, 8388608, 8193, 8320, 8388737, 1, 8320,
  ...
  private static final int[] SP6 = {
    ...
    536887312, 16, 541065232, 541065232, 0, 4210704, 541081600, 16400, 4210688, 541081600,
  ...
  public void init(boolean encrypting, CipherParameters params) {
    ...
    throw new IllegalArgumentException(
        "invalid parameter passed to DES init - " + params.getClass().getName());
  }
    ...
    for (int i2 = 0; i2 != 32; i2 += 2) {
      ...
      newKey[i2] =
          ((16515072 & i22) >>> 10)
              ...
              | ((i22 & 4032) >>> 6);
      newKey[i2 + 1] =
          ((258048 & i22) >>> 4) | ((i1 & 258048) << 12) | ((i1 & 63) << 16) | (i22 & 63);
    }
    return newKey;
  }
  ...
  protected void desFunc(int[] wKey, byte[] in, int inOff, byte[] out, int outOff) {
    ...
    for (int round = 0; round < 8; round++) {
      ...
      int fval9 = work8 >>> 8;
      int fval10 =
          fval8 | iArr2[fval9 & 63] | iArr3[(work8 >>> 16) & 63] | iArr4[(work8 >>> 24) & 63];
      int work9 = left7 ^ wKey[(round * 4) + 3];
      right7 ^=
          (((fval10 | iArr5[work9 & 63]) | iArr6[(work9 >>> 8) & 63]) | iArr7[(work9 >>> 16) & 63])
              | iArr8[(work9 >>> 24) & 63];
    }
