...
public class DESEngine implements BlockCipher {
    ...
    private static final int[] SP6 = {
        ...
        541081600, 536870912, 536887296, 16, 541065232, 4210688, 541081616, 4194304, 16400,
        536870928, 4194304, 536887296, 536870912, 16400, 536870928, 541081616, 4210688, 541065216,
        4210704, 541081600, 0, 541065232, 16, 16384, 541065216, 4210704, 16384, 4194320, 536887312,
    ...
    protected void desFunc(int[] wKey, byte[] in, int inOff, byte[] out, int outOff) {
        ...
        for (int round = 0; round < 8; round++) {
            ...
            left7 ^=
                    (((fval2 | SP8[work7 & 63]) | SP6[(work7 >>> 8) & 63])
                                    | SP4[(work7 >>> 16) & 63])
                            | SP2[(work7 >>> 24) & 63];
            ...
            right7 ^=
                    (((fval4 | SP8[work9 & 63]) | SP6[(work9 >>> 8) & 63])
                                    | SP4[(work9 >>> 16) & 63])
                            | SP2[(work9 >>> 24) & 63];
        }
