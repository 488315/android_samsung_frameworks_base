...
public class RC2Engine implements BlockCipher {
    ...
    public void init(boolean encrypting, CipherParameters params) {
        ...
        if (params instanceof RC2Parameters) {
            ...
            throw new IllegalArgumentException(
                    "invalid parameter passed to RC2 init - " + params.getClass().getName());
        }
    }
    ...
    private void encryptBlock(byte[] in, int inOff, byte[] out, int outOff) {
        ...
        for (int i2 = 20; i2 <= 40; i2 += 4) {
            ...
            x322 =
                    rotateWordLeft(
                            ((~x102) & x542) + x322 + (x762 & x102) + this.workingKey[i2 + 1], 2);
            x542 =
                    rotateWordLeft(
                            ((~x322) & x762) + x542 + (x102 & x322) + this.workingKey[i2 + 2], 3);
            x762 =
                    rotateWordLeft(
                            ((~x542) & x102) + x762 + (x322 & x542) + this.workingKey[i2 + 3], 5);
        }
        ...
        for (int i3 = 44; i3 < 64; i3 += 4) {
            ...
            x323 =
                    rotateWordLeft(
                            ((~x103) & x543) + x323 + (x763 & x103) + this.workingKey[i3 + 1], 2);
            x543 =
                    rotateWordLeft(
                            ((~x323) & x763) + x543 + (x103 & x323) + this.workingKey[i3 + 2], 3);
            x763 =
                    rotateWordLeft(
                            ((~x543) & x103) + x763 + (x323 & x543) + this.workingKey[i3 + 3], 5);
        }
        int i4 = outOff + 0;
        out[i4] = (byte) x103;
    ...
    private void decryptBlock(byte[] in, int inOff, byte[] out, int outOff) {
        ...
        for (int i = 60; i >= 44; i -= 4) {
            x76 =
                    rotateWordLeft(x76, 11)
                            - ((((~x54) & x10) + (x32 & x54)) + this.workingKey[i + 3]);
            x54 =
                    rotateWordLeft(x54, 13)
                            - ((((~x32) & x76) + (x10 & x32)) + this.workingKey[i + 2]);
            x32 =
                    rotateWordLeft(x32, 14)
                            - ((((~x10) & x54) + (x76 & x10)) + this.workingKey[i + 1]);
        ...
        for (int i2 = 40; i2 >= 20; i2 -= 4) {
            x762 =
                    rotateWordLeft(x762, 11)
                            - ((((~x542) & x102) + (x322 & x542)) + this.workingKey[i2 + 3]);
            x542 =
                    rotateWordLeft(x542, 13)
                            - ((((~x322) & x762) + (x102 & x322)) + this.workingKey[i2 + 2]);
            x322 =
                    rotateWordLeft(x322, 14)
                            - ((((~x102) & x542) + (x762 & x102)) + this.workingKey[i2 + 1]);
            x102 =
                    rotateWordLeft(x102, 15)
                            - ((((~x762) & x322) + (x542 & x762)) + this.workingKey[i2]);
        }
        ...
        for (int i3 = 16; i3 >= 0; i3 -= 4) {
            x763 =
                    rotateWordLeft(x763, 11)
                            - ((((~x543) & x103) + (x323 & x543)) + this.workingKey[i3 + 3]);
            x543 =
                    rotateWordLeft(x543, 13)
                            - ((((~x323) & x763) + (x103 & x323)) + this.workingKey[i3 + 2]);
            x323 =
                    rotateWordLeft(x323, 14)
                            - ((((~x103) & x543) + (x763 & x103)) + this.workingKey[i3 + 1]);
            x103 =
                    rotateWordLeft(x103, 15)
                            - ((((~x763) & x323) + (x543 & x763)) + this.workingKey[i3]);
        }
        int i4 = outOff + 0;
        out[i4] = (byte) x103;
        out[outOff + 1] = (byte) (x103 >> 8);
