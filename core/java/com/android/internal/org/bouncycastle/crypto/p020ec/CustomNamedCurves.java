package com.android.internal.org.bouncycastle.crypto.p020ec;
...
import com.android.internal.org.bouncycastle.math.p026ec.custom.sec.SecP192K1Curve;
import com.android.internal.org.bouncycastle.math.p026ec.custom.sec.SecP192R1Curve;
import com.android.internal.org.bouncycastle.math.p026ec.custom.sec.SecP224K1Curve;
import com.android.internal.org.bouncycastle.math.p026ec.custom.sec.SecP224R1Curve;
import com.android.internal.org.bouncycastle.math.p026ec.custom.sec.SecP256K1Curve;
import com.android.internal.org.bouncycastle.math.p026ec.custom.sec.SecP256R1Curve;
import com.android.internal.org.bouncycastle.math.p026ec.custom.sec.SecP384R1Curve;
import com.android.internal.org.bouncycastle.math.p026ec.custom.sec.SecP521R1Curve;
...
public class CustomNamedCurves {
  static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() { // from class:
        ...
        protected X9ECParameters createParameters() {
          ...
          X9ECPoint G =
              CustomNamedCurves.configureBasepoint(
                  curve,
  ...
  static X9ECParametersHolder secp192r1 = new X9ECParametersHolder() { // from class:
        // com.android.internal.org.bouncycastle.crypto.ec.CustomNamedCurves.2
        @Override // com.android.internal.org.bouncycastle.asn1.p019x9.X9ECParametersHolder
        protected X9ECParameters createParameters() {
  ...
  static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() { // from class:
        // com.android.internal.org.bouncycastle.crypto.ec.CustomNamedCurves.3
        @Override // com.android.internal.org.bouncycastle.asn1.p019x9.X9ECParametersHolder
        protected X9ECParameters createParameters() {
          GLVTypeBParameters glv =
              new GLVTypeBParameters(
  ...
  static X9ECParametersHolder secp224r1 = new X9ECParametersHolder() { // from class:
        // com.android.internal.org.bouncycastle.crypto.ec.CustomNamedCurves.4
        @Override // com.android.internal.org.bouncycastle.asn1.p019x9.X9ECParametersHolder
        protected X9ECParameters createParameters() {
  ...
  static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() { // from class:
        // com.android.internal.org.bouncycastle.crypto.ec.CustomNamedCurves.5
        @Override // com.android.internal.org.bouncycastle.asn1.p019x9.X9ECParametersHolder
        protected X9ECParameters createParameters() {
          GLVTypeBParameters glv =
              new GLVTypeBParameters(
  ...
  static X9ECParametersHolder secp256r1 = new X9ECParametersHolder() { // from class:
        // com.android.internal.org.bouncycastle.crypto.ec.CustomNamedCurves.6
        @Override // com.android.internal.org.bouncycastle.asn1.p019x9.X9ECParametersHolder
        protected X9ECParameters createParameters() {
  ...
  static X9ECParametersHolder secp384r1 = new X9ECParametersHolder() { // from class:
        // com.android.internal.org.bouncycastle.crypto.ec.CustomNamedCurves.7
        @Override // com.android.internal.org.bouncycastle.asn1.p019x9.X9ECParametersHolder
        protected X9ECParameters createParameters() {
  ...
  static X9ECParametersHolder secp521r1 = new X9ECParametersHolder() { // from class:
        // com.android.internal.org.bouncycastle.crypto.ec.CustomNamedCurves.8
        @Override // com.android.internal.org.bouncycastle.asn1.p019x9.X9ECParametersHolder
        protected X9ECParameters createParameters() {
  ...
  static void defineCurveWithOID(
      String name, ASN1ObjectIdentifier oid, X9ECParametersHolder holder) {
    names.addElement(name);
