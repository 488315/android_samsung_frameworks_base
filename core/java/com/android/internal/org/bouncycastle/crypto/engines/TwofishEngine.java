...
public final class TwofishEngine implements BlockCipher {
  ...
  /* renamed from: P */
  private static final byte[][] f845P = {
    new byte[] {
      -87,
      103,
      -77,
    ...
    while (i6 < 256) {
      ...
      switch (this.k64Cnt & i5) {
        ...
        case 2:
          ...
          this.gSBox[(i6 * 2) + 1] =
              this.gMDS1[(bArr3[0][(bArr3[1][b1] & 255) ^ m196b1(k1)] & 255) ^ m196b1(k0)];
          this.gSBox[(i6 * 2) + 512] =
              this.gMDS2[(bArr3[1][(bArr3[0][b2] & 255) ^ m197b2(k1)] & 255) ^ m197b2(k0)];
          int[] iArr4 = this.gMDS3;
          byte[] bArr5 = bArr3[1];
          this.gSBox[(i6 * 2) + 513] =
              iArr4[(bArr5[(bArr5[b3] & 255) ^ m198b3(k1)] & 255) ^ m198b3(k0)];
          continue;
        case 3:
          c = 1;
          break;
      ...
      this.gSBox[(i6 * 2) + 1] =
          this.gMDS1[(bArr32[0][(bArr32[1][b1] & 255) ^ m196b1(k1)] & 255) ^ m196b1(k0)];
      this.gSBox[(i6 * 2) + 512] =
          this.gMDS2[(bArr32[1][(bArr32[0][b2] & 255) ^ m197b2(k1)] & 255) ^ m197b2(k0)];
      int[] iArr42 = this.gMDS3;
      byte[] bArr52 = bArr32[1];
      this.gSBox[(i6 * 2) + 513] =
          iArr42[(bArr52[(bArr52[b3] & 255) ^ m198b3(k1)] & 255) ^ m198b3(k0)];
      continue;
      i6++;
      k32e2 = k32e;
      i4 = 0;
  ...
  private int F32(int x, int[] k32) {
    ...
    switch (3 & this.k64Cnt) {
      ...
      case 1:
        ...
        byte[][] bArr2 = f845P;
        int result =
            ((this.gMDS1[(bArr2[0][b1] & 255) ^ m196b1(k0)]
                        ^ iArr[(bArr2[0][b0] & 255) ^ m195b0(k0)])
                    ^ this.gMDS2[(bArr2[1][b2] & 255) ^ m197b2(k0)])
                ^ this.gMDS3[(bArr2[1][b3] & 255) ^ m198b3(k0)];
        return result;
      case 3:
        break;
      case 2:
        ...
        int i =
            (this.gMDS1[(bArr3[0][(bArr3[1][b1] & 255) ^ m196b1(k1)] & 255) ^ m196b1(k0)]
                    ^ iArr2[(bArr4[(bArr4[b0] & 255) ^ m195b0(k1)] & 255) ^ m195b0(k0)])
                ^ this.gMDS2[(bArr3[1][(bArr3[0][b2] & 255) ^ m197b2(k1)] & 255) ^ m197b2(k0)];
    ...
    int i2 =
        (this.gMDS1[(bArr32[0][(bArr32[1][b1] & 255) ^ m196b1(k1)] & 255) ^ m196b1(k0)]
                ^ iArr22[(bArr42[(bArr42[b0] & 255) ^ m195b0(k1)] & 255) ^ m195b0(k0)])
            ^ this.gMDS2[(bArr32[1][(bArr32[0][b2] & 255) ^ m197b2(k1)] & 255) ^ m197b2(k0)];
  ...
  private int Fe32_0(int x) {
    int[] iArr = this.gSBox;
    return iArr[(((x >>> 24) & 255) * 2) + 513]
        ^ ((iArr[((x & 255) * 2) + 0] ^ iArr[(((x >>> 8) & 255) * 2) + 1])
            ^ iArr[(((x >>> 16) & 255) * 2) + 512]);
  }

  private int Fe32_3(int x) {
    int[] iArr = this.gSBox;
    return iArr[(((x >>> 16) & 255) * 2) + 513]
        ^ ((iArr[(((x >>> 24) & 255) * 2) + 0] ^ iArr[((x & 255) * 2) + 1])
            ^ iArr[(((x >>> 8) & 255) * 2) + 512]);
  }
