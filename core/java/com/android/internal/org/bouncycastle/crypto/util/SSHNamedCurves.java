...
public class SSHNamedCurves {
    private static final Map<String, ASN1ObjectIdentifier> oidMap =
            Collections.unmodifiableMap(
                    new HashMap<
                            String,
                            ASN1ObjectIdentifier>() { // from class:
                                                      // com.android.internal.org.bouncycastle.crypto.util.SSHNamedCurves.1
                        {
    ...
    private static final Map<String, String> curveNameToSSHName =
            Collections.unmodifiableMap(
                    new HashMap<
                            String,
                            String>() { // from class:
                                        // com.android.internal.org.bouncycastle.crypto.util.SSHNamedCurves.2
                        {
                            String[][] curves = {
                                new String[] {"secp256r1", "nistp256"},
                                new String[] {"secp384r1", "nistp384"},
                                new String[] {"secp521r1", "nistp521"},
                                new String[] {"sect163k1", "nistk163"},
                                new String[] {"secp192r1", "nistp192"},
                                new String[] {"secp224r1", "nistp224"},
                                new String[] {"sect233k1", "nistk233"},
                                new String[] {"sect233r1", "nistb233"},
                                new String[] {"sect283k1", "nistk283"},
                                new String[] {"sect409k1", "nistk409"},
                                new String[] {"sect409r1", "nistb409"},
                                new String[] {"sect571k1", "nistt571"}
                            };
    ...
    private static HashMap<ECCurve, String> curveMap =
            new HashMap<
                    ECCurve,
                    String>() { // from class:
                                // com.android.internal.org.bouncycastle.crypto.util.SSHNamedCurves.3
                {
    ...
    private static final Map<ASN1ObjectIdentifier, String> oidToName =
            Collections.unmodifiableMap(
                    new HashMap<
                            ...
                            String>() { // from class:
                                        // com.android.internal.org.bouncycastle.crypto.util.SSHNamedCurves.4
                        {
