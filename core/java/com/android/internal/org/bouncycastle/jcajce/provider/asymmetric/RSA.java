...
public class RSA {
  ...
  public static class Mappings extends AsymmetricAlgorithmProvider {
    ...
    private void addDigestSignature(
        ConfigurableProvider provider, String digest, String className, ASN1ObjectIdentifier oid) {
    ...
    private void addISO9796Signature(
      ...
      provider.addAlgorithm(
          "Alg.Alias.Signature." + digest + "withRSA/ISO9796-2", digest + "WITHRSA/ISO9796-2");
      provider.addAlgorithm(
          "Alg.Alias.Signature." + digest + "WithRSA/ISO9796-2", digest + "WITHRSA/ISO9796-2");
