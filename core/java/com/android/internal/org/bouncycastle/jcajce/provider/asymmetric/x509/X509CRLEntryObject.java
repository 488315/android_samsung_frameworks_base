...
class X509CRLEntryObject extends X509CRLEntry {
  ...
  /* renamed from: c */
  private TBSCertList.CRLEntry f902c;
  ...
  private Set getExtensionOIDs(boolean critical) {
    Extensions extensions = this.f902c.getExtensions();
    if (extensions != null) {
      Set set = new HashSet();
  ...
  private Extension getExtension(ASN1ObjectIdentifier oid) {
    Extensions exts = this.f902c.getExtensions();
    if (exts != null) {
  ...
  public boolean equals(Object other) {
    ...
    if (other instanceof X509CRLEntryObject) {
      ...
      return this.f902c.equals(otherBC.f902c);
    }
  ...
  public byte[] getEncoded() throws CRLException {
    try {
      return this.f902c.getEncoded(ASN1Encoding.DER);
    } catch (IOException e) {
  ...
  public BigInteger getSerialNumber() {
    return this.f902c.getUserCertificate().getValue();
  }

  @Override // java.security.cert.X509CRLEntry
  public Date getRevocationDate() {
    return this.f902c.getRevocationDate().getDate();
  }

  @Override // java.security.cert.X509CRLEntry
  public boolean hasExtensions() {
    return this.f902c.getExtensions() != null;
  }
