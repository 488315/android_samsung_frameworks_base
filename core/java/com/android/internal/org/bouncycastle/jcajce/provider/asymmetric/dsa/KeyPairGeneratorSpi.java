...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
  ...
  public void initialize(AlgorithmParameterSpec params2, SecureRandom random)
    ...
    DSAKeyGenerationParameters dSAKeyGenerationParameters =
        new DSAKeyGenerationParameters(
            random, new DSAParameters(dsaParams.getP(), dsaParams.getQ(), dsaParams.getG()));
    this.param = dSAKeyGenerationParameters;
    this.engine.init(dSAKeyGenerationParameters);
    this.initialised = true;
  }
      ...
      if (params.containsKey(paramStrength)) {
        ...
        synchronized (lock) {
          if (params.containsKey(paramStrength)) {
            ...
            if (i == 1024) {
              ...
              if (Properties.isOverrideSet(
                ...
                DSAParameterGenerationParameters dsaParams =
                    new DSAParameterGenerationParameters(1024, 160, certainty, this.random);
                pGen.init(dsaParams);
              }
            } else if (i > 1024) {
              DSAParameterGenerationParameters dsaParams2 =
                  new DSAParameterGenerationParameters(i, 256, certainty, this.random);
            ...
            DSAKeyGenerationParameters dSAKeyGenerationParameters =
                new DSAKeyGenerationParameters(this.random, pGen.generateParameters());
            this.param = dSAKeyGenerationParameters;
