...
import com.android.internal.org.bouncycastle.math.p026ec.FixedPointCombMultiplier;
  ...
  public static AsymmetricKeyParameter generatePublicKeyParameter(PublicKey key)
    ...
    if (key instanceof java.security.interfaces.ECPublicKey) {
      ...
      return new ECPublicKeyParameters(
          ...
          new ECDomainParameters(s2.getCurve(), s2.getG(), s2.getN(), s2.getH(), s2.getSeed()));
    }
    try {
