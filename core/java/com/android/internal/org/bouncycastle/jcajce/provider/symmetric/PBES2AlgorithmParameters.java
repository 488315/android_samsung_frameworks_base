...
public class PBES2AlgorithmParameters {
    ...
    private abstract static class BasePBEWithHmacAlgorithmParameters
        ...
        protected byte[] engineGetEncoded() {
            try {
                return new DERSequence(
                                new ASN1Encodable[] {PKCSObjectIdentifiers.id_PBES2, this.params})
                        .getEncoded();
            } catch (IOException e) {
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class parameterSpec)
            ...
            if (parameterSpec == PBEParameterSpec.class) {
                ...
                byte[] iv =
                        ((ASN1OctetString) this.params.getEncryptionScheme().getParameters())
                                .getOctets();
        ...
        try {
            return (PBEParameterSpec)
                    PBES2AlgorithmParameters.class
                            ...
                            .getConstructor(
                                    byte[].class, Integer.TYPE, AlgorithmParameterSpec.class)
                            .newInstance(
                                    salt, Integer.valueOf(iterationCount), new IvParameterSpec(iv));
        } catch (Exception e) {
