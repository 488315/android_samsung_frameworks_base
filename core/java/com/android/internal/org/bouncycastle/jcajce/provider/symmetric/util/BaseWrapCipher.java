...
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
    ...
    protected byte[] engineGetIV() {
        return Arrays.clone(this.f906iv);
    }
    ...
    protected AlgorithmParameters engineGetParameters() {
        if (this.engineParams == null && this.f906iv != null) {
            ...
            try {
                ...
                createParametersInstance.init(new IvParameterSpec(this.f906iv));
            } catch (Exception e) {
    ...
    protected void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if ((param instanceof KeyParameter) && (i = this.ivSize) != 0 && (opmode == 3 || opmode == 1)) {
            ...
            param = new ParametersWithIV(param, this.f906iv);
        }
        if (random != null) {
