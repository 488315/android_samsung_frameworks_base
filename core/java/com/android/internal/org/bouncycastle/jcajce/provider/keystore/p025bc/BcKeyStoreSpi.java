package com.android.internal.org.bouncycastle.jcajce.provider.keystore.p025bc;
...
import com.android.internal.org.bouncycastle.crypto.p021io.DigestInputStream;
import com.android.internal.org.bouncycastle.crypto.p021io.DigestOutputStream;
import com.android.internal.org.bouncycastle.crypto.p021io.MacInputStream;
import com.android.internal.org.bouncycastle.crypto.p021io.MacOutputStream;
...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
      ...
      if (this.type == 4) {
        ...
        try {
          ...
          try {
            ...
            Cipher cipher2 =
                BcKeyStoreSpi.this.makePBECipher(
                    "BrokenPBEWithSHAAnd3-KeyTripleDES-CBC", 2, password, salt2, iterationCount);
            ...
            try {
              ...
              Cipher cipher3 =
                  BcKeyStoreSpi.this.makePBECipher(
                      "OldPBEWithSHAAnd3-KeyTripleDES-CBC", 2, password, salt2, iterationCount);
            ...
            Cipher out =
                BcKeyStoreSpi.this.makePBECipher(
                    BcKeyStoreSpi.KEY_CIPHER, 1, password, salt2, iterationCount);
  ...
  public static class BouncyCastleStore extends BcKeyStoreSpi {
    ...
    @Override // com.android.internal.org.bouncycastle.jcajce.provider.keystore.p025bc.BcKeyStoreSpi, java.security.KeyStoreSpi
    public void engineLoad(InputStream stream, char[] password) throws IOException {
      String cipherAlg;
      this.table.clear();
      if (stream == null) {
