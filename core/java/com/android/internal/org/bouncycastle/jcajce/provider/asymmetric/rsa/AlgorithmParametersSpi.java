...
public abstract class AlgorithmParametersSpi extends java.security.AlgorithmParametersSpi {
    ...
    public static class OAEP extends AlgorithmParametersSpi {
        ...
        protected byte[] engineGetEncoded() {
            AlgorithmIdentifier hashAlgorithm =
                    new AlgorithmIdentifier(
                            DigestFactory.getOID(this.currentSpec.getDigestAlgorithm()),
                            DERNull.INSTANCE);
            ...
            AlgorithmIdentifier maskGenAlgorithm =
                    new AlgorithmIdentifier(
                            ...
                            new AlgorithmIdentifier(
                                    DigestFactory.getOID(mgfSpec.getDigestAlgorithm()),
                                    DERNull.INSTANCE));
            ...
            RSAESOAEPparams oaepP =
                    new RSAESOAEPparams(hashAlgorithm, maskGenAlgorithm, pSourceAlgorithm);
            try {
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class paramSpec)
            ...
            throw new InvalidParameterSpecException(
                    "unknown parameter spec passed to OAEP parameters object.");
        }
        ...
        protected void engineInit(AlgorithmParameterSpec paramSpec)
            ...
            if (!(paramSpec instanceof OAEPParameterSpec)) {
                throw new InvalidParameterSpecException(
                        "OAEPParameterSpec required to initialise an OAEP algorithm parameters"
                            + " object");
            }
    ...
    public static class PSS extends AlgorithmParametersSpi {
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class paramSpec)
            ...
            throw new InvalidParameterSpecException(
                    "unknown parameter spec passed to PSS parameters object.");
        }
        ...
        protected void engineInit(AlgorithmParameterSpec paramSpec)
            ...
            if (!(paramSpec instanceof PSSParameterSpec)) {
                throw new InvalidParameterSpecException(
                        "PSSParameterSpec required to initialise an PSS algorithm parameters"
                            + " object");
            }
        ...
        protected void engineInit(byte[] params) throws IOException {
            try {
                ...
                if (!pssP.getMaskGenAlgorithm()
                        .getAlgorithm()
                        .equals((ASN1Primitive) PKCSObjectIdentifiers.id_mgf1)) {
                    throw new IOException(
                            "unknown mask generation function: "
                                    + pssP.getMaskGenAlgorithm().getAlgorithm());
                }
                this.currentSpec =
