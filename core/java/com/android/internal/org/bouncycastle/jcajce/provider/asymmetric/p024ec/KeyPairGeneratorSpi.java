package com.android.internal.org.bouncycastle.jcajce.provider.asymmetric.p024ec;
...
public abstract class KeyPairGeneratorSpi extends KeyPairGenerator {
  ...
  public static class C4577EC extends KeyPairGeneratorSpi {
    ...
    public C4577EC(String algorithm, ProviderConfiguration configuration) {
      super(algorithm);
      this.engine = new ECKeyPairGenerator();
      this.ecParams = null;
      this.strength = 256;
    ...
    public void initialize(int strength, SecureRandom random) {
      ...
      ECGenParameterSpec ecParams =
          (ECGenParameterSpec) ecParameters.get(Integers.valueOf(strength));
      if (ecParams == null) {
    ...
    public KeyPair generateKeyPair() {
      ...
      if (obj instanceof ECParameterSpec) {
        ...
        return new KeyPair(
            pubKey, new BCECPrivateKey(this.algorithm, priv, pubKey, p, this.configuration));
      }
      if (obj == null) {
        return new KeyPair(
            new BCECPublicKey(this.algorithm, pub, this.configuration),
            new BCECPrivateKey(this.algorithm, priv, this.configuration));
      }
      ...
      return new KeyPair(
          pubKey2, new BCECPrivateKey(this.algorithm, priv, pubKey2, p2, this.configuration));
    }

    protected ECKeyGenerationParameters createKeyGenParamsBC(ECParameterSpec p, SecureRandom r) {
      return new ECKeyGenerationParameters(
          new ECDomainParameters(p.getCurve(), p.getG(), p.getN(), p.getH()), r);
    }
    ...
    protected ECKeyGenerationParameters createKeyGenParamsJCE(
      ...
      if ((p instanceof ECNamedCurveSpec)
          && (x9P = ECUtils.getDomainParametersFromName(((ECNamedCurveSpec) p).getName()))
              != null) {
        ECDomainParameters dp =
            new ECDomainParameters(x9P.getCurve(), x9P.getG(), x9P.getN(), x9P.getH());
  ...
  public static class ECDSA extends C4577EC {
    public ECDSA() {
      super("ECDSA", BouncyCastleProvider.CONFIGURATION);
    }
  }

  public static class ECDH extends C4577EC {
    public ECDH() {
      super("ECDH", BouncyCastleProvider.CONFIGURATION);
    }
  }

  public static class ECDHC extends C4577EC {
    public ECDHC() {
      super("ECDHC", BouncyCastleProvider.CONFIGURATION);
    }
  }

  public static class ECMQV extends C4577EC {
    public ECMQV() {
