...
public class KeyAgreementSpi extends BaseAgreementSpi {
  ...
  protected byte[] bigIntToBytes(BigInteger r) {
    ...
    return x9IntegerConverter.integerToBytes(
        r, x9IntegerConverter.getByteLength(this.parameters.getCurve()));
  }
          ...
          "calculation failed: "
              + e
                  .getMessage()) { // from class:
                                   // com.android.internal.org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi.1
  ...
  private void initFromKey(Key key, AlgorithmParameterSpec parameterSpec)
    ...
    this.ukmParameters =
        parameterSpec instanceof UserKeyingMaterialSpec
  ...
  public static class C4575DH extends KeyAgreementSpi {
    public C4575DH() {
