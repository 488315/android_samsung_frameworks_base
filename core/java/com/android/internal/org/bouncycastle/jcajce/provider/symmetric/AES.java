...
public final class AES {
  ...
  public static class AlgParamsGCM extends BaseAlgorithmParameters {
    ...
    protected void engineInit(AlgorithmParameterSpec paramSpec)
      ...
      if (com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.GcmSpecUtil
          .isGcmSpec(paramSpec)) {
        this.gcmParams =
            com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.GcmSpecUtil
                .extractGcmParameters(paramSpec);
      } else {
    ...
    protected AlgorithmParameterSpec localEngineGetParameterSpec(Class paramSpec)
      ...
      if (paramSpec == AlgorithmParameterSpec.class
        ...
        if (com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.GcmSpecUtil
            .gcmSpecExists()) {
          return com.android.internal.org.bouncycastle.jcajce.provider.symmetric.util.GcmSpecUtil
              .extractGcmSpec(this.gcmParams.toASN1Primitive());
        }
  ...
  public static class Mappings extends SymmetricAlgorithmProvider {
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm(
          "Cipher.PBEWITHSHA256AND128BITAES-CBC-BC", str + "$PBEWithSHA256AESCBC128");
      provider.addAlgorithm(
          "Cipher.PBEWITHSHA256AND192BITAES-CBC-BC", str + "$PBEWithSHA256AESCBC192");
      provider.addAlgorithm(
          "Cipher.PBEWITHSHA256AND256BITAES-CBC-BC", str + "$PBEWithSHA256AESCBC256");
      provider.addAlgorithm(
      ...
      provider.addAlgorithm(
          ...
          str + "$PBEWithMD5And128BitAESCBCOpenSSL");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHMD5AND192BITAES-CBC-OPENSSL",
          str + "$PBEWithMD5And192BitAESCBCOpenSSL");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHMD5AND256BITAES-CBC-OPENSSL",
          str + "$PBEWithMD5And256BitAESCBCOpenSSL");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHSHAAND128BITAES-CBC-BC", str + "$PBEWithSHAAnd128BitAESBC");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHSHAAND192BITAES-CBC-BC", str + "$PBEWithSHAAnd192BitAESBC");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHSHAAND256BITAES-CBC-BC", str + "$PBEWithSHAAnd256BitAESBC");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHSHA256AND128BITAES-CBC-BC",
          str + "$PBEWithSHA256And128BitAESBC");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHSHA256AND192BITAES-CBC-BC",
          str + "$PBEWithSHA256And192BitAESBC");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHSHA256AND256BITAES-CBC-BC",
          str + "$PBEWithSHA256And256BitAESBC");
      provider.addAlgorithm(
