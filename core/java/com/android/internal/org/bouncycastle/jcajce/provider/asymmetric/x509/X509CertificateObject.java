...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        try {
            if (this.encoded == null) {
                this.encoded = this.f904c.getEncoded(ASN1Encoding.DER);
            }
            return this.encoded;
        } catch (IOException e) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || otherBC.internalCertificateValue == null) && (signature = this.f904c.getSignature()) != null && !signature.equals(otherBC.f904c.getSignature())) {
                return false;
            }
        }
    ...
    private X509CertificateInternal getInternalCertificate() {
        ...
        synchronized (this.cacheLock) {
            ...
            X509CertificateInternal temp = new X509CertificateInternal(this.bcHelper, this.f904c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, encoding);
            synchronized (this.cacheLock) {
