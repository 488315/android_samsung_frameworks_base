...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
  ...
  public boolean equals(Object other) {
    ...
    if (other instanceof X509CertificateObject) {
      ...
      } else if ((this.internalCertificateValue == null || otherBC.internalCertificateValue == null)
          && (signature = this.f904c.getSignature()) != null
          && !signature.equals(otherBC.f904c.getSignature())) {
        return false;
      }
    }
