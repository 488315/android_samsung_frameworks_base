...
public class EC5Util {
    ...
    public static ECCurve convertCurve(EllipticCurve ec) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C4595Fp curve = new ECCurve.C4595Fp(((ECFieldFp) field).getP(), a, b);
    ...
    public static com.android.internal.org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec ecSpec) {
        ...
        com.android.internal.org.bouncycastle.math.p026ec.ECPoint g = convertPoint(curve, ecSpec.getGenerator());
    ...
    public static com.android.internal.org.bouncycastle.math.p026ec.ECPoint convertPoint(ECParameterSpec ecSpec, ECPoint point) {
        return convertPoint(convertCurve(ecSpec.getCurve()), point);
    }

    public static com.android.internal.org.bouncycastle.math.p026ec.ECPoint convertPoint(ECCurve curve, ECPoint point) {
        return curve.createPoint(point.getAffineX(), point.getAffineY());
    }

    public static ECPoint convertPoint(com.android.internal.org.bouncycastle.math.p026ec.ECPoint point) {
