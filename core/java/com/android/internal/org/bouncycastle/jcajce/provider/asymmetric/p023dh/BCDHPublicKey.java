...
import com.android.internal.org.bouncycastle.asn1.p019x9.DomainParameters;
import com.android.internal.org.bouncycastle.asn1.p019x9.ValidationParams;
...
public class BCDHPublicKey implements DHPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f894y;

    BCDHPublicKey(DHPublicKeySpec spec) {
        this.f894y = spec.getY();
        ...
        if (dHParameterSpec instanceof DHDomainParameterSpec) {
            ...
            this.dhPublicKey = new DHPublicKeyParameters(this.f894y, dhSp.getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f894y, new DHParameters(spec.getP(), spec.getG()));
        }
    }
    ...
    BCDHPublicKey(DHPublicKey key) {
        ...
        if (params instanceof DHDomainParameterSpec) {
            ...
            this.dhPublicKey = new DHPublicKeyParameters(this.f894y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
        }
    }

    BCDHPublicKey(DHPublicKeyParameters params) {
        this.f894y = params.getY();
        ...
        try {
            ...
            if (!id.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement) && !isPKCSParam(seq)) {
                ...
                if (validationParams != null) {
                    this.dhPublicKey = new DHPublicKeyParameters(this.f894y, new DHParameters(params.getP(), params.getG(), params.getQ(), params.getJ(), new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue())));
                } else {
                    this.dhPublicKey = new DHPublicKeyParameters(this.f894y, new DHParameters(params.getP(), params.getG(), params.getQ(), params.getJ(), (DHValidationParameters) null));
                }
            ...
            if (params2.getL() != null) {
                ...
                this.dhPublicKey = new DHPublicKeyParameters(this.f894y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG(), null, this.dhSpec.getL()));
            } else {
    ...
    public byte[] getEncoded() {
        ...
        if ((dHParameterSpec instanceof DHDomainParameterSpec) && ((DHDomainParameterSpec) dHParameterSpec).getQ() != null) {
            ...
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.dhpublicnumber, new DomainParameters(params.getP(), params.getG(), params.getQ(), params.getJ(), vParams).toASN1Primitive()), new ASN1Integer(this.f894y));
        }
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), new ASN1Integer(this.f894y));
    }

    public String toString() {
        return DHUtil.publicKeyToString("DH", this.f894y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
