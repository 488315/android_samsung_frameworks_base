...
public class BCDHPublicKey implements DHPublicKey {
  ...
  BCDHPublicKey(DHPublicKeySpec spec) {
    ...
    if (dHParameterSpec instanceof DHDomainParameterSpec) {
      ...
      this.dhPublicKey =
          new DHPublicKeyParameters(this.f894y, new DHParameters(spec.getP(), spec.getG()));
    }
  }
    ...
    if (params instanceof DHDomainParameterSpec) {
      ...
      this.dhPublicKey =
          new DHPublicKeyParameters(
              this.f894y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
  }
  ...
  BCDHPublicKey(BigInteger y, DHParameterSpec dhSpec) {
    ...
    if (dhSpec instanceof DHDomainParameterSpec) {
      this.dhPublicKey =
          new DHPublicKeyParameters(y, ((DHDomainParameterSpec) dhSpec).getDomainParameters());
    } else {
      this.dhPublicKey =
  ...
  public BCDHPublicKey(SubjectPublicKeyInfo info) {
    ...
    try {
      ...
      if (params2.getL() != null) {
        this.dhSpec =
            new DHParameterSpec(params2.getP(), params2.getG(), params2.getL().intValue());
        this.dhPublicKey =
            new DHPublicKeyParameters(
                this.f894y,
  ...
  public byte[] getEncoded() {
    ...
    DHParameterSpec dHParameterSpec = this.dhSpec;
    if ((dHParameterSpec instanceof DHDomainParameterSpec)
        && ((DHDomainParameterSpec) dHParameterSpec).getQ() != null) {
      ...
      if (validationParameters != null) {
        vParams =
            new ValidationParams(validationParameters.getSeed(), validationParameters.getCounter());
      }
      return KeyUtil.getEncodedSubjectPublicKeyInfo(
          new AlgorithmIdentifier(
              X9ObjectIdentifiers.dhpublicnumber,
              new DomainParameters(
                      params.getP(), params.getG(), params.getQ(), params.getJ(), vParams)
                  .toASN1Primitive()),
          new ASN1Integer(this.f894y));
    }
    return KeyUtil.getEncodedSubjectPublicKeyInfo(
        new AlgorithmIdentifier(
  ...
  public String toString() {
    return DHUtil.publicKeyToString(
        "DH", this.f894y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
  }
