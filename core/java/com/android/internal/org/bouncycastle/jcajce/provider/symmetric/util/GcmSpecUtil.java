                    ...
                    AccessController.doPrivileged(
                            new PrivilegedExceptionAction() { // from class:
                                ...
                                public Object run() throws Exception {
                                    return GcmSpecUtil.gcmSpecClass.getDeclaredMethod(
                                            name, new Class[0]);
                                }
                            });
                            ...
                            new PrivilegedExceptionAction() { // from class:
                                ...
                                public Object run() throws Exception {
                                    return new AEADParameters(
                                            KeyParameter.this,
                                            ((Integer)
                                                            GcmSpecUtil.tLen.invoke(
                                                                    params, new Object[0]))
                                                    .intValue(),
                                            (byte[]) GcmSpecUtil.iv.invoke(params, new Object[0]));
                                }
                            });
        } catch (Exception e) {
                            ...
                            new PrivilegedExceptionAction() { // from class:
                                ...
                                public Object run() throws Exception {
                                    return new GCMParameters(
                                            (byte[])
                                                    GcmSpecUtil.iv.invoke(paramSpec, new Object[0]),
                                            ((Integer)
                                                                    GcmSpecUtil.tLen.invoke(
                                                                            paramSpec,
                                                                            new Object[0]))
