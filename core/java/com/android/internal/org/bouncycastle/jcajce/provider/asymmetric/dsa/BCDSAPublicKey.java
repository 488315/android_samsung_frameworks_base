...
public class BCDSAPublicKey implements DSAPublicKey {
  ...
  BCDSAPublicKey(DSAPublicKeySpec spec) {
    ...
    this.lwKeyParams =
        new DSAPublicKeyParameters(this.f899y, DSAUtil.toDSAParameters(this.dsaSpec));
  }
  ...
  public byte[] getEncoded() {
    if (this.dsaSpec == null) {
      return KeyUtil.getEncodedSubjectPublicKeyInfo(
          new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa), new ASN1Integer(this.f899y));
    }
    return KeyUtil.getEncodedSubjectPublicKeyInfo(
  ...
  public String toString() {
    ...
    buf.append("DSA Public Key [")
        .append(DSAUtil.generateKeyFingerprint(this.f899y, getParams()))
  ...
  private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
    ...
    if (p.equals(ZERO)) {
      ...
      this.dsaSpec =
          new DSAParameterSpec(p, (BigInteger) in.readObject(), (BigInteger) in.readObject());
    }
    this.lwKeyParams =
        new DSAPublicKeyParameters(this.f899y, DSAUtil.toDSAParameters(this.dsaSpec));
  }
