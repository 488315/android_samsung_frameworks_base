...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f899y;

    BCDSAPublicKey(DSAPublicKeySpec spec) {
        this.f899y = spec.getY();
        this.dsaSpec = new DSAParameterSpec(spec.getP(), spec.getQ(), spec.getG());
        this.lwKeyParams = new DSAPublicKeyParameters(this.f899y, DSAUtil.toDSAParameters(this.dsaSpec));
    }
    ...
    public byte[] getEncoded() {
        if (this.dsaSpec == null) {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa), new ASN1Integer(this.f899y));
        }
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa, new DSAParameter(this.dsaSpec.getP(), this.dsaSpec.getQ(), this.dsaSpec.getG()).toASN1Primitive()), new ASN1Integer(this.f899y));
    }
    ...
    public String toString() {
        ...
        buf.append("DSA Public Key [").append(DSAUtil.generateKeyFingerprint(this.f899y, getParams())).append(NavigationBarInflaterView.SIZE_MOD_END).append(nl);
