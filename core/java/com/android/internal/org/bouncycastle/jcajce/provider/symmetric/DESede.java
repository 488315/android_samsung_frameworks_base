...
public final class DESede {
  ...
  public static class Mappings extends AlgorithmProvider {
    ...
    public void configure(ConfigurableProvider provider) {
      ...
      provider.addAlgorithm(
          "Cipher.PBEWITHSHAAND3-KEYTRIPLEDES-CBC", str + "$PBEWithSHAAndDES3Key");
      provider.addAlgorithm(
          "Cipher.PBEWITHSHAAND2-KEYTRIPLEDES-CBC", str + "$PBEWithSHAAndDES2Key");
      provider.addAlgorithm(
          "Alg.Alias.Cipher",
          PKCSObjectIdentifiers.pbeWithSHAAnd3_KeyTripleDES_CBC,
      ...
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHSHAAND3-KEYTRIPLEDES-CBC", str + "$PBEWithSHAAndDES3KeyFactory");
      provider.addAlgorithm(
          "SecretKeyFactory.PBEWITHSHAAND2-KEYTRIPLEDES-CBC", str + "$PBEWithSHAAndDES2KeyFactory");
      provider.addAlgorithm(
