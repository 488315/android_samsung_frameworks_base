...
class X509CRLObject extends X509CRLImpl {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof X509CRLObject) {
            ...
            } else if ((this.internalCRLValue == null || otherBC.internalCRLValue == null) && (signature = this.f903c.getSignature()) != null && !signature.equals(otherBC.f903c.getSignature())) {
                return false;
            }
        }
    ...
    private X509CRLInternal getInternalCRL() {
        ...
        synchronized (this.cacheLock) {
            ...
            X509CRLInternal temp = new X509CRLInternal(this.bcHelper, this.f903c, this.sigAlgName, this.sigAlgParams, this.isIndirect, encoding);
            synchronized (this.cacheLock) {
