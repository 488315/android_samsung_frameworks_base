...
public class BCECPublicKey
  ...
  public BCECPublicKey(
    ...
    this.ecPublicKey =
        new ECPublicKeyParameters(
            EC5Util.convertPoint(params, spec.getW()),
  ...
  public BCECPublicKey(ECPublicKey key, ProviderConfiguration configuration) {
    ...
    this.ecPublicKey =
        new ECPublicKeyParameters(
            EC5Util.convertPoint(params, key.getW()),
  ...
  public byte[] getEncoded() {
    boolean compress =
        this.withCompression
            || Properties.isOverrideSet("com.android.internal.org.bouncycastle.ec.enable_pc");
  ...
  public com.android.internal.org.bouncycastle.math.p026ec.ECPoint getQ() {
    com.android.internal.org.bouncycastle.math.p026ec.ECPoint q = this.ecPublicKey.getQ();
    if (this.ecSpec == null) {
