...
public class SecP192R1Field {
  ...
  /* renamed from: M */
  private static final long f952M = 4294967295L;

  /* renamed from: P5 */
  private static final int f954P5 = -1;
  private static final int PExt11 = -1;

  /* renamed from: P */
  static final int[] f953P = {-1, -1, -2, -1, -1, -1};
  ...
  public static void add(int[] x, int[] y, int[] z) {
    ...
    if (c != 0 || (z[5] == -1 && Nat192.gte(z, f953P))) {
      addPInvTo(z);
    }
  }
  ...
  public static void half(int[] x, int[] z) {
    if ((x[0] & 1) == 0) {
      ...
      int c = Nat192.add(x, f953P, z);
      Nat.shiftDownBit(6, z, c);
    }
  }

  public static void inv(int[] x, int[] z) {
    Mod.checkedModOddInverse(f953P, x, z);
  }
  ...
  public static void random(SecureRandom r, int[] z) {
    ...
    } while (Nat.lessThan(6, z, f953P) == 0);
  }
  ...
  public static void reduce(int[] xx, int[] z) {
    ...
    z[2] = (int) z22;
    if (((z22 >> 32) != 0 && Nat.incAt(6, z, 3) != 0) || (z[5] == -1 && Nat192.gte(z, f953P))) {
      addPInvTo(z);
    }
  }
  ...
  public static void reduce32(int x, int[] z) {
    ...
    if ((cc != 0 && Nat.incAt(6, z, 3) != 0) || (z[5] == -1 && Nat192.gte(z, f953P))) {
      addPInvTo(z);
    }
  }
