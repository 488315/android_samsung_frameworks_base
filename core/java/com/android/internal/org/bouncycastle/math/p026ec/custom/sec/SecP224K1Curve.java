...
public class SecP224K1Curve extends ECCurve.AbstractFp {
  ...
  /* renamed from: q */
  public static final BigInteger f957q = SecP224K1FieldElement.f960Q;
  ...
  public SecP224K1Curve() {
    ...
    this.f927b = fromBigInteger(BigInteger.valueOf(5L));
    this.order =
        new BigInteger(
            1, Hex.decodeStrict("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7"));
  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
    ...
    for (int i = 0; i < len; i++) {
      ...
      Nat224.copy(((SecP224K1FieldElement) p.getRawXCoord()).f961x, 0, table, pos);
      int pos2 = pos + 7;
      Nat224.copy(((SecP224K1FieldElement) p.getRawYCoord()).f961x, 0, table, pos2);
      pos = pos2 + 7;
    }
