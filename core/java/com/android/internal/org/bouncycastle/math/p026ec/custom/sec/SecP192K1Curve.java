...
public class SecP192K1Curve extends ECCurve.AbstractFp {
  ...
  /* renamed from: q */
  public static final BigInteger f946q = SecP192K1FieldElement.f949Q;
  ...
  public SecP192K1Curve() {
    ...
    this.f926a = fromBigInteger(ECConstants.ZERO);
    this.f927b = fromBigInteger(BigInteger.valueOf(3L));
    this.order =
        new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFE26F2FC170F69466A74DEFD8D"));
  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
    ...
    for (int i = 0; i < len; i++) {
      ...
      Nat192.copy(((SecP192K1FieldElement) p.getRawXCoord()).f950x, 0, table, pos);
      int pos2 = pos + 6;
      Nat192.copy(((SecP192K1FieldElement) p.getRawYCoord()).f950x, 0, table, pos2);
      pos = pos2 + 6;
    }
