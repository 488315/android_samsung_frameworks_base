...
class LongArray implements Cloneable {
  ...
  private static final short[] INTERLEAVE2_TABLE = {
    ...
    84,
    85,
    IGnss.GnssAidingData.DELETE_SVSTEER,
    IGnssNavigationMessageCallback.GnssNavigationMessageType.GPS_L1CA,
    IGnssNavigationMessageCallback.GnssNavigationMessageType.GPS_CNAV2,
    261,
    272,
    273,
    276,
    ...
    1109,
    1280,
    IGnssNavigationMessageCallback.GnssNavigationMessageType.BDS_D1,
    1284,
    1285,
    1296,
    1297,
  ...
  private static final int[] INTERLEAVE3_TABLE = {
    ...
    262728,
    262729,
    Protocol.BASE_DATA_CONNECTION_AC,
    266241,
    266248,
    266249,
    266304,
  ...
  private static final int[] INTERLEAVE4_TABLE = {
    ...
    17891328,
    17891329,
    C4337R.bool.allow_test_udfps,
    C4337R.bool.auto_data_switch_ping_test_before_switch,
    C4337R.bool.config_cecTvSendStandbyOnSleep_userConfigurable,
    C4337R.bool.config_cecTvWakeOnOneTouchPlayDisabled_allowed,
    C4337R.bool.config_customUserSwitchUi,
    C4337R.bool.config_debugEnableAutomaticSystemServerHeapDumps,
    17895424,
    17895425,
    17895440,
    17895441,
    ...
    285212945,
    285216768,
    SemDvfsManager.TYPE_RESOURCE_CPU_MIN_LITTLE_CORE,
    285216784,
    285216785,
    285217024,
    285217025,
    ...
    285282576,
    285282577,
    TvSettingsEnums.NETWORK_WIFI_ON_OFF,
    286261249,
    286261264,
    286261265,
    286261504,
  ...
  private static void addBoth(
      long[] x, int xOff, long[] y1, int y1Off, long[] y2, int y2Off, int count) {
    for (int i = 0; i < count; i++) {
      int i2 = xOff + i;
  ...
  private static long interleave3(long x) {
    ...
    return (interleave3_21to63(((int) (x >>> 42)) & AudioChannelLayout.INDEX_MASK_21) << 2)
        | interleave3_21to63(((int) x) & AudioChannelLayout.INDEX_MASK_21)
        | z
        | (interleave3_21to63(((int) (x >>> 21)) & AudioChannelLayout.INDEX_MASK_21) << 1);
  }
  ...
  private static long interleave5(long x) {
    return interleave3_13to65(((int) x) & 8191)
        | (interleave3_13to65(((int) (x >>> 13)) & 8191) << 1)
        | (interleave3_13to65(((int) (x >>> 26)) & 8191) << 2)
        | (interleave3_13to65(((int) (x >>> 39)) & 8191) << 3)
        | (interleave3_13to65(((int) (x >>> 52)) & 8191) << 4);
  }
  ...
  private static long interleave2_n(long x, int rounds) {
    while (rounds > 1) {
      rounds -= 2;
      x =
          (interleave4_16to64(((int) (x >>> 16)) & 65535) << 1)
              | interleave4_16to64(((int) x) & 65535)
              | (interleave4_16to64(((int) (x >>> 32)) & 65535) << 2)
              | (interleave4_16to64(((int) (x >>> 48)) & 65535) << 3);
    }
    if (rounds > 0) {
