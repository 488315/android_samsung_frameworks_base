...
class LongArray implements Cloneable {
    ...
    private static final int[] INTERLEAVE3_TABLE = {
        ...
        262145,
        262152,
        Ike.ERROR_PROTOCOL_INVALID_MESSAGE_ID,
        262208,
        262209,
        262216,
        262217,
        ...
        266824,
        266825,
        TransitionInfo.FLAGS_IS_OCCLUDED_NO_ANIMATION,
        294913,
        294920,
        294921,
        294976,
    ...
    private static final int[] INTERLEAVE4_TABLE = {
        ...
        17891328,
        17891329,
        R.bool.allow_test_udfps,
        R.bool.auto_data_switch_allow_roaming,
    ...
    private static final int[] INTERLEAVE5_TABLE = {
        ...
        1025,
        1056,
        RILConstants.RIL_UNSOL_SECURITY_ALGORITHMS_UPDATED,
        32768,
        32769,
        32800,
        32801,
    ...
    static final byte[] bitLengths = {
        ...
        7, 7, 7, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8,
    ...
    private static long addShiftedDown(
            long[] x, int xOff, long[] y, int yOff, int count, int shift) {
        int shiftInv = 64 - shift;
        long prev = 0;
        int i = count;
        while (true) {
    ...
    private static long interleave7(long x) {
        long z = Long.MIN_VALUE & x;
        return INTERLEAVE7_TABLE[((int) x) & 511]
                | z
                | (INTERLEAVE7_TABLE[((int) (x >>> 9)) & 511] << 1)
                | (INTERLEAVE7_TABLE[((int) (x >>> 18)) & 511] << 2)
                | (INTERLEAVE7_TABLE[((int) (x >>> 27)) & 511] << 3)
                | (INTERLEAVE7_TABLE[((int) (x >>> 36)) & 511] << 4)
                | (INTERLEAVE7_TABLE[((int) (x >>> 45)) & 511] << 5)
                | (INTERLEAVE7_TABLE[((int) (x >>> 54)) & 511] << 6);
    }

    private static void interleave2_n(
            long[] x, int xOff, long[] z, int zOff, int count, int rounds) {
        for (int i = 0; i < count; i++) {
