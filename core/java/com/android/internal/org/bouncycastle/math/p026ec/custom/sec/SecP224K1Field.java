...
public class SecP224K1Field {
    ...
    /* renamed from: P6 */
    private static final int f959P6 = -1;
    private static final int PExt13 = -1;
    private static final int PInv33 = 6803;

    /* renamed from: P */
    static final int[] f958P = {-6803, -2, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] x, int[] y, int[] z) {
        ...
        if (c != 0 || (z[6] == -1 && Nat224.gte(z, f958P))) {
    ...
    public static void half(int[] x, int[] z) {
        if ((x[0] & 1) == 0) {
            ...
            int c = Nat224.add(x, f958P, z);
            Nat.shiftDownBit(7, z, c);
        }
    }

    public static void inv(int[] x, int[] z) {
        Mod.checkedModOddInverse(f958P, x, z);
    }
    ...
    public static void random(SecureRandom r, int[] z) {
        ...
        } while (Nat.lessThan(7, z, f958P) == 0);
    }
    ...
    public static void reduce32(int x, int[] z) {
        if ((x != 0 && Nat224.mul33WordAdd(PInv33, x, z, 0) != 0) || (z[6] == -1 && Nat224.gte(z, f958P))) {
            Nat.add33To(7, PInv33, z);
        }
    }
