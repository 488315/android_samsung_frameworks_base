...
public class SecP224R1Field {
  ...
  /* renamed from: M */
  private static final long f963M = 4294967295L;

  /* renamed from: P6 */
  private static final int f965P6 = -1;
  private static final int PExt13 = -1;

  /* renamed from: P */
  static final int[] f964P = {1, 0, 0, -1, -1, -1, -1};
  ...
  public static void add(int[] x, int[] y, int[] z) {
    ...
    if (c != 0 || (z[6] == -1 && Nat224.gte(z, f964P))) {
      addPInvTo(z);
    }
  }
  ...
  public static void half(int[] x, int[] z) {
    if ((x[0] & 1) == 0) {
      ...
      int c = Nat224.add(x, f964P, z);
      Nat.shiftDownBit(7, z, c);
    }
  }

  public static void inv(int[] x, int[] z) {
    Mod.checkedModOddInverse(f964P, x, z);
  }
  ...
  public static void random(SecureRandom r, int[] z) {
    ...
    } while (Nat.lessThan(7, z, f964P) == 0);
  }
  ...
  public static void reduce(int[] xx, int[] z) {
    ...
    z[3] = (int) z32;
    if (((z32 >> 32) != 0 && Nat.incAt(7, z, 4) != 0) || (z[6] == -1 && Nat224.gte(z, f964P))) {
      addPInvTo(z);
    }
  }
  ...
  public static void reduce32(int x, int[] z) {
    ...
    if ((cc != 0 && Nat.incAt(7, z, 4) != 0) || (z[6] == -1 && Nat224.gte(z, f964P))) {
      addPInvTo(z);
    }
  }
