...
class Tnaf {
  ...
  static {
    ...
    alpha0 =
        new ZTauElement[] {
          ...
          null,
          new ZTauElement(negate2, negate),
          null,
          new ZTauElement(negate, negate),
          null,
          new ZTauElement(ECConstants.ONE, negate),
          null
        };
    alpha0Tnaf =
        new byte[][] {
    ...
    alpha1 =
        new ZTauElement[] {
          ...
          new ZTauElement(ECConstants.ONE, ECConstants.ZERO),
          null,
          new ZTauElement(negate2, ECConstants.ONE),
          null,
          new ZTauElement(negate, ECConstants.ONE),
          null,
  ...
  public static BigInteger norm(byte mu, ZTauElement lambda) {
    BigInteger s1 = lambda.f944u.multiply(lambda.f944u);
    BigInteger s2 = lambda.f944u.multiply(lambda.f945v);
    BigInteger s3 = lambda.f945v.multiply(lambda.f945v).shiftLeft(1);
    if (mu == 1) {
  ...
  public static byte[] tauAdicNaf(byte mu, ZTauElement lambda) {
    ...
    int i = 0;
    int length = 0;
    BigInteger r0 = lambda.f944u;
    BigInteger r1 = lambda.f945v;
    while (true) {
  ...
  public static ZTauElement partModReduction(
    ...
    BigInteger r0 =
        k.subtract(d0.multiply(q.f944u))
            .subtract(BigInteger.valueOf(2L).multiply(s[1]).multiply(q.f945v));
    BigInteger r1 = s[1].multiply(q.f944u).subtract(s[0].multiply(q.f945v));
    ...
    while (true) {
      if (!r0.equals(ECConstants.ZERO) || !r1.equals(ECConstants.ZERO)) {
        if (!r0.testBit(0)) {
          ...
          if (s) {
            BigInteger r02 = r0.subtract(alpha[uLocal].f944u);
            r1 = r1.subtract(alpha[uLocal].f945v);
            r0 = r02;
          } else {
            BigInteger r03 = r0.add(alpha[uLocal].f944u);
            r1 = r1.add(alpha[uLocal].f945v);
            r0 = r03;
          }
        }
        BigInteger t = r0;
