...
public class SecP192K1Field {
    ...
    /* renamed from: P5 */
    private static final int f948P5 = -1;
    private static final int PExt11 = -1;
    private static final int PInv33 = 4553;

    /* renamed from: P */
    static final int[] f947P = {-4553, -2, -1, -1, -1, -1};
    ...
    public static void add(int[] x, int[] y, int[] z) {
        ...
        if (c != 0 || (z[5] == -1 && Nat192.gte(z, f947P))) {
    ...
    public static void half(int[] x, int[] z) {
        if ((x[0] & 1) == 0) {
            ...
            int c = Nat192.add(x, f947P, z);
            Nat.shiftDownBit(6, z, c);
        }
    }

    public static void inv(int[] x, int[] z) {
        Mod.checkedModOddInverse(f947P, x, z);
    }
    ...
    public static void random(SecureRandom r, int[] z) {
        ...
        } while (Nat.lessThan(6, z, f947P) == 0);
    }
    ...
    public static void reduce32(int x, int[] z) {
        if ((x != 0 && Nat192.mul33WordAdd(PInv33, x, z, 0) != 0) || (z[5] == -1 && Nat192.gte(z, f947P))) {
            Nat.add33To(6, PInv33, z);
        }
    }
