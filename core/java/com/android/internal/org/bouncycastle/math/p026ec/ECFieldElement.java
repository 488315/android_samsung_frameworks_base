...
public abstract class ECFieldElement implements ECConstants {
    ...
    public static class C4596Fp extends AbstractFp {
        ...
        public ECFieldElement sqrt() {
            ...
            while (true) {
                ...
                if (P.compareTo(this.f938q) < 0 && modReduce(P.multiply(P).subtract(fourX)).modPow(legendreExponent, this.f938q).equals(qMinusOne)) {
    ...
    public static class F2m extends AbstractF2m {
        ...
        public boolean equals(Object anObject) {
            ...
            F2m b = (F2m) anObject;
            return this.f936m == b.f936m && this.representation == b.representation && Arrays.areEqual(this.f935ks, b.f935ks) && this.f937x.equals(b.f937x);
        }
