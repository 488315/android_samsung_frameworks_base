...
public class SecP256R1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint b) {
    ...
    SecP256R1FieldElement X1 = (SecP256R1FieldElement) this.f941x;
    SecP256R1FieldElement Y1 = (SecP256R1FieldElement) this.f942y;
    SecP256R1FieldElement X2 = (SecP256R1FieldElement) b.getXCoord();
    SecP256R1FieldElement Y2 = (SecP256R1FieldElement) b.getYCoord();
    SecP256R1FieldElement Z1 = (SecP256R1FieldElement) this.f943zs[0];
    ...
    if (Z1IsOne) {
      ...
      S2 = t3;
      SecP256R1Field.square(Z1.f978x, S2);
      U2 = t2;
      SecP256R1Field.multiply(S2, X2.f978x, U2);
      SecP256R1Field.multiply(S2, Z1.f978x, S2);
      SecP256R1Field.multiply(S2, Y2.f978x, S2);
    }
    ...
    if (Z2IsOne) {
      ...
      SecP256R1Field.square(Z2.f978x, t4);
      SecP256R1Field.multiply(t4, X1.f978x, tt1);
      SecP256R1Field.multiply(t4, Z2.f978x, t4);
      SecP256R1Field.multiply(t4, Y1.f978x, t4);
      S1 = t4;
      S12 = tt1;
    }
    int[] H = Nat256.create();
    ...
    int[] HSquared = X3.f978x;
    SecP256R1Field.square(t2, HSquared);
    int[] iArr = X3.f978x;
    int[] S13 = X3.f978x;
    SecP256R1Field.subtract(iArr, G, S13);
    SecP256R1FieldElement Y3 = new SecP256R1FieldElement(G);
    SecP256R1Field.subtract(t3, X3.f978x, Y3.f978x);
    SecP256R1Field.multiplyAddToExt(Y3.f978x, t2, tt1);
    SecP256R1Field.reduce(tt1, Y3.f978x);
    SecP256R1FieldElement Z3 = new SecP256R1FieldElement(H);
    if (!Z1IsOne) {
      int[] iArr2 = Z3.f978x;
      int[] R = Z1.f978x;
      SecP256R1Field.multiply(iArr2, R, Z3.f978x);
    }
    if (!Z2IsOne) {
      SecP256R1Field.multiply(Z3.f978x, Z2.f978x, Z3.f978x);
    }
  ...
  public ECPoint twice() {
    ...
    SecP256R1Field.square(Y1.f978x, Y1Squared);
    int[] T = Nat256.create();
    SecP256R1Field.square(Y1Squared, T);
    boolean Z1IsOne = Z1.isOne();
    int[] Z1Squared = Z1.f978x;
    if (!Z1IsOne) {
      Z1Squared = t2;
      SecP256R1Field.square(Z1.f978x, Z1Squared);
    }
    SecP256R1Field.subtract(X1.f978x, Z1Squared, t1);
    SecP256R1Field.add(X1.f978x, Z1Squared, t2);
    SecP256R1Field.multiply(t2, t1, t2);
    int c = Nat256.addBothTo(t2, t2, t2);
    SecP256R1Field.reduce32(c, t2);
    SecP256R1Field.multiply(Y1Squared, X1.f978x, Y1Squared);
    ...
    SecP256R1Field.square(t2, X3.f978x);
    SecP256R1Field.subtract(X3.f978x, Y1Squared, X3.f978x);
    SecP256R1Field.subtract(X3.f978x, Y1Squared, X3.f978x);
    SecP256R1FieldElement Y3 = new SecP256R1FieldElement(Y1Squared);
    SecP256R1Field.subtract(Y1Squared, X3.f978x, Y3.f978x);
    SecP256R1Field.multiply(Y3.f978x, t2, Y3.f978x);
    SecP256R1Field.subtract(Y3.f978x, t1, Y3.f978x);
    SecP256R1FieldElement Z3 = new SecP256R1FieldElement(t2);
    SecP256R1Field.twice(Y1.f978x, Z3.f978x);
    if (!Z1IsOne) {
      SecP256R1Field.multiply(Z3.f978x, Z1.f978x, Z3.f978x);
    }
  ...
  public ECPoint negate() {
    ...
    return new SecP256R1Point(this.curve, this.f941x, this.f942y.negate(), this.f943zs);
  }
}
