...
public class SecP384R1Field {
  ...
  /* renamed from: M */
  private static final long f980M = 4294967295L;
  private static final int P11 = -1;
  private static final int PExt23 = -1;

  /* renamed from: P */
  static final int[] f981P = {-1, 0, 0, -1, -2, -1, -1, -1, -1, -1, -1, -1};
  ...
  public static void add(int[] x, int[] y, int[] z) {
    ...
    if (c != 0 || (z[11] == -1 && Nat.gte(12, z, f981P))) {
      addPInvTo(z);
    }
  }
  ...
  public static void half(int[] x, int[] z) {
    if ((x[0] & 1) == 0) {
      ...
      int c = Nat.add(12, x, f981P, z);
      Nat.shiftDownBit(12, z, c);
    }
  }

  public static void inv(int[] x, int[] z) {
    Mod.checkedModOddInverse(f981P, x, z);
  }
  ...
  public static void random(SecureRandom r, int[] z) {
    ...
    } while (Nat.lessThan(12, z, f981P) == 0);
  }
  ...
  public static void reduce32(int x, int[] z) {
    ...
    if ((cc != 0 && Nat.incAt(12, z, 5) != 0) || (z[11] == -1 && Nat.gte(12, z, f981P))) {
      addPInvTo(z);
    }
  }
