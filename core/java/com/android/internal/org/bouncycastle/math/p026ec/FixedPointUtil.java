    ...
    return (FixedPointPreCompInfo)
        c.precompute(
            ...
            new PreCompCallback() { // from class:
                                    // com.android.internal.org.bouncycastle.math.ec.FixedPointUtil.1
              @Override // com.android.internal.org.bouncycastle.math.p026ec.PreCompCallback
              public PreCompInfo precompute(PreCompInfo existing) {
                FixedPointPreCompInfo existingFP =
                    existing instanceof FixedPointPreCompInfo
                        ? (FixedPointPreCompInfo) existing
                        : null;
                ...
                if (!checkExisting(existingFP, n)) {
                  ...
                  result.setLookupTable(
                      ECCurve.this.createCacheSafeLookupTable(lookupTable, 0, lookupTable.length));
