...
public class SecP256R1Field {
    ...
    /* renamed from: M */
    private static final long f974M = 4294967295L;

    /* renamed from: P7 */
    private static final int f976P7 = -1;
    private static final int PExt15s1 = Integer.MAX_VALUE;

    /* renamed from: P */
    static final int[] f975P = {-1, -1, -1, 0, 0, 0, 1, -1};
    private static final int[] PExt = {1, 0, 0, -2, -1, -1, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};

    public static void add(int[] x, int[] y, int[] z) {
        int c = Nat256.add(x, y, z);
        if (c != 0 || (z[7] == -1 && Nat256.gte(z, f975P))) {
            addPInvTo(z);
        }
    }
    ...
    public static void half(int[] x, int[] z) {
        if ((x[0] & 1) == 0) {
            ...
            int c = Nat256.add(x, f975P, z);
            Nat.shiftDownBit(8, z, c);
        }
    }

    public static void inv(int[] x, int[] z) {
        Mod.checkedModOddInverse(f975P, x, z);
    }
    ...
    public static void random(SecureRandom r, int[] z) {
        ...
        } while (Nat.lessThan(8, z, f975P) == 0);
    }
    ...
    public static void reduce32(int x, int[] z) {
        ...
        if (cc != 0 || (z[7] == -1 && Nat256.gte(z, f975P))) {
            addPInvTo(z);
        }
    }
