...
public abstract class Nat256 {
    ...
    public static int addBothTo(int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        long c =
                0
                        + (x[xOff + 0] & 4294967295L)
                        + (y[yOff + 0] & 4294967295L)
                        + (z[zOff + 0] & 4294967295L);
        z[zOff + 0] = (int) c;
        long c2 =
                (c >>> 32)
                        + (x[xOff + 1] & 4294967295L)
                        + (y[yOff + 1] & 4294967295L)
                        + (z[zOff + 1] & 4294967295L);
        z[zOff + 1] = (int) c2;
        long c3 =
                (c2 >>> 32)
                        + (x[xOff + 2] & 4294967295L)
                        + (y[yOff + 2] & 4294967295L)
                        + (z[zOff + 2] & 4294967295L);
        z[zOff + 2] = (int) c3;
        long c4 =
                (c3 >>> 32)
                        + (x[xOff + 3] & 4294967295L)
                        + (y[yOff + 3] & 4294967295L)
                        + (z[zOff + 3] & 4294967295L);
        z[zOff + 3] = (int) c4;
        long c5 =
                (c4 >>> 32)
                        + (x[xOff + 4] & 4294967295L)
                        + (y[yOff + 4] & 4294967295L)
                        + (z[zOff + 4] & 4294967295L);
        z[zOff + 4] = (int) c5;
        long c6 =
                (c5 >>> 32)
                        + (x[xOff + 5] & 4294967295L)
                        + (y[yOff + 5] & 4294967295L)
                        + (z[zOff + 5] & 4294967295L);
        z[zOff + 5] = (int) c6;
        long c7 =
                (c6 >>> 32)
                        + (x[xOff + 6] & 4294967295L)
                        + (y[yOff + 6] & 4294967295L)
                        + (z[zOff + 6] & 4294967295L);
        z[zOff + 6] = (int) c7;
        long c8 =
                (c7 >>> 32)
                        + (x[xOff + 7] & 4294967295L)
                        + (y[yOff + 7] & 4294967295L)
                        + (z[zOff + 7] & 4294967295L);
        z[zOff + 7] = (int) c8;
        return (int) (c8 >>> 32);
    }
    ...
    public static int subBothFrom(int[] x, int[] y, int[] z) {
        ...
        z[5] = (int) c6;
        long c7 =
                (c6 >> 32) + (((z[6] & 4294967295L) - (x[6] & 4294967295L)) - (y[6] & 4294967295L));
        z[6] = (int) c7;
        long c8 =
                (c7 >> 32) + (((z[7] & 4294967295L) - (x[7] & 4294967295L)) - (y[7] & 4294967295L));
        z[7] = (int) c8;
        return (int) (c8 >> 32);
    }
