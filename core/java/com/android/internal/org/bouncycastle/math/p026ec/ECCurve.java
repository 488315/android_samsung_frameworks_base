...
import com.android.internal.org.bouncycastle.math.p026ec.endo.ECEndomorphism;
import com.android.internal.org.bouncycastle.math.p026ec.endo.GLVEndomorphism;
...
public abstract class ECCurve {
  ...
  /* renamed from: a */
  protected ECFieldElement f926a;

  /* renamed from: b */
  protected ECFieldElement f927b;
  ...
  public ECPoint decodePoint(byte[] encoded) {
    ...
    switch (type) {
      ...
      case 4:
        ...
        p =
            validatePoint(
                X2, BigIntegers.fromUnsignedByteArray(encoded, expectedLength + 1, expectedLength));
        break;
      case 6:
      case 7:
        if (encoded.length != (expectedLength * 2) + 1) {
        ...
        BigInteger Y =
            BigIntegers.fromUnsignedByteArray(encoded, expectedLength + 1, expectedLength);
  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
    ...
    return new AbstractECLookupTable() { // from class:
      ...
      @Override // com.android.internal.org.bouncycastle.math.p026ec.AbstractECLookupTable,
                // com.android.internal.org.bouncycastle.math.p026ec.ECLookupTable
      ...
      private ECPoint createPoint(byte[] x, byte[] y) {
        ...
        return eCCurve.createRawPoint(
            eCCurve.fromBigInteger(new BigInteger(1, x)),
  ...
  public abstract static class AbstractFp extends ECCurve {
    ...
    protected ECPoint decompressPoint(int yTilde, BigInteger X1) {
      ...
      ECFieldElement rhs = x.square().add(this.f926a).multiply(x).add(this.f927b);
  ...
  public static class C4595Fp extends AbstractFp {
    private static final int FP_DEFAULT_COORDS = 4;
    ECPoint.C4598Fp infinity;
    ...
    public C4595Fp(BigInteger q, BigInteger a, BigInteger b) {
      this(q, a, b, null, null);
    }

    public C4595Fp(
        BigInteger q, BigInteger a, BigInteger b, BigInteger order, BigInteger cofactor) {
      super(q);
      this.f933q = q;
      this.f934r = ECFieldElement.C4596Fp.calculateResidue(q);
      this.infinity = new ECPoint.C4598Fp(this, null, null);
      this.f926a = fromBigInteger(a);
      this.f927b = fromBigInteger(b);
      this.order = order;
    ...
    protected ECCurve cloneCurve() {
      return new C4595Fp(this.f933q, this.f934r, this.f926a, this.f927b, this.order, this.cofactor);
    }
    ...
    public int getFieldSize() {
      return this.f933q.bitLength();
    }

    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECCurve
    public ECFieldElement fromBigInteger(BigInteger x) {
      return new ECFieldElement.C4596Fp(this.f933q, this.f934r, x);
    }

    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECCurve
    protected ECPoint createRawPoint(ECFieldElement x, ECFieldElement y) {
      return new ECPoint.C4598Fp(this, x, y);
    }

    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECCurve
    protected ECPoint createRawPoint(ECFieldElement x, ECFieldElement y, ECFieldElement[] zs) {
      return new ECPoint.C4598Fp(this, x, y, zs);
    }
    ...
    public ECPoint importPoint(ECPoint p) {
      if (this != p.getCurve() && getCoordinateSystem() == 2 && !p.isInfinity()) {
        switch (p.getCurve().getCoordinateSystem()) {
          ...
          case 3:
          case 4:
            return new ECPoint.C4598Fp(
                this,
                fromBigInteger(p.f941x.toBigInteger()),
                fromBigInteger(p.f942y.toBigInteger()),
                new ECFieldElement[] {fromBigInteger(p.f943zs[0].toBigInteger())});
        }
      }
  ...
  public abstract static class AbstractF2m extends ECCurve {
    ...
    public boolean isKoblitz() {
      return this.order != null
          && this.cofactor != null
          && this.f927b.isOne()
          && (this.f926a.isZero() || this.f926a.isOne());
    }
  ...
  public static class F2m extends AbstractF2m {
    ...
    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECCurve
    public ECFieldElement fromBigInteger(BigInteger x) {
      return new ECFieldElement.F2m(this.f932m, this.f929k1, this.f930k2, this.f931k3, x);
    }
    ...
    public boolean isTrinomial() {
      return this.f930k2 == 0 && this.f931k3 == 0;
    }
    ...
    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECCurve
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
      final int FE_LONGS = (this.f932m + 63) >>> 6;
      final int[] ks =
          isTrinomial()
              ? new int[] {this.f929k1}
              : new int[] {this.f929k1, this.f930k2, this.f931k3};
      final long[] table = new long[len * FE_LONGS * 2];
      int pos = 0;
      for (int i = 0; i < len; i++) {
        ECPoint p = points[off + i];
        ((ECFieldElement.F2m) p.getRawXCoord()).f937x.copyTo(table, pos);
        int pos2 = pos + FE_LONGS;
        ((ECFieldElement.F2m) p.getRawYCoord()).f937x.copyTo(table, pos2);
        pos = pos2 + FE_LONGS;
      }
      return new AbstractECLookupTable() { // from class:
        ...
        private ECPoint createPoint(long[] x, long[] y) {
          ECFieldElement.F2m X = new ECFieldElement.F2m(F2m.this.f932m, ks, new LongArray(x));
          ECFieldElement.F2m Y = new ECFieldElement.F2m(F2m.this.f932m, ks, new LongArray(y));
