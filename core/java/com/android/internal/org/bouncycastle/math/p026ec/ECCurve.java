...
public abstract class ECCurve {
    ...
    public static class C4595Fp extends AbstractFp {
        ...
        public C4595Fp(BigInteger q, BigInteger a, BigInteger b, BigInteger order, BigInteger cofactor) {
            super(q);
            this.f933q = q;
        ...
        protected C4595Fp(BigInteger q, BigInteger r, ECFieldElement a, ECFieldElement b, BigInteger order, BigInteger cofactor) {
            super(q);
            this.f933q = q;
            this.f934r = r;
            this.infinity = new ECPoint.C4598Fp(this, null, null);
        ...
        public ECPoint importPoint(ECPoint p) {
            if (this != p.getCurve() && getCoordinateSystem() == 2 && !p.isInfinity()) {
                switch (p.getCurve().getCoordinateSystem()) {
                    ...
                    case 3:
                    case 4:
                        return new ECPoint.C4598Fp(this, fromBigInteger(p.f941x.toBigInteger()), fromBigInteger(p.f942y.toBigInteger()), new ECFieldElement[]{fromBigInteger(p.f943zs[0].toBigInteger())});
                }
            }
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f927b.isOne() && (this.f926a.isZero() || this.f926a.isOne());
        }
    ...
    public static class F2m extends AbstractF2m {
        ...
        @Override // com.android.internal.org.bouncycastle.math.p026ec.ECCurve
        protected ECCurve cloneCurve() {
            return new F2m(this.f932m, this.f929k1, this.f930k2, this.f931k3, this.f926a, this.f927b, this.order, this.cofactor);
        }
        ...
        public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
            ...
            final int[] ks = isTrinomial() ? new int[]{this.f929k1} : new int[]{this.f929k1, this.f930k2, this.f931k3};
