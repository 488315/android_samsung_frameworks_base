...
public class SecP224R1Curve extends ECCurve.AbstractFp {
  ...
  /* renamed from: q */
  public static final BigInteger f962q = SecP224R1FieldElement.f966Q;
  ...
  public SecP224R1Curve() {
    ...
    this.f926a =
        fromBigInteger(
            new BigInteger(
                1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE")));
    this.f927b =
        fromBigInteger(
            new BigInteger(
                1, Hex.decodeStrict("B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4")));
    this.order =
        new BigInteger(
            1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D"));
  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
    ...
    for (int i = 0; i < len; i++) {
      ...
      Nat224.copy(((SecP224R1FieldElement) p.getRawXCoord()).f967x, 0, table, pos);
      int pos2 = pos + 7;
      Nat224.copy(((SecP224R1FieldElement) p.getRawYCoord()).f967x, 0, table, pos2);
      pos = pos2 + 7;
    }
  ...
  @Override // com.android.internal.org.bouncycastle.math.ec.ECCurve.AbstractFp,
            // com.android.internal.org.bouncycastle.math.p026ec.ECCurve
