...
public abstract class WNafUtil {
    private static final int[] DEFAULT_WINDOW_SIZE_CUTOFFS = {
        ...
        121,
        337,
        MetricsProto.MetricsEvent.ACTION_APPOP_DENIED_REQUEST_INSTALL_PACKAGES,
        2305
    };
    ...
    public static void configureBasepoint(ECPoint p) {
        ...
        c.precompute(
                ...
                new PreCompCallback() { // from class:
                                        // com.android.internal.org.bouncycastle.math.ec.WNafUtil.1
                    @Override // com.android.internal.org.bouncycastle.math.ec.PreCompCallback
                    public PreCompInfo precompute(PreCompInfo existing) {
                        WNafPreCompInfo existingWNaf =
                                existing instanceof WNafPreCompInfo
                                        ? (WNafPreCompInfo) existing
                                        : null;
    ...
    public static WNafPreCompInfo precompute(
            final ECPoint p, final int minWidth, final boolean includeNegated) {
        ...
        return (WNafPreCompInfo)
                c.precompute(
                        ...
                        PRECOMP_NAME,
                        new PreCompCallback() { // from class:
                                                // com.android.internal.org.bouncycastle.math.ec.WNafUtil.2
                            @Override // com.android.internal.org.bouncycastle.math.ec.PreCompCallback
                            public PreCompInfo precompute(PreCompInfo existing) {
                                int pos;
                                WNafPreCompInfo existingWNaf =
                                ...
                                if (checkExisting(
                                        existingWNaf, width, 1 << (width - 2), includeNegated)) {
                                ...
                                if (includeNegated) {
                                    if (preCompNeg == null) {
                                        ...
                                        if (pos < reqPreCompLen) {
                                            preCompNeg =
                                                    WNafUtil.resizeTable(preCompNeg, reqPreCompLen);
                                        }
                                    }
                            ...
                            private boolean checkExisting(
                                    ...
                                    int width,
                                    int reqPreCompLen,
                                    boolean includeNegated2) {
                                return existingWNaf != null
                                        && existingWNaf.getWidth()
                                                >= Math.max(existingWNaf.getConfWidth(), width)
                                        && checkTable(existingWNaf.getPreComp(), reqPreCompLen)
                                        && (!includeNegated2
                                                || checkTable(
                                                        existingWNaf.getPreCompNeg(),
                                                        reqPreCompLen));
                            }
    ...
    public static WNafPreCompInfo precomputeWithPointMap(
            ...
            final WNafPreCompInfo fromWNaf,
        ...
        return (WNafPreCompInfo)
                c.precompute(
                        ...
                        PRECOMP_NAME,
                        new PreCompCallback() { // from class:
                                                // com.android.internal.org.bouncycastle.math.ec.WNafUtil.3
                            @Override // com.android.internal.org.bouncycastle.math.ec.PreCompCallback
                            public PreCompInfo precompute(PreCompInfo existing) {
                                WNafPreCompInfo existingWNaf =
                                        existing instanceof WNafPreCompInfo
                                ...
                                WNafPreCompInfo result = new WNafPreCompInfo();
                                result.setPromotionCountdown(
                                        WNafPreCompInfo.this.getPromotionCountdown());
