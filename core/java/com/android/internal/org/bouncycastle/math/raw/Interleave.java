...
public class Interleave {
    ...
    long x2 =
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(
                Bits.bitPermuteStep(
                    Bits.bitPermuteStep(
                        Bits.bitPermuteStep(x, 4294901760L, 16), 280375465148160L, 8),
                    67555025218437360L,
                    4),
                868082074056920076L,
                2),
  ...
  public static int shuffle(int x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(Bits.bitPermuteStep(x, 65280, 8), 15728880, 4), 202116108, 2),
        572662306,
        1);
  }
  ...
  public static long shuffle(long x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(
                Bits.bitPermuteStep(Bits.bitPermuteStep(x, 4294901760L, 16), 280375465148160L, 8),
                67555025218437360L,
                4),
            868082074056920076L,
            2),
  ...
  public static int shuffle2(int x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(Bits.bitPermuteStep(x, 11141290, 7), 52428, 14), 15728880, 4),
        65280,
        8);
  }
  ...
  public static long shuffle2(long x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(Bits.bitPermuteStep(x, 4278255360L, 24), 57421771435671756L, 6),
            264913582878960L,
            12),
        723401728380766730L,
        3);
  ...
  public static long shuffle3(long x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(Bits.bitPermuteStep(x, 47851476196393130L, 7), 225176545447116L, 14),
        4042322160L,
        28);
  }
  ...
  public static int unshuffle(int x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(Bits.bitPermuteStep(x, 572662306, 1), 202116108, 2), 15728880, 4),
        65280,
        8);
  }
  ...
  public static long unshuffle(long x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(
                Bits.bitPermuteStep(
                    Bits.bitPermuteStep(x, 2459565876494606882L, 1), 868082074056920076L, 2),
                67555025218437360L,
                4),
            280375465148160L,
            8),
  ...
  public static int unshuffle2(int x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(Bits.bitPermuteStep(x, 65280, 8), 15728880, 4), 52428, 14),
        11141290,
        7);
  }
  ...
  public static long unshuffle2(long x) {
    return Bits.bitPermuteStep(
        Bits.bitPermuteStep(
            Bits.bitPermuteStep(
                Bits.bitPermuteStep(x, 723401728380766730L, 3), 264913582878960L, 12),
            57421771435671756L,
            6),
        4278255360L,
        24);
