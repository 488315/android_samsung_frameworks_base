...
public class SecP256K1Curve extends ECCurve.AbstractFp {
  ...
  /* renamed from: q */
  public static final BigInteger f968q = SecP256K1FieldElement.f971Q;
  ...
  public SecP256K1Curve() {
    ...
    this.f927b = fromBigInteger(BigInteger.valueOf(7L));
    this.order =
        new BigInteger(
            1,
  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
    ...
    for (int i = 0; i < len; i++) {
      ...
      Nat256.copy(((SecP256K1FieldElement) p.getRawXCoord()).f972x, 0, table, pos);
      int pos2 = pos + 8;
      Nat256.copy(((SecP256K1FieldElement) p.getRawYCoord()).f972x, 0, table, pos2);
      pos = pos2 + 8;
    }
