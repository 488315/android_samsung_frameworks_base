...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f966Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001"));

    /* renamed from: x */
    protected int[] f967x;

    public SecP224R1FieldElement(BigInteger x) {
        if (x == null || x.signum() < 0 || x.compareTo(f966Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224R1FieldElement");
        }
        this.f967x = SecP224R1Field.fromBigInteger(x);
    }

    public SecP224R1FieldElement() {
        this.f967x = Nat224.create();
    }
    ...
    public boolean isZero() {
        return Nat224.isZero(this.f967x);
    }

    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f967x);
    }

    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f967x, 0) == 1;
    }

    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f967x);
    }
    ...
    public int getFieldSize() {
        return f966Q.bitLength();
    }

    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECFieldElement
    public ECFieldElement add(ECFieldElement b) {
        int[] z = Nat224.create();
        SecP224R1Field.add(this.f967x, ((SecP224R1FieldElement) b).f967x, z);
    ...
    public ECFieldElement addOne() {
        int[] z = Nat224.create();
        SecP224R1Field.addOne(this.f967x, z);
        return new SecP224R1FieldElement(z);
    }
    ...
    public ECFieldElement subtract(ECFieldElement b) {
        int[] z = Nat224.create();
        SecP224R1Field.subtract(this.f967x, ((SecP224R1FieldElement) b).f967x, z);
        return new SecP224R1FieldElement(z);
    }
    ...
    public ECFieldElement multiply(ECFieldElement b) {
        int[] z = Nat224.create();
        SecP224R1Field.multiply(this.f967x, ((SecP224R1FieldElement) b).f967x, z);
        return new SecP224R1FieldElement(z);
    }
    ...
    public ECFieldElement divide(ECFieldElement b) {
        int[] z = Nat224.create();
        SecP224R1Field.inv(((SecP224R1FieldElement) b).f967x, z);
        SecP224R1Field.multiply(z, this.f967x, z);
        return new SecP224R1FieldElement(z);
    }
    ...
    public ECFieldElement negate() {
        int[] z = Nat224.create();
        SecP224R1Field.negate(this.f967x, z);
        return new SecP224R1FieldElement(z);
    }
    ...
    public ECFieldElement square() {
        int[] z = Nat224.create();
        SecP224R1Field.square(this.f967x, z);
        return new SecP224R1FieldElement(z);
    }
    ...
    public ECFieldElement invert() {
        int[] z = Nat224.create();
        SecP224R1Field.inv(this.f967x, z);
        return new SecP224R1FieldElement(z);
    }
    ...
    public ECFieldElement sqrt() {
        ...
        int[] r = Mod.random(SecP224R1Field.f964P);
        int[] t = Nat224.create();
        if (!isSquare(c)) {
            return null;
        }
    ...
    public boolean equals(Object other) {
        ...
        return Nat224.m205eq(this.f967x, o.f967x);
    }

    public int hashCode() {
        return f966Q.hashCode() ^ Arrays.hashCode(this.f967x, 0, 7);
    }
    ...
    /* renamed from: RM */
    private static void m200RM(int[] nc, int[] d0, int[] e0, int[] d1, int[] e1, int[] f1, int[] t) {
    ...
    /* renamed from: RP */
    private static void m201RP(int[] nc, int[] d1, int[] e1, int[] f1, int[] t) {
        Nat224.copy(nc, f1);
        ...
        for (int i = 0; i < 7; i++) {
            ...
            m200RM(nc, d0, e0, d1, e1, f1, t);
        }
    }

    /* renamed from: RS */
    private static void m202RS(int[] d, int[] e, int[] f, int[] t) {
