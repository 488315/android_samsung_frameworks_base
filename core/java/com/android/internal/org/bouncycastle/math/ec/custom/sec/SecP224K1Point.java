...
public class SecP224K1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint b) {
    ...
    SecP224K1FieldElement X1 = (SecP224K1FieldElement) this.f941x;
    SecP224K1FieldElement Y1 = (SecP224K1FieldElement) this.f942y;
    SecP224K1FieldElement X2 = (SecP224K1FieldElement) b.getXCoord();
    SecP224K1FieldElement Y2 = (SecP224K1FieldElement) b.getYCoord();
    SecP224K1FieldElement Z1 = (SecP224K1FieldElement) this.f943zs[0];
    ...
    if (Z1IsOne) {
      ...
      S2 = t3;
      SecP224K1Field.square(Z1.f961x, S2);
      U2 = t2;
      SecP224K1Field.multiply(S2, X2.f961x, U2);
      SecP224K1Field.multiply(S2, Z1.f961x, S2);
      SecP224K1Field.multiply(S2, Y2.f961x, S2);
    }
    ...
    if (Z2IsOne) {
      ...
      SecP224K1Field.square(Z2.f961x, t4);
      SecP224K1Field.multiply(t4, X1.f961x, tt1);
      SecP224K1Field.multiply(t4, Z2.f961x, t4);
      SecP224K1Field.multiply(t4, Y1.f961x, t4);
      S1 = t4;
      S12 = tt1;
    }
    int[] H = Nat224.create();
    ...
    int[] HSquared = X3.f961x;
    SecP224K1Field.square(t2, HSquared);
    int[] iArr = X3.f961x;
    int[] S13 = X3.f961x;
    SecP224K1Field.subtract(iArr, G, S13);
    SecP224K1FieldElement Y3 = new SecP224K1FieldElement(G);
    SecP224K1Field.subtract(t3, X3.f961x, Y3.f961x);
    SecP224K1Field.multiplyAddToExt(Y3.f961x, t2, tt1);
    SecP224K1Field.reduce(tt1, Y3.f961x);
    SecP224K1FieldElement Z3 = new SecP224K1FieldElement(H);
    if (!Z1IsOne) {
      int[] iArr2 = Z3.f961x;
      int[] R = Z1.f961x;
      SecP224K1Field.multiply(iArr2, R, Z3.f961x);
    }
    if (!Z2IsOne) {
      SecP224K1Field.multiply(Z3.f961x, Z2.f961x, Z3.f961x);
    }
  ...
  public ECPoint twice() {
    ...
    SecP224K1Field.square(Y1.f961x, Y1Squared);
    int[] T = Nat224.create();
    SecP224K1Field.square(Y1Squared, T);
    int[] M = Nat224.create();
    SecP224K1Field.square(X1.f961x, M);
    int c = Nat224.addBothTo(M, M, M);
    SecP224K1Field.reduce32(c, M);
    SecP224K1Field.multiply(Y1Squared, X1.f961x, Y1Squared);
    ...
    SecP224K1Field.square(M, X3.f961x);
    SecP224K1Field.subtract(X3.f961x, Y1Squared, X3.f961x);
    SecP224K1Field.subtract(X3.f961x, Y1Squared, X3.f961x);
    SecP224K1FieldElement Y3 = new SecP224K1FieldElement(Y1Squared);
    SecP224K1Field.subtract(Y1Squared, X3.f961x, Y3.f961x);
    SecP224K1Field.multiply(Y3.f961x, M, Y3.f961x);
    SecP224K1Field.subtract(Y3.f961x, t1, Y3.f961x);
    SecP224K1FieldElement Z3 = new SecP224K1FieldElement(M);
    SecP224K1Field.twice(Y1.f961x, Z3.f961x);
    if (!Z1.isOne()) {
      SecP224K1Field.multiply(Z3.f961x, Z1.f961x, Z3.f961x);
    }
  ...
  public ECPoint negate() {
    ...
    return new SecP224K1Point(this.curve, this.f941x, this.f942y.negate(), this.f943zs);
  }
}
