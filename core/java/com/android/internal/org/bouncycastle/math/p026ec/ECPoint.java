...
public abstract class ECPoint {
    ...
    public static class C4598Fp extends AbstractFp {
        ...
        public ECPoint timesPow2(int e) {
            ...
            ECFieldElement X1 = this.f941x;
            ECFieldElement Z1 = this.f943zs.length < 1 ? curve.fromBigInteger(ECConstants.ONE) : this.f943zs[0];
            if (!Z1.isOne()) {
                switch (coord) {
                    case 0:
                        break;
            ...
            switch (coord) {
                ...
                case 1:
                    return new C4598Fp(curve, X1.multiply(Z1), Y1, new ECFieldElement[]{Z1.multiply(Z1.square())});
                case 2:
