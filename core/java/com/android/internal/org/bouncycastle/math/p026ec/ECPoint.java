...
public abstract class ECPoint {
  ...
  /* renamed from: x */
  protected ECFieldElement f941x;

  /* renamed from: y */
  protected ECFieldElement f942y;

  /* renamed from: zs */
  protected ECFieldElement[] f943zs;
  ...
  protected boolean satisfiesOrder() {
    BigInteger n;
    return ECConstants.ONE.equals(this.curve.getCofactor())
        || (n = this.curve.getOrder()) == null
        || ECAlgorithms.referenceMultiply(this, n).isInfinity();
  }
  ...
  public ECFieldElement getZCoord(int index) {
    if (index >= 0) {
      ECFieldElement[] eCFieldElementArr = this.f943zs;
  ...
  public boolean isNormalized() {
    ...
    return coord == 0 || coord == 5 || isInfinity() || this.f943zs[0].isOne();
  }
  ...
  public boolean isInfinity() {
    if (this.f941x != null && this.f942y != null) {
      ECFieldElement[] eCFieldElementArr = this.f943zs;
            ...
            getCurve()
                .precompute(
                    ...
                    new PreCompCallback() { // from class:
                                            // com.android.internal.org.bouncycastle.math.ec.ECPoint.1
                      @Override // com.android.internal.org.bouncycastle.math.p026ec.PreCompCallback
                      public PreCompInfo precompute(PreCompInfo existing) {
                        ValidityPrecompInfo info =
                            existing instanceof ValidityPrecompInfo
                                ? (ValidityPrecompInfo) existing
                                : null;
                        if (info == null) {
  ...
  public ECPoint scaleX(ECFieldElement scale) {
    ...
    return getCurve()
        .createRawPoint(getRawXCoord().multiply(scale), getRawYCoord(), getRawZCoords());
  }
  ...
  public ECPoint scaleXNegateY(ECFieldElement scale) {
    ...
    return getCurve()
        .createRawPoint(getRawXCoord().multiply(scale), getRawYCoord().negate(), getRawZCoords());
  }
  ...
  public ECPoint scaleY(ECFieldElement scale) {
    ...
    return getCurve()
        .createRawPoint(getRawXCoord(), getRawYCoord().multiply(scale), getRawZCoords());
  }
  ...
  public ECPoint scaleYNegateX(ECFieldElement scale) {
    ...
    return getCurve()
        .createRawPoint(getRawXCoord().negate(), getRawYCoord().multiply(scale), getRawZCoords());
  }
  ...
  public String toString() {
    ...
    for (int i = 0; i < this.f943zs.length; i++) {
      sb.append(',');
      sb.append(this.f943zs[i]);
    }
    sb.append(')');
    return sb.toString();
  }
  ...
  public abstract static class AbstractFp extends ECPoint {
    ...
    protected boolean satisfiesCurveEquation() {
      ECFieldElement X = this.f941x;
      ECFieldElement Y = this.f942y;
      ...
      switch (getCurveCoordinateSystem()) {
        case 0:
          break;
        case 1:
          ECFieldElement Z = this.f943zs[0];
          if (!Z.isOne()) {
        ...
        case 3:
        case 4:
          ECFieldElement Z4 = this.f943zs[0];
          if (!Z4.isOne()) {
  ...
  public static class C4598Fp extends AbstractFp {
    C4598Fp(ECCurve curve, ECFieldElement x, ECFieldElement y) {
      super(curve, x, y);
    }

    C4598Fp(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs) {
      super(curve, x, y, zs);
    }

    @Override // com.android.internal.org.bouncycastle.math.p026ec.ECPoint
    protected ECPoint detach() {
      return new C4598Fp(null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public ECPoint add(ECPoint b) {
      ...
      ECFieldElement X1 = this.f941x;
      ECFieldElement Y12 = this.f942y;
      ECFieldElement X2 = b.f941x;
      ECFieldElement Y2 = b.f942y;
      switch (coord) {
        case 0:
          ...
          return new C4598Fp(curve, X3, Y33);
        case 1:
          ECFieldElement Z1 = this.f943zs[0];
          ECFieldElement Z2 = b.f943zs[0];
          ...
          return new C4598Fp(curve, X32, Y34, new ECFieldElement[] {Z32});
        case 2:
        case 4:
          ECFieldElement Z12 = this.f943zs[0];
          ECFieldElement Z22 = b.f943zs[0];
          ...
          return new C4598Fp(curve, Y1, Y3, zs);
        case 3:
        default:
          throw new IllegalStateException("unsupported coordinate system");
      }
    ...
    public ECPoint twice() {
      ...
      switch (coord) {
        case 0:
          ...
          return new C4598Fp(curve, X3, Y3);
        case 1:
          ECFieldElement Z1 = this.f943zs[0];
          boolean Z1IsOne = Z1.isOne();
          ...
          return new C4598Fp(curve, X32, Y32, new ECFieldElement[] {two(_4sSquared).multiply(s)});
        case 2:
          ECFieldElement Z12 = this.f943zs[0];
          boolean Z1IsOne2 = Z12.isOne();
          ...
          return new C4598Fp(curve, X33, Y33, new ECFieldElement[] {Z3});
        case 3:
        default:
          throw new IllegalStateException("unsupported coordinate system");
        case 4:
    ...
    public ECPoint twicePlus(ECPoint b) {
      ...
      switch (coord) {
        case 0:
          ...
          return new C4598Fp(curve, X4, Y4);
        case 4:
    ...
    public ECPoint timesPow2(int e) {
      ...
      ECFieldElement X1 = this.f941x;
      ECFieldElement Z1 =
          this.f943zs.length < 1 ? curve.fromBigInteger(ECConstants.ONE) : this.f943zs[0];
      if (!Z1.isOne()) {
        switch (coord) {
          case 0:
            break;
      ...
      switch (coord) {
        case 0:
          ...
          ECFieldElement zInv2 = zInv.square();
          ECFieldElement zInv3 = zInv2.multiply(zInv);
          return new C4598Fp(curve, X1.multiply(zInv2), Y1.multiply(zInv3));
        case 1:
          return new C4598Fp(
              curve, X1.multiply(Z1), Y1, new ECFieldElement[] {Z1.multiply(Z1.square())});
        case 2:
          return new C4598Fp(curve, X1, Y1, new ECFieldElement[] {Z1});
        case 3:
        default:
          throw new IllegalStateException("unsupported coordinate system");
        case 4:
          return new C4598Fp(curve, X1, Y1, new ECFieldElement[] {Z1, W1});
      }
    }
    ...
    public ECPoint negate() {
      ...
      int coord = curve.getCoordinateSystem();
      if (coord != 0) {
        return new C4598Fp(curve, this.f941x, this.f942y.negate(), this.f943zs);
      }
      return new C4598Fp(curve, this.f941x, this.f942y.negate());
    }
    ...
    protected ECFieldElement getJacobianModifiedW() {
      ECFieldElement W = this.f943zs[1];
      if (W == null) {
        ECFieldElement[] eCFieldElementArr = this.f943zs;
        ECFieldElement W2 = calculateJacobianModifiedW(this.f943zs[0], null);
    ...
    protected C4598Fp twiceJacobianModified(boolean calculateW) {
      ECFieldElement X1 = this.f941x;
      ECFieldElement Y1 = this.f942y;
      ECFieldElement Z1 = this.f943zs[0];
      ...
      return new C4598Fp(getCurve(), X3, Y3, new ECFieldElement[] {Z3, W3});
    }
  }
  ...
  public abstract static class AbstractF2m extends ECPoint {
    ...
    protected boolean satisfiesCurveEquation() {
      ...
      if (coord == 6) {
        ...
        if (X.isZero()) {
          ECFieldElement lhs = this.f942y.square();
      ...
      ECFieldElement Z3 = this.f942y;
      ECFieldElement lhs2 = Z3.add(X).multiply(Z3);
      switch (coord) {
        case 0:
          break;
        case 1:
          ECFieldElement Z5 = this.f943zs[0];
          if (!Z5.isOne()) {
    ...
    protected boolean satisfiesOrder() {
      ...
      if (ECConstants.FOUR.equals(cofactor)) {
        ...
        ECFieldElement L =
            ((ECCurve.AbstractF2m) this.curve).solveQuadraticEquation(X.add(this.curve.getA()));
        if (L == null) {
          return false;
        }
    ...
    public AbstractF2m tau() {
      ...
      switch (coord) {
        ...
        case 6:
          ...
          ECFieldElement Z1 = this.f943zs[0];
          return (AbstractF2m)
              curve.createRawPoint(X1.square(), Y12.square(), new ECFieldElement[] {Z1.square()});
        case 2:
        case 3:
        case 4:
        default:
        ...
        case 6:
          ...
          return (AbstractF2m)
              curve.createRawPoint(
                  X1.squarePow(pow), Y12.squarePow(pow), new ECFieldElement[] {Z1.squarePow(pow)});
        case 2:
        case 3:
        case 4:
        default:
  ...
  public static class F2m extends AbstractF2m {
    ...
    public ECPoint add(ECPoint b) {
      ...
      switch (coord) {
        ...
        case 6:
          ...
          ECFieldElement L1 = this.f942y;
          ECFieldElement Z12 = this.f943zs[0];
          ECFieldElement L2 = b.f942y;
          ECFieldElement Z22 = b.f943zs[0];
    ...
    public ECPoint twice() {
      ...
      switch (coord) {
        case 0:
          ECFieldElement L1 = this.f942y.divide(X1).add(X1);
    ...
    public ECPoint negate() {
      ...
      switch (getCurveCoordinateSystem()) {
        ...
        case 1:
          ECFieldElement L = this.f942y;
          return new F2m(this.curve, X, L.add(X), new ECFieldElement[] {this.f943zs[0]});
        case 2:
        case 3:
        case 4:
        default:
          throw new IllegalStateException("unsupported coordinate system");
        case 5:
          ECFieldElement L2 = this.f942y;
          return new F2m(this.curve, X, L2.addOne());
        case 6:
          ECFieldElement L3 = this.f942y;
          ECFieldElement Z = this.f943zs[0];
