...
public class MessagingImageMessage extends ImageView implements MessagingMessage {
    ...
    public MessagingImageMessage(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mPath = new Path();
        this.mMinImageHeight = context.getResources().getDimensionPixelSize(C4337R.dimen.messaging_image_min_size);
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(C4337R.dimen.messaging_image_max_height);
        this.mMaxImageHeight = dimensionPixelSize;
        this.mImageRounding = context.getResources().getDimensionPixelSize(C4337R.dimen.messaging_image_rounding);
        this.mExtraSpacing = context.getResources().getDimensionPixelSize(C4337R.dimen.messaging_image_extra_spacing);
    ...
    static MessagingMessage createMessage(IMessagingLayout layout, Notification.MessagingStyle.Message m, ImageResolver resolver) {
        ...
        if (createdMessage == null) {
            createdMessage = (MessagingImageMessage) LayoutInflater.from(layout.getContext()).inflate(C4337R.layout.notification_template_messaging_image_message, (ViewGroup) messagingLinearLayout, false);
