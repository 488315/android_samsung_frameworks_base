...
public class ScrollingTabContainerView extends HorizontalScrollView
  ...
  public void animateToTab(int position) {
    ...
    Runnable runnable2 =
        new Runnable() { // from class: com.android.internal.widget.ScrollingTabContainerView.1
          @Override // java.lang.Runnable
          public void run() {
            int scrollPos =
                tabView.getLeft()
                    - ((ScrollingTabContainerView.this.getWidth() - tabView.getWidth()) / 2);
  ...
  private class TabAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      if (convertView == null) {
        ...
        return scrollingTabContainerView.createTabView(
            scrollingTabContainerView.mContext, (ActionBar.Tab) getItem(position), true);
      }
