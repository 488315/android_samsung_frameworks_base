...
public class NotificationActionListLayout extends LinearLayout {
  ...
  public NotificationActionListLayout(
    ...
    this.mCollapsibleIndentDimen = C4337R.dimen.notification_actions_padding_start;
              ...
              maxPriorityWidth2 =
                  getResources()
                      .getDimensionPixelSize(
                          C4337R.dimen.notification_actions_collapsed_priority_width);
            }
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    int innerWidth =
        (View.MeasureSpec.getSize(widthMeasureSpec) - this.mPaddingLeft) - this.mPaddingRight;
  ...
  protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    while (i < count) {
      ...
      if (child.getVisibility() == 8) {
        ...
        int childTop =
            ((paddingTop2 + ((innerHeight - childHeight) / 2)) + lp.topMargin) - lp.bottomMargin;
        isLayoutRtl = isLayoutRtl2;
  ...
  private void updateHeights() {
    int inset = getResources().getDimensionPixelSize(C4337R.dimen.button_inset_vertical_material);
    this.mEmphasizedPaddingTop =
        getResources().getDimensionPixelSize(C4337R.dimen.notification_content_margin) - inset;
    int dimensionPixelSize =
        getResources().getDimensionPixelSize(C4337R.dimen.notification_content_margin_end) - inset;
    this.mEmphasizedPaddingBottom = dimensionPixelSize;
    this.mEmphasizedHeight =
        this.mEmphasizedPaddingTop
            + dimensionPixelSize
            + getResources()
                .getDimensionPixelSize(C4337R.dimen.notification_action_emphasized_height);
    this.mRegularHeight =
        getResources().getDimensionPixelSize(C4337R.dimen.notification_action_list_height);
  }
  ...
  static final class TextViewInfo {
    ...
    boolean needsRebuild() {
      return (this.mTextView.getText().length() == this.mTextLength
              && NotificationActionListLayout.isPriority(this.mTextView) == this.mIsPriority)
          ? false
          : true;
    }
  }
