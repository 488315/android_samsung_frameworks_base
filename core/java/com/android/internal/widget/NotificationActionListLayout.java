...
public class NotificationActionListLayout extends LinearLayout {
                ...
                if (!constrained) {
                    ...
                    if (isPriority && collapsePriorityActions) {
                        if (maxPriorityWidth2 == 0) {
                            maxPriorityWidth2 = getResources().getDimensionPixelSize(C4337R.dimen.notification_actions_collapsed_priority_width);
                        }
    ...
    private void updateHeights() {
        ...
        this.mEmphasizedPaddingTop = getResources().getDimensionPixelSize(C4337R.dimen.notification_content_margin) - inset;
        int dimensionPixelSize = getResources().getDimensionPixelSize(C4337R.dimen.notification_content_margin_end) - inset;
        this.mEmphasizedPaddingBottom = dimensionPixelSize;
        this.mEmphasizedHeight = this.mEmphasizedPaddingTop + dimensionPixelSize + getResources().getDimensionPixelSize(C4337R.dimen.notification_action_emphasized_height);
        this.mRegularHeight = getResources().getDimensionPixelSize(C4337R.dimen.notification_action_list_height);
    }
