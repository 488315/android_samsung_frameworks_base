...
public class ToolbarWidgetWrapper implements DecorToolbar {
  ...
  public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
    this(toolbar, style, C4337R.string.action_bar_up_description);
  }
  ...
  public ToolbarWidgetWrapper(
    ...
    TypedArray a =
        toolbar.getContext().obtainStyledAttributes(null, C4337R.styleable.ActionBar, 16843470, 0);
    ...
    this.mToolbar.setNavigationOnClickListener(
        new View
            .OnClickListener() { // from class: com.android.internal.widget.ToolbarWidgetWrapper.1
  ...
  public void initProgress() {
    Log.m98i(TAG, "Progress display unsupported");
  }
  ...
  public void setMenu(Menu menu, MenuPresenter.Callback cb) {
    if (this.mActionMenuPresenter == null) {
      ...
      actionMenuPresenter.setId(C4337R.id.action_menu_presenter);
    }
  ...
  public Animator setupAnimatorToVisibility(int visibility, long duration) {
    if (visibility == 8) {
      ObjectAnimator anim =
          ObjectAnimator.ofFloat(this.mToolbar, (Property<Toolbar, Float>) View.ALPHA, 1.0f, 0.0f);
    ...
    if (visibility == 0) {
      ObjectAnimator anim2 =
          ObjectAnimator.ofFloat(this.mToolbar, (Property<Toolbar, Float>) View.ALPHA, 0.0f, 1.0f);
