...
public class PeopleHelper {
  ...
  public void init(Context context) {
    ...
    this.mAvatarSize =
        context.getResources().getDimensionPixelSize(C4337R.dimen.messaging_avatar_size);
  ...
  public void animateViewForceHidden(final CachingIconView view, final boolean forceHidden) {
    ...
    view.animate()
        ...
        .setInterpolator(
            forceHidden ? MessagingPropertyAnimator.ALPHA_OUT : MessagingPropertyAnimator.ALPHA_IN)
        .setDuration(160L);
  ...
  public Icon createAvatarSymbol(CharSequence name, String symbol, int layoutColor) {
    ...
    if (symbol.isEmpty()
      ...
      Icon avatarIcon = Icon.createWithResource(this.mContext, C4337R.drawable.messaging_user);
