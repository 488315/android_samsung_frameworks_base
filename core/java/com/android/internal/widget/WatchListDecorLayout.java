    ...
    if (listView != null) {
      ...
      int paddingTop =
          Math.max(
              ...
              measureAndGetHeight(this.mTopPanel, widthMeasureSpec, heightMeasureSpec));
      int paddingBottom =
          Math.max(
              this.mListView.getPaddingBottom(),
              measureAndGetHeight(this.mBottomPanel, widthMeasureSpec, heightMeasureSpec));
      if (paddingTop != this.mListView.getPaddingTop()
        ...
        listView2.setPadding(
            listView2.getPaddingLeft(),
            paddingTop,
    ...
    if (this.mTopPanel != null) {
      if (listView.getChildCount() > 0) {
        if (this.mListView.getFirstVisiblePosition() == 0) {
          ...
          setScrolling(
              this.mTopPanel,
              (firstChild.getY() - this.mTopPanel.getHeight()) - this.mTopPanel.getTop());
        } else {
      ...
      if (this.mListView.getChildCount() > 0) {
        if (this.mListView.getLastVisiblePosition() >= this.mListView.getCount() - 1) {
          ...
          setScrolling(
              this.mBottomPanel,
              Math.max(
                  0.0f, (lastChild.getY() + lastChild.getHeight()) - this.mBottomPanel.getTop()));
          return;
        } else {
