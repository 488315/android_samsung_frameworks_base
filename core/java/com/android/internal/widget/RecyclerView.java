...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
  ...
  public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    this.mViewInfoProcessCallback =
        new ViewInfoStore
            .ProcessCallback() { // from class: com.android.internal.widget.RecyclerView.4
    ...
    if (attrs != null) {
      TypedArray a2 =
          context.obtainStyledAttributes(attrs, C4337R.styleable.RecyclerView, defStyle, 0);
    ...
    context.obtainStyledAttributes(attrs, C4337R.styleable.EdgeEffect).recycle();
      ...
      if (className2.length() != 0) {
        ...
        try {
          ...
          try {
            ...
            constructorArgs =
                new Object[] {
                  context, attrs, Integer.valueOf(defStyleAttr), Integer.valueOf(defStyleRes)
                };
            ...
            try {
              ...
              throw new IllegalStateException(
                  attrs.getPositionDescription() + ": Error creating LayoutManager " + className3,
                  e1);
            }
          }
          ...
          throw new IllegalStateException(
              attrs.getPositionDescription() + ": Class is not a LayoutManager " + className3, e2);
        } catch (ClassNotFoundException e3) {
          throw new IllegalStateException(
              attrs.getPositionDescription() + ": Unable to find LayoutManager " + className3, e3);
  ...
  private void initChildrenHelper() {
    this.mChildHelper =
        new ChildHelper(
            new ChildHelper.Callback() { // from class: com.android.internal.widget.RecyclerView.5
  ...
  void initAdapterManager() {
    this.mAdapterHelper =
        new AdapterHelper(
            new AdapterHelper.Callback() { // from class: com.android.internal.widget.RecyclerView.6
                ...
                switch (op.cmd) {
                  ...
                  case 4:
                    RecyclerView.this.mLayout.onItemsUpdated(
                        RecyclerView.this, op.positionStart, op.itemCount, op.payload);
                    break;
                  case 8:
                    RecyclerView.this.mLayout.onItemsMoved(
                        RecyclerView.this, op.positionStart, op.itemCount, 1);
                    break;
                }
              }
  ...
  public void scrollToPosition(int position) {
    ...
    if (layoutManager == null) {
      Log.m96e(
          TAG,
          "Cannot scroll to position a LayoutManager set. Call setLayoutManager with a non-null"
              + " argument.");
    } else {
  ...
  public void smoothScrollToPosition(int position) {
    ...
    if (layoutManager == null) {
      Log.m96e(
          TAG,
          "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null"
              + " argument.");
    } else {
  ...
  public void scrollTo(int x, int y) {
    Log.m102w(
        TAG,
        "RecyclerView does not support scrolling to an absolute position. Use scrollToPosition"
            + " instead");
  }
  ...
  public boolean fling(int velocityX, int velocityY) {
    ...
    if ((velocityX != 0 || velocityY != 0) && !dispatchNestedPreFling(velocityX, velocityY)) {
      ...
      if (this.mLayout.getChildCount() > 0) {
        ...
        if (velocityY < 0) {
          consumed =
              getChildAdapterPosition(firstChild) > 0 || firstChild.getTop() < getPaddingTop();
        }
        if (velocityY > 0) {
          consumed =
  ...
  public View focusSearch(View focused, int direction) {
    ...
    boolean canRunFocusFailure =
        (this.mAdapter == null || this.mLayout == null || isComputingLayout() || this.mLayoutFrozen)
            ? false
            : true;
  ...
  public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
    LayoutManager layoutManager = this.mLayout;
    if (layoutManager == null
        || !layoutManager.onAddFocusables(this, views, direction, focusableMode)) {
  ...
  void assertNotInLayoutOrScroll(String message) {
    ...
    if (this.mDispatchScrollCounter > 0) {
      Log.m103w(
          TAG,
          "Cannot call this method in a scroll callback. Scroll callbacks might be run during a"
              + " measure & layout pass where you cannot change the RecyclerView data. Any method"
              + " call that might change the structure of the RecyclerView or the adapter contents"
  ...
  */
    ...
    switch (action) {
      ...
      case 2:
        ...
        if (this.mScrollState == i) {
          ...
          if (scrollByInternal(
              canScrollHorizontally ? dx2 : 0, canScrollVertically ? dy2 : 0, vtev)) {
            getParent().requestDisallowInterceptTouchEvent(true);
          }
  ...
  void dispatchLayout() {
    if (this.mAdapter == null) {
      Log.m96e(TAG, "No adapter attached; skipping layout");
      return;
    }
    if (this.mLayout == null) {
      Log.m96e(TAG, "No layout manager attached; skipping layout");
      return;
    }
    ...
    if (this.mPreserveFocusAfterLayout
      ...
      if (viewToFocus != null) {
        if (this.mState.mFocusedSubChildId != -1
            && (child = viewToFocus.findViewById(this.mState.mFocusedSubChildId)) != null
            && child.isFocusable()) {
          viewToFocus = child;
        }
      ...
      for (int i2 = 0; i2 < this.mChildHelper.getChildCount(); i2++) {
        ...
        if (!viewHolder.shouldIgnore() && !this.mViewInfoStore.isInPreLayout(viewHolder)) {
          ...
          ItemAnimator.ItemHolderInfo animationInfo =
              this.mItemAnimator.recordPreLayoutInformation(
                  this.mState, viewHolder, flags, viewHolder.getUnmodifiedPayloads());
          if (wasHidden) {
  ...
  private void handleMissingPreInfoForChangeError(
        ...
        if (otherKey == key) {
          ...
          throw new IllegalStateException(
              "Two different ViewHolders have the same change ID. This might happen due to"
                  + " inconsistent Adapter update events or if the LayoutManager lays out the same"
                  + " View multiple times.\n"
                  + " ViewHolder 1:"
                  + other
                  + " \n View Holder 2:"
    ...
    Log.m96e(
        TAG,
        "Problem while matching changed view holders with the newones. The pre-layout information"
            + " for the change holder "
            + oldChangeViewHolder
  ...
  boolean canReuseUpdatedViewHolder(ViewHolder viewHolder) {
    ItemAnimator itemAnimator = this.mItemAnimator;
    return itemAnimator == null
        || itemAnimator.canReuseUpdatedViewHolder(viewHolder, viewHolder.getUnmodifiedPayloads());
  }
  ...
  */
  ...
  class ViewFlinger implements Runnable {
    ...
    ViewFlinger() {
      this.mScroller =
          new OverScroller(RecyclerView.this.getContext(), RecyclerView.sQuinticInterpolator);
    }
    ...
    public void run() {
      ...
      if (scroller.computeScrollOffset()) {
        ...
        boolean fullyConsumedHorizontal =
            dx != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && hresult == dx;
      ...
      if (holder != null && holder.mShadowingHolder != null) {
        ...
        if (left != shadowingView.getLeft() || top != shadowingView.getTop()) {
          shadowingView.layout(
              left, top, shadowingView.getWidth() + left, shadowingView.getHeight() + top);
        }
      }
    }
  }
  ...
  public final class Recycler {
    ...
    public void bindViewToPosition(View view, int position) {
      ...
      if (holder == null) {
        throw new IllegalArgumentException(
            "The view does not have a ViewHolder. You cannot pass arbitrary views to this method,"
                + " they should be created by the Adapter");
      }
    ...
    ViewHolder tryGetViewHolderForPositionByDeadline(
      ...
      if (holder2 == null
          && (holder2 = getScrapOrHiddenOrCachedHolderForPosition(position, dryRun)) != null) {
      ...
      if (holder2 != null) {
        ...
        if (RecyclerView.this.mAdapter.hasStableIds()
            && (holder2 =
                    getScrapOrCachedViewForId(
                        RecyclerView.this.mAdapter.getItemId(offsetPosition), type, dryRun))
                != null) {
          holder2.mPosition = offsetPosition;
          fromScrapOrHiddenOrCache2 = true;
        }
        if (holder2 == null
            && (viewCacheExtension = this.mViewCacheExtension) != null
            && (view = viewCacheExtension.getViewForPositionAndType(this, position, type))
                != null) {
        ...
        if (holder2 != null) {
          ...
          if (deadlineNs == Long.MAX_VALUE
            ...
            ViewHolder holder3 =
                RecyclerView.this.mAdapter.createViewHolder(RecyclerView.this, type);
            if (RecyclerView.ALLOW_THREAD_GAP_WORK
                && (innerView = RecyclerView.findNestedRecyclerView(holder3.itemView)) != null) {
    ...
    void recycleViewHolderInternal(ViewHolder holder) {
      ...
      if (holder.shouldIgnore()) {
        throw new IllegalArgumentException(
            "Trying to recycle an ignored view holder. You should first call stopIgnoringView(view)"
                + " before calling recycle.");
      }
      ...
      if (forceRecycle || holder.isRecyclable()) {
        if (this.mViewCacheMax > 0
            && !holder.hasAnyOfTheFlags(MetricsProto.MetricsEvent.DIALOG_SUPPORT_DISCLAIMER)) {
    ...
    ViewHolder getChangedScrapViewForPosition(int position) {
      ...
      if (RecyclerView.this.mAdapter.hasStableIds()
          && (offsetPosition = RecyclerView.this.mAdapterHelper.findPositionOffset(position)) > 0
    ...
    ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
      ...
      if (!dryRun
          && (view = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(position)) != null) {
  ...
  public abstract static class LayoutManager {
    ...
    public void onLayoutChildren(Recycler recycler, State state) {
      Log.m96e(
          RecyclerView.TAG, "You must override onLayoutChildren(Recycler recycler, State state) ");
    }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int position) {
      Log.m96e(
          RecyclerView.TAG, "You must override smoothScrollToPosition to support smooth scrolling");
    }
    ...
    public View findContainingItemView(View view) {
      ...
      RecyclerView recyclerView = this.mRecyclerView;
      if (recyclerView == null
          || (found = recyclerView.findContainingItemView(view)) == null
    ...
    public View getFocusedChild() {
      ...
      RecyclerView recyclerView = this.mRecyclerView;
      if (recyclerView == null
          || (focused = recyclerView.getFocusedChild()) == null
    ...
    public void measureChildWithMargins(View child, int widthUsed, int heightUsed) {
      ...
      int widthSpec =
          getChildMeasureSpec(
              getWidth(),
              getWidthMode(),
              getPaddingLeft() + getPaddingRight() + lp.leftMargin + lp.rightMargin + widthUsed2,
              lp.width,
              canScrollHorizontally());
      int heightSpec =
          getChildMeasureSpec(
              getHeight(),
              getHeightMode(),
              getPaddingTop() + getPaddingBottom() + lp.topMargin + lp.bottomMargin + heightUsed2,
              lp.height,
              canScrollVertically());
      if (shouldMeasureChild(child, widthSpec, heightSpec, lp)) {
        child.measure(widthSpec, heightSpec);
    ...
    public static int getChildMeasureSpec(
        int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
      int size = Math.max(0, parentSize - padding);
      int resultSize = 0;
      int resultMode = 0;
      if (canScroll) {
        ...
        resultSize = size;
        resultMode =
            (parentMode == Integer.MIN_VALUE || parentMode == 1073741824) ? Integer.MIN_VALUE : 0;
      }
      return View.MeasureSpec.makeMeasureSpec(resultSize, resultMode);
    }
    ...
    public void layoutDecorated(View child, int left, int top, int right, int bottom) {
      Rect insets = ((LayoutParams) child.getLayoutParams()).mDecorInsets;
      child.layout(
          insets.left + left, insets.top + top, right - insets.right, bottom - insets.bottom);
    }
    ...
    public static Properties getProperties(
      ...
      TypedArray a =
          context.obtainStyledAttributes(
              attrs, C4337R.styleable.RecyclerView, defStyleAttr, defStyleRes);
  ...
  public abstract static class ViewHolder {
    ...
    public String toString() {
      ...
      if (!isRecyclable()) {
        sb.append(
            " not recyclable(" + this.mIsRecyclableCount + NavigationBarInflaterView.KEY_CODE_END);
      }
  ...
  public abstract static class SmoothScroller {
    ...
    public void onAnimation(int dx, int dy) {
      ...
      if (view != null) {
        if (getChildPosition(view) == this.mTargetPosition) {
          ...
          Log.m96e(RecyclerView.TAG, "Passed over target position while smooth scrolling.");
          this.mTargetView = null;
        }
      }
      if (this.mRunning) {
    ...
    protected void normalize(PointF scrollVector) {
      double magnitude =
          Math.sqrt(
              (scrollVector.f87x * scrollVector.f87x) + (scrollVector.f88y * scrollVector.f88y));
      scrollVector.f87x = (float) (scrollVector.f87x / magnitude);
      scrollVector.f88y = (float) (scrollVector.f88y / magnitude);
    }
  ...
  public static class SavedState extends AbsSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: com.android.internal.widget.RecyclerView.SavedState.1
  ...
  public abstract static class ItemAnimator {
    ...
    public abstract boolean animateAppearance(
        ViewHolder viewHolder, ItemHolderInfo itemHolderInfo, ItemHolderInfo itemHolderInfo2);
