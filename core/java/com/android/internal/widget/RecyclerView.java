...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C4337R.styleable.RecyclerView, defStyle, 0);
    ...
    public void setScrollingTouchSlop(int slopConstant) {
        ...
        switch (slopConstant) {
            ...
            case 1:
                ...
                return;
            default:
                Log.m102w(TAG, "setScrollingTouchSlop(): bad argument constant " + slopConstant + "; using default value");
                break;
        }
        this.mTouchSlop = vc.getScaledTouchSlop();
    }
    ...
    public void scrollToPosition(int position) {
        ...
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.m96e(TAG, "Cannot scroll to position a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else {
    ...
    public void smoothScrollToPosition(int position) {
        ...
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.m96e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else {
    ...
    public void scrollTo(int x, int y) {
        Log.m102w(TAG, "RecyclerView does not support scrolling to an absolute position. Use scrollToPosition instead");
    }
    ...
    public void scrollBy(int x, int y) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.m96e(TAG, "Cannot scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            return;
        }
        if (this.mLayoutFrozen) {
            return;
    ...
    public boolean fling(int velocityX, int velocityY) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.m96e(TAG, "Cannot fling without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            return false;
        }
        if (this.mLayoutFrozen) {
            return false;
    ...
    void assertNotInLayoutOrScroll(String message) {
        ...
        if (this.mDispatchScrollCounter > 0) {
            Log.m103w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks might be run during a measure & layout pass where you cannot change the RecyclerView data. Any method call that might change the structure of the RecyclerView or the adapter contents should be postponed to the next frame.", new IllegalStateException(""));
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case 2:
                ...
                if (index < 0) {
                    Log.m96e(TAG, "Error processing scroll; pointer index for id " + this.mScrollPointerId + " not found. Did any MotionEvents get skipped?");
                    return false;
                }
    ...
    */
    ...
    private void handleMissingPreInfoForChangeError(long key, ViewHolder holder, ViewHolder oldChangeViewHolder) {
        ...
        Log.m96e(TAG, "Problem while matching changed view holders with the newones. The pre-layout information for the change holder " + oldChangeViewHolder + " cannot be found but it is necessary for " + holder);
    }
    ...
    */
    ...
    public static abstract class LayoutManager {
        ...
        public void onLayoutChildren(Recycler recycler, State state) {
            Log.m96e(RecyclerView.TAG, "You must override onLayoutChildren(Recycler recycler, State state) ");
        }
        ...
        public void smoothScrollToPosition(RecyclerView recyclerView, State state, int position) {
            Log.m96e(RecyclerView.TAG, "You must override smoothScrollToPosition to support smooth scrolling");
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.RecyclerView, defStyleAttr, defStyleRes);
    ...
    public static abstract class ViewHolder {
        ...
        public final void setIsRecyclable(boolean recyclable) {
            ...
            if (i2 < 0) {
                this.mIsRecyclableCount = 0;
                Log.m96e("View", "isRecyclable decremented below 0: unmatched pair of setIsRecyable() calls for " + this);
    ...
    public static abstract class SmoothScroller {
        ...
        protected void normalize(PointF scrollVector) {
            double magnitude = Math.sqrt((scrollVector.f87x * scrollVector.f87x) + (scrollVector.f88y * scrollVector.f88y));
        ...
        public static class Action {
            ...
            void runIfNecessary(RecyclerView recyclerView) {
                ...
                if (this.mChanged) {
                    ...
                    if (i > 10) {
                        Log.m96e(RecyclerView.TAG, "Smooth Scroll action is being updated too frequently. Make sure you are not changing it unless necessary");
                    }
                    this.mChanged = false;
                    return;
                }
