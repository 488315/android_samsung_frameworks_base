...
class ItemTouchUIUtilImpl implements ItemTouchUIUtil {
    ...
    public void onDraw(Canvas c, RecyclerView recyclerView, View view, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        if (isCurrentlyActive) {
            Object originalElevation = view.getTag(C4337R.id.item_touch_helper_previous_elevation);
            if (originalElevation == null) {
                ...
                view.setTag(C4337R.id.item_touch_helper_previous_elevation, originalElevation2);
            }
        }
    ...
    public void clearView(View view) {
        Object tag = view.getTag(C4337R.id.item_touch_helper_previous_elevation);
        if (tag != null && (tag instanceof Float)) {
            view.setElevation(((Float) tag).floatValue());
        }
        view.setTag(C4337R.id.item_touch_helper_previous_elevation, null);
