  ...
  final View.AccessibilityDelegate mItemDelegate =
      new View
          .AccessibilityDelegate() { // from class:
                                     // com.android.internal.widget.RecyclerViewAccessibilityDelegate.1
        @Override // android.view.View.AccessibilityDelegate
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfo info) {
          super.onInitializeAccessibilityNodeInfo(host, info);
          if (!RecyclerViewAccessibilityDelegate.this.shouldIgnore()
              && RecyclerViewAccessibilityDelegate.this.mRecyclerView.getLayoutManager() != null) {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
          ...
          if (!RecyclerViewAccessibilityDelegate.this.shouldIgnore()
              && RecyclerViewAccessibilityDelegate.this.mRecyclerView.getLayoutManager() != null) {
            return RecyclerViewAccessibilityDelegate.this
                .mRecyclerView
                .getLayoutManager()
