...
public class MessagingTextMessage extends ImageFloatingTextView implements MessagingMessage {
  ...
  static MessagingMessage createMessage(
      IMessagingLayout layout, Notification.MessagingStyle.Message m) {
      ...
      createdMessage =
          (MessagingTextMessage)
              LayoutInflater.from(layout.getContext())
                  .inflate(
                      C4337R.layout.notification_template_messaging_text_message,
  ...
  public int getMeasuredType() {
    ...
    boolean measuredTooSmall =
        getMeasuredHeight() < (getLayoutHeight() + getPaddingTop()) + getPaddingBottom();
