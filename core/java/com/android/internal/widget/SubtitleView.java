...
public class SubtitleView extends View {
    ...
    public SubtitleView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0000R.styleable.TextView, defStyleAttr, defStyleRes);
        CharSequence text = "";
        int textSize = 15;
        ...
        this.mCornerRadius = res.getDimensionPixelSize(C4337R.dimen.subtitle_corner_radius);
        this.mOutlineWidth = res.getDimensionPixelSize(C4337R.dimen.subtitle_outline_width);
        this.mShadowRadius = res.getDimensionPixelSize(C4337R.dimen.subtitle_shadow_radius);
        float dimensionPixelSize = res.getDimensionPixelSize(C4337R.dimen.subtitle_shadow_offset);
