...
public class ConversationLayout extends FrameLayout implements ImageMessageConsumer, IMessagingLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.mMessagingLinearLayout = (MessagingLinearLayout) findViewById(C4337R.id.notification_messaging);
        this.mActions = (NotificationActionListLayout) findViewById(C4337R.id.actions);
        this.mImageMessageContainer = (MessagingLinearLayout) findViewById(C4337R.id.conversation_image_message_container);
        ...
        this.mImportanceRingView = (CachingIconView) findViewById(C4337R.id.conversation_icon_badge_ring);
        this.mConversationIconBadge = findViewById(C4337R.id.conversation_icon_badge);
        this.mConversationIconBadgeBg = (CachingIconView) findViewById(C4337R.id.conversation_icon_badge_bg);
        ...
        this.mExpandButtonContainerA11yContainer = (ViewGroup) findViewById(C4337R.id.expand_button_a11y_container);
        ...
        this.mExpandButtonAndContentContainer = (ViewGroup) findViewById(C4337R.id.expand_button_and_content_container);
        this.mExpandButton = (NotificationExpandButton) findViewById(C4337R.id.expand_button);
        this.mMessageSpacingStandard = getResources().getDimensionPixelSize(C4337R.dimen.notification_messaging_spacing);
        this.mMessageSpacingGroup = getResources().getDimensionPixelSize(C4337R.dimen.notification_messaging_spacing_conversation_group);
        this.mNotificationHeaderExpandedPadding = getResources().getDimensionPixelSize(C4337R.dimen.conversation_header_expanded_padding_end);
        this.mContentMarginEnd = getResources().getDimensionPixelSize(C4337R.dimen.notification_content_margin_end);
        this.mBadgeProtrusion = getResources().getDimensionPixelSize(C4337R.dimen.conversation_badge_protrusion);
        this.mConversationAvatarSize = getResources().getDimensionPixelSize(C4337R.dimen.conversation_avatar_size);
        this.mConversationAvatarSizeExpanded = getResources().getDimensionPixelSize(C4337R.dimen.conversation_avatar_size_group_expanded);
        this.mConversationIconTopPaddingExpandedGroup = getResources().getDimensionPixelSize(C4337R.dimen.conversation_icon_container_top_padding_small_avatar);
        this.mConversationIconTopPadding = getFontScaledMarginHeight(this.mContext, C4337R.dimen.conversation_icon_container_top_padding);
        this.mExpandedGroupMessagePadding = getResources().getDimensionPixelSize(C4337R.dimen.expanded_group_conversation_message_padding);
        this.mExpandedGroupBadgeProtrusion = getResources().getDimensionPixelSize(C4337R.dimen.conversation_badge_protrusion_group_expanded);
        this.mExpandedGroupBadgeProtrusionFacePile = getResources().getDimensionPixelSize(C4337R.dimen.conversation_badge_protrusion_group_expanded_face_pile);
        this.mConversationFacePile = findViewById(C4337R.id.conversation_face_pile);
        this.mFacePileAvatarSize = getResources().getDimensionPixelSize(C4337R.dimen.conversation_face_pile_avatar_size);
        this.mFacePileAvatarSizeExpandedGroup = getResources().getDimensionPixelSize(C4337R.dimen.conversation_face_pile_avatar_size_group_expanded);
        this.mFacePileProtectionWidth = getResources().getDimensionPixelSize(C4337R.dimen.conversation_face_pile_protection_width);
        this.mFacePileProtectionWidthExpanded = getResources().getDimensionPixelSize(C4337R.dimen.conversation_face_pile_protection_width_expanded);
        this.mFallbackChatName = getResources().getString(C4337R.string.conversation_title_fallback_one_to_one);
        this.mFallbackGroupChatName = getResources().getString(C4337R.string.conversation_title_fallback_group_chat);
        ...
        this.mConversationStartMargin = getResources().getDimensionPixelSize(C4337R.dimen.notification_content_margin_start);
        this.mConversationTopMargin = getFontScaledMarginHeight(this.mContext, C4337R.dimen.conversation_expand_button_top_margin_expanded);
        this.mConversationMinHeight = getResources().getDimensionPixelSize(C4337R.dimen.conversation_expand_button_height);
    }
    ...
    public void setIsImportantConversation(boolean isImportantConversation, boolean animate) {
        ...
        if (animate && isImportantConversation) {
            ...
            int standardThickness = getResources().getDimensionPixelSize(C4337R.dimen.importance_ring_stroke_width);
            int largeThickness = getResources().getDimensionPixelSize(C4337R.dimen.importance_ring_anim_max_stroke_width);
            ...
            final int bgSize = getResources().getDimensionPixelSize(C4337R.dimen.conversation_icon_size_badged);
    ...
    private void updateActionListPadding() {
        ...
        if (notificationActionListLayout != null) {
            notificationActionListLayout.setCollapsibleIndentDimen(C4337R.dimen.call_notification_collapsible_indent);
        }
    }
    ...
    private void bindFacePile() {
        ...
        ImageView bottomBackground = (ImageView) this.mConversationFacePile.findViewById(C4337R.id.conversation_face_pile_bottom_background);
        ImageView bottomView = (ImageView) this.mConversationFacePile.findViewById(C4337R.id.conversation_face_pile_bottom);
        ImageView topView = (ImageView) this.mConversationFacePile.findViewById(C4337R.id.conversation_face_pile_top);
    ...
    public CharSequence getConversationText() {
        ...
        if (text == null && (messagingMessage instanceof MessagingImageMessage)) {
            String unformatted = getResources().getString(C4337R.string.conversation_single_line_image_placeholder);
