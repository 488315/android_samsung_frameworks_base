...
public interface ILockSettings extends IInterface {
  ...
  boolean setLockCredential(
      LockscreenCredential lockscreenCredential, LockscreenCredential lockscreenCredential2, int i)
      throws RemoteException;
  ...
  public static class Default implements ILockSettings {
    ...
    public void initRecoveryServiceWithSigFile(
        String rootCertificateAlias, byte[] recoveryServiceCertFile, byte[] recoveryServiceSigFile)
        throws RemoteException {}
    ...
    public Map recoverKeyChainSnapshot(
        String sessionId, byte[] recoveryKeyBlob, List<WrappedApplicationKey> applicationKeys)
        throws RemoteException {
      return null;
    }
    ...
    public void checkRemoteLockPassword(
        int type, byte[] password, int userId, IRemoteCallback callback) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 7:
              LockscreenCredential _arg07 =
                  (LockscreenCredential) data.readTypedObject(LockscreenCredential.CREATOR);
            ...
            case 9:
              ...
              ICheckCredentialProgressCallback _arg28 =
                  ICheckCredentialProgressCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 43:
              ...
              data.enforceNoDataAvail();
              byte[] _result24 =
                  startRecoverySessionWithCertPath(_arg039, _arg121, _arg215, _arg3, _arg4, _arg5);
              reply.writeNoException();
            ...
            case 51:
              IWeakEscrowTokenRemovedListener _arg045 =
                  IWeakEscrowTokenRemovedListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 53:
              ...
              IWeakEscrowTokenActivatedListener _arg217 =
                  IWeakEscrowTokenActivatedListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 94:
              ...
              return true;
            case 95:
              LockscreenCredential _arg086 =
                  (LockscreenCredential) data.readTypedObject(LockscreenCredential.CREATOR);
              LockscreenCredential _arg147 =
                  (LockscreenCredential) data.readTypedObject(LockscreenCredential.CREATOR);
              int _arg221 = data.readInt();
              boolean _arg33 = data.readBoolean();
              data.enforceNoDataAvail();
              boolean _result55 =
                  setLockCredentialWithIgnoreNotifyIfNeeded(_arg086, _arg147, _arg221, _arg33);
              reply.writeNoException();
              reply.writeBoolean(_result55);
              return true;
            case 96:
              LockscreenCredential _arg087 =
                  (LockscreenCredential) data.readTypedObject(LockscreenCredential.CREATOR);
            ...
            case 100:
              ...
              data.enforceNoDataAvail();
              VerifyCredentialResponse _result58 =
                  checkCredentialForDualDarDo(_arg091, _arg152, _arg224, _arg35);
              reply.writeNoException();
      ...
      public VerifyCredentialResponse checkCredential(
        ...
        try {
          ...
          VerifyCredentialResponse _result =
              (VerifyCredentialResponse) _reply.readTypedObject(VerifyCredentialResponse.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
        ...
        try {
          ...
          RemoteLockscreenValidationSession _result =
              (RemoteLockscreenValidationSession)
                  _reply.readTypedObject(RemoteLockscreenValidationSession.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
        ...
        try {
          ...
          RemoteLockscreenValidationResult _result =
              (RemoteLockscreenValidationResult)
                  _reply.readTypedObject(RemoteLockscreenValidationResult.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
