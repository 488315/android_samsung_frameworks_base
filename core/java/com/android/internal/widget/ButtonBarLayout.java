...
public class ButtonBarLayout extends LinearLayout {
  ...
  public ButtonBarLayout(Context context, AttributeSet attrs) {
    ...
    TypedArray ta = context.obtainStyledAttributes(attrs, C4337R.styleable.ButtonBarLayout);
            ...
            minHeight =
                (int)
                    (minHeight
                        ...
                        + (getResources().getDisplayMetrics().density * 16.0f));
          }
        }
      } else {
        minHeight += getPaddingBottom();
  ...
  private void setStacked(boolean z) {
    ...
    View findViewById = findViewById(C4337R.id.spacer);
