...
public class ActionBarContextView extends AbsActionBarView {
  ...
  public ActionBarContextView(
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.ActionMode, defStyleAttr, defStyleRes);
  ...
  protected void onConfigurationChanged(Configuration newConfig) {
    ...
    if (this.mIsThemeDeviceDefaultFamily) {
      TypedArray a =
          this.mContext.obtainStyledAttributes(null, C4337R.styleable.ActionMode, 16843668, 0);
  ...
  public void initForMode(final ActionMode mode) {
    ...
    closeButton.setOnClickListener(
        new View
            .OnClickListener() { // from class: com.android.internal.widget.ActionBarContextView.1
        ...
        new View
          ...
          public boolean onLongClick(View v) {
            ...
            if (ActionBarContextView.this.getLayoutDirection() == 0) {
              ...
              xOffset =
                  ((xOffset2 + width) - (((width - paddingStart) - paddingEnd) / 2)) - paddingStart;
            }
  ...
  */
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    int maxHeight =
        this.mContentHeight > 0 ? this.mContentHeight : View.MeasureSpec.getSize(heightMeasureSpec);
      ...
      if (!this.mIsThemeDeviceDefaultFamily) {
        ...
        if (this.mTitleView != null) {
          TypedArray appearance =
              getContext()
                  .obtainStyledAttributes(this.mTitleStyleRes, C4337R.styleable.TextAppearance);
        ...
        if (textView != null && textView.getVisibility() == 0) {
          LinearLayout.LayoutParams lp2 =
              (LinearLayout.LayoutParams) this.mTitleView.getLayoutParams();
          int contentInsetStart =
              (int)
                  getContext()
                      .getResources()
                      .getDimension(C4337R.dimen.sem_toolbar_content_inset_start);
        ...
        if (textView2 != null && textView2.getVisibility() == 0) {
          LinearLayout.LayoutParams lp3 =
              (LinearLayout.LayoutParams) this.mSubtitleView.getLayoutParams();
          int contentInsetStart2 =
              (int)
                  getContext()
                      .getResources()
                      .getDimension(C4337R.dimen.sem_toolbar_content_inset_start);
