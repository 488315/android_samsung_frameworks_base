...
public class SlidingTab extends ViewGroup {
    ...
    private static class Slider {
        ...
        void setState(int state) {
            ...
            if (state == 2) {
                ...
                textView.setTextAppearance(textView.getContext(), C4337R.style.TextAppearance_SlidingTabActive);
            } else {
                TextView textView2 = this.text;
                textView2.setTextAppearance(textView2.getContext(), C4337R.style.TextAppearance_SlidingTabNormal);
            }
        ...
        void reset(boolean animate) {
            ...
            this.text.setVisibility(0);
            TextView textView = this.text;
            textView.setTextAppearance(textView.getContext(), C4337R.style.TextAppearance_SlidingTabNormal);
            this.tab.setVisibility(0);
            this.target.setVisibility(4);
            int i = this.alignment;
            boolean horiz = true;
    ...
    public SlidingTab(Context context, AttributeSet attrs) {
        ...
        this.mLeftSlider = new Slider(this, C4337R.drawable.jog_tab_left_generic, C4337R.drawable.jog_tab_bar_left_generic, C4337R.drawable.jog_tab_target_gray);
        this.mRightSlider = new Slider(this, C4337R.drawable.jog_tab_right_generic, C4337R.drawable.jog_tab_bar_right_generic, C4337R.drawable.jog_tab_target_gray);
    }
