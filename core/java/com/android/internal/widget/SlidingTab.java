...
public class SlidingTab extends ViewGroup {
  ...
  private static class Slider {
    ...
    Slider(ViewGroup parent, int tabId, int barId, int targetId) {
      ...
      textView.setTextAppearance(parent.getContext(), C4337R.style.TextAppearance_SlidingTabNormal);
    ...
    void hide() {
      ...
      if (horiz) {
        dx =
            i == 0
                ? this.alignment_value - this.tab.getRight()
                : this.alignment_value - this.tab.getLeft();
      } else {
        dx = 0;
      }
      if (!horiz) {
        dy =
            this.alignment == 2
                ? this.alignment_value - this.tab.getBottom()
                : this.alignment_value - this.tab.getTop();
      }
    ...
    void setState(int state) {
      ...
      if (state == 2) {
        ...
        textView.setTextAppearance(
            textView.getContext(), C4337R.style.TextAppearance_SlidingTabActive);
      } else {
        TextView textView2 = this.text;
        textView2.setTextAppearance(
            textView2.getContext(), C4337R.style.TextAppearance_SlidingTabNormal);
      }
    ...
    void reset(boolean animate) {
      ...
      TextView textView = this.text;
      textView.setTextAppearance(
          textView.getContext(), C4337R.style.TextAppearance_SlidingTabNormal);
      this.tab.setVisibility(0);
      this.target.setVisibility(4);
      int i = this.alignment;
      boolean horiz = true;
    ...
    void layout(int l, int t, int r, int b, int alignment) {
      ...
      int leftTarget2 =
          (((int) (parentWidth2 * SlidingTab.THRESHOLD)) - targetWidth2) + (handleWidth2 / 2);
      ...
      if (alignment == 0) {
        ...
        if (alignment != 1) {
          ...
          int top =
              (((int) (parentHeight * SlidingTab.THRESHOLD)) + (handleHeight / 2)) - targetHeight;
    ...
    public void measure(int widthMeasureSpec, int heightMeasureSpec) {
      ...
      this.tab.measure(
          View.MeasureSpec.makeSafeMeasureSpec(width, 0),
          View.MeasureSpec.makeSafeMeasureSpec(height, 0));
      this.text.measure(
          View.MeasureSpec.makeSafeMeasureSpec(width, 0),
          View.MeasureSpec.makeSafeMeasureSpec(height, 0));
    }
  ...
  public SlidingTab(Context context, AttributeSet attrs) {
    ...
    this.mAnimationDoneListener =
        new Animation.AnimationListener() { // from class: com.android.internal.widget.SlidingTab.1
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.SlidingTab);
    ...
    this.mLeftSlider =
        new Slider(
            this,
            C4337R.drawable.jog_tab_left_generic,
            C4337R.drawable.jog_tab_bar_left_generic,
            C4337R.drawable.jog_tab_target_gray);
    this.mRightSlider =
        new Slider(
            this,
            C4337R.drawable.jog_tab_right_generic,
            C4337R.drawable.jog_tab_bar_right_generic,
            C4337R.drawable.jog_tab_target_gray);
  }
  ...
  */
  ...
  void startAnimating(final boolean holdAfter) {
    ...
    trans1.setAnimationListener(
        new Animation.AnimationListener() { // from class: com.android.internal.widget.SlidingTab.2
          @Override // android.view.animation.Animation.AnimationListener
          public void onAnimationEnd(Animation animation) {
            Animation anim;
            if (holdAfter) {
  ...
  private boolean withinView(float x, float y, View view) {
    return (isHorizontal() && y > -50.0f && y < ((float) (view.getHeight() + 50)))
        || (!isHorizontal() && x > -50.0f && x < ((float) (view.getWidth() + 50)));
  }
