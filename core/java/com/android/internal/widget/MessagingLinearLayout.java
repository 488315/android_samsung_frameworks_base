...
public class MessagingLinearLayout extends ViewGroup {
  ...
  public MessagingLinearLayout(Context context, AttributeSet attrs) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(attrs, C4337R.styleable.MessagingLinearLayout, 0, 0);
    ...
    while (i12 >= 0 && i14 < i3) {
      if (getChildAt(i12).getVisibility() == 8) {
        ...
        measureChildWithMargins(
            view, i, 0, i2, ((i14 - this.mPaddingTop) - this.mPaddingBottom) + i18);
        ...
        setMeasuredDimension(
            resolveSize(Math.max(getSuggestedMinimumWidth(), i13), i),
            Math.max(getSuggestedMinimumHeight(), i14));
      }
      i12 = i4 - 1;
      c = c;
    }
      ...
      if (childAt.getVisibility() == 8) {
        ...
        if (lp.hide) {
          if (!shown || !lp.visibleBefore) {
            ...
            width = width2;
            childAt.layout(
                childLeft, childTop, childLeft + childWidth, lp.lastVisibleHeight + childTop);
