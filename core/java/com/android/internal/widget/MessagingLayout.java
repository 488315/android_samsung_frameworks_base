...
public class MessagingLayout extends FrameLayout implements ImageMessageConsumer, IMessagingLayout {
  ...
  protected void onFinishInflate() {
    ...
    this.mRightIconView = (ImageView) findViewById(C4337R.id.right_icon);
  ...
  private void updateImageMessages() {
    ...
    if (newMessage != null
        && (imageView = this.mRightIconView) != null
    ...
    for (int i2 = 0; i2 < this.mGroups.size(); i2++) {
      ...
      if (group2.needsGeneratedAvatar() && !TextUtils.isEmpty(senderName2)) {
        if (this.mIsOneToOne
          ...
          if (cachedIcon2 == null) {
            cachedIcon2 =
                createAvatarSymbol(senderName2, uniqueNames.get(senderName2), this.mLayoutColor);
            ...
            (60.0f
                * ((float)
                    (((float)
                            (shift
                                + Math.max(
                                    0.30000001192092896d - luminance,
  ...
  private void addMessagesToGroups(
                  ...
                  while (it.hasNext()) {
                    ...
                    if (group.isShown()) {
                      ...
                      MessagingPropertyAnimator.startLocalTranslationFrom(
                          group, group.getHeight(), MessagingLayout.LINEAR_OUT_SLOW_IN);
                    }
                  }
