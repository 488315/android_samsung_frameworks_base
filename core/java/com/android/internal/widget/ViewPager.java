...
public class ViewPager extends ViewGroup {
  ...
  private int getLeftEdgeForItem(int position) {
    ...
    int scaledOffset =
        (int) (width * MathUtils.constrain(info.offset, this.mFirstOffset, this.mLastOffset));
    if (isLayoutRtl()) {
  ...
  protected int getChildDrawingOrder(int childCount, int i) {
    ...
    int result =
        ((LayoutParams) this.mDrawingOrderedChildren.get(index).getLayoutParams()).childIndex;
    return result;
  }
  ...
  public void setOffscreenPageLimit(int limit) {
    if (limit < 1) {
      Log.m102w(TAG, "Requested offscreen page limit " + limit + " too small; defaulting to 1");
      limit = 1;
    }
  ...
  public static class SavedState extends AbsSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.ClassLoaderCreator<
            SavedState>() { // from class: com.android.internal.widget.ViewPager.SavedState.1
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    for (int i2 = 0; i2 < size2; i2++) {
      ...
      if (child2.getVisibility() != 8
        ...
        int widthSpec2 =
            View.MeasureSpec.makeMeasureSpec((int) (childWidthSize * lp.widthFactor), 1073741824);
                ...
                if (!lp2.needsMeasure) {
                  ...
                  int widthSpec =
                      View.MeasureSpec.makeMeasureSpec(
                          (int) (childWidth * lp2.widthFactor), 1073741824);
                  width = width2;
                  int heightSpec =
                      View.MeasureSpec.makeMeasureSpec(
                          (height - paddingTop) - paddingBottom, 1073741824);
  ...
  public boolean onTouchEvent(MotionEvent ev) {
    ...
    if ((ev.getAction() == 0 && ev.getEdgeFlags() != 0)
        || (pagerAdapter = this.mAdapter) == null
    ...
    switch (action & 255) {
      ...
      case 1:
        if (this.mIsBeingDragged) {
          ...
          int nextPage =
              determineTargetPage(currentPage, nextPageOffset, initialVelocity, totalDelta);
      ...
      while (pos < lastPos) {
        ...
        if (marginOffset3 + left > scrollX) {
          ...
          this.mMarginDrawable.setBounds(
              (int) left, this.mTopPageBounds, (int) (i + left + 0.5f), this.mBottomPageBounds);
