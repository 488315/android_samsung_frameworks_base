...
public class DefaultItemAnimator extends SimpleItemAnimator {
  ...
  public void runPendingAnimations() {
    ...
    if (movesPending) {
      ...
      Runnable mover =
          new Runnable() { // from class: com.android.internal.widget.DefaultItemAnimator.1
    ...
    if (changesPending) {
      ...
      Runnable changer =
          new Runnable() { // from class: com.android.internal.widget.DefaultItemAnimator.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    if (additionsPending) {
      ...
      Runnable adder =
          new Runnable() { // from class: com.android.internal.widget.DefaultItemAnimator.3
            @Override // java.lang.Runnable
            public void run() {
