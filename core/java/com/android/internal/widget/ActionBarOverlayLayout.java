...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
    ...
    public void setUiOptions(int uiOptions) {
        ...
        if (splitWhenNarrow) {
            splitActionBar = getContext().getResources().getBoolean(C4337R.bool.split_action_bar_is_narrow);
        }
        if (splitActionBar) {
            pullChildren();
            if (this.mActionBarBottom != null && this.mDecorToolbar.canSplit()) {
                ...
                ActionBarContextView cab = (ActionBarContextView) findViewById(C4337R.id.action_context_bar);
            ...
            if (splitActionBar) {
                Log.m96e(TAG, "Requested split action bar with incompatible window decor! Ignoring request.");
            }
        }
    }
