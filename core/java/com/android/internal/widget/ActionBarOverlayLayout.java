...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
    ...
    this.mRemoveActionBarHideOffset =
        new Runnable() { // from class: com.android.internal.widget.ActionBarOverlayLayout.3
          ...
          public void run() {
            ...
            actionBarOverlayLayout.mCurrentActionBarTopAnimator =
                actionBarOverlayLayout
                    .mActionBarTop
                    .animate()
                    .translationY(0.0f)
                    .setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
            if (ActionBarOverlayLayout.this.mActionBarBottom != null
                && ActionBarOverlayLayout.this.mActionBarBottom.getVisibility() != 8) {
              ActionBarOverlayLayout actionBarOverlayLayout2 = ActionBarOverlayLayout.this;
              actionBarOverlayLayout2.mCurrentActionBarBottomAnimator =
                  actionBarOverlayLayout2
                      .mActionBarBottom
                      .animate()
                      .translationY(0.0f)
                      .setListener(ActionBarOverlayLayout.this.mBottomAnimatorListener);
            }
          }
        };
          ...
          public void run() {
            ...
            actionBarOverlayLayout.mCurrentActionBarTopAnimator =
                actionBarOverlayLayout
                    .mActionBarTop
                    .animate()
                    .translationY(-ActionBarOverlayLayout.this.mActionBarTop.getHeight())
                    .setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
            if (ActionBarOverlayLayout.this.mActionBarBottom != null
                && ActionBarOverlayLayout.this.mActionBarBottom.getVisibility() != 8) {
              ActionBarOverlayLayout actionBarOverlayLayout2 = ActionBarOverlayLayout.this;
              actionBarOverlayLayout2.mCurrentActionBarBottomAnimator =
                  actionBarOverlayLayout2
                      .mActionBarBottom
                      .animate()
                      .translationY(ActionBarOverlayLayout.this.mActionBarBottom.getHeight())
                      .setListener(ActionBarOverlayLayout.this.mBottomAnimatorListener);
            }
          }
        };
  ...
  private boolean applyInsets(
      View view, Rect insets, boolean left, boolean top, boolean bottom, boolean right) {
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    int maxHeight =
        Math.max(0, this.mActionBarTop.getMeasuredHeight() + lp.topMargin + lp.bottomMargin);
    ...
    if (actionBarContainer2 != null) {
      ...
      int maxWidth3 =
          Math.max(
              maxWidth2,
              this.mActionBarBottom.getMeasuredWidth() + lp2.leftMargin + lp2.rightMargin);
      int maxHeight2 =
          Math.max(
              maxHeight,
              this.mActionBarBottom.getMeasuredHeight() + lp2.topMargin + lp2.bottomMargin);
    ...
    int maxWidth4 =
        Math.max(childState2, this.mContent.getMeasuredWidth() + lp3.leftMargin + lp3.rightMargin);
    int maxHeight3 =
        Math.max(maxWidth, this.mContent.getMeasuredHeight() + lp3.topMargin + lp3.bottomMargin);
    int childState4 = combineMeasuredStates(childState, this.mContent.getMeasuredState());
    setMeasuredDimension(
        resolveSizeAndState(
            Math.max(maxWidth4 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()),
            widthMeasureSpec,
            childState4),
        resolveSizeAndState(
            Math.max(
                maxHeight3 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()),
            heightMeasureSpec,
            childState4 << 16));
  }
    ...
    if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
      int top =
          this.mActionBarTop.getVisibility() == 0
              ? (int) (this.mActionBarTop.getBottom() + this.mActionBarTop.getTranslationY() + 0.5f)
              : 0;
  ...
  void pullChildren() {
    if (this.mContent == null) {
      ...
      this.mActionBarTop = (ActionBarContainer) findViewById(C4337R.id.action_bar_container);
      this.mDecorToolbar = getDecorToolbar(findViewById(C4337R.id.action_bar));
      this.mActionBarBottom = (ActionBarContainer) findViewById(C4337R.id.split_action_bar);
    }
  }
  ...
  public void setUiOptions(int uiOptions) {
    ...
    if (splitWhenNarrow) {
      splitActionBar =
          getContext().getResources().getBoolean(C4337R.bool.split_action_bar_is_narrow);
    }
    if (splitActionBar) {
      pullChildren();
      if (this.mActionBarBottom != null && this.mDecorToolbar.canSplit()) {
        ...
        ActionBarContextView cab =
            (ActionBarContextView) findViewById(C4337R.id.action_context_bar);
