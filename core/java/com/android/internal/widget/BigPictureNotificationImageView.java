    ...
    this.mMaximumDrawableWidth =
        context
            ...
            .getDimensionPixelSize(
                isLowRam
                    ? C4337R.dimen.notification_big_picture_max_width_low_ram
                    : C4337R.dimen.notification_big_picture_max_width);
    this.mMaximumDrawableHeight =
        context
            .getResources()
            .getDimensionPixelSize(
                isLowRam
                    ? C4337R.dimen.notification_big_picture_max_height_low_ram
                    : C4337R.dimen.notification_big_picture_max_height);
  }
  ...
  private Drawable loadImage(Icon icon) {
    ...
    Drawable drawable =
        LocalImageResolver.resolveImage(
            icon, this.mContext, this.mMaximumDrawableWidth, this.mMaximumDrawableHeight);
    if (drawable == null) {
