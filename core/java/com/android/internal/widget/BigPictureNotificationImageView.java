...
public class BigPictureNotificationImageView extends ImageView {
    ...
    public BigPictureNotificationImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mMaximumDrawableWidth = context.getResources().getDimensionPixelSize(isLowRam ? C4337R.dimen.notification_big_picture_max_width_low_ram : C4337R.dimen.notification_big_picture_max_width);
        this.mMaximumDrawableHeight = context.getResources().getDimensionPixelSize(isLowRam ? C4337R.dimen.notification_big_picture_max_height_low_ram : C4337R.dimen.notification_big_picture_max_height);
    }
