...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected int getHorizontalSnapPreference() {
        ...
        if (pointF == null || pointF.f87x == 0.0f) {
            return 0;
        }
        return this.mTargetVector.f87x > 0.0f ? 1 : -1;
    }

    protected int getVerticalSnapPreference() {
        PointF pointF = this.mTargetVector;
        if (pointF == null || pointF.f88y == 0.0f) {
            return 0;
        }
        return this.mTargetVector.f88y > 0.0f ? 1 : -1;
    }

    protected void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        PointF scrollVector = computeScrollVectorForPosition(getTargetPosition());
        if (scrollVector == null || (scrollVector.f87x == 0.0f && scrollVector.f88y == 0.0f)) {
            ...
            this.mInterimTargetDx = (int) (scrollVector.f87x * 10000.0f);
            this.mInterimTargetDy = (int) (scrollVector.f88y * 10000.0f);
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        ...
        Log.m102w(TAG, "You should override computeScrollVectorForPosition when the LayoutManager does not implement " + RecyclerView.SmoothScroller.ScrollVectorProvider.class.getCanonicalName());
        return null;
    }
}
