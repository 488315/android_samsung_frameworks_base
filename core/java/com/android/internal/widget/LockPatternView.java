...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.LockPatternView, C4337R.attr.lockPatternStyle, C4337R.style.Widget_LockPatternView);
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C4337R.dimen.lock_pattern_dot_line_width);
        this.mPathWidth = dimensionPixelSize;
        paint2.setStrokeWidth(dimensionPixelSize);
        this.mLineFadeOutAnimationDurationMs = getResources().getInteger(C4337R.integer.lock_pattern_line_fade_out_duration);
        this.mLineFadeOutAnimationDelayMs = getResources().getInteger(C4337R.integer.lock_pattern_line_fade_out_delay);
        this.mDotSize = getResources().getDimensionPixelSize(C4337R.dimen.lock_pattern_dot_size);
        this.mDotSizeActivated = getResources().getDimensionPixelSize(C4337R.dimen.lock_pattern_dot_size_activated);
        ...
        if (z) {
            ...
            this.mNotSelectedDrawable = getResources().getDrawable(C4337R.drawable.lockscreen_notselected);
        }
        ...
        int fadeAwayGradientWidth = getResources().getDimensionPixelSize(C4337R.dimen.lock_pattern_fade_away_gradient_width);
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        public void onPopulateAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (!LockPatternView.this.mPatternInProgress) {
                CharSequence contentDescription = LockPatternView.this.getContext().getText(C4337R.string.lockscreen_access_pattern_area);
        ...
        private CharSequence getTextForVirtualView(int virtualViewId) {
            ...
            return res.getString(C4337R.string.lockscreen_access_pattern_cell_added_verbose, Integer.valueOf(virtualViewId));
        }
