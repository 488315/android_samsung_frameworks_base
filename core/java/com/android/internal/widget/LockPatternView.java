...
public class LockPatternView extends View {
  ...
  public static final class Cell {
    ...
    /* renamed from: of */
    public static Cell m229of(int row, int column) {
      checkRange(row, column);
  ...
  public LockPatternView(Context context, AttributeSet attrs) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs,
            C4337R.styleable.LockPatternView,
            C4337R.attr.lockPatternStyle,
            C4337R.style.Widget_LockPatternView);
    ...
    int dimensionPixelSize =
        getResources().getDimensionPixelSize(C4337R.dimen.lock_pattern_dot_line_width);
    this.mPathWidth = dimensionPixelSize;
    paint2.setStrokeWidth(dimensionPixelSize);
    this.mLineFadeOutAnimationDurationMs =
        getResources().getInteger(C4337R.integer.lock_pattern_line_fade_out_duration);
    this.mLineFadeOutAnimationDelayMs =
        getResources().getInteger(C4337R.integer.lock_pattern_line_fade_out_delay);
    this.mDotSize = getResources().getDimensionPixelSize(C4337R.dimen.lock_pattern_dot_size);
    this.mDotSizeActivated =
        getResources().getDimensionPixelSize(C4337R.dimen.lock_pattern_dot_size_activated);
    TypedValue outValue = new TypedValue();
    getResources().getValue(C4337R.dimen.lock_pattern_dot_hit_factor, outValue, true);
    this.mDotHitFactor = Math.max(Math.min(outValue.getFloat(), 1.0f), 0.2f);
    boolean z = getResources().getBoolean(C4337R.bool.use_lock_pattern_drawable);
    this.mUseLockPatternDrawable = z;
    if (z) {
      this.mSelectedDrawable = getResources().getDrawable(C4337R.drawable.lockscreen_selected);
      this.mNotSelectedDrawable =
          getResources().getDrawable(C4337R.drawable.lockscreen_notselected);
    }
    ...
    int fadeAwayGradientWidth =
        getResources().getDimensionPixelSize(C4337R.dimen.lock_pattern_fade_away_gradient_width);
    this.mFadeOutGradientShader =
        new LinearGradient(
            (-fadeAwayGradientWidth) / 2.0f,
            0.0f,
            fadeAwayGradientWidth / 2.0f,
            0.0f,
            0,
  ...
  public void startCellStateAnimation(
      CellState cellState,
      float startAlpha,
      float endAlpha,
  ...
  private void startCellStateAnimationSw(
    ...
    animator.addUpdateListener(
        new ValueAnimator
            .AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView.1
          ...
          public void onAnimationUpdate(ValueAnimator animation) {
            ...
            cellState.radius =
                (LockPatternView.this.mDotSize / 2) * (((1.0f - t) * startScale) + (endScale * t));
            LockPatternView.this.invalidate();
          }
        });
    animator.addListener(
        new AnimatorListenerAdapter() { // from class: com.android.internal.widget.LockPatternView.2
  ...
  private void startCellStateAnimationHw(
      final CellState cellState,
      float startAlpha,
      float endAlpha,
      float startTranslationY,
    ...
    cellState.hwCenterY =
        CanvasProperty.createFloat(getCenterYForRow(cellState.row) + startTranslationY);
    ...
    startRtFloatAnimation(
        cellState.hwCenterY,
        getCenterYForRow(cellState.row) + endTranslationY,
        delay,
        duration,
        interpolator);
    startRtFloatAnimation(
        cellState.hwRadius, (this.mDotSize / 2) * endScale, delay, duration, interpolator);
    startRtAlphaAnimation(
        cellState,
        endAlpha,
        delay,
        duration,
        interpolator,
        new AnimatorListenerAdapter() { // from class: com.android.internal.widget.LockPatternView.3
          @Override // android.animation.AnimatorListenerAdapter,
                    // android.animation.Animator.AnimatorListener
          public void onAnimationEnd(Animator animation) {
  ...
  private void startRtAlphaAnimation(
      CellState cellState,
      float endAlpha,
      long delay,
      long duration,
    ...
    RenderNodeAnimator animator =
        new RenderNodeAnimator(cellState.hwPaint, 1, (int) (255.0f * endAlpha));
    animator.setDuration(duration);
    animator.setStartDelay(delay);
    animator.setInterpolator(interpolator);
  ...
  private void startRtFloatAnimation(
      CanvasProperty<Float> property,
      float endValue,
      long delay,
      long duration,
      Interpolator interpolator) {
  ...
  protected void notifyPatternStarted() {
    sendAccessEvent(C4337R.string.lockscreen_access_pattern_start);
    OnPatternListener onPatternListener = this.mOnPatternListener;
    if (onPatternListener != null) {
  ...
  private void notifyPatternDetected() {
    sendAccessEvent(C4337R.string.lockscreen_access_pattern_detected);
    OnPatternListener onPatternListener = this.mOnPatternListener;
    if (onPatternListener != null) {
  ...
  private void notifyPatternCleared() {
    sendAccessEvent(C4337R.string.lockscreen_access_pattern_cleared);
    OnPatternListener onPatternListener = this.mOnPatternListener;
    if (onPatternListener != null) {
  ...
  protected void onSizeChanged(int w, int h, int oldw, int oldh) {
    ...
    this.mExploreByTouchHelper.invalidateRoot();
    this.mDotHitRadius =
        Math.min(this.mSquareHeight / 2.0f, this.mSquareWidth / 2.0f) * this.mDotHitFactor;
  ...
  protected Cell detectAndAddHit(float x, float y) {
    ...
    if (cell != null) {
      ...
      if (!pattern.isEmpty()) {
        ...
        fillInGapCell = Cell.m229of(fillInRow, fillInColumn);
      }
      if (fillInGapCell != null
          && !this.mPatternDrawLookup[fillInGapCell.row][fillInGapCell.column]) {
  ...
  private void startCellActivatedAnimation(Cell cell) {
    ...
    AnimatorSet.Builder animatorSetBuilder =
        animatorSet
            ...
            .with(
                createLineEndAnimation(
                    cellState,
                    this.mInProgressX,
                    this.mInProgressY,
                    getCenterXForColumn(cell.column),
    ...
    animatorSet.addListener(
        new AnimatorListenerAdapter() { // from class: com.android.internal.widget.LockPatternView.4
          @Override // android.animation.AnimatorListenerAdapter,
                    // android.animation.Animator.AnimatorListener
          public void onAnimationEnd(Animator animation) {
  ...
  private Animator createDotActivationColorAnimation(final CellState cellState) {
    ValueAnimator.AnimatorUpdateListener updateListener =
        new ValueAnimator
            .AnimatorUpdateListener() { // from class:
                                        // com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda2
          @Override // android.animation.ValueAnimator.AnimatorUpdateListener
          public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            LockPatternView.this.lambda$createDotActivationColorAnimation$0(
                cellState, valueAnimator);
          }
        };
    ...
    set.play(deactivateAnimator)
        .after((this.mLineFadeOutAnimationDelayMs + this.mLineFadeOutAnimationDurationMs) - 100)
        .after(activateAnimator);
    return set;
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$createDotActivationColorAnimation$0(
  ...
  private Animator createLineEndAnimation(
    ...
    valueAnimator.addUpdateListener(
        new ValueAnimator
            .AnimatorUpdateListener() { // from class:
                                        // com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda0
          @Override // android.animation.ValueAnimator.AnimatorUpdateListener
          public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
            LockPatternView.this.lambda$createLineEndAnimation$1(
                state, startX, targetX, startY, targetY, valueAnimator2);
          }
        });
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$createLineEndAnimation$1(
      CellState state,
      float startX,
      float targetX,
      float startY,
  ...
  private Animator createLineDisappearingAnimation() {
    ...
    valueAnimator.addUpdateListener(
        new ValueAnimator
            .AnimatorUpdateListener() { // from class:
                                        // com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda3
          @Override // android.animation.ValueAnimator.AnimatorUpdateListener
          public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
  ...
  private Animator createDotRadiusAnimation(final CellState state) {
    ...
    ValueAnimator.AnimatorUpdateListener animatorUpdateListener =
        new ValueAnimator
            .AnimatorUpdateListener() { // from class:
                                        // com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda1
          @Override // android.animation.ValueAnimator.AnimatorUpdateListener
          public final void onAnimationUpdate(ValueAnimator valueAnimator) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$createDotRadiusAnimation$3(
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (this.mPatternDisplayMode == DisplayMode.Animate) {
      ...
      int spotInCycle =
          ((int) (SystemClock.elapsedRealtime() - this.mAnimatingPeriodStart)) % oneCycle;
    ...
    if (drawPath) {
      ...
      while (true) {
        ...
        if (i3 == 0) {
          ...
          count = count2;
          drawLineSegment(
              canvas, lastX2, lastY2, endX, endY, this.mLineFadeStart[i3], elapsedRealtime);
        }
        lastX2 = centerX2;
        lastY2 = centerY2;
        i3 = i + 1;
      ...
      if ((this.mPatternInProgress || this.mPatternDisplayMode == DisplayMode.Animate)
        ...
        this.mPathPaint.setAlpha(
            (int)
                (calculateLastSegmentAlpha(this.mInProgressX, this.mInProgressY, lastX, lastY)
                    * 255.0f));
      ...
      for (int j = 0; j < 3; j++) {
        ...
        if (this.mUseLockPatternDrawable) {
          ...
          recordingCanvas.drawCircle(
              cellState.hwCenterX, cellState.hwCenterY, cellState.hwRadius, cellState.hwPaint);
        }
      }
    }
  }
  ...
  private void drawLineSegment(
    ...
    if (this.mFadePattern) {
      ...
      float fadeAwayProgress = Math.max(((elapsedRealtime - lineFadeStart) - i) / i2, 0.0f);
  ...
  private void drawFadingAwayLineSegment(
      Canvas canvas, float startX, float startY, float endX, float endY, float fadeAwayProgress) {
    ...
    canvas.drawLine(
        (-segmentLength) * fadeAwayProgress,
        0.0f,
        segmentLength * (1.0f - fadeAwayProgress),
        0.0f,
        this.mPathPaint);
    canvas.restore();
  ...
  private int getCurrentColor(boolean partOfPattern) {
    ...
    if (this.mPatternDisplayMode == DisplayMode.Correct
        || this.mPatternDisplayMode == DisplayMode.Animate) {
  ...
  private void drawCellDrawable(Canvas canvas, int i, int j, float radius, boolean partOfPattern) {
    Rect dst =
        new Rect(
            (int) (this.mPaddingLeft + (j * this.mSquareWidth)),
            (int) (this.mPaddingTop + (i * this.mSquareHeight)),
            (int) (this.mPaddingLeft + ((j + 1) * this.mSquareWidth)),
            (int) (this.mPaddingTop + ((i + 1) * this.mSquareHeight)));
  ...
  public Parcelable onSaveInstanceState() {
    ...
    return new SavedState(
        superState,
        patternString,
        this.mPatternDisplayMode.ordinal(),
        this.mInputEnabled,
        this.mInStealthMode);
  }
  ...
  private static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: com.android.internal.widget.LockPatternView.SavedState.1
  ...
  private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
    ...
    public void onPopulateAccessibilityEvent(View host, AccessibilityEvent event) {
      ...
      if (!LockPatternView.this.mPatternInProgress) {
        CharSequence contentDescription =
            LockPatternView.this.getContext().getText(C4337R.string.lockscreen_access_pattern_area);
    ...
    private CharSequence getTextForVirtualView(int virtualViewId) {
      ...
      return res.getString(
          C4337R.string.lockscreen_access_pattern_cell_added_verbose,
          Integer.valueOf(virtualViewId));
    }
