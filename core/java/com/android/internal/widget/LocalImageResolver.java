...
public class LocalImageResolver {
  ...
  private static Drawable resolveImage(
    ...
    try {
      ...
      Log.m94d(TAG, "Couldn't use ImageDecoder for drawable, falling back to non-resized load.");
      return null;
    }
  }
  ...
  public static Resources resolveResourcesForIcon(Context context, Icon icon) {
    ...
    try {
      ...
      Log.m96e(TAG, String.format("Unable to resolve package %s for icon %s", resPackage, icon));
      return null;
    }
  }
}
