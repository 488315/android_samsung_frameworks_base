...
public class ResolverDrawerLayout extends ViewGroup {
  ...
  public ResolverDrawerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.ResolverDrawerLayout, defStyleAttr, 0);
  ...
  private boolean updateCollapseOffset(int oldCollapsibleHeight, boolean remainClosed) {
    ...
    if (isLaidOut()) {
      ...
      if (remainClosed
          && oldCollapsibleHeight < (i = this.mCollapsibleHeight)
          && f == oldCollapsibleHeight) {
        setCollapseOffset(i);
      } else {
  ...
  public boolean onTouchEvent(MotionEvent ev) {
    ...
    switch (action) {
      ...
      case 2:
        ...
        if (index < 0) {
          Log.m96e(TAG, "Bad pointer id " + this.mActivePointerId + ", resetting");
          index = 0;
          this.mActivePointerId = ev.getPointerId(0);
  ...
  private float performDrag(float dy) {
    ...
    float newPos =
        Math.max(
            0.0f,
            Math.min(
                this.mCollapseOffset + dy, this.mCollapsibleHeight + this.mUncollapsibleHeight));
    float f = this.mCollapseOffset;
    if (newPos == f) {
      return 0.0f;
    }
    ...
    if (isCollapsedOld != isCollapsedNew) {
      ...
      getMetricsLogger()
          .write(
              new LogMaker(MetricsProto.MetricsEvent.ACTION_SHARESHEET_COLLAPSED_CHANGED)
      ...
      if (lp2.alwaysShow || child2.getVisibility() == i3) {
        ...
        if (lp2.maxHeight != i2) {
          ...
          measureChildWithMargins(
              ...
              0,
              makeMeasureSpec,
              lp2.maxHeight > remainingHeight2 ? lp2.maxHeight - remainingHeight2 : i4);
        } else {
          i5 = i4;
          i6 = i3;
          i7 = i2;
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    if (this.mScrollIndicatorDrawable != null) {
      ...
      this.mScrollIndicatorDrawable.setBounds(
          left2, bottom2 - this.mScrollIndicatorDrawable.getIntrinsicHeight(), right3, bottom2);
  ...
  public static class LayoutParams extends ViewGroup.MarginLayoutParams {
    ...
    public LayoutParams(Context c, AttributeSet attrs) {
      super(c, attrs);
      TypedArray a =
          c.obtainStyledAttributes(attrs, C4337R.styleable.ResolverDrawerLayout_LayoutParams);
