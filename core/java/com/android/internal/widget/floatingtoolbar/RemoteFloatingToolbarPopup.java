...
public final class RemoteFloatingToolbarPopup implements FloatingToolbarPopup {
  ...
  private final SelectionToolbarCallbackImpl mSelectionToolbarCallback =
      new SelectionToolbarCallbackImpl(this);
  ...
  public RemoteFloatingToolbarPopup(Context context, View parent) {
    ...
    this.mSelectionToolbarManager =
        (SelectionToolbarManager) context.getSystemService(SelectionToolbarManager.class);
  ...
  public void show(
    ...
    if (isShowing()
        && Objects.equals(menuItems, this.mMenuItems)
        && Objects.equals(contentRect, this.mPreviousContentRect)) {
      if (DEBUG) {
        Log.m100v(
            FloatingToolbar.FLOATING_TOOLBAR_TAG, "Ignore duplicate show() for the same content.");
        return;
      }
      return;
    }
    ...
    boolean isLayoutRequired =
        list == null || !MenuItemRepr.reprEquals(menuItems, list) || this.mWidthChanged;
    if (isLayoutRequired) {
    ...
    ShowInfo showInfo =
        new ShowInfo(
            this.mFloatingToolbarToken,
            isLayoutRequired,
            getToolbarMenuItems(this.mMenuItems),
            contentRect,
            suggestWidth,
            this.mScreenViewPort,
            this.mParent.getViewRootImpl().getInputToken(),
            this.mIsLightTheme);
    if (DEBUG) {
      Log.m100v(
    ...
    for (MenuItem menuItem : menuItems) {
      ToolbarMenuItem toolbarMenuItem =
          new ToolbarMenuItem.Builder(
                  ...
                  ToolbarMenuItem.getPriorityFromMenuItem(menuItem))
              .build();
  ...
  public void onShow(final WidgetInfo info) {
    runOnUiThread(
        new Runnable() { // from class:
                         // com.android.internal.widget.floatingtoolbar.RemoteFloatingToolbarPopup$$ExternalSyntheticLambda2
  ...
  public void onWidgetUpdated(final WidgetInfo info) {
    runOnUiThread(
        new Runnable() { // from class:
                         // com.android.internal.widget.floatingtoolbar.RemoteFloatingToolbarPopup$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$onWidgetUpdated$1(WidgetInfo info) {
    if (!isShowing()) {
      Log.m102w(
          FloatingToolbar.FLOATING_TOOLBAR_TAG, "onWidgetUpdated(): The widget isn't showing.");
      return;
    }
    updatePopupWindowContent(info);
    Rect contentRect = info.getContentRect();
  ...
  public void onToolbarShowTimeout() {
    runOnUiThread(
        new Runnable() { // from class:
                         // com.android.internal.widget.floatingtoolbar.RemoteFloatingToolbarPopup$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void onMenuItemClicked(final ToolbarMenuItem toolbarMenuItem) {
    runOnUiThread(
        new Runnable() { // from class:
                         // com.android.internal.widget.floatingtoolbar.RemoteFloatingToolbarPopup$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  private static class SelectionToolbarCallbackImpl extends ISelectionToolbarCallback.Stub {
    ...
    public void onShown(WidgetInfo info) {
      if (RemoteFloatingToolbarPopup.DEBUG) {
        Log.m100v(
            FloatingToolbar.FLOATING_TOOLBAR_TAG, "SelectionToolbarCallbackImpl onShown: " + info);
      }
  ...
  static final class MenuItemRepr {
    ...
    public int hashCode() {
      return Objects.hash(
          Integer.valueOf(this.mItemId), Integer.valueOf(this.mGroupId), this.mTitle, this.mIcon);
    }
    ...
    public boolean equals(Object o) {
      ...
      return this.mItemId == other.mItemId
          ...
          && TextUtils.equals(this.mTitle, other.mTitle)
