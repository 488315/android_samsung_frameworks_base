...
public class LockPatternUtils {
    ...
    public DevicePolicyManager getDevicePolicyManager() {
        if (this.mDevicePolicyManager == null) {
            ...
            if (devicePolicyManager == null) {
                Log.m97e(TAG, "Can't get DevicePolicyManagerService: is it running?", new IllegalStateException("Stack trace:"));
            }
        }
    ...
    private TrustManager getTrustManager() {
        ...
        if (trust == null) {
            Log.m97e(TAG, "Can't get TrustManagerService: is it running?", new IllegalStateException("Stack trace:"));
        }
        return trust;
    }
    ...
    public boolean isLockScreenDisabled(int userId) {
        ...
        boolean disabledByDefault = this.mContext.getResources().getBoolean(C4337R.bool.config_disableLockscreenByDefault);
    ...
    public void setVisiblePatternEnabled(boolean enabled, int userId) {
        if (isVisiblePatternDisabledByMDMAsUser(userId) && enabled) {
            Log.m96e(TAG, "setVisiblePatternEnabled() : Could not enable visible pattern by MDM admin. user : " + userId);
        } else {
    ...
    public static boolean frpCredentialEnabled(Context context) {
        return context.getResources().getBoolean(C4337R.bool.config_enableCredentialFactoryResetProtection);
    }
    ...
    public long getCarrierLockoutAttemptDeadline(int userId) {
        ...
        if (deadline - now > SKT_LOCKOUT_ATTEMPT_DEFAULT_TIMEOUT) {
            Log.m96e(TAG, "getCarrierLockoutAttemptDeadline : Need to adjust deadline " + (deadline - now) + " to " + SKT_LOCKOUT_ATTEMPT_DEFAULT_TIMEOUT);
    ...
    public void setBiometricState(int biometricType, int state, int userId) {
        ...
        Log.m94d(TAG, "setBiometricState ( oldValue = " + Integer.toHexString(oldValue) + " , newValue = " + Integer.toHexString(newValue) + " )");
