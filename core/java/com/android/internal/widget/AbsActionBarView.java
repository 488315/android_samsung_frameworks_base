...
public abstract class AbsActionBarView extends ViewGroup {
  ...
  public Animator setupAnimatorToVisibility(int visibility, long duration) {
    ...
    if (visibility == 0) {
      ...
      ObjectAnimator anim =
          ObjectAnimator.ofFloat(this, (Property<AbsActionBarView, Float>) View.ALPHA, 1.0f);
  ...
  protected int measureChildView(View child, int availableWidth, int childSpecHeight, int spacing) {
    child.measure(
        View.MeasureSpec.makeMeasureSpec(availableWidth, Integer.MIN_VALUE), childSpecHeight);
