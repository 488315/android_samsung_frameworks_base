...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(C4337R.layout.action_bar_up_container, (ViewGroup) this, false);
    ...
    public void setSplitToolbar(boolean splitActionBar) {
        if (this.mSplitActionBar != splitActionBar) {
            ...
            if (this.mActionMenuPresenter != null) {
                if (!splitActionBar) {
                    this.mActionMenuPresenter.setExpandedActionViewsExclusive(getResources().getBoolean(C4337R.bool.action_bar_expanded_action_views_exclusive));
                } else {
    ...
    private CharSequence buildHomeContentDescription() {
        ...
        if (!TextUtils.isEmpty(title)) {
            if (!TextUtils.isEmpty(subtitle)) {
                String result = getResources().getString(C4337R.string.action_bar_home_subtitle_description_format, title, subtitle, homeDesc);
                return result;
            }
            String result2 = getResources().getString(C4337R.string.action_bar_home_description_format, title, homeDesc);
            return result2;
        }
        return homeDesc;
    }
    ...
    public void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            LinearLayout linearLayout = (LinearLayout) inflater.inflate(C4337R.layout.action_bar_title_item, (ViewGroup) this, false);
