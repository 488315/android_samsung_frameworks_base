...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
  ...
  public ActionBarView(Context context, AttributeSet attrs) {
    ...
    this.mDefaultUpDescription = C4337R.string.action_bar_up_description;
    View.OnClickListener onClickListener =
        new View.OnClickListener() { // from class: com.android.internal.widget.ActionBarView.1
    ...
    View.OnClickListener onClickListener2 =
        new View.OnClickListener() { // from class: com.android.internal.widget.ActionBarView.2
          @Override // android.view.View.OnClickListener
          public void onClick(View v) {
            if (ActionBarView.this.mMenuPrepared) {
              ActionBarView.this.mWindowCallback.onMenuItemSelected(
                  0, ActionBarView.this.mLogoNavItem);
            }
          }
        };
    this.mUpClickListener = onClickListener2;
    setBackgroundResource(0);
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ActionBar, 16843470, 0);
    ...
    int homeResId = a.getResourceId(16, C4337R.layout.action_bar_home);
    ViewGroup viewGroup =
        (ViewGroup)
            inflater.inflate(C4337R.layout.action_bar_up_container, (ViewGroup) this, false);
    ...
    this.mExpandedHomeLayout.setContentDescription(
        getResources().getText(this.mDefaultUpDescription));
  ...
  public void initProgress() {
    ...
    progressBar.setId(C4337R.id.progress_horizontal);
  ...
  public void initIndeterminateProgress() {
    ProgressBar progressBar =
        new ProgressBar(this.mContext, null, 0, this.mIndeterminateProgressStyle);
    this.mIndeterminateProgressView = progressBar;
    progressBar.setId(C4337R.id.progress_circular);
  ...
  public void setSplitToolbar(boolean splitActionBar) {
    if (this.mSplitActionBar != splitActionBar) {
      ...
      if (this.mActionMenuPresenter != null) {
        if (!splitActionBar) {
          this.mActionMenuPresenter.setExpandedActionViewsExclusive(
              getResources().getBoolean(C4337R.bool.action_bar_expanded_action_views_exclusive));
        } else {
  ...
  public void setMenu(Menu menu, MenuPresenter.Callback cb) {
    ...
    if (this.mActionMenuPresenter == null) {
      ...
      this.mActionMenuPresenter.setId(C4337R.id.action_menu_presenter);
    ...
    if (textView != null) {
      ...
      boolean visible =
          (this.mExpandedActionView != null
                  || (this.mDisplayOptions & 8) == 0
                  || (TextUtils.isEmpty(this.mTitle) && TextUtils.isEmpty(this.mSubtitle)))
              ? false
              : true;
  ...
  private CharSequence buildHomeContentDescription() {
    ...
    if (this.mHomeDescription != null) {
      ...
      homeDesc = this.mContext.getResources().getText(C4337R.string.action_bar_home_description);
    }
    ...
    if (!TextUtils.isEmpty(title)) {
      if (!TextUtils.isEmpty(subtitle)) {
        String result =
            getResources()
                .getString(
                    C4337R.string.action_bar_home_subtitle_description_format,
                    title,
                    subtitle,
                    homeDesc);
        return result;
      ...
      String result2 =
          getResources()
              .getString(C4337R.string.action_bar_home_description_format, title, homeDesc);
      return result2;
    }
    return homeDesc;
  }
      ...
      switch (mode) {
        case 1:
          if (this.mSpinner == null) {
            ...
            spinner.setId(C4337R.id.action_bar_spinner);
  ...
  public void initTitle() {
    if (this.mTitleLayout == null) {
      ...
      LinearLayout linearLayout =
          (LinearLayout)
              inflater.inflate(C4337R.layout.action_bar_title_item, (ViewGroup) this, false);
  ...
  */
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (this.mIsCollapsible) {
      ...
      for (int i2 = 0; i2 < childCount; i2++) {
        ...
        if (child.getVisibility() != 8
            && ((child != this.mMenuView || this.mMenuView.getChildCount() != 0)
                && child != this.mUpGoerFive)) {
          visibleChildren++;
        }
      }
    ...
    boolean showTitle =
        (linearLayout2 == null
                || linearLayout2.getVisibility() == 8
                || (this.mDisplayOptions & 8) == 0)
            ? false
            : true;
    HomeView homeLayout =
        this.mExpandedActionView != null ? this.mExpandedHomeLayout : this.mHomeLayout;
    ...
    if (progressBar2 != null && progressBar2.getVisibility() != 8) {
      availableWidth2 =
          measureChildView(this.mIndeterminateProgressView, availableWidth2, childSpecHeight, 0);
      rightOfCenter =
          Math.max(0, rightOfCenter2 - this.mIndeterminateProgressView.getMeasuredWidth());
    } else {
    ...
    if (this.mExpandedActionView == null) {
      switch (this.mNavigationMode) {
        case 1:
          if (this.mListNavLayout != null) {
            ...
            this.mListNavLayout.measure(
                View.MeasureSpec.makeMeasureSpec(availableWidth4, Integer.MIN_VALUE),
        ...
        case 2:
          if (this.mTabScrollView != null) {
            ...
            ScrollingTabContainerView scrollingTabContainerView = this.mTabScrollView;
            int paddingRight2 =
                View.MeasureSpec.makeMeasureSpec(availableWidth5, Integer.MIN_VALUE);
      ...
      if (customView == null) {
        ...
        int customNavWidth =
            Math.max(
                0,
                (lp.width >= 0 ? Math.min(lp.width, availableWidth2) : availableWidth2)
                    - horizontalMargin);
      ...
      measureChildView(
          ...
          View.MeasureSpec.makeMeasureSpec(this.mContentHeight, 1073741824),
          0);
      ...
      if (progressBar == null && progressBar.getVisibility() != 8) {
        this.mProgressView.measure(
            View.MeasureSpec.makeMeasureSpec(i - (this.mProgressBarPadding * 2), 1073741824),
  ...
  */
    ...
    if (homeLayout.getParent() == this.mUpGoerFive) {
      ...
      int x4 =
          next(
              x3
                  + positionChild(
                      this.mUpGoerFive,
                      next(x3, startOffset, isLayoutRtl),
                      y,
                      contentHeight,
                      isLayoutRtl),
              startOffset,
      ...
      if (this.mExpandedActionView == null) {
        switch (this.mNavigationMode) {
          case 1:
            if (this.mListNavLayout != null) {
              ...
              x =
                  next(
                      x2 + positionChild(this.mListNavLayout, x2, y, contentHeight, isLayoutRtl),
                      this.mItemPadding,
                      isLayoutRtl);
              break;
            }
          ...
          case 2:
            if (this.mTabScrollView != null) {
              ...
              x =
                  next(
                      x5 + positionChild(this.mTabScrollView, x5, y, contentHeight, isLayoutRtl),
                      this.mItemPadding,
                      isLayoutRtl);
              break;
            }
        ...
        if (progressBar2 != null) {
          ...
          progressBar3.layout(
              i2, -halfProgressHeight, progressBar3.getMeasuredWidth() + i2, halfProgressHeight);
          return;
        }
        return;
      }
  ...
  public void onRestoreInstanceState(Parcelable p) {
    ...
    if (state.expandedMenuItemId != 0
        ...
        && (menuBuilder = this.mOptionsMenu) != null
        && (item = menuBuilder.findItem(state.expandedMenuItemId)) != null) {
  ...
  static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: com.android.internal.widget.ActionBarView.SavedState.1
  ...
  private static class HomeView extends FrameLayout {
    ...
    @Override // android.view.View
    protected void onFinishInflate() {
      this.mUpView = (ImageView) findViewById(C4337R.id.f642up);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
      ...
      if (this.mIconView.getVisibility() != 8) {
        ...
        FrameLayout.LayoutParams iconLp =
            (FrameLayout.LayoutParams) this.mIconView.getLayoutParams();
        width += iconLp.leftMargin + this.mIconView.getMeasuredWidth() + iconLp.rightMargin;
        height =
            Math.max(
                height,
                iconLp.topMargin + this.mIconView.getMeasuredHeight() + iconLp.bottomMargin);
      } else if (upMargins < 0) {
        width -= upMargins;
      }
      int widthMode = View.MeasureSpec.getMode(widthMeasureSpec);
  ...
  private class ExpandedActionViewMenuPresenter implements MenuPresenter {
    ...
    public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
      ...
      ActionBarView.this.mExpandedHomeLayout.setIcon(
          ActionBarView.this
              .mIcon
              .getConstantState()
              .newDrawable(ActionBarView.this.getResources()));
