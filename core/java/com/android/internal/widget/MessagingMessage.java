...
public interface MessagingMessage extends MessagingLinearLayout.MessagingChild {
  ...
  default boolean sameAs(Notification.MessagingStyle.Message message) {
    ...
    if (!Objects.equals(message.getText(), ownMessage.getText())
        || !Objects.equals(message.getSender(), ownMessage.getSender())) {
      return false;
    }
    boolean hasRemoteInputHistoryChanged =
        message.isRemoteInputHistory() != ownMessage.isRemoteInputHistory();
    return (hasRemoteInputHistoryChanged
            || Objects.equals(
                Long.valueOf(message.getTimestamp()), Long.valueOf(ownMessage.getTimestamp())))
        && Objects.equals(message.getDataMimeType(), ownMessage.getDataMimeType())
        && Objects.equals(message.getDataUri(), ownMessage.getDataUri());
  }
    ...
    getGroup()
        .performRemoveAnimation(
            ...
            new Runnable() { // from class:
                             // com.android.internal.widget.MessagingMessage$$ExternalSyntheticLambda0
