...
public final class SpringForce implements Force {
  ...
  DynamicAnimation.MassState updateValues(
    ...
    if (displacement2 > 1.0d) {
      ...
      displacement =
          (Math.pow(2.718281828459045d, d * deltaT) * coeffA)
      ...
      double displacement3 =
          Math.pow(2.718281828459045d, (-d5) * deltaT) * (lastDisplacement2 + (coeffB2 * deltaT));
      double pow2 =
          (lastDisplacement2 + (coeffB2 * deltaT))
              * Math.pow(2.718281828459045d, (-this.mNaturalFreq) * deltaT);
      double d6 = this.mNaturalFreq;
      double currentVelocity2 =
          (pow2 * (-d6)) + (Math.pow(2.718281828459045d, (-d6) * deltaT) * coeffB2);
      ...
      double displacement4 =
          Math.pow(2.718281828459045d, (-displacement2) * d8 * deltaT)
