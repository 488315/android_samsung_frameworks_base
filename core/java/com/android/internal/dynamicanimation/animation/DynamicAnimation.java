...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>>
  ...
  /* renamed from: X */
  public static final ViewProperty f666X =
      new ViewProperty(
          "x") { // from class: com.android.internal.dynamicanimation.animation.DynamicAnimation.9
        @Override // android.util.FloatProperty
        public void setValue(View view, float value) {
          view.setX(value);
        }
  ...
  /* renamed from: Y */
  public static final ViewProperty f667Y =
      new ViewProperty(
          "y") { // from class: com.android.internal.dynamicanimation.animation.DynamicAnimation.10
        @Override // android.util.FloatProperty
        public void setValue(View view, float value) {
          view.setY(value);
        }
  ...
  /* renamed from: Z */
  public static final ViewProperty f668Z =
      new ViewProperty(
          "z") { // from class: com.android.internal.dynamicanimation.animation.DynamicAnimation.11
        @Override // android.util.FloatProperty
        public void setValue(View view, float value) {
          view.setZ(value);
        }
  ...
  public boolean doAnimationFrame(long frameTime) {
    ...
    boolean finished =
        updateValueAndVelocity(
            durationScale == 0.0f ? 2147483647L : (long) (deltaT / durationScale));
