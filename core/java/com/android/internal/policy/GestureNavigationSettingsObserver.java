...
public class GestureNavigationSettingsObserver extends ContentObserver {
                ...
                new DeviceConfig
                    ...
                    public void onPropertiesChanged(DeviceConfig.Properties properties) {
                        if ("systemui".equals(properties.getNamespace())
                                && GestureNavigationSettingsObserver.this.mOnChangeRunnable
                                        != null) {
    ...
    public void register() {
        this.mBgHandler.post(
                new Runnable() { // from class:
                                 // com.android.internal.policy.GestureNavigationSettingsObserver$$ExternalSyntheticLambda2
    ...
    public /* synthetic */ void lambda$register$1() {
        ...
        r.registerContentObserver(
                Settings.Secure.getUriFor(Settings.Secure.NAVIGATION_MODE), false, this, -1);
        r.registerContentObserver(
                Settings.Global.getUriFor(Settings.Global.BOTTOM_GESTURE_INSET_SCALE),
                false,
                this,
                -1);
        r.registerContentObserver(
    ...
    public /* synthetic */ void lambda$registerForCallingUser$3() {
        ...
        DeviceConfig.addOnPropertiesChangedListener(
                "systemui",
                new Executor() { // from class:
                                 // com.android.internal.policy.GestureNavigationSettingsObserver$$ExternalSyntheticLambda4
                    @Override // java.util.concurrent.Executor
                    public final void execute(Runnable runnable) {
                        GestureNavigationSettingsObserver.this.lambda$registerForCallingUser$2(
                                runnable);
                    }
                },
                this.mOnPropertiesChangedListener);
    ...
    public void unregister() {
        this.mBgHandler.post(
                new Runnable() { // from class:
                                 // com.android.internal.policy.GestureNavigationSettingsObserver$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        if (defaultInset > 0.0f) {
            backGestureInset =
                    DeviceConfig.getFloat(
                            "systemui",
                            SystemUiDeviceConfigFlags.BACK_GESTURE_EDGE_WIDTH,
                            defaultInset);
        } else {
    ...
    public int getBottomSensitivity(Resources userRes) {
        ...
        DisplayMetrics dm = userRes.getDisplayMetrics();
        float bottomInset =
                userRes.getDimension(R.dimen.navigation_bar_gesture_height) / dm.density;
        float inset = TypedValue.applyDimension(1, bottomInset, dm);
        float scale =
                Settings.Global.getFloat(
                        this.mContext.getContentResolver(),
                        Settings.Global.BOTTOM_GESTURE_INSET_SCALE,
                        1.0f);
