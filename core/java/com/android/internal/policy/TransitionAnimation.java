...
public class TransitionAnimation {
    ...
    private AttributeCache.Entry getCachedAnimations(WindowManager.LayoutParams lp) {
        if (this.mDebug) {
            Slog.m119v(this.mTag, "Loading animations: layout params pkg=" + (lp != null ? lp.packageName : null) + " resId=0x" + (lp != null ? Integer.toHexString(lp.windowAnimations) : null));
        }
    ...
    private AttributeCache.Entry getCachedAnimations(String packageName, int resId) {
        if (this.mDebug) {
            Slog.m119v(this.mTag, "Loading animations: package=" + packageName + " resId=0x" + Integer.toHexString(resId));
        }
        if (packageName != null) {
            if (((-16777216) & resId) == 16777216) {
                packageName = "android";
    ...
    public HardwareBuffer createCrossProfileAppsThumbnail(Drawable thumbnailDrawable, Rect frame) {
        ...
        int thumbnailSize = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.cross_profile_apps_thumbnail_size);
