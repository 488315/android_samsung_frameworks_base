...
public class TransitionAnimation {
  ...
  public TransitionAnimation(Context context, boolean debug, String tag) {
    ...
    this.mClipRevealTranslationY =
        (int) (context.getResources().getDisplayMetrics().density * 8.0f);
  ...
  public Animation loadKeyguardUnoccludeAnimation() {
    if (CoreRune.FW_CUSTOM_OCCLUDE_BASIC_ANIM) {
      return loadDefaultAnimationRes(C4337R.anim.samsung_lock_screen_unocclude);
    }
    return loadDefaultAnimationRes(C4337R.anim.wallpaper_open_exit);
  }

  public Animation loadVoiceActivityOpenAnimation(boolean enter) {
    int i;
    if (enter) {
      i = C4337R.anim.voice_activity_open_enter;
    } else {
      i = C4337R.anim.voice_activity_open_exit;
    }
  ...
  public Animation loadVoiceActivityExitAnimation(boolean enter) {
    int i;
    if (enter) {
      i = C4337R.anim.voice_activity_close_enter;
    } else {
      i = C4337R.anim.voice_activity_close_exit;
    }
    return loadDefaultAnimationRes(i);
  }
  ...
  public Animation loadCrossProfileAppEnterAnimation() {
    return loadAnimationRes("android", C4337R.anim.task_open_enter_cross_profile_apps);
  }

  public Animation loadCrossProfileAppThumbnailEnterAnimation() {
    return loadAnimationRes("android", C4337R.anim.cross_profile_apps_thumbnail_enter);
  }
  ...
  public int getDefaultAnimationResId(int animAttr, int transit) {
    ...
    int resId = 0;
    if (animAttr >= 0
        && (ent = getCachedAnimations("android", this.mDefaultWindowAnimationStyleResId)) != null) {
      resId = ent.array.getResourceId(animAttr, 0);
    }
    return updateToTranslucentAnimIfNeeded(resId, transit);
  }
  ...
  private Animation loadAnimationAttr(
      String packageName, int animStyleResId, int animAttr, boolean translucent, int transit) {
    if (animStyleResId == 0) {
      return null;
    }
    int resId = 0;
    ...
    if (animAttr >= 0) {
      AttributeCache.Entry ent =
          getCachedAnimations(packageName != null ? packageName : "android", animStyleResId);
      if (ent != null) {
        context = ent.context;
        resId = ent.array.getResourceId(animAttr, 0);
      }
  ...
  private AttributeCache.Entry getCachedAnimations(WindowManager.LayoutParams lp) {
    ...
    if (this.mDebug || !"android".equals(packageName)) {
      Slog.m119v(this.mTag, "Loading animations: picked package=" + packageName);
    }
    return AttributeCache.instance().get(packageName, resId, C4337R.styleable.WindowAnimation);
  }
  ...
  private void setupDefaultNextAppTransitionStartRect(Rect startRect, Rect rect) {
    if (startRect == null) {
      Slog.m116e(this.mTag, "Starting rect for app requested, but none available", new Throwable());
      rect.setEmpty();
    } else {
      rect.set(startRect);
    }
  ...
  public Animation createClipRevealAnimationLocked(
    ...
    return createClipRevealAnimationLockedCompat(
        getTransitCompatType(transit, wallpaperTransit), enter, appFrame, displayFrame, startRect);
  }
  ...
  public Animation createClipRevealAnimationLockedCompat(
    ...
    if (enter) {
      ...
      long duration2 =
          calculateClipRevealTransitionDuration(cutOff, translationX, translationY, displayFrame);
      Animation clipAnimLR =
          new ClipRectLRAnimation(clipStartX, this.mTmpRect.width() + clipStartX, 0, appWidth);
  ...
  public Animation createScaleUpAnimationLocked(
      int transit, int wallpaperTransit, boolean enter, Rect containingFrame, Rect startRect) {
      ...
      case 3:
        if (freeform && scaleUp) {
          ...
          if (shouldScaleDownThumbnailTransition(orientation)) {
            ...
            float y =
                (containingFrame.height() / 2.0f) - ((containingFrame.height() / 2.0f) * scale);
            ...
            if (scaleUp) {
              translateAnim =
                  createCurvedMotion(thumbStartX, 0.0f, thumbStartY - contentInsets.top, 0.0f);
            } else {
              translateAnim =
                  createCurvedMotion(0.0f, thumbStartX, 0.0f, thumbStartY - contentInsets.top);
            }
  ...
  public HardwareBuffer createCrossProfileAppsThumbnail(Drawable thumbnailDrawable, Rect frame) {
    ...
    int thumbnailSize =
        this.mContext
            .getResources()
            .getDimensionPixelSize(C4337R.dimen.cross_profile_apps_thumbnail_size);
  ...
  private void getNextAppTransitionStartRect(Rect startRect, Rect defaultStartRect, Rect rect) {
    if (startRect == null && defaultStartRect == null) {
      Slog.m116e(this.mTag, "Starting rect for container not available", new Throwable());
      rect.setEmpty();
    } else {
  ...
  private AnimationSet createAspectScaledThumbnailFreeformAnimationLocked(
    ...
    ScaleAnimation scale =
        enter
            ...
            : new ScaleAnimation(1.0f, scaleH, 1.0f, scaleV, scaleHCenter, scaleVCenter);
  ...
  private static int updateToTranslucentAnimIfNeeded(int anim, int transit) {
    if (transit == 24 && anim == 17432591) {
      return C4337R.anim.activity_translucent_open_enter;
    }
    if (transit == 25 && anim == 17432590) {
      return C4337R.anim.activity_translucent_close_exit;
    }
    return anim;
  }
  ...
  public static Animation loadAnimationSafely(Context context, int resId, String tag) {
    try {
      ...
      Slog.m122w(tag, "Unable to load animation resource", e);
      return null;
    } catch (RuntimeException e2) {
      Slog.m122w(tag, "Unable to load animation resource", e2);
      return null;
    }
  }
  ...
  public static Animation createHiddenByKeyguardExit(
    ...
    if (goingToNotificationShade) {
      return AnimationUtils.loadAnimation(context, C4337R.anim.lock_screen_behind_enter_fade_in);
    }
    if (CoreRune.FW_CUSTOM_KEYGUARD_BASIC_ANIM) {
      ...
      resource = C4337R.anim.lock_screen_behind_enter_subtle;
    } else if (onWallpaper) {
      resource = C4337R.anim.lock_screen_behind_enter_wallpaper;
    } else {
      resource = C4337R.anim.lock_screen_behind_enter;
    }
  ...
  private static int updateToCustomKeyguardAnim(boolean onWallpaper, boolean subtleAnimation) {
    if (subtleAnimation) {
      if (onWallpaper) {
        return C4337R.anim.samsung_lock_screen_behind_enter_wallpaper_subtle;
      }
      return C4337R.anim.samsung_lock_screen_behind_enter_subtle;
    }
    if (onWallpaper) {
      return C4337R.anim.samsung_lock_screen_behind_enter_wallpaper;
    }
    return C4337R.anim.samsung_lock_screen_behind_enter;
  }

  private int updateToCustomAnimIfNeeded(int anim) {
    switch (anim) {
      case C4337R.anim.activity_close_enter /* 17432589 */:
        return C4337R.anim.samsung_activity_close_enter;
      case C4337R.anim.activity_close_exit /* 17432590 */:
        return C4337R.anim.samsung_activity_close_exit;
      case C4337R.anim.activity_open_enter /* 17432591 */:
        return C4337R.anim.samsung_activity_open_enter;
      case C4337R.anim.activity_open_exit /* 17432592 */:
        return C4337R.anim.samsung_activity_open_exit;
      case C4337R.anim.activity_translucent_close_exit /* 17432593 */:
        return C4337R.anim.samsung_activity_translucent_close_exit;
      case C4337R.anim.activity_translucent_open_enter /* 17432594 */:
        return C4337R.anim.samsung_activity_translucent_open_enter;
      case C4337R.anim.task_close_enter /* 17432933 */:
        return C4337R.anim.samsung_task_close_enter;
      case C4337R.anim.task_close_exit /* 17432934 */:
        return C4337R.anim.samsung_task_close_exit;
      case C4337R.anim.task_open_enter /* 17432943 */:
        return C4337R.anim.samsung_task_open_enter;
      case C4337R.anim.task_open_exit /* 17432945 */:
        return C4337R.anim.samsung_task_open_exit;
      case C4337R.anim.wallpaper_close_enter /* 17432958 */:
        return C4337R.anim.samsung_wallpaper_close_enter;
      case C4337R.anim.wallpaper_close_exit /* 17432959 */:
        return C4337R.anim.samsung_wallpaper_close_exit;
      case C4337R.anim.wallpaper_open_enter /* 17432966 */:
        return C4337R.anim.samsung_wallpaper_open_enter;
      case C4337R.anim.wallpaper_open_exit /* 17432967 */:
        return C4337R.anim.samsung_wallpaper_open_exit;
      default:
        return anim;
    }
  }
  ...
  public Animation loadDimAnimation() {
    return loadAnimationRes("android", C4337R.anim.samsung_activity_open_dim_anim);
  }
  ...
  public int updateToCustomCoverAnimIfNeeded(int anim) {
    switch (anim) {
      ...
      case C4337R.anim.task_close_enter /* 17432933 */:
      case C4337R.anim.wallpaper_open_enter /* 17432966 */:
        return C4337R.anim.samsung_cover_screen_task_close_enter;
      case C4337R.anim.activity_close_exit /* 17432590 */:
      case C4337R.anim.task_close_exit /* 17432934 */:
      case C4337R.anim.wallpaper_open_exit /* 17432967 */:
        return C4337R.anim.samsung_cover_screen_task_close_exit;
      case C4337R.anim.activity_open_enter /* 17432591 */:
      case C4337R.anim.task_open_enter /* 17432943 */:
      case C4337R.anim.wallpaper_close_enter /* 17432958 */:
        return C4337R.anim.samsung_cover_screen_task_open_enter;
      case C4337R.anim.activity_open_exit /* 17432592 */:
      case C4337R.anim.task_open_exit /* 17432945 */:
      case C4337R.anim.wallpaper_close_exit /* 17432959 */:
        return C4337R.anim.samsung_cover_screen_task_open_exit;
      default:
        return anim;
    }
  }
