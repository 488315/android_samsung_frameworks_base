    ...
    if (preserveOrientation
      ...
      if (startOrientationWasLandscape) {
        ...
        if (height1 < minVisibleHeight) {
          ...
          width1 =
              Math.max(minVisibleWidth, Math.min(maxVisibleSize.f85x, Math.round(height1 * 1.2f)));
        }
        ...
        if (width2 < minVisibleWidth) {
          ...
          height2 =
              Math.max(minVisibleHeight, Math.min(maxVisibleSize.f86y, Math.round(width2 / 1.2f)));
        }
      } else {
        ...
        if (height12 >= minVisibleHeight) {
          ...
          width1 =
              Math.max(
                  minVisibleWidth,
                  Math.min(maxVisibleSize.f85x, Math.round(minVisibleHeight / 1.2f)));
          height1 = minVisibleHeight;
        }
        height2 = Math.max(minVisibleHeight, Math.min(maxVisibleSize.f86y, height));
