...
public abstract class AbstractSinglePendingRequestRemoteService<
  ...
  public AbstractSinglePendingRequestRemoteService(
      Context context,
  ...
  void handleBindFailure() {
    if (this.mPendingRequest != null) {
      if (this.mVerbose) {
        Slog.m119v(this.mTag, "Sending failure to " + this.mPendingRequest);
      }
  ...
  public void dump(String prefix, PrintWriter pw) {
    ...
    pw.append((CharSequence) prefix)
        .append("hasPendingRequest=")
        .append((CharSequence) String.valueOf(this.mPendingRequest != null))
        .println();
  }
  ...
  void handlePendingRequestWhileUnBound(
    ...
    if (this.mPendingRequest != null) {
      if (this.mVerbose) {
        Slog.m119v(
            this.mTag,
            "handlePendingRequestWhileUnBound(): cancelling "
