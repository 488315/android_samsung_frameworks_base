...
public abstract class AbstractRemoteService<
  ...
  public void dump(String prefix, PrintWriter pw) {
    ...
    if (this.mServiceExitReason != -1) {
      pw.append((CharSequence) prefix)
          ...
          .append((CharSequence) ApplicationExitInfo.reasonCodeToString(this.mServiceExitReason));
      pw.println();
    }
    if (this.mServiceExitSubReason != -1) {
      pw.append((CharSequence) prefix)
          ...
          .append((CharSequence) ApplicationExitInfo.subreasonToString(this.mServiceExitSubReason));
      pw.println();
    }
            ...
            new BiConsumer() { // from class:
              ...
              public final void accept(Object obj, Object obj2) {
                ((AbstractRemoteService) obj)
                    .handlePendingRequest((AbstractRemoteService.BasePendingRequest) obj2);
              }
            },
            this,
            pendingRequest));
    ...
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              ...
              public final void accept(Object obj, Object obj2) {
                ((AbstractRemoteService) obj)
                    .handleFinishRequest((AbstractRemoteService.BasePendingRequest) obj2);
              }
            },
            this,
            finshedRequest));
    ...
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              ...
              public final void accept(Object obj, Object obj2) {
                ((AbstractRemoteService) obj)
                    .handlePendingRequest((AbstractRemoteService.MyAsyncPendingRequest) obj2);
              }
            },
            this,
            asyncRequest));
  ...
  protected void scheduleBind() {
    if (this.mHandler.hasMessages(1)) {
      if (this.mVerbose) {
        Slog.m119v(this.mTag, "scheduleBind(): already scheduled");
        return;
      }
      return;
    }
  ...
  public void scheduleUnbind(boolean delay) {
    ...
    if (unbindDelay <= 0) {
      if (this.mVerbose) {
        Slog.m119v(this.mTag, "not scheduling unbind when value is " + unbindDelay);
        return;
      }
      return;
    }
    ...
    if (this.mVerbose) {
      Slog.m119v(this.mTag, "unbinding in " + unbindDelay + "ms: " + this.mNextUnbind);
    }
  ...
  protected final void handlePendingRequest(BasePendingRequest<S, I> pendingRequest) {
    ...
    if (!handleIsBound()) {
      if (this.mVerbose) {
        Slog.m119v(this.mTag, "handlePendingRequest(): queuing " + pendingRequest);
      }
    ...
    if (this.mVerbose) {
      Slog.m119v(this.mTag, "handlePendingRequest(): " + pendingRequest);
    }
  ...
  public void handleEnsureBound() {
    ...
    if (this.mVerbose) {
      Slog.m119v(this.mTag, "ensureBound()");
    }
    this.mConnecting = true;
    ...
    this.mBound = true;
    if (!willBind) {
      Slog.m121w(this.mTag, "could not bind to " + this.mIntent + " using flags " + flags);
  ...
  private void handleEnsureUnbound() {
    if (handleIsBound() || this.mConnecting) {
      if (this.mVerbose) {
        Slog.m119v(this.mTag, "ensureUnbound()");
      }
      this.mConnecting = false;
      if (handleIsBound()) {
  ...
  private class RemoteServiceConnection implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      if (AbstractRemoteService.this.mVerbose) {
        Slog.m119v(AbstractRemoteService.this.mTag, "onServiceConnected()");
      }
    ...
    public void onServiceDisconnected(ComponentName name) {
      if (AbstractRemoteService.this.mVerbose) {
        Slog.m119v(AbstractRemoteService.this.mTag, "onServiceDisconnected()");
      }
    ...
    public void onBindingDied(ComponentName name) {
      if (AbstractRemoteService.this.mVerbose) {
        Slog.m119v(AbstractRemoteService.this.mTag, "onBindingDied()");
      }
  ...
  private boolean checkIfDestroyed() {
    if (this.mDestroyed && this.mVerbose) {
      Slog.m119v(
          this.mTag,
          "Not handling operation as service for " + this.mComponentName + " is already destroyed");
    }
    return this.mDestroyed;
  }
    ...
    public /* synthetic */ void lambda$new$0(AbstractRemoteService service) {
      synchronized (this.mLock) {
        ...
        if (remoteService != null) {
          Slog.m121w(this.mTag, "timed out after " + service.getRemoteRequestMillis() + " ms");
          remoteService.finishRequest(this);
          onTimeout(remoteService);
          return;
        }
        Slog.m121w(this.mTag, "timed out (no service)");
      }
    }
    ...
    public void run() {
      ...
      try {
        ...
        try {
          ...
          Slog.m121w(TAG, "exception handling async request (" + this + "): " + e);
        }
      } finally {
        finish();
      }
