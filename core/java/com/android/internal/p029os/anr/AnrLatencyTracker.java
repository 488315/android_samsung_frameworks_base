package com.android.internal.p029os.anr;
...
public class AnrLatencyTracker implements AutoCloseable {
  ...
  public String dumpAsCommaSeparatedArrayWithHeader() {
    StringBuilder append =
        new StringBuilder()
            .append("DurationsV5: ")
            .append(this.mAnrTriggerUptime)
            .append(",")
            .append(this.mAppNotRespondingStartUptime - this.mAnrTriggerUptime)
            .append(",")
            .append(this.mAnrRecordPlacedOnQueueUptime - this.mAppNotRespondingStartUptime)
            .append(",")
            .append(this.mAnrProcessingStartedUptime - this.mAnrRecordPlacedOnQueueUptime)
            .append(",")
            .append(this.mDumpStackTracesStartUptime - this.mAnrProcessingStartedUptime)
            .append(",")
            .append(this.mUpdateCpuStatsNowTotalLatency)
            .append(",")
            .append(this.mCurrentPsiStateTotalLatency)
            .append(",")
            .append(this.mProcessCpuTrackerMethodsTotalLatency)
            .append(",")
            .append(this.mCriticalEventLogTotalLatency)
            .append(",")
            .append(this.mGlobalLockTotalContention)
            .append(",")
            .append(this.mPidLockTotalContention)
            .append(",")
            .append(this.mAMSLockTotalContention)
            .append(",")
            .append(this.mProcLockTotalContention)
            .append(",")
            .append(this.mAnrRecordLockTotalContention)
            .append(",")
            .append(this.mAnrQueueSize)
            .append(",");
    ...
    return append
        .append(j - this.mDumpStackTracesStartUptime)
        .append(",")
        .append(this.mTempFileDumpingDuration)
        .append(",")
        .append(this.mTempFileDumpingStartUptime - this.mEarlyDumpRequestSubmissionUptime)
        .append(",")
        .append(this.mEarlyDumpExecutorPidCount)
        .append(",")
        .append(this.mCopyingFirstPidDuration)
        .append(",")
        .append(this.mEarlyDumpStatus)
        .append(",")
        .append(this.mCopyingFirstPidSucceeded ? 1 : 0)
        .append(",")
        .append(this.mPreDumpIfLockTooSlowDuration)
        .append(",")
        .append(this.mNotifyAppUnresponsiveDuration)
        .append(",")
        .append(this.mNotifyWindowUnresponsiveDuration)
        .append("\n\n")
        .toString();
  }
  ...
  public void pushAtom() {
    ...
    FrameworkStatsLog.write(
        ...
        j5 - j4,
        j6 - j5,
        this.mDumpStackTracesStartUptime - j6,
