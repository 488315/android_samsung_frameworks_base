...
import com.android.internal.p029os.PowerProfileProto;
    ...
    private void readPowerValuesFromXml(Context context, int xmlId) {
        ...
        try {
            try {
                ...
                parser.close();
                int[] configResIds = {C4337R.integer.config_bluetooth_idle_cur_ma, C4337R.integer.config_bluetooth_rx_cur_ma, C4337R.integer.config_bluetooth_tx_cur_ma, C4337R.integer.config_bluetooth_operating_voltage_mv};
