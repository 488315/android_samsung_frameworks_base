...
class ZygoteConnection {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:136:0x0253, code lost:
        ...
        throw new com.android.internal.p029os.ZygoteSecurityException("Client may not specify capabilities: permitted=0x" + java.lang.Long.toHexString(r0.mPermittedCapabilities) + ", effective=0x" + java.lang.Long.toHexString(r0.mEffectiveCapabilities));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x0199, code lost:
        ...
        r0 = com.android.internal.p029os.Zygote.forkAndSpecialize(r11, r12, r13, r14, r8, r0, r15, r5, r9, r29, r10, r2, r3, r1, r6, r7, r7, r7);
     */
        ...
        try {
            if (pipeFd == null || pid2 <= 0) {
                ...
                if (innerPid2 > 0) {
                    ...
                    Log.m102w(TAG, "Wrapped process reported a pid that is not a child of the process that we forked: childPid=" + pid2 + " innerPid=" + innerPid2);
                }
            }
            this.mSocketOutStream.writeInt(pid2);
            this.mSocketOutStream.writeBoolean(usingWrapper2);
