      ...
      try {
        ...
        while (true) {
          try {
            ...
            if (fields.length != 11) {
              Slog.m115e(TAG, "Malformed entry in " + sUidIoFile + ": " + line);
            } else {
              try {
                String str = fields[0];
                ...
                Slog.m115e(TAG, "Could not parse entry in " + sUidIoFile + ": " + e.getMessage());
              }
            }
          } finally {
          }
        ...
        Slog.m115e(TAG, "Failed to read " + sUidIoFile + ": " + e2.getMessage());
      }
    } finally {
