...
public class FuseAppLoop implements Handler.Callback {
    ...
    public boolean handleMessage(android.p009os.Message r26) {
        /*
            Method dump skipped, instructions count: 604
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.p029os.FuseAppLoop.handleMessage(android.os.Message):boolean");
    }
