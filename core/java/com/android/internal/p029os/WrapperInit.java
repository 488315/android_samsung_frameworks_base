        ...
        if (fdNum != 0) {
            ...
            try {
                try {
                    ...
                    Slog.m114d(TAG, "Could not write pid of wrapped process to Zygote pipe.", ex);
                }
            } finally {
        ...
        try {
            ...
            if (data[0].permitted != data[0].inheritable || data[1].permitted != data[1].inheritable) {
                ...
                try {
                    ...
                    Slog.m116e(TAG, "RuntimeInit: Failed capset", e);
                    return;
                }
            }
            for (int i = 0; i < 64; i++) {
                ...
                if ((data[dataIndex].inheritable & capMask) != 0) {
                    try {
                        ...
                        Slog.m116e(TAG, "RuntimeInit: Failed to raise ambient capability " + i, ex);
                    }
                }
            }
        } catch (ErrnoException e2) {
            Slog.m116e(TAG, "RuntimeInit: Failed capget", e2);
        }
    }
}
