...
public class ClassLoaderFactory {
  ...
  private static native String createClassloaderNamespace(
      ClassLoader classLoader, int i, String str, String str2, boolean z, String str3, String str4);
  ...
  public static boolean isPathClassLoaderName(String name) {
    return name == null
        || PATH_CLASS_LOADER_NAME.equals(name)
  ...
  public static ClassLoader createClassLoader(
      ...
      List<ClassLoader> sharedLibrariesLoadedAfter) {
    ClassLoader[] arrayOfSharedLibraries;
    ClassLoader[] arrayOfSharedLibrariesLoadedAfterApp;
    if (sharedLibraries != null) {
      arrayOfSharedLibraries =
          (ClassLoader[]) sharedLibraries.toArray(new ClassLoader[sharedLibraries.size()]);
    } else {
  ...
  public static ClassLoader createClassLoader(
    ...
    if (errorMessage != null) {
      throw new UnsatisfiedLinkError(
          "Unable to create namespace for the classloader " + classLoader + ": " + errorMessage);
    }
    return classLoader;
  }
}
