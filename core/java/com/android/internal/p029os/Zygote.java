...
import android.content.p002pm.ProcessInfo;
...
public final class Zygote {
  ...
  static int forkSystemServer(
    ...
    Log.m98i(TAG, "!@Boot_EBS:    Took " + (end - start) + "ms wait for zygote prefork");
    int pid =
  ...
  static Runnable forkUsap(
    ...
    try {
      ...
      int pid =
          nativeForkApp(
              readFD.getInt$(), writeFD.getInt$(), sessionSocketRawFDs, false, isPriorityFork);
      if (pid == 0) {
  ...
  private static Runnable childMain(
      ZygoteCommandBuffer argBuffer, LocalServerSocket usapPoolSocket, FileDescriptor writePipe) {
    ...
    if (argBuffer == null) {
      ...
      try {
        ...
        Log.m96e("AppStartup", ex2.getMessage());
        ...
        if (argBuffer == null) {
          try {
            ...
            try {
              ...
              Log.m96e("USAP", "Failed to close USAP pool socket");
              throw new RuntimeException(ex3);
            }
          } catch (IOException ioEx) {
            Log.m96e("USAP", "Failed to write response to session socket: " + ioEx.getMessage());
          ...
          try {
            ...
            Log.m96e(
                ...
                String.format(
                    ...
                    Integer.valueOf(pid), Integer.valueOf(writePipe.getInt$()), ex4.getMessage()));
  ...
  static void setAppProcessName(ZygoteArguments args, String loggingTag) {
    if (args.mNiceName != null) {
      ...
      Log.m102w(loggingTag, "Unable to set package name.");
    }
  }
  ...
  static void applyInvokeWithSecurityPolicy(ZygoteArguments args, Credentials peer)
    ...
    if (args.mInvokeWith != null && peerUid != 0 && (args.mRuntimeFlags & 1) == 0) {
      throw new ZygoteSecurityException(
          "Peer is permitted to specify an explicit invoke-with wrapper command only for debuggable"
              + " applications.");
    }
  }
