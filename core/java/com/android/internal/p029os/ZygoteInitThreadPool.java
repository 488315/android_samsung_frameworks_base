...
class ZygoteInitThreadPool {
    ...
    ZygoteInitThreadPool(boolean SystemServer) {
        Log.m98i(TAG, "Set ZygoteInitThreadPool as " + PARALLEL_THREAD_COUNT + " + " + this.each_preload_list.size() + " threads");
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x004d, code lost:
        ...
        android.util.Log.m96e(com.android.internal.p029os.ZygoteInitThreadPool.TAG, "!@Time out! kill itself! (" + r17 + android.inputmethodservice.navigationbar.NavigationBarInflaterView.KEY_CODE_END + r16);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0079, code lost:
        ...
        r10 = r0.next();
        android.util.Log.m96e(com.android.internal.p029os.ZygoteInitThreadPool.TAG, "*******Backtrace of Thread: Preload for " + r10.getName() + " *******");
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x00a7, code lost:
        ...
        r14 = r11[r13];
        android.util.Log.m96e(com.android.internal.p029os.ZygoteInitThreadPool.TAG, "    " + r14.toString());
     */
    ...
    */
    ...
    private void preloadInternal(String line) {
        ...
        if (this.isSystemServer) {
            Log.m102w(TAG, "Completed : " + line + " took " + (SystemClock.uptimeMillis() - startTime) + "ms ");
        }
    ...
    */
    public void lambda$parallelPreloadTimeout$1(int start, int end) {
        ...
        while (i2 < end) {
            ...
            Thread.currentThread().setName(threadName + " (preloading: " + line + NavigationBarInflaterView.KEY_CODE_END);
            Trace.traceBegin(16384L, line);
            try {
                ...
                if (timeToLoad >= 50) {
                    try {
                        Log.m100v(TAG, "Class " + line + " was preloaded took to much time: " + timeToLoad + "ms");
        ...
        if (this.isSystemServer) {
            Log.m102w(TAG, "Completed : " + threadName + " took " + (SystemClock.uptimeMillis() - startTime) + "ms ");
        }
        this.threads.remove(Thread.currentThread());
    }
