...
public class LegacyVpnInfo implements Parcelable {
  ...
  public static int stateFromNetworkInfo(NetworkInfo.DetailedState state) {
    switch (C44922.$SwitchMap$android$net$NetworkInfo$DetailedState[state.ordinal()]) {
      case 1:
        break;
      case 2:
        break;
      ...
      case 4:
        break;
      default:
        Log.m102w(TAG, "Unhandled state " + state + " ; treating as disconnected");
        break;
    }
    return 0;
  }
