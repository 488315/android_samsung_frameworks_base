...
public class VpnConfig implements Parcelable {
  ...
  public static final Parcelable.Creator<VpnConfig> CREATOR =
      new Parcelable.Creator<VpnConfig>() { // from class: com.android.internal.net.VpnConfig.1
  ...
  public static Intent getIntentForConfirmation() {
    ...
    ComponentName componentName =
        ComponentName.unflattenFromString(
            Resources.getSystem().getString(C4337R.string.config_customVpnConfirmDialogComponent));
  ...
  public static PendingIntent getIntentForStatusPanelEnterpriseVpn(
    ...
    if (!configOption) {
      ...
      Log.m94d(
          TAG, "getIntentForStatusPanelEnterpriseVpn : config size =  " + mConfigsReceived.size());
    ...
    return PendingIntent.getActivityAsUser(
        context, 0, intent, config == null ? 536870912 : 301989888, null, UserHandle.CURRENT);
  }
