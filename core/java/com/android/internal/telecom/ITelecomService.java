...
public interface ITelecomService extends IInterface {
  ...
  void addCall(
      CallAttributes callAttributes, ICallEventCallback iCallEventCallback, String str, String str2)
      throws RemoteException;
  ...
  public static class Default implements ITelecomService {
    ...
    public PhoneAccountHandle getDefaultOutgoingPhoneAccount(
        String uriScheme, String callingPackage, String callingFeatureId) throws RemoteException {
      return null;
    }
    ...
    public boolean isIncomingCallPermitted(
        PhoneAccountHandle phoneAccountHandle, String callingPackage) throws RemoteException {
      return false;
    }
    ...
    public boolean isInSelfManagedCall(
        String packageName, UserHandle userHandle, String callingPackage) throws RemoteException {
      return false;
    }
          ...
          switch (code) {
            ...
            case 5:
              ...
              ParceledListSlice<PhoneAccountHandle> _result3 =
                  getCallCapablePhoneAccounts(_arg05, _arg13, _arg23);
              reply.writeNoException();
