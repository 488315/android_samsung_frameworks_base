...
public interface IConnectionService extends IInterface {
  ...
  public static class Default implements IConnectionService {
    ...
    public void addConnectionServiceAdapter(
        IConnectionServiceAdapter adapter, Session.Info sessionInfo) throws RemoteException {}
    ...
    public void onAvailableCallEndpointsChanged(
        String activeCallId, List<CallEndpoint> availableCallEndpoints, Session.Info sessionInfo)
        throws RemoteException {}

    @Override // com.android.internal.telecom.IConnectionService
    public void onMuteStateChanged(String activeCallId, boolean isMuted, Session.Info sessionInfo)
        throws RemoteException {}
    ...
    public void addConferenceParticipants(
        String CallId, List<Uri> participants, Session.Info sessionInfo) throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IConnectionService {
            ...
            case 36:
              ...
              Connection.CallFilteringCompletionInfo _arg136 =
                  (Connection.CallFilteringCompletionInfo)
                      data.readTypedObject(Connection.CallFilteringCompletionInfo.CREATOR);
    ...
    private static class Proxy implements IConnectionService {
      ...
      public void onTrackedByNonUiService(
          String callId, boolean isTracked, Session.Info sessionInfo) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
          _data.writeString(callId);
