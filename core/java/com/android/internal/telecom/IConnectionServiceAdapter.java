...
public interface IConnectionServiceAdapter extends IInterface {
  ...
  public static class Default implements IConnectionServiceAdapter {
    ...
    public void setConnectionProperties(
        String callId, int connectionProperties, Session.Info sessionInfo) throws RemoteException {}
    ...
    public void requestCallEndpointChange(
        String callId, CallEndpoint endpoint, ResultReceiver callback, Session.Info sessionInfo)
        throws RemoteException {}
          ...
          switch (code) {
            case 1:
              ...
              ParcelableConnection _arg2 =
                  (ParcelableConnection) data.readTypedObject(ParcelableConnection.CREATOR);
            ...
            case 2:
              ...
              ParcelableConference _arg22 =
                  (ParcelableConference) data.readTypedObject(ParcelableConference.CREATOR);
