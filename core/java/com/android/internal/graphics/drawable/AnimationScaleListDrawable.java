...
public class AnimationScaleListDrawable extends DrawableContainer implements Animatable {
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.AnimationScaleListDrawable);
    updateDensity(r);
    a.recycle();
      ...
      if (type2 != 1) {
        ...
        if (depth >= innerDepth || type2 != 3) {
          if (type2 == 2
            ...
            TypedArray a =
                obtainAttributes(r, theme, attrs, C4337R.styleable.AnimationScaleListDrawableItem);
  ...
  static class AnimationScaleListState extends DrawableContainer.DrawableContainerState {
    ...
    AnimationScaleListState(
        AnimationScaleListState orig, AnimationScaleListDrawable owner, Resources res) {
