...
public final class BackgroundBlurDrawable extends Drawable {
    ...
    static {
        ...
        TAG = simpleName;
        boolean z = Log.isLoggable(simpleName, 3);
        DEBUG = z;
    }

    /* renamed from: com.android.internal.graphics.drawable.BackgroundBlurDrawable$1 */
    class C44541 implements RenderNode.PositionUpdateListener {
        C44541() {
        }
        ...
        public void positionChanged(final long frameNumber, final int left, final int top, final int right, final int bottom) {
            ...
            if (BackgroundBlurDrawable.DEBUG || showDebug) {
                Log.m98i(BackgroundBlurDrawable.TAG, "positionChanged fn=" + frameNumber + " drawable=" + BackgroundBlurDrawable.this + ", left : " + left + ", top : " + top + ", right : " + right + ", bottom : " + bottom);
                ...
                if (callback instanceof View) {
                    ...
                    Log.m98i(BackgroundBlurDrawable.TAG, "positionChanged attached View=" + attachedView + ", viewRoot=" + ((Object) (viewRoot != null ? viewRoot.getTag() : viewRoot)));
                } else {
                    Log.m98i(BackgroundBlurDrawable.TAG, "positionChanged attached callback=" + callback);
                }
            }
            BackgroundBlurDrawable.this.mAggregator.onRenderNodePositionChanged(frameNumber, new Runnable() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$1$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    BackgroundBlurDrawable.C44541.this.lambda$positionChanged$1(showDebug, frameNumber, left, top, right, bottom);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$positionChanged$1(final boolean showDebug, final long frameNumber, int left, int top, int right, int bottom) {
            if (BackgroundBlurDrawable.DEBUG || showDebug) {
                Log.m98i(BackgroundBlurDrawable.TAG, "positionChanged$run fn=" + frameNumber + " dr=BackgroundBlurDrawable@" + BackgroundBlurDrawable.this.hashCode() + " rect=" + BackgroundBlurDrawable.this.mRect);
            }
            BackgroundBlurDrawable.this.mHandler.post(new Runnable() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    BackgroundBlurDrawable.C44541.this.lambda$positionChanged$0(showDebug, frameNumber);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$positionChanged$0(boolean showDebug, long frameNumber) {
            if (BackgroundBlurDrawable.DEBUG || showDebug) {
                Log.m98i(BackgroundBlurDrawable.TAG, "positionChanged$run#2 fn=" + frameNumber + " dr=BackgroundBlurDrawable@" + BackgroundBlurDrawable.this.hashCode() + " rect=" + BackgroundBlurDrawable.this.mRect);
            }
        ...
        public void positionLost(final long frameNumber) {
            ...
            if (BackgroundBlurDrawable.DEBUG || showDebug) {
                Log.m98i(BackgroundBlurDrawable.TAG, "positionLost fn=" + frameNumber + " dr=BackgroundBlurDrawable@" + BackgroundBlurDrawable.this.hashCode() + " rect=" + BackgroundBlurDrawable.this.mRect);
            }
            BackgroundBlurDrawable.this.mAggregator.onRenderNodePositionChanged(frameNumber, new Runnable() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$1$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    BackgroundBlurDrawable.C44541.this.lambda$positionLost$3(showDebug, frameNumber);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$positionLost$3(final boolean showDebug, final long frameNumber) {
            if (BackgroundBlurDrawable.DEBUG || showDebug) {
                Log.m98i(BackgroundBlurDrawable.TAG, "positionLost$run fn=" + frameNumber + " dr=BackgroundBlurDrawable@" + BackgroundBlurDrawable.this.hashCode() + " rect=" + BackgroundBlurDrawable.this.mRect);
            }
            BackgroundBlurDrawable.this.mHandler.post(new Runnable() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$1$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    BackgroundBlurDrawable.C44541.this.lambda$positionLost$2(showDebug, frameNumber);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$positionLost$2(boolean showDebug, long frameNumber) {
            if (BackgroundBlurDrawable.DEBUG || showDebug) {
                Log.m98i(BackgroundBlurDrawable.TAG, "positionLost$run#2 fn=" + frameNumber + " dr=BackgroundBlurDrawable@" + BackgroundBlurDrawable.this.hashCode() + " rect=" + BackgroundBlurDrawable.this.mRect);
            }
            BackgroundBlurDrawable.this.invalidateSelf();
            BackgroundBlurDrawable.this.mAggregator.onBlurDrawableUpdated(BackgroundBlurDrawable.this);
        }
    ...
    private BackgroundBlurDrawable(Aggregator aggregator, boolean showDebug) {
        ...
        this.mScaleY = 1.0f;
        this.mRect = new Rect();
        C44541 c44541 = new C44541();
        this.mPositionUpdateListener = c44541;
        ...
        renderNode.addPositionUpdateListener(c44541);
    ...
    public void draw(Canvas canvas) {
        if (!isVisible() || getAlpha() == 0) {
            if (DEBUG) {
                Log.m98i(TAG, "draw: BackgroundBlurDrawable@" + hashCode() + " bounds=" + getBounds() + ", mRectPath.isEmpty()=" + this.mRectPath.isEmpty() + " isVisible()=" + isVisible() + " getAlpha()=" + getAlpha() + " mAlpha=" + this.mAlpha + " return");
                return;
            }
            return;
        }
        ...
        if (canvas.isHardwareAccelerated()) {
            ...
            if (this.mShowDebug) {
                ...
                if (this.mBlurRadius <= 100) {
                    Log.m98i(TAG, "draw: BackgroundBlurDrawable@" + hashCode() + " bounds=" + getBounds() + ", drawRenderNode w=" + this.mRenderNode.getWidth() + " h=" + this.mRenderNode.getHeight());
                }
            }
            canvas.drawRenderNode(this.mRenderNode);
            return;
        }
        Log.m98i(TAG, "BackgroundBlur is not supported on S/W canvas!!!!");
    }

    public void setScaleX(float scaleX) {
        Log.m94d("BackgroundBlurDrawable", "setScaleX, scaleX : " + scaleX);
        this.mScaleX = scaleX;
        this.mAggregator.onBlurDrawableUpdated(this);
    }

    public void setScaleY(float scaleY) {
        Log.m94d("BackgroundBlurDrawable", "setScaleY, scaleY : " + scaleY);
        this.mScaleY = scaleY;
        this.mAggregator.onBlurDrawableUpdated(this);
    }
    ...
    public boolean setVisible(boolean visible, boolean restart) {
        ...
        if (this.mShowDebug) {
            Log.m98i(TAG, "setVisible: visible=" + visible + " BackgroundBlurDrawable@" + hashCode() + " Callers=" + Debug.getCallers(10));
        }
        if (changed) {
            this.mVisible = visible;
            if (this.mIsTargetView && visible && getAlpha() != 0 && this.mRectPath.isEmpty()) {
                Log.m98i(TAG, "setVisible: mRectPath is empty, need to call updatePath");
                updatePath();
            }
            this.mAggregator.onBlurDrawableUpdated(this);
        }
    ...
    public void setAlpha(int alpha) {
        if (this.mAlpha != alpha / 255.0f) {
            ...
            if (this.mIsTargetView && getAlpha() != 0 && this.mVisible && this.mRectPath.isEmpty()) {
                if (this.mShowDebug) {
                    Log.m98i(TAG, "setAlpha: mRectPath is empty, need to call updatePath mAlpha=" + this.mAlpha + " BackgroundBlurDrawable@" + hashCode() + " Callers=" + Debug.getCallers(10));
                }
                updatePath();
            }
            invalidateSelf();
    ...
    public void setBounds(int left, int top, int right, int bottom) {
        ...
        if (this.mShowDebug) {
            Log.m98i(TAG, "setBounds: BackgroundBlurDrawable@" + hashCode() + " setPosition(" + left + ", " + top + ", " + right + ", " + bottom + NavigationBarInflaterView.KEY_CODE_END + " Callers=" + Debug.getCallers(10));
        }
    ...
    public static final class Aggregator {
        ...
        public BackgroundBlurDrawable createBackgroundBlurDrawable(Context context) {
            ...
            drawable.setBlurRadius(context.getResources().getDimensionPixelSize(C4337R.dimen.default_background_blur_radius));
            return drawable;
        }
        ...
        void onBlurDrawableUpdated(BackgroundBlurDrawable drawable) {
            ...
            if (shouldBeDrawn) {
                ...
                if (!isDrawn) {
                    ...
                    if (showDebug) {
                        Log.m98i(BackgroundBlurDrawable.TAG, "Add BackgroundBlurDrawable@" + drawable.hashCode());
                    } else if (BackgroundBlurDrawable.DEBUG) {
                        Log.m94d(BackgroundBlurDrawable.TAG, "Add " + drawable);
                    }
                } else if (showDebug) {
                    Log.m98i(BackgroundBlurDrawable.TAG, "Update BackgroundBlurDrawable@" + drawable.hashCode());
                } else if (BackgroundBlurDrawable.DEBUG) {
                    Log.m94d(BackgroundBlurDrawable.TAG, "Update " + drawable);
                }
            } else if (!shouldBeDrawn && isDrawn) {
                this.mHasUiUpdates = true;
                this.mDrawables.remove(drawable);
                if (showDebug) {
                    Log.m98i(BackgroundBlurDrawable.TAG, "Remove BackgroundBlurDrawable@" + drawable.hashCode());
                } else if (BackgroundBlurDrawable.DEBUG) {
                    Log.m94d(BackgroundBlurDrawable.TAG, "Remove " + drawable);
                }
            }
            if (this.mOnPreDrawListener == null && (viewRootImpl = this.mViewRoot) != null && viewRootImpl.getView() != null && hasRegions()) {
                if (showDebug) {
                    Log.m98i(BackgroundBlurDrawable.TAG, "registerPreDrawListener");
                }
        ...
        public /* synthetic */ boolean lambda$registerPreDrawListener$1(boolean debug) {
            ...
            if (!hasRegions() && this.mViewRoot.getView() != null) {
                ...
                if (debug) {
                    Log.m98i(BackgroundBlurDrawable.TAG, "removeOnPreDrawListener");
                    return true;
                }
                return true;
            }
        ...
        public boolean hasUpdates() {
            if (BackgroundBlurDrawable.DEBUG) {
                Log.m94d(BackgroundBlurDrawable.TAG, "hasUpdates " + this.mHasUiUpdates);
            }
        ...
        public boolean hasRegions() {
            if (BackgroundBlurDrawable.DEBUG) {
                Log.m94d(BackgroundBlurDrawable.TAG, "hasRegions " + this.mDrawables.size());
            }
        ...
        public float[][] getBlurRegionsForFrameLocked(long frameNumber, BlurRegion[] blurRegionsForFrame, boolean forceUpdate) {
            ...
            if (BackgroundBlurDrawable.DEBUG) {
                Log.m94d(BackgroundBlurDrawable.TAG, "Dispatching " + blurRegionsForFrame.length + " blur regions:");
            }
            ...
            for (int i2 = 0; i2 < blurRegionsArray.length; i2++) {
                ...
                if (BackgroundBlurDrawable.DEBUG) {
                    Log.m94d(BackgroundBlurDrawable.TAG, blurRegionsForFrame[i2].toString());
                }
            }
    ...
    public static final class BlurRegion {
        ...
        BlurRegion(BackgroundBlurDrawable drawable) {
            ...
            if (isShowDebug) {
                Log.m98i(BackgroundBlurDrawable.TAG, "BlurRegion@" + hashCode() + " drawable=" + drawable);
            }
        }
        ...
        float[] toFloatArray() {
            ...
            if (this.showDebug) {
                Log.m98i(BackgroundBlurDrawable.TAG, "toFloatArray: BlurRegion@" + hashCode() + " rect=" + this.rect);
            }
            return floatArray;
        }
