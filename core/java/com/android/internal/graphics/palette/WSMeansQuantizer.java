...
public final class WSMeansQuantizer implements Quantizer {
  ...
  public WSMeansQuantizer(
      int[] inClusters, PointProvider pointProvider, Map<Integer, Integer> inputPixelToCount) {
    int i = 0;
  ...
  public void quantize(int[] pixels, int maxColors) {
    ...
    this.mPoints =
        (float[][]) Array.newInstance((Class<?>) Float.TYPE, this.mInputPixelToCount.size(), 3);
