...
public final class WuQuantizer implements Quantizer {
  ...
  private double variance(Box cube) {
    ...
    double xx =
        ((((((this.mMoments[getIndex(cube.f683r1, cube.f681g1, cube.f679b1)]
                                    - this.mMoments[
                                        getIndex(cube.f683r1, cube.f681g1, cube.f678b0)])
                                - this.mMoments[getIndex(cube.f683r1, cube.f680g0, cube.f679b1)])
                            + this.mMoments[getIndex(cube.f683r1, cube.f680g0, cube.f678b0)])
                        - this.mMoments[getIndex(cube.f682r0, cube.f681g1, cube.f679b1)])
                    + this.mMoments[getIndex(cube.f682r0, cube.f681g1, cube.f678b0)])
                + this.mMoments[getIndex(cube.f682r0, cube.f680g0, cube.f679b1)])
            - this.mMoments[getIndex(cube.f682r0, cube.f680g0, cube.f678b0)];
  ...
  private boolean cut(Box one, Box two) {
    ...
    MaximizeResult maxRResult =
        maximize(one, Direction.RED, one.f682r0 + 1, one.f683r1, wholeR, wholeG, wholeB, wholeW);
    MaximizeResult maxGResult =
        maximize(one, Direction.GREEN, one.f680g0 + 1, one.f681g1, wholeR, wholeG, wholeB, wholeW);
    MaximizeResult maxBResult =
        maximize(one, Direction.BLUE, one.f678b0 + 1, one.f679b1, wholeR, wholeG, wholeB, wholeW);
  ...
  private static int volume(Box cube, int[] moment) {
    return ((((((moment[getIndex(cube.f683r1, cube.f681g1, cube.f679b1)]
                                - moment[getIndex(cube.f683r1, cube.f681g1, cube.f678b0)])
                            - moment[getIndex(cube.f683r1, cube.f680g0, cube.f679b1)])
                        + moment[getIndex(cube.f683r1, cube.f680g0, cube.f678b0)])
                    - moment[getIndex(cube.f682r0, cube.f681g1, cube.f679b1)])
                + moment[getIndex(cube.f682r0, cube.f681g1, cube.f678b0)])
            + moment[getIndex(cube.f682r0, cube.f680g0, cube.f679b1)])
        - moment[getIndex(cube.f682r0, cube.f680g0, cube.f678b0)];
  }

  private static int bottom(Box cube, Direction direction, int[] moment) {
    switch (C44581.f677xfe7d3ccb[direction.ordinal()]) {
      case 1:
        return (((-moment[getIndex(cube.f682r0, cube.f681g1, cube.f679b1)])
                    + moment[getIndex(cube.f682r0, cube.f681g1, cube.f678b0)])
                + moment[getIndex(cube.f682r0, cube.f680g0, cube.f679b1)])
            - moment[getIndex(cube.f682r0, cube.f680g0, cube.f678b0)];
      case 2:
        return (((-moment[getIndex(cube.f683r1, cube.f680g0, cube.f679b1)])
                    + moment[getIndex(cube.f683r1, cube.f680g0, cube.f678b0)])
                + moment[getIndex(cube.f682r0, cube.f680g0, cube.f679b1)])
            - moment[getIndex(cube.f682r0, cube.f680g0, cube.f678b0)];
      case 3:
        return (((-moment[getIndex(cube.f683r1, cube.f681g1, cube.f678b0)])
                    + moment[getIndex(cube.f683r1, cube.f680g0, cube.f678b0)])
                + moment[getIndex(cube.f682r0, cube.f681g1, cube.f678b0)])
            - moment[getIndex(cube.f682r0, cube.f680g0, cube.f678b0)];
      default:
  ...
  private static int top(Box cube, Direction direction, int position, int[] moment) {
    switch (C44581.f677xfe7d3ccb[direction.ordinal()]) {
      case 1:
        return ((moment[getIndex(position, cube.f681g1, cube.f679b1)]
                    - moment[getIndex(position, cube.f681g1, cube.f678b0)])
                - moment[getIndex(position, cube.f680g0, cube.f679b1)])
            + moment[getIndex(position, cube.f680g0, cube.f678b0)];
      case 2:
        return ((moment[getIndex(cube.f683r1, position, cube.f679b1)]
                    - moment[getIndex(cube.f683r1, position, cube.f678b0)])
                - moment[getIndex(cube.f682r0, position, cube.f679b1)])
            + moment[getIndex(cube.f682r0, position, cube.f678b0)];
      case 3:
        return ((moment[getIndex(cube.f683r1, cube.f681g1, position)]
                    - moment[getIndex(cube.f683r1, cube.f680g0, position)])
                - moment[getIndex(cube.f682r0, cube.f681g1, position)])
            + moment[getIndex(cube.f682r0, cube.f680g0, position)];
      default:
        throw new IllegalArgumentException("unexpected direction " + direction);
    }
  }
