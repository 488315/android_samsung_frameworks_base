...
public class ModemPowerProfile {
        ...
        while (XmlUtils.nextElementWithin(parser, depth)) {
            ...
            switch (c) {
                ...
                case 2:
                    ...
                    break;
                default:
                    Slog.m115e(TAG, "Unexpected element parsed: " + name);
                    break;
            }
        }
    }
    ...
    private void parseActivePowerConstantsFromXml(XmlResourceParser parser) throws IOException, XmlPullParserException {
        ...
        try {
                ...
                switch (z) {
                    ...
                    case true:
                        ...
                        if (parser.next() == 4) {
                            ...
                            if (level < 0 || level >= 5) {
                                Slog.m115e(TAG, "Unexpected tx level: " + level + ". Must be between 0 and 4");
                                break;
                            } else {
            ...
            Slog.m116e(TAG, "Failed parse to active modem power constants", iae);
        }
    }
    ...
    public void setPowerConstant(int key, String value) {
        try {
            ...
            Slog.m116e(TAG, "Failed to set power constant 0x" + Integer.toHexString(key) + NavigationBarInflaterView.KEY_CODE_START + keyToString(key) + ") to " + value, e);
        }
    }
    ...
    public double getAverageBatteryDrainMa(int key) {
        ...
        Slog.m121w(TAG, "getAverageBatteryDrainMaH called with unexpected key: 0x" + Integer.toHexString(key) + ", " + keyToString(key));
        return Double.NaN;
    }
