...
public class SystemNotificationChannels {
    ...
    public static void createAll(Context context) {
        ...
        NotificationChannel security =
                new NotificationChannel(
                        SECURITY, context.getString(R.string.notification_channel_security), 2);
        channelsList.add(security);
        NotificationChannel car =
                new NotificationChannel(
                        CAR_MODE, context.getString(R.string.notification_channel_car_mode), 2);
        car.setBlockable(true);
        channelsList.add(car);
        channelsList.add(newAccountChannel(context));
        NotificationChannel developer =
                new NotificationChannel(
                        DEVELOPER, context.getString(R.string.notification_channel_developer), 2);
        ...
        NotificationChannel updates =
                new NotificationChannel(
                        UPDATES, context.getString(R.string.notification_channel_updates), 2);
        ...
        NotificationChannel vpn =
                new NotificationChannel(
                        VPN, context.getString(R.string.notification_channel_vpn), 2);
        channelsList.add(vpn);
        NotificationChannel deviceAdmin =
                new NotificationChannel(
                        DEVICE_ADMIN, getDeviceAdminNotificationChannelName(context), 4);
        channelsList.add(deviceAdmin);
        NotificationChannel alertsChannel =
                new NotificationChannel(
                        ALERTS, context.getString(R.string.notification_channel_alerts), 3);
        channelsList.add(alertsChannel);
        NotificationChannel usb =
                new NotificationChannel(
                        USB, context.getString(R.string.notification_channel_usb), 1);
        ...
        NotificationChannel newFeaturePrompt =
                new NotificationChannel(
                        ...
                        context.getString(
                                R.string.notification_channel_accessibility_magnification),
                        4);
        ...
        NotificationChannel accessibilitySecurityPolicyChannel =
                new NotificationChannel(
                        ...
                        context.getString(
                                R.string.notification_channel_accessibility_security_policy),
                        2);
        channelsList.add(accessibilitySecurityPolicyChannel);
        channelsList.add(
                new NotificationChannel(
                        MDM_DEXPOLICY,
                        context.getString(R.string.notification_channel_dex_policy),
                        4));
        ...
        channelsList.add(
                new NotificationChannel(
                        ETHERNET,
                        context.getString(R.string.ethernet_cable_connected_notification_title),
                        2));
    ...
    private static NotificationChannel newAccountChannel(Context context) {
        return new NotificationChannel(
                ACCOUNT, context.getString(R.string.notification_channel_account), 2);
    }
