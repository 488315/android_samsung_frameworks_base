...
public final class XmlReader {
    public static void readDocumentStartTag(TypedXmlPullParser parser, String expectedRootTag)
        ...
        XmlValidator.checkParserCondition(
                expectedRootTag.equals(tagName),
                "Unexpected root tag found %s, expected %s",
                tagName,
                expectedRootTag);
    }
    ...
    public static void readDocumentStart(TypedXmlPullParser parser)
        ...
        try {
            ...
            Preconditions.checkArgument(
                    type == 0, "Unexpected type, expected %d", Integer.valueOf(type));
            parser.nextTag();
    ...
    public static void readDocumentEndTag(TypedXmlPullParser parser)
        ...
        try {
            ...
            XmlValidator.checkParserCondition(
                    z, "Unexpected tag found %s, expected document end", parser.getName());
        } catch (XmlPullParserException e) {
    ...
    public static void readEndTag(TypedXmlPullParser parser, String tagName, int tagDepth)
        ...
        XmlValidator.checkParserCondition(
                !hasNestedTag,
                "Unexpected nested tag %s found in tag %s",
                parser.getName(),
                tagName);
    }
    ...
    public static int readAttributeIntInRange(
        ...
        XmlValidator.checkParserCondition(
                ...
                tagName,
                attrName,
                Integer.valueOf(lowerInclusive),
                Integer.valueOf(upperInclusive));
        return value;
    }
    ...
    public static float readAttributeFloatInRange(
        ...
        XmlValidator.checkParserCondition(
                ...
                tagName,
                attrName,
                Float.valueOf(lowerInclusive),
                Float.valueOf(upperInclusive));
        return value;
    }
