...
public interface IAppWidgetService extends IInterface {
  ...
  public static class Default implements IAppWidgetService {
    ...
    public void partiallyUpdateAppWidgetIds(
        String callingPackage, int[] appWidgetIds, RemoteViews views) throws RemoteException {}
    ...
    @Override // com.android.internal.appwidget.IAppWidgetService
    public void notifyAppWidgetViewDataChanged(String packageName, int[] appWidgetIds, int viewId)
        throws RemoteException {}
    ...
    public List<AppWidgetProviderInfo> getAllProvidersForProfile(
        int categoryFilter, int profileId, boolean checkCrossProfile) throws RemoteException {
      return null;
    }
        ...
        default:
          switch (code) {
            ...
            case 26:
              ...
              data.enforceNoDataAvail();
              boolean _result12 =
                  bindRemoteViewsService(_arg025, _arg124, _arg212, _arg33, _arg42, _arg5, _arg6);
              reply.writeNoException();
      ...
      public AppWidgetProviderInfo getAppWidgetInfo(String callingPackage, int appWidgetId)
        ...
        try {
          ...
          AppWidgetProviderInfo _result =
              (AppWidgetProviderInfo) _reply.readTypedObject(AppWidgetProviderInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
