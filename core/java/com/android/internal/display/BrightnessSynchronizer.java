...
public class BrightnessSynchronizer {
    ...
    static {
        int max = Math.max(255, Resources.getSystem().getInteger(C4337R.integer.config_screenBrightnessExtendedMaximum));
    ...
    public void startSynchronizing() {
        ...
        Slog.m117i(TAG, "Initial brightness readings: " + this.mLatestIntBrightness + "(int), " + this.mLatestFloatBrightness + "(float)");
        if (!Float.isNaN(this.mLatestFloatBrightness)) {
            ...
            if (i != -1) {
                ...
                float defaultBrightness = this.mContext.getResources().getFloat(C4337R.dimen.config_screenBrightnessSettingDefaultFloat);
    ...
    private void updateScreenBrightness(int type) {
        ...
        if (lastFloatChanged) {
            ...
            this.mPreferredSettingValue = currentBrightnessFloat;
            Slog.m113d(TAG, "onChange: last float changed: " + currentBrightnessFloat + " -> " + newBrightnessInt);
        ...
        Slog.m113d(TAG, "onChange: last int changed: " + currentBrightnessInt + " -> " + newBrightnessFloat);
    ...
    public class BrightnessUpdate {
        ...
        void update() {
            if (this.mState == 1) {
                ...
                if (this.mUpdatedTypes != 0) {
                    Slog.m117i(BrightnessSynchronizer.TAG, NavigationBarInflaterView.SIZE_MOD_START + this.mId + "] New Update " + toStringLabel(this.mSourceType, this.mBrightness) + " set brightness values: " + toStringLabel(this.mUpdatedTypes & 2, brightnessFloat) + " " + toStringLabel(this.mUpdatedTypes & 1, brightnessInt));
        ...
        boolean swallowUpdate(int type, float brightness) {
            ...
            Slog.m117i(BrightnessSynchronizer.TAG, "Swallowing update of " + toStringLabel(type, brightness) + " by update: " + this);
            return true;
        }
    ...
    public static class DisplaySynchronizer {
        ...
        public void updateScreenBrightness(int type) {
            ...
            Slog.m113d(BrightnessSynchronizer.TAG, "updateScreenBrightness: displayId=" + this.mDisplayId + " type=" + type + " mPreferredSettingValue=" + this.mPreferredSettingValue + NavigationBarInflaterView.KEY_CODE_START + BrightnessSynchronizer.brightnessFloatToInt(this.mPreferredSettingValue) + ") currentBrightnessInt=" + currentBrightnessInt + " currentBrightnessIntFromFloat=" + currentBrightnessIntFromFloat + NavigationBarInflaterView.KEY_CODE_START + currentBrightnessFloat + NavigationBarInflaterView.KEY_CODE_END);
            if (currentBrightnessInt != currentBrightnessIntFromFloat) {
                ...
                Slog.m113d(BrightnessSynchronizer.TAG, "synced: mPreferredSettingValue: " + this.mPreferredSettingValue + " currentBrightnessFloat: " + currentBrightnessFloat);
                this.mPreferredSettingValue = currentBrightnessFloat;
            }
        }
        ...
        private void syncBrightnessValue(int currentBrightnessInt, float currentBrightnessFloat, boolean lastFloatChanged) {
            if (lastFloatChanged) {
                ...
                this.mPreferredSettingValue = currentBrightnessFloat;
                Slog.m113d(BrightnessSynchronizer.TAG, "onChange: last float changed: " + currentBrightnessFloat + " -> " + newBrightnessInt);
            ...
            this.mPreferredSettingValue = newBrightnessFloat;
            Slog.m113d(BrightnessSynchronizer.TAG, "onChange: last int changed: " + currentBrightnessInt + " -> " + newBrightnessFloat);
