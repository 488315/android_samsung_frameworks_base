...
public class AccessibilityShortcutController {
      ...
      if (RoSystemProperties.SUPPORT_ONE_HANDED_MODE) {
        featuresMap.put(
            ...
            new ToggleableFrameworkFeatureInfo(
                ...
                "1",
                "0",
                C4337R.string.one_handed_mode_feature_name));
      }
      featuresMap.put(
          ...
          new ToggleableFrameworkFeatureInfo(
              ...
              "1",
              "0",
              C4337R.string.reduce_bright_colors_feature_name));
      featuresMap.put(
          ACCESSIBILITY_HEARING_AIDS_COMPONENT_NAME,
          new LaunchableFrameworkFeatureInfo(C4337R.string.hearing_aids_feature_name));
  ...
  public void performAccessibilityShortcut() {
    Slog.m113d(TAG, "Accessibility shortcut activated");
    ContentResolver cr = this.mContext.getContentResolver();
    ...
    if (shortcutTargetService == null && AccessibilityUtils.isSetupWizard(this.mContext)) {
      Slog.m113d(TAG, "Accessibility shortcutTargetService == null");
    ...
    if (TextUtils.isEmpty(shortcutTargetService)) {
      Slog.m113d(TAG, "Accessibility shortcut target isEmpty");
      return;
    }
  ...
  private void showToast() {
    ...
    if (isServiceEnabled) {
      i = C4337R.string.accessibility_shortcut_disabling_service;
    } else {
      i = C4337R.string.accessibility_shortcut_enabling_service;
    }
            ...
            .setNegativeButton(
                ...
                new DialogInterface
                  ...
                  public final void onClick(DialogInterface dialogInterface, int i) {
                    AccessibilityShortcutController.this.lambda$createShortcutWarningDialog$0(
            ...
            .setOnCancelListener(
                new DialogInterface
                  ...
                  public final void onCancel(DialogInterface dialogInterface) {
                    AccessibilityShortcutController.this.lambda$createShortcutWarningDialog$1(
  ...
  private String getShortcutWarningTitle(List<AccessibilityTarget> targets) {
    if (targets.size() == 1 && TALKBACK_SE.equals(targets.get(0).getId())) {
      return this.mContext.getString(
          C4337R.string.accessibility_shortcut_warning_title_samsung_talkback,
          targets.get(0).getLabel());
    }
    return this.mContext.getString(C4337R.string.accessibility_shortcut_warning_title_samsung);
  }

  private String getShortcutWarningMessage(List<AccessibilityTarget> targets) {
    if (targets.size() == 1) {
      return this.mContext.getString(
          C4337R.string.accessibility_shortcut_single_service_warning_samsung,
          targets.get(0).getLabel());
    }
    ...
    return this.mContext.getString(
            C4337R.string.accessibility_shortcut_multiple_service_warning_samsung)
        + "\n"
        + sb.toString()
        + "\n"
  ...
  public void playNotificationTone() {
    ...
    Uri ringtoneUri =
        Uri.parse(
            "file://"
                + this.mContext.getString(
                    C4337R.string.config_defaultAccessibilityNotificationSound));
  ...
  class TtsPrompt implements TextToSpeech.OnInitListener {
    ...
    TtsPrompt(String serviceName) {
      this.mText =
          AccessibilityShortcutController.this.mContext.getString(
              C4337R.string.accessibility_shortcut_spoken_feedback, serviceName);
      this.mTts =
    ...
    public void onInit(int status) {
      if (status != 0) {
        ...
        AccessibilityShortcutController.this.mHandler.sendMessage(
            PooledLambda.obtainMessage(new C4341xe6764ed2(), this));
      }
    }
    ...
    public void play() {
      ...
      if (status != 0) {
        Slog.m113d(AccessibilityShortcutController.TAG, "Tts play fail");
        AccessibilityShortcutController.this.playNotificationTone();
      }
    }
    ...
    public void waitForTtsReady() {
          ...
          AccessibilityShortcutController.this.mHandler.sendMessage(
              PooledLambda.obtainMessage(
                  new Consumer() { // from class:
                                   // com.android.internal.accessibility.AccessibilityShortcutController$TtsPrompt$$ExternalSyntheticLambda1
      ...
      if (i == 0) {
        Slog.m113d(AccessibilityShortcutController.TAG, "Tts not ready to speak.");
        AccessibilityShortcutController.this.playNotificationTone();
      } else {
        this.mRetryCount = i - 1;
        AccessibilityShortcutController.this.mHandler.sendMessageDelayed(
            PooledLambda.obtainMessage(new C4341xe6764ed2(), this), 1000L);
      }
    }
  }
  ...
  private class UserSetupCompleteObserver extends ContentObserver {
    ...
    private void setEmptyShortcutTargetIfNeeded() {
      ...
      String shortcutTargets =
          Settings.Secure.getStringForUser(
              contentResolver, Settings.Secure.ACCESSIBILITY_SHORTCUT_TARGET_SERVICE, this.mUserId);
      if (shortcutTargets != null) {
        return;
      }
      String defaultShortcutTarget =
          AccessibilityShortcutController.this.mContext.getString(
              C4337R.string.config_defaultAccessibilityService);
      List<AccessibilityServiceInfo> enabledServices =
          AccessibilityShortcutController.this
              .mFrameworkObjectProvider
              .getAccessibilityManagerInstance(AccessibilityShortcutController.this.mContext)
