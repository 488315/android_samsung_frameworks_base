...
public class AccessibilitySamsungShortcutChooserActivity extends Activity {
      ...
      new BroadcastReceiver() { // from class:
        ...
        public void onReceive(Context context, Intent intent) {
          if (Intent.ACTION_SCREEN_OFF.equals(intent.getAction())
              && AccessibilitySamsungShortcutChooserActivity.this.mMenuDialog != null) {
  ...
  public void onTargetSelected(AdapterView<?> parent, View view, int position, long id) {
    ...
    Settings.Secure.putString(
        getContentResolver(), Settings.Secure.ACCESSIBILITY_BUTTON_TARGET_COMPONENT, targetName);
    AccessibilityManager accessibilityManager = this.mAccessibilityManager;
    if (accessibilityManager != null) {
      accessibilityManager.semPerformAccessibilityButtonClick(
        ...
        .setOnClickListener(
            new View
              ...
              public final void onClick(View view) {
                AccessibilitySamsungShortcutChooserActivity.this.lambda$updateDialogListeners$1(
                    view);
              }
            });
    this.mMenuDialog
            ...
            .setOnDismissListener(
                new DialogInterface
                  ...
                  public final void onDismiss(DialogInterface dialogInterface) {
                    AccessibilitySamsungShortcutChooserActivity.this.lambda$createMenuDialog$2(
                        dialogInterface);
                  }
                });
    boolean allowEditing =
        AccessibilityUtils.isUserSetupCompleted(this) && !SemEmergencyManager.isEmergencyMode(this);
  ...
  private int getGravity() {
    if (this.mShortcutType == 0) {
      if (getResources().getBoolean(C4337R.bool.sem_config_dialogLargeScreen)
