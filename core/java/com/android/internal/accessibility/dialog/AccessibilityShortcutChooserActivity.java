...
public class AccessibilityShortcutChooserActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    TypedArray theme = getTheme().obtainStyledAttributes(C0000R.styleable.Theme);
    ...
    createMenuDialog.setOnShowListener(
        new DialogInterface
    ...
    if (!target.isShortcutEnabled()) {
      ...
      if (target instanceof AccessibilityServiceTarget) {
        showPermissionDialogIfNeeded(
            this, (AccessibilityServiceTarget) target, this.mTargetAdapter);
        return;
      }
    }
  ...
  private void showPermissionDialogIfNeeded(
    ...
    AlertDialog create =
        new AlertDialog.Builder(context)
            .setView(
                AccessibilityTargetHelper.createEnableDialogContentView(
                    context,
                    serviceTarget,
                    new View
                      ...
                      public final void onClick(View view) {
                        AccessibilityShortcutChooserActivity.this
                            .lambda$showPermissionDialogIfNeeded$1(targetAdapter, view);
                      }
                    },
                    new View
                        .OnClickListener() { // from class:
                      ...
                      public final void onClick(View view) {
                        AccessibilityShortcutChooserActivity.this
                            .lambda$showPermissionDialogIfNeeded$2(view);
                      }
                    }))
            .setOnDismissListener(
                new DialogInterface
                  ...
                  public final void onDismiss(DialogInterface dialogInterface) {
                    AccessibilityShortcutChooserActivity.this.lambda$showPermissionDialogIfNeeded$3(
                        dialogInterface);
                  }
                })
            .create();
  ...
  public /* synthetic */ void lambda$showPermissionDialogIfNeeded$1(
      ShortcutTargetAdapter targetAdapter, View v) {
  ...
  private void onDoneButtonClicked() {
    ...
    this.mMenuDialog
        .getButton(-1)
        .setText(getString(C4337R.string.edit_accessibility_shortcut_menu_button));
    updateDialogListeners();
  }
  ...
  private void onEditButtonClicked() {
    ...
    this.mMenuDialog
        .getButton(-1)
        .setText(getString(C4337R.string.done_accessibility_shortcut_menu_button));
    updateDialogListeners();
  }
  ...
  private void updateDialogListeners() {
    ...
    this.mMenuDialog.setTitle(
        getString(
            isEditMenuMode
                ? C4337R.string.accessibility_edit_shortcut_menu_volume_title
                : C4337R.string.accessibility_select_shortcut_menu_title));
    this.mMenuDialog
        .getButton(-1)
        .setOnClickListener(
            isEditMenuMode
  ...
  private AlertDialog createMenuDialog() {
    String dialogTitle = getString(C4337R.string.accessibility_select_shortcut_menu_title);
        ...
        new AlertDialog.Builder(this)
            ...
            .setOnDismissListener(
                new DialogInterface
                  ...
                  @Override // android.content.DialogInterface.OnDismissListener
                  public final void onDismiss(DialogInterface dialogInterface) {
                    AccessibilityShortcutChooserActivity.this.lambda$createMenuDialog$6(
                        dialogInterface);
                  }
                });
    if (AccessibilityUtils.isUserSetupCompleted(this)) {
      String positiveButtonText = getString(C4337R.string.edit_accessibility_shortcut_menu_button);
