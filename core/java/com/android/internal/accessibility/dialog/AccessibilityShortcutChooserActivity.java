...
public class AccessibilityShortcutChooserActivity extends Activity {
    ...
    private void onDoneButtonClicked() {
        ...
        this.mTargetAdapter.notifyDataSetChanged();
        this.mMenuDialog.getButton(-1).setText(getString(C4337R.string.edit_accessibility_shortcut_menu_button));
        updateDialogListeners();
    }
    ...
    private void onEditButtonClicked() {
        ...
        this.mTargetAdapter.notifyDataSetChanged();
        this.mMenuDialog.getButton(-1).setText(getString(C4337R.string.done_accessibility_shortcut_menu_button));
        updateDialogListeners();
    }

    private void updateDialogListeners() {
        boolean isEditMenuMode = this.mTargetAdapter.getShortcutMenuMode() == 1;
        this.mMenuDialog.setTitle(getString(isEditMenuMode ? C4337R.string.accessibility_edit_shortcut_menu_volume_title : C4337R.string.accessibility_select_shortcut_menu_title));
