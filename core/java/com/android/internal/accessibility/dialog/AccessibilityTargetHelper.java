...
public final class AccessibilityTargetHelper {
        ...
        try {
            ...
            boolean isSamePackageName =
                    activityComponentName
                            .getPackageName()
                            .equals(serviceComponentName.getPackageName());
    ...
    private static List<AccessibilityTarget> getAccessibilityActivityTargets(
        ...
        List<AccessibilityShortcutInfo> installedServices =
                am.getInstalledAccessibilityShortcutListAsUser(
                        context, ActivityManager.getCurrentUser());
        if (installedServices == null) {
            return Collections.emptyList();
        }
        List<AccessibilityTarget> targets = new ArrayList<>(installedServices.size());
    ...
    private static AccessibilityTarget createAccessibilityServiceTarget(
        ...
        switch (AccessibilityUtils.getAccessibilityServiceFragmentType(info)) {
            case 0:
                return new VolumeShortcutToggleAccessibilityServiceTarget(
                        context, shortcutType, info);
            case 1:
