...
public final class AccessibilityTargetHelper {
    ...
    private static List<AccessibilityTarget> getAllowListingFeatureTargets(Context context, int shortcutType) {
        ...
        InvisibleToggleAllowListingFeatureTarget magnification = new InvisibleToggleAllowListingFeatureTarget(context, shortcutType, ShortcutUtils.isShortcutContained(context, shortcutType, "com.android.server.accessibility.MagnificationController"), "com.android.server.accessibility.MagnificationController", uid, context.getString(C4337R.string.accessibility_magnification_chooser_text), context.getDrawable(C4337R.drawable.ic_accessibility_magnification), Settings.Secure.ACCESSIBILITY_DISPLAY_MAGNIFICATION_NAVBAR_ENABLED);
        targets.add(magnification);
        ToggleAllowListingFeatureTarget daltonizer = new ToggleAllowListingFeatureTarget(context, shortcutType, ShortcutUtils.isShortcutContained(context, shortcutType, AccessibilityShortcutController.DALTONIZER_COMPONENT_NAME.flattenToString()), AccessibilityShortcutController.DALTONIZER_COMPONENT_NAME.flattenToString(), uid, context.getString(C4337R.string.color_correction_feature_name), context.getDrawable(C4337R.drawable.ic_accessibility_color_correction), Settings.Secure.ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED);
        targets.add(daltonizer);
        ToggleAllowListingFeatureTarget colorInversion = new ToggleAllowListingFeatureTarget(context, shortcutType, ShortcutUtils.isShortcutContained(context, shortcutType, AccessibilityShortcutController.COLOR_INVERSION_COMPONENT_NAME.flattenToString()), AccessibilityShortcutController.COLOR_INVERSION_COMPONENT_NAME.flattenToString(), uid, context.getString(C4337R.string.color_inversion_feature_name), context.getDrawable(C4337R.drawable.ic_accessibility_color_inversion), Settings.Secure.ACCESSIBILITY_DISPLAY_INVERSION_ENABLED);
        targets.add(colorInversion);
        if (RoSystemProperties.SUPPORT_ONE_HANDED_MODE) {
            ToggleAllowListingFeatureTarget oneHandedMode = new ToggleAllowListingFeatureTarget(context, shortcutType, ShortcutUtils.isShortcutContained(context, shortcutType, AccessibilityShortcutController.ONE_HANDED_COMPONENT_NAME.flattenToString()), AccessibilityShortcutController.ONE_HANDED_COMPONENT_NAME.flattenToString(), uid, context.getString(C4337R.string.one_handed_mode_feature_name), context.getDrawable(C4337R.drawable.ic_accessibility_one_handed), Settings.Secure.ONE_HANDED_MODE_ACTIVATED);
            targets.add(oneHandedMode);
        }
        ToggleAllowListingFeatureTarget reduceBrightColors = new ToggleAllowListingFeatureTarget(context, shortcutType, ShortcutUtils.isShortcutContained(context, shortcutType, AccessibilityShortcutController.REDUCE_BRIGHT_COLORS_COMPONENT_NAME.flattenToString()), AccessibilityShortcutController.REDUCE_BRIGHT_COLORS_COMPONENT_NAME.flattenToString(), uid, context.getString(C4337R.string.reduce_bright_colors_feature_name), context.getDrawable(C4337R.drawable.ic_accessibility_reduce_bright_colors), Settings.Secure.REDUCE_BRIGHT_COLORS_ACTIVATED);
        targets.add(reduceBrightColors);
        InvisibleToggleAllowListingFeatureTarget hearingAids = new InvisibleToggleAllowListingFeatureTarget(context, shortcutType, ShortcutUtils.isShortcutContained(context, shortcutType, AccessibilityShortcutController.ACCESSIBILITY_HEARING_AIDS_COMPONENT_NAME.flattenToString()), AccessibilityShortcutController.ACCESSIBILITY_HEARING_AIDS_COMPONENT_NAME.flattenToString(), uid, context.getString(C4337R.string.hearing_aids_feature_name), context.getDrawable(C4337R.drawable.ic_accessibility_hearing_aid), null);
    ...
    static View createEnableDialogContentView(Context context, final AccessibilityServiceTarget target, final View.OnClickListener allowListener, final View.OnClickListener denyListener) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View content = inflater.inflate(C4337R.layout.accessibility_enable_service_warning, (ViewGroup) null);
        ImageView dialogIcon = (ImageView) content.findViewById(C4337R.id.accessibility_permissionDialog_icon);
        dialogIcon.lambda$setImageURIAsync$2(target.getIcon());
        TextView dialogTitle = (TextView) content.findViewById(C4337R.id.accessibility_permissionDialog_title);
        dialogTitle.setText(context.getString(C4337R.string.accessibility_enable_service_title, getServiceName(context, target.getLabel())));
        Button allowButton = (Button) content.findViewById(C4337R.id.accessibility_permission_enable_allow_button);
        Button denyButton = (Button) content.findViewById(C4337R.id.accessibility_permission_enable_deny_button);
    ...
    static /* synthetic */ void lambda$createEnableDialogContentView$1(AccessibilityServiceTarget target, View.OnClickListener allowListener, View view) {
        target.onCheckedChanged(true);
        allowListener.onClick(view);
    }

    static /* synthetic */ void lambda$createEnableDialogContentView$2(AccessibilityServiceTarget target, View.OnClickListener denyListener, View view) {
