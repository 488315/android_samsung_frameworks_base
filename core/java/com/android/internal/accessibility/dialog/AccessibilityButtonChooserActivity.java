  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    boolean accessControlEnabled =
        Settings.System.getIntForUser(
                getContentResolver(), Settings.System.SEM_ACCESS_CONTROL_ENABLED, 0, -2)
            == 1;
    ...
    setContentView(C4337R.layout.accessibility_button_chooser);
    ...
    String component =
        Settings.Secure.getString(
            getContentResolver(), Settings.Secure.ACCESSIBILITY_BUTTON_TARGET_COMPONENT);
    ...
    boolean isGestureNavigateEnabled =
        2 == getResources().getInteger(C4337R.integer.config_navBarInteractionMode);
    if (isGestureNavigateEnabled) {
      TextView promptPrologue =
          (TextView) findViewById(C4337R.id.accessibility_button_prompt_prologue);
      if (isTouchExploreOn) {
        i2 = C4337R.string.accessibility_gesture_3finger_prompt_text;
      } else {
        i2 = C4337R.string.accessibility_gesture_prompt_text;
      }
      promptPrologue.setText(i2);
    }
    if (TextUtils.isEmpty(component)) {
      TextView prompt = (TextView) findViewById(C4337R.id.accessibility_button_prompt);
      if (isGestureNavigateEnabled) {
        if (isTouchExploreOn) {
          i = C4337R.string.accessibility_gesture_3finger_instructional_text;
        } else {
          i = C4337R.string.accessibility_gesture_instructional_text;
        }
        prompt.setText(i);
      }
    ...
    GridView gridview = (GridView) findViewById(C4337R.id.accessibility_button_chooser_grid);
