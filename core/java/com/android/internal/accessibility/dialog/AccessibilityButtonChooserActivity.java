...
public class AccessibilityButtonChooserActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isGestureNavigateEnabled = 2 == getResources().getInteger(C4337R.integer.config_navBarInteractionMode);
        if (isGestureNavigateEnabled) {
            TextView promptPrologue = (TextView) findViewById(C4337R.id.accessibility_button_prompt_prologue);
            if (isTouchExploreOn) {
