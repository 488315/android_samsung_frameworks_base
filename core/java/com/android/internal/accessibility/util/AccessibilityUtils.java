...
public final class AccessibilityUtils {
                                ...
                                new Predicate() { // from class:
                                    ...
                                    public final boolean test(Object obj) {
                                        return AccessibilityUtils
                                                .lambda$getAccessibilityMenuComponentToMigrate$0(
                                                        (ComponentName) obj);
                                    }
                                })
                        .findFirst();
    ...
    public static boolean makeToastForEmergencyMode(
        ...
        if (!SemEmergencyManager.isEmergencyMode(context)
                || allowPerformInEmergencyMode(targetName)) {
            return false;
        }
        String message =
                context.getString(
                        R.string.accessibility_shortcut_cannot_use_emergency_mode, targetLabel);
    ...
    public static boolean makeToastForDexMode(
        ...
        String message =
                context.getString(R.string.accessibility_shortcut_cannot_use_dex_mode, targetLabel);
        Toast.makeText(new ContextThemeWrapper(context, 16974123), message, 0).show();
        return true;
    }
    ...
    private static boolean disallowPerformInDexDualMonitorDisplay(String targetName) {
        return targetName.equals(A11yLogger.COMPONENT_NAME_RELUMINO_SHORTCUT.flattenToString())
                || targetName.equals(
                        A11yLogger.COMPONENT_NAME_COLOR_LENS_SHORTCUT.flattenToString())
                || targetName.equals(
    ...
    public static boolean makeToastForCoverScreen(Context context, String targetName) {
        ...
        String message =
                context.getString(R.string.accessibility_shortcut_open_phone_and_try_again);
        Toast.makeText(new ContextThemeWrapper(context, 16974123), message, 0).show();
        return true;
    }
    ...
    public static boolean disallowPerformInCoverScreen(String targetName) {
        return targetName.equals(
                ...
                || targetName.equals(
                        A11yLogger.COMPONENT_NAME_MAGNIFIER_CAMERA_SHORTCUT.flattenToString())
                || targetName.equals(
                ...
                || targetName.equals(
                        A11yLogger.COMPONENT_NAME_GOOGLE_SOUND_NOTIFICATION_SHORTCUT
                                .flattenToString());
    }
    ...
    public static boolean makeToastForFingerprint(
        ...
        if (fpm == null
                || fpm.semCanChangeDeviceColorMode()
                || !disallowPerformWhileFingerPrint(targetName)) {
            return false;
        }
        String message =
                context.getString(
                        R.string.accessibility_shortcut_cannot_use_fingerprint, targetLabel);
        Toast.makeText(new ContextThemeWrapper(context, 16974123), message, 0).show();
        return true;
    }
    ...
    public static boolean disallowPerformWhileFingerPrint(String targetName) {
        return targetName.equals(A11yLogger.COMPONENT_NAME_COLOR_LENS_SHORTCUT.flattenToString())
                || targetName.equals(
                        A11yLogger.COMPONENT_NAME_COLOR_ADJUSTMENT_SHORTCUT.flattenToString())
                || targetName.equals(
