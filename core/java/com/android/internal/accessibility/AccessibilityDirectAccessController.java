...
public class AccessibilityDirectAccessController {
    ...
    if (sFrameworkShortcutFeaturesMap == null) {
      ...
      featuresMap.put(
          ...
          new ToggleableFrameworkFeatureInfo(
              ...
              "1",
              "0",
              C4337R.string.color_inversion_feature_name));
      featuresMap.put(
          ...
          new ToggleableFrameworkFeatureInfo(
              ...
              "1",
              "0",
              C4337R.string.color_correction_feature_name));
  ...
  public void performAccessibilityDirectAccess() {
    Slog.m113d(TAG, "Accessibility direct access activated");
    final ContentResolver cr = this.mContext.getContentResolver();
    final int userId = ActivityManager.getCurrentUser();
    int dialogAlreadyShown =
        Settings.Secure.getIntForUser(cr, "accessibility_direct_access_dialog_shown", 0, userId);
    String directAccessTargetService =
        Settings.Secure.getStringForUser(
            cr, Settings.Secure.ACCESSIBILITY_DIRECT_ACCESS_TARGET_SERVICE, userId);
    if (directAccessTargetService == null && AccessibilityUtils.isSetupWizard(this.mContext)) {
      Slog.m113d(TAG, "Accessibility directAccessTargetService == null");
      Settings.Secure.putStringForUser(
          cr,
          Settings.Secure.ACCESSIBILITY_DIRECT_ACCESS_TARGET_SERVICE,
          AccessibilityShortcutController.TALKBACK_SE,
          userId);
      directAccessTargetService = AccessibilityShortcutController.TALKBACK_SE;
    }
    if (TextUtils.isEmpty(directAccessTargetService)
        || (isKeyguardLocked() && dialogAlreadyShown == 0)) {
      Slog.m113d(TAG, "Accessibility direct access isEmpty");
      return;
    }
      ...
      if (ShortcutUtils.isSupportDCMotorHapticFeedback(vibrator)) {
        ...
        long[] vibePattern =
            ArrayUtils.convertToLongArray(
                this.mContext.getResources().getIntArray(C4337R.array.config_longPressVibePattern));
    ...
    if (dialogAlreadyShown == 0) {
      this.mHandler.postDelayed(
          new Runnable() { // from class:
                           // com.android.internal.accessibility.AccessibilityDirectAccessController$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              AccessibilityDirectAccessController.this.lambda$performAccessibilityDirectAccess$0(
                  userId, cr);
            }
          },
          0L);
    ...
    if (directAccessTargetService != null
        && directAccessTargetService.contains(
      ...
      Slog.m113d(TAG, "Interaction Control is activated");
    ...
    if (directAccessTargetService != null
        ...
        && AccessibilityUtils.isAccessibilityServiceEnabled(
            this.mContext,
            "com.samsung.accessibility/com.samsung.accessibility.universalswitch.UniversalSwitchService")) {
      Slog.m113d(TAG, "Universal switch is activated");
  ...
  private AlertDialog createShortcutWarningDialog(final int userId) {
    ...
    AlertDialog alertDialog =
        frameworkObjectProvider
            .getAlertDialogBuilder(frameworkObjectProvider.getSystemUiContext())
            .setTitle(getShortcutWarningTitle(targets))
            .setMessage(getShortcutWarningMessage(targets))
            .setCancelable(false)
            .setPositiveButton(
                C4337R.string.accessibility_shortcut_use, (DialogInterface.OnClickListener) null)
            .setNegativeButton(
                C4337R.string.accessibility_shortcut_dont_use,
                new DialogInterface
                    .OnClickListener() { // from class:
                                         // com.android.internal.accessibility.AccessibilityDirectAccessController$$ExternalSyntheticLambda2
                  @Override // android.content.DialogInterface.OnClickListener
                  public final void onClick(DialogInterface dialogInterface, int i) {
                    AccessibilityDirectAccessController.this.lambda$createShortcutWarningDialog$1(
            ...
            .setOnCancelListener(
                new DialogInterface
                    .OnCancelListener() { // from class:
                                          // com.android.internal.accessibility.AccessibilityDirectAccessController$$ExternalSyntheticLambda3
                  @Override // android.content.DialogInterface.OnCancelListener
                  public final void onCancel(DialogInterface dialogInterface) {
                    AccessibilityDirectAccessController.this.lambda$createShortcutWarningDialog$2(
  ...
  public /* synthetic */ void lambda$createShortcutWarningDialog$1(
    ...
    Settings.Secure.putIntForUser(
        this.mContext.getContentResolver(), "accessibility_direct_access_dialog_shown", 0, userId);
  }
  ...
  private String getShortcutWarningTitle(List<AccessibilityTarget> targets) {
    if (targets.size() == 1
        && AccessibilityShortcutController.TALKBACK_SE.equals(targets.get(0).getId())) {
      if (AccessibilityUtils.isSideKeySupported()) {
        return this.mContext.getString(C4337R.string.f645xe67c7996, targets.get(0).getLabel());
      }
      return this.mContext.getString(
          C4337R.string.accessibility_direct_access_warning_title_samsung_talkback,
          targets.get(0).getLabel());
    }
    if (AccessibilityUtils.isSideKeySupported()) {
      return this.mContext.getString(
          C4337R.string.accessibility_direct_access_warning_title_samsung_side_key);
    }
    return this.mContext.getString(C4337R.string.accessibility_direct_access_warning_title_samsung);
  }

  private String getShortcutWarningMessage(List<AccessibilityTarget> targets) {
    if (targets.size() == 1) {
      if (AccessibilityUtils.isSideKeySupported()) {
        return this.mContext.getString(C4337R.string.f644xe5c5f2ca, targets.get(0).getLabel())
            + " "
            + this.mContext.getString(C4337R.string.accessibility_select_different_function);
      }
      return this.mContext.getString(
              C4337R.string.accessibility_direct_access_single_service_warning_samsung,
              targets.get(0).getLabel())
          + " "
          + this.mContext.getString(C4337R.string.accessibility_select_different_function);
    }
    ...
    for (AccessibilityTarget target : targets) {
      sb.append(
          this.mContext.getString(
              C4337R.string.accessibility_shortcut_multiple_service_list, target.getLabel()));
    }
    if (AccessibilityUtils.isSideKeySupported()) {
      return this.mContext.getString(C4337R.string.f643x72618f82)
          + "\n"
          + sb.toString()
          + "\n"
          + this.mContext.getString(C4337R.string.accessibility_select_different_function);
    ...
    return this.mContext.getString(
            C4337R.string.accessibility_direct_access_multiple_service_warning_samsung)
        + "\n"
        + sb.toString()
        + "\n"
        + this.mContext.getString(C4337R.string.accessibility_select_different_function);
  ...
  private String getShortcutFeatureDescription() {
    ...
    ToggleableFrameworkFeatureInfo frameworkFeatureInfo =
    ...
    alertDialog.setOnDismissListener(
        new DialogInterface
            .OnDismissListener() { // from class:
                                   // com.android.internal.accessibility.AccessibilityDirectAccessController$$ExternalSyntheticLambda1
  ...
  private ComponentName getShortcutTargetComponentName() {
    ...
    Slog.m113d(TAG, "shortcutTargets.get(0) : " + shortcutTargets.get(0));
  ...
  class TtsPrompt implements TextToSpeech.OnInitListener {
    ...
    TtsPrompt(String serviceName) {
      if (AccessibilityUtils.isSideKeySupported()) {
        this.mText =
            AccessibilityDirectAccessController.this.mContext.getString(
                C4337R.string.accessibility_direct_access_spoken_feedback_side_key, serviceName);
      } else {
        this.mText =
            AccessibilityDirectAccessController.this.mContext.getString(
                C4337R.string.accessibility_direct_access_spoken_feedback, serviceName);
      }
      this.mTts =
          AccessibilityDirectAccessController.this.mFrameworkObjectProvider.getTextToSpeech(
              AccessibilityDirectAccessController.this.mContext, this);
    }

    public void dismiss() {
      this.mDismiss = true;
      AccessibilityDirectAccessController.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(new C4340x3fc729fb(), this.mTts));
    }
    ...
    public void play() {
      ...
      if (status != 0) {
        Slog.m113d(AccessibilityDirectAccessController.TAG, "Tts play fail");
        AccessibilityDirectAccessController.this.playNotificationTone();
      }
    }
    ...
    public void waitForTtsReady() {
          ...
          AccessibilityDirectAccessController.this.mHandler.sendMessage(
              PooledLambda.obtainMessage(
                  new Consumer() { // from class:
                                   // com.android.internal.accessibility.AccessibilityDirectAccessController$TtsPrompt$$ExternalSyntheticLambda1
      ...
      if (i == 0) {
        Slog.m113d(AccessibilityDirectAccessController.TAG, "Tts not ready to speak.");
        AccessibilityDirectAccessController.this.playNotificationTone();
      } else {
        this.mRetryCount = i - 1;
        AccessibilityDirectAccessController.this.mHandler.sendMessageDelayed(
            PooledLambda.obtainMessage(new C4338x3fc729f9(), this), 1000L);
      }
    }
  }
  ...
  public static class FrameworkObjectProvider {
    ...
    public AlertDialog.Builder getAlertDialogBuilder(Context context) {
      ...
      return new AlertDialog.Builder(
          isNight ? new ContextThemeWrapper(context, 16974120) : context);
    }
