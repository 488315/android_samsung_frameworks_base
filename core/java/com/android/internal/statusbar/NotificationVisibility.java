...
public class NotificationVisibility implements Parcelable {
    ...
    public String toString() {
        return "NotificationVisibility(id=" + this.f1003id + " key=" + this.key + " rank=" + this.rank + " count=" + this.count + (this.visible ? " visible" : "") + " location=" + this.location.name() + " )";
    }

    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public NotificationVisibility m8002clone() {
