...
public interface IStatusBarService extends IInterface {
  ...
  void onNotificationClear(
      String str, int i, String str2, int i2, int i3, NotificationVisibility notificationVisibility)
      throws RemoteException;
  ...
  public static class Default implements IStatusBarService {
    ...
    @Override // com.android.internal.statusbar.IStatusBarService
    public void setIcon(
        String slot, String iconPackage, int iconId, int iconLevel, String contentDescription)
        throws RemoteException {}
    ...
    @Override // com.android.internal.statusbar.IStatusBarService
    public void disableForUserToType(int what, IBinder token, String pkg, int userId, int barType)
        throws RemoteException {}
    ...
    @Override // com.android.internal.statusbar.IStatusBarService
    public void disable2ForUserToType(int what, IBinder token, String pkg, int userId, int barType)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IStatusBarService {
          ...
          switch (code) {
            ...
            case 18:
              ...
              NotificationVisibility _arg110 =
                  (NotificationVisibility) data.readTypedObject(NotificationVisibility.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 23:
              NotificationVisibility[] _arg018 =
                  (NotificationVisibility[]) data.createTypedArray(NotificationVisibility.CREATOR);
            ...
            case 48:
              ...
              showAuthenticationDialog(
                  _arg035, _arg122, _arg215, _arg312, _arg48, _arg53, _arg62, _arg7, _arg8);
              reply.writeNoException();
              return true;
            case 49:
            ...
            case 52:
              ...
              return true;
            case 53:
              IBiometricContextListener _arg040 =
              ...
              return true;
            case 54:
              IUdfpsRefreshRateRequestCallback _arg041 =
    ...
    private static class Proxy implements IStatusBarService {
      ...
      public RegisterStatusBarResult registerStatusBar(IStatusBar callbacks)
        ...
        try {
          ...
          RegisterStatusBarResult _result =
              (RegisterStatusBarResult) _reply.readTypedObject(RegisterStatusBarResult.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public void disable2ForUserToType(
          int what, IBinder token, String pkg, int userId, int barType) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
