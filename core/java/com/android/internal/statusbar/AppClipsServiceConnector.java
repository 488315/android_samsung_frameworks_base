...
public class AppClipsServiceConnector {
    ...
    private void connectToServiceAndProcessRequest(final int taskId, final CompletableFuture<Boolean> future) {
        ...
        ComponentName serviceComponent = ComponentName.unflattenFromString(this.mContext.getResources().getString(C4337R.string.config_screenshotAppClipsServiceComponent));
