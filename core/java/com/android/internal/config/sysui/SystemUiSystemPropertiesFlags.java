...
public class SystemUiSystemPropertiesFlags {
  ...
  public static final class NotificationFlags {
    public static final Flag FSI_FORCE_DEMOTE =
        SystemUiSystemPropertiesFlags.devFlag("persist.sysui.notification.fsi_force_demote");
    public static final Flag SHOW_STICKY_HUN_FOR_DENIED_FSI =
        SystemUiSystemPropertiesFlags.releasedFlag(
            "persist.sysui.notification.show_sticky_hun_for_denied_fsi");
    public static final Flag ALLOW_DISMISS_ONGOING =
        SystemUiSystemPropertiesFlags.releasedFlag("persist.sysui.notification.ongoing_dismissal");
    public static final Flag OTP_REDACTION =
        SystemUiSystemPropertiesFlags.devFlag("persist.sysui.notification.otp_redaction");
    public static final Flag NO_SORT_BY_INTERRUPTIVENESS =
        SystemUiSystemPropertiesFlags.releasedFlag(
            "persist.sysui.notification.no_sort_by_interruptiveness");
    ...
    public static final Flag WAKE_LOCK_FOR_POSTING_NOTIFICATION =
        SystemUiSystemPropertiesFlags.devFlag(
            "persist.sysui.notification.wake_lock_for_posting_notification");
  }
  ...
  public static FlagResolver getResolver() {
    if (Build.IS_DEBUGGABLE && TEST_RESOLVER != null) {
      Log.m98i("SystemUiSystemPropertiesFlags", "Returning debug resolver " + TEST_RESOLVER);
