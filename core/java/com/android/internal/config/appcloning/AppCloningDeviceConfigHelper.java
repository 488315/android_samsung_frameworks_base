...
public class AppCloningDeviceConfigHelper {
  ...
  public static AppCloningDeviceConfigHelper getInstance(Context context) {
    ...
    synchronized (sLock) {
      if (sInstance == null) {
        AppCloningDeviceConfigHelper appCloningDeviceConfigHelper2 =
            new AppCloningDeviceConfigHelper();
  ...
  private void init(Context context) {
    ...
    DeviceConfig.addOnPropertiesChangedListener(
        "app_cloning", context.getMainExecutor(), this.mDeviceConfigChangeListener);
  }

  private void initializeDeviceConfigChangeListener() {
    this.mDeviceConfigChangeListener =
        new DeviceConfig
          ...
          public final void onPropertiesChanged(DeviceConfig.Properties properties) {
            AppCloningDeviceConfigHelper.this.lambda$initializeDeviceConfigChangeListener$0(
                properties);
          }
        };
  }
  ...
  private void updateEnableAppCloningBuildingBlocks() {
    this.mEnableAppCloningBuildingBlocks =
        DeviceConfig.getBoolean("app_cloning", ENABLE_APP_CLONING_BUILDING_BLOCKS, true);
  }
