...
public final class BitUtils {
  ...
  public static boolean maskedEquals(UUID a, UUID b, UUID mask) {
    ...
    return maskedEquals(
        ...
        && maskedEquals(
            a.getMostSignificantBits(), b.getMostSignificantBits(), mask.getMostSignificantBits());
  }
  ...
  public static String flagsToString(int flags, IntFunction<String> getFlagName) {
    ...
    TextUtils.wrap(
        builder, NavigationBarInflaterView.SIZE_MOD_START, NavigationBarInflaterView.SIZE_MOD_END);
