      ...
      for (int i = 0; i < this.mAllCallingUids.size(); i++) {
        ...
        pw.println(
            String.format(
                ...
                Integer.valueOf(uid),
                Long.valueOf(this.mQueryStats.get(uid)),
                Long.valueOf(this.mInsertStats.get(uid)),
                Long.valueOf(this.mUpdateStats.get(uid)),
                Long.valueOf(this.mDeleteStats.get(uid)),
                Long.valueOf(this.mBatchStats.get(uid)),
                Long.valueOf(this.mInsertInBatchStats.get(uid)),
                Long.valueOf(this.mUpdateInBatchStats.get(uid)),
                Long.valueOf(this.mDeleteInBatchStats.get(uid)),
                Double.valueOf(this.mOperationDurationMillis.get(uid) / 1000.0d)));
      }
      pw.println();
    }
  }
