...
public interface PooledLambda {
  ...
  /* renamed from: __ */
  static <R> ArgumentPlaceholder<R> m227__() {
    return (ArgumentPlaceholder<R>) ArgumentPlaceholder.INSTANCE;
  }

  /* renamed from: __ */
  static <R> ArgumentPlaceholder<R> m228__(Class<R> typeHint) {
    return m227__();
  }
  ...
  static <A, B> PooledRunnable obtainRunnable(
      BiConsumer<? super A, ? super B> function, A arg1, B arg2) {
    return (PooledRunnable)
        PooledLambdaImpl.acquire(
            PooledLambdaImpl.sPool,
            function,
  ...
  static <A, B> PooledPredicate<A> obtainPredicate(
      BiPredicate<? super A, ? super B> function, ArgumentPlaceholder<A> arg1, B arg2) {
    return (PooledPredicate)
        PooledLambdaImpl.acquire(
            PooledLambdaImpl.sPool,
            function,
            2,
  ...
  static <A, B> PooledPredicate<B> obtainPredicate(
      BiPredicate<? super A, ? super B> function, A arg1, ArgumentPlaceholder<B> arg2) {
    return (PooledPredicate)
        PooledLambdaImpl.acquire(
            PooledLambdaImpl.sPool,
            function,
  ...
  static <A, B, C> PooledRunnable obtainRunnable(
      TriConsumer<? super A, ? super B, ? super C> function, A arg1, B arg2, C arg3) {
    return (PooledRunnable)
        PooledLambdaImpl.acquire(
            PooledLambdaImpl.sPool,
            function,
  ...
  static <A, B, C, D, E, F, G> PooledRunnable obtainRunnable(
      HeptConsumer<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G>
          function,
      A arg1,
      B arg2,
      C arg3,
