...
public class ObservableServiceConnection<T> implements ServiceConnection {
  ...
  private final CallbackRegistry<Callback<T>, ObservableServiceConnection<T>, T> mCallbackRegistry =
      new CallbackRegistry<>(new C46871());
  ...
  class C46871
      extends CallbackRegistry.NotifierCallback<Callback<T>, ObservableServiceConnection<T>, T> {
    C46871() {}
      ...
      ObservableServiceConnection.this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            public final void run() {
              ObservableServiceConnection.C46871.this.lambda$onNotifyCallback$0(
  ...
  public boolean bind() {
    synchronized (this.mLock) {
      ...
      boolean bindResult =
          this.mContext.bindService(this.mServiceIntent, this.mFlags, this.mExecutor, this);
