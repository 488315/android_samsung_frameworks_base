...
public class AsyncChannel {
  ...
  public void connect(
    ...
    new Thread(
            new Runnable(
                ...
                srcHandler,
                dstPackageName,
                dstClassName) { // from class: com.android.internal.util.AsyncChannel.1ConnectAsync
              ...
              public void run() {
                int result =
                    AsyncChannel.this.connectSrcHandlerToPackageSync(
                        this.mSrcCtx, this.mSrcHdlr, this.mDstPackageName, this.mDstClassName);
  ...
  public void disconnect() {
    ...
    if (this.mConnection == null
        && (messenger = this.mDstMessenger) != null
        && this.mDeathMonitor != null) {
    ...
    public static Message sendMessageSynchronously(Messenger dstMessenger, Message msg) {
      ...
      if (dstMessenger != null && msg != null) {
        try {
          ...
          Log.m97e(AsyncChannel.TAG, "error in sendMessageSynchronously", e);
        } catch (InterruptedException e2) {
          Log.m97e(AsyncChannel.TAG, "error in sendMessageSynchronously", e2);
        }
      }
      sm.recycle();
      return resultMsg;
