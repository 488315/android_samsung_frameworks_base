...
public final class FrameworkStatsLog {
    ...
    public static final int
            ACCESSIBILITY_SHORTCUT_REPORTED__SHORTCUT_TYPE__A11Y_WEAR_TRIPLE_PRESS_GESTURE = 7;
    ...
    public static final int ACCESSIBILITY_SHORTCUT_REPORTED__SHORTCUT_TYPE__TWO_FINGER_TRIPLE_TAP =
            8;
    ...
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__A11Y_BUTTON_LONG_PRESS = 4;
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__A11Y_FLOATING_MENU = 5;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__A11Y_GESTURE = 6;
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__A11Y_WEAR_TRIPLE_PRESS_GESTURE = 7;
    ...
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__TWO_FINGER_TRIPLE_TAP = 8;
    ...
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__A11Y_BUTTON_LONG_PRESS = 4;
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__A11Y_FLOATING_MENU = 5;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__A11Y_GESTURE = 6;
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__A11Y_WEAR_TRIPLE_PRESS_GESTURE =
                    7;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__QUICK_SETTINGS =
            9;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__TRIPLE_TAP = 3;
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__TWO_FINGER_TRIPLE_TAP = 8;
    ...
    public static final int ACCESSIBILITY_SHORTCUT_STATS__QS_SHORTCUT_TYPE__A11Y_BUTTON_LONG_PRESS =
            4;
    ...
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__QS_SHORTCUT_TYPE__A11Y_WEAR_TRIPLE_PRESS_GESTURE = 7;
    ...
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__A11Y_BUTTON_LONG_PRESS = 4;
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__A11Y_FLOATING_MENU = 5;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__A11Y_GESTURE = 6;
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__A11Y_WEAR_TRIPLE_PRESS_GESTURE =
                    7;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__QUICK_SETTINGS =
            9;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__TRIPLE_TAP = 3;
    public static final int
            ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__TWO_FINGER_TRIPLE_TAP = 8;
    ...
    public static final int ADAPTIVE_AUTH_UNLOCK_AFTER_LOCK_REPORTED__UNLOCK_TYPE__BIOMETRIC_AUTH =
            2;
    ...
    public static final int
            ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY =
            1015;
    public static final int
            ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    ...
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT =
            1017;
    public static final int
            ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT =
            1012;
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int
            ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    ...
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI =
            1001;
    ...
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING =
            1011;
    public static final int
            ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
            998;
    ...
    public static final int
            ANRLATENCY_REPORTED__ANR_TYPE__INPUT_DISPATCHING_TIMEOUT_NO_FOCUSED_WINDOW = 4;
    ...
    public static final int APEX_INFO_GATHERED__ALGO_TYPE__DIGEST_ALGORITHM_VERITY_CHUNKED_SHA256 =
            3;
    ...
    public static final int APPLICATION_LOCALES_CHANGED__CALLER__CALLER_APP_UPDATE_LOCALES_CHANGE =
            4;
    ...
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ACCOUNT_TRANSFER = 104;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ACTIVE_DEVICE_ADMIN = 324;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ACTIVITY_RECOGNITION = 103;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ACTIVITY_STARTER = 52;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ACTIVITY_VISIBILITY_GRACE_PERIOD =
                    67;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ALARM_MANAGER_ALARM_CLOCK =
                    301;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ALARM_MANAGER_WHILE_IDLE =
                    302;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ALLOWLISTED_PACKAGE = 65;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_APPOP = 66;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_BACKGROUND_ACTIVITY_PERMISSION =
                    58;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_BACKGROUND_FGS_PERMISSION =
                    59;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_BLUETOOTH_BROADCAST = 203;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_BOOT_COMPLETED = 200;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_CARRIER_PRIVILEGED_APP = 321;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_COMPANION_DEVICE_MANAGER =
                    57;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_CURRENT_INPUT_METHOD = 71;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DENIED = 1;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DEVICE_DEMO_MODE = 63;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DEVICE_OWNER = 55;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DISALLOW_APPS_CONTROL = 323;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DOMAIN_VERIFICATION_V1 = 307;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DOMAIN_VERIFICATION_V2 = 308;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DPO_PROTECTED_APP = 322;
    ...
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_EVENT_SMS =
            314;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_FGS_BINDING =
            54;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_GEOFENCING =
            100;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_INSTR_BACKGROUND_ACTIVITY_PERMISSION =
                    60;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_INSTR_BACKGROUND_FGS_PERMISSION =
                    61;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_KEY_CHAIN =
            304;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_LOCALE_CHANGED = 206;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_LOCATION_PROVIDER = 312;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_LOCKED_BOOT_COMPLETED = 202;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_MEDIA_BUTTON = 313;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_MEDIA_NOTIFICATION_TRANSFER =
                    325;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_MEDIA_SESSION_CALLBACK = 317;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_NOTIFICATION_SERVICE = 310;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_OPT_OUT_REQUESTED = 1000;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_OP_ACTIVATE_PLATFORM_VPN =
                    69;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_OP_ACTIVATE_VPN = 68;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_OTHER = 2;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PACKAGE_INSTALLER = 326;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PACKAGE_REPLACED = 311;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PACKAGE_UNARCHIVE = 328;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PACKAGE_VERIFIER = 305;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PRE_BOOT_COMPLETED = 201;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PROC_STATE_BFGS = 15;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PROC_STATE_BTOP = 13;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PROC_STATE_FGS = 14;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PROC_STATE_PERSISTENT = 10;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PROC_STATE_PERSISTENT_UI =
                    11;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PROC_STATE_TOP = 12;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PROFILE_OWNER = 56;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PUSH_MESSAGING = 101;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_PUSH_MESSAGING_OVER_QUOTA =
                    102;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_REFRESH_SAFETY_SOURCES = 208;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ROLE_DIALER =
            318;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_ROLE_EMERGENCY = 319;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SCHEDULE_EXACT_ALARM_PERMISSION_STATE_CHANGED =
                    207;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SERVICE_LAUNCH = 303;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SHELL = 316;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_START_ACTIVITY_FLAG = 53;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SYNC_MANAGER = 306;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SYSTEM_ALERT_WINDOW_PERMISSION =
                    62;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SYSTEM_ALLOW_LISTED = 300;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SYSTEM_EXEMPT_APP_OP = 327;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SYSTEM_MODULE = 320;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SYSTEM_UID =
            51;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_TEMP_ALLOWED_WHILE_IN_USE =
                    70;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_TILE_ONCLICK = 329;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_TIMEZONE_CHANGED = 204;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_TIME_CHANGED = 205;
    ...
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__PREVIOUS_RESTRICTION_LEVEL__LEVEL_ADAPTIVE_BUCKET = 3;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__PREVIOUS_RESTRICTION_LEVEL__LEVEL_BACKGROUND_RESTRICTED =
                    5;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__PREVIOUS_RESTRICTION_LEVEL__LEVEL_EXEMPTED = 2;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__PREVIOUS_RESTRICTION_LEVEL__LEVEL_HIBERNATION = 6;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__PREVIOUS_RESTRICTION_LEVEL__LEVEL_RESTRICTED_BUCKET =
                    4;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__PREVIOUS_RESTRICTION_LEVEL__LEVEL_UNKNOWN = 0;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__PREVIOUS_RESTRICTION_LEVEL__LEVEL_UNRESTRICTED = 1;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__RESTRICTION_LEVEL__LEVEL_ADAPTIVE_BUCKET = 3;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__RESTRICTION_LEVEL__LEVEL_BACKGROUND_RESTRICTED = 5;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__RESTRICTION_LEVEL__LEVEL_EXEMPTED = 2;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__RESTRICTION_LEVEL__LEVEL_HIBERNATION =
            6;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__RESTRICTION_LEVEL__LEVEL_RESTRICTED_BUCKET = 4;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__RESTRICTION_LEVEL__LEVEL_UNKNOWN = 0;
    public static final int
            APP_BACKGROUND_RESTRICTIONS_INFO__RESTRICTION_LEVEL__LEVEL_UNRESTRICTED = 1;
    ...
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__TRACKER__BATTERY_EXEMPTION_TRACKER =
            2;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__TRACKER__BATTERY_TRACKER = 1;
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__TRACKER__BIND_SERVICE_EVENTS_TRACKER =
            7;
    ...
    public static final int APP_COMPACTED_V2__OOM_CHANGE_REASON__OOM_ADJ_REASON_COMPONENT_DISABLED =
            22;
    public static final int APP_COMPACTED_V2__OOM_CHANGE_REASON__OOM_ADJ_REASON_EXECUTING_SERVICE =
            20;
    ...
    public static final int APP_COMPACTED_V2__OOM_CHANGE_REASON__OOM_ADJ_REASON_SHORT_FGS_TIMEOUT =
            13;
    ...
    public static final int APP_COMPACTED_V2__OOM_CHANGE_REASON__OOM_ADJ_REASON_UNKNOWN_TO_PROTO =
            -1;
    ...
    public static final int APP_COMPACTED__PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
            1004;
    ...
    public static final int APP_COMPACTED__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
            1016;
    ...
    public static final int APP_FREEZE_CHANGED__UNFREEZE_REASON_V2__UFR_FILE_LOCK_CHECK_FAILURE =
            17;
    ...
    public static final int
            APP_OPS__OP_ID__APP_OP_CAPTURE_CONSENTLESS_BUGREPORT_ON_USERDEBUG_BUILD = 131;
    ...
    public static final int
            APP_OPS__OP_ID__APP_OP_SYSTEM_EXEMPT_FROM_ACTIVITY_BG_START_RESTRICTION = 130;
    public static final int APP_OPS__OP_ID__APP_OP_SYSTEM_EXEMPT_FROM_DISMISSIBLE_NOTIFICATIONS =
            125;
    ...
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_CACHED_IDLE_FORCED_APP_STANDBY =
            18;
    ...
    public static final int
            APP_PROCESS_DIED__SUB_REASON__SUBREASON_EXCESSIVE_OUTGOING_BROADCASTS_WHILE_CACHED = 32;
    ...
    public static final int
            APP_RESTRICTION_STATE_CHANGED__RESTRICTION_TYPE__TYPE_BACKGROUND_RESTRICTED = 5;
    ...
    public static final int
            APP_RESTRICTION_STATE_CHANGED__RESTRICTION_TYPE__TYPE_RESTRICTED_BUCKET = 4;
    ...
    public static final int APP_RESTRICTION_STATE_CHANGED__RESTRICTION_TYPE__TYPE_USER_LAUNCH_ONLY =
            7;
    ...
    public static final int APP_START_OCCURRED__MULTI_WINDOW_LAUNCH_TYPE__LAUNCH_TYPE_UNSPECIFIED =
            0;
    ...
    public static final int
            APP_START_OCCURRED__PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 5;
    ...
    public static final int
            APP_START_OCCURRED__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 17;
    ...
    public static final int APP_START_OCCURRED__PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
            7;
    public static final int APP_START_OCCURRED__PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
            6;
    ...
    public static final int APP_START_OCCURRED__PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
            8;
    ...
    public static final int APP_SUPPORTED_LOCALES_CHANGED__STATUS__FAILURE_INVALID_TARGET_PACKAGE =
            3;
    ...
    public static final int
            ATTENTION_MANAGER_SERVICE_RESULT_REPORTED__ATTENTION_CHECK_RESULT__ATTENTION_FAILURE_CAMERA_PERMISSION_ABSENT =
                    6;
    public static final int
            ATTENTION_MANAGER_SERVICE_RESULT_REPORTED__ATTENTION_CHECK_RESULT__ATTENTION_FAILURE_CANCELLED =
                    3;
    public static final int
            ATTENTION_MANAGER_SERVICE_RESULT_REPORTED__ATTENTION_CHECK_RESULT__ATTENTION_FAILURE_PREEMPTED =
                    4;
    public static final int
            ATTENTION_MANAGER_SERVICE_RESULT_REPORTED__ATTENTION_CHECK_RESULT__ATTENTION_FAILURE_TIMED_OUT =
                    5;
    public static final int
            ATTENTION_MANAGER_SERVICE_RESULT_REPORTED__ATTENTION_CHECK_RESULT__ATTENTION_FAILURE_UNKNOWN =
                    2;
    public static final int
            ATTENTION_MANAGER_SERVICE_RESULT_REPORTED__ATTENTION_CHECK_RESULT__ATTENTION_SUCCESS_ABSENT =
                    0;
    public static final int
            ATTENTION_MANAGER_SERVICE_RESULT_REPORTED__ATTENTION_CHECK_RESULT__ATTENTION_SUCCESS_PRESENT =
                    1;
    public static final int
            ATTENTION_MANAGER_SERVICE_RESULT_REPORTED__ATTENTION_CHECK_RESULT__UNKNOWN = 20;
    ...
    public static final int
            ATTRIBUTED_APP_OPS__OP__APP_OP_CAPTURE_CONSENTLESS_BUGREPORT_ON_USERDEBUG_BUILD = 131;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_RAPID_CLEAR_NOTIFICATIONS_BY_LISTENER =
            142;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_RECEIVE_EXPLICIT_USER_INTERACTION_AUDIO =
            121;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_RECEIVE_MMS = 18;
    public static final int
            ATTRIBUTED_APP_OPS__OP__APP_OP_RECEIVE_SANDBOXED_DETECTION_TRAINING_DATA = 137;
    ...
    public static final int
            ATTRIBUTED_APP_OPS__OP__APP_OP_SYSTEM_EXEMPT_FROM_ACTIVITY_BG_START_RESTRICTION = 130;
    public static final int
            ATTRIBUTED_APP_OPS__OP__APP_OP_SYSTEM_EXEMPT_FROM_DISMISSIBLE_NOTIFICATIONS = 125;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_SYSTEM_EXEMPT_FROM_HIBERNATION = 129;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_SYSTEM_EXEMPT_FROM_POWER_RESTRICTIONS =
            128;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER =
            105;
    ...
    public static final int
            AUTH_DEPRECATED_APIUSED__DEPRECATED_API__API_BIOMETRIC_MANAGER_CAN_AUTHENTICATE = 4;
    public static final int
            AUTH_DEPRECATED_APIUSED__DEPRECATED_API__API_FINGERPRINT_MANAGER_AUTHENTICATE = 1;
    public static final int
    ...
    public static final int AUTOFILL_FIELD_CLASSIFICATION_EVENT_REPORTED__STATUS__STATUS_SUCCESS =
            1;
    public static final int AUTOFILL_FIELD_CLASSIFICATION_EVENT_REPORTED__STATUS__STATUS_UNKNOWN =
            0;
    ...
    public static final int
            AUTOFILL_FILL_REQUEST_REPORTED__REQUEST_TRIGGER_REASON__TRIGGER_REASON_NORMAL_TRIGGER =
                    4;
    public static final int
            AUTOFILL_FILL_REQUEST_REPORTED__REQUEST_TRIGGER_REASON__TRIGGER_REASON_PRE_TRIGGER = 3;
    public static final int
            AUTOFILL_FILL_REQUEST_REPORTED__REQUEST_TRIGGER_REASON__TRIGGER_REASON_RETRIGGER = 2;
    public static final int
            AUTOFILL_FILL_REQUEST_REPORTED__REQUEST_TRIGGER_REASON__TRIGGER_REASON_SERVED_FROM_CACHED_RESPONSE =
                    5;
    public static final int
            AUTOFILL_FILL_REQUEST_REPORTED__REQUEST_TRIGGER_REASON__TRIGGER_REASON_UNKNOWN = 0;
    public static final int AUTOFILL_FILL_RESPONSE_REPORTED = 605;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__AUTHENTICATION_RESULT__AUTHENTICATION_FAILURE = 2;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__AUTHENTICATION_RESULT__AUTHENTICATION_RESULT_UNKNOWN =
                    0;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__AUTHENTICATION_RESULT__AUTHENTICATION_SUCCESS = 1;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__AUTHENTICATION_TYPE__AUTHENTICATION_TYPE_UNKNOWN = 0;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__AUTHENTICATION_TYPE__DATASET_AUTHENTICATION = 1;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__AUTHENTICATION_TYPE__FULL_AUTHENTICATION = 2;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__DETECTION_PREFERENCE__DETECTION_PREFER_AUTOFILL_PROVIDER =
                    1;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__DETECTION_PREFERENCE__DETECTION_PREFER_PCC = 2;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__DETECTION_PREFERENCE__DETECTION_PREFER_UNKONWN = 0;
    ...
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__DISPLAY_PRESENTATION_TYPE__UNKNOWN_AUTOFILL_DISPLAY_PRESENTATION_TYPE =
                    0;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__RESPONSE_STATUS__RESPONSE_STATUS_CANCELLED = 3;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__RESPONSE_STATUS__RESPONSE_STATUS_FAILURE = 1;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__RESPONSE_STATUS__RESPONSE_STATUS_SESSION_DESTROYED = 5;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__RESPONSE_STATUS__RESPONSE_STATUS_SUCCESS = 2;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__RESPONSE_STATUS__RESPONSE_STATUS_TIMEOUT = 4;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__RESPONSE_STATUS__RESPONSE_STATUS_TRANSACTION_TOO_LARGE =
                    6;
    public static final int
            AUTOFILL_FILL_RESPONSE_REPORTED__RESPONSE_STATUS__RESPONSE_STATUS_UNKNOWN = 0;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED = 469;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__AUTHENTICATION_RESULT__AUTHENTICATION_FAILURE = 2;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__AUTHENTICATION_RESULT__AUTHENTICATION_RESULT_UNKNOWN =
                    0;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__AUTHENTICATION_RESULT__AUTHENTICATION_SUCCESS = 1;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__AUTHENTICATION_TYPE__AUTHENTICATION_TYPE_UNKNOWN =
                    0;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__AUTHENTICATION_TYPE__DATASET_AUTHENTICATION = 1;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__AUTHENTICATION_TYPE__FULL_AUTHENTICATION = 2;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__DETECTION_PREFERENCE__DETECTION_PREFER_AUTOFILL_PROVIDER =
                    1;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__DETECTION_PREFERENCE__DETECTION_PREFER_PCC = 2;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__DETECTION_PREFERENCE__DETECTION_PREFER_UNKONWN =
                    0;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__DISPLAY_PRESENTATION_TYPE__DIALOG = 3;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__DISPLAY_PRESENTATION_TYPE__INLINE = 2;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__DISPLAY_PRESENTATION_TYPE__MENU =
            1;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__DISPLAY_PRESENTATION_TYPE__UNKNOWN_AUTOFILL_DISPLAY_PRESENTATION_TYPE =
                    0;
    public static final int
            AUTOFILL_PRESENTATION_EVENT_REPORTED__PRESENTATION_EVENT_RESULT__ANY_SHOWN = 1;
    public static final int
    ...
    public static final int
            AUTOFILL_SAVE_EVENT_REPORTED__SAVE_UI_NOT_SHOWN_REASON__NO_SAVE_REASON_HAS_EMPTY_REQUIRED =
                    4;
    public static final int
            AUTOFILL_SAVE_EVENT_REPORTED__SAVE_UI_NOT_SHOWN_REASON__NO_SAVE_REASON_NONE = 1;
    public static final int
            AUTOFILL_SAVE_EVENT_REPORTED__SAVE_UI_NOT_SHOWN_REASON__NO_SAVE_REASON_NO_SAVE_INFO = 2;
    public static final int
    ...
    public static final int
            AUTOFILL_SAVE_EVENT_REPORTED__SAVE_UI_NOT_SHOWN_REASON__NO_SAVE_REASON_SESSION_DESTROYED =
                    9;
    public static final int
            AUTOFILL_SAVE_EVENT_REPORTED__SAVE_UI_NOT_SHOWN_REASON__NO_SAVE_REASON_UNKNOWN = 0;
    public static final int
    ...
    public static final int
            AUTOFILL_SAVE_EVENT_REPORTED__SAVE_UI_SHOWN_REASON__SAVE_UI_SHOWN_REASON_TRIGGER_ID_SET =
                    3;
    public static final int
            AUTOFILL_SAVE_EVENT_REPORTED__SAVE_UI_SHOWN_REASON__SAVE_UI_SHOWN_REASON_UNKNOWN = 0;
    public static final int AUTOFILL_SESSION_COMMITTED = 607;
    public static final int
            AUTOFILL_SESSION_COMMITTED__COMMIT_REASON__COMMIT_REASON_ACTIVITY_FINISHED = 1;
    public static final int
            AUTOFILL_SESSION_COMMITTED__COMMIT_REASON__COMMIT_REASON_SESSION_DESTROYED = 5;
    ...
    public static final int AUTOFILL_SESSION_COMMITTED__COMMIT_REASON__COMMIT_REASON_VIEW_CLICKED =
            3;
    public static final int
            AUTOFILL_SESSION_COMMITTED__COMMIT_REASON__COMMIT_REASON_VIEW_COMMITTED = 2;
    public static final int AUTOFILL_UI_EVENT_REPORTED = 603;
    public static final int
            AUTOFILL_UI_EVENT_REPORTED__EVENT_TYPE__ACTION_SETTINGS_UPDATE_DEFAULT_APP = 2;
    public static final int AUTOFILL_UI_EVENT_REPORTED__EVENT_TYPE__AUTOFILL_ENABLED_FROM_DENYLIST =
            6;
    public static final int
            AUTOFILL_UI_EVENT_REPORTED__EVENT_TYPE__AUTOFILL_FORGED_COMPONENT_ATTEMPT = 7;
    public static final int
            AUTOFILL_UI_EVENT_REPORTED__EVENT_TYPE__AUTOFILL_SERVICE_DISABLED_ACTIVITY = 5;
    public static final int AUTOFILL_UI_EVENT_REPORTED__EVENT_TYPE__AUTOFILL_SERVICE_DISABLED_APP =
            4;
    public static final int AUTOFILL_UI_EVENT_REPORTED__EVENT_TYPE__AUTOFILL_SERVICE_DISABLED_SELF =
            3;
    ...
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_NON_APP_VISIBLE_WINDOW =
            11;
    ...
    public static final int
            BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_ALLOWLISTED_COMPONENT = 3;
    ...
    public static final int
            BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_NON_APP_VISIBLE_WINDOW = 11;
    ...
    public static final int BIOMETRIC_AUTHENTICATED__SESSION_TYPE__SESSION_TYPE_BIOMETRIC_PROMPT =
            2;
    ...
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_ALTERNATE_BIOMETRIC_BOUNCER_SHOWN =
                    4;
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_ASSISTANT_VISIBLE = 3;
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_NOTIFICATION_PANEL_CLICKED =
                    5;
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_OCCLUDING_APP_REQUESTED = 6;
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_PICK_UP_GESTURE_TRIGGERED =
                    7;
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_PRIMARY_BOUNCER_SHOWN = 2;
    public static final int BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_QS_EXPANDED =
            8;
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_STARTED_WAKING_UP = 1;
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_SWIPE_UP_ON_BOUNCER = 9;
    public static final int
            BIOMETRIC_AUTHENTICATED__WAKE_REASON_DETAILS__DETAILS_FACE_UDFPS_POINTER_DOWN = 10;
    ...
    public static final int BIOMETRIC_AUTHENTICATED__WAKE_REASON__WAKE_REASON_DISPLAY_GROUP_ADDED =
            6;
    ...
    public static final int BIOMETRIC_ERROR_OCCURRED__SESSION_TYPE__SESSION_TYPE_BIOMETRIC_PROMPT =
            2;
    ...
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_ALTERNATE_BIOMETRIC_BOUNCER_SHOWN =
                    4;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_ASSISTANT_VISIBLE = 3;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_NOTIFICATION_PANEL_CLICKED =
                    5;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_OCCLUDING_APP_REQUESTED = 6;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_PICK_UP_GESTURE_TRIGGERED =
                    7;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_PRIMARY_BOUNCER_SHOWN = 2;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_QS_EXPANDED = 8;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_STARTED_WAKING_UP = 1;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_SWIPE_UP_ON_BOUNCER = 9;
    public static final int
            BIOMETRIC_ERROR_OCCURRED__WAKE_REASON_DETAILS__DETAILS_FACE_UDFPS_POINTER_DOWN = 10;
    ...
    public static final int BIOMETRIC_ERROR_OCCURRED__WAKE_REASON__WAKE_REASON_DISPLAY_GROUP_ADDED =
            6;
    ...
    public static final int BIOMETRIC_FRRNOTIFICATION__ACTION__FRR_NOTIFICATION_ACTION_DISMISSED =
            3;
    ...
    public static final int BIOMETRIC_PROPERTIES_COLLECTED__SENSOR_STRENGTH__STRENGTH_CONVENIENCE =
            1;
    ...
    public static final int BIOMETRIC_PROPERTIES_COLLECTED__SENSOR_TYPE__SENSOR_FP_UDFPS_OPTICAL =
            3;
    public static final int
            BIOMETRIC_PROPERTIES_COLLECTED__SENSOR_TYPE__SENSOR_FP_UDFPS_ULTRASONIC = 2;
    ...
    public static final int BIOMETRIC_SYSTEM_HEALTH_ISSUE_DETECTED__ISSUE__ISSUE_CANCEL_TIMED_OUT =
            4;
    ...
    public static final int
            BIOMETRIC_SYSTEM_HEALTH_ISSUE_DETECTED__ISSUE__ISSUE_UNKNOWN_TEMPLATE_ENROLLED_FRAMEWORK =
                    2;
    public static final int
            BIOMETRIC_SYSTEM_HEALTH_ISSUE_DETECTED__ISSUE__ISSUE_UNKNOWN_TEMPLATE_ENROLLED_HAL = 3;
    public static final int BIOMETRIC_SYSTEM_HEALTH_ISSUE_DETECTED__MODALITY__MODALITY_FACE = 4;
    public static final int BIOMETRIC_SYSTEM_HEALTH_ISSUE_DETECTED__MODALITY__MODALITY_FINGERPRINT =
            1;
    ...
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__EVENT__BOOT_COMPLETED = 2;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__EVENT__LOCKED_BOOT_COMPLETED = 1;
    public static final int BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__EVENT__UNKNOWN =
            0;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__FULL_DEMO = 4;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__FULL_GUEST = 3;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__FULL_RESTRICTED = 5;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__FULL_SECONDARY = 2;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__FULL_SYSTEM = 1;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__PROFILE_CLONE = 8;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__PROFILE_MANAGED = 6;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__PROFILE_PRIVATE = 9;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__SYSTEM_HEADLESS = 7;
    public static final int
            BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__TYPE_UNKNOWN = 0;
    ...
    public static final int
            BOOT_TIME_EVENT_DURATION__EVENT__OTA_PACKAGE_MANAGER_DATA_APP_AVG_SCAN_TIME = 14;
    public static final int BOOT_TIME_EVENT_DURATION__EVENT__OTA_PACKAGE_MANAGER_INIT_TIME = 13;
    public static final int
            BOOT_TIME_EVENT_DURATION__EVENT__OTA_PACKAGE_MANAGER_SYSTEM_APP_AVG_SCAN_TIME = 15;
    ...
    public static final int
            BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__FACTORY_RESET_BOOT_COMPLETE_NO_ENCRYPTION = 7;
    public static final int
            BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__FACTORY_RESET_BOOT_COMPLETE_POST_DECRYPT = 8;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__FRAMEWORK_BOOT_COMPLETED = 13;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__FRAMEWORK_LOCKED_BOOT_COMPLETED =
            12;
    ...
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__OTA_BOOT_COMPLETE_NO_ENCRYPTION =
            10;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__OTA_BOOT_COMPLETE_POST_DECRYPT =
            11;
    ...
    public static final int BOOT_TIME_EVENT_ERROR_CODE__EVENT__FACTORY_RESET_CURRENT_TIME_FAILURE =
            1;
    ...
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__DELIVERY_GROUP_POLICY__BROADCAST_DELIVERY_GROUP_POLICY_ALL =
                    0;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__DELIVERY_GROUP_POLICY__BROADCAST_DELIVERY_GROUP_POLICY_MERGED =
                    2;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__DELIVERY_GROUP_POLICY__BROADCAST_DELIVERY_GROUP_POLICY_MOST_RECENT =
                    1;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_NORMAL = 1;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_STOPPED = 2;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_UNKNOWN = 0;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_COLD = 3;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_HOT = 2;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_UNKNOWN = 0;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_WARM = 1;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_BOUND_TOP =
                    1020;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY =
                    1015;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY =
                    1018;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT =
                    1017;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT =
                    1012;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY =
                    1014;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_NONEXISTENT =
                    1019;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_PERSISTENT =
                    1000;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI =
                    1001;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_RECEIVER =
                    1010;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING =
                    1011;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
                    998;
    ...
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_CACHED_ACTIVITY =
                    1015;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_CACHED_RECENT =
                    1017;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_LAST_ACTIVITY =
                    1014;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_PERSISTENT_UI =
                    1001;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_TOP = 1002;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
                    998;
    ...
    public static final int CAMERA_COMPAT_CONTROL_EVENT_REPORTED__EVENT__APPEARED_APPLY_TREATMENT =
            1;
    public static final int CAMERA_COMPAT_CONTROL_EVENT_REPORTED__EVENT__APPEARED_REVERT_TREATMENT =
            2;
    public static final int CAMERA_COMPAT_CONTROL_EVENT_REPORTED__EVENT__CLICKED_APPLY_TREATMENT =
            3;
    public static final int CAMERA_COMPAT_CONTROL_EVENT_REPORTED__EVENT__CLICKED_DISMISS = 5;
    public static final int CAMERA_COMPAT_CONTROL_EVENT_REPORTED__EVENT__CLICKED_REVERT_TREATMENT =
            4;
    ...
    public static final int
            CAMERA_FEATURE_COMBINATION_QUERY_EVENT__QUERY_TYPE__QUERY_FEATURE_COMBINATION = 0;
    public static final int
            CAMERA_FEATURE_COMBINATION_QUERY_EVENT__QUERY_TYPE__QUERY_SESSION_CHARACTERISTICS = 1;
    public static final int
            CAMERA_FEATURE_COMBINATION_QUERY_EVENT__STATUS_CODE__ERROR_ILLEGAL_ARGUMENT = 3;
    public static final int
            CAMERA_FEATURE_COMBINATION_QUERY_EVENT__STATUS_CODE__ERROR_INVALID_OPERATION = 10;
    ...
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AEB_HYBRID_HDR_MERGE = 201;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AIF_MERGE = 110;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_CLEAR_ZOOM_MERGE_OIS_ANCHOR_6 =
                    271;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_CLEAR_ZOOM_MERGE_ZSL_ANCHOR_6 =
                    270;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_HDR =
            183;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_LLS =
            185;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_MAX_RESOLUTION_HDR = 181;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_MAX_RESOLUTION_LLS = 184;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_MAX_RESOLUTION_SINGLE =
                    180;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_MAX_RESOLUTION_SINGLE_FLASH =
                    186;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_AI_HIGHRES_SINGLE =
            182;
    ...
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_HDR_QM_LT = 48;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_LLHDR =
            42;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_LLS = 40;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_NIGHT =
            45;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_NIGHT_REMOSAIC = 280;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_QM_LT =
            47;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_SINGLE =
            46;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_SR = 43;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_SR_HDR =
            44;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_DUAL_BOKEH_SUB_NIGHT = 49;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_EXECUTOR_NIGHT =
            1000;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_EXECUTOR_TETRA_SR =
            1001;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_EXPERT_RAW_MFRP_MERGE = 170;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_FUSION_HIGHRES_LLHDR_MERGE = 211;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_FUSION_HIGHRES_MERGE = 210;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIFI_MERGE_DEBLUR =
            11;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIFI_MERGE_FLASH =
            15;
    ...
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIGHRES_LLHDR_MERGE = 91;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HIGHRES_MERGE = 90;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_LLHDR_MERGE_LOIS = 196;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_LLHDR_MERGE_LZ = 195;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_LLHDR_MERGE_QOIS = 198;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_LLHDR_MERGE_QZ = 197;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_MFHDR_MERGE_LOIS = 191;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_MFHDR_MERGE_LZ = 190;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_MFHDR_MERGE_QOIS = 193;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_MFHDR_MERGE_QZ = 192;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_NNHDR_MERGE_LOIS = 242;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_NNHDR_MERGE_LZ = 240;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_NNHDR_MERGE_QOIS = 243;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_HYBRID_NNHDR_MERGE_QZ = 241;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LITE_LLHDR_MERGE =
            101;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LITE_MERGE = 100;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_LDEBLURVEHDR_QZM = 39;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_LDEBLURVENR = 60;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_LZT =
            30;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM3_LOIST = 31;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM4 =
            32;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM5_LCREMOSAIC = 33;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM6 =
            34;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QOISM7 =
            35;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QZM5 =
            37;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_LLHDR_MERGE_QZM7 =
            38;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MACRO_RAW_SR_MERGE =
            250;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_LZT =
            20;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM3_LOIST = 22;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM4_LCREMOSAIC = 23;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM5 =
            24;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM6 =
            25;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QOISM7 =
            26;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QZM5 =
            28;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_QZM7 =
            29;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MFHDR_MERGE_REMOSAIC = 21;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MF_SR_MERGE = 70;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MF_SR_MERGE_HDR =
            71;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MF_SR_MERGE_REMOSAIC = 75;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_MF_UW_SR_MERGE =
            130;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_PRO_RGB_CONVERSION =
            230;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_RAW_SR_MERGE = 160;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_RAW_SR_MERGE_BRIGHT_SKY_MOON_HYBRID =
                    161;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_RAW_SR_MERGE_HYBRID = 162;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SIE_LLHDR_MERGE =
            121;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SIE_MERGE = 120;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SIE_MFHDR_MERGE =
            122;
    ...
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_EXTREME_DARK = 83;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_EXTREME_DARK_MAX = 86;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HANDHELD = 80;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HANDHELD_MAX = 84;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HANDHELD_MAX_REMOSAIC =
                    88;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HANDHELD_REMOSAIC = 87;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HIGHRES_EXTREME_DARK =
                    261;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HIGHRES_HANDHELD = 260;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_HIGHRES_HANDHELD_REMOSAIC =
                    262;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_TRIPOD =
            81;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_TRIPOD_LE = 82;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SUPER_NIGHT_TRIPOD_MAX = 85;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_SW_ND_FILTER = 221;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_TETRA_SR_MERGE =
            290;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_RAW_AI_HIGHRES_MAX_RESOLUTION_HDR_MERGE =
                    145;
    public static final int
            CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_RAW_AI_HIGHRES_MAX_RESOLUTION_MERGE =
                    144;
    public static final int CAMERA_SHOT_LATENCY_REPORTED__MODE__CONTROL_DS_MODE_UDC_RAW_HDR_MERGE =
            141;
    ...
    public static final int CDM_ASSOCIATION_ACTION__DEVICE_PROFILE__DEVICE_PROFILE_APP_STREAMING =
            2;
    public static final int CDM_ASSOCIATION_ACTION__DEVICE_PROFILE__DEVICE_PROFILE_AUTO_PROJECTION =
            3;
    ...
    public static final int
            CDM_ASSOCIATION_ACTION__DEVICE_PROFILE__DEVICE_PROFILE_NEARBY_DEVICE_STREAMING = 6;
    ...
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_NEW_STATE__COMPONENT_STATE_DEFAULT = 0;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_NEW_STATE__COMPONENT_STATE_DISABLED = 2;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_NEW_STATE__COMPONENT_STATE_DISABLED_UNTIL_USED =
                    4;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_NEW_STATE__COMPONENT_STATE_DISABLED_USER =
                    3;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_NEW_STATE__COMPONENT_STATE_ENABLED = 1;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_OLD_STATE__COMPONENT_STATE_DEFAULT = 0;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_OLD_STATE__COMPONENT_STATE_DISABLED = 2;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_OLD_STATE__COMPONENT_STATE_DISABLED_UNTIL_USED =
                    4;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_OLD_STATE__COMPONENT_STATE_DISABLED_USER =
                    3;
    public static final int
            COMPONENT_STATE_CHANGED_REPORTED__COMPONENT_OLD_STATE__COMPONENT_STATE_ENABLED = 1;
    ...
    public static final int
            CONTENT_CAPTURE_SERVICE_EVENTS__EVENT__DATA_SHARE_ERROR_CLIENT_PIPE_FAIL = 12;
    public static final int
            CONTENT_CAPTURE_SERVICE_EVENTS__EVENT__DATA_SHARE_ERROR_CONCURRENT_REQUEST = 14;
    public static final int CONTENT_CAPTURE_SERVICE_EVENTS__EVENT__DATA_SHARE_ERROR_EMPTY_DATA = 11;
    public static final int CONTENT_CAPTURE_SERVICE_EVENTS__EVENT__DATA_SHARE_ERROR_IOEXCEPTION =
            10;
    public static final int
            CONTENT_CAPTURE_SERVICE_EVENTS__EVENT__DATA_SHARE_ERROR_SERVICE_PIPE_FAIL = 13;
    public static final int
            CONTENT_CAPTURE_SERVICE_EVENTS__EVENT__DATA_SHARE_ERROR_TIMEOUT_INTERRUPTED = 15;
    ...
    public static final int
            CPU_CYCLES_PER_THREAD_GROUP_CLUSTER__THREAD_GROUP__SYSTEM_SERVER_BINDER = 1;
    public static final int
            CPU_CYCLES_PER_THREAD_GROUP_CLUSTER__THREAD_GROUP__UNKNOWN_THREAD_GROUP = 0;
    ...
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__API_NAME__API_NAME_GET_CREDENTIAL_PROVIDER_SERVICES = 6;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__API_NAME__API_NAME_GET_CREDENTIAL_VIA_REGISTRY = 9;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__API_NAME__API_NAME_IS_ENABLED_CREDENTIAL_PROVIDER_SERVICE =
                    4;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__API_NAME__API_NAME_REGISTER_CREDENTIAL_DESCRIPTION = 7;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__API_NAME__API_NAME_SET_ENABLED_PROVIDERS = 5;
    public static final int CREDENTIAL_MANAGER_API_CALLED__API_NAME__API_NAME_UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__API_NAME__API_NAME_UNREGISTER_CREDENTIAL_DESCRIPTION = 8;
    public static final int CREDENTIAL_MANAGER_API_CALLED__API_STATUS__API_STATUS_CLIENT_CANCELED =
            4;
    ...
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CANDIDATE_PROVIDER_STATUS__PROVIDER_FINAL_FAILURE = 4;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CANDIDATE_PROVIDER_STATUS__PROVIDER_FINAL_SUCCESS = 2;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CANDIDATE_PROVIDER_STATUS__PROVIDER_QUERY_FAILURE = 3;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CANDIDATE_PROVIDER_STATUS__PROVIDER_QUERY_SUCCESS = 1;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CANDIDATE_PROVIDER_STATUS__PROVIDER_UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CHOSEN_PROVIDER_STATUS__PROVIDER_FINAL_FAILURE = 4;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CHOSEN_PROVIDER_STATUS__PROVIDER_FINAL_SUCCESS = 2;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CHOSEN_PROVIDER_STATUS__PROVIDER_QUERY_FAILURE = 3;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CHOSEN_PROVIDER_STATUS__PROVIDER_QUERY_SUCCESS = 1;
    public static final int
            CREDENTIAL_MANAGER_API_CALLED__CHOSEN_PROVIDER_STATUS__PROVIDER_UNKNOWN = 0;
    public static final int CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_CLEAR_CREDENTIAL =
            3;
    public static final int CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_CREATE_CREDENTIAL =
            2;
    public static final int CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_GET_CREDENTIAL = 1;
    public static final int
            CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_GET_CREDENTIAL_PROVIDER_SERVICES =
                    6;
    public static final int
            CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_GET_CREDENTIAL_VIA_REGISTRY = 9;
    public static final int
            CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_IS_ENABLED_CREDENTIAL_PROVIDER_SERVICE =
                    4;
    public static final int
            CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_REGISTER_CREDENTIAL_DESCRIPTION = 7;
    public static final int
            CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_SET_ENABLED_PROVIDERS = 5;
    public static final int CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_API_V2CALLED__API_NAME__API_NAME_UNREGISTER_CREDENTIAL_DESCRIPTION =
                    8;
    public static final int
            CREDENTIAL_MANAGER_API_V2CALLED__API_STATUS__API_STATUS_CLIENT_CANCELED = 4;
    ...
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__CANDIDATE_PROVIDER_STATUS__PROVIDER_FINAL_FAILURE =
                    4;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__CANDIDATE_PROVIDER_STATUS__PROVIDER_FINAL_SUCCESS =
                    2;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__CANDIDATE_PROVIDER_STATUS__PROVIDER_QUERY_FAILURE =
                    3;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__CANDIDATE_PROVIDER_STATUS__PROVIDER_QUERY_SUCCESS =
                    1;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__CANDIDATE_PROVIDER_STATUS__PROVIDER_UNKNOWN =
                    0;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__UNIQUE_ENTRIES__ACTION_ENTRY = 1;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__UNIQUE_ENTRIES__AUTHENTICATION_ENTRY =
                    4;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__UNIQUE_ENTRIES__CREDENTIAL_ENTRY = 2;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__UNIQUE_ENTRIES__REMOTE_ENTRY = 3;
    public static final int
            CREDENTIAL_MANAGER_BROWSED_AUTHENTICATION_CLICKED__UNIQUE_ENTRIES__UNKNOWN = 0;
    public static final int CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED = 652;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_CLEAR_CREDENTIAL = 3;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_CREATE_CREDENTIAL = 2;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_GET_CREDENTIAL = 1;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_GET_CREDENTIAL_PROVIDER_SERVICES =
                    6;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_GET_CREDENTIAL_VIA_REGISTRY =
                    9;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_IS_ENABLED_CREDENTIAL_PROVIDER_SERVICE =
                    4;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_REGISTER_CREDENTIAL_DESCRIPTION =
                    7;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_SET_ENABLED_PROVIDERS =
                    5;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__API_NAME__API_NAME_UNREGISTER_CREDENTIAL_DESCRIPTION =
                    8;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__CANDIDATE_PROVIDER_STATUS__PROVIDER_FINAL_FAILURE =
                    4;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__CANDIDATE_PROVIDER_STATUS__PROVIDER_FINAL_SUCCESS =
                    2;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__CANDIDATE_PROVIDER_STATUS__PROVIDER_QUERY_FAILURE =
                    3;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__CANDIDATE_PROVIDER_STATUS__PROVIDER_QUERY_SUCCESS =
                    1;
    public static final int
            CREDENTIAL_MANAGER_CANDIDATE_PHASE_REPORTED__CANDIDATE_PROVIDER_STATUS__PROVIDER_UNKNOWN =
                    0;
    public static final int CREDENTIAL_MANAGER_FINALNOUID_REPORTED = 668;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__API_STATUS__API_STATUS_CLIENT_CANCELED = 4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__API_STATUS__API_STATUS_FAILURE = 2;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__API_STATUS__API_STATUS_SUCCESS = 1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__API_STATUS__API_STATUS_UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__API_STATUS__API_STATUS_USER_CANCELED = 3;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__CLICKED_ENTRIES__ACTION_ENTRY = 1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__CLICKED_ENTRIES__AUTHENTICATION_ENTRY = 4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__CLICKED_ENTRIES__CREDENTIAL_ENTRY = 2;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__CLICKED_ENTRIES__REMOTE_ENTRY = 3;
    public static final int CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__CLICKED_ENTRIES__UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__FINAL_STATUS__PROVIDER_FINAL_FAILURE = 4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__FINAL_STATUS__PROVIDER_FINAL_SUCCESS = 2;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__FINAL_STATUS__PROVIDER_QUERY_FAILURE = 3;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__FINAL_STATUS__PROVIDER_QUERY_SUCCESS = 1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__FINAL_STATUS__PROVIDER_UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__OEM_UI_USAGE_STATUS__OEM_UI_USAGE_STATUS_NOT_SPECIFIED =
                    2;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__OEM_UI_USAGE_STATUS__OEM_UI_USAGE_STATUS_SPECIFIED_BUT_NOT_ENABLED =
                    4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__OEM_UI_USAGE_STATUS__OEM_UI_USAGE_STATUS_SPECIFIED_BUT_NOT_FOUND =
                    3;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__OEM_UI_USAGE_STATUS__OEM_UI_USAGE_STATUS_SUCCESS =
                    1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__OEM_UI_USAGE_STATUS__OEM_UI_USAGE_STATUS_UNKNOWN =
                    0;
    public static final int CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__UNIQUE_ENTRIES__ACTION_ENTRY =
            1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__UNIQUE_ENTRIES__AUTHENTICATION_ENTRY = 4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__UNIQUE_ENTRIES__CREDENTIAL_ENTRY = 2;
    public static final int CREDENTIAL_MANAGER_FINAL_NO_UID_REPORTED__UNIQUE_ENTRIES__REMOTE_ENTRY =
            3;
    ...
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__API_STATUS__API_STATUS_CLIENT_CANCELED = 4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__API_STATUS__API_STATUS_FAILURE = 2;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__API_STATUS__API_STATUS_SUCCESS = 1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__API_STATUS__API_STATUS_UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__API_STATUS__API_STATUS_USER_CANCELED = 3;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CHOSEN_PROVIDER_AVAILABLE_ENTRIES__ACTION_ENTRY =
                    1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CHOSEN_PROVIDER_AVAILABLE_ENTRIES__AUTHENTICATION_ENTRY =
                    4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CHOSEN_PROVIDER_AVAILABLE_ENTRIES__CREDENTIAL_ENTRY =
                    2;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CHOSEN_PROVIDER_AVAILABLE_ENTRIES__REMOTE_ENTRY =
                    3;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CHOSEN_PROVIDER_AVAILABLE_ENTRIES__UNKNOWN = 0;
    public static final int
    ...
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CHOSEN_PROVIDER_STATUS__PROVIDER_QUERY_SUCCESS =
                    1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CHOSEN_PROVIDER_STATUS__PROVIDER_UNKNOWN = 0;
    public static final int CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CLICKED_ENTRIES__ACTION_ENTRY =
            1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CLICKED_ENTRIES__AUTHENTICATION_ENTRY = 4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CLICKED_ENTRIES__CREDENTIAL_ENTRY = 2;
    public static final int CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CLICKED_ENTRIES__REMOTE_ENTRY =
            3;
    public static final int CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__CLICKED_ENTRIES__UNKNOWN = 0;
    public static final int CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__UNIQUE_ENTRIES__ACTION_ENTRY =
            1;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__UNIQUE_ENTRIES__AUTHENTICATION_ENTRY = 4;
    public static final int
            CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__UNIQUE_ENTRIES__CREDENTIAL_ENTRY = 2;
    public static final int CREDENTIAL_MANAGER_FINAL_PHASE_REPORTED__UNIQUE_ENTRIES__REMOTE_ENTRY =
            3;
    ...
    public static final int
            CREDENTIAL_MANAGER_INITIAL_PHASE_REPORTED__API_NAME__API_NAME_CLEAR_CREDENTIAL = 3;
    public static final int
            CREDENTIAL_MANAGER_INITIAL_PHASE_REPORTED__API_NAME__API_NAME_CREATE_CREDENTIAL = 2;
    public static final int
            CREDENTIAL_MANAGER_INITIAL_PHASE_REPORTED__API_NAME__API_NAME_GET_CREDENTIAL = 1;
    public static final int
    ...
    public static final int
            CREDENTIAL_MANAGER_INITIAL_PHASE_REPORTED__API_NAME__API_NAME_REGISTER_CREDENTIAL_DESCRIPTION =
                    7;
    public static final int
            CREDENTIAL_MANAGER_INITIAL_PHASE_REPORTED__API_NAME__API_NAME_SET_ENABLED_PROVIDERS = 5;
    public static final int CREDENTIAL_MANAGER_INITIAL_PHASE_REPORTED__API_NAME__API_NAME_UNKNOWN =
            0;
    public static final int
    ...
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__AUTH_UNIQUE_ENTRIES__ACTION_ENTRY = 1;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__AUTH_UNIQUE_ENTRIES__AUTHENTICATION_ENTRY =
                    4;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__AUTH_UNIQUE_ENTRIES__CREDENTIAL_ENTRY = 2;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__AUTH_UNIQUE_ENTRIES__REMOTE_ENTRY = 3;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__AUTH_UNIQUE_ENTRIES__UNKNOWN = 0;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__QUERY_UNIQUE_ENTRIES__ACTION_ENTRY = 1;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__QUERY_UNIQUE_ENTRIES__AUTHENTICATION_ENTRY =
                    4;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__QUERY_UNIQUE_ENTRIES__CREDENTIAL_ENTRY = 2;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__QUERY_UNIQUE_ENTRIES__REMOTE_ENTRY = 3;
    public static final int
            CREDENTIAL_MANAGER_TOTAL_CANDIDATE_REPORTED__QUERY_UNIQUE_ENTRIES__UNKNOWN = 0;
    ...
    public static final int
            DATA_USAGE_BYTES_TRANSFER_V2__OPPORTUNISTIC_DATA_SUB__DSS_NOT_OPPORTUNISTIC = 3;
    public static final int
            DATA_USAGE_BYTES_TRANSFER_V2__OPPORTUNISTIC_DATA_SUB__DSS_OPPORTUNISTIC = 2;
    ...
    public static final int DATA_USAGE_BYTES_TRANSFER__OPPORTUNISTIC_DATA_SUB__NOT_OPPORTUNISTIC =
            3;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__ALLOW_MODIFICATION_OF_ADMIN_CONFIGURED_NETWORKS = 132;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__BIND_CROSS_PROFILE_SERVICE = 151;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CAN_INTERACT_ACROSS_PROFILES_FALSE_NO_PROFILES = 147;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CAN_INTERACT_ACROSS_PROFILES_FALSE_PERMISSION = 146;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__CAN_INTERACT_ACROSS_PROFILES_TRUE = 145;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CAN_REQUEST_INTERACT_ACROSS_PROFILES_FALSE_NO_PROFILES =
                    142;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CAN_REQUEST_INTERACT_ACROSS_PROFILES_FALSE_PERMISSION =
                    144;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CAN_REQUEST_INTERACT_ACROSS_PROFILES_FALSE_WHITELIST =
                    143;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CAN_REQUEST_INTERACT_ACROSS_PROFILES_TRUE = 141;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CREDENTIAL_MANAGEMENT_APP_CREDENTIAL_FOUND_IN_POLICY =
                    183;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CREDENTIAL_MANAGEMENT_APP_GENERATE_KEY_PAIR_FAILED = 185;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CREDENTIAL_MANAGEMENT_APP_INSTALL_KEY_PAIR_FAILED = 184;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CREDENTIAL_MANAGEMENT_APP_POLICY_LOOKUP_FAILED = 186;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__CREDENTIAL_MANAGEMENT_APP_REMOVED = 187;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CREDENTIAL_MANAGEMENT_APP_REQUEST_ACCEPTED = 180;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CREDENTIAL_MANAGEMENT_APP_REQUEST_DENIED = 181;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CREDENTIAL_MANAGEMENT_APP_REQUEST_FAILED = 182;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_APPS_GET_TARGET_USER_PROFILES = 125;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_APPS_START_ACTIVITY_AS_USER = 126;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_ADMIN_RESTRICTED = 164;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_INSTALL_BANNER_CLICKED = 168;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_INSTALL_BANNER_NO_INTENT_CLICKED =
                    169;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_LAUNCHED_FROM_APP = 162;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_LAUNCHED_FROM_SETTINGS = 163;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_MISSING_INSTALL_BANNER_INTENT =
                    167;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_MISSING_PERSONAL_APP = 166;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_MISSING_WORK_APP = 165;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_PERMISSION_REVOKED = 172;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_USER_CONSENTED = 170;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__CROSS_PROFILE_SETTINGS_PAGE_USER_DECLINED_CONSENT = 171;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__IS_ACTIVE_PASSWORD_SUFFICIENT_FOR_DEVICE = 189;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PLATFORM_PROVISIONING_COPY_ACCOUNT_MS =
            190;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PLATFORM_PROVISIONING_COPY_ACCOUNT_STATUS = 193;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PLATFORM_PROVISIONING_CREATE_PROFILE_MS =
            191;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PLATFORM_PROVISIONING_START_PROFILE_MS =
            192;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PLATFORM_ROLE_HOLDER_UPDATE_FAILED = 215;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PLATFORM_ROLE_HOLDER_UPDATE_FINISHED =
            214;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_DOWNLOAD_PACKAGE_TASK_MS =
            99;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_DPC_INSTALLED_BY_PACKAGE =
            85;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_ENCRYPT_DEVICE_ACTIVITY_TIME_MS = 88;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_ENTRY_POINT_ADB = 82;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_ENTRY_POINT_CLOUD_ENROLLMENT = 81;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_ENTRY_POINT_TRUSTED_SOURCE =
            83;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_FINALIZATION_ACTIVITY_TIME_MS = 92;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_FLOW_TYPE = 124;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_INSTALL_PACKAGE_TASK_MS =
            100;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_MANAGED_PROFILE_ON_FULLY_MANAGED_DEVICE =
                    77;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_PERSISTENT_DEVICE_OWNER =
            78;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_POST_ENCRYPTION_ACTIVITY_TIME_MS = 91;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_PREPROVISIONING_ACTIVITY_TIME_MS = 87;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_PROVISIONING_ACTIVITY_TIME_MS = 86;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_PROVISION_FULLY_MANAGED_DEVICE_TASK_MS =
                    196;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_PROVISION_MANAGED_PROFILE_TASK_MS = 195;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_TERMS_ACTIVITY_TIME_MS =
            107;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__PROVISIONING_TRAMPOLINE_ACTIVITY_TIME_MS = 90;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__RESOLVER_AUTOLAUNCH_CROSS_PROFILE_TARGET = 161;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__RESOLVER_CROSS_PROFILE_TARGET_OPENED =
            155;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__RESOLVER_EMPTY_STATE_NO_APPS_RESOLVED =
            160;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__RESOLVER_EMPTY_STATE_NO_SHARING_TO_PERSONAL = 158;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__RESOLVER_EMPTY_STATE_NO_SHARING_TO_WORK =
            159;
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__RESOLVER_EMPTY_STATE_WORK_APPS_DISABLED =
            157;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__SET_BLUETOOTH_CONTACT_SHARING_DISABLED =
            47;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__SET_CROSS_PROFILE_CALLER_ID_DISABLED =
            46;
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__SET_CROSS_PROFILE_CONTACTS_SEARCH_DISABLED = 45;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__SET_PERMITTED_ACCESSIBILITY_SERVICES =
            28;
    ...
    public static final int
            DEVICE_POLICY_EVENT__EVENT_ID__SET_PREFERENTIAL_NETWORK_SERVICE_ENABLED = 199;
    ...
    public static final int DEVICE_POLICY_EVENT__EVENT_ID__WIFI_SERVICE_ADD_NETWORK_SUGGESTIONS =
            114;
    ...
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_BACKGROUND_NOT_RESTRICTED =
                    11;
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_BATTERY_NOT_LOW = 2;
    public static final int DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_CHARGING = 1;
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_CONNECTIVITY = 7;
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_CONTENT_TRIGGER = 8;
    public static final int DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_DEADLINE = 5;
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_DEVICE_NOT_DOZING = 9;
    public static final int DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_FLEXIBILITY =
            15;
    public static final int DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_IDLE = 6;
    public static final int DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_PREFETCH =
            14;
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_STORAGE_NOT_LOW = 3;
    public static final int DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_TARE_WEALTH =
            13;
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_TIMING_DELAY = 4;
    public static final int DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_UNKNOWN = 0;
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_WITHIN_EXPEDITED_JOB_QUOTA =
                    12;
    public static final int
            DEVICE_WIDE_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_WITHIN_QUOTA = 10;
    ...
    public static final int
            DISPLAY_BRIGHTNESS_CHANGED__ENTIRE_REASON__REASON_SCREEN_OFF_BRIGHTNESS_SENSOR = 9;
    ...
    public static final int DISPLAY_HBM_STATE_CHANGED__REASON__HBM_SV_OFF_LOW_REQUESTED_BRIGHTNESS =
            9;
    ...
    public static final int
            DREAM_SETTING_CHANGED__DREAM_SETTING_TYPE__DREAM_SETTING_TYPE_DREAM_COMPONENT = 2;
    public static final int DREAM_SETTING_CHANGED__DREAM_SETTING_TYPE__DREAM_SETTING_TYPE_ENABLED =
            1;
    public static final int
            DREAM_SETTING_CHANGED__DREAM_SETTING_TYPE__DREAM_SETTING_TYPE_SHOW_ADDITIONAL_INFO = 4;
    public static final int
            DREAM_SETTING_CHANGED__DREAM_SETTING_TYPE__DREAM_SETTING_TYPE_SHOW_HOME_CONTROLS = 5;
    public static final int
            DREAM_SETTING_CHANGED__DREAM_SETTING_TYPE__DREAM_SETTING_TYPE_UNSPECIFIED = 0;
    public static final int
            DREAM_SETTING_CHANGED__DREAM_SETTING_TYPE__DREAM_SETTING_TYPE_WHEN_TO_DREAM = 3;
    public static final int
            DREAM_SETTING_CHANGED__WHEN_TO_DREAM__WHEN_TO_DREAM_EITHER_CHARGING_OR_DOCKED = 3;
    public static final int DREAM_SETTING_CHANGED__WHEN_TO_DREAM__WHEN_TO_DREAM_UNSPECIFIED = 0;
    public static final int
            DREAM_SETTING_CHANGED__WHEN_TO_DREAM__WHEN_TO_DREAM_WHILE_CHARGING_ONLY = 1;
    public static final int DREAM_SETTING_CHANGED__WHEN_TO_DREAM__WHEN_TO_DREAM_WHILE_DOCKED_ONLY =
            2;
    public static final int DREAM_SETTING_SNAPSHOT = 10192;
    public static final int
            DREAM_SETTING_SNAPSHOT__WHEN_TO_DREAM__WHEN_TO_DREAM_EITHER_CHARGING_OR_DOCKED = 3;
    public static final int DREAM_SETTING_SNAPSHOT__WHEN_TO_DREAM__WHEN_TO_DREAM_UNSPECIFIED = 0;
    public static final int
            DREAM_SETTING_SNAPSHOT__WHEN_TO_DREAM__WHEN_TO_DREAM_WHILE_CHARGING_ONLY = 1;
    public static final int DREAM_SETTING_SNAPSHOT__WHEN_TO_DREAM__WHEN_TO_DREAM_WHILE_DOCKED_ONLY =
            2;
    ...
    public static final int
            EXTERNAL_DISPLAY_STATE_CHANGED__STATE__ERROR_CABLE_NOT_CAPABLE_DISPLAYPORT = 13;
    public static final int EXTERNAL_DISPLAY_STATE_CHANGED__STATE__ERROR_DISPLAYPORT_LINK_FAILED =
            12;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_MODE__MODE_FOREGROUND =
            3;
    ...
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACCEPT_HANDOVER = 74;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACCESS_ACCESSIBILITY = 88;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACCESS_MEDIA_LOCATION = 90;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACCESS_NOTIFICATIONS = 25;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACCESS_RESTRICTED_SETTINGS =
                    119;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACTIVATE_PLATFORM_VPN = 94;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACTIVATE_VPN = 47;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACTIVITY_RECOGNITION = 79;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACTIVITY_RECOGNITION_SOURCE =
                    113;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ADD_VOICEMAIL = 52;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ANSWER_PHONE_CALLS = 69;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ARCHIVE_ICON_OVERLAY = 145;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ASSIST_SCREENSHOT = 50;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ASSIST_STRUCTURE = 49;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUDIO_ACCESSIBILITY_VOLUME =
                    64;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUDIO_ALARM_VOLUME = 37;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUDIO_BLUETOOTH_VOLUME =
                    39;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUDIO_MASTER_VOLUME = 33;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUDIO_MEDIA_VOLUME = 36;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUDIO_NOTIFICATION_VOLUME =
                    38;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUDIO_RING_VOLUME = 35;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUDIO_VOICE_VOLUME = 34;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUTO_REVOKE_MANAGED_BY_INSTALLER =
                    98;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_AUTO_REVOKE_PERMISSIONS_IF_UNUSED =
                    97;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_BIND_ACCESSIBILITY_SERVICE =
                    73;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_BLUETOOTH_ADVERTISE = 114;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_BLUETOOTH_CONNECT = 111;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_BLUETOOTH_SCAN = 77;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_BODY_SENSORS = 56;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_BODY_SENSORS_WRIST_TEMPERATURE =
                    132;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_CALL_PHONE = 13;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_CAMERA =
            26;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_CAMERA_SANDBOXED = 134;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_CAPTURE_CONSENTLESS_BUGREPORT_ON_USERDEBUG_BUILD =
                    131;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_CHANGE_WIFI_STATE = 71;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_COARSE_LOCATION = 0;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_COARSE_LOCATION_SOURCE =
                    109;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_CREATE_ACCESSIBILITY_OVERLAY =
                    138;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_DEPRECATED_1 = 96;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_EMERGENCY_LOCATION = 147;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ENABLE_MOBILE_DATA_BY_USER =
                    140;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ESTABLISH_VPN_MANAGER =
                    118;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ESTABLISH_VPN_SERVICE =
                    117;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_FINE_LOCATION = 1;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_FINE_LOCATION_SOURCE = 108;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_FOREGROUND_SERVICE_SPECIAL_USE =
                    127;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_GET_ACCOUNTS = 62;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_GET_USAGE_STATS = 43;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_GPS = 2;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_INSTANT_APP_START_FOREGROUND =
                    68;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_INTERACT_ACROSS_PROFILES =
                    93;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_LEGACY_STORAGE = 87;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_LOADER_USAGE_STATS = 95;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MANAGE_CREDENTIALS = 104;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MANAGE_EXTERNAL_STORAGE =
                    92;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MANAGE_IPSEC_TUNNELS = 75;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MANAGE_MEDIA = 110;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MANAGE_ONGOING_CALLS = 103;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MEDIA_ROUTING_CONTROL =
                    139;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MOCK_LOCATION = 58;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MONITOR_HIGH_POWER_LOCATION =
                    42;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MONITOR_LOCATION = 41;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MUTE_MICROPHONE = 44;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_NEARBY_WIFI_DEVICES = 116;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_NEIGHBORING_CELLS = 12;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_NONE = -1;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_NO_ISOLATED_STORAGE = 99;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_PHONE_CALL_CAMERA = 101;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_PHONE_CALL_MICROPHONE =
                    100;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_PICTURE_IN_PICTURE = 67;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_PLAY_AUDIO = 28;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_POST_NOTIFICATION = 11;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_PROCESS_OUTGOING_CALLS =
                    54;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_PROJECT_MEDIA = 46;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_QUERY_ALL_PACKAGES = 91;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RAPID_CLEAR_NOTIFICATIONS_BY_LISTENER =
                    142;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_CALENDAR = 8;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_CALL_LOG = 6;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_CELL_BROADCASTS = 57;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_CLIPBOARD = 29;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_CONTACTS = 4;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_DEVICE_IDENTIFIERS =
                    89;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_EXTERNAL_STORAGE = 59;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_ICC_SMS = 21;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_MEDIA_AUDIO = 81;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_MEDIA_IMAGES = 85;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_MEDIA_VIDEO = 83;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_MEDIA_VISUAL_USER_SELECTED =
                    123;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_PHONE_NUMBERS = 65;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_PHONE_STATE = 51;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_SMS =
            14;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_SYSTEM_GRAMMATICAL_GENDER =
                    143;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_WRITE_HEALTH_DATA =
                    126;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_AMBIENT_TRIGGER_AUDIO =
                    120;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_EMERGENCY_SMS = 17;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_EXPLICIT_USER_INTERACTION_AUDIO =
                    121;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_MMS = 18;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_SANDBOXED_DETECTION_TRAINING_DATA =
                    137;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_SANDBOX_TRIGGER_AUDIO =
                    136;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_SENSITIVE_NOTIFICATIONS =
                    148;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_SMS = 16;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECEIVE_WAP_PUSH = 19;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECORD_AUDIO = 27;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECORD_AUDIO_HOTWORD = 102;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECORD_AUDIO_OUTPUT = 106;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECORD_AUDIO_SANDBOXED =
                    135;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RECORD_INCOMING_PHONE_AUDIO =
                    115;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_REQUEST_DELETE_PACKAGES =
                    72;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_REQUEST_INSTALL_PACKAGES =
                    66;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RESERVED_FOR_TESTING = 141;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RUN_ANY_IN_BACKGROUND = 70;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RUN_BACKUP_JOBS = 144;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RUN_IN_BACKGROUND = 63;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_RUN_USER_INITIATED_JOBS =
                    122;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SCHEDULE_EXACT_ALARM = 107;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SEND_SMS =
            20;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SMS_FINANCIAL_TRANSACTIONS =
                    80;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_START_FOREGROUND = 76;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SYSTEM_ALERT_WINDOW = 24;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SYSTEM_EXEMPT_FROM_ACTIVITY_BG_START_RESTRICTION =
                    130;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SYSTEM_EXEMPT_FROM_DISMISSIBLE_NOTIFICATIONS =
                    125;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SYSTEM_EXEMPT_FROM_HIBERNATION =
                    129;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SYSTEM_EXEMPT_FROM_POWER_RESTRICTIONS =
                    128;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SYSTEM_EXEMPT_FROM_SUSPENSION =
                    124;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_TAKE_AUDIO_FOCUS = 32;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_TAKE_MEDIA_BUTTONS = 31;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_TOAST_WINDOW = 45;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_TURN_SCREEN_ON = 61;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_UNARCHIVAL_CONFIRMATION =
                    146;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_USE_BIOMETRIC = 78;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_USE_FINGERPRINT = 55;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_USE_FULL_SCREEN_INTENT =
                    133;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER =
                    105;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_USE_SIP =
            53;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_UWB_RANGING = 112;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_VIBRATE =
            3;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WAKE_LOCK =
            40;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WIFI_SCAN =
            10;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_CALENDAR = 9;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_CALL_LOG = 7;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_CLIPBOARD = 30;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_CONTACTS = 5;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_EXTERNAL_STORAGE =
                    60;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_ICC_SMS = 22;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_MEDIA_AUDIO = 82;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_MEDIA_IMAGES = 86;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_MEDIA_VIDEO = 84;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_SETTINGS = 23;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_SMS =
            15;
    public static final int
            FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_WALLPAPER = 48;
    ...
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_CAPABILITIES__PROCESS_CAPABILITY_BFSL =
                    16;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_CAPABILITIES__PROCESS_CAPABILITY_FOREGROUND_CAMERA =
                    2;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_CAPABILITIES__PROCESS_CAPABILITY_FOREGROUND_LOCATION =
                    1;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_CAPABILITIES__PROCESS_CAPABILITY_FOREGROUND_MICROPHONE =
                    4;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_CAPABILITIES__PROCESS_CAPABILITY_NONE = 0;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_CAPABILITIES__PROCESS_CAPABILITY_POWER_RESTRICTED_NETWORK =
                    8;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_CAPABILITIES__PROCESS_CAPABILITY_USER_RESTRICTED_NETWORK =
                    32;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_CACHED_ACTIVITY =
                    1015;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_TOP =
            1002;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
                    998;
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__FGS_START_API__FGSSTARTAPI_DELEGATE =
            4;
    ...
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__FGS_START_API__FGSSTARTAPI_START_FOREGROUND_SERVICE =
                    3;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__FGS_START_API__FGSSTARTAPI_START_SERVICE = 2;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__FGS_TYPE_CHECK_CODE__FGS_TYPE_POLICY_CHECK_DEPRECATED =
                    2;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__FGS_TYPE_CHECK_CODE__FGS_TYPE_POLICY_CHECK_DISABLED =
                    3;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__FGS_TYPE_CHECK_CODE__FGS_TYPE_POLICY_CHECK_OK = 1;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__FGS_TYPE_CHECK_CODE__FGS_TYPE_POLICY_CHECK_PERMISSION_DENIED_ENFORCED =
                    5;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__FGS_TYPE_CHECK_CODE__FGS_TYPE_POLICY_CHECK_PERMISSION_DENIED_PERMISSIVE =
                    4;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__FGS_TYPE_CHECK_CODE__FGS_TYPE_POLICY_CHECK_UNKNOWN =
                    0;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_CAPABILITIES__PROCESS_CAPABILITY_BFSL =
                    16;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_CAPABILITIES__PROCESS_CAPABILITY_FOREGROUND_CAMERA =
                    2;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_CAPABILITIES__PROCESS_CAPABILITY_FOREGROUND_LOCATION =
                    1;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_CAPABILITIES__PROCESS_CAPABILITY_FOREGROUND_MICROPHONE =
                    4;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_CAPABILITIES__PROCESS_CAPABILITY_NONE = 0;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_CAPABILITIES__PROCESS_CAPABILITY_POWER_RESTRICTED_NETWORK =
                    8;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_CAPABILITIES__PROCESS_CAPABILITY_USER_RESTRICTED_NETWORK =
                    32;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_CACHED_ACTIVITY =
                    1015;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_TOP =
            1002;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
                    998;
    ...
    public static final int
            GET_TYPE_ACCESSED_WITHOUT_PERMISSION__LOCATION__AM_CHECK_URI_PERMISSION = 2;
    public static final int GET_TYPE_ACCESSED_WITHOUT_PERMISSION__LOCATION__AM_ERROR = 3;
    public static final int
            GET_TYPE_ACCESSED_WITHOUT_PERMISSION__LOCATION__AM_FRAMEWORK_PERMISSION = 1;
    public static final int
            GET_TYPE_ACCESSED_WITHOUT_PERMISSION__LOCATION__PROVIDER_CHECK_URI_PERMISSION = 5;
    public static final int GET_TYPE_ACCESSED_WITHOUT_PERMISSION__LOCATION__PROVIDER_ERROR = 6;
    public static final int
            GET_TYPE_ACCESSED_WITHOUT_PERMISSION__LOCATION__PROVIDER_FRAMEWORK_PERMISSION = 4;
    ...
    public static final int GNSS_CONFIGURATION_REPORTED__A_GLONASS_POS_PROTOCOL_SELECT__LPP_UPLANE =
            4;
    public static final int GNSS_CONFIGURATION_REPORTED__A_GLONASS_POS_PROTOCOL_SELECT__RRC_CPLANE =
            1;
    public static final int
            GNSS_CONFIGURATION_REPORTED__A_GLONASS_POS_PROTOCOL_SELECT__RRLP_CPLANE = 2;
    ...
    public static final int GNSS_NFW_NOTIFICATION_REPORTED__PROTOCOL_STACK__OTHER_PROTOCOL_STACK =
            100;
    ...
    public static final int
            GNSS_NFW_NOTIFICATION_REPORTED__RESPONSE_TYPE__ACCEPTED_LOCATION_PROVIDED = 2;
    public static final int
            GNSS_NFW_NOTIFICATION_REPORTED__RESPONSE_TYPE__ACCEPTED_NO_LOCATION_PROVIDED = 1;
    ...
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__AUDIO_SYSTEM = 5;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__LOGICAL_ADDRESS_UNKNOWN =
                    -1;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__PLAYBACK_DEVICE_1 = 4;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__PLAYBACK_DEVICE_2 = 8;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__PLAYBACK_DEVICE_3 = 11;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__RECORDING_DEVICE_1 = 1;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__RECORDING_DEVICE_2 = 2;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__RECORDING_DEVICE_3 = 9;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__RESERVED_1 = 12;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__RESERVED_2 = 13;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__SPECIFIC_USE = 14;
    public static final int HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__TUNER_1 =
            3;
    public static final int HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__TUNER_2 =
            6;
    ...
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__ACTIVE_SOURCE_LOGICAL_ADDRESS__UNREGISTERED_OR_BROADCAST =
                    15;
    ...
    public static final int HDMI_CEC_ACTIVE_SOURCE_CHANGED__LOCAL_RELATIONSHIP__DIFFERENT_BRANCH =
            1;
    public static final int
            HDMI_CEC_ACTIVE_SOURCE_CHANGED__LOCAL_RELATIONSHIP__RELATIONSHIP_TO_ACTIVE_SOURCE_UNKNOWN =
                    0;
    ...
    public static final int HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__AUDIO_SYSTEM =
            5;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__LOGICAL_ADDRESS_UNKNOWN = -1;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__PLAYBACK_DEVICE_1 = 4;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__PLAYBACK_DEVICE_2 = 8;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__PLAYBACK_DEVICE_3 = 11;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__RECORDING_DEVICE_1 = 1;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__RECORDING_DEVICE_2 = 2;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__RECORDING_DEVICE_3 = 9;
    ...
    public static final int HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__SPECIFIC_USE =
            14;
    ...
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__DESTINATION_LOGICAL_ADDRESS__UNREGISTERED_OR_BROADCAST = 15;
    ...
    public static final int HDMI_CEC_MESSAGE_REPORTED__FEATURE_ABORT_REASON__CANNOT_PROVIDE_SOURCE =
            12;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__FEATURE_ABORT_REASON__FEATURE_ABORT_REASON_UNKNOWN = 0;
    public static final int HDMI_CEC_MESSAGE_REPORTED__FEATURE_ABORT_REASON__INVALID_OPERAND = 13;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__FEATURE_ABORT_REASON__NOT_IN_CORRECT_MODE_TO_RESPOND = 11;
    public static final int HDMI_CEC_MESSAGE_REPORTED__FEATURE_ABORT_REASON__REFUSED = 14;
    public static final int HDMI_CEC_MESSAGE_REPORTED__FEATURE_ABORT_REASON__UNABLE_TO_DETERMINE =
            15;
    ...
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__INITIATOR_LOGICAL_ADDRESS__LOGICAL_ADDRESS_UNKNOWN = -1;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__INITIATOR_LOGICAL_ADDRESS__PLAYBACK_DEVICE_1 = 4;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__INITIATOR_LOGICAL_ADDRESS__PLAYBACK_DEVICE_2 = 8;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__INITIATOR_LOGICAL_ADDRESS__PLAYBACK_DEVICE_3 = 11;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__INITIATOR_LOGICAL_ADDRESS__RECORDING_DEVICE_1 = 1;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__INITIATOR_LOGICAL_ADDRESS__RECORDING_DEVICE_2 = 2;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__INITIATOR_LOGICAL_ADDRESS__RECORDING_DEVICE_3 = 9;
    ...
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__INITIATOR_LOGICAL_ADDRESS__UNREGISTERED_OR_BROADCAST = 15;
    ...
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__SEND_MESSAGE_RESULT__SEND_MESSAGE_RESULT_UNKNOWN = 0;
    ...
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__INPUT_SELECT =
            308;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__LEFT = 259;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__LEFT_DOWN =
            264;
    ...
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__POWER_OFF =
            364;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__POWER_ON = 365;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__POWER_TOGGLE =
            363;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__RIGHT = 260;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__RIGHT_DOWN =
            262;
    ...
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__USER_CONTROL_PRESSED_COMMAND_OTHER =
                    1;
    public static final int
            HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__USER_CONTROL_PRESSED_COMMAND_UNKNOWN =
                    0;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__VOLUME_DOWN =
            322;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__VOLUME_MUTE =
            323;
    public static final int HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__VOLUME_UP =
            321;
    public static final int HDMI_EARC_STATUS_REPORTED = 701;
    public static final int HDMI_EARC_STATUS_REPORTED__LOG_REASON__LOG_REASON_EARC_STATUS_CHANGED =
            2;
    public static final int
            HDMI_EARC_STATUS_REPORTED__LOG_REASON__LOG_REASON_EARC_STATUS_CHANGED_UNSUPPORTED_PORT =
                    3;
    public static final int
            HDMI_EARC_STATUS_REPORTED__LOG_REASON__LOG_REASON_EARC_STATUS_CHANGED_WRONG_STATE = 4;
    ...
    public static final int
            HDMI_EARC_STATUS_REPORTED__NEW_CONNECTED_STATE__HDMI_EARC_STATUS_ARC_PENDING = 3;
    public static final int
            HDMI_EARC_STATUS_REPORTED__NEW_CONNECTED_STATE__HDMI_EARC_STATUS_EARC_CONNECTED = 4;
    public static final int
            HDMI_EARC_STATUS_REPORTED__NEW_CONNECTED_STATE__HDMI_EARC_STATUS_EARC_PENDING = 2;
    public static final int HDMI_EARC_STATUS_REPORTED__NEW_CONNECTED_STATE__HDMI_EARC_STATUS_IDLE =
            1;
    public static final int
            HDMI_EARC_STATUS_REPORTED__NEW_CONNECTED_STATE__HDMI_EARC_STATUS_UNKNOWN = 0;
    public static final int
            HDMI_EARC_STATUS_REPORTED__OLD_CONNECTED_STATE__HDMI_EARC_STATUS_ARC_PENDING = 3;
    public static final int
            HDMI_EARC_STATUS_REPORTED__OLD_CONNECTED_STATE__HDMI_EARC_STATUS_EARC_CONNECTED = 4;
    public static final int
            HDMI_EARC_STATUS_REPORTED__OLD_CONNECTED_STATE__HDMI_EARC_STATUS_EARC_PENDING = 2;
    public static final int HDMI_EARC_STATUS_REPORTED__OLD_CONNECTED_STATE__HDMI_EARC_STATUS_IDLE =
            1;
    public static final int
            HDMI_EARC_STATUS_REPORTED__OLD_CONNECTED_STATE__HDMI_EARC_STATUS_UNKNOWN = 0;
    public static final int HDMI_SOUNDBAR_MODE_STATUS_REPORTED = 724;
    public static final int
            HDMI_SOUNDBAR_MODE_STATUS_REPORTED__LOG_REASON__LOG_REASON_DSM_SETTING_TOGGLED = 2;
    ...
    public static final int
            HEARING_AID_INFO_REPORTED__BOND_ENTRY__ACCESSIBILITY_HEARING_AID_PAIR_ANOTHER = 2;
    public static final int
            HEARING_AID_INFO_REPORTED__BOND_ENTRY__ACCESSIBILITY_HEARING_AID_SETTINGS = 4;
    ...
    public static final int
            HOTWORD_AUDIO_EGRESS_EVENT_REPORTED__DETECTOR_TYPE__TRUSTED_DETECTOR_DSP = 1;
    public static final int
            HOTWORD_AUDIO_EGRESS_EVENT_REPORTED__DETECTOR_TYPE__TRUSTED_DETECTOR_SOFTWARE = 2;
    public static final int HOTWORD_AUDIO_EGRESS_EVENT_REPORTED__EVENT__CLOSE_ERROR_FROM_CLIENT =
            11;
    public static final int
            HOTWORD_AUDIO_EGRESS_EVENT_REPORTED__EVENT__CLOSE_ERROR_FROM_HOTWORD_DETECTION_SERVICE =
                    12;
    ...
    public static final int
            HOTWORD_AUDIO_EGRESS_EVENT_REPORTED__EVENT__INACTIVE_HOTWORD_DETECTION_SERVICE = 6;
    ...
    public static final int
            HOTWORD_DETECTION_SERVICE_INIT_RESULT_REPORTED__DETECTOR_TYPE__NORMAL_DETECTOR = 0;
    public static final int
            HOTWORD_DETECTION_SERVICE_INIT_RESULT_REPORTED__DETECTOR_TYPE__TRUSTED_DETECTOR_DSP = 1;
    public static final int
            HOTWORD_DETECTION_SERVICE_INIT_RESULT_REPORTED__DETECTOR_TYPE__TRUSTED_DETECTOR_SOFTWARE =
                    2;
    public static final int
            HOTWORD_DETECTION_SERVICE_INIT_RESULT_REPORTED__RESULT__CALLBACK_INIT_STATE_ERROR = 1;
    public static final int
            HOTWORD_DETECTION_SERVICE_INIT_RESULT_REPORTED__RESULT__CALLBACK_INIT_STATE_SUCCESS = 0;
    public static final int
    ...
    public static final int
            HOTWORD_DETECTION_SERVICE_RESTARTED__DETECTOR_TYPE__TRUSTED_DETECTOR_DSP = 1;
    public static final int
            HOTWORD_DETECTION_SERVICE_RESTARTED__DETECTOR_TYPE__TRUSTED_DETECTOR_SOFTWARE = 2;
    ...
    public static final int HOTWORD_DETECTOR_CREATE_REQUESTED__DETECTOR_TYPE__TRUSTED_DETECTOR_DSP =
            1;
    public static final int
            HOTWORD_DETECTOR_CREATE_REQUESTED__DETECTOR_TYPE__TRUSTED_DETECTOR_SOFTWARE = 2;
    ...
    public static final int HOTWORD_DETECTOR_EVENTS__EVENT__AUDIO_EGRESS_CLOSE_ERROR_FROM_CLIENT =
            30;
    public static final int
            HOTWORD_DETECTOR_EVENTS__EVENT__AUDIO_EGRESS_CLOSE_ERROR_FROM_HOTWORD_DETECTION_SERVICE =
                    31;
    public static final int HOTWORD_DETECTOR_EVENTS__EVENT__AUDIO_EGRESS_CLOSE_ERROR_FROM_SYSTEM =
            29;
    ...
    public static final int HOTWORD_DETECTOR_EVENTS__EVENT__AUDIO_EGRESS_ILLEGAL_COPY_BUFFER_SIZE =
            28;
    public static final int HOTWORD_DETECTOR_EVENTS__EVENT__AUDIO_EGRESS_INACTIVE_CLIENT = 24;
    public static final int
            HOTWORD_DETECTOR_EVENTS__EVENT__AUDIO_EGRESS_INACTIVE_HOTWORD_DETECTION_SERVICE = 25;
    ...
    public static final int
            HOTWORD_DETECTOR_EVENTS__EVENT__CALLBACK_ON_PROCESS_RESTARTED_EXCEPTION = 18;
    public static final int HOTWORD_DETECTOR_EVENTS__EVENT__CALLBACK_ON_REJECTED_EXCEPTION = 16;
    public static final int HOTWORD_DETECTOR_EVENTS__EVENT__CALLBACK_ON_STATUS_REPORTED_EXCEPTION =
            14;
    ...
    public static final int
            HOTWORD_DETECTOR_EVENTS__EVENT__EXTERNAL_SOURCE_DETECT_SECURITY_EXCEPTION = 13;
    ...
    public static final int HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__DETECTOR_TYPE__NORMAL_DETECTOR =
            0;
    public static final int
            HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__DETECTOR_TYPE__TRUSTED_DETECTOR_DSP = 1;
    public static final int
            HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__DETECTOR_TYPE__TRUSTED_DETECTOR_SOFTWARE = 2;
    ...
    public static final int
            HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__DETECT_SECURITY_EXCEPTION = 8;
    public static final int HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__DETECT_TIMEOUT = 2;
    public static final int
            HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__DETECT_UNEXPECTED_CALLBACK = 7;
    public static final int HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__FAILED_TO_INFORM_SERVICE =
            1;
    ...
    public static final int HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__REJECTED_FROM_RESTART =
            10;
    public static final int
            HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__REJECT_UNEXPECTED_CALLBACK = 9;
    ...
    public static final int
            HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__TRAINING_DATA_EGRESS_LIMIT_REACHED = 12;
    public static final int
            HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__TRAINING_DATA_REMOTE_EXCEPTION = 14;
    public static final int
            HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED__RESULT__TRAINING_DATA_SECURITY_EXCEPTION = 13;
    ...
    public static final int
            IME_REQUEST_FINISHED__PHASE__PHASE_CLIENT_INSETS_CONSUMER_NOTIFY_HIDDEN = 38;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_CLIENT_INSETS_CONSUMER_REQUEST_SHOW =
            36;
    ...
    public static final int
            IME_REQUEST_FINISHED__PHASE__PHASE_IME_APPLY_VISIBILITY_INSETS_CONSUMER = 16;
    ...
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_WM_HAS_IME_INSETS_CONTROL_TARGET =
            20;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_WM_REMOTE_INSETS_CONTROLLER = 25;
    public static final int
            IME_REQUEST_FINISHED__PHASE__PHASE_WM_REMOTE_INSETS_CONTROL_TARGET_HIDE_INSETS = 24;
    public static final int
            IME_REQUEST_FINISHED__PHASE__PHASE_WM_REMOTE_INSETS_CONTROL_TARGET_SHOW_INSETS = 23;
    ...
    public static final int
            IME_REQUEST_FINISHED__PHASE__PHASE_WM_WINDOW_INSETS_CONTROL_TARGET_HIDE_INSETS = 22;
    public static final int
            IME_REQUEST_FINISHED__PHASE__PHASE_WM_WINDOW_INSETS_CONTROL_TARGET_SHOW_INSETS = 21;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_CONTROL_WINDOW_INSETS_ANIMATION =
            55;
    ...
    public static final int
            IME_REQUEST_FINISHED__REASON__REASON_HIDE_SAME_WINDOW_FOCUSED_WITHOUT_EDITOR = 21;
    public static final int
            IME_REQUEST_FINISHED__REASON__REASON_HIDE_SCREEN_OFF_SECURE_LOCK_SCREEN_STATE = 59;
    ...
    public static final int
            IME_REQUEST_FINISHED__REASON__REASON_HIDE_SOFT_INPUT_EXTRACT_INPUT_CHANGED = 31;
    ...
    public static final int
            IME_REQUEST_FINISHED__REASON__REASON_HIDE_SOFT_INPUT_IME_TOGGLE_SOFT_INPUT = 30;
    public static final int IME_REQUEST_FINISHED__REASON__REASON_HIDE_SOFT_INPUT_IMM_DEPRECATION =
            32;
    public static final int IME_REQUEST_FINISHED__REASON__REASON_HIDE_SOFT_INPUT_LEGACY_DIRECT = 41;
    public static final int
            IME_REQUEST_FINISHED__REASON__REASON_HIDE_SOFT_INPUT_ON_ANIMATION_STATE_CHANGED = 51;
    public static final int
            IME_REQUEST_FINISHED__REASON__REASON_HIDE_SOFT_INPUT_REQUEST_HIDE_WITH_CONTROL = 52;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_HIDE_WHEN_INPUT_TARGET_INVISIBLE =
            37;
    public static final int
            IME_REQUEST_FINISHED__REASON__REASON_HIDE_WINDOW_GAINED_FOCUS_WITHOUT_EDITOR = 33;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_REMOVE_IME_SCREENSHOT_FROM_IMMS =
            35;
    ...
    public static final int
            IME_REQUEST_FINISHED__REASON__REASON_SHOW_SOFT_INPUT_IME_TOGGLE_SOFT_INPUT = 53;
    public static final int IME_REQUEST_FINISHED__REASON__REASON_SHOW_SOFT_INPUT_IMM_DEPRECATION =
            54;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_UPDATE_CANDIDATES_VIEW_VISIBILITY =
            45;
    ...
    public static final int
            KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_BOUND_TOP =
            1020;
    public static final int
            KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int
            KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    ...
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_CACHED_RECENT =
            1017;
    public static final int
            KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    ...
    public static final int
            KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int
            KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_LAST_ACTIVITY =
            1014;
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_NONEXISTENT =
            1019;
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_PERSISTENT =
            1000;
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_PERSISTENT_UI =
            1001;
    ...
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_TOP_SLEEPING =
            1011;
    public static final int
            KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    ...
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__ACCESSIBILITY_ALL_APPS = 23;
    ...
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__BRIGHTNESS_DOWN = 13;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__BRIGHTNESS_UP =
            12;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__CHANGE_SPLITSCREEN_FOCUS = 50;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__DESKTOP_MODE =
            48;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__HOME = 1;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__KEYBOARD_BACKLIGHT_DOWN = 15;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__KEYBOARD_BACKLIGHT_TOGGLE = 16;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__KEYBOARD_BACKLIGHT_UP = 14;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LANGUAGE_SWITCH = 22;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_APPLICATION_BY_PACKAGE_NAME =
                    47;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_ASSISTANT = 5;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_BROWSER = 35;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_CALCULATOR = 39;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_CALENDAR = 38;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_CONTACTS = 37;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_EMAIL = 36;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_FILES = 44;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_FITNESS = 46;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_GALLERY = 43;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_MAPS = 41;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_MESSAGING = 42;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_MUSIC = 40;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_DEFAULT_WEATHER = 45;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_SEARCH =
            21;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_SYSTEM_SETTINGS = 7;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__LAUNCH_VOICE_ASSISTANT = 6;
    ...
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__MULTI_WINDOW_NAVIGATION = 49;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__OPEN_NOTES = 29;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__OPEN_SHORTCUT_HELPER = 11;
    ...
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__SPLIT_SCREEN_NAVIGATION = 26;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__SYSTEM_MUTE =
            25;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__SYSTEM_NAVIGATION = 31;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__TAKE_SCREENSHOT = 10;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__TOGGLE_CAPS_LOCK = 24;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__TOGGLE_NOTIFICATION_PANEL = 8;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__TOGGLE_POWER =
            30;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__TOGGLE_TASKBAR =
            9;
    public static final int
            KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__TRIGGER_BUG_REPORT = 27;
    ...
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__VOLUME_DOWN =
            18;
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__VOLUME_MUTE =
            19;
    ...
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_AUTH_INFO__SECURITY_LEVEL__SECURITY_LEVEL_KEYSTORE = 4;
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_AUTH_INFO__SECURITY_LEVEL__SECURITY_LEVEL_SOFTWARE = 1;
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_AUTH_INFO__SECURITY_LEVEL__SECURITY_LEVEL_STRONGBOX = 3;
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_AUTH_INFO__SECURITY_LEVEL__SECURITY_LEVEL_TRUSTED_ENVIRONMENT =
                    2;
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_AUTH_INFO__SECURITY_LEVEL__SECURITY_LEVEL_UNSPECIFIED = 0;
    public static final int KEYSTORE2_KEY_CREATION_WITH_AUTH_INFO__USER_AUTH_TYPE__ANY = 5;
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_AUTH_INFO__USER_AUTH_TYPE__AUTH_TYPE_UNSPECIFIED = 0;
    ...
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_UNSPECIFIED = 0;
    ...
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__EC_CURVE__EC_CURVE_UNSPECIFIED = 0;
    ...
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__KEY_ORIGIN__ORIGIN_UNSPECIFIED = 0;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__KEY_ORIGIN__RESERVED = 4;
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__KEY_ORIGIN__SECURELY_IMPORTED = 5;
    ...
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_UNSPECIFIED =
                    0;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__EC = 3;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__HMAC =
            128;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__RSA = 1;
    public static final int
            KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__TRIPLE_DES = 33;
    ...
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_GENERAL_INFO__OUTCOME__OUTCOME_UNSPECIFIED = 0;
    ...
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_GENERAL_INFO__SECURITY_LEVEL__SECURITY_LEVEL_KEYSTORE = 4;
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_GENERAL_INFO__SECURITY_LEVEL__SECURITY_LEVEL_SOFTWARE = 1;
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_GENERAL_INFO__SECURITY_LEVEL__SECURITY_LEVEL_STRONGBOX = 3;
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_GENERAL_INFO__SECURITY_LEVEL__SECURITY_LEVEL_TRUSTED_ENVIRONMENT =
                    2;
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_GENERAL_INFO__SECURITY_LEVEL__SECURITY_LEVEL_UNSPECIFIED =
                    0;
    public static final int KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO = 10122;
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO__PURPOSE__AGREE_KEY = 7;
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO__PURPOSE__ATTEST_KEY = 8;
    public static final int KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO__PURPOSE__DECRYPT =
            2;
    public static final int KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO__PURPOSE__ENCRYPT =
            1;
    public static final int
            KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO__PURPOSE__KEY_PURPOSE_UNSPECIFIED =
                    0;
    public static final int KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO__PURPOSE__SIGN = 3;
    public static final int KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO__PURPOSE__VERIFY =
            4;
    public static final int KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO__PURPOSE__WRAP_KEY =
            6;
    ...
    public static final int
            KEYSTORE2_STORAGE_STATS__STORAGE_TYPE__BLOB_METADATA_BLOB_ENTRY_ID_INDEX = 13;
    ...
    public static final int
            KEYSTORE2_STORAGE_STATS__STORAGE_TYPE__KEY_ENTRY_DOMAIN_NAMESPACE_INDEX = 3;
    ...
    public static final int KEYSTORE2_STORAGE_STATS__STORAGE_TYPE__KEY_METADATA_KEY_ENTRY_ID_INDEX =
            9;
    public static final int KEYSTORE2_STORAGE_STATS__STORAGE_TYPE__KEY_PARAMETER = 6;
    public static final int
            KEYSTORE2_STORAGE_STATS__STORAGE_TYPE__KEY_PARAMETER_KEY_ENTRY_ID_INDEX = 7;
    ...
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__ACTIVIY_IMPORTANCE__IMPORTANCE_BACKGROUND = 3;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__ACTIVIY_IMPORTANCE__IMPORTANCE_FORGROUND_SERVICE =
                    2;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__ACTIVIY_IMPORTANCE__IMPORTANCE_TOP = 1;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__ACTIVIY_IMPORTANCE__IMPORTANCE_UNKNOWN = 0;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__API_IN_USE__API_ADD_GNSS_MEASUREMENTS_LISTENER = 2;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__API_IN_USE__API_REGISTER_GNSS_STATUS_CALLBACK = 3;
    public static final int LOCATION_MANAGER_API_USAGE_REPORTED__API_IN_USE__API_REQUEST_GEOFENCE =
            4;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__API_IN_USE__API_REQUEST_LOCATION_UPDATES = 1;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__API_IN_USE__API_SEND_EXTRA_COMMAND = 5;
    public static final int LOCATION_MANAGER_API_USAGE_REPORTED__API_IN_USE__API_UNKNOWN = 0;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_EXPIRE_IN__EXPIRATION_BETWEEN_0_AND_20_SEC =
                    1;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_EXPIRE_IN__EXPIRATION_BETWEEN_10_MIN_AND_1_HOUR =
                    4;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_EXPIRE_IN__EXPIRATION_BETWEEN_1_MIN_AND_10_MIN =
                    3;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_EXPIRE_IN__EXPIRATION_BETWEEN_20_SEC_AND_1_MIN =
                    2;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_EXPIRE_IN__EXPIRATION_LARGER_THAN_1_HOUR =
                    5;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_EXPIRE_IN__EXPIRATION_NO_EXPIRY = 6;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_EXPIRE_IN__EXPIRATION_UNKNOWN = 0;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_INTERVAL__INTERVAL_BETWEEN_0_SEC_AND_1_SEC =
                    1;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_INTERVAL__INTERVAL_BETWEEN_10_MIN_AND_1_HOUR =
                    5;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_INTERVAL__INTERVAL_BETWEEN_1_MIN_AND_10_MIN =
                    4;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_INTERVAL__INTERVAL_BETWEEN_1_SEC_AND_5_SEC =
                    2;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_INTERVAL__INTERVAL_BETWEEN_5_SEC_AND_1_MIN =
                    3;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_INTERVAL__INTERVAL_LARGER_THAN_1_HOUR =
                    6;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_INTERVAL__INTERVAL_UNKNOWN = 0;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_RADIUS__RADIUS_BETWEEN_0_AND_100 = 1;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_RADIUS__RADIUS_BETWEEN_1000_AND_10000 =
                    5;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_RADIUS__RADIUS_BETWEEN_100_AND_200 = 2;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_RADIUS__RADIUS_BETWEEN_200_AND_300 = 3;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_RADIUS__RADIUS_BETWEEN_300_AND_1000 = 4;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_RADIUS__RADIUS_LARGER_THAN_100000 = 6;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_RADIUS__RADIUS_NEGATIVE = 7;
    public static final int LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_RADIUS__RADIUS_UNKNOWN =
            0;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_SMALLEST_DISPLACEMENT__DISTANCE_BETWEEN_0_AND_100 =
                    2;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_SMALLEST_DISPLACEMENT__DISTANCE_LARGER_THAN_100 =
                    3;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_SMALLEST_DISPLACEMENT__DISTANCE_UNKNOWN =
                    0;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__BUCKETIZED_SMALLEST_DISPLACEMENT__DISTANCE_ZERO =
                    1;
    public static final int LOCATION_MANAGER_API_USAGE_REPORTED__CALLBACK_TYPE__CALLBACK_LISTENER =
            2;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__CALLBACK_TYPE__CALLBACK_NOT_APPLICABLE = 1;
    public static final int
            LOCATION_MANAGER_API_USAGE_REPORTED__CALLBACK_TYPE__CALLBACK_PENDING_INTENT = 3;
    public static final int LOCATION_MANAGER_API_USAGE_REPORTED__CALLBACK_TYPE__CALLBACK_UNKNOWN =
            0;
    ...
    public static final int LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED__STATE__CERTAIN =
            4;
    public static final int LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED__STATE__DESTROYED =
            6;
    public static final int LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED__STATE__FAILED = 7;
    public static final int
            LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED__STATE__INITIALIZING = 3;
    public static final int
            LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED__STATE__PROVIDERS_INITIALIZING = 1;
    public static final int LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED__STATE__STOPPED =
            2;
    public static final int LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED__STATE__UNCERTAIN =
            5;
    public static final int LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED__STATE__UNKNOWN =
            0;
    ...
    public static final int
            MAGNIFICATION_MODE_WITH_IME_ON_REPORTED__ACTIVATED_MODE__MAGNIFICATION_ALL = 3;
    public static final int
            MAGNIFICATION_MODE_WITH_IME_ON_REPORTED__ACTIVATED_MODE__MAGNIFICATION_FULL_SCREEN = 1;
    public static final int
            MAGNIFICATION_MODE_WITH_IME_ON_REPORTED__ACTIVATED_MODE__MAGNIFICATION_UNKNOWN_MODE = 0;
    public static final int
            MAGNIFICATION_MODE_WITH_IME_ON_REPORTED__ACTIVATED_MODE__MAGNIFICATION_WINDOW = 2;
    ...
    public static final int
            MAGNIFICATION_USAGE_REPORTED__ACTIVATED_MODE__MAGNIFICATION_FULL_SCREEN = 1;
    public static final int
            MAGNIFICATION_USAGE_REPORTED__ACTIVATED_MODE__MAGNIFICATION_UNKNOWN_MODE = 0;
    ...
    public static final int
            MEDIA_CAPABILITIES__MATCH_CONTENT_REFRESH_RATE_PREFERENCE__MATCH_CONTENT_FRAMERATE_ALWAYS =
                    3;
    public static final int
            MEDIA_CAPABILITIES__MATCH_CONTENT_REFRESH_RATE_PREFERENCE__MATCH_CONTENT_FRAMERATE_NEVER =
                    1;
    public static final int
            MEDIA_CAPABILITIES__MATCH_CONTENT_REFRESH_RATE_PREFERENCE__MATCH_CONTENT_FRAMERATE_SEAMLESSS_ONLY =
                    2;
    public static final int
            MEDIA_CAPABILITIES__MATCH_CONTENT_REFRESH_RATE_PREFERENCE__MATCH_CONTENT_FRAMERATE_UNKNOWN =
                    0;
    public static final int
            MEDIA_CAPABILITIES__SURROUND_OUTPUT_MODE__ENCODED_SURROUND_OUTPUT_ALWAYS = 3;
    public static final int MEDIA_CAPABILITIES__SURROUND_OUTPUT_MODE__ENCODED_SURROUND_OUTPUT_AUTO =
            1;
    public static final int
            MEDIA_CAPABILITIES__SURROUND_OUTPUT_MODE__ENCODED_SURROUND_OUTPUT_MANUAL = 4;
    public static final int
            MEDIA_CAPABILITIES__SURROUND_OUTPUT_MODE__ENCODED_SURROUND_OUTPUT_NEVER = 2;
    public static final int
            MEDIA_CAPABILITIES__SURROUND_OUTPUT_MODE__ENCODED_SURROUND_OUTPUT_UNKNOWN = 0;
    public static final int MEDIA_CODEC_RECLAIM_REQUEST_COMPLETED = 600;
    public static final int
            MEDIA_CODEC_RECLAIM_REQUEST_COMPLETED__RECLAIM_STATUS__RECLAIM_FAILED_NO_CLIENTS = 2;
    public static final int
            MEDIA_CODEC_RECLAIM_REQUEST_COMPLETED__RECLAIM_STATUS__RECLAIM_FAILED_RECLAIM_RESOURCES =
                    3;
    public static final int
            MEDIA_CODEC_RECLAIM_REQUEST_COMPLETED__RECLAIM_STATUS__RECLAIM_STATUS_UNSPECIFIED = 0;
    public static final int MEDIA_CODEC_RECLAIM_REQUEST_COMPLETED__RECLAIM_STATUS__RECLAIM_SUCCESS =
            1;
    ...
    public static final int MEDIA_CODEC_RENDERED__RESOLUTION__RESOLUTION_MAX_SIZE =
            Integer.MAX_VALUE;
    ...
    public static final int MEDIA_PROJECTION_STATE_CHANGED__CREATION_SOURCE__CREATION_SOURCE_APP =
            1;
    public static final int MEDIA_PROJECTION_STATE_CHANGED__CREATION_SOURCE__CREATION_SOURCE_CAST =
            3;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__CREATION_SOURCE__CREATION_SOURCE_SYSTEM_UI_SCREEN_RECORDER =
                    2;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__CREATION_SOURCE__CREATION_SOURCE_UNKNOWN = 0;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_APP_SELECTOR_DISPLAYED =
                    3;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_CANCELLED = 8;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_CAPTURING_IN_PROGRESS =
                    4;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_CAPTURING_IN_PROGRESS_RESUMED =
                    6;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_CAPTURING_PAUSED =
                    5;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_INITIATED = 1;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_PERMISSION_REQUEST_DISPLAYED =
                    2;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_STOPPED = 7;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_UNKNOWN = 0;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_APP_SELECTOR_DISPLAYED =
                    3;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_CANCELLED = 8;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_CAPTURING_IN_PROGRESS = 4;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_CAPTURING_IN_PROGRESS_RESUMED =
                    6;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_CAPTURING_PAUSED = 5;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_INITIATED = 1;
    public static final int
            MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_PERMISSION_REQUEST_DISPLAYED =
                    2;
    public static final int MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_STOPPED =
            7;
    ...
    public static final int
            MEDIA_PROJECTION_TARGET_CHANGED__TARGET_WINDOWING_MODE__WINDOWING_MODE_FREEFORM = 4;
    public static final int
            MEDIA_PROJECTION_TARGET_CHANGED__TARGET_WINDOWING_MODE__WINDOWING_MODE_FULLSCREEN = 2;
    public static final int
            MEDIA_PROJECTION_TARGET_CHANGED__TARGET_WINDOWING_MODE__WINDOWING_MODE_HIDDEN = 1;
    public static final int
            MEDIA_PROJECTION_TARGET_CHANGED__TARGET_WINDOWING_MODE__WINDOWING_MODE_SPLIT_SCREEN = 3;
    public static final int
            MEDIA_PROJECTION_TARGET_CHANGED__TARGET_WINDOWING_MODE__WINDOWING_MODE_UNKNOWN = 0;
    ...
    public static final int
            MOBILE_BUNDLED_APP_INFO_GATHERED__ALGO_TYPE__DIGEST_ALGORITHM_CHUNKED_SHA256 = 1;
    public static final int
            MOBILE_BUNDLED_APP_INFO_GATHERED__ALGO_TYPE__DIGEST_ALGORITHM_CHUNKED_SHA512 = 2;
    public static final int MOBILE_BUNDLED_APP_INFO_GATHERED__ALGO_TYPE__DIGEST_ALGORITHM_SHA256 =
            4;
    public static final int MOBILE_BUNDLED_APP_INFO_GATHERED__ALGO_TYPE__DIGEST_ALGORITHM_UNKNOWN =
            0;
    public static final int
            MOBILE_BUNDLED_APP_INFO_GATHERED__ALGO_TYPE__DIGEST_ALGORITHM_VERITY_CHUNKED_SHA256 = 3;
    ...
    public static final int MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_BACKUP =
            1008;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_HOME =
            1013;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_SERVICE =
            1009;
    public static final int MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_TOP =
            1002;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_UNKNOWN =
            999;
    public static final int
            MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int MOBILE_RADIO_POWER_STATE_CHANGED = 12;
    public static final int
            MOBILE_RADIO_POWER_STATE_CHANGED__STATE__DATA_CONNECTION_POWER_STATE_HIGH = 3;
    public static final int
            MOBILE_RADIO_POWER_STATE_CHANGED__STATE__DATA_CONNECTION_POWER_STATE_LOW = 1;
    public static final int
            MOBILE_RADIO_POWER_STATE_CHANGED__STATE__DATA_CONNECTION_POWER_STATE_MEDIUM = 2;
    public static final int
    ...
    public static final int
            NON_A11Y_TOOL_SERVICE_WARNING_REPORTED__STATUS__WARNING_SERVICE_DISABLED = 3;
    ...
    public static final int
            NOTIFICATION_CHANNEL_MODIFIED__IMPORTANCE__IMPORTANCE_IMPORTANT_CONVERSATION = 5;
    ...
    public static final int NOTIFICATION_CHANNEL_MODIFIED__IMPORTANCE__IMPORTANCE_UNSPECIFIED =
            -1000;
    ...
    public static final int
            NOTIFICATION_CHANNEL_MODIFIED__OLD_IMPORTANCE__IMPORTANCE_IMPORTANT_CONVERSATION = 5;
    ...
    public static final int NOTIFICATION_CHANNEL_MODIFIED__OLD_IMPORTANCE__IMPORTANCE_UNSPECIFIED =
            -1000;
    ...
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_ASST__IMPORTANCE_IMPORTANT_CONVERSATION = 5;
    ...
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_INITIAL_SOURCE__IMPORTANCE_EXPLANATION_APP = 1;
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_INITIAL_SOURCE__IMPORTANCE_EXPLANATION_APP_PRE_CHANNELS =
                    5;
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_INITIAL_SOURCE__IMPORTANCE_EXPLANATION_ASST = 3;
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_INITIAL_SOURCE__IMPORTANCE_EXPLANATION_SYSTEM = 4;
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_INITIAL_SOURCE__IMPORTANCE_EXPLANATION_UNKNOWN = 0;
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_INITIAL_SOURCE__IMPORTANCE_EXPLANATION_USER = 2;
    ...
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_INITIAL__IMPORTANCE_IMPORTANT_CONVERSATION = 5;
    ...
    public static final int NOTIFICATION_REPORTED__IMPORTANCE_INITIAL__IMPORTANCE_UNSPECIFIED =
            -1000;
    public static final int NOTIFICATION_REPORTED__IMPORTANCE_SOURCE__IMPORTANCE_EXPLANATION_APP =
            1;
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_SOURCE__IMPORTANCE_EXPLANATION_APP_PRE_CHANNELS = 5;
    public static final int NOTIFICATION_REPORTED__IMPORTANCE_SOURCE__IMPORTANCE_EXPLANATION_ASST =
            3;
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_SOURCE__IMPORTANCE_EXPLANATION_SYSTEM = 4;
    public static final int
            NOTIFICATION_REPORTED__IMPORTANCE_SOURCE__IMPORTANCE_EXPLANATION_UNKNOWN = 0;
    ...
    public static final int NOTIFICATION_REPORTED__IMPORTANCE__IMPORTANCE_IMPORTANT_CONVERSATION =
            5;
    ...
    public static final int
            PACKAGE_MANAGER_APPS_FILTER_CACHE_BUILD_REPORTED__EVENT_TYPE__UNSPECIFIED = 0;
    public static final int
            PACKAGE_MANAGER_APPS_FILTER_CACHE_BUILD_REPORTED__EVENT_TYPE__USER_CREATED = 2;
    public static final int
            PACKAGE_MANAGER_APPS_FILTER_CACHE_BUILD_REPORTED__EVENT_TYPE__USER_DELETED = 3;
    public static final int PACKAGE_MANAGER_APPS_FILTER_CACHE_UPDATE_REPORTED = 546;
    public static final int
            PACKAGE_MANAGER_APPS_FILTER_CACHE_UPDATE_REPORTED__EVENT_TYPE__COMPAT_CHANGED = 4;
    public static final int
            PACKAGE_MANAGER_APPS_FILTER_CACHE_UPDATE_REPORTED__EVENT_TYPE__PACKAGE_ADDED = 1;
    public static final int
            PACKAGE_MANAGER_APPS_FILTER_CACHE_UPDATE_REPORTED__EVENT_TYPE__PACKAGE_DELETED = 2;
    public static final int
            PACKAGE_MANAGER_APPS_FILTER_CACHE_UPDATE_REPORTED__EVENT_TYPE__PACKAGE_REPLACED = 3;
    public static final int
            PACKAGE_MANAGER_APPS_FILTER_CACHE_UPDATE_REPORTED__EVENT_TYPE__UNSPECIFIED = 0;
    ...
    public static final int PHONE_SERVICE_STATE_CHANGED__SIGNAL_STRENGTH__SIGNAL_STRENGTH_MODERATE =
            2;
    public static final int
            PHONE_SERVICE_STATE_CHANGED__SIGNAL_STRENGTH__SIGNAL_STRENGTH_NONE_OR_UNKNOWN = 0;
    ...
    public static final int PHONE_SIGNAL_STRENGTH_CHANGED__SIGNAL_STRENGTH__SIGNAL_STRENGTH_GREAT =
            4;
    public static final int
            PHONE_SIGNAL_STRENGTH_CHANGED__SIGNAL_STRENGTH__SIGNAL_STRENGTH_MODERATE = 2;
    public static final int
            PHONE_SIGNAL_STRENGTH_CHANGED__SIGNAL_STRENGTH__SIGNAL_STRENGTH_NONE_OR_UNKNOWN = 0;
    ...
    public static final int
            PRIVACY_SENSOR_TOGGLE_INTERACTION__ACTION__TOGGLE_ON_EXCEPT_ALLOWLISTED_APPS = 3;
    ...
    public static final int PROCESS_START_TIME__TRIGGER_TYPE__TRIGGER_TYPE_PUSH_MESSAGE_OVER_QUOTA =
            3;
    ...
    public static final int PROCESS_STATE_CHANGED__STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
            1004;
    ...
    public static final int PROCESS_STATE_CHANGED__STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
            1016;
    ...
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_BOUND_TOP =
                    1020;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY =
                    1015;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY =
                    1018;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT =
                    1017;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT =
                    1012;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY =
                    1014;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_NONEXISTENT =
                    1019;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_PERSISTENT =
                    1000;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI =
                    1001;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_RECEIVER =
                    1010;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING =
                    1011;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
                    998;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_NORMAL = 1;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_STOPPED = 2;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_UNKNOWN = 0;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_COLD = 3;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_HOT = 2;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_UNKNOWN = 0;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_WARM = 1;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_BACKUP =
                    1008;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_BOUND_TOP =
                    1020;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY =
                    1015;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY =
                    1018;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT =
                    1017;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT =
                    1012;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY =
                    1014;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_NONEXISTENT =
                    1019;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_PERSISTENT =
                    1000;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI =
                    1001;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_RECEIVER =
                    1010;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_SERVICE =
                    1009;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING =
                    1011;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_UNKNOWN =
                    999;
    public static final int
            PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
                    998;
    ...
    public static final int
            REBOOT_ESCROW_PREPARATION_REPORTED__RESULT__ROR_SKIP_PREPARATION_AND_NOTIFY = 1;
    public static final int
            REBOOT_ESCROW_PREPARATION_REPORTED__RESULT__ROR_SKIP_PREPARATION_NOT_NOTIFY = 2;
    ...
    public static final int
            REBOOT_ESCROW_RECOVERY_REPORTED__VBMETA_DIGEST_STATUS__MATCH_EXPECTED_SLOT = 0;
    public static final int
            REBOOT_ESCROW_RECOVERY_REPORTED__VBMETA_DIGEST_STATUS__MATCH_FALLBACK_SLOT = 1;
    ...
    public static final int
            RESOURCE_VALUE_API_STATISTICS_REPORTED__API__RESOURCE_API_RETRIEVE_ATTRIBUTES = 2;
    ...
    public static final int
            RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_CANT_SAVE_STATE = 350;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_EMPTY = 500;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_FOREGROUND =
            100;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_FOREGROUND_SERVICE = 125;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_GONE = 1000;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_PERCEPTIBLE =
            230;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_PERCEPTIBLE_PRE_26 = 130;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_SERVICE = 300;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_TOP_SLEEPING =
            325;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_TOP_SLEEPING_PRE_28 = 150;
    public static final int RUNNING_APP_PROCESS_MEMORY__IMPORTANCE_TYPE__IMPORTANCE_VISIBLE = 200;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_BACKUP =
            9;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    5;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_BOUND_TOP = 3;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_CACHED_ACTIVITY = 16;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    17;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_CACHED_EMPTY = 19;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_CACHED_RECENT = 18;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_FOREGROUND_SERVICE = 4;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_HEAVY_WEIGHT = 13;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_HOME = 14;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_IMPORTANT_BACKGROUND = 7;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_IMPORTANT_FOREGROUND = 6;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_LAST_ACTIVITY = 15;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_PERSISTENT = 0;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_PERSISTENT_UI = 1;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_RECEIVER =
            11;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_SERVICE =
            10;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_TOP = 2;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_TOP_SLEEPING = 12;
    public static final int
            RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_TRANSIENT_BACKGROUND = 8;
    public static final int RUNNING_APP_PROCESS_MEMORY__PROCESS_STATE_TYPE__PROCESS_STATE_UNKNOWN =
            -1;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_AUTO_REVOKE_PERMISSIONS_IF_UNUSED =
            97;
    ...
    public static final int
            RUNTIME_APP_OP_ACCESS__OP__APP_OP_CAPTURE_CONSENTLESS_BUGREPORT_ON_USERDEBUG_BUILD =
                    131;
    ...
    public static final int
            RUNTIME_APP_OP_ACCESS__OP__APP_OP_RAPID_CLEAR_NOTIFICATIONS_BY_LISTENER = 142;
    ...
    public static final int
            RUNTIME_APP_OP_ACCESS__OP__APP_OP_RECEIVE_EXPLICIT_USER_INTERACTION_AUDIO = 121;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_RECEIVE_MMS = 18;
    public static final int
            RUNTIME_APP_OP_ACCESS__OP__APP_OP_RECEIVE_SANDBOXED_DETECTION_TRAINING_DATA = 137;
    ...
    public static final int
            RUNTIME_APP_OP_ACCESS__OP__APP_OP_SYSTEM_EXEMPT_FROM_ACTIVITY_BG_START_RESTRICTION =
                    130;
    public static final int
            RUNTIME_APP_OP_ACCESS__OP__APP_OP_SYSTEM_EXEMPT_FROM_DISMISSIBLE_NOTIFICATIONS = 125;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_SYSTEM_EXEMPT_FROM_HIBERNATION = 129;
    public static final int
            RUNTIME_APP_OP_ACCESS__OP__APP_OP_SYSTEM_EXEMPT_FROM_POWER_RESTRICTIONS = 128;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER =
            105;
    ...
    public static final int
            SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_BACKGROUND_NOT_RESTRICTED = 11;
    public static final int
            SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_BATTERY_NOT_LOW = 2;
    public static final int SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_CHARGING = 1;
    public static final int SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_CONNECTIVITY =
            7;
    public static final int
            SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_CONTENT_TRIGGER = 8;
    public static final int SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_DEADLINE = 5;
    public static final int
            SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_DEVICE_NOT_DOZING = 9;
    ...
    public static final int
            SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_STORAGE_NOT_LOW = 3;
    public static final int SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_TARE_WEALTH =
            13;
    ...
    public static final int
            SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_WITHIN_EXPEDITED_JOB_QUOTA =
                    12;
    public static final int SCHEDULED_JOB_CONSTRAINT_CHANGED__CONSTRAINT__CONSTRAINT_WITHIN_QUOTA =
            10;
    ...
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_ANR = 12;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_CANCELLED = 0;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_CONSTRAINTS_NOT_SATISFIED =
                    1;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_DATA_CLEARED =
                    8;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_DEVICE_IDLE = 4;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_DEVICE_THERMAL =
                    5;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_OLAF = 13;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_PREEMPT = 2;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_RESTRICTED_BUCKET =
                    6;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_RTC_UPDATED = 9;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_SUCCESSFUL_FINISH =
                    10;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_TIMEOUT = 3;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_UNINSTALL = 7;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_UNKNOWN = -1;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_USER_UI_STOP =
                    11;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_CACHED_ACTIVITY =
            1015;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_CACHED_EMPTY =
            1018;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_CACHED_RECENT =
            1017;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    ...
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_LAST_ACTIVITY =
            1014;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_NONEXISTENT =
            1019;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_PERSISTENT =
            1000;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_PERSISTENT_UI =
            1001;
    ...
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_TOP_SLEEPING =
            1011;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_APP_STANDBY = 12;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_BACKGROUND_RESTRICTION =
                    11;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_CANCELLED_BY_APP = 1;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_CONSTRAINT_BATTERY_NOT_LOW =
                    5;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_CONSTRAINT_CHARGING = 6;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_CONSTRAINT_CONNECTIVITY =
                    7;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_CONSTRAINT_DEVICE_IDLE = 8;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_CONSTRAINT_STORAGE_NOT_LOW =
                    9;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_DEVICE_STATE = 4;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_ESTIMATED_APP_LAUNCH_TIME_CHANGED =
                    15;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_PREEMPT =
            2;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_QUOTA = 10;
    public static final int
            SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_SYSTEM_PROCESSING = 14;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_TIMEOUT =
            3;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_UNDEFINED =
            0;
    ...
    public static final int SCREEN_DIM_REPORTED__LAST_USER_ACTIVITY_EVENT__SCREEN_TIMEOUT_OVERRIDE =
            7;
    ...
    public static final int
            SCREEN_INTERACTIVE_SESSION_REPORTED__INTERACTIVE_STATE_OFF_REASON__POWER_BUTTON = 2;
    public static final int
            SCREEN_INTERACTIVE_SESSION_REPORTED__INTERACTIVE_STATE_OFF_REASON__TIMEOUT = 1;
    public static final int
            SCREEN_INTERACTIVE_SESSION_REPORTED__INTERACTIVE_STATE_OFF_REASON__UNKNOWN = 0;
    public static final int
            SCREEN_INTERACTIVE_SESSION_REPORTED__LAST_USER_ACTIVITY_EVENT__ACCESSIBILITY = 3;
    public static final int
            SCREEN_INTERACTIVE_SESSION_REPORTED__LAST_USER_ACTIVITY_EVENT__ATTENTION = 4;
    public static final int SCREEN_INTERACTIVE_SESSION_REPORTED__LAST_USER_ACTIVITY_EVENT__BUTTON =
            1;
    public static final int
            SCREEN_INTERACTIVE_SESSION_REPORTED__LAST_USER_ACTIVITY_EVENT__DEVICE_STATE = 6;
    public static final int
            SCREEN_INTERACTIVE_SESSION_REPORTED__LAST_USER_ACTIVITY_EVENT__FACE_DOWN = 5;
    public static final int SCREEN_INTERACTIVE_SESSION_REPORTED__LAST_USER_ACTIVITY_EVENT__OTHER =
            0;
    public static final int
            SCREEN_INTERACTIVE_SESSION_REPORTED__LAST_USER_ACTIVITY_EVENT__SCREEN_TIMEOUT_OVERRIDE =
                    7;
    ...
    public static final int SCREEN_STATE_CHANGED_V2__REASON__DISPLAY_STATE_REASON_DEFAULT_POLICY =
            1;
    public static final int SCREEN_STATE_CHANGED_V2__REASON__DISPLAY_STATE_REASON_DRAW_WAKE_LOCK =
            2;
    ...
    public static final int
            SCREEN_TIMEOUT_OVERRIDE_REPORTED__OVERRIDE_OUTCOME__CANCEL_CLIENT_API_CALL = 3;
    public static final int
            SCREEN_TIMEOUT_OVERRIDE_REPORTED__OVERRIDE_OUTCOME__CANCEL_CLIENT_DISCONNECTED = 6;
    public static final int SCREEN_TIMEOUT_OVERRIDE_REPORTED__OVERRIDE_OUTCOME__CANCEL_OTHER = 7;
    public static final int
            SCREEN_TIMEOUT_OVERRIDE_REPORTED__OVERRIDE_OUTCOME__CANCEL_POWER_BUTTON = 5;
    public static final int
            SCREEN_TIMEOUT_OVERRIDE_REPORTED__OVERRIDE_OUTCOME__CANCEL_USER_INTERACTION = 4;
    public static final int SCREEN_TIMEOUT_OVERRIDE_REPORTED__OVERRIDE_OUTCOME__TIMEOUT_SUCCESS = 1;
    public static final int
            SCREEN_TIMEOUT_OVERRIDE_REPORTED__OVERRIDE_OUTCOME__TIMEOUT_USER_INITIATED_REVERT = 2;
    ...
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_NORMAL = 1;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_STOPPED = 2;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__PACKAGE_STOPPED_STATE__PACKAGE_STATE_UNKNOWN = 0;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_COLD = 3;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_HOT = 2;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_UNKNOWN = 0;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__PROC_START_TYPE__PROCESS_START_TYPE_WARM = 1;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY =
                    1015;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY =
                    1018;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT =
                    1017;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT =
                    1012;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY =
                    1014;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_NONEXISTENT =
                    1019;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_PERSISTENT =
                    1000;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI =
                    1001;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING =
                    1011;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
                    998;
    ...
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE =
                    1004;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY =
                    1015;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT =
                    1016;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY =
                    1018;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT =
                    1017;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE =
                    1003;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT =
                    1012;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND =
                    1006;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND =
                    1005;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY =
                    1014;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI =
                    1001;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING =
                    1011;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND =
                    1007;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int
            SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
                    998;
    ...
    public static final int SIGNED_CONFIG_REPORTED__STATUS__SIGNATURE_CHECK_FAILED_PROD_KEY_ABSENT =
            9;
    ...
    public static final int SPLITSCREEN_UICHANGED__EXIT_REASON__APP_DOES_NOT_SUPPORT_MULTIWINDOW =
            8;
    ...
    public static final int
            SYNC_EXEMPTION_OCCURRED__RESTRICTION_LEVEL__LEVEL_BACKGROUND_RESTRICTED = 5;
    ...
    public static final int THERMAL_HEADROOM_CALLED__API_STATUS__UNSPECIFIED_THERMAL_API_FAILURE =
            0;
    ...
    public static final int
            THERMAL_HEADROOM_THRESHOLDS_CALLED__API_STATUS__NO_TEMPERATURE_THRESHOLD = 6;
    public static final int THERMAL_HEADROOM_THRESHOLDS_CALLED__API_STATUS__SUCCESS = 1;
    public static final int
            THERMAL_HEADROOM_THRESHOLDS_CALLED__API_STATUS__UNSPECIFIED_THERMAL_API_FAILURE = 0;
    ...
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_AMBIENT = 18;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_BATTERY = 2;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_BCL_CURRENT =
                    7;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_BCL_PERCENTAGE =
                    8;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_BCL_VOLTAGE =
                    6;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_CAMERA = 15;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_CPU = 0;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_DISPLAY = 11;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_FLASHLIGHT =
                    16;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_GPU = 1;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_MODEM = 12;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_NPU = 9;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_POGO = 19;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_POWER_AMPLIFIER =
                    5;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_SKIN = 3;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_SOC = 13;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_SPEAKER = 17;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_TPU = 10;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_UNKNOWN = -1;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_USB_PORT = 4;
    public static final int
            THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__SENSOR_TYPE__TEMPERATURE_TYPE_WIFI = 14;
    ...
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_AUDIO_ONLY =
            104;
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_BUFFERING = 103;
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_BLACKOUT =
            116;
    public static final int
            TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_CARD_INVALID = 115;
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_CARD_MUTE =
            114;
    public static final int
            TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_INSUFFICIENT_OUTPUT_PROTECTION =
                    107;
    public static final int
            TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_LICENSE_EXPIRED = 110;
    public static final int
            TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_NEED_ACTIVATION = 111;
    public static final int
            TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_NEED_PAIRING = 112;
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_NO_CARD =
            113;
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_NO_LICENSE =
            109;
    public static final int
            TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_PVR_RECORDING_NOT_ALLOWED =
                    108;
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_REBOOTING =
            117;
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_CAS_UNKNOWN =
            118;
    public static final int
            TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_INSUFFICIENT_RESOURCE = 106;
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_NOT_CONNECTED =
            105;
    ...
    public static final int TIF_TUNE_STATE_CHANGED__STATE__VIDEO_UNAVAILABLE_REASON_WEAK_SIGNAL =
            102;
    ...
    public static final int
            TRACING_SERVICE_REPORT_EVENT__EVENT__TRACING_SERVICE_REPORT_BIND_PERM_INCORRECT = 3;
    public static final int
            TRACING_SERVICE_REPORT_EVENT__EVENT__TRACING_SERVICE_REPORT_SVC_COMM_ERROR = 5;
    public static final int
            TRACING_SERVICE_REPORT_EVENT__EVENT__TRACING_SERVICE_REPORT_SVC_HANDOFF = 2;
    public static final int
            TRACING_SERVICE_REPORT_EVENT__EVENT__TRACING_SERVICE_REPORT_SVC_PERM_MISSING = 4;
    public static final int TRACING_SERVICE_REPORT_EVENT__EVENT__TRACING_SERVICE_REPORT_UNDEFINED =
            0;
    ...
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_FINGERPRINT_WAKE_AND_UNLOCK =
            3;
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_FOLD_TO_AOD = 19;
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_KEYGUARD_FPS_UNLOCK_TO_HOME =
            28;
    ...
    public static final int
            UIACTION_LATENCY_REPORTED__ACTION__ACTION_NOTIFICATIONS_HIDDEN_FOR_MEASURE = 30;
    public static final int
            UIACTION_LATENCY_REPORTED__ACTION__ACTION_NOTIFICATIONS_HIDDEN_FOR_MEASURE_WITH_SHADE_OPEN =
                    31;
    public static final int
            UIACTION_LATENCY_REPORTED__ACTION__ACTION_NOTIFICATION_BIG_PICTURE_LOADED = 27;
    ...
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_ROTATE_SCREEN_CAMERA_CHECK =
            10;
    ...
    public static final int
            UID_PROCESS_STATE_CHANGED__STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    ...
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__DISPLAY_REFRESH_RATE__UNKNOWN_REFRESH_RATE = 0;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__DISPLAY_REFRESH_RATE__VARIABLE_REFRESH_RATE = 1;
    ...
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__DISPLAY_RESOLUTION__UNKNOWN_RESOLUTION = 0;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__BACK_PANEL_ARROW =
            89;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__BIOMETRIC_PROMPT_TRANSITION = 57;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__IME_INSETS_ANIMATION = 70;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__IME_INSETS_HIDE_ANIMATION = 82;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__IME_INSETS_SHOW_ANIMATION = 81;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_ALL_APPS_SCROLL = 27;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_ALL_APPS_SEARCH_BACK = 95;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_APP_CLOSE_TO_HOME = 10;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_APP_CLOSE_TO_HOME_FALLBACK =
                    79;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_APP_CLOSE_TO_PIP = 11;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_APP_LAUNCH_FROM_ICON = 9;
    public static final int
    ...
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_APP_LAUNCH_FROM_WIDGET =
                    28;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_APP_SWIPE_TO_RECENTS = 67;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_CLOSE_ALL_APPS_BACK = 90;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_CLOSE_ALL_APPS_SWIPE = 68;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_CLOSE_ALL_APPS_TO_HOME =
                    69;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_LAUNCH_APP_PAIR_FROM_TASKBAR =
                    93;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_LAUNCH_APP_PAIR_FROM_WORKSPACE =
                    92;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_OPEN_ALL_APPS = 26;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_OPEN_SEARCH_RESULT = 72;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_PRIVATE_SPACE_LOCK = 102;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_PRIVATE_SPACE_UNLOCK =
                    103;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_QUICK_SWITCH = 12;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_SAVE_APP_PAIR = 94;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_SEARCH_QSB_WEB_SEARCH =
                    91;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_TASKBAR_ALL_APPS_CLOSE_BACK =
                    96;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_TASKBAR_ALL_APPS_SEARCH_BACK =
                    97;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_UNFOLD_ANIM = 84;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_UNLOCK_ENTRANCE_ANIMATION =
                    64;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_WIDGET_BOTTOM_SHEET_CLOSE_BACK =
                    100;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_WIDGET_EDU_SHEET_CLOSE_BACK =
                    101;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_WIDGET_PICKER_CLOSE_BACK =
                    98;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_WIDGET_PICKER_SEARCH_BACK =
                    99;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_CLOCK_MOVE_ANIMATION =
                    71;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_LAUNCH_CAMERA = 52;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_OCCLUSION = 65;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_PASSWORD_APPEAR = 18;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_PASSWORD_DISAPPEAR = 21;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_PATTERN_APPEAR = 19;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_PATTERN_DISAPPEAR = 22;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_PIN_APPEAR = 20;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_PIN_DISAPPEAR = 23;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_TRANSITION_FROM_AOD =
                    24;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_TRANSITION_TO_AOD = 25;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LOCKSCREEN_UNLOCK_ANIMATION = 30;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__NOTIFICATION_SHADE_SWIPE = 1;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__ONE_HANDED_ENTER_TRANSITION = 43;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__ONE_HANDED_EXIT_TRANSITION = 44;
    ...
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__PREDICTIVE_BACK_CROSS_ACTIVITY =
                    85;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__PREDICTIVE_BACK_CROSS_TASK = 86;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__PREDICTIVE_BACK_HOME = 87;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__RECENTS_SCROLLING =
            66;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SCREEN_OFF = 41;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SCREEN_OFF_SHOW_AOD = 42;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_EDGE_OPEN_PANEL = 10002;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_NOTIFICATION_SHADE_QS_SHOW_DETAIL =
                    10001;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_RESERVED3 =
            10003;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_RESERVED4 =
            10004;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SEC_UNKNOWN =
            10000;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SETTINGS_PAGE_SCROLL = 29;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SETTINGS_SLIDER =
            54;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SETTINGS_TOGGLE =
            58;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_APP_LAUNCH =
            17;
    public static final int
    ...
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_APP_LAUNCH_FROM_MEDIA_PLAYER =
                    32;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_APP_LAUNCH_FROM_QS_TILE = 33;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_APP_LAUNCH_FROM_SETTINGS_BUTTON =
                    34;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_CLEAR_ALL =
            63;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_DIALOG_OPEN =
            59;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_HEADS_UP_APPEAR = 13;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_HEADS_UP_DISAPPEAR = 14;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_NOTIFICATION_ADD = 15;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_NOTIFICATION_REMOVE = 16;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_QS_EXPAND_COLLAPSE = 6;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_QS_SCROLL_SWIPE = 7;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_ROW_EXPAND =
            4;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_ROW_SWIPE =
            5;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_SCROLL_FLING = 3;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SPLASHSCREEN_AVD =
            39;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SPLASHSCREEN_EXIT_ANIM = 40;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SPLIT_SCREEN_DOUBLE_TAP_DIVIDER =
                    83;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SPLIT_SCREEN_ENTER = 50;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SPLIT_SCREEN_EXIT =
            51;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SPLIT_SCREEN_RESIZE = 53;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__STATUS_BAR_APP_LAUNCH_FROM_CALL_CHIP =
                    35;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SUW_LOADING_SCREEN_FOR_STATUS = 49;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SUW_LOADING_TO_NEXT_FLOW = 48;
    public static final int
    ...
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SUW_SHOW_FUNCTION_SCREEN_WITH_ACTIONS =
                    47;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__TAKE_SCREENSHOT =
            55;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__TASKBAR_COLLAPSE =
            62;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__TASKBAR_EXPAND =
            61;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__UNFOLD_ANIM = 45;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__UNKNOWN_INTERACTION = 0;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__USER_DIALOG_OPEN =
            60;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__USER_SWITCH = 38;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__VOLUME_CONTROL =
            56;
    public static final int
            UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WALLPAPER_TRANSITION = 37;
    ...
    public static final int
            UNSAFE_INTENT_EVENT_REPORTED__EVENT_TYPE__EXPLICIT_INTENT_FILTER_UNMATCH = 3;
    public static final int
            UNSAFE_INTENT_EVENT_REPORTED__EVENT_TYPE__INTERNAL_NON_EXPORTED_COMPONENT_MATCH = 2;
    public static final int
    ...
    public static final int
            USB_COMPLIANCE_WARNINGS_REPORTED__COMPLIANCE_WARNINGS__COMPLIANCE_WARNING_BC_1_2 = 2;
    public static final int
    ...
    public static final int
            USB_COMPLIANCE_WARNINGS_REPORTED__COMPLIANCE_WARNINGS__COMPLIANCE_WARNING_MISSING_RP =
                    3;
    public static final int
            USB_COMPLIANCE_WARNINGS_REPORTED__COMPLIANCE_WARNINGS__COMPLIANCE_WARNING_OTHER = 4;
    public static final int
            USB_COMPLIANCE_WARNINGS_REPORTED__COMPLIANCE_WARNINGS__COMPLIANCE_WARNING_UNRELIABLE_IO =
                    9;
    public static final int
            USB_COMPLIANCE_WARNINGS_REPORTED__COMPLIANCE_WARNINGS__COMPLIANCE_WARNING_UNSPECIFIED =
                    0;
    ...
    public static final int USERSPACE_REBOOT_REPORTED__OUTCOME__FAILED_SHUTDOWN_SEQUENCE_ABORTED =
            2;
    public static final int USERSPACE_REBOOT_REPORTED__OUTCOME__FAILED_USERDATA_REMOUNT = 3;
    public static final int
            USERSPACE_REBOOT_REPORTED__OUTCOME__FAILED_USERSPACE_REBOOT_WATCHDOG_TRIGGERED = 4;
    ...
    public static final int
            USERSPACE_REBOOT_REPORTED__USER_ENCRYPTION_STATE__USER_ENCRYPTION_STATE_UNKNOWN = 0;
    ...
    public static final int
            USER_RISK_EVENT_REPORTED__CALL_NUMBER_VERIFICATION_STATUS__NOT_VERIFIED = 1;
    public static final int USER_RISK_EVENT_REPORTED__CALL_NUMBER_VERIFICATION_STATUS__PASSED = 2;
    public static final int
            USER_RISK_EVENT_REPORTED__CALL_NUMBER_VERIFICATION_STATUS__UNKNOWN_STATUS = 0;
    ...
    public static final int
            USER_RISK_EVENT_REPORTED__EVENT_TYPE__MEDIA_PROJECTION_CONSENT_DIALOG_SHOWN = 5;
    ...
    public static final int VPN_CONNECTION_REPORTED__ERROR_CODE__EC_UNSUPPORTED_CRITICAL_PAYLOAD =
            2;
    ...
    public static final int
            VPN_CONNECTION_REPORTED__VPN_PROFILE_TYPE__TYPE_IKEV2_FROM_IKE_TUN_CONN_PARAMS = 10;
    ...
    public static final int VPN_CONNECTION_REPORTED__VPN_PROFILE_TYPE__TYPE_IKEV2_IPSEC_USER_PASS =
            7;
    ...
    public static final int VPN_CONNECTION_REPORTED__VPN_PROFILE_TYPE__TYPE_TYPE_IPSEC_XAUTH_PSK =
            4;
    ...
    public static final int
            WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY =
            1015;
    public static final int
            WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY =
            1018;
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_CACHED_RECENT =
            1017;
    public static final int
            WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    ...
    public static final int
            WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int
            WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY =
            1014;
    ...
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI =
            1001;
    ...
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING =
            1011;
    public static final int
            WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO =
            998;
    ...
    public static final int WATCHDOG_ROLLBACK_OCCURRED__ROLLBACK_REASON__REASON_APP_NOT_RESPONDING =
            4;
    public static final int WATCHDOG_ROLLBACK_OCCURRED__ROLLBACK_REASON__REASON_BOOT_LOOPING = 7;
    public static final int
            WATCHDOG_ROLLBACK_OCCURRED__ROLLBACK_REASON__REASON_EXPLICIT_HEALTH_CHECK = 2;
    public static final int WATCHDOG_ROLLBACK_OCCURRED__ROLLBACK_REASON__REASON_NATIVE_CRASH = 1;
    public static final int
            WATCHDOG_ROLLBACK_OCCURRED__ROLLBACK_REASON__REASON_NATIVE_CRASH_DURING_BOOT = 5;
    public static final int
            WATCHDOG_ROLLBACK_OCCURRED__ROLLBACK_REASON__REASON_NETWORK_RELATED_CRASH = 6;
    ...
    public static final int
            WIFI_RADIO_POWER_STATE_CHANGED__STATE__DATA_CONNECTION_POWER_STATE_HIGH = 3;
    public static final int WIFI_RADIO_POWER_STATE_CHANGED__STATE__DATA_CONNECTION_POWER_STATE_LOW =
            1;
    public static final int
            WIFI_RADIO_POWER_STATE_CHANGED__STATE__DATA_CONNECTION_POWER_STATE_MEDIUM = 2;
    public static final int
    ...
    public static void write(
            int code, int[] uid, String[] tag, String arg2, String arg3, int arg4) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeAttributionChain(
                uid == null ? new int[0] : uid, tag == null ? new String[0] : tag);
    ...
    public static void write(
            int code, int arg1, int arg2, int arg3, boolean arg4, boolean arg5, int arg6) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (863 == code) {
    ...
    public static void write(
            int code, int arg1, int arg2, int arg3, int arg4, int arg5, String arg6, String arg7) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(
            int code, int arg1, int arg2, long arg3, boolean arg4, int arg5, float arg6, int arg7) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(
            int code, int arg1, int arg2, long arg3, int arg4, int arg5, int arg6) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(
            int code, int arg1, int arg2, long arg3, int arg4, long arg5, long arg6) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(
            int code, int arg1, String arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (100405 == code) {
    ...
    public static void write(
            int code, long arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeLong(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(
            int code, String arg1, long arg2, String arg3, int arg4, String[] arg5) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeString(arg1);
        builder.writeLong(arg2);
    ...
    public static StatsEvent buildStatsEvent(
            int code, boolean arg1, String arg2, int arg3, boolean arg4, boolean arg5) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeBoolean(arg1);
        builder.writeString(arg2);
    ...
    public static StatsEvent buildStatsEvent(
            int code, int arg1, int arg2, boolean arg3, float arg4) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(
            int code, int arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (10218 == code) {
    ...
    public static StatsEvent buildStatsEvent(
            int code, int arg1, int arg2, long arg3, long arg4, long arg5, long arg6) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        if (10204 == code) {
            builder.addBooleanAnnotation((byte) 2, true);
    ...
    public static StatsEvent buildStatsEvent(
            int code, int arg1, String arg2, long arg3, long arg4) {
        StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (10035 == code) {
    ...
    public static void write(
        ...
        for (int i = 0; i < ws.size(); i++) {
            write_non_chained(
                    code, ws.getUid(i), ws.getPackageName(i), arg2, arg3, arg4, arg5, arg6);
        }
        List<WorkSource.WorkChain> workChains = ws.getWorkChains();
        if (workChains != null) {
            for (WorkSource.WorkChain wc : workChains) {
