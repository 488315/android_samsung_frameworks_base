...
public class StateMachine {
  ...
  public static class LogRec {
    ...
    public void update(
        StateMachine sm, Message msg, String info, IState state, IState orgState, IState dstState) {
      this.mSm = sm;
  ...
  static class SmHandler extends Handler {
    ...
    class StateInfo {
      ...
      public String toString() {
        ...
        return append
            .append(
                stateInfo == null ? SemCapabilities.FEATURE_TAG_NULL : stateInfo.state.getName())
            .toString();
      }
    }
    ...
    public final void handleMessage(Message msg) {
      ...
      if (!this.mHasQuit) {
        ...
        } else if (!this.mIsConstructionCompleted
            && this.mMsg.what == -2
            && this.mMsg.obj == mSmHandlerObj) {
      ...
      if (this.mLogRecords.logOnlyTransitions()) {
        if (this.mDestState != null) {
          ...
          logRecords.add(
              stateMachine,
              message,
              stateMachine.getLogRecString(message),
              msgProcessedState,
              orgState,
              this.mDestState);
        }
        ...
        logRecords2.add(
            stateMachine2,
            message2,
            stateMachine2.getLogRecString(message2),
            msgProcessedState,
            orgState,
            this.mDestState);
      }
  ...
  protected void logv(String s) {
    Log.m100v(this.mName, s);
  }

  protected void logi(String s) {
    Log.m98i(this.mName, s);
  }

  protected void logw(String s) {
    Log.m102w(this.mName, s);
  }

  protected void loge(String s) {
    Log.m96e(this.mName, s);
  }

  protected void loge(String s, Throwable e) {
    Log.m97e(this.mName, s, e);
  }
}
