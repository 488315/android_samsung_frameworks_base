...
public class MimeIconUtils {
    ...
    switch (c) {
      ...
      case 1:
        return buildTypeInfo(
            mimeType, C4337R.drawable.ic_doc_folder, C4337R.string.mime_type_folder, -1);
      case 2:
      ...
      case '\f':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_certificate,
            C4337R.string.mime_type_generic,
            C4337R.string.mime_type_generic_ext);
      case '\r':
      case 14:
      case 15:
      case 16:
      ...
      case '(':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_codes,
            C4337R.string.mime_type_document,
            C4337R.string.mime_type_document_ext);
      case ')':
      case '*':
      case '+':
      case ',':
      ...
      case ':':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_compressed,
            C4337R.string.mime_type_compressed,
            C4337R.string.mime_type_compressed_ext);
      case ';':
      case '<':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_contact,
            C4337R.string.mime_type_generic,
            C4337R.string.mime_type_generic_ext);
      case '=':
      case '>':
      ...
      case 'I':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_image,
            C4337R.string.mime_type_image,
            C4337R.string.mime_type_image_ext);
      case 'J':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_pdf,
            C4337R.string.mime_type_document,
            C4337R.string.mime_type_document_ext);
      case 'K':
      case 'L':
      ...
      case 'P':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_presentation,
            C4337R.string.mime_type_presentation,
            C4337R.string.mime_type_presentation_ext);
      case 'Q':
      case 'R':
      case 'S':
      case 'T':
      ...
      case 'W':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_spreadsheet,
            C4337R.string.mime_type_spreadsheet,
            C4337R.string.mime_type_spreadsheet_ext);
      case 'X':
      case 'Y':
      case 'Z':
      case '[':
      ...
      case 'c':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_document,
            C4337R.string.mime_type_document,
            C4337R.string.mime_type_document_ext);
      case 'd':
      case 'e':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_video,
            C4337R.string.mime_type_video,
            C4337R.string.mime_type_video_ext);
      case 'f':
      case 'g':
      case 'h':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_word,
            C4337R.string.mime_type_document,
            C4337R.string.mime_type_document_ext);
      case 'i':
      case 'j':
      ...
      case 'o':
        return buildTypeInfo(
            mimeType,
            C4337R.drawable.ic_doc_powerpoint,
            C4337R.string.mime_type_presentation,
            C4337R.string.mime_type_presentation_ext);
      default:
  ...
  private static ContentResolver.MimeTypeInfo buildGenericTypeInfo(String mimeType) {
    if (mimeType.startsWith("audio/")) {
      return buildTypeInfo(
          mimeType,
          C4337R.drawable.ic_doc_audio,
          C4337R.string.mime_type_audio,
          C4337R.string.mime_type_audio_ext);
    }
    ...
    return buildTypeInfo(
        mimeType,
        C4337R.drawable.ic_doc_generic,
        C4337R.string.mime_type_generic,
        C4337R.string.mime_type_generic_ext);
  }
