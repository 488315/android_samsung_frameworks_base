...
public class EmergencyAffordanceManager {
  ...
  private static Uri getPhoneUri(Context context) {
    String override;
    String number = context.getResources().getString(C4337R.string.config_emergency_call_number);
  ...
  private boolean isEmergencyAffordanceNeeded() {
    return Settings.Global.getInt(
            this.mContext.getContentResolver(), Settings.Global.EMERGENCY_AFFORDANCE_NEEDED, 0)
        != 0;
  }
