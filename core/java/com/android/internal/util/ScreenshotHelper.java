...
public class ScreenshotHelper {
  ...
  public ScreenshotHelper(Context context) {
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.internal.util.ScreenshotHelper.1
  ...
  public void takeScreenshot(
      ScreenshotRequest request, Handler handler, Consumer<Uri> completionConsumer) {
        ...
        try {
          final Runnable mScreenshotTimeout =
              new Runnable() { // from class:
                               // com.android.internal.util.ScreenshotHelper$$ExternalSyntheticLambda0
          ...
          if (serviceConnection != null && this.mScreenshotService != null) {
            ...
            try {
              ...
              Log.m96e(TAG, "Couldn't take screenshot: " + e);
          ...
          ComponentName serviceComponent =
              ComponentName.unflattenFromString(
                  this.mContext
                      .getResources()
                      .getString(C4337R.string.config_screenshotServiceComponent));
          Intent serviceIntent = new Intent();
          serviceIntent.setComponent(serviceComponent);
          ServiceConnection conn =
              new ServiceConnection() { // from class: com.android.internal.util.ScreenshotHelper.3
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                  synchronized (ScreenshotHelper.this.mScreenshotLock) {
                    ...
                    try {
                      ...
                      Log.m96e(ScreenshotHelper.TAG, "Couldn't take screenshot: " + e2);
                      Consumer consumer = completionConsumer;
                      if (consumer != null) {
                  ...
                  synchronized (ScreenshotHelper.this.mScreenshotLock) {
                    if (ScreenshotHelper.this.mScreenshotConnection != null) {
                      ...
                      if (handler.hasCallbacks(mScreenshotTimeout)) {
                        Log.m96e(ScreenshotHelper.TAG, "Screenshot service disconnected");
                        handler.removeCallbacks(mScreenshotTimeout);
          ...
          if (this.mContext.bindServiceAsUser(
              serviceIntent, conn, Enums.AUDIO_FORMAT_AAC_MAIN, UserHandle.CURRENT)) {
  ...
  public /* synthetic */ void lambda$takeScreenshotInternal$0(Consumer completionConsumer) {
    synchronized (this.mScreenshotLock) {
      if (this.mScreenshotConnection != null) {
        Log.m96e(TAG, "Timed out before getting screenshot capture response");
        resetConnection();
  ...
  public void notifyScreenshotError() {
    ComponentName errorComponent =
        ComponentName.unflattenFromString(
            this.mContext
                .getResources()
                .getString(C4337R.string.config_screenshotErrorReceiverComponent));
