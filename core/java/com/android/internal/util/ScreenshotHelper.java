...
public class ScreenshotHelper {
    ...
    */
        ...
        synchronized (this.mScreenshotLock) {
            try {
                try {
                    ...
                    ComponentName serviceComponent = ComponentName.unflattenFromString(this.mContext.getResources().getString(C4337R.string.config_screenshotServiceComponent));
    ...
    public void notifyScreenshotError() {
        ComponentName errorComponent = ComponentName.unflattenFromString(this.mContext.getResources().getString(C4337R.string.config_screenshotErrorReceiverComponent));
