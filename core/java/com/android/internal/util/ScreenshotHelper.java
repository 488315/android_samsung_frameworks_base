                ...
                try {
                    ...
                    final Runnable mScreenshotTimeout =
                            new Runnable() { // from class:
                                ...
                                public final void run() {
                                    ScreenshotHelper.this.lambda$takeScreenshotInternal$0(
                                            completionConsumer);
                                }
                            };
                    ...
                    ComponentName serviceComponent =
                            ComponentName.unflattenFromString(
                                    this.mContext
                                            .getResources()
                                            .getString(R.string.config_screenshotServiceComponent));
                    Intent serviceIntent = new Intent();
                    serviceIntent.setComponent(serviceComponent);
                    ServiceConnection conn =
                            new ServiceConnection() { // from class:
                                                      // com.android.internal.util.ScreenshotHelper.3
                                ...
                                public void onServiceConnected(
                                    ...
                                    synchronized (ScreenshotHelper.this.mScreenshotLock) {
                                        ...
                                        Messenger messenger2 =
                                                new Messenger(
                                                        ScreenshotHelper.this.mScreenshotService);
                                        try {
                                            messenger2.send(msg);
                                        } catch (RemoteException e2) {
                                            Log.e(
                                                    ScreenshotHelper.TAG,
                                                    "Couldn't take screenshot: " + e2);
                                            if (completionConsumer != null) {
                                                completionConsumer.accept(null);
                                            }
                                        }
                                    ...
                                    synchronized (ScreenshotHelper.this.mScreenshotLock) {
                                        if (ScreenshotHelper.this.mScreenshotConnection != null) {
                                            ...
                                            if (handler.hasCallbacks(mScreenshotTimeout)) {
                                                Log.e(
                                                        ScreenshotHelper.TAG,
                                                        "Screenshot service disconnected");
                                                handler.removeCallbacks(mScreenshotTimeout);
    ...
    public void notifyScreenshotError() {
        ComponentName errorComponent =
                ComponentName.unflattenFromString(
                        this.mContext
                                .getResources()
                                .getString(R.string.config_screenshotErrorReceiverComponent));
