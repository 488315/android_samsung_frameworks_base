...
public class UserIcons {
    private static final int[] USER_ICON_COLORS = {C4337R.color.user_icon_1, C4337R.color.user_icon_2, C4337R.color.user_icon_3, C4337R.color.user_icon_4, C4337R.color.user_icon_5, C4337R.color.user_icon_6, C4337R.color.user_icon_7, C4337R.color.user_icon_8, C4337R.color.user_icon_9};
    ...
    public static Bitmap convertToBitmapAtUserIconSize(Resources res, Drawable icon) {
        int size = res.getDimensionPixelSize(C4337R.dimen.user_icon_size);
    ...
    public static Drawable getDefaultUserIcon(Resources resources, int userId, boolean light) {
        int colorResId = light ? C4337R.color.user_icon_default_white : C4337R.color.user_icon_default_gray;
        if (userId != -10000) {
    ...
    public static Drawable getDefaultUserIconInColor(Resources resources, int color) {
        Drawable icon = resources.getDrawable(C4337R.drawable.mum_default, null).mutate();
