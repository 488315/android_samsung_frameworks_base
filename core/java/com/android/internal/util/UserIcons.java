...
public class UserIcons {
  private static final int[] USER_ICON_COLORS = {
    C4337R.color.user_icon_1,
    C4337R.color.user_icon_2,
    C4337R.color.user_icon_3,
    C4337R.color.user_icon_4,
    C4337R.color.user_icon_5,
    C4337R.color.user_icon_6,
    C4337R.color.user_icon_7,
    C4337R.color.user_icon_8,
    C4337R.color.user_icon_9
  };
  ...
  public static Drawable getDefaultUserIcon(Resources resources, int userId, boolean light) {
    int colorResId =
        light ? C4337R.color.user_icon_default_white : C4337R.color.user_icon_default_gray;
    if (userId != -10000) {
