...
public final class RailStats {
  ...
  public void updateRailData(
    ...
    if (node == null) {
      this.mRailInfoData.put(
          Long.valueOf(index),
          new RailInfoData(
              index, railName, subSystemName, timestampSinceBootMs, energyUsedSinceBootuWs));
  ...
  public static class RailInfoData {
    ...
    public void printData() {
      Slog.m113d(TAG, "Index = " + this.index);
      Slog.m113d(TAG, "RailName = " + this.railName);
      Slog.m113d(TAG, "SubSystemName = " + this.subSystemName);
      Slog.m113d(TAG, "TimestampSinceBootMs = " + this.timestampSinceBootMs);
      Slog.m113d(TAG, "EnergyUsedSinceBootuWs = " + this.energyUsedSinceBootuWs);
    }
  }
}
