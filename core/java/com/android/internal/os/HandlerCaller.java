...
public class HandlerCaller {
  ...
  public HandlerCaller(Context context, Looper looper, Callback callback, boolean asyncHandler) {
    ...
    this.f997mH = new MyHandler(mainLooper, asyncHandler);
  ...
  public void executeOrSendMessage(Message msg) {
    if (Looper.myLooper() == this.mMainLooper) {
      ...
      this.f997mH.sendMessage(msg);
    }
  }

  public void sendMessageDelayed(Message msg, long delayMillis) {
    this.f997mH.sendMessageDelayed(msg, delayMillis);
  }

  public boolean hasMessages(int what) {
    return this.f997mH.hasMessages(what);
  }

  public void removeMessages(int what) {
    this.f997mH.removeMessages(what);
  }

  public void removeMessages(int what, Object obj) {
    this.f997mH.removeMessages(what, obj);
  }
  ...
  public SomeArgs sendMessageAndWait(Message msg) {
    if (Looper.myLooper() == this.f997mH.getLooper()) {
  ...
  public Message obtainMessage(int what) {
    return this.f997mH.obtainMessage(what);
  }

  public Message obtainMessageBO(int i, boolean z, Object obj) {
    return this.f997mH.obtainMessage(i, z ? 1 : 0, 0, obj);
  }
  ...
  public Message obtainMessageBOO(int i, boolean z, Object obj, Object obj2) {
    ...
    obtain.arg1 = obj;
    obtain.arg2 = obj2;
    return this.f997mH.obtainMessage(i, z ? 1 : 0, 0, obtain);
  }

  public Message obtainMessageO(int what, Object arg1) {
    return this.f997mH.obtainMessage(what, 0, 0, arg1);
  }

  public Message obtainMessageI(int what, int arg1) {
    return this.f997mH.obtainMessage(what, arg1, 0);
  }

  public Message obtainMessageII(int what, int arg1, int arg2) {
    return this.f997mH.obtainMessage(what, arg1, arg2);
  }

  public Message obtainMessageIO(int what, int arg1, Object arg2) {
    return this.f997mH.obtainMessage(what, arg1, 0, arg2);
  }

  public Message obtainMessageIIO(int what, int arg1, int arg2, Object arg3) {
    return this.f997mH.obtainMessage(what, arg1, arg2, arg3);
  }
  ...
  public Message obtainMessageIIOO(int what, int arg1, int arg2, Object arg3, Object arg4) {
    ...
    args.arg1 = arg3;
    args.arg2 = arg4;
    return this.f997mH.obtainMessage(what, arg1, arg2, args);
  }
  ...
  public Message obtainMessageIOO(int what, int arg1, Object arg2, Object arg3) {
    ...
    args.arg1 = arg2;
    args.arg2 = arg3;
    return this.f997mH.obtainMessage(what, arg1, 0, args);
  }
  ...
  public Message obtainMessageOO(int what, Object arg1, Object arg2) {
    ...
    args.arg1 = arg1;
    args.arg2 = arg2;
    return this.f997mH.obtainMessage(what, 0, 0, args);
  }
