...
public interface IInputMethod extends IInterface {
  ...
  void hideSoftInput(IBinder iBinder, ImeTracker.Token token, int i, ResultReceiver resultReceiver)
      throws RemoteException;
  ...
  void showSoftInput(IBinder iBinder, ImeTracker.Token token, int i, ResultReceiver resultReceiver)
      throws RemoteException;
  ...
  public static class Default implements IInputMethod {
    ...
    public void startStylusHandwriting(
        int requestId, InputChannel channel, List<MotionEvent> events) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 2:
              ...
              IInlineSuggestionsRequestCallback _arg1 =
                  IInlineSuggestionsRequestCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
      ...
      try {
        ...
        this.privilegedOperations =
            IInputMethodPrivilegedOperations.Stub.asInterface(_aidl_parcel.readStrongBinder());
        if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
          if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
            throw new BadParcelableException("Overflow in the size of parcelable");
          }
        ...
        if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
          ...
          this.imeDispatcher =
              (ImeOnBackInvokedDispatcher)
                  _aidl_parcel.readTypedObject(ImeOnBackInvokedDispatcher.CREATOR);
          if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
            throw new BadParcelableException("Overflow in the size of parcelable");
          }
          _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
