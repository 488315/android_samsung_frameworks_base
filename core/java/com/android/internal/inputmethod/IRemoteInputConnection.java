    ...
    public abstract static class Stub extends Binder implements IRemoteInputConnection {
                ...
                case 4:
                    ...
                    ExtractedTextRequest _arg14 =
                            (ExtractedTextRequest)
                                    data.readTypedObject(ExtractedTextRequest.CREATOR);
                    int _arg24 = data.readInt();
                    AndroidFuture _arg33 =
                            (AndroidFuture) data.readTypedObject(AndroidFuture.CREATOR);
                    data.enforceNoDataAvail();
        ...
        private static class Proxy implements IRemoteInputConnection {
            ...
            public void commitCompletion(
                    InputConnectionCommandHeader header, CompletionInfo completion)
                    throws RemoteException {
                Parcel _data = Parcel.obtain(asBinder());
                try {
                    _data.writeInterfaceToken(IRemoteInputConnection.DESCRIPTOR);
            ...
            public void commitCorrection(
                    InputConnectionCommandHeader header, CorrectionInfo correction)
                    throws RemoteException {
                Parcel _data = Parcel.obtain(asBinder());
                try {
                    _data.writeInterfaceToken(IRemoteInputConnection.DESCRIPTOR);
