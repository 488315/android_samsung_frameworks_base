...
public interface IRemoteInputConnection extends IInterface {
  ...
  void beginBatchEdit(InputConnectionCommandHeader inputConnectionCommandHeader)
  ...
  void commitCompletion(
      InputConnectionCommandHeader inputConnectionCommandHeader, CompletionInfo completionInfo)
      throws RemoteException;
  ...
  void commitCorrection(
      InputConnectionCommandHeader inputConnectionCommandHeader, CorrectionInfo correctionInfo)
      throws RemoteException;

  void commitText(
      InputConnectionCommandHeader inputConnectionCommandHeader, CharSequence charSequence, int i)
      throws RemoteException;

  void commitTextWithTextAttribute(
      InputConnectionCommandHeader inputConnectionCommandHeader,
  ...
  void endBatchEdit(InputConnectionCommandHeader inputConnectionCommandHeader)
      throws RemoteException;

  void finishComposingText(InputConnectionCommandHeader inputConnectionCommandHeader)
      throws RemoteException;

  void forgetCancellationSignal(IBinder iBinder) throws RemoteException;

  void getCursorCapsMode(
      InputConnectionCommandHeader inputConnectionCommandHeader, int i, AndroidFuture androidFuture)
      throws RemoteException;
  ...
  void performHandwritingGesture(
      InputConnectionCommandHeader inputConnectionCommandHeader,
      ParcelableHandwritingGesture parcelableHandwritingGesture,
      ResultReceiver resultReceiver)
      throws RemoteException;

  void performPrivateCommand(
      InputConnectionCommandHeader inputConnectionCommandHeader, String str, Bundle bundle)
      throws RemoteException;

  void performSpellCheck(InputConnectionCommandHeader inputConnectionCommandHeader)
      throws RemoteException;
  ...
  void requestCursorUpdatesWithFilter(
      InputConnectionCommandHeader inputConnectionCommandHeader,
      int i,
      int i2,
      int i3,
  ...
  void setComposingRegion(InputConnectionCommandHeader inputConnectionCommandHeader, int i, int i2)
      throws RemoteException;

  void setComposingRegionWithTextAttribute(
      InputConnectionCommandHeader inputConnectionCommandHeader,
      int i,
      int i2,
      TextAttribute textAttribute)
  ...
  void setComposingTextWithTextAttribute(
      InputConnectionCommandHeader inputConnectionCommandHeader,
      CharSequence charSequence,
      int i,
      TextAttribute textAttribute)
  ...
  void setImeConsumesInput(InputConnectionCommandHeader inputConnectionCommandHeader, boolean z)
      throws RemoteException;
  ...
  public static class Default implements IRemoteInputConnection {
    ...
    public void getTextBeforeCursor(
        InputConnectionCommandHeader header, int length, int flags, AndroidFuture future)
        throws RemoteException {}
    ...
    @Override // com.android.internal.inputmethod.IRemoteInputConnection
    public void commitCompletion(InputConnectionCommandHeader header, CompletionInfo completion)
        throws RemoteException {}

    @Override // com.android.internal.inputmethod.IRemoteInputConnection
    public void commitCorrection(InputConnectionCommandHeader header, CorrectionInfo correction)
        throws RemoteException {}
    ...
    public void performPrivateCommand(
        InputConnectionCommandHeader header, String action, Bundle data) throws RemoteException {}

    @Override // com.android.internal.inputmethod.IRemoteInputConnection
    public void performHandwritingGesture(
        InputConnectionCommandHeader header,
        ParcelableHandwritingGesture gesture,
        ResultReceiver resultReceiver)
        throws RemoteException {}
    ...
    public void getSelectedText(
        InputConnectionCommandHeader header, int flags, AndroidFuture future)
        throws RemoteException {}
    ...
    public void requestTextBoundsInfo(
        InputConnectionCommandHeader header, RectF bounds, ResultReceiver resultReceiver)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IRemoteInputConnection {
          ...
          switch (code) {
            ...
            case 4:
              InputConnectionCommandHeader _arg04 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ExtractedTextRequest _arg14 =
                  (ExtractedTextRequest) data.readTypedObject(ExtractedTextRequest.CREATOR);
            ...
            case 9:
              ...
              return true;
            case 10:
              InputConnectionCommandHeader _arg010 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              CharSequence _arg19 =
                  (CharSequence) data.readTypedObject(TextUtils.CHAR_SEQUENCE_CREATOR);
              ...
              return true;
            case 11:
              InputConnectionCommandHeader _arg011 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 12:
              InputConnectionCommandHeader _arg012 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              CompletionInfo _arg111 =
                  (CompletionInfo) data.readTypedObject(CompletionInfo.CREATOR);
              data.enforceNoDataAvail();
              commitCompletion(_arg012, _arg111);
              return true;
            case 13:
              InputConnectionCommandHeader _arg013 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              CorrectionInfo _arg112 =
                  (CorrectionInfo) data.readTypedObject(CorrectionInfo.CREATOR);
              data.enforceNoDataAvail();
              commitCorrection(_arg013, _arg112);
              return true;
            case 14:
              InputConnectionCommandHeader _arg014 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 15:
              InputConnectionCommandHeader _arg015 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 16:
              InputConnectionCommandHeader _arg016 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 17:
              InputConnectionCommandHeader _arg017 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              data.enforceNoDataAvail();
              ...
              return true;
            case 18:
              InputConnectionCommandHeader _arg018 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              data.enforceNoDataAvail();
              ...
              return true;
            case 19:
              InputConnectionCommandHeader _arg019 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 20:
              InputConnectionCommandHeader _arg020 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 21:
              InputConnectionCommandHeader _arg021 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              data.enforceNoDataAvail();
              ...
              return true;
            case 22:
              InputConnectionCommandHeader _arg022 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 23:
              InputConnectionCommandHeader _arg023 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ParcelableHandwritingGesture _arg119 =
                  (ParcelableHandwritingGesture)
                      data.readTypedObject(ParcelableHandwritingGesture.CREATOR);
              ResultReceiver _arg213 =
                  (ResultReceiver) data.readTypedObject(ResultReceiver.CREATOR);
              data.enforceNoDataAvail();
              performHandwritingGesture(_arg023, _arg119, _arg213);
              return true;
            case 24:
              InputConnectionCommandHeader _arg024 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ParcelableHandwritingGesture _arg120 =
                  (ParcelableHandwritingGesture)
                      data.readTypedObject(ParcelableHandwritingGesture.CREATOR);
              ...
              return true;
            case 25:
              InputConnectionCommandHeader _arg025 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 26:
              InputConnectionCommandHeader _arg026 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 27:
              InputConnectionCommandHeader _arg027 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 28:
              InputConnectionCommandHeader _arg028 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 29:
              InputConnectionCommandHeader _arg029 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 30:
              InputConnectionCommandHeader _arg030 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              RectF _arg126 = (RectF) data.readTypedObject(RectF.CREATOR);
              ResultReceiver _arg220 =
                  (ResultReceiver) data.readTypedObject(ResultReceiver.CREATOR);
              data.enforceNoDataAvail();
              requestTextBoundsInfo(_arg030, _arg126, _arg220);
              return true;
            case 31:
              InputConnectionCommandHeader _arg031 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              InputContentInfo _arg127 =
                  (InputContentInfo) data.readTypedObject(InputContentInfo.CREATOR);
              ...
              return true;
            case 32:
              InputConnectionCommandHeader _arg032 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 33:
              InputConnectionCommandHeader _arg033 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              ...
              return true;
            case 34:
              InputConnectionCommandHeader _arg034 =
                  (InputConnectionCommandHeader)
                      data.readTypedObject(InputConnectionCommandHeader.CREATOR);
              int _arg130 = data.readInt();
              int _arg223 = data.readInt();
              CharSequence _arg311 =
                  (CharSequence) data.readTypedObject(TextUtils.CHAR_SEQUENCE_CREATOR);
