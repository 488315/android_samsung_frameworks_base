...
public interface IImeTracker extends IInterface {
  ...
  public static class Default implements IImeTracker {
    ...
    public ImeTracker.Token onRequestShow(String tag, int uid, int origin, int reason)
        throws RemoteException {
      return null;
    }

    @Override // com.android.internal.inputmethod.IImeTracker
    public ImeTracker.Token onRequestHide(String tag, int uid, int origin, int reason)
        throws RemoteException {
      return null;
    }
