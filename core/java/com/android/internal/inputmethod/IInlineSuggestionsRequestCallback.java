          ...
          switch (code) {
            ...
            case 2:
              InlineSuggestionsRequest _arg0 =
                  (InlineSuggestionsRequest) data.readTypedObject(InlineSuggestionsRequest.CREATOR);
              IInlineSuggestionsResponseCallback _arg1 =
                  IInlineSuggestionsResponseCallback.Stub.asInterface(data.readStrongBinder());
