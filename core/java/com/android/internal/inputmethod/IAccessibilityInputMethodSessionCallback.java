...
public interface IAccessibilityInputMethodSessionCallback extends IInterface {
    ...
    void sessionCreated(IAccessibilityInputMethodSession iAccessibilityInputMethodSession, int i)
    ...
    public abstract static class Stub extends Binder
            implements IAccessibilityInputMethodSessionCallback {
        ...
        public static IAccessibilityInputMethodSessionCallback asInterface(IBinder obj) {
            ...
            IInterface iin =
                    obj.queryLocalInterface(IAccessibilityInputMethodSessionCallback.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
            ...
            switch (code) {
                case 1:
                    IAccessibilityInputMethodSession _arg0 =
