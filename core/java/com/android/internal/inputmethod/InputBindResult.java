...
public final class InputBindResult implements Parcelable {
    ...
    public String toString() {
        return "InputBindResult{result=" + getResultString() + " method=" + this.method + " id=" + this.f684id + " sequence=" + this.sequence + " virtualDisplayToScreenMatrix=" + getVirtualDisplayToScreenMatrix() + " isInputMethodSuppressingSpellChecker=" + this.isInputMethodSuppressingSpellChecker + "}";
    }
