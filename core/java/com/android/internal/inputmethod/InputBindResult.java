...
public final class InputBindResult implements Parcelable {
  ...
  public static final Parcelable.Creator<InputBindResult> CREATOR =
      new Parcelable.Creator<
          InputBindResult>() { // from class: com.android.internal.inputmethod.InputBindResult.1
  ...
  public InputBindResult(
      ...
      String id,
      int sequence,
      Matrix virtualDisplayToScreenMatrix,
    ...
    if (n < 0) {
      ...
      while (n > 0) {
        ...
        IAccessibilityInputMethodSession value =
            IAccessibilityInputMethodSession.Stub.asInterface(source.readStrongBinder());
  ...
  public String toString() {
    return "InputBindResult{result="
        ...
        + " sequence="
        + this.sequence
        + " virtualDisplayToScreenMatrix="
        + getVirtualDisplayToScreenMatrix()
