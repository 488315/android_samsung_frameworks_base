...
public interface IMms extends IInterface {
  ...
  Uri importTextMessage(String str, String str2, int i, String str3, long j, boolean z, boolean z2)
      throws RemoteException;
  ...
  public static class Default implements IMms {
    ...
    public boolean updateStoredMessageStatus(
        String callingPkg, Uri messageUri, ContentValues statusValues) throws RemoteException {
      return false;
    }
        ...
        default:
          switch (code) {
            ...
            case 3:
              ...
              data.enforceNoDataAvail();
              Uri _result =
                  importTextMessage(_arg03, _arg13, _arg23, _arg33, _arg43, _arg53, _arg63);
              reply.writeNoException();
