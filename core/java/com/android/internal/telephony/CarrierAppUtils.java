...
public final class CarrierAppUtils {
  ...
  */
  public static void disableCarrierAppsUntilPrivileged(
    ...
    LegacyPermissionManager permissionManager2 =
        (LegacyPermissionManager) context.getSystemService(Context.LEGACY_PERMISSION_SERVICE);
    List<ApplicationInfo> candidates =
        getDefaultCarrierAppCandidatesHelper(userId, systemCarrierAppsDisabledUntilUsed, context);
    if (candidates != null && !candidates.isEmpty()) {
      Map<String, List<AssociatedAppInfo>> associatedApps2 =
          getDefaultCarrierAssociatedAppsHelper(
      ...
      int carrierAppsHandledSdk4 =
          Settings.Secure.getIntForUser(
              contentResolver2, Settings.Secure.CARRIER_APPS_HANDLED, 0, userId2);
      ...
      try {
            ...
            try {
              ...
              try {
                if (telephonyManager2 != null) {
                  try {
                    if (telephonyManager2.checkCarrierPrivilegesForPackageAnyPhone(packageName)
                        == 1) {
                      hasPrivileges = true;
                      ...
                      int enabledSetting =
                          context
                              .createContextAsUser(UserHandle.m55of(userId), 0)
                              .getPackageManager()
                      ...
                      if (hasPrivileges) {
                        ...
                        try {
                          if (!isUpdatedSystemApp(ai2)
                            ...
                            Log.m98i(
                                ...
                                "Update state ("
                                    + packageName
                                    + "): DISABLED_UNTIL_USED for user "
                                    + userId);
                            context
                                .createContextAsUser(UserHandle.m55of(userId), 0)
                                .getPackageManager()
                                .setSystemAppState(packageName, 3);
                          }
                          if (associatedAppList != null) {
                            for (AssociatedAppInfo associatedApp : associatedAppList) {
                              if (hasRunEver) {
                                ...
                                boolean associatedAppInstalled =
                                    (associatedApp.appInfo.flags & 8388608) == 0;
                                if (!allowDisable
                                    && associatedAppEnabledSetting == 0
                                  ...
                                  context
                                      .createContextAsUser(UserHandle.m55of(userId), 0)
                                      .getPackageManager()
                                      .setSystemAppState(associatedApp.appInfo.packageName, 3);
                                } else {
                                  i = 3;
                                }
                              ...
                              allowDisable = true;
                              int associatedAppEnabledSetting2 =
                                  context
                                      .createContextAsUser(UserHandle.m55of(userId), 0)
                                      .getPackageManager()
                                      .getApplicationEnabledSetting(
                        ...
                        try {
                          ...
                          if ((isUpdatedSystemApp(ai2) || enabledSetting != 0)
                              && enabledSetting != 4) {
                            try {
                          ...
                          Log.m98i(
                              TAG,
                              "Update state (" + packageName + "): ENABLED for user " + userId);
                          context
                              .createContextAsUser(UserHandle.m55of(userId), 0)
                              .getPackageManager()
                              .setSystemAppState(packageName, 2);
                          context
                              .createPackageContextAsUser(str3, 0, UserHandle.m55of(userId))
                              .getPackageManager()
                              .setApplicationEnabledSetting(packageName, 1, 1);
                          if (associatedAppList != null) {
                            ...
                            while (it3.hasNext()) {
                              ...
                              String str6 = str4;
                              int associatedAppEnabledSetting3 =
                                  context
                                      .createContextAsUser(UserHandle.m55of(userId), 0)
                                      .getPackageManager()
                                      .getApplicationEnabledSetting(
                                          associatedApp2.appInfo.packageName);
                              boolean associatedAppInstalled2 =
                                  (associatedApp2.appInfo.flags & 8388608) != 0;
                              try {
                                if (associatedAppEnabledSetting3 != 0) {
                                  carrierAppsHandledSdk2 = carrierAppsHandledSdk4;
                                  if (associatedAppEnabledSetting3 != 4
                                      && associatedAppInstalled2) {
                                    str2 = str5;
                                    it3 = it4;
                                    str4 = str6;
                                ...
                                context
                                    .createContextAsUser(UserHandle.m55of(userId), 0)
                                    .getPackageManager()
                                    .setSystemAppState(associatedApp2.appInfo.packageName, 2);
                                context
                                    .createPackageContextAsUser(str3, 0, UserHandle.m55of(userId))
                                    .getPackageManager()
                                    .setApplicationEnabledSetting(
                                        associatedApp2.appInfo.packageName, 1, 1);
                                it3 = it4;
                                str4 = str6;
                                carrierAppsHandledSdk4 = carrierAppsHandledSdk2;
                                str5 = str2;
        ...
        if (!hasRunEver || !hasRunForSdk) {
          ...
          try {
            Settings.Secure.putIntForUser(
                contentResolver, str7, Build.VERSION.SDK_INT, contentResolver.getUserId());
        ...
        try {
          permissionManager4.grantDefaultPermissionsToEnabledCarrierApps(
              packageNames,
              UserHandle.m55of(userId),
              TelephonyUtils.DIRECT_EXECUTOR,
