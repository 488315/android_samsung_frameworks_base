...
public class Sms7BitEncodingTranslator {
  ...
  public static String translate(CharSequence message, boolean isCdmaFormat) {
    ...
    if ((sparseIntArray3 == null || sparseIntArray3.size() <= 0)
        && (((sparseIntArray = mTranslationTableGSM) == null || sparseIntArray.size() <= 0)
            && ((sparseIntArray2 = mTranslationTableCDMA) == null
                || sparseIntArray2.size() <= 0))) {
      return null;
    }
  ...
  private static char translateIfNeeded(char c, boolean isCdmaFormat) {
    ...
    if (DBG) {
      Rlog.m246w(
          TAG,
          "No translation found for " + Integer.toHexString(c) + "! Replacing for empty space");
      return ' ';
    }
    return ' ';
  }
