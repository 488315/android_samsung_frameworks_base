    ...
    public void parseSms() {
        ...
        if (SmsManager.getDefault().getSmsSetting(SmsConstants.SMS_SUPPORT_REPLY_ADDRESS)) {
            if (this.mBearerData.callbackNumber != null) {
                ...
                Rlog.m240e(LOG_TAG, "SMS CALL BACK NUMBER: getDisplayOriginatingAddress(): " + getDisplayOriginatingAddress());
            } else {
                this.replyAddress = null;
                Rlog.m240e(LOG_TAG, "SMS CALL BACK NUMBER: null  getDisplayOriginatingAddress(): " + getDisplayOriginatingAddress());
            }
        }
        ...
        if (this.mBearerData.messageType == 4) {
            if (!this.mBearerData.messageStatusSet) {
                Rlog.m238d(LOG_TAG, "DELIVERY_ACK message without msgStatus (" + (this.mUserData == null ? "also missing" : "does have") + " userData).");
                this.status = 2;
            } else {
