...
public class ExponentialBackoff {
  ...
  public ExponentialBackoff(
      long initialDelayMs, long maximumDelayMs, int multiplier, Looper looper, Runnable runnable) {
  ...
  public ExponentialBackoff(
    ...
    this.mHandlerAdapter =
        new HandlerAdapter() { // from class: com.android.internal.telephony.ExponentialBackoff.1
  ...
  public void notifyFailed() {
    ...
    long temp =
        Math.min(this.mMaximumDelayMs, (long) (this.mStartDelayMs * Math.pow(this.mMultiplier, i)));
