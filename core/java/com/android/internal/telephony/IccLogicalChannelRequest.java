...
public class IccLogicalChannelRequest implements Parcelable {
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.subId), Integer.valueOf(that.subId))
        && Objects.deepEquals(Integer.valueOf(this.slotIndex), Integer.valueOf(that.slotIndex))
        && Objects.deepEquals(Integer.valueOf(this.portIndex), Integer.valueOf(that.portIndex))
        && Objects.deepEquals(this.callingPackage, that.callingPackage)
        && Objects.deepEquals(this.aid, that.aid)
        && Objects.deepEquals(Integer.valueOf(this.f1005p2), Integer.valueOf(that.f1005p2))
