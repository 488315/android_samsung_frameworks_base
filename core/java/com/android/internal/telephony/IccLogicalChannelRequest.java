...
public class IccLogicalChannelRequest implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.f1005p2);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.f1005p2 = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(Integer.valueOf(this.subId), Integer.valueOf(that.subId)) && Objects.deepEquals(Integer.valueOf(this.slotIndex), Integer.valueOf(that.slotIndex)) && Objects.deepEquals(Integer.valueOf(this.portIndex), Integer.valueOf(that.portIndex)) && Objects.deepEquals(this.callingPackage, that.callingPackage) && Objects.deepEquals(this.aid, that.aid) && Objects.deepEquals(Integer.valueOf(this.f1005p2), Integer.valueOf(that.f1005p2)) && Objects.deepEquals(Integer.valueOf(this.channel), Integer.valueOf(that.channel)) && Objects.deepEquals(this.binder, that.binder)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(Integer.valueOf(this.subId), Integer.valueOf(this.slotIndex), Integer.valueOf(this.portIndex), this.callingPackage, this.aid, Integer.valueOf(this.f1005p2), Integer.valueOf(this.channel), this.binder).toArray());
    }
