...
public interface ISub extends IInterface {
  ...
  List<SubscriptionInfo> getActiveSubscriptionInfoList(String str, String str2)
      throws RemoteException;
  ...
  public static class Default implements ISub {
    ...
    public List<SubscriptionInfo> getAllSubInfoList(String callingPackage, String callingFeatureId)
        throws RemoteException {
      return null;
    }
    ...
    public SubscriptionInfo getActiveSubscriptionInfoForIccId(
        String iccId, String callingPackage, String callingFeatureId) throws RemoteException {
      return null;
    }
    ...
    public void removeSubscriptionsFromGroup(
        int[] subIdList, ParcelUuid groupUuid, String callingPackage) throws RemoteException {}
    ...
    public void setPhoneNumber(
        int subId, int source, String number, String callingPackage, String callingFeatureId)
        throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 19:
              ...
              ISetOpportunisticDataCallback _arg27 =
