...
public class PhoneConstantConversions {
  public static int convertCallState(PhoneConstants.State state) {
    switch (C46721.$SwitchMap$com$android$internal$telephony$PhoneConstants$State[
        state.ordinal()]) {
      case 1:
        return 1;
      case 2:
  ...
  static /* synthetic */ class C46721 {

    /* renamed from: $SwitchMap$com$android$internal$telephony$PhoneConstants$DataState */
    static final /* synthetic */ int[] f1006x67a69abf;
    static final /* synthetic */ int[]
        $SwitchMap$com$android$internal$telephony$PhoneConstants$State;
    ...
    static {
      ...
      try {
        f1006x67a69abf[PhoneConstants.DataState.CONNECTED.ordinal()] = 2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        f1006x67a69abf[PhoneConstants.DataState.SUSPENDED.ordinal()] = 3;
      } catch (NoSuchFieldError e3) {
      }
      try {
        f1006x67a69abf[PhoneConstants.DataState.DISCONNECTING.ordinal()] = 4;
      ...
      try {
        $SwitchMap$com$android$internal$telephony$PhoneConstants$State[
                PhoneConstants.State.OFFHOOK.ordinal()] =
            2;
  ...
  public static int convertDataState(PhoneConstants.DataState state) {
    switch (C46721.f1006x67a69abf[state.ordinal()]) {
      case 1:
        return 1;
      case 2:
        return 2;
