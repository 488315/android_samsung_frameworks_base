...
public class SmsHeader {
  ...
  public static SmsHeader semFromByteArray(int subId, byte[] data) {
    String mnoName =
        SmsManager.getSmsManagerForContextAndSubscriptionId(null, subId).getMnoName().toUpperCase();
    ...
    while (inStream.available() > 0) {
      ...
      switch (id) {
        ...
        case 68:
          ...
          Rlog.m81i(
              "SmsHeader",
              "id:" + ktReadConfirm.f1007id + "readConfirmID" + ktReadConfirm.readConfirmID);
          continue;
        case 192:
          if (!mnoName.contains("SKT_KR")
            ...
            if (!SemCscFeature.getInstance()
              ...
              Rlog.m81i(
                  "TwoPhoneIndication",
                  "Received smsHeader.twoPhoneIndication: " + smsHeader.twoPhoneIndication);
              break;
            }
          }
          break;
