          ...
          switch (code) {
            ...
            case 4:
              ITransportSelectorResultCallback _arg03 =
                  ITransportSelectorResultCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
    ...
    private static class Proxy implements ITransportSelectorCallback {
      ...
      public IWwanSelectorCallback onWwanSelected() throws RemoteException {
        ...
        try {
          ...
          IWwanSelectorCallback _result =
              IWwanSelectorCallback.Stub.asInterface(_reply.readStrongBinder());
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
