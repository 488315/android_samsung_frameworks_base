...
public class SmsCbHeader {
    ...
    private static final String[] LANGUAGE_CODES_GROUP_2 = {new Locale("cs").getLanguage(), new Locale("he").getLanguage(), new Locale("ar").getLanguage(), new Locale("ru").getLanguage(), new Locale(SemImsProfile.ImsFeature.f3008IS).getLanguage(), null, null, null, null, null, null, null, null, null, null, null};
