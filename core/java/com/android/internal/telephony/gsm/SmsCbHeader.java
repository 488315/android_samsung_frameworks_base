...
public class SmsCbHeader {
  ...
  private static final String[] LANGUAGE_CODES_GROUP_2 = {
    ...
    new Locale(SemImsProfile.ImsFeature.f3008IS).getLanguage(),
    null,
    null,
    null,
    null,
  ...
  public SmsCbHeader(byte[] pdu) throws IllegalArgumentException {
    ...
    if (pdu.length <= 88) {
      ...
      if (isEtwsMessage() && pdu.length <= 56) {
        ...
        this.mEtwsInfo =
            new SmsCbEtwsInfo(
                warningType, emergencyUserAlert, activatePopup, true, warningSecurityInfo);
        this.mCmasInfo = null;
        return;
      }
      this.mFormat = 1;
    ...
    if (isEtwsMessage()) {
      ...
      this.mEtwsInfo =
          new SmsCbEtwsInfo(warningType2, emergencyUserAlert2, activatePopup2, false, null);
      this.mCmasInfo = null;
      return;
    }
    if (isCmasMessage()) {
