...
public interface IEuiccCardController extends IInterface {
  ...
  void cancelSession(
      String str, String str2, byte[] bArr, int i, ICancelSessionCallback iCancelSessionCallback)
      throws RemoteException;
  ...
  void retrieveNotification(
      String str, String str2, int i, IRetrieveNotificationCallback iRetrieveNotificationCallback)
      throws RemoteException;
  ...
  void setNickname(
      String str, String str2, String str3, String str4, ISetNicknameCallback iSetNicknameCallback)
      throws RemoteException;
  ...
  public static class Default implements IEuiccCardController {
    ...
    public void listNotifications(
        String callingPackage, String cardId, int events, IListNotificationsCallback callback)
        throws RemoteException {}
    ...
    public void retrieveNotification(
        String callingPackage, String cardId, int seqNumber, IRetrieveNotificationCallback callback)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 9:
              ...
              IGetDefaultSmdpAddressCallback _arg29 =
                  IGetDefaultSmdpAddressCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 11:
              ...
              ISetDefaultSmdpAddressCallback _arg38 =
                  ISetDefaultSmdpAddressCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 18:
              ...
              ILoadBoundProfilePackageCallback _arg311 =
                  ILoadBoundProfilePackageCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 21:
              ...
              IRetrieveNotificationListCallback _arg314 =
                  IRetrieveNotificationListCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 23:
              ...
              IRemoveNotificationFromListCallback _arg316 =
                  IRemoveNotificationFromListCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
