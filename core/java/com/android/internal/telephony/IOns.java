...
public interface IOns extends IInterface {
  ...
  void setPreferredDataSubscriptionId(
      int i, boolean z, ISetOpportunisticDataCallback iSetOpportunisticDataCallback, String str)
          ...
          switch (code) {
            ...
            case 5:
              ...
              IUpdateAvailableNetworksCallback _arg14 =
                  IUpdateAvailableNetworksCallback.Stub.asInterface(data.readStrongBinder());
