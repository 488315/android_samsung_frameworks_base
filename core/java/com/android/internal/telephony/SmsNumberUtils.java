    ...
    */
    ...
    public static String filterDestAddr(Context context, int subId, String destAddr) {
        ...
        if (destAddr == null || !PhoneNumberUtils.isGlobalPhoneNumber(destAddr)) {
            Log.m102w(TAG, "destAddr" + pii(TAG, destAddr) + " is not a global phone number! Nothing changed.");
            return destAddr;
        }
        ...
        if (z) {
            ...
            Log.m94d(TAG, "leave filterDestAddr, new destAddr=\"" + (result != null ? pii(TAG, result) : pii(TAG, destAddr)) + "\"");
        }
