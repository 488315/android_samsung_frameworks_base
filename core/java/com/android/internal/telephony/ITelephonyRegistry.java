...
public interface ITelephonyRegistry extends IInterface {
  ...
  void notifyDataConnectionForSubscriber(
      int i, int i2, PreciseDataConnectionState preciseDataConnectionState) throws RemoteException;
  ...
  void notifyPreciseCallState(int i, int i2, int[] iArr, String[] strArr, int[] iArr2, int[] iArr3)
      throws RemoteException;
  ...
  void removeCarrierConfigChangeListener(
      ICarrierConfigChangeListener iCarrierConfigChangeListener, String str) throws RemoteException;

  void removeCarrierPrivilegesCallback(
      ICarrierPrivilegesCallback iCarrierPrivilegesCallback, String str) throws RemoteException;
  ...
  public static class Default implements ITelephonyRegistry {
    ...
    public void notifyDataConnectionForSubscriber(
        int phoneId, int subId, PreciseDataConnectionState preciseState) throws RemoteException {}
    ...
    public void notifySimActivationStateChangedForPhoneId(
        int phoneId, int subId, int activationState, int activationType) throws RemoteException {}
    ...
    public void notifyPhysicalChannelConfigForSubscriber(
        int phoneId, int subId, List<PhysicalChannelConfig> configs) throws RemoteException {}
    ...
    public void notifyAllowedNetworkTypesChanged(
        int phoneId, int subId, int reason, long allowedNetworkType) throws RemoteException {}
    ...
    @Override // com.android.internal.telephony.ITelephonyRegistry
    public void removeCarrierConfigChangeListener(ICarrierConfigChangeListener listener, String pkg)
        throws RemoteException {}

    @Override // com.android.internal.telephony.ITelephonyRegistry
    public void notifyCarrierConfigChanged(
        int phoneId, int subId, int carrierId, int specificCarrierId) throws RemoteException {}
          ...
          switch (code) {
            case 1:
              ...
              IOnSubscriptionsChangedListener _arg2 =
                  IOnSubscriptionsChangedListener.Stub.asInterface(data.readStrongBinder());
            ...
            case 14:
              ...
              PreciseDataConnectionState _arg28 =
            ...
            case 28:
              ...
              TelephonyDisplayInfo _arg214 =
                  (TelephonyDisplayInfo) data.readTypedObject(TelephonyDisplayInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 40:
              ...
              List<PhysicalChannelConfig> _arg222 =
            ...
            case 43:
              ...
              List<LinkCapacityEstimate> _arg225 =
            ...
            case 44:
              ...
              ICarrierPrivilegesCallback _arg136 =
              ...
              return true;
            case 45:
              ICarrierPrivilegesCallback _arg043 =
                  ICarrierPrivilegesCallback.Stub.asInterface(data.readStrongBinder());
            ...
            case 47:
              ...
              return true;
            case 48:
              ICarrierConfigChangeListener _arg046 =
