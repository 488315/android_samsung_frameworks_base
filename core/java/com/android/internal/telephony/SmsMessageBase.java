...
public abstract class SmsMessageBase {
    ...
    */
    public static int findNextUnicodePosition(int currentPosition, int byteLimit, CharSequence msgBody) {
        ...
        Rlog.m77d(LOG_TAG, "currentPosition = " + currentPosition + " byteLimit= " + byteLimit + " msgBody.length()= " + msgBody.length());
        ...
        if (octets > 140) {
            ...
            while (pos < msgBody.length()) {
                ...
                if (nextPos <= pos || nextPos > msgBody.length()) {
                    Log.m96e(LOG_TAG, "findNextUnicodePosition() isn`t working.(" + pos + " >= " + nextPos + " or " + nextPos + " >= " + msgBody.length() + NavigationBarInflaterView.KEY_CODE_END);
