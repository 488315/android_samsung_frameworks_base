...
public abstract class CoreFlags {
    ...
    public static BooleanFlag BOOL_FLAG =
            booleanFlag(ContainerProxy.CATEGORY_CORE, "bool_flag", false);
    ...
    public static DynamicBooleanFlag DYN_FLAG =
            dynamicBooleanFlag(ContainerProxy.CATEGORY_CORE, "dyn_flag", true);
