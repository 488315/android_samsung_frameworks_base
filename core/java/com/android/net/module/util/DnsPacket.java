...
public abstract class DnsPacket {
  ...
  public static class DnsHeader {
    ...
    public DnsHeader(int id, int flags, int qdcount, int ancount) {
      this.mId = id;
      this.mFlags = flags;
      this.mRecordCount = new int[] {qdcount, ancount, 0, 0};
    }
  ...
  public static class DnsRecord {
    ...
    public static DnsRecord makeAOrAAAARecord(
        int rType, String dName, int nsClass, long ttl, InetAddress address) throws IOException {
    ...
    public static DnsRecord makeCNameRecord(
        int rType, String dName, int nsClass, long ttl, String domainName) throws IOException {
  ...
  protected DnsPacket(DnsHeader header, List<DnsRecord> qd, List<DnsRecord> an) {
    ...
    this.mRecords =
        new List[] {
          Collections.unmodifiableList(new ArrayList(qd)),
          Collections.unmodifiableList(new ArrayList(an)),
          new ArrayList(),
          new ArrayList()
        };
    for (int i = 0; i < 4; i++) {
