...
public class FMRadioService extends IFMPlayer.Stub {
  ...
  static {
    ...
    isFactoryBinary =
        "factory".equalsIgnoreCase(SystemProperties.get("ro.factory.factory_binary", "Unknown"));
    curFreq = -1L;
  ...
  public void handleAvrcpMode() {
    ...
    boolean z =
        Settings.Secure.getInt(this.mContext.getContentResolver(), "bluetooth_avc_mode", 1) == 1;
    this.mAvrcpMode = z;
    if (type == 8) {
  ...
  private class AudioFocusHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        ...
        case 1:
          FMRadioService.log(
              "mAudioFocusHandler:Fired  TIME = " + (SystemClock.uptimeMillis() / 1000));
  ...
  private void registerBikeModeObserver() {
    ...
    this.mContext
        ...
        .registerContentObserver(
            Settings.Secure.getUriFor(AudioConstants.SETTING_BIKE_MODE), false, this.bmObserver);
    this.mBikeMode =
        Settings.Secure.getInt(
                this.mContext.getContentResolver(), AudioConstants.SETTING_BIKE_MODE, 0)
            == 1;
  }
  ...
  private void registerAvrcpModeObserver() {
    ...
    this.mContext
        .getContentResolver()
        .registerContentObserver(
            Settings.Secure.getUriFor("bluetooth_avc_mode"), false, this.mAvrcpObserver);
    this.mAvrcpMode =
        Settings.Secure.getInt(this.mContext.getContentResolver(), "bluetooth_avc_mode", 1) == 1;
  }
    ...
    if ("".equals(FMRadioServiceFeature.FEATURE_SETLOCALTUNNING)) {
      if (FMRadioServiceFeature.CHIP_VENDOR == 4 || FMRadioServiceFeature.CHIP_VENDOR == 9) {
        this.mSnr_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_COMMON_SNR"));
        ...
        this.mgoodChrmssi_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_QUALCOMM_GOODCH_RMSSITH"));
        return;
      }
      if (FMRadioServiceFeature.CHIP_VENDOR == 5 || FMRadioServiceFeature.CHIP_VENDOR == 10) {
        this.mRssi_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_COMMON_RSSI"));
        this.mRichwave_seekDC =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_RICHWAVE_SEEK_DC"));
        this.mRichwave_seekQA =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_RICHWAVE_SEEK_QA"));
        return;
      }
      if (FMRadioServiceFeature.CHIP_VENDOR == 6) {
        ...
        this.mFreqOffset_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_SPRD_FREQ_OFFSET"));
        this.mNoisePwr_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_SPRD_NOISE_PWR"));
        this.mPilotPwr_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_SPRD_PILOT_PWR"));
        return;
      }
      if (FMRadioServiceFeature.CHIP_VENDOR == 7) {
        ...
        this.mSlsi_ifcount1 =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_SLSI_IFCOUNT1"));
        this.mSlsi_ifcount2 =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_SLSI_IFCOUNT2"));
        this.mSlsi_blendcoeff =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_SLSI_BLENDCOEF"));
      ...
      if (FMRadioServiceFeature.CHIP_VENDOR == 8) {
        String tempMtkChipVolume =
            SemFloatingFeature.getInstance()
                .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_MEDIATEK_CHIPVOLUME");
        ...
        this.mMtk_seeksmg =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_MEDIATEK_SEEKSMG"));
        this.mMtk_seekdesenserssi =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_MEDIATEK_SEEKDESENSERSSI"));
        this.mSoftmute_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_COMMON_SOFTMUTE_TH"));
        this.mMtk_blendrssi_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_MEDIATEK_BLENDRSSI_TH"));
        this.mMtk_blendpamd_th =
            Integer.parseInt(
                SemFloatingFeature.getInstance()
                    .getString("SEC_FLOATING_FEATURE_FMRADIO_CONFIG_MEDIATEK_BLENDPAMD_TH"));
        return;
      }
      return;
    }
  ...
  public FMRadioService(Context context) {
    ...
    this.mAvrcpObserver =
        new ContentObserver(
            new Handler(
                Looper.getMainLooper())) { // from class: com.android.server.FMRadioService.1
              ...
              if (stream == AudioManager.semGetStreamType(1)
                ...
                if (!FMRadioService.this.volumeLock) {
                  ...
                  if (volume == current_stream_volume && !FMRadioService.this.isDNDEnable()) {
                    ...
                    fMRadioService.mAvrcpMode =
                        Settings.Secure.getInt(
                                fMRadioService.mContext.getContentResolver(),
                                "bluetooth_avc_mode",
                                1)
                            == 1;
          ...
          public void onReceive(Context context2, Intent intent) {
                ...
                if (FMRadioService.this.mIsOn) {
                  ...
                  fMRadioService.mBikeMode =
                      Settings.Secure.getInt(
                          ...
                          == 1;
                  FMRadioService.log(
                      "mReceiver: bike mode check : " + FMRadioService.this.mBikeMode);
            ...
            if (intent.getAction().equals("android.intent.action.HEADSET_PLUG")
              ...
              if (intent.hasExtra("portName")
                ...
                FMRadioService.log(
                    "Not 3.5pi type, and audio not support play FM Radio via usb type c");
                return;
              }
              ...
              fMRadioService2.mIsHeadsetPlugged =
                  fMRadioService2.mIsMicrophoneConnected
              ...
              if (!FMRadioService.this.mIsHeadsetPlugged) {
                int tvstatus =
                    Settings.System.getInt(
                        FMRadioService.this.mContext.getContentResolver(), "tv_out", 0);
                ...
                fMRadioService3.mBikeMode =
                    Settings.Secure.getInt(
                            fMRadioService3.mContext.getContentResolver(),
                            AudioConstants.SETTING_BIKE_MODE,
                            0)
                        == 1;
            ...
            if (intent.getAction().equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
              ...
              fMRadioService4.mAirPlaneEnabled =
                  Settings.Global.getInt(
                          fMRadioService4.mContext.getContentResolver(), "airplane_mode_on", 0)
                      != 0;
    ...
    this.mPhoneListener =
        new PhoneStateListener(
            null, Looper.getMainLooper()) { // from class: com.android.server.FMRadioService.6
          ...
          public void onCallStateChanged(int state, String incomingNumber) {
            FMRadioService.log(
                "phone state : "
                    + state
                    + " mNeedToResumeFM: "
                    + FMRadioService.mNeedToResumeFM
                    + " mIsPhoneCallRinging : "
            ...
            switch (state) {
              case 0:
                if (FMRadioService.mNeedToResumeFM
                  ...
                  if (FMRadioService.this.m233on(false)) {
                    ...
                    FMRadioService.log(
                        "onCallStateChanged() :: CALL_STATE_IDLE setPath() = " + outputPath);
                    ...
                    if (FMRadioService.mIsTransientPaused) {
                      FMRadioService.this.mResumeVol =
                          r3.mAudioManager.getStreamVolume(AudioManager.semGetStreamType(1));
                      FMRadioService.log(
                          "slowly increase the volume till :" + FMRadioService.this.mResumeVol);
    ...
    this.mAudioFocusListener =
        new AudioManager
            .OnAudioFocusChangeListener() { // from class: com.android.server.FMRadioService.8
    ...
    this.mSystemReceiver1 =
        new BroadcastReceiver() { // from class: com.android.server.FMRadioService.10
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            String action = intent.getAction();
    ...
    this.bmObserver =
        new ContentObserver(
            new Handler(
                Looper.getMainLooper())) { // from class: com.android.server.FMRadioService.17
          @Override // android.database.ContentObserver
          public void onChange(boolean selfChange) {
            super.onChange(selfChange);
    ...
    this.mAirPlaneEnabled =
        Settings.Global.getInt(this.mContext.getContentResolver(), "airplane_mode_on", 0) != 0;
  ...
  private void registerSetPropertyListener() {
    ...
    this.mContext.registerReceiver(
        this.mSetPropertyReceiver, intentFilterSetProperty, this.SetPropertyPermission, null);
  ...
  */
  public synchronized boolean on_in_testmode() {
    if (!isFactoryBinary) {
      log(
          "on_in_testmode is called with normal binary. This function is only for Factory binary."
              + " So just return");
      return false;
    }
    try {
  ...
  public synchronized boolean m233on(boolean isAudioFocusNeeded) {
    ...
    if (this.SURVEY_MODE_ENABLE) {
      ...
      if (!"com.sec.android.app.fm".equals(mPackageName)) {
        try {
          mPackageVersion =
              this.mContext.getPackageManager().getPackageInfo(mPackageName, 0).versionName;
        } catch (PackageManager.NameNotFoundException e) {
          Log.m96e("FMRadioService", "NameNotFoundException: " + e);
        }
        SamsungAnalyticsRunnable samsungAnalyticsRunnable =
            new SamsungAnalyticsRunnable(mPackageName, mPackageVersion);
    ...
    if (this.mIsHeadsetPlugged && !this.mOnProgress) {
      ...
      try {
        if ((this.mTelephonyManager.getCallStateForSubscription() == 1 && !isDNDEnable())
            || this.mTelephonyManager.getCallStateForSubscription() == 2) {
          if (mIsTransientPaused) {
      ...
      if (!isFmTestApp() && !isCTSTestApp()) {
        ...
        AudioAttributes attributes =
            new AudioAttributes.Builder()
                .setLegacyStreamType(AudioManager.semGetStreamType(1))
                .semAddAudioTag("FM_RADIO")
                .semAddAudioTag("NO_FADEOUT_FROM_AUDIOFOCUS")
                .build();
        AudioFocusRequest audioFocusRequest =
            new AudioFocusRequest.Builder(1)
                .setAudioAttributes(attributes)
                .setOnAudioFocusChangeListener(this.mAudioFocusListener)
                .build();
        ...
        if (this.mIsExternalChipset) {
          if (FMRadioServiceFeature.CHIP_VENDOR == 9) {
            if (this.mPlayerNative.preInitialize() > 0) {
              ...
              if (DEBUGGABLE) {
                log(
                    "OnAudioFocusChangeListener switch on mNeedResumeToFreq:"
                        + this.mNeedResumeToFreq
                        + "setOutputPath = "
                        + outputPath);
              } else {
          ...
          if (FMRadioServiceFeature.CHIP_VENDOR == 4 || FMRadioServiceFeature.CHIP_VENDOR == 9) {
            if (this.mIsSupportSoftmute
                && isPathSupportSoftmute(this.mAudioManager.semGetRadioOutputPath())) {
          ...
          if (FMRadioServiceFeature.CHIP_VENDOR != 4 && FMRadioServiceFeature.CHIP_VENDOR != 9) {
            if (FMRadioServiceFeature.CHIP_VENDOR != 5 && FMRadioServiceFeature.CHIP_VENDOR != 10) {
              ...
              if (z != this.mIsSetWakeKey && inputManager != null) {
                try {
                  inputManager.semSetWakeKeyDynamically(
                      "com.sec.android.app.fm", z, VOLUME_UP_DOWN);
              ...
              if (data != null) {
                ...
                this.mListeners
                    ...
                    .onRadioDataSystemReceived(
                        rdsData.mFreq, rdsData.mChannelName, rdsData.mRadioText);
                continue;
              } else {
      ...
      default:
        if (FMRadioServiceFeature.CHIP_VENDOR == 5 || FMRadioServiceFeature.CHIP_VENDOR == 10) {
          ...
          switch (z) {
            ...
            default:
              log(
                  "setIntegerTunningParameter() : invalid parameterName - "
                      + parameterName
                      + " for chip vendor - "
                      + FMRadioServiceFeature.CHIP_VENDOR);
              break;
          }
        } else {
          char c = '\t';
          if (FMRadioServiceFeature.CHIP_VENDOR == 4 || FMRadioServiceFeature.CHIP_VENDOR == 9) {
            ...
            log(
                "setIntegerTunningParameter() : this parameter is not support yet - "
                    + parameterName
                    + " chipvendor - "
                    + FMRadioServiceFeature.CHIP_VENDOR);
            break;
        ...
        default:
          if (FMRadioServiceFeature.CHIP_VENDOR == 5 || FMRadioServiceFeature.CHIP_VENDOR == 10) {
            ...
            switch (z) {
              ...
              default:
                log(
                    "getIntegerTunningParameter() : invalid parameterName - "
                        + parameterName
                        + " for chip vendor - "
                        + FMRadioServiceFeature.CHIP_VENDOR);
                break;
            ...
            log(
                "getIntegerTunningParameter() : this parameter is not support yet - "
                    + parameterName
                    + " chipvendor - "
                    + FMRadioServiceFeature.CHIP_VENDOR);
          }
  ...
  */
  public void setLongTunningParameter(String parameterName, long value) {
    ...
    switch (parameterName) {
      ...
      default:
        log(
            "setLongTunningParameter() : invalid parameterName - "
                + parameterName
                + " for chip vendor - "
                + FMRadioServiceFeature.CHIP_VENDOR);
        break;
  ...
  */
  public long getLongTunningParameter(String parameterName, long defaultValue) {
    ...
    switch (parameterName) {
      ...
      default:
        log(
            "getLongTunningParameter() : invalid parameterName - "
                + parameterName
                + " for chip vendor - "
                + FMRadioServiceFeature.CHIP_VENDOR);
        if (FMRadioServiceFeature.CHIP_VENDOR == 7) {
  ...
  public void setStringTunningParameter(String parameterName, String value) {
    ...
    if (FMRadioServiceFeature.CHIP_VENDOR == 4 || FMRadioServiceFeature.CHIP_VENDOR == 9) {
      ...
      switch (z) {
        ...
        default:
          log(
              "setStringTunningParameter() : invalid parameterName - "
                  + parameterName
                  + " for chip vendor - "
                  + FMRadioServiceFeature.CHIP_VENDOR);
          break;
    ...
    log(
        "setStringTunningParameter() : this parameter is not support yet - "
            + parameterName
            + " chipvendor - "
            + FMRadioServiceFeature.CHIP_VENDOR);
  }
  ...
  */
  public String getStringTunningParameter(String parameterName, String defaultValue) {
    ...
    if (FMRadioServiceFeature.CHIP_VENDOR == 4 || FMRadioServiceFeature.CHIP_VENDOR == 9) {
      ...
      switch (z) {
        ...
        default:
          log(
              "getStringTunningParameter() : invalid parameterName - "
                  + parameterName
                  + " for chipvendor - "
                  + FMRadioServiceFeature.CHIP_VENDOR);
          break;
      ...
      log(
          "getStringTunningParameter() : this parameter is not support yet - "
              + parameterName
              + " chipvendor - "
              + FMRadioServiceFeature.CHIP_VENDOR);
    }
    ...
    */
    public void run() {
      PowerManager.WakeLock wakelock =
          FMRadioService.this.mPowerManager.newWakeLock(536870913, "FMRadio Service Scan Thread");
      wakelock.acquire();
      ...
      try {
        try {
          ...
          if (FMRadioService.this.mIsSkipTunigVal && !FMRadioService.this.mIsExternalChipset) {
            FMRadioService fMRadioService2 = FMRadioService.this;
            fMRadioService2.setSignalSetting(
                fMRadioService2.mRssi_th, FMRadioService.this.mSnr_th, FMRadioService.this.mCnt_th);
            FMRadioService.log(
                "first scan no block channel with "
                    + FMRadioService.this.mRssi_th
                    + FMRadioService.this.mSnr_th
                    + FMRadioService.this.mCnt_th);
          }
          if (!FMRadioService.this.mIsExternalChipset) {
            doScan();
  ...
  public boolean isDNDEnable() {
    boolean dndOn =
        Settings.Global.getInt(this.mContext.getContentResolver(), Settings.Global.ZEN_MODE, 0)
            == 1;
