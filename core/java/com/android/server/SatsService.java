...
public final class SatsService extends ISatsService.Stub {
                            ...
                            if ("uart3".equalsIgnoreCase(switchName)) {
                                ...
                                switch (state) {
                                    ...
                                    case 1:
                                        ...
                                        break;
                                    default:
                                        Slog.m115e(SatsService.TAG, "Unknown state[" + state + NavigationBarInflaterView.SIZE_MOD_END);
                                        break;
                                }
                            }
                        } catch (Exception e) {
    ...
    public final class AtCmdHandler implements Runnable {
        ...
        public void selectTarget(int connectTarget) {
            switch (connectTarget) {
                ...
                case 1:
                    ...
                    break;
                default:
                    Slog.m115e(UART_SOCKET_NAME, "Invalid target : [" + connectTarget + NavigationBarInflaterView.SIZE_MOD_END);
                    break;
            }
        }
        ...
        private boolean isValidCommand(String cmd) {
            ...
            Slog.m117i(this.THREAD_TAG, "isValidCommand: cmd is [" + cmd + NavigationBarInflaterView.SIZE_MOD_END);
            try {
        ...
        private String executeEmAtCommand(String cmd) {
            ...
            for (String testParam : testParams) {
                if (parameter.equals(testParam)) {
                    Slog.m117i(this.THREAD_TAG, "executeEmAtCommand: test command(" + testParam + NavigationBarInflaterView.KEY_CODE_END);
    ...
    public String executePseudoDrkAtCommnd(String cmd) {
        ...
        try {
            ...
            Slog.m115e(TAG, "Permission denied : Name = [" + callerName + "], UID = [" + callerUid + NavigationBarInflaterView.SIZE_MOD_END);
            String str3 = "\r\n\r\n\r\nOK\r\n";
    ...
    private final class EngModesCmdHelper {
        ...
        private byte[] proceedlCmd(Context context, String param, int fixedParamLen) {
            ...
            if (!appendData(sequenceNo, param.substring(fixedParamLen + 3, param.length()).trim())) {
                Slog.m115e(SatsService.TAG, "Failed to append command SN-" + sequenceNo + " EN-" + (getDataIndex() + 1));
