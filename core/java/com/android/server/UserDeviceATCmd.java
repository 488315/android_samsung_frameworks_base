    ...
    try {
      ...
      if (supportedParams[1].equals(cmd.substring(0, supportedParams[1].length()))) {
        ...
        if (!emProp.equals(EM_PROPERTY_STATE_USR)
          ...
          Slog.m117i(TAG, "1,0,0,0 is complete.");
          return result4;
        }
