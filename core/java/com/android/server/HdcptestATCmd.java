...
public class HdcptestATCmd implements IWorkOnAt {
    ...
    */
    public String processCmd(String cmd) {
        ...
        String[] supportedParams = {"0,0", "0,3", "0,4", "0,5", "0,8", "0,9", "1,0", "2,", "3,3,", "3,4,", "3,5,", "3,8,", "3,9,"};
        ...
        try {
            ...
            try {
                if (supportedParams[0].equals(cmd.substring(0, supportedParams[0].length()))) {
                    ...
                    result = ret == 0 ? result2 + "OK" : !checkPath(new StringBuilder().append(AT_HDCP_FILE_PATH_CPK).append(AT_HDCP_KEY_20).toString(), 2) ? !checkPath(new StringBuilder().append("/efs").append(AT_HDCP_KEY_20).toString(), 2) ? result2 + AT_RESPONSE_NG_KEY : ret == 44 ? result2 + AT_RESPONSE_ERROR_EXEC : result2 + AT_RESPONSE_NG_FIELD : ret == 44 ? result2 + AT_RESPONSE_ERROR_EXEC : result2 + AT_RESPONSE_NG_FIELD;
                    ...
                    try {
                        if (supportedParams[1].equals(cmd.substring(0, supportedParams[1].length()))) {
                            ...
                            result = ret2 == 0 ? result2 + "OK" : ret2 == 44 ? result2 + AT_RESPONSE_ERROR_EXEC : result2 + AT_RESPONSE_NG_FIELD;
                            ...
                            if (sendTobsd(AT_HDCP_DP_VER_22_VERIFY_CMD) == 0) {
                                ...
                                result = ret3 == 0 ? result2 + "OK" : ret3 == 44 ? result2 + AT_RESPONSE_ERROR_EXEC : result2 + "NG";
                            }
                            ...
                            if (sendTobsd(AT_HDCP_DP_VER_13_VERIFY_CMD) == 0) {
                                ...
                                result = ret4 == 0 ? result2 + "OK" : ret4 == 44 ? result2 + AT_RESPONSE_ERROR_EXEC : result2 + "NG";
                            }
                            ...
                            if (sendTobsd(AT_HDCP_DP_VER_22_VERIFY_M_CMD) == 0) {
                                ...
                                result = ret5 == 0 ? result2 + "OK" : ret5 == 44 ? result2 + AT_RESPONSE_ERROR_EXEC : result2 + "NG";
                            }
                            ...
                            if (sendTobsd(AT_HDCP_DP_VER_13_VERIFY_M_CMD) == 0) {
                                ...
                                result = ret6 == 0 ? result2 + "OK" : ret6 == 44 ? result2 + AT_RESPONSE_ERROR_EXEC : result2 + "NG";
                            }
                            ...
                            String AT_RESPONSE_SERIAL = serialNo.length() >= 16 ? serialNo : serialNo.length() <= 0 ? "0" + AT_WV_DEFAULT_SERIAL.substring(1) : serialNo + AT_WV_DEFAULT_SERIAL.substring(serialNo.length());
                            ...
                            if (params[1] != null && params[1].length() != 0) {
                                ...
                                result = sendTobsd(new StringBuilder().append(AT_HDCP_WRITE_CMD).append(params[1]).toString()) == 0 ? result2 + "OK" : result2 + "NG";
                            ...
                            if (params[2] != null && params[2].length() != 0) {
                                ...
                                result = ret7 == 0 ? result2 + "OK" : ret7 == 44 ? result2 + AT_RESPONSE_ERROR_EXEC : result2 + "NG";
                            ...
                            if (bArray2 == null) {
                                ...
                                makeDirectory(AT_HDCP_FILE_PATH_CPK);
                                result = sendTobsd(new StringBuilder().append(AT_HDCP_DP_VER_22_WRITE_CMD).append(params[2]).toString()) == 0 ? result2 + "OK" : result2 + "NG";
                            } else {
                            ...
                            if (bArray3 == null) {
                                ...
                                makeDirectory(AT_HDCP_FILE_PATH_CPK);
                                result = sendTobsd(new StringBuilder().append(AT_HDCP_DP_VER_13_WRITE_CMD).append(params[2]).toString()) == 0 ? result2 + "OK" : result2 + "NG";
                            } else {
                            ...
                            if (bArray4 == null) {
                                ...
                                makeDirectory(AT_HDCP_FILE_PATH_CPK);
                                result = sendTobsd(new StringBuilder().append(AT_HDCP_DP_VER_22_WRITE_M_CMD).append(params[2]).toString()) == 0 ? result2 + "OK" : result2 + "NG";
                            } else {
                            ...
                            if (bArray5 == null) {
                                ...
                                makeDirectory(AT_HDCP_FILE_PATH_CPK);
                                result = sendTobsd(new StringBuilder().append(AT_HDCP_DP_VER_13_WRITE_M_CMD).append(params[2]).toString()) == 0 ? result2 + "OK" : result2 + "NG";
                            } else {
