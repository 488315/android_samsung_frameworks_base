...
public class PermissionBackupHelper extends BlobBackupHelper {
  ...
  public PermissionBackupHelper(int userId) {
    ...
    this.mPermissionManager =
        (PermissionManagerInternal) LocalServices.getService(PermissionManagerInternal.class);
  }
  ...
  protected byte[] getBackupPayload(String key) {
    ...
    try {
      ...
      switch (c) {
        ...
        default:
          Slog.m121w(TAG, "Unexpected backup key " + key);
          return null;
      }
    } catch (Exception e) {
      Slog.m116e(TAG, "Unable to store payload " + key, e);
      return null;
    }
  }
    ...
    try {
      ...
      switch (c) {
        case 0:
          ...
          break;
        default:
          Slog.m121w(TAG, "Unexpected restore key " + key);
          break;
      }
    } catch (Exception e) {
      Slog.m116e(TAG, "Unable to restore key " + key, e);
    }
  }
}
