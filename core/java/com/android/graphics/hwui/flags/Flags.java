...
public final class Flags {
    ...
    public static final String FLAG_ANIMATE_HDR_TRANSITIONS =
    ...
    public static final String FLAG_CLIP_SURFACEVIEWS =
    ...
    public static final String FLAG_GAINMAP_ANIMATIONS =
            "com.android.graphics.hwui.flags.gainmap_animations";
    public static final String FLAG_GAINMAP_CONSTRUCTOR_WITH_METADATA =
            "com.android.graphics.hwui.flags.gainmap_constructor_with_metadata";
    public static final String FLAG_HDR_10BIT_PLUS =
            "com.android.graphics.hwui.flags.hdr_10bit_plus";
    public static final String FLAG_HIGH_CONTRAST_TEXT_LUMINANCE =
            "com.android.graphics.hwui.flags.high_contrast_text_luminance";
    public static final String FLAG_HIGH_CONTRAST_TEXT_SMALL_TEXT_RECT =
            "com.android.graphics.hwui.flags.high_contrast_text_small_text_rect";
    public static final String FLAG_INITIALIZE_GL_ALWAYS =
            "com.android.graphics.hwui.flags.initialize_gl_always";
    ...
    public static final String FLAG_REQUESTED_FORMATS_V =
