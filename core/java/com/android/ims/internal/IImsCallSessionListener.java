...
public interface IImsCallSessionListener extends IInterface {
  ...
  public static class Default implements IImsCallSessionListener {
    ...
    public void callSessionHandover(
        IImsCallSession session, int srcAccessTech, int targetAccessTech, ImsReasonInfo reasonInfo)
        throws RemoteException {}
    ...
    public void callSessionMayHandover(
        IImsCallSession session, int srcAccessTech, int targetAccessTech) throws RemoteException {}
          ...
          switch (code) {
            case 1:
              ...
              ImsStreamMediaProfile _arg1 =
                  (ImsStreamMediaProfile) data.readTypedObject(ImsStreamMediaProfile.CREATOR);
