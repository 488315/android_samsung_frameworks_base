...
public interface IImsUtListener extends IInterface {
  ...
  void utConfigurationCallForwardQueried(
      IImsUt iImsUt, int i, ImsCallForwardInfo[] imsCallForwardInfoArr) throws RemoteException;
          ...
          switch (code) {
            ...
            case 7:
              ...
              ImsCallForwardInfo[] _arg25 =
                  (ImsCallForwardInfo[]) data.createTypedArray(ImsCallForwardInfo.CREATOR);
              data.enforceNoDataAvail();
