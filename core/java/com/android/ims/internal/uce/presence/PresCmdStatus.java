...
public class PresCmdStatus implements Parcelable {
  public static final Parcelable.Creator<PresCmdStatus> CREATOR =
      new Parcelable.Creator<
          PresCmdStatus>() { // from class: com.android.ims.internal.uce.presence.PresCmdStatus.1
  ...
  public void readFromParcel(Parcel source) {
    ...
    this.mCmdId =
        (PresCmdId) source.readParcelable(PresCmdId.class.getClassLoader(), PresCmdId.class);
    this.mStatus =
        (StatusCode) source.readParcelable(StatusCode.class.getClassLoader(), StatusCode.class);
  }
}
