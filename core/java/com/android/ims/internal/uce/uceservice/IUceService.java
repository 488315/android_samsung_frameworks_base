...
public interface IUceService extends IInterface {
  ...
  int createPresenceServiceForSubscription(
      IPresenceListener iPresenceListener, UceLong uceLong, String str) throws RemoteException;
  ...
  public static class Default implements IUceService {
    ...
    public int createPresenceServiceForSubscription(
        IPresenceListener presenceServiceListener, UceLong presenceServiceListenerHdl, String iccId)
        throws RemoteException {
      return 0;
    }
