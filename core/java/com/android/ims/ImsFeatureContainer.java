...
public final class ImsFeatureContainer implements Parcelable {
    ...
    public ImsFeatureContainer(
            IBinder iFace,
            IImsConfig iConfig,
            IImsRegistration iReg,
    ...
    public boolean equals(Object o) {
        ...
        if (this.imsFeature.equals(that.imsFeature)
                && this.imsConfig.equals(that.imsConfig)
                && this.imsRegistration.equals(that.imsRegistration)
                && this.sipTransport.equals(that.sipTransport)
                && this.mState == that.getState()
                && this.mCapabilities == that.getCapabilities()) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "FeatureContainer{imsFeature="
                + this.imsFeature
                + ", imsConfig="
                + this.imsConfig
                + ", imsRegistration="
                ...
                + this.sipTransport
                + ", state="
                + ImsFeature.STATE_LOG_MAP.get(Integer.valueOf(this.mState))
                + ", capabilities = "
                + ImsService.getCapabilitiesString(this.mCapabilities)
                + '}';
    }
