...
final class MessageSchema<T> implements Schema<T> {
    ...
    */
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo messageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        for (FieldInfo fi : fis) {
            if (fi.getType() == FieldType.MAP) {
                mapFieldCount++;
            } else if (fi.getType().m171id() >= 18 && fi.getType().m171id() <= 49) {
                repeatedFieldCount++;
            }
        }
        ...
        while (checkInitializedIndex2 < repeatedFieldCount) {
            ...
            if (fi2.getType() == FieldType.MAP) {
                ...
                mapFieldCount2++;
                isProto3 = isProto32;
            } else if (fi2.getType().m171id() < 18 || fi2.getType().m171id() > 49) {
                isProto3 = isProto32;
            } else {
                isProto3 = isProto32;
    ...
    private int getSerializedSizeProto2(T message) {
        ...
        while (i < this.buffer.length) {
            ...
            int presenceMask = 0;
            if (fieldType > 17) {
                if (this.useCachedSizeField && fieldType >= FieldType.DOUBLE_LIST_PACKED.m171id() && fieldType <= FieldType.SINT64_LIST_PACKED.m171id()) {
    ...
    private int getSerializedSizeProto3(T message) {
        ...
        for (int i = 0; i < this.buffer.length; i += 3) {
            ...
            int number = numberAt(i);
            long offset = offset(typeAndOffset);
            if (fieldType >= FieldType.DOUBLE_LIST_PACKED.m171id() && fieldType <= FieldType.SINT64_LIST_PACKED.m171id()) {
    ...
    */
                ...
                if (pos >= 0) {
                        ...
                        switch (type(typeAndOffset)) {
                            ...
                            case 12:
                                ...
                                if (enumVerifier == null) {
                                    ...
                                    unknownFieldSchema2 = unknownFieldSchema;
                                    obj3 = SchemaUtil.storeUnknownEnum(t, number, enumValue, obj2, unknownFieldSchema2);
                                    extensionRegistryLite = extensionRegistryLite2;
                                    t2 = t;
                                    reader2 = reader3;
                                    extensions2 = extensions3;
                            ...
                            case 30:
                                ...
                                obj3 = SchemaUtil.filterUnknownEnumList(message, number, enumList, getEnumFieldVerifier(pos), obj3, unknownFieldSchema);
                                unknownFieldSchema2 = unknownFieldSchema;
                                extensionRegistryLite = extensionRegistryLite2;
                                t2 = t;
                                reader2 = reader3;
                            ...
                            case 44:
                                ...
                                obj3 = SchemaUtil.filterUnknownEnumList(message, number, enumList2, getEnumFieldVerifier(pos), obj3, unknownFieldSchema);
                                unknownFieldSchema2 = unknownFieldSchema;
                                extensionRegistryLite = extensionRegistryLite2;
                                t2 = t;
                                reader2 = reader3;
                            ...
                            case 49:
                                ...
                                try {
                                    ...
                                    invalidWireTypeException = e;
                                    obj3 = obj2;
                                    InvalidProtocolBufferException.InvalidWireTypeException e3 = invalidWireTypeException;
                            ...
                            case 50:
                                try {
                                    ...
                                    InvalidProtocolBufferException.InvalidWireTypeException e32 = invalidWireTypeException;
                                    if (!unknownFieldSchema2.shouldDiscardUnknownFields(reader3)) {
                                    }
                                    extensionRegistryLite = extensionRegistryLite2;
                                    t2 = t;
                            ...
                            case 63:
                                ...
                                if (enumVerifier2 != null && !enumVerifier2.isInRange(enumValue2)) {
                                    obj3 = SchemaUtil.storeUnknownEnum(t, number, enumValue2, obj3, unknownFieldSchema2);
                                    extensionRegistryLite = extensionRegistryLite2;
                                    t2 = t;
                                    reader2 = reader3;
                                    extensions2 = extensions3;
                            ...
                            case 67:
                                try {
                                    ...
                                    invalidWireTypeException = e5;
                                    InvalidProtocolBufferException.InvalidWireTypeException e322 = invalidWireTypeException;
                                    if (!unknownFieldSchema2.shouldDiscardUnknownFields(reader3)) {
                                    }
                                    extensionRegistryLite = extensionRegistryLite2;
                                    t2 = t;
                            ...
                            default:
                                ...
                                if (obj2 == null) {
                                    try {
                                        ...
                                        invalidWireTypeException = e;
                                        obj3 = obj2;
                                        InvalidProtocolBufferException.InvalidWireTypeException e3222 = invalidWireTypeException;
                                        if (!unknownFieldSchema2.shouldDiscardUnknownFields(reader3)) {
                                        }
                                        extensionRegistryLite = extensionRegistryLite2;
                                        t2 = t;
                                ...
                                try {
                                    ...
                                    InvalidProtocolBufferException.InvalidWireTypeException e32222 = invalidWireTypeException;
                                    if (!unknownFieldSchema2.shouldDiscardUnknownFields(reader3)) {
                                        if (obj3 == null) {
                                            obj3 = unknownFieldSchema2.getBuilderFromMessage(t);
                                        }
                                        if (!unknownFieldSchema2.mergeOneFieldFrom(obj3, reader3)) {
                                            Object obj4 = obj3;
                                        ...
                                        while (i3 < this.repeatedFieldOffsetStart) {
                                            obj3 = filterMapUnknownEnumValues(message, this.intArray[i3], obj3, unknownFieldSchema, message);
                                            i3++;
                                            e32222 = e32222;
                                        }
                                        Object obj5 = obj3;
                                ...
                                if (!unknownFieldSchema2.mergeOneFieldFrom(obj3, reader3)) {
                                    ...
                                    while (i4 < this.repeatedFieldOffsetStart) {
                                        obj3 = filterMapUnknownEnumValues(message, this.intArray[i4], obj3, unknownFieldSchema, message);
                                        i4++;
                    ...
                    if (number == Integer.MAX_VALUE) {
                        ...
                        while (i5 < this.repeatedFieldOffsetStart) {
                            obj3 = filterMapUnknownEnumValues(message, this.intArray[i5], obj3, unknownFieldSchema, message);
                            i5++;
                            pos = pos;
                        }
                        Object obj7 = obj3;
                        if (obj7 != null) {
                            unknownFieldSchema2.setBuilderToMessage(t2, obj7);
                            return;
                        }
                        return;
                    }
                    try {
                        ...
                        if (extension != null) {
                            ...
                            T t3 = t2;
                            try {
                                obj3 = extensionSchema.parseExtension(message, reader, extension, extensionRegistry, extensions, obj3, unknownFieldSchema);
                            ...
                            T t4 = t2;
                            try {
                                if (unknownFieldSchema2.shouldDiscardUnknownFields(reader5)) {
                                    try {
                                        if (reader.skipField()) {
                                    ...
                                    if (obj3 == null) {
                                        obj3 = unknownFieldSchema2.getBuilderFromMessage(t4);
                                    }
                                    if (unknownFieldSchema2.mergeOneFieldFrom(obj3, reader5)) {
                                        extensionRegistryLite = extensionRegistryLite4;
                                        t2 = t4;
                                        reader2 = reader5;
                                    }
    ...
    private int decodeMapEntryValue(byte[] data, int position, int limit, WireFormat.FieldType fieldType, Class<?> messageType, ArrayDecoders.Registers registers) throws IOException {
        switch (C42951.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
