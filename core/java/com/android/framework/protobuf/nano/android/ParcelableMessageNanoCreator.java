...
public final class ParcelableMessageNanoCreator<T extends MessageNano>
  ...
  public T createFromParcel(Parcel in) {
    ...
    try {
      ...
      Log.m97e(TAG, "Exception trying to create proto from parcel", e);
      return proto;
    } catch (ClassNotFoundException e2) {
      Log.m97e(TAG, "Exception trying to create proto from parcel", e2);
      return proto;
    } catch (IllegalAccessException e3) {
      Log.m97e(TAG, "Exception trying to create proto from parcel", e3);
      return proto;
    } catch (InstantiationException e4) {
      Log.m97e(TAG, "Exception trying to create proto from parcel", e4);
      return proto;
    } catch (NoSuchMethodException e5) {
      Log.m97e(TAG, "Exception trying to create proto from parcel", e5);
      return proto;
    } catch (InvocationTargetException e6) {
      Log.m97e(TAG, "Exception trying to create proto from parcel", e6);
      return proto;
    }
  }
