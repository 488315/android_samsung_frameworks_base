...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
  ...
  private class DescendingEntryIterator implements Iterator<Map.Entry<K, V>> {
    ...
    public boolean hasNext() {
      int i = this.pos;
      return (i > 0 && i <= SmallSortedMap.this.entryList.size())
  ...
  private static class EmptySet {
    private static final Iterator<Object> ITERATOR =
        new Iterator<
            Object>() { // from class: com.android.framework.protobuf.SmallSortedMap.EmptySet.1
          @Override // java.util.Iterator
          public boolean hasNext() {
            return false;
          }
    ...
    private static final Iterable<Object> ITERABLE =
        new Iterable<
            Object>() { // from class: com.android.framework.protobuf.SmallSortedMap.EmptySet.2
