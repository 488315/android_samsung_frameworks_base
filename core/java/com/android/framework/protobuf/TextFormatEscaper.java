...
final class TextFormatEscaper {
  ...
  static String escapeBytes(final ByteString input) {
    return escapeBytes(
        new ByteSequence() { // from class: com.android.framework.protobuf.TextFormatEscaper.1
  ...
  static String escapeBytes(final byte[] input) {
    return escapeBytes(
        new ByteSequence() { // from class: com.android.framework.protobuf.TextFormatEscaper.2
          @Override // com.android.framework.protobuf.TextFormatEscaper.ByteSequence
          public int size() {
            return input.length;
          }
