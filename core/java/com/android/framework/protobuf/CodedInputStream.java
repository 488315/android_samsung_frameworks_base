...
public abstract class CodedInputStream {
  ...
  public abstract <T extends MessageLite> T readGroup(
      int i, Parser<T> parser, ExtensionRegistryLite extensionRegistryLite) throws IOException;
  ...
  public abstract void readMessage(
      MessageLite.Builder builder, ExtensionRegistryLite extensionRegistryLite) throws IOException;
  ...
  private static final class ArrayDecoder extends CodedInputStream {
    ...
    public void readGroup(
        int fieldNumber, MessageLite.Builder builder, ExtensionRegistryLite extensionRegistry)
        throws IOException {
      checkRecursionLimit();
      this.recursionDepth++;
        ...
        if (this.limit - tempPos2 >= 9) {
          ...
          if (x2 < 0) {
            ...
            if (x3 >= 0) {
              ...
              tempPos3 = tempPos4 + 1;
              int x4 =
                  (UnsafeUtil.getByte(tempPos4) << SprAnimatorBase.INTERPOLATOR_TYPE_CUBICEASEINOUT)
                      ^ x3;
              if (x4 < 0) {
                y = (-2080896) ^ x4;
              } else {
    ...
    private class SkippedDataSink implements RefillCallback {
      ...
      public void onRefill() {
        ...
        this.byteArrayStream.write(
            StreamDecoder.this.buffer, this.lastPos, StreamDecoder.this.pos - this.lastPos);
        this.lastPos = 0;
      }
    ...
    private boolean tryRefillBuffer(int n) throws IOException {
      ...
      int bytesRead =
          read(
              ...
              i5,
              Math.min(
                  bArr2.length - i5, (this.sizeLimit - this.totalBytesRetired) - this.bufferSize));
  ...
  private static final class IterableDirectByteBufferDecoder extends CodedInputStream {
    ...
    public void resetSizeCounter() {
      this.startOffset =
          (int)
              ((this.totalBytesRead + this.currentByteBufferPos) - this.currentByteBufferStartPos);
    }
