...
public class UnmodifiableLazyStringList extends AbstractList<String>
  ...
  public ListIterator<String> listIterator(int index) {
    return new ListIterator<String>(
        index) { // from class: com.android.framework.protobuf.UnmodifiableLazyStringList.1
  ...
  public Iterator<String> iterator() {
    return new Iterator<
        String>() { // from class: com.android.framework.protobuf.UnmodifiableLazyStringList.2
