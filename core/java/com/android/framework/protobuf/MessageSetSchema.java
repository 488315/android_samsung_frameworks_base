...
final class MessageSetSchema<T> implements Schema<T> {
  ...
  */
  public void mergeFrom(
      T t, byte[] data, int position, int limit, ArrayDecoders.Registers registers)
      throws IOException {
    ...
    FieldSet<GeneratedMessageLite.ExtensionDescriptor> extensions =
        ((GeneratedMessageLite.ExtendableMessage) t).ensureExtensionsAreMutable();
    ...
    while (typeId < limit) {
      ...
      if (startTag != WireFormat.MESSAGE_SET_ITEM_TAG) {
        if (WireFormat.getTagWireType(startTag) == 2) {
          GeneratedMessageLite.GeneratedExtension<?, ?> extension3 =
              (GeneratedMessageLite.GeneratedExtension)
                  this.extensionSchema.findExtensionByNumber(
                      registers.extensionRegistry,
          ...
          if (extension3 != null) {
            typeId =
                ArrayDecoders.decodeMessageField(
                    Protobuf.getInstance()
                        .schemaFor((Class) extension3.getMessageDefaultInstance().getClass()),
                    data,
                    number,
                    limit,
                    registers);
            ...
            typeId =
                ArrayDecoders.decodeUnknownField(
                    startTag, data, number, limit, unknownFields, registers);
            extension2 = extension3;
          }
        } else {
              ...
              case 2:
                if (wireType != 0) {
                  ...
                  extension2 =
                      (GeneratedMessageLite.GeneratedExtension)
                          this.extensionSchema.findExtensionByNumber(
                              registers.extensionRegistry, this.defaultInstance, typeId2);
                  number = position3;
                }
              case 3:
                if (extension2 != null) {
                  int position4 =
                      ArrayDecoders.decodeMessageField(
                          Protobuf.getInstance()
                              .schemaFor((Class) extension2.getMessageDefaultInstance().getClass()),
                          data,
                          position2,
                          limit,
                          registers);
  ...
  private <UT, UB, ET extends FieldSet.FieldDescriptorLite<ET>> void mergeFromHelper(
    ...
    do {
      try {
        ...
        reader, extensionRegistry, extensionSchema, extensions, unknownFieldSchema, unknownFields));
  }
  ...
  private <UT, UB, ET extends FieldSet.FieldDescriptorLite<ET>>
      ...
      if (WireFormat.getTagWireType(startTag) == 2) {
        Object extension =
            extensionSchema.findExtensionByNumber(
                extensionRegistry, this.defaultInstance, WireFormat.getTagFieldNumber(startTag));
        if (extension != null) {
    ...
    while (number != Integer.MAX_VALUE) {
      ...
      if (tag == WireFormat.MESSAGE_SET_TYPE_ID_TAG) {
        ...
        extension2 =
            extensionSchema.findExtensionByNumber(extensionRegistry, this.defaultInstance, typeId);
      } else if (tag == WireFormat.MESSAGE_SET_MESSAGE_TAG) {
        if (extension2 != null) {
          extensionSchema.parseLengthPrefixedMessageSetItem(
              reader, extension2, extensionRegistry, extensions);
        } else {
