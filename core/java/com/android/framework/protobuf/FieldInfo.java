...
final class FieldInfo implements Comparable<FieldInfo> {
  ...
  public static FieldInfo forMapField(
      Field field, int fieldNumber, Object mapDefaultEntry, Internal.EnumVerifier enumVerifier) {
  ...
  public Class<?> getMessageFieldClass() {
    switch (C42861.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()]) {
      case 1:
      case 2:
      ...
      if (enumVerifier != null) {
        ...
        if (field2 == null) {
          return FieldInfo.forFieldWithEnumVerifier(
              this.field, this.fieldNumber, this.type, enumVerifier);
        }
        return FieldInfo.forPackedFieldWithEnumVerifier(
            this.field, this.fieldNumber, this.type, enumVerifier, field2);
      }
