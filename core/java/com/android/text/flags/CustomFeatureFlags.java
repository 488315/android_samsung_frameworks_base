...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(
                    Arrays.asList(
                            Flags.FLAG_COMPLETE_FONT_LOAD_IN_SYSTEM_SERVICES_READY,
                            Flags.FLAG_DEPRECATE_UI_FONTS,
                            Flags.FLAG_DISABLE_HANDWRITING_INITIATOR_FOR_IME,
                            Flags.FLAG_ESCAPE_CLEARS_FOCUS,
                            Flags.FLAG_FIX_DOUBLE_UNDERLINE,
                            Flags.FLAG_FIX_FONT_UPDATE_FAILURE,
                            Flags.FLAG_FIX_LINE_HEIGHT_FOR_LOCALE,
                            Flags.FLAG_FIX_MISALIGNED_CONTEXT_MENU,
                            Flags.FLAG_FIX_NULL_TYPEFACE_BOLDING,
                            Flags.FLAG_HANDWRITING_CURSOR_POSITION,
                            Flags.FLAG_HANDWRITING_END_OF_LINE_TAP,
                            Flags.FLAG_HANDWRITING_UNSUPPORTED_MESSAGE,
                            Flags.FLAG_ICU_BIDI_MIGRATION,
                            Flags.FLAG_INSERT_MODE_CRASH_WHEN_DELETE,
                            Flags.FLAG_INSERT_MODE_NOT_UPDATE_SELECTION,
                            Flags.FLAG_LAZY_VARIATION_INSTANCE,
                            Flags.FLAG_LETTER_SPACING_JUSTIFICATION,
                            Flags.FLAG_MISSING_GETTER_APIS,
                            Flags.FLAG_NEW_FONTS_FALLBACK_XML,
                            Flags.FLAG_NO_BREAK_NO_HYPHENATION_SPAN,
                            Flags.FLAG_PHRASE_STRICT_FALLBACK,
                            Flags.FLAG_RUST_HYPHENATOR,
                            Flags.FLAG_USE_BOUNDS_FOR_WIDTH,
                            Flags.FLAG_USE_OPTIMIZED_BOOTTIME_FONT_LOADING,
    ...
    public boolean completeFontLoadInSystemServicesReady() {
        return getValue(
                ...
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda18
    ...
    public boolean deprecateUiFonts() {
        return getValue(
                Flags.FLAG_DEPRECATE_UI_FONTS,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda22
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean disableHandwritingInitiatorForIme() {
        return getValue(
                Flags.FLAG_DISABLE_HANDWRITING_INITIATOR_FOR_IME,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda17
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean escapeClearsFocus() {
        return getValue(
                Flags.FLAG_ESCAPE_CLEARS_FOCUS,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda10
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean fixDoubleUnderline() {
        return getValue(
                Flags.FLAG_FIX_DOUBLE_UNDERLINE,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda25
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean fixFontUpdateFailure() {
        return getValue(
                Flags.FLAG_FIX_FONT_UPDATE_FAILURE,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda11
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean fixLineHeightForLocale() {
        return getValue(
                Flags.FLAG_FIX_LINE_HEIGHT_FOR_LOCALE,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda15
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean fixMisalignedContextMenu() {
        return getValue(
                Flags.FLAG_FIX_MISALIGNED_CONTEXT_MENU,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda21
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean fixNullTypefaceBolding() {
        return getValue(
                Flags.FLAG_FIX_NULL_TYPEFACE_BOLDING,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda7
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean handwritingCursorPosition() {
        return getValue(
                Flags.FLAG_HANDWRITING_CURSOR_POSITION,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda3
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean handwritingEndOfLineTap() {
        return getValue(
                Flags.FLAG_HANDWRITING_END_OF_LINE_TAP,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda12
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean handwritingUnsupportedMessage() {
        return getValue(
                Flags.FLAG_HANDWRITING_UNSUPPORTED_MESSAGE,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda9
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean icuBidiMigration() {
        return getValue(
                Flags.FLAG_ICU_BIDI_MIGRATION,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda13
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean insertModeCrashWhenDelete() {
        return getValue(
                Flags.FLAG_INSERT_MODE_CRASH_WHEN_DELETE,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda24
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean insertModeNotUpdateSelection() {
        return getValue(
                Flags.FLAG_INSERT_MODE_NOT_UPDATE_SELECTION,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda2
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean lazyVariationInstance() {
        return getValue(
                Flags.FLAG_LAZY_VARIATION_INSTANCE,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean letterSpacingJustification() {
        return getValue(
                Flags.FLAG_LETTER_SPACING_JUSTIFICATION,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda16
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean missingGetterApis() {
        return getValue(
                Flags.FLAG_MISSING_GETTER_APIS,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda5
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean newFontsFallbackXml() {
        return getValue(
                Flags.FLAG_NEW_FONTS_FALLBACK_XML,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda20
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean noBreakNoHyphenationSpan() {
        return getValue(
                Flags.FLAG_NO_BREAK_NO_HYPHENATION_SPAN,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda6
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean phraseStrictFallback() {
        return getValue(
                Flags.FLAG_PHRASE_STRICT_FALLBACK,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda4
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean rustHyphenator() {
        return getValue(
                Flags.FLAG_RUST_HYPHENATOR,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean useBoundsForWidth() {
        return getValue(
                Flags.FLAG_USE_BOUNDS_FOR_WIDTH,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda19
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean useOptimizedBoottimeFontLoading() {
        return getValue(
                Flags.FLAG_USE_OPTIMIZED_BOOTTIME_FONT_LOADING,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda8
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean vendorCustomLocaleFallback() {
        return getValue(
                Flags.FLAG_VENDOR_CUSTOM_LOCALE_FALLBACK,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda23
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean wordStyleAuto() {
        return getValue(
                Flags.FLAG_WORD_STYLE_AUTO,
                new Predicate() { // from class:
                                  // com.android.text.flags.CustomFeatureFlags$$ExternalSyntheticLambda14
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
