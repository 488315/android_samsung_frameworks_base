...
public abstract class AbstractMessageParser {
  ...
  private boolean parseSmiley() {
    ...
    if (!this.parseSmilies
        || (match = longestMatch(getResources().getSmileys(), this, this.nextChar, true)) == null) {
      return false;
    }
  ...
  private boolean parseAcronym() {
    ...
    if (!this.parseAcronyms
        || (match = longestMatch(getResources().getAcronyms(), this, this.nextChar)) == null) {
      return false;
    }
  ...
  public static class Format extends Token {
    ...
    public String toHtml(boolean caps) {
      if (this.matched) {
        return this.start ? getFormatStart(this.f2945ch) : getFormatEnd(this.f2945ch);
      }
      char c = this.f2945ch;
    ...
    while (it.hasNext()) {
      ...
      while (it2.hasNext()) {
        ...
        if (token.isHtml()) {
          ...
          switch (C48361.f2944x418776ea[token.getType().ordinal()]) {
            case 1:
              html.append("<a href=\"");
  ...
  static /* synthetic */ class C48361 {
    ...
    static {
      ...
      try {
        f2944x418776ea[Token.Type.SMILEY.ordinal()] = 2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        f2944x418776ea[Token.Type.ACRONYM.ordinal()] = 3;
      } catch (NoSuchFieldError e3) {
      }
      try {
        f2944x418776ea[Token.Type.MUSIC.ordinal()] = 4;
      } catch (NoSuchFieldError e4) {
      }
      try {
        f2944x418776ea[Token.Type.GOOGLE_VIDEO.ordinal()] = 5;
      } catch (NoSuchFieldError e5) {
      }
      try {
        f2944x418776ea[Token.Type.YOUTUBE_VIDEO.ordinal()] = 6;
      } catch (NoSuchFieldError e6) {
      }
      try {
        f2944x418776ea[Token.Type.PHOTO.ordinal()] = 7;
      } catch (NoSuchFieldError e7) {
      }
      try {
        f2944x418776ea[Token.Type.FLICKR.ordinal()] = 8;
