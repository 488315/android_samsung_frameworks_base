...
public class DownloadDrmHelper {
    ...
    public static boolean isDrmMimeType(Context context, String mimetype) {
        ...
        try {
            ...
            Log.m102w(TAG, "DrmManagerClient instance could not be created, context is Illegal.");
            return false;
        } catch (IllegalStateException e2) {
            Log.m102w(TAG, "DrmManagerClient didn't initialize properly.");
            return false;
        }
    }
    ...
    public static String getOriginalMimeType(Context context, String path, String containingMime) {
        ...
        try {
            ...
            Log.m102w(TAG, "Can't get original mime type since path is null or empty string.");
            return containingMime;
        } catch (IllegalStateException e2) {
            Log.m102w(TAG, "DrmManagerClient didn't initialize properly.");
            return containingMime;
