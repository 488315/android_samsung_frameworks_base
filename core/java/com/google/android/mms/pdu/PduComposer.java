...
public class PduComposer {
  ...
  private int makeMessageBody(int type) {
    ...
    PduBody body =
        type == 132 ? ((RetrieveConf) this.mPdu).getBody() : ((SendReq) this.mPdu).getBody();
    if (body != null && body.getPartsNum() != 0) {
      ...
      while (i2 < partNum) {
        ...
        byte[] contentLocation2 = part2.getContentLocation();
        if (contentLocation2 != null) {
          appendOctet(142);
          appendTextString(contentLocation2);
        }
        String str3 = str;
                ...
                while (true) {
                  try {
                    ...
                    try {
                      ...
                      dataLength2 += len2;
                      len = len2;
                      contentLocation2 = contentLocation;
