...
public class IAFDDBManager {
  ...
  */
  public IAFDDiagnosis.IAFD_DATA initDBByURIOrFile(boolean isURI, Uri db_uri, String dbPath) {
    ...
    if (isURI) {
      try {
        cursor =
            this.mContext
                .getContentResolver()
                .query(DB_IAFD_TB_URI_SM, columnsSMTB, null, null, null);
      } catch (Exception e) {
        e = e;
        e.printStackTrace();
        if (cursor2 == null) {}
      ...
      try {
        SQLiteDatabase mdb =
            SQLiteDatabase.openDatabase(dbPath, (SQLiteDatabase.CursorFactory) null, 1);
        try {
    ...
    if (cursor != null) {
      ...
      if (cursor.moveToNext()) {
        ...
        iafd_data.controlInfo.setWhiteList(
            "1",
      ...
      while (cursor.moveToNext()) {
        ...
        if (iTB == i3) {
          switch (cursor.getInt(i)) {
            case 30:
              iafd_data.controlInfo.setenableDetectAll32bitApp(
                  Boolean.valueOf(z), cursor.getString(5));
              break;
            case 31:
              if (z != 0) {
            ...
            case 33:
              if (z != 0) {
                iafd_data.controlInfo.setCSCFilter(
                    cursor.getString(4), cursor.getString(5), this.mSalesCode);
                break;
              }
              break;
            case 34:
            ...
            case 38:
              if (z != 0) {
                iafd_data.controlInfo.setIAFDDBControlFeature(
                    cursor.getString(4), cursor.getString(5), this.isCHNModel);
                break;
              }
              break;
            case 39:
  ...
  public void initIAFDDBHotfix() {
    ...
    try {
      File filepath =
          new File("/data/user/0/com.sec.android.iaft/iafd/db/", "iafddbhotfix_db.bin.enc.dec");
      if (filepath.exists()) {
        ...
        File filepath2 =
            new File("/data/user/0/com.sec.android.iaft/iafd/db/", "iafddbhotfix_db.bin.enc.dec");
        if (filepath2.exists()
            && (iafddataTmp = initDBByURIOrFile(false, null, filepath2.toString())) != null) {
      ...
      if (msg.what == 252 || msg.what == 253) {
        ...
        try {
          if (msg.what == 252) {
            ...
            IAFDDiagnosis.IAFD_DATA iafddataTmp =
                IAFDDBManager.this.initDBByURIOrFile(true, IAFDDBManager.DB_IAFD_TB_URI_SM, null);
            if (iafddataTmp != null) {
              IAFDDBManager.this.mIfadDBData[1] = iafddataTmp;
            } else {
              IAFDDBManager.mSMDBInitReTryCnt++;
              if (IAFDDBManager.this.mIAFDDBManagerHandler != null
                  && IAFDDBManager.mSMDBInitReTryCnt < 25) {
                Slog.m117i(
                    IAFDDBManager.TAG,
                    "in update,  mSMDBInitReTryCnt=" + IAFDDBManager.mSMDBInitReTryCnt);
                IAFDDBManager.this.mIAFDDBManagerHandler.sendMessageDelayed(
                    IAFDDBManager.this.mIAFDDBManagerHandler.obtainMessage(253), 5000L);
              }
            }
          }
        ...
        if (!IAFDDBManager.this.mRegisteredSmartManagerIAFDObserver) {
          try {
            if (IAFDDBManager.this.mIAFDDBObserver == null) {
              ...
              iAFDDBManager.mIAFDDBObserver =
                  iAFDDBManager.new IAFDDBObserver(iAFDDBManager.mIAFDDBManagerHandler);
            }
            IAFDDBManager.this
                .mContext
                .getContentResolver()
                .registerContentObserver(
                    IAFDDBManager.DB_IAFD_TB_URI_SM, true, IAFDDBManager.this.mIAFDDBObserver);
            IAFDDBManager.this.mRegisteredSmartManagerIAFDObserver = true;
            if (!IAFDDBManager.this.mRegisteredHotfixDBObserver) {
              IAFDDBManager.this.mIAFDDBManagerHandler.sendMessageDelayed(
                  IAFDDBManager.this.mIAFDDBManagerHandler.obtainMessage(250), 1000L);
            }
          } catch (Exception e2) {
            ...
            if (IAFDDBManager.this.mIAFDDBManagerHandler != null
              ...
              IAFDDBManager.this.mIAFDDBManagerHandler.sendMessageDelayed(
                  IAFDDBManager.this.mIAFDDBManagerHandler.obtainMessage(254), 5000L);
              return;
            }
            return;
          }
        ...
        if (!IAFDDBManager.this.mRegisteredHotfixDBObserver) {
          try {
            if (IAFDDBManager.this.mIAFDDBObserver == null) {
              ...
              iAFDDBManager2.mIAFDDBObserver =
                  iAFDDBManager2.new IAFDDBObserver(iAFDDBManager2.mIAFDDBManagerHandler);
            }
            IAFDDBManager.this
                .mContext
                .getContentResolver()
                .registerContentObserver(
                    IAFDSocketFdServer.mUriHotfixIAFDDB_TB,
                    true,
                    IAFDDBManager.this.mIAFDDBObserver);
            ...
            if (IAFDDBManager.this.mIAFDDBManagerHandler != null
                && IAFDDBManager.mHotfixDBInitReTryCnt < 25) {
              Slog.m117i(
                  IAFDDBManager.TAG,
                  "mHotfixDBInitReTryCnt=" + IAFDDBManager.mHotfixDBInitReTryCnt);
              IAFDDBManager.this.mIAFDDBManagerHandler.sendMessageDelayed(
                  IAFDDBManager.this.mIAFDDBManagerHandler.obtainMessage(250), 5000L);
              return;
            }
            return;
          }
