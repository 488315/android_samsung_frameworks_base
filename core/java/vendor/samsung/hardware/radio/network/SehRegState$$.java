...
public interface SehRegState$$ {
  static String toString(int _aidl_v) {
    return _aidl_v == 0
        ? "NOT_REG_MT_NOT_SEARCHING_OP"
        : _aidl_v == 1
            ? "REG_HOME"
            : _aidl_v == 2
                ? "NOT_REG_MT_SEARCHING_OP"
                : _aidl_v == 3
                    ? "REG_DENIED"
                    : _aidl_v == 4
                        ? "UNKNOWN"
                        : _aidl_v == 5
                            ? "REG_ROAMING"
                            : _aidl_v == 10
                                ? "NOT_REG_MT_NOT_SEARCHING_OP_EM"
                                : _aidl_v == 12
                                    ? "NOT_REG_MT_SEARCHING_OP_EM"
                                    : _aidl_v == 13
                                        ? "REG_DENIED_EM"
                                        : _aidl_v == 14 ? "UNKNOWN_EM" : Integer.toString(_aidl_v);
  }
