...
public interface ISehRadioNetwork extends IInterface {
  ...
  public static class Default implements ISehRadioNetwork {
    ...
    @Override // vendor.samsung.hardware.radio.network.ISehRadioNetwork
    public void setVendorSpecificConfiguration(int serial, SehVendorConfiguration[] configurations)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 16:
              ...
              SehCurrentNetworkInfo[] _arg17 =
                  (SehCurrentNetworkInfo[]) data.createTypedArray(SehCurrentNetworkInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 20:
              ...
              SehPreferredNetworkInfo _arg111 =
                  (SehPreferredNetworkInfo) data.readTypedObject(SehPreferredNetworkInfo.CREATOR);
              data.enforceNoDataAvail();
