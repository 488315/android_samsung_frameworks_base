...
public interface ISehRadioNetworkResponse extends IInterface {
  ...
  void getRoamingNetworkInfoViaBLEResponse(
      SehRadioResponseInfo sehRadioResponseInfo, SehRoamingNetworkInfo[] sehRoamingNetworkInfoArr)
      throws RemoteException;

  void getVendorSpecificConfigurationResponse(
      SehRadioResponseInfo sehRadioResponseInfo, SehVendorConfiguration[] sehVendorConfigurationArr)
      throws RemoteException;
  ...
  public static class Default implements ISehRadioNetworkResponse {
    ...
    public void getPreferredNetworkListResponse(
        SehRadioResponseInfo info, SehPreferredNetworkInfo[] infos) throws RemoteException {}

    @Override // vendor.samsung.hardware.radio.network.ISehRadioNetworkResponse
    public void getRoamingNetworkInfoViaBLEResponse(
        SehRadioResponseInfo info, SehRoamingNetworkInfo[] networkInfo) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 10:
              ...
              SehRoamingNetworkInfo[] _arg19 =
                  (SehRoamingNetworkInfo[]) data.createTypedArray(SehRoamingNetworkInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 11:
              ...
              SehVendorConfiguration[] _arg110 =
                  (SehVendorConfiguration[]) data.createTypedArray(SehVendorConfiguration.CREATOR);
              data.enforceNoDataAvail();
