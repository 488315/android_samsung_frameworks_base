...
public interface ISehRadioIndication
        extends vendor.samsung.hardware.radio.V2_0.ISehRadioIndication {
    public static final String kInterfaceName =
            "vendor.samsung.hardware.radio@2.1::ISehRadioIndication";
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of"
                           + " vendor.samsung.hardware.radio@2.1::ISehRadioIndication]@Proxy";
            }
        }
                    ...
                    needPacketUsage(
                            ...
                            new ISehRadioIndication
                                    .needPacketUsageCallback() { // from class:
                                                                 // vendor.samsung.hardware.radio.V2_1.ISehRadioIndication.Stub.1
