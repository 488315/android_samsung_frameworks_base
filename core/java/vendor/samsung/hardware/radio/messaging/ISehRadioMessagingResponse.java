...
public interface ISehRadioMessagingResponse extends IInterface {
  ...
  void sendSmsResponse(SehRadioResponseInfo sehRadioResponseInfo, SehSendSmsResult sehSendSmsResult)
      throws RemoteException;
  ...
  public static class Default implements ISehRadioMessagingResponse {
    ...
    public void getStoredMsgCountFromSimResponse(
        SehRadioResponseInfo info, SehStoredMsgCount storedMsgInfo) throws RemoteException {}
    ...
    @Override // vendor.samsung.hardware.radio.messaging.ISehRadioMessagingResponse
    public void getCellBroadcastConfigResponse(SehRadioResponseInfo info, SehCbConfigArgs configs)
        throws RemoteException {}
          ...
          switch (code) {
            case 1:
              SehRadioResponseInfo _arg0 =
                  (SehRadioResponseInfo) data.readTypedObject(SehRadioResponseInfo.CREATOR);
