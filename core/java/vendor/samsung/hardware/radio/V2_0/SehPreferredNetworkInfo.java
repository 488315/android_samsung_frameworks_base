...
public final class SehPreferredNetworkInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.index == other.index
                && HidlSupport.deepEquals(this.oper, other.oper)
                && HidlSupport.deepEquals(this.plmn, other.plmn)
                && this.gsmAct == other.gsmAct
                && this.gsmCompactAct == other.gsmCompactAct
                && this.utranAct == other.utranAct
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(HidlSupport.deepHashCode(this.oper)),
                Integer.valueOf(HidlSupport.deepHashCode(this.plmn)),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.gsmAct))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.gsmCompactAct))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.utranAct))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.mode))));
    }
    ...
    public final void readEmbeddedFromParcel(
        ...
        parcel.readEmbeddedBuffer(
                this.oper.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<SehPreferredNetworkInfo> _hidl_vec) {
