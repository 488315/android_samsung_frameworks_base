...
public final class SehApnProfile {
  ...
  /* renamed from: pw */
  public String f3119pw = new String();
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.apn, other.apn)
        ...
        && HidlSupport.deepEquals(this.f3119pw, other.f3119pw)
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(this.f3119pw)),
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    this.f3119pw = _hidl_blob.getString(_hidl_offset + 64);
    parcel.readEmbeddedBuffer(
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    ...
    _hidl_blob.putString(64 + _hidl_offset, this.f3119pw);
