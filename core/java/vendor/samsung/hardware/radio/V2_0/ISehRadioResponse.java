...
public interface ISehRadioResponse extends IBase {
  ...
  void getCellBroadcastConfigResponse(
      RadioResponseInfo radioResponseInfo, SehCbConfigArgs sehCbConfigArgs) throws RemoteException;
  ...
  void sendRequestStringsResponse(RadioResponseInfo radioResponseInfo, ArrayList<String> arrayList)
      throws RemoteException;
