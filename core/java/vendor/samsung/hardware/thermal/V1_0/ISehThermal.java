...
public interface ISehThermal extends IThermal {
  ...
  void sehGetTypeTemperatures(int i, sehGetTypeTemperaturesCallback sehgettypetemperaturescallback)
      throws RemoteException;
  ...
  public static final class Proxy implements ISehThermal {
    ...
    public ThermalStatus registerThermalChangedCallback(
        IThermalChangedCallback callback, boolean filterType, int type) throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(android.hardware.thermal.V2_0.IThermal.kInterfaceName);
    ...
    public void getCurrentCoolingDevices(
      ...
      try {
        ...
        ArrayList<android.hardware.thermal.V2_0.CoolingDevice> _hidl_out_devices =
            android.hardware.thermal.V2_0.CoolingDevice.readVectorFromParcel(_hidl_reply);
        _hidl_cb.onValues(_hidl_out_status, _hidl_out_devices);
      } finally {
        _hidl_reply.release();
      }
    ...
    @Override // vendor.samsung.hardware.thermal.V1_0.ISehThermal
    public ThermalStatus sehUnregisterThermalChangedCallback(ISehThermalChangedCallback callback)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(ISehThermal.kInterfaceName);
      _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());
      ...
      switch (_hidl_code) {
        ...
        case 5:
          ...
          getTemperatureThresholds(
              ...
              new IThermal
                ...
                public void onValues(
                    ThermalStatus status, ArrayList<TemperatureThreshold> temperatureThresholds) {
                  _hidl_reply.writeStatus(0);
                  status.writeToParcel(_hidl_reply);
        ...
        case 8:
          ...
          getCurrentCoolingDevices(
              ...
              new IThermal
                ...
                public void onValues(
                    ThermalStatus status,
                    ArrayList<android.hardware.thermal.V2_0.CoolingDevice> devices) {
                  _hidl_reply.writeStatus(0);
                  status.writeToParcel(_hidl_reply);
        ...
        case 11:
          ...
          ISehThermalChangedCallback callback3 =
              ISehThermalChangedCallback.asInterface(_hidl_request.readStrongBinder());
