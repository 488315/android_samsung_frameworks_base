...
public abstract class Transition implements Cloneable {
  ...
  public Transition(Context context, AttributeSet attrs) {
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.Transition);
    ...
    while (true) {
      ...
      if (i < iArr.length) {
        switch (iArr[i]) {
          ...
          case 4:
            matchItemIds(
                unmatchedStart, unmatchedEnd, startValues.itemIdValues, endValues.itemIdValues);
            break;
        }
        i++;
      } else {
          ...
          if (animator3 != null) {
            ...
            if (animator != null) {
              ...
              runningAnimators.put(
                  animator,
                  new AnimationInfo(view, getName(), this, sceneRoot.getWindowId(), infoValues));
  ...
  public boolean isValidTarget(View target) {
    ...
    if ((this.mTargetIds.size() == 0
            ...
            && (((arrayList = this.mTargetTypes) == null || arrayList.isEmpty())
                && ((arrayList2 = this.mTargetNames) == null || arrayList2.isEmpty())))
  ...
  void captureValues(ViewGroup sceneRoot, boolean start) {
    ...
    if ((this.mTargetIds.size() > 0 || this.mTargets.size() > 0)
        && (((arrayList = this.mTargetNames) == null || arrayList.isEmpty())
            && ((arrayList2 = this.mTargetTypes) == null || arrayList2.isEmpty()))) {
  ...
  static void addViewValues(
      TransitionValuesMaps transitionValuesMaps, View view, TransitionValues transitionValues) {
  ...
  void playTransition(ViewGroup sceneRoot) {
    ...
    createAnimators(
        sceneRoot, this.mStartValues, this.mEndValues, this.mStartValuesList, this.mEndValuesList);
    runAnimators();
  }
  ...
  public static class AnimationInfo {
    ...
    AnimationInfo(
        View view, String name, Transition transition, WindowId windowId, TransitionValues values) {
      this.view = view;
      this.name = name;
      this.values = values;
