...
public abstract class Visibility extends Transition {
  ...
  public Visibility(Context context, AttributeSet attrs) {
    ...
    this.mMode = 3;
    this.mSuppressLayout = true;
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.VisibilityTransition);
  ...
  private static VisibilityInfo getVisibilityChangeInfo(
  ...
  public Animator createAnimator(
    ...
    if (visInfo.startParent != null || visInfo.endParent != null) {
      if (visInfo.fadeIn) {
        return onAppear(
            sceneRoot, startValues, visInfo.startVisibility, endValues, visInfo.endVisibility);
      }
      return onDisappear(
          sceneRoot, startValues, visInfo.startVisibility, endValues, visInfo.endVisibility);
    }
  ...
  public Animator onDisappear(
    ...
    View savedOverlayView = (View) startView.getTag(C4337R.id.transition_overlay_view_tag);
        ...
        if (startView.getParent() == null) {
          ...
          if (!parentVisibilityInfo.visibilityChange) {
            ...
            if (startParent.getParent() == null
                && id != -1
                && sceneRoot.findViewById(id) != null
    ...
    if (overlayView != null) {
      ...
      if (!reusingOverlayView) {
        if (animator == null) {
          ...
          startView.setTagInternal(C4337R.id.transition_overlay_view_tag, overlayView);
          final View finalOverlayView = overlayView;
          addListener(
              new TransitionListenerAdapter() { // from class: android.transition.Visibility.1
                ...
                public void onTransitionEnd(Transition transition) {
                  startView.setTagInternal(C4337R.id.transition_overlay_view_tag, null);
                  overlay.remove(finalOverlayView);
    ...
    if (viewToKeep != null) {
      ...
      if (animator2 != null) {
        DisappearListener disappearListener =
            new DisappearListener(viewToKeep, endVisibility, this.mSuppressLayout);
