...
public class ChangeTransform extends Transition {
  ...
  private static final Property<PathAnimatorMatrix, float[]> NON_TRANSLATIONS_PROPERTY =
      new Property<PathAnimatorMatrix, float[]>(
          float[].class, "nonTranslations") { // from class: android.transition.ChangeTransform.1
  ...
  private static final Property<PathAnimatorMatrix, PointF> TRANSLATIONS_PROPERTY =
      new Property<PathAnimatorMatrix, PointF>(
          PointF.class, "translations") { // from class: android.transition.ChangeTransform.2
        @Override // android.util.Property
  ...
  public ChangeTransform(Context context, AttributeSet attrs) {
    ...
    this.mReparent = true;
    this.mTempMatrix = new Matrix();
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ChangeTransform);
  ...
  private void captureValues(TransitionValues transitionValues) {
    ...
    if (this.mReparent) {
      ...
      transitionValues.values.put(
          PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C4337R.id.transitionTransform));
      transitionValues.values.put(
          PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C4337R.id.parentMatrix));
    }
  }
  ...
  public Animator createAnimator(
    ...
    if (startValues != null
      ...
      Matrix startParentMatrix =
          (Matrix) startValues.values.get(PROPNAME_INTERMEDIATE_PARENT_MATRIX);
      ...
      ObjectAnimator transformAnimator =
          createTransformAnimator(startValues, endValues, handleParentChange);
  ...
  private ObjectAnimator createTransformAnimator(
      TransitionValues startValues, TransitionValues endValues, final boolean handleParentChange) {
    ...
    Path path =
        getPathMotion()
            .getPath(
                startMatrixValues[2], startMatrixValues[5], endMatrixValues[2], endMatrixValues[5]);
    PropertyValuesHolder translationProperty =
        PropertyValuesHolder.ofObject(TRANSLATIONS_PROPERTY, (TypeConverter) null, path);
    ObjectAnimator animator =
        ObjectAnimator.ofPropertyValuesHolder(
            pathAnimatorMatrix, valuesProperty, translationProperty);
    final Matrix finalEndMatrix = endMatrix;
    AnimatorListenerAdapter listener =
        new AnimatorListenerAdapter() { // from class: android.transition.ChangeTransform.3
          ...
          public void onAnimationEnd(Animator animation) {
            if (!this.mIsCanceled) {
              if (handleParentChange && ChangeTransform.this.mUseOverlay) {
                ...
                view.setTagInternal(C4337R.id.transitionTransform, null);
                view.setTagInternal(C4337R.id.parentMatrix, null);
              }
            }
          ...
          private void setCurrentMatrix(Matrix currentMatrix) {
            ...
            view.setTagInternal(C4337R.id.transitionTransform, this.mTempMatrix);
            transforms.restore(view);
          }
        };
  ...
  private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
    ...
    endValues.view.setTagInternal(C4337R.id.parentMatrix, endParentMatrix);
  ...
  private static class GhostListener extends TransitionListenerAdapter {
    ...
    public void onTransitionEnd(Transition transition) {
      ...
      this.mView.setTagInternal(C4337R.id.transitionTransform, null);
      this.mView.setTagInternal(C4337R.id.parentMatrix, null);
  ...
  private static class PathAnimatorMatrix {
    ...
    public void setTranslation(PointF translation) {
      this.mTranslationX = translation.f87x;
      this.mTranslationY = translation.f88y;
      setAnimationMatrix();
    }
