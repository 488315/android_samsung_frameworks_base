...
public class ChangeBounds extends Transition {
  ...
  private static final Property<Drawable, PointF> DRAWABLE_ORIGIN_PROPERTY =
      new Property<Drawable, PointF>(
          PointF.class, "boundsOrigin") { // from class: android.transition.ChangeBounds.1
        private Rect mBounds = new Rect();

        @Override // android.util.Property
        public void set(Drawable object, PointF value) {
          object.copyBounds(this.mBounds);
          this.mBounds.offsetTo(Math.round(value.f87x), Math.round(value.f88y));
  ...
  private static final Property<View, PointF> POSITION_PROPERTY =
      new Property<View, PointF>(
          PointF.class, "position") { // from class: android.transition.ChangeBounds.6
        @Override // android.util.Property
        public void set(View view, PointF topLeft) {
          int left = Math.round(topLeft.f87x);
          int top = Math.round(topLeft.f88y);
  ...
  static {
    String str = "topLeft";
    TOP_LEFT_PROPERTY =
        new Property<ViewBounds, PointF>(
            PointF.class, str) { // from class: android.transition.ChangeBounds.2
          @Override // android.util.Property
    ...
    BOTTOM_RIGHT_PROPERTY =
        new Property<ViewBounds, PointF>(
            PointF.class, str2) { // from class: android.transition.ChangeBounds.3
          @Override // android.util.Property
    ...
    BOTTOM_RIGHT_ONLY_PROPERTY =
        new Property<View, PointF>(
            PointF.class, str2) { // from class: android.transition.ChangeBounds.4
          @Override // android.util.Property
          public void set(View view, PointF bottomRight) {
            int left = view.getLeft();
            int top = view.getTop();
            int right = Math.round(bottomRight.f87x);
            int bottom = Math.round(bottomRight.f88y);
            view.setLeftTopRightBottom(left, top, right, bottom);
          }
    ...
    TOP_LEFT_ONLY_PROPERTY =
        new Property<View, PointF>(
            PointF.class, str) { // from class: android.transition.ChangeBounds.5
          @Override // android.util.Property
          public void set(View view, PointF topLeft) {
            int left = Math.round(topLeft.f87x);
            int top = Math.round(topLeft.f88y);
  ...
  public ChangeBounds(Context context, AttributeSet attrs) {
    ...
    this.mResizeClip = false;
    this.mReparent = false;
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ChangeBounds);
    ...
    if (startValues != null && endValues != null) {
      ...
      if (startParent != null && endParent != null) {
        ...
        if (parentMatches(startParent, endParent)) {
          ...
          if ((startClip3 != null && !startClip3.equals(endClip3))
              || (startClip3 == null && endClip3 != null)) {
            numChanges++;
          }
          if (numChanges > 0) {
            if (!(view2.getParent() instanceof ViewGroup)) {
              ...
              Transition.TransitionListener transitionListener =
                  new TransitionListenerAdapter() { // from class: android.transition.ChangeBounds.7
            ...
            if (changeBounds.mResizeClip) {
              ...
              view2.setLeftTopRightBottom(
                  startLeft, startTop2, startLeft + maxWidth, startTop2 + maxHeight);
              if (startLeft == endLeft2 && startTop2 == endTop) {
                ...
                positionAnimator =
                    ObjectAnimator.ofObject(
                        view2,
                        (Property<View, V>) POSITION_PROPERTY,
                        (TypeConverter) null,
                        topLeftPath);
              }
              ...
              if (startClip2.equals(endClip2)) {
                ...
                ObjectAnimator clipAnimator2 =
                    ObjectAnimator.ofObject(
                        view2, "clipBounds", sRectEvaluator, startClip2, endClip2);
                final int endLeft3 = endLeft;
                positionAnimator2 = positionAnimator;
                clipAnimator2.addListener(
                    new AnimatorListenerAdapter() { // from class: android.transition.ChangeBounds.9
            ...
            if (numChanges == 2) {
              if (startWidth != endWidth || startHeight != endHeight) {
                ...
                ObjectAnimator topLeftAnimator =
                    ObjectAnimator.ofObject(
                        viewBounds,
                        (Property<ViewBounds, V>) TOP_LEFT_PROPERTY,
                        (TypeConverter) null,
                        topLeftPath2);
                Path bottomRightPath =
                    getPathMotion().getPath(startRight, startBottom, endRight, endBottom);
                ObjectAnimator bottomRightAnimator =
                    ObjectAnimator.ofObject(
                        viewBounds,
                        (Property<ViewBounds, V>) BOTTOM_RIGHT_PROPERTY,
                        (TypeConverter) null,
                        bottomRightPath);
                ...
                set.addListener(
                    new AnimatorListenerAdapter(
                        viewBounds) { // from class: android.transition.ChangeBounds.8
              ...
              return ObjectAnimator.ofObject(
                  view2, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath3);
            }
            if (startLeft != endLeft2) {
              ...
              return ObjectAnimator.ofObject(
                  view2,
                  (Property<View, V>) BOTTOM_RIGHT_ONLY_PROPERTY,
                  (TypeConverter) null,
                  bottomRight);
            }
            ...
            return ObjectAnimator.ofObject(
                view,
                (Property<View, V>) TOP_LEFT_ONLY_PROPERTY,
                (TypeConverter) null,
                topLeftPath4);
          }
          return null;
        ...
        int startX =
            ((Integer) startValues.values.get(PROPNAME_WINDOW_X)).intValue() - this.tempLocation[0];
        int startY =
            ((Integer) startValues.values.get(PROPNAME_WINDOW_Y)).intValue() - this.tempLocation[1];
        int endX =
            ((Integer) endValues.values.get(PROPNAME_WINDOW_X)).intValue() - this.tempLocation[0];
        int endY =
            ((Integer) endValues.values.get(PROPNAME_WINDOW_Y)).intValue() - this.tempLocation[1];
        if (startX != endX || startY != endY) {
          ...
          PropertyValuesHolder origin =
              PropertyValuesHolder.ofObject(
                  DRAWABLE_ORIGIN_PROPERTY, (TypeConverter) null, topLeftPath5);
          ObjectAnimator anim = ObjectAnimator.ofPropertyValuesHolder(drawable, origin);
          anim.addListener(
              new AnimatorListenerAdapter() { // from class: android.transition.ChangeBounds.10
                @Override // android.animation.AnimatorListenerAdapter,
                          // android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
  ...
  private static class ViewBounds {
    ...
    public void setTopLeft(PointF topLeft) {
      this.mLeft = Math.round(topLeft.f87x);
      this.mTop = Math.round(topLeft.f88y);
    ...
    public void setBottomRight(PointF bottomRight) {
      this.mRight = Math.round(bottomRight.f87x);
      this.mBottom = Math.round(bottomRight.f88y);
