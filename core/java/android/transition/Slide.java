...
public class Slide extends Visibility {
  ...
  public Slide(Context context, AttributeSet attrs) {
    ...
    this.mSlideEdge = 80;
    this.mSlideFraction = 1.0f;
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.Slide);
  ...
  public Animator onDisappear(
    ...
    return TranslationAnimationCreator.createAnimation(
        view, startValues, position[0], position[1], startX, startY, endX, endY, sAccelerate, this);
  }
