...
public class Explode extends Visibility {
  ...
  public Animator onAppear(
    ...
    return TranslationAnimationCreator.createAnimation(
        view, endValues, bounds.left, bounds.top, startX, startY, endX, endY, sDecelerate, this);
  }
  ...
  public Animator onDisappear(
    ...
    float endX = startX;
    float endY = startY;
    int[] interruptedPosition = (int[]) startValues.view.getTag(C4337R.id.transitionPosition);
