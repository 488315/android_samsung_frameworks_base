            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    ...
                    if ("fade".equals(name)) {
                        ...
                        transition = (Transition) createCustom(attrs, Transition.class, SemLocationManager.GEOFENCE_TRANSITION);
            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    ...
                    if (name.equals("target")) {
                        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C4337R.styleable.TransitionTarget);
