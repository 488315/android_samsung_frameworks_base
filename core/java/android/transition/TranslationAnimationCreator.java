...
class TranslationAnimationCreator {
  ...
  static Animator createAnimation(
    ...
    int[] startPosition = (int[]) values.view.getTag(C4337R.id.transitionPosition);
  ...
  private static class TransitionPositionListener extends AnimatorListenerAdapter
    ...
    private TransitionPositionListener(
      ...
      int[] iArr = (int[]) viewInHierarchy.getTag(C4337R.id.transitionPosition);
      this.mTransitionPosition = iArr;
      if (iArr != null) {
        viewInHierarchy.setTagInternal(C4337R.id.transitionPosition, null);
      }
    }
    ...
    public void onAnimationCancel(Animator animation) {
      ...
      this.mViewInHierarchy.setTagInternal(C4337R.id.transitionPosition, this.mTransitionPosition);
    }
