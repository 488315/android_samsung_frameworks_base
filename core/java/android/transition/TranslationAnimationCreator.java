...
class TranslationAnimationCreator {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter
        ...
        private TransitionPositionListener(
            ...
            this.mTransitionPosition =
                    (int[]) this.mViewInHierarchy.getTag(R.id.transitionPosition);
        ...
        public void onAnimationCancel(Animator animation) {
            ...
            this.mTransitionPosition[0] =
                    Math.round(this.mStartX + this.mMovingView.getTranslationX());
            this.mTransitionPosition[1] =
                    Math.round(this.mStartY + this.mMovingView.getTranslationY());
