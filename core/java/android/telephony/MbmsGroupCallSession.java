        ...
        ServiceConnection serviceConnection = new ServiceConnection() { // from class: android.telephony.MbmsGroupCallSession.3
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    Log.m96e(MbmsGroupCallSession.LOG_TAG, "Service died before initialization");
                    MbmsGroupCallSession.this.mInternalCallback.onError(103, e2.toString());
                    MbmsGroupCallSession.sIsInitialized.set(false);
                } catch (RuntimeException e3) {
                    Log.m96e(MbmsGroupCallSession.LOG_TAG, "Runtime exception during initialization");
            ...
            public void onNullBinding(ComponentName name) {
                Log.m102w(MbmsGroupCallSession.LOG_TAG, "bindAndInitialize: Remote service returned null");
