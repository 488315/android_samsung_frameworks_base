...
public abstract class Qos {
  ...
  public static class QosBandwidth implements Parcelable {
    ...
    public int hashCode() {
      return Objects.hash(
          Integer.valueOf(this.maxBitrateKbps), Integer.valueOf(this.guaranteedBitrateKbps));
    }
  ...
  protected Qos(Parcel source) {
    ...
    this.downlink =
        (QosBandwidth)
            source.readParcelable(QosBandwidth.class.getClassLoader(), QosBandwidth.class);
    this.uplink =
        (QosBandwidth)
            source.readParcelable(QosBandwidth.class.getClassLoader(), QosBandwidth.class);
  }
