...
public final class QosBearerSession implements Parcelable {
    ...
    public QosBearerSession(
            int qosBearerSessionId, Qos qos, List<QosBearerFilter> qosBearerFilterList) {
    ...
    private QosBearerSession(Parcel source) {
        ...
        this.qosBearerFilterList = new ArrayList();
        source.readList(
                this.qosBearerFilterList,
                QosBearerFilter.class.getClassLoader(),
                QosBearerFilter.class);
    }
    ...
    public String toString() {
        return "QosBearerSession { qosBearerSessionId="
                + this.qosBearerSessionId
                + " qos="
                + this.qos
                + " qosBearerFilterList="
                + this.qosBearerFilterList
    ...
    public int hashCode() {
        return Objects.hash(
                Integer.valueOf(this.qosBearerSessionId), this.qos, this.qosBearerFilterList);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (this.qosBearerSessionId == other.qosBearerSessionId
