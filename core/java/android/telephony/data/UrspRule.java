...
public final class UrspRule implements Parcelable {
  ...
  public boolean equals(Object o) {
    ...
    if (this.mPrecedence == that.mPrecedence
        && this.mTrafficDescriptors.size() == that.mTrafficDescriptors.size()
        && this.mTrafficDescriptors.containsAll(that.mTrafficDescriptors)
        && this.mRouteSelectionDescriptor.size() == that.mRouteSelectionDescriptor.size()
        && this.mRouteSelectionDescriptor.containsAll(that.mRouteSelectionDescriptor)) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        this.mRouteSelectionDescriptor);
  }
