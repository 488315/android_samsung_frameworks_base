...
public final class DataProfile implements Parcelable {
  public static final Parcelable.Creator<DataProfile> CREATOR =
      new Parcelable.Creator<DataProfile>() { // from class: android.telephony.data.DataProfile.1
  ...
  private DataProfile(Parcel source) {
    ...
    this.mApnSetting =
        (ApnSetting) source.readParcelable(ApnSetting.class.getClassLoader(), ApnSetting.class);
  ...
  public boolean canSatisfy(int networkCapability) {
    ...
    return apnSetting != null
        && apnSetting.canHandleType(networkCapabilityToApnType(networkCapability));
  }
