...
public abstract class DataService extends Service {
      ...
      synchronized (this.mDataCallListChangedCallbacks) {
        for (IDataServiceCallback callback : this.mDataCallListChangedCallbacks) {
          DataService.this
              .mHandler
              .obtainMessage(
                  11, this.mSlotIndex, 0, new DataCallListChangedIndication(dataCallList, callback))
              .sendToTarget();
        }
      }
    }
    ...
    public final void notifyApnUnthrottled(String apn) {
      synchronized (this.mApnUnthrottledCallbacks) {
        for (IDataServiceCallback callback : this.mApnUnthrottledCallbacks) {
          DataService.this
              .mHandler
              .obtainMessage(16, this.mSlotIndex, 0, new ApnUnthrottledIndication(apn, callback))
              .sendToTarget();
        }
      }
    }
      ...
      synchronized (this.mApnUnthrottledCallbacks) {
        for (IDataServiceCallback callback : this.mApnUnthrottledCallbacks) {
          DataService.this
              .mHandler
              .obtainMessage(
                  16, this.mSlotIndex, 0, new ApnUnthrottledIndication(dataProfile, callback))
              .sendToTarget();
        }
      }
    }
        ...
        case 12:
          if (serviceProvider2 == null) {
            ...
            serviceProvider2.startHandover(
                bReq.cid, bReq.callback != null ? new DataServiceCallback(bReq.callback) : null);
            serviceProvider = serviceProvider2;
            break;
          }
        case 13:
          if (serviceProvider2 == null) {
            ...
            serviceProvider2.cancelHandover(
                cReq.cid, cReq.callback != null ? new DataServiceCallback(cReq.callback) : null);
            serviceProvider = serviceProvider2;
            break;
          }
        case 14:
  ...
  private class IDataServiceWrapper extends IDataService.Stub {
    ...
    public void deactivateDataCall(
      ...
      DataService.this
          .mHandler
          .obtainMessage(5, slotIndex, 0, new DeactivateDataCallRequest(cid, reason, callback))
          .sendToTarget();
    }

    @Override // android.telephony.data.IDataService
    public void setInitialAttachApn(
        int slotIndex, DataProfile dataProfile, boolean isRoaming, IDataServiceCallback callback) {
      DataService.this
          .mHandler
          .obtainMessage(
              6, slotIndex, 0, new SetInitialAttachApnRequest(dataProfile, isRoaming, callback))
          .sendToTarget();
    }

    @Override // android.telephony.data.IDataService
    public void setDataProfile(
        int slotIndex, List<DataProfile> dps, boolean isRoaming, IDataServiceCallback callback) {
      DataService.this
          .mHandler
          .obtainMessage(7, slotIndex, 0, new SetDataProfileRequest(dps, isRoaming, callback))
          .sendToTarget();
    }
