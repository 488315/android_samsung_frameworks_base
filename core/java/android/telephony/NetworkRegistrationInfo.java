...
public final class NetworkRegistrationInfo implements Parcelable {
  public static final Parcelable.Creator<NetworkRegistrationInfo> CREATOR =
      new Parcelable.Creator<
          NetworkRegistrationInfo>() { // from class: android.telephony.NetworkRegistrationInfo.1
  ...
  private NetworkRegistrationInfo(Parcel source) {
    ...
    this.mCellIdentity =
        (CellIdentity)
            source.readParcelable(CellIdentity.class.getClassLoader(), CellIdentity.class);
  ...
  public String toString() {
    StringBuilder append =
        new StringBuilder("NetworkRegistrationInfo{")
            .append(" domain=")
            .append(domainToString(this.mDomain))
            .append(" transportType=")
            .append(AccessNetworkConstants.transportTypeToString(this.mTransportType))
            .append(" registrationState=")
            .append(registrationStateToString(this.mRegistrationState))
            .append(" networkRegistrationState=")
            .append(registrationStateToString(this.mNetworkRegistrationState))
            .append(" roamingType=")
            .append(ServiceState.roamingTypeToString(this.mRoamingType))
            .append(" accessNetworkTechnology=")
            .append(TelephonyManager.getNetworkTypeName(this.mAccessNetworkTechnology))
            .append(" rejectCause=")
            .append(this.mRejectCause)
            .append(" emergencyEnabled=")
            .append(this.mEmergencyOnly)
            .append(" availableServices=");
    ...
    return append
        .append(
            append2
                ...
                .toString())
        .append(" cellIdentity=")
        .append(this.mCellIdentity)
        .append(" voiceSpecificInfo=")
        .append(this.mVoiceSpecificInfo)
        .append(" dataSpecificInfo=")
        .append(this.mDataSpecificInfo)
        .append(" nrState=")
        .append(Build.IS_DEBUGGABLE ? nrStateToString(this.mNrState) : "****")
        .append(" rRplmn=")
        .append(this.mRplmn)
        .append(" isUsingCarrierAggregation=")
        .append(this.mIsUsingCarrierAggregation)
        .append(" isNonTerrestrialNetwork=")
        .append(isNonTerrestrialNetworkToString(this.mIsNonTerrestrialNetwork))
        .append("}")
        .toString();
  }
