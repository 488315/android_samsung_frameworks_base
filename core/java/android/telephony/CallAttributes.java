...
public final class CallAttributes implements Parcelable {
  ...
  private CallAttributes(Parcel in) {
    this.mPreciseCallState =
        (PreciseCallState)
            in.readParcelable(PreciseCallState.class.getClassLoader(), PreciseCallState.class);
    this.mNetworkType = in.readInt();
    this.mCallQuality =
        (CallQuality) in.readParcelable(CallQuality.class.getClassLoader(), CallQuality.class);
  }
