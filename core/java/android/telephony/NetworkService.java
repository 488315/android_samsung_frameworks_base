...
public abstract class NetworkService extends Service {
        ...
        case 1:
          if (serviceProvider == null) {
            NetworkService.this.mServiceMap.put(
                slotIndex, NetworkService.this.onCreateNetworkServiceProvider(slotIndex));
            break;
          }
          break;
        case 2:
  ...
  private final void log(String s) {
    com.android.telephony.Rlog.m238d(this.TAG, s);
  }

  private final void loge(String s) {
    com.android.telephony.Rlog.m240e(this.TAG, s);
  }
}
