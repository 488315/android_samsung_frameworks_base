...
public final class ModemActivityInfo implements Parcelable {
      ...
      new Parcelable.Creator<
        ...
        public ModemActivityInfo createFromParcel(Parcel in) {
          ...
          Parcelable[] tempSpecifiers =
              (Parcelable[]) in.createTypedArray(ActivityStatsTechSpecificInfo.CREATOR);
  ...
  public ModemActivityInfo(
    ...
    ActivityStatsTechSpecificInfo[] activityStatsTechSpecificInfoArr = {
  ...
  public int[] getTransmitTimeMillis(int rat) {
    ...
    while (true) {
      ActivityStatsTechSpecificInfo[] activityStatsTechSpecificInfoArr =
          this.mActivityStatsTechSpecificInfo;
          ...
          if (this.mActivityStatsTechSpecificInfo[j].getRat() == 6) {
            if (other.mActivityStatsTechSpecificInfo[i].getFrequencyRange()
              ...
              for (int lvl = 0; lvl < 5; lvl++) {
                txTimeMs[lvl] =
                    (int)
                        (other.getTransmitDurationMillisAtPowerLevel(lvl, rat, freq)
                            - getTransmitDurationMillisAtPowerLevel(lvl, rat, freq));
              }
              matched = true;
              ...
              txTimeMs2[lvl2] =
                  (int)
                      (other.getTransmitDurationMillisAtPowerLevel(lvl2, rat)
                          - getTransmitDurationMillisAtPowerLevel(lvl2, rat));
            }
            matched = true;
            mDeltaSpecificInfo[i] =
                new ActivityStatsTechSpecificInfo(
                    ...
                    0,
                    txTimeMs2,
                    (int) (other.getReceiveTimeMillis(rat) - getReceiveTimeMillis(rat)));
          }
        }
      }
      if (!matched) {
