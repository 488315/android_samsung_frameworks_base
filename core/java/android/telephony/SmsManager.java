...
public final class SmsManager {
    ...
    private void sendTextMessageInternal(final String destinationAddress, final String scAddress, final String text, final PendingIntent sentIntent, final PendingIntent deliveryIntent, final boolean persistMessage, final String packageName, final String attributionTag, final long messageId) {
            ...
            resolveSubscriptionForOperation(new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.1
                ...
                public void onSuccess(int subId) {
                    ...
                    try {
                        ...
                        Log.m96e(SmsManager.TAG, "sendTextMessageInternal: Couldn't send SMS, exception - " + e.getMessage() + " " + SmsManager.formatCrossStackMessageId(messageId));
        ...
        try {
            ...
            Log.m96e(TAG, "sendTextMessageInternal (no persist): Couldn't send SMS, exception - " + e.getMessage() + " " + formatCrossStackMessageId(messageId));
    ...
    private void sendTextMessageInternal(final String destinationAddress, final String scAddress, final String text, final PendingIntent sentIntent, final PendingIntent deliveryIntent, final boolean persistMessage, int priority, final boolean expectMore, int validityPeriod) {
            ...
            resolveSubscriptionForOperation(new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.2
                ...
                public void onSuccess(int subId) {
                    try {
                        ...
                        Log.m96e(SmsManager.TAG, "sendTextMessageInternal: Couldn't send SMS, exception - " + e.getMessage());
                        SmsManager.notifySmsError(sentIntent, 31);
                    }
                }
        ...
        try {
            ...
            Log.m96e(TAG, "sendTextMessageInternal(no persist): Couldn't send SMS, exception - " + e.getMessage());
            notifySmsError(sentIntent, 31);
        }
    }
            ...
            if ((parts != null && parts.size() >= 1) || isSupportSendingEmptySms()) {
                if (parts.size() > 1) {
                        ...
                        resolveSubscriptionForOperation(new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.3
                            ...
                            public void onSuccess(int subId) {
                                try {
                                    ...
                                    Log.m96e(SmsManager.TAG, "sendMultipartTextMessageInternal: Couldn't send SMS - " + e.getMessage() + " " + SmsManager.formatCrossStackMessageId(messageId));
                    ...
                    try {
                        ...
                        Log.m96e(TAG, "sendMultipartTextMessageInternal: Couldn't send SMS - " + e.getMessage() + " " + formatCrossStackMessageId(messageId));
                ...
                resolveSubscriptionForOperation(new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.4
                    ...
                    public void onSuccess(int subId) {
                        try {
                            ...
                            Log.m96e(SmsManager.TAG, "sendMultipartTextMessageInternal: Couldn't send SMS - " + e.getMessage());
                            SmsManager.notifySmsError((List<PendingIntent>) sentIntents, 31);
                        }
                    }
            ...
            try {
                ...
                if (iSms != null) {
                    ...
                    try {
                        ...
                        e = e;
                        Log.m96e(TAG, "sendMultipartTextMessageInternal (no persist): Couldn't send SMS - " + e.getMessage());
        ...
        resolveSubscriptionForOperation(new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.5
            ...
            public void onSuccess(int subId) {
                try {
                    ...
                    Log.m96e(SmsManager.TAG, "sendDataMessage: Couldn't send SMS - Exception: " + e.getMessage());
                    SmsManager.notifySmsError(sentIntent, 31);
                }
            }
    ...
    private void resolveSubscriptionForOperation(final SubscriptionResolverResult resolverResult) {
        ...
        if (isSmsSimPickActivityNeeded) {
            Log.m94d(TAG, "resolveSubscriptionForOperation isSmsSimPickActivityNeeded is true for calling package. ");
            try {
    ...
    public boolean enableCellBroadcastRange(int startMessageId, int endMessageId, int ranType) {
        ...
        try {
            ...
            if (iSms != null) {
                ...
                com.android.telephony.Rlog.m238d(TAG, "enableCellBroadcastRange: " + (success ? "succeeded" : "failed") + " at calling enableCellBroadcastRangeForSubscriber. subId = " + subId);
            }
        } catch (RemoteException ex) {
    ...
    public boolean disableCellBroadcastRange(int startMessageId, int endMessageId, int ranType) {
        ...
        try {
            ...
            if (iSms != null) {
                ...
                com.android.telephony.Rlog.m238d(TAG, "disableCellBroadcastRange: " + (success ? "succeeded" : "failed") + " at calling disableCellBroadcastRangeForSubscriber. subId = " + subId);
            }
        } catch (RemoteException ex) {
    ...
    public SemCbConfig semGetCbSettings() {
        ...
        try {
            ...
            ex.printStackTrace();
            com.android.telephony.Rlog.m238d(TAG, "[CB] IllegalArgumentException Exception In getCbConfig of SmsManager");
        } catch (NullPointerException e2) {
        }
        if (iccISms == null) {
            return null;
        ...
        if (subId >= 0) {
            ...
            for (int j = 0; j < msgIds.length; j++) {
                try {
                    ...
                    com.android.telephony.Rlog.m238d(TAG, "[CB ] ArrayIndexOutOfBoundsException In getCbConfig of SmsManager.java");
                    return null;
                }
            }
            cbConfig.msgIds = msgIds;
            com.android.telephony.Rlog.m238d(TAG, "[SmsManger- CB] bCBEnabled = " + cbConfig.bCBEnabled + " selectedId = " + cbConfig.selectedId + " msgIdMaxCount = " + cbConfig.msgIdMaxCount + " msgIdCount = " + cbConfig.msgIdCount);
    ...
    public void sendTextMessage(String destinationAddress, String scAddress, String text, PendingIntent sentIntent, PendingIntent deliveryIntent, boolean replyPath, int expiry, int serviceType, int encodingType) {
        com.android.telephony.Rlog.m242i(TAG, "sendTextMessage with encoding Type: mno - " + getMnoName());
        if (TextUtils.isEmpty(destinationAddress)) {
            throw new IllegalArgumentException("Invalid destinationAddress");
        }
        if (getMnoName().toUpperCase().contains("DOCOMO") && destinationAddress.length() >= 256) {
    ...
    public ArrayList<SmsMessage> getAllMessagesFromIccSimType(int iccType) {
        ...
        try {
            try {
                ...
                com.android.telephony.Rlog.m238d(TAG, "getAllMessagesFromIccSimType - exception - iccType:" + iccType2);
            }
            if (iccType2 == 4) {
                format = getFormat;
            } else if (iccType2 == 10) {
            ...
            com.android.telephony.Rlog.m238d(TAG, "getAllMessagesFromIccSimType, subId = " + subId + " format = " + format + " iccType = " + iccType2);
    ...
    public void sendTextMessageNSRI(String destinationAddress, String scAddress, byte[] data, PendingIntent sentIntent, PendingIntent deliveryIntent, String from, int msgCount, int msgTotal) {
        ...
        Log.m94d(TAG, "[NSRI_SMS] sendTextMessageNSRI Addr = " + destinationAddress + " Smsc = " + scAddress + " textLen = " + data.length + " from = " + from + " msgCount = " + msgCount + " msgTotal = " + msgTotal);
        try {
            ISms iccISms = getISmsService();
            if (iccISms != null) {
