...
public final class SmsManager {
  ...
  @SystemApi public static final int PREMIUM_SMS_CONSENT_ALWAYS_ALLOW = 3;

  @SystemApi public static final int PREMIUM_SMS_CONSENT_ASK_USER = 1;

  @SystemApi public static final int PREMIUM_SMS_CONSENT_NEVER_ALLOW = 2;

  @SystemApi public static final int PREMIUM_SMS_CONSENT_UNKNOWN = 0;
  ...
  private static final SmsManager DEFAULT_INSTANCE =
      getSmsManagerForContextAndSubscriptionId(null, Integer.MAX_VALUE);
  ...
  private void sendTextMessageInternal(
    ...
    if (persistMessage) {
      resolveSubscriptionForOperation(
          new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.1
            ...
            public void onSuccess(int subId) {
              ...
              try {
                ...
                Log.m96e(
                    SmsManager.TAG,
                    "sendTextMessageInternal: Couldn't send SMS, exception - "
                        + e.getMessage()
                        + " "
                        + SmsManager.formatCrossStackMessageId(messageId));
    ...
    try {
      ...
      Log.m96e(
          TAG,
          "sendTextMessageInternal (no persist): Couldn't send SMS, exception - "
              + e.getMessage()
              + " "
  ...
  private void sendTextMessageInternal(
    ...
    if (priority >= 0 && priority <= 3) {
      ...
      Log.m96e(TAG, "Invalid Priority " + priority);
      priority2 = -1;
    }
    if (validityPeriod2 < 5 || validityPeriod2 > 635040) {
      Log.m96e(TAG, "Invalid Validity Period " + validityPeriod2);
      validityPeriod2 = -1;
    }
    ...
    if (persistMessage) {
      resolveSubscriptionForOperation(
          new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.2
            @Override // android.telephony.SmsManager.SubscriptionResolverResult
            public void onSuccess(int subId) {
              try {
                ISms iSms = SmsManager.getISmsServiceOrThrow();
                ...
                Log.m96e(
                    SmsManager.TAG,
                    "sendTextMessageInternal: Couldn't send SMS, exception - " + e.getMessage());
                SmsManager.notifySmsError(sentIntent, 31);
              }
            }
    ...
    try {
      ...
      Log.m96e(
          TAG,
          "sendTextMessageInternal(no persist): Couldn't send SMS, exception - " + e.getMessage());
      notifySmsError(sentIntent, 31);
    }
  }
  ...
  private void sendMultipartTextMessageInternal(
      ...
      final List<PendingIntent> sentIntents,
      final List<PendingIntent> deliveryIntents,
      final boolean persistMessage,
      final String packageName,
      final String attributionTag,
      final long messageId) {
    ...
    if (!getMnoName().toUpperCase().contains("DOCOMO") || destinationAddress.length() < 256) {
      if ((parts != null && parts.size() >= 1) || isSupportSendingEmptySms()) {
        if (parts.size() > 1) {
          if (persistMessage) {
            resolveSubscriptionForOperation(
                new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.3
                  @Override // android.telephony.SmsManager.SubscriptionResolverResult
                  public void onSuccess(int subId) {
                    try {
                      ISms iSms = SmsManager.getISmsServiceOrThrow();
                      iSms.sendMultipartTextForSubscriber(
                          subId,
                          packageName,
                          attributionTag,
                          destinationAddress,
                      ...
                      Log.m96e(
                          SmsManager.TAG,
                          "sendMultipartTextMessageInternal: Couldn't send SMS - "
                              + e.getMessage()
                              + " "
                              + SmsManager.formatCrossStackMessageId(messageId));
  ...
  private void sendMultipartTextMessageInternal(
    ...
    if (validityPeriod < 5 || validityPeriod > 635040) {
      Log.m96e(TAG, "Invalid Validity Period " + validityPeriod);
      validityPeriod2 = -1;
    } else {
    ...
    if (parts.size() > 1) {
      ...
      if (persistMessage) {
        resolveSubscriptionForOperation(
            new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.4
              @Override // android.telephony.SmsManager.SubscriptionResolverResult
              public void onSuccess(int subId) {
                try {
                  ISms iSms = SmsManager.getISmsServiceOrThrow();
                  ...
                  Log.m96e(
                      SmsManager.TAG,
                      "sendMultipartTextMessageInternal: Couldn't send SMS - " + e.getMessage());
                  SmsManager.notifySmsError((List<PendingIntent>) sentIntents, 31);
                }
              }
      ...
      try {
        ...
        if (iSms != null) {
          ...
          try {
            ...
            Log.m96e(
                TAG,
                "sendMultipartTextMessageInternal (no persist): Couldn't send SMS - "
                    + e.getMessage());
  ...
  public void sendDataMessage(
    ...
    resolveSubscriptionForOperation(
        new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.5
          @Override // android.telephony.SmsManager.SubscriptionResolverResult
          public void onSuccess(int subId) {
            try {
              ISms iSms = SmsManager.getISmsServiceOrThrow();
              ...
              Log.m96e(
                  SmsManager.TAG,
                  "sendDataMessage: Couldn't send SMS - Exception: " + e.getMessage());
              SmsManager.notifySmsError(sentIntent, 31);
            }
          }
  ...
  private void resolveSubscriptionForOperation(final SubscriptionResolverResult resolverResult) {
    ...
    try {
      ...
      Log.m97e(TAG, "resolveSubscriptionForOperation", ex);
    }
    if (isSmsSimPickActivityNeeded) {
      Log.m94d(
          TAG,
          "resolveSubscriptionForOperation isSmsSimPickActivityNeeded is true for calling"
              + " package. ");
      try {
        getITelephony()
            .enqueueSmsPickResult(
                null,
                null,
                new IIntegerConsumer.Stub() { // from class: android.telephony.SmsManager.6
        ...
        Log.m97e(TAG, "Unable to launch activity", ex2);
  ...
  public void sendResolverResult(
    ...
    } else if (!Compatibility.isChangeEnabled(GET_TARGET_SDK_VERSION_CODE_CHANGE)
        && !pickActivityShown) {
      resolverResult.onSuccess(subId);
    } else {
  ...
  public boolean copyMessageToIcc(byte[] smsc, byte[] pdu, int status) {
    ...
    try {
      ...
      boolean success =
          iSms.copyMessageToIccEfForSubscriber(getSubscriptionId(), null, status, pdu, smsc);
      return success;
    } catch (RemoteException e) {
      return false;
    }
  ...
  public boolean deleteMessageFromIcc(int messageIndex) {
    try {
      ...
      boolean success =
          iSms.updateMessageOnIccEfForSubscriber(getSubscriptionId(), null, messageIndex, 0, null);
      return success;
    } catch (RemoteException e) {
      return false;
    }
  ...
  public boolean updateMessageOnIcc(int messageIndex, int newStatus, byte[] pdu) {
    try {
      ...
      boolean success =
          iSms.updateMessageOnIccEfForSubscriber(
              getSubscriptionId(), null, messageIndex, newStatus, pdu);
      return success;
    } catch (RemoteException e) {
      return false;
    }
  ...
  public boolean enableCellBroadcastRange(int startMessageId, int endMessageId, int ranType) {
    ...
    try {
      ...
      if (iSms != null) {
        int subId = getSubscriptionId();
        success =
            iSms.enableCellBroadcastRangeForSubscriber(
                subId, startMessageId, endMessageId, ranType);
      ...
      com.android.telephony.Rlog.m239d(TAG, "enableCellBroadcastRange: ", ex);
    }
    return success;
  }
  ...
  public boolean disableCellBroadcastRange(int startMessageId, int endMessageId, int ranType) {
    ...
    try {
      ...
      if (iSms != null) {
        int subId = getSubscriptionId();
        success =
            iSms.disableCellBroadcastRangeForSubscriber(
                subId, startMessageId, endMessageId, ranType);
        com.android.telephony.Rlog.m238d(
            TAG,
            "disableCellBroadcastRange: "
                + (success ? "succeeded" : "failed")
                + " at calling disableCellBroadcastRangeForSubscriber. subId = "
                + subId);
      }
    } catch (RemoteException ex) {
      com.android.telephony.Rlog.m239d(TAG, "disableCellBroadcastRange: ", ex);
    }
    return success;
  }
  ...
  private ArrayList<SmsMessage> createMessageListFromRawRecords(List<SmsRawData> records) {
    ...
    if (records != null) {
      ...
      for (int i = 0; i < count; i++) {
        ...
        if (data != null
            && (sms = SmsMessage.createFromEfRecord(i + 1, data.getBytes(), getSubscriptionId()))
                != null) {
          messages.add(sms);
        }
      }
  ...
  public int getSmsCapacityOnIcc() {
    try {
      ...
      Log.m97e(TAG, "getSmsCapacityOnIcc() RemoteException", ex);
      return 0;
    }
  }
  ...
  public void sendMultimediaMessage(
    ...
    if (m != null) {
      resolveSubscriptionForOperation(
          new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.7
            @Override // android.telephony.SmsManager.SubscriptionResolverResult
            public void onSuccess(int subId) {
              m.sendMultimediaMessage(
                  subId, contentUri, locationUrl, configOverrides, sentIntent, messageId);
            }
  ...
  public void downloadMultimediaMessage(
    ...
    downloadMultimediaMessage(
        context, locationUrl, contentUri, configOverrides, downloadedIntent, 0L);
  }
  ...
  public void downloadMultimediaMessage(
      ...
      final Uri contentUri,
      final Bundle configOverrides,
      final PendingIntent downloadedIntent,
      final long messageId) {
    ...
    if (m != null) {
      resolveSubscriptionForOperation(
          new SubscriptionResolverResult() { // from class: android.telephony.SmsManager.8
            @Override // android.telephony.SmsManager.SubscriptionResolverResult
            public void onSuccess(int subId) {
              m.downloadMultimediaMessage(
                  subId, locationUrl, contentUri, configOverrides, downloadedIntent, messageId);
            }
  ...
  public void getSmsMessagesForFinancialApp(
      Bundle params, Executor executor, FinancialSmsCallback callback) {}

  public String createAppSpecificSmsTokenWithPackageInfo(String prefixes, PendingIntent intent) {
    try {
      ISms iccSms = getISmsServiceOrThrow();
      return iccSms.createAppSpecificSmsTokenWithPackageInfo(
          getSubscriptionId(), null, prefixes, intent);
    } catch (RemoteException ex) {
      ex.rethrowFromSystemServer();
      return null;
    }
  ...
  public int checkSmsShortCodeDestination(String destAddress, String countryIso) {
    try {
      ISms iccISms = getISmsServiceOrThrow();
      if (iccISms != null) {
        return iccISms.checkSmsShortCodeDestination(
            getSubscriptionId(), null, null, destAddress, countryIso);
      }
      return 0;
    } catch (RemoteException e) {
      Log.m97e(TAG, "checkSmsShortCodeDestination() RemoteException", e);
      return 0;
    }
  }
  ...
  public boolean setSmscAddress(String smsc) {
    ...
    try {
      ...
      return iSms.setSmscAddressOnIccEfForSubscriber(
          IccUtils.bytesToHexString(encodedSmscAddress), getSubscriptionId(), null);
    } catch (RemoteException ex2) {
  ...
  public int getPremiumSmsConsent(String packageName) {
    try {
      ...
      Log.m97e(TAG, "getPremiumSmsPermission() RemoteException", e);
      return 0;
    }
  }
    ...
    try {
      ...
      if (iSms != null) {
        if (ISIS_PACKAGE_NAME.equals(packageName) && getMnoName().toUpperCase().contains("VZW")) {
          permission = 3;
          Log.m98i(TAG, "setPremiumSmsPermission() for ISIS_PACKAGE");
        }
        iSms.setPremiumSmsPermission(packageName, permission);
      }
    } catch (RemoteException e) {
      Log.m97e(TAG, "setPremiumSmsPermission() RemoteException", e);
    }
  }
  ...
  public Uri getSmscIdentity() {
    ...
    try {
      ...
      com.android.telephony.Rlog.m240e(TAG, "getSmscIdentity(): Exception : " + ex);
      ex.rethrowAsRuntimeException();
    }
    if (info == null) {
      com.android.telephony.Rlog.m240e(TAG, "getSmscIdentity(): IPhoneSubInfo instance is NULL");
  ...
  public SemCbConfig semGetCbSettings() {
    ISms iccISms;
    com.android.telephony.Rlog.m238d(TAG, "[CB] In getCbConfig");
    byte[] out = null;
    ...
    try {
      ...
      com.android.telephony.Rlog.m238d(TAG, "[CB] Exception In getCbConfig of SmsManager");
    } catch (IllegalArgumentException ex) {
      ex.printStackTrace();
      com.android.telephony.Rlog.m238d(
          TAG, "[CB] IllegalArgumentException Exception In getCbConfig of SmsManager");
    } catch (NullPointerException e2) {
    }
    if (iccISms == null) {
      return null;
    ...
    int subId = getSubscriptionId();
    com.android.telephony.Rlog.m238d(TAG, "getCbSettings subId: " + subId);
    if (subId >= 0) {
      ...
      for (int j = 0; j < msgIds.length; j++) {
        try {
          ...
          com.android.telephony.Rlog.m238d(
              TAG, "[CB ] ArrayIndexOutOfBoundsException In getCbConfig of SmsManager.java");
          return null;
        }
      }
      ...
      for (int i2 = 0; i2 < cbConfig.msgIds.length; i2++) {
        com.android.telephony.Rlog.m238d(TAG, "[CB] msgIDs =  " + cbConfig.msgIds[i2]);
      }
      return cbConfig;
    }
    com.android.telephony.Rlog.m240e(TAG, "getCbSettings invalid subID : " + subId);
    return null;
  }

  public void semSendMultipartTextMessage(
      String destinationAddress,
      String scAddress,
      ArrayList<String> parts,
      ArrayList<PendingIntent> sentIntents,
      ...
      int serviceType,
      int encodingType) {
    com.android.telephony.Rlog.m242i(TAG, "semSendMultipartTextMessage with encodiing type");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (!getMnoName().toUpperCase().contains("DOCOMO") || destinationAddress.length() < 256) {
      ...
      if (parts.size() > 1) {
        try {
          ISms iccISms = getISmsServiceOrThrow();
          iccISms.sendMultipartTextwithOptionsForSubscriber(
              getSubscriptionId(),
  ...
  public void semSendMultipartTextMessage(
      ...
      int priority) {
    com.android.telephony.Rlog.m242i(TAG, "semSendMultipartTextMessage with priority");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (getMnoName().toUpperCase().contains("DOCOMO") && destinationAddress.length() >= 256) {
    ...
    if (parts.size() > 1) {
      try {
        ISms iccISms = getISmsServiceOrThrow();
        if (iccISms != null) {
          iccISms.sendMultipartTextwithCBPForSubscriber(
              getSubscriptionId(),
              ActivityThread.currentPackageName(),
              destinationAddress,
              scAddress,
  ...
  public boolean semGetSMSPAvailable() {
    com.android.telephony.Rlog.m238d(TAG, "getSMSPAvailable in SmsManager");
    ...
    try {
      ...
      com.android.telephony.Rlog.m238d(TAG, "Exception In getSMSPAvailable() of SmsManager.java");
      return false;
    }
  }
  ...
  public void semSendMultipartTextMessage(
      ...
      int encodingType,
      int confirmId) {
    com.android.telephony.Rlog.m242i(TAG, "semSendMultipartTextMessage with confirmId");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (!getMnoName().toUpperCase().contains("DOCOMO") || destinationAddress.length() < 256) {
  ...
  public void sendTextMessage(
    ...
    com.android.telephony.Rlog.m242i(
        TAG, "sendTextMessage with encoding Type: mno - " + getMnoName());
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (getMnoName().toUpperCase().contains("DOCOMO") && destinationAddress.length() >= 256) {
    ...
    try {
      ISms iccISms = getISmsServiceOrThrow();
      iccISms.sendTextwithOptionsForSubscriber(
          getSubscriptionId(),
          ActivityThread.currentPackageName(),
          destinationAddress,
          scAddress,
  ...
  public void sendTextMessage(
      ...
      String callbackNumber,
      int priority) {
    com.android.telephony.Rlog.m242i(TAG, "sendTextMessage with callbacknmber and priority");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (getMnoName().toUpperCase().contains("DOCOMO") && destinationAddress.length() >= 256) {
    ...
    try {
      ISms iccISms = getISmsServiceOrThrow();
      if (iccISms != null) {
        iccISms.sendTextwithCBPForSubscriber(
            getSubscriptionId(),
            ActivityThread.currentPackageName(),
            destinationAddress,
            scAddress,
  ...
  public void sendTextMessage(
      ...
      int encodingType,
      int confirmId) {
    com.android.telephony.Rlog.m242i(TAG, "sendTextMessage with confirmId");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (getMnoName().toUpperCase().contains("DOCOMO") && destinationAddress.length() >= 256) {
    ...
    try {
      ISms iccISms = getISmsServiceOrThrow();
      iccISms.sendTextwithOptionsReadconfirmForSubscriber(
          getSubscriptionId(),
          ActivityThread.currentPackageName(),
          destinationAddress,
          scAddress,
  ...
  public ArrayList<SmsMessage> getAllMessagesFromIccSimType(int iccType) {
    ...
    if (iccType2 == 0) {
      com.android.telephony.Rlog.m238d(TAG, "IccType is Unknown");
    ...
    try {
      try {
        ...
        if (iccISms != null) {
          ...
          boolean isroaming =
              Boolean.parseBoolean(
                  TelephonyManager.getTelephonyProperty(
                      phoneId, TelephonyProperties.PROPERTY_OPERATOR_ISROAMING, "false"));
          ...
          boolean isCtcVolteOn =
              Settings.System.getInt(context.getContentResolver(), voiceTypeKey, -1) == 0;
          if ((iccType2 == 10 && !isroaming && !isCtcVolteOn)
              || (iccType2 == 4 && ((isroaming || isCtcVolteOn) && isCHN))) {
        ...
        com.android.telephony.Rlog.m238d(
            TAG, "getAllMessagesFromIccSimType - exception - iccType:" + iccType2);
      }
      if (iccType2 == 4) {
        format = getFormat;
      } else if (iccType2 == 10) {
      ...
      com.android.telephony.Rlog.m238d(
          TAG,
          "getAllMessagesFromIccSimType, subId = "
              + subId
              + " format = "
              + format
              + " iccType = "
  ...
  private static ArrayList<SmsMessage> createMessageListFromRawRecords(
      List<SmsRawData> records, String format) {
    ArrayList<SmsMessage> messages = new ArrayList<>();
    if (records != null) {
      int count = records.size();
      for (int i = 0; i < count; i++) {
        ...
        if (data != null) {
          ...
          messages.add(sms);
          if (sms == null) {
            Log.m94d(TAG, "createFromEfRecord NULL:" + format + "index:" + i);
          }
        } else {
          messages.add(null);
        }
  ...
  public void sendOTADomestic(String destinationAddress, String scAddress, String text) {
    com.android.telephony.Rlog.m242i(TAG, "sendOTADomestic");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (getMnoName().toUpperCase().contains("DOCOMO") && destinationAddress.length() >= 256) {
    ...
    try {
      ISms iccISms = getISmsServiceOrThrow();
      iccISms.sendOTADomesticForSubscriber(
          getSubscriptionId(),
          ActivityThread.currentPackageName(),
          destinationAddress,
          scAddress,
  ...
  public void sendDataMessage(
      ...
      short originationPort,
      byte[] data,
      PendingIntent sentIntent,
      PendingIntent deliveryIntent) {
    com.android.telephony.Rlog.m242i(TAG, "sendDataMessage");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (getMnoName().toUpperCase().contains("DOCOMO") && destinationAddress.length() >= 256) {
    ...
    try {
      ISms iccISms = getISmsServiceOrThrow();
      iccISms.sendDatawithOrigPortForSubscriber(
          getSubscriptionId(),
          null,
          destinationAddress,
          scAddress,
          destinationPort & 65535,
          originationPort & 65535,
          data,
          sentIntent,
          deliveryIntent);
    } catch (RemoteException e) {
  ...
  public void sendTextMessageNSRI(
      String destinationAddress,
      String scAddress,
      byte[] data,
      PendingIntent sentIntent,
      ...
      int msgCount,
      int msgTotal) {
    com.android.telephony.Rlog.m242i(TAG, "sendTextMessageNSRI");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    Log.m94d(
        TAG,
        "[NSRI_SMS] sendTextMessageNSRI Addr = "
            + destinationAddress
            + " Smsc = "
            + scAddress
            + " textLen = "
    ...
    try {
      ISms iccISms = getISmsService();
      if (iccISms != null) {
        iccISms.sendTextNSRIForSubscriber(
            getSubscriptionId(),
            ActivityThread.currentPackageName(),
            destinationAddress,
            scAddress,
  ...
  public void sendTextMessageAutoLogin(
      String destinationAddress,
      String scAddress,
      String text,
      PendingIntent sentIntent,
      PendingIntent deliveryIntent) {
    com.android.telephony.Rlog.m242i(TAG, "sendTextMessageAutoLogin");
    if (TextUtils.isEmpty(destinationAddress)) {
      throw new IllegalArgumentException("Invalid destinationAddress");
    }
    if (getMnoName().toUpperCase().contains("DOCOMO") && destinationAddress.length() >= 256) {
    ...
    try {
      ISms iccISms = getISmsServiceOrThrow();
      iccISms.sendTextAutoLoginForSubscriber(
          getSubscriptionId(),
          ActivityThread.currentPackageName(),
          destinationAddress,
          scAddress,
  ...
  public String getCurrentFormat() {
    ...
    String mode =
        TelephonyManager.getTelephonyProperty(
            phoneId, TelephonyProperties.CURRENT_ACTIVE_PHONE, String.valueOf(1));
    com.android.telephony.Rlog.m238d(TAG, "getCurrentFormat, subId = " + subId + " mode = " + mode);
  ...
  private boolean isSupportSendingEmptySms() {
    final String matchedCode =
        SystemProperties.get("mdc.matched_code", SystemProperties.get("ro.csc.sales_code", ""));
    ...
    return Arrays.stream(supportCode)
        .anyMatch(
            new Predicate() { // from class: android.telephony.SmsManager$$ExternalSyntheticLambda0
