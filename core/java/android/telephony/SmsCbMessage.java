...
public final class SmsCbMessage implements Parcelable {
  ...
  public String toString() {
    StringBuilder append =
        new StringBuilder()
            .append("SmsCbMessage{geographicalScope=")
            .append(this.mGeographicalScope)
            .append(", serialNumber=")
            .append(this.mSerialNumber)
            .append(", location=")
            .append(this.mLocation)
            .append(", serviceCategory=")
            .append(this.mServiceCategory)
            .append(", language=")
            .append(this.mLanguage)
            .append(", body=")
            .append(this.mBody)
            .append(", priority=")
            .append(this.mPriority)
            .append(this.mEtwsWarningInfo != null ? ", " + this.mEtwsWarningInfo.toString() : "")
            .append(this.mCmasWarningInfo != null ? ", " + this.mCmasWarningInfo.toString() : "")
            .append(", maximumWaitingTime=")
            .append(this.mMaximumWaitTimeSec)
            .append(", received time=")
            .append(this.mReceivedTimeMillis)
            .append(", slotIndex = ")
            .append(this.mSlotIndex)
            .append(", geo=");
    List<CbGeoUtils.Geometry> list = this.mGeometries;
    return append
        .append(
            list != null
                ? CbGeoUtils.encodeGeometriesToString(list)
  ...
  public ContentValues getContentValues() {
    ...
    if (etwsInfo != null) {
      cv.put(
          Telephony.CellBroadcasts.ETWS_WARNING_TYPE, Integer.valueOf(etwsInfo.getWarningType()));
    ...
    if (cmasInfo != null) {
      cv.put(
          Telephony.CellBroadcasts.CMAS_MESSAGE_CLASS, Integer.valueOf(cmasInfo.getMessageClass()));
      cv.put(Telephony.CellBroadcasts.CMAS_CATEGORY, Integer.valueOf(cmasInfo.getCategory()));
      cv.put(
          Telephony.CellBroadcasts.CMAS_RESPONSE_TYPE, Integer.valueOf(cmasInfo.getResponseType()));
  ...
  public static SmsCbMessage createFromCursor(Cursor cursor) {
    ...
    int certainty;
    int geoScope =
        cursor.getInt(cursor.getColumnIndexOrThrow(Telephony.CellBroadcasts.GEOGRAPHICAL_SCOPE));
    int serialNum = cursor.getInt(cursor.getColumnIndexOrThrow("serial_number"));
    int category =
        cursor.getInt(cursor.getColumnIndexOrThrow(Telephony.CellBroadcasts.SERVICE_CATEGORY));
    String language = cursor.getString(cursor.getColumnIndexOrThrow("language"));
    String body = cursor.getString(cursor.getColumnIndexOrThrow("body"));
    int format =
        cursor.getInt(cursor.getColumnIndexOrThrow(Telephony.CellBroadcasts.MESSAGE_FORMAT));
    ...
    if (etwsWarningTypeColumn2 != -1
        && !cursor.isNull(etwsWarningTypeColumn2)
        && etwsIsPrimaryColumn != -1
        && !cursor.isNull(etwsIsPrimaryColumn)) {
    ...
    if (cmasMessageClassColumn != -1 && !cursor.isNull(cmasMessageClassColumn)) {
      ...
      int cmasResponseTypeColumn =
          cursor.getColumnIndex(Telephony.CellBroadcasts.CMAS_RESPONSE_TYPE);
      ...
      cmasInfo =
          new SmsCbCmasInfo(messageClass, cmasCategory, responseType, severity, urgency, certainty);
    } else {
      etwsWarningTypeColumn = etwsWarningTypeColumn2;
      cid2 = cid;
      cmasInfo = null;
    ...
    long receivedTimeMillis =
        cursor.getLong(cursor.getColumnIndexOrThrow(Telephony.CellBroadcasts.RECEIVED_TIME));
    int maximumWaitTimeSec =
        cursor.getInt(cursor.getColumnIndexOrThrow(Telephony.CellBroadcasts.MAXIMUM_WAIT_TIME));
  ...
  public int getCmasCategory() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasCategory");
      return 0;
    }
  }
  ...
  public int getCmasResponseType() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasResponseType");
      return 0;
    }
  }
  ...
  public int getCmasSeverity() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasSeverity");
      return 0;
    }
  }
  ...
  public int getCmasUrgency() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasUrgency");
      return 0;
    }
  }
  ...
  public int getCmasCertainty() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasCertainty");
      return 0;
    }
  }
  ...
  public int getCmasMessageId() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasMessageID");
      return 0;
    }
  }
  ...
  public int getCmasAlertHandling() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasAlertHandling");
      return 0;
    }
  }
  ...
  public long getCmasMsgExpires() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasMsgExpires");
      return 0L;
    }
  }
  ...
  public boolean getCmasRecordTypeFirstExists() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasRecordTypeFirstExists");
      return false;
    }
  }
  ...
  public boolean getCmasRecordTypeSecondExists() {
    try {
      ...
      Rlog.m79e(LOG_TAG, "Null pointer exception in getCmasRecordTypeSecondExists");
      return false;
    }
  }
}
