...
public final class CarrierRestrictionRules implements Parcelable {
  ...
  public static final Parcelable.Creator<CarrierRestrictionRules> CREATOR =
      new Parcelable.Creator<
          CarrierRestrictionRules>() { // from class: android.telephony.CarrierRestrictionRules.1
  ...
  public boolean isAllCarriersAllowed() {
    return this.mAllowedCarriers.isEmpty()
          ...
          result.replaceAll(
              new UnaryOperator() { // from class:
                ...
                public final Object apply(Object obj) {
                  return CarrierRestrictionRules.lambda$areCarrierIdentifiersAllowed$0(
                      (Boolean) obj);
                }
              });
          break;
