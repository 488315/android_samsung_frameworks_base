...
public final class PhoneNumberRange implements Parcelable {
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(this.mCountryCode, that.mCountryCode)
        && Objects.equals(this.mPrefix, that.mPrefix)
        && Objects.equals(this.mLowerBound, that.mLowerBound)
        && Objects.equals(this.mUpperBound, that.mUpperBound)) {
      return true;
    }
    return false;
  }
  ...
  public String toString() {
    return "PhoneNumberRange{mCountryCode='"
        + this.mCountryCode
        + DateFormat.QUOTE
        + ", mPrefix='"
        + this.mPrefix
  ...
  public boolean matches(String number) {
    ...
    try {
      ...
      Log.m97e(PhoneNumberRange.class.getSimpleName(), "Invalid bounds or number.", e);
      return false;
    }
  }
}
