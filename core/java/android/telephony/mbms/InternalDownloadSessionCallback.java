...
public class InternalDownloadSessionCallback extends IMbmsDownloadSessionCallback.Stub {
  ...
  public void onError(final int errorCode, final String message) {
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalDownloadSessionCallback.1
  ...
  public void onFileServicesUpdated(final List<FileServiceInfo> services) {
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalDownloadSessionCallback.2
            @Override // java.lang.Runnable
            public void run() {
  ...
  public void onMiddlewareReady() {
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalDownloadSessionCallback.3
            @Override // java.lang.Runnable
            public void run() {
