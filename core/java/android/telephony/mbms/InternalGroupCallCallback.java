...
public class InternalGroupCallCallback extends IGroupCallCallback.Stub {
  ...
  public void onError(final int errorCode, final String message) {
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalGroupCallCallback.1
  ...
  public void onGroupCallStateChanged(final int state, final int reason) {
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalGroupCallCallback.2
            @Override // java.lang.Runnable
            public void run() {
  ...
  public void onBroadcastSignalStrengthUpdated(final int signalStrength) {
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalGroupCallCallback.3
            @Override // java.lang.Runnable
            public void run() {
              InternalGroupCallCallback.this.mAppCallback.onBroadcastSignalStrengthUpdated(
                  signalStrength);
            }
          });
    } finally {
