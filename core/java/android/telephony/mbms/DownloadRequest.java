...
public final class DownloadRequest implements Parcelable {
  ...
  public static class Builder {
    ...
    public static Builder fromSerializedRequest(byte[] data) {
      try {
        ...
        Log.m96e(DownloadRequest.LOG_TAG, "Got IOException trying to parse opaque data");
        throw new IllegalArgumentException(e);
      } catch (ClassNotFoundException e2) {
        Log.m96e(DownloadRequest.LOG_TAG, "Got ClassNotFoundException trying to parse opaque data");
  ...
  private DownloadRequest(
      String fileServiceId, Uri source, Uri destination, int sub, String appIntent, int version) {
  ...
  public byte[] toByteArray() {
    try {
      ...
      Log.m96e(LOG_TAG, "Got IOException trying to serialize opaque data");
      return null;
    }
  }
