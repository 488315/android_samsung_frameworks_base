...
public class InternalStreamingSessionCallback extends IMbmsStreamingSessionCallback.Stub {
  ...
  public void onError(final int errorCode, final String message) throws RemoteException {
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalStreamingSessionCallback.1
  ...
  public void onStreamingServicesUpdated(final List<StreamingServiceInfo> services)
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalStreamingSessionCallback.2
            @Override // java.lang.Runnable
            public void run() {
              InternalStreamingSessionCallback.this.mAppCallback.onStreamingServicesUpdated(
                  services);
            }
          });
    } finally {
  ...
  public void onMiddlewareReady() throws RemoteException {
    ...
    try {
      this.mExecutor.execute(
          new Runnable() { // from class: android.telephony.mbms.InternalStreamingSessionCallback.3
            @Override // java.lang.Runnable
            public void run() {
