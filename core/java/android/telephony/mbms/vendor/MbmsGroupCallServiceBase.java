...
public class MbmsGroupCallServiceBase extends Service {
    private final IBinder mInterface = new IMbmsGroupCallService.Stub() { // from class:
                ...
                public int initialize(
                        final IMbmsGroupCallSessionCallback callback, final int subscriptionId)
                    ...
                    int result =
                            MbmsGroupCallServiceBase.this.initialize(
                                    new MbmsGroupCallSessionCallback() { // from class:
                                        // android.telephony.mbms.vendor.MbmsGroupCallServiceBase.1.1
                                        @Override // android.telephony.mbms.MbmsGroupCallSessionCallback
                                        public void onError(int errorCode, String message) {
                                            try {
                                                if (errorCode == -1) {
                                                    throw new IllegalArgumentException(
                                                            "Middleware cannot send an unknown"
                                                                + " error.");
                                                }
                                                callback.onError(errorCode, message);
                                            } catch (RemoteException e) {
                                                MbmsGroupCallServiceBase.this.onAppCallbackDied(
                                                        uid, subscriptionId);
                                            }
                                        }
                                        ...
                                        public void onAvailableSaisUpdated(
                                                List currentSais, List availableSais) {
                                            try {
                                                callback.onAvailableSaisUpdated(
                                                        currentSais, availableSais);
                                            } catch (RemoteException e) {
                                                MbmsGroupCallServiceBase.this.onAppCallbackDied(
                                                        uid, subscriptionId);
                                            }
                                        ...
                                        @Override // android.telephony.mbms.MbmsGroupCallSessionCallback
                                        public void onServiceInterfaceAvailable(
                                                String interfaceName, int index) {
                                            try {
                                                callback.onServiceInterfaceAvailable(
                                                        interfaceName, index);
                                            } catch (RemoteException e) {
                                                MbmsGroupCallServiceBase.this.onAppCallbackDied(
                                                        uid, subscriptionId);
                        ...
                        callback.asBinder()
                                .linkToDeath(
                                        new IBinder.DeathRecipient() { // from class:
                                            // android.telephony.mbms.vendor.MbmsGroupCallServiceBase.1.2
                ...
                public int startGroupCall(
                        ...
                        List saiList,
                        List frequencyList,
                        final IGroupCallCallback callback)
                        throws RemoteException {
                    if (callback == null) {
                        throw new NullPointerException("Callback must not be null");
                    }
                    final int uid = Binder.getCallingUid();
                    int result =
                            MbmsGroupCallServiceBase.this.startGroupCall(
                                    subscriptionId,
                                    tmgi,
                                    saiList,
                                    frequencyList,
                                    new GroupCallCallback() { // from class:
                                        // android.telephony.mbms.vendor.MbmsGroupCallServiceBase.1.3
                                        ...
                                        @Override // android.telephony.mbms.GroupCallCallback
                                        public void onBroadcastSignalStrengthUpdated(
                                                int signalStrength) {
                                            try {
                                                callback.onBroadcastSignalStrengthUpdated(
                                                        signalStrength);
                                            } catch (RemoteException e) {
                                                MbmsGroupCallServiceBase.this.onAppCallbackDied(
                                                        uid, subscriptionId);
                    ...
                    if (result == 0) {
                        callback.asBinder()
                                .linkToDeath(
                                        new IBinder.DeathRecipient() { // from class:
                                            // android.telephony.mbms.vendor.MbmsGroupCallServiceBase.1.4
                                            @Override // android.os.IBinder.DeathRecipient
                                            public void binderDied() {
                                                MbmsGroupCallServiceBase.this.onAppCallbackDied(
                                                        uid, subscriptionId);
    ...
    public void updateGroupCall(
            int subscriptionId, long tmgi, List<Integer> saiList, List<Integer> frequencyList) {
        throw new UnsupportedOperationException("Not implemented");
    }
