...
public class MbmsDownloadServiceBase extends IMbmsDownloadService.Stub {
    ...
    public final int initialize(
            final int subscriptionId, final IMbmsDownloadSessionCallback callback)
            throws RemoteException {
        if (callback == null) {
    ...
    public final int addStatusListener(
        ...
        DownloadStatusListener exposedCallback =
                new VendorDownloadStatusListener(
                        listener) { // from class:
                                    // android.telephony.mbms.vendor.MbmsDownloadServiceBase.3
    ...
    public int addProgressListener(
            DownloadRequest downloadRequest, DownloadProgressListener listener)
            throws RemoteException {
        return 0;
    }
    ...
    public final int addProgressListener(
        ...
        DownloadProgressListener exposedCallback =
                new VendorDownloadProgressListener(
                        listener) { // from class:
                                    // android.telephony.mbms.vendor.MbmsDownloadServiceBase.5
