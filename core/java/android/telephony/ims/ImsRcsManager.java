...
public class ImsRcsManager {
    ...
    public void registerImsRegistrationCallback(Executor executor, RegistrationManager.RegistrationCallback c) throws ImsException {
        ...
        if (imsRcsController == null) {
            Log.m102w(TAG, "Register registration callback: IImsRcsController is null");
    ...
    public void unregisterImsRegistrationCallback(RegistrationManager.RegistrationCallback c) {
        ...
        IImsRcsController imsRcsController = getIImsRcsController();
        if (imsRcsController == null) {
            Log.m102w(TAG, "Unregister registration callback: IImsRcsController is null");
    ...
    public void getRegistrationState(Executor executor, final Consumer<Integer> stateCallback) {
        ...
        IImsRcsController imsRcsController = getIImsRcsController();
        if (imsRcsController == null) {
            Log.m102w(TAG, "Get registration state error: IImsRcsController is null");
            throw new IllegalStateException("Cannot find remote IMS service");
        }
        try {
            imsRcsController.getImsRcsRegistrationState(this.mSubId, new BinderC33951(executor, stateCallback));
        } catch (RemoteException | ServiceSpecificException e) {
            Log.m102w(TAG, "Get registration state error: " + e);
    ...
    class BinderC33951 extends IIntegerConsumer.Stub {
        final /* synthetic */ Executor val$executor;
        final /* synthetic */ Consumer val$stateCallback;

        BinderC33951(Executor executor, Consumer consumer) {
    ...
    public void getRegistrationTransportType(Executor executor, final Consumer<Integer> transportTypeCallback) {
        ...
        IImsRcsController imsRcsController = getIImsRcsController();
        if (imsRcsController == null) {
            Log.m102w(TAG, "Get registration transport type error: IImsRcsController is null");
            throw new IllegalStateException("Cannot find remote IMS service");
        }
        try {
            imsRcsController.getImsRcsRegistrationTransportType(this.mSubId, new BinderC33962(executor, transportTypeCallback));
        } catch (RemoteException | ServiceSpecificException e) {
            Log.m102w(TAG, "Get registration transport type error: " + e);
    ...
    class BinderC33962 extends IIntegerConsumer.Stub {
        final /* synthetic */ Executor val$executor;
        final /* synthetic */ Consumer val$transportTypeCallback;

        BinderC33962(Executor executor, Consumer consumer) {
            this.val$executor = executor;
    ...
    public void addOnAvailabilityChangedListener(Executor executor, OnAvailabilityChangedListener listener) throws ImsException {
        ...
        IImsRcsController imsRcsController = getIImsRcsController();
        if (imsRcsController == null) {
            Log.m102w(TAG, "Add availability changed listener: IImsRcsController is null");
            throw new ImsException("Cannot find remote IMS service", 1);
        }
    ...
    public void removeOnAvailabilityChangedListener(OnAvailabilityChangedListener listener) {
        ...
        IImsRcsController imsRcsController = getIImsRcsController();
        if (imsRcsController == null) {
            Log.m102w(TAG, "Remove availability changed listener: IImsRcsController is null");
            return;
        }
    ...
    public boolean isCapable(int capability, int radioTech) throws ImsException {
        IImsRcsController imsRcsController = getIImsRcsController();
        if (imsRcsController == null) {
            Log.m102w(TAG, "isCapable: IImsRcsController is null");
            throw new ImsException("Cannot find remote IMS service", 1);
        }
        try {
    ...
    public boolean isAvailable(int capability, int radioTech) throws ImsException {
        IImsRcsController imsRcsController = getIImsRcsController();
        if (imsRcsController == null) {
            Log.m102w(TAG, "isAvailable: IImsRcsController is null");
            throw new ImsException("Cannot find remote IMS service", 1);
        }
        try {
