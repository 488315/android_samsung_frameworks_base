  ...
  public void getRegistrationState(Executor executor, final Consumer<Integer> stateCallback) {
    ...
    try {
      imsRcsController.getImsRcsRegistrationState(
          this.mSubId, new BinderC33951(executor, stateCallback));
  ...
  public void getRegistrationTransportType(
    ...
    try {
      imsRcsController.getImsRcsRegistrationTransportType(
          this.mSubId, new BinderC33962(executor, transportTypeCallback));
    } catch (RemoteException | ServiceSpecificException e) {
  ...
  public void registerImsStateCallback(Executor executor, ImsStateCallback callback)
    ...
    ITelephony telephony =
        binderCacheManager.listenOnBinder(
            callback, new ImsMmTelManager$$ExternalSyntheticLambda2(callback));
    if (telephony == null) {
