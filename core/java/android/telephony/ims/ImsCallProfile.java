...
public final class ImsCallProfile implements Parcelable {
  ...
  @SystemApi public static final String EXTRA_CONFERENCE = "android.telephony.ims.extra.CONFERENCE";
  ...
  public static final String EXTRA_TELECOM_CALL_ID =
      "com.samsung.telephony.extra.ims.TELECOM_CALL_ID";
  ...
  public String toString() {
    StringBuilder append =
        new StringBuilder()
            .append("{ serviceType=")
            .append(this.mServiceType)
            .append(", callType=")
            .append(this.mCallType)
            .append(", restrictCause=")
            .append(this.mRestrictCause)
            .append(", mediaProfile=");
    ImsStreamMediaProfile imsStreamMediaProfile = this.mMediaProfile;
    return append
        .append(
            imsStreamMediaProfile != null
                ? imsStreamMediaProfile.toString()
                : SemCapabilities.FEATURE_TAG_NULL)
        .append(", emergencyServiceCategories=")
        .append(this.mEmergencyServiceCategories)
        .append(", emergencyUrns=")
        .append(this.mEmergencyUrns)
        .append(", emergencyCallRouting=")
        .append(this.mEmergencyCallRouting)
        .append(", emergencyCallTesting=")
        .append(this.mEmergencyCallTesting)
        .append(", hasKnownUserIntentEmergency=")
        .append(this.mHasKnownUserIntentEmergency)
        .append(", mRestrictCause=")
        .append(this.mRestrictCause)
        .append(", mCallerNumberVerstat= ")
        .append(this.mCallerNumberVerificationStatus)
        .append(", mAcceptedRtpHeaderExtensions= ")
  ...
  private void readFromParcel(Parcel in) {
    ...
    Object[] accepted =
        in.readArray(RtpHeaderExtensionType.class.getClassLoader(), RtpHeaderExtensionType.class);
  ...
  private Bundle maybeCleanseExtras(Bundle extras) {
    ...
    if (startSize != endSize) {
      Log.m98i(
          ...
          "maybeCleanseExtras: "
              + (startSize - endSize)
              + " extra values were removed - only primitive types and system parcelables are"
              + " permitted.");
    }
    return filtered;
  }
