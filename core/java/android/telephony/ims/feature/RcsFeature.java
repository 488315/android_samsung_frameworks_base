...
public class RcsFeature extends ImsFeature {
  ...
  static final class RcsFeatureBinder extends IImsRcsFeature.Stub {
                  ...
                  new Supplier() { // from class:
                    ...
                    public final Object get() {
                      ...
                      lambda$queryCapabilityStatus$0 =
                          RcsFeature.RcsFeatureBinder.this.lambda$queryCapabilityStatus$0();
    ...
    public void changeCapabilitiesConfiguration(
        final CapabilityChangeRequest r, final IImsCapabilityCallback c) throws RemoteException {
      executeMethodAsync(
          new Runnable() { // from class:
    ...
    public void setCapabilityExchangeEventListener(ICapabilityExchangeEventListener listener)
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              RcsFeature.RcsFeatureBinder.this.lambda$setCapabilityExchangeEventListener$5(
                  listenerWrapper);
            }
          },
    ...
    public /* synthetic */ void lambda$publishCapabilities$6(
        String pidfXml, RcsCapabilityExchangeImplBase.PublishResponseCallback callbackWrapper) {
      this.mReference
    ...
    @Override // android.telephony.ims.aidl.IImsRcsFeature
    public void subscribeForCapabilities(final List<Uri> uris, ISubscribeResponseCallback callback)
        throws RemoteException {
    ...
    public void sendOptionsCapabilityRequest(
        final Uri contactUri, final List<String> myCapabilities, IOptionsResponseCallback callback)
        throws RemoteException {
    ...
    public /* synthetic */ void lambda$sendOptionsCapabilityRequest$8(
      ...
      this.mReference
          .getCapabilityExchangeImplBaseInternal()
          .sendOptionsCapabilityRequest(contactUri, new HashSet(myCapabilities), callbackWrapper);
    }
