...
public class CapabilityExchangeAidlWrapper implements CapabilityExchangeEventListener {
  ...
  public void onRequestPublishCapabilities(int publishTriggerType) throws ImsException {
    ...
    try {
      ...
      Log.m102w(LOG_TAG, "request publish capabilities exception: " + e);
  ...
  public void onUnpublish() throws ImsException {
    ...
    try {
      ...
      Log.m102w(LOG_TAG, "Unpublish exception: " + e);
      throw new ImsException("Remote is not available", 1);
    }
  }
  ...
  public void onPublishUpdated(
    ...
    try {
      ...
      Log.m102w(LOG_TAG, "onPublishUpdated exception: " + e);
      throw new ImsException("Remote is not available", 1);
    }
  }
  ...
  public void onRemoteCapabilityRequest(
    ...
    IOptionsRequestCallback internalCallback =
        new IOptionsRequestCallback
            .Stub() { // from class: android.telephony.ims.aidl.CapabilityExchangeAidlWrapper.1
    ...
    try {
      ...
      Log.m102w(LOG_TAG, "Remote capability request exception: " + e);
      throw new ImsException("Remote is not available", 1);
    }
  }
}
