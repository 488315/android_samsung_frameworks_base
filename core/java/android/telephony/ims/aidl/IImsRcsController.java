...
public interface IImsRcsController extends IInterface {
  ...
  void requestAvailability(
      int i, String str, String str2, Uri uri, IRcsUceControllerCallback iRcsUceControllerCallback)
      throws RemoteException;
  ...
  public static class Default implements IImsRcsController {
    ...
    public void triggerNetworkRegistration(
        int subId, ISipDelegate connection, int sipCode, String sipReason) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 17:
              ...
              ISipDelegateConnectionStateCallback _arg33 =
                  ISipDelegateConnectionStateCallback.Stub.asInterface(data.readStrongBinder());
