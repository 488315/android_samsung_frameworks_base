...
public interface IImsRcsFeature extends IInterface {
  ...
  void setCapabilityExchangeEventListener(
      ICapabilityExchangeEventListener iCapabilityExchangeEventListener) throws RemoteException;

  void subscribeForCapabilities(
      List<Uri> list, ISubscribeResponseCallback iSubscribeResponseCallback) throws RemoteException;
  ...
  public static class Default implements IImsRcsFeature {
    ...
    @Override // android.telephony.ims.aidl.IImsRcsFeature
    public void changeCapabilitiesConfiguration(CapabilityChangeRequest r, IImsCapabilityCallback c)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 5:
              CapabilityChangeRequest _arg03 =
                  (CapabilityChangeRequest) data.readTypedObject(CapabilityChangeRequest.CREATOR);
            ...
            case 7:
              ICapabilityExchangeEventListener _arg05 =
                  ICapabilityExchangeEventListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
