...
public interface IImsServiceController extends IInterface {
  ...
  void addFeatureStatusCallback(int i, int i2, IImsFeatureStatusCallback iImsFeatureStatusCallback)
  ...
  void removeFeatureStatusCallback(
      int i, int i2, IImsFeatureStatusCallback iImsFeatureStatusCallback) throws RemoteException;
      ...
      public ImsFeatureConfiguration querySupportedImsFeatures() throws RemoteException {
        ...
        try {
          ...
          ImsFeatureConfiguration _result =
              (ImsFeatureConfiguration) _reply.readTypedObject(ImsFeatureConfiguration.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
