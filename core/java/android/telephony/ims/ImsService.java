...
public class ImsService extends Service {
  ...
  private static final Map<Long, String> CAPABILITIES_LOG_MAP =
      Map.of(1L, "EMERGENCY_OVER_MMTEL", 2L, "SIP_DELEGATE_CREATION");
  ...
  class BinderC33991 extends IImsServiceController.Stub {
                ...
                new Supplier() { // from class:
                  ...
                  public final Object get() {
                    ...
                    lambda$createMmTelFeature$2 =
                        ImsService.BinderC33991.this.lambda$createMmTelFeature$2(slotId, subId);
                ...
                new Supplier() { // from class:
                  ...
                  public final Object get() {
                    ...
                    lambda$createEmergencyOnlyMmTelFeature$3 =
                        ImsService.BinderC33991.this.lambda$createEmergencyOnlyMmTelFeature$3(
                            slotId);
                ...
                new Supplier() { // from class:
                  ...
                  public final Object get() {
                    ...
                    lambda$createRcsFeature$4 =
                        ImsService.BinderC33991.this.lambda$createRcsFeature$4(slotId, subId);
    ...
    public void addFeatureStatusCallback(
      ...
      ImsService.this.executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsService.BinderC33991.this.lambda$addFeatureStatusCallback$5(
    ...
    public void removeFeatureStatusCallback(
      ...
      ImsService.this.executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsService.BinderC33991.this.lambda$removeFeatureStatusCallback$6(
                  slotId, featureType, c);
            }
          },
              ...
              new Supplier() { // from class:
                ...
                public final Object get() {
                  ...
                  lambda$querySupportedImsFeatures$8 =
                      ImsService.BinderC33991.this.lambda$querySupportedImsFeatures$8();
                  ...
                  new Supplier() { // from class:
                    ...
                    public final Object get() {
                      ...
                      lambda$getImsServiceCapabilities$9 =
                          ImsService.BinderC33991.this.lambda$getImsServiceCapabilities$9();
    ...
    public /* synthetic */ Long lambda$getImsServiceCapabilities$9() {
      ...
      if (caps != sanitizedCaps) {
        Log.m102w(
            ImsService.LOG_TAG,
            "removing invalid bits from field: 0x" + Long.toHexString(caps ^ sanitizedCaps));
      }
          ...
          ImsService.this.executeMethodAsyncForResult(
              new Supplier() { // from class:
                ...
                public final Object get() {
                  ...
                  lambda$getConfig$11 =
                      ImsService.BinderC33991.this.lambda$getConfig$11(slotId, subId);
              ...
              new Supplier() { // from class:
                ...
                public final Object get() {
                  ...
                  lambda$getRegistration$12 =
                      ImsService.BinderC33991.this.lambda$getRegistration$12(slotId, subId);
              ...
              new Supplier() { // from class:
                ...
                public final Object get() {
                  ...
                  lambda$getSipTransport$13 =
                      ImsService.BinderC33991.this.lambda$getSipTransport$13(slotId);
  ...
  public void removeImsFeatureStatusCallback(
    ...
    synchronized (this.mFeaturesBySlot) {
      ...
      if (features == null) {
        Log.m102w(
            LOG_TAG, "Can not remove ImsFeatureStatusCallback - no features on slot " + slotId);
        return;
      }
      ImsFeature f = features.get(featureType);
      if (f != null) {
  ...
  public static String getCapabilitiesString(long caps) {
    ...
    for (long i = 0; (caps & filter) != 0 && i <= 63; i++) {
      ...
      if ((caps & bitToCheck) != 0) {
        result.append(
            CAPABILITIES_LOG_MAP.getOrDefault(Long.valueOf(bitToCheck), bitToCheck + "?"));
        result.append(" ");
      }
      filter <<= 1;
    }
