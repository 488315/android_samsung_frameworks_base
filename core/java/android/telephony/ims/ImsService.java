...
public class ImsService extends Service {
    ...
    protected final IBinder mImsServiceController = new BinderC33991();
    private final IBinder.DeathRecipient mDeathRecipient = new C34002();
    ...
    class BinderC33991 extends IImsServiceController.Stub {
        BinderC33991() {
        }
            ...
            synchronized (ImsService.this.mListenerLock) {
                if (ImsService.this.mListener != null && ImsService.this.mListener.asBinder().isBinderAlive()) {
                    try {
                        ...
                        Log.m102w(ImsService.LOG_TAG, "IImsServiceControllerListener does not exist");
                    }
                }
                ...
                if (ImsService.this.mListener == null) {
                    ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda11
                        ...
                        public final void run() {
                            ImsService.BinderC33991.this.lambda$setListener$0();
                        }
                    }, "releaseResource");
                    return;
                }
                try {
                    ...
                    Log.m98i(ImsService.LOG_TAG, "setListener: register linkToDeath");
                    ...
                    ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda12
                        @Override // java.lang.Runnable
                        public final void run() {
                            ImsService.BinderC33991.this.lambda$setListener$1();
                        }
                    }, "releaseResource");
                }
            }
            ...
            if (f == null) {
                return (IImsMmTelFeature) ImsService.this.executeMethodAsyncForResult(new Supplier() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda6
                    ...
                    public final Object get() {
                        ...
                        lambda$createMmTelFeature$2 = ImsService.BinderC33991.this.lambda$createMmTelFeature$2(slotId, subId);
            ...
            if (f == null) {
                return (IImsMmTelFeature) ImsService.this.executeMethodAsyncForResult(new Supplier() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda4
                    ...
                    public final Object get() {
                        ...
                        lambda$createEmergencyOnlyMmTelFeature$3 = ImsService.BinderC33991.this.lambda$createEmergencyOnlyMmTelFeature$3(slotId);
            ...
            if (f == null) {
                return (IImsRcsFeature) ImsService.this.executeMethodAsyncForResult(new Supplier() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda8
                    ...
                    public final Object get() {
                        ...
                        lambda$createRcsFeature$4 = ImsService.BinderC33991.this.lambda$createRcsFeature$4(slotId, subId);
        ...
        public void addFeatureStatusCallback(final int slotId, final int featureType, final IImsFeatureStatusCallback c) {
            ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda15
                @Override // java.lang.Runnable
                public final void run() {
                    ImsService.BinderC33991.this.lambda$addFeatureStatusCallback$5(slotId, featureType, c);
                }
        ...
        public void removeFeatureStatusCallback(final int slotId, final int featureType, final IImsFeatureStatusCallback c) {
            ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    ImsService.BinderC33991.this.lambda$removeFeatureStatusCallback$6(slotId, featureType, c);
                }
        ...
        public void removeImsFeature(final int slotId, final int featureType, boolean changeSubId) {
            if (changeSubId && ImsService.this.isImsFeatureCreatedForSlot(slotId, featureType)) {
                Log.m102w(ImsService.LOG_TAG, "Do not remove Ims feature for compatibility");
            } else {
                ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ImsService.BinderC33991.this.lambda$removeImsFeature$7(slotId, featureType);
                    }
                }, "removeImsFeature");
        ...
        public ImsFeatureConfiguration querySupportedImsFeatures() {
            return (ImsFeatureConfiguration) ImsService.this.executeMethodAsyncForResult(new Supplier() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda2
                ...
                public final Object get() {
                    ...
                    lambda$querySupportedImsFeatures$8 = ImsService.BinderC33991.this.lambda$querySupportedImsFeatures$8();
        ...
        public long getImsServiceCapabilities() {
            return ((Long) ImsService.this.executeMethodAsyncForResult(new Supplier() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda10
                ...
                public final Object get() {
                    ...
                    lambda$getImsServiceCapabilities$9 = ImsService.BinderC33991.this.lambda$getImsServiceCapabilities$9();
        ...
        public /* synthetic */ Long lambda$getImsServiceCapabilities$9() {
            ...
            if (caps != sanitizedCaps) {
                Log.m102w(ImsService.LOG_TAG, "removing invalid bits from field: 0x" + Long.toHexString(caps ^ sanitizedCaps));
            }
        ...
        public void notifyImsServiceReadyForFeatureCreation() {
            ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    ImsService.BinderC33991.this.lambda$notifyImsServiceReadyForFeatureCreation$10();
                }
        ...
        public IImsConfig getConfig(final int slotId, final int subId) {
            return (IImsConfig) ImsService.this.executeMethodAsyncForResult(new Supplier() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda3
                ...
                public final Object get() {
                    ...
                    lambda$getConfig$11 = ImsService.BinderC33991.this.lambda$getConfig$11(slotId, subId);
        ...
        public IImsRegistration getRegistration(final int slotId, final int subId) {
            return (IImsRegistration) ImsService.this.executeMethodAsyncForResult(new Supplier() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda14
                ...
                public final Object get() {
                    ...
                    lambda$getRegistration$12 = ImsService.BinderC33991.this.lambda$getRegistration$12(slotId, subId);
        ...
        public ISipTransport getSipTransport(final int slotId) {
            return (ISipTransport) ImsService.this.executeMethodAsyncForResult(new Supplier() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda1
                ...
                public final Object get() {
                    ...
                    lambda$getSipTransport$13 = ImsService.BinderC33991.this.lambda$getSipTransport$13(slotId);
        ...
        public void enableIms(final int slotId, final int subId) {
            ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda16
                @Override // java.lang.Runnable
                public final void run() {
                    ImsService.BinderC33991.this.lambda$enableIms$14(slotId, subId);
                }
            }, "enableIms");
        }
        ...
        public void disableIms(final int slotId, final int subId) {
            ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
                    ImsService.BinderC33991.this.lambda$disableIms$15(slotId, subId);
                }
            }, "disableIms");
        }
        ...
        public void resetIms(final int slotId, final int subId) {
            ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$1$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    ImsService.BinderC33991.this.lambda$resetIms$16(slotId, subId);
                }
            }, "resetIms");
        }
    ...
    class C34002 implements IBinder.DeathRecipient {
        C34002() {
        }

        @Override // android.os.IBinder.DeathRecipient
        public void binderDied() {
            Log.m102w(ImsService.LOG_TAG, "IImsServiceControllerListener binder to framework has died. Cleaning up");
            ImsService.this.executeMethodAsync(new Runnable() { // from class: android.telephony.ims.ImsService$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ImsService.C34002.this.lambda$binderDied$0();
                }
            }, "releaseResource");
        }
    ...
    public IBinder onBind(Intent intent) {
        if (SERVICE_INTERFACE.equals(intent.getAction())) {
            Log.m98i(LOG_TAG, "ImsService Bound.");
    ...
    public IImsMmTelFeature createMmTelFeatureInternal(int slotId, int subscriptionId) {
        ...
        Log.m96e(LOG_TAG, "createMmTelFeatureInternal: null feature returned.");
        return null;
    }
    ...
    public IImsMmTelFeature createEmergencyOnlyMmTelFeatureInternal(int slotId) {
        ...
        Log.m96e(LOG_TAG, "createEmergencyOnlyMmTelFeatureInternal: null feature returned.");
        return null;
    }
    ...
    public IImsRcsFeature createRcsFeatureInternal(int slotId, int subId) {
        ...
        Log.m96e(LOG_TAG, "createRcsFeatureInternal: null feature returned.");
        return null;
    }
    ...
    public void addImsFeatureStatusCallback(int slotId, int featureType, IImsFeatureStatusCallback c) {
        synchronized (this.mFeaturesBySlot) {
            ...
            if (features == null) {
                Log.m102w(LOG_TAG, "Can not add ImsFeatureStatusCallback - no features on slot " + slotId);
                return;
            }
    ...
    public void removeImsFeatureStatusCallback(int slotId, int featureType, IImsFeatureStatusCallback c) {
        synchronized (this.mFeaturesBySlot) {
            SparseArray<ImsFeature> features = this.mFeaturesBySlot.get(slotId);
            if (features == null) {
                Log.m102w(LOG_TAG, "Can not remove ImsFeatureStatusCallback - no features on slot " + slotId);
                return;
            }
            ImsFeature f = features.get(featureType);
            if (f != null) {
    ...
    public void removeImsFeature(int slotId, int featureType) {
        ...
        synchronized (this.mFeaturesBySlot) {
            SparseArray<ImsFeature> features = this.mFeaturesBySlot.get(slotId);
            if (features == null) {
                Log.m102w(LOG_TAG, "Can not remove ImsFeature. No ImsFeatures exist on slot " + slotId);
                return;
            }
            ImsFeature f = features.get(featureType);
            if (f == null) {
                Log.m102w(LOG_TAG, "Can not remove ImsFeature. No feature with type " + featureType + " exists on slot " + slotId);
            } else {
                f.onFeatureRemoved();
    ...
    public void releaseResource() {
        Log.m102w(LOG_TAG, "cleaning up features");
        synchronized (this.mFeaturesBySlot) {
    ...
    public void executeMethodAsync(final Runnable r, String errorLogName) {
        try {
            ...
            Log.m102w(LOG_TAG, "ImsService Binder - " + errorLogName + " exception: " + e.getMessage());
        }
    }
