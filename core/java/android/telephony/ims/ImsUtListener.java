...
public class ImsUtListener {
    ...
    public void onUtConfigurationUpdated(int id) {
        try {
            ...
            Log.m102w(LOG_TAG, "utConfigurationUpdated: remote exception");
        }
    }
    ...
    public void onUtConfigurationUpdateFailed(int id, ImsReasonInfo error) {
        try {
            ...
            Log.m102w(LOG_TAG, "utConfigurationUpdateFailed: remote exception");
        }
    }
    ...
    public void onUtConfigurationQueried(int id, Bundle configuration) {
        try {
            ...
            Log.m102w(LOG_TAG, "utConfigurationQueried: remote exception");
        }
    }
    ...
    public void onUtConfigurationQueryFailed(int id, ImsReasonInfo error) {
        try {
            ...
            Log.m102w(LOG_TAG, "utConfigurationQueryFailed: remote exception");
        }
    }
    ...
    public void onUtConfigurationCallBarringQueried(int id, ImsSsInfo[] cbInfo) {
        try {
            ...
            Log.m102w(LOG_TAG, "utConfigurationCallBarringQueried: remote exception");
        }
    }
    ...
    public void onUtConfigurationCallForwardQueried(int id, ImsCallForwardInfo[] cfInfo) {
        try {
            ...
            Log.m102w(LOG_TAG, "utConfigurationCallForwardQueried: remote exception");
        }
    }
    ...
    public void onUtConfigurationCallWaitingQueried(int id, ImsSsInfo[] cwInfo) {
        try {
            ...
            Log.m102w(LOG_TAG, "utConfigurationCallWaitingQueried: remote exception");
        }
    }
    ...
    public void onSupplementaryServiceIndication(ImsSsData ssData) {
        try {
            ...
            Log.m102w(LOG_TAG, "onSupplementaryServiceIndication: remote exception");
        }
    }
