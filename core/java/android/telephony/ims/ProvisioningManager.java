...
public class ProvisioningManager {
          ...
          this.mExecutor.execute(
              new Runnable() { // from class:
                ...
                public final void run() {
                  ProvisioningManager.Callback.CallbackBinder.this.lambda$onIntConfigChanged$0(
                      item, value);
                }
              });
        } finally {
        ...
        try {
          this.mExecutor.execute(
              new Runnable() { // from class:
                ...
                @Override // java.lang.Runnable
                public final void run() {
                  ProvisioningManager.Callback.CallbackBinder.this.lambda$onStringConfigChanged$1(
                      item, value);
                }
              });
        } finally {
        ...
        try {
          this.mExecutor.execute(
              new Runnable() { // from class:
                ...
                @Override // java.lang.Runnable
                public final void run() {
                  ProvisioningManager.FeatureProvisioningCallback.CallbackBinder.this
                      .lambda$onFeatureProvisioningChanged$0(capability, tech, isProvisioned);
                }
              });
        } finally {
          restoreCallingIdentity(callingIdentity);
        ...
        try {
          this.mExecutor.execute(
              new Runnable() { // from class:
                ...
                public final void run() {
                  ProvisioningManager.FeatureProvisioningCallback.CallbackBinder.this
                      .lambda$onRcsFeatureProvisioningChanged$1(capability, tech, isProvisioned);
                }
              });
        } finally {
          restoreCallingIdentity(callingIdentity);
        ...
        try {
          this.mExecutor.execute(
              new Runnable() { // from class:
                ...
                public final void run() {
                  ProvisioningManager.RcsProvisioningCallback.CallbackBinder.this
                      .lambda$onAutoConfigurationErrorReceived$1(errorCode, errorString);
                }
              });
        } finally {
          Binder.restoreCallingIdentity(identity);
  ...
  public void unregisterFeatureProvisioningChangedCallback(FeatureProvisioningCallback callback) {
    try {
      getITelephony()
          .unregisterFeatureProvisioningChangedCallback(this.mSubId, callback.getBinder());
    } catch (RemoteException e) {
      throw e.rethrowAsRuntimeException();
    }
  }
  ...
  public void setProvisioningStatusForCapability(int capability, int tech, boolean isProvisioned) {
    try {
      getITelephony()
          .setImsProvisioningStatusForCapability(this.mSubId, capability, tech, isProvisioned);
    } catch (RemoteException e) {
      throw e.rethrowAsRuntimeException();
    }
  }
  ...
  public void setRcsProvisioningStatusForCapability(int capability, boolean isProvisioned) {
    try {
      getITelephony()
          .setRcsProvisioningStatusForCapability(this.mSubId, capability, 0, isProvisioned);
    } catch (RemoteException e) {
      throw e.rethrowAsRuntimeException();
    }
  }
  ...
  public void setRcsProvisioningStatusForCapability(
    ...
    try {
      getITelephony()
          .setRcsProvisioningStatusForCapability(this.mSubId, capability, tech, isProvisioned);
    } catch (RemoteException e) {
      throw e.rethrowAsRuntimeException();
    }
  }
