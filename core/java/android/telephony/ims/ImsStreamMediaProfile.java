...
public final class ImsStreamMediaProfile implements Parcelable {
  ...
  public static final Parcelable.Creator<ImsStreamMediaProfile> CREATOR =
      new Parcelable.Creator<
          ImsStreamMediaProfile>() { // from class: android.telephony.ims.ImsStreamMediaProfile.1
  ...
  public ImsStreamMediaProfile(
      int audioQuality, int audioDirection, int videoQuality, int videoDirection, int rttMode) {
    this.mIsReceivingRttAudio = false;
