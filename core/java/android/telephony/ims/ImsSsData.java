...
public final class ImsSsData implements Parcelable {
  ...
  private ImsSsData(Parcel in) {
    ...
    this.mImsSsInfo =
        in.readParcelableList(new ArrayList(), getClass().getClassLoader(), ImsSsInfo.class);
  }
  ...
  public int[] getSuppServiceInfoCompat() {
    ...
    if (list == null || list.size() == 0) {
      Rlog.m240e(
          TAG, "getSuppServiceInfoCompat: Could not parse mImsSsInfo, returning empty int[]");
      return result;
    }
    if (isTypeClir()) {
