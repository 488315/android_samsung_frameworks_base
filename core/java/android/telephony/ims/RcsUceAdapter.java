...
public class RcsUceAdapter {
          ...
          this.mExecutor.execute(
              new Runnable() { // from class:
                ...
                public final void run() {
                  RcsUceAdapter.PublishStateCallbackAdapter.PublishStateBinder.this
  ...
  public void requestCapabilities(
    ...
    if (imsRcsController == null) {
      Log.m96e(TAG, "requestCapabilities: IImsRcsController is null");
      throw new ImsException("Can not find remote IMS service", 1);
    }
    IRcsUceControllerCallback internalCallback = new BinderC34241(executor, c);
    try {
      ...
      Log.m97e(TAG, "Error calling IImsRcsController#requestCapabilities", e);
  ...
  class BinderC34241 extends IRcsUceControllerCallback.Stub {
    final /* synthetic */ CapabilitiesCallback val$c;
    final /* synthetic */ Executor val$executor;

    BinderC34241(Executor executor, CapabilitiesCallback capabilitiesCallback) {
  ...
  public void requestAvailability(Uri contactNumber, Executor executor, CapabilitiesCallback c)
    ...
    IImsRcsController imsRcsController = getIImsRcsController();
    if (imsRcsController == null) {
      Log.m96e(TAG, "requestAvailability: IImsRcsController is null");
      throw new ImsException("Cannot find remote IMS service", 1);
    }
    IRcsUceControllerCallback internalCallback = new BinderC34252(executor, c);
    try {
      ...
      Log.m97e(TAG, "Error calling IImsRcsController#requestAvailability", e);
      throw new ImsException("Remote IMS Service is not available", 1);
    } catch (ServiceSpecificException e2) {
      throw new ImsException(e2.toString(), e2.errorCode);
    }
  ...
  class BinderC34252 extends IRcsUceControllerCallback.Stub {
    final /* synthetic */ CapabilitiesCallback val$c;
    final /* synthetic */ Executor val$executor;

    BinderC34252(Executor executor, CapabilitiesCallback capabilitiesCallback) {
      this.val$executor = executor;
      this.val$c = capabilitiesCallback;
    }
  ...
  public int getUcePublishState() throws ImsException {
    IImsRcsController imsRcsController = getIImsRcsController();
    if (imsRcsController == null) {
      Log.m96e(TAG, "getUcePublishState: IImsRcsController is null");
      throw new ImsException("Can not find remote IMS service", 1);
    }
    try {
      return imsRcsController.getUcePublishState(this.mSubId);
    } catch (RemoteException e) {
      Log.m97e(TAG, "Error calling IImsRcsController#getUcePublishState", e);
      throw new ImsException("Remote IMS Service is not available", 1);
    } catch (ServiceSpecificException e2) {
  ...
  public void addOnPublishStateChangedListener(
    ...
    IImsRcsController imsRcsController = getIImsRcsController();
    if (imsRcsController == null) {
      Log.m96e(TAG, "addOnPublishStateChangedListener : IImsRcsController is null");
      throw new ImsException("Cannot find remote IMS service", 1);
    }
    ...
    try {
      ...
      Log.m97e(TAG, "Error calling IImsRcsController#registerUcePublishStateCallback", e);
      throw new ImsException("Remote IMS Service is not available", 1);
    } catch (ServiceSpecificException e2) {
      throw new ImsException(e2.getMessage(), e2.errorCode);
    }
  ...
  public void removeOnPublishStateChangedListener(OnPublishStateChangedListener listener)
    ...
    IImsRcsController imsRcsController = getIImsRcsController();
    if (imsRcsController == null) {
      Log.m96e(TAG, "removeOnPublishStateChangedListener: IImsRcsController is null");
      throw new ImsException("Cannot find remote IMS service", 1);
    }
    ...
    try {
      ...
      Log.m97e(TAG, "Error calling IImsRcsController#unregisterUcePublishStateCallback", e);
      throw new ImsException("Remote IMS Service is not available", 1);
    } catch (ServiceSpecificException e2) {
      throw new ImsException(e2.getMessage(), e2.errorCode);
    }
  ...
  public boolean isUceSettingEnabled() throws ImsException {
    IImsRcsController imsRcsController = getIImsRcsController();
    if (imsRcsController == null) {
      Log.m96e(TAG, "isUceSettingEnabled: IImsRcsController is null");
      throw new ImsException("Can not find remote IMS service", 1);
    }
    try {
      return imsRcsController.isUceSettingEnabled(
          this.mSubId, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
    } catch (RemoteException e) {
      Log.m97e(TAG, "Error calling IImsRcsController#isUceSettingEnabled", e);
      throw new ImsException("Remote IMS Service is not available", 1);
    }
  }
  ...
  public void setUceSettingEnabled(boolean isEnabled) throws ImsException {
    IImsRcsController imsRcsController = getIImsRcsController();
    if (imsRcsController == null) {
      Log.m96e(TAG, "setUceSettingEnabled: IImsRcsController is null");
      throw new ImsException("Can not find remote IMS service", 1);
    }
    try {
      imsRcsController.setUceSettingEnabled(this.mSubId, isEnabled);
    } catch (RemoteException e) {
      Log.m97e(TAG, "Error calling IImsRcsController#setUceSettingEnabled", e);
      throw new ImsException("Remote IMS Service is not available", 1);
    }
  }
