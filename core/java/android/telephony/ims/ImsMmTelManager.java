...
public class ImsMmTelManager implements RegistrationManager {
    ...
    public static class CapabilityCallback {
        ...
        static class CapabilityBinder extends IImsCapabilityCallback.Stub {
            ...
            public void onCapabilitiesStatusChanged(final int config) {
                Log.m98i(ImsMmTelManager.TAG, "onCapabilitiesStatusChanged()");
    ...
    public void getRegistrationState(Executor executor, final Consumer<Integer> stateCallback) {
        ...
        try {
            iTelephony.getImsMmTelRegistrationState(this.mSubId, new BinderC33901(executor, stateCallback));
        } catch (RemoteException | ServiceSpecificException e) {
            Log.m102w(TAG, "Error getting registration state: " + e);
    ...
    class BinderC33901 extends IIntegerConsumer.Stub {
        final /* synthetic */ Executor val$executor;
        final /* synthetic */ Consumer val$stateCallback;

        BinderC33901(Executor executor, Consumer consumer) {
    ...
    public void getRegistrationTransportType(Executor executor, final Consumer<Integer> transportTypeCallback) {
        ...
        try {
            iTelephony.getImsMmTelRegistrationTransportType(this.mSubId, new BinderC33912(executor, transportTypeCallback));
        } catch (RemoteException | ServiceSpecificException e) {
            Log.m102w(TAG, "Error getting transport type: " + e);
    ...
    class BinderC33912 extends IIntegerConsumer.Stub {
        final /* synthetic */ Executor val$executor;
        final /* synthetic */ Consumer val$transportTypeCallback;

        BinderC33912(Executor executor, Consumer consumer) {
            this.val$executor = executor;
    ...
    public void unregisterMmTelCapabilityCallback(CapabilityCallback c) {
        ...
        ITelephony iTelephony = getITelephony();
        if (iTelephony == null) {
            Log.m102w(TAG, "Could not find Telephony Service.");
            return;
        }
        try {
    ...
    public void isSupported(int capability, int transportType, Executor executor, Consumer<Boolean> callback) throws ImsException {
        ...
        try {
            iTelephony.isMmTelCapabilitySupported(this.mSubId, new BinderC33923(executor, callback), capability, transportType);
        } catch (RemoteException e) {
    ...
    class BinderC33923 extends IIntegerConsumer.Stub {
        final /* synthetic */ Consumer val$callback;
        final /* synthetic */ Executor val$executor;

        BinderC33923(Executor executor, Consumer consumer) {
            this.val$executor = executor;
    ...
    public void getFeatureState(Executor executor, Consumer<Integer> callback) throws ImsException {
        ...
        try {
            iTelephony.getImsMmTelFeatureState(this.mSubId, new BinderC33934(executor, callback));
        } catch (RemoteException e) {
            e.rethrowAsRuntimeException();
        } catch (ServiceSpecificException sse) {
            throw new ImsException(sse.getMessage(), sse.errorCode);
    ...
    class BinderC33934 extends IIntegerConsumer.Stub {
        final /* synthetic */ Consumer val$callback;
        final /* synthetic */ Executor val$executor;

        BinderC33934(Executor executor, Consumer consumer) {
            this.val$executor = executor;
            this.val$callback = consumer;
        }
