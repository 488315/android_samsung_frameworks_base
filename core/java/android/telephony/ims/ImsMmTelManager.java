  ...
  public void getRegistrationState(Executor executor, final Consumer<Integer> stateCallback) {
    ...
    try {
      iTelephony.getImsMmTelRegistrationState(
          this.mSubId, new BinderC33901(executor, stateCallback));
  ...
  public void getRegistrationTransportType(
    ...
    try {
      iTelephony.getImsMmTelRegistrationTransportType(
          this.mSubId, new BinderC33912(executor, transportTypeCallback));
    } catch (RemoteException | ServiceSpecificException e) {
  ...
  public void isSupported(
    ...
    try {
      iTelephony.isMmTelCapabilitySupported(
          this.mSubId, new BinderC33923(executor, callback), capability, transportType);
    } catch (RemoteException e) {
