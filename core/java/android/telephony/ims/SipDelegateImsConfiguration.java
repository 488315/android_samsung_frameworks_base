...
public final class SipDelegateImsConfiguration implements Parcelable {
  public static final Parcelable.Creator<SipDelegateImsConfiguration> CREATOR =
      new Parcelable.Creator<
          SipDelegateImsConfiguration>() { // from class:
                                           // android.telephony.ims.SipDelegateImsConfiguration.1
  ...
  public SipDelegateConfiguration toNewConfig() {
    ...
    SipDelegateConfiguration.Builder builder =
        new SipDelegateConfiguration.Builder(
            this.mVersion,
            transportType,
            getSocketAddr(
                getString(KEY_SIP_CONFIG_UE_DEFAULT_IPADDRESS_STRING),
    ...
    if (getBoolean(KEY_SIP_CONFIG_IS_IPSEC_ENABLED_BOOL, false)) {
      builder.setIpSecConfiguration(
          new SipDelegateConfiguration.IpSecConfiguration(
