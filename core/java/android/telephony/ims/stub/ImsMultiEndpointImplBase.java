...
public class ImsMultiEndpointImplBase {
  ...
  private final IImsMultiEndpoint mImsMultiEndpoint = new BinderC34581();

  /* renamed from: android.telephony.ims.stub.ImsMultiEndpointImplBase$1 */
  class BinderC34581 extends IImsMultiEndpoint.Stub {
    BinderC34581() {}
    ...
    public void setListener(final IImsExternalCallStateListener listener) throws RemoteException {
      executeMethodAsync(
          new Runnable() { // from class:
                           // android.telephony.ims.stub.ImsMultiEndpointImplBase$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              ImsMultiEndpointImplBase.BinderC34581.this.lambda$setListener$0(listener);
            }
          },
          "setListener");
    }
    ...
    public /* synthetic */ void lambda$setListener$0(IImsExternalCallStateListener listener) {
      if (ImsMultiEndpointImplBase.this.mListener != null
        ...
        Log.m102w(ImsMultiEndpointImplBase.TAG, "setListener: discarding dead Binder");
        ImsMultiEndpointImplBase.this.mListener = null;
      }
      if (ImsMultiEndpointImplBase.this.mListener != null
          && listener != null
          && Objects.equals(
              ImsMultiEndpointImplBase.this.mListener.asBinder(), listener.asBinder())) {
        return;
      }
      if (listener == null) {
        ImsMultiEndpointImplBase.this.mListener = null;
    ...
    public void requestImsExternalCallStateInfo() throws RemoteException {
      executeMethodAsync(
          new Runnable() { // from class:
                           // android.telephony.ims.stub.ImsMultiEndpointImplBase$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              ImsMultiEndpointImplBase.BinderC34581.this.lambda$requestImsExternalCallStateInfo$1();
            }
          },
    ...
    private void executeMethodAsync(final Runnable r, String errorLogName) {
      try {
        CompletableFuture.runAsync(
                new Runnable() { // from class:
                                 // android.telephony.ims.stub.ImsMultiEndpointImplBase$1$$ExternalSyntheticLambda2
                  @Override // java.lang.Runnable
                  public final void run() {
                    TelephonyUtils.runWithCleanCallingIdentity(r);
                  }
                },
                ImsMultiEndpointImplBase.this.mExecutor)
            .join();
      } catch (CancellationException | CompletionException e) {
        Log.m102w(
            ImsMultiEndpointImplBase.TAG,
            "ImsMultiEndpointImplBase Binder - " + errorLogName + " exception: " + e.getMessage());
      }
    }
  }
  ...
  public final void onImsExternalCallStateUpdate(List<ImsExternalCallState> externalCallDialogs) {
    ...
    Log.m94d(TAG, "ims external call state update triggered.");
  ...
  public void requestImsExternalCallStateInfo() {
    Log.m94d(TAG, "requestImsExternalCallStateInfo() not implemented");
  }
