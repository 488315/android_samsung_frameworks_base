    ...
    class BinderC34581 extends IImsMultiEndpoint.Stub {
        ...
        public /* synthetic */ void lambda$setListener$0(IImsExternalCallStateListener listener) {
            ...
            if (listener == null) {
                ...
                Log.m102w(ImsMultiEndpointImplBase.TAG, "setListener is being called when there is already an active listener");
                ImsMultiEndpointImplBase.this.mListener = listener;
            }
        }
        ...
        private void executeMethodAsync(final Runnable r, String errorLogName) {
            try {
                ...
                Log.m102w(ImsMultiEndpointImplBase.TAG, "ImsMultiEndpointImplBase Binder - " + errorLogName + " exception: " + e.getMessage());
            }
        }
    }
