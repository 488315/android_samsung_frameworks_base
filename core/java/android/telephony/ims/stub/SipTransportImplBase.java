...
public class SipTransportImplBase {
  ...
  private final IBinder.DeathRecipient mDeathRecipient = new C34611();
  private final ISipTransport.Stub mSipTransportImpl = new BinderC34622();
  ...
  class C34611 implements IBinder.DeathRecipient {
    C34611() {}
      ...
      SipTransportImplBase.this.mBinderExecutor.execute(
          new Runnable() { // from class:
            ...
            public final void run() {
              SipTransportImplBase.C34611.this.lambda$binderDied$0();
            }
          });
    }
    ...
    public void binderDied(final IBinder who) {
      SipTransportImplBase.this.mBinderExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              SipTransportImplBase.C34611.this.lambda$binderDied$1(who);
            }
          });
    }
  }
  ...
  class BinderC34622 extends ISipTransport.Stub {
    BinderC34622() {}
      ...
      try {
        SipTransportImplBase.this.mBinderExecutor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                SipTransportImplBase.BinderC34622.this.lambda$createSipDelegate$0(
                    subId, request, dc, mc);
              }
            });
      } finally {
      ...
      try {
        SipTransportImplBase.this.mBinderExecutor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                SipTransportImplBase.BinderC34622.this.lambda$destroySipDelegate$1(
                    delegate, reason);
              }
            });
      } finally {
  ...
  public void createSipDelegateInternal(
      int subId, DelegateRequest r, ISipDelegateStateCallback cb, ISipDelegateMessageCallback mc) {
  ...
  public void destroySipDelegateInternal(ISipDelegate d, int reason) {
    ...
    Log.m102w(
        LOG_TAG, "destroySipDelegateInternal, could not findSipDelegate corresponding to " + d);
  }
  ...
  private void linkDeathRecipient(SipDelegateAidlWrapper w) {
    try {
      ...
      Log.m102w(LOG_TAG, "linkDeathRecipient, remote process already died, cleaning up.");
  ...
  public void binderDiedInternal(IBinder who) {
    ...
    while (it.hasNext()) {
      ...
      if (who == null || w.getStateCallbackBinder().asBinder().equals(who)) {
        Log.m102w(LOG_TAG, "Binder death detected for " + w + ", calling destroy and removing.");
    ...
    Log.m102w(
        LOG_TAG,
        "Binder death detected for IBinder " + who + ", but couldn't find matching SipDelegate");
  }
