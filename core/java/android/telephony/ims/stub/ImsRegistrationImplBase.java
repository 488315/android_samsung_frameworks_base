...
public class ImsRegistrationImplBase {
  ...
  class BinderC34591 extends IImsRegistration.Stub {
    BinderC34591() {}
    ...
    public /* synthetic */ Integer lambda$getRegistrationTechnology$0() {
      return Integer.valueOf(
          ImsRegistrationImplBase.this.mRegistrationAttributes == null
              ? -1
              : ImsRegistrationImplBase.this.mRegistrationAttributes.getRegistrationTechnology());
    }
                  ...
                  new Supplier() { // from class:
                    ...
                    public final Object get() {
                      ...
                      lambda$getRegistrationTechnology$0 =
                          ImsRegistrationImplBase.BinderC34591.this
                              .lambda$getRegistrationTechnology$0();
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            public final void run() {
              ImsRegistrationImplBase.BinderC34591.this.lambda$addRegistrationCallback$1(
                  c, exceptionRef);
            }
          },
    ...
    public void removeRegistrationCallback(final IImsRegistrationCallback c)
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsRegistrationImplBase.BinderC34591.this.lambda$removeRegistrationCallback$2(c);
            }
          },
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$triggerFullNetworkRegistration$3(
    ...
    public void triggerFullNetworkRegistration(final int sipCode, final String sipReason) {
      executeMethodAsyncNoException(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsRegistrationImplBase.BinderC34591.this.lambda$triggerFullNetworkRegistration$3(
                  sipCode, sipReason);
            }
          },
    ...
    public void triggerUpdateSipDelegateRegistration() {
      executeMethodAsyncNoException(
          new Runnable() { // from class:
            ...
            public final void run() {
              ImsRegistrationImplBase.BinderC34591.this
                  .lambda$triggerUpdateSipDelegateRegistration$4();
            }
          },
    ...
    public void triggerSipDelegateDeregistration() {
      executeMethodAsyncNoException(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsRegistrationImplBase.BinderC34591.this.lambda$triggerSipDelegateDeregistration$5();
            }
          },
    ...
    public void triggerDeregistration(final int reason) {
      executeMethodAsyncNoException(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsRegistrationImplBase.BinderC34591.this.lambda$triggerDeregistration$6(reason);
            }
          },
    ...
    private void executeMethodAsync(final Runnable r, String errorLogName) throws RemoteException {
      try {
        ...
        Log.m102w(
            ...
            "ImsRegistrationImplBase Binder - " + errorLogName + " exception: " + e.getMessage());
  ...
  static /* synthetic */ void lambda$onRegistered$0(
    ...
    try {
      ...
      Log.m102w(LOG_TAG, e + "onRegistered(int, Set) - Skipping callback.");
    }
  }
  ...
  static /* synthetic */ void lambda$onRegistering$1(
    ...
    try {
      ...
      Log.m102w(LOG_TAG, e + "onRegistering(int, Set) - Skipping callback.");
    }
  }
  ...
  public final void onDeregistered(
      ImsReasonInfo info, final int suggestedAction, final int imsRadioTech) {
        ...
        new Consumer() { // from class:
          ...
          public final void accept(Object obj) {
            ImsRegistrationImplBase.lambda$onDeregistered$2(
                ImsReasonInfo.this, suggestedAction, imsRadioTech, (IImsRegistrationCallback) obj);
          }
        });
  }

  static /* synthetic */ void lambda$onDeregistered$2(
      ImsReasonInfo reasonInfo, int suggestedAction, int imsRadioTech, IImsRegistrationCallback c) {
    try {
      c.onDeregistered(reasonInfo, suggestedAction, imsRadioTech);
    } catch (RemoteException e) {
      Log.m102w(LOG_TAG, e + "onDeregistered() - Skipping callback.");
    }
  }
  ...
  static /* synthetic */ void lambda$onTechnologyChangeFailed$4(
    ...
    try {
      ...
      Log.m102w(LOG_TAG, e + "onTechnologyChangeFailed() - Skipping callback.");
    }
  }
  ...
  public void lambda$onSubscriberAssociatedUriChanged$5(
    ...
    try {
      ...
      Log.m102w(LOG_TAG, e + "onSubscriberAssociatedUriChanged() - Skipping callback.");
    }
  }
  ...
  private void updateToDisconnectedState(
    ...
    synchronized (this.mLock) {
      ...
      if (info != null) {
        ...
        Log.m102w(LOG_TAG, "updateToDisconnectedState: no ImsReasonInfo provided.");
        this.mLastDisconnectCause = new ImsReasonInfo();
      }
    }
  }
