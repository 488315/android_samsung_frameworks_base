...
public class ImsConfigImplBase {
    ...
    public static class ImsConfigStub extends IImsConfig.Stub {
            ...
            try {
                synchronized (this.mLock) {
                    ...
                    if (returnVal == 0) {
                        ...
                        Log.m94d(ImsConfigImplBase.TAG, "Set provision value of " + item + " to " + value + " failed with error code " + returnVal);
                    }
                }
        ...
        public void notifyRcsAutoConfigurationReceived(final byte[] config, final boolean isCompressed) throws RemoteException {
            ...
            if (exceptionRef.get() != null) {
                Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception notifyRcsAutoConfigurationReceived");
                throw exceptionRef.get();
            }
        }
        ...
        public void notifyRcsAutoConfigurationRemoved() throws RemoteException {
            ...
            if (exceptionRef.get() != null) {
                Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception notifyRcsAutoConfigurationRemoved");
                throw exceptionRef.get();
            }
        }
        ...
        private void executeMethodAsync(final Runnable r, String errorLogName) throws RemoteException {
            try {
                ...
                Log.m102w(ImsConfigImplBase.TAG, "ImsConfigImplBase Binder - " + errorLogName + " exception: " + e.getMessage());
