...
public class ImsConfigImplBase {
  ...
  public static class ImsConfigStub extends IImsConfig.Stub {
    ...
    public void addImsConfigCallback(final IImsConfigCallback c) throws RemoteException {
      ...
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception addImsConfigCallback");
    ...
    public void removeImsConfigCallback(final IImsConfigCallback c) throws RemoteException {
      ...
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception removeImsConfigCallback");
        throw exceptionRef.get();
      }
    }
    ...
    public int getConfigInt(final int item) throws RemoteException {
      ...
      int retVal =
          ((Integer)
                      ...
                      new Supplier() { // from class:
                        ...
                        public final Object get() {
                          ...
                          lambda$getConfigInt$2 =
                              ImsConfigImplBase.ImsConfigStub.this.lambda$getConfigInt$2(
                                  item, exceptionRef);
              ...
              .intValue();
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception getConfigString");
        throw exceptionRef.get();
      }
      return retVal;
    }
                  ...
                  new Supplier() { // from class:
                    ...
                    public final Object get() {
                      ...
                      lambda$getConfigString$3 =
                          ImsConfigImplBase.ImsConfigStub.this.lambda$getConfigString$3(
                              item, exceptionRef);
    ...
    public int setConfigInt(final int item, final int value) throws RemoteException {
      ...
      int retVal =
          ((Integer)
                      ...
                      new Supplier() { // from class:
                        ...
                        public final Object get() {
                          ...
                          lambda$setConfigInt$4 =
                              ImsConfigImplBase.ImsConfigStub.this.lambda$setConfigInt$4(
              ...
              .intValue();
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception setConfigInt");
        throw exceptionRef.get();
      }
      return retVal;
    }
                      ...
                      new Supplier() { // from class:
                        ...
                        public final Object get() {
                          ...
                          lambda$setConfigString$5 =
                              ImsConfigImplBase.ImsConfigStub.this.lambda$setConfigString$5(
                                  item, value, exceptionRef);
    ...
    public void updateImsCarrierConfigs(final PersistableBundle bundle) throws RemoteException {
      ...
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception updateImsCarrierConfigs");
        throw exceptionRef.get();
      }
    }
    ...
    @Override // android.telephony.ims.aidl.IImsConfig
    public void notifyRcsAutoConfigurationReceived(final byte[] config, final boolean isCompressed)
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsConfigImplBase.ImsConfigStub.this.lambda$notifyRcsAutoConfigurationReceived$7(
    ...
    public void notifyRcsAutoConfigurationRemoved() throws RemoteException {
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsConfigImplBase.ImsConfigStub.this.lambda$notifyRcsAutoConfigurationRemoved$8(
                  exceptionRef);
            }
          },
      ...
      if (exceptionRef.get() != null) {
        Log.m94d(
            ImsConfigImplBase.TAG, "ImsConfigImplBase Exception notifyRcsAutoConfigurationRemoved");
        throw exceptionRef.get();
      }
    }
    ...
    public void addRcsConfigCallback(final IRcsConfigCallback c) throws RemoteException {
      ...
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception addRcsConfigCallback");
        throw exceptionRef.get();
      }
    }
    ...
    public void removeRcsConfigCallback(final IRcsConfigCallback c) throws RemoteException {
      ...
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception removeRcsConfigCallback");
        throw exceptionRef.get();
      }
    }
    ...
    public void triggerRcsReconfiguration() throws RemoteException {
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsConfigImplBase.ImsConfigStub.this.lambda$triggerRcsReconfiguration$11(
                  exceptionRef);
            }
          },
          "triggerRcsReconfiguration");
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception triggerRcsReconfiguration");
        throw exceptionRef.get();
      }
    }
    ...
    public void setRcsClientConfiguration(final RcsClientConfiguration rcc) throws RemoteException {
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsConfigImplBase.ImsConfigStub.this.lambda$setRcsClientConfiguration$12(
                  rcc, exceptionRef);
            }
          },
          "setRcsClientConfiguration");
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception setRcsClientConfiguration");
        throw exceptionRef.get();
      }
    }
    ...
    public void notifyIntImsConfigChanged(final int item, final int value) throws RemoteException {
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsConfigImplBase.ImsConfigStub.this.lambda$notifyIntImsConfigChanged$13(
                  item, value, exceptionRef);
            }
          },
          "notifyIntImsConfigChanged");
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception notifyIntImsConfigChanged");
        throw exceptionRef.get();
      }
    }
    ...
    public void notifyStringImsConfigChanged(final int item, final String value)
      ...
      executeMethodAsync(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ImsConfigImplBase.ImsConfigStub.this.lambda$notifyStringImsConfigChanged$14(
                  item, value, exceptionRef);
            }
          },
          "notifyStringImsConfigChanged");
      if (exceptionRef.get() != null) {
        Log.m94d(ImsConfigImplBase.TAG, "ImsConfigImplBase Exception notifyStringImsConfigChanged");
        throw exceptionRef.get();
      }
    }
    ...
    public void clearCachedValue() {
      Log.m98i(ImsConfigImplBase.TAG, "clearCachedValue");
      synchronized (this.mLock) {
    ...
    private void executeMethodAsync(final Runnable r, String errorLogName) throws RemoteException {
      try {
        ...
        Log.m102w(
            ImsConfigImplBase.TAG,
            "ImsConfigImplBase Binder - " + errorLogName + " exception: " + e.getMessage());
  ...
  static /* synthetic */ void lambda$notifyConfigChanged$0(
    ...
    try {
      ...
      Log.m102w(TAG, "notifyConfigChanged(int): dead binder in notify, skipping.");
    }
  }
  ...
  static /* synthetic */ void lambda$notifyConfigChanged$1(
    ...
    try {
      ...
      Log.m102w(TAG, "notifyConfigChanged(string): dead binder in notify, skipping.");
    }
  }
  ...
  public void addRcsConfigCallback(IRcsConfigCallback c) {
    ...
    synchronized (this.mRcsConfigDataLock) {
      ...
      try {
        ...
        Log.m102w(TAG, "dead binder to call onConfigurationChanged, skipping.");
      }
    }
  }
  ...
  static /* synthetic */ void lambda$onNotifyRcsAutoConfigurationReceived$2(
    ...
    try {
      ...
      Log.m102w(TAG, "dead binder in notifyRcsAutoConfigurationReceived, skipping.");
    }
  }
  ...
  static /* synthetic */ void lambda$onNotifyRcsAutoConfigurationRemoved$3(IRcsConfigCallback c) {
    try {
      ...
      Log.m102w(TAG, "dead binder in notifyRcsAutoConfigurationRemoved, skipping.");
    }
  }
  ...
  public final void notifyProvisionedValueChanged(int item, int value) {
    ...
    try {
      ...
      Log.m102w(TAG, "notifyProvisionedValueChanged(int): Framework connection is dead.");
    }
  }
  ...
  public final void notifyProvisionedValueChanged(int item, String value) {
    ...
    try {
      ...
      Log.m102w(TAG, "notifyProvisionedValueChanged(string): Framework connection is dead.");
    }
  }
  ...
  static /* synthetic */ void lambda$notifyAutoConfigurationErrorReceived$4(
    ...
    try {
      ...
      Log.m102w(TAG, "dead binder in notifyAutoConfigurationErrorReceived, skipping.");
    }
  }
  ...
  static /* synthetic */ void lambda$notifyPreProvisioningReceived$5(
    ...
    try {
      ...
      Log.m102w(TAG, "dead binder in notifyPreProvisioningReceived, skipping.");
    }
  }
