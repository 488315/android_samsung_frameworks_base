...
public class ImsCallSessionImplBase extends IImsCallSession.Stub {
  ...
  private class ImsCallSessionListenerConverter extends IImsCallSessionListener.Stub {
    ...
    public void callSessionProgressing(
        IImsCallSession i, ImsStreamMediaProfile imsStreamMediaProfile) throws RemoteException {
    ...
    @Override // com.android.ims.internal.IImsCallSessionListener
    public void callSessionConferenceExtendFailed(IImsCallSession i, ImsReasonInfo imsReasonInfo)
        throws RemoteException {
    ...
    public void callSessionHandover(
        IImsCallSession i, int srcAccessTech, int targetAccessTech, ImsReasonInfo reasonInfo)
        throws RemoteException {
