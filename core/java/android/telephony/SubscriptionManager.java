...
public class SubscriptionManager {
  ...
  @SystemApi public static final Uri ADVANCED_CALLING_ENABLED_CONTENT_URI;
  ...
  @SystemApi public static final Uri CROSS_SIM_ENABLED_CONTENT_URI;
  ...
  @SystemApi @Deprecated public static final int PROFILE_CLASS_DEFAULT = -1;

  @SystemApi public static final int PROFILE_CLASS_OPERATIONAL = 2;

  @SystemApi public static final int PROFILE_CLASS_PROVISIONING = 1;

  @SystemApi public static final int PROFILE_CLASS_TESTING = 0;

  @SystemApi public static final int PROFILE_CLASS_UNSET = -1;
  ...
  @SystemApi public static final Uri VT_ENABLED_CONTENT_URI;
  public static final String VT_IMS_ENABLED = "vt_ims_enabled";

  @SystemApi public static final Uri WFC_ENABLED_CONTENT_URI;
  public static final String WFC_IMS_ENABLED = "wfc_ims_enabled";
  public static final String WFC_IMS_MODE = "wfc_ims_mode";
  public static final String WFC_IMS_ROAMING_ENABLED = "wfc_ims_roaming_enabled";
  public static final String WFC_IMS_ROAMING_MODE = "wfc_ims_roaming_mode";

  @SystemApi public static final Uri WFC_MODE_CONTENT_URI;

  @SystemApi public static final Uri WFC_ROAMING_ENABLED_CONTENT_URI;

  @SystemApi public static final Uri WFC_ROAMING_MODE_CONTENT_URI;
  ...
  static {
    ...
    CONTENT_URI = uri;
    sGetDefaultSubIdCache =
        new VoidPropertyInvalidatedCache<>(
            new FunctionalUtils
                .ThrowingFunction() { // from class:
    ...
    sGetDefaultSmsSubIdCache =
        new VoidPropertyInvalidatedCache<>(
            ...
            CACHE_KEY_SUBSCRIPTION_MANAGER_SERVICE_PROPERTY,
            -1);
    sGetActiveDataSubscriptionIdCache =
        new VoidPropertyInvalidatedCache<>(
            new FunctionalUtils
                .ThrowingFunction() { // from class:
            ...
            -1);
    sGetSlotIndexCache =
        new IntegerPropertyInvalidatedCache<>(
            new FunctionalUtils
                .ThrowingBiFunction() { // from class:
    ...
    public T query(Void r5) {
      ...
      try {
        ...
        com.android.telephony.Rlog.m246w(
            SubscriptionManager.LOG_TAG,
            "Failed to recompute cache key for " + this.mCacheKeyProperty);
        return t;
      }
    }
  }
  ...
  public static class OnSubscriptionsChangedListener {
    ...
    public void onAddListenerFailed() {
      com.android.telephony.Rlog.m246w(
          SubscriptionManager.LOG_TAG, "onAddListenerFailed not overridden");
    }

    private void log(String s) {
      com.android.telephony.Rlog.m238d(SubscriptionManager.LOG_TAG, s);
    }
  }
  ...
  public void addOnSubscriptionsChangedListener(
      Executor executor, final OnSubscriptionsChangedListener listener) {
    ...
    if (telephonyRegistryManager != null) {
      ...
      loge(
          "addOnSubscriptionsChangedListener: pkgname="
              + pkgName
              + " failed to be added  due to TELEPHONY_REGISTRY_SERVICE being unavailable.");
      executor.execute(
  ...
  public void addOnOpportunisticSubscriptionsChangedListener(
      Executor executor, OnOpportunisticSubscriptionsChangedListener listener) {
  ...
  public SubscriptionInfo getActiveSubscriptionInfo(int subId) {
    ...
    try {
      ...
      SubscriptionInfo subInfo =
          iSub.getActiveSubscriptionInfo(
  ...
  public SubscriptionInfo getActiveSubscriptionInfoForIcc(String iccId) {
    ...
    try {
      ...
      SubscriptionInfo result =
          iSub.getActiveSubscriptionInfoForIccId(
              iccId, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
      return result;
    } catch (RemoteException e) {
      return null;
    }
  ...
  public SubscriptionInfo getActiveSubscriptionInfoForSimSlotIndex(int slotIndex) {
    ...
    try {
      ...
      SubscriptionInfo result =
          iSub.getActiveSubscriptionInfoForSimSlotIndex(
  ...
  public List<SubscriptionInfo> getActiveSubscriptionInfoList(boolean userVisibleOnly) {
    ...
    try {
      ...
      if (iSub != null) {
        activeList =
            iSub.getActiveSubscriptionInfoList(
                this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
      }
    } catch (RemoteException e) {
    }
            ...
            .filter(
                new Predicate() { // from class:
                  ...
                  public final boolean test(Object obj) {
                    ...
                    lambda$getActiveSubscriptionInfoList$1 =
                        SubscriptionManager.this.lambda$getActiveSubscriptionInfoList$1(
  ...
  public List<SubscriptionInfo> getAvailableSubscriptionInfoList() {
    try {
      ...
      List<SubscriptionInfo> result =
          iSub.getAvailableSubscriptionInfoList(
              this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
      return result;
    } catch (RemoteException e) {
      return null;
  ...
  public List<SubscriptionInfo> semGetAvailableSubscriptionInfoListWithSelectable(
      boolean selectable) {
    if (selectable) {
  ...
  public List<SubscriptionInfo> getAccessibleSubscriptionInfoList() {
    try {
      ...
      List<SubscriptionInfo> result =
          iSub.getAccessibleSubscriptionInfoList(this.mContext.getOpPackageName());
      return result;
    } catch (RemoteException e) {
      return null;
    }
  ...
  public void addSubscriptionInfoRecord(
      String uniqueId, String displayName, int slotIndex, int subscriptionType) {
    if (uniqueId == null) {
      Log.m96e(LOG_TAG, "[addSubscriptionInfoRecord]- uniqueId is null");
      return;
    }
    try {
      ISub iSub = TelephonyManager.getSubscriptionService();
      if (iSub == null) {
        Log.m96e(LOG_TAG, "[addSubscriptionInfoRecord]- ISub service is null");
        return;
      }
      int result = iSub.addSubInfo(uniqueId, displayName, slotIndex, subscriptionType);
      if (result < 0) {
        Log.m96e(LOG_TAG, "Adding of subscription didn't succeed: error = " + result);
      } else {
  ...
  public void removeSubscriptionInfoRecord(String uniqueId, int subscriptionType) {
    ...
    try {
      ISub iSub = TelephonyManager.getSubscriptionService();
      if (iSub == null) {
        Log.m96e(LOG_TAG, "[removeSubscriptionInfoRecord]- ISub service is null");
        return;
      }
      boolean result = iSub.removeSubInfo(uniqueId, subscriptionType);
      if (!result) {
        Log.m96e(LOG_TAG, "Removal of subscription didn't succeed");
      } else {
  ...
  public int setIconTint(final int tint, final int subId) {
    return setSubscriptionPropertyHelper(
        subId,
        "setIconTint",
        new CallISubMethodHelper() { // from class:
  ...
  public int setDisplayName(final String displayName, final int subId, final int nameSource) {
    return setSubscriptionPropertyHelper(
        ...
        "setDisplayName",
        new CallISubMethodHelper() { // from class:
                                     // android.telephony.SubscriptionManager$$ExternalSyntheticLambda15
          @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
          public final int callMethod(ISub iSub) {
  ...
  public int setDataRoaming(final int roaming, final int subId) {
    return setSubscriptionPropertyHelper(
        ...
        "setDataRoaming",
        new CallISubMethodHelper() { // from class:
                                     // android.telephony.SubscriptionManager$$ExternalSyntheticLambda1
          @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
          public final int callMethod(ISub iSub) {
            int dataRoaming;
  ...
  private static void loge(String msg) {
    com.android.telephony.Rlog.m240e(LOG_TAG, msg);
  }
  ...
  private static String getStringSubscriptionProperty(
      Context context, int subscriptionId, String columnName) {
    String resultValue = null;
    try {
      ISub iSub = TelephonyManager.getSubscriptionService();
      if (iSub != null) {
        resultValue =
            iSub.getSubscriptionProperty(
                subscriptionId,
                columnName,
                context.getOpPackageName(),
  ...
  public static boolean getBooleanSubscriptionProperty(
      int subscriptionId, String columnName, boolean defaultValue, Context context) {
  ...
  public static int getIntegerSubscriptionProperty(
      int subscriptionId, String columnName, int defaultValue, Context context) {
    String result = getStringSubscriptionProperty(context, subscriptionId, columnName);
    if (!result.isEmpty()) {
      try {
  ...
  public static long getLongSubscriptionProperty(
      int subscriptionId, String columnName, long defaultValue, Context context) {
    String result = getStringSubscriptionProperty(context, subscriptionId, columnName);
    if (!result.isEmpty()) {
      try {
  ...
  public List<SubscriptionPlan> getSubscriptionPlans(int subId) {
    SubscriptionPlan[] subscriptionPlans =
        getNetworkPolicyManager().getSubscriptionPlans(subId, this.mContext.getOpPackageName());
  ...
  public void setSubscriptionPlans(
      int subId, List<SubscriptionPlan> plans, long expirationDurationMillis) {
    getNetworkPolicyManager()
        .setSubscriptionPlans(
            subId,
            (SubscriptionPlan[]) plans.toArray(new SubscriptionPlan[0]),
            expirationDurationMillis,
            this.mContext.getOpPackageName());
  }

  public void setSubscriptionOverrideUnmetered(
      int subId, boolean overrideUnmetered, long expirationDurationMillis) {
    setSubscriptionOverrideUnmetered(
        subId, overrideUnmetered, TelephonyManager.getAllNetworkTypes(), expirationDurationMillis);
  }

  public void setSubscriptionOverrideUnmetered(int i, boolean z, int[] iArr, long j) {
    getNetworkPolicyManager()
        .setSubscriptionOverride(i, 1, z ? 1 : 0, iArr, j, this.mContext.getOpPackageName());
  }

  public void setSubscriptionOverrideCongested(
      int subId, boolean overrideCongested, long expirationDurationMillis) {
    setSubscriptionOverrideCongested(
        subId, overrideCongested, TelephonyManager.getAllNetworkTypes(), expirationDurationMillis);
  }

  public void setSubscriptionOverrideCongested(
      int subId, boolean overrideCongested, int[] networkTypes, long expirationDurationMillis) {
  ...
  public void setPreferredDataSubscriptionId(
    ...
    try {
      ...
      ISetOpportunisticDataCallback callbackStub = new BinderC31641(executor, callback);
  ...
  class BinderC31641 extends ISetOpportunisticDataCallback.Stub {
    final /* synthetic */ Consumer val$callback;
    final /* synthetic */ Executor val$executor;

    BinderC31641(Executor executor, Consumer consumer) {
    ...
    public void onComplete(final int result) {
      ...
      try {
        ...
        executor.execute(
            new Runnable() { // from class:
                             // android.telephony.SubscriptionManager$1$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
    ...
    return setSubscriptionPropertyHelper(
            ...
            new CallISubMethodHelper() { // from class:
              ...
              public final int callMethod(ISub iSub) {
                ...
                lambda$setOpportunistic$6 =
                    SubscriptionManager.this.lambda$setOpportunistic$6(opportunistic, subId, iSub);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ int lambda$setOpportunistic$6(boolean opportunistic, int subId, ISub iSub)
  ...
  public boolean lambda$getActiveSubscriptionInfoList$1(SubscriptionInfo info) {
    ...
    return TelephonyManager.from(this.mContext).hasCarrierPrivileges(info.getSubscriptionId())
      ...
      if (info.getGroupUuid() == null || !info.isOpportunistic()) {
        ...
        if (groupUuid == null) {
          selectableList.add(info);
            ...
            || (groupMap.get(groupUuid).getSimSlotIndex() == -1 && info.getSimSlotIndex() != -1)) {
  ...
  public void setDeviceToDeviceStatusSharingPreference(
      final int subscriptionId, final int sharing) {
    setSubscriptionPropertyHelper(
        subscriptionId,
        "setDeviceToDeviceSharingStatus",
        new CallISubMethodHelper() { // from class:
                                     // android.telephony.SubscriptionManager$$ExternalSyntheticLambda19
          @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
          public final int callMethod(ISub iSub) {
            int deviceToDeviceStatusSharing;
            deviceToDeviceStatusSharing =
                iSub.setDeviceToDeviceStatusSharing(sharing, subscriptionId);
  ...
  public void setDeviceToDeviceStatusSharingContacts(
      final int subscriptionId, final List<Uri> contacts) {
          ...
          public final int callMethod(ISub iSub) {
            ...
            deviceToDeviceStatusSharingContacts =
                iSub.setDeviceToDeviceStatusSharingContacts(
                    SubscriptionManager.serializeUriLists(contacts), subscriptionId);
  ...
  public List<Uri> getDeviceToDeviceStatusSharingContacts(int subscriptionId) {
    String result =
        getStringSubscriptionProperty(this.mContext, subscriptionId, "d2d_sharing_contacts");
    if (result != null) {
      try {
  ...
  private int setSubscriptionPropertyHelper(
      int subId, String methodName, CallISubMethodHelper helper) {
    if (!isValidSubscriptionId(subId)) {
    ...
    Bundle bundle =
        this.mContext
            ...
            .call(
                ...
                GET_SIM_SPECIFIC_SETTINGS_METHOD_NAME,
                (String) null,
                (Bundle) null);
  ...
  public String getPhoneNumber(int subscriptionId) {
    ...
    try {
      ISub iSub = TelephonyManager.getSubscriptionService();
      if (iSub != null) {
        return iSub.getPhoneNumberFromFirstAvailableSource(
            subscriptionId, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
      }
      throw new IllegalStateException("subscription service unavailable.");
    } catch (RemoteException ex) {
      throw ex.rethrowAsRuntimeException();
  ...
  void setUsageSetting(final int subscriptionId, final int usageSetting) {
    setSubscriptionPropertyHelper(
        ...
        "setUsageSetting",
        new CallISubMethodHelper() { // from class:
                                     // android.telephony.SubscriptionManager$$ExternalSyntheticLambda2
          @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
          public final int callMethod(ISub iSub) {
            int lambda$setUsageSetting$12;
            lambda$setUsageSetting$12 =
                SubscriptionManager.this.lambda$setUsageSetting$12(
                    usageSetting, subscriptionId, iSub);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ int lambda$setUsageSetting$12(
  ...
  public void setSubscriptionUserHandle(int subscriptionId, UserHandle userHandle) {
    if (!isValidSubscriptionId(subscriptionId)) {
      throw new IllegalArgumentException(
          "[setSubscriptionUserHandle]: Invalid subscriptionId: " + subscriptionId);
    }
    try {
      ISub iSub = TelephonyManager.getSubscriptionService();
      if (iSub != null) {
      ...
      throw new IllegalStateException(
          "[setSubscriptionUserHandle]: subscription service unavailable");
    } catch (RemoteException ex) {
      ex.rethrowAsRuntimeException();
    }
  }
  ...
  public UserHandle getSubscriptionUserHandle(int subscriptionId) {
    if (!isValidSubscriptionId(subscriptionId)) {
      throw new IllegalArgumentException(
          "[getSubscriptionUserHandle]: Invalid subscriptionId: " + subscriptionId);
    }
    try {
      ISub iSub = TelephonyManager.getSubscriptionService();
      if (iSub != null) {
      ...
      Log.m96e(LOG_TAG, "[getSubscriptionUserHandle]: subscription service unavailable");
      return null;
    } catch (RemoteException ex) {
      ex.rethrowAsRuntimeException();
      return null;
  ...
  public boolean isSubscriptionAssociatedWithUser(int subscriptionId, UserHandle userHandle) {
    if (!isValidSubscriptionId(subscriptionId)) {
      throw new IllegalArgumentException(
          "[isSubscriptionAssociatedWithUser]: Invalid subscriptionId: " + subscriptionId);
    }
    try {
      ISub iSub = TelephonyManager.getSubscriptionService();
      if (iSub != null) {
      ...
      Log.m96e(LOG_TAG, "[isSubscriptionAssociatedWithUser]: subscription service unavailable");
      return false;
    } catch (RemoteException ex) {
      ex.rethrowAsRuntimeException();
      return false;
  ...
  public List<SubscriptionInfo> getSubscriptionInfoListAssociatedWithUser(UserHandle userHandle) {
    ...
    Log.m96e(
        LOG_TAG, "[getSubscriptionInfoListAssociatedWithUser]: subscription service unavailable");
    return new ArrayList();
  }
  ...
  public void createDummySubscription(String iccId) {
    try {
      ...
      if (iSub != null) {
        ...
        Log.m96e(LOG_TAG, "[createDummySubscription]: subscription service unavailable");
      }
    } catch (RemoteException ex) {
      ex.rethrowAsRuntimeException();
    }
