...
public class SubscriptionManager {
    ...
    @SystemApi public static final int TRANSFER_STATUS_CONVERTED = 2;

    @SystemApi public static final int TRANSFER_STATUS_NONE = 0;

    @SystemApi public static final int TRANSFER_STATUS_TRANSFERRED_OUT = 1;
                    ...
                    new FunctionalUtils
                        ...
                        public final Object applyOrThrow(Object obj, Object obj2) {
                            return Integer.valueOf(
                                    ((ISub) obj)
                                            .getDefaultSubIdAsUser(((Integer) obj2).intValue()));
                        }
                    },
            ...
            new IntegerPropertyInvalidatedCache<>(
                    new FunctionalUtils
                        ...
                        public final Object applyOrThrow(Object obj, Object obj2) {
                            return Integer.valueOf(
                                    ((ISub) obj)
                                            .getDefaultSmsSubIdAsUser(((Integer) obj2).intValue()));
                        }
                    },
                    CACHE_KEY_SUBSCRIPTION_MANAGER_SERVICE_PROPERTY,
                    -1);
    ...
    private static IntegerPropertyInvalidatedCache<Integer> sGetSlotIndexCache =
            new IntegerPropertyInvalidatedCache<>(
                    new FunctionalUtils
                        ...
                        public final Object applyOrThrow(Object obj, Object obj2) {
                            return Integer.valueOf(
                                    ((ISub) obj).getSlotIndex(((Integer) obj2).intValue()));
                        }
                    },
                    CACHE_KEY_SUBSCRIPTION_MANAGER_SERVICE_PROPERTY,
                    -1);
    private static IntegerPropertyInvalidatedCache<Integer> sGetSubIdCache =
            new IntegerPropertyInvalidatedCache<>(
                    new FunctionalUtils
                        ...
                        public final Object applyOrThrow(Object obj, Object obj2) {
                            return Integer.valueOf(
                                    ((ISub) obj).getSubId(((Integer) obj2).intValue()));
                        }
                    },
                    CACHE_KEY_SUBSCRIPTION_MANAGER_SERVICE_PROPERTY,
                    -1);
    private static IntegerPropertyInvalidatedCache<Integer> sGetPhoneIdCache =
            new IntegerPropertyInvalidatedCache<>(
                    new FunctionalUtils
                        ...
                        public final Object applyOrThrow(Object obj, Object obj2) {
                            return Integer.valueOf(
                                    ((ISub) obj).getPhoneId(((Integer) obj2).intValue()));
                        }
                    },
                    CACHE_KEY_SUBSCRIPTION_MANAGER_SERVICE_PROPERTY,
                    -1);
    ...
    public static final Uri ADVANCED_CALLING_ENABLED_CONTENT_URI =
            Uri.withAppendedPath(CONTENT_URI, "advanced_calling");
    ...
    public static final Uri WFC_ROAMING_MODE_CONTENT_URI =
            Uri.withAppendedPath(CONTENT_URI, "wfc_roaming_mode");

    @SystemApi
    public static final Uri VT_ENABLED_CONTENT_URI =
            Uri.withAppendedPath(CONTENT_URI, "vt_enabled");
    ...
    public static final Uri SIM_INFO_BACKUP_AND_RESTORE_CONTENT_URI =
            Uri.withAppendedPath(CONTENT_URI, "backup_and_restore");
    public static final Uri SIM_INFO_SUW_RESTORE_CONTENT_URI =
            Uri.withAppendedPath(SIM_INFO_BACKUP_AND_RESTORE_CONTENT_URI, "suw_restore");

    @SystemApi
    public static final Uri CROSS_SIM_ENABLED_CONTENT_URI =
            Uri.withAppendedPath(CONTENT_URI, "cross_sim_calling_enabled");
    ...
    private static class VoidPropertyInvalidatedCache<T> extends PropertyInvalidatedCache<Void, T> {
        ...
        public T recompute(Void query) {
            try {
                return this.mInterfaceMethod.applyOrThrow(
                        TelephonyManager.getSubscriptionService());
            } catch (Exception re) {
    ...
    private NetworkPolicyManager getNetworkPolicyManager() {
        return (NetworkPolicyManager)
                this.mContext.getSystemService(Context.NETWORK_POLICY_SERVICE);
    }
        ...
        if (telephonyRegistryManager != null) {
            ...
            loge(
                    "addOnSubscriptionsChangedListener: pkgname="
                            + pkgName
                            + " failed to be added  due to TELEPHONY_REGISTRY_SERVICE being"
                            + " unavailable.");
            executor.execute(
                            ...
                            .filter(
                                    new Predicate() { // from class:
                                        ...
                                        public final boolean test(Object obj) {
                                            ...
                                            lambda$getActiveSubscriptionInfoList$2 =
                                                    SubscriptionManager.this
                                                            .lambda$getActiveSubscriptionInfoList$2(
                                                                    (SubscriptionInfo) obj);
        ...
        return setSubscriptionPropertyHelper(
                ...
                new CallISubMethodHelper() { // from class:
                    ...
                    public final int callMethod(ISub iSub) {
                        ...
                        displayNameUsingSrc =
                                iSub.setDisplayNameUsingSrc(displayName, subId, nameSource);
    ...
    public static int getDefaultSubscriptionId() {
        return sGetDefaultSubIdCacheAsUser
                .query(Integer.valueOf(Process.myUserHandle().getIdentifier()))
                .intValue();
    }
    ...
    public static int getDefaultSmsSubscriptionId() {
        return sGetDefaultSmsSubIdCacheAsUser
                .query(Integer.valueOf(Process.myUserHandle().getIdentifier()))
                .intValue();
    }
    ...
    public static void setSubscriptionProperty(
            int subscriptionId, String columnName, String value) {
        try {
            ISub iSub = TelephonyManager.getSubscriptionService();
            if (iSub != null) {
    ...
    public static Resources getResourcesForSubId(
            Context context, int subId, boolean useRootLocale) {
        ...
        if (isValidSubscriptionId(subId)) {
            ...
            Pair<String, Configuration> cacheKey2 =
                    Pair.create(context.getPackageName() + ", subid=" + subId, configurationKey);
    ...
    public List<SubscriptionPlan> getSubscriptionPlans(int subId) {
        SubscriptionPlan[] subscriptionPlans =
                getNetworkPolicyManager()
                        .getSubscriptionPlans(subId, this.mContext.getOpPackageName());
        return subscriptionPlans == null
                ? Collections.emptyList()
                : Arrays.asList(subscriptionPlans);
    }
    ...
    public void setSubscriptionOverrideUnmetered(int i, boolean z, int[] iArr, long j) {
        getNetworkPolicyManager()
                .setSubscriptionOverride(
                        i, 1, z ? 1 : 0, iArr, j, this.mContext.getOpPackageName());
    }
    ...
    public List<SubscriptionInfo> getOpportunisticSubscriptions() {
        ...
        String contextAttributionTag =
                this.mContext != null ? this.mContext.getAttributionTag() : null;
        ...
        return setSubscriptionPropertyHelper(
                        ...
                        new CallISubMethodHelper() { // from class:
                            ...
                            public final int callMethod(ISub iSub) {
                                ...
                                lambda$setOpportunistic$7 =
                                        SubscriptionManager.this.lambda$setOpportunistic$7(
                                                opportunistic, subId, iSub);
    ...
    public void addSubscriptionsIntoGroup(List<Integer> subIdList, ParcelUuid groupUuid) {
        ...
        int[] subIdArray =
                subIdList.stream()
                        .mapToInt(
                                new ToIntFunction() { // from class:
                                                      // android.telephony.SubscriptionManager$$ExternalSyntheticLambda20
                                    @Override // java.util.function.ToIntFunction
                                    public final int applyAsInt(Object obj) {
                                        int intValue;
                                        intValue = ((Integer) obj).intValue();
    ...
    public void removeSubscriptionsFromGroup(List<Integer> subIdList, ParcelUuid groupUuid) {
        ...
        String callingPackage =
                this.mContext != null ? this.mContext.getOpPackageName() : "<unknown>";
        int[] subIdArray =
                subIdList.stream()
                        .mapToInt(
                                new ToIntFunction() { // from class:
            ...
            if (info.getGroupUuid() == null || !info.isOpportunistic()) {
                ...
                if (groupUuid == null) {
                    selectableList.add(info);
                        ...
                        || (groupMap.get(groupUuid).getSimSlotIndex() == -1
    ...
    public int getDeviceToDeviceStatusSharingPreference(int subscriptionId) {
        return getIntegerSubscriptionProperty(
                subscriptionId, "d2d_sharing_status", 0, this.mContext);
    }
                    ...
                    public final int callMethod(ISub iSub) {
                        ...
                        deviceToDeviceStatusSharingContacts =
                                iSub.setDeviceToDeviceStatusSharingContacts(
                                        SubscriptionManager.serializeUriLists(contacts),
                                        subscriptionId);
    ...
    public List<Uri> getDeviceToDeviceStatusSharingContacts(int subscriptionId) {
        String result =
                getStringSubscriptionProperty(
                        this.mContext, subscriptionId, "d2d_sharing_contacts");
        if (result != null) {
            try {
        ...
        setSubscriptionPropertyHelper(
                ...
                new CallISubMethodHelper() { // from class:
                    ...
                    public final int callMethod(ISub iSub) {
                        ...
                        lambda$setUsageSetting$13 =
                                SubscriptionManager.this.lambda$setUsageSetting$13(
    ...
    public boolean isSubscriptionAssociatedWithUser(int subscriptionId, UserHandle userHandle) {
        if (!isValidSubscriptionId(subscriptionId)) {
            throw new IllegalArgumentException(
                    "[isSubscriptionAssociatedWithUser]: Invalid subscriptionId: "
                            + subscriptionId);
        }
        try {
            ISub iSub = TelephonyManager.getSubscriptionService();
    ...
    public boolean isSubscriptionAssociatedWithUser(int subscriptionId) {
        if (!isValidSubscriptionId(subscriptionId)) {
            throw new IllegalArgumentException(
                    "[isSubscriptionAssociatedWithCallingUser]: Invalid subscriptionId: "
                            + subscriptionId);
        }
        try {
            ISub iSub = TelephonyManager.getSubscriptionService();
    ...
    public List<SubscriptionInfo> getSubscriptionInfoListAssociatedWithUser(UserHandle userHandle) {
        ...
        Log.e(
                LOG_TAG,
                "[getSubscriptionInfoListAssociatedWithUser]: subscription service unavailable");
        return new ArrayList();
    }

    public static int getAllServiceCapabilityBitmasks() {
        return SERVICE_CAPABILITY_VOICE_BITMASK
