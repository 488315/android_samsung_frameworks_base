...
public class SubscriptionManager {
    ...
    private static class VoidPropertyInvalidatedCache<T> extends PropertyInvalidatedCache<Void, T> {
        ...
        public T query(Void r5) {
            ...
            try {
                ...
                com.android.telephony.Rlog.m246w(SubscriptionManager.LOG_TAG, "Failed to recompute cache key for " + this.mCacheKeyProperty);
                return t;
            }
        }
    }
    ...
    public static class OnSubscriptionsChangedListener {
        ...
        public void onAddListenerFailed() {
            com.android.telephony.Rlog.m246w(SubscriptionManager.LOG_TAG, "onAddListenerFailed not overridden");
        }
    ...
    public List<SubscriptionInfo> getSubscriptionInfoListAssociatedWithUser(UserHandle userHandle) {
        ...
        Log.m96e(LOG_TAG, "[getSubscriptionInfoListAssociatedWithUser]: subscription service unavailable");
        return new ArrayList();
    }
