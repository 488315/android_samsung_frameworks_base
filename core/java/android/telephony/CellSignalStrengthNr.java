...
public final class CellSignalStrengthNr extends CellSignalStrength implements Parcelable {
  ...
  public static final Parcelable.Creator<CellSignalStrengthNr> CREATOR =
      new Parcelable.Creator<
          CellSignalStrengthNr>() { // from class: android.telephony.CellSignalStrengthNr.1
            ...
            csiCqiReport.stream()
                .map(
                    new Function() { // from class:
                                     // android.telephony.CellSignalStrengthNr$$ExternalSyntheticLambda0
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        Integer valueOf;
                        valueOf =
                            Integer.valueOf(
                                CellSignalStrengthNr.inRangeOrUnavailable(
                                    Byte.toUnsignedInt(((Byte) obj).byteValue()), 0, 15));
                        return valueOf;
                      }
                    })
  ...
  public void updateLevel(PersistableBundle cc, ServiceState ss) {
    if (cc != null) {
      this.mParametersUseForLevel =
          cc.getInt(CarrierConfigManager.KEY_PARAMETERS_USE_FOR_5G_NR_SIGNAL_BAR_INT, 1);
      this.mSsRsrpThresholds =
          cc.getIntArray(CarrierConfigManager.KEY_5G_NR_SSRSRP_THRESHOLDS_INT_ARRAY);
      this.mSsRsrqThresholds =
          cc.getIntArray(CarrierConfigManager.KEY_5G_NR_SSRSRQ_THRESHOLDS_INT_ARRAY);
      this.mSsSinrThresholds =
          cc.getIntArray(CarrierConfigManager.KEY_5G_NR_SSSINR_THRESHOLDS_INT_ARRAY);
    } else {
      this.mParametersUseForLevel = 1;
    }
  ...
  public int hashCode() {
    return Objects.hash(
        Integer.valueOf(this.mCsiRsrp),
        Integer.valueOf(this.mCsiRsrq),
        Integer.valueOf(this.mCsiSinr),
        Integer.valueOf(this.mCsiCqiTableIndex),
        this.mCsiCqiReport,
  ...
  public boolean equals(Object obj) {
    ...
    return this.mCsiRsrp == o.mCsiRsrp
        && this.mCsiRsrq == o.mCsiRsrq
        && this.mCsiSinr == o.mCsiSinr
        && this.mCsiCqiTableIndex == o.mCsiCqiTableIndex
        && this.mCsiCqiReport.equals(o.mCsiCqiReport)
        && this.mSsRsrp == o.mSsRsrp
        && this.mSsRsrq == o.mSsRsrq
        && this.mSsSinr == o.mSsSinr
        && this.mLevel == o.mLevel
        && this.mTimingAdvance == o.mTimingAdvance;
  }

  public String toString() {
    return "CellSignalStrengthNr:{"
        + (" csiRsrp = " + this.mCsiRsrp)
        + (" csiRsrq = " + this.mCsiRsrq)
        + (" csiCqiTableIndex = " + this.mCsiCqiTableIndex)
        + (" csiCqiReport = " + this.mCsiCqiReport)
        + (" ssRsrp = " + this.mSsRsrp)
        + (" ssRsrq = " + this.mSsRsrq)
        + (" ssSinr = " + this.mSsSinr)
        + (" level = " + this.mLevel)
        + (" parametersUseForLevel = " + this.mParametersUseForLevel)
