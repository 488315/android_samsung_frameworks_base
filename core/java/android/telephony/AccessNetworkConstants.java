...
import android.p009os.health.UidHealthStats;
...
public final class AccessNetworkConstants {
  ...
  enum UtranBandArfcnFrequency {
    ...
    UTRAN_ARFCN_FREQUENCY_BAND_A(
        101, 0, UidHealthStats.MEASUREMENT_MOBILE_RX_PACKETS, 10121, 0, 9504, 9596),
  ...
  enum EutranBandArfcnFrequency {
    ...
    EUTRAN_ARFCN_FREQUENCY_BAND_4(
        4, 2110000, SettingsEnums.SETTINGS_LANGUAGES_CATEGORY, 2399, 1710000, 19950, 20399),
    ...
    EUTRAN_ARFCN_FREQUENCY_BAND_7(
        7,
        2620000,
        SmartFaceManager.SMART_STAY_DELAY,
        Convert.BitRate.VIDEO_D1_BITRATE,
        2500000,
        20750,
        21449),
    ...
    EUTRAN_ARFCN_FREQUENCY_BAND_23(
        23, 2180000, 7500, 7699, WindowManagerPolicyConstants.WINDOW_FREEZE_LAYER, 25500, 25699),
