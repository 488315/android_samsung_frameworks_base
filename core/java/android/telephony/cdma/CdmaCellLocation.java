...
public class CdmaCellLocation extends CellLocation {
  ...
  public boolean equals(Object o) {
    try {
      ...
      return o != null
          ...
          && equalsHandlesNulls(
              Integer.valueOf(this.mBaseStationLatitude), Integer.valueOf(s.mBaseStationLatitude))
          && equalsHandlesNulls(
              Integer.valueOf(this.mBaseStationLongitude), Integer.valueOf(s.mBaseStationLongitude))
  ...
  public String toString() {
    ...
    return NavigationBarInflaterView.SIZE_MOD_START
        ...
        + ","
        + Rlog.pii(TelephonyUtils.IS_DEBUGGABLE, Integer.valueOf(this.mBaseStationLongitude))
        + ","
        + this.mSystemId
        + ","
        + this.mNetworkId
