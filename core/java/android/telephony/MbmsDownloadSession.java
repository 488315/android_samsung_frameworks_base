    ...
    private int bindAndInitialize() {
        ServiceConnection serviceConnection = new ServiceConnection() { // from class: android.telephony.MbmsDownloadSession.3
            ...
            public void onServiceDisconnected(ComponentName name) {
                Log.m102w(MbmsDownloadSession.LOG_TAG, "bindAndInitialize: Remote service disconnected");
                MbmsDownloadSession.sIsInitialized.set(false);
            ...
            public void onNullBinding(ComponentName name) {
                Log.m102w(MbmsDownloadSession.LOG_TAG, "bindAndInitialize: Remote service returned null");
