...
public class SignalStrength implements Parcelable {
  public static final Parcelable.Creator<SignalStrength> CREATOR =
      new Parcelable.Creator<SignalStrength>() { // from class: android.telephony.SignalStrength.1
            ...
            : this.mLte.isValid()
                ...
                : this.mCdma.isValid()
                    ...
                    : this.mTdscdma.isValid()
                        ...
                        : this.mWcdma.isValid()
                            ? this.mWcdma
                            : this.mGsm.isValid() ? this.mGsm : this.mLte;
  }
  ...
  public SignalStrength(Parcel in) {
    ...
    this.mCdma =
        (CellSignalStrengthCdma)
            in.readParcelable(
                CellSignalStrengthCdma.class.getClassLoader(), CellSignalStrengthCdma.class);
    this.mGsm =
        (CellSignalStrengthGsm)
            in.readParcelable(
                CellSignalStrengthGsm.class.getClassLoader(), CellSignalStrengthGsm.class);
    this.mWcdma =
        (CellSignalStrengthWcdma)
            in.readParcelable(
                CellSignalStrengthWcdma.class.getClassLoader(), CellSignalStrengthWcdma.class);
    this.mTdscdma =
        (CellSignalStrengthTdscdma)
            in.readParcelable(
                CellSignalStrengthTdscdma.class.getClassLoader(), CellSignalStrengthTdscdma.class);
    this.mLte =
        (CellSignalStrengthLte)
            in.readParcelable(
                CellSignalStrengthLte.class.getClassLoader(), CellSignalStrengthLte.class);
    this.mNr =
        (CellSignalStrengthNr)
            in.readParcelable(
                CellSignalStrengthLte.class.getClassLoader(), CellSignalStrengthNr.class);
  ...
  public String toString() {
    ...
    StringBuilder append2 =
        append
            .append(
                (cellSignalStrengthCdma == null || !cellSignalStrengthCdma.isValid())
                    ? "Invalid"
                    : this.mCdma)
            .append(",mGsm=");
    ...
    StringBuilder append3 =
        append2
            .append(
                (cellSignalStrengthGsm == null || !cellSignalStrengthGsm.isValid())
                    ? "Invalid"
                    : this.mGsm)
            .append(",mWcdma=");
    ...
    StringBuilder append4 =
        append3
            .append(
                (cellSignalStrengthWcdma == null || !cellSignalStrengthWcdma.isValid())
                    ? "Invalid"
                    : this.mWcdma)
            .append(",mTdscdma=");
    ...
    StringBuilder append5 =
        append4
            .append(
                (cellSignalStrengthTdscdma == null || !cellSignalStrengthTdscdma.isValid())
                    ? "Invalid"
                    : this.mTdscdma)
            .append(",mLte=");
    ...
    StringBuilder append6 =
        append5
            .append(
                (cellSignalStrengthLte == null || !cellSignalStrengthLte.isValid())
                    ? "Invalid"
                    : this.mLte)
            .append(",mNr=");
  ...
  private void setFromNotifierBundle(Bundle m) {
    ...
    this.mTdscdma =
        (CellSignalStrengthTdscdma) m.getParcelable("Tdscdma", CellSignalStrengthTdscdma.class);
  ...
  private static void log(String s) {
    com.android.telephony.Rlog.m246w(LOG_TAG, s);
  }

  private static void loge(String s) {
    com.android.telephony.Rlog.m240e(LOG_TAG, s);
  }
  ...
  public void updateLevel(
      PersistableBundle cc, ServiceState ss, String networkTypeCapability, boolean isOn1xCall) {
    updateLevel(cc, ss);
