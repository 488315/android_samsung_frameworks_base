...
public class CarrierConfigManager {
    ...
    public static final String f506x12969fb = "always_show_primary_signal_bar_in_opportunistic_network_boolean";
    ...
    public static final String f507x6ee79b57 = "display_voicemail_number_as_default_call_forwarding_number";
    ...
    public static final String f508x8c1f92dc = "opportunistic_time_to_scan_after_capability_switch_to_primary_long";
    ...
    public static final String f509x619559f = "premium_capability_notification_backoff_hysteresis_time_millis_long";
    ...
    public static final String f510xb56f17b1 = "premium_capability_purchase_condition_backoff_hysteresis_time_millis_long";
    ...
    public static final class ImsEmergency {
        ...
        public static final String f511x581c7bc0 = "imsemergency.emergency_over_cs_roaming_supported_access_network_types_int_array";
        ...
        public static final String f512x1b863f8b = "imsemergency.emergency_over_ims_roaming_supported_3gpp_network_types_int_array";
    ...
    public PersistableBundle getConfigForSubId(int subId) {
        ...
        try {
            ...
            if (loader == null) {
                com.android.telephony.Rlog.m246w(TAG, "Error getting config for subId " + subId + " ICarrierConfigLoader is null");
                return null;
            }
    ...
    public void overrideConfig(int subscriptionId, PersistableBundle overrideValues, boolean persistent) {
        try {
            ICarrierConfigLoader loader = getICarrierConfigLoader();
            if (loader == null) {
                com.android.telephony.Rlog.m246w(TAG, "Error setting config for subId " + subscriptionId + " ICarrierConfigLoader is null");
            } else {
                loader.overrideConfig(subscriptionId, overrideValues, persistent);
            }
        } catch (RemoteException ex) {
            com.android.telephony.Rlog.m240e(TAG, "Error setting config for subId " + subscriptionId + ": " + ex);
        }
    }
    ...
    public void notifyConfigChangedForSubId(int subId) {
        try {
            ICarrierConfigLoader loader = getICarrierConfigLoader();
            if (loader == null) {
                com.android.telephony.Rlog.m246w(TAG, "Error reloading config for subId=" + subId + " ICarrierConfigLoader is null");
            } else {
                loader.notifyConfigChangedForSubId(subId);
            }
        } catch (RemoteException ex) {
            com.android.telephony.Rlog.m240e(TAG, "Error reloading config for subId=" + subId + ": " + ex);
        }
    }
    ...
    public void updateConfigForPhoneId(int phoneId, String simState) {
        try {
            ICarrierConfigLoader loader = getICarrierConfigLoader();
            if (loader == null) {
                com.android.telephony.Rlog.m246w(TAG, "Error updating config for phoneId=" + phoneId + " ICarrierConfigLoader is null");
            } else {
                loader.updateConfigForPhoneId(phoneId, simState);
            }
        } catch (RemoteException ex) {
            com.android.telephony.Rlog.m240e(TAG, "Error updating config for phoneId=" + phoneId + ": " + ex);
        }
    }
    ...
    public String getDefaultCarrierServicePackageName() {
        try {
            ICarrierConfigLoader loader = getICarrierConfigLoader();
            if (loader == null) {
                com.android.telephony.Rlog.m246w(TAG, "getDefaultCarrierServicePackageName ICarrierConfigLoader is null");
                return "";
            }
            return loader.getDefaultCarrierServicePackageName();
        } catch (RemoteException ex) {
            com.android.telephony.Rlog.m240e(TAG, "getDefaultCarrierServicePackageName ICarrierConfigLoader is null" + ex);
            ex.rethrowAsRuntimeException();
            return "";
        }
    }
