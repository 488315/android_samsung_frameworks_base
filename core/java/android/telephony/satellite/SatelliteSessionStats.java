...
public class SatelliteSessionStats implements Parcelable {
    public static final Parcelable.Creator<SatelliteSessionStats> CREATOR =
    ...
    public String toString() {
        return "countOfSuccessfulUserMessages:"
                + this.mCountOfSuccessfulUserMessages
                + ",countOfUnsuccessfulUserMessages:"
                + this.mCountOfUnsuccessfulUserMessages
                + ",countOfTimedOutUserMessagesWaitingForConnection:"
                + this.mCountOfTimedOutUserMessagesWaitingForConnection
                + ",countOfTimedOutUserMessagesWaitingForAck:"
                + this.mCountOfTimedOutUserMessagesWaitingForAck
                + ",countOfUserMessagesInQueueToBeSent:"
    ...
    public boolean equals(Object o) {
        ...
        if (this.mCountOfSuccessfulUserMessages == that.mCountOfSuccessfulUserMessages
                && this.mCountOfUnsuccessfulUserMessages == that.mCountOfUnsuccessfulUserMessages
                && this.mCountOfTimedOutUserMessagesWaitingForConnection
    ...
    public int hashCode() {
        return Objects.hash(
                Integer.valueOf(this.mCountOfSuccessfulUserMessages),
                Integer.valueOf(this.mCountOfUnsuccessfulUserMessages),
                Integer.valueOf(this.mCountOfTimedOutUserMessagesWaitingForConnection),
                Integer.valueOf(this.mCountOfTimedOutUserMessagesWaitingForAck),
