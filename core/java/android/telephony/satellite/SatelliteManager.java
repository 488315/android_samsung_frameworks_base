...
public class SatelliteManager {
    ...
    public void startTransmissionUpdates(Executor executor, Consumer<Integer> resultListener, SatelliteTransmissionUpdateCallback callback) {
        ...
        try {
            ...
            if (telephony != null) {
                ...
                ISatelliteTransmissionUpdateCallback internalCallback = new BinderC35227(executor, callback);
    ...
    class BinderC35227 extends ISatelliteTransmissionUpdateCallback.Stub {
        ...
        BinderC35227(Executor executor, SatelliteTransmissionUpdateCallback satelliteTransmissionUpdateCallback) {
            this.val$executor = executor;
    ...
    class BinderC350711 extends ISatelliteProvisionStateCallback.Stub {
        ...
        BinderC350711(Executor executor, SatelliteProvisionStateCallback satelliteProvisionStateCallback) {
            this.val$executor = executor;
