...
public final class TelephonyScanManager {
  ...
  public TelephonyScanManager() {
    ...
    this.mDeathRecipient =
        new IBinder.DeathRecipient() { // from class: android.telephony.TelephonyScanManager.2
        ...
        case 4:
          try {
            ...
            com.android.telephony.Rlog.m241e(
                TelephonyScanManager.TAG, "Exception in networkscan callback onResults", e3);
            return;
          }
        case 2:
          try {
            ...
            com.android.telephony.Rlog.m241e(
                TelephonyScanManager.TAG, "Exception in networkscan callback onError", e4);
            return;
          }
        case 3:
          try {
            executor.execute(
                new Runnable() { // from class:
                  ...
                  @Override // java.lang.Runnable
                  public final void run() {
                    TelephonyScanManager.HandlerC32721.lambda$handleMessage$3(
            ...
            com.android.telephony.Rlog.m241e(
                TelephonyScanManager.TAG, "Exception in networkscan callback onComplete", e5);
            return;
          }
        default:
          com.android.telephony.Rlog.m240e(
              TelephonyScanManager.TAG, "Unhandled message " + Integer.toHexString(message.what));
          return;
      }
    }
