...
public final class TelephonyScanManager {
    ...
    public TelephonyScanManager() {
        ...
        this.mLooper = looper;
        HandlerC32721 handlerC32721 = new HandlerC32721(looper);
        this.mHandler = handlerC32721;
        this.mMessenger = new Messenger(handlerC32721);
    ...
    class HandlerC32721 extends Handler {
        HandlerC32721(Looper looper) {
            super(looper);
        }
        ...
        public void handleMessage(Message message) {
            ...
            if (nsi == null) {
                com.android.telephony.Rlog.m240e(TelephonyScanManager.TAG, "Unexpceted message " + message.what + " as there is no NetworkScanInfo with id " + message.arg2);
                return;
            }
                ...
                case 4:
                    try {
                        ...
                        executor.execute(new Runnable() { // from class: android.telephony.TelephonyScanManager$1$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                TelephonyScanManager.HandlerC32721.lambda$handleMessage$1(ci, callback);
                            }
                        });
                        return;
                    } catch (Exception e3) {
                        com.android.telephony.Rlog.m241e(TelephonyScanManager.TAG, "Exception in networkscan callback onResults", e3);
                        return;
                    }
                case 2:
                    try {
                        ...
                        executor.execute(new Runnable() { // from class: android.telephony.TelephonyScanManager$1$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                TelephonyScanManager.HandlerC32721.lambda$handleMessage$2(errorCode, callback);
                            }
                        });
                        synchronized (TelephonyScanManager.this.mScanInfo) {
                        ...
                        com.android.telephony.Rlog.m241e(TelephonyScanManager.TAG, "Exception in networkscan callback onError", e4);
                        return;
                    }
                case 3:
                    try {
                        executor.execute(new Runnable() { // from class: android.telephony.TelephonyScanManager$1$$ExternalSyntheticLambda3
                            @Override // java.lang.Runnable
                            public final void run() {
                                TelephonyScanManager.HandlerC32721.lambda$handleMessage$3(TelephonyScanManager.NetworkScanCallback.this);
                            }
                        });
                        synchronized (TelephonyScanManager.this.mScanInfo) {
                            TelephonyScanManager.this.mScanInfo.remove(message.arg2);
                        ...
                        com.android.telephony.Rlog.m241e(TelephonyScanManager.TAG, "Exception in networkscan callback onComplete", e5);
                        return;
                    }
                default:
                    com.android.telephony.Rlog.m240e(TelephonyScanManager.TAG, "Unhandled message " + Integer.toHexString(message.what));
                    return;
            }
        }

        static /* synthetic */ void lambda$handleMessage$1(CellInfo[] ci, NetworkScanCallback callback) {
            com.android.telephony.Rlog.m238d(TelephonyScanManager.TAG, "onResults: " + Arrays.toString(ci));
        ...
        static /* synthetic */ void lambda$handleMessage$2(int errorCode, NetworkScanCallback callback) {
            com.android.telephony.Rlog.m238d(TelephonyScanManager.TAG, "onError: " + errorCode);
            callback.onError(errorCode);
        }

        static /* synthetic */ void lambda$handleMessage$3(NetworkScanCallback callback) {
            com.android.telephony.Rlog.m238d(TelephonyScanManager.TAG, "onComplete");
            callback.onComplete();
        }
    }
            ...
            try {
                synchronized (this.mScanInfo) {
                    try {
                        ...
                        com.android.telephony.Rlog.m240e(TAG, "Failed to initiate network scan");
                        return null;
                    } catch (Throwable th) {
                        th = th;
                        try {
                            ...
                            ex = e;
                            com.android.telephony.Rlog.m241e(TAG, "requestNetworkScan RemoteException", ex);
                            return null;
                        } catch (NullPointerException e2) {
                            ex = e2;
                            com.android.telephony.Rlog.m241e(TAG, "requestNetworkScan NPE", ex);
                            return null;
                        }
                    }
                }
