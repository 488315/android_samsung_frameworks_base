...
public final class CellSignalStrengthLte extends CellSignalStrength implements Parcelable {
  ...
  public static final Parcelable.Creator<CellSignalStrengthLte> CREATOR =
      new Parcelable.Creator<
          CellSignalStrengthLte>() { // from class: android.telephony.CellSignalStrengthLte.1
    ...
    if (cc == null) {
      ...
      if (ss != null && ss.isUsingNonTerrestrialNetwork()) {
        this.mParametersUseForLevel =
            cc.getInt(CarrierConfigManager.KEY_PARAMETERS_USED_FOR_NTN_LTE_SIGNAL_BAR_INT);
      ...
      rsrpOnly =
          cc.getBoolean(CarrierConfigManager.KEY_USE_ONLY_RSRP_FOR_LTE_SIGNAL_BAR_BOOL, false);
    }
    int rsrpBoost = 0;
    if (ss != null) {
