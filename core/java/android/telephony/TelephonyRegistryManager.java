...
public class TelephonyRegistryManager {
    ...
    class BinderC32691 extends IOnSubscriptionsChangedListener.Stub {
        ...
        BinderC32691(Executor executor, SubscriptionManager.OnSubscriptionsChangedListener onSubscriptionsChangedListener) {
    ...
    class BinderC32702 extends IOnSubscriptionsChangedListener.Stub {
        ...
        BinderC32702(Executor executor, SubscriptionManager.OnOpportunisticSubscriptionsChangedListener onOpportunisticSubscriptionsChangedListener) {
            this.val$executor = executor;
        ...
        public void onSubscriptionsChanged() {
            long identity = Binder.clearCallingIdentity();
            try {
                Log.m94d(TelephonyRegistryManager.TAG, "onOpportunisticSubscriptionsChanged callback received.");
                Executor executor = this.val$executor;
    ...
    static class CarrierPrivilegesCallbackWrapper extends ICarrierPrivilegesCallback.Stub implements ListenerExecutor {
        ...
        public /* synthetic */ void lambda$onCarrierPrivilegesChanged$1(final Set privilegedPkgNamesSet, final Set privilegedUidsSet) throws Exception {
            ...
            executeSafely(executor, new C3265x8726eb0(weakReference), new ListenerExecutor.ListenerOperation() { // from class: android.telephony.TelephonyRegistryManager$CarrierPrivilegesCallbackWrapper$$ExternalSyntheticLambda3
        ...
        public /* synthetic */ void lambda$onCarrierServiceChanged$3(final String packageName, final int uid) throws Exception {
            ...
            WeakReference<TelephonyManager.CarrierPrivilegesCallback> weakReference = this.mCallback;
            Objects.requireNonNull(weakReference);
            executeSafely(executor, new C3265x8726eb0(weakReference), new ListenerExecutor.ListenerOperation() { // from class: android.telephony.TelephonyRegistryManager$CarrierPrivilegesCallbackWrapper$$ExternalSyntheticLambda2
                @Override // com.android.internal.listeners.ListenerExecutor.ListenerOperation
                public final void operate(Object obj) {
    ...
    class BinderC32713 extends ICarrierConfigChangeListener.Stub {
        ...
        BinderC32713(Executor executor, CarrierConfigManager.CarrierConfigChangeListener carrierConfigChangeListener) {
            this.val$executor = executor;
        ...
        public void onCarrierConfigChanged(final int slotIndex, final int subId, final int carrierId, final int specificCarrierId) {
            Log.m94d(TelephonyRegistryManager.TAG, "onCarrierConfigChanged call in ICarrierConfigChangeListener callback");
