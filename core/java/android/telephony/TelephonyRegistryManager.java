...
public class TelephonyRegistryManager {
  ...
  private final ConcurrentHashMap<
          SubscriptionManager.OnSubscriptionsChangedListener, IOnSubscriptionsChangedListener>
  ...
  public void addOnSubscriptionsChangedListener(
    ...
    if (this.mSubscriptionChangedListenerMap.get(listener) != null) {
      Log.m94d(TAG, "addOnSubscriptionsChangedListener listener already present");
      return;
    }
    IOnSubscriptionsChangedListener callback = new BinderC32691(executor, listener);
  ...
  class BinderC32691 extends IOnSubscriptionsChangedListener.Stub {
    ...
    public void onSubscriptionsChanged() {
      ...
      try {
        ...
        final SubscriptionManager.OnSubscriptionsChangedListener onSubscriptionsChangedListener =
            this.val$listener;
        executor.execute(
  ...
  public void removeOnSubscriptionsChangedListener(
    ...
    try {
      sRegistry.removeOnSubscriptionsChangedListener(
          this.mContext.getOpPackageName(), this.mSubscriptionChangedListenerMap.get(listener));
  ...
  public void addOnOpportunisticSubscriptionsChangedListener(
      SubscriptionManager.OnOpportunisticSubscriptionsChangedListener listener, Executor executor) {
    if (this.mOpportunisticSubscriptionChangedListenerMap.get(listener) != null) {
      Log.m94d(TAG, "addOnOpportunisticSubscriptionsChangedListener listener already present");
      return;
    }
    IOnSubscriptionsChangedListener callback = new BinderC32702(executor, listener);
  ...
  class BinderC32702 extends IOnSubscriptionsChangedListener.Stub {
    final /* synthetic */ Executor val$executor;
    ...
    public void onSubscriptionsChanged() {
      ...
      try {
        Log.m94d(
            TelephonyRegistryManager.TAG, "onOpportunisticSubscriptionsChanged callback received.");
        Executor executor = this.val$executor;
  ...
  public void notifyRegistrationFailed(
    ...
    try {
      sRegistry.notifyRegistrationFailed(
          slotIndex, subId, cellIdentity, chosenPlmn, domain, causeCode, additionalCauseCode);
    } catch (RemoteException ex) {
      throw ex.rethrowFromSystemServer();
    }
  }
  ...
  static class CarrierPrivilegesCallbackWrapper extends ICarrierPrivilegesCallback.Stub
          ...
          new FunctionalUtils
            ...
            public final void runOrThrow() {
              TelephonyRegistryManager.CarrierPrivilegesCallbackWrapper.this
                  .lambda$onCarrierPrivilegesChanged$1(privilegedPkgNamesSet, privilegedUidsSet);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onCarrierPrivilegesChanged$1(
      ...
      executeSafely(
          executor,
          new C3265x8726eb0(weakReference),
          new ListenerExecutor
            ...
            public final void operate(Object obj) {
              ((TelephonyManager.CarrierPrivilegesCallback) obj)
                  .onCarrierPrivilegesChanged(privilegedPkgNamesSet, privilegedUidsSet);
            }
          });
    }
  ...
  public void addCarrierPrivilegesCallback(
    ...
    WeakHashMap<
            TelephonyManager.CarrierPrivilegesCallback,
            WeakReference<CarrierPrivilegesCallbackWrapper>>
        weakHashMap = sCarrierPrivilegeCallbacks;
    synchronized (weakHashMap) {
      WeakReference<CarrierPrivilegesCallbackWrapper> existing = weakHashMap.get(callback);
      if (existing != null && existing.get() != null) {
        Log.m94d(TAG, "addCarrierPrivilegesCallback: callback already registered");
        return;
      }
  ...
  public void notifyCarrierPrivilegesChanged(
    ...
    try {
      ...
      int[] uids =
          privilegedUids.stream().mapToInt(new AudioPort$$ExternalSyntheticLambda0()).toArray();
  ...
  public void addCarrierConfigChangedListener(
    ...
    if (this.mCarrierConfigChangeListenerMap.get(listener) != null) {
      Log.m96e(TAG, "registerCarrierConfigChangeListener: listener already present");
      return;
    }
    ICarrierConfigChangeListener callback = new BinderC32713(executor, listener);
    try {
  ...
  class BinderC32713 extends ICarrierConfigChangeListener.Stub {
    final /* synthetic */ Executor val$executor;
    ...
    public void onCarrierConfigChanged(
        final int slotIndex, final int subId, final int carrierId, final int specificCarrierId) {
      Log.m94d(
      ...
      try {
        ...
        executor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                CarrierConfigManager.CarrierConfigChangeListener.this.onCarrierConfigChanged(
  ...
  public void removeCarrierConfigChangedListener(
    ...
    Objects.requireNonNull(listener, "Listener should be non-null.");
    if (this.mCarrierConfigChangeListenerMap.get(listener) == null) {
      Log.m96e(TAG, "removeCarrierConfigChangedListener: listener was not present");
      return;
    }
    try {
      sRegistry.removeCarrierConfigChangeListener(
          this.mCarrierConfigChangeListenerMap.get(listener), this.mContext.getOpPackageName());
  ...
  public void notifyCarrierConfigChanged(
    ...
    if (!SubscriptionManager.isValidPhoneId(slotIndex)) {
      Log.m96e(TAG, "notifyCarrierConfigChanged, ignored: invalid slotIndex " + slotIndex);
      return;
    }
    try {
  ...
  public void notifyCallBackModeStarted(int phoneId, int subId, int type) {
    try {
      Log.m94d(TAG, "notifyCallBackModeStarted:type=" + type);
  ...
  public void notifyCallbackModeStopped(int phoneId, int subId, int type, int reason) {
    try {
      Log.m94d(TAG, "notifyCallbackModeStopped:type=" + type + ", reason=" + reason);
