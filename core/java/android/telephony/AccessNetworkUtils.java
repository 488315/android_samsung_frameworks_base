    ...
    public static int getFrequencyFromEarfcn(int band, int earfcn, boolean isUplink) {
        ...
        while (true) {
            ...
            if (band != earfcnFrequency.band) {
                ...
                Rlog.m85w(TAG, "Band and the range of EARFCN are not consistent: band = " + band + " ,earfcn = " + earfcn + " ,isUplink = " + isUplink);
                return -1;
            }
        }
    }
    ...
    public static int getFrequencyFromUarfcn(int band, int uarfcn, boolean isUplink) {
        ...
        while (true) {
            ...
            if (band != uarfcnFrequency.band) {
                ...
                Rlog.m85w(TAG, "Band and the range of UARFCN are not consistent: band = " + band + " ,uarfcn = " + uarfcn + " ,isUplink = " + isUplink);
                return -1;
            }
        }
    ...
    public static int getFrequencyFromArfcn(int band, int arfcn, boolean isUplink) {
        ...
        while (true) {
            ...
            if (band != arfcnFrequency.band) {
                ...
                Rlog.m85w(TAG, "Band and the range of ARFCN are not consistent: band = " + band + " ,arfcn = " + arfcn + " ,isUplink = " + isUplink);
                return -1;
            }
        }
