...
public class PhoneStateListener {
  ...
  @Deprecated public static final int LISTEN_ACTIVE_DATA_SUBSCRIPTION_ID_CHANGE = 4194304;

  @Deprecated public static final int LISTEN_BARRING_INFO = Integer.MIN_VALUE;

  @SystemApi @Deprecated public static final int LISTEN_CALL_ATTRIBUTES_CHANGED = 67108864;

  @Deprecated public static final int LISTEN_CALL_DISCONNECT_CAUSES = 33554432;

  @Deprecated public static final int LISTEN_CALL_FORWARDING_INDICATOR = 8;

  @Deprecated public static final int LISTEN_CALL_STATE = 32;

  @Deprecated public static final int LISTEN_CARRIER_NETWORK_CHANGE = 65536;

  @Deprecated public static final int LISTEN_CELL_INFO = 1024;

  @Deprecated public static final int LISTEN_CELL_LOCATION = 16;

  @Deprecated public static final int LISTEN_DATA_ACTIVATION_STATE = 262144;

  @Deprecated public static final int LISTEN_DATA_ACTIVITY = 128;

  @Deprecated public static final int LISTEN_DATA_CONNECTION_REAL_TIME_INFO = 8192;

  @Deprecated public static final int LISTEN_DATA_CONNECTION_STATE = 64;

  @Deprecated public static final int LISTEN_DISPLAY_INFO_CHANGED = 1048576;

  @Deprecated public static final int LISTEN_EMERGENCY_NUMBER_LIST = 16777216;

  @Deprecated public static final int LISTEN_IMS_CALL_DISCONNECT_CAUSES = 134217728;

  @Deprecated public static final int LISTEN_MESSAGE_WAITING_INDICATOR = 4;
  public static final int LISTEN_NONE = 0;

  @Deprecated public static final int LISTEN_OEM_HOOK_RAW_EVENT = 32768;

  @SystemApi @Deprecated public static final int LISTEN_OUTGOING_EMERGENCY_CALL = 268435456;

  @SystemApi @Deprecated public static final int LISTEN_OUTGOING_EMERGENCY_SMS = 536870912;

  @Deprecated public static final int LISTEN_PHONE_CAPABILITY_CHANGE = 2097152;

  @SystemApi @Deprecated public static final int LISTEN_PRECISE_CALL_STATE = 2048;

  @Deprecated public static final int LISTEN_PRECISE_DATA_CONNECTION_STATE = 4096;

  @SystemApi @Deprecated public static final int LISTEN_RADIO_POWER_STATE_CHANGED = 8388608;

  @Deprecated public static final int LISTEN_REGISTRATION_FAILURE = 1073741824;

  @Deprecated public static final int LISTEN_SERVICE_STATE = 1;

  @Deprecated public static final int LISTEN_SIGNAL_STRENGTH = 2;

  @Deprecated public static final int LISTEN_SIGNAL_STRENGTHS = 256;

  @SystemApi @Deprecated public static final int LISTEN_SRVCC_STATE_CHANGED = 16384;

  @Deprecated public static final int LISTEN_USER_MOBILE_DATA_STATE = 524288;

  @SystemApi @Deprecated public static final int LISTEN_VOICE_ACTIVATION_STATE = 131072;
  ...
  public PhoneStateListener(Integer subId) {
    ...
    if (subId != null && VMRuntime.getRuntime().getTargetSdkVersion() >= 29) {
      throw new IllegalArgumentException(
          "PhoneStateListener with subId: " + subId + " is not supported, use default constructor");
    }
  }
  ...
  static class IPhoneStateListenerStub extends IPhoneStateListener.Stub {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onServiceStateChanged$1(
                  psl, serviceState);
            }
          });
    }
    ...
    public void onSignalStrengthChanged(final int asu) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda48
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onSignalStrengthChanged$3(
                  psl, asu);
            }
          });
    }
    ...
    public void onMessageWaitingIndicatorChanged(final boolean mwi) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda25
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onMessageWaitingIndicatorChanged$5(psl, mwi);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onMessageWaitingIndicatorChanged$5(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda30
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onCallForwardingIndicatorChanged(final boolean cfi) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda45
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onCallForwardingIndicatorChanged$7(psl, cfi);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onCallForwardingIndicatorChanged$7(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda35
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onCellLocationChanged(CellIdentity cellIdentity) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda17
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onCellLocationChanged$9(
                  psl, location);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onCellLocationChanged$9(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onLegacyCallStateChanged(final int state, final String incomingNumber) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onLegacyCallStateChanged$11(
                  psl, state, incomingNumber);
            }
          });
    }
      ...
      if (state == 4 && VMRuntime.getRuntime().getTargetSdkVersion() < 30) {
        Binder.withCleanCallingIdentity(
            new FunctionalUtils
              ...
              public final void runOrThrow() {
                PhoneStateListener.IPhoneStateListenerStub.this
                    .lambda$onDataConnectionStateChanged$13(psl, networkType);
              }
            });
      } else {
        Binder.withCleanCallingIdentity(
            new FunctionalUtils
              ...
              public final void runOrThrow() {
                PhoneStateListener.IPhoneStateListenerStub.this
                    .lambda$onDataConnectionStateChanged$15(psl, state, networkType);
              }
            });
      }
    }
    ...
    public /* synthetic */ void lambda$onDataConnectionStateChanged$13(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              PhoneStateListener.IPhoneStateListenerStub.lambda$onDataConnectionStateChanged$12(
                  PhoneStateListener.this, networkType);
            }
          });
    }

    static /* synthetic */ void lambda$onDataConnectionStateChanged$12(
        PhoneStateListener psl, int networkType) {
    ...
    public /* synthetic */ void lambda$onDataConnectionStateChanged$15(
        final PhoneStateListener psl, final int state, final int networkType) throws Exception {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda56
            @Override // java.lang.Runnable
            public final void run() {
              PhoneStateListener.IPhoneStateListenerStub.lambda$onDataConnectionStateChanged$14(
                  PhoneStateListener.this, state, networkType);
            }
          });
    }

    static /* synthetic */ void lambda$onDataConnectionStateChanged$14(
        PhoneStateListener psl, int state, int networkType) {
    ...
    public void onDataActivity(final int direction) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onDataActivity$17(
                  psl, direction);
            }
          });
    }
    ...
    public void onSignalStrengthsChanged(final SignalStrength signalStrength) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onSignalStrengthsChanged$19(
                  psl, signalStrength);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onSignalStrengthsChanged$19(
        final PhoneStateListener psl, final SignalStrength signalStrength) throws Exception {
      this.mExecutor.execute(
          new Runnable() { // from class:
    ...
    public void onCellInfoChanged(final List<CellInfo> cellInfo) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda43
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onCellInfoChanged$21(
                  psl, cellInfo);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onCellInfoChanged$21(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda57
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onPreciseCallStateChanged(final PreciseCallState callState) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda36
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onPreciseCallStateChanged$23(
                  psl, callState);
            }
          });
    }
    ...
    public void onCallDisconnectCauseChanged(
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda29
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onCallDisconnectCauseChanged$25(
                      psl, disconnectCause, preciseDisconnectCause);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onCallDisconnectCauseChanged$25(
        final PhoneStateListener psl, final int disconnectCause, final int preciseDisconnectCause)
        throws Exception {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda44
            @Override // java.lang.Runnable
            public final void run() {
              PhoneStateListener.this.onCallDisconnectCauseChanged(
    ...
    public void onPreciseDataConnectionStateChanged(
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onPreciseDataConnectionStateChanged$27(psl, dataConnectionState);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onPreciseDataConnectionStateChanged$27(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda33
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onDataConnectionRealTimeInfoChanged(final DataConnectionRealTimeInfo dcRtInfo) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda5
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onDataConnectionRealTimeInfoChanged$29(psl, dcRtInfo);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onDataConnectionRealTimeInfoChanged$29(
        final PhoneStateListener psl, final DataConnectionRealTimeInfo dcRtInfo) throws Exception {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda54
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onSrvccStateChanged(final int state) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda16
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onSrvccStateChanged$31(
                  psl, state);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onSrvccStateChanged$31(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda61
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onVoiceActivationStateChanged(final int activationState) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda60
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onVoiceActivationStateChanged$33(psl, activationState);
            }
          });
    }
    ...
    public void onDataActivationStateChanged(final int activationState) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda18
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onDataActivationStateChanged$35(psl, activationState);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onDataActivationStateChanged$35(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onUserMobileDataStateChanged(final boolean enabled) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda7
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onUserMobileDataStateChanged$37(psl, enabled);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onUserMobileDataStateChanged$37(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onDisplayInfoChanged(final TelephonyDisplayInfo telephonyDisplayInfo) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda23
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onDisplayInfoChanged$39(
                  psl, telephonyDisplayInfo);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onDisplayInfoChanged$39(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda31
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onOemHookRawEvent(final byte[] rawData) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onOemHookRawEvent$41(
                  psl, rawData);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onOemHookRawEvent$41(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onCarrierNetworkChange(final boolean active) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda50
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onCarrierNetworkChange$43(
                  psl, active);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onCarrierNetworkChange$43(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda58
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onEmergencyNumberListChanged(final Map emergencyNumberList) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onEmergencyNumberListChanged$45(psl, emergencyNumberList);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onEmergencyNumberListChanged$45(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda26
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onOutgoingEmergencyCall(
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onOutgoingEmergencyCall$47(
                  psl, placedEmergencyNumber, subscriptionId);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onOutgoingEmergencyCall$47(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              PhoneStateListener.this.onOutgoingEmergencyCall(
    ...
    public void onOutgoingEmergencySms(
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda46
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onOutgoingEmergencySms$49(
                  psl, sentEmergencyNumber, subscriptionId);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onOutgoingEmergencySms$49(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda59
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onPhoneCapabilityChanged(final PhoneCapability capability) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda63
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onPhoneCapabilityChanged$51(
                  psl, capability);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onPhoneCapabilityChanged$51(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onRadioPowerStateChanged(final int state) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onRadioPowerStateChanged$53(
                  psl, state);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onRadioPowerStateChanged$53(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda40
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onCallStatesChanged(List<CallState> callStateList) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda21
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onCallStatesChanged$55(
                  psl, ca);
            }
          });
    }
    ...
    public void onActiveDataSubIdChanged(final int subId) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onActiveDataSubIdChanged$57(
                  psl, subId);
            }
          });
    }
    ...
    public void onImsCallDisconnectCauseChanged(final ImsReasonInfo disconnectCause) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda49
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this
                  .lambda$onImsCallDisconnectCauseChanged$59(psl, disconnectCause);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onImsCallDisconnectCauseChanged$59(
        final PhoneStateListener psl, final ImsReasonInfo disconnectCause) throws Exception {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onRegistrationFailed(
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onRegistrationFailed$61(
                  psl, cellIdentity, chosenPlmn, domain, causeCode, additionalCauseCode);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onRegistrationFailed$61(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              PhoneStateListener.this.onRegistrationFailed(
    ...
    public void onBarringInfoChanged(final BarringInfo barringInfo) {
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
              .ThrowingRunnable() { // from class:
                                    // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda37
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              PhoneStateListener.IPhoneStateListenerStub.this.lambda$onBarringInfoChanged$63(
                  psl, barringInfo);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onBarringInfoChanged$63(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.telephony.PhoneStateListener$IPhoneStateListenerStub$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
