    ...
    public void onRequestNetworkRegistrationInfoComplete(int result, NetworkRegistrationInfo state) {
        ...
        if (iNetworkServiceCallback != null) {
            try {
                ...
                com.android.telephony.Rlog.m240e(mTag, "Failed to onRequestNetworkRegistrationInfoComplete on the remote");
                return;
            }
        }
        com.android.telephony.Rlog.m240e(mTag, "onRequestNetworkRegistrationInfoComplete callback is null.");
    }
}
