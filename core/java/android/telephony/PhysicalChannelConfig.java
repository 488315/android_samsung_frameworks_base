...
public final class PhysicalChannelConfig implements Parcelable {
  ...
  public static final Parcelable.Creator<PhysicalChannelConfig> CREATOR =
      new Parcelable.Creator<
          PhysicalChannelConfig>() { // from class: android.telephony.PhysicalChannelConfig.1
    ...
    switch (this.mNetworkType) {
      ...
      case 16:
        this.mUplinkFrequency =
            AccessNetworkUtils.getFrequencyFromArfcn(this.mBand, this.mUplinkChannelNumber, true);
        break;
      case 3:
      case 8:
      case 9:
      ...
      case 17:
        this.mUplinkFrequency =
            AccessNetworkUtils.getFrequencyFromUarfcn(this.mBand, this.mUplinkChannelNumber, true);
        break;
      case 13:
        this.mUplinkFrequency =
            AccessNetworkUtils.getFrequencyFromEarfcn(this.mBand, this.mUplinkChannelNumber, true);
        break;
      case 20:
        this.mUplinkFrequency =
    ...
    public Builder setCellBandwidthDownlinkKhz(int cellBandwidthDownlinkKhz) {
      if (cellBandwidthDownlinkKhz < 0) {
        throw new IllegalArgumentException(
            "Cell downlink bandwidth(kHz) " + cellBandwidthDownlinkKhz + " is invalid.");
      }
