...
public class NetworkScan {
    ...
    public void stopScan() {
        ...
        if (telephony == null) {
            com.android.telephony.Rlog.m240e(TAG, "Failed to get the ITelephony instance.");
        }
        try {
            telephony.stopNetworkScan(this.mSubId, this.mScanId);
        } catch (RemoteException ex) {
            com.android.telephony.Rlog.m241e(TAG, "stopNetworkScan  RemoteException", ex);
        } catch (IllegalArgumentException e) {
            com.android.telephony.Rlog.m238d(TAG, "stopNetworkScan - no active scan for ScanID=" + this.mScanId);
        } catch (RuntimeException ex2) {
            com.android.telephony.Rlog.m241e(TAG, "stopNetworkScan  RuntimeException", ex2);
        }
    }
