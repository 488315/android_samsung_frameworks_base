...
public final class ExtendedRegistrationInfo implements Parcelable {
  ...
  public String toString() {
    return "ExtendedRegistrationInfo{ snapshotStatus="
        ...
        + NetworkRegistrationInfo.registrationStateToString(this.mUnprocessedDataRegState)
        + " unprocessedDataRat="
        + this.mUnprocessedDataRadioTechnology
        + " mobileOptionalRat="
        + this.mMobileOptionalRadioTech
        + " unprocessedVoiceRegState="
        + NetworkRegistrationInfo.registrationStateToString(this.mUnprocessedVoiceRegState)
        + " isPsOnlyReg="
        + this.mIsPsOnlyReg
        + "}";
  }
