...
public class ModemInfo implements Parcelable {
  ...
  public String toString() {
    return "modemId="
        ...
        + " isDataSupported:"
        + this.isDataSupported;
  }

  public int hashCode() {
    return Objects.hash(
        Integer.valueOf(this.modemId),
        Integer.valueOf(this.rat),
        Boolean.valueOf(this.isVoiceSupported),
        Boolean.valueOf(this.isDataSupported));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (this.modemId != s.modemId
        || this.rat != s.rat
        || this.isVoiceSupported != s.isVoiceSupported
        || this.isDataSupported != s.isDataSupported) {
      return false;
    }
    return true;
  }
