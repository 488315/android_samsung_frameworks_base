...
public final class PrintDocumentInfo implements Parcelable {
  ...
  public static final Parcelable.Creator<PrintDocumentInfo> CREATOR =
      new Parcelable.Creator<PrintDocumentInfo>() { // from class: android.print.PrintDocumentInfo.1
    ...
    public Builder setPageCount(int pageCount) {
      if (pageCount < 0 && pageCount != -1) {
        throw new IllegalArgumentException(
            "pageCount must be greater than or equal to zero or DocumentInfo#PAGE_COUNT_UNKNOWN");
      }
