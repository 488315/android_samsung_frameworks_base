...
public final class PrintJobInfo implements Parcelable {
  ...
  public String toString() {
    ...
    builder.append(
        append.append(printAttributes != null ? printAttributes.toString() : null).toString());
    StringBuilder append2 = new StringBuilder().append(", documentInfo: ");
    PrintDocumentInfo printDocumentInfo = this.mDocumentInfo;
    builder.append(
        append2.append(printDocumentInfo != null ? printDocumentInfo.toString() : null).toString());
    ...
    builder.append(
        append3.append(pageRangeArr != null ? Arrays.toString(pageRangeArr) : null).toString());
    ...
    builder.append(
        append4.append(charSequence != null ? charSequence.toString() : null).toString());
    ...
    builder.append(
        append5.append(charSequence2 != null ? charSequence2.toString() : null).toString());
    builder.append("}");
