...
public final class PrinterInfo implements Parcelable {
  ...
  private PrinterInfo(Parcel parcel) {
    ...
    this.mCapabilities =
        (PrinterCapabilitiesInfo) parcel.readParcelable(null, PrinterCapabilitiesInfo.class);
  ...
  public int hashCode() {
    int hashCode =
        ((((((1 * 31) + this.mId.hashCode()) * 31) + this.mName.hashCode()) * 31) + this.mStatus)
            * 31;
    ...
    int hashCode3 =
        (((((((hashCode2
                                        + (printerCapabilitiesInfo != null
                                            ? printerCapabilitiesInfo.hashCode()
                                            : 0))
                                    * 31)
  ...
  public boolean equalsIgnoringStatus(PrinterInfo other) {
    ...
    return pendingIntent == null
        ...
        : pendingIntent.equals(other.mInfoIntent);
  }
