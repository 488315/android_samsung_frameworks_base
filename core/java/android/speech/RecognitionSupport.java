...
public final class RecognitionSupport implements Parcelable {
  ...
  RecognitionSupport(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) installedOnDeviceLanguages);
    this.mPendingOnDeviceLanguages = pendingOnDeviceLanguages;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) pendingOnDeviceLanguages);
    this.mSupportedOnDeviceLanguages = supportedOnDeviceLanguages;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) supportedOnDeviceLanguages);
    this.mOnlineLanguages = onlineLanguages;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) onlineLanguages);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(this.mInstalledOnDeviceLanguages, that.mInstalledOnDeviceLanguages)
        ...
        && Objects.equals(this.mSupportedOnDeviceLanguages, that.mSupportedOnDeviceLanguages)
