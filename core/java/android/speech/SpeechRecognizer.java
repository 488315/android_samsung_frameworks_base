...
public class SpeechRecognizer {
          ...
          public void handleMessage(Message msg) {
            switch (msg.what) {
              ...
              case 6:
                ...
                SpeechRecognizer.this.handleCheckRecognitionSupport(
              ...
              case 7:
                ...
                SpeechRecognizer.this.handleTriggerModelDownload(
  ...
  public static boolean isOnDeviceRecognitionAvailable(Context context) {
    ComponentName componentName =
        ComponentName.unflattenFromString(
            context.getString(C4337R.string.config_defaultOnDeviceSpeechRecognitionService));
  ...
  public void triggerModelDownload(Intent intent) {
    ...
    putMessage(
        Message.obtain(
            this.mHandler, 7, new ModelDownloadListenerArgs(intent, null, 0 == true ? 1 : 0)));
  }
  ...
  public void triggerModelDownload(
    ...
    putMessage(
        Message.obtain(
            this.mHandler, 7, new ModelDownloadListenerArgs(recognizerIntent, executor, listener)));
  }
  ...
  public void handleStartListening(Intent recognizerIntent) {
    ...
    try {
      ...
      Log.m97e(TAG, "startListening() failed", e);
  ...
  public void handleStopMessage() {
    ...
    try {
      ...
      Log.m97e(TAG, "stopListening() failed", e);
      this.mListener.onError(5);
    }
  }
  ...
  public void handleCheckRecognitionSupport(
    ...
    try {
      ...
      Log.m97e(TAG, "checkRecognitionSupport() failed", e);
      callbackExecutor.execute(
          new Runnable() { // from class: android.speech.SpeechRecognizer$$ExternalSyntheticLambda1
  ...
  public void handleTriggerModelDownload(
    ...
    if (modelDownloadListener == null) {
      try {
        ...
        Log.m97e(TAG, "triggerModelDownload() without a listener failed", e);
        this.mListener.onError(5);
        return;
      }
    }
    try {
      ...
      Log.m97e(TAG, "triggerModelDownload() with a listener failed", e2);
      callbackExecutor.execute(
          new Runnable() { // from class: android.speech.SpeechRecognizer$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
  ...
  private boolean checkOpenConnection() {
    ...
    this.mListener.onError(5);
    Log.m96e(TAG, "not connected to the recognition service");
    return false;
  }
    ...
    try {
      this.mManagerService.createSession(
          ...
          new IRecognitionServiceManagerCallback
              .Stub() { // from class: android.speech.SpeechRecognizer.2
            ...
            public void onSuccess(IRecognitionService service) throws RemoteException {
              ...
              while (!SpeechRecognizer.this.mPendingTasks.isEmpty()) {
                SpeechRecognizer.this.mHandler.sendMessage(
                    (Message) SpeechRecognizer.this.mPendingTasks.poll());
              }
            }
            ...
            public void onError(int errorCode) throws RemoteException {
              Log.m96e(
                  SpeechRecognizer.TAG,
                  "Bind to system recognition service failed with error " + errorCode);
  ...
  private ComponentName getSpeechRecognizerComponentName() {
    ...
    String serviceComponent =
        Settings.Secure.getString(
            this.mContext.getContentResolver(), Settings.Secure.VOICE_RECOGNITION_SERVICE);
    if (TextUtils.isEmpty(serviceComponent)) {
      Log.m96e(TAG, "no selected voice recognition service");
      this.mListener.onError(5);
      return null;
    }
            ...
            public void handleMessage(Message msg) {
              ...
              switch (msg.what) {
                case 1:
                  ...
                  break;
                case 2:
                  InternalRecognitionListener.this.mInternalListener.onBufferReceived(
                      (byte[]) msg.obj);
                  break;
                case 3:
                ...
                case 4:
                  ...
                  break;
                case 5:
                  InternalRecognitionListener.this.mInternalListener.onReadyForSpeech(
                      (Bundle) msg.obj);
                  break;
                case 6:
                  ...
                  break;
                case 7:
                  InternalRecognitionListener.this.mInternalListener.onPartialResults(
                      (Bundle) msg.obj);
                  break;
                case 8:
                ...
                case 9:
                  ...
                  break;
                case 10:
                  InternalRecognitionListener.this.mInternalListener.onSegmentResults(
                      (Bundle) msg.obj);
                  break;
                case 11:
                  ...
                  break;
                case 12:
                  InternalRecognitionListener.this.mInternalListener.onLanguageDetection(
                      (Bundle) msg.obj);
                  break;
              }
            }
  ...
  static class InternalSupportCallback extends IRecognitionSupportCallback.Stub {
    ...
    public void onSupportResult(final RecognitionSupport recognitionSupport)
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.speech.SpeechRecognizer$InternalSupportCallback$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              SpeechRecognizer.InternalSupportCallback.this.lambda$onSupportResult$0(
                  recognitionSupport);
            }
          });
    }
    ...
    public void onError(final int errorCode) throws RemoteException {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.speech.SpeechRecognizer$InternalSupportCallback$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
  ...
  static class InternalModelDownloadListener extends IModelDownloadListener.Stub {
    ...
    public void onProgress(final int completedPercent) throws RemoteException {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.speech.SpeechRecognizer$InternalModelDownloadListener$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              SpeechRecognizer.InternalModelDownloadListener.this.lambda$onProgress$0(
                  completedPercent);
            }
          });
    }
    ...
    public void onSuccess() throws RemoteException {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.speech.SpeechRecognizer$InternalModelDownloadListener$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onScheduled() throws RemoteException {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.speech.SpeechRecognizer$InternalModelDownloadListener$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onError(final int error) throws RemoteException {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // android.speech.SpeechRecognizer$InternalModelDownloadListener$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
