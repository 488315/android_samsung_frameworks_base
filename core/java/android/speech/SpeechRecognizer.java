...
public class SpeechRecognizer {
    ...
    public static boolean isOnDeviceRecognitionAvailable(Context context) {
        ComponentName componentName = ComponentName.unflattenFromString(context.getString(C4337R.string.config_defaultOnDeviceSpeechRecognitionService));
        ...
        try {
            this.mManagerService.createSession(componentName, this.mClientToken, z, new IRecognitionServiceManagerCallback.Stub() { // from class: android.speech.SpeechRecognizer.2
                ...
                public void onError(int errorCode) throws RemoteException {
                    Log.m96e(SpeechRecognizer.TAG, "Bind to system recognition service failed with error " + errorCode);
