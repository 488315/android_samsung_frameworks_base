...
class AudioPlaybackQueueItem extends PlaybackQueueItem {
  ...
  public void run() {
    ...
    try {
      create.setOnErrorListener(
          new MediaPlayer
              .OnErrorListener() { // from class: android.speech.tts.AudioPlaybackQueueItem.1
            @Override // android.media.MediaPlayer.OnErrorListener
            public boolean onError(MediaPlayer mp, int what, int extra) {
              Log.m102w(AudioPlaybackQueueItem.TAG, "Audio playback error: " + what + ", " + extra);
      ...
      this.mPlayer.setOnCompletionListener(
          new MediaPlayer
              .OnCompletionListener() { // from class: android.speech.tts.AudioPlaybackQueueItem.2
