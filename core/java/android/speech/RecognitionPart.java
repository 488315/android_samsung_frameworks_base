...
public final class RecognitionPart implements Parcelable {
  ...
  public static final Parcelable.Creator<RecognitionPart> CREATOR =
      new Parcelable.Creator<RecognitionPart>() { // from class: android.speech.RecognitionPart.1
  ...
  RecognitionPart(String rawText, String formattedText, long timestampMillis, int confidenceLevel) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) rawText);
    ...
    if (confidenceLevel != 0
      ...
      throw new IllegalArgumentException(
          "confidenceLevel was "
              + confidenceLevel
              + " but must be one of: CONFIDENCE_LEVEL_UNKNOWN(0), CONFIDENCE_LEVEL_LOW(1),"
              + " CONFIDENCE_LEVEL_MEDIUM_LOW(2), CONFIDENCE_LEVEL_MEDIUM(3),"
              + " CONFIDENCE_LEVEL_MEDIUM_HIGH(4), CONFIDENCE_LEVEL_HIGH(5"
  ...
  public static final class Builder extends BaseBuilder {
    ...
    public RecognitionPart build() {
      ...
      RecognitionPart o =
          new RecognitionPart(
              this.mRawText, this.mFormattedText, this.mTimestampMillis, this.mConfidenceLevel);
      return o;
    }
