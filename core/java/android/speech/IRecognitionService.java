...
public interface IRecognitionService extends IInterface {
  ...
  void startListening(
      Intent intent, IRecognitionListener iRecognitionListener, AttributionSource attributionSource)
      throws RemoteException;
  ...
  public static class Default implements IRecognitionService {
    ...
    public void startListening(
        Intent recognizerIntent, IRecognitionListener listener, AttributionSource attributionSource)
        throws RemoteException {}
