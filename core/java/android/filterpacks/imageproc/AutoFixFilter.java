...
public class AutoFixFilter extends Filter {
  private static final int[] normal_cdf = {
    ...
    422,
    422,
    C4337R.styleable.Theme_zzz_DeviceDefaultPointerStyle,
    C4337R.styleable.Theme_zzz_DeviceDefaultPointerStyle,
    C4337R.styleable.Theme_zzz_DeviceDefaultPointerStyle,
    C4337R.styleable.Theme_zzz_DeviceDefaultPointerStyle,
    424,
    ...
    426,
    426,
    FrameworkStatsLog.DROPBOX_ENTRY_DROPPED,
    FrameworkStatsLog.DROPBOX_ENTRY_DROPPED,
    FrameworkStatsLog.DROPBOX_ENTRY_DROPPED,
    FrameworkStatsLog.DROPBOX_ENTRY_DROPPED,
    428,
    ...
    FrameworkStatsLog.HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED,
    FrameworkStatsLog.HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED,
    FrameworkStatsLog.HOTWORD_DETECTOR_EVENTS,
    FrameworkStatsLog.HOTWORD_DETECTOR_EVENTS,
    FrameworkStatsLog.HOTWORD_DETECTOR_EVENTS,
    435,
    435,
    ...
    445,
    445,
    FrameworkStatsLog.GNSS_PSDS_DOWNLOAD_REPORTED,
    FrameworkStatsLog.GNSS_PSDS_DOWNLOAD_REPORTED,
    FrameworkStatsLog.GNSS_PSDS_DOWNLOAD_REPORTED,
    FrameworkStatsLog.GNSS_PSDS_DOWNLOAD_REPORTED,
    447,
    ...
    448,
    448,
    FrameworkStatsLog.DREAM_UI_EVENT_REPORTED,
    FrameworkStatsLog.DREAM_UI_EVENT_REPORTED,
    FrameworkStatsLog.DREAM_UI_EVENT_REPORTED,
    FrameworkStatsLog.DREAM_UI_EVENT_REPORTED,
    FrameworkStatsLog.DREAM_UI_EVENT_REPORTED,
    ...
    MetricsProto.MetricsEvent.ACTION_HIDE_APP_DISAMBIG_NONE_FEATURED,
    MetricsProto.MetricsEvent.ACTION_HIDE_APP_DISAMBIG_NONE_FEATURED,
    MetricsProto.MetricsEvent.ACTION_APP_DISAMBIG_ALWAYS,
    MetricsProto.MetricsEvent.ACTION_APP_DISAMBIG_ALWAYS,
    MetricsProto.MetricsEvent.ACTION_APP_DISAMBIG_ALWAYS,
    ...
    MetricsProto.MetricsEvent.ACTION_DELETION_SELECTION_APP_OFF,
    MetricsProto.MetricsEvent.ACTION_DELETION_SELECTION_APP_OFF,
    MetricsProto.MetricsEvent.ACTION_DELETION_APPS_COLLAPSED,
    MetricsProto.MetricsEvent.ACTION_DELETION_APPS_COLLAPSED,
    MetricsProto.MetricsEvent.ACTION_DELETION_SELECTION_DOWNLOADS,
    MetricsProto.MetricsEvent.ACTION_DELETION_SELECTION_DOWNLOADS,
    MetricsProto.MetricsEvent.ACTION_DELETION_SELECTION_DOWNLOADS,
    MetricsProto.MetricsEvent.ACTION_DELETION_DOWNLOADS_COLLAPSED,
    MetricsProto.MetricsEvent.ACTION_DELETION_DOWNLOADS_COLLAPSED,
    MetricsProto.MetricsEvent.ACTION_DELETION_DOWNLOADS_COLLAPSED,
    MetricsProto.MetricsEvent.ACTION_DELETION_HELPER_CLEAR,
    MetricsProto.MetricsEvent.ACTION_DELETION_HELPER_CLEAR,
    MetricsProto.MetricsEvent.ACTION_DELETION_HELPER_CLEAR,
    468,
    468,
    ...
    470,
    470,
    MetricsProto.MetricsEvent.ACTION_DELETION_HELPER_APPS_DELETION_FAIL,
    MetricsProto.MetricsEvent.ACTION_DELETION_HELPER_DOWNLOADS_DELETION_FAIL,
    MetricsProto.MetricsEvent.ACTION_DELETION_HELPER_DOWNLOADS_DELETION_FAIL,
    MetricsProto.MetricsEvent.ACTION_DELETION_HELPER_DOWNLOADS_DELETION_FAIL,
    ...
    477,
    477,
    MetricsProto.MetricsEvent.ACTION_SUPPORT_TIPS_AND_TRICKS,
    MetricsProto.MetricsEvent.ACTION_SUPPORT_TIPS_AND_TRICKS,
    MetricsProto.MetricsEvent.ACTION_SUPPORT_TIPS_AND_TRICKS,
    ...
    MetricsProto.MetricsEvent.DIALOG_SUPPORT_DISCLAIMER,
    MetricsProto.MetricsEvent.DIALOG_SUPPORT_PHONE,
    528,
    529,
    529,
    530,
    ...
    MetricsProto.MetricsEvent.DIALOG_BLUETOOTH_PAIRED_DEVICE_PROFILE,
    540,
    MetricsProto.MetricsEvent.DIALOG_WPS_SETUP,
    543,
    544,
    545,
    546,
    ...
    MetricsProto.MetricsEvent.PROVISIONING_ENTRY_POINT_NFC,
    MetricsProto.MetricsEvent.PROVISIONING_ENTRY_POINT_TRUSTED_SOURCE,
    620,
    MetricsProto.MetricsEvent.PROVISIONING_CANCELLED,
    628,
    631,
    MetricsProto.MetricsEvent.ACTION_PERMISSION_GRANT_READ_CALENDAR,
    MetricsProto.MetricsEvent.ACTION_PERMISSION_GRANT_WRITE_CALENDAR,
    644,
    MetricsProto.MetricsEvent.ACTION_PERMISSION_REVOKE_READ_CONTACTS,
    654,
    659,
    MetricsProto.MetricsEvent.ACTION_PERMISSION_REQUEST_RECORD_AUDIO,
    MetricsProto.MetricsEvent.ACTION_PERMISSION_REVOKE_READ_PHONE_STATE,
    MetricsProto.MetricsEvent.ACTION_PERMISSION_DENIED_READ_CALL_LOG,
    MetricsProto.MetricsEvent.ACTION_PERMISSION_REQUEST_USE_SIP,
    700,
    MetricsProto.MetricsEvent.ACTION_PERMISSION_REQUEST_READ_SMS
  };
