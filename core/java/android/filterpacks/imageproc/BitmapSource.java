...
public class BitmapSource extends Filter {
  ...
  public void loadImage(FilterContext filterContext) {
    ...
    FrameFormat outputFormat =
        ImageFormat.create(this.mBitmap.getWidth(), this.mBitmap.getHeight(), 3, this.mTarget);
  ...
  public void fieldPortValueUpdated(String name, FilterContext context) {
    Frame frame;
    if ((name.equals(SemSmartClipMetaTagType.BITMAP) || name.equals("target"))
        && (frame = this.mImageFrame) != null) {
      frame.release();
