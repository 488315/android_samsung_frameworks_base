...
public class RapporConfig implements DifferentialPrivacyConfig {
    ...
    public RapporConfig(
        ...
        Preconditions.checkArgument(
                probabilityQ >= SContextConstants.ENVIRONMENT_VALUE_UNKNOWN && probabilityQ <= 1.0d,
    ...
    public String toString() {
        return String.format(
                "EncoderId: %s, NumBits: %d, ProbabilityF: %.3f, ProbabilityP: %.3f, ProbabilityQ:"
                    + " %.3f, NumCohorts: %d, NumBloomHashes: %d",
                this.mEncoderId,
                Integer.valueOf(this.mNumBits),
