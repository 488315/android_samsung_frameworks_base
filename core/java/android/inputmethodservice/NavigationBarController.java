...
final class NavigationBarController {
  ...
  static final class Impl implements Callback, Window.DecorCallback {
    ...
    private void installNavigationBarFrameIfNecessary() {
      ...
      this.mNavigationBarFrame =
          (NavigationBarFrame)
              decorView.findViewByPredicate(
                  new NavigationBarController$Impl$$ExternalSyntheticLambda0(
      ...
      if (navigationBarFrame == null) {
        ...
        LayoutInflater.from(this.mService)
            .inflate(C4337R.layout.input_method_navigation_bar, this.mNavigationBarFrame);
        if (systemInsets != null) {
          decorView.addView(
              this.mNavigationBarFrame, new FrameLayout.LayoutParams(-1, systemInsets.bottom, 80));
        ...
        NavigationBarView navigationBarView =
            (NavigationBarView)
                navigationBarFrame2.findViewByPredicate(
                    new NavigationBarController$Impl$$ExternalSyntheticLambda0(
      ...
      setIconTintInternal(
          calculateTargetDarkIntensity(this.mAppearance, this.mDrawLegacyNavigationBarBackground));
    }
    ...
    public /* synthetic */ void lambda$scheduleRelayout$0(NavigationBarFrame frame) {
      ...
      View navbarBackgroundView = window.getNavigationBarBackgroundView();
      if (navbarBackgroundView != null
          && decorGroup.indexOfChild(navbarBackgroundView) > decorGroup.indexOfChild(frame)) {
    ...
    public void onSystemBarAppearanceChanged(int appearance) {
      ...
      float targetDarkIntensity =
          calculateTargetDarkIntensity(appearance, this.mDrawLegacyNavigationBarBackground);
      ValueAnimator valueAnimator = this.mTintAnimator;
      if (valueAnimator != null) {
        valueAnimator.cancel();
      }
      ...
      ofFloat.addUpdateListener(
          new ValueAnimator
              .AnimatorUpdateListener() { // from class:
                                          // android.inputmethodservice.NavigationBarController$Impl$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
              NavigationBarController.Impl.this.lambda$onSystemBarAppearanceChanged$1(
                  valueAnimator2);
            }
          });
