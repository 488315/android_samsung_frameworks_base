...
final class IRemoteInputConnectionInvoker {
    ...
    public void performHandwritingGesture(HandwritingGesture gesture, Executor executor, final IntConsumer consumer) {
        ...
        try {
            ...
            try {
                this.mConnection.performHandwritingGesture(createHeader(), ParcelableHandwritingGesture.m165of(gesture), resultReceiver);
                if (ignored != null) {
                    ignored.close();
                }
            } finally {
    ...
    public boolean previewHandwritingGesture(HandwritingGesture gesture, CancellationSignal cancellationSignal) {
        try {
            ...
            try {
                this.mConnection.previewHandwritingGesture(createHeader(), ParcelableHandwritingGesture.m165of(gesture), csToken);
                if (csToken != null) {
                    csToken.close();
                    return true;
                }
