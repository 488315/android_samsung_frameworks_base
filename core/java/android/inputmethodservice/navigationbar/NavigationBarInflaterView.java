...
public final class NavigationBarInflaterView extends FrameLayout {
    ...
    FrameLayout frameLayout =
        (FrameLayout)
            this.mLayoutInflater.inflate(
                C4337R.layout.input_method_navigation_layout, (ViewGroup) this, false);
  ...
  private void initiallyFill(ButtonDispatcher buttonDispatcher) {
    addAll(
        buttonDispatcher,
        (ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_ends_group));
    addAll(
        buttonDispatcher,
        (ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_center_group));
  }
  ...
  protected void inflateLayout(String newLayout) {
    ...
    inflateButtons(
        ...
        false);
    addGravitySpacer(
        (LinearLayout) this.mHorizontal.findViewById(C4337R.id.input_method_nav_ends_group));
    inflateButtons(
        end,
        (ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_ends_group),
        false,
    ...
    if (sizeStr.contains("W") || sizeStr.contains("A")) {
      ...
      if (sizeStr.contains("W")) {
        ...
        int width =
            (int)
                convertDpToPx(
                    this.mContext, Float.parseFloat(sizeStr.substring(0, sizeStr.indexOf("A"))));
