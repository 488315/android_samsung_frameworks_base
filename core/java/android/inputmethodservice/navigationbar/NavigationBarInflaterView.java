...
public final class NavigationBarInflaterView extends FrameLayout {
    ...
    private void inflateChildren() {
        removeAllViews();
        FrameLayout frameLayout = (FrameLayout) this.mLayoutInflater.inflate(C4337R.layout.input_method_navigation_layout, (ViewGroup) this, false);
    ...
    private void updateAlternativeOrder() {
        updateAlternativeOrder(this.mHorizontal.findViewById(C4337R.id.input_method_nav_ends_group));
        updateAlternativeOrder(this.mHorizontal.findViewById(C4337R.id.input_method_nav_center_group));
    }
    ...
    private void initiallyFill(ButtonDispatcher buttonDispatcher) {
        addAll(buttonDispatcher, (ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_ends_group));
        addAll(buttonDispatcher, (ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_center_group));
    }
    ...
    protected void inflateLayout(String newLayout) {
        ...
        inflateButtons(start, (ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_ends_group), false, true);
        inflateButtons(center, (ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_center_group), false, false);
        addGravitySpacer((LinearLayout) this.mHorizontal.findViewById(C4337R.id.input_method_nav_ends_group));
        inflateButtons(end, (ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_ends_group), false, false);
    ...
    View createView(String buttonSpec, ViewGroup parent, LayoutInflater inflater) {
        ...
        if (BACK.equals(button)) {
            View v = inflater.inflate(C4337R.layout.input_method_nav_back, parent, false);
            return v;
        }
        ...
        if (HOME_HANDLE.equals(button)) {
            View v2 = inflater.inflate(C4337R.layout.input_method_nav_home_handle, parent, false);
            return v2;
        }
        if (IME_SWITCHER.equals(button)) {
            View v3 = inflater.inflate(C4337R.layout.input_method_nav_ime_switcher, parent, false);
            return v3;
        }
    ...
    private void clearViews() {
        ...
        clearAllChildren((ViewGroup) this.mHorizontal.findViewById(C4337R.id.input_method_nav_buttons));
    }
