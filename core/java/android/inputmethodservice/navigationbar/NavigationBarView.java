...
public final class NavigationBarView extends FrameLayout {
  ...
  public NavigationBarView(Context context, AttributeSet attrs) {
    ...
    sparseArray.put(
        C4337R.id.input_method_nav_back, new ButtonDispatcher(C4337R.id.input_method_nav_back));
    sparseArray.put(
        C4337R.id.input_method_nav_ime_switcher,
        new ButtonDispatcher(C4337R.id.input_method_nav_ime_switcher));
    sparseArray.put(
        C4337R.id.input_method_nav_home_handle,
        new ButtonDispatcher(C4337R.id.input_method_nav_home_handle));
  ...
  */
  ...
  public void onFinishInflate() {
    ...
    NavigationBarInflaterView navigationBarInflaterView =
        (NavigationBarInflaterView) findViewById(C4337R.id.input_method_nav_inflater);
