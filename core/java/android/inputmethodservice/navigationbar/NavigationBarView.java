...
public final class NavigationBarView extends FrameLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
        ...
        sparseArray.put(C4337R.id.input_method_nav_back, new ButtonDispatcher(C4337R.id.input_method_nav_back));
        sparseArray.put(C4337R.id.input_method_nav_ime_switcher, new ButtonDispatcher(C4337R.id.input_method_nav_ime_switcher));
        sparseArray.put(C4337R.id.input_method_nav_home_handle, new ButtonDispatcher(C4337R.id.input_method_nav_home_handle));
    ...
    */
    ...
    public ButtonDispatcher getBackButton() {
        return this.mButtonDispatchers.get(C4337R.id.input_method_nav_back);
    }

    public ButtonDispatcher getImeSwitchButton() {
        return this.mButtonDispatchers.get(C4337R.id.input_method_nav_ime_switcher);
    }

    public ButtonDispatcher getHomeHandle() {
        return this.mButtonDispatchers.get(C4337R.id.input_method_nav_home_handle);
    }
    ...
    private void updateIcons(Configuration oldConfig) {
        ...
        if (densityChange || dirChange) {
            this.mImeSwitcherIcon = getDrawable(C4337R.drawable.ic_ime_switcher);
        }
    ...
    private KeyButtonDrawable getBackDrawable() {
        KeyButtonDrawable drawable = getDrawable(C4337R.drawable.ic_ime_nav_back);
    ...
    public void onFinishInflate() {
        ...
        NavigationBarInflaterView navigationBarInflaterView = (NavigationBarInflaterView) findViewById(C4337R.id.input_method_nav_inflater);
    ...
    private void updateOrientationViews() {
        this.mHorizontal = findViewById(C4337R.id.input_method_nav_horizontal);
        updateCurrentView();
    }
