...
class IInputMethodWrapper extends IInputMethod.Stub implements HandlerCaller.Callback {
      ...
      case 60:
        ...
        if (isValid(inputMethod, target, "DO_SHOW_SOFT_INPUT")) {
          ...
          inputMethod.showSoftInputWithToken(
              msg.arg1, (ResultReceiver) args4.arg2, (IBinder) args4.arg1, statsToken);
        } else {
      ...
      case 70:
        ...
        if (isValid(inputMethod, target, "DO_HIDE_SOFT_INPUT")) {
          ...
          inputMethod.hideSoftInputWithToken(
              msg.arg1, (ResultReceiver) args5.arg2, (IBinder) args5.arg1, statsToken2);
        } else {
      ...
      case 110:
        ...
        if (isValid(inputMethod, target, "DO_START_STYLUS_HANDWRITING")) {
          inputMethod.startStylusHandwriting(
              msg.arg1, (InputChannel) args7.arg1, (List) args7.arg2);
        }
        args7.recycle();
        return;
      case 120:
  ...
  protected void dump(FileDescriptor fd, PrintWriter fout, String[] args) {
    ...
    this.mCaller
        .getHandler()
        .sendMessageAtFrontOfQueue(this.mCaller.obtainMessageOOOO(1, fd, fout, args, latch));
    try {
  ...
  public void bindInput(InputBinding binding) {
    if (this.mCancellationGroup != null) {
      Log.m96e(TAG, "bindInput must be paired with unbindInput.");
    }
  ...
  public void unbindInput() {
    ...
    if (cancellationGroup != null) {
      ...
      Log.m96e(TAG, "unbindInput must be paired with bindInput.");
    }
    HandlerCaller handlerCaller = this.mCaller;
  ...
  public void startInput(IInputMethod.StartInputParams params) {
    if (this.mCancellationGroup == null) {
      Log.m96e(TAG, "startInput must be called after bindInput.");
      this.mCancellationGroup = new CancellationGroup();
    }
    ...
    InputConnection ic =
        params.remoteInputConnection == null
            ? null
            : new RemoteInputConnection(
                this.mTarget, params.remoteInputConnection, this.mCancellationGroup);
    HandlerCaller handlerCaller = this.mCaller;
  ...
  public void setSessionEnabled(IInputMethodSession session, boolean enabled) {
    try {
      ...
      if (ls == null) {
        Log.m102w(TAG, "Session is already finished: " + session);
      } else {
        HandlerCaller handlerCaller = this.mCaller;
  ...
  public void showSoftInput(
    ...
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageIOOO(60, flags, showInputToken, resultReceiver, statsToken));
  }
  ...
  public void hideSoftInput(
    ...
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageIOOO(70, flags, hideInputToken, resultReceiver, statsToken));
  }
  ...
  public void startStylusHandwriting(
      int requestId, InputChannel channel, List<MotionEvent> stylusEvents) throws RemoteException {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageIOO(110, requestId, channel, stylusEvents));
  }
