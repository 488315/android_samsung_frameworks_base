        ...
        switch (this.mWindowState) {
            ...
            case 2:
                try {
                    ...
                    Log.m98i(TAG, "Probably the IME window token is already invalidated. show() does nothing.");
                    updateWindowState(3);
                    return;
        ...
        switch (this.mWindowState) {
            ...
            case 2:
                try {
                    ...
                    Log.m98i(TAG, "Probably the IME window token is already invalidated. No need to dismiss it.");
                }
                updateWindowState(4);
                return;
            case 3:
