...
public class CompactExtractEditLayout extends LinearLayout {
    ...
    private void applyProportionalLayout(int screenWidthPx, int screenHeightPx) {
        ...
        setLayoutHeight(this, applyFractionInt(C4337R.fraction.input_extract_layout_height, screenHeightPx));
        setPadding(applyFractionInt(C4337R.fraction.input_extract_layout_padding_left, screenWidthPx), 0, applyFractionInt(C4337R.fraction.input_extract_layout_padding_right, screenWidthPx), 0);
        setLayoutMarginBottom(this.mInputExtractEditText, applyFractionInt(C4337R.fraction.input_extract_text_margin_bottom, screenHeightPx));
        setLayoutMarginBottom(this.mInputExtractAccessories, applyFractionInt(C4337R.fraction.input_extract_action_margin_bottom, screenHeightPx));
    }
