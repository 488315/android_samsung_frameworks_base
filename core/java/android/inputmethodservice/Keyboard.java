...
public class Keyboard {
    ...
    public static class Row {
        ...
        public Row(Resources res, Keyboard parent, XmlResourceParser parser) {
            ...
            a.recycle();
            TypedArray a2 = res.obtainAttributes(Xml.asAttributeSet(parser), C4337R.styleable.Keyboard_Row);
    ...
    public static class Key {
        ...
        public Key(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
            ...
            a.recycle();
            TypedArray a2 = res.obtainAttributes(Xml.asAttributeSet(parser), C4337R.styleable.Keyboard_Key);
            this.f266x += this.gap;
        ...
        public boolean isInside(int x, int y) {
            ...
            int i3 = this.f266x;
            return (x >= i3 || (leftEdge && x <= this.width + i3)) && (x < this.width + i3 || (rightEdge && x >= i3)) && ((y >= (i = this.f267y) || (topEdge && y <= this.height + i)) && (y < this.height + i || (bottomEdge && y >= i)));
        }
