...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    private void onBufferDraw() {
        ...
        if (invalidKey2 != null && canvas.getClipBounds(clipRegion) && (invalidKey2.f266x + kbdPaddingLeft) - 1 <= clipRegion.left && (invalidKey2.f267y + kbdPaddingTop) - 1 <= clipRegion.top && invalidKey2.f266x + invalidKey2.width + kbdPaddingLeft + 1 >= clipRegion.right && invalidKey2.f267y + invalidKey2.height + kbdPaddingTop + 1 >= clipRegion.bottom) {
            drawSingleKey = true;
        } else {
            drawSingleKey = false;
        }
    ...
    */
    ...
    public void invalidateKey(int keyIndex) {
        ...
        this.mDirtyRect.union(key.f266x + this.mPaddingLeft, key.f267y + this.mPaddingTop, key.f266x + key.width + this.mPaddingLeft, key.f267y + key.height + this.mPaddingTop);
        onBufferDraw();
        invalidate(key.f266x + this.mPaddingLeft, key.f267y + this.mPaddingTop, key.f266x + key.width + this.mPaddingLeft, key.f267y + key.height + this.mPaddingTop);
    }
