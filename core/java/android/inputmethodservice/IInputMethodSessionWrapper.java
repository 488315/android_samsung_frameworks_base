...
class IInputMethodSessionWrapper extends IInputMethodSession.Stub
  ...
  public void updateSelection(
    ...
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageIIIIII(
            90, oldSelStart, oldSelEnd, newSelStart, newSelEnd, candidatesStart, candidatesEnd));
  }
  ...
  public void invalidateInput(
    ...
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageIOO(150, sessionId, editorInfo, inputConnection));
  }
