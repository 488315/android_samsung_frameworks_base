...
public final class Manifest {
  ...
  public static final class permission {
    ...
    public static final String ACCESS_AUTOBLOCKER =
    ...
    public static final String ACCESS_COMMANDS =
    ...
    public static final String ACCESS_KEY_CUSTOMIZE_INFO =
        "com.samsung.android.permisson.ACCESS_KEY_CUSTOMIZE_INFO";
    ...
    public static final String ACCESS_MAINTENANCE_MODE =
    ...
    @SystemApi public static final String ACCESS_MTP = "android.permission.ACCESS_MTP";
    ...
    @SystemApi public static final String ACCESS_PDB_STATE = "android.permission.ACCESS_PDB_STATE";
    public static final String ACCESS_PROVIDER =
        "com.samsung.android.bbc.bbcagent.permission.ACCESS_PROVIDER";

    @SystemApi
    public static final String ACCESS_RCS_USER_CAPABILITY_EXCHANGE =
        "android.permission.ACCESS_RCS_USER_CAPABILITY_EXCHANGE";

    public static final String ACCESS_SEMCLIPBOARD =
        "com.samsung.android.clipboard.ACCESS_SEMCLIPBOARD";

    @SystemApi
    public static final String ACCESS_SHARED_LIBRARIES =
        "android.permission.ACCESS_SHARED_LIBRARIES";

    @SystemApi public static final String ACCESS_SHORTCUTS = "android.permission.ACCESS_SHORTCUTS";

    @SystemApi
    public static final String ACCESS_SURFACE_FLINGER = "android.permission.ACCESS_SURFACE_FLINGER";

    public static final String ACCESS_SYSTEM_KEY_DISPATCHING =
    ...
    @SystemApi public static final String ACCESS_TV_TUNER = "android.permission.ACCESS_TV_TUNER";
    ...
    @Deprecated
    public static final String ADAPTIVE_BRIGHTNESS_PERMISSION =
        "com.samsung.adaptivebrightnessgo.permission.ADAPTIVE_BRIGHTNESS_PERMISSION";
    ...
    @SystemApi public static final String BACKUP = "android.permission.BACKUP";
    ...
    public static final String BIND_DESKTOP_MODE_UI_SERVICE =
        "com.samsung.android.desktopmode.permission.BIND_DESKTOP_MODE_UI_SERVICE";
    ...
    @SystemApi public static final String BIND_GBA_SERVICE = "android.permission.BIND_GBA_SERVICE";

    @SystemApi
    public static final String BIND_HOTWORD_DETECTION_SERVICE =
        "android.permission.BIND_HOTWORD_DETECTION_SERVICE";

    @SystemApi public static final String BIND_IMS_SERVICE = "android.permission.BIND_IMS_SERVICE";
    ...
    @Deprecated
    public static final String BIND_SESETTINGS_SERVICES =
    ...
    @SystemApi public static final String BIND_TRUST_AGENT = "android.permission.BIND_TRUST_AGENT";
    ...
    public static final String BIOMETRICS_PRIVILEGED =
    ...
    @SystemApi public static final String BLUETOOTH_MAP = "android.permission.BLUETOOTH_MAP";
    ...
    @SystemApi public static final String BRICK = "android.permission.BRICK";
    ...
    public static final String BROADCAST_GEN_AI_RECLAIM_TRIGGER =
        "com.samsung.android.permission.BROADCAST_GEN_AI_RECLAIM_TRIGGER";
    ...
    public static final String BROADCAST_PMM_CRITICAL_TRIGGER =
        "com.samsung.android.permission.BROADCAST_PMM_CRITICAL_TRIGGER";
    public static final String BROADCAST_QUICKACCESS =
        "com.samsung.android.permission.BROADCAST_QUICKACCESS";
    public static final String BROADCAST_RECEIVER =
    ...
    @SystemApi public static final String CAPTURE_TV_INPUT = "android.permission.CAPTURE_TV_INPUT";
    ...
    public static final String CHANGE_DISPLAY_COLOR =
        "com.samsung.android.permission.CHANGE_DISPLAY_COLOR";
    ...
    public static final String CHANGE_SPEN_THEME =
        "com.samsung.android.permission.CHANGE_SPEN_THEME";
    ...
    public static final String CHIMERA_PREFERENCE =
        "com.samsung.android.permission.CHIMERA_PREFERENCE";
    ...
    public static final String CONTAINER_BROADCAST =
        "com.sec.enterprise.knox.permission.CONTAINER_BROADCAST";
    ...
    @SystemApi public static final String CONTROL_VPN = "android.permission.CONTROL_VPN";
    ...
    @SystemApi public static final String CREATE_USERS = "android.permission.CREATE_USERS";
    ...
    @SystemApi public static final String CRYPT_KEEPER = "android.permission.CRYPT_KEEPER";

    @Deprecated
    public static final String CUSTOM_SEALEDMODE =
    ...
    @SystemApi public static final String DEVICE_POWER = "android.permission.DEVICE_POWER";
    public static final String DIAGMON = "com.sec.android.diagmonagent.permission.DIAGMON";
    public static final String DIAGMON_SURVEY =
    ...
    public static final String ENFORCE_UPDATE_OWNERSHIP =
    ...
    public static final String EXTRACT_SMARTCLIP_DATA =
    ...
    public static final String FINGERPRINT_PRIVILEGED =
        "com.samsung.android.permission.FINGERPRINT_PRIVILEGED";
    public static final String FLASHLIGHT = "android.permission.FLASHLIGHT";

    @SystemApi public static final String FORCE_BACK = "android.permission.FORCE_BACK";
    ...
    public static final String FOREGROUND_SERVICE_FILE_MANAGEMENT =
    ...
    @SystemApi public static final String GET_APP_METADATA = "android.permission.GET_APP_METADATA";
    ...
    @Deprecated public static final String GET_TASKS = "android.permission.GET_TASKS";
    ...
    @SystemApi public static final String HARDWARE_TEST = "android.permission.HARDWARE_TEST";

    @SystemApi public static final String HDMI_CEC = "android.permission.HDMI_CEC";
    ...
    public static final String HQM_NOTIFICATION_PERMISSION =
        "com.samsung.permission.HQM_NOTIFICATION_PERMISSION";

    @SystemApi public static final String INJECT_EVENTS = "android.permission.INJECT_EVENTS";
    ...
    public static final String KEYGUARD_STATE_UPDATE =
        "com.samsung.android.desktopmode.permission.KEYGUARD_STATE_UPDATE";
    ...
    @SystemApi public static final String KILL_UID = "android.permission.KILL_UID";
    public static final String KNOX_ACTIVATE_DEVICE_PERMISSIONS_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_ACTIVATE_DEVICE_PERMISSIONS_INTERNAL";
    public static final String KNOX_ADVANCED_APP_MGMT =
        "com.samsung.android.knox.permission.KNOX_ADVANCED_APP_MGMT";
    public static final String KNOX_ADVANCED_RESTRICTION =
        "com.samsung.android.knox.permission.KNOX_ADVANCED_RESTRICTION";
    public static final String KNOX_ADVANCED_SECURITY =
        "com.samsung.android.knox.permission.KNOX_ADVANCED_SECURITY";
    public static final String KNOX_ANALYTICS_INTERNAL =
    ...
    public static final String KNOX_APP_PERMISSION_MGMT =
        "com.samsung.android.knox.permission.KNOX_APP_PERMISSION_MGMT";
    public static final String KNOX_APP_SEPARATION =
        "com.samsung.android.knox.permission.KNOX_APP_SEPARATION";

    @Deprecated
    public static final String KNOX_ATTESTATION =
        "com.sec.enterprise.knox.permission.KNOX_ATTESTATION";

    public static final String KNOX_AUDIT_LOG =
        "com.samsung.android.knox.permission.KNOX_AUDIT_LOG";
    public static final String KNOX_AUTH_MGMT =
        "com.samsung.android.knox.permission.KNOX_AUTH_MGMT";
    public static final String KNOX_BLUETOOTH =
        "com.samsung.android.knox.permission.KNOX_BLUETOOTH";
    public static final String KNOX_BLUETOOTH_SECUREMODE =
        "com.samsung.android.knox.permission.KNOX_BLUETOOTH_SECUREMODE";
    public static final String KNOX_BLUETOOTH_SECUREMODE_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_BLUETOOTH_SECUREMODE_INTERNAL";
    public static final String KNOX_BROWSER_PROXY =
        "com.samsung.android.knox.permission.KNOX_BROWSER_PROXY";
    public static final String KNOX_BROWSER_SETTINGS =
        "com.samsung.android.knox.permission.KNOX_BROWSER_SETTINGS";

    @Deprecated public static final String KNOX_CCM = "com.sec.enterprise.knox.permission.KNOX_CCM";
    public static final String KNOX_CCM_KEYSTORE =
        "com.samsung.android.knox.permission.KNOX_CCM_KEYSTORE";
    public static final String KNOX_CERTENROLL =
        "com.sec.enterprise.knox.permission.KNOX_CERTENROLL";
    public static final String KNOX_CERTENROLL_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_CERTENROLL_INTERNAL";
    public static final String KNOX_CERTIFICATE =
        "com.samsung.android.knox.permission.KNOX_CERTIFICATE";
    public static final String KNOX_CERTIFICATE_ENROLLMENT =
        "com.samsung.android.knox.permission.KNOX_CERTIFICATE_ENROLLMENT";
    public static final String KNOX_CERT_PROVISIONING =
        "com.samsung.android.knox.permission.KNOX_CERT_PROVISIONING";
    public static final String KNOX_CLIPBOARD =
        "com.samsung.android.knox.permission.KNOX_CLIPBOARD";
    public static final String KNOX_CONTAINER =
        "com.samsung.android.knox.permission.KNOX_CONTAINER";
    public static final String KNOX_CONTAINER_RCP =
        "com.samsung.android.knox.permission.KNOX_CONTAINER_RCP";
    public static final String KNOX_CRITICAL_COMMUNICATIONS =
        "com.samsung.android.knox.permission.KNOX_CRITICAL_COMMUNICATIONS";
    public static final String KNOX_CUSTOM_DEX =
        "com.samsung.android.knox.permission.KNOX_CUSTOM_DEX";
    public static final String KNOX_CUSTOM_PROKIOSK =
        "com.samsung.android.knox.permission.KNOX_CUSTOM_PROKIOSK";
    public static final String KNOX_CUSTOM_SEALEDMODE =
        "com.samsung.android.knox.permission.KNOX_CUSTOM_SEALEDMODE";
    public static final String KNOX_CUSTOM_SETTING =
        "com.samsung.android.knox.permission.KNOX_CUSTOM_SETTING";
    public static final String KNOX_CUSTOM_SYSTEM =
        "com.samsung.android.knox.permission.KNOX_CUSTOM_SYSTEM";
    public static final String KNOX_DATE_TIME =
        "com.samsung.android.knox.permission.KNOX_DATE_TIME";
    public static final String KNOX_DEACTIVATE_LICENSE =
        "com.sec.enterprise.knox.permission.KNOX_DEACTIVATE_LICENSE";
    public static final String KNOX_DEVICE_CONFIGURATION =
        "com.samsung.android.knox.permission.KNOX_DEVICE_CONFIGURATION";
    public static final String KNOX_DEVICE_REGISTRATION_REQUEST_INTENT_INTERNAL =
    ...
    public static final String KNOX_DKS_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_DKS_INTERNAL";
    public static final String KNOX_DUAL_DAR = "com.samsung.android.knox.permission.KNOX_DUAL_DAR";
    public static final String KNOX_DUAL_DAR_INTERNAL =
    ...
    public static final String KNOX_ENHANCED_ATTESTATION =
        "com.samsung.android.knox.permission.KNOX_ENHANCED_ATTESTATION";
    public static final String KNOX_ENTERPRISE_DEVICE_ADMIN =
    ...
    public static final String KNOX_FORESIGHT =
        "com.samsung.android.knox.permission.KNOX_FORESIGHT";
    public static final String KNOX_GEOFENCING =
        "com.samsung.android.knox.permission.KNOX_GEOFENCING";
    public static final String KNOX_GLOBALPROXY =
    ...
    public static final String KNOX_HW_CONTROL =
        "com.samsung.android.knox.permission.KNOX_HW_CONTROL";
    public static final String KNOX_INTERNAL_EXCEPTION =
        "com.samsung.android.knox.permission.KNOX_INTERNAL_EXCEPTION";
    public static final String KNOX_INVENTORY =
        "com.samsung.android.knox.permission.KNOX_INVENTORY";
    public static final String KNOX_KES_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_KES_INTERNAL";

    @Deprecated
    public static final String KNOX_KEYSTORE = "com.sec.enterprise.knox.permission.KNOX_KEYSTORE";

    public static final String KNOX_KIOSK_MODE =
        "com.samsung.android.knox.permission.KNOX_KIOSK_MODE";
    public static final String KNOX_KIOSK_MODE_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_KIOSK_MODE_INTERNAL";
    public static final String KNOX_KPECORE_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_KPECORE_INTERNAL";
    public static final String KNOX_KPU_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_KPU_INTERNAL";
    public static final String KNOX_LDAP = "com.samsung.android.knox.permission.KNOX_LDAP";
    public static final String KNOX_LDAP_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_LDAP_INTERNAL";
    public static final String KNOX_LICENSE_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_LICENSE_INTERNAL";
    public static final String KNOX_LICENSE_LOG =
    ...
    public static final String KNOX_LOCKSCREEN =
        "com.samsung.android.knox.permission.KNOX_LOCKSCREEN";
    public static final String KNOX_MATRIX =
        "com.samsung.security.fabric.crypto.permission.KNOX_MATRIX";
    public static final String KNOX_MOBILE_THREAT_DEFENSE =
    ...
    public static final String KNOX_MTP_DISABLED_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_MTP_DISABLED_INTERNAL";
    public static final String KNOX_MULTI_USER_MGMT =
    ...
    public static final String KNOX_NDA_DATA_ANALYTICS =
        "com.samsung.android.knox.permission.KNOX_NDA_DATA_ANALYTICS";
    public static final String KNOX_NDA_DEVICE_SETTINGS =
        "com.samsung.android.knox.permission.KNOX_NDA_DEVICE_SETTINGS";
    public static final String KNOX_NDA_PERIPHERAL =
        "com.samsung.android.knox.permission.KNOX_NDA_PERIPHERAL";
    public static final String KNOX_NETWORK_FILTER_MGMT =
        "com.samsung.android.knox.permission.KNOX_NETWORK_FILTER_MGMT";
    public static final String KNOX_NETWORK_FILTER_SERVICE_PROVIDER =
        "com.samsung.android.knox.permission.KNOX_NETWORK_FILTER_SERVICE_PROVIDER";
    public static final String KNOX_NETWORK_TRAFFIC_AGENT =
        "com.samsung.android.knox.permission.KNOX_NETWORK_TRAFFIC_AGENT";
    public static final String KNOX_NOTIFY_ICCID_AVAILABLE_INTERNAL =
    ...
    public static final String KNOX_SEAMS_MGMT =
        "com.samsung.android.knox.permission.KNOX_SEAMS_MGMT";
    public static final String KNOX_SEAMS_SEPOLICY =
        "com.sec.enterprise.knox.permission.KNOX_SEAMS_SEPOLICY";
    public static final String KNOX_SEAMS_SEPOLICY_INTERNAL =
    ...
    public static final String KNOX_SENSITIVE_DATA_PROTECTION =
        "com.samsung.android.knox.permission.KNOX_SENSITIVE_DATA_PROTECTION";
    public static final String KNOX_SET_PROXY_CREDENTIAL_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_SET_PROXY_CREDENTIAL_INTERNAL";
    public static final String KNOX_SILENT_ACTIVATION_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_SILENT_ACTIVATION_INTERNAL";
    public static final String KNOX_SIM_RESTRICTION =
        "com.samsung.android.knox.permission.KNOX_SIM_RESTRICTION";
    public static final String KNOX_SMARTCARD =
        "com.samsung.android.knox.permission.KNOX_SMARTCARD";
    public static final String KNOX_SOLUTION_SDK =
        "com.samsung.android.knox.permission.KNOX_SOLUTION_SDK";
    public static final String KNOX_SPDCONTROL =
    ...
    public static final String KNOX_TIMA_KEYSTORE =
        "com.samsung.android.knox.permission.KNOX_TIMA_KEYSTORE";
    public static final String KNOX_TIMA_KEYSTORE_PER_APP =
        "com.samsung.android.knox.permission.KNOX_TIMA_KEYSTORE_PER_APP";
    public static final String KNOX_UCM_BIND_PLUGIN_SERVICE =
        "com.samsung.android.knox.permission.KNOX_UCM_BIND_PLUGIN_SERVICE";
    public static final String KNOX_UCM_ESE_MGMT =
    ...
    public static final String KNOX_UCM_OTHER_MGMT =
        "com.samsung.android.knox.permission.KNOX_UCM_OTHER_MGMT";
    public static final String KNOX_UCM_PLUGIN_SERVICE =
        "com.samsung.android.knox.permission.KNOX_UCM_PLUGIN_SERVICE";
    public static final String KNOX_UCM_PRIVILEGED_MGMT =
    ...
    public static final String KNOX_VPN_CONTAINER =
        "com.samsung.android.knox.permission.KNOX_VPN_CONTAINER";
    public static final String KNOX_VPN_GENERIC =
        "com.samsung.android.knox.permission.KNOX_VPN_GENERIC";
    public static final String KNOX_VPN_INTERNAL =
        "com.samsung.android.knox.permission.KNOX_VPN_INTERNAL";
    public static final String KNOX_VPN_SOLUTION =
        "com.samsung.android.knox.permission.KNOX_VPN_SOLUTION";
    public static final String KNOX_WIFI = "com.samsung.android.knox.permission.KNOX_WIFI";
    public static final String KPM_OPERATION_REQUEST_INFORM_ACTION_INTERNAL =
    ...
    public static final String LAUNCH_SOFTWARE_UPDATE =
    ...
    @SystemApi public static final String LOCATION_BYPASS = "android.permission.LOCATION_BYPASS";
    public static final String LOCATION_HARDWARE = "android.permission.LOCATION_HARDWARE";

    @SystemApi public static final String LOCK_DEVICE = "android.permission.LOCK_DEVICE";
    public static final String LOCK_SECURITY_MONITOR =
        "com.samsung.android.permission.LOCK_SECURITY_MONITOR";
    ...
    @SystemApi public static final String LOOP_RADIO = "android.permission.LOOP_RADIO";
    ...
    @SystemApi public static final String MANAGE_AUTO_FILL = "android.permission.MANAGE_AUTO_FILL";
    ...
    @SystemApi public static final String MANAGE_DEBUGGING = "android.permission.MANAGE_DEBUGGING";
    ...
    @SystemApi public static final String MANAGE_GAME_MODE = "android.permission.MANAGE_GAME_MODE";
    ...
    @SystemApi public static final String MANAGE_ROLLBACKS = "android.permission.MANAGE_ROLLBACKS";
    ...
    @SystemApi public static final String MANAGE_SEARCH_UI = "android.permission.MANAGE_SEARCH_UI";
    ...
    @SystemApi public static final String MANAGE_USB = "android.permission.MANAGE_USB";

    @SystemApi public static final String MANAGE_USERS = "android.permission.MANAGE_USERS";
    ...
    public static final String MDM_CONTENT_PROVIDER =
        "com.sec.enterprise.knox.MDM_CONTENT_PROVIDER";
    public static final String MDM_ENTERPRISE_TIMA_NOTIFICATION =
        "com.sec.enterprise.knox.permission.MDM_ENTERPRISE_TIMA_NOTIFICATION";
    public static final String MDM_SILENT_ACTIVATION =
        "com.sec.enterprise.mdm.permission.MDM_SILENT_ACTIVATION";

    @Deprecated public static final String MDM_SSO = "com.sec.enterprise.mdm.permission.MDM_SSO";
    ...
    @SystemApi public static final String MOVE_PACKAGE = "android.permission.MOVE_PACKAGE";
    public static final String MTP_DISABLED = "com.sec.restriction.permission.MTP_DISABLED";
    public static final String MULTI_CONTROL_RECEIVER_PERMISSION =
        "com.samsung.android.permission.MULTI_CONTROL_RECEIVER_PERMISSION";
    public static final String MULTI_WINDOW_MONITOR =
    ...
    @SystemApi public static final String NETWORK_FACTORY = "android.permission.NETWORK_FACTORY";

    @SystemApi
    public static final String NETWORK_MANAGED_PROVISIONING =
        "android.permission.NETWORK_MANAGED_PROVISIONING";

    @SystemApi public static final String NETWORK_SCAN = "android.permission.NETWORK_SCAN";

    @SystemApi public static final String NETWORK_SETTINGS = "android.permission.NETWORK_SETTINGS";
    ...
    @SystemApi public static final String NETWORK_STACK = "android.permission.NETWORK_STACK";
    ...
    @SystemApi public static final String NOTIFY_TV_INPUTS = "android.permission.NOTIFY_TV_INPUTS";
    ...
    public static final String PLM_SERVICE_ACCESS =
        "com.android.server.enterprise.plm.permission.PLM_SERVICE_ACCESS";
    public static final String POST_NOTIFICATIONS = "android.permission.POST_NOTIFICATIONS";

    @SystemApi public static final String POWER_SAVER = "android.permission.POWER_SAVER";
    ...
    public static final String PROVISION_HOTSPOT_TRIGGER =
        "com.samsung.unifiedtp.permission.PROVISION_HOTSPOT_TRIGGER";
    ...
    @SystemApi public static final String QUERY_USERS = "android.permission.QUERY_USERS";
    ...
    public static final String READ_DATABASES =
        "com.samsung.android.fota.permission.READ_DATABASES";

    @SystemApi
    public static final String READ_DEVICE_CONFIG = "android.permission.READ_DEVICE_CONFIG";

    @SystemApi public static final String READ_DREAM_STATE = "android.permission.READ_DREAM_STATE";
    ...
    public static final String READ_FRAME_BUFFER_IGNORE_POLICY =
    ...
    @Deprecated public static final String READ_INPUT_STATE = "android.permission.READ_INPUT_STATE";
    ...
    public static final String READ_KNOX_NOTIFICATION =
        "com.samsung.permission.READ_KNOX_NOTIFICATION";
    ...
    public static final String READ_OMC_CONFIG =
        "com.samsung.android.sdm.config.provider.READ_OMC_CONFIG";

    @SystemApi public static final String READ_PEOPLE_DATA = "android.permission.READ_PEOPLE_DATA";
    ...
    public static final String READ_TRAFFIC_STATS =
        "com.tmobile.oem.echolocate.system.provider.trafficstats.TrafficStatsContentProvider.READ_TRAFFIC_STATS";
    ...
    @SystemApi public static final String REAL_GET_TASKS = "android.permission.REAL_GET_TASKS";
    ...
    public static final String RECEIVE_CONFIG_CHANGED =
        "com.samsung.android.sdm.config.permission.RECEIVE_CONFIG_CHANGED";
    ...
    @SystemApi public static final String RECOVERY = "android.permission.RECOVERY";

    @SystemApi public static final String RECOVER_KEYSTORE = "android.permission.RECOVER_KEYSTORE";
    ...
    @SystemApi public static final String REMOVE_TASKS = "android.permission.REMOVE_TASKS";
    ...
    public static final String REQUEST_AUTHNR_SERVICE =
    ...
    public static final String REQUEST_PROCESS_FIDO =
    ...
    public static final String RESET_FACE_LOCKOUT =
        "com.samsung.android.bio.face.permission.RESET_FACE_LOCKOUT";
    public static final String RESET_FINGERPRINT_LOCKOUT =
        "android.permission.RESET_FINGERPRINT_LOCKOUT";
    public static final String RESET_INTELLIGENT_SCAN_LOCKOUT =
        "com.samsung.android.biometrics.permission.RESET_INTELLIGENT_SCAN_LOCKOUT";

    @SystemApi public static final String RESET_PASSWORD = "android.permission.RESET_PASSWORD";
    public static final String RESET_SHORTCUT_MANAGER_THROTTLING =
        "android.permission.RESET_SHORTCUT_MANAGER_THROTTLING";

    @Deprecated public static final String RESTART_PACKAGES = "android.permission.RESTART_PACKAGES";
    ...
    public static final String RUN_DISK_DEFRAGMENTATION =
    ...
    public static final String SAMSUNG_KEYSTORE_PERMISSION =
        "com.samsung.android.security.permission.SAMSUNG_KEYSTORE_PERMISSION";
    public static final String SAMSUNG_OVERLAY_COMPONENT =
        "com.samsung.android.permission.SAMSUNG_OVERLAY_COMPONENT";
    public static final String SAMSUNG_OVERLAY_THEME =
        "com.samsung.android.permission.SAMSUNG_OVERLAY_THEME";
    public static final String SAMSUNG_SECUREKEY_PERMISSION =
        "com.samsung.android.security.permission.SAMSUNG_SECUREKEY_PERMISSION";
    ...
    public static final String SCREEN_ROTATION_ANIMATION_STARTED =
        "com.samsung.android.permisson.SCREEN_ROTATION_ANIMATION_STARTED";

    @SystemApi
    public static final String SECURE_ELEMENT_PRIVILEGED_OPERATION =
        "android.permission.SECURE_ELEMENT_PRIVILEGED_OPERATION";

    public static final String SEM_ACCESS_WIFI_SECURED_INFO =
        "com.samsung.permission.SEM_ACCESS_WIFI_SECURED_INFO";
    public static final String SEM_ADAPTIVE_BRIGHTNESS =
        "com.samsung.adaptivebrightnessgo.permission.SEM_ADAPTIVE_BRIGHTNESS";
    public static final String SEM_APP_RESTRICTION =
        "com.samsung.android.permission.SEM_APP_RESTRICTION";
    public static final String SEM_AUTO_BIND_NOTIFICATION_LISTENER_SERVICE =
        "com.samsung.android.permission.SEM_AUTO_BIND_NOTIFICATION_LISTENER_SERVICE";
    public static final String SEM_BATTERY_INFO = "com.samsung.android.permission.SEM_BATTERY_INFO";
    public static final String SEM_BATTERY_INFO_PROVIDER =
        "com.samsung.android.permission.SEM_BATTERY_INFO_PROVIDER";
    public static final String SEM_CMC_PUSH = "com.samsung.android.mdecservice.nms.SEM_CMC_PUSH";
    public static final String SEM_CONTROL_DISPLAY_COLOR_TRANSFORMS =
        "com.samsung.android.permission.SEM_CONTROL_DISPLAY_COLOR_TRANSFORMS";
    public static final String SEM_GLOBAL_SEARCH =
        "com.samsung.android.permission.SEM_GLOBAL_SEARCH";
    public static final String SEM_MEDIA_CONTENTS =
        "com.samsung.android.permission.SEM_MEDIA_CONTENTS";
    public static final String SEM_SET_DEVICE_BLOCK =
        "com.samsung.android.permission.SEM_SET_DEVICE_BLOCK";
    public static final String SEM_UPDATE_NOTIFICATION_CHANNELS =
        "com.samsung.android.permission.SEM_UPDATE_NOTIFICATION_CHANNELS";
    public static final String SEM_VOLD_DATA_MOVE =
        "com.samsung.android.permission.SEM_VOLD_DATA_MOVE";
    public static final String SEM_WRITE_CAPTURED_URL =
    ...
    @SystemApi public static final String SERIAL_PORT = "android.permission.SERIAL_PORT";
    ...
    @SystemApi public static final String SET_CLIP_SOURCE = "android.permission.SET_CLIP_SOURCE";
    ...
    @SystemApi public static final String SET_ORIENTATION = "android.permission.SET_ORIENTATION";
    ...
    @SystemApi public static final String SHUTDOWN = "android.permission.SHUTDOWN";
    ...
    public static final String SMART_SCAN_ADVANCED =
        "com.samsung.android.knox.permission.SMART_SCAN_ADVANCED";
    public static final String SMART_SCAN_BASIC =
        "com.samsung.android.knox.permission.SMART_SCAN_BASIC";
    public static final String SMIME_CERTIFICATE_INTERNAL =
    ...
    public static final String SSRM_NOTIFICATION_PERMISSION =
    ...
    public static final String START_DOCK_OR_HOME =
    ...
    @SystemApi public static final String SUSPEND_APPS = "android.permission.SUSPEND_APPS";
    ...
    @SystemApi public static final String SYSTEM_CAMERA = "android.permission.SYSTEM_CAMERA";
    ...
    @SystemApi public static final String UPDATE_FONTS = "android.permission.UPDATE_FONTS";

    @SystemApi public static final String UPDATE_LOCK = "android.permission.UPDATE_LOCK";
    ...
    @SystemApi public static final String USER_ACTIVITY = "android.permission.USER_ACTIVITY";
    ...
    @Deprecated public static final String USE_FINGERPRINT = "android.permission.USE_FINGERPRINT";
    ...
    public static final String USE_LINK_TO_WINDOWS_REMOTE_APP_MODE =
        "com.sec.android.permission.USE_LINK_TO_WINDOWS_REMOTE_APP_MODE";
    public static final String USE_MULTI_CONTROL_MANAGER =
        "com.sec.android.permission.USE_MULTI_CONTROL_MANAGER";
    ...
    @SystemApi public static final String UWB_PRIVILEGED = "android.permission.UWB_PRIVILEGED";
    public static final String UWB_RANGING = "android.permission.UWB_RANGING";
    public static final String UWB_SYSTEM_PROTECTION =
    ...
    public static final String WIFI_DIAGNOSTICS_PROVIDER =
    ...
    public static final String WRITE_DATABASES =
        "com.samsung.android.fota.permission.WRITE_DATABASES";
    ...
    @SystemApi public static final String WRITE_OBB = "android.permission.WRITE_OBB";
    ...
    @SystemApi public static final String WRITE_SMS = "android.permission.WRITE_SMS";
    ...
    public static final String WRITE_TRAFFIC_STATS =
        "com.tmobile.oem.echolocate.system.provider.trafficstats.TrafficStatsContentProvider.WRITE_TRAFFIC_STATS";
    ...
    public static final String receiveDetailedApplicationState =
        "diagandroid.app.receiveDetailedApplicationState";
    public static final String receiveDetailedCallState =
  ...
  public static final class permission_group {
    ...
    @SystemApi public static final String UNDEFINED = "android.permission-group.UNDEFINED";
