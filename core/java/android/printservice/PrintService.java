...
public abstract class PrintService extends Service {
  ...
  public final List<PrintJob> getActivePrintJobs() {
    ...
    try {
      ...
      Log.m97e(LOG_TAG, "Error calling getPrintJobs()", re);
    }
    return Collections.emptyList();
  }
    ...
    public void handleMessage(Message message) {
      ...
      switch (action) {
        ...
        case 9:
          ...
          printService.onPrintJobQueued(
              new PrintJob(printService, printJobInfo, printService.mClient));
          return;
        case 10:
          PrintJobInfo printJobInfo2 = (PrintJobInfo) message.obj;
          PrintService printService2 = PrintService.this;
          printService2.onRequestCancelPrintJob(
              new PrintJob(printService2, printJobInfo2, printService2.mClient));
          return;
        case 11:
