...
public final class PrintJob {
    ...
    public PrintJobInfo getInfo() {
        ...
        try {
            ...
            Log.m97e(LOG_TAG, "Couldn't get info for job: " + this.mCachedInfo.getId(), re);
        }
        if (info != null) {
    ...
    public void setProgress(float progress) {
        ...
        try {
            ...
            Log.m97e(LOG_TAG, "Error setting progress for job: " + this.mCachedInfo.getId(), re);
        }
    }
    ...
    public void setStatus(CharSequence status) {
        ...
        try {
            ...
            Log.m97e(LOG_TAG, "Error setting status for job: " + this.mCachedInfo.getId(), re);
        }
    }
    ...
    public boolean setTag(String tag) {
        ...
        try {
            ...
            Log.m97e(LOG_TAG, "Error setting tag for job: " + this.mCachedInfo.getId(), re);
            return false;
        }
    }
    ...
    private boolean setState(int state, String error) {
        try {
            ...
            Log.m97e(LOG_TAG, "Error setting the state of job: " + this.mCachedInfo.getId(), re);
            return false;
        }
    }
}
