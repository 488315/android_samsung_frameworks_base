  ...
  */
  public static PrintServiceInfo create(Context context, ResolveInfo resolveInfo) {
    ...
    XmlResourceParser parser =
        resolveInfo.serviceInfo.loadXmlMetaData(packageManager, PrintService.SERVICE_META_DATA);
    if (parser != null) {
          ...
          try {
            try {
              try {
                ...
                Log.m96e(
                    LOG_TAG,
                    "Unable to load resources for: " + resolveInfo.serviceInfo.packageName);
                if (parser != null) {}
              }
            } catch (IOException ioe) {
              Log.m102w(LOG_TAG, "Error reading meta-data:" + ioe);
            }
          } catch (XmlPullParserException xppe) {
            Log.m102w(LOG_TAG, "Error reading meta-data:" + xppe);
            if (parser != null) {}
          }
        } finally {
          if (parser != null) {
      ...
      if (TAG_PRINT_SERVICE.equals(nodeName)) {
        ...
        TypedArray attributes =
            resources.obtainAttributes(allAttributes, C4337R.styleable.PrintService);
        ...
        Log.m96e(LOG_TAG, "Ignoring meta-data that does not start with print-service tag");
      }
    }
    return new PrintServiceInfo(
        resolveInfo,
  ...
  public String toString() {
    ...
    builder
        .append(", advancedPrintOptionsActivityName=")
