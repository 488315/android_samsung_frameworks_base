    ...
    public static PrintServiceInfo create(Context context, ResolveInfo resolveInfo) {
        ...
        if (parser != null) {
                    ...
                    try {
                        try {
                            try {
                                ...
                                Log.m96e(LOG_TAG, "Unable to load resources for: " + resolveInfo.serviceInfo.packageName);
                                if (parser != null) {
                                }
                            }
            ...
            if (TAG_PRINT_SERVICE.equals(nodeName)) {
                ...
                TypedArray attributes = resources.obtainAttributes(allAttributes, C4337R.styleable.PrintService);
