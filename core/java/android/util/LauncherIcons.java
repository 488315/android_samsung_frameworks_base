...
public final class LauncherIcons {
    ...
    public Drawable getBadgedDrawable(Drawable base, Drawable badgeForeground, int backgroundColor) {
        ...
        Drawable badgeShadow = overlayableRes.getDrawable(C4337R.drawable.ic_corp_icon_badge_shadow);
        Drawable badgeColor = overlayableRes.getDrawable(C4337R.drawable.ic_corp_icon_badge_color).getConstantState().newDrawable().mutate();
