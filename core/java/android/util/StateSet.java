...
public class StateSet {
    ...
    static {
        int[] iArr = {16842909, 1, 16842913, 2, 16842908, 4, 16842910, 8, 16842919, 16, 16843518, 32, 16843547, 64, 16843623, 128, 16843624, 256, 16843625, 512, C4337R.attr.zzz_state_spen_hovered, 1024};
        VIEW_STATE_IDS = iArr;
        if (iArr.length / 2 != C4337R.styleable.ViewDrawableStates.length) {
            throw new IllegalStateException("VIEW_STATE_IDs array length does not match ViewDrawableStates style array");
        }
        int[] orderedIds = new int[iArr.length];
        for (int i = 0; i < C4337R.styleable.ViewDrawableStates.length; i++) {
            int viewState = C4337R.styleable.ViewDrawableStates[i];
            int j = 0;
            while (true) {
