...
public class DexObserver {
                ...
                try {
                    try {
                        ...
                        if (mVIDPID == null || mUsbType == null) {
                            ...
                            Slog.m147d(TAG, "checkDexStatebySysfs() USBPD_IDS[" + mVIDPID + "], USBPD_TYPE[" + mUsbType + NavigationBarInflaterView.SIZE_MOD_END);
                        }
    ...
    private void onUpdateDexMode() {
        ...
        synchronized (this.mDexStateLock) {
            Slog.m147d(TAG, "setDexMode() : mDexMode " + this.mDexMode + " mSemiDexMode " + this.mSemiDexMode);
