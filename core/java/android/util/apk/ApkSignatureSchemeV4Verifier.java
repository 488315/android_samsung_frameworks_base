...
public class ApkSignatureSchemeV4Verifier {
  ...
  private static V4Signature.SigningInfo findSigningInfoForBlockId(
      V4Signature.SigningInfos signingInfos, int v3BlockId) throws SignatureNotFoundException {
  ...
  private static Pair<Certificate, byte[]> verifySigner(
    ...
    Pair<String, ? extends AlgorithmParameterSpec> signatureAlgorithmParams =
        ApkSigningBlockUtils.getSignatureAlgorithmJcaSignatureAlgorithm(signatureAlgorithmId);
