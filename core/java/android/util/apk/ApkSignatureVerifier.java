...
public class ApkSignatureVerifier {
  ...
  private static ParseResult<SigningDetails> verifySignatures(
      ParseInput input, String apkPath, int minSignatureSchemeVersion, boolean verifyFull) {
    ParseResult<SigningDetailsWithDigests> result =
  ...
  private static ParseResult<SigningDetailsWithDigests> verifyV3AndBelowSignatures(
    ...
    try {
      ...
      try {
        ...
        if (minSignatureSchemeVersion >= 2) {
          return input.error(
              -103, "No APK Signature Scheme v2 signature in package " + apkPath, e2);
        }
  ...
  private static ParseResult<SigningDetailsWithDigests> verifyV4Signature(
      ParseInput input, String apkPath, int minSignatureSchemeVersion, boolean verifyFull)
    ...
    try {
      try {
        try {
          Pair<V4Signature.HashingInfo, V4Signature.SigningInfos> v4Pair =
            ...
            try {
              ...
              try {
                ...
                throw new SecurityException(
                    "V4 verification failed to collect V2/V3 certificates from : " + apkPath, ee);
              }
            }
          }
          ApkSignatureSchemeV4Verifier.VerifiedSigner vSigner =
              ApkSignatureSchemeV4Verifier.verify(apkPath, hashingInfo, signingInfos, v3BlockId);
          ...
          if (verifyFull) {
            ...
            while (true) {
              ...
              if (ArrayUtils.equals(
                  vSigner.apkDigest, nonstreamingDigest, vSigner.apkDigest.length)) {
                found = true;
                break;
              }
              found = found2;
          ...
          ParseResult<SigningDetailsWithDigests> success =
              input.success(
                  new SigningDetailsWithDigests(
                      new SigningDetails(signerSigs, 4, pastSignerSigs), vSigner.contentDigests));
        ...
        ParseResult<SigningDetailsWithDigests> error =
            input.error(
                -103,
                "Failed to collect certificates from " + apkPath + " using APK Signature Scheme v4",
                e3);
        Trace.traceEnd(262144L);
        return error;
      }
  ...
  private static ParseResult<SigningDetailsWithDigests> verifyV3Signature(
      ParseInput input, String apkPath, boolean verifyFull) throws SignatureNotFoundException {
    ...
    try {
      try {
        ...
        ParseResult<SigningDetailsWithDigests> success =
            input.success(
                new SigningDetailsWithDigests(
                    new SigningDetails(signerSigs, 3, pastSignerSigs), vSigner.contentDigests));
        Trace.traceEnd(262144L);
        return success;
      } catch (SignatureNotFoundException e) {
        throw e;
        ...
        ParseResult<SigningDetailsWithDigests> error =
            input.error(
                -103,
                "Failed to collect certificates from " + apkPath + " using APK Signature Scheme v3",
                e2);
        Trace.traceEnd(262144L);
        return error;
      }
  ...
  private static ParseResult<SigningDetailsWithDigests> verifyV2Signature(
      ParseInput input, String apkPath, boolean verifyFull) throws SignatureNotFoundException {
    ...
    try {
      try {
        ...
        ParseResult<SigningDetailsWithDigests> success =
            input.success(
                new SigningDetailsWithDigests(
                    new SigningDetails(signerSigs, 2), vSigner.contentDigests));
        Trace.traceEnd(262144L);
        return success;
      } catch (SignatureNotFoundException e) {
        throw e;
        ...
        ParseResult<SigningDetailsWithDigests> error =
            input.error(
                -103,
                "Failed to collect certificates from " + apkPath + " using APK Signature Scheme v2",
                e2);
        Trace.traceEnd(262144L);
        return error;
      }
  ...
  private static ParseResult<SigningDetailsWithDigests> verifyV1Signature(
    ...
    try {
      ...
      if (manifestEntry == null) {
        ParseResult<SigningDetailsWithDigests> error =
            input.error(-101, "Package " + apkPath + " has no manifest");
        Trace.traceEnd(262144L);
      ...
      if (ArrayUtils.isEmpty(lastCerts)) {
        ParseResult<SigningDetailsWithDigests> error3 =
            input.error(
                -103, "Package " + apkPath + " has no certificates at entry AndroidManifest.xml");
        Trace.traceEnd(262144L);
        closeQuietly(jarFile);
        return error3;
      }
      ...
      if (verifyFull) {
        ...
        while (it.hasNext()) {
          ...
          if (ArrayUtils.isEmpty(entryCerts)) {
            return input.error(
                -103, "Package " + apkPath + " has no certificates at entry " + entry2.getName());
          }
          ...
          if (!Signature.areExactMatch(lastSigs, entrySigs)) {
            return input.error(
                -104,
                "Package " + apkPath + " has mismatched certificates at entry " + entry2.getName());
          }
          it = it2;
        }
      }
  ...
  private static ParseResult<Certificate[][]> loadCertificates(
