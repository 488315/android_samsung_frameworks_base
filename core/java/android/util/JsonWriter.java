...
public final class JsonWriter implements Closeable {
  ...
  public JsonWriter endArray() throws IOException {
    return close(
        JsonScope.EMPTY_ARRAY, JsonScope.NONEMPTY_ARRAY, NavigationBarInflaterView.SIZE_MOD_END);
  }
  ...
  private void beforeValue(boolean root) throws IOException {
    switch (C35991.$SwitchMap$android$util$JsonScope[peek().ordinal()]) {
      case 1:
