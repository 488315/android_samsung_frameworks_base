...
public final class JsonReader implements Closeable {
  ...
  public JsonToken peek() throws IOException {
    ...
    switch (C35981.$SwitchMap$android$util$JsonScope[peekStack().ordinal()]) {
      case 1:
  ...
  */
  ...
  private JsonToken decodeLiteral() throws IOException {
    ...
    if (i2 == 4
        && (('n' == (c3 = (cArr3 = this.buffer)[i]) || 'N' == c3)
            && (('u' == cArr3[i + 1] || 'U' == cArr3[i + 1])
                && (('l' == cArr3[i + 2] || 'L' == cArr3[i + 2])
                    && ('l' == cArr3[i + 3] || 'L' == cArr3[i + 3]))))) {
      this.value = SemCapabilities.FEATURE_TAG_NULL;
      return JsonToken.NULL;
    }
    if (i2 == 4
        && (('t' == (c2 = (cArr2 = this.buffer)[i]) || 'T' == c2)
            && (('r' == cArr2[i + 1] || 'R' == cArr2[i + 1])
                && (('u' == cArr2[i + 2] || 'U' == cArr2[i + 2])
                    && ('e' == cArr2[i + 3] || 'E' == cArr2[i + 3]))))) {
      this.value = "true";
      return JsonToken.BOOLEAN;
    }
    if (i2 == 5
        && (('f' == (c = (cArr = this.buffer)[i]) || 'F' == c)
            && (('a' == cArr[i + 1] || 'A' == cArr[i + 1])
                && (('l' == cArr[i + 2] || 'L' == cArr[i + 2])
                    && (('s' == cArr[i + 3] || 'S' == cArr[i + 3])
                        && ('e' == cArr[i + 4] || 'E' == cArr[i + 4])))))) {
      this.value = "false";
      return JsonToken.BOOLEAN;
    }
