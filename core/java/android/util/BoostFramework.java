...
public class BoostFramework {
  ...
  public BoostFramework() {
    ...
    try {
      ...
      Log.m96e(TAG, "BoostFramework() : Exception_2 = " + e);
    }
  }
  ...
  public BoostFramework(Context context, boolean isTrusted) {
    ...
    try {
      ...
      Log.m96e(TAG, "BoostFramework() : Exception_3 = " + e);
    }
  }
  ...
  public BoostFramework(boolean isUntrustedDomain) {
    ...
    try {
      ...
      Log.m96e(TAG, "BoostFramework() : Exception_5 = " + e);
    }
  }
      ...
      if (!sIsLoaded) {
        try {
          ...
          try {
            ...
            Log.m98i(TAG, "BoostFramework() : Exception_1 = perfGetHalVer not supported");
          ...
          try {
            ...
            Log.m98i(TAG, "BoostFramework() : Exception_4 = PreferredApps not supported");
          }
          sIsLoaded = true;
        } catch (Exception e3) {
          Log.m96e(TAG, "BoostFramework() : Exception_1 = " + e3);
        }
        try {
          ...
          Log.m96e(TAG, "BoostFramework() Ux Perf: Exception = " + e4);
        }
      }
    }
  }
  ...
  public int perfGetFeedbackExtn(int req, String pkg_name, int numArgs, int... list) {
    try {
      ...
      Object retVal =
          method.invoke(this.mPerf, Integer.valueOf(req), pkg_name, Integer.valueOf(numArgs), list);
      int ret = ((Integer) retVal).intValue();
      return ret;
    } catch (Exception e) {
      Log.m96e(TAG, "Exception " + e);
  ...
  public int perfIOPrefetchStart(int pid, String pkgName, String codePath) {
    ...
    try {
      ...
      Log.m96e(TAG, "Ux Perf Exception " + e2);
      return ret;
    }
  }
  ...
  public void perfEvent(int eventId, String pkg_name, int numArgs, int... list) {
    try {
      ...
      if (method != null) {
        method.invoke(
            this.mPerf, Integer.valueOf(eventId), pkg_name, Integer.valueOf(numArgs), list);
      }
    } catch (Exception e) {
      Log.m96e(TAG, "Exception " + e);
    }
  ...
  public int perfHintAcqRel(
      int handle, int hint, String pkg_name, int duration, int hintType, int numArgs, int... list) {
    try {
  ...
  public static class ScrollOptimizer {
    ...
    public static void initQXPerfFuncs() {
      ...
      try {
        ...
        Log.m96e(BoostFramework.TAG, "initQXPerfFuncs failed");
        e.printStackTrace();
      }
    }
    ...
    public static void setFrameInterval(final long frameIntervalNanos) {
      ...
      Thread initThread =
          new Thread(
              new Runnable() { // from class: android.util.BoostFramework.ScrollOptimizer.1
                ...
                public void run() {
                  try {
                    ...
                    Log.m96e(BoostFramework.TAG, "Failed to run initThread.");
                    e2.printStackTrace();
                  }
                }
              });
