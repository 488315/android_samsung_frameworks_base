...
public class IconDrawableFactory {
  ...
  public Drawable getBadgedIcon(
    ...
    if (appInfo.isInstantApp()) {
      int badgeColor = Resources.getSystem().getColor(C4337R.color.instant_app_badge, null);
      Drawable badge = this.mContext.getDrawable(C4337R.drawable.ic_instant_icon_badge_bolt);
                  ...
                  new Supplier() { // from class:
                    ...
                    public final Object get() {
                      ...
                      lambda$getBadgedIcon$0 =
                          IconDrawableFactory.this.lambda$getBadgedIcon$0(userId);
