...
public class WallpaperBackupHelper extends FileBackupHelperBase implements BackupHelper {
  ...
  public void restoreEntity(BackupDataInputStream data) {
    if (this.mWpm == null) {
      Slog.m121w(TAG, "restoreEntity(): no wallpaper service");
      return;
    }
      ...
      try {
        if (writeFile(stage, data)) {
          try {
            ...
            Slog.m115e(TAG, "Unable to set restored wallpaper: " + e.getMessage());
          }
        } else {
          Slog.m115e(TAG, "Unable to save restored wallpaper");
        }
      } finally {
        stage.delete();
      }
