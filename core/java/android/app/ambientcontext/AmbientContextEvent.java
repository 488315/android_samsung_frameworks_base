...
public final class AmbientContextEvent implements Parcelable {
  ...
  AmbientContextEvent(
    ...
    AnnotationValidations.validate(
        (Class<? extends Annotation>) EventCode.class, (Annotation) null, eventType);
    this.mStartTime = startTime;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) startTime);
    this.mEndTime = endTime;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) endTime);
    this.mConfidenceLevel = confidenceLevel;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) LevelValue.class, (Annotation) null, confidenceLevel);
    this.mDensityLevel = densityLevel;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) LevelValue.class, (Annotation) null, densityLevel);
    this.mVendorData = vendorData;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) vendorData);
  }
  ...
  public String toString() {
    return "AmbientContextEvent { eventType = "
        + this.mEventType
        + ", startTime = "
        + this.mStartTime
        + ", endTime = "
  ...
  static {
    ...
    CREATOR =
        new Parcelable.Creator<
            AmbientContextEvent>() { // from class: android.app.ambientcontext.AmbientContextEvent.1
  ...
  public static final class Builder {
    ...
    public AmbientContextEvent build() {
      ...
      AmbientContextEvent o =
          new AmbientContextEvent(
              this.mEventType,
              this.mStartTime,
              this.mEndTime,
              this.mConfidenceLevel,
