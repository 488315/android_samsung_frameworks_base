          ...
          switch (msg.what) {
            case 1:
              ...
              int newlyUnlockedInt =
                  data != null ? data.getInt(TrustManager.DATA_NEWLY_UNLOCKED) : 0;
              ...
              ((TrustListener) msg.obj)
                  .onTrustChanged(
                      ...
                      msg.arg2,
                      flags,
                      msg.getData().getStringArrayList(TrustManager.DATA_GRANTED_MESSAGES));
              break;
            case 2:
          ...
          new ITrustListener.Stub() { // from class: android.app.trust.TrustManager.1
            ...
            public void onTrustChanged(boolean z, boolean z2, int i, int i2, List<String> list) {
              Message obtainMessage =
                  TrustManager.this.mHandler.obtainMessage(1, z ? 1 : 0, i, trustListener);
              if (i2 != 0) {
              ...
              obtainMessage
                  .getData()
                  .putCharSequenceArrayList(TrustManager.DATA_GRANTED_MESSAGES, (ArrayList) list);
