...
public final class RuntimeAppOpAccessMessage implements Parcelable {
  public static final Parcelable.Creator<RuntimeAppOpAccessMessage> CREATOR =
      new Parcelable.Creator<
          RuntimeAppOpAccessMessage>() { // from class: android.app.RuntimeAppOpAccessMessage.1
  ...
  public RuntimeAppOpAccessMessage(
    ...
    this.mOpCode = opCode;
    AnnotationValidations.validate(
        (Class<IntRange>) IntRange.class, (IntRange) null, opCode, "from", 0L, "to", 135L);
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) message);
    this.mSamplingStrategy = samplingStrategy;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) AppOpsManager.SamplingStrategy.class,
        (Annotation) null,
        samplingStrategy);
  }
