...
public class LaunchActivityItem extends ClientTransactionItem {
  public static final Parcelable.Creator<LaunchActivityItem> CREATOR =
      new Parcelable.Creator<
          LaunchActivityItem>() { // from class: android.app.servertransaction.LaunchActivityItem.1
  ...
  public void recycle() {
    setValues(
        this, null, 0, null, null, null, 0, null, null, 0, null, null, null, null, null, false,
  ...
  public boolean equals(Object o) {
    ...
    if ((intent == null && other.mIntent == null)
        || (intent != null && intent.filterEquals(other.mIntent))) {
      intentsEqual = true;
    } else {
      intentsEqual = false;
    }
  ...
  public int hashCode() {
    return (((((((((((((((((((((((((((((((((17 * 31) + this.mIntent.filterHashCode()) * 31)
                                                                                                                                + this
                                                                                                                                    .mIdent)
                                                                                                                            * 31)
                                                                                                                        + Objects
                                                    ...
                                                    * 31)
                                                + (this.mActivityOptions != null ? 1 : 0))
                                            * 31)
                                        + (this.mIsForward ? 1 : 0))
                                    * 31)
                                + Objects.hashCode(this.mProfilerInfo))
                            * 31)
                        + Objects.hashCode(this.mAssistToken))
                    * 31)
                + Objects.hashCode(this.mShareableActivityToken))
            * 31)
  ...
  private boolean activityInfoEqual(ActivityInfo other) {
    ...
    return activityInfo == null
        ? other == null
        : other != null
            && activityInfo.flags == other.flags
  ...
  public String toString() {
    return "LaunchActivityItem{intent="
        + this.mIntent
        + ",ident="
        + this.mIdent
        + ",info="
