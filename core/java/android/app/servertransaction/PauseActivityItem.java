...
public class PauseActivityItem extends ActivityLifecycleItem {
  public static final Parcelable.Creator<PauseActivityItem> CREATOR =
      new Parcelable.Creator<
          PauseActivityItem>() { // from class: android.app.servertransaction.PauseActivityItem.1
  ...
  public boolean equals(Object o) {
    ...
    if (this.mFinished == other.mFinished
  ...
  public int hashCode() {
    return (((((((((17 * 31) + (this.mFinished ? 1 : 0)) * 31) + (this.mUserLeaving ? 1 : 0)) * 31)
                        + this.mConfigChanges)
                    * 31)
  ...
  public String toString() {
    return "PauseActivityItem{finished="
        + this.mFinished
        + ",userLeaving="
        + this.mUserLeaving
        + ",configChanges="
