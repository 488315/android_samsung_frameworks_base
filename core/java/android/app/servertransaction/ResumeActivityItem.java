...
public class ResumeActivityItem extends ActivityLifecycleItem {
  public static final Parcelable.Creator<ResumeActivityItem> CREATOR =
      new Parcelable.Creator<
          ResumeActivityItem>() { // from class: android.app.servertransaction.ResumeActivityItem.1
  ...
  public static ResumeActivityItem obtain(
      int procState, boolean isForward, boolean shouldSendCompatFakeFocus) {
  ...
  public boolean equals(Object o) {
    ...
    if (this.mProcState == other.mProcState
  ...
  public int hashCode() {
    return (((((((17 * 31) + this.mProcState) * 31) + (this.mUpdateProcState ? 1 : 0)) * 31)
                + (this.mIsForward ? 1 : 0))
            * 31)
  ...
  public String toString() {
    return "ResumeActivityItem{procState="
        + this.mProcState
        + ",updateProcState="
