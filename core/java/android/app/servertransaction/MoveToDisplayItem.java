...
public class MoveToDisplayItem extends ActivityTransactionItem {
  public static final Parcelable.Creator<MoveToDisplayItem> CREATOR =
      new Parcelable.Creator<
          MoveToDisplayItem>() { // from class: android.app.servertransaction.MoveToDisplayItem.1
  ...
  public boolean equals(Object o) {
    ...
    if (this.mTargetDisplayId == other.mTargetDisplayId
  ...
  public String toString() {
    return "MoveToDisplayItem{targetDisplayId="
