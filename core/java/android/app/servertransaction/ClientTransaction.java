...
public class ClientTransaction implements Parcelable, ObjectPoolItem {
  public static final Parcelable.Creator<ClientTransaction> CREATOR =
      new Parcelable.Creator<
          ClientTransaction>() { // from class: android.app.servertransaction.ClientTransaction.1
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(this.mActivityCallbacks, other.mActivityCallbacks)
        && Objects.equals(this.mLifecycleStateRequest, other.mLifecycleStateRequest)
        && this.mClient == other.mClient
        && this.mActivityToken == other.mActivityToken) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    return (((((result * 31) + Objects.hashCode(this.mLifecycleStateRequest)) * 31)
    ...
    if (size > 0) {
      ...
      for (int i = 0; i < size; i++) {
        pw.append((CharSequence) prefix)
            .append("    ")
            .println(this.mActivityCallbacks.get(i).toString());
      }
