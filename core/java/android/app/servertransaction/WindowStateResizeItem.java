...
public class WindowStateResizeItem extends WindowStateTransactionItem {
    ...
    public static WindowStateResizeItem obtain(
            IWindow window,
        ...
        WindowStateResizeItem instance =
                (WindowStateResizeItem) ObjectPool.obtain(WindowStateResizeItem.class);
        if (instance == null) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.mFrames, other.mFrames)
                && this.mReportDraw == other.mReportDraw
                && Objects.equals(this.mConfiguration, other.mConfiguration)
                && Objects.equals(this.mInsetsState, other.mInsetsState)
                && this.mForceLayout == other.mForceLayout
                && this.mAlwaysConsumeSystemBars == other.mAlwaysConsumeSystemBars
                && this.mDisplayId == other.mDisplayId
                && this.mSyncSeqId == other.mSyncSeqId
    ...
    @Override // android.app.servertransaction.WindowStateTransactionItem
    public int hashCode() {
        return (((((((((((((((((((((17 * 31) + super.hashCode()) * 31)
                                                                                                                                                                + Objects
                                                                                                                                                                        .hashCode(
                                                                                                                                                                                this
                                                                                                                                                                                        .mFrames))
