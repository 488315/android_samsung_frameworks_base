...
public class TransactionExecutorHelper {
    ...
    switch (postExecutionState) {
      ...
      default:
        throw new UnsupportedOperationException(
            "Pre-execution states for state: " + postExecutionState + " is not supported.");
    }
  }
  ...
  public int getClosestOfStates(ActivityThread.ActivityClientRecord r, int[] finalStates) {
    ...
    if (r == null) {
      Log.m102w(TAG, "ActivityClientRecord was null");
      return -1;
    }
  ...
  static String transactionToString(
    ...
    pw.append((CharSequence) (prefix + "Target activity: "))
