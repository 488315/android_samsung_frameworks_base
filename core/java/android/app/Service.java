...
public abstract class Service extends ContextWrapper
  ...
  public final boolean stopSelfResult(int startId) {
    ...
    try {
      return iActivityManager.stopServiceToken(
          new ComponentName(this, this.mClassName), this.mToken, startId);
    } catch (RemoteException e) {
      return false;
    }
  ...
  public final void setForeground(boolean isForeground) {
    Log.m102w(TAG, "setForeground: ignoring old API call on " + getClass().getName());
  }
  ...
  public final void stopForeground(int notificationBehavior) {
    try {
      this.mActivityManager.setServiceForeground(
          new ComponentName(this, this.mClassName), this.mToken, 0, null, notificationBehavior, 0);
    ...
    synchronized (this.mForegroundServiceTraceTitleLock) {
      ...
      if (str == null) {
        ...
        Trace.asyncTraceForTrackBegin(
            64L, TRACE_TRACK_NAME_FOREGROUND_SERVICE, formatSimple, System.identityHashCode(this));
      } else {
  ...
  public final void callOnTimeout(int startId) {
    if (this.mToken == null) {
      Log.m102w(TAG, "Service already destroyed, skipping onTimeout()");
      return;
    }
    try {
      if (!this.mActivityManager.shouldServiceTimeOut(
          new ComponentName(this, this.mClassName), this.mToken)) {
        Log.m102w(TAG, "Service no longer relevant, skipping onTimeout()");
        return;
      }
    } catch (RemoteException e) {
    }
