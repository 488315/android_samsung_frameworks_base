...
public class DevicePolicyManager {
    ...
    public static final String PROPERTY_NON_REQUIRED_APPS_TASK =
            "persist.sys.knox.non_required_apps_task";
    ...
    @SystemApi public static final int STATUS_HEADLESS_ONLY_SYSTEM_USER = 17;
    ...
    protected DevicePolicyManager(
        ...
        this.mGetKeyGuardDisabledFeaturesCache =
                new IpcDataCache<>(
                        sDpmCaches.child("getKeyguardDisabledFeatures"),
                        new IpcDataCache.RemoteCall() { // from class:
        ...
        this.mHasDeviceOwnerCache =
                new IpcDataCache<>(
                        sDpmCaches.child("hasDeviceOwner"),
                        new IpcDataCache.RemoteCall() { // from class:
        ...
        this.mGetProfileOwnerOrDeviceOwnerSupervisionComponentCache =
                new IpcDataCache<>(
                        sDpmCaches.child("getProfileOwnerOrDeviceOwnerSupervisionComponent"),
                        new IpcDataCache.RemoteCall() { // from class:
                            ...
                            public final Object apply(Object obj) {
                                ...
                                lambda$new$4 =
                                        DevicePolicyManager.this.lambda$new$4((UserHandle) obj);
                                return lambda$new$4;
                            }
                        });
        this.mIsOrganizationOwnedDeviceWithManagedProfileCache =
                new IpcDataCache<>(
                        sDpmCaches.child("isOrganizationOwnedDeviceWithManagedProfile"),
                        new IpcDataCache.RemoteCall() { // from class:
        ...
        this.mGetDeviceOwnerOrganizationNameCache =
                new IpcDataCache<>(
                        sDpmCaches.child("getDeviceOwnerOrganizationName"),
                        new IpcDataCache.RemoteCall() { // from class:
        ...
        this.mGetOrganizationNameForUserCache =
                new IpcDataCache<>(
                        sDpmCaches.child("getOrganizationNameForUser"),
                        new IpcDataCache.RemoteCall() { // from class:
        ...
        this.mIsNetworkLoggingEnabledCache =
                new IpcDataCache<>(
                        sDpmCaches.child("isNetworkLoggingEnabled"),
                        new IpcDataCache.RemoteCall() { // from class:
                            ...
                            public final Object apply(Object obj) {
                                ...
                                lambda$new$10 =
                                        DevicePolicyManager.this.lambda$new$10((ComponentName) obj);
    ...
    public void setContentProtectionPolicy(ComponentName admin, int policy) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setContentProtectionPolicy(
    ...
    public int getContentProtectionPolicy(ComponentName admin) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.getContentProtectionPolicy(
    ...
    public List<ComponentName> getActiveAdmins() {
        throwIfParentInstance(
                SecContentProviderURI.ENTERPRISEDEVICEMANAGERPOLICY_ACTIVEADMINS_METHOD);
    ...
    public int getPasswordMinimumLength(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordMinimumLength(
    ...
    public int getPasswordMinimumUpperCase(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordMinimumUpperCase(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int getPasswordMinimumLowerCase(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordMinimumLowerCase(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int getPasswordMinimumLetters(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordMinimumLetters(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int getPasswordMinimumNumeric(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordMinimumNumeric(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int getPasswordMinimumSymbols(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordMinimumSymbols(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int getPasswordMinimumNonLetter(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordMinimumNonLetter(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void setPasswordExpirationTimeout(ComponentName admin, long timeout) {
        if (this.mService != null) {
            try {
                this.mService.setPasswordExpirationTimeout(
    ...
    public long getPasswordExpirationTimeout(ComponentName admin) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordExpirationTimeout(
    ...
    public int getPasswordHistoryLength(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getPasswordHistoryLength(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void setRequiredPasswordComplexity(int passwordComplexity) {
        ...
        try {
            this.mService.setRequiredPasswordComplexity(
    ...
    public int getRequiredPasswordComplexity() {
        ...
        try {
            return this.mService.getRequiredPasswordComplexity(
    ...
    public boolean isPasswordSufficientAfterProfileUnification(int userHandle, int profileUser) {
        if (this.mService != null) {
            try {
                return this.mService.isPasswordSufficientAfterProfileUnification(
    ...
    public void setMaximumFailedPasswordsForWipe(ComponentName admin, int num) {
        if (this.mService != null) {
            try {
                this.mService.setMaximumFailedPasswordsForWipe(
    ...
    public int getMaximumFailedPasswordsForWipe(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getMaximumFailedPasswordsForWipe(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int getProfileWithMinimumFailedPasswordsForWipe(int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getProfileWithMinimumFailedPasswordsForWipe(
    ...
    public boolean setResetPasswordToken(ComponentName admin, byte[] token) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.setResetPasswordToken(
    ...
    public boolean isResetPasswordTokenActive(ComponentName admin) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.isResetPasswordTokenActive(
                        admin, this.mContext.getPackageName());
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void setMaximumTimeToLock(ComponentName admin, long timeMs) {
        if (this.mService != null) {
            try {
                this.mService.setMaximumTimeToLock(
    ...
    public void setRequiredStrongAuthTimeout(ComponentName admin, long timeoutMs) {
        if (this.mService != null) {
            try {
                this.mService.setRequiredStrongAuthTimeout(
    ...
    public long getRequiredStrongAuthTimeout(ComponentName admin, int userId) {
        if (this.mService != null) {
            try {
                return this.mService.getRequiredStrongAuthTimeout(
    ...
    private void wipeDataInternal(int flags, String wipeReasonForUser, boolean factoryReset) {
        if (this.mService != null) {
            try {
                this.mService.wipeDataWithReason(
    ...
    public void setFactoryResetProtectionPolicy(
        ...
        if (this.mService != null) {
            try {
                this.mService.setFactoryResetProtectionPolicy(
                        admin, this.mContext.getPackageName(), policy);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int getStorageEncryptionStatus(int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getStorageEncryptionStatus(
    ...
    public boolean installCaCert(ComponentName admin, byte[] certBuffer) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.installCaCert(
    ...
    public void uninstallCaCert(ComponentName admin, byte[] certBuffer) {
        ...
        if (this.mService != null) {
            try {
                ...
                this.mService.uninstallCaCerts(
                        admin, this.mContext.getPackageName(), new String[] {alias});
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            ...
            if (certs.length > 1) {
                pemChain =
                        Credentials.convertToPem(
                                (Certificate[]) Arrays.copyOfRange(certs, 1, certs.length));
            }
            try {
                byte[] pkcs8Key =
                        ((PKCS8EncodedKeySpec)
            ...
            switch (e3.errorCode) {
                ...
                default:
                    throw new RuntimeException(
                            String.format(
                                    "Unknown error while generating key: %d",
                                    Integer.valueOf(e3.errorCode)));
            }
    ...
    public boolean revokeKeyPairFromWifiAuth(String alias) {
        ...
        try {
            return this.mService.setKeyGrantToWifiAuth(
                    this.mContext.getPackageName(), alias, false);
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
            return false;
        }
    ...
    private static String getCaCertAlias(byte[] certBuffer) throws CertificateException {
        ...
        X509Certificate cert =
                (X509Certificate)
                        certFactory.generateCertificate(new ByteArrayInputStream(certBuffer));
    ...
    public void setAlwaysOnVpnPackage(
            ComponentName admin, String vpnPackage, boolean lockdownEnabled)
    ...
    public void setAlwaysOnVpnPackage(
        ...
        if (this.mService != null) {
            try {
                this.mService.setAlwaysOnVpnPackage(
                        admin,
                        vpnPackage,
                        lockdownEnabled,
    ...
    public void setCameraDisabled(ComponentName admin, boolean disabled) {
        if (this.mService != null) {
            try {
                this.mService.setCameraDisabled(
    ...
    public boolean getCameraDisabled(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getCameraDisabled(
    ...
    public void setScreenCaptureDisabled(ComponentName admin, boolean disabled) {
        if (this.mService != null) {
            try {
                this.mService.setScreenCaptureDisabled(
                        admin, this.mContext.getPackageName(), disabled, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public boolean getScreenCaptureDisabled(ComponentName admin, int userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getScreenCaptureDisabled(
                        admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void setAutoTimeZoneEnabled(ComponentName admin, boolean enabled) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setAutoTimeZoneEnabled(
    ...
    public void setKeyguardDisabledFeatures(ComponentName admin, int which) {
        if (this.mService != null) {
            try {
                this.mService.setKeyguardDisabledFeatures(
    ...
    public void reportFailedPasswordAttemptWithFailureCount(int userHandle, int count) {
        if (this.mService != null) {
            try {
                this.mService.reportFailedPasswordAttemptWithFailureCount(
                        userHandle, count, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public String[] setPackagesSuspended(
        ...
        if (this.mService != null) {
            try {
                return this.mService.setPackagesSuspended(
    ...
    public boolean isPackageSuspended(ComponentName admin, String packageName)
        ...
        if (this.mService != null) {
            try {
                return this.mService.isPackageSuspended(
    ...
    public boolean isOrganizationOwnedDeviceWithManagedProfile() {
        ...
        if (this.mService != null) {
            return this.mIsOrganizationOwnedDeviceWithManagedProfileCache
                    .query(null)
                    .booleanValue();
        }
        return false;
    ...
    public void addPersistentPreferredActivity(
        ...
        if (this.mService != null) {
            try {
                this.mService.addPersistentPreferredActivity(
    ...
    public void clearPackagePersistentPreferredActivities(ComponentName admin, String packageName) {
        ...
        if (this.mService != null) {
            try {
                this.mService.clearPackagePersistentPreferredActivities(
                        admin, this.mContext.getPackageName(), packageName);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void setDefaultSmsApplication(ComponentName admin, String packageName) {
        if (this.mService != null) {
            try {
                this.mService.setDefaultSmsApplication(
    ...
    public void setApplicationRestrictions(
            ComponentName admin, String packageName, Bundle settings) {
        if (!android.app.admin.flags.Flags.dmrhSetAppRestrictions()) {
            throwIfParentInstance("setApplicationRestrictions");
        }
        if (this.mService != null) {
            try {
                this.mService.setApplicationRestrictions(
                        admin,
                        this.mContext.getPackageName(),
                        packageName,
                        settings,
    ...
    public void setTrustAgentConfiguration(
        ...
        if (this.mService != null) {
            try {
                this.mService.setTrustAgentConfiguration(
                        admin,
                        this.mContext.getPackageName(),
                        target,
                        configuration,
    ...
    public List<PersistableBundle> getTrustAgentConfiguration(
        ...
        if (this.mService != null) {
            try {
                return this.mService.getTrustAgentConfiguration(
    ...
    public boolean getCrossProfileCallerIdDisabled(UserHandle userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getCrossProfileCallerIdDisabledForUser(
    ...
    public boolean hasManagedProfileCallerIdAccess(UserHandle userHandle, String packageName) {
        ...
        try {
            return this.mService.hasManagedProfileCallerIdAccess(
    ...
    public boolean hasManagedProfileContactsAccess(UserHandle userHandle, String packageName) {
        if (this.mService != null) {
            try {
                return this.mService.hasManagedProfileContactsAccess(
                        userHandle.getIdentifier(), packageName);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public boolean getCrossProfileContactsSearchDisabled(UserHandle userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getCrossProfileContactsSearchDisabledForUser(
                        userHandle.getIdentifier());
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void startManagedQuickContact(
        ...
        if (this.mService != null) {
            try {
                this.mService.startManagedQuickContact(
                        actualLookupKey,
                        actualContactId,
                        isContactIdIgnored,
                        directoryId,
    ...
    public boolean getBluetoothContactSharingDisabled(UserHandle userHandle) {
        if (this.mService != null) {
            try {
                return this.mService.getBluetoothContactSharingDisabledForUser(
                        userHandle.getIdentifier());
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void addCrossProfileIntentFilter(ComponentName admin, IntentFilter filter, int flags) {
        ...
        if (this.mService != null) {
            try {
                this.mService.addCrossProfileIntentFilter(
    ...
    public boolean isAccessibilityServicePermittedByAdmin(
        ...
        if (this.mService != null) {
            try {
                return this.mService.isAccessibilityServicePermittedByAdmin(
    ...
    public boolean setPermittedInputMethods(ComponentName admin, List<String> packageNames) {
        if (this.mService != null) {
            try {
                return this.mService.setPermittedInputMethods(
    ...
    public List<String> getPermittedInputMethods(ComponentName admin) {
        if (this.mService != null) {
            try {
                return this.mService.getPermittedInputMethods(
    ...
    public boolean isInputMethodPermittedByAdmin(
        ...
        if (this.mService != null) {
            try {
                return this.mService.isInputMethodPermittedByAdmin(
    ...
    public boolean setPermittedCrossProfileNotificationListeners(
        ...
        if (this.mService != null) {
            try {
                return this.mService.setPermittedCrossProfileNotificationListeners(
                        admin, packageList);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public List<String> getKeepUninstalledPackages(ComponentName admin) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.getKeepUninstalledPackages(
                        admin, this.mContext.getPackageName());
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void setKeepUninstalledPackages(ComponentName admin, List<String> packageNames) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setKeepUninstalledPackages(
    ...
    public Bundle getApplicationRestrictions(ComponentName admin, String packageName) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.getApplicationRestrictions(
                        admin, this.mContext.getPackageName(), packageName, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void addUserRestriction(ComponentName admin, String key) {
        if (this.mService != null) {
            try {
                this.mService.setUserRestriction(
    ...
    public Bundle getUserRestrictions(ComponentName admin) {
        ...
        if (this.mService != null) {
            try {
                ret =
                        this.mService.getUserRestrictions(
                                admin, this.mContext.getPackageName(), this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public Set<EnforcingAdmin> getEnforcingAdminsForRestriction(int userId, String restriction) {
        if (this.mService != null) {
            try {
                return new HashSet(
                        this.mService.getEnforcingAdminsForRestriction(userId, restriction));
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean setApplicationHidden(ComponentName admin, String packageName, boolean hidden) {
        if (this.mService != null) {
            try {
                return this.mService.setApplicationHidden(
                        admin,
                        this.mContext.getPackageName(),
                        packageName,
                        hidden,
    ...
    public boolean isApplicationHidden(ComponentName admin, String packageName) {
        if (this.mService != null) {
            try {
                return this.mService.isApplicationHidden(
                        admin, this.mContext.getPackageName(), packageName, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int enableSystemApp(ComponentName admin, Intent intent) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.enableSystemAppWithIntent(
    ...
    public boolean installExistingPackage(ComponentName admin, String packageName) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.installExistingPackage(
                        admin, this.mContext.getPackageName(), packageName);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public void setAccountManagementDisabled(
        ...
        if (this.mService != null) {
            try {
                this.mService.setAccountManagementDisabled(
                        admin,
                        this.mContext.getPackageName(),
                        accountType,
                        disabled,
    ...
    public String[] getAccountTypesWithManagementDisabledAsUser(
        ...
        if (this.mService != null) {
            try {
                return this.mService.getAccountTypesWithManagementDisabledAsUser(
    ...
    public void setConfiguredNetworksLockdownState(ComponentName admin, boolean lockdown) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setConfiguredNetworksLockdownState(
    ...
    public void setUninstallBlocked(
        ...
        if (this.mService != null) {
            try {
                this.mService.setUninstallBlocked(
    ...
    public boolean addCrossProfileWidgetProvider(ComponentName admin, String packageName) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.addCrossProfileWidgetProvider(
                        admin, this.mContext.getPackageName(), packageName);
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
    ...
    public boolean removeCrossProfileWidgetProvider(ComponentName admin, String packageName) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.removeCrossProfileWidgetProvider(
                        admin, this.mContext.getPackageName(), packageName);
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        ...
        if (this.mService != null) {
            try {
                List<String> providers =
                        this.mService.getCrossProfileWidgetProviders(
                                admin, this.mContext.getPackageName());
                if (providers != null) {
                    return providers;
                }
    ...
    public boolean setStatusBarDisabled(ComponentName admin, boolean disabled) {
        ...
        try {
            return this.mService.setStatusBarDisabled(
                    admin, this.mContext.getPackageName(), disabled);
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public void notifyPendingSystemUpdate(long updateReceivedTime, boolean isSecurityPatch) {
        ...
        if (this.mService != null) {
            try {
                this.mService.notifyPendingSystemUpdate(
                        SystemUpdateInfo.of(updateReceivedTime, isSecurityPatch));
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
    ...
    public void setShortSupportMessage(ComponentName admin, CharSequence message) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setShortSupportMessage(
                        admin, this.mContext.getPackageName(), message);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setAuditLogEventCallback(
            Executor executor, Consumer<List<SecurityLog.SecurityEvent>> callback) {
        ...
        try {
            this.mService.setAuditLogEventsCallback(
                    this.mContext.getPackageName(), wrappedCallback);
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public DevicePolicyManager getParentProfileInstance(UserInfo uInfo) {
        ...
        if (!uInfo.isManagedProfile()) {
            throw new SecurityException(
                    "The user " + uInfo.id + " does not have a parent profile.");
        }
        return new DevicePolicyManager(this.mContext, this.mService, true);
    }
    ...
    public boolean isMeteredDataDisabledPackageForUser(
        ...
        if (this.mService != null) {
            try {
                return this.mService.isMeteredDataDisabledPackageForUser(
                        admin, packageName, userId);
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
    ...
    public List<SecurityLog.SecurityEvent> retrievePreRebootSecurityLogs(ComponentName admin) {
        ...
        try {
            ParceledListSlice<SecurityLog.SecurityEvent> list =
                    this.mService.retrievePreRebootSecurityLogs(
                            admin, this.mContext.getPackageName());
            if (list != null) {
                return list.getList();
            }
    ...
    public List<NetworkEvent> retrieveNetworkLogs(ComponentName admin, long batchToken) {
        ...
        try {
            return this.mService.retrieveNetworkLogs(
                    admin, this.mContext.getPackageName(), batchToken);
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
            ...
            try {
                IServiceConnection sd =
                        this.mContext.getServiceDispatcher(
                                conn,
                                this.mContext.getMainThreadHandler(),
    ...
    public boolean bindDeviceAdminServiceAsUser(
        ...
        try {
            try {
                IServiceConnection sd =
                        this.mContext.getServiceDispatcher(
                                conn, this.mContext.getMainThreadHandler(), flags.getValue());
                try {
                    serviceIntent.prepareToLeaveProcess(this.mContext);
                    return this.mService.bindDeviceAdminServiceAsUser(
                            admin,
    ...
    public void clearApplicationUserData(
        ...
        try {
            this.mService.clearApplicationUserData(
                    admin, packageName, new AnonymousClass2(executor, listener));
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    class AnonymousClass2 extends IPackageDataObserver.Stub {
        ...
        AnonymousClass2(
                Executor executor,
                OnClearApplicationUserDataListener onClearApplicationUserDataListener) {
            this.val$executor = executor;
        ...
        public void onRemoveCompleted(final String pkg, final boolean succeeded) {
            ...
            executor.execute(
                    new Runnable() { // from class:
                        // android.app.admin.DevicePolicyManager$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public Set<String> getDisallowedSystemApps(
        ...
        try {
            return new ArraySet(
                    this.mService.getDisallowedSystemApps(admin, userId, provisioningAction));
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
            ...
            try {
                this.mService.installUpdateFromFile(
                        ...
                        new StartInstallingUpdateCallback
                                .Stub() { // from class: android.app.admin.DevicePolicyManager.3
    ...
    public void setCrossProfileCalendarPackages(ComponentName admin, Set<String> packageNames) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setCrossProfileCalendarPackages(
                        admin, packageNames == null ? null : new ArrayList(packageNames));
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean isPackageAllowedToAccessCalendar(String packageName) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.isPackageAllowedToAccessCalendarForUser(
        ...
        if (this.mService != null) {
            try {
                List<String> packageNames =
                        this.mService.getCrossProfileCalendarPackagesForUser(myUserId());
                if (packageNames == null) {
                    return null;
                }
                return new ArraySet(packageNames);
    ...
    public Set<String> getAllCrossProfilePackages() {
        ...
        if (this.mService != null) {
            try {
                return new ArraySet(
                        this.mService.getAllCrossProfilePackages(this.mContext.getUserId()));
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean startViewCalendarEventInManagedProfile(
        ...
        if (this.mService != null) {
            try {
                return this.mService.startViewCalendarEventInManagedProfile(
    ...
    public void setApplicationExemptions(String packageName, Set<Integer> exemptions)
        ...
        if (this.mService != null) {
            try {
                this.mService.setApplicationExemptions(
                        this.mContext.getPackageName(),
                        packageName,
                ...
                switch (e2.errorCode) {
                    ...
                    default:
                        throw new RuntimeException(
                                "Unknown error setting application exemptions: " + e2.errorCode,
                                e2);
                }
            }
        }
    ...
    public void setUserControlDisabledPackages(ComponentName admin, List<String> packages) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setUserControlDisabledPackages(
    ...
    public List<String> getUserControlDisabledPackages(ComponentName admin) {
        ...
        if (this.mService != null) {
            try {
                return this.mService.getUserControlDisabledPackages(
                        admin, this.mContext.getPackageName());
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
    ...
    public void setCommonCriteriaModeEnabled(ComponentName admin, boolean enabled) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setCommonCriteriaModeEnabled(
                        admin, this.mContext.getPackageName(), enabled);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public UserHandle createAndProvisionManagedProfile(
        ...
        try {
            return this.mService.createAndProvisionManagedProfile(
    ...
    public void provisionFullyManagedDevice(FullyManagedDeviceProvisioningParams provisioningParams)
        ...
        if (this.mService != null) {
            try {
                this.mService.provisionFullyManagedDevice(
                        provisioningParams, this.mContext.getPackageName());
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            } catch (ServiceSpecificException e) {
    ...
    public void setMinimumRequiredWifiSecurityLevel(int level) {
        ...
        if (this.mService != null) {
            try {
                this.mService.setMinimumRequiredWifiSecurityLevel(
    ...
    public String getDevicePolicyManagementRoleHolderUpdaterPackage() {
        String devicePolicyManagementUpdaterConfig =
                this.mContext.getString(R.string.config_devicePolicyManagementUpdater);
    ...
    public String getFinancedDeviceKioskRoleHolder() {
        if (this.mService != null) {
            try {
                return this.mService.getFinancedDeviceKioskRoleHolder(
                        this.mContext.getPackageName());
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public Set<Integer> getSubscriptionIds() {
        ...
        if (this.mService != null) {
            try {
                return intArrayToSet(
                        this.mService.getSubscriptionIds(this.mContext.getPackageName()));
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setMaxPolicyStorageLimit(int storageLimit) {
        if (this.mService != null) {
            try {
                this.mService.setMaxPolicyStorageLimit(
                        this.mContext.getPackageName(), storageLimit);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void forceSetMaxPolicyStorageLimit(int storageLimit) {
        if (this.mService != null) {
            try {
                this.mService.forceSetMaxPolicyStorageLimit(
                        this.mContext.getPackageName(), storageLimit);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    public int getHeadlessDeviceOwnerMode() {
        if (!android.app.admin.flags.Flags.headlessDeviceOwnerProvisioningFixEnabled()
                || this.mService == null) {
            return 0;
        }
        try {
    ...
    public boolean semGetRequireStorageCardEncryption(ComponentName admin, boolean isParent) {
        if (this.mService != null) {
            try {
                return this.mService.semGetRequireStorageCardEncryption(
                        admin, myUserId(), isParent);
            } catch (RemoteException e) {
                Log.w(TAG, "Failed talking with device policy service", e);
                return false;
            }
