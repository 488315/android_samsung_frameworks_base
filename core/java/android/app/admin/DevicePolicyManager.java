...
public class DevicePolicyManager {
  ...
  public static final String ACTION_DEVICE_POLICY_MANAGER_PASSWORD_CHANGED =
      "com.samsung.knox.app.action.DEVICE_POLICY_MANAGER_PASSWORD_CHANGED";
  ...
  @Deprecated public static final int ENCRYPTION_STATUS_ACTIVATING = 2;
  ...
  @SystemApi public static final int EXEMPT_FROM_ACTIVITY_BG_START_RESTRICTION = 2;

  @SystemApi public static final int EXEMPT_FROM_DISMISSIBLE_NOTIFICATIONS = 1;

  @SystemApi public static final int EXEMPT_FROM_HIBERNATION = 3;

  @SystemApi public static final int EXEMPT_FROM_POWER_RESTRICTIONS = 4;

  @SystemApi public static final int EXEMPT_FROM_SUSPENSION = 0;
  ...
  public static final String EXTRA_DO_CHANGED_STATUS =
      "com.samsung.android.knox.intent.extra.EXTRA_DO_CHANGED_STATUS";
  public static final String EXTRA_DO_PO_PACKAGE_NAME =
      "com.samsung.android.knox.intent.extra.EXTRA_DO_PO_PACKAGE_NAME";
  ...
  @SystemApi public static final String EXTRA_RESTRICTION = "android.app.extra.RESTRICTION";
  ...
  @SystemApi public static final int FLAG_SUPPORTED_MODES_DEVICE_OWNER = 4;

  @SystemApi public static final int FLAG_SUPPORTED_MODES_ORGANIZATION_OWNED = 1;

  @SystemApi public static final int FLAG_SUPPORTED_MODES_PERSONALLY_OWNED = 2;
  ...
  @Deprecated public static final int KEYGUARD_DISABLE_REMOTE_INPUT = 64;
  ...
  @SystemApi public static final int PROVISIONING_TRIGGER_CLOUD_ENROLLMENT = 1;

  @SystemApi public static final int PROVISIONING_TRIGGER_MANAGED_ACCOUNT = 4;

  @SystemApi public static final int PROVISIONING_TRIGGER_NFC = 5;

  @SystemApi @Deprecated public static final int PROVISIONING_TRIGGER_PERSISTENT_DEVICE_OWNER = 3;

  @SystemApi public static final int PROVISIONING_TRIGGER_QR_CODE = 2;

  @SystemApi public static final int PROVISIONING_TRIGGER_UNSPECIFIED = 0;
  ...
  @SystemApi public static final int RESULT_DEVICE_OWNER_SET = 123;

  /* renamed from: RESULT_UPDATE_DEVICE_POLICY_MANAGEMENT_ROLE_HOLDER_PROVISIONING_DISABLED */
  @SystemApi public static final int f23x11afbb80 = 3;

  /* renamed from: RESULT_UPDATE_DEVICE_POLICY_MANAGEMENT_ROLE_HOLDER_RECOVERABLE_ERROR */
  @SystemApi public static final int f24x60c7bbf9 = 1;

  /* renamed from: RESULT_UPDATE_DEVICE_POLICY_MANAGEMENT_ROLE_HOLDER_UNRECOVERABLE_ERROR */
  @SystemApi public static final int f25xfc76a200 = 2;

  @SystemApi public static final int RESULT_UPDATE_ROLE_HOLDER = 2;

  @SystemApi public static final int RESULT_WORK_PROFILE_CREATED = 122;
  ...
  public static final int f26xa2719067 = 2;
  ...
  @SystemApi public static final int STATE_USER_PROFILE_COMPLETE = 4;

  @SystemApi public static final int STATE_USER_PROFILE_FINALIZED = 5;

  @SystemApi public static final int STATE_USER_SETUP_COMPLETE = 2;

  @SystemApi public static final int STATE_USER_SETUP_FINALIZED = 3;

  @SystemApi public static final int STATE_USER_SETUP_INCOMPLETE = 1;

  @SystemApi public static final int STATE_USER_UNMANAGED = 0;

  @SystemApi public static final int STATUS_ACCOUNTS_NOT_EMPTY = 6;

  @SystemApi public static final int STATUS_CANNOT_ADD_MANAGED_PROFILE = 11;

  @SystemApi public static final int STATUS_DEVICE_ADMIN_NOT_SUPPORTED = 13;

  @SystemApi public static final int STATUS_HAS_DEVICE_OWNER = 1;

  @SystemApi public static final int STATUS_HAS_PAIRED = 8;

  @SystemApi public static final int STATUS_HEADLESS_SYSTEM_USER_MODE_NOT_SUPPORTED = 16;

  @SystemApi public static final int STATUS_MANAGED_USERS_NOT_SUPPORTED = 9;

  @SystemApi public static final int STATUS_NONSYSTEM_USER_EXISTS = 5;

  @SystemApi public static final int STATUS_NOT_SYSTEM_USER = 7;

  @SystemApi public static final int STATUS_OK = 0;

  @SystemApi public static final int STATUS_PROVISIONING_NOT_ALLOWED_FOR_NON_DEVELOPER_USERS = 15;

  @Deprecated public static final int STATUS_SPLIT_SYSTEM_USER_DEVICE_SYSTEM_USER = 14;

  @SystemApi public static final int STATUS_SYSTEM_USER = 10;

  @SystemApi public static final int STATUS_UNKNOWN_ERROR = -1;

  @SystemApi public static final int STATUS_USER_HAS_PROFILE_OWNER = 2;

  @SystemApi public static final int STATUS_USER_NOT_RUNNING = 3;

  @SystemApi public static final int STATUS_USER_SETUP_COMPLETED = 4;
  ...
  private static final IpcDataCache.Config sDpmCaches =
      new IpcDataCache.Config(8, "system_server", "DevicePolicyManagerCaches");
  ...
  protected DevicePolicyManager(
    ...
    this.mGetKeyGuardDisabledFeaturesCache =
        new IpcDataCache<>(
            config.child("getKeyguardDisabledFeatures"),
            new IpcDataCache
                .RemoteCall() { // from class:
    ...
    this.mHasDeviceOwnerCache =
        new IpcDataCache<>(
            config.child("hasDeviceOwner"),
            new IpcDataCache
                .RemoteCall() { // from class:
    ...
    this.mGetProfileOwnerOrDeviceOwnerSupervisionComponentCache =
        new IpcDataCache<>(
            config.child("getProfileOwnerOrDeviceOwnerSupervisionComponent"),
            new IpcDataCache
                .RemoteCall() { // from class:
    ...
    this.mIsOrganizationOwnedDeviceWithManagedProfileCache =
        new IpcDataCache<>(
            config.child("isOrganizationOwnedDeviceWithManagedProfile"),
            new IpcDataCache
                .RemoteCall() { // from class:
    ...
    this.mGetDeviceOwnerOrganizationNameCache =
        new IpcDataCache<>(
            config.child("getDeviceOwnerOrganizationName"),
            new IpcDataCache
                .RemoteCall() { // from class:
    ...
    this.mGetOrganizationNameForUserCache =
        new IpcDataCache<>(
            config.child("getOrganizationNameForUser"),
            new IpcDataCache
                .RemoteCall() { // from class:
    ...
    this.mIsNetworkLoggingEnabledCache =
        new IpcDataCache<>(
            config.child("isNetworkLoggingEnabled"),
            new IpcDataCache
                .RemoteCall() { // from class:
  ...
  public static String operationSafetyReasonToString(int reason) {
    return DebugUtils.constantToString(
        DevicePolicyManager.class, PREFIX_OPERATION_SAFETY_REASON, reason);
  }
  ...
  public void removeActiveAdmin(ComponentName admin) {
    throwIfParentInstance(
        SecContentProviderURI.ENTERPRISEDEVICEMANAGERPOLICY_REMOVEACTIVEADMIN_METHOD);
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
  ...
  public int getPasswordMinimumLength(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordMinimumLength(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public int getPasswordMinimumUpperCase(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordMinimumUpperCase(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public int getPasswordMinimumLowerCase(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordMinimumLowerCase(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public int getPasswordMinimumLetters(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordMinimumLetters(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public int getPasswordMinimumNumeric(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordMinimumNumeric(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public int getPasswordMinimumSymbols(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordMinimumSymbols(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public int getPasswordMinimumNonLetter(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordMinimumNonLetter(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void setPasswordExpirationTimeout(ComponentName admin, long timeout) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setPasswordExpirationTimeout(
            admin, this.mContext.getPackageName(), timeout, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordExpirationTimeout(
            admin, myUserId(), this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public int getPasswordHistoryLength(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPasswordHistoryLength(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public boolean isActivePasswordSufficient() {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isActivePasswordSufficient(
            this.mContext.getPackageName(), myUserId(), this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void setRequiredPasswordComplexity(int passwordComplexity) {
    ...
    try {
      iDevicePolicyManager.setRequiredPasswordComplexity(
          this.mContext.getPackageName(), passwordComplexity, this.mParentInstance);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public int getRequiredPasswordComplexity() {
    ...
    try {
      return iDevicePolicyManager.getRequiredPasswordComplexity(
          this.mContext.getPackageName(), this.mParentInstance);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public boolean isPasswordSufficientAfterProfileUnification(int userHandle, int profileUser) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isPasswordSufficientAfterProfileUnification(
  ...
  public int getCurrentFailedPasswordAttempts(int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getCurrentFailedPasswordAttempts(
            this.mContext.getPackageName(), userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void setMaximumFailedPasswordsForWipe(ComponentName admin, int num) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setMaximumFailedPasswordsForWipe(
            admin, this.mContext.getPackageName(), num, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public int getMaximumFailedPasswordsForWipe(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getMaximumFailedPasswordsForWipe(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public int getProfileWithMinimumFailedPasswordsForWipe(int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getProfileWithMinimumFailedPasswordsForWipe(
            userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean setResetPasswordToken(ComponentName admin, byte[] token) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.setResetPasswordToken(
            admin, this.mContext.getPackageName(), token);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean isResetPasswordTokenActive(ComponentName admin) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isResetPasswordTokenActive(
            admin, this.mContext.getPackageName());
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean resetPasswordWithToken(
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.resetPasswordWithToken(
            admin, this.mContext.getPackageName(), password, token, flags);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void setMaximumTimeToLock(ComponentName admin, long timeMs) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setMaximumTimeToLock(
            admin, this.mContext.getPackageName(), timeMs, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void setRequiredStrongAuthTimeout(ComponentName admin, long timeoutMs) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setRequiredStrongAuthTimeout(
            admin, this.mContext.getPackageName(), timeoutMs, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public long getRequiredStrongAuthTimeout(ComponentName admin, int userId) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getRequiredStrongAuthTimeout(
            admin, userId, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  private void wipeDataInternal(int flags, String wipeReasonForUser, boolean factoryReset) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.wipeDataWithReason(
            this.mContext.getPackageName(),
            flags,
            wipeReasonForUser,
            this.mParentInstance,
            factoryReset);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void setFactoryResetProtectionPolicy(
      ComponentName admin, FactoryResetProtectionPolicy policy) {
    throwIfParentInstance("setFactoryResetProtectionPolicy");
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setFactoryResetProtectionPolicy(
            admin, this.mContext.getPackageName(), policy);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  private void executeCallback(
      AndroidFuture<Boolean> future, final Executor executor, final Consumer<Boolean> callback) {
    future.whenComplete(
  ...
  static /* synthetic */ void lambda$executeCallback$0(
      Throwable error, Consumer callback, Boolean result) {
  ...
  public ComponentName setGlobalProxy(
      ComponentName admin, Proxy proxySpec, List<String> exclusionList) {
    String hostSpec;
    String hostSpec2;
  ...
  public int getStorageEncryptionStatus(int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getStorageEncryptionStatus(
            this.mContext.getPackageName(), userHandle);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean installCaCert(ComponentName admin, byte[] certBuffer) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.installCaCert(
            admin, this.mContext.getPackageName(), certBuffer);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void uninstallAllUserCaCerts(ComponentName admin) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.uninstallCaCerts(
            admin,
            this.mContext.getPackageName(),
            (String[]) new TrustedCertificateStore().userAliases().toArray(new String[0]));
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
    }
  ...
  public boolean installKeyPair(
      ComponentName admin, PrivateKey privKey, Certificate cert, String alias) {
  ...
  public boolean installKeyPair(
      ComponentName admin, PrivateKey privKey, Certificate[] certs, String alias, int flags) {
    byte[] pemCert;
    byte[] pemChain;
    ...
    try {
      ...
      if (certs.length > 1) {
        pemChain =
            Credentials.convertToPem((Certificate[]) Arrays.copyOfRange(certs, 1, certs.length));
      }
    } catch (RemoteException e) {
      e = e;
    ...
    try {
      byte[] pkcs8Key =
          ((PKCS8EncodedKeySpec)
                  KeyFactory.getInstance(privKey.getAlgorithm())
                      .getKeySpec(privKey, PKCS8EncodedKeySpec.class))
              .getEncoded();
      return this.mService.installKeyPair(
          admin,
          this.mContext.getPackageName(),
          pkcs8Key,
          pemCert,
  ...
  public AttestedKeyPair generateKeyPair(
      ComponentName admin, String algorithm, KeyGenParameterSpec keySpec, int idAttestationFlags) {
    ...
    try {
      ...
      boolean success =
          this.mService.generateKeyPair(
              ...
              attestationChain);
      if (!success) {
        Log.m96e(TAG, "Error generating key via DevicePolicyManagerService.");
        return null;
      }
      ...
      try {
        ...
        Log.m97e(TAG, "Error parsing attestation chain for alias " + alias, e);
      ...
      Log.m102w(TAG, String.format("Key Generation failure: %d", Integer.valueOf(e3.errorCode)));
      switch (e3.errorCode) {
        case 1:
        ...
        default:
          throw new RuntimeException(
              String.format(
                  "Unknown error while generating key: %d", Integer.valueOf(e3.errorCode)));
      }
  ...
  public boolean grantKeyPairToApp(ComponentName admin, String alias, String packageName) {
    ...
    try {
      return this.mService.setKeyGrantForApp(
          admin, this.mContext.getPackageName(), alias, packageName, true);
    } catch (RemoteException e) {
  ...
  public Map<Integer, Set<String>> getKeyPairGrants(String alias) {
    ...
    try {
      return this.mService
          .getKeyPairGrants(this.mContext.getPackageName(), alias)
          .getPackagesByUid();
    } catch (RemoteException e) {
      e.rethrowFromSystemServer();
      return null;
  ...
  public boolean revokeKeyPairFromApp(ComponentName admin, String alias, String packageName) {
    ...
    try {
      return this.mService.setKeyGrantForApp(
          admin, this.mContext.getPackageName(), alias, packageName, false);
    } catch (RemoteException e) {
      e.rethrowFromSystemServer();
      return false;
    }
  ...
  public boolean setKeyPairCertificate(
      ComponentName admin, String alias, List<Certificate> certs, boolean isUserSelectable) {
      ...
      if (certs.size() > 1) {
        pemChain =
            Credentials.convertToPem(
                (Certificate[]) certs.subList(1, certs.size()).toArray(new Certificate[0]));
      }
      return this.mService.setKeyPairCertificate(
          admin, this.mContext.getPackageName(), alias, pemCert, pemChain, isUserSelectable);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    } catch (IOException | CertificateException e2) {
  ...
  private static String getCaCertAlias(byte[] certBuffer) throws CertificateException {
    ...
    X509Certificate cert =
        (X509Certificate) certFactory.generateCertificate(new ByteArrayInputStream(certBuffer));
      ...
      if (lockdownAllowlist == null) {
        ...
        try {
          ...
          switch (e2.errorCode) {
            ...
            default:
              throw new RuntimeException(
                  "Unknown error setting always-on VPN: " + e2.errorCode, e2);
          }
        }
      }
  ...
  public void setCameraDisabled(ComponentName admin, boolean disabled) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setCameraDisabled(
            admin, this.mContext.getPackageName(), disabled, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean getCameraDisabled(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getCameraDisabled(
            admin, this.mContext.getPackageName(), userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void setScreenCaptureDisabled(ComponentName admin, boolean disabled) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setScreenCaptureDisabled(
            admin, this.mContext.getPackageName(), disabled, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public boolean getScreenCaptureDisabled(ComponentName admin, int userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getScreenCaptureDisabled(
            admin, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void setKeyguardDisabledFeatures(ComponentName admin, int which) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setKeyguardDisabledFeatures(
            admin, this.mContext.getPackageName(), which, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
    ...
    return Integer.valueOf(
        getService()
            .getKeyguardDisabledFeatures(
                (ComponentName) query.first,
                ((Integer) query.second).intValue(),
                isParentInstance()));
  }

  public int getKeyguardDisabledFeatures(ComponentName admin, int userHandle) {
    if (this.mService != null) {
      return this.mGetKeyGuardDisabledFeaturesCache
          .query(new Pair<>(admin, Integer.valueOf(userHandle)))
          .intValue();
    }
    return 0;
  }
  ...
  private boolean isDeviceOwnerAppOnAnyUserInner(String packageName, boolean callingUserOnly) {
    ...
    if (packageName == null
        || (deviceOwner = getDeviceOwnerComponentInner(callingUserOnly)) == null) {
      return false;
    }
  ...
  public UserHandle getDeviceOwnerUser() {
    ...
    if (iDevicePolicyManager != null) {
      try {
        ...
        if (userId != -10000) {
          return UserHandle.m55of(userId);
        }
        return null;
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
  ...
  public boolean setProfileOwner(ComponentName admin, int userHandle)
      throws IllegalArgumentException {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
  ...
  public String[] setPackagesSuspended(
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.setPackagesSuspended(
            admin, this.mContext.getPackageName(), packageNames, suspended);
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
    }
  ...
  public boolean isPackageSuspended(ComponentName admin, String packageName)
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isPackageSuspended(
            admin, this.mContext.getPackageName(), packageName);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      } catch (IllegalArgumentException ex) {
        Log.m97e(TAG, "IllegalArgumentException checking isPackageSuspended", ex);
  ...
  public void addPersistentPreferredActivity(
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.addPersistentPreferredActivity(
            admin, this.mContext.getPackageName(), filter, activity);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void clearPackagePersistentPreferredActivities(ComponentName admin, String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.clearPackagePersistentPreferredActivities(
            admin, this.mContext.getPackageName(), packageName);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void setDefaultSmsApplication(ComponentName admin, String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setDefaultSmsApplication(
            admin, this.mContext.getPackageName(), packageName, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean isCallerApplicationRestrictionsManagingPackage() {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isCallerApplicationRestrictionsManagingPackage(
            this.mContext.getPackageName());
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void setApplicationRestrictions(ComponentName admin, String packageName, Bundle settings) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setApplicationRestrictions(
            admin, this.mContext.getPackageName(), packageName, settings);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void setTrustAgentConfiguration(
      ComponentName admin, ComponentName target, PersistableBundle configuration) {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setTrustAgentConfiguration(
            admin, this.mContext.getPackageName(), target, configuration, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public List<PersistableBundle> getTrustAgentConfiguration(
      ComponentName admin, ComponentName agent) {
    return getTrustAgentConfiguration(admin, agent, myUserId());
  }

  public List<PersistableBundle> getTrustAgentConfiguration(
      ComponentName admin, ComponentName agent, int userHandle) {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getTrustAgentConfiguration(
            admin, agent, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean getCrossProfileCallerIdDisabled(UserHandle userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getCrossProfileCallerIdDisabledForUser(
  ...
  public boolean hasManagedProfileCallerIdAccess(UserHandle userHandle, String packageName) {
    ...
    try {
      return iDevicePolicyManager.hasManagedProfileCallerIdAccess(
  ...
  public boolean hasManagedProfileContactsAccess(UserHandle userHandle, String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.hasManagedProfileContactsAccess(
            userHandle.getIdentifier(), packageName);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public boolean getCrossProfileContactsSearchDisabled(UserHandle userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getCrossProfileContactsSearchDisabledForUser(
            userHandle.getIdentifier());
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void startManagedQuickContact(
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.startManagedQuickContact(
            actualLookupKey, actualContactId, isContactIdIgnored, directoryId, originalIntent);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void startManagedQuickContact(
      String actualLookupKey, long actualContactId, Intent originalIntent) {
  ...
  public boolean getBluetoothContactSharingDisabled(UserHandle userHandle) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getBluetoothContactSharingDisabledForUser(
            userHandle.getIdentifier());
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void addCrossProfileIntentFilter(ComponentName admin, IntentFilter filter, int flags) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.addCrossProfileIntentFilter(
            admin, this.mContext.getPackageName(), filter, flags);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean isAccessibilityServicePermittedByAdmin(
      ComponentName admin, String packageName, int userHandle) {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isAccessibilityServicePermittedByAdmin(
            admin, packageName, userHandle);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean setPermittedInputMethods(ComponentName admin, List<String> packageNames) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.setPermittedInputMethods(
            admin, this.mContext.getPackageName(), packageNames, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public List<String> getPermittedInputMethods(ComponentName admin) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getPermittedInputMethods(
            admin, this.mContext.getPackageName(), this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean isInputMethodPermittedByAdmin(
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isInputMethodPermittedByAdmin(
            admin, packageName, userHandle, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean setPermittedCrossProfileNotificationListeners(
      ComponentName admin, List<String> packageList) {
    throwIfParentInstance("setPermittedCrossProfileNotificationListeners");
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.setPermittedCrossProfileNotificationListeners(
            admin, packageList);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public List<String> getKeepUninstalledPackages(ComponentName admin) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getKeepUninstalledPackages(
            admin, this.mContext.getPackageName());
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void setKeepUninstalledPackages(ComponentName admin, List<String> packageNames) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setKeepUninstalledPackages(
            admin, this.mContext.getPackageName(), packageNames);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public Bundle getApplicationRestrictions(ComponentName admin, String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getApplicationRestrictions(
            admin, this.mContext.getPackageName(), packageName);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void addUserRestriction(ComponentName admin, String key) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setUserRestriction(
            admin, this.mContext.getPackageName(), key, true, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void clearUserRestriction(ComponentName admin, String key) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setUserRestriction(
            admin, this.mContext.getPackageName(), key, false, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public Bundle getUserRestrictions(ComponentName admin) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        ret =
            iDevicePolicyManager.getUserRestrictions(
                admin, this.mContext.getPackageName(), this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public boolean setApplicationHidden(ComponentName admin, String packageName, boolean hidden) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.setApplicationHidden(
            admin, this.mContext.getPackageName(), packageName, hidden, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean isApplicationHidden(ComponentName admin, String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isApplicationHidden(
            admin, this.mContext.getPackageName(), packageName, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public int enableSystemApp(ComponentName admin, Intent intent) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.enableSystemAppWithIntent(
            admin, this.mContext.getPackageName(), intent);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean installExistingPackage(ComponentName admin, String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.installExistingPackage(
            admin, this.mContext.getPackageName(), packageName);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void setAccountManagementDisabled(
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setAccountManagementDisabled(
            admin, this.mContext.getPackageName(), accountType, disabled, this.mParentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public String[] getAccountTypesWithManagementDisabledAsUser(int userId, boolean parentInstance) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getAccountTypesWithManagementDisabledAsUser(
            userId, this.mContext.getPackageName(), parentInstance);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public boolean isPreferentialNetworkServiceEnabled() {
    ...
    return getPreferentialNetworkServiceConfigs().stream()
        .anyMatch(
  ...
  public void setConfiguredNetworksLockdownState(ComponentName admin, boolean lockdown) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setConfiguredNetworksLockdownState(
            admin, this.mContext.getPackageName(), lockdown);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public void setUninstallBlocked(
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setUninstallBlocked(
            admin, this.mContext.getPackageName(), packageName, uninstallBlocked);
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
    }
  ...
  public boolean addCrossProfileWidgetProvider(ComponentName admin, String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.addCrossProfileWidgetProvider(
            admin, this.mContext.getPackageName(), packageName);
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
  ...
  public boolean removeCrossProfileWidgetProvider(ComponentName admin, String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.removeCrossProfileWidgetProvider(
            admin, this.mContext.getPackageName(), packageName);
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
    ...
    if (iDevicePolicyManager != null) {
      try {
        List<String> providers =
            iDevicePolicyManager.getCrossProfileWidgetProviders(
                admin, this.mContext.getPackageName());
        if (providers != null) {
          return providers;
        }
  ...
  public void notifyPendingSystemUpdate(long updateReceivedTime) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.notifyPendingSystemUpdate(SystemUpdateInfo.m4of(updateReceivedTime));
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
    }
  ...
  public void notifyPendingSystemUpdate(long updateReceivedTime, boolean isSecurityPatch) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.notifyPendingSystemUpdate(
            SystemUpdateInfo.m5of(updateReceivedTime, isSecurityPatch));
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
    }
  ...
  public boolean setPermissionGrantState(
    ...
    try {
      ...
      this.mService.setPermissionGrantState(
          admin,
          this.mContext.getPackageName(),
          packageName,
          permission,
  ...
  public int getPermissionGrantState(ComponentName admin, String packageName, String permission) {
    ...
    try {
      return this.mService.getPermissionGrantState(
          admin, this.mContext.getPackageName(), packageName, permission);
    } catch (RemoteException re) {
      throw re.rethrowFromSystemServer();
    }
  }
  ...
  public List<SecurityLog.SecurityEvent> retrieveSecurityLogs(ComponentName admin) {
    ...
    try {
      ParceledListSlice<SecurityLog.SecurityEvent> list =
          this.mService.retrieveSecurityLogs(admin, this.mContext.getPackageName());
      if (list != null) {
        return list.getList();
      }
      return null;
  ...
  public DevicePolicyManager getParentProfileInstance(UserInfo uInfo) {
    ...
    if (!uInfo.isManagedProfile()) {
      throw new SecurityException("The user " + uInfo.f54id + " does not have a parent profile.");
    }
    return new DevicePolicyManager(this.mContext, this.mService, true);
  }
  ...
  public List<SecurityLog.SecurityEvent> retrievePreRebootSecurityLogs(ComponentName admin) {
    ...
    try {
      ParceledListSlice<SecurityLog.SecurityEvent> list =
          this.mService.retrievePreRebootSecurityLogs(admin, this.mContext.getPackageName());
      if (list != null) {
        return list.getList();
      }
      return null;
    ...
    try {
      ...
      try {
        IServiceConnection sd =
            context.getServiceDispatcher(
                conn, context.getMainThreadHandler(), Integer.toUnsignedLong(flags));
        try {
          serviceIntent.prepareToLeaveProcess(this.mContext);
          return this.mService.bindDeviceAdminServiceAsUser(
              admin,
  ...
  public boolean bindDeviceAdminServiceAsUser(
    ...
    try {
      ...
      try {
        IServiceConnection sd =
            context.getServiceDispatcher(conn, context.getMainThreadHandler(), flags.getValue());
        try {
          serviceIntent.prepareToLeaveProcess(this.mContext);
          return this.mService.bindDeviceAdminServiceAsUser(
              admin,
  ...
  public void clearApplicationUserData(
      ...
      String packageName,
      Executor executor,
      OnClearApplicationUserDataListener listener) {
    throwIfParentInstance("clearAppData");
    Objects.requireNonNull(executor);
    Objects.requireNonNull(listener);
    try {
      this.mService.clearApplicationUserData(
          admin, packageName, new BinderC03831(executor, listener));
    } catch (RemoteException re) {
      throw re.rethrowFromSystemServer();
    }
  }
  ...
  class BinderC03831 extends IPackageDataObserver.Stub {
    final /* synthetic */ Executor val$executor;
    final /* synthetic */ OnClearApplicationUserDataListener val$listener;

    BinderC03831(
        Executor executor, OnClearApplicationUserDataListener onClearApplicationUserDataListener) {
    ...
    public void onRemoveCompleted(final String pkg, final boolean succeeded) {
      ...
      executor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              DevicePolicyManager.OnClearApplicationUserDataListener.this
                  .onApplicationUserDataCleared(pkg, succeeded);
            }
          });
    }
  }
  ...
  public Set<String> getDisallowedSystemApps(
  ...
  public void rebootMDM(String reason) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        ...
        Log.m103w(TAG, "Failed talking with device policy service", e);
      }
    }
  }
  ...
  public int setGlobalPrivateDnsModeSpecifiedHost(ComponentName admin, String privateDnsHost) {
    ...
    if (NetworkUtilsInternal.isWeaklyValidatedHostname(privateDnsHost)
        && !PrivateDnsConnectivityChecker.canConnectToPrivateDnsServer(privateDnsHost)) {
      return 1;
    }
    try {
  ...
  public void installSystemUpdate(
      ...
      final InstallSystemUpdateCallback callback) {
    ...
    try {
      ParcelFileDescriptor fileDescriptor =
          this.mContext.getContentResolver().openFileDescriptor(updateFilePath, "r");
      try {
        this.mService.installUpdateFromFile(
            admin,
            this.mContext.getPackageName(),
            fileDescriptor,
            new StartInstallingUpdateCallback
                .Stub() { // from class: android.app.admin.DevicePolicyManager.2
              ...
              public void onStartInstallingUpdateError(int errorCode, String errorMessage) {
                DevicePolicyManager.this.executeCallback(
                    errorCode, errorMessage, executor, callback);
              }
            });
  ...
  public void executeCallback(
    ...
    executor.execute(
        new Runnable() { // from class:
          ...
          @Override // java.lang.Runnable
          public final void run() {
            DevicePolicyManager.InstallSystemUpdateCallback.this.onInstallUpdateError(
  ...
  public void setProfileOwnerOnOrganizationOwnedDevice(
      ComponentName who, boolean isProfileOwnerOnOrganizationOwnedDevice) {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager == null) {
      return;
    }
    try {
      iDevicePolicyManager.setProfileOwnerOnOrganizationOwnedDevice(
          who, myUserId(), isProfileOwnerOnOrganizationOwnedDevice);
    } catch (RemoteException re) {
      throw re.rethrowFromSystemServer();
    }
  }
  ...
  public boolean isPackageAllowedToAccessCalendar(String packageName) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.isPackageAllowedToAccessCalendarForUser(
    ...
    if (iDevicePolicyManager != null) {
      try {
        List<String> packageNames =
            iDevicePolicyManager.getCrossProfileCalendarPackagesForUser(myUserId());
        if (packageNames == null) {
          return null;
        }
        return new ArraySet(packageNames);
  ...
  public boolean startViewCalendarEventInManagedProfile(
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.startViewCalendarEventInManagedProfile(
            this.mContext.getPackageName(), eventId, start, end, allDay, flags);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  @SystemApi
  public void setApplicationExemptions(String packageName, Set<Integer> exemptions)
      throws PackageManager.NameNotFoundException {
    throwIfParentInstance("setApplicationExemptions");
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setApplicationExemptions(
            this.mContext.getPackageName(),
            packageName,
            ArrayUtils.convertToIntArray((ArraySet<Integer>) new ArraySet(exemptions)));
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      } catch (ServiceSpecificException e2) {
        switch (e2.errorCode) {
          ...
          default:
            throw new RuntimeException(
                "Unknown error setting application exemptions: " + e2.errorCode, e2);
        }
      }
    }
  }
  ...
  @SystemApi
  public Set<Integer> getApplicationExemptions(String packageName)
      throws PackageManager.NameNotFoundException {
    ...
    try {
      ...
      switch (e2.errorCode) {
        ...
        default:
          throw new RuntimeException(
              "Unknown error getting application exemptions: " + e2.errorCode, e2);
      }
    }
  }
  ...
  public void setUserControlDisabledPackages(ComponentName admin, List<String> packages) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setUserControlDisabledPackages(
            admin, this.mContext.getPackageName(), packages);
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
    }
  ...
  public List<String> getUserControlDisabledPackages(ComponentName admin) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getUserControlDisabledPackages(
            admin, this.mContext.getPackageName());
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      }
  ...
  public void setCommonCriteriaModeEnabled(ComponentName admin, boolean enabled) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setCommonCriteriaModeEnabled(
            admin, this.mContext.getPackageName(), enabled);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public UserHandle createAndProvisionManagedProfile(
      ManagedProfileProvisioningParams provisioningParams) throws ProvisioningException {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager == null) {
      return null;
    }
    try {
      return iDevicePolicyManager.createAndProvisionManagedProfile(
          provisioningParams, this.mContext.getPackageName());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    } catch (ServiceSpecificException e2) {
  ...
  @SystemApi
  public void provisionFullyManagedDevice(FullyManagedDeviceProvisioningParams provisioningParams)
      throws ProvisioningException {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.provisionFullyManagedDevice(
            provisioningParams, this.mContext.getPackageName());
      } catch (RemoteException re) {
        throw re.rethrowFromSystemServer();
      } catch (ServiceSpecificException e) {
  ...
  public void setMinimumRequiredWifiSecurityLevel(int level) {
    ...
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.setMinimumRequiredWifiSecurityLevel(
            this.mContext.getPackageName(), level);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public String getDevicePolicyManagementRoleHolderUpdaterPackage() {
    String devicePolicyManagementUpdaterConfig =
        this.mContext.getString(C4337R.string.config_devicePolicyManagementUpdater);
  ...
  public void m2xce7fef36() {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
        iDevicePolicyManager.mo3xce7fef36();
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  public String getFinancedDeviceKioskRoleHolder() {
    ...
    if (iDevicePolicyManager != null) {
      try {
        return iDevicePolicyManager.getFinancedDeviceKioskRoleHolder(
            this.mContext.getPackageName());
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
  ...
  public void semSetRequireStorageCardEncryption(
      ComponentName admin, boolean value, boolean isParent) {
    IDevicePolicyManager iDevicePolicyManager = this.mService;
    if (iDevicePolicyManager != null) {
      try {
  ...
  public void semSetAllowThirdPartyAppList(ComponentName admin, String value) {
    ...
    Log.m102w(TAG, "semSetAllowThirdPartyAppList - No more support from R OS");
  }

  public String semGetAllowThirdPartyAppList(ComponentName admin) {
    throwIfParentInstance("semGetAllowThirdPartyAppList");
    Log.m102w(TAG, "semGetAllowThirdPartyAppList - No more support from R OS");
    return "".intern();
  }
  ...
  public void semSetAllowUnsignedInstallationPackage(ComponentName cp, boolean flags) {
    ...
    Log.m102w(TAG, "semSetAllowUnsignedInstallationPackage - No more support from R OS");
  }
  ...
  public boolean semGetAllowUnsignedInstallationPackage(ComponentName admin) {
    ...
    Log.m102w(TAG, "semGetAllowUnsignedInstallationPackage - No more support from R OS");
    return true;
  }
