...
public class DevicePolicyManager {
    ...
    public void notifyPendingSystemUpdate(long updateReceivedTime, boolean isSecurityPatch) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.notifyPendingSystemUpdate(SystemUpdateInfo.m5of(updateReceivedTime, isSecurityPatch));
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
    ...
    public void clearApplicationUserData(ComponentName admin, String packageName, Executor executor, OnClearApplicationUserDataListener listener) {
        ...
        try {
            this.mService.clearApplicationUserData(admin, packageName, new BinderC03831(executor, listener));
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    class BinderC03831 extends IPackageDataObserver.Stub {
        ...
        BinderC03831(Executor executor, OnClearApplicationUserDataListener onClearApplicationUserDataListener) {
    ...
    public String getDevicePolicyManagementRoleHolderUpdaterPackage() {
        String devicePolicyManagementUpdaterConfig = this.mContext.getString(C4337R.string.config_devicePolicyManagementUpdater);
