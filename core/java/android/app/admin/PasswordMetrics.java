...
public final class PasswordMetrics implements Parcelable {
    ...
    public static int sanitizeComplexityLevel(int complexityLevel) {
        switch (complexityLevel) {
            ...
            default:
                Log.m102w(TAG, "Invalid password complexity used: " + complexityLevel);
                return 0;
        }
    }
    ...
    private static abstract class ComplexityBucket {
        ...
        public static final ComplexityBucket BUCKET_MEDIUM = new PasswordMetricsComplexityBucketC04102("BUCKET_MEDIUM", 1, 196608);
        public static final ComplexityBucket BUCKET_LOW = new PasswordMetricsComplexityBucketC04113("BUCKET_LOW", 2, 65536);
        ...
        enum PasswordMetricsComplexityBucketC04091 extends ComplexityBucket {
            private PasswordMetricsComplexityBucketC04091(String str, int i, int complexityLevel) {
        ...
        static {
            int i = 0;
            BUCKET_HIGH = new PasswordMetricsComplexityBucketC04091("BUCKET_HIGH", i, 327680);
            BUCKET_NONE = new PasswordMetricsComplexityBucketC04124("BUCKET_NONE", 3, i);
        }

        /* renamed from: android.app.admin.PasswordMetrics$ComplexityBucket$2 */
        enum PasswordMetricsComplexityBucketC04102 extends ComplexityBucket {
            private PasswordMetricsComplexityBucketC04102(String str, int i, int complexityLevel) {
                super(str, i, complexityLevel);
            }
        ...
        enum PasswordMetricsComplexityBucketC04113 extends ComplexityBucket {
            private PasswordMetricsComplexityBucketC04113(String str, int i, int complexityLevel) {
                super(str, i, complexityLevel);
            }
        ...
        enum PasswordMetricsComplexityBucketC04124 extends ComplexityBucket {
            private PasswordMetricsComplexityBucketC04124(String str, int i, int complexityLevel) {
                super(str, i, complexityLevel);
            }
