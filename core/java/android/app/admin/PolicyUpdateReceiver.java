...
public abstract class PolicyUpdateReceiver extends BroadcastReceiver {
  ...
  public final void onReceive(Context context, Intent intent) {
    ...
    switch (c) {
      case 0:
        Log.m98i(TAG, "Received ACTION_DEVICE_POLICY_SET_RESULT");
        onPolicySetResult(
            context,
            getPolicyKey(intent),
        ...
        break;
      case 1:
        Log.m98i(TAG, "Received ACTION_DEVICE_POLICY_CHANGED");
        onPolicyChanged(
            context,
            getPolicyKey(intent),
            getPolicyExtraBundle(intent),
        ...
        break;
      default:
        Log.m96e(TAG, "Unknown action received: " + intent.getAction());
        break;
    }
  }
