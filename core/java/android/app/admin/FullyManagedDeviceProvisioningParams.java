...
public final class FullyManagedDeviceProvisioningParams implements Parcelable {
  ...
  public static final Parcelable.Creator<FullyManagedDeviceProvisioningParams> CREATOR =
      new Parcelable.Creator<
          FullyManagedDeviceProvisioningParams>() { // from class:
  ...
  public static final class Builder {
    ...
    public FullyManagedDeviceProvisioningParams build() {
      ...
      return new FullyManagedDeviceProvisioningParams(
          componentName, str, z, str2, j, locale, z2, persistableBundle, this.mDemoDevice);
    }
  }
  ...
  public String toString() {
    StringBuilder append =
        new StringBuilder()
            .append("FullyManagedDeviceProvisioningParams{mDeviceAdminComponentName=")
            .append(this.mDeviceAdminComponentName)
            .append(", mOwnerName=")
    ...
    StringBuilder append2 =
        append.append(str).append(", mLocalTime=").append(this.mLocalTime).append(", mLocale=");
    Locale locale = this.mLocale;
    if (locale != null) {
      obj = locale;
    }
    return append2
        .append(obj)
        .append(", mDeviceOwnerCanGrantSensorsPermissions=")
        .append(this.mDeviceOwnerCanGrantSensorsPermissions)
        .append(", mAdminExtras=")
        .append(this.mAdminExtras)
        .append(", mDemoDevice=")
        .append(this.mDemoDevice)
        .append('}')
        .toString();
  }
