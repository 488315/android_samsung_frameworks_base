...
public final class SystemUpdateInfo implements Parcelable {
  ...
  /* renamed from: of */
  public static SystemUpdateInfo m4of(long receivedTime) {
    if (receivedTime == -1) {
      return null;
    }
  ...
  /* renamed from: of */
  public static SystemUpdateInfo m5of(long receivedTime, boolean isSecurityPatch) {
    if (receivedTime == -1) {
      return null;
    }
  ...
  public String toString() {
    return String.format(
        ...
        Long.valueOf(this.mReceivedTime), securityPatchStateToString(this.mSecurityPatchState));
  }
