...
public final class ManagedProfileProvisioningParams implements Parcelable {
  ...
  public static final Parcelable.Creator<ManagedProfileProvisioningParams> CREATOR =
      new Parcelable.Creator<
          ManagedProfileProvisioningParams>() { // from class:
  ...
  public void logParams(String callerPackage) {
    ...
    logParam(
        callerPackage, ORGANIZATION_OWNED_PROVISIONING_PARAM, this.mOrganizationOwnedProvisioning);
  ...
  public static final class Builder {
    ...
    public ManagedProfileProvisioningParams build() {
      ...
      return new ManagedProfileProvisioningParams(
          componentName, str, str2, account, z, z2, z3, persistableBundle);
    }
  }
  ...
  public String toString() {
    StringBuilder append =
        new StringBuilder()
            .append("ManagedProfileProvisioningParams{mProfileAdminComponentName=")
            .append(this.mProfileAdminComponentName)
            .append(", mOwnerName=")
            .append(this.mOwnerName)
            .append(", mProfileName=");
    ...
    return append2
        .append(obj)
        .append(", mLeaveAllSystemAppsEnabled=")
        .append(this.mLeaveAllSystemAppsEnabled)
        .append(", mOrganizationOwnedProvisioning=")
        .append(this.mOrganizationOwnedProvisioning)
        .append(", mKeepAccountOnMigration=")
        .append(this.mKeepAccountOnMigration)
        .append(", mAdminExtras=")
        .append(this.mAdminExtras)
        .append('}')
        .toString();
  }
