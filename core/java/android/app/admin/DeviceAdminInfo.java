...
public final class DeviceAdminInfo implements Parcelable {
    ...
    static {
        sPoliciesDisplayOrder.add(new PolicyInfo(4, "wipe-data", C4337R.string.policylab_wipeData, C4337R.string.policydesc_wipeData, C4337R.string.policylab_wipeData_secondaryUser, C4337R.string.policydesc_wipeData_secondaryUser));
        sPoliciesDisplayOrder.add(new PolicyInfo(2, "reset-password", C4337R.string.policylab_resetPassword, C4337R.string.policydesc_resetPassword));
        sPoliciesDisplayOrder.add(new PolicyInfo(0, "limit-password", C4337R.string.policylab_limitPassword, C4337R.string.policydesc_limitPassword));
        sPoliciesDisplayOrder.add(new PolicyInfo(1, "watch-login", C4337R.string.policylab_watchLogin, C4337R.string.policydesc_watchLogin, C4337R.string.policylab_watchLogin, C4337R.string.policydesc_watchLogin_secondaryUser));
        sPoliciesDisplayOrder.add(new PolicyInfo(3, "force-lock", C4337R.string.policylab_forceLock, C4337R.string.policydesc_forceLock));
        sPoliciesDisplayOrder.add(new PolicyInfo(5, "set-global-proxy", C4337R.string.policylab_setGlobalProxy, C4337R.string.policydesc_setGlobalProxy));
        sPoliciesDisplayOrder.add(new PolicyInfo(6, "expire-password", C4337R.string.policylab_expirePassword, C4337R.string.policydesc_expirePassword));
        sPoliciesDisplayOrder.add(new PolicyInfo(7, "encrypted-storage", C4337R.string.policylab_encryptedStorage, C4337R.string.policydesc_encryptedStorage));
        sPoliciesDisplayOrder.add(new PolicyInfo(8, "disable-camera", C4337R.string.policylab_disableCamera, C4337R.string.policydesc_disableCamera));
        sPoliciesDisplayOrder.add(new PolicyInfo(9, "disable-keyguard-features", C4337R.string.policylab_disableKeyguardFeatures, C4337R.string.policydesc_disableKeyguardFeatures));
        sPoliciesDisplayOrder.add(new PolicyInfo(20, "require-storagecard-encryption", C4337R.string.policylab_require_storagecard_encryption, C4337R.string.policydesc_require_storagecard_encryption));
        sPoliciesDisplayOrder.add(new PolicyInfo(10, "recover-password", C4337R.string.policylab_recoverPassword, C4337R.string.policydesc_recoverPassword));
        sPoliciesDisplayOrder.add(new PolicyInfo(14, "allow-popimapemail", C4337R.string.policylab_allow_popimapemail, C4337R.string.policydesc_allow_popimapemail));
        sPoliciesDisplayOrder.add(new PolicyInfo(11, "allow-storagecard", C4337R.string.policylab_allow_storagecard, C4337R.string.policydesc_allow_storagecard));
        sPoliciesDisplayOrder.add(new PolicyInfo(12, "allow-wifi", C4337R.string.policylab_allow_wifi, C4337R.string.policydesc_allow_wifi));
        sPoliciesDisplayOrder.add(new PolicyInfo(13, "allow-textmessaging", C4337R.string.policylab_allow_textmessaging, C4337R.string.policydesc_allow_textmessaging));
        sPoliciesDisplayOrder.add(new PolicyInfo(15, "allow-browser", C4337R.string.policylab_allow_browser, C4337R.string.policydesc_allow_browser));
        sPoliciesDisplayOrder.add(new PolicyInfo(16, "allow-internetsharing", C4337R.string.policylab_allow_internetsharing, C4337R.string.policydesc_allow_internetsharing));
        sPoliciesDisplayOrder.add(new PolicyInfo(17, "allow-bluetoothmode", C4337R.string.policylab_allow_bluetoothmode, C4337R.string.policydesc_allow_bluetoothmode));
        sPoliciesDisplayOrder.add(new PolicyInfo(18, "allow-desktopsync", C4337R.string.policylab_allow_desktopsync, C4337R.string.policydesc_allow_desktopsync));
        sPoliciesDisplayOrder.add(new PolicyInfo(19, "allow-irda", C4337R.string.policylab_allow_irda, C4337R.string.policydesc_allow_irda));
                                ...
                                while (true) {
                                    ...
                                    if (type3 != i2 && type3 != i3) {
                                        ...
                                        if (val != null) {
                                            ...
                                            Log.m102w(TAG, "Unknown tag under uses-policies of " + getComponent() + ": " + policyName);
                                        }
                                    }
                                    i = 1;
                                    i2 = 3;
