...
public final class PolicyState<V> implements Parcelable {
  public static final Parcelable.Creator<PolicyState<?>> CREATOR =
      new Parcelable.Creator<PolicyState<?>>() { // from class: android.app.admin.PolicyState.1
  ...
  private PolicyState(Parcel source) {
    ...
    this.mResolutionMechanism =
        (ResolutionMechanism) source.readParcelable(ResolutionMechanism.class.getClassLoader());
  }
