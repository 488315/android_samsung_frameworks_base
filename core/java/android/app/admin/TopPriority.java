...
public final class TopPriority<V> extends ResolutionMechanism<V> {
  public static final Parcelable.Creator<TopPriority<?>> CREATOR =
      new Parcelable.Creator<TopPriority<?>>() { // from class: android.app.admin.TopPriority.1
  ...
  public TopPriority(List<Authority> highestToLowestPriorityAuthorities) {
    this.mHighestToLowestPriorityAuthorities =
        (List) Objects.requireNonNull(highestToLowestPriorityAuthorities);
  }
  ...
  private TopPriority(Parcel source) {
    ...
    for (int i = 0; i < size; i++) {
      this.mHighestToLowestPriorityAuthorities.add(
          (Authority) source.readParcelable(Authority.class.getClassLoader()));
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    try {
      ...
      return Objects.equals(
          this.mHighestToLowestPriorityAuthorities, other.mHighestToLowestPriorityAuthorities);
