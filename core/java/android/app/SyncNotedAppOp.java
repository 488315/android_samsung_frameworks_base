...
public final class SyncNotedAppOp implements Parcelable {
  ...
  public boolean equals(Object o) {
    ...
    if (this.mOpMode == that.mOpMode
        && this.mOpCode == that.mOpCode
  ...
  public int hashCode() {
    ...
    return (((((_hash * 31) + this.mOpCode) * 31) + Objects.hashCode(this.mAttributionTag)) * 31)
