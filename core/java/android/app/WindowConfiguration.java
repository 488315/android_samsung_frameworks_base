...
public class WindowConfiguration implements Parcelable, Comparable<WindowConfiguration> {
  ...
  public int updateFrom(WindowConfiguration delta) {
    ...
    if (CoreRune.MW_EMBED_ACTIVITY_MODE
        && (i2 = delta.mEmbedActivityMode) != 0
        && this.mEmbedActivityMode != i2) {
    ...
    if (CoreRune.MW_CAPTION_SHELL_OPACITY
        && (i = delta.mFreeformTranslucent) != 0
        && this.mFreeformTranslucent != i) {
  ...
  public long diff(WindowConfiguration other, boolean compareUndefined) {
    ...
    if ((compareUndefined || other.mAppBounds != null)
        && (rect = this.mAppBounds) != (rect2 = other.mAppBounds)
        && (rect == null || !rect.equals(rect2))) {
      changes |= 2;
    }
    ...
    if ((compareUndefined || other.mDisplayWindowingMode != 0)
        && this.mDisplayWindowingMode != other.mDisplayWindowingMode) {
      changes |= 128;
    }
    ...
    if (CoreRune.MT_SUPPORT_COMPAT_SANDBOX) {
      if ((compareUndefined || other.mCompatSandboxFlags != 0)
        ...
        changes |= 33554432;
          ...
          && (rect3 = this.mCompatSandboxBounds) != (rect4 = other.mCompatSandboxBounds)
          && (rect3 == null || !rect3.equals(rect4))) {
        changes |= 33554432;
      }
    }
    ...
    if ((compareUndefined || other.mFreeformTranslucent != 0)
        && this.mFreeformTranslucent != other.mFreeformTranslucent) {
  ...
  public int compareTo(WindowConfiguration that) {
    ...
    return n23 != 0
        ? n23
        : (!CoreRune.MW_CAPTION_SHELL_OPACITY
                || (n23 = this.mFreeformTranslucent - that.mFreeformTranslucent) == 0)
            ? n23
            : n23;
  }
  ...
  public String toString() {
    ...
    StringBuilder append2 =
        append
            ...
            .append(" mDisplayWindowingMode=")
            .append(windowingModeToString(this.mDisplayWindowingMode))
    ...
    return append2
        ...
        .append(" mOverlappingWithCutout=")
        .append(this.mOverlappingWithCutout)
        .append(" mStageConfig=")
        .append(stageConfigToString(this.mStage))
        .append(
            CoreRune.MW_EMBED_ACTIVITY_MODE
                ? " mEmbedActivityMode=" + embedActivityModeToString(this.mEmbedActivityMode)
                : "")
        .append(" mFreeformTaskPinningState=")
        .append(freeformTaskPinningToString(this.mFreeformTaskPinningState))
        .append("")
        .append(CoreRune.MT_SUPPORT_COMPAT_SANDBOX ? compatSandboxInfoToString() : "")
        .append(" mDexTaskDockingState=")
        .append(dexTaskDockingStateToString(this.mDexTaskDockingState))
        .append(
            CoreRune.MW_CAPTION_SHELL_OPACITY
                ? " mFreeformTranslucent=" + translucentToString(this.mFreeformTranslucent)
                : "")
        .append("}")
        .toString();
  }
