...
public final class NotificationChannel implements Parcelable {
  ...
  private void populateFromXml(
    ...
    Preconditions.checkArgument(
        (forRestore && context == null) ? false : true, "forRestore is true but got null context");
    ...
    setSound(
        forRestore ? restoreSoundUri(context, sound, pkgInstalled) : sound,
  ...
  public Uri restoreSoundUri(Context context, Uri uri, boolean pkgInstalled) {
    ...
    if (unCanonicalizedUri == null) {
      try {
        ...
        Slog.m116e("NotiChannel", "This is not MediaSore uri : " + canonicalizedUri, e);
      }
      if (c.moveToFirst()) {
  ...
  private Uri getSoundForBackup(Context context) {
    ...
    try {
      ...
      Slog.m116e("NotiChannel", sound + " uri permission from App", e);
      return Settings.System.DEFAULT_NOTIFICATION_URI;
    }
  }
  ...
  private void writeXml(TypedXmlSerializer out, boolean forBackup, Context context)
      throws IOException {
    Preconditions.checkArgument(
        (forBackup && context == null) ? false : true, "forBackup is true but got null context");
  ...
  public JSONObject toJson() throws JSONException {
    ...
    if (getImportance() != -1000) {
      record.put(
          "importance", NotificationListenerService.Ranking.importanceToString(getImportance()));
    }
    if (canBypassDnd()) {
  ...
  public boolean equals(Object o) {
    ...
    if (getImportance() == that.getImportance()
        ...
        && Arrays.equals(this.mVibration, that.mVibration)
  ...
  private String getFieldsString() {
    ...
    return ", mDescription="
        ...
        + this.mLightColor
        + ", mVibration="
        + Arrays.toString(this.mVibration)
        + ", mUserLockedFields="
