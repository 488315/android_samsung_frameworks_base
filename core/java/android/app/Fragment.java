...
public class Fragment implements ComponentCallbacks2, View.OnCreateContextMenuListener {
  ...
  public static Fragment instantiate(Context context, String fname, Bundle args) {
    try {
      ...
      throw new InstantiationException(
          "Unable to instantiate fragment " + fname + ": could not find Fragment constructor", e4);
  ...
  public LoaderManager getLoaderManager() {
    ...
    LoaderManagerImpl loaderManager =
        fragmentHostCallback.getLoaderManager(this.mWho, this.mLoadersStarted, true);
  ...
  public void startActivityForResultAsUser(
    ...
    fragmentHostCallback.onStartActivityAsUserFromFragment(
        this, intent, requestCode, options, user);
  }
  ...
  public void startIntentSenderForResult(
    ...
    fragmentHostCallback.onStartIntentSenderFromFragment(
  ...
  public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
    ...
    setSharedElementReturnTransition(
        loadTransition(context, a, getSharedElementReturnTransition(), transition, 7));
    ...
    Activity hostActivity =
        fragmentHostCallback != null ? fragmentHostCallback.getActivity() : null;
  ...
  public void onAttach(Context context) {
    ...
    FragmentHostCallback fragmentHostCallback = this.mHost;
    Activity hostActivity =
        fragmentHostCallback == null ? null : fragmentHostCallback.getActivity();
    if (hostActivity != null) {
      this.mCalled = false;
  ...
  public Transition getReturnTransition() {
    ...
    return animationInfo.mReturnTransition == USE_DEFAULT_TRANSITION
        ? getEnterTransition()
  ...
  public Transition getReenterTransition() {
    ...
    return animationInfo.mReenterTransition == USE_DEFAULT_TRANSITION
        ? getExitTransition()
  ...
  public void startPostponedEnterTransition() {
    ...
    if (fragmentManagerImpl == null || fragmentManagerImpl.mHost == null) {
      ...
      this.mFragmentManager
          ...
          .getHandler()
          .postAtFrontOfQueue(
              new Runnable() { // from class: android.app.Fragment$$ExternalSyntheticLambda0
