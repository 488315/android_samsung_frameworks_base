...
class ActivityTransitionState {
  ...
  public ArrayList<String> getPendingExitNames() {
    ...
    if (this.mPendingExitNames == null
        && (enterTransitionCoordinator = this.mEnterTransitionCoordinator) != null
        && !enterTransitionCoordinator.isReturning()) {
  ...
  public void enterReady(Activity activity) {
    ...
    this.mEnterTransitionCoordinator =
        new EnterTransitionCoordinator(
            ...
            this.mEnterActivityOptions.isCrossTask());
    ...
    if (this.mEnterTransitionCoordinator.isReturning()) {
      ...
      if (arrayList != null) {
        this.mEnterTransitionCoordinator.viewInstancesReady(
            this.mExitingFrom, this.mExitingTo, arrayList);
      } else {
  ...
  public void onResume(Activity activity) {
    if (this.mEnterTransitionCoordinator == null || activity.isTopOfTask()) {
      ...
      activity.mHandler.postDelayed(new RunnableC01211(), 1000L);
    }
  }
  ...
  class RunnableC01211 implements Runnable {
    ...
    public void run() {
      if (ActivityTransitionState.this.mEnterTransitionCoordinator == null
          || ActivityTransitionState.this.mEnterTransitionCoordinator.isWaitingForRemoteExit()) {
        ...
        ActivityTransitionState.this.mEnterTransitionCoordinator.runAfterTransitionsComplete(
            new Runnable() { // from class:
              ...
              public final void run() {
                ActivityTransitionState.RunnableC01211.this.lambda$run$0();
              }
            });
      }
    }
