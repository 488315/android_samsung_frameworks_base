...
public interface IActivityClientController extends IInterface {
  ...
  void dismissKeyguard(
      IBinder iBinder, IKeyguardDismissCallback iKeyguardDismissCallback, CharSequence charSequence)
      throws RemoteException;
  ...
  void registerRemoteAnimations(
      IBinder iBinder, RemoteAnimationDefinition remoteAnimationDefinition) throws RemoteException;
  ...
  public static class Default implements IActivityClientController {
    ...
    public void activityStopped(
        IBinder token, Bundle state, PersistableBundle persistentState, CharSequence description)
        throws RemoteException {}
    ...
    public boolean navigateUpTo(
        IBinder token, Intent target, String resolvedType, int resultCode, Intent resultData)
        throws RemoteException {
      return false;
    }
    ...
    public void overridePendingTaskTransition(
        IBinder token, String packageName, int enterAnim, int exitAnim) throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IActivityClientController {
          ...
          switch (code) {
            ...
            case 10:
              ...
              SizeConfigurationBuckets _arg14 =
                  (SizeConfigurationBuckets) data.readTypedObject(SizeConfigurationBuckets.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 35:
              ...
              PictureInPictureParams _arg114 =
                  (PictureInPictureParams) data.readTypedObject(PictureInPictureParams.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 36:
              ...
              PictureInPictureParams _arg115 =
                  (PictureInPictureParams) data.readTypedObject(PictureInPictureParams.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 43:
              ...
              ActivityManager.TaskDescription _arg118 =
            ...
            case 59:
              ...
              IKeyguardDismissCallback _arg131 =
            ...
            case 60:
              ...
              RemoteAnimationDefinition _arg132 =
            ...
            case 62:
              ...
              IRequestFinishCallback _arg133 =
            ...
            case 64:
              ...
              ICompatCameraControlCallback _arg36 =
                  ICompatCameraControlCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
    ...
    private static class Proxy implements IActivityClientController {
      ...
      public void reportSizeConfigurations(
          IBinder token, SizeConfigurationBuckets sizeConfigurations) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        try {
          _data.writeInterfaceToken(IActivityClientController.DESCRIPTOR);
          _data.writeStrongBinder(token);
