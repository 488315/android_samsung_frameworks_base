...
import android.p009os.PerformanceCollector;
import android.p009os.PersistableBundle;
import android.p009os.Process;
import android.p009os.RemoteException;
import android.p009os.ServiceManager;
import android.p009os.SystemClock;
import android.p009os.TestLooperManager;
...
public class Instrumentation {
  ...
  public void start() {
    ...
    InstrumentationThread instrumentationThread =
        new InstrumentationThread("Instr: " + getClass().getName());
  ...
  public void resetInTouchMode() {
    boolean defaultInTouchMode =
        getContext().getResources().getBoolean(C4337R.bool.config_defaultInTouchMode);
    ...
    final boolean match(Context who, Activity activity, Intent intent) {
      ...
      synchronized (this) {
        ...
        if (intentFilter != null
            && intentFilter.match(who.getContentResolver(), intent, true, Instrumentation.TAG)
                < 0) {
          return false;
        }
        if (this.mClass != null) {
  ...
  public boolean invokeContextMenuAction(Activity targetActivity, int id, int flag) {
    ...
    try {
      ...
      Log.m97e(TAG, "Could not sleep for long press timeout", e);
      return false;
    }
  }
  ...
  private AppComponentFactory getFactory(String pkg) {
    if (pkg == null) {
      Log.m96e(TAG, "No pkg specified, disabling AppComponentFactory");
  ...
  public Bundle getAllocCounts() {
    ...
    results.putLong(
        PerformanceCollector.METRIC_KEY_GC_INVOCATION_COUNT, Debug.getGlobalGcInvocationCount());
    return results;
  }
  ...
  public Bundle getBinderCounts() {
    Bundle results = new Bundle();
    results.putLong(
        PerformanceCollector.METRIC_KEY_SENT_TRANSACTIONS, Debug.getBinderSentTransactions());
    results.putLong(
  ...
  */
  ...
  public static void checkStartActivityResult(int res, Object intent) {
    ...
    switch (res) {
      ...
      case -101:
        Log.m94d(
            TAG, "checkStartActivityResult() : mdm admin has blocked start activity " + intent);
        return;
      case -100:
        ...
        if ((intent instanceof Intent) && ((Intent) intent).getComponent() != null) {
          throw new ActivityNotFoundException(
              "Unable to find explicit activity class "
                  ...
                  + "; have you declared this activity in your AndroidManifest.xml, or does your"
                  + " intent not match its declared <intent-filter>?");
        }
  ...
  public UiAutomation getUiAutomation(int flags) {
    ...
    if (this.mUiAutomationConnection != null) {
      ...
      try {
        ...
        Log.m97e(TAG, "Unable to connect to UiAutomation. Waited for " + waited + " ms", e);
