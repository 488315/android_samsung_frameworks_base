...
public class FragmentBreadCrumbs extends ViewGroup
  ...
  public FragmentBreadCrumbs(Context context, AttributeSet attrs) {
    this(context, attrs, C4337R.attr.fragmentBreadCrumbsStyle);
  }
  ...
  public FragmentBreadCrumbs(
    ...
    this.mOnClickListener =
        new View.OnClickListener() { // from class: android.app.FragmentBreadCrumbs.1
          ...
          public void onClick(View v) {
            if (v.getTag() instanceof FragmentManager.BackStackEntry) {
              ...
              if (FragmentBreadCrumbs.this.mOnBreadCrumbClickListener != null) {
                if (FragmentBreadCrumbs.this.mOnBreadCrumbClickListener.onBreadCrumbClick(
                    bse == FragmentBreadCrumbs.this.mTopEntry ? null : bse, 0)) {
                  return;
                }
              }
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.FragmentBreadCrumbs, defStyleAttr, defStyleRes);
    this.mGravity = a.getInt(0, DEFAULT_GRAVITY);
    this.mLayoutResId = a.getResourceId(2, C4337R.layout.fragment_bread_crumb_item);
  ...
  public void setActivity(Activity a) {
    ...
    LinearLayout linearLayout =
        (LinearLayout)
            layoutInflater.inflate(C4337R.layout.fragment_bread_crumbs, (ViewGroup) this, false);
  ...
  private BackStackRecord createBackStackEntry(CharSequence title, CharSequence shortTitle) {
    ...
    BackStackRecord entry =
        new BackStackRecord((FragmentManagerImpl) this.mActivity.getFragmentManager());
  ...
  void updateCrumbs() {
    ...
    for (int i = 0; i < numEntries + numPreEntries; i++) {
      ...
      if (i >= numViews) {
        ...
        if (i == 0) {
          item.findViewById(C4337R.id.left_icon).setVisibility(8);
        }
    ...
    while (i3 < numViews2) {
      ...
      if (i4 > 0) {
        ...
        View leftIcon = child.findViewById(C4337R.id.left_icon);
