...
public class FragmentBreadCrumbs extends ViewGroup implements FragmentManager.OnBackStackChangedListener {
    ...
    public FragmentBreadCrumbs(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.FragmentBreadCrumbs, defStyleAttr, defStyleRes);
    ...
    public void setActivity(Activity a) {
        ...
        LinearLayout linearLayout = (LinearLayout) layoutInflater.inflate(C4337R.layout.fragment_bread_crumbs, (ViewGroup) this, false);
