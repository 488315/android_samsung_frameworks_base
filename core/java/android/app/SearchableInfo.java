...
public final class SearchableInfo implements Parcelable {
  ...
  public static class ActionKeyInfo implements Parcelable {
    ...
    ActionKeyInfo(Context activityContext, AttributeSet attr) {
      TypedArray a =
          activityContext.obtainStyledAttributes(attr, C4337R.styleable.SearchableActionKey);
      int i = a.getInt(0, 0);
      this.mKeyCode = i;
    ...
    try {
      ...
      while (tagType != 1) {
        if (tagType == 2) {
          ...
          } else if (xml.getName().equals(MD_XML_ELEMENT_SEARCHABLE_EXTRA_ATTR)
              && result != null
              && (attr = Xml.asAttributeSet(xml)) != null) {
  ...
  private void addExtraAttribute(Context activityContext, AttributeSet attr) {
    TypedArray ta =
        activityContext.obtainStyledAttributes(attr, C4337R.styleable.SearchableExtraAttr);
