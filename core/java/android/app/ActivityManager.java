...
public class ActivityManager {
    ...
    private final IUidFrozenStateChangedCallback mFrozenStateChangedCallback = new IUidFrozenStateChangedCallbackStubC00971();
    ...
    public static boolean isHighEndGfx() {
        return (isLowRamDeviceStatic() || RoSystemProperties.CONFIG_AVOID_GFX_ACCEL || Resources.getSystem().getBoolean(C4337R.bool.config_avoidGfxAccel)) ? false : true;
    }
    ...
    public void setApplicationStartInfoCompleteListener(Executor executor, ApplicationStartInfoCompleteListener listener) {
        ...
        IApplicationStartInfoCompleteListener callback = new IApplicationStartInfoCompleteListenerStubC00982(executor, listener);
        try {
    ...
    class IApplicationStartInfoCompleteListenerStubC00982 extends IApplicationStartInfoCompleteListener.Stub {
        final /* synthetic */ Executor val$executor;
        final /* synthetic */ ApplicationStartInfoCompleteListener val$listener;

        IApplicationStartInfoCompleteListenerStubC00982(Executor executor, ApplicationStartInfoCompleteListener applicationStartInfoCompleteListener) {
