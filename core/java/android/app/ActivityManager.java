...
public class ActivityManager {
  ...
  private final IUidFrozenStateChangedCallback mFrozenStateChangedCallback =
      new IUidFrozenStateChangedCallbackStubC00971();
  ...
  static final class MyUidObserver extends UidObserver {
    ...
    public void onUidStateChanged(int uid, int procState, long procStateSeq, int capability) {
      this.mListener.onUidImportance(
          uid, RunningAppProcessInfo.procStateToImportanceForClient(procState, this.mContext));
    }
  ...
  class IUidFrozenStateChangedCallbackStubC00971 extends IUidFrozenStateChangedCallback.Stub {
    IUidFrozenStateChangedCallbackStubC00971() {}
                ...
                executor.execute(
                    new Runnable() { // from class:
                      ...
                      public final void run() {
                        ActivityManager.UidFrozenStateChangedCallback.this.onUidFrozenStateChanged(
                            r2, r3);
                      }
                    });
              }
  ...
  public static boolean isHighEndGfx() {
    return (isLowRamDeviceStatic()
            ...
            || Resources.getSystem().getBoolean(C4337R.bool.config_avoidGfxAccel))
        ? false
        : true;
  }
  ...
  public static class TaskDescription implements Parcelable {
    ...
    public static final Parcelable.Creator<TaskDescription> CREATOR =
        new Parcelable.Creator<
            TaskDescription>() { // from class: android.app.ActivityManager.TaskDescription.1
          /* JADX WARN: Can't rename method to resolve collision */
    ...
    public static final class Builder {
      ...
      public TaskDescription build() {
        Icon icon =
            this.mIconRes == 0
                ? null
                : Icon.createWithResource(ActivityThread.currentPackageName(), this.mIconRes);
    ...
    public String toString() {
      return "TaskDescription Label: "
          ...
          + " statusBarColor: "
          + this.mStatusBarColor
          + (this.mEnsureStatusBarContrastWhenTransparent ? " (contrast when transparent)" : "")
          + " navigationBarColor: "
          + this.mNavigationBarColor
          + (this.mEnsureNavigationBarContrastWhenTransparent ? " (contrast when transparent)" : "")
          + " resizeMode: "
    ...
    public int getDeviceDefaultNavigationBarColor(Context context) {
      return context.getResources().getColor(C4337R.color.navbar_light_theme_color, null);
    }
  ...
  public static class RecentTaskInfo extends TaskInfo implements Parcelable {
    public static final Parcelable.Creator<RecentTaskInfo> CREATOR =
        new Parcelable.Creator<
            RecentTaskInfo>() { // from class: android.app.ActivityManager.RecentTaskInfo.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public void readFromParcel(Parcel source) {
      this.f12id = source.readInt();
      this.persistentId = source.readInt();
      this.childrenTaskInfos =
          source.readArrayList(RecentTaskInfo.class.getClassLoader(), RecentTaskInfo.class);
  ...
  public static class RunningTaskInfo extends TaskInfo implements Parcelable {
    public static final Parcelable.Creator<RunningTaskInfo> CREATOR =
        new Parcelable.Creator<
            RunningTaskInfo>() { // from class: android.app.ActivityManager.RunningTaskInfo.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
  ...
  public Size getAppTaskThumbnailSize() {
    ...
    synchronized (this) {
      ...
      size = new Size(this.mAppTaskThumbnailSize.f85x, this.mAppTaskThumbnailSize.f86y);
    }
    return size;
  }
  ...
  public int addAppTask(
    ...
    if (tw != size.f85x || th != size.f86y) {
      Bitmap bm = Bitmap.createBitmap(size.f85x, size.f86y, thumbnail.getConfig());
      float dx = 0.0f;
      if (size.f85x * tw > size.f86y * th) {
        scale = size.f85x / th;
        dx = (size.f86y - (tw * scale)) * 0.5f;
      } else {
        scale = size.f86y / tw;
        float dy = (size.f85x - (th * scale)) * 0.5f;
      }
  ...
  public static class RunningServiceInfo implements Parcelable {
    public static final Parcelable.Creator<RunningServiceInfo> CREATOR =
        new Parcelable.Creator<
            RunningServiceInfo>() { // from class: android.app.ActivityManager.RunningServiceInfo.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
  ...
  public boolean clearApplicationUserData(String packageName, IPackageDataObserver observer) {
    try {
      return getService()
          .clearApplicationUserData(packageName, false, observer, this.mContext.getUserId());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public static class ProcessErrorStateInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<ProcessErrorStateInfo> CREATOR =
        new Parcelable.Creator<
            ProcessErrorStateInfo>() { // from class:
  ...
  public static class RunningAppProcessInfo implements Parcelable {
    public static final Parcelable.Creator<RunningAppProcessInfo> CREATOR =
        new Parcelable.Creator<
            RunningAppProcessInfo>() { // from class:
  ...
  public List<ApplicationStartInfo> getHistoricalProcessStartReasons(int maxNum) {
    try {
      ParceledListSlice<ApplicationStartInfo> startInfos =
          getService().getHistoricalProcessStartReasons(null, maxNum, this.mContext.getUserId());
  ...
  public List<ApplicationStartInfo> getExternalHistoricalProcessStartReasons(
    ...
    try {
      ParceledListSlice<ApplicationStartInfo> startInfos =
          getService()
              .getHistoricalProcessStartReasons(packageName, maxNum, this.mContext.getUserId());
      return startInfos == null ? Collections.emptyList() : startInfos.getList();
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  ...
  public void setApplicationStartInfoCompleteListener(
      Executor executor, ApplicationStartInfoCompleteListener listener) {
    Preconditions.checkNotNull(executor, "executor cannot be null");
    Preconditions.checkNotNull(listener, "listener cannot be null");
    IApplicationStartInfoCompleteListener callback =
        new IApplicationStartInfoCompleteListenerStubC00982(executor, listener);
    try {
  ...
  class IApplicationStartInfoCompleteListenerStubC00982
      extends IApplicationStartInfoCompleteListener.Stub {
    final /* synthetic */ Executor val$executor;
    final /* synthetic */ ApplicationStartInfoCompleteListener val$listener;

    IApplicationStartInfoCompleteListenerStubC00982(
        Executor executor,
        ApplicationStartInfoCompleteListener applicationStartInfoCompleteListener) {
    ...
    public void onApplicationStartInfoComplete(final ApplicationStartInfo applicationStartInfo) {
      ...
      final ApplicationStartInfoCompleteListener applicationStartInfoCompleteListener =
          this.val$listener;
      executor.execute(
          new Runnable() { // from class: android.app.ActivityManager$2$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              ActivityManager.ApplicationStartInfoCompleteListener.this
  ...
  public List<ApplicationExitInfo> getHistoricalProcessExitReasons(
    ...
    try {
      ParceledListSlice<ApplicationExitInfo> r =
          getService()
              .getHistoricalProcessExitReasons(packageName, pid, maxNum, this.mContext.getUserId());
  ...
  public int getPackageImportance(String packageName) {
    try {
      int procState =
          getService().getPackageProcessState(packageName, this.mContext.getOpPackageName());
    ...
    try {
      getService()
          .broadcastIntentWithFeature(
              null, null, intent, null, null, -1, null, null, null, null, null, appOp, options,
              false, true, userId);
    } catch (RemoteException e) {
    }
  }
  ...
  public static void noteWakeupAlarm(
    ...
    try {
      getService()
          .noteWakeupAlarm(
              ps != null ? ps.getTarget() : null, workSource, sourceUid, sourcePkg, tag);
    } catch (RemoteException e) {
    }
  }
  ...
  private static void dumpService(PrintWriter pw, FileDescriptor fd, String name, String[] args) {
    ...
    try {
      ...
      tp.m210go(fd, JobInfo.MIN_BACKOFF_MILLIS);
    } catch (Throwable e2) {
      if (tp != null) {
        tp.kill();
      }
  ...
  public boolean isProfileForeground(UserHandle userHandle) {
    ...
    if (userManager != null) {
      for (UserInfo userInfo : userManager.getProfiles(getCurrentUser())) {
        if (userInfo.f54id == userHandle.getIdentifier()) {
          return true;
        }
      }
      return false;
    ...
    public void startActivity(Context context, Intent intent, Bundle options) {
      ...
      thread
          ...
          .execStartActivityFromAppTask(
              context, thread.getApplicationThread(), this.mAppTaskImpl, intent, options);
    }
  ...
  public boolean semSwitchUser(int userid) {
    try {
      ...
      Log.m97e(TAG, "semSwitchUser failed", e);
      return false;
    }
  }
  ...
  public void semRegisterProcessListener(SemProcessListener listener) {
    ...
    if (existingProcessObserver != null) {
      Log.m102w(TAG, "ProcessListener already registered");
      return;
    }
  ...
  public void semUnregisterProcessListener(SemProcessListener listener) {
    ProcessObserver existingProcessObserver = this.mProcessObserverMap.get(listener);
    if (existingProcessObserver == null) {
      Log.m102w(TAG, "ProcessListener no registered");
      return;
    }
    try {
  ...
  public void semRegisterActivityControllerListener(SemActivityControllerListener listener) {
    synchronized (this.mActivityControllerListeners) {
      if (this.mActivityControllerListeners.contains(listener)) {
        Log.m102w(TAG, "ActivityControllerListener already registered");
        return;
      }
  ...
  public void semUnregisterActivityControllerListener(SemActivityControllerListener listener) {
    synchronized (this.mActivityControllerListeners) {
      if (!this.mActivityControllerListeners.contains(listener)) {
        Log.m102w(TAG, "ActivityControllerListener no registered");
        return;
      }
      try {
  ...
  public void addHomeVisibilityListener(Executor executor, final HomeVisibilityListener listener) {
    ...
    try {
      ...
      executor.execute(
          new Runnable() { // from class: android.app.ActivityManager$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public static final class PendingIntentInfo implements Parcelable {
    public static final Parcelable.Creator<PendingIntentInfo> CREATOR =
        new Parcelable.Creator<
            PendingIntentInfo>() { // from class: android.app.ActivityManager.PendingIntentInfo.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
  ...
  public String[] queryRegisteredReceiverPackages(Intent intent) {
    ...
    try {
      ...
      return getService()
          .queryRegisteredReceiverPackages(intent, resolvedType, this.mContext.getUserId());
    } catch (RemoteException e) {
