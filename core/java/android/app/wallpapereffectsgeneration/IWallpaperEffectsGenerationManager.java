...
public interface IWallpaperEffectsGenerationManager extends IInterface {
  ...
  public static class Default implements IWallpaperEffectsGenerationManager {
    ...
    public void generateCinematicEffect(
        CinematicEffectRequest request, ICinematicEffectListener listener) throws RemoteException {}
          ...
          switch (code) {
            case 1:
              CinematicEffectRequest _arg0 =
                  (CinematicEffectRequest) data.readTypedObject(CinematicEffectRequest.CREATOR);
            ...
            case 2:
              CinematicEffectResponse _arg02 =
                  (CinematicEffectResponse) data.readTypedObject(CinematicEffectResponse.CREATOR);
              data.enforceNoDataAvail();
