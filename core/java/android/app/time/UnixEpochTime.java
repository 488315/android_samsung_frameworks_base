...
public final class UnixEpochTime implements Parcelable {
  public static final Parcelable.Creator<UnixEpochTime> CREATOR =
      new Parcelable.Creator<UnixEpochTime>() { // from class: android.app.time.UnixEpochTime.1
  ...
  /* renamed from: at */
  public UnixEpochTime m7at(long elapsedRealtimeTimeMillis) {
    long adjustedUnixEpochTimeMillis =
        (elapsedRealtimeTimeMillis - this.mElapsedRealtimeMillis) + this.mUnixEpochTimeMillis;
