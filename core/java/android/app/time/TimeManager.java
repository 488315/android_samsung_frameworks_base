...
public final class TimeManager {
  ...
  private final ITimeDetectorService mITimeDetectorService =
      ITimeDetectorService.Stub.asInterface(ServiceManager.getServiceOrThrow("time_detector"));
  ...
  public void addTimeZoneDetectorListener(
    ...
    synchronized (this.mLock) {
      ArrayMap<TimeZoneDetectorListener, TimeZoneDetectorListener> arrayMap =
          this.mTimeZoneDetectorListeners;
      if (arrayMap == null) {
      ...
      if (this.mTimeZoneDetectorReceiver == null) {
        ITimeZoneDetectorListener iListener =
            new ITimeZoneDetectorListener.Stub() { // from class: android.app.time.TimeManager.1
  ...
  static /* synthetic */ void lambda$addTimeZoneDetectorListener$0(
    ...
    executor.execute(
        new Runnable() { // from class: android.app.time.TimeManager$$ExternalSyntheticLambda1
    ...
    synchronized (this.mLock) {
      ...
      if (arrayMap != null && !arrayMap.isEmpty()) {
        ArrayMap<TimeZoneDetectorListener, TimeZoneDetectorListener> timeZoneDetectorListeners =
            new ArrayMap<>(this.mTimeZoneDetectorListeners);
