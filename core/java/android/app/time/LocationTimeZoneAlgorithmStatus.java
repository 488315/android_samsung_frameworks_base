...
public final class LocationTimeZoneAlgorithmStatus implements Parcelable {
  ...
  public static final Parcelable.Creator<LocationTimeZoneAlgorithmStatus> CREATOR =
      new Parcelable.Creator<
          LocationTimeZoneAlgorithmStatus>() { // from class:
  ...
  public boolean equals(Object o) {
    ...
    if (this.mStatus == that.mStatus
        ...
        && Objects.equals(this.mPrimaryProviderReportedStatus, that.mPrimaryProviderReportedStatus)
        && this.mSecondaryProviderStatus == that.mSecondaryProviderStatus
        && Objects.equals(
            this.mSecondaryProviderReportedStatus, that.mSecondaryProviderReportedStatus)) {
      return true;
    }
    return false;
  }
  ...
  public boolean couldEnableTelephonyFallback() {
    ...
    if (i3 == 1) {
      secondarySuggestsFallback = true;
        ...
        && (timeZoneProviderStatus2 = this.mSecondaryProviderReportedStatus) != null) {
