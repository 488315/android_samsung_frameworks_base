...
public final class TimeCapabilities implements Parcelable {
  public static final Parcelable.Creator<TimeCapabilities> CREATOR =
      new Parcelable.Creator<
          TimeCapabilities>() { // from class: android.app.time.TimeCapabilities.1
  ...
  public TimeConfiguration tryApplyConfigChanges(
      TimeConfiguration config, TimeConfiguration requestedChanges) {
  ...
  public boolean equals(Object o) {
    ...
    if (this.mConfigureAutoDetectionEnabledCapability
            == that.mConfigureAutoDetectionEnabledCapability
        && this.mSetManualTimeCapability == that.mSetManualTimeCapability
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(this.mSetManualTimeCapability));
  }

  public String toString() {
    return "TimeCapabilities{mUserHandle="
        + this.mUserHandle
  ...
  public static class Builder {
    ...
    public TimeCapabilities build() {
      verifyCapabilitySet(
          this.mConfigureAutoDetectionEnabledCapability, "configureAutoDetectionEnabledCapability");
