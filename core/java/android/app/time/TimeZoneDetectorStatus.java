...
public final class TimeZoneDetectorStatus implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        if (this.mDetectorStatus == that.mDetectorStatus
                && this.mTelephonyTimeZoneAlgorithmStatus.equals(
                        that.mTelephonyTimeZoneAlgorithmStatus)
                && this.mLocationTimeZoneAlgorithmStatus.equals(
                        that.mLocationTimeZoneAlgorithmStatus)) {
            return true;
        }
        return false;
    }
