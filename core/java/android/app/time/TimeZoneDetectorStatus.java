...
public final class TimeZoneDetectorStatus implements Parcelable {
  public static final Parcelable.Creator<TimeZoneDetectorStatus> CREATOR =
      new Parcelable.Creator<
          TimeZoneDetectorStatus>() { // from class: android.app.time.TimeZoneDetectorStatus.1
        ...
        public TimeZoneDetectorStatus createFromParcel(Parcel in) {
          ...
          TelephonyTimeZoneAlgorithmStatus telephonyTimeZoneAlgorithmStatus =
              (TelephonyTimeZoneAlgorithmStatus)
                  in.readParcelable(
                      getClass().getClassLoader(), TelephonyTimeZoneAlgorithmStatus.class);
          LocationTimeZoneAlgorithmStatus locationTimeZoneAlgorithmStatus =
              (LocationTimeZoneAlgorithmStatus)
                  in.readParcelable(
                      getClass().getClassLoader(), LocationTimeZoneAlgorithmStatus.class);
          return new TimeZoneDetectorStatus(
              detectorStatus, telephonyTimeZoneAlgorithmStatus, locationTimeZoneAlgorithmStatus);
        }
  ...
  public TimeZoneDetectorStatus(
    ...
    this.mTelephonyTimeZoneAlgorithmStatus =
        (TelephonyTimeZoneAlgorithmStatus) Objects.requireNonNull(telephonyTimeZoneAlgorithmStatus);
    this.mLocationTimeZoneAlgorithmStatus =
        (LocationTimeZoneAlgorithmStatus) Objects.requireNonNull(locationTimeZoneAlgorithmStatus);
  }
  ...
  public String toString() {
    return "TimeZoneDetectorStatus{mDetectorStatus="
        + DetectorStatusTypes.detectorStatusToString(this.mDetectorStatus)
  ...
  public boolean equals(Object o) {
    ...
    if (this.mDetectorStatus == that.mDetectorStatus
        && this.mTelephonyTimeZoneAlgorithmStatus.equals(that.mTelephonyTimeZoneAlgorithmStatus)
        && this.mLocationTimeZoneAlgorithmStatus.equals(that.mLocationTimeZoneAlgorithmStatus)) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        Integer.valueOf(this.mDetectorStatus),
        this.mTelephonyTimeZoneAlgorithmStatus,
        this.mLocationTimeZoneAlgorithmStatus);
  }
}
