...
public class AlertDialog extends Dialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder(Context context, int themeResId) {
            this.f18P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, themeResId)));
        ...
        public AlertDialog create() {
            AlertDialog dialog = new AlertDialog(this.f18P.mContext, this.mIsDeviceDefault ? this.mThemeResId : 0, false);
