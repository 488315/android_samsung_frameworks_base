...
public class GrammaticalInflectionManager {
    ...
    public void setSystemWideGrammaticalGender(int grammaticalGender) {
        ...
        try {
            this.mService.setSystemWideGrammaticalGender(
                    grammaticalGender, this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int getSystemGrammaticalGender() {
        try {
            return this.mService.getSystemGrammaticalGender(
                    this.mContext.getAttributionSource(), this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int peekSystemGrammaticalGenderByUserId(int userId) {
        try {
            return this.mService.peekSystemGrammaticalGenderByUserId(
                    this.mContext.getAttributionSource(), userId);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
