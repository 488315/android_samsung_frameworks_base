...
public interface ISearchUiManager extends IInterface {
  ...
  public static class Default implements ISearchUiManager {
    ...
    public void createSearchSession(SearchContext context, SearchSessionId sessionId, IBinder token)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements ISearchUiManager {
    ...
    private static class Proxy implements ISearchUiManager {
      ...
      public void createSearchSession(
          SearchContext context, SearchSessionId sessionId, IBinder token) throws RemoteException {
