...
public final class SearchSession implements AutoCloseable {
  ...
  SearchSession(Context context, SearchContext searchContext) {
    ...
    try {
      ...
      Log.m97e(TAG, "Failed to search session", e);
  ...
  public void registerEmptyQueryResultUpdateCallback(
    ...
    synchronized (this.mRegisteredCallbacks) {
      ...
      try {
        ...
        Log.m97e(TAG, "Failed to register for empty query result updates", e);
    ...
    synchronized (this.mRegisteredCallbacks) {
      ...
      if (this.mRegisteredCallbacks.containsKey(callback)) {
        try {
          ...
          Log.m97e(TAG, "Failed to unregister for empty query result updates", e);
          e.rethrowAsRuntimeException();
        }
      }
    }
  ...
  public void destroy() {
    if (!this.mIsClosed.getAndSet(true)) {
      ...
      try {
        ...
        Log.m97e(TAG, "Failed to notify search target event", e);
        e.rethrowFromSystemServer();
        return;
      }
    }
