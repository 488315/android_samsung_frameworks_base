...
public final class SearchAction implements Parcelable {
  public static final Parcelable.Creator<SearchAction> CREATOR =
      new Parcelable.Creator<SearchAction>() { // from class: android.app.search.SearchAction.1
  ...
  public String toString() {
    StringBuilder append =
        new StringBuilder()
            ...
            .append(this.mId)
            .append(" title=")
            .append((Object) this.mTitle)
            .append(" contentDescription=")
            .append((Object) this.mContentDescription)
            .append(" subtitle=")
            .append((Object) this.mSubtitle)
            .append(" icon=")
            .append(this.mIcon)
    ...
    String str =
        append
            .append(pendingIntent == null ? "" : pendingIntent.getIntent())
            .append(" intent=")
            .append(this.mIntent)
            .append(" userHandle=")
            .append(this.mUserHandle)
            .toString();
    return str;
  }
