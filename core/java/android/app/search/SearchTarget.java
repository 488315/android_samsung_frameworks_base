...
public final class SearchTarget implements Parcelable {
  public static final Parcelable.Creator<SearchTarget> CREATOR =
      new Parcelable.Creator<SearchTarget>() { // from class: android.app.search.SearchTarget.1
  ...
  private SearchTarget(Parcel parcel) {
    ...
    this.mUserHandle = UserHandle.m55of(parcel.readInt());
  ...
  public static final class Builder {
    ...
    public Builder setAppWidgetProviderInfo(AppWidgetProviderInfo appWidgetProviderInfo) {
      ...
      if (str != null && !str.equals(appWidgetProviderInfo.provider.getPackageName())) {
        throw new IllegalStateException(
            "SearchTarget packageName is different from appWidgetProviderInfo's packageName");
      }
      return this;
    }
