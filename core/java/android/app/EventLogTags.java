...
public class EventLogTags {
  ...
  public static void writeWmOnPausedCalled(
      int token, String componentName, String reason, long time) {
    EventLog.writeEvent(
        WM_ON_PAUSED_CALLED, Integer.valueOf(token), componentName, reason, Long.valueOf(time));
  }

  public static void writeWmOnResumeCalled(
      int token, String componentName, String reason, long time) {
    EventLog.writeEvent(
        WM_ON_RESUME_CALLED, Integer.valueOf(token), componentName, reason, Long.valueOf(time));
  }

  public static void writeWmOnStopCalled(
      int token, String componentName, String reason, long time) {
    EventLog.writeEvent(
        WM_ON_STOP_CALLED, Integer.valueOf(token), componentName, reason, Long.valueOf(time));
  }

  public static void writeWmOnCreateCalled(
      int token, String componentName, String reason, long time) {
    EventLog.writeEvent(
        WM_ON_CREATE_CALLED, Integer.valueOf(token), componentName, reason, Long.valueOf(time));
  }

  public static void writeWmOnRestartCalled(
      int token, String componentName, String reason, long time) {
    EventLog.writeEvent(
        WM_ON_RESTART_CALLED, Integer.valueOf(token), componentName, reason, Long.valueOf(time));
  }

  public static void writeWmOnStartCalled(
      int token, String componentName, String reason, long time) {
    EventLog.writeEvent(
        WM_ON_START_CALLED, Integer.valueOf(token), componentName, reason, Long.valueOf(time));
  }

  public static void writeWmOnDestroyCalled(
      int token, String componentName, String reason, long time) {
    EventLog.writeEvent(
        WM_ON_DESTROY_CALLED, Integer.valueOf(token), componentName, reason, Long.valueOf(time));
  }

  public static void writeWmOnActivityResultCalled(int token, String componentName, String reason) {
    EventLog.writeEvent(
        WM_ON_ACTIVITY_RESULT_CALLED, Integer.valueOf(token), componentName, reason);
  }

  public static void writeWmOnTopResumedGainedCalled(
      int token, String componentName, String reason) {
    EventLog.writeEvent(
        WM_ON_TOP_RESUMED_GAINED_CALLED, Integer.valueOf(token), componentName, reason);
  }

  public static void writeWmOnTopResumedLostCalled(int token, String componentName, String reason) {
    EventLog.writeEvent(
        WM_ON_TOP_RESUMED_LOST_CALLED, Integer.valueOf(token), componentName, reason);
  }
