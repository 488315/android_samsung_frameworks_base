...
public class SearchManager
  ...
  public void startSearch(
    ...
    startSearch(
        initialQuery, selectInitialQuery, launchActivity, appSearchData, globalSearch, null);
  }
  ...
  void startGlobalSearch(
    ...
    if (globalSearchActivity == null) {
      Log.m102w(TAG, "No global search activity found.");
      return;
    }
    ...
    try {
      ...
      Log.m96e(TAG, "Global search activity not found: " + globalSearchActivity);
    }
  }
  ...
  public void triggerSearch(String query, ComponentName launchActivity, Bundle appSearchData) {
    if (query == null || TextUtils.getTrimmedLength(query) == 0) {
      Log.m102w(TAG, "triggerSearch called with empty query, ignoring.");
    } else {
  ...
  public List<SearchableInfo> semGetSearchablesInInsightSearch(boolean includeGlobalSearch) {
    try {
      ...
      Log.m96e(TAG, "semGetSearchablesInInsightSearch() failed: " + e);
