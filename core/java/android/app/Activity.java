...
public class Activity extends ContextThemeWrapper
  ...
  private final GestureDetector.SimpleOnGestureListener mLongPressListener =
      new GestureDetector.SimpleOnGestureListener() { // from class: android.app.Activity.4
  ...
  private void notifyVoiceInteractionManagerServiceActivityEvent(int type) {
    if (this.mVoiceInteractionManagerService == null) {
      IVoiceInteractionManagerService asInterface =
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      ...
      fragmentController.restoreAllState(
          p, nonConfigurationInstances2 != null ? nonConfigurationInstances2.fragments : null);
    }
  ...
  protected void onResume() {
    ...
    if (this.mIsInPictureInPictureMode
      ...
      Slog.m121w(TAG, "[PipTaskOrganizer] init mIsInPictureInPictureMode false activity=" + this);
  ...
  final void performTopResumedActivityChanged(boolean isTopResumedActivity, String reason) {
    if (MultiWindowCoreState.MW_MULTISTAR_STAY_TOP_RESUMED_ACTIVITY_DYNAMIC_ENABLED
        && this.mResumed
  ...
  public final void requestShowKeyboardShortcuts() {
    ComponentName sysuiComponent =
        ComponentName.unflattenFromString(
            getResources().getString(C4337R.string.config_systemUIServiceComponent));
    ...
    if (ab instanceof WindowDecorActionBar) {
      throw new IllegalStateException(
          "This Activity already has an action bar supplied by the window decor. Do not request"
              + " Window.FEATURE_ACTION_BAR and set android:windowActionBar to false in your theme"
  ...
  public boolean onKeyDown(int keyCode, KeyEvent event) {
    ...
    if (keyCode == 4) {
      if (getApplicationInfo().targetSdkVersion >= 5) {
        Slog.m113d(TAG, "onKeyDown(KEYCODE_BACK)");
        event.startTracking();
      } else {
        onBackPressed();
      }
  ...
  public boolean onMenuOpened(int featureId, Menu menu) {
    if (featureId == 8) {
      ...
      if (actionBar != null) {
        ...
        Log.m96e(TAG, "Tried to open action bar menu with no action bar");
      }
    }
    return true;
  }
    ...
    switch (featureId) {
      case 0:
        ...
        if (item.getItemId() != 16908332
            || (actionBar = this.mActionBar) == null
            || (actionBar.getDisplayOptions() & 4) == 0) {
          return false;
        }
    ...
    if (upIntent != null) {
      ...
      if (shouldUpRecreateTask(upIntent)) {
        ...
        if (this.mResultCode != 0 || this.mResultData != null) {
          Log.m98i(TAG, "onNavigateUp only finishing topmost activity to return a result");
          finish();
          return true;
        }
        finishAffinity();
  ...
  protected void onApplyThemeResource(Resources.Theme theme, int resid, boolean first) {
    ...
    TypedArray a = theme.obtainStyledAttributes(C4337R.styleable.ActivityTaskDescription);
  ...
  public final void requestPermissions(String[] permissions, int requestCode) {
    ...
    if (this.mHasCurrentPermissionsRequest) {
      Log.m102w(TAG, "Can request only one set of permissions at a time");
    ...
    if (activity == null) {
      ...
      if (ar != null) {
        this.mMainThread.sendActivityResult(
            this.mToken, this.mEmbeddedID, requestCode, ar.getResultCode(), ar.getResultData());
      }
      if (requestCode >= 0) {
  ...
  private Bundle transferSpringboardActivityOptions(Bundle options) {
    ...
    if (options == null
        && (window = this.mWindow) != null
        && !window.isActive()
        && (activityOptions = getActivityOptions()) != null
  ...
  public void startActivityAsCaller(
      Intent intent, Bundle options, boolean ignoreTargetSecurity, int userId, int requestCode) {
    if (this.mParent != null) {
      throw new RuntimeException("Can't be called from a child");
    }
    Bundle options2 = transferSpringboardActivityOptions(options);
  ...
  public void startIntentSenderForResult(
    ...
    startIntentSenderForResult(
        intent, requestCode, fillInIntent, flagsMask, flagsValues, extraFlags, (Bundle) null);
  }
  ...
  public void startIntentSenderForResult(
    ...
    if (activity == null) {
      startIntentSenderForResultInner(
          intent, this.mEmbeddedID, requestCode, fillInIntent, flagsMask, flagsValues, options);
  ...
  public void startActivityFromChild(
    ...
    if (ar != null) {
      this.mMainThread.sendActivityResult(
          this.mToken, child.mEmbeddedID, requestCode, ar.getResultCode(), ar.getResultData());
    }
    cancelInputsAndStartExitTransition(options2);
  }
    ...
    if (widthDp == null || widthDp.length == 2) {
      if (heightDp == null || heightDp.length == 2) {
        if (marginDp == null || marginDp.length == 2) {
          ...
          ActivityClient.getInstance()
              .adjustPopOverOptions(this.mToken, widthDp, heightDp, marginDp, position);
        }
      }
    }
  }
  ...
  public Uri getReferrer() {
    if (CoreRune.SYSFW_APP_SPEG && SPEG_PACKAGE_NAME.equals(this.mReferrer)) {
      ...
      if (resolveInfo == null) {
        Log.m102w("SPEG", "resolveInfo is null");
        return null;
      }
      Log.m98i("SPEG", "Pretend to be the default launcher");
    ...
    if (intent != null) {
      try {
        ...
        Log.m102w(
            TAG,
            "Cannot read referrer from intent; intent extras contain unknown custom Parcelable"
                + " objects");
      }
    }
  ...
  public PendingIntent createPendingResult(int requestCode, Intent data, int flags) {
    ...
    try {
      ...
      IIntentSender target =
          service.getIntentSenderWithFeature(
              3,
              packageName,
              attributionTag,
              activity == null ? this.mToken : activity.mToken,
              this.mEmbeddedID,
              requestCode,
              new Intent[] {data},
              null,
  ...
  public void dumpInternal(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
    ...
    if (dumpInternalState) {
      ...
      Log.m98i(TAG, "Not calling dump() on " + this + " because of special argument " + arg);
    }
  }
  ...
  public void semConvertFromTranslucent(boolean skipSetWindowOpaque) {
    Log.m94d(
        TAG, "semConvertFromTranslucent, activity=" + this + ", caller=" + Debug.getCallers(3));
    this.mTranslucentCallback = null;
  ...
  public boolean convertToTranslucent(
    ...
    this.mChangeCanvasToTranslucent =
        ActivityClient.getInstance()
            .convertToTranslucent(this.mToken, options == null ? null : options.toBundle());
    WindowManagerGlobal.getInstance().changeCanvasOpacity(this.mToken, false);
    if (!this.mChangeCanvasToTranslucent
        && (translucentConversionListener = this.mTranslucentCallback) != null) {
  ...
  public boolean convertToTranslucent(
      final SemTranslucentConversionListener callback, ActivityOptions options) {
  ...
  public boolean semConvertToTranslucent(final SemTranslucentConversionListener callback) {
    Log.m94d(TAG, "semConvertToTranslucent, activity=" + this + ", caller=" + Debug.getCallers(3));
    return convertToTranslucent(
        new TranslucentConversionListener() { // from class: android.app.Activity.3
          @Override // android.app.Activity.TranslucentConversionListener
          public void onTranslucentConversionComplete(boolean drawComplete) {
            SemTranslucentConversionListener semTranslucentConversionListener = callback;
            if (semTranslucentConversionListener != null) {
  ...
  public Intent getParentActivityIntent() {
    ...
    try {
      ...
      Log.m96e(
          TAG, "getParentActivityIntent: bad parentActivityName '" + parentName + "' in manifest");
      return null;
    }
  }
  ...
  */
  final void attach(
    ...
    if (!CoreRune.SYSFW_APP_SPEG) {
      ...
      str = referrer;
      if (SPEG_PACKAGE_NAME.equals(str)
          || ((activity2 = this.mParent) != null
              && SPEG_PACKAGE_NAME.equals(activity2.mReferrer))) {
        Slog.m117i("SPEG", "Activity launched by SPEG");
        ...
        if (!CoreRune.SAFE_DEBUG) {
          Log.m98i(
              TAG,
              "attach mDexTaskDocking="
                  + WindowConfiguration.dexTaskDockingStateToString(this.mDexTaskDocking));
          return;
        }
        return;
      }
  ...
  final void performCreate(Bundle icicle, PersistableBundle persistentState) {
    ...
    if (CoreRune.MT_SUPPORT_COMPAT_SANDBOX) {
      windowingMode =
          CompatSandbox.getCompatWindowingMode(getResources().getConfiguration(), windowingMode);
    }
    ...
    this.mShouldDockBigOverlays =
        getResources().getBoolean(C4337R.bool.config_dockBigOverlayWindows);
  ...
  final void performStart(String reason) {
    ...
    if (!this.mWindowAdded) {
      boolean hasOverrideNightMode =
          this.mCurrentConfig.isNightModeActive()
  ...
  final void performResume(boolean followedByPause, String reason) {
    ...
    if (!this.mVisibleFromClient && !this.mFinished) {
      Log.m102w(TAG, "An activity without a UI must call finish() before onResume() completes");
    ...
    if (this.mWindow.getDecorView() != null) {
      boolean split =
          this.mWindowingMode == 6
              && WindowConfiguration.isSplitScreenWindowingMode(newConfig.windowConfiguration);
    ...
    if (who == null) {
      ...
      while (it.hasNext()) {
        ...
        if (viewRoot.getView() != null
            && viewRoot.getView().dispatchActivityResult(who, requestCode, resultCode, data)) {
          return;
        }
      }
  ...
  public void registerRemoteAnimations(RemoteAnimationDefinition definition) {
    Slog.m113d(TAG, "registerRemoteAnimations, activity=" + this + ", definition=" + definition);
    ...
    public void onStartIntentSenderFromFragment(
      ...
      if (Activity.this.mParent == null) {
        ...
        Activity.this.mParent.startIntentSenderFromFragment(
            fragment, intent, requestCode, fillInIntent, flagsMask, flagsValues, options);
      }
    }
  ...
  private void startAppLockService() {
    ...
    try {
      ActivityTaskManager.getService()
          .startAppLockService(this.mToken, getIntent(), showWhenLocked, getPackageName());
    } catch (RemoteException e) {
    }
  }
