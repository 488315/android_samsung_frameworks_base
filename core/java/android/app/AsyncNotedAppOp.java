...
public final class AsyncNotedAppOp implements Parcelable {
  ...
  public AsyncNotedAppOp(
    ...
    AnnotationValidations.validate(
        (Class<IntRange>) IntRange.class, (IntRange) null, opCode, "from", 0L);
    this.mNotingUid = notingUid;
    AnnotationValidations.validate(
        (Class<IntRange>) IntRange.class, (IntRange) null, notingUid, "from", 0L);
    ...
    this.mTime = time;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) CurrentTimeMillisLong.class, (Annotation) null, time);
    onConstructed();
  }
