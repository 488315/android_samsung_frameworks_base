...
public final class ExecuteAppFunctionResponse implements Parcelable {
                    ...
                    GenericDocumentWrapper resultWrapper =
                            (GenericDocumentWrapper)
                                    Objects.requireNonNull(
                                            GenericDocumentWrapper.CREATOR.createFromParcel(
                                                    parcel));
                    Bundle extras =
                            (Bundle)
                                    Objects.requireNonNull(
    ...
    public ExecuteAppFunctionResponse(GenericDocument resultDocument, Bundle extras) {
        this.mResultDocumentWrapper =
                new GenericDocumentWrapper(
                        (GenericDocument) Objects.requireNonNull(resultDocument));
