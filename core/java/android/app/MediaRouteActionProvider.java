...
public class MediaRouteActionProvider extends ActionProvider {
    ...
    public View onCreateActionView(MenuItem item) {
        if (this.mButton != null) {
            Log.m96e(TAG, "onCreateActionView: this ActionProvider is already associated with a menu item. Don't reuse MediaRouteActionProvider instances! Abandoning the old one...");
        }
