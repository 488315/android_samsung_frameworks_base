...
import android.content.p001om.OverlayManager;
import android.content.p002pm.ApplicationInfo;
import android.content.p002pm.CrossProfileApps;
import android.content.p002pm.DataLoaderManager;
import android.content.p002pm.ICrossProfileApps;
import android.content.p002pm.IDataLoaderManager;
...
import android.content.p002pm.verify.domain.DomainVerificationManager;
import android.content.p002pm.verify.domain.IDomainVerificationManager;
...
import android.media.p008tv.ITvInputManager;
import android.media.p008tv.TvInputManager;
import android.media.p008tv.interactive.ITvInteractiveAppManager;
import android.media.p008tv.interactive.TvInteractiveAppManager;
import android.media.p008tv.tunerresourcemanager.ITunerResourceManager;
...
import android.p009os.BatteryStatsManager;
import android.p009os.BugreportManager;
import android.p009os.CustomFrequencyManager;
import android.p009os.DropBoxManager;
import android.p009os.HardwarePropertiesManager;
import android.p009os.IBatteryPropertiesRegistrar;
import android.p009os.IBinder;
import android.p009os.ICustomFrequencyManager;
import android.p009os.IDumpstate;
import android.p009os.IHardwarePropertiesManager;
import android.p009os.IPowerManager;
import android.p009os.IRecoverySystem;
import android.p009os.ISemHcmManager;
import android.p009os.ISemHqmManager;
import android.p009os.ISystemUpdateManager;
import android.p009os.IThermalService;
import android.p009os.IUserManager;
import android.p009os.IncidentManager;
import android.p009os.PerformanceHintManager;
import android.p009os.PermissionEnforcer;
import android.p009os.PowerManager;
import android.p009os.Process;
import android.p009os.RecoverySystem;
import android.p009os.SemHcmManager;
import android.p009os.SemHqmManager;
import android.p009os.ServiceManager;
import android.p009os.SystemConfigManager;
import android.p009os.SystemUpdateManager;
import android.p009os.SystemVibrator;
import android.p009os.SystemVibratorManager;
import android.p009os.UserHandle;
import android.p009os.UserManager;
import android.p009os.Vibrator;
import android.p009os.VibratorManager;
import android.p009os.health.SystemHealthManager;
import android.p009os.image.DynamicSystemManager;
import android.p009os.image.IDynamicSystemService;
import android.p009os.incremental.IIncrementalService;
...
import com.android.internal.p029os.IDropBoxManagerService;
...
public final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.TETHERING_SERVICE, TetheringManager.class, new SystemServiceRegistryCachedServiceFetcherC027322());
        ...
        registerService(Context.HQM_SERVICE, SemHqmManager.class, new CachedServiceFetcher<SemHqmManager>() { // from class: android.app.SystemServiceRegistry.28
            ...
            public SemHqmManager createService(ContextImpl ctx) {
                ...
                if (service == null) {
                    Log.m96e(SystemServiceRegistry.TAG, "Failed to get Hqm manager service.");
                    return null;
                }
        ...
        if (!"0".equals(SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_SYSTEM_CONFIG_HCM_AI_POWER_SAVING_LEVEL"))) {
            registerService(Context.HCM_SERVICE, SemHcmManager.class, new CachedServiceFetcher<SemHcmManager>() { // from class: android.app.SystemServiceRegistry.29
                ...
                public SemHcmManager createService(ContextImpl ctx) {
                    ...
                    if (service == null) {
                        Log.m96e(SystemServiceRegistry.TAG, "Failed to get Hcm manager service.");
                        return null;
                    }
        ...
        registerService(Context.SEM_LOCATION_SERVICE, SemLocationManager.class, new CachedServiceFetcher<SemLocationManager>() { // from class: android.app.SystemServiceRegistry.41
            ...
            public SemLocationManager createService(ContextImpl ctx) throws ServiceManager.ServiceNotFoundException {
                Log.m96e(SystemServiceRegistry.TAG, "create SemLocationManager service");
        ...
        registerService("wallpaper", WallpaperManager.class, new CachedServiceFetcher<WallpaperManager>() { // from class: android.app.SystemServiceRegistry.69
            ...
            public WallpaperManager createService(ContextImpl ctx) throws ServiceManager.ServiceNotFoundException {
                ...
                if (b == null) {
                    ...
                    boolean enabled = Resources.getSystem().getBoolean(C4337R.bool.config_enableWallpaperService);
                    if (!enabled) {
                        return DisabledWallpaperManager.getInstance();
                    }
                    Log.m96e(SystemServiceRegistry.TAG, "No wallpaper service");
                }
        ...
        try {
            isExynosDisplaySolutionService = Resources.getSystem().getBoolean(C4337R.bool.config_enableExynosDisplaySolutionService);
        } catch (Exception e) {
            Slog.m116e(TAG, "Not starting ExynosDisplaySolutionService", e);
        }
        if (isExynosDisplaySolutionService) {
            registerService(Context.EXYNOS_DISPLAY_SOLUTION_SERVICE, ExynosDisplaySolutionManager.class, new CachedServiceFetcher<ExynosDisplaySolutionManager>() { // from class: android.app.SystemServiceRegistry.155
                ...
                public ExynosDisplaySolutionManager createService(ContextImpl ctx) {
                    ...
                    if (service == null) {
                        Log.m96e(SystemServiceRegistry.TAG, "Failed to get ExynosDisplaySolution Manager Service.");
                        return null;
                    }
        ...
        registerService(Context.SEM_MULTI_CONTROL_SERVICE, SemMultiControlManager.class, new CachedServiceFetcher<SemMultiControlManager>() { // from class: android.app.SystemServiceRegistry.160
            ...
            public SemMultiControlManager createService(ContextImpl ctx) {
                ...
                if (service == null) {
                    Log.m96e(SystemServiceRegistry.TAG, "SemMultiControlManager is not supported");
                    return null;
                }
        ...
        registerService(Context.SEM_REMOTE_APP_MODE_SERVICE, SemRemoteAppModeManager.class, new CachedServiceFetcher<SemRemoteAppModeManager>() { // from class: android.app.SystemServiceRegistry.164
            ...
            public SemRemoteAppModeManager createService(ContextImpl ctx) {
                ...
                if (service == null) {
                    Log.m96e(SystemServiceRegistry.TAG, "SemRemoteAppModeManager is not supported");
                    return null;
                }
        ...
        Log.m96e(TAG, "SemDisplayQualityFeature.ENABLED:" + SemDisplayQualityFeature.ENABLED + ",PLATFORM:" + SemDisplayQualityFeature.PLATFORM);
        ...
        registerService(Context.SEM_DESKTOP_MODE_SERVICE, SemDesktopModeManager.class, new CachedServiceFetcher<SemDesktopModeManager>() { // from class: android.app.SystemServiceRegistry.171
            ...
            public SemDesktopModeManager createService(ContextImpl ctx) {
                ...
                if (service == null) {
                    Log.m96e(SystemServiceRegistry.TAG, "SemDesktopModeManager is not supported");
                    return null;
                }
    ...
    class SystemServiceRegistryCachedServiceFetcherC027322 extends CachedServiceFetcher<TetheringManager> {
        SystemServiceRegistryCachedServiceFetcherC027322() {
        }
                    ...
                    synchronized (r0) {
                        while (gates[this.mCacheIndex] < 2) {
                            try {
                                ...
                                Slog.m121w(SystemServiceRegistry.TAG, "getService() interrupted");
                                interrupted = true;
                            }
                        }
                    }
