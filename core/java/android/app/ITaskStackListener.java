...
public interface ITaskStackListener extends IInterface {
  ...
  public static class Default implements ITaskStackListener {
    ...
    public void onActivityLaunchOnSecondaryDisplayFailed(
        ActivityManager.RunningTaskInfo taskInfo, int requestedDisplayId) throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 16:
              ...
              return true;
            case 17:
              ActivityManager.RunningTaskInfo _arg014 =
                  (ActivityManager.RunningTaskInfo)
                      data.readTypedObject(ActivityManager.RunningTaskInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 23:
              ...
              return true;
            case 24:
              ActivityManager.RunningTaskInfo _arg020 =
                  (ActivityManager.RunningTaskInfo)
                      data.readTypedObject(ActivityManager.RunningTaskInfo.CREATOR);
              data.enforceNoDataAvail();
