...
public class BaseTemplateData implements Parcelable {
  ...
  public static final class SubItemLoggingInfo implements Parcelable {
    ...
    public int hashCode() {
      return Objects.hash(
          Integer.valueOf(this.mInstanceId), Integer.valueOf(this.mFeatureType), this.mPackageName);
    }
