...
public final class Icon implements Parcelable {
  public static final Parcelable.Creator<Icon> CREATOR =
      new Parcelable.Creator<Icon>() { // from class: android.app.smartspace.uitemplatedata.Icon.1
  ...
  Icon(Parcel in) {
    this.mIcon =
        (android.graphics.drawable.Icon) in.readTypedObject(android.graphics.drawable.Icon.CREATOR);
    this.mContentDescription = TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(in);
    this.mShouldTint = in.readBoolean();
  }

  private Icon(
      android.graphics.drawable.Icon icon, CharSequence contentDescription, boolean shouldTint) {
    this.mIcon = icon;
