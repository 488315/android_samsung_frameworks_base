...
public interface IGameModeListener extends IInterface {
  ...
  public static class Default implements IGameModeListener {
    ...
    public void onGameModeChanged(String packageName, int gameModeFrom, int gameModeTo, int userId)
  ...
  public abstract static class Stub extends Binder implements IGameModeListener {
    ...
    private static class Proxy implements IGameModeListener {
      ...
      public void onGameModeChanged(
          String packageName, int gameModeFrom, int gameModeTo, int userId) throws RemoteException {
