...
public abstract class LauncherActivity extends ListActivity {
  ...
  private class ActivityAdapter extends BaseAdapter implements Filterable {
    ...
    public ActivityAdapter(IconResizer resizer) {
      ...
      this.mInflater =
          (LayoutInflater) LauncherActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      View view;
      if (convertView == null) {
        view = this.mInflater.inflate(C4337R.layout.activity_list_item_2, parent, false);
      } else {
        view = convertView;
      }
        ...
        if (item.icon == null) {
          item.icon =
              this.mIconResizer.createIconThumbnail(
                  item.resolveInfo.loadIcon(LauncherActivity.this.getPackageManager()));
        }
  ...
  private void updateAlertTitle() {
    TextView alertTitle = (TextView) findViewById(C4337R.id.alertTitle);
    if (alertTitle != null) {
  ...
  protected void onSetContentView() {
    setContentView(C4337R.layout.activity_list);
  }
