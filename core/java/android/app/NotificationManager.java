...
public class NotificationManager {
  ...
  public void notifyAsPackage(String targetPackage, String tag, int id, Notification notification) {
    ...
    try {
      Slog.m117i(
          TAG, sender + ": notify(" + id + ", " + tag + ", " + notification + ") as package");
  ...
  public void notifyAsUser(String tag, int id, Notification notification, UserHandle user) {
    ...
    try {
      Slog.m117i(TAG, pkg + ": notify(" + id + ", " + tag + ", " + notification + ") as user");
      service.enqueueNotificationWithTag(
          pkg,
  ...
  public void cancelAsUser(String tag, int id, UserHandle user) {
    ...
    String pkg = this.mContext.getPackageName();
    if (localLOGV) {
      Log.m100v(TAG, pkg + ": cancel(" + id + NavigationBarInflaterView.KEY_CODE_END);
    }
    try {
      service.cancelNotificationWithTag(
  ...
  public static class Policy implements Parcelable {
    ...
    public static final Parcelable.Creator<Policy> CREATOR =
        new Parcelable.Creator<Policy>() { // from class: android.app.NotificationManager.Policy.1
    ...
    public boolean equals(Object o) {
      ...
      return other.priorityCategories == this.priorityCategories
          ...
          && (list = other.mExceptionContacts) != null
          && list.equals(this.mExceptionContacts)
          && (list2 = other.mAppBypassDndList) != null
          && list2.equals(this.mAppBypassDndList);
    }
    ...
    private boolean suppressedVisualEffectsEqual(
      ...
      if ((suppressedEffects & 2) != (otherSuppressedVisualEffects & 2)) {
        int currSuppressedEffects =
            (suppressedEffects & 2) != 0 ? otherSuppressedVisualEffects : suppressedEffects;
      ...
      if (currSuppressedEffects2 != (otherSuppressedVisualEffects & 1)) {
        int currSuppressedEffects3 =
            (suppressedEffects & 1) != 0 ? otherSuppressedVisualEffects : suppressedEffects;
    ...
    public String toString() {
      ...
      StringBuilder append =
          new StringBuilder()
              .append("NotificationManager.Policy[priorityCategories=")
              ...
              .append(",areChannelsBypassingDnd=");
      int i = this.state;
      if (i == -1) {
        str = "unset";
      } else if ((i & 1) != 0) {
    ...
    public void addAppBypassDnd(String pkg, int uid, boolean allow) {
      ...
      for (String s : this.mAppBypassDndList) {
        Log.m94d(NotificationManager.TAG, "addAppBypassDnd app=" + s);
      }
    }

    public void setAppBypassDndList(List<String> appBypassDndList) {
      Log.m94d(NotificationManager.TAG, "set bypass dnd app list");
      if (this.mAppBypassDndList == null) {
        this.mAppBypassDndList = new ArrayList();
      }
  ...
  private static class EdgeNotificationManager {
    ...
    public void removeEdgeNotification(int id, Bundle extra) {
      Log.m98i(TAG, "removeEdgeNotification:" + id);
    ...
    public void postEdgeNotification(int id, Bundle extra) {
      Log.m98i(TAG, "postEdgeNotification:" + id);
      if (extra == null || extra.getString(EXTRA_SAMSUNG_NOTIFICATION_TYPE) != null) {
    ...
    public void postEdgeNotificationByNormal(int id, Notification notification) {
      if (notification.extras != null
        ...
        Log.m98i(TAG, "postEdgeNotificationByNormal");
