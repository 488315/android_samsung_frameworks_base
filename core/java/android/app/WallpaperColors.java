...
public final class WallpaperColors implements Parcelable {
  ...
  public static WallpaperColors fromBitmap(Bitmap bitmap, float dimAmount) {
    ...
    if (bitmapArea > MAX_WALLPAPER_EXTRACTION_AREA) {
      ...
      bitmap =
          Bitmap.createScaledBitmap(bitmap, optimalSize.getWidth(), optimalSize.getHeight(), false);
    }
    ...
    swatches.sort(
        new Comparator() { // from class: android.app.WallpaperColors$$ExternalSyntheticLambda0
  ...
  public WallpaperColors(Map<Integer, Integer> colorToPopulation, int colorHints) {
    ...
    mapEntries.sort(
        new Comparator() { // from class: android.app.WallpaperColors$$ExternalSyntheticLambda1
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            int compareTo;
            compareTo =
