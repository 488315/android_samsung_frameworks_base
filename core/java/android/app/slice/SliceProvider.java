...
public abstract class SliceProvider extends ContentProvider {
  ...
  public SliceProvider(String... autoGrantPermissions) {
    this.mAnr =
        new Runnable() { // from class: android.app.slice.SliceProvider$$ExternalSyntheticLambda0
  ...
  public Bundle call(String method, String arg, Bundle extras) {
    if (method.equals(METHOD_SLICE)) {
      Uri uri =
          getUriWithoutUserId(
              validateIncomingUriOrNull((Uri) extras.getParcelable("slice_uri", Uri.class)));
    ...
    try {
      ...
      Slice.Builder childAction =
          new Slice.Builder(parent)
              .addIcon(
                  Icon.createWithResource(context, C4337R.drawable.ic_permission),
                  null,
      ...
      parent.addSubSlice(
          new Slice.Builder(sliceUri.buildUpon().appendPath("permission").build())
              .addIcon(
                  Icon.createWithResource(context, C4337R.drawable.ic_arrow_forward),
                  null,
                  Collections.emptyList())
              .addText(getPermissionString(context, callingPackage), null, Collections.emptyList())
  ...
  public static Intent createPermissionIntent(
    ...
    intent.setComponent(
        ComponentName.unflattenFromString(
            context.getResources().getString(C4337R.string.config_slicePermissionComponent)));
  ...
  public static CharSequence getPermissionString(Context context, String callingPackage) {
    ...
    try {
      return context.getString(
          C4337R.string.slices_permission_request,
