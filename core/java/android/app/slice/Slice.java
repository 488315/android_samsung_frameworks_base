...
public final class Slice implements Parcelable {
  ...
  @Deprecated public static final String SUBTYPE_SLIDER = "slider";
  ...
  public static class Builder {
    ...
    public Builder addSubSlice(Slice slice, String subType) {
      ...
      this.mItems.add(
          new SliceItem(
              ...
              "slice",
              subType,
              (String[]) slice.getHints().toArray(new String[slice.getHints().size()])));
      return this;
    }
    ...
    public Builder addAction(PendingIntent action, Slice s, String subType) {
      ...
      this.mItems.add(
          new SliceItem(
              action, s, "action", subType, (String[]) hints.toArray(new String[hints.size()])));
      return this;
    }
