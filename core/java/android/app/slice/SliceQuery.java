...
public class SliceQuery {
  ...
  private static boolean contains(SliceItem container, final SliceItem item) {
    ...
    return stream(container)
        .filter(
            new Predicate() { // from class: android.app.slice.SliceQuery$$ExternalSyntheticLambda0
  ...
  public static SliceItem find(Slice s, String type, String[] hints, String[] nonHints) {
    ...
    return find(
        new SliceItem(s, "slice", (String) null, (String[]) h.toArray(new String[h.size()])),
        type,
        hints,
        nonHints);
  }
  ...
  public static SliceItem find(
    ...
    return stream(s)
        .filter(
            new Predicate() { // from class: android.app.slice.SliceQuery$$ExternalSyntheticLambda2
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
