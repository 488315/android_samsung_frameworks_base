    ...
    public abstract static class Stub extends Binder implements IJobService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
            ...
            switch (code) {
                case 1:
                    JobParameters _arg0 =
                            (JobParameters) data.readTypedObject(JobParameters.CREATOR);
        ...
        private static class Proxy implements IJobService {
            ...
            @Override // android.app.job.IJobService
            public void getTransferredDownloadBytes(
                    JobParameters jobParams, JobWorkItem jobWorkItem) throws RemoteException {
                Parcel _data = Parcel.obtain(asBinder());
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeTypedObject(jobParams, 0);
