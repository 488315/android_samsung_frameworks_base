    ...
    public static final class Builder {
        ...
        public Builder setPeriodic(long intervalMillis, long flexMillis) {
            ...
            if (intervalMillis < minPeriod) {
                Log.m102w(JobInfo.TAG, "Requested interval " + TimeUtils.formatDuration(intervalMillis) + " for job " + this.mJobId + " is too small; raising to " + TimeUtils.formatDuration(minPeriod));
            ...
            if (flexMillis < minFlex) {
                Log.m102w(JobInfo.TAG, "Requested flex " + TimeUtils.formatDuration(flexMillis) + " for job " + this.mJobId + " is too small; raising to " + TimeUtils.formatDuration(minFlex));
                flexMillis = minFlex;
            }
        ...
        public Builder setBackoffCriteria(long initialBackoffMillis, int backoffPolicy) {
            ...
            if (initialBackoffMillis < minBackoff) {
                Log.m102w(JobInfo.TAG, "Requested backoff " + TimeUtils.formatDuration(initialBackoffMillis) + " for job " + this.mJobId + " is too small; raising to " + TimeUtils.formatDuration(minBackoff));
