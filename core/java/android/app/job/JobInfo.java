...
public class JobInfo implements Parcelable {
  ...
  public boolean equals(Object o) {
    ...
    return this.jobId == j.jobId
        ...
        && this.mPreferredConstraintFlags == j.mPreferredConstraintFlags
  ...
  public int hashCode() {
    ...
    int hashCode3 =
        (((hashCode2 * 31) + this.constraintFlags) * 31) + this.mPreferredConstraintFlags;
    ...
    int hashCode4 =
        (((((((hashCode3 * 31) + Long.hashCode(this.triggerContentUpdateDelay)) * 31)
                            + Long.hashCode(this.triggerContentMaxDelay))
                        * 31)
    ...
    return (((((((((((((((((((((((((((hashCode4 * 31) + Long.hashCode(this.networkDownloadBytes))
                                                                                                            * 31)
                                                                                                        + Long
                                                                                                            .hashCode(
                                                                                                                this
                                                                ...
                                                                + Boolean.hashCode(
                                                                    this.isPersisted))
                                                            * 31)
                                                        + Long.hashCode(this.intervalMillis))
                                                    * 31)
                                                + Long.hashCode(this.flexMillis))
                                            * 31)
                                        + Long.hashCode(this.initialBackoffMillis))
                                    * 31)
                                + this.backoffPolicy)
                            * 31)
                        + this.mBias)
  ...
  public static final class TriggerContentUri implements Parcelable {
    public static final Parcelable.Creator<TriggerContentUri> CREATOR =
        new Parcelable.Creator<
            TriggerContentUri>() { // from class: android.app.job.JobInfo.TriggerContentUri.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
  ...
  public static final class Builder {
    ...
    public Builder setPrefersBatteryNotLow(boolean prefersBatteryNotLow) {
      this.mPreferredConstraintFlags =
          (this.mPreferredConstraintFlags & (-3)) | (prefersBatteryNotLow ? 2 : 0);
      return this;
    }
    ...
    public Builder setPrefersDeviceIdle(boolean prefersDeviceIdle) {
      this.mPreferredConstraintFlags =
          (this.mPreferredConstraintFlags & (-5)) | (prefersDeviceIdle ? 4 : 0);
      return this;
    }
    ...
    public JobInfo build(
        boolean disallowPrefetchDeadlines, boolean rejectNegativeNetworkEstimates) {
      if (this.mBackoffPolicySet && (this.mConstraintFlags & 4) != 0) {
        throw new IllegalArgumentException(
            "An idle mode job will not respect any back-off policy, so calling setBackoffCriteria"
                + " with setRequiresDeviceIdle is an error.");
      }
  ...
  public final void enforceValidity(
    ...
    if ((j > 0 || this.networkUploadBytes > 0 || this.minimumNetworkChunkBytes > 0)
        && this.networkRequest == null) {
      throw new IllegalArgumentException(
    ...
    if ((i & 2) != 0) {
      ...
      if (i2 != 400 && i2 != 300) {
        throw new IllegalArgumentException(
            "An important while foreground job must be high or default priority. Don't mark"
                + " unimportant tasks as important while foreground.");
      }
    }
    ...
    if (isExpedited) {
      ...
      if (i3 != 500 && i3 != 400) {
        throw new IllegalArgumentException(
            "An expedited job must be high or max priority. Don't use expedited jobs for"
                + " unimportant tasks.");
      }
