...
public interface IJobCallback extends IInterface {
  ...
  public static class Default implements IJobCallback {
    ...
    public void updateEstimatedNetworkBytes(
        int jobId, JobWorkItem item, long downloadBytes, long uploadBytes) throws RemoteException {}

    @Override // android.app.job.IJobCallback
    public void updateTransferredNetworkBytes(
        int jobId, JobWorkItem item, long transferredDownloadBytes, long transferredUploadBytes)
        throws RemoteException {}

    @Override // android.app.job.IJobCallback
    public void setNotification(
        int jobId, int notificationId, Notification notification, int jobEndNotificationPolicy)
        throws RemoteException {}
