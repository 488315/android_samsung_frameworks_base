...
public abstract class JobServiceEngine {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    try {
                        ...
                        Log.m96e(JobServiceEngine.TAG, "Error while executing job: " + params.getJobId());
                ...
                case 1:
                    ...
                    try {
                        ...
                        Log.m97e(JobServiceEngine.TAG, "Application unable to handle onStopJob.", e2);
                ...
                case 2:
                    ...
                    if (callback != null) {
                        try {
                            ...
                            Log.m96e(JobServiceEngine.TAG, "Error reporting job finish to system: binder has goneaway.");
                            return;
                        }
                    }
                    Log.m96e(JobServiceEngine.TAG, "finishJob() called for a nonexistent job id.");
                    return;
                case 3:
                    ...
                    try {
                        ...
                        Log.m97e(JobServiceEngine.TAG, "Application unable to handle getTransferredDownloadBytes.", e4);
                ...
                case 4:
                    ...
                    try {
                        ...
                        Log.m97e(JobServiceEngine.TAG, "Application unable to handle getTransferredUploadBytes.", e5);
                ...
                case 5:
                    ...
                    if (callback2 != null) {
                        try {
                            ...
                            Log.m96e(JobServiceEngine.TAG, "Error updating data transfer progress to system: binder has gone away.");
                        }
                    } else {
                        Log.m96e(JobServiceEngine.TAG, "updateDataTransferProgress() called for a nonexistent job id.");
                    }
                    args3.recycle();
                    return;
                case 6:
                    ...
                    if (callback3 != null) {
                        try {
                            ...
                            Log.m96e(JobServiceEngine.TAG, "Error updating estimated transfer size to system: binder has gone away.");
                        }
                    } else {
                        Log.m96e(JobServiceEngine.TAG, "updateEstimatedNetworkBytes() called for a nonexistent job id.");
                    }
                    args4.recycle();
                    return;
                case 7:
                    ...
                    if (callback4 != null) {
                        try {
                            ...
                            Log.m96e(JobServiceEngine.TAG, "Error providing notification: binder has gone away.");
                        }
                    } else {
                        Log.m96e(JobServiceEngine.TAG, "setNotification() called for a nonexistent job.");
                    }
                    args5.recycle();
                    return;
                case 8:
                    ...
                    try {
                        ...
                        Log.m96e(JobServiceEngine.TAG, "Error while executing job: " + params9.getJobId());
                        throw new RuntimeException(e9);
                    }
                default:
                    Log.m96e(JobServiceEngine.TAG, "Unrecognised message received.");
                    return;
            }
        }
        ...
        private void ackGetTransferredDownloadBytesMessage(JobParameters params, JobWorkItem item, long progress) {
            ...
            if (callback == null) {
                if (Log.isLoggable(JobServiceEngine.TAG, 3)) {
                    Log.m94d(JobServiceEngine.TAG, "Attempting to ack a job that has already been processed.");
                }
            } else {
                try {
                    callback.acknowledgeGetTransferredDownloadBytesMessage(jobId, workId, progress);
                } catch (RemoteException e) {
                    Log.m96e(JobServiceEngine.TAG, "System unreachable for returning progress.");
                }
            }
        }
        ...
        private void ackStartMessage(JobParameters params, boolean workOngoing) {
            ...
            if (callback == null) {
                ...
                try {
                    ...
                    Log.m96e(JobServiceEngine.TAG, "System unreachable for starting job.");
                }
            }
        }
        ...
        private void ackStopMessage(JobParameters params, boolean reschedule) {
            ...
            if (callback == null) {
                ...
                try {
                    ...
                    Log.m96e(JobServiceEngine.TAG, "System unreachable for stopping job.");
                }
            }
        }
    }
    ...
    public void onNetworkChanged(JobParameters params) {
        Log.m102w(TAG, "onNetworkChanged() not implemented. Must override in a subclass.");
    }
