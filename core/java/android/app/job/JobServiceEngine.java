          ...
          if (callback2 != null) {
            try {
              callback2.updateTransferredNetworkBytes(
                  params6.getJobId(), (JobWorkItem) args3.arg2, args3.argl1, args3.argl2);
            } catch (RemoteException e6) {
              Log.m96e(
                  JobServiceEngine.TAG,
                  "Error updating data transfer progress to system: binder has gone away.");
            }
          } else {
            Log.m96e(
                JobServiceEngine.TAG,
          ...
          if (callback3 != null) {
            try {
              callback3.updateEstimatedNetworkBytes(
                  params7.getJobId(), (JobWorkItem) args4.arg2, args4.argl1, args4.argl2);
            } catch (RemoteException e7) {
              Log.m96e(
                  JobServiceEngine.TAG,
                  "Error updating estimated transfer size to system: binder has gone away.");
            }
          } else {
            Log.m96e(
                JobServiceEngine.TAG,
    ...
    private void ackGetTransferredDownloadBytesMessage(
      ...
      if (callback == null) {
        if (Log.isLoggable(JobServiceEngine.TAG, 3)) {
          Log.m94d(
              JobServiceEngine.TAG, "Attempting to ack a job that has already been processed.");
        }
      } else {
        try {
