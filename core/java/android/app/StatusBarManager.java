...
public class StatusBarManager {
  ...
  @SystemApi public static final int MEDIA_TRANSFER_RECEIVER_STATE_TRANSFER_TO_RECEIVER_FAILED = 3;
  ...
  @SystemApi public static final int MEDIA_TRANSFER_SENDER_STATE_TRANSFER_TO_RECEIVER_SUCCEEDED = 4;

  @SystemApi public static final int MEDIA_TRANSFER_SENDER_STATE_TRANSFER_TO_RECEIVER_TRIGGERED = 2;

  @SystemApi public static final int MEDIA_TRANSFER_SENDER_STATE_TRANSFER_TO_THIS_DEVICE_FAILED = 7;
  ...
  private final IPlatformCompat mPlatformCompat =
      IPlatformCompat.Stub.asInterface(ServiceManager.getService(Context.PLATFORM_COMPAT_SERVICE));
  ...
  private synchronized IStatusBarService getService() {
    if (this.mService == null) {
      ...
      if (asInterface == null) {
        Slog.m121w(TAG, "warning: no STATUS_BAR_SERVICE");
      }
    }
  ...
  public void disableToType(int what, int barType) {
    try {
      ...
      if (svc != null) {
        svc.disableForUserToType(
            what, this.mToken, this.mContext.getPackageName() + getTag(), userId, barType);
      }
    } catch (RemoteException ex) {
      throw ex.rethrowFromSystemServer();
    }
  ...
  public void setExpansionDisabledForSimNetworkLock(boolean disabled) {
    try {
      ...
      if (svc != null) {
        svc.disableForUser(
            disabled ? 65536 : 0, this.mToken, this.mContext.getPackageName() + getTag(), userId);
      }
    } catch (RemoteException ex) {
      throw ex.rethrowFromSystemServer();
    }
  ...
  public void requestAddTileService(
    ...
    if (!tileServiceComponentName.getPackageName().equals(this.mContext.getPackageName())) {
      resultExecutor.execute(
          new Runnable() { // from class: android.app.StatusBarManager$$ExternalSyntheticLambda0
  ...
  public void updateMediaTapToTransferSenderDisplay(
      int displayState, MediaRoute2Info routeInfo, Executor undoExecutor, Runnable undoCallback) {
    Objects.requireNonNull(routeInfo);
    if (displayState != 4 && displayState != 5 && undoCallback != null) {
      throw new IllegalArgumentException(
          "The undoCallback should only be provided when the state is a transfer succeeded state");
    }
  ...
  static final class NearbyMediaDevicesProviderWrapper extends INearbyMediaDevicesProvider.Stub {
    ...
    public void registerNearbyDevicesCallback(final INearbyMediaDevicesUpdateCallback callback) {
      Consumer<List<NearbyDevice>> callbackAsConsumer =
