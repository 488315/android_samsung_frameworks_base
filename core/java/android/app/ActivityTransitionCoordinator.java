...
abstract class ActivityTransitionCoordinator extends ResultReceiver {
  ...
  protected void setEpicenter() {
    ...
    if (!this.mAllSharedElementNames.isEmpty()
        ...
        && (index = this.mSharedElementNames.indexOf(this.mAllSharedElementNames.get(0))) >= 0) {
  ...
  protected Transition configureTransition(
    ...
    if (transition != null) {
      Transition transition2 = transition.mo5406clone();
  ...
  private void setSharedElementState(
    ...
    if (decorLoc == null) {
      ...
      if (decorView != null
          && WindowConfiguration.inMultiWindowMode(decorView.getWindowingMode())) {
