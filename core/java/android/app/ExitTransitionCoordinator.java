...
public class ExitTransitionCoordinator extends ActivityTransitionCoordinator {
    ...
    switch (resultCode) {
      case 100:
        ...
        this.mResultReceiver =
            (ResultReceiver)
                resultData.getParcelable("android:remoteReceiver", ResultReceiver.class);
        if (this.mIsCanceled) {
  ...
  private void sharedElementExitBack() {
    ...
    if (decorView != null
        && (bundle = this.mExitSharedElementBundle) != null
        && !bundle.isEmpty()
  ...
  public void startSharedElementExit(ViewGroup decorView) {
    ...
    transition.addListener(
        new TransitionListenerAdapter() { // from class: android.app.ExitTransitionCoordinator.2
  ...
  public void startExit(Activity activity) {
    ...
    if (!this.mIsExitStarted) {
      ...
      activity.convertToTranslucent(
          new Activity
              .TranslucentConversionListener() { // from class:
  ...
  public void fadeOutBackground() {
    ...
    if (this.mBackgroundAnimator == null) {
      ...
      if (decor != null && (background = decor.getBackground()) != null) {
        ...
        ofInt.addListener(
            new AnimatorListenerAdapter() { // from class: android.app.ExitTransitionCoordinator.5
    ...
    if (viewsTransition == null) {
      ...
      viewsTransition.addListener(
          new ActivityTransitionCoordinator
              .ContinueTransitionListener() { // from class: android.app.ExitTransitionCoordinator.6
            ...
            public void onTransitionEnd(Transition transition) {
              ...
              if (ExitTransitionCoordinator.this.mIsHidden
                  && (arrayList = transitioningViews) != null) {
  ...
  private Transition getSharedElementExitTransition() {
    ...
    if (sharedElementTransition == null) {
      ...
      sharedElementTransition.addListener(
          new ActivityTransitionCoordinator
              .ContinueTransitionListener() { // from class: android.app.ExitTransitionCoordinator.7
            @Override // android.app.ActivityTransitionCoordinator.ContinueTransitionListener,
                      // android.transition.TransitionListenerAdapter,
                      // android.transition.Transition.TransitionListener
            public void onTransitionEnd(Transition transition) {
              ...
              if (ExitTransitionCoordinator.this.mIsHidden) {
                ...
                exitTransitionCoordinator.showViews(
                    exitTransitionCoordinator.mSharedElements, true);
              }
              super.onTransitionEnd(transition);
            }
          });
  ...
  protected void notifyComplete() {
    if (isReadyToNotify()) {
      if (!this.mSharedElementNotified) {
        ...
        ExitTransitionCallbacks exitTransitionCallbacks = this.mExitCallbacks;
        if (exitTransitionCallbacks != null
            && exitTransitionCallbacks.isReturnTransitionAllowed()) {
