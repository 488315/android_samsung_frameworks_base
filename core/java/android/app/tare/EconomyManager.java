...
public class EconomyManager {
  ...
  public static final String f41xfbcbc316 =
  ...
  public static final long DEFAULT_AM_MAX_SATIATED_BALANCE_CAKES =
      arcToCake(EncodeConstants.Resolution.MM_360_EXPORT_HEIGHT_960);
  ...
  public static final long DEFAULT_AM_MAX_CONSUMPTION_LIMIT_CAKES =
      arcToCake(EncodeConstants.BitRate.MM_BITRATE_10_HEVC_HD_30);
  ...
  public static final long f40x5aa96625 = arcToCake(3);
  ...
  public static final long f35x297a1e43 = arcToCake(1);
  ...
  public static final long f38x83c55dfe = arcToCake(1);
  ...
  public static final long f36xdb032552 = arcToCake(5);

  /* renamed from: DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_INEXACT_WAKEUP_BASE_PRICE_CAKES */
  public static final long f39x99e20f8d = arcToCake(4);
  ...
  public static final long f34x85b599af = arcToCake(3);
  ...
  public static final long f37x5c914194 = arcToCake(2);
  ...
  public static final long DEFAULT_JS_MIN_SATIATED_BALANCE_EXEMPTED_CAKES =
      arcToCake(EncodeConstants.BitRate.MM_BITRATE_10_HEVC_HD_30);
    ...
    if (val != null) {
      ...
      if (!trunc2.isEmpty()) {
        if (trunc2.endsWith("c")) {
          ...
          Log.m96e(TAG, "Couldn't determine units of credit value: " + val);
        ...
        try {
          ...
          Log.m97e(TAG, "Malformed config string: " + val + " to " + trunc, e);
          return defaultValCakes;
        }
      }
    }
