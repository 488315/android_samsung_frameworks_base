...
public interface IActivityManager extends IInterface {
  ...
  ContentProviderHolder getContentProviderExternal(String str, int i, IBinder iBinder, String str2)
      throws RemoteException;
  ...
  IBinder registerUidObserverForUids(
      IUidObserver iUidObserver, int i, int i2, String str, int[] iArr) throws RemoteException;
  ...
  void setApplicationStartInfoCompleteListener(
  ...
  boolean startUserInBackgroundVisibleOnDisplay(int i, int i2, IProgressListener iProgressListener)
      throws RemoteException;
  ...
  int stopUserWithDelayedLocking(int i, boolean z, IStopUserCallback iStopUserCallback)
      throws RemoteException;
  ...
  public static class Default implements IActivityManager {
    ...
    public void handleApplicationCrash(
        IBinder app, ApplicationErrorReport.ParcelableCrashInfo crashInfo) throws RemoteException {}
    ...
    public void moveTaskToFront(
        IApplicationThread caller, String callingPackage, int task, int flags, Bundle options)
        throws RemoteException {}
    ...
    public ContentProviderHolder getContentProvider(
        IApplicationThread caller, String callingPackage, String name, int userId, boolean stable)
        throws RemoteException {
      return null;
    }
    ...
    public void publishContentProviders(
        IApplicationThread caller, List<ContentProviderHolder> providers) throws RemoteException {}
    ...
    public void noteWakeupAlarm(
        IIntentSender sender, WorkSource workSource, int sourceUid, String sourcePkg, String tag)
        throws RemoteException {}
    ...
    public boolean profileControl(
        String process, int userId, boolean start, ProfilerInfo profilerInfo, int profileType)
        throws RemoteException {
      return false;
    }
    ...
    public void handleApplicationStrictModeViolation(
        IBinder app, int penaltyMask, StrictMode.ViolationInfo crashInfo) throws RemoteException {}
    ...
    public void requestBugReportWithDescription(
        String shareTitle, String shareDescription, int bugreportType) throws RemoteException {}
    ...
    public void setApplicationStartInfoCompleteListener(
        IApplicationStartInfoCompleteListener listener, int userId) throws RemoteException {}
    ...
    @Override // android.app.IActivityManager
    public String[] queryRegisteredReceiverPackages(Intent intent, String resolvedType, int userId)
        throws RemoteException {
      return null;
    }
    ...
    @Override // android.app.IActivityManager
    public boolean startProfileWithListener(int userid, IProgressListener unlockProgressListener)
        throws RemoteException {
      return false;
    }
  ...
  public abstract static class Stub extends Binder implements IActivityManager {
        ...
        default:
          switch (code) {
            ...
            case 13:
              ...
              ApplicationErrorReport.ParcelableCrashInfo _arg111 =
                  (ApplicationErrorReport.ParcelableCrashInfo)
                      data.readTypedObject(ApplicationErrorReport.ParcelableCrashInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 30:
              ...
              data.enforceNoDataAvail();
              ContentProviderHolder _result10 =
                  getContentProvider(_arg024, _arg117, _arg212, _arg36, _arg43);
              reply.writeNoException();
            ...
            case 31:
              ...
              List<ContentProviderHolder> _arg118 =
            ...
            case 80:
              ...
              return true;
            case 81:
              IForegroundServiceObserver _arg065 =
            ...
            case 108:
              ...
              StrictMode.ViolationInfo _arg232 =
                  (StrictMode.ViolationInfo) data.readTypedObject(StrictMode.ViolationInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 130:
              ...
              data.enforceNoDataAvail();
              ContentProviderHolder _result45 =
                  getContentProviderExternal(_arg097, _arg163, _arg235, _arg315);
              reply.writeNoException();
            ...
            case 132:
              ...
              return true;
            case 133:
              ActivityManager.RunningAppProcessInfo _arg0100 =
            ...
            case 220:
              ...
              data.enforceNoDataAvail();
              ParceledListSlice<ApplicationStartInfo> _result80 =
                  getHistoricalProcessStartReasons(_arg0164, _arg196, _arg248);
              reply.writeNoException();
              reply.writeTypedObject(_result80, 1);
              return true;
            case 221:
              IApplicationStartInfoCompleteListener _arg0165 =
                  IApplicationStartInfoCompleteListener.Stub.asInterface(data.readStrongBinder());
            ...
            case 223:
              ...
              data.enforceNoDataAvail();
              ParceledListSlice<ApplicationExitInfo> _result81 =
                  getHistoricalProcessExitReasons(_arg0167, _arg198, _arg249, _arg320);
              reply.writeNoException();
            ...
            case 236:
              ...
              data.enforceNoDataAvail();
              ParceledListSlice _result88 =
                  queryIntentComponentsForIntentSender(_arg0177, _arg1103);
              reply.writeNoException();
            ...
            case 245:
              ...
              IProgressListener _arg253 =
                  IProgressListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              boolean _result94 =
                  startUserInBackgroundVisibleOnDisplay(_arg0183, _arg1107, _arg253);
              reply.writeNoException();
            ...
            case 249:
              ...
              return true;
            case 250:
              IUidFrozenStateChangedCallback _arg0187 =
                  IUidFrozenStateChangedCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              registerUidFrozenStateChangedCallback(_arg0187);
              reply.writeNoException();
              return true;
            case 251:
              IUidFrozenStateChangedCallback _arg0188 =
                  IUidFrozenStateChangedCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 274:
              ...
              data.enforceNoDataAvail();
              SemAppRestrictionManager.RestrictionInfo _result116 =
                  getRestrictionInfo(_arg0206, _arg1117, _arg255);
              reply.writeNoException();
            ...
            case 277:
              ...
              data.enforceNoDataAvail();
              List<SemAppRestrictionManager.AppRestrictionInfo> _result118 =
                  getRestrictableList(_arg0208);
              reply.writeNoException();
            ...
            case 279:
              ...
              List<SemAppRestrictionManager.AppRestrictionInfo> _result120 =
                  getRestrictedList(_arg0209);
              reply.writeNoException();
              reply.writeTypedList(_result120, 1);
              return true;
            case 280:
              SemAppRestrictionManager.RestrictionInfo _arg0210 =
                  (SemAppRestrictionManager.RestrictionInfo)
                      data.readTypedObject(SemAppRestrictionManager.RestrictionInfo.CREATOR);
              List<SemAppRestrictionManager.AppRestrictionInfo> _arg1119 =
                  data.createTypedArrayList(SemAppRestrictionManager.AppRestrictionInfo.CREATOR);
              data.enforceNoDataAvail();
              ...
              return true;
            case 281:
              List<SemAppRestrictionManager.AppRestrictionInfo> _arg0211 =
                  data.createTypedArrayList(SemAppRestrictionManager.AppRestrictionInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 284:
              ...
              data.enforceNoDataAvail();
              ParceledListSlice<PackageInfo> _result123 =
                  getInstalledPackageListFromMARs(_arg0213, _arg1120);
              reply.writeNoException();
      ...
      public ContentProviderHolder getContentProvider(
        ...
        try {
          ...
          ContentProviderHolder _result =
              (ContentProviderHolder) _reply.readTypedObject(ContentProviderHolder.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
        ...
        try {
          ...
          ActivityManager.PendingIntentInfo _result =
              (ActivityManager.PendingIntentInfo)
                  _reply.readTypedObject(ActivityManager.PendingIntentInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public List<ActivityManager.ProcessErrorStateInfo> getProcessesInErrorState()
        ...
        try {
          ...
          List<ActivityManager.ProcessErrorStateInfo> _result =
              _reply.createTypedArrayList(ActivityManager.ProcessErrorStateInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public List<ActivityManager.RunningAppProcessInfo> getRunningAppProcesses()
        ...
        try {
          ...
          List<ActivityManager.RunningAppProcessInfo> _result =
              _reply.createTypedArrayList(ActivityManager.RunningAppProcessInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
        ...
        try {
          ...
          ActivityTaskManager.RootTaskInfo _result =
              (ActivityTaskManager.RootTaskInfo)
                  _reply.readTypedObject(ActivityTaskManager.RootTaskInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public SemAppRestrictionManager.RestrictionInfo getRestrictionInfo(
        ...
        try {
          ...
          SemAppRestrictionManager.RestrictionInfo _result =
              (SemAppRestrictionManager.RestrictionInfo)
                  _reply.readTypedObject(SemAppRestrictionManager.RestrictionInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public List<SemAppRestrictionManager.AppRestrictionInfo> getRestrictableList(int type)
        ...
        try {
          ...
          List<SemAppRestrictionManager.AppRestrictionInfo> _result =
              _reply.createTypedArrayList(SemAppRestrictionManager.AppRestrictionInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
    ...
    private boolean onTransact$startActivity$(Parcel data, Parcel reply) throws RemoteException {
      ...
      data.enforceNoDataAvail();
      int _result =
          startActivity(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9);
      reply.writeNoException();
    ...
    private boolean onTransact$bindServiceInstance$(Parcel data, Parcel reply)
      ...
      data.enforceNoDataAvail();
      int _result =
          bindServiceInstance(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8);
      reply.writeNoException();
      reply.writeInt(_result);
      return true;
    }
    ...
    private boolean onTransact$getIntentSender$(Parcel data, Parcel reply) throws RemoteException {
      ...
      IIntentSender _result =
          getIntentSender(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9);
      reply.writeNoException();
