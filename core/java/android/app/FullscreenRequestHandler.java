...
public class FullscreenRequestHandler {
  ...
  static void requestFullscreenMode(
      int request,
      final OutcomeReceiver<Void, Throwable> approvalCallback,
      Configuration config,
      IBinder token) {
    int earlyCheck =
        earlyCheckRequestMatchesWindowingMode(
      ...
      case 1:
        e =
            new IllegalStateException(
                "The window is not a freeform window, the request to get into fullscreen cannot be"
                    + " approved.");
        break;
      case 2:
        e =
            new IllegalStateException(
                "The window is not in fullscreen by calling the requestFullscreenMode API before,"
                    + " such that cannot be restored.");
        break;
      case 3:
