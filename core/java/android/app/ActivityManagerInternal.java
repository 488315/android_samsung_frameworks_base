...
public abstract class ActivityManagerInternal {
  ...
  public abstract void addToLocaleChangedHistoryLocked(
  ...
  public abstract void killPackageProcesses(
      String str, int i, int i2, String str2, Runnable runnable, Runnable runnable2);
