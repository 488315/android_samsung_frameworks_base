          ...
          switch (code) {
            ...
            case 4:
              TimeZoneConfiguration _arg03 =
                  (TimeZoneConfiguration) data.readTypedObject(TimeZoneConfiguration.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 7:
              ManualTimeZoneSuggestion _arg05 =
                  (ManualTimeZoneSuggestion) data.readTypedObject(ManualTimeZoneSuggestion.CREATOR);
              data.enforceNoDataAvail();
