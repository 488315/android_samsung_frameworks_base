...
public class DreamManager {
  ...
  private final IDreamManager mService =
      IDreamManager.Stub.asInterface(ServiceManager.getServiceOrThrow(DreamService.DREAM_SERVICE));
  ...
  public boolean isScreensaverEnabled() {
    return Settings.Secure.getIntForUser(
            this.mContext.getContentResolver(), Settings.Secure.SCREENSAVER_ENABLED, 0, -2)
        != 0;
  }

  public void setScreensaverEnabled(boolean z) {
    Settings.Secure.putIntForUser(
        this.mContext.getContentResolver(), Settings.Secure.SCREENSAVER_ENABLED, z ? 1 : 0, -2);
  }

  public boolean areDreamsSupported() {
    return this.mContext.getResources().getBoolean(C4337R.bool.config_dreamsSupported);
  }
