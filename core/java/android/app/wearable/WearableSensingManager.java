...
public class WearableSensingManager {
    ...
    static /* synthetic */ void lambda$provideDataStream$1(Executor executor, final Consumer statusConsumer, Bundle result) {
    ...
    static /* synthetic */ void lambda$provideData$3(Executor executor, final Consumer statusConsumer, Bundle result) {
        final int status = result.getInt("android.app.wearable.WearableSensingStatusBundleKey");
        long identity = Binder.clearCallingIdentity();
        try {
