...
public class ListFragment extends Fragment {
  ...
  private void ensureList() {
    ...
    if (root instanceof ListView) {
      ...
      TextView textView = (TextView) root.findViewById(C4337R.id.internalEmpty);
      ...
      this.mProgressContainer = root.findViewById(C4337R.id.progressContainer);
      this.mListContainer = root.findViewById(C4337R.id.listContainer);
