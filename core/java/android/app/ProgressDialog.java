...
public class ProgressDialog extends AlertDialog {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (i2 == 1) {
            ...
            public void handleMessage(Message message) {
              ...
              if (ProgressDialog.this.mProgressNumberFormat != null) {
                ...
                if (ProgressDialog.this.mProgressNumber.isLayoutRtl()) {
                  ProgressDialog.this.mProgressNumber.setText(
                      String.format(str, Integer.valueOf(max), Integer.valueOf(progress)));
                } else {
                  ProgressDialog.this.mProgressNumber.setText(
                      String.format(str, Integer.valueOf(progress), Integer.valueOf(max)));
                }
              } else {
                ProgressDialog.this.mProgressNumber.setText("");
              }
              if (ProgressDialog.this.mProgressPercentFormat != null) {
                SpannableString spannableString =
                    new SpannableString(
                        ProgressDialog.this.mProgressPercentFormat.format(progress / max));
                spannableString.setSpan(
                    new StyleSpan(!ProgressDialog.this.mThemeIsDeviceDefault ? 1 : 0),
                    0,
      ...
      View view2 =
          inflater.inflate(
              a.getResourceId(13, C4337R.layout.alert_dialog_progress), (ViewGroup) null);
      ...
      View view3 =
          inflater.inflate(C4337R.layout.tw_progress_dialog_circle_material, (ViewGroup) null);
      ...
      if (this instanceof BootProgressDialog) {
        ...
        view =
            inflater.inflate(a.getResourceId(18, C4337R.layout.progress_dialog), (ViewGroup) null);
      }
  ...
  private void onProgressChanged() {
    ...
    if (this.mProgressStyle == 1
        && (handler = this.mViewUpdateHandler) != null
