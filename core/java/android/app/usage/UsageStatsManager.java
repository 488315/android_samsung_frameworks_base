...
public final class UsageStatsManager {
  ...
  public UsageEvents queryEventsForSelf(long beginTime, long endTime) {
    try {
      UsageEvents events =
          this.mService.queryEventsForPackage(beginTime, endTime, this.mContext.getOpPackageName());
      if (events != null) {
        return events;
      }
    } catch (RemoteException e) {
  ...
  public void reportUsageStart(Activity activity, String token, long timeAgoMs) {
    try {
      this.mService.reportPastUsageStart(
          activity.getActivityToken(), token, timeAgoMs, this.mContext.getOpPackageName());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
