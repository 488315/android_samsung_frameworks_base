...
public final class CacheQuotaHint implements Parcelable {
  public static final Parcelable.Creator<CacheQuotaHint> CREATOR =
      new Parcelable.Creator<CacheQuotaHint>() { // from class: android.app.usage.CacheQuotaHint.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public CacheQuotaHint createFromParcel(Parcel in) {
          Builder builder = new Builder();
          return builder
              .setVolumeUuid(in.readString())
              .setUid(in.readInt())
              .setQuota(in.readLong())
              .setUsageStats(
                  (UsageStats)
                      in.readParcelable(UsageStats.class.getClassLoader(), UsageStats.class))
              .build();
        }
  ...
  public int hashCode() {
    return Objects.hash(
        this.mUuid, Integer.valueOf(this.mUid), this.mUsageStats, Long.valueOf(this.mQuota));
  }
