...
public interface IStorageStatsManager extends IInterface {
  ...
  public static class Default implements IStorageStatsManager {
    ...
    @Override // android.app.usage.IStorageStatsManager
    public ParceledListSlice queryCratesForUid(String volumeUuid, int uid, String callingPackage)
        throws RemoteException {
      return null;
    }
      ...
      public ExternalStorageStats queryExternalStatsForUser(
        ...
        try {
          ...
          ExternalStorageStats _result =
              (ExternalStorageStats) _reply.readTypedObject(ExternalStorageStats.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
