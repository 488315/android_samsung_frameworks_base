...
public interface IUsageStatsManager extends IInterface {
  ...
  public static class Default implements IUsageStatsManager {
    ...
    public UsageEvents queryEventsForUser(
        long beginTime, long endTime, int userId, String callingPackage) throws RemoteException {
      return null;
    }
    ...
    public void reportChooserSelection(
        String packageName, int userId, String contentType, String[] annotations, String action)
        throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 33:
              ...
              data.enforceNoDataAvail();
              BroadcastResponseStatsList _result15 =
                  queryBroadcastResponseStats(_arg029, _arg129, _arg221, _arg311);
              reply.writeNoException();
