...
public class DatePickerDialog extends AlertDialog
  ...
  private DatePickerDialog(
    ...
    DatePicker.ValidationCallback validationCallback =
    ...
    View view = inflater.inflate(C4337R.layout.date_picker_dialog, (ViewGroup) null);
    setView(view);
    ...
    DatePicker datePicker = (DatePicker) view.findViewById(C4337R.id.datePicker);
