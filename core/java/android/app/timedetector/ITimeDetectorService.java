          ...
          switch (code) {
            ...
            case 7:
              ManualTimeSuggestion _arg05 =
                  (ManualTimeSuggestion) data.readTypedObject(ManualTimeSuggestion.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 8:
              ExternalTimeSuggestion _arg06 =
                  (ExternalTimeSuggestion) data.readTypedObject(ExternalTimeSuggestion.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 10:
              TelephonyTimeSuggestion _arg08 =
                  (TelephonyTimeSuggestion) data.readTypedObject(TelephonyTimeSuggestion.CREATOR);
              data.enforceNoDataAvail();
      ...
      public TimeCapabilitiesAndConfig getCapabilitiesAndConfig() throws RemoteException {
        ...
        try {
          ...
          TimeCapabilitiesAndConfig _result =
              (TimeCapabilitiesAndConfig) _reply.readTypedObject(TimeCapabilitiesAndConfig.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
