...
public final class NotificationHistory implements Parcelable {
  ...
  public static final class HistoricalNotification {
    ...
    public String toString() {
      ...
      StringBuilder append =
          new StringBuilder()
              .append("HistoricalNotification{, key =")
              .append(this.mSbnKey)
              .append(", type =")
              .append(this.mType)
              .append(", mPostedTimeMs=")
              .append(this.mPostedTimeMs)
              .append(NavigationBarInflaterView.KEY_CODE_START)
              .append(dayTime.format(new Date(this.mPostedTimeMs)))
              .append("), mIsChecked =")
              .append(this.mIsChecked)
              .append(", mUri =");
      Uri uri = this.mUri;
      return append
          .append(uri != null ? uri.toString() : null)
          .append(", mWhen=")
          .append(this.mWhen)
          .append(NavigationBarInflaterView.KEY_CODE_START)
          .append(dayTime.format(new Date(this.mWhen)))
          .append("), mChannelName='")
          .append(fixedName)
          ...
          .append(", mIcon=")
          .append(this.mIcon)
          .append(", mConversationId=")
          .append(this.mConversationId)
          .append('}')
          .toString();
    }
    ...
    public boolean equals(Object o) {
      ...
      if ((getIcon() == null && that.getIcon() == null)
          || (getIcon() != null && that.getIcon() != null && getIcon().sameAs(that.getIcon()))) {
        iconsAreSame = true;
      } else {
        iconsAreSame = false;
      }
  ...
  public void addNotificationsToWrite(
    ...
    Collections.sort(
        ...
        new Comparator() { // from class: android.app.NotificationHistory$$ExternalSyntheticLambda0
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            return NotificationHistory.lambda$addNotificationsToWrite$0(
  ...
  static /* synthetic */ int lambda$addNotificationsToWrite$0(
      ...
      if (!sbnkey.equals(hn.getSbnKey()) || !text.equals(hn.getText()) || sameUri) {
        ...
        if (hn.getUri() != null) {
          BackgroundThread.getHandler()
              .postDelayed(
                  new Runnable() { // from class: android.app.NotificationHistory.1
  ...
  public void addNotificationsForDump(
    ...
    Collections.sort(
        this.mNotificationsToWrite,
        new Comparator() { // from class: android.app.NotificationHistory$$ExternalSyntheticLambda2
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            return NotificationHistory.lambda$addNotificationsForDump$1(
                (NotificationHistory.HistoricalNotification) obj,
                (NotificationHistory.HistoricalNotification) obj2);
          }
        });
  ...
  static /* synthetic */ int lambda$addNotificationsForDump$1(
      HistoricalNotification o1, HistoricalNotification o2) {
    return Long.compare(o1.getPostedTimeMs(), o2.getPostedTimeMs()) * (-1);
  }
  ...
  public void addNotificationsToWrite(NotificationHistory notificationHistory) {
    ...
    Collections.sort(
        this.mNotificationsToWrite,
        new Comparator() { // from class: android.app.NotificationHistory$$ExternalSyntheticLambda1
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            return NotificationHistory.lambda$addNotificationsToWrite$2(
                (NotificationHistory.HistoricalNotification) obj,
                (NotificationHistory.HistoricalNotification) obj2);
          }
        });
  ...
  static /* synthetic */ int lambda$addNotificationsToWrite$2(
      HistoricalNotification o1, HistoricalNotification o2) {
    return Long.compare(o1.getPostedTimeMs(), o2.getPostedTimeMs()) * (-1);
  }
