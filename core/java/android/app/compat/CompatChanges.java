...
public final class CompatChanges {
        ...
        return QUERY_CACHE
                .query(
                        ChangeIdStateQuery.byPackageName(
                                changeId, packageName, user.getIdentifier()))
                .booleanValue();
    }
    ...
    public static void putAllPackageOverrides(
            Map<String, Map<Long, PackageOverride>> packageNameToOverrides) {
    ...
    public static void putPackageOverrides(
            String packageName, Map<Long, PackageOverride> overrides) {
    ...
    public static void removeAllPackageOverrides(
            Map<String, Set<Long>> packageNameToOverridesToRemove) {
