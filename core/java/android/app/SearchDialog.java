...
public class SearchDialog extends Dialog {
  ...
  static int resolveDialogTheme(Context context) {
    ...
    context.getTheme().resolveAttribute(C4337R.attr.searchDialogTheme, outValue, true);
  ...
  private void createContentView() {
    setContentView(C4337R.layout.search_bar);
    SearchView searchView = (SearchView) findViewById(C4337R.id.search_view);
    ...
    this.mBadgeLabel = (TextView) this.mSearchView.findViewById(C4337R.id.search_badge);
    this.mSearchAutoComplete =
        (AutoCompleteTextView) this.mSearchView.findViewById(C4337R.id.search_src_text);
    this.mAppIcon = (ImageView) findViewById(C4337R.id.search_app_icon);
    this.mSearchPlate = this.mSearchView.findViewById(C4337R.id.search_plate);
    this.mWorkingSpinner = getContext().getDrawable(C4337R.drawable.search_spinner);
    setWorking(false);
  ...
  public void onRestoreInstanceState(Bundle savedInstanceState) {
    ...
    ComponentName launchComponent =
        (ComponentName)
            savedInstanceState.getParcelable(INSTANCE_KEY_COMPONENT, ComponentName.class);
  ...
  private void updateSearchAppIcon() {
    ...
    try {
      ...
      Log.m102w(LOG_TAG, this.mLaunchComponent + " not found, using generic app icon");
      icon = icon2;
    }
  ...
  private void launchIntent(Intent intent) {
    ...
    Log.m94d(LOG_TAG, "launching " + intent);
    try {
