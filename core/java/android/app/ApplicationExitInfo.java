...
public final class ApplicationExitInfo implements Parcelable {
  ...
  public UserHandle getUserHandle() {
    return UserHandle.m55of(UserHandle.getUserId(this.mRealUid));
  }
  ...
  public InputStream getTraceInputStream() throws IOException {
    ...
    try {
      IParcelFileDescriptorRetriever iParcelFileDescriptorRetriever =
      ...
      ParcelFileDescriptor fd =
          iAppTraceRetriever.getTraceFileDescriptor(this.mPackageName, this.mPackageUid, this.mPid);
      if (fd == null) {
        return null;
      }
  ...
  public String getReasonsAsString() {
    return "main="
        + reasonCodeToString(this.mReason)
        + " sub="
        + subreasonToString(this.mSubReason);
  }
  ...
  public int hashCode() {
    ...
    return (((((((((((((((((((((((((result * 31) + this.mRealUid) * 31) + this.mPackageUid) * 31)
                                                                                        + this
                                                                                            .mDefiningUid)
                                                                                    * 31)
                                                                                + this
