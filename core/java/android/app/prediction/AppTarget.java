...
public final class AppTarget implements Parcelable {
  ...
  private AppTarget(Parcel parcel) {
    ...
    if (shortcutInfo == null) {
      ...
      this.mUser = UserHandle.m55of(parcel.readInt());
    } else {
  ...
  public boolean equals(Object o) {
    ...
    boolean sameClassName =
        (str == null && other.mClassName == null) || (str != null && str.equals(other.mClassName));
    ShortcutInfo shortcutInfo = this.mShortcutInfo;
    boolean sameShortcutInfo =
        (shortcutInfo == null && other.mShortcutInfo == null)
            || !(shortcutInfo == null
                || other.mShortcutInfo == null
                || shortcutInfo.getId() != other.mShortcutInfo.getId());
  ...
  public static final class Builder {
    ...
    public AppTarget build() {
      ...
      return new AppTarget(
          this.mId, this.mPackageName, this.mUser, this.mShortcutInfo, this.mClassName, this.mRank);
    }
  }
}
