...
public class TimePickerDialog extends AlertDialog
  ...
  public TimePickerDialog(
    ...
    View view = inflater.inflate(C4337R.layout.time_picker_dialog, (ViewGroup) null);
    setView(view);
    ...
    TimePicker timePicker = (TimePicker) view.findViewById(C4337R.id.timePicker);
  ...
  public void show() {
    ...
    getButton(-1)
        .setOnClickListener(
            new View.OnClickListener() { // from class: android.app.TimePickerDialog.1
