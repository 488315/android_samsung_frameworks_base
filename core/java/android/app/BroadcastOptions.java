...
public class BroadcastOptions extends ComponentOptions {
  ...
  public BroadcastOptions(Bundle opts) {
    ...
    this.mDeliveryGroupExtrasMerger =
        (BundleMerger) opts.getParcelable(KEY_DELIVERY_GROUP_EXTRAS_MERGER, BundleMerger.class);
    this.mDeliveryGroupMatchingFilter =
        (IntentFilter) opts.getParcelable(KEY_DELIVERY_GROUP_MATCHING_FILTER, IntentFilter.class);
