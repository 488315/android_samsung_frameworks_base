...
public final class GameManager {
  ...
  private final IGameManagerService mService =
      IGameManagerService.Stub.asInterface(ServiceManager.getServiceOrThrow(Context.GAME_SERVICE));
  ...
  public int getGameMode() {
    return getGameModeImpl(
        this.mContext.getPackageName(), this.mContext.getApplicationInfo().targetSdkVersion);
  }
  ...
  public int getGameMode(String packageName) {
    try {
      ApplicationInfo applicationInfo =
          this.mContext
              .getPackageManager()
              .getApplicationInfo(packageName, PackageManager.ApplicationInfoFlags.m9of(0L));
