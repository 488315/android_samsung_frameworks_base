...
public class ShaderProgram extends Program {
    ...
    public void setSourceRegion(Quad region) {
        setSourceRegion(region.f61p0.f59x, region.f61p0.f60y, region.f62p1.f59x, region.f62p1.f60y, region.f63p2.f59x, region.f63p2.f60y, region.f64p3.f59x, region.f64p3.f60y);
    }

    public void setTargetRegion(Quad region) {
        setTargetRegion(region.f61p0.f59x, region.f61p0.f60y, region.f62p1.f59x, region.f62p1.f60y, region.f63p2.f59x, region.f63p2.f60y, region.f64p3.f59x, region.f64p3.f60y);
    }
