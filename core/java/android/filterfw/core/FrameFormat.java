...
public class FrameFormat {
    ...
    if (keyValueMap != null) {
      for (String specKey : keyValueMap.keySet()) {
        ...
        if (keyValueMap2 == null
            || !keyValueMap2.containsKey(specKey)
            || !this.mMetaData.get(specKey).equals(specification.mMetaData.get(specKey))) {
          return false;
        }
      }
    }
  ...
  public String toString() {
    ...
    String classString =
        this.mObjectClass != null ? " class(" + this.mObjectClass.getSimpleName() + ") " : "";
    return targetString
