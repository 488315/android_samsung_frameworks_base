...
public class Quad {
    ...
    public boolean IsInUnitRange() {
        return this.p0.IsInUnitRange()
                && this.p1.IsInUnitRange()
                && this.p2.IsInUnitRange()
                && this.p3.IsInUnitRange();
    }
    ...
    public Quad translated(float x, float y) {
        return new Quad(
                this.p0.plus(x, y), this.p1.plus(x, y), this.p2.plus(x, y), this.p3.plus(x, y));
    }
    ...
    public Rectangle boundingBox() {
        List<Float> xs =
                Arrays.asList(
                        Float.valueOf(this.p0.x),
                        Float.valueOf(this.p1.x),
                        Float.valueOf(this.p2.x),
                        Float.valueOf(this.p3.x));
        List<Float> ys =
                Arrays.asList(
                        Float.valueOf(this.p0.y),
                        Float.valueOf(this.p1.y),
                        Float.valueOf(this.p2.y),
                        Float.valueOf(this.p3.y));
    ...
    public float getBoundingWidth() {
        List<Float> xs =
                Arrays.asList(
                        ...
                        Float.valueOf(this.p2.x),
                        Float.valueOf(this.p3.x));
        return ((Float) Collections.max(xs)).floatValue()
                - ((Float) Collections.min(xs)).floatValue();
    }
    ...
    public float getBoundingHeight() {
        List<Float> ys =
                Arrays.asList(
                        ...
                        Float.valueOf(this.p2.y),
                        Float.valueOf(this.p3.y));
        return ((Float) Collections.max(ys)).floatValue()
                - ((Float) Collections.min(ys)).floatValue();
    }
