package android.filterfw.p004io;
...
public class TextGraphReader extends GraphReader {
  ...
  @Override // android.filterfw.p004io.GraphReader
    ...
    while (!scanner2.atEnd()) {
      switch (state) {
        ...
        case 12:
          ...
          this.mCommands.add(
              new ConnectCommand(
                  curSourceFilterName, curSourcePortName, curTargetFilterName, curTargetPortName));
          state = 16;
  ...
  */
  /* JADX WARN: Code restructure failed: missing block: B:13:0x01a1, code lost:
     ...
     throw new android.filterfw.p004io.GraphIOException("Unexpected end of assignments on line " + r25.lineNo() + "!");
  */
  ...
  */
  private KeyValueMap readKeyValueAssignments(PatternScanner scanner, Pattern endPattern)
