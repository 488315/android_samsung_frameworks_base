...
public final class Flags {
    ...
    public static final String FLAG_PERFETTO_PROTOLOG_TRACING =
            "android.tracing.perfetto_protolog_tracing";
    public static final String FLAG_PERFETTO_TRANSITION_TRACING =
            "android.tracing.perfetto_transition_tracing";
    public static final String FLAG_PERFETTO_VIEW_CAPTURE_TRACING =
            "android.tracing.perfetto_view_capture_tracing";
