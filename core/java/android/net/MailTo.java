...
public class MailTo {
  ...
  /* renamed from: CC */
  private static final String f314CC = "cc";
  public static final String MAILTO_SCHEME = "mailto:";
  private static final String SUBJECT = "subject";

  /* renamed from: TO */
  private static final String f315TO = "to";
  ...
  public static MailTo parse(String url) throws ParseException {
    ...
    if (address != null) {
      ...
      m.mHeaders.put(f315TO, address);
    }
    return m;
  }

  public String getTo() {
    return this.mHeaders.get(f315TO);
  }

  public String getCc() {
    return this.mHeaders.get(f314CC);
  }
