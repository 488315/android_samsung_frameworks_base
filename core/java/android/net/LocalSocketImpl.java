...
class LocalSocketImpl {
  ...
  class SocketInputStream extends InputStream {
    ...
    public int available() throws IOException {
      FileDescriptor myFd = LocalSocketImpl.this.f313fd;
      if (myFd == null) {
  ...
  public String toString() {
    return super.toString() + " fd:" + this.f313fd;
  }
  ...
  public void create(int sockType) throws IOException {
    ...
    try {
      this.f313fd = Os.socket(OsConstants.AF_UNIX, osType, 0);
  ...
  public void close() throws IOException {
    synchronized (this) {
      FileDescriptor fileDescriptor = this.f313fd;
  ...
  protected void accept(LocalSocketImpl s) throws IOException {
    ...
    try {
      s.f313fd = Os.accept(fileDescriptor, null);
      ...
      switch (optID) {
        case 1:
          Object toReturn =
              Integer.valueOf(
                  Os.getsockoptInt(
                      fileDescriptor, OsConstants.IPPROTO_TCP, OsConstants.TCP_NODELAY));
          return toReturn;
        case 4:
        case 4097:
        case 4098:
          ...
          Object toReturn2 =
              Integer.valueOf(Os.getsockoptInt(this.f313fd, OsConstants.SOL_SOCKET, osOpt));
          return toReturn2;
        case 128:
          StructLinger linger =
              Os.getsockoptLinger(fileDescriptor, OsConstants.SOL_SOCKET, OsConstants.SO_LINGER);
          if (!linger.isOn()) {
            return -1;
          }
        ...
        case 4102:
          StructTimeval timeval =
              Os.getsockoptTimeval(fileDescriptor, OsConstants.SOL_SOCKET, OsConstants.SO_SNDTIMEO);
  ...
  public void setOption(int i, Object obj) throws IOException {
    ...
    try {
      switch (i) {
        case 1:
          Os.setsockoptInt(this.f313fd, OsConstants.IPPROTO_TCP, OsConstants.TCP_NODELAY, i3);
          return;
        case 4:
        case 4097:
        case 4098:
          Os.setsockoptInt(this.f313fd, OsConstants.SOL_SOCKET, javaSoToOsOpt(i), i3);
          return;
        case 128:
          Os.setsockoptLinger(
              this.f313fd, OsConstants.SOL_SOCKET, OsConstants.SO_LINGER, new StructLinger(i2, i3));
          return;
        case 4102:
          StructTimeval fromMillis = StructTimeval.fromMillis(i3);
          Os.setsockoptTimeval(
              this.f313fd, OsConstants.SOL_SOCKET, OsConstants.SO_RCVTIMEO, fromMillis);
          Os.setsockoptTimeval(
              this.f313fd, OsConstants.SOL_SOCKET, OsConstants.SO_SNDTIMEO, fromMillis);
          return;
        default:
  ...
  public Credentials getPeerCredentials() throws IOException {
    return getPeerCredentials_native(this.f313fd);
  }
