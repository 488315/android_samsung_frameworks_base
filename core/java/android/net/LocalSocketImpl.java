        ...
        try {
            switch (optID) {
                ...
                case 4098:
                    ...
                    Object toReturn2 = Integer.valueOf(Os.getsockoptInt(this.f313fd, OsConstants.SOL_SOCKET, osOpt));
                    return toReturn2;
                case 128:
        ...
        try {
            switch (i) {
                ...
                case 4098:
                    ...
                    return;
                case 128:
                    Os.setsockoptLinger(this.f313fd, OsConstants.SOL_SOCKET, OsConstants.SO_LINGER, new StructLinger(i2, i3));
                    return;
                case 4102:
                    StructTimeval fromMillis = StructTimeval.fromMillis(i3);
                    Os.setsockoptTimeval(this.f313fd, OsConstants.SOL_SOCKET, OsConstants.SO_RCVTIMEO, fromMillis);
                    Os.setsockoptTimeval(this.f313fd, OsConstants.SOL_SOCKET, OsConstants.SO_SNDTIMEO, fromMillis);
                    return;
                default:
