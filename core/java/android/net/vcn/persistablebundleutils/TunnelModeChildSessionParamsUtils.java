...
public final class TunnelModeChildSessionParamsUtils {
    ...
    public static TunnelModeChildSessionParams fromPersistableBundle(PersistableBundle in) {
        ...
        if (hasIpv4AddressReq != hasIpv4NetmaskReq) {
            Log.m102w(TAG, String.format("Expect IPv4 address request and IPv4 netmask request either both exist or both absent, but found hasIpv4AddressReq exists? %b, hasIpv4AddressReq exists? %b, ", Boolean.valueOf(hasIpv4AddressReq), Boolean.valueOf(hasIpv4NetmaskReq)));
        }
