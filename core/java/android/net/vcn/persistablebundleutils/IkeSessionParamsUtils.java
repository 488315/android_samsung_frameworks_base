...
public final class IkeSessionParamsUtils {
  ...
  public static boolean isIkeOptionValid(int option) {
    try {
      ...
      Log.m94d(TAG, "Option not supported; discarding: " + option);
      return false;
    }
  }
  ...
  public static PersistableBundle toPersistableBundle(IkeSessionParams params) {
    if (params.getNetwork() != null || params.getIke3gppExtension() != null) {
      throw new IllegalStateException(
          "Cannot convert a IkeSessionParams with a caller configured network or with 3GPP"
              + " extension enabled");
    }
    ...
    result.putPersistableBundle(
        LOCAL_ID_KEY, IkeIdentificationUtils.toPersistableBundle(params.getLocalIdentification()));
    result.putPersistableBundle(
        REMOTE_ID_KEY,
  ...
  public static IkeSessionParams fromPersistableBundle(PersistableBundle in) {
    ...
    builder.setLocalIdentification(
        IkeIdentificationUtils.fromPersistableBundle(in.getPersistableBundle(LOCAL_ID_KEY)));
    builder.setRemoteIdentification(
        IkeIdentificationUtils.fromPersistableBundle(in.getPersistableBundle(REMOTE_ID_KEY)));
    AuthConfigUtils.setBuilderByReadingPersistableBundle(
        in.getPersistableBundle(LOCAL_AUTH_KEY), in.getPersistableBundle(REMOTE_AUTH_KEY), builder);
    ...
    public static void setBuilderByReadingPersistableBundle(
      ...
      switch (localMethodType) {
        case 1:
          if (remoteMethodType != 1) {
            throw new IllegalArgumentException(
                "Expect remote auth method to be PSK based, but was " + remoteMethodType);
          }
        ...
        case 3:
          if (remoteMethodType != 2) {
            throw new IllegalArgumentException(
                "When using EAP for local authentication, expect remote auth method to be digital"
                    + " signature based, but was "
                    + remoteMethodType);
          }
  ...
  private static class IkeAuthDigitalSignConfigUtils {
    ...
    public static PersistableBundle toPersistableBundle(
      ...
      try {
        result.putPersistableBundle(
            END_CERT_KEY,
            PersistableBundleUtils.fromByteArray(config.getClientEndCertificate().getEncoded()));
    ...
    public static PersistableBundle toPersistableBundle(
      ...
      try {
        ...
        if (caCert != null) {
          result.putPersistableBundle(
              TRUST_CERT_KEY, PersistableBundleUtils.fromByteArray(caCert.getEncoded()));
        }
        return result;
      } catch (CertificateEncodingException e) {
    ...
    public static void setBuilderByReadingPersistableBundle(
      ...
      PrivateKey privateKey =
          CertUtils.privateKeyFromByteArray(PersistableBundleUtils.toByteArray(privateKeyBundle));
  ...
  private static final class IkeAuthEapConfigUtils {
    ...
    public static PersistableBundle toPersistableBundle(
      ...
      result.putPersistableBundle(
          EAP_CONFIG_KEY, EapSessionConfigUtils.toPersistableBundle(config.getEapConfig()));
      return result;
    }
