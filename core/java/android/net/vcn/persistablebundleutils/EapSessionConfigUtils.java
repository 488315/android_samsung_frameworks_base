...
public final class EapSessionConfigUtils {
  ...
  public static PersistableBundle toPersistableBundle(EapSessionConfig config) {
    ...
    if (config.getEapSimConfig() != null) {
      result.putPersistableBundle(
          EAP_SIM_CONFIG_KEY, EapSimConfigUtils.toPersistableBundle(config.getEapSimConfig()));
    }
    if (config.getEapTtlsConfig() != null) {
      result.putPersistableBundle(
          EAP_TTLS_CONFIG_KEY, EapTtlsConfigUtils.toPersistableBundle(config.getEapTtlsConfig()));
    }
    if (config.getEapAkaConfig() != null) {
      result.putPersistableBundle(
          EAP_AKA_CONFIG_KEY, EapAkaConfigUtils.toPersistableBundle(config.getEapAkaConfig()));
    }
  ...
  private static final class EapAkaPrimeConfigUtils extends EapAkaConfigUtils {
    ...
    public static PersistableBundle toPersistableBundle(EapSessionConfig.EapAkaPrimeConfig config) {
      PersistableBundle result =
          EapUiccConfigUtils.toPersistableBundle((EapSessionConfig.EapUiccConfig) config);
    ...
    public static PersistableBundle toPersistableBundle(EapSessionConfig.EapTtlsConfig config) {
      ...
      try {
        if (config.getServerCaCert() != null) {
          PersistableBundle caBundle =
              PersistableBundleUtils.fromByteArray(config.getServerCaCert().getEncoded());
