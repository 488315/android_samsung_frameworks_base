...
public class VcnManager {
  ...
  private static final Map<VcnNetworkPolicyChangeListener, VcnUnderlyingNetworkPolicyListenerBinder>
    ...
    public void onGatewayConnectionError(
      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              VcnManager.VcnStatusCallbackBinder.this.lambda$onGatewayConnectionError$3(
    ...
    public /* synthetic */ void lambda$onGatewayConnectionError$3(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              VcnManager.VcnStatusCallbackBinder.this.lambda$onGatewayConnectionError$2(
                  gatewayConnectionName, errorCode, cause);
            }
          });
    }
