...
public final class VcnGatewayConnectionConfig {
  ...
  public VcnGatewayConnectionConfig(PersistableBundle in) {
    ...
    if (gatewayOptionsBundle == null) {
      ...
      this.mGatewayOptions =
          new ArraySet(
              PersistableBundleUtils.toList(
                  gatewayOptionsBundle, PersistableBundleUtils.INTEGER_DESERIALIZER));
    }
  ...
  private void validate() {
    ...
    Preconditions.checkArgument(
        (sortedSet == null || sortedSet.isEmpty()) ? false : true,
  ...
  public static void validateRetryInterval(long[] retryIntervalsMs) {
    Preconditions.checkArgument(
        retryIntervalsMs != null && retryIntervalsMs.length > 0 && retryIntervalsMs.length <= 10,
  ...
  public PersistableBundle toPersistableBundle() {
    ...
    PersistableBundle exposedCapsBundle =
        PersistableBundleUtils.fromList(
            new ArrayList(this.mExposedCapabilities), PersistableBundleUtils.INTEGER_SERIALIZER);
    PersistableBundle networkTemplatesBundle =
        PersistableBundleUtils.fromList(
            this.mUnderlyingNetworkTemplates,
            new PersistableBundleUtils
    ...
    PersistableBundle gatewayOptionsBundle =
        PersistableBundleUtils.fromList(
            new ArrayList(this.mGatewayOptions), PersistableBundleUtils.INTEGER_SERIALIZER);
