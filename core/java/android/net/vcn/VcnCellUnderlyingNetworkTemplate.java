...
public final class VcnCellUnderlyingNetworkTemplate extends VcnUnderlyingNetworkTemplate {
  ...
  public static VcnCellUnderlyingNetworkTemplate fromPersistableBundle(PersistableBundle in) {
    ...
    Set<Integer> allowedSpecificCarrierIds =
        new ArraySet<>(
            PersistableBundleUtils.toList(
                specificCarrierIdsBundle, PersistableBundleUtils.INTEGER_DESERIALIZER));
  ...
  public PersistableBundle toPersistableBundle() {
    ...
    PersistableBundle plmnIdsBundle =
        PersistableBundleUtils.fromList(
            new ArrayList(this.mAllowedNetworkPlmnIds), PersistableBundleUtils.STRING_SERIALIZER);
