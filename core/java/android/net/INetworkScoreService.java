...
public interface INetworkScoreService extends IInterface {
  ...
  public static class Default implements INetworkScoreService {
    ...
    public void registerNetworkScoreCache(
        int networkType, INetworkScoreCache scoreCache, int filterType) throws RemoteException {}
      ...
      public NetworkScorerAppData getActiveScorer() throws RemoteException {
        ...
        try {
          ...
          NetworkScorerAppData _result =
              (NetworkScorerAppData) _reply.readTypedObject(NetworkScorerAppData.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
