...
public class NetworkPolicyManager {
  ...
  public void setSubscriptionPlans(
      int subId, SubscriptionPlan[] plans, long expirationDurationMillis, String callingPackage) {
    try {
  ...
  public static Iterator<Pair<ZonedDateTime, ZonedDateTime>> cycleIterator(NetworkPolicy policy) {
    ...
    return new Iterator<
        Pair<ZonedDateTime, ZonedDateTime>>() { // from class: android.net.NetworkPolicyManager.1
