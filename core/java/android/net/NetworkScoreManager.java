...
public class NetworkScoreManager {
  ...
  @Deprecated public static final String ACTION_CHANGE_ACTIVE = "android.net.scoring.CHANGE_ACTIVE";
  ...
  public void registerNetworkScoreCallback(
    ...
    Log.m100v(TAG, "registerNetworkScoreCallback: callback=" + callback + ", executor=" + executor);
