...
public class PacProxySelector extends ProxySelector {
  ...
  public PacProxySelector() {
    IProxyService asInterface =
        IProxyService.Stub.asInterface(ServiceManager.getService("com.android.net.IProxyService"));
    this.mProxyService = asInterface;
    if (asInterface == null) {
      Log.m96e(TAG, "PacProxyService: no proxy service");
    }
  ...
  public List<java.net.Proxy> select(URI uri) {
    ...
    if (this.mProxyService == null) {
      Log.m96e(TAG, "select: no proxy service return NO_PROXY");
    ...
    try {
      ...
      Log.m97e(TAG, "Error resolving PAC File", e3);
    }
    if (response == null) {
