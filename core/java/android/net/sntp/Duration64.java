...
public final class Duration64 {
  ...
  public static Duration64 between(Timestamp64 startInclusive, Timestamp64 endExclusive) {
    long oneBits =
        (startInclusive.getEraSeconds() << 32) | (startInclusive.getFractionBits() & 4294967295L);
    long twoBits =
        (endExclusive.getEraSeconds() << 32) | (endExclusive.getFractionBits() & 4294967295L);
  ...
  public static Duration64 fromDuration(Duration duration) {
    ...
    long bits =
        (seconds << 32) | (Timestamp64.nanosToFractionBits(duration.getNano()) & 4294967295L);
