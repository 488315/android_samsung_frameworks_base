...
public class ScoredNetwork implements Parcelable {
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(this.networkKey, that.networkKey)
        ...
        && Objects.equals(Boolean.valueOf(this.meteredHint), Boolean.valueOf(that.meteredHint))
  ...
  public int hashCode() {
    return Objects.hash(
        this.networkKey, this.rssiCurve, Boolean.valueOf(this.meteredHint), this.attributes);
  }
  ...
  public boolean hasRankingScore() {
    ...
    return this.rssiCurve != null
        || ((bundle = this.attributes) != null
            && bundle.containsKey(ATTRIBUTES_KEY_RANKING_SCORE_OFFSET));
  }

  public int calculateRankingScore(int rssi) throws UnsupportedOperationException {
    if (!hasRankingScore()) {
      throw new UnsupportedOperationException(
          "Either rssiCurve or rankingScoreOffset is required to calculate the ranking score");
    }
    Bundle bundle = this.attributes;
  ...
  public int calculateBadge(int rssi) {
    ...
    if (bundle != null && bundle.containsKey(ATTRIBUTES_KEY_BADGING_CURVE)) {
      RssiCurve badgingCurve =
          (RssiCurve) this.attributes.getParcelable(ATTRIBUTES_KEY_BADGING_CURVE, RssiCurve.class);
