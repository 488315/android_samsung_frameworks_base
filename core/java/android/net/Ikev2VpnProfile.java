...
public final class Ikev2VpnProfile extends PlatformVpnProfile {
  ...
  public boolean equals(Object obj) {
    ...
    return this.mType == other.mType
        ...
        && this.mAutomaticNattKeepaliveTimerEnabled == other.mAutomaticNattKeepaliveTimerEnabled
        && this.mAutomaticIpVersionSelectionEnabled == other.mAutomaticIpVersionSelectionEnabled;
  }
  ...
  public VpnProfile toVpnProfile() throws IOException, GeneralSecurityException {
    ...
    switch (this.mType) {
      case 6:
        ...
        X509Certificate x509Certificate = this.mServerRootCaCert;
        profile.ipsecCaCert =
            x509Certificate != null ? certificateToPemString(x509Certificate) : "";
        return profile;
      case 7:
      ...
      case 8:
        ...
        X509Certificate x509Certificate2 = this.mServerRootCaCert;
        profile.ipsecCaCert =
            x509Certificate2 != null ? certificateToPemString(x509Certificate2) : "";
        return profile;
      default:
        throw new IllegalArgumentException("Invalid auth method set");
    }
  ...
  public static Ikev2VpnProfile fromVpnProfile(VpnProfile profile) throws GeneralSecurityException {
      ...
      switch (profile.type) {
        case 6:
          builder.setAuthUsernamePassword(
              profile.username, profile.password, certificateFromPemString(profile.ipsecCaCert));
          break;
        case 7:
    ...
    if (profile.excludeLocalRoutes && !profile.isBypassable) {
      Log.m102w(TAG, "ExcludeLocalRoutes should only be set in the bypassable VPN");
    }
  ...
  private static X509Certificate certificateFromPemString(String certStr)
    ...
    try {
      List<X509Certificate> certs =
          android.security.Credentials.convertFromPem(certStr.getBytes(StandardCharsets.US_ASCII));
