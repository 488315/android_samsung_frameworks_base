...
public class SingleScanSettings implements Parcelable {
  public static final Parcelable.Creator<SingleScanSettings> CREATOR =
      new Parcelable.Creator<
          SingleScanSettings>() { // from class: android.net.wifi.nl80211.SingleScanSettings.1
        ...
        public SingleScanSettings createFromParcel(Parcel in) {
          ...
          if (in.dataAvail() != 0) {
            Log.m96e(SingleScanSettings.TAG, "Found trailing data after parcel parsing.");
          }
          return result;
        }
  ...
  public boolean equals(Object rhs) {
    ...
    if ((rhs instanceof SingleScanSettings) && (settings = (SingleScanSettings) rhs) != null) {
      return this.scanType == settings.scanType
          && this.enable6GhzRnr == settings.enable6GhzRnr
          && this.channelSettings.equals(settings.channelSettings)
          && this.hiddenNetworks.equals(settings.hiddenNetworks)
          && Arrays.equals(this.vendorIes, settings.vendorIes);
    }
    return false;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        Integer.valueOf(this.scanType),
        this.channelSettings,
        this.hiddenNetworks,
        Boolean.valueOf(this.enable6GhzRnr),
