...
public class WifiNl80211Manager {
  ...
  private static final String TIMEOUT_ALARM_TAG =
      "WifiNl80211Manager Send Management Frame Timeout";
  ...
  public class WificondEventHandler extends IWificondEventCallback.Stub {
    ...
    public void registerCountryCodeChangedListener(
        Executor executor, CountryCodeChangedListener listener) {
    ...
    public void OnRegDomainChanged(final String countryCode) {
      Log.m94d(WifiNl80211Manager.TAG, "OnRegDomainChanged " + countryCode);
      long token = Binder.clearCallingIdentity();
      try {
        this.mCountryCodeChangedListenerHolder.forEach(
            new BiConsumer() { // from class:
                               // android.net.wifi.nl80211.WifiNl80211Manager$WificondEventHandler$$ExternalSyntheticLambda0
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                Executor executor = (Executor) obj2;
                executor.execute(
                    new Runnable() { // from class:
                                     // android.net.wifi.nl80211.WifiNl80211Manager$WificondEventHandler$$ExternalSyntheticLambda1
  ...
  class ScanEventHandler extends IScanEvent.Stub {
    ...
    public void OnScanResultReady() {
      Log.m94d(WifiNl80211Manager.TAG, "Scan result ready event");
      long token = Binder.clearCallingIdentity();
      WifiNl80211Manager.this.mLastSingleScanTriggeredTime.set(0L);
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$ScanEventHandler$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
    ...
    public void OnScanFailed() {
      Log.m94d(WifiNl80211Manager.TAG, "Scan failed event");
      long token = Binder.clearCallingIdentity();
      WifiNl80211Manager.this.mLastSingleScanTriggeredTime.set(0L);
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$ScanEventHandler$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
    ...
    public void OnScanRequestFailed(final int errorCode) {
      Log.m94d(WifiNl80211Manager.TAG, "Scan failed event with error code: " + errorCode);
      long token = Binder.clearCallingIdentity();
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$ScanEventHandler$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public WifiNl80211Manager(Context context, IBinder binder) {
    ...
    if (asInterface == null) {
      Log.m96e(TAG, "Failed to get reference to wificond");
    }
  }
  ...
  class PnoScanEventHandler extends IPnoScanEvent.Stub {
    ...
    public void OnPnoNetworkFound() {
      Log.m94d(WifiNl80211Manager.TAG, "Pno scan result event");
      long token = Binder.clearCallingIdentity();
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$PnoScanEventHandler$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
    ...
    public void OnPnoScanFailed() {
      Log.m94d(WifiNl80211Manager.TAG, "Pno Scan failed event");
      long token = Binder.clearCallingIdentity();
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$PnoScanEventHandler$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
  ...
  class ApInterfaceEventCallback extends IApInterfaceEventCallback.Stub {
    ...
    public void onConnectedClientsChanged(
        final NativeWifiClient client, final boolean isConnected) {
      if (WifiNl80211Manager.this.mVerboseLoggingEnabled) {
        Log.m94d(
            WifiNl80211Manager.TAG,
            "onConnectedClientsChanged called with "
      ...
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$ApInterfaceEventCallback$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
                WifiNl80211Manager.ApInterfaceEventCallback.this.lambda$onConnectedClientsChanged$0(
                    client, isConnected);
              }
            });
      } finally {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onConnectedClientsChanged$0(
        NativeWifiClient client, boolean isConnected) {
    ...
    public void onSoftApChannelSwitched(final int frequency, final int bandwidth) {
      ...
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$ApInterfaceEventCallback$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
                WifiNl80211Manager.ApInterfaceEventCallback.this.lambda$onSoftApChannelSwitched$1(
                    frequency, bandwidth);
              }
            });
      } finally {
  ...
  class SendMgmtFrameEvent extends ISendMgmtFrameEvent.Stub {
    ...
    private AlarmManager.OnAlarmListener mTimeoutCallback =
        new AlarmManager
            .OnAlarmListener() { // from class:
                                 // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda5
    ...
    SendMgmtFrameEvent(Executor executor, SendMgmtFrameCallback callback) {
      this.mExecutor = executor;
      this.mCallback = callback;
      WifiNl80211Manager.this.mAlarmManager.set(
          2,
          SystemClock.elapsedRealtime() + 1000,
          WifiNl80211Manager.TIMEOUT_ALARM_TAG,
          this.mTimeoutCallback,
          WifiNl80211Manager.this.mEventHandler);
    }
    ...
    public /* synthetic */ void lambda$new$2() {
      runIfFirstCall(
          new Runnable() { // from class:
                           // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$new$1() {
      if (WifiNl80211Manager.this.mVerboseLoggingEnabled) {
        Log.m96e(WifiNl80211Manager.TAG, "Timed out waiting for ACK");
      }
      long token = Binder.clearCallingIdentity();
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda4
              @Override // java.lang.Runnable
              public final void run() {
    ...
    public /* synthetic */ void lambda$OnAck$5(final int elapsedTimeMs) {
      runIfFirstCall(
          new Runnable() { // from class:
                           // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void OnAck(final int elapsedTimeMs) {
      WifiNl80211Manager.this.mEventHandler.post(
          new Runnable() { // from class:
                           // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$OnAck$4(final int elapsedTimeMs) {
      ...
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
    ...
    public /* synthetic */ void lambda$OnFailure$8(final int reason) {
      runIfFirstCall(
          new Runnable() { // from class:
                           // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void OnFailure(final int reason) {
      WifiNl80211Manager.this.mEventHandler.post(
          new Runnable() { // from class:
                           // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$OnFailure$7(final int reason) {
      ...
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda7
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public void lambda$retrieveWificondAndRegisterForDeath$1() {
    this.mEventHandler.post(
        new Runnable() { // from class:
                         // android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void setOnServiceDeadCallback(Runnable deathEventHandler) {
    if (this.mDeathEventHandler != null) {
      Log.m96e(TAG, "Death handler already present");
    }
  ...
  private boolean retrieveWificondAndRegisterForDeath() {
    if (this.mWificond != null) {
      if (this.mVerboseLoggingEnabled) {
        Log.m94d(TAG, "Wificond handle already retrieved");
      }
      return true;
    }
    ...
    if (asInterface != null) {
      try {
            ...
            .linkToDeath(
                new IBinder
                    .DeathRecipient() { // from class:
                                        // android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda6
        ...
        Log.m96e(TAG, "Failed to register death notification for wificond");
        return false;
      }
    }
    Log.m96e(TAG, "Failed to get reference to wificond");
  ...
  public boolean semSetupInterface(String ifaceName) {
    Log.m94d(TAG, "Setting up interface for client mode. iface:" + ifaceName);
    ...
    try {
      for (IBinder it : this.mWificond.GetClientInterfaces()) {
        ...
        if (TextUtils.equals(ifaceName, clientInterface.getInterfaceName())) {
          ...
          if (wifiScanner == null) {
            Log.m96e(TAG, "Failed to get IWifiScannerImpl");
          } else {
      ...
      Log.m96e(TAG, "Failed to get IClientInterface due to remote exception");
      return false;
    }
  }
  ...
  public boolean setupInterfaceForClientMode(
      String ifaceName,
      Executor executor,
      ScanEventCallback scanCallback,
      ScanEventCallback pnoScanCallback) {
    Log.m94d(TAG, "Setting up interface for client mode: " + ifaceName);
    if (!retrieveWificondAndRegisterForDeath()) {
      return false;
    }
    if (scanCallback == null || pnoScanCallback == null || executor == null) {
      Log.m96e(TAG, "setupInterfaceForClientMode invoked with null callbacks");
      return false;
    }
    try {
      IClientInterface clientInterface = this.mWificond.createClientInterface(ifaceName);
      if (clientInterface == null) {
        Log.m96e(TAG, "Could not get IClientInterface instance from wificond");
        return false;
      }
      ...
      try {
        ...
        if (wificondScanner == null) {
          Log.m96e(TAG, "Failed to get WificondScannerImpl");
          return false;
        }
        ...
        PnoScanEventHandler pnoScanEventHandler =
            new PnoScanEventHandler(executor, pnoScanCallback);
        this.mPnoScanEventHandlers.put(ifaceName, pnoScanEventHandler);
        wificondScanner.subscribePnoScanEvents(pnoScanEventHandler);
        return true;
      } catch (RemoteException e) {
        Log.m96e(TAG, "Failed to refresh wificond scanner due to remote exception");
        return true;
      }
  ...
  public boolean tearDownClientInterface(String ifaceName) {
    if (getClientInterface(ifaceName) == null) {
      Log.m96e(TAG, "No valid wificond client interface handler for iface=" + ifaceName);
      return false;
    }
    try {
      ...
      if (iWificond == null) {
        Log.m96e(TAG, "tearDownClientInterface: mWificond binder is null! Did wificond die?");
        return false;
      }
      try {
        boolean success = iWificond.tearDownClientInterface(ifaceName);
        if (!success) {
          Log.m96e(TAG, "Failed to teardown client interface");
          return false;
        }
        ...
        Log.m96e(TAG, "Failed to teardown client interface due to remote exception");
        return false;
      }
    } catch (RemoteException e2) {
      Log.m96e(TAG, "Failed to unsubscribe wificond scanner due to remote exception");
      return false;
    }
  }

  public boolean setupInterfaceForSoftApMode(String ifaceName) {
    Log.m94d(TAG, "Setting up interface for soft ap mode for iface=" + ifaceName);
    if (!retrieveWificondAndRegisterForDeath()) {
      return false;
    }
    try {
      ...
      if (apInterface == null) {
        Log.m96e(TAG, "Could not get IApInterface instance from wificond");
        return false;
      }
      ...
      Log.m96e(TAG, "Failed to get IApInterface due to remote exception");
      return false;
    }
  }
  ...
  public boolean tearDownSoftApInterface(String ifaceName) {
    if (getApInterface(ifaceName) == null) {
      Log.m96e(TAG, "No valid wificond ap interface handler for iface=" + ifaceName);
      return false;
    }
    IWificond iWificond = this.mWificond;
    if (iWificond == null) {
      Log.m96e(TAG, "tearDownSoftApInterface: mWificond binder is null! Did wificond die?");
      return false;
    }
    try {
      boolean success = iWificond.tearDownApInterface(ifaceName);
      if (!success) {
        Log.m96e(TAG, "Failed to teardown AP interface");
        return false;
      }
      ...
      Log.m96e(TAG, "Failed to teardown AP interface due to remote exception");
      return false;
    }
  }

  public boolean tearDownInterfaces() {
    Log.m94d(TAG, "tearing down interfaces in wificond");
    if (!retrieveWificondAndRegisterForDeath()) {
      return false;
    }
    try {
      ...
      Log.m96e(TAG, "Failed to tear down interfaces due to remote exception");
      return false;
    }
  }
  ...
  public SignalPollResult signalPoll(String ifaceName) {
    ...
    try {
      ...
      if (resultArray == null || resultArray.length != 4) {
        Log.m96e(TAG, "Invalid signal poll result from wificond");
        return null;
      }
      return new SignalPollResult(resultArray[0], resultArray[1], resultArray[3], resultArray[2]);
    } catch (RemoteException e) {
      Log.m96e(TAG, "Failed to do signal polling due to remote exception");
      return null;
    }
  }
  ...
  public List<NativeScanResult> getScanResults(String ifaceName, int scanType) {
    ...
    if (scannerImpl == null) {
      Log.m96e(TAG, "No valid wificond scanner interface handler for iface=" + ifaceName);
    ...
    try {
      ...
      Log.m96e(TAG, "Failed to create ScanDetail ArrayList");
    }
    if (results == null) {
      results = new ArrayList();
    }
    if (this.mVerboseLoggingEnabled) {
      Log.m94d(TAG, "get " + results.size() + " scan results from wificond");
    }
    return results;
  }
  ...
  public int getMaxSsidsPerScan(String ifaceName) {
    ...
    try {
      ...
      Log.m96e(TAG, "Failed to getMaxSsidsPerScan");
      return 0;
    }
  }
  ...
  public boolean startScan(
      String ifaceName, int scanType, Set<Integer> freqs, List<byte[]> hiddenNetworkSSIDs) {
  ...
  public boolean startScan(
      ...
      int scanType,
      Set<Integer> freqs,
      List<byte[]> hiddenNetworkSSIDs,
      Bundle extraScanningParams) {
    IWifiScannerImpl scannerImpl = getScannerImpl(ifaceName);
    if (scannerImpl == null) {
      Log.m96e(TAG, "No valid wificond scanner interface handler for iface=" + ifaceName);
      return false;
    ...
    SingleScanSettings settings =
        createSingleScanSettings(scanType, freqs, hiddenNetworkSSIDs, extraScanningParams);
    if (settings == null) {
      return false;
    }
    try {
      ...
      Log.m96e(TAG, "Failed to request scan due to remote exception");
      this.mLastSingleScanTriggeredTime.set(0L);
      return false;
    }
  }

  public int startScan2(
      String ifaceName,
      int scanType,
      Set<Integer> freqs,
      List<byte[]> hiddenNetworkSSIDs,
  ...
  private SingleScanSettings createSingleScanSettings(
      int scanType,
      Set<Integer> freqs,
      List<byte[]> hiddenNetworkSSIDs,
      Bundle extraScanningParams) {
    ...
    try {
      ...
      Log.m97e(TAG, "Invalid scan type ", e);
      return null;
    }
  }
  ...
  public boolean startPnoScan(
      ...
      Executor executor,
      final PnoScanRequestCallback callback) {
    IWifiScannerImpl scannerImpl = getScannerImpl(ifaceName);
    if (scannerImpl == null) {
      Log.m96e(TAG, "No valid wificond scanner interface handler for iface=" + ifaceName);
      return false;
    ...
    if (callback == null || executor == null) {
      Log.m96e(TAG, "startPnoScan called with a null callback");
      return false;
    }
    try {
      ...
      if (success) {
        ...
        executor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda4
              @Override // java.lang.Runnable
              public final void run() {
        ...
        executor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda5
              @Override // java.lang.Runnable
              public final void run() {
      ...
      Log.m96e(TAG, "Failed to start pno scan due to remote exception");
      return false;
    }
  }
  ...
  public boolean stopPnoScan(String ifaceName) {
    ...
    try {
      ...
      Log.m96e(TAG, "Failed to stop pno scan due to remote exception");
      return false;
    }
  }
  ...
  public void abortScan(String ifaceName) {
    ...
    try {
      ...
      Log.m96e(TAG, "Failed to request abortScan due to remote exception");
    }
  }
  ...
  public int[] getChannelsMhzForBand(int band) {
    IWificond iWificond = this.mWificond;
    if (iWificond == null) {
      Log.m96e(TAG, "getChannelsMhzForBand: mWificond binder is null! Did wificond die?");
      return new int[0];
    }
    int[] result = null;
    try {
      ...
      Log.m96e(TAG, "Failed to request getChannelsForBand due to remote exception");
    }
    if (result == null) {
  ...
  public DeviceWiphyCapabilities getDeviceWiphyCapabilities(String ifaceName) {
    IWificond iWificond = this.mWificond;
    if (iWificond == null) {
      Log.m96e(TAG, "getDeviceWiphyCapabilities: mWificond binder is null! Did wificond die?");
      return null;
    }
    try {
  ...
  public boolean registerCountryCodeChangedListener(
    ...
    Log.m94d(TAG, "registerCountryCodeEventListener called");
    this.mWificondEventHandler.registerCountryCodeChangedListener(executor, listener);
    return true;
  }

  public void unregisterCountryCodeChangedListener(CountryCodeChangedListener listener) {
    Log.m94d(TAG, "unregisterCountryCodeEventListener called");
  ...
  public void notifyCountryCodeChanged(String newCountryCode) {
    ...
    try {
      ...
      Log.m98i(TAG, "Receive country code change to " + newCountryCode);
  ...
  public boolean registerApCallback(String ifaceName, Executor executor, SoftApCallback callback) {
    ...
    if (iface == null) {
      Log.m96e(TAG, "No valid ap interface handler for iface=" + ifaceName);
      return false;
    }
    if (callback == null || executor == null) {
      Log.m96e(TAG, "registerApCallback called with a null callback");
      return false;
    }
    try {
      ...
      if (!success) {
        Log.m96e(TAG, "Failed to register ap callback.");
        return false;
      }
      return true;
    } catch (RemoteException e) {
      Log.m96e(TAG, "Exception in registering AP callback: " + e);
      return false;
    }
  }
  ...
  public void sendMgmtFrame(
      ...
      int mcs,
      Executor executor,
      final SendMgmtFrameCallback callback) {
    if (callback == null || executor == null) {
      Log.m96e(TAG, "callback cannot be null!");
      return;
    }
    if (frame == null) {
      Log.m96e(TAG, "frame cannot be null!");
      executor.execute(
          new Runnable() { // from class:
                           // android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    if (clientInterface == null) {
      ...
      executor.execute(
          new Runnable() { // from class:
                           // android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              WifiNl80211Manager.SendMgmtFrameCallback.this.onFailure(1);
            }
      ...
      if (!this.mSendMgmtFrameInProgress.compareAndSet(false, true)) {
        Log.m96e(TAG, "An existing management frame transmission is in progress!");
        executor.execute(
            new Runnable() { // from class:
                             // android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
      ...
      try {
        ...
        Log.m96e(TAG, "Exception while starting link probe: " + e);
  ...
  public static class OemSecurityType {
    ...
    public OemSecurityType(
        int protocol, List<Integer> keyManagement, List<Integer> pairwiseCipher, int groupCipher) {
  ...
  public void disableRandomMac(String ifaceName) {
    IWifiScannerImpl scannerImpl = getScannerImpl(ifaceName);
    if (scannerImpl == null) {
      Log.m96e(TAG, "No valid wificond scanner interface handler, disableRandomMac");
      return;
    }
    try {
      scannerImpl.disableRandomMac();
    } catch (RemoteException e) {
      Log.m96e(TAG, "Failed to request disable random mac due to remote exception");
    }
  }
  ...
  public boolean singleScanIsProgress() {
    ...
    long elapsedTimeFromLastSingleScanTriggered =
        SystemClock.elapsedRealtime() - this.mLastSingleScanTriggeredTime.get();
    if (elapsedTimeFromLastSingleScanTriggered > 0
        && elapsedTimeFromLastSingleScanTriggered < 4000) {
      Log.m98i(
          TAG, "single scan is in progress : elapsed=" + elapsedTimeFromLastSingleScanTriggered);
      return true;
    }
    this.mLastSingleScanTriggeredTime.set(0L);
    return false;
