...
public abstract class SharedConnectivityService extends Service {
    ...
    class BinderC22711 extends ISharedConnectivityService.Stub {
        ...
        public void disconnectHotspotNetwork(final HotspotNetwork network) {
            ...
            SharedConnectivityService.this.mHandler.post(new Runnable() { // from class: android.net.wifi.sharedconnectivity.service.SharedConnectivityService$1$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    SharedConnectivityService.BinderC22711.this.lambda$disconnectHotspotNetwork$3(network);
                }
            });
        }
    ...
    public static boolean areHotspotNetworksEnabledForService(Context context) {
        String servicePackage = context.getResources().getString(C4337R.string.config_sharedConnectivityServicePackage);
        return Objects.equals(context.getPackageName(), servicePackage) && context.getResources().getBoolean(C4337R.bool.config_hotspotNetworksEnabledForService);
    }

    public static boolean areKnownNetworksEnabledForService(Context context) {
        String servicePackage = context.getResources().getString(C4337R.string.config_sharedConnectivityServicePackage);
        return Objects.equals(context.getPackageName(), servicePackage) && context.getResources().getBoolean(C4337R.bool.config_knownNetworksEnabledForService);
    }
}
