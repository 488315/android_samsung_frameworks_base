      ...
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            public final void runOrThrow() {
              PacProxyManager.PacProxyInstalledListenerProxy.this.lambda$onPacProxyInstalled$1(
                  network, proxy);
            }
          });
    }
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            public final void run() {
              PacProxyManager.PacProxyInstalledListenerProxy.this.lambda$onPacProxyInstalled$0(
                  network, proxy);
            }
          });
    }
