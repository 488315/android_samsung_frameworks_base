...
public class X509TrustManagerExtensions {
        ...
        try {
            ...
            try {
                isSameTrustConfiguration =
                        tm.getClass()
                                .getMethod("isSameTrustConfiguration", String.class, String.class);
            } catch (ReflectiveOperationException e) {
            }
            this.mIsSameTrustConfiguration = isSameTrustConfiguration;
        } catch (NoSuchMethodException e2) {
            throw new IllegalArgumentException(
                    "Required method checkServerTrusted(X509Certificate[], String, String, String)"
                        + " missing");
        }
    }
    ...
    public List<X509Certificate> checkServerTrusted(
        ...
        try {
            return (List)
                    this.mCheckServerTrusted.invoke(this.mTrustManager, chain, authType, host);
    ...
    public boolean isSameTrustConfiguration(String hostname1, String hostname2) {
        ...
        try {
            return ((Boolean)
                            this.mIsSameTrustConfiguration.invoke(
                                    this.mTrustManager, hostname1, hostname2))
                    .booleanValue();
        } catch (IllegalAccessException e) {
