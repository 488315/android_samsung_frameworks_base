...
public class SslCertificate {
  ...
  public View inflateCertificateView(Context context) {
    ...
    ((TextView) certificateView.findViewById(C4337R.id.serial_number))
        .setText(getSerialNumber(this.mX509Certificate));
    ...
    ((TextView) certificateView.findViewById(C4337R.id.sha256_fingerprint))
        .setText(getDigest(this.mX509Certificate, "SHA256"));
    ((TextView) certificateView.findViewById(C4337R.id.sha1_fingerprint))
        .setText(getDigest(this.mX509Certificate, "SHA1"));
