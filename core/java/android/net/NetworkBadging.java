...
public class NetworkBadging {
    ...
    private static int getWifiSignalResource(int signalLevel) {
        switch (signalLevel) {
            case 0:
                return C4337R.drawable.ic_wifi_signal_0;
            case 1:
                return C4337R.drawable.ic_wifi_signal_1;
            case 2:
                return C4337R.drawable.ic_wifi_signal_2;
            case 3:
                return C4337R.drawable.ic_wifi_signal_3;
            case 4:
                return C4337R.drawable.ic_wifi_signal_4;
            default:
