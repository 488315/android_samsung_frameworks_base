...
public interface INetdEventCallback extends IInterface {
  ...
  public static class Default implements INetdEventCallback {
    ...
    public void onPrivateDnsValidationEvent(
        int netId, String ipAddress, String hostname, boolean validated) throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements INetdEventCallback {
    ...
    private static class Proxy implements INetdEventCallback {
      ...
      public void onNat64PrefixEvent(
          int netId, boolean added, String prefixString, int prefixLength) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
          _data.writeInt(netId);
