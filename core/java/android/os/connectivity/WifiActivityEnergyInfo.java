...
public final class WifiActivityEnergyInfo implements Parcelable {
    ...
    private static long calculateEnergyMicroJoules(
        ...
        double voltage =
                powerProfile.getAveragePower(PowerProfile.POWER_WIFI_CONTROLLER_OPERATING_VOLTAGE)
                        / 1000.0d;
    ...
    private static long calculateEnergyMicroJoules$ravenwood(
            long txDurationMillis, long rxDurationMillis, long idleDurationMillis) {
        return 0L;
    }
    ...
    public String toString() {
        return "WifiActivityEnergyInfo{ mTimeSinceBootMillis="
                + this.mTimeSinceBootMillis
                + " mStackState="
                + this.mStackState
                + " mControllerTxDurationMillis="
                + this.mControllerTxDurationMillis
                + " mControllerRxDurationMillis="
                + this.mControllerRxDurationMillis
                + " mControllerScanDurationMillis="
                + this.mControllerScanDurationMillis
    ...
    public boolean isValid() {
        return this.mControllerTxDurationMillis >= 0
                && this.mControllerRxDurationMillis >= 0
                && this.mControllerScanDurationMillis >= 0
                && this.mControllerIdleDurationMillis >= 0;
    }
}
