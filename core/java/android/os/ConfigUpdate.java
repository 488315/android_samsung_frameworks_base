...
public final class ConfigUpdate {
    ...
    @SystemApi public static final String ACTION_UPDATE_CONFIG = "android.os.action.UPDATE_CONFIG";
    ...
    @SystemApi public static final String ACTION_UPDATE_PINS = "android.intent.action.UPDATE_PINS";
    ...
    @SystemApi public static final String EXTRA_DOMAIN = "android.os.extra.DOMAIN";

    @SystemApi public static final String EXTRA_REQUIRED_HASH = "android.os.extra.REQUIRED_HASH";

    @SystemApi public static final String EXTRA_VERSION = "android.os.extra.VERSION";
