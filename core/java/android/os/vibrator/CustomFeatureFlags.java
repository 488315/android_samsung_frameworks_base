...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(
                    Arrays.asList(
                            ...
                            Flags.FLAG_HAPTIC_FEEDBACK_VIBRATION_OEM_CUSTOMIZATION_ENABLED,
                            Flags.FLAG_KEYBOARD_CATEGORY_ENABLED,
                            Flags.FLAG_USE_VIBRATOR_HAPTIC_FEEDBACK,
                            ""));
    ...
    public boolean adaptiveHapticsEnabled() {
        return getValue(
                ...
                new Predicate() { // from class:
                                  // android.os.vibrator.CustomFeatureFlags$$ExternalSyntheticLambda1
    ...
    public boolean hapticFeedbackVibrationOemCustomizationEnabled() {
        return getValue(
                Flags.FLAG_HAPTIC_FEEDBACK_VIBRATION_OEM_CUSTOMIZATION_ENABLED,
                new Predicate() { // from class:
                                  // android.os.vibrator.CustomFeatureFlags$$ExternalSyntheticLambda2
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        return ((FeatureFlags) obj)
                                .hapticFeedbackVibrationOemCustomizationEnabled();
                    }
                });
    }
    ...
    public boolean keyboardCategoryEnabled() {
        return getValue(
                Flags.FLAG_KEYBOARD_CATEGORY_ENABLED,
                new Predicate() { // from class:
                                  // android.os.vibrator.CustomFeatureFlags$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean useVibratorHapticFeedback() {
        return getValue(
                Flags.FLAG_USE_VIBRATOR_HAPTIC_FEEDBACK,
                new Predicate() { // from class:
                                  // android.os.vibrator.CustomFeatureFlags$$ExternalSyntheticLambda3
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
