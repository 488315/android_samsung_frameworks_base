...
public final class VibrationXmlSerializer {
    ...
    public static void serialize(VibrationEffect effect, Writer writer)
            throws SerializationFailedException, IOException {
        serialize(effect, writer, 0);
    }

    public static void serialize(VibrationEffect effect, Writer writer, int flags)
            throws SerializationFailedException, IOException {
    ...
    private static XmlSerializedVibration<VibrationEffect> toSerializedVibration(
            VibrationEffect effect, int flags) throws SerializationFailedException {
        ...
        try {
            XmlSerializedVibration<VibrationEffect> serializedVibration =
                    VibrationEffectXmlSerializer.serialize(effect, serializerFlags);
