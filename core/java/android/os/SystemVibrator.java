...
public class SystemVibrator extends Vibrator {
  ...
  protected VibratorInfo getInfo() {
    synchronized (this.mLock) {
      ...
      if (vibratorManager == null) {
        Log.m102w(TAG, "Failed to retrieve vibrator info; no vibrator manager.");
      ...
      for (int i = 0; i < vibratorIds.length; i++) {
        ...
        if (vibrator instanceof NullVibrator) {
          Log.m102w(
              TAG,
              "Vibrator manager service not ready; Info not yet available for vibrator: "
                  + vibratorIds[i]);
          return VibratorInfo.EMPTY_VIBRATOR_INFO;
        }
  ...
  public boolean hasVibrator() {
    ...
    Log.m102w(TAG, "Failed to check if vibrator exists; no vibrator manager.");
    return false;
  }
  ...
  public boolean isVibrating() {
    VibratorManager vibratorManager = this.mVibratorManager;
    if (vibratorManager == null) {
      Log.m102w(TAG, "Failed to vibrate; no vibrator manager.");
      return false;
    }
  ...
  public void addVibratorStateListener(Vibrator.OnVibratorStateChangedListener listener) {
    ...
    if (context == null) {
      Log.m102w(TAG, "Failed to add vibrate state listener; no vibrator context.");
    } else {
  ...
  public void addVibratorStateListener(
    ...
    if (this.mVibratorManager == null) {
      Log.m102w(TAG, "Failed to add vibrate state listener; no vibrator manager.");
      return;
    }
  ...
  public void removeVibratorStateListener(Vibrator.OnVibratorStateChangedListener listener) {
    Objects.requireNonNull(listener);
    if (this.mVibratorManager == null) {
      Log.m102w(TAG, "Failed to remove vibrate state listener; no vibrator manager.");
      return;
    }
    synchronized (this.mRegisteredListeners) {
      if (this.mRegisteredListeners.containsKey(listener)) {
  ...
  public boolean setAlwaysOnEffect(
      int uid, String opPkg, int alwaysOnId, VibrationEffect effect, VibrationAttributes attrs) {
    if (this.mVibratorManager == null) {
      Log.m102w(TAG, "Failed to set always-on effect; no vibrator manager.");
      return false;
    }
  ...
  public void cancel() {
    VibratorManager vibratorManager = this.mVibratorManager;
    if (vibratorManager == null) {
      Log.m102w(TAG, "Failed to cancel vibrate; no vibrator manager.");
    } else {
  ...
  public static class MultiVibratorInfo extends VibratorInfo {
    ...
    private MultiVibratorInfo(
        VibratorInfo[] vibrators, VibratorInfo.FrequencyProfile mergedProfile) {
      super(
          -1,
          ...
          integerLimitIntersection(
              ...
              new Function() { // from class:
                               // android.os.SystemVibrator$MultiVibratorInfo$$ExternalSyntheticLambda0
          ...
          integerLimitIntersection(
              vibrators,
              new Function() { // from class:
                               // android.os.SystemVibrator$MultiVibratorInfo$$ExternalSyntheticLambda1
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
          ...
          integerLimitIntersection(
              vibrators,
              new Function() { // from class:
                               // android.os.SystemVibrator$MultiVibratorInfo$$ExternalSyntheticLambda2
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
          ...
          integerLimitIntersection(
              vibrators,
              new Function() { // from class:
                               // android.os.SystemVibrator$MultiVibratorInfo$$ExternalSyntheticLambda3
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
          ...
          floatPropertyIntersection(
              vibrators,
              new Function() { // from class:
                               // android.os.SystemVibrator$MultiVibratorInfo$$ExternalSyntheticLambda4
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
    ...
    private static VibratorInfo.FrequencyProfile frequencyProfileIntersection(
      ...
      float freqResolution =
          floatPropertyIntersection(
              infos,
              new Function() { // from class:
                               // android.os.SystemVibrator$MultiVibratorInfo$$ExternalSyntheticLambda5
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                  Float valueOf;
                  valueOf =
                      Float.valueOf(
                          ((VibratorInfo) obj).getFrequencyProfile().getFrequencyResolutionHz());
                  return valueOf;
                }
              });
      float resonantFreq =
          floatPropertyIntersection(
              infos,
              new Function() { // from class:
                               // android.os.SystemVibrator$MultiVibratorInfo$$ExternalSyntheticLambda6
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
      ...
      for (VibratorInfo info : infos) {
        ...
        int vibratorStartIdx =
            Math.round(
                (freqRange.getLower().floatValue() - vibratorFreqRange.getLower().floatValue())
                    / freqResolution);
        ...
        if (vibratorStartIdx < 0 || vibratorEndIdx >= vibratorMaxAmplitudes.length) {
          Slog.m121w(
              SystemVibrator.TAG,
              "Error calculating the intersection of vibrator frequency profiles: attempted to"
                  + " fetch from vibrator "
                  + info.getId()
        ...
        for (int i = 0; i < vibratorIds.length; i++) {
          ...
          try {
            ...
            try {
              ...
              Log.m103w(
                  SystemVibrator.TAG,
                  "Failed to unregister listener while recovering from a failed register call",
                  e1);
            }
            throw e;
          }
  ...
  public int semGetSupportedVibrationType() {
    VibratorManager vibratorManager = this.mVibratorManager;
    if (vibratorManager == null) {
      Log.m102w(TAG, "Failed to call semGetSupportedVibrationType; no vibrator service.");
      return -1;
    }
    int ret = vibratorManager.semGetSupportedVibrationType();
    Log.m100v(TAG, "semGetSupportedVibrationType: ret=" + ret);
    return ret;
  }
  ...
  public int semGetNumberOfSupportedPatterns() {
    VibratorManager vibratorManager = this.mVibratorManager;
    if (vibratorManager == null) {
      Log.m102w(TAG, "Failed to call semGetNumberOfSupportedPatterns; no vibrator service.");
      return -1;
    }
    int ret = vibratorManager.semGetNumberOfSupportedPatterns();
    Log.m100v(TAG, "semGetNumberOfSupportedPatterns: ret=" + ret);
    return ret;
  }
  ...
  public boolean semIsHapticSupported() {
    ...
    Log.m102w(TAG, "Failed to call semIsHapticSupported; no vibrator service.");
    return false;
  }
