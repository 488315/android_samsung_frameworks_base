...
class PowerComponents {
  ...
  public double getConsumedPower(BatteryConsumer.Dimensions dimensions) {
    if (dimensions.powerComponent != -1) {
      ...
      return batteryConsumerData.getDouble(
          batteryConsumerData.getKeyOrThrow(dimensions.powerComponent, dimensions.processState)
              .mPowerColumnIndex);
    }
    ...
    return batteryConsumerData2.getDouble(
        batteryConsumerData2.layout.totalConsumedPowerColumnIndex);
  }
  ...
  public double getConsumedPowerForCustomComponent(int componentId) {
    ...
    if (index >= 0 && index < this.mData.layout.customPowerComponentCount) {
      BatteryConsumer.BatteryConsumerData batteryConsumerData = this.mData;
      return batteryConsumerData.getDouble(
          batteryConsumerData.layout.firstCustomConsumedPowerColumn + index);
    }
  ...
  public long getUsageDurationForCustomComponentMillis(int componentId) {
    ...
    if (index >= 0 && index < this.mData.layout.customPowerComponentCount) {
      BatteryConsumer.BatteryConsumerData batteryConsumerData = this.mData;
      return batteryConsumerData.getLong(
          batteryConsumerData.layout.firstCustomUsageDurationColumn + index);
    }
    throw new IllegalArgumentException("Unsupported custom power component ID: " + componentId);
  }
      ...
      if (componentId < 19) {
          ...
          if (powerDeciCoulombs == 0 && durationMs == 0) {
            ...
            if (key.processState == 0) {
              ...
              writePowerComponentUsage(
                  proto, 2246267895810L, componentId, powerDeciCoulombs, durationMs);
            } else {
              i = i2;
              writePowerUsageSlice(
                  proto, componentId, powerDeciCoulombs, durationMs, key.processState);
            }
        ...
        for (int idx = 0; idx < this.mData.layout.customPowerComponentCount; idx++) {
          ...
          if (powerDeciCoulombs2 != 0 || durationMs2 != 0) {
            if (proto != null) {
              writePowerComponentUsage(
                  proto, 2246267895810L, componentId2, powerDeciCoulombs2, durationMs2);
              interestingData = true;
            } else {
              return true;
            }
  ...
  private void writePowerComponentUsage(
      ProtoOutputStream proto, long tag, int componentId, long powerDeciCoulombs, long durationMs) {
  ...
  static final class Builder {
    ...
    public Builder setConsumedPowerForCustomComponent(int componentId, double componentPower) {
      ...
      BatteryConsumer.BatteryConsumerData batteryConsumerData = this.mData;
      batteryConsumerData.putDouble(
          batteryConsumerData.layout.firstCustomConsumedPowerColumn + index, componentPower);
      return this;
    }
    ...
    private void addPowerAndDuration(BatteryConsumer.BatteryConsumerData otherData) {
      ...
      for (int i2 = this.mData.layout.customPowerComponentCount - 1; i2 >= 0; i2--) {
        ...
        batteryConsumerData.putDouble(
            powerColumnIndex,
            batteryConsumerData.getDouble(powerColumnIndex)
        ...
        BatteryConsumer.BatteryConsumerData batteryConsumerData2 = this.mData;
        batteryConsumerData2.putLong(
            usageColumnIndex,
            batteryConsumerData2.getLong(usageColumnIndex)
    ...
    public double getTotalPower() {
      ...
      for (int componentId = 0; componentId < 19; componentId++) {
        BatteryConsumer.BatteryConsumerData batteryConsumerData = this.mData;
        totalPowerMah +=
            batteryConsumerData.getDouble(
                batteryConsumerData.getKeyOrThrow(componentId, 0).mPowerColumnIndex);
      }
      for (int i = 0; i < this.mData.layout.customPowerComponentCount; i++) {
        BatteryConsumer.BatteryConsumerData batteryConsumerData2 = this.mData;
        totalPowerMah +=
            batteryConsumerData2.getDouble(
                batteryConsumerData2.layout.firstCustomConsumedPowerColumn + i);
      }
      return totalPowerMah;
    }
    ...
    public PowerComponents build() {
      BatteryConsumer.BatteryConsumerData batteryConsumerData = this.mData;
      batteryConsumerData.putDouble(
          batteryConsumerData.layout.totalConsumedPowerColumnIndex, getTotalPower());
