...
public class HwBlob {
  ...
  public final void putHidlMemory(long offset, HidlMemory mem) {
    putNativeHandle(0 + offset, mem.getHandle());
    putInt64(16 + offset, mem.getSize());
    putString(24 + offset, mem.getName());
  }
