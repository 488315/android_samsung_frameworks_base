...
public class BaseBundle {
  ...
  public String getPairValue() {
    ...
    if (size > 1) {
      Log.m102w(TAG, "getPairValue() used on Bundle with multiple pairs.");
    }
    if (size == 0) {
      return null;
    }
        ...
        if (this.mOwnsLazyValues) {
          ...
          if (this.mLazyValues == 0) {
            Preconditions.checkState(
                this.mWeakParcelledData.get() != null, "Parcel recycled earlier than expected");
