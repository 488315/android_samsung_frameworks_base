...
public class VolumeRecord implements Parcelable {
  public static final Parcelable.Creator<VolumeRecord> CREATOR =
      new Parcelable.Creator<VolumeRecord>() { // from class: android.os.storage.VolumeRecord.1
  ...
  public void dump(IndentingPrintWriter pw) {
    ...
    pw.printPair(
        "userFlags", DebugUtils.flagsToString(VolumeRecord.class, "USER_FLAG_", this.userFlags));
    pw.println();
  ...
  public VolumeRecord m3772clone() {
