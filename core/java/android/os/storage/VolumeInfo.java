...
public class VolumeInfo implements Parcelable {
  ...
  static {
    ...
    CREATOR =
        new Parcelable.Creator<VolumeInfo>() { // from class: android.os.storage.VolumeInfo.2
  ...
  public File getInternalPathForUser(int userId) {
    ...
    if (i == 0 || i == 5) {
      return new File(
          this.path.replace(FullBackup.MANAGED_EXTERNAL_SPECIFIC_TREE_TOKEN, "/mnt/media_rw/"));
    }
