...
public class SystemConfigManager {
  ...
  private final ISystemConfig mInterface =
      ISystemConfig.Stub.asInterface(ServiceManager.getService(Context.SYSTEM_CONFIG_SERVICE));
  ...
  public Set<String> getDisabledUntilUsedPreinstalledCarrierApps() {
    try {
      ...
      Log.m96e(TAG, "Caught remote exception");
  ...
  public Map<String, List<CarrierAssociatedAppEntry>>
    ...
    try {
      ...
      Log.m97e(TAG, "Caught remote exception", e);
      return Collections.emptyMap();
    }
  }
