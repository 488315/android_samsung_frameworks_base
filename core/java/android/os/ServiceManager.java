...
public final class ServiceManager {
  ...
  public void initLazyServiceManager(Context context) {
    ...
    try {
      ...
      Slog.m116e(TAG, "Failure starting Lazy Service", e);
  ...
  public static void addService(String name, Class type) {
    if (lazyServiceManager == null) {
      try {
        ...
        Log.m97e(TAG, "error in addService", e);
        return;
      }
    }
  ...
  public static IBinder getService(String name) {
    try {
      ...
      Log.m97e(TAG, "error in getService", e);
      return null;
    }
  }
  ...
  public static IBinder checkService(String name) {
    try {
      ...
      Log.m97e(TAG, "error in checkService", e);
      return null;
    }
  }
  ...
  public static boolean isDeclared(String name) {
    try {
      ...
      Log.m97e(TAG, "error in isDeclared", e);
      return false;
    }
  }
  ...
  public static String[] getDeclaredInstances(String iface) {
    try {
      ...
      Log.m97e(TAG, "error in getDeclaredInstances", e);
  ...
  public static String[] listServices() {
    try {
      ...
      Log.m97e(TAG, "error in listServices", e);
      return null;
    }
  }
  ...
  public static ServiceDebugInfo[] getServiceDebugInfo() {
    try {
      ...
      Log.m97e(TAG, "error in getServiceDebugInfo", e);
      return null;
    }
  }
  ...
  private static IBinder rawGetService(String name) throws RemoteException {
    ...
    synchronized (sLock) {
      ...
      if (time >= slowThreshold
          && (nowUptime > sLastSlowLogUptime + 5000 || sLastSlowLogActualTime < time)) {
      ...
      if (i >= logInterval) {
        ...
        if (nowUptime >= j + 5000) {
          EventLogTags.writeServiceManagerStats(
              i, sGetServiceAccumulatedUs / 1000, (int) (nowUptime - j));
