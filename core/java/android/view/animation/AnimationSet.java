...
public class AnimationSet extends Animation {
  ...
  public AnimationSet(Context context, AttributeSet attrs) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.AnimationSet);
  ...
  /* renamed from: clone */
  public AnimationSet mo6029clone() throws CloneNotSupportedException {
    AnimationSet animation = (AnimationSet) super.mo6029clone();
    ...
    for (int i = 0; i < count; i++) {
      animation.mAnimations.add(animations.get(i).mo6029clone());
    }
    return animation;
  }
      ...
      for (int i = count - 1; i >= 0; i--) {
        ...
        if (!a.isFillEnabled() || a.getFillBefore() || a.getStartOffset() == 0) {
          ...
          a.applyTransformation(
              interpolator != null ? interpolator.getInterpolation(0.0f) : 0.0f, temp);
