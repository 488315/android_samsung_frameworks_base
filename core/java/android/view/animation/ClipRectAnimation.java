...
public class ClipRectAnimation extends Animation {
  ...
  public ClipRectAnimation(Context context, AttributeSet attrs) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ClipRectAnimation);
  ...
  public void initialize(int width, int height, int parentWidth, int parentHeight) {
    ...
    this.mFromRect.set(
        ...
        (int) resolveSize(this.mFromBottomType, this.mFromBottomValue, height, parentHeight));
    this.mToRect.set(
