...
public class ExtendAnimation extends Animation {
    ...
    public ExtendAnimation(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ExtendAnimation);
    ...
    public ExtendAnimation(int fromL, int fromT, int fromR, int fromB, int toL, int toT, int toR, int toB) {
        this(Insets.m14of(-fromL, -fromT, -fromR, -fromB), Insets.m14of(-toL, -toT, -toR, -toB));
    }
    ...
    public void initialize(int width, int height, int parentWidth, int parentHeight) {
        ...
        this.mFromInsets = Insets.min(Insets.m14of(-((int) resolveSize(this.mFromLeftType, this.mFromLeftValue, width, parentWidth)), -((int) resolveSize(this.mFromTopType, this.mFromTopValue, height, parentHeight)), -((int) resolveSize(this.mFromRightType, this.mFromRightValue, width, parentWidth)), -((int) resolveSize(this.mFromBottomType, this.mFromBottomValue, height, parentHeight))), Insets.NONE);
        this.mToInsets = Insets.min(Insets.m14of(-((int) resolveSize(this.mToLeftType, this.mToLeftValue, width, parentWidth)), -((int) resolveSize(this.mToTopType, this.mToTopValue, height, parentHeight)), -((int) resolveSize(this.mToRightType, this.mToRightValue, width, parentWidth)), -((int) resolveSize(this.mToBottomType, this.mToBottomValue, height, parentHeight))), Insets.NONE);
    }
}
