...
public class AnticipateOvershootInterpolator extends BaseInterpolator implements NativeInterpolator {
    ...
    public AnticipateOvershootInterpolator(Resources res, Resources.Theme theme, AttributeSet attrs) {
        TypedArray a;
        if (theme != null) {
            a = theme.obtainStyledAttributes(attrs, C4337R.styleable.AnticipateOvershootInterpolator, 0, 0);
        } else {
            a = res.obtainAttributes(attrs, C4337R.styleable.AnticipateOvershootInterpolator);
        }
    ...
    /* renamed from: a */
    private static float m162a(float t, float s) {
        return t * t * (((1.0f + s) * t) - s);
    }

    /* renamed from: o */
    private static float m163o(float t, float s) {
        return t * t * (((1.0f + s) * t) + s);
    }

    @Override // android.animation.TimeInterpolator
    public float getInterpolation(float t) {
        return t < 0.5f ? m162a(2.0f * t, this.mTension) * 0.5f : (m163o((t * 2.0f) - 2.0f, this.mTension) + 2.0f) * 0.5f;
    }
