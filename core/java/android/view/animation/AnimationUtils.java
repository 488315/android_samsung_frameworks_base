        ...
        try {
            try {
                ...
                try {
                    ...
                    Log.m96e(TAG, "RuntimeException for unknown animation name, resouce ID #0x" + Integer.toHexString(id));
                    Log.m96e(TAG, "loadAnimation: getConfiguration = " + context.getResources().getConfiguration());
                    Log.m96e(TAG, "loadAnimation: getDisplayMetrics = " + context.getResources().getDisplayMetrics());
                    try {
