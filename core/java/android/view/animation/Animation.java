...
public abstract class Animation implements Cloneable {
  ...
  public Animation(Context context, AttributeSet attrs) {
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.Animation);
  ...
  public Animation mo6029clone() throws CloneNotSupportedException {
  ...
  public void getInvalidateRegion(
      int left, int top, int right, int bottom, RectF invalidate, Transformation transformation) {
    ...
    static Description parseValue(TypedValue value, Context context) {
      ...
      if (value == null) {
        ...
        if (value.type == 5) {
          d.type = 0;
          d.value =
              TypedValue.complexToDimension(value.data, context.getResources().getDisplayMetrics());
          return d;
        }
      }
      d.type = 0;
