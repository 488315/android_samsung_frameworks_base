...
public final class SelectionEvent implements Parcelable {
  ...
  SelectionEvent(
      int start, int end, int eventType, String entityType, int invocationMethod, String resultId) {
    this.mPackageName = "";
    ...
    switch (eventType) {
      ...
      default:
        throw new IllegalArgumentException(
            String.format(Locale.US, "%d is not an eventType", Integer.valueOf(eventType)));
    }
  }
  ...
  public String toString() {
    return String.format(
        ...
        "SelectionEvent {absoluteStart=%d, absoluteEnd=%d, eventType=%d, entityType=%s,"
            + " widgetVersion=%s, packageName=%s, widgetType=%s, invocationMethod=%s, resultId=%s,"
            + " eventTime=%d, durationSinceSessionStart=%d, durationSincePreviousEvent=%d,"
