...
public final class TextClassificationConstants {
  ...
  void dump(IndentingPrintWriter pw) {
    ...
    pw.print(SMART_SELECT_ANIMATION_ENABLED, Boolean.valueOf(isSmartSelectionAnimationEnabled()))
        .println();
    ...
    pw.print(SYSTEM_TEXT_CLASSIFIER_ENABLED, Boolean.valueOf(isSystemTextClassifierEnabled()))
        .println();
    pw.print(TEXT_CLASSIFIER_SERVICE_PACKAGE_OVERRIDE, getTextClassifierServicePackageOverride())
        .println();
    pw.print(
            SYSTEM_TEXT_CLASSIFIER_API_TIMEOUT_IN_SECOND,
