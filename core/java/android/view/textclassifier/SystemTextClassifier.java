...
public final class SystemTextClassifier implements TextClassifier {
  ...
  public TextSelection suggestSelection(TextSelection.Request request) {
    ...
    try {
      ...
      Log.m167e("androidtc", "Error suggesting selection for text. Using fallback.", e);
    }
  ...
  public TextClassification classifyText(TextClassification.Request request) {
    ...
    try {
      ...
      Log.m167e("androidtc", "Error classifying text. Using fallback.", e);
    }
  ...
  public TextLinks generateLinks(TextLinks.Request request) {
    ...
    try {
      ...
      Log.m167e("androidtc", "Error generating links. Using fallback.", e);
    }
    return this.mFallback.generateLinks(request);
  }
  ...
  public void onSelectionEvent(SelectionEvent event) {
    ...
    try {
      ...
      Log.m167e("androidtc", "Error reporting selection event.", e);
    }
  }
  ...
  public void onTextClassifierEvent(TextClassifierEvent event) {
    ...
    try {
      ...
      Log.m167e("androidtc", "Error reporting textclassifier event.", e);
    }
  }
  ...
  public TextLanguage detectLanguage(TextLanguage.Request request) {
    ...
    try {
      ...
      Log.m167e("androidtc", "Error detecting language.", e);
    }
  ...
  public void destroy() {
    try {
      ...
      Log.m167e("androidtc", "Error destroying classification session.", e);
    }
  }
  ...
  void initializeRemoteSession(
    ...
    try {
      ...
      Log.m167e("androidtc", "Error starting a new classification session.", e);
    }
  }
  ...
  private static final class ResponseReceiver<T> {
    ...
    public void onFailure() {
      Log.m167e("androidtc", "Request failed at " + this.mName, null);
      this.mLatch.countDown();
    }
    ...
    public T get() {
      if (Looper.myLooper() != Looper.getMainLooper()) {
        try {
          boolean success =
              this.mLatch.await(
                  this.mSettings.getSystemTextClassifierApiTimeoutInSecond(), TimeUnit.SECONDS);
          if (!success) {
            Log.m169w("androidtc", "Timeout in ResponseReceiver.get(): " + this.mName);
          }
        } catch (InterruptedException e) {
          Thread.currentThread().interrupt();
          Log.m167e("androidtc", "Interrupted during ResponseReceiver.get(): " + this.mName, e);
        }
      }
