...
public final class TextClassification implements Parcelable {
  ...
  public static final Parcelable.Creator<TextClassification> CREATOR =
      new Parcelable.Creator<
          TextClassification>() { // from class: android.view.textclassifier.TextClassification.1
  ...
  private TextClassification(
      ...
      String legacyLabel,
      Intent legacyIntent,
      View.OnClickListener legacyOnClickListener,
  ...
  public Builder toBuilder() {
    return new Builder()
        .setId(this.mId)
        .setText(this.mText)
        .addActions(this.mActions)
        .setEntityConfidence(this.mEntityConfidence)
        .setIcon(this.mLegacyIcon)
        .setLabel(this.mLegacyLabel)
        .setIntent(this.mLegacyIntent)
        .setOnClickListener(this.mLegacyOnClickListener)
  ...
  static /* synthetic */ void lambda$createIntentOnClickListener$0(PendingIntent intent, View v) {
    try {
      ...
      Log.m167e(LOG_TAG, "Error sending PendingIntent", e);
    }
  }
  ...
  public static final class Builder {
    ...
    public TextClassification build() {
      ...
      return new TextClassification(
          str, drawable, str2, intent, onClickListener, list, entityConfidence, str3, bundle);
    }
  }
  ...
  public static final class Request implements Parcelable {
    public static final Parcelable.Creator<Request> CREATOR =
        new Parcelable.Creator<
            Request>() { // from class: android.view.textclassifier.TextClassification.Request.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public static Request readFromParcel(Parcel in) {
      ...
      Request request =
          new Request(text, startIndex, endIndex, defaultLocales, referenceTime, extras);
  ...
  private TextClassification(Parcel in) {
    ...
    if (!createTypedArrayList.isEmpty()) {
      ...
      this.mLegacyOnClickListener =
          createIntentOnClickListener(
              ((RemoteAction) createTypedArrayList.get(0)).getActionIntent());
    } else {
