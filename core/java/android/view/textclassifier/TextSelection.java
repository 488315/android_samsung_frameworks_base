...
public final class TextSelection implements Parcelable {
  ...
  public static final class Request implements Parcelable {
    public static final Parcelable.Creator<Request> CREATOR =
        new Parcelable.Creator<
            Request>() { // from class: android.view.textclassifier.TextSelection.Request.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public static Request readFromParcel(Parcel in) {
      ...
      Request request =
          new Request(
              text, startIndex, endIndex, defaultLocales, false, includeTextClassification, extras);
  ...
  private TextSelection(Parcel in) {
    ...
    this.mTextClassification =
        (TextClassification)
            in.readParcelable(TextClassification.class.getClassLoader(), TextClassification.class);
  }
}
