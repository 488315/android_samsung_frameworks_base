...
public final class TextLinksParams {
  private static final Function<TextLinks.TextLink, TextLinks.TextLinkSpan> DEFAULT_SPAN_FACTORY =
      new Function() { // from class:
                       // android.view.textclassifier.TextLinksParams$$ExternalSyntheticLambda0
  ...
  private TextLinksParams(
      int applyStrategy, Function<TextLinks.TextLink, TextLinks.TextLinkSpan> spanFactory) {
  ...
  public static TextLinksParams fromLinkMask(int mask) {
    ...
    return new Builder()
        .setEntityConfig(TextClassifier.EntityConfig.createWithExplicitEntityList(entitiesToFind))
        .build();
  }
  ...
  public int apply(Spannable text, TextLinks textLinks) {
    ...
    while (true) {
      ...
      if (span != null) {
        ClickableSpan[] existingSpans =
            (ClickableSpan[]) text.getSpans(link.getStart(), link.getEnd(), ClickableSpan.class);
  ...
  public static final class Builder {
    ...
    private Function<TextLinks.TextLink, TextLinks.TextLinkSpan> mSpanFactory =
        TextLinksParams.DEFAULT_SPAN_FACTORY;
    ...
    public Builder setSpanFactory(
        Function<TextLinks.TextLink, TextLinks.TextLinkSpan> spanFactory) {
