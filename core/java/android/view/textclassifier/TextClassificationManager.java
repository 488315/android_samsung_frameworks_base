...
public final class TextClassificationManager {
    ...
    private final TextClassificationSessionFactory mDefaultSessionFactory =
            new TextClassificationSessionFactory() { // from class:
                ...
                public final TextClassifier createTextClassificationSession(
                    ...
                    lambda$new$0 =
                            TextClassificationManager.this.lambda$new$0(textClassificationContext);
                    return lambda$new$0;
                }
            };
        ...
        synchronized (this.mLock) {
            if (getSettings().isSystemTextClassifierEnabled()) {
                try {
                    Log.d(
                            "androidtc",
                            "Initializing SystemTextClassifier, type = "
    ...
    private TextClassifier getLocalTextClassifier() {
        Log.d(
                "androidtc",
                "Local text-classifier not supported. Returning a no-op text-classifier.");
        return TextClassifier.NO_OP;
    }
