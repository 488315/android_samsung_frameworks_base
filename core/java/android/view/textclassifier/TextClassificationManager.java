...
public final class TextClassificationManager {
  ...
  public TextClassificationManager(Context context) {
    TextClassificationSessionFactory textClassificationSessionFactory =
        new TextClassificationSessionFactory() { // from class:
          ...
          public final TextClassifier createTextClassificationSession(
  ...
  public TextClassifier createTextClassificationSession(
    ...
    TextClassifier textClassifier =
        this.mSessionFactory.createTextClassificationSession(classificationContext);
    ...
    synchronized (this.mLock) {
      if (getSettings().isSystemTextClassifierEnabled()) {
        try {
          Log.m166d(
              "androidtc",
              "Initializing SystemTextClassifier, type = " + TextClassifier.typeToString(type));
          return new SystemTextClassifier(this.mContext, getSettings(), type == 2);
        } catch (ServiceManager.ServiceNotFoundException e) {
          Log.m167e("androidtc", "Could not initialize SystemTextClassifier", e);
        }
      }
  ...
  private TextClassifier getLocalTextClassifier() {
    Log.m166d(
        "androidtc", "Local text-classifier not supported. Returning a no-op text-classifier.");
    return TextClassifier.NO_OP;
  }
