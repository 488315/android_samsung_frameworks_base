...
public final class TextLinks implements Parcelable {
  ...
  public static final Parcelable.Creator<TextLinks> CREATOR =
      new Parcelable.Creator<TextLinks>() { // from class: android.view.textclassifier.TextLinks.1
  ...
  public static final class TextLink implements Parcelable {
    public static final Parcelable.Creator<TextLink> CREATOR =
        new Parcelable.Creator<
            TextLink>() { // from class: android.view.textclassifier.TextLinks.TextLink.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    private TextLink(
        int start, int end, EntityConfidence entityConfidence, Bundle extras, URLSpan urlSpan) {
  ...
  public static final class Builder {
    ...
    private Builder addLink(
        int start, int end, Map<String, Float> entityScores, Bundle extras, URLSpan urlSpan) {
      this.mLinks.add(
