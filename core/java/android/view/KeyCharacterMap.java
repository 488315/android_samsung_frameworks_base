...
public class KeyCharacterMap implements Parcelable {
  ...
  static {
    ...
    sparseIntArray.append(
        MetricsProto.MetricsEvent.WIFI_NETWORK_RECOMMENDATION_SAVED_NETWORK_EVALUATOR,
        ACCENT_COMMA_ABOVE);
    ...
    CREATOR =
        new Parcelable.Creator<KeyCharacterMap>() { // from class: android.view.KeyCharacterMap.1
