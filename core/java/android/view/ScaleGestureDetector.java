...
public class ScaleGestureDetector {
    ...
    public float getScaleFactor() {
        ...
        if (Float.isNaN(sqrtValue)) {
            Log.m96e(TAG, "getScaleFactor: Cannot getScaleFactor, sqrtValue is NaN, mCurrLenBeforeSqrt = " + this.mCurrLenBeforeSqrt + ", mPrevLenBeforeSqrt = " + this.mPrevLenBeforeSqrt);
            return 1.0f;
        }
        if (this.mPrevLenBeforeSqrt > 0.0f) {
            return sqrtValue;
