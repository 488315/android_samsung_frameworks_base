...
public final class MotionPredictor {
    ...
    public MotionPredictor(Context context) {
        this.mIsPredictionEnabled = context.getResources().getBoolean(C4337R.bool.config_enableMotionPrediction);
        int offsetNanos = context.getResources().getInteger(C4337R.integer.config_motionPredictionOffsetNanos);
