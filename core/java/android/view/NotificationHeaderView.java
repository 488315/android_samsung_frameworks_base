...
public class NotificationHeaderView extends RelativeLayout {
    ...
    public NotificationHeaderView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mTouchableHeight = res.getDimensionPixelSize(C4337R.dimen.notification_header_touchable_height);
        this.mEntireHeaderClickable = res.getBoolean(C4337R.bool.config_notificationHeaderClickableForExpand);
    }
