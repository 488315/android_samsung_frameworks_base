            ...
            case 0:
                if (this.mDoubleTapListener != null) {
                    ...
                    if (motionEvent4 != null && (motionEvent2 = this.mPreviousUpEvent) != null && hadTapMessage && isConsideredDoubleTap(motionEvent4, motionEvent2, ev)) {
                        ...
                        Log.m98i(TAG, "obtain mCurrentDownEvent. id: " + ev.getId() + " caller: " + Debug.getCallers(3));
                        ...
                        if (this.mIsDoubleTapping) {
                            ...
                            if (!shouldInhibitDefaultAction) {
                                ...
                                if (deltaY2 > slopSquare) {
                                    ...
                                    hasPendingLongPress = hasPendingLongPress2;
                                    handled4 = false;
                                    handler2.sendMessageAtTime(handler2.obtainMessage(2, 3, 0), ev.getDownTime() + ((long) (longPressTimeout * this.mAmbiguousGestureMultiplier)));
                                } else {
                                    motionClassification = motionClassification2;
                                    hasPendingLongPress = hasPendingLongPress2;
                                    handled4 = false;
                            ...
                            if (Math.abs(scrollX) >= 1.0f || Math.abs(scrollY) >= 1.0f) {
                                recordGestureClassification(5);
                                boolean handled7 = this.mListener.onScroll(this.mCurrentDownEvent, ev, scrollX, scrollY);
                                this.mLastFocusX = focusX;
                                this.mLastFocusY = focusY;
                                handled2 = handled7;
                            } else {
