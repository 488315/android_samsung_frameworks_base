    ...
    */
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = MenuInflater.this.mContext.obtainStyledAttributes(attrs, C4337R.styleable.MenuGroup);
        ...
        public void readItem(AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = MenuInflater.this.mContext.obtainStyledAttributes(attributeSet, C4337R.styleable.MenuItem);
            ...
            if (z && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                ...
                if (z) {
                    Log.m102w(MenuInflater.LOG_TAG, "Ignoring attribute 'actionProviderClass'. Action view already specified.");
                }
        ...
        private void setItem(MenuItem item) {
            ...
            if (i2 > 0) {
                if (!actionViewSpecified) {
                    ...
                    Log.m102w(MenuInflater.LOG_TAG, "Ignoring attribute 'itemActionViewLayout'. Action view already specified.");
                }
            }
