...
public class InsetsSourceConsumer {
    ...
    private void applyRequestedVisibilityToControl() {
        ...
        try {
            Log.m98i(TAG, "applyRequestedVisibilityToControl: visible=" + requestedVisible + ", type=" + WindowInsets.Type.toString(this.mType) + ", host=" + this.mController.getHost().getRootViewTitle());
            if (requestedVisible) {
    ...
    private void ensureControlPosition() {
        ...
        matrix.setTranslate(this.mSourceControl.getSurfacePosition().f85x, this.mSourceControl.getSurfacePosition().f86y);
