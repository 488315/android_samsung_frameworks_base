...
public class RemoteAnimationDefinition implements Parcelable {
  public static final Parcelable.Creator<RemoteAnimationDefinition> CREATOR =
      new Parcelable.Creator<
          RemoteAnimationDefinition>() { // from class: android.view.RemoteAnimationDefinition.1
  ...
  public RemoteAnimationDefinition(Parcel in) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      RemoteAnimationAdapterEntry entry =
          (RemoteAnimationAdapterEntry) in.readTypedObject(RemoteAnimationAdapterEntry.CREATOR);
  ...
  public void linkToDeath(IBinder.DeathRecipient deathRecipient) {
    for (int i = 0; i < this.mTransitionAnimationMap.size(); i++) {
      try {
        ...
        Slog.m115e("RemoteAnimationDefinition", "Failed to link to death recipient");
        return;
      }
    }
  }
