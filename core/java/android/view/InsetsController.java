...
public class InsetsController implements WindowInsetsController, InsetsAnimationControlCallbacks {
  ...
  private static final Interpolator SYSTEM_BARS_DIM_INTERPOLATOR =
      new Interpolator() { // from class: android.view.InsetsController$$ExternalSyntheticLambda0
  ...
  public interface Host {
    ...
    void applySurfaceParams(
        boolean z, SyncRtSurfaceTransactionApplier.SurfaceParams... surfaceParamsArr);
  ...
  static {
    ...
    sEvaluator =
        new TypeEvaluator() { // from class: android.view.InsetsController$$ExternalSyntheticLambda1
          ...
          public final Object evaluate(float f, Object obj, Object obj2) {
            ...
            m14of =
                Insets.m14of(
                    ...
                    (int) (insets.bottom + ((insets2.bottom - insets.bottom) * f)));
            return m14of;
          }
        };
  }
  ...
  public static class InternalAnimationControlListener
    ...
    public InternalAnimationControlListener(
      ...
      this.mSfAnimationHandlerThreadLocal =
          new ThreadLocal<
              AnimationHandler>() { // from class:
          ...
          new ValueAnimator
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
              InsetsController.InternalAnimationControlListener.this.lambda$onReady$0(
                  insetsInterpolator, controller, start, end, alphaInterpolator, valueAnimator);
            }
          });
      this.mAnimator.addListener(
          new AnimatorListenerAdapter() { // from class:
            ...
            public void onAnimationStart(Animator animator) {
              ...
              ImeTracker.forJank()
                  .onRequestAnimation(
                      InternalAnimationControlListener.this.mInputMethodJankContext,
                      !InternalAnimationControlListener.this.mShow ? 1 : 0,
      ...
      return new Interpolator() { // from class:
        ...
        public final float getInterpolation(float f) {
          ...
          lambda$getInsetsInterpolator$1 =
              InsetsController.InternalAnimationControlListener.this.lambda$getInsetsInterpolator$1(
                  f);
    ...
    Interpolator getAlphaInterpolator() {
      ...
      if (this.mBehavior == 2) {
        return new Interpolator() { // from class:
          ...
          @Override // android.animation.TimeInterpolator
          public final float getInterpolation(float f) {
            return InsetsController.InternalAnimationControlListener.lambda$getAlphaInterpolator$5(
                f);
          }
        };
      }
    ...
    private long calculateDurationMs() {
      if ((this.mRequestedTypes & WindowInsets.Type.ime()) == 0) {
        return (this.mBehavior == 2 || CoreRune.FW_CUSTOM_BASIC_INSET_ANIM)
  ...
  public InsetsController(Host host) {
    this(
        host,
        new TriFunction() { // from class: android.view.InsetsController$$ExternalSyntheticLambda7
  ...
  static /* synthetic */ InsetsSourceConsumer lambda$new$2(
    ...
    if (type.intValue() == WindowInsets.Type.ime()) {
      return new ImeInsetsSourceConsumer(
          id.intValue(),
          controller.mState,
          new InsetsController$$ExternalSyntheticLambda8(),
          controller);
    }
  ...
  public InsetsController(
      ...
      Handler handler) {
    this.mJankContext =
        new ImeTracker.InputMethodJankContext() { // from class: android.view.InsetsController.1
    ...
    this.mPendingControlTimeout =
        new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda9
    ...
    this.mInvokeControllableInsetsChangedListeners =
        new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda10
          @Override // java.lang.Runnable
          public final void run() {
    ...
    this.mRemoveGoneSources =
        new InsetsState.OnTraverseCallbacks() { // from class: android.view.InsetsController.2
          ...
          public void onIdNotFoundInState2(int index1, InsetsSource source1) {
            if (!ViewRootImpl.CAPTION_ON_SHELL
                && source1.getType() == WindowInsets.Type.captionBar()) {
              return;
            }
    ...
    this.mStartResizingAnimationIfNeeded =
        new InsetsState.OnTraverseCallbacks() { // from class: android.view.InsetsController.3
            ...
            if (type != WindowInsets.Type.navigationBars()
                && (consumer =
                        (InsetsSourceConsumer)
                            InsetsController.this.mSourceConsumers.get(source1.getId()))
                    != null
                && consumer.getControl() != null
                && (WindowInsets.Type.systemBars() & type) != 0
                && source1.isVisible()
                && source2.isVisible()
                && !source1.getFrame().equals(source2.getFrame())) {
              if (!Rect.intersects(InsetsController.this.mFrame, source1.getFrame())
                  && !Rect.intersects(InsetsController.this.mFrame, source2.getFrame())) {
                return;
              }
              this.mTypes |= type;
    ...
    this.mAnimCallback =
        new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda11
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$new$3() {
    ...
    WindowInsets insets =
        state.calculateInsets(
            rect, insetsState, isRound, i3, i4, i, this.mWindowType, this.mLastActivityType, null);
  ...
  private void updateState(InsetsState newState) {
    ...
    if (cancelledUserAnimationTypes[0] != 0) {
      this.mHandler.post(
          new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void show(int types, boolean fromIme, ImeTracker.Token statsToken) {
    if ((WindowInsets.Type.ime() & types) != 0) {
      Log.m94d(TAG, "show(ime(), fromIme=" + fromIme + NavigationBarInflaterView.KEY_CODE_END);
    }
    if (fromIme) {
      ImeTracing.getInstance()
          .triggerClientDump("InsetsController#show", this.mHost.getInputMethodManager(), null);
    ...
    if (fromIme && this.mPendingImeControlRequest != null) {
      if ((WindowInsets.Type.ime() & types) != 0) {
        ImeTracker.forLatency()
            .onShown(statsToken, new InsetsController$$ExternalSyntheticLambda2());
      }
    ...
    int typesReady = 0;
    boolean imeVisible =
        this.mState.isSourceOrDefaultVisible(
            this.mImeSourceConsumer.getId(), WindowInsets.Type.ime());
    int type = 1;
    while (true) {
      if (type > 512) {
        break;
  ...
  public void hide(int types, boolean fromIme, ImeTracker.Token statsToken) {
    if (!fromIme) {
      ...
      ImeTracing.getInstance()
          .triggerClientDump("InsetsController#hide", this.mHost.getInputMethodManager(), null);
  ...
  public void controlWindowInsetsAnimation(
    ...
    controlWindowInsetsAnimation(
        types, cancellationSignal, listener, false, durationMillis, interpolator, 2);
  }
  ...
  private void controlAnimationUncheckedInner(
    ...
    if ((types & this.mTypesBeingCancelled) != 0) {
      ...
      if (monitoredAnimation && (types & WindowInsets.Type.ime()) != 0) {
        if (animationType == 0) {
          ImeTracker.forLatency()
              .onShowCancelled(statsToken, 40, new InsetsController$$ExternalSyntheticLambda2());
        } else {
          ImeTracker.forLatency()
              .onHideCancelled(statsToken, 40, new InsetsController$$ExternalSyntheticLambda2());
        }
      }
    ...
    if (animationType != 2) {
      ...
      Log.m94d(TAG, "user animation disabled types: " + disabledTypes);
    ...
    Pair<Integer, Boolean> typesReadyPair =
        collectSourceControls(fromIme, types2, controls, animationType, statsToken);
    ...
    if (imeReady) {
      ...
      if (useInsetsAnimationThread) {
        ...
        insetsAnimationControlImpl =
            new InsetsAnimationControlImpl(
                ...
                animationType,
                layoutInsetsDuringAnimation,
                insetsController.mHost.getTranslator(),
                statsToken);
      }
      ...
      if ((WindowInsets.Type.ime() & typesReady) == 0) {
        ...
        ImeTracing.getInstance()
            .triggerClientDump(
                "InsetsAnimationControlImpl", insetsController.mHost.getInputMethodManager(), null);
        i = animationType;
        if (i != 1) {
          token = statsToken;
        } else {
      ...
      Log.m98i(
          ...
          "controlAnimationUncheckedInner: Added types="
              + WindowInsets.Type.toString(typesReady)
              + ", animType="
              + i
              + ", host="
              + insetsController.mHost.getRootViewTitle()
              + ", from="
              + Debug.getCallers(3));
          ...
          if (fromIme) {
            Log.m102w(
                ...
                String.format(
                    ...
                    WindowInsets.Type.toString(consumer.getType()), Boolean.valueOf(fromIme)));
          }
        } else {
  ...
  public void notifyFinished(InsetsAnimationControlRunner runner, boolean shown) {
    if (runner.isCancelRequested()) {
      Log.m94d(TAG, "Ignore notifyFinished beacuse the animation has already been canceled.");
      return;
    }
  ...
  void applySurfaceParams(
      boolean ignoreVisibility, SyncRtSurfaceTransactionApplier.SurfaceParams... params) {
  ...
  public InsetsSourceConsumer getSourceConsumer(int id, int type) {
    ...
    if (type == WindowInsets.Type.ime()
        && (insetsSourceConsumer = this.mImeSourceConsumer) != null) {
  ...
  public <T extends InsetsAnimationControlRunner & InternalInsetsAnimationController>
    ...
    this.mHost.addOnPreDrawRunnable(
        new Runnable() { // from class: android.view.InsetsController$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
          public final void run() {
            InsetsController.this.lambda$startAnimation$7(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$startAnimation$7(
      InsetsAnimationControlRunner runner,
      int types,
  ...
  public void setCaptionInsetsHeight(int height) {
    if (!ViewRootImpl.CAPTION_ON_SHELL && this.mCaptionInsetsHeight != height) {
      ...
      if (height != 0) {
        this.mState
            .getOrCreateSource(ID_CAPTION_BAR, WindowInsets.Type.captionBar())
            .setFrame(
                this.mFrame.left,
                this.mFrame.top,
                this.mFrame.right,
                this.mFrame.top + this.mCaptionInsetsHeight);
      } else {
