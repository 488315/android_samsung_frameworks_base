...
public final class InputMethodSubtype implements Parcelable {
  ...
  public static final Parcelable.Creator<InputMethodSubtype> CREATOR =
      new Parcelable.Creator<
          InputMethodSubtype>() { // from class: android.view.inputmethod.InputMethodSubtype.1
  ...
  public CharSequence getDisplayName(Context context, String packageName, ApplicationInfo appInfo) {
    ...
    if (containsExtraValueKey(EXTRA_KEY_UNTRANSLATABLE_STRING_IN_SUBTYPE_NAME)) {
      ...
      replacementString =
          getLocaleDisplayName(getLocaleFromContext(context), getLocaleObject(), displayContext);
    }
    ...
    try {
      ...
      Slog.m121w(TAG, "Found illegal format in subtype name(" + ((Object) subtypeName) + "): " + e);
      return "";
    }
  }
    ...
    synchronized (this) {
      ...
      for (String str : pairs) {
        ...
        if (pair.length == 1) {
          ...
          if (pair.length > 2) {
            Slog.m121w(TAG, "ExtraValue has two or more '='s");
          }
