...
public final class InputMethodManager {
  ...
  private final ImeOnBackInvokedDispatcher mImeDispatcher =
      new ImeOnBackInvokedDispatcher(
          Handler.getMain()) { // from class: android.view.inputmethod.InputMethodManager.1
          ...
          synchronized (InputMethodManager.this.f584mH) {
            onBackInvokedDispatcher =
                InputMethodManager.this.mCurRootView != null
                    ? InputMethodManager.this.mCurRootView.getOnBackInvokedDispatcher()
                    : null;
          }
  ...
  private final IInputMethodClient.Stub mClient =
      new IInputMethodClient.Stub() { // from class: android.view.inputmethod.InputMethodManager.2
        ...
        protected void dump(FileDescriptor fd, PrintWriter fout, String[] args) {
          ...
          sargs.arg3 = args;
          sargs.arg4 = latch;
          InputMethodManager.this.f584mH.sendMessage(
              InputMethodManager.this.f584mH.obtainMessage(1, sargs));
          try {
        ...
        public void updateVirtualDisplayToScreenMatrix(int bindSequence, float[] matrixValues) {
          InputMethodManager.this
              .f584mH
              .obtainMessage(30, bindSequence, 0, matrixValues)
              .sendToTarget();
        }
  ...
  private InputMethodManager getFallbackInputMethodManagerIfNecessary(View view) {
    ...
    InputMethodManager fallbackImm =
        (InputMethodManager) viewRootImpl.mContext.getSystemService(InputMethodManager.class);
    if (fallbackImm == null) {
    ...
    public void onPostWindowGainedFocus(
      ...
      synchronized (InputMethodManager.this.f584mH) {
        ...
        if (nextFocusIsServedView
            && !InputMethodManager.this.hasActiveInputConnectionInternal(viewForWindowFocus)) {
          forceFocus2 = true;
        }
      }
          ...
          try {
            ...
            if (!InputMethodManager.this.mRestartOnNextWindowFocus) {
              ...
              if (InputMethodManager.DEBUG) {
                Log.m100v(
                    InputMethodManager.TAG, "Restarting due to mRestartOnNextWindowFocus as true");
              }
            ...
            try {
              ...
              boolean checkFocusResult =
                  inputMethodManager.checkFocusInternalLocked(
                      forceFocus, inputMethodManager.mCurRootView);
              if (checkFocusResult
                  && InputMethodManager.this.startInputOnWindowFocusGainInternal(
                      1, viewForWindowFocus, startInputFlags, softInputMode, windowFlags)) {
                return;
              }
              synchronized (InputMethodManager.this.f584mH) {
                try {
                  try {
                    if (InputMethodManager.DEBUG) {
                      try {
                        Log.m100v(
                            InputMethodManager.TAG, "Reporting focus gain, without startInput");
                      } catch (Throwable th) {
                        th = th;
                        throw th;
                      }
                    ...
                    IInputMethodManagerGlobalInvoker.startInputOrWindowGainedFocus(
                        ...
                        null,
                        null,
                        InputMethodManager.this.mCurRootView.mContext.getApplicationInfo()
                            .targetSdkVersion,
                        UserHandle.myUserId(),
    ...
    synchronized (this.f584mH) {
      z =
          this.mCurRootView != null
              ...
              && (remoteInputConnectionImpl = this.mServedInputConnection) != null
              && remoteInputConnectionImpl.isAssociatedWith(view)
      ...
      switch (msg.what) {
        case 1:
          ...
          try {
            InputMethodManager.this.doDump(
                (FileDescriptor) args.arg1, (PrintWriter) args.arg2, (String[]) args.arg3);
        ...
        case 2:
          ...
          if (InputMethodManager.DEBUG) {
            Log.m98i(
                InputMethodManager.TAG,
                "handleMessage: MSG_BIND " + res.sequence + "," + res.f684id);
          }
          synchronized (InputMethodManager.this.f584mH) {
            ...
            if (curBindSequence >= 0 && curBindSequence == res.sequence) {
              ...
              InputMethodManager.this.mVirtualDisplayToScreenMatrix =
                  res.getVirtualDisplayToScreenMatrix();
              InputMethodManager.this.startInputInner(6, null, 0, 0, 0);
              return;
            }
            Log.m102w(
                InputMethodManager.TAG,
                "Ignoring onBind: cur seq=" + curBindSequence + ", given seq=" + res.sequence);
        ...
        case 4:
          ...
          synchronized (InputMethodManager.this.f584mH) {
            ...
            if (servedView2 != null && InputMethodManager.canStartInput(servedView2)) {
              ...
              InputMethodManager inputMethodManager = InputMethodManager.this;
              if (inputMethodManager.checkFocusInternalLocked(
                  inputMethodManager.mRestartOnNextWindowFocus,
        ...
        case 11:
          ...
          if (InputMethodManager.DEBUG) {
            Log.m98i(
                InputMethodManager.TAG,
                "handleMessage: MSG_BIND_ACCESSIBILITY " + res2.sequence + "," + res2.f684id);
          }
          synchronized (InputMethodManager.this.f584mH) {
              ...
              if (res2.accessibilitySessions != null
                  && (invoker =
                          IAccessibilityInputMethodSessionInvoker.createOrNull(
                              res2.accessibilitySessions.get(sequence2)))
                      != null) {
            ...
            Log.m102w(
                InputMethodManager.TAG,
                "Ignoring onBind: cur seq=" + curBindSequence2 + ", given seq=" + res2.sequence);
        ...
        case 12:
          ...
          if (InputMethodManager.DEBUG) {
            Log.m98i(
                InputMethodManager.TAG,
                "handleMessage: MSG_UNBIND_ACCESSIBILITY_SERVICE " + sequence3 + " id=" + id);
          }
          synchronized (InputMethodManager.this.f584mH) {
              ...
              rootView.post(
                  new Runnable() { // from class:
                    ...
                    public final void run() {
                      InputMethodManager.HandlerC3829H.this.lambda$handleMessage$0(
                          currentViewRootImpl);
                    }
                  });
            } else {
        ...
        case 30:
          ...
          synchronized (InputMethodManager.this.f584mH) {
            ...
            if (matrixValues != null
              ...
              if (InputMethodManager.this.mCursorAnchorInfo != null
                ...
                if (InputMethodManager.this.mServedInputConnection.isCursorAnchorInfoMonitoring()) {
                  InputMethodManager.this.mCurBindState.mImeSession.updateCursorAnchorInfo(
                      CursorAnchorInfo.createForAdditionalParentMatrix(
                          InputMethodManager.this.mCursorAnchorInfo,
                          InputMethodManager.this.mVirtualDisplayToScreenMatrix));
                  return;
                }
                return;
  ...
  private InputMethodManager(IInputMethodManager service, int displayId, Looper looper) {
    ...
    this.mFallbackInputConnection =
        new RemoteInputConnectionImpl(looper, new BaseInputConnection(this, false), this, null);
  }
  ...
  public static InputMethodManager getInstance() {
    Log.m103w(
        TAG,
        "InputMethodManager.getInstance() is deprecated because it cannot be compatible with"
            + " multi-display. Use context.getSystemService(InputMethodManager.class) instead.",
        new Throwable());
  ...
  public static InputMethodManager peekInstance() {
    ...
    Log.m103w(
        TAG,
        "InputMethodManager.peekInstance() is deprecated because it cannot be compatible with"
            + " multi-display. Use context.getSystemService(InputMethodManager.class) instead.",
        new Throwable());
    synchronized (sLock) {
            ...
            new PropertyInvalidatedCache<Integer, Boolean>(
              ...
              public Boolean recompute(Integer userId2) {
                return Boolean.valueOf(
                    IInputMethodManagerGlobalInvoker.isStylusHandwritingAvailableAsUser(
                        userId2.intValue()));
              }
            };
      }
      isAvailable =
          this.mStylusHandwritingAvailableCache.query(Integer.valueOf(userId)).booleanValue();
    }
    return isAvailable;
  }
  ...
  public List<InputMethodSubtype> getEnabledInputMethodSubtypeList(
    ...
    return IInputMethodManagerGlobalInvoker.getEnabledInputMethodSubtypeList(
        imi == null ? null : imi.getId(), allowsImplicitlyEnabledSubtypes, UserHandle.myUserId());
  }

  public List<InputMethodSubtype> getEnabledInputMethodSubtypeListAsUser(
      String imeId, boolean allowsImplicitlyEnabledSubtypes, int userId) {
    return IInputMethodManagerGlobalInvoker.getEnabledInputMethodSubtypeList(
        (String) Objects.requireNonNull(imeId), allowsImplicitlyEnabledSubtypes, userId);
  }
  ...
  private boolean showSoftInput(
    ...
    ImeTracker.forLatency()
        .onRequestShow(statsToken, 1, reason, new InsetsController$$ExternalSyntheticLambda2());
    ...
    synchronized (this.f584mH) {
      if (!hasServedByInputMethodLocked(view)) {
        ...
        ImeTracker.forLatency()
            .onShowFailed(statsToken, 1, new InsetsController$$ExternalSyntheticLambda2());
  ...
  public void showSoftInputUnchecked(int flags, ResultReceiver resultReceiver) {
    synchronized (this.f584mH) {
      ImeTracker.Token statsToken =
          ImeTracker.forLogging().onRequestShow(null, Process.myUid(), 1, 1);
      Log.m102w(
          TAG,
          "showSoftInputUnchecked() is a hidden method, which will be removed soon. If you are"
              + " using androidx.appcompat.widget.SearchView, please update to version 26.0 or"
              + " newer version.");
      ...
      if (viewRootImpl != null && viewRootImpl.getView() != null) {
        ...
        IInputMethodManagerGlobalInvoker.showSoftInput(
            this.mClient,
            this.mCurRootView.getView().getWindowToken(),
            statsToken,
            flags,
            this.mCurRootView.getLastClickToolType(),
            resultReceiver,
  ...
  private boolean hideSoftInputFromWindow(
    ...
    ImeTracker.Token statsToken =
        ImeTracker.forLogging().onRequestHide(null, Process.myUid(), 2, reason);
    ImeTracker.forLatency()
        .onRequestHide(statsToken, 2, reason, new InsetsController$$ExternalSyntheticLambda2());
    ImeTracing.getInstance()
    ...
    synchronized (this.f584mH) {
      ...
      Log.m98i(
          TAG_LIFE_CYCLE,
          "hsifw() ignored windowToken="
              + (windowToken == null ? SemCapabilities.FEATURE_TAG_NULL : windowToken)
              + " servedView="
              + (servedView == null
  ...
  public boolean doInvalidateInput(
      RemoteInputConnectionImpl inputConnection, TextSnapshot textSnapshot, final int sessionId) {
    synchronized (this.f584mH) {
            ...
            new Consumer() { // from class:
              ...
              public final void accept(Object obj) {
                ((IAccessibilityInputMethodSessionInvoker) obj)
                    .invalidateInput(EditorInfo.this, accessibilityInputConnection, sessionId);
              }
            });
        return true;
      }
  ...
  */
      ...
      try {
        ...
        if (z5) {
          Log.m100v(
              TAG,
              "Starting input: view="
                  + InputMethodDebug.dumpViewInfo(view3)
                  + " reason="
        ...
        synchronized (handlerC3829H2) {
          ...
          if (servedView == view3) {
            ...
            if (this.mServedConnecting) {
              int startInputFlags3 =
                  this.mCurrentEditorInfo == null ? startInputFlags2 | 4 : startInputFlags2;
              try {
                ...
                if (ic != null) {
                  ...
                  RemoteInputConnectionImpl servedInputConnection3 =
                ...
                if (z) {
                  Log.m100v(
                      ...
                      "START INPUT: view="
                          ...
                          + editorInfo
                          + " startInputFlags="
                          + InputMethodDebug.startInputFlagsToString(startInputFlags3));
                }
              } catch (Throwable th5) {
                th = th5;
                handlerC3829H = handlerC3829H2;
              ...
              if (OPTIMIZE_NONEDITABLE_VIEWS && previouslyServedConnection == null && ic == null) {
                ...
                if (isSwitchingBetweenEquivalentNonEditableViews(
                    this.mPreviousViewFocusParameters,
                    startInputFlags3,
                    startInputReason,
                    softInputMode2,
                    windowFlags2)) {
                  ...
                  if (canSkip) {
                    int targetUserId =
                        editorInfo.targetInputMethodUser != null
                            ? editorInfo.targetInputMethodUser.getIdentifier()
                            : UserHandle.myUserId();
                    Trace.traceBegin(32L, "IMM.startInputOrWindowGainedFocus");
                    Log.m98i(
                        TAG,
                    ...
                    try {
                      InputBindResult res =
                          IInputMethodManagerGlobalInvoker.startInputOrWindowGainedFocus(
                              ...
                              windowFlags2,
                              editorInfo,
                              servedInputConnection2,
                              servedInputConnection2 == null
                                  ? null
                                  : servedInputConnection2.asIRemoteAccessibilityInputConnection(),
                        ...
                        try {
                          if (res == null) {
                            try {
                              Log.wtf(
                                  TAG,
                                  "startInputOrWindowGainedFocus must not return null."
                                      + " startInputReason="
                                      + InputMethodDebug.startInputReasonToString(startInputReason)
                                      + " editorInfo="
                                      + editorInfo
                            ...
                            try {
                              this.mVirtualDisplayToScreenMatrix =
                                  res.getVirtualDisplayToScreenMatrix();
                              if (res.f684id != null) {
                                ...
                                if (res.accessibilitySessions != null) {
                                  for (int i2 = 0; i2 < res.accessibilitySessions.size(); i2++) {
                                    IAccessibilityInputMethodSessionInvoker wrapper =
                                        IAccessibilityInputMethodSessionInvoker.createOrNull(
                                            res.accessibilitySessions.valueAt(i2));
                                    if (wrapper != null) {
                                      this.mAccessibilityInputMethodSession.append(
                                          res.accessibilitySessions.keyAt(i2), wrapper);
                                    }
                                  }
                                }
                              ...
                              switch (res.result) {
                                case 12:
                                  if (DEBUG_SEP) {
                                    Log.m100v(
                                        TAG,
                                        "startInputInner: not ime target window so set served view"
                                            + " : "
                                            + this.mServedView
                                            + " to null");
                                  }
                              ...
                              if (this.mCompletions != null && isImeSessionAvailableLocked()) {
                                this.mCurBindState.mImeSession.displayCompletions(
                                    this.mCompletions);
                              }
                              ...
                              if (ic != null
                                ...
                                if (DEBUG_SEP) {
                                  ...
                                  Log.m100v(
                                      TAG,
                                      "Calling View.onInputConnectionOpened: view= "
                                          + view
                                          + ", ic="
                                          + ic
                                          + ", editorInfo="
                                          ...
                                          + ", imeOptions="
                                          + Integer.toHexString(editorInfo.imeOptions)
                                          + ", internalImeOptions="
                                          + editorInfo.internalImeOptions);
                                } else {
                                  view = view3;
                                }
            ...
            try {
              Log.m100v(
                  ...
                  "Starting input: finished by someone else. view="
                      + InputMethodDebug.dumpViewInfo(view2)
                      + " servedView="
                      + InputMethodDebug.dumpViewInfo(servedView2)
                      + " mServedConnecting="
                      + this.mServedConnecting);
          ...
          if (remoteInputConnectionImpl != null && startInputReason == 6) {
            reportInputConnectionOpened(
                ...
                this.mCurrentEditorInfo,
                this.mServedInputConnectionHandler,
                view2);
          }
          return z4;
        }
  ...
  private boolean isSwitchingBetweenEquivalentNonEditableViews(
    ...
    return (startInputFlags & 8) == 0
        ...
        && previousViewFocusParameters.sameAs(
            this.mCurrentEditorInfo, startInputFlags, startInputReason, softInputMode, windowFlags);
  }
  ...
  public boolean checkFocusInternalLocked(boolean forceNewFocus, ViewRootImpl viewRootImpl) {
    ...
    if (DEBUG) {
      StringBuilder append =
          new StringBuilder()
              .append("checkFocus: view=")
              .append(this.mServedView)
              .append(" next=")
              .append(this.mNextServedView)
              .append(" force=")
              .append(forceNewFocus)
              .append(" package=");
      View view = this.mServedView;
      Log.m100v(
          TAG,
          append.append(view != null ? view.getContext().getPackageName() : "<none>").toString());
    }
  ...
  public void onViewFocusChangedInternal(View view, boolean hasFocus) {
      ...
      if (DEBUG_SEP) {
        Log.m98i(
            ...
            "onViewFocusChangedInternal return, view is "
                + (view == null ? SemCapabilities.FEATURE_TAG_NULL : "detached temporarily"));
        return;
      }
      return;
    }
    ...
    synchronized (this.f584mH) {
      ...
      if (DEBUG_SEP) {
        Log.m98i(
            TAG, "onViewFocusChangedInternal return, view=" + InputMethodDebug.dumpViewInfo(view));
      }
    }
  }
  ...
  void closeCurrentInput() {
    ImeTracker.Token statsToken =
        ImeTracker.forLogging().onRequestHide(null, Process.myUid(), 2, 4);
    ImeTracker.forLatency()
        .onRequestHide(statsToken, 2, 4, new InsetsController$$ExternalSyntheticLambda2());
    synchronized (this.f584mH) {
      ViewRootImpl viewRootImpl = this.mCurRootView;
      if (viewRootImpl != null && viewRootImpl.getView() != null) {
        ImeTracker.forLogging().onProgress(statsToken, 1);
        Log.m98i(
            TAG_LIFE_CYCLE, "closeCurrentInput: IInputMethodManagerGlobalInvoker.hideSoftInput");
        try {
          IInputMethodManagerGlobalInvoker.hideSoftInput(
              this.mClient, this.mCurRootView.getView().getWindowToken(), statsToken, 2, null, 4);
        } catch (NullPointerException e) {
          ViewRootImpl viewRootImpl2 = this.mCurRootView;
          if (viewRootImpl2 == null || viewRootImpl2.getView() == null) {
            Log.m102w(
                TAG, "NullPointerException: No current root view, ignoring closeCurrentInput()");
          }
          e.printStackTrace();
        }
        return;
  ...
  public void notifyImeHidden(IBinder windowToken, ImeTracker.Token statsToken) {
    ...
    ImeTracker.forLatency()
        .onRequestHide(statsToken, 2, 28, new InsetsController$$ExternalSyntheticLambda2());
    ImeTracing.getInstance().triggerClientDump("InputMethodManager#notifyImeHidden", this, null);
    synchronized (this.f584mH) {
      if (isImeSessionAvailableLocked()
          && (viewRootImpl = this.mCurRootView) != null
          && viewRootImpl.getWindowToken() == windowToken) {
        ImeTracker.forLogging().onProgress(statsToken, 1);
        IInputMethodManagerGlobalInvoker.hideSoftInput(
      ...
      try {
        try {
          if (!hasServedByInputMethodLocked(view) || this.mCurrentEditorInfo == null) {
            ...
            RemoteInputConnectionImpl remoteInputConnectionImpl = this.mServedInputConnection;
            if (remoteInputConnectionImpl == null
                || !remoteInputConnectionImpl.hasPendingInvalidation()) {
              try {
                ...
                forAccessibilitySessionsLocked(
                    new Consumer() { // from class:
                      ...
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        InputMethodManager.this.lambda$updateSelection$3(
                            selStart,
                            selEnd,
                            candidatesStart,
                            candidatesEnd,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$updateSelection$3(
      int selStart,
      int selEnd,
      int candidatesStart,
      int candidatesEnd,
    ...
    wrapper.updateSelection(
        this.mCursorSelStart, this.mCursorSelEnd, selStart, selEnd, candidatesStart, candidatesEnd);
  }
      ...
      if (hasServedByInputMethodLocked(view)
        ...
        boolean isImmediate =
            remoteInputConnectionImpl != null
                && remoteInputConnectionImpl.resetHasPendingImmediateCursorAnchorInfoUpdate();
        ...
        if (this.mVirtualDisplayToScreenMatrix != null) {
          this.mCurBindState.mImeSession.updateCursorAnchorInfo(
              CursorAnchorInfo.createForAdditionalParentMatrix(
                  cursorAnchorInfo, this.mVirtualDisplayToScreenMatrix));
        } else {
  ...
  public void setInputMethod(IBinder token, String id) {
    ...
    if (Process.myUid() == 1000) {
      Log.m102w(
          TAG,
          "System process should not be calling setInputMethod() because almost always it is a bug"
              + " under multi-user / multi-profile environment. Consider interacting with"
              + " InputMethodManagerService directly via LocalServices.");
      return;
    }
    Context fallbackContext = ActivityThread.currentApplication();
    if (fallbackContext == null
        || fallbackContext.checkSelfPermission(Manifest.permission.WRITE_SECURE_SETTINGS) != 0) {
      return;
    }
    ...
    if (found || SemInputMethodManagerUtils.METHOD_ID_BIXBY_DICTATION.equals(id)) {
      Log.m102w(
          TAG,
          "The undocumented behavior that setInputMethod() accepts null token when the caller has"
              + " WRITE_SECURE_SETTINGS is deprecated. This behavior may be completely removed in a"
              + " future version.  Update secure settings directly instead.");
  ...
  public void setInputMethodAndSubtype(IBinder token, String id, InputMethodSubtype subtype) {
    if (token == null) {
      Log.m96e(
          TAG, "setInputMethodAndSubtype() does not accept null token on Android Q and later.");
    } else {
  ...
  public int dispatchInputEvent(
    ...
    synchronized (this.f584mH) {
      if (isImeSessionAvailableLocked()) {
        ...
        PendingEvent p =
            obtainPendingEventLocked(event, token, this.mCurBindState.mImeId, callback, handler);
  ...
  private int sendInputEventOnMainLooperLocked(PendingEvent p) {
    ...
    if (inputChannel != null) {
      ...
      if (sPreventImeStartupUnlessTextEditor) {
        ...
        Log.m102w(
            TAG, "Unable to send input event to IME: " + getImeIdLocked() + " dropping: " + event);
      }
    }
    return 0;
  }
  ...
  public void finishedInputEvent(int seq, boolean handled, boolean timeout) {
    synchronized (this.f584mH) {
      ...
      if (timeout) {
        Log.m102w(
            TAG,
            "Timeout waiting for IME to handle input event after 2500 ms: " + p.mInputMethodId);
      } else {
  ...
  public boolean setCurrentInputMethodSubtype(InputMethodSubtype subtype) {
    ...
    if (Process.myUid() == 1000) {
      Log.m102w(
          TAG,
          "System process should not call setCurrentInputMethodSubtype() because almost always it"
              + " is a bug under multi-user / multi-profile environment. Consider directly"
              + " interacting with InputMethodManagerService via LocalServices.");
      return false;
    }
    if (subtype == null
  ...
  public void notifyUserAction() {
    Log.m102w(
        TAG,
        "notifyUserAction() is a hidden method, which is now just a stub method that does nothing. "
            + " Leave comments in b.android.com/114740982 if your  application still depends on the"
            + " previous behavior of this method.");
  }
        ...
        Comparator.comparingInt(
            new ToIntFunction() { // from class:
              ...
              public final int applyAsInt(Object obj) {
                return InputMethodManager.lambda$getShortcutInputMethodsAndSubtypes$4(
                    (InputMethodInfo) obj);
              }
            }));
  ...
  static /* synthetic */ int lambda$getShortcutInputMethodsAndSubtypes$4(
  ...
  public void reportVirtualDisplayGeometry(int childDisplayId, Matrix matrix) {
    ...
    IInputMethodManagerGlobalInvoker.reportVirtualDisplayGeometryAsync(
        this.mClient, childDisplayId, matrixValues);
  }
  ...
  public boolean minimizeSoftInput(IBinder windowToken, int height) {
    ...
    synchronized (this.f584mH) {
      ...
      Log.m98i(
          TAG,
          "minimizeSoftInput: cancel windowToken="
              + (windowToken == null ? SemCapabilities.FEATURE_TAG_NULL : windowToken)
              + " servedView="
              + (servedView == null
                  ? SemCapabilities.FEATURE_TAG_NULL
  ...
  public boolean forceHideSoftInput(ResultReceiver resultReceiver) {
    ...
    ImeTracker.Token statsToken =
        ImeTracker.forLogging().onRequestHide(null, Process.myUid(), 2, 42);
    ImeTracker.forLatency()
        .onRequestHide(statsToken, 2, 42, new InsetsController$$ExternalSyntheticLambda2());
    ...
    synchronized (this.f584mH) {
      ...
      if (servedView == null) {
        return IInputMethodManagerGlobalInvoker.hideSoftInput(
            this.mClient, null, statsToken, 0, resultReceiver, 42);
      }
      return IInputMethodManagerGlobalInvoker.hideSoftInput(
          this.mClient, servedView.getWindowToken(), statsToken, 0, resultReceiver, 42);
    }
  }
  ...
  private void updateIMESwitchEnable() {
    ...
    if (servedView != null && servedView.getContext() != null) {
      boolean switchDisable =
          servedView.getContext().getPackageName().contains("com.samsung.android.honeyboard");
