...
public interface ImeTracker {
    ...
    public static final ImeTracker LOGGER = new ImeTrackerC38081();
    ...
    class ImeTrackerC38081 implements ImeTracker {
        ...
        ImeTrackerC38081() {
            SystemProperties.addChangeCallback(new Runnable() { // from class: android.view.inputmethod.ImeTracker$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ImeTracker.ImeTrackerC38081.this.lambda$new$0();
                }
            });
        }
        ...
        public Token onRequestShow(String component, int uid, int origin, int reason) {
            ...
            Log.m98i(ImeTracker.TAG, token.mTag + ": onRequestShow at " + Debug.originToString(origin) + " reason " + InputMethodDebug.softInputDisplayReasonToString(reason));
            return token;
        }
        ...
        public Token onRequestHide(String component, int uid, int origin, int reason) {
            ...
            Log.m98i(ImeTracker.TAG, token.mTag + ": onRequestHide at " + Debug.originToString(origin) + " reason " + InputMethodDebug.softInputDisplayReasonToString(reason));
            return token;
        }
        ...
        public void onProgress(Token token, int phase) {
            ...
            if (this.mLogProgress) {
                Log.m98i(ImeTracker.TAG, token.mTag + ": onProgress at " + Debug.phaseToString(phase));
            }
        }
        ...
        public void onFailed(Token token, int phase) {
            ...
            Log.m98i(ImeTracker.TAG, token.mTag + ": onFailed at " + Debug.phaseToString(phase));
        }
        ...
        public void onTodo(Token token, int phase) {
            ...
            Log.m98i(ImeTracker.TAG, token.mTag + ": onTodo at " + Debug.phaseToString(phase));
        }
        ...
        public void onCancelled(Token token, int phase) {
            ...
            Log.m98i(ImeTracker.TAG, token.mTag + ": onCancelled at " + Debug.phaseToString(phase));
        }
        ...
        public void onShown(Token token) {
            ...
            Log.m98i(ImeTracker.TAG, token.mTag + ": onShown");
        }
        ...
        public void onHidden(Token token) {
            ...
            Log.m98i(ImeTracker.TAG, token.mTag + ": onHidden");
        }
