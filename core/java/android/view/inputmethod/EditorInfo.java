...
public class EditorInfo implements InputType, Parcelable {
  public static final Parcelable.Creator<EditorInfo> CREATOR =
      new Parcelable.Creator<EditorInfo>() { // from class: android.view.inputmethod.EditorInfo.1
        ...
        public EditorInfo createFromParcel(Parcel source) {
          ...
          res.autofillId =
              (AutofillId)
                  source.readParcelable(AutofillId.class.getClassLoader(), AutofillId.class);
  ...
  private void trimLongSurroundingText(
    ...
    int newAfterCursorLength =
        Math.min(subTextAfterCursorLength, maxLengthMinusSelection - possibleMaxBeforeCursorLength);
    ...
    if (newSelLength != sourceSelLength) {
      CharSequence beforeCursor2 =
          subText.subSequence(newBeforeCursorHead, newBeforeCursorHead + newBeforeCursorLength);
    ...
    this.mInitialSurroundingText =
        new SurroundingText(beforeCursor, newSelHead, newSelHead + newSelLength, newOffset);
  }
  ...
  public CharSequence getInitialTextBeforeCursor(int length, int flags) {
    ...
    int selStart =
        Math.min(
            surroundingText.getSelectionStart(), this.mInitialSurroundingText.getSelectionEnd());
  ...
  public void dump(Printer pw, String prefix, boolean dumpExtras) {
    ...
    pw.println(
        prefix + "actionLabel=" + ((Object) this.actionLabel) + " actionId=" + this.actionId);
    pw.println(
        prefix
            + "initialSelStart="
  ...
  public boolean kindofEquals(EditorInfo that) {
    ...
    if (surroundingText != surroundingText2
        && (surroundingText == null || !surroundingText.isEqualTo(surroundingText2))) {
      return false;
    }
    return true;
  }
