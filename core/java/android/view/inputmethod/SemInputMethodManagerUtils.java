...
public class SemInputMethodManagerUtils {
  public static final String METHOD_ID_BIXBY =
      "com.samsung.android.bixby.voiceinput/com.samsung.android.svoiceime.BixbyDictVoiceReco";
  public static final String METHOD_ID_BIXBY_DICTATION =
      "com.samsung.android.bixby.service/.dictation.DictationInputMethodService";
  public static final String METHOD_ID_BIXBY_OLD =
      "com.samsung.android.svoiceime/.BixbyDictVoiceReco";
  public static final String METHOD_ID_CUSTOMIZED_SOGOU =
      "com.sohu.inputmethod.sogou.samsung/.SogouIME";
  public static final String METHOD_ID_GOOGLE_VOICE_TTS =
      "com.google.android.tts/com.google.android.apps.speech.tts.googletts.settings.asr.voiceime.VoiceInputMethodService";
  public static final String METHOD_ID_HONEYBOARD =
      "com.samsung.android.honeyboard/.service.HoneyBoardService";
  public static final String METHOD_ID_SWIFTKEY =
  ...
  private static final String PROP_ENABLE_DEBUG_CALL_STACK =
      "persist.sys.ime.enable_debug_call_stack";
  static final boolean DEBUG_CALL_STACK =
      SystemProperties.getBoolean(PROP_ENABLE_DEBUG_CALL_STACK, false);

  static void putInfoInExtra(View view, EditorInfo editorInfo) {
    int maxLength;
    if (InputMethodManager.DEBUG_SEP) {
      Log.m100v(TAG, "Starting input: editorInfo=" + editorInfo);
    }
    ...
    if (view.getDisplay() != null) {
      ...
      Log.m94d(TAG, "startInputInner - Id : " + displayId);
      ...
      if (view.getContext().getDisplay() != null) {
        ...
        Log.m94d(TAG, "startInputInner - Id from getContext : " + displayId2);
        editorInfo.extras.putInt("displayId", displayId2);
        return;
      }
      Log.m94d(TAG, "getDisplay is null");
    }
  }
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (filter instanceof InputFilter.LengthFilter) {
        try {
          ...
          Log.m100v(TAG, "getMaxLengthForEditText LengthFilter = " + e);
        }
      } else if (filter != null) {
        try {
          ...
          Log.m100v(TAG, "getMaxLengthForEditText InputFilter = " + e2);
        }
      } else {
        continue;
      }
