...
public class SemInputMethodManagerUtils {
    ...
    public static final String CLASS_NAME_TOOLKIT_HONEYBOARD =
    ...
    public static final String METHOD_ID_TOOLKIT_HONEYBOARD =
            "com.samsung.android.honeyboard/com.samsung.android.writingtoolkit.service.FakeHoneyBoardService";
    ...
    static void putInfoInExtra(View view, EditorInfo editorInfo, String caller) {
        ...
        if ((view instanceof EditText)
                && (maxLength = getMaxLengthForEditText((EditText) view)) >= 0) {
