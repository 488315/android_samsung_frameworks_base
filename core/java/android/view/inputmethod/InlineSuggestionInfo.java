...
public final class InlineSuggestionInfo implements Parcelable {
  public static final Parcelable.Creator<InlineSuggestionInfo> CREATOR =
      new Parcelable.Creator<
          InlineSuggestionInfo>() { // from class: android.view.inputmethod.InlineSuggestionInfo.1
  ...
  public InlineSuggestionInfo(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) inlinePresentationSpec);
    this.mSource = source;
  ...
  public int hashCode() {
    ...
    return (((((((((_hash * 31) + Objects.hashCode(this.mSource)) * 31)
                                + Arrays.hashCode(this.mAutofillHints))
                            * 31)
  ...
  InlineSuggestionInfo(Parcel in) {
    ...
    InlineSuggestion tooltip =
        (flg & 32) == 0 ? null : (InlineSuggestion) in.readTypedObject(InlineSuggestion.CREATOR);
    this.mInlinePresentationSpec = inlinePresentationSpec;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) inlinePresentationSpec);
    this.mSource = source;
