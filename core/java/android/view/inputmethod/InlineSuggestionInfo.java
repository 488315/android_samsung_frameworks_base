...
public final class InlineSuggestionInfo implements Parcelable {
    public static final Parcelable.Creator<InlineSuggestionInfo> CREATOR =
            new Parcelable.Creator<
                    InlineSuggestionInfo>() { // from class:
                                              // android.view.inputmethod.InlineSuggestionInfo.1
    ...
    public static InlineSuggestionInfo newInlineSuggestionInfo(
            InlinePresentationSpec presentationSpec,
            String source,
            String[] autofillHints,
            String type,
            boolean isPinned) {
        return new InlineSuggestionInfo(
                presentationSpec, source, autofillHints, type, isPinned, null);
    }
    ...
    public static InlineSuggestionInfo newInlineSuggestionInfo(
            ...
            String type,
            boolean isPinned,
            InlineSuggestion tooltip) {
        return new InlineSuggestionInfo(
                presentationSpec, source, autofillHints, type, isPinned, tooltip);
    }
    ...
    public InlineSuggestionInfo(
        ...
        this.mSource = source;
        if (!Objects.equals(this.mSource, SOURCE_AUTOFILL)
                && !Objects.equals(this.mSource, SOURCE_PLATFORM)) {
            throw new IllegalArgumentException(
                    "source was "
                            + this.mSource
                            + " but must be one of: SOURCE_AUTOFILL("
                            + SOURCE_AUTOFILL
                            + "), SOURCE_PLATFORM("
                            + SOURCE_PLATFORM
        ...
        AnnotationValidations.validate(
                (Class<NonNull>) NonNull.class, (NonNull) null, (Object) this.mSource);
        this.mAutofillHints = autofillHints;
        this.mType = type;
        if (!Objects.equals(this.mType, TYPE_SUGGESTION)
                && !Objects.equals(this.mType, TYPE_ACTION)) {
            throw new IllegalArgumentException(
                    "type was "
                            + this.mType
                            + " but must be one of: TYPE_SUGGESTION("
                            + TYPE_SUGGESTION
                            + "), TYPE_ACTION("
                            + TYPE_ACTION
                            + NavigationBarInflaterView.KEY_CODE_END);
    ...
    public String toString() {
        return "InlineSuggestionInfo { inlinePresentationSpec = "
                + this.mInlinePresentationSpec
                + ", source = "
                + this.mSource
                + ", autofillHints = "
                + Arrays.toString(this.mAutofillHints)
                + ", type = "
                + this.mType
                + ", pinned = "
                + this.mPinned
    ...
    public boolean equals(Object o) {
        ...
        if (Objects.equals(this.mInlinePresentationSpec, that.mInlinePresentationSpec)
                && Objects.equals(this.mSource, that.mSource)
                && Arrays.equals(this.mAutofillHints, that.mAutofillHints)
                && Objects.equals(this.mType, that.mType)
                && this.mPinned == that.mPinned
                && Objects.equals(this.mTooltip, that.mTooltip)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((_hash * 31) + Objects.hashCode(this.mSource)) * 31)
                                                                + Arrays.hashCode(
                                                                        this.mAutofillHints))
                                                        * 31)
                                                + Objects.hashCode(this.mType))
                                        * 31)
                                + Boolean.hashCode(this.mPinned))
                        * 31)
                + Objects.hashCode(this.mTooltip);
    }
    ...
    InlineSuggestionInfo(Parcel in) {
        ...
        InlineSuggestion tooltip =
                (flg & 32) == 0
                        ? null
                        : (InlineSuggestion) in.readTypedObject(InlineSuggestion.CREATOR);
        this.mInlinePresentationSpec = inlinePresentationSpec;
        AnnotationValidations.validate(
                (Class<NonNull>) NonNull.class,
                (NonNull) null,
