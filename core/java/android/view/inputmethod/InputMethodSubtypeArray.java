...
public class InputMethodSubtypeArray {
  ...
  public void writeToParcel(Parcel dest) {
      ...
      synchronized (this.mLockObject) {
        ...
        if (compressedData == null && decompressedSize == 0) {
          ...
          if (compressedData == null) {
            decompressedSize = -1;
            Slog.m117i(TAG, "Failed to compress data.");
          } else {
    ...
    if (compressedData != null && decompressedSize > 0) {
      ...
      Slog.m117i(TAG, "Unexpected state. Behaving as an empty array.");
      dest.writeInt(0);
    }
  }
      ...
      synchronized (this.mLockObject) {
        ...
        if (instance == null) {
          ...
          if (decompressedData != null) {
            ...
            Slog.m115e(TAG, "Failed to decompress data. Returns null as fallback.");
  ...
  private static byte[] compress(byte[] data) {
    try {
      ...
      Slog.m116e(TAG, "Failed to compress the data.", e);
      return null;
    }
  }
  ...
  private static byte[] decompress(byte[] data, int expectedSize) {
    try {
      ...
      Slog.m116e(TAG, "Failed to decompress the data.", e);
      return null;
    }
  }
}
