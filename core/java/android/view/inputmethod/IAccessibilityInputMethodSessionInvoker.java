...
final class IAccessibilityInputMethodSessionInvoker {
  ...
  private IAccessibilityInputMethodSessionInvoker(
      IAccessibilityInputMethodSession session, Handler customHandler) {
    ...
    if (handler == null) {
      ...
      handler.post(
          new Runnable() { // from class:
                           // android.view.inputmethod.IAccessibilityInputMethodSessionInvoker$$ExternalSyntheticLambda2
    ...
    if (handler == null) {
      ...
      handler.post(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              IAccessibilityInputMethodSessionInvoker.this.lambda$updateSelection$0(
                  oldSelStart, oldSelEnd, selStart, selEnd, candidatesStart, candidatesEnd);
            }
          });
    }
  ...
  public void invalidateInput(
    ...
    if (handler == null) {
      ...
      handler.post(
          new Runnable() { // from class:
                           // android.view.inputmethod.IAccessibilityInputMethodSessionInvoker$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              IAccessibilityInputMethodSessionInvoker.this.lambda$invalidateInput$1(
