...
public final class CursorAnchorInfo implements Parcelable {
  ...
  public boolean equals(Object obj) {
    ...
    if (hashCode() != that.hashCode()
        ...
        || !areSameFloatImpl(this.mInsertionMarkerHorizontal, that.mInsertionMarkerHorizontal)
  ...
  public static final class Builder {
    ...
    public Builder setInsertionMarkerLocation(
        float horizontalPosition, float lineTop, float lineBaseline, float lineBottom, int flags) {
    ...
    public CursorAnchorInfo build() {
      if (!this.mMatrixInitialized) {
        SparseRectFArray.SparseRectFArrayBuilder sparseRectFArrayBuilder =
            this.mCharacterBoundsArrayBuilder;
        boolean hasCharacterBounds =
            (sparseRectFArrayBuilder == null || sparseRectFArrayBuilder.isEmpty()) ? false : true;
        ...
        if (hasCharacterBounds
          ...
          throw new IllegalArgumentException(
              "Coordinate transformation matrix is required when positional parameters are"
                  + " specified.");
        }
      }
