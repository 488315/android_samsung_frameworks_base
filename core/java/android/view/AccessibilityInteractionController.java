    ...
    */
    public void findAccessibilityNodeInfoByAccessibilityIdUiThread(Message message) {
        ...
        if (this.mViewRootImpl.mView == null || this.mViewRootImpl.mAttachInfo == null) {
            IAccessibilityInteractionConnectionCallback callback2 = (IAccessibilityInteractionConnectionCallback) ((SomeArgs) message.obj).arg1;
            try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (!interruptPrefetch) {
                                    ...
                                    this.mPrefetcher.prefetchAccessibilityNodeInfos(requestedView, requestedNode2 == null ? null : new AccessibilityNodeInfo(requestedNode2), infos);
                                    resetAccessibilityFetchFlags();
                                }
                                AccessibilityNodeInfo requestedNode3 = requestedNode2;
                                if (interruptPrefetch) {
                                    updateInfosForViewportAndReturnFindNodeResult(infos, callback3, interactionId, spec2, matrixValues2, interactiveRegion2);
                                    SatisfiedFindAccessibilityNodeByAccessibilityIdRequest satisfiedRequest = getSatisfiedRequestInPrefetch(requestedNode3 == null ? null : requestedNode3, infos, flags);
                                ...
                                updateInfoForViewportAndReturnFindNodeResult(requestedNode3 == null ? null : new AccessibilityNodeInfo(requestedNode3), callback3, interactionId, spec2, matrixValues4, interactiveRegion2);
                                this.mPrefetcher.prefetchAccessibilityNodeInfos(requestedView, requestedNode3 == null ? null : new AccessibilityNodeInfo(requestedNode3), infos);
                                resetAccessibilityFetchFlags();
                                updateInfosForViewPort(infos, spec2, matrixValues4, interactiveRegion2);
                                SatisfiedFindAccessibilityNodeByAccessibilityIdRequest satisfiedRequest2 = getSatisfiedRequestInPrefetch(requestedNode3 == null ? null : requestedNode3, infos, flags);
                                ...
                                if (interruptPrefetch) {
                                    updateInfoForViewportAndReturnFindNodeResult(requestedNode == null ? null : new AccessibilityNodeInfo(requestedNode), callback, interactionId, spec, matrixValues, interactiveRegion);
                                    throw th;
                                }
                                updateInfosForViewportAndReturnFindNodeResult(infos, callback, interactionId, spec, matrixValues, interactiveRegion);
                                SatisfiedFindAccessibilityNodeByAccessibilityIdRequest satisfiedRequest3 = getSatisfiedRequestInPrefetch(requestedNode == null ? null : requestedNode, infos, flags);
