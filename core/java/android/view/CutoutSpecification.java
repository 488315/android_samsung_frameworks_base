...
public class CutoutSpecification {
    ...
    private Insets scaleInsets(Insets insets, float ratio) {
        return Insets.m14of((int) ((insets.left * ratio) + 0.5f), (int) ((insets.top * ratio) + 0.5f), (int) ((insets.right * ratio) + 0.5f), (int) ((insets.bottom * ratio) + 0.5f));
    }
    ...
    public static class Parser {
        ...
        public CutoutSpecification parse(String originalSpec) {
            ...
            this.mInsets = Insets.m14of(this.mSafeInsetLeft, this.mSafeInsetTop, this.mSafeInsetRight, this.mSafeInsetBottom);
