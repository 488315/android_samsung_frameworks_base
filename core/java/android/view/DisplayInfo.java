...
public final class DisplayInfo implements Parcelable {
  ...
  public boolean equals(DisplayInfo other) {
    return other != null
        ...
        && (!CoreRune.FW_VRR_REFRESH_RATE_MODE || this.refreshRateMode == other.refreshRateMode)
        ...
        && this.thermalRefreshRateThrottling.contentEquals(other.thermalRefreshRateThrottling)
        && Objects.equals(
  ...
  public void readFromParcel(Parcel source) {
    ...
    this.hdrCapabilities =
        (Display.HdrCapabilities) source.readParcelable(null, Display.HdrCapabilities.class);
