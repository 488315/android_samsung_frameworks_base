...
public final class DataShareRequest implements Parcelable {
  public static final Parcelable.Creator<DataShareRequest> CREATOR =
      new Parcelable.Creator<
          DataShareRequest>() { // from class: android.view.contentcapture.DataShareRequest.1
  ...
  public String toString() {
    return "DataShareRequest { packageName = "
        + this.mPackageName
        + ", locusId = "
        + this.mLocusId
        + ", mimeType = "
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(this.mPackageName, that.mPackageName)
        && Objects.equals(this.mLocusId, that.mLocusId)
        && Objects.equals(this.mMimeType, that.mMimeType)) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    return (((_hash * 31) + Objects.hashCode(this.mLocusId)) * 31)
