...
public final class ContentCaptureEvent implements Parcelable {
    ...
    public void mergeEvent(ContentCaptureEvent event) {
        ...
        if (this.mType != eventType) {
            Log.m96e(TAG, "mergeEvent(" + getTypeAsString(eventType) + ") cannot be merged with different eventType=" + getTypeAsString(this.mType));
            return;
        }
        if (eventType == 2) {
        ...
        Log.m96e(TAG, "mergeEvent(" + getTypeAsString(eventType) + ") does not support this event type.");
    }
