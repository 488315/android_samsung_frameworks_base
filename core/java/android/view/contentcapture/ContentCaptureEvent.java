...
public final class ContentCaptureEvent implements Parcelable {
  ...
  public static final Parcelable.Creator<ContentCaptureEvent> CREATOR =
      new Parcelable.Creator<
          ContentCaptureEvent>() { // from class: android.view.contentcapture.ContentCaptureEvent.1
        ...
        public ContentCaptureEvent createFromParcel(Parcel parcel) {
          ...
          if (type == -1 || type == 6) {
            event.setClientContext(
                (ContentCaptureContext) parcel.readParcelable(null, ContentCaptureContext.class));
          }
          if (type == 9) {
  ...
  public ContentCaptureEvent addAutofillId(AutofillId id) {
    ...
    if (this.mIds == null) {
      ...
      if (autofillId == null) {
        Log.m102w(TAG, "addAutofillId(" + id + ") called without an initial id");
      } else {
  ...
  public void restoreComposingSpan() {
    ...
    if (charSequence instanceof Spannable) {
      ...
      Log.m102w(TAG, "Text is not a Spannable.");
    }
  }
  ...
  public void restoreSelectionSpans() {
    ...
    Log.m102w(TAG, "Text is not a SpannableString.");
  }
  ...
  public void mergeEvent(ContentCaptureEvent event) {
    ...
    if (eventType == 2) {
      ...
      if (ids != null) {
        if (id != null) {
          Log.m102w(TAG, "got TYPE_VIEW_DISAPPEARED event with both id and ids: " + event);
        }
      ...
      throw new IllegalArgumentException(
          "mergeEvent(): got TYPE_VIEW_DISAPPEARED event with neither id or ids: " + event);
    }
    if (eventType == 3) {
    ...
    Log.m96e(
        TAG, "mergeEvent(" + getTypeAsString(eventType) + ") does not support this event type.");
  }
  ...
  public String toString() {
    ...
    if (viewNode != null) {
      ...
      if (this.mNode.getText() != null) {
        string
            .append(", text=")
            .append((CharSequence) ContentCaptureHelper.getSanitizedString(this.mNode.getText()));
      }
    }
    if (this.mText != null) {
      string
