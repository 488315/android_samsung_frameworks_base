...
public final class ViewNode extends AssistStructure.ViewNode {
  ...
  private ViewNode(long nodeFlags, Parcel parcel) {
    ...
    if ((256 & nodeFlags) != 0) {
      this.f582mX = parcel.readInt();
      this.f583mY = parcel.readInt();
      this.mWidth = parcel.readInt();
      this.mHeight = parcel.readInt();
    } else {
      int val = parcel.readInt();
      this.f582mX = val & 32767;
      this.f583mY = (val >> 16) & 32767;
  ...
  */
  private void writeSelfToParcel(Parcel parcel, int parcelFlags) {
    ...
    if ((this.f582mX & (-32768)) == 0 && (this.f583mY & (-32768)) == 0) {}
    nodeFlags |= 256;
    ...
    if ((nodeFlags & 256) == 0) {
      parcel.writeInt((this.f583mY << 16) | this.f582mX);
      parcel.writeInt((this.mHeight << 16) | this.mWidth);
    } else {
      parcel.writeInt(this.f582mX);
      parcel.writeInt(this.f583mY);
  ...
  public static final class ViewStructureImpl extends ViewStructure {
    ...
    public void setDimens(int left, int top, int scrollX, int scrollY, int width, int height) {
      this.mNode.f582mX = left;
      this.mNode.f583mY = top;
    ...
    public void setTransformation(Matrix matrix) {
      Log.m102w(ViewNode.TAG, "setTransformation() is not supported");
    }

    @Override // android.view.ViewStructure
    public void setElevation(float elevation) {
      Log.m102w(ViewNode.TAG, "setElevation() is not supported");
    }

    @Override // android.view.ViewStructure
    public void setAlpha(float alpha) {
      Log.m102w(ViewNode.TAG, "setAlpha() is not supported");
    }
    ...
    public void setChildCount(int num) {
      Log.m102w(ViewNode.TAG, "setChildCount() is not supported");
    }

    @Override // android.view.ViewStructure
    public int addChildCount(int num) {
      Log.m102w(ViewNode.TAG, "addChildCount() is not supported");
      return 0;
    }

    @Override // android.view.ViewStructure
    public int getChildCount() {
      Log.m102w(ViewNode.TAG, "getChildCount() is not supported");
      return 0;
    }

    @Override // android.view.ViewStructure
    public ViewStructure newChild(int index) {
      Log.m102w(ViewNode.TAG, "newChild() is not supported");
      return null;
    }

    @Override // android.view.ViewStructure
    public ViewStructure asyncNewChild(int index) {
      Log.m102w(ViewNode.TAG, "asyncNewChild() is not supported");
      return null;
    }
    ...
    public void setDataIsSensitive(boolean sensitive) {
      Log.m102w(ViewNode.TAG, "setDataIsSensitive() is not supported");
    }

    @Override // android.view.ViewStructure
    public void asyncCommit() {
      Log.m102w(ViewNode.TAG, "asyncCommit() is not supported");
    }

    @Override // android.view.ViewStructure
    public Rect getTempRect() {
      Log.m102w(ViewNode.TAG, "getTempRect() is not supported");
      return null;
    }

    @Override // android.view.ViewStructure
    public void setWebDomain(String domain) {
      Log.m102w(ViewNode.TAG, "setWebDomain() is not supported");
    }
    ...
    public ViewStructure.HtmlInfo.Builder newHtmlInfoBuilder(String tagName) {
      Log.m102w(ViewNode.TAG, "newHtmlInfoBuilder() is not supported");
      return null;
    }

    @Override // android.view.ViewStructure
    public void setHtmlInfo(ViewStructure.HtmlInfo htmlInfo) {
      Log.m102w(ViewNode.TAG, "setHtmlInfo() is not supported");
    }
