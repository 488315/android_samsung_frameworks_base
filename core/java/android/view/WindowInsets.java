...
public final class WindowInsets {
  ...
  public static void assignCompatInsets(Insets[] typeInsetsMap, Rect insets) {
    typeInsetsMap[Type.indexOf(1)] = Insets.m14of(0, insets.top, 0, 0);
    typeInsetsMap[Type.indexOf(2)] = Insets.m14of(insets.left, 0, insets.right, insets.bottom);
  }
  ...
  public WindowInsets replaceSystemWindowInsets(int left, int top, int right, int bottom) {
    ...
    return new Builder(this).setSystemWindowInsets(Insets.m14of(left, top, right, bottom)).build();
  }
  ...
  static Insets insetInsets(Insets insets, int left, int top, int right, int bottom) {
    ...
    return Insets.m14of(newLeft, newTop, newRight, newBottom);
  }
  ...
  public static final class Builder {
    ...
    public Builder setDisplayCutout(DisplayCutout displayCutout) {
      DisplayCutout displayCutout2 =
          displayCutout != null ? displayCutout : DisplayCutout.NO_CUTOUT;
      this.mDisplayCutout = displayCutout2;
      if (!displayCutout2.isEmpty()) {
        Insets safeInsets = Insets.m15of(this.mDisplayCutout.getSafeInsets());
