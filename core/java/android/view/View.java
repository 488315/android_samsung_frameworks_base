...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    @ViewDebug.ExportedProperty(category = "drawing", mapping = {@ViewDebug.IntToString(from = 0, m158to = KeyProperties.DIGEST_NONE), @ViewDebug.IntToString(from = 1, m158to = "SOFTWARE"), @ViewDebug.IntToString(from = 2, m158to = "HARDWARE")})
    int mLayerType;
    ...
    /* renamed from: X */
    public static final Property<View, Float> f557X = new FloatProperty<View>("x") { // from class: android.view.View.7
        @Override // android.util.FloatProperty
        public void setValue(View object, float value) {
            object.setX(value);
        }
    ...
    /* renamed from: Y */
    public static final Property<View, Float> f558Y = new FloatProperty<View>("y") { // from class: android.view.View.8
        @Override // android.util.FloatProperty
        public void setValue(View object, float value) {
            object.setY(value);
        }
    ...
    /* renamed from: Z */
    public static final Property<View, Float> f559Z = new FloatProperty<View>("z") { // from class: android.view.View.9
        @Override // android.util.FloatProperty
        public void setValue(View object, float value) {
            object.setZ(value);
        }
    ...
    public View(Context context) {
        ...
        if (!sCompatibilityDone && context != null) {
            ...
            sUseDefaultFocusHighlight = context.getResources().getBoolean(C4337R.bool.config_useDefaultFocusHighlight);
    ...
    */
    public View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.View, defStyleAttr, defStyleRes);
        retrieveExplicitStyle(context.getTheme(), attrs);
        saveAttributeDataForStyleable(context, C4337R.styleable.View, attrs, a, defStyleAttr, defStyleRes);
    ...
    private void initializeScrollIndicatorsInternal() {
        if (this.mScrollIndicatorDrawable == null) {
            this.mScrollIndicatorDrawable = this.mContext.getDrawable(C4337R.drawable.scroll_indicator_material);
        }
    }
    ...
    public void setOnClickListener(OnClickListener l) {
        if (l != null) {
            ...
            if (con != null && con.getTheme() != null) {
                this.mIsDeviceDefault = con.getTheme().resolveAttribute(C4337R.attr.parentIsDeviceDefault, outValue, true) && outValue.data != 0;
            }
        }
        if (!isClickable()) {
            setClickable(true);
    ...
    @ViewDebug.ExportedProperty(mapping = {@ViewDebug.IntToString(from = 0, m158to = "auto"), @ViewDebug.IntToString(from = 1, m158to = "yes"), @ViewDebug.IntToString(from = 2, m158to = "no"), @ViewDebug.IntToString(from = 4, m158to = "yesExcludeDescendants"), @ViewDebug.IntToString(from = 8, m158to = "noExcludeDescendants")})
    ...
    public final boolean isImportantForAutofill() {
        for (ViewParent parent = this.mParent; parent instanceof View; parent = parent.getParent()) {
            ...
            if (parentImportance == 8 || parentImportance == 4) {
                if (Log.isLoggable(AUTOFILL_LOG_TAG, 2)) {
                    Log.m100v(AUTOFILL_LOG_TAG, "View (" + this + ") is not important for autofill because parent " + parent + "'s importance is " + parentImportance);
                }
                return false;
            }
        }
        ...
        if (importance == 8 || importance == 2) {
            if (Log.isLoggable(AUTOFILL_LOG_TAG, 2)) {
                Log.m100v(AUTOFILL_LOG_TAG, "View (" + this + ") is not important for autofill because its importance is " + importance);
            }
            return false;
        }
        if (importance != 0) {
            Log.m102w(AUTOFILL_LOG_TAG, "invalid autofill importance (" + importance + " on view " + this);
            return false;
        }
        int id = this.mID;
        if (id != -1 && !isViewIdGenerated(id)) {
    ...
    private boolean calculateIsImportantForContentCapture() {
        for (ViewParent parent = this.mParent; parent instanceof View; parent = parent.getParent()) {
            ...
            if (parentImportance == 8 || parentImportance == 4) {
                if (Log.isLoggable(CONTENT_CAPTURE_LOG_TAG, 2)) {
                    Log.m100v(CONTENT_CAPTURE_LOG_TAG, "View (" + this + ") is not important for content capture because parent " + parent + "'s importance is " + parentImportance);
                }
                return false;
            }
        }
        ...
        if (importance == 8 || importance == 2) {
            if (Log.isLoggable(CONTENT_CAPTURE_LOG_TAG, 2)) {
                Log.m100v(CONTENT_CAPTURE_LOG_TAG, "View (" + this + ") is not important for content capture because its importance is " + importance);
            }
            return false;
        }
        if (importance != 0) {
            Log.m102w(CONTENT_CAPTURE_LOG_TAG, "invalid content capture importance (" + importance + " on view " + this);
            return false;
        }
    ...
    public void dispatchInitialProvideContentCaptureStructure() {
        AttachInfo ai = this.mAttachInfo;
        if (ai == null) {
            Log.m102w(CONTENT_CAPTURE_LOG_TAG, "dispatchProvideContentCaptureStructure(): no AttachInfo for " + this);
            return;
        }
        ContentCaptureManager ccm = ai.mContentCaptureManager;
        if (ccm == null) {
            Log.m102w(CONTENT_CAPTURE_LOG_TAG, "dispatchProvideContentCaptureStructure(): no ContentCaptureManager for " + this);
            return;
        }
        ai.mReadyForContentCaptureUpdates = true;
        if (!isImportantForContentCapture()) {
            if (Log.isLoggable(CONTENT_CAPTURE_LOG_TAG, 3)) {
                Log.m94d(CONTENT_CAPTURE_LOG_TAG, "dispatchProvideContentCaptureStructure(): decorView is not important");
                return;
            }
            return;
        }
        ...
        if (session == null) {
            if (Log.isLoggable(CONTENT_CAPTURE_LOG_TAG, 3)) {
                Log.m94d(CONTENT_CAPTURE_LOG_TAG, "dispatchProvideContentCaptureStructure(): no session for " + this);
            }
        } else {
    ...
    @ViewDebug.ExportedProperty(mapping = {@ViewDebug.IntToString(from = 0, m158to = "VISIBLE"), @ViewDebug.IntToString(from = 4, m158to = "INVISIBLE"), @ViewDebug.IntToString(from = 8, m158to = "GONE")})
    ...
    @ViewDebug.ExportedProperty(category = TtmlUtils.TAG_LAYOUT, mapping = {@ViewDebug.IntToString(from = 0, m158to = "LTR"), @ViewDebug.IntToString(from = 1, m158to = "RTL"), @ViewDebug.IntToString(from = 2, m158to = "INHERIT"), @ViewDebug.IntToString(from = 3, m158to = "LOCALE")})
    ...
    @ViewDebug.ExportedProperty(category = TtmlUtils.TAG_LAYOUT, mapping = {@ViewDebug.IntToString(from = 0, m158to = "RESOLVED_DIRECTION_LTR"), @ViewDebug.IntToString(from = 1, m158to = "RESOLVED_DIRECTION_RTL")})
    ...
    public void setHasTransientState(boolean hasTransientState) {
        ...
        if (i < 0) {
            this.mTransientStateCount = 0;
            Log.m96e(VIEW_LOG_TAG, "hasTransientState decremented below 0: unmatched pair of setHasTransientState calls");
            return;
        }
        if ((hasTransientState && i == 1) || (!hasTransientState && i == 0)) {
            ...
            if (viewParent != null && newHasTransientState != oldHasTransientState) {
                try {
                    ...
                    Log.m97e(VIEW_LOG_TAG, this.mParent.getClass().getSimpleName() + " does not fully implement ViewParent", e);
                }
            }
        }
    }
    ...
    @ViewDebug.ExportedProperty(category = "focus", mapping = {@ViewDebug.IntToString(from = 0, m158to = "NOT_FOCUSABLE"), @ViewDebug.IntToString(from = 1, m158to = "FOCUSABLE"), @ViewDebug.IntToString(from = 16, m158to = "FOCUSABLE_AUTO")})
    ...
    @ViewDebug.ExportedProperty(category = Context.ACCESSIBILITY_SERVICE, mapping = {@ViewDebug.IntToString(from = 0, m158to = "auto"), @ViewDebug.IntToString(from = 1, m158to = "yes"), @ViewDebug.IntToString(from = 2, m158to = "no"), @ViewDebug.IntToString(from = 4, m158to = "noHideDescendants")})
    ...
    public void notifyViewAccessibilityStateChangedIfNeeded(int changeType) {
        ...
        if (viewParent2 != null) {
            try {
                ...
                Log.m97e(VIEW_LOG_TAG, this.mParent.getClass().getSimpleName() + " does not fully implement ViewParent", e2);
            }
        }
    }
            ...
            public void run() {
                ...
                if (viewRootImpl != null) {
                    ...
                    if (rootView instanceof DecorView) {
                        ...
                        Log.m94d(viewRootImpl.getTag(), "DecorView.setDisplayCutoutBackgroundColor() #" + Integer.toHexString(color));
                    }
                }
            }
        });
    ...
    private void initRoundedCorner() {
        this.mRoundRadius = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_rounded_corner_radius);
        int color = DEBUG_ROUNDED_CORNER ? -16776961 : this.mResources.getColor(C4337R.color.sem_round_and_bgcolor_dark, null);
        this.mBottomRightRoundColor = color;
        this.mBottomLeftRoundColor = color;
        this.mTopRightRoundColor = color;
        this.mTopLeftRoundColor = color;
    ...
    */
    ...
    @ViewDebug.ExportedProperty(mapping = {@ViewDebug.IntToString(from = 0, m158to = "INSIDE_OVERLAY"), @ViewDebug.IntToString(from = 16777216, m158to = "INSIDE_INSET"), @ViewDebug.IntToString(from = 33554432, m158to = "OUTSIDE_OVERLAY"), @ViewDebug.IntToString(from = 50331648, m158to = "OUTSIDE_INSET")})
            ...
            if ((baseState.mSavedData & 4) != 0) {
                ...
                if ((this.mPrivateFlags3 & 1073741824) != 0) {
                    if (Log.isLoggable(AUTOFILL_LOG_TAG, 3)) {
                        Log.m94d(AUTOFILL_LOG_TAG, "onRestoreInstanceState(): not setting autofillId to " + baseState.mAutofillViewId + " because view explicitly set it to " + this.mAutofillId);
                    }
                } else {
    ...
    public void outputDirtyFlags(String indent, boolean clear, int clearMask) {
        Log.m94d(VIEW_LOG_TAG, indent + this + "             DIRTY(" + (this.mPrivateFlags & 2097152) + ") DRAWN(" + (this.mPrivateFlags & 32) + ") CACHE_VALID(" + (this.mPrivateFlags & 32768) + ") INVALIDATED(" + (this.mPrivateFlags & Integer.MIN_VALUE) + NavigationBarInflaterView.KEY_CODE_END);
        if (clear) {
    ...
    private void buildDrawingCacheImpl(boolean autoScale) {
        ...
        if (width > 0 && height > 0) {
            Log.m102w(VIEW_LOG_TAG, getClass().getSimpleName() + " not displayed because it is too large to fit into a software layer (or drawing cache), needs " + projectedBitmapSize + " bytes, only " + drawingCacheSize + " available");
        }
        destroyDrawingCache();
        this.mCachingFailed = true;
    }
    ...
    */
    boolean draw(Canvas canvas, ViewGroup parent, long drawingTime) {
        ...
        this.mPrivateFlags |= 32;
        if (concatMatrix2 || (parentFlags & 2049) != z || !canvas.quickReject(this.mLeft, this.mTop, this.mRight, this.mBottom) || (this.mPrivateFlags & 64) != 0) {
    ...
    private void drawBackground(Canvas canvas) {
        ...
        int moveX = 0;
        int moveY = 0;
        if (getLastBackgroundResource() == 17304562 && this.mContext.getResources().getAssets().getSamsungThemeOverlays().size() > 0) {
            int width = this.mRight - this.mLeft;
            int height = this.mBottom - this.mTop;
            if (width > height) {
                squareSize = width;
    ...
    private Drawable getDefaultFocusHighlightDrawable() {
        if (this.mDefaultFocusHighlightCache == null) {
            if (CoreRune.BAIDU_CARLIFE && isCarLifeDisplay()) {
                this.mDefaultFocusHighlightCache = this.mContext.getDrawable(C4337R.drawable.carlife_selector_background_focused);
            } else {
                int[] attrs = {16843534};
    ...
    @ViewDebug.ExportedProperty(category = TtmlUtils.TAG_LAYOUT, indexMapping = {@ViewDebug.IntToString(from = 0, m158to = "x"), @ViewDebug.IntToString(from = 1, m158to = "y")})
    ...
    */
    ...
    protected void debug(int depth) {
        ...
        Log.m94d(VIEW_LOG_TAG, debugIndent(depth) + "frame={" + this.mLeft + ", " + this.mTop + ", " + this.mRight + ", " + this.mBottom + "} scroll={" + this.mScrollX + ", " + this.mScrollY + "} ");
        if (this.mPaddingLeft != 0 || this.mPaddingTop != 0 || this.mPaddingRight != 0 || this.mPaddingBottom != 0) {
            Log.m94d(VIEW_LOG_TAG, debugIndent(depth) + "padding={" + this.mPaddingLeft + ", " + this.mPaddingTop + ", " + this.mPaddingRight + ", " + this.mPaddingBottom + "}");
        }
        Log.m94d(VIEW_LOG_TAG, debugIndent(depth) + "mMeasureWidth=" + this.mMeasuredWidth + " mMeasureHeight=" + this.mMeasuredHeight);
        ...
        Log.m94d(VIEW_LOG_TAG, ((debugIndent(depth) + "privateFlags={") + printPrivateFlags(this.mPrivateFlags)) + "}");
    }
    ...
    */
    ...
    public boolean gatherTransparentRegion(Region region) {
        ...
        if (region != null && attachInfo != null) {
            ...
            if ((pflags & 128) == 0) {
                ...
                region.m20op(location[0] - shadowOffset, location[1] - shadowOffset, ((location[0] + this.mRight) - this.mLeft) + shadowOffset, ((location[1] + this.mBottom) - this.mTop) + (shadowOffset * 3), Region.EnumC0836Op.DIFFERENCE);
            } else {
                Drawable drawable = this.mBackground;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final boolean startDragAndDrop(ClipData data, DragShadowBuilder shadowBuilder, Object myLocalState, int flags, RectF selectedArea, Point location) {
        ...
        if (!a11yEnabled || (flags & 1024) == 0) {
            ...
            if (shadowSize.f85x < 0 || shadowSize.f86y < 0 || shadowTouchPoint.f85x < 0 || shadowTouchPoint.f86y < 0) {
            ...
            SurfaceControl surfaceControl = new SurfaceControl.Builder(session2).setName("drag surface").setParent(root2.getSurfaceControl()).setBufferSize(shadowSize.f85x, shadowSize.f86y).setFormat(-3).setCallsite("View.startDragAndDrop").build();
            if (overrideInvScale != 1.0f) {
            ...
            try {
                if (CoreRune.FW_DND_ANIMATION) {
                    try {
                        if (CoreRune.FW_DND_OBJECT_CAPTURE && (4194304 & flags) != 0) {
                            ...
                            try {
                                token = iWindowSession.performDragWithArea(iWindow, flags, surfaceControl, lastTouchSource, f, f2, f3, f4, data, selectedArea2, location2);
                                if (token == null) {
                                    try {
                ...
                token = this.mAttachInfo.mSession.performDrag(this.mAttachInfo.mWindow, flags, surfaceControl, root.getLastTouchSource(), lastTouchPoint2.f85x, lastTouchPoint2.f86y, shadowTouchPoint.f85x, shadowTouchPoint.f86y, data);
                if (token == null) {
                }
                if (token == null) {
                }
    ...
    */
    ...
    public void checkForLongClick(long delay, float x, float y, int classification) {
        ...
        if (ViewRootImpl.DEBUG_TOUCH_EVENT) {
            Log.m98i(VIEW_LOG_TAG, "checkForLongClick delay : " + delay + ", x : " + x + ", y : " + y + ", classification : " + classification + ", caller=" + Debug.getCallers(3));
        }
        ...
        if (isNestedScrollingEnabled()) {
            ...
            for (ViewParent p = getParent(); p != null; p = p.getParent()) {
                try {
                    ...
                    Log.m97e(VIEW_LOG_TAG, "ViewParent " + p + " does not implement interface method onStartNestedScroll", e);
                }
    ...
    @ViewDebug.ExportedProperty(category = "text", mapping = {@ViewDebug.IntToString(from = 0, m158to = "INHERIT"), @ViewDebug.IntToString(from = 1, m158to = "FIRST_STRONG"), @ViewDebug.IntToString(from = 2, m158to = "ANY_RTL"), @ViewDebug.IntToString(from = 3, m158to = "LTR"), @ViewDebug.IntToString(from = 4, m158to = "RTL"), @ViewDebug.IntToString(from = 5, m158to = "LOCALE"), @ViewDebug.IntToString(from = 6, m158to = "FIRST_STRONG_LTR"), @ViewDebug.IntToString(from = 7, m158to = "FIRST_STRONG_RTL")})
    ...
    @ViewDebug.ExportedProperty(category = "text", mapping = {@ViewDebug.IntToString(from = 0, m158to = "INHERIT"), @ViewDebug.IntToString(from = 1, m158to = "GRAVITY"), @ViewDebug.IntToString(from = 2, m158to = "TEXT_START"), @ViewDebug.IntToString(from = 3, m158to = "TEXT_END"), @ViewDebug.IntToString(from = 4, m158to = "CENTER"), @ViewDebug.IntToString(from = 5, m158to = "VIEW_START"), @ViewDebug.IntToString(from = 6, m158to = "VIEW_END")})
    ...
    public void semSetPointerIcon(int toolType, PointerIcon pointerIcon) {
        if (pointerIcon != null) {
            Log.m98i("PointerIcon", "[View]semSetPointerIcon = " + pointerIcon.getType() + ", toolType = " + toolType + ", view = " + this + ", callingPid = " + Binder.getCallingPid());
        } else {
            Log.m98i("PointerIcon", "[View]semSetPointerIcon is NULL , toolType = " + toolType + ", view = " + this + ", callingPid = " + Binder.getCallingPid());
        }
        if (toolType == 2) {
    ...
    public static class MeasureSpec {
        ...
        static int adjust(int measureSpec, int delta) {
            ...
            if (size2 < 0) {
                Log.m96e(View.VIEW_LOG_TAG, "MeasureSpec.adjust: new size would be negative! (" + size2 + ") spec: " + toString(measureSpec) + " delta: " + delta);
                size2 = 0;
            }
        ...
        public void accept(ViewTranslationRequest request) {
            ...
            if (request != null && request.getKeys().size() > 0) {
                ...
                if (Log.isLoggable(View.CONTENT_CAPTURE_LOG_TAG, 2)) {
                    Log.m100v(View.CONTENT_CAPTURE_LOG_TAG, "Calling setHasTransientState(true) for " + View.this.getAutofillId());
                }
