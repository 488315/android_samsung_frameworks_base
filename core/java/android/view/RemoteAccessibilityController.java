...
class RemoteAccessibilityController {
  ...
  void assosciateHierarchy(
    ...
    try {
      setRemoteAccessibilityEmbeddedConnection(
          connection, connection.associateEmbeddedHierarchy(leashToken, hostId));
  ...
  boolean alreadyAssociated(IAccessibilityEmbeddedConnection connection) {
    RemoteAccessibilityEmbeddedConnection remoteAccessibilityEmbeddedConnection =
  ...
  private void setRemoteAccessibilityEmbeddedConnection(
    ...
    try {
      ...
      if (connection != null && leashToken != null) {
        RemoteAccessibilityEmbeddedConnection remoteAccessibilityEmbeddedConnection2 =
