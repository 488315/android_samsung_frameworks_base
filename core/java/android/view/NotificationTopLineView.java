...
public class NotificationTopLineView extends ViewGroup {
  ...
  public NotificationTopLineView(
    ...
    this.mChildMinWidth =
        res.getDimensionPixelSize(C4337R.dimen.notification_header_shrink_min_width);
    this.mChildHideWidth =
        res.getDimensionPixelSize(C4337R.dimen.notification_header_shrink_hide_width);
  ...
  protected void onFinishInflate() {
    ...
    this.mAppName = findViewById(C4337R.id.app_name_text);
    this.mTitle = findViewById(16908310);
    this.mHeaderText = findViewById(C4337R.id.header_text);
    this.mHeaderTextDivider = findViewById(C4337R.id.header_text_divider);
    this.mSecondaryHeaderText = findViewById(C4337R.id.header_text_secondary);
    this.mSecondaryHeaderTextDivider = findViewById(C4337R.id.header_text_secondary_divider);
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    while (i2 < getChildCount()) {
      ...
      if (child.getVisibility() == 8) {
        ...
        int childWidthSpec =
            getChildMeasureSpec(wrapContentWidthSpec, lp.leftMargin + lp.rightMargin, lp.width);
        int childHeightSpec =
        ...
        switch (this.mGravityY) {
          case 16:
            ...
            if (childBaseline != -1) {
              ...
              childTop =
                  ((this.mPaddingTop + ((childSpace - childHeight) / 2)) + params.topMargin)
                      - params.bottomMargin;
              break;
            }
          case 48:
  ...
  private class HeaderTouchListener implements View.OnTouchListener {
    ...
    public void bindTouchRects() {
      ...
      this.mTouchSlop =
          ViewConfiguration.get(NotificationTopLineView.this.getContext()).getScaledTouchSlop();
    }
