...
public class NotificationTopLineView extends ViewGroup {
    ...
    public NotificationTopLineView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mChildMinWidth = res.getDimensionPixelSize(C4337R.dimen.notification_header_shrink_min_width);
        this.mChildHideWidth = res.getDimensionPixelSize(C4337R.dimen.notification_header_shrink_hide_width);
