...
public class Surface implements Parcelable {
    ...
    private void unlockSwCanvasAndPost(Canvas canvas) {
        ...
        if (this.mNativeObject != this.mLockedObject) {
            Log.m102w(TAG, "WARNING: Surface's mNativeObject (0x" + Long.toHexString(this.mNativeObject) + ") != mLockedObject (0x" + Long.toHexString(this.mLockedObject) + NavigationBarInflaterView.KEY_CODE_END);
        }
