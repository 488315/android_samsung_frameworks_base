...
public final class SurfaceControl implements Parcelable {
    ...
    public static final class DisplayMode {
        ...
        public String toString() {
            return "DisplayMode{id=" + this.f550id + ", width=" + this.width + ", height=" + this.height + ", xDpi=" + this.xDpi + ", yDpi=" + this.yDpi + ", refreshRate=" + this.refreshRate + ", appVsyncOffsetNanos=" + this.appVsyncOffsetNanos + ", presentationDeadlineNanos=" + this.presentationDeadlineNanos + ", supportedHdrTypes=" + Arrays.toString(this.supportedHdrTypes) + ", group=" + this.group + "}";
        }
        ...
        public int hashCode() {
            return Objects.hash(Integer.valueOf(this.f550id), Integer.valueOf(this.width), Integer.valueOf(this.height), Float.valueOf(this.xDpi), Float.valueOf(this.yDpi), Float.valueOf(this.refreshRate), Long.valueOf(this.appVsyncOffsetNanos), Long.valueOf(this.presentationDeadlineNanos), Integer.valueOf(this.group), Integer.valueOf(Arrays.hashCode(this.supportedHdrTypes)));
        }
    }
    ...
    public static final class RefreshRateRange implements Parcelable {
        ...
        public RefreshRateRange(float min, float max) {
            if (min < 0.0f || max < 0.0f || min > 0.01f + max) {
                Slog.m115e(TAG, "Wrong values for min and max when initializing RefreshRateRange : " + min + " " + max);
                this.max = 0.0f;
                this.min = 0.0f;
            } else {
                if (min > max) {
    ...
    public static void notifyHFRmode(IBinder displayToken, int hfrMode) {
        if (CoreRune.FW_VRR_REFRESH_RATE_MODE) {
            Log.m94d(TAG, "notifyHFRmode, displayToken=" + displayToken + ", hfrMode=" + Settings.Secure.refreshRateModeToString(hfrMode));
        }
        if (displayToken == null) {
            throw new IllegalArgumentException("displayToken must not be null");
        }
    ...
    public static class Transaction implements Closeable, Parcelable {
        ...
        public void apply(boolean sync) {
            if (CoreRune.FW_SURFACE_DEBUG_APPLY && !TextUtils.isEmpty(this.mDebugName)) {
                Log.m98i(SurfaceControl.TAG, "apply is called, name=" + this.mDebugName + ", caller=" + Debug.getCallers(6));
                this.mDebugName = null;
            }
        ...
        public Transaction show(SurfaceControl sc) {
            if (CoreRune.FW_SURFACE_DEBUG_VISIBILITY || !TextUtils.isEmpty(this.mDebugName)) {
                ...
                Log.m98i(SurfaceControl.TAG, builder.append(", sc=").append(sc).append(", caller=").append(Debug.getCallers(6)).toString());
            }
            checkPreconditions(sc);
        ...
        public Transaction setPosition(SurfaceControl sc, float x, float y) {
            if (CoreRune.FW_SURFACE_DEBUG_TRANSFORM) {
                Log.m94d(SurfaceControl.TAG, "setPosition, x=" + x + ", y=" + y + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
            }
            checkPreconditions(sc);
        ...
        public Transaction setLayer(SurfaceControl sc, int z) {
            if (CoreRune.FW_SURFACE_DEBUG_LAYER) {
                Log.m94d(SurfaceControl.TAG, "setLayer, z=" + z + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
            }
            checkPreconditions(sc);
        ...
        public Transaction setRelativeLayer(SurfaceControl sc, SurfaceControl relativeTo, int z) {
            if (CoreRune.FW_SURFACE_DEBUG_LAYER) {
                Log.m94d(SurfaceControl.TAG, "setRelativeLayer, z=" + z + ", sc=" + sc + ", relativeTo=" + relativeTo + ", caller=" + Debug.getCallers(6));
            }
            checkPreconditions(sc);
        ...
        public Transaction setAlpha(SurfaceControl sc, float alpha) {
            if (CoreRune.FW_SURFACE_DEBUG_ALPHA) {
                ...
                Log.m94d(SurfaceControl.TAG, builder.append(", alpha=").append(alpha).append(", sc=").append(sc).append(", caller=").append(Debug.getCallers(6)).toString());
            }
            checkPreconditions(sc);
        ...
        public Transaction setMatrix(SurfaceControl sc, float dsdx, float dtdx, float dtdy, float dsdy) {
            if (CoreRune.FW_SURFACE_DEBUG_TRANSFORM) {
                Log.m94d(SurfaceControl.TAG, "setMatrix, (" + dsdx + "," + dtdx + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + dtdy + "," + dsdy + ") , sc=" + sc + ", caller=" + Debug.getCallers(6));
            }
            checkPreconditions(sc);
        ...
        public Transaction setWindowCrop(SurfaceControl sc, Rect crop) {
            if (CoreRune.FW_SURFACE_DEBUG_CROP) {
                Log.m94d(SurfaceControl.TAG, "setWindowCrop, crop=" + crop + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
            }
            checkPreconditions(sc);
            if (crop != null) {
        ...
        public Transaction setCrop(SurfaceControl sc, Rect crop) {
            if (CoreRune.FW_SURFACE_DEBUG_CROP) {
                Log.m94d(SurfaceControl.TAG, "setCrop, crop=" + crop + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
            }
            checkPreconditions(sc);
            if (crop != null) {
        ...
        public Transaction setWindowCrop(SurfaceControl sc, int width, int height) {
            if (CoreRune.FW_SURFACE_DEBUG_CROP) {
                Log.m94d(SurfaceControl.TAG, "setWindowCrop, width=" + width + ", height=" + height + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
            }
            checkPreconditions(sc);
        ...
        public Transaction reparent(SurfaceControl sc, SurfaceControl newParent) {
            ...
            if (CoreRune.FW_SURFACE_DEBUG_REPARENT) {
                ...
                Log.m94d(SurfaceControl.TAG, sb.append(", sc=").append(sc).append(", newParent=").append(newParent).append(", caller=").append(Debug.getCallers(12)).toString());
            }
            if (newParent != null) {
        ...
        public Transaction remove(SurfaceControl sc) {
            if (CoreRune.FW_SURFACE_DEBUG_REMOVE) {
                ...
                Log.m94d(SurfaceControl.TAG, sb.append(", sc=").append(sc).append(", caller=").append(Debug.getCallers(12)).toString());
            }
            reparent(sc, null);
            sc.release();
            return this;
        ...
        public Transaction startChangeResolution(IBinder displayToken, boolean enabled) {
            ...
            Log.m98i(SurfaceControl.TAG, "startChangeResolution, enabled=" + enabled + ", caller=" + Debug.getCallers(5));
