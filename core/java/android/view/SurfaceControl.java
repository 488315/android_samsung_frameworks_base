...
public final class SurfaceControl implements Parcelable {
  ...
  private static final NativeAllocationRegistry sRegistry =
      NativeAllocationRegistry.createMalloced(
          SurfaceControl.class.getClassLoader(), nativeGetNativeSurfaceControlFinalizer());
  ...
  public static int rotationToBufferTransform(int rotation) {
    switch (rotation) {
      ...
      case 3:
        break;
      default:
        Log.m96e(TAG, "Trying to convert unknown rotation=" + rotation);
        break;
    }
    return 0;
  }
  ...
  public static class Builder {
    ...
    public SurfaceControl build() {
      ...
      if (this.mName == null) {
        Log.m103w(SurfaceControl.TAG, "Missing name for SurfaceControl", new Throwable());
      }
  ...
  private SurfaceControl(
    ...
    try {
      ...
      if (CoreRune.FW_SURFACE_DEBUG_CREATION) {
        Log.m94d(TAG, "SurfaceControl is created, sc=" + this + ", caller=" + Debug.getCallers(6));
      }
    } catch (Throwable th2) {
      th = th2;
      metaParcel.recycle();
  ...
  public static void closeTransaction() {
    synchronized (SurfaceControl.class) {
      ...
      if (j == 0) {
        Log.m96e(TAG, "Call to SurfaceControl.closeTransaction without matching openTransaction");
      } else {
        long j2 = j - 1;
  ...
  public static final class RefreshRateRange implements Parcelable {
    public static final Parcelable.Creator<RefreshRateRange> CREATOR =
        new Parcelable.Creator<
            RefreshRateRange>() { // from class: android.view.SurfaceControl.RefreshRateRange.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public RefreshRateRange(float min, float max) {
      if (min < 0.0f || max < 0.0f || min > 0.01f + max) {
        Slog.m115e(
            TAG,
            "Wrong values for min and max when initializing RefreshRateRange : " + min + " " + max);
        this.max = 0.0f;
        this.min = 0.0f;
      } else {
        if (min > max) {
  ...
  public static void restrictHighRefreshRate(boolean enabled) {
    Log.m94d(TAG, "restrictHighRefreshRate, enabled=" + enabled);
  ...
  public static void setDisplayProjection(
    ...
    DisplayManagerGlobal.getInstance()
        .resizeVirtualDisplay(
            ...
            layerStackRect.width(),
            layerStackRect.height(),
            1);
  }
  ...
  public static void destroyDisplay(IBinder displayToken) {
    ...
    DisplayManagerGlobal.getInstance()
        .releaseVirtualDisplay(IVirtualDisplayCallback.Stub.asInterface(displayToken));
  }
  ...
  public static boolean setDisplayBrightness(
    ...
    if (Float.isNaN(displayBrightness)
      ...
      throw new IllegalArgumentException(
          "displayBrightness must be a number between 0.0f  and 1.0f, or -1 to turn the backlight"
              + " off: "
              + displayBrightness);
    }
    if (Float.isNaN(sdrBrightness)
      ...
      throw new IllegalArgumentException(
          "sdrBrightness must be a number between 0.0f and 1.0f, or -1 to turn the backlight off: "
              + sdrBrightness);
    }
    return nativeSetDisplayBrightness(
        displayToken, sdrBrightness, sdrBrightnessNits, displayBrightness, displayBrightnessNits);
  }
  ...
  private static void validateColorArg(float[] color) {
    if (color.length != 4) {
      throw new IllegalArgumentException(
          "Color must be specified as a float array with four values to represent r, g, b, a in"
              + " range [0..1]");
    }
    for (float c : color) {
      if (c < 0.0f || c > 1.0f) {
  ...
  public static class Transaction implements Closeable, Parcelable {
    ...
    public static void setDefaultApplyToken(IBinder token) {
      if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_LOG) {
        Log.m94d(SurfaceControl.TAG, "setDefaultApplyToken, caller=" + Debug.getCallers(5));
      }
    ...
    public void apply(boolean sync) {
      if (CoreRune.FW_SURFACE_DEBUG_APPLY && !TextUtils.isEmpty(this.mDebugName)) {
        Log.m98i(
            SurfaceControl.TAG,
            "apply is called, name=" + this.mDebugName + ", caller=" + Debug.getCallers(6));
        this.mDebugName = null;
      }
    ...
    protected void applyResizedSurfaces() {
      for (int i = this.mResizedSurfaces.size() - 1; i >= 0; i--) {
        ...
        synchronized (surfaceControl.mLock) {
          surfaceControl.resize(size.f85x, size.f86y);
        }
      }
      this.mResizedSurfaces.clear();
    }
    ...
    public Transaction setPosition(SurfaceControl sc, float x, float y) {
      if (CoreRune.FW_SURFACE_DEBUG_TRANSFORM) {
        Log.m94d(
            SurfaceControl.TAG,
            "setPosition, x=" + x + ", y=" + y + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
      }
      checkPreconditions(sc);
    ...
    public Transaction setLayer(SurfaceControl sc, int z) {
      if (CoreRune.FW_SURFACE_DEBUG_LAYER) {
        Log.m94d(
            SurfaceControl.TAG,
            "setLayer, z=" + z + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
      }
      checkPreconditions(sc);
    ...
    public Transaction setWindowCrop(SurfaceControl sc, Rect crop) {
      if (CoreRune.FW_SURFACE_DEBUG_CROP) {
        Log.m94d(
            SurfaceControl.TAG,
            "setWindowCrop, crop=" + crop + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
      }
      checkPreconditions(sc);
      if (crop != null) {
        SurfaceControl.nativeSetWindowCrop(
            this.mNativeObject, sc.mNativeObject, crop.left, crop.top, crop.right, crop.bottom);
      } else {
    ...
    public Transaction setCrop(SurfaceControl sc, Rect crop) {
      if (CoreRune.FW_SURFACE_DEBUG_CROP) {
        Log.m94d(
            SurfaceControl.TAG,
            "setCrop, crop=" + crop + ", sc=" + sc + ", caller=" + Debug.getCallers(6));
      }
      checkPreconditions(sc);
      if (crop != null) {
    ...
    public Transaction setFrameRate(
        SurfaceControl sc, float frameRate, int compatibility, int changeFrameRateStrategy) {
      checkPreconditions(sc);
      SurfaceControl.nativeSetFrameRate(
          this.mNativeObject, sc.mNativeObject, frameRate, compatibility, changeFrameRateStrategy);
      return this;
    }
    ...
    public Transaction setTrustedOverlay(SurfaceControl sc, boolean isTrustedOverlay) {
      ...
      SurfaceControl.nativeSetTrustedOverlay(
          this.mNativeObject, sc.mNativeObject, isTrustedOverlay);
      return this;
    }
    ...
    public Transaction merge(Transaction other) {
      ...
      this.mReparentedSurfaces.putAll(
          (ArrayMap<? extends SurfaceControl, ? extends SurfaceControl>) other.mReparentedSurfaces);
    ...
    class C36841 extends TrustedPresentationCallback {
      final /* synthetic */ Executor val$executor;
      final /* synthetic */ Consumer val$listener;

      /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
      C36841(Executor executor, Consumer consumer) {
        super();
    ...
    public Transaction setTrustedPresentationCallback(
      ...
      checkPreconditions(sc);
      TrustedPresentationCallback tpc = new C36841(executor, listener);
    ...
    public Transaction setInternalPresentationOnly(
        SurfaceControl sc, boolean isInternalPresentationOnly) {
      sc.checkNotReleased();
      SurfaceControl.nativeSetFlags(
          this.mNativeObject, sc.mNativeObject, isInternalPresentationOnly ? 8 : 0, 8);
      return this;
    }
    ...
    public Transaction startChangeResolution(IBinder displayToken, boolean enabled) {
      ...
      Log.m98i(
          SurfaceControl.TAG,
          "startChangeResolution, enabled=" + enabled + ", caller=" + Debug.getCallers(5));
    ...
    private void readFromParcel(Parcel in) {
      ...
      if (in.readInt() != 0) {
        ...
        this.mFreeNativeResources =
            sRegistry.registerNativeAllocation(this, nativeReadTransactionFromParcel);
        if (CoreRune.FW_SURFACE_DEBUG_APPLY) {
  ...
  private static class GlobalTransactionWrapper extends Transaction {
    ...
    void applyGlobalTransaction(boolean sync) {
      if (CoreRune.FW_SURFACE_DEBUG_APPLY && !TextUtils.isEmpty(this.mDebugName)) {
        Log.m98i(SurfaceControl.TAG, "applyGlobalTransaction called, name=" + this.mDebugName);
        this.mDebugName = null;
      }
      applyResizedSurfaces();
      notifyReparentedSurfaces();
