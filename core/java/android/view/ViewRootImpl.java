...
public final class ViewRootImpl
  ...
  private ArrayList<AttachedSurfaceControl.OnBufferTransformHintChangedListener>
      mTransformHintListeners;
  ...
  public interface ActivityConfigCallback {
    ...
    void requestCompatCameraControl(
  ...
  static {
    ...
    sAnrReported = false;
    sTransactionHangCallback =
        new BLASTBufferQueue.TransactionHangCallback() { // from class: android.view.ViewRootImpl.1
  ...
  private void updateCompatTranslator(int res) {
    ...
    if (compatTranslatorEnabled && this.mCompatTranslator == null) {
      ...
      if (view != null
          && view != this.mView
          && (parentViewRootImpl = view.getViewRootImpl()) != null) {
    ...
    if (this.mCompatTranslatorEnabled != compatTranslatorEnabled) {
      if (CoreRune.SAFE_DEBUG) {
        Slog.m113d(
            this.mTag,
            "CompatTranslatorEnabled changed from "
                + this.mCompatTranslatorEnabled
                + " to "
                + compatTranslatorEnabled);
      }
  ...
  private void updateCutoutRemoveNeeded(int flags) {
    boolean isCutoutRemoveNeeded =
        (2097152 & flags) != 0
            || (MultiWindowCoreState.MW_SPLIT_IMMERSIVE_MODE_ENABLED
                && getCompatWindowConfiguration().isSplitScreen());
  ...
  private void updatePositionInBounds(CompatTranslator translator, Configuration configuration) {
    ...
    if (translator.savePositionInBounds(left, top)) {
      Slog.m119v(
          this.mTag,
          "updatePositionInBounds, enabled="
              + this.mBoundsCompatTranslatorEnabled
              + ", left="
              + left
              + ", top="
              + top);
  ...
  public ViewRootImpl(
      Context context, Display display, IWindowSession session, WindowLayout windowLayout) {
    ...
    this.mGestureExclusionTracker =
        new ViewRootRectTracker(
            new Function() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda8
    ...
    this.mKeepClearRectsTracker =
        new ViewRootRectTracker(
            new Function() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda9
              @Override // java.util.function.Function
              public final Object apply(Object obj) {
    ...
    this.mUnrestrictedKeepClearRectsTracker =
        new ViewRootRectTracker(
            new Function() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda10
              @Override // java.util.function.Function
              public final Object apply(Object obj) {
                List collectUnrestrictedPreferKeepClearRects;
                collectUnrestrictedPreferKeepClearRects =
                    ((View) obj).collectUnrestrictedPreferKeepClearRects();
    ...
    this.mDisplayListener =
        new DisplayManager.DisplayListener() { // from class: android.view.ViewRootImpl.3
          @Override // android.hardware.display.DisplayManager.DisplayListener
          public void onDisplayChanged(int displayId) {
            if (ViewRootImpl.this.mView != null
                && ViewRootImpl.this.mDisplay.getDisplayId() == displayId) {
              ...
              Log.m98i(
                  ...
                  "onDisplayChanged oldDisplayState="
                      + oldDisplayState
                      + " newDisplayState="
                      + newDisplayState);
              if (oldDisplayState != newDisplayState) {
                ...
                if (oldDisplayState != 0) {
                  ...
                  if (ViewRootImpl.DEBUG_TRAVERSAL
                      && ViewRootImpl.DEBUG_TRAVERSAL_PACKAGE_NAME.equals(
                          ViewRootImpl.this.mView.getContext().getPackageName())) {
                    Log.m98i(
                        ViewRootImpl.this.mTag,
                        "Traversal, [4] mView="
                            + ViewRootImpl.this.mView
                            + " oldDisplayState="
                            + oldDisplayState);
                  }
                  switch (oldDisplayState) {
                    ...
                    case 4:
                      if (newDisplayState == 2
                          && displayId == 0
                          && (ViewRootImpl.this.mWindowAttributes.samsungFlags & 262144) == 0) {
                        ViewRootImpl.this.mFullRedrawNeeded = true;
                        ViewRootImpl.this.scheduleTraversals();
                        break;
                      }
          ...
          private int toViewScreenState(int displayState) {
            return Settings.System.getInt(
                        ViewRootImpl.this.mContentResolver, ViewRootImpl.AOD_SHOW_STATE, 0)
                    != 0
                ? displayState == 2 ? 1 : 0
                : displayState == 1 ? 0 : 1;
          }
    ...
    this.mExecutor =
        new Executor() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda11
    ...
    this.mAdded = false;
    this.mAttachInfo =
        new View.AttachInfo(session, binderC3744W, display, this, viewRootHandler, this, context);
    ...
    this.mHandwritingInitiator =
        new HandwritingInitiator(
            viewConfiguration,
    ...
    String processorOverrideName =
        context
            .getResources()
            .getString(C4337R.string.config_inputEventCompatProcessorOverrideClassName);
      ...
      try {
        compatProcessor =
            (InputEventCompatProcessor)
                Class.forName(processorOverrideName)
    ...
    if (CoreRune.FW_OVERLAPPING_WITH_CUTOUT_AS_DEFAULT) {
      this.mMinimumSizeForOverlappingWithCutoutAsDefault =
          this.mContext
              .getResources()
              .getDimensionPixelSize(
                  C4337R.dimen.samsung_minimum_size_for_overlapping_with_cutout_as_default);
    }
  ...
  private void updateDesktopMode() {
    ...
    if (semDesktopModeManager != null) {
      ...
      if (this.mDisplay.getDisplayId() != 2
          && (!this.mDesktopModeStandAlone
              || (desktopModeEnabled != 3 && desktopModeEnabled != 4))) {
        z = false;
      }
      this.mDesktopMode = z;
  ...
  public void notifyChildRebuilt() {
    if (this.mView instanceof RootViewSurfaceTaker) {
      ...
      SurfaceHolder.Callback2 willYouTakeTheSurface =
          ((RootViewSurfaceTaker) this.mView).willYouTakeTheSurface();
      ...
      InputQueue.Callback willYouTakeTheInputQueue =
          ((RootViewSurfaceTaker) this.mView).willYouTakeTheInputQueue();
      ...
      for (InsetsSourceControl control : controls) {
        if (control != null) {
          ...
          control.setInsetsHint(
              (int) (hint.left * invScale),
              (int) (hint.top * invScale),
              (int) (hint.right * invScale),
              (int) (hint.bottom * invScale));
        }
      }
    }
    return controls;
  ...
  */
        ...
        if (this.mView == null) {
          ...
          try {
            ...
            if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_TRANSIENT_LAUNCH_OVERLAY
                && this.mWindowAttributes.type == 2632) {
            ...
            try {
              ...
              if (DEBUG_KEEP_SCREEN_ON
                  && (this.mClientWindowLayoutFlags & 128) != 0
                  && (attrs2.flags & 128) == 0) {
              ...
              CompatibilityInfo compatibilityInfo =
                  this.mDisplay.getDisplayAdjustments().getCompatibilityInfo();
              ...
              attachInfo.mApplicationScale =
                  translator2 == null ? 1.0f : translator2.applicationScale;
              if (panelParentView != null) {
                this.mAttachInfo.mPanelParentWindowToken =
              ...
              if ((callback instanceof RootViewSurfaceTaker)
                  && (pendingInsetsController =
                          ((RootViewSurfaceTaker) callback).providePendingInsetsController())
                      != null) {
              ...
              try {
                try {
                  ...
                  int res =
                      this.mWindowSession.addToDisplayAsUser(
                          this.mWindow,
                          this.mWindowAttributes,
                          getHostVisibility(),
                          this.mDisplay.getDisplayId(),
                          userId,
                          this.mInsetsController.getRequestedVisibleTypes(),
                          inputChannel == null ? new InputChannel() : inputChannel,
                          this.mTempInsets,
                          this.mTempControls,
                          attachedFrame2,
                          compatScale);
                  ...
                  if (translator3 != null) {
                    ...
                    this.mTranslator.translateSourceControlsInScreenToAppWindow(
                        this.mTempControls.get());
                  ...
                  if (inputChannel != null) {
                    ...
                    if ((ai.flags & 33554432) == 0 && ai.category != 0) {
                      ...
                      if (this.mAttachInfo.mThreadedRenderer != null) {
                        ...
                        this.mHardwareRendererObserver =
                            new HardwareRendererObserver(
                                listener, listener.data, this.mHandler, true);
                        this.mAttachInfo.mThreadedRenderer.addObserver(
                            this.mHardwareRendererObserver);
                      }
                  ...
                  InputStage nativePostImeStage =
                      new NativePostImeInputStage(
                          viewPostImeStage, "aq:native-post-ime:" + ((Object) counterSuffix));
                  InputStage earlyPostImeStage = new EarlyPostImeInputStage(nativePostImeStage);
                  InputStage imeStage =
                      new ImeInputStage(earlyPostImeStage, "aq:ime:" + ((Object) counterSuffix));
                  InputStage viewPreImeStage = new ViewPreImeInputStage(imeStage);
                  InputStage nativePreImeStage =
                      new NativePreImeInputStage(
                          viewPreImeStage, "aq:native-pre-ime:" + ((Object) counterSuffix));
                  this.mFirstInputStage = nativePreImeStage;
                  this.mFirstPostImeInputStage = earlyPostImeStage;
                  this.mPendingInputEventQueueLengthCounterName =
                      "aq:pending:" + ((Object) counterSuffix);
                  if (CoreRune.BIXBY_TOUCH) {
                    this.mSemPressGestureDetector =
                        new SemPressGestureDetector(this.mContext, this.mView);
                  }
  ...
  public void setAccessibilityWindowAttributesIfNeeded() {
    ...
    if (registered) {
      AccessibilityWindowAttributes attributes =
          new AccessibilityWindowAttributes(
              this.mWindowAttributes, this.mContext.getResources().getConfiguration().getLocales());
      if (!attributes.equals(this.mAccessibilityWindowAttributes)) {
        this.mAccessibilityWindowAttributes = attributes;
        this.mAccessibilityManager.setAccessibilityWindowAttributes(
            getDisplayId(), this.mAttachInfo.mAccessibilityWindowId, attributes);
      }
    }
  }

  private void registerListeners() {
    this.mAccessibilityManager.addAccessibilityStateChangeListener(
        this.mAccessibilityInteractionConnectionManager, this.mHandler);
    this.mAccessibilityManager.addHighTextContrastStateChangeListener(
        this.mHighContrastTextManager, this.mHandler);
    DisplayManagerGlobal.getInstance()
        .registerDisplayListener(this.mDisplayListener, this.mHandler, 7L);
    if (this.mAttachInfo != null
        && this.mDisplay.getState() != this.mAttachInfo.mDisplayState
        && this.mAttachInfo.mDisplay != null
        && this.mAttachInfo.mDisplay.getDisplayId() == this.mDisplay.getDisplayId()) {
      this.mAttachInfo.mDisplayState = this.mDisplay.getState();
      Log.m98i(
          this.mTag,
          "synced displayState. AttachInfo displayState=" + this.mAttachInfo.mDisplayState);
    }
  }

  private void unregisterListeners() {
    this.mAccessibilityManager.removeAccessibilityStateChangeListener(
        this.mAccessibilityInteractionConnectionManager);
    this.mAccessibilityManager.removeHighTextContrastStateChangeListener(
        this.mHighContrastTextManager);
  ...
  private void setTag() {
    ...
    if (split.length > 0) {
      String str =
          "ViewRootImpl@"
              + Integer.toHexString(this.mWindow.hashCode())
  ...
  void destroyHardwareResources() {
    ...
    if (renderer != null) {
      if (Looper.myLooper() != this.mAttachInfo.mHandler.getLooper()) {
        this.mAttachInfo.mHandler.postAtFrontOfQueue(
            new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda18
  ...
  public void registerRtFrameCallback(final HardwareRenderer.FrameDrawingCallback callback) {
    if (this.mAttachInfo.mThreadedRenderer != null) {
      this.mAttachInfo.mThreadedRenderer.registerRtFrameCallback(
          new HardwareRenderer.FrameDrawingCallback() { // from class: android.view.ViewRootImpl.2
  ...
  private void enableHardwareAcceleration(WindowManager.LayoutParams attrs) {
    ...
    if (ThreadedRenderer.sRendererEnabled || forceHwAccelerated) {
      ...
      ThreadedRenderer renderer =
          ThreadedRenderer.create(this.mContext, translucent, attrs.getTitle().toString());
  ...
  public void setLayoutParams(WindowManager.LayoutParams attrs, boolean newView) {
    ...
    synchronized (this) {
      ...
      int appearanceAndBehaviorPrivateFlags =
          this.mWindowAttributes.privateFlags & Enums.AUDIO_FORMAT_DTS_HD;
      ...
      this.mWindowAttributes.privateFlags |=
          compatibleWindowFlag | appearanceAndBehaviorPrivateFlags | 33554432;
      if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_TRANSIENT_LAUNCH_OVERLAY
          && this.mWindowAttributes.type == 2632) {
        this.mWindowAttributes.inputFeatures |= 1;
      }
      if (this.mWindowAttributes.preservePreviousSurfaceInsets) {
        this.mWindowAttributes.surfaceInsets.set(
            oldInsetLeft2, oldInsetTop, oldInsetRight, oldInsetBottom);
        this.mWindowAttributes.hasManualSurfaceInsets = oldHasManualSurfaceInsets;
      } else if (this.mWindowAttributes.surfaceInsets.left != oldInsetLeft2
          || this.mWindowAttributes.surfaceInsets.top != oldInsetTop
          || this.mWindowAttributes.surfaceInsets.right != oldInsetRight
          || this.mWindowAttributes.surfaceInsets.bottom != oldInsetBottom) {
      ...
      if (DEBUG_TRAVERSAL
          && DEBUG_TRAVERSAL_PACKAGE_NAME.equals(this.mView.getContext().getPackageName())) {
  ...
  private boolean isImpossibleRenderer() {
    return this.mSemEarlyAppVisibilityChanged
        && this.mAppVisible
        && this.mStopped
        && !this.mSemEarlyAppVisibility;
  }
  ...
  void handleAppVisibility(boolean visible) {
    ...
    Log.m98i(
        this.mTag,
        "handleAppVisibility mAppVisible = " + this.mAppVisible + " visible = " + visible);
  ...
  public void handleResized(int msg, SomeArgs args) {
    ...
    boolean attachedFrameChanged =
        LOCAL_LAYOUT && !Objects.equals(this.mTmpFrames.attachedFrame, attachedFrame2);
    ...
    if (this.mDragResizing && this.mUseMTRenderer) {
      ...
      while (i >= 0) {
        this.mWindowCallbacks
            .get(i)
            .onWindowSizeIsChanging(
                this.mPendingBackDropFrame,
                fullscreen,
                this.mAttachInfo.mVisibleInsets,
                this.mAttachInfo.mStableInsets);
        i--;
        frames = frames;
  ...
  private void updateInternalDisplay(int displayId, Resources resources) {
    ...
    if (this.mHdrSdrRatioChangedListener != null
        && (display = this.mDisplay) != null
        && display.isHdrSdrRatioAvailable()) {
      this.mDisplay.registerHdrSdrRatioChangedListener(
          this.mExecutor, this.mHdrSdrRatioChangedListener);
    }
  ...
  void pokeDrawLockIfNeeded() {
    if (!this.mPokeDrawLockController.consumeRequestedToAllowPokeDrawLock(false)
        || !Display.isDozeState(this.mAttachInfo.mDisplayState)) {
      return;
    }
    if ((this.mWindowAttributes.type == 1 || this.mCanAllowPokeDrawLock)
        && this.mAdded
        && this.mTraversalScheduled) {
      if (this.mAttachInfo.mHasWindowFocus
          || !this.mPokeDrawLockController.shouldSkipPokeDrawLockIfNeeded(this.mReportNextDraw)) {
        try {
  ...
  void notifyInsetsChanged() {
    ...
    if ((winConfig.getWindowingMode() == 5 || isBottomSplit)
        && imeSource != null
        && imeSource.isVisible()
        && !imeSource.getFrame().isEmpty()
        && imeSource.getFrame().top < this.mWinFrame.top) {
      return;
    }
    this.mApplyInsetsRequested = true;
    requestLayout();
    if (View.sForceLayoutWhenInsetsChanged
        && this.mView != null
        && (this.mWindowAttributes.softInputMode & 240) == 16) {
    ...
    if (DEBUG_TRAVERSAL
      ...
      Log.m98i(
          this.mTag,
          "Traversal, [6] mView=" + this.mView + " mIsInTraversal=" + this.mIsInTraversal);
    }
    ...
    if (DEBUG_TRAVERSAL
      ...
      Log.m98i(
          ...
          "Traversal, [7] mView="
              ...
              + this.mHandlingLayoutInLayoutRequest);
    }
  ...
  void invalidate() {
    if (DEBUG_TRAVERSAL
        && DEBUG_TRAVERSAL_PACKAGE_NAME.equals(this.mView.getContext().getPackageName())) {
      Log.m98i(
          this.mTag, "Traversal, [8] mView=" + this.mView + " mWillDrawSoon=" + this.mWillDrawSoon);
    }
  ...
  private void invalidateRectOnScreen(Rect dirty) {
    ...
    boolean intersected =
        localDirty.intersect(
            0,
            0,
            (int) ((this.mWidth * appScale) + 0.5f),
            (int) ((this.mHeight * appScale) + 0.5f));
    if (!intersected) {
      localDirty.setEmpty();
    }
    if (DEBUG_TRAVERSAL
  ...
  public void setWindowStopped(boolean stopped) {
    ...
    if (this.mStopped != stopped) {
      ...
      if (renderer != null) {
        Log.m94d(
            this.mTag, "WindowStopped on " + ((Object) getTitle()) + " set to " + this.mStopped);
  ...
  public SurfaceControl getBoundsLayer() {
    if (this.mBoundsLayer == null) {
      ...
      boolean needBoundsLayer =
          winConfig.getWindowingMode() == 5
              && winConfig.getFreeformTranslucent() != 1
              && this.mWindowAttributes.type == 1;
      this.mBoundsLayer =
          new SurfaceControl.Builder(this.mSurfaceSession)
              .setContainerLayer()
              .setName(
                  "Bounds for - " + getTitle().toString() + "@" + this.mBoundsLayerCreatedCount)
  ...
  void updateBlastSurfaceIfNeeded() {
    ...
    BLASTBufferQueue bLASTBufferQueue3 =
  ...
  private void setBoundsLayerCrop(SurfaceControl.Transaction t) {
    ...
    this.mTempRect.inset(
        this.mWindowAttributes.surfaceInsets.left,
        this.mWindowAttributes.surfaceInsets.top,
        this.mWindowAttributes.surfaceInsets.right,
        this.mWindowAttributes.surfaceInsets.bottom);
    this.mTempRect.inset(
        this.mChildBoundingInsets.left,
        this.mChildBoundingInsets.top,
        this.mChildBoundingInsets.right,
        this.mChildBoundingInsets.bottom);
  ...
  private boolean updateBoundsLayer(SurfaceControl.Transaction t) {
    ...
    if (this.mAttachInfo.mDisplayState == 1) {
      ...
      Log.m98i(
          this.mTag,
          "updateBoundsLayer: set mDeferTransactionRequested=" + this.mDeferTransactionRequested);
    }
    WindowConfiguration winConfig =
        this.mContext.getResources().getConfiguration().windowConfiguration;
  ...
  public boolean getChildLocalHitRegion(View child, Region region, Matrix matrix, boolean isHover) {
    if (child != this.mView) {
      throw new IllegalArgumentException(
          "child "
              + child
              + " is not the root view "
              + this.mView
              + " managed by this ViewRootImpl");
    }
  ...
  void scheduleTraversals() {
    if (DEBUG_TRAVERSAL
      ...
      Log.m98i(
          this.mTag,
          "Traversal, scheduleTraversals! mView=" + this.mView + " callers=" + Debug.getCallers(7));
    }
  ...
  private void applyKeepScreenOnFlag(WindowManager.LayoutParams params) {
    if (this.mAttachInfo.mKeepScreenOn) {
      ...
      params.flags =
          (params.flags & PackageManager.INSTALL_FAILED_PRE_APPROVAL_NOT_AVAILABLE)
              | (this.mClientWindowLayoutFlags & 128);
    }
  }
  ...
  private boolean collectViewAttributes() {
    if (this.mAttachInfo.mRecomputeGlobalAttributes) {
      ...
      systemUiVisibilityInfo.globalVisibility =
          (systemUiVisibilityInfo.globalVisibility & (-2))
              | (this.mAttachInfo.mSystemUiVisibility & 1);
      dispatchDispatchSystemUiVisibilityChanged();
      if (this.mAttachInfo.mKeepScreenOn != oldScreenOn
          || this.mAttachInfo.mSystemUiVisibility != params.subtreeSystemUiVisibility
          || this.mAttachInfo.mHasSystemUiListeners != params.hasSystemUiListeners) {
  ...
  void updateCompatSysUiVisibility(
      int visibleTypes, int requestedVisibleTypes, int controllableTypes) {
    int visibleTypes2 =
        (requestedVisibleTypes & controllableTypes) | ((~controllableTypes) & visibleTypes);
    updateCompatSystemUiVisibilityInfo(
        4, WindowInsets.Type.statusBars(), visibleTypes2, controllableTypes);
    updateCompatSystemUiVisibilityInfo(
        2, WindowInsets.Type.navigationBars(), visibleTypes2, controllableTypes);
    dispatchDispatchSystemUiVisibilityChanged();
  }

  private void updateCompatSystemUiVisibilityInfo(
      int systemUiFlag, int insetsType, int visibleTypes, int controllableTypes) {
  ...
  private void controlInsetsForCompatibility(WindowManager.LayoutParams params) {
    ...
    boolean statusWasHiddenByFlags =
        (this.mTypesHiddenByFlags & WindowInsets.Type.statusBars()) != 0;
    boolean statusIsHiddenByFlags =
        (sysUiVis & 4) != 0 || ((flags & 1024) != 0 && matchParent && nonAttachedAppWindow);
    boolean navWasHiddenByFlags =
        (this.mTypesHiddenByFlags & WindowInsets.Type.navigationBars()) != 0;
  ...
  */
    ...
    if (lp.width != -2) {
      ...
      if (this.mTmpValue.type == 5) {
        ...
        if (this.mDesktopMode && lp.type == 2005 && this.mView != null) {
          ...
          baseSize =
              (int)
                  this.mTmpValue.getFraction(
                      packageMetrics.widthPixels, packageMetrics.widthPixels);
        }
      }
      ...
      if (baseSize == 0 || desiredWindowWidth <= baseSize) {
        ...
        int childHeightMeasureSpec =
            getRootMeasureSpec(desiredWindowHeight, lp.height, lp.privateFlags);
        ...
        if (z) {
          ...
          Log.m100v(
              ...
              "Window "
                  ...
                  + ") from width spec: "
                  + View.MeasureSpec.toString(childWidthMeasureSpec)
                  + " and height spec: "
                  + View.MeasureSpec.toString(childHeightMeasureSpec));
        } else {
          windowSizeMayChange = false;
          goodMeasure = false;
        }
        if ((host.getMeasuredWidthAndState() & 16777216) == 0) {
          ...
          performMeasure(
              getRootMeasureSpec(baseSize2, lp.width, lp.privateFlags), childHeightMeasureSpec);
          if (z) {
            Log.m100v(
                this.mTag,
                "Window "
        ...
        if (!goodMeasure2) {
          int childWidthMeasureSpec2 =
              getRootMeasureSpec(desiredWindowWidth, lp.width, lp.privateFlags);
          int childHeightMeasureSpec2 =
              getRootMeasureSpec(desiredWindowHeight, lp.height, lp.privateFlags);
          if (forRootSizeOnly
              && setMeasuredRootSizeFromSpec(childWidthMeasureSpec2, childHeightMeasureSpec2)) {
  ...
  WindowInsets getWindowInsets(boolean forceConstruct, boolean removeCutout) {
    if (this.mLastWindowInsets == null || forceConstruct) {
      ...
      WindowInsets calculateInsets =
          this.mInsetsController.calculateInsets(
              config.isScreenRound(),
              this.mWindowAttributes.type,
              config.windowConfiguration.getActivityType(),
              this.mWindowAttributes.softInputMode,
              this.mWindowAttributes.flags,
              this.mWindowAttributes.systemUiVisibility
                  | this.mWindowAttributes.subtreeSystemUiVisibility);
      ...
      if (this.mIsCutoutRemoveNeeded || removeCutout) {
        ...
        if (this.mIsCutoutRemoveNeeded) {
          ...
          this.mAttachInfo.mVisibleInsets.set(
  ...
  public void dispatchApplyInsets(View host) {
    ...
    if (imeSource != null
        && imeSource.isVisible()
        && getConfiguration().windowConfiguration.isPopOver()) {
      this.mForceNextWindowRelayout = true;
    }
    host.dispatchApplyWindowInsets(insets);
    this.mAttachInfo.delayNotifyContentCaptureInsetsEvent(
        insets.getInsets(WindowInsets.Type.all()));
    Trace.traceEnd(8L);
  }
  ...
  private boolean updateCaptionInsets() {
    ...
    if (captionInsetsHeight != 0) {
      captionFrame.set(
          this.mWinFrame.left,
          this.mWinFrame.top,
          this.mWinFrame.right,
          this.mWinFrame.top + captionInsetsHeight);
    }
  ...
  private boolean shouldDispatchCutout() {
    return this.mWindowAttributes.layoutInDisplayCutoutMode == 3
        || this.mWindowAttributes.layoutInDisplayCutoutMode == 1;
  }
  ...
  private Rect getWindowBoundsInsetSystemBars() {
    Rect bounds =
        new Rect(this.mContext.getResources().getConfiguration().windowConfiguration.getBounds());
    bounds.inset(
        this.mInsetsController
            .getState()
            .calculateInsets(
                bounds, WindowInsets.Type.systemBars() | WindowInsets.Type.displayCutout(), false));
    return bounds;
  }
  ...
  */
  private void performTraversals() {
      ...
      if (Trace.isTagEnabled(8L)) {
        Trace.instant(
            ...
            TextUtils.formatSimple(
                "performTraversals#mNumPausedForSync=%d", Integer.valueOf(this.mNumPausedForSync)));
      }
      if (DEBUG_BLAST) {
    ...
    boolean viewVisibilityChanged =
        !z6
            && (this.mViewVisibility != viewVisibility3
                || this.mNewSurfaceNeeded
                || this.mAppVisibilityChanged);
    ...
    if (!z6) {
      if ((this.mViewVisibility == 0) != (viewVisibility3 == 0)) {
        ...
        if (layoutRequested) {
          ...
          windowSizeMayChange =
              measureHierarchy(
                      ...
                      desiredWindowHeight3,
                      desiredWindowHeight2,
                      shouldOptimizeMeasure)
                  | windowSizeMayChange2;
        }
        ...
        if (layoutRequested || !windowSizeMayChange) {
          ...
          boolean windowShouldResize2 =
              windowShouldResize
                  | ((this.mDragResizing || !this.mPendingDragResizing) ? cancelDraw2 : true);
          computesInternalInsets =
              (!this.mAttachInfo.mTreeObserver.hasComputeInternalInsetsListeners()
                      || this.mAttachInfo.mHasNonEmptyGivenInternalInsets)
                  ? true
                  : cancelDraw2;
          ...
          if (!updatedConfiguration2
            ...
            if (this.mViewMeasureDeferred) {
              performMeasure(
                  View.MeasureSpec.makeMeasureSpec(frame2.width(), 1073741824),
                  View.MeasureSpec.makeMeasureSpec(frame2.height(), 1073741824));
            }
            ...
            if (!surfaceSizeChanged
                ...
                || surfaceCreated
                || insetsPending
                || this.mChildBoundingInsetsChanged
                || this.mForceUpdateBoundsLayer) {
              prepareSurfaces();
              this.mChildBoundingInsetsChanged = false;
              this.mForceUpdateBoundsLayer = false;
              this.mFullRedrawNeeded = true;
            ...
            if (didLayout) {
              ...
              if ((host.mPrivateFlags & 512) != 0) {
                ...
                region2.set(
                    i5,
                    iArr[1],
                    (host.mRight + i5) - host.mLeft,
                    (this.mTmpLocation[1] + host.mBottom) - host.mTop);
                host.gatherTransparentRegion(this.mTransparentRegion);
                if (this.mWindowAttributes.surfaceInsets.left > 0
                    || this.mWindowAttributes.surfaceInsets.top > 0) {
                  this.mTransparentRegion.translate(
                      this.mWindowAttributes.surfaceInsets.left,
                      this.mWindowAttributes.surfaceInsets.top);
                }
                CompatibilityInfo.Translator translator = this.mTranslator;
            ...
            if (computesInternalInsets) {
              ...
              if (insetsPending2 || !this.mLastGivenInsets.equals(insets)) {
                ...
                if (translator2 != null) {
                  Rect contentInsets2 =
                      translator2.getTranslatedContentInsets(insets.contentInsets);
                  CompatibilityInfo.Translator translator3 = this.mTranslator;
                  Rect contentInsets3 = insets.visibleInsets;
                  visibleInsets = translator3.getTranslatedVisibleInsets(contentInsets3);
                  touchableRegion =
                      this.mTranslator.getTranslatedTouchableArea(insets.touchableRegion);
            ...
            if (computedInternalInsets
                || (Objects.equals(this.mPreviousTouchableRegion, this.mTouchableRegion)
              ...
              if (this.mTouchableRegion != null) {
                ...
                if (touchableInsetMode != 3) {
                  Log.m96e(
                      this.mTag,
                      "Setting touchableInsetMode to non TOUCHABLE_INSETS_REGION from"
                          + " OnComputeInternalInsets, while also using setTouchableRegion causes"
                          + " setTouchableRegion to be ignored");
                }
              } else {
            ...
            if (this.mFirst) {
              if (!sAlwaysAssignFocus && isInTouchMode()) {
                ...
                if ((focused instanceof ViewGroup)
                    && ((ViewGroup) focused).getDescendantFocusability() == 262144) {
            ...
            if (!viewVisibilityChanged || this.mFirst) {
              ...
              if (isViewVisible) {
                ...
                boolean cancelDueToPreDrawListener =
                    this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
                cancelAndRedraw =
                    !cancelDueToPreDrawListener || (cancelDraw3 && this.mDrewOnceForSync);
                if (!cancelAndRedraw) {
                ...
                if (isCancelDraw
                    ...
                    && (CoreRune.SAFE_DEBUG
                        ...
                        || CoreRune.IS_DEBUG_LEVEL_HIGH)) {
                  Log.m98i(
                      this.mTag,
                      "cancelAndRedraw "
                          + this.mAttachInfo.mTreeObserver.mLog
                          + " isViewVisible: "
                          + isViewVisible);
                }
                isCancelDraw2 = DEBUG_TRAVERSAL;
                if (isCancelDraw2
                    && DEBUG_TRAVERSAL_PACKAGE_NAME.equals(
                        this.mView.getContext().getPackageName())) {
                  Log.m98i(
                      this.mTag,
                      "Traversal, [11] mView="
                          + this.mView
                ...
                if (isViewVisible) {
                  ...
                  this.mLastPerformTraversalsSkipDrawReason =
                      cancelDueToPreDrawListener
                          ? "predraw_"
                              + this.mAttachInfo.mTreeObserver
                                  .getLastDispatchOnPreDrawCanceledReason()
                  ...
                  if (!performDraw(this.mActiveSurfaceSyncGroup)
                      && (surfaceSyncGroup = this.mActiveSurfaceSyncGroup) != null) {
            ...
            if ((childWidthMeasureSpec & 1) != 0) {}
            this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
            boolean cancelDueToPreDrawListener2 =
                this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
            ...
            if (isCancelDraw2) {
              Log.m98i(
                  this.mTag,
                  "Traversal, [11] mView=" + this.mView + " cancelAndRedraw=" + cancelAndRedraw);
            }
            if (isViewVisible) {}
            if (this.mAttachInfo.mContentCaptureEvents != null) {}
            this.mIsInTraversal = false;
          ...
          if (Trace.isTagEnabled(8L)) {
            ...
            Trace.traceBegin(
                8L,
                TextUtils.formatSimple(
                    "relayoutWindow#first=%b/resize=%b/vis=%b/params=%b/force=%b", objArr));
          }
            ...
            try {
              ...
              try {
                try {
                  ...
                  if (this.mStopped) {}
                  int childWidthMeasureSpec3 =
                      getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
                  int childHeightMeasureSpec3 =
                      getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
                  z3 = DEBUG_LAYOUT;
                  if (!z3) {}
                  ...
                  if ((childWidthMeasureSpec & 1) != 0) {}
                  this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
                  boolean cancelDueToPreDrawListener22 =
                      this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
          ...
          if (i2 > this.mLastSyncSeqId) {
            try {
              ...
              if (threadedRenderer != null) {}
              if (this.mStopped) {}
              int childWidthMeasureSpec32 =
                  getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
              int childHeightMeasureSpec32 =
                  getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
              z3 = DEBUG_LAYOUT;
              if (!z3) {}
              ...
              if ((childWidthMeasureSpec & 1) != 0) {}
              this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
              boolean cancelDueToPreDrawListener222 =
                  this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
          ...
          if (this.mSurfaceControl.isValid()) {
            try {
              ...
              if (surfaceControlChanged && this.mWindowAttributes.type == 2000) {
                ...
                try {
                  this.mTransaction
                      .setDefaultFrameRateCompatibility(this.mSurfaceControl, 101)
                      .apply();
                  ...
                  if (threadedRenderer != null) {}
                  if (this.mStopped) {}
                  int childWidthMeasureSpec322 =
                      getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
                  int childHeightMeasureSpec322 =
                      getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
                  z3 = DEBUG_LAYOUT;
                  if (!z3) {}
                  ...
                  if ((childWidthMeasureSpec & 1) != 0) {}
                  this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
                  boolean cancelDueToPreDrawListener2222 =
                      this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
              ...
              if (threadedRenderer != null) {}
              if (this.mStopped) {}
              int childWidthMeasureSpec3222 =
                  getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
              int childHeightMeasureSpec3222 =
                  getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
              z3 = DEBUG_LAYOUT;
              if (!z3) {}
              ...
              if ((childWidthMeasureSpec & 1) != 0) {}
              this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
              boolean cancelDueToPreDrawListener22222 =
                  this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
          ...
          if (z4) {
            Log.m100v(
                this.mTag,
                "relayout: frame=" + frame2.toShortString() + " surface=" + this.mSurface);
          }
          if (this.mRelayoutRequested
              && !this.mPendingMergedConfiguration.equals(this.mLastReportedMergedConfiguration)) {
            if (DEBUG_CONFIGURATION) {
              Log.m100v(
                  this.mTag,
                  "Visible with new config: "
                      + this.mPendingMergedConfiguration.getMergedConfiguration());
            }
            performConfigurationChange(
                new MergedConfiguration(this.mPendingMergedConfiguration), this.mFirst, -1);
          ...
          if (this.mLastSurfaceSize.equals(this.mSurfaceSize)) {
            ...
            try {
              ...
              try {
                ...
                if (threadedRenderer != null) {}
                if (this.mStopped) {}
                int childWidthMeasureSpec32222 =
                    getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
                int childHeightMeasureSpec32222 =
                    getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
                z3 = DEBUG_LAYOUT;
                if (!z3) {}
                ...
                if ((childWidthMeasureSpec & 1) != 0) {}
                this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
                boolean cancelDueToPreDrawListener222222 =
                    this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
              ...
              if (threadedRenderer != null) {}
              if (this.mStopped) {}
              int childWidthMeasureSpec322222 =
                  getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
              int childHeightMeasureSpec322222 =
                  getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
              z3 = DEBUG_LAYOUT;
              if (!z3) {}
              ...
              if ((childWidthMeasureSpec & 1) != 0) {}
              this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
              boolean cancelDueToPreDrawListener2222222 =
                  this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
            ...
            if (this.mSurface.isValid()) {
              ...
              if (dispatchApplyInsets) {
                ...
                try {
                  ...
                  if (threadedRenderer != null) {}
                  if (this.mStopped) {}
                  int childWidthMeasureSpec3222222 =
                      getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
                  int childHeightMeasureSpec3222222 =
                      getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
                  z3 = DEBUG_LAYOUT;
                  if (!z3) {}
                  ...
                  if ((childWidthMeasureSpec & 1) != 0) {}
                  this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
                  boolean cancelDueToPreDrawListener22222222 =
                      this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
              ...
              if (surfaceCreated) {
                ...
                try {
                      ...
                      if (this.mSurface.isValid()) {
                        ...
                        try {
                          ...
                          try {
                            objArr2[0] =
                                "isValid="
                                    + this.mSurface.isValid()
                                    + " 0x"
                                    + Long.toHexString(this.mSurface.mNativeObject);
                            Log.m94d(
                                str,
                                String.format(
                                    "mThreadedRenderer.updateSurface() mSurface={%s}", objArr2));
                  ...
                  if (threadedRenderer != null) {}
                  if (this.mStopped) {}
                  int childWidthMeasureSpec32222222 =
                      getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
                  int childHeightMeasureSpec32222222 =
                      getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
                  z3 = DEBUG_LAYOUT;
                  if (!z3) {}
                  ...
                  if ((childWidthMeasureSpec & 1) != 0) {}
                  this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
                  boolean cancelDueToPreDrawListener222222222 =
                      this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
                ...
                if (this.mAttachInfo.mThreadedRenderer != null) {
                  try {
                            ...
                            try {
                              try {
                                Log.m94d(
                                    this.mTag,
                                    String.format(
                                        "mThreadedRenderer.initialize() mSurface={%s}"
                                            + " hwInitialized="
                                            + hwInitialized3,
                                        "isValid="
                                            + this.mSurface.isValid()
                                ...
                                if (this.mDragResizing != dragResizing) {
                                  if (dragResizing) {
                                    boolean backdropSizeMatchesFrame =
                                        this.mWinFrame.width() == this.mPendingBackDropFrame.width()
                                            && this.mWinFrame.height()
                                                == this.mPendingBackDropFrame.height();
                                    startDragResizing(
                                        this.mPendingBackDropFrame,
                                        !backdropSizeMatchesFrame,
                                        this.mAttachInfo.mContentInsets,
                                        this.mAttachInfo.mStableInsets);
                                  } else {
                                    endDragResizing();
                                  }
                                ...
                                try {
                                  ...
                                  if (threadedRenderer != null) {}
                                  if (this.mStopped) {}
                                  int childWidthMeasureSpec322222222 =
                                      getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
                                  int childHeightMeasureSpec322222222 =
                                      getRootMeasureSpec(
                                          this.mHeight, lp4.height, lp4.privateFlags);
                                  z3 = DEBUG_LAYOUT;
                                  if (!z3) {}
                                  performMeasure(
                                      childWidthMeasureSpec322222222,
                                      childHeightMeasureSpec322222222);
                                  ...
                                  if (computedInternalInsets
                                      | (Objects.equals(
                                              this.mPreviousTouchableRegion, this.mTouchableRegion)
                                          && this.mTouchableRegion != null)) {}
                                  if (this.mFirst) {}
                                  if (viewVisibilityChanged) {}
                                  isViewVisible = isViewVisible2;
                                  ...
                                  this.mViewVisibility = viewVisibility2;
                                  if (this.mAttachInfo.mHasWindowFocus) {}
                                  this.mImeFocusController.onTraversal(
                                      hasWindowFocus, this.mWindowAttributes);
                                  if ((childWidthMeasureSpec & 1) != 0) {}
                                  this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
                                  boolean cancelDueToPreDrawListener2222222222 =
                                      this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
                              ...
                              if (threadedRenderer != null) {}
                              if (this.mStopped) {}
                              int childWidthMeasureSpec3222222222 =
                                  getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
                              int childHeightMeasureSpec3222222222 =
                                  getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
                              z3 = DEBUG_LAYOUT;
                              if (!z3) {}
                              performMeasure(
                                  childWidthMeasureSpec3222222222,
                                  childHeightMeasureSpec3222222222);
                              ...
                              if ((childWidthMeasureSpec & 1) != 0) {}
                              this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
                              boolean cancelDueToPreDrawListener22222222222 =
                                  this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
                    ...
                    if (DEBUG_ORIENTATION) {
                      Log.m100v(
                          TAG, "Relayout returned: frame=" + frame2 + ", surface=" + this.mSurface);
                    }
                    this.mAttachInfo.mWindowLeft = frame2.left;
                    this.mAttachInfo.mWindowTop = frame2.top;
                    ...
                    if (this.mSurfaceHolder == null) {
                      ...
                      if (!surfaceCreated
                        ...
                        Log.m98i(
                            this.mTag,
                            String.format(
                                "ViewRootImpl >> surfaceChanged W=%d, H=%d)",
                        ...
                        if (callbacks2 != null) {
                          ...
                          for (int length = callbacks2.length; i8 < length; length = length) {
                            ...
                            c2.surfaceChanged(
                                baseSurfaceHolder2, i9, relayoutResult7, this.mHeight);
                            i8++;
                    ...
                    threadedRenderer = this.mAttachInfo.mThreadedRenderer;
                    if (threadedRenderer != null
                        && threadedRenderer.isEnabled()
                        && (hwInitialized4
                            || this.mWidth != threadedRenderer.getWidth()
                            || this.mHeight != threadedRenderer.getHeight()
                            || this.mNeedsRendererSetup)) {
                      if (CoreRune.MW_CAPTION_SHELL_BUG_FIX
                          || !(this.mWindowSession instanceof WindowlessWindowManager)) {
                        threadedRenderer.setup(
                            this.mWidth,
                            this.mHeight,
                            this.mAttachInfo,
                            this.mWindowAttributes.surfaceInsets);
                      } else {
                        threadedRenderer.setup(
                            this.mWidth,
                            this.mHeight,
                            this.mAttachInfo,
                            this.mWindowAttributes.surfaceInsets,
                            this.mLastReportedMergedConfiguration
                    ...
                    if ((this.mStopped || this.mReportNextDraw)
                        && (this.mWidth != host.getMeasuredWidth()
                            || this.mHeight != host.getMeasuredHeight()
                            || dispatchApplyInsets
                            || updatedConfiguration)) {
                      int childWidthMeasureSpec32222222222 =
                          getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
                      int childHeightMeasureSpec32222222222 =
                          getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
                      z3 = DEBUG_LAYOUT;
                      if (!z3) {
                        Log.m100v(
                      ...
                      performMeasure(
                          childWidthMeasureSpec32222222222, childHeightMeasureSpec32222222222);
                      ...
                      if (lp4.horizontalWeight <= 0.0f) {
                        ...
                        width2222222222 +=
                            (int) ((this.mWidth - width2222222222) * lp4.horizontalWeight);
                        int childWidthMeasureSpec4 =
                            View.MeasureSpec.makeMeasureSpec(width2222222222, 1073741824);
                        measureAgain = true;
                      ...
                      if (lp4.verticalWeight <= 0.0f) {
                        height2222222222 +=
                            (int) ((this.mHeight - height2222222222) * lp4.verticalWeight);
                        measureAgain = true;
                        childHeightMeasureSpec2 =
                            View.MeasureSpec.makeMeasureSpec(height2222222222, 1073741824);
                      } else {
                    ...
                    if ((childWidthMeasureSpec & 1) != 0) {}
                    this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
                    boolean cancelDueToPreDrawListener222222222222 =
                        this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
              ...
              if (this.mStopped) {}
              int childWidthMeasureSpec322222222222 =
                  getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
              int childHeightMeasureSpec322222222222 =
                  getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
              z3 = DEBUG_LAYOUT;
              if (!z3) {}
              ...
              if ((childWidthMeasureSpec & 1) != 0) {}
              this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
              boolean cancelDueToPreDrawListener2222222222222 =
                  this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
          ...
          if (threadedRenderer != null) {}
          if (this.mStopped) {}
          int childWidthMeasureSpec3222222222222 =
              getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
          int childHeightMeasureSpec3222222222222 =
              getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
          z3 = DEBUG_LAYOUT;
          if (!z3) {}
          ...
          if ((childWidthMeasureSpec & 1) != 0) {}
          this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
          boolean cancelDueToPreDrawListener22222222222222 =
              this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
        ...
        if (threadedRenderer != null) {}
        if (this.mStopped) {}
        int childWidthMeasureSpec32222222222222 =
            getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
        int childHeightMeasureSpec32222222222222 =
            getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
        z3 = DEBUG_LAYOUT;
        if (!z3) {}
        ...
        if ((childWidthMeasureSpec & 1) != 0) {}
        this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
        boolean cancelDueToPreDrawListener222222222222222 =
            this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
    ...
    if (threadedRenderer != null) {}
    if (this.mStopped) {}
    int childWidthMeasureSpec322222222222222 =
        getRootMeasureSpec(this.mWidth, lp4.width, lp4.privateFlags);
    int childHeightMeasureSpec322222222222222 =
        getRootMeasureSpec(this.mHeight, lp4.height, lp4.privateFlags);
    z3 = DEBUG_LAYOUT;
    if (!z3) {}
    ...
    if ((childWidthMeasureSpec & 1) != 0) {}
    this.mCheckIfCanDraw = !isSyncRequest || cancelDraw3;
    boolean cancelDueToPreDrawListener2222222222222222 =
        this.mAttachInfo.mTreeObserver.dispatchOnPreDraw();
  ...
  private void createSyncIfNeeded() {
    ...
    this.mWmsRequestSyncGroup =
        new SurfaceSyncGroup(
            "wmsSync-" + this.mTag,
            new Consumer() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda17
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                ViewRootImpl.this.lambda$createSyncIfNeeded$3(
                    seqId, (SurfaceControl.Transaction) obj);
              }
            });
    if (DEBUG_BLAST) {
      ...
      try {
        if (CoreRune.FW_CCM_BUG_FIX) {
          ContentCaptureManager contentCaptureManager =
              this.mAttachInfo.getContentCaptureManager(this.mContext);
            ...
            if (event instanceof AutofillId) {
              ...
              if (session == null) {
                ...
                if (actualId != sessionId) {
                  Log.m102w(
                      this.mTag,
                      "content capture session mismatch for view ("
                          + view
                          + "): was "
                          + sessionId
                          + " before, it's "
  ...
  public void maybeHandleWindowMove(Rect frame) {
    boolean windowMoved =
        (this.mAttachInfo.mWindowLeft == frame.left && this.mAttachInfo.mWindowTop == frame.top)
            ? false
            : true;
    if (windowMoved) {
    ...
    synchronized (this) {
      if (this.mWindowFocusChanged) {
        ...
        if (this.mAdded) {
          Log.m98i(
              ...
              "handleWindowFocusChanged: "
                  + (this.mUpcomingWindowFocus ? "1 " : "0 ")
                  + (this.mUpcomingInTouchMode ? "1" : "0")
                  + " call from "
                  + Debug.getCaller());
        }
        if (hasWindowFocus) {
        ...
        if (this.mAdded) {
          ...
          this.mImeFocusController.onPostWindowFocus(
              getFocusedViewOrNull(), hasWindowFocus, this.mWindowAttributes);
          if (hasWindowFocus) {
        ...
        if (CoreRune.BIXBY_TOUCH && hasWindowFocus && this.mSemPressGestureDetector != null) {
          if (Settings.System.getInt(this.mContext.getContentResolver(), "bixby_touch_enable", 0)
              == 1) {
  ...
  public void dispatchCompatFakeFocus() {
    ...
    EventLog.writeEvent(
        LOGTAG_INPUT_FOCUS,
        "Giving fake focus to " + this.mBasePackageName,
        "reason=unity bug workaround");
    dispatchFocusEvent(true, true);
    EventLog.writeEvent(
        LOGTAG_INPUT_FOCUS,
        "Removing fake focus from " + this.mBasePackageName,
  ...
  private void dispatchFocusEvent(boolean hasWindowFocus, boolean fakeFocus) {
    ...
    if (hasWindowFocus && this.mAttachInfo.mThreadedRenderer != null && this.mSurface.isValid()) {
      ...
      try {
        ...
        this.mAttachInfo.mThreadedRenderer.initializeIfNeeded(
            this.mWidth, this.mHeight, this.mAttachInfo, this.mSurface, surfaceInsets);
        Log.m94d(
            this.mTag,
            String.format(
                "mThreadedRenderer.initializeIfNeeded()#2 mSurface={%s}",
                "isValid="
                    + this.mSurface.isValid()
                    + " 0x"
                    + Long.toHexString(this.mSurface.mNativeObject)));
  ...
  private void fireAccessibilityFocusEventIfHasFocusedNode() {
    ...
    if (!AccessibilityManager.getInstance(this.mContext).isEnabled()
        || (focusedView = this.mView.findFocus()) == null) {
      return;
    }
  ...
  private void performLayout(
      WindowManager.LayoutParams lp, int desiredWindowWidth, int desiredWindowHeight) {
    ...
    try {
      ...
      if (numViewsRequestingLayout > 0
          && (validLayoutRequesters = getValidLayoutRequesters(this.mLayoutRequesters, false))
              != null) {
        ...
        host.layout(0, 0, host.getMeasuredWidth(), host.getMeasuredHeight());
        this.mHandlingLayoutInLayoutRequest = false;
        final ArrayList<View> validLayoutRequesters2 =
            getValidLayoutRequesters(this.mLayoutRequesters, true);
        if (validLayoutRequesters2 != null) {
          getRunQueue()
              .post(
                  new Runnable() { // from class: android.view.ViewRootImpl.4
                    @Override // java.lang.Runnable
                    public void run() {
  ...
  private ArrayList<View> getValidLayoutRequesters(
    ...
    for (int i = 0; i < numViewsRequestingLayout; i++) {
      ...
      if (view != null
          ...
          && view.mParent != null
          && (secondLayoutRequests || (view.mPrivateFlags & 4096) == 4096)) {
        boolean gone = false;
        View parent = view;
        while (true) {
          if (parent == null) {
  ...
  public void onPreDraw(RecordingCanvas canvas) {
    if (this.mCurScrollY != 0
        && this.mHardwareYOffset != 0
        && this.mAttachInfo.mThreadedRenderer.isOpaque()) {
    ...
    if (this.mProfileRendering) {
      ...
      if (this.mRenderProfilingEnabled) {
        if (this.mRenderProfiler == null) {
          this.mRenderProfiler =
              new Choreographer.FrameCallback() { // from class: android.view.ViewRootImpl.5
                @Override // android.view.Choreographer.FrameCallback
                public void doFrame(long frameTimeNanos) {
                  ViewRootImpl.this.mDirty.set(
                      0, 0, ViewRootImpl.this.mWidth, ViewRootImpl.this.mHeight);
                  if (ViewRootImpl.DEBUG_TRAVERSAL
                      && ViewRootImpl.DEBUG_TRAVERSAL_PACKAGE_NAME.equals(
                          ViewRootImpl.this.mView.getContext().getPackageName())) {
                    Log.m98i(
                        ViewRootImpl.this.mTag, "Traversal, [12] mView=" + ViewRootImpl.this.mView);
                  }
                  ViewRootImpl.this.scheduleTraversals();
                  if (ViewRootImpl.this.mRenderProfilingEnabled) {
                    ViewRootImpl.this.mChoreographer.postFrameCallback(
                        ViewRootImpl.this.mRenderProfiler);
                  }
                }
              };
        }
  ...
  public boolean isHardwareEnabled() {
    return this.mAttachInfo.mThreadedRenderer != null
        && this.mAttachInfo.mThreadedRenderer.isEnabled();
  }
  ...
  private void addFrameCommitCallbackIfNeeded() {
    ...
    final ArrayList<Runnable> commitCallbacks =
        this.mAttachInfo.mTreeObserver.captureFrameCommitCallbacks();
    boolean needFrameCommitCallback = commitCallbacks != null && commitCallbacks.size() > 0;
    if (!needFrameCommitCallback) {
      return;
    }
    Log.m94d(
        this.mTag, "Creating frameCommitCallback commitCallbacks size=" + commitCallbacks.size());
    this.mAttachInfo.mThreadedRenderer.setFrameCommitCallback(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$addFrameCommitCallbackIfNeeded$5(
    ...
    this.mHandler.postAtFrontOfQueue(
        new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
      ...
      switch (this.mAttachInfo.mDisplayState) {
        case 1:
          if (this.mDeferTransactionRequested) {
            this.mDeferTransactionRequested = false;
            Log.m98i(
                this.mTag, "performDraw() SCREEN_OFF but mDeferTransactionRequested = true break");
            break;
          } else {
        ...
        case 4:
          if (this.mDisplay.getDisplayId() == 0
              && (this.mWindowAttributes.samsungFlags & 262144) == 0
              && Settings.System.getInt(this.mContentResolver, AOD_SHOW_STATE, 0) != 0) {
            Log.m98i(
                this.mTag,
                "performDraw() was skipped by AOD_SHOW_STATE... DisplayState = "
                    + this.mAttachInfo.mDisplayState);
            return false;
          }
          break;
      }
  ...
  private boolean isContentCaptureReallyEnabled() {
    ...
    return (this.mContext.getContentCaptureOptions() == null
            || (ccm = this.mAttachInfo.getContentCaptureManager(this.mContext)) == null
            || !ccm.isContentCaptureEnabled())
        ? false
        : true;
  }
    ...
    try {
      ...
      if (this.mAttachInfo.mContentCaptureManager != null) {
        MainContentCaptureSession session =
            this.mAttachInfo.mContentCaptureManager.getMainContentCaptureSession();
        session.notifyWindowBoundsChanged(
            session.getId(), getConfiguration().windowConfiguration.getBounds());
      }
  ...
  */
  private boolean draw(
      boolean fullRedrawNeeded, SurfaceSyncGroup activeSyncGroup, boolean syncBuffer) {
    int curScrollY;
    ...
    if (fullRedrawNeeded2) {
      dirty.set(
          0, 0, (int) ((this.mWidth * appScale) + 0.5f), (int) ((this.mHeight * appScale) + 0.5f));
    }
    if (DEBUG_ORIENTATION || DEBUG_DRAW) {
      Log.m100v(
          ...
          "Draw "
              + this.mView
              + "/"
              + ((Object) this.mWindowAttributes.getTitle())
              + ": dirty={"
              + dirty.left
              + ","
              + dirty.top
        ...
        if (z && DEBUG_TRAVERSAL_PACKAGE_NAME.equals(this.mView.getContext().getPackageName())) {
          Log.m98i(
              ...
              "Traversal, [13] mView="
                  ...
                  + accessibilityFocusDirty2
                  + " mForceDraw="
                  + this.mForceDraw
                  + " mUpdateHdrSdrRatioInfo="
                  + this.mUpdateHdrSdrRatioInfo);
        }
          ...
          if (!isHardwareEnabled()) {
            ...
            if (this.mUpdateHdrSdrRatioInfo) {
              ...
              applyTransactionOnDraw(
                  this.mTransaction.setExtendedRangeBrightness(
                      getSurfaceControl(), this.mRenderHdrSdrRatio, this.mDesiredHdrSdrRatio));
            ...
            if (this.mAttachInfo.mThreadedRenderer != null
                && !this.mAttachInfo.mThreadedRenderer.isEnabled()
                && this.mAttachInfo.mThreadedRenderer.isRequested()
                && this.mSurface.isValid()) {
              if (z
                  && DEBUG_TRAVERSAL_PACKAGE_NAME.equals(
                      this.mView.getContext().getPackageName())) {
                Log.m98i(
                    this.mTag,
                    "Traversal, [13-1] mView="
                        + this.mView
                        + " isImpossibleRenderer="
                        + isImpossibleRenderer());
              }
                ...
                try {
                  ...
                  if (ViewRune.COMMON_IS_PRODUCT_DEV) {
                    Log.m94d(
                        this.mTag,
                        String.format(
                            "mThreadedRenderer.initializeIfNeeded()#1 mSurface={%s}",
                            "isValid="
                                + this.mSurface.isValid()
                                + " 0x"
                                + Long.toHexString(this.mSurface.mNativeObject)));
              ...
              Log.m96e(
                  this.mTag,
                  "isImpossibleRenderer() Blocked ThreadedRenderer.initializeIfNeeded()");
              this.mFullRedrawNeeded = true;
              scheduleTraversals();
              return false;
            }
  ...
  private boolean getAccessibilityFocusedRect(Rect bounds) {
    ...
    if (!manager.isEnabled()
        ...
        || (host = this.mAccessibilityFocusedHost) == null
        || host.mAttachInfo == null) {
      return false;
    }
    ...
    if (!bounds.intersect(
        0, 0, attachInfo.mViewRootImpl.mWidth, attachInfo.mViewRootImpl.mHeight)) {
      bounds.setEmpty();
    }
  ...
  private Drawable getAccessibilityFocusedDrawable() {
    if (this.mAttachInfo.mAccessibilityFocusDrawable == null) {
      ...
      boolean resolved =
          this.mView
              .mContext
              .getTheme()
              .resolveAttribute(C4337R.attr.accessibilityFocusedDrawable, value, true);
      if (resolved) {
        this.mAttachInfo.mAccessibilityFocusDrawable =
            this.mView.mContext.getDrawable(value.resourceId);
      }
    }
    if (this.mAttachInfo.mAccessibilityFocusDrawable instanceof GradientDrawable) {
      ...
      drawable.setStroke(
          this.mAccessibilityManager.semGetAccessibilityFocusStrokeWidth(this.mContext),
          this.mAccessibilityManager.getAccessibilityFocusColor());
    }
  ...
  void systemGestureExclusionChanged() {
    ...
    if (rectsForWindowManager != null && this.mView != null) {
      try {
        this.mWindowSession.reportSystemGestureExclusionChanged(
            this.mWindow, rectsForWindowManager);
        this.mAttachInfo.mTreeObserver.dispatchOnSystemGestureExclusionRectsChanged(
            rectsForWindowManager);
      } catch (RemoteException e) {
  ...
  private void updateKeepClearForAccessibilityFocusRect() {
    if (this.mViewConfiguration.isPreferKeepClearForFocusEnabled()) {
      ...
      boolean hasAccessibilityFocus =
          getAccessibilityFocusedRect(this.mKeepClearAccessibilityFocusRect);
  ...
  void keepClearRectsChanged(boolean accessibilityFocusRectChanged) {
    ...
    boolean unrestrictedKeepClearRectsChanged =
        this.mUnrestrictedKeepClearRectsTracker.computeChanges();
    if ((restrictedKeepClearRectsChanged
            || unrestrictedKeepClearRectsChanged
            || accessibilityFocusRectChanged)
        && this.mView != null) {
  ...
  void reportKeepClearAreasChanged() {
    ...
    List<Rect> unrestrictedKeepClearRects =
        this.mUnrestrictedKeepClearRectsTracker.getLastComputedRects();
    ...
    try {
      this.mWindowSession.reportKeepClearAreasChanged(
          this.mWindow, restrictedKeepClearRects, unrestrictedKeepClearRects);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  boolean scrollToRectOrFocus(Rect rectangle, boolean immediate) {
    ...
    if (vi.left > ci.left || vi.top > ci.top || vi.right > ci.right || vi.bottom > ci.bottom) {
      ...
      if (z) {
        Log.m100v(
            this.mTag,
            "Eval scroll: focus=" + focus + " rectangle=" + rectangle2 + " ci=" + ci + " vi=" + vi);
      }
      if (focus != lastScrolledFocus || this.mScrollMayChange || rectangle2 != null) {
        ...
        if (focus.getGlobalVisibleRect(this.mVisRect, null)) {
          ...
          if (rectangle2 == null) {
            ...
            if (z) {
              Log.m100v(
                  this.mTag, "Focus " + focus + ": focusRect=" + this.mTempRect.toShortString());
            }
            View view = this.mView;
            if (view instanceof ViewGroup) {
              try {
                ...
                Log.m96e(
                    this.mTag,
                    "offsetDescendantRectToMyCoords() error occurred. focus="
                        + focus
                        + " mTempRect="
                        + this.mTempRect.toShortString()
                        + " "
                        + ex);
                ex.printStackTrace();
              }
  ...
  void setAccessibilityFocus(View view, AccessibilityNodeInfo node) {
    if (this.mAccessibilityFocusedVirtualView != null) {
      ...
      if (provider != null) {
        ...
        int virtualNodeId =
            AccessibilityNodeInfo.getVirtualDescendantId(focusNode.getSourceNodeId());
    ...
    if (desiredRatio != this.mDesiredHdrSdrRatio) {
      ...
      if (this.mDesiredHdrSdrRatio < 1.01f) {
        ...
        Consumer<Display> consumer =
            new Consumer() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda21
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
  ...
  public void recomputeViewAttributes(View child) {
    ...
    if (this.mView == child) {
      if (this.mIsInTraversal) {
        this.mHandler.post(
            new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda7
              @Override // java.lang.Runnable
              public final void run() {
  ...
  void dispatchDetachedFromWindow() {
    ...
    if (this.mThread != Thread.currentThread()) {
      Log.m102w(
          this.mTag,
          "There is possible to occur CalledFromWrongThreadException. " + Debug.getCallers(10));
    }
    this.mAttachInfo.mRootView = null;
    destroySurface();
  ...
  public void performConfigurationChange(
      MergedConfiguration mergedConfiguration, boolean force, int newDisplayId) {
    View.AttachInfo attachInfo;
    ...
    int lastRotation =
        this.mLastReportedMergedConfiguration
            ...
            .getRotation();
    int newRotation =
        mergedConfiguration.getMergedConfiguration().windowConfiguration.getRotation();
    ...
    Configuration lastOverrideConfig =
        this.mLastReportedMergedConfiguration.getOverrideConfiguration();
    ...
    if (changeNightDim) {
      ...
      if (!isDeskTopModeEnabled) {
        ...
        Log.m98i(
            this.mTag, "performConfigurationChange setNightDimText nightDimLevel=" + nightDimLevel);
        invalidateWorld(this.mView);
      }
    }
    ...
    if (lastOverrideConfig.seq > 0
        && overrideConfig.seq > 0
        && overrideConfig.isOtherSeqNewer(lastOverrideConfig)) {
      Log.m100v(
          this.mTag,
          "Last overrideConfig is newer : " + overrideConfig + " -> " + lastOverrideConfig);
    ...
    if (CoreRune.MW_CAPTION_SHELL_BUG_FIX
      ...
      if (!lastBounds.equals(newBounds)
          && (attachInfo = this.mAttachInfo) != null
  ...
  private void updateLastConfigurationFromResources(Configuration resConfig) {
    ...
    if (lastLayoutDirection != currentLayoutDirection
        ...
        && this.mViewLayoutDirectionInitial == 2) {
      ...
      switch (message.what) {
        ...
        case 2:
          View.AttachInfo.InvalidateInfo invalidateInfo =
              (View.AttachInfo.InvalidateInfo) message.obj;
          invalidateInfo.target.invalidate(
              invalidateInfo.left, invalidateInfo.top, invalidateInfo.right, invalidateInfo.bottom);
        ...
        case 7:
          ...
          ViewRootImpl.this.enqueueInputEvent(
              (InputEvent) someArgs2.arg1, (InputEventReceiver) someArgs2.arg2, 0, true);
          someArgs2.recycle();
          break;
        case 8:
        ...
        case 18:
          ...
          if (configuration.isOtherSeqNewer(
              ViewRootImpl.this.mLastReportedMergedConfiguration.getMergedConfiguration())) {
            configuration =
                ViewRootImpl.this.mLastReportedMergedConfiguration.getGlobalConfiguration();
          }
          ViewRootImpl.this.mPendingMergedConfiguration.setConfiguration(
              configuration,
              ViewRootImpl.this.mLastReportedMergedConfiguration.getOverrideConfiguration());
          ViewRootImpl.this.performConfigurationChange(
              new MergedConfiguration(ViewRootImpl.this.mPendingMergedConfiguration), false, -1);
          break;
        case 19:
        ...
        case 25:
          ...
          break;
        case 26:
          ViewRootImpl.this.handleRequestKeyboardShortcuts(
              (IResultReceiver) message.obj, message.arg1);
          break;
        case 27:
        ...
        case 31:
          ...
          if (ViewRootImpl.this.mView == null) {
            ...
            Log.m96e(
                ViewRootImpl.TAG,
                String.format(
                    "Calling showInsets(%d,%b) on window that no longer has views.", objArr));
          }
        ...
        case 32:
          ...
          break;
        case 33:
          ViewRootImpl.this.handleScrollCaptureRequest(
              (IScrollCaptureResponseListener) message.obj);
          break;
        case 34:
          if (ViewRootImpl.this.mAdded) {
            Log.m98i(
                ViewRootImpl.this.mTag,
                new StringBuilder("MSG_WINDOW_TOUCH_MODE_CHANGED ").toString());
          }
  ...
  private boolean ensureTouchModeLocally(boolean inTouchMode) {
    ...
    if (!inTouchMode
        && !this.mAttachInfo.mHasWindowFocus
        && (this.mDesktopMode || ((CoreRune.MT_NEW_DEX && this.mNewDexMode) || isSplitScreen()))) {
      if (CoreRune.SAFE_DEBUG) {
    ...
    try {
      ...
      Log.m96e(
          TAG, "ensureTouchModeLocally() error occurred. inTouchMode=" + inTouchMode + " " + ex);
      ex.printStackTrace();
      return false;
    }
  }
  ...
  private boolean enterTouchMode() {
    ...
    if (view == null
        || !view.hasFocus()
        || (focused = this.mView.findFocus()) == null
  ...
  private boolean leaveTouchMode() {
    ...
    if (view.hasFocus()) {
      ...
      if (!(focusedView instanceof ViewGroup)
          || ((ViewGroup) focusedView).getDescendantFocusability() != 262144) {
        return false;
      }
    }
  ...
  private boolean getPalmRejection(MotionEvent event) {
    ...
    if (event.getToolType(0) != 1
        || SsumMajor < 100.0f
        || SsumEccen <= 2.0f
        || SvarX2 >= TILT_TO_ZOOM_XVAR / (N + 4)) {
      return false;
    }
    Log.m98i(
        TAG,
        "[ViewRootImpl] action cancel - 2, Palm Sweep, SsumMajor:"
            + SsumMajor
            + " eccen:"
            + SsumEccen
            + " varX:"
  ...
  abstract class InputStage {
    ...
    protected boolean shouldDropInputEvent(QueuedInputEvent q) {
      ...
      if (ViewRootImpl.this.mView == null || !ViewRootImpl.this.mAdded) {
        Slog.m121w(
            ViewRootImpl.this.mTag, "Dropping event due to root view being removed: " + q.mEvent);
        Slog.m115e(
            ViewRootImpl.this.mTag,
            "mStopped="
                + ViewRootImpl.this.mStopped
                + " mHasWindowFocus="
                + ViewRootImpl.this.mAttachInfo.mHasWindowFocus
                + " mPausedForTransition="
                + ViewRootImpl.this.mPausedForTransition);
        return true;
      }
      boolean hasWindowFocus = ViewRootImpl.this.mAttachInfo.mHasWindowFocus;
      if ((ViewRootImpl.this.mView instanceof DecorView)
          && (q.mEvent instanceof KeyEvent)
          && ((KeyEvent) q.mEvent).getKeyCode() == 4) {
      ...
      if (!hasWindowFocus
          && !hasFakeFocusFlag
          && !q.mEvent.isFromSource(2)
          && !ViewRootImpl.this.isAutofillUiShowing()) {
    ...
    private void traceEvent(QueuedInputEvent q, long traceTag) {
      ...
      Trace.traceBegin(
          traceTag, this.mTracePrefix + " id=0x" + Integer.toHexString(q.mEvent.getId()));
    }
  }
  ...
  final class NativePreImeInputStage extends AsyncInputStage
    ...
    protected int onProcess(QueuedInputEvent q) {
      if (q.mEvent instanceof KeyEvent) {
        ...
        if (isBack(keyEvent)
            && ViewRootImpl.this.mContext != null
            && ViewRootImpl.this.mOnBackInvokedDispatcher.isOnBackInvokedCallbackEnabled()) {
    ...
    private int doOnBackKeyEvent(KeyEvent keyEvent) {
      OnBackInvokedCallback topCallback =
          ViewRootImpl.this.getOnBackInvokedDispatcher().getTopCallback();
  ...
  final class ViewPreImeInputStage extends InputStage {
    ...
    private int processKeyEvent(QueuedInputEvent q) {
      ...
      if (ViewRootImpl.this.mDesktopMode) {
        if (ViewRootImpl.this.mAttachInfo.mDragToken != null
            && event.getKeyCode() == 4
            && event.getAction() == 0) {
      ...
      return ((ViewRune.WIDGET_PEN_SUPPORTED
                  && ViewRootImpl.this.mView.dispatchKeyEventTextMultiSelection(event))
              || ViewRootImpl.this.mView.dispatchKeyEventPreIme(event))
          ? 1
          : 0;
    }
  }
  ...
  final class ImeInputStage extends AsyncInputStage
    ...
    protected int onProcess(QueuedInputEvent q) {
      int result =
          ViewRootImpl.this.mImeFocusController.onProcessImeInputStage(
              q, q.mEvent, ViewRootImpl.this.mWindowAttributes, this);
      switch (result) {
        case -1:
          return 3;
        case 0:
  ...
  final class EarlyPostImeInputStage extends InputStage {
    ...
    private int processPointerEvent(QueuedInputEvent q) {
      ...
      if (event.isTouchEvent()) {
        ...
        if (event.mNeedWindowOffset
            && (translator = ViewRootImpl.this.getCompatTranslator()) != null) {
  ...
  final class ViewPostImeInputStage extends InputStage {
    ...
    protected void onDeliverToNext(QueuedInputEvent q) {
      if (ViewRootImpl.this.mUnbufferedInputDispatch
          ...
          && ViewRootImpl.isTerminalInputEvent(q.mEvent)) {
        ...
        if (focused != null) {
          ...
          if (v != null && v != focused) {
            ...
            if (ViewRootImpl.this.mView instanceof ViewGroup) {
              ((ViewGroup) ViewRootImpl.this.mView)
                  .offsetDescendantRectToMyCoords(focused, ViewRootImpl.this.mTempRect);
              ((ViewGroup) ViewRootImpl.this.mView)
                  .offsetRectIntoDescendantCoords(v, ViewRootImpl.this.mTempRect);
            }
            if (v.requestFocus(direction, ViewRootImpl.this.mTempRect)) {
              boolean isFastScrolling = event.getRepeatCount() > 0;
              ViewRootImpl.this.playSoundEffect(
                  SoundEffectConstants.getConstantForFocusDirection(direction, isFastScrolling));
              return true;
            }
          }
    ...
    private int processKeyEvent(QueuedInputEvent q) {
      ...
      if (ViewRootImpl.this.mView.dispatchKeyEvent(event)) {
        if ((CoreRune.FW_ACTIVE_OR_XCOVER_KEY || CoreRune.FW_XCOVER_AND_TOP_KEY)
            && (((keycode = event.getKeyCode()) == 1015 || keycode == 1079)
                && SystemProperties.getInt("sys.datawedge.prop", 0) == 1)) {
    ...
    private int processPointerEvent(QueuedInputEvent q) {
      ...
      if (ViewRootImpl.DEBUG_TOUCH_EVENT) {
        Log.m98i(ViewRootImpl.this.mTag, "ViewPostIme pointer " + action);
          ...
          || action == 1
          || (ViewRune.COMMON_IS_PRODUCT_DEV && action != 2 && action != 7 && action != 213)) {
        Log.m98i(ViewRootImpl.this.mTag, "ViewPostIme pointer " + action);
      }
      ...
      if (ViewRootImpl.this.mAttachInfo.mUnbufferedDispatchRequested
          && !ViewRootImpl.this.mUnbufferedInputDispatch) {
    ...
    private void maybeUpdatePointerIcon(MotionEvent event) {
      ...
      if (needsStylusPointerIcon || event.isFromSource(8194)) {
        ...
        if (event.getActionMasked() != 10
            && event.getActionMasked() != 4
            && !ViewRootImpl.this.updatePointerIcon(event)
            && event.getActionMasked() == 7) {
          ViewRootImpl.this.mPointerIconType = null;
        }
      }
    }
    ...
    private int processTrackballEvent(QueuedInputEvent q) {
      MotionEvent event = (MotionEvent) q.mEvent;
      return ((!event.isFromSource(InputDevice.SOURCE_MOUSE_RELATIVE)
                  || (ViewRootImpl.this.hasPointerCapture()
                      && !ViewRootImpl.this.mView.dispatchCapturedPointerEvent(event)))
              && !ViewRootImpl.this.mView.dispatchTrackballEvent(event))
          ? 0
          : 1;
    }
    ...
    private int processGenericMotionEvent(QueuedInputEvent q) {
      MotionEvent event = (MotionEvent) q.mEvent;
      return ((event.isFromSource(InputDevice.SOURCE_TOUCHPAD)
                  && ViewRootImpl.this.hasPointerCapture()
                  && ViewRootImpl.this.mView.dispatchCapturedPointerEvent(event))
              || ViewRootImpl.this.mView.dispatchGenericMotionEvent(event))
          ? 1
          : 0;
    }
  }
  ...
  public boolean updatePointerIcon(MotionEvent event) {
    ...
    if ((this.mPointerIconType.intValue() == -1 || this.mPointerIconType.intValue() == 20000)
        && !pointerIcon.equals(this.mCustomPointerIcon)) {
      this.mCustomPointerIcon = pointerIcon;
      Log.m98i(
          TAG,
          "updatePointerIcon Custom PointerIcon = "
              + this.mPointerIconType
              + ", calling pid = "
              + Binder.getCallingPid());
    ...
    public void process(MotionEvent event) {
      ...
      switch (action) {
        case 0:
          ...
          this.f569mY.reset(2);
          ViewRootImpl.this.enqueueInputEvent(
              new KeyEvent(curTime, curTime, 0, 23, 0, metaState, -1, 0, 1024, 257));
          break;
        case 1:
          this.f568mX.reset(2);
          this.f569mY.reset(2);
          curTime = curTime3;
          ViewRootImpl.this.enqueueInputEvent(
              new KeyEvent(curTime3, curTime3, 1, 23, 0, metaState, -1, 0, 1024, 257));
          break;
        default:
          curTime = curTime3;
          break;
      ...
      if (ViewRootImpl.DEBUG_TRACKBALL) {
        Log.m100v(
            ViewRootImpl.this.mTag,
            "TB X="
                + this.f568mX.position
                + " step="
                + this.f568mX.step
                + " dir="
                + this.f568mX.dir
                + " acc="
                + this.f568mX.acceleration
                + " move="
                + event.getX()
                + " / Y="
                + this.f569mY.position
                + " step="
                + this.f569mY.step
                + " dir="
                + this.f569mY.dir
                + " acc="
                + this.f569mY.acceleration
                + " move="
                + event.getY());
      }
      float xOff =
          this.f568mX.collect(event.getX(), event.getEventTime(), GnssSignalType.CODE_TYPE_X);
      float yOff =
          this.f569mY.collect(event.getY(), event.getEventTime(), GnssSignalType.CODE_TYPE_Y);
      int movement = 0;
      if (xOff > yOff) {
      ...
      if (keycode != 0) {
        ...
        if (ViewRootImpl.DEBUG_TRACKBALL) {
          Log.m100v(
              ViewRootImpl.this.mTag,
              "Move: movement=" + movement + " accelMovement=" + accelMovement + " accel=" + accel);
        }
        if (accelMovement <= movement) {
          ...
          keycode2 = keycode;
          ViewRootImpl.this.enqueueInputEvent(
              new KeyEvent(curTime, curTime, 2, keycode, repeatCount, metaState, -1, 0, 1024, 257));
          curTime2 = curTime;
          movement = movement2;
        }
        while (movement > 0) {
          ...
          int i = keycode2;
          ViewRootImpl.this.enqueueInputEvent(
              new KeyEvent(curTime4, curTime4, 0, i, 0, metaState, -1, 0, 1024, 257));
          ViewRootImpl.this.enqueueInputEvent(
              new KeyEvent(curTime4, curTime4, 1, i, 0, metaState, -1, 0, 1024, 257));
          movement--;
          curTime2 = curTime4;
          str = str2;
          keycode2 = keycode2;
  ...
  final class SyntheticJoystickHandler extends Handler {
          ...
          if (ViewRootImpl.this.mAttachInfo.mHasWindowFocus) {
            ...
            KeyEvent e =
                KeyEvent.changeTimeRepeat(
                    oldEvent, SystemClock.uptimeMillis(), oldEvent.getRepeatCount() + 1);
    ...
    private void update(MotionEvent event) {
      ...
      for (int h = 0; h < historySize; h++) {
        ...
        this.mJoystickAxesState.updateStateForAxis(
            event, time, 0, event.getHistoricalAxisValue(0, 0, h));
        this.mJoystickAxesState.updateStateForAxis(
            event, time, 1, event.getHistoricalAxisValue(1, 0, h));
        this.mJoystickAxesState.updateStateForAxis(
            event, time, 15, event.getHistoricalAxisValue(15, 0, h));
        this.mJoystickAxesState.updateStateForAxis(
            event, time, 16, event.getHistoricalAxisValue(16, 0, h));
      }
    ...
    final class JoystickAxesState {
      ...
      void updateStateForAxis(MotionEvent event, long time, int axis, float value) {
        ...
        if (currentState == 1 || currentState == -1) {
          ...
          if (keyCode2 != 0) {
            ViewRootImpl.this.enqueueInputEvent(
                new KeyEvent(time, time, 1, keyCode2, 0, metaState, deviceId, 0, 1024, source));
            deviceId = deviceId;
        ...
        if ((newState == 1 || newState == -1)
            && (keyCode = joystickAxisAndStateToKeycode(axis, newState)) != 0) {
          int deviceId2 = deviceId;
          KeyEvent keyEvent =
              new KeyEvent(time, time, 0, keyCode, 0, metaState, deviceId2, 0, 1024, source);
          ViewRootImpl.this.enqueueInputEvent(keyEvent);
          Message m = SyntheticJoystickHandler.this.obtainMessage(repeatMessage, keyEvent);
          m.setAsynchronous(true);
          SyntheticJoystickHandler.this.sendMessageDelayed(
              m, ViewConfiguration.getKeyRepeatTimeout());
          SyntheticJoystickHandler.this.mDeviceKeyEvents.put(
              deviceId2,
              new KeyEvent(time, time, 1, keyCode, 0, metaState, deviceId2, 0, 1056, source));
        }
        if (axis == 0 || axis == 1) {
  ...
  final class SyntheticTouchNavigationHandler extends Handler {
    ...
    SyntheticTouchNavigationHandler() {
      ...
      this.mGestureDetector =
          new GestureDetector(
              ViewRootImpl.this.mContext,
              new GestureDetector
                  .OnGestureListener() { // from class:
                ...
                public boolean onFling(
                  ...
                  SyntheticTouchNavigationHandler.this.dispatchFling(
                      velocityX, velocityY, e2.getEventTime());
                  return true;
                }
              });
    }
    ...
    if (this.mView != null && this.mAdded) {
      ...
      if (what == 6) {
        ...
        if (windowConfiguration.getWindowingMode() == 6
            && !windowConfiguration.isAlwaysOnTop()
            && windowConfiguration.getStagePosition() == 16
    ...
    if (view instanceof ViewGroup) {
      ...
      if (decorView.getChildCount() > 0) {
        return (AutofillManager)
            decorView.getChildAt(0).getContext().getSystemService(AutofillManager.class);
      }
      return null;
    }
    return null;
  ...
  public AccessibilityInteractionController getAccessibilityInteractionController() {
    if (this.mView == null) {
      throw new IllegalStateException(
          "getAccessibilityInteractionController called when there is no mView");
    }
  ...
  private boolean shouldNotLocalLayout(
      WindowConfiguration winConfig, WindowManager.LayoutParams params) {
    ...
    return largeCutoutSize > 0
        && largeCutoutSize <= this.mMinimumSizeForOverlappingWithCutoutAsDefault;
  }
  ...
  private boolean shouldNotLocalLayoutPopOver(WindowConfiguration winConfig) {
    ...
    return winConfig.isPopOver()
        && (imeSource = this.mInsetsController.getState().peekSource(InsetsSource.ID_IME)) != null
        && imeSource.isVisible();
  }
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  private int relayoutWindow(WindowManager.LayoutParams layoutParams, int i, boolean z)
    ...
    WindowConfiguration windowConfiguration3 =
        this.mLastReportedMergedConfiguration.getGlobalConfiguration().windowConfiguration;
    ...
    if (LOCAL_LAYOUT
        && (this.mViewFrameInfo.flags & 1) == 0
        && this.mWindowAttributes.type != 3
        && this.mSyncSeqId <= this.mLastSyncSeqId) {
      if (windowConfiguration2.diff(windowConfiguration3, false) == 0
          && !shouldNotLocalLayout(compatWindowConfiguration, layoutParams)
          && ((!CoreRune.MW_EMBED_ACTIVITY
                  || !shouldNotLocalLayoutEmbedded(compatWindowConfiguration))
              && !shouldNotLocalLayoutPopOver(compatWindowConfiguration))) {
        InsetsState state = this.mInsetsController.getState();
        Rect rect2 = this.mTempRect;
        state.getDisplayCutoutSafe(rect2);
        this.mWindowLayout.computeFrames(
            this.mWindowAttributes.forRotation(compatWindowConfiguration.getRotation()),
            state,
            rect2,
            compatWindowConfiguration.getBounds(),
            compatWindowConfiguration.getWindowingMode(),
            i6,
            i7,
            this.mInsetsController.getRequestedVisibleTypes(),
            1.0f,
            this.mTmpFrames,
            compatWindowConfiguration.getStageType());
        ...
        boolean z6 =
            ((rect4.top != rect3.top || rect4.left != rect3.left)
                    && (rect4.width() != rect3.width() || rect4.height() != rect3.height()))
                ? false
                : true;
        if (z6 && (rect = this.mPendingWinFrame) != null) {
          if (rect.width() != rect4.width() || this.mPendingWinFrame.height() != rect4.height()) {
            ...
            Log.m98i(
                this.mTag,
                "Request to relayout frame from wm due to using pendingFrame="
                    + this.mPendingWinFrame
                    + " instead of newFrame="
                    + rect4);
        ...
        if (z6
            && compatWindowConfiguration.getRotation() == 2
            && this.mDisplay.getDisplayId() != 0
            && (rect4.width() != this.mWinFrame.width()
                || rect4.height() != this.mWinFrame.height())) {
          z6 = false;
          Log.m98i(
              this.mTag,
              "Request to relayout frame because WindowFrame is changed by handleResized");
        }
        z2 = z6;
        ...
        if (layoutParams != null
            && this.mOrigWindowType != layoutParams.type
            && this.mTargetSdkVersion < 14) {
          Slog.m121w(
              this.mTag,
              "Window type can not be changed after the window is added; ignoring change of "
                  + this.mView);
          layoutParams.type = this.mOrigWindowType;
        }
        StringBuilder append =
            new StringBuilder(NavigationBarInflaterView.KEY_CODE_START)
                .append(this.mWinFrame.left)
                .append(',')
                .append(this.mWinFrame.top)
                .append(',')
                .append(this.mWinFrame.right)
                .append(',')
                .append(this.mWinFrame.bottom)
                .append(')');
        ...
        if (!z2) {
          ...
          relayout =
              this.mWindowSession.relayout(
                  ...
                  this.mLastSyncSeqId,
                  this.mTmpFrames,
                  this.mPendingMergedConfiguration,
                  this.mSurfaceControl,
                  this.mTempInsets,
                  this.mTempControls,
                  this.mRelayoutBundle);
          z4 = true;
        ...
        int rotationToBufferTransform =
            SurfaceControl.rotationToBufferTransform(
                (this.mDisplay.getInstallOrientation() + this.mDisplay.getRotation()) % 4);
        WindowLayout.computeSurfaceSize(
            this.mWindowAttributes,
            windowConfiguration.getMaxBounds(),
            i2,
            i4,
            this.mWinFrameInScreen,
            this.mPendingDragResizing,
            this.mSurfaceSize);
        ...
        if (this.mSurfaceControl.isValid() && !HardwareRenderer.isDrawingEnabled()) {
          this.mTransaction
              .setWindowCrop(this.mSurfaceControl, this.mSurfaceSize.f85x, this.mSurfaceSize.f86y)
              .apply();
        }
        ...
        if (this.mAttachInfo.mContentCaptureManager != null) {
          MainContentCaptureSession mainContentCaptureSession =
              this.mAttachInfo.mContentCaptureManager.getMainContentCaptureSession();
          mainContentCaptureSession.notifyWindowBoundsChanged(
              mainContentCaptureSession.getId(),
        ...
        if (!this.mSurfaceControl.isValid()) {
          ...
          if (this.mAttachInfo.mThreadedRenderer != null) {
            this.mAttachInfo.mThreadedRenderer.setSurfaceControl(
                this.mSurfaceControl, this.mBlastBufferQueue);
          }
          updateRenderHdrSdrRatio();
        ...
        if (compatTranslator != null) {
          if (CoreRune.FW_BOUNDS_COMPAT_TRANSLATOR_AS_BOUNDS) {
            updatePositionInBounds(
                compatTranslator, this.mPendingMergedConfiguration.getOverrideConfiguration());
          }
          compatTranslator.savePositionInScreen(
              this.mTmpFrames.frame.left, this.mTmpFrames.frame.top);
        ...
        Log.m98i(
            ...
            "Relayout returned: old="
                ...
                + currentTimeMillis2
                + " res=0x"
                + Integer.toHexString(relayout)
                + " s={"
                + this.mSurface.isValid()
                + ' '
                + ("0x" + Long.toHexString(this.mSurface.mNativeObject))
                + "} ch="
                + (i3 == this.mSurface.getGenerationId())
                + " seqId="
                + this.mSyncSeqId);
        return relayout;
      }
    ...
    if (!z2) {}
    int rotationToBufferTransform2 =
        SurfaceControl.rotationToBufferTransform(
            (this.mDisplay.getInstallOrientation() + this.mDisplay.getRotation()) % 4);
    WindowLayout.computeSurfaceSize(
        this.mWindowAttributes,
  ...
  private void updateOpacity(
      WindowManager.LayoutParams params, boolean dragResizing, boolean forceUpdate) {
  ...
  */
  private boolean getViewBoundsSandboxingEnabled() {
    ...
    if (ActivityThread.isSystem()
        || !CompatChanges.isChangeEnabled(ActivityInfo.OVERRIDE_SANDBOX_VIEW_BOUNDS_APIS)) {
      return false;
    }
    try {
      properties =
          this.mContext
              ...
              .queryApplicationProperty(
                  WindowManager.PROPERTY_COMPAT_ALLOW_SANDBOXING_VIEW_BOUNDS_APIS);
  ...
  public void playSoundEffect(int effectId) {
    ...
    try {
      ...
      if (this.mFastScrollSoundEffectsEnabled
  ...
  public View keyboardNavigationClusterSearch(View currentCluster, int direction) {
    ...
    return FocusFinder.getInstance()
        .findNextKeyboardNavigationCluster(this.mView, currentCluster, direction);
  }
  ...
  public void dump(String prefix, PrintWriter writer) {
    ...
    writer.println(
        innerPrefix + "mConsumeBatchedInputScheduled=" + this.mConsumeBatchedInputScheduled);
    writer.println(
        innerPrefix
            + "mConsumeBatchedInputImmediatelyScheduled="
            + this.mConsumeBatchedInputImmediatelyScheduled);
    writer.println(innerPrefix + "mPendingInputEventCount=" + this.mPendingInputEventCount);
    writer.println(
        innerPrefix + "mProcessInputEventsScheduled=" + this.mProcessInputEventsScheduled);
    writer.println(innerPrefix + "mTraversalScheduled=" + this.mTraversalScheduled);
    if (this.mTraversalScheduled) {
      writer.println(
          innerPrefix
              + " (barrier="
              + this.mTraversalBarrier
              + NavigationBarInflaterView.KEY_CODE_END);
    }
    ...
    if (this.mReportNextDraw) {
      writer.println(
          innerPrefix
              + " (reason="
              + this.mLastReportNextDrawReason
              + NavigationBarInflaterView.KEY_CODE_END);
    }
    if (this.mLastPerformTraversalsSkipDrawReason != null) {
      writer.println(
          innerPrefix
              + "mLastPerformTraversalsFailedReason="
              + this.mLastPerformTraversalsSkipDrawReason);
    }
    if (this.mLastPerformDrawSkippedReason != null) {
      writer.println(
          innerPrefix + "mLastPerformDrawFailedReason=" + this.mLastPerformDrawSkippedReason);
    }
    if (this.mWmsRequestSyncGroupState != 0) {
      writer.println(innerPrefix + "mWmsRequestSyncGroupState=" + this.mWmsRequestSyncGroupState);
    }
    writer.println(
        innerPrefix + "mLastReportedMergedConfiguration=" + this.mLastReportedMergedConfiguration);
    writer.println(
        innerPrefix + "mLastConfigurationFromResources=" + this.mLastConfigurationFromResources);
    writer.println(innerPrefix + "mIsAmbientMode=" + this.mIsAmbientMode);
    writer.println(
        innerPrefix + "mUnbufferedInputSource=" + Integer.toHexString(this.mUnbufferedInputSource));
    if (this.mAttachInfo != null) {
  ...
  public void loadSystemProperties() {
    this.mHandler.post(
        new Runnable() { // from class: android.view.ViewRootImpl.7
          @Override // java.lang.Runnable
          public void run() {
            ViewRootImpl.this.mProfileRendering =
                SystemProperties.getBoolean(ViewRootImpl.PROPERTY_PROFILE_RENDERING, false);
            ViewRootImpl viewRootImpl = ViewRootImpl.this;
            ...
            if (ViewRootImpl.this.mAttachInfo.mThreadedRenderer != null
                && ViewRootImpl.this.mAttachInfo.mThreadedRenderer.loadSystemProperties()) {
  ...
  public void dispatchResized(
    ...
    Log.m98i(
        ...
        "Resizing "
            + this
            + ": frame = "
            + clientWindowFrames.frame.toShortString()
            + " reportDraw = "
            + z
            + " forceLayout = "
            + z2
  ...
  public void dispatchInsetsControlChanged(
    ...
    if (insetsState != null
        && insetsState.isSourceOrDefaultVisible(InsetsSource.ID_IME, WindowInsets.Type.ime())) {
      ImeTracing.getInstance()
          .triggerClientDump(
  ...
  public void dispatchMoved(int newX, int newY) {
    ...
    if (translator != null) {
      if (CoreRune.FW_BOUNDS_COMPAT_TRANSLATOR_AS_BOUNDS) {
        updatePositionInBounds(
            translator, this.mLastReportedMergedConfiguration.getOverrideConfiguration());
      }
  ...
  private static final class QueuedInputEvent {
    ...
    public boolean shouldSkipIme() {
      ...
      return (inputEvent instanceof MotionEvent)
          && (inputEvent.isFromSource(2) || this.mEvent.isFromSource(4194304));
    }
      ...
      if (!flagToString(
          ...
          flagToString(
              ...
              flagToString(
                  "FINISHED_HANDLED",
                  8,
                  flagToString("FINISHED", 4, flagToString("DEFERRED", 2, hasPrevious, sb), sb),
                  sb),
              sb),
          sb)) {
        sb.append("0");
  ...
  private QueuedInputEvent obtainQueuedInputEvent(
      InputEvent event, InputEventReceiver receiver, int flags) {
  ...
  void enqueueInputEvent(
      InputEvent event, InputEventReceiver receiver, int flags, boolean processImmediately) {
    if (CoreRune.FW_SPEN_HOVER
        && (event instanceof KeyEvent)
        && (((KeyEvent) event).getFlags() & 33554432) != 0) {
      flags |= 1;
    }
    ...
    if (event instanceof MotionEvent) {
      ...
      if (me.getAction() == 3) {
        EventLog.writeEvent(
            EventLogTags.VIEW_ENQUEUE_INPUT_EVENT, "Motion - Cancel", getTitle().toString());
      }
    } else if (event instanceof KeyEvent) {
      KeyEvent ke = (KeyEvent) event;
      if (ke.isCanceled()) {
        EventLog.writeEvent(
            EventLogTags.VIEW_ENQUEUE_INPUT_EVENT, "Key - Cancel", getTitle().toString());
      }
    }
  ...
  void doProcessInputEvents() {
    while (this.mPendingInputEventHead != null) {
      ...
      if (q.mEvent instanceof MotionEvent) {
        ...
        View view = this.mView;
        if (view != null
            && ((view.getTop() != 0 || this.mView.getLeft() != 0)
                && this.mWindowAttributes.layoutInDisplayCutoutMode == 1
  ...
  private void deliverInputEvent(QueuedInputEvent q) {
      ...
      if (CoreRune.MT_SUPPORT_COMPAT_SANDBOX) {
        ...
        if (CompatSandbox.isMotionEventSandboxingEnabled(config)) {
          ...
          if (DEBUG_TOUCH_EVENT) {
            Log.m94d(
                this.mTag,
                "MotionEventSandboxingEnabled, rawX"
                    + event2.getRawX()
                    + ", rawY"
                    + event2.getRawY()
                    + ", xOffset"
    ...
    if (Trace.isTagEnabled(8L)) {
      Trace.traceBegin(
          8L,
          "deliverInputEvent src=0x"
              + Integer.toHexString(q.mEvent.getSource())
              + " eventTimeNano="
              + q.mEvent.getEventTimeNanos()
              + " id=0x"
      ...
      if (modified) {
        ...
        try {
          InputEvent processedEvent =
              this.mInputCompatProcessor.processInputEventBeforeFinish(q.mEvent);
  ...
  final class WindowInputEventReceiver extends InputEventReceiver {
    ...
    public void onInputEvent(InputEvent event) {
      ...
      try {
        List<InputEvent> processedEvents =
            ViewRootImpl.this.mInputCompatProcessor.processInputEventForCompatibility(event);
        Trace.traceEnd(8L);
        ...
        if (ViewRune.COMMON_IS_PRODUCT_DEV && (event instanceof MotionEvent)) {
          ...
          traceKey =
              String.format(
                  "(X=%d, Y=%d, Action=%d)",
                  Integer.valueOf((int) motionEvent.getX()),
                  Integer.valueOf((int) motionEvent.getY()),
    ...
    public void onBatchedInputEventPending(int source) {
      boolean unbuffered =
          ViewRootImpl.this.mUnbufferedInputDispatch
              || (ViewRootImpl.this.mUnbufferedInputSource & source) != 0;
      if (unbuffered) {
        if (ViewRootImpl.this.mConsumeBatchedInputScheduled) {
    ...
    public void onDragEvent(boolean isExiting, float x, float y) {
      DragEvent event =
          DragEvent.obtain(
              isExiting ? 6 : 2, x, y, 0.0f, 0.0f, null, null, null, null, null, false);
  ...
  final class InputMetricsListener
    ...
    public void onFrameMetricsAvailable(int dropCountSinceLastInvocation) {
      ...
      if (gpuCompletedTime >= presentTime) {
        ...
        Log.m102w(
            ViewRootImpl.TAG,
            "Not reporting timeline because gpuCompletedTime is "
                + discrepancyMs
      ...
      ViewRootImpl.this.mInputEventReceiver.reportTimeline(
          inputEventId, gpuCompletedTime, presentTime);
    }
  }
    ...
    public void run() {
      ...
      synchronized (this) {
        ...
        if (viewRectCount != 0) {
          ...
          this.mTempViewRects =
              (View.AttachInfo.InvalidateInfo[]) arrayList2.toArray(invalidateInfoArr);
  ...
  public void dispatchInvalidateRectDelayed(
      View.AttachInfo.InvalidateInfo info, long delayMilliseconds) {
  ...
  public void windowFocusInTaskChanged(boolean hasFocus) {
    synchronized (this) {
      ...
      if (CoreRune.SAFE_DEBUG) {
        Log.m98i(
            this.mTag,
            "windowFocusInTaskChanged "
                + this.mUpcomingWindowFocusInTask
                + " to "
                + hasFocus
                + ", windowFocus="
                + this.mUpcomingWindowFocus);
      }
  ...
  private void postSendWindowContentChangedCallback(View source, int changeType) {
    if (this.mSendWindowContentChangedAccessibilityEvent == null) {
      this.mSendWindowContentChangedAccessibilityEvent =
  ...
  public boolean requestSendAccessibilityEvent(View child, AccessibilityEvent event) {
    ...
    if (event.getEventType() != 2048
        && (sendWindowContentChangedAccessibilityEvent =
                this.mSendWindowContentChangedAccessibilityEvent)
            != null
        && sendWindowContentChangedAccessibilityEvent.mSource != null) {
  ...
  private void handleWindowContentChangedEvent(AccessibilityEvent event) {
    ...
    if (createAccessibilityNodeInfo == null) {
      ...
      provider.performAction(
          focusedChildId,
          AccessibilityNodeInfo.AccessibilityAction.ACTION_CLEAR_ACCESSIBILITY_FOCUS.getId(),
          null);
  ...
  public void handleScrollCaptureRequest(final IScrollCaptureResponseListener listener) {
    final ScrollCaptureSearchResults results =
        new ScrollCaptureSearchResults(this.mContext.getMainExecutor());
    ...
    if (rootView != null) {
      ...
      rootView.dispatchScrollCaptureSearch(
          rect,
          point,
          new Consumer() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda13
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    if (!results.isComplete()) {
      ...
      viewRootHandler.postDelayed(
          new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void lambda$handleScrollCaptureRequest$10(
    ...
    ScrollCaptureConnection connection =
        new ScrollCaptureConnection(this.mView.getContext().getMainExecutor(), selectedTarget);
  ...
  static class BinderC3744W extends IWindow.Stub {
    ...
    private static int checkCallingPermission(String permission) {
      try {
        return ActivityManager.getService()
            .checkPermission(permission, Binder.getCallingPid(), Binder.getCallingUid());
      } catch (RemoteException e) {
        return -1;
      }
    }
    ...
    public void executeCommand(String command, String parameters, ParcelFileDescriptor out) {
      ...
      if (checkCallingPermission(Manifest.permission.DUMP) != 0) {
        throw new SecurityException(
            "Insufficient permissions to invoke executeCommand() from pid="
                + Binder.getCallingPid()
                + ", uid="
    ...
    public void invalidateForScreenShot(boolean forceMode) {
      ...
      if (forceMode) {
        ...
        viewAncestor.mAttachInfo.mThreadedRenderer.setTargetHdrSdrRatio(
            viewAncestor.mRenderHdrSdrRatio);
      }
      if (viewAncestor.mInvalidateForScreenshotRunnable == null) {
        viewAncestor.mInvalidateForScreenshotRunnable =
            new Runnable() { // from class: android.view.ViewRootImpl.W.1
              @Override // java.lang.Runnable
              public void run() {
    ...
    if (!this.mDragResizing) {
      ...
      if (this.mUseMTRenderer) {
        for (int i = this.mWindowCallbacks.size() - 1; i >= 0; i--) {
          this.mWindowCallbacks
              .get(i)
              .onWindowDragResizeStart(initialBounds, fullscreen, systemInsets, stableInsets);
        }
      }
      this.mFullRedrawNeeded = true;
    }
  ...
  final class AccessibilityInteractionConnectionManager
    ...
    public void onAccessibilityStateChanged(boolean enabled) {
      if (enabled) {
        ...
        if (ViewRootImpl.this.mAttachInfo.mLeashedParentToken != null) {
          ViewRootImpl.this.mAccessibilityManager.associateEmbeddedHierarchy(
              ViewRootImpl.this.mAttachInfo.mLeashedParentToken, ViewRootImpl.this.mLeashToken);
          return;
        }
        return;
      }
    ...
    public void ensureConnection() {
      ...
      if (!registered) {
        ViewRootImpl.this.mAttachInfo.mAccessibilityWindowId =
            ViewRootImpl.this.mAccessibilityManager.addAccessibilityInteractionConnection(
                ViewRootImpl.this.mWindow,
                ViewRootImpl.this.mLeashToken,
                ViewRootImpl.this.mContext.getPackageName(),
    ...
    public void ensureNoConnection() {
      ...
      if (registered) {
        ...
        ViewRootImpl.this.mAccessibilityManager.removeAccessibilityInteractionConnection(
            ViewRootImpl.this.mWindow);
      }
    }
    ...
    public int ensureDirectConnection() {
      if (this.mDirectConnectionId == -1) {
        this.mDirectConnectionId =
            AccessibilityInteractionClient.addDirectConnection(
                new AccessibilityInteractionConnection(ViewRootImpl.this),
                ViewRootImpl.this.mAccessibilityManager);
  ...
  final class HighContrastTextManager
    ...
    HighContrastTextManager() {
      ThreadedRenderer.setHighContrastText(
          ViewRootImpl.this.mAccessibilityManager.isHighTextContrastEnabled());
    }
  ...
  private class SendWindowContentChangedAccessibilityEvent implements Runnable {
    ...
    public void runOrPost(View source, int changeType) {
      if (ViewRootImpl.this.mHandler.getLooper() != Looper.myLooper()) {
        ...
        Log.m97e(
            ViewRootImpl.TAG,
            "Accessibility content change on non-UI thread. Future Android versions will throw an"
                + " exception.",
            e);
      ...
      if (ViewRootImpl.this.mAccessibilityManager.getPerformingAction() != 0) {
        this.mAction =
            OptionalInt.of(ViewRootImpl.this.mAccessibilityManager.getPerformingAction());
      }
  ...
  private static class UnhandledKeyManager {
    ...
    void preDispatch(KeyEvent event) {
      ...
      this.mCurrentReceiver = null;
      if (event.getAction() == 1
          && (idx = this.mCapturedKeys.indexOfKey(event.getKeyCode())) >= 0) {
  ...
  private void updateDisplayDecoration() {
    this.mTransaction
        .setDisplayDecoration(this.mSurfaceControl, this.mDisplayDecorationCached)
        .apply();
  }
  ...
  private void updateSkipScreenshot() {
    if (this.mWindowAttributes.type < 2000
        || (this.mWindowAttributes.privateFlags & 1048576) != 0) {
  ...
  public void mergeWithNextTransaction(SurfaceControl.Transaction t, long frameNumber) {
    ...
    StringBuilder append =
        sb.append(t != null ? Long.toHexString(t.mNativeObject) : SemCapabilities.FEATURE_TAG_NULL)
            .append(" mBlastBufferQueue=0x");
    BLASTBufferQueue bLASTBufferQueue = this.mBlastBufferQueue;
    if (bLASTBufferQueue != null) {
    ...
    Log.m98i(
        ...
        append
            ...
            .append(" fn= ")
            .append(frameNumber)
            .append(" mRenderHdrSdrRatio=")
            .append(this.mRenderHdrSdrRatio)
            .append(" caller= ")
            .append(Debug.getCallers(3))
            .toString());
    BLASTBufferQueue bLASTBufferQueue2 = this.mBlastBufferQueue;
    if (bLASTBufferQueue2 != null) {
  ...
  public void addOnBufferTransformHintChangedListener(
      AttachedSurfaceControl.OnBufferTransformHintChangedListener listener) {
    Objects.requireNonNull(listener);
    if (this.mTransformHintListeners.contains(listener)) {
      throw new IllegalArgumentException(
          "attempt to call addOnBufferTransformHintChangedListener() with a previously registered"
              + " listener");
    }
  ...
  private void dispatchTransformHintChanged(int hint) {
    ...
    ArrayList<AttachedSurfaceControl.OnBufferTransformHintChangedListener> listeners =
        (ArrayList) this.mTransformHintListeners.clone();
  ...
  public void requestCompatCameraControl(
      boolean showControl, boolean transformationApplied, ICompatCameraControlCallback callback) {
    this.mActivityConfigCallback.requestCompatCameraControl(
  ...
  private void registerCompatOnBackInvokedCallback() {
    this.mCompatOnBackInvokedCallback =
    ...
    if (this.mOnBackInvokedDispatcher.hasImeOnBackInvokedDispatcher()) {
      ...
      this.mOnBackInvokedDispatcher.registerOnBackInvokedCallback(
          0, this.mCompatOnBackInvokedCallback);
    }
  }
  ...
  private void registerCallbacksForSync(boolean syncBuffer, SurfaceSyncGroup surfaceSyncGroup) {
    ...
    t.merge(this.mPendingTransaction);
    this.mAttachInfo.mThreadedRenderer.registerRtFrameCallback(
        new C37408(t, surfaceSyncGroup, syncBuffer));
  }
  ...
  class C37408 implements HardwareRenderer.FrameDrawingCallback {
    ...
    public HardwareRenderer.FrameCommitCallback onFrameDraw(int syncResult, final long frame) {
      ...
      ViewRootImpl.this.mergeWithNextTransaction(this.val$t, frame);
      if ((syncResult & 6) != 0) {
        this.val$surfaceSyncGroup.addTransaction(
            ViewRootImpl.this.mBlastBufferQueue.gatherPendingTransactions(frame));
      ...
      if (this.val$syncBuffer) {
        ...
        boolean result =
            bLASTBufferQueue.syncNextTransaction(
                new Consumer() { // from class:
                                 // android.view.ViewRootImpl$8$$ExternalSyntheticLambda0
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
                    ViewRootImpl.C37408.this.lambda$onFrameDraw$0(
                        surfaceSyncGroup, (SurfaceControl.Transaction) obj);
                  }
                });
        if (!result) {
          Log.m102w(
              ViewRootImpl.this.mTag,
              "Unable to syncNextTransaction. Possibly something else is trying to sync?");
          this.val$surfaceSyncGroup.markSyncReady();
        }
      }
    ...
    public /* synthetic */ void lambda$onFrameDraw$0(
      ...
      if (CoreRune.FW_SURFACE_DEBUG_APPLY) {
        ...
        Log.m98i(
            ViewRootImpl.this.mTag,
            "Received ready transaction from native, debugName=" + transaction.mDebugName);
      }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onFrameDraw$1(
        long frame,
        SurfaceSyncGroup surfaceSyncGroup,
        boolean syncBuffer,
        boolean didProduceBuffer) {
      if (ViewRootImpl.DEBUG_BLAST) {
        Log.m98i(
            ViewRootImpl.this.mTag,
            "Received frameCommittedCallback lastAttemptedDrawFrameNum="
                + frame
                + " didProduceBuffer="
                + didProduceBuffer);
      }
  ...
  private void safeguardOverlappingSyncs(final SurfaceSyncGroup activeSurfaceSyncGroup) {
    ...
    String safeguardSsgInfo =
        safeguardSsg.getName()
            + " @ "
            + sdf.format(Long.valueOf(Calendar.getInstance().getTimeInMillis()));
    String str = this.mTag;
    StringBuilder append =
        new StringBuilder()
            .append("New safeguard sync group ")
            .append(safeguardSsgInfo)
            .append(", mPreviousSyncSafeguard=");
        ...
        append
            .append(
                surfaceSyncGroup != null
                    ? surfaceSyncGroup.getName()
                    : SemCapabilities.FEATURE_TAG_NULL)
            .append(", mFirstPreviousSyncSafeguardInfo=")
            .append(this.mFirstPreviousSyncSafeguardInfo)
            .toString());
    ...
    synchronized (this.mPreviousSyncSafeguardLock) {
      ...
      if (surfaceSyncGroup2 != null) {
        ...
        this.mPreviousSyncSafeguard.addSyncCompleteCallback(
            this.mSimpleExecutor,
            new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda4
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public SurfaceSyncGroup getOrCreateSurfaceSyncGroup() {
    ...
    if (this.mActiveSurfaceSyncGroup == null) {
      ...
      surfaceSyncGroup.setAddedToSyncListener(
          new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    if (DEBUG_BLAST) {
      if (newSyncGroup) {
        Log.m98i(
            this.mTag, "Creating new active sync group " + this.mActiveSurfaceSyncGroup.getName());
      } else {
        Log.m94d(
            this.mTag,
            "Return already created active sync group " + this.mActiveSurfaceSyncGroup.getName());
      }
    }
  ...
  public /* synthetic */ void lambda$getOrCreateSurfaceSyncGroup$15() {
    Runnable runnable =
        new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda20
          @Override // java.lang.Runnable
          public final void run() {
  ...
  private void updateSyncInProgressCount(SurfaceSyncGroup syncGroup) {
    ...
    syncGroup.addSyncCompleteCallback(
        this.mSimpleExecutor,
        new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void requestRecomputeViewAttributes() {
    if (this.mIsInTraversal) {
      this.mHandler.post(
          new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public boolean updateAppliedLetterboxDirection(int direction) {
    ...
    if (updated) {
      ...
      Log.m100v(
          this.mTag,
          "updateAppliedLetterboxDirection, direction="
              + this.mAppliedLetterboxDirection
              + ", Caller="
              + Debug.getCaller());
    }
    return updated;
  ...
  final class SmartClipRemoteRequestDispatcherProxy {
    ...
    public SmartClipRemoteRequestDispatcherProxy(Context context) {
      this.DEBUG = false;
      SmartClipRemoteRequestDispatcher.ViewRootImplGateway viewRootImplGateway =
          new SmartClipRemoteRequestDispatcher
              .ViewRootImplGateway() { // from class:
                                       // android.view.ViewRootImpl.SmartClipRemoteRequestDispatcherProxy.1
            @Override // com.samsung.android.content.smartclip.SmartClipRemoteRequestDispatcher.ViewRootImplGateway
            public void enqueueInputEvent(
                InputEvent event,
      ...
      SmartClipRemoteRequestDispatcher smartClipRemoteRequestDispatcher =
          new SmartClipRemoteRequestDispatcher(context, viewRootImplGateway);
    ...
    public void dispatchSmartClipRemoteRequest(final SmartClipRemoteRequestInfo request) {
      if (this.DEBUG) {
        Log.m98i(
            "SmartClipRemoteRequestDispatcher_ViewRootImpl",
            "dispatchSmartClipRemoteRequest : req id="
                + request.mRequestId
                + " type="
      ...
      switch (request.mRequestType) {
        case 1:
          this.mDispatcher.checkPermission(
              "com.samsung.android.permission.EXTRACT_SMARTCLIP_DATA",
              request.mCallerPid,
              request.mCallerUid);
          ViewRootImpl.this.mHandler.post(
              new Runnable() { // from class:
                               // android.view.ViewRootImpl.SmartClipRemoteRequestDispatcherProxy.2
                @Override // java.lang.Runnable
                public void run() {
                  SmartClipRemoteRequestDispatcherProxy.this.dispatchSmartClipMetaDataExtraction(
                      request);
                }
              });
          break;
    ...
    public void dispatchSmartClipMetaDataExtraction(SmartClipRemoteRequestInfo request) {
      ...
      if (ViewRootImpl.this.mView != null) {
        SmartClipDataCropperImpl cropper =
            new SmartClipDataCropperImpl(ViewRootImpl.this.mView.getContext(), requestInfo);
        cropper.doExtractSmartClipData(ViewRootImpl.this.mView);
      } else {
        SmartClipDataCropperImpl cropper2 =
            new SmartClipDataCropperImpl(this.mContext, requestInfo);
  ...
  public void dispatchSmartClipRemoteRequest(SmartClipRemoteRequestInfo request) {
    SmartClipRemoteRequestDispatcherProxy smartClipRemoteRequestDispatcherProxy =
        this.mSmartClipDispatcherProxy;
    if (smartClipRemoteRequestDispatcherProxy != null) {
      ...
      Log.m96e(
          TAG,
          "dispatchSmartClipRemoteRequest : SmartClip dispatcher is null! req id="
              + request.mRequestId
              + " type="
              + request.mRequestType);
    }
  ...
  public void handleDispatchSPenGestureEvent(InputEvent[] events) {
    ...
    for (final InputEvent event : events) {
      if (event != null) {
        Runnable runnable =
            new Runnable() { // from class: android.view.ViewRootImpl$$ExternalSyntheticLambda12
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public boolean isWheelScrollingHandled(MotionEvent event) {
    switch (event.getAction()) {
      ...
      case 2:
        ...
        if (Math.abs(event.getY() - this.mFlexPanelScrollY)
            > ViewConfiguration.get(this.mContext).getScaledTouchSlop() + 1) {
