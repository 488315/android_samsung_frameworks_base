    ...
    public static String readDataFromAccessibilityProvider(Context context, String key) {
        ...
        try {
            try {
                ...
                Uri uri = CONTENT_URI;
                ContentProviderClient acquireContentProviderClient = resolver.acquireContentProviderClient(uri);
                mClient = acquireContentProviderClient;
                if (acquireContentProviderClient != null) {
                    Cursor query = acquireContentProviderClient.query(uri, SELECT_PROJECTION, "name=?", new String[]{key}, null);
                    cursor = query;
                    if (query != null) {
                        query.moveToFirst();
