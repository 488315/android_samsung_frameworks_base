...
public final class AccessibilityInteractionClient extends IAccessibilityInteractionConnectionCallback.Stub {
    ...
    public SparseArray<List<AccessibilityWindowInfo>> getWindowsOnAllDisplays(int connectionId) {
        ...
        try {
            ...
            Log.m97e("AccessibilityInteractionClient", "Error while calling remote getWindowsOnAllDisplays", re);
        }
    ...
    public List<AccessibilityWindowInfo> getWindowsOnMainDisplays(int connectionId) {
        try {
            ...
            Log.m97e("AccessibilityInteractionClient", "Error while calling remote getWindowsOnMainDisplays", re);
            return null;
        }
    }
    ...
    public AccessibilityNodeInfo findAccessibilityNodeInfoByAccessibilityId(int connectionId, IBinder leashToken, long accessibilityNodeId, boolean bypassCache, int prefetchFlags, Bundle arguments) {
        ...
        try {
            ...
            Log.m97e("AccessibilityInteractionClient", "Error while calling remote getWindowIdForLeashToken", re);
        }
        if (windowId == -1) {
            return null;
        }
        ...
        try {
            ...
            if (bypassCache) {
                ...
                try {
                    ...
                    Log.m97e("AccessibilityInteractionClient", "Error while calling remote findAccessibilityNodeInfoByAccessibilityId", re);
                    return null;
                }
            }
            try {
