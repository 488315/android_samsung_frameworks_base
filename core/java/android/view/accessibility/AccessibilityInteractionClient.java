...
public final class AccessibilityInteractionClient
  ...
  public static int addDirectConnection(
      IAccessibilityInteractionConnection connection, AccessibilityManager accessibilityManager) {
    int connectionId;
    SparseArray<IAccessibilityServiceConnection> sparseArray = sConnectionCache;
    synchronized (sparseArray) {
  ...
  public AccessibilityWindowInfo getWindow(
    ...
    try {
      ...
      Log.m97e("AccessibilityInteractionClient", "Error while calling remote getWindow", re);
      return null;
    }
  }
  ...
  */
        ...
        try {
          ...
          if (cache != null) {
            AccessibilityNodeInfo cachedInfo =
                cache.getNode(accessibilityWindowId, accessibilityNodeId);
            if (cachedInfo != null) {
              if (shouldTraceClient()) {
                logTraceClient(
                    connection2,
          ...
          Log.m97e(
              "AccessibilityInteractionClient",
              "Error while calling remote findAccessibilityNodeInfoByAccessibilityId",
              re);
          return null;
        }
      }
          ...
          try {
            if (isWindowScrolling(accessibilityWindowId)) {
              ...
              if ((descendantPrefetchFlags & (descendantPrefetchFlags - 1)) == 0) {
                throw new IllegalArgumentException(
                    "There can be no more than one descendant prefetching strategy");
              }
              try {
                ...
                if (shouldTraceClient()) {
                  try {
                    ...
                    try {
                      accessibilityInteractionClient.logTraceClient(
                          connection,
                          str,
                          "InteractionId:"
                              + interactionId
                ...
                try {
                  ...
                  try {
                    String[] packageNames =
                        connection.findAccessibilityNodeInfoByAccessibilityId(
                            accessibilityWindowId,
                            accessibilityNodeId,
                            interactionId,
                            this,
                    ...
                    if (packageNames != null) {
                      if ((prefetchFlags5 & 32) == 0) {
                        ...
                        if (shouldTraceCallback()) {
                          accessibilityInteractionClient.logTraceCallback(
                              connection3,
                              str2,
                              "InteractionId:"
                                  + interactionId
                        ...
                        if ((prefetchFlags5 & 63) != 0 && info != null) {
                          accessibilityInteractionClient.setInteractionWaitingForPrefetchResult(
                              interactionId, connectionId, packageNames);
                        }
                        accessibilityInteractionClient.finalizeAndCacheAccessibilityNodeInfo(
                      ...
                      accessibilityInteractionClient.finalizeAndCacheAccessibilityNodeInfos(
                ...
                (Consumer<ScreenCapture.ScreenshotHardwareBuffer>)
                    new Consumer() { // from class:
                      ...
                      public final void accept(Object obj) {
                        AccessibilityInteractionClient.this.lambda$takeScreenshotOfWindow$1(
                            interactionId, (ScreenCapture.ScreenshotHardwareBuffer) obj);
                      }
                    });
  ...
  public AccessibilityNodeInfo findFocus(
    ...
    try {
      ...
      if (connection != null) {
        AccessibilityCache cache = getCache(connectionId);
        if (cache != null
            && (cachedInfo = cache.getFocus(focusType, accessibilityNodeId, accessibilityWindowId))
                != null) {
          return cachedInfo;
        }
        int interactionId = this.mInteractionIdCounter.getAndIncrement();
  ...
  public void lambda$takeScreenshotOfWindow$1(
  ...
  private void finalizeAndCacheAccessibilityNodeInfo(
      AccessibilityNodeInfo info, int connectionId, boolean bypassCache, String[] packageNames) {
  ...
  private void checkFindAccessibilityNodeInfoResultIntegrity(List<AccessibilityNodeInfo> infos) {
    ...
    if (root == null) {
      Log.m96e("AccessibilityInteractionClient", "No root.");
    }
    ...
    while (!fringe.isEmpty()) {
      ...
      if (!seen.add(current)) {
        Log.m96e("AccessibilityInteractionClient", "Duplicate node.");
        return;
      }
    ...
    if (disconnectedCount > 0) {
      Log.m96e("AccessibilityInteractionClient", disconnectedCount + " Disconnected nodes.");
    }
  }
  ...
  private boolean shouldTraceClient() {
    ...
    return accessibilityManager != null
        && accessibilityManager.isA11yInteractionClientTraceEnabled();
  }

  private boolean shouldTraceCallback() {
    AccessibilityManager accessibilityManager = this.mAccessibilityManager;
    return accessibilityManager != null
        && accessibilityManager.isA11yInteractionConnectionCBTraceEnabled();
  }
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          e = e;
          Log.m96e("AccessibilityInteractionClient", "Failed to log trace. " + e);
        }
      } catch (RemoteException e2) {
        e = e2;
      }
  ...
  public void attachAccessibilityOverlayToWindow(
    ...
    synchronized (this.mInstanceLock) {
      ...
      if (connection == null) {
        Log.m96e("AccessibilityInteractionClient", "Error while getting service connection.");
      } else {
