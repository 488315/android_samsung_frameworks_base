...
public interface IWindowMagnificationConnection extends IInterface {
  ...
  public static class Default implements IWindowMagnificationConnection {
    ...
    public void disableWindowMagnification(
        int displayId, IRemoteMagnificationAnimationCallback callback) throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IWindowMagnificationConnection {
          ...
          switch (code) {
            case 1:
              ...
              IRemoteMagnificationAnimationCallback _arg6 =
                  IRemoteMagnificationAnimationCallback.Stub.asInterface(data.readStrongBinder());
            ...
            case 8:
              ...
              return true;
            case 9:
              IWindowMagnificationConnectionCallback _arg09 =
                  IWindowMagnificationConnectionCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
