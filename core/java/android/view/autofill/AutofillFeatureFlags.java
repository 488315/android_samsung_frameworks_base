...
public class AutofillFeatureFlags {
    ...
    public static final String f579x39c3202f = "autofill_credential_manager_suppress_fill_and_save_dialog";
    ...
    public static final String f580x412b2c8c = "include_all_autofill_type_not_none_views_in_assist_structure";
    ...
    public static final String f581x4542a29f = "package_and_activity_allowlist_for_triggering_fill_request";
