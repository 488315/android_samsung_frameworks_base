...
public interface IAutoFillManager extends IInterface {
  ...
  void updateSession(
      int i, AutofillId autofillId, Rect rect, AutofillValue autofillValue, int i2, int i3, int i4)
      throws RemoteException;
  ...
  public static class Default implements IAutoFillManager {
    ...
    public void setAuthenticationResult(
        Bundle data, int sessionId, int authenticationId, int userId) throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 3:
              ...
              data.enforceNoDataAvail();
              startSession(
                  _arg03, _arg13, _arg22, _arg32, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10);
              return true;
            case 4:
