...
public class InsetsResizeAnimationRunner
  ...
  public InsetsResizeAnimationRunner(
    ...
    WindowInsetsAnimation windowInsetsAnimation =
        new WindowInsetsAnimation(types, interpolator, duration);
  ...
  public void onReady(WindowInsetsAnimationController controller, int types) {
    ...
    this.mAnimator.addListener(
        new AnimatorListenerAdapter() { // from class: android.view.InsetsResizeAnimationRunner.1
  ...
  public boolean applyChangeInsets(final InsetsState outState) {
    ...
    InsetsState.traverse(
        ...
        this.mToState,
        new InsetsState
            .OnTraverseCallbacks() { // from class: android.view.InsetsResizeAnimationRunner.2
