...
public interface IWindow extends IInterface {
  ...
  public static class Default implements IWindow {
    ...
    public void dispatchWallpaperCommand(
        String action, int x, int y, int z, Bundle extras, boolean sync) throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IWindow {
        ...
        default:
          switch (code) {
            ...
            case 3:
              ...
              InsetsSourceControl[] _arg13 =
                  (InsetsSourceControl[]) data.createTypedArray(InsetsSourceControl.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 15:
              ...
              return true;
            case 16:
              IScrollCaptureResponseListener _arg014 =
    ...
    private static class Proxy implements IWindow {
      ...
      public void insetsControlChanged(
          InsetsState insetsState, InsetsSourceControl[] activeControls) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
          _data.writeTypedObject(insetsState, 0);
