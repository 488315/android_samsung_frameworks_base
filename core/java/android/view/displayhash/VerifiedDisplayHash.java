...
public final class VerifiedDisplayHash implements Parcelable {
  public static final Parcelable.Creator<VerifiedDisplayHash> CREATOR =
      new Parcelable.Creator<
          VerifiedDisplayHash>() { // from class: android.view.displayhash.VerifiedDisplayHash.1
  ...
  public VerifiedDisplayHash(
      long timeMillis, Rect boundsInWindow, String hashAlgorithm, byte[] imageHash) {
    this.mTimeMillis = timeMillis;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) CurrentTimeMillisLong.class, (Annotation) null, timeMillis);
    this.mBoundsInWindow = boundsInWindow;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) boundsInWindow);
    this.mHashAlgorithm = hashAlgorithm;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) hashAlgorithm);
    this.mImageHash = imageHash;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) imageHash);
  }
  ...
  public String toString() {
    return "VerifiedDisplayHash { timeMillis = "
        + this.mTimeMillis
        + ", boundsInWindow = "
