...
public abstract class DisplayEventReceiver {
  ...
  private static final NativeAllocationRegistry sNativeAllocationRegistry =
      NativeAllocationRegistry.createMalloced(
          DisplayEventReceiver.class.getClassLoader(), nativeGetDisplayEventReceiverFinalizer());
  ...
  public DisplayEventReceiver(
    ...
    long nativeInit =
        nativeInit(
            ...
            new WeakReference(vsyncEventData),
            this.mMessageQueue,
            vsyncSource,
            eventRegistration,
            layerHandle);
    ...
    this.mFreeNativeResources =
        sNativeAllocationRegistry.registerNativeAllocation(this, nativeInit);
  }
  ...
  public void onVsync(
      long timestampNanos, long physicalDisplayId, int frame, VsyncEventData vsyncEventData) {}
  ...
  public void scheduleVsync() {
    ...
    if (j == 0) {
      Log.m102w(
          TAG,
          "Attempted to schedule a vertical sync pulse but the display event receiver has already"
              + " been disposed.");
    } else {
