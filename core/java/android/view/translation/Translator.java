...
public class Translator {
  ...
  public Translator(
    ...
    try {
      this.mSystemServerBinder.onSessionCreated(
          translationContext, this.mId, serviceBinderReceiver, context.getUserId());
    } catch (RemoteException e) {
      Log.m102w(TAG, "RemoteException calling startSession(): " + e);
    }
  }
  ...
  public void translate(
    ...
    try {
      ...
      Log.m102w(TAG, "RemoteException calling requestTranslate(): " + e);
    }
  }
  ...
  public void destroy() {
    synchronized (this.mLock) {
      ...
      try {
        ...
        Log.m102w(TAG, "RemoteException calling onSessionFinished");
      }
  ...
  public void requestUiTranslate(
    ...
    try {
      ...
      Log.m102w(TAG, "RemoteException calling flushRequest");
    }
  }
  ...
  static class TranslationResponseCallbackImpl extends ITranslationCallback.Stub {
    ...
    public void onTranslationResponse(final TranslationResponse response) throws RemoteException {
      if (Log.isLoggable(UiTranslationManager.LOG_TAG, 3)) {
        Log.m98i(Translator.TAG, "onTranslationResponse called.");
      }
      Runnable runnable =
          new Runnable() { // from class:
            ...
            public final void run() {
              Translator.TranslationResponseCallbackImpl.this.lambda$onTranslationResponse$0(
                  response);
            }
          };
