...
public interface ITranslationManager extends IInterface {
    ...
    void onTranslationCapabilitiesRequest(int i, int i2, ResultReceiver resultReceiver, int i3)
            throws RemoteException;

    void onTranslationFinished(boolean z, IBinder iBinder, ComponentName componentName, int i)
            throws RemoteException;

    void registerTranslationCapabilityCallback(IRemoteCallback iRemoteCallback, int i)
            throws RemoteException;

    void registerUiTranslationStateCallback(IRemoteCallback iRemoteCallback, int i)
            throws RemoteException;

    void unregisterTranslationCapabilityCallback(IRemoteCallback iRemoteCallback, int i)
            throws RemoteException;

    void unregisterUiTranslationStateCallback(IRemoteCallback iRemoteCallback, int i)
            throws RemoteException;
    ...
    public static class Default implements ITranslationManager {
        ...
        public void onTranslationCapabilitiesRequest(
                int sourceFormat, int destFormat, ResultReceiver receiver, int userId)
                throws RemoteException {}
        ...
        public void onTranslationFinished(
                boolean activityDestroyed, IBinder token, ComponentName componentName, int userId)
                throws RemoteException {}
    ...
    public abstract static class Stub extends Binder implements ITranslationManager {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    updateUiTranslationState(
                            _arg05, _arg15, _arg23, _arg33, _arg4, _arg5, _arg6, _arg7);
                    return true;
                case 6:
                    IRemoteCallback _arg06 =
                            IRemoteCallback.Stub.asInterface(data.readStrongBinder());
        ...
        private static class Proxy implements ITranslationManager {
            ...
            @Override // android.view.translation.ITranslationManager
            public void unregisterTranslationCapabilityCallback(
                    IRemoteCallback callback, int userId) throws RemoteException {
                Parcel _data = Parcel.obtain(asBinder());
                try {
                    _data.writeInterfaceToken(ITranslationManager.DESCRIPTOR);
                    _data.writeStrongInterface(callback);
