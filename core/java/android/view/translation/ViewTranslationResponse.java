...
public final class ViewTranslationResponse implements Parcelable {
  ...
  ViewTranslationResponse(
      AutofillId autofillId, Map<String, TranslationResponseValue> translationResponseValues) {
    this.mAutofillId = autofillId;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) autofillId);
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(this.mAutofillId, that.mAutofillId)
        && Objects.equals(this.mTranslationResponseValues, that.mTranslationResponseValues)) {
      return true;
    }
    return false;
  }
