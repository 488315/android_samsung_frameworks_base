...
public final class TranslationManager {
  ...
  public /* synthetic */ void lambda$createOnDeviceTranslator$4(
      final Executor executor, final Consumer callback, int tId, final Translator translator) {
    if (translator == null) {
  ...
  public Translator createOnDeviceTranslator(TranslationContext translationContext) {
    ...
    synchronized (this.mLock) {
      ...
      Translator newTranslator =
          new Translator(
              this.mContext, translationContext, translatorId, this, this.mHandler, this.mService);
      newTranslator.start();
      try {
        ...
        Log.m96e(TAG, "Timed out getting create session: " + e);
        return null;
      }
    }
  }
  ...
  public Set<TranslationCapability> getOnDeviceTranslationCapabilities(
    ...
    try {
      ...
      ParceledListSlice<TranslationCapability> listSlice =
          (ParceledListSlice)
              result.bundle.getParcelable(EXTRA_CAPABILITIES, ParceledListSlice.class);
      ...
      Log.m96e(TAG, "Timed out getting supported translation capabilities: " + e2);
      return Collections.emptySet();
    }
  }
          ...
          .computeIfAbsent(
              ...
              new Function() { // from class:
                ...
                public final Object apply(Object obj) {
                  return TranslationManager.lambda$addOnDeviceTranslationCapabilityUpdateListener$5(
                      (Pair) obj);
                }
              })
          .add(pendingIntent);
  ...
  public void removeOnDeviceTranslationCapabilityUpdateListener(
    ...
    synchronized (this.mLock) {
      ...
      if (remoteCallback == null) {
        Log.m102w(
            TAG,
            "removeOnDeviceTranslationCapabilityUpdateListener: the capability listener not found;"
                + " ignoring.");
        return;
      }
      try {
  ...
  public PendingIntent getOnDeviceTranslationSettingsActivityIntent() {
    ...
    try {
      ...
      try {
        ...
        Log.m96e(TAG, "Fail to get translation service settings activity.");
        return null;
      }
    ...
    public void sendResult(final Bundle bundle) {
      Binder.withCleanCallingIdentity(
          new FunctionalUtils
            ...
            @Override // com.android.internal.util.FunctionalUtils.ThrowingRunnable
            public final void runOrThrow() {
              TranslationManager.TranslationCapabilityRemoteCallback.this.lambda$sendResult$1(
                  bundle);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$sendResult$1(final Bundle bundle) throws Exception {
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              TranslationManager.TranslationCapabilityRemoteCallback.this.lambda$sendResult$0(
                  bundle);
            }
          });
    }
      ...
      TranslationCapability capability =
          (TranslationCapability)
              bundle.getParcelable(
                  TranslationManager.EXTRA_CAPABILITIES, TranslationCapability.class);
