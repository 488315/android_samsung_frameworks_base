...
public final class TranslationRequest implements Parcelable {
  public static final Parcelable.Creator<TranslationRequest> CREATOR =
      new Parcelable.Creator<
          TranslationRequest>() { // from class: android.view.translation.TranslationRequest.1
  ...
  TranslationRequest(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) translationRequestValues);
    this.mViewTranslationRequests = viewTranslationRequests;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) viewTranslationRequests);
  }
  ...
  TranslationRequest(Parcel in) {
    ...
    in.readParcelableList(
        arrayList, TranslationRequestValue.class.getClassLoader(), TranslationRequestValue.class);
    ArrayList arrayList2 = new ArrayList();
    in.readParcelableList(
        arrayList2, ViewTranslationRequest.class.getClassLoader(), ViewTranslationRequest.class);
    this.mFlags = flags;
    Preconditions.checkFlagsArgument(flags, 15);
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) arrayList2);
  }
    ...
    public TranslationRequest build() {
      ...
      TranslationRequest o =
          new TranslationRequest(
              this.mFlags, this.mTranslationRequestValues, this.mViewTranslationRequests);
      return o;
    }
