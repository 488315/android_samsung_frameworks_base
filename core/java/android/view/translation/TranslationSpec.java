...
public final class TranslationSpec implements Parcelable {
  ...
  TranslationSpec(Parcel in) {
    ...
    AnnotationValidations.validate(
        (Class<? extends Annotation>) Deprecated.class, (Annotation) null, language);
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) language);
    this.mLocale = locale;
    AnnotationValidations.validate((Class<NonNull>) NonNull.class, (NonNull) null, (Object) locale);
    this.mDataFormat = dataFormat;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) DataFormat.class, (Annotation) null, dataFormat);
  }
