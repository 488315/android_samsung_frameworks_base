...
public final class TranslationCapability implements Parcelable {
  public static final Parcelable.Creator<TranslationCapability> CREATOR =
      new Parcelable.Creator<
          TranslationCapability>() { // from class: android.view.translation.TranslationCapability.1
  ...
  TranslationCapability(Parcel in) {
    ...
    if (state != 1 && state != 2 && state != 3 && state != 4 && state != 1000) {
      throw new IllegalArgumentException(
          "state was "
              + state
              + " but must be one of: STATE_AVAILABLE_TO_DOWNLOAD(1), STATE_DOWNLOADING(2),"
              + " STATE_ON_DEVICE(3), STATE_NOT_AVAILABLE(4), STATE_REMOVED_AND_AVAILABLE(1000"
