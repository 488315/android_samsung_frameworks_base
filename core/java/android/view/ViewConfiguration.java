...
public class ViewConfiguration {
  ...
  private ViewConfiguration(Context context) {
    ...
    int dimensionPixelSize =
        res.getDimensionPixelSize(C4337R.dimen.config_viewConfigurationTouchSlop);
    this.mTouchSlop = dimensionPixelSize;
    this.mHandwritingSlop =
        res.getDimensionPixelSize(C4337R.dimen.config_viewConfigurationHandwritingSlop);
    this.mHoverSlop = res.getDimensionPixelSize(C4337R.dimen.config_viewConfigurationHoverSlop);
    this.mMinScrollbarTouchTarget =
        res.getDimensionPixelSize(C4337R.dimen.config_minScrollbarTouchTarget);
    ...
    this.mMinimumFlingVelocity =
        res.getDimensionPixelSize(C4337R.dimen.config_viewMinFlingVelocity);
    this.mMaximumFlingVelocity =
        res.getDimensionPixelSize(C4337R.dimen.config_viewMaxFlingVelocity);
    int configMinRotaryEncoderFlingVelocity =
        res.getDimensionPixelSize(C4337R.dimen.config_viewMinRotaryEncoderFlingVelocity);
    int configMaxRotaryEncoderFlingVelocity =
        res.getDimensionPixelSize(C4337R.dimen.config_viewMaxRotaryEncoderFlingVelocity);
    ...
    this.mHorizontalScrollFactor =
        res.getDimensionPixelSize(C4337R.dimen.config_horizontalScrollFactor);
    this.mVerticalScrollFactor =
        res.getDimensionPixelSize(C4337R.dimen.config_verticalScrollFactor);
    this.mShowMenuShortcutsWhenKeyboardPresent =
        res.getBoolean(C4337R.bool.config_showMenuShortcutsWhenKeyboardPresent);
    this.mMinScalingSpan = res.getDimensionPixelSize(C4337R.dimen.config_minScalingSpan);
    this.mScreenshotChordKeyTimeout =
        res.getInteger(C4337R.integer.config_screenshotChordKeyTimeout);
    this.mSmartSelectionInitializedTimeout =
        res.getInteger(C4337R.integer.config_smartSelectionInitializedTimeoutMillis);
    this.mSmartSelectionInitializingTimeout =
        res.getInteger(C4337R.integer.config_smartSelectionInitializingTimeoutMillis);
    this.mPreferKeepClearForFocusEnabled =
        res.getBoolean(C4337R.bool.config_preferKeepClearForFocus);
  }
  ...
  public int getScaledMinimumScalingSpan() {
    if (!this.mConstructedWithContext) {
      throw new IllegalStateException(
          "Min scaling span cannot be determined when this method is called on a ViewConfiguration"
              + " that was instantiated using a constructor with no Context parameter");
    }
