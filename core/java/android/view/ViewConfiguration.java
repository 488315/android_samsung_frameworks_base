...
public class ViewConfiguration {
    ...
    private ViewConfiguration(Context context) {
        ...
        this.mScrollbarSize = res.getDimensionPixelSize(C4337R.dimen.config_scrollbarSize);
        ...
        res.getValue(C4337R.dimen.config_ambiguousGestureMultiplier, multiplierValue, true);
        ...
        if (!this.sHasPermanentMenuKeySet) {
            int configVal = res.getInteger(C4337R.integer.config_overrideHasPermanentMenuKey);
            switch (configVal) {
                case 1:
        ...
        this.mFadingMarqueeEnabled = res.getBoolean(C4337R.bool.config_ui_enableFadingMarquee);
        int dimensionPixelSize = res.getDimensionPixelSize(C4337R.dimen.config_viewConfigurationTouchSlop);
        this.mTouchSlop = dimensionPixelSize;
        this.mHandwritingSlop = res.getDimensionPixelSize(C4337R.dimen.config_viewConfigurationHandwritingSlop);
        this.mHoverSlop = res.getDimensionPixelSize(C4337R.dimen.config_viewConfigurationHoverSlop);
        this.mMinScrollbarTouchTarget = res.getDimensionPixelSize(C4337R.dimen.config_minScrollbarTouchTarget);
        ...
        this.mMinimumFlingVelocity = res.getDimensionPixelSize(C4337R.dimen.config_viewMinFlingVelocity);
        this.mMaximumFlingVelocity = res.getDimensionPixelSize(C4337R.dimen.config_viewMaxFlingVelocity);
        int configMinRotaryEncoderFlingVelocity = res.getDimensionPixelSize(C4337R.dimen.config_viewMinRotaryEncoderFlingVelocity);
        int configMaxRotaryEncoderFlingVelocity = res.getDimensionPixelSize(C4337R.dimen.config_viewMaxRotaryEncoderFlingVelocity);
        ...
        this.mGlobalActionsKeyTimeout = res.getInteger(C4337R.integer.config_globalActionsKeyTimeout);
        this.mHorizontalScrollFactor = res.getDimensionPixelSize(C4337R.dimen.config_horizontalScrollFactor);
        this.mVerticalScrollFactor = res.getDimensionPixelSize(C4337R.dimen.config_verticalScrollFactor);
        this.mShowMenuShortcutsWhenKeyboardPresent = res.getBoolean(C4337R.bool.config_showMenuShortcutsWhenKeyboardPresent);
        this.mMinScalingSpan = res.getDimensionPixelSize(C4337R.dimen.config_minScalingSpan);
        this.mScreenshotChordKeyTimeout = res.getInteger(C4337R.integer.config_screenshotChordKeyTimeout);
        this.mSmartSelectionInitializedTimeout = res.getInteger(C4337R.integer.config_smartSelectionInitializedTimeoutMillis);
        this.mSmartSelectionInitializingTimeout = res.getInteger(C4337R.integer.config_smartSelectionInitializingTimeoutMillis);
        this.mPreferKeepClearForFocusEnabled = res.getBoolean(C4337R.bool.config_preferKeepClearForFocus);
    }
