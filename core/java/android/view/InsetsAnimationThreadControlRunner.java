...
public class InsetsAnimationThreadControlRunner implements InsetsAnimationControlRunner {
  ...
  class InsetsAnimationControlCallbacksC36351 implements InsetsAnimationControlCallbacks {
    private final float[] mTmpFloat9 = new float[9];

    InsetsAnimationControlCallbacksC36351() {}
    ...
    public void notifyFinished(InsetsAnimationControlRunner runner, final boolean shown) {
      ...
      InsetsAnimationThreadControlRunner insetsAnimationThreadControlRunner =
          InsetsAnimationThreadControlRunner.this;
      insetsAnimationThreadControlRunner.releaseControls(
          insetsAnimationThreadControlRunner.mControl.getControls());
      InsetsAnimationThreadControlRunner.this.mMainThreadHandler.post(
          new Runnable() { // from class:
            ...
            public final void run() {
              InsetsAnimationThreadControlRunner.InsetsAnimationControlCallbacksC36351.this
                  .lambda$notifyFinished$0(shown);
            }
          });
    }
    ...
    public void reportPerceptible(final int types, final boolean perceptible) {
      InsetsAnimationThreadControlRunner.this.mMainThreadHandler.post(
          new Runnable() { // from class:
            ...
            public final void run() {
              InsetsAnimationThreadControlRunner.InsetsAnimationControlCallbacksC36351.this
                  .lambda$reportPerceptible$1(types, perceptible);
            }
          });
    }
  }

  public InsetsAnimationThreadControlRunner(
    ...
    InsetsAnimationControlCallbacksC36351 insetsAnimationControlCallbacksC36351 =
        new InsetsAnimationControlCallbacksC36351();
    this.mCallbacks = insetsAnimationControlCallbacksC36351;
    ...
    this.mControl =
        new InsetsAnimationControlImpl(
            ...
            translator,
            statsToken);
    InsetsAnimationThread.getHandler()
        .post(
            new Runnable() { // from class:
  ...
  public void releaseControls(SparseArray<InsetsSourceControl> controls) {
    for (int i = controls.size() - 1; i >= 0; i--) {
      controls
          .valueAt(i)
          .release(new InsetsAnimationThreadControlRunner$$ExternalSyntheticLambda0());
    }
  }
