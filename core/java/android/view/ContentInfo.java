...
public final class ContentInfo implements Parcelable {
  ...
  public Pair<ContentInfo, ContentInfo> partition(Predicate<ClipData.Item> itemPredicate) {
    ...
    ContentInfo accepted =
        new Builder(this)
            .setClip(new ClipData(new ClipDescription(this.mClip.getDescription()), acceptedItems))
            .build();
    ContentInfo remaining =
        new Builder(this)
            .setClip(new ClipData(new ClipDescription(this.mClip.getDescription()), remainingItems))
            .build();
