...
public final class ThreadedRenderer extends HardwareRenderer {
  ...
  ThreadedRenderer(Context context, boolean translucent, String name) {
    ...
    TypedArray a = context.obtainStyledAttributes(null, C4337R.styleable.Lighting, 0, 0);
    if (SemViewUtils.isFoldDevice() || SemViewUtils.isTablet()) {
      this.mLightY = context.getResources().getDimensionPixelSize(C4337R.dimen.sem_light_y);
    ...
    if (CoreRune.MW_CAPTION_SHELL_DEX) {
      ...
      this.mDesktopLightY = context.getResources().getDimensionPixelSize(C4337R.dimen.sem_light_y);
    }
  ...
  private void updateRootDisplayList(View view, DrawCallbacks callbacks) {
    ...
    if (this.mNextRtFrameCallbacks != null) {
      ...
      setFrameCallback(new C36941(frameCallbacks));
    }
  ...
  class C36941 implements HardwareRenderer.FrameDrawingCallback {
    final /* synthetic */ ArrayList val$frameCallbacks;

    C36941(ArrayList arrayList) {
    ...
    public HardwareRenderer.FrameCommitCallback onFrameDraw(int syncResult, long frame) {
      ...
      return new HardwareRenderer
        ...
        public final void onFrameCommit(boolean z) {
          ThreadedRenderer.C36941.lambda$onFrameDraw$0(frameCommitCallbacks, z);
        }
      };
    }
  ...
  void draw(View view, View.AttachInfo attachInfo, DrawCallbacks callbacks) {
    ...
    if ((syncResult & 2) != 0) {
      Log.m102w("OpenGLRenderer", "Surface lost, forcing relayout");
  ...
  public static class SimpleRenderer extends HardwareRenderer {
    ...
    public SimpleRenderer(Context context, String name, Surface surface) {
      ...
      if (CoreRune.MW_CAPTION_SHELL_DEX) {
        this.mContext = context;
        this.mDesktopLightY =
            context.getResources().getDimensionPixelSize(C4337R.dimen.sem_light_y);
      }
      this.mLightRadius = a.getDimension(2, 0.0f);
      float ambientShadowAlpha = a.getFloat(0, 0.0f);
      float spotShadowAlpha = a.getFloat(1, 0.0f);
  ...
  public static boolean isInDexDisplay(Context context) {
    return CoreRune.MW_CAPTION_SHELL_DEX
        && context.getResources().getConfiguration().isDesktopModeEnabled()
        && context.getDisplayId() != 0;
  }
}
