...
public final class DisplayCutout {
    ...
    private static class Bounds {
        ...
        private Bounds(Rect left, Rect top, Rect right, Rect bottom, boolean copyArguments) {
            this.mRects = new Rect[]{DisplayCutout.getCopyOrRef(left, copyArguments), DisplayCutout.getCopyOrRef(top, copyArguments), DisplayCutout.getCopyOrRef(right, copyArguments), DisplayCutout.getCopyOrRef(bottom, copyArguments)};
        }
    ...
    public DisplayCutout inset(int insetLeft, int insetTop, int insetRight, int insetBottom) {
        ...
        return new DisplayCutout(safeInsets, Insets.m15of(waterfallInsets), bounds, this.mCutoutPathParserInfo, false);
    }
    ...
    private static Insets getWaterfallInsets(Resources res, String displayUniqueId) {
        ...
        if (index >= 0 && index < array.length() && array.getResourceId(index, 0) > 0) {
            ...
            insets = Insets.m14of(waterfall.getDimensionPixelSize(0, 0), waterfall.getDimensionPixelSize(1, 0), waterfall.getDimensionPixelSize(2, 0), waterfall.getDimensionPixelSize(3, 0));
            waterfall.recycle();
        } else {
    ...
    private static Insets loadWaterfallInset(Resources res) {
        return Insets.m14of(res.getDimensionPixelSize(C4337R.dimen.waterfall_display_left_edge_size), res.getDimensionPixelSize(C4337R.dimen.waterfall_display_top_edge_size), res.getDimensionPixelSize(C4337R.dimen.waterfall_display_right_edge_size), res.getDimensionPixelSize(C4337R.dimen.waterfall_display_bottom_edge_size));
    }
