...
public abstract class Window {
  ...
  public final TypedArray getWindowStyle() {
    ...
    synchronized (this) {
      if (this.mWindowStyle == null) {
        this.mWindowStyle = this.mContext.obtainStyledAttributes(C4337R.styleable.Window);
      }
  ...
  public final void dispatchOnWindowSwipeDismissed() {
    OnWindowSwipeDismissedCallback onWindowSwipeDismissedCallback =
        this.mOnWindowSwipeDismissedCallback;
  ...
  public final boolean onDrawLegacyNavigationBarBackgroundChanged(
    ...
    return decorCallback.onDrawLegacyNavigationBarBackgroundChanged(
  ...
  public final void setHideOverlayWindows(boolean hide) {
    if (this.mContext.checkSelfPermission(Manifest.permission.HIDE_NON_SYSTEM_OVERLAY_WINDOWS) != 0
        && this.mContext.checkSelfPermission(Manifest.permission.HIDE_OVERLAY_WINDOWS) != 0) {
  ...
  public static int getDefaultFeatures(Context context) {
    ...
    if (res.getBoolean(C4337R.bool.config_defaultWindowFeatureOptionsPanel)) {
      features = 0 | 1;
    }
    if (res.getBoolean(C4337R.bool.config_defaultWindowFeatureContextMenu)) {
      return features | 64;
    }
    return features;
  }
