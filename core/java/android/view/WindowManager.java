...
public interface WindowManager extends ViewManager {
  ...
  /* renamed from: PROPERTY_COMPAT_ALLOW_IGNORING_ORIENTATION_REQUEST_WHEN_LOOP_DETECTED */
  public static final String f572x8d62ad7e =
  ...
  @Deprecated public static final int TRANSIT_KEYGUARD_GOING_AWAY = 7;
  ...
  public static final boolean WINDOW_EXTENSIONS_ENABLED =
  ...
  public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
    ...
    public static final Parcelable.Creator<LayoutParams> CREATOR =
        new Parcelable.Creator<
            LayoutParams>() { // from class: android.view.WindowManager.LayoutParams.1
    ...
    @Deprecated public static final int FLAG_DISMISS_KEYGUARD = 4194304;

    @Deprecated public static final int FLAG_DITHER = 4096;
    public static final int FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS = Integer.MIN_VALUE;

    @Deprecated public static final int FLAG_FORCE_NOT_FULLSCREEN = 2048;

    @Deprecated public static final int FLAG_FULLSCREEN = 1024;
    public static final int FLAG_HARDWARE_ACCELERATED = 16777216;
    public static final int FLAG_IGNORE_CHEEK_PRESSES = 32768;
    public static final int FLAG_KEEP_SCREEN_ON = 128;

    @Deprecated public static final int FLAG_LAYOUT_ATTACHED_IN_DECOR = 1073741824;

    @Deprecated public static final int FLAG_LAYOUT_INSET_DECOR = 65536;

    @Deprecated public static final int FLAG_LAYOUT_IN_OVERSCAN = 33554432;
    ...
    @Deprecated public static final int FLAG_SHOW_WHEN_LOCKED = 524288;
    public static final int FLAG_SLIPPERY = 536870912;
    public static final int FLAG_SPLIT_TOUCH = 8388608;

    @Deprecated public static final int FLAG_TOUCHABLE_WHEN_WAKING = 64;

    @Deprecated public static final int FLAG_TRANSLUCENT_NAVIGATION = 134217728;

    @Deprecated public static final int FLAG_TRANSLUCENT_STATUS = 67108864;

    @Deprecated public static final int FLAG_TURN_SCREEN_ON = 2097152;
    ...
    @Deprecated public static final int SOFT_INPUT_ADJUST_RESIZE = 16;
    ...
    @SystemApi public static final int SYSTEM_FLAG_HIDE_NON_SYSTEM_OVERLAY_WINDOWS = 524288;

    @SystemApi public static final int SYSTEM_FLAG_SHOW_FOR_ALL_USERS = 16;
    ...
    @Deprecated public static final int TYPE_PHONE = 2002;
    public static final int TYPE_POINTER = 2018;
    public static final int TYPE_PRESENTATION = 2037;

    @Deprecated public static final int TYPE_PRIORITY_PHONE = 2007;
    ...
    @Deprecated public static final int TYPE_SYSTEM_ALERT = 2003;
    public static final int TYPE_SYSTEM_DIALOG = 2008;
    public static final int TYPE_SYSTEM_DIALOG_EXTENSION = 2412;

    @Deprecated public static final int TYPE_SYSTEM_ERROR = 2010;

    @Deprecated public static final int TYPE_SYSTEM_OVERLAY = 2006;

    @Deprecated public static final int TYPE_TOAST = 2005;
    ...
    @ViewDebug.ExportedProperty(
        flagMapping = {
          @ViewDebug.FlagToString(equals = 1, mask = 1, name = "ALLOW_LOCK_WHILE_SCREEN_ON"),
          @ViewDebug.FlagToString(equals = 2, mask = 2, name = "DIM_BEHIND"),
          @ViewDebug.FlagToString(equals = 4, mask = 4, name = "BLUR_BEHIND"),
          @ViewDebug.FlagToString(equals = 8, mask = 8, name = "NOT_FOCUSABLE"),
          @ViewDebug.FlagToString(equals = 16, mask = 16, name = "NOT_TOUCHABLE"),
          @ViewDebug.FlagToString(equals = 32, mask = 32, name = "NOT_TOUCH_MODAL"),
          @ViewDebug.FlagToString(equals = 64, mask = 64, name = "TOUCHABLE_WHEN_WAKING"),
          @ViewDebug.FlagToString(equals = 128, mask = 128, name = "KEEP_SCREEN_ON"),
          @ViewDebug.FlagToString(equals = 256, mask = 256, name = "LAYOUT_IN_SCREEN"),
          @ViewDebug.FlagToString(equals = 512, mask = 512, name = "LAYOUT_NO_LIMITS"),
          @ViewDebug.FlagToString(equals = 1024, mask = 1024, name = "FULLSCREEN"),
          @ViewDebug.FlagToString(equals = 2048, mask = 2048, name = "FORCE_NOT_FULLSCREEN"),
          @ViewDebug.FlagToString(equals = 4096, mask = 4096, name = "DITHER"),
          @ViewDebug.FlagToString(equals = 8192, mask = 8192, name = "SECURE"),
          @ViewDebug.FlagToString(equals = 16384, mask = 16384, name = "SCALED"),
          @ViewDebug.FlagToString(equals = 32768, mask = 32768, name = "IGNORE_CHEEK_PRESSES"),
          @ViewDebug.FlagToString(equals = 65536, mask = 65536, name = "LAYOUT_INSET_DECOR"),
          @ViewDebug.FlagToString(equals = 131072, mask = 131072, name = "ALT_FOCUSABLE_IM"),
          @ViewDebug.FlagToString(equals = 262144, mask = 262144, name = "WATCH_OUTSIDE_TOUCH"),
          @ViewDebug.FlagToString(equals = 524288, mask = 524288, name = "SHOW_WHEN_LOCKED"),
          @ViewDebug.FlagToString(equals = 1048576, mask = 1048576, name = "SHOW_WALLPAPER"),
          @ViewDebug.FlagToString(equals = 2097152, mask = 2097152, name = "TURN_SCREEN_ON"),
          @ViewDebug.FlagToString(equals = 4194304, mask = 4194304, name = "DISMISS_KEYGUARD"),
          @ViewDebug.FlagToString(equals = 8388608, mask = 8388608, name = "SPLIT_TOUCH"),
          @ViewDebug.FlagToString(
              equals = 16777216,
              mask = 16777216,
              name = "HARDWARE_ACCELERATED"),
          @ViewDebug.FlagToString(equals = 33554432, mask = 33554432, name = "LOCAL_FOCUS_MODE"),
          @ViewDebug.FlagToString(equals = 67108864, mask = 67108864, name = "TRANSLUCENT_STATUS"),
          @ViewDebug.FlagToString(
              equals = 134217728,
              mask = 134217728,
              name = "TRANSLUCENT_NAVIGATION"),
          @ViewDebug.FlagToString(equals = 268435456, mask = 268435456, name = "LOCAL_FOCUS_MODE"),
          @ViewDebug.FlagToString(equals = 536870912, mask = 536870912, name = "FLAG_SLIPPERY"),
          @ViewDebug.FlagToString(
              equals = 1073741824,
              mask = 1073741824,
    ...
    @ViewDebug.ExportedProperty(
        flagMapping = {
          @ViewDebug.FlagToString(equals = 1, mask = 1, name = "LEFT"),
          @ViewDebug.FlagToString(equals = 2, mask = 2, name = "TOP"),
          @ViewDebug.FlagToString(equals = 4, mask = 4, name = "RIGHT"),
          @ViewDebug.FlagToString(equals = 8, mask = 8, name = "BOTTOM")
        })
    private int mFitInsetsSides;

    @ViewDebug.ExportedProperty(
        flagMapping = {
          @ViewDebug.FlagToString(equals = 1, mask = 1, name = "STATUS_BARS"),
          @ViewDebug.FlagToString(equals = 2, mask = 2, name = "NAVIGATION_BARS"),
          @ViewDebug.FlagToString(equals = 4, mask = 4, name = "CAPTION_BAR"),
          @ViewDebug.FlagToString(equals = 8, mask = 8, name = "IME"),
          @ViewDebug.FlagToString(equals = 16, mask = 16, name = "SYSTEM_GESTURES"),
          @ViewDebug.FlagToString(equals = 32, mask = 32, name = "MANDATORY_SYSTEM_GESTURES"),
          @ViewDebug.FlagToString(equals = 64, mask = 64, name = "TAPPABLE_ELEMENT"),
    ...
    @ViewDebug.ExportedProperty(
        flagMapping = {
          @ViewDebug.FlagToString(equals = 1, mask = 1, name = "MULTI_WINDOW_FLAG_MENU"),
          @ViewDebug.FlagToString(equals = 2, mask = 2, name = "MULTI_WINDOW_FLAG_MENU_POPUP"),
          @ViewDebug.FlagToString(equals = 8, mask = 8, name = "MULTI_WINDOW_FLAG_MENU_TOOLTIP"),
          @ViewDebug.FlagToString(
              equals = 4,
              mask = 4,
    ...
    @ViewDebug.ExportedProperty(
        flagMapping = {
          @ViewDebug.FlagToString(equals = 2, mask = 2, name = "FORCE_HARDWARE_ACCELERATED"),
          @ViewDebug.FlagToString(equals = 4, mask = 4, name = "WANTS_OFFSET_NOTIFICATIONS"),
          @ViewDebug.FlagToString(equals = 16, mask = 16, name = "SHOW_FOR_ALL_USERS"),
          @ViewDebug.FlagToString(equals = 32, mask = 32, name = "UNRESTRICTED_GESTURE_EXCLUSION"),
          @ViewDebug.FlagToString(equals = 64, mask = 64, name = "NO_MOVE_ANIMATION"),
          @ViewDebug.FlagToString(equals = 128, mask = 128, name = "COMPATIBLE_WINDOW"),
          @ViewDebug.FlagToString(equals = 256, mask = 256, name = "SYSTEM_ERROR"),
          @ViewDebug.FlagToString(equals = 512, mask = 512, name = "OPTIMIZE_MEASURE"),
          @ViewDebug.FlagToString(
              equals = 1024,
              mask = 1024,
              name = "DISABLE_WALLPAPER_TOUCH_EVENTS"),
          @ViewDebug.FlagToString(equals = 2048, mask = 2048, name = "FORCE_STATUS_BAR_VISIBLE"),
          @ViewDebug.FlagToString(
              equals = 4096,
              mask = 4096,
              name = "LAYOUT_SIZE_EXTENDED_BY_CUTOUT"),
          @ViewDebug.FlagToString(equals = 8192, mask = 8192, name = "FORCE_DECOR_VIEW_VISIBILITY"),
          @ViewDebug.FlagToString(
              equals = 16384,
              mask = 16384,
          ...
          @ViewDebug.FlagToString(equals = 4194304, mask = 4194304, name = "NOT_MAGNIFIABLE"),
          @ViewDebug.FlagToString(
              equals = 8388608,
              mask = 8388608,
          ...
          @ViewDebug.FlagToString(equals = 33554432, mask = 33554432, name = "USE_BLAST"),
          @ViewDebug.FlagToString(
              equals = 67108864,
              mask = 67108864,
          ...
          @ViewDebug.FlagToString(equals = 536870912, mask = 536870912, name = "TRUSTED_OVERLAY"),
          @ViewDebug.FlagToString(
              equals = 1073741824,
              mask = 1073741824,
    ...
    @ViewDebug.ExportedProperty(
        flagMapping = {
          ...
          @ViewDebug.FlagToString(equals = 2, mask = 2, name = "TRANSPARENT_POP_OVER"),
          @ViewDebug.FlagToString(equals = 8, mask = 8, name = "FIXED_ORIENTATION_PORTRAIT"),
          @ViewDebug.FlagToString(equals = 32, mask = 32, name = "OVERRIDE_SYSTEM_UI_POLICY"),
          @ViewDebug.FlagToString(equals = 64, mask = 64, name = "CHANGE_DIM_EFFECT_TO_BLUR"),
          @ViewDebug.FlagToString(equals = 128, mask = 128, name = "NO_SURFACE_BUFFER"),
          @ViewDebug.FlagToString(equals = 256, mask = 256, name = "DECOR_CAPTION_WINDOW"),
          @ViewDebug.FlagToString(equals = 512, mask = 512, name = "DELAY_RESIZE_ON_SOFT_INPUT"),
          @ViewDebug.FlagToString(
              equals = 4096,
              mask = 4096,
              name = "FORCE_HIDE_DEX_LOADING_SCREEN"),
          @ViewDebug.FlagToString(equals = 8192, mask = 8192, name = "USE_LAYOUT_IN_UDC_CUTOUT"),
          @ViewDebug.FlagToString(equals = 16384, mask = 16384, name = "CONTENT_RESIZE_ANIMATION"),
          @ViewDebug.FlagToString(equals = 65536, mask = 65536, name = "FAKE_FOCUS"),
          @ViewDebug.FlagToString(equals = 131072, mask = 131072, name = "FORCE_TRUSTED_OVERLAY"),
          @ViewDebug.FlagToString(equals = 262144, mask = 262144, name = "DOZE_MODE"),
          @ViewDebug.FlagToString(
              equals = 1048576,
              mask = 1048576,
          ...
          @ViewDebug.FlagToString(equals = 268435456, mask = 268435456, name = "SVIEW_COVER"),
          @ViewDebug.FlagToString(
              equals = 536870912,
              mask = 536870912,
    ...
    @ViewDebug.ExportedProperty(
        mapping = {
          @ViewDebug.IntToString(from = 1, m158to = "BASE_APPLICATION"),
          @ViewDebug.IntToString(from = 2, m158to = "APPLICATION"),
          @ViewDebug.IntToString(from = 3, m158to = "APPLICATION_STARTING"),
          @ViewDebug.IntToString(from = 4, m158to = "DRAWN_APPLICATION"),
          @ViewDebug.IntToString(from = 1000, m158to = "APPLICATION_PANEL"),
          @ViewDebug.IntToString(from = 1001, m158to = "APPLICATION_MEDIA"),
          @ViewDebug.IntToString(from = 1002, m158to = "APPLICATION_SUB_PANEL"),
          @ViewDebug.IntToString(from = 1005, m158to = "APPLICATION_ABOVE_SUB_PANEL"),
          @ViewDebug.IntToString(from = 1003, m158to = "APPLICATION_ATTACHED_DIALOG"),
          @ViewDebug.IntToString(from = 1004, m158to = "APPLICATION_MEDIA_OVERLAY"),
          @ViewDebug.IntToString(
              from = 2000,
              m158to = DevicePolicyResources.Drawables.Source.STATUS_BAR),
          @ViewDebug.IntToString(from = 2001, m158to = "SEARCH_BAR"),
          @ViewDebug.IntToString(from = 2002, m158to = "PHONE"),
          @ViewDebug.IntToString(from = 2003, m158to = "SYSTEM_ALERT"),
          @ViewDebug.IntToString(from = 2005, m158to = "TOAST"),
          @ViewDebug.IntToString(from = 2006, m158to = "SYSTEM_OVERLAY"),
          @ViewDebug.IntToString(from = 2007, m158to = "PRIORITY_PHONE"),
          @ViewDebug.IntToString(from = 2008, m158to = "SYSTEM_DIALOG"),
          @ViewDebug.IntToString(from = 2009, m158to = "KEYGUARD_DIALOG"),
          @ViewDebug.IntToString(from = 2010, m158to = "SYSTEM_ERROR"),
          @ViewDebug.IntToString(from = 2011, m158to = "INPUT_METHOD"),
          @ViewDebug.IntToString(from = 2012, m158to = "INPUT_METHOD_DIALOG"),
          @ViewDebug.IntToString(from = 2013, m158to = "WALLPAPER"),
          @ViewDebug.IntToString(from = 2014, m158to = "STATUS_BAR_PANEL"),
          @ViewDebug.IntToString(from = 2015, m158to = "SECURE_SYSTEM_OVERLAY"),
          @ViewDebug.IntToString(from = 2016, m158to = "DRAG"),
          @ViewDebug.IntToString(from = 2017, m158to = "STATUS_BAR_SUB_PANEL"),
          @ViewDebug.IntToString(from = 2018, m158to = "POINTER"),
          @ViewDebug.IntToString(from = 2019, m158to = "NAVIGATION_BAR"),
          @ViewDebug.IntToString(from = 2020, m158to = "VOLUME_OVERLAY"),
          @ViewDebug.IntToString(from = 2021, m158to = "BOOT_PROGRESS"),
          @ViewDebug.IntToString(from = 2022, m158to = "INPUT_CONSUMER"),
          @ViewDebug.IntToString(from = 2024, m158to = "NAVIGATION_BAR_PANEL"),
          @ViewDebug.IntToString(from = 2026, m158to = "DISPLAY_OVERLAY"),
          @ViewDebug.IntToString(from = 2027, m158to = "MAGNIFICATION_OVERLAY"),
          @ViewDebug.IntToString(from = 2037, m158to = "PRESENTATION"),
          @ViewDebug.IntToString(from = 2030, m158to = "PRIVATE_PRESENTATION"),
          @ViewDebug.IntToString(from = 2031, m158to = "VOICE_INTERACTION"),
          @ViewDebug.IntToString(from = 2033, m158to = "VOICE_INTERACTION_STARTING"),
          @ViewDebug.IntToString(from = 2034, m158to = "DOCK_DIVIDER"),
          @ViewDebug.IntToString(from = 2035, m158to = "QS_DIALOG"),
          @ViewDebug.IntToString(from = 2036, m158to = "SCREENSHOT"),
          @ViewDebug.IntToString(from = 2038, m158to = "APPLICATION_OVERLAY"),
          @ViewDebug.IntToString(from = 2040, m158to = "NOTIFICATION_SHADE"),
          @ViewDebug.IntToString(
              from = TYPE_NOTIFICATION_SHADE_WIDGET,
              m158to = "NOTIFICATION_SHADE_WIDGET"),
          @ViewDebug.IntToString(from = TYPE_PENTASTIC_ICON, m158to = "PENTASTIC_ICON"),
          @ViewDebug.IntToString(from = TYPE_PENTASTIC_ANIM, m158to = "PENTASTIC_ANIM"),
          @ViewDebug.IntToString(from = TYPE_GAME_TOOL, m158to = "GAME_TOOL"),
          @ViewDebug.IntToString(from = TYPE_GAME_TOOL_OVERLAY, m158to = "GAME_TOOL_OVERLAY"),
          @ViewDebug.IntToString(
              from = TYPE_TRANSIENT_LAUNCH_OVERLAY,
              m158to = "TRANSIENT_LAUNCH_OVERLAY"),
          @ViewDebug.IntToString(
              from = TYPE_LOCK_ONLY_LIVE_WALLPAPER,
              m158to = "LOCK_ONLY_LIVE_WALLPAPER")
        })
    public int type;
    ...
    /* renamed from: x */
    @ViewDebug.ExportedProperty public int f573x;

    /* renamed from: y */
    @ViewDebug.ExportedProperty public int f574y;
    ...
    public LayoutParams forRotation(int rotation) {
      ...
      LayoutParams[] layoutParamsArr = this.paramsForRotation;
      if (layoutParamsArr == null
          || layoutParamsArr.length <= rotation
          || (layoutParams = layoutParamsArr[rotation]) == null) {
        return this;
      }
      return layoutParams;
    }
    ...
    public final void setSurfaceInsets(View view, boolean manual, boolean preservePrevious) {
      ...
      if (config.windowConfiguration.isPopOver()
          || ((CoreRune.MW_CAPTION_SHELL && config.isDesktopModeEnabled())
              || config.windowConfiguration.getWindowingMode() == 5)) {
        scaleFactor = 3.0f;
      } else {
        scaleFactor = 2.0f;
      }
      ...
      if (surfaceInset == 0) {
        ...
        rect.set(
            Math.max(surfaceInset, rect.left),
            Math.max(surfaceInset, this.surfaceInsets.top),
            Math.max(surfaceInset, this.surfaceInsets.right),
            Math.max(surfaceInset, this.surfaceInsets.bottom));
      }
    ...
    public void writeToParcel(Parcel out, int parcelableFlags) {
      ...
      out.writeInt(this.f573x);
      out.writeInt(this.f574y);
    ...
    public LayoutParams(Parcel in) {
      ...
      this.f573x = in.readInt();
      this.f574y = in.readInt();
      ...
      this.providedInsets =
          (InsetsFrameProvider[]) in.createTypedArray(InsetsFrameProvider.CREATOR);
    ...
    public final int copyFrom(LayoutParams o) {
      ...
      if (!Objects.equals(this.accessibilityTitle, o.accessibilityTitle)
          && (charSequence = o.accessibilityTitle) != null) {
      ...
      if (layoutParamsArr != layoutParamsArr2) {
        if ((changes & 1) == 0) {
          if (layoutParamsArr != null
              && layoutParamsArr2 != null
              && layoutParamsArr.length == layoutParamsArr2.length) {
    ...
    public static boolean hasLayoutDiff(LayoutParams a, LayoutParams b) {
      return (a.width == b.width
              ...
              && a.gravity == b.gravity
              && Arrays.equals(a.providedInsets, b.providedInsets)
    ...
    public String debug(String output) {
      Log.m94d("Debug", output + "Contents of " + this + ":");
      String output2 = super.debug("");
      Log.m94d("Debug", output2);
      Log.m94d("Debug", "");
      Log.m94d("Debug", "WindowManager.LayoutParams={title=" + ((Object) this.mTitle) + "}");
      return "";
    }
    ...
    public void dumpDimensions(StringBuilder sb) {
      String valueOf;
      sb.append('(');
      sb.append(this.f573x);
      sb.append(',');
      sb.append(this.f574y);
      sb.append(")(");
      String str = "wrap";
      if (this.width == -1) {
        valueOf = "fill";
    ...
    public String toString(String prefix) {
      ...
      if (this.surfaceInsets.left != 0
          || this.surfaceInsets.top != 0
          || this.surfaceInsets.right != 0
          || this.surfaceInsets.bottom != 0
          || this.hasManualSurfaceInsets
          || !this.preservePreviousSurfaceInsets) {
      ...
      sb.append(prefix)
          .append("  fl=")
          .append(
              CoreRune.FW_FLAG_TO_HEX_STRING
                  ? Integer.toHexString(this.flags)
                  : ViewDebug.flagsToString(LayoutParams.class, "flags", this.flags));
            ...
            .append(
                CoreRune.FW_FLAG_TO_HEX_STRING
                    ...
                    : ViewDebug.flagsToString(
                        LayoutParams.class, "privateFlags", this.privateFlags));
      }
      if (this.systemUiVisibility != 0) {
        ...
        sb.append(prefix)
            ...
            .append(
                CoreRune.FW_FLAG_TO_HEX_STRING
                    ? Integer.toHexString(this.systemUiVisibility)
                    : ViewDebug.flagsToString(
                        View.class, "mSystemUiVisibility", this.systemUiVisibility));
      }
      if (this.subtreeSystemUiVisibility != 0) {
        ...
        sb.append(prefix)
            ...
            .append(
                CoreRune.FW_FLAG_TO_HEX_STRING
                    ? Integer.toHexString(this.subtreeSystemUiVisibility)
                    : ViewDebug.flagsToString(
                        View.class, "mSystemUiVisibility", this.subtreeSystemUiVisibility));
      }
      if (this.insetsFlags.appearance != 0) {
        ...
        sb.append(prefix)
            ...
            .append(
                ViewDebug.flagsToString(
                    InsetsFlags.class, "appearance", this.insetsFlags.appearance));
      }
      if (this.insetsFlags.behavior != 0) {
        ...
        sb.append(prefix)
            .append("  bhv=")
            .append(
                ViewDebug.flagsToString(InsetsFlags.class, "behavior", this.insetsFlags.behavior));
      }
      if (this.mFitInsetsTypes != 0) {
        ...
        sb.append(prefix)
            ...
            .append(
                ViewDebug.flagsToString(
                    LayoutParams.class, "mFitInsetsTypes", this.mFitInsetsTypes));
      }
      if (this.mFitInsetsSides != WindowInsets.Side.all()) {
        ...
        sb.append(prefix)
            ...
            .append(
                ViewDebug.flagsToString(
                    LayoutParams.class, "mFitInsetsSides", this.mFitInsetsSides));
      }
      ...
      if (this.samsungFlags != 0) {
        ...
        if (CoreRune.FW_FLAG_TO_HEX_STRING) {
          ...
          flagsToString =
              ViewDebug.flagsToString(LayoutParams.class, "samsungFlags", this.samsungFlags);
        }
    ...
    public void dumpDebug(ProtoOutputStream proto, long fieldId) {
      ...
      proto.write(1120986464258L, this.f573x);
      proto.write(1120986464259L, this.f574y);
      ...
      proto.write(
          ...
          this.subtreeSystemUiVisibility);
    ...
    public void scale(float scale) {
      this.f573x = (int) ((this.f573x * scale) + 0.5f);
      this.f574y = (int) ((this.f574y * scale) + 0.5f);
      if (this.width > 0) {
    ...
    protected void encodeProperties(ViewHierarchyEncoder encoder) {
      ...
      encoder.addProperty("x", this.f573x);
      encoder.addProperty("y", this.f574y);
    ...
    public boolean isFullscreen() {
      return this.f573x == 0 && this.f574y == 0 && this.width == -1 && this.height == -1;
    }
