...
public interface WindowManager extends ViewManager {
    ...
    public static final String f572x8d62ad7e = "android.window.PROPERTY_COMPAT_ALLOW_IGNORING_ORIENTATION_REQUEST_WHEN_LOOP_DETECTED";
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
        ...
        @ViewDebug.ExportedProperty(mapping = {@ViewDebug.IntToString(from = 1, m158to = "BASE_APPLICATION"), @ViewDebug.IntToString(from = 2, m158to = "APPLICATION"), @ViewDebug.IntToString(from = 3, m158to = "APPLICATION_STARTING"), @ViewDebug.IntToString(from = 4, m158to = "DRAWN_APPLICATION"), @ViewDebug.IntToString(from = 1000, m158to = "APPLICATION_PANEL"), @ViewDebug.IntToString(from = 1001, m158to = "APPLICATION_MEDIA"), @ViewDebug.IntToString(from = 1002, m158to = "APPLICATION_SUB_PANEL"), @ViewDebug.IntToString(from = 1005, m158to = "APPLICATION_ABOVE_SUB_PANEL"), @ViewDebug.IntToString(from = 1003, m158to = "APPLICATION_ATTACHED_DIALOG"), @ViewDebug.IntToString(from = 1004, m158to = "APPLICATION_MEDIA_OVERLAY"), @ViewDebug.IntToString(from = 2000, m158to = DevicePolicyResources.Drawables.Source.STATUS_BAR), @ViewDebug.IntToString(from = 2001, m158to = "SEARCH_BAR"), @ViewDebug.IntToString(from = 2002, m158to = "PHONE"), @ViewDebug.IntToString(from = 2003, m158to = "SYSTEM_ALERT"), @ViewDebug.IntToString(from = 2005, m158to = "TOAST"), @ViewDebug.IntToString(from = 2006, m158to = "SYSTEM_OVERLAY"), @ViewDebug.IntToString(from = 2007, m158to = "PRIORITY_PHONE"), @ViewDebug.IntToString(from = 2008, m158to = "SYSTEM_DIALOG"), @ViewDebug.IntToString(from = 2009, m158to = "KEYGUARD_DIALOG"), @ViewDebug.IntToString(from = 2010, m158to = "SYSTEM_ERROR"), @ViewDebug.IntToString(from = 2011, m158to = "INPUT_METHOD"), @ViewDebug.IntToString(from = 2012, m158to = "INPUT_METHOD_DIALOG"), @ViewDebug.IntToString(from = 2013, m158to = "WALLPAPER"), @ViewDebug.IntToString(from = 2014, m158to = "STATUS_BAR_PANEL"), @ViewDebug.IntToString(from = 2015, m158to = "SECURE_SYSTEM_OVERLAY"), @ViewDebug.IntToString(from = 2016, m158to = "DRAG"), @ViewDebug.IntToString(from = 2017, m158to = "STATUS_BAR_SUB_PANEL"), @ViewDebug.IntToString(from = 2018, m158to = "POINTER"), @ViewDebug.IntToString(from = 2019, m158to = "NAVIGATION_BAR"), @ViewDebug.IntToString(from = 2020, m158to = "VOLUME_OVERLAY"), @ViewDebug.IntToString(from = 2021, m158to = "BOOT_PROGRESS"), @ViewDebug.IntToString(from = 2022, m158to = "INPUT_CONSUMER"), @ViewDebug.IntToString(from = 2024, m158to = "NAVIGATION_BAR_PANEL"), @ViewDebug.IntToString(from = 2026, m158to = "DISPLAY_OVERLAY"), @ViewDebug.IntToString(from = 2027, m158to = "MAGNIFICATION_OVERLAY"), @ViewDebug.IntToString(from = 2037, m158to = "PRESENTATION"), @ViewDebug.IntToString(from = 2030, m158to = "PRIVATE_PRESENTATION"), @ViewDebug.IntToString(from = 2031, m158to = "VOICE_INTERACTION"), @ViewDebug.IntToString(from = 2033, m158to = "VOICE_INTERACTION_STARTING"), @ViewDebug.IntToString(from = 2034, m158to = "DOCK_DIVIDER"), @ViewDebug.IntToString(from = 2035, m158to = "QS_DIALOG"), @ViewDebug.IntToString(from = 2036, m158to = "SCREENSHOT"), @ViewDebug.IntToString(from = 2038, m158to = "APPLICATION_OVERLAY"), @ViewDebug.IntToString(from = 2040, m158to = "NOTIFICATION_SHADE"), @ViewDebug.IntToString(from = TYPE_NOTIFICATION_SHADE_WIDGET, m158to = "NOTIFICATION_SHADE_WIDGET"), @ViewDebug.IntToString(from = TYPE_PENTASTIC_ICON, m158to = "PENTASTIC_ICON"), @ViewDebug.IntToString(from = TYPE_PENTASTIC_ANIM, m158to = "PENTASTIC_ANIM"), @ViewDebug.IntToString(from = TYPE_GAME_TOOL, m158to = "GAME_TOOL"), @ViewDebug.IntToString(from = TYPE_GAME_TOOL_OVERLAY, m158to = "GAME_TOOL_OVERLAY"), @ViewDebug.IntToString(from = TYPE_TRANSIENT_LAUNCH_OVERLAY, m158to = "TRANSIENT_LAUNCH_OVERLAY"), @ViewDebug.IntToString(from = TYPE_LOCK_ONLY_LIVE_WALLPAPER, m158to = "LOCK_ONLY_LIVE_WALLPAPER")})
        public int type;
        ...
        public static boolean hasLayoutDiff(LayoutParams a, LayoutParams b) {
            return (a.width == b.width && a.height == b.height && a.f573x == b.f573x && a.f574y == b.f574y && a.horizontalMargin == b.horizontalMargin && a.verticalMargin == b.verticalMargin && a.layoutInDisplayCutoutMode == b.layoutInDisplayCutoutMode && a.gravity == b.gravity && Arrays.equals(a.providedInsets, b.providedInsets) && a.mFitInsetsTypes == b.mFitInsetsTypes && a.mFitInsetsSides == b.mFitInsetsSides && a.mFitInsetsIgnoringVisibility == b.mFitInsetsIgnoringVisibility) ? false : true;
        }
