  ...
  */
  ...
  public static boolean metaStateHasModifiers(int metaState, int modifiers) {
    if ((META_INVALID_MODIFIER_MASK & modifiers) == 0) {
      return metaStateFilterDirectionalModifiers(
              metaStateFilterDirectionalModifiers(
                  metaStateFilterDirectionalModifiers(
                      metaStateFilterDirectionalModifiers(
                          normalizeMetaState(metaState) & META_MODIFIER_MASK,
                          modifiers,
                          1,
                          64,
                          128),
    ...
    throw new IllegalArgumentException(
        "modifiers must not contain META_CAPS_LOCK_ON, META_NUM_LOCK_ON, META_SCROLL_LOCK_ON,"
  ...
  private static boolean keyCodeIsValid(int keyCode) {
    return ((keyCode >= 0 && keyCode <= 316) || (keyCode >= 1000 && keyCode <= 1104))
        && keyCode != 1001;
  }
