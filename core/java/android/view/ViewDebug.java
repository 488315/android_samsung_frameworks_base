...
public class ViewDebug {
  ...
  static void dispatchCommand(
      View view, String command, String parameters, OutputStream clientStream) throws IOException {
  ...
  private static String[] hidden_getStyleAttributesDump(
  ...
  private static void requestLayout(View root, String parameter) {
    ...
    if (view != null) {
      root.post(
          new Runnable() { // from class: android.view.ViewDebug.1
  ...
  private static void profileViewAndChildren(
      View view, RenderNode node, BufferedWriter out, boolean root) throws IOException {
    long durationMeasure =
        (root || (view.mPrivateFlags & 2048) != 0) ? profileViewMeasure(view) : 0L;
    long durationLayout = (root || (view.mPrivateFlags & 8192) != 0) ? profileViewLayout(view) : 0L;
    long durationDraw =
        (!root && view.willNotDraw() && (view.mPrivateFlags & 32) == 0)
            ? 0L
            : profileViewDraw(view, node);
  ...
  private static long profileViewMeasure(final View view) {
    return profileViewOperation(
        view,
        new ViewOperation() { // from class: android.view.ViewDebug.2
  ...
  private static long profileViewLayout(final View view) {
    return profileViewOperation(
        view,
        new ViewOperation() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda7
          @Override // android.view.ViewDebug.ViewOperation
  ...
  private static long profileViewDraw(final View view, RenderNode node) {
    ...
    if (view.isHardwareAccelerated()) {
      ...
      try {
        return profileViewOperation(
            view,
            new ViewOperation() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda5
              @Override // android.view.ViewDebug.ViewOperation
              public final void run() {
    ...
    try {
      return profileViewOperation(
          view,
          new ViewOperation() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda6
            @Override // android.view.ViewDebug.ViewOperation
            public final void run() {
  ...
  private static long profileViewOperation(View view, final ViewOperation operation) {
    ...
    view.post(
        new Runnable() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda8
          @Override // java.lang.Runnable
          public final void run() {
    ...
    try {
      if (!latch.await(6000L, TimeUnit.MILLISECONDS)) {
        Log.m102w("View", "Could not complete the profiling of the view " + view);
        return -1L;
      }
      return duration[0];
  ...
  static /* synthetic */ void lambda$profileViewOperation$3(
      ViewOperation operation, long[] duration, CountDownLatch latch) {
    try {
      operation.pre();
    ...
    if ((view.mPrivateFlags & 128) != 128) {
      ...
      if (b != null) {
        ByteArrayOutputStream arrayOut =
            new ByteArrayOutputStream(b.getWidth() * b.getHeight() * 2);
  ...
  private static class PictureCallbackHandler
    ...
    private PictureCallbackHandler(
        HardwareRenderer renderer, Function<Picture, Boolean> callback, Executor executor) {
    ...
    public void run() {
      ...
      if (Thread.currentThread() == this.mRenderThread) {
        ...
        throw new IllegalStateException(
            "ViewDebug#startRenderingCommandsCapture must be given an executor that invokes"
                + " asynchronously");
      }
      if (isStopped) {
        picture.close();
  ...
  public static AutoCloseable startRenderingCommandsCapture(
      View tree, Executor executor, Function<Picture, Boolean> callback) {
    ...
    if (attachInfo.mHandler.getLooper() != Looper.myLooper()) {
      throw new IllegalStateException(
          "Called on the wrong thread. Must be called on the thread that owns the given View");
    }
    ...
    public void run() {
      ...
      if (stream != null) {
        try {
          ...
          Log.m103w(
              "ViewDebug",
              "Aborting rendering commands capture due to IOException writing to output stream",
              ex2);
          return;
        }
      }
  ...
  private static void capture(View root, OutputStream clientStream, String parameter)
      throws IOException {
    View captureView = findView(root, parameter);
    capture(root, clientStream, captureView);
  }

  public static void capture(View root, OutputStream clientStream, View captureView)
      throws IOException {
    Bitmap b = performViewCapture(captureView, false);
    if (b == null) {
      Log.m102w("View", "Failed to create capture bitmap!");
      b =
          Bitmap.createBitmap(
              root.getResources().getDisplayMetrics(), 1, 1, Bitmap.Config.ARGB_8888);
    }
  ...
  private static Bitmap performViewCapture(final View captureView, final boolean skipChildren) {
    if (captureView != null) {
      ...
      captureView.post(
          new Runnable() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
      ...
      try {
        ...
        Log.m102w("View", "Could not complete the capture of the view " + captureView);
        Thread.currentThread().interrupt();
        return null;
      }
    }
  ...
  static /* synthetic */ void lambda$performViewCapture$4(
      View captureView, Bitmap[] cache, boolean skipChildren, CountDownLatch latch) {
    try {
      try {
        CanvasProvider provider =
            captureView.isHardwareAccelerated()
                ? new HardwareCanvasProvider()
                : new SoftwareCanvasProvider();
        cache[0] = captureView.createSnapshot(provider, skipChildren);
      } catch (OutOfMemoryError e) {
        Log.m102w("View", "Out of memory for bitmap");
      }
    } finally {
      latch.countDown();
    }
  ...
  public static void dump(
      View root, boolean skipChildren, boolean includeProperties, OutputStream clientStream)
      throws IOException {
    BufferedWriter out = null;
    try {
      try {
  ...
  public static void dumpv2(final View view, ByteArrayOutputStream out)
      throws InterruptedException {
    final ViewHierarchyEncoder encoder = new ViewHierarchyEncoder(out);
    final CountDownLatch latch = new CountDownLatch(1);
    view.post(
        new Runnable() { // from class: android.view.ViewDebug.3
          @Override // java.lang.Runnable
          public void run() {
  ...
  public static void dumpTheme(View view, OutputStream clientStream) throws IOException {
    ...
    try {
      try {
        out = new BufferedWriter(new OutputStreamWriter(clientStream, "utf-8"), 32768);
        String[] attributes =
            getStyleAttributesDump(view.getContext().getResources(), view.getContext().getTheme());
        if (attributes != null) {
  ...
  private static View findView(ViewGroup group, String className, int hashCode) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (childAt.mOverlay != null
          && (found2 = findView(childAt.mOverlay.mOverlayViewGroup, className, hashCode)) != null) {
        return found2;
      }
      if ((childAt instanceof HierarchyHandler)
          && (found = ((HierarchyHandler) childAt).findHierarchyView(className, hashCode))
              != null) {
        return found;
      }
    }
  ...
  private static void dumpViewHierarchy(
    ...
    FutureTask task =
        new FutureTask(
            new Runnable() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda9
              @Override // java.lang.Runnable
              public final void run() {
                ViewDebug.dumpViewHierarchyOnUIThread(
                    Context.this, group, out, level, skipChildren, includeProperties);
              }
            },
            null);
  ...
  public static void dumpViewHierarchyOnUIThread(
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (!(view instanceof ViewGroup)) {
        ...
        dumpViewHierarchyOnUIThread(
            context, (ViewGroup) view, out, level + 1, skipChildren, includeProperties);
      }
      if (view.mOverlay != null) {
        ViewOverlay overlay = view.getOverlay();
        ViewGroup overlayContainer = overlay.mOverlayViewGroup;
        dumpViewHierarchyOnUIThread(
            context, overlayContainer, out, level + 2, skipChildren, includeProperties);
      }
    }
  ...
  private static boolean dumpView(
      Context context, View view, BufferedWriter out, int level, boolean includeProperties) {
    for (int i = 0; i < level; i++) {
      try {
        out.write(32);
      } catch (IOException e) {
        Log.m102w("View", "Error while dumping hierarchy tree");
        return false;
      }
    }
  ...
  private static <T extends Annotation> PropertyInfo<T, ?>[] convertToPropertyInfos(
      Method[] methods, Field[] fields, final Class<T> property) {
    return (PropertyInfo[])
        Stream.of(
                (Object[])
                    new Stream[] {
                      Arrays.stream(methods)
                          .map(
                              new Function() { // from class:
                                               // android.view.ViewDebug$$ExternalSyntheticLambda1
                                @Override // java.util.function.Function
                                public final Object apply(Object obj) {
                                  ViewDebug.PropertyInfo forMethod;
                                  forMethod =
                                      ViewDebug.PropertyInfo.forMethod((Method) obj, property);
                                  return forMethod;
                                }
                              }),
                      Arrays.stream(fields)
                          .map(
                              new Function() { // from class:
                                               // android.view.ViewDebug$$ExternalSyntheticLambda2
                                @Override // java.util.function.Function
                                public final Object apply(Object obj) {
            ...
            .filter(
                new Predicate() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda3
            ...
            .toArray(
                new IntFunction() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda4
  ...
  private static PropertyInfo<ExportedProperty, ?>[] getExportedProperties(Class<?> klass) {
    ...
    if (properties == null) {
      PropertyInfo<ExportedProperty, ?>[] properties2 =
          convertToPropertyInfos(
              klass.getDeclaredMethods(), klass.getDeclaredFields(), ExportedProperty.class);
  ...
  private static void dumpViewProperties(Context context, Object view, BufferedWriter out)
      throws IOException {
    dumpViewProperties(context, view, out, "");
  }

  private static void dumpViewProperties(
      Context context, Object view, BufferedWriter out, String prefix) throws IOException {
    if (view == null) {
  ...
  private static void writeExportedProperties(
      Context context, Object view, BufferedWriter out, Class<?> klass, String prefix)
      throws IOException {
    Object value;
    ...
    for (PropertyInfo<ExportedProperty, ?> info : getExportedProperties(klass)) {
      ...
      if (info.returnType == Integer.TYPE || info.returnType == Byte.TYPE) {
        ...
        if (info.returnType == int[].class) {
          ...
          exportUnrolledArray(
              context, out, info.property, (int[]) value, valuePrefix2, info.entrySuffix);
            ...
            for (int j2 = 0; j2 < array.length; j2 += 2) {
              if (array[j2] != null) {
                writeEntry(
                    ...
                    array[j2],
                    info.entrySuffix,
                    array[j2 + 1] == null ? SemCapabilities.FEATURE_TAG_NULL : array[j2 + 1]);
              }
            }
          }
  ...
  private static void writeEntry(
      BufferedWriter out, String prefix, String name, String suffix, Object value)
      throws IOException {
    out.write(prefix);
    out.write(name);
    out.write(suffix);
  ...
  private static void exportUnrolledFlags(
      BufferedWriter out, FlagToString[] mapping, int intValue, String prefix) throws IOException {
  ...
  private static FlagToString[] getFlagMapping(Class<?> clazz, String field) {
    try {
      return ((ExportedProperty)
              clazz.getDeclaredField(field).getAnnotation(ExportedProperty.class))
          .flagMapping();
  ...
  private static void exportUnrolledArray(
      Context context,
      BufferedWriter out,
  ...
  private static PropertyInfo<CapturedViewProperty, ?>[] getCapturedViewProperties(Class<?> klass) {
    ...
    if (infos == null) {
      PropertyInfo<CapturedViewProperty, ?>[] infos2 =
          convertToPropertyInfos(klass.getMethods(), klass.getFields(), CapturedViewProperty.class);
  ...
  public static void dumpCapturedView(String tag, Object view) {
    Class<?> klass = view.getClass();
    Log.m94d(tag, (klass.getName() + ": ") + exportCapturedViewProperties(view, klass, ""));
  }
  ...
  public static Object invokeViewMethod(final View view, final Method method, final Object[] args) {
    ...
    view.post(
        new Runnable() { // from class: android.view.ViewDebug.4
          @Override // java.lang.Runnable
          public void run() {
            try {
  ...
  public static void setLayoutParameter(final View view, String param, int value)
      throws NoSuchFieldException, IllegalAccessException {
    final ViewGroup.LayoutParams p = view.getLayoutParams();
    Field f = p.getClass().getField(param);
    if (f.getType() != Integer.TYPE) {
      throw new RuntimeException(
          "Only integer layout parameters can be set. Field "
              + param
              + " is of type "
    ...
    view.post(
        new Runnable() { // from class: android.view.ViewDebug.5
          @Override // java.lang.Runnable
          public void run() {
  ...
  public static class SoftwareCanvasProvider implements CanvasProvider {
    ...
    public Canvas getCanvas(View view, int width, int height) {
      Bitmap createBitmap =
          Bitmap.createBitmap(
              view.getResources().getDisplayMetrics(), width, height, Bitmap.Config.ARGB_8888);
