...
public class ViewDebug {
            ...
            try {
                if (method.getReturnType() != Void.class) {
                    if (method.getParameterTypes().length != 0
                            || !method.isAnnotationPresent(property)) {
                        return null;
                    }
    ...
    static void dispatchCommand(
            View view, String command, String parameters, OutputStream clientStream)
            throws IOException {
    ...
    private static void profileViewAndChildren(
        ...
        long durationLayout =
                (root || (view.mPrivateFlags & 8192) != 0) ? profileViewLayout(view) : 0L;
        long durationDraw =
    ...
    private static long profileViewMeasure(final View view) {
        return profileViewOperation(
                ...
                new ViewOperation() { // from class: android.view.ViewDebug.2
                    ...
                    public void run() {
                        View.this.measure(
                                View.this.mOldWidthMeasureSpec, View.this.mOldHeightMeasureSpec);
                    }
                });
    }
    ...
    private static long profileViewLayout(final View view) {
        return profileViewOperation(
                view,
                new ViewOperation() { // from class:
                                      // android.view.ViewDebug$$ExternalSyntheticLambda0
                    @Override // android.view.ViewDebug.ViewOperation
    ...
    private static long profileViewDraw(final View view, RenderNode node) {
        ...
        Bitmap bitmap =
                Bitmap.createBitmap(dm, dm.widthPixels, dm.heightPixels, Bitmap.Config.RGB_565);
    ...
    private static long profileViewOperation(View view, final ViewOperation operation) {
        ...
        view.post(
                new Runnable() { // from class: android.view.ViewDebug$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
                        ViewDebug.lambda$profileViewOperation$3(
                                ViewDebug.ViewOperation.this, duration, latch);
                    }
                });
        try {
    ...
    public static AutoCloseable startRenderingCommandsCapture(
        ...
        if (attachInfo.mHandler.getLooper() != Looper.myLooper()) {
            throw new IllegalStateException(
                    "Called on the wrong thread. Must be called on the thread that owns the given"
                        + " View");
        }
        ...
        public void run() {
            ...
            if (stream != null) {
                try {
                    ...
                    Log.w(
                            ViewDebug.TAG,
                            "Aborting rendering commands capture due to IOException writing to"
                                + " output stream",
                            ex2);
                    return;
                }
        ...
        if (captureView != null) {
            ...
            captureView.post(
                    new Runnable() { // from class:
                                     // android.view.ViewDebug$$ExternalSyntheticLambda10
                        @Override // java.lang.Runnable
                        public final void run() {
                            ViewDebug.lambda$performViewCapture$4(
                                    View.this, cache, skipChildren, latch);
                        }
                    });
            try {
        ...
        try {
            try {
                ...
                if (view instanceof ViewGroup) {
                    ViewGroup group = (ViewGroup) view;
                    dumpViewHierarchy(
                            group.getContext(), group, out, 0, skipChildren, includeProperties);
                }
                out.write("DONE.");
                out.newLine();
            } catch (Exception e) {
    ...
    public static void dumpv2(final View view, ByteArrayOutputStream out)
        ...
        view.post(
                new Runnable() { // from class: android.view.ViewDebug.3
                    @Override // java.lang.Runnable
                    public void run() {
                        ViewHierarchyEncoder.this.addProperty(
                                "window:left", view.mAttachInfo.mWindowLeft);
                        ViewHierarchyEncoder.this.addProperty(
                                "window:top", view.mAttachInfo.mWindowTop);
    ...
    public static void dumpTheme(View view, OutputStream clientStream) throws IOException {
        ...
        try {
            try {
                out = new BufferedWriter(new OutputStreamWriter(clientStream, "utf-8"), 32768);
                String[] attributes =
                        getStyleAttributesDump(
                                view.getContext().getResources(), view.getContext().getTheme());
                if (attributes != null) {
    ...
    private static View findView(ViewGroup group, String className, int hashCode) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (childAt.mOverlay != null
                    && (found2 = findView(childAt.mOverlay.mOverlayViewGroup, className, hashCode))
                            != null) {
                return found2;
            }
    ...
    private static void dumpViewHierarchy(
        ...
        if (handler.getLooper() == Looper.myLooper()) {
            dumpViewHierarchyOnUIThread(
                    context, group, out, level, skipChildren, includeProperties);
            return;
        }
        FutureTask task =
                new FutureTask(
                        new Runnable() { // from class:
                                         // android.view.ViewDebug$$ExternalSyntheticLambda8
                            @Override // java.lang.Runnable
                            public final void run() {
                ...
                Stream.of(
                                (Object[])
                                        new Stream[] {
                                            Arrays.stream(methods)
                                                    .map(
                                                            new Function() { // from class:
                                                                             // android.view.ViewDebug$$ExternalSyntheticLambda4
                                                                @Override // java.util.function.Function
                                                                public final Object apply(
                                                                        Object obj) {
                                                                    ViewDebug.PropertyInfo
                                                                            forMethod;
                                                                    forMethod =
                                                                            ViewDebug.PropertyInfo
                                                                                    .forMethod(
                                            ...
                                            Arrays.stream(fields)
                                                    .map(
                                                            new Function() { // from class:
                                                                             // android.view.ViewDebug$$ExternalSyntheticLambda5
                                                                @Override // java.util.function.Function
                                                                public final Object apply(
                                                                        Object obj) {
                        ...
                        .filter(
                                new Predicate() { // from class:
                                                  // android.view.ViewDebug$$ExternalSyntheticLambda6
                        ...
                        .toArray(
                                new IntFunction() { // from class:
                                                    // android.view.ViewDebug$$ExternalSyntheticLambda7
    ...
    private static void writeExportedProperties(
        ...
        for (PropertyInfo<ExportedProperty, ?> info : getExportedProperties(klass)) {
            try {
                ...
                categoryPrefix =
                        info.property.category().length() != 0
                                ? info.property.category() + ":"
                                : "";
            } catch (Exception e) {
            }
                        ...
                        for (int j2 = 0; j2 < array.length; j2 += 2) {
                            if (array[j2] != null) {
                                writeEntry(
                                        ...
                                        array[j2],
                                        info.entrySuffix,
                                        array[j2 + 1] == null ? "null" : array[j2 + 1]);
                            }
                        }
                    }
    ...
    private static void exportUnrolledFlags(
            BufferedWriter out, FlagToString[] mapping, int intValue, String prefix)
            throws IOException {
    ...
    private static PropertyInfo<CapturedViewProperty, ?>[] getCapturedViewProperties(
        ...
        if (infos == null) {
            PropertyInfo<CapturedViewProperty, ?>[] infos2 =
                    convertToPropertyInfos(
                            klass.getMethods(), klass.getFields(), CapturedViewProperty.class);
        ...
        for (PropertyInfo<CapturedViewProperty, ?> pi : getCapturedViewProperties(klass)) {
            try {
                ...
                if (pi.property.retrieveReturn()) {
                    sb.append(
                            exportCapturedViewProperties(
                                    methodValue, pi.returnType, pi.name + "#"));
                } else {
    ...
    public static byte[] invokeViewMethod(
            final View targetView, String methodName, ByteBuffer params)
                ...
                FutureTask<Object> task =
                        new FutureTask<>(
                                new Callable() { // from class:
                                                 // android.view.ViewDebug$$ExternalSyntheticLambda3
    ...
    public static void deserializeMethodParameters(
            Object[] args, Class<?>[] argTypes, ByteBuffer in)
            throws ViewMethodInvocationSerializationException {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (isArray) {
                ...
                if (arrayType != 'B') {
                    throw new ViewMethodInvocationSerializationException(
                            "Unsupported array parameter type ("
                                    + typeSignature
                                    + ") to invoke view method @argument "
                                    + i);
                }
    ...
    public static byte[] serializeReturnValue(Class<?> cls, Object obj)
