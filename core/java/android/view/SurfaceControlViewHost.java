...
public class SurfaceControlViewHost {
  ...
  final class ISurfaceControlViewHostImpl extends ISurfaceControlViewHost.Stub {
      ...
      if (SurfaceControlViewHost.this.mViewRoot != null) {
        SurfaceControlViewHost.this.mViewRoot.mHandler.post(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                SurfaceControlViewHost.ISurfaceControlViewHostImpl.this.lambda$onInsetsChanged$2(
                    frame);
              }
            });
      }
    ...
    public ISurfaceSyncGroup getSurfaceSyncGroup() {
      ...
      SurfaceControlViewHost.this.mViewRoot.mHandler.post(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              SurfaceControlViewHost.ISurfaceControlViewHostImpl.this.lambda$getSurfaceSyncGroup$3(
                  surfaceSyncGroup);
            }
          });
      try {
        ...
        Log.m97e(SurfaceControlViewHost.TAG, "Failed to get SurfaceSyncGroup for SCVH", e);
        return null;
      }
    }
    ...
    public /* synthetic */ void lambda$getSurfaceSyncGroup$3(CompletableFuture surfaceSyncGroup) {
      surfaceSyncGroup.complete(
          SurfaceControlViewHost.this.mViewRoot.getOrCreateSurfaceSyncGroup().mISurfaceSyncGroup);
    }
  }
  ...
  public static final class SurfacePackage implements Parcelable {
    public static final Parcelable.Creator<SurfacePackage> CREATOR =
        new Parcelable.Creator<
            SurfacePackage>() { // from class: android.view.SurfaceControlViewHost.SurfacePackage.1
  ...
  public SurfaceControlViewHost(
      Context context, Display display, IBinder hostToken, String callsite) {
    CloseGuard closeGuard = CloseGuard.get();
    this.mCloseGuard = closeGuard;
    this.mReleased = false;
    this.mRemoteInterface = new ISurfaceControlViewHostImpl();
    this.mSurfaceControl =
        new SurfaceControl.Builder()
            ...
            .setName(TAG)
            .setCallsite(
                "SurfaceControlViewHost[" + callsite + NavigationBarInflaterView.SIZE_MOD_END)
            .build();
    this.mWm =
  ...
  public void relayout(
      WindowManager.LayoutParams attrs, WindowlessWindowManager.ResizeCompleteCallback callback) {
  ...
  private void addWindowToken(WindowManager.LayoutParams attrs) {
    WindowManagerImpl wm =
        (WindowManagerImpl) this.mViewRoot.mContext.getSystemService(Context.WINDOW_SERVICE);
