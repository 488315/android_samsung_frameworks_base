...
public final class ViewTreeObserver {
  ...
  void merge(ViewTreeObserver observer) {
    CopyOnWriteArrayList<OnWindowAttachListener> copyOnWriteArrayList =
        observer.mOnWindowAttachListeners;
    if (copyOnWriteArrayList != null) {
      CopyOnWriteArrayList<OnWindowAttachListener> copyOnWriteArrayList2 =
          this.mOnWindowAttachListeners;
    ...
    CopyOnWriteArrayList<OnWindowFocusChangeListener> copyOnWriteArrayList3 =
        observer.mOnWindowFocusListeners;
    if (copyOnWriteArrayList3 != null) {
      CopyOnWriteArrayList<OnWindowFocusChangeListener> copyOnWriteArrayList4 =
          this.mOnWindowFocusListeners;
    ...
    CopyOnWriteArrayList<OnWindowVisibilityChangeListener> copyOnWriteArrayList5 =
        observer.mOnWindowVisibilityListeners;
    if (copyOnWriteArrayList5 != null) {
      CopyOnWriteArrayList<OnWindowVisibilityChangeListener> copyOnWriteArrayList6 =
    ...
    CopyOnWriteArrayList<OnGlobalFocusChangeListener> copyOnWriteArrayList7 =
        observer.mOnGlobalFocusListeners;
    if (copyOnWriteArrayList7 != null) {
      CopyOnWriteArrayList<OnGlobalFocusChangeListener> copyOnWriteArrayList8 =
          this.mOnGlobalFocusListeners;
    ...
    CopyOnWriteArrayList<OnTouchModeChangeListener> copyOnWriteArrayList9 =
        observer.mOnTouchModeChangeListeners;
    if (copyOnWriteArrayList9 != null) {
      CopyOnWriteArrayList<OnTouchModeChangeListener> copyOnWriteArrayList10 =
    ...
    CopyOnWriteArray<OnComputeInternalInsetsListener> copyOnWriteArray5 =
        observer.mOnComputeInternalInsetsListeners;
    if (copyOnWriteArray5 != null) {
      CopyOnWriteArray<OnComputeInternalInsetsListener> copyOnWriteArray6 =
    ...
    CopyOnWriteArray<OnScrollChangedListener> copyOnWriteArray7 =
        observer.mOnScrollChangedListeners;
  ...
  public void removeOnWindowVisibilityChangeListener(OnWindowVisibilityChangeListener victim) {
    checkIsAlive();
    CopyOnWriteArrayList<OnWindowVisibilityChangeListener> copyOnWriteArrayList =
        this.mOnWindowVisibilityListeners;
    if (copyOnWriteArrayList == null) {
      return;
    }
  ...
  public void addOnDrawListener(OnDrawListener listener) {
    ...
    if (this.mInDispatchOnDraw) {
      ...
      Log.m97e("ViewTreeObserver", ex.getMessage(), ex);
    }
  ...
  public void removeOnComputeInternalInsetsListener(OnComputeInternalInsetsListener victim) {
    checkIsAlive();
    CopyOnWriteArray<OnComputeInternalInsetsListener> copyOnWriteArray =
        this.mOnComputeInternalInsetsListeners;
    if (copyOnWriteArray == null) {
      return;
    }
  ...
  public void removeOnEnterAnimationCompleteListener(OnEnterAnimationCompleteListener listener) {
    checkIsAlive();
    CopyOnWriteArrayList<OnEnterAnimationCompleteListener> copyOnWriteArrayList =
