...
public final class PixelCopy {
    ...
    class C36641 extends HardwareRenderer.CopyRequest {
        ...
        C36641(Rect srcRect, Bitmap destinationBitmap, Handler handler, OnPixelCopyFinishedListener onPixelCopyFinishedListener) {
    ...
    public static final class Request {
        ...
        public void request(Executor callbackExecutor, final Consumer<Result> listener) {
            if (!this.mSource.isValid()) {
                ...
                HardwareRenderer.copySurfaceInto(this.mSource, new C36651(PixelCopy.adjustSourceRectForInsets(this.mSourceInsets, this.mSrcRect), this.mDest, callbackExecutor, listener));
            }
        }
