...
public final class PixelCopy {
  ...
  public static void request(
      Surface source, Bitmap dest, OnPixelCopyFinishedListener listener, Handler listenerThread) {
  ...
  public static void request(
    ...
    HardwareRenderer.copySurfaceInto(source, new C36641(srcRect, dest, listenerThread, listener));
  }

  /* renamed from: android.view.PixelCopy$1 */
  class C36641 extends HardwareRenderer.CopyRequest {
    ...
    public void onCopyFinished(final int result) {
      ...
      handler.post(
          new Runnable() { // from class: android.view.PixelCopy$1$$ExternalSyntheticLambda0
  ...
  public static void request(
      Window source, Bitmap dest, OnPixelCopyFinishedListener listener, Handler listenerThread) {
    request(source, (Rect) null, dest, listener, listenerThread);
  }
  ...
  public static final class Request {
    ...
    public void request(Executor callbackExecutor, final Consumer<Result> listener) {
      if (!this.mSource.isValid()) {
        callbackExecutor.execute(
            new Runnable() { // from class: android.view.PixelCopy$Request$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
        ...
        HardwareRenderer.copySurfaceInto(
            this.mSource,
            new C36651(
                PixelCopy.adjustSourceRectForInsets(this.mSourceInsets, this.mSrcRect),
                this.mDest,
                callbackExecutor,
                listener));
      }
    ...
    class C36651 extends HardwareRenderer.CopyRequest {
      final /* synthetic */ Executor val$callbackExecutor;
      final /* synthetic */ Consumer val$listener;

      /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
      C36651(Rect srcRect, Bitmap destinationBitmap, Executor executor, Consumer consumer) {
        super(srcRect, destinationBitmap);
      ...
      public void onCopyFinished(final int result) {
        ...
        executor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                PixelCopy.Request.C36651.this.lambda$onCopyFinished$0(consumer, result);
              }
            });
      }
    }
