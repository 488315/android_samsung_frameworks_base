...
public class SpellCheckerSession {
  ...
  public SpellCheckerSession(
    ...
    SpellCheckerSessionListenerImpl spellCheckerSessionListenerImpl =
        new SpellCheckerSessionListenerImpl(this);
      ...
      switch (this.mState) {
        ...
        default:
          Log.m96e(
              ...
              "processCloseLocked is called unexpectedly. mState=" + stateToString(this.mState));
          break;
      }
    }
      ...
      public SpellCheckerSessionParams build() {
        ...
        if (locale == null && !this.mShouldReferToSpellCheckerLanguageSettings) {
          throw new IllegalArgumentException(
              "mLocale should not be null if  mShouldReferToSpellCheckerLanguageSettings is"
                  + " false.");
        }
