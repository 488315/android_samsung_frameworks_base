...
public final class WidgetInfo implements Parcelable {
  public static final Parcelable.Creator<WidgetInfo> CREATOR =
      new Parcelable.Creator<
          WidgetInfo>() { // from class: android.view.selectiontoolbar.WidgetInfo.1
  ...
  public WidgetInfo(
      long widgetToken, Rect contentRect, SurfaceControlViewHost.SurfacePackage surfacePackage) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) surfacePackage);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (this.mWidgetToken == that.mWidgetToken
        ...
        && Objects.equals(this.mSurfacePackage, that.mSurfacePackage)) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    return (((_hash * 31) + Objects.hashCode(this.mContentRect)) * 31)
        + Objects.hashCode(this.mSurfacePackage);
  }
  ...
  WidgetInfo(Parcel in) {
    ...
    SurfaceControlViewHost.SurfacePackage surfacePackage =
        (SurfaceControlViewHost.SurfacePackage)
            in.readTypedObject(SurfaceControlViewHost.SurfacePackage.CREATOR);
    this.mWidgetToken = widgetToken;
    this.mContentRect = contentRect;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) contentRect);
