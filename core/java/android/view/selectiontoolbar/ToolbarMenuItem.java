...
public final class ToolbarMenuItem implements Parcelable {
  public static final Parcelable.Creator<ToolbarMenuItem> CREATOR =
      new Parcelable.Creator<
          ToolbarMenuItem>() { // from class: android.view.selectiontoolbar.ToolbarMenuItem.1
  ...
  public boolean equals(Object o) {
    ...
    if (this.mItemId == that.mItemId
        && Objects.equals(this.mTitle, that.mTitle)
        && Objects.equals(this.mContentDescription, that.mContentDescription)
        && this.mGroupId == that.mGroupId
        && Objects.equals(this.mIcon, that.mIcon)
        && Objects.equals(this.mTooltipText, that.mTooltipText)
        && this.mPriority == that.mPriority) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    return (((((((((((_hash * 31) + Objects.hashCode(this.mTitle)) * 31)
                                        + Objects.hashCode(this.mContentDescription))
                                    * 31)
                                + this.mGroupId)
                            * 31)
                        + Objects.hashCode(this.mIcon))
                    * 31)
                + Objects.hashCode(this.mTooltipText))
            * 31)
        + this.mPriority;
  }
  ...
  public static final class Builder {
    ...
    public Builder(
      ...
      AnnotationValidations.validate(
          (Class<NonNull>) NonNull.class, (NonNull) null, (Object) title);
      this.mContentDescription = contentDescription;
      this.mGroupId = groupId;
      this.mIcon = icon;
      this.mTooltipText = tooltipText;
