...
public final class ShowInfo implements Parcelable {
  public static final Parcelable.Creator<ShowInfo> CREATOR =
      new Parcelable.Creator<ShowInfo>() { // from class: android.view.selectiontoolbar.ShowInfo.1
  ...
  public ShowInfo(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) menuItems);
    this.mContentRect = contentRect;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) contentRect);
    this.mSuggestedWidth = suggestedWidth;
    this.mViewPortOnScreen = viewPortOnScreen;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) viewPortOnScreen);
    this.mHostInputToken = hostInputToken;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) hostInputToken);
  ...
  public String toString() {
    return "ShowInfo { widgetToken = "
        + this.mWidgetToken
        + ", layoutRequired = "
        + this.mLayoutRequired
        + ", menuItems = "
        + this.mMenuItems
        + ", contentRect = "
        + this.mContentRect
        + ", suggestedWidth = "
        + this.mSuggestedWidth
        + ", viewPortOnScreen = "
        + this.mViewPortOnScreen
        + ", hostInputToken = "
  ...
  public boolean equals(Object o) {
    ...
    if (this.mWidgetToken == that.mWidgetToken
        && this.mLayoutRequired == that.mLayoutRequired
        && Objects.equals(this.mMenuItems, that.mMenuItems)
        && Objects.equals(this.mContentRect, that.mContentRect)
        && this.mSuggestedWidth == that.mSuggestedWidth
        && Objects.equals(this.mViewPortOnScreen, that.mViewPortOnScreen)
        && Objects.equals(this.mHostInputToken, that.mHostInputToken)
        && this.mIsLightTheme == that.mIsLightTheme) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    return (((((((((((((_hash * 31) + Boolean.hashCode(this.mLayoutRequired)) * 31)
                                                + Objects.hashCode(this.mMenuItems))
                                            * 31)
                                        + Objects.hashCode(this.mContentRect))
                                    * 31)
                                + this.mSuggestedWidth)
                            * 31)
                        + Objects.hashCode(this.mViewPortOnScreen))
                    * 31)
