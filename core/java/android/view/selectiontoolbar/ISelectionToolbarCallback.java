...
public interface ISelectionToolbarCallback extends IInterface {
  ...
  public abstract static class Stub extends Binder implements ISelectionToolbarCallback {
        ...
        default:
          switch (code) {
            ...
            case 3:
              ...
              return true;
            case 4:
              ToolbarMenuItem _arg03 =
                  (ToolbarMenuItem) data.readTypedObject(ToolbarMenuItem.CREATOR);
              data.enforceNoDataAvail();
