...
public class DragEvent implements Parcelable {
    ...
    public static final Parcelable.Creator<DragEvent> CREATOR = new Parcelable.Creator<DragEvent>() { // from class: android.view.DragEvent.1
        ...
        public DragEvent createFromParcel(Parcel in) {
            ...
            event.f541mX = in.readFloat();
            event.f542mY = in.readFloat();
    ...
    public static DragEvent obtain(DragEvent source) {
        return obtain(source.mAction, source.f541mX, source.f542mY, source.mOffsetX, source.mOffsetY, source.mLocalState, source.mClipDescription, source.mClipData, source.mDragSurface, source.mDragAndDropPermissions, source.mDragResult, source.mIsStickyEvent);
    }
    ...
    public String toString() {
        return "DragEvent{" + Integer.toHexString(System.identityHashCode(this)) + " action=" + this.mAction + " @ (" + this.f541mX + ", " + this.f542mY + ") desc=" + this.mClipDescription + " data=" + this.mClipData + " local=" + this.mLocalState + " result=" + this.mDragResult + " isEavesDrop=" + this.mIsEavesDropEvent + " isStickyEvent=" + this.mIsStickyEvent + "}";
    }
