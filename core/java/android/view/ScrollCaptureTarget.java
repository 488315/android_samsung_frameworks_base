...
public final class ScrollCaptureTarget {
    ...
    void dump(PrintWriter writer) {
        ...
        writer.println("positionInWindow: " + (inWindow == null ? SemCapabilities.FEATURE_TAG_NULL : NavigationBarInflaterView.SIZE_MOD_START + inWindow.f85x + "," + inWindow.f86y + NavigationBarInflaterView.SIZE_MOD_END));
