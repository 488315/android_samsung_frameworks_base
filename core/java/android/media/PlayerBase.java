...
public abstract class PlayerBase {
    ...
    try {
      this.mPlayerIId =
          getService()
              .trackPlayer(
                  new PlayerIdCard(
                      this.mImplType, this.mAttributes, new IPlayerWrapper(this), sessionId));
  ...
  public static void deprecateStreamTypeForPlayback(int streamType, String className, String opName)
    ...
    Log.m102w(
        className, "Use of stream types is deprecated for operations other than volume control");
    Log.m102w(
        className,
