...
public final class MediaCas implements AutoCloseable {
  ...
  private static final Singleton<IMediaCasService> sService =
      new Singleton<IMediaCasService>() { // from class: android.media.MediaCas.1
        /* JADX INFO: Access modifiers changed from: protected */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.util.Singleton
        public IMediaCasService create() {
          try {
            Log.m94d(MediaCas.TAG, "Trying to get AIDL service");
            ...
            Log.m94d(MediaCas.TAG, "Failed to get cas AIDL service");
            return null;
          }
        }
      };
  private static final Singleton<android.hardware.cas.V1_0.IMediaCasService> sServiceHidl =
      new Singleton<
          android.hardware.cas.V1_0.IMediaCasService>() { // from class: android.media.MediaCas.2
        /* JADX INFO: Access modifiers changed from: protected */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.util.Singleton
        public android.hardware.cas.V1_0.IMediaCasService create() {
          try {
            Log.m94d(MediaCas.TAG, "Trying to get cas@1.2 service");
            android.hardware.cas.V1_2.IMediaCasService serviceV12 =
                android.hardware.cas.V1_2.IMediaCasService.getService(true);
            if (serviceV12 != null) {
              return serviceV12;
            }
          } catch (Exception e) {
            Log.m94d(MediaCas.TAG, "Failed to get cas@1.2 service");
          }
          try {
            Log.m94d(MediaCas.TAG, "Trying to get cas@1.1 service");
            android.hardware.cas.V1_1.IMediaCasService serviceV11 =
                android.hardware.cas.V1_1.IMediaCasService.getService(true);
            if (serviceV11 != null) {
              return serviceV11;
            }
          } catch (Exception e2) {
            Log.m94d(MediaCas.TAG, "Failed to get cas@1.1 service");
          }
          try {
            Log.m94d(MediaCas.TAG, "Trying to get cas@1.0 service");
            return android.hardware.cas.V1_0.IMediaCasService.getService(true);
          } catch (Exception e3) {
            Log.m94d(MediaCas.TAG, "Failed to get cas@1.0 service");
            return null;
          }
        }
      };
  ...
  private final TunerResourceManager.ResourcesReclaimListener mResourceListener =
      new TunerResourceManager.ResourcesReclaimListener() { // from class: android.media.MediaCas.5
    ...
    public void handleMessage(Message msg) {
      ...
      if (msg.what == 1) {
        ...
        eventListener.onSessionEvent(
            mediaCas, mediaCas.createFromSessionId(sessionId), msg.arg1, msg.arg2, data2);
        return;
      }
      if (msg.what == 2) {
  ...
  public final class Session implements AutoCloseable {
    ...
    public void sendSessionEvent(int event, int arg, byte[] data) throws MediaCasException {
      ...
      if (MediaCas.this.mICasHidl11 == null) {
        Log.m94d(MediaCas.TAG, "Send Session Event isn't supported by cas@1.0 interface");
      ...
      try {
        if (MediaCas.this.mICas != null) {
          ...
          MediaCasStateException.throwExceptionIfNeeded(
              MediaCas.this.mICasHidl.closeSession(MediaCas.this.toByteArray(this.mSessionId)));
        }
        this.mIsClosed = true;
  ...
  private void createPlugin(int casSystemId) throws MediaCasException.UnsupportedCasException {
    try {
      try {
        ...
        if (service != null) {
          Log.m94d(TAG, "Use CAS AIDL interface to create plugin");
          ...
          android.hardware.cas.V1_2.IMediaCasService serviceV12 =
              android.hardware.cas.V1_2.IMediaCasService.castFrom((IHwInterface) serviceV10);
          if (serviceV12 == null) {
            android.hardware.cas.V1_1.IMediaCasService serviceV11 =
                android.hardware.cas.V1_1.IMediaCasService.castFrom((IHwInterface) serviceV10);
            if (serviceV11 == null) {
              Log.m94d(TAG, "Used cas@1_0 interface to create plugin");
              this.mICasHidl = serviceV10.createPlugin(casSystemId, this.mBinderHidl);
            } else {
              Log.m94d(TAG, "Used cas@1.1 interface to create plugin");
            ...
            Log.m94d(TAG, "Used cas@1.2 interface to create plugin");
            android.hardware.cas.V1_2.ICas castFrom =
                android.hardware.cas.V1_2.ICas.castFrom(
                    (IHwInterface) serviceV12.createPluginExt(casSystemId, this.mBinderHidl));
        ...
        Log.m96e(TAG, "Failed to create plugin: " + e);
        this.mICas = null;
        this.mICasHidl = null;
        throw new MediaCasException.UnsupportedCasException(
            "Unsupported casSystemId " + casSystemId);
  ...
  private void registerClient(Context context, String tvInputServiceSessionId, int priorityHint) {
    TunerResourceManager tunerResourceManager =
        (TunerResourceManager) context.getSystemService(Context.TV_TUNER_RESOURCE_MGR_SERVICE);
  ...
  public interface EventListener {
    ...
    default void onSessionEvent(
      ...
      Log.m94d(MediaCas.TAG, "Received MediaCas Session event");
    }

    default void onPluginStatusUpdate(MediaCas mediaCas, int status, int arg) {
      Log.m94d(MediaCas.TAG, "Received MediaCas Plugin Status event");
    }

    default void onResourceLost(MediaCas mediaCas) {
      Log.m94d(MediaCas.TAG, "Received MediaCas Resource Reclaim event");
    }
  }
  ...
  public Session openSession() throws MediaCasException {
    ...
    try {
      ...
      if (iCas != null) {
        try {
          ...
          Log.m94d(TAG, "Write Stats Log for succeed to Open Session.");
    ...
    Log.m94d(TAG, "Write Stats Log for fail to Open Session.");
  ...
  public Session openSession(int sessionUsage, int scramblingMode) throws MediaCasException {
    ...
    if (this.mICasHidl12 == null) {
      Log.m94d(TAG, "Open Session with scrambling mode is only supported by cas@1.2+ interface");
      throw new MediaCasException.UnsupportedCasException(
