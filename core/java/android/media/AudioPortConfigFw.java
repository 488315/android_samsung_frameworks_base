...
public class AudioPortConfigFw implements Parcelable {
  public static final Parcelable.Creator<AudioPortConfigFw> CREATOR =
      new Parcelable.Creator<AudioPortConfigFw>() { // from class: android.media.AudioPortConfigFw.1
    ...
    try {
      ...
      this.hal =
          (android.media.audio.common.AudioPortConfig)
              _aidl_parcel.readTypedObject(android.media.audio.common.AudioPortConfig.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
