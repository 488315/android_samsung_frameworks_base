...
public class MicrophoneInfoFw implements Parcelable {
  public static final Parcelable.Creator<MicrophoneInfoFw> CREATOR =
      new Parcelable.Creator<MicrophoneInfoFw>() { // from class: android.media.MicrophoneInfoFw.1
    ...
    try {
      ...
      this.info =
          (android.media.audio.common.MicrophoneInfo)
              _aidl_parcel.readTypedObject(android.media.audio.common.MicrophoneInfo.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
      ...
      this.dynamic =
          (MicrophoneDynamicInfo) _aidl_parcel.readTypedObject(MicrophoneDynamicInfo.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
