...
public abstract class MediaMetadataEditor {
  ...
  public synchronized void clear() {
    if (this.mApplied) {
      Log.m96e(TAG, "Can't clear a previously applied MediaMetadataEditor");
      return;
    }
  ...
  public synchronized void addEditableKey(int key) {
    if (this.mApplied) {
      Log.m96e(TAG, "Can't change editable keys of a previously applied MetadataEditor");
      return;
    }
    if (key == 268435457) {
      ...
      Log.m96e(TAG, "Metadata key " + key + " cannot be edited");
    }
  }

  public synchronized void removeEditableKeys() {
    if (this.mApplied) {
      Log.m96e(TAG, "Can't remove all editable keys of a previously applied MetadataEditor");
      return;
    }
  ...
  public synchronized MediaMetadataEditor putString(int key, String value)
    ...
    if (this.mApplied) {
      Log.m96e(TAG, "Can't edit a previously applied MediaMetadataEditor");
      return this;
    }
