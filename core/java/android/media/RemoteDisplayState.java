...
public final class RemoteDisplayState implements Parcelable {
    ...
    public static final class RemoteDisplayInfo implements Parcelable {
        ...
        public boolean isValid() {
            return (TextUtils.isEmpty(this.f292id) || TextUtils.isEmpty(this.name)) ? false : true;
        }
        ...
        public String toString() {
            return "RemoteDisplayInfo{ id=" + this.f292id + ", name=" + this.name + ", description=" + this.description + ", status=" + this.status + ", volume=" + this.volume + ", volumeMax=" + this.volumeMax + ", volumeHandling=" + this.volumeHandling + ", presentationDisplayId=" + this.presentationDisplayId + " }";
        }
    }
}
