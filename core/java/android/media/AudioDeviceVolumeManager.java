...
public class AudioDeviceVolumeManager {
          ...
          listenerInfo.mExecutor.execute(
              new Runnable() { // from class:
                ...
                public final void run() {
                  AudioDeviceVolumeManager.ListenerInfo.this.mListener.onAudioDeviceVolumeChanged(
                      device, vol);
                }
              });
        }
        ...
        if (listenerInfo.mDevice.equalTypeAddress(device)) {
          listenerInfo.mExecutor.execute(
              new Runnable() { // from class:
                ...
                @Override // java.lang.Runnable
                public final void run() {
                  AudioDeviceVolumeManager.ListenerInfo.this.mListener.onAudioDeviceVolumeAdjusted(
              ...
              public final boolean test(Object obj) {
                ...
                equalTypeAddress =
                    ((AudioDeviceVolumeManager.ListenerInfo) obj)
                        .mDevice.equalTypeAddress(AudioDeviceAttributes.this);
  ...
  public void addOnDeviceVolumeBehaviorChangedListener(
      Executor executor, OnDeviceVolumeBehaviorChangedListener listener) throws SecurityException {
        ...
        new Supplier() { // from class:
          ...
          public final Object get() {
            ...
            lambda$addOnDeviceVolumeBehaviorChangedListener$1 =
                AudioDeviceVolumeManager.this.lambda$addOnDeviceVolumeBehaviorChangedListener$1();
          ...
          new CallbackUtil
            ...
            public final void callbackMethod(Object obj) {
              ((AudioDeviceVolumeManager.OnDeviceVolumeBehaviorChangedListener) obj)
                  .onDeviceVolumeBehaviorChanged(AudioDeviceAttributes.this, volumeBehavior);
            }
          });
    }
  }
