...
public final class MediaRoute2Info implements Parcelable {
  ...
  public static final Parcelable.Creator<MediaRoute2Info> CREATOR =
      new Parcelable.Creator<MediaRoute2Info>() { // from class: android.media.MediaRoute2Info.1
  ...
  public String toString() {
    StringBuilder result =
        new StringBuilder()
            ...
            .append(this.mIsVisibilityRestricted)
            .append(", allowedPackages=")
            .append(String.join(",", this.mAllowedPackages))
            .append(" }");
