...
public class AudioProfile implements Parcelable {
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(Arrays.hashCode(this.mSamplingRates)),
        Integer.valueOf(Arrays.hashCode(this.mChannelMasks)),
        Integer.valueOf(Arrays.hashCode(this.mChannelIndexMasks)),
  ...
  public boolean equals(Object o) {
    ...
    if (this.mFormat == that.mFormat
        && hasIdenticalElements(this.mSamplingRates, that.mSamplingRates)
        && hasIdenticalElements(this.mChannelMasks, that.mChannelMasks)
        && hasIdenticalElements(this.mChannelIndexMasks, that.mChannelIndexMasks)
        ...
        Arrays.stream(ints)
            .mapToObj(
                new IntFunction() { // from class:
                                    // android.media.AudioProfile$$ExternalSyntheticLambda0
