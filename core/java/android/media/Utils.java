...
public class Utils {
  ...
  static Size parseSize(Object o, Size fallback) {
    ...
    try {
      ...
      Log.m102w(TAG, "could not parse size '" + o + "'");
      return fallback;
    }
  }
  ...
  static int parseIntSafely(Object o, int fallback) {
    ...
    try {
      ...
      Log.m102w(TAG, "could not parse integer '" + o + "'");
      return fallback;
    }
  }
  ...
  static Range<Integer> parseIntRange(Object o, Range<Integer> fallback) {
    ...
    try {
      ...
      Log.m102w(TAG, "could not parse integer range '" + o + "'");
      return fallback;
    }
  }
  ...
  static Range<Long> parseLongRange(Object o, Range<Long> fallback) {
    ...
    try {
      ...
      Log.m102w(TAG, "could not parse long range '" + o + "'");
      return fallback;
    }
  }
  ...
  static Range<Rational> parseRationalRange(Object o, Range<Rational> fallback) {
    ...
    try {
      ...
      Log.m102w(TAG, "could not parse rational range '" + o + "'");
      return fallback;
    }
  }
  ...
  public static File getUniqueExternalFile(
    ...
    try {
      ...
      Log.m96e(TAG, "Unable to get a unique file name: " + e);
      return null;
    }
  }
  ...
  public static class ListenerList<V> {
    ...
    public void add(Object key, Executor executor, Listener<V> listener) {
      ...
      ListenerWithCancellation<V> listenerWithCancellation = new C18771(executor, listener);
    ...
    class C18771 implements ListenerWithCancellation<V> {
      final /* synthetic */ Executor val$executor;
      final /* synthetic */ Listener val$listener;
      private final Object mLock = new Object();
      private volatile boolean mCancelled = false;

      C18771(Executor executor, Listener listener) {
        ...
        executor.execute(
            new Runnable() { // from class:
              ...
              public final void run() {
                Utils.ListenerList.C18771.this.lambda$onEvent$0(listener, eventCode, info);
              }
            });
      }
    ...
    public void notify(int eventCode, V info) {
      synchronized (this.mListeners) {
        ...
        Long identity =
            this.mClearCallingIdentity ? Long.valueOf(Binder.clearCallingIdentity()) : null;
        try {
