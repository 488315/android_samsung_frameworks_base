...
public class RecognitionConfig implements Parcelable {
  public static final Parcelable.Creator<RecognitionConfig> CREATOR =
      new Parcelable.Creator<
          RecognitionConfig>() { // from class: android.media.soundtrigger.RecognitionConfig.1
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.phraseRecognitionExtras =
          (PhraseRecognitionExtra[]) _aidl_parcel.createTypedArray(PhraseRecognitionExtra.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(
            Boolean.valueOf(this.captureRequested), Boolean.valueOf(that.captureRequested))
