...
public class PhraseRecognitionExtra implements Parcelable {
  public static final Parcelable.Creator<PhraseRecognitionExtra> CREATOR =
      new Parcelable.Creator<
          PhraseRecognitionExtra>() { // from class:
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.f311id), Integer.valueOf(that.f311id))
        && Objects.deepEquals(
            Integer.valueOf(this.recognitionModes), Integer.valueOf(that.recognitionModes))
        && Objects.deepEquals(
            Integer.valueOf(this.confidenceLevel), Integer.valueOf(that.confidenceLevel))
