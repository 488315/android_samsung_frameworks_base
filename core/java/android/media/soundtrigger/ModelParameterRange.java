...
public class ModelParameterRange implements Parcelable {
  public static final Parcelable.Creator<ModelParameterRange> CREATOR =
      new Parcelable.Creator<
          ModelParameterRange>() { // from class: android.media.soundtrigger.ModelParameterRange.1
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.minInclusive), Integer.valueOf(that.minInclusive))
        && Objects.deepEquals(
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(Integer.valueOf(this.minInclusive), Integer.valueOf(this.maxInclusive))
            .toArray());
  }
