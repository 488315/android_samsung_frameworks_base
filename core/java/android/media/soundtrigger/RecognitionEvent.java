...
public class RecognitionEvent implements Parcelable {
  public static final Parcelable.Creator<RecognitionEvent> CREATOR =
      new Parcelable.Creator<
          RecognitionEvent>() { // from class: android.media.soundtrigger.RecognitionEvent.1
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.status), Integer.valueOf(that.status))
        ...
        && Objects.deepEquals(
            Boolean.valueOf(this.captureAvailable), Boolean.valueOf(that.captureAvailable))
        && Objects.deepEquals(
            Integer.valueOf(this.captureDelayMs), Integer.valueOf(that.captureDelayMs))
        && Objects.deepEquals(
            Integer.valueOf(this.capturePreambleMs), Integer.valueOf(that.capturePreambleMs))
        && Objects.deepEquals(
