...
public class SoundModel implements Parcelable {
  public static final Parcelable.Creator<SoundModel> CREATOR =
      new Parcelable.Creator<SoundModel>() { // from class: android.media.soundtrigger.SoundModel.1
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.type), Integer.valueOf(that.type))
        ...
        && Objects.deepEquals(Integer.valueOf(this.dataSize), Integer.valueOf(that.dataSize))) {
      return true;
    }
    return false;
  }
