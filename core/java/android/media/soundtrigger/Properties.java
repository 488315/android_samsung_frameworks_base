...
public class Properties implements Parcelable {
  public static final Parcelable.Creator<Properties> CREATOR =
      new Parcelable.Creator<Properties>() { // from class: android.media.soundtrigger.Properties.1
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(this.implementor, that.implementor)
        ...
        && Objects.deepEquals(Integer.valueOf(this.maxUsers), Integer.valueOf(that.maxUsers))
        && Objects.deepEquals(
            Integer.valueOf(this.recognitionModes), Integer.valueOf(that.recognitionModes))
        && Objects.deepEquals(
            Boolean.valueOf(this.captureTransition), Boolean.valueOf(that.captureTransition))
        && Objects.deepEquals(Integer.valueOf(this.maxBufferMs), Integer.valueOf(that.maxBufferMs))
        && Objects.deepEquals(
            Boolean.valueOf(this.concurrentCapture), Boolean.valueOf(that.concurrentCapture))
        && Objects.deepEquals(
            Boolean.valueOf(this.triggerInEvent), Boolean.valueOf(that.triggerInEvent))
        && Objects.deepEquals(
            Integer.valueOf(this.powerConsumptionMw), Integer.valueOf(that.powerConsumptionMw))
        && Objects.deepEquals(
            Integer.valueOf(this.audioCapabilities), Integer.valueOf(that.audioCapabilities))) {
      return true;
    }
    return false;
  }
