  ...
  class Injection extends ISoundTriggerInjection.Stub {
      ...
      synchronized (SoundTriggerInstrumentation.this.mLock) {
        ...
        SoundTriggerInstrumentation.this.mGlobalCallbackExecutor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                SoundTriggerInstrumentation.Injection.this.lambda$onSoundModelLoaded$0(
                    modelSession);
              }
            });
      }
    ...
    public void onSoundModelUnloaded(IInjectModelEvent modelSession) {
      synchronized (SoundTriggerInstrumentation.this.mLock) {
        ModelSession clientModelSession =
            (ModelSession)
                SoundTriggerInstrumentation.this.mModelSessionMap.remove(modelSession.asBinder());
    ...
    public void onRecognitionStarted(
      ...
      synchronized (SoundTriggerInstrumentation.this.mLock) {
        ModelSession clientModelSession =
            (ModelSession)
                SoundTriggerInstrumentation.this.mModelSessionMap.get(modelSession.asBinder());
        if (clientModelSession == null) {
          return;
        }
            ...
            new Consumer() { // from class:
              ...
              public final void accept(Object obj) {
                ((SoundTriggerInstrumentation.ModelCallback) obj)
                    .onRecognitionStarted(SoundTriggerInstrumentation.RecognitionSession.this);
              }
            });
      }
    }
    ...
    synchronized (this.mLock) {
      ...
      try {
        current.setResourceContention(
            isResourceContended,
            new IAcknowledgeEvent
                .Stub() { // from class: android.media.soundtrigger.SoundTriggerInstrumentation.1
