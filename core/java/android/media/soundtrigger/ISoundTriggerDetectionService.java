...
public interface ISoundTriggerDetectionService extends IInterface {
  ...
  void onGenericRecognitionEvent(
      ParcelUuid parcelUuid, int i, SoundTrigger.GenericRecognitionEvent genericRecognitionEvent)
          ...
          switch (code) {
            case 1:
              ...
              ISoundTriggerDetectionServiceClient _arg2 =
                  ISoundTriggerDetectionServiceClient.Stub.asInterface(data.readStrongBinder());
