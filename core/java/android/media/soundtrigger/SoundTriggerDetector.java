...
public final class SoundTriggerDetector {
      ...
      int status =
          this.mSoundTriggerSession.startRecognition(
              ...
              new SoundTrigger.RecognitionConfig(
                  captureTriggerAudio, allowMultipleTriggers, null, null, audioCapabilities),
              runInBatterySaver);
      return status == 0;
  ...
  private class RecognitionCallback extends IRecognitionStatusCallback.Stub {
    ...
    public void onGenericSoundTriggerDetected(SoundTrigger.GenericRecognitionEvent event) {
      Slog.m113d(SoundTriggerDetector.TAG, "onGenericSoundTriggerDetected()" + event);
      Message.obtain(
    ...
    public void onKeyphraseDetected(SoundTrigger.KeyphraseRecognitionEvent event) {
      Slog.m115e(SoundTriggerDetector.TAG, "Ignoring onKeyphraseDetected() called for " + event);
    }

    @Override // android.hardware.soundtrigger.IRecognitionStatusCallback
    public void onRecognitionPaused() {
      Slog.m113d(SoundTriggerDetector.TAG, "onRecognitionPaused()");
      SoundTriggerDetector.this.mHandler.sendEmptyMessage(4);
    }

    @Override // android.hardware.soundtrigger.IRecognitionStatusCallback
    public void onRecognitionResumed() {
      Slog.m113d(SoundTriggerDetector.TAG, "onRecognitionResumed()");
      SoundTriggerDetector.this.mHandler.sendEmptyMessage(5);
    }

    @Override // android.hardware.soundtrigger.IRecognitionStatusCallback
    public void onPreempted() {
      Slog.m113d(SoundTriggerDetector.TAG, "onPreempted()");
      SoundTriggerDetector.this.mHandler.sendEmptyMessage(3);
    }

    @Override // android.hardware.soundtrigger.IRecognitionStatusCallback
    public void onModuleDied() {
      Slog.m113d(SoundTriggerDetector.TAG, "onModuleDied()");
      SoundTriggerDetector.this.mHandler.sendEmptyMessage(3);
    }

    @Override // android.hardware.soundtrigger.IRecognitionStatusCallback
    public void onResumeFailed(int status) {
      Slog.m113d(SoundTriggerDetector.TAG, "onResumeFailed()" + status);
      SoundTriggerDetector.this.mHandler.sendEmptyMessage(3);
    }

    @Override // android.hardware.soundtrigger.IRecognitionStatusCallback
    public void onPauseFailed(int status) {
      Slog.m113d(SoundTriggerDetector.TAG, "onPauseFailed()" + status);
      SoundTriggerDetector.this.mHandler.sendEmptyMessage(3);
    }
  }
  ...
  private class MyHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      if (SoundTriggerDetector.this.mCallback == null) {
        Slog.m121w(
            SoundTriggerDetector.TAG, "Received message: " + msg.what + " for NULL callback.");
      }
      switch (msg.what) {
        case 2:
