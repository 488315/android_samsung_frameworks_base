...
public class AudioVolumeGroupChangeHandler {
                            ...
                            public void handleMessage(Message msg) {
                                ...
                                synchronized (this) {
                                    if (msg.what == 4) {
                                        ...
                                        if (AudioVolumeGroupChangeHandler.this.mListeners.contains(
                                                msg.obj)) {
                                            listeners.add(
                                        ...
                                        listeners =
                                                (ArrayList)
                                                        AudioVolumeGroupChangeHandler.this
                                                                .mListeners.clone();
                                    }
                                }
                                ...
                                switch (msg.what) {
                                    case 1000:
                                        for (int i = 0; i < listeners.size(); i++) {
                                            listeners
                                                    .get(i)
                                                    .onAudioVolumeGroupChanged(msg.arg1, msg.arg2);
                                        }
                                        return;
                                    default:
                                        return;
    ...
    private static void postEventFromNative(
            Object moduleRef, int what, int arg1, int arg2, Object obj) {
        Handler handler;
