...
public class AudioPolicy {
  ...
  private AudioPolicy(
    ...
    this.mPolicyCb =
        new IAudioPolicyCallback.Stub() { // from class: android.media.audiopolicy.AudioPolicy.1
  ...
  public AudioRecord createAudioRecordSink(AudioMix mix) throws IllegalArgumentException {
    ...
    AudioFormat mixFormat =
        new AudioFormat.Builder(mix.getFormat())
            .setChannelMask(
                AudioFormat.inChannelMaskFromOutChannelMask(mix.getFormat().getChannelMask()))
            .build();
