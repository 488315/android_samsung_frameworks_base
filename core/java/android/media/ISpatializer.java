...
public interface ISpatializer extends IInterface {
  ...
  void registerHeadTrackingCallback(
      ISpatializerHeadTrackingCallback iSpatializerHeadTrackingCallback) throws RemoteException;
          ...
          switch (code) {
            ...
            case 17:
              ISpatializerHeadTrackingCallback _arg09 =
                  ISpatializerHeadTrackingCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
