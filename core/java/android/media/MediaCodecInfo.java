...
public final class MediaCodecInfo {
  ...
  public static final class CodecCapabilities {
    ...
    private static final Feature[] decoderFeatures = {
      new Feature(FEATURE_AdaptivePlayback, 1, true),
      new Feature(FEATURE_SecurePlayback, 2, false),
      new Feature(FEATURE_TunneledPlayback, 4, false),
      new Feature(FEATURE_PartialFrame, 8, false),
      new Feature(FEATURE_FrameParsing, 16, false),
      new Feature(FEATURE_MultipleFrames, 32, false),
      new Feature(FEATURE_DynamicTimestamp, 64, false),
      new Feature("low-latency", 128, true),
      new Feature(FEATURE_SpecialCodec, 1073741824, false, true)
    };
    ...
    private static final Feature[] encoderFeatures = {
      new Feature(FEATURE_IntraRefresh, 1, false),
      new Feature(FEATURE_MultipleFrames, 2, false),
      new Feature(FEATURE_DynamicTimestamp, 4, false),
      new Feature(FEATURE_QpBounds, 8, false),
      new Feature(FEATURE_EncodingStatistics, 16, false),
      new Feature(FEATURE_HdrEditing, 32, false),
      new Feature(FEATURE_SpecialCodec, 1073741824, false, true)
    };
    ...
    public final boolean isFormatSupported(MediaFormat format) {
      ...
      for (Feature feat : getValidFeatures()) {
        if (!feat.mInternal
            && (yesNo = (Integer) map.get(MediaFormat.KEY_FEATURE_ + feat.mName)) != null
      ...
      if (profile != null) {
        ...
        for (CodecProfileLevel pl : this.profileLevels) {
          if (pl.profile == profile.intValue()
              && pl.level > maxLevel
              && (!this.mMime.equalsIgnoreCase("video/3gpp") || pl.level != 16 || maxLevel == 1)) {
            maxLevel = pl.level;
          }
        }
          ...
          if ((!this.mMime.equalsIgnoreCase("video/3gpp")
            ...
            if (pl.level >= level.intValue()) {
              return createFromProfileLevel(this.mMime, profile, pl.level) == null
                  || createFromProfileLevel(this.mMime, profile, level.intValue()) != null;
            }
          }
        }
      }
    ...
    public CodecCapabilities dup() {
      ...
      caps.profileLevels =
          (CodecProfileLevel[]) Arrays.copyOf(codecProfileLevelArr, codecProfileLevelArr.length);
    ...
    public static CodecCapabilities createFromProfileLevel(String mime, int profile, int level) {
      ...
      CodecCapabilities ret =
          new CodecCapabilities(
              new CodecProfileLevel[] {pl}, new int[0], true, defaultFormat, new MediaFormat());
      if (ret.mError != 0) {
        return null;
      }
      return ret;
    ...
    CodecCapabilities(
      ...
      int maxInstances =
          Utils.parseIntSafely(map.get("max-concurrent-instances"), this.mMaxSupportedInstances);
      this.mMaxSupportedInstances =
          ((Integer) Range.create(1, 256).clamp(Integer.valueOf(maxInstances))).intValue();
  ...
  public static final class AudioCapabilities {
    ...
    private void limitSampleRates(Range<Integer>[] rateRanges) {
      ...
      Range<Integer>[] intersectSortedDistinctRanges =
      ...
      if (mime.equalsIgnoreCase("audio/mpeg")) {
        sampleRates =
            new int[] {
              ...
              24000,
              32000,
              SemDolbyAudioEffect.SAMPLE_RATE_44100,
              48000
            };
        ...
        if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_OPUS)) {
          ...
          if (!mime.equalsIgnoreCase("audio/flac")) {
            if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_G711_ALAW)) {
              ...
              bitRates =
                  Range.create(
                      Integer.valueOf(EncodeConstants.BitRate.MM_AVG_FHD_DATARATE),
                      Integer.valueOf(EncodeConstants.BitRate.MM_AVG_FHD_DATARATE));
              maxChannels = 1;
              ...
              while (i2 < length) {
                ...
                switch (profileLevel.profile) {
                  ...
                  case 4:
                    ...
                    sampleRates =
                        new int[] {
                          SemDolbyAudioEffect.SAMPLE_RATE_44100, 48000, 88200, 96000, 176400, 192000
                        };
                  ...
                  case 2:
                    sampleRateRange2 = sampleRateRange3;
                    int[] sampleRates2 = {
                      22050, 24000, SemDolbyAudioEffect.SAMPLE_RATE_44100, 48000
                    };
                  ...
                  default:
                    sampleRateRange2 = sampleRateRange3;
                    Log.m102w(TAG, "Unrecognized profile " + profileLevel.profile + " for " + mime);
              ...
              while (i3 < length2) {
                ...
                switch (profileLevel2.profile) {
                  ...
                  default:
                    Log.m102w(
                        TAG, "Unrecognized profile " + profileLevel2.profile + " for " + mime);
                    this.mParent.mError |= 1;
                    sampleRates =
                        new int[] {
                          SemDolbyAudioEffect.SAMPLE_RATE_44100, 48000, 88200, 96000, 176400, 192000
              ...
              Log.m102w(TAG, "Unsupported mime " + mime);
    ...
    private void parseFromInfo(MediaFormat info) {
      ...
      if (info.containsKey("channel-ranges")) {
        ...
        channels =
            maxInputChannels == 0
                ? new Range[] {Range.create(0, 0)}
                : new Range[] {Range.create(1, Integer.valueOf(maxInputChannels))};
      } else if ((this.mParent.mError & 2) != 0) {
        channels = new Range[] {Range.create(0, 0)};
      }
      if (info.containsKey("bitrate-range")) {
        bitRates =
            bitRates.intersect(Utils.parseIntRange(info.getString("bitrate-range"), bitRates));
      }
  ...
  public static final class VideoCapabilities {
    ...
    public Range<Integer> getSupportedWidthsFor(int height) {
      try {
        ...
        int minWidthInBlocks =
            Math.max(
                Utils.divUp(this.mBlockCountRange.getLower().intValue(), heightInBlocks),
                (int)
                    Math.ceil(
                        this.mBlockAspectRatioRange.getLower().doubleValue() * heightInBlocks));
        int maxWidthInBlocks =
            Math.min(
                this.mBlockCountRange.getUpper().intValue() / heightInBlocks,
                (int) (this.mBlockAspectRatioRange.getUpper().doubleValue() * heightInBlocks));
        Range<Integer> range2 =
            range.intersect(
                Integer.valueOf(((minWidthInBlocks - 1) * this.mBlockWidth) + this.mWidthAlignment),
        ...
        return range2.intersect(
            Integer.valueOf(
                (int) Math.ceil(this.mAspectRatioRange.getLower().doubleValue() * height)),
            Integer.valueOf((int) (this.mAspectRatioRange.getUpper().doubleValue() * height)));
      } catch (IllegalArgumentException e) {
        Log.m100v(TAG, "could not get supported widths for " + height);
        throw new IllegalArgumentException("unsupported height");
      }
    }
    ...
    public Range<Integer> getSupportedHeightsFor(int width) {
      try {
        ...
        int minHeightInBlocks =
            Math.max(
                Utils.divUp(this.mBlockCountRange.getLower().intValue(), widthInBlocks),
                (int)
                    Math.ceil(
                        widthInBlocks / this.mBlockAspectRatioRange.getUpper().doubleValue()));
        int maxHeightInBlocks =
            Math.min(
                this.mBlockCountRange.getUpper().intValue() / widthInBlocks,
                (int) (widthInBlocks / this.mBlockAspectRatioRange.getLower().doubleValue()));
        Range<Integer> range2 =
            range.intersect(
                Integer.valueOf(
                    ((minHeightInBlocks - 1) * this.mBlockHeight) + this.mHeightAlignment),
        ...
        return range2.intersect(
            Integer.valueOf(
                (int) Math.ceil(width / this.mAspectRatioRange.getUpper().doubleValue())),
            Integer.valueOf((int) (width / this.mAspectRatioRange.getLower().doubleValue())));
      } catch (IllegalArgumentException e) {
        Log.m100v(TAG, "could not get supported heights for " + width);
        throw new IllegalArgumentException("unsupported width");
      }
    }
    ...
    public Range<Double> getAchievableFrameRatesFor(int width, int height) {
      ...
      if (map == null || map.size() <= 0) {
        Log.m102w(TAG, "Codec did not publish any measurement data.");
        return null;
      }
    ...
    public static final class PerformancePoint {
      ...
      public String toString() {
        ...
        if (origRate < this.mMaxFrameRate) {
          info =
              info + ", max " + this.mMaxFrameRate + SemMediaPostProcessor.ProcessingFormat.Key.FPS;
        }
      ...
      public PerformancePoint(
        ...
        this.mBlockSize =
            new Size(Utils.divUp(blockSize.getWidth(), 16), Utils.divUp(blockSize.getHeight(), 16));
        this.mWidth =
            (int)
                (Utils.divUp(Math.max(1L, width), Math.max(blockSize.getWidth(), 16))
                    * this.mBlockSize.getWidth());
        this.mHeight =
            (int)
                (Utils.divUp(Math.max(1L, height), Math.max(blockSize.getHeight(), 16))
      ...
      public boolean covers(MediaFormat format) {
        PerformancePoint other =
            new PerformancePoint(
                ...
                Math.round(
                    (float)
                        Math.ceil(format.getNumber(MediaFormat.KEY_FRAME_RATE, 0).doubleValue())));
        return covers(other);
      }
    ...
    private boolean supports(Integer width, Integer height, Number rate) {
      ...
      if (ok && height != null && width != null) {
        boolean ok2 =
            Math.min(height.intValue(), width.intValue()) <= this.mSmallerDimensionUpperLimit;
        ...
        boolean ok3 =
            ok2
                && this.mBlockCountRange.contains((Range<Integer>) Integer.valueOf(blockCount))
                && this.mBlockAspectRatioRange.contains(
                    (Range<Rational>) new Rational(widthInBlocks, heightInBlocks))
                && this.mAspectRatioRange.contains(
                    (Range<Rational>) new Rational(width.intValue(), height.intValue()));
        if (ok3 && rate != null) {
    ...
    private static Pair<Range<Integer>, Range<Integer>> parseWidthHeightRanges(Object o) {
      ...
      if (range != null) {
        try {
          ...
          Log.m102w(TAG, "could not parse size range '" + o + "'");
          return null;
        }
      }
      return null;
    ...
    */
    private void parseFromInfo(MediaFormat info) {
      ...
      if (map.containsKey("feature-can-swap-width-height")) {
        if (widths3 != null) {
          this.mSmallerDimensionUpperLimit =
              Math.min(widths3.getUpper().intValue(), heights4.getUpper().intValue());
          Range<Integer> widths5 = widths3.extend(heights4);
          heights = widths5;
          widths = widths5;
          Range<Rational> ratios2 =
              Utils.parseRationalRange(map.get("block-aspect-ratio-range"), null);
          Range<Rational> blockRatios2 =
              Utils.parseRationalRange(map.get("pixel-aspect-ratio-range"), null);
            ...
            try {
              ...
              Log.m102w(
                  ...
                  "frame rate range ("
                      + frameRates
                      + ") is out of limits: "
                      + MediaCodecInfo.FRAME_RATE_RANGE);
              frameRates = null;
            }
          }
            ...
            try {
              ...
              Log.m102w(
                  ...
                  "bitrate range ("
                      + bitRates
                      + ") is out of limits: "
                      + MediaCodecInfo.BITRATE_RANGE);
              bitRates2 = null;
            }
          }
          MediaCodecInfo.checkPowerOfTwo(
              blockSize2.getWidth(), "block-size width must be power of two");
          MediaCodecInfo.checkPowerOfTwo(
              blockSize2.getHeight(), "block-size height must be power of two");
          MediaCodecInfo.checkPowerOfTwo(
              alignment2.getWidth(), "alignment width must be power of two");
          MediaCodecInfo.checkPowerOfTwo(
              alignment2.getHeight(), "alignment height must be power of two");
          ...
          applyMacroBlockLimits(
              ...
              Long.MAX_VALUE,
              blockSize2.getWidth(),
              blockSize2.getHeight(),
              alignment2.getWidth(),
              alignment2.getHeight());
              ...
              if (counts != null) {
                this.mBlockCountRange =
                    this.mBlockCountRange.intersect(
                        Utils.factorRange(
                            counts,
                            ((this.mBlockWidth * this.mBlockHeight) / blockSize2.getWidth())
                                / blockSize2.getHeight()));
              }
              if (blockRates != null) {
              ...
              if (blockRatios2 != null) {
                this.mBlockAspectRatioRange =
                    this.mBlockAspectRatioRange.intersect(
                        Utils.scaleRange(
                            blockRatios2,
                            this.mBlockHeight / blockSize2.getHeight(),
                            this.mBlockWidth / blockSize2.getWidth()));
              }
              if (ratios2 != null) {
          ...
          if (counts != null) {
            this.mBlockCountRange =
                MediaCodecInfo.POSITIVE_INTEGERS.intersect(
                    Utils.factorRange(
                        counts,
                        ((this.mBlockWidth * this.mBlockHeight) / blockSize2.getWidth())
                            / blockSize2.getHeight()));
          ...
          if (blockRates != null) {
            this.mBlocksPerSecondRange =
                MediaCodecInfo.POSITIVE_LONGS.intersect(
                    Utils.factorRange(
                        blockRates,
                        ((this.mBlockWidth * this.mBlockHeight) / blockSize2.getWidth())
                            / blockSize2.getHeight()));
          ...
          if (blockRatios != null) {
            this.mBlockAspectRatioRange =
                MediaCodecInfo.POSITIVE_RATIONALS.intersect(
                    Utils.scaleRange(
                        blockRatios,
                        this.mBlockHeight / blockSize2.getHeight(),
                        this.mBlockWidth / blockSize2.getWidth()));
        ...
        Log.m102w(TAG, "feature can-swap-width-height is best used with size-range");
        this.mSmallerDimensionUpperLimit =
            Math.min(
                this.mWidthRange.getUpper().intValue(), this.mHeightRange.getUpper().intValue());
      ...
      heights = widths3;
      widths = range;
      Range<Rational> ratios22 =
          Utils.parseRationalRange(map.get("block-aspect-ratio-range"), null);
      Range<Rational> blockRatios22 =
          Utils.parseRationalRange(map.get("pixel-aspect-ratio-range"), null);
      frameRates = Utils.parseIntRange(map.get("frame-rate-range"), null);
      if (frameRates != null) {}
      bitRates = Utils.parseIntRange(map.get("bitrate-range"), null);
    ...
    private void applyBlockLimits(
      ...
      if (factor != 1) {
        ...
        this.mHorizontalBlockRange =
            Utils.factorRange(this.mHorizontalBlockRange, newBlockWidth / this.mBlockWidth);
        this.mVerticalBlockRange =
            Utils.factorRange(this.mVerticalBlockRange, newBlockHeight / this.mBlockHeight);
      }
    ...
    private void updateLimits() {
      ...
      this.mWidthRange =
          this.mWidthRange.intersect(
              Integer.valueOf(
                  ((this.mHorizontalBlockRange.getLower().intValue() - 1) * this.mBlockWidth)
                      + this.mWidthAlignment),
              Integer.valueOf(this.mHorizontalBlockRange.getUpper().intValue() * this.mBlockWidth));
      this.mHeightRange =
          this.mHeightRange.intersect(
              Integer.valueOf(
                  ((this.mVerticalBlockRange.getLower().intValue() - 1) * this.mBlockHeight)
                      + this.mHeightAlignment),
              Integer.valueOf(this.mVerticalBlockRange.getUpper().intValue() * this.mBlockHeight));
      this.mAspectRatioRange =
          this.mAspectRatioRange.intersect(
              new Rational(
                  this.mWidthRange.getLower().intValue(), this.mHeightRange.getUpper().intValue()),
              new Rational(
                  this.mWidthRange.getUpper().intValue(), this.mHeightRange.getLower().intValue()));
      this.mSmallerDimensionUpperLimit =
          Math.min(
              this.mSmallerDimensionUpperLimit,
              Math.min(
                  this.mWidthRange.getUpper().intValue(), this.mHeightRange.getUpper().intValue()));
      Range<Long> intersect3 =
          this.mBlocksPerSecondRange.intersect(
              Long.valueOf(
                  this.mBlockCountRange.getLower().intValue()
                      * this.mFrameRateRange.getLower().intValue()),
    ...
    private void applyMacroBlockLimits(
      ...
      this.mHorizontalBlockRange =
          this.mHorizontalBlockRange.intersect(
              Integer.valueOf(Utils.divUp(minHorizontalBlocks, this.mBlockWidth / blockWidth)),
              Integer.valueOf(maxHorizontalBlocks / (this.mBlockWidth / blockWidth)));
      this.mVerticalBlockRange =
          this.mVerticalBlockRange.intersect(
              Integer.valueOf(Utils.divUp(minVerticalBlocks, this.mBlockHeight / blockHeight)),
      ...
      if (equalsIgnoreCase) {
        ...
        while (i5 < length) {
          ...
          switch (profileLevel.level) {
            ...
            default:
              str19 = str22;
              Log.m102w(TAG, str22 + profileLevel.level + " for " + mime);
              errors |= 1;
              MBPS5 = 0;
              FS5 = 0;
              BR6 = 0;
          ...
          switch (profileLevel.profile) {
            ...
            case 64:
              str20 = str21;
              Log.m102w(TAG, str21 + profileLevel.profile + " for " + mime);
              errors |= 2;
              supported = false;
              BR7 = BR6 * 1000;
              break;
            ...
            default:
              str20 = str21;
              Log.m102w(TAG, str23 + profileLevel.profile + " for " + mime);
              errors |= 1;
              BR7 = BR6 * 1000;
              break;
          }
        ...
        applyMacroBlockLimits(
            maxLengthInBlocks, maxLengthInBlocks, maxBlocks2, maxBlocksPerSecond, 16, 16, 1, 1);
        maxBlocks = maxBps;
      } else {
        ...
        if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_MPEG2)) {
          ...
          while (MBPS6 < length2) {
            ...
            switch (profileLevel2.profile) {
              case 0:
                ...
                switch (profileLevel2.level) {
                  ...
                  default:
                    Log.m102w(
                        str25,
                        str29 + profileLevel2.profile + str28 + profileLevel2.level + str24 + mime);
                    errors |= 1;
                    MBPS4 = 0;
                    FS4 = 0;
                    str16 = str27;
              ...
              case 5:
                i4 = MBPS6;
                Log.m98i(str25, "Unsupported profile " + profileLevel2.profile + str24 + mime);
                errors |= 2;
                supported2 = false;
                MBPS4 = 0;
                FS4 = 0;
              ...
              default:
                i4 = MBPS6;
                Log.m102w(str25, str27 + profileLevel2.profile + str24 + mime);
                errors |= 1;
                MBPS4 = 0;
                FS4 = 0;
                str16 = str27;
            ...
            while (i8 < length3) {
              ...
              switch (MBPS7) {
                ...
                case 16384:
                  ...
                  String str39 = str33;
                  profileLevels4 = profileLevels9;
                  Log.m98i(str34, "Unsupported profile " + profileLevel3.profile + str39 + mime);
                  errors |= 2;
                  supported3 = false;
                  FR4 = 0;
                  MBPS3 = 0;
                ...
                default:
                  ...
                  String str43 = str33;
                  profileLevels4 = profileLevels9;
                  Log.m102w(str34, str30 + profileLevel3.profile + str43 + mime);
                  errors |= 1;
                  FR4 = 0;
                  MBPS3 = 0;
                  FS3 = 0;
              ...
              while (minH < length4) {
                ...
                switch (profileLevel4.level) {
                  ...
                  default:
                    ...
                    Log.m102w(
                        str12,
                        str32 + profileLevel4.profile + str31 + profileLevel4.level + str11 + mime);
                    errors3 |= 1;
                    minHeight = minHeight3;
                    MBPS = 0;
                    minHeight2 = 0;
                ...
                switch (FR6) {
                  ...
                  default:
                    maxRate = errors4;
                    Log.m102w(str12, str30 + profileLevel4.profile + str11 + mime);
                    errors3 |= 1;
                    break;
                }
                if (strict) {
                ...
                while (i11 < length5) {
                  ...
                  switch (profileLevel5.level) {
                    ...
                    default:
                      ...
                      str8 = str46;
                      str9 = str47;
                      Log.m102w(str9, str7 + profileLevel5.level + str8 + mime);
                      errors |= 1;
                      break;
                  }
                  switch (profileLevel5.profile) {
                    ...
                    default:
                      str10 = str30;
                      Log.m102w(str9, str10 + profileLevel5.profile + str8 + mime);
                      errors |= 1;
                      break;
                  }
                  errors &= -5;
                  ...
                  while (maxBps6 < length6) {
                    ...
                    switch (profileLevel6.level) {
                      ...
                      case 8192:
                        ...
                        break;
                      default:
                        Log.m102w(str50, str49 + profileLevel6.level + str46 + mime);
                        errors |= 1;
                        profileLevels2 = profileLevels11;
                        SR2 = 0;
                        D3 = 0;
                    ...
                    switch (profileLevel6.profile) {
                      ...
                      default:
                        str6 = str48;
                        Log.m102w(str50, str48 + profileLevel6.profile + str46 + mime);
                        errors |= 1;
                        break;
                    }
                    errors &= -5;
                    ...
                    while (i14 < length7) {
                      ...
                      switch (profileLevel7.level) {
                        ...
                        default:
                          FR = 0.0d;
                          str3 = str51;
                          Log.m102w(str50, str3 + profileLevel7.level + str46 + mime);
                          errors |= 1;
                          break;
                      }
                      switch (profileLevel7.profile) {
                        ...
                        default:
                          str4 = str52;
                          i = length7;
                          Log.m102w(str50, str4 + profileLevel7.profile + str46 + mime);
                          errors |= 1;
                          break;
                      }
                      errors &= -5;
                    ...
                    if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_AV1)) {
                      ...
                      while (D4 < length8) {
                        ...
                        switch (SR3) {
                          ...
                          default:
                            str2 = str53;
                            Log.m102w(str2, str54 + profileLevel8.level + str46 + mime);
                            profileLevels = profileLevels12;
                            errors2 = errors5 | 1;
                            D = 0;
                            str = str54;
                        ...
                        switch (profileLevel8.profile) {
                          ...
                          default:
                            D2 = D;
                            Log.m102w(str2, str52 + profileLevel8.profile + str46 + mime);
                            errors2 |= 1;
                            break;
                        }
                      ...
                      Log.m102w(str53, "Unsupported mime " + mime);
                      errors = 4 | 2;
                      maxBlocks = 64000;
                    }
                  }
    ...
    private void parseFromInfo(MediaFormat info) {
      ...
      if (info.containsKey("complexity-range")) {
        this.mComplexityRange =
            Utils.parseIntRange(info.getString("complexity-range"), this.mComplexityRange);
      }
