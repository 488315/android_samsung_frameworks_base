                            ...
                            while (i3 < length2) {
                                ...
                                switch (profileLevel2.profile) {
                                    ...
                                    case 2:
                                        ...
                                        break;
                                    default:
                                        Log.m102w(TAG, "Unrecognized profile " + profileLevel2.profile + " for " + mime);
                                        this.mParent.mError |= 1;
                                        sampleRates = new int[]{SemDolbyAudioEffect.SAMPLE_RATE_44100, 48000, 88200, 96000, 176400, 192000};
                                        bitRates = Range.create(96000, 24500000);
                                        maxChannels = 32;
                ...
                if (widths3 != null) {
                    ...
                    if (frameRates != null) {
                        ...
                        try {
                            ...
                            heights2 = widths;
                            Log.m102w(TAG, "frame rate range (" + frameRates + ") is out of limits: " + MediaCodecInfo.FRAME_RATE_RANGE);
                            frameRates = null;
                        }
                    }
                    ...
                    if (bitRates != null) {
                        ...
                        try {
                            ...
                            Log.m102w(TAG, "bitrate range (" + bitRates + ") is out of limits: " + MediaCodecInfo.BITRATE_RANGE);
                            bitRates2 = null;
                        }
                    }
                            ...
                            case 0:
                                ...
                                switch (profileLevel2.level) {
                                    case 1:
                                        ...
                                        break;
                                    default:
                                        Log.m102w(str25, str29 + profileLevel2.profile + str28 + profileLevel2.level + str24 + mime);
                                        errors |= 1;
                                        MBPS4 = 0;
                                        FS4 = 0;
                                        str16 = str27;
                                ...
                                case 1:
                                    ...
                                    switch (profileLevel3.level) {
                                        ...
                                        case 256:
                                            ...
                                            break;
                                        default:
                                            Log.m102w(str37, str13 + profileLevel3.profile + str35 + profileLevel3.level + str36 + mime);
                                            errors |= 1;
                                            str34 = str37;
                                            FR4 = 0;
                                            MBPS3 = 0;
                                ...
                                case 32768:
                                    switch (profileLevel3.level) {
                                        ...
                                        default:
                                            ...
                                            String str41 = str33;
                                            profileLevels4 = profileLevels9;
                                            Log.m102w(str34, append2.append(str40).append(profileLevel3.level).append(str41).append(mime).toString());
                                            errors |= 1;
                                            FR4 = 0;
                                            MBPS3 = 0;
                                            FS3 = 0;
                            ...
                            while (minH < length4) {
                                ...
                                switch (profileLevel4.level) {
                                    ...
                                    default:
                                        ...
                                        profileLevels3 = profileLevels10;
                                        str12 = str34;
                                        Log.m102w(str12, str32 + profileLevel4.profile + str31 + profileLevel4.level + str11 + mime);
                                        errors3 |= 1;
                                        minHeight = minHeight3;
                                        MBPS = 0;
                                        minHeight2 = 0;
