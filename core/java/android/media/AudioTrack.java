...
public class AudioTrack extends PlayerBase implements AudioRouting, VolumeAutomation {
  ...
  private static final Map<String, Integer> CHANNEL_PAIR_MAP =
      Map.of(
          "front",
          12,
          NavigationBarInflaterView.BACK,
          192,
          "front of center",
          768,
          "side",
          Integer.valueOf(GLES30.GL_COLOR),
          "top front",
          81920,
          "top back",
          655360,
          "top side",
          Integer.valueOf(IntentFilter.MATCH_CATEGORY_HOST),
          "bottom front",
          20971520,
          "front wide",
          Integer.valueOf(android.media.audio.Enums.AUDIO_FORMAT_DTS_HD));
  ...
  @SystemApi public static final int ENCAPSULATION_MODE_HANDLE = 2;
  ...
  private static native boolean native_is_direct_output_supported(
  ...
  private final native int native_write_native_bytes(
      ByteBuffer byteBuffer, int i, int i2, int i3, boolean z);
  ...
  public AudioTrack(
      ...
      throws IllegalArgumentException {
    this(
        new AudioAttributes.Builder().setLegacyStreamType(streamType).build(),
  ...
  private AudioTrack(
    ...
    if (shouldEnablePowerSaving(this.mAttributes, format, bufferSizeInBytes, mode)) {
      this.mAttributes =
          new AudioAttributes.Builder(this.mAttributes)
              .replaceFlags((this.mAttributes.getAllFlags() | 512) & (-257))
              .build();
    }
      ...
      try {
        int initResult =
            native_setup(
                ...
                sampleRate,
                this.mChannelMask,
                this.mChannelIndexMask,
                this.mAudioFormat,
                this.mNativeBufferSizeInBytes,
                this.mDataLoadMode,
                session,
        ...
        if ((this.mAttributes.getFlags() & 16) != 0) {
          if (AudioFormat.isEncodingLinearFrames(this.mAudioFormat)) {
            frameSizeInBytes =
                this.mChannelCount * AudioFormat.getBytesPerSample(this.mAudioFormat);
          } else {
            frameSizeInBytes = 1;
          }
          this.mOffset =
              ((int) Math.ceil(HEADER_V2_SIZE_BYTES / frameSizeInBytes)) * frameSizeInBytes;
        }
    ...
    private AudioTrack buildCallInjectionTrack() {
      AudioMixingRule audioMixingRule =
          new AudioMixingRule.Builder()
              .addMixRule(
                  2,
                  new AudioAttributes.Builder().setCapturePreset(7).setForCallRedirection().build())
              .setTargetMixRole(1)
              .build();
      android.media.audiopolicy.AudioMix audioMix =
          new AudioMix.Builder(audioMixingRule).setFormat(this.mFormat).setRouteFlags(2).build();
    ...
    public AudioTrack build() throws UnsupportedOperationException {
      ...
      switch (this.mPerformanceMode) {
        case 1:
          this.mAttributes =
              new AudioAttributes.Builder(this.mAttributes)
                  .replaceFlags((this.mAttributes.getAllFlags() | 256) & (-513))
                  .build();
          break;
        case 2:
          this.mAttributes =
      ...
      if (i == 1) {
        this.mAttributes =
            new AudioAttributes.Builder(this.mAttributes).setForCallRedirection().build();
      }
      if (this.mOffload) {
      ...
      try {
        AudioTrack track =
            new AudioTrack(
                ...
                this.mSessionId,
                this.mOffload,
                this.mEncapsulationMode,
                this.mTunerConfiguration);
        if (track.getState() == 0) {
  ...
  public static boolean isDirectPlaybackSupported(AudioFormat format, AudioAttributes attributes) {
    ...
    return native_is_direct_output_supported(
        format.getEncoding(),
  ...
  public static boolean shouldEnablePowerSaving(
    ...
    if ((attributes != null
            && (flags != 0
                || attributes.getUsage() != 1
                || (attributes.getContentType() != 0
                    && attributes.getContentType() != 2
                    && attributes.getContentType() != 3)))
        || format == null
    ...
    if (bufferSizeInBytes != 0) {
      long bufferTargetSize =
          (((format.getChannelCount() * 100) * AudioFormat.getBytesPerSample(format.getEncoding()))
                  * format.getSampleRate())
              / 1000;
  ...
  private void audioParamCheck(
      int sampleRateInHz, int channelConfig, int channelIndexMask, int audioFormat, int mode) {
    ...
    if (audioFormat == 13
      ...
      Log.m102w(
          TAG,
          "ENCODING_IEC61937 is configured with channel mask as "
              + channelConfig
      ...
      default:
        if (channelConfig == 0 && channelIndexMask != 0) {
          ...
          if (!isMultichannelConfigSupported(channelConfig, audioFormat)) {
            throw new IllegalArgumentException(
                "Unsupported channel mask configuration "
                    + channelConfig
                    + " for encoding "
                    + audioFormat);
          }
    ...
    if (channelIndexMask != 0) {
      ...
      if (((-16777216) & channelIndexMask) == 0
          && (!AudioFormat.isEncodingLinearFrames(audioFormat)
              || channelIndexCount <= AudioSystem.OUT_CHANNEL_COUNT_MAX)) {
        accepted = true;
      }
      if (!accepted) {
        throw new IllegalArgumentException(
  ...
  private static boolean isMultichannelConfigSupported(int channelConfig, int encoding) {
    ...
    try {
      ...
      if (channelCount > channelCountLimit) {
        loge(
            "Channel configuration contains too many channels for encoding "
                + encoding
  ...
  public AudioFormat getFormat() {
    AudioFormat.Builder builder =
        new AudioFormat.Builder().setSampleRate(this.mSampleRate).setEncoding(this.mAudioFormat);
  ...
  public int setStartThresholdInFrames(int startThresholdInFrames) {
    ...
    if (startThresholdInFrames < 1) {
      throw new IllegalArgumentException(
          "startThresholdInFrames " + startThresholdInFrames + " must be positive");
    }
  ...
  public void setPlaybackPositionUpdateListener(
      OnPlaybackPositionUpdateListener listener, Handler handler) {
    if (listener != null) {
  ...
  void playerSetVolume(boolean muting, float leftVolume, float rightVolume) {
    native_setVolume(
        clampGainOrLevel(muting ? 0.0f : leftVolume),
        clampGainOrLevel(muting ? 0.0f : rightVolume));
  }
  ...
  public int setLoopPoints(int startInFrames, int endInFrames, int loopCount) {
    ...
    if (loopCount != 0
        && (startInFrames < 0
            || startInFrames >= (i = this.mNativeBufferSizeInFrames)
            || startInFrames >= endInFrames
            || endInFrames > i)) {
      return -2;
    }
  ...
  public int write(byte[] audioData, int offsetInBytes, int sizeInBytes, int writeMode) {
    ...
    if (writeMode != 0 && writeMode != 1) {
      Log.m96e(TAG, "AudioTrack.write() called with invalid blocking mode");
      return -2;
    }
    if (audioData == null
        || offsetInBytes < 0
    ...
    int ret =
        native_write_byte(audioData, offsetInBytes, sizeInBytes, this.mAudioFormat, writeMode == 0);
  ...
  public int write(short[] audioData, int offsetInShorts, int sizeInShorts, int writeMode) {
    ...
    int ret =
        native_write_short(
            audioData, offsetInShorts, sizeInShorts, this.mAudioFormat, writeMode == 0);
    if (this.mDataLoadMode == 0 && this.mState == 2 && ret > 0) {
      this.mState = 1;
    }
    return ret;
  ...
  public int write(float[] audioData, int offsetInFloats, int sizeInFloats, int writeMode) {
    if (this.mState == 0) {
      Log.m96e(TAG, "AudioTrack.write() called in invalid state STATE_UNINITIALIZED");
      return -3;
    }
    if (this.mAudioFormat != 4) {
      Log.m96e(TAG, "AudioTrack.write(float[] ...) requires format ENCODING_PCM_FLOAT");
      return -3;
    }
    if (writeMode != 0 && writeMode != 1) {
      Log.m96e(TAG, "AudioTrack.write() called with invalid blocking mode");
    ...
    if (audioData == null
        || offsetInFloats < 0
        || sizeInFloats < 0
        || offsetInFloats + sizeInFloats < 0
        || offsetInFloats + sizeInFloats > audioData.length) {
      Log.m96e(TAG, "AudioTrack.write() called with invalid array, offset, or size");
      return -2;
    }
    if (!blockUntilOffloadDrain(writeMode)) {
      return 0;
    ...
    int ret =
        native_write_float(
            audioData, offsetInFloats, sizeInFloats, this.mAudioFormat, writeMode == 0);
    if (this.mDataLoadMode == 0 && this.mState == 2 && ret > 0) {
      this.mState = 1;
    }
    return ret;
  ...
  public int write(ByteBuffer audioData, int sizeInBytes, int writeMode) {
    ...
    if (audioData == null || sizeInBytes < 0 || sizeInBytes > audioData.remaining()) {
      Log.m96e(TAG, "AudioTrack.write() called with invalid size (" + sizeInBytes + ") value");
      return -2;
    }
    if (!blockUntilOffloadDrain(writeMode)) {
      return 0;
    ...
    if (audioData.isDirect()) {
      ret =
          native_write_native_bytes(
              audioData, audioData.position(), sizeInBytes, this.mAudioFormat, writeMode == 0);
    } else {
      ret =
          native_write_byte(
              NioUtils.unsafeArray(audioData),
              audioData.position() + NioUtils.unsafeArrayOffset(audioData),
              sizeInBytes,
              this.mAudioFormat,
              writeMode == 0);
    }
  ...
  public int write(ByteBuffer audioData, int sizeInBytes, int writeMode, long timestamp) {
    ...
    if (this.mDataLoadMode != 1) {
      Log.m96e(TAG, "AudioTrack.write() with timestamp called for non-streaming mode track");
      return -3;
    }
    if ((this.mAttributes.getFlags() & 16) == 0) {
      Log.m94d(TAG, "AudioTrack.write() called on a regular AudioTrack. Ignoring pts...");
    ...
    if (this.mAvSyncHeader.remaining() != 0) {
      ...
      if (ret < 0) {
        Log.m96e(TAG, "AudioTrack.write() could not write timestamp header!");
        this.mAvSyncHeader = null;
        this.mAvSyncBytesRemaining = 0;
        return ret;
      }
      if (this.mAvSyncHeader.remaining() > 0) {
        Log.m100v(TAG, "AudioTrack.write() partial timestamp header written.");
        return 0;
      }
    }
    ...
    if (ret2 < 0) {
      Log.m96e(TAG, "AudioTrack.write() could not write audio data!");
      this.mAvSyncHeader = null;
      this.mAvSyncBytesRemaining = 0;
      return ret2;
    }
  ...
  */
        ...
        if (!this.mRoutingChangeListeners.containsKey(listener)) {
          ...
          this.mRoutingChangeListeners.put(
              ...
              new NativeRoutingEventHandlerDelegate(
                  this,
                  listener,
                  handler != null ? handler : new Handler(this.mInitializationLooper)));
        }
      }
    }
  }
  ...
  public void addOnCodecFormatChangedListener(
      Executor executor, final OnCodecFormatChangedListener listener) {
    this.mCodecFormatChangedListeners.add(
        listener,
        executor,
        new Utils.ListenerList
            .Listener() { // from class: android.media.AudioTrack$$ExternalSyntheticLambda0
          @Override // android.media.Utils.ListenerList.Listener
          public final void onEvent(int i, Object obj) {
            AudioTrack.this.lambda$addOnCodecFormatChangedListener$0(
                listener, i, (AudioMetadataReadMap) obj);
          }
        });
  }
    ...
    public void handleMessage(final Message msg) {
      synchronized (AudioTrack.this.mStreamEventCbLock) {
        ...
        LinkedList<StreamEventCbInfo> cbInfoList =
            new LinkedList<>(AudioTrack.this.mStreamEventCbInfoList);
          ...
          while (it.hasNext()) {
            ...
            switch (msg.what) {
              case 6:
                cbi.mStreamEventExec.execute(
                    new Runnable() { // from class:
                                     // android.media.AudioTrack$StreamEventHandler$$ExternalSyntheticLambda1
              ...
              case 7:
                cbi.mStreamEventExec.execute(
                    new Runnable() { // from class:
                                     // android.media.AudioTrack$StreamEventHandler$$ExternalSyntheticLambda2
                      @Override // java.lang.Runnable
                      public final void run() {
              ...
              case 9:
                cbi.mStreamEventExec.execute(
                    new Runnable() { // from class:
                                     // android.media.AudioTrack$StreamEventHandler$$ExternalSyntheticLambda0
                      @Override // java.lang.Runnable
                      public final void run() {
  ...
  private class NativePositionEventHandlerDelegate {
    ...
    NativePositionEventHandlerDelegate(
        final AudioTrack track, final OnPlaybackPositionUpdateListener listener, Handler handler) {
      Looper looper;
      if (handler != null) {
  ...
  private static void postEventFromNative(
      Object audiotrack_ref, int what, int arg1, int arg2, Object obj) {
    Handler handler;
    ...
    if (what == 100) {
      ...
      if (audioMetaData == null) {
        Log.m96e(TAG, "Unable to get audio metadata from byte buffer");
        return;
      } else {
  ...
  public static final class MetricsConstants {
    ...
    @Deprecated public static final String CHANNELMASK = "android.media.audiorecord.channelmask";
    ...
    @Deprecated public static final String SAMPLERATE = "android.media.audiorecord.samplerate";
