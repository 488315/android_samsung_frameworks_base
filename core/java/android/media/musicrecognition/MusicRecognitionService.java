...
public abstract class MusicRecognitionService extends Service {
    ...
    private final IMusicRecognitionService mServiceInterface =
            new IMusicRecognitionService.Stub() { // from class:
                // android.media.musicrecognition.MusicRecognitionService.1
                @Override // android.media.musicrecognition.IMusicRecognitionService
                public void onAudioStreamStarted(
                        ParcelFileDescriptor fd,
                        AudioFormat audioFormat,
                        final IMusicRecognitionServiceCallback callback) {
                    Handler handler = MusicRecognitionService.this.mHandler;
                    final MusicRecognitionService musicRecognitionService =
                            MusicRecognitionService.this;
                    handler.sendMessage(
                            PooledLambda.obtainMessage(
                                    new TriConsumer() { // from class:
                                        // android.media.musicrecognition.MusicRecognitionService$1$$ExternalSyntheticLambda0
                                        @Override // com.android.internal.util.function.TriConsumer
                                        public final void accept(
                                                Object obj, Object obj2, Object obj3) {
                                            MusicRecognitionService.this.onRecognize(
                                                    (ParcelFileDescriptor) obj,
                                                    (AudioFormat) obj2,
                                                    (MusicRecognitionService.AnonymousClass1.C00051)
                                                            obj3);
                                        }
                                    },
                                    fd,
                                    ...
                                    new Callback() { // from class:
                                        // android.media.musicrecognition.MusicRecognitionService.1.1
    ...
    public abstract void onRecognize(
            ParcelFileDescriptor parcelFileDescriptor, AudioFormat audioFormat, Callback callback);
