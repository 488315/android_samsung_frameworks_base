...
public final class MediaSession {
  ...
  public MediaSession(Context context, String tag, Bundle sessionInfo) {
    ...
    this.mMaxBitmapSize =
        context
            .getResources()
            .getDimensionPixelSize(C4337R.dimen.config_mediaMetadataBitmapMaxSize);
      ...
      try {
        if (!TextUtils.equals(broadcastReceiver.getPackageName(), this.mContext.getPackageName())) {
          throw new IllegalArgumentException(
              "broadcastReceiver should belong to the same package as the context given when"
  ...
  public void setMetadata(MediaMetadata metadata) {
    ...
    if (metadata != null) {
      metadata =
          new MediaMetadata.Builder(metadata).setBitmapDimensionLimit(this.mMaxBitmapSize).build();
  ...
  public void setRatingType(int type) {
    try {
      ...
      Log.m97e(TAG, "Error in setRatingType.", e);
    }
  }
      ...
      if (provider != null) {
        if (provider == this.mVolumeProvider) {
          try {
            ...
            Log.m97e(TAG, "Error in notifyVolumeChanged", e);
            return;
          }
        }
      }
      Log.m102w(TAG, "Received update from stale volume provider");
    }
  }
  ...
  static boolean hasCustomParcelable(Bundle bundle) {
    ...
    try {
      try {
        ...
        Log.m95d(TAG, "Custom parcelable in bundle.", e);
        if (parcel == null) {
          return true;
        }
        parcel.recycle();
  ...
  void postToCallbackDelayed(
      MediaSessionManager.RemoteUserInfo caller, int what, Object obj, Bundle data, long delay) {
    synchronized (this.mLock) {
      CallbackMessageHandler callbackMessageHandler = this.mCallback;
      if (callbackMessageHandler != null) {
  ...
  public static final class Token implements Parcelable {
    public static final Parcelable.Creator<Token> CREATOR =
        new Parcelable.Creator<Token>() { // from class: android.media.session.MediaSession.Token.1
        ...
        switch (ke.getKeyCode()) {
          ...
          case 85:
            if (ke.getRepeatCount() > 0) {
              ...
              mediaSession.dispatchMediaButtonDelayed(
  ...
  public static class CallbackStub extends ISessionCallback.Stub {
    ...
    public void onCommand(
        String packageName, int pid, int uid, String command, Bundle args, ResultReceiver cb) {
