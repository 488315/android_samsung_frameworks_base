...
public interface ISessionManager extends IInterface {
  void addOnMediaKeyEventDispatchedListener(
      IOnMediaKeyEventDispatchedListener iOnMediaKeyEventDispatchedListener) throws RemoteException;
  ...
  void dispatchVolumeKeyEventToSessionAsSystemService(
      String str, String str2, KeyEvent keyEvent, MediaSession.Token token) throws RemoteException;
  ...
  void setOnVolumeKeyLongPressListener(IOnVolumeKeyLongPressListener iOnVolumeKeyLongPressListener)
      throws RemoteException;
  ...
  public static class Default implements ISessionManager {
    ...
    public ISession createSession(
        String packageName, ISessionCallback sessionCb, String tag, Bundle sessionInfo, int userId)
        throws RemoteException {
      return null;
    }
    ...
    public void dispatchMediaKeyEvent(
        String packageName, boolean asSystemService, KeyEvent keyEvent, boolean needWakeLock)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 17:
              IOnMediaKeyEventDispatchedListener _arg016 =
                  IOnMediaKeyEventDispatchedListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 19:
              IOnMediaKeyEventSessionChangedListener _arg018 =
                  IOnMediaKeyEventSessionChangedListener.Stub.asInterface(data.readStrongBinder());
