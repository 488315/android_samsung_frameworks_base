...
public class MediaHTTPService extends IMediaHTTPService.Stub {
    ...
    public MediaHTTPService(List<HttpCookie> cookies) {
        ...
        Log.m100v(TAG, "MediaHTTPService(" + this + "): Cookies: " + cookies);
    }
        ...
        synchronized (this.mCookieStoreInitializedLock) {
            if (!this.mCookieStoreInitialized) {
                ...
                if (cookieHandler == null) {
                    ...
                    Log.m100v(TAG, "makeHTTPConnection: CookieManager created: " + cookieHandler);
                } else {
                    Log.m100v(TAG, "makeHTTPConnection: CookieHandler (" + cookieHandler + ") exists.");
                }
                    ...
                    if (cookieHandler instanceof CookieManager) {
                        ...
                        for (HttpCookie cookie : this.mCookies) {
                            try {
                                ...
                                Log.m100v(TAG, "makeHTTPConnection: CookieStore.add" + e);
                            }
                        }
                    } else {
                        Log.m102w(TAG, "makeHTTPConnection: The installed CookieHandler is not a CookieManager. Can’t add the provided cookies to the cookie store.");
                    }
                }
                this.mCookieStoreInitialized = true;
                Log.m100v(TAG, "makeHTTPConnection(" + this + "): cookieHandler: " + cookieHandler + " Cookies: " + this.mCookies);
            }
        }
