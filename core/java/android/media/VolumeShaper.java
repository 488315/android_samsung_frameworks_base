...
public final class VolumeShaper implements AutoCloseable {
  ...
  public void replace(Configuration configuration, Operation operation, boolean join) {
    this.mId =
        applyPlayer(
            configuration, new Operation.Builder(operation).replace(this.mId, join).build());
  }
  ...
  public static final class Configuration implements Parcelable {
    ...
    static {
      ...
      SINE_RAMP =
          new Builder().setInterpolatorType(2).setCurve(times, sines).setDuration(1000L).build();
      SCURVE_RAMP =
          new Builder().setInterpolatorType(2).setCurve(times, scurve).setDuration(1000L).build();
      CREATOR =
          new Parcelable.Creator<
              Configuration>() { // from class: android.media.VolumeShaper.Configuration.1
    ...
    public String toString() {
      return "VolumeShaper.Configuration{mType = "
          + this.mType
          + ", mId = "
          + this.mId
          + (this.mType != 0
              ? ", mOptionFlags = 0x"
                  + Integer.toHexString(this.mOptionFlags).toUpperCase()
                  + ", mDurationMs = "
                  + this.mDurationMs
                  + ", mInterpolatorType = "
                  + this.mInterpolatorType
                  + ", mTimes[] = "
                  + Arrays.toString(this.mTimes)
                  + ", mVolumes[] = "
                  + Arrays.toString(this.mVolumes)
                  + "}"
              : "}");
    }
    ...
    public int hashCode() {
      ...
      return Objects.hash(
          ...
          Integer.valueOf(this.mOptionFlags),
          Double.valueOf(this.mDurationMs),
          Integer.valueOf(this.mInterpolatorType),
          Integer.valueOf(Arrays.hashCode(this.mTimes)),
          Integer.valueOf(Arrays.hashCode(this.mVolumes)));
    }
      ...
      if (i == other.mType && this.mId == other.mId) {
        return i == 0
            || (this.mOptionFlags == other.mOptionFlags
                && this.mDurationMs == other.mDurationMs
                && this.mInterpolatorType == other.mInterpolatorType
                && Arrays.equals(this.mTimes, other.mTimes)
                && Arrays.equals(this.mVolumes, other.mVolumes));
      }
      return false;
    }
    ...
    private InterpolatorConfig toInterpolatorParcelable() {
      ...
      parcelable.f280xy = new float[this.mTimes.length * 2];
      for (int i = 0; i < this.mTimes.length; i++) {
        parcelable.f280xy[i * 2] = this.mTimes[i];
        parcelable.f280xy[(i * 2) + 1] = this.mVolumes[i];
      }
      return parcelable;
    }
    ...
    public static Configuration fromParcelable(VolumeShaperConfiguration parcelable) {
      ...
      int length = parcelable.interpolatorConfig.f280xy.length;
      if (length % 2 != 0) {
      ...
      for (int i = 0; i < length / 2; i++) {
        times[i] = parcelable.interpolatorConfig.f280xy[i * 2];
        volumes[i] = parcelable.interpolatorConfig.f280xy[(i * 2) + 1];
      }
  ...
  public static final class Operation implements Parcelable {
    ...
    public static final Parcelable.Creator<Operation> CREATOR =
        new Parcelable.Creator<Operation>() { // from class: android.media.VolumeShaper.Operation.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public String toString() {
      return "VolumeShaper.Operation{mFlags = 0x"
    ...
    public int hashCode() {
      return Objects.hash(
          ...
          Integer.valueOf(this.mReplaceId),
          Float.valueOf(this.mXOffset));
    }
    ...
    public boolean equals(Object o) {
      ...
      return this.mFlags == other.mFlags
          && this.mReplaceId == other.mReplaceId
    ...
    public static Operation fromParcelable(VolumeShaperOperation parcelable) {
      return new Operation(
          flagsFromAidl(parcelable.flags), parcelable.replaceId, parcelable.xOffset);
    }
