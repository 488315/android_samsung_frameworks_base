...
public final class DynamicsProcessing extends AudioEffect {
    ...
    private void updateEngineEqByChannelIndex(int i, int i2, C1937Eq c1937Eq) {
        ...
        setNumberArray(new Number[]{Integer.valueOf(i), Integer.valueOf(i2)}, new Number[]{Integer.valueOf(c1937Eq.isInUse() ? 1 : 0), Integer.valueOf(c1937Eq.isEnabled() ? 1 : 0), Integer.valueOf(bandCount)});
