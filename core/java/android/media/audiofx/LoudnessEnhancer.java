...
public class LoudnessEnhancer extends AudioEffect {
  ...
  public LoudnessEnhancer(int audioSession)
    ...
    if (audioSession == 0) {
      Log.m102w(TAG, "WARNING: attaching a LoudnessEnhancer to global output mix is deprecated!");
    }
  }
  ...
  public static class Settings {
    ...
    public String toString() {
      String str =
          new String("LoudnessEnhancer;targetGainmB=" + Integer.toString(this.targetGainmB));
      return str;
    }
  }
