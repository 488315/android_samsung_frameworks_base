  ...
  private AudioEffect(
    ...
    try {
      try {
        ...
        Log.m96e(TAG, "Error code " + initResult + " when initializing AudioEffect.");
        switch (initResult) {
          case -5:
          ...
          default:
            throw new RuntimeException(
                "Cannot initialize effect engine for type: " + type + " Error: " + initResult);
        }
      } catch (Throwable th2) {
        th = th2;
        if (attributionSourceState == null) {
    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        ...
        case 2:
          ...
          return;
        default:
          Log.m96e(AudioEffect.TAG, "handleMessage() Unknown event type: " + msg.what);
          return;
      }
    }
  }
