...
public class AudioProfile implements Parcelable {
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.channelMasks =
          (AudioChannelLayout[]) _aidl_parcel.createTypedArray(AudioChannelLayout.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(this.name, that.name)
        ...
        && Objects.deepEquals(
            Integer.valueOf(this.encapsulationType), Integer.valueOf(that.encapsulationType))) {
      return true;
    }
    return false;
  }
