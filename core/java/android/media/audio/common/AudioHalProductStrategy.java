...
public class AudioHalProductStrategy implements Parcelable {
  public static final Parcelable.Creator<AudioHalProductStrategy> CREATOR =
      new Parcelable.Creator<
          AudioHalProductStrategy>() { // from class:
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.f301id), Integer.valueOf(that.f301id))
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(Integer.valueOf(this.f301id), this.attributesGroups).toArray());
  }
