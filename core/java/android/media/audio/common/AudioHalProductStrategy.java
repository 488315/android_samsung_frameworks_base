...
public class AudioHalProductStrategy implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.f301id);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.f301id = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(Integer.valueOf(this.f301id), Integer.valueOf(that.f301id)) && Objects.deepEquals(this.attributesGroups, that.attributesGroups)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(Integer.valueOf(this.f301id), this.attributesGroups).toArray());
    }
