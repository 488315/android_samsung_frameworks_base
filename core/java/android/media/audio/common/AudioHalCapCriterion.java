...
public class AudioHalCapCriterion implements Parcelable {
  public static final Parcelable.Creator<AudioHalCapCriterion> CREATOR =
      new Parcelable.Creator<
          AudioHalCapCriterion>() { // from class: android.media.audio.common.AudioHalCapCriterion.1
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(this.name, this.criterionTypeName, this.defaultLiteralValue).toArray());
  }
