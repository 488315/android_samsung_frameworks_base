...
public class AudioHalEngineConfig implements Parcelable {
  public static final Parcelable.Creator<AudioHalEngineConfig> CREATOR =
      new Parcelable.Creator<
          AudioHalEngineConfig>() { // from class: android.media.audio.common.AudioHalEngineConfig.1
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.volumeGroups =
          (AudioHalVolumeGroup[]) _aidl_parcel.createTypedArray(AudioHalVolumeGroup.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
  ...
  public static class CapSpecificConfig implements Parcelable {
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
      ...
      try {
        ...
        this.criteria =
            (AudioHalCapCriterion[]) _aidl_parcel.createTypedArray(AudioHalCapCriterion.CREATOR);
        if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
          if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
            throw new BadParcelableException("Overflow in the size of parcelable");
          }
