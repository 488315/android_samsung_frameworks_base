...
public class AudioPortConfig implements Parcelable {
  public static final Parcelable.Creator<AudioPortConfig> CREATOR =
      new Parcelable.Creator<
          AudioPortConfig>() { // from class: android.media.audio.common.AudioPortConfig.1
  ...
  public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
    ...
    _aidl_parcel.writeInt(this.f303id);
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.f303id = _aidl_parcel.readInt();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
      ...
      this.format =
          (AudioFormatDescription) _aidl_parcel.readTypedObject(AudioFormatDescription.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.f303id), Integer.valueOf(that.f303id))
        && Objects.deepEquals(Integer.valueOf(this.portId), Integer.valueOf(that.portId))
        && Objects.deepEquals(this.sampleRate, that.sampleRate)
        && Objects.deepEquals(this.channelMask, that.channelMask)
        && Objects.deepEquals(this.format, that.format)
        && Objects.deepEquals(this.gain, that.gain)
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(
                Integer.valueOf(this.f303id),
                Integer.valueOf(this.portId),
                this.sampleRate,
                this.channelMask,
                this.format,
                this.gain,
  ...
  public int describeContents() {
    ...
    return _mask
        | describeContents(this.channelMask)
        | describeContents(this.format)
        | describeContents(this.gain)
