...
public class AudioPortConfig implements Parcelable {
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(Integer.valueOf(this.f303id), Integer.valueOf(that.f303id)) && Objects.deepEquals(Integer.valueOf(this.portId), Integer.valueOf(that.portId)) && Objects.deepEquals(this.sampleRate, that.sampleRate) && Objects.deepEquals(this.channelMask, that.channelMask) && Objects.deepEquals(this.format, that.format) && Objects.deepEquals(this.gain, that.gain) && Objects.deepEquals(this.flags, that.flags) && Objects.deepEquals(this.ext, that.ext)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(Integer.valueOf(this.f303id), Integer.valueOf(this.portId), this.sampleRate, this.channelMask, this.format, this.gain, this.flags, this.ext).toArray());
    }
