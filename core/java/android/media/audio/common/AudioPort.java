...
public class AudioPort implements Parcelable {
  public static final Parcelable.Creator<AudioPort> CREATOR =
      new Parcelable.Creator<AudioPort>() { // from class: android.media.audio.common.AudioPort.1
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.extraAudioDescriptors =
          (ExtraAudioDescriptor[]) _aidl_parcel.createTypedArray(ExtraAudioDescriptor.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.f302id), Integer.valueOf(that.f302id))
