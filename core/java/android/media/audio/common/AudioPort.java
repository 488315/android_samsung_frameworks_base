...
public class AudioPort implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.f302id);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.f302id = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(Integer.valueOf(this.f302id), Integer.valueOf(that.f302id)) && Objects.deepEquals(this.name, that.name) && Objects.deepEquals(this.profiles, that.profiles) && Objects.deepEquals(this.flags, that.flags) && Objects.deepEquals(this.extraAudioDescriptors, that.extraAudioDescriptors) && Objects.deepEquals(this.gains, that.gains) && Objects.deepEquals(this.ext, that.ext)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(Integer.valueOf(this.f302id), this.name, this.profiles, this.flags, this.extraAudioDescriptors, this.gains, this.ext).toArray());
    }
