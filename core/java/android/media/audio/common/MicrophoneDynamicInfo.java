...
public class MicrophoneDynamicInfo implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeString(this.f304id);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.f304id = _aidl_parcel.readString();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public String toString() {
        ...
        _aidl_sj.add("id: " + Objects.toString(this.f304id));
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(this.f304id, that.f304id) && Objects.deepEquals(this.channelMapping, that.channelMapping)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(this.f304id, this.channelMapping).toArray());
    }
