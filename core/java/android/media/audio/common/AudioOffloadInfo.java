...
public class AudioOffloadInfo implements Parcelable {
  public static final Parcelable.Creator<AudioOffloadInfo> CREATOR =
      new Parcelable.Creator<
          AudioOffloadInfo>() { // from class: android.media.audio.common.AudioOffloadInfo.1
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(this.base, that.base)
        && Objects.deepEquals(Integer.valueOf(this.streamType), Integer.valueOf(that.streamType))
        && Objects.deepEquals(
            Integer.valueOf(this.bitRatePerSecond), Integer.valueOf(that.bitRatePerSecond))
        && Objects.deepEquals(
            java.lang.Long.valueOf(this.durationUs), java.lang.Long.valueOf(that.durationUs))
        && Objects.deepEquals(
            java.lang.Boolean.valueOf(this.hasVideo), java.lang.Boolean.valueOf(that.hasVideo))
        && Objects.deepEquals(
            java.lang.Boolean.valueOf(this.isStreaming),
            java.lang.Boolean.valueOf(that.isStreaming))
        && Objects.deepEquals(Integer.valueOf(this.bitWidth), Integer.valueOf(that.bitWidth))
        && Objects.deepEquals(
            Integer.valueOf(this.offloadBufferSize), Integer.valueOf(that.offloadBufferSize))
        ...
        && Objects.deepEquals(Integer.valueOf(this.contentId), Integer.valueOf(that.contentId))
