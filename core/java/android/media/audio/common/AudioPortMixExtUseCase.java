...
public final class AudioPortMixExtUseCase implements Parcelable {
  public static final Parcelable.Creator<AudioPortMixExtUseCase> CREATOR =
      new Parcelable.Creator<
          AudioPortMixExtUseCase>() { // from class:
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.media.audio.common.AudioPortMixExtUseCase.unspecified("
            + getUnspecified()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.media.audio.common.AudioPortMixExtUseCase.stream("
            + getStream()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.media.audio.common.AudioPortMixExtUseCase.source("
            + getSource()
            + NavigationBarInflaterView.KEY_CODE_END;
      default:
