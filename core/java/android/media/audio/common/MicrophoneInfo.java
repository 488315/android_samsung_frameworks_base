...
public class MicrophoneInfo implements Parcelable {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeString(this.f305id);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.f305id = _aidl_parcel.readString();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public String toString() {
        ...
        _aidl_sj.add("id: " + Objects.toString(this.f305id));
    ...
    public boolean equals(Object other) {
        ...
        if (Objects.deepEquals(this.f305id, that.f305id) && Objects.deepEquals(this.device, that.device) && Objects.deepEquals(Integer.valueOf(this.location), Integer.valueOf(that.location)) && Objects.deepEquals(Integer.valueOf(this.group), Integer.valueOf(that.group)) && Objects.deepEquals(Integer.valueOf(this.indexInTheGroup), Integer.valueOf(that.indexInTheGroup)) && Objects.deepEquals(this.sensitivity, that.sensitivity) && Objects.deepEquals(Integer.valueOf(this.directionality), Integer.valueOf(that.directionality)) && Objects.deepEquals(this.frequencyResponse, that.frequencyResponse) && Objects.deepEquals(this.position, that.position) && Objects.deepEquals(this.orientation, that.orientation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.deepHashCode(Arrays.asList(this.f305id, this.device, Integer.valueOf(this.location), Integer.valueOf(this.group), Integer.valueOf(this.indexInTheGroup), this.sensitivity, Integer.valueOf(this.directionality), this.frequencyResponse, this.position, this.orientation).toArray());
    }
    ...
    public static class Coordinate implements Parcelable {
        ...
        /* renamed from: x */
        public float f306x = 0.0f;

        /* renamed from: y */
        public float f307y = 0.0f;

        /* renamed from: z */
        public float f308z = 0.0f;
        ...
        public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
            int _aidl_start_pos = _aidl_parcel.dataPosition();
            _aidl_parcel.writeInt(0);
            _aidl_parcel.writeFloat(this.f306x);
            _aidl_parcel.writeFloat(this.f307y);
            _aidl_parcel.writeFloat(this.f308z);
            int _aidl_end_pos = _aidl_parcel.dataPosition();
            _aidl_parcel.setDataPosition(_aidl_start_pos);
            _aidl_parcel.writeInt(_aidl_end_pos - _aidl_start_pos);
            _aidl_parcel.setDataPosition(_aidl_end_pos);
        ...
        public final void readFromParcel(Parcel _aidl_parcel) {
            ...
            try {
                ...
                this.f306x = _aidl_parcel.readFloat();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                ...
                this.f307y = _aidl_parcel.readFloat();
                if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                    ...
                    this.f308z = _aidl_parcel.readFloat();
                    if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                        throw new BadParcelableException("Overflow in the size of parcelable");
                    }
                    _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
