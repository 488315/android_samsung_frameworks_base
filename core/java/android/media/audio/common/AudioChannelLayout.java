...
public final class AudioChannelLayout implements Parcelable {
  ...
  public static final Parcelable.Creator<AudioChannelLayout> CREATOR =
      new Parcelable.Creator<
          AudioChannelLayout>() { // from class: android.media.audio.common.AudioChannelLayout.1
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.media.audio.common.AudioChannelLayout.none("
            + getNone()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.media.audio.common.AudioChannelLayout.invalid("
            + getInvalid()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.media.audio.common.AudioChannelLayout.indexMask("
            + getIndexMask()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 3:
        return "android.media.audio.common.AudioChannelLayout.layoutMask("
            + getLayoutMask()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 4:
        return "android.media.audio.common.AudioChannelLayout.voiceMask("
            + getVoiceMask()
            + NavigationBarInflaterView.KEY_CODE_END;
      default:
