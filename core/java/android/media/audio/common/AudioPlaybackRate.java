...
public class AudioPlaybackRate implements Parcelable {
  public static final Parcelable.Creator<AudioPlaybackRate> CREATOR =
      new Parcelable.Creator<
          AudioPlaybackRate>() { // from class: android.media.audio.common.AudioPlaybackRate.1
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(java.lang.Float.valueOf(this.speed), java.lang.Float.valueOf(that.speed))
        && Objects.deepEquals(
            java.lang.Float.valueOf(this.pitch), java.lang.Float.valueOf(that.pitch))
        && Objects.deepEquals(
            Integer.valueOf(this.timestretchMode), Integer.valueOf(that.timestretchMode))
        && Objects.deepEquals(
