...
public class AudioPortMixExt implements Parcelable {
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.usecase =
          (AudioPortMixExtUseCase) _aidl_parcel.readTypedObject(AudioPortMixExtUseCase.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.handle), Integer.valueOf(that.handle))
        ...
        && Objects.deepEquals(
            Integer.valueOf(this.maxOpenStreamCount), Integer.valueOf(that.maxOpenStreamCount))
        && Objects.deepEquals(
            Integer.valueOf(this.maxActiveStreamCount), Integer.valueOf(that.maxActiveStreamCount))
        && Objects.deepEquals(
