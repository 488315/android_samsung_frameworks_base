...
public class AudioFormatDescription implements Parcelable {
  public static final Parcelable.Creator<AudioFormatDescription> CREATOR =
      new Parcelable.Creator<
          AudioFormatDescription>() { // from class:
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(java.lang.Byte.valueOf(this.type), java.lang.Byte.valueOf(that.type))
        && Objects.deepEquals(java.lang.Byte.valueOf(this.pcm), java.lang.Byte.valueOf(that.pcm))
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(
                java.lang.Byte.valueOf(this.type), java.lang.Byte.valueOf(this.pcm), this.encoding)
            .toArray());
  }
