...
public class AudioHalVolumeGroup implements Parcelable {
  public static final Parcelable.Creator<AudioHalVolumeGroup> CREATOR =
      new Parcelable.Creator<
          AudioHalVolumeGroup>() { // from class: android.media.audio.common.AudioHalVolumeGroup.1
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        ...
        this.volumeCurves =
            (AudioHalVolumeCurve[]) _aidl_parcel.createTypedArray(AudioHalVolumeCurve.CREATOR);
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
        _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(this.name, that.name)
        && Objects.deepEquals(Integer.valueOf(this.minIndex), Integer.valueOf(that.minIndex))
        && Objects.deepEquals(Integer.valueOf(this.maxIndex), Integer.valueOf(that.maxIndex))
