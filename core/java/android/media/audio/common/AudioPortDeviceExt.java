...
public class AudioPortDeviceExt implements Parcelable {
  public static final Parcelable.Creator<AudioPortDeviceExt> CREATOR =
      new Parcelable.Creator<
          AudioPortDeviceExt>() { // from class: android.media.audio.common.AudioPortDeviceExt.1
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.encodedFormats =
          (AudioFormatDescription[]) _aidl_parcel.createTypedArray(AudioFormatDescription.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(this.device, that.device)
        ...
        && Objects.deepEquals(
            Integer.valueOf(this.encapsulationModes), Integer.valueOf(that.encapsulationModes))
        && Objects.deepEquals(
