...
public final class AudioPortExt implements Parcelable {
    ...
    switch (_aidl_tag) {
      ...
      case 1:
        AudioPortDeviceExt _aidl_value2 =
            (AudioPortDeviceExt) _aidl_parcel.readTypedObject(AudioPortDeviceExt.CREATOR);
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.media.audio.common.AudioPortExt.unspecified("
            + getUnspecified()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.media.audio.common.AudioPortExt.device("
            + Objects.toString(getDevice())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.media.audio.common.AudioPortExt.mix("
            + Objects.toString(getMix())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 3:
        return "android.media.audio.common.AudioPortExt.session("
            + getSession()
            + NavigationBarInflaterView.KEY_CODE_END;
      default:
