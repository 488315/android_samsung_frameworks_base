...
public class AudioMMapPolicyInfo implements Parcelable {
  public static final Parcelable.Creator<AudioMMapPolicyInfo> CREATOR =
      new Parcelable.Creator<
          AudioMMapPolicyInfo>() { // from class: android.media.audio.common.AudioMMapPolicyInfo.1
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(this.device, that.device)
        && Objects.deepEquals(Integer.valueOf(this.mmapPolicy), Integer.valueOf(that.mmapPolicy))) {
      return true;
    }
    return false;
  }
