...
public final class AudioDeviceAddress implements Parcelable {
  public static final Parcelable.Creator<AudioDeviceAddress> CREATOR =
      new Parcelable.Creator<
          AudioDeviceAddress>() { // from class: android.media.audio.common.AudioDeviceAddress.1
  ...
  /* renamed from: id */
  public static final int f296id = 0;
  ...
  public @interface Tag {
    ...
    /* renamed from: id */
    public static final int f297id = 0;
    public static final int ipv4 = 2;
    public static final int ipv6 = 3;
    public static final int mac = 1;
  }
  ...
  /* renamed from: id */
  public static AudioDeviceAddress m53id(String _value) {
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.media.audio.common.AudioDeviceAddress.id("
            + Objects.toString(getId())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.media.audio.common.AudioDeviceAddress.mac("
            + Arrays.toString(getMac())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.media.audio.common.AudioDeviceAddress.ipv4("
            + Arrays.toString(getIpv4())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 3:
        return "android.media.audio.common.AudioDeviceAddress.ipv6("
            + Arrays.toString(getIpv6())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 4:
        return "android.media.audio.common.AudioDeviceAddress.alsa("
