...
public class PermissionUtil {
    public static SafeCloseable establishIdentityIndirect(
            Context context,
            String middlemanPermission,
        ...
        return new CompositeSafeCloseable(
                IdentityContext.create(originatorIdentity), ClearCallingIdentityContext.create());
    }
    ...
    public static int checkPermissionForDataDelivery(
            Context context, Identity identity, String permission, String reason) {
    ...
    public static int checkPermissionForPreflight(
            Context context, Identity identity, String permission) {
