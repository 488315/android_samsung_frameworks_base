...
public final class MediaProjectionManager {
        ...
        try {
            ...
            try {
                IMediaProjection projection =
                        this.mService.createProjection(uid, packageName, 0, false);
                if (projection == null) {
    ...
    static final class CallbackDelegate extends IMediaProjectionWatcherCallback.Stub {
        ...
        @Override // android.media.projection.IMediaProjectionWatcherCallback
        public void onRecordingSessionSet(
                final MediaProjectionInfo info, final ContentRecordingSession session) {
            this.mHandler.post(
                    new Runnable() { // from class:
                        // android.media.projection.MediaProjectionManager$CallbackDelegate$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            MediaProjectionManager.CallbackDelegate.this
                                    .lambda$onRecordingSessionSet$0(info, session);
                        }
                    });
        }
    }
