...
public final class MediaProjectionManager {
    ...
    public Intent createScreenCaptureIntent() {
        Intent i = new Intent();
        ComponentName mediaProjectionPermissionDialogComponent = ComponentName.unflattenFromString(this.mContext.getResources().getString(C4337R.string.config_mediaProjectionPermissionDialogComponent));
