...
public final class MediaProjectionConfig implements Parcelable {
  ...
  public static final Parcelable.Creator<MediaProjectionConfig> CREATOR =
      new Parcelable.Creator<
          MediaProjectionConfig>() { // from class: android.media.projection.MediaProjectionConfig.1
  ...
  MediaProjectionConfig(Parcel in) {
    ...
    AnnotationValidations.validate(
        (Class<IntRange>) IntRange.class, (IntRange) null, displayToCapture, "from", 0L, "to", 0L);
    this.mRegionToCapture = regionToCapture;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) CaptureRegion.class, (Annotation) null, regionToCapture);
  }
