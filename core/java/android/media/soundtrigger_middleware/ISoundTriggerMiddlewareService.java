...
public interface ISoundTriggerMiddlewareService extends IInterface {
  public static final String DESCRIPTOR =
      "android$media$soundtrigger_middleware$ISoundTriggerMiddlewareService".replace('$', '.');
  ...
  ISoundTriggerModule attachAsOriginator(
      int i, Identity identity, ISoundTriggerCallback iSoundTriggerCallback) throws RemoteException;
  ...
  public static class Default implements ISoundTriggerMiddlewareService {
    ...
    public ISoundTriggerModule attachAsOriginator(
        int handle, Identity identity, ISoundTriggerCallback callback) throws RemoteException {
      return null;
    }
