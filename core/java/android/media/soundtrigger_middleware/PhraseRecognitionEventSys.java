...
public class PhraseRecognitionEventSys implements Parcelable {
  public static final Parcelable.Creator<PhraseRecognitionEventSys> CREATOR =
      new Parcelable.Creator<
          PhraseRecognitionEventSys>() { // from class:
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.phraseRecognitionEvent =
          (PhraseRecognitionEvent) _aidl_parcel.readTypedObject(PhraseRecognitionEvent.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(this.phraseRecognitionEvent, that.phraseRecognitionEvent)
        && Objects.deepEquals(
            Long.valueOf(this.halEventReceivedMillis), Long.valueOf(that.halEventReceivedMillis))
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(
                this.phraseRecognitionEvent, Long.valueOf(this.halEventReceivedMillis), this.token)
            .toArray());
  }
