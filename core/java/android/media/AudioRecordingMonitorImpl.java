...
public class AudioRecordingMonitorImpl implements AudioRecordingMonitor {
          ...
          if (config != null) {
            synchronized (AudioRecordingMonitorImpl.this.mRecordCallbackLock) {
              if (AudioRecordingMonitorImpl.this.mRecordingCallbackHandler != null) {
                Message m =
                    AudioRecordingMonitorImpl.this.mRecordingCallbackHandler.obtainMessage(
                        1, config);
  ...
  private void beginRecordingCallbackHandling() {
    if (this.mRecordingCallbackHandlerThread == null) {
      ...
      if (looper != null) {
        this.mRecordingCallbackHandler = new HandlerC17672(looper);
        IAudioService service = getService();
        try {
  ...
  class HandlerC17672 extends Handler {
    HandlerC17672(Looper looper) {
      super(looper);
    }
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        case 1:
          ...
          synchronized (AudioRecordingMonitorImpl.this.mRecordCallbackLock) {
            ...
            LinkedList<AudioRecordingCallbackInfo> cbInfoList =
                new LinkedList<>(AudioRecordingMonitorImpl.this.mRecordCallbackList);
                ...
                cbi.mExecutor.execute(
                    new Runnable() { // from class:
                      ...
                      public final void run() {
                        AudioRecordingMonitorImpl.AudioRecordingCallbackInfo.this.mCb
        ...
        default:
          Log.m96e(AudioRecordingMonitorImpl.TAG, "Unknown event " + msg.what);
          return;
      }
    }
  }
