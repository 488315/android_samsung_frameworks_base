...
public final class Flags {
    ...
    public static final String FLAG_DYNAMIC_COLOR_ASPECTS =
            "android.media.codec.dynamic_color_aspects";
    public static final String FLAG_HLG_EDITING = "android.media.codec.hlg_editing";
    public static final String FLAG_INPUT_SURFACE_THROTTLE =
            "android.media.codec.input_surface_throttle";
    public static final String FLAG_IN_PROCESS_SW_AUDIO_CODEC =
            "android.media.codec.in_process_sw_audio_codec";
    public static final String FLAG_IN_PROCESS_SW_AUDIO_CODEC_SUPPORT =
            "android.media.codec.in_process_sw_audio_codec_support";
    public static final String FLAG_LARGE_AUDIO_FRAME_FINISH =
            "android.media.codec.large_audio_frame_finish";
    ...
    public static final String FLAG_NULL_OUTPUT_SURFACE_SUPPORT =
            "android.media.codec.null_output_surface_support";
    public static final String FLAG_REGION_OF_INTEREST = "android.media.codec.region_of_interest";
    public static final String FLAG_REGION_OF_INTEREST_SUPPORT =
            "android.media.codec.region_of_interest_support";
    ...
    public static final String FLAG_STOP_HAL_BEFORE_SURFACE =
            "android.media.codec.stop_hal_before_surface";
