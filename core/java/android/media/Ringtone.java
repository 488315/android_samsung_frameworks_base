...
public class Ringtone {
    ...
    private void applyPlaybackProperties_sync() {
        if (this.mLocalPlayer != null) {
            ...
            if (this.mHapticGenerator == null && this.mHapticGeneratorEnabled) {
                this.mHapticGenerator =
                        HapticGenerator.create(this.mLocalPlayer.getAudioSessionId());
            }
        ...
        if (this.mAllowRemote && this.mRemotePlayer != null) {
            try {
                this.mRemotePlayer.setPlaybackProperties(
                        this.mRemoteToken,
                        this.mVolume,
                        this.mIsLooping,
                        this.mHapticGeneratorEnabled);
                return;
    ...
    */
    public static java.lang.String getTitle(
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled: android.media.Ringtone.getTitle(android.content.Context,"
                        + " android.net.Uri, boolean, boolean, boolean):java.lang.String");
    }
    ...
    private boolean playFallbackRingtone() {
        ...
        if (ringtoneType != -1
                && RingtoneManager.getActualDefaultRingtoneUri(this.mContext, ringtoneType)
                        == null) {
        ...
        try {
            AssetFileDescriptor afd =
                    this.mContext.getResources().openRawResourceFd(R.raw.fallbackring);
    ...
    private void setupCustomRoutine() {
        ...
        this.mUriStatus = false;
        if (AsPackageName.RINGTONE_PICKER.equals(packageName)
    ...
    private void addTag(String tag) {
        ...
        this.mAudioAttributes =
                new AudioAttributes.Builder(this.mAudioAttributes).addTag(tag).build();
    }
