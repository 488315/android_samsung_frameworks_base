...
public class Ringtone {
    ...
    private void applyPlaybackProperties_sync() {
        ...
        Log.m102w("Ringtone", "Neither local nor remote player available when applying playback properties");
    }
    ...
    */
    public static String getTitle(Context context, Uri uri, boolean followSettingsUri, boolean allowRemote, boolean withThemeTitle) {
                ...
                try {
                    try {
                        if ("media".equals(authority)) {
                            ...
                            cursor = res.query(uri, Rune.SEC_AUDIO_SUPPORT_SOUND_THEME ? SoundTheme.SOUND_THEME_MEDIA_COLUMNS : MEDIA_COLUMNS, mediaSelection, null, null);
    ...
    private boolean playFallbackRingtone() {
        ...
        try {
            AssetFileDescriptor afd = this.mContext.getResources().openRawResourceFd(C4337R.raw.fallbackring);
