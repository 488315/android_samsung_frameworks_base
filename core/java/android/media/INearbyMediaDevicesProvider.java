...
public interface INearbyMediaDevicesProvider extends IInterface {
  ...
  void registerNearbyDevicesCallback(
      INearbyMediaDevicesUpdateCallback iNearbyMediaDevicesUpdateCallback) throws RemoteException;
          ...
          switch (code) {
            case 3:
              INearbyMediaDevicesUpdateCallback _arg0 =
                  INearbyMediaDevicesUpdateCallback.Stub.asInterface(data.readStrongBinder());
