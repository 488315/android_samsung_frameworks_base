...
public class AudioSystem {
  ...
  private static native int getDevicesForAttributes(
      AudioAttributes audioAttributes, AudioDeviceAttributes[] audioDeviceAttributesArr, boolean z);
  ...
  public static native int setPreferredMixerAttributes(
      AudioAttributes audioAttributes, int i, int i2, AudioMixerAttributes audioMixerAttributes);
  ...
  public static int getPlatformType(Context context) {
    if (Rune.SEC_AUDIO_ATT_SOFTPHONE
        || ((TelephonyManager) context.getSystemService("phone")).isVoiceCapable()) {
      return 1;
    }
