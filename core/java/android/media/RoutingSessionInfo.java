...
public final class RoutingSessionInfo implements Parcelable {
  ...
  RoutingSessionInfo(Builder builder) {
    ...
    boolean volumeAdjustmentForRemoteGroupSessions =
        Resources.getSystem().getBoolean(C4337R.bool.config_volumeAdjustmentForRemoteGroupSessions);
    int defineVolumeHandling =
        defineVolumeHandling(
            builder.mVolumeHandling, unmodifiableList, volumeAdjustmentForRemoteGroupSessions);
  ...
  public static final class Builder {
    ...
    public Builder(String id, String clientPackageName) {
      ...
      this.mId = id;
      this.mClientPackageName =
          (String) Objects.requireNonNull(clientPackageName, "clientPackageName must not be null");
