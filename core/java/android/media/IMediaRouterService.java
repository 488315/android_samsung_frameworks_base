...
public interface IMediaRouterService extends IInterface {
  void deselectRouteWithManager(
      IMediaRouter2Manager iMediaRouter2Manager, int i, String str, MediaRoute2Info mediaRoute2Info)
  ...
  RoutingSessionInfo getSystemSessionInfoForPackage(
      IMediaRouter2Manager iMediaRouter2Manager, String str) throws RemoteException;
  ...
  void setRouteVolumeWithRouter2(
      IMediaRouter2 iMediaRouter2, MediaRoute2Info mediaRoute2Info, int i) throws RemoteException;

  void setSelectedRoute(IMediaRouterClient iMediaRouterClient, String str, boolean z)
      throws RemoteException;

  void setSessionVolumeWithManager(
      IMediaRouter2Manager iMediaRouter2Manager, int i, String str, int i2) throws RemoteException;
  ...
  public static class Default implements IMediaRouterService {
    ...
    public void selectRouteWithRouter2(
        IMediaRouter2 router, String sessionId, MediaRoute2Info route) throws RemoteException {}
    ...
    public RoutingSessionInfo getSystemSessionInfoForPackage(
        IMediaRouter2Manager manager, String packageName) throws RemoteException {
      return null;
    }
    ...
    public void selectRouteWithManager(
        IMediaRouter2Manager manager, int requestId, String sessionId, MediaRoute2Info route)
        throws RemoteException {}
    ...
    public void releaseSessionWithManager(
        IMediaRouter2Manager manager, int requestId, String sessionId) throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 16:
              ...
              RouteDiscoveryPreference _arg19 =
                  (RouteDiscoveryPreference) data.readTypedObject(RouteDiscoveryPreference.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 17:
              ...
              RouteListingPreference _arg110 =
                  (RouteListingPreference) data.readTypedObject(RouteListingPreference.CREATOR);
              data.enforceNoDataAvail();
      ...
      public MediaRouterClientState getState(IMediaRouterClient client) throws RemoteException {
        ...
        try {
          ...
          MediaRouterClientState _result =
              (MediaRouterClientState) _reply.readTypedObject(MediaRouterClientState.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
