...
class Cea608CCWidget extends ClosedCaptionWidget implements Cea608CCParser.DisplayListener {
    ...
    private static class CCLineBox extends TextView {
        ...
        CCLineBox(Context context) {
            ...
            this.mShadowOffset = res.getDimensionPixelSize(C4337R.dimen.subtitle_shadow_offset);
        }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            try {
                ...
                Log.m102w("CCLineBox", "setScaleX(" + requiredTextWidth + ", " + actualTextWidth + ") : " + e.getMessage());
            }
