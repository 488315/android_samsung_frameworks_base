...
public class MediaMetadataRetriever implements AutoCloseable {
  ...
  private native void _setDataSource(IBinder iBinder, String str, String[] strArr, String[] strArr2)
      throws IllegalArgumentException;
  ...
  public void setDataSource(String path) throws IllegalArgumentException {
    if (path == null) {
      Log.m96e(TAG, "setDataSource path is null");
    ...
    try {
      ...
      Log.m96e(TAG, "setDataSource - FileNotFoundException");
      throw new IllegalArgumentException(path + " does not exist");
    } catch (IOException e2) {
      Log.m96e(TAG, "setDataSource - IOException");
  ...
  public void setDataSource(Context context, Uri uri)
    ...
    if (uri == null) {
      Log.m96e(TAG, "setDataSource - uri is null");
