...
public interface IMediaRoute2ProviderServiceCallback extends IInterface {
  ...
  public abstract static class Stub extends Binder implements IMediaRoute2ProviderServiceCallback {
          ...
          switch (code) {
            case 1:
              MediaRoute2ProviderInfo _arg0 =
                  (MediaRoute2ProviderInfo) data.readTypedObject(MediaRoute2ProviderInfo.CREATOR);
