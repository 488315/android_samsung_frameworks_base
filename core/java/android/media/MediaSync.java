...
public final class MediaSync {
  ...
  public void setPlaybackParams(PlaybackParams params) {
    ...
    if (native_setPlaybackParams != SContextConstants.ENVIRONMENT_VALUE_UNKNOWN
  ...
  public void setSyncParams(SyncParams params) {
    ...
    if (native_setSyncParams != SContextConstants.ENVIRONMENT_VALUE_UNKNOWN
        && this.mAudioThread != null) {
      postRenderAudio(0L);
    }
  }
            ...
            synchronized (MediaSync.this.mAudioLock) {
              ...
              if (size > 0 && MediaSync.this.mAudioTrack.getPlayState() != 3) {
                try {
                  ...
                  Log.m102w(MediaSync.TAG, "could not start audio track");
                }
              }
              ...
              long pendingTimeMs =
                  TimeUnit.MICROSECONDS.toMillis(
                      MediaSync.this.native_getPlayTimeForPendingAudioFrames());
              ...
              public void run() {
                synchronized (MediaSync.this.mCallbackLock) {
                  ...
                  if (MediaSync.this.mCallbackHandler != null
                      && MediaSync.this.mCallbackHandler.getLooper().getThread()
                          == Thread.currentThread()) {
                    if (callback != null) {
                      callback.onAudioBufferConsumed(
                          sync, audioBuffer.mByteBuffer, audioBuffer.mBufferIndex);
                    }
                  }
                }
              }
