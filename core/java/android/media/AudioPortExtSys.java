...
public final class AudioPortExtSys implements Parcelable {
  public static final Parcelable.Creator<AudioPortExtSys> CREATOR =
      new Parcelable.Creator<AudioPortExtSys>() { // from class: android.media.AudioPortExtSys.1
    ...
    switch (_aidl_tag) {
      ...
      case 1:
        AudioPortDeviceExtSys _aidl_value2 =
            (AudioPortDeviceExtSys) _aidl_parcel.readTypedObject(AudioPortDeviceExtSys.CREATOR);
        _set(_aidl_tag, _aidl_value2);
        return;
      case 2:
        AudioPortMixExtSys _aidl_value3 =
            (AudioPortMixExtSys) _aidl_parcel.readTypedObject(AudioPortMixExtSys.CREATOR);
