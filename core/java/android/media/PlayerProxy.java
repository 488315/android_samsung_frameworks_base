...
public class PlayerProxy {
  ...
  public void setStartDelayMs(int delayMs) {
    try {
      ...
      throw new IllegalStateException(
          "No player to proxy for setStartDelayMs operation, player already released?", e);
    }
  }
  ...
  public void applyVolumeShaper(
    ...
    try {
      ...
      throw new IllegalStateException(
          "No player to proxy for applyVolumeShaper operation, player already released?", e);
    }
  }
}
