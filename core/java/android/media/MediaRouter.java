...
public class MediaRouter {
    ...
    static class Static implements DisplayManager.DisplayListener {
        ...
        Static(Context appContext) {
            ...
            RouteCategory routeCategory = new RouteCategory(C4337R.string.default_audio_route_category_name, 3, false);
        ...
        void updateAudioRoutes(AudioRoutesInfo newRoutes) {
            ...
            if (!TextUtils.equals(newRoutes.bluetoothName, this.mCurAudioRoutesInfo.bluetoothName)) {
                ...
                if (newRoutes.bluetoothName != null) {
                    ...
                    if (routeInfo2 == null) {
                        ...
                        info.mDescription = this.mResources.getText(C4337R.string.bluetooth_a2dp_audio_route_name);
                        info.mSupportedTypes = 1;
                        info.mDeviceType = 3;
                        info.mGlobalRouteId = MediaRouter.sStatic.mResources.getString(C4337R.string.bluetooth_a2dp_audio_route_id);
            ...
            if (audioRoutesChanged) {
                Log.m100v(MediaRouter.TAG, "Audio routes updated: " + newRoutes + ", a2dp=" + isBluetoothA2dpOn());
            ...
            public /* synthetic */ void lambda$onRestoreRoute$0() {
                if (this == Static.this.mClient && Static.this.mSelectedRoute != null) {
                    ...
                    if (Static.this.mSelectedRoute.isDefault() && Static.this.mBluetoothA2dpRoute != null) {
                        Log.m94d(MediaRouter.TAG, "onRestoreRoute() : selectedRoute=" + Static.this.mSelectedRoute + ", a2dpRoute=" + Static.this.mBluetoothA2dpRoute);
                    } else {
    ...
    static void selectRouteStatic(int types, RouteInfo route, boolean explicit) {
        ...
        if (!route.matchesTypes(types)) {
            Log.m102w(TAG, "selectRoute ignored; cannot select route with supported types " + typesToString(route.getSupportedTypes()) + " into route types " + typesToString(types));
            return;
        }
        if (sStatic.isPlaybackActive() && sStatic.mBluetoothA2dpRoute != null && (types & 1) != 0 && (route.isBluetooth() || route.isDefault())) {
            ...
            Log.m98i(TAG, "Skip setBluetoothA2dpOn(): types=" + types + ", isPlaybackActive()=" + sStatic.isPlaybackActive() + ", BT route=" + sStatic.mBluetoothA2dpRoute);
        }
        ...
        if (activeDisplay != null || oldRouteHasAddress || newRouteHasAddress) {
            if (newRouteHasAddress && !matchesDeviceAddress(activeDisplay, route)) {
                if (sStatic.mCanConfigureWifiDisplays) {
                    ...
                    Log.m96e(TAG, "Cannot connect to wifi displays because this process is not allowed to do so.");
                }
    ...
    static RouteInfo makeWifiDisplayRoute(WifiDisplay display, WifiDisplayStatus wfdStatus) {
        ...
        newRoute.mDescription = sStatic.mResources.getText(C4337R.string.wireless_display_route_description);
    ...
    public static class UserRouteInfo extends RouteInfo {
        ...
        public void requestSetVolume(int volume) {
            if (this.mVolumeHandling == 1) {
                if (this.mVcb == null) {
                    Log.m96e(MediaRouter.TAG, "Cannot requestSetVolume on user route - no volume callback set");
                } else {
        ...
        public void requestUpdateVolume(int direction) {
            if (this.mVolumeHandling == 1) {
                if (this.mVcb == null) {
                    Log.m96e(MediaRouter.TAG, "Cannot requestChangeVolume on user route - no volumec callback set");
                } else {
