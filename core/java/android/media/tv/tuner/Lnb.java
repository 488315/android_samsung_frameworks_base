  ...
  private void onEvent(final int eventType) {
    synchronized (this.mCallbackLock) {
      for (final LnbCallback callback : this.mCallbackMap.keySet()) {
        ...
        if (callback != null && executor != null) {
          executor.execute(
              new Runnable() { // from class: android.media.tv.tuner.Lnb$$ExternalSyntheticLambda1
  ...
  private void onDiseqcMessage(final byte[] diseqcMessage) {
    synchronized (this.mCallbackLock) {
      for (final LnbCallback callback : this.mCallbackMap.keySet()) {
        ...
        if (callback != null && executor != null) {
          executor.execute(
              new Runnable() { // from class: android.media.tv.tuner.Lnb$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
