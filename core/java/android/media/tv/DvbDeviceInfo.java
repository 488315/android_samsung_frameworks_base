...
public final class DvbDeviceInfo implements Parcelable {
  public static final Parcelable.Creator<DvbDeviceInfo> CREATOR =
      new Parcelable.Creator<DvbDeviceInfo>() { // from class: android.media.tv.DvbDeviceInfo.1
        ...
        public DvbDeviceInfo createFromParcel(Parcel source) {
          try {
            ...
            Log.m97e(DvbDeviceInfo.TAG, "Exception creating DvbDeviceInfo from parcel", e);
            return null;
          }
        }
