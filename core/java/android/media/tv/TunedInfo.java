...
public final class TunedInfo implements Parcelable {
      ...
      new Parcelable.Creator<TunedInfo>() { // from class: android.media.tv.TunedInfo.1
        ...
        public TunedInfo createFromParcel(Parcel source) {
          try {
            ...
            Log.m97e(TunedInfo.TAG, "Exception creating TunedInfo from parcel", e);
            return null;
          }
        }
  ...
  public boolean equals(Object o) {
    ...
    return TextUtils.equals(this.mInputId, other.getInputId())
        && Objects.equals(this.mChannelUri, other.mChannelUri)
        && this.mIsRecordingSession == other.mIsRecordingSession
        && this.mIsVisible == other.mIsVisible
        && this.mIsMainSession == other.mIsMainSession
        && this.mAppType == other.mAppType
        && this.mAppTag == other.mAppTag;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        this.mInputId,
        this.mChannelUri,
        Boolean.valueOf(this.mIsRecordingSession),
        Boolean.valueOf(this.mIsVisible),
        Boolean.valueOf(this.mIsMainSession),
        Integer.valueOf(this.mAppType),
        Integer.valueOf(this.mAppTag));
  }
}
