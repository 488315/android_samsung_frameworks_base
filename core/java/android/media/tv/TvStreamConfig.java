...
public class TvStreamConfig implements Parcelable {
  ...
  public static final Parcelable.Creator<TvStreamConfig> CREATOR =
      new Parcelable.Creator<TvStreamConfig>() { // from class: android.media.tv.TvStreamConfig.1
        ...
        public TvStreamConfig createFromParcel(Parcel source) {
          try {
            ...
            Log.m97e(TvStreamConfig.TAG, "Exception creating TvStreamConfig from parcel", e);
            return null;
          }
        }
