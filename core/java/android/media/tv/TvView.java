...
public class TvView extends ViewGroup {
    ...
    this.mSurfaceHolderCallback =
        new SurfaceHolder.Callback() { // from class: android.media.tv.TvView.1
          ...
          public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            ...
            tvView.dispatchSurfaceChanged(
                tvView.mSurfaceFormat, TvView.this.mSurfaceWidth, TvView.this.mSurfaceHeight);
          }
  ...
  public void tune(String inputId, Uri channelUri, Bundle params) {
    ...
    if (tvInputManager != null) {
      tvInputManager.createSession(
          inputId, this.mTvAppAttributionSource, mySessionCallback2, this.mHandler);
    }
  }
  ...
  public void sendAppPrivateCommand(String action, Bundle data) {
    ...
    if (session != null) {
      ...
      Log.m102w(
          TAG,
          "sendAppPrivateCommand - session not yet created (action \"" + action + "\" pending)");
  ...
  public boolean gatherTransparentRegion(Region region) {
    if (this.mWindowZOrder != 2 && region != null) {
      ...
      if (width > 0 && height > 0) {
        ...
        int left = location[0];
        int top = location[1];
        region.m20op(left, top, left + width, top + height, Region.EnumC0836Op.UNION);
      }
    }
  ...
  private class MySessionCallback extends TvInputManager.SessionCallback {
    ...
    public void onSessionCreated(TvInputManager.Session session) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onSessionCreated - session already created");
        if (session != null) {
          session.release();
          return;
        }
      ...
      if (session != null) {
        ...
        if (TvView.this.mSurface != null) {
          ...
          if (TvView.this.mSurfaceChanged) {
            ...
            tvView2.dispatchSurfaceChanged(
                tvView2.mSurfaceFormat, TvView.this.mSurfaceWidth, TvView.this.mSurfaceHeight);
          }
        }
    ...
    public void onSessionReleased(TvInputManager.Session session) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onSessionReleased - session not created");
        return;
      }
    ...
    public void onChannelRetuned(TvInputManager.Session session, Uri channelUri) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onChannelRetuned - session not created");
    ...
    public void onAudioPresentationsChanged(
      ...
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onAudioPresentationsChanged - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onAudioPresentationSelected(
      ...
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onAudioPresentationSelected - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onTracksChanged(TvInputManager.Session session, List<TvTrackInfo> tracks) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onTracksChanged - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onTrackSelected(TvInputManager.Session session, int type, String trackId) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onTrackSelected - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onVideoSizeChanged(TvInputManager.Session session, int width, int height) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onVideoSizeChanged - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onVideoAvailable(TvInputManager.Session session) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onVideoAvailable - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onVideoUnavailable(TvInputManager.Session session, int reason) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onVideoUnavailable - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onContentAllowed(TvInputManager.Session session) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onContentAllowed - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onContentBlocked(TvInputManager.Session session, TvContentRating rating) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onContentBlocked - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onLayoutSurface(
      ...
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onLayoutSurface - session not created");
        return;
      }
    ...
    public void onSessionEvent(TvInputManager.Session session, String eventType, Bundle eventArgs) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onSessionEvent - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onTimeShiftStatusChanged(TvInputManager.Session session, int status) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onTimeShiftStatusChanged - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onTimeShiftStartPositionChanged(TvInputManager.Session session, long timeMs) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onTimeShiftStartPositionChanged - session not created");
    ...
    public void onTimeShiftCurrentPositionChanged(TvInputManager.Session session, long timeMs) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onTimeShiftCurrentPositionChanged - session not created");
      } else if (TvView.this.mTimeShiftPositionCallback != null) {
    ...
    public void onAitInfoUpdated(TvInputManager.Session session, AitInfo aitInfo) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onAitInfoUpdated - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onSignalStrengthUpdated(TvInputManager.Session session, int strength) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onSignalStrengthUpdated - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onCueingMessageAvailability(TvInputManager.Session session, boolean available) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onCueingMessageAvailability - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onTimeShiftMode(TvInputManager.Session session, int mode) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onTimeShiftMode - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onAvailableSpeeds(TvInputManager.Session session, float[] speeds) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onAvailableSpeeds - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onTuned(TvInputManager.Session session, Uri channelUri) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onTuned - session not created");
      } else if (TvView.this.mCallback != null) {
    ...
    public void onTvMessage(TvInputManager.Session session, int type, Bundle data) {
      if (this != TvView.this.mSessionCallback) {
        Log.m102w(TvView.TAG, "onTvMessage - session not created");
      } else if (TvView.this.mCallback != null) {
