...
public final class TvInputManager {
    ...
    private final ITvInputClient mClient =
            new ITvInputClient.Stub() { // from class: android.media.tv.TvInputManager.1
                    ...
                    synchronized (TvInputManager.this.mSessionCallbackRecordMap) {
                        SessionCallbackRecord record =
                                (SessionCallbackRecord)
                                        TvInputManager.this.mSessionCallbackRecordMap.get(seq);
                        if (record == null) {
                ...
                public void onAudioPresentationSelected(
                        int presentationId, int programId, int seq) {
                    synchronized (TvInputManager.this.mSessionCallbackRecordMap) {
                        SessionCallbackRecord record =
                                (SessionCallbackRecord)
                                        TvInputManager.this.mSessionCallbackRecordMap.get(seq);
                        if (record == null) {
                            ...
                            if (record.mSession.updateAudioPresentationSelection(
    ...
    public abstract static class SessionCallback {
        ...
        public void onAudioPresentationSelected(
                Session session, int presentationId, int programId) {}
    ...
    private static final class SessionCallbackRecord {
        ...
        void postSessionCreated(final Session session) {
            ...
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.1
        ...
        void postSessionReleased() {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.2
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postChannelRetuned(final Uri channelUri) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.3
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postAudioPresentationsChanged(final List<AudioPresentation> audioPresentations) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.4
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postAudioPresentationSelected(final int presentationId, final int programId) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.5
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postTracksChanged(final List<TvTrackInfo> tracks) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.6
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postTrackSelected(final int type, final String trackId) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.7
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postVideoSizeChanged(final int width, final int height) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.8
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postVideoAvailable() {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.9
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postVideoUnavailable(final int reason) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.10
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postVideoFreezeUpdated(final boolean isFrozen) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.11
                        @Override // java.lang.Runnable
                        public void run() {
                            SessionCallbackRecord.this.mSessionCallback.onVideoFreezeUpdated(
                                    SessionCallbackRecord.this.mSession, isFrozen);
                            if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                                    && SessionCallbackRecord.this.mSession
                                                    .getInteractiveAppSession()
                                            != null) {
                                SessionCallbackRecord.this
                                        .mSession
                                        .getInteractiveAppSession()
                                        .notifyVideoFreezeUpdated(isFrozen);
                            }
                        }
                    });
        }
        ...
        void postContentAllowed() {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.12
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postContentBlocked(final TvContentRating rating) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.13
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postLayoutSurface(final int left, final int top, final int right, final int bottom) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.14
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postSessionEvent(final String eventType, final Bundle eventArgs) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.15
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postTimeShiftStatusChanged(final int status) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.16
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postTimeShiftStartPositionChanged(final long timeMs) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.17
                        @Override // java.lang.Runnable
                        public void run() {
                            SessionCallbackRecord.this.mSessionCallback
        ...
        void postTimeShiftCurrentPositionChanged(final long timeMs) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.18
                        @Override // java.lang.Runnable
                        public void run() {
                            SessionCallbackRecord.this.mSessionCallback
        ...
        void postAitInfoUpdated(final AitInfo aitInfo) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.19
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postSignalStrength(final int strength) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.20
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postCueingMessageAvailability(final boolean available) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.21
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postTimeShiftMode(final int mode) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.22
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postAvailableSpeeds(final float[] speeds) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.23
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postTuned(final Uri channelUri) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.24
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postTvMessage(final int type, final Bundle data) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.25
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postRecordingStopped(final Uri recordedProgramUri) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.26
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postError(final int error) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.27
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        void postBroadcastInfoResponse(final BroadcastInfoResponse response) {
            if (this.mSession.mIAppNotificationEnabled) {
                this.mHandler.post(
                        new Runnable() { // from class:
                                         // android.media.tv.TvInputManager.SessionCallbackRecord.28
                            @Override // java.lang.Runnable
                            public void run() {
                                if (SessionCallbackRecord.this.mSession.getInteractiveAppSession()
                                        != null) {
                                    SessionCallbackRecord.this
                                            .mSession
                                            .getInteractiveAppSession()
        ...
        void postAdResponse(final AdResponse response) {
            if (this.mSession.mIAppNotificationEnabled) {
                this.mHandler.post(
                        new Runnable() { // from class:
                                         // android.media.tv.TvInputManager.SessionCallbackRecord.29
                            @Override // java.lang.Runnable
                            public void run() {
                                if (SessionCallbackRecord.this.mSession.getInteractiveAppSession()
                                        != null) {
        ...
        void postAdBufferConsumed(final AdBuffer buffer) {
            if (this.mSession.mIAppNotificationEnabled) {
                this.mHandler.post(
                        new Runnable() { // from class:
                                         // android.media.tv.TvInputManager.SessionCallbackRecord.30
                            @Override // java.lang.Runnable
                            public void run() {
                                if (SessionCallbackRecord.this.mSession.getInteractiveAppSession()
                                        != null) {
        ...
        void postTvInputSessionData(final String type, final Bundle data) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.SessionCallbackRecord.31
                        @Override // java.lang.Runnable
                        public void run() {
                            if (SessionCallbackRecord.this.mSession.getAdSession() != null) {
                                SessionCallbackRecord.this
                                        .mSession
                                        .getAdSession()
                                        .notifyTvInputSessionData(type, data);
                            }
                        }
                    });
        }
    ...
    private static final class TvInputCallbackRecord {
        ...
        public void postInputAdded(final String inputId) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.TvInputCallbackRecord.1
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void postInputRemoved(final String inputId) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.TvInputCallbackRecord.2
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void postInputUpdated(final String inputId) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.TvInputCallbackRecord.3
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void postInputStateChanged(final String inputId, final int state) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.TvInputCallbackRecord.4
                        @Override // java.lang.Runnable
                        public void run() {
                            TvInputCallbackRecord.this.mCallback.onInputStateChanged(
                                    inputId, state);
                        }
                    });
        }
        ...
        public void postTvInputInfoUpdated(final TvInputInfo inputInfo) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.TvInputCallbackRecord.5
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void postCurrentTunedInfosUpdated(final List<TunedInfo> currentTunedInfos) {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // android.media.tv.TvInputManager.TvInputCallbackRecord.6
                        @Override // java.lang.Runnable
                        public void run() {
                            TvInputCallbackRecord.this.mCallback.onCurrentTunedInfosUpdated(
                                    currentTunedInfos);
                        }
                    });
        }
    ...
    public TvInputManager(ITvInputManager service, int userId) {
        ...
        ITvInputManagerCallback managerCallback =
                new ITvInputManagerCallback
                        .Stub() { // from class: android.media.tv.TvInputManager.2
                    ...
                    public void onInputAdded(String inputId) {
                        synchronized (TvInputManager.this.mLock) {
                            ...
                            for (TvInputCallbackRecord record :
                                    TvInputManager.this.mCallbackRecords) {
                ...
                synchronized (this.mLock) {
                    for (TvInputInfo info : infos) {
                        ...
                        this.mStateMap.put(
                                inputId,
                                Integer.valueOf(
                                        this.mService.getTvInputState(inputId, this.mUserId)));
                    }
                }
            }
    ...
    public static final class Session {
            ...
            synchronized (this.mMetadataLock) {
                if (presentationId != -1) {
                    if (!containsAudioPresentation(this.mAudioPresentations, presentationId)) {
                        Log.w(
                                TvInputManager.TAG,
                                "Invalid audio presentation id: " + presentationId);
                        return;
                    }
                }
                if (this.mToken == null) {
                ...
                try {
                    this.mService.selectAudioPresentation(
                            this.mToken, presentationId, programId, this.mUserId);
                } catch (RemoteException e) {
                    throw e.rethrowFromSystemServer();
                }
            }
        ...
        public void setInteractiveAppNotificationEnabled(boolean enabled) {
            ...
            try {
                this.mService.setInteractiveAppNotificationEnabled(
                        this.mToken, enabled, this.mUserId);
                ...
                if (!this.mVideoTracks.isEmpty() && this.mSelectedVideoTrackId != null) {
                    for (TvTrackInfo track : this.mVideoTracks) {
                        if (track.getId().equals(this.mSelectedVideoTrackId)) {
                            ...
                            if (this.mVideoWidth != videoWidth
        ...
        void createOverlayView(View view, Rect frame) {
            ...
            try {
                this.mService.createOverlayView(
        ...
        void unblockContent(TvContentRating unblockedRating) {
            ...
            try {
                this.mService.unblockContent(
                        this.mToken, unblockedRating.flattenToString(), this.mUserId);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
