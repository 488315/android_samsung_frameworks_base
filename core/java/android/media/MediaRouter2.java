...
public final class MediaRouter2 {
  ...
  public static MediaRouter2 getInstance(Context context, String clientPackageName) {
    ...
    try {
      if (!serviceBinder.verifyPackageExists(clientPackageName)) {
        Log.m96e(TAG, "Package " + clientPackageName + " not found. Ignoring.");
        return null;
      }
    ...
    synchronized (sSystemRouterLock) {
      ...
      if (instance == null) {
        ...
        sManager.registerCallback(
            new PendingIntent$$ExternalSyntheticLambda1(), instance.mManagerCallback);
      }
    }
    return instance;
  }
  ...
  private MediaRouter2(Context appContext) {
    ...
    IMediaRouterService asInterface =
        IMediaRouterService.Stub.asInterface(
            ServiceManager.getService(Context.MEDIA_ROUTER_SERVICE));
  ...
  public void registerRouteCallback(
    ...
    synchronized (this.mLock) {
      ...
      if (this.mStub != null && updateDiscoveryPreferenceIfNeededLocked()) {
        try {
          this.mMediaRouterService.setDiscoveryRequestWithRouter2(
              this.mStub, this.mDiscoveryPreference);
  ...
  public void unregisterRouteCallback(RouteCallback routeCallback) {
    ...
    if (!this.mRouteCallbackRecords.remove(new RouteCallbackRecord(null, routeCallback, null))) {
      Log.m102w(TAG, "unregisterRouteCallback: Ignoring unknown callback");
      return;
    }
    if (isSystemRouter()) {
      return;
    ...
    synchronized (this.mLock) {
      ...
      if (updateDiscoveryPreferenceIfNeededLocked()) {
        try {
          ...
          Log.m97e(TAG, "unregisterRouteCallback: Unable to set discovery request.", ex);
        }
      }
      ...
      try {
        try {
          showMediaOutputSwitcher =
              this.mMediaRouterService.showMediaOutputSwitcher(this.mPackageName);
        } catch (RemoteException ex) {
          ex.rethrowFromSystemServer();
          return false;
        }
  ...
  public void setRouteListingPreference(RouteListingPreference routeListingPreference) {
    synchronized (this.mLock) {
      ...
      try {
        ...
        this.mMediaRouterService.setRouteListingPreference(
            this.mStub, this.mRouteListingPreference);
      } catch (RemoteException ex) {
        ex.rethrowFromSystemServer();
      }
    }
                            ...
                            new Function() { // from class:
                              ...
                              public final Object apply(Object obj) {
                                ...
                                routeDiscoveryPreference =
                                    ((MediaRouter2.RouteCallbackRecord) obj).mPreference;
  ...
  public void registerTransferCallback(Executor executor, TransferCallback callback) {
    ...
    if (!this.mTransferCallbackRecords.addIfAbsent(record)) {
      Log.m102w(TAG, "registerTransferCallback: Ignoring the same callback");
    }
  }
  ...
  public void unregisterTransferCallback(TransferCallback callback) {
    ...
    if (!this.mTransferCallbackRecords.remove(new TransferCallbackRecord(null, callback))) {
      Log.m102w(TAG, "unregisterTransferCallback: Ignoring an unknown callback");
    }
  }
  ...
  public void registerControllerCallback(Executor executor, ControllerCallback callback) {
    ...
    if (!this.mControllerCallbackRecords.addIfAbsent(record)) {
      Log.m102w(TAG, "registerControllerCallback: Ignoring the same callback");
    }
  }
  ...
  public void unregisterControllerCallback(ControllerCallback callback) {
    ...
    if (!this.mControllerCallbackRecords.remove(new ControllerCallbackRecord(null, callback))) {
      Log.m102w(TAG, "unregisterControllerCallback: Ignoring an unknown callback");
    }
  }
  ...
  public void transferTo(MediaRoute2Info route) {
    ...
    Log.m100v(TAG, "Transferring to route: " + route);
    synchronized (this.mLock) {
  ...
  void requestCreateController(
    ...
    if (stub != null) {
      try {
        ...
        Log.m97e(
            TAG, "createControllerForTransfer: Failed to request for creating a controller.", ex);
  ...
  void dispatchFilteredRoutesUpdatedOnHandler(List<MediaRoute2Info> newRoutes) {
    ...
    Set<String> newRouteIds =
        (Set)
            newRoutes.stream()
                .map(new MediaRouter2$$ExternalSyntheticLambda9())
  ...
  void updateFilteredRoutesLocked() {
    this.mFilteredRoutes =
        Collections.unmodifiableList(
            filterRoutesWithCompositePreferenceLocked(List.copyOf(this.mRoutes.values())));
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda12
  ...
  void createControllerOnHandler(int requestId, RoutingSessionInfo sessionInfo) {
    ...
    if (matchingRequest == null) {
      Log.m102w(TAG, "createControllerOnHandler: Ignoring an unknown request.");
      return;
    }
    ...
    if (!TextUtils.equals(requestedRoute.getProviderId(), sessionInfo.getProviderId())) {
      Log.m102w(
          TAG,
          "The session's provider ID does not match the requested route's. (requested route's"
              + " providerId="
    ...
    if (!oldController.scheduleRelease()) {
      Log.m102w(
          TAG,
          "createControllerOnHandler: Ignoring controller creation for released old controller."
              + " oldController="
              + oldController);
  ...
  void updateControllerOnHandler(RoutingSessionInfo sessionInfo) {
    ...
    if (sessionInfo == null) {
      Log.m102w(TAG, "updateControllerOnHandler: Ignoring null sessionInfo.");
      return;
    }
    if (sessionInfo.isSystemSession()) {
  ...
  void releaseControllerOnHandler(RoutingSessionInfo sessionInfo) {
    RoutingController matchingController;
    if (sessionInfo == null) {
      Log.m102w(TAG, "releaseControllerOnHandler: Ignoring null sessionInfo.");
      return;
    }
    synchronized (this.mLock) {
      matchingController = this.mNonSystemRoutingControllers.get(sessionInfo.getId());
    ...
    if (matchingController == null) {
      if (DEBUG) {
        Log.m94d(
            TAG,
            "releaseControllerOnHandler: Matching controller not found. uniqueSessionId="
                + sessionInfo.getId());
      }
    } else {
      RoutingSessionInfo oldInfo = matchingController.getRoutingSessionInfo();
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public RoutingSessionInfo ensureClientPackageNameForSystemSession(
    ...
    return new RoutingSessionInfo.Builder(sessionInfo)
        .setClientPackageName(this.mClientPackageName)
        .build();
  }
    ...
    while (it.hasNext()) {
      ...
      if (!filteredRoutes.isEmpty()) {
        record.mExecutor.execute(
            new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda7
  ...
  private void notifyRoutesRemoved(List<MediaRoute2Info> routes) {
    ...
    while (it.hasNext()) {
      ...
      if (!filteredRoutes.isEmpty()) {
        record.mExecutor.execute(
            new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda10
              @Override // java.lang.Runnable
              public final void run() {
                MediaRouter2.RouteCallbackRecord.this.mRouteCallback.onRoutesRemoved(
                    filteredRoutes);
              }
            });
      }
  ...
  private void notifyRoutesChanged(List<MediaRoute2Info> routes) {
    ...
    while (it.hasNext()) {
      ...
      if (!filteredRoutes.isEmpty()) {
        record.mExecutor.execute(
            new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda3
              @Override // java.lang.Runnable
              public final void run() {
                MediaRouter2.RouteCallbackRecord.this.mRouteCallback.onRoutesChanged(
                    filteredRoutes);
              }
            });
      }
  ...
  private void notifyRoutesUpdated(List<MediaRoute2Info> routes) {
    ...
    while (it.hasNext()) {
      ...
      final List<MediaRoute2Info> filteredRoutes =
          filterRoutesWithIndividualPreference(routes, record.mPreference);
      record.mExecutor.execute(
          new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void notifyPreferredFeaturesChanged(final List<String> features) {
    ...
    while (it.hasNext()) {
      final RouteCallbackRecord record = it.next();
      record.mExecutor.execute(
          new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
              MediaRouter2.RouteCallbackRecord.this.mRouteCallback.onPreferredFeaturesChanged(
                  features);
            }
          });
    }
  ...
  public void notifyTransfer(
    ...
    while (it.hasNext()) {
      ...
      record.mExecutor.execute(
          new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void notifyTransferFailure(final MediaRoute2Info route) {
    ...
    while (it.hasNext()) {
      final TransferCallbackRecord record = it.next();
      record.mExecutor.execute(
          new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void notifyStop(final RoutingController controller) {
    ...
    while (it.hasNext()) {
      final TransferCallbackRecord record = it.next();
      record.mExecutor.execute(
          new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void notifyControllerUpdated(final RoutingController controller) {
    ...
    while (it.hasNext()) {
      ...
      record.mExecutor.execute(
          new Runnable() { // from class: android.media.MediaRouter2$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public class RoutingController {
    ...
    public void selectRoute(MediaRoute2Info route) {
      ...
      Objects.requireNonNull(route, "route must not be null");
      if (isReleased()) {
        Log.m102w(MediaRouter2.TAG, "selectRoute: Called on released controller. Ignoring.");
        return;
      }
      ...
      if (!MediaRouter2.checkRouteListContainsRouteId(selectableRoutes, route.getId())) {
        Log.m102w(MediaRouter2.TAG, "Ignoring selecting a non-selectable route=" + route);
        return;
      }
      ...
      if (stub != null) {
        try {
          ...
          Log.m97e(MediaRouter2.TAG, "Unable to select route for session.", ex);
        }
      }
    }
    ...
    public void deselectRoute(MediaRoute2Info route) {
      ...
      Objects.requireNonNull(route, "route must not be null");
      if (isReleased()) {
        Log.m102w(MediaRouter2.TAG, "deselectRoute: called on released controller. Ignoring.");
        return;
      }
      List<MediaRoute2Info> selectedRoutes = getSelectedRoutes();
      if (!MediaRouter2.checkRouteListContainsRouteId(selectedRoutes, route.getId())) {
        Log.m102w(
            MediaRouter2.TAG, "Ignoring deselecting a route that is not selected. route=" + route);
        return;
      }
      ...
      if (!MediaRouter2.checkRouteListContainsRouteId(deselectableRoutes, route.getId())) {
        Log.m102w(MediaRouter2.TAG, "Ignoring deselecting a non-deselectable route=" + route);
        return;
      }
      if (MediaRouter2.this.isSystemRouter()) {
      ...
      if (stub != null) {
        try {
          ...
          Log.m97e(MediaRouter2.TAG, "Unable to deselect route from session.", ex);
        }
      }
    }
    ...
    void transferToRoute(MediaRoute2Info route) {
      ...
      synchronized (this.mControllerLock) {
        if (isReleased()) {
          Log.m102w(MediaRouter2.TAG, "transferToRoute: Called on released controller. Ignoring.");
          return;
        }
        if (!this.mSessionInfo.getTransferableRoutes().contains(route.getId())) {
          Log.m102w(MediaRouter2.TAG, "Ignoring transferring to a non-transferable route=" + route);
          return;
        }
        synchronized (MediaRouter2.this.mLock) {
          stub = MediaRouter2.this.mStub;
        ...
        if (stub != null) {
          try {
            ...
            Log.m97e(MediaRouter2.TAG, "Unable to transfer to route for session.", ex);
          }
        }
      }
    }
    ...
    public void setVolume(int volume) {
      ...
      if (getVolumeHandling() == 0) {
        Log.m102w(MediaRouter2.TAG, "setVolume: The routing session has fixed volume. Ignoring.");
        return;
      }
      if (volume < 0 || volume > getVolumeMax()) {
        Log.m102w(MediaRouter2.TAG, "setVolume: The target volume is out of range. Ignoring");
        return;
      }
      if (isReleased()) {
        Log.m102w(MediaRouter2.TAG, "setVolume: Called on released controller. Ignoring.");
        return;
      }
      if (MediaRouter2.this.isSystemRouter()) {
      ...
      if (stub != null) {
        try {
          ...
          Log.m97e(MediaRouter2.TAG, "setVolume: Failed to deliver request.", ex);
        }
      }
    }
        ...
        synchronized (MediaRouter2.this.mLock) {
          ...
          MediaRouter2.this.mHandler.postDelayed(
              new Runnable() { // from class:
                               // android.media.MediaRouter2$RoutingController$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
      ...
      synchronized (this.mControllerLock) {
        ...
        if (i == 3) {
          if (MediaRouter2.DEBUG) {
            Log.m94d(MediaRouter2.TAG, "releaseInternal: Called on released controller. Ignoring.");
          }
          return;
        }
        boolean z = true;
        ...
        synchronized (MediaRouter2.this.mLock) {
          ...
          if (MediaRouter2.this.mRouteCallbackRecords.isEmpty()
    ...
    private List<MediaRoute2Info> getRoutesWithIds(final List<String> routeIds) {
      ...
      if (MediaRouter2.this.isSystemRouter()) {
        return (List)
            MediaRouter2.this.getRoutes().stream()
                .filter(
                    new Predicate() { // from class:
                                      // android.media.MediaRouter2$RoutingController$$ExternalSyntheticLambda1
      ...
      synchronized (MediaRouter2.this.mLock) {
        ...
        list =
            (List)
                stream
                    .map(new MediaRouter2$RoutingController$$ExternalSyntheticLambda2(map))
                    .filter(new MediaRouter2$RoutingController$$ExternalSyntheticLambda3())
                    .collect(Collectors.toList());
      }
      return list;
    }
  ...
  class MediaRouter2Stub extends IMediaRouter2.Stub {
    ...
    public void notifyRoutesUpdated(List<MediaRoute2Info> routes) {
      MediaRouter2.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // android.media.MediaRouter2$MediaRouter2Stub$$ExternalSyntheticLambda3
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                ...
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((MediaRouter2) obj)
                      .createControllerOnHandler(
                          ((Integer) obj2).intValue(), (RoutingSessionInfo) obj3);
                }
              },
              MediaRouter2.this,
  ...
  class ManagerCallback implements MediaRouter2Manager.Callback {
    ...
    public void onTransferred(RoutingSessionInfo oldSession, RoutingSessionInfo newSession) {
      ...
      if (!oldSession.isSystemSession()
          && !TextUtils.equals(
              MediaRouter2.this.mClientPackageName, oldSession.getClientPackageName())) {
        return;
      }
      if ((!newSession.isSystemSession()
              && !TextUtils.equals(
                  MediaRouter2.this.mClientPackageName, newSession.getClientPackageName()))
          || TextUtils.equals(oldSession.getId(), newSession.getId())) {
        return;
      }
      if (oldSession.isSystemSession()) {
        MediaRouter2.this.mSystemController.setRoutingSessionInfo(
            MediaRouter2.this.ensureClientPackageNameForSystemSession(oldSession));
      ...
      if (newSession.isSystemSession()) {
        MediaRouter2.this.mSystemController.setRoutingSessionInfo(
            MediaRouter2.this.ensureClientPackageNameForSystemSession(newSession));
    ...
    public void onTransferFailed(RoutingSessionInfo session, MediaRoute2Info route) {
      if (!session.isSystemSession()
          && !TextUtils.equals(
              MediaRouter2.this.mClientPackageName, session.getClientPackageName())) {
        return;
      }
    ...
    public void onSessionUpdated(RoutingSessionInfo session) {
      ...
      if (session.isSystemSession()) {
        MediaRouter2.this.mSystemController.setRoutingSessionInfo(
            MediaRouter2.this.ensureClientPackageNameForSystemSession(session));
    ...
    public void onSessionReleased(RoutingSessionInfo session) {
      if (session.isSystemSession()) {
        Log.m96e(MediaRouter2.TAG, "onSessionReleased: Called on system session. Ignoring.");
      } else {
        if (!TextUtils.equals(
            MediaRouter2.this.mClientPackageName, session.getClientPackageName())) {
          return;
