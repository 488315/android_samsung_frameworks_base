...
public interface IStrategyNonDefaultDevicesDispatcher extends IInterface {
  ...
  public static class Default implements IStrategyNonDefaultDevicesDispatcher {
    ...
    public void dispatchNonDefDevicesChanged(int strategyId, List<AudioDeviceAttributes> devices)
  ...
  public abstract static class Stub extends Binder implements IStrategyNonDefaultDevicesDispatcher {
