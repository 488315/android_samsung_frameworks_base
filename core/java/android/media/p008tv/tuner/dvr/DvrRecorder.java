package android.media.p008tv.tuner.dvr;

import android.annotation.SystemApi;
import android.media.p008tv.tuner.TunerUtils;
import android.media.p008tv.tuner.TunerVersionChecker;
...
public class DvrRecorder implements AutoCloseable {
    ...
    public int start() {
        ...
        this.mOverflow = 0;
        Log.m94d(TAG, "Write Stats Log for Record.");
    ...
    public int stop() {
        int result;
        Log.m94d(TAG, "Write Stats Log for Playback.");
    ...
    public int flush() {
        synchronized (this.mIsStoppedLock) {
            ...
            Log.m102w(TAG, "Cannot flush non-stopped Record DVR.");
            return 3;
        }
    }
