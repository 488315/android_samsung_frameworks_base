...
public class IsdbtFrontendSettings extends FrontendSettings {
  ...
  public static class Builder {
    ...
    public Builder setModulation(int modulation) {
      if (TunerVersionChecker.checkHigherOrEqualVersionTo(131072, "setModulation")) {
        Log.m94d(IsdbtFrontendSettings.TAG, "Use IsdbtLayerSettings on HAL 2.0 or higher");
      } else {
  ...
  @Override // android.media.p008tv.tuner.frontend.FrontendSettings
  public int getType() {
    return 9;
  }
    ...
    public static final class Builder {
      ...
      public IsdbtLayerSettings build() {
        return new IsdbtLayerSettings(
            this.mModulation, this.mTimeInterleaveMode, this.mCodeRate, this.mNumOfSegments);
      }
    }
  }
}
