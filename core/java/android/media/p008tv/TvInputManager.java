...
public final class TvInputManager {
  ...
  public abstract static class SessionCallback {
    ...
    public void onAudioPresentationsChanged(
        Session session, List<AudioPresentation> audioPresentations) {}
  ...
  private static final class SessionCallbackRecord {
    ...
    void postSessionCreated(final Session session) {
      ...
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.1
    ...
    void postSessionReleased() {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    void postChannelRetuned(final Uri channelUri) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.3
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onChannelRetuned(
                  SessionCallbackRecord.this.mSession, channelUri);
            }
          });
    }
    ...
    void postAudioPresentationsChanged(final List<AudioPresentation> audioPresentations) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.4
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onAudioPresentationsChanged(
                  SessionCallbackRecord.this.mSession, audioPresentations);
            }
          });
    }
    ...
    void postAudioPresentationSelected(final int presentationId, final int programId) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.5
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onAudioPresentationSelected(
                  SessionCallbackRecord.this.mSession, presentationId, programId);
            }
          });
    }
    ...
    void postTracksChanged(final List<TvTrackInfo> tracks) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.6
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onTracksChanged(
                  SessionCallbackRecord.this.mSession, tracks);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
                    .mSession
                    .getInteractiveAppSession()
    ...
    void postTrackSelected(final int type, final String trackId) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.7
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onTrackSelected(
                  SessionCallbackRecord.this.mSession, type, trackId);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
                    .mSession
    ...
    void postVideoSizeChanged(final int width, final int height) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.8
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onVideoSizeChanged(
                  SessionCallbackRecord.this.mSession, width, height);
            }
          });
    }
    ...
    void postVideoAvailable() {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.9
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onVideoAvailable(
                  SessionCallbackRecord.this.mSession);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
    ...
    void postVideoUnavailable(final int reason) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.10
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onVideoUnavailable(
                  SessionCallbackRecord.this.mSession, reason);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
                    .mSession
    ...
    void postContentAllowed() {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.11
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onContentAllowed(
                  SessionCallbackRecord.this.mSession);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
    ...
    void postContentBlocked(final TvContentRating rating) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.12
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onContentBlocked(
                  SessionCallbackRecord.this.mSession, rating);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
                    .mSession
    ...
    void postLayoutSurface(final int left, final int top, final int right, final int bottom) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.13
            @Override // java.lang.Runnable
            public void run() {
    ...
    void postSessionEvent(final String eventType, final Bundle eventArgs) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.14
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onSessionEvent(
                  SessionCallbackRecord.this.mSession, eventType, eventArgs);
            }
          });
    }
    ...
    void postTimeShiftStatusChanged(final int status) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.15
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onTimeShiftStatusChanged(
                  SessionCallbackRecord.this.mSession, status);
            }
          });
    }
    ...
    void postTimeShiftStartPositionChanged(final long timeMs) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.16
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onTimeShiftStartPositionChanged(
                  SessionCallbackRecord.this.mSession, timeMs);
            }
          });
    }
    ...
    void postTimeShiftCurrentPositionChanged(final long timeMs) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.17
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onTimeShiftCurrentPositionChanged(
                  SessionCallbackRecord.this.mSession, timeMs);
            }
          });
    }
    ...
    void postAitInfoUpdated(final AitInfo aitInfo) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.18
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onAitInfoUpdated(
                  SessionCallbackRecord.this.mSession, aitInfo);
            }
          });
    }
    ...
    void postSignalStrength(final int strength) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.19
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onSignalStrengthUpdated(
                  SessionCallbackRecord.this.mSession, strength);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
                    .mSession
                    .getInteractiveAppSession()
                    .notifySignalStrength(strength);
              }
            }
          });
    }
    ...
    void postCueingMessageAvailability(final boolean available) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.20
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onCueingMessageAvailability(
                  SessionCallbackRecord.this.mSession, available);
            }
          });
    }
    ...
    void postTimeShiftMode(final int mode) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.21
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onTimeShiftMode(
                  SessionCallbackRecord.this.mSession, mode);
            }
          });
    }
    ...
    void postAvailableSpeeds(final float[] speeds) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.22
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onAvailableSpeeds(
                  SessionCallbackRecord.this.mSession, speeds);
            }
          });
    }
    ...
    void postTuned(final Uri channelUri) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.23
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onTuned(
                  SessionCallbackRecord.this.mSession, channelUri);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
    ...
    void postTvMessage(final int type, final Bundle data) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.24
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onTvMessage(
                  SessionCallbackRecord.this.mSession, type, data);
              if (SessionCallbackRecord.this.mSession.mIAppNotificationEnabled
                  && SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                SessionCallbackRecord.this
                    .mSession
    ...
    void postRecordingStopped(final Uri recordedProgramUri) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.25
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onRecordingStopped(
                  SessionCallbackRecord.this.mSession, recordedProgramUri);
            }
          });
    }
    ...
    void postError(final int error) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.26
            @Override // java.lang.Runnable
            public void run() {
              SessionCallbackRecord.this.mSessionCallback.onError(
                  SessionCallbackRecord.this.mSession, error);
            }
          });
    }
    ...
    void postBroadcastInfoResponse(final BroadcastInfoResponse response) {
      if (this.mSession.mIAppNotificationEnabled) {
        this.mHandler.post(
            new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.27
              @Override // java.lang.Runnable
              public void run() {
    ...
    void postAdResponse(final AdResponse response) {
      if (this.mSession.mIAppNotificationEnabled) {
        this.mHandler.post(
            new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.28
              @Override // java.lang.Runnable
              public void run() {
                if (SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                  SessionCallbackRecord.this
    ...
    void postAdBufferConsumed(final AdBuffer buffer) {
      if (this.mSession.mIAppNotificationEnabled) {
        this.mHandler.post(
            new Runnable() { // from class: android.media.tv.TvInputManager.SessionCallbackRecord.29
              @Override // java.lang.Runnable
              public void run() {
                if (SessionCallbackRecord.this.mSession.getInteractiveAppSession() != null) {
                  SessionCallbackRecord.this
  ...
  private static final class TvInputCallbackRecord {
    ...
    public void postInputAdded(final String inputId) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.TvInputCallbackRecord.1
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void postInputRemoved(final String inputId) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.TvInputCallbackRecord.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void postInputUpdated(final String inputId) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.TvInputCallbackRecord.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void postInputStateChanged(final String inputId, final int state) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.TvInputCallbackRecord.4
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void postTvInputInfoUpdated(final TvInputInfo inputInfo) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.TvInputCallbackRecord.5
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void postCurrentTunedInfosUpdated(final List<TunedInfo> currentTunedInfos) {
      this.mHandler.post(
          new Runnable() { // from class: android.media.tv.TvInputManager.TvInputCallbackRecord.6
            @Override // java.lang.Runnable
            public void run() {
  ...
  public TvInputManager(ITvInputManager service, int userId) {
    ...
    this.mUserId = userId;
    this.mClient =
        new ITvInputClient.Stub() { // from class: android.media.tv.TvInputManager.1
          @Override // android.media.p008tv.ITvInputClient
          public void onSessionCreated(
              String inputId, IBinder token, InputChannel channel, int seq) {
            synchronized (TvInputManager.this.mSessionCallbackRecordMap) {
              SessionCallbackRecord record =
                  (SessionCallbackRecord) TvInputManager.this.mSessionCallbackRecordMap.get(seq);
              if (record == null) {
                Log.m96e(TvInputManager.TAG, "Callback not found for " + token);
                return;
              }
              ...
              if (token != null) {
                session =
                    new Session(
                        token,
                        channel,
                        TvInputManager.this.mService,
                        TvInputManager.this.mUserId,
                        seq,
                        TvInputManager.this.mSessionCallbackRecordMap);
              } else {
          ...
          public void onSessionReleased(int seq) {
            synchronized (TvInputManager.this.mSessionCallbackRecordMap) {
              ...
              TvInputManager.this.mSessionCallbackRecordMap.delete(seq);
              if (record == null) {
                Log.m96e(TvInputManager.TAG, "Callback not found for seq:" + seq);
              } else {
          ...
          @Override // android.media.p008tv.ITvInputClient
          public void onAudioPresentationsChanged(
              List<AudioPresentation> audioPresentations, int seq) {
            synchronized (TvInputManager.this.mSessionCallbackRecordMap) {
              SessionCallbackRecord record =
                  (SessionCallbackRecord) TvInputManager.this.mSessionCallbackRecordMap.get(seq);
              if (record == null) {
    ...
    ITvInputManagerCallback managerCallback =
        new ITvInputManagerCallback.Stub() { // from class: android.media.tv.TvInputManager.2
          @Override // android.media.p008tv.ITvInputManagerCallback
          public void onInputAdded(String inputId) {
      ...
      try {
        ...
        synchronized (obj) {
          for (TvInputInfo info : infos) {
            ...
            this.mStateMap.put(
                inputId, Integer.valueOf(this.mService.getTvInputState(inputId, this.mUserId)));
          }
        }
  ...
  public int getInputState(String inputId) {
    ...
    synchronized (this.mLock) {
      ...
      if (state == null) {
        Log.m102w(TAG, "Unrecognized input ID: " + inputId);
        return 2;
      }
  ...
  @SystemApi
  public void notifyPreviewProgramAddedToWatchNext(
      String packageName, long previewProgramId, long watchNextProgramId) {
    Intent intent = new Intent();
    ...
    synchronized (this.mSessionCallbackRecordMap) {
      ...
      try {
        this.mService.createSession(
            this.mClient, inputId, tvAppAttributionSource, isRecordingSession, seq, this.mUserId);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      }
    }
  ...
  @SystemApi
  public Hardware acquireTvInputHardware(
      int deviceId, HardwareCallback callback, TvInputInfo info) {
    return acquireTvInputHardware(deviceId, info, callback);
  }

  @SystemApi
  public Hardware acquireTvInputHardware(
      int deviceId, TvInputInfo info, HardwareCallback callback) {
    Preconditions.checkNotNull(info);
    Preconditions.checkNotNull(callback);
    return acquireTvInputHardwareInternal(
        deviceId,
        info,
        null,
        400,
        new Executor() { // from class: android.media.tv.TvInputManager.3
  ...
  public Hardware acquireTvInputHardware(
    ...
    Preconditions.checkNotNull(callback);
    return acquireTvInputHardwareInternal(
        deviceId, info, tvInputSessionId, priorityHint, executor, callback);
  }
  ...
  class BinderC20464 extends ITvInputHardwareCallback.Stub {
    final /* synthetic */ HardwareCallback val$callback;
    final /* synthetic */ Executor val$executor;

    BinderC20464(Executor executor, HardwareCallback hardwareCallback) {
      ...
      try {
        ...
        executor.execute(
            new Runnable() { // from class:
                             // android.media.tv.TvInputManager$4$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
    ...
    public void onStreamConfigChanged(final TvStreamConfig[] configs) {
      ...
      try {
        ...
        executor.execute(
            new Runnable() { // from class:
                             // android.media.tv.TvInputManager$4$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
  ...
  private Hardware acquireTvInputHardwareInternal(
      int deviceId,
      TvInputInfo info,
      String tvInputSessionId,
      int priorityHint,
    ...
    try {
      ITvInputHardware hardware =
          this.mService.acquireTvInputHardware(
              deviceId,
              new BinderC20464(executor, callback),
              info,
              this.mUserId,
              tvInputSessionId,
              priorityHint);
  ...
  public static final class Session {
    ...
    public void release() {
      ...
      if (iBinder == null) {
        Log.m102w(TvInputManager.TAG, "The session has been already released");
        return;
      }
      try {
      ...
      synchronized (this.mMetadataLock) {
        if (presentationId != -1) {
          if (!containsAudioPresentation(this.mAudioPresentations, presentationId)) {
            Log.m102w(TvInputManager.TAG, "Invalid audio presentation id: " + presentationId);
            return;
          }
        }
        IBinder iBinder = this.mToken;
    ...
    private boolean containsAudioPresentation(
        List<AudioPresentation> audioPresentations, int presentationId) {
      synchronized (this.mMetadataLock) {
    ...
    boolean updateAudioPresentationSelection(int presentationId, int programId) {
      synchronized (this.mMetadataLock) {
        if (programId == this.mSelectedAudioProgramId
            && presentationId == this.mSelectedAudioPresentationId) {
          return false;
        }
      ...
      synchronized (this.mMetadataLock) {
        if (type == 0) {
          if (trackId != null && !containsTrack(this.mAudioTracks, trackId)) {
            Log.m102w(TvInputManager.TAG, "Invalid audio trackId: " + trackId);
            return;
          }
        } else if (type == 1) {
          if (trackId != null && !containsTrack(this.mVideoTracks, trackId)) {
            Log.m102w(TvInputManager.TAG, "Invalid video trackId: " + trackId);
            return;
          }
        } else if (type == 2) {
          if (trackId != null && !containsTrack(this.mSubtitleTracks, trackId)) {
            Log.m102w(TvInputManager.TAG, "Invalid subtitle trackId: " + trackId);
            return;
          }
        } else {
    ...
    boolean updateTracks(List<TvTrackInfo> tracks) {
      ...
      synchronized (this.mMetadataLock) {
        ...
        if (this.mAudioTracks.isEmpty()
            && this.mVideoTracks.isEmpty()
            && this.mSubtitleTracks.isEmpty()) {
          z = false;
        }
      }
      return z;
    ...
    private int sendInputEventOnMainLooperLocked(PendingEvent p) {
      ...
      if (inputChannel != null) {
        ...
        Log.m102w(
            TvInputManager.TAG,
            "Unable to send input event to session: " + this.mToken + " dropping:" + event);
        return 0;
      }
      return 0;
    }
    ...
    void finishedInputEvent(int seq, boolean handled, boolean timeout) {
      synchronized (this.mHandler) {
        ...
        if (timeout) {
          Log.m102w(
              TvInputManager.TAG,
              "Timeout waiting for session to handle input event after 2500 ms: " + this.mToken);
        } else {
  ...
  public static final class Hardware {
    ...
    public void overrideAudioSink(
      ...
      try {
        this.mInterface.overrideAudioSink(
            audioType, audioAddress, samplingRate, channelMask, format);
      } catch (RemoteException e) {
        throw new RuntimeException(e);
      }
    }
    ...
    public void overrideAudioSink(
        AudioDeviceInfo device, int samplingRate, int channelMask, int format) {
