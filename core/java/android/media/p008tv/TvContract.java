...
public final class TvContract {
  ...
  @SystemApi public static final String EXTRA_PACKAGE_NAME = "android.media.tv.extra.PACKAGE_NAME";
  ...
  public static Uri buildChannelsUriForInput(String inputId, boolean browsableOnly) {
    ...
    return builder
        .appendQueryParameter(PARAM_BROWSABLE_ONLY, String.valueOf(browsableOnly))
        .build();
  }
