...
public interface ITvInputManager extends IInterface {
  ...
  public static class Default implements ITvInputManager {
    @Override // android.media.p008tv.ITvInputManager
    ...
    @Override // android.media.p008tv.ITvInputManager
    public void sendAppPrivateCommand(IBinder sessionToken, String action, Bundle data, int userId)
        throws RemoteException {}
    ...
    @Override // android.media.p008tv.ITvInputManager
    public boolean captureFrame(String inputId, Surface surface, TvStreamConfig config, int userId)
        throws RemoteException {
      return false;
    }
  ...
  public abstract static class Stub extends Binder implements ITvInputManager {
        ...
        default:
          switch (code) {
            ...
            case 53:
              ...
              ITvInputHardwareCallback _arg146 =
              ...
              ITvInputHardware _result14 =
                  acquireTvInputHardware(_arg053, _arg146, _arg229, _arg311, _arg43, _arg52);
              reply.writeNoException();
    ...
    private static class Proxy implements ITvInputManager {
      ...
      public void sendAppPrivateCommand(
          IBinder sessionToken, String action, Bundle data, int userId) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
      ...
      public void requestBroadcastInfo(
          IBinder sessionToken, BroadcastInfoRequest request, int userId) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
