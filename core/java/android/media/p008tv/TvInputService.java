...
public abstract class TvInputService extends Service {
  ...
  public final IBinder onBind(Intent intent) {
    ITvInputService.Stub tvInputServiceBinder =
        new ITvInputService.Stub() { // from class: android.media.tv.TvInputService.1
          @Override // android.media.p008tv.ITvInputService
          ...
          public void createSession(
            ...
            if (channel == null) {
              Log.m102w(TvInputService.TAG, "Creating session without input channel");
            }
            if (cb == null) {
              return;
            }
  ...
  public abstract static class Session implements KeyEvent.Callback {
    ...
    public void notifyVideoUnavailable(final int reason) {
      if (reason < 0 || reason > 18) {
        Log.m96e(TvInputService.TAG, "notifyVideoUnavailable - unknown reason: " + reason);
      }
      executeOrPostRunnableOnMainThread(
          ...
          new Runnable() { // from class: android.media.tv.TvInputService.Session.9
            ...
            public void run() {
              try {
                ...
                Log.m97e(TvInputService.TAG, "error in notifyAudioPresentationsChanged", e);
              }
            }
          });
    }
          ...
          new Runnable() { // from class: android.media.tv.TvInputService.Session.10
            ...
            public void run() {
              try {
                ...
                Log.m97e(TvInputService.TAG, "error in notifyAudioPresentationSelected", e);
              }
            }
          });
    }
    ...
    public void notifyAdBufferConsumed(AdBuffer buffer) {
      try {
        ...
        Log.m103w(TvInputService.TAG, "dup AdBuffer error in notifyAdBufferConsumed:", e);
      }
    }
    ...
    void relayoutOverlayView(Rect frame) {
      ...
      this.mWindowParams.f573x = frame.left;
      this.mWindowParams.f574y = frame.top;
    ...
    int dispatchInputEvent(InputEvent event, InputEventReceiver receiver) {
      ...
      if (event instanceof KeyEvent) {
        ...
        skipDispatchToOverlayView =
            KeyEvent.isMediaSessionKey(keyEvent.getKeyCode()) || keyEvent.getKeyCode() == 222;
  ...
  public abstract static class RecordingSession {
    ...
    public void notifyTuned(final Uri channelUri) {
      executeOrPostRunnableOnMainThread(
          new Runnable() { // from class: android.media.tv.TvInputService.RecordingSession.1
            @Override // java.lang.Runnable
            public void run() {
              try {
    ...
    public void notifyRecordingStopped(final Uri recordedProgramUri) {
      executeOrPostRunnableOnMainThread(
          new Runnable() { // from class: android.media.tv.TvInputService.RecordingSession.2
            @Override // java.lang.Runnable
            public void run() {
              try {
                if (RecordingSession.this.mSessionCallback != null) {
    ...
    public void notifyError(int error) {
      ...
      executeOrPostRunnableOnMainThread(
          new Runnable() { // from class: android.media.tv.TvInputService.RecordingSession.3
            @Override // java.lang.Runnable
            public void run() {
              try {
                if (RecordingSession.this.mSessionCallback != null) {
    ...
    public void notifySessionEvent(final String eventType, final Bundle eventArgs) {
      Preconditions.checkNotNull(eventType);
      executeOrPostRunnableOnMainThread(
          new Runnable() { // from class: android.media.tv.TvInputService.RecordingSession.4
            @Override // java.lang.Runnable
            public void run() {
              try {
                if (RecordingSession.this.mSessionCallback != null) {
  ...
  public abstract static class HardwareSession extends Session {
    ...
    public HardwareSession(Context context) {
      ...
      this.mHardwareSessionCallback =
          new TvInputManager
              .SessionCallback() { // from class: android.media.tv.TvInputService.HardwareSession.1
    ...
    public final boolean onSetSurface(Surface surface) {
      Log.m96e(TvInputService.TAG, "onSetSurface() should not be called in HardwareProxySession.");
      return false;
    }
    ...
    private void broadcastAddHardwareInput(int deviceId, TvInputInfo inputInfo) {
      ...
      for (int i = 0; i < n; i++) {
        try {
          ...
          Log.m97e(TvInputService.TAG, "error in broadcastAddHardwareInput", e);
        }
      }
    ...
    private void broadcastAddHdmiInput(int id, TvInputInfo inputInfo) {
      ...
      for (int i = 0; i < n; i++) {
        try {
          ...
          Log.m97e(TvInputService.TAG, "error in broadcastAddHdmiInput", e);
        }
      }
      TvInputService.this.mCallbacks.finishBroadcast();
    }
    ...
    private void broadcastRemoveHardwareInput(String inputId) {
      ...
      for (int i = 0; i < n; i++) {
        try {
          ...
          Log.m97e(TvInputService.TAG, "error in broadcastRemoveHardwareInput", e);
        }
      }
      TvInputService.this.mCallbacks.finishBroadcast();
    }
    ...
    public final void handleMessage(Message msg) {
      switch (msg.what) {
        case 1:
          ...
          args.recycle();
          Session sessionImpl =
              TvInputService.this.onCreateSession(inputId, sessionId, tvAppAttributionSource);
          if (sessionImpl == null) {
            try {
              cb.onSessionCreated(null, null);
              break;
            } catch (RemoteException e) {
              Log.m97e(TvInputService.TAG, "error in onSessionCreated", e);
              return;
            }
          } else {
            ITvInputSession stub =
                new ITvInputSessionWrapper(TvInputService.this, sessionImpl, channel);
            if (sessionImpl instanceof HardwareSession) {
              ...
              if (TextUtils.isEmpty(hardwareInputId)
                ...
                if (TextUtils.isEmpty(hardwareInputId)) {
                  Log.m102w(TvInputService.TAG, "Hardware input id is not setup yet.");
                } else {
                  Log.m102w(TvInputService.TAG, "Invalid hardware input id : " + hardwareInputId);
                }
                ...
                try {
                  ...
                  Log.m97e(TvInputService.TAG, "error in onSessionCreated", e2);
                  return;
                }
              } else {
                ...
                TvInputManager manager =
                    (TvInputManager) TvInputService.this.getSystemService(Context.TV_INPUT_SERVICE);
        ...
        case 2:
          ...
          try {
            ...
            Log.m97e(TvInputService.TAG, "error in onSessionCreated", e3);
          }
        ...
        case 3:
          ...
          if (recordingSessionImpl == null) {
            try {
              ...
              Log.m97e(TvInputService.TAG, "error in onSessionCreated", e4);
              return;
            }
          } else {
            try {
              cb3.onSessionCreated(
                  new ITvInputSessionWrapper(TvInputService.this, recordingSessionImpl), null);
            } catch (RemoteException e5) {
              Log.m97e(TvInputService.TAG, "error in onSessionCreated", e5);
            }
        ...
        case 8:
          ...
          break;
        default:
          Log.m102w(TvInputService.TAG, "Unhandled message code: " + msg.what);
          break;
      }
    }
  }
