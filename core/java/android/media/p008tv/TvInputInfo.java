...
public final class TvInputInfo implements Parcelable {
  ...
  public static TvInputInfo createTvInputInfo(
      ...
      throws XmlPullParserException, IOException {
    TvInputInfo info =
        new Builder(context, service).setTvInputHardwareInfo(hardwareInfo).setLabel(label).build();
    info.mIconUri = iconUri;
    return info;
  }
  ...
  public static final class Builder {
    ...
    public Builder setHdmiDeviceInfo(HdmiDeviceInfo hdmiDeviceInfo) {
      if (this.mTvInputHardwareInfo != null) {
        Log.m102w(
            TvInputInfo.TAG, "TvInputHardwareInfo will not be used to build this TvInputInfo");
    ...
    public Builder setTvInputHardwareInfo(TvInputHardwareInfo tvInputHardwareInfo) {
      if (this.mHdmiDeviceInfo != null) {
        Log.m102w(TvInputInfo.TAG, "mHdmiDeviceInfo will not be used to build this TvInputInfo");
        ...
        if (tvInputHardwareInfo != null) {
          ...
          if (this.mTvInputHardwareInfo.getType() == 9) {
            this.mHdmiDeviceInfo =
                HdmiDeviceInfo.hardwarePort(65535, this.mTvInputHardwareInfo.getHdmiPortId());
          }
        } else {
      ...
      try {
        try {
          ...
          try {
            ...
            TypedArray sa = res.obtainAttributes(attrs, C4337R.styleable.TvInputService);
