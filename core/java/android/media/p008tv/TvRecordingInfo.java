...
public final class TvRecordingInfo implements Parcelable {
  public static final Parcelable.Creator<TvRecordingInfo> CREATOR =
      new Parcelable.Creator<TvRecordingInfo>() { // from class: android.media.tv.TvRecordingInfo.1
  ...
  public void writeToParcel(Parcel dest, int flags) {
    ...
    this.mContentRatings.forEach(
        new Consumer() { // from class: android.media.tv.TvRecordingInfo$$ExternalSyntheticLambda1
  ...
  private TvRecordingInfo(Parcel in) {
    ...
    flattenedContentRatings.forEach(
        new Consumer() { // from class: android.media.tv.TvRecordingInfo$$ExternalSyntheticLambda0
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
