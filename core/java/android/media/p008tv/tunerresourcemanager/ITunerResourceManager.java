...
public interface ITunerResourceManager extends IInterface {
  public static final String DESCRIPTOR =
      "android$media$tv$tunerresourcemanager$ITunerResourceManager".replace('$', '.');
  ...
  public static class Default implements ITunerResourceManager {
    @Override // android.media.p008tv.tunerresourcemanager.ITunerResourceManager
          ...
          switch (code) {
            case 1:
              ResourceClientProfile _arg0 =
                  (ResourceClientProfile) data.readTypedObject(ResourceClientProfile.CREATOR);
            ...
            case 10:
              TunerFrontendRequest _arg010 =
                  (TunerFrontendRequest) data.readTypedObject(TunerFrontendRequest.CREATOR);
            ...
            case 16:
              TunerDescramblerRequest _arg016 =
                  (TunerDescramblerRequest) data.readTypedObject(TunerDescramblerRequest.CREATOR);
