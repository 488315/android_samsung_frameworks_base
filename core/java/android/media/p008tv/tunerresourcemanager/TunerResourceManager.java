...
import android.media.p008tv.tunerresourcemanager.IResourcesReclaimListener;
...
public class TunerResourceManager {
    ...
    class BinderC21921 extends IResourcesReclaimListener.Stub {
        final /* synthetic */ Executor val$executor;
        final /* synthetic */ ResourcesReclaimListener val$listener;

        BinderC21921(Executor executor, ResourcesReclaimListener resourcesReclaimListener) {
            this.val$executor = executor;
            this.val$listener = resourcesReclaimListener;
        }

        @Override // android.media.p008tv.tunerresourcemanager.IResourcesReclaimListener
    ...
    public void registerClientProfile(ResourceClientProfile profile, Executor executor, ResourcesReclaimListener listener, int[] clientId) {
        try {
            this.mService.registerClientProfile(profile, new BinderC21921(executor, listener), clientId);
