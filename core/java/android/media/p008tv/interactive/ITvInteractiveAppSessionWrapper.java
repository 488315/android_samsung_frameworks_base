...
public class ITvInteractiveAppSessionWrapper extends ITvInteractiveAppSession.Stub
  ...
  public void executeMessage(Message msg) {
    ...
    switch (msg.what) {
      ...
      case 47:
        ...
        break;
      default:
        Log.m102w(TAG, "Unhandled message code: " + msg.what);
        break;
    }
    ...
    if (durationMs > 1000) {
      Log.m102w(
          TAG,
          "Handling message (" + msg.what + ") took too long time (duration=" + durationMs + "ms)");
    }
  }

  @Override // android.media.p008tv.interactive.ITvInteractiveAppSession
  ...
  public void notifyTimeShiftStatusChanged(String inputId, int status) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(37, inputId, Integer.valueOf(status)));
  }
  ...
  public void notifyTimeShiftStartPositionChanged(String inputId, long timeMs) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(38, inputId, Long.valueOf(timeMs)));
  }
  ...
  public void notifyTimeShiftCurrentPositionChanged(String inputId, long timeMs) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(39, inputId, Long.valueOf(timeMs)));
  }
  ...
  public void notifyTrackSelected(int type, String trackId) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(16, Integer.valueOf(type), trackId));
  }
  ...
  public void notifyTvMessage(int type, Bundle data) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(33, Integer.valueOf(type), data));
  }
  ...
  public void notifyRecordingError(String recordingId, int err) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(44, recordingId, Integer.valueOf(err)));
  }
  ...
  public void dispatchSurfaceChanged(int format, int width, int height) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageIIII(24, format, width, height, 0));
  }
  ...
  private final class TvInteractiveAppEventReceiver extends InputEventReceiver {
    ...
    public void onInputEvent(InputEvent event) {
      ...
      int handled =
          ITvInteractiveAppSessionWrapper.this.mSessionImpl.dispatchInputEvent(event, this);
      if (handled != -1) {
