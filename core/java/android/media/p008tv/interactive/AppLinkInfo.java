...
public final class AppLinkInfo implements Parcelable {
  ...
  public AppLinkInfo(String packageName, String className, String uriString) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) className);
  ...
  public String toString() {
    return "AppLinkInfo { packageName = "
  ...
  AppLinkInfo(Parcel in) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) readFromParcel.getPackageName());
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class,
        (NonNull) null,
        (Object) this.mComponentName.getClassName());
