...
public interface ITvInteractiveAppManager extends IInterface {
  ...
  void notifyBroadcastInfoResponse(
      IBinder iBinder, BroadcastInfoResponse broadcastInfoResponse, int i) throws RemoteException;
  ...
  void unregisterCallback(ITvInteractiveAppManagerCallback iTvInteractiveAppManagerCallback, int i)
      throws RemoteException;

  public static class Default implements ITvInteractiveAppManager {
    @Override // android.media.p008tv.interactive.ITvInteractiveAppManager
    ...
    public void createBiInteractiveApp(
        IBinder sessionToken, Uri biIAppUri, Bundle params, int userId) throws RemoteException {}
    ...
    @Override // android.media.p008tv.interactive.ITvInteractiveAppManager
    public void sendTvRecordingInfo(IBinder sessionToken, TvRecordingInfo recordingInfo, int userId)
        throws RemoteException {}
    ...
    public void notifyTimeShiftStatusChanged(
        IBinder sessionToken, String inputId, int status, int userId) throws RemoteException {}

    @Override // android.media.p008tv.interactive.ITvInteractiveAppManager
    public void notifyTimeShiftStartPositionChanged(
        IBinder sessionToken, String inputId, long timeMs, int userId) throws RemoteException {}
    ...
    @Override // android.media.p008tv.interactive.ITvInteractiveAppManager
    public void notifyRecordingError(IBinder sessionToken, String recordingId, int err, int userId)
        throws RemoteException {}
    ...
    public void notifyBroadcastInfoResponse(
        IBinder sessionToken, BroadcastInfoResponse response, int UserId) throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements ITvInteractiveAppManager {
        ...
        default:
          switch (code) {
            ...
            case 48:
              ...
              BroadcastInfoResponse _arg146 =
                  (BroadcastInfoResponse) data.readTypedObject(BroadcastInfoResponse.CREATOR);
            ...
            case 53:
              ...
              return true;
            case 54:
              ITvInteractiveAppManagerCallback _arg055 =
                  ITvInteractiveAppManagerCallback.Stub.asInterface(data.readStrongBinder());
              ...
              return true;
            case 55:
              ITvInteractiveAppManagerCallback _arg056 =
                  ITvInteractiveAppManagerCallback.Stub.asInterface(data.readStrongBinder());
    ...
    private static class Proxy implements ITvInteractiveAppManager {
      ...
      public void sendTvRecordingInfo(
          IBinder sessionToken, TvRecordingInfo recordingInfo, int userId) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(ITvInteractiveAppManager.DESCRIPTOR);
      ...
      public void notifyRecordingError(
          IBinder sessionToken, String recordingId, int err, int userId) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(ITvInteractiveAppManager.DESCRIPTOR);
