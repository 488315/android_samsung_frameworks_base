...
public abstract class TvInteractiveAppService extends Service {
  ...
  public final IBinder onBind(Intent intent) {
    ITvInteractiveAppService.Stub tvIAppServiceBinder =
        new ITvInteractiveAppService
            .Stub() { // from class: android.media.tv.interactive.TvInteractiveAppService.1
          @Override // android.media.p008tv.interactive.ITvInteractiveAppService
  ...
  public abstract static class Session implements KeyEvent.Callback {
      ...
      executeOrPostRunnableOnMainThread(
          new Runnable() { // from class:
            ...
            public final void run() {
              TvInteractiveAppService.Session.this.lambda$requestStartRecording$0(
    ...
    public void requestScheduleRecording(
      ...
      executeOrPostRunnableOnMainThread(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              TvInteractiveAppService.Session.this.lambda$requestScheduleRecording$2(
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$requestScheduleRecording$2(
        String requestId, String inputId, Uri channelUri, Uri programUri, Bundle params) {
      try {
        ITvInteractiveAppSessionCallback iTvInteractiveAppSessionCallback = this.mSessionCallback;
        if (iTvInteractiveAppSessionCallback != null) {
          iTvInteractiveAppSessionCallback.onRequestScheduleRecording(
              requestId, inputId, channelUri, programUri, params);
        }
      } catch (RemoteException e) {
    ...
    public /* synthetic */ void lambda$requestScheduleRecording$3(
      ...
      try {
        ITvInteractiveAppSessionCallback iTvInteractiveAppSessionCallback = this.mSessionCallback;
        if (iTvInteractiveAppSessionCallback != null) {
          iTvInteractiveAppSessionCallback.onRequestScheduleRecording2(
              requestId, inputId, channelUri, startTime, duration, repeatDays, params);
        }
      } catch (RemoteException e) {
        Log.m103w(TvInteractiveAppService.TAG, "error in requestScheduleRecording", e);
    ...
    public void setTvRecordingInfo(final String recordingId, final TvRecordingInfo recordingInfo) {
      executeOrPostRunnableOnMainThread(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              TvInteractiveAppService.Session.this.lambda$setTvRecordingInfo$4(
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTvRecordingInfo$4(
    ...
    public void requestSigning(
        final String signingId, final String algorithm, final String alias, final byte[] data) {
      executeOrPostRunnableOnMainThread(
          new Runnable() { // from class:
    ...
    public void notifyAdBufferReady(final AdBuffer buffer) {
      try {
        ...
        Log.m103w(TvInteractiveAppService.TAG, "dup AdBuffer error in notifyAdBufferReady:", e);
      }
    }
    ...
    private void broadcastRteStateChanged(int type, int state, int error) {
      ...
      for (int i = 0; i < n; i++) {
        try {
          ...
          Log.m97e(TvInteractiveAppService.TAG, "error in broadcastRteStateChanged", e);
        }
      }
      ...
      switch (msg.what) {
        case 1:
          ...
          if (sessionImpl == null) {
            try {
              ...
              Log.m97e(TvInteractiveAppService.TAG, "error in onSessionCreated", e);
              return;
            }
          } else {
        ...
        case 2:
          ...
          try {
            ...
            Log.m97e(TvInteractiveAppService.TAG, "error in onSessionCreated", e2);
          }
        ...
        case 3:
          ...
          break;
        default:
          Log.m102w(TvInteractiveAppService.TAG, "Unhandled message code: " + msg.what);
          break;
      }
    }
  }
