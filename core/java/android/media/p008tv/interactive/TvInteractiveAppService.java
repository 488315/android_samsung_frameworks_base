...
import android.media.p008tv.interactive.ITvInteractiveAppService;
        ...
        public Void doInBackground(View... views) {
            ...
            try {
                ...
                if (!isCancelled() && mediaViewParent.isAttachedToWindow()) {
                    Log.m96e(TvInteractiveAppService.TAG, "Time out on releasing media view. Killing " + mediaViewParent.getContext().getPackageName());
