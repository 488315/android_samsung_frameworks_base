...
import android.media.p008tv.TvView;
...
public class TvInteractiveAppView extends ViewGroup {
  ...
  private final TvInteractiveAppManager.Session.FinishedInputEventCallback
  ...
  public TvInteractiveAppView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    this.mSurfaceHolderCallback =
        new SurfaceHolder
            .Callback() { // from class: android.media.tv.interactive.TvInteractiveAppView.1
          ...
          public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            ...
            tvInteractiveAppView.dispatchSurfaceChanged(
                tvInteractiveAppView.mSurfaceFormat,
                TvInteractiveAppView.this.mSurfaceWidth,
                TvInteractiveAppView.this.mSurfaceHeight);
          }
    ...
    this.mFinishedInputEventCallback =
        new TvInteractiveAppManager.Session
            .FinishedInputEventCallback() { // from class:
                                            // android.media.tv.interactive.TvInteractiveAppView.3
          ...
          public void onFinishedInputEvent(Object token, boolean handled) {
            ...
            if (!TvInteractiveAppView.this.dispatchUnhandledInputEvent(event)
                && (viewRootImpl = TvInteractiveAppView.this.getViewRootImpl()) != null) {
    ...
    if (sourceResId != 0) {
      Log.m94d(TAG, "Build local AttributeSet");
      XmlResourceParser xml = context.getResources().getXml(sourceResId);
      this.mParser = xml;
      this.mAttrs = Xml.asAttributeSet(xml);
    } else {
      Log.m94d(TAG, "Use passed in AttributeSet");
      this.mParser = null;
      this.mAttrs = attrs;
    }
    this.mDefStyleAttr = defStyleAttr;
    resetSurfaceView();
    this.mTvInteractiveAppManager =
        (TvInteractiveAppManager) getContext().getSystemService(Context.TV_INTERACTIVE_APP_SERVICE);
  }
  ...
  private void resetSurfaceView() {
    ...
    SurfaceView surfaceView2 =
        new SurfaceView(
            getContext(),
            this.mAttrs,
            this.mDefStyleAttr) { // from class: android.media.tv.interactive.TvInteractiveAppView.2
  ...
  public boolean dispatchUnhandledInputEvent(InputEvent event) {
    OnUnhandledInputEventListener onUnhandledInputEventListener =
        this.mOnUnhandledInputEventListener;
    if (onUnhandledInputEventListener != null
        && onUnhandledInputEventListener.onUnhandledInputEvent(event)) {
      return true;
    }
  ...
  public void setOnUnhandledInputEventListener(
      Executor executor, OnUnhandledInputEventListener listener) {
  ...
  public abstract static class TvInteractiveAppCallback {
    ...
    public void onTimeShiftCommandRequest(
        String iAppServiceId, String cmdType, Bundle parameters) {}
    ...
    public void onRequestSigning(
        String iAppServiceId, String signingId, String algorithm, String alias, byte[] data) {}

    public void onSetTvRecordingInfo(
        String iAppServiceId, String recordingId, TvRecordingInfo recordingInfo) {}
  ...
  class MySessionCallback extends TvInteractiveAppManager.SessionCallback {
    ...
    public void onSessionCreated(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onSessionCreated - session already created");
        if (session != null) {
          session.release();
          return;
        }
      ...
      if (session != null) {
        if (TvInteractiveAppView.this.mSurface != null) {
          ...
          if (TvInteractiveAppView.this.mSurfaceChanged) {
            ...
            tvInteractiveAppView2.dispatchSurfaceChanged(
                tvInteractiveAppView2.mSurfaceFormat,
                TvInteractiveAppView.this.mSurfaceWidth,
                TvInteractiveAppView.this.mSurfaceHeight);
          }
        }
    ...
    public void onSessionReleased(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onSessionReleased - session not created");
        return;
      }
    ...
    public void onLayoutSurface(
        TvInteractiveAppManager.Session session, int left, int top, int right, int bottom) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onLayoutSurface - session not created");
        return;
      }
    ...
    public void onCommandRequest(
        TvInteractiveAppManager.Session session, final String cmdType, final Bundle parameters) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onCommandRequest - session not created");
        return;
      }
        ...
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                  TvInteractiveAppView.MySessionCallback.this.lambda$onCommandRequest$0(
                      cmdType, parameters);
                }
              });
        }
    ...
    public /* synthetic */ void lambda$onCommandRequest$0(String cmdType, Bundle parameters) {
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallback != null) {
          TvInteractiveAppView.this.mCallback.onPlaybackCommandRequest(
              this.mIAppServiceId, cmdType, parameters);
        }
      }
    }
    ...
    public void onTimeShiftCommandRequest(
        TvInteractiveAppManager.Session session, final String cmdType, final Bundle parameters) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onTimeShiftCommandRequest - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                  TvInteractiveAppView.MySessionCallback.this.lambda$onTimeShiftCommandRequest$1(
                      cmdType, parameters);
                }
              });
        }
    ...
    public /* synthetic */ void lambda$onTimeShiftCommandRequest$1(
      ...
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallback != null) {
          TvInteractiveAppView.this.mCallback.onTimeShiftCommandRequest(
              this.mIAppServiceId, cmdType, parameters);
        }
      }
    }
    ...
    public void onSessionStateChanged(
        TvInteractiveAppManager.Session session, final int state, final int err) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onSessionStateChanged - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                  TvInteractiveAppView.MySessionCallback.this.lambda$onSessionStateChanged$2(
                      state, err);
                }
              });
        }
    ...
    public void onBiInteractiveAppCreated(
        TvInteractiveAppManager.Session session, final Uri biIAppUri, final String biIAppId) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onBiInteractiveAppCreated - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                  TvInteractiveAppView.MySessionCallback.this.lambda$onBiInteractiveAppCreated$3(
                      biIAppUri, biIAppId);
                }
              });
        }
    ...
    public /* synthetic */ void lambda$onBiInteractiveAppCreated$3(Uri biIAppUri, String biIAppId) {
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallback != null) {
          TvInteractiveAppView.this.mCallback.onBiInteractiveAppCreated(
              this.mIAppServiceId, biIAppUri, biIAppId);
        }
      }
    }
    ...
    public void onTeletextAppStateChanged(TvInteractiveAppManager.Session session, int state) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onTeletextAppStateChanged - session not created");
    ...
    public void onSetVideoBounds(TvInteractiveAppManager.Session session, final Rect rect) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onSetVideoBounds - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void onRequestCurrentVideoBounds(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestCurrentVideoBounds - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                  TvInteractiveAppView.MySessionCallback.this
                      .lambda$onRequestCurrentVideoBounds$5();
                }
              });
        }
      }
    ...
    public void onRequestCurrentChannelUri(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestCurrentChannelUri - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void onRequestCurrentChannelLcn(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestCurrentChannelLcn - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void onRequestStreamVolume(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestStreamVolume - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void onRequestTrackInfoList(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestTrackInfoList - session not created");
        return;
      }
      synchronized (TvInteractiveAppView.this.mCallbackLock) {
        if (TvInteractiveAppView.this.mCallbackExecutor != null) {
          TvInteractiveAppView.this.mCallbackExecutor.execute(
              new Runnable() { // from class:
                               // android.media.tv.interactive.TvInteractiveAppView$MySessionCallback$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void onRequestCurrentTvInputId(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestCurrentTvInputId - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
    ...
    public void onRequestTimeShiftMode(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestTimeShiftMode - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
    ...
    public void onRequestAvailableSpeeds(TvInteractiveAppManager.Session session) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestAvailableSpeeds - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
    ...
    public void onRequestStartRecording(
        TvInteractiveAppManager.Session session, String requestId, Uri programUri) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestStartRecording - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
        TvInteractiveAppView.this.mCallback.onRequestStartRecording(
            this.mIAppServiceId, requestId, programUri);
      }
    }

    @Override // android.media.tv.interactive.TvInteractiveAppManager.SessionCallback
    public void onRequestStopRecording(
        TvInteractiveAppManager.Session session, String recordingId) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestStopRecording - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
        TvInteractiveAppView.this.mCallback.onRequestStopRecording(
            this.mIAppServiceId, recordingId);
      }
    }
    ...
    public void onSetTvRecordingInfo(
      ...
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onSetRecordingInfo - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
        TvInteractiveAppView.this.mCallback.onSetTvRecordingInfo(
            this.mIAppServiceId, recordingId, recordingInfo);
      }
    }
    ...
    public void onRequestScheduleRecording(
        ...
        Bundle params) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestScheduleRecording - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
        TvInteractiveAppView.this.mCallback.onRequestScheduleRecording(
            this.mIAppServiceId, requestId, inputId, channelUri, programUri, params);
      }
    }
    ...
    public void onRequestTvRecordingInfo(
        TvInteractiveAppManager.Session session, String recordingId) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestRecordingInfo - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
        TvInteractiveAppView.this.mCallback.onRequestTvRecordingInfo(
            this.mIAppServiceId, recordingId);
      }
    }
    ...
    public void onRequestTvRecordingInfoList(TvInteractiveAppManager.Session session, int type) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestRecordingInfoList - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
    ...
    public void onRequestSigning(
        ...
        byte[] data) {
      if (this != TvInteractiveAppView.this.mSessionCallback) {
        Log.m102w(TvInteractiveAppView.TAG, "onRequestSigning - session not created");
      } else if (TvInteractiveAppView.this.mCallback != null) {
        TvInteractiveAppView.this.mCallback.onRequestSigning(
            this.mIAppServiceId, id, algorithm, alias, data);
      }
    }
  }
}
