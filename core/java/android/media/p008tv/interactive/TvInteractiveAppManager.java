...
import android.media.p008tv.interactive.ITvInteractiveAppClient;
import android.media.p008tv.interactive.ITvInteractiveAppManagerCallback;
    ...
    public static final class Session {
        ...
        private int sendInputEventOnMainLooperLocked(PendingEvent p) {
            ...
            if (inputChannel != null) {
                ...
                Log.m102w(TvInteractiveAppManager.TAG, "Unable to send input event to session: " + this.mToken + " dropping:" + event);
                return 0;
            }
            return 0;
        }
        ...
        void finishedInputEvent(int seq, boolean handled, boolean timeout) {
            synchronized (this.mHandler) {
                ...
                if (timeout) {
                    Log.m102w(TvInteractiveAppManager.TAG, "Timeout waiting for session to handle input event after 2500 ms: " + this.mToken);
                } else {
