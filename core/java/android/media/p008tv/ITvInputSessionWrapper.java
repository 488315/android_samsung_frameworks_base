...
public class ITvInputSessionWrapper extends ITvInputSession.Stub implements HandlerCaller.Callback {
      ...
      if (msg.what == 6 && durationMs > 2000) {
        throw new RuntimeException(
            "Too much time to handle tune request. ("
                + durationMs
                + "ms > 2000ms) Consider handling the tune request in a separate thread.");
      }
      if (durationMs > 5000) {
        throw new RuntimeException(
  ...
  @Override // android.media.p008tv.ITvInputSession
  public void release() {
    if (!this.mIsRecordingSession) {
  ...
  public void dispatchSurfaceChanged(int format, int width, int height) {
    ...
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageIIII(4, format, width, height, 0));
  }
  ...
  public void selectTrack(int type, String trackId) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(8, Integer.valueOf(type), trackId));
  }
  ...
  public void notifyTvMessage(int type, Bundle data) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(32, Integer.valueOf(type), data));
  }
  ...
  public void setTvMessageEnabled(int type, boolean enabled) {
    HandlerCaller handlerCaller = this.mCaller;
    handlerCaller.executeOrSendMessage(
        handlerCaller.obtainMessageOO(31, Integer.valueOf(type), Boolean.valueOf(enabled)));
  }
