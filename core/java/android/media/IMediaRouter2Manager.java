...
public interface IMediaRouter2Manager extends IInterface {
  ...
  void notifyRouteListingPreferenceChange(String str, RouteListingPreference routeListingPreference)
  ...
  public static class Default implements IMediaRouter2Manager {
    ...
    public void notifyDiscoveryPreferenceChanged(
        String packageName, RouteDiscoveryPreference discoveryPreference) throws RemoteException {}

    @Override // android.media.IMediaRouter2Manager
    public void notifyRouteListingPreferenceChange(
        String packageName, RouteListingPreference routeListingPreference) throws RemoteException {}
