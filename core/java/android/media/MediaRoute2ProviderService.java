...
public abstract class MediaRoute2ProviderService extends Service {
  ...
  public final void notifySessionCreated(long requestId, RoutingSessionInfo sessionInfo) {
    ...
    if (requestId != 0 && !removeRequestId(requestId)) {
      Log.m102w(TAG, "notifySessionCreated: The requestId doesn't exist. requestId=" + requestId);
      return;
    }
    String sessionId = sessionInfo.getId();
    synchronized (this.mSessionLock) {
      if (this.mSessionInfos.containsKey(sessionId)) {
        Log.m102w(TAG, "notifySessionCreated: Ignoring duplicate session id.");
        return;
      }
      ...
      try {
        ...
        Log.m102w(TAG, "Failed to notify session created.");
      }
    }
  }
  ...
  public final void notifySessionUpdated(RoutingSessionInfo sessionInfo) {
    Objects.requireNonNull(sessionInfo, "sessionInfo must not be null");
    if (DEBUG) {
      Log.m94d(TAG, "notifySessionUpdated: Updating session id=" + sessionInfo);
    }
    String sessionId = sessionInfo.getId();
    synchronized (this.mSessionLock) {
      if (this.mSessionInfos.containsKey(sessionId)) {
        ...
        Log.m102w(TAG, "notifySessionUpdated: Ignoring unknown session info.");
      }
    }
  }
  ...
  public final void notifySessionReleased(String sessionId) {
    ...
    if (DEBUG) {
      Log.m94d(TAG, "notifySessionReleased: Releasing session id=" + sessionId);
    }
    synchronized (this.mSessionLock) {
      RoutingSessionInfo sessionInfo = this.mSessionInfos.remove(sessionId);
      if (sessionInfo == null) {
        Log.m102w(TAG, "notifySessionReleased: Ignoring unknown session info.");
        return;
      }
      IMediaRoute2ProviderServiceCallback iMediaRoute2ProviderServiceCallback =
          this.mRemoteCallback;
  ...
  public final void notifyRequestFailed(long requestId, int reason) {
    ...
    if (!removeRequestId(requestId)) {
      Log.m102w(TAG, "notifyRequestFailed: The requestId doesn't exist. requestId=" + requestId);
      return;
    }
    try {
      this.mRemoteCallback.notifyRequestFailed(requestId, reason);
    } catch (RemoteException e) {
      Log.m102w(TAG, "Failed to notify that the request has failed.");
    }
  }
  ...
  public void publishState() {
    ...
    if (!this.mStatePublishScheduled.compareAndSet(true, false)
        || (iMediaRoute2ProviderServiceCallback = this.mRemoteCallback) == null) {
      return;
    }
    try {
  ...
  public void updateSessions() {
    ...
    try {
      ...
      Log.m102w(TAG, "Failed to notify session info changed.");
    }
  }
  ...
  final class MediaRoute2ProviderServiceStub extends IMediaRoute2ProviderService.Stub {
    ...
    private boolean checkSessionIdIsValid(String sessionId, String description) {
      ...
      if (MediaRoute2ProviderService.this.getSessionInfo(sessionId) == null) {
        Log.m102w(
            MediaRoute2ProviderService.TAG,
            description + ": Ignoring unknown session from system service. sessionId=" + sessionId);
        return false;
      }
      return true;
    }
    ...
    private boolean checkRouteIdIsValid(String routeId, String description) {
      ...
      if (MediaRoute2ProviderService.this.mProviderInfo == null
        ...
        Log.m102w(
            MediaRoute2ProviderService.TAG,
            description + ": Ignoring unknown route from system service. routeId=" + routeId);
        return false;
      }
      return true;
    }
              ...
              new BiConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2) {
                  ((MediaRoute2ProviderService) obj)
                      .setCallback((IMediaRoute2ProviderServiceCallback) obj2);
                }
              },
      ...
      MediaRoute2ProviderService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2) {
                  ((MediaRoute2ProviderService) obj)
                      .onDiscoveryPreferenceChanged((RouteDiscoveryPreference) obj2);
                }
              },
              MediaRoute2ProviderService.this,
              discoveryPreference));
          ...
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((MediaRoute2ProviderService) obj)
                      .onSetRouteVolume(
                          ((Long) obj2).longValue(), (String) obj3, ((Integer) obj4).intValue());
                }
              },
              MediaRoute2ProviderService.this,
          ...
          PooledLambda.obtainMessage(
              new QuintConsumer() { // from class:
                ...
                public final void accept(
                  ...
                  ((MediaRoute2ProviderService) obj)
                      .onCreateSession(
                          ((Long) obj2).longValue(), (String) obj3, (String) obj4, (Bundle) obj5);
                }
              },
              MediaRoute2ProviderService.this,
              Long.valueOf(requestId),
      ...
      MediaRoute2ProviderService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((MediaRoute2ProviderService) obj)
                      .onSelectRoute(((Long) obj2).longValue(), (String) obj3, (String) obj4);
                }
              },
              MediaRoute2ProviderService.this,
              Long.valueOf(requestId),
      ...
      MediaRoute2ProviderService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((MediaRoute2ProviderService) obj)
                      .onDeselectRoute(((Long) obj2).longValue(), (String) obj3, (String) obj4);
                }
              },
              MediaRoute2ProviderService.this,
              Long.valueOf(requestId),
      ...
      MediaRoute2ProviderService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((MediaRoute2ProviderService) obj)
                      .onTransferToRoute(((Long) obj2).longValue(), (String) obj3, (String) obj4);
                }
              },
              MediaRoute2ProviderService.this,
              Long.valueOf(requestId),
          ...
          PooledLambda.obtainMessage(
              new TriConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((MediaRoute2ProviderService) obj)
                      .onReleaseSession(((Long) obj2).longValue(), (String) obj3);
                }
              },
              MediaRoute2ProviderService.this,
              Long.valueOf(requestId),
