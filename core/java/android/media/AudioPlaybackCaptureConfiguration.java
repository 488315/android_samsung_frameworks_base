...
public final class AudioPlaybackCaptureConfiguration {
    ...
    private AudioPlaybackCaptureConfiguration(
            AudioMixingRule audioMixingRule, MediaProjection projection) {
    ...
    public int[] getMatchingUsages() {
        return getIntPredicates(
                1,
                new ToIntFunction() { // from class:
                    // android.media.AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda2
    ...
    public int[] getMatchingUids() {
        return getIntPredicates(
                4,
                new ToIntFunction() { // from class:
                    // android.media.AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda1
                    @Override // java.util.function.ToIntFunction
                    public final int applyAsInt(Object obj) {
                        int intProp;
    ...
    public int[] getExcludeUsages() {
        return getIntPredicates(
                32769,
                new ToIntFunction() { // from class:
                    // android.media.AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda4
                    @Override // java.util.function.ToIntFunction
                    public final int applyAsInt(Object obj) {
                        int usage;
                        usage =
    ...
    public int[] getExcludeUids() {
        return getIntPredicates(
                32772,
                new ToIntFunction() { // from class:
                    // android.media.AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda3
                    @Override // java.util.function.ToIntFunction
                    public final int applyAsInt(Object obj) {
                        int intProp;
                        intProp = ((AudioMixingRule.AudioMixMatchCriterion) obj).getIntProp();
    ...
    private int[] getIntPredicates(
            final int rule, ToIntFunction<AudioMixingRule.AudioMixMatchCriterion> getPredicate) {
        return this.mAudioMixingRule.getCriteria().stream()
                .filter(
                        new Predicate() { // from class:
                            // android.media.AudioPlaybackCaptureConfiguration$$ExternalSyntheticLambda0
                            @Override // java.util.function.Predicate
                            public final boolean test(Object obj) {
                                return AudioPlaybackCaptureConfiguration.lambda$getIntPredicates$4(
                                        rule, (AudioMixingRule.AudioMixMatchCriterion) obj);
                            }
                        })
    ...
    static /* synthetic */ boolean lambda$getIntPredicates$4(
            int rule, AudioMixingRule.AudioMixMatchCriterion criterion) {
        return criterion.getRule() == rule;
    }

    android.media.audiopolicy.AudioMix createAudioMix(AudioFormat audioFormat) {
        return new AudioMix.Builder(this.mAudioMixingRule)
    ...
    public static final class Builder {
        ...
        public Builder(MediaProjection projection) {
            ...
            try {
                Preconditions.checkArgument(
                        projection.getProjection().canProjectAudio(),
        ...
        public Builder addMatchingUsage(int usage) {
            ...
            this.mAudioMixingRuleBuilder.addRule(
                    new AudioAttributes.Builder().setUsage(usage).build(), 1);
        ...
        public Builder excludeUsage(int usage) {
            ...
            this.mAudioMixingRuleBuilder.excludeRule(
                    new AudioAttributes.Builder().setUsage(usage).build(), 1);
        ...
        public AudioPlaybackCaptureConfiguration build() {
            return new AudioPlaybackCaptureConfiguration(
                    this.mAudioMixingRuleBuilder.build(), this.mProjection);
        }
    }
}
