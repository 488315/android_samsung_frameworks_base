...
public class RemoteControlClient {
      ...
      new MediaSession.Callback() { // from class: android.media.RemoteControlClient.1
        ...
        public void onSetRating(Rating rating) {
          if ((RemoteControlClient.this.mTransportControlFlags & 512) != 0) {
            RemoteControlClient remoteControlClient = RemoteControlClient.this;
            remoteControlClient.onUpdateMetadata(
                remoteControlClient.mCurrentClientGenId, 268435457, rating);
          }
        }
      };
    ...
    */
    ...
    public synchronized void apply() {
      /*
          ...
          android.util.Log.m96e(r0, r1)     // Catch: java.lang.Throwable -> L8d
          monitor-exit(r5)
          return
      Le:
          android.media.RemoteControlClient r0 = android.media.RemoteControlClient.this     // Catch: java.lang.Throwable -> L8d
          java.lang.Object r0 = android.media.RemoteControlClient.m2934$$Nest$fgetmCacheLock(r0)     // Catch: java.lang.Throwable -> L8d
          ...
          android.media.RemoteControlClient.m2942$$Nest$fputmMetadata(r1, r2)     // Catch: java.lang.Throwable -> L88
          android.media.RemoteControlClient r1 = android.media.RemoteControlClient.this     // Catch: java.lang.Throwable -> L88
          android.os.Bundle r1 = android.media.RemoteControlClient.m2937$$Nest$fgetmMetadata(r1)     // Catch: java.lang.Throwable -> L88
          ...
          android.media.RemoteControlClient r1 = android.media.RemoteControlClient.this     // Catch: java.lang.Throwable -> L88
          android.graphics.Bitmap r1 = android.media.RemoteControlClient.m2938$$Nest$fgetmOriginalArtwork(r1)     // Catch: java.lang.Throwable -> L88
          if (r1 == 0) goto L52
          android.media.RemoteControlClient r1 = android.media.RemoteControlClient.this     // Catch: java.lang.Throwable -> L8b
          android.graphics.Bitmap r1 = android.media.RemoteControlClient.m2938$$Nest$fgetmOriginalArtwork(r1)     // Catch: java.lang.Throwable -> L8b
      ...
      L52:
          ...
          android.media.RemoteControlClient.m2943$$Nest$fputmOriginalArtwork(r1, r2)     // Catch: java.lang.Throwable -> L88
          r1 = 0
          r5.mEditorArtwork = r1     // Catch: java.lang.Throwable -> L88
          android.media.RemoteControlClient r1 = android.media.RemoteControlClient.this     // Catch: java.lang.Throwable -> L88
          android.media.session.MediaSession r1 = android.media.RemoteControlClient.m2939$$Nest$fgetmSession(r1)     // Catch: java.lang.Throwable -> L88
          if (r1 == 0) goto L82
          ...
          android.media.RemoteControlClient.m2941$$Nest$fputmMediaMetadata(r1, r2)     // Catch: java.lang.Throwable -> L8b
          android.media.RemoteControlClient r1 = android.media.RemoteControlClient.this     // Catch: java.lang.Throwable -> L8b
          android.media.session.MediaSession r1 = android.media.RemoteControlClient.m2939$$Nest$fgetmSession(r1)     // Catch: java.lang.Throwable -> L8b
          android.media.RemoteControlClient r2 = android.media.RemoteControlClient.this     // Catch: java.lang.Throwable -> L8b
          android.media.MediaMetadata r2 = android.media.RemoteControlClient.m2936$$Nest$fgetmMediaMetadata(r2)     // Catch: java.lang.Throwable -> L8b
      ...
      */
      throw new UnsupportedOperationException(
          "Method not decompiled: android.media.RemoteControlClient.MetadataEditor.apply():void");
    }
  }
  ...
  public void onSeekTo(int generationId, long timeMs) {
    ...
    synchronized (this.mCacheLock) {
      if (this.mCurrentClientGenId == generationId
          && (onPlaybackPositionUpdateListener = this.mPositionUpdateListener) != null) {
  ...
  public void onUpdateMetadata(int generationId, int key, Object value) {
    ...
    synchronized (this.mCacheLock) {
      if (this.mCurrentClientGenId == generationId
          && (onMetadataUpdateListener = this.mMetadataUpdateListener) != null) {
