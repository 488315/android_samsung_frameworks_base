...
public final class MediaCodec {
          ...
          while (true) {
            ...
            if (mediaTimeUs != null && systemNano != null && onFrameRenderedListener != null) {
              onFrameRenderedListener.onFrameRendered(
                  this.mCodec, ((Long) mediaTimeUs).longValue(), ((Long) systemNano).longValue());
              i++;
            } else {
              return;
            }
          ...
          synchronized (MediaCodec.this.mBufferLock) {
            switch (MediaCodec.this.mBufferMode) {
              case 0:
                ...
                mediaCodec2.validateOutputByteBufferLocked(
                    mediaCodec2.mCachedOutputBuffers, index2, info);
                break;
              case 1:
  ...
  public final void queueInputBuffer(
      int index, int offset, int size, long presentationTimeUs, int flags) throws CryptoException {
    ...
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "queueInputBuffer() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please use"
                + " getQueueRequest() to queue buffers");
      }
  ...
  public static final class CryptoInfo {
    ...
    public String toString() {
      ...
      int i2 = 0;
      while (true) {
        byte[] bArr2 = this.f282iv;
        if (i2 < bArr2.length) {
          builder.append("0123456789abcdef".charAt((bArr2[i2] & 240) >> 4));
          builder.append("0123456789abcdef".charAt(this.f282iv[i2] & 15));
          i2++;
        } else {
  ...
  public final void queueSecureInputBuffer(
    ...
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "queueSecureInputBuffer() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please"
                + " use getQueueRequest() to queue buffers");
      }
      invalidateByteBufferLocked(this.mCachedInputBuffers, index, true);
      this.mDequeuedInputBuffers.remove(index);
    }
  ...
  public final int dequeueInputBuffer(long timeoutUs) {
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "dequeueInputBuffer() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please use"
                + " MediaCodec.Callback objectes to get input buffer slots.");
      }
    }
  ...
  public final int dequeueOutputBuffer(BufferInfo info, long timeoutUs) {
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "dequeueOutputBuffer() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please"
                + " use MediaCodec.Callback objects to get output buffer slots.");
      }
    }
  ...
  public ByteBuffer[] getInputBuffers() {
    ...
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "getInputBuffers() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please obtain"
                + " MediaCodec.LinearBlock or HardwareBuffer objects and attach to QueueRequest"
                + " objects.");
      }
  ...
  public ByteBuffer[] getOutputBuffers() {
    ...
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "getOutputBuffers() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please use"
                + " getOutputFrame to get output frames.");
      }
  ...
  public ByteBuffer getInputBuffer(int index) {
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "getInputBuffer() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please obtain"
                + " MediaCodec.LinearBlock or HardwareBuffer objects and attach to QueueRequest"
                + " objects.");
      }
    }
  ...
  public Image getInputImage(int index) {
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "getInputImage() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please obtain"
                + " MediaCodec.LinearBlock or HardwareBuffer objects and attach to QueueRequest"
                + " objects.");
      }
    }
  ...
  public ByteBuffer getOutputBuffer(int index) {
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "getOutputBuffer() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please use"
                + " getOutputFrame() to get output frames.");
      }
    }
  ...
  public Image getOutputImage(int index) {
    synchronized (this.mBufferLock) {
      if (this.mBufferMode == 1) {
        throw new IncompatibleWithBlockModelException(
            "getOutputImage() is not compatible with CONFIGURE_FLAG_USE_BLOCK_MODEL. Please use"
                + " getOutputFrame() to get output frames.");
      }
    }
      ...
      if (info.remaining() == 104) {
        ...
        if (bitDepthAllocated == 8 || bitDepthAllocated == 16) {
          ...
          while (ix < numPlanes) {
            ...
            throw new UnsupportedOperationException(
                "unexpected subsampling: " + horiz + "x" + vert + " on plane " + ix);
          }
          if (this.mFormat == 54) {
            ...
            if (this.mPlanes[1].getPixelStride() != pixelStride
                || this.mPlanes[2].getPixelStride() != pixelStride) {
