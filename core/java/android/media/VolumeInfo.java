  ...
  public static VolumeInfo getDefaultVolumeInfo() {
    ...
    if (sDefaultVolumeInfo == null) {
      try {
        ...
        Log.m97e(TAG, "Error calling getDefaultVolumeInfo", e);
      ...
      if (i2 != -100) {
        ...
        if (i3 != -100 && i2 < i3) {
          throw new IllegalArgumentException(
              "Volume index:" + this.mVolIndex + " lower than min index:" + this.mMinVolIndex);
        }
        int i4 = this.mMaxVolIndex;
        if (i4 != -100 && i2 > i4) {
          throw new IllegalArgumentException(
              "Volume index:" + this.mVolIndex + " greater than max index:" + this.mMaxVolIndex);
        }
      }
