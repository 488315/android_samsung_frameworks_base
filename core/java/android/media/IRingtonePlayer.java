...
public interface IRingtonePlayer extends IInterface {
  ...
  void playAsync(Uri uri, UserHandle userHandle, boolean z, AudioAttributes audioAttributes)
      throws RemoteException;
          ...
          switch (code) {
            ...
            case 12:
              INotificationPlayerOnCompletionListener _arg011 =
                  INotificationPlayerOnCompletionListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
