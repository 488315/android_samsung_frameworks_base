...
public interface IMidiManager extends IInterface {
  ...
  public static class Default implements IMidiManager {
    ...
    public void openBluetoothDevice(
        IBinder clientToken, BluetoothDevice bluetoothDevice, IMidiDeviceOpenCallback callback)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 8:
              ...
              MidiDeviceInfo _result3 =
                  registerDeviceServer(_arg07, _arg16, _arg23, _arg3, _arg4, _arg5, _arg6, _arg7);
              reply.writeNoException();
