...
public final class MidiDevice implements Closeable {
        ...
        public void close() throws IOException {
            synchronized (this.mGuard) {
                ...
                try {
                    ...
                    Log.m96e(MidiDevice.TAG, "RemoteException in MidiConnection.close");
                }
                this.mIsClosed = true;
            }
        }
    ...
    public MidiInputPort openInputPort(int portNumber) {
        ...
        try {
            ...
            Log.m96e(TAG, "RemoteException in openInputPort");
            return null;
        }
    }
    ...
    public MidiOutputPort openOutputPort(int portNumber) {
        ...
        try {
            ...
            Log.m96e(TAG, "RemoteException in openOutputPort");
            return null;
        }
    }
    ...
    public MidiConnection connectPorts(MidiInputPort inputPort, int outputPortNumber) {
        ...
        try {
            ...
            Log.m96e(TAG, "RemoteException in connectPorts");
            return null;
        }
    }
    ...
    public void close() throws IOException {
        synchronized (this.mGuard) {
            if (this.mNativeHandle != 0) {
                Log.m102w(TAG, "MidiDevice#close() called while there is an outstanding native client 0x" + Long.toHexString(this.mNativeHandle));
            }
            if (!this.mIsDeviceClosed && this.mNativeHandle == 0) {
                ...
                try {
                    ...
                    Log.m96e(TAG, "RemoteException in closeDevice");
                }
            }
        }
    }
