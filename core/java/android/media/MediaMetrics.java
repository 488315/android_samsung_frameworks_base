...
public class MediaMetrics {
  ...
  public static class Value {
    ...
    /* renamed from: NO */
    public static final String f283NO = "no";
    public static final String OFF = "off";

    /* renamed from: ON */
    public static final String f284ON = "on";
    public static final String UNMUTE = "unmute";

    /* renamed from: UP */
    public static final String f285UP = "up";
  ...
  public static class Item {
      ...
      if (version == 0) {
        if (headerRead != headerSize) {
          throw new IllegalArgumentException(
              "Item key:" + key + " headerRead:" + headerRead + " != headerSize:" + headerSize);
        }
      } else {
        if (headerRead > headerSize) {
          throw new IllegalArgumentException(
        ...
        switch (type) {
          ...
          default:
            ...
            if (version != 0) {
              ...
              throw new IllegalArgumentException(
                  "Property " + propKey + " has unsupported type " + ((int) type));
            }
        }
    ...
    private int reserveProperty(byte[] keyBytes, int payloadSize) {
      ...
      if (keyLength > 65535) {
        throw new IllegalStateException(
            "property key too long " + new String(keyBytes, MediaMetrics.MEDIAMETRICS_CHARSET));
      }
    ...
    private static String getStringFromBuffer(ByteBuffer buffer, int size) {
      ...
      throw new IllegalArgumentException(
          "No zero termination found in string position: " + buffer.position() + " end: " + i);
    }

    private void updateHeader() {
      ByteBuffer byteBuffer = this.mBuffer;
      byteBuffer
          .putInt(0, byteBuffer.position())
