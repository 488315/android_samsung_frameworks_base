...
public final class Rating implements Parcelable {
  ...
  public String toString() {
    StringBuilder append =
        new StringBuilder().append("Rating:style=").append(this.mRatingStyle).append(" rating=");
  ...
  public static Rating newStarRating(int starRatingStyle, float starRating) {
    ...
    switch (starRatingStyle) {
      ...
      case 5:
        ...
        break;
      default:
        Log.m96e(TAG, "Invalid rating style (" + starRatingStyle + ") for a star rating");
        return null;
    }
    if (starRating >= 0.0f && starRating <= maxRating) {
      return new Rating(starRatingStyle, starRating);
    }
    Log.m96e(TAG, "Trying to set out of range star-based rating");
    return null;
  }
  ...
  public static Rating newPercentageRating(float percent) {
    ...
    Log.m96e(TAG, "Invalid percentage-based rating value");
    return null;
  }
