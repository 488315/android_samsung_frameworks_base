...
public final class NetworkEvent extends Event implements Parcelable {
  public static final Parcelable.Creator<NetworkEvent> CREATOR =
      new Parcelable.Creator<NetworkEvent>() { // from class: android.media.metrics.NetworkEvent.1
  ...
  public static final class Builder {
    ...
    public NetworkEvent build() {
      NetworkEvent o =
          new NetworkEvent(this.mNetworkType, this.mTimeSinceCreatedMillis, this.mMetricsBundle);
      return o;
    }
  }
}
