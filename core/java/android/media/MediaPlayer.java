...
public class MediaPlayer extends PlayerBase
  ...
  private MediaPlayer(Context context, int sessionId) {
    ...
    this.mIntSubtitleDataListener =
        new OnSubtitleDataListener() { // from class: android.media.MediaPlayer.3
    ...
    this.mOnCompletionInternalListener =
        new OnCompletionListener() { // from class: android.media.MediaPlayer.7
    ...
    AttributionSource attributionSource =
        context == null ? AttributionSource.myAttributionSource() : context.getAttributionSource();
    AttributionSource.ScopedParcelState attributionSourceState =
        (attributionSource.getPackageName() == null
                ? attributionSource.withPackageName("")
                : attributionSource)
            .asScopedParcelState();
    try {
      native_setup(
  ...
  public void setSurface(Surface surface) {
    if (this.mScreenOnWhilePlaying && surface != null) {
      Log.m102w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
    }
  ...
  public static MediaPlayer create(
    ...
    try {
      ...
      AudioAttributes aa =
          audioAttributes != null ? audioAttributes : new AudioAttributes.Builder().build();
      ...
      Log.m95d(TAG, "create failed:", ex);
      return null;
    } catch (IllegalArgumentException ex2) {
      Log.m95d(TAG, "create failed:", ex2);
      return null;
    } catch (SecurityException ex3) {
      Log.m95d(TAG, "create failed:", ex3);
      return null;
    }
  }
    ...
    try {
      try {
        try {
          ...
          Log.m95d(TAG, "create failed:", ex4);
          if (afd != null) {
            afd.close();
          }
          return null;
        ...
        if (afd != null) {
          try {
            ...
            Log.m95d(TAG, "create failed:", ex5);
          }
        }
      }
    } catch (IOException ex6) {
      Log.m95d(TAG, "create failed:", ex6);
    }
  }
  ...
  public void setDataSource(
    ...
    if (cookies != null
      ...
      throw new IllegalArgumentException(
          "The cookie handler has to be of CookieManager type when cookies are provided.");
    }
  ...
  private void setDataSource(String path, String[] keys, String[] values, List<HttpCookie> cookies)
    ...
    if ("file".equals(scheme)) {
      ...
      nativeSetDataSource(
          MediaHTTPService.createHttpServiceBinderIfNecessary(path, cookies), path, keys, values);
      return;
    }
  ...
  public void prepare() throws IOException, IllegalStateException {
    ...
    try {
      ...
      if (retCode != 0) {
        Log.m102w(TAG, "prepare(): could not set piid " + this.mPlayerIId);
      }
      piidParcel.recycle();
  ...
  public void prepareAsync() throws IllegalStateException {
    ...
    try {
      ...
      if (retCode != 0) {
        Log.m102w(TAG, "prepareAsync(): could not set piid " + this.mPlayerIId);
      }
    } finally {
      piidParcel.recycle();
    }
    ...
    if (this.mRoutingChangeListeners.size() == 0 && !this.mEnableSelfRoutingMonitor) {
      try {
        ...
        if (Log.isLoggable(TAG, 3)) {
          Log.m95d(TAG, "testEnableNativeRoutingCallbacks failed", e);
          return false;
        }
        return false;
      }
        ...
        if (!this.mRoutingChangeListeners.containsKey(listener)) {
          ...
          this.mRoutingChangeListeners.put(
              ...
              new NativeRoutingEventHandlerDelegate(
                  this, listener, handler != null ? handler : this.mEventHandler));
        }
      }
    }
  }
  ...
  public void setWakeMode(Context context, int mode) {
    ...
    if (SystemProperties.getBoolean("audio.offload.ignore_setawake", false)) {
      Log.m102w(TAG, "IGNORING setWakeMode " + mode);
      return;
    }
    ...
    PowerManager.WakeLock newWakeLock =
        pm.newWakeLock(536870912 | mode, MediaPlayer.class.getName());
  ...
  public void setScreenOnWhilePlaying(boolean screenOn) {
    if (this.mScreenOnWhilePlaying != screenOn) {
      if (screenOn && this.mSurfaceHolder == null) {
        Log.m102w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
      }
  ...
  public void seekTo(long msec, int mode) {
    ...
    if (msec > 2147483647L) {
      Log.m102w(TAG, "seekTo offset " + msec + " is too large, cap to 2147483647");
      msec = 2147483647L;
    } else if (msec < -2147483648L) {
      Log.m102w(TAG, "seekTo offset " + msec + " is too small, cap to -2147483648");
      msec = -2147483648L;
    }
    _seekTo(msec, mode);
  }
  ...
  public MediaTimestamp getTimestamp() {
    try {
      return new MediaTimestamp(
          ...
          System.nanoTime(),
          isPlaying() ? getPlaybackParams().getSpeed() : 0.0f);
    } catch (IllegalStateException e) {
      return null;
    }
  }
  ...
  public void setAudioAttributes(AudioAttributes attributes) throws IllegalArgumentException {
    ...
    if (attributes.getUsage() == 4) {
      ...
      if (AsPackageName.CELL_RECEIVER.equals(opPackageName)
          || "com.android.cellbroadcastreceiver".equals(opPackageName)) {
        attributes = new AudioAttributes.Builder(attributes).addTag(AudioTag.AUDIO_NO_FADE).build();
        Log.m94d(TAG, "attributes, add nofade tag");
      }
    }
  ...
  public static class TrackInfo implements Parcelable {
    static final Parcelable.Creator<TrackInfo> CREATOR =
        new Parcelable.Creator<TrackInfo>() { // from class: android.media.MediaPlayer.TrackInfo.1
    ...
    public boolean hasHapticChannels() {
      ...
      return mediaFormat != null
          && mediaFormat.containsKey(MediaFormat.KEY_HAPTIC_CHANNEL_COUNT)
          && this.mFormat.getInteger(MediaFormat.KEY_HAPTIC_CHANNEL_COUNT) > 0;
    }
  ...
  private synchronized void setSubtitleAnchor() {
    if (this.mSubtitleController == null && ActivityThread.currentApplication() != null) {
      ...
      handler.post(
          new Runnable() { // from class: android.media.MediaPlayer.2
            @Override // java.lang.Runnable
            public void run() {
              Context context = ActivityThread.currentApplication();
              MediaPlayer.this.mSubtitleController =
                  new SubtitleController(context, timeProvider, MediaPlayer.this);
              MediaPlayer.this.mSubtitleController.setAnchor(
                  new SubtitleController.Anchor() { // from class: android.media.MediaPlayer.2.1
      ...
      try {
        ...
        Log.m102w(TAG, "failed to join SetSubtitleAnchorThread");
      }
    }
  }
  ...
  public void addSubtitleSource(final InputStream is, final MediaFormat format)
    ...
    if (is != null) {
      ...
      Log.m102w(TAG, "addSubtitleSource called with null InputStream");
    }
    ...
    Handler handler = new Handler(thread.getLooper());
    handler.post(
        new Runnable() { // from class: android.media.MediaPlayer.4
          private int addTrack() {
            SubtitleTrack track;
            if (is == null
                || MediaPlayer.this.mSubtitleController == null
                || (track = MediaPlayer.this.mSubtitleController.addTrack(format)) == null) {
              return 901;
            }
            try {
              int availableSize = is.available();
              if (availableSize > 20971520) {
                Log.m96e(MediaPlayer.TAG, "addTrack() unsupported size : " + availableSize);
                return 901;
              }
              ...
              try {
                try {
                  ...
                  Log.m97e(MediaPlayer.TAG, e.getMessage(), e);
                  synchronized (MediaPlayer.this.mOpenSubtitleSources) {
                    MediaPlayer.this.mOpenSubtitleSources.remove(is);
                    if (scanner != null) {
                      scanner.close();
              ...
              Log.m97e(MediaPlayer.TAG, e2.getMessage(), e2);
              return 901;
            }
          }
    ...
    synchronized (this.mIndexTrackPairs) {
      for (int i = 0; i < tracks.length; i++) {
        if (!this.mInbandTrackIndices.get(i)) {
          ...
          if (tracks[i] == null) {
            Log.m102w(TAG, "unexpected NULL track at index " + i);
          }
  ...
  public void addTimedTextSource(Context context, Uri uri, String mimeType)
    ...
    try {
      try {
        ...
        Log.m95d(TAG, "addTimedTextSource IOException happend : ", ex);
        if (fd == null) {
          return;
        }
        fd.close();
      } catch (SecurityException ex2) {
        Log.m95d(TAG, "addTimedTextSource SecurityException happend : ", ex2);
        if (fd == null) {
          return;
        }
        fd.close();
  ...
  public void addTimedTextSource(
      FileDescriptor fd, final long offset, final long length, String mime)
      throws IllegalArgumentException, IllegalStateException {
    ...
    try {
      ...
      Handler handler = new Handler(thread.getLooper());
      handler.post(
          new Runnable() { // from class: android.media.MediaPlayer.5
            private int addTrack() {
              ...
              try {
                ...
                Log.m97e(MediaPlayer.TAG, e3.getMessage(), e3);
                try {
                  Os.close(dupedFd);
                  return 900;
                } catch (ErrnoException e4) {
                  Log.m97e(MediaPlayer.TAG, e4.getMessage(), e4);
                  return 900;
                }
              }
            }
  ...
  public int getSelectedTrack(int trackType) throws IllegalStateException {
    ...
    SubtitleController subtitleController = this.mSubtitleController;
    if (subtitleController != null
        && ((trackType == 4 || trackType == 3)
            && (subtitleTrack = subtitleController.getSelectedTrack()) != null)) {
      synchronized (this.mIndexTrackPairs) {
        for (int i = 0; i < this.mIndexTrackPairs.size(); i++) {
          if (this.mIndexTrackPairs.get(i).second == subtitleTrack
              && subtitleTrack.getTrackType() == trackType) {
            return i;
          }
        }
      }
    ...
    try {
      ...
      if (!select) {
        if (subtitleController.getSelectedTrack() == track) {
          ...
          Log.m102w(TAG, "trying to deselect track that was not selected");
          return;
        }
      }
  ...
  class EventHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      if (this.mMediaPlayer.mNativeContext == 0) {
        Log.m102w(MediaPlayer.TAG, "mediaplayer went away with unhandled events");
        return;
      }
      switch (msg.what) {
        case 0:
        ...
        case 3:
          OnBufferingUpdateListener onBufferingUpdateListener =
              MediaPlayer.this.mOnBufferingUpdateListener;
        ...
        case 5:
          OnVideoSizeChangedListener onVideoSizeChangedListener =
              MediaPlayer.this.mOnVideoSizeChangedListener;
        ...
        case 7:
          try {
            ...
            Log.m95d(MediaPlayer.TAG, "handleMessage MEDIA_STARTED or MEDIA_PAUSED e : ", e2);
            return;
          }
        case 8:
          try {
            ...
            Log.m95d(MediaPlayer.TAG, "handleMessage MEDIA_STOPPED e : ", e3);
            return;
          }
        case 9:
          break;
        ...
        case 100:
          Log.m96e(
              MediaPlayer.TAG,
              "Error (" + msg.arg1 + "," + msg.arg2 + NavigationBarInflaterView.KEY_CODE_END);
          boolean error_was_handled = false;
          OnErrorListener onErrorListener = MediaPlayer.this.mOnErrorListener;
          if (onErrorListener != null) {
            if ((msg.arg2 == -49 || msg.arg2 == -60 || msg.arg2 == -61 || msg.arg2 == -64)
                && MediaPlayer.this.mOnPlayReadyErrorListener != null) {
              if (msg.obj != null) {
                Log.m96e(
                    MediaPlayer.TAG,
                    "PlayReadyAcquistion Failed \n sending onPlayReadyError " + ((String) msg.obj));
                error_was_handled =
                    MediaPlayer.this.mOnPlayReadyErrorListener.onPlayReadyError(
                        this.mMediaPlayer, msg.arg1, msg.arg2, (String) msg.obj);
              } else {
                Log.m96e(
                    MediaPlayer.TAG, "PlayReadyAcquistion Failed \n sending onPlayReadyError NULL");
                error_was_handled = onErrorListener.onError(this.mMediaPlayer, msg.arg1, msg.arg2);
              }
            } else if (msg.arg2 == 300) {
              Log.m96e(
                  MediaPlayer.TAG,
                  "License Not Found, propagate error to MoviePlaybackService.java");
              error_was_handled =
                  MediaPlayer.this.mOnErrorListener.onError(this.mMediaPlayer, msg.arg1, msg.arg2);
            } else {
              try {
                if (MediaPlayer.this.mOnErrorListener != null) {
                  error_was_handled =
                      MediaPlayer.this.mOnErrorListener.onError(
                          this.mMediaPlayer, msg.arg1, msg.arg2);
                } else {
                  Log.m96e(MediaPlayer.TAG, "error listener is null ");
                }
              } catch (NullPointerException e4) {
                Log.m95d(MediaPlayer.TAG, "handleMessage e : ", e4);
              }
            }
          }
          MediaPlayer.this.mOnCompletionInternalListener.onCompletion(this.mMediaPlayer);
        ...
        case 200:
          switch (msg.arg1) {
            case 700:
              Log.m98i(
                  MediaPlayer.TAG,
                  "Info (" + msg.arg1 + "," + msg.arg2 + NavigationBarInflaterView.KEY_CODE_END);
              break;
            case 701:
            case 702:
        ...
        case 201:
          synchronized (this) {
            ...
            final OnSubtitleDataListener extSubtitleListener =
                MediaPlayer.this.mExtSubtitleDataListener;
            ...
            if (msg.obj instanceof Parcel) {
              ...
              if (extSubtitleListener != null) {
                if (extSubtitleHandler != null) {
                  extSubtitleHandler.post(
                      new Runnable() { // from class: android.media.MediaPlayer.EventHandler.1
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        case 202:
          OnTimedMetaDataAvailableListener onTimedMetaDataAvailableListener =
              MediaPlayer.this.mOnTimedMetaDataAvailableListener;
        ...
        case 210:
          Log.m100v(
              MediaPlayer.TAG, "MEDIA_DRM_INFO " + MediaPlayer.this.mOnDrmInfoHandlerDelegate);
          if (msg.obj == null) {
            Log.m102w(MediaPlayer.TAG, "MEDIA_DRM_INFO msg.obj=NULL");
            return;
          }
          if (msg.obj instanceof Parcel) {
            DrmInfo drmInfo = null;
            synchronized (MediaPlayer.this.mDrmLock) {
              if (MediaPlayer.this.mOnDrmInfoHandlerDelegate != null
                  && MediaPlayer.this.mDrmInfo != null) {
          ...
          Log.m102w(MediaPlayer.TAG, "MEDIA_DRM_INFO msg.obj of unexpected type " + msg.obj);
          return;
        case 211:
          synchronized (this) {
          ...
          if (mediaTimeListener != null && (msg.obj instanceof Parcel)) {
            ...
            if (mediaTimeHandler != null) {
              mediaTimeHandler.post(
                  new Runnable() { // from class: android.media.MediaPlayer.EventHandler.2
                    @Override // java.lang.Runnable
                    public void run() {
                      mediaTimeListener.onMediaTimeDiscontinuity(
                          EventHandler.this.mMediaPlayer, timestamp);
                    }
                  });
              return;
            } else {
        ...
        case 300:
          ...
          if (rtpRxNoticeListener != null && (msg.obj instanceof Parcel)) {
            ...
            try {
              ...
              parcel5.recycle();
              MediaPlayer.this.mOnRtpRxNoticeExecutor.execute(
                  new Runnable() { // from class:
                                   // android.media.MediaPlayer$EventHandler$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                      MediaPlayer.EventHandler.this.lambda$handleMessage$0(
                          rtpRxNoticeListener, noticeType, data3);
                    }
                  });
              return;
            } catch (Throwable th) {
        ...
        case 10000:
          ...
          return;
        default:
          Log.m96e(MediaPlayer.TAG, "Unknown message type " + msg.what);
          return;
      }
      try {
        ...
        Log.m95d(MediaPlayer.TAG, "handleMessage MEDIA_SKIPPED e : ", e6);
      }
    }
  ...
  private static void postEventFromNative(
      Object mediaplayer_ref, int what, int arg1, int arg2, Object obj) {
    ...
    switch (what) {
      ...
      case 200:
        if (arg1 == 2) {
          new Thread(
                  new Runnable() { // from class: android.media.MediaPlayer.6
                    @Override // java.lang.Runnable
                    public void run() {
                      try {
        ...
        break;
      case 210:
        Log.m100v(TAG, "postEventFromNative MEDIA_DRM_INFO");
        if (obj instanceof Parcel) {
          ...
          Log.m102w(TAG, "MEDIA_DRM_INFO msg.obj of unexpected type " + obj);
          break;
        }
    }
  ...
  public void setOnMediaTimeDiscontinuityListener(
      OnMediaTimeDiscontinuityListener listener, Handler handler) {
    if (listener == null) {
      throw new IllegalArgumentException("Illegal null listener");
    }
    if (handler == null) {
  ...
  public void setOnRtpRxNoticeListener(
      Context context, Executor executor, OnRtpRxNoticeListener listener) {
    Objects.requireNonNull(context);
    Preconditions.checkArgument(
        context.checkSelfPermission(Manifest.permission.BIND_IMS_SERVICE) == 0,
  ...
  public void setOnDrmPreparedListener(OnDrmPreparedListener listener, Handler handler) {
    synchronized (this.mDrmLock) {
      if (listener != null) {
        this.mOnDrmPreparedHandlerDelegate =
            new OnDrmPreparedHandlerDelegate(this, listener, handler);
      } else {
        this.mOnDrmPreparedHandlerDelegate = null;
      }
    }
  ...
  private class OnDrmInfoHandlerDelegate {
    ...
    void notifyClient(final DrmInfo drmInfo) {
      ...
      if (handler != null) {
        handler.post(
            new Runnable() { // from class: android.media.MediaPlayer.OnDrmInfoHandlerDelegate.1
              @Override // java.lang.Runnable
              public void run() {
                OnDrmInfoHandlerDelegate.this.mOnDrmInfoListener.onDrmInfo(
                    OnDrmInfoHandlerDelegate.this.mMediaPlayer, drmInfo);
              }
            });
      } else {
  ...
  private class OnDrmPreparedHandlerDelegate {
    ...
    OnDrmPreparedHandlerDelegate(MediaPlayer mp, OnDrmPreparedListener listener, Handler handler) {
      ...
      if (handler != null) {
        ...
        Log.m96e(MediaPlayer.TAG, "OnDrmPreparedHandlerDelegate: Unexpected null mEventHandler");
      }
    }
    ...
    void notifyClient(final int status) {
      ...
      if (handler != null) {
        handler.post(
            new Runnable() { // from class: android.media.MediaPlayer.OnDrmPreparedHandlerDelegate.1
              @Override // java.lang.Runnable
              public void run() {
                OnDrmPreparedHandlerDelegate.this.mOnDrmPreparedListener.onDrmPrepared(
                    OnDrmPreparedHandlerDelegate.this.mMediaPlayer, status);
              }
            });
      } else {
        Log.m96e(
            MediaPlayer.TAG, "OnDrmPreparedHandlerDelegate:notifyClient: Unexpected null mHandler");
      }
    }
  }
  ...
  public DrmInfo getDrmInfo() {
    ...
    synchronized (this.mDrmLock) {
      if (!this.mDrmInfoResolved && this.mDrmInfo == null) {
        Log.m100v(TAG, "The Player has not been prepared yet");
  ...
  public void prepareDrm(UUID uuid)
    ...
    Log.m100v(TAG, "prepareDrm: uuid: " + uuid + " mOnDrmConfigHelper: " + this.mOnDrmConfigHelper);
    boolean allDoneWithoutProvisioning = false;
    synchronized (this.mDrmLock) {
      if (this.mDrmInfo == null) {
        Log.m96e(
            TAG,
            "prepareDrm(): Wrong usage: The player must be prepared and DRM info be retrieved"
                + " before this call.");
      ...
      if (this.mActiveDrmScheme) {
        String msg =
            "prepareDrm(): Wrong usage: There is already an active DRM scheme with "
                + this.mDrmUUID;
        Log.m96e(TAG, msg);
        throw new IllegalStateException(msg);
      }
      if (this.mPrepareDrmInProgress) {
        Log.m96e(TAG, "prepareDrm(): Wrong usage: There is already a pending prepareDrm call.");
        throw new IllegalStateException(
            "prepareDrm(): Wrong usage: There is already a pending prepareDrm call.");
      }
      if (this.mDrmProvisioningInProgress) {
        Log.m96e(TAG, "prepareDrm(): Unexpectd: Provisioning is already in progress.");
        throw new IllegalStateException(
            "prepareDrm(): Unexpectd: Provisioning is already in progress.");
      }
      cleanDrmObj();
    ...
    synchronized (this.mDrmLock) {
      ...
      try {
        try {
          ...
          Log.m102w(TAG, "prepareDrm: NotProvisionedException");
          ...
          switch (result) {
            case 1:
              Log.m96e(
                  TAG, "prepareDrm: Provisioning was required but failed due to a network error.");
              throw new ProvisioningNetworkErrorException(
                  "prepareDrm: Provisioning was required but failed due to a network error.");
            case 2:
              Log.m96e(
                  TAG,
                  "prepareDrm: Provisioning was required but the request was denied by the"
                      + " server.");
              throw new ProvisioningServerErrorException(
                  "prepareDrm: Provisioning was required but the request was denied by the"
                      + " server.");
            default:
              Log.m96e(TAG, "prepareDrm: Post-provisioning preparation failed.");
        ...
        Log.m96e(
            TAG,
            "prepareDrm(): Wrong usage: The player must be in the prepared state to call"
                + " prepareDrm().");
        throw new IllegalStateException(
            "prepareDrm(): Wrong usage: The player must be in the prepared state to call"
                + " prepareDrm().");
      } catch (Exception e4) {
        Log.m96e(TAG, "prepareDrm: Exception " + e4);
        throw e4;
      }
    }
  ...
  public void releaseDrm() throws NoDrmSchemeException {
    Log.m100v(TAG, "releaseDrm:");
    synchronized (this.mDrmLock) {
      if (!this.mActiveDrmScheme) {
        Log.m96e(TAG, "releaseDrm(): No active DRM scheme to release.");
      ...
      try {
        ...
        Log.m97e(TAG, "releaseDrm: Exception ", e2);
      }
    }
  }
  ...
  public MediaDrm.KeyRequest getKeyRequest(
    ...
    Log.m100v(
        TAG,
        "getKeyRequest:  keySetId: "
            + Arrays.toString(keySetId)
            + " initData:"
    ...
    synchronized (this.mDrmLock) {
      if (!this.mActiveDrmScheme) {
        Log.m96e(TAG, "getKeyRequest NoDrmSchemeException");
      ...
      if (keyType != 3) {
        try {
          try {
            ...
            Log.m102w(TAG, "getKeyRequest Exception " + e);
            throw e;
          }
        } catch (NotProvisionedException e2) {
          Log.m102w(
              TAG,
              "getKeyRequest NotProvisionedException: Unexpected. Shouldn't have reached here.");
      ...
      request =
          this.mDrmObj.getKeyRequest(scope, initData, mimeType, keyType, hmapOptionalParameters);
      Log.m100v(TAG, "getKeyRequest:   --> request: " + request);
    }
    return request;
  }
      ...
      if (keySetId == null) {
        try {
          try {
            ...
            Log.m102w(TAG, "provideKeyResponse Exception " + e);
            throw e;
          }
        } catch (NotProvisionedException e2) {
          Log.m102w(
              TAG,
              "provideKeyResponse NotProvisionedException: Unexpected. Shouldn't have reached"
                  + " here.");
  ...
  public void restoreKeys(byte[] keySetId) throws NoDrmSchemeException {
    Log.m100v(TAG, "restoreKeys: keySetId: " + Arrays.toString(keySetId));
    synchronized (this.mDrmLock) {
      if (!this.mActiveDrmScheme) {
        Log.m102w(TAG, "restoreKeys NoDrmSchemeException");
      ...
      try {
        ...
        Log.m102w(TAG, "restoreKeys Exception " + e);
        throw e;
      }
    }
  }
  ...
  public String getDrmPropertyString(String propertyName) throws NoDrmSchemeException {
    String value;
    Log.m100v(TAG, "getDrmPropertyString: propertyName: " + propertyName);
    synchronized (this.mDrmLock) {
      if (!this.mActiveDrmScheme && !this.mDrmConfigAllowed) {
        Log.m102w(TAG, "getDrmPropertyString NoDrmSchemeException");
      ...
      try {
        ...
        Log.m102w(TAG, "getDrmPropertyString Exception " + e);
        throw e;
      }
    }
    Log.m100v(TAG, "getDrmPropertyString: propertyName: " + propertyName + " --> value: " + value);
    return value;
  }

  public void setDrmPropertyString(String propertyName, String value) throws NoDrmSchemeException {
    Log.m100v(TAG, "setDrmPropertyString: propertyName: " + propertyName + " value: " + value);
    synchronized (this.mDrmLock) {
      if (!this.mActiveDrmScheme && !this.mDrmConfigAllowed) {
        Log.m102w(TAG, "setDrmPropertyString NoDrmSchemeException");
      ...
      try {
        ...
        Log.m102w(TAG, "setDrmPropertyString Exception " + e);
        throw e;
      }
    }
  }
  ...
  public static final class DrmInfo {
    ...
    private DrmInfo(Parcel parcel) {
      Log.m100v(MediaPlayer.TAG, "DrmInfo(" + parcel + ") size " + parcel.dataSize());
      int psshsize = parcel.readInt();
      byte[] pssh = new byte[psshsize];
      parcel.readByteArray(pssh);
      Log.m100v(MediaPlayer.TAG, "DrmInfo() PSSH: " + arrToHex(pssh));
      this.mapPssh = parsePSSH(pssh, psshsize);
      Log.m100v(MediaPlayer.TAG, "DrmInfo() PSSH: " + this.mapPssh);
      ...
      for (int i = 0; i < supportedDRMsCount; i++) {
        ...
        Log.m100v(
            MediaPlayer.TAG, "DrmInfo() supportedScheme[" + i + "]: " + this.supportedSchemes[i]);
      }
      Log.m100v(
          MediaPlayer.TAG,
          "DrmInfo() Parcel psshsize: " + psshsize + " supportedDRMsCount: " + supportedDRMsCount);
    }
      ...
      while (len > 0) {
        if (len < 16) {
          Log.m102w(
              MediaPlayer.TAG,
              String.format(
                  "parsePSSH: len is too short to parse UUID: (%d < 16) pssh: %d",
                  Integer.valueOf(len), Integer.valueOf(psshsize)));
          return null;
        }
        ...
        if (len2 < 4) {
          Log.m102w(
              MediaPlayer.TAG,
              String.format(
                  "parsePSSH: len is too short to parse datalen: (%d < 4) pssh: %d",
                  Integer.valueOf(len2), Integer.valueOf(psshsize)));
          return null;
        }
        ...
        if (len3 < datalen) {
          Log.m102w(
              MediaPlayer.TAG,
              String.format(
                  "parsePSSH: len is too short to parse data: (%d < %d) pssh: %d",
                  Integer.valueOf(len3), Integer.valueOf(datalen), Integer.valueOf(psshsize)));
          return null;
        }
        ...
        Log.m100v(
            MediaPlayer.TAG,
            String.format(
                "parsePSSH[%d]: <%s, %s> pssh: %d",
                Integer.valueOf(numentries), uuid, arrToHex(data), Integer.valueOf(psshsize)));
        numentries++;
  ...
  private void prepareDrm_createDrmStep(UUID uuid) throws UnsupportedSchemeException {
    Log.m100v(TAG, "prepareDrm_createDrmStep: UUID: " + uuid);
    try {
      this.mDrmObj = new MediaDrm(uuid);
      Log.m100v(TAG, "prepareDrm_createDrmStep: Created mDrmObj=" + this.mDrmObj);
    } catch (Exception e) {
      Log.m96e(TAG, "prepareDrm_createDrmStep: MediaDrm failed with " + e);
      throw e;
    }
  }
  ...
  private void prepareDrm_openSessionStep(UUID uuid)
    ...
    Log.m100v(TAG, "prepareDrm_openSessionStep: uuid: " + uuid);
    try {
      this.mDrmSessionId = this.mDrmObj.openSession();
      Log.m100v(
          TAG, "prepareDrm_openSessionStep: mDrmSessionId=" + Arrays.toString(this.mDrmSessionId));
      _prepareDrm(getByteArrayFromUUID(uuid), this.mDrmSessionId);
      Log.m100v(TAG, "prepareDrm_openSessionStep: _prepareDrm/Crypto succeeded");
    } catch (Exception e) {
      Log.m96e(TAG, "prepareDrm_openSessionStep: open/crypto failed with " + e);
      throw e;
    }
  }
  ...
  private class ProvisioningThread extends Thread {
    ...
    public ProvisioningThread initialize(
        MediaDrm.ProvisionRequest request, UUID uuid, MediaPlayer mediaPlayer) {
      ...
      this.uuid = uuid;
      this.status = 3;
      Log.m100v(MediaPlayer.TAG, "HandleProvisioninig: Thread is initialised url: " + this.urlStr);
      return this;
    }
    ...
    public void run() {
      ...
      try {
        ...
        this.status = 1;
        Log.m102w(MediaPlayer.TAG, "HandleProvisioninig: Thread run: openConnection " + e);
      }
      try {
        try {
          ...
          Log.m100v(
              MediaPlayer.TAG,
              "HandleProvisioninig: Thread run: response "
                  + response.length
                  + " "
                  + Arrays.toString(response));
        } catch (Exception e2) {
          this.status = 1;
          Log.m102w(
              MediaPlayer.TAG, "HandleProvisioninig: Thread run: connect " + e2 + " url: " + url);
        }
        ...
        if (response != null) {
          try {
            ...
            Log.m100v(
                MediaPlayer.TAG,
                "HandleProvisioninig: Thread run: provideProvisionResponse SUCCEEDED!");
            provisioningSucceeded = true;
          } catch (Exception e3) {
            this.status = 2;
            Log.m102w(
                MediaPlayer.TAG, "HandleProvisioninig: Thread run: provideProvisionResponse " + e3);
          }
        }
  ...
  private int HandleProvisioninig(UUID uuid) {
    if (this.mDrmProvisioningInProgress) {
      Log.m96e(TAG, "HandleProvisioninig: Unexpected mDrmProvisioningInProgress");
      return 3;
    }
    MediaDrm.ProvisionRequest provReq = this.mDrmObj.getProvisionRequest();
    if (provReq == null) {
      Log.m96e(TAG, "HandleProvisioninig: getProvisionRequest returned null.");
      return 3;
    }
    Log.m100v(
        TAG,
        "HandleProvisioninig provReq  data: "
            + Arrays.toString(provReq.getData())
            + " url: "
            + provReq.getDefaultUrl());
    ...
    try {
      ...
      Log.m102w(TAG, "HandleProvisioninig: Thread.join Exception " + e);
    }
  ...
  public boolean resumePrepareDrm(UUID uuid) {
    Log.m100v(TAG, "resumePrepareDrm: uuid: " + uuid);
    try {
      prepareDrm_openSessionStep(uuid);
      this.mDrmUUID = uuid;
      this.mActiveDrmScheme = true;
      ...
      Log.m102w(TAG, "HandleProvisioninig: Thread run _prepareDrm resume failed with " + e);
      return false;
    }
  }
  ...
  private void resetDrmState() {
    synchronized (this.mDrmLock) {
      Log.m100v(
          TAG,
          "resetDrmState:  mDrmInfo="
              + this.mDrmInfo
              + " mDrmProvisioningThread="
              + this.mDrmProvisioningThread
              + " mPrepareDrmInProgress="
              + this.mPrepareDrmInProgress
              + " mActiveDrmScheme="
              + this.mActiveDrmScheme);
      ...
      if (provisioningThread != null) {
        try {
          ...
          Log.m102w(TAG, "resetDrmState: ProvThread.join Exception " + e);
        }
        this.mDrmProvisioningThread = null;
      }
      this.mPrepareDrmInProgress = false;
  ...
  static class TimeProvider implements OnSeekCompleteListener, MediaTimeProvider {
    ...
    private void scheduleNotification(int type, long delayUs) {
      ...
      if (this.DEBUG) {
        Log.m100v(TAG, "scheduleNotification " + type + " in " + delayUs);
      }
    ...
    public void onBuffering(boolean buffering) {
      synchronized (this) {
        if (this.DEBUG) {
          Log.m94d(TAG, "onBuffering: " + buffering);
        }
    ...
    public synchronized void notifySeek() {
      ...
      try {
        ...
        if (this.DEBUG) {
          Log.m94d(TAG, "onSeekComplete at " + timeUs);
        }
        ...
        if (this.DEBUG) {
          Log.m94d(TAG, "onSeekComplete but no player");
        }
        this.mPausing = true;
    ...
    private int registerListener(MediaTimeProvider.OnMediaTimeListener listener) {
      ...
      while (true) {
        ...
        if (i >= onMediaTimeListenerArr.length
            || (onMediaTimeListener = onMediaTimeListenerArr[i]) == listener
            || onMediaTimeListener == null) {
          break;
        }
        i++;
      }
      ...
      synchronized (this) {
        ...
        while (true) {
          ...
          if (onMediaTimeListener == listener) {
            System.arraycopy(
                onMediaTimeListenerArr,
                i + 1,
                onMediaTimeListenerArr,
                i,
                (onMediaTimeListenerArr.length - i) - 1);
            long[] jArr = this.mTimes;
    ...
    public synchronized void notifyTimedEvent(boolean refreshTime) {
      ...
      while (true) {
        ...
        if (j > -1) {
          if (j <= 1000 + nowUs) {
            ...
            if (this.DEBUG) {
              Log.m94d(TAG, Environment.MEDIA_REMOVED);
            }
            this.mTimes[ix] = -1;
      ...
      if (nextTimeUs > nowUs && !this.mPaused) {
        if (this.DEBUG) {
          Log.m94d(TAG, "scheduling for " + nextTimeUs + " and " + nowUs);
        }
      ...
      synchronized (this) {
        ...
        try {
          ...
          if (this.mPlayer.isPlaying() && !this.mBuffering) {
            ...
            this.mPaused = z;
            if (this.DEBUG) {
              Log.m100v(TAG, (this.mPaused ? "paused" : "playing") + " at " + this.mLastTimeUs);
            }
            if (monotonic) {
          ...
          this.mPaused = true;
          if (this.DEBUG) {
            Log.m94d(TAG, "illegal state, but pausing: estimating at " + this.mLastReportedTime);
          }
          return this.mLastReportedTime;
        }
      }
  ...
  private String convertStartingPathToSystem(String path) {
    if (path != null && path.startsWith("/product/media/audio/ui/")) {
      ...
      Log.m96e(TAG, "convert starting path: " + path2);
      return path2;
    }
    return path;
  }
