...
public class AsyncPlayer {
  ...
  public void startSound(Command cmd) {
    try {
      ...
      if (delay > 1000) {
        Log.m102w(this.mTag, "Notification sound delayed by " + delay + "msecs");
      }
    } catch (Exception e) {
        ...
        switch (cmd.code) {
          ...
          case 2:
            if (AsyncPlayer.this.mPlayer != null) {
              long delay = SystemClock.uptimeMillis() - cmd.requestTime;
              if (delay > 1000) {
                Log.m102w(AsyncPlayer.this.mTag, "Notification stop delayed by " + delay + "msecs");
              }
              ...
              Log.m102w(AsyncPlayer.this.mTag, "STOP command without a player");
              break;
            }
        }
        synchronized (AsyncPlayer.this.mCmdQueue) {
  ...
  public void play(Context context, Uri uri, boolean looping, int stream) {
    ...
    try {
      ...
      Log.m97e(this.mTag, "Call to deprecated AsyncPlayer.play() method caused:", e);
    }
  }
