...
public class AccessibilityServiceInfo implements Parcelable {
    ...
    */
    public AccessibilityServiceInfo(ResolveInfo resolveInfo, Context context) throws XmlPullParserException, IOException {
        ...
        this.mComponentName = new ComponentName(serviceInfo2.packageName, serviceInfo2.name);
        this.mResolveInfo = resolveInfo;
        XmlResourceParser parser = null;
        try {
            PackageManager packageManager = context.getPackageManager();
            long startTime = SystemClock.elapsedRealtime();
            parser = serviceInfo2.loadXmlMetaData(packageManager, AccessibilityService.SERVICE_META_DATA);
            long elapsedTime = SystemClock.elapsedRealtime() - startTime;
            if (elapsedTime > 100) {
                try {
                    Log.m98i("AccessibilityServiceInfo", "took more than 100ms mComponentName : " + this.mComponentName + ", elapsedTime : " + elapsedTime);
            ...
            try {
                ...
                Resources resources = packageManager.getResourcesForApplication(serviceInfo2.applicationInfo);
                TypedArray asAttributes = resources.obtainAttributes(allAttributes, C4337R.styleable.AccessibilityService);
    ...
    private static SparseArray<CapabilityInfo> getCapabilityInfoSparseArray(Context context) {
        if (sAvailableCapabilityInfos == null) {
            ...
            sparseArray.put(1, new CapabilityInfo(1, C4337R.string.capability_title_canRetrieveWindowContent, C4337R.string.capability_desc_canRetrieveWindowContent));
            sAvailableCapabilityInfos.put(2, new CapabilityInfo(2, C4337R.string.capability_title_canRequestTouchExploration, C4337R.string.capability_desc_canRequestTouchExploration));
            sAvailableCapabilityInfos.put(8, new CapabilityInfo(8, C4337R.string.capability_title_canRequestFilterKeyEvents, C4337R.string.capability_desc_canRequestFilterKeyEvents));
            sAvailableCapabilityInfos.put(16, new CapabilityInfo(16, C4337R.string.capability_title_canControlMagnification, C4337R.string.capability_desc_canControlMagnification));
            sAvailableCapabilityInfos.put(32, new CapabilityInfo(32, C4337R.string.capability_title_canPerformGestures, C4337R.string.capability_desc_canPerformGestures));
            sAvailableCapabilityInfos.put(128, new CapabilityInfo(128, C4337R.string.capability_title_canTakeScreenshot, C4337R.string.capability_desc_canTakeScreenshot));
            if (context == null || fingerprintAvailable(context)) {
                sAvailableCapabilityInfos.put(64, new CapabilityInfo(64, C4337R.string.capability_title_canCaptureFingerprintGestures, C4337R.string.capability_desc_canCaptureFingerprintGestures));
            }
        }
