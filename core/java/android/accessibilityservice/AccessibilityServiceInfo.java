...
public class AccessibilityServiceInfo implements Parcelable {
  ...
  public static final Parcelable.Creator<AccessibilityServiceInfo> CREATOR =
      new Parcelable.Creator<
          AccessibilityServiceInfo>() { // from class:
  ...
  */
    ...
    try {
          ...
          try {
            try {
              throw new XmlPullParserException(
                  "Unable to create context for: " + serviceInfo.packageName);
            } catch (Throwable th) {
              e = th;
              if (parser != null) {
                parser.close();
      ...
      try {
        if (!TAG_ACCESSIBILITY_SERVICE.equals(nodeName)) {
          throw new XmlPullParserException(
              "Meta-data does not start withaccessibility-service tag");
        }
        AttributeSet allAttributes = Xml.asAttributeSet(parser);
        Resources resources =
            packageManager.getResourcesForApplication(serviceInfo2.applicationInfo);
        TypedArray asAttributes =
            resources.obtainAttributes(allAttributes, C4337R.styleable.AccessibilityService);
    ...
    if (platformCompat != null) {
      try {
        return platformCompat.isChangeEnabled(
            REQUEST_ACCESSIBILITY_BUTTON_CHANGE, resolveInfo.serviceInfo.applicationInfo);
  ...
  public String loadDescription(PackageManager packageManager) {
    ...
    CharSequence description =
        packageManager.getText(
            serviceInfo.packageName, this.mDescriptionResId, serviceInfo.applicationInfo);
    if (description != null) {
  ...
  public String loadHtmlDescription(PackageManager packageManager) {
    ...
    CharSequence htmlDescription =
        packageManager.getText(
            serviceInfo.packageName, this.mHtmlDescriptionRes, serviceInfo.applicationInfo);
  ...
  public void initFromParcel(Parcel parcel) {
    ...
    this.mComponentName =
        (ComponentName) parcel.readParcelable(getClass().getClassLoader(), ComponentName.class);
  ...
  private static SparseArray<CapabilityInfo> getCapabilityInfoSparseArray(Context context) {
    if (sAvailableCapabilityInfos == null) {
      ...
      sparseArray.put(
          ...
          new CapabilityInfo(
              1,
              C4337R.string.capability_title_canRetrieveWindowContent,
              C4337R.string.capability_desc_canRetrieveWindowContent));
      sAvailableCapabilityInfos.put(
          2,
          new CapabilityInfo(
              2,
              C4337R.string.capability_title_canRequestTouchExploration,
              C4337R.string.capability_desc_canRequestTouchExploration));
      sAvailableCapabilityInfos.put(
          8,
          new CapabilityInfo(
              8,
              C4337R.string.capability_title_canRequestFilterKeyEvents,
              C4337R.string.capability_desc_canRequestFilterKeyEvents));
      sAvailableCapabilityInfos.put(
          16,
          new CapabilityInfo(
              16,
              C4337R.string.capability_title_canControlMagnification,
              C4337R.string.capability_desc_canControlMagnification));
      sAvailableCapabilityInfos.put(
          32,
          new CapabilityInfo(
              32,
              C4337R.string.capability_title_canPerformGestures,
              C4337R.string.capability_desc_canPerformGestures));
      sAvailableCapabilityInfos.put(
          128,
          new CapabilityInfo(
              128,
              C4337R.string.capability_title_canTakeScreenshot,
              C4337R.string.capability_desc_canTakeScreenshot));
      if (context == null || fingerprintAvailable(context)) {
        sAvailableCapabilityInfos.put(
            64,
            new CapabilityInfo(
                64,
                C4337R.string.capability_title_canCaptureFingerprintGestures,
                C4337R.string.capability_desc_canCaptureFingerprintGestures));
      }
    }
