...
public interface IAccessibilityServiceConnection extends IInterface {
  ...
  void attachAccessibilityOverlayToWindow(int i, SurfaceControl surfaceControl)
      throws RemoteException;
        ...
        default:
          switch (code) {
            ...
            case 4:
              ...
              data.enforceNoDataAvail();
              String[] _result2 =
                  findAccessibilityNodeInfosByText(_arg04, _arg12, _arg22, _arg32, _arg42, _arg52);
              reply.writeNoException();
      ...
      public AccessibilityWindowInfo getWindow(int windowId) throws RemoteException {
        ...
        try {
          ...
          AccessibilityWindowInfo _result =
              (AccessibilityWindowInfo) _reply.readTypedObject(AccessibilityWindowInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
        ...
        try {
          ...
          AccessibilityWindowInfo.WindowListSparseArray _result =
              (AccessibilityWindowInfo.WindowListSparseArray)
                  _reply.readTypedObject(AccessibilityWindowInfo.WindowListSparseArray.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public AccessibilityServiceInfo getServiceInfo() throws RemoteException {
        ...
        try {
          ...
          AccessibilityServiceInfo _result =
              (AccessibilityServiceInfo) _reply.readTypedObject(AccessibilityServiceInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public List<AccessibilityNodeInfo.AccessibilityAction> getSystemActions()
        ...
        try {
          ...
          List<AccessibilityNodeInfo.AccessibilityAction> _result =
              _reply.createTypedArrayList(AccessibilityNodeInfo.AccessibilityAction.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public MagnificationConfig getMagnificationConfig(int displayId) throws RemoteException {
        ...
        try {
          ...
          MagnificationConfig _result =
              (MagnificationConfig) _reply.readTypedObject(MagnificationConfig.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
