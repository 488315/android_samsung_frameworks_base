...
public final class GestureDescription {
    ...
    for (int i = 0; i < this.mStrokes.size(); i++) {
      ...
      if (strokeDescription.hasPointForTime(time)) {
        ...
        touchPoints[numPointsFound].mIsStartOfPath =
            strokeDescription.getContinuedStrokeId() < 0 && time == strokeDescription.mStartTime;
  ...
  public static class TouchPoint implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int i) {
      ...
      parcel.writeFloat(this.f5mX);
      parcel.writeFloat(this.f6mY);
    }
  }
  ...
  public static class MotionEventGenerator {
    ...
    public static List<GestureStep> getGestureStepsFromGestureDescription(
      ...
      while (nextKeyPointTime >= 0) {
        ...
        gestureSteps.add(
            new GestureStep(timeSinceGestureStart, currentTouchPointSize, currentTouchPoints));
