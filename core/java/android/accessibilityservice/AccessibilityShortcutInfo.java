    ...
    public AccessibilityShortcutInfo(Context context, ActivityInfo activityInfo) throws XmlPullParserException, IOException {
        ...
        try {
            ...
            try {
                ...
                if (elapsedTime > 100) {
                    Log.m98i("AccessibilityShortcutInfo", "took more than 100ms mComponentName : " + componentName + ", elapsedTime : " + elapsedTime);
                }
                if (parser == null) {
                ...
                TypedArray asAttributes = resources.obtainAttributes(allAttributes, C4337R.styleable.AccessibilityShortcutTarget);
