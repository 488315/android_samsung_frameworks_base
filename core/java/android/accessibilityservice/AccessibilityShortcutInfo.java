  ...
  public AccessibilityShortcutInfo(Context context, ActivityInfo activityInfo)
    ...
    try {
      ...
      try {
        ...
        Resources resources =
            packageManager.getResourcesForApplication(this.mActivityInfo.applicationInfo);
        TypedArray asAttributes =
            resources.obtainAttributes(allAttributes, C4337R.styleable.AccessibilityShortcutTarget);
    ...
    if (resId == 0
        || (text =
                packageManager.getText(
                    activityInfo.packageName, resId, activityInfo.applicationInfo))
            == null) {
      return null;
    }
