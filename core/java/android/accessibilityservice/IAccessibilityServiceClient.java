...
public interface IAccessibilityServiceClient extends IInterface {
  ...
  void init(IAccessibilityServiceConnection iAccessibilityServiceConnection, int i, IBinder iBinder)
      throws RemoteException;
          ...
          switch (code) {
            case 1:
              IAccessibilityServiceConnection _arg0 =
                  IAccessibilityServiceConnection.Stub.asInterface(data.readStrongBinder());
            ...
            case 18:
              IAccessibilityInputMethodSession _arg015 =
                  IAccessibilityInputMethodSession.Stub.asInterface(data.readStrongBinder());
