...
public abstract class AccessibilityService extends Service {
  ...
  private int calculateGestureSampleTimeMs(int displayId) {
    ...
    if (getApplicationInfo().targetSdkVersion > 29
        && (display =
                ((DisplayManager) getSystemService(DisplayManager.class)).getDisplay(displayId))
            != null
    ...
    if (callbackInfo != null
      ...
      if (callbackInfo.handler != null) {
        callbackInfo.handler.post(
            new Runnable() { // from class: android.accessibilityservice.AccessibilityService.1
  ...
  public static final class MagnificationController {
                  ...
                  new Runnable() { // from class:
                    ...
                    public final void run() {
                      AccessibilityService.MagnificationController.this
                          .lambda$dispatchMagnificationChanged$0(listener, region, config);
                    }
                  });
            } else {
    ...
    public /* synthetic */ void lambda$dispatchMagnificationChanged$0(
        OnMagnificationChangedListener listener, Region region, MagnificationConfig config) {
      listener.onMagnificationChanged(this, region, config);
    }
  ...
  public static final class SoftKeyboardController {
    ...
    void dispatchSoftKeyboardShowModeChanged(final int showMode) {
      synchronized (this.mLock) {
        ...
        Slog.m121w(
            "AccessibilityService",
            "Received soft keyboard show mode changed callback with no listeners registered!");
        setSoftKeyboardCallbackEnabled(false);
      }
    }
  ...
  public /* synthetic */ void lambda$takeScreenshot$0(
    ...
    HardwareBuffer hardwareBuffer =
        (HardwareBuffer)
            result.getParcelable(KEY_ACCESSIBILITY_SCREENSHOT_HARDWAREBUFFER, HardwareBuffer.class);
    ParcelableColorSpace colorSpace =
        (ParcelableColorSpace)
            result.getParcelable(
                KEY_ACCESSIBILITY_SCREENSHOT_COLORSPACE, ParcelableColorSpace.class);
  ...
  public void takeScreenshotOfWindow(
    ...
    AccessibilityInteractionClient.getInstance(this)
        .takeScreenshotOfWindow(this.mConnectionId, accessibilityWindowId, executor, callback);
  }
  ...
  public void setAccessibilityFocusAppearance(int strokeWidth, int color) {
    ...
    if (connection != null) {
      try {
        ...
        Log.m103w(
            "AccessibilityService",
            "Error while setting the strokeWidth and color of the accessibility focus rectangle",
            re);
        re.rethrowFromSystemServer();
      }
    }
  ...
  public static class IAccessibilityServiceClientWrapper extends IAccessibilityServiceClient.Stub {
    ...
    public void init(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              AccessibilityService.IAccessibilityServiceClientWrapper.this.lambda$init$0(
                  connectionId, connection, windowToken);
            }
          });
    }
    ...
    public void onGesture(final AccessibilityGestureEvent gestureInfo) {
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              AccessibilityService.IAccessibilityServiceClientWrapper.this.lambda$onGesture$3(
                  gestureInfo);
            }
          });
    }
    ...
    public void onKeyEvent(final KeyEvent event, final int sequence) {
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              AccessibilityService.IAccessibilityServiceClientWrapper.this.lambda$onKeyEvent$5(
                  event, sequence);
            }
          });
    }
    ...
    public void setImeSessionEnabled(
      ...
      try {
        ...
        if (ls == null) {
          Log.m102w("AccessibilityService", "Session is already finished: " + session);
        } else {
          this.mExecutor.execute(
              new Runnable() { // from class:
    ...
    public void bindInput() {
      if (this.mCancellationGroup != null) {
        Log.m96e("AccessibilityService", "bindInput must be paired with unbindInput.");
      }
    ...
    public void unbindInput() {
      ...
      if (cancellationGroup != null) {
        ...
        Log.m96e("AccessibilityService", "unbindInput must be paired with bindInput.");
      }
    }
    ...
    public void startInput(
      ...
      if (this.mCancellationGroup == null) {
        Log.m96e("AccessibilityService", "startInput must be called after bindInput.");
        this.mCancellationGroup = new CancellationGroup();
      }
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              AccessibilityService.IAccessibilityServiceClientWrapper.this.lambda$startInput$16(
    ...
    public /* synthetic */ void lambda$startInput$16(
        IRemoteAccessibilityInputConnection connection, EditorInfo editorInfo, boolean restarting) {
      if (this.mConnectionId != -1) {
        RemoteAccessibilityInputConnection ic =
            connection == null
                ? null
                : new RemoteAccessibilityInputConnection(connection, this.mCancellationGroup);
    ...
    public void onMotionEvent(final MotionEvent event) {
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              AccessibilityService.IAccessibilityServiceClientWrapper.this.lambda$onMotionEvent$17(
                  event);
            }
          });
    }
  ...
  private static class GestureResultCallbackInfo {
    ...
    GestureResultCallbackInfo(
        GestureDescription gestureDescription, GestureResultCallback callback, Handler handler) {
  ...
  private void sendScreenshotSuccess(
      final ScreenshotResult screenshot, Executor executor, final TakeScreenshotCallback callback) {
    executor.execute(
        new Runnable() { // from class:
  ...
  public void attachAccessibilityOverlayToWindow(int accessibilityWindowId, SurfaceControl sc) {
    Preconditions.checkNotNull(sc, "SurfaceControl cannot be null");
    AccessibilityInteractionClient.getInstance(this)
        .attachAccessibilityOverlayToWindow(this.mConnectionId, accessibilityWindowId, sc);
  }
}
