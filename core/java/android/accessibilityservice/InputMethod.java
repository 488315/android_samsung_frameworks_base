...
public class InputMethod {
  ...
  final void startInput(RemoteAccessibilityInputConnection ic, EditorInfo attribute) {
    Log.m100v(LOG_TAG, "startInput(): editor=" + attribute);
  ...
  final void restartInput(RemoteAccessibilityInputConnection ic, EditorInfo attribute) {
    Log.m100v(LOG_TAG, "restartInput(): editor=" + attribute);
  ...
  final void doStartInput(
    ...
    Log.m100v(LOG_TAG, "CALL: onStartInput");
    onStartInput(attribute, restarting);
  }

  final void doFinishInput() {
    Log.m100v(LOG_TAG, "CALL: doFinishInput");
    if (this.mInputStarted) {
      Log.m100v(LOG_TAG, "CALL: onFinishInput");
      onFinishInput();
    }
  ...
  public final class AccessibilityInputConnection {
    ...
    public SurroundingText getSurroundingText(int beforeLength, int afterLength, int flags) {
      RemoteAccessibilityInputConnection remoteAccessibilityInputConnection = this.mIc;
      if (remoteAccessibilityInputConnection != null) {
        return remoteAccessibilityInputConnection.getSurroundingText(
  ...
  private final class SessionImpl implements AccessibilityInputMethodSession {
    ...
    public void updateSelection(
      ...
      if (this.mEnabled) {
        InputMethod.this.onUpdateSelection(
            oldSelEnd, oldSelEnd, newSelStart, newSelEnd, candidatesStart, candidatesEnd);
      }
    }
    ...
    public void invalidateInput(
      ...
      inputMethod.restartInput(
          new RemoteAccessibilityInputConnection(inputMethod.mStartedInputConnection, sessionId),
          editorInfo);
    }
  }
}
