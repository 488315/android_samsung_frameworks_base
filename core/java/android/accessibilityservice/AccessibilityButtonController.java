...
public final class AccessibilityButtonController {
  ...
  public boolean isAccessibilityButtonAvailable() {
    ...
    try {
      ...
      Slog.m122w(LOG_TAG, "Failed to get accessibility button availability.", re);
  ...
  void dispatchAccessibilityButtonClicked() {
    synchronized (this.mLock) {
          ...
          handler.post(
              new Runnable() { // from class:
                ...
                public final void run() {
                  AccessibilityButtonController.this.lambda$dispatchAccessibilityButtonClicked$0(
                      callback);
                }
              });
        }
      ...
      Slog.m121w(LOG_TAG, "Received accessibility button click with no callbacks!");
    }
  }
              ...
              new Runnable() { // from class:
                ...
                public final void run() {
                  AccessibilityButtonController.this
                      .lambda$dispatchAccessibilityButtonAvailabilityChanged$1(callback, available);
                }
              });
        }
        return;
      }
      Slog.m121w(LOG_TAG, "Received accessibility button availability change with no callbacks!");
    }
  }
