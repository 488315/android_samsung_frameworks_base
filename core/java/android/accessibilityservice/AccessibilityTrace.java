...
public interface AccessibilityTrace {
  ...
  public static final String NAME_ACCESSIBILITY_SERVICE_CONNECTION =
  ...
  public static final String NAME_ACCESSIBILITY_INTERACTION_CONNECTION =
      "IAccessibilityInteractionConnection";
  public static final String NAME_ACCESSIBILITY_INTERACTION_CONNECTION_CALLBACK =
      "IAccessibilityInteractionConnectionCallback";
  public static final String NAME_REMOTE_MAGNIFICATION_ANIMATION_CALLBACK =
      "IRemoteMagnificationAnimationCallback";
  public static final String NAME_WINDOW_MAGNIFICATION_CONNECTION =
      "IWindowMagnificationConnection";
  public static final String NAME_WINDOW_MAGNIFICATION_CONNECTION_CALLBACK =
      "IWindowMagnificationConnectionCallback";
  public static final String NAME_WINDOW_MANAGER_INTERNAL = "WindowManagerInternal";
  public static final String NAME_WINDOWS_FOR_ACCESSIBILITY_CALLBACK =
  ...
  public static final String NAME_ACCESSIBILITY_INTERACTION_CLIENT =
      "AccessibilityInteractionClient";
  public static final String NAME_ALL_LOGGINGS = "AllLoggings";
  public static final Map<String, Long> sNamesToFlags =
      Map.ofEntries(
          new AbstractMap.SimpleEntry(NAME_ACCESSIBILITY_SERVICE_CONNECTION, 1L),
          new AbstractMap.SimpleEntry(NAME_ACCESSIBILITY_SERVICE_CLIENT, 2L),
          new AbstractMap.SimpleEntry(NAME_ACCESSIBILITY_MANAGER, 4L),
          new AbstractMap.SimpleEntry(NAME_ACCESSIBILITY_MANAGER_CLIENT, 8L),
          new AbstractMap.SimpleEntry(NAME_ACCESSIBILITY_INTERACTION_CONNECTION, 16L),
          new AbstractMap.SimpleEntry(NAME_ACCESSIBILITY_INTERACTION_CONNECTION_CALLBACK, 32L),
          new AbstractMap.SimpleEntry(NAME_REMOTE_MAGNIFICATION_ANIMATION_CALLBACK, 64L),
          new AbstractMap.SimpleEntry(NAME_WINDOW_MAGNIFICATION_CONNECTION, 128L),
          new AbstractMap.SimpleEntry(NAME_WINDOW_MAGNIFICATION_CONNECTION_CALLBACK, 256L),
          new AbstractMap.SimpleEntry(NAME_WINDOW_MANAGER_INTERNAL, 512L),
          new AbstractMap.SimpleEntry(NAME_WINDOWS_FOR_ACCESSIBILITY_CALLBACK, 1024L),
          new AbstractMap.SimpleEntry(NAME_MAGNIFICATION_CALLBACK, 2048L),
          new AbstractMap.SimpleEntry(NAME_INPUT_FILTER, 4096L),
          new AbstractMap.SimpleEntry(NAME_GESTURE, 8192L),
          new AbstractMap.SimpleEntry(NAME_ACCESSIBILITY_SERVICE, 16384L),
          new AbstractMap.SimpleEntry(NAME_PACKAGE_BROADCAST_RECEIVER, 32768L),
          new AbstractMap.SimpleEntry(NAME_USER_BROADCAST_RECEIVER, 65536L),
          new AbstractMap.SimpleEntry(NAME_FINGERPRINT, 131072L),
          new AbstractMap.SimpleEntry(NAME_ACCESSIBILITY_INTERACTION_CLIENT, 262144L),
          new AbstractMap.SimpleEntry("None", 0L),
          new AbstractMap.SimpleEntry(NAME_ALL_LOGGINGS, -1L));
