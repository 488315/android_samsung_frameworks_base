...
public interface AccessibilityTrace {
    ...
    public static final String NAME_MAGNIFICATION_CONNECTION_CALLBACK =
    ...
    public static final Map<String, Long> sNamesToFlags =
            Map.ofEntries(
                    ...
                    new AbstractMap.SimpleEntry(
                            NAME_ACCESSIBILITY_INTERACTION_CONNECTION_CALLBACK, 32L),
                    new AbstractMap.SimpleEntry(NAME_REMOTE_MAGNIFICATION_ANIMATION_CALLBACK, 64L),
                    new AbstractMap.SimpleEntry(NAME_MAGNIFICATION_CONNECTION, 128L),
                    new AbstractMap.SimpleEntry(NAME_MAGNIFICATION_CONNECTION_CALLBACK, 256L),
