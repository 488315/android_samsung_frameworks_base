...
public class AppWidgetHostView extends FrameLayout implements AppWidgetHost.AppWidgetHostListener {
    ...
    public void setAppWidget(int appWidgetId, AppWidgetProviderInfo info) {
        ...
        if (info != null) {
            ...
            if ((info.providerInfo.applicationInfo.flags & 1073741824) != 0) {
                description = Resources.getSystem().getString(C4337R.string.suspended_widget_accessibility, description);
            }
    ...
    void restoreInstanceState() {
        ...
        try {
            ...
            Log.m97e(TAG, "failed to restoreInstanceState for widget id: " + this.mAppWidgetId + ", " + (this.mInfo == null ? SemCapabilities.FEATURE_TAG_NULL : this.mInfo.provider), e);
        }
    }
    ...
    private class ViewApplyListener implements RemoteViews.OnViewAppliedListener {
        ...
        public void onViewApplied(View v) {
            ...
            if (viewId > -1) {
                ...
                Log.m98i(AppWidgetHostView.TAG, "onViewApplied, Trigger viewDataChanged for viewId : " + viewId);
        ...
        public void onError(Exception e) {
            if (this.mIsReapply) {
                ...
                appWidgetHostView.mLastExecutionSignal = remoteViews.applyAsync(context, appWidgetHostView2, appWidgetHostView2.mAsyncExecutor, AppWidgetHostView.this.new ViewApplyListener(this.mViews, this.mLayoutId, false), AppWidgetHostView.this.mInteractionHandler, AppWidgetHostView.this.mCurrentSize);
            } else {
    ...
    protected Context getRemoteContextEnsuringCorrectCachedApkPath() {
        try {
            ...
            Log.m103w(TAG, "Failed to get RemoteContext." + this.mInfo.providerInfo.applicationInfo.sourceDir + ", " + e2, e2);
            if (1 != 0) {
    ...
    public void hidden_semSetComplicationColor(int baseColor) {
        ...
        Log.m94d(TAG, "Changed base color(" + baseColor + ") and set primary : " + this.mComplicationColorsMap);
        traverseAndSetColor(this);
    }
