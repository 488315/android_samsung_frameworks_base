...
import android.content.p002pm.LauncherActivityInfo;
...
public class AppWidgetHostView extends FrameLayout implements AppWidgetHost.AppWidgetHostListener {
  ...
  private static final LayoutInflater.Filter INFLATER_FILTER =
      new LayoutInflater
          .Filter() { // from class: android.appwidget.AppWidgetHostView$$ExternalSyntheticLambda3
  ...
  public void setAppWidget(int appWidgetId, AppWidgetProviderInfo info) {
    ...
    if (info != null) {
      ...
      if ((info.providerInfo.applicationInfo.flags & 1073741824) != 0) {
        description =
            Resources.getSystem()
                .getString(C4337R.string.suspended_widget_accessibility, description);
      }
  ...
  private static Rect getDefaultPaddingForWidget(Context context, Rect padding) {
    ...
    padding.left = r.getDimensionPixelSize(C4337R.dimen.default_app_widget_padding_left);
    padding.right = r.getDimensionPixelSize(C4337R.dimen.default_app_widget_padding_right);
    padding.top = r.getDimensionPixelSize(C4337R.dimen.default_app_widget_padding_top);
    padding.bottom = r.getDimensionPixelSize(C4337R.dimen.default_app_widget_padding_bottom);
    return padding;
  }
    ...
    try {
      ...
      Log.m97e(
          ...
          "failed to restoreInstanceState for widget id: "
              + this.mAppWidgetId
              + ", "
              + (this.mInfo == null ? SemCapabilities.FEATURE_TAG_NULL : this.mInfo.provider),
          e);
    }
  }
  ...
  protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    try {
      ...
      if (remoteViews != null
          && (toApply = remoteViews.getRemoteViewsToApplyIfDifferent(oldSize, newSize)) != null) {
      ...
      Log.m97e(TAG, "Remote provider threw runtime exception, using error view instead.", e);
      handleViewError();
    }
  }
  ...
  public void updateAppWidget(RemoteViews remoteViews) {
    ...
    if (appWidgetProviderInfo != null
        && appWidgetProviderInfo.getProfile() != null
    ...
    if (appWidgetProviderInfo2 != null
        && appWidgetProviderInfo2.getProfile() != null
  ...
  public void applyContent(View content, boolean recycled, Exception exception) {
    ...
    if (ViewRune.APPWIDGET_COMPLICATION
        && (appWidgetProviderInfo = this.mInfo) != null
        && appWidgetProviderInfo.widgetCategory == 8192
        && !this.mComplicationColorsMap.isEmpty()) {
  ...
  private class ViewApplyListener implements RemoteViews.OnViewAppliedListener {
    ...
    public void onViewApplied(View v) {
      ...
      if (viewId > -1) {
        ...
        Log.m98i(
            AppWidgetHostView.TAG, "onViewApplied, Trigger viewDataChanged for viewId : " + viewId);
        AppWidgetHostView.this.onViewDataChanged(viewId);
      }
      AppWidgetHostView appWidgetHostView = AppWidgetHostView.this;
      appWidgetHostView.mLastInflatedRemoteViewsId =
          this.mViews.computeUniqueId(appWidgetHostView.mLastInflatedRemoteViews);
    ...
    public void onError(Exception e) {
      if (this.mIsReapply) {
        ...
        appWidgetHostView.mLastExecutionSignal =
            remoteViews.applyAsync(
                context,
                appWidgetHostView2,
                appWidgetHostView2.mAsyncExecutor,
                AppWidgetHostView.this.new ViewApplyListener(this.mViews, this.mLayoutId, false),
  ...
  public void onViewDataChanged(int viewId) {
    ...
    Log.m98i(TAG, "viewDataChanged, viewId = " + viewId + ", v = " + v);
    if (v != null && (v instanceof AdapterView)) {
      ...
      if (adapter instanceof BaseAdapter) {
        ...
        baseAdapter.notifyDataSetChanged();
          ...
          && (adapterView instanceof RemoteViewsAdapter.RemoteAdapterConnectionCallback)) {
    ...
    Log.m98i(TAG, "view is null, will retry when view inflating is finished.");
  }
  ...
  protected Context getRemoteContextEnsuringCorrectCachedApkPath() {
    try {
      ...
      Context newContext =
          this.mContext.createApplicationContext(this.mInfo.providerInfo.applicationInfo, 4);
      ...
      Log.m96e(TAG, "Package name " + this.mInfo.providerInfo.packageName + " not found");
      ...
      Log.m97e(TAG, "Error trying to create the remote context.", e5);
      return this.mContext;
    }
  }
  ...
  private boolean clearResourcePackageCache(Context context, String pkg) {
    try {
      ...
      return true;
        ...
        | SecurityException e) {
      Log.m97e(TAG, "Failed to clear cache for " + pkg + ", " + e, e);
      return false;
    }
  }
  ...
  protected View getDefaultView() {
    ...
    try {
      if (this.mInfo != null) {
        ...
        Log.m102w(TAG, "can't inflate defaultView because mInfo is missing");
      }
    } catch (RuntimeException e) {
      exception = e;
    }
    ...
    if (this.mInfo != null) {
      ...
      if (!activities.isEmpty()) {
        ...
        launcherApps.startMainActivity(
            ai.getComponentName(), ai.getUser(), RemoteViews.getSourceBounds(view), null);
      }
    }
  }
  ...
  protected View getErrorView() {
    ...
    tv.setText(C4337R.string.gadget_host_error_inflating);
  ...
  public void setColorResources(SparseIntArray colorMapping) {
    RemoteViews.ColorResources colorResources = this.mColorResources;
    if (colorResources != null
        && isSameColorMapping(colorResources.getColorMapping(), colorMapping)) {
      return;
    }
  ...
  protected void dispatchDraw(Canvas canvas) {
    try {
      ...
      Log.m96e(TAG, "Drawing view failed: " + e);
      post(
  ...
  public void semForceOrientation(boolean forced, boolean isPortrait) {
    Log.m94d(TAG, "force orientation - forced=" + forced + ", isPortrait=" + isPortrait);
  ...
  public void hidden_semSetComplicationColor(int baseColor) {
    ...
    this.mComplicationColorsMap.put(
        COMPLICATION_COLOR_PRIMARY, Integer.valueOf(color | 1073741824));
    this.mComplicationColorsMap.put(
        COMPLICATION_COLOR_ON_PRIMARY, Integer.valueOf((-16777216) | color));
    this.mComplicationColorsMap.put(
        COMPLICATION_COLOR_ON_SECONDARY, Integer.valueOf((-872415232) | color));
    this.mComplicationColorsMap.put(
        COMPLICATION_COLOR_ON_TERTIARY, Integer.valueOf((-1291845632) | color));
    this.mComplicationColorsMap.put(
        COMPLICATION_COLOR_BACKGROUND, Integer.valueOf(1073741824 | color));
    Log.m94d(
        TAG,
        "Changed base color(" + baseColor + ") and set primary : " + this.mComplicationColorsMap);
    traverseAndSetColor(this);
  }
  ...
  private void traverseAndSetColor(View view) {
    if (view instanceof ViewGroup) {
      ...
      if (d instanceof GradientDrawable) {
        ...
        if (gd.getColor() != null) {
          ...
          int color =
              (16777215 & this.mComplicationColorsMap.get(COMPLICATION_COLOR_PRIMARY).intValue())
                  | alpha;
          gd.setColor(color);
      ...
      if (view instanceof TextView) {
        ((TextView) view)
            .setTextColor(
                (-16777216)
                    | (16777215
                        & this.mComplicationColorsMap.get(COMPLICATION_COLOR_PRIMARY).intValue()));
        return;
      } else {
        if (view instanceof ProgressBar) {
          ...
          progressBar.setProgressTintList(
              ColorStateList.valueOf(
                  this.mComplicationColorsMap.get(COMPLICATION_COLOR_ON_PRIMARY).intValue()));
    ...
    if (colorFilter instanceof PorterDuffColorFilter) {
      ...
      imageView.setColorFilter(
          (16777215 & this.mComplicationColorsMap.get(COMPLICATION_COLOR_ON_PRIMARY).intValue())
              | alpha3);
      view.invalidate();
      return;
    }
    Log.m94d(TAG, "This is not PorterDuffColorFilter");
  }
}
