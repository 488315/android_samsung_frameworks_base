...
public class AppWidgetProviderInfo implements Parcelable {
  public static final Parcelable.Creator<AppWidgetProviderInfo> CREATOR =
      new Parcelable.Creator<
          AppWidgetProviderInfo>() { // from class: android.appwidget.AppWidgetProviderInfo.1
  ...
  public AppWidgetProviderInfo m1227clone() {
    AppWidgetProviderInfo that = new AppWidgetProviderInfo();
    ComponentName componentName = this.provider;
    that.provider = componentName == null ? null : componentName.m1270clone();
    ...
    that.configure = componentName2 == null ? null : componentName2.m1270clone();
    ComponentName componentName3 = this.semConfigure;
    that.semConfigure = componentName3 != null ? componentName3.m1270clone() : null;
  ...
  private Drawable loadDrawable(
    ...
    try {
      Resources resources =
          context.getPackageManager().getResourcesForApplication(this.providerInfo.applicationInfo);
