...
public class AppWidgetManager {
    ...
    public void updateAppWidgetOptions(int appWidgetId, Bundle options) {
        ...
        try {
            Log.m94d(TAG, "updateAppWidgetOptions() appWidgetId = " + appWidgetId + ", options = " + options);
    ...
    public void notifyAppWidgetViewDataChanged(int[] appWidgetIds, int viewId) {
        ...
        try {
            Log.m98i(TAG, "notifyAppWidgetViewDataChanged() appWidgetIds = " + Arrays.toString(appWidgetIds) + ", viewId = " + viewId);
    ...
    private boolean bindAppWidgetIdIfAllowed(int appWidgetId, int profileId, ComponentName provider, Bundle options) {
        if (this.mService != null) {
            try {
                Log.m94d(TAG, "bindAppWidgetIdIfAllowed() appWidgetIds = " + appWidgetId + ", provider = " + provider);
