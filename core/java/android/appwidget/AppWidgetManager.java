...
public class AppWidgetManager {
  ...
  public /* synthetic */ void lambda$new$3() {
    try {
      ...
      Log.m97e(TAG, "Nofity service of inheritance info", e);
    }
  }
  ...
  public void updateAppWidget(int[] appWidgetIds, RemoteViews views) {
    ...
    try {
      Log.m98i(TAG, "updateAppWidget() appWidgetIds = " + Arrays.toString(appWidgetIds));
  ...
  public void updateAppWidgetOptions(int appWidgetId, Bundle options) {
    ...
    try {
      Log.m94d(
          TAG, "updateAppWidgetOptions() appWidgetId = " + appWidgetId + ", options = " + options);
  ...
  public void partiallyUpdateAppWidget(int[] appWidgetIds, RemoteViews views) {
    ...
    try {
      Log.m94d(TAG, "partiallyUpdateAppWidget() appWidgetIds = " + Arrays.toString(appWidgetIds));
  ...
  public List<AppWidgetProviderInfo> getInstalledProvidersForPackage(
    ...
    if (packageName == null) {
      throw new NullPointerException(
          "A non-null package must be passed to this method. If you want all widgets regardless of"
              + " package, see getInstalledProvidersForProfile(UserHandle)");
    }
    if (this.mService == null) {
      return Collections.emptyList();
    }
  ...
  public AppWidgetProviderInfo getAppWidgetInfo(int appWidgetId) {
    ...
    try {
      AppWidgetProviderInfo info =
          iAppWidgetService.getAppWidgetInfo(this.mPackageName, appWidgetId);
      if (info != null) {
        info.updateDimensions(this.mDisplayMetrics);
      }
      return info;
  ...
  public boolean bindRemoteViewsService(
    ...
    try {
      return iAppWidgetService.bindRemoteViewsService(
      ...
      try {
        Log.m94d(
            ...
            "bindAppWidgetIdIfAllowed() appWidgetIds = "
                ...
                + ", provider = "
                + provider);
        Log.m95d(TAG, "Stack:", new Throwable("stack dump"));
