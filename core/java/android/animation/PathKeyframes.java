...
public class PathKeyframes implements Keyframes {
  ...
  abstract static class IntKeyframesBase extends SimpleKeyframes implements Keyframes.IntKeyframes {
    IntKeyframesBase() {
      super();
    }
