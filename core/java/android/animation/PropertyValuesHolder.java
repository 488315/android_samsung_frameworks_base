...
public class PropertyValuesHolder implements Cloneable {
    ...
    private Method getPropertyFunction(Class cls, String prefix, Class valueType) {
        ...
        if (returnVal == null) {
            Log.m102w("PropertyValuesHolder", "Method " + getMethodName(prefix, this.mPropertyName) + "() with type " + valueType + " not found on target class " + cls);
        }
        return returnVal;
    }
    ...
    void setupSetterAndGetter(Object target) {
        if (this.mProperty != null) {
            ...
            try {
                ...
                Log.m102w("PropertyValuesHolder", "No such property (" + this.mProperty.getName() + ") on target object " + target + ". Trying reflection instead");
                this.mProperty = null;
            }
        }
        if (this.mProperty == null) {
