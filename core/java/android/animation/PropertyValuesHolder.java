...
public class PropertyValuesHolder implements Cloneable {
      ...
      for (int i2 = 0; i2 < keyframeCount2; i2++) {
        ...
        if (!kf2.hasValue() || kf2.valueWasSetOnStart()) {
          ...
          try {
            ...
            Log.m96e("PropertyValuesHolder", e2.toString());
          } catch (InvocationTargetException e3) {
            Log.m96e("PropertyValuesHolder", e3.toString());
          }
        }
      }
    }
  ...
  private void setupValue(Object target, Keyframe kf) {
    ...
    try {
      ...
      Log.m96e("PropertyValuesHolder", e.toString());
  ...
  @Override //
  /* renamed from: clone */
  public PropertyValuesHolder mo592clone() {
    try {
      PropertyValuesHolder newPVH = (PropertyValuesHolder) super.clone();
      newPVH.mPropertyName = this.mPropertyName;
      newPVH.mProperty = this.mProperty;
      newPVH.mKeyframes = this.mKeyframes.mo554clone();
  ...
  public void getPropertyValues(PropertyValues values) {
    ...
    if ((keyframes instanceof PathKeyframes.FloatKeyframesBase)
        || (keyframes instanceof PathKeyframes.IntKeyframesBase)
        || (keyframes.getKeyframes() != null && this.mKeyframes.getKeyframes().size() > 2)) {
      values.dataSource =
          new PropertyValues.DataSource() { // from class: android.animation.PropertyValuesHolder.1
  ...
  static class IntPropertyValuesHolder extends PropertyValuesHolder {
    ...
    @Override // android.animation.PropertyValuesHolder
    /* renamed from: clone */
    public IntPropertyValuesHolder mo592clone() {
      IntPropertyValuesHolder newPVH = (IntPropertyValuesHolder) super.mo592clone();
  ...
  static class FloatPropertyValuesHolder extends PropertyValuesHolder {
    ...
    public FloatPropertyValuesHolder mo592clone() {
      FloatPropertyValuesHolder newPVH = (FloatPropertyValuesHolder) super.mo592clone();
  ...
  static class MultiFloatValuesHolder extends PropertyValuesHolder {
    ...
    public MultiFloatValuesHolder(
        String propertyName, TypeConverter converter, TypeEvaluator evaluator, Object... values) {
      super(propertyName);
        ...
        switch (numParameters) {
          ...
          case 4:
            PropertyValuesHolder.nCallFourFloatMethod(
                target, j, values[0], values[1], values[2], values[3]);
            break;
        }
      }
    }
    ...
    void setupSetter(Class targetClass) {
      ...
      synchronized (hashMap) {
        ...
        if (!wasInMap) {
          ...
          try {
            this.mJniSetter =
                PropertyValuesHolder.nGetMultipleFloatMethod(targetClass, methodName, numParams);
          } catch (NoSuchMethodError e) {
            try {
              this.mJniSetter =
    ...
    void setupSetter(Class targetClass) {
      ...
      synchronized (hashMap) {
        ...
        if (!wasInMap) {
          ...
          try {
            this.mJniSetter =
                PropertyValuesHolder.nGetMultipleIntMethod(targetClass, methodName, numParams);
          } catch (NoSuchMethodError e) {
            try {
              this.mJniSetter =
  ...
  private static class PointFToFloatArray extends TypeConverter<PointF, float[]> {
    ...
    public float[] convert(PointF value) {
      this.mCoordinates[0] = value.f87x;
      this.mCoordinates[1] = value.f88y;
  ...
  private static class PointFToIntArray extends TypeConverter<PointF, int[]> {
    ...
    public int[] convert(PointF value) {
      this.mCoordinates[0] = Math.round(value.f87x);
      this.mCoordinates[1] = Math.round(value.f88y);
      return this.mCoordinates;
    }
  }
