...
public class ValueAnimator extends Animator implements AnimationHandler.AnimationFrameCallback {
  ...
  public static boolean registerDurationScaleChangeListener(DurationScaleChangeListener listener) {
    ...
    synchronized (sDurationScaleChangeListeners) {
      int i = 0;
      while (true) {
        ArrayList<WeakReference<DurationScaleChangeListener>> arrayList =
  ...
  public void setCurrentPlayTime(long playTime) {
    ...
    float fraction = j > 0 ? playTime / j : 1.0f;
  ...
  public void setEvaluator(TypeEvaluator value) {
    ...
    if (value != null
        && (propertyValuesHolderArr = this.mValues) != null
        && propertyValuesHolderArr.length > 0) {
  ...
  public ValueAnimator mo547clone() {
    ValueAnimator anim = (ValueAnimator) super.mo547clone();
    if (this.mUpdateListeners != null) {
    ...
    if (oldValues != null) {
      ...
      for (int i = 0; i < numValues; i++) {
        PropertyValuesHolder newValuesHolder = oldValues[i].mo592clone();
