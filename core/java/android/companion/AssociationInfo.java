...
public final class AssociationInfo implements Parcelable {
  public static final Parcelable.Creator<AssociationInfo> CREATOR =
      new Parcelable.Creator<AssociationInfo>() { // from class: android.companion.AssociationInfo.1
  ...
  public static final class Builder implements NonActionableBuilder {
    ...
    public AssociationInfo build() {
      return new AssociationInfo(
          this.mOriginalInfo.mId,
          this.mOriginalInfo.mUserId,
          this.mOriginalInfo.mPackageName,
          this.mOriginalInfo.mDeviceMacAddress,
          this.mOriginalInfo.mDisplayName,
          this.mOriginalInfo.mDeviceProfile,
          this.mOriginalInfo.mAssociatedDevice,
          this.mOriginalInfo.mSelfManaged,
          this.mNotifyOnDeviceNearby,
          this.mRevoked,
          this.mOriginalInfo.mTimeApprovedMs,
