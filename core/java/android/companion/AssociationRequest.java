...
public final class AssociationRequest implements Parcelable {
    ...
    public AssociationRequest build() {
      ...
      if (this.mSelfManaged && this.mDisplayName == null) {
        throw new IllegalStateException(
            "Request for a self-managed association MUST provide the display name of the device");
      }
  ...
  public boolean equals(Object o) {
    ...
    if (this.mSingleDevice == that.mSingleDevice
        ...
        && Objects.equals(
            this.mDeviceProfilePrivilegesDescription, that.mDeviceProfilePrivilegesDescription)
  ...
  public int hashCode() {
    ...
    return (((((((((((((((((((((_hash * 31) + Objects.hashCode(this.mDeviceFilters)) * 31)
                                                                ...
                                                                + Objects.hashCode(
                                                                    this.mAssociatedDevice))
                                                            * 31)
                                                        + Boolean.hashCode(this.mSelfManaged))
                                                    * 31)
                                ...
                                + this.mUserId)
                            * 31)
                        + Objects.hashCode(this.mDeviceProfilePrivilegesDescription))
                    * 31)
  ...
  AssociationRequest(Parcel in) {
    ...
    AssociatedDevice associatedDevice =
        (flg & 64) == 0 ? null : (AssociatedDevice) in.readTypedObject(AssociatedDevice.CREATOR);
