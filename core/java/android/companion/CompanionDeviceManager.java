...
public final class CompanionDeviceManager {
    ...
    @Deprecated public static final String EXTRA_DEVICE = "android.companion.extra.DEVICE";
    ...
    public void associate(AssociationRequest request, Callback callback, Handler handler) {
        ...
        try {
            this.mService.associate(
                    request,
                    new AssociationRequestCallbackProxy(Handler.mainIfNull(handler), callback),
    ...
    public void associate(AssociationRequest request, Executor executor, Callback callback) {
        ...
        try {
            this.mService.associate(
                    request,
                    new AssociationRequestCallbackProxy(executor, callback),
                    this.mContext.getOpPackageName(),
                    this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
    ...
    public IntentSender buildAssociationCancellationIntent() {
        ...
        try {
            PendingIntent pendingIntent =
                    this.mService.buildAssociationCancellationIntent(
    ...
    public List<String> getAssociations() {
        return CollectionUtils.mapNotNull(
                ...
                new Function() { // from class:
                    // android.companion.CompanionDeviceManager$$ExternalSyntheticLambda0
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                        return CompanionDeviceManager.lambda$getAssociations$0(
                                (AssociationInfo) obj);
                    }
                });
    }
    ...
    public List<AssociationInfo> getMyAssociations() {
        ...
        try {
            return this.mService.getAssociations(
                    this.mContext.getOpPackageName(), this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public void disassociate(String deviceMacAddress) {
        ...
        try {
            this.mService.legacyDisassociate(
                    deviceMacAddress, this.mContext.getOpPackageName(), this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void requestNotificationAccess(ComponentName component) {
        ...
        try {
            PendingIntent pendingIntent =
                    this.mService.requestNotificationAccess(component, this.mContext.getUserId());
    ...
    public boolean isDeviceAssociatedForWifiConnection(
            String packageName, MacAddress macAddress, UserHandle user) {
        if (this.mService == null) {
            Log.w(TAG, "CompanionDeviceManager service is not available.");
            return false;
        }
        ...
        try {
            return this.mService.isDeviceAssociatedForWifiConnection(
    ...
    public void addOnAssociationsChangedListener(
            Executor executor, OnAssociationsChangedListener listener) {
    ...
    public void addOnAssociationsChangedListener(
        ...
        synchronized (this.mListeners) {
            OnAssociationsChangedListenerProxy proxy =
                    new OnAssociationsChangedListenerProxy(executor, listener);
            try {
        ...
        synchronized (this.mListeners) {
            ...
            while (iterator.hasNext()) {
                ...
                if (proxy.mListener == listener) {
                    try {
                        this.mService.removeOnAssociationsChangedListener(
                                proxy, this.mContext.getUserId());
                        iterator.remove();
                    } catch (RemoteException e) {
                        throw e.rethrowFromSystemServer();
                    }
    ...
    public void addOnTransportsChangedListener(
        ...
        synchronized (this.mTransportsChangedListeners) {
            OnTransportsChangedListenerProxy proxy =
                    new OnTransportsChangedListenerProxy(executor, listener);
            try {
    ...
    public void removeOnTransportsChangedListener(Consumer<List<AssociationInfo>> listener) {
        ...
        synchronized (this.mTransportsChangedListeners) {
            Iterator<OnTransportsChangedListenerProxy> iterator =
                    this.mTransportsChangedListeners.iterator();
            while (iterator.hasNext()) {
    ...
    public void addOnMessageReceivedListener(
        ...
        OnMessageReceivedListenerProxy proxy =
                new OnMessageReceivedListenerProxy(executor, listener);
        try {
    ...
    public void removeOnMessageReceivedListener(int i, BiConsumer<Integer, byte[]> biConsumer) {
        ...
        try {
            this.mService.removeOnMessageReceivedListener(
                    i, new OnMessageReceivedListenerProxy(null, biConsumer));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean canPairWithoutPrompt(
            String packageName, String deviceMacAddress, UserHandle user) {
        if (this.mService == null) {
            Log.w(TAG, "CompanionDeviceManager service is not available.");
            return false;
        }
        ...
        try {
            return this.mService.canPairWithoutPrompt(
                    packageName, deviceMacAddress, user.getIdentifier());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean removeBond(int associationId) {
        ...
        try {
            return this.mService.removeBond(
                    associationId, this.mContext.getOpPackageName(), this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void startObservingDevicePresence(String deviceAddress)
        ...
        try {
            this.mService.legacyStartObservingDevicePresence(
                    deviceAddress, this.mContext.getOpPackageName(), this.mContext.getUserId());
    ...
    public void stopObservingDevicePresence(String deviceAddress)
        ...
        Objects.requireNonNull(deviceAddress, "address cannot be null");
        try {
            this.mService.legacyStopObservingDevicePresence(
                    deviceAddress, this.mContext.getPackageName(), this.mContext.getUserId());
        } catch (RemoteException e) {
            ExceptionUtils.propagateIfInstanceOf(e.getCause(), DeviceNotAssociatedException.class);
        }
        int callingUid = Binder.getCallingUid();
    ...
    public void startObservingDevicePresence(ObservingDevicePresenceRequest request) {
        ...
        Objects.requireNonNull(request, "request cannot be null");
        try {
            this.mService.startObservingDevicePresence(
                    request, this.mContext.getOpPackageName(), this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void stopObservingDevicePresence(ObservingDevicePresenceRequest request) {
        ...
        Objects.requireNonNull(request, "request cannot be null");
        try {
            this.mService.stopObservingDevicePresence(
                    request, this.mContext.getOpPackageName(), this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public void attachSystemDataTransport(int associationId, InputStream in, OutputStream out)
            throws DeviceNotAssociatedException {
        if (this.mService == null) {
            Log.w(TAG, "CompanionDeviceManager service is not available.");
            return;
    ...
    public void associate(String packageName, MacAddress macAddress, byte[] certificate) {
        ...
        try {
            this.mService.createAssociation(
    ...
    public IntentSender buildPermissionTransferUserConsentIntent(int associationId)
        ...
        try {
            PendingIntent pendingIntent =
                    this.mService.buildPermissionTransferUserConsentIntent(
                            this.mContext.getOpPackageName(),
                            this.mContext.getUserId(),
                            associationId);
            if (pendingIntent == null) {
    ...
    public boolean isPermissionTransferUserConsented(int associationId) {
        ...
        try {
            return this.mService.isPermissionTransferUserConsented(
                    this.mContext.getOpPackageName(), this.mContext.getUserId(), associationId);
        } catch (RemoteException e) {
            ExceptionUtils.propagateIfInstanceOf(e.getCause(), DeviceNotAssociatedException.class);
            throw e.rethrowFromSystemServer();
        }
    ...
    public void startSystemDataTransfer(int associationId) throws DeviceNotAssociatedException {
        ...
        try {
            this.mService.startSystemDataTransfer(
                    this.mContext.getOpPackageName(),
                    this.mContext.getUserId(),
                    associationId,
                    null);
    ...
    public void startSystemDataTransfer(
            int associationId, Executor executor, OutcomeReceiver<Void, CompanionException> result)
            throws DeviceNotAssociatedException {
        if (this.mService == null) {
            Log.w(TAG, "CompanionDeviceManager service is not available.");
            return;
        ...
        try {
            this.mService.startSystemDataTransfer(
                    ...
                    this.mContext.getUserId(),
                    associationId,
                    new SystemDataTransferCallbackProxy(executor, result));
        } catch (RemoteException e) {
            ExceptionUtils.propagateIfInstanceOf(e.getCause(), DeviceNotAssociatedException.class);
            throw e.rethrowFromSystemServer();
        }
    ...
    public boolean isCompanionApplicationBound() {
        ...
        try {
            return this.mService.isCompanionApplicationBound(
                    this.mContext.getOpPackageName(), this.mContext.getUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    static class AssociationRequestCallbackProxy extends IAssociationRequestCallback.Stub {
        ...
        public void onAssociationPending(PendingIntent pi) {
            ...
            execute(
                    new Consumer() { // from class:
                        // android.companion.CompanionDeviceManager$AssociationRequestCallbackProxy$$ExternalSyntheticLambda4
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            CompanionDeviceManager.Callback.this.onAssociationPending(
                                    (IntentSender) obj);
                        }
                    },
                    pi.getIntentSender());
        ...
        public void onAssociationCreated(AssociationInfo association) {
            ...
            execute(
                    new Consumer() { // from class:
                        // android.companion.CompanionDeviceManager$AssociationRequestCallbackProxy$$ExternalSyntheticLambda2
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            CompanionDeviceManager.Callback.this.onAssociationCreated(
                                    (AssociationInfo) obj);
                        }
                    },
                    association);
        ...
        public void onFailure(CharSequence error) throws RemoteException {
            ...
            execute(
                    new Consumer() { // from class:
                        // android.companion.CompanionDeviceManager$AssociationRequestCallbackProxy$$ExternalSyntheticLambda3
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
            ...
            if (this.mExecutor != null) {
                this.mExecutor.execute(
                        new Runnable() { // from class:
                            // android.companion.CompanionDeviceManager$AssociationRequestCallbackProxy$$ExternalSyntheticLambda0
                ...
                this.mHandler.post(
                        new Runnable() { // from class:
                            // android.companion.CompanionDeviceManager$AssociationRequestCallbackProxy$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                callback.accept(arg);
                            }
    ...
    static class OnAssociationsChangedListenerProxy extends IOnAssociationsChangedListener.Stub {
        ...
        private OnAssociationsChangedListenerProxy(
                Executor executor, OnAssociationsChangedListener listener) {
            this.mExecutor = executor;
        ...
        public void onAssociationsChanged(final List<AssociationInfo> associations) {
            this.mExecutor.execute(
                    new Runnable() { // from class:
                        // android.companion.CompanionDeviceManager$OnAssociationsChangedListenerProxy$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CompanionDeviceManager.OnAssociationsChangedListenerProxy.this
                                    .lambda$onAssociationsChanged$0(associations);
                        }
                    });
        }
    }
    ...
    static class OnTransportsChangedListenerProxy extends IOnTransportsChangedListener.Stub {
        ...
        private OnTransportsChangedListenerProxy(
                Executor executor, Consumer<List<AssociationInfo>> listener) {
            this.mExecutor = executor;
            this.mListener = listener;
        }
        ...
        public void onTransportsChanged(final List<AssociationInfo> associations) {
            this.mExecutor.execute(
                    new Runnable() { // from class:
                        // android.companion.CompanionDeviceManager$OnTransportsChangedListenerProxy$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CompanionDeviceManager.OnTransportsChangedListenerProxy.this
                                    .lambda$onTransportsChanged$0(associations);
                        }
                    });
        }
    }
    ...
    static class OnMessageReceivedListenerProxy extends IOnMessageReceivedListener.Stub {
        ...
        private OnMessageReceivedListenerProxy(
                Executor executor, BiConsumer<Integer, byte[]> listener) {
            this.mExecutor = executor;
            this.mListener = listener;
        }
        ...
        public void onMessageReceived(final int associationId, final byte[] data) {
            this.mExecutor.execute(
                    new Runnable() { // from class:
                        // android.companion.CompanionDeviceManager$OnMessageReceivedListenerProxy$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CompanionDeviceManager.OnMessageReceivedListenerProxy.this
                                    .lambda$onMessageReceived$0(associationId, data);
                        }
                    });
        }
    }
    ...
    static class SystemDataTransferCallbackProxy extends ISystemDataTransferCallback.Stub {
        ...
        private SystemDataTransferCallbackProxy(
                Executor executor, OutcomeReceiver<Void, CompanionException> callback) {
            this.mExecutor = executor;
            this.mCallback = callback;
        }
        ...
        public void onResult() {
            this.mExecutor.execute(
                    new Runnable() { // from class:
                        // android.companion.CompanionDeviceManager$SystemDataTransferCallbackProxy$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            CompanionDeviceManager.SystemDataTransferCallbackProxy.this
                                    .lambda$onResult$0();
                        }
                    });
        }
        ...
        public void onError(final String error) {
            this.mExecutor.execute(
                    new Runnable() { // from class:
                        // android.companion.CompanionDeviceManager$SystemDataTransferCallbackProxy$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CompanionDeviceManager.SystemDataTransferCallbackProxy.this
                                    .lambda$onError$1(error);
                        }
                    });
        }
    }
    ...
    class Transport {
        ...
        public void start() throws IOException {
            if (CompanionDeviceManager.this.mService == null) {
                Log.w(
                        CompanionDeviceManager.TAG,
                        "CompanionDeviceManager service is not available.");
                return;
            }
            ...
            try {
                CompanionDeviceManager.this.mService.attachSystemDataTransport(
                        CompanionDeviceManager.this.mContext.getOpPackageName(),
                        CompanionDeviceManager.this.mContext.getUserId(),
                        this.mAssociationId,
                        remoteFd);
                new Thread(
                                new Runnable() { // from class:
                                    // android.companion.CompanionDeviceManager$Transport$$ExternalSyntheticLambda0
                                    @Override // java.lang.Runnable
                                    public final void run() {
                ...
                new Thread(
                                new Runnable() { // from class:
                                    // android.companion.CompanionDeviceManager$Transport$$ExternalSyntheticLambda1
                                    @Override // java.lang.Runnable
                                    public final void run() {
        ...
        public void stop() {
            ...
            this.mStopped = true;
            try {
                CompanionDeviceManager.this.mService.detachSystemDataTransport(
                        CompanionDeviceManager.this.mContext.getOpPackageName(),
                        CompanionDeviceManager.this.mContext.getUserId(),
                        this.mAssociationId);
