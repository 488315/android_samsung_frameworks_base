...
public final class CompanionDeviceManager {
  ...
  public void requestNotificationAccess(ComponentName component) {
    ...
    try {
      IntentSender intentSender =
          this.mService
              .requestNotificationAccess(component, this.mContext.getUserId())
              .getIntentSender();
  ...
  public void addOnTransportsChangedListener(
      Executor executor, OnTransportsChangedListener listener) {
  ...
  public void removeOnTransportsChangedListener(
      OnTransportsChangedListener onTransportsChangedListener) {
    try {
      this.mService.removeOnTransportsChangedListener(
          new OnTransportsChangedListenerProxy(null, onTransportsChangedListener));
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void addOnMessageReceivedListener(
      Executor executor, int messageType, OnMessageReceivedListener listener) {
  ...
  public void removeOnMessageReceivedListener(
      int i, OnMessageReceivedListener onMessageReceivedListener) {
    try {
      this.mService.removeOnMessageReceivedListener(
          i, new OnMessageReceivedListenerProxy(null, onMessageReceivedListener));
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void startObservingDevicePresence(String deviceAddress)
    ...
    try {
      this.mService.registerDevicePresenceListenerService(
  ...
  public void stopObservingDevicePresence(String deviceAddress)
    ...
    Objects.requireNonNull(deviceAddress, "address cannot be null");
    try {
      this.mService.unregisterDevicePresenceListenerService(
  ...
  public void dispatchMessage(int messageId, int associationId, byte[] message)
      throws DeviceNotAssociatedException {
    Log.m102w(LOG_TAG, "dispatchMessage replaced by attachSystemDataTransport");
  }
  ...
  public void startSystemDataTransfer(int associationId) throws DeviceNotAssociatedException {
    try {
      this.mService.startSystemDataTransfer(
          this.mContext.getOpPackageName(), this.mContext.getUserId(), associationId, null);
    } catch (RemoteException e) {
      ExceptionUtils.propagateIfInstanceOf(e.getCause(), DeviceNotAssociatedException.class);
      throw e.rethrowFromSystemServer();
    }
    ...
    public void onMessageReceived(final int associationId, final byte[] data) {
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              CompanionDeviceManager.OnMessageReceivedListenerProxy.this.lambda$onMessageReceived$0(
                  associationId, data);
            }
          });
    }
    ...
    public void start() throws IOException {
      ...
      try {
        CompanionDeviceManager.this.mService.attachSystemDataTransport(
            CompanionDeviceManager.this.mContext.getPackageName(),
