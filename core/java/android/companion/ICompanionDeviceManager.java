...
public interface ICompanionDeviceManager extends IInterface {
  void addOnAssociationsChangedListener(
      IOnAssociationsChangedListener iOnAssociationsChangedListener, int i) throws RemoteException;
  ...
  void attachSystemDataTransport(
      String str, int i, int i2, ParcelFileDescriptor parcelFileDescriptor) throws RemoteException;
  ...
  void removeOnMessageReceivedListener(int i, IOnMessageReceivedListener iOnMessageReceivedListener)
      throws RemoteException;

  void removeOnTransportsChangedListener(IOnTransportsChangedListener iOnTransportsChangedListener)
      throws RemoteException;
  ...
  void unregisterDevicePresenceListenerService(String str, String str2, int i)
      throws RemoteException;
  ...
  public static class Default implements ICompanionDeviceManager {
    ...
    @Override // android.companion.ICompanionDeviceManager
    public void addOnMessageReceivedListener(int messageType, IOnMessageReceivedListener listener)
        throws RemoteException {}
    ...
    public void startSystemDataTransfer(
        String packageName, int userId, int associationId, ISystemDataTransferCallback callback)
        throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 12:
              ...
              return true;
            case 13:
              IOnAssociationsChangedListener _arg013 =
                  IOnAssociationsChangedListener.Stub.asInterface(data.readStrongBinder());
              ...
              return true;
            case 14:
              IOnAssociationsChangedListener _arg014 =
                  IOnAssociationsChangedListener.Stub.asInterface(data.readStrongBinder());
              ...
              return true;
            case 15:
              IOnTransportsChangedListener _arg015 =
              ...
              return true;
            case 16:
              IOnTransportsChangedListener _arg016 =
                  IOnTransportsChangedListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 18:
              ...
              IOnMessageReceivedListener _arg113 =
            ...
            case 19:
              ...
              IOnMessageReceivedListener _arg114 =
                  IOnMessageReceivedListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 22:
              ...
              PendingIntent _result7 =
                  buildPermissionTransferUserConsentIntent(_arg022, _arg115, _arg29);
              reply.writeNoException();
