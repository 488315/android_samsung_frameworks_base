...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(
                    Arrays.asList(
                            Flags.FLAG_CAMERA_DEVICE_AWARENESS,
                            Flags.FLAG_DEVICE_AWARE_DRM,
                            Flags.FLAG_DEVICE_AWARE_RECORD_AUDIO_PERMISSION,
                            Flags.FLAG_INTENT_INTERCEPTION_ACTION_MATCHING_FIX,
                            Flags.FLAG_METRICS_COLLECTION,
                            Flags.FLAG_VIRTUAL_CAMERA_SERVICE_DISCOVERY,
                            Flags.FLAG_VIRTUAL_DISPLAY_MULTI_WINDOW_MODE_SUPPORT,
                            ""));
    ...
    public boolean cameraDeviceAwareness() {
        return getValue(
                ...
                new Predicate() { // from class:
                    // android.companion.virtualdevice.flags.CustomFeatureFlags$$ExternalSyntheticLambda6
    ...
    public boolean deviceAwareDrm() {
        return getValue(
                Flags.FLAG_DEVICE_AWARE_DRM,
                new Predicate() { // from class:
                    // android.companion.virtualdevice.flags.CustomFeatureFlags$$ExternalSyntheticLambda3
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean deviceAwareRecordAudioPermission() {
        return getValue(
                Flags.FLAG_DEVICE_AWARE_RECORD_AUDIO_PERMISSION,
                new Predicate() { // from class:
                    // android.companion.virtualdevice.flags.CustomFeatureFlags$$ExternalSyntheticLambda4
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean intentInterceptionActionMatchingFix() {
        return getValue(
                Flags.FLAG_INTENT_INTERCEPTION_ACTION_MATCHING_FIX,
                new Predicate() { // from class:
                    // android.companion.virtualdevice.flags.CustomFeatureFlags$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean metricsCollection() {
        return getValue(
                Flags.FLAG_METRICS_COLLECTION,
                new Predicate() { // from class:
                    // android.companion.virtualdevice.flags.CustomFeatureFlags$$ExternalSyntheticLambda5
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean virtualCameraServiceDiscovery() {
        return getValue(
                Flags.FLAG_VIRTUAL_CAMERA_SERVICE_DISCOVERY,
                new Predicate() { // from class:
                    // android.companion.virtualdevice.flags.CustomFeatureFlags$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean virtualDisplayMultiWindowModeSupport() {
        return getValue(
                Flags.FLAG_VIRTUAL_DISPLAY_MULTI_WINDOW_MODE_SUPPORT,
                new Predicate() { // from class:
                    // android.companion.virtualdevice.flags.CustomFeatureFlags$$ExternalSyntheticLambda2
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
