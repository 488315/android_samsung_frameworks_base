...
public abstract class CompanionDeviceService extends Service {
    ...
    public void onMessageDispatchedFromSystem(int messageId, int associationId, byte[] message) {
        Log.m102w(LOG_TAG, "Replaced by attachSystemDataTransport");
    }
    ...
    public final IBinder onBind(Intent intent) {
        ...
        Log.m102w(LOG_TAG, "Tried to bind to wrong intent (should be android.companion.CompanionDeviceService): " + intent);
        return null;
    }
