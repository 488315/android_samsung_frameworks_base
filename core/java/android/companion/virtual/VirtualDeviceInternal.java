...
public class VirtualDeviceInternal {
  ...
  private final ArrayMap<VirtualDeviceManager.IntentInterceptorCallback, IntentInterceptorDelegate>
  ...
  VirtualDeviceInternal(
      IVirtualDeviceManager service, Context context, int associationId, VirtualDeviceParams params)
      throws RemoteException {
    IVirtualDeviceActivityListener.Stub stub =
              ...
              synchronized (VirtualDeviceInternal.this.mActivityListenersLock) {
                for (int i = 0; i < VirtualDeviceInternal.this.mActivityListeners.size(); i++) {
                  ((ActivityListenerDelegate)
                          VirtualDeviceInternal.this.mActivityListeners.valueAt(i))
    ...
    IVirtualDeviceSoundEffectListener.Stub stub2 =
              ...
              synchronized (VirtualDeviceInternal.this.mSoundEffectListenersLock) {
                for (int i = 0; i < VirtualDeviceInternal.this.mSoundEffectListeners.size(); i++) {
                  ((SoundEffectListenerDelegate)
                          VirtualDeviceInternal.this.mSoundEffectListeners.valueAt(i))
    ...
    this.mVirtualDevice =
        service.createVirtualDevice(
            new Binder(), applicationContext.getPackageName(), associationId, params, stub, stub2);
  }
  ...
  void launchPendingIntent(
    ...
    try {
      this.mVirtualDevice.launchPendingIntent(
          displayId,
          pendingIntent,
          new ResultReceiverC05903(new Handler(Looper.getMainLooper()), executor, listener));
    } catch (RemoteException e) {
  ...
  class ResultReceiverC05903 extends ResultReceiver {
    final /* synthetic */ Executor val$executor;
    final /* synthetic */ IntConsumer val$listener;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ResultReceiverC05903(Handler handler, Executor executor, IntConsumer intConsumer) {
      super(handler);
    ...
    try {
      int displayId =
          this.mService.createVirtualDisplay(
              config, callbackWrapper, this.mVirtualDevice, this.mContext.getPackageName());
  ...
  VirtualNavigationTouchpad createVirtualNavigationTouchpad(
    ...
    try {
      IBinder token =
          new Binder(
              "android.hardware.input.VirtualNavigationTouchpad:" + config.getInputDeviceName());
  ...
  void addSoundEffectListener(
    ...
    SoundEffectListenerDelegate delegate =
        new SoundEffectListenerDelegate(
            (Executor) Objects.requireNonNull(executor),
            (VirtualDeviceManager.SoundEffectListener) Objects.requireNonNull(soundEffectListener));
    ...
    public void onTopActivityChanged(final int displayId, final ComponentName topActivity) {
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              VirtualDeviceInternal.ActivityListenerDelegate.this.lambda$onTopActivityChanged$0(
                  displayId, topActivity);
            }
          });
    }
    ...
    public void onTopActivityChanged(
      ...
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              VirtualDeviceInternal.ActivityListenerDelegate.this.lambda$onTopActivityChanged$1(
                  displayId, topActivity, userId);
            }
          });
    }
    ...
    public void onDisplayEmpty(final int displayId) {
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              VirtualDeviceInternal.ActivityListenerDelegate.this.lambda$onDisplayEmpty$2(
                  displayId);
            }
          });
    }
  ...
  static class IntentInterceptorDelegate extends IVirtualDeviceIntentInterceptor.Stub {
    ...
    private IntentInterceptorDelegate(
        Executor executor, VirtualDeviceManager.IntentInterceptorCallback interceptorCallback) {
      this.mExecutor = executor;
      ...
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                VirtualDeviceInternal.IntentInterceptorDelegate.this.lambda$onIntentIntercepted$0(
                    intent);
              }
            });
      } finally {
    ...
    public void onPlaySoundEffect(final int effectType) {
      this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              VirtualDeviceInternal.SoundEffectListenerDelegate.this.lambda$onPlaySoundEffect$0(
                  effectType);
            }
          });
    }
