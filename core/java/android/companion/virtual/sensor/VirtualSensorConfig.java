...
public final class VirtualSensorConfig implements Parcelable {
  public static final Parcelable.Creator<VirtualSensorConfig> CREATOR =
      new Parcelable.Creator<
          VirtualSensorConfig>() { // from class:
                                   // android.companion.virtual.sensor.VirtualSensorConfig.1
  ...
  public static final class Builder {
      ...
      if (i > 0) {
        ...
        if ((i2 & 1024) == 0) {
          throw new IllegalArgumentException(
              "Setting direct channel type is required for sensors with direct channel support.");
        }
        this.mFlags = i2 | (i << 7);
      }
      if ((this.mFlags & 1024) > 0 && i == 0) {
        throw new IllegalArgumentException(
            "Highest direct report rate level is required for sensors with direct channel"
                + " support.");
      }
    ...
    public Builder setDirectChannelTypesSupported(int memoryTypes) {
      ...
      if ((memoryTypes & (-2)) > 0) {
        throw new IllegalArgumentException(
            "Only TYPE_MEMORY_FILE direct channels can be supported for virtual sensors.");
      }
      return this;
    }
  }
