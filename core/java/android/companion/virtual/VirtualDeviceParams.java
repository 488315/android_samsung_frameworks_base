...
public final class VirtualDeviceParams implements Parcelable {
  ...
  public static final Parcelable.Creator<VirtualDeviceParams> CREATOR =
      new Parcelable.Creator<
          VirtualDeviceParams>() { // from class: android.companion.virtual.VirtualDeviceParams.1
  ...
  private VirtualDeviceParams(
      ...
      Set<ComponentName> allowedActivities,
      Set<ComponentName> blockedActivities,
    ...
    this.mAllowedCrossTaskNavigations =
        new ArraySet<>((Collection) Objects.requireNonNull(allowedCrossTaskNavigations));
    this.mBlockedCrossTaskNavigations =
        new ArraySet<>((Collection) Objects.requireNonNull(blockedCrossTaskNavigations));
    this.mDefaultNavigationPolicy = defaultNavigationPolicy;
    this.mAllowedActivities =
        new ArraySet<>((Collection) Objects.requireNonNull(allowedActivities));
    this.mBlockedActivities =
        new ArraySet<>((Collection) Objects.requireNonNull(blockedActivities));
  ...
  public void writeToParcel(Parcel dest, int flags) {
    ...
    dest.writeStrongBinder(
        iVirtualSensorCallback != null ? iVirtualSensorCallback.asBinder() : null);
  ...
  public boolean equals(Object o) {
    ...
    return i2 == that.mLockState
        ...
        && Objects.equals(this.mAllowedCrossTaskNavigations, that.mAllowedCrossTaskNavigations)
        && Objects.equals(this.mBlockedCrossTaskNavigations, that.mBlockedCrossTaskNavigations)
        && this.mDefaultNavigationPolicy == that.mDefaultNavigationPolicy
        && Objects.equals(this.mAllowedActivities, that.mAllowedActivities)
        && Objects.equals(this.mBlockedActivities, that.mBlockedActivities)
  ...
  public static final class Builder {
    ...
    static class VirtualSensorCallbackDelegate extends IVirtualSensorCallback.Stub {
      ...
      public void onDirectChannelCreated(final int channelHandle, final SharedMemory sharedMemory) {
        Executor executor;
        if (this.mDirectChannelCallback != null
            && (executor = this.mDirectChannelExecutor) != null) {
          executor.execute(
              new Runnable() { // from class:
                ...
                public final void run() {
                  VirtualDeviceParams.Builder.VirtualSensorCallbackDelegate.this
                      .lambda$onDirectChannelCreated$1(channelHandle, sharedMemory);
                }
              });
        }
      }
    ...
    public Builder setAllowedCrossTaskNavigations(Set<ComponentName> allowedCrossTaskNavigations) {
      if (this.mDefaultNavigationPolicyConfigured && this.mDefaultNavigationPolicy != 1) {
        throw new IllegalArgumentException(
            "Allowed cross task navigation and blocked task navigation cannot  both be set.");
      }
    ...
    public Builder setBlockedCrossTaskNavigations(Set<ComponentName> blockedCrossTaskNavigations) {
      if (this.mDefaultNavigationPolicyConfigured && this.mDefaultNavigationPolicy != 0) {
        throw new IllegalArgumentException(
            "Allowed cross task navigation and blocked task navigation cannot  be set.");
      }
    ...
    public VirtualDeviceParams build() {
      ...
      if (!this.mVirtualSensorConfigs.isEmpty()) {
        if (this.mDevicePolicies.get(0, 0) != 1) {
          throw new IllegalArgumentException(
              "DEVICE_POLICY_CUSTOM for POLICY_TYPE_SENSORS is required for creating virtual"
                  + " sensors.");
        }
        ...
        while (true) {
          ...
          if (this.mVirtualSensorConfigs.get(i).getDirectChannelTypesSupported() <= 0) {
            ...
            throw new IllegalArgumentException(
                "VirtualSensorDirectChannelCallback is required for creating virtual sensors that"
      ...
      if ((this.mAudioPlaybackSessionId != 0 || this.mAudioRecordingSessionId != 0)
        ...
        throw new IllegalArgumentException(
            "DEVICE_POLICY_CUSTOM for POLICY_TYPE_AUDIO is required for configuration of"
                + " device-specific audio session ids.");
      }
