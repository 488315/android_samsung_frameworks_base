...
public final class ConnectivityServiceProto {
    ...
    public static final int MQR_SERVICE_INFO_CALLBACK_REGISTERED = 10;
    public static final int MQR_SERVICE_INFO_CALLBACK_REGISTRATION_FAILED = 11;
    public static final int MQR_SERVICE_INFO_CALLBACK_UNREGISTERED = 12;
    ...
    public static final int MQR_SERVICE_RESOLUTION_STOP = 9;
    ...
    public static final int NET_SERVICE_INFO_CALLBACK = 4;
