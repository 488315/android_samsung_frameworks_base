...
public class Camera {
  ...
  public static void getCameraInfo(int cameraId, CameraInfo cameraInfo) {
    boolean overrideToPortrait =
        CameraManager.shouldOverrideToPortrait(
    ...
    try {
      ...
      Log.m96e("Camera", "Audio service is unavailable for queries");
    }
  }
  ...
  private boolean shouldForceSlowJpegMode() {
    ...
    String[] slowJpegPackageNames =
        applicationContext.getResources().getStringArray(C4337R.array.config_forceSlowJpegModeList);
  ...
  private void initAppOps() {
    ...
    try {
      ...
      Log.m97e("Camera", "Error registering appOps callback", e);
  ...
  public final Allocation createPreviewAllocation(RenderScript rs, int usage)
    ...
    Type.Builder yuvBuilder =
        new Type.Builder(
            rs, Element.createPixel(rs, Element.DataType.UNSIGNED_8, Element.DataKind.PIXEL_YUV));
    ...
    if (previewAllocation != null) {
      ...
      if (previewSize.width != previewAllocation.getType().getX()
        ...
        throw new IllegalArgumentException(
            "Allocation dimensions don't match preview dimensions: Allocation is "
  ...
  private class EventHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        case 1:
          Log.m96e("Camera", "Error " + msg.arg1);
        ...
        case 2048:
          ...
          return;
        default:
          Log.m96e("Camera", "Unknown message type " + msg.what);
          return;
      }
    }
  }
  ...
  public final boolean enableShutterSound(boolean enabled) {
    ...
    synchronized (this.mShutterSoundLock) {
      ...
      if (enabled && !this.mHasAppOpsPlayAudio) {
        Log.m98i("Camera", "Shutter sound is not allowed by AppOpsManager");
  ...
  public void updateAppOpsPlayAudio() {
    synchronized (this.mShutterSoundLock) {
      ...
      try {
        ...
        if (iAppOpsService != null) {
          mode =
              iAppOpsService.checkAudioOperation(
                  28, 13, Process.myUid(), ActivityThread.currentPackageName());
        }
        this.mHasAppOpsPlayAudio = mode == 0;
      } catch (RemoteException e) {
        Log.m96e("Camera", "AppOpsService check audio operation failed");
        this.mHasAppOpsPlayAudio = false;
      }
  ...
  public class Parameters {
    ...
    @Deprecated
    public void dump() {
      Log.m96e("Camera", "dump: size=" + this.mMap.size());
      for (String k : this.mMap.keySet()) {
        Log.m96e("Camera", "dump: " + k + "=" + this.mMap.get(k));
      }
    }
    ...
    public void set(String key, String value) {
      if (key.indexOf(61) != -1 || key.indexOf(59) != -1 || key.indexOf(0) != -1) {
        Log.m96e("Camera", "Key \"" + key + "\" contains invalid character (= or ; or \\0)");
      } else if (value.indexOf(61) != -1 || value.indexOf(59) != -1 || value.indexOf(0) != -1) {
        Log.m96e("Camera", "Value \"" + value + "\" contains invalid character (= or ; or \\0)");
      } else {
        put(key, value);
      }
    }
    ...
    private Size strToSize(String str) {
      ...
      Log.m96e("Camera", "Invalid size parameter string=" + str);
      return null;
    }
    ...
    private ArrayList<int[]> splitRange(String str) {
      ...
      if (str == null || str.charAt(0) != '(' || str.charAt(str.length() - 1) != ')') {
        Log.m96e("Camera", "Invalid range list string=" + str);
        return null;
      }
    ...
    private ArrayList<Area> splitArea(String str) {
      int endIndex;
      if (str == null || str.charAt(0) != '(' || str.charAt(str.length() - 1) != ')') {
        Log.m96e("Camera", "Invalid area string=" + str);
        return null;
      }
