...
public interface IFingerprintService extends IInterface {
  ...
  void registerAuthenticators(List<FingerprintSensorPropertiesInternal> list)
      throws RemoteException;
  ...
  void removeAll(
      IBinder iBinder, int i, IFingerprintServiceReceiver iFingerprintServiceReceiver, String str)
      throws RemoteException;

  void removeClientActiveCallback(IFingerprintClientActiveCallback iFingerprintClientActiveCallback)
      throws RemoteException;
  ...
  int semRunSensorTest(
      IBinder iBinder, int i, int i2, ISemFingerprintRequestCallback iSemFingerprintRequestCallback)
      throws RemoteException;
  ...
  public static class Default implements IFingerprintService {
    ...
    public ITestSession createTestSession(
        int sensorId, ITestSessionCallback callback, String opPackageName) throws RemoteException {
      return null;
    }
    ...
    public long detectFingerprint(
        IBinder token, IFingerprintServiceReceiver receiver, FingerprintAuthenticateOptions options)
        throws RemoteException {
      return 0L;
    }
    ...
    public void cancelAuthenticationFromService(
        int sensorId, IBinder token, String opPackageName, long requestId) throws RemoteException {}
    ...
    public void removeAll(
        IBinder token, int userId, IFingerprintServiceReceiver receiver, String opPackageName)
        throws RemoteException {}
    ...
    public void resetLockout(
        IBinder token, int sensorId, int userId, byte[] hardwareAuthToken, String opPackageNAame)
        throws RemoteException {}
    ...
    @Override // android.hardware.fingerprint.IFingerprintService
    public void registerAuthenticators(List<FingerprintSensorPropertiesInternal> hidlSensors)
        throws RemoteException {}
    ...
    @Override // android.hardware.fingerprint.IFingerprintService
    public void semRegisterAodController(IBinder token, ISemFingerprintAodController aodController)
        throws RemoteException {}
    ...
    @Override // android.hardware.fingerprint.IFingerprintService
    public int semRegisterDisplayBrightnessCallback(ISemBiometricSysUiDisplayBrightnessCallback cb)
        throws RemoteException {
      return 0;
    }
  ...
  public abstract static class Stub extends Binder implements IFingerprintService {
          ...
          switch (code) {
            ...
            case 28:
              IBiometricServiceLockoutResetCallback _arg029 =
                  IBiometricServiceLockoutResetCallback.Stub.asInterface(data.readStrongBinder());
            ...
            case 30:
              IFingerprintClientActiveCallback _arg030 =
                  IFingerprintClientActiveCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 31:
              ...
              return true;
            case 32:
              List<FingerprintSensorPropertiesInternal> _arg032 =
            ...
            case 36:
              ...
              return true;
            case 37:
              IUdfpsOverlayController _arg037 =
              ...
              return true;
            case 38:
              ISidefpsController _arg038 =
                  ISidefpsController.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 39:
              ...
              return true;
            case 40:
              IBiometricStateListener _arg040 =
            ...
            case 43:
              ...
              IFingerprintServiceReceiver _arg222 =
                  IFingerprintServiceReceiver.Stub.asInterface(data.readStrongBinder());
            ...
            case 56:
              ...
              ISemFingerprintRequestCallback _arg313 =
                  ISemFingerprintRequestCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 62:
              ...
              ISemFingerprintAodController _arg135 =
            ...
            case 69:
              ...
              ISemFingerprintRequestCallback _arg138 =
                  ISemFingerprintRequestCallback.Stub.asInterface(data.readStrongBinder());
            ...
            case 70:
              ...
              return true;
            case 71:
              ISemBiometricSysUiDisplayStateCallback _arg054 =
                  ISemBiometricSysUiDisplayStateCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 72:
              ...
              return true;
            case 73:
              ISemBiometricSysUiDisplayBrightnessCallback _arg055 =
            ...
            case 82:
              ...
              ISemFingerprintRequestCallback _arg7 =
                  ISemFingerprintRequestCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              int _result45 =
                  semRequest(_arg062, _arg143, _arg228, _arg3, _arg48, _arg53, _arg62, _arg7);
              reply.writeNoException();
      ...
      public List<FingerprintSensorPropertiesInternal> getSensorPropertiesInternal(
        ...
        try {
          ...
          List<FingerprintSensorPropertiesInternal> _result =
              _reply.createTypedArrayList(FingerprintSensorPropertiesInternal.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
        ...
        try {
          ...
          FingerprintSensorPropertiesInternal _result =
              (FingerprintSensorPropertiesInternal)
                  _reply.readTypedObject(FingerprintSensorPropertiesInternal.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
    ...
    protected void resetLockout_enforcePermission() throws SecurityException {
      this.mEnforcer.enforcePermission(
          Manifest.permission.RESET_FINGERPRINT_LOCKOUT, getCallingPid(), getCallingUid());
    }
