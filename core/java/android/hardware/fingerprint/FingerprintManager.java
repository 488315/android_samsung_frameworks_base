...
public class FingerprintManager implements BiometricAuthenticator, BiometricFingerprintConstants {
    ...
    private class OnEnrollCancelListener implements CancellationSignal.OnCancelListener {
        ...
        public void onCancel() {
            Slog.m113d(FingerprintManager.TAG, "Cancel fingerprint enrollment requested for: " + this.mAuthRequestId);
    ...
    private class OnAuthenticationCancelListener implements CancellationSignal.OnCancelListener {
        ...
        @Override // android.os.CancellationSignal.OnCancelListener
        public void onCancel() {
            Slog.m113d(FingerprintManager.TAG, "Cancel fingerprint authentication requested for: " + this.mAuthRequestId);
    ...
    private class OnFingerprintDetectionCancelListener implements CancellationSignal.OnCancelListener {
        ...
        @Override // android.os.CancellationSignal.OnCancelListener
        public void onCancel() {
            Slog.m113d(FingerprintManager.TAG, "Cancel fingerprint detect requested for: " + this.mAuthRequestId);
    ...
    public void addLockoutResetCallback(LockoutResetCallback callback) {
        if (this.mService != null) {
            try {
                ...
                this.mService.addLockoutResetCallback(new BinderC11531(powerManager, callback), this.mContext.getOpPackageName());
                return;
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
            ...
            try {
                ...
                handler.post(new Runnable() { // from class: android.hardware.fingerprint.FingerprintManager$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        FingerprintManager.BinderC11531.lambda$onLockoutReset$0(FingerprintManager.LockoutResetCallback.this, sensorId, wakeLock);
                    }
                });
            } finally {
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Slog.m117i(FingerprintManager.TAG, "handleMessage = " + msg.what + ", " + msg.arg1 + ", " + msg.arg2);
            switch (msg.what) {
                case 100:
    ...
    private float[] createEnrollStageThresholds(Context context) {
        ...
        if (isPowerbuttonFps()) {
            enrollStageThresholdStrings = context.getResources().getStringArray(C4337R.array.config_sfps_enroll_stage_thresholds);
        } else {
            enrollStageThresholdStrings = context.getResources().getStringArray(C4337R.array.config_udfps_enroll_stage_thresholds);
        }
    ...
    public static String getAcquiredString(Context context, int acquireInfo, int vendorCode) {
        ...
        switch (acquireInfo) {
            ...
            case 6:
                String[] msgArray = context.getResources().getStringArray(C4337R.array.fingerprint_acquired_vendor);
    ...
    class BinderC11575 extends ISemFingerprintAodController.Stub {
        ...
        public void turnOnDozeMode() {
            ...
            handler.post(new Runnable() { // from class: android.hardware.fingerprint.FingerprintManager$5$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    FingerprintManager.BinderC11575.lambda$turnOnDozeMode$0(SemFingerprintViewListener.this);
                }
            });
        }
        ...
        public void turnOffDozeMode() {
            ...
            handler.post(new Runnable() { // from class: android.hardware.fingerprint.FingerprintManager$5$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    FingerprintManager.BinderC11575.lambda$turnOffDozeMode$1(SemFingerprintViewListener.this);
                }
            });
        }
        ...
        public void turnOnDozeHlpmMode() {
            ...
            handler.post(new Runnable() { // from class: android.hardware.fingerprint.FingerprintManager$5$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    FingerprintManager.BinderC11575.lambda$turnOnDozeHlpmMode$2(SemFingerprintViewListener.this);
                }
            });
        }
        ...
        public void turnOffDozeHlpmMode() {
            ...
            handler.post(new Runnable() { // from class: android.hardware.fingerprint.FingerprintManager$5$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    FingerprintManager.BinderC11575.lambda$turnOffDozeHlpmMode$3(SemFingerprintViewListener.this);
                }
            });
        }
        ...
        public void hideAodScreen() {
            ...
            handler.post(new Runnable() { // from class: android.hardware.fingerprint.FingerprintManager$5$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    FingerprintManager.BinderC11575.lambda$hideAodScreen$4(SemFingerprintViewListener.this);
                }
            });
        }
    ...
    private static String semGetErrorString(Context context, int errMsg, int vendorCode) {
        if (errMsg == 5 || errMsg == 8) {
            switch (vendorCode) {
                ...
                case 5003:
                    return context.getString(C4337R.string.sem_fingerprint_error_smart_view, context.getString(C4337R.string.sem_fingerprint_app_smart_view));
                default:
                    return context.getString(C4337R.string.fingerprint_error_canceled);
            }
        }
