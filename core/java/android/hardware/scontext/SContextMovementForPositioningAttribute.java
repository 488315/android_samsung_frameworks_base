...
public class SContextMovementForPositioningAttribute extends SContextAttribute {
  ...
  public boolean checkAttribute() {
    if (this.mNomoveDurationThrs < 0) {
      Log.m96e(TAG, "The nomove duration threshold is wrong.");
      return false;
    }
    if (this.mMoveDurationThrs < 0) {
      Log.m96e(TAG, "The move duration threshold is wrong.");
      return false;
    }
    if (this.mMoveDistanceThrs < SContextConstants.ENVIRONMENT_VALUE_UNKNOWN) {
      Log.m96e(TAG, "The move distance threshold is wrong.");
      return false;
    }
    if (this.mMoveMinDurationThrs < 0) {
      Log.m96e(TAG, "The move minimum duration threshold is wrong.");
      return false;
    }
    return true;
  }
