...
public class SContextManager extends SemContextManager {
  ...
  @Deprecated
  public boolean registerListener(
      SContextListener listener, int service, int arg1, int arg2, int arg3, int arg4, int arg5) {
    SContextAttribute attribute = null;
    if (service == 24) {
            ...
            public void handleMessage(Message msg) {
              ...
              if (!SContextListenerDelegate.this.mDereisgeredListener
                ...
                if (SContextListenerDelegate.this.mIsHistoryData) {
                  Log.m94d(
                      SContextManager.TAG,
                      "Data is received so remove listener related HistoryData");
                  ...
                  Log.m94d(
                      SContextManager.TAG,
                      "Listener is already registered and history data is sent to Application");
