...
public final class QosFilterTypeOfService implements Parcelable {
  public static final Parcelable.Creator<QosFilterTypeOfService> CREATOR =
      new Parcelable.Creator<
          QosFilterTypeOfService>() { // from class:
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.data.QosFilterTypeOfService.noinit("
            + getNoinit()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.data.QosFilterTypeOfService.value("
            + ((int) getValue())
            + NavigationBarInflaterView.KEY_CODE_END;
      default:
