...
public final class QosFilterIpv6FlowLabel implements Parcelable {
  public static final Parcelable.Creator<QosFilterIpv6FlowLabel> CREATOR =
      new Parcelable.Creator<
          QosFilterIpv6FlowLabel>() { // from class:
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.data.QosFilterIpv6FlowLabel.noinit("
            + getNoinit()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.data.QosFilterIpv6FlowLabel.value("
            + getValue()
            + NavigationBarInflaterView.KEY_CODE_END;
      default:
