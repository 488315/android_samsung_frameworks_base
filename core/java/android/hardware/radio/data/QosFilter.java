...
public class QosFilter implements Parcelable {
  public static final Parcelable.Creator<QosFilter> CREATOR =
      new Parcelable.Creator<QosFilter>() { // from class: android.hardware.radio.data.QosFilter.1
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.tos =
          (QosFilterTypeOfService) _aidl_parcel.readTypedObject(QosFilterTypeOfService.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
      ...
      this.flowLabel =
          (QosFilterIpv6FlowLabel) _aidl_parcel.readTypedObject(QosFilterIpv6FlowLabel.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
