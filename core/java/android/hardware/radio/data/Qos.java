...
public final class Qos implements Parcelable {
  ...
  /* renamed from: nr */
  public static final int f202nr = 2;
  private int _tag;
  ...
  public @interface Tag {
    ...
    /* renamed from: nr */
    public static final int f203nr = 2;
  }
  ...
  /* renamed from: nr */
  public static Qos m36nr(NrQos _value) {
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.data.Qos.noinit("
            + getNoinit()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.data.Qos.eps("
            + Objects.toString(getEps())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.hardware.radio.data.Qos.nr("
