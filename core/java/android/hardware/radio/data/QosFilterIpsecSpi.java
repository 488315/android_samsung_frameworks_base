...
public final class QosFilterIpsecSpi implements Parcelable {
  public static final Parcelable.Creator<QosFilterIpsecSpi> CREATOR =
      new Parcelable.Creator<
          QosFilterIpsecSpi>() { // from class: android.hardware.radio.data.QosFilterIpsecSpi.1
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.data.QosFilterIpsecSpi.noinit("
            + getNoinit()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.data.QosFilterIpsecSpi.value("
            + getValue()
            + NavigationBarInflaterView.KEY_CODE_END;
      default:
