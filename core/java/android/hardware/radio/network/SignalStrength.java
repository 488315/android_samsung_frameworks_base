...
public class SignalStrength implements Parcelable {
  public static final Parcelable.Creator<SignalStrength> CREATOR =
      new Parcelable.Creator<
          SignalStrength>() { // from class: android.hardware.radio.network.SignalStrength.1
  ...
  /* renamed from: nr */
  public NrSignalStrength f212nr;
  ...
  public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
    ...
    _aidl_parcel.writeTypedObject(this.f212nr, _aidl_flag);
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.tdscdma =
          (TdscdmaSignalStrength) _aidl_parcel.readTypedObject(TdscdmaSignalStrength.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        ...
        this.f212nr = (NrSignalStrength) _aidl_parcel.readTypedObject(NrSignalStrength.CREATOR);
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
        _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
  ...
  public String toString() {
    ...
    _aidl_sj.add("nr: " + Objects.toString(this.f212nr));
