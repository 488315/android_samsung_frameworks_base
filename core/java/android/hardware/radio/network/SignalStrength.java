...
public class SignalStrength implements Parcelable {
    ...
    public int describeContents() {
        ...
        return _mask | describeContents(this.cdma) | describeContents(this.evdo) | describeContents(this.lte) | describeContents(this.tdscdma) | describeContents(this.wcdma) | describeContents(this.f212nr);
    }
