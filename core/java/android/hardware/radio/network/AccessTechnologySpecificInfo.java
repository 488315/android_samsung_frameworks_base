...
public final class AccessTechnologySpecificInfo implements Parcelable {
  public static final Parcelable.Creator<AccessTechnologySpecificInfo> CREATOR =
      new Parcelable.Creator<
          AccessTechnologySpecificInfo>() { // from class:
    ...
    switch (_aidl_tag) {
      ...
      case 2:
        EutranRegistrationInfo _aidl_value3 =
            (EutranRegistrationInfo) _aidl_parcel.readTypedObject(EutranRegistrationInfo.CREATOR);
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.network.AccessTechnologySpecificInfo.noinit("
            + getNoinit()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.network.AccessTechnologySpecificInfo.cdmaInfo("
      ...
      case 2:
        return "android.hardware.radio.network.AccessTechnologySpecificInfo.eutranInfo("
            ...
            + NavigationBarInflaterView.KEY_CODE_END;
      case 3:
        return "android.hardware.radio.network.AccessTechnologySpecificInfo.ngranNrVopsInfo("
            + Objects.toString(getNgranNrVopsInfo())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 4:
        return "android.hardware.radio.network.AccessTechnologySpecificInfo.geranDtmSupported("
