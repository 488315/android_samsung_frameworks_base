...
public interface IRadioNetworkResponse extends IInterface {
  ...
  void getAvailableNetworksResponse(
      RadioResponseInfo radioResponseInfo, OperatorInfo[] operatorInfoArr) throws RemoteException;

  void getBarringInfoResponse(
      RadioResponseInfo radioResponseInfo, CellIdentity cellIdentity, BarringInfo[] barringInfoArr)
      throws RemoteException;
  ...
  void getSignalStrengthResponse(RadioResponseInfo radioResponseInfo, SignalStrength signalStrength)
      throws RemoteException;
  ...
  public static class Default implements IRadioNetworkResponse {
    ...
    @Override // android.hardware.radio.network.IRadioNetworkResponse
    public void getAvailableNetworksResponse(RadioResponseInfo info, OperatorInfo[] networkInfos)
        throws RemoteException {}
    ...
    @Override // android.hardware.radio.network.IRadioNetworkResponse
    public void isNullCipherAndIntegrityEnabledResponse(RadioResponseInfo info, boolean isEnabled)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 13:
              ...
              RadioAccessSpecifier[] _arg112 =
                  (RadioAccessSpecifier[]) data.createTypedArray(RadioAccessSpecifier.CREATOR);
              data.enforceNoDataAvail();
    ...
    private static class Proxy implements IRadioNetworkResponse {
      ...
      public void setLinkCapacityReportingCriteriaResponse(RadioResponseInfo info)
        ...
        try {
          ...
          if (!_status) {
            throw new RemoteException(
                "Method setLinkCapacityReportingCriteriaResponse is unimplemented.");
          }
        } finally {
          _data.recycle();
        }
      ...
      public void setNetworkSelectionModeAutomaticResponse(RadioResponseInfo info)
        ...
        try {
          ...
          if (!_status) {
            throw new RemoteException(
                "Method setNetworkSelectionModeAutomaticResponse is unimplemented.");
          }
        } finally {
          _data.recycle();
        }
      ...
      public void setSignalStrengthReportingCriteriaResponse(RadioResponseInfo info)
        ...
        try {
          ...
          if (!_status) {
            throw new RemoteException(
                "Method setSignalStrengthReportingCriteriaResponse is unimplemented.");
          }
        } finally {
          _data.recycle();
        }
      ...
      public void setNullCipherAndIntegrityEnabledResponse(RadioResponseInfo info)
        ...
        try {
          ...
          if (!_status) {
            throw new RemoteException(
                "Method setNullCipherAndIntegrityEnabledResponse is unimplemented.");
          }
        } finally {
          _data.recycle();
        }
