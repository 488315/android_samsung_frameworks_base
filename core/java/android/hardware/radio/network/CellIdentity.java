...
public final class CellIdentity implements Parcelable {
  ...
  /* renamed from: nr */
  public static final int f205nr = 6;
  ...
  public @interface Tag {
    ...
    /* renamed from: nr */
    public static final int f206nr = 6;
    public static final int tdscdma = 3;
    public static final int wcdma = 2;
  }
  ...
  /* renamed from: nr */
  public static CellIdentity m37nr(CellIdentityNr _value) {
    ...
    switch (_aidl_tag) {
      ...
      case 3:
        CellIdentityTdscdma _aidl_value4 =
            (CellIdentityTdscdma) _aidl_parcel.readTypedObject(CellIdentityTdscdma.CREATOR);
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.network.CellIdentity.noinit("
            + getNoinit()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.network.CellIdentity.gsm("
            + Objects.toString(getGsm())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.hardware.radio.network.CellIdentity.wcdma("
            + Objects.toString(getWcdma())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 3:
        return "android.hardware.radio.network.CellIdentity.tdscdma("
            + Objects.toString(getTdscdma())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 4:
        return "android.hardware.radio.network.CellIdentity.cdma("
            + Objects.toString(getCdma())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 5:
        return "android.hardware.radio.network.CellIdentity.lte("
            + Objects.toString(getLte())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 6:
        return "android.hardware.radio.network.CellIdentity.nr("
