...
public interface IRadioNetwork extends IInterface {
  ...
  void setResponseFunctions(
      IRadioNetworkResponse iRadioNetworkResponse, IRadioNetworkIndication iRadioNetworkIndication)
  ...
  void setSystemSelectionChannels(int i, boolean z, RadioAccessSpecifier[] radioAccessSpecifierArr)
      throws RemoteException;
  ...
  public static class Default implements IRadioNetwork {
    ...
    public void setResponseFunctions(
        IRadioNetworkResponse radioNetworkResponse, IRadioNetworkIndication radioNetworkIndication)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 29:
              ...
              SignalThresholdInfo[] _arg112 =
                  (SignalThresholdInfo[]) data.createTypedArray(SignalThresholdInfo.CREATOR);
              data.enforceNoDataAvail();
