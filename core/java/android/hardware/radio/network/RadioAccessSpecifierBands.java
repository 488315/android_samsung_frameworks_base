...
public final class RadioAccessSpecifierBands implements Parcelable {
  public static final Parcelable.Creator<RadioAccessSpecifierBands> CREATOR =
      new Parcelable.Creator<
          RadioAccessSpecifierBands>() { // from class:
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.network.RadioAccessSpecifierBands.noinit("
            + getNoinit()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.network.RadioAccessSpecifierBands.geranBands("
            + GeranBands$$.arrayToString(getGeranBands())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.hardware.radio.network.RadioAccessSpecifierBands.utranBands("
            + UtranBands$$.arrayToString(getUtranBands())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 3:
        return "android.hardware.radio.network.RadioAccessSpecifierBands.eutranBands("
            + EutranBands$$.arrayToString(getEutranBands())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 4:
        return "android.hardware.radio.network.RadioAccessSpecifierBands.ngranBands("
