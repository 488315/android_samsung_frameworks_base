...
public final class CellInfoRatSpecificInfo implements Parcelable {
  public static final Parcelable.Creator<CellInfoRatSpecificInfo> CREATOR =
      new Parcelable.Creator<
          CellInfoRatSpecificInfo>() { // from class:
  ...
  /* renamed from: nr */
  public static final int f208nr = 4;
  ...
  public @interface Tag {
    ...
    /* renamed from: nr */
    public static final int f209nr = 4;
    public static final int tdscdma = 2;
    public static final int wcdma = 1;
  }
  ...
  /* renamed from: nr */
  public static CellInfoRatSpecificInfo m38nr(CellInfoNr _value) {
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.network.CellInfoRatSpecificInfo.gsm("
            + Objects.toString(getGsm())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.network.CellInfoRatSpecificInfo.wcdma("
            + Objects.toString(getWcdma())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.hardware.radio.network.CellInfoRatSpecificInfo.tdscdma("
            + Objects.toString(getTdscdma())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 3:
        return "android.hardware.radio.network.CellInfoRatSpecificInfo.lte("
            + Objects.toString(getLte())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 4:
        return "android.hardware.radio.network.CellInfoRatSpecificInfo.nr("
            + Objects.toString(getNr())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 5:
        return "android.hardware.radio.network.CellInfoRatSpecificInfo.cdma("
