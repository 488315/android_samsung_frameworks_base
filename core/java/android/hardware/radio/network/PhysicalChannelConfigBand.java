...
public final class PhysicalChannelConfigBand implements Parcelable {
  public static final Parcelable.Creator<PhysicalChannelConfigBand> CREATOR =
      new Parcelable.Creator<
          PhysicalChannelConfigBand>() { // from class:
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.radio.network.PhysicalChannelConfigBand.noinit("
            + getNoinit()
            + NavigationBarInflaterView.KEY_CODE_END;
      case 1:
        return "android.hardware.radio.network.PhysicalChannelConfigBand.geranBand("
            + GeranBands$$.toString(getGeranBand())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 2:
        return "android.hardware.radio.network.PhysicalChannelConfigBand.utranBand("
            + UtranBands$$.toString(getUtranBand())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 3:
        return "android.hardware.radio.network.PhysicalChannelConfigBand.eutranBand("
            + EutranBands$$.toString(getEutranBand())
            + NavigationBarInflaterView.KEY_CODE_END;
      case 4:
        return "android.hardware.radio.network.PhysicalChannelConfigBand.ngranBand("
