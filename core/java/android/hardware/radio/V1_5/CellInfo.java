...
public final class CellInfo {
  ...
  public static final class CellInfoRatSpecificInfo {
    ...
    public static final class hidl_discriminator {
      ...
      /* renamed from: nr */
      public static final byte f193nr = 4;
    ...
    /* renamed from: nr */
    public void m31nr(CellInfoNr nr) {
      this.hidl_d = (byte) 4;
      this.hidl_o = nr;
    }

    /* renamed from: nr */
    public CellInfoNr m30nr() {
      if (this.hidl_d != 4) {
        Object obj = this.hidl_o;
        String className =
            obj != null ? obj.getClass().getName() : SemCapabilities.FEATURE_TAG_NULL;
    ...
    public static final ArrayList<CellInfoRatSpecificInfo> readVectorFromParcel(HwParcel parcel) {
      ...
      HwBlob childBlob =
          parcel.readEmbeddedBuffer(_hidl_vec_size * 192, _hidl_blob.handle(), 0L, true);
      _hidl_vec.clear();
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
      ...
      switch (this.hidl_d) {
        ...
        case 3:
          ...
          return;
        case 4:
          m30nr().writeEmbeddedToBlob(_hidl_blob, 8 + _hidl_offset);
          return;
        case 5:
