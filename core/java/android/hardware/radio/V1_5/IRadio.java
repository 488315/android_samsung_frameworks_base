...
public interface IRadio extends android.hardware.radio.V1_4.IRadio {
    ...
    @Override // android.hardware.radio.V1_4.IRadio, android.hardware.radio.V1_3.IRadio,
    ...
    void setLinkCapacityReportingCriteria_1_5(
            int i,
            int i2,
            int i3,
            int i4,
    ...
    void setSignalStrengthReportingCriteria_1_5(
            int i, SignalThresholdInfo signalThresholdInfo, int i2) throws RemoteException;

    void setSystemSelectionChannels_1_5(int i, boolean z, ArrayList<RadioAccessSpecifier> arrayList)
            throws RemoteException;

    void setupDataCall_1_5(
            int i,
            int i2,
    ...
    public static final class Proxy implements IRadio {
        ...
        public void startNetworkScan(
                int serial, android.hardware.radio.V1_1.NetworkScanRequest request)
                throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.radio.V1_1.IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
        ...
        public void setSystemSelectionChannels(
                ...
                ArrayList<android.hardware.radio.V1_1.RadioAccessSpecifier> specifiers)
                throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            ...
            android.hardware.radio.V1_1.RadioAccessSpecifier.writeVectorToParcel(
        ...
        @Override // android.hardware.radio.V1_5.IRadio
        public void startNetworkScan_1_5(int serial, NetworkScanRequest request)
                throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IRadio.kInterfaceName);
            _hidl_request.writeInt32(serial);
        ...
        public void onTransact(
            ...
            switch (_hidl_code) {
                ...
                case 143:
                    ...
                    ArrayList<android.hardware.radio.V1_1.RadioAccessSpecifier> specifiers =
                            android.hardware.radio.V1_1.RadioAccessSpecifier.readVectorFromParcel(
                                    _hidl_request);
                ...
                case 160:
                    ...
                    ArrayList<RadioAccessSpecifier> specifiers2 =
