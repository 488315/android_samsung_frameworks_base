...
public final class CellInfoWcdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.cellIdentityWcdma, other.cellIdentityWcdma)
                && HidlSupport.deepEquals(this.signalStrengthWcdma, other.signalStrengthWcdma)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(HidlSupport.deepHashCode(this.signalStrengthWcdma)));
    }
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<CellInfoWcdma> _hidl_vec) {
