...
public final class ClosedSubscriberGroupInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.csgIndication == other.csgIndication
                && HidlSupport.deepEquals(this.homeNodebName, other.homeNodebName)
                && this.csgIdentity == other.csgIdentity) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.csgIndication))),
                Integer.valueOf(HidlSupport.deepHashCode(this.homeNodebName)),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.csgIdentity))));
    }
    ...
    public final void readEmbeddedFromParcel(
        ...
        parcel.readEmbeddedBuffer(
                this.homeNodebName.getBytes().length + 1,
                _hidl_blob.handle(),
                _hidl_offset + 8 + 0,
                false);
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<ClosedSubscriberGroupInfo> _hidl_vec) {
