...
public final class CellIdentity {
  ...
  public static final class hidl_discriminator {
    ...
    /* renamed from: nr */
    public static final byte f192nr = 6;
  ...
  /* renamed from: nr */
  public void m29nr(CellIdentityNr nr) {
    this.hidl_d = (byte) 6;
    this.hidl_o = nr;
  }

  /* renamed from: nr */
  public CellIdentityNr m28nr() {
    if (this.hidl_d != 6) {
      Object obj = this.hidl_o;
      String className = obj != null ? obj.getClass().getName() : SemCapabilities.FEATURE_TAG_NULL;
      throw new IllegalStateException(
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    ...
    switch (this.hidl_d) {
      ...
      case 5:
        ...
        return;
      case 6:
        m28nr().writeEmbeddedToBlob(_hidl_blob, 8 + _hidl_offset);
        return;
      default:
        throw new Error("Unknown union discriminator (value: " + ((int) this.hidl_d) + ").");
    }
