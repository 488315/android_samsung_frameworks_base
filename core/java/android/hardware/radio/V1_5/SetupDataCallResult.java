...
public final class SetupDataCallResult {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.suggestedRetryTime))),
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    parcel.readEmbeddedBuffer(
        r8.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 24 + 0, false);
    int _hidl_vec_size = _hidl_blob.getInt32(_hidl_offset + 40 + 8);
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size * 40, _hidl_blob.handle(), _hidl_offset + 40 + 0, true);
    ...
    HwBlob childBlob2 =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size2 * 16, _hidl_blob.handle(), _hidl_offset + 56 + 0, true);
    this.dnses.clear();
    ...
    HwBlob childBlob3 =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size3 * 16, _hidl_blob.handle(), _hidl_offset + 72 + 0, true);
    this.gateways.clear();
    ...
    HwBlob childBlob4 =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size4 * 16, _hidl_blob.handle(), _hidl_offset + 88 + 0, true);
    this.pcscf.clear();
