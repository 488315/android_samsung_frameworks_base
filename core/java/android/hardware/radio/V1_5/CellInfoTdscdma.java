...
public final class CellInfoTdscdma {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.cellIdentityTdscdma, other.cellIdentityTdscdma)
        && HidlSupport.deepEquals(this.signalStrengthTdscdma, other.signalStrengthTdscdma)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(this.signalStrengthTdscdma)));
  }
  ...
  public static final ArrayList<CellInfoTdscdma> readVectorFromParcel(HwParcel parcel) {
    ...
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(_hidl_vec_size * 160, _hidl_blob.handle(), 0L, true);
    _hidl_vec.clear();
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    this.signalStrengthTdscdma.readEmbeddedFromParcel(parcel, _hidl_blob, 144 + _hidl_offset);
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<CellInfoTdscdma> _hidl_vec) {
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    ...
    this.signalStrengthTdscdma.writeEmbeddedToBlob(_hidl_blob, 144 + _hidl_offset);
  }
}
