...
public final class NetworkScanRequest {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.type == other.type
        ...
        && HidlSupport.deepEquals(this.specifiers, other.specifiers)
        && this.maxSearchTime == other.maxSearchTime
        && this.incrementalResults == other.incrementalResults
        && this.incrementalResultsPeriodicity == other.incrementalResultsPeriodicity
        && HidlSupport.deepEquals(this.mccMncs, other.mccMncs)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.interval))),
        Integer.valueOf(HidlSupport.deepHashCode(this.specifiers)),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.maxSearchTime))),
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.incrementalResults))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Integer.valueOf(this.incrementalResultsPeriodicity))),
        Integer.valueOf(HidlSupport.deepHashCode(this.mccMncs)));
  }

  public final String toString() {
    return "{.type = "
        + ScanType.toString(this.type)
        + ", .interval = "
        + this.interval
        + ", .specifiers = "
        + this.specifiers
        ...
        + this.incrementalResultsPeriodicity
        + ", .mccMncs = "
        + this.mccMncs
        + "}";
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<NetworkScanRequest> _hidl_vec) {
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    ...
    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
      this.specifiers.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 48);
    }
    ...
    for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size2; _hidl_index_02++) {
      childBlob2.putString(_hidl_index_02 * 16, this.mccMncs.get(_hidl_index_02));
    }
