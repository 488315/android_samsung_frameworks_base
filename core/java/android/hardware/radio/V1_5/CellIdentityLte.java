...
public final class CellIdentityLte {
  public android.hardware.radio.V1_2.CellIdentityLte base =
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.base, other.base)
        ...
        && HidlSupport.deepEquals(this.optionalCsgInfo, other.optionalCsgInfo)
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(this.optionalCsgInfo)),
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    HwBlob childBlob2 =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size2 * 4, _hidl_blob.handle(), 0 + _hidl_offset + 144, true);
    this.bands.clear();
