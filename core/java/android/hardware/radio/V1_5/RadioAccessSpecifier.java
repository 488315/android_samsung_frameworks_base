    ...
    public final void readEmbeddedFromParcel(
      ...
      switch (int8) {
        ...
        case 1:
          ...
          HwBlob childBlob2 =
              parcel.readEmbeddedBuffer(
                  _hidl_vec_size2 * 4, _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
          ((ArrayList) this.hidl_o).clear();
        ...
        case 2:
          ...
          HwBlob childBlob3 =
              parcel.readEmbeddedBuffer(
                  _hidl_vec_size3 * 4, _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
          ((ArrayList) this.hidl_o).clear();
        ...
        case 3:
          ...
          HwBlob childBlob4 =
              parcel.readEmbeddedBuffer(
                  _hidl_vec_size4 * 4, _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
          ((ArrayList) this.hidl_o).clear();
