...
public interface ITunerCallback extends IInterface {
  ...
  public abstract static class Stub extends Binder implements ITunerCallback {
        ...
        default:
          switch (code) {
            ...
            case 2:
              ...
              return true;
            case 3:
              RadioManager.BandConfig _arg03 =
                  (RadioManager.BandConfig) data.readTypedObject(RadioManager.BandConfig.CREATOR);
              data.enforceNoDataAvail();
              onConfigurationChanged(_arg03);
              return true;
            case 4:
              RadioManager.ProgramInfo _arg04 =
                  (RadioManager.ProgramInfo) data.readTypedObject(RadioManager.ProgramInfo.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 10:
              ...
              return true;
            case 11:
              ProgramList.Chunk _arg09 =
                  (ProgramList.Chunk) data.readTypedObject(ProgramList.Chunk.CREATOR);
              data.enforceNoDataAvail();
              ...
              IntStream.range(0, N)
                  .forEach(
                      new IntConsumer() { // from class:
                                          // android.hardware.radio.ITunerCallback$Stub$$ExternalSyntheticLambda0
          ...
          if (parameters == null) {
            ...
            parameters.forEach(
                new BiConsumer() { // from class:
                                   // android.hardware.radio.ITunerCallback$Stub$Proxy$$ExternalSyntheticLambda0
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    ITunerCallback.Stub.Proxy.lambda$onParametersUpdated$0(
