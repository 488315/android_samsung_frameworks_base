...
public interface IRadioIndication extends android.hardware.radio.V1_3.IRadioIndication {
  ...
  void currentEmergencyNumberList(int i, ArrayList<EmergencyNumber> arrayList)
      throws RemoteException;

  void currentPhysicalChannelConfigs_1_4(int i, ArrayList<PhysicalChannelConfig> arrayList)
      throws RemoteException;

  void currentSignalStrength_1_4(int i, SignalStrength signalStrength) throws RemoteException;

  void dataCallListChanged_1_4(int i, ArrayList<SetupDataCallResult> arrayList)
      throws RemoteException;
  ...
  public static final class Proxy implements IRadioIndication {
    ...
    @Override // android.hardware.radio.V1_4.IRadioIndication
    public void dataCallListChanged_1_4(int type, ArrayList<SetupDataCallResult> dcList)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(IRadioIndication.kInterfaceName);
      _hidl_request.writeInt32(type);
    ...
    @Override // android.hardware.radio.V1_4.IRadioIndication
    public void currentSignalStrength_1_4(int type, SignalStrength signalStrength)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(IRadioIndication.kInterfaceName);
      _hidl_request.writeInt32(type);
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        ...
        case 57:
          ...
          ArrayList<PhysicalChannelConfig> configs3 =
        ...
        case 58:
          ...
          ArrayList<SetupDataCallResult> dcList2 =
