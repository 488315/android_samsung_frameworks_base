...
public final class NetworkScanResult {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.status == other.status
        ...
        && HidlSupport.deepEquals(this.networkInfos, other.networkInfos)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.error))),
        Integer.valueOf(HidlSupport.deepHashCode(this.networkInfos)));
  }

  public final String toString() {
    return "{.status = "
        + ScanStatus.toString(this.status)
        + ", .error = "
        + RadioError.toString(this.error)
        + ", .networkInfos = "
        + this.networkInfos
        + "}";
  }
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size * 136, _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<NetworkScanResult> _hidl_vec) {
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    ...
    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
      this.networkInfos.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 136);
    }
