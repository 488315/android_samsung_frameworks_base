...
public final class EmergencyNumber {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.number, other.number)
                ...
                && HidlSupport.deepEquals(
                        Integer.valueOf(this.sources), Integer.valueOf(other.sources))) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(
        ...
        parcel.readEmbeddedBuffer(
                this.mcc.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
        this.mnc = _hidl_blob.getString(_hidl_offset + 32);
        parcel.readEmbeddedBuffer(
                this.mnc.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 32 + 0, false);
