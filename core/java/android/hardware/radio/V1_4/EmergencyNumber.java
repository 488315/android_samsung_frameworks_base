...
public final class EmergencyNumber {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.number, other.number)
        && HidlSupport.deepEquals(this.mcc, other.mcc)
        && HidlSupport.deepEquals(this.mnc, other.mnc)
        && HidlSupport.deepEquals(
            Integer.valueOf(this.categories), Integer.valueOf(other.categories))
        && HidlSupport.deepEquals(this.urns, other.urns)
        && HidlSupport.deepEquals(Integer.valueOf(this.sources), Integer.valueOf(other.sources))) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.categories))),
        Integer.valueOf(HidlSupport.deepHashCode(this.urns)),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.sources))));
  }
  ...
  public final String toString() {
    return "{.number = "
        ...
        + this.mnc
        + ", .categories = "
        + EmergencyServiceCategory.dumpBitfield(this.categories)
        + ", .urns = "
        + this.urns
        + ", .sources = "
        + EmergencyNumberSource.dumpBitfield(this.sources)
        + "}";
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<EmergencyNumber> _hidl_vec) {
