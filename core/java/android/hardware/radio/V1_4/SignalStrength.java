...
public final class SignalStrength {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.gsm, other.gsm)
        ...
        && HidlSupport.deepEquals(this.f190nr, other.f190nr)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(this.f190nr)));
  }
  ...
  public static final ArrayList<SignalStrength> readVectorFromParcel(HwParcel parcel) {
    ...
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(_hidl_vec_size * 108, _hidl_blob.handle(), 0L, true);
    _hidl_vec.clear();
