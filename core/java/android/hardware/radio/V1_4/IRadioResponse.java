...
public interface IRadioResponse extends android.hardware.radio.V1_3.IRadioResponse {
  ...
  void getAllowedCarriersResponse_1_4(
      RadioResponseInfo radioResponseInfo,
      CarrierRestrictionsWithPriority carrierRestrictionsWithPriority,
      int i)
      throws RemoteException;

  void getCellInfoListResponse_1_4(
      RadioResponseInfo radioResponseInfo, ArrayList<CellInfo> arrayList) throws RemoteException;

  void getDataCallListResponse_1_4(
      RadioResponseInfo radioResponseInfo, ArrayList<SetupDataCallResult> arrayList)
      throws RemoteException;

  void getDataRegistrationStateResponse_1_4(
  ...
  void getIccCardStatusResponse_1_4(RadioResponseInfo radioResponseInfo, CardStatus cardStatus)
      throws RemoteException;

  void getPreferredNetworkTypeBitmapResponse(RadioResponseInfo radioResponseInfo, int i)
      throws RemoteException;

  void getSignalStrengthResponse_1_4(
  ...
  void setPreferredNetworkTypeBitmapResponse(RadioResponseInfo radioResponseInfo)
      throws RemoteException;

  void setupDataCallResponse_1_4(
  ...
  public static final class Proxy implements IRadioResponse {
    ...
    public void getDataRegistrationStateResponse(
        RadioResponseInfo info, android.hardware.radio.V1_0.DataRegStateResult dataRegResponse)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(android.hardware.radio.V1_0.IRadioResponse.kInterfaceName);
      info.writeToParcel(_hidl_request);
    ...
    public void getRadioCapabilityResponse(
        RadioResponseInfo info, android.hardware.radio.V1_0.RadioCapability rc)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(android.hardware.radio.V1_0.IRadioResponse.kInterfaceName);
      info.writeToParcel(_hidl_request);
    ...
    @Override // android.hardware.radio.V1_4.IRadioResponse
    public void getCellInfoListResponse_1_4(RadioResponseInfo info, ArrayList<CellInfo> cellInfo)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(IRadioResponse.kInterfaceName);
      info.writeToParcel(_hidl_request);
    ...
    @Override // android.hardware.radio.V1_4.IRadioResponse
    public void getIccCardStatusResponse_1_4(RadioResponseInfo info, CardStatus cardStatus)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(IRadioResponse.kInterfaceName);
      info.writeToParcel(_hidl_request);
    ...
    @Override // android.hardware.radio.V1_4.IRadioResponse
    public void setupDataCallResponse_1_4(RadioResponseInfo info, SetupDataCallResult dcResponse)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(IRadioResponse.kInterfaceName);
      info.writeToParcel(_hidl_request);
    ...
    @Override // android.hardware.radio.V1_4.IRadioResponse
    public void getSignalStrengthResponse_1_4(RadioResponseInfo info, SignalStrength signalStrength)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
      _hidl_request.writeInterfaceToken(IRadioResponse.kInterfaceName);
      info.writeToParcel(_hidl_request);
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        ...
        case 119:
          ...
          android.hardware.radio.V1_0.RadioCapability rc2 =
              new android.hardware.radio.V1_0.RadioCapability();
        ...
        case 154:
          ...
          getDataCallListResponse_1_4(
              info153, SetupDataCallResult.readVectorFromParcel(_hidl_request));
          return;
        case 155:
          _hidl_request.enforceInterface(IRadioResponse.kInterfaceName);
