...
public final class CellInfo {
  ...
  public static final class Info {
    ...
    public static final class hidl_discriminator {
      ...
      /* renamed from: nr */
      public static final byte f186nr = 5;
    ...
    /* renamed from: nr */
    public void m27nr(CellInfoNr nr) {
      this.hidl_d = (byte) 5;
      this.hidl_o = nr;
    }

    /* renamed from: nr */
    public CellInfoNr m26nr() {
      if (this.hidl_d != 5) {
        Object obj = this.hidl_o;
        String className =
            obj != null ? obj.getClass().getName() : SemCapabilities.FEATURE_TAG_NULL;
    ...
    public static final ArrayList<Info> readVectorFromParcel(HwParcel parcel) {
      ...
      HwBlob childBlob =
          parcel.readEmbeddedBuffer(_hidl_vec_size * 128, _hidl_blob.handle(), 0L, true);
      _hidl_vec.clear();
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
      ...
      switch (this.hidl_d) {
        ...
        case 4:
          ...
          return;
        case 5:
          m26nr().writeEmbeddedToBlob(_hidl_blob, 8 + _hidl_offset);
          return;
        default:
          throw new Error("Unknown union discriminator (value: " + ((int) this.hidl_d) + ").");
      }
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.isRegistered == other.isRegistered
        ...
        && HidlSupport.deepEquals(this.info, other.info)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.isRegistered))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.connectionStatus))),
        Integer.valueOf(HidlSupport.deepHashCode(this.info)));
  }
