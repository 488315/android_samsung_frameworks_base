...
public final class CdmaInformationRecord {
    ...
    public final void readEmbeddedFromParcel(
        ...
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
            ...
            _hidl_vec_element3.readEmbeddedFromParcel(parcel, childBlob3, _hidl_index_03 * 4);
        ...
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size5; _hidl_index_05++) {
            ...
            _hidl_vec_element5.readEmbeddedFromParcel(parcel, childBlob5, _hidl_index_05 * 4);
        ...
        for (int _hidl_index_06 = 0; _hidl_index_06 < _hidl_vec_size6; _hidl_index_06++) {
            ...
            _hidl_vec_element6.readEmbeddedFromParcel(parcel, childBlob6, _hidl_index_06 * 1);
        ...
        for (int _hidl_index_07 = 0; _hidl_index_07 < _hidl_vec_size7; _hidl_index_07++) {
            ...
            _hidl_vec_element7.readEmbeddedFromParcel(parcel, childBlob7, _hidl_index_07 * 2);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            this.display.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 16);
        }
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size2; _hidl_index_02++) {
            this.number.get(_hidl_index_02).writeEmbeddedToBlob(childBlob2, _hidl_index_02 * 24);
        }
        ...
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
            this.signal.get(_hidl_index_03).writeEmbeddedToBlob(childBlob3, _hidl_index_03 * 4);
        }
        ...
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size4; _hidl_index_04++) {
            this.redir.get(_hidl_index_04).writeEmbeddedToBlob(childBlob4, _hidl_index_04 * 32);
        }
        ...
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size5; _hidl_index_05++) {
            this.lineCtrl.get(_hidl_index_05).writeEmbeddedToBlob(childBlob5, _hidl_index_05 * 4);
        }
        ...
        for (int _hidl_index_06 = 0; _hidl_index_06 < _hidl_vec_size6; _hidl_index_06++) {
            this.clir.get(_hidl_index_06).writeEmbeddedToBlob(childBlob6, _hidl_index_06 * 1);
        }
        ...
        for (int _hidl_index_07 = 0; _hidl_index_07 < _hidl_vec_size7; _hidl_index_07++) {
            this.audioCtrl.get(_hidl_index_07).writeEmbeddedToBlob(childBlob7, _hidl_index_07 * 2);
        }
