...
public final class ActivityStatsInfo {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.sleepModeTimeMs == other.sleepModeTimeMs
        && this.idleModeTimeMs == other.idleModeTimeMs
        && HidlSupport.deepEquals(this.txmModetimeMs, other.txmModetimeMs)
        && this.rxModeTimeMs == other.rxModeTimeMs) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.sleepModeTimeMs))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.idleModeTimeMs))),
        Integer.valueOf(HidlSupport.deepHashCode(this.txmModetimeMs)),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.rxModeTimeMs))));
  }

  public final String toString() {
    return "{.sleepModeTimeMs = "
        + this.sleepModeTimeMs
        + ", .idleModeTimeMs = "
        + this.idleModeTimeMs
        + ", .txmModetimeMs = "
        + Arrays.toString(this.txmModetimeMs)
        + ", .rxModeTimeMs = "
        + this.rxModeTimeMs
        + "}";
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<ActivityStatsInfo> _hidl_vec) {
