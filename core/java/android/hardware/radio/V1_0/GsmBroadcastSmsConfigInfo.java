...
public final class GsmBroadcastSmsConfigInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.fromServiceId == other.fromServiceId
                && this.toServiceId == other.toServiceId
                && this.fromCodeScheme == other.fromCodeScheme
                && this.toCodeScheme == other.toCodeScheme
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.fromServiceId))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.toServiceId))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.fromCodeScheme))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.toCodeScheme))),
                Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.selected))));
    }
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<GsmBroadcastSmsConfigInfo> _hidl_vec) {
