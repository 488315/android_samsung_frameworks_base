...
public final class CellIdentityGsm {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.mcc, other.mcc)
        ...
        && this.lac == other.lac
        && this.cid == other.cid
        && this.arfcn == other.arfcn
        && this.bsic == other.bsic) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.lac))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.cid))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.arfcn))),
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.bsic))));
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<CellIdentityGsm> _hidl_vec) {
