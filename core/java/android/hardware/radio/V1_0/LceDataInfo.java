...
public final class LceDataInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.lastHopCapacityKbps == other.lastHopCapacityKbps
                ...
                && this.lceSuspended == other.lceSuspended) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(
                        HidlSupport.deepHashCode(Integer.valueOf(this.lastHopCapacityKbps))),
                Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.confidenceLevel))),
                Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.lceSuspended))));
    }

    public final String toString() {
        return "{.lastHopCapacityKbps = "
                + this.lastHopCapacityKbps
                + ", .confidenceLevel = "
                + ((int) this.confidenceLevel)
                + ", .lceSuspended = "
                + this.lceSuspended
                + "}";
    }
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<LceDataInfo> _hidl_vec) {
