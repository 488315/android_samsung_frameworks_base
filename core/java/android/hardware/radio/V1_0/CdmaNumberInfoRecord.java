...
public final class CdmaNumberInfoRecord {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.number, other.number)
        ...
        && this.f171pi == other.f171pi
        && this.f172si == other.f172si) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.f171pi))),
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.f172si))));
  }
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    parcel.readEmbeddedBuffer(
        r2.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 0 + 0, false);
