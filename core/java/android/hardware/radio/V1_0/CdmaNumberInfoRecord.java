...
public final class CdmaNumberInfoRecord {
    ...
    /* renamed from: pi */
    public byte f171pi = 0;

    /* renamed from: si */
    public byte f172si = 0;
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.number, other.number) && this.numberType == other.numberType && this.numberPlan == other.numberPlan && this.f171pi == other.f171pi && this.f172si == other.f172si) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(this.number)), Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.numberType))), Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.numberPlan))), Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.f171pi))), Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.f172si))));
    }

    public final String toString() {
        return "{.number = " + this.number + ", .numberType = " + ((int) this.numberType) + ", .numberPlan = " + ((int) this.numberPlan) + ", .pi = " + ((int) this.f171pi) + ", .si = " + ((int) this.f172si) + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f171pi = _hidl_blob.getInt8(18 + _hidl_offset);
        this.f172si = _hidl_blob.getInt8(19 + _hidl_offset);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8(18 + _hidl_offset, this.f171pi);
        _hidl_blob.putInt8(19 + _hidl_offset, this.f172si);
    }
}
