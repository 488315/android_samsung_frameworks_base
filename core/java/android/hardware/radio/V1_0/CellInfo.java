...
public final class CellInfo {
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
      ...
      _hidl_vec_element3.readEmbeddedFromParcel(parcel, childBlob3, _hidl_index_03 * 72);
    ...
    for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size4; _hidl_index_04++) {
      ...
      _hidl_vec_element4.readEmbeddedFromParcel(parcel, childBlob4, _hidl_index_04 * 56);
    ...
    for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size5; _hidl_index_05++) {
      ...
      _hidl_vec_element5.readEmbeddedFromParcel(parcel, childBlob5, _hidl_index_05 * 56);
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    ...
    for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size5; _hidl_index_05++) {
      this.tdscdma.get(_hidl_index_05).writeEmbeddedToBlob(childBlob5, _hidl_index_05 * 56);
    }
