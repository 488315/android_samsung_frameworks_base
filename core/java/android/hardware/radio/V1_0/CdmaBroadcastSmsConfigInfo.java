...
public final class CdmaBroadcastSmsConfigInfo {
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.language))),
    ...
    public static final ArrayList<CdmaBroadcastSmsConfigInfo> readVectorFromParcel(
            HwParcel parcel) {
        ArrayList<CdmaBroadcastSmsConfigInfo> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob =
                parcel.readEmbeddedBuffer(_hidl_vec_size * 12, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<CdmaBroadcastSmsConfigInfo> _hidl_vec) {
