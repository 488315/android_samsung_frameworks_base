...
public final class CdmaSmsAddress {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.digitMode == other.digitMode
                && this.numberMode == other.numberMode
                && this.numberType == other.numberType
                && this.numberPlan == other.numberPlan
                && HidlSupport.deepEquals(this.digits, other.digits)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.digitMode))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.numberMode))),
                ...
                Integer.valueOf(HidlSupport.deepHashCode(this.digits)));
    }

    public final String toString() {
        return "{.digitMode = "
                + CdmaSmsDigitMode.toString(this.digitMode)
                + ", .numberMode = "
                + CdmaSmsNumberMode.toString(this.numberMode)
                + ", .numberType = "
                + CdmaSmsNumberType.toString(this.numberType)
                + ", .numberPlan = "
                + CdmaSmsNumberPlan.toString(this.numberPlan)
                + ", .digits = "
                + this.digits
                + "}";
    }
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<CdmaSmsAddress> _hidl_vec) {
