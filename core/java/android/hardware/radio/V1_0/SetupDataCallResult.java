...
public final class SetupDataCallResult {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.status == other.status
        ...
        && HidlSupport.deepEquals(this.type, other.type)
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(this.type)),
  ...
  public final String toString() {
    return "{.status = "
        + DataCallFailCause.toString(this.status)
        + ", .suggestedRetryTime = "
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    parcel.readEmbeddedBuffer(
        r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
    this.ifname = _hidl_blob.getString(_hidl_offset + 32);
    parcel.readEmbeddedBuffer(
        r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 32 + 0, false);
    ...
    parcel.readEmbeddedBuffer(
        r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 64 + 0, false);
    this.gateways = _hidl_blob.getString(_hidl_offset + 80);
    parcel.readEmbeddedBuffer(
        r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 80 + 0, false);
    this.pcscf = _hidl_blob.getString(_hidl_offset + 96);
    parcel.readEmbeddedBuffer(
        r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 96 + 0, false);
