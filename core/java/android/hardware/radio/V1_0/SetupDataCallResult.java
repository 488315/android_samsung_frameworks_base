...
public final class SetupDataCallResult {
    ...
    public final void readEmbeddedFromParcel(
        ...
        parcel.readEmbeddedBuffer(
                this.type.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
