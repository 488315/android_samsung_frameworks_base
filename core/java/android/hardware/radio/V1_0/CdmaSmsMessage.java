...
public final class CdmaSmsMessage {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.teleserviceId == other.teleserviceId
                && this.isServicePresent == other.isServicePresent
                && this.serviceCategory == other.serviceCategory
                && HidlSupport.deepEquals(this.address, other.address)
                && HidlSupport.deepEquals(this.subAddress, other.subAddress)
                && HidlSupport.deepEquals(this.bearerData, other.bearerData)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.teleserviceId))),
                Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.isServicePresent))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.serviceCategory))),
                Integer.valueOf(HidlSupport.deepHashCode(this.address)),
                Integer.valueOf(HidlSupport.deepHashCode(this.subAddress)),
                Integer.valueOf(HidlSupport.deepHashCode(this.bearerData)));
    }
    ...
    public final void readEmbeddedFromParcel(
        ...
        HwBlob childBlob =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size * 1, _hidl_blob.handle(), _hidl_offset + 72 + 0, true);
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<CdmaSmsMessage> _hidl_vec) {
