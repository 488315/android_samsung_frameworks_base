...
public final class CdmaSmsSubaddress {
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.subaddressType))),
                Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.odd))),
                Integer.valueOf(HidlSupport.deepHashCode(this.digits)));
    }

    public final String toString() {
        return "{.subaddressType = "
                + CdmaSmsSubaddressType.toString(this.subaddressType)
                + ", .odd = "
                + this.odd
                + ", .digits = "
                + this.digits
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<CdmaSmsSubaddress> _hidl_vec) {
