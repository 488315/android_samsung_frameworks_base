...
public final class CdmaSignalInfoRecord {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.isPresent == other.isPresent
                ...
                && this.alertPitch == other.alertPitch
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.isPresent))),
                Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.signalType))),
                Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.alertPitch))),
                Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.signal))));
    }
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<CdmaSignalInfoRecord> _hidl_vec) {
