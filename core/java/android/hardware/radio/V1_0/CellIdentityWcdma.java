...
public final class CellIdentityWcdma {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.psc))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.uarfcn))));
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<CellIdentityWcdma> _hidl_vec) {
