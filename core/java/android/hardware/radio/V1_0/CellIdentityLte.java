...
public final class CellIdentityLte {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.mcc, other.mcc)
        ...
        && this.f174ci == other.f174ci
        && this.pci == other.pci
        && this.tac == other.tac
        && this.earfcn == other.earfcn) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f174ci))),
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.earfcn))));
  }
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    this.f174ci = _hidl_blob.getInt32(_hidl_offset + 32);
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<CellIdentityLte> _hidl_vec) {
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    ...
    _hidl_blob.putInt32(32 + _hidl_offset, this.f174ci);
