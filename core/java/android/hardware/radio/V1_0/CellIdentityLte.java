...
public final class CellIdentityLte {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.mcc, other.mcc) && HidlSupport.deepEquals(this.mnc, other.mnc) && this.f174ci == other.f174ci && this.pci == other.pci && this.tac == other.tac && this.earfcn == other.earfcn) {
            return true;
        }
        return false;
    }
