...
public final class CallForwardInfo {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.reason))),
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.timeSeconds))));
  }

  public final String toString() {
    return "{.status = "
        + CallForwardInfoStatus.toString(this.status)
        + ", .reason = "
        + this.reason
        + ", .serviceClass = "
        + this.serviceClass
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<CallForwardInfo> _hidl_vec) {
