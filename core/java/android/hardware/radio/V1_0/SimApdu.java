...
public final class SimApdu {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.sessionId == other.sessionId
        ...
        && this.f182p1 == other.f182p1
        && this.f183p2 == other.f183p2
        && this.f184p3 == other.f184p3
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f182p1))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f183p2))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f184p3))),
