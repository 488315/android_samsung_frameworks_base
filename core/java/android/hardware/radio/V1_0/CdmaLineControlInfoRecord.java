...
public final class CdmaLineControlInfoRecord {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.lineCtrlPolarityIncluded == other.lineCtrlPolarityIncluded
        && this.lineCtrlToggle == other.lineCtrlToggle
        && this.lineCtrlReverse == other.lineCtrlReverse
        && this.lineCtrlPowerDenial == other.lineCtrlPowerDenial) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.lineCtrlPolarityIncluded))),
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.lineCtrlToggle))),
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.lineCtrlReverse))),
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.lineCtrlPowerDenial))));
  }

  public final String toString() {
    return "{.lineCtrlPolarityIncluded = "
        + ((int) this.lineCtrlPolarityIncluded)
        + ", .lineCtrlToggle = "
        + ((int) this.lineCtrlToggle)
        + ", .lineCtrlReverse = "
        + ((int) this.lineCtrlReverse)
        + ", .lineCtrlPowerDenial = "
        + ((int) this.lineCtrlPowerDenial)
        + "}";
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<CdmaLineControlInfoRecord> _hidl_vec) {
