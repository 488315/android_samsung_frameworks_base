...
public final class SelectUiccSub {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.slot == other.slot
                ...
                && this.actStatus == other.actStatus) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.slot))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.appIndex))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.subType))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.actStatus))));
    }
    ...
    public final String toString() {
        return "{.slot = "
                ...
                + this.appIndex
                + ", .subType = "
                + SubscriptionType.toString(this.subType)
                + ", .actStatus = "
                + UiccSubActStatus.toString(this.actStatus)
                + "}";
    }
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<SelectUiccSub> _hidl_vec) {
        HwBlob _hidl_blob = new HwBlob(16);
