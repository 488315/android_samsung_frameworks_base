...
public final class IccIo {
    ...
    public final void readEmbeddedFromParcel(
        ...
        parcel.readEmbeddedBuffer(
                this.path.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
        ...
        parcel.readEmbeddedBuffer(
                this.data.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 40 + 0, false);
        this.pin2 = _hidl_blob.getString(_hidl_offset + 56);
        parcel.readEmbeddedBuffer(
                this.pin2.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 56 + 0, false);
        this.aid = _hidl_blob.getString(_hidl_offset + 72);
        parcel.readEmbeddedBuffer(
                this.aid.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 72 + 0, false);
    }
