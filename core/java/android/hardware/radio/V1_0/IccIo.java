...
public final class IccIo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.command == other.command && this.fileId == other.fileId && HidlSupport.deepEquals(this.path, other.path) && this.f175p1 == other.f175p1 && this.f176p2 == other.f176p2 && this.f177p3 == other.f177p3 && HidlSupport.deepEquals(this.data, other.data) && HidlSupport.deepEquals(this.pin2, other.pin2) && HidlSupport.deepEquals(this.aid, other.aid)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.command))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.fileId))), Integer.valueOf(HidlSupport.deepHashCode(this.path)), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f175p1))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f176p2))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f177p3))), Integer.valueOf(HidlSupport.deepHashCode(this.data)), Integer.valueOf(HidlSupport.deepHashCode(this.pin2)), Integer.valueOf(HidlSupport.deepHashCode(this.aid)));
    }

    public final String toString() {
        return "{.command = " + this.command + ", .fileId = " + this.fileId + ", .path = " + this.path + ", .p1 = " + this.f175p1 + ", .p2 = " + this.f176p2 + ", .p3 = " + this.f177p3 + ", .data = " + this.data + ", .pin2 = " + this.pin2 + ", .aid = " + this.aid + "}";
    }
