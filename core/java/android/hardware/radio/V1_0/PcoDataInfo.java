...
public final class PcoDataInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.cid == other.cid
                && HidlSupport.deepEquals(this.bearerProto, other.bearerProto)
                && this.pcoId == other.pcoId
                && HidlSupport.deepEquals(this.contents, other.contents)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(HidlSupport.deepHashCode(this.bearerProto)),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.pcoId))),
                Integer.valueOf(HidlSupport.deepHashCode(this.contents)));
    }
    ...
    public final void readEmbeddedFromParcel(
        ...
        parcel.readEmbeddedBuffer(
                this.bearerProto.getBytes().length + 1,
                _hidl_blob.handle(),
                _hidl_offset + 8 + 0,
                false);
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<PcoDataInfo> _hidl_vec) {
