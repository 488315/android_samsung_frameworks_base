...
public final class OperatorInfo {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.alphaLong, other.alphaLong)
        ...
        && HidlSupport.deepEquals(this.operatorNumeric, other.operatorNumeric)
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(this.operatorNumeric)),
  ...
  public final String toString() {
    return "{.alphaLong = "
        ...
        + ", .status = "
        + OperatorStatus.toString(this.status)
        + "}";
  }
