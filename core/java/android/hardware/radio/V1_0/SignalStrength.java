...
public final class SignalStrength {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.f181gw, other.f181gw)
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(this.f181gw)),
  ...
  public static final ArrayList<SignalStrength> readVectorFromParcel(HwParcel parcel) {
    ...
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(_hidl_vec_size * 60, _hidl_blob.handle(), 0L, true);
    _hidl_vec.clear();
