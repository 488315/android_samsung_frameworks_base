...
public final class SignalStrength {
    ...
    /* renamed from: gw */
    public GsmSignalStrength f181gw = new GsmSignalStrength();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.f181gw, other.f181gw) && HidlSupport.deepEquals(this.cdma, other.cdma) && HidlSupport.deepEquals(this.evdo, other.evdo) && HidlSupport.deepEquals(this.lte, other.lte) && HidlSupport.deepEquals(this.tdScdma, other.tdScdma)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(this.f181gw)), Integer.valueOf(HidlSupport.deepHashCode(this.cdma)), Integer.valueOf(HidlSupport.deepHashCode(this.evdo)), Integer.valueOf(HidlSupport.deepHashCode(this.lte)), Integer.valueOf(HidlSupport.deepHashCode(this.tdScdma)));
    }

    public final String toString() {
        return "{.gw = " + this.f181gw + ", .cdma = " + this.cdma + ", .evdo = " + this.evdo + ", .lte = " + this.lte + ", .tdScdma = " + this.tdScdma + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.f181gw.readEmbeddedFromParcel(parcel, _hidl_blob, 0 + _hidl_offset);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        this.f181gw.writeEmbeddedToBlob(_hidl_blob, 0 + _hidl_offset);
