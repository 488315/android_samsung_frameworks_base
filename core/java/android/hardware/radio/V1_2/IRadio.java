...
public interface IRadio extends android.hardware.radio.V1_1.IRadio {
  ...
  @Override // android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio,
  ...
  void setSignalStrengthReportingCriteria(
      int i, int i2, int i3, ArrayList<Integer> arrayList, int i4) throws RemoteException;

  void setupDataCall_1_2(
      int i,
      int i2,
