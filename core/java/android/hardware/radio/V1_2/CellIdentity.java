...
public final class CellIdentity {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 80, _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
        ...
        HwBlob childBlob2 = parcel.readEmbeddedBuffer(_hidl_vec_size2 * 80, _hidl_blob.handle(), _hidl_offset + 24 + 0, true);
        ...
        HwBlob childBlob3 = parcel.readEmbeddedBuffer(_hidl_vec_size3 * 56, _hidl_blob.handle(), _hidl_offset + 40 + 0, true);
        ...
        HwBlob childBlob4 = parcel.readEmbeddedBuffer(_hidl_vec_size4 * 88, _hidl_blob.handle(), _hidl_offset + 56 + 0, true);
        ...
        HwBlob childBlob5 = parcel.readEmbeddedBuffer(_hidl_vec_size5 * 88, _hidl_blob.handle(), _hidl_offset + 72 + 0, true);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size2; _hidl_index_02++) {
            this.cellIdentityWcdma.get(_hidl_index_02).writeEmbeddedToBlob(childBlob2, _hidl_index_02 * 80);
        }
        ...
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
            this.cellIdentityCdma.get(_hidl_index_03).writeEmbeddedToBlob(childBlob3, _hidl_index_03 * 56);
        }
        ...
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size5; _hidl_index_05++) {
            this.cellIdentityTdscdma.get(_hidl_index_05).writeEmbeddedToBlob(childBlob5, _hidl_index_05 * 88);
        }
