    ...
    public final void readEmbeddedFromParcel(
        ...
        HwBlob childBlob =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size * 96, _hidl_blob.handle(), _hidl_offset + 24 + 0, true);
        this.gsm.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        HwBlob childBlob2 =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size2 * 80, _hidl_blob.handle(), _hidl_offset + 40 + 0, true);
        this.cdma.clear();
        ...
        HwBlob childBlob3 =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size3 * 112, _hidl_blob.handle(), _hidl_offset + 56 + 0, true);
        this.lte.clear();
        ...
        HwBlob childBlob4 =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size4 * 96, _hidl_blob.handle(), _hidl_offset + 72 + 0, true);
        this.wcdma.clear();
        ...
        HwBlob childBlob5 =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size5 * 104, _hidl_blob.handle(), _hidl_offset + 88 + 0, true);
        this.tdscdma.clear();
