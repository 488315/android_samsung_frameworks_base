...
public final class ProgramList implements AutoCloseable {
  ...
  class C12791 extends ListCallback {
    final /* synthetic */ ListCallback val$callback;
    final /* synthetic */ Executor val$executor;

    C12791(Executor executor, ListCallback listCallback) {
  ...
  public void registerListCallback(Executor executor, ListCallback callback) {
    registerListCallback(new C12791(executor, callback));
  }
  ...
  static /* synthetic */ void lambda$addOnCompleteListener$0(
    ...
    executor.execute(
        new Runnable() { // from class: android.hardware.radio.ProgramList$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  void apply(Chunk chunk) {
    ...
    synchronized (this.mLock) {
      ...
      if (chunk.isPurge()) {
        Iterator<Map.Entry<ProgramSelector.Identifier, RadioManager.ProgramInfo>> programsIterator =
            this.mPrograms.entrySet().iterator();
      ...
      chunk.getRemoved().stream()
          .forEach(
              new Consumer() { // from class:
                               // android.hardware.radio.ProgramList$$ExternalSyntheticLambda2
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  ProgramList.this.lambda$apply$1(removedList, (ProgramSelector.Identifier) obj);
                }
              });
      chunk.getModified().stream()
          .forEach(
              new Consumer() { // from class:
                               // android.hardware.radio.ProgramList$$ExternalSyntheticLambda3
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
  ...
  public void lambda$apply$2(
      RadioManager.ProgramInfo value, List<ProgramSelector.Identifier> changedIdentifierList) {
  ...
  public static final class Chunk implements Parcelable {
    public static final Parcelable.Creator<Chunk> CREATOR =
        new Parcelable.Creator<Chunk>() { // from class: android.hardware.radio.ProgramList.Chunk.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
