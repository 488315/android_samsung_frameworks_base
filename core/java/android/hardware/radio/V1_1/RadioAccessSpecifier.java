...
public final class RadioAccessSpecifier {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.radioAccessNetwork == other.radioAccessNetwork
                && HidlSupport.deepEquals(this.geranBands, other.geranBands)
                && HidlSupport.deepEquals(this.utranBands, other.utranBands)
                && HidlSupport.deepEquals(this.eutranBands, other.eutranBands)
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(HidlSupport.deepHashCode(this.geranBands)),
                Integer.valueOf(HidlSupport.deepHashCode(this.utranBands)),
                Integer.valueOf(HidlSupport.deepHashCode(this.eutranBands)),
    ...
    public final void readEmbeddedFromParcel(
        ...
        HwBlob childBlob =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size * 4, _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
        ...
        HwBlob childBlob2 =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size2 * 4, _hidl_blob.handle(), _hidl_offset + 24 + 0, true);
        ...
        HwBlob childBlob4 =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size4 * 4, _hidl_blob.handle(), _hidl_offset + 56 + 0, true);
        this.channels.clear();
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
            childBlob3.putInt32(
                    _hidl_index_03 * 4, this.eutranBands.get(_hidl_index_03).intValue());
        }
