...
public final class ImsiEncryptionInfo {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.mcc, other.mcc)
        ...
        && HidlSupport.deepEquals(this.carrierKey, other.carrierKey)
        && HidlSupport.deepEquals(this.keyIdentifier, other.keyIdentifier)
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(this.carrierKey)),
        Integer.valueOf(HidlSupport.deepHashCode(this.keyIdentifier)),
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size * 1, _hidl_blob.handle(), _hidl_offset + 32 + 0, true);
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<ImsiEncryptionInfo> _hidl_vec) {
