...
public final class KeepaliveStatus {
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.sessionHandle))),
  ...
  public final String toString() {
    return "{.sessionHandle = "
        + this.sessionHandle
        + ", .code = "
        + KeepaliveStatusCode.toString(this.code)
        + "}";
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<KeepaliveStatus> _hidl_vec) {
