...
public final class ProgramSelector implements Parcelable {
                    ...
                    Arrays.stream(this.mSecondaryIds)
                        .filter(
                            new Predicate() { // from class:
                              ...
                              @Override // java.util.function.Predicate
                              public final boolean test(Object obj) {
                                return ProgramSelector.lambda$withSecondaryPreferred$1(
                                    preferredType, (ProgramSelector.Identifier) obj);
                              }
                            }),
                    Stream.of(preferred))
                .toArray(
  ...
  public boolean strictEquals(Object obj) {
    ...
    if (this.mPrimaryId.equals(other.getPrimaryId())) {
      ...
      if (identifierArr.length == other.mSecondaryIds.length
          && Arrays.asList(identifierArr).containsAll(Arrays.asList(other.mSecondaryIds))) {
        return true;
      }
    }
    return false;
  ...
  private ProgramSelector(Parcel in) {
    ...
    if (Stream.of((Object[]) identifierArr)
        .anyMatch(
            new Predicate() { // from class:
  ...
  public static final class Identifier implements Parcelable {
    public static final Parcelable.Creator<Identifier> CREATOR =
        new Parcelable.Creator<
            Identifier>() { // from class: android.hardware.radio.ProgramSelector.Identifier.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
