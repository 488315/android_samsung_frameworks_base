...
public final class QosBandwidth {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (otherObject == null || otherObject.getClass() != QosBandwidth.class) {
      return false;
    }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.guaranteedBitrateKbps))));
  }
  ...
  public static final ArrayList<QosBandwidth> readVectorFromParcel(HwParcel parcel) {
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    _hidl_blob.putInt32(0 + _hidl_offset, this.maxBitrateKbps);
    _hidl_blob.putInt32(4 + _hidl_offset, this.guaranteedBitrateKbps);
  }
}
