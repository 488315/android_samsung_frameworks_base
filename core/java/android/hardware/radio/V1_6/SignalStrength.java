...
public final class SignalStrength {
    ...
    /* renamed from: nr */
    public NrSignalStrength f199nr = new NrSignalStrength();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.gsm, other.gsm) && HidlSupport.deepEquals(this.cdma, other.cdma) && HidlSupport.deepEquals(this.evdo, other.evdo) && HidlSupport.deepEquals(this.lte, other.lte) && HidlSupport.deepEquals(this.tdscdma, other.tdscdma) && HidlSupport.deepEquals(this.wcdma, other.wcdma) && HidlSupport.deepEquals(this.f199nr, other.f199nr)) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.tdscdma.readEmbeddedFromParcel(parcel, _hidl_blob, 60 + _hidl_offset);
        this.wcdma.readEmbeddedFromParcel(parcel, _hidl_blob, 72 + _hidl_offset);
        this.f199nr.readEmbeddedFromParcel(parcel, _hidl_blob, 88 + _hidl_offset);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.tdscdma.writeEmbeddedToBlob(_hidl_blob, 60 + _hidl_offset);
        this.wcdma.writeEmbeddedToBlob(_hidl_blob, 72 + _hidl_offset);
        this.f199nr.writeEmbeddedToBlob(_hidl_blob, 88 + _hidl_offset);
    }
}
