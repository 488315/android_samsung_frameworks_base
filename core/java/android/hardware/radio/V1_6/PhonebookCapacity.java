...
public final class PhonebookCapacity {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.maxAdditionalNumberRecords))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Integer.valueOf(this.usedAdditionalNumberRecords))),
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.maxAdditionalNumberLen))));
  }
