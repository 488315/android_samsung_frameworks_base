...
public final class PortRange {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (otherObject == null || otherObject.getClass() != PortRange.class) {
      return false;
    }
    PortRange other = (PortRange) otherObject;
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.start))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.end))));
  }
  ...
  public static final ArrayList<PortRange> readVectorFromParcel(HwParcel parcel) {
    ArrayList<PortRange> _hidl_vec = new ArrayList<>();
    HwBlob _hidl_blob = parcel.readBuffer(16L);
    int _hidl_vec_size = _hidl_blob.getInt32(8L);
    HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 8, _hidl_blob.handle(), 0L, true);
    _hidl_vec.clear();
    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
      PortRange _hidl_vec_element = new PortRange();
  ...
  public static final void writeVectorToParcel(HwParcel parcel, ArrayList<PortRange> _hidl_vec) {
