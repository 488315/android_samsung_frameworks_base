...
public final class CellInfoLte {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.cellIdentityLte, other.cellIdentityLte)
                && HidlSupport.deepEquals(this.signalStrengthLte, other.signalStrengthLte)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(HidlSupport.deepHashCode(this.signalStrengthLte)));
    }
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<CellInfoLte> _hidl_vec) {
