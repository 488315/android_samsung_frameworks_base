...
public final class LinkCapacityEstimate {
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(
                        HidlSupport.deepHashCode(Integer.valueOf(this.downlinkCapacityKbps))),
                Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.uplinkCapacityKbps))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(
                                Integer.valueOf(this.secondaryDownlinkCapacityKbps))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(
                                Integer.valueOf(this.secondaryUplinkCapacityKbps))));
    }
