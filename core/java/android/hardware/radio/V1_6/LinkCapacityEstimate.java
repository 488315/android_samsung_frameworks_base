...
public final class LinkCapacityEstimate {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.downlinkCapacityKbps == other.downlinkCapacityKbps
        ...
        && this.secondaryDownlinkCapacityKbps == other.secondaryDownlinkCapacityKbps
        && this.secondaryUplinkCapacityKbps == other.secondaryUplinkCapacityKbps) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.downlinkCapacityKbps))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.uplinkCapacityKbps))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Integer.valueOf(this.secondaryDownlinkCapacityKbps))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Integer.valueOf(this.secondaryUplinkCapacityKbps))));
  }

  public final String toString() {
    return "{.downlinkCapacityKbps = "
        + this.downlinkCapacityKbps
        + ", .uplinkCapacityKbps = "
        + this.uplinkCapacityKbps
        + ", .secondaryDownlinkCapacityKbps = "
        + this.secondaryDownlinkCapacityKbps
        + ", .secondaryUplinkCapacityKbps = "
        + this.secondaryUplinkCapacityKbps
        + "}";
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<LinkCapacityEstimate> _hidl_vec) {
    HwBlob _hidl_blob = new HwBlob(16);
