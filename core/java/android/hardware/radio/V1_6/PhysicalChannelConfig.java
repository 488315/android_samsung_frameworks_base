...
public final class PhysicalChannelConfig {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.downlinkChannelNumber))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.uplinkChannelNumber))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.cellBandwidthDownlinkKhz))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.cellBandwidthUplinkKhz))),
