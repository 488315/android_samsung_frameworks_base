...
public final class CellInfo {
  ...
  public static final class CellInfoRatSpecificInfo {
    ...
    public static final class hidl_discriminator {
      ...
      /* renamed from: nr */
      public static final byte f196nr = 4;
    ...
    public CellInfoGsm gsm() {
      if (this.hidl_d != 0) {
        ...
        String className =
            obj != null ? obj.getClass().getName() : SemCapabilities.FEATURE_TAG_NULL;
    ...
    /* renamed from: nr */
    public void m33nr(CellInfoNr nr) {
      this.hidl_d = (byte) 4;
      this.hidl_o = nr;
    }

    /* renamed from: nr */
    public CellInfoNr m32nr() {
      if (this.hidl_d != 4) {
        Object obj = this.hidl_o;
        String className =
            obj != null ? obj.getClass().getName() : SemCapabilities.FEATURE_TAG_NULL;
    ...
    public static final ArrayList<CellInfoRatSpecificInfo> readVectorFromParcel(HwParcel parcel) {
      ...
      HwBlob childBlob =
          parcel.readEmbeddedBuffer(_hidl_vec_size * 200, _hidl_blob.handle(), 0L, true);
      _hidl_vec.clear();
    ...
    public static final void writeVectorToParcel(
        HwParcel parcel, ArrayList<CellInfoRatSpecificInfo> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
      ...
      switch (this.hidl_d) {
        ...
        case 3:
          ...
          return;
        case 4:
          m32nr().writeEmbeddedToBlob(_hidl_blob, 8 + _hidl_offset);
          return;
        case 5:
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.registered == other.registered
        ...
        && HidlSupport.deepEquals(this.ratSpecificInfo, other.ratSpecificInfo)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.connectionStatus))),
        Integer.valueOf(HidlSupport.deepHashCode(this.ratSpecificInfo)));
  }
  ...
  public final String toString() {
    return "{.registered = "
        + this.registered
        + ", .connectionStatus = "
        + CellConnectionStatus.toString(this.connectionStatus)
        + ", .ratSpecificInfo = "
  ...
  public static final ArrayList<CellInfo> readVectorFromParcel(HwParcel parcel) {
    ...
    int _hidl_vec_size = _hidl_blob.getInt32(8L);
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(_hidl_vec_size * 208, _hidl_blob.handle(), 0L, true);
    _hidl_vec.clear();
    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
