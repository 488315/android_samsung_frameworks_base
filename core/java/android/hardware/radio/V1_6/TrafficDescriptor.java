...
public final class TrafficDescriptor {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.dnn, other.dnn)
        && HidlSupport.deepEquals(this.osAppId, other.osAppId)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(this.osAppId)));
  }
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<TrafficDescriptor> _hidl_vec) {
