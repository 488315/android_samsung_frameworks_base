...
public final class SlicingConfig {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.urspRules, other.urspRules)
    ...
    public final int hashCode() {
        return Objects.hash(
                Integer.valueOf(HidlSupport.deepHashCode(this.urspRules)),
    ...
    public final void readEmbeddedFromParcel(
        ...
        HwBlob childBlob =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size * 40, _hidl_blob.handle(), _hidl_offset + 0 + 0, true);
        ...
        HwBlob childBlob2 =
                parcel.readEmbeddedBuffer(
                        _hidl_vec_size2 * 20, _hidl_blob.handle(), _hidl_offset + 16 + 0, true);
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<SlicingConfig> _hidl_vec) {
