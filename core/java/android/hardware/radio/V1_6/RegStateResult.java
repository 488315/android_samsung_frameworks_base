...
public final class RegStateResult {
  ...
  public static final class AccessTechnologySpecificInfo {
    ...
    public RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo cdmaInfo() {
      ...
      Object obj2 = this.hidl_o;
      if (obj2 != null
          && !RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo.class.isInstance(
              obj2)) {
        throw new Error("Union is in a corrupted state.");
      }
    ...
    public RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo eutranInfo() {
      ...
      Object obj2 = this.hidl_o;
      if (obj2 != null
          && !RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo.class.isInstance(
              obj2)) {
        throw new Error("Union is in a corrupted state.");
      }
        ...
        case 1:
          RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo
              cdma2000RegistrationInfo =
                  new RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo();
        ...
        case 2:
          RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo
              eutranRegistrationInfo =
                  new RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo();
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    parcel.readEmbeddedBuffer(
        r5.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 184 + 0, false);
