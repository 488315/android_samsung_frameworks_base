...
public interface IRadioVoiceResponse extends IInterface {
  ...
  public static class Default implements IRadioVoiceResponse {
    ...
    public void getCallForwardStatusResponse(
        RadioResponseInfo info, CallForwardInfo[] callForwardInfos) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 14:
              ...
              LastCallFailCauseInfo _arg16 =
                  (LastCallFailCauseInfo) data.readTypedObject(LastCallFailCauseInfo.CREATOR);
              data.enforceNoDataAvail();
    ...
    private static class Proxy implements IRadioVoiceResponse {
        ...
        try {
          ...
          if (!_status) {
            throw new RemoteException(
                "Method handleStkCallSetupRequestFromSimResponse is unimplemented.");
          }
        } finally {
          _data.recycle();
        }
      ...
      public void hangupForegroundResumeBackgroundResponse(RadioResponseInfo info)
        ...
        try {
          ...
          if (!_status) {
            throw new RemoteException(
                "Method hangupForegroundResumeBackgroundResponse is unimplemented.");
          }
        } finally {
          _data.recycle();
        }
