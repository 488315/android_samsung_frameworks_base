...
public class CdmaCallWaiting implements Parcelable {
  public static final Parcelable.Creator<CdmaCallWaiting> CREATOR =
      new Parcelable.Creator<
          CdmaCallWaiting>() { // from class: android.hardware.radio.voice.CdmaCallWaiting.1
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.signalInfoRecord =
          (CdmaSignalInfoRecord) _aidl_parcel.readTypedObject(CdmaSignalInfoRecord.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
