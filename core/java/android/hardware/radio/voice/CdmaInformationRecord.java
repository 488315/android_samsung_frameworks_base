...
public class CdmaInformationRecord implements Parcelable {
  ...
  public static final Parcelable.Creator<CdmaInformationRecord> CREATOR =
      new Parcelable.Creator<
          CdmaInformationRecord>() { // from class:
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.display =
          (CdmaDisplayInfoRecord[]) _aidl_parcel.createTypedArray(CdmaDisplayInfoRecord.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
      ...
      this.number =
          (CdmaNumberInfoRecord[]) _aidl_parcel.createTypedArray(CdmaNumberInfoRecord.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
      ...
      this.signal =
          (CdmaSignalInfoRecord[]) _aidl_parcel.createTypedArray(CdmaSignalInfoRecord.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
      ...
      this.clir =
          (CdmaT53ClirInfoRecord[]) _aidl_parcel.createTypedArray(CdmaT53ClirInfoRecord.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
        ...
        this.audioCtrl =
            (CdmaT53AudioControlInfoRecord[])
                _aidl_parcel.createTypedArray(CdmaT53AudioControlInfoRecord.CREATOR);
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
        _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
