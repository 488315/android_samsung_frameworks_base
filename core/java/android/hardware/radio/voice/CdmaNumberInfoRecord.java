...
public class CdmaNumberInfoRecord implements Parcelable {
  ...
  public static final Parcelable.Creator<CdmaNumberInfoRecord> CREATOR =
      new Parcelable.Creator<
          CdmaNumberInfoRecord>() { // from class:
  ...
  /* renamed from: pi */
  public byte f220pi = 0;

  /* renamed from: si */
  public byte f221si = 0;
  ...
  public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
    ...
    _aidl_parcel.writeByte(this.f220pi);
    _aidl_parcel.writeByte(this.f221si);
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      this.f220pi = _aidl_parcel.readByte();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
        ...
        this.f221si = _aidl_parcel.readByte();
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
        _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
  ...
  public String toString() {
    ...
    _aidl_sj.add("pi: " + ((int) this.f220pi));
    _aidl_sj.add("si: " + ((int) this.f221si));
