...
public class RadioManager {
  ...
  public static class ModuleProperties implements Parcelable {
    ...
    public ModuleProperties(
      ...
      this.mDabFrequencyTable =
          (dabFrequencyTable == null || dabFrequencyTable.isEmpty()) ? null : dabFrequencyTable;
    ...
    private ModuleProperties(Parcel in) {
      ...
      Parcelable[] tmp =
          (Parcelable[])
              in.readParcelableArray(BandDescriptor.class.getClassLoader(), BandDescriptor.class);
  ...
  public static class BandDescriptor implements Parcelable {
    public static final Parcelable.Creator<BandDescriptor> CREATOR =
        new Parcelable.Creator<
            BandDescriptor>() { // from class: android.hardware.radio.RadioManager.BandDescriptor.1
          /* JADX WARN: Can't rename method to resolve collision */
    ...
    public int hashCode() {
      ...
      return (((((((result * 31) + this.mType) * 31) + this.mLowerLimit) * 31) + this.mUpperLimit)
              * 31)
          + this.mSpacing;
    }
  ...
  public static class FmBandDescriptor extends BandDescriptor {
    ...
    @Override // android.hardware.radio.RadioManager.BandDescriptor
    public int hashCode() {
      return (((((((((super.hashCode() * 31) + (this.mStereo ? 1 : 0)) * 31) + (this.mRds ? 1 : 0))
                              * 31)
                          + (this.mTa ? 1 : 0))
                      * 31)
                  + (this.mAf ? 1 : 0))
  ...
  public static class BandConfig implements Parcelable {
    public static final Parcelable.Creator<BandConfig> CREATOR =
        new Parcelable.Creator<
            BandConfig>() { // from class: android.hardware.radio.RadioManager.BandConfig.1
          /* JADX WARN: Can't rename method to resolve collision */
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.os.Parcelable.Creator
  ...
  public static class FmBandConfig extends BandConfig {
    public static final Parcelable.Creator<FmBandConfig> CREATOR =
        new Parcelable.Creator<
            FmBandConfig>() { // from class: android.hardware.radio.RadioManager.FmBandConfig.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
  ...
  public static class AmBandConfig extends BandConfig {
    public static final Parcelable.Creator<AmBandConfig> CREATOR =
        new Parcelable.Creator<
            AmBandConfig>() { // from class: android.hardware.radio.RadioManager.AmBandConfig.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
  ...
  public static class ProgramInfo implements Parcelable {
    public static final Parcelable.Creator<ProgramInfo> CREATOR =
        new Parcelable.Creator<
            ProgramInfo>() { // from class: android.hardware.radio.RadioManager.ProgramInfo.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public int getChannel() {
      try {
        ...
        Log.m102w(RadioManager.TAG, "Not an AM/FM program");
        return 0;
      }
    }
    ...
    private ProgramInfo(Parcel in) {
      this.mSelector =
          (ProgramSelector)
              Objects.requireNonNull((ProgramSelector) in.readTypedObject(ProgramSelector.CREATOR));
  ...
  public int listModules(List<ModuleProperties> modules) {
    if (modules == null) {
      Log.m96e(TAG, "the output list must not be empty");
      return -22;
    }
    Log.m94d(TAG, "Listing available tuners...");
    try {
      List<ModuleProperties> returnedList = this.mService.listModules();
      if (returnedList == null) {
        Log.m96e(TAG, "Returned list was a null");
        return Integer.MIN_VALUE;
      }
      modules.addAll(returnedList);
      return 0;
    } catch (RemoteException e) {
      Log.m97e(TAG, "Failed listing available tuners", e);
      return -32;
    }
  }
  ...
  public RadioTuner openTuner(
    ...
    Log.m94d(TAG, "Opening tuner " + moduleId + Session.TRUNCATE_STRING);
    TunerCallbackAdapter halCallback = new TunerCallbackAdapter(callback, handler);
    try {
      ITuner tuner = this.mService.openTuner(moduleId, config, withAudio, halCallback);
      if (tuner == null) {
        Log.m96e(TAG, "Failed to open tuner");
        return null;
      }
      ...
      Log.m97e(TAG, "Failed to open tuner", ex);
      return null;
    }
  }
  ...
  public void addAnnouncementListener(
    ...
    int[] types =
        enabledAnnouncementTypes.stream()
            .mapToInt(new PreferentialNetworkServiceConfig$$ExternalSyntheticLambda2())
            .toArray();
    IAnnouncementListener listenerIface = new BinderC12851(executor, listener);
  ...
  class BinderC12851 extends IAnnouncementListener.Stub {
    final /* synthetic */ Executor val$executor;
    final /* synthetic */ Announcement.OnListUpdatedListener val$listener;

    BinderC12851(Executor executor, Announcement.OnListUpdatedListener onListUpdatedListener) {
  ...
  public RadioManager(Context context) throws ServiceManager.ServiceNotFoundException {
    this(
        context,
        IRadioService.Stub.asInterface(ServiceManager.getServiceOrThrow(Context.RADIO_SERVICE)));
  }
