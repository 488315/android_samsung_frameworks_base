...
public interface IRadioConfigResponse extends IInterface {
  ...
  void getPhoneCapabilityResponse(
      RadioResponseInfo radioResponseInfo, PhoneCapability phoneCapability) throws RemoteException;

  void getSimSlotsStatusResponse(
      RadioResponseInfo radioResponseInfo, SimSlotStatus[] simSlotStatusArr) throws RemoteException;
  ...
  public static class Default implements IRadioConfigResponse {
    ...
    @Override // android.hardware.radio.config.IRadioConfigResponse
    public void getPhoneCapabilityResponse(RadioResponseInfo info, PhoneCapability phoneCapability)
        throws RemoteException {}
