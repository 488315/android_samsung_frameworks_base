...
public final class PhysicalSensor {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.sensorType == other.sensorType
                ...
                && HidlSupport.deepEquals(this.f3vendor, other.f3vendor)
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(HidlSupport.deepHashCode(this.f3vendor)),
    ...
    public final void readEmbeddedFromParcel(
        ...
        parcel.readEmbeddedBuffer(
                this.type.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
        ...
        parcel.readEmbeddedBuffer(
                this.f3vendor.getBytes().length + 1,
                _hidl_blob.handle(),
                _hidl_offset + 40 + 0,
                false);
