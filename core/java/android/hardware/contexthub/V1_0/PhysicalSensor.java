...
public final class PhysicalSensor {
  ...
  public String f3142vendor = new String();
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.sensorType == other.sensorType
        ...
        && HidlSupport.deepEquals(this.f3142vendor, other.f3142vendor)
        && this.version == other.version
        && this.fifoReservedCount == other.fifoReservedCount
        && this.fifoMaxCount == other.fifoMaxCount
        && this.minDelayMs == other.minDelayMs
        && this.maxDelayMs == other.maxDelayMs
        && this.peakPowerMw == other.peakPowerMw) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.sensorType))),
        Integer.valueOf(HidlSupport.deepHashCode(this.type)),
        Integer.valueOf(HidlSupport.deepHashCode(this.name)),
        Integer.valueOf(HidlSupport.deepHashCode(this.f3142vendor)),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.version))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.fifoReservedCount))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.fifoMaxCount))),
        Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.minDelayMs))),
        Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.maxDelayMs))),
        Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.peakPowerMw))));
  }

  public final String toString() {
    return "{.sensorType = "
        + SensorType.toString(this.sensorType)
        + ", .type = "
        + this.type
        + ", .name = "
        + this.name
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    this.f3142vendor = _hidl_blob.getString(_hidl_offset + 40);
    parcel.readEmbeddedBuffer(
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<PhysicalSensor> _hidl_vec) {
  ...
  public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
    ...
    _hidl_blob.putString(40 + _hidl_offset, this.f3142vendor);
