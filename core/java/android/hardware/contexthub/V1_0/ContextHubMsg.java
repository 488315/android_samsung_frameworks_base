...
public final class ContextHubMsg {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.appName == other.appName
        && this.hostEndPoint == other.hostEndPoint
        && this.msgType == other.msgType
        && HidlSupport.deepEquals(this.msg, other.msg)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.appName))),
        Integer.valueOf(HidlSupport.deepHashCode(Short.valueOf(this.hostEndPoint))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.msgType))),
        Integer.valueOf(HidlSupport.deepHashCode(this.msg)));
  }
