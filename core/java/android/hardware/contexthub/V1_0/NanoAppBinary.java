...
public final class NanoAppBinary {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.appId == other.appId
        ...
        && this.targetChreApiMajorVersion == other.targetChreApiMajorVersion
        && this.targetChreApiMinorVersion == other.targetChreApiMinorVersion
        && HidlSupport.deepEquals(this.customBinary, other.customBinary)) {
      return true;
    }
    return false;
  }
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.appVersion))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.flags))),
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.targetChreApiMajorVersion))),
        Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.targetChreApiMinorVersion))),
        Integer.valueOf(HidlSupport.deepHashCode(this.customBinary)));
  }
  ...
  public final String toString() {
    return "{.appId = "
        ...
        + this.appVersion
        + ", .flags = "
        + NanoAppFlags.dumpBitfield(this.flags)
        + ", .targetChreApiMajorVersion = "
        + ((int) this.targetChreApiMajorVersion)
        + ", .targetChreApiMinorVersion = "
        + ((int) this.targetChreApiMinorVersion)
        + ", .customBinary = "
        + this.customBinary
        + "}";
  }
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size * 1, _hidl_blob.handle(), _hidl_offset + 24 + 0, true);
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<NanoAppBinary> _hidl_vec) {
