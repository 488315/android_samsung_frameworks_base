...
public class HdmiTimerRecordSources {
  ...
  public static TimerRecordSource ofExternalPhysicalAddress(
      TimerInfo timerInfo, HdmiRecordSources.ExternalPhysicalAddress externalPhysicalAddress) {
  ...
  private static void checkTimerRecordSourceInputs(
    ...
    if (timerInfo == null) {
      Log.m102w(TAG, "TimerInfo should not be null.");
      throw new IllegalArgumentException("TimerInfo should not be null.");
    }
    if (source == null) {
      Log.m102w(TAG, "source should not be null.");
  ...
  public static TimerInfo timerInfoOf(
      int dayOfMonth, int monthOfYear, Time startTime, Duration duration, int recordingSequence) {
