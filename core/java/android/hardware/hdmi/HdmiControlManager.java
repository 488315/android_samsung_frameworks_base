...
public final class HdmiControlManager {
  ...
  public static final String f162x4670840e =
  ...
  private final ArrayMap<HdmiCecVolumeControlFeatureListener, IHdmiCecVolumeControlFeatureListener>
      mHdmiCecVolumeControlFeatureListeners = new ArrayMap<>();
  private final ArrayMap<String, ArrayMap<CecSettingChangeListener, IHdmiCecSettingChangeListener>>
      ...
      try {
        ...
        if (ports.isEmpty()) {
          Log.m96e(
              ...
              "Can't find port info, not updating connected status. Hotplug event:" + event);
          return;
        }
  ...
  public HdmiClient getClient(int type) {
    ...
    switch (type) {
      ...
      case 5:
        try {
          if ((iHdmiControlService.getCecSettingIntValue(CEC_SETTING_NAME_SOUNDBAR_MODE) == 1
  ...
  public boolean isDeviceConnected(HdmiDeviceInfo targetDevice) {
    ...
    return (physicalAddress == 65535
            ...
            || HdmiUtils.getLocalPortFromPhysicalAddress(targetPhysicalAddress, physicalAddress)
                == -1)
        ? false
        : true;
  }
  ...
  public void addHotplugEventListener(Executor executor, HotplugEventListener listener) {
    if (this.mService == null) {
      Log.m96e(TAG, "addHotplugEventListener: HdmiControlService is not available");
      return;
    }
    if (this.mHotplugEventListeners.containsKey(listener)) {
      Log.m96e(TAG, "listener is already registered");
      return;
    }
  ...
  public void removeHotplugEventListener(HotplugEventListener listener) {
    if (this.mService == null) {
      Log.m96e(TAG, "removeHotplugEventListener: HdmiControlService is not available");
      return;
    }
    IHdmiHotplugEventListener wrappedListener = this.mHotplugEventListeners.remove(listener);
    if (wrappedListener == null) {
      Log.m96e(TAG, "tried to remove not-registered listener");
      return;
    }
    try {
  ...
  class BinderC12131 extends IHdmiHotplugEventListener.Stub {
    final /* synthetic */ Executor val$executor;
    final /* synthetic */ HotplugEventListener val$listener;

    BinderC12131(Executor executor, HotplugEventListener hotplugEventListener) {
  ...
  private IHdmiHotplugEventListener getHotplugEventListenerWrapper(
    ...
    return new BinderC12131(executor, listener);
  }
  ...
  public void addHdmiControlStatusChangeListener(
    ...
    if (this.mService == null) {
      Log.m96e(TAG, "addHdmiControlStatusChangeListener: HdmiControlService is not available");
      return;
    }
  ...
  public void removeHdmiControlStatusChangeListener(HdmiControlStatusChangeListener listener) {
    if (this.mService == null) {
      Log.m96e(TAG, "removeHdmiControlStatusChangeListener: HdmiControlService is not available");
      return;
    }
    IHdmiControlStatusChangeListener wrappedListener =
  ...
  class BinderC12142 extends IHdmiControlStatusChangeListener.Stub {
    final /* synthetic */ Executor val$executor;
    final /* synthetic */ HdmiControlStatusChangeListener val$listener;

    BinderC12142(
        Executor executor, HdmiControlStatusChangeListener hdmiControlStatusChangeListener) {
      this.val$executor = executor;
      ...
      try {
        ...
        executor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                HdmiControlManager.HdmiControlStatusChangeListener.this.onStatusChange(
                    isCecEnabled, isCecAvailable);
              }
            });
      } finally {
        Binder.restoreCallingIdentity(token);
  ...
  private IHdmiControlStatusChangeListener getHdmiControlStatusChangeListenerWrapper(
      Executor executor, HdmiControlStatusChangeListener listener) {
    return new BinderC12142(executor, listener);
  }

  public void addHdmiCecVolumeControlFeatureListener(
      Executor executor, HdmiCecVolumeControlFeatureListener listener) {
    if (this.mService == null) {
      Log.m96e(TAG, "addHdmiCecVolumeControlFeatureListener: HdmiControlService is not available");
      return;
    }
  ...
  public void removeHdmiCecVolumeControlFeatureListener(
    ...
    if (this.mService == null) {
      Log.m96e(
          TAG, "removeHdmiCecVolumeControlFeatureListener: HdmiControlService is not available");
      return;
    }
    IHdmiCecVolumeControlFeatureListener wrappedListener =
  ...
  class BinderC12153 extends IHdmiCecVolumeControlFeatureListener.Stub {
    final /* synthetic */ Executor val$executor;
  ...
  private IHdmiCecVolumeControlFeatureListener createHdmiCecVolumeControlFeatureListenerWrapper(
      Executor executor, HdmiCecVolumeControlFeatureListener listener) {
    return new BinderC12153(executor, listener);
  }

  private void addCecSettingChangeListener(
      String setting, Executor executor, CecSettingChangeListener listener) {
    if (this.mService == null) {
      Log.m96e(TAG, "addCecSettingChangeListener: HdmiControlService is not available");
      return;
    }
  ...
  private void removeCecSettingChangeListener(String setting, CecSettingChangeListener listener) {
    if (this.mService == null) {
      Log.m96e(TAG, "removeCecSettingChangeListener: HdmiControlService is not available");
      return;
    }
    IHdmiCecSettingChangeListener wrappedListener =
  ...
  class BinderC12164 extends IHdmiCecSettingChangeListener.Stub {
    final /* synthetic */ Executor val$executor;
    final /* synthetic */ CecSettingChangeListener val$listener;

    BinderC12164(Executor executor, CecSettingChangeListener cecSettingChangeListener) {
      this.val$executor = executor;
  ...
  private IHdmiCecSettingChangeListener getCecSettingChangeListenerWrapper(
    ...
    return new BinderC12164(executor, listener);
  }

  public List<String> getUserCecSettings() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getUserCecSettings: HdmiControlService is not available");
  ...
  public List<String> getAllowedCecSettingStringValues(String name) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getAllowedCecSettingStringValues: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public List<Integer> getAllowedCecSettingIntValues(String name) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getAllowedCecSettingIntValues: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setHdmiCecEnabled(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setHdmiCecEnabled: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getHdmiCecEnabled() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getHdmiCecEnabled: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setHdmiCecVersion(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setHdmiCecVersion: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getHdmiCecVersion() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getHdmiCecVersion: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setRoutingControl(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setRoutingControl: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getRoutingControl() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getRoutingControl: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setSoundbarMode(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setSoundbarMode: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getSoundbarMode() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getSoundbarMode: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setPowerControlMode(String value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setPowerControlMode: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public String getPowerControlMode() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getPowerControlMode: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setPowerStateChangeOnActiveSourceLost(String value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setPowerStateChangeOnActiveSourceLost: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
      iHdmiControlService.setCecSettingStringValue(
  ...
  public String getPowerStateChangeOnActiveSourceLost() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getPowerStateChangeOnActiveSourceLost: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
      return iHdmiControlService.getCecSettingStringValue(
  ...
  public void setSystemAudioControl(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setSystemAudioControl: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getSystemAudioControl() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getSystemAudioControl: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setSystemAudioModeMuting(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setSystemAudioModeMuting: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getSystemAudioModeMuting() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getSystemAudioModeMuting: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setTvWakeOnOneTouchPlay(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setTvWakeOnOneTouchPlay: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getTvWakeOnOneTouchPlay() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getTvWakeOnOneTouchPlay: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setTvSendStandbyOnSleep(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setTvSendStandbyOnSleep: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getTvSendStandbyOnSleep() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getTvSendStandbyOnSleep: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setSadPresenceInQuery(String setting, int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setSadPresenceInQuery: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setSadsPresenceInQuery(List<String> settings, int value) {
    if (this.mService == null) {
      Log.m96e(TAG, "setSadsPresenceInQuery: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getSadPresenceInQuery(String setting) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getSadPresenceInQuery: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public void setEarcEnabled(int value) {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "setEarcEnabled: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
  ...
  public int getEarcEnabled() {
    IHdmiControlService iHdmiControlService = this.mService;
    if (iHdmiControlService == null) {
      Log.m96e(TAG, "getEarcEnabled: HdmiControlService is not available");
      throw new RuntimeException("HdmiControlService is not available");
    }
    try {
