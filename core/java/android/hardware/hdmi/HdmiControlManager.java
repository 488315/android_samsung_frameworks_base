...
public final class HdmiControlManager {
    ...
    public static final String f162x4670840e = "rc_profile_source_handles_media_context_sensitive_menu";
    ...
    private final class ClientHotplugEventListener implements HotplugEventListener {
        ...
        public void onReceived(HdmiHotplugEvent event) {
            ...
            try {
                ...
                if (ports.isEmpty()) {
                    Log.m96e(HdmiControlManager.TAG, "Can't find port info, not updating connected status. Hotplug event:" + event);
                    return;
                }
    ...
    class BinderC12142 extends IHdmiControlStatusChangeListener.Stub {
        ...
        BinderC12142(Executor executor, HdmiControlStatusChangeListener hdmiControlStatusChangeListener) {
            this.val$executor = executor;
    ...
    public void removeHdmiCecVolumeControlFeatureListener(HdmiCecVolumeControlFeatureListener listener) {
        if (this.mService == null) {
            Log.m96e(TAG, "removeHdmiCecVolumeControlFeatureListener: HdmiControlService is not available");
            return;
        }
    ...
    class BinderC12153 extends IHdmiCecVolumeControlFeatureListener.Stub {
        ...
        BinderC12153(Executor executor, HdmiCecVolumeControlFeatureListener hdmiCecVolumeControlFeatureListener) {
            this.val$executor = executor;
