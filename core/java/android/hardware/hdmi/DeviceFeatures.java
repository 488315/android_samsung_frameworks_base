    ...
    public Builder update(DeviceFeatures newDeviceFeatures) {
      this.mRecordTvScreenSupport =
          DeviceFeatures.updateFeatureSupportStatus(
              this.mRecordTvScreenSupport, newDeviceFeatures.getRecordTvScreenSupport());
      ...
      this.mSetAudioVolumeLevelSupport =
          DeviceFeatures.updateFeatureSupportStatus(
              this.mSetAudioVolumeLevelSupport, newDeviceFeatures.getSetAudioVolumeLevelSupport());
      return this;
    }
  }
}
