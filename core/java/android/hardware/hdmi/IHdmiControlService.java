...
public interface IHdmiControlService extends IInterface {
  ...
  void addHdmiControlStatusChangeListener(
      IHdmiControlStatusChangeListener iHdmiControlStatusChangeListener) throws RemoteException;

  void addHdmiMhlVendorCommandListener(IHdmiMhlVendorCommandListener iHdmiMhlVendorCommandListener)
      throws RemoteException;
  ...
  void addSystemAudioModeChangeListener(
      IHdmiSystemAudioModeChangeListener iHdmiSystemAudioModeChangeListener) throws RemoteException;
          ...
          switch (code) {
            ...
            case 7:
              IHdmiControlStatusChangeListener _arg03 =
                  IHdmiControlStatusChangeListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 9:
              IHdmiCecVolumeControlFeatureListener _arg05 =
                  IHdmiCecVolumeControlFeatureListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 23:
              IHdmiSystemAudioModeChangeListener _arg015 =
                  IHdmiSystemAudioModeChangeListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
