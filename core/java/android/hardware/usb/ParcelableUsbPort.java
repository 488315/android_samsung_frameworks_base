...
public final class ParcelableUsbPort implements Parcelable {
  ...
  /* renamed from: of */
  public static ParcelableUsbPort m45of(UsbPort port) {
    return new ParcelableUsbPort(
        port.getId(),
        port.getSupportedModes(),
