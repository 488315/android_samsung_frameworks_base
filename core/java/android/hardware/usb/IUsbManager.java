...
public interface IUsbManager extends IInterface {
  void addAccessoryPackagesToPreferenceDenied(
      UsbAccessory usbAccessory, String[] strArr, UserHandle userHandle) throws RemoteException;
  ...
  boolean isSupportScrLckBlk() throws RemoteException;
  ...
  void requestAccessoryPermission(
      UsbAccessory usbAccessory, String str, PendingIntent pendingIntent) throws RemoteException;
  ...
  void setAccessoryPersistentPermission(
      UsbAccessory usbAccessory, int i, UserHandle userHandle, boolean z) throws RemoteException;
  ...
  public static class Default implements IUsbManager {
    ...
    public void addAccessoryPackagesToPreferenceDenied(
        UsbAccessory accessory, String[] packageNames, UserHandle user) throws RemoteException {}
    ...
    public void removeAccessoryPackagesFromPreferenceDenied(
        UsbAccessory device, String[] packageNames, UserHandle user) throws RemoteException {}
    ...
    public void requestAccessoryPermission(
        UsbAccessory accessory, String packageName, PendingIntent pi) throws RemoteException {}
    ...
    public void enableUsbDataWhileDocked(
        String portId, int operationId, IUsbOperationInternal callback) throws RemoteException {}
    ...
    @Override // android.hardware.usb.IUsbManager
    public boolean isSupportScrLckBlk() throws RemoteException {
      return false;
    }
  ...
  public abstract static class Stub extends Binder implements IUsbManager {
    ...
    static final int TRANSACTION_isSupportScrLckBlk = 46;
        ...
        default:
          switch (code) {
            ...
            case 42:
              ...
              return true;
            case 43:
              IDisplayPortAltModeInfoListener _arg035 =
                  IDisplayPortAltModeInfoListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 45:
              ...
              return true;
            case 46:
              boolean _result21 = isSupportScrLckBlk();
              reply.writeNoException();
            ...
            case 48:
              ...
              data.enforceNoDataAvail();
              int _result23 = restrictUsbHostInterface(_arg037, _arg127);
              reply.writeNoException();
