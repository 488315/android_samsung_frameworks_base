...
public final class UsbOperationInternal extends IUsbOperationInternal.Stub {
    ...
    public void onOperationComplete(int status) {
        ...
        try {
            ...
            this.mStatus = status;
            Log.m98i(TAG, "Port:" + this.mId + " opID:" + this.mOperationID + " status:" + this.mStatus);
    ...
    public void waitForOperationComplete() {
        ...
        try {
            try {
                ...
                if (!this.mOperationComplete) {
                    Log.m96e(TAG, "Port:" + this.mId + " opID:" + this.mOperationID + " operationComplete not received in 5000msecs");
                }
            } catch (InterruptedException e) {
                Log.m96e(TAG, "Port:" + this.mId + " opID:" + this.mOperationID + " operationComplete interrupted");
            }
        } finally {
            this.mLock.unlock();
        }
