...
public class UsbAccessory implements Parcelable {
    ...
    public UsbAccessory(
        ...
        this(
                ...
                version,
                uri,
                new IUsbSerialReader.Stub() { // from class: android.hardware.usb.UsbAccessory.1
    ...
    public boolean equals(Object obj) {
        ...
        return compare(this.mManufacturer, accessory.getManufacturer())
                && compare(this.mModel, accessory.getModel())
                && compare(this.mDescription, accessory.getDescription())
                && compare(this.mVersion, accessory.getVersion())
                && compare(this.mUri, accessory.getUri())
                && compare(getSerial(), accessory.getSerial());
    }

    public int hashCode() {
        return (((this.mManufacturer.hashCode() ^ this.mModel.hashCode())
                                ^ (this.mDescription == null ? 0 : this.mDescription.hashCode()))
                        ^ (this.mVersion == null ? 0 : this.mVersion.hashCode()))
                ^ (this.mUri != null ? this.mUri.hashCode() : 0);
    }

    public String toString() {
        return "UsbAccessory[mManufacturer="
                + this.mManufacturer
                + ", mModel="
                + this.mModel
                + ", mDescription="
