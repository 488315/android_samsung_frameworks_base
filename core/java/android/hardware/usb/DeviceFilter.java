    ...
    public boolean matches(UsbDevice device) {
        ...
        for (int intfNum2 = 0; intfNum2 < count; intfNum2++) {
            try {
                ...
                if (intfToCheck != null) {
                    Slog.m113d(str2, "matches interface(" + intfNum + ") -> [" + intfToCheck.toString() + NavigationBarInflaterView.SIZE_MOD_END);
                    return false;
                }
                return false;
            } catch (Exception e) {
                ...
                if (intfToCheck != null) {
                    Slog.m113d(str3, "matches interface(" + intfNum + ") -> [" + intfToCheck.toString() + NavigationBarInflaterView.SIZE_MOD_END);
                    return false;
                }
                return false;
            }
