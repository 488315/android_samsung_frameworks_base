...
public class UsbDevice implements Parcelable {
  ...
  private UsbDevice(
    ...
    IUsbSerialReader iUsbSerialReader =
        (IUsbSerialReader) Objects.requireNonNull(serialNumberReader);
    ...
    StringBuilder builder =
        new StringBuilder(
            "UsbDevice[mName="
                ...
                + ", mHasAudioPlayback="
                + this.mHasAudioPlayback
                + ", mHasAudioCapture="
                + this.mHasAudioCapture
                + ", mHasMidi="
                + this.mHasMidi
                + ", mHasVideoCapture="
                + this.mHasVideoCapture
                + ", mHasVideoPlayback="
                + this.mHasVideoPlayback
                + ", mConfigurations=[");
