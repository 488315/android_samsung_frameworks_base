...
public class UsbManager {
  ...
  @SystemApi public static final String ACTION_USB_STATE = "android.hardware.usb.action.USB_STATE";
                  ...
                  new Runnable() { // from class:
                    ...
                    public final void run() {
                      UsbManager.DisplayPortAltModeInfoListener.this
                          .onDisplayPortAltModeInfoChanged(portId, displayPortAltModeInfo);
                    }
                  });
            } catch (Exception e) {
              Slog.m150e(
                  UsbManager.TAG,
                  "Exception during onDisplayPortAltModeInfoChanged from executor: " + executor,
                  e);
            }
          } finally {
  ...
  void enableLimitPowerTransfer(
    ...
    try {
      ...
      try {
        ...
        Log.m97e(
            TAG,
            "enableLimitPowerTransfer failed to call onOperationComplete. opId:" + operationId,
            r);
      }
      throw e.rethrowFromSystemServer();
    }
  ...
  void enableUsbDataWhileDocked(UsbPort port, int operationId, IUsbOperationInternal callback) {
    ...
    try {
      ...
      try {
        ...
        Log.m97e(
            TAG,
            "enableUsbDataWhileDocked: failed to call onOperationComplete. opId:" + operationId,
            r);
      }
      throw e.rethrowFromSystemServer();
    }
  ...
  private void unregisterDisplayPortAltModeEventsLocked() {
    DisplayPortAltModeInfoDispatchingListener displayPortAltModeInfoDispatchingListener =
        this.mDisplayPortServiceListener;
