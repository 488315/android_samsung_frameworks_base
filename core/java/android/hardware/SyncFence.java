...
public final class SyncFence implements AutoCloseable, Parcelable {
  ...
  private SyncFence(Parcel parcel) {
    ...
    this.mCloser =
        new Runnable() { // from class: android.hardware.SyncFence$$ExternalSyntheticLambda0
  ...
  public SyncFence(long nativeFencePtr) {
    ...
    if (nativeFencePtr != 0) {
      ...
      this.mCloser =
          new Runnable() { // from class: android.hardware.SyncFence$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
  ...
  private SyncFence() {
    this.mCloser =
        new Runnable() { // from class: android.hardware.SyncFence$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
