...
public final class SensorPrivacyManager {
  ...
  private final ISensorPrivacyListener mIToggleListener = new BinderC08861();
  ...
  class BinderC08861 extends ISensorPrivacyListener.Stub {
    BinderC08861() {}
      ...
      synchronized (SensorPrivacyManager.this.mLock) {
        for (int i = 0; i < SensorPrivacyManager.this.mToggleListeners.size(); i++) {
          final OnSensorPrivacyChangedListener listener =
              (OnSensorPrivacyChangedListener) SensorPrivacyManager.this.mToggleListeners.keyAt(i);
  ...
  private int resolveSourceFromCurrentContext() {
    ...
    if (Objects.equals(
        packageName, this.mContext.getPackageManager().getPermissionControllerPackageName())) {
      return 6;
    }
    return 5;
  }
  ...
  public void showSensorUseDialog(int sensor) {
    try {
      ...
      Log.m97e(LOG_TAG, "Received exception while trying to show sensor use dialog", e);
    }
  }
