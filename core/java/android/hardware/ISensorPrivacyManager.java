...
public interface ISensorPrivacyManager extends IInterface {
  ...
  void setToggleSensorPrivacyForProfileGroupWithConfirmPopup(int i, int i2, int i3, boolean z)
      throws RemoteException;
  ...
  public abstract static class Stub extends Binder implements ISensorPrivacyManager {
    ...
    /* renamed from: TRANSACTION_setToggleSensorPrivacyForProfileGroupWithConfirmPopup */
    static final int f105x4f59cbf8 = 12;
