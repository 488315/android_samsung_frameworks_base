...
public final class DeviceStateInfo implements Parcelable {
  ...
  public static final Parcelable.Creator<DeviceStateInfo> CREATOR =
      new Parcelable.Creator<
          DeviceStateInfo>() { // from class: android.hardware.devicestate.DeviceStateInfo.1
  ...
  */
  ...
  public boolean equals(Object other) {
    ...
    if (this.baseState == that.baseState
        && this.currentState == that.currentState
        && Arrays.equals(this.supportedStates, that.supportedStates)) {
      return true;
    }
    return false;
  }
