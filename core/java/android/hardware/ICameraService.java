...
public interface ICameraService extends IInterface {
  ...
  ICamera connect(
      ICameraClient iCameraClient, int i, String str, int i2, int i3, int i4, boolean z, boolean z2)
      throws RemoteException;
  ...
  CameraMetadataNative getCameraCharacteristics(String str, int i, boolean z)
      throws RemoteException;
  ...
  boolean isConcurrentSessionConfigurationSupported(
      CameraIdAndSessionConfiguration[] cameraIdAndSessionConfigurationArr, int i)
      throws RemoteException;
  ...
  public static class Default implements ICameraService {
    ...
    @Override // android.hardware.ICameraService
    public CameraInfo getCameraInfo(int cameraId, boolean overrideToPortrait)
        throws RemoteException {
      return null;
    }
    ...
    public boolean isConcurrentSessionConfigurationSupported(
        CameraIdAndSessionConfiguration[] sessions, int targetSdkVersion) throws RemoteException {
      return false;
    }
    ...
    public CameraMetadataNative getCameraCharacteristics(
        String cameraId, int targetSdkVersion, boolean overrideToPortrait) throws RemoteException {
      return null;
    }
    ...
    @Override // android.hardware.ICameraService
    public void setTorchMode(String cameraId, boolean enabled, IBinder clientBinder)
        throws RemoteException {}

    @Override // android.hardware.ICameraService
    public void turnOnTorchWithStrengthLevel(
        String cameraId, int strengthLevel, IBinder clientBinder) throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements ICameraService {
          ...
          switch (code) {
            ...
            case 4:
              ...
              ICameraDeviceUser _result4 =
                  connectDevice(_arg04, _arg13, _arg22, _arg32, _arg42, _arg52, _arg62, _arg72);
              reply.writeNoException();
            ...
            case 15:
              ...
              ICameraInjectionCallback _arg33 =
            ...
            case 21:
              ...
              return true;
            case 22:
              CameraExtensionSessionStats _arg018 =
            ...
            case 28:
              ...
              IDeviceInjectorCallback _arg34 =
            ...
            case 29:
              ...
              IDeviceInjectorCallback _arg35 =
                  IDeviceInjectorCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
    ...
    private static class Proxy implements ICameraService {
      ...
      @Override // android.hardware.ICameraService
      public CameraMetadataNative getCameraCharacteristics(
          String cameraId, int targetSdkVersion, boolean overrideToPortrait)
          throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
      ...
      public VendorTagDescriptor getCameraVendorTagDescriptor() throws RemoteException {
        ...
        try {
          ...
          VendorTagDescriptor _result =
              (VendorTagDescriptor) _reply.readTypedObject(VendorTagDescriptor.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public VendorTagDescriptorCache getCameraVendorTagCache() throws RemoteException {
        ...
        try {
          ...
          VendorTagDescriptorCache _result =
              (VendorTagDescriptorCache) _reply.readTypedObject(VendorTagDescriptorCache.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
