...
public interface IGnssConfiguration extends android.hardware.gnss.V2_0.IGnssConfiguration {
    ...
    @Override // android.hardware.gnss.V2_0.IGnssConfiguration, android.hardware.gnss.V1_1.IGnssConfiguration, android.hardware.gnss.V1_0.IGnssConfiguration, android.internal.hidl.base.V1_0.IBase, android.p009os.IHwInterface
    IHwBinder asBinder();
    ...
    public static final class Proxy implements IGnssConfiguration {
        ...
        @Override // android.hardware.gnss.V2_1.IGnssConfiguration, android.hardware.gnss.V2_0.IGnssConfiguration, android.hardware.gnss.V1_1.IGnssConfiguration, android.hardware.gnss.V1_0.IGnssConfiguration, android.internal.hidl.base.V1_0.IBase, android.p009os.IHwInterface
