...
public interface IGnssAntennaInfoCallback extends IBase {
  ...
  public static final class Coord {
    ...
    /* renamed from: x */
    public double f147x = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;
    public double xUncertainty = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;

    /* renamed from: y */
    public double f148y = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;
    public double yUncertainty = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;

    /* renamed from: z */
    public double f149z = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;
    ...
    public final int hashCode() {
      return Objects.hash(
          Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.f147x))),
          Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.xUncertainty))),
          Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.f148y))),
          Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.yUncertainty))),
          Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.f149z))),
    ...
    public final void readEmbeddedFromParcel(
        HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
      this.f147x = _hidl_blob.getDouble(0 + _hidl_offset);
      this.xUncertainty = _hidl_blob.getDouble(8 + _hidl_offset);
      this.f148y = _hidl_blob.getDouble(16 + _hidl_offset);
      this.yUncertainty = _hidl_blob.getDouble(24 + _hidl_offset);
      this.f149z = _hidl_blob.getDouble(32 + _hidl_offset);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
      _hidl_blob.putDouble(0 + _hidl_offset, this.f147x);
      _hidl_blob.putDouble(8 + _hidl_offset, this.xUncertainty);
      _hidl_blob.putDouble(16 + _hidl_offset, this.f148y);
      _hidl_blob.putDouble(24 + _hidl_offset, this.yUncertainty);
      _hidl_blob.putDouble(32 + _hidl_offset, this.f149z);
  ...
  public static final class GnssAntennaInfo {
    ...
    public final boolean equals(Object otherObject) {
      ...
      if (this.carrierFrequencyMHz == other.carrierFrequencyMHz
          ...
          && HidlSupport.deepEquals(this.signalGainCorrectionDbi, other.signalGainCorrectionDbi)
          && HidlSupport.deepEquals(
              this.signalGainCorrectionUncertaintyDbi, other.signalGainCorrectionUncertaintyDbi)) {
        return true;
      }
      return false;
    }
    ...
    public final int hashCode() {
      return Objects.hash(
          Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.carrierFrequencyMHz))),
          Integer.valueOf(HidlSupport.deepHashCode(this.phaseCenterOffsetCoordinateMillimeters)),
          Integer.valueOf(HidlSupport.deepHashCode(this.phaseCenterVariationCorrectionMillimeters)),
          Integer.valueOf(
              HidlSupport.deepHashCode(this.phaseCenterVariationCorrectionUncertaintyMillimeters)),
          Integer.valueOf(HidlSupport.deepHashCode(this.signalGainCorrectionDbi)),
          Integer.valueOf(HidlSupport.deepHashCode(this.signalGainCorrectionUncertaintyDbi)));
    }
    ...
    public final void readEmbeddedFromParcel(
      ...
      HwBlob childBlob4 =
          parcel.readEmbeddedBuffer(
              _hidl_vec_size4 * 16, _hidl_blob.handle(), _hidl_offset + 104 + 0, true);
