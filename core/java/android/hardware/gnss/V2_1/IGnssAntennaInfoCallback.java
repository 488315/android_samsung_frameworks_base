...
public interface IGnssAntennaInfoCallback extends IBase {
    ...
    public static final class Coord {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (this.f147x == other.f147x && this.xUncertainty == other.xUncertainty && this.f148y == other.f148y && this.yUncertainty == other.yUncertainty && this.f149z == other.f149z && this.zUncertainty == other.zUncertainty) {
                return true;
            }
            return false;
        }
        ...
        public final int hashCode() {
            return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.f147x))), Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.xUncertainty))), Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.f148y))), Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.yUncertainty))), Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.f149z))), Integer.valueOf(HidlSupport.deepHashCode(Double.valueOf(this.zUncertainty))));
        }

        public final String toString() {
            return "{.x = " + this.f147x + ", .xUncertainty = " + this.xUncertainty + ", .y = " + this.f148y + ", .yUncertainty = " + this.yUncertainty + ", .z = " + this.f149z + ", .zUncertainty = " + this.zUncertainty + "}";
        }
    ...
    public static final class Proxy implements IGnssAntennaInfoCallback {
        ...
        @Override // android.hardware.gnss.V2_1.IGnssAntennaInfoCallback, android.internal.hidl.base.V1_0.IBase, android.p009os.IHwInterface
