...
public interface IGnssAntennaInfoCallback extends IInterface {
  ...
  public static class Coord implements Parcelable {
    public static final Parcelable.Creator<Coord> CREATOR =
        new Parcelable.Creator<
            Coord>() { // from class: android.hardware.gnss.IGnssAntennaInfoCallback.Coord.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    /* renamed from: x */
    public double f142x = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;
    public double xUncertainty = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;

    /* renamed from: y */
    public double f143y = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;
    public double yUncertainty = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;

    /* renamed from: z */
    public double f144z = SContextConstants.ENVIRONMENT_VALUE_UNKNOWN;
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
      int _aidl_start_pos = _aidl_parcel.dataPosition();
      _aidl_parcel.writeInt(0);
      _aidl_parcel.writeDouble(this.f142x);
      _aidl_parcel.writeDouble(this.xUncertainty);
      _aidl_parcel.writeDouble(this.f143y);
      _aidl_parcel.writeDouble(this.yUncertainty);
      _aidl_parcel.writeDouble(this.f144z);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
      ...
      try {
        ...
        this.f142x = _aidl_parcel.readDouble();
        if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
          if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
            throw new BadParcelableException("Overflow in the size of parcelable");
          }
        ...
        this.f143y = _aidl_parcel.readDouble();
        if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
          if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
            throw new BadParcelableException("Overflow in the size of parcelable");
          }
        ...
        this.f144z = _aidl_parcel.readDouble();
        if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
          if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
            throw new BadParcelableException("Overflow in the size of parcelable");
          }
