...
public interface IGnssMeasurement extends android.hardware.gnss.V1_1.IGnssMeasurement {
  ...
  int setCallback_2_0(IGnssMeasurementCallback iGnssMeasurementCallback, boolean z)
  ...
  public static final class Proxy implements IGnssMeasurement {
    ...
    public int setCallback_1_1(
        android.hardware.gnss.V1_1.IGnssMeasurementCallback callback, boolean enableFullTracking)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
    ...
    @Override // android.hardware.gnss.V2_0.IGnssMeasurement
    public int setCallback_2_0(IGnssMeasurementCallback callback, boolean enableFullTracking)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        ...
        case 4:
          ...
          IGnssMeasurementCallback callback3 =
