...
public interface IGnss extends android.hardware.gnss.V1_1.IGnss {
  ...
  @Override // android.hardware.gnss.V1_1.IGnss, android.hardware.gnss.V1_0.IGnss,
  ...
  public static final class Proxy implements IGnss {
    ...
    public android.hardware.gnss.V1_0.IAGnssRil getExtensionAGnssRil() throws RemoteException {
      ...
      try {
        ...
        _hidl_reply.verifySuccess();
        _hidl_request.releaseTemporaryStorage();
        android.hardware.gnss.V1_0.IAGnssRil _hidl_out_aGnssRilIface =
            android.hardware.gnss.V1_0.IAGnssRil.asInterface(_hidl_reply.readStrongBinder());
    ...
    public android.hardware.gnss.V1_0.IAGnss getExtensionAGnss() throws RemoteException {
      ...
      try {
        ...
        _hidl_reply.verifySuccess();
        _hidl_request.releaseTemporaryStorage();
        android.hardware.gnss.V1_0.IAGnss _hidl_out_aGnssIface =
            android.hardware.gnss.V1_0.IAGnss.asInterface(_hidl_reply.readStrongBinder());
    ...
    public android.hardware.gnss.V1_0.IGnssDebug getExtensionGnssDebug() throws RemoteException {
      ...
      try {
        ...
        _hidl_reply.verifySuccess();
        _hidl_request.releaseTemporaryStorage();
        android.hardware.gnss.V1_0.IGnssDebug _hidl_out_debugIface =
            android.hardware.gnss.V1_0.IGnssDebug.asInterface(_hidl_reply.readStrongBinder());
    ...
    public android.hardware.gnss.V1_0.IGnssBatching getExtensionGnssBatching()
      ...
      try {
        ...
        _hidl_reply.verifySuccess();
        _hidl_request.releaseTemporaryStorage();
        android.hardware.gnss.V1_0.IGnssBatching _hidl_out_batchingIface =
            android.hardware.gnss.V1_0.IGnssBatching.asInterface(_hidl_reply.readStrongBinder());
    ...
    public IGnssDebug getExtensionGnssDebug_2_0() throws RemoteException {
      ...
      try {
        ...
        _hidl_reply.verifySuccess();
        _hidl_request.releaseTemporaryStorage();
        IGnssDebug _hidl_out_gnssDebugIface =
      ...
      switch (_hidl_code) {
        ...
        case 23:
          ...
          android.hardware.gnss.V1_0.GnssLocation location =
              new android.hardware.gnss.V1_0.GnssLocation();
        ...
        case 25:
          _hidl_request.enforceInterface(IGnss.kInterfaceName);
          IGnssConfiguration _hidl_out_gnssConfigurationIface2 =
