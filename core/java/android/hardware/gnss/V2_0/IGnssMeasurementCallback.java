...
public interface IGnssMeasurementCallback
    extends android.hardware.gnss.V1_1.IGnssMeasurementCallback {
  ...
  public static final class GnssMeasurement {
    ...
    public final boolean equals(Object otherObject) {
      ...
      if (HidlSupport.deepEquals(this.v1_1, other.v1_1)
    ...
    public final int hashCode() {
      return Objects.hash(
          Integer.valueOf(HidlSupport.deepHashCode(this.v1_1)),
    ...
    public static final ArrayList<GnssMeasurement> readVectorFromParcel(HwParcel parcel) {
      ...
      HwBlob childBlob =
          parcel.readEmbeddedBuffer(_hidl_vec_size * 176, _hidl_blob.handle(), 0L, true);
      _hidl_vec.clear();
    ...
    public final void readEmbeddedFromParcel(
      ...
      parcel.readEmbeddedBuffer(
          r2.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 152 + 0, false);
  ...
  public static final class GnssData {
    ...
    public final void readEmbeddedFromParcel(
      ...
      HwBlob childBlob =
          parcel.readEmbeddedBuffer(
              _hidl_vec_size * 176, _hidl_blob.handle(), _hidl_offset + 0 + 0, true);
