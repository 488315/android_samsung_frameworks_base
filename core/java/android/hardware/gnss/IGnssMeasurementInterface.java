...
public interface IGnssMeasurementInterface extends IInterface {
  ...
  public static class Default implements IGnssMeasurementInterface {
    ...
    public void setCallback(
        IGnssMeasurementCallback callback, boolean enableFullTracking, boolean enableCorrVecOutputs)
        throws RemoteException {}
  ...
  public static class Options implements Parcelable {
    public static final Parcelable.Creator<Options> CREATOR =
        new Parcelable.Creator<
            Options>() { // from class: android.hardware.gnss.IGnssMeasurementInterface.Options.1
