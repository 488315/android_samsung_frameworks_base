...
public interface IGnssXtra extends IBase {
  ...
  public abstract static class Stub extends HwBinder implements IGnssXtra {
    @Override // android.hardware.gnss.V1_0.IGnssXtra, android.internal.hidl.base.V1_0.IBase,
              // android.p009os.IHwInterface
    public IHwBinder asBinder() {
      return this;
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        case 1:
          ...
          IGnssXtraCallback callback =
              IGnssXtraCallback.asInterface(_hidl_request.readStrongBinder());
