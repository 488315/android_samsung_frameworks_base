  ...
  public static final class GnssNavigationMessage {
    ...
    public final boolean equals(Object otherObject) {
      ...
      if (this.svid == other.svid
          ...
          && HidlSupport.deepEquals(Short.valueOf(this.status), Short.valueOf(other.status))
  ...
  public abstract static class Stub extends HwBinder implements IGnssNavigationMessageCallback {
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(
          Arrays.asList(IGnssNavigationMessageCallback.kInterfaceName, IBase.kInterfaceName));
    }
