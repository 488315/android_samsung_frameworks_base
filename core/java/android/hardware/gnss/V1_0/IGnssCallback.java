...
public interface IGnssCallback extends IBase {
  ...
  public static final class GnssSvInfo {
    ...
    public final boolean equals(Object otherObject) {
      ...
      if (this.svid == other.svid
          ...
          && HidlSupport.deepEquals(Byte.valueOf(this.svFlag), Byte.valueOf(other.svFlag))) {
        return true;
      }
      return false;
    }
  ...
  public static final class GnssSvStatus {
    ...
    public static final ArrayList<GnssSvStatus> readVectorFromParcel(HwParcel parcel) {
      ...
      HwBlob childBlob =
          parcel.readEmbeddedBuffer(
              _hidl_vec_size * MetricsProto.MetricsEvent.FIELD_ACTIVITY_RECORD_LAUNCH_MODE,
              _hidl_blob.handle(),
              0L,
              true);
      _hidl_vec.clear();
      for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        _hidl_vec_element.readEmbeddedFromParcel(
            parcel,
            childBlob,
            _hidl_index_0 * MetricsProto.MetricsEvent.FIELD_ACTIVITY_RECORD_LAUNCH_MODE);
        _hidl_vec.add(_hidl_vec_element);
      }
      return _hidl_vec;
    }
    ...
    public static final void writeVectorToParcel(
      ...
      _hidl_blob.putBool(12L, false);
      HwBlob childBlob =
          new HwBlob(_hidl_vec_size * MetricsProto.MetricsEvent.FIELD_ACTIVITY_RECORD_LAUNCH_MODE);
      for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        _hidl_vec
            .get(_hidl_index_0)
            .writeEmbeddedToBlob(
