...
public interface IGnssGeofencing extends IBase {
  ...
  public abstract static class Stub extends HwBinder implements IGnssGeofencing {
    @Override // android.hardware.gnss.V1_0.IGnssGeofencing, android.internal.hidl.base.V1_0.IBase,
              // android.p009os.IHwInterface
    public IHwBinder asBinder() {
      return this;
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        case 1:
          ...
          IGnssGeofenceCallback callback =
              IGnssGeofenceCallback.asInterface(_hidl_request.readStrongBinder());
