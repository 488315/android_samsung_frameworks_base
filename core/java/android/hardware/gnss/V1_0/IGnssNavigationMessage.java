...
public interface IGnssNavigationMessage extends IBase {
  ...
  int setCallback(IGnssNavigationMessageCallback iGnssNavigationMessageCallback)
  ...
  static IGnssNavigationMessage getService(String serviceName, boolean retry)
      throws RemoteException {
  ...
  public abstract static class Stub extends HwBinder implements IGnssNavigationMessage {
    @Override // android.hardware.gnss.V1_0.IGnssNavigationMessage,
              // android.internal.hidl.base.V1_0.IBase, android.p009os.IHwInterface
    public IHwBinder asBinder() {
      return this;
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(
          Arrays.asList(IGnssNavigationMessage.kInterfaceName, IBase.kInterfaceName));
    }
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        case 1:
          ...
          IGnssNavigationMessageCallback callback =
              IGnssNavigationMessageCallback.asInterface(_hidl_request.readStrongBinder());
