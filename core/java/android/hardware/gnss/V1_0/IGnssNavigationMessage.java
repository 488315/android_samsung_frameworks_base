        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of"
                        + " android.hardware.gnss@1.0::IGnssNavigationMessage]@Proxy";
            }
        }
    ...
    public abstract static class Stub extends HwBinder implements IGnssNavigationMessage {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(
                    Arrays.asList(
                            new byte[] {
                                -81, -123, -86, 15, 72, -82, -103, -93, -97, 70, -120, -61, 68, -28,
                                65, -109, 4, -10, -127, -7, -81, -127, -118, 92, -115, 117, -110,
                                -122, -4, 68, 24, -34
                            },
                            new byte[] {
                                -20,
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    IGnssNavigationMessageCallback callback =
                            IGnssNavigationMessageCallback.asInterface(
