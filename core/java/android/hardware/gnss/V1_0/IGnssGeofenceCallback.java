...
public interface IGnssGeofenceCallback extends IBase {
  ...
  static IGnssGeofenceCallback getService(String serviceName, boolean retry)
      throws RemoteException {
  ...
  public static final class Proxy implements IGnssGeofenceCallback {
    ...
    public void gnssGeofenceTransitionCb(
        int geofenceId, GnssLocation location, int transition, long timestamp)
        throws RemoteException {
  ...
  public abstract static class Stub extends HwBinder implements IGnssGeofenceCallback {
    @Override // android.hardware.gnss.V1_0.IGnssGeofenceCallback,
              // android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
    public IHwBinder asBinder() {
      return this;
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(
          Arrays.asList(IGnssGeofenceCallback.kInterfaceName, IBase.kInterfaceName));
    }
