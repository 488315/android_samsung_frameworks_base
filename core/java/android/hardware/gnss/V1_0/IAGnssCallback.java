...
public interface IAGnssCallback extends IBase {
  ...
  public static final class AGnssStatusIpV4 {
    ...
    public final int hashCode() {
      return Objects.hash(
          ...
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.ipV4Addr))));
    }

    public final String toString() {
      return "{.type = "
          + AGnssType.toString(this.type)
          + ", .status = "
          + AGnssStatusValue.toString(this.status)
          + ", .ipV4Addr = "
          + this.ipV4Addr
          + "}";
    }
    ...
    public static final void writeVectorToParcel(
        HwParcel parcel, ArrayList<AGnssStatusIpV4> _hidl_vec) {
  ...
  public static final class AGnssStatusIpV6 {
    ...
    public final boolean equals(Object otherObject) {
      ...
      if (this.type == other.type
          && this.status == other.status
          && HidlSupport.deepEquals(this.ipV6Addr, other.ipV6Addr)) {
        return true;
      }
      return false;
    }
    ...
    public final int hashCode() {
      return Objects.hash(
          Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.type))),
          Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.status))),
          Integer.valueOf(HidlSupport.deepHashCode(this.ipV6Addr)));
    }
    ...
    public static final ArrayList<AGnssStatusIpV6> readVectorFromParcel(HwParcel parcel) {
      ...
      int _hidl_vec_size = _hidl_blob.getInt32(8L);
      HwBlob childBlob =
          parcel.readEmbeddedBuffer(_hidl_vec_size * 18, _hidl_blob.handle(), 0L, true);
      _hidl_vec.clear();
      for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
    ...
    public static final void writeVectorToParcel(
        HwParcel parcel, ArrayList<AGnssStatusIpV6> _hidl_vec) {
      HwBlob _hidl_blob = new HwBlob(16);
      int _hidl_vec_size = _hidl_vec.size();
      _hidl_blob.putInt32(8L, _hidl_vec_size);
      _hidl_blob.putBool(12L, false);
  ...
  public abstract static class Stub extends HwBinder implements IAGnssCallback {
    @Override // android.hardware.gnss.V1_0.IAGnssCallback, android.internal.hidl.base.V1_0.IBase,
              // android.p009os.IHwInterface
    public IHwBinder asBinder() {
      return this;
