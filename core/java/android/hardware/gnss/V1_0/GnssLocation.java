...
public final class GnssLocation {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(
                        Short.valueOf(this.gnssLocationFlags),
                        Short.valueOf(other.gnssLocationFlags))
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(
                        HidlSupport.deepHashCode(Float.valueOf(this.horizontalAccuracyMeters))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(Float.valueOf(this.verticalAccuracyMeters))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(Float.valueOf(this.speedAccuracyMetersPerSecond))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(Float.valueOf(this.bearingAccuracyDegrees))),
    ...
    public static final void writeVectorToParcel(
            HwParcel parcel, ArrayList<GnssLocation> _hidl_vec) {
