...
public final class GnssLocation {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(
            Short.valueOf(this.gnssLocationFlags), Short.valueOf(other.gnssLocationFlags))
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Short.valueOf(this.gnssLocationFlags))),
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.horizontalAccuracyMeters))),
        Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.verticalAccuracyMeters))),
        Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.speedAccuracyMetersPerSecond))),
        Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.bearingAccuracyDegrees))),
        Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.timestamp))));
  }

  public final String toString() {
    return "{.gnssLocationFlags = "
        + GnssLocationFlags.dumpBitfield(this.gnssLocationFlags)
        + ", .latitudeDegrees = "
