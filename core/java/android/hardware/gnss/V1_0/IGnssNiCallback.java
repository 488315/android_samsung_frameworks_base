  ...
  public static final class GnssNiNotification {
    ...
    public final int hashCode() {
      return Objects.hash(
          ...
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.requestorIdEncoding))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.notificationIdEncoding))));
    }
