...
public interface IGnssMeasurement extends android.hardware.gnss.V1_0.IGnssMeasurement {
  ...
  int setCallback_1_1(IGnssMeasurementCallback iGnssMeasurementCallback, boolean z)
  ...
  public static final class Proxy implements IGnssMeasurement {
    ...
    @Override // android.hardware.gnss.V1_1.IGnssMeasurement
    public int setCallback_1_1(IGnssMeasurementCallback callback, boolean enableFullTracking)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        ...
        case 3:
          ...
          IGnssMeasurementCallback callback2 =
