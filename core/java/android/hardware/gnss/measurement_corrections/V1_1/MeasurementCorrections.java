...
public final class MeasurementCorrections {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.v1_0, other.v1_0)
                ...
                && this.environmentBearingUncertaintyDegrees
                        == other.environmentBearingUncertaintyDegrees
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                Integer.valueOf(
                        HidlSupport.deepHashCode(Boolean.valueOf(this.hasEnvironmentBearing))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(Float.valueOf(this.environmentBearingDegrees))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(
                                Float.valueOf(this.environmentBearingUncertaintyDegrees))),
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            this.satCorrections
                    .get(_hidl_index_0)
                    .writeEmbeddedToBlob(childBlob, _hidl_index_0 * 64);
        }
