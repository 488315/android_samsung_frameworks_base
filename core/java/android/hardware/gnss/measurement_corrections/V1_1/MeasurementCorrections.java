...
public final class MeasurementCorrections {
  public android.hardware.gnss.measurement_corrections.V1_0.MeasurementCorrections v1_0 =
      new android.hardware.gnss.measurement_corrections.V1_0.MeasurementCorrections();
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (HidlSupport.deepEquals(this.v1_0, other.v1_0)
        && this.hasEnvironmentBearing == other.hasEnvironmentBearing
        && this.environmentBearingDegrees == other.environmentBearingDegrees
        && this.environmentBearingUncertaintyDegrees == other.environmentBearingUncertaintyDegrees
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.hasEnvironmentBearing))),
        Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.environmentBearingDegrees))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Float.valueOf(this.environmentBearingUncertaintyDegrees))),
        Integer.valueOf(HidlSupport.deepHashCode(this.satCorrections)));
  }

  public final String toString() {
    return "{.v1_0 = "
        + this.v1_0
        + ", .hasEnvironmentBearing = "
        + this.hasEnvironmentBearing
        + ", .environmentBearingDegrees = "
        + this.environmentBearingDegrees
        + ", .environmentBearingUncertaintyDegrees = "
        + this.environmentBearingUncertaintyDegrees
        + ", .satCorrections = "
        + this.satCorrections
        + "}";
  }
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size * 64, _hidl_blob.handle(), _hidl_offset + 80 + 0, true);
  ...
  public static final void writeVectorToParcel(
      HwParcel parcel, ArrayList<MeasurementCorrections> _hidl_vec) {
