...
public final class SingleSatCorrection {
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Short.valueOf(this.singleSatCorrectionFlags))),
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.excessPathLengthMeters))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Float.valueOf(this.excessPathLengthUncertaintyMeters))),
