    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.latitudeDegrees == other.latitudeDegrees
                ...
                && this.horizontalPositionUncertaintyMeters
                        == other.horizontalPositionUncertaintyMeters
        ...
        return Objects.hash(
                ...
                Integer.valueOf(
                        HidlSupport.deepHashCode(
                                Double.valueOf(this.horizontalPositionUncertaintyMeters))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(
                                Double.valueOf(this.verticalPositionUncertaintyMeters))),
                Integer.valueOf(
                        HidlSupport.deepHashCode(Long.valueOf(this.toaGpsNanosecondsOfWeek))),
