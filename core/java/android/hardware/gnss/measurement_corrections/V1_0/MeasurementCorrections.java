...
public final class MeasurementCorrections {
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (this.latitudeDegrees == other.latitudeDegrees
        ...
        && this.horizontalPositionUncertaintyMeters == other.horizontalPositionUncertaintyMeters
        && this.verticalPositionUncertaintyMeters == other.verticalPositionUncertaintyMeters
        && this.toaGpsNanosecondsOfWeek == other.toaGpsNanosecondsOfWeek
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(
            HidlSupport.deepHashCode(Double.valueOf(this.horizontalPositionUncertaintyMeters))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Double.valueOf(this.verticalPositionUncertaintyMeters))),
        Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.toaGpsNanosecondsOfWeek))),
  ...
  public final String toString() {
    return "{.latitudeDegrees = "
        ...
        + this.horizontalPositionUncertaintyMeters
        + ", .verticalPositionUncertaintyMeters = "
        + this.verticalPositionUncertaintyMeters
        + ", .toaGpsNanosecondsOfWeek = "
        + this.toaGpsNanosecondsOfWeek
        + ", .satCorrections = "
        + this.satCorrections
        + "}";
  }
  ...
  public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
    ...
    HwBlob childBlob =
        parcel.readEmbeddedBuffer(
            _hidl_vec_size * 56, _hidl_blob.handle(), _hidl_offset + 48 + 0, true);
