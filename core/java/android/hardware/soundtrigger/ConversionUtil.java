...
public class ConversionUtil {
    ...
    public static SoundTrigger.Keyphrase aidl2apiPhrase(Phrase aidlPhrase) {
        return new SoundTrigger.Keyphrase(aidlPhrase.f310id, aidl2apiRecognitionModes(aidlPhrase.recognitionModes), new Locale.Builder().setLanguageTag(aidlPhrase.locale).build(), aidlPhrase.text, Arrays.copyOf(aidlPhrase.users, aidlPhrase.users.length));
    }
    ...
    public static SoundTrigger.KeyphraseRecognitionExtra aidl2apiPhraseRecognitionExtra(PhraseRecognitionExtra aidlExtra) {
        ...
        return new SoundTrigger.KeyphraseRecognitionExtra(aidlExtra.f311id, aidl2apiRecognitionModes(aidlExtra.recognitionModes), aidlExtra.confidenceLevel, apiLevels);
    }
