...
public final class KeyphraseMetadata implements Parcelable {
  public static final Parcelable.Creator<KeyphraseMetadata> CREATOR =
      new Parcelable.Creator<
          KeyphraseMetadata>() { // from class: android.hardware.soundtrigger.KeyphraseMetadata.1
  ...
  public KeyphraseMetadata(
      int id, String keyphrase, Set<Locale> supportedLocales, int recognitionModeFlags) {
    this.mId = id;
  ...
  public boolean equals(Object o) {
    ...
    if (this.mId == that.mId
        && Objects.equals(this.mKeyphrase, that.mKeyphrase)
        && Objects.equals(this.mSupportedLocales, that.mSupportedLocales)
        && this.mRecognitionModeFlags == that.mRecognitionModeFlags) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    return (((((_hash * 31) + Objects.hashCode(this.mKeyphrase)) * 31)
  ...
  KeyphraseMetadata(Parcel in) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) keyphrase);
