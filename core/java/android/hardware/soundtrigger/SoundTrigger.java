...
public class SoundTrigger {
    ...
    public static final class KeyphraseRecognitionExtra implements Parcelable {
        ...
        public int hashCode() {
            ...
            return (((((result * 31) + this.f227id) * 31) + this.recognitionModes) * 31) + this.coarseConfidenceLevel;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (Arrays.equals(this.confidenceLevels, other.confidenceLevels) && this.f227id == other.f227id && this.recognitionModes == other.recognitionModes && this.coarseConfidenceLevel == other.coarseConfidenceLevel) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            return "KeyphraseRecognitionExtra [id=" + this.f227id + ", recognitionModes=" + this.recognitionModes + ", coarseConfidenceLevel=" + this.coarseConfidenceLevel + ", confidenceLevels=" + Arrays.toString(this.confidenceLevels) + NavigationBarInflaterView.SIZE_MOD_END;
        }
    }
    ...
    public static class KeyphraseRecognitionEvent extends RecognitionEvent implements Parcelable {
        ...
        @Override // android.hardware.soundtrigger.SoundTrigger.RecognitionEvent, android.p009os.Parcelable
        public void writeToParcel(Parcel parcel, int i) {
            parcel.writeInt(this.status);
            parcel.writeInt(this.soundModelHandle);
            parcel.writeByte(this.captureAvailable ? (byte) 1 : (byte) 0);
