...
public final class DemuxFilterEvent implements Parcelable {
  public static final Parcelable.Creator<DemuxFilterEvent> CREATOR =
      new Parcelable.Creator<
          DemuxFilterEvent>() { // from class: android.hardware.tv.tuner.DemuxFilterEvent.1
    ...
    switch (_aidl_tag) {
      case 0:
        DemuxFilterSectionEvent _aidl_value =
            (DemuxFilterSectionEvent) _aidl_parcel.readTypedObject(DemuxFilterSectionEvent.CREATOR);
        _set(_aidl_tag, _aidl_value);
        return;
      case 1:
        DemuxFilterMediaEvent _aidl_value2 =
            (DemuxFilterMediaEvent) _aidl_parcel.readTypedObject(DemuxFilterMediaEvent.CREATOR);
        _set(_aidl_tag, _aidl_value2);
        return;
      case 2:
        DemuxFilterPesEvent _aidl_value3 =
            (DemuxFilterPesEvent) _aidl_parcel.readTypedObject(DemuxFilterPesEvent.CREATOR);
      ...
      case 7:
        DemuxFilterTemiEvent _aidl_value8 =
            (DemuxFilterTemiEvent) _aidl_parcel.readTypedObject(DemuxFilterTemiEvent.CREATOR);
        _set(_aidl_tag, _aidl_value8);
        return;
      case 8:
        DemuxFilterMonitorEvent _aidl_value9 =
            (DemuxFilterMonitorEvent) _aidl_parcel.readTypedObject(DemuxFilterMonitorEvent.CREATOR);
