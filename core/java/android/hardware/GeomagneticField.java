            ...
            while (m2 <= n) {
                ...
                gcX +=
                        relativeRadiusPower[n + 2]
                                ...
                                * SCHMIDT_QUASI_NORM_FACTORS[n][m2];
                gcY +=
                        relativeRadiusPower[n + 2]
                                * m2
        ...
        float radSq =
                (altitudeKm * altitudeKm)
                        + (2.0f
                                ...
                                * ((float)
                                        Math.sqrt(
                                                (4.0680636E7f * clat * clat)
                                                        + (4.04083E7f * slat * slat))))
