...
public interface IVibrator extends IInterface {
    ...
    /* renamed from: on */
    void mo46on(int i, IVibratorCallback iVibratorCallback) throws RemoteException;
    ...
    public static class Default implements IVibrator {
        ...
        @Override // android.hardware.vibrator.IVibrator
        /* renamed from: on */
        public void mo46on(int timeoutMs, IVibratorCallback callback) throws RemoteException {
        }
