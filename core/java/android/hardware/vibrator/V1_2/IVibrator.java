...
public interface IVibrator extends android.hardware.vibrator.V1_1.IVibrator {
  ...
  @Override // android.hardware.vibrator.V1_1.IVibrator, android.hardware.vibrator.V1_0.IVibrator,
      ...
      switch (_hidl_code) {
          ...
          perform(
              ...
              new IVibrator
                  .performCallback() { // from class:
                                       // android.hardware.vibrator.V1_2.IVibrator.Stub.1
          ...
          perform_1_1(
              ...
              new IVibrator
                  .perform_1_1Callback() { // from class:
                                           // android.hardware.vibrator.V1_2.IVibrator.Stub.2
        ...
        case 7:
          ...
          perform_1_2(
              effect3,
              strength3,
              new perform_1_2Callback() { // from class:
                                          // android.hardware.vibrator.V1_2.IVibrator.Stub.3
