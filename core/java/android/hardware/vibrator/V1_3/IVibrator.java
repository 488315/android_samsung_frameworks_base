...
public interface IVibrator extends android.hardware.vibrator.V1_2.IVibrator {
  ...
  @Override // android.hardware.vibrator.V1_2.IVibrator, android.hardware.vibrator.V1_1.IVibrator,
  ...
  public static final class Proxy implements IVibrator {
    ...
    @Override // android.hardware.vibrator.V1_3.IVibrator, android.hardware.vibrator.V1_2.IVibrator,
              // android.hardware.vibrator.V1_1.IVibrator, android.hardware.vibrator.V1_0.IVibrator,
    ...
    /* renamed from: on */
    public int mo47on(int timeoutMs) throws RemoteException {
    ...
    public void perform_1_1(int effect, byte strength, IVibrator.perform_1_1Callback _hidl_cb)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
    ...
    public void perform_1_2(int effect, byte strength, IVibrator.perform_1_2Callback _hidl_cb)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        case 1:
          ...
          int _hidl_out_vibratorOnRet = mo47on(timeoutMs);
        ...
        case 5:
          ...
          perform(
              ...
              strength,
              new IVibrator
                  .performCallback() { // from class:
                                       // android.hardware.vibrator.V1_3.IVibrator.Stub.1
        ...
        case 6:
          ...
          perform_1_1(
              ...
              strength2,
              new IVibrator
                  .perform_1_1Callback() { // from class:
                                           // android.hardware.vibrator.V1_3.IVibrator.Stub.2
        ...
        case 7:
          ...
          perform_1_2(
              ...
              strength3,
              new IVibrator
                  .perform_1_2Callback() { // from class:
                                           // android.hardware.vibrator.V1_3.IVibrator.Stub.3
        ...
        case 10:
          ...
          perform_1_3(
              effect4,
              strength4,
              new perform_1_3Callback() { // from class:
                                          // android.hardware.vibrator.V1_3.IVibrator.Stub.4
