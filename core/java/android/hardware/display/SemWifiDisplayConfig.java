...
public final class SemWifiDisplayConfig implements Parcelable {
  ...
  public static final Parcelable.Creator<SemWifiDisplayConfig> CREATOR =
      new Parcelable.Creator<
          SemWifiDisplayConfig>() { // from class: android.hardware.display.SemWifiDisplayConfig.2
  ...
  public SemWifiDisplayConfig() {
    ...
    this.mPrameterGroups =
        new HashMap<
            String,
            List<
                SemWifiDisplayParameter>>() { // from class:
  ...
  private SemWifiDisplayConfig(
      int connetionType, String ipAddress, String port, String deviceName, String p2pMacAddress) {
    this.mConnectionType = 1;
    this.mFlags = 0;
    this.mMode = 0;
    this.mPrameterGroups =
  ...
  public void setMode(int mode) {
    this.mMode = mode;
    addParameter(
        SemWifiDisplayParameter.INIT_PARAMETER, new SemWifiDisplayParameter("mode", this.mMode));
  }
