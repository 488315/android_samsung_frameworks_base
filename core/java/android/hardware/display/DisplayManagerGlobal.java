        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 9:
                    ...
                    Log.m94d(DisplayManagerGlobal.TAG, "handleMessage EVENT_VOLUME_LEVEL_CHANGED= curVol: " + curVol);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 6:
                    ...
                    Log.m94d(DisplayManagerGlobal.TAG, "handleMessage EVENT_CONNECTIONSTATUS_CHANGED = " + status);
                    this.mListener.onConnectionStatusChanged(status);
                    break;
                case 7:
                    int status2 = data.getInt("status", 6);
                    Log.m94d(DisplayManagerGlobal.TAG, "handleMessage EVENT_REMOTE_DISPLAY_STATE_CHANGED = " + status2);
                    this.mListener.onScreenSharingStatusChanged(status2);
                    break;
                case 8:
                    int status3 = data.getInt("status", 0);
                    Log.m94d(DisplayManagerGlobal.TAG, "handleMessage EVENT_REMOTE_DISPLAY_ROTATION_CHANGED = " + status3);
