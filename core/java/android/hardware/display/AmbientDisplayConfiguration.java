...
public class AmbientDisplayConfiguration {
    ...
    public AmbientDisplayConfiguration(Context context) {
        ...
        this.mAlwaysOnByDefault = context.getResources().getBoolean(C4337R.bool.config_dozeAlwaysOnEnabled);
        this.mPickupGestureEnabledByDefault = context.getResources().getBoolean(C4337R.bool.config_dozePickupGestureEnabled);
    }
    ...
    public boolean pulseOnNotificationAvailable() {
        return this.mContext.getResources().getBoolean(C4337R.bool.config_pulseOnNotificationsAvailable) && ambientDisplayAvailable();
    }
    ...
    public boolean dozePickupSensorAvailable() {
        return this.mContext.getResources().getBoolean(C4337R.bool.config_dozePulsePickup);
    }
    ...
    public boolean wakeScreenGestureAvailable() {
        return this.mContext.getResources().getBoolean(C4337R.bool.config_dozeWakeLockScreenSensorAvailable);
    }
    ...
    public long getWakeLockScreenDebounce() {
        return this.mContext.getResources().getInteger(C4337R.integer.config_dozeWakeLockScreenDebounce);
    }

    public String doubleTapSensorType() {
        return this.mContext.getResources().getString(C4337R.string.config_dozeDoubleTapSensorType);
    }

    public String[] tapSensorTypeMapping() {
        String[] postureMapping = this.mContext.getResources().getStringArray(C4337R.array.config_dozeTapSensorPostureMapping);
        if (ArrayUtils.isEmpty(postureMapping)) {
            return new String[]{this.mContext.getResources().getString(C4337R.string.config_dozeTapSensorType)};
        }
        return postureMapping;
    }

    public String longPressSensorType() {
        return this.mContext.getResources().getString(C4337R.string.config_dozeLongPressSensorType);
    }

    public String udfpsLongPressSensorType() {
        return this.mContext.getResources().getString(C4337R.string.config_dozeUdfpsLongPressSensorType);
    }

    public String quickPickupSensorType() {
        return this.mContext.getResources().getString(C4337R.string.config_quickPickupSensorType);
    }
    ...
    public String ambientDisplayComponent() {
        return this.mContext.getResources().getString(C4337R.string.config_dozeComponent);
    }
    ...
    private boolean alwaysOnDisplayAvailable() {
        return this.mContext.getResources().getBoolean(C4337R.bool.config_dozeAlwaysOnDisplayAvailable);
    }
