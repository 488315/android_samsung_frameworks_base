...
public interface IDisplayManager extends IInterface {
  ...
  void resizeVirtualDisplay(IVirtualDisplayCallback iVirtualDisplayCallback, int i, int i2, int i3)
      throws RemoteException;
  ...
  void setBackupBrightnessConfiguration(
      BrightnessConfiguration brightnessConfiguration, int i, String str) throws RemoteException;
  ...
  public static class Default implements IDisplayManager {
    ...
    public void setBackupBrightnessConfiguration(
        BrightnessConfiguration config, int userId, String packageName) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 21:
              VirtualDisplayConfig _arg013 =
                  (VirtualDisplayConfig) data.readTypedObject(VirtualDisplayConfig.CREATOR);
            ...
            case 27:
              SemWifiDisplayConfig _arg019 =
                  (SemWifiDisplayConfig) data.readTypedObject(SemWifiDisplayConfig.CREATOR);
              IWifiDisplayConnectionCallback _arg111 =
                  IWifiDisplayConnectionCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 46:
              ...
              SemWifiDisplayParameter _arg115 =
                  (SemWifiDisplayParameter) data.readTypedObject(SemWifiDisplayParameter.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 51:
              BrightnessConfiguration _arg034 =
                  (BrightnessConfiguration) data.readTypedObject(BrightnessConfiguration.CREATOR);
            ...
            case 88:
              ...
              data.enforceNoDataAvail();
              IRefreshRateToken _result43 =
                  acquireRefreshRateMaxLimitToken(_arg062, _arg131, _arg28);
              reply.writeNoException();
            ...
            case 89:
              ...
              IRefreshRateToken _result44 =
                  acquireRefreshRateMinLimitToken(_arg063, _arg132, _arg29);
              reply.writeNoException();
      ...
      public BrightnessConfiguration getBrightnessConfigurationForDisplay(
        ...
        try {
          ...
          BrightnessConfiguration _result =
              (BrightnessConfiguration) _reply.readTypedObject(BrightnessConfiguration.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public DisplayDecorationSupport getDisplayDecorationSupport(int displayId)
        ...
        try {
          ...
          DisplayDecorationSupport _result =
              (DisplayDecorationSupport) _reply.readTypedObject(DisplayDecorationSupport.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
