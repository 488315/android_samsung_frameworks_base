...
public final class ColorDisplayManager {
  ...
  public boolean setNightDisplayAutoMode(int autoMode) {
    ...
    if (this.mManager.getNightDisplayAutoMode() != autoMode) {
      getMetricsLogger()
          .write(
              new LogMaker(MetricsProto.MetricsEvent.ACTION_NIGHT_DISPLAY_AUTO_MODE_CHANGED)
                  .setType(4)
                  .setSubtype(autoMode));
    }
  ...
  public boolean setNightDisplayCustomStartTime(LocalTime startTime) {
    ...
    getMetricsLogger()
        .write(
            new LogMaker(
                    MetricsProto.MetricsEvent.ACTION_NIGHT_DISPLAY_AUTO_MODE_CUSTOM_TIME_CHANGED)
                .setType(4)
                .setSubtype(0));
  ...
  public static boolean isNightDisplayAvailable(Context context) {
    return context.getResources().getBoolean(C4337R.bool.config_nightDisplayAvailable);
  }

  public static int getMinimumColorTemperature(Context context) {
    return context.getResources().getInteger(C4337R.integer.config_nightDisplayColorTemperatureMin);
  }

  public static int getMaximumColorTemperature(Context context) {
    return context.getResources().getInteger(C4337R.integer.config_nightDisplayColorTemperatureMax);
  }

  public static boolean isDisplayWhiteBalanceAvailable(Context context) {
    return context.getResources().getBoolean(C4337R.bool.config_displayWhiteBalanceAvailable);
  }

  public static boolean isReduceBrightColorsAvailable(Context context) {
    return context.getResources().getBoolean(C4337R.bool.config_reduceBrightColorsAvailable);
  }

  public static int getMinimumReduceBrightColorsStrength(Context context) {
    return context.getResources().getInteger(C4337R.integer.config_reduceBrightColorsStrengthMin);
  }

  public static int getMaximumReduceBrightColorsStrength(Context context) {
    return context.getResources().getInteger(C4337R.integer.config_reduceBrightColorsStrengthMax);
  }

  public static boolean isColorTransformAccelerated(Context context) {
    return context.getResources().getBoolean(C4337R.bool.config_setColorTransformAccelerated);
  }
  ...
  public static boolean areAccessibilityTransformsEnabled(Context context) {
    ...
    return Settings.Secure.getInt(cr, Settings.Secure.ACCESSIBILITY_DISPLAY_INVERSION_ENABLED, 0)
            == 1
        || Settings.Secure.getInt(cr, Settings.Secure.ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED, 0)
            == 1;
  }
