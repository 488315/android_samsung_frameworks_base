...
public final class BrightnessConfiguration implements Parcelable {
  ...
  public static final Parcelable.Creator<BrightnessConfiguration> CREATOR =
      new Parcelable.Creator<
          BrightnessConfiguration>() { // from class:
  ...
  public int hashCode() {
    int result =
        (((((((1 * 31) + Arrays.hashCode(this.mLux)) * 31) + Arrays.hashCode(this.mNits)) * 31)
  ...
  public boolean equals(Object o) {
    ...
    return Arrays.equals(this.mLux, other.mLux)
        ...
        && checkFloatEquals(
            this.mShortTermModelLowerLuxMultiplier, other.mShortTermModelLowerLuxMultiplier)
        && checkFloatEquals(
