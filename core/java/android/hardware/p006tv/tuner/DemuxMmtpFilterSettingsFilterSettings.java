...
public final class DemuxMmtpFilterSettingsFilterSettings implements Parcelable {
  public static final Parcelable.Creator<DemuxMmtpFilterSettingsFilterSettings> CREATOR =
      new Parcelable.Creator<
          DemuxMmtpFilterSettingsFilterSettings>() { // from class:
                                                     // android.hardware.tv.tuner.DemuxMmtpFilterSettingsFilterSettings.1
  ...
  /* renamed from: av */
  public static final int f241av = 2;
  ...
  public @interface Tag {
    ...
    /* renamed from: av */
    public static final int f242av = 2;
    public static final int download = 5;
    public static final int noinit = 0;
    public static final int pesData = 3;
    public static final int record = 4;
  ...
  /* renamed from: av */
  public static DemuxMmtpFilterSettingsFilterSettings m43av(DemuxFilterAvSettings _value) {
    ...
    switch (_aidl_tag) {
      ...
      case 2:
        DemuxFilterAvSettings _aidl_value3 =
            (DemuxFilterAvSettings) _aidl_parcel.readTypedObject(DemuxFilterAvSettings.CREATOR);
      ...
      case 4:
        ...
        return;
      case 5:
        DemuxFilterDownloadSettings _aidl_value6 =
            (DemuxFilterDownloadSettings)
                _aidl_parcel.readTypedObject(DemuxFilterDownloadSettings.CREATOR);
