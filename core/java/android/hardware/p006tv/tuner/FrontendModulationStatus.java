...
public final class FrontendModulationStatus implements Parcelable {
  public static final Parcelable.Creator<FrontendModulationStatus> CREATOR =
      new Parcelable.Creator<
          FrontendModulationStatus>() { // from class:
                                        // android.hardware.tv.tuner.FrontendModulationStatus.1
