...
public final class DemuxTsFilterSettingsFilterSettings implements Parcelable {
  public static final Parcelable.Creator<DemuxTsFilterSettingsFilterSettings> CREATOR =
      new Parcelable.Creator<
          DemuxTsFilterSettingsFilterSettings>() { // from class:
  ...
  /* renamed from: av */
  public static final int f244av = 2;
  ...
  public @interface Tag {
    ...
    /* renamed from: av */
    public static final int f245av = 2;
    public static final int noinit = 0;
    public static final int pesData = 3;
    public static final int record = 4;
    public static final int section = 1;
  ...
  /* renamed from: av */
  public static DemuxTsFilterSettingsFilterSettings m44av(DemuxFilterAvSettings _value) {
