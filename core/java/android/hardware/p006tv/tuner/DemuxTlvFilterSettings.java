...
public class DemuxTlvFilterSettings implements Parcelable {
  public static final Parcelable.Creator<DemuxTlvFilterSettings> CREATOR =
      new Parcelable.Creator<
          DemuxTlvFilterSettings>() { // from class:
                                      // android.hardware.tv.tuner.DemuxTlvFilterSettings.1
  ...
  public final void readFromParcel(Parcel _aidl_parcel) {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
        ...
        this.filterSettings =
            (DemuxTlvFilterSettingsFilterSettings)
                _aidl_parcel.readTypedObject(DemuxTlvFilterSettingsFilterSettings.CREATOR);
        if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
          throw new BadParcelableException("Overflow in the size of parcelable");
        }
        _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
