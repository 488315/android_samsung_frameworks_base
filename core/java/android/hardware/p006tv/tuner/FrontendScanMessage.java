...
public final class FrontendScanMessage implements Parcelable {
  public static final Parcelable.Creator<FrontendScanMessage> CREATOR =
      new Parcelable.Creator<
          FrontendScanMessage>() { // from class: android.hardware.tv.tuner.FrontendScanMessage.1
    ...
    switch (_aidl_tag) {
      ...
      case 12:
        FrontendModulation _aidl_value13 =
            (FrontendModulation) _aidl_parcel.readTypedObject(FrontendModulation.CREATOR);
