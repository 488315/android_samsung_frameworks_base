...
public final class DemuxFilterSettings implements Parcelable {
  public static final Parcelable.Creator<DemuxFilterSettings> CREATOR =
      new Parcelable.Creator<
          DemuxFilterSettings>() { // from class: android.hardware.tv.tuner.DemuxFilterSettings.1
  ...
  /* renamed from: ip */
  public static final int f232ip = 2;
  public static final int mmtp = 1;
  public static final int tlv = 3;

  /* renamed from: ts */
  public static final int f233ts = 0;
  private int _tag;
  ...
  public @interface Tag {
    ...
    /* renamed from: ip */
    public static final int f234ip = 2;
    public static final int mmtp = 1;
    public static final int tlv = 3;

    /* renamed from: ts */
    public static final int f235ts = 0;
  }
  ...
  /* renamed from: ts */
  public static DemuxFilterSettings m40ts(DemuxTsFilterSettings _value) {
  ...
  /* renamed from: ip */
  public static DemuxFilterSettings m39ip(DemuxIpFilterSettings _value) {
  ...
  public void readFromParcel(Parcel _aidl_parcel) {
    ...
    switch (_aidl_tag) {
      case 0:
        DemuxTsFilterSettings _aidl_value =
            (DemuxTsFilterSettings) _aidl_parcel.readTypedObject(DemuxTsFilterSettings.CREATOR);
        _set(_aidl_tag, _aidl_value);
        return;
      case 1:
        DemuxMmtpFilterSettings _aidl_value2 =
            (DemuxMmtpFilterSettings) _aidl_parcel.readTypedObject(DemuxMmtpFilterSettings.CREATOR);
        _set(_aidl_tag, _aidl_value2);
        return;
      case 2:
        DemuxIpFilterSettings _aidl_value3 =
            (DemuxIpFilterSettings) _aidl_parcel.readTypedObject(DemuxIpFilterSettings.CREATOR);
        _set(_aidl_tag, _aidl_value3);
        return;
      case 3:
        DemuxTlvFilterSettings _aidl_value4 =
            (DemuxTlvFilterSettings) _aidl_parcel.readTypedObject(DemuxTlvFilterSettings.CREATOR);
        _set(_aidl_tag, _aidl_value4);
        return;
      case 4:
        DemuxAlpFilterSettings _aidl_value5 =
            (DemuxAlpFilterSettings) _aidl_parcel.readTypedObject(DemuxAlpFilterSettings.CREATOR);
  ...
  private void _assertTag(int tag) {
    if (getTag() != tag) {
      throw new IllegalStateException(
          "bad access: " + _tagString(tag) + ", " + _tagString(getTag()) + " is available.");
    }
  }
