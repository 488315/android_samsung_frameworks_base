...
public class CameraLightSensorManager {
        ...
        if (this.mSystemHandler == null) {
            if (cameraLooper == null) {
                ...
                Log.d(
                        ...
                        "Using CameraManagerThread looper " + thread.getLooper());
            } else {
        ...
        if (this.mCameraLightSensorConnection == null) {
            ...
            this.mCameraLightSensorConnection =
                    new ServiceConnection() { // from class:
                        // android.hardware.CameraLightSensorManager.1
                        @Override // android.content.ServiceConnection
                        public void onServiceConnected(ComponentName name, IBinder service) {
                            Log.d(
                                    "CameraLightSensor_Manager",
                                    " Service is connected, cmp name = "
                                            + name
                                            + " service = "
                                            + service);
                            synchronized (CameraLightSensorManager.this.mLockIPC) {
                                ...
                                if (CameraLightSensorManager.this.mSystemHandler != null
                                    ...
                                    CameraLightSensorManager.this.mSystemHandler.sendEmptyMessage(
                                            1);
            ...
            if (this.mCameraLightListener != null) {
                if (isAllowListedListener(sensorListener.toString())) {
                    ...
                    Log.d(
                            ...
                            "Entering1 registerCameraLightSensor " + sensorListener);
                    ...
                    Log.d(
                            "Debug_Camera_Manager",
                            "Exit1 registerCameraLightSensor" + sensorListener);
                    ...
                    if (sensorListener
                        ...
                        try {
                            ...
                            boolean isFaceUnlockActive =
                                    mLockPatternUtils.getBiometricState(
                                                    256, UserHandle.semGetMyUserId())
                                            == 1;
                            if (this.mkeyguard != null) {
                                Log.d(
                                        "Debug_Camera_Manager",
                            ...
                            if (this.mkeyguard != null
                                ...
                                Log.d(
                                        "CameraLightSensor_Manager",
                                        "On lock screen, FaceUnlock is true");
                                if (this.mSystemHandler != null) {
                                ...
                                Log.d(
                                        "CameraLightSensor_Manager",
                                        "On lock screen, FaceUnlock is false");
                                if (this.mSystemHandler != null) {
            ...
            if (this.mCameraLightListener != null) {
                synchronized (this.mCameraLightListener) {
                    if (!this.mCameraLightListener.contains(sensorListener)) {
                        Log.e(
                                "CameraLightSensor_Manager",
                                "No camera light sensor listeners present");
                        return false;
                    }
                    this.mCameraLightListener.remove(sensorListener);
                    Log.d(
                            "Debug_Camera_Manager",
                            "Exit2 unRegisterCameraLightSensor" + sensorListener);
                    this.mEnabledService = false;
                    if (this.mSystemHandler != null) {
    ...
    private void initAllowListListenerList() {
        ...
        this.mAllowListListenerList.add(
                "com.sec.android.sdhms.thermal.siop.scenario.HighBrightness");
                    ...
                    synchronized (CameraLightSensorManager.this.mLockIPC) {
                        ...
                        if (CameraLightSensorManager.this.mSystemIPC != null) {
                            try {
                                ...
                                bResp.putShort(
                                        "respAlreadyRegister",
                                        CameraLightSensorManager.this.listenerRegistered);
                                msg2.setData(bResp);
                                ...
                                Log.d(
                                        "CameraLightSensor_Manager",
                                        "IPC_SERVICE_START_CAMERA -> Dead Object");
                                e.printStackTrace();
                            }
                            ...
                            cameraLightSensorManager.mProcessBinded =
                                    context.bindServiceAsUser(
                                            in, serviceConnection, 1, UserHandle.CURRENT_OR_SELF);
                            Log.d(
                                    "CameraLightSensor_Manager",
                                    "Binding Package status= "
                            ...
                            Log.d(
                                    "CameraLightSensor_Manager",
                                    "IPC_SERVICE_START_CAMERA Service not started yet,retry binding"
                                            + " service = "
                                            + this.retyrBinding);
                            ...
                            this.retyrBinding--;
                            CameraLightSensorManager.this.mSystemHandler.sendEmptyMessageDelayed(
                                    1, 1000L);
                        } else if (CameraLightSensorManager.this.mSystemHandler != null
                                && this.retry > 0) {
                            Log.d(
                                    "CameraLightSensor_Manager",
                                    "IPC_SERVICE_START_CAMERA Service not started yet,retry= "
                                            + this.retry);
                            this.retry--;
                            CameraLightSensorManager.this.mSystemHandler.sendEmptyMessageDelayed(
                                    1, 500L);
                            ...
                            Log.d(
                                    "CameraLightSensor_Manager",
                                    "IPC_SERVICE_START_CAMERA Service not started yet, will try it"
                                            + " again after service connected");
                    ...
                    synchronized (CameraLightSensorManager.this.mLockIPC) {
                        ...
                        if (CameraLightSensorManager.this.mSystemIPC != null) {
                            try {
                                Log.d(
                                        "CameraLightSensor_Manager",
                                        "IPC_SERVICE_UNREGISTER_CONNECTION ->"
                ...
                case 6:
                    synchronized (CameraLightSensorManager.this.mLockIPC) {
                        ...
                        if (this.camera_ev_bv == null) {
                            Log.d(
                                    "CameraLightSensor_Manager",
                                    "received a null event from service");
                            return;
                        }
                        if (CameraLightSensorManager.this.mSystemHandler != null) {
                                ...
                                if (CameraLightSensorManager.this.mCameraLightListener.size() > 0) {
                                    ...
                                    try {
                                        for (SensorEventListener evL :
                                                CameraLightSensorManager.this
                                                        .mCameraLightListener) {
                                            if (evL != null && this.camera_ev_bv != null) {
                                                float[] cvtLux =
                                                        CameraLightSensorManager.this.mMotionManager
                                                                .getEvToLux(this.camera_ev_bv);
                                        ...
                                        Log.d(
                                                "CameraLightSensor_Manager",
                                                "Exception while getting listener.");
                                    }
                                    if (CameraLightSensorManager.this.mSystemHandler != null) {
                                        CameraLightSensorManager.this.mSystemHandler.removeMessages(
                                                8);
                                        CameraLightSensorManager.this.mSystemHandler
