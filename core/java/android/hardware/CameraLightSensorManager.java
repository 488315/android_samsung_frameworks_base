...
public class CameraLightSensorManager {
  ...
  private List<SensorEventListener> mCameraLightListener =
  ...
  private final Boolean mSABCLite =
      Boolean.valueOf(
          SemFloatingFeature.getInstance()
              .getBoolean("SEC_FLOATING_FEATURE_SENSOR_SUPPORT_SABC_LITE"));
  ...
  private void initLocked(Looper cameraLooper) {
    if (this.mSystemHandler == null) {
      if (cameraLooper == null) {
        ...
        Log.m94d(
            "CameraLightSensor_Manager", "Using CameraManagerThread looper " + thread.getLooper());
      } else {
        Log.m94d("CameraLightSensor_Manager", "Using handler looper " + cameraLooper);
    ...
    if (this.mCameraLightSensorConnection == null) {
      Log.m94d("CameraLightSensor_Manager", "Creating new connection for service.");
      this.mCameraLightSensorConnection =
          new ServiceConnection() { // from class: android.hardware.CameraLightSensorManager.1
            @Override // android.content.ServiceConnection
            public void onServiceConnected(ComponentName name, IBinder service) {
              Log.m94d(
                  "CameraLightSensor_Manager",
                  " Service is connected, cmp name = " + name + " service = " + service);
              synchronized (CameraLightSensorManager.this.mLockIPC) {
                ...
                if (CameraLightSensorManager.this.mSystemHandler != null
                    && CameraLightSensorManager.this.mEnabledService
                    && CameraLightSensorManager.this.mConnectionFailed) {
            ...
            public void onServiceDisconnected(ComponentName name) {
              Log.m94d("CameraLightSensor_Manager", " Service is disconnected, cmp name = " + name);
              synchronized (CameraLightSensorManager.this.mLockIPC) {
                ...
                if (CameraLightSensorManager.this.mCameraLightSensorConnection != null) {
                  Log.m94d(
                      "CameraLightSensor_Manager",
                      "Unbinding and removing connection for service.");
                  CameraLightSensorManager.this.mContext.unbindService(
                      CameraLightSensorManager.this.mCameraLightSensorConnection);
      ...
      try {
        ...
        in.setComponent(
            new ComponentName(
                ...
                "com.samsung.adaptivebrightnessgo.CameraLightSensorService"));
        this.mProcessBinded =
            this.mContext.bindServiceAsUser(
                in, this.mCameraLightSensorConnection, 1, UserHandle.CURRENT_OR_SELF);
        Log.m94d(
            "CameraLightSensor_Manager",
        ...
        if (this.mMotionManager == null) {
          this.mMotionManager =
              (SemMotionRecognitionManager)
                  this.mContext.getSystemService(Context.SEM_MOTION_RECOGNITION_SERVICE);
        }
      } catch (Exception e) {
        e.printStackTrace();
        Log.m94d("CameraLightSensor_Manager", "Exception while starting service.");
      }
    }
  }
  ...
  public boolean registerCameraLightSensor(
      Looper cameraLooper, SensorEventListener sensorListener, Sensor sensor) {
      ...
      if (this.mCameraLightListener != null) {
        if (isAllowListedListener(sensorListener.toString())) {
          if (!isAvailableEvLuxTable()) {
            Log.m94d("Debug_Camera_Manager", "There is no Ev-Lux table for this model ");
            return false;
          }
          initLocked(cameraLooper);
          this.mEnabledService = true;
          Log.m94d("Debug_Camera_Manager", "Entering1 registerCameraLightSensor " + sensorListener);
          ...
          Log.m94d("Debug_Camera_Manager", "Exit1 registerCameraLightSensor" + sensorListener);
          this.mCameraSensor = sensor;
          if (sensorListener
              .toString()
              .contains("com.android.server.display.AutomaticBrightnessController")) {
            try {
              ...
              boolean isFaceUnlockActive =
                  mLockPatternUtils.getBiometricState(256, UserHandle.semGetMyUserId()) == 1;
              if (this.mkeyguard != null) {
                Log.m94d(
                    "Debug_Camera_Manager",
                    "lock screen, mkeyguard= "
                        + this.mkeyguard.isDeviceLocked()
                        + " isFaceUnlockActive= "
                        + isFaceUnlockActive);
              }
              ...
              if (keyguardManager != null
                  ...
                  && isFaceUnlockActive) {
                Log.m94d("CameraLightSensor_Manager", "On lock screen, FaceUnlock is true");
                ResponseHandler responseHandler = this.mSystemHandler;
                if (responseHandler != null) {
                  responseHandler.sendEmptyMessageDelayed(1, 300L);
                }
              } else {
                Log.m94d("CameraLightSensor_Manager", "On lock screen, FaceUnlock is false");
                ResponseHandler responseHandler2 = this.mSystemHandler;
                if (responseHandler2 != null) {
                  responseHandler2.sendEmptyMessage(1);
                }
              }
              Log.m94d("CameraLightSensor_Manager", sensorListener + " registered");
            } catch (Exception e) {
              e.printStackTrace();
              Log.m96e("CameraLightSensor_Manager", "Error during FaceUnlock check.");
            }
          } else {
        ...
        Log.m96e(
            "CameraLightSensor_Manager",
            sensorListener + " not in allowlisted packages of Camera Light Sensor.");
      }
      Log.m96e("CameraLightSensor_Manager", "mCameraLightListener is NULL");
      return false;
    }
  }

  public boolean unRegisterCameraLightSensor(SensorEventListener sensorListener) {
    Log.m94d("Debug_Camera_Manager", "Entering2 unRegisterCameraLightSensor" + sensorListener);
    synchronized (this.mLockIPC) {
      List<SensorEventListener> list = this.mCameraLightListener;
      if (list != null) {
        synchronized (list) {
          if (!this.mCameraLightListener.contains(sensorListener)) {
            Log.m96e("CameraLightSensor_Manager", "No camera light sensor listeners present");
            return false;
          }
          this.mCameraLightListener.remove(sensorListener);
          Log.m94d("Debug_Camera_Manager", "Exit2 unRegisterCameraLightSensor" + sensorListener);
          this.mEnabledService = false;
          ResponseHandler responseHandler = this.mSystemHandler;
          if (responseHandler != null) {
      ...
      Log.m96e("CameraLightSensor_Manager", "mCameraLightListener List is not initialized");
      return false;
    }
  }
  ...
  private void initAllowListListenerList() {
    ...
    this.mAllowListListenerList.add(
        "com.sec.android.sdhms.thermal.overheatcontrol.OverheatSensorChecker");
      ...
      switch (msg.what) {
          ...
          synchronized (CameraLightSensorManager.this.mLockIPC) {
            ...
            if (CameraLightSensorManager.this.mSystemIPC != null) {
              try {
                Log.m94d(
                    "CameraLightSensor_Manager",
                    "IPC_SERVICE_START_CAMERA -> MSG_SERVICE_START_CAMERA");
                Bundle bResp = new Bundle();
                bResp.putShort(
                    "respAlreadyRegister", CameraLightSensorManager.this.listenerRegistered);
                msg2.setData(bResp);
                CameraLightSensorManager.this.mSystemIPC.send(msg2);
                this.retry = 5;
              } catch (Exception e) {
                Log.m94d("CameraLightSensor_Manager", "IPC_SERVICE_START_CAMERA -> Dead Object");
                e.printStackTrace();
              }
            } else if (!CameraLightSensorManager.this.mProcessBinded
                && CameraLightSensorManager.this.mSystemHandler != null
                && CameraLightSensorManager.this.mEnabledService
                && this.retyrBinding > 0) {
              Intent in = new Intent();
              ...
              cameraLightSensorManager.mProcessBinded =
                  context.bindServiceAsUser(in, serviceConnection, 1, UserHandle.CURRENT_OR_SELF);
              Log.m94d(
                  "CameraLightSensor_Manager",
                  "Binding Package status= "
                      + CameraLightSensorManager.this.mProcessBinded
                      + " Component= "
                      + in.getComponent()
                      + " UserHandle= "
                      + UserHandle.CURRENT_OR_SELF);
              Log.m94d(
                  "CameraLightSensor_Manager",
                  "IPC_SERVICE_START_CAMERA Service not started yet,retry binding service = "
                      + this.retyrBinding);
              ...
              Log.m94d(
                  "CameraLightSensor_Manager",
                  "IPC_SERVICE_START_CAMERA Service not started yet,retry= " + this.retry);
              this.retry--;
              CameraLightSensorManager.this.mSystemHandler.sendEmptyMessageDelayed(1, 500L);
            } else if (this.retry == 0) {
              Log.m94d(
                  "CameraLightSensor_Manager",
                  "IPC_SERVICE_START_CAMERA Service not started yet, will try it again after"
                      + " service connected");
          ...
          synchronized (CameraLightSensorManager.this.mLockIPC) {
            ...
            if (CameraLightSensorManager.this.mSystemIPC != null) {
              try {
                Log.m94d(
                    "CameraLightSensor_Manager",
                    "IPC_SERVICE_UNREGISTER_CONNECTION -> MSG_SERVICE_STOP_CAMERA");
                CameraLightSensorManager.this.mSystemIPC.send(msg3);
              } catch (Exception e2) {
                Log.m94d(
                    "CameraLightSensor_Manager",
                    "IPC_SERVICE_UNREGISTER_CONNECTION -> Dead Object");
                e2.printStackTrace();
              }
            }
          }
        ...
        case 6:
          synchronized (CameraLightSensorManager.this.mLockIPC) {
            ...
            if (floatArray == null) {
              Log.m94d("CameraLightSensor_Manager", "received a null event from service");
              return;
            }
            if (CameraLightSensorManager.this.mSystemHandler != null) {
            ...
            if (CameraLightSensorManager.this.mCameraLightListener != null
                && CameraLightSensorManager.this.mCameraLightListener.size() > 0) {
              if (CameraLightSensorManager.this.mSystemHandler != null) {
              ...
              Log.m94d(
                  ...
                  " Exposure= "
                      ...
                      + this.camera_ev_bv[1]
                      + " Total listeners= "
                      + CameraLightSensorManager.this.mCameraLightListener.size());
            }
            return;
          }
        case 8:
            ...
            if (CameraLightSensorManager.this.mCameraLightListener != null) {
              synchronized (CameraLightSensorManager.this.mCameraLightListener) {
                if (CameraLightSensorManager.this.mCameraLightListener.size() > 0) {
                  ...
                  try {
                    for (SensorEventListener evL :
                        CameraLightSensorManager.this.mCameraLightListener) {
                      if (evL != null && this.camera_ev_bv != null) {
                        float[] cvtLux =
                            CameraLightSensorManager.this.mMotionManager.getEvToLux(
                                this.camera_ev_bv);
                        if (cvtLux[0] != this.old_lux) {
                          Log.m94d(
                              "Debug_Camera_Listener",
                              ""
                                  + evL.toString()
                                  + " lux= "
                                  + cvtLux[0]
                    ...
                    e3.printStackTrace();
                    Log.m94d("CameraLightSensor_Manager", "Exception while getting listener.");
                  }
                  if (CameraLightSensorManager.this.mSystemHandler != null) {
                    CameraLightSensorManager.this.mSystemHandler.removeMessages(8);
                    ...
                    Log.m94d(
                        "CameraLightSensor_Manager",
                        "MSG_MANAGER_LISTENER_LOOP mSystemHandler is null");
                  }
                } else {
                  Log.m94d(
                      "CameraLightSensor_Manager",
                      "MSG_MANAGER_LISTENER_LOOP array is "
                          + CameraLightSensorManager.this.mCameraLightListener.size());
                  if (CameraLightSensorManager.this.mSystemHandler != null) {
                    CameraLightSensorManager.this.mSystemHandler.removeMessages(8);
                  }
