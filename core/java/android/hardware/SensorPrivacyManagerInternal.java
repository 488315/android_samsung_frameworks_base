...
public abstract class SensorPrivacyManagerInternal {
  ...
  public abstract void addSensorPrivacyListener(
      int i, int i2, OnSensorPrivacyChangedListener onSensorPrivacyChangedListener);

  public abstract void addSensorPrivacyListenerForAllUsers(
      int i, OnUserSensorPrivacyChangedListener onUserSensorPrivacyChangedListener);
