...
public interface IThermal extends android.hardware.thermal.V1_0.IThermal {
    ...
    void getCurrentCoolingDevices(
            boolean z, int i, getCurrentCoolingDevicesCallback getcurrentcoolingdevicescallback)
            throws RemoteException;

    void getCurrentTemperatures(
            boolean z, int i, getCurrentTemperaturesCallback getcurrenttemperaturescallback)
            throws RemoteException;
    ...
    void getTemperatureThresholds(
            boolean z, int i, getTemperatureThresholdsCallback gettemperaturethresholdscallback)
            throws RemoteException;
    ...
    ThermalStatus registerThermalChangedCallback(
            IThermalChangedCallback iThermalChangedCallback, boolean z, int i)
            throws RemoteException;
    ...
    ThermalStatus unregisterThermalChangedCallback(IThermalChangedCallback iThermalChangedCallback)
            throws RemoteException;
    ...
    public static final class Proxy implements IThermal {
        ...
        public void getTemperatures(IThermal.getTemperaturesCallback _hidl_cb)
            ...
            try {
                ...
                ArrayList<android.hardware.thermal.V1_0.Temperature> _hidl_out_temperatures =
                        android.hardware.thermal.V1_0.Temperature.readVectorFromParcel(_hidl_reply);
        ...
        public void getCoolingDevices(IThermal.getCoolingDevicesCallback _hidl_cb)
            ...
            try {
                ...
                ThermalStatus _hidl_out_status = new ThermalStatus();
                _hidl_out_status.readFromParcel(_hidl_reply);
                ArrayList<android.hardware.thermal.V1_0.CoolingDevice> _hidl_out_devices =
                        android.hardware.thermal.V1_0.CoolingDevice.readVectorFromParcel(
                                _hidl_reply);
        ...
        public void getCurrentTemperatures(
                boolean filterType, int type, getCurrentTemperaturesCallback _hidl_cb)
                throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
        ...
        public void getTemperatureThresholds(
                boolean filterType, int type, getTemperatureThresholdsCallback _hidl_cb)
                throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IThermal.kInterfaceName);
            _hidl_request.writeBool(filterType);
        ...
        public void getCurrentCoolingDevices(
                boolean filterType, int type, getCurrentCoolingDevicesCallback _hidl_cb)
                throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IThermal.kInterfaceName);
            _hidl_request.writeBool(filterType);
    ...
    public abstract static class Stub extends HwBinder implements IThermal {
        @Override // android.hardware.thermal.V2_0.IThermal, android.hardware.thermal.V1_0.IThermal,
        // android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public IHwBinder asBinder() {
            return this;
            ...
            switch (_hidl_code) {
                case 1:
                    _hidl_request.enforceInterface(
                            android.hardware.thermal.V1_0.IThermal.kInterfaceName);
                    getTemperatures(
                            new IThermal.getTemperaturesCallback() { // from class:
                                // android.hardware.thermal.V2_0.IThermal.Stub.1
                                ...
                                public void onValues(
                                    ...
                                    android.hardware.thermal.V1_0.Temperature.writeVectorToParcel(
                ...
                case 2:
                    _hidl_request.enforceInterface(
                            android.hardware.thermal.V1_0.IThermal.kInterfaceName);
                    getCpuUsages(
                            new IThermal.getCpuUsagesCallback() { // from class:
                                // android.hardware.thermal.V2_0.IThermal.Stub.2
                ...
                case 3:
                    _hidl_request.enforceInterface(
                            android.hardware.thermal.V1_0.IThermal.kInterfaceName);
                    getCoolingDevices(
                            new IThermal.getCoolingDevicesCallback() { // from class:
                                // android.hardware.thermal.V2_0.IThermal.Stub.3
                                @Override // android.hardware.thermal.V1_0.IThermal.getCoolingDevicesCallback
                                public void onValues(
                                        ThermalStatus status,
                                        ArrayList<android.hardware.thermal.V1_0.CoolingDevice>
                                                devices) {
                                    _hidl_reply.writeStatus(0);
                                    status.writeToParcel(_hidl_reply);
                                    android.hardware.thermal.V1_0.CoolingDevice.writeVectorToParcel(
                                            _hidl_reply, devices);
                                    _hidl_reply.send();
                                }
                            });
                ...
                case 4:
                    ...
                    getCurrentTemperatures(
                            filterType,
                            type,
                            new getCurrentTemperaturesCallback() { // from class:
                                // android.hardware.thermal.V2_0.IThermal.Stub.4
                ...
                case 5:
                    ...
                    getTemperatureThresholds(
                            filterType2,
                            type2,
                            new getTemperatureThresholdsCallback() { // from class:
                                // android.hardware.thermal.V2_0.IThermal.Stub.5
                ...
                case 8:
                    ...
                    getCurrentCoolingDevices(
                            filterType4,
                            type4,
                            new getCurrentCoolingDevicesCallback() { // from class:
                                // android.hardware.thermal.V2_0.IThermal.Stub.6
