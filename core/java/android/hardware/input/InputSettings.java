...
public class InputSettings {
  ...
  public static float getMaximumObscuringOpacityForTouch(Context context) {
    return Settings.Global.getFloat(
        context.getContentResolver(), Settings.Global.MAXIMUM_OBSCURING_OPACITY_FOR_TOUCH, 0.8f);
  }
  ...
  public static void setMaximumObscuringOpacityForTouch(Context context, float opacity) {
    ...
    Settings.Global.putFloat(
        context.getContentResolver(), Settings.Global.MAXIMUM_OBSCURING_OPACITY_FOR_TOUCH, opacity);
  }

  public static boolean isStylusEverUsed(Context context) {
    return Settings.Global.getInt(context.getContentResolver(), Settings.Global.STYLUS_EVER_USED, 0)
        == 1;
  }
  ...
  public static boolean useTouchpadNaturalScrolling(Context context) {
    return Settings.System.getIntForUser(
            context.getContentResolver(), Settings.System.TOUCHPAD_NATURAL_SCROLLING, 1, -2)
        == 1;
  }

  public static void setTouchpadNaturalScrolling(Context context, boolean z) {
    Settings.System.putIntForUser(
        context.getContentResolver(), Settings.System.TOUCHPAD_NATURAL_SCROLLING, z ? 1 : 0, -2);
  }

  public static boolean useTouchpadTapToClick(Context context) {
    return Settings.System.getIntForUser(
            context.getContentResolver(), Settings.System.TOUCHPAD_TAP_TO_CLICK, 0, -2)
        == 1;
  }
  ...
  public static boolean useTouchpadRightClickZone(Context context) {
    return Settings.System.getIntForUser(
            context.getContentResolver(), Settings.System.TOUCHPAD_RIGHT_CLICK_ZONE, 0, -2)
        == 1;
  }

  public static void setTouchpadRightClickZone(Context context, boolean z) {
    Settings.System.putIntForUser(
        context.getContentResolver(), Settings.System.TOUCHPAD_RIGHT_CLICK_ZONE, z ? 1 : 0, -2);
  }

  public static boolean isStylusPointerIconEnabled(Context context) {
    return context.getResources().getBoolean(C4337R.bool.config_enableStylusPointerIcon)
        || InputProperties.force_enable_stylus_pointer_icon().orElse(false).booleanValue();
  }
}
