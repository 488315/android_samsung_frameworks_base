...
public class InputSettings {
    ...
    public static boolean isStylusPointerIconEnabled(Context context) {
        return context.getResources().getBoolean(C4337R.bool.config_enableStylusPointerIcon) || InputProperties.force_enable_stylus_pointer_icon().orElse(false).booleanValue();
    }
}
