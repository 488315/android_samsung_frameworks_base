...
public class IKeyboardBacklightState implements Parcelable {
  public static final Parcelable.Creator<IKeyboardBacklightState> CREATOR =
      new Parcelable.Creator<
          IKeyboardBacklightState>() { // from class:
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(
            Integer.valueOf(this.brightnessLevel), Integer.valueOf(that.brightnessLevel))
        && Objects.deepEquals(
            Integer.valueOf(this.maxBrightnessLevel), Integer.valueOf(that.maxBrightnessLevel))) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(
                Integer.valueOf(this.brightnessLevel), Integer.valueOf(this.maxBrightnessLevel))
            .toArray());
  }
