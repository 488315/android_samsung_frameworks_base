...
public class InputSensorInfo implements Parcelable {
  ...
  public InputSensorInfo(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) vendor2);
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) stringType);
    this.mRequiredPermission = requiredPermission;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) requiredPermission);
