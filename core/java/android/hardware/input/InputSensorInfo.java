...
public class InputSensorInfo implements Parcelable {
    public static final Parcelable.Creator<InputSensorInfo> CREATOR =
            new Parcelable.Creator<
                    InputSensorInfo>() { // from class: android.hardware.input.InputSensorInfo.1
    ...
    public InputSensorInfo(
        ...
        AnnotationValidations.validate(
                (Class<NonNull>) NonNull.class, (NonNull) null, (Object) this.mName);
        this.mVendor = vendor2;
        AnnotationValidations.validate(
                (Class<NonNull>) NonNull.class, (NonNull) null, (Object) this.mVendor);
        ...
        AnnotationValidations.validate(
                (Class<NonNull>) NonNull.class, (NonNull) null, (Object) this.mStringType);
        this.mRequiredPermission = requiredPermission;
        AnnotationValidations.validate(
                (Class<NonNull>) NonNull.class, (NonNull) null, (Object) this.mRequiredPermission);
    ...
    public String toString() {
        return "InputSensorInfo { name = "
                ...
                + this.mFifoReservedEventCount
                + ", fifoMaxEventCount = "
                + this.mFifoMaxEventCount
                + ", stringType = "
                + this.mStringType
                + ", requiredPermission = "
