...
public interface ICas extends android.hardware.cas.V1_1.ICas {
  ...
  void openSession_1_2(int i, int i2, openSession_1_2Callback opensession_1_2callback)
  ...
  public static final class Proxy implements ICas {
    ...
    public void openSession_1_2(int intent, int mode, openSession_1_2Callback _hidl_cb)
        throws RemoteException {
      HwParcel _hidl_request = new HwParcel();
  ...
  public abstract static class Stub extends HwBinder implements ICas {
    ...
    public final ArrayList<String> interfaceChain() {
      return new ArrayList<>(
          Arrays.asList(
              ICas.kInterfaceName,
              android.hardware.cas.V1_1.ICas.kInterfaceName,
    ...
    public void onTransact(
      ...
      switch (_hidl_code) {
        ...
        case 2:
          _hidl_request.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
          openSession(
              new ICas.openSessionCallback() { // from class: android.hardware.cas.V1_2.ICas.Stub.1
        ...
        case 12:
          ...
          openSession_1_2(
              intent,
              mode,
              new openSession_1_2Callback() { // from class: android.hardware.cas.V1_2.ICas.Stub.2
