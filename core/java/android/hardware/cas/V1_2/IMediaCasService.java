...
public interface IMediaCasService extends android.hardware.cas.V1_1.IMediaCasService {
    ...
    public static final class Proxy implements IMediaCasService {
        ...
        // android.hardware.cas.V1_0.IMediaCasService,
        ...
        public android.hardware.cas.V1_0.ICas createPlugin(
                int CA_system_id, android.hardware.cas.V1_0.ICasListener listener)
        ...
        public android.hardware.cas.V1_1.ICas createPluginExt(
                int caSystemId, android.hardware.cas.V1_1.ICasListener listener)
                throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(
            ...
            switch (_hidl_code) {
                ...
                case 3:
                    ...
                    android.hardware.cas.V1_0.ICasListener listener =
                            android.hardware.cas.V1_0.ICasListener.asInterface(
                                    _hidl_request.readStrongBinder());
                    android.hardware.cas.V1_0.ICas _hidl_out_cas =
                            createPlugin(CA_system_id2, listener);
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeStrongBinder(
                            _hidl_out_cas != null ? _hidl_out_cas.asBinder() : null);
                    _hidl_reply.send();
                    return;
                case 4:
                    _hidl_request.enforceInterface(
                ...
                case 5:
                    ...
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeStrongBinder(
                            _hidl_out_descrambler != null
                                    ? _hidl_out_descrambler.asBinder()
                                    : null);
                    _hidl_reply.send();
                    return;
                case 6:
                    ...
                    android.hardware.cas.V1_1.ICasListener listener2 =
                            android.hardware.cas.V1_1.ICasListener.asInterface(
                                    _hidl_request.readStrongBinder());
                    android.hardware.cas.V1_1.ICas _hidl_out_cas2 =
                            createPluginExt(caSystemId, listener2);
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeStrongBinder(
                            _hidl_out_cas2 != null ? _hidl_out_cas2.asBinder() : null);
                    _hidl_reply.send();
                    return;
                case 256067662:
