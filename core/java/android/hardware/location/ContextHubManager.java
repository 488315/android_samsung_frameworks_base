...
public final class ContextHubManager {
  ...
  private IContextHubTransactionCallback createTransactionCallback(
      final ContextHubTransaction<Void> transaction) {
    return new IContextHubTransactionCallback
      ...
      public void onQueryResponse(int result, List<NanoAppState> nanoappList) {
        Log.m96e(ContextHubManager.TAG, "Received a query callback on a non-query request");
  ...
  private IContextHubTransactionCallback createQueryCallback(
    ...
    return new IContextHubTransactionCallback
        .Stub() { // from class: android.hardware.location.ContextHubManager.2
      @Override // android.hardware.location.IContextHubTransactionCallback
      public void onQueryResponse(int result, List<NanoAppState> nanoappList) {
      ...
      @Override // android.hardware.location.IContextHubTransactionCallback
      public void onTransactionComplete(int result) {
        Log.m96e(ContextHubManager.TAG, "Received a non-query callback on a query request");
        transaction.setResponse(new ContextHubTransaction.Response(7, null));
      }
    };
  }
  ...
  public int registerCallback(ICallback callback) {
    if (this.mLocalCallback != null) {
      Log.m102w(TAG, "Max number of local callbacks reached!");
      return -1;
    }
  ...
  public int registerCallback(Callback callback, Handler handler) {
    synchronized (this) {
      if (this.mCallback != null) {
        Log.m102w(TAG, "Max number of callbacks reached!");
        return -1;
      }
  ...
  class BinderC12603 extends IContextHubClientCallback.Stub {
      ...
      executor.execute(
          new Runnable() { // from class:
            ...
            public final void run() {
              ContextHubManager.BinderC12603.lambda$onMessageFromNanoApp$0(
    ...
    static /* synthetic */ void lambda$onMessageFromNanoApp$0(
        ContextHubClientCallback callback, ContextHubClient client, NanoAppMessage message) {
    ...
    public void onHubReset() {
      ...
      executor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ContextHubManager.BinderC12603.lambda$onHubReset$1(
    ...
    public void onNanoAppAborted(final long nanoAppId, final int abortCode) {
      ...
      executor.execute(
          new Runnable() { // from class:
                           // android.hardware.location.ContextHubManager$3$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
              ContextHubManager.BinderC12603.lambda$onNanoAppAborted$2(
                  ContextHubClientCallback.this, contextHubClient, nanoAppId, abortCode);
            }
          });
    }

    static /* synthetic */ void lambda$onNanoAppAborted$2(
        ContextHubClientCallback callback, ContextHubClient client, long nanoAppId, int abortCode) {
    ...
    public void onNanoAppLoaded(final long nanoAppId) {
      ...
      executor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              ContextHubManager.BinderC12603.lambda$onNanoAppLoaded$3(
    ...
    public void onNanoAppUnloaded(final long nanoAppId) {
      ...
      executor.execute(
          new Runnable() { // from class:
                           // android.hardware.location.ContextHubManager$3$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              ContextHubManager.BinderC12603.lambda$onNanoAppUnloaded$4(
                  ContextHubClientCallback.this, contextHubClient, nanoAppId);
            }
          });
    }
    ...
    public void onNanoAppEnabled(final long nanoAppId) {
      ...
      executor.execute(
          new Runnable() { // from class:
                           // android.hardware.location.ContextHubManager$3$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              ContextHubManager.BinderC12603.lambda$onNanoAppEnabled$5(
                  ContextHubClientCallback.this, contextHubClient, nanoAppId);
            }
          });
    }
    ...
    public void onNanoAppDisabled(final long nanoAppId) {
      ...
      executor.execute(
          new Runnable() { // from class:
                           // android.hardware.location.ContextHubManager$3$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              ContextHubManager.BinderC12603.lambda$onNanoAppDisabled$6(
                  ContextHubClientCallback.this, contextHubClient, nanoAppId);
            }
          });
    }
    ...
    public void onClientAuthorizationChanged(final long nanoAppId, final int authorization) {
      ...
      executor.execute(
          new Runnable() { // from class:
                           // android.hardware.location.ContextHubManager$3$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
              ContextHubManager.BinderC12603.lambda$onClientAuthorizationChanged$7(
                  ContextHubClientCallback.this, contextHubClient, nanoAppId, authorization);
            }
          });
    }
  ...
  private IContextHubClientCallback createClientCallback(
    ...
    return new BinderC12603(executor, callback, client);
  }
  ...
  public ContextHubClient createClient(
    ...
    try {
      IContextHubClient clientProxy =
          this.mService.createClient(hubInfo.getId(), clientInterface, attributionTag, packageName);
  ...
  public int unregisterCallback(Callback callback) {
    synchronized (this) {
      if (callback != this.mCallback) {
        Log.m102w(TAG, "Cannot recognize callback!");
        return -1;
      }
      this.mCallback = null;
  ...
  public synchronized int unregisterCallback(ICallback callback) {
    if (callback != this.mLocalCallback) {
      Log.m102w(TAG, "Cannot recognize local callback!");
      return -1;
    }
  ...
  class BinderC12614 extends IContextHubCallback.Stub {
    BinderC12614() {}
      ...
      synchronized (ContextHubManager.this) {
        if (ContextHubManager.this.mCallback != null) {
          ContextHubManager.this.mCallbackHandler.post(
              new Runnable() { // from class:
                               // android.hardware.location.ContextHubManager$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                  ContextHubManager.BinderC12614.this.lambda$onMessageReceipt$0(
  ...
  public ContextHubManager(Context context, Looper mainLooper)
    ...
    BinderC12614 binderC12614 = new BinderC12614();
    this.mClientCallback = binderC12614;
    this.mMainLooper = mainLooper;
    IContextHubService asInterface =
        IContextHubService.Stub.asInterface(
            ServiceManager.getServiceOrThrow(Context.CONTEXTHUB_SERVICE));
    this.mService = asInterface;
    try {
      asInterface.registerCallback(binderC12614);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
