  ...
  private IBinder mBinder =
      new IGeofenceHardware
        ...
        public int getStatusOfMonitoringType(int monitoringType) {
          ...
          return GeofenceHardwareService.this.mGeofenceHardwareImpl.getStatusOfMonitoringType(
              monitoringType);
        }
  ...
  public void checkPermission(int pid, int uid, int monitoringType) {
    if (this.mGeofenceHardwareImpl.getAllowedResolutionLevel(pid, uid)
      ...
      throw new SecurityException(
          "Insufficient permissions to access hardware geofence for type: " + monitoringType);
    }
  }
}
