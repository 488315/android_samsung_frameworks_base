...
public class ContextHubIntentEvent {
  ...
  private ContextHubIntentEvent(
      ContextHubInfo contextHubInfo, int eventType, long nanoAppId, NanoAppMessage nanoAppMessage) {
      ...
      case 7:
        ...
        if (eventType == 5) {
          ...
          NanoAppMessage message =
              (NanoAppMessage)
                  intent.getParcelableExtra(ContextHubManager.EXTRA_MESSAGE, NanoAppMessage.class);
          if (message == null) {
        ...
        if (eventType == 7) {
          int authState =
              getIntExtraOrThrow(intent, ContextHubManager.EXTRA_CLIENT_AUTHORIZATION_STATE);
          ContextHubIntentEvent event3 =
              new ContextHubIntentEvent(info, eventType, nanoAppId, null, -1, authState);
          return event3;
        }
