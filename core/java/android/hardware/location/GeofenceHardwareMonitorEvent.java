...
public class GeofenceHardwareMonitorEvent implements Parcelable {
    public static final Parcelable.Creator<GeofenceHardwareMonitorEvent> CREATOR =
            new Parcelable.Creator<GeofenceHardwareMonitorEvent>() { // from class:
                ...
                public GeofenceHardwareMonitorEvent createFromParcel(Parcel source) {
                    ...
                    Location location =
                            (Location) source.readParcelable(classLoader, Location.class);
                    return new GeofenceHardwareMonitorEvent(
                            monitoringType, monitoringStatus, sourceTechnologies, location);
                }
    ...
    public GeofenceHardwareMonitorEvent(
            int monitoringType, int monitoringStatus, int sourceTechnologies, Location location) {
    ...
    public String toString() {
        return String.format(
                ...
                Integer.valueOf(this.mMonitoringType),
                Integer.valueOf(this.mMonitoringStatus),
                Integer.valueOf(this.mSourceTechnologies),
                this.mLocation);
    }
}
