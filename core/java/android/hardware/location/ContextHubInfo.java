...
public class ContextHubInfo implements Parcelable {
  ...
  public ContextHubInfo(ContextHub contextHub) {
    ...
    this.mVendor = contextHub.f3141vendor;
  ...
  public ContextHubInfo(android.hardware.contexthub.ContextHubInfo contextHub) {
    this.mId = contextHub.f133id;
    this.mName = contextHub.name;
    this.mVendor = contextHub.f3140vendor;
    this.mToolchain = contextHub.toolchain;
  ...
  public int getStaticSwVersion() {
    return (this.mChreApiMajorVersion << SprAnimatorBase.INTERPOLATOR_TYPE_ELASTICEASEINOUT)
        | (this.mChreApiMinorVersion << 16)
  ...
  public String toString() {
    ...
    return ((((((((((retVal + ", Name : " + this.mName) + "\n\tVendor : " + this.mVendor)
                                        + ", Toolchain : "
                                        + this.mToolchain)
                                    + ", Toolchain version: 0x"
                                    + Integer.toHexString(this.mToolchainVersion))
                                + "\n\tPlatformVersion : 0x"
                                + Integer.toHexString(this.mPlatformVersion))
                            + ", SwVersion : "
                            + ((int) this.mChreApiMajorVersion)
                            + MediaMetrics.SEPARATOR
                            + ((int) this.mChreApiMinorVersion)
                            + MediaMetrics.SEPARATOR
                            + ((int) this.mChrePatchVersion))
                        + ", CHRE platform ID: 0x"
