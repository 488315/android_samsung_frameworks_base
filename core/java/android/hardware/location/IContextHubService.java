...
public interface IContextHubService extends IInterface {
  ...
  void disableNanoApp(int i, IContextHubTransactionCallback iContextHubTransactionCallback, long j)
      throws RemoteException;
  ...
  public static class Default implements IContextHubService {
    ...
    public IContextHubClient createPendingIntentClient(
        int contextHubId, PendingIntent pendingIntent, long nanoAppId, String attributionTag)
        throws RemoteException {
      return null;
    }
          ...
          switch (code) {
            ...
            case 12:
              ...
              IContextHubTransactionCallback _arg16 =
                  IContextHubTransactionCallback.Stub.asInterface(data.readStrongBinder());
      ...
      public NanoAppInstanceInfo getNanoAppInstanceInfo(int nanoAppHandle) throws RemoteException {
        ...
        try {
          ...
          NanoAppInstanceInfo _result =
              (NanoAppInstanceInfo) _reply.readTypedObject(NanoAppInstanceInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
