...
public final class GeofenceHardwareImpl {
          ...
          switch (msg.what) {
              ...
              synchronized (GeofenceHardwareImpl.this.mGeofences) {
                callback =
                    (IGeofenceHardwareCallback)
                        GeofenceHardwareImpl.this.mGeofences.get(geofenceTransition.mGeofenceId);
                if (GeofenceHardwareImpl.DEBUG) {
                  Log.m94d(
                      GeofenceHardwareImpl.TAG,
                      "GeofenceTransistionCallback: GPS : GeofenceId: "
                          + geofenceTransition.mGeofenceId
                          + " Transition: "
                          + geofenceTransition.mTransition
                          + " Location: "
                          + geofenceTransition.mLocation
                          + ":"
                          + GeofenceHardwareImpl.this.mGeofences);
                }
              }
              if (callback != null) {
                try {
            ...
            case 2:
              ...
              synchronized (GeofenceHardwareImpl.this.mGeofences) {
                callback2 =
                    (IGeofenceHardwareCallback)
                        GeofenceHardwareImpl.this.mGeofences.get(geofenceId);
              }
              if (callback2 != null) {
                try {
                  callback2.onGeofenceAdd(geofenceId, msg.arg2);
                } catch (RemoteException e2) {
                  Log.m98i(GeofenceHardwareImpl.TAG, "Remote Exception:" + e2);
                }
              }
              GeofenceHardwareImpl.this.releaseWakeLock();
              return;
            case 3:
              ...
              synchronized (GeofenceHardwareImpl.this.mGeofences) {
                callback3 =
                    (IGeofenceHardwareCallback)
                        GeofenceHardwareImpl.this.mGeofences.get(geofenceId2);
              }
              if (callback3 != null) {
                try {
                ...
                synchronized (GeofenceHardwareImpl.this.mGeofences) {
                  ...
                  while (true) {
                    if (i < GeofenceHardwareImpl.this.mGeofences.size()) {
                      if (((IGeofenceHardwareCallback)
                                  GeofenceHardwareImpl.this.mGeofences.valueAt(i))
                              .asBinder()
                          != callbackBinder) {
                        i++;
                      } else {
                    ...
                    if (reaper.mCallback != null && reaper.mCallback.asBinder() == callbackBinder) {
                      ...
                      if (GeofenceHardwareImpl.DEBUG) {
                        Log.m94d(
                            GeofenceHardwareImpl.TAG,
                            String.format(
                                "Removed reaper %s because binder %s is no longer needed.",
            ...
            case 4:
              ...
              synchronized (GeofenceHardwareImpl.this.mGeofences) {
                callback4 =
                    (IGeofenceHardwareCallback)
                        GeofenceHardwareImpl.this.mGeofences.get(geofenceId3);
              }
              if (callback4 != null) {
                try {
            ...
            case 5:
              ...
              synchronized (GeofenceHardwareImpl.this.mGeofences) {
                callback5 =
                    (IGeofenceHardwareCallback)
                        GeofenceHardwareImpl.this.mGeofences.get(geofenceId4);
              }
              if (callback5 != null) {
                try {
            ...
            case 6:
              ...
              if (GeofenceHardwareImpl.DEBUG) {
                Log.m94d(GeofenceHardwareImpl.TAG, "Geofence callback reaped:" + callback6);
              }
              int monitoringType = msg.arg1;
              synchronized (GeofenceHardwareImpl.this.mGeofences) {
                for (int i2 = 0; i2 < GeofenceHardwareImpl.this.mGeofences.size(); i2++) {
                  if (((IGeofenceHardwareCallback) GeofenceHardwareImpl.this.mGeofences.valueAt(i2))
                      .equals(callback6)) {
                    ...
                    geofenceHardwareImpl.removeGeofence(
                        geofenceHardwareImpl.mGeofences.keyAt(i2), monitoringType);
          ...
          switch (msg.what) {
            case 1:
              ...
              ArrayList<IGeofenceHardwareMonitorCallback> callbackList =
                  GeofenceHardwareImpl.this.mCallbacks[event.getMonitoringType()];
              if (callbackList != null) {
                if (GeofenceHardwareImpl.DEBUG) {
                  Log.m94d(GeofenceHardwareImpl.TAG, "MonitoringSystemChangeCallback: " + event);
                }
                ...
                while (it.hasNext()) {
                  ...
                  try {
                    ...
                    Log.m95d(
                        GeofenceHardwareImpl.TAG, "Error reporting onMonitoringSystemChange.", e);
                  }
                }
              }
              GeofenceHardwareImpl.this.releaseWakeLock();
            ...
            case 2:
              ...
              IGeofenceHardwareMonitorCallback callback =
                  (IGeofenceHardwareMonitorCallback) msg.obj;
              ArrayList<IGeofenceHardwareMonitorCallback> callbackList2 =
                  GeofenceHardwareImpl.this.mCallbacks[monitoringType];
            ...
            case 3:
              ...
              IGeofenceHardwareMonitorCallback callback2 =
                  (IGeofenceHardwareMonitorCallback) msg.obj;
              ArrayList<IGeofenceHardwareMonitorCallback> callbackList3 =
                  GeofenceHardwareImpl.this.mCallbacks[monitoringType2];
              ...
              break;
            case 4:
              IGeofenceHardwareMonitorCallback callback3 =
                  (IGeofenceHardwareMonitorCallback) msg.obj;
              if (GeofenceHardwareImpl.DEBUG) {
                Log.m94d(GeofenceHardwareImpl.TAG, "Monitor callback reaped:" + callback3);
              }
              ArrayList<IGeofenceHardwareMonitorCallback> callbackList4 =
                  GeofenceHardwareImpl.this.mCallbacks[msg.arg1];
  ...
  private void updateGpsHardwareAvailability() {
    ...
    try {
      ...
      Log.m96e(TAG, "Remote Exception calling LocationManagerService");
      gpsSupported = false;
    }
    if (gpsSupported) {
  ...
  */
  private void updateFusedHardwareAvailability() {
    ...
    try {
      ...
      Log.m96e(TAG, "RemoteException calling LocationManagerService");
      e = null;
    }
    if (this.mVersion >= 2 && (this.mCapabilities & 1) == 0) {
      ...
      if (iFusedGeofenceHardware == null) {
        remoteException = (iFusedGeofenceHardware.isSupported() && hasGnnsCapabilities) ? 1 : null;
      } else {
  ...
  public void setGpsHardwareGeofence(IGpsGeofenceHardware service) {
    if (this.mGpsService == null) {
      ...
      Log.m96e(TAG, "Error: GpsService being set again.");
    } else {
      this.mGpsService = null;
      Log.m102w(TAG, "GPS Geofence Hardware service seems to have crashed");
    }
  }
  ...
  public void setFusedGeofenceHardware(IFusedGeofenceHardware service) {
    if (this.mFusedService == null) {
      ...
      Log.m96e(TAG, "Error: FusedService being set again");
    } else {
      this.mFusedService = null;
      Log.m102w(TAG, "Fused Geofence Hardware service seems to have crashed");
    }
  }
  ...
  public boolean addCircularFence(
    ...
    if (DEBUG) {
      String message =
          String.format(
              "addCircularFence: monitoringType=%d, %s", Integer.valueOf(monitoringType), request);
      Log.m94d(TAG, message);
    }
    ...
    switch (monitoringType) {
      case 0:
        ...
        try {
          boolean result2 =
              iGpsGeofenceHardware.addCircularHardwareGeofence(
                  request.getId(),
                  request.getLatitude(),
          ...
          Log.m96e(TAG, "AddGeofence: Remote Exception calling LocationManagerService");
          result = false;
          break;
        }
      case 1:
        ...
        try {
          ...
          Log.m96e(TAG, "AddGeofence: RemoteException calling LocationManagerService");
          result = false;
          break;
        }
      default:
    ...
    if (DEBUG) {
      Log.m94d(TAG, "addCircularFence: Result is: " + result);
    }
    return result;
  }
  ...
  public boolean removeGeofence(int geofenceId, int monitoringType) {
    boolean result;
    if (DEBUG) {
      Log.m94d(TAG, "Remove Geofence: GeofenceId: " + geofenceId);
    }
    synchronized (this.mGeofences) {
    ...
    switch (monitoringType) {
      case 0:
        ...
        try {
          ...
          Log.m96e(TAG, "RemoveGeofence: Remote Exception calling LocationManagerService");
          result = false;
          break;
        }
      case 1:
        ...
        try {
          ...
          Log.m96e(TAG, "RemoveGeofence: RemoteException calling LocationManagerService");
          result = false;
          break;
        }
      default:
    ...
    if (DEBUG) {
      Log.m94d(TAG, "removeGeofence: Result is: " + result);
    }
    return result;
  }
  ...
  public boolean pauseGeofence(int geofenceId, int monitoringType) {
    boolean result;
    if (DEBUG) {
      Log.m94d(TAG, "Pause Geofence: GeofenceId: " + geofenceId);
    }
    synchronized (this.mGeofences) {
      if (this.mGeofences.get(geofenceId) == null) {
        throw new IllegalArgumentException("Geofence " + geofenceId + " not registered.");
    ...
    switch (monitoringType) {
      case 0:
        ...
        try {
          ...
          Log.m96e(TAG, "PauseGeofence: Remote Exception calling LocationManagerService");
          result = false;
          break;
        }
      case 1:
        ...
        try {
          ...
          Log.m96e(TAG, "PauseGeofence: RemoteException calling LocationManagerService");
          result = false;
          break;
        }
      default:
    ...
    if (DEBUG) {
      Log.m94d(TAG, "pauseGeofence: Result is: " + result);
    }
    return result;
  }
  ...
  public boolean resumeGeofence(int geofenceId, int monitoringType, int monitorTransition) {
    boolean result;
    if (DEBUG) {
      Log.m94d(TAG, "Resume Geofence: GeofenceId: " + geofenceId);
    }
    synchronized (this.mGeofences) {
      if (this.mGeofences.get(geofenceId) == null) {
        throw new IllegalArgumentException("Geofence " + geofenceId + " not registered.");
    ...
    switch (monitoringType) {
      case 0:
        ...
        try {
          ...
          Log.m96e(TAG, "ResumeGeofence: Remote Exception calling LocationManagerService");
          result = false;
          break;
        }
      case 1:
        ...
        try {
          ...
          Log.m96e(TAG, "ResumeGeofence: RemoteException calling LocationManagerService");
          result = false;
          break;
        }
      default:
    ...
    if (DEBUG) {
      Log.m94d(TAG, "resumeGeofence: Result is: " + result);
    }
    return result;
  }
  ...
  public void reportGeofenceTransition(
      ...
      int sourcesUsed) {
    if (location == null) {
      Log.m96e(TAG, String.format("Invalid Geofence Transition: location=null", new Object[0]));
      return;
    }
    if (DEBUG) {
      Log.m94d(
    ...
    GeofenceTransition geofenceTransition =
        new GeofenceTransition(
            geofenceId, transition, transitionTimestamp, location, monitoringType, sourcesUsed);
    acquireWakeLock();
  ...
  public void reportGeofenceMonitorStatus(
      int monitoringType, int monitoringStatus, Location location, int source) {
    setMonitorAvailability(monitoringType, monitoringStatus);
    acquireWakeLock();
    GeofenceHardwareMonitorEvent event =
        new GeofenceHardwareMonitorEvent(monitoringType, monitoringStatus, source, location);
  ...
  public void reportGeofenceAddStatus(int geofenceId, int status) {
    if (DEBUG) {
      Log.m94d(TAG, "AddCallback| id:" + geofenceId + ", status:" + status);
    }
  ...
  public void reportGeofenceRemoveStatus(int geofenceId, int status) {
    if (DEBUG) {
      Log.m94d(TAG, "RemoveCallback| id:" + geofenceId + ", status:" + status);
    }
  ...
  public void reportGeofencePauseStatus(int geofenceId, int status) {
    if (DEBUG) {
      Log.m94d(TAG, "PauseCallbac| id:" + geofenceId + ", status" + status);
    }
  ...
  public void reportGeofenceResumeStatus(int geofenceId, int status) {
    if (DEBUG) {
      Log.m94d(TAG, "ResumeCallback| id:" + geofenceId + ", status:" + status);
    }
  ...
  class Reaper implements IBinder.DeathRecipient {
    ...
    public void binderDied() {
      if (this.mCallback != null) {
        ...
        Message m2 =
            GeofenceHardwareImpl.this.mCallbacksHandler.obtainMessage(4, this.mMonitorCallback);
    ...
    public int hashCode() {
      ...
      int result =
          i
              + (iGeofenceHardwareCallback != null
                  ? iGeofenceHardwareCallback.asBinder().hashCode()
                  : 0);
      int result2 = result * 31;
      IGeofenceHardwareMonitorCallback iGeofenceHardwareMonitorCallback = this.mMonitorCallback;
      return ((result2
                  + (iGeofenceHardwareMonitorCallback != null
                      ? iGeofenceHardwareMonitorCallback.asBinder().hashCode()
                      : 0))
              * 31)
          + this.mMonitoringType;
    }
    ...
    public boolean equals(Object obj) {
      ...
      if (!binderEquals(rhs.mCallback, this.mCallback)
          || !binderEquals(rhs.mMonitorCallback, this.mMonitorCallback)
          || rhs.mMonitoringType != this.mMonitoringType) {
        return false;
      }
      return true;
    }
    ...
    private boolean callbackEquals(IGeofenceHardwareCallback cb) {
      IGeofenceHardwareCallback iGeofenceHardwareCallback = this.mCallback;
      return iGeofenceHardwareCallback != null
          && iGeofenceHardwareCallback.asBinder() == cb.asBinder();
    }
  }
