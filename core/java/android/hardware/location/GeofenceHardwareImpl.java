...
public final class GeofenceHardwareImpl {
                ...
                case 1:
                    ...
                    synchronized (GeofenceHardwareImpl.this.mGeofences) {
                        ...
                        if (GeofenceHardwareImpl.DEBUG) {
                            Log.m94d(GeofenceHardwareImpl.TAG, "GeofenceTransistionCallback: GPS : GeofenceId: " + geofenceTransition.mGeofenceId + " Transition: " + geofenceTransition.mTransition + " Location: " + geofenceTransition.mLocation + ":" + GeofenceHardwareImpl.this.mGeofences);
                        }
                    }
                    if (callback != null) {
                        try {
                        ...
                        if (!callbackInUse) {
                            ...
                            while (iterator.hasNext()) {
                                ...
                                if (reaper.mCallback != null && reaper.mCallback.asBinder() == callbackBinder) {
                                    ...
                                    if (GeofenceHardwareImpl.DEBUG) {
                                        Log.m94d(GeofenceHardwareImpl.TAG, String.format("Removed reaper %s because binder %s is no longer needed.", reaper, callbackBinder));
                                    }
                                }
                            }
                        }
                    ...
                    if (callbackList != null) {
                        ...
                        while (it.hasNext()) {
                            ...
                            try {
                                ...
                                Log.m95d(GeofenceHardwareImpl.TAG, "Error reporting onMonitoringSystemChange.", e);
                            }
                        }
                    }
                    GeofenceHardwareImpl.this.releaseWakeLock();
    ...
    */
    ...
    public void reportGeofenceTransition(int geofenceId, Location location, int transition, long transitionTimestamp, int monitoringType, int sourcesUsed) {
        ...
        if (DEBUG) {
            Log.m94d(TAG, "GeofenceTransition| " + location + ", transition:" + transition + ", transitionTimestamp:" + transitionTimestamp + ", monitoringType:" + monitoringType + ", sourcesUsed:" + sourcesUsed);
        }
