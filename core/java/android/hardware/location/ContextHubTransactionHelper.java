...
public class ContextHubTransactionHelper {
    ...
    public static IContextHubTransactionCallback createNanoAppQueryCallback(
        ...
        return new IContextHubTransactionCallback
                .Stub() { // from class: android.hardware.location.ContextHubTransactionHelper.1
            ...
            public void onQueryResponse(int result, List<NanoAppState> nanoappList) {
                ContextHubTransaction.this.setResponse(
                        new ContextHubTransaction.Response(result, nanoappList));
            }

            @Override // android.hardware.location.IContextHubTransactionCallback
            public void onTransactionComplete(int result) {
                Log.e(
                        ContextHubTransactionHelper.TAG,
                        "Received a non-query callback on a query request");
    ...
    public static IContextHubTransactionCallback createTransactionCallback(
        ...
        Objects.requireNonNull(transaction, "transaction cannot be null");
        return new IContextHubTransactionCallback
                .Stub() { // from class: android.hardware.location.ContextHubTransactionHelper.2
            @Override // android.hardware.location.IContextHubTransactionCallback
            public void onQueryResponse(int result, List<NanoAppState> nanoappList) {
                Log.e(
                        ContextHubTransactionHelper.TAG,
                        "Received a query callback on a non-query request");
                ContextHubTransaction.this.setResponse(new ContextHubTransaction.Response(7, null));
            }
            ...
            public void onTransactionComplete(int result) {
                ContextHubTransaction.this.setResponse(
                        new ContextHubTransaction.Response(result, null));
            }
        };
    }
}
