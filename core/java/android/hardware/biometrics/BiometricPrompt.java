...
public class BiometricPrompt implements BiometricAuthenticator, BiometricConstants {
  ...
  public static class Builder {
    ...
    public BiometricPrompt build() {
      ...
      if (iAuthService == null) {
        iAuthService =
            IAuthService.Stub.asInterface(ServiceManager.getService(Context.AUTH_SERVICE));
      }
      this.mService = iAuthService;
      return new BiometricPrompt(
          this.mContext, this.mPromptInfo, this.mNegativeButtonInfo, this.mService);
    }
  }
  ...
  private class OnAuthenticationCancelListener implements CancellationSignal.OnCancelListener {
    ...
    public void onCancel() {
      if (!BiometricPrompt.this.mIsPromptShowing) {
        ...
        Log.m94d(
            BiometricPrompt.TAG, "Cancel BP authentication requested for: " + this.mAuthRequestId);
  ...
  class BinderC08931 extends IBiometricServiceReceiver.Stub {
      ...
      BiometricPrompt.this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            public final void run() {
              BiometricPrompt.BinderC08931.this.lambda$onAuthenticationSucceeded$0(
                  authenticationType);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onAuthenticationSucceeded$0(int authenticationType) {
      AuthenticationResult result =
          new AuthenticationResult(BiometricPrompt.this.mCryptoObject, authenticationType);
    ...
    public void onError(int modality, final int error, int vendorCode) {
      ...
      switch (modality) {
        case 2:
          errorMessage =
              FingerprintManager.getErrorString(BiometricPrompt.this.mContext, error, vendorCode);
          break;
        case 8:
          errorMessage =
              FaceManager.getErrorString(BiometricPrompt.this.mContext, error, vendorCode);
          break;
      }
      if (errorMessage == null) {
        switch (error) {
          case 5:
            errorMessage =
                BiometricPrompt.this.mContext.getString(C4337R.string.biometric_error_canceled);
            break;
          case 10:
            errorMessage =
                BiometricPrompt.this.mContext.getString(
                    C4337R.string.biometric_error_user_canceled);
            break;
          case 12:
            errorMessage =
                BiometricPrompt.this.mContext.getString(
                    C4337R.string.biometric_error_hw_unavailable);
            break;
          case 14:
            errorMessage =
                BiometricPrompt.this.mContext.getString(
                    C4337R.string.biometric_error_device_not_secured);
            break;
          default:
            Log.m96e(
                BiometricPrompt.TAG,
                "Unknown error, modality: "
                    ...
                    + vendorCode);
            errorMessage =
                BiometricPrompt.this.mContext.getString(C4337R.string.biometric_error_generic);
            break;
        }
      }
    ...
    public void onSemAuthenticationSucceeded(
      ...
      BiometricPrompt.this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              BiometricPrompt.BinderC08931.this.lambda$onSemAuthenticationSucceeded$6(
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSemAuthenticationSucceeded$6(
  ...
  private BiometricPrompt(
      Context context, PromptInfo promptInfo, ButtonInfo negativeButtonInfo, IAuthService service) {
  ...
  public static class AuthenticationResult extends BiometricAuthenticator.AuthenticationResult {
    ...
    public byte[] semGetToken() {
      if (BiometricPrompt.DEBUG) {
        ...
        Slog.m113d(
            BiometricPrompt.TAG,
            append.append(bArr == null ? "NULL" : Integer.valueOf(bArr.length)).toString());
      }
      return this.mToken;
    }
  }
  ...
  public void authenticateUser(
      CancellationSignal cancel, Executor executor, AuthenticationCallback callback, int userId) {
    if (cancel == null) {
        ...
        try {
          ...
          if (this.mIsPromptShowing) {
            final String stringToSend =
                this.mContext.getString(C4337R.string.biometric_error_canceled);
  ...
  public /* synthetic */ void lambda$authenticateInternal$1(AuthenticationCallback callback) {
    callback.onAuthenticationError(
        1, this.mContext.getString(C4337R.string.biometric_error_hw_unavailable));
  }
