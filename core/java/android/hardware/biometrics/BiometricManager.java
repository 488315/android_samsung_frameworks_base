...
public class BiometricManager {
  ...
  public int canAuthenticate(int userId, int authenticators) {
    ...
    Slog.m121w(TAG, "canAuthenticate(): Service not connected");
    return 1;
  }
  ...
  public boolean hasEnrolledBiometrics(int userId) {
    ...
    try {
      ...
      Slog.m121w(TAG, "Remote exception in hasEnrolledBiometrics(): " + e);
      return false;
    }
  }
  ...
  public void registerEnabledOnKeyguardCallback(IBiometricEnabledOnKeyguardCallback callback) {
    ...
    Slog.m121w(TAG, "registerEnabledOnKeyguardCallback(): Service not connected");
  }
  ...
  public long[] getAuthenticatorIds(int userId) {
    ...
    Slog.m121w(TAG, "getAuthenticatorIds(): Service not connected");
    return new long[0];
  }
  ...
  public void resetLockoutTimeBound(
    ...
    if (iAuthService != null) {
      try {
        iAuthService.resetLockoutTimeBound(
