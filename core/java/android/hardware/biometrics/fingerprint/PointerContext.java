...
public class PointerContext implements Parcelable {
  ...
  public boolean equals(Object other) {
    ...
    if (Objects.deepEquals(Integer.valueOf(this.pointerId), Integer.valueOf(that.pointerId))
        && Objects.deepEquals(Float.valueOf(this.f109x), Float.valueOf(that.f109x))
        && Objects.deepEquals(Float.valueOf(this.f110y), Float.valueOf(that.f110y))
        ...
        && Objects.deepEquals(Float.valueOf(this.orientation), Float.valueOf(that.orientation))
        ...
        && Objects.deepEquals(Long.valueOf(this.gestureStart), Long.valueOf(that.gestureStart))) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(
                ...
                Float.valueOf(this.f109x),
                Float.valueOf(this.f110y),
