...
public interface ISoundTriggerHw extends IInterface {
  ...
  public static class Default implements ISoundTriggerHw {
    ...
    @Override // android.hardware.soundtrigger3.ISoundTriggerHw
    public int loadPhraseSoundModel(PhraseSoundModel soundModel, ISoundTriggerHwCallback callback)
        throws RemoteException {
      return 0;
    }
      ...
      public ModelParameterRange queryParameter(int modelHandle, int modelParam)
        ...
        try {
          ...
          ModelParameterRange _result =
              (ModelParameterRange) _reply.readTypedObject(ModelParameterRange.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
