...
public class KeyCreationResult implements Parcelable {
    public static final Parcelable.Creator<KeyCreationResult> CREATOR =
            new Parcelable.Creator<KeyCreationResult>() { // from class:
                // android.hardware.security.keymint.KeyCreationResult.1
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.keyCharacteristics =
                    (KeyCharacteristics[])
                            _aidl_parcel.createTypedArray(KeyCharacteristics.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                ...
                this.certificateChain =
                        (Certificate[]) _aidl_parcel.createTypedArray(Certificate.CREATOR);
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
                _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
