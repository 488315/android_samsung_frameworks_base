...
public interface IKeyMintDevice extends IInterface {
  ...
  KeyCreationResult importWrappedKey(
      byte[] bArr, byte[] bArr2, byte[] bArr3, KeyParameter[] keyParameterArr, long j, long j2)
      throws RemoteException;
      ...
      public KeyMintHardwareInfo getHardwareInfo() throws RemoteException {
        ...
        try {
          ...
          KeyMintHardwareInfo _result =
              (KeyMintHardwareInfo) _reply.readTypedObject(KeyMintHardwareInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public KeyCharacteristics[] getKeyCharacteristics(
        ...
        try {
          ...
          KeyCharacteristics[] _result =
              (KeyCharacteristics[]) _reply.createTypedArray(KeyCharacteristics.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
