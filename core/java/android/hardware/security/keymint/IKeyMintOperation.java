...
public interface IKeyMintOperation extends IInterface {
  ...
  public static class Default implements IKeyMintOperation {
    ...
    public void updateAad(byte[] input, HardwareAuthToken authToken, TimeStampToken timeStampToken)
        throws RemoteException {}

    @Override // android.hardware.security.keymint.IKeyMintOperation
    public byte[] update(byte[] input, HardwareAuthToken authToken, TimeStampToken timeStampToken)
        throws RemoteException {
      return null;
    }
