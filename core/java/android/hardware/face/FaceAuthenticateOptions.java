...
public class FaceAuthenticateOptions implements AuthenticateOptions, Parcelable {
  ...
  public static final Parcelable.Creator<FaceAuthenticateOptions> CREATOR =
      new Parcelable.Creator<
          FaceAuthenticateOptions>() { // from class:
  ...
  FaceAuthenticateOptions(
    ...
    if (authenticateReason != 0
        && authenticateReason != 1
        && authenticateReason != 2
        && authenticateReason != 3
        && authenticateReason != 4
        && authenticateReason != 5
        && authenticateReason != 6
        && authenticateReason != 7
        && authenticateReason != 8
        && authenticateReason != 9
        && authenticateReason != 10) {
      throw new IllegalArgumentException(
          "authenticateReason was "
              ...
              + " AUTHENTICATE_REASON_QS_EXPANDED(8), AUTHENTICATE_REASON_SWIPE_UP_ON_BOUNCER(9),"
              + " AUTHENTICATE_REASON_UDFPS_POINTER_DOWN(10"
              + NavigationBarInflaterView.KEY_CODE_END);
    }
    this.mWakeReason = wakeReason;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) PowerManager.WakeReason.class, (Annotation) null, wakeReason);
    this.mOpPackageName = opPackageName;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) opPackageName);
