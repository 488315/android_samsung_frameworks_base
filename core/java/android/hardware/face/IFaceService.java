...
public interface IFaceService extends IInterface {
  ...
  void remove(IBinder iBinder, int i, int i2, IFaceServiceReceiver iFaceServiceReceiver, String str)
      throws RemoteException;
  ...
  public static class Default implements IFaceService {
    ...
    @Override // android.hardware.face.IFaceService
    public void remove(
        IBinder token, int faceId, int userId, IFaceServiceReceiver receiver, String opPackageName)
        throws RemoteException {}
    ...
    public void resetLockout(
        IBinder token, int sensorId, int userId, byte[] hardwareAuthToken, String opPackageName)
        throws RemoteException {}
    ...
    public void getFeature(
        IBinder token, int userId, int feature, IFaceServiceReceiver receiver, String opPackageName)
        throws RemoteException {}

    @Override // android.hardware.face.IFaceService
    public void registerAuthenticators(List<FaceSensorPropertiesInternal> hidlSensors)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 5:
              ...
              FaceAuthenticateOptions _arg3 =
                  (FaceAuthenticateOptions) data.readTypedObject(FaceAuthenticateOptions.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 12:
              ...
              data.enforceNoDataAvail();
              long _result7 =
                  enroll(_arg012, _arg111, _arg28, _arg34, _arg42, _arg52, _arg62, _arg72);
              reply.writeNoException();
            ...
            case 28:
              ...
              return true;
            case 29:
              List<FaceSensorPropertiesInternal> _arg029 =
            ...
            case 30:
              IFaceAuthenticatorsRegisteredCallback _arg030 =
                  IFaceAuthenticatorsRegisteredCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              addAuthenticatorsRegisteredCallback(_arg030);
              reply.writeNoException();
              return true;
            case 31:
              IBiometricStateListener _arg031 =
            ...
            case 34:
              ...
              data.enforceNoDataAvail();
              long _result15 =
                  semAuthenticateExt(_arg033, _arg129, _arg221, _arg314, _arg411, _arg56);
              reply.writeNoException();
