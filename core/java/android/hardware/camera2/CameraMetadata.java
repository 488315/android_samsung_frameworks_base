...
public abstract class CameraMetadata<TKey> {
  ...
  <TKey> ArrayList<TKey> getKeys(
      Class<?> cls, Class<TKey> cls2, CameraMetadata<TKey> cameraMetadata, int[] iArr, boolean z) {
    String name;
    long vendorId;
    ...
    MediaController.C52592 c52592 = (ArrayList<TKey>) new ArrayList();
    ...
    if (allVendorKeys != null) {
      ...
      while (it.hasNext()) {
        ...
        if (iArr == null
            || Arrays.binarySearch(iArr, CameraMetadataNative.getTag(name, vendorId)) >= 0) {
