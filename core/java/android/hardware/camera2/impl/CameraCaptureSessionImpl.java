...
public class CameraCaptureSessionImpl extends CameraCaptureSession implements CameraCaptureSessionCore {
    ...
    public void abortCaptures() throws CameraAccessException {
        synchronized (this.mDeviceImpl.mInterfaceLock) {
            checkNotClosed();
            if (this.mAborting) {
                Log.m102w(TAG, this.mIdString + "abortCaptures - Session is already aborting; doing nothing");
                return;
            }
            this.mAborting = true;
    ...
    class C09631 extends CaptureCallback {
        ...
        C09631(Executor executor, CameraCaptureSession.CaptureCallback callback, CameraCaptureSession.CaptureCallback captureCallback, Executor executor2) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda6
                        ...
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onCaptureStarted$0(captureCallback, request, timestamp, frameNumber);
                        }
                    });
                } finally {
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onReadoutStarted$1(captureCallback, request, timestamp, frameNumber);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onCapturePartial$2(captureCallback, request, result);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onCaptureProgressed$3(captureCallback, request, partialResult);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onCaptureCompleted$4(captureCallback, request, result);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda7
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onCaptureFailed$5(captureCallback, request, failure);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda8
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onCaptureSequenceCompleted$6(captureCallback, sequenceId, frameNumber);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onCaptureSequenceAborted$7(captureCallback, sequenceId);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.C09631.this.lambda$onCaptureBufferLost$8(captureCallback, request, target, frameNumber);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
        ...
        public void onDrained() {
            synchronized (CameraCaptureSessionImpl.this.mDeviceImpl.mInterfaceLock) {
                ...
                try {
                    ...
                    Log.m97e(CameraCaptureSessionImpl.TAG, CameraCaptureSessionImpl.this.mIdString + "Exception while unconfiguring outputs: ", e);
                } catch (IllegalStateException e2) {
                }
            }
        }
