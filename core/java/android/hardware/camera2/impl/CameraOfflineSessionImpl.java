...
public class CameraOfflineSessionImpl extends CameraOfflineSession
  ...
  public CameraOfflineSessionImpl(
    ...
    Integer partialCount =
        (Integer) characteristics.get(CameraCharacteristics.REQUEST_PARTIAL_RESULT_COUNT);
    ...
    this.mOfflineExecutor =
        (Executor) Preconditions.checkNotNull(offlineExecutor, "offline executor must not be null");
    this.mOfflineCallback =
        (CameraOfflineSession.CameraOfflineSessionCallback)
            Preconditions.checkNotNull(offlineCallback, "offline callback must not be null");
  }
  ...
  public class CameraDeviceCallbacks extends ICameraDeviceCallbacks.Stub {
                  ...
                  new Runnable() { // from class:
                    ...
                    public void run() {
                      if (!CameraOfflineSessionImpl.this.isClosed()) {
                        CameraOfflineSessionImpl.this.mOfflineCallback.onError(
                            CameraOfflineSessionImpl.this, 0);
                      }
                    }
                  };
    ...
    public void onRepeatingRequestError(long lastFrameNumber, int repeatingRequestId) {
      Log.m96e(
          ...
          "Unexpected repeating request error received. Last frame number is " + lastFrameNumber);
    }
                          ...
                          if (!CameraOfflineSessionImpl.this.isClosed() && callback != null) {
                            ...
                            if (holder.hasBatchedOutputs()) {
                              ...
                              for (int i = 0; i < holder.getRequestCount(); i++) {
                                ...
                                long cbTimestamp =
                                    timestamp
                                        - (((subsequenceId - i) * 1000000000)
                                            / fpsRange.getUpper().intValue());
            ...
            try {
              ...
              if (isPartialResult) {
                final CaptureResult resultAsCapture =
                    new CaptureResult(
                        CameraOfflineSessionImpl.this.mCameraId, result, request, resultExtras);
                          ...
                          if (holder.hasBatchedOutputs()) {
                            for (int i = 0; i < holder.getRequestCount(); i++) {
                              CameraMetadataNative resultLocal =
                                  new CameraMetadataNative(cameraMetadataNative);
                              ...
                              callback.onCaptureProgressed(
                                  CameraOfflineSessionImpl.this, cbRequest, resultInBatch);
                            }
                            return;
                          }
                          callback.onCaptureProgressed(
                              CameraOfflineSessionImpl.this, request, resultAsCapture);
                        }
                      }
                    };
                ...
                final List<CaptureResult> partialResults =
                    CameraOfflineSessionImpl.this.mFrameNumberTracker.popPartialResults(
                        frameNumber2);
                      ...
                      new Runnable() { // from class:
                        ...
                        public void run() {
                          ...
                          if (!CameraOfflineSessionImpl.this.isClosed() && callback != null) {
                                ...
                                cameraMetadataNative2.set(
                                    ...
                                    (CaptureResult.Key<Long>)
                                        Long.valueOf(
                                            sensorTimestamp
                                                - (((subsequenceId - i) * 1000000000)
                                                    / ((Integer) fpsRange.getUpper()).intValue())));
                                CameraMetadataNative resultLocal =
                                    new CameraMetadataNative(cameraMetadataNative2);
                            ...
                            callback.onCaptureCompleted(
                                CameraOfflineSessionImpl.this, request, resultAsCapture2);
                          }
                        }
                      };
    ...
    public void onPrepared(int streamId) {
      Log.m96e(CameraOfflineSessionImpl.TAG, "Unexpected stream " + streamId + " is prepared");
    }

    @Override // android.hardware.camera2.ICameraDeviceCallbacks
    public void onRequestQueueEmpty() {
      Log.m100v(CameraOfflineSessionImpl.TAG, "onRequestQueueEmpty");
    }
    ...
    private void onCaptureErrorLocked(int errorCode, CaptureResultExtras resultExtras) {
      ...
      final CaptureCallbackHolder holder =
          (CaptureCallbackHolder) CameraOfflineSessionImpl.this.mCaptureCallbackMap.get(requestId);
      if (holder == null) {
        Log.m96e(
            CameraOfflineSessionImpl.TAG,
            String.format(
                "Receive capture error on unknown request ID %d", Integer.valueOf(requestId)));
        return;
      }
          ...
          if (request.containsTarget(surface)) {
            ...
            Runnable failureDispatch =
                new Runnable() { // from class:
                  ...
                  public void run() {
                    CameraCaptureSession.CaptureCallback callback =
                        captureCallbackHolder.getCallback().getSessionCallback();
                    if (!CameraOfflineSessionImpl.this.isClosed() && callback != null) {
                      callback.onCaptureBufferLost(
                          CameraOfflineSessionImpl.this, request, surface, frameNumber);
                    }
                  }
                };
            if (executor != null) {
      ...
      final CaptureFailure failure =
          new CaptureFailure(
              request, 0, mayHaveBuffers, requestId, frameNumber, errorPhysicalCameraId);
      Executor executor2 = holder.getCallback().getExecutor();
  ...
  public void checkAndFireSequenceComplete() {
    ...
    while (iter.hasNext()) {
      ...
      if (sequenceCompleted && callback != null && executor != null) {
        Runnable resultDispatch =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraOfflineSessionImpl.1
              @Override // java.lang.Runnable
              public void run() {
                if (!CameraOfflineSessionImpl.this.isClosed()) {
      ...
      if (holder != null) {
        ...
        if (lastRegularFrameNumber <= lastCompletedRegularFrameNumber
          ...
          if (requestLastFrameNumbers.isSequenceCompleted()) {
            ...
            Log.m96e(TAG, "Sequence not yet completed for request id " + requestId);
          }
        }
      }
    }
  ...
  public void notifyFailedSwitch() {
    synchronized (this.mInterfaceLock) {
      Runnable switchFailDispatch =
          new Runnable() { // from class: android.hardware.camera2.impl.CameraOfflineSessionImpl.2
            @Override // java.lang.Runnable
            public void run() {
  ...
  public void setRemoteSession(ICameraOfflineSession remoteSession) throws CameraAccessException {
    synchronized (this.mInterfaceLock) {
      ...
      try {
        ...
        Runnable readyDispatch =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraOfflineSessionImpl.3
              @Override // java.lang.Runnable
              public void run() {
                if (!CameraOfflineSessionImpl.this.isClosed()) {
    ...
    synchronized (this.mInterfaceLock) {
      ...
      if (iCameraOfflineSession != null) {
        ...
        try {
          ...
          Log.m97e(TAG, "Exception while disconnecting from offline session: ", e);
        }
        this.mRemoteSession = null;
        Runnable closeDispatch =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraOfflineSessionImpl.4
              @Override // java.lang.Runnable
              public void run() {
  ...
  public void binderDied() {
    Log.m102w(TAG, "CameraOfflineSession on device " + this.mCameraId + " died unexpectedly");
    disconnect();
  }
