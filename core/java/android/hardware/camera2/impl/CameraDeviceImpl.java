...
public class CameraDeviceImpl extends CameraDevice implements IBinder.DeathRecipient {
    ...
    private final Runnable mCallOnOpened =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.1
                ...
                public void run() {
                    synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                        ...
                        StateCallbackKK sessionCallback =
                                CameraDeviceImpl.this.mSessionStateCallback;
    ...
    private final Runnable mCallOnUnconfigured =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.2
                @Override // java.lang.Runnable
                public void run() {
                    synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                        if (CameraDeviceImpl.this.mRemoteDevice == null) {
    ...
    private final Runnable mCallOnActive =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.3
                @Override // java.lang.Runnable
                public void run() {
                    synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                        if (CameraDeviceImpl.this.mRemoteDevice == null) {
    ...
    private final Runnable mCallOnBusy =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.4
                @Override // java.lang.Runnable
                public void run() {
                    synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                        if (CameraDeviceImpl.this.mRemoteDevice == null) {
    ...
    private final Runnable mCallOnClosed =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.5
    ...
    private final Runnable mCallOnIdle =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.6
                @Override // java.lang.Runnable
                public void run() {
                    synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                        if (CameraDeviceImpl.this.mRemoteDevice == null) {
    ...
    private final Runnable mCallOnDisconnected =
            new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.7
                @Override // java.lang.Runnable
                public void run() {
                    synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                        if (CameraDeviceImpl.this.mRemoteDevice == null) {
    ...
    private class ClientStateCallback extends CameraDevice.StateCallback {
        ...
        private ClientStateCallback(
                Executor clientExecutor, CameraDevice.StateCallback clientStateCallback) {
        ...
        public void onClosed(final CameraDevice camera) {
            this.mClientExecutor.execute(
                    new Runnable() { // from class:
                        // android.hardware.camera2.impl.CameraDeviceImpl.ClientStateCallback.1
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void onOpened(final CameraDevice camera) {
            this.mClientExecutor.execute(
                    new Runnable() { // from class:
                        // android.hardware.camera2.impl.CameraDeviceImpl.ClientStateCallback.2
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void onDisconnected(final CameraDevice camera) {
            this.mClientExecutor.execute(
                    new Runnable() { // from class:
                        // android.hardware.camera2.impl.CameraDeviceImpl.ClientStateCallback.3
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void onError(final CameraDevice camera, final int error) {
            this.mClientExecutor.execute(
                    new Runnable() { // from class:
                        // android.hardware.camera2.impl.CameraDeviceImpl.ClientStateCallback.4
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    private Map<String, CameraCharacteristics> getPhysicalIdToChars() {
        if (this.mPhysicalIdsToChars == null) {
            try {
                this.mPhysicalIdsToChars =
                        this.mCameraManager.getPhysicalIdToCharsMap(this.mCharacteristics);
            ...
            if (remoteDeviceBinder != null) {
                try {
                    ...
                    throw new CameraAccessException(
                            2, "The camera device has encountered a serious error");
                }
            }
    ...
    public void setRemoteFailure(ServiceSpecificException failure) {
        ...
        switch (failure.errorCode) {
            ...
            default:
                Log.e(
                        this.TAG,
                        "Unexpected failure in opening camera device: "
                                + failure.errorCode
                                + failure.getMessage());
                break;
            case 6:
        ...
        synchronized (this.mInterfaceLock) {
            this.mInError = true;
            this.mDeviceExecutor.execute(
                    new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.8
                        @Override // java.lang.Runnable
                        public void run() {
                            if (isError) {
                                CameraDeviceImpl.this.mDeviceCallback.onError(
                                        CameraDeviceImpl.this, code);
                            } else {
                                CameraDeviceImpl.this.mDeviceCallback.onDisconnected(
    ...
    */
    public boolean configureStreamsChecked(
            android.hardware.camera2.params.InputConfiguration r19,
            java.util.List<android.hardware.camera2.params.OutputConfiguration> r20,
            int r21,
            android.hardware.camera2.CaptureRequest r22,
            long r23)
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " android.hardware.camera2.impl.CameraDeviceImpl.configureStreamsChecked(android.hardware.camera2.params.InputConfiguration,"
                    + " java.util.List, int, android.hardware.camera2.CaptureRequest,"
                    + " long):boolean");
    }
    ...
    public void createCaptureSession(
        ...
        createCaptureSessionInternal(
                null, outConfigurations, callback, checkAndWrapHandler(handler), 0, null);
    }
    ...
    public void createCaptureSessionByOutputConfigurations(
        ...
        createCaptureSessionInternal(
                null, currentOutputs, callback, checkAndWrapHandler(handler), 0, null);
    }

    @Override // android.hardware.camera2.CameraDevice
    public void createReprocessableCaptureSession(
        ...
        if (inputConfig == null) {
            throw new IllegalArgumentException(
                    "inputConfig cannot be null when creating a reprocessable capture session");
        }
        List<OutputConfiguration> outConfigurations = new ArrayList<>(outputs.size());
        for (Surface surface : outputs) {
            outConfigurations.add(new OutputConfiguration(surface));
        ...
        createCaptureSessionInternal(
                inputConfig, outConfigurations, callback, checkAndWrapHandler(handler), 0, null);
    }
    ...
    public void createReprocessableCaptureSessionByConfigurations(
        ...
        if (outputs == null) {
            throw new IllegalArgumentException(
                    "Output configurations cannot be null when creating a reprocessable capture"
                            + " session");
        }
        ...
        createCaptureSessionInternal(
                inputConfig, currentOutputs, callback, checkAndWrapHandler(handler), 0, null);
    }

    @Override // android.hardware.camera2.CameraDevice
    public void createConstrainedHighSpeedCaptureSession(
            List<Surface> outputs, CameraCaptureSession.StateCallback callback, Handler handler)
            throws CameraAccessException {
        ...
        createCaptureSessionInternal(
                null, outConfigurations, callback, checkAndWrapHandler(handler), 1, null);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void createCaptureSessionInternal(
            android.hardware.camera2.params.InputConfiguration r23,
            java.util.List<android.hardware.camera2.params.OutputConfiguration> r24,
            android.hardware.camera2.CameraCaptureSession.StateCallback r25,
            java.util.concurrent.Executor r26,
            int r27,
            android.hardware.camera2.CaptureRequest r28)
            throws android.hardware.camera2.CameraAccessException {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " android.hardware.camera2.impl.CameraDeviceImpl.createCaptureSessionInternal(android.hardware.camera2.params.InputConfiguration,"
                    + " java.util.List,"
                    + " android.hardware.camera2.CameraCaptureSession$StateCallback,"
                    + " java.util.concurrent.Executor, int,"
                    + " android.hardware.camera2.CaptureRequest):void");
    }

    @Override // android.hardware.camera2.CameraDevice
    public boolean isSessionConfigurationSupported(SessionConfiguration sessionConfig)
            throws CameraAccessException, UnsupportedOperationException, IllegalArgumentException {
        synchronized (this.mInterfaceLock) {
            checkIfCameraClosedOrInError();
            if (CompatChanges.isChangeEnabled(CHECK_PARAMS_IN_IS_SESSION_CONFIGURATION_SUPPORTED)
                    && Flags.cameraDeviceSetup()
                    && this.mCameraDeviceSetup != null) {
    ...
    public static void disableZslIfNeeded(
            CameraMetadataNative request, int targetSdkVersion, int templateType) {
        ...
        request.set(
                (CaptureRequest.Key<CaptureRequest.Key<Boolean>>) CaptureRequest.CONTROL_ENABLE_ZSL,
                (CaptureRequest.Key<Boolean>) false);
    }

    @Override // android.hardware.camera2.CameraDevice
    public CaptureRequest.Builder createCaptureRequest(
            int templateType, Set<String> physicalCameraIdSet) throws CameraAccessException {
        ...
        synchronized (this.mInterfaceLock) {
            ...
            CameraMetadataNative templatedRequest =
                    this.mRemoteDevice.createDefaultRequest(templateType);
            disableZslIfNeeded(templatedRequest, this.mAppTargetSdkVersion, templateType);
            builder =
                    new CaptureRequest.Builder(
                            templatedRequest, false, -1, getId(), physicalCameraIdSet);
        }
        return builder;
    }
    ...
    public CaptureRequest.Builder createReprocessCaptureRequest(TotalCaptureResult inputResult)
        ...
        synchronized (this.mInterfaceLock) {
            checkIfCameraClosedOrInError();
            CameraMetadataNative resultMetadata =
                    new CameraMetadataNative(inputResult.getNativeCopy());
            builder =
                    new CaptureRequest.Builder(
                            resultMetadata, true, inputResult.getSessionId(), getId(), null);
    ...
    public CameraOfflineSession switchToOffline(
            ...
            for (Surface surface : offlineOutputs) {
                ...
                while (true) {
                    ...
                    if (surface != this.mConfiguredOutputs.valueAt(i).getSurface()) {
                        ...
                        streamId = this.mConfiguredOutputs.keyAt(i);
                        offlineConfiguredOutputs.append(
                                streamId, this.mConfiguredOutputs.valueAt(i));
                        break;
                    }
                }
                if (streamId == -1) {
                    throw new IllegalArgumentException(
                            "Offline surface is not part of this session");
                }
                if (!this.mOfflineSupport.contains(Integer.valueOf(streamId))) {
                    throw new IllegalArgumentException(
                            "Surface: " + surface + " does not  support offline mode");
                }
                offlineStreamIds.add(Integer.valueOf(streamId));
            }
            stopRepeating();
            this.mOfflineSessionImpl =
                    new CameraOfflineSessionImpl(
                            this.mCameraId,
                            this.mCharacteristics,
                            executor,
                            listener,
                            offlineConfiguredOutputs,
                            this.mConfiguredInput,
                            this.mConfiguredOutputs,
                            this.mFrameNumberTracker,
                            this.mCaptureCallbackMap,
                            this.mRequestLastFrameNumbersList);
        ...
        this.mOfflineSwitchService.execute(
                new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.9
                    @Override // java.lang.Runnable
                    public void run() {
                        try {
                            try {
                                ICameraOfflineSession remoteOfflineSession =
                                        CameraDeviceImpl.this.mRemoteDevice.switchToOffline(
                                                CameraDeviceImpl.this.mOfflineSessionImpl
                                                        .getCallbacks(),
                                                Arrays.stream(
                                                                (Integer[])
                                                                        offlineStreamIds.toArray(
                                                                                new Integer
                                                                                        [offlineStreamIds
                                                                                                .size()]))
                                                        .mapToInt(
                                                        ...
                                                        .toArray());
                                CameraDeviceImpl.this.mOfflineSessionImpl.setRemoteSession(
                                        remoteOfflineSession);
                            } catch (CameraAccessException e) {
    ...
    public void finalizeOutputConfigs(List<OutputConfiguration> outputConfigs)
        ...
        synchronized (this.mInterfaceLock) {
            ...
            for (OutputConfiguration config : outputConfigs) {
                ...
                if (streamId == -1) {
                    throw new IllegalArgumentException(
                            "Deferred config is not part of this session");
                }
                if (config.getSurfaces().size() == 0) {
                    throw new IllegalArgumentException(
                            "The final config for stream "
                                    + streamId
    ...
    public int captureBurst(
            List<CaptureRequest> requests, CaptureCallback callback, Executor executor)
            throws CameraAccessException {
    ...
    public void checkEarlyTriggerSequenceCompleteLocked(
        ...
        if (lastFrameNumber == -1) {
                                ...
                                if (!CameraDeviceImpl.this.isClosed()) {
                                    holder.getCallback()
                                            .onCaptureSequenceAborted(
                                                    CameraDeviceImpl.this, requestId);
                                }
                            }
                        };
            ...
            Log.w(
                    this.TAG,
                    String.format(
                            "did not register callback to request %d", Integer.valueOf(requestId)));
            return;
        }
        this.mRequestLastFrameNumbersList.add(
                new RequestLastFrameNumbersHolder(
                        requestId, lastFrameNumber, repeatingRequestTypes));
    ...
    public void updateTracker(
        ...
        if (this.mBatchOutputMap.containsKey(Integer.valueOf(requestId))) {
            ...
            for (int i = 0; i < requestCount; i++) {
                this.mFrameNumberTracker.updateTracker(
                        frameNumber - ((requestCount - 1) - i),
                        result,
                        isPartialResult,
                        requestType);
            }
            ...
            try {
                try {
                    ...
                    for (CaptureRequest request : requestList) {
                        try {
                            ...
                            for (Surface surface : request.getTargets()) {
                                if (surface == null) {
                                    throw new IllegalArgumentException(
                                            "Null Surface targets are not allowed");
                                }
                            }
                        } catch (Throwable th) {
                            th = th;
                    ...
                    SubmitInfo requestInfo =
                            this.mRemoteDevice.submitRequestList(requestArray, repeating);
                    ...
                    if (hasBatchedOutputs) {
                        ...
                        this.mBatchOutputMap.put(
                                Integer.valueOf(requestInfo.getRequestId()),
                                Integer.valueOf(requestCount));
                    }
                    if (callback != null) {
                        this.mCaptureCallbackMap.put(
                    ...
                    if (repeating) {
                        if (this.mRepeatingRequestId != -1) {
                            checkEarlyTriggerSequenceCompleteLocked(
                                    this.mRepeatingRequestId,
                                    requestInfo.getLastFrameNumber(),
                                    this.mRepeatingRequestTypes);
                        }
    ...
    public int setRepeatingRequest(
            CaptureRequest request, CaptureCallback callback, Executor executor)
            throws CameraAccessException {
        List<CaptureRequest> requestList = new ArrayList<>();
        requestList.add(request);
        ...
        synchronized (this.mInterfaceLock) {
            ...
            if (this.mRepeatingRequestId != -1) {
                ...
                try {
                    ...
                    checkEarlyTriggerSequenceCompleteLocked(
                            requestId, lastFrameNumber, requestTypes);
    ...
    public void flush() throws CameraAccessException {
        synchronized (this.mInterfaceLock) {
            ...
            if (this.mRepeatingRequestId != -1) {
                checkEarlyTriggerSequenceCompleteLocked(
                        this.mRepeatingRequestId, lastFrameNumber, this.mRepeatingRequestTypes);
                this.mRepeatingRequestId = -1;
                this.mRepeatingRequestTypes = null;
            }
        }
    ...
    private boolean checkInputConfigurationWithStreamConfigurations(
        ...
        for (Map.Entry<String, CameraCharacteristics> entry : getPhysicalIdToChars().entrySet()) {
            ...
            if (configMap2 != null
                    && checkInputConfigurationWithStreamConfigurationsAs(inputConfig, configMap2)) {
                return true;
            }
        }
        return false;
    ...
    private void checkInputConfiguration(InputConfiguration inputConfig) {
        ...
        if (inputConfig.isMultiResolution()) {
            MultiResolutionStreamConfigurationMap configMap =
            ...
            if (!validFormat) {
                throw new IllegalArgumentException(
                        "multi-resolution input format " + inputFormat + " is not valid");
            }
            boolean validSize = false;
            ...
            if (!validSize) {
                throw new IllegalArgumentException(
                        "Multi-resolution input size "
                                + inputConfig.getWidth()
                                + "x"
                                + inputConfig.getHeight()
                                + " is not valid");
            }
            return;
        }
        if (!checkInputConfigurationWithStreamConfigurations(inputConfig, false)
                && !checkInputConfigurationWithStreamConfigurations(inputConfig, true)) {
            throw new IllegalArgumentException(
                    "Input config with format "
                            + inputFormat
                            + " and size "
                            + inputConfig.getWidth()
                            + "x"
                            + inputConfig.getHeight()
                            + " not supported by camera id "
                            + this.mCameraId);
        }
    }

    public abstract static class StateCallbackKK extends CameraDevice.StateCallback {
    ...
    private void onCaptureErrorLocked(int errorCode, CaptureResultExtras resultExtras) {
        ...
        if (errorCode == 5) {
            OutputConfiguration config =
                    this.mConfiguredOutputs.get(resultExtras.getErrorStreamId());
            if (config == null) {
                Log.v(
                        this.TAG,
                        String.format(
            ...
            for (final Surface surface : config.getSurfaces()) {
                if (request.containsTarget(surface)) {
                    Runnable failureDispatch = new Runnable() { // from class:
                                // android.hardware.camera2.impl.CameraDeviceImpl.12
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (!CameraDeviceImpl.this.isClosed()) {
                                        holder.getCallback()
        ...
        Runnable failureDispatch2 =
                new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.13
                    @Override // java.lang.Runnable
                    public void run() {
                        if (!CameraDeviceImpl.this.isClosed()) {
                            holder.getCallback()
                                    .onCaptureFailed(CameraDeviceImpl.this, request, failure);
                        }
                    }
                };
        if (errorPhysicalCameraId == null) {
            if (this.mBatchOutputMap.containsKey(Integer.valueOf(requestId))) {
                ...
                while (i2 < this.mBatchOutputMap.get(Integer.valueOf(requestId)).intValue()) {
                    this.mFrameNumberTracker.updateTracker(
                            frameNumber - (subsequenceId - i2), true, request.getRequestType());
                    i2++;
                    failure = failure;
                }
            } else {
    ...
    public class CameraDeviceCallbacks extends ICameraDeviceCallbacks.Stub {
        ...
        public void onRepeatingRequestError(long lastFrameNumber, int repeatingRequestId) {
            synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                if (CameraDeviceImpl.this.mRemoteDevice != null
                    ...
                    if (CameraDeviceImpl.this.mOfflineSessionImpl != null) {
                        CameraDeviceImpl.this
                                .mOfflineSessionImpl
                                .getCallbacks()
                                .onRepeatingRequestError(lastFrameNumber, repeatingRequestId);
                        return;
                    }
                    CameraDeviceImpl.this.checkEarlyTriggerSequenceCompleteLocked(
                            CameraDeviceImpl.this.mRepeatingRequestId,
                            lastFrameNumber,
                            CameraDeviceImpl.this.mRepeatingRequestTypes);
                ...
                if (CameraDeviceImpl.this.mFailedRepeatingRequestId == repeatingRequestId
                        && CameraDeviceImpl.this.mFailedRepeatingRequestTypes != null
                        && CameraDeviceImpl.this.mRemoteDevice != null) {
                    Log.v(
                            CameraDeviceImpl.this.TAG,
                            "Resuming stop of failed repeating request with id: "
                                    + CameraDeviceImpl.this.mFailedRepeatingRequestId);
                    CameraDeviceImpl.this.checkEarlyTriggerSequenceCompleteLocked(
                            CameraDeviceImpl.this.mFailedRepeatingRequestId,
                            lastFrameNumber,
                            CameraDeviceImpl.this.mFailedRepeatingRequestTypes);
                    ...
                    try {
                        ...
                        if (CameraDeviceImpl.this.mOfflineSessionImpl == null) {
                            ...
                            try {
                                holder.getExecutor()
                                        .execute(
                                                new Runnable() { // from class:
                                                    // android.hardware.camera2.impl.CameraDeviceImpl.CameraDeviceCallbacks.1
                                                    @Override // java.lang.Runnable
                                                    public void run() {
                                                        if (!CameraDeviceImpl.this.isClosed()) {
                                                            int subsequenceId =
                        ...
                        try {
                            CameraDeviceImpl.this
                                    .mOfflineSessionImpl
                                    .getCallbacks()
                                    .onCaptureStarted(resultExtras, timestamp);
                        } catch (Throwable th3) {
                            th = th3;
                            throw th;
                        }
            ...
            synchronized (obj2) {
                try {
                    try {
                        ...
                        if (CameraDeviceImpl.this.mOfflineSessionImpl != null) {
                            try {
                                CameraDeviceImpl.this
                                        .mOfflineSessionImpl
                                        .getCallbacks()
                                        .onResultReceived(result, resultExtras, physicalResults);
                                return;
                            } catch (Throwable th) {
                                th = th;
                                obj = obj2;
                        ...
                        final CaptureCallbackHolder holder2 =
                                (CaptureCallbackHolder)
                                        CameraDeviceImpl.this.mCaptureCallbackMap.get(requestId2);
                        boolean isPartialResult =
                                resultExtras.getPartialResultCount()
                                        < CameraDeviceImpl.this.mTotalPartialCount;
                        if (holder2 == null) {
                            return;
                        }
                        final CaptureRequest request =
                                holder2.getRequest(resultExtras.getSubsequenceId());
                        int requestType = request.getRequestType();
                        if (CameraDeviceImpl.this.isClosed()) {
                            CameraDeviceImpl.this.updateTracker(
                                    requestId2, frameNumber2, requestType, null, isPartialResult);
                            return;
                        }
                        CameraMetadataNative resultCopy =
                                holder2.hasBatchedOutputs()
                                        ? new CameraMetadataNative(result)
                                        : null;
                        if (isPartialResult) {
                            final CaptureResult resultAsCapture2 =
                                    new CaptureResult(
                                            CameraDeviceImpl.this.getId(),
                                            result,
                                            request,
                                            resultExtras);
                            ...
                            final List<CaptureResult> partialResults =
                                    CameraDeviceImpl.this.mFrameNumberTracker.popPartialResults(
                                            frameNumber2);
                            if (CameraDeviceImpl.this.mBatchOutputMap.containsKey(
                                    Integer.valueOf(requestId2))) {
                                int requestCount =
                                        ((Integer)
                                                        CameraDeviceImpl.this.mBatchOutputMap.get(
                                                                Integer.valueOf(requestId2)))
                                                .intValue();
                                for (int i = 1; i < requestCount; i++) {
                                    CameraDeviceImpl.this.mFrameNumberTracker.popPartialResults(
                                            frameNumber2 - (requestCount - i));
                                }
                            }
                            final long sensorTimestamp =
                                    ((Long) result.get(CaptureResult.SENSOR_TIMESTAMP)).longValue();
                            final Range<Integer> fpsRange =
                                    (Range) request.get(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE);
        ...
        public void onPrepared(int streamId) {
            synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                ...
                OutputConfiguration output =
                        (OutputConfiguration)
                                CameraDeviceImpl.this.mConfiguredOutputs.get(streamId);
                ...
                if (output == null) {
                    Log.w(
                            CameraDeviceImpl.this.TAG,
                            "onPrepared invoked for unknown output Surface");
                    return;
                }
    ...
    public void binderDied() {
        ...
        this.mInError = true;
        Runnable r =
                new Runnable() { // from class: android.hardware.camera2.impl.CameraDeviceImpl.14
                    @Override // java.lang.Runnable
                    public void run() {
                        if (!CameraDeviceImpl.this.isClosed()) {
    ...
    public void createExtensionSession(ExtensionSessionConfiguration extensionConfiguration)
            throws CameraAccessException {
        HashMap<String, CameraCharacteristics> characteristicsMap =
                new HashMap<>(getPhysicalIdToChars());
        ...
        try {
            try {
                boolean ret =
                        CameraExtensionCharacteristics.registerClient(
                                this.mContext,
                                token,
                ...
                if (CameraExtensionCharacteristics.areAdvancedExtensionsSupported(
                        extensionConfiguration.getExtension())) {
                    this.mCurrentAdvancedExtensionSession =
                    ...
                    this.mCurrentExtensionSession =
                            CameraExtensionSessionImpl.createCameraExtensionSession(
                                    this,
                                    characteristicsMap,
                                    this.mContext,
                                    extensionConfiguration,
                ...
                if (0 != 0) {
                    CameraExtensionCharacteristics.unregisterClient(
                            this.mContext, token, extensionConfiguration.getExtension());
                }
            } catch (RemoteException e) {
    ...
    private List<OutputConfiguration> applyExtensionStreamOption(
            List<OutputConfiguration> outputs, CaptureRequest sessionParams) {
        CaptureRequest.Key<Integer> CONTROL_CAMERA_CLIENT =
                new CaptureRequest.Key<>(
                        "samsung.android.control.cameraClient", (Class<Integer>) Integer.class);
        ...
        for (OutputConfiguration outputConfiguration : outputs) {
            if (outputConfiguration.getSurfaceGroupId() != -1) {
                OutputConfiguration newConfiguration =
                ...
                newConfiguration.setReadoutTimestampEnabled(
