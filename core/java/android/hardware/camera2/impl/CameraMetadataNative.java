...
public class CameraMetadataNative implements Parcelable {
  ...
  public static final Parcelable.Creator<CameraMetadataNative> CREATOR =
      new Parcelable.Creator<
          CameraMetadataNative>() { // from class:
  ...
  private static synchronized native void nativeClose(long j);

  private static synchronized native void nativeDump(long j) throws IOException;

  private static synchronized native ArrayList nativeGetAllVendorKeys(long j, Class cls);

  private static synchronized native long nativeGetBufferSize(long j);

  private static synchronized native int nativeGetEntryCount(long j);

  @FastNative
  private static native int nativeGetTagFromKey(String str, long j) throws IllegalArgumentException;

  private static synchronized native int nativeGetTagFromKeyLocal(long j, String str)
      throws IllegalArgumentException;

  @FastNative
  private static native int nativeGetTypeFromTag(int i, long j) throws IllegalArgumentException;

  private static synchronized native int nativeGetTypeFromTagLocal(long j, int i)
      throws IllegalArgumentException;

  private static synchronized native boolean nativeIsEmpty(long j);

  private static synchronized native void nativeReadFromParcel(Parcel parcel, long j);

  private static synchronized native byte[] nativeReadValues(int i, long j);
  ...
  private static synchronized native void nativeSwap(long j, long j2) throws NullPointerException;

  @FastNative
  private static native void nativeUpdate(long j, long j2);

  private static synchronized native void nativeWriteToParcel(Parcel parcel, long j);

  private static synchronized native void nativeWriteValues(int i, byte[] bArr, long j);
  ...
  public static class Key<T> {
    ...
    public Key(String name, Class<T> type, long vendorId) {
      ...
      TypeReference<T> createSpecializedTypeReference =
          TypeReference.createSpecializedTypeReference((Class) type);
  ...
  static {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.2
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.3
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.4
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.5
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.6
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.7
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.8
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.9
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        CameraCharacteristics.SCALER_MANDATORY_MAXIMUM_RESOLUTION_STREAM_COMBINATIONS
            .getNativeKey(),
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.10
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.11
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        CameraCharacteristics.f114x783e32d9.getNativeKey(),
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.12
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        CameraCharacteristics.CONTROL_MAX_REGIONS_AE.getNativeKey(),
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.13
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        CameraCharacteristics.CONTROL_MAX_REGIONS_AWB.getNativeKey(),
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.14
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
            return (T) cameraMetadataNative.getMaxRegions(key);
          }
    ...
    hashMap.put(
        CameraCharacteristics.CONTROL_MAX_REGIONS_AF.getNativeKey(),
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.15
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
            return (T) cameraMetadataNative.getMaxRegions(key);
          }
    ...
    hashMap.put(
        CameraCharacteristics.REQUEST_MAX_NUM_OUTPUT_RAW.getNativeKey(),
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.16
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        CameraCharacteristics.REQUEST_MAX_NUM_OUTPUT_PROC.getNativeKey(),
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.17
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
            return (T) cameraMetadataNative.getMaxNumOutputs(key);
          }
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.18
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
            return (T) cameraMetadataNative.getMaxNumOutputs(key);
          }
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.19
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.20
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.21
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.22
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.23
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.24
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.25
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.26
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap.put(
        ...
        new GetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.27
          @Override // android.hardware.camera2.impl.GetCommand
          public <T> T getValue(CameraMetadataNative cameraMetadataNative, Key<T> key) {
    ...
    hashMap2.put(
        CameraCharacteristics.SCALER_AVAILABLE_FORMATS.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.28
          /* JADX WARN: Multi-variable type inference failed */
    ...
    hashMap2.put(
        CaptureResult.STATISTICS_FACE_RECTANGLES.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.29
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.SetCommand
          public <T> void setValue(CameraMetadataNative metadata, T t) {
    ...
    hashMap2.put(
        CaptureResult.STATISTICS_FACES.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.30
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.SetCommand
          public <T> void setValue(CameraMetadataNative metadata, T t) {
    ...
    hashMap2.put(
        CaptureRequest.TONEMAP_CURVE.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.31
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.SetCommand
          public <T> void setValue(CameraMetadataNative metadata, T t) {
    ...
    hashMap2.put(
        CaptureResult.JPEG_GPS_LOCATION.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.32
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.SetCommand
          public <T> void setValue(CameraMetadataNative metadata, T t) {
    ...
    hashMap2.put(
        ...
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.33
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.SetCommand
          public <T> void setValue(CameraMetadataNative metadata, T t) {
    ...
    hashMap2.put(
        CaptureRequest.CONTROL_AWB_REGIONS.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.34
          @Override // android.hardware.camera2.impl.SetCommand
    ...
    hashMap2.put(
        CaptureRequest.CONTROL_AF_REGIONS.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.35
          @Override // android.hardware.camera2.impl.SetCommand
          public <T> void setValue(CameraMetadataNative metadata, T value) {
    ...
    hashMap2.put(
        CaptureRequest.CONTROL_AE_REGIONS.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.36
          @Override // android.hardware.camera2.impl.SetCommand
          public <T> void setValue(CameraMetadataNative metadata, T value) {
    ...
    hashMap2.put(
        CaptureResult.STATISTICS_LENS_SHADING_CORRECTION_MAP.getNativeKey(),
        new SetCommand() { // from class: android.hardware.camera2.impl.CameraMetadataNative.37
          /* JADX WARN: Multi-variable type inference failed */
          @Override // android.hardware.camera2.impl.SetCommand
          public <T> void setValue(CameraMetadataNative metadata, T t) {
  ...
  private <T> T getBase(Key<T> key) {
    ...
    if (values == null
        && (((Key) key).mFallbackName == null
            || (values =
                    readValues(
                        (tag =
                            nativeGetTagFromKeyLocal(
                                this.mMetadataPtr, ((Key) key).mFallbackName))))
                == null)) {
      return null;
    }
  ...
  public boolean setFaces(Face[] faces) {
    ...
    for (Face face : faces) {
      if (face == null) {
        numFaces--;
        Log.m102w(TAG, "setFaces - null face detected, skipping");
    ...
    for (Face face2 : faces) {
      if (face2 != null) {
        ...
        if (fullMode) {
          ...
          int j = 0 + 1;
          faceLandmarks[(i * 6) + 0] = face2.getLeftEyePosition().f85x;
          int j2 = j + 1;
          faceLandmarks[(i * 6) + j] = face2.getLeftEyePosition().f86y;
          int j3 = j2 + 1;
          faceLandmarks[(i * 6) + j2] = face2.getRightEyePosition().f85x;
          int j4 = j3 + 1;
          faceLandmarks[(i * 6) + j3] = face2.getRightEyePosition().f86y;
          int j5 = j4 + 1;
          faceLandmarks[(i * 6) + j4] = face2.getMouthPosition().f85x;
          int i2 = j5 + 1;
          faceLandmarks[(i * 6) + j5] = face2.getMouthPosition().f86y;
        }
        i++;
      }
    }
    set(
        (CaptureResult.Key<CaptureResult.Key<Rect[]>>) CaptureResult.STATISTICS_FACE_RECTANGLES,
        (CaptureResult.Key<Rect[]>) faceRectangles);
    set(
        (CaptureResult.Key<CaptureResult.Key<int[]>>) CaptureResult.STATISTICS_FACE_IDS,
        (CaptureResult.Key<int[]>) faceIds);
    set(
        (CaptureResult.Key<CaptureResult.Key<int[]>>) CaptureResult.STATISTICS_FACE_LANDMARKS,
        (CaptureResult.Key<int[]>) faceLandmarks);
    set(
        (CaptureResult.Key<CaptureResult.Key<byte[]>>) CaptureResult.STATISTICS_FACE_SCORES,
        (CaptureResult.Key<byte[]>) faceScores);
    return true;
  }
  ...
  public Face[] getFaces() {
    ...
    if (faceDetectMode == null) {
      Log.m102w(TAG, "Face detect mode metadata is null, assuming the mode is SIMPLE");
      faceDetectMode = 1;
      ...
      if (faceDetectMode.intValue() != 1 && faceDetectMode.intValue() != 2) {
        Log.m102w(TAG, "Unknown face detect mode: " + faceDetectMode);
        return new Face[0];
      }
    }
    if (faceScores == null || faceRectangles == null) {
      Log.m102w(TAG, "Expect face scores and rectangles to be non-null");
      return new Face[0];
    }
    if (faceScores.length != faceRectangles.length) {
      Log.m102w(
          TAG,
          String.format(
              "Face score size(%d) doesn match face rectangle size(%d)!",
              Integer.valueOf(faceScores.length), Integer.valueOf(faceRectangles.length)));
    }
    ...
    if (faceDetectMode.intValue() == 2) {
      if (faceIds == null || faceLandmarks == null) {
        Log.m102w(
            TAG,
            "Expect face ids and landmarks to be non-null for FULL mode,fallback to SIMPLE mode");
        faceDetectMode = 1;
      } else {
        if (faceIds.length != numFaces || faceLandmarks.length != numFaces * 6) {
          Log.m102w(
              TAG,
              String.format(
                  "Face id size(%d), or face landmark size(%d) don'tmatch face number(%d)!",
                  Integer.valueOf(faceIds.length),
                  Integer.valueOf(faceLandmarks.length * 6),
                  Integer.valueOf(numFaces)));
        }
        numFaces = Math.min(Math.min(numFaces, faceIds.length), faceLandmarks.length / 6);
      }
    } else if (faceDetectMode.intValue() == 101) {
      if (faceIds == null) {
        Log.m102w(TAG, "Expect face ids to be non-null for TRACKING mode,fallback to SIMPLE mode");
        faceDetectMode = 1;
      } else {
        if (faceIds.length != numFaces) {
          Log.m102w(
              TAG,
              String.format(
                  "Face id size(%d) don't match face number(%d)!",
                  Integer.valueOf(faceIds.length), Integer.valueOf(numFaces)));
        }
    ...
    if (faceDetectMode.intValue() == 1) {
      ...
      for (int i3 = 0; i3 < numFaces; i3++) {
        if (faceScores[i3] <= 100 && faceScores[i3] >= 1 && faceIds[i3] >= 0) {
          ...
          Face face2 =
              new Face(faceRectangles[i3], faceScores[i3], faceIds[i3], leftEye, rightEye, mouth);
          faceList.add(face2);
        }
      }
    }
  ...
  public boolean setLensShadingMap(LensShadingMap lensShadingMap) {
    ...
    setBase(
        (CaptureResult.Key<CaptureResult.Key<float[]>>) CaptureResult.STATISTICS_LENS_SHADING_MAP,
        (CaptureResult.Key<float[]>) lsmArray);
    ...
    setBase(
        ...
        (CameraCharacteristics.Key<Size>) s);
    return true;
  }
  ...
  public LensShadingMap getLensShadingMap() {
    ...
    if (s == null) {
      Log.m102w(TAG, "getLensShadingMap - Lens shading map size was null.");
      return null;
    }
  ...
  public DynamicRangeProfiles getDynamicRangeProfiles() {
    long[] profileArray =
        (long[]) getBase(CameraCharacteristics.REQUEST_AVAILABLE_DYNAMIC_RANGE_PROFILES_MAP);
  ...
  public Location getGpsLocation() {
    ...
    if (timeStamp == null) {
      Log.m102w(TAG, "getGpsLocation - No timestamp for GPS location.");
    } else {
      l.setTime(timeStamp.longValue() * 1000);
    }
    if (coords == null) {
      Log.m102w(TAG, "getGpsLocation - No coordinates for GPS location");
    } else {
  ...
  public boolean setGpsLocation(Location l) {
    if (l == null) {
      setBase(
          (CaptureRequest.Key<CaptureRequest.Key<Long>>) CaptureRequest.JPEG_GPS_TIMESTAMP,
          (CaptureRequest.Key<Long>) null);
      setBase(
          (CaptureRequest.Key<CaptureRequest.Key<double[]>>) CaptureRequest.JPEG_GPS_COORDINATES,
          (CaptureRequest.Key<double[]>) null);
      setBase(
          (CaptureRequest.Key<CaptureRequest.Key<String>>)
              CaptureRequest.JPEG_GPS_PROCESSING_METHOD,
          (CaptureRequest.Key<String>) null);
      return false;
    }
    ...
    set(
        (CaptureRequest.Key<CaptureRequest.Key<Long>>) CaptureRequest.JPEG_GPS_TIMESTAMP,
        (CaptureRequest.Key<Long>) Long.valueOf(timestamp));
    set(
        (CaptureRequest.Key<CaptureRequest.Key<double[]>>) CaptureRequest.JPEG_GPS_COORDINATES,
        (CaptureRequest.Key<double[]>) coords);
    if (processMethod == null) {
      Log.m102w(
          TAG, "setGpsLocation - No process method, Location is not from a GPS or NETWORKprovider");
    } else {
      setBase(
          (CaptureRequest.Key<CaptureRequest.Key<String>>)
              CaptureRequest.JPEG_GPS_PROCESSING_METHOD,
          (CaptureRequest.Key<String>) processMethod);
    }
    return true;
  }

  private void parseRecommendedConfigurations(
    ...
    while (i3 < publicFormat3) {
      ...
      int publicFormat4 =
          isDepth
              ? StreamConfigurationMap.depthFormatToPublic(internalFormat2)
              : StreamConfigurationMap.imageFormatToPublic(internalFormat2);
      Size sz2 = new Size(width2, height2);
      int usecaseBitmap2 = c.getUsecaseBitmap();
      if (!c.isInput()) {
        StreamConfiguration streamConfiguration =
            new StreamConfiguration(internalFormat2, width2, height2, z);
        ...
        if (minFrameDuration <= 0) {
          ...
          width = width2;
          height = height2;
          StreamConfigurationDuration minDurationConfiguration3 =
              new StreamConfigurationDuration(internalFormat2, width2, height2, minFrameDuration);
        ...
        if (stallDuration <= 0) {
          ...
          minDurationConfiguration2 = minDurationConfiguration;
          StreamConfigurationDuration stallDurationConfiguration2 =
              new StreamConfigurationDuration(internalFormat, width, height, stallDuration);
        ...
        if (usecaseBitmap2 != 16) {
          throw new IllegalArgumentException(
              "Recommended input stream configurations should only be advertised in the ZSL use"
                  + " case!");
        }
  ...
  public void initializeStreamConfigurationData(
      ArrayList<StreamConfiguration> sc,
      ArrayList<StreamConfigurationDuration> scd,
      ArrayList<StreamConfigurationDuration> scs,
      StreamConfigurationData scData) {
    if (scData == null || sc == null) {
      return;
    }
    scData.streamConfigurationArray = new StreamConfiguration[sc.size()];
    scData.streamConfigurationArray =
        (StreamConfiguration[]) sc.toArray(scData.streamConfigurationArray);
    if (scd != null && !scd.isEmpty()) {
      scData.minDurationArray = new StreamConfigurationDuration[scd.size()];
      scData.minDurationArray =
          (StreamConfigurationDuration[]) scd.toArray(scData.minDurationArray);
    } else {
    ...
    if (scs != null && !scs.isEmpty()) {
      ...
      scData.stallDurationArray =
          (StreamConfigurationDuration[]) scs.toArray(scData.stallDurationArray);
    } else {
  ...
  public ArrayList<RecommendedStreamConfigurationMap> getRecommendedStreamConfigurations() {
    ...
    RecommendedStreamConfiguration[] configurations =
        (RecommendedStreamConfiguration[])
            getBase(CameraCharacteristics.SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS);
    RecommendedStreamConfiguration[] depthConfigurations =
        (RecommendedStreamConfiguration[])
            getBase(CameraCharacteristics.DEPTH_AVAILABLE_RECOMMENDED_DEPTH_STREAM_CONFIGURATIONS);
    ...
    if (configurations != null) {
      ...
      try {
        ...
        Log.m96e(str, "Failed parsing the recommended stream configurations!");
        return null;
      }
    } else {
      str = TAG;
    ...
    if (depthConfigurations == null) {
      ...
      try {
        parseRecommendedConfigurations(
            ...
            fullMap,
            true,
            depthStreamConfigList2,
            depthStreamDurationList2,
            depthStreamStallList,
            null);
      } catch (IllegalArgumentException e2) {
        Log.m96e(str, "Failed parsing the recommended depth stream configurations!");
        return null;
      }
    }
    ReprocessFormatsMap inputOutputFormatsMap =
        (ReprocessFormatsMap)
            getBase(CameraCharacteristics.SCALER_AVAILABLE_RECOMMENDED_INPUT_OUTPUT_FORMATS_MAP);
    ...
    for (int i2 = 32; i < i2; i2 = 32) {
      ...
      if (configurations == null) {
        ...
        streamDurationList2 = streamDurationList;
        streamStallList2 = streamStallList;
        initializeStreamConfigurationData(
            streamConfigList.get(i), streamDurationList2.get(i), streamStallList2.get(i), scData);
      }
      ...
      if (depthConfigurations == null) {
        ...
        initializeStreamConfigurationData(
            ...
            depthStreamDurationList.get(i),
            depthStreamStallList.get(i),
            depthScData);
      }
      if ((scData.streamConfigurationArray == null || scData.streamConfigurationArray.length == 0)
          ...
          default:
            map =
                new StreamConfigurationMap(
                    ...
                    scData.minDurationArray,
                    scData.stallDurationArray,
                    depthScData.streamConfigurationArray,
                    depthScData.minDurationArray,
        ...
        recommendedConfigurations.add(
            new RecommendedStreamConfigurationMap(map, i, supportsPrivate[i]));
      }
      i++;
  ...
  private boolean isPreviewStabilizationSupported() {
    int[] videoStabilizationModes =
        (int[]) getBase(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES);
  ...
  private boolean isCroppedRawSupported() {
    long[] streamUseCases =
        (long[]) getBase(CameraCharacteristics.SCALER_AVAILABLE_STREAM_USE_CASES);
  ...
  private MandatoryStreamCombination[] getMandatoryStreamCombinationsHelper(
    ...
    int hwLevel =
        ((Integer) getBase(CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL)).intValue();
    MandatoryStreamCombination.Builder build =
        new MandatoryStreamCombination.Builder(
            this.mCameraId,
            hwLevel,
            this.mDisplaySize,
            caps,
  ...
  public StreamConfigurationMap getStreamConfigurationMap() {
    ...
    StreamConfigurationDuration[] stallDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.SCALER_AVAILABLE_STALL_DURATIONS);
    ...
    StreamConfigurationDuration[] depthStallDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.DEPTH_AVAILABLE_DEPTH_STALL_DURATIONS);
    StreamConfiguration[] dynamicDepthConfigurations =
        (StreamConfiguration[])
            getBase(CameraCharacteristics.DEPTH_AVAILABLE_DYNAMIC_DEPTH_STREAM_CONFIGURATIONS);
    StreamConfigurationDuration[] dynamicDepthMinFrameDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.DEPTH_AVAILABLE_DYNAMIC_DEPTH_MIN_FRAME_DURATIONS);
    ...
    StreamConfiguration[] heicConfigurations =
        (StreamConfiguration[])
            getBase(CameraCharacteristics.HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS);
    StreamConfigurationDuration[] heicMinFrameDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.HEIC_AVAILABLE_HEIC_MIN_FRAME_DURATIONS);
    StreamConfigurationDuration[] heicStallDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.HEIC_AVAILABLE_HEIC_STALL_DURATIONS);
    StreamConfiguration[] jpegRConfigurations =
        (StreamConfiguration[])
            getBase(CameraCharacteristics.JPEGR_AVAILABLE_JPEG_R_STREAM_CONFIGURATIONS);
    StreamConfigurationDuration[] jpegRMinFrameDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.JPEGR_AVAILABLE_JPEG_R_MIN_FRAME_DURATIONS);
    StreamConfigurationDuration[] jpegRStallDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.JPEGR_AVAILABLE_JPEG_R_STALL_DURATIONS);
    HighSpeedVideoConfiguration[] highSpeedVideoConfigurations =
        (HighSpeedVideoConfiguration[])
            getBase(CameraCharacteristics.CONTROL_AVAILABLE_HIGH_SPEED_VIDEO_CONFIGURATIONS);
    ReprocessFormatsMap inputOutputFormatsMap =
  ...
  public StreamConfigurationMap getStreamConfigurationMapMaximumResolution() {
    ...
    StreamConfigurationDuration[] minFrameDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.SCALER_AVAILABLE_MIN_FRAME_DURATIONS_MAXIMUM_RESOLUTION);
    StreamConfigurationDuration[] stallDurations =
        (StreamConfigurationDuration[])
            getBase(CameraCharacteristics.SCALER_AVAILABLE_STALL_DURATIONS_MAXIMUM_RESOLUTION);
    if (configurations != null && minFrameDurations != null && stallDurations != null) {
      ...
      StreamConfiguration[] dynamicDepthConfigurations =
          (StreamConfiguration[]) getBase(CameraCharacteristics.f113x6f2fa73c);
      StreamConfigurationDuration[] dynamicDepthMinFrameDurations =
          (StreamConfigurationDuration[]) getBase(CameraCharacteristics.f112x51945058);
      StreamConfigurationDuration[] dynamicDepthStallDurations =
          (StreamConfigurationDuration[])
              getBase(
                  CameraCharacteristics
      ...
      StreamConfigurationDuration[] heicStallDurations =
          (StreamConfigurationDuration[])
              getBase(CameraCharacteristics.HEIC_AVAILABLE_HEIC_STALL_DURATIONS_MAXIMUM_RESOLUTION);
      StreamConfiguration[] jpegRConfigurations =
          (StreamConfiguration[])
              getBase(
                  CameraCharacteristics
      ...
      StreamConfigurationDuration[] jpegRMinFrameDurations =
          (StreamConfigurationDuration[])
              getBase(
                  CameraCharacteristics
                      .JPEGR_AVAILABLE_JPEG_R_MIN_FRAME_DURATIONS_MAXIMUM_RESOLUTION);
      StreamConfigurationDuration[] jpegRStallDurations =
          (StreamConfigurationDuration[])
              getBase(
                  CameraCharacteristics.JPEGR_AVAILABLE_JPEG_R_STALL_DURATIONS_MAXIMUM_RESOLUTION);
      HighSpeedVideoConfiguration[] highSpeedVideoConfigurations =
          (HighSpeedVideoConfiguration[]) getBase(CameraCharacteristics.f111xa18493cc);
      ReprocessFormatsMap inputOutputFormatsMap =
          (ReprocessFormatsMap)
              getBase(
                  CameraCharacteristics
  ...
  public <T> TonemapCurve getTonemapCurve() {
    ...
    if (red == null || green == null || blue == null) {
      Log.m102w(TAG, "getTonemapCurve - missing tone curve components");
      return null;
    }
  ...
  public OisSample[] getOisSamples() {
    ...
    if (xShifts.length != timestamps.length) {
      throw new AssertionError(
          String.format(
              "timestamps has %d entries but xShifts has %d",
              Integer.valueOf(timestamps.length), Integer.valueOf(xShifts.length)));
    }
    if (yShifts.length != timestamps.length) {
      throw new AssertionError(
          String.format(
              "timestamps has %d entries but yShifts has %d",
              Integer.valueOf(timestamps.length), Integer.valueOf(yShifts.length)));
    }
  ...
  public Capability[] getExtendedSceneModeCapabilities() {
    ...
    int i;
    int[] maxSizes2 =
        (int[]) getBase(CameraCharacteristics.CONTROL_AVAILABLE_EXTENDED_SCENE_MODE_MAX_SIZES);
    float[] zoomRanges2 =
        (float[])
            getBase(CameraCharacteristics.CONTROL_AVAILABLE_EXTENDED_SCENE_MODE_ZOOM_RATIO_RANGES);
    Range<Float> zoomRange2 = (Range) getBase(CameraCharacteristics.CONTROL_ZOOM_RATIO_RANGE);
    float maxDigitalZoom =
        ((Float) getBase(CameraCharacteristics.SCALER_AVAILABLE_MAX_DIGITAL_ZOOM)).floatValue();
    if (maxSizes2 == null) {
      return null;
    }
    if (maxSizes2.length % 3 != 0) {
      throw new AssertionError(
          "availableExtendedSceneModeMaxSizes must be tuples of [mode, width, height]");
    }
    ...
    if (zoomRanges2 != null) {
      if (zoomRanges2.length % 2 != 0) {
        throw new AssertionError(
            "availableExtendedSceneModeZoomRanges must be tuples of [minZoom, maxZoom]");
      }
      numExtendedSceneModeZoomRanges = zoomRanges2.length / 2;
      if (numExtendedSceneModes - numExtendedSceneModeZoomRanges != 1) {
        throw new AssertionError(
            "Number of extended scene mode zoom ranges must be 1 less than number of supported"
                + " modes");
      }
    }
      ...
      if (mode == 0 || j >= numExtendedSceneModeZoomRanges) {
        ...
        capabilities[i3] =
            new Capability(
                ...
                new Range(Float.valueOf(modeOffMinZoomRatio), Float.valueOf(modeOffMaxZoomRatio)));
      } else {
        maxSizes = maxSizes2;
        zoomRange = zoomRange2;
        i = 1;
        ...
        capabilities[i3] =
            new Capability(
                ...
                new Size(width, height),
                new Range(
                    Float.valueOf(zoomRanges2[j * 2]), Float.valueOf(zoomRanges2[(j * 2) + 1])));
        j++;
      }
      i3++;
      i2 = i;
  ...
  public boolean setAvailableFormats(int[] value) {
    ...
    setBase(
        ...
        (CameraCharacteristics.Key<int[]>) newValues);
    return true;
  }
  ...
  public boolean setFaceRectangles(Rect[] faceRects) {
    ...
    setBase(
        (CaptureResult.Key<CaptureResult.Key<Rect[]>>) CaptureResult.STATISTICS_FACE_RECTANGLES,
        (CaptureResult.Key<Rect[]>) newFaceRects);
    return true;
  }
  ...
  public <T> boolean setTonemapCurve(TonemapCurve tc) {
    ...
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<float[]>>) CaptureRequest.TONEMAP_CURVE_RED,
        (CaptureRequest.Key<float[]>) curve[0]);
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<float[]>>) CaptureRequest.TONEMAP_CURVE_GREEN,
        (CaptureRequest.Key<float[]>) curve[1]);
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<float[]>>) CaptureRequest.TONEMAP_CURVE_BLUE,
        (CaptureRequest.Key<float[]>) curve[2]);
    return true;
  }
  ...
  public <T> boolean setScalerCropRegion(Rect cropRegion) {
    ...
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<Boolean>>) CaptureRequest.SCALER_CROP_REGION_SET,
        (CaptureRequest.Key<Boolean>) true);
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<Rect>>) CaptureRequest.SCALER_CROP_REGION,
        (CaptureRequest.Key<Rect>) cropRegion);
    return true;
  }
  ...
  public <T> boolean setAFRegions(T afRegions) {
    ...
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<Boolean>>) CaptureRequest.CONTROL_AF_REGIONS_SET,
        (CaptureRequest.Key<Boolean>) true);
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<MeteringRectangle[]>>)
            CaptureRequest.CONTROL_AF_REGIONS,
        (CaptureRequest.Key<MeteringRectangle[]>) afRegions);
    return true;
  }
  ...
  public <T> boolean setAERegions(T aeRegions) {
    ...
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<Boolean>>) CaptureRequest.CONTROL_AE_REGIONS_SET,
        (CaptureRequest.Key<Boolean>) true);
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<MeteringRectangle[]>>)
            CaptureRequest.CONTROL_AE_REGIONS,
        (CaptureRequest.Key<MeteringRectangle[]>) aeRegions);
    return true;
  }
  ...
  public <T> boolean setAWBRegions(T awbRegions) {
    ...
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<Boolean>>) CaptureRequest.CONTROL_AWB_REGIONS_SET,
        (CaptureRequest.Key<Boolean>) true);
    setBase(
        (CaptureRequest.Key<CaptureRequest.Key<MeteringRectangle[]>>)
            CaptureRequest.CONTROL_AWB_REGIONS,
        (CaptureRequest.Key<MeteringRectangle[]>) awbRegions);
    return true;
  }
  ...
  public void setMultiResolutionStreamConfigurationMap(
      Map<String, StreamConfiguration[]> multiResolutionMap) {
    this.mMultiResolutionStreamConfigurationMap =
