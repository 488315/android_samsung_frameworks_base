...
public abstract class CaptureCallback {
  ...
  public abstract void onCaptureBufferLost(
      CameraDevice cameraDevice, CaptureRequest captureRequest, Surface surface, long j);
  ...
  public abstract void onCaptureFailed(
      CameraDevice cameraDevice, CaptureRequest captureRequest, CaptureFailure captureFailure);

  public abstract void onCapturePartial(
      CameraDevice cameraDevice, CaptureRequest captureRequest, CaptureResult captureResult);

  public abstract void onCaptureProgressed(
      CameraDevice cameraDevice, CaptureRequest captureRequest, CaptureResult captureResult);
  ...
  public abstract void onCaptureStarted(
      CameraDevice cameraDevice, CaptureRequest captureRequest, long j, long j2);

  public abstract void onReadoutStarted(
      CameraDevice cameraDevice, CaptureRequest captureRequest, long j, long j2);
