    ...
    public static class SessionStateCallbackProxy extends CameraCaptureSession.StateCallback {
            ...
            try {
                this.mExecutor.execute(
                        new Runnable() { // from class:
                            // android.hardware.camera2.impl.CallbackProxies$SessionStateCallbackProxy$$ExternalSyntheticLambda5
                            @Override // java.lang.Runnable
                            public final void run() {
                                CallbackProxies.SessionStateCallbackProxy.this
                                        .lambda$onConfigured$0(session);
                            }
                        });
            } finally {
        ...
        public void onConfigureFailed(final CameraCaptureSession session) {
            ...
            try {
                this.mExecutor.execute(
                        new Runnable() { // from class:
                            // android.hardware.camera2.impl.CallbackProxies$SessionStateCallbackProxy$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                CallbackProxies.SessionStateCallbackProxy.this
                                        .lambda$onConfigureFailed$1(session);
                            }
                        });
            } finally {
                Binder.restoreCallingIdentity(ident);
        ...
        public void onReady(final CameraCaptureSession session) {
            ...
            try {
                this.mExecutor.execute(
                        new Runnable() { // from class:
                            // android.hardware.camera2.impl.CallbackProxies$SessionStateCallbackProxy$$ExternalSyntheticLambda6
                            @Override // java.lang.Runnable
                            public final void run() {
                                CallbackProxies.SessionStateCallbackProxy.this.lambda$onReady$2(
                                        session);
                            }
                        });
            } finally {
        ...
        public void onActive(final CameraCaptureSession session) {
            ...
            try {
                this.mExecutor.execute(
                        new Runnable() { // from class:
                            // android.hardware.camera2.impl.CallbackProxies$SessionStateCallbackProxy$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                CallbackProxies.SessionStateCallbackProxy.this.lambda$onActive$3(
                                        session);
                            }
                        });
            } finally {
        ...
        public void onCaptureQueueEmpty(final CameraCaptureSession session) {
            ...
            try {
                this.mExecutor.execute(
                        new Runnable() { // from class:
                            // android.hardware.camera2.impl.CallbackProxies$SessionStateCallbackProxy$$ExternalSyntheticLambda3
                            @Override // java.lang.Runnable
                            public final void run() {
                                CallbackProxies.SessionStateCallbackProxy.this
                                        .lambda$onCaptureQueueEmpty$4(session);
                            }
                        });
            } finally {
                Binder.restoreCallingIdentity(ident);
        ...
        public void onClosed(final CameraCaptureSession session) {
            ...
            try {
                this.mExecutor.execute(
                        new Runnable() { // from class:
                            // android.hardware.camera2.impl.CallbackProxies$SessionStateCallbackProxy$$ExternalSyntheticLambda4
                            @Override // java.lang.Runnable
                            public final void run() {
                                CallbackProxies.SessionStateCallbackProxy.this.lambda$onClosed$5(
                                        session);
                            }
                        });
            } finally {
        ...
        public void onSurfacePrepared(final CameraCaptureSession session, final Surface surface) {
            ...
            try {
                this.mExecutor.execute(
                        new Runnable() { // from class:
                            // android.hardware.camera2.impl.CallbackProxies$SessionStateCallbackProxy$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                CallbackProxies.SessionStateCallbackProxy.this
                                        .lambda$onSurfacePrepared$6(session, surface);
                            }
                        });
            } finally {
                Binder.restoreCallingIdentity(ident);
