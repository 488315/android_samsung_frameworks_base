...
public class CaptureResult extends CameraMetadata<Key<?>> {
  ...
  public static final Key<Range<Integer>> CONTROL_AE_TARGET_FPS_RANGE =
      new Key<>(
          ...
          new TypeReference<
              Range<Integer>>() { // from class: android.hardware.camera2.CaptureResult.1
          });
  ...
  public static final Key<Pair<Float, Float>> LENS_FOCUS_RANGE =
      new Key<>(
          ...
          new TypeReference<
              Pair<Float, Float>>() { // from class: android.hardware.camera2.CaptureResult.2
          });
  ...
  public static final Key<Pair<Double, Double>[]> SENSOR_NOISE_PROFILE =
      new Key<>(
          ...
          new TypeReference<
              Pair<Double, Double>[]>() { // from class: android.hardware.camera2.CaptureResult.3
          });
