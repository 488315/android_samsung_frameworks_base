...
public class CaptureResult extends CameraMetadata<Key<?>> {
    ...
    public static final Key<Integer> CONTROL_AE_STATE =
            new Key<>("android.control.aeState", Integer.TYPE);
    ...
    public static final Key<Integer> CONTROL_AF_STATE =
            new Key<>("android.control.afState", Integer.TYPE);
    ...
    public static final Key<Integer> CONTROL_AWB_STATE =
            new Key<>("android.control.awbState", Integer.TYPE);
    ...
    public static final Key<Integer> CONTROL_AF_SCENE_CHANGE =
            new Key<>("android.control.afSceneChange", Integer.TYPE);
    ...
    public static final Key<Integer> CONTROL_AUTOFRAMING_STATE =
            new Key<>("android.control.autoframingState", Integer.TYPE);

    @PublicKey
    public static final Key<Integer> CONTROL_LOW_LIGHT_BOOST_STATE =
            new Key<>("android.control.lowLightBoostState", Integer.TYPE);
    ...
    public static final Key<Pair<Float, Float>> LENS_FOCUS_RANGE =
            new Key<>(
                    ...
                    new TypeReference<Pair<Float, Float>>() { // from class:
    ...
    public static final Key<float[]> LENS_POSE_ROTATION =
            new Key<>("android.lens.poseRotation", float[].class);

    @PublicKey
    public static final Key<float[]> LENS_POSE_TRANSLATION =
            new Key<>("android.lens.poseTranslation", float[].class);

    @PublicKey
    public static final Key<float[]> LENS_INTRINSIC_CALIBRATION =
            new Key<>("android.lens.intrinsicCalibration", float[].class);

    @PublicKey @Deprecated
    public static final Key<float[]> LENS_RADIAL_DISTORTION =
            new Key<>("android.lens.radialDistortion", float[].class);

    @PublicKey
    public static final Key<float[]> LENS_DISTORTION =
            new Key<>("android.lens.distortion", float[].class);
    ...
    public static final Key<Boolean> QUIRKS_PARTIAL_RESULT =
            new Key<>("android.quirks.partialResult", Boolean.TYPE);

    @Deprecated
    public static final Key<Integer> REQUEST_FRAME_COUNT =
            new Key<>("android.request.frameCount", Integer.TYPE);
    ...
    public static final Key<Byte> REQUEST_PIPELINE_DEPTH =
            new Key<>("android.request.pipelineDepth", Byte.TYPE);
    ...
    public static final Key<Rect> SCALER_RAW_CROP_REGION =
            new Key<>("android.scaler.rawCropRegion", Rect.class);
    ...
    public static final Key<Long> SENSOR_TIMESTAMP =
            new Key<>("android.sensor.timestamp", Long.TYPE);

    @PublicKey
    public static final Key<Rational[]> SENSOR_NEUTRAL_COLOR_POINT =
            new Key<>("android.sensor.neutralColorPoint", Rational[].class);
    ...
    public static final Key<Pair<Double, Double>[]> SENSOR_NOISE_PROFILE =
            new Key<>(
                    ...
                    new TypeReference<
                            Pair<Double, Double>
                                    []>() { // from class: android.hardware.camera2.CaptureResult.3
                    });

    @PublicKey
    public static final Key<Float> SENSOR_GREEN_SPLIT =
            new Key<>("android.sensor.greenSplit", Float.TYPE);
    ...
    public static final Key<Long> SENSOR_ROLLING_SHUTTER_SKEW =
            new Key<>("android.sensor.rollingShutterSkew", Long.TYPE);
    ...
    public static final Key<Integer> SENSOR_DYNAMIC_WHITE_LEVEL =
            new Key<>("android.sensor.dynamicWhiteLevel", Integer.TYPE);
    ...
    public static final Key<Boolean> SENSOR_RAW_BINNING_FACTOR_USED =
            new Key<>("android.sensor.rawBinningFactorUsed", Boolean.TYPE);
    ...
    public static final Key<int[]> STATISTICS_FACE_IDS =
            new Key<>("android.statistics.faceIds", int[].class);
    public static final Key<int[]> STATISTICS_FACE_LANDMARKS =
            new Key<>("android.statistics.faceLandmarks", int[].class);
    public static final Key<Rect[]> STATISTICS_FACE_RECTANGLES =
            new Key<>("android.statistics.faceRectangles", Rect[].class);
    public static final Key<byte[]> STATISTICS_FACE_SCORES =
            new Key<>("android.statistics.faceScores", byte[].class);

    @SyntheticKey @PublicKey
    public static final Key<Face[]> STATISTICS_FACES =
            new Key<>("android.statistics.faces", Face[].class);

    @PublicKey
    public static final Key<LensShadingMap> STATISTICS_LENS_SHADING_CORRECTION_MAP =
            new Key<>("android.statistics.lensShadingCorrectionMap", LensShadingMap.class);
    ...
    public static final Key<float[]> STATISTICS_PREDICTED_COLOR_GAINS =
            new Key<>("android.statistics.predictedColorGains", float[].class);

    @Deprecated
    public static final Key<Rational[]> STATISTICS_PREDICTED_COLOR_TRANSFORM =
            new Key<>("android.statistics.predictedColorTransform", Rational[].class);

    @PublicKey
    public static final Key<Integer> STATISTICS_SCENE_FLICKER =
            new Key<>("android.statistics.sceneFlicker", Integer.TYPE);
    ...
    public static final Key<Point[]> STATISTICS_HOT_PIXEL_MAP =
            new Key<>("android.statistics.hotPixelMap", Point[].class);
    ...
    public static final Key<long[]> STATISTICS_OIS_TIMESTAMPS =
            new Key<>("android.statistics.oisTimestamps", long[].class);
    public static final Key<float[]> STATISTICS_OIS_X_SHIFTS =
            new Key<>("android.statistics.oisXShifts", float[].class);
    public static final Key<float[]> STATISTICS_OIS_Y_SHIFTS =
            new Key<>("android.statistics.oisYShifts", float[].class);

    @SyntheticKey @PublicKey
    public static final Key<OisSample[]> STATISTICS_OIS_SAMPLES =
            new Key<>("android.statistics.oisSamples", OisSample[].class);

    @SyntheticKey @PublicKey
    public static final Key<LensIntrinsicsSample[]> STATISTICS_LENS_INTRINSICS_SAMPLES =
            new Key<>("android.statistics.lensIntrinsicsSamples", LensIntrinsicsSample[].class);

    public static final Key<long[]> STATISTICS_LENS_INTRINSIC_TIMESTAMPS =
            new Key<>("android.statistics.lensIntrinsicTimestamps", long[].class);
    public static final Key<float[]> STATISTICS_LENS_INTRINSIC_SAMPLES =
            new Key<>("android.statistics.lensIntrinsicSamples", float[].class);
    ...
    public static final Key<Long> SYNC_FRAME_NUMBER =
            new Key<>("android.sync.frameNumber", Long.TYPE);
    ...
    public static final Key<String> LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_ID =
            new Key<>("android.logicalMultiCamera.activePhysicalId", String.class);

    @PublicKey
    public static final Key<Rect> LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_SENSOR_CROP_REGION =
            new Key<>("android.logicalMultiCamera.activePhysicalSensorCropRegion", Rect.class);
    ...
    public static final Key<Integer> EXTENSION_CURRENT_TYPE =
            new Key<>("android.extension.currentType", Integer.TYPE);
    ...
    public static final Key<int[]> EFV_PADDING_REGION =
            new Key<>("android.efv.paddingRegion", int[].class);

    @ExtensionKey
    public static final Key<int[]> EFV_AUTO_ZOOM_PADDING_REGION =
            new Key<>("android.efv.autoZoomPaddingRegion", int[].class);

    @ExtensionKey
    public static final Key<PointF[]> EFV_TARGET_COORDINATES =
            new Key<>("android.efv.targetCoordinates", PointF[].class);
