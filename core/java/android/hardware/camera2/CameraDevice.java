...
public abstract class CameraDevice implements AutoCloseable {
    ...
    @SystemApi public static final int SESSION_OPERATION_MODE_CONSTRAINED_HIGH_SPEED = 1;

    @SystemApi public static final int SESSION_OPERATION_MODE_NORMAL = 0;

    @SystemApi public static final int SESSION_OPERATION_MODE_VENDOR_START = 32768;
    ...
    public abstract static class CameraDeviceSetup {
        ...
        public abstract CameraCharacteristics getSessionCharacteristics(
                SessionConfiguration sessionConfiguration) throws CameraAccessException;

        public abstract boolean isSessionConfigurationSupported(
                SessionConfiguration sessionConfiguration) throws CameraAccessException;

        public abstract void openCamera(Executor executor, StateCallback stateCallback)
                throws CameraAccessException;
    }
    ...
    @Deprecated
    public abstract void createCaptureSession(
            List<Surface> list, CameraCaptureSession.StateCallback stateCallback, Handler handler)
            throws CameraAccessException;

    @Deprecated
    public abstract void createCaptureSessionByOutputConfigurations(
            List<OutputConfiguration> list,
    ...
    public abstract CaptureRequest.Builder createReprocessCaptureRequest(
            TotalCaptureResult totalCaptureResult) throws CameraAccessException;
