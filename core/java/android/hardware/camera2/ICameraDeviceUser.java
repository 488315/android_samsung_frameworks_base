...
public interface ICameraDeviceUser extends IInterface {
  ...
  public static class Default implements ICameraDeviceUser {
    ...
    @Override // android.hardware.camera2.ICameraDeviceUser
    public void finalizeOutputConfigurations(int streamId, OutputConfiguration outputConfiguration)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 7:
              SessionConfiguration _arg05 =
                  (SessionConfiguration) data.readTypedObject(SessionConfiguration.CREATOR);
              data.enforceNoDataAvail();
