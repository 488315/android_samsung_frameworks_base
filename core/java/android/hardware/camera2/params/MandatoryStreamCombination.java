...
public final class MandatoryStreamCombination {
    ...
    private static StreamCombinationTemplate[] sConcurrentStreamCombinations = {
        ...
        new StreamCombinationTemplate(
                new StreamTemplate[] {
                    new StreamTemplate(35, SizeThreshold.s720p),
                    new StreamTemplate(35, SizeThreshold.s1440p)
                },
                "Two-input in app video / image processing"),
        new StreamCombinationTemplate(
                new StreamTemplate[] {
                    new StreamTemplate(34, SizeThreshold.s720p),
        ...
        new StreamCombinationTemplate(
                new StreamTemplate[] {
                    new StreamTemplate(34, SizeThreshold.s720p),
                    new StreamTemplate(256, SizeThreshold.s1440p)
                },
    ...
    private static StreamCombinationTemplate[] sStreamUseCaseCombinations = {
        new StreamCombinationTemplate(
                new StreamTemplate[] {new StreamTemplate(34, SizeThreshold.PREVIEW, 1)},
                "Simple preview"),
        new StreamCombinationTemplate(
    ...
    public static final class Builder {
        ...
        public Builder(
            ...
            this.mIsHiddenPhysicalCamera =
                    CameraManager.isHiddenPhysicalCamera(Integer.toString(this.mCameraId));
                    ...
                    if (s10Bit && template.mFormat == 54) {
                        ...
                        if (!sdrYuvSizes.equals(new HashSet(sizes))) {
                            Log.e(
                                    ...
                                    "The supported 10-bit YUV sizes are different from the"
                    ...
                    try {
                        ...
                        MandatoryStreamInformation streamInfo =
                                new MandatoryStreamInformation(
                                        sizes, i4, isMaximumSize, false, false, z);
                ...
                try {
                    MandatoryStreamCombination streamCombination =
                            new MandatoryStreamCombination(
                                    streamsInfo, combTemplate.mDescription, false);
                    ...
                    Log.e(
                            MandatoryStreamCombination.TAG,
                            "No stream information for mandatory combination: "
                                    + combTemplate.mDescription);
                    return null;
                }
            }
        ...
        public List<MandatoryStreamCombination>
            ...
            if (!this.mIsPreviewStabilizationSupported) {
                Log.v(
                        MandatoryStreamCombination.TAG,
                        "Device does not support preview stabilization");
                return null;
            }
        ...
        public List<MandatoryStreamCombination> getAvailableMandatoryStreamUseCaseCombinations() {
            ...
            if (this.mIsCroppedRawSupported) {
                availableStreamCombinations.ensureCapacity(
                        capacity
                                + MandatoryStreamCombination.sCroppedRawStreamUseCaseCombinations
                                        .length);
                availableTemplates.addAll(
                        Arrays.asList(
                                MandatoryStreamCombination.sCroppedRawStreamUseCaseCombinations));
        ...
        public List<MandatoryStreamCombination>
            ...
            while (i < length) {
                ...
                while (i2 < length2) {
                    ...
                    int i3 = length;
                    StreamCombinationTemplate[] chosenStreamCombinations4 =
                            chosenStreamCombinations;
                    Size sizeChosen =
                            getMinSize(
                                    formatSize,
                                    getMaxSize(
                                            this.mStreamConfigMap.getOutputSizes(
                                                    template.mFormat)));
        ...
        public List<MandatoryStreamCombination>
            ...
            chosenStreamCombinationTemplates.addAll(
                    Arrays.asList(
                            MandatoryStreamCombination.sUltraHighResolutionStreamCombinations));
            ArrayList<MandatoryStreamCombination> availableStreamCombinations = new ArrayList<>();
                ...
                remosaicSize =
                        0
                                + MandatoryStreamCombination
                                        .sUltraHighResolutionReprocStreamCombinations
                                        .length;
                chosenStreamCombinationTemplates.addAll(
                        Arrays.asList(
                                MandatoryStreamCombination
            ...
            if (maxResPRIVInputSizes != null && maxResPRIVInputSizes.length != 0) {
                ...
                chosenStreamCombinationTemplates.addAll(
                        Arrays.asList(
                                MandatoryStreamCombination
                                        .sUltraHighResolutionPRIVReprocStreamCombinations));
            }
            availableStreamCombinations.ensureCapacity(
        ...
        private MandatoryStreamCombination createUHSensorMandatoryStreamCombination(
            ...
            if (isReprocess) {
                ...
                if (combTemplate.mReprocessType == ReprocessType.PRIVATE) {
                    inputSize.add(
                            getMaxSize(
                                    builder.mStreamConfigMapMaximumResolution.getInputSizes(34)));
                    format = 34;
                } else if (combTemplate.mReprocessType == ReprocessType.REMOSAIC) {
                    inputSize.add(
                            getMaxSize(
                                    builder.mStreamConfigMapMaximumResolution.getInputSizes(32)));
                    format = 32;
                } else {
                    inputSize.add(
                            getMaxSize(
                                    builder.mStreamConfigMapMaximumResolution.getInputSizes(35)));
                    format = 35;
                }
                int i = format;
        ...
        public List<MandatoryStreamCombination> getAvailableMandatoryStreamCombinations() {
            ...
            if (isHardwareLevelAtLeastLegacy()) {
                availableTemplates.addAll(
                        Arrays.asList(MandatoryStreamCombination.sLegacyCombinations));
            }
            if (isHardwareLevelAtLeastLimited() || isExternalCamera()) {
                availableTemplates.addAll(
                        Arrays.asList(MandatoryStreamCombination.sLimitedCombinations));
                if (isPrivateReprocessingSupported()) {
                    availableTemplates.addAll(
                            Arrays.asList(
                                    MandatoryStreamCombination.sLimitedPrivateReprocCombinations));
                }
                if (isYUVReprocessingSupported()) {
                    availableTemplates.addAll(
                            Arrays.asList(
                                    MandatoryStreamCombination.sLimitedYUVReprocCombinations));
                }
            }
            if (isCapabilitySupported(6)) {
                availableTemplates.addAll(
                        Arrays.asList(MandatoryStreamCombination.sBurstCombinations));
            }
            if (isHardwareLevelAtLeastFull()) {
                availableTemplates.addAll(
                        Arrays.asList(MandatoryStreamCombination.sFullCombinations));
                if (isPrivateReprocessingSupported()) {
                    availableTemplates.addAll(
                            Arrays.asList(
                                    MandatoryStreamCombination.sFullPrivateReprocCombinations));
                }
                if (isYUVReprocessingSupported()) {
                    availableTemplates.addAll(
            ...
            if (isCapabilitySupported(3)) {
                availableTemplates.addAll(
                        Arrays.asList(MandatoryStreamCombination.sRawCombinations));
                if (isPrivateReprocessingSupported()) {
                    availableTemplates.addAll(
                            Arrays.asList(
                                    MandatoryStreamCombination.sRAWPrivateReprocCombinations));
                }
                if (isYUVReprocessingSupported()) {
                    availableTemplates.addAll(
            ...
            if (isHardwareLevelAtLeastLevel3()) {
                availableTemplates.addAll(
                        Arrays.asList(MandatoryStreamCombination.sLevel3Combinations));
                if (isPrivateReprocessingSupported()) {
                    availableTemplates.addAll(
                            Arrays.asList(
                                    MandatoryStreamCombination.sLevel3PrivateReprocCombinations));
                }
                if (isYUVReprocessingSupported()) {
                    availableTemplates.addAll(
            ...
            while (it.hasNext()) {
                ...
                for (int length = streamTemplateArr2.length; i2 < length; length = i) {
                    ...
                    try {
                        MandatoryStreamInformation streamInfo =
                                new MandatoryStreamInformation(
                                        sizes, template.mFormat, isMaximumSize);
                        streamsInfo.add(streamInfo);
                        i2++;
                        it = it2;
        ...
        private HashMap<Pair<SizeThreshold, Integer>, List<Size>> enumerateAvailableSizes() {
            ...
            if (previewSizes != null && !previewSizes.isEmpty()) {
                ...
                while (i < length) {
                    ...
                    Pair<SizeThreshold, Integer> pair2 =
                            new Pair<>(SizeThreshold.PREVIEW, intFormat2);
                    availableSizes.put(pair2, getSizesWithinBound(sizes2, previewMaxSize));
                    Pair<SizeThreshold, Integer> pair3 =
                            new Pair<>(SizeThreshold.RECORD, intFormat2);
                    availableSizes.put(pair3, getSizesWithinBound(sizes2, recordingMaxSize));
                    Pair<SizeThreshold, Integer> pair4 =
                            new Pair<>(SizeThreshold.MAXIMUM, intFormat2);
                    availableSizes.put(pair4, Arrays.asList(sizes2));
                    Pair<SizeThreshold, Integer> pair5 =
                            new Pair<>(SizeThreshold.s720p, intFormat2);
                    availableSizes.put(pair5, getSizesWithinBound(sizes2, s720pSize));
                    Pair<SizeThreshold, Integer> pair6 =
                            new Pair<>(SizeThreshold.s1440p, intFormat2);
