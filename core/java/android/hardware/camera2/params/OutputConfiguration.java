...
public final class OutputConfiguration implements Parcelable {
  ...
  public static final Parcelable.Creator<OutputConfiguration> CREATOR =
      new Parcelable.Creator<
          OutputConfiguration>() { // from class:
  ...
  public void setMultiResolutionOutput() {
    if (this.mIsShared) {
      throw new IllegalStateException(
          "Multi-resolution output flag must not be set for configuration with surface sharing");
    }
    if (this.mSurfaceGroupId == -1) {
      throw new IllegalStateException(
          "Multi-resolution output flag should only be set for surface with non-negative group ID");
    }
  ...
  public static Collection<OutputConfiguration> createInstancesForMultiResolutionOutput(
    ...
    for (int i2 = 0; i2 < imageReaders.length; i2++) {
      MultiResolutionStreamInfo streamInfo =
          multiResolutionImageReader.getStreamInfoForImageReader(imageReaders[i2]);
  ...
  public void removeSensorPixelModeUsed(int sensorPixelModeUsed) {
    if (!this.mSensorPixelModesUsed.remove(Integer.valueOf(sensorPixelModeUsed))) {
      throw new IllegalArgumentException(
          "sensorPixelMode " + sensorPixelModeUsed + "is not part of this output configuration");
    }
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (this.mRotation != other.mRotation
        ...
        || (i = this.mConfiguredFormat) != (i2 = other.mConfiguredFormat)
        || this.mSurfaceGroupId != other.mSurfaceGroupId
        || this.mSurfaceType != other.mSurfaceType
        || this.mIsDeferredConfig != other.mIsDeferredConfig
        || this.mIsShared != other.mIsShared
  ...
  public int hashCode() {
    if (this.mIsDeferredConfig) {
      ...
      fArr[10] = this.mDynamicRangeProfile;
      fArr[11] = this.mColorSpace;
      fArr[12] = this.mStreamUseCase;
    ...
    fArr2[11] = this.mDynamicRangeProfile;
    fArr2[12] = this.mColorSpace;
    fArr2[13] = this.mStreamUseCase;
