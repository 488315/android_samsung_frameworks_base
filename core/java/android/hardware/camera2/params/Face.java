...
public final class Face {
  ...
  public String toString() {
    return String.format(
        "{ bounds: %s, score: %s, id: %d, leftEyePosition: %s, rightEyePosition: %s, mouthPosition:"
            + " %s }",
        this.mBounds,
    ...
    if (leftEyePosition != null || rightEyePosition != null || mouthPosition != null) {
      if (leftEyePosition == null || rightEyePosition == null || mouthPosition == null) {
        throw new IllegalArgumentException(
            "If any of leftEyePosition, rightEyePosition, or mouthPosition are non-null, all three"
                + " must be non-null.");
      }
    }
  }
  ...
  public static final class Builder {
    ...
    public Face build() {
      ...
      return new Face(
          this.mBounds, this.mScore, this.mId, this.mLeftEye, this.mRightEye, this.mMouth);
    }
    ...
    private void checkIdUnsupportedThenNull(Object obj, String fieldName) {
      if (obj != null) {
        throw new IllegalArgumentException(
            "Field \"" + fieldName + "\" must be unset or null if id is ID_UNSUPPORTED.");
      }
    }
  }
}
