...
public final class MeteringRectangle {
    ...
    public MeteringRectangle(Rect rect, int meteringWeight) {
        ...
        this.f126mX = Preconditions.checkArgumentNonnegative(rect.left, "rect.left must be nonnegative");
    ...
    public boolean equals(MeteringRectangle other) {
        return other != null && this.f126mX == other.f126mX && this.f127mY == other.f127mY && this.mWidth == other.mWidth && this.mHeight == other.mHeight && this.mWeight == other.mWeight;
    }

    public int hashCode() {
        return HashCodeHelpers.hashCode(this.f126mX, this.f127mY, this.mWidth, this.mHeight, this.mWeight);
    }

    public String toString() {
        return String.format("(x:%d, y:%d, w:%d, h:%d, wt:%d)", Integer.valueOf(this.f126mX), Integer.valueOf(this.f127mY), Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mWeight));
    }
}
