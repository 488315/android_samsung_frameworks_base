...
public final class StreamConfigurationMap {
    ...
    if (configurations != null || depthConfigurations != null || heicConfigurations != null) {
      if (configurations == null) {
        ...
        this.mConfigurations =
            (StreamConfiguration[])
                Preconditions.checkArrayElementsNotNull(configurations, "configurations");
        this.mMinFrameDurations =
            (StreamConfigurationDuration[])
                Preconditions.checkArrayElementsNotNull(minFrameDurations, "minFrameDurations");
        this.mStallDurations =
            (StreamConfigurationDuration[])
                Preconditions.checkArrayElementsNotNull(stallDurations, "stallDurations");
      }
      ...
      if (depthConfigurations == null) {
        ...
        this.mDepthStallDurations =
            (StreamConfigurationDuration[])
                Preconditions.checkArrayElementsNotNull(depthStallDurations, "depthStallDurations");
      }
      ...
      if (heicConfigurations == null) {
        ...
        this.mHeicConfigurations =
            (StreamConfiguration[])
                Preconditions.checkArrayElementsNotNull(heicConfigurations, "heicConfigurations");
        ...
        this.mHeicStallDurations =
            (StreamConfigurationDuration[])
                Preconditions.checkArrayElementsNotNull(heicStallDurations, "heicStallDurations");
      }
      if (jpegRConfigurations == null) {
        ...
        this.mJpegRConfigurations =
            (StreamConfiguration[])
                Preconditions.checkArrayElementsNotNull(jpegRConfigurations, "jpegRConfigurations");
        ...
        this.mJpegRStallDurations =
            (StreamConfigurationDuration[])
                Preconditions.checkArrayElementsNotNull(jpegRStallDurations, "jpegRStallDurations");
      }
      ...
      while (i9 < length3) {
        ...
        if (!config2.isOutput()) {
          ...
          this.mDepthOutputFormats.put(
              config2.getFormat(), this.mDepthOutputFormats.get(config2.getFormat()) + 1);
        }
        i9++;
      ...
      while (i10 < length4) {
        ...
        if (!config3.isOutput()) {
          ...
          this.mDynamicDepthOutputFormats.put(
              config3.getFormat(), this.mDynamicDepthOutputFormats.get(config3.getFormat()) + 1);
        }
        i10++;
      ...
      while (i11 < length5) {
        ...
        if (!config4.isOutput()) {
          ...
          this.mHeicOutputFormats.put(
              config4.getFormat(), this.mHeicOutputFormats.get(config4.getFormat()) + 1);
        }
        i11++;
      ...
      while (i12 < length6) {
        ...
        if (!config5.isOutput()) {
          ...
          this.mJpegROutputFormats.put(
              config5.getFormat(), this.mJpegROutputFormats.get(config5.getFormat()) + 1);
        }
        i12++;
      ...
      while (i13 < length7) {
        ...
        this.mHighSpeedVideoSizeMap.put(
            size, Integer.valueOf((fpsRangeCount == null ? 0 : fpsRangeCount).intValue() + 1));
  ...
  public Size[] getHighSpeedVideoSizesFor(Range<Integer> fpsRange) {
    ...
    if (sizeCount == null || sizeCount.intValue() == 0) {
      throw new IllegalArgumentException(
          String.format("FpsRange %s does not support high speed video recording", fpsRange));
    }
  ...
  public boolean equals(Object obj) {
    ...
    if (!Arrays.equals(this.mConfigurations, other.mConfigurations)
        ...
        || !Arrays.equals(this.mDynamicDepthConfigurations, other.mDynamicDepthConfigurations)
        || !Arrays.equals(this.mDynamicDepthMinFrameDurations, other.mDynamicDepthMinFrameDurations)
        || !Arrays.equals(this.mDynamicDepthStallDurations, other.mDynamicDepthStallDurations)
  ...
  private Size[] getInternalFormatSizes(
    ...
    if ((output && dataspace != 4096 && dataspace != 4101 && dataspace != 4098 && dataspace != 4100)
        || sizesCount != 0) {
      if (output
          && dataspace != 4096
          && dataspace != 4101
    ...
    switch (duration) {
      case 0:
        ...
        return dataspace == 4100
            ? this.mHeicMinFrameDurations
            : dataspace == 4101 ? this.mJpegRMinFrameDurations : this.mMinFrameDurations;
      case 1:
        return dataspace == 4096
            ? this.mDepthStallDurations
            : dataspace == 4098
                ...
                : dataspace == 4100
                    ? this.mHeicStallDurations
                    : dataspace == 4101 ? this.mJpegRStallDurations : this.mStallDurations;
      default:
  ...
  private void appendValidOutputFormatsForInputString(StringBuilder sb) {
    ...
    for (int inputFormat : inputFormats) {
      sb.append(
          String.format(
              "[in:%s(%d), out:", formatToString(inputFormat), Integer.valueOf(inputFormat)));
      int[] outputFormats = getValidOutputFormatsForInput(inputFormat);
      for (int i = 0; i < outputFormats.length; i++) {
        sb.append(
            String.format(
                "%s(%d)", formatToString(outputFormats[i]), Integer.valueOf(outputFormats[i])));
