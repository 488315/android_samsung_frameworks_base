...
public final class Capability {
  ...
  public Capability(int mode, Size maxStreamingSize, Range<Float> zoomRatioRange) {
    ...
    Preconditions.checkArgumentPositive(
        zoomRatioRange.getLower().floatValue(), "zoomRatioRange.getLower() must be positive");
    Preconditions.checkArgumentPositive(
        zoomRatioRange.getUpper().floatValue(), "zoomRatioRange.getUpper() must be positive");
