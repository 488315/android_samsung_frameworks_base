...
public class CameraAccessException extends AndroidException {
  ...
  public static String getDefaultMessage(int problem) {
    switch (problem) {
      ...
      case 2:
        return "The camera device is removable and has been disconnected from the Android device,"
                   + " or the camera service has shut down the connection due to a higher-priority"
                   + " access request for the camera device.";
      case 3:
        return "The camera device is currently in the error state; no further calls to it will"
                   + " succeed.";
      case 4:
        return "The camera device is in use already";
      case 5:
        return "The system-wide limit for number of open cameras has been reached, and more camera"
                   + " devices cannot be opened until previous instances are closed.";
      default:
        return null;
    }
  }
