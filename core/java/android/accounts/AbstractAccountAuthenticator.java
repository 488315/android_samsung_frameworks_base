...
public abstract class AbstractAccountAuthenticator {
    ...
    private class Transport extends IAccountAuthenticator.Stub {
        ...
        public void addAccount(
            ...
            try {
                ...
                AbstractAccountAuthenticator.this.handleException(
                        response, "addAccount", accountType, e);
            }
        }
        ...
        public void getAuthTokenLabel(IAccountAuthenticatorResponse response, String authTokenType)
            ...
            if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
                Log.v(
                        AbstractAccountAuthenticator.TAG,
                        "getAuthTokenLabel: authTokenType " + authTokenType);
            }
            try {
        ...
        public void startUpdateCredentialsSession(
            ...
            try {
                ...
                if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
                    ...
                    Log.v(
                            AbstractAccountAuthenticator.TAG,
                            "startUpdateCredentialsSession: result "
                                    + AccountManager.sanitizeResult(result));
                }
                if (result != null) {
                    response.onResult(result);
        ...
        public void finishSession(
            ...
            if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
                Log.v(
                        AbstractAccountAuthenticator.TAG,
                        "finishSession: accountType " + accountType);
            }
            try {
                Bundle result =
    ...
    public Bundle getAccountCredentialsForCloning(
            final AccountAuthenticatorResponse response, Account account)
            throws NetworkErrorException {
        new Thread(
                        ...
                        new Runnable() { // from class:
                            ...
                            public void run() {
                                ...
                                sessionBundle.putString(
                                        AbstractAccountAuthenticator.KEY_AUTH_TOKEN_TYPE,
                                        authTokenType);
                                sessionBundle.putStringArray(
                                        AbstractAccountAuthenticator.KEY_REQUIRED_FEATURES,
                                        requiredFeatures);
                                sessionBundle.putBundle(
                                        AbstractAccountAuthenticator.KEY_OPTIONS, options);
                                Bundle result = new Bundle();
                                result.putBundle(
                                        AccountManager.KEY_ACCOUNT_SESSION_BUNDLE, sessionBundle);
                                response.onResult(result);
                            }
                        })
                .start();
                        ...
                        new Runnable() { // from class:
                            ...
                            public void run() {
                                ...
                                sessionBundle.putString(
                                        AbstractAccountAuthenticator.KEY_AUTH_TOKEN_TYPE,
                                        authTokenType);
                                sessionBundle.putParcelable(
                                        AbstractAccountAuthenticator.KEY_ACCOUNT, account);
                                sessionBundle.putBundle(
                                        AbstractAccountAuthenticator.KEY_OPTIONS, options);
                                Bundle result = new Bundle();
                                result.putBundle(
    ...
    public Bundle finishSession(
        ...
        return containsKeyAccount
                ...
                : addAccount(
                        response, accountType, authTokenType, requiredFeatures, sessionOptions);
    }
