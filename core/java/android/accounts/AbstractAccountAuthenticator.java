...
public abstract class AbstractAccountAuthenticator {
  ...
  public abstract Bundle editProperties(
      AccountAuthenticatorResponse accountAuthenticatorResponse, String str);
  ...
  public abstract Bundle hasFeatures(
      AccountAuthenticatorResponse accountAuthenticatorResponse, Account account, String[] strArr)
      throws NetworkErrorException;
  ...
  private class Transport extends IAccountAuthenticator.Stub {
    ...
    public void addAccount(
      ...
      if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
        Log.m100v(
            AbstractAccountAuthenticator.TAG,
            "addAccount: accountType "
                + accountType
                + ", authTokenType "
                + authTokenType
                + ", features "
                + (features == null ? "[]" : Arrays.toString(features)));
      }
      try {
        Bundle result =
        ...
        if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
          ...
          Log.m100v(
              AbstractAccountAuthenticator.TAG,
              "addAccount: result " + AccountManager.sanitizeResult(result));
        }
        if (result != null) {
    ...
    public void confirmCredentials(
      ...
      if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
        Log.m100v(AbstractAccountAuthenticator.TAG, "confirmCredentials: " + account);
      }
      try {
        Bundle result =
            AbstractAccountAuthenticator.this.confirmCredentials(
        ...
        if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
          ...
          Log.m100v(
              AbstractAccountAuthenticator.TAG,
              "confirmCredentials: result " + AccountManager.sanitizeResult(result));
        }
        if (result != null) {
          response.onResult(result);
        }
      } catch (Exception e) {
        AbstractAccountAuthenticator.this.handleException(
            response, "confirmCredentials", account.toString(), e);
      }
    }
    ...
    public void getAuthTokenLabel(IAccountAuthenticatorResponse response, String authTokenType)
      ...
      if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
        Log.m100v(
            AbstractAccountAuthenticator.TAG, "getAuthTokenLabel: authTokenType " + authTokenType);
      }
      try {
        ...
        if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
          ...
          Log.m100v(
              AbstractAccountAuthenticator.TAG,
              "getAuthTokenLabel: result " + AccountManager.sanitizeResult(result));
        }
        response.onResult(result);
      } catch (Exception e) {
        AbstractAccountAuthenticator.this.handleException(
            response, "getAuthTokenLabel", authTokenType, e);
      }
    }
    ...
    public void getAuthToken(
      ...
      if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
        Log.m100v(
            AbstractAccountAuthenticator.TAG,
            "getAuthToken: " + account + ", authTokenType " + authTokenType);
      }
      try {
        Bundle result =
        ...
        if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
          ...
          Log.m100v(
              AbstractAccountAuthenticator.TAG,
              "getAuthToken: result " + AccountManager.sanitizeResult(result));
        }
        if (result != null) {
          response.onResult(result);
        }
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "getAuthToken", account.toString() + "," + authTokenType, e);
      }
    }
    ...
    public void updateCredentials(
      ...
      if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
        Log.m100v(
            AbstractAccountAuthenticator.TAG,
            "updateCredentials: " + account + ", authTokenType " + authTokenType);
      }
      try {
        Bundle result =
            AbstractAccountAuthenticator.this.updateCredentials(
                new AccountAuthenticatorResponse(response), account, authTokenType, loginOptions);
        if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
          if (result != null) {
            result.keySet();
          ...
          Log.m100v(
              AbstractAccountAuthenticator.TAG,
              "updateCredentials: result " + AccountManager.sanitizeResult(result));
        }
        if (result != null) {
          response.onResult(result);
        }
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "updateCredentials", account.toString() + "," + authTokenType, e);
      }
    }
    ...
    public void editProperties(IAccountAuthenticatorResponse response, String accountType)
      ...
      try {
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "editProperties", accountType, e);
      }
    }
    ...
    public void hasFeatures(
      ...
      try {
        Bundle result =
            AbstractAccountAuthenticator.this.hasFeatures(
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "hasFeatures", account.toString(), e);
      }
    }
    ...
    public void getAccountRemovalAllowed(IAccountAuthenticatorResponse response, Account account)
      ...
      try {
        Bundle result =
            AbstractAccountAuthenticator.this.getAccountRemovalAllowed(
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "getAccountRemovalAllowed", account.toString(), e);
      }
    }
    ...
    public void getAccountCredentialsForCloning(
      ...
      try {
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "getAccountCredentialsForCloning", account.toString(), e);
      }
    }
    ...
    public void addAccountFromCredentials(
      ...
      try {
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "addAccountFromCredentials", account.toString(), e);
      }
    }
    ...
    public void startAddAccountSession(
      ...
      if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
        Log.m100v(
            AbstractAccountAuthenticator.TAG,
            "startAddAccountSession: accountType "
                + accountType
                + ", authTokenType "
                + authTokenType
                + ", features "
      ...
      try {
        Bundle result =
            AbstractAccountAuthenticator.this.startAddAccountSession(
                new AccountAuthenticatorResponse(response),
                accountType,
                authTokenType,
                features,
        ...
        if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
          ...
          Log.m100v(
              AbstractAccountAuthenticator.TAG,
              "startAddAccountSession: result " + AccountManager.sanitizeResult(result));
        }
        if (result != null) {
          response.onResult(result);
        }
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "startAddAccountSession", accountType, e);
      }
    }
    ...
    public void startUpdateCredentialsSession(
      ...
      if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
        Log.m100v(
            AbstractAccountAuthenticator.TAG,
            "startUpdateCredentialsSession: " + account + ", authTokenType " + authTokenType);
      }
      try {
        Bundle result =
            AbstractAccountAuthenticator.this.startUpdateCredentialsSession(
                new AccountAuthenticatorResponse(response), account, authTokenType, loginOptions);
        if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
          if (result != null) {
            result.keySet();
          ...
          Log.m100v(
              AbstractAccountAuthenticator.TAG,
              "startUpdateCredentialsSession: result " + AccountManager.sanitizeResult(result));
        }
        if (result != null) {
          response.onResult(result);
        }
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "startUpdateCredentialsSession", account.toString() + "," + authTokenType, e);
      }
    }
    ...
    public void finishSession(
      ...
      if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
        Log.m100v(AbstractAccountAuthenticator.TAG, "finishSession: accountType " + accountType);
      }
      try {
        Bundle result =
            AbstractAccountAuthenticator.this.finishSession(
        ...
        if (Log.isLoggable(AbstractAccountAuthenticator.TAG, 2)) {
          Log.m100v(
              AbstractAccountAuthenticator.TAG,
              "finishSession: result " + AccountManager.sanitizeResult(result));
        }
        if (result != null) {
          response.onResult(result);
        }
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "finishSession", accountType, e);
      }
    }
    ...
    public void isCredentialsUpdateSuggested(
      ...
      try {
        Bundle result =
            AbstractAccountAuthenticator.this.isCredentialsUpdateSuggested(
        ...
        AbstractAccountAuthenticator.this.handleException(
            response, "isCredentialsUpdateSuggested", account.toString(), e);
      }
    }
  }
  ...
  public Bundle getAccountCredentialsForCloning(
      final AccountAuthenticatorResponse response, Account account) throws NetworkErrorException {
    new Thread(
            new Runnable() { // from class: android.accounts.AbstractAccountAuthenticator.1
  ...
  public Bundle addAccountFromCredentials(
      final AccountAuthenticatorResponse response, Account account, Bundle accountCredentials)
      throws NetworkErrorException {
    new Thread(
            new Runnable() { // from class: android.accounts.AbstractAccountAuthenticator.2
              @Override // java.lang.Runnable
              public void run() {
                Bundle result = new Bundle();
                result.putBoolean(AccountManager.KEY_BOOLEAN_RESULT, false);
  ...
  public Bundle startAddAccountSession(
      ...
      throws NetworkErrorException {
    new Thread(
            new Runnable() { // from class: android.accounts.AbstractAccountAuthenticator.3
              @Override // java.lang.Runnable
              public void run() {
                Bundle sessionBundle = new Bundle();
                sessionBundle.putString(
                    AbstractAccountAuthenticator.KEY_AUTH_TOKEN_TYPE, authTokenType);
                sessionBundle.putStringArray(
                    AbstractAccountAuthenticator.KEY_REQUIRED_FEATURES, requiredFeatures);
  ...
  public Bundle startUpdateCredentialsSession(
      ...
      throws NetworkErrorException {
    new Thread(
            new Runnable() { // from class: android.accounts.AbstractAccountAuthenticator.4
              @Override // java.lang.Runnable
              public void run() {
                Bundle sessionBundle = new Bundle();
                sessionBundle.putString(
  ...
  public Bundle finishSession(
      AccountAuthenticatorResponse response, String accountType, Bundle sessionBundle)
      throws NetworkErrorException {
    Bundle sessionOptions;
    if (TextUtils.isEmpty(accountType)) {
      Log.m96e(TAG, "Account type cannot be empty.");
      Bundle result = new Bundle();
    ...
    if (sessionBundle == null) {
      Log.m96e(TAG, "Session bundle cannot be null.");
    ...
    if (!sessionBundle.containsKey(KEY_AUTH_TOKEN_TYPE)) {
      ...
      result3.putString(
          ...
          "Authenticator must override finishSession if startAddAccountSession or"
              + " startUpdateCredentialsSession is overridden.");
    ...
    return containsKeyAccount
        ? updateCredentials(response, account, authTokenType, options)
        : addAccount(response, accountType, authTokenType, requiredFeatures, sessionOptions);
  }

  public Bundle isCredentialsUpdateSuggested(
      AccountAuthenticatorResponse response, Account account, String statusToken)
      throws NetworkErrorException {
    Bundle result = new Bundle();
    result.putBoolean(AccountManager.KEY_BOOLEAN_RESULT, false);
    return result;
