...
public interface IAccountManager extends IInterface {
  ...
  boolean addAccountExplicitlyWithVisibility(
      Account account, String str, Bundle bundle, Map map, String str2) throws RemoteException;
  ...
  void getAccountByTypeAndFeatures(
      IAccountManagerResponse iAccountManagerResponse, String str, String[] strArr, String str2)
      throws RemoteException;
  ...
  public static class Default implements IAccountManager {
    ...
    public void removeAccountAsUser(
        IAccountManagerResponse response, Account account, boolean expectActivityLaunch, int userId)
        throws RemoteException {}
    ...
    public boolean addAccountExplicitlyWithVisibility(
        Account account, String password, Bundle extras, Map visibility, String opPackageName)
        throws RemoteException {
      return false;
    }
        ...
        default:
          switch (code) {
            ...
            case 38:
              ...
              data.enforceNoDataAvail();
              boolean _result14 =
                  addAccountExplicitlyWithVisibility(_arg038, _arg130, _arg226, _arg316, _arg410);
              reply.writeNoException();
