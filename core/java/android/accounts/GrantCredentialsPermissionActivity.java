...
public class GrantCredentialsPermissionActivity extends Activity implements View.OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(C4337R.layout.grant_credentials_permission);
    setTitle(C4337R.string.grant_permissions_header_text);
    ...
    try {
      ...
      final TextView authTokenTypeView = (TextView) findViewById(C4337R.id.authtoken_type);
      authTokenTypeView.setVisibility(8);
      AccountManagerCallback<String> callback =
          new AccountManagerCallback<
              String>() { // from class: android.accounts.GrantCredentialsPermissionActivity.1
      ...
      findViewById(C4337R.id.allow_button).setOnClickListener(this);
      findViewById(C4337R.id.deny_button).setOnClickListener(this);
      LinearLayout packagesListView = (LinearLayout) findViewById(C4337R.id.packages_list);
      ...
      ((TextView) findViewById(C4337R.id.account_name)).setText(this.mAccount.name);
      ((TextView) findViewById(C4337R.id.account_type)).setText(accountTypeLabel);
  ...
  private View newPackageView(String packageLabel) {
    View view =
        this.mInflater.inflate(C4337R.layout.permissions_package_list_item, (ViewGroup) null);
    ((TextView) view.findViewById(C4337R.id.package_label)).setText(packageLabel);
    return view;
  }
  ...
  public void onClick(View v) {
    switch (v.getId()) {
      case C4337R.id.allow_button /* 16908776 */:
        AccountManager.get(this)
        ...
        break;
      case C4337R.id.deny_button /* 16908988 */:
        AccountManager.get(this)
