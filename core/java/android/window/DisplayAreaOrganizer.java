      ...
      DisplayAreaOrganizer.this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            public final void run() {
              DisplayAreaOrganizer.BinderC42201.this.lambda$onDisplayAreaAppeared$0(
                  displayAreaInfo, leash);
            }
          });
    }
    ...
    public void onDisplayAreaVanished(final DisplayAreaInfo displayAreaInfo) {
      DisplayAreaOrganizer.this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              DisplayAreaOrganizer.BinderC42201.this.lambda$onDisplayAreaVanished$1(
                  displayAreaInfo);
            }
          });
    }
    ...
    public void onDisplayAreaInfoChanged(final DisplayAreaInfo displayAreaInfo) {
      DisplayAreaOrganizer.this.mExecutor.execute(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              DisplayAreaOrganizer.BinderC42201.this.lambda$onDisplayAreaInfoChanged$2(
                  displayAreaInfo);
            }
          });
    }
