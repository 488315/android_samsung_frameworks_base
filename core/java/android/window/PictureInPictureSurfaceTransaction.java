...
public final class PictureInPictureSurfaceTransaction implements Parcelable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(Float.valueOf(this.mAlpha), Float.valueOf(that.mAlpha))
        ...
        && Objects.equals(Float.valueOf(this.mCornerRadius), Float.valueOf(that.mCornerRadius))
        && Objects.equals(Float.valueOf(this.mShadowRadius), Float.valueOf(that.mShadowRadius))
        && Objects.equals(this.mWindowCrop, that.mWindowCrop)
        && this.mShouldDisableCanAffectSystemUiFlags == that.mShouldDisableCanAffectSystemUiFlags;
  }
  ...
  public static void apply(
    ...
    if (pointF != null) {
      tx.setPosition(surfaceControl, pointF.f87x, surfaceTransaction.mPosition.f88y);
    }
    ...
    if (surfaceTransaction.hasCornerRadiusSet()) {
      tx.setCornerRadius(
          surfaceControl,
          CoreRune.MW_PIP_DISABLE_ROUND_CORNER ? 0.0f : surfaceTransaction.mCornerRadius);
    }
    if (surfaceTransaction.hasShadowRadiusSet()) {
      tx.setShadowRadius(
          surfaceControl,
          CoreRune.MW_PIP_DISABLE_ROUND_CORNER ? 0.0f : surfaceTransaction.mShadowRadius);
    }
