...
public class ImeOnBackInvokedDispatcher implements OnBackInvokedDispatcher, Parcelable {
  public static final Parcelable.Creator<ImeOnBackInvokedDispatcher> CREATOR =
      new Parcelable.Creator<
          ImeOnBackInvokedDispatcher>() { // from class: android.window.ImeOnBackInvokedDispatcher.2
  ...
  public void registerOnBackInvokedCallback(int priority, OnBackInvokedCallback callback) {
    ...
    IOnBackInvokedCallback iCallback =
        new WindowOnBackInvokedDispatcher.OnBackInvokedCallbackWrapper(callback, false);
  ...
  public void receive(
    ...
    if (resultCode == 0) {
      ...
      IOnBackInvokedCallback callback =
          IOnBackInvokedCallback.Stub.asInterface(resultData.getBinder(RESULT_KEY_CALLBACK));
  ...
  private void unregisterReceivedCallback(
    ...
    if (callback == null) {
      Log.m96e(
          TAG,
          "Ime callback not found. Ignoring unregisterReceivedCallback. callbackId: " + callbackId);
    } else {
  ...
  static class ImeOnBackInvokedCallback implements OnBackInvokedCallback {
    ...
    public void onBackInvoked() {
      try {
        ...
        Log.m97e(
            ImeOnBackInvokedDispatcher.TAG, "Exception when invoking forwarded callback. e: ", e);
      }
    }
