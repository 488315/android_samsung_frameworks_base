...
public class ImeOnBackInvokedDispatcher implements OnBackInvokedDispatcher, Parcelable {
    ...
    private void unregisterReceivedCallback(int callbackId, OnBackInvokedDispatcher receivingDispatcher) {
        ...
        if (callback == null) {
            Log.m96e(TAG, "Ime callback not found. Ignoring unregisterReceivedCallback. callbackId: " + callbackId);
        } else {
    ...
    static class ImeOnBackInvokedCallback implements OnBackInvokedCallback {
        ...
        public void onBackInvoked() {
            try {
                ...
                Log.m97e(ImeOnBackInvokedDispatcher.TAG, "Exception when invoking forwarded callback. e: ", e);
            }
        }
