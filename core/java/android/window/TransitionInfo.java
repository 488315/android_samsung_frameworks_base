...
public final class TransitionInfo implements Parcelable {
    ...
    public void setSeparatedFromCustomDisplayChange(boolean separated) {
        if (this.mSeparatedFromCustomDisplayChange != separated) {
            ...
            Log.m94d(TAG, "setSeparatedFromCustomDisplayChange: " + separated + ", Callers=" + Debug.getCallers(3));
        }
    }
    ...
    public static final class Root implements Parcelable {
        ...
        public Root localRemoteCopy() {
            if (CoreRune.MW_SHELL_TRANSITION) {
                return new Root(this.mDisplayId, new SurfaceControl(this.mLeash, "localRemote"), this.mOffset.f85x, this.mOffset.f86y, this.mConfiguration, this.mIsActivityRootLeash);
            }
            return new Root(this.mDisplayId, new SurfaceControl(this.mLeash, "localRemote"), this.mOffset.f85x, this.mOffset.f86y);
        }
