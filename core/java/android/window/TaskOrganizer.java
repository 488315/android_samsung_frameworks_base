...
public class TaskOrganizer extends WindowOrganizer {
  ...
  public TaskOrganizer(ITaskOrganizerController taskOrganizerController, Executor executor) {
    this.mInterface = new BinderC42471();
    this.mExecutor = executor != null ? executor : new PendingIntent$$ExternalSyntheticLambda1();
    this.mTaskOrganizerController =
        taskOrganizerController != null ? taskOrganizerController : getController();
  }
  ...
  public void createRootTask(
    ...
    try {
      this.mTaskOrganizerController.createRootTask(
          displayId, windowingMode, launchCookie, removeWithTaskOrganizer);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void createStageRootTask(
    ...
    try {
      this.mTaskOrganizerController.createStageRootTask(
          displayId, windowingMode, stageType, launchCookie);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public List<ActivityManager.RunningTaskInfo> getChildTasks(
      WindowContainerToken parent, int[] activityTypes) {
    try {
  ...
  public void setOrientationRequestPolicy(
      boolean isIgnoreOrientationRequestDisabled, int[] fromOrientations, int[] toOrientations) {
    try {
      this.mTaskOrganizerController.setOrientationRequestPolicy(
          isIgnoreOrientationRequestDisabled, fromOrientations, toOrientations);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  class BinderC42471 extends ITaskOrganizer.Stub {
    BinderC42471() {}
    ...
    public void addStartingWindow(final StartingWindowInfo windowInfo) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$addStartingWindow$0(windowInfo);
            }
          });
    }
    ...
    public void removeStartingWindow(final StartingWindowRemovalInfo removalInfo) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$removeStartingWindow$1(removalInfo);
            }
          });
    }
    ...
    public void copySplashScreenView(final int taskId) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$copySplashScreenView$2(taskId);
            }
          });
    }
    ...
    public void onAppSplashScreenViewRemoved(final int taskId) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onAppSplashScreenViewRemoved$3(taskId);
            }
          });
    }
    ...
    public void onTaskAppeared(
        final ActivityManager.RunningTaskInfo taskInfo, final SurfaceControl leash) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onTaskAppeared$4(taskInfo, leash);
            }
          });
    }
    ...
    public void onTaskVanished(final ActivityManager.RunningTaskInfo taskInfo) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onTaskVanished$5(taskInfo);
            }
          });
    }
    ...
    public void onTaskInfoChanged(final ActivityManager.RunningTaskInfo info) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onTaskInfoChanged$6(info);
            }
          });
    }
    ...
    public void onBackPressedOnTaskRoot(final ActivityManager.RunningTaskInfo info) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onBackPressedOnTaskRoot$7(info);
            }
          });
    }
    ...
    public void onImeDrawnOnTask(final int taskId) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onImeDrawnOnTask$8(taskId);
            }
          });
    }
    ...
    @Override // android.window.ITaskOrganizer
    public void onSplitLayoutChangeRequested(
        final ActivityManager.RunningTaskInfo taskInfo, final Bundle infoBundle) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onSplitLayoutChangeRequested$9(
                  taskInfo, infoBundle);
            }
          });
    }
    ...
    public void preloadSplashScreenAppIcon(
        final ActivityInfo info, final int userId, final Configuration config) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$preloadSplashScreenAppIcon$10(
                  info, userId, config);
            }
          });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$preloadSplashScreenAppIcon$10(
    ...
    public void resetStashedFreeform(final int taskId, final boolean anim) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$resetStashedFreeform$11(taskId, anim);
            }
          });
    }
    ...
    public void onKeepScreenOnChanged(final int taskId, final boolean keepScreenOn) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onKeepScreenOnChanged$12(taskId, keepScreenOn);
            }
          });
    }
    ...
    public void onImmersiveModeChanged(final int taskId, final boolean immersive) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onImmersiveModeChanged$13(taskId, immersive);
            }
          });
    }
    ...
    public void onNewDexImmersiveModeChanged(final int taskId, final boolean immersive) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$onNewDexImmersiveModeChanged$14(
                  taskId, immersive);
            }
          });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onNewDexImmersiveModeChanged$14(
    ...
    public void requestAffordanceAnim(
        final ActivityManager.RunningTaskInfo taskInfo, final int gestureFrom) {
      TaskOrganizer.this.mExecutor.execute(
          new Runnable() { // from class: android.window.TaskOrganizer$1$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
              TaskOrganizer.BinderC42471.this.lambda$requestAffordanceAnim$15(
                  taskInfo, gestureFrom);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$requestAffordanceAnim$15(
