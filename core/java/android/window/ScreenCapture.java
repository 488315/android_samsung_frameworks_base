...
public class ScreenCapture {
    ...
    public static class CaptureArgs implements Parcelable {
        ...
        public static class Builder<T extends Builder<T>> {
            ...
            public T setIsScreenShotBySystem(boolean isScreenShotBySystem) {
                ...
                Log.m94d(ScreenCapture.TAG, "[Capture_TEST] : setIsScreenShotBySystem " + isScreenShotBySystem);
                return getThis();
            }
    ...
    static /* synthetic */ void lambda$createSyncCaptureListener$0(ScreenshotHardwareBuffer[] bufferRef, CountDownLatch latch, ScreenshotHardwareBuffer buffer) {
        bufferRef[0] = buffer;
        latch.countDown();
    }
