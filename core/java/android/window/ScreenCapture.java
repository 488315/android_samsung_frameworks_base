...
public class ScreenCapture {
  ...
  public static class ScreenshotHardwareBuffer {
    ...
    public Bitmap asBitmap() {
      ...
      if (hardwareBuffer == null) {
        Log.m102w(ScreenCapture.TAG, "Failed to take screenshot. Null screenshot object");
        return null;
      }
  ...
  public static class CaptureArgs implements Parcelable {
    ...
    public static class Builder<T extends Builder<T>> {
      ...
      public T setIsScreenShotBySystem(boolean isScreenShotBySystem) {
        ...
        Log.m94d(
            ScreenCapture.TAG, "[Capture_TEST] : setIsScreenShotBySystem " + isScreenShotBySystem);
        return getThis();
      }
  ...
  public static class ScreenCaptureListener implements Parcelable {
    ...
    public ScreenCaptureListener(Consumer<ScreenshotHardwareBuffer> consumer) {
      long nativeCreateScreenCaptureListener =
          ScreenCapture.nativeCreateScreenCaptureListener(consumer);
  ...
  public static SynchronousScreenCaptureListener createSyncCaptureListener() {
    ...
    Consumer<ScreenshotHardwareBuffer> consumer =
        new Consumer() { // from class: android.window.ScreenCapture$$ExternalSyntheticLambda0
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            ScreenCapture.lambda$createSyncCaptureListener$0(
                bufferRef, latch, (ScreenCapture.ScreenshotHardwareBuffer) obj);
          }
        };
    return new SynchronousScreenCaptureListener(
        consumer, consumer, latch, bufferRef) { // from class: android.window.ScreenCapture.1
      ...
      public ScreenshotHardwareBuffer getBuffer() {
        try {
          ...
          Log.m97e(ScreenCapture.TAG, "Failed to wait for screen capture result", e);
          return null;
        }
      }
    };
  ...
  static /* synthetic */ void lambda$createSyncCaptureListener$0(
      ScreenshotHardwareBuffer[] bufferRef, CountDownLatch latch, ScreenshotHardwareBuffer buffer) {
    bufferRef[0] = buffer;
    latch.countDown();
  }
