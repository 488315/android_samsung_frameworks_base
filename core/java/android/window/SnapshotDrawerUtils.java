...
public class SnapshotDrawerUtils {
    ...
    public static class SnapshotSurface {
        ...
        public void drawSnapshot(boolean releaseAfterDraw) {
            Log.m100v(SnapshotDrawerUtils.TAG, "Drawing snapshot surface sizeMismatch=" + this.mSizeMismatch);
        ...
        private void drawSizeMismatchSnapshot() {
            ...
            if (aspectRatioMismatch) {
                ...
                if (background == null) {
                    Log.m96e(SnapshotDrawerUtils.TAG, "Unable to draw snapshot: failed to allocate graphic buffer for " + ((Object) this.mTitle));
                    return;
                }
