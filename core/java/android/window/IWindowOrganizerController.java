          ...
          switch (code) {
            ...
            case 2:
              ...
              IWindowContainerTransactionCallback _arg1 =
                  IWindowContainerTransactionCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 6:
              ...
              WindowContainerTransaction _arg15 =
                  (WindowContainerTransaction)
                      data.readTypedObject(WindowContainerTransaction.CREATOR);
              IWindowContainerTransactionCallback _arg22 =
                  IWindowContainerTransactionCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
      ...
      public IDisplayAreaOrganizerController getDisplayAreaOrganizerController()
        ...
        try {
          ...
          IDisplayAreaOrganizerController _result =
              IDisplayAreaOrganizerController.Stub.asInterface(_reply.readStrongBinder());
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public ITaskFragmentOrganizerController getTaskFragmentOrganizerController()
        ...
        try {
          ...
          ITaskFragmentOrganizerController _result =
              ITaskFragmentOrganizerController.Stub.asInterface(_reply.readStrongBinder());
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
