...
public final class SizeConfigurationBuckets implements Parcelable {
  public static final Parcelable.Creator<SizeConfigurationBuckets> CREATOR =
      new Parcelable.Creator<
          SizeConfigurationBuckets>() { // from class: android.window.SizeConfigurationBuckets.1
  ...
  public static int filterDiff(
    ...
    if ((diff & 1024) != 0) {
      boolean crosses =
          buckets.crossesHorizontalSizeThreshold(oldConfig.screenWidthDp, newConfig.screenWidthDp)
