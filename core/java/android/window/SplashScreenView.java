...
public final class SplashScreenView extends FrameLayout {
  ...
  public static class Builder {
    ...
    public Builder createFromParcel(SplashScreenViewParcelable parcelable) {
      ...
      if (surfacePackage == null && parcelable.mIconBitmap != null) {
        this.mIconDrawable =
            new BitmapDrawable(this.mContext.getResources(), parcelable.mIconBitmap);
        this.mParceledIconBitmap = parcelable.mIconBitmap;
      }
      if (parcelable.mIconBackground != null) {
        this.mIconBackground =
            new BitmapDrawable(this.mContext.getResources(), parcelable.mIconBackground);
        this.mParceledIconBackgroundBitmap = parcelable.mIconBackground;
      }
      if (parcelable.mBrandingBitmap != null) {
        setBrandingDrawable(
            new BitmapDrawable(this.mContext.getResources(), parcelable.mBrandingBitmap),
            parcelable.mBrandingWidth,
      ...
      if (SplashScreenView.DEBUG) {
        Log.m94d(
            SplashScreenView.TAG,
            String.format("Building from parcel drawable: %s", this.mIconDrawable));
      }
      return this;
    }
    ...
    public SplashScreenView build() {
      ...
      final SplashScreenView view =
          (SplashScreenView)
              layoutInflater.inflate(C4337R.layout.splash_screen_view, (ViewGroup) null, false);
      ...
      view.mBrandingImageView = view.findViewById(C4337R.id.splashscreen_branding_view);
      ...
      if ((this.mIconDrawable instanceof IconAnimateListener) || this.mSurfacePackage != null) {
        ...
        if (consumer != null) {
          consumer.accept(
              new Runnable() { // from class:
                               // android.window.SplashScreenView$Builder$$ExternalSyntheticLambda0
        ...
        ImageView imageView = (ImageView) view.findViewById(C4337R.id.splashscreen_icon_view);
      ...
      if (this.mBrandingImageHeight > 0
          && this.mBrandingImageWidth > 0
          && this.mBrandingDrawable != null) {
      ...
      if (SplashScreenView.DEBUG) {
        Log.m94d(
            ...
            "Build "
                ...
                + this.mIconSize
                + "\nBranding: view: "
                + view.mBrandingImageView
                + " drawable: "
                + this.mBrandingDrawable
                + " size w: "
                + this.mBrandingImageWidth
                + " h: "
                + this.mBrandingImageHeight);
      }
      Trace.traceEnd(32L);
      return view;
    }
    ...
    private SurfaceView createSurfaceView(SplashScreenView splashScreenView) {
      ...
      if (this.mSurfacePackage == null) {
        if (SplashScreenView.DEBUG) {
          Log.m94d(
              SplashScreenView.TAG,
              "SurfaceControlViewHost created on thread " + Thread.currentThread().getId());
        }
        ...
        splashScreenView.mSurfacePackageCopy =
            new SurfaceControlViewHost.SurfacePackage(surfacePackage);
      } else {
        if (SplashScreenView.DEBUG) {
          Log.m94d(SplashScreenView.TAG, "Using copy of SurfacePackage in the client");
        }
      ...
      if (i2 != 0) {
        ...
        if (SplashScreenView.DEBUG) {
          Log.m94d(SplashScreenView.TAG, "Icon size " + this.mIconSize);
        }
      }
  ...
  public void onCopied() {
    ...
    if (DEBUG) {
      Log.m94d(TAG, "Setting SurfaceView's SurfacePackage to null.");
    }
  ...
  public void syncTransferSurfaceOnDraw() {
    ...
    if (DEBUG) {
      surfacePackage
          .getSurfaceControl()
          .addOnReparentListener(
              new SurfaceControl
                  .OnReparentListener() { // from class:
                                          // android.window.SplashScreenView$$ExternalSyntheticLambda1
                @Override // android.view.SurfaceControl.OnReparentListener
                public final void onReparent(
                    SurfaceControl.Transaction transaction, SurfaceControl surfaceControl) {
                  Log.m96e(
                      SplashScreenView.TAG,
                      String.format("SurfacePackage'surface reparented to %s", surfaceControl));
                }
              });
      Log.m94d(TAG, "Transferring surface " + this.mSurfaceView.toString());
    }
  ...
  void initIconAnimation(Drawable drawable) {
    ...
    aniDrawable.prepareAnimate(
        new LongConsumer() { // from class:
                             // android.window.SplashScreenView$$ExternalSyntheticLambda0
          @Override // java.util.function.LongConsumer
          public final void accept(long j) {
            SplashScreenView.this.animationStartCallback(j);
          }
        });
    aniDrawable.setAnimationJankMonitoring(
        new AnimatorListenerAdapter() { // from class: android.window.SplashScreenView.1
  ...
  public void remove() {
    ...
    if (window != null) {
      ...
      if (DEBUG) {
        Log.m94d(TAG, "remove starting view");
      }
      if (decorView != null) {
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    ViewGroup.MarginLayoutParams params =
        (ViewGroup.MarginLayoutParams) this.mBrandingImageView.getLayoutParams();
    if (params == null) {
      Log.m96e(TAG, "Unable to adjust branding image layout, layout changed?");
      return;
    }
  ...
  private void releaseAnimationSurfaceHost() {
    ...
    if (surfaceControlViewHost != null && !this.mIsCopied) {
      if (DEBUG) {
        Log.m94d(
            TAG,
            "Shell removed splash screen. Releasing SurfaceControlViewHost on thread #"
  ...
  public static class SplashScreenViewParcelable implements Parcelable {
    public static final Parcelable.Creator<SplashScreenViewParcelable> CREATOR =
    ...
    public SplashScreenViewParcelable(SplashScreenView view) {
      ...
      if (surfacePackage == null) {
        this.mIconBitmap =
            iconView != null ? copyDrawable(((ImageView) view.getIconView()).getDrawable()) : null;
      }
    ...
    private void readParcel(Parcel source) {
      ...
      this.mSurfacePackage =
          (SurfaceControlViewHost.SurfacePackage)
              source.readTypedObject(SurfaceControlViewHost.SurfacePackage.CREATOR);
