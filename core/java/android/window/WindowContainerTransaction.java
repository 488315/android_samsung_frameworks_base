...
public final class WindowContainerTransaction implements Parcelable {
  ...
  public static final Parcelable.Creator<WindowContainerTransaction> CREATOR =
      new Parcelable.Creator<
          WindowContainerTransaction>() { // from class: android.window.WindowContainerTransaction.1
  ...
  public WindowContainerTransaction reparentFirst(
      WindowContainerToken child, WindowContainerToken parent, boolean onTop) {
    this.mHierarchyOps.add(
        0,
        HierarchyOp.createForReparent(
  ...
  public WindowContainerTransaction setLaunchRoot(
    ...
    this.mHierarchyOps.add(
        HierarchyOp.createForSetLaunchRoot(container.asBinder(), windowingModes, activityTypes));
    return this;
  }
  ...
  public WindowContainerTransaction startActivityInTaskFragment(
      IBinder fragmentToken, IBinder callerToken, Intent activityIntent, Bundle activityOptions) {
    TaskFragmentOperation operation =
  ...
  public WindowContainerTransaction addInsetsSource(
      WindowContainerToken receiver, IBinder owner, int index, int type, Rect frame) {
  ...
  public void merge(WindowContainerTransaction other, boolean transfer) {
    ...
    for (int i2 = 0; i2 < n2; i2++) {
      this.mHierarchyOps.add(
          transfer ? other.mHierarchyOps.get(i2) : new HierarchyOp(other.mHierarchyOps.get(i2)));
    }
    ...
    IBinder otherTaskFragmentOrganizerAsBinder =
        iTaskFragmentOrganizer2 != null ? iTaskFragmentOrganizer2.asBinder() : null;
  ...
  public String toString() {
    ...
    if (CoreRune.MW_SHELL_CHANGE_TRANSITION && changeTransitionRequested()) {
      extraStr =
          " changeTransitRequest=" + changeTransitRequestToString(this.mChangeTransitionRequest);
    }
  ...
  public static class Change implements Parcelable {
    ...
    public static final Parcelable.Creator<Change> CREATOR =
        new Parcelable.Creator<
            Change>() { // from class: android.window.WindowContainerTransaction.Change.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public boolean getIgnoreOrientationRequest() {
      if ((this.mChangeMask & 32) == 0) {
        throw new RuntimeException(
            "IgnoreOrientationRequest not set. Check CHANGE_IGNORE_ORIENTATION_REQUEST first");
      }
    ...
    public String toString() {
      ...
      boolean changesBounds =
          ((i & 536870912) == 0 || (this.mWindowSetMask & 1) == 0) ? false : true;
      boolean changesAppBounds =
          ((536870912 & i) == 0 || (this.mWindowSetMask & 2) == 0) ? false : true;
  ...
  public static final class HierarchyOp implements Parcelable {
    public static final Parcelable.Creator<HierarchyOp> CREATOR =
        new Parcelable.Creator<
            HierarchyOp>() { // from class: android.window.WindowContainerTransaction.HierarchyOp.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
