...
public interface IDisplayAreaOrganizerController extends IInterface {
  ...
  DisplayAreaAppearedInfo createTaskDisplayArea(
      IDisplayAreaOrganizer iDisplayAreaOrganizer, int i, int i2, String str)
      throws RemoteException;

  void deleteTaskDisplayArea(WindowContainerToken windowContainerToken) throws RemoteException;

  ParceledListSlice<DisplayAreaAppearedInfo> registerOrganizer(
      IDisplayAreaOrganizer iDisplayAreaOrganizer, int i) throws RemoteException;
  ...
  public static class Default implements IDisplayAreaOrganizerController {
    ...
    public DisplayAreaAppearedInfo createTaskDisplayArea(
        IDisplayAreaOrganizer organizer, int displayId, int parentFeatureId, String name)
        throws RemoteException {
      return null;
    }
  ...
  public abstract static class Stub extends Binder implements IDisplayAreaOrganizerController {
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
      ...
      switch (code) {
        ...
        default:
          switch (code) {
            case 1:
              IDisplayAreaOrganizer _arg0 =
                  IDisplayAreaOrganizer.Stub.asInterface(data.readStrongBinder());
            ...
            case 2:
              ...
              return true;
            case 3:
              IDisplayAreaOrganizer _arg03 =
                  IDisplayAreaOrganizer.Stub.asInterface(data.readStrongBinder());
              int _arg12 = data.readInt();
              int _arg2 = data.readInt();
              String _arg3 = data.readString();
              data.enforceNoDataAvail();
              DisplayAreaAppearedInfo _result2 =
                  createTaskDisplayArea(_arg03, _arg12, _arg2, _arg3);
              reply.writeNoException();
    ...
    private static class Proxy implements IDisplayAreaOrganizerController {
      ...
      public ParceledListSlice<DisplayAreaAppearedInfo> registerOrganizer(
        ...
        try {
          ...
          ParceledListSlice<DisplayAreaAppearedInfo> _result =
      ...
      public DisplayAreaAppearedInfo createTaskDisplayArea(
        ...
        try {
          ...
          DisplayAreaAppearedInfo _result =
              (DisplayAreaAppearedInfo) _reply.readTypedObject(DisplayAreaAppearedInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
