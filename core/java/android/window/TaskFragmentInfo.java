...
public final class TaskFragmentInfo implements Parcelable {
  public static final Parcelable.Creator<TaskFragmentInfo> CREATOR =
      new Parcelable.Creator<TaskFragmentInfo>() { // from class: android.window.TaskFragmentInfo.1
  ...
  public int getMinimumWidth() {
    return this.mMinimumDimensions.f85x;
  }

  public int getMinimumHeight() {
    return this.mMinimumDimensions.f86y;
  }
  ...
  public boolean equalsForTaskFragmentOrganizer(TaskFragmentInfo that) {
    return that != null
        ...
        && this.mInRequestedTaskFragmentActivities.equals(that.mInRequestedTaskFragmentActivities)
        ...
        && this.mIsClearedForReorderActivityToFront == that.mIsClearedForReorderActivityToFront
