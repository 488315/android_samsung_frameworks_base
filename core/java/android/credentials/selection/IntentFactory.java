...
public class IntentFactory {
    ...
    public static IntentCreationResult createCredentialSelectorIntentForCredMan(
            ...
            ArrayList<DisabledProviderData> disabledProviderDataList,
            ResultReceiver resultReceiver) {
        IntentCreationResult result =
                createCredentialSelectorIntentInternal(
                        context, requestInfo, disabledProviderDataList, resultReceiver);
        result.getIntent()
    ...
    public static Intent createCredentialSelectorIntent(
            ...
            ArrayList<DisabledProviderData> disabledProviderDataList,
            ResultReceiver resultReceiver) {
        return createCredentialSelectorIntentForCredMan(
                        context,
                        requestInfo,
                        enabledProviderDataList,
                        disabledProviderDataList,
                        resultReceiver)
                .getIntent();
    }
    ...
    public static Intent createCancelUiIntent(
            ...
            boolean shouldShowCancellationUi,
        ...
        intent.putExtra(
                ...
                new CancelSelectionRequest(
                        new RequestToken(requestToken), shouldShowCancellationUi, appPackageName));
        return intent;
    }
    ...
    private static void setCredentialSelectorUiComponentName(
            Context context, Intent intent, IntentCreationResult.Builder intentResultBuilder) {
        ...
        intent.setComponent(
                ComponentName.unflattenFromString(
                        Resources.getSystem()
                                .getString(
                                        R.string.config_fallbackCredentialManagerDialogComponent)));
    }

    private static ComponentName getOemOverrideComponentName(
            Context context, IntentCreationResult.Builder intentResultBuilder) {
        ComponentName result = null;
        String oemComponentString =
                Resources.getSystem()
                        .getString(R.string.config_oemCredentialManagerDialogComponent);
                ...
                try {
                    ...
                    ActivityInfo info =
                            context.getPackageManager()
                                    .getActivityInfo(
                                            oemComponentName,
                                            PackageManager.ComponentInfoFlags.of(1048576L));
                    boolean oemComponentEnabled = info.enabled;
                    int runtimeComponentEnabledState =
                            context.getPackageManager()
                    ...
                    if (oemComponentEnabled && info.exported) {
                        intentResultBuilder.setOemUiUsageStatus(
                                IntentCreationResult.OemUiUsageStatus.SUCCESS);
                        ...
                        Slog.i(
                                TAG,
                                "Found enabled oem CredMan UI component but it was not enabled.");
                    }
                    ...
                    Slog.i(
                            TAG,
                            "Unable to find oem CredMan UI component: "
                                    + oemComponentString
