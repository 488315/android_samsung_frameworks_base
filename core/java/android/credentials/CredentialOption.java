...
public final class CredentialOption implements Parcelable {
  ...
  private CredentialOption(
    ...
    this.mCredentialRetrievalData =
        (Bundle) Objects.requireNonNull(credentialRetrievalData, "requestData must not be null");
    this.mCandidateQueryData =
        (Bundle) Objects.requireNonNull(candidateQueryData, "candidateQueryData must not be null");
    this.mIsSystemProviderRequired = isSystemProviderRequired;
    this.mAllowedProviders =
        (ArraySet) Objects.requireNonNull(allowedProviders, "providerFilterSer mustnot be empty");
  }
  ...
  private CredentialOption(Parcel in) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) candidateQueryData);
    this.mIsSystemProviderRequired = isSystemProviderRequired;
    ArraySet readArraySet = in.readArraySet(null);
    this.mAllowedProviders = readArraySet;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) readArraySet);
  }
  ...
  public static final class Builder {
      ...
      this.mCredentialRetrievalData =
          (Bundle)
              Objects.requireNonNull(
                  credentialRetrievalData, "credentialRetrievalData must not be null");
      this.mCandidateQueryData =
          (Bundle)
              Objects.requireNonNull(candidateQueryData, "candidateQueryData must not be null");
    }
    ...
    public Builder addAllowedProvider(ComponentName allowedProvider) {
      this.mAllowedProviders.add(
          (ComponentName)
              Objects.requireNonNull(allowedProvider, "allowedProvider must not be null"));
      return this;
    }
