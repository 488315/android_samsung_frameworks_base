...
public interface IGetCredentialCallback extends IInterface {
  ...
  public abstract static class Stub extends Binder implements IGetCredentialCallback {
        ...
        default:
          switch (code) {
            case 1:
              ...
              return true;
            case 2:
              GetCredentialResponse _arg02 =
                  (GetCredentialResponse) data.readTypedObject(GetCredentialResponse.CREATOR);
              data.enforceNoDataAvail();
              onResponse(_arg02);
              return true;
            case 3:
