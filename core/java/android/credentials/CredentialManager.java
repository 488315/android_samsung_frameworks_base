...
public final class CredentialManager {
  ...
  public void getCredential(
    ...
    if (cancellationSignal != null && cancellationSignal.isCanceled()) {
      Log.m102w(TAG, "getCredential already canceled");
      return;
    }
  ...
  public void prepareGetCredential(
    ...
    if (cancellationSignal != null && cancellationSignal.isCanceled()) {
      Log.m102w(TAG, "prepareGetCredential already canceled");
      return;
    }
      ...
      iCancellationSignal =
          this.mService.executePrepareGetCredential(
              ...
              new PrepareGetCredentialTransport(
                  executor, outcomeReceiver, getCredentialTransportPendingUseCase),
  ...
  public void createCredential(
    ...
    Objects.requireNonNull(callback, "callback must not be null");
    if (cancellationSignal != null && cancellationSignal.isCanceled()) {
      Log.m102w(TAG, "createCredential already canceled");
      return;
    }
    ICancellationSignal cancelRemote = null;
    try {
  ...
  public void clearCredentialState(
    ...
    Objects.requireNonNull(callback, "callback must not be null");
    if (cancellationSignal != null && cancellationSignal.isCanceled()) {
      Log.m102w(TAG, "clearCredentialState already canceled");
      return;
    }
    ICancellationSignal cancelRemote = null;
    try {
      ...
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                CredentialManager.PrepareGetCredentialTransport.this.lambda$onError$1(
                    errorType, message);
              }
            });
      } finally {
  ...
  protected static class GetCredentialTransportPendingUseCase extends IGetCredentialCallback.Stub {
    ...
    public void onPendingIntent(PendingIntent pendingIntent) {
      PrepareGetCredentialResponse.GetPendingCredentialInternalCallback
          getPendingCredentialInternalCallback = this.mCallback;
      if (getPendingCredentialInternalCallback != null) {
        getPendingCredentialInternalCallback.onPendingIntent(pendingIntent);
      } else {
        Log.m94d(
            CredentialManager.TAG, "Unexpected onPendingIntent call before the show invocation");
      }
    }
    ...
    public void onResponse(GetCredentialResponse response) {
      ...
      Log.m94d(CredentialManager.TAG, "Unexpected onResponse call before the show invocation");
    }
    ...
    public void onError(String errorType, String message) {
      ...
      Log.m94d(CredentialManager.TAG, "Unexpected onError call before the show invocation");
    }
  }
      ...
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                CredentialManager.ClearCredentialStateTransport.this.lambda$onError$0(
                    errorType, message);
              }
            });
      } finally {
      ...
      try {
        this.mExecutor.execute(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                CredentialManager.SetEnabledProvidersTransport.this.lambda$onError$2(
                    errorType, message);
              }
            });
      } finally {
