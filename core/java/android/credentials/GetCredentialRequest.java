...
public final class GetCredentialRequest implements Parcelable {
  public static final Parcelable.Creator<GetCredentialRequest> CREATOR =
      new Parcelable.Creator<
          GetCredentialRequest>() { // from class: android.credentials.GetCredentialRequest.1
  ...
  public String toString() {
    return "GetCredentialRequest {credentialOption="
  ...
  public static final class Builder {
    ...
    public Builder addCredentialOption(CredentialOption credentialOption) {
      this.mCredentialOptions.add(
          (CredentialOption)
              Objects.requireNonNull(credentialOption, "credentialOption must not be null"));
      return this;
    }
    ...
    public GetCredentialRequest build() {
      ...
      return new GetCredentialRequest(
          this.mCredentialOptions, this.mData, this.mAlwaysSendAppInfoToProvider, this.mOrigin);
    }
  }
}
