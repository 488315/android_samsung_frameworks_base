...
public class IntentFactory {
    public static Intent createCredentialSelectorIntent(RequestInfo requestInfo, ArrayList<ProviderData> enabledProviderDataList, ArrayList<DisabledProviderData> disabledProviderDataList, ResultReceiver resultReceiver) {
        ...
        ComponentName componentName = ComponentName.unflattenFromString(Resources.getSystem().getString(C4337R.string.config_credentialManagerDialogComponent));
    ...
    public static Intent createProviderUpdateIntent() {
        Intent intent = new Intent();
        ComponentName componentName = ComponentName.unflattenFromString(Resources.getSystem().getString(C4337R.string.config_credentialManagerReceiverComponent));
        intent.setComponent(componentName);
