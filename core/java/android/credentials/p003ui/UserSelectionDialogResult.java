...
public final class UserSelectionDialogResult extends BaseDialogResult implements Parcelable {
  public static final Parcelable.Creator<UserSelectionDialogResult> CREATOR =
      new Parcelable.Creator<
          UserSelectionDialogResult>() { // from class:
                                         // android.credentials.ui.UserSelectionDialogResult.1
  ...
  public static UserSelectionDialogResult fromResultData(Bundle resultData) {
    return (UserSelectionDialogResult)
        resultData.getParcelable(EXTRA_USER_SELECTION_RESULT, UserSelectionDialogResult.class);
  }
  ...
  public UserSelectionDialogResult(
      IBinder requestToken, String providerId, String entryKey, String entrySubkey) {
    super(requestToken);
  ...
  protected UserSelectionDialogResult(Parcel in) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) providerId);
    this.mEntryKey = entryKey;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) entryKey);
    this.mEntrySubkey = entrySubkey;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) entrySubkey);
    this.mProviderPendingIntentResponse =
        (ProviderPendingIntentResponse) in.readTypedObject(ProviderPendingIntentResponse.CREATOR);
  }
