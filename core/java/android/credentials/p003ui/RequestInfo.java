...
public final class RequestInfo implements Parcelable {
  public static final Parcelable.Creator<RequestInfo> CREATOR =
      new Parcelable.Creator<RequestInfo>() { // from class: android.credentials.ui.RequestInfo.1
  ...
  public static RequestInfo newCreateRequestInfo(
      IBinder token, CreateCredentialRequest createCredentialRequest, String appPackageName) {
    return new RequestInfo(
        token, TYPE_CREATE, appPackageName, createCredentialRequest, null, false, new ArrayList());
  }
  ...
  public static RequestInfo newGetRequestInfo(
      IBinder token, GetCredentialRequest getCredentialRequest, String appPackageName) {
    return new RequestInfo(
        token, TYPE_GET, appPackageName, null, getCredentialRequest, false, new ArrayList());
  }
  ...
  private RequestInfo(Parcel in) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) appPackageName);
    this.mCreateCredentialRequest = createCredentialRequest;
    this.mGetCredentialRequest = getCredentialRequest;
