...
public final class GetCandidateCredentialsResponse implements Parcelable {
    public static final Parcelable.Creator<GetCandidateCredentialsResponse> CREATOR =
            new Parcelable.Creator<GetCandidateCredentialsResponse>() { // from class:
                // android.credentials.GetCandidateCredentialsResponse.1
    ...
    public GetCandidateCredentialsResponse(
            ...
            Intent intent,
            ComponentName primaryProviderComponentName) {
        Preconditions.checkCollectionNotEmpty(
                candidateProviderDataList, "candidateProviderDataList");
    ...
    protected GetCandidateCredentialsResponse(Parcel in) {
        ...
        AnnotationValidations.validate(
                ...
                (NonNull) null,
                (Object) this.mCandidateProviderDataList);
        this.mIntent = (Intent) in.readTypedObject(Intent.CREATOR);
        this.mPrimaryProviderComponentName =
