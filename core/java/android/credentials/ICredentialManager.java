...
public interface ICredentialManager extends IInterface {
  ...
  public static class Default implements ICredentialManager {
    ...
    public ICancellationSignal executeGetCredential(
        GetCredentialRequest request, IGetCredentialCallback callback, String callingPackage)
        throws RemoteException {
      return null;
    }
    ...
    public ICancellationSignal executeCreateCredential(
        CreateCredentialRequest request, ICreateCredentialCallback callback, String callingPackage)
        throws RemoteException {
      return null;
    }
          ...
          switch (code) {
            case 1:
              GetCredentialRequest _arg0 =
                  (GetCredentialRequest) data.readTypedObject(GetCredentialRequest.CREATOR);
            ...
            case 3:
              CreateCredentialRequest _arg03 =
                  (CreateCredentialRequest) data.readTypedObject(CreateCredentialRequest.CREATOR);
              ...
              return true;
            case 4:
              ClearCredentialStateRequest _arg04 =
                  (ClearCredentialStateRequest)
                      data.readTypedObject(ClearCredentialStateRequest.CREATOR);
              IClearCredentialStateCallback _arg14 =
            ...
            case 5:
              ...
              ISetEnabledProvidersCallback _arg32 =
              ...
              return true;
            case 6:
              RegisterCredentialDescriptionRequest _arg06 =
                  (RegisterCredentialDescriptionRequest)
                      data.readTypedObject(RegisterCredentialDescriptionRequest.CREATOR);
              ...
              return true;
            case 7:
              UnregisterCredentialDescriptionRequest _arg07 =
                  (UnregisterCredentialDescriptionRequest)
                      data.readTypedObject(UnregisterCredentialDescriptionRequest.CREATOR);
            ...
            case 10:
              ...
              List<CredentialProviderInfo> _result7 =
                  getCredentialProviderServicesForTesting(_arg010);
              reply.writeNoException();
