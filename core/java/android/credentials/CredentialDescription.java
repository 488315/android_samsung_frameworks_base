...
public final class CredentialDescription implements Parcelable {
  public static final Parcelable.Creator<CredentialDescription> CREATOR =
      new Parcelable.Creator<
          CredentialDescription>() { // from class: android.credentials.CredentialDescription.1
  ...
  public CredentialDescription(
      String type, Set<String> supportedElementKeys, List<CredentialEntry> credentialEntries) {
    ...
    Preconditions.checkArgument(
        credentialEntries.size() <= 16, "The number of Credential Entries exceed 16.");
    Preconditions.checkArgument(
        compareEntryTypes(type, credentialEntries) == 0,
  ...
  private CredentialDescription(Parcel in) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) hashSet);
    ...
    return credentialEntries.stream()
        .filter(
            new Predicate() { // from class:
                              // android.credentials.CredentialDescription$$ExternalSyntheticLambda0
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                return CredentialDescription.lambda$compareEntryTypes$0(
                    type, (CredentialEntry) obj);
              }
            })
        .toList()
        .size();
  ...
  static /* synthetic */ boolean lambda$compareEntryTypes$0(
      String type, CredentialEntry credentialEntry) {
  ...
  public boolean equals(Object obj) {
    ...
    return this.mType.equals(other.mType)
        && this.mSupportedElementKeys.equals(other.mSupportedElementKeys);
  }
}
