...
public final class CredentialDescription implements Parcelable {
    public static final Parcelable.Creator<CredentialDescription> CREATOR =
            new Parcelable.Creator<CredentialDescription>() { // from class:
                // android.credentials.CredentialDescription.1
    ...
    private CredentialDescription(Parcel in) {
        ...
        AnnotationValidations.validate(
                ...
                (NonNull) null,
                (Object) this.mSupportedElementKeys);
        this.mCredentialEntries = arrayList;
        AnnotationValidations.validate(
                (Class<NonNull>) NonNull.class, (NonNull) null, (Object) this.mCredentialEntries);
    }

    private static int compareEntryTypes(
            final String type, List<CredentialEntry> credentialEntries) {
