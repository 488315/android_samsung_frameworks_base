...
public final class GnssAntennaInfo implements Parcelable {
  public static final Parcelable.Creator<GnssAntennaInfo> CREATOR =
      new Parcelable.Creator<GnssAntennaInfo>() { // from class: android.location.GnssAntennaInfo.1
        ...
        public GnssAntennaInfo createFromParcel(Parcel in) {
          ...
          PhaseCenterOffset phaseCenterOffset =
              (PhaseCenterOffset) in.readTypedObject(PhaseCenterOffset.CREATOR);
          SphericalCorrections phaseCenterVariationCorrections =
              (SphericalCorrections) in.readTypedObject(SphericalCorrections.CREATOR);
  ...
  public static final class PhaseCenterOffset implements Parcelable {
    public static final Parcelable.Creator<PhaseCenterOffset> CREATOR =
        new Parcelable.Creator<
            PhaseCenterOffset>() { // from class:
    ...
    public String toString() {
      return "PhaseCenterOffset{OffsetXMm="
          + this.mOffsetXMm
          + " +/-"
          + this.mOffsetXUncertaintyMm
          + ", OffsetYMm="
          + this.mOffsetYMm
          + " +/-"
          + this.mOffsetYUncertaintyMm
          + ", OffsetZMm="
          + this.mOffsetZMm
          + " +/-"
          + this.mOffsetZUncertaintyMm
          + '}';
    }
    ...
    public boolean equals(Object o) {
      ...
      return Double.compare(that.mOffsetXMm, this.mOffsetXMm) == 0
          && Double.compare(that.mOffsetXUncertaintyMm, this.mOffsetXUncertaintyMm) == 0
          && Double.compare(that.mOffsetYMm, this.mOffsetYMm) == 0
          && Double.compare(that.mOffsetYUncertaintyMm, this.mOffsetYUncertaintyMm) == 0
          && Double.compare(that.mOffsetZMm, this.mOffsetZMm) == 0
          && Double.compare(that.mOffsetZUncertaintyMm, this.mOffsetZUncertaintyMm) == 0;
    }

    public int hashCode() {
      return Objects.hash(
          Double.valueOf(this.mOffsetXMm),
          Double.valueOf(this.mOffsetYMm),
          Double.valueOf(this.mOffsetZMm));
    }
  }

  public static final class SphericalCorrections implements Parcelable {
    public static final Parcelable.Creator<SphericalCorrections> CREATOR =
        new Parcelable.Creator<
            SphericalCorrections>() { // from class:
    ...
    public SphericalCorrections(double[][] corrections, double[][] correctionUncertainties) {
      if (corrections.length != correctionUncertainties.length || corrections.length < 1) {
        throw new IllegalArgumentException(
            "correction and uncertainty arrays must have the same (non-zero) dimensions");
      }
      ...
      for (int i = 0; i < corrections.length; i++) {
        ...
        if (length != i2 || correctionUncertainties[i].length != i2 || i2 < 2) {
          throw new IllegalArgumentException(
              "correction and uncertainty arrays must all  have the same (greater than 2) number of"
                  + " columns");
        }
      }
    ...
    private SphericalCorrections(Parcel in) {
      ...
      double[][] corrections =
          (double[][]) Array.newInstance((Class<?>) Double.TYPE, numRows, numColumns);
    ...
    public String toString() {
      return "SphericalCorrections{Corrections="
          + Arrays.deepToString(this.mCorrections)
          + ", CorrectionUncertainties="
          + Arrays.deepToString(this.mCorrectionUncertainties)
          + ", DeltaTheta="
          + getDeltaTheta()
          + ", DeltaPhi="
          + getDeltaPhi()
    ...
    public boolean equals(Object o) {
      ...
      return this.mNumRows == that.mNumRows
          && this.mNumColumns == that.mNumColumns
          && Arrays.deepEquals(this.mCorrections, that.mCorrections)
          && Arrays.deepEquals(this.mCorrectionUncertainties, that.mCorrectionUncertainties);
    }
  ...
  private GnssAntennaInfo(
      ...
      PhaseCenterOffset phaseCenterOffset,
      SphericalCorrections phaseCenterVariationCorrections,
      SphericalCorrections signalGainCorrectionDbi) {
  ...
  public static class Builder {
    ...
    public GnssAntennaInfo build() {
      return new GnssAntennaInfo(
          this.mCarrierFrequencyMHz,
          this.mPhaseCenterOffset,
          this.mPhaseCenterVariationCorrections,
          this.mSignalGainCorrections);
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    return Double.compare(that.mCarrierFrequencyMHz, this.mCarrierFrequencyMHz) == 0
        && this.mPhaseCenterOffset.equals(that.mPhaseCenterOffset)
        && Objects.equals(
            this.mPhaseCenterVariationCorrections, that.mPhaseCenterVariationCorrections)
        && Objects.equals(this.mSignalGainCorrections, that.mSignalGainCorrections);
  }

  public int hashCode() {
    return Objects.hash(
        Double.valueOf(this.mCarrierFrequencyMHz),
        this.mPhaseCenterOffset,
        this.mPhaseCenterVariationCorrections,
        this.mSignalGainCorrections);
  }
