...
public final class SatellitePvt implements Parcelable {
  public static final Parcelable.Creator<SatellitePvt> CREATOR =
      new Parcelable.Creator<SatellitePvt>() { // from class: android.location.SatellitePvt.1
        ...
        public SatellitePvt createFromParcel(Parcel in) {
          ...
          PositionEcef positionEcef =
              (PositionEcef) in.readParcelable(classLoader, PositionEcef.class);
          VelocityEcef velocityEcef =
              (VelocityEcef) in.readParcelable(classLoader, VelocityEcef.class);
  ...
  public static final class PositionEcef implements Parcelable {
    public static final Parcelable.Creator<PositionEcef> CREATOR =
        new Parcelable.Creator<
            PositionEcef>() { // from class: android.location.SatellitePvt.PositionEcef.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
  ...
  public static final class VelocityEcef implements Parcelable {
    public static final Parcelable.Creator<VelocityEcef> CREATOR =
        new Parcelable.Creator<
            VelocityEcef>() { // from class: android.location.SatellitePvt.VelocityEcef.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public String toString() {
      return "VelocityEcef{xMetersPerSecond="
          + this.mXMetersPerSecond
          + ", yMetersPerSecond="
          + this.mYMetersPerSecond
          + ", zMetersPerSecond="
          + this.mZMetersPerSecond
          + ", ureRateMetersPerSecond="
          + this.mUreRateMetersPerSecond
          + "}";
    }
  }

  public static final class ClockInfo implements Parcelable {
    public static final Parcelable.Creator<ClockInfo> CREATOR =
        new Parcelable.Creator<
            ClockInfo>() { // from class: android.location.SatellitePvt.ClockInfo.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public String toString() {
      return "ClockInfo{hardwareCodeBiasMeters="
          + this.mHardwareCodeBiasMeters
          + ", timeCorrectionMeters="
          + this.mTimeCorrectionMeters
          + ", clockDriftMetersPerSecond="
          + this.mClockDriftMetersPerSecond
          + "}";
    }
  }
  ...
  public String toString() {
    return "SatellitePvt[Flags="
        ...
        + this.mClockInfo
        + ", IonoDelayMeters="
        + this.mIonoDelayMeters
        + ", TropoDelayMeters="
        + this.mTropoDelayMeters
        + ", TimeOfClockSeconds="
        + this.mTimeOfClockSeconds
        + ", TimeOfEphemerisSeconds="
        + this.mTimeOfEphemerisSeconds
        + ", IssueOfDataClock="
        + this.mIssueOfDataClock
        + ", IssueOfDataEphemeris="
        + this.mIssueOfDataEphemeris
        + ", EphemerisSource="
        + this.mEphemerisSource
