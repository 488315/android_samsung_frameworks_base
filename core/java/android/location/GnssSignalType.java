...
public final class GnssSignalType implements Parcelable {
  public static final Parcelable.Creator<GnssSignalType> CREATOR =
      new Parcelable.Creator<GnssSignalType>() { // from class: android.location.GnssSignalType.1
  ...
  public static GnssSignalType create(
      int constellationType, double carrierFrequencyHz, String codeType) {
    Preconditions.checkArgument(
        carrierFrequencyHz > SContextConstants.ENVIRONMENT_VALUE_UNKNOWN,
  ...
  public boolean equals(Object obj) {
    ...
    if (this.mConstellationType == other.mConstellationType
        && Double.compare(this.mCarrierFrequencyHz, other.mCarrierFrequencyHz) == 0
        && this.mCodeType.equals(other.mCodeType)) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        Double.valueOf(this.mCarrierFrequencyHz),
        this.mCodeType);
  }
