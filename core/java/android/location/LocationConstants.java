...
public class LocationConstants {
  ...
  public enum STATE_TYPE implements Parcelable {
    ...
    public static final Parcelable.Creator<STATE_TYPE> CREATOR =
        new Parcelable.Creator<
            STATE_TYPE>() { // from class: android.location.LocationConstants.STATE_TYPE.1
  ...
  public enum PAUSED_BY implements Parcelable {
    ...
    public static final Parcelable.Creator<PAUSED_BY> CREATOR =
        new Parcelable.Creator<
            PAUSED_BY>() { // from class: android.location.LocationConstants.PAUSED_BY.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
  ...
  public enum LISTENER_TYPE implements Parcelable {
    ...
    public static final Parcelable.Creator<LISTENER_TYPE> CREATOR =
        new Parcelable.Creator<
            LISTENER_TYPE>() { // from class: android.location.LocationConstants.LISTENER_TYPE.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
