...
public final class GnssStatus implements Parcelable {
  ...
  public static final Parcelable.Creator<GnssStatus> CREATOR =
      new Parcelable.Creator<GnssStatus>() { // from class: android.location.GnssStatus.1
  ...
  public boolean equals(Object o) {
    ...
    return this.mSvCount == that.mSvCount
        && Arrays.equals(this.mSvidWithFlags, that.mSvidWithFlags)
        && Arrays.equals(this.mCn0DbHzs, that.mCn0DbHzs)
        && Arrays.equals(this.mElevations, that.mElevations)
        && Arrays.equals(this.mAzimuths, that.mAzimuths)
        && Arrays.equals(this.mCarrierFrequencies, that.mCarrierFrequencies)
        && Arrays.equals(this.mBasebandCn0DbHzs, that.mBasebandCn0DbHzs);
  }

  public int hashCode() {
    int result = Objects.hash(Integer.valueOf(this.mSvCount));
    return (((result * 31) + Arrays.hashCode(this.mSvidWithFlags)) * 31)
