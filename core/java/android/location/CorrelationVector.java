...
public final class CorrelationVector implements Parcelable {
  public static final Parcelable.Creator<CorrelationVector> CREATOR =
      new Parcelable.Creator<
          CorrelationVector>() { // from class: android.location.CorrelationVector.1
  ...
  private CorrelationVector(Builder builder) {
    ...
    Preconditions.checkArgumentPositive(
        builder.mMagnitude.length, "Magnitude array must have non-zero length");
    Preconditions.checkArgument(
        builder.mFrequencyOffsetMetersPerSecond >= SContextConstants.ENVIRONMENT_VALUE_UNKNOWN,
        "FrequencyOffsetMetersPerSecond must be non-negative (greater than or equal to 0)");
    Preconditions.checkArgument(
        builder.mSamplingWidthMeters > SContextConstants.ENVIRONMENT_VALUE_UNKNOWN,
  ...
  public String toString() {
    return "CorrelationVector{FrequencyOffsetMetersPerSecond="
        + this.mFrequencyOffsetMetersPerSecond
        + ", SamplingWidthMeters="
        + this.mSamplingWidthMeters
        + ", SamplingStartMeters="
        + this.mSamplingStartMeters
        + ", Magnitude="
        + Arrays.toString(this.mMagnitude)
        + '}';
  }
  ...
  public boolean equals(Object object) {
    ...
    return Arrays.equals(this.mMagnitude, c.getMagnitude())
        && Double.compare(this.mSamplingWidthMeters, c.getSamplingWidthMeters()) == 0
        && Double.compare(this.mSamplingStartMeters, c.getSamplingStartMeters()) == 0
        && Double.compare(
                this.mFrequencyOffsetMetersPerSecond, c.getFrequencyOffsetMetersPerSecond())
            == 0;
  }

  public int hashCode() {
    return Objects.hash(
        Double.valueOf(this.mSamplingWidthMeters),
        Double.valueOf(this.mSamplingStartMeters),
        Double.valueOf(this.mFrequencyOffsetMetersPerSecond),
        Integer.valueOf(Arrays.hashCode(this.mMagnitude)));
  }
