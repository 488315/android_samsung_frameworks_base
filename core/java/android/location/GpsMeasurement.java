...
public class GpsMeasurement implements Parcelable {
  ...
  public static final Parcelable.Creator<GpsMeasurement> CREATOR =
      new Parcelable.Creator<GpsMeasurement>() { // from class: android.location.GpsMeasurement.1
  ...
  public void set(GpsMeasurement measurement) {
    ...
    this.mPseudorangeRateUncertaintyInMetersPerSec =
    ...
    this.mAccumulatedDeltaRangeUncertaintyInMeters =
  ...
  public String toString() {
    ...
    builder.append(
        String.format(
            "   %-29s = %-25s   %-40s = %s\n",
            "ReceivedGpsTowInNs",
            Long.valueOf(this.mReceivedGpsTowInNs),
            "ReceivedGpsTowUncertaintyInNs",
            Long.valueOf(this.mReceivedGpsTowUncertaintyInNs)));
    builder.append(String.format("   %-29s = %s\n", "Cn0InDbHz", Double.valueOf(this.mCn0InDbHz)));
    builder.append(
        String.format(
            "   %-29s = %-25s   %-40s = %s\n",
            "PseudorangeRateInMetersPerSec",
            Double.valueOf(this.mPseudorangeRateInMetersPerSec),
            "PseudorangeRateUncertaintyInMetersPerSec",
            Double.valueOf(this.mPseudorangeRateUncertaintyInMetersPerSec)));
    builder.append(
        String.format(
            "   %-29s = %s\n",
    ...
    builder.append(
        String.format(
            ...
            Double.valueOf(this.mAccumulatedDeltaRangeInMeters),
            "AccumulatedDeltaRangeUncertaintyInMeters",
            Double.valueOf(this.mAccumulatedDeltaRangeUncertaintyInMeters)));
    ...
    objArr[3] =
        hasPseudorangeUncertaintyInMeters()
            ? Double.valueOf(this.mPseudorangeUncertaintyInMeters)
            : null;
    ...
    objArr2[3] =
        hasCodePhaseUncertaintyInChips() ? Double.valueOf(this.mCodePhaseUncertaintyInChips) : null;
    builder.append(String.format("   %-29s = %-25s   %-40s = %s\n", objArr2));
    ...
    objArr8[3] =
        hasDopplerShiftUncertaintyInHz() ? Double.valueOf(this.mDopplerShiftUncertaintyInHz) : null;
    builder.append(String.format("   %-29s = %-25s   %-40s = %s\n", objArr8));
    builder.append(
    ...
    objArr10[3] =
        hasElevationUncertaintyInDeg() ? Double.valueOf(this.mElevationUncertaintyInDeg) : null;
    builder.append(String.format("   %-29s = %-25s   %-40s = %s\n", objArr10));
    ...
    objArr11[3] =
        hasAzimuthUncertaintyInDeg() ? Double.valueOf(this.mAzimuthUncertaintyInDeg) : null;
    builder.append(String.format("   %-29s = %-25s   %-40s = %s\n", objArr11));
