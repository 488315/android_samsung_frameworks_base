...
public final class Flags {
    ...
    public static final String FLAG_ENABLE_LOCATION_BYPASS =
            "android.location.flags.enable_location_bypass";
    public static final String FLAG_FIX_SERVICE_WATCHER =
            "android.location.flags.fix_service_watcher";
    public static final String FLAG_GEOID_HEIGHTS_VIA_ALTITUDE_HAL =
            "android.location.flags.geoid_heights_via_altitude_hal";
    public static final String FLAG_GNSS_API_MEASUREMENT_REQUEST_WORK_SOURCE =
    ...
    public static final String FLAG_GNSS_CONFIGURATION_FROM_RESOURCE =
            "android.location.flags.gnss_configuration_from_resource";
    public static final String FLAG_LOCATION_BYPASS = "android.location.flags.location_bypass";
    public static final String FLAG_LOCATION_VALIDATION =
            "android.location.flags.location_validation";
    public static final String FLAG_NEW_GEOCODER = "android.location.flags.new_geocoder";
    public static final String FLAG_RELEASE_SUPL_CONNECTION_ON_TIMEOUT =
            "android.location.flags.release_supl_connection_on_timeout";
    public static final String FLAG_REPLACE_FUTURE_ELAPSED_REALTIME_JNI =
            "android.location.flags.replace_future_elapsed_realtime_jni";
    public static final String FLAG_SUBSCRIPTIONS_CHANGED_LISTENER_THREAD =
