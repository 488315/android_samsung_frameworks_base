...
public final class LastLocationRequest implements Parcelable {
  public static final Parcelable.Creator<LastLocationRequest> CREATOR =
      new Parcelable.Creator<
          LastLocationRequest>() { // from class: android.location.LastLocationRequest.1
  ...
  private LastLocationRequest(
      boolean hiddenFromAppOps, boolean adasGnssBypass, boolean locationSettingsIgnored) {
  ...
  public boolean equals(Object o) {
    ...
    if (this.mHiddenFromAppOps == that.mHiddenFromAppOps
  ...
  public int hashCode() {
    return Objects.hash(
        Boolean.valueOf(this.mHiddenFromAppOps),
        Boolean.valueOf(this.mAdasGnssBypass),
        Boolean.valueOf(this.mLocationSettingsIgnored));
  }
  ...
  public static final class Builder {
    ...
    public LastLocationRequest build() {
      return new LastLocationRequest(
          this.mHiddenFromAppOps, this.mAdasGnssBypass, this.mLocationSettingsIgnored);
    }
  }
}
