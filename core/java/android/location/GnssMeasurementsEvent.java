...
public final class GnssMeasurementsEvent implements Parcelable {
  public static final Parcelable.Creator<GnssMeasurementsEvent> CREATOR =
      new Parcelable.Creator<
          GnssMeasurementsEvent>() { // from class: android.location.GnssMeasurementsEvent.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public GnssMeasurementsEvent createFromParcel(Parcel in) {
          int flag = in.readInt();
          GnssClock clock =
              (GnssClock) in.readParcelable(getClass().getClassLoader(), GnssClock.class);
          List<GnssMeasurement> measurements = in.createTypedArrayList(GnssMeasurement.CREATOR);
          List<GnssAutomaticGainControl> agcs =
              in.createTypedArrayList(GnssAutomaticGainControl.CREATOR);
  ...
  public abstract static class Callback {
    ...
    @Deprecated public static final int STATUS_LOCATION_DISABLED = 2;

    @Deprecated public static final int STATUS_NOT_ALLOWED = 3;

    @Deprecated public static final int STATUS_NOT_SUPPORTED = 0;

    @Deprecated public static final int STATUS_READY = 1;
  ...
  public static final class Builder {
    ...
    public Builder setMeasurements(GnssMeasurement... measurements) {
      this.mMeasurements =
          measurements == null ? Collections.emptyList() : Arrays.asList(measurements);
      return this;
    }
    ...
    public GnssMeasurementsEvent build() {
      return new GnssMeasurementsEvent(
          this.mFlag, this.mClock, this.mMeasurements, this.mGnssAgcs, this.mIsFullTracking);
    }
  }
}
