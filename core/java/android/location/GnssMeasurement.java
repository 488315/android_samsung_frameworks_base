...
public final class GnssMeasurement implements Parcelable {
  ...
  public static final Parcelable.Creator<GnssMeasurement> CREATOR =
      new Parcelable.Creator<GnssMeasurement>() { // from class: android.location.GnssMeasurement.1
        ...
        public GnssMeasurement createFromParcel(Parcel parcel) {
          ...
          if (gnssMeasurement.hasSatellitePvt()) {
            ...
            gnssMeasurement.mSatellitePvt =
                (SatellitePvt) parcel.readParcelable(classLoader, SatellitePvt.class);
          }
  ...
  public void set(GnssMeasurement measurement) {
    ...
    this.mPseudorangeRateUncertaintyMetersPerSecond =
    ...
    this.mAccumulatedDeltaRangeUncertaintyMeters =
  ...
  public void setSatelliteInterSignalBiasUncertaintyNanos(
  ...
  public void writeToParcel(Parcel parcel, int flags) {
    ...
    if (hasCorrelationVectors()) {
      ...
      CorrelationVector[] correlationVectorArray =
          (CorrelationVector[])
              this.mReadOnlyCorrelationVectors.toArray(
                  new CorrelationVector[correlationVectorCount]);
  ...
  public String toString() {
    ...
    builder.append(
        String.format(
            "   %-29s = %-25s   %-40s = %s\n",
            "ReceivedSvTimeNanos",
            Long.valueOf(this.mReceivedSvTimeNanos),
            "ReceivedSvTimeUncertaintyNanos",
            Long.valueOf(this.mReceivedSvTimeUncertaintyNanos)));
    ...
    builder.append(
        String.format(
            ...
            Double.valueOf(this.mPseudorangeRateMetersPerSecond),
            "PseudorangeRateUncertaintyMetersPerSecond",
            Double.valueOf(this.mPseudorangeRateUncertaintyMetersPerSecond)));
    builder.append(
        String.format(
            "   %-29s = %s\n",
    ...
    builder.append(
        String.format(
            ...
            Double.valueOf(this.mAccumulatedDeltaRangeMeters),
            "AccumulatedDeltaRangeUncertaintyMeters",
            Double.valueOf(this.mAccumulatedDeltaRangeUncertaintyMeters)));
    ...
    if (hasCarrierPhase() || hasCarrierPhaseUncertainty()) {
      ...
      objArr[3] =
          hasCarrierPhaseUncertainty() ? Double.valueOf(this.mCarrierPhaseUncertainty) : null;
    ...
    if (hasFullInterSignalBiasNanos() || hasFullInterSignalBiasUncertaintyNanos()) {
      ...
      objArr2[1] =
          hasFullInterSignalBiasNanos() ? Double.valueOf(this.mFullInterSignalBiasNanos) : null;
      objArr2[2] = "InterSignalBiasUncertaintyNs";
      objArr2[3] =
          hasFullInterSignalBiasUncertaintyNanos()
              ? Double.valueOf(this.mFullInterSignalBiasUncertaintyNanos)
              : null;
      builder.append(String.format("   %-29s = %-25s   %-40s = %s\n", objArr2));
    }
    if (hasSatelliteInterSignalBiasNanos() || hasSatelliteInterSignalBiasUncertaintyNanos()) {
      ...
      objArr3[1] =
          hasSatelliteInterSignalBiasNanos()
              ? Double.valueOf(this.mSatelliteInterSignalBiasNanos)
              : null;
      objArr3[2] = "SatelliteInterSignalBiasUncertaintyNs";
      objArr3[3] =
          hasSatelliteInterSignalBiasUncertaintyNanos()
              ? Double.valueOf(this.mSatelliteInterSignalBiasUncertaintyNanos)
              : null;
      builder.append(String.format("   %-29s = %-25s   %-40s = %s\n", objArr3));
    }
    if (hasSatellitePvt()) {
