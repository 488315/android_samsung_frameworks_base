...
public final class GnssClock implements Parcelable {
  public static final Parcelable.Creator<GnssClock> CREATOR =
      new Parcelable.Creator<GnssClock>() { // from class: android.location.GnssClock.1
  ...
  public String toString() {
    ...
    if (hasDriftNanosPerSecond() || hasDriftUncertaintyNanosPerSecond()) {
      ...
      objArr3[3] =
          hasDriftUncertaintyNanosPerSecond()
              ? Double.valueOf(this.mDriftUncertaintyNanosPerSecond)
              : null;
      builder.append(String.format("   %-15s = %-25s   %-26s = %s\n", objArr3));
    }
    builder.append(
        String.format(
            ...
            Integer.valueOf(this.mHardwareClockDiscontinuityCount)));
    if (hasElapsedRealtimeNanos() || hasElapsedRealtimeUncertaintyNanos()) {
      ...
      objArr4[3] =
          hasElapsedRealtimeUncertaintyNanos()
              ? Double.valueOf(this.mElapsedRealtimeUncertaintyNanos)
              : null;
      builder.append(String.format("   %-15s = %-25s   %-26s = %s\n", objArr4));
    }
    if (hasReferenceConstellationTypeForIsb()) {
      builder.append(
          String.format(
              "   %-15s = %s\n",
              "ReferenceConstellationTypeForIsb",
              Integer.valueOf(this.mReferenceConstellationTypeForIsb)));
    }
    if (hasReferenceCarrierFrequencyHzForIsb()) {
      builder.append(
          String.format(
              "   %-15s = %s\n",
              "ReferenceCarrierFrequencyHzForIsb",
              Double.valueOf(this.mReferenceCarrierFrequencyHzForIsb)));
    }
