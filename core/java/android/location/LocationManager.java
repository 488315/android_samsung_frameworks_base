...
public class LocationManager {
  ...
  @SystemApi public static final String GPS_HARDWARE_PROVIDER = "gps_hardware";
  ...
  @Deprecated public static final String KEY_STATUS_CHANGED = "status";
  ...
  public boolean isAdasGnssLocationEnabled() {
    try {
      return this.mService.isAdasGnssLocationEnabledForUser(
  ...
  public void setAdasGnssLocationEnabled(boolean enabled) {
    try {
      this.mService.setAdasGnssLocationEnabledForUser(
          enabled, this.mContext.getUser().getIdentifier());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public Location getLastKnownLocation(String provider, LastLocationRequest lastLocationRequest) {
    ...
    try {
      return this.mService.getLastLocation(
          provider,
          lastLocationRequest,
  ...
  public void getCurrentLocation(
    ...
    getCurrentLocation(
        provider, new LocationRequest.Builder(0L).build(), cancellationSignal, executor, consumer);
  }
  ...
  public void getCurrentLocation(
    ...
    getCurrentLocation(
        locationRequest.getProvider(), locationRequest, cancellationSignal, executor, consumer);
  }
  ...
  public void getCurrentLocation(
    ...
    GetCurrentLocationTransport transport =
        new GetCurrentLocationTransport(executor, consumer, cancellationSignal);
    try {
  ...
  public void requestSingleUpdate(String provider, LocationListener listener, Looper looper) {
    ...
    requestLocationUpdates(
        provider,
        new LocationRequest.Builder(0L).setMaxUpdates(1).setDurationMillis(30000L).build(),
  ...
  public void requestSingleUpdate(Criteria criteria, LocationListener listener, Looper looper) {
    ...
    requestLocationUpdates(
        FUSED_PROVIDER,
        new LocationRequest.Builder(0L)
            .setQuality(criteria)
            .setMaxUpdates(1)
  ...
  public void requestLocationUpdates(
      String provider, long minTimeMs, float minDistanceM, LocationListener listener) {
  ...
  public void requestLocationUpdates(
    ...
    Handler handler = looper == null ? new Handler() : new Handler(looper);
    requestLocationUpdates(
        provider, minTimeMs, minDistanceM, new HandlerExecutor(handler), listener);
  }
  ...
  public void requestLocationUpdates(
    ...
    requestLocationUpdates(
        provider,
        LocationRequest.createFromDeprecatedProvider(provider, minTimeMs, minDistanceM, false),
        executor,
        listener);
  }
  ...
  public void requestLocationUpdates(
    ...
    Handler handler = looper == null ? new Handler() : new Handler(looper);
    requestLocationUpdates(
        minTimeMs, minDistanceM, criteria, new HandlerExecutor(handler), listener);
  }
  ...
  public void requestLocationUpdates(
    ...
    requestLocationUpdates(
        FUSED_PROVIDER,
        LocationRequest.createFromDeprecatedCriteria(criteria, minTimeMs, minDistanceM, false),
        executor,
        listener);
  }

  public void requestLocationUpdates(
      String provider, long minTimeMs, float minDistanceM, PendingIntent pendingIntent) {
    Preconditions.checkArgument(provider != null, "invalid null provider");
    requestLocationUpdates(
        provider,
        LocationRequest.createFromDeprecatedProvider(provider, minTimeMs, minDistanceM, false),
  ...
  @Deprecated
  public void requestLocationUpdates(
      long minTimeMs, float minDistanceM, Criteria criteria, PendingIntent pendingIntent) {
    Preconditions.checkArgument(criteria != null, "invalid null criteria");
    requestLocationUpdates(
        FUSED_PROVIDER,
        LocationRequest.createFromDeprecatedCriteria(criteria, minTimeMs, minDistanceM, false),
  ...
  @Deprecated
  public void requestLocationUpdates(
      LocationRequest locationRequest, LocationListener listener, Looper looper) {
    Handler handler = looper == null ? new Handler() : new Handler(looper);
  ...
  @Deprecated
  public void requestLocationUpdates(
      LocationRequest locationRequest, Executor executor, LocationListener listener) {
  ...
  public void requestLocationUpdates(
    ...
    Preconditions.checkArgument(locationRequest != null, "invalid null location request");
    try {
      WeakHashMap<LocationListener, WeakReference<LocationListenerTransport>> weakHashMap =
          sLocationListeners;
      synchronized (weakHashMap) {
        ...
        this.mService.registerLocationListener(
            provider,
            locationRequest,
            transport,
            this.mContext.getPackageName(),
  ...
  public void requestLocationUpdates(
      String provider, LocationRequest locationRequest, PendingIntent pendingIntent) {
    Preconditions.checkArgument(provider != null, "invalid null provider");
    Preconditions.checkArgument(locationRequest != null, "invalid null location request");
    Preconditions.checkArgument(pendingIntent != null, "invalid null pending intent");
    if (Compatibility.isChangeEnabled(BLOCK_UNTARGETED_PENDING_INTENTS)) {
      Preconditions.checkArgument(
          pendingIntent.isTargetedToPackage(), "pending intent must be targeted to a package");
    }
    ...
    try {
      this.mService.registerLocationPendingIntent(
          provider,
          locationRequest,
          pendingIntent,
          this.mContext.getPackageName(),
      ...
      if (NETWORK_PROVIDER.equals(provider) || FUSED_PROVIDER.equals(provider)) {
        try {
          this.mContext.enforcePermission(
              Manifest.permission.ACCESS_FINE_LOCATION, Process.myPid(), Process.myUid(), null);
        } catch (SecurityException e) {
          this.mContext.enforcePermission(
              Manifest.permission.ACCESS_COARSE_LOCATION, Process.myPid(), Process.myUid(), null);
        }
      } else {
        this.mContext.enforcePermission(
            Manifest.permission.ACCESS_FINE_LOCATION, Process.myPid(), Process.myUid(), null);
  ...
  public boolean isProviderPackage(String provider, String packageName, String attributionTag) {
    try {
      return this.mService.isProviderPackage(
          provider, (String) Objects.requireNonNull(packageName), attributionTag);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void addTestProvider(
      String provider, ProviderProperties properties, Set<String> extraAttributionTags) {
    Preconditions.checkArgument(provider != null, "invalid null provider");
    Preconditions.checkArgument(properties != null, "invalid null properties");
    Preconditions.checkArgument(
        extraAttributionTags != null, "invalid null extra attribution tags");
    try {
      this.mService.addTestProvider(
          provider,
          properties,
          new ArrayList(extraAttributionTags),
  ...
  public void removeTestProvider(String provider) {
    ...
    try {
      this.mService.removeTestProvider(
          provider, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void setTestProviderLocation(String provider, Location location) {
    ...
    try {
      this.mService.setTestProviderLocation(
          provider, location, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void setTestProviderEnabled(String provider, boolean enabled) {
    ...
    try {
      this.mService.setTestProviderEnabled(
          provider, enabled, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void addProximityAlert(
    ...
    if (Compatibility.isChangeEnabled(BLOCK_IMMUTABLE_PENDING_INTENTS)) {
      Preconditions.checkArgument(
          true ^ pendingIntent.isImmutable(), "pending intent must be mutable");
    }
    if (expiration < 0) {
    ...
    try {
      ...
      this.mService.requestGeofence(
          fence, pendingIntent, this.mContext.getPackageName(), this.mContext.getAttributionTag());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public boolean addGpsStatusListener(GpsStatus.Listener listener) {
    ...
    GnssLazyLoader.sGnssStatusListeners.addListener(
        listener,
        new GpsStatusTransport(new HandlerExecutor(new Handler()), this.mContext, listener));
    return true;
  }
  ...
  public boolean registerGnssStatusCallback(Executor executor, GnssStatus.Callback callback) {
    GnssLazyLoader.sGnssStatusListeners.addListener(
        callback, new GnssStatusTransport(executor, this.mContext, callback));
    return true;
  }
  ...
  public boolean addNmeaListener(Executor executor, OnNmeaMessageListener listener) {
    GnssLazyLoader.sGnssNmeaListeners.addListener(
        listener, new GnssNmeaTransport(executor, this.mContext, listener));
    return true;
  }
  ...
  public boolean registerGnssMeasurementsCallback(
    ...
    return registerGnssMeasurementsCallback(
        new GnssMeasurementRequest.Builder().build(), new HandlerExecutor(handler), callback);
  }

  public boolean registerGnssMeasurementsCallback(
      Executor executor, GnssMeasurementsEvent.Callback callback) {
    return registerGnssMeasurementsCallback(
        new GnssMeasurementRequest.Builder().build(), executor, callback);
  }

  @SystemApi
  @Deprecated
  public boolean registerGnssMeasurementsCallback(
      GnssRequest request, Executor executor, GnssMeasurementsEvent.Callback callback) {
    return registerGnssMeasurementsCallback(request.toGnssMeasurementRequest(), executor, callback);
  }

  public boolean registerGnssMeasurementsCallback(
      GnssMeasurementRequest request, Executor executor, GnssMeasurementsEvent.Callback callback) {
    GnssLazyLoader.sGnssMeasurementsListeners.addListener(
        callback, new GnssMeasurementsTransport(executor, this.mContext, request, callback));
    return true;
  }
  ...
  public boolean registerAntennaInfoListener(Executor executor, GnssAntennaInfo.Listener listener) {
    GnssLazyLoader.sGnssAntennaInfoListeners.addListener(
        listener, new GnssAntennaInfoTransport(executor, this.mContext, listener));
    return true;
  }
  ...
  public boolean registerGnssNavigationMessageCallback(
      Executor executor, GnssNavigationMessage.Callback callback) {
    GnssLazyLoader.sGnssNavigationListeners.addListener(
        callback, new GnssNavigationTransport(executor, this.mContext, callback));
    return true;
  }
  ...
  public void addProviderRequestChangedListener(
      Executor executor, ProviderRequest.ChangedListener listener) {
    ProviderRequestLazyLoader.sProviderRequestListeners.addListener(
        listener, new ProviderRequestTransport(executor, listener));
  }
  ...
  @SystemApi
  @Deprecated
  public boolean registerGnssBatchedLocationCallback(
      long periodNanos, boolean wakeOnFifoFull, BatchedLocationCallback callback, Handler handler) {
    if (handler == null) {
      handler = new Handler();
    }
    try {
      this.mService.startGnssBatch(
          periodNanos,
  ...
  private static class GnssStatusTransportManager
    ...
    public void registerTransport(GnssStatusTransport transport) throws RemoteException {
      LocationManager.getService()
          .registerGnssStatusCallback(
              transport,
              transport.getPackage(),
  ...
  static class GetCurrentLocationTransport extends ILocationCallback.Stub
      implements ListenerExecutor, CancellationSignal.OnCancelListener {
    volatile Consumer<Location> mConsumer;
    private final Executor mExecutor;

    GetCurrentLocationTransport(
        Executor executor, Consumer<Location> consumer, CancellationSignal cancellationSignal) {
    ...
    public void onLocation(final Location location) {
      executeSafely(
          ...
          new Supplier() { // from class:
                           // android.location.LocationManager$GetCurrentLocationTransport$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
              Consumer lambda$onLocation$0;
              lambda$onLocation$0 =
                  LocationManager.GetCurrentLocationTransport.this.lambda$onLocation$0();
              return lambda$onLocation$0;
            }
          },
          new ListenerExecutor.ListenerOperation<
              Consumer<
                  Location>>() { // from class:
                                 // android.location.LocationManager.GetCurrentLocationTransport.1
  ...
  /* JADX INFO: Access modifiers changed from: private */
  static class LocationListenerTransport extends ILocationListener.Stub
    ...
    public void onLocationChanged(
        final List<Location> locations, final IRemoteCallback onCompleteCallback) {
      executeSafely(
          this.mExecutor,
          new Supplier() { // from class:
            ...
            public final Object get() {
              ...
              lambda$onLocationChanged$0 =
                  LocationManager.LocationListenerTransport.this.lambda$onLocationChanged$0();
              return lambda$onLocationChanged$0;
            }
          },
          new ListenerExecutor.ListenerOperation<
              LocationListener>() { // from class:
    ...
    public void onFlushComplete(final int requestCode) {
      executeSafely(
          this.mExecutor,
          new Supplier() { // from class:
                           // android.location.LocationManager$LocationListenerTransport$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
              LocationListener lambda$onFlushComplete$1;
              lambda$onFlushComplete$1 =
                  LocationManager.LocationListenerTransport.this.lambda$onFlushComplete$1();
      ...
      executeSafely(
          ...
          new Supplier() { // from class:
            ...
            public final Object get() {
              ...
              lambda$onProviderEnabledChanged$3 =
                  LocationManager.LocationListenerTransport.this
                      .lambda$onProviderEnabledChanged$3();
          ...
          new ListenerExecutor
            ...
            @Override // com.android.internal.listeners.ListenerExecutor.ListenerOperation
            public final void operate(Object obj) {
              LocationManager.LocationListenerTransport.lambda$onProviderEnabledChanged$4(
                  enabled, provider, (LocationListener) obj);
            }
          });
    }

    static /* synthetic */ void lambda$onProviderEnabledChanged$4(
        boolean enabled, String provider, LocationListener listener) throws Exception {
      if (enabled) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  static class GnssStatusTransport extends IGnssStatusListener.Stub
    ...
    public void onGnssStarted() {
      execute(
          ...
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssStatusTransport$$ExternalSyntheticLambda3
    ...
    public void onGnssStopped() {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssStatusTransport$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onFirstFix(final int ttff) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssStatusTransport$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onSvStatusChanged(final GnssStatus gnssStatus) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssStatusTransport$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  private static class GpsStatusTransport extends GnssStatusTransport {
    ...
    @Override // android.location.LocationManager.GnssStatusTransport,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  static class GnssNmeaTransport extends IGnssNmeaListener.Stub
    ...
    public void onNmeaReceived(final long timestamp, final String nmea) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssNmeaTransport$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  static class GnssMeasurementsTransport extends IGnssMeasurementsListener.Stub
    ...
    public void onGnssMeasurementsReceived(final GnssMeasurementsEvent event) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssMeasurementsTransport$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((GnssMeasurementsEvent.Callback) obj)
                  .onGnssMeasurementsReceived(GnssMeasurementsEvent.this);
            }
          });
    }
    ...
    public void onStatusChanged(final int status) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssMeasurementsTransport$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  static class GnssAntennaInfoTransport extends IGnssAntennaInfoListener.Stub
    ...
    GnssAntennaInfoTransport(
        Executor executor, Context context, GnssAntennaInfo.Listener listener) {
      Preconditions.checkArgument(executor != null, "invalid null executor");
      Preconditions.checkArgument(listener != null, "invalid null listener");
      this.mExecutor = executor;
      this.mPackageName = context.getPackageName();
    ...
    public void onGnssAntennaInfoChanged(final List<GnssAntennaInfo> antennaInfos) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssAntennaInfoTransport$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  static class GnssNavigationTransport extends IGnssNavigationMessageListener.Stub
    ...
    public void onGnssNavigationMessageReceived(final GnssNavigationMessage event) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssNavigationTransport$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((GnssNavigationMessage.Callback) obj)
                  .onGnssNavigationMessageReceived(GnssNavigationMessage.this);
            }
          });
    }
    ...
    public void onStatusChanged(final int status) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$GnssNavigationTransport$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  static class ProviderRequestTransport extends IProviderRequestListener.Stub
    ...
    public void onProviderRequestChanged(final String provider, final ProviderRequest request) {
      execute(
          this.mExecutor,
          new Consumer() { // from class:
                           // android.location.LocationManager$ProviderRequestTransport$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
