...
public class LocationManager {
    ...
    private static class GnssStatusTransportManager extends ListenerTransportManager<GnssStatusTransport> {
    ...
    private static class GnssNmeaTransportManager extends ListenerTransportManager<GnssNmeaTransport> {
    ...
    private static class GnssMeasurementsTransportManager extends ListenerTransportManager<GnssMeasurementsTransport> {
    ...
    private static class GnssNavigationTransportManager extends ListenerTransportManager<GnssNavigationTransport> {
    ...
    static class GetCurrentLocationTransport extends ILocationCallback.Stub implements ListenerExecutor, CancellationSignal.OnCancelListener {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static class LocationListenerTransport extends ILocationListener.Stub implements ListenerExecutor {
        ...
        static /* synthetic */ void lambda$onProviderEnabledChanged$4(boolean enabled, String provider, LocationListener listener) throws Exception {
            if (enabled) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static class GnssStatusTransport extends IGnssStatusListener.Stub implements ListenerTransport<GnssStatus.Callback> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static class GnssNmeaTransport extends IGnssNmeaListener.Stub implements ListenerTransport<OnNmeaMessageListener> {
        private final String mAttributionTag;
        private final Executor mExecutor;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static class GnssMeasurementsTransport extends IGnssMeasurementsListener.Stub implements ListenerTransport<GnssMeasurementsEvent.Callback> {
        private final String mAttributionTag;
        private final Executor mExecutor;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static class GnssAntennaInfoTransport extends IGnssAntennaInfoListener.Stub implements ListenerTransport<GnssAntennaInfo.Listener> {
        private final String mAttributionTag;
        private final Executor mExecutor;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static class GnssNavigationTransport extends IGnssNavigationMessageListener.Stub implements ListenerTransport<GnssNavigationMessage.Callback> {
        private final String mAttributionTag;
        private final Executor mExecutor;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static class ProviderRequestTransport extends IProviderRequestListener.Stub implements ListenerTransport<ProviderRequest.ChangedListener> {
        private final Executor mExecutor;
