...
public class GpsMeasurementsEvent implements Parcelable {
  public static final Parcelable.Creator<GpsMeasurementsEvent> CREATOR =
      new Parcelable.Creator<
          GpsMeasurementsEvent>() { // from class: android.location.GpsMeasurementsEvent.1
  ...
  public void writeToParcel(Parcel parcel, int flags) {
    ...
    GpsMeasurement[] measurementsArray =
        (GpsMeasurement[])
            this.mReadOnlyMeasurements.toArray(new GpsMeasurement[measurementsCount]);
