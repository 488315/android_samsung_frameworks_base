...
public final class GnssMeasurementRequest implements Parcelable {
  public static final Parcelable.Creator<GnssMeasurementRequest> CREATOR =
      new Parcelable.Creator<
          GnssMeasurementRequest>() { // from class: android.location.GnssMeasurementRequest.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public GnssMeasurementRequest createFromParcel(Parcel parcel) {
          return new GnssMeasurementRequest(
              parcel.readBoolean(), parcel.readBoolean(), parcel.readInt());
        }
  ...
  private GnssMeasurementRequest(
      boolean fullTracking, boolean correlationVectorOutputsEnabled, int intervalMillis) {
  ...
  public boolean equals(Object obj) {
    ...
    if (this.mFullTracking == other.mFullTracking
        && this.mCorrelationVectorOutputsEnabled == other.mCorrelationVectorOutputsEnabled
        && this.mIntervalMillis == other.mIntervalMillis) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        Boolean.valueOf(this.mFullTracking),
        Boolean.valueOf(this.mCorrelationVectorOutputsEnabled),
  ...
  public static final class Builder {
    ...
    public Builder setIntervalMillis(int value) {
      this.mIntervalMillis =
          Preconditions.checkArgumentInRange(value, 0, Integer.MAX_VALUE, "intervalMillis");
      return this;
    }

    public GnssMeasurementRequest build() {
      return new GnssMeasurementRequest(
          this.mFullTracking, this.mCorrelationVectorOutputsEnabled, this.mIntervalMillis);
    }
  }
}
