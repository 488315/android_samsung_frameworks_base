...
public final class GnssCapabilities implements Parcelable {
  ...
  public static final Parcelable.Creator<GnssCapabilities> CREATOR =
      new Parcelable.Creator<
          GnssCapabilities>() { // from class: android.location.GnssCapabilities.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public GnssCapabilities createFromParcel(Parcel in) {
          return new GnssCapabilities(
              in.readInt(),
              in.readBoolean(),
              in.readInt(),
              in.readInt(),
  ...
  private GnssCapabilities(
      ...
      int measurementCorrectionsFlags,
      int powerFlags,
      List<GnssSignalType> gnssSignalTypes) {
  ...
  public GnssCapabilities withTopHalFlags(int flags, boolean isAdrCapabilityKnown) {
    ...
    return new GnssCapabilities(
        ...
        this.mMeasurementCorrectionsFlags,
        this.mPowerFlags,
        this.mGnssSignalTypes);
  }
  ...
  public GnssCapabilities withSubHalMeasurementCorrectionsFlags(int flags) {
    ...
    return new GnssCapabilities(
        this.mTopFlags, this.mIsAdrCapabilityKnown, flags, this.mPowerFlags, this.mGnssSignalTypes);
  }
  ...
  public boolean equals(Object o) {
    ...
    return this.mTopFlags == that.mTopFlags
        && this.mIsAdrCapabilityKnown == that.mIsAdrCapabilityKnown
        && this.mMeasurementCorrectionsFlags == that.mMeasurementCorrectionsFlags
        && this.mPowerFlags == that.mPowerFlags
        && this.mGnssSignalTypes.equals(that.mGnssSignalTypes);
  }

  public int hashCode() {
    return Objects.hash(
        Integer.valueOf(this.mTopFlags),
        Boolean.valueOf(this.mIsAdrCapabilityKnown),
        Integer.valueOf(this.mMeasurementCorrectionsFlags),
        Integer.valueOf(this.mPowerFlags),
        this.mGnssSignalTypes);
  }
  ...
  public static final class Builder {
    ...
    public GnssCapabilities build() {
      return new GnssCapabilities(
          ...
          this.mMeasurementCorrectionsFlags,
          this.mPowerFlags,
          new ArrayList(this.mGnssSignalTypes));
    }
