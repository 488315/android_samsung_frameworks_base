...
public final class LocationRequest implements Parcelable {
  ...
  @SystemApi @Deprecated public static final int ACCURACY_BLOCK = 102;

  @SystemApi @Deprecated public static final int ACCURACY_CITY = 104;

  @SystemApi @Deprecated public static final int ACCURACY_FINE = 100;
  public static final Parcelable.Creator<LocationRequest> CREATOR =
      new Parcelable.Creator<LocationRequest>() { // from class: android.location.LocationRequest.1
  ...
  @SystemApi @Deprecated public static final int POWER_HIGH = 203;

  @SystemApi @Deprecated public static final int POWER_LOW = 201;

  @SystemApi @Deprecated public static final int POWER_NONE = 200;
  ...
  public static LocationRequest createFromDeprecatedProvider(
    ...
    return new Builder(intervalMillis)
  ...
  public static LocationRequest createFromDeprecatedCriteria(
      Criteria criteria, long intervalMillis, float minUpdateDistanceMeters, boolean singleShot) {
  ...
  public LocationRequest setSmallestDisplacement(float minDisplacementMeters) {
    this.mMinUpdateDistanceMeters =
        Preconditions.checkArgumentInRange(
            minDisplacementMeters, 0.0f, Float.MAX_VALUE, "minDisplacementMeters");
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (this.mIntervalMillis == that.mIntervalMillis
        && this.mQuality == that.mQuality
        && this.mExpireAtRealtimeMillis == that.mExpireAtRealtimeMillis
        && this.mDurationMillis == that.mDurationMillis
        && this.mMaxUpdates == that.mMaxUpdates
        && this.mMinUpdateIntervalMillis == that.mMinUpdateIntervalMillis
        && Float.compare(that.mMinUpdateDistanceMeters, this.mMinUpdateDistanceMeters) == 0
        && this.mMaxUpdateDelayMillis == that.mMaxUpdateDelayMillis
        && this.mHideFromAppOps == that.mHideFromAppOps
        && this.mAdasGnssBypass == that.mAdasGnssBypass
        && this.mBypass == that.mBypass
        && this.mLowPower == that.mLowPower
        && Objects.equals(this.mProvider, that.mProvider)
        && Objects.equals(this.mWorkSource, that.mWorkSource)) {
      return true;
    }
    return false;
  }
  ...
  public static final class Builder {
    ...
    public Builder setIntervalMillis(long intervalMillis) {
      this.mIntervalMillis =
          Preconditions.checkArgumentInRange(intervalMillis, 0L, Long.MAX_VALUE, "intervalMillis");
      return this;
    }

    public Builder setQuality(int quality) {
      Preconditions.checkArgument(
          quality == 104 || quality == 102 || quality == 100,
    ...
    public Builder setDurationMillis(long durationMillis) {
      this.mDurationMillis =
          Preconditions.checkArgumentInRange(durationMillis, 1L, Long.MAX_VALUE, "durationMillis");
      return this;
    }

    public Builder setMaxUpdates(int maxUpdates) {
      this.mMaxUpdates =
          Preconditions.checkArgumentInRange(maxUpdates, 1, Integer.MAX_VALUE, "maxUpdates");
      return this;
    }

    public Builder setMinUpdateIntervalMillis(long minUpdateIntervalMillis) {
      this.mMinUpdateIntervalMillis =
          Preconditions.checkArgumentInRange(
              minUpdateIntervalMillis, 0L, Long.MAX_VALUE, "minUpdateIntervalMillis");
      return this;
    }
    ...
    public Builder setMinUpdateDistanceMeters(float minUpdateDistanceMeters) {
      this.mMinUpdateDistanceMeters =
          Preconditions.checkArgumentInRange(
              minUpdateDistanceMeters, 0.0f, Float.MAX_VALUE, "minUpdateDistanceMeters");
      return this;
    }

    public Builder setMaxUpdateDelayMillis(long maxUpdateDelayMillis) {
      this.mMaxUpdateDelayMillis =
          Preconditions.checkArgumentInRange(
              maxUpdateDelayMillis, 0L, Long.MAX_VALUE, "maxUpdateDelayMillis");
      return this;
    }
    ...
    public LocationRequest build() {
      Preconditions.checkState(
          (this.mIntervalMillis == Long.MAX_VALUE && this.mMinUpdateIntervalMillis == -1)
              ? false
              : true,
      ...
      return new LocationRequest(
          ...
          this.mDurationMillis,
          this.mMaxUpdates,
          Math.min(this.mMinUpdateIntervalMillis, j),
          this.mMinUpdateDistanceMeters,
          this.mMaxUpdateDelayMillis,
          this.mHiddenFromAppOps,
          this.mAdasGnssBypass,
          this.mBypass,
          this.mLowPower,
          new WorkSource(this.mWorkSource));
    }
  }
}
