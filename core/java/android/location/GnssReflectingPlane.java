...
public final class GnssReflectingPlane implements Parcelable {
  public static final Parcelable.Creator<GnssReflectingPlane> CREATOR =
      new Parcelable.Creator<
          GnssReflectingPlane>() { // from class: android.location.GnssReflectingPlane.1
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        Double.valueOf(this.mLatitudeDegrees),
        Double.valueOf(this.mAltitudeMeters),
        Double.valueOf(this.mAzimuthDegrees));
  }
