...
public final class GnssExcessPathInfo implements Parcelable {
  public static final Parcelable.Creator<GnssExcessPathInfo> CREATOR =
      new Parcelable.Creator<
          GnssExcessPathInfo>() { // from class: android.location.GnssExcessPathInfo.1
        ...
        public GnssExcessPathInfo createFromParcel(Parcel parcel) {
          ...
          GnssReflectingPlane reflectingPlane =
              (flags & 4) != 0 ? GnssReflectingPlane.CREATOR.createFromParcel(parcel) : null;
  ...
  public float getExcessPathLengthMeters() {
    if (!hasExcessPathLength()) {
      throw new UnsupportedOperationException(
          "getExcessPathLengthMeters() is not supported when hasExcessPathLength() is false");
    }
  ...
  public boolean equals(Object obj) {
    ...
    if (hasExcessPathLength()
        && Float.compare(this.mExcessPathLengthMeters, that.mExcessPathLengthMeters) != 0) {
      return false;
    }
    if (hasExcessPathLengthUncertainty()
        && Float.compare(
                this.mExcessPathLengthUncertaintyMeters, that.mExcessPathLengthUncertaintyMeters)
            != 0) {
      return false;
    }
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        Float.valueOf(this.mExcessPathLengthMeters),
        Float.valueOf(this.mExcessPathLengthUncertaintyMeters),
        this.mReflectingPlane,
        Float.valueOf(this.mAttenuationDb));
  }
  ...
  public String toString() {
    ...
    if (hasExcessPathLengthUncertainty()) {
      builder
          .append(" ExcessPathLengthUncertaintyMeters=")
          .append(this.mExcessPathLengthUncertaintyMeters);
    }
    if (hasReflectingPlane()) {
  ...
  public static final class Builder {
    ...
    public Builder setExcessPathLengthMeters(float excessPathLengthMeters) {
      Preconditions.checkArgumentInRange(
          excessPathLengthMeters, 0.0f, Float.MAX_VALUE, "excessPathLengthMeters");
      this.mExcessPathLengthMeters = excessPathLengthMeters;
      this.mFlags |= 1;
      return this;
    }
