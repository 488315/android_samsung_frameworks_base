...
public final class CallerIdentity {
  ...
  public static CallerIdentity forTest(
      int uid, int pid, String packageName, String attributionTag) {
    return forTest(uid, pid, packageName, attributionTag, null);
  }

  public static CallerIdentity forTest(
      int uid, int pid, String packageName, String attributionTag, String listenerId) {
  ...
  public static CallerIdentity fromBinder(
      Context context, String packageName, String attributionTag) {
    return fromBinder(context, packageName, attributionTag, null);
  }

  public static CallerIdentity fromBinder(
      Context context, String packageName, String attributionTag, String listenerId) {
  ...
  public static CallerIdentity fromBinderUnsafe(
      String packageName, String attributionTag, String listenerId) {
    return new CallerIdentity(
        Binder.getCallingUid(), Binder.getCallingPid(), packageName, attributionTag, listenerId);
  }
  ...
  public boolean equals(Object o) {
    ...
    return this.mUid == that.mUid
        ...
        && ((str = this.mListenerId) == null
            || (str2 = that.mListenerId) == null
            || str.equals(str2));
  }
