...
public final class ProviderProperties implements Parcelable {
  ...
  public static final Parcelable.Creator<ProviderProperties> CREATOR =
      new Parcelable.Creator<
          ProviderProperties>() { // from class: android.location.provider.ProviderProperties.1
  ...
  public boolean equals(Object o) {
    ...
    return this.mHasNetworkRequirement == that.mHasNetworkRequirement
        && this.mHasSatelliteRequirement == that.mHasSatelliteRequirement
        && this.mHasCellRequirement == that.mHasCellRequirement
        && this.mHasMonetaryCost == that.mHasMonetaryCost
        && this.mHasAltitudeSupport == that.mHasAltitudeSupport
        && this.mHasSpeedSupport == that.mHasSpeedSupport
        && this.mHasBearingSupport == that.mHasBearingSupport
        && this.mPowerUsage == that.mPowerUsage
        && this.mAccuracy == that.mAccuracy;
  }

  public int hashCode() {
    return Objects.hash(
        Boolean.valueOf(this.mHasNetworkRequirement),
        Boolean.valueOf(this.mHasSatelliteRequirement),
        Boolean.valueOf(this.mHasCellRequirement),
        Boolean.valueOf(this.mHasMonetaryCost),
        Boolean.valueOf(this.mHasAltitudeSupport),
        Boolean.valueOf(this.mHasSpeedSupport),
        Boolean.valueOf(this.mHasBearingSupport),
        Integer.valueOf(this.mPowerUsage),
        Integer.valueOf(this.mAccuracy));
  }
  ...
  public static final class Builder {
    ...
    public ProviderProperties build() {
      return new ProviderProperties(
          this.mHasNetworkRequirement,
          this.mHasSatelliteRequirement,
          this.mHasCellRequirement,
          this.mHasMonetaryCost,
          this.mHasAltitudeSupport,
          this.mHasSpeedSupport,
          this.mHasBearingSupport,
          this.mPowerUsage,
          this.mAccuracy);
    }
  }
