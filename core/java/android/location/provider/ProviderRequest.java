...
public final class ProviderRequest implements Parcelable {
  ...
  public static final ProviderRequest EMPTY_REQUEST =
      new ProviderRequest(Long.MAX_VALUE, 102, 0, false, false, false, new WorkSource());
  public static final Parcelable.Creator<ProviderRequest> CREATOR =
      new Parcelable.Creator<
          ProviderRequest>() { // from class: android.location.provider.ProviderRequest.1
  ...
  public boolean equals(Object o) {
    ...
    if (j == that.mIntervalMillis
        ...
        && this.mLocationSettingsIgnored == that.mLocationSettingsIgnored
  ...
  public int hashCode() {
    return Objects.hash(
        Long.valueOf(this.mIntervalMillis), Integer.valueOf(this.mQuality), this.mWorkSource);
  }
