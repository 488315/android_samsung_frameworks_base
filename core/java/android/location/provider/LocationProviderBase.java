...
public abstract class LocationProviderBase {
  ...
  private static Location stripExtras(Location location) {
    ...
    if (extras != null
        && (extras.containsKey(Location.EXTRA_NO_GPS_LOCATION)
  ...
  final class Service extends ILocationProvider.Stub {
    Service() {}
      ...
      synchronized (LocationProviderBase.this.mBinder) {
        try {
          manager.onInitialize(
              LocationProviderBase.this.mAllowed,
              LocationProviderBase.this.mProperties,
              LocationProviderBase.this.mAttributionTag);
        } catch (RemoteException | RuntimeException e) {
          Log.m104w(LocationProviderBase.this.mTag, e);
        }
        ...
        new Handler(Looper.getMainLooper())
            .post(
                new Runnable() { // from class:
                                 // android.location.provider.LocationProviderBase$Service$$ExternalSyntheticLambda0
    ...
    static /* synthetic */ void lambda$setRequest$0(RuntimeException e) {
    ...
    public void flush() {
      try {
        LocationProviderBase.this.onFlush(
            new OnFlushCompleteCallback() { // from class:
                                            // android.location.provider.LocationProviderBase$Service$$ExternalSyntheticLambda1
        ...
        new Handler(Looper.getMainLooper())
            .post(
                new Runnable() { // from class:
                                 // android.location.provider.LocationProviderBase$Service$$ExternalSyntheticLambda2
                  @Override // java.lang.Runnable
                  public final void run() {
    ...
    static /* synthetic */ void lambda$flush$1(RuntimeException e) {
      throw new AssertionError(e);
    }
    ...
    public void sendExtraCommand(String command, Bundle extras) {
      try {
        ...
        new Handler(Looper.getMainLooper())
            .post(
                new Runnable() { // from class:
                                 // android.location.provider.LocationProviderBase$Service$$ExternalSyntheticLambda3
                  @Override // java.lang.Runnable
                  public final void run() {
    ...
    static /* synthetic */ void lambda$sendExtraCommand$2(RuntimeException e) {
      throw new AssertionError(e);
    }
  }
}
