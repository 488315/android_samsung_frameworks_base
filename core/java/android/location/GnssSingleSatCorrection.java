...
public final class GnssSingleSatCorrection implements Parcelable {
  public static final Parcelable.Creator<GnssSingleSatCorrection> CREATOR =
      new Parcelable.Creator<
          GnssSingleSatCorrection>() { // from class: android.location.GnssSingleSatCorrection.1
        ...
        public GnssSingleSatCorrection createFromParcel(Parcel parcel) {
          ...
          float combinedExcessPathLengthMeters =
              (singleSatCorrectionFlags & 2) != 0 ? parcel.readFloat() : 0.0f;
          float combinedExcessPathLengthUncertaintyMeters =
              (singleSatCorrectionFlags & 4) != 0 ? parcel.readFloat() : 0.0f;
          float combinedAttenuationDb =
              (singleSatCorrectionFlags & 16) != 0 ? parcel.readFloat() : 0.0f;
          List<GnssExcessPathInfo> gnssExcessPathInfoList =
              parcel.createTypedArrayList(GnssExcessPathInfo.CREATOR);
          return new GnssSingleSatCorrection(
              singleSatCorrectionFlags,
              constellationType,
              satId,
              carrierFrequencyHz,
              probSatIsLos,
              combinedExcessPathLengthMeters,
              combinedExcessPathLengthUncertaintyMeters,
  ...
  private GnssSingleSatCorrection(
  ...
  public boolean equals(Object obj) {
    ...
    if (this.mSingleSatCorrectionFlags != that.mSingleSatCorrectionFlags
        || this.mConstellationType != that.mConstellationType
        || this.mSatId != that.mSatId
        || Float.compare(this.mCarrierFrequencyHz, that.mCarrierFrequencyHz) != 0) {
      return false;
    }
    if (hasValidSatelliteLineOfSight()
        && Float.compare(this.mProbSatIsLos, that.mProbSatIsLos) != 0) {
      return false;
    }
    if (hasExcessPathLength()
        && Float.compare(this.mCombinedExcessPathLengthMeters, that.mCombinedExcessPathLengthMeters)
            != 0) {
      return false;
    }
    if (!hasExcessPathLengthUncertainty()
        || Float.compare(
                this.mCombinedExcessPathLengthUncertaintyMeters,
                that.mCombinedExcessPathLengthUncertaintyMeters)
            == 0) {
      return (!hasCombinedAttenuation()
              || Float.compare(this.mCombinedAttenuationDb, that.mCombinedAttenuationDb) == 0)
          && this.mGnssExcessPathInfoList.equals(that.mGnssExcessPathInfoList);
    }
    return false;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        Integer.valueOf(this.mSingleSatCorrectionFlags),
        Integer.valueOf(this.mConstellationType),
        Integer.valueOf(this.mSatId),
        Float.valueOf(this.mCarrierFrequencyHz),
        Float.valueOf(this.mProbSatIsLos),
        Float.valueOf(this.mCombinedExcessPathLengthMeters),
        Float.valueOf(this.mCombinedExcessPathLengthUncertaintyMeters),
        Float.valueOf(this.mCombinedAttenuationDb),
        this.mGnssExcessPathInfoList);
  }
  ...
  public String toString() {
    ...
    if (hasExcessPathLength()) {
      builder
          .append(" CombinedExcessPathLengthMeters=")
          .append(this.mCombinedExcessPathLengthMeters);
    }
    if (hasExcessPathLengthUncertainty()) {
      builder
          .append(" CombinedExcessPathLengthUncertaintyMeters=")
          .append(this.mCombinedExcessPathLengthUncertaintyMeters);
    }
    if (hasCombinedAttenuation()) {
  ...
  public static final class Builder {
    ...
    public Builder setCarrierFrequencyHz(float carrierFrequencyHz) {
      Preconditions.checkArgumentInRange(
          carrierFrequencyHz, 0.0f, Float.MAX_VALUE, "carrierFrequencyHz");
      this.mCarrierFrequencyHz = carrierFrequencyHz;
      return this;
    }
    ...
    public Builder setProbabilityLineOfSight(float probSatIsLos) {
      Preconditions.checkArgumentInRange(
          probSatIsLos, 0.0f, 1.0f, "probSatIsLos should be between 0 and 1.");
      this.mProbSatIsLos = probSatIsLos;
    ...
    public Builder setExcessPathLengthMeters(float combinedExcessPathLengthMeters) {
      Preconditions.checkArgumentInRange(
          combinedExcessPathLengthMeters, 0.0f, Float.MAX_VALUE, "excessPathLengthMeters");
    ...
    public Builder setCombinedAttenuationDb(float combinedAttenuationDb) {
      Preconditions.checkArgumentInRange(
          combinedAttenuationDb, 0.0f, Float.MAX_VALUE, "combinedAttenuationDb");
      this.mCombinedAttenuationDb = combinedAttenuationDb;
    ...
    public GnssSingleSatCorrection build() {
      return new GnssSingleSatCorrection(
          this.mSingleSatCorrectionFlags,
          this.mConstellationType,
          this.mSatId,
          this.mCarrierFrequencyHz,
          this.mProbSatIsLos,
          this.mCombinedExcessPathLengthMeters,
          this.mCombinedExcessPathLengthUncertaintyMeters,
          this.mCombinedAttenuationDb,
          this.mGnssExcessInfoList);
    }
  }
}
