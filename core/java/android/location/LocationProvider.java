...
public class LocationProvider {
  ...
  @Deprecated public static final int AVAILABLE = 2;

  @Deprecated public static final int OUT_OF_SERVICE = 0;

  @Deprecated public static final int TEMPORARILY_UNAVAILABLE = 1;
  ...
  public static boolean propertiesMeetCriteria(
      String name, ProviderProperties properties, Criteria criteria) {
    ...
    if (criteria.getPowerRequirement() != 0
