...
public class Criteria implements Parcelable {
  ...
  public static final Parcelable.Creator<Criteria> CREATOR =
      new Parcelable.Creator<Criteria>() { // from class: android.location.Criteria.1
  ...
  public void setPowerRequirement(int powerRequirement) {
    this.mPowerRequirement =
        Preconditions.checkArgumentInRange(powerRequirement, 0, 3, "powerRequirement");
  }
