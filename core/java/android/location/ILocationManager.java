...
public interface ILocationManager extends IInterface {
  ...
  void addGnssNavigationMessageListener(
  ...
  void addProviderRequestListener(IProviderRequestListener iProviderRequestListener)
      throws RemoteException;
  ...
  ICancellationSignal getCurrentLocation(
      String str,
  ...
  void getFromLocation(
      double d, double d2, int i, GeocoderParams geocoderParams, IGeocodeListener iGeocodeListener)
      throws RemoteException;
  ...
  void injectGnssMeasurementCorrections(GnssMeasurementCorrections gnssMeasurementCorrections)
      throws RemoteException;
  ...
  void removeGnssAntennaInfoListener(IGnssAntennaInfoListener iGnssAntennaInfoListener)
      throws RemoteException;

  void removeGnssMeasurementsListener(IGnssMeasurementsListener iGnssMeasurementsListener)
      throws RemoteException;

  void removeGnssNavigationMessageListener(
      IGnssNavigationMessageListener iGnssNavigationMessageListener) throws RemoteException;

  void removeProviderRequestListener(IProviderRequestListener iProviderRequestListener)
      throws RemoteException;

  void removeTestProvider(String str, String str2, String str3) throws RemoteException;

  void requestGeofence(Geofence geofence, PendingIntent pendingIntent, String str, String str2)
      throws RemoteException;

  void requestListenerFlush(String str, ILocationListener iLocationListener, int i)
      throws RemoteException;

  void requestPendingIntentFlush(String str, PendingIntent pendingIntent, int i)
      throws RemoteException;
  ...
  void setTestProviderEnabled(String str, boolean z, String str2, String str3)
      throws RemoteException;

  void setTestProviderLocation(String str, Location location, String str2, String str3)
      throws RemoteException;
  ...
  public static class Default implements ILocationManager {
    ...
    public Location getLastLocation(
        String provider, LastLocationRequest request, String packageName, String attributionTag)
        throws RemoteException {
      return null;
    }
    ...
    @Override // android.location.ILocationManager
    public void requestPendingIntentFlush(
        String provider, PendingIntent pendingIntent, int requestCode) throws RemoteException {}

    @Override // android.location.ILocationManager
    public void requestGeofence(
        Geofence geofence, PendingIntent intent, String packageName, String attributionTag)
        throws RemoteException {}
    ...
    public void registerGnssStatusCallback(
        IGnssStatusListener callback, String packageName, String attributionTag, String listenerId)
        throws RemoteException {}
    ...
    public void registerGnssNmeaCallback(
        IGnssNmeaListener callback, String packageName, String attributionTag, String listenerId)
        throws RemoteException {}
    ...
    public void setTestProviderLocation(
        String provider, Location location, String packageName, String attributionTag)
        throws RemoteException {}

    @Override // android.location.ILocationManager
    public void setTestProviderEnabled(
        String provider, boolean enabled, String packageName, String attributionTag)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements ILocationManager {
    public static final String DESCRIPTOR = "android.location.ILocationManager";
    static final String[] PERMISSIONS_injectLocation = {
          ...
          switch (code) {
            case 1:
              ...
              LastLocationRequest _arg1 =
                  (LastLocationRequest) data.readTypedObject(LastLocationRequest.CREATOR);
            ...
            case 2:
              ...
              LocationRequest _arg12 =
                  (LocationRequest) data.readTypedObject(LocationRequest.CREATOR);
              ILocationCallback _arg22 =
                  ILocationCallback.Stub.asInterface(data.readStrongBinder());
              String _arg32 = data.readString();
              String _arg4 = data.readString();
              String _arg5 = data.readString();
              data.enforceNoDataAvail();
              ICancellationSignal _result2 =
                  getCurrentLocation(_arg02, _arg12, _arg22, _arg32, _arg4, _arg5);
              reply.writeNoException();
            ...
            case 3:
              ...
              LocationRequest _arg13 =
                  (LocationRequest) data.readTypedObject(LocationRequest.CREATOR);
              ILocationListener _arg23 =
                  ILocationListener.Stub.asInterface(data.readStrongBinder());
            ...
            case 18:
              ...
              return true;
            case 19:
              IGnssStatusListener _arg014 =
                  IGnssStatusListener.Stub.asInterface(data.readStrongBinder());
            ...
            case 20:
              ...
              return true;
            case 21:
              IGnssNmeaListener _arg016 =
                  IGnssNmeaListener.Stub.asInterface(data.readStrongBinder());
            ...
            case 22:
              ...
              return true;
            case 23:
              GnssMeasurementRequest _arg018 =
                  (GnssMeasurementRequest) data.readTypedObject(GnssMeasurementRequest.CREATOR);
              IGnssMeasurementsListener _arg112 =
                  IGnssMeasurementsListener.Stub.asInterface(data.readStrongBinder());
              ...
              return true;
            case 24:
              IGnssMeasurementsListener _arg019 =
                  IGnssMeasurementsListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              ...
              return true;
            case 25:
              GnssMeasurementCorrections _arg020 =
                  (GnssMeasurementCorrections)
                      data.readTypedObject(GnssMeasurementCorrections.CREATOR);
              data.enforceNoDataAvail();
              injectGnssMeasurementCorrections(_arg020);
              reply.writeNoException();
              return true;
            case 26:
              IGnssNavigationMessageListener _arg021 =
                  IGnssNavigationMessageListener.Stub.asInterface(data.readStrongBinder());
              ...
              return true;
            case 27:
              IGnssNavigationMessageListener _arg022 =
                  IGnssNavigationMessageListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              ...
              return true;
            case 28:
              IGnssAntennaInfoListener _arg023 =
                  IGnssAntennaInfoListener.Stub.asInterface(data.readStrongBinder());
              ...
              return true;
            case 29:
              IGnssAntennaInfoListener _arg024 =
                  IGnssAntennaInfoListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              ...
              return true;
            case 30:
              IProviderRequestListener _arg025 =
                  IProviderRequestListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              addProviderRequestListener(_arg025);
              reply.writeNoException();
              return true;
            case 31:
              IProviderRequestListener _arg026 =
                  IProviderRequestListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 54:
              ...
              ProviderProperties _arg122 =
                  (ProviderProperties) data.readTypedObject(ProviderProperties.CREATOR);
      ...
      public GnssCapabilities getGnssCapabilities() throws RemoteException {
        ...
        try {
          ...
          GnssCapabilities _result =
              (GnssCapabilities) _reply.readTypedObject(GnssCapabilities.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public ProviderProperties getProviderProperties(String provider) throws RemoteException {
        ...
        try {
          ...
          ProviderProperties _result =
              (ProviderProperties) _reply.readTypedObject(ProviderProperties.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public PackageTagsList getIgnoreSettingsAllowlist() throws RemoteException {
        ...
        try {
          ...
          PackageTagsList _result =
              (PackageTagsList) _reply.readTypedObject(PackageTagsList.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
    ...
    protected void injectLocation_enforcePermission() throws SecurityException {
      this.mEnforcer.enforcePermissionAllOf(
          PERMISSIONS_injectLocation, getCallingPid(), getCallingUid());
    }
    ...
    protected void setExtraLocationControllerPackageEnabled_enforcePermission()
