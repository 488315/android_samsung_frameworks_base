...
public class ListPreference extends DialogPreference {
  ...
  protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
    ...
    builder.setSingleChoiceItems(
        this.mEntries,
        valueIndex,
        new DialogInterface.OnClickListener() { // from class: android.preference.ListPreference.1
  ...
  protected void onDialogClosed(boolean positiveResult) {
    ...
    if (positiveResult
        && (i = this.mClickedDialogEntryIndex) >= 0
        && (charSequenceArr = this.mEntryValues) != null) {
  ...
  private static class SavedState extends Preference.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: android.preference.ListPreference.SavedState.1
