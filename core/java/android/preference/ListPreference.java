...
public class ListPreference extends DialogPreference {
    ...
    public ListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ListPreference, defStyleAttr, defStyleRes);
        this.mEntries = a.getTextArray(0);
        this.mEntryValues = a.getTextArray(1);
        a.recycle();
        TypedArray a2 = context.obtainStyledAttributes(attrs, C4337R.styleable.Preference, defStyleAttr, defStyleRes);
