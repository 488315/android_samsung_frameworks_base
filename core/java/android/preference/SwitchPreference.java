...
public class SwitchPreference extends TwoStatePreference {
    ...
    public SwitchPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if ((configuration.screenWidthDp <= 320 && configuration.fontScale >= 1.1f) || (configuration.screenWidthDp < 411 && configuration.fontScale >= 1.3f)) {
            setLayoutResource(C4337R.layout.tw_preference_switch_large);
        }
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.SwitchPreference, defStyleAttr, defStyleRes);
