...
public class SeekBarVolumizer implements SeekBar.OnSeekBarChangeListener, Handler.Callback {
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
        if (fromTouch) {
            ...
            Log.m94d(TAG, "onProgressChanged : stream = " + this.mStreamType + ", progress = " + progress);
            stopToneGenerator();
            int i = this.mStreamType;
            if (i == 2) {
                ...
                Log.m94d(TAG, "onProgressChanged : AudioManager.STREAM_SYSTEM[" + this.mAudioManager.getStreamVolume(1) + NavigationBarInflaterView.SIZE_MOD_END);
            } else if (i == 8) {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("com.samsung.intent.action.DEFAULT_CS_SIM_CHANGED".equals(action)) {
                ...
                try {
                    ...
                    Log.m94d(SeekBarVolumizer.TAG, "Exception happens in SIM_CHANGED_ACTION : " + e.toString());
                    return;
                }
            }
