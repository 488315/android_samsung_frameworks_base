...
public abstract class DialogPreference extends Preference
  ...
  public DialogPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    this.mDismissRunnable =
        new Runnable() { // from class: android.preference.DialogPreference.1
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.DialogPreference, defStyleAttr, defStyleRes);
  ...
  protected void showDialog(Bundle state) {
    ...
    this.mBuilder =
        new AlertDialog.Builder(context)
            ...
            .setIcon(this.mDialogIcon)
            .setPositiveButton(this.mPositiveButtonText, this)
            .setNegativeButton(this.mNegativeButtonText, this);
    ...
    dialog.setOnShowListener(
        new DialogInterface.OnShowListener() { // from class: android.preference.DialogPreference.2
  ...
  private static class SavedState extends Preference.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: android.preference.DialogPreference.SavedState.1
