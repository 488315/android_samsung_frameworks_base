...
public class PreferenceFrameLayout extends FrameLayout {
    ...
    public PreferenceFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C4337R.attr.preferenceFrameLayoutStyle);
    }
    ...
    public PreferenceFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.PreferenceFrameLayout, defStyleAttr, defStyleRes);
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, C4337R.styleable.PreferenceFrameLayout_Layout);
