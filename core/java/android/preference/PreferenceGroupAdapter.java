...
public class PreferenceGroupAdapter extends BaseAdapter
  ...
  */
          ...
          if (preference2 instanceof PreferenceCategory) {
            ...
            if (z) {
              ...
              if ((preference5 instanceof PreferenceCategory)
                  || ((preference5 == null
                          && (this.mNextGroupPreference instanceof PreferenceCategory))
                      || preference2 == (preference = this.mNextGroupPreference)
                      || (preference5 == null && preference == null))) {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    PreferenceLayout createPreferenceLayout =
        createPreferenceLayout(preference, this.mTempPreferenceLayout);
