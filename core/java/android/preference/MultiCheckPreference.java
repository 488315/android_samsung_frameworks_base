...
public class MultiCheckPreference extends DialogPreference {
  ...
  public MultiCheckPreference(
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.ListPreference, defStyleAttr, defStyleRes);
    ...
    a.recycle();
    TypedArray a2 = context.obtainStyledAttributes(attrs, C4337R.styleable.Preference, 0, 0);
  ...
  public void setValues(boolean[] values) {
    ...
    if (zArr != null) {
      ...
      if (values != null) {
        ...
        System.arraycopy(
            values, 0, zArr2, 0, values.length < zArr2.length ? values.length : zArr2.length);
      }
    }
  }
  ...
  protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
    ...
    builder.setMultiChoiceItems(
        ...
        this.mSetValues,
        new DialogInterface
            .OnMultiChoiceClickListener() { // from class: android.preference.MultiCheckPreference.1
  ...
  private static class SavedState extends Preference.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: android.preference.MultiCheckPreference.SavedState.1
