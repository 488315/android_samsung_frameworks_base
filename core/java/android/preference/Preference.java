    ...
    if (this.mIsDeviceDefault) {
      ...
      this.mColorPrimaryDark =
          context
              .getResources()
              .getColorStateList(
                  C4337R.color.tw_secondary_text_user_setting_value_material_light,
                  context.getTheme());
    }
    ...
    if (this.mIsDeviceDefault
      ...
      convertView.setContentDescription(
          tempConvertView.getText().toString()
              + ", "
              + this.mContext.getString(C4337R.string.tw_preferencecategory_added_title));
    }
    return convertView;
  }
  ...
  public static class BaseSavedState extends AbsSavedState {
    public static final Parcelable.Creator<BaseSavedState> CREATOR =
        new Parcelable.Creator<
            BaseSavedState>() { // from class: android.preference.Preference.BaseSavedState.1
