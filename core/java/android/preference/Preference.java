...
public class Preference implements Comparable<Preference> {
    ...
    public Preference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mLayoutResId = C4337R.layout.preference;
        ...
        if (this.mIsDeviceDefault) {
            ...
            this.mColorPrimaryDark = context.getResources().getColorStateList(C4337R.color.tw_secondary_text_user_setting_value_material_light, context.getTheme());
        }
    ...
    public View getView(View convertView, ViewGroup parent) {
        ...
        if (this.mIsDeviceDefault && (this instanceof PreferenceCategory) && (convertView instanceof TextView)) {
            ...
            convertView.setContentDescription(tempConvertView.getText().toString() + ", " + this.mContext.getString(C4337R.string.tw_preferencecategory_added_title));
        }
        return convertView;
    }
