...
public abstract class PreferenceActivity extends ListActivity
            ...
            case 2:
              ...
              if (header != null && header.fragment != null) {
                Header mappedHeader2 =
                    PreferenceActivity.this.findBestMatchingHeader(header, oldHeaders);
                if (mappedHeader2 == null || PreferenceActivity.this.mCurHeader != mappedHeader2) {
                  ...
                  && (mappedHeader =
                          (preferenceActivity = PreferenceActivity.this)
                              .findBestMatchingHeader(
                                  preferenceActivity.mCurHeader, PreferenceActivity.this.mHeaders))
                      != null) {
  ...
  private static class HeaderAdapter extends ArrayAdapter<Header> {
    ...
    public HeaderAdapter(
        Context context, List<Header> objects, int layoutResId, boolean removeIconBehavior) {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    TypedArray sa =
        obtainStyledAttributes(
            null, C4337R.styleable.PreferenceActivity, C4337R.attr.preferenceActivityStyle, 0);
    int layoutResId = sa.getResourceId(0, C4337R.layout.preference_list_content);
    this.mPreferenceHeaderItemResId = sa.getResourceId(1, C4337R.layout.preference_header_item);
    this.mPreferenceHeaderRemoveEmptyIcon = sa.getBoolean(2, false);
    TypedValue outValue = new TypedValue();
    getTheme().resolveAttribute(C4337R.attr.parentIsDeviceDefault, outValue, true);
    this.mIsDeviceDefault = outValue.data != 0;
    sa.recycle();
    setContentView(layoutResId);
    this.mListFooter = (FrameLayout) findViewById(C4337R.id.list_footer);
    this.mPrefsContainer = (ViewGroup) findViewById(C4337R.id.prefs_frame);
    this.mHeadersContainer = (ViewGroup) findViewById(C4337R.id.headers);
    ...
    if (this.mIsDeviceDefault && !this.mSinglePane) {
      View findViewById = findViewById(C4337R.id.prefs_split_bar);
      ...
      View findViewById2 = findViewById(C4337R.id.prefs_split_bar);
    ...
    if (this.mHeaders.size() == 0 && initialFragment == null) {
      if (this.mIsDeviceDefault) {
        i = C4337R.layout.tw_preference_list_content_single;
      } else {
        i = C4337R.layout.preference_list_content_single;
      }
      setContentView(i);
      this.mListFooter = (FrameLayout) findViewById(C4337R.id.list_footer);
      this.mPrefsContainer = (ViewGroup) findViewById(C4337R.id.prefs);
      ...
      ViewGroup container = (ViewGroup) findViewById(C4337R.id.prefs_container);
    ...
    if (intent.getBooleanExtra(EXTRA_PREFS_SHOW_BUTTON_BAR, false)) {
      findViewById(C4337R.id.button_bar).setVisibility(0);
      Button backButton = (Button) findViewById(C4337R.id.back_button);
      backButton.setOnClickListener(
          new View.OnClickListener() { // from class: android.preference.PreferenceActivity.2
      ...
      Button skipButton = (Button) findViewById(C4337R.id.skip_button);
      skipButton.setOnClickListener(
          new View.OnClickListener() { // from class: android.preference.PreferenceActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
      ...
      Button button = (Button) findViewById(C4337R.id.next_button);
      this.mNextButton = button;
      button.setOnClickListener(
          new View.OnClickListener() { // from class: android.preference.PreferenceActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
              PreferenceActivity.this.setResult(-1);
              PreferenceActivity.this.finish();
    ...
    if (this.mIsDeviceDefault && !this.mSinglePane && this.mSplitBarView != null) {
      if (this.mSplitBarLayoutChangeListner == null) {
        this.mSplitBarLayoutChangeListner =
            new View
                .OnLayoutChangeListener() { // from class: android.preference.PreferenceActivity.5
                ...
                if (PreferenceActivity.this.mIsDeviceDefault
                  ...
                  float x =
                      mRightLayoutStartPosition
                          - (PreferenceActivity.this.mSplitBarView.getWidth() / 2.0f);
                  if (x < 0.0f) {
                    x = 0.0f;
                  }
      ...
      this.mSplitBarView.setOnTouchListener(
          new View.OnTouchListener() { // from class: android.preference.PreferenceActivity.6
            ...
            public boolean onTouch(View v, MotionEvent event) {
              ...
              if (action != 2) {
                ...
                LinearLayout.LayoutParams llp2 =
                    (LinearLayout.LayoutParams)
                        PreferenceActivity.this.mHeadersContainer.getLayoutParams();
              ...
              int parentLayoutWidth =
                  ((View) PreferenceActivity.this.mSplitBarView.getParent()).getWidth();
              ...
              if (PreferenceActivity.this.mIsDeviceDefault && PreferenceActivity.this.mIsRTL) {
                if (touchX > splitBarwidth && touchXInParentRect <= parentLayoutWidth) {
                  ...
                  if (newSplitBarCenterPosX / parentLayoutWidth > 0.8f) {
                    ...
                    float splitXinFullview =
                        TypedValue.applyDimension(
                            1, PreferenceActivity.SPLIT_BAR_SPLIT_X_IN_FULLVIEW, d);
                  ...
                  if (splitRatio < 0.33999997f) {
                    ...
                    float splitXinFullview2 =
                        TypedValue.applyDimension(
                            1, PreferenceActivity.SPLIT_BAR_SPLIT_X_IN_FULLVIEW, d2);
                ...
                if (newSplitBarCenterPosX / parentLayoutWidth < 0.2f) {
                  ...
                  float splitXinFullview4 =
                      TypedValue.applyDimension(
                          1, PreferenceActivity.SPLIT_BAR_SPLIT_X_IN_FULLVIEW, d4);
              ...
              if (PreferenceActivity.this.mUpdateLayoutBySplitChange) {
                ...
                LinearLayout.LayoutParams rlp2 =
                    (LinearLayout.LayoutParams)
                        PreferenceActivity.this.mPrefsContainer.getLayoutParams();
  ...
  public boolean onIsMultiPane() {
    boolean preferMultiPane = getResources().getBoolean(C4337R.bool.preferences_prefer_dual_pane);
  ...
  */
  /* JADX WARN: Code restructure failed: missing block: B:45:0x006d, code lost:
     ...
     r14 = obtainStyledAttributes(r3, com.android.internal.C4337R.styleable.PreferenceHeader);
     r18 = r9;
     r13.f351id = r14.getResourceId(r8, -1);
     r8 = r14.peekValue(r7);
  */
  ...
  */
  ...
  protected boolean isValidFragment(String fragmentName) {
    if (getApplicationInfo().targetSdkVersion >= 19) {
      throw new RuntimeException(
          "Subclasses of PreferenceActivity must override isValidFragment(String) to verify that"
              + " the Fragment class is valid! "
              + getClass().getName()
    ...
    if (this.mFragmentBreadCrumbs == null) {
      ...
      try {
        ...
        if (this.mSinglePane) {
          ...
          View bcSection = findViewById(C4337R.id.breadcrumb_section);
          if (bcSection != null) {
  ...
  private void switchToHeaderInner(String fragmentName, Bundle args) {
    ...
    transaction.replace(C4337R.id.prefs, f);
  ...
  Header findBestMatchingHeader(Header cur, ArrayList<Header> from) {
    ...
    for (int j = 0; j < from.size(); j++) {
      ...
      if (cur == oh || (cur.f351id != -1 && cur.f351id == oh.f351id)) {
        matches.clear();
        matches.add(oh);
        break;
      }
  ...
  public void startPreferenceFragment(Fragment fragment, boolean push) {
    FragmentTransaction transaction = getFragmentManager().beginTransaction();
    transaction.replace(C4337R.id.prefs, fragment);
    if (push) {
  ...
  public void addPreferencesFromResource(int preferencesResId) {
    requirePreferenceManager();
    setPreferenceScreen(
        this.mPreferenceManager.inflateFromResource(this, preferencesResId, getPreferenceScreen()));
  }
