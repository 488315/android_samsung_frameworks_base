  ...
  public MultiSelectListPreference(
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.MultiSelectListPreference, defStyleAttr, defStyleRes);
            ...
            if (isChecked) {
              MultiSelectListPreference.this.mPreferenceChanged |=
                  MultiSelectListPreference.this.mNewValues.add(
                      MultiSelectListPreference.this.mEntryValues[which].toString());
            } else {
              MultiSelectListPreference.this.mPreferenceChanged |=
  ...
  private static class SavedState extends Preference.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: android.preference.MultiSelectListPreference.SavedState.1
