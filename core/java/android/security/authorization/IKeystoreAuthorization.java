...
public interface IKeystoreAuthorization extends IInterface {
  public static final String DESCRIPTOR =
      "android$security$authorization$IKeystoreAuthorization".replace('$', '.');
  ...
  public static class Default implements IKeystoreAuthorization {
    ...
    @Override // android.security.authorization.IKeystoreAuthorization
    public void onLockScreenEvent(
        int lockScreenEvent, int userId, byte[] password, long[] unlockingSids)
        throws RemoteException {}

    @Override // android.security.authorization.IKeystoreAuthorization
    public AuthorizationTokens getAuthTokensForCredStore(
        long challenge, long secureUserId, long authTokenMaxAgeMillis) throws RemoteException {
      return null;
    }
      ...
      public AuthorizationTokens getAuthTokensForCredStore(
        ...
        try {
          ...
          AuthorizationTokens _result =
              (AuthorizationTokens) _reply.readTypedObject(AuthorizationTokens.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
