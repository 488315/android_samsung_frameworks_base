...
public final class VerificationToken implements Parcelable {
  ...
  VerificationToken(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) attestationProfile);
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) requirements);
    this.mVerificationResult = verificationResult;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) AttestationVerificationManager.VerificationResult.class,
        (Annotation) null,
        verificationResult);
    this.mVerificationTime = verificationTime;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) verificationTime);
    this.mHmac = hmac;
