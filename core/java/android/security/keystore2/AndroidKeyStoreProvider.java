...
public class AndroidKeyStoreProvider extends Provider {
  ...
  static AndroidKeyStorePublicKey makeAndroidKeyStorePublicKeyFromKeyEntryResponse(
    ...
    if (parsedX509Certificate == null) {
      throw new UnrecoverableKeyException(
          "Failed to parse the X.509 certificate containing the public key. This likely indicates a"
              + " hardware problem.");
    }
  ...
  private static AndroidKeyStoreKey loadAndroidKeyStoreKeyFromKeystore(
    ...
    try {
      ...
      switch (e.getErrorCode()) {
        ...
        default:
          throw ((UnrecoverableKeyException)
              new UnrecoverableKeyException("Failed to obtain information about key").initCause(e));
      }
    }
  }
}
