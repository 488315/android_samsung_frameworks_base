...
public abstract class AndroidKeyStoreKeyPairGeneratorSpi extends KeyPairGeneratorSpi {
    ...
    public KeyPair generateKeyPair() {
        ...
        try {
            try {
                ...
                } catch (DeviceIdAttestationException | IllegalArgumentException | InvalidAlgorithmParameterException | UnrecoverableKeyException e) {
            ...
            if (!success) {
                try {
                    ...
                    if (e3.getErrorCode() != 7) {
                        Log.m97e(TAG, "Failed to delete newly generated key after generation failed unexpectedly.", e3);
                    }
                }
            }
        }
    ...
    static /* synthetic */ void lambda$constructKeyGenerationArguments$3(List params, boolean[] hasDefaultMgf1DigestBeenAdded, Integer digest) {
