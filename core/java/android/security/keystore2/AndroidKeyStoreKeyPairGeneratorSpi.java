...
public abstract class AndroidKeyStoreKeyPairGeneratorSpi extends KeyPairGeneratorSpi {
    ...
    */
    public void initialize(
            java.security.spec.AlgorithmParameterSpec r12, java.security.SecureRandom r13)
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " android.security.keystore2.AndroidKeyStoreKeyPairGeneratorSpi.initialize(java.security.spec.AlgorithmParameterSpec,"
    ...
    private void checkAttestKeySecurityLevel(KeyGenParameterSpec spec, KeyEntryResponse key)
        ...
        if (spec.isStrongBoxBacked() != attestKeyInStrongBox) {
            if (attestKeyInStrongBox) {
                throw new InvalidAlgorithmParameterException(
                        "Invalid security level: Cannot sign non-StrongBox key with StrongBox"
                            + " attestKey");
            }
            throw new InvalidAlgorithmParameterException(
                    "Invalid security level: Cannot sign StrongBox key with non-StrongBox"
                        + " attestKey");
        }
    }
        ...
        switch (this.mKeymasterAlgorithm) {
            ...
            case 3:
                if (algSpecificSpec instanceof ECGenParameterSpec) {
                    ...
                    if (this.mOriginalKeymasterAlgorithm == 1203
                            && !this.mEcCurveName.equalsIgnoreCase("x25519")) {
                        throw new InvalidAlgorithmParameterException(
                                "XDH algorithm only supports x25519 curve.");
                    }
                    if (this.mOriginalKeymasterAlgorithm == 1204
                            && !this.mEcCurveName.equalsIgnoreCase("ed25519")) {
                        throw new InvalidAlgorithmParameterException(
                                "Ed25519 algorithm only supports ed25519 curve.");
                    }
                    Integer ecSpecKeySizeBits =
                            SUPPORTED_EC_CURVE_NAME_TO_SIZE.get(
                                    this.mEcCurveName.toLowerCase(Locale.US));
        ...
        try {
            try {
                KeyStoreSecurityLevel iSecurityLevel =
                        this.mKeyStore.getSecurityLevel(securityLevel);
                ...
                switch (e.getErrorCode()) {
                    ...
                    default:
                        ProviderException p =
                                new ProviderException("Failed to generate key pair.", e);
                ...
                throw new ProviderException(
                        "Failed to construct key object from newly generated key pair.", e2);
            }
        } finally {
            if (!success) {
                try {
                    ...
                    if (e3.getErrorCode() != 7) {
                        Log.e(
                                TAG,
                                "Failed to delete newly generated key after generation failed"
                                    + " unexpectedly.",
                                e3);
                    }
                }
    ...
    private Collection<KeyParameter> constructKeyGenerationArguments()
        ...
        if (this.mKeymasterAlgorithm == 3) {
            params.add(
                    KeyStore2ParameterUtils.makeEnum(
                            268435466,
                            keySizeAndNameToEcCurve(this.mKeySizeBits, this.mEcCurveName)));
        }
        ArrayUtils.forEach(
                ...
                new Consumer() { // from class:
                    ...
                    public final void accept(Object obj) {
                        params.add(
                                KeyStore2ParameterUtils.makeEnum(
                                        536870913, ((Integer) obj).intValue()));
                    }
                });
        ArrayUtils.forEach(
                ...
                new Consumer() { // from class:
                    ...
                    public final void accept(Object obj) {
                        params.add(
                                KeyStore2ParameterUtils.makeEnum(
                                        536870916, ((Integer) obj).intValue()));
                    }
                });
        ArrayUtils.forEach(
                ...
                new Consumer() { // from class:
                    ...
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        AndroidKeyStoreKeyPairGeneratorSpi.this
                                .lambda$constructKeyGenerationArguments$5(params, (Integer) obj);
                    }
                });
        ArrayUtils.forEach(
                ...
                new Consumer() { // from class:
                    ...
                    public final void accept(Object obj) {
                        params.add(
                                KeyStore2ParameterUtils.makeEnum(
                                        536870918, ((Integer) obj).intValue()));
                    }
                });
        ArrayUtils.forEach(
                this.mKeymasterDigests,
                new Consumer() { // from class:
                                 // android.security.keystore2.AndroidKeyStoreKeyPairGeneratorSpi$$ExternalSyntheticLambda7
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        params.add(
                                KeyStore2ParameterUtils.makeEnum(
                                        536870917, ((Integer) obj).intValue()));
                    }
                });
        KeyStore2ParameterUtils.addUserAuthArgs(params, this.mSpec);
        if (this.mSpec.getKeyValidityStart() != null) {
            params.add(
                    KeyStore2ParameterUtils.makeDate(1610613136, this.mSpec.getKeyValidityStart()));
        }
        ...
        if (this.mSpec.getCertificateNotAfter() != null) {
            params.add(
                    KeyStore2ParameterUtils.makeDate(
                            1610613745, this.mSpec.getCertificateNotAfter()));
        }
        if (this.mSpec.getCertificateNotBefore() != null) {
            params.add(
                    KeyStore2ParameterUtils.makeDate(
                            1610613744, this.mSpec.getCertificateNotBefore()));
        }
        if (this.mSpec.getCertificateSerialNumber() != null) {
            params.add(
                    KeyStore2ParameterUtils.makeBignum(
                            -2147482642, this.mSpec.getCertificateSerialNumber()));
        }
    ...
    public /* synthetic */ void lambda$constructKeyGenerationArguments$5(
            ...
            ArrayUtils.forEach(
                    ...
                    new Consumer() { // from class:
                        ...
                        public final void accept(Object obj) {
                            params.add(
                                    KeyStore2ParameterUtils.makeEnum(
                                            536871115, ((Integer) obj).intValue()));
                        }
                    });
                        ...
                        new Consumer() { // from class:
                            ...
                            public final void accept(Object obj) {
                                AndroidKeyStoreKeyPairGeneratorSpi
                                        .lambda$constructKeyGenerationArguments$4(
                                                defaultMgf1Digest, params, (Integer) obj);
                            }
                        });
            }
        }
    ...
    static /* synthetic */ void lambda$constructKeyGenerationArguments$4(
            int defaultMgf1Digest, List params, Integer digest) {
    ...
    private void addAlgorithmSpecificParameters(List<KeyParameter> params) {
        switch (this.mKeymasterAlgorithm) {
            case 1:
                params.add(
                        KeyStore2ParameterUtils.makeLong(
                                1342177480, this.mRSAPublicExponent.longValue()));
                return;
            case 2:
            default:
                throw new ProviderException("Unsupported algorithm: " + this.mKeymasterAlgorithm);
            ...
            case 3:
                ...
                while (true) {
                    if (it2.hasNext()) {
                        ...
                        int outputSizeBits2 =
                                KeymasterUtils.getDigestOutputSizeBits(keymasterDigest2);
