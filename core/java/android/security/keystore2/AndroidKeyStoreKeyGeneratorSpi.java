    ...
    protected void engineInit(AlgorithmParameterSpec params, SecureRandom random)
      ...
      if (this.mKeySizeBits != 128 && this.mKeySizeBits != 192 && this.mKeySizeBits != 256) {
        throw new InvalidAlgorithmParameterException(
            "Unsupported key size: " + this.mKeySizeBits + ". Supported: 128, 192, 256.");
      }
    }
  }
                ...
                if (keymasterDigestsFromSpec.length != 1
                  ...
                  throw new InvalidAlgorithmParameterException(
                      "Unsupported digests specification: "
                          ...
                          + ". Only "
                          + KeyProperties.Digest.fromKeymaster(this.mKeymasterDigest)
  ...
  protected SecretKey engineGenerateKey() {
    ...
    try {
      KeyMetadata metadata =
          iSecurityLevel.generateKey(descriptor, null, params, flags, additionalEntropy);
      try {
        String keyAlgorithmJCA =
            KeyProperties.KeyAlgorithm.fromKeymasterSecretKeyAlgorithm(
                this.mKeymasterAlgorithm, this.mKeymasterDigest);
        SecretKey result =
            new AndroidKeyStoreSecretKey(descriptor, metadata, keyAlgorithmJCA, iSecurityLevel);
        return result;
        ...
        try {
          ...
          Log.m97e(
              TAG,
              "Failed to delete key after generating successfully but failed to get the algorithm"
                  + " string.",
              kse);
        }
