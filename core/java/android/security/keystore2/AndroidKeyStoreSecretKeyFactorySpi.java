...
public class AndroidKeyStoreSecretKeyFactorySpi extends SecretKeyFactorySpi {
    ...
    protected KeySpec engineGetKeySpec(SecretKey secretKey, Class keySpecClass)
        ...
        if (!(secretKey instanceof AndroidKeyStoreSecretKey)) {
            throw new InvalidKeySpecException(
                    "Only Android KeyStore secret keys supported: "
                            + (secretKey != 0 ? secretKey.getClass().getName() : "null"));
        }
        ...
        try {
            ...
            try {
                        ...
                        switch (a.keyParameter.tag) {
                            ...
                            case 268435960:
                                ...
                                int authenticatorType =
                                        a.keyParameter.value.getHardwareAuthenticatorType();
                            ...
                            case 268436158:
                                ...
                                try {
                                    int origin2 =
                                            KeyProperties.Origin.fromKeymaster(
                                    ...
                                    throw new ProviderException(
                                            "Unsupported key characteristic", e);
                                }
                            case 536870913:
                                purposes =
                                        KeyProperties.Purpose.fromKeymaster(
                            ...
                            case 536870918:
                                ...
                                if (paddingMode == 5 || paddingMode == 3) {
                                    ...
                                    try {
                                        ...
                                        throw new ProviderException(
                                                "Unsupported padding: " + paddingMode);
                                    }
                                }
                                keyValidityForConsumptionEnd2 = keyValidityForConsumptionEnd;
                                keyValidityForOriginationEnd2 = keyValidityForOriginationEnd;
                            ...
                            case 805306873:
                                long userAuthenticationValidityDurationSeconds2 =
                                        KeyStore2ParameterUtils.getUnsignedInt(a);
                                    ...
                                    try {
                                        throw new ProviderException(
                                                "User authentication timeout validity too long: "
                                                        + userAuthenticationValidityDurationSeconds2
                                                        + " seconds");
                            ...
                            case 1610613136:
                                ...
                                authorizations = authorizationArr;
                            case 1610613137:
                                Date keyValidityForOriginationEnd7 =
                                ...
                                authorizations = authorizationArr;
                            case 1610613138:
                                Date keyValidityForConsumptionEnd7 =
                                        KeyStore2ParameterUtils.getDate(a);
                            ...
                            case 1879048695:
                                ...
                                authorizations = authorizationArr;
                            case 1879048698:
                                boolean userAuthenticationValidWhileOnBody2 =
                                        KeyStore2ParameterUtils.isSecureHardware(a.securityLevel);
                                userAuthenticationValidWhileOnBody =
                                        userAuthenticationValidWhileOnBody2;
                                i++;
                                securityLevel3 = i2;
                                authorizations = authorizationArr;
                            case 1879048699:
                                boolean trustedUserPresenceRequired2 =
                                        KeyStore2ParameterUtils.isSecureHardware(a.securityLevel);
                            ...
                            case 1879048700:
                                try {
                                    boolean trustedUserConfirmationRequired2 =
                                            KeyStore2ParameterUtils.isSecureHardware(
                                                    a.securityLevel);
                                    trustedUserConfirmationRequired =
                                            trustedUserConfirmationRequired2;
                                    i++;
                                    securityLevel3 = i2;
                                    authorizations = authorizationArr;
                ...
                String[] encryptionPaddings =
                        (String[]) encryptionPaddingsList.toArray(new String[0]);
                String[] signaturePaddings =
                        (String[]) signaturePaddingsList.toArray(new String[0]);
                ...
                if (keymasterSwEnforcedUserAuthenticators == 2
                        || keymasterHwEnforcedUserAuthenticators == 2) {
                    invalidatedByBiometricEnrollment =
                            (keymasterSecureUserIds.isEmpty()
                                            || keymasterSecureUserIds.contains(
                                                    getGateKeeperSecureUserId()))
                                    ? false
                                    : true;
                }
                long userAuthenticationValidityDurationSeconds3 =
                        userAuthenticationValidityDurationSeconds;
                int keymasterHwEnforcedUserAuthenticators2 = keymasterHwEnforcedUserAuthenticators;
                int keymasterHwEnforcedUserAuthenticators3 =
                        (int) userAuthenticationValidityDurationSeconds3;
                return new KeyInfo(
                        key.getUserKeyDescriptor().alias,
                        insideSecureHardware,
                        origin,
                        keySize,
                        keyValidityStart7,
                        keyValidityForOriginationEnd8,
                        keyValidityForConsumptionEnd8,
                        purposes,
                        encryptionPaddings,
                        signaturePaddings,
                        digests,
                        ...
                        userAuthenticationRequirementEnforcedBySecureHardware
                                ? keymasterHwEnforcedUserAuthenticators2
