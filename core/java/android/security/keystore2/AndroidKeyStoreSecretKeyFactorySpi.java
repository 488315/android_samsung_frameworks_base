            ...
            switch (a.keyParameter.tag) {
              case -1610612234:
                ...
                keymasterSecureUserIds.add(
                    KeymasterArguments.toUint64(a.keyParameter.value.getLongInteger()));
              ...
              case 268436158:
                ...
                try {
                  ...
                  try {
                    int origin2 =
                        KeyProperties.Origin.fromKeymaster(a.keyParameter.value.getOrigin());
                    origin = origin2;
              ...
              case 536870913:
                purposes =
                    KeyProperties.Purpose.fromKeymaster(a.keyParameter.value.getKeyPurpose())
                        | purposes;
              ...
              case 536870916:
                ...
                keyValidityForConsumptionEnd = keyValidityForConsumptionEnd2;
                blockModesList.add(
                    KeyProperties.BlockMode.fromKeymaster(a.keyParameter.value.getBlockMode()));
                keyValidityForConsumptionEnd2 = keyValidityForConsumptionEnd;
                keyValidityForOriginationEnd2 = keyValidityForOriginationEnd;
                keyValidityStart2 = keyValidityStart;
                i++;
              ...
              case 536870917:
                ...
                keyValidityForConsumptionEnd = keyValidityForConsumptionEnd2;
                digestsList.add(
                    KeyProperties.Digest.fromKeymaster(a.keyParameter.value.getDigest()));
                keyValidityForConsumptionEnd2 = keyValidityForConsumptionEnd;
                keyValidityForOriginationEnd2 = keyValidityForOriginationEnd;
                keyValidityStart2 = keyValidityStart;
                i++;
                ...
                try {
                  ...
                  if (remainingUsageCountUnsigned > 2147483647L) {
                    throw new ProviderException(
                        "Usage count of limited use key too long: " + remainingUsageCountUnsigned);
                  }
