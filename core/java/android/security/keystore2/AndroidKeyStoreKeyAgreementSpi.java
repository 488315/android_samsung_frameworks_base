...
public class AndroidKeyStoreKeyAgreementSpi extends KeyAgreementSpi
  ...
  protected Key engineDoPhase(Key key, boolean lastPhase)
    ...
    if ((androidKeyStorePrivateKey instanceof ECKey)
        && !((ECKey) key)
            .getParams()
            .getCurve()
            .equals(((ECKey) this.mKey).getParams().getCurve())) {
  ...
  private void ensureKeystoreOperationInitialized()
    ...
    try {
      ...
      InvalidKeyException e =
          KeyStoreCryptoOperationUtils.getInvalidKeyException(this.mKey, keyStoreException);
      if (e != null) {
        throw e;
      }
    }
