...
public final class ParcelableKeyGenParameterSpec implements Parcelable {
  ...
  public static final Parcelable.Creator<ParcelableKeyGenParameterSpec> CREATOR =
      new Parcelable.Creator<
          ParcelableKeyGenParameterSpec>() { // from class:
  ...
  private ParcelableKeyGenParameterSpec(Parcel in) {
    ...
    if (keySpecType == 1) {
      ...
      AlgorithmParameterSpec algorithmSpec2 =
          new RSAKeyGenParameterSpec(rsaKeySize, publicExponent);
      ...
      throw new IllegalArgumentException(
          String.format("Unknown algorithm parameter spec: %d", Integer.valueOf(keySpecType)));
    }
