...
public class LegacyVpnProfileStore {
  ...
  public static boolean put(String alias, byte[] profile) {
    try {
      ...
      Log.m97e(TAG, "Failed to put vpn profile.", e);
      return false;
    }
  }
  ...
  public static byte[] get(String alias) {
    try {
      ...
      if (e.errorCode != 7) {
        Log.m97e(TAG, "Failed to get vpn profile.", e);
        return null;
      }
      return null;
    } catch (Exception e2) {
      Log.m97e(TAG, "Failed to get vpn profile.", e2);
      return null;
    }
  }
  ...
  public static boolean remove(String alias) {
    try {
      ...
      if (e.errorCode != 7) {
        Log.m97e(TAG, "Failed to remove vpn profile.", e);
        return false;
      }
      return false;
    } catch (Exception e2) {
      Log.m97e(TAG, "Failed to remove vpn profile.", e2);
      return false;
    }
  }
  ...
  public static String[] list(String prefix) {
    try {
      ...
      Log.m97e(TAG, "Failed to list vpn profiles.", e);
      return new String[0];
    }
  }
}
