...
public class ConfirmationPrompt {
    ...
    public void presentPrompt(Executor executor, ConfirmationCallback callback) throws ConfirmationAlreadyPresentingException, ConfirmationNotAvailableException {
        ...
        switch (responseCode) {
            ...
            case 6:
                throw new ConfirmationNotAvailableException();
            default:
                Log.m102w(TAG, "Unexpected responseCode=" + responseCode + " from presentConfirmationPrompt() call.");
    ...
    public void cancelPrompt() {
        ...
        Log.m102w(TAG, "Unexpected responseCode=" + responseCode + " from cancelConfirmationPrompt() call.");
        throw new IllegalStateException();
    }
