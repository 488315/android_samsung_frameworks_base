...
public final class Flags {
    ...
    public static final String FLAG_ASM_OPT_SYSTEM_INTO_ENFORCEMENT =
            "android.security.asm_opt_system_into_enforcement";
    public static final String FLAG_ASM_RESTRICTIONS_ENABLED =
            "android.security.asm_restrictions_enabled";
    public static final String FLAG_ASM_TOASTS_ENABLED = "android.security.asm_toasts_enabled";
    public static final String FLAG_BINARY_TRANSPARENCY_SEPOLICY_HASH =
            "android.security.binary_transparency_sepolicy_hash";
    public static final String FLAG_BLOCK_NULL_ACTION_INTENTS =
            "android.security.block_null_action_intents";
    public static final String FLAG_CERTIFICATE_TRANSPARENCY_CONFIGURATION =
            "android.security.certificate_transparency_configuration";
    public static final String FLAG_CONTENT_URI_PERMISSION_APIS =
            "android.security.content_uri_permission_apis";
    public static final String FLAG_DEPRECATE_FSV_SIG = "android.security.deprecate_fsv_sig";
    public static final String FLAG_DUMP_ATTESTATION_VERIFICATIONS =
            "android.security.dump_attestation_verifications";
    public static final String FLAG_ENFORCE_INTENT_FILTER_MATCH =
            "android.security.enforce_intent_filter_match";
    public static final String FLAG_EXTEND_ECM_TO_ALL_SETTINGS =
            "android.security.extend_ecm_to_all_settings";
    public static final String FLAG_EXTEND_VB_CHAIN_TO_UPDATED_APK =
            "android.security.extend_vb_chain_to_updated_apk";
    public static final String FLAG_FIX_UNLOCKED_DEVICE_REQUIRED_KEYS_V2 =
            "android.security.fix_unlocked_device_required_keys_v2";
    ...
    public static final String FLAG_KEYINFO_UNLOCKED_DEVICE_REQUIRED =
            "android.security.keyinfo_unlocked_device_required";
    public static final String FLAG_MGF1_DIGEST_SETTER_V2 =
            "android.security.mgf1_digest_setter_v2";
    public static final String FLAG_REPORT_PRIMARY_AUTH_ATTEMPTS =
