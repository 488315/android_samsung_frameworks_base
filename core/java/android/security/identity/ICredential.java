...
public interface ICredential extends IInterface {
  ...
  void storeStaticAuthenticationDataWithExpiration(AuthKeyParcel authKeyParcel, long j, byte[] bArr)
      throws RemoteException;
  ...
  public static class Default implements ICredential {
    ...
    public long selectAuthKey(
        boolean allowUsingExhaustedKeys, boolean allowUsingExpiredKeys, boolean incrementUsageCount)
        throws RemoteException {
      return 0L;
    }
    ...
    public void storeStaticAuthenticationDataWithExpiration(
        AuthKeyParcel authenticationKey, long expirationDateMillisSinceEpoch, byte[] staticAuthData)
        throws RemoteException {}
          ...
          switch (code) {
            ...
            case 8:
              ...
              RequestNamespaceParcel[] _arg12 =
                  (RequestNamespaceParcel[]) data.createTypedArray(RequestNamespaceParcel.CREATOR);
      ...
      public GetEntriesResultParcel getEntries(
        ...
        try {
          ...
          GetEntriesResultParcel _result =
              (GetEntriesResultParcel) _reply.readTypedObject(GetEntriesResultParcel.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
