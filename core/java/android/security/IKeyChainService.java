...
public interface IKeyChainService extends IInterface {
  ...
  void setCredentialManagementApp(String str, AppUriAuthenticationPolicy appUriAuthenticationPolicy)
      throws RemoteException;
  ...
  public static class Default implements IKeyChainService {
    ...
    @Override // android.security.IKeyChainService
    public void setCredentialManagementApp(String packageName, AppUriAuthenticationPolicy policy)
        throws RemoteException {}
