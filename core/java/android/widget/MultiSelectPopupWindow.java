...
public class MultiSelectPopupWindow {
    ...
    private class TextActionModeCallback extends ActionMode.Callback2 {
        ...
        private void populateMenuWithItems(Menu menu) {
            ...
            menu.add(0, C4337R.id.floatingToolbarClose, 0, C4337R.string.close).setIcon(MultiSelectPopupWindow.sTextView.getContext().getResources().getDrawable(C4337R.drawable.tw_floating_popup_button_ic_close));
            menu.add(0, C4337R.id.multiSelectCopy, 2, 17039361).setIcon(MultiSelectPopupWindow.sTextView.getContext().getResources().getDrawable(C4337R.drawable.tw_floating_popup_button_ic_copy)).setShowAsAction(2);
            if (MultiSelectPopupWindow.this.isShareViaEnable()) {
                menu.add(0, C4337R.id.multiSelectShare, 3, C4337R.string.share).setIcon(MultiSelectPopupWindow.sTextView.getContext().getResources().getDrawable(C4337R.drawable.tw_floating_popup_button_ic_share)).setShowAsAction(1);
            }
        ...
        private void updateSelectAllItem(Menu menu) {
            ...
            if (selectAllEnable && !selectAllItemExists) {
                menu.add(0, C4337R.id.multiSelectAll, 1, 17039373).setIcon(MultiSelectPopupWindow.sTextView.getContext().getResources().getDrawable(C4337R.drawable.tw_floating_popup_button_ic_selectall)).setShowAsAction(1);
        ...
        public void onGetContentRect(ActionMode mode, View view, Rect outRect) {
            ...
            int popupTopMargin = MultiSelectPopupWindow.sTextView.getResources().getDimensionPixelSize(C4337R.dimen.tw_floating_popup_top_margin);
            int popupBottomMargin = MultiSelectPopupWindow.sTextView.getResources().getDimensionPixelSize(C4337R.dimen.tw_floating_popup_bottom_margin);
    ...
    private abstract class HandleView extends View implements TextViewPositionListener {
        ...
        public HandleView(Drawable drawableLtr, Drawable drawableRtl) {
            ...
            updateDrawable();
            recalHandleView();
            this.mMinSize = MultiSelectPopupWindow.sTextView.getContext().getResources().getDimensionPixelSize(C4337R.dimen.text_handle_min_size);
