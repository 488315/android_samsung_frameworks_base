...
class DayPickerView extends ViewGroup {
  ...
  public DayPickerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    int monthTextAppearanceResId =
        a.getResourceId(16, C4337R.style.TextAppearance_Material_Widget_Calendar_Month);
    int dayOfWeekTextAppearanceResId =
        a.getResourceId(11, C4337R.style.TextAppearance_Material_Widget_Calendar_DayOfWeek);
    int dayTextAppearanceResId =
        a.getResourceId(12, C4337R.style.TextAppearance_Material_Widget_Calendar_Day);
    ...
    DayPickerPagerAdapter dayPickerPagerAdapter =
        new DayPickerPagerAdapter(
            context, C4337R.layout.date_picker_month_item_material, C4337R.id.month_view);
    ...
    if (monthTextAppearanceResId != 0) {
      TypedArray ta =
          this.mContext.obtainStyledAttributes(null, ATTRS_TEXT_COLOR, 0, monthTextAppearanceResId);
