...
class DayPickerView extends ViewGroup {
    ...
    public DayPickerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.CalendarView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.CalendarView, attrs, a, defStyleAttr, defStyleRes);
        ...
        int monthTextAppearanceResId = a.getResourceId(16, C4337R.style.TextAppearance_Material_Widget_Calendar_Month);
        int dayOfWeekTextAppearanceResId = a.getResourceId(11, C4337R.style.TextAppearance_Material_Widget_Calendar_DayOfWeek);
        int dayTextAppearanceResId = a.getResourceId(12, C4337R.style.TextAppearance_Material_Widget_Calendar_Day);
        ColorStateList daySelectorColor = a.getColorStateList(15);
        a.recycle();
        DayPickerPagerAdapter dayPickerPagerAdapter = new DayPickerPagerAdapter(context, C4337R.layout.date_picker_month_item_material, C4337R.id.month_view);
        ...
        ImageButton imageButton = (ImageButton) findViewById(C4337R.id.prev);
        this.mPrevButton = imageButton;
        imageButton.setOnClickListener(this.mOnClickListener);
        ImageButton imageButton2 = (ImageButton) findViewById(C4337R.id.next);
        this.mNextButton = imageButton2;
        imageButton2.setOnClickListener(this.mOnClickListener);
        ViewPager viewPager = (ViewPager) findViewById(C4337R.id.day_picker_view_pager);
