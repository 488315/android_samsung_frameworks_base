...
public class AutoCompleteTextView extends EditText implements Filter.FilterListener {
    ...
    public AutoCompleteTextView(Context context, AttributeSet attributeSet, int i, int i2, Resources.Theme theme) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C4337R.styleable.AutoCompleteTextView, i, i2);
        saveAttributeDataForStyleable(context, C4337R.styleable.AutoCompleteTextView, attributeSet, obtainStyledAttributes, i, i2);
        if (theme == null) {
        ...
        if (context2 != context) {
            TypedArray obtainStyledAttributes2 = context2.obtainStyledAttributes(attributeSet, C4337R.styleable.AutoCompleteTextView, i, i2);
            saveAttributeDataForStyleable(context, C4337R.styleable.AutoCompleteTextView, attributeSet, obtainStyledAttributes, i, i2);
