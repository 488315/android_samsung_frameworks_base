...
public class AutoCompleteTextView extends EditText implements Filter.FilterListener {
  ...
  public AutoCompleteTextView(
    ...
    TypedArray obtainStyledAttributes =
        context.obtainStyledAttributes(attributeSet, C4337R.styleable.AutoCompleteTextView, i, i2);
    saveAttributeDataForStyleable(
        context,
        C4337R.styleable.AutoCompleteTextView,
        attributeSet,
    ...
    if (context2 != context) {
      TypedArray obtainStyledAttributes2 =
          context2.obtainStyledAttributes(
              attributeSet, C4337R.styleable.AutoCompleteTextView, i, i2);
      saveAttributeDataForStyleable(
          context,
          C4337R.styleable.AutoCompleteTextView,
          attributeSet,
    ...
    int resourceId2 = typedArray.getResourceId(1, C4337R.layout.simple_dropdown_hint);
  ...
  public void setOnDismissListener(final OnDismissListener dismissListener) {
    ...
    if (dismissListener != null) {
      wrappedListener =
          new PopupWindow.OnDismissListener() { // from class: android.widget.AutoCompleteTextView.1
            @Override // android.widget.PopupWindow.OnDismissListener
  ...
  public void performCompletion(View selectedView, int position, long id) {
    ...
    if (isPopupShowing()) {
      ...
      if (selectedItem == null) {
        Log.m102w(TAG, "performCompletion: no selected item");
        return;
      }
  ...
  private void buildImeCompletions() {
    ...
    if (adapter != null
        && (imm = (InputMethodManager) getContext().getSystemService(InputMethodManager.class))
            != null) {
  ...
  private static class PopupDataSetObserver extends DataSetObserver {
    ...
    private PopupDataSetObserver(AutoCompleteTextView view) {
      this.updateRunnable =
          new Runnable() { // from class: android.widget.AutoCompleteTextView.PopupDataSetObserver.1
            @Override // java.lang.Runnable
            public void run() {
              ListAdapter adapter;
              AutoCompleteTextView textView =
                  (AutoCompleteTextView) PopupDataSetObserver.this.mViewReference.get();
