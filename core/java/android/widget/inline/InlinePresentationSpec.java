...
public final class InlinePresentationSpec implements Parcelable {
  public static final Parcelable.Creator<InlinePresentationSpec> CREATOR =
      new Parcelable.Creator<
          InlinePresentationSpec>() { // from class: android.widget.inline.InlinePresentationSpec.1
  ...
  InlinePresentationSpec(Size minSize, Size maxSize, Bundle style) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) minSize);
    this.mMaxSize = maxSize;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) maxSize);
    this.mStyle = style;
