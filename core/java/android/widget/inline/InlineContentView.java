...
public class InlineContentView extends ViewGroup {
        ...
        SurfaceView surfaceView = new SurfaceView(context, attrs, defStyleAttr, defStyleRes) { // from class: android.widget.inline.InlineContentView.4
            ...
            protected void onSetSurfacePositionAndScale(SurfaceControl.Transaction transaction, SurfaceControl surface, int positionLeft, int positionTop, float postScaleX, float postScaleY) {
                if (InlineContentView.this.mParentPosition != null) {
                    positionLeft = (int) ((positionLeft - InlineContentView.this.mParentPosition[0]) / InlineContentView.this.mParentScale.f87x);
                    positionTop = (int) ((positionTop - InlineContentView.this.mParentPosition[1]) / InlineContentView.this.mParentScale.f88y);
                }
    ...
    public void computeParentPositionAndScale() {
        ...
        if (parentSurfaceOwnerView != null) {
            ...
            if (!contentPositionOrScaleChanged && Float.compare(oldParentScaleX, this.mParentScale.f87x) != 0) {
                contentPositionOrScaleChanged = true;
            }
            ...
            if (!contentPositionOrScaleChanged && Float.compare(oldParentScaleY, this.mParentScale.f88y) != 0) {
                contentPositionOrScaleChanged = true;
            }
