...
public class InlineContentView extends ViewGroup {
    ...
    public InlineContentView(
        ...
        this.mSurfaceCallback =
                new SurfaceHolder
                        .Callback() { // from class: android.widget.inline.InlineContentView.1
                    @Override // android.view.SurfaceHolder.Callback
                    public void surfaceCreated(SurfaceHolder holder) {
                        SurfaceControl surfaceControl =
                                InlineContentView.this.mSurfaceView.getSurfaceControl();
                        surfaceControl.addOnReparentListener(
                                InlineContentView.this.mOnReparentListener);
                ...
                new SurfaceControl
                    ...
                    public void onReparent(
                        ...
                        if (!(parentSurfaceOwnerView instanceof SurfaceView)) {
                            ...
                            InlineContentView.this.mParentSurfaceOwnerView =
                                    new WeakReference((SurfaceView) parentSurfaceOwnerView);
                        }
                    }
                };
        this.mOnDrawListener =
                new ViewTreeObserver
                        .OnDrawListener() { // from class: android.widget.inline.InlineContentView.3
        ...
        this.mSurfaceView =
                new SurfaceView(
                        ...
                        attrs,
                        defStyleAttr,
                        defStyleRes) { // from class: android.widget.inline.InlineContentView.4
                    ...
                    protected void onSetSurfacePositionAndScale(
                        ...
                        if (InlineContentView.this.mParentPosition != null) {
                            positionLeft =
                                    (int)
                                            ((positionLeft
                                                            - InlineContentView.this
                                                                    .mParentPosition[0])
                                                    / InlineContentView.this.mParentScale.x);
                            positionTop =
                                    (int)
                                            ((positionTop
                                                            - InlineContentView.this
                                                                    .mParentPosition[1])
                                                    / InlineContentView.this.mParentScale.y);
                        }
    ...
    protected void onAttachedToWindow() {
        ...
        if (this.mSurfacePackageUpdater != null) {
            this.mSurfacePackageUpdater.getSurfacePackage(
                    new Consumer() { // from class:
                                     // android.widget.inline.InlineContentView$$ExternalSyntheticLambda0
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            InlineContentView.this.lambda$onAttachedToWindow$0(
                                    (SurfaceControlViewHost.SurfacePackage) obj);
                        }
                    });
        }
    ...
    public void computeParentPositionAndScale() {
        ...
        SurfaceView parentSurfaceOwnerView =
                this.mParentSurfaceOwnerView != null ? this.mParentSurfaceOwnerView.get() : null;
        if (parentSurfaceOwnerView != null) {
            ...
            if (oldParentPositionX != this.mParentPosition[0]
                    || oldParentPositionY != this.mParentPosition[1]) {
                contentPositionOrScaleChanged = true;
            }
            if (this.mParentScale == null) {
                this.mParentScale = new PointF();
            }
            float lastParentSurfaceWidth =
                    parentSurfaceOwnerView.getSurfaceRenderPosition().width();
            ...
            if (!contentPositionOrScaleChanged
                    && Float.compare(oldParentScaleX, this.mParentScale.x) != 0) {
                contentPositionOrScaleChanged = true;
            }
            float lastParentSurfaceHeight =
                    parentSurfaceOwnerView.getSurfaceRenderPosition().height();
            ...
            if (!contentPositionOrScaleChanged
                    && Float.compare(oldParentScaleY, this.mParentScale.y) != 0) {
                contentPositionOrScaleChanged = true;
            }
