...
class DatePickerCalendarDelegate extends DatePicker.AbstractDatePickerDelegate {
  ...
  public DatePickerCalendarDelegate(
    ...
    DayPickerView.OnDaySelectedListener onDaySelectedListener =
        new DayPickerView
            .OnDaySelectedListener() { // from class: android.widget.DatePickerCalendarDelegate.1
    ...
    YearPickerView.OnYearSelectedListener onYearSelectedListener =
        new YearPickerView
            .OnYearSelectedListener() { // from class: android.widget.DatePickerCalendarDelegate.2
    ...
    int layoutResourceId = a.getResourceId(19, C4337R.layout.date_picker_material);
    ViewGroup viewGroup =
    ...
    ViewGroup header = (ViewGroup) this.mContainer.findViewById(C4337R.id.date_picker_header);
    TextView textView = (TextView) header.findViewById(C4337R.id.date_picker_header_year);
    this.mHeaderYear = textView;
    textView.setOnClickListener(onClickListener);
    TextView textView2 = (TextView) header.findViewById(C4337R.id.date_picker_header_date);
    ...
    a.recycle();
    ViewAnimator viewAnimator = (ViewAnimator) this.mContainer.findViewById(C4337R.id.animator);
    this.mAnimator = viewAnimator;
    DayPickerView dayPickerView =
        (DayPickerView) viewAnimator.findViewById(C4337R.id.date_picker_day_picker);
    ...
    YearPickerView yearPickerView =
        (YearPickerView) this.mAnimator.findViewById(C4337R.id.date_picker_year_picker);
    ...
    this.mSelectDay = res.getString(C4337R.string.select_day);
    this.mSelectYear = res.getString(C4337R.string.select_year);
  ...
  public /* synthetic */ void lambda$new$0(View v) {
    tryVibrate();
    switch (v.getId()) {
      case C4337R.id.date_picker_header_date /* 16908971 */:
        setCurrentView(0);
        break;
      case C4337R.id.date_picker_header_year /* 16908972 */:
        setCurrentView(1);
        break;
    }
  }
