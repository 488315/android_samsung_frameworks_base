...
class DatePickerCalendarDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C4337R.styleable.DatePicker, defStyleAttr, defStyleRes);
        ...
        DayPickerView dayPickerView = (DayPickerView) viewAnimator.findViewById(C4337R.id.date_picker_day_picker);
        ...
        YearPickerView yearPickerView = (YearPickerView) this.mAnimator.findViewById(C4337R.id.date_picker_year_picker);
