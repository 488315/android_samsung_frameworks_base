...
public class AdapterViewFlipper extends AdapterViewAnimator {
  ...
  public AdapterViewFlipper(Context context) {
    ...
    this.mReceiver =
        new BroadcastReceiver() { // from class: android.widget.AdapterViewFlipper.1
    ...
    this.mFlipRunnable =
        new Runnable() { // from class: android.widget.AdapterViewFlipper.2
  ...
  public AdapterViewFlipper(
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.AdapterViewFlipper, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.AdapterViewFlipper, attrs, a, defStyleAttr, defStyleRes);
  ...
  protected void onAttachedToWindow() {
    ...
    getContext()
        .registerReceiverAsUser(this.mReceiver, Process.myUserHandle(), filter, null, getHandler());
    if (this.mAutoStart) {
      startFlipping();
    }
  }
