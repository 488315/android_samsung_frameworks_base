...
public class AdapterViewFlipper extends AdapterViewAnimator {
    ...
    public AdapterViewFlipper(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.AdapterViewFlipper, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.AdapterViewFlipper, attrs, a, defStyleAttr, defStyleRes);
