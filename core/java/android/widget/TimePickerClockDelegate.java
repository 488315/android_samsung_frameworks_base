...
class TimePickerClockDelegate extends TimePicker.AbstractTimePickerDelegate {
  ...
  /* renamed from: AM */
  private static final int f622AM = 0;
  ...
  /* renamed from: PM */
  private static final int f623PM = 1;
  ...
  public TimePickerClockDelegate(
    ...
    RadialTimePickerView.OnValueSelectedListener onValueSelectedListener2 =
        new RadialTimePickerView
            .OnValueSelectedListener() { // from class: android.widget.TimePickerClockDelegate.2
          ...
          public void onValueSelected(int pickerType, int newValue, boolean autoAdvance) {
            ...
            switch (pickerType) {
              case 0:
                ...
                boolean isTransition =
                    TimePickerClockDelegate.this.mAllowAutoAdvance && autoAdvance;
                ...
                if (isTransition) {
                  ...
                  TimePickerClockDelegate.this.mDelegator.announceForAccessibility(
                      localizedHour + ". " + TimePickerClockDelegate.this.mSelectMinutes);
                  break;
                }
                break;
              case 1:
            ...
            if (TimePickerClockDelegate.this.mOnTimeChangedListener != null && valueChanged) {
              TimePickerClockDelegate.this.mOnTimeChangedListener.onTimeChanged(
                  TimePickerClockDelegate.this.mDelegator,
                  TimePickerClockDelegate.this.getHour(),
                  TimePickerClockDelegate.this.getMinute());
            }
          }
        };
    this.mOnValueSelectedListener = onValueSelectedListener2;
    TextInputTimePickerView.OnValueTypedListener onValueTypedListener =
        new TextInputTimePickerView
            .OnValueTypedListener() { // from class: android.widget.TimePickerClockDelegate.3
    ...
    NumericTextView.OnValueChangedListener onValueChangedListener =
        new NumericTextView
            .OnValueChangedListener() { // from class: android.widget.TimePickerClockDelegate.4
          @Override // com.android.internal.widget.NumericTextView.OnValueChangedListener
          public void onValueChanged(
              NumericTextView view, int value, boolean isValid, boolean isFinished) {
    ...
    this.mCommitHour =
        new Runnable() { // from class: android.widget.TimePickerClockDelegate.5
    ...
    this.mCommitMinute =
        new Runnable() { // from class: android.widget.TimePickerClockDelegate.6
          @Override // java.lang.Runnable
          public void run() {
            TimePickerClockDelegate timePickerClockDelegate = TimePickerClockDelegate.this;
    ...
    View.OnFocusChangeListener onFocusChangeListener =
        new View.OnFocusChangeListener() { // from class: android.widget.TimePickerClockDelegate.7
          @Override // android.view.View.OnFocusChangeListener
          public void onFocusChange(View v, boolean focused) {
            if (focused) {
              switch (v.getId()) {
                case C4337R.id.am_label /* 16908785 */:
                  TimePickerClockDelegate.this.setAmOrPm(0);
                  break;
                case C4337R.id.hours /* 16909140 */:
                  TimePickerClockDelegate.this.setCurrentItemShowing(0, true, true);
                  break;
                case C4337R.id.minutes /* 16909329 */:
                  TimePickerClockDelegate.this.setCurrentItemShowing(1, true, true);
                  break;
                case C4337R.id.pm_label /* 16909479 */:
    ...
    View.OnClickListener onClickListener =
        new View.OnClickListener() { // from class: android.widget.TimePickerClockDelegate.8
    ...
    TypedArray a =
        this.mContext.obtainStyledAttributes(
            attrs, C4337R.styleable.TimePicker, defStyleAttr, defStyleRes);
    LayoutInflater inflater =
        (LayoutInflater) this.mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    Resources res = this.mContext.getResources();
    this.mSelectHours = res.getString(C4337R.string.select_hours);
    this.mSelectMinutes = res.getString(C4337R.string.select_minutes);
    int layoutResourceId = a.getResourceId(12, C4337R.layout.time_picker_material);
    View mainView = inflater.inflate(layoutResourceId, delegator);
    mainView.setSaveFromParentEnabled(false);
    View findViewById = mainView.findViewById(C4337R.id.time_header);
    this.mRadialTimePickerHeader = findViewById;
    findViewById.setOnTouchListener(new NearestTouchDelegate());
    NumericTextView numericTextView = (NumericTextView) mainView.findViewById(C4337R.id.hours);
    ...
    numericTextView.setAccessibilityDelegate(
        new ClickActionDelegate(context, C4337R.string.select_hours));
    TextView textView = (TextView) mainView.findViewById(C4337R.id.separator);
    this.mSeparatorView = textView;
    NumericTextView numericTextView2 = (NumericTextView) mainView.findViewById(C4337R.id.minutes);
    ...
    numericTextView2.setAccessibilityDelegate(
        new ClickActionDelegate(context, C4337R.string.select_minutes));
    numericTextView2.setRange(0, 59);
    View findViewById2 = mainView.findViewById(C4337R.id.ampm_layout);
    ...
    RadioButton radioButton = (RadioButton) findViewById2.findViewById(C4337R.id.am_label);
    this.mAmLabel = radioButton;
    radioButton.setText(obtainVerbatim(amPmStrings[0]));
    radioButton.setOnClickListener(onClickListener);
    ensureMinimumTextWidth(radioButton);
    RadioButton radioButton2 = (RadioButton) findViewById2.findViewById(C4337R.id.pm_label);
    ...
    if (timeHeaderTextAppearance == 0) {
      ...
      TypedArray textAppearance =
          this.mContext.obtainStyledAttributes(null, ATTRS_TEXT_COLOR, 0, timeHeaderTextAppearance);
    ...
    View findViewById3 = mainView.findViewById(C4337R.id.input_header);
    ...
    RadialTimePickerView radialTimePickerView =
        (RadialTimePickerView) mainView.findViewById(C4337R.id.radial_picker);
    ...
    TextInputTimePickerView textInputTimePickerView =
        (TextInputTimePickerView) mainView.findViewById(C4337R.id.input_mode);
    this.mTextInputPickerView = textInputTimePickerView;
    textInputTimePickerView.setListener(onValueTypedListener);
    ImageButton imageButton = (ImageButton) mainView.findViewById(C4337R.id.toggle_mode);
    this.mRadialTimePickerModeButton = imageButton;
    imageButton.setOnClickListener(
        new View.OnClickListener() { // from class: android.widget.TimePickerClockDelegate.1
          @Override // android.view.View.OnClickListener
          public void onClick(View v) {
            TimePickerClockDelegate.this.toggleRadialPickerMode();
          }
        });
    this.mRadialTimePickerModeEnabledDescription =
        context.getResources().getString(C4337R.string.time_picker_radial_mode_description);
    this.mTextInputPickerModeEnabledDescription =
        context.getResources().getString(C4337R.string.time_picker_text_input_mode_description);
  ...
  public void toggleRadialPickerMode() {
    if (this.mRadialPickerModeEnabled) {
      ...
      this.mRadialTimePickerModeButton.setImageResource(C4337R.drawable.btn_clock_material);
      this.mRadialTimePickerModeButton.setContentDescription(
          this.mRadialTimePickerModeEnabledDescription);
    ...
    this.mRadialTimePickerModeButton.setImageResource(C4337R.drawable.btn_keyboard_key_material);
    this.mRadialTimePickerModeButton.setContentDescription(
        this.mTextInputPickerModeEnabledDescription);
  ...
  */
  private void updateHourFormat() {
    ...
    String bestDateTimePattern =
        DateFormat.getBestDateTimePattern(this.mLocale, this.mIs24Hour ? "Hm" : "hm");
  ...
  private static class ClickActionDelegate extends View.AccessibilityDelegate {
    ...
    public ClickActionDelegate(Context context, int resId) {
      this.mClickAction =
          new AccessibilityNodeInfo.AccessibilityAction(16, context.getString(resId));
    }
  ...
  private void updateTextInputPicker() {
    this.mTextInputPickerView.updateTextInputValues(
        getLocalizedHour(this.mCurrentHour),
        this.mCurrentMinute,
        this.mCurrentHour < 12 ? 0 : 1,
        this.mIs24Hour,
        this.mHourFormatStartsAtZero);
  }
  ...
  private void setAmPmStart(boolean isAmPmAtStart) {
    ...
    RelativeLayout.LayoutParams params =
        (RelativeLayout.LayoutParams) this.mAmPmLayout.getLayoutParams();
  ...
  public Parcelable onSaveInstanceState(Parcelable superState) {
    return new TimePicker.AbstractTimePickerDelegate.SavedState(
        superState, getHour(), getMinute(), is24Hour(), getCurrentItemShowing());
  }
  ...
  public void onPopulateAccessibilityEvent(AccessibilityEvent event) {
    ...
    String selectedTime =
        DateUtils.formatDateTime(this.mContext, this.mTempCalendar.getTimeInMillis(), flags);
    String selectionMode =
        this.mRadialTimePickerView.getCurrentItemShowing() == 0
            ? this.mSelectHours
            : this.mSelectMinutes;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
      ...
      if (actionMasked == 0) {
        if (view instanceof ViewGroup) {
          this.mInitialTouchTarget =
              findNearestChild(
                  (ViewGroup) view, (int) motionEvent.getX(), (int) motionEvent.getY());
        } else {
