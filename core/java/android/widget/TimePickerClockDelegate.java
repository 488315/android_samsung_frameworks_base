...
class TimePickerClockDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    public TimePickerClockDelegate(TimePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C4337R.styleable.TimePicker, defStyleAttr, defStyleRes);
        ...
        numericTextView.setAccessibilityDelegate(new ClickActionDelegate(context, C4337R.string.select_hours));
        ...
        numericTextView2.setAccessibilityDelegate(new ClickActionDelegate(context, C4337R.string.select_minutes));
        ...
        a.recycle();
        RadialTimePickerView radialTimePickerView = (RadialTimePickerView) mainView.findViewById(C4337R.id.radial_picker);
        ...
        TextInputTimePickerView textInputTimePickerView = (TextInputTimePickerView) mainView.findViewById(C4337R.id.input_mode);
        ...
        this.mRadialTimePickerModeEnabledDescription = context.getResources().getString(C4337R.string.time_picker_radial_mode_description);
        this.mTextInputPickerModeEnabledDescription = context.getResources().getString(C4337R.string.time_picker_text_input_mode_description);
