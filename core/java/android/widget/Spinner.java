...
public class Spinner extends AbsSpinner implements DialogInterface.OnClickListener {
  ...
  public final class InspectionCompanion
      implements android.view.inspector.InspectionCompanion<Spinner> {
  ...
  public Spinner(
      Context context, AttributeSet attributeSet, int i, int i2, int i3, Resources.Theme theme) {
    ...
    TypedArray obtainStyledAttributes =
        context.obtainStyledAttributes(attributeSet, C4337R.styleable.Spinner, i, i2);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.Spinner, attributeSet, obtainStyledAttributes, i, i2);
    if (theme == null) {
    ...
    context.getTheme().resolveAttribute(C4337R.attr.parentIsDeviceDefault, typedValue, true);
    ...
    switch (i4) {
      ...
      case 1:
        final DropdownPopup dropdownPopup =
            new DropdownPopup(this.mPopupContext, attributeSet, i, i2);
        TypedArray obtainStyledAttributes2 =
            this.mPopupContext.obtainStyledAttributes(
                attributeSet, C4337R.styleable.Spinner, i, i2);
        ...
        TypedArray obtainStyledAttributes3 =
            context.obtainStyledAttributes(attributeSet, C4337R.styleable.ListPopupWindow, i, i2);
        this.mDropdownHorizontalOffset = obtainStyledAttributes3.getDimensionPixelOffset(0, 0);
        obtainStyledAttributes3.recycle();
        this.mPopup = dropdownPopup;
        this.mForwardingListener =
            new ForwardingListener(this) { // from class: android.widget.Spinner.1
              ...
              public boolean onForwardingStarted() {
                if (!Spinner.this.mPopup.isShowing()) {
                  Spinner.this.mPopup.show(
                      Spinner.this.getTextDirection(), Spinner.this.getTextAlignment());
                  return true;
                }
                return true;
              }
  ...
  public void setPopupBackgroundDrawable(Drawable background) {
    ...
    if (!(spinnerPopup instanceof DropdownPopup)) {
      Log.m96e(TAG, "setPopupBackgroundDrawable: incompatible spinner mode; ignoring...");
    } else {
  ...
  public void setDropDownWidth(int pixels) {
    if (!(this.mPopup instanceof DropdownPopup)) {
      Log.m96e(TAG, "Cannot set dropdown width for MODE_DIALOG, ignoring");
    } else {
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (this.mPopup != null && View.MeasureSpec.getMode(widthMeasureSpec) == Integer.MIN_VALUE) {
      ...
      if (this.mIsThemeDeviceDefaultFamily
          ...
          && getSelectedItemPosition() < this.mAdapter.getCount()) {
      ...
      setMeasuredDimension(
          Math.min(
              Math.max(measuredWidth, contentWidth), View.MeasureSpec.getSize(widthMeasureSpec)),
          getMeasuredHeight());
    }
  }
  ...
  void layout(int delta, boolean animate) {
    ...
    int childrenWidth =
        ((this.mRight - this.mLeft) - this.mSpinnerPadding.left) - this.mSpinnerPadding.right;
  ...
  private void setUpChild(View child, boolean addChild) {
    ...
    int childHeightSpec =
        ViewGroup.getChildMeasureSpec(
            ...
            this.mSpinnerPadding.top + this.mSpinnerPadding.bottom,
            lp.height);
    int childWidthSpec =
        ViewGroup.getChildMeasureSpec(
            this.mWidthMeasureSpec,
            this.mSpinnerPadding.left + this.mSpinnerPadding.right,
            lp.width);
    child.measure(childWidthSpec, childHeightSpec);
    int childTop =
        this.mSpinnerPadding.top
            + ((((getMeasuredHeight() - this.mSpinnerPadding.bottom) - this.mSpinnerPadding.top)
  ...
  @Override // android.widget.AbsSpinner, android.widget.AdapterView, android.view.ViewGroup,
            // android.view.View
  ...
  public void onRestoreInstanceState(Parcelable state) {
    ...
    if (ss.showDropdown && (vto = getViewTreeObserver()) != null) {
      ViewTreeObserver.OnGlobalLayoutListener listener =
          new ViewTreeObserver.OnGlobalLayoutListener() { // from class: android.widget.Spinner.2
  ...
  public void semSetDropDownHeight(int pixels) {
    SpinnerPopup spinnerPopup = this.mPopup;
    if (!(spinnerPopup instanceof DropdownPopup)) {
      Log.m96e(TAG, "Cannot set dropdown height for MODE_DIALOG, ignoring");
    } else {
  ...
  static class SavedState extends AbsSpinner.SavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<SavedState>() { // from class: android.widget.Spinner.SavedState.1
  ...
  private class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
    ...
    public void show(int textDirection, int textAlignment) {
      ...
      AlertDialog create =
          builder
              .setSingleChoiceItems(this.mListAdapter, Spinner.this.getSelectedItemPosition(), this)
              .create();
      this.mPopup = create;
    ...
    public void setBackgroundDrawable(Drawable bg) {
      Log.m96e(Spinner.TAG, "Cannot set popup background for MODE_DIALOG, ignoring");
    }

    @Override // android.widget.Spinner.SpinnerPopup
    public void setVerticalOffset(int px) {
      Log.m96e(Spinner.TAG, "Cannot set vertical offset for MODE_DIALOG, ignoring");
    }

    @Override // android.widget.Spinner.SpinnerPopup
    public void setHorizontalOffset(int px) {
      Log.m96e(Spinner.TAG, "Cannot set horizontal offset for MODE_DIALOG, ignoring");
    }
    ...
    public void setHeight(int px) {
      Log.m96e(Spinner.TAG, "Cannot set DropDown Height for MODE_DIALOG, ignoring");
    }
  }
  ...
  private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
    ...
    public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
      ...
      setOnItemClickListener(
          new AdapterView
              .OnItemClickListener() { // from class: android.widget.Spinner.DropdownPopup.1
            @Override // android.widget.AdapterView.OnItemClickListener
            public void onItemClick(AdapterView parent, View v, int position, long id) {
              Spinner.this.setSelection(position);
              if (Spinner.this.mOnItemClickListener != null) {
                Spinner.this.performItemClick(
                    v, position, DropdownPopup.this.mAdapter.getItemId(position));
              }
    ...
    void computeContentWidth() {
      ...
      if (background != null) {
        ...
        hOffset2 =
            Spinner.this.isLayoutRtl()
                ? Spinner.this.mTempRect.right
                : -Spinner.this.mTempRect.left;
      } else {
      ...
      if (Spinner.this.mDropDownWidth == -2) {
        int contentWidth =
            Spinner.this.measureContentWidth((SpinnerAdapter) this.mAdapter, getBackground());
        Rect contentFrame = new Rect();
        Spinner.this.getWindowDisplayFrame(contentFrame);
        int contentWidthLimit =
            ((contentFrame.right - contentFrame.left) - Spinner.this.mTempRect.left)
                - Spinner.this.mTempRect.right;
        ...
        if (Spinner.this.mIsThemeDeviceDefaultFamily) {
          ...
          setContentWidth(
              Math.max(contentWidth, (spinnerWidth - spinnerPaddingLeft) - spinnerPaddingRight));
        }
      ...
      if (!wasShowing && (vto = Spinner.this.getViewTreeObserver()) != null) {
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener =
            new ViewTreeObserver
                .OnGlobalLayoutListener() { // from class: android.widget.Spinner.DropdownPopup.2
              @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
              public void onGlobalLayout() {
                if (Spinner.this.mIsThemeDeviceDefaultFamily) {
        ...
        setOnDismissListener(
            new PopupWindow
                .OnDismissListener() { // from class: android.widget.Spinner.DropdownPopup.3
