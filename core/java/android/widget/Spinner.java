...
public class Spinner extends AbsSpinner implements DialogInterface.OnClickListener {
    ...
    public Spinner(Context context, AttributeSet attributeSet, int i, int i2, int i3, Resources.Theme theme) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C4337R.styleable.Spinner, i, i2);
        saveAttributeDataForStyleable(context, C4337R.styleable.Spinner, attributeSet, obtainStyledAttributes, i, i2);
        if (theme == null) {
        ...
        switch (i4) {
            ...
            case 1:
                ...
                TypedArray obtainStyledAttributes2 = this.mPopupContext.obtainStyledAttributes(attributeSet, C4337R.styleable.Spinner, i, i2);
                ...
                TypedArray obtainStyledAttributes3 = context.obtainStyledAttributes(attributeSet, C4337R.styleable.ListPopupWindow, i, i2);
    ...
    static class SavedState extends AbsSpinner.SavedState {
        ...
        @Override // android.widget.AbsSpinner.SavedState, android.view.View.BaseSavedState, android.view.AbsSavedState, android.p009os.Parcelable
