...
public class ViewFlipper extends ViewAnimator {
  ...
  public ViewFlipper(Context context) {
    ...
    this.mReceiver =
        new BroadcastReceiver() { // from class: android.widget.ViewFlipper.1
    ...
    this.mFlipRunnable =
        new Runnable() { // from class: android.widget.ViewFlipper.2
  ...
  public ViewFlipper(Context context, AttributeSet attrs) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ViewFlipper);
