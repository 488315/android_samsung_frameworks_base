...
class DatePickerSpinnerDelegate extends DatePicker.AbstractDatePickerDelegate {
  ...
  DatePickerSpinnerDelegate(
    ...
    TypedArray attributesArray =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.DatePicker, defStyleAttr, defStyleRes);
    ...
    int layoutResourceId = attributesArray.getResourceId(20, C4337R.layout.date_picker_legacy);
    ...
    NumberPicker.OnValueChangeListener onChangeListener =
        new NumberPicker
            .OnValueChangeListener() { // from class: android.widget.DatePickerSpinnerDelegate.1
          @Override // android.widget.NumberPicker.OnValueChangeListener
          public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
            DatePickerSpinnerDelegate.this.updateInputState();
            DatePickerSpinnerDelegate.this.mTempDate.setTimeInMillis(
                DatePickerSpinnerDelegate.this.mCurrentDate.getTimeInMillis());
            ...
            datePickerSpinnerDelegate.setDate(
                datePickerSpinnerDelegate.mTempDate.get(1),
                DatePickerSpinnerDelegate.this.mTempDate.get(2),
                DatePickerSpinnerDelegate.this.mTempDate.get(5));
    ...
    this.mSpinners = (LinearLayout) view2.findViewById(C4337R.id.pickers);
    CalendarView calendarView =
        (CalendarView) this.mDelegator.findViewById(C4337R.id.calendar_view);
    this.mCalendarView = calendarView;
    calendarView.setOnDateChangeListener(
        new CalendarView
            .OnDateChangeListener() { // from class: android.widget.DatePickerSpinnerDelegate.2
    ...
    NumberPicker numberPicker = (NumberPicker) this.mDelegator.findViewById(C4337R.id.day);
    ...
    this.mDaySpinnerInput = (EditText) numberPicker.findViewById(C4337R.id.numberpicker_input);
    NumberPicker numberPicker2 = (NumberPicker) this.mDelegator.findViewById(C4337R.id.month);
    ...
    this.mMonthSpinnerInput = (EditText) numberPicker2.findViewById(C4337R.id.numberpicker_input);
    NumberPicker numberPicker3 = (NumberPicker) this.mDelegator.findViewById(C4337R.id.year);
    this.mYearSpinner = numberPicker3;
    numberPicker3.setOnLongPressUpdateInterval(100L);
    numberPicker3.setOnValueChangedListener(onChangeListener);
    this.mYearSpinnerInput = (EditText) numberPicker3.findViewById(C4337R.id.numberpicker_input);
  ...
  public Parcelable onSaveInstanceState(Parcelable superState) {
    return new DatePicker.AbstractDatePickerDelegate.SavedState(
        ...
        getMonth(),
        getDayOfMonth(),
        getMinDate().getTimeInMillis(),
        getMaxDate().getTimeInMillis());
  }
  ...
  private boolean isNewDate(int year, int month, int dayOfMonth) {
    return (this.mCurrentDate.get(1) == year
            && this.mCurrentDate.get(2) == month
            && this.mCurrentDate.get(5) == dayOfMonth)
        ? false
        : true;
  }
  ...
  public void updateSpinners() {
    ...
    String[] displayedValues =
        (String[])
            Arrays.copyOfRange(
                this.mShortMonths,
                this.mMonthSpinner.getMinValue(),
                this.mMonthSpinner.getMaxValue() + 1);
  ...
  public void notifyDateChanged() {
    ...
    if (this.mOnDateChangedListener != null) {
      this.mOnDateChangedListener.onDateChanged(
          this.mDelegator, getYear(), getMonth(), getDayOfMonth());
    }
  ...
  private void setImeOptions(NumberPicker spinner, int spinnerCount, int spinnerIndex) {
    ...
    TextView input = (TextView) spinner.findViewById(C4337R.id.numberpicker_input);
    input.setImeOptions(imeOptions);
  }

  private void setContentDescriptions() {
    trySetContentDescription(
        this.mDaySpinner, C4337R.id.increment, C4337R.string.date_picker_increment_day_button);
    trySetContentDescription(
        this.mDaySpinner, C4337R.id.decrement, C4337R.string.date_picker_decrement_day_button);
    trySetContentDescription(
        this.mMonthSpinner, C4337R.id.increment, C4337R.string.date_picker_increment_month_button);
    trySetContentDescription(
        this.mMonthSpinner, C4337R.id.decrement, C4337R.string.date_picker_decrement_month_button);
    trySetContentDescription(
        this.mYearSpinner, C4337R.id.increment, C4337R.string.date_picker_increment_year_button);
    trySetContentDescription(
        this.mYearSpinner, C4337R.id.decrement, C4337R.string.date_picker_decrement_year_button);
  }
