...
class DatePickerSpinnerDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C4337R.styleable.DatePicker, defStyleAttr, defStyleRes);
        ...
        CalendarView calendarView = (CalendarView) this.mDelegator.findViewById(C4337R.id.calendar_view);
    ...
    private void setContentDescriptions() {
        trySetContentDescription(this.mDaySpinner, C4337R.id.increment, C4337R.string.date_picker_increment_day_button);
        trySetContentDescription(this.mDaySpinner, C4337R.id.decrement, C4337R.string.date_picker_decrement_day_button);
        trySetContentDescription(this.mMonthSpinner, C4337R.id.increment, C4337R.string.date_picker_increment_month_button);
        trySetContentDescription(this.mMonthSpinner, C4337R.id.decrement, C4337R.string.date_picker_decrement_month_button);
        trySetContentDescription(this.mYearSpinner, C4337R.id.increment, C4337R.string.date_picker_increment_year_button);
        trySetContentDescription(this.mYearSpinner, C4337R.id.decrement, C4337R.string.date_picker_decrement_year_button);
    }
