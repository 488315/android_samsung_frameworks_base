...
public class DateTimeView extends TextView {
      ...
      if (duration < 60000) {
        ...
        result =
            PluralsMessageFormatter.format(
                ...
                arguments,
                past
                    ? C4337R.string.duration_minutes_relative
                    : C4337R.string.duration_minutes_relative_future);
      } else if (duration < 86400000) {
        ...
        result =
            PluralsMessageFormatter.format(
                ...
                arguments,
                past
                    ? C4337R.string.duration_hours_relative
                    : C4337R.string.duration_hours_relative_future);
      } else if (duration < 31449600000L) {
        LocalDateTime localDateTime = this.mLocalTime;
        ZoneId zoneId = ZoneId.systemDefault();
        LocalDateTime localNow = toLocalDateTime(now, zoneId);
        ...
        String result2 =
            PluralsMessageFormatter.format(
                ...
                arguments,
                past
                    ? C4337R.string.duration_days_relative
                    : C4337R.string.duration_days_relative_future);
        result = result2;
      } else {
        ...
        result =
            PluralsMessageFormatter.format(
                ...
                arguments,
                past
                    ? C4337R.string.duration_years_relative
                    : C4337R.string.duration_years_relative_future);
      }
      info.setText(result);
    }
  }
  ...
  static class ReceiverInfo {
    ...
    private ReceiverInfo() {
      ...
      this.mReceiver =
          new BroadcastReceiver() { // from class: android.widget.DateTimeView.ReceiverInfo.1
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
              String action = intent.getAction();
              if (Intent.ACTION_TIME_TICK.equals(action)
                  && System.currentTimeMillis() < ReceiverInfo.this.getSoonestUpdateTime()) {
                return;
              }
      ...
      this.mObserver =
          new ContentObserver(
              new Handler()) { // from class: android.widget.DateTimeView.ReceiverInfo.2
