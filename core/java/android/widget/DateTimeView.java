...
public class DateTimeView extends TextView {
    ...
    public DateTimeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mLastDisplay = -1;
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.DateTimeView, 0, 0);
    ...
    private void updateRelativeTime() {
        ...
        if (duration < 3600000) {
            ...
            if (past) {
                i4 = C4337R.string.duration_minutes_shortest;
            } else {
                i4 = C4337R.string.duration_minutes_shortest_future;
            }
            ...
            if (past) {
                i3 = C4337R.string.duration_hours_shortest;
            } else {
                i3 = C4337R.string.duration_hours_shortest_future;
            }
            ...
            if (past) {
                i2 = C4337R.string.duration_days_shortest;
            } else {
                i2 = C4337R.string.duration_days_shortest_future;
            }
            ...
            if (past) {
                i = C4337R.string.duration_years_shortest;
            } else {
                i = C4337R.string.duration_years_shortest_future;
            }
    ...
    private void updateNowText() {
        ...
        this.mNowText = getContext().getResources().getString(C4337R.string.now_string_shortest);
    }
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        if (this.mShowRelativeTime) {
            ...
            if (duration < 60000) {
                ...
                result = PluralsMessageFormatter.format(getContext().getResources(), arguments, past ? C4337R.string.duration_minutes_relative : C4337R.string.duration_minutes_relative_future);
            } else if (duration < 86400000) {
                int count2 = (int) (duration / 3600000);
                arguments.put(Contract.Events.Projection.COUNT_ONLY, Integer.valueOf(count2));
                result = PluralsMessageFormatter.format(getContext().getResources(), arguments, past ? C4337R.string.duration_hours_relative : C4337R.string.duration_hours_relative_future);
            } else if (duration < 31449600000L) {
                LocalDateTime localDateTime = this.mLocalTime;
                ZoneId zoneId = ZoneId.systemDefault();
                LocalDateTime localNow = toLocalDateTime(now, zoneId);
                ...
                String result2 = PluralsMessageFormatter.format(getContext().getResources(), arguments, past ? C4337R.string.duration_days_relative : C4337R.string.duration_days_relative_future);
                result = result2;
            } else {
                int count4 = (int) (duration / 31449600000L);
                arguments.put(Contract.Events.Projection.COUNT_ONLY, Integer.valueOf(count4));
                result = PluralsMessageFormatter.format(getContext().getResources(), arguments, past ? C4337R.string.duration_years_relative : C4337R.string.duration_years_relative_future);
            }
            info.setText(result);
        }
    }
    ...
    static class ReceiverInfo {
        ...
        void updateAll() {
            synchronized (this.mAttachedViews) {
                ...
                if (count > 0) {
                    Log.m98i(DateTimeView.TAG, "updateAll - getTimeFormat");
