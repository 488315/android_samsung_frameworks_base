...
public class ExpandableListView extends ListView {
  ...
  public ExpandableListView(
    ...
    saveAttributeDataForStyleable(
        context, C4337R.styleable.ExpandableListView, attrs, a, defStyleAttr, defStyleRes);
  ...
  boolean handleItemClick(View v, int position, long id) {
    ...
    if (posMetadata.position.type == 2) {
      ...
      if (onGroupClickListener != null
          && onGroupClickListener.onGroupClick(this, v, posMetadata.position.groupPos, id2)) {
        posMetadata.recycle();
        return true;
      }
  ...
  static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<
            SavedState>() { // from class: android.widget.ExpandableListView.SavedState.1
  ...
  public Parcelable onSaveInstanceState() {
    ...
    return new SavedState(
        ...
        expandableListConnector != null
            ? expandableListConnector.getExpandedGroupMetadataList()
            : null);
  }
