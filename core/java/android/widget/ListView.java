...
public class ListView extends AbsListView {
    ...
    public ListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ListView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.ListView, attrs, a, defStyleAttr, defStyleRes);
    ...
    public void addHeaderView(View v, Object data, boolean isSelectable) {
        if (v.getParent() != null && v.getParent() != this && Log.isLoggable(TAG, 5)) {
            Log.m102w(TAG, "The specified child already has a parent. You must call removeView() on the child's parent first.");
        }
        ...
        try {
            ...
            switch (this.mLayoutMode) {
                ...
                default:
                    ...
                    int delta3 = this.mNextSelectedPosition >= 0 ? this.mNextSelectedPosition - this.mSelectedPosition : 0;
            ...
            if (viewRootImpl == null || (focusHost = viewRootImpl.getAccessibilityFocusedHost()) == null) {
            ...
            if (sel != null) {
                if (this.mItemsCanFocus && hasFocus() && (!sel.hasFocus() || focusFirstItemTemporarily)) {
                    boolean focusWasTaken = (sel == focusLayoutRestoreDirectChild3 && focusLayoutRestoreView != null && focusLayoutRestoreView.requestFocus()) || sel.requestFocus();
                    if (focusWasTaken) {
            ...
            if (viewRootImpl != null) {
                ...
                if (newAccessibilityFocusedView == null) {
                    if (accessibilityFocusLayoutRestoreView != null && accessibilityFocusLayoutRestoreView.isAttachedToWindow()) {
                        ...
                        View restoreView = getChildAt(MathUtils.constrain(delta2 - this.mFirstPosition, 0, getChildCount() - 1));
                        if (restoreView != null) {
                    ...
                    View restoreView2 = mInsideViewAccFocused ? getChildAt(position).findViewById(newAccessibilityFocusedView.getId()) : getChildAt(position);
                    if (newAccessibilityFocusedView.isAccessibilityFocused() && newAccessibilityFocusedView != restoreView2) {
    ...
    */
    private boolean commonKey(int keyCode, int count, KeyEvent event) {
        ...
        if (KeyEvent.isConfirmKey(keyCode) && event.hasNoModifiers() && action != 1 && !(handled2 = resurrectSelectionIfNeeded()) && event.getRepeatCount() == 0 && getChildCount() > 0) {
            keyPressed();
            handled2 = true;
        }
            ...
            switch (keyCode) {
                ...
                case 61:
                    ...
                    if (this.mAppWidgetSnapScroll) {
                        ...
                        View viewFocusedNext = FocusFinder.getInstance().findNextFocus(this, deepestFocusedView, 2);
                        ...
                        if (viewFocusedNext != null) {
                            ...
                            if (rootBottom < childBottom) {
                                ...
                                if (childLoc[1] > rootBottom) {
                                    setSelectionFromTop(this.mSelectedPosition, firstVisibleView.getTop() - childLoc[1]);
                                }
                                ...
                                if (childRelativeTop2 >= bottom / 3) {
                                    childRelativeTop = childRelativeTop2 - ((getHeight() - this.mListPadding.bottom) / 3);
                                    handled2 = false;
                                } else {
                                    childRelativeTop = 0;
                                    handled2 = true;
