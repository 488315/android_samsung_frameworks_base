...
public class MediaController extends FrameLayout {
  ...
  public MediaController(Context context, AttributeSet attrs) {
    ...
    this.mAttachStateListener =
        new View.OnAttachStateChangeListener() { // from class: android.widget.MediaController.1
          ...
          public void onLayoutChange(
            ...
            if (MediaController.this.mShowing) {
              MediaController.this.mWindowManager.updateViewLayout(
                  MediaController.this.mDecor, MediaController.this.mDecorLayoutParams);
            }
          }
        };
    this.mTouchListener =
    ...
    this.mSeekListener =
        new SeekBar.OnSeekBarChangeListener() { // from class: android.widget.MediaController.7
          ...
          public void onProgressChanged(SeekBar bar, int progress, boolean fromuser) {
            ...
            if (MediaController.this.mCurrentTime != null) {
              MediaController.this.mCurrentTime.setText(
  ...
  public void updateFloatingWindowLayout() {
    ...
    p.f573x = anchorPos[0] + ((this.mAnchor.getWidth() - p.width) / 2);
    p.f574y = (anchorPos[1] + this.mAnchor.getHeight()) - this.mDecor.getMeasuredHeight();
  ...
  protected View makeControllerView() {
    ...
    View inflate2 = inflate.inflate(C4337R.layout.media_controller, (ViewGroup) null);
    this.mRoot = inflate2;
  ...
  private void initControllerView(View v) {
    ...
    this.mPlayDescription = res.getText(C4337R.string.lockscreen_transport_play_description);
    this.mPauseDescription = res.getText(C4337R.string.lockscreen_transport_pause_description);
    ImageButton imageButton = (ImageButton) v.findViewById(C4337R.id.pause);
    this.mPauseButton = imageButton;
    if (imageButton != null) {
      imageButton.requestFocus();
      this.mPauseButton.setOnClickListener(this.mPauseListener);
    }
    ImageButton imageButton2 = (ImageButton) v.findViewById(C4337R.id.ffwd);
    ...
    ImageButton imageButton3 = (ImageButton) v.findViewById(C4337R.id.rew);
    ...
    ImageButton imageButton4 = (ImageButton) v.findViewById(C4337R.id.next);
    this.mNextButton = imageButton4;
    if (imageButton4 != null && !this.mFromXml && !this.mListenersSet) {
      imageButton4.setVisibility(8);
    }
    ImageButton imageButton5 = (ImageButton) v.findViewById(C4337R.id.prev);
    this.mPrevButton = imageButton5;
    if (imageButton5 != null && !this.mFromXml && !this.mListenersSet) {
      imageButton5.setVisibility(8);
    }
    ProgressBar progressBar = (ProgressBar) v.findViewById(C4337R.id.mediacontroller_progress);
    ...
    this.mEndTime = (TextView) v.findViewById(C4337R.id.time);
    this.mCurrentTime = (TextView) v.findViewById(C4337R.id.time_current);
  ...
  public void hide() {
    if (this.mAnchor != null && this.mShowing) {
      try {
        ...
        Log.m102w("MediaController", "already removed");
      }
      this.mShowing = false;
