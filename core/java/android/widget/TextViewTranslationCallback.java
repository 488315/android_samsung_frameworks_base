...
public class TextViewTranslationCallback implements ViewTranslationCallback {
    ...
    public boolean onShowTranslation(View view) {
        ...
        if (response == null) {
            Log.e(
                    TAG,
                    "onShowTranslation() shouldn't be called before onViewTranslationResponse().");
            return false;
        }
        TextView theTextView = (TextView) view;
        if (this.mTranslationTransformation == null
                || !response.equals(this.mTranslationTransformation.getViewTranslationResponse())) {
    ...
    public boolean onHideTranslation(View view) {
        if (view.getViewTranslationResponse() == null) {
            Log.e(
                    TAG,
                    "onHideTranslation() shouldn't be called before onViewTranslationResponse().");
            return false;
        }
        if (this.mTranslationTransformation != null) {
            final TransformationMethod transformation =
                    this.mTranslationTransformation.getOriginalTransformationMethod();
            TextView theTextView = (TextView) view;
            final WeakReference<TextView> textViewRef = new WeakReference<>(theTextView);
            runChangeTextWithAnimationIfNeeded(
                    theTextView,
        ...
        this.mAnimator.addListener(
                new Animator
                        .AnimatorListener() { // from class:
                                              // android.widget.TextViewTranslationCallback.1
