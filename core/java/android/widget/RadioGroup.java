...
public class RadioGroup extends LinearLayout {
    ...
    public RadioGroup(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, C4337R.styleable.RadioGroup, 16842878, 0);
        saveAttributeDataForStyleable(context, C4337R.styleable.RadioGroup, attrs, attributes, 16842878, 0);
