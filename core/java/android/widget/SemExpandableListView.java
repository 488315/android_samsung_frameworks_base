...
public class SemExpandableListView extends ListView {
    ...
    public SemExpandableListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mItemDecorator = new SemExpandableListConnector.ItemDecorator() { // from class: android.widget.SemExpandableListView.1
            ...
            public View onItemDecorate(View convertView, View itemView, SemExpandableListConnector.PositionMetadata pos) {
                ...
                if (convertView != null && ((ViewGroup) convertView).getChildAt(0) == itemView) {
                    ...
                    if (holder != null) {
                        if (holder.indicatorImgView != null) {
                            ...
                            IndicatorImageView indicatorImgView = semExpandableListView.new IndicatorImageView(semExpandableListView.mContext);
                ...
                if (indicatorLeft2 != indicatorRight2 && (indicator = SemExpandableListView.this.getIndicator(pos)) != null) {
                    ...
                    IndicatorImageView indicatorImgView2 = semExpandableListView2.new IndicatorImageView(semExpandableListView2.mContext);
                    ...
                    if (SemExpandableListView.this.mIndicatorAnimationType == 1) {
                        ...
                        if (SemExpandableListView.DEBUGGABLE_LOW) {
                            Log.m94d(SemExpandableListView.TAG, "onItemDecorate : mGroupIndicatorWidth = " + SemExpandableListView.this.mGroupIndicatorWidth + ", mGroupIndicatorHeight = " + SemExpandableListView.this.mGroupIndicatorHeight);
                            Log.m94d(SemExpandableListView.TAG, "onItemDecorate : paddingHeight = " + paddingHeight);
                        }
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ExpandableListView, defStyleAttr, defStyleRes);
        ...
        this.mDescriptionExpand = this.mContext.getResources().getString(C4337R.string.expandablelist_indicator_description, this.mContext.getResources().getString(C4337R.string.expandablelist_expand));
        this.mDescriptionCollapse = this.mContext.getResources().getString(C4337R.string.expandablelist_indicator_description, this.mContext.getResources().getString(C4337R.string.expandablelist_collapse));
        this.mGroupIndicatorWidth = (int) this.mContext.getResources().getDimension(C4337R.dimen.expandablelist_indicator_width);
        this.mGroupIndicatorHeight = (int) this.mContext.getResources().getDimension(C4337R.dimen.expandablelist_indicator_height);
        this.mIndicatorPaddingHeight = this.mContext.getResources().getDimension(C4337R.dimen.expandablelist_indicator_padding_height);
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: android.widget.SemExpandableListView.5
            ...
            public boolean onPreDraw() {
                ...
                if (expandedGroup == null) {
                    Log.m96e(SemExpandableListView.TAG, "startExpandAnimation() groupPos=" + groupPos + ", firstPos=" + firstVisiblePos + ", expGroupFlatPos=" + expGroupFlatPos);
                    SemExpandableListView.this.resetExpandAnimationState();
                    animationEndRunnable.run();
                    return true;
                }
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: android.widget.SemExpandableListView.6
            ...
            */
            public boolean onPreDraw() {
                ...
                long lastPosPackedPos = SemExpandableListView.this.getExpandableListPosition(lastValidPos3);
                ...
                int height = SemExpandableListView.this.getHeight();
                SemExpandableListView semExpandableListView = SemExpandableListView.this;
                int listBottom2 = Math.min(height, semExpandableListView.getChildAt(semExpandableListView.getChildCount() - 1).getBottom());
                ViewInfo lastVisPrevViewInfo2 = (ViewInfo) SemExpandableListView.this.mViewSnapshots.get(lastPosPackedPos);
                if (lastVisPrevViewInfo2 != null) {
                    SemExpandableListView.this.mTranslationOffset = listBottom2 - lastVisPrevViewInfo2.bottom;
                } else {
                    long lastGroupPosPackedPos = SemExpandableListView.getPackedPositionForGroup(lastGroupId2);
                    ViewInfo lastVisGroupPrevViewInfo = (ViewInfo) SemExpandableListView.this.mViewSnapshots.get(lastGroupPosPackedPos);
                        ...
                        if (!SemExpandableListView.this.isHeaderOrFooterPosition(position)) {
                            ...
                            if (oldViewInfo == null) {
                                ...
                                if (lastValidPos2 == 0) {
                                    ...
                                    SemExpandableListView.this.mGhostViewsVisibleAreas[groupPos] = new RectF();
                                    listBottom = listBottom2;
                                    lastVisPrevViewInfo = lastVisPrevViewInfo2;
                                    long nextExpGroupPackedPosition = SemExpandableListView.getPackedPositionForGroup(groupPos + 1);
                                    int nextExpGroupFlatPos = SemExpandableListView.this.getFlatListPosition(nextExpGroupPackedPosition);
                                    if (nextExpGroupFlatPos >= childCount2) {
                                        childCount = childCount2;
                                        nextGroupTop = SemExpandableListView.this.getHeight();
                                    } else {
                                        childCount = childCount2;
                                        nextGroupTop = SemExpandableListView.this.getChildAt(nextExpGroupFlatPos).getTop();
                                    }
                                    ...
                                    if (!z) {
                                        ...
                                        RectF endRect = new RectF(oldViewInfo.left, child.getBottom(), oldViewInfo.right, nextGroupTop);
                                        SemExpandableListView.this.mExpandingRects[groupPos] = new ExpandingRect(oldViewInfo.bottom, endRect, SemExpandableListView.this.mGhostViewsVisibleAreas[groupPos]);
                                    } else {
                                        lastGroupId = lastGroupId2;
                                        child = child2;
                                        allExpanded = allExpanded3;
                                ...
                                if (child2.getWidth() != 0 && child2.getHeight() != 0) {
                                    ...
                                    ObjectAnimator animBounds = SemExpandableListView.this.createViewSnapshotAnimationReverse(-groupOffsets[groupPos], viewInfo);
                                    animations.add(animBounds);
                                }
                            }
                            position++;
                ...
                for (int i = 0; i < viewSnapshotsCount; i++) {
                    ViewInfo viewInfo2 = (ViewInfo) SemExpandableListView.this.mViewSnapshots.valueAt(i);
                    SemExpandableListView semExpandableListView3 = SemExpandableListView.this;
                    ObjectAnimator animBounds2 = semExpandableListView3.createViewSnapshotAnimation(semExpandableListView3.mTranslationOffset, viewInfo2);
                    animations.add(animBounds2);
                    SemExpandableListView.this.mGhostViews.add(viewInfo2);
                }
                Animator.AnimatorListener listener = new AnimatorListenerAdapter() { // from class: android.widget.SemExpandableListView.6.1
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationStart(Animator animation) {
    ...
    private void startCollapseAnimation(final int groupPosBefore, final Runnable animationEndRunnable) {
        ...
        if (collapsedGroupBefore == null) {
            Log.m96e(TAG, "startCollapseAnimation() BEFORE: groupPos=" + groupPosBefore + ", flatPos=" + collapsedGroupFlatPosBefore + ", firstPos=" + firstVisiblePosBefore);
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: android.widget.SemExpandableListView.7
            ...
            public boolean onPreDraw() {
                ...
                if (collapsedGroupAfter == null) {
                    Log.m96e(SemExpandableListView.TAG, "startCollapseAnimation() BEFORE: groupPos=" + groupPosBefore + ", flatPos=" + collapsedGroupFlatPosBefore + ", groupCount=" + groupCountBefore + ", firstPos=" + firstVisiblePosBefore + ", totalListChildrenCount=" + listTotalChildrenCountBefore + "; AFTER: flatPos=" + collapsedGroupFlatPosAfter + ", groupCount=" + SemExpandableListView.this.mAdapter.getGroupCount() + ", firstPos=" + firstVisiblePosAfter2 + ", totalListChildrenCount=" + SemExpandableListView.this.getChildCount());
                    SemExpandableListView.this.resetCollapseAnimationState();
                    animationEndRunnable.run();
                    return true;
                }
    ...
    public void startIndicatorAnimation(View child, boolean isExpanding, int duration) {
        ...
        if (holder == null || holder.indicatorImgView == null) {
            Log.m96e(TAG, "startIndicatorAnimation() holder or indicatorImgView is null, startAngle=" + startAngle);
            return;
        }
    ...
    private class IndicatorImageView extends ImageView {
        ...
        private void printState(int[] drawableState) {
            ...
            Log.m98i(SemExpandableListView.TAG, "drawableStateChanged() gr=" + this.groupPos + ", child=" + this.childPos + ", state=" + sb.toString());
        }
        ...
        public void printAnimationInfo(Animator animation) {
            if (animation != null) {
                ...
                if (animation.equals(this.mMorphingAnimationToDown)) {
                    Log.m94d(SemExpandableListView.TAG, "printAnimationInfo : this animation => mMorphingAnimationToDown");
                } else if (animation.equals(this.mMorphingAnimationToUp)) {
                    Log.m94d(SemExpandableListView.TAG, "printAnimationInfo : this animation => mMorphingAnimationToUp");
                }
            }
        }
        ...
        private void initArrow() {
            ...
            if (SemExpandableListView.DEBUGGABLE_LOW) {
                Log.m94d(SemExpandableListView.TAG, "IndicatorImageView : initArrow : mMorphingAnimationToDown = " + this.mMorphingAnimationToDown);
            }
            ...
            if (SemExpandableListView.DEBUGGABLE_LOW) {
                Log.m94d(SemExpandableListView.TAG, "IndicatorImageView : initArrow : mMorphingAnimationToUp = " + this.mMorphingAnimationToUp);
            }
                ...
                if (path != null) {
                    ...
                    if (!this.mMorphingAnimationToDown.isRunning() && !this.mMorphingAnimationToUp.isRunning()) {
                        if (SemExpandableListView.this.mConnector.isGroupExpanded(this.groupPos)) {
                            if (SemExpandableListView.DEBUGGABLE_LOW) {
                                Log.m94d(SemExpandableListView.TAG, "IndicatorImageView : onDraw : group(" + this.groupPos + ") collapse !!");
                            }
                            this.mMorphingAnimatedValue = 0.0f;
                        } else {
                            if (SemExpandableListView.DEBUGGABLE_LOW) {
                                Log.m94d(SemExpandableListView.TAG, "IndicatorImageView : onDraw : group(" + this.groupPos + ") expand !!");
                            }
        ...
        public void startIndicatorMorphAimation() {
            ...
            if (valueAnimator == null || !valueAnimator.isRunning()) {
                ...
                if ((valueAnimator2 == null || !valueAnimator2.isRunning()) && SemExpandableListView.this.mConnector != null) {
                    if (SemExpandableListView.this.mConnector.isGroupExpanded(this.groupPos)) {
                        if (SemExpandableListView.DEBUGGABLE_LOW) {
                            Log.m94d(SemExpandableListView.TAG, "IndicatorImageView : startIndicatorMorphAimation : group(" + this.groupPos + ") collapse !!");
                            Log.m94d(SemExpandableListView.TAG, "IndicatorImageView : startIndicatorMorphAimation : start morphingAnimation to UP");
                        }
                    ...
                    if (SemExpandableListView.DEBUGGABLE_LOW) {
                        Log.m94d(SemExpandableListView.TAG, "IndicatorImageView : startIndicatorMorphAimation : group(" + this.groupPos + ") expand !!");
                        Log.m94d(SemExpandableListView.TAG, "IndicatorImageView : startIndicatorMorphAimation : start morphingAnimation to DOWN");
                    }
    ...
    public void setIndicatorGravity(int gravity) {
        ...
        Log.m98i(TAG, "setIndicatorGravity() gravity=" + gravity + ", mIndicatorGravity=" + this.mIndicatorGravity);
    }
