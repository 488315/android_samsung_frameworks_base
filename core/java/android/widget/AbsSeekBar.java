...
public abstract class AbsSeekBar extends ProgressBar {
    ...
    public AbsSeekBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mIsTouchDisabled = false;
        this.mSetDualColorMode = false;
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.SeekBar, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.SeekBar, attrs, a, defStyleAttr, defStyleRes);
        ...
        this.mThumbExclusionMaxSize = getResources().getDimensionPixelSize(C4337R.dimen.seekbar_thumb_exclusion_max_size);
        ...
        this.mModeExpandTrackMinWidth = res.getDimensionPixelSize(C4337R.dimen.sem_seekbar_mode_expand_track_height);
        this.mModeExpandTrackMaxWidth = res.getDimensionPixelSize(C4337R.dimen.sem_seekbar_mode_expand_track_height_expand);
        this.mThumbRadius = res.getDimensionPixelSize(C4337R.dimen.sem_seekbar_thumb_radius);
        this.mModeExpandThumbRadius = res.getDimensionPixelSize(C4337R.dimen.sem_seekbar_mode_expand_thumb_radius);
        ...
        this.mDefaultSecondaryProgressColor = colorToColorStateList(res.getColor(C4337R.color.tw_seekbar_color_control_secondary, null));
    ...
    */
    ...
    public void semSetMode(int mode) {
        ...
        switch (mode) {
            ...
            case 1:
                ...
                break;
            case 3:
                Drawable thumb = this.mContext.getDrawable(C4337R.drawable.tw_scrubber_control_vertical_material_anim);
                setThumb(thumb);
                break;
            case 4:
                this.mSplitProgress = this.mContext.getDrawable(C4337R.drawable.tw_split_seekbar_primary_progress_material);
                this.mDivider = this.mContext.getDrawable(C4337R.drawable.tw_split_seekbar_vertical_bar_material);
                updateSplitProgress();
                break;
            case 5:
    ...
    public void setDefaultColorForVolumePanel(boolean isClearCoverOpened) {
        ...
        this.mOverlapNormalProgressColor = colorToColorStateList(res.getColor(C4337R.color.tw_seekbar_color_overlap_normal_light, null));
    ...
    private class ThumbDrawable extends Drawable {
        ...
        public ThumbDrawable(int radius, ColorStateList color, boolean isVertical) {
            ...
            paint.setStrokeWidth(AbsSeekBar.this.mContext.getResources().getDimension(C4337R.dimen.sem_seekbar_thumb_stroke));
            paint2.setColor(AbsSeekBar.this.mContext.getResources().getColor(C4337R.color.tw_thumb_control_fill_color_activated));
            this.mIsVertical = isVertical;
            initAnimation();
        }
