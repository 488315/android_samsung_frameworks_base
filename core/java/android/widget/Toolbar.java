...
public class Toolbar extends ViewGroup {
  ...
  public final class InspectionCompanion
      implements android.view.inspector.InspectionCompanion<Toolbar> {
    ...
    public void mapProperties(PropertyMapper propertyMapper) {
      this.mCollapseContentDescriptionId =
          propertyMapper.mapObject("collapseContentDescription", 16843984);
      ...
      this.mContentInsetEndWithActionsId =
          propertyMapper.mapInt("contentInsetEndWithActions", 16844067);
      ...
      this.mContentInsetStartWithNavigationId =
          propertyMapper.mapInt("contentInsetStartWithNavigation", 16844066);
      ...
      this.mNavigationContentDescriptionId =
          propertyMapper.mapObject("navigationContentDescription", 16843969);
    ...
    public void readProperties(Toolbar node, PropertyReader propertyReader) {
      ...
      propertyReader.readObject(
          this.mCollapseContentDescriptionId, node.getCollapseContentDescription());
      ...
      propertyReader.readInt(
          this.mContentInsetEndWithActionsId, node.getContentInsetEndWithActions());
      ...
      propertyReader.readInt(
          this.mContentInsetStartWithNavigationId, node.getContentInsetStartWithNavigation());
      ...
      propertyReader.readObject(
          this.mNavigationContentDescriptionId, node.getNavigationContentDescription());
  ...
  public Toolbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    this.mMenuViewItemClickListener =
        new ActionMenuView.OnMenuItemClickListener() { // from class: android.widget.Toolbar.1
    ...
    this.mShowOverflowMenuRunnable =
        new Runnable() { // from class: android.widget.Toolbar.2
    ...
    this.mPerformToCollapse =
        new Runnable() { // from class: android.widget.Toolbar.3
          @Override // java.lang.Runnable
          public void run() {
    ...
    this.mIsSetOpenTheme =
        z && context.getResources().getAssets().getSamsungThemeOverlays().size() > 0;
    TypedArray a =
        context.obtainStyledAttributes(attrs, C4337R.styleable.Toolbar, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.Toolbar, attrs, a, defStyleAttr, defStyleRes);
    ...
    ta.recycle();
    if (this.mNavIconResourceId != 17304524) {
    ...
    if (this.mIsSetOpenTheme) {
      ...
      if (resourceId == 17303727) {
        ...
        this.mBackgroundResourceId = C4337R.drawable.tw_action_bar_background;
      } else if (resourceId == 17303728) {
        setBackground(context.getDrawable(C4337R.drawable.tw_action_bar_background_dark));
        this.mBackgroundResourceId = C4337R.drawable.tw_action_bar_background_dark;
      }
      typedArray.recycle();
    }
  }
  ...
  protected void onConfigurationChanged(Configuration newConfig) {
    ...
    if (this.mIsThemeDeviceDefaultFamily) {
      ...
      setLayoutParams(lp);
      TypedArray ta2 =
          getContext().obtainStyledAttributes(null, C4337R.styleable.Toolbar, 16843946, 0);
      ...
      ta2.recycle();
      TypedArray ta3 =
          getContext().obtainStyledAttributes(null, C4337R.styleable.View, 16843946, 0);
      ...
      int width =
          getContext()
              .getResources()
              .getDimensionPixelSize(C4337R.dimen.sem_toolbar_navigation_button_width);
  ...
  public boolean canShowOverflowMenu() {
    ...
    return getVisibility() == 0
        && (actionMenuView = this.mMenuView) != null
        && actionMenuView.isOverflowReserved();
  }
  ...
  public boolean hasExpandedActionView() {
    ...
    return (expandedActionViewMenuPresenter == null
            || expandedActionViewMenuPresenter.mCurrentExpandedItem == null)
        ? false
        : true;
  }
  ...
  public void collapseActionView() {
    ...
    MenuItemImpl item =
        expandedActionViewMenuPresenter == null
            ? null
            : expandedActionViewMenuPresenter.mCurrentExpandedItem;
    if (item != null) {
    ...
    if (getLayoutDirection() == 0) {
      ...
      if (rotate == 3 && checkNaviBarForLandscape()) {
        ...
        xOffset =
            height2 < navigationBarHeight
                ? (xOffset - ((int) ((navigationBarHeight / density) * realDensity))) - (width / 2)
      ...
      if (rotate == 1 && checkNaviBarForLandscape()) {
        xOffset =
            xOffset2
                - ((int)
                    ((navigationBarHeight / res.getDisplayMetrics().density)
                        * realDisplayMetrics.density));
      } else {
        xOffset = xOffset2;
      }
    }
  ...
  public void setNavigationIcon(int resId) {
    ...
    if (i > 0 && i == 17304524 && resId == 17304524) {
      this.mIsCustomNavIcon = false;
    } else {
      this.mIsCustomNavIcon = true;
    }
  ...
  public void ensureCollapseButtonView() {
    CharSequence descriptionText =
        getContext().getResources().getString(C4337R.string.action_bar_up_description);
    if (this.mCollapseButtonView == null) {
      ...
      this.mCollapseButtonView.setOnClickListener(
          new View.OnClickListener() { // from class: android.widget.Toolbar.4
  ...
  public void onRestoreInstanceState(Parcelable state) {
    ...
    if (ss.expandedMenuItemId != 0
        && this.mExpandedMenuPresenter != null
        && menu != null
        && (item = menu.findItem(ss.expandedMenuItemId)) != null) {
  ...
  private void measureChildConstrained(
      View child,
      int parentWidthSpec,
      int widthUsed,
  ...
  private int measureChildCollapseMargins(
      View child,
    ...
    int childWidthMeasureSpec =
        getChildMeasureSpec(
            ...
            this.mPaddingLeft + this.mPaddingRight + hMargins + widthUsed,
            lp.width);
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (shouldLayout(this.mNavButtonView)) {
      measureChildConstrained(
          this.mNavButtonView, widthMeasureSpec, 0, heightMeasureSpec, 0, this.mMaxButtonHeight);
      navWidth = this.mNavButtonView.getMeasuredWidth() + getHorizontalMargins(this.mNavButtonView);
      height =
          Math.max(
              0, this.mNavButtonView.getMeasuredHeight() + getVerticalMargins(this.mNavButtonView));
      childState2 = combineMeasuredStates(0, this.mNavButtonView.getMeasuredState());
    }
    if (shouldLayout(this.mCollapseButtonView)) {
      measureChildConstrained(
          this.mCollapseButtonView,
          widthMeasureSpec,
          0,
          heightMeasureSpec,
          0,
          this.mMaxButtonHeight);
      navWidth =
          this.mCollapseButtonView.getMeasuredWidth()
              + getHorizontalMargins(this.mCollapseButtonView);
      height =
          Math.max(
              height,
              this.mCollapseButtonView.getMeasuredHeight()
                  + getVerticalMargins(this.mCollapseButtonView));
    ...
    if (shouldLayout(this.mMenuView)) {
      marginStartIndex2 = 0;
      measureChildConstrained(
          this.mMenuView, widthMeasureSpec, width, heightMeasureSpec, 0, this.mMaxButtonHeight);
      int menuWidth2 = this.mMenuView.getMeasuredWidth() + getHorizontalMargins(this.mMenuView);
      height =
          Math.max(height, this.mMenuView.getMeasuredHeight() + getVerticalMargins(this.mMenuView));
    ...
    if (shouldLayout(this.mExpandedActionView)) {
      ...
      height =
          Math.max(
              height,
              this.mExpandedActionView.getMeasuredHeight()
                  + getVerticalMargins(this.mExpandedActionView));
      childState2 = combineMeasuredStates(childState2, this.mExpandedActionView.getMeasuredState());
    }
    if (shouldLayout(this.mLogoView)) {
      width2 +=
          measureChildCollapseMargins(
              this.mLogoView, widthMeasureSpec, width2, heightMeasureSpec, 0, collapsingMargins);
      height =
          Math.max(height, this.mLogoView.getMeasuredHeight() + getVerticalMargins(this.mLogoView));
    ...
    while (width4 < childCount2) {
      ...
      if (lp.mViewType != 0) {
        ...
        width3 +=
            measureChildCollapseMargins(
                child, widthMeasureSpec, width3, heightMeasureSpec, 0, collapsingMargins);
    ...
    if (!shouldLayout(this.mTitleTextView)) {
      ...
      if (this.mIsThemeDeviceDefaultFamily) {
        TypedArray appearance =
            getContext()
                .obtainStyledAttributes(this.mTitleTextAppearance, C4337R.styleable.TextAppearance);
      ...
      measureChildCollapseMargins(
          this.mTitleTextView,
          widthMeasureSpec,
          width3 + titleHorizMargins,
          heightMeasureSpec,
          titleVertMargins,
          collapsingMargins);
      titleWidth =
          this.mTitleTextView.getMeasuredWidth() + getHorizontalMargins(this.mTitleTextView);
      titleHeight2 =
          this.mTitleTextView.getMeasuredHeight() + getVerticalMargins(this.mTitleTextView);
      ...
      titleWidth =
          Math.max(
              ...
              measureChildCollapseMargins(
                  ...
                  width3 + titleHorizMargins,
                  heightMeasureSpec,
                  titleHeight2 + titleVertMargins,
                  collapsingMargins));
      int titleHeight3 =
          titleHeight2
              + this.mSubtitleTextView.getMeasuredHeight()
              + getVerticalMargins(this.mSubtitleTextView);
    ...
    int measuredWidth =
        resolveSizeAndState(
            Math.max(width5, getSuggestedMinimumWidth()),
            widthMeasureSpec,
            (-16777216) & childState4);
    int measuredHeight =
        resolveSizeAndState(
            Math.max(height4, getSuggestedMinimumHeight()), heightMeasureSpec, childState4 << 16);
  ...
  */
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    if (shouldLayout(this.mCollapseButtonView)) {
      if (isRtl) {
        right =
            layoutChildRight(this.mCollapseButtonView, right, collapsingMargins, alignmentHeight2);
      } else {
        left2 =
            layoutChildLeft(this.mCollapseButtonView, left2, collapsingMargins, alignmentHeight2);
      }
    }
    if (shouldLayout(this.mMenuView)) {
      if (isRtl) {
    ...
    if (shouldLayout(this.mExpandedActionView)) {
      if (isRtl) {
        right2 =
            layoutChildRight(this.mExpandedActionView, right2, collapsingMargins, alignmentHeight2);
      } else {
        left3 =
            layoutChildLeft(this.mExpandedActionView, left3, collapsingMargins, alignmentHeight2);
      }
    }
    if (shouldLayout(this.mLogoView)) {
      if (isRtl) {
      ...
      if (!layoutSubtitle || this.mSubtitleTextView.getMeasuredWidth() <= 0) {
        ...
        switch (this.mGravity & 112) {
          ...
          case 80:
            paddingLeft = paddingLeft2;
            spaceBelow =
                (((height - paddingBottom) - bottomlp.bottomMargin) - this.mTitleMarginBottom)
                    - titleHeight;
            alignmentHeight = alignmentHeight2;
            break;
          default:
              ...
              if (spaceBelow2 < toplp.bottomMargin + this.mTitleMarginBottom) {
                spaceAbove =
                    Math.max(
                        0,
                        spaceAbove
                            - ((bottomlp.bottomMargin + this.mTitleMarginBottom) - spaceBelow2));
              }
            }
        ...
        if (isRtl) {
          ...
          if (layoutSubtitle) {
            ...
            this.mSubtitleTextView.layout(
                subtitleLeft2, titleTop3, subtitleRight2, subtitleBottom2);
    ...
    for (int i2 = 0; i2 < rightViewsCount; i2++) {
      right2 =
          layoutChildRight(this.mTempViews.get(i2), right2, collapsingMargins, alignmentHeight3);
    }
    ...
    while (leftViewsCount2 < centerViewsCount) {
      centerLeft =
          layoutChildLeft(
              this.mTempViews.get(leftViewsCount2),
              centerLeft,
              collapsingMargins,
              alignmentHeight3);
      leftViewsCount2++;
  ...
  private int layoutChildRight(
      View child, int right, int[] collapsingMargins, int alignmentHeight) {
    LayoutParams lp = (LayoutParams) child.getLayoutParams();
  ...
  private void addCustomViewsWithGravity(List<View> views, int gravity) {
    ...
    for (int i2 = 0; i2 < childCount; i2++) {
      ...
      if (lp2.mViewType == 0
          && shouldLayout(child2)
          && getChildHorizontalGravity(lp2.gravity) == absGrav) {
        views.add(child2);
      }
    }
  }
  ...
  static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<SavedState>() { // from class: android.widget.Toolbar.SavedState.1
