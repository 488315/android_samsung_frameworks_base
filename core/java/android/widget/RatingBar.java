...
public class RatingBar extends AbsSeekBar {
    ...
    public RatingBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mNumStars = 5;
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.RatingBar, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.RatingBar, attrs, a, defStyleAttr, defStyleRes);
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        info.setStateDescription(PluralsMessageFormatter.format(getContext().getResources(), params, C4337R.string.rating_label));
    }
