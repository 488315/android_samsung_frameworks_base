  ...
  public CheckedTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.CheckedTextView, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.CheckedTextView, attrs, a, defStyleAttr, defStyleRes);
    ...
    this.mDrawablePadding =
        getContext().getResources().getDimensionPixelSize(C4337R.dimen.tw_checkedtextview_padding);
    if (d != null) {
