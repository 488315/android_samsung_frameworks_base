...
public class ImageView extends View {
    ...
    public ImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mBaselineAlignBottom = false;
        initImageView();
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ImageView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.ImageView, attrs, a, defStyleAttr, defStyleRes);
