...
public class ImageView extends View {
  ...
  public ImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.ImageView, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.ImageView, attrs, a, defStyleAttr, defStyleRes);
  ...
  public Runnable setImageURIAsync(Uri uri) {
    Uri uri2;
    if (this.mResource == 0
        && ((uri2 = this.mUri) == uri || (uri != null && uri2 != null && uri.equals(uri2)))) {
      return null;
    }
  ...
  private void resolveUri() {
    ...
    if (this.mResource != 0) {
      ...
      if (uri != null) {
        ...
        if (d == null) {
          Log.m102w(LOG_TAG, "resolveUri failed on bad bitmap uri: " + this.mUri);
          this.mUri = null;
        }
      } else {
        return;
  ...
  private Drawable getDrawableFromUri(Uri uri) {
    ...
    if (ContentResolver.SCHEME_ANDROID_RESOURCE.equals(scheme)) {
      try {
        ...
        return r.f46r.getDrawable(r.f45id, this.mContext.getTheme());
      } catch (Exception e) {
    ...
    if (resizeWidth || resizeHeight) {
      ...
      if (desiredAspect != 0.0f) {
        ...
        if (Math.abs(actualAspect - desiredAspect) > 1.0E-7d) {
          ...
          if (resizeWidth) {
            int newWidth =
                ((int) (((heightSize - ptop) - pbottom) * desiredAspect)) + pleft + pright;
          ...
          if (!done2 && resizeHeight) {
            int newHeight =
                ((int) (((widthSize - pleft) - pright) / desiredAspect)) + ptop + pbottom;
  ...
  public boolean isDefaultFocusHighlightNeeded(Drawable background, Drawable foreground) {
    ...
    boolean lackFocusState =
        (drawable != null && drawable.isStateful() && this.mDrawable.hasFocusStateSpecified())
            ? false
            : true;
