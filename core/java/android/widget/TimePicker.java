...
public class TimePicker extends FrameLayout {
    ...
    public void mapProperties(PropertyMapper propertyMapper) {
      ...
      this.mTimePickerModeId =
          propertyMapper.mapIntEnum(
              "timePickerMode",
              16843956,
              new View$InspectionCompanion$$ExternalSyntheticLambda0(timePickerModeEnumMapping));
  ...
  public TimePicker(final Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    if (requestedMode == 2 && isDialogMode) {
      this.mMode = context.getResources().getInteger(C4337R.integer.time_picker_mode);
    } else {
    ...
    switch (this.mMode) {
      case 2:
        this.mDelegate =
            new TimePickerClockDelegate(this, context, attrs, defStyleAttr, defStyleRes);
        break;
      default:
        this.mDelegate =
            new TimePickerSpinnerDelegate(this, context, attrs, defStyleAttr, defStyleRes);
        break;
    }
  ...
  abstract static class AbstractTimePickerDelegate implements TimePickerDelegate {
    ...
    public final void autofill(AutofillValue value) {
      if (value == null || !value.isDate()) {
        Log.m102w(TimePicker.LOG_TAG, value + " could not be autofilled into " + this);
        return;
      }
