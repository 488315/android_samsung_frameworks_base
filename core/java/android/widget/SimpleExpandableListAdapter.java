...
public class SimpleExpandableListAdapter extends BaseExpandableListAdapter {
  ...
  public View getChildView(
    ...
    bindView(
        v, this.mChildData.get(groupPosition).get(childPosition), this.mChildFrom, this.mChildTo);
    return v;
  }

  public View newChildView(boolean isLastChild, ViewGroup parent) {
    return this.mInflater.inflate(
        isLastChild ? this.mLastChildLayout : this.mChildLayout, parent, false);
  }
  ...
  public View newGroupView(boolean isExpanded, ViewGroup parent) {
    return this.mInflater.inflate(
        isExpanded ? this.mExpandedGroupLayout : this.mCollapsedGroupLayout, parent, false);
  }
