...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName component) {
        ...
        try {
            ...
            if (drawable == null) {
                Log.m102w(LOG_TAG, "Invalid icon resource " + iconId + " for " + component.flattenToShortString());
                return null;
            }
            return drawable;
    ...
    private static String getStringOrNull(Cursor cursor, int col) {
        ...
        try {
            ...
            Log.m97e(LOG_TAG, "unexpected error retrieving valid column from cursor, did the remote process die?", e);
            return null;
        }
    }
}
