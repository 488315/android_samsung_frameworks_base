...
public class RadialTimePickerView extends View {
    ...
    public RadialTimePickerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mTextSize = new int[]{res.getDimensionPixelSize(C4337R.dimen.timepicker_text_size_normal), res.getDimensionPixelSize(C4337R.dimen.timepicker_text_size_normal), res.getDimensionPixelSize(C4337R.dimen.timepicker_text_size_inner)};
        this.mTextInset = new int[]{res.getDimensionPixelSize(C4337R.dimen.timepicker_text_inset_normal), res.getDimensionPixelSize(C4337R.dimen.timepicker_text_inset_normal), res.getDimensionPixelSize(C4337R.dimen.timepicker_text_inset_inner)};
        ...
        this.mSelectorDotRadius = res.getDimensionPixelSize(C4337R.dimen.timepicker_selector_dot_radius);
    ...
    void applyAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, C4337R.styleable.TimePicker, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.TimePicker, attrs, a, defStyleAttr, defStyleRes);
        ...
        this.mPaintBackground.setColor(a.getColor(4, context.getColor(C4337R.color.timepicker_default_numbers_background_color_material)));
        a.recycle();
    }
