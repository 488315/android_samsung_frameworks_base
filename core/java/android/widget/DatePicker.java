...
public class DatePicker extends FrameLayout {
    ...
    public void mapProperties(PropertyMapper propertyMapper) {
      ...
      this.mDatePickerModeId =
          propertyMapper.mapIntEnum(
              "datePickerMode",
              16843955,
              new View$InspectionCompanion$$ExternalSyntheticLambda0(datePickerModeEnumMapping));
  ...
  public DatePicker(final Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    saveAttributeDataForStyleable(
        context, C4337R.styleable.DatePicker, attrs, a, defStyleAttr, defStyleRes);
    ...
    if (requestedMode == 2 && isDialogMode) {
      this.mMode = context.getResources().getInteger(C4337R.integer.date_picker_mode);
    } else {
  ...
  abstract static class AbstractDatePickerDelegate implements DatePickerDelegate {
    ...
    public final void autofill(AutofillValue value) {
      if (value == null || !value.isDate()) {
        Log.m102w(DatePicker.LOG_TAG, value + " could not be autofilled into " + this);
        return;
      }
    ...
    static class SavedState extends View.BaseSavedState {
      ...
      public SavedState(
          Parcelable superState, int year, int month, int day, long minDate, long maxDate) {
