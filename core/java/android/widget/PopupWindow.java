...
public class PopupWindow {
    ...
    private static final int[] ONEUI_BLUR_POPUP_BACKGROUND_RES = {C4337R.drawable.sem_popup_background_material_dark, C4337R.drawable.sem_popup_background_material, C4337R.drawable.sem_list_popup_background_material_dark, C4337R.drawable.sem_list_popup_background_material, C4337R.drawable.sem_search_popup_background_material_dark, C4337R.drawable.sem_search_popup_background_material, C4337R.drawable.sem_spinner_popup_background_material_dark, C4337R.drawable.sem_spinner_popup_background_material};
    ...
    public PopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.PopupWindow, defStyleAttr, defStyleRes);
        ...
        this.mStatusBarHeight = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.status_bar_height);
        this.mNavigationBarHeight = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.navigation_bar_height);
    }
    ...
    private void update(View anchor, boolean updateLocation, int xoff, int yoff, int width, int height) {
        ...
        updateAboveAnchor(aboveAnchor);
        boolean paramsChanged = (oldGravity == p.gravity && oldX == p.f573x && oldY == p.f574y && oldWidth == p.width && oldHeight == p.height) ? false : true;
    ...
    int semGetCenterPointForFoldable() {
        ...
        try {
            ...
            if (ViewRune.supportFoldableDualDisplay()) {
                ...
                int centerPoint = (displaySize.f86y > displaySize.f85x ? displaySize.f85x : displaySize.f86y) / 2;
                return centerPoint;
            }
            if (!ViewRune.supportFoldableNoSubDisplay() || this.mContext.getResources().getConfiguration().orientation != 1) {
                return 0;
            }
            int centerPoint2 = (displaySize.f86y > displaySize.f85x ? displaySize.f86y : displaySize.f85x) / 2;
            return centerPoint2;
        } catch (Exception e) {
            return 0;
        }
