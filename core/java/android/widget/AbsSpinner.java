...
public abstract class AbsSpinner extends AdapterView<SpinnerAdapter> {
    ...
    public AbsSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        initAbsSpinner();
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.AbsSpinner, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.AbsSpinner, attrs, a, defStyleAttr, defStyleRes);
