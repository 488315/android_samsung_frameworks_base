...
public abstract class AbsSpinner extends AdapterView<SpinnerAdapter> {
  ...
  public AbsSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.AbsSpinner, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.AbsSpinner, attrs, a, defStyleAttr, defStyleRes);
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (selectedPosition >= 0
        && (spinnerAdapter = this.mAdapter) != null
        && selectedPosition < spinnerAdapter.getCount()) {
      ...
      if (view != null) {
        ...
        preferredHeight =
            getChildHeight(view) + this.mSpinnerPadding.top + this.mSpinnerPadding.bottom;
        preferredWidth =
            getChildWidth(view) + this.mSpinnerPadding.left + this.mSpinnerPadding.right;
  ...
  */
  ...
  static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<SavedState>() { // from class: android.widget.AbsSpinner.SavedState.1
