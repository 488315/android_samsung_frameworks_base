...
public class TwoLineListItem extends RelativeLayout {
    ...
    public TwoLineListItem(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.TwoLineListItem, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.TwoLineListItem, attrs, a, defStyleAttr, defStyleRes);
        a.recycle();
    }
