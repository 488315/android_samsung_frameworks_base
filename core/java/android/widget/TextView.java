...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    */
    public TextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        style.recycle();
        TypedArray a = theme2.obtainStyledAttributes(attrs, C4337R.styleable.TextViewAppearance, defStyleAttr, defStyleRes);
        ...
        if (ap == -1) {
            ...
            theme = theme2;
            saveAttributeDataForStyleable(context, C4337R.styleable.TextAppearance, null, appearance2, 0, ap);
        ...
        TypedArray a2 = theme.obtainStyledAttributes(attrs, C4337R.styleable.TextView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.TextView, attrs, a2, defStyleAttr, defStyleRes);
        ...
        if (inputMethod != null) {
            ...
            if (inputType4 != 0) {
                ...
                createEditorIfNeeded();
                this.mEditor.mKeyListener = DigitsKeyListener.getInstance(null, (lineHeightUnit2 & 2) != 0, (lineHeightUnit2 & 4) != 0);
            ...
            this.mCursorThicknessScale = getContext().getResources().getConfiguration().semCursorThicknessScale;
            if (isPassword) {
            ...
            TypedArray a3 = context2.obtainStyledAttributes(attrs, C4337R.styleable.View, defStyleAttr, defStyleRes);
        ...
        TypedArray a32 = context2.obtainStyledAttributes(attrs, C4337R.styleable.View, defStyleAttr, defStyleRes);
    ...
    @ViewDebug.ExportedProperty(category = "text", mapping = {@ViewDebug.IntToString(from = 0, m158to = SQLiteDatabase.SYNC_MODE_NORMAL), @ViewDebug.IntToString(from = 1, m158to = "BOLD"), @ViewDebug.IntToString(from = 2, m158to = "ITALIC"), @ViewDebug.IntToString(from = 3, m158to = "BOLD_ITALIC")})
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (ss.selStart >= 0 && ss.selEnd >= 0 && this.mSpannable != null) {
            ...
            if (ss.selStart > len || ss.selEnd > len) {
                ...
                Log.m96e(LOG_TAG, "Saved cursor position " + ss.selStart + "/" + ss.selEnd + " out of range for " + restored + "text " + ((Object) this.mText));
            } else {
    ...
    */
    private void setText(CharSequence text, BufferType type, boolean notifyBefore, int oldlen) {
        ...
        if (notifyBefore) {
            ...
            if (charSequence != null) {
                ...
                if (type2 != BufferType.EDITABLE || getKeyListener() != null || needEditableForNotification) {
                    ...
                    int checkResult = precomputed.getParams().checkResultUsable(getPaint(), this.mTextDir, this.mBreakStrategy, this.mHyphenationFrequency, LineBreakConfig.getLineBreakConfig(this.mLineBreakStyle, this.mLineBreakWordStyle));
                    switch (checkResult) {
                        case 0:
                ...
                if (!TextUtils.isEmpty(text2) && !(text2 instanceof SpannedString) && !(text2 instanceof Spannable) && TextUtils.semNeedMoreWidth(text2.charAt(text2.length() - 1))) {
                ...
                if ((text2 instanceof Spannable) && (!this.mAllowTransformationLengthChange || isOffsetMapping)) {
        ...
        if (text2 instanceof Spannable) {
            ...
            ChangeWatcher[] watchers2 = (ChangeWatcher[]) sp3.getSpans(0, sp3.length(), ChangeWatcher.class);
            while (i < r14) {
            }
            if (this.mChangeWatcher == null) {
            }
    ...
    public int performHandwritingRemoveSpaceGesture(RemoveSpaceGesture gesture) {
        ...
        if (!isOffsetMappingAvailable()) {
            ...
            RectF area = new RectF(Math.min(startPoint.f87x, endPoint.f87x), lineVerticalCenter + 0.1f, Math.max(startPoint.f87x, endPoint.f87x), lineVerticalCenter - 0.1f);
    ...
    private int getLineForHandwritingGesture(PointF point) {
        ...
        if (line < this.mLayout.getLineCount() - 1 && point.f88y > this.mLayout.getLineBottom(line) - lineMargin && point.f88y > (this.mLayout.getLineBottom(line, false) + this.mLayout.getLineBottom(line)) / 2.0f) {
            line++;
        } else if (point.f88y < this.mLayout.getLineTop(line) - lineMargin || point.f88y > this.mLayout.getLineBottom(line, false) + lineMargin) {
            return -1;
        }
    ...
    */
    public void makeNewLayout(int wantWidth, int hintWidth, BoringLayout.Metrics boring, BoringLayout.Metrics hintBoring, int ellipsisWidth, boolean bringIntoView) {
        ...
        boolean testDirChange = this.mSingleLine && this.mLayout != null && (alignment5 == Layout.Alignment.ALIGN_NORMAL || alignment5 == Layout.Alignment.ALIGN_OPPOSITE);
        int oldDir3 = 0;
        if (testDirChange) {
        ...
        this.mLayout = makeSingleLayout(wantWidth2, boring, ellipsisWidth, alignment5, shouldEllipsize, effectiveEllipsize, effectiveEllipsize == this.mEllipsize);
        if (switchEllipsize) {
            ...
            this.mSavedMarqueeModeLayout = makeSingleLayout(wantWidth2, boring, ellipsisWidth, alignment5, shouldEllipsize, oppositeEllipsize, effectiveEllipsize != this.mEllipsize);
        } else {
            oldDir = oldDir4;
            i = 0;
            alignment = alignment5;
        ...
        if (charSequence != null) {
            ...
            if (hintBoring != UNKNOWN_BORING) {
                ...
                BoringLayout.Metrics hintBoring3 = BoringLayout.isBoring(charSequence, this.mTextPaint, hintTextDir, isFallbackLineSpacingForBoringLayout(), this.mHintBoring);
                if (hintBoring3 != null) {
            ...
            if (hintBoring2 == null) {
                ...
                if (hintBoring2.width > hintWidth3) {
                    ...
                    if (boringLayout != null) {
                        ...
                        oldDir2 = oldDir;
                        hintTextDir2 = hintTextDir;
                        this.mHintLayout = BoringLayout.make(this.mHint, this.mTextPaint, hintWidth3, alignment4, this.mSpacingMult, this.mSpacingAdd, hintBoring2, this.mIncludePad);
                    }
                ...
                if (i4 == 0 || hintBoring2.width > hintWidth3) {
                    ...
                    if (boringLayout2 != null) {
                        alignment2 = alignment3;
                        this.mHintLayout = boringLayout2.replaceOrMake(this.mHint, this.mTextPaint, hintWidth3, alignment3, this.mSpacingMult, this.mSpacingAdd, hintBoring2, this.mIncludePad, this.mEllipsize, ellipsisWidth);
                    } else {
                        alignment2 = alignment3;
            ...
            if (this.mHintLayout == null) {
                ...
                z = true;
                StaticLayout.Builder builder = StaticLayout.Builder.obtain(charSequence2, i2, charSequence2.length(), this.mTextPaint, hintWidth3).setAlignment(alignment2).setTextDirection(hintTextDir2).setLineSpacing(this.mSpacingAdd, this.mSpacingMult).setIncludePad(this.mIncludePad).setUseLineSpacingFromFallbacks(isFallbackLineSpacingForStaticLayout()).setBreakStrategy(this.mBreakStrategy).setHyphenationFrequency(this.mHyphenationFrequency).setJustificationMode(this.mJustificationMode).setMaxLines(this.mMaxMode == 1 ? this.mMaximum : Integer.MAX_VALUE).setLineBreakConfig(LineBreakConfig.getLineBreakConfig(this.mLineBreakStyle, this.mLineBreakWordStyle));
                if (i4 != 0) {
                    i3 = ellipsisWidth;
    ...
    public boolean bringPointIntoView(int offset, boolean requestRectWithoutFocus) {
        ...
        if (!isLayoutRequested()) {
            ...
            switch (C41618.$SwitchMap$android$text$Layout$Alignment[layout.getParagraphAlignment(line).ordinal()]) {
                case 1:
                    grav = 1;
                    break;
                case 2:
    ...
    */
    protected void onProvideStructure(ViewStructure structure, int viewFor, int flags) {
        ...
        if (viewFor == 1 || viewFor == 2) {
            ...
            if (this.mTextId != 0) {
                try {
                    ...
                    if (Helper.sVerbose) {
                        Log.m100v(LOG_TAG, "onProvideAutofillStructure(): cannot set name for text id " + this.mTextId + ": " + e.getMessage());
                    }
                }
            }
        ...
        if (!isPassword || viewFor == 1 || viewFor == 2) {
            ...
            if (lineCount <= 1) {
                ...
                if (text2 != null) {
                    ...
                    text2 = text2.subSequence(Math.min(expandedTopChar, text2.length()), Math.min(expandedBottomChar, text2.length()));
                    if (viewFor == 1) {
        ...
        if (maxLength2 != 0) {
            try {
                ...
                if (Helper.sVerbose) {
                    Log.m100v(LOG_TAG, "onProvideAutofillStructure(): cannot set name for hint id " + this.mHintId + ": " + e2.getMessage());
                }
            }
        }
    ...
    public void autofill(AutofillValue value) {
        if (!isTextEditable()) {
            ...
            if (!value.isText()) {
                Log.m102w(LOG_TAG, "value of type " + value.describeContents() + " cannot be autofilled into " + this);
                return;
            }
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        if (editor != null) {
            ...
            if (isTextEditable() && isFocused()) {
                CharSequence imeActionLabel = this.mContext.getResources().getString(C4337R.string.keyboardview_keycode_enter);
        ...
        if (isFocused()) {
            ...
            if (canShare()) {
                info.addAction(new AccessibilityNodeInfo.AccessibilityAction(268435456, getResources().getString(C4337R.string.share)));
            }
            if (canProcessText()) {
    ...
    public void onCreateViewTranslationRequest(int[] supportedFormats, Consumer<ViewTranslationRequest> requestsCollector) {
        ...
        if (ArrayUtils.contains(supportedFormats, 1)) {
            ...
            if (isTextEditable() || isPassword) {
                Log.m102w(LOG_TAG, "Cannot create translation request. editable = " + isTextEditable() + ", isPassword = " + isPassword);
                return;
            } else {
    ...
    */
        ...
        try {
            if ((start2 > 0 && start2 < len) || (stop4 > 0 && stop4 < len)) {
                ...
                if (start2 > 0 && start2 < len) {
                    ...
                    if (TextUtils.isCombinedCode(startChar) || text.charAt(start2 - 1) == Emoji.ZERO_WIDTH_JOINER) {
                        needCheckPosition2 = true;
                    }
                }
                if (stop4 > 0 && stop4 < len) {
                    char stopChar = text.charAt(stop4);
                    if (!needCheckPosition2 && (TextUtils.isCombinedCode(stopChar) || text.charAt(stop4 - 1) == Emoji.ZERO_WIDTH_JOINER)) {
    ...
    boolean canClipboard() {
        ...
        if ((this.mActionModeFlags & 4096) != 4096 || isKeyguardLocked()) {
            Log.m94d(LOG_TAG, "cannot show clipboard, caused by mEnableClipboard = " + ((this.mActionModeFlags & 4096) == 4096) + ", isKeyguardLocked() : " + isKeyguardLocked());
            return false;
        }
        InputMethodManager imm = (InputMethodManager) this.mContext.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
        ...
        if (isAccessoryKeyboard && showImeWithHardKeyboard != 1) {
            Log.m94d(LOG_TAG, "isAccessoryKeyboard is true, showImeWithHardKeyboard : " + showImeWithHardKeyboard);
            return false;
        }
        ...
        if (!SemInputMethodManagerUtils.METHOD_ID_HONEYBOARD.equals(defaultIME)) {
            Log.m94d(LOG_TAG, "defaultIME is not com.samsung.android.honeyboard/.service.HoneyBoardService");
            return false;
        }
    ...
    private CharSequence getTextForRectSelection(Rect selectedRect) {
        ...
        if (!TextUtils.isEmpty(text) && this.mLayout != null) {
            ...
            int textBtm = ((this.mLayout.getLineBottom(lineCount - 1) + startPos2.f86y) + topPadding) - getScrollY();
    ...
    private CharSequence getTextForSingleWord(Rect selectedRect, Rect wordRect) {
        ...
        if (offset >= 0 && offset <= len) {
            ...
            if (selectionStart != selectionEnd && selectionStart >= 0 && selectionEnd >= 0) {
                if (selectionStart > selectionEnd) {
                    Log.m96e(LOG_TAG, "AirDic : start > end !! start = " + selectionStart + ", end = " + selectionEnd);
                    Log.m96e(LOG_TAG, "AirDic : text = " + ((Object) text));
                    Log.m96e(LOG_TAG, "AirDic : line = " + line + ", sLine = " + sLine + ", eLine = " + eLine);
                    return null;
                }
            ...
            if (action == 10) {
                if (this.mHoveredSpan != null) {
                    try {
                        ...
                        Log.m94d(LOG_TAG, "** skip SemInfoExtractionManager Service by IllegalStateException, onHoverExit **");
                    }
                }
                this.mHoveredSpan = null;
                this.mHoverEnterTime = -1L;
                                ...
                                if (this.mHoverEnterTime > 0) {
                                    ...
                                    if (elipse > 300) {
                                        ...
                                        try {
                                            ...
                                            Log.m94d(LOG_TAG, "** skip SemInfoExtractionManager Service by IllegalStateException, onHover : URLSpan1 **");
                                        }
                        ...
                        if (this.mHoverExitTime > 0) {
                            ...
                            if (elipse2 > 300) {
                                try {
                                    ...
                                    Log.m94d(LOG_TAG, "** skip SemInfoExtractionManager Service by IllegalStateException, onHover : hover exit **");
                                }
                                this.mHoveredSpan = null;
                                this.mHoverEnterTime = -1L;
                                this.mHoverExitTime = -1L;
                    ...
                    public void run() {
                        ...
                        if (isPenSelected) {
                            ...
                            try {
                                ...
                                Log.m96e(TextView.LOG_TAG, "** skip SemInfoExtractionManager Service by IllegalStateException **");
                            }
    ...
    private void initButtonShape() {
        ...
        this.mButtonShapeTextColorLight = resources.getColor(C4337R.color.sem_button_shape_text_color_light, null);
        this.mButtonShapeTextColorDark = resources.getColor(C4337R.color.sem_button_shape_text_color_dark, null);
        this.mButtonShapeOutlineStrokeEnabled = resources.getInteger(C4337R.integer.sem_button_shape_outline_stroke_enabled);
        this.mButtonShapeOutlineStrokeDisabled = resources.getInteger(C4337R.integer.sem_button_shape_outline_stroke_disabled);
        this.mButtonShapeAlpha = this.mButtonShapeOutlineStrokeEnabled;
        this.mButtonShapeOutlineStrokeTop = resources.getDimensionPixelSize(C4337R.dimen.sem_button_shape_outline_stroke_top);
        this.mButtonShapeOutlineStrokeBottom = resources.getDimensionPixelSize(C4337R.dimen.sem_button_shape_outline_stroke_bottom);
        this.mButtonShapeOutlineStrokeHorizontal = resources.getDimensionPixelSize(C4337R.dimen.sem_button_shape_outline_stroke_horizontal);
        this.mButtonShapeOutlineRadius = resources.getDimensionPixelSize(C4337R.dimen.sem_button_shape_outline_radius);
    }
    ...
    private int getPosition(Point location) {
        ...
        if (increment.f86y + statusBarHeight <= location.f86y && location.f86y < (increment.f86y << 1) + statusBarHeight) {
            return pos | 4;
        }
        return pos | 2;
    }
