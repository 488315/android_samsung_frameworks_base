...
class RemoteCollectionItemsAdapter extends BaseAdapter {
                ...
                new IntUnaryOperator() { // from class:
                  ...
                  public final int applyAsInt(int i) {
                    ...
                    lambda$initLayoutIdToViewType$0 =
                        RemoteCollectionItemsAdapter.this.lambda$initLayoutIdToViewType$0(i);
                ...
                .filter(
                    new IntPredicate() { // from class:
                      ...
                      public final boolean test(int i4) {
                        return RemoteCollectionItemsAdapter.lambda$initLayoutIdToViewType$1(
                            assignedViewTypes, i4);
                      }
                    })
                .findFirst()
                .orElseThrow(
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (reapplyView != null) {
      try {
        item.reapply(
            parent.getContext(), reapplyView, this.mInteractionHandler, null, this.mColorResources);
        return reapplyView;
      } catch (RuntimeException e) {
      }
    }
    return item.apply(
        parent.getContext(), parent, this.mInteractionHandler, (SizeF) null, this.mColorResources);
  }
  ...
  private static View getViewToReapply(View convertView, RemoteViews item) {
    ...
    if ((layoutIdTag instanceof Integer)
        && item.getLayoutId() == ((Integer) layoutIdTag).intValue()) {
      return convertView;
    }
    return null;
  }
