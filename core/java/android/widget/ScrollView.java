...
public class ScrollView extends FrameLayout {
    ...
    public ScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        initScrollView();
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ScrollView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.ScrollView, attrs, a, defStyleAttr, defStyleRes);
    ...
    private void initGoToTop() {
        ...
        boolean resolved = this.mContext.getTheme().resolveAttribute(C4337R.attr.semGoToTopStyle, value, true);
        if (resolved) {
    ...
    public void semSetGoToTopEnabled(boolean enabled, int buttonStyle) {
        Drawable drawable = buttonStyle == 0 ? this.mSemGoToTopLightImage : this.mContext.getResources().getDrawable(C4337R.drawable.sem_list_go_to_top_dark);
