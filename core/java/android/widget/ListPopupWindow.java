...
public class ListPopupWindow implements ShowableListMenu {
    ...
    public ListPopupWindow(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C4337R.styleable.ListPopupWindow, i, i2);
    ...
    public void setHeight(int height) {
        if (height < 0 && -2 != height && -1 != height) {
            if (this.mContext.getApplicationInfo().targetSdkVersion < 26) {
                Log.m96e(TAG, "Negative value " + height + " passed to ListPopupWindow#setHeight produces undefined results");
            } else {
    ...
    private void setBlurEffect() {
        ...
        if (context != null && this.mIsDeviceDefault) {
            ...
            if (!isThemeApplied && !isReduceTransparency && this.mPopup.semIsAvailableBlurBackground()) {
                ...
                builder.setBackgroundCornerRadius(this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_popup_menu_corner_radius));
