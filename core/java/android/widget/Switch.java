...
public class Switch extends CompoundButton {
  ...
  public Switch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(attrs, C4337R.styleable.Switch, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.Switch, attrs, a, defStyleAttr, defStyleRes);
    ...
    if ((!this.mIsSamsungBasicInteraction && !this.mIsMetaDataInActivity)
        || a.getResourceId(2, 0) != 17304325) {
      this.mThumbDrawable = a.getDrawable(2);
    } else if (this.mIsThemeChanged) {
      this.mThumbDrawable =
          switchTheme.data != 0
              ? res.getDrawable(
                  C4337R.drawable.sem_switch_thumb_material_anim_for_theme, context.getTheme())
              : res.getDrawable(
                  C4337R.drawable.sem_switch_thumb_material_dark_anim_for_theme,
                  context.getTheme());
    } else {
      this.mThumbDrawable =
          switchTheme.data != 0
              ? res.getDrawable(C4337R.drawable.sem_switch_thumb_material_anim, context.getTheme())
              : res.getDrawable(
                  C4337R.drawable.sem_switch_thumb_material_dark_anim, context.getTheme());
    }
    ...
    if ((this.mIsSamsungBasicInteraction || this.mIsMetaDataInActivity)
        && a.getResourceId(4, 0) == 17304331) {
      this.mTrackDrawable =
          switchTheme.data != 0
              ? res.getDrawable(C4337R.drawable.sem_switch_track_material, context.getTheme())
              : res.getDrawable(C4337R.drawable.sem_switch_track_material_dark, context.getTheme());
    } else {
    ...
    if ((this.mIsSamsungBasicInteraction || this.mIsMetaDataInActivity) && !this.mIsThemeChanged) {
      this.mTrackOnDrawable =
          res.getDrawable(C4337R.drawable.sem_switch_track_mtrl_alpha_on, context.getTheme());
      Drawable drawable3 =
          res.getDrawable(C4337R.drawable.sem_switch_track_mtrl_alpha_off, context.getTheme());
  ...
  public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (this.mIsSamsungBasicInteraction || this.mIsMetaDataInActivity) {
      ...
      switchWidth =
          Math.max(this.mSwitchMinWidth, (this.mThumbWidth * 2) + paddingLeft + paddingRight);
    }
    ...
    if (this.mIsThemeChanged) {
      ...
      this.mTrackMargin =
          ratio > THUMB_TRACK_WIDTH_RATIO
              ? (int) Math.ceil(r9 - (switchWidth * THUMB_TRACK_WIDTH_RATIO))
              : 0;
    }
  ...
  private Layout makeLayout(CharSequence text) {
    ...
    return StaticLayout.Builder.obtain(transformed, 0, transformed.length(), this.mTextPaint, width)
  ...
  protected CharSequence getButtonStateDescription() {
    if (isChecked()) {
      ...
      return charSequence == null
          ? getResources().getString(C4337R.string.sem_switch_on)
          : charSequence;
    }
    CharSequence charSequence2 = this.mTextOff;
    return charSequence2 == null
        ? getResources().getString(C4337R.string.sem_switch_off)
        : charSequence2;
  }
