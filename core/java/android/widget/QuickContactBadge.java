...
public class QuickContactBadge extends ImageView implements View.OnClickListener {
  ...
  public QuickContactBadge(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray styledAttributes = this.mContext.obtainStyledAttributes(C4337R.styleable.Theme);
  ...
  public void setImageToDefault() {
    if (this.mDefaultAvatar == null) {
      this.mDefaultAvatar = this.mContext.getDrawable(C4337R.drawable.ic_contact_picture);
    }
  ...
  public void assignContactFromPhone(String phoneNumber, boolean lazyLookup, Bundle extras) {
    ...
    if (!lazyLookup && (queryHandler = this.mQueryHandler) != null) {
      queryHandler.startQuery(
          1,
          null,
          Uri.withAppendedPath(ContactsContract.PhoneLookup.CONTENT_FILTER_URI, this.mContactPhone),
  ...
  public void onClick(View v) {
    ...
    if (this.mContactUri != null) {
      ContactsContract.QuickContact.showQuickContact(
          getContext(), this, this.mContactUri, this.mExcludeMimes, this.mPrioritizedMimeType);
      return;
    }
      ...
      try {
        switch (token) {
          ...
          case 2:
            ...
            createUri =
                Uri.fromParts(
                    "mailto", extras.getString(QuickContactBadge.EXTRA_URI_CONTENT), null);
            if (cursor != null) {
        ...
        if (trigger && QuickContactBadge.this.mContactUri != null) {
          ...
          ContactsContract.QuickContact.showQuickContact(
              context,
              quickContactBadge,
              quickContactBadge.mContactUri,
              QuickContactBadge.this.mExcludeMimes,
              QuickContactBadge.this.mPrioritizedMimeType);
        } else if (createUri != null) {
          Intent intent =
              new Intent("com.android.contacts.action.SHOW_OR_CREATE_CONTACT", createUri);
          if (extras != null) {
