...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C4337R.styleable.NumberPicker, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.NumberPicker, attrs, attributesArray, defStyleAttr, defStyleRes);
        ...
        if (!z) {
            ImageButton imageButton = (ImageButton) findViewById(C4337R.id.increment);
        ...
        if (!z) {
            ImageButton imageButton2 = (ImageButton) findViewById(C4337R.id.decrement);
        ...
        EditText editText = (EditText) findViewById(C4337R.id.numberpicker_input);
