...
public class TableLayout extends LinearLayout {
  ...
  public TableLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
    TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.TableLayout);
      ...
      if (child.getVisibility() == 8) {
        ...
        if (firstRow2) {
          ...
          if (difference <= 0) {
            ...
            System.arraycopy(
                widths, oldMaxWidths.length, this.mMaxWidths, oldMaxWidths.length, difference);
          }
