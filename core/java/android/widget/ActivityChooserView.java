...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C4337R.styleable.ActivityChooserView, i, i2);
        saveAttributeDataForStyleable(context, C4337R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, i2);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(1, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(0);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(this.mContext).inflate(C4337R.layout.activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        LinearLayout linearLayout = (LinearLayout) findViewById(C4337R.id.activity_chooser_view_content);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C4337R.dimen.config_prefDialogWidth));
    }
    ...
    public void showPopupUnchecked(int maxActivityCount) {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(this.mContext.getString(C4337R.string.activitychooserview_choose_application));
    ...
    private class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        private void startActivity(Intent intent, ResolveInfo resolveInfo) {
            try {
                ...
                String message = ActivityChooserView.this.mContext.getString(C4337R.string.activitychooserview_choose_application_error, appLabel);
            ...
            switch (itemViewType) {
                case 0:
                    if (convertView == null || convertView.getId() != 16909247) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C4337R.layout.activity_chooser_view_list_item, parent, false);
                    }
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C4337R.layout.activity_chooser_view_list_item, parent, false);
                        convertView2.setId(1);
                        TextView titleView2 = (TextView) convertView2.findViewById(16908310);
                        titleView2.setText(ActivityChooserView.this.mContext.getString(C4337R.string.activity_chooser_view_see_all));
                        return convertView2;
                    }
                    return convertView;
                default:
