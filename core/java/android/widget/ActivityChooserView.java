...
public class ActivityChooserView extends ViewGroup
  ...
  public ActivityChooserView(Context context, AttributeSet attributeSet, int i, int i2) {
    ...
    this.mModelDataSetOberver =
        new DataSetObserver() { // from class: android.widget.ActivityChooserView.1
    ...
    this.mOnGlobalLayoutListener =
        new ViewTreeObserver
            .OnGlobalLayoutListener() { // from class: android.widget.ActivityChooserView.2
    ...
    TypedArray obtainStyledAttributes =
        context.obtainStyledAttributes(attributeSet, C4337R.styleable.ActivityChooserView, i, i2);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, i2);
    this.mInitialActivityCount = obtainStyledAttributes.getInt(1, 4);
    Drawable drawable = obtainStyledAttributes.getDrawable(0);
    obtainStyledAttributes.recycle();
    LayoutInflater.from(this.mContext)
        .inflate(C4337R.layout.activity_chooser_view, (ViewGroup) this, true);
    Callbacks callbacks = new Callbacks();
    this.mCallbacks = callbacks;
    LinearLayout linearLayout =
        (LinearLayout) findViewById(C4337R.id.activity_chooser_view_content);
    this.mActivityChooserContent = linearLayout;
    this.mActivityChooserContentBackground = linearLayout.getBackground();
    FrameLayout frameLayout = (FrameLayout) findViewById(C4337R.id.default_activity_button);
    ...
    this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C4337R.id.image);
    FrameLayout frameLayout2 = (FrameLayout) findViewById(C4337R.id.expand_activities_button);
    frameLayout2.setOnClickListener(callbacks);
    frameLayout2.setAccessibilityDelegate(
        new View.AccessibilityDelegate() { // from class: android.widget.ActivityChooserView.3
    ...
    frameLayout2.setOnTouchListener(
        new ForwardingListener(frameLayout2) { // from class: android.widget.ActivityChooserView.4
    ...
    ImageView imageView = (ImageView) frameLayout2.findViewById(C4337R.id.image);
    ...
    activityChooserViewAdapter.registerDataSetObserver(
        new DataSetObserver() { // from class: android.widget.ActivityChooserView.5
          @Override // android.database.DataSetObserver
          public void onChanged() {
            super.onChanged();
    ...
    this.mListPopupMaxWidth =
        Math.max(
            resources.getDisplayMetrics().widthPixels / 2,
            resources.getDimensionPixelSize(C4337R.dimen.config_prefDialogWidth));
  }
  ...
  public void showPopupUnchecked(int maxActivityCount) {
    ...
    if (maxActivityCount != Integer.MAX_VALUE
    ...
    if (!popupWindow.isShowing()) {
      ...
      popupWindow
          ...
          .setContentDescription(
              this.mContext.getString(C4337R.string.activitychooserview_choose_application));
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (this.mDefaultActivityButton.getVisibility() != 0) {
      heightMeasureSpec =
          View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(heightMeasureSpec), 1073741824);
    }
    ...
    if (activityCount == 1 || (activityCount > 1 && historySize > 0)) {
      ...
      if (this.mDefaultActionButtonContentDescription != 0) {
        ...
        String contentDescription =
            this.mContext.getString(this.mDefaultActionButtonContentDescription, label);
  ...
  private class Callbacks
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
      ...
      switch (itemViewType) {
        case 0:
          ...
          int position2 =
              ActivityChooserView.this.mAdapter.getShowDefaultActivity() ? position : position + 1;
          Intent launchIntent =
              ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(position2);
          if (launchIntent != null) {
            launchIntent.addFlags(524288);
            ResolveInfo resolveInfo =
                ActivityChooserView.this.mAdapter.getDataModel().getActivity(position2);
    ...
    public void onClick(View view) {
      ...
      int index =
          ActivityChooserView.this.mAdapter.getDataModel().getActivityIndex(defaultActivity);
    ...
    private void startActivity(Intent intent, ResolveInfo resolveInfo) {
      try {
        ...
        CharSequence appLabel =
            resolveInfo.loadLabel(ActivityChooserView.this.mContext.getPackageManager());
        String message =
            ActivityChooserView.this.mContext.getString(
                C4337R.string.activitychooserview_choose_application_error, appLabel);
        Log.m96e(ActivityChooserView.LOG_TAG, message);
  ...
  private class ActivityChooserViewAdapter extends BaseAdapter {
      ...
      switch (itemViewType) {
        case 0:
          if (convertView == null || convertView.getId() != 16909247) {
            convertView =
                LayoutInflater.from(ActivityChooserView.this.getContext())
                    .inflate(C4337R.layout.activity_chooser_view_list_item, parent, false);
          }
        ...
        case 1:
          if (convertView == null || convertView.getId() != 1) {
            ...
            titleView2.setText(
                ActivityChooserView.this.mContext.getString(
                    C4337R.string.activity_chooser_view_see_all));
            return convertView2;
          }
          return convertView;
        default:
    ...
    public void setShowDefaultActivity(
        boolean showDefaultActivity, boolean highlightDefaultActivity) {
      if (this.mShowDefaultActivity != showDefaultActivity
