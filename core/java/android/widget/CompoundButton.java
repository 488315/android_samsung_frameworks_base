...
public abstract class CompoundButton extends Button implements Checkable {
    ...
    public CompoundButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.CompoundButton, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.CompoundButton, attrs, a, defStyleAttr, defStyleRes);
    ...
    protected CharSequence getButtonStateDescription() {
        if (isChecked()) {
            return getResources().getString(C4337R.string.checked);
        }
        return getResources().getString(C4337R.string.not_checked);
    }
