...
public class Scroller {
  ...
  /* renamed from: P1 */
  private static final float f615P1 = 0.175f;

  /* renamed from: P2 */
  private static final float f616P2 = 0.35000002f;
  ...
  static {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      while (true) {
        ...
        f2 = 3.0f;
        coef = x * 3.0f * (1.0f - x);
        float tx = ((((1.0f - x) * f615P1) + (x * f616P2)) * coef) + (x * x * x);
      ...
      SPLINE_TIME[i] = (coef2 * (((1.0f - y) * f615P1) + (f616P2 * y))) + (y * y * y);
    }
