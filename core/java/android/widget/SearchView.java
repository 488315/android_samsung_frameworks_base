...
public class SearchView extends LinearLayout implements CollapsibleActionView {
  ...
  private static final String SEM_AUTHORITY_SVI_APP =
      "com.samsung.android.honeyboard.provider.VoiceLanguageListProvider";
  private static final String SEM_KEY_SVI_APP_LOCALE = "is_honeyvoice_locale_supported";
  private static final String SEM_SVI_ACTION =
      "samsung.honeyboard.honeyvoice.action.RECOGNIZE_SPEECH";
  ...
  private static final int TW_SEARCH_ICON_RES_ID = 17304543;
  ...
  public final class InspectionCompanion
      implements android.view.inspector.InspectionCompanion<SearchView> {
  ...
  public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    this.mUpdateDrawableStateRunnable =
        new Runnable() { // from class: android.widget.SearchView.1
          @Override // java.lang.Runnable
          public void run() {
            SearchView.this.updateFocusedState();
          }
        };
    this.mReleaseCursorRunnable =
        new Runnable() { // from class: android.widget.SearchView.2
          @Override // java.lang.Runnable
          public void run() {
            if (SearchView.this.mSuggestionsAdapter != null
                && (SearchView.this.mSuggestionsAdapter instanceof SuggestionsAdapter)) {
    ...
    View.OnClickListener onClickListener =
        new View.OnClickListener() { // from class: android.widget.SearchView.5
    ...
    this.mTextKeyListener =
        new View.OnKeyListener() { // from class: android.widget.SearchView.6
          ...
          public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            boolean isFolderTypeFeature =
                SearchView.this
                    .getContext()
                    .getPackageManager()
                    .hasSystemFeature(PackageManager.SEM_FEATURE_FOLDER_TYPE);
            if (isFolderTypeFeature) {
              InputMethodManager imm =
                  (InputMethodManager)
                      SearchView.this.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
              if (keyCode == 23) {
                imm.viewClicked(v);
            ...
            if (SearchView.this.mSearchSrcTextView.isPopupShowing()
                && SearchView.this.mSearchSrcTextView.getListSelection() != -1) {
            ...
            if (!SearchView.this.mSearchSrcTextView.isEmpty() && event.hasNoModifiers()) {
              if (event.getAction() == 1 && (keyCode == 66 || keyCode == 160)) {
                ...
                searchView.launchQuerySearch(
                    0, null, searchView.mSearchSrcTextView.getText().toString());
                return true;
              }
              if (event.getAction() == 0
                  && (actionKey = SearchView.this.mSearchable.findActionKey(keyCode)) != null
                  && actionKey.getQueryActionMsg() != null) {
                SearchView.this.launchQuerySearch(
                    keyCode,
                    actionKey.getQueryActionMsg(),
                    SearchView.this.mSearchSrcTextView.getText().toString());
                return true;
              }
            }
            return false;
    ...
    TextView.OnEditorActionListener onEditorActionListener =
        new TextView.OnEditorActionListener() { // from class: android.widget.SearchView.7
    ...
    AdapterView.OnItemClickListener onItemClickListener =
        new AdapterView.OnItemClickListener() { // from class: android.widget.SearchView.8
    ...
    AdapterView.OnItemSelectedListener onItemSelectedListener =
        new AdapterView.OnItemSelectedListener() { // from class: android.widget.SearchView.9
    ...
    this.mTextWatcher =
        new TextWatcher() { // from class: android.widget.SearchView.10
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.SearchView, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.SearchView, attrs, a, defStyleAttr, defStyleRes);
    LayoutInflater inflater =
        (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    int layoutResId = a.getResourceId(0, C4337R.layout.search_view);
    ...
    SearchAutoComplete searchAutoComplete =
        (SearchAutoComplete) findViewById(C4337R.id.search_src_text);
    this.mSearchSrcTextView = searchAutoComplete;
    searchAutoComplete.setSearchView(this);
    this.mSearchEditFrame = findViewById(C4337R.id.search_edit_frame);
    View findViewById = findViewById(C4337R.id.search_plate);
    this.mSearchPlate = findViewById;
    View findViewById2 = findViewById(C4337R.id.submit_area);
    this.mSubmitArea = findViewById2;
    ImageView imageView3 = (ImageView) findViewById(C4337R.id.search_button);
    this.mSearchButton = imageView3;
    ImageView imageView4 = (ImageView) findViewById(C4337R.id.search_go_btn);
    this.mGoButton = imageView4;
    ImageView imageView5 = (ImageView) findViewById(C4337R.id.search_close_btn);
    this.mCloseButton = imageView5;
    ImageView imageView6 = (ImageView) findViewById(C4337R.id.search_voice_btn);
    this.mVoiceButton = imageView6;
    ImageView imageView7 = (ImageView) findViewById(C4337R.id.search_mag_icon);
    this.mCollapsedIcon = imageView7;
    ImageView imageView8 = (ImageView) findViewById(C4337R.id.search_more_btn);
    this.mMoreButton = imageView8;
    ImageView imageView9 = (ImageView) findViewById(C4337R.id.search_back_btn);
    ...
    this.mSuggestionRowLayout = a.getResourceId(11, C4337R.layout.search_dropdown_item_icons_2line);
    ...
    searchAutoComplete.setOnFocusChangeListener(
        new View.OnFocusChangeListener() { // from class: android.widget.SearchView.3
          @Override // android.view.View.OnFocusChangeListener
          public void onFocusChange(View v, boolean hasFocus) {
            if (SearchView.this.mOnQueryTextFocusChangeListener != null) {
              SearchView.this.mOnQueryTextFocusChangeListener.onFocusChange(
    ...
    if (this.mThemeIsDeviceDefault) {
      if (resourceId == 0) {
        imageView7.lambda$setImageURIAsync$2(getContext().getResources().getDrawable(17304543));
        imageView3.lambda$setImageURIAsync$2(getContext().getResources().getDrawable(17304543));
      }
      Resources resources = this.mContext.getResources();
      if (!this.mIsNight) {
        if (findViewById.getBackground() == null) {
          searchAutoComplete.setTextColor(
              resources.getColor(C4337R.color.sem_search_view_no_background_text_color_light));
          searchAutoComplete.setHintTextColor(
              resources.getColor(C4337R.color.sem_search_view_no_background_hint_text_color_light));
          imageView4.setColorFilter(
              resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
          imageView5.setColorFilter(
              resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
          imageView6.setColorFilter(
              resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
          ...
          searchAutoComplete.setTextColor(
              resources.getColor(C4337R.color.tw_searchview_text_material));
          searchAutoComplete.setHintTextColor(
              resources.getColor(C4337R.color.tw_searchview_hint_text_material));
          imageView4.setColorFilter(
              resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
          imageView5.setColorFilter(
              resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
          imageView6.setColorFilter(
              resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
        ...
        searchAutoComplete.setTextColor(
            resources.getColor(C4337R.color.sem_search_view_no_background_text_color_dark));
        searchAutoComplete.setHintTextColor(
            resources.getColor(C4337R.color.sem_search_view_no_background_hint_text_color_dark));
        imageView4.setColorFilter(
            resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
        imageView5.setColorFilter(
            resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
        imageView6.setColorFilter(
            resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
        ...
        searchAutoComplete.setTextColor(
            resources.getColor(C4337R.color.tw_searchview_text_material_dark));
        searchAutoComplete.setHintTextColor(
            resources.getColor(C4337R.color.tw_searchview_hint_text_material_dark));
        imageView4.setColorFilter(
            resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
        imageView5.setColorFilter(
            resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
        imageView6.setColorFilter(
            resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
    ...
    if (findViewById3 != null) {
      findViewById3.addOnLayoutChangeListener(
          new View.OnLayoutChangeListener() { // from class: android.widget.SearchView.4
  ...
  protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    if (changed) {
      ...
      this.mSearchSrtTextViewBoundsExpanded.set(
          this.mSearchSrcTextViewBounds.left, 0, this.mSearchSrcTextViewBounds.right, bottom - top);
      UpdatableTouchDelegate updatableTouchDelegate = this.mTouchDelegate;
      if (updatableTouchDelegate == null) {
        UpdatableTouchDelegate updatableTouchDelegate2 =
            new UpdatableTouchDelegate(
                this.mSearchSrtTextViewBoundsExpanded,
                this.mSearchSrcTextViewBounds,
                this.mSearchSrcTextView);
        this.mTouchDelegate = updatableTouchDelegate2;
        setTouchDelegate(updatableTouchDelegate2);
        return;
      }
      updatableTouchDelegate.setBounds(
          this.mSearchSrtTextViewBoundsExpanded, this.mSearchSrcTextViewBounds);
    }
  }
  ...
  private int getPreferredWidth() {
    return getContext()
        .getResources()
        .getDimensionPixelSize(C4337R.dimen.search_view_preferred_width);
  }

  private int getPreferredHeight() {
    return getContext()
        .getResources()
        .getDimensionPixelSize(C4337R.dimen.search_view_preferred_height);
  }
  ...
  private void updateSubmitButton(boolean hasText) {
    ...
    if (this.mSubmitButtonEnabled
        && isSubmitAreaEnabled()
        && hasFocus()
        && (hasText || !this.mVoiceButtonEnabled)) {
      visibility = 0;
    }
  ...
  private void updateSubmitArea() {
    ...
    if (isSubmitAreaEnabled()
        && (this.mGoButton.getVisibility() == 0 || this.mVoiceButton.getVisibility() == 0)) {
      visibility = 0;
    }
  ...
  public boolean onKeyDown(int keyCode, KeyEvent event) {
    ...
    if (actionKey != null && actionKey.getQueryActionMsg() != null) {
      launchQuerySearch(
          keyCode, actionKey.getQueryActionMsg(), this.mSearchSrcTextView.getText().toString());
      return true;
    }
  ...
  public boolean onSuggestionsKey(View v, int keyCode, KeyEvent event) {
    ...
    if (this.mSearchable != null
      ...
      if ((keyCode != 19 || this.mSearchSrcTextView.getListSelection() != 0)
          && (actionKey = this.mSearchable.findActionKey(keyCode)) != null
          && ((actionKey.getSuggestActionMsg() != null
                  || actionKey.getSuggestActionMsgColumn() != null)
              && (position = this.mSearchSrcTextView.getListSelection()) != -1)) {
        Cursor c = this.mSuggestionsAdapter.getCursor();
        if (c.moveToPosition(position)
            && (actionMsg = getActionKeyMessage(c, actionKey)) != null
            && actionMsg.length() > 0) {
  ...
  private void updateSearchAutoComplete() {
    ...
    if (this.mSearchable.getSuggestAuthority() != null) {
      ...
      ((SuggestionsAdapter) this.mSuggestionsAdapter)
          .setQueryRefinement(this.mQueryRefinement ? 2 : 1);
    }
  }
  ...
  boolean semIsForceHideSoftInput() {
    ...
    int mShowImeWithHardKeyboard =
        Settings.Secure.getInt(
            getContext().getContentResolver(), Settings.Secure.SHOW_IME_WITH_HARD_KEYBOARD, 0);
      ...
      if (searchable.getVoiceSearchLaunchWebSearch()) {
        ...
        if (this.mUseSVI) {
          ...
          Intent appSearchIntent =
              createVoiceAppSearchIntent(this.mVoiceAppSearchIntent, searchable);
          getContext().startActivity(appSearchIntent);
        }
      }
    } catch (ActivityNotFoundException e) {
      Log.m102w(LOG_TAG, "Could not find voice search activity");
    }
  }
  ...
  static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR =
        new Parcelable.Creator<SavedState>() { // from class: android.widget.SearchView.SavedState.1
  ...
  public void adjustDropDownSizeAndPosition() {
    ...
    if (this.mDropDownAnchor.getWidth() > 1) {
      ...
      if (this.mIconifiedByDefault) {
        iconOffset =
            res.getDimensionPixelSize(C4337R.dimen.dropdownitem_icon_width)
                + res.getDimensionPixelSize(C4337R.dimen.dropdownitem_text_padding_left);
      } else {
        iconOffset = 0;
      }
      if (this.mThemeIsDeviceDefault) {
      ...
      int width =
          (((this.mDropDownAnchor.getWidth() + dropDownPadding.left) + dropDownPadding.right)
                  + iconOffset)
              - anchorPadding;
  ...
  private void launchIntent(Intent intent) {
    ...
    try {
      ...
      Log.m97e(LOG_TAG, "Failed launch activity: " + intent, ex);
    }
  }
  ...
  private Intent createVoiceWebSearchIntent(Intent baseIntent, SearchableInfo searchable) {
    ...
    voiceIntent.putExtra(
        "calling_package", searchActivity == null ? null : searchActivity.flattenToShortString());
    return voiceIntent;
  }
  ...
  private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
    ...
    try {
      String action =
          SuggestionsAdapter.getColumnString(c, SearchManager.SUGGEST_COLUMN_INTENT_ACTION);
      if (action == null) {
      ...
      String data2 =
          SuggestionsAdapter.getColumnString(c, SearchManager.SUGGEST_COLUMN_INTENT_DATA);
      if (data2 == null) {
        data2 = this.mSearchable.getSuggestIntentData();
      }
      if (data2 != null
          && (id =
                  SuggestionsAdapter.getColumnString(
                      c, SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID))
              != null) {
      ...
      String extraData =
          SuggestionsAdapter.getColumnString(c, SearchManager.SUGGEST_COLUMN_INTENT_EXTRA_DATA);
  ...
  public static class SearchAutoComplete extends AutoCompleteTextView {
    ...
    public SearchAutoComplete(Context context) {
      ...
      this.mRunShowSoftInputIfNecessary =
          new Runnable() { // from class:
                           // android.widget.SearchView$SearchAutoComplete$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
      super.onWindowFocusChanged(hasWindowFocus);
      if (!this.mSearchView.semIsForceHideSoftInput()
          && hasWindowFocus
  ...
  public boolean semSetSviEnabled(boolean enabled) {
    if (!ViewRune.WIDGET_SEARCHVIEW_USE_SVI) {
      Log.m102w(LOG_TAG, "semSetSviEnabled: WIDGET_SEARCHVIEW_USE_SVI is false");
      this.mUseSVI = false;
      return false;
    }
    ...
    if (enabled) {
      try {
        ...
        PackageInfo packageInfo =
            packageManager.getPackageInfo("com.samsung.android.honeyboard", 0);
        long version = packageInfo != null ? packageInfo.getLongVersionCode() : -1L;
        if (version < 220002001) {
          Log.m102w(LOG_TAG, "semSetSviEnabled: not supported SVI version");
          this.mUseSVI = false;
        }
        if (!isSystemLocaleSupported()) {
          Log.m102w(LOG_TAG, "semSetSviEnabled: not supported system locale");
          this.mUseSVI = false;
        }
      } catch (Exception e) {
        Log.m102w(LOG_TAG, "Exception " + e);
        this.mUseSVI = false;
      }
    }
    return this.mUseSVI;
  ...
  private boolean isSystemLocaleSupported() {
    ...
    Uri uri =
        Uri.parse(
            "content://com.samsung.android.honeyboard.provider.VoiceLanguageListProvider/is_honeyvoice_locale_supported");
    int isLocalSupported = 0;
    try {
      cursor = this.mContext.getContentResolver().query(uri, null, null, null, null);
    } catch (Exception e) {
      Log.m102w(LOG_TAG, "isSystemLocaleSupported: exception!!" + e);
    }
    if (cursor != null) {
  ...
  private void semCheckMaxFontSize() {
    ...
    int searchSrcTextSize =
        getContext()
            .getResources()
            .getDimensionPixelSize(C4337R.dimen.tw_searchview_search_text_size);
