...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.SearchView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.SearchView, attrs, a, defStyleAttr, defStyleRes);
        ...
        this.mIsNight = z2;
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C4337R.id.search_src_text);
        ...
        if (this.mThemeIsDeviceDefault) {
            ...
            if (!this.mIsNight) {
                if (findViewById.getBackground() == null) {
                    searchAutoComplete.setTextColor(resources.getColor(C4337R.color.sem_search_view_no_background_text_color_light));
                    searchAutoComplete.setHintTextColor(resources.getColor(C4337R.color.sem_search_view_no_background_hint_text_color_light));
                    imageView4.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
                    imageView5.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
                    imageView6.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
                    imageView.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
                    imageView2.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
                    imageView3.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_light));
                } else {
                    searchAutoComplete.setTextColor(resources.getColor(C4337R.color.tw_searchview_text_material));
                    searchAutoComplete.setHintTextColor(resources.getColor(C4337R.color.tw_searchview_hint_text_material));
                    imageView4.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
                    imageView5.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
                    imageView6.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
                    imageView.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
                    imageView2.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
                    imageView3.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material));
                }
            } else if (findViewById.getBackground() == null) {
                searchAutoComplete.setTextColor(resources.getColor(C4337R.color.sem_search_view_no_background_text_color_dark));
                searchAutoComplete.setHintTextColor(resources.getColor(C4337R.color.sem_search_view_no_background_hint_text_color_dark));
                imageView4.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
                imageView5.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
                imageView6.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
                imageView.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
                imageView2.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
                imageView3.setColorFilter(resources.getColor(C4337R.color.sem_search_view_no_background_icon_color_dark));
            } else {
                searchAutoComplete.setTextColor(resources.getColor(C4337R.color.tw_searchview_text_material_dark));
                searchAutoComplete.setHintTextColor(resources.getColor(C4337R.color.tw_searchview_hint_text_material_dark));
                imageView4.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
                imageView5.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
                imageView6.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
                imageView.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
                imageView2.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
                imageView3.setColorFilter(resources.getColor(C4337R.color.tw_searchview_search_icon_color_material_dark));
            }
        }
        a.recycle();
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C4337R.dimen.search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C4337R.dimen.search_view_preferred_height);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                iconOffset = res.getDimensionPixelSize(C4337R.dimen.dropdownitem_icon_width) + res.getDimensionPixelSize(C4337R.dimen.dropdownitem_text_padding_left);
            } else {
                iconOffset = 0;
            }
            if (this.mThemeIsDeviceDefault) {
    ...
    private void semCheckMaxFontSize() {
        ...
        int searchSrcTextSize = getContext().getResources().getDimensionPixelSize(C4337R.dimen.tw_searchview_search_text_size);
