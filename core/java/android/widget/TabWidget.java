...
public class TabWidget extends LinearLayout implements View.OnFocusChangeListener {
    ...
    public TabWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.TabWidget, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.TabWidget, attrs, a, defStyleAttr, defStyleRes);
        ...
        if (z) {
            TypedArray typedArray = context.getTheme().obtainStyledAttributes(null, C4337R.styleable.Theme, 0, 0);
            int tabTextAppearnceId = typedArray.getResourceId(143, 0);
            typedArray.recycle();
            TypedArray typedArray2 = getContext().obtainStyledAttributes(tabTextAppearnceId, C4337R.styleable.TextAppearance);
    ...
    public void setCurrentTab(int index) {
        ...
        if (i != -1) {
            ...
            if (this.mIsThemeDeviceDefaultFamily && (oldTabView = getChildTabViewAt(this.mSelectedTab)) != null) {
                ...
                SemTabDotLineView oldSemTabDotLineView = (SemTabDotLineView) oldTabView.findViewById(C4337R.id.sem_tab_indicator);
        ...
        if (this.mIsThemeDeviceDefaultFamily && (tabView = getChildTabViewAt(this.mSelectedTab)) != null) {
            ...
            SemTabDotLineView semTabDotLineView = (SemTabDotLineView) tabView.findViewById(C4337R.id.sem_tab_indicator);
        ...
        */
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (TabWidget.this.mSelectedTab != this.mTabIndex) {
                ...
                SemTabDotLineView semTabDotLineView = (SemTabDotLineView) view.findViewById(C4337R.id.sem_tab_indicator);
                ...
                if (semTabDotLineView != null && tabText != null && (oldView = (tabWidget = TabWidget.this).getChildTabViewAt(tabWidget.mSelectedTab)) != null) {
                    SemTabDotLineView oldDotView = (SemTabDotLineView) oldView.findViewById(C4337R.id.sem_tab_indicator);
