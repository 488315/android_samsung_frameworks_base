  ...
  public AnalogClock(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    this.mSecondsHandFps =
        AppGlobals.getIntCoreSetting(
            ...
            context
                .getResources()
                .getInteger(C4337R.integer.config_defaultAnalogClockSecondsHandFps));
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.AnalogClock, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.AnalogClock, attrs, a, defStyleAttr, defStyleRes);
