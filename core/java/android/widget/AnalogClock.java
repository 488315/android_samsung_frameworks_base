...
public class AnalogClock extends View {
    ...
    public AnalogClock(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mSecondsHandFps = AppGlobals.getIntCoreSetting(WidgetFlags.KEY_ANALOG_CLOCK_SECONDS_HAND_FPS, context.getResources().getInteger(C4337R.integer.config_defaultAnalogClockSecondsHandFps));
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.AnalogClock, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.AnalogClock, attrs, a, defStyleAttr, defStyleRes);
        Drawable drawable = a.getDrawable(0);
        this.mDial = drawable;
        if (drawable == null) {
            this.mDial = context.getDrawable(C4337R.drawable.clock_dial);
        }
        ...
        if (drawable2 == null) {
            this.mHourHand = context.getDrawable(C4337R.drawable.clock_hand_hour);
        }
        ...
        if (drawable3 == null) {
            this.mMinuteHand = context.getDrawable(C4337R.drawable.clock_hand_minute);
        }
