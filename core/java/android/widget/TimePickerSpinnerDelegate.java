...
class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate {
  ...
  public TimePickerSpinnerDelegate(
    ...
    int layoutResourceId = a.getResourceId(13, C4337R.layout.time_picker_legacy);
    a.recycle();
    LayoutInflater inflater = LayoutInflater.from(this.mContext);
    View view = inflater.inflate(layoutResourceId, (ViewGroup) this.mDelegator, true);
    view.setSaveFromParentEnabled(false);
    NumberPicker numberPicker = (NumberPicker) delegator.findViewById(C4337R.id.hour);
    this.mHourSpinner = numberPicker;
    numberPicker.setOnValueChangedListener(
        new NumberPicker
            .OnValueChangeListener() { // from class: android.widget.TimePickerSpinnerDelegate.1
          @Override // android.widget.NumberPicker.OnValueChangeListener
          public void onValueChange(NumberPicker spinner, int oldVal, int newVal) {
            TimePickerSpinnerDelegate.this.updateInputState();
            if (!TimePickerSpinnerDelegate.this.is24Hour()
                && ((oldVal == 11 && newVal == 12) || (oldVal == 12 && newVal == 11))) {
    ...
    EditText editText = (EditText) numberPicker.findViewById(C4337R.id.numberpicker_input);
    this.mHourSpinnerInput = editText;
    editText.setImeOptions(5);
    TextView textView = (TextView) this.mDelegator.findViewById(C4337R.id.divider);
    this.mDivider = textView;
    if (textView != null) {
      setDividerText();
    }
    NumberPicker numberPicker2 = (NumberPicker) this.mDelegator.findViewById(C4337R.id.minute);
    ...
    numberPicker2.setOnValueChangedListener(
        new NumberPicker
            .OnValueChangeListener() { // from class: android.widget.TimePickerSpinnerDelegate.2
          @Override // android.widget.NumberPicker.OnValueChangeListener
          public void onValueChange(NumberPicker spinner, int oldVal, int newVal) {
            TimePickerSpinnerDelegate.this.updateInputState();
    ...
    EditText editText2 = (EditText) numberPicker2.findViewById(C4337R.id.numberpicker_input);
    this.mMinuteSpinnerInput = editText2;
    editText2.setImeOptions(5);
    String[] amPmStrings = TimePicker.getAmPmStrings(context);
    this.mAmPmStrings = amPmStrings;
    View amPmView = this.mDelegator.findViewById(C4337R.id.amPm);
    if (amPmView instanceof Button) {
      ...
      button.setOnClickListener(
          new View.OnClickListener() { // from class: android.widget.TimePickerSpinnerDelegate.3
      ...
      numberPicker3.setOnValueChangedListener(
          new NumberPicker
              .OnValueChangeListener() { // from class: android.widget.TimePickerSpinnerDelegate.4
            @Override // android.widget.NumberPicker.OnValueChangeListener
      ...
      EditText editText3 = (EditText) numberPicker3.findViewById(C4337R.id.numberpicker_input);
      this.mAmPmSpinnerInput = editText3;
      editText3.setImeOptions(6);
    }
    if (isAmPmAtStart()) {
      ViewGroup amPmParent = (ViewGroup) delegator.findViewById(C4337R.id.timePickerLayout);
  ...
  private void setContentDescriptions() {
    trySetContentDescription(
        this.mMinuteSpinner,
        C4337R.id.increment,
        C4337R.string.time_picker_increment_minute_button);
    trySetContentDescription(
        this.mMinuteSpinner,
        C4337R.id.decrement,
        C4337R.string.time_picker_decrement_minute_button);
    trySetContentDescription(
        this.mHourSpinner, C4337R.id.increment, C4337R.string.time_picker_increment_hour_button);
    trySetContentDescription(
        this.mHourSpinner, C4337R.id.decrement, C4337R.string.time_picker_decrement_hour_button);
    NumberPicker numberPicker = this.mAmPmSpinner;
    if (numberPicker != null) {
      trySetContentDescription(
          numberPicker, C4337R.id.increment, C4337R.string.time_picker_increment_set_pm_button);
      trySetContentDescription(
          this.mAmPmSpinner,
          C4337R.id.decrement,
          C4337R.string.time_picker_decrement_set_am_button);
    }
  }
