...
class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    private void setContentDescriptions() {
        trySetContentDescription(this.mMinuteSpinner, C4337R.id.increment, C4337R.string.time_picker_increment_minute_button);
        trySetContentDescription(this.mMinuteSpinner, C4337R.id.decrement, C4337R.string.time_picker_decrement_minute_button);
        trySetContentDescription(this.mHourSpinner, C4337R.id.increment, C4337R.string.time_picker_increment_hour_button);
        trySetContentDescription(this.mHourSpinner, C4337R.id.decrement, C4337R.string.time_picker_decrement_hour_button);
        NumberPicker numberPicker = this.mAmPmSpinner;
        if (numberPicker != null) {
            trySetContentDescription(numberPicker, C4337R.id.increment, C4337R.string.time_picker_increment_set_pm_button);
            trySetContentDescription(this.mAmPmSpinner, C4337R.id.decrement, C4337R.string.time_picker_decrement_set_am_button);
        }
    }
