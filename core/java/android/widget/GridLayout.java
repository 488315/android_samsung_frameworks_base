...
public class GridLayout extends ViewGroup {
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.GridLayout, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.GridLayout, attrs, a, defStyleAttr, defStyleRes);
        try {
