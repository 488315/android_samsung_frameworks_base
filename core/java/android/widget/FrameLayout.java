...
public class FrameLayout extends ViewGroup {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C4337R.styleable.FrameLayout_Layout);
    ...
    public FrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mForegroundPaddingBottom = 0;
        this.mMatchParentChildren = new ArrayList<>(1);
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.FrameLayout, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.FrameLayout, attrs, a, defStyleAttr, defStyleRes);
