  ...
  public FrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.FrameLayout, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.FrameLayout, attrs, a, defStyleAttr, defStyleRes);
      ...
      if (child.getVisibility() == 8) {
        ...
        switch (verticalGravity) {
          case 16:
            parentLeft = parentLeft2;
            childTop =
                (((((parentBottom - parentTop) - height) / 2) + parentTop) + lp.topMargin)
                    - lp.bottomMargin;
            break;
          case 48:
            parentLeft = parentLeft2;
