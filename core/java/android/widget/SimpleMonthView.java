...
class SimpleMonthView extends View {
    ...
    public SimpleMonthView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDesiredDayOfWeekHeight = res.getDimensionPixelSize(C4337R.dimen.date_picker_day_of_week_height);
        ...
        this.mDesiredDaySelectorRadius = res.getDimensionPixelSize(C4337R.dimen.date_picker_day_selector_radius);
    ...
    private ColorStateList applyTextAppearance(Paint p, int resId) {
        TypedArray ta = this.mContext.obtainStyledAttributes(null, C4337R.styleable.TextAppearance, 0, resId);
    ...
    private void initPaints(Resources res) {
        ...
        int dayOfWeekTextSize = res.getDimensionPixelSize(C4337R.dimen.date_picker_day_of_week_text_size);
