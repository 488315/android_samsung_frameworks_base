...
public class TextInputTimePickerView extends RelativeLayout {
  ...
  /* renamed from: AM */
  private static final int f620AM = 0;
  public static final int AMPM = 2;
  public static final int HOURS = 0;
  public static final int MINUTES = 1;

  /* renamed from: PM */
  private static final int f621PM = 1;
  ...
  public TextInputTimePickerView(
    ...
    inflate(context, C4337R.layout.time_picker_text_input_material, this);
    EditText editText = (EditText) findViewById(C4337R.id.input_hour);
    this.mHourEditText = editText;
    EditText editText2 = (EditText) findViewById(C4337R.id.input_minute);
    this.mMinuteEditText = editText2;
    this.mInputSeparatorView = (TextView) findViewById(C4337R.id.input_separator);
    this.mErrorLabel = (TextView) findViewById(C4337R.id.label_error);
    this.mHourLabel = (TextView) findViewById(C4337R.id.label_hour);
    this.mMinuteLabel = (TextView) findViewById(C4337R.id.label_minute);
    editText.addTextChangedListener(
        new TextWatcher() { // from class: android.widget.TextInputTimePickerView.1
          ...
          public void afterTextChanged(Editable editable) {
            if (TextInputTimePickerView.this.parseAndSetHourInternal(editable.toString())
                && editable.length() > 1) {
    ...
    Spinner spinner = (Spinner) findViewById(C4337R.id.am_pm_spinner);
    ...
    spinner.setOnItemSelectedListener(
        new AdapterView
            .OnItemSelectedListener() { // from class: android.widget.TextInputTimePickerView.3
  ...
  void updateTextInputValues(
      int localizedHour, int minute, int amOrPm, boolean is24Hour, boolean hourFormatStartsAtZero) {
