...
public class VideoView extends SurfaceView
  ...
  public VideoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    this.mSizeChangedListener =
        new MediaPlayer.OnVideoSizeChangedListener() { // from class: android.widget.VideoView.1
          ...
          public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
            ...
            if (VideoView.this.mVideoWidth != 0 && VideoView.this.mVideoHeight != 0) {
              VideoView.this
                  .getHolder()
                  .setFixedSize(VideoView.this.mVideoWidth, VideoView.this.mVideoHeight);
    ...
    this.mErrorListener =
        new MediaPlayer.OnErrorListener() { // from class: android.widget.VideoView.5
          ...
          public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            int messageId;
            Log.m94d(VideoView.TAG, "Error: " + framework_err + "," + impl_err);
            ...
            if ((VideoView.this.mOnErrorListener == null
                    || !VideoView.this.mOnErrorListener.onError(
                        VideoView.this.mMediaPlayer, framework_err, impl_err))
              ...
              new AlertDialog.Builder(VideoView.this.mContext)
                  ...
                  .setPositiveButton(
                      17039376,
                      new DialogInterface
                          .OnClickListener() { // from class: android.widget.VideoView.5.1
    ...
    this.mBufferingUpdateListener =
        new MediaPlayer.OnBufferingUpdateListener() { // from class: android.widget.VideoView.6
