...
public class RemoteViewsAdapter extends BaseAdapter implements Handler.Callback {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    try {
                        ...
                        Log.m96e(RemoteViewsAdapter.TAG, "Failed to bind remoteViewsService: " + e.getMessage());
                        return;
                    }
                case 2:
                    enqueueDeferredUnbindServiceMessage();
        ...
        private boolean sendNotifyDataSetChange(boolean always) {
            if (!always) {
                try {
                    ...
                    Log.m96e(RemoteViewsAdapter.TAG, "Error in updateNotifyDataSetChanged(): " + e.getMessage());
                    return false;
                }
            }
    ...
    static class RemoteViewsFrameLayout extends AppWidgetHostView {
        ...
        protected View getDefaultView() {
            ...
            TextView loadingTextView = (TextView) LayoutInflater.from(getContext()).inflate(C4337R.layout.remote_views_adapter_default_loading_view, (ViewGroup) this, false);
        ...
        try {
            ...
            synchronized (this.mCache) {
                if (viewTypeInRange) {
                    ...
                    Log.m96e(TAG, "Error: widget's RemoteViewsFactory returns more view types than  indicated by getViewTypeCount() ");
                }
            }
        } catch (RemoteException | RuntimeException e) {
