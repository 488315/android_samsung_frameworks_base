...
public class ProgressBar extends View {
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        initProgressBar();
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.ProgressBar, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.ProgressBar, attrs, a, defStyleAttr, defStyleRes);
        ...
        context.getTheme().resolveAttribute(C4337R.attr.parentIsDeviceDefaultDark, outValue, true);
        this.mIsDeviceDefaultDark = outValue.data != 0;
        TypedArray ta = context.obtainStyledAttributes(attrs, C4337R.styleable.SemProgressBar, defStyleAttr, defStyleRes);
        ...
        this.mIndeterminateHorizontalXsmall = getResources().getDrawable(C4337R.drawable.sem_progress_bar_indeterminate_xsmall_transition, contextThemeWrapper.getTheme());
        this.mIndeterminateHorizontalSmall = getResources().getDrawable(C4337R.drawable.sem_progress_bar_indeterminate_small_transition, contextThemeWrapper.getTheme());
        this.mIndeterminateHorizontalMedium = getResources().getDrawable(C4337R.drawable.sem_progress_bar_indeterminate_medium_transition, contextThemeWrapper.getTheme());
        this.mIndeterminateHorizontalLarge = getResources().getDrawable(C4337R.drawable.sem_progress_bar_indeterminate_large_transition, contextThemeWrapper.getTheme());
        this.mIndeterminateHorizontalXlarge = getResources().getDrawable(C4337R.drawable.sem_progress_bar_indeterminate_xlarge_transition, contextThemeWrapper.getTheme());
        ...
        public void run() {
            synchronized (ProgressBar.this) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    ProgressBar.this.doRefreshProgress(rd.f602id, rd.progress, rd.fromUser, true, rd.animate);
                    rd.recycle();
                }
        ...
        if (this.mRefreshData != null) {
            synchronized (this) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    doRefreshProgress(rd.f602id, rd.progress, rd.fromUser, true, rd.animate);
                    rd.recycle();
                }
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        if (getStateDescription() == null) {
            if (isIndeterminate()) {
                info.setStateDescription(getResources().getString(C4337R.string.in_progress));
            } else {
    ...
    public void semSetMode(int mode) {
        ...
        switch (mode) {
            case 3:
                Drawable progressDrawable = this.mContext.getDrawable(C4337R.drawable.tw_scrubber_progress_vertical_material);
                if (progressDrawable != null) {
                ...
                break;
            case 4:
                Drawable progressDrawable2 = this.mContext.getDrawable(C4337R.drawable.tw_split_seekbar_background_progress_material);
    ...
    private void initCirCleStrokeWidth(int width) {
        if (this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_size_small) == width) {
            this.mRoundStrokeWidth = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_circle_size_small_width);
            return;
        }
        if (this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_size_small_title) == width) {
            this.mRoundStrokeWidth = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_circle_size_small_title_width);
        } else if (this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_size_large) == width) {
            this.mRoundStrokeWidth = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_circle_size_large_width);
        } else {
            this.mRoundStrokeWidth = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_circle_size_normal_width);
        }
    }

    private void semSetIndeterminateProgressDrawable(int width) {
        if (getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_indeterminate_xsmall) >= width) {
            setIndeterminateDrawable(this.mIndeterminateHorizontalXsmall);
            return;
        }
        if (getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_indeterminate_small) >= width) {
            setIndeterminateDrawable(this.mIndeterminateHorizontalSmall);
            return;
        }
        if (getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_indeterminate_medium) >= width) {
            setIndeterminateDrawable(this.mIndeterminateHorizontalMedium);
        } else if (getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_indeterminate_large) >= width) {
    ...
    private void initializeRoundCicleMode() {
        ...
        CirCleProgressDrawable primaryProgress = new CirCleProgressDrawable(false, colorToColorStateList(this.mContext.getResources().getColor(C4337R.color.tw_progress_color_control_activated_light)));
        CirCleProgressDrawable background = new CirCleProgressDrawable(true, colorToColorStateList(this.mContext.getResources().getColor(C4337R.color.tw_progress_color_control_bg_light)));
