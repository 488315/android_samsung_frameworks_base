...
public class ProgressBar extends View {
  ...
  public final class InspectionCompanion
    ...
    public void readProperties(ProgressBar node, PropertyReader propertyReader) {
      ...
      propertyReader.readObject(
          this.mProgressBackgroundTintBlendModeId, node.getProgressBackgroundTintBlendMode());
      propertyReader.readObject(
      ...
      propertyReader.readObject(
          this.mSecondaryProgressTintBlendModeId, node.getSecondaryProgressTintBlendMode());
      propertyReader.readObject(
  ...
  public ProgressBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.ProgressBar, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.ProgressBar, attrs, a, defStyleAttr, defStyleRes);
    ...
    TypedArray ta =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.SemProgressBar, defStyleAttr, defStyleRes);
    ...
    this.mIndeterminateHorizontalXsmall =
        getResources()
            .getDrawable(
                C4337R.drawable.sem_progress_bar_indeterminate_xsmall_transition,
                contextThemeWrapper.getTheme());
    this.mIndeterminateHorizontalSmall =
        getResources()
            .getDrawable(
                C4337R.drawable.sem_progress_bar_indeterminate_small_transition,
                contextThemeWrapper.getTheme());
    this.mIndeterminateHorizontalMedium =
        getResources()
            .getDrawable(
                C4337R.drawable.sem_progress_bar_indeterminate_medium_transition,
                contextThemeWrapper.getTheme());
    this.mIndeterminateHorizontalLarge =
        getResources()
            .getDrawable(
                C4337R.drawable.sem_progress_bar_indeterminate_large_transition,
                contextThemeWrapper.getTheme());
    this.mIndeterminateHorizontalXlarge =
        getResources()
            .getDrawable(
                C4337R.drawable.sem_progress_bar_indeterminate_xlarge_transition,
                contextThemeWrapper.getTheme());
    ...
    if (this.mProgressTintInfo.mHasProgressTint || this.mProgressTintInfo.mHasProgressTintMode) {
      if (ViewRune.APPWIDGET_COMPLICATION) {
        ...
        if ((drawable instanceof VectorDrawable)
            && ((VectorDrawable) drawable).hasPath(SEM_PROGRESS_PATH_NAME_PRIMARY)) {
  ...
  private void applyProgressBackgroundTint() {
    if (this.mProgressTintInfo.mHasProgressBackgroundTint
      ...
      if (ViewRune.APPWIDGET_COMPLICATION) {
        Drawable drawable = this.mProgressDrawable;
        if ((drawable instanceof VectorDrawable)
            && ((VectorDrawable) drawable).hasPath(SEM_PROGRESS_PATH_NAME_BACKGROUND)) {
          this.mProgressDrawable = this.mProgressDrawable.mutate();
          if (this.mProgressTintInfo.mHasProgressBackgroundTint) {
            ((VectorDrawable) this.mProgressDrawable)
                .setPathStrokeColor(
                    SEM_PROGRESS_PATH_NAME_BACKGROUND,
                    this.mProgressTintInfo.mProgressBackgroundTintList.getDefaultColor());
            return;
          }
          return;
        }
      ...
      if (d instanceof LayerDrawable) {
        ...
        for (int i = 0; i < numStates; i++) {
          ...
          if ((mStateDrawable instanceof LayerDrawable)
              && (progressDrawable2 = ((LayerDrawable) mStateDrawable).findDrawableByLayerId(id))
                  != null
  ...
  synchronized boolean setProgressInternal(int progress, boolean fromUser, boolean animate) {
    ...
    int progress2 =
        MathUtils.constrain(progress, this.mSemMinEnabled ? this.mSemMin : this.mMin, this.mMax);
    ...
    if (this.mCurrentMode == 6
        ...
        && (drawable = ((LayerDrawable) getProgressDrawable()).findDrawableByLayerId(16908301))
            != null
    ...
    switch (mode) {
      case 3:
        Drawable progressDrawable =
            this.mContext.getDrawable(C4337R.drawable.tw_scrubber_progress_vertical_material);
        if (progressDrawable != null) {
      ...
      case 4:
        Drawable progressDrawable2 =
            this.mContext.getDrawable(
                C4337R.drawable.tw_split_seekbar_background_progress_material);
  ...
  private void initCirCleStrokeWidth(int width) {
    if (this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_size_small)
        == width) {
      this.mRoundStrokeWidth =
          this.mContext
              .getResources()
              .getDimensionPixelSize(C4337R.dimen.sem_progress_circle_size_small_width);
      return;
    }
    if (this.mContext
            .getResources()
            .getDimensionPixelSize(C4337R.dimen.sem_progress_bar_size_small_title)
        == width) {
      this.mRoundStrokeWidth =
          this.mContext
              .getResources()
              .getDimensionPixelSize(C4337R.dimen.sem_progress_circle_size_small_title_width);
    } else if (this.mContext
            .getResources()
            .getDimensionPixelSize(C4337R.dimen.sem_progress_bar_size_large)
        == width) {
      this.mRoundStrokeWidth =
          this.mContext
              .getResources()
              .getDimensionPixelSize(C4337R.dimen.sem_progress_circle_size_large_width);
    } else {
      this.mRoundStrokeWidth =
          this.mContext
              .getResources()
              .getDimensionPixelSize(C4337R.dimen.sem_progress_circle_size_normal_width);
    }
  }

  private void semSetIndeterminateProgressDrawable(int width) {
    if (getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_indeterminate_xsmall)
        >= width) {
      setIndeterminateDrawable(this.mIndeterminateHorizontalXsmall);
      return;
    }
    if (getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_indeterminate_small)
        >= width) {
      setIndeterminateDrawable(this.mIndeterminateHorizontalSmall);
      return;
    }
    if (getResources().getDimensionPixelSize(C4337R.dimen.sem_progress_bar_indeterminate_medium)
        >= width) {
      setIndeterminateDrawable(this.mIndeterminateHorizontalMedium);
    } else if (getResources()
            .getDimensionPixelSize(C4337R.dimen.sem_progress_bar_indeterminate_large)
        >= width) {
  ...
  private static class CircleAnimationCallback extends Animatable2.AnimationCallback {
    ...
    public void onAnimationEnd(Drawable drawable) {
      this.mHandler.post(
          new Runnable() { // from class: android.widget.ProgressBar.CircleAnimationCallback.1
            @Override // java.lang.Runnable
            public void run() {
    ...
    CirCleProgressDrawable primaryProgress =
        new CirCleProgressDrawable(
            ...
            colorToColorStateList(
                this.mContext
                    .getResources()
                    .getColor(C4337R.color.tw_progress_color_control_activated_light)));
    CirCleProgressDrawable background =
        new CirCleProgressDrawable(
            ...
            colorToColorStateList(
                this.mContext
                    .getResources()
                    .getColor(C4337R.color.tw_progress_color_control_bg_light)));
