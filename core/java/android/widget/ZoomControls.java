...
public class ZoomControls extends LinearLayout {
  ...
  public ZoomControls(Context context, AttributeSet attrs) {
    ...
    inflater.inflate(C4337R.layout.zoom_controls, (ViewGroup) this, true);
    this.mZoomIn = (ZoomButton) findViewById(C4337R.id.zoomIn);
    this.mZoomOut = (ZoomButton) findViewById(C4337R.id.zoomOut);
  }
