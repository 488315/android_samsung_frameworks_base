...
public class LinearLayout extends ViewGroup {
    ...
    public LinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C4337R.styleable.LinearLayout, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4337R.styleable.LinearLayout, attrs, a, defStyleAttr, defStyleRes);
                        ...
                        while (i11 < count) {
                            ...
                            if (child3 == null) {
                                ...
                                if (child3.getVisibility() == 8) {
                                    ...
                                    this.mTotalLength = Math.max(totalLength3, totalLength3 + largestChildHeight3 + i12 + lp3.bottomMargin + getNextLocationOffset(child3));
                                }
                            }
                            i3 = i2;
                            i11 = i3 + 1;
                    ...
                    if (child5 != null) {
                        ...
                        if (child5.getVisibility() == 8) {
                            ...
                            if (childWeight <= 0.0f) {
                                ...
                                heightMode3 = heightMode;
                                int childWidthMeasureSpec = getChildMeasureSpec(widthMeasureSpec, i15 + childHeight5 + lp4.leftMargin + lp4.rightMargin, lp4.width);
        ...
        while (i2 < count5) {
            ...
            if (child == null) {
                ...
                if (weightedMaxHeight8 == 8) {
                    ...
                    if (lp.weight > 0.0f) {
                        weightedMaxHeight3 = Math.max(weightedMaxHeight, childWidth3 != 0 ? margin : childHeight);
                    } else {
                        int weightedMaxHeight9 = weightedMaxHeight;
                        alternativeMaxHeight4 = Math.max(alternativeMaxHeight4, childWidth3 != 0 ? margin : childHeight);
                ...
                if (child4.getVisibility() == 8) {
                    ...
                    if (childWeight <= 0.0f) {
                        ...
                        if (this.mUseLargestChild && widthMode != 1073741824) {
                            ...
                            if (childWidth4 == 0 && (!this.mAllowInconsistentMeasurement || widthMode == 1073741824)) {
                                childWidth = share;
                            } else {
                        ...
                        widthMode4 = widthMode;
                        int childHeightMeasureSpec = getChildMeasureSpec(heightMeasureSpec, i13 + childWidth6 + lp4.topMargin + lp4.bottomMargin, lp4.height);
                    ...
                    int alternativeMaxHeight10 = Math.max(alternativeMaxHeight7, matchHeightLocally ? margin3 : childHeight2);
                    if (matchHeight) {
