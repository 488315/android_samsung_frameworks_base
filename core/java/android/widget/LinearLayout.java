...
public class LinearLayout extends ViewGroup {
  ...
  @ViewDebug.ExportedProperty(
      ...
      flagMapping = {
        ...
        @ViewDebug.FlagToString(equals = Gravity.START, mask = Gravity.START, name = "START"),
  ...
  public static class LayoutParams extends ViewGroup.MarginLayoutParams {
    ...
    public LayoutParams(Context c, AttributeSet attrs) {
      super(c, attrs);
      this.gravity = -1;
      TypedArray a = c.obtainStyledAttributes(attrs, C4337R.styleable.LinearLayout_Layout);
    ...
    public void mapProperties(PropertyMapper propertyMapper) {
      ...
      this.mOrientationId =
          propertyMapper.mapIntEnum(
              "orientation",
              16842948,
              new View$InspectionCompanion$$ExternalSyntheticLambda0(orientationEnumMapping));
  ...
  public LinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.LinearLayout, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.LinearLayout, attrs, a, defStyleAttr, defStyleRes);
  ...
  public int getBaseline() {
    ...
    if (childBaseline == -1) {
      ...
      throw new RuntimeException(
          "mBaselineAlignedChildIndex of LinearLayout points to a View that doesn't know how to get"
              + " its baseline.");
    }
    ...
    while (true) {
      ...
      if (i7 < count6) {
        ...
        if (child2 == null) {
          ...
          if (largestChildHeight8 == 8) {
            ...
            if (heightMode5 == 1073741824 && useExcessSpace) {
              ...
              this.mTotalLength =
                  Math.max(totalLength, lp2.topMargin + totalLength + lp2.bottomMargin);
              ...
              int i8 = i7;
              int i9 = totalWeight3 == 0.0f ? this.mTotalLength : 0;
              i4 = i8;
              lp = lp2;
              weightedMaxWidth2 = weightedMaxWidth4;
              count4 = count6;
              ...
              count5 = 1073741824;
              childState5 = measuredWidth;
              measureChildBeforeLayout(child2, i4, widthMeasureSpec, 0, heightMeasureSpec, i9);
            ...
            if (i5 < baselineChildIndex2 && lp.weight > 0.0f) {
              throw new RuntimeException(
                  "A child of LinearLayout with index less than mBaselineAlignedChildIndex has"
                      + " weight > 0, which won't work.  Either remove the weight, or don't set"
            ...
            int margin4 = lp.leftMargin + lp.rightMargin;
            int measuredWidth2 = child.getMeasuredWidth() + margin4;
            ...
            if (largestChildHeight4 != 0) {
              ...
              if (lp.width == -1) {
                ...
                if (lp.weight <= 0.0f) {
                  weightedMaxWidth2 =
                      Math.max(weightedMaxWidth2, matchWidthLocally2 ? margin2 : measuredWidth2);
                } else {
                  heightMode4 =
                      Math.max(heightMode4, matchWidthLocally2 ? margin2 : measuredWidth2);
                }
                int i10 = i5 + getChildrenSkipCount(child, i5);
                largestChildHeight4 = margin3;
                maxWidth = maxWidth2;
            ...
            margin3 = 0;
            if (lp.weight <= 0.0f) {}
            int i102 = i5 + getChildrenSkipCount(child, i5);
            largestChildHeight4 = margin3;
            maxWidth = maxWidth2;
            weightedMaxWidth3 = weightedMaxWidth2;
            measuredWidth = childState7;
        ...
        int heightSizeAndState =
            resolveSizeAndState(
                Math.max(heightSize, getSuggestedMinimumHeight()), heightMeasureSpec, 0);
        int heightSize2 = heightSizeAndState & 16777215;
        int remainingExcess =
            (heightSize2 - this.mTotalLength)
                + (this.mAllowInconsistentMeasurement ? 0 : consumedExcessSpace2);
        if (nonSkippedChildCount2 != 0) {
          totalWeight = totalWeight2;
          childState = measuredWidth;
        } else {
          if ((!sRemeasureWeightedChildren && remainingExcess == 0) || totalWeight2 <= 0.0f) {
              ...
              while (i13 < count) {
                ...
                if (child4 != null) {
                  ...
                  if (child4.getVisibility() == 8) {
                    ...
                    if (childExtra > 0.0f) {
                      int makeMeasureSpec =
                          View.MeasureSpec.makeMeasureSpec(child4.getMeasuredWidth(), 1073741824);
                      weightedMaxWidth = weightedMaxWidth5;
                      int weightedMaxWidth6 =
                          View.MeasureSpec.makeMeasureSpec(largestChildHeight3, 1073741824);
            ...
            if (child5.getVisibility() == 8) {
              ...
              if (childWeight <= 0.0f) {
                ...
                if (this.mUseLargestChild && heightMode != 1073741824) {
                  ...
                  if (childHeight3 == 0
                      && (!this.mAllowInconsistentMeasurement || heightMode == 1073741824)) {
                    childHeight = share;
                  } else {
                ...
                int childHeightMeasureSpec =
                    View.MeasureSpec.makeMeasureSpec(Math.max(0, childHeight), 1073741824);
                ...
                int childWidthMeasureSpec =
                    getChildMeasureSpec(
                        widthMeasureSpec,
                        i15 + childHeight5 + lp4.leftMargin + lp4.rightMargin,
                        lp4.width);
                child5.measure(childWidthMeasureSpec, childHeightMeasureSpec);
                childState2 =
                    combineMeasuredStates(childState2, child5.getMeasuredState() & (-256));
                remainingWeightSum = remainingWeightSum2;
              }
              int largestChildHeight9 = lp4.leftMargin;
              int margin5 = largestChildHeight9 + lp4.rightMargin;
              int measuredWidth3 = child5.getMeasuredWidth() + margin5;
              ...
              if (widthMode != 1073741824) {
                ...
                if (lp4.width == -1) {
                  ...
                  int alternativeMaxWidth7 =
                      Math.max(alternativeMaxWidth5, !matchWidthLocally ? margin : measuredWidth3);
                  if (largestChildHeight4 != 0 && lp4.width == -1) {
                    ...
                    this.mTotalLength =
                        Math.max(
                            totalLength4,
                            totalLength4
                                + child5.getMeasuredHeight()
                                + lp4.topMargin
                                + lp4.bottomMargin
                                + getNextLocationOffset(child5));
                    largestChildHeight4 = i;
        ...
        this.mTotalLength = i16 + this.mPaddingTop + this.mPaddingBottom;
  ...
  */
  void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (weightedMaxHeight8 == 8) {
          ...
          if (widthMode6 != 1073741824 || !useExcessSpace) {
            ...
            measureChildBeforeLayout(
                child, i2, widthMeasureSpec, largestChildWidth8, heightMeasureSpec, 0);
            ...
            if (isExactly) {
              this.mTotalLength +=
                  lp.leftMargin + childWidth2 + lp.rightMargin + getNextLocationOffset(child);
            } else {
              int totalLength = this.mTotalLength;
              this.mTotalLength =
                  Math.max(
            ...
            if (isExactly) {
              ...
              int totalLength2 = this.mTotalLength;
              this.mTotalLength =
                  Math.max(totalLength2, lp2.leftMargin + totalLength2 + lp2.rightMargin);
            }
            if (baselineAligned2) {
              int freeWidthSpec =
          ...
          if (lp.weight > 0.0f) {
            weightedMaxHeight3 =
                Math.max(weightedMaxHeight, childWidth3 != 0 ? margin : childHeight);
          } else {
            int weightedMaxHeight9 = weightedMaxHeight;
            alternativeMaxHeight4 =
                Math.max(alternativeMaxHeight4, childWidth3 != 0 ? margin : childHeight);
    ...
    if (maxAscent[1] == -1 && maxAscent[0] == -1 && maxAscent[2] == -1 && maxAscent[3] == -1) {
      ...
      int ascent =
          Math.max(maxAscent[3], Math.max(maxAscent[0], Math.max(maxAscent[1], maxAscent[2])));
      int i5 = maxDescent[3];
      int i6 = maxDescent[0];
      int i7 = maxDescent[1];
      childState = childState10;
        ...
        while (i8 < count) {
          ...
          if (child2 == null) {
            ...
            if (isExactly) {
              ...
              this.mTotalLength =
                  i9 + maxHeight4 + largestChildWidth10 + i10 + getNextLocationOffset(child2);
            } else {
              maxHeight2 = descent;
              i = i8;
    ...
    int widthSizeAndState3 =
        resolveSizeAndState(
            Math.max(this.mTotalLength, getSuggestedMinimumWidth()), widthMeasureSpec, 0);
    int widthSize2 = widthSizeAndState3 & 16777215;
    int remainingExcess5 =
        (widthSize2 - this.mTotalLength)
            + (this.mAllowInconsistentMeasurement ? 0 : usedExcessSpace);
    if (largestChildWidth6 != 0) {
      totalWeight = totalWeight2;
      remainingExcess = remainingExcess5;
    } else {
      if ((!sRemeasureWeightedChildren && remainingExcess5 == 0) || totalWeight2 <= 0.0f) {
            ...
            if (child3 != null) {
              ...
              if (alternativeMaxHeight9 == 8) {
                ...
                if (childExtra > 0.0f) {
                  remainingExcess4 = remainingExcess5;
                  child3.measure(
                      View.MeasureSpec.makeMeasureSpec(largestChildWidth10, 1073741824),
                      View.MeasureSpec.makeMeasureSpec(child3.getMeasuredHeight(), 1073741824));
                } else {
                  remainingExcess4 = remainingExcess5;
                }
              }
        ...
        setMeasuredDimension(
            widthSizeAndState | ((-16777216) & childState2),
            resolveSizeAndState(
                Math.max(
        ...
        if (child4.getVisibility() == 8) {
          ...
          if (childWeight <= 0.0f) {
            ...
            if (this.mUseLargestChild && widthMode != 1073741824) {
              ...
              int childWidth4 = lp4.width;
              if (childWidth4 == 0
                  && (!this.mAllowInconsistentMeasurement || widthMode == 1073741824)) {
                childWidth = share;
              } else {
                int childWidth5 = child4.getMeasuredWidth();
                childWidth = childWidth5 + share;
              }
            }
            largestChildWidth = largestChildWidth10;
            int childWidthMeasureSpec =
                View.MeasureSpec.makeMeasureSpec(Math.max(0, childWidth), 1073741824);
            int i13 = this.mPaddingTop;
            int childWidth6 = this.mPaddingBottom;
            widthMode4 = widthMode;
            int childHeightMeasureSpec =
                getChildMeasureSpec(
                    heightMeasureSpec,
                    i13 + childWidth6 + lp4.topMargin + lp4.bottomMargin,
                    lp4.height);
            child4.measure(childWidthMeasureSpec, childHeightMeasureSpec);
            childState2 =
                combineMeasuredStates(childState2, child4.getMeasuredState() & (-16777216));
            largestChildWidth3 = remainingExcess7;
            remainingWeightSum2 = remainingWeightSum3;
          }
          if (isExactly) {
            this.mTotalLength +=
                child4.getMeasuredWidth()
                    + lp4.leftMargin
                    + lp4.rightMargin
                    + getNextLocationOffset(child4);
            remainingWeightSum = remainingWeightSum2;
          } else {
            int totalLength3 = this.mTotalLength;
            remainingWeightSum = remainingWeightSum2;
          ...
          int alternativeMaxHeight10 =
              Math.max(alternativeMaxHeight7, matchHeightLocally ? margin3 : childHeight2);
          if (matchHeight) {
    ...
    if (maxAscent[1] == -1 && maxAscent[0] == -1 && maxAscent[2] == -1 && maxAscent[3] == -1) {
      ...
      int ascent2 =
          Math.max(maxAscent[3], Math.max(maxAscent[0], Math.max(maxAscent[1], maxAscent[2])));
      int descent3 =
          Math.max(maxDescent[3], Math.max(maxDescent[0], Math.max(maxDescent[1], maxDescent[2])));
    ...
    while (i2 < count2) {
      ...
      if (child == null) {
        ...
        if (i4 == 8) {
            ...
            if (lp.height != -1) {
              ...
              switch (gravity2 & 112) {
                case 16:
                  childBottom = childBottom2;
                  int childTop2 =
                      ((((childSpace - childHeight) / 2) + paddingTop2) + lp.topMargin)
                          - lp.bottomMargin;
                  childTop = childTop2;
                  break;
                case 48:
              ...
              int childLeft6 =
                  childLeft4 + childWidth + lp.rightMargin + getNextLocationOffset(child);
          ...
          int childLeft62 =
              childLeft42 + childWidth + lp.rightMargin + getNextLocationOffset(child);
          i2 = i3 + getChildrenSkipCount(child, childIndex);
