...
public class TableRow extends LinearLayout {
  ...
  public static class LayoutParams extends LinearLayout.LayoutParams {
    ...
    public LayoutParams(Context c, AttributeSet attrs) {
      ...
      TypedArray a = c.obtainStyledAttributes(attrs, C4337R.styleable.TableRow_Cell);
  ...
  void measureChildBeforeLayout(
    ...
    if (this.mConstrainedColumnWidths != null) {
      ...
      int childHeightMeasureSpec =
          getChildMeasureSpec(
              heightMeasureSpec,
              this.mPaddingTop + this.mPaddingBottom + lp.topMargin + lp.bottomMargin + totalHeight,
              lp.height);
