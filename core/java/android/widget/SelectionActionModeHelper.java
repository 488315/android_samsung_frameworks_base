...
public class SelectionActionModeHelper {
  ...
  SelectionActionModeHelper(Editor editor) {
    ...
    this.mTextClassificationHelper =
        new TextClassificationHelper(
            context,
            new SelectionActionModeHelper$$ExternalSyntheticLambda3(textView),
            getText(textView),
            0,
            1,
  ...
  public void startSelectionActionModeAsync(boolean adjustSelection) {
    SelectionActionModeHelper$$ExternalSyntheticLambda0
        selectionActionModeHelper$$ExternalSyntheticLambda0;
    Consumer consumer;
    ...
    this.mSelectionTracker.onOriginalSelection(
        getText(this.mTextView), sortedSelectionIndices[0], sortedSelectionIndices[1], false);
    cancelAsyncTask();
    ...
    if (adjustSelection2) {
      ...
      selectionActionModeHelper$$ExternalSyntheticLambda0 =
          new Supplier() { // from class:
                           // android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda10
      ...
      selectionActionModeHelper$$ExternalSyntheticLambda0 =
          new SelectionActionModeHelper$$ExternalSyntheticLambda0(textClassificationHelper2);
    }
      ...
      consumer =
          new Consumer() { // from class:
            ...
            public final void accept(Object obj) {
              SelectionActionModeHelper.this.startSelectionActionModeWithSmartSelectAnimation(
    ...
    this.mTextClassificationAsyncTask =
        new TextClassificationAsyncTask(
                ...
                selectionActionModeHelper$$ExternalSyntheticLambda0,
                consumer,
                new SelectionActionModeHelper$$ExternalSyntheticLambda2(textClassificationHelper3))
            .execute(new Void[0]);
  }
  ...
  public void startLinkActionModeAsync(int start, int end) {
    ...
    SelectionActionModeHelper$$ExternalSyntheticLambda0
        selectionActionModeHelper$$ExternalSyntheticLambda0 =
            new SelectionActionModeHelper$$ExternalSyntheticLambda0(textClassificationHelper);
    Consumer consumer =
        new Consumer() { // from class:
                         // android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda6
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
    ...
    this.mTextClassificationAsyncTask =
        new TextClassificationAsyncTask(
                ...
                selectionActionModeHelper$$ExternalSyntheticLambda0,
                consumer,
                new SelectionActionModeHelper$$ExternalSyntheticLambda2(textClassificationHelper2))
            .execute(new Void[0]);
  }
  ...
  public void invalidateActionModeAsync() {
    ...
    Consumer consumer =
        new Consumer() { // from class:
                         // android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void onSelectionDrag() {
    int[] sortedSelectionIndices = sortSelectionIndicesFromTextView(this.mTextView);
    this.mSelectionTracker.onSelectionAction(
        sortedSelectionIndices[0], sortedSelectionIndices[1], 106, null, this.mTextClassification);
  }
  ...
  public void startSelectionActionModeWithSmartSelectAnimation(final SelectionResult result) {
    ...
    PointF animationStartPoint =
        movePointInsideNearestRectangle(
            touchPoint,
            selectionRectangles,
            new SelectionActionModeHelper$$ExternalSyntheticLambda5());
            ...
            SelectionActionModeHelper.mergeRectangleIntoList(
                ...
                new Function() { // from class:
                  ...
                  public final Object apply(Object obj) {
                    return SelectionActionModeHelper.lambda$convertSelectionToRectangles$1(
                        i, (RectF) obj);
                  }
                });
          }
  ...
  public static <T> void mergeRectangleIntoList(
      List<T> list, RectF candidate, Function<T, RectF> extractor, Function<RectF, T> packer) {
    ...
    for (int index = 0; index < elementCount; index++) {
      ...
      if (candidate.contains(existingRectangle)) {
        ...
        boolean rectanglesContinueEachOther =
            candidate.left == existingRectangle.right || candidate.right == existingRectangle.left;
        if (candidate.top == existingRectangle.top
            && candidate.bottom == existingRectangle.bottom
            && (RectF.intersects(candidate, existingRectangle) || rectanglesContinueEachOther)) {
          canMerge = true;
        }
        if (canMerge) {
  ...
  public static <T> PointF movePointInsideNearestRectangle(
    ...
    for (int index = 0; index < elementCount; index++) {
      ...
      if (point.f87x > rectangle.right) {
        candidateX = rectangle.right;
      } else {
        float candidateX2 = point.f87x;
        if (candidateX2 < rectangle.left) {
          candidateX = rectangle.left;
        } else {
          candidateX = point.f87x;
        }
      }
      double candidateDistance =
          Math.pow(point.f87x - candidateX, 2.0d) + Math.pow(point.f88y - candidateY, 2.0d);
  ...
  private static final class SelectionTracker {
    ...
    private void onClassifiedSelection(SelectionResult result) {
      if (isSelectionStarted()) {
        ...
        this.mAllowReset =
            (this.mSelectionStart == this.mOriginalStart && i == this.mOriginalEnd) ? false : true;
      }
    }
  ...
  private static final class SelectionMetricsLogger {
    ...
    public void logSelectionStarted(
      ...
      try {
        ...
        Log.m97e(LOG_TAG, "" + e.getMessage(), e);
      }
    }
      ...
      try {
        if (hasActiveClassificationSession()) {
          ...
          if (selection != null) {
            ...
            this.mClassificationSession.onSelectionEvent(
                SelectionEvent.createSelectionModifiedEvent(wordIndices[0], wordIndices[1]));
          }
    ...
    public void logSelectionAction(
        int start, int end, int action, String actionLabel, TextClassification classification) {
      try {
        if (hasActiveClassificationSession()) {
          Preconditions.checkArgumentInRange(start, 0, this.mText.length(), "start");
          Preconditions.checkArgumentInRange(end, start, this.mText.length(), "end");
          ...
          if (classification != null) {
            ...
            this.mClassificationSession.onSelectionEvent(
                SelectionEvent.createSelectionActionEvent(wordIndices[0], wordIndices[1], action));
          }
    ...
    private int[] getWordDelta(int start, int end) {
      ...
      if (start == i) {
        ...
        if (!this.mTokenIterator.isBoundary(start)
            && !isWhitespace(
                this.mTokenIterator.preceding(start), this.mTokenIterator.following(start))) {
    ...
    private void maybeGenerateTranslateViewEvent(TextClassification classification) {
      if (classification != null) {
        TextClassifierEvent event =
            generateTranslateEvent(6, classification, this.mClassificationContext, null);
    ...
    private void maybeGenerateTranslateClickEvent(
      ...
      if (classification != null) {
        this.mTranslateClickEvent =
            generateTranslateEvent(13, classification, this.mClassificationContext, actionLabel);
      }
    }
  ...
  static final class TextClassificationAsyncTask extends AsyncTask<Void, Void, SelectionResult> {
    ...
    public void onTimeOut() {
      Log.m94d(SelectionActionModeHelper.LOG_TAG, "Timeout in TextClassificationAsyncTask");
  ...
  static final class TextClassificationHelper {
    ...
    public SelectionResult suggestSelection() {
      ...
      if (!isDarkLaunchEnabled()) {
        ...
        this.mSelectionEnd =
            Math.min(this.mText.length(), selection.getSelectionEndIndex() + this.mTrimStart);
      }
    ...
    private SelectionResult performClassification(TextSelection selection) {
      ...
      if (!Objects.equals(this.mText, this.mLastClassificationText)
        ...
        this.mLastClassificationResult =
            new SelectionResult(
                this.mSelectionStart, this.mSelectionEnd, classification, selection);
      }
    ...
    private void trimText() {
      int trimDelta =
          Math.min(
              TextClassificationManager.getSettings(this.mContext).getSmartSelectionTrimDelta(),
              240);
