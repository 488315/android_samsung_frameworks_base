        ...
        try {
            ...
            switch (this.mLayoutMode) {
                ...
                case 3:
                    ...
                    focusLayoutRestoreDirectChild3 = focusLayoutRestoreDirectChild2;
                    delta2 = accessibilityFocusPosition;
                    sel = this.mIsRTL ? fillRightRTL(this.mItemCount - 1, childrenLeft) : fillLeft(this.mItemCount - 1, childrenRight);
                    adjustViewsLeftOrRight();
                    break;
                case 4:
                    recycleBin = recycleBin2;
                    ...
                    if (childCount != 0) {
                        if (!this.mIsRTL) {
                            if (this.mSelectedPosition >= 0 && this.mSelectedPosition < this.mItemCount) {
                                sel = fillSpecific(this.mSelectedPosition, oldSel == null ? childrenLeft : oldSel.getLeft());
                                break;
                            } else if (this.mFirstPosition >= this.mItemCount) {
                                sel = fillSpecific(0, childrenLeft);
                                break;
                            } else {
                                sel = fillSpecific(this.mFirstPosition, oldFirst == null ? childrenLeft : oldFirst.getLeft());
                                break;
                            }
                        } else if (this.mSelectedPosition >= 0 && this.mSelectedPosition < this.mItemCount) {
                            sel = fillSpecificRTL(this.mSelectedPosition, oldSel == null ? childrenRight : oldSel.getRight());
                            break;
                        } else if (this.mFirstPosition >= this.mItemCount) {
                            sel = fillSpecificRTL(0, childrenRight);
                            break;
                        } else {
                            sel = fillSpecificRTL(this.mFirstPosition, oldFirst == null ? childrenRight : oldFirst.getRight());
                            break;
                        }
                    } else if (!this.mIsRTL) {
                        if (!this.mStackFromBottom) {
