...
public class RelativeLayout extends ViewGroup {
  ...
  private void initFromAttributes(
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, C4337R.styleable.RelativeLayout, defStyleAttr, defStyleRes);
    saveAttributeDataForStyleable(
        context, C4337R.styleable.RelativeLayout, attrs, a, defStyleAttr, defStyleRes);
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (horizontalGravity || verticalGravity) {
      ...
      Gravity.apply(
          this.mGravity, i5 - left, bottom3 - top2, selfBounds, contentBounds, layoutDirection);
    ...
    if (myHeight < 0 && !this.mAllowBrokenMeasureSpecs) {
      ...
      if (this.mMeasureVerticalWithPaddingMargin) {
        maxHeight =
            Math.max(
                0,
                (((myHeight - this.mPaddingTop) - this.mPaddingBottom) - params.topMargin)
                    - params.bottomMargin);
      } else {
  ...
  public static class LayoutParams extends ViewGroup.MarginLayoutParams {
    ...
    @ViewDebug.ExportedProperty(
        ...
        indexMapping = {
          @ViewDebug.IntToString(from = 2, m158to = "above"),
          @ViewDebug.IntToString(from = 4, m158to = "alignBaseline"),
          @ViewDebug.IntToString(from = 8, m158to = "alignBottom"),
          @ViewDebug.IntToString(from = 5, m158to = "alignLeft"),
          @ViewDebug.IntToString(from = 12, m158to = "alignParentBottom"),
          @ViewDebug.IntToString(from = 9, m158to = "alignParentLeft"),
          @ViewDebug.IntToString(from = 11, m158to = "alignParentRight"),
          @ViewDebug.IntToString(from = 10, m158to = "alignParentTop"),
          @ViewDebug.IntToString(from = 7, m158to = "alignRight"),
          @ViewDebug.IntToString(from = 6, m158to = "alignTop"),
          @ViewDebug.IntToString(from = 3, m158to = "below"),
          @ViewDebug.IntToString(from = 14, m158to = "centerHorizontal"),
          @ViewDebug.IntToString(from = 13, m158to = "center"),
          @ViewDebug.IntToString(from = 15, m158to = "centerVertical"),
          @ViewDebug.IntToString(from = 0, m158to = "leftOf"),
          @ViewDebug.IntToString(from = 1, m158to = "rightOf"),
          @ViewDebug.IntToString(from = 18, m158to = "alignStart"),
          @ViewDebug.IntToString(from = 19, m158to = "alignEnd"),
          @ViewDebug.IntToString(from = 20, m158to = "alignParentStart"),
          @ViewDebug.IntToString(from = 21, m158to = "alignParentEnd"),
          @ViewDebug.IntToString(from = 16, m158to = "startOf"),
          @ViewDebug.IntToString(from = 17, m158to = "endOf")
        },
        mapping = {
          @ViewDebug.IntToString(from = -1, m158to = "true"),
          @ViewDebug.IntToString(from = 0, m158to = "false/NO_ID")
        },
        resolveId = true)
    private int[] mRules;
    ...
    public LayoutParams(Context c, AttributeSet attrs) {
      ...
      TypedArray a = c.obtainStyledAttributes(attrs, C4337R.styleable.RelativeLayout_Layout);
