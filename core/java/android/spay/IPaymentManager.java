          ...
          switch (code) {
            case 1:
              PaymentTZServiceConfig _arg0 =
                  (PaymentTZServiceConfig) data.readTypedObject(PaymentTZServiceConfig.CREATOR);
      ...
      public PaymentTZServiceCommnInfo registerSPayFW(PaymentTZServiceConfig config)
        ...
        try {
          ...
          PaymentTZServiceCommnInfo _result =
              (PaymentTZServiceCommnInfo) _reply.readTypedObject(PaymentTZServiceCommnInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
