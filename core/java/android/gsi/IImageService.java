...
public interface IImageService extends IInterface {
  ...
  public static class Default implements IImageService {
    ...
    public void createBackingImage(String name, long size, int flags, IProgressCallback on_progress)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IImageService {
    ...
    private static class Proxy implements IImageService {
      ...
      public void createBackingImage(
          String name, long size, int flags, IProgressCallback on_progress) throws RemoteException {
