...
public class Short4 {
    ...
    public short dotProduct(Short4 a) {
        return (short) ((this.f424x * a.f424x) + (this.f425y * a.f425y) + (this.f426z * a.f426z) + (this.f423w * a.f423w));
    }

    public static short dotProduct(Short4 a, Short4 b) {
        return (short) ((b.f424x * a.f424x) + (b.f425y * a.f425y) + (b.f426z * a.f426z) + (b.f423w * a.f423w));
    }
