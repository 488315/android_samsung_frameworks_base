...
public final class ScriptIntrinsicResize extends ScriptIntrinsic {
    ...
    public void setInput(Allocation ain) {
        ...
        if (!e.isCompatible(Element.m58U8(this.mRS)) && !e.isCompatible(Element.U8_2(this.mRS)) && !e.isCompatible(Element.U8_3(this.mRS)) && !e.isCompatible(Element.U8_4(this.mRS)) && !e.isCompatible(Element.F32(this.mRS)) && !e.isCompatible(Element.F32_2(this.mRS)) && !e.isCompatible(Element.F32_3(this.mRS)) && !e.isCompatible(Element.F32_4(this.mRS))) {
