...
public class ProgramFragmentFixedFunction extends ProgramFragment {
  ...
  static class InternalBuilder extends Program.BaseProgramBuilder {
    ...
    public ProgramFragmentFixedFunction create() {
      ...
      long[] tmp =
          new long
              [(this.mInputCount + this.mOutputCount + this.mConstantCount + this.mTextureCount)
                  * 2];
  ...
  public static class Builder {
    ...
    private void buildShaderString() {
      ...
      for (int i = 0; i < this.mNumTextures; i++) {
        switch (C25241.f416x21e46749[this.mSlots[i].env.ordinal()]) {
          case 1:
            switch (C25241.f417xa802c1be[this.mSlots[i].format.ordinal()]) {
              case 1:
  ...
  static /* synthetic */ class C25241 {
    ...
    static {
      ...
      try {
        f416x21e46749[Builder.EnvMode.MODULATE.ordinal()] = 2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        f416x21e46749[Builder.EnvMode.DECAL.ordinal()] = 3;
      ...
      try {
        f417xa802c1be[Builder.Format.LUMINANCE_ALPHA.ordinal()] = 2;
      } catch (NoSuchFieldError e5) {
      }
      try {
        f417xa802c1be[Builder.Format.RGB.ordinal()] = 3;
      } catch (NoSuchFieldError e6) {
      }
      try {
        f417xa802c1be[Builder.Format.RGBA.ordinal()] = 4;
