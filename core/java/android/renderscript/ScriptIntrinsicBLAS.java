...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
  ...
  static void validateGEMV(
      Element e, int TransA, Allocation A, Allocation X, int incX, Allocation Y, int incY) {
    int expectedXDim;
    int expectedYDim;
  ...
  public void SGEMV(
    ...
    int M = A.getType().getY();
    int N = A.getType().getX();
    this.mRS.nScriptIntrinsicBLAS_Single(
        getID(this.mRS),
        47,
        TransA,
        0,
  ...
  public void DGEMV(
    ...
    int M = A.getType().getY();
    int N = A.getType().getX();
    this.mRS.nScriptIntrinsicBLAS_Double(
        getID(this.mRS),
        55,
        TransA,
        0,
  ...
  public void CGEMV(
    ...
    int M = A.getType().getY();
    int N = A.getType().getX();
    this.mRS.nScriptIntrinsicBLAS_Complex(
        getID(this.mRS),
        63,
        TransA,
        0,
  ...
  static void validateTRMV(
      Element e, int Uplo2, int TransA, int Diag2, Allocation A, Allocation X, int incX) {
    validateTranspose(TransA);
    validateUplo(Uplo2);
    validateDiag(Diag2);
  ...
  static int validateTPMV(
      Element e, int Uplo2, int TransA, int Diag2, Allocation Ap, Allocation X, int incX) {
    validateTranspose(TransA);
    validateUplo(Uplo2);
    validateDiag(Diag2);
  ...
  static int validateSYMV(
      Element e, int Uplo2, Allocation A, Allocation X, Allocation Y, int incX, int incY) {
    validateUplo(Uplo2);
    int N = A.getType().getY();
    if (A.getType().getX() != N) {
  ...
  static int validateSPMV(
      Element e, int Uplo2, Allocation Ap, Allocation X, int incX, Allocation Y, int incY) {
    validateUplo(Uplo2);
  ...
  static int validateSYR2(
      Element e, int Uplo2, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
    validateUplo(Uplo2);
    if (!A.getType().getElement().isCompatible(e)
        || !X.getType().getElement().isCompatible(e)
        || !Y.getType().getElement().isCompatible(e)) {
  ...
  static int validateSPR2(
      Element e, int Uplo2, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
    validateUplo(Uplo2);
    if (!Ap.getType().getElement().isCompatible(e)
        || !X.getType().getElement().isCompatible(e)
        || !Y.getType().getElement().isCompatible(e)) {
  ...
  public void SSYR2(
      int Uplo2, float alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
  ...
  public void SSPR2(
      int Uplo2, float alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
  ...
  public void DSYR2(
      int Uplo2, double alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
  ...
  public void DSPR2(
      int Uplo2, double alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
  ...
  static void validateGERU(
      Element e, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
    if (!A.getType().getElement().isCompatible(e)
        || !X.getType().getElement().isCompatible(e)
        || !Y.getType().getElement().isCompatible(e)) {
      throw new RSRuntimeException("Called BLAS with wrong Element type");
  ...
  public void CHER2(
      int Uplo2, Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
    int N = validateSYR2(Element.F32_2(this.mRS), Uplo2, X, incX, Y, incY, A);
    this.mRS.nScriptIntrinsicBLAS_Complex(
        getID(this.mRS),
        102,
  ...
  public void CHPR2(
      int Uplo2, Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
    int N = validateSPR2(Element.F32_2(this.mRS), Uplo2, X, incX, Y, incY, Ap);
    this.mRS.nScriptIntrinsicBLAS_Complex(
        getID(this.mRS),
        103,
  ...
  public void ZHER2(
      int Uplo2, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
    int N = validateSYR2(Element.F64_2(this.mRS), Uplo2, X, incX, Y, incY, A);
    this.mRS.nScriptIntrinsicBLAS_Z(
        getID(this.mRS),
        111,
  ...
  public void ZHPR2(
      int Uplo2, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
    int N = validateSPR2(Element.F64_2(this.mRS), Uplo2, X, incX, Y, incY, Ap);
    this.mRS.nScriptIntrinsicBLAS_Z(
        getID(this.mRS),
        112,
  ...
  static void validateL3(
      Element e, int TransA, int TransB, int Side2, Allocation A, Allocation B, Allocation C) {
    int aM = -1;
    int aN = -1;
    int bM = -1;
    int bN = -1;
  ...
  public void SGEMM(
      int TransA, int TransB, float alpha, Allocation A, Allocation B, float beta, Allocation C) {
    int M;
    int K;
    int N;
    validateTranspose(TransA);
  ...
  public void DGEMM(
      int TransA, int TransB, double alpha, Allocation A, Allocation B, double beta, Allocation C) {
    int M;
    int K;
    int N;
    validateTranspose(TransA);
  ...
  public void CGEMM(
      int TransA, int TransB, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
    int M;
    int K;
    int N;
    validateTranspose(TransA);
  ...
  public void SSYMM(
      int Side2, int Uplo2, float alpha, Allocation A, Allocation B, float beta, Allocation C) {
    validateSide(Side2);
    validateUplo(Uplo2);
  ...
  public void DSYMM(
      int Side2, int Uplo2, double alpha, Allocation A, Allocation B, double beta, Allocation C) {
    validateSide(Side2);
    validateUplo(Uplo2);
    if (A.getType().getX() != A.getType().getY()) {
      throw new RSRuntimeException("Matrix A is not symmetric");
  ...
  public void CSYMM(
      int Side2, int Uplo2, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
    validateSide(Side2);
    validateUplo(Uplo2);
    if (A.getType().getX() != A.getType().getY()) {
      throw new RSRuntimeException("Matrix A is not symmetric");
  ...
  public void ZSYMM(
      int Side2, int Uplo2, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
    validateSide(Side2);
    validateUplo(Uplo2);
    if (A.getType().getX() != A.getType().getY()) {
      throw new RSRuntimeException("Matrix A is not symmetric");
  ...
  public void SSYR2K(
      int Uplo2, int Trans, float alpha, Allocation A, Allocation B, float beta, Allocation C) {
    int K;
    validateUplo(Uplo2);
  ...
  public void DSYR2K(
      int Uplo2, int Trans, double alpha, Allocation A, Allocation B, double beta, Allocation C) {
    int K;
    validateUplo(Uplo2);
  ...
  public void CSYR2K(
      int Uplo2, int Trans, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
    int K;
    validateUplo(Uplo2);
  ...
  public void ZSYR2K(
      int Uplo2, int Trans, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
    int K;
    validateUplo(Uplo2);
  ...
  public void STRMM(
      int Side2, int Uplo2, int TransA, int Diag2, float alpha, Allocation A, Allocation B) {
    validateUplo(Uplo2);
    validateDiag(Diag2);
  ...
  public void DTRMM(
      int Side2, int Uplo2, int TransA, int Diag2, double alpha, Allocation A, Allocation B) {
    validateUplo(Uplo2);
    validateDiag(Diag2);
  ...
  public void CTRMM(
      int Side2, int Uplo2, int TransA, int Diag2, Float2 alpha, Allocation A, Allocation B) {
    validateUplo(Uplo2);
    validateDiag(Diag2);
  ...
  public void ZTRMM(
      int Side2, int Uplo2, int TransA, int Diag2, Double2 alpha, Allocation A, Allocation B) {
    validateUplo(Uplo2);
    validateDiag(Diag2);
  ...
  static void validateHEMM(Element e, int Side2, Allocation A, Allocation B, Allocation C) {
    ...
    if ((Side2 == 141 && adim != B.getType().getY())
        || (Side2 == 142 && adim != B.getType().getX())) {
  ...
  public void CHER2K(
      int Uplo2, int Trans, Float2 alpha, Allocation A, Allocation B, float beta, Allocation C) {
    int k;
    validateUplo(Uplo2);
  ...
  public void ZHER2K(
      int Uplo2, int Trans, Double2 alpha, Allocation A, Allocation B, double beta, Allocation C) {
    int k;
    validateUplo(Uplo2);
  ...
  public void BNNM(
    ...
    this.mRS.nScriptIntrinsicBLAS_BNNM(
        getID(this.mRS),
        M,
        N,
        K,
