...
public final class ScriptIntrinsicHistogram extends ScriptIntrinsic {
    ...
    public static ScriptIntrinsicHistogram create(RenderScript rs, Element e) {
        if (!e.isCompatible(Element.U8_4(rs)) && !e.isCompatible(Element.U8_3(rs)) && !e.isCompatible(Element.U8_2(rs)) && !e.isCompatible(Element.m58U8(rs))) {
    ...
    public void forEach(Allocation ain, Script.LaunchOptions opt) {
        ...
        if (!ain.getType().getElement().isCompatible(Element.m58U8(this.mRS)) && !ain.getType().getElement().isCompatible(Element.U8_2(this.mRS)) && !ain.getType().getElement().isCompatible(Element.U8_3(this.mRS)) && !ain.getType().getElement().isCompatible(Element.U8_4(this.mRS))) {
