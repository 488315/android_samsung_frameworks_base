...
public class Mesh extends BaseObj {
  ...
  public static class Builder {
    ...
    public Builder addVertexType(Type t) throws IllegalStateException {
      ...
      this.mVertexTypes[this.mVertexTypeCount].f411t = t;
      this.mVertexTypes[this.mVertexTypeCount].f410e = null;
    ...
    public Builder addVertexType(Element e, int size) throws IllegalStateException {
      ...
      entryArr[i] = new Entry();
      this.mVertexTypes[this.mVertexTypeCount].f411t = null;
      this.mVertexTypes[this.mVertexTypeCount].f410e = e;
    ...
    public Mesh create() {
      ...
      for (int ct = 0; ct < this.mVertexTypeCount; ct++) {
        ...
        if (entry.f411t != null) {
          alloc2 = Allocation.createTyped(this.mRS, entry.f411t, this.mUsage);
        } else if (entry.f410e != null) {
          alloc2 = Allocation.createSized(this.mRS, entry.f410e, entry.size, this.mUsage);
        } else {
      ...
      for (int ct2 = 0; ct2 < this.mIndexTypes.size(); ct2++) {
        ...
        if (entry2.f411t != null) {
          alloc = Allocation.createTyped(this.mRS, entry2.f411t, this.mUsage);
        } else if (entry2.f410e != null) {
          alloc = Allocation.createSized(this.mRS, entry2.f410e, entry2.size, this.mUsage);
        } else {
          throw new IllegalStateException("Builder corrupt, no valid element in entry.");
        }
  ...
  public static class AllocationBuilder {
    ...
    public AllocationBuilder addVertexAllocation(Allocation a) throws IllegalStateException {
      ...
      entryArr[i] = new Entry();
      this.mVertexTypes[this.mVertexTypeCount].f409a = a;
      this.mVertexTypeCount++;
      return this;
    }
    ...
    public Mesh create() {
      ...
      for (int ct = 0; ct < this.mVertexTypeCount; ct++) {
        Entry entry = this.mVertexTypes[ct];
        vertexBuffers[ct] = entry.f409a;
        vtx[ct] = entry.f409a.getID(this.mRS);
      }
      for (int ct2 = 0; ct2 < this.mIndexTypes.size(); ct2++) {
        Entry entry2 = (Entry) this.mIndexTypes.elementAt(ct2);
        long allocID = entry2.f409a == null ? 0L : entry2.f409a.getID(this.mRS);
        indexBuffers[ct2] = entry2.f409a;
        primitives[ct2] = entry2.prim;
        idx[ct2] = allocID;
        prim[ct2] = entry2.prim.mID;
      }
