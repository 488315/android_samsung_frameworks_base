...
import android.p010se.omapi.ISecureElementListener;
import android.p010se.omapi.ISecureElementService;
...
public final class SEService {
    ...
    private class SEListener extends ISecureElementListener.Stub {
        ...
        @Override // android.se.omapi.ISecureElementListener.Stub, android.p009os.IInterface
    ...
    public SEService(Context context, Executor executor, OnConnectedListener listener) {
        ...
        this.mConnection = new ServiceConnection() { // from class: android.se.omapi.SEService.1
            ...
            public synchronized void onServiceConnected(ComponentName className, IBinder service) {
                ...
                Log.m98i(SEService.TAG, "Service onServiceConnected");
            }

            @Override // android.content.ServiceConnection
            public void onServiceDisconnected(ComponentName className) {
                SEService.this.mSecureElementService = null;
                Log.m98i(SEService.TAG, "Service onServiceDisconnected");
            }
        };
        ...
        if (bindingSuccessful) {
            Log.m98i(TAG, "bindService successful");
        }
    }
            ...
            for (String readerName : readerNames) {
                if (this.mReaders.get(readerName) == null) {
                    try {
                        ...
                        Log.m97e(TAG, "Error adding Reader: " + readerName, e);
                    }
                }
            }
