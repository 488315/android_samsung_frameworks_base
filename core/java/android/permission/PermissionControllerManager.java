...
public final class PermissionControllerManager {
    ...
    static /* synthetic */ CompletableFuture lambda$revokeSelfPermissionsOnKill$38(String packageName, List permissions, IPermissionController service) throws Exception {
        AndroidFuture<Void> callback = new AndroidFuture<>();
        service.revokeSelfPermissionsOnKill(packageName, permissions, callback);
        return callback;
    }

    static /* synthetic */ void lambda$revokeSelfPermissionsOnKill$39(List permissions, String packageName, Void result, Throwable err) {
        if (err != null) {
            Log.m97e(TAG, "Failed to self revoke " + String.join(",", permissions) + " for package " + packageName, err);
        }
    }
}
