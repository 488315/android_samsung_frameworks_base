...
public final class PermissionControllerManager {
    ...
    synchronized (sLock) {
      try {
        Pair<Integer, Thread> key =
            new Pair<>(Integer.valueOf(context.getUserId()), handler.getLooper().getThread());
        ...
        if (remoteService == null) {
          ...
          if (serviceInfo == null) {
            String errorMsg =
                "No PermissionController package (" + pkgName + ") for user " + context.getUserId();
            ...
            new ServiceConnector
              ...
              public final Object run(Object obj) {
                ...
                lambda$revokeRuntimePermissions$0 =
                    PermissionControllerManager.this.lambda$revokeRuntimePermissions$0(
                        request, doDryRun, reason, (IPermissionController) obj);
            ...
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$revokeRuntimePermissions$1(
                        PermissionControllerManager.OnRevokeRuntimePermissionsCallback.this,
                        (Map) obj,
                        (Throwable) obj2);
                  }
                },
  ...
  public /* synthetic */ CompletableFuture lambda$revokeRuntimePermissions$0(
      Map request, boolean doDryRun, int reason, IPermissionController service) throws Exception {
  ...
  static /* synthetic */ void lambda$revokeRuntimePermissions$1(
    ...
    try {
      if (err != null) {
        Log.m97e(TAG, "Failure when revoking runtime permissions " + revoked, err);
              ...
              public final Object run(Object obj) {
                return PermissionControllerManager
                    .lambda$setRuntimePermissionGrantStateByDeviceAdmin$2(
                        callerPackageName, params, (IPermissionController) obj);
              }
            })
        .whenCompleteAsync(
            (BiConsumer<? super R, ? super Throwable>)
                  ...
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager
                        .lambda$setRuntimePermissionGrantStateByDeviceAdmin$3(
                            callerPackageName, callback, (Boolean) obj, (Throwable) obj2);
                  }
                },
            executor);
  }
  ...
  static /* synthetic */ CompletableFuture lambda$setRuntimePermissionGrantStateByDeviceAdmin$2(
      String callerPackageName, AdminPermissionControlParams params, IPermissionController service)
      throws Exception {
  ...
  static /* synthetic */ void lambda$setRuntimePermissionGrantStateByDeviceAdmin$3(
    ...
    try {
      if (err != null) {
        Log.m97e(TAG, "Error setting permissions state for device admin " + callerPackageName, err);
                    ...
                    RemoteStream.receiveBytes(
                        new FunctionalUtils
                          ...
                          public final void acceptOrThrow(Object obj2) {
                            IPermissionController.this.getRuntimePermissionBackup(
                                r2, (ParcelFileDescriptor) obj2);
                          }
                        });
                return receiveBytes;
              }
        ...
        .whenCompleteAsync(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$getRuntimePermissionBackup$6(
  ...
  static /* synthetic */ void lambda$getRuntimePermissionBackup$6(
    ...
    if (err != null) {
      Log.m97e(TAG, "Error getting permission backup", err);
              ...
              public final Object run(Object obj) {
                ...
                sendBytes =
                    RemoteStream.sendBytes(
                        (FunctionalUtils.ThrowingConsumer<ParcelFileDescriptor>)
                            new FunctionalUtils
                                .ThrowingConsumer() { // from class:
                                                      // android.permission.PermissionControllerManager$$ExternalSyntheticLambda5
                              @Override // com.android.internal.util.FunctionalUtils.ThrowingConsumer
                              public final void acceptOrThrow(Object obj2) {
                                IPermissionController.this.stageAndApplyRuntimePermissionsBackup(
                                    r2, (ParcelFileDescriptor) obj2);
                              }
                            },
                        backup);
        ...
        .whenComplete(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$stageAndApplyRuntimePermissionsBackup$9(
  ...
  static /* synthetic */ void lambda$stageAndApplyRuntimePermissionsBackup$9(
    ...
    if (err != null) {
      Log.m97e(TAG, "Error sending permission backup", err);
    }
  }
    ...
    this.mRemoteService
        .postAsync(
            new ServiceConnector
              ...
              @Override // com.android.internal.infra.ServiceConnector.Job
              public final Object run(Object obj) {
                return PermissionControllerManager.lambda$applyStagedRuntimePermissionBackup$10(
        ...
        .whenCompleteAsync(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$applyStagedRuntimePermissionBackup$11(
                        packageName, callback, (Boolean) obj, (Throwable) obj2);
                  }
                },
            executor);
  }
  ...
  static /* synthetic */ void lambda$applyStagedRuntimePermissionBackup$11(
    ...
    try {
      if (err != null) {
        Log.m97e(TAG, "Error restoring delayed permissions for " + packageName, err);
        callback.accept(true);
      } else {
        callback.accept(
            Boolean.valueOf(Boolean.TRUE.equals(applyStagedRuntimePermissionBackupResult)));
      }
    } finally {
      Binder.restoreCallingIdentity(token);
    }
  ...
  public void dump(final FileDescriptor fd, final String[] args) {
    try {
      ...
      Log.m97e(TAG, "Could not get dump", e);
    }
  }

  public void getAppPermissions(
      final String packageName, final OnGetAppPermissionResultCallback callback, Handler handler) {
    Preconditions.checkNotNull(packageName);
    Preconditions.checkNotNull(callback);
  ...
  static /* synthetic */ void lambda$getAppPermissions$15(
      Throwable err, OnGetAppPermissionResultCallback callback, List getAppPermissionsResult) {
    if (err != null) {
      Log.m97e(TAG, "Error getting app permission", err);
  ...
  static /* synthetic */ void lambda$countPermissionApps$19(
    ...
    if (err != null) {
      Log.m97e(TAG, "Error counting permission apps", err);
                ...
                new BiConsumer() { // from class:
                  ...
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$getPermissionUsages$22(
                        PermissionControllerManager.OnPermissionUsageResultCallback.this,
                        (List) obj,
                        (Throwable) obj2);
                  }
                },
  ...
  static /* synthetic */ void lambda$getPermissionUsages$22(
      OnPermissionUsageResultCallback callback, List getPermissionUsagesResult, Throwable err) {
    if (err != null) {
      Log.m97e(TAG, "Error getting permission usages", err);
    ...
    this.mRemoteService
        .postAsync(
            new ServiceConnector
              ...
              public final Object run(Object obj) {
                return PermissionControllerManager
                    .lambda$grantOrUpgradeDefaultRuntimePermissions$23((IPermissionController) obj);
              }
            })
        .whenCompleteAsync(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$grantOrUpgradeDefaultRuntimePermissions$24(
  ...
  static /* synthetic */ CompletableFuture lambda$grantOrUpgradeDefaultRuntimePermissions$23(
    ...
    Log.m98i(TAG, "Calling grantOrUpgradeDefaultRuntimePermissions");
  ...
  static /* synthetic */ void lambda$grantOrUpgradeDefaultRuntimePermissions$24(
      Consumer callback, Boolean grantOrUpgradeDefaultRuntimePermissionsResult, Throwable err) {
    if (err != null) {
      Log.m97e(TAG, "Error granting or upgrading runtime permissions", err);
      callback.accept(false);
    } else {
      callback.accept(
          Boolean.valueOf(Boolean.TRUE.equals(grantOrUpgradeDefaultRuntimePermissionsResult)));
    }
  }
        ...
        .whenCompleteAsync(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$getPrivilegesDescriptionStringForProfile$26(
  ...
  static /* synthetic */ void lambda$getPrivilegesDescriptionStringForProfile$26(
    ...
    if (err != null) {
      Log.m97e(TAG, "Error from getPrivilegesDescriptionStringForProfile", err);
    ...
    this.mRemoteService
        .postAsync(
            new ServiceConnector
              ...
              @Override // com.android.internal.infra.ServiceConnector.Job
              public final Object run(Object obj) {
                return PermissionControllerManager.lambda$updateUserSensitiveForApp$27(
        ...
        .whenComplete(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$updateUserSensitiveForApp$28(
  ...
  static /* synthetic */ void lambda$updateUserSensitiveForApp$28(
    ...
    if (err != null) {
      Log.m97e(TAG, "Error updating user_sensitive flags for uid " + uid, err);
    }
  }
  ...
  public void getPlatformPermissionsForGroup(
      final String permissionGroupName, Executor executor, final Consumer<List<String>> callback) {
    this.mRemoteService
        .postAsync(
            new ServiceConnector
                .Job() { // from class:
              ...
              @Override // com.android.internal.infra.ServiceConnector.Job
              public final Object run(Object obj) {
                return PermissionControllerManager.lambda$getPlatformPermissionsForGroup$30(
        ...
        .whenCompleteAsync(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$getPlatformPermissionsForGroup$31(
                        permissionGroupName, callback, (List) obj, (Throwable) obj2);
                  }
                },
            executor);
  }
  ...
  static /* synthetic */ void lambda$getPlatformPermissionsForGroup$31(
    ...
    try {
      if (err != null) {
        Log.m97e(TAG, "Failed to get permissions of " + permissionGroupName, err);
    ...
    this.mRemoteService
        .postAsync(
            new ServiceConnector
              ...
              @Override // com.android.internal.infra.ServiceConnector.Job
              public final Object run(Object obj) {
                return PermissionControllerManager.lambda$getGroupOfPlatformPermission$32(
        ...
        .whenCompleteAsync(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$getGroupOfPlatformPermission$33(
                        permissionName, callback, (String) obj, (Throwable) obj2);
                  }
                },
            executor);
  }
  ...
  static /* synthetic */ void lambda$getGroupOfPlatformPermission$33(
    ...
    try {
      if (err != null) {
        Log.m97e(TAG, "Failed to get group of " + permissionName, err);
        callback.accept(null);
      } else {
        callback.accept(result);
      }
  ...
  static /* synthetic */ void lambda$getUnusedAppCount$35(
    ...
    if (err != null) {
      Log.m97e(TAG, "Error getting unused app count", err);
      callback.accept(0);
    } else {
      long token = Binder.clearCallingIdentity();
      try {
    ...
    this.mRemoteService
        .postAsync(
            new ServiceConnector
              ...
              @Override // com.android.internal.infra.ServiceConnector.Job
              public final Object run(Object obj) {
                return PermissionControllerManager.lambda$getHibernationEligibility$36(
                    packageName, (IPermissionController) obj);
              }
            })
        .whenCompleteAsync(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$getHibernationEligibility$37(
                        callback, (Integer) obj, (Throwable) obj2);
                  }
                },
            executor);
  ...
  static /* synthetic */ void lambda$getHibernationEligibility$37(
    ...
    if (err != null) {
      Log.m97e(TAG, "Error getting hibernation eligibility", err);
      callback.accept(-1);
    } else {
      long token = Binder.clearCallingIdentity();
      try {
    ...
    this.mRemoteService
        .postAsync(
            new ServiceConnector
              ...
              @Override // com.android.internal.infra.ServiceConnector.Job
              public final Object run(Object obj) {
                return PermissionControllerManager.lambda$revokeSelfPermissionsOnKill$38(
                    packageName, permissions, (IPermissionController) obj);
              }
            })
        .whenComplete(
            (BiConsumer<? super R, ? super Throwable>)
                new BiConsumer() { // from class:
                  ...
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    PermissionControllerManager.lambda$revokeSelfPermissionsOnKill$39(
                        permissions, packageName, (Void) obj, (Throwable) obj2);
                  }
                });
  }

  static /* synthetic */ CompletableFuture lambda$revokeSelfPermissionsOnKill$38(
  ...
  static /* synthetic */ void lambda$revokeSelfPermissionsOnKill$39(
      List permissions, String packageName, Void result, Throwable err) {
    if (err != null) {
      Log.m97e(
          TAG,
          "Failed to self revoke " + String.join(",", permissions) + " for package " + packageName,
          err);
    }
  }
}
