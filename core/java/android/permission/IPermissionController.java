...
public interface IPermissionController extends IInterface {
  ...
  void getRuntimePermissionBackup(UserHandle userHandle, ParcelFileDescriptor parcelFileDescriptor)
      throws RemoteException;
  ...
  void revokeSelfPermissionsOnKill(String str, List<String> list, AndroidFuture androidFuture)
      throws RemoteException;
  ...
  void stageAndApplyRuntimePermissionsBackup(
      UserHandle userHandle, ParcelFileDescriptor parcelFileDescriptor) throws RemoteException;
  ...
  public static class Default implements IPermissionController {
    ...
    public void applyStagedRuntimePermissionBackup(
        String packageName, UserHandle user, AndroidFuture callback) throws RemoteException {}
    ...
    public void getPlatformPermissionsForGroup(
        String permissionGroupName, AndroidFuture<List<String>> callback) throws RemoteException {}

    @Override // android.permission.IPermissionController
    public void getGroupOfPlatformPermission(String permissionName, AndroidFuture<String> callback)
        throws RemoteException {}
    ...
    public void revokeSelfPermissionsOnKill(
        String packageName, List<String> permissions, AndroidFuture callback)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IPermissionController {
    ...
    static final int f349x42c91ad7 = 9;
        ...
        default:
          switch (code) {
            ...
            case 14:
              ...
              AndroidFuture<List<String>> _arg112 =
                  (AndroidFuture) data.readTypedObject(AndroidFuture.CREATOR);
              data.enforceNoDataAvail();
    ...
    private static class Proxy implements IPermissionController {
      ...
      public void countPermissionApps(
          List<String> permissionNames, int flags, AndroidFuture callback) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        try {
          _data.writeInterfaceToken(IPermissionController.DESCRIPTOR);
