...
public final class PermissionManager {
  ...
  private final ArrayMap<PackageManager.OnPermissionsChangedListener, IOnPermissionsChangeListener>
  ...
  static {
    ...
    sPermissionCache =
        new PropertyInvalidatedCache<PermissionQuery, Integer>(
            2048, str, "checkPermission") { // from class: android.permission.PermissionManager.1
          @Override // android.app.PropertyInvalidatedCache
          public Integer recompute(PermissionQuery query) {
            return Integer.valueOf(
                PermissionManager.checkPermissionUncached(query.permission, query.pid, query.uid));
          }
        };
    sPackageNamePermissionCache =
        new PropertyInvalidatedCache<PackageNamePermissionQuery, Integer>(
            16,
            str,
            "checkPackageNamePermission") { // from class: android.permission.PermissionManager.2
          @Override // android.app.PropertyInvalidatedCache
  ...
  public boolean isPermissionRevokedByPolicy(String packageName, String permissionName) {
    try {
      return this.mPermissionManager.isPermissionRevokedByPolicy(
          packageName, permissionName, this.mContext.getUserId());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void grantRuntimePermission(String packageName, String permissionName, UserHandle user) {
    try {
      this.mPermissionManager.grantRuntimePermission(
          packageName, permissionName, user.getIdentifier());
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void revokeRuntimePermission(
    ...
    try {
      this.mPermissionManager.revokeRuntimePermission(
          packageName, permName, user.getIdentifier(), reason);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public void updatePermissionFlags(
      String packageName, String permissionName, int flagMask, int flagValues, UserHandle user) {
    try {
  ...
  public List<SplitPermissionInfo> getSplitPermissions() {
    ...
    try {
      ...
      Slog.m116e(LOG_TAG, "Error getting split permissions", e);
      return Collections.emptyList();
    }
  }
  ...
  public void startOneTimePermissionSession(
    ...
    startOneTimePermissionSession(
        packageName, timeoutMillis, -1L, importanceToResetTimer, importanceToKeepSessionAlive);
  }
  ...
  public void startOneTimePermissionSession(
    ...
    try {
      this.mPermissionManager.startOneTimePermissionSession(
          packageName, this.mContext.getUserId(), timeoutMillis, revokeAfterKilledDelayMillis);
    } catch (RemoteException e) {
  ...
  public static int checkPermissionUncached(String permission, int pid, int uid) {
    ...
    if (am == null) {
      ...
      if (appId != 0 && appId != 1000) {
        Slog.m121w(
            LOG_TAG, "Missing ActivityManager; assuming " + uid + " does not hold " + permission);
        return -1;
      }
      if (sShouldWarnMissingActivityManager) {
        Slog.m121w(LOG_TAG, "Missing ActivityManager; assuming " + uid + " holds " + permission);
  ...
  private static final class PermissionQuery {
    ...
    public String toString() {
      return String.format(
          "PermissionQuery(permission=\"%s\", pid=%s, uid=%s)",
          this.permission, Integer.valueOf(this.pid), Integer.valueOf(this.uid));
    }
  ...
  private static final class PackageNamePermissionQuery {
    ...
    public String toString() {
      return String.format(
          ...
          this.pkgName, this.permName, Integer.valueOf(this.userId));
    }
  ...
  public static int checkPackageNamePermissionUncached(
      String permName, String pkgName, int userId) {
    try {
  ...
  public static int checkPackageNamePermission(String permName, String pkgName, int userId) {
    return sPackageNamePermissionCache
        .query(new PackageNamePermissionQuery(permName, pkgName, userId))
        .intValue();
  }
  ...
  private final class OnPermissionsChangeListenerDelegate extends IOnPermissionsChangeListener.Stub
      ...
      switch (msg.what) {
        case 1:
          ...
          try {
            ...
            Slog.m118i(PermissionManager.LOG_TAG, "Failed to notify listener", e);
            return true;
          }
        default:
          return false;
