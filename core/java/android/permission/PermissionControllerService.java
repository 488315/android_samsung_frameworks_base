...
public abstract class PermissionControllerService extends Service {
  ...
  public void onSetRuntimePermissionGrantStateByDeviceAdmin(
      String callerPackageName, AdminPermissionControlParams params, Consumer<Boolean> callback) {
    throw new AbstractMethodError("Must be overridden in implementing class");
  }
  ...
  class BinderC24571 extends IPermissionController.Stub {
    BinderC24571() {}
        ...
        PermissionControllerService.this.onRevokeRuntimePermissions(
            ...
            new Consumer() { // from class:
              ...
              public final void accept(Object obj) {
                PermissionControllerService.BinderC24571.lambda$revokeRuntimePermissions$1(
      ...
      CollectionUtils.forEach(
          ...
          new BiConsumer() { // from class:
            ...
            public final void accept(Object obj, Object obj2) {
              PermissionControllerService.BinderC24571.lambda$revokeRuntimePermissions$0(
                  (String) obj, (List) obj2);
            }
          });
      ...
      try {
        ...
        try {
          ...
          permissionControllerService.onGetRuntimePermissionsBackup(
              user, backup, new PermissionControllerService$1$$ExternalSyntheticLambda4(latch));
          latch.await();
          backup.close();
        } catch (Throwable th) {
          try {
        ...
        Log.m97e(PermissionControllerService.LOG_TAG, "Could not open pipe to write backup to", e);
      } catch (InterruptedException e2) {
        Log.m97e(PermissionControllerService.LOG_TAG, "getRuntimePermissionBackup timed out", e2);
      }
    }
    ...
    public void stageAndApplyRuntimePermissionsBackup(UserHandle user, ParcelFileDescriptor pipe) {
      ...
      try {
        ...
        Log.m97e(PermissionControllerService.LOG_TAG, "Could not open pipe to read backup from", e);
      } catch (InterruptedException e2) {
        Log.m97e(
            PermissionControllerService.LOG_TAG, "restoreRuntimePermissionBackup timed out", e2);
      }
    }
    ...
    public void applyStagedRuntimePermissionBackup(
      ...
      permissionControllerService.onApplyStagedRuntimePermissionBackup(
          packageName, user, new PermissionControllerService$1$$ExternalSyntheticLambda6(callback));
    }
    ...
    public void getAppPermissions(String packageName, AndroidFuture callback) {
      ...
      permissionControllerService.onGetAppPermissions(
          packageName, new PermissionControllerService$1$$ExternalSyntheticLambda5(callback));
    }
    ...
    public void revokeRuntimePermission(String packageName, String permissionName) {
      ...
      permissionControllerService.onRevokeRuntimePermission(
          packageName,
          permissionName,
          new PermissionControllerService$1$$ExternalSyntheticLambda4(latch));
      try {
        latch.await();
      } catch (InterruptedException e) {
        Log.m97e(PermissionControllerService.LOG_TAG, "revokeRuntimePermission timed out", e);
      }
    }
    ...
    public void countPermissionApps(
      ...
      permissionControllerService.onCountPermissionApps(
          permissionNames,
          flags,
          new PermissionControllerService$1$$ExternalSyntheticLambda2(callback));
    }
    ...
    public void getPermissionUsages(boolean countSystem, long numMillis, AndroidFuture callback) {
      ...
      permissionControllerService.onGetPermissionUsages(
          countSystem,
          numMillis,
          new PermissionControllerService$1$$ExternalSyntheticLambda5(callback));
    }

    @Override // android.permission.IPermissionController
    public void setRuntimePermissionGrantStateByDeviceAdminFromParams(
        String callerPackageName, AdminPermissionControlParams params, AndroidFuture callback) {
    ...
    public void grantOrUpgradeDefaultRuntimePermissions(final AndroidFuture callback) {
      ...
      enforceSomePermissionsGrantedToCaller(Manifest.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY);
      Log.m98i(
          PermissionControllerService.LOG_TAG, "Calling onGrantOrUpgradeDefaultRuntimePermissions");
      PermissionControllerService.this.onGrantOrUpgradeDefaultRuntimePermissions(
          new Runnable() { // from class:
                           // android.permission.PermissionControllerService$1$$ExternalSyntheticLambda1
    ...
    public void updateUserSensitiveForApp(int uid, final AndroidFuture callback) {
      ...
      try {
        PermissionControllerService.this.onUpdateUserSensitivePermissionFlags(
            uid,
            new Runnable() { // from class:
                             // android.permission.PermissionControllerService$1$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
    ...
    public void getPlatformPermissionsForGroup(
      ...
      try {
        ...
        permissionControllerService.onGetPlatformPermissionsForGroup(
            permissionName, new PermissionControllerService$1$$ExternalSyntheticLambda5(callback));
      } catch (Throwable t) {
        callback.completeExceptionally(t);
      }
    }
    ...
    public void getHibernationEligibility(String packageName, AndroidFuture callback) {
      try {
        ...
        permissionControllerService.onGetHibernationEligibility(
            packageName, new PermissionControllerService$1$$ExternalSyntheticLambda2(callback));
      } catch (Throwable t) {
        callback.completeExceptionally(t);
      }
    }
    ...
    public void revokeSelfPermissionsOnKill(
        String packageName, List<String> permissions, final AndroidFuture callback) {
      try {
        Objects.requireNonNull(callback);
        ...
        int targetPackageUid =
            PermissionControllerService.this
                .getPackageManager()
                .getPackageUid(packageName, PackageManager.PackageInfoFlags.m11of(0L));
