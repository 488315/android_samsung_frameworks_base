    ...
    class BinderC24571 extends IPermissionController.Stub {
            ...
            try {
                ...
                PermissionControllerService.this.onRevokeRuntimePermissions(request, doDryRun, reason, callerPackageName, new Consumer() { // from class: android.permission.PermissionControllerService$1$$ExternalSyntheticLambda9
                    ...
                    public final void accept(Object obj) {
                        PermissionControllerService.BinderC24571.lambda$revokeRuntimePermissions$1(AndroidFuture.this, (Map) obj);
                    }
                });
        ...
        static /* synthetic */ void lambda$revokeRuntimePermissions$1(AndroidFuture callback, Map revoked) {
            CollectionUtils.forEach(revoked, new BiConsumer() { // from class: android.permission.PermissionControllerService$1$$ExternalSyntheticLambda3
                ...
                public final void accept(Object obj, Object obj2) {
                    PermissionControllerService.BinderC24571.lambda$revokeRuntimePermissions$0((String) obj, (List) obj2);
                }
            });
        ...
        public void stageAndApplyRuntimePermissionsBackup(UserHandle user, ParcelFileDescriptor pipe) {
            ...
            try {
                ...
                Log.m97e(PermissionControllerService.LOG_TAG, "restoreRuntimePermissionBackup timed out", e2);
            }
        }
        ...
        public void grantOrUpgradeDefaultRuntimePermissions(final AndroidFuture callback) {
            Preconditions.checkNotNull(callback, "callback");
            enforceSomePermissionsGrantedToCaller(Manifest.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY);
            Log.m98i(PermissionControllerService.LOG_TAG, "Calling onGrantOrUpgradeDefaultRuntimePermissions");
        ...
        public void revokeSelfPermissionsOnKill(String packageName, List<String> permissions, final AndroidFuture callback) {
            try {
                ...
                int targetPackageUid = PermissionControllerService.this.getPackageManager().getPackageUid(packageName, PackageManager.PackageInfoFlags.m11of(0L));
