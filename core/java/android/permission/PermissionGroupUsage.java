...
public final class PermissionGroupUsage implements Parcelable {
  public static final Parcelable.Creator<PermissionGroupUsage> CREATOR =
      new Parcelable.Creator<
          PermissionGroupUsage>() { // from class: android.permission.PermissionGroupUsage.1
  ...
  public PermissionGroupUsage(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) permissionGroupName);
    this.mActive = active;
  ...
  public int hashCode() {
    ...
    return (((((((((((((((_hash * 31) + this.mUid) * 31)
                                                        + Long.hashCode(this.mLastAccessTimeMillis))
                                                    * 31)
                                                + Objects.hashCode(this.mPermissionGroupName))
                                            * 31)
                                        + Boolean.hashCode(this.mActive))
                                    * 31)
                                + Boolean.hashCode(this.mPhoneCall))
                            * 31)
