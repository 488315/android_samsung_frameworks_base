...
public class PermissionUsageHelper implements AppOpsManager.OnOpActiveChangedListener, AppOpsManager.OnOpStartedListener {
    ...
    private ArrayMap<String, String> getSubattributionLabelsForPackage(String packageName, int uid) {
        ...
        PackageInfo packageInfo = userContext.getPackageManager().getPackageInfo(packageName, PackageManager.PackageInfoFlags.m11of(2147487744L));
    ...
    private boolean isSubattributionSupported(String packageName, int uid) {
        try {
            ...
            ApplicationInfo appInfo = userPkgManager.getApplicationInfoAsUser(packageName, PackageManager.ApplicationInfoFlags.m9of(0L), UserHandle.getUserId(uid));
            if (appInfo == null) {
                return false;
            }
        ...
        synchronized (permissionUsageHelper.mAttributionChains) {
            ...
            while (i3 < permissionUsageHelper.mAttributionChains.size()) {
                ...
                if (!usageList.isEmpty() && usageList.get(lastVisible).isEnd()) {
                    if (usageList.get(0).isStart() && str.equals(getGroupForOp(usageList.get(0).usage.f350op)) && Manifest.permission_group.MICROPHONE.equals(str)) {
    ...
    private static class OpUsage {
        ...
        public int hashCode() {
            return Objects.hash(this.packageName, this.attributionTag, this.f350op, Integer.valueOf(this.uid), Long.valueOf(this.lastAccessTime), Boolean.valueOf(this.isRunning));
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Objects.equals(this.packageName, other.packageName) && Objects.equals(this.attributionTag, other.attributionTag) && Objects.equals(this.f350op, other.f350op) && this.uid == other.uid && this.lastAccessTime == other.lastAccessTime && this.isRunning == other.isRunning;
        }
    }
    ...
    private static class AccessChainLink {
        ...
        public boolean equals(Object obj) {
            ...
            return other.flags == this.flags && packageAndOpEquals(other.usage.f350op, other.usage.packageName, other.usage.attributionTag, other.usage.uid);
        }

        public boolean packageAndOpEquals(String op, String packageName, String attributionTag, int uid) {
            return Objects.equals(op, this.usage.f350op) && Objects.equals(packageName, this.usage.packageName) && Objects.equals(attributionTag, this.usage.attributionTag) && uid == this.usage.uid;
        }
    }
}
