...
public interface IPermissionManager extends IInterface {
  ...
  public static class Default implements IPermissionManager {
    ...
    public boolean addAllowlistedRestrictedPermission(
        String packageName, String permissionName, int flags, int userId) throws RemoteException {
      return false;
    }
    ...
    public void revokeRuntimePermission(
        String packageName, String permissionName, int userId, String reason)
        throws RemoteException {}
    ...
    public void startOneTimePermissionSession(
        String packageName, int userId, long timeout, long revokeAfterKilledDelay)
        throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 13:
              ...
              data.enforceNoDataAvail();
              boolean _result8 =
                  addAllowlistedRestrictedPermission(_arg013, _arg19, _arg26, _arg32);
              reply.writeNoException();
            ...
            case 14:
              ...
              data.enforceNoDataAvail();
              boolean _result9 =
                  removeAllowlistedRestrictedPermission(_arg014, _arg110, _arg27, _arg33);
              reply.writeNoException();
            ...
            case 27:
              ...
              return true;
            case 28:
              AttributionSourceState _arg027 =
                  (AttributionSourceState) data.readTypedObject(AttributionSourceState.CREATOR);
              data.enforceNoDataAvail();
