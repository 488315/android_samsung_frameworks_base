...
public abstract class CarrierMessagingService extends Service {
  ...
  public static final int f476xbf78d2e5 = 2;
  ...
  public void onFilterSms(
      MessagePdu pdu, String format, int destPort, int subId, ResultCallback<Boolean> callback) {
    try {
  ...
  public void onReceiveTextSms(
    ...
    onFilterSms(
        ...
        subId,
        new ResultCallback<
            Boolean>() { // from class: android.service.carrier.CarrierMessagingService.1
