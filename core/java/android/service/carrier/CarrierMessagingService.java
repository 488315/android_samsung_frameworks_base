...
public abstract class CarrierMessagingService extends Service {
    ...
    public void onSendTextSms(
            String text, int subId, String destAddress, ResultCallback<SendSmsResult> callback) {
        try {
    ...
    @Deprecated
    public void onSendMultipartTextSms(
            List<String> parts,
            int subId,
            String destAddress,
    ...
    public void onSendMms(
            Uri pduUri, int subId, Uri location, ResultCallback<SendMmsResult> callback) {
        try {
    ...
    public void onDownloadMms(
            Uri contentUri, int subId, Uri location, ResultCallback<Integer> callback) {
        try {
    ...
    private class ICarrierMessagingWrapper extends ICarrierMessagingService.Stub {
        ...
        public void filterSms(
            ...
            CarrierMessagingService.this.onReceiveTextSms(
                    pdu,
                    format,
                    destPort,
                    subId,
        ...
        public void sendTextSms(
                ...
                int sendSmsFlag,
                final ICarrierMessagingCallback callback) {
            CarrierMessagingService.this.onSendTextSms(
                    text,
                    subId,
                    destAddress,
                    sendSmsFlag,
                    new ResultCallback<
                            SendSmsResult>() { // from class:
                        ...
                        public void onReceiveResult(SendSmsResult result) throws RemoteException {
                            callback.onSendSmsComplete(
                                    result.getSendStatus(), result.getMessageRef());
                        }
                    });
        }
        ...
        public void sendDataSms(
                ...
                int sendSmsFlag,
                final ICarrierMessagingCallback callback) {
            CarrierMessagingService.this.onSendDataSms(
                    data,
                    subId,
                    destAddress,
                    destPort,
        ...
        public void sendMultipartTextSms(
                ...
                int sendSmsFlag,
                final ICarrierMessagingCallback callback) {
            CarrierMessagingService.this.onSendMultipartTextSms(
                    parts,
                    subId,
                    destAddress,
                    sendSmsFlag,
                    new ResultCallback<
                            SendMultipartSmsResult>() { // from class:
                                                        // android.service.carrier.CarrierMessagingService.ICarrierMessagingWrapper.4
                        @Override // android.service.carrier.CarrierMessagingService.ResultCallback
                        public void onReceiveResult(SendMultipartSmsResult result)
        ...
        @Override // android.service.carrier.ICarrierMessagingService
        public void sendMms(
                Uri pduUri, int subId, Uri location, final ICarrierMessagingCallback callback) {
            CarrierMessagingService.this.onSendMms(
                    pduUri,
                    subId,
                    location,
                    new ResultCallback<
                            SendMmsResult>() { // from class:
                        ...
                        public void onReceiveResult(SendMmsResult result) throws RemoteException {
                            callback.onSendMmsComplete(
                                    result.getSendStatus(), result.getSendConfPdu());
                        }
                    });
        }
        ...
        public void downloadMms(
                Uri pduUri, int subId, Uri location, final ICarrierMessagingCallback callback) {
            CarrierMessagingService.this.onDownloadMms(
                    pduUri,
                    subId,
                    location,
                    new ResultCallback<
