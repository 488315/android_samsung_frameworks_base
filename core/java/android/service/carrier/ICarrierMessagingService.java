...
public interface ICarrierMessagingService extends IInterface {
  ...
  void sendTextSms(
      String str, int i, String str2, int i2, ICarrierMessagingCallback iCarrierMessagingCallback)
      throws RemoteException;
  ...
  public static class Default implements ICarrierMessagingService {
    ...
    public void filterSms(
        MessagePdu pdu, String format, int destPort, int subId, ICarrierMessagingCallback callback)
        throws RemoteException {}
