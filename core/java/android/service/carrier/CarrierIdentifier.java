...
public class CarrierIdentifier implements Parcelable {
  public static final Parcelable.Creator<CarrierIdentifier> CREATOR =
      new Parcelable.Creator<
          CarrierIdentifier>() { // from class: android.service.carrier.CarrierIdentifier.1
  ...
  public boolean equals(Object obj) {
    ...
    if (Objects.equals(this.mMcc, that.mMcc)
        ...
        && Objects.equals(Integer.valueOf(this.mCarrierId), Integer.valueOf(that.mCarrierId))
        && Objects.equals(
            Integer.valueOf(this.mSpecificCarrierId), Integer.valueOf(that.mSpecificCarrierId))) {
      return true;
    }
    return false;
  }
