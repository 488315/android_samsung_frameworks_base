...
public interface ITextClassifierService extends IInterface {
  ...
  public static class Default implements ITextClassifierService {
    ...
    public void onTextClassifierEvent(
        TextClassificationSessionId sessionId, TextClassifierEvent event) throws RemoteException {}
          ...
          switch (code) {
            case 1:
              ...
              TextSelection.Request _arg1 =
                  (TextSelection.Request) data.readTypedObject(TextSelection.Request.CREATOR);
            ...
            case 8:
              ...
              TextLanguage.Request _arg17 =
                  (TextLanguage.Request) data.readTypedObject(TextLanguage.Request.CREATOR);
