...
public abstract class TextClassifierService extends Service {
    ...
    class AnonymousClass1 extends ITextClassifierService.Stub {
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this.lambda$onSuggestSelection$0(
        ...
        public void onClassifyText(
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        @Override // java.lang.Runnable
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this.lambda$onClassifyText$1(
                                    sessionId, request, callback);
                        }
                    });
        }
        ...
        public void onGenerateLinks(
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        @Override // java.lang.Runnable
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this.lambda$onGenerateLinks$2(
                                    sessionId, request, callback);
                        }
                    });
        }
        ...
        public void onSelectionEvent(
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        @Override // java.lang.Runnable
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this.lambda$onSelectionEvent$3(
                                    sessionId, event);
                        }
                    });
        }
        ...
        public void onTextClassifierEvent(
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        @Override // java.lang.Runnable
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this
                                    .lambda$onTextClassifierEvent$4(sessionId, event);
                        }
                    });
        }
        ...
        public void onDetectLanguage(
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        @Override // java.lang.Runnable
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this.lambda$onDetectLanguage$5(
                                    sessionId, request, callback);
                        }
                    });
        }
        ...
        public void onSuggestConversationActions(
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this
                                    .lambda$onSuggestConversationActions$6(
                                            sessionId, request, callback);
                        }
                    });
        }
        ...
        public void onCreateTextClassificationSession(
                final TextClassificationContext context,
                final TextClassificationSessionId sessionId) {
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this
                                    .lambda$onCreateTextClassificationSession$7(context, sessionId);
                        }
                    });
        }
        ...
        public void onDestroyTextClassificationSession(
            ...
            TextClassifierService.this.mMainThreadHandler.post(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            TextClassifierService.AnonymousClass1.this
                                    .lambda$onDestroyTextClassificationSession$8(sessionId);
                        }
                    });
        }
    ...
    public void onSuggestConversationActions(
        ...
        this.mSingleThreadExecutor.submit(
                new Runnable() { // from class:
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        TextClassifierService.this.lambda$onSuggestConversationActions$1(
                                callback, request);
                    }
                });
    }
