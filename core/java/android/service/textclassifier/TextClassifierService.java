...
public abstract class TextClassifierService extends Service {
  ...
  private final ITextClassifierService.Stub mBinder = new BinderC28021();
  ...
  class BinderC28021 extends ITextClassifierService.Stub {
    ...
    public void onSuggestSelection(
        final TextClassificationSessionId sessionId,
        final TextSelection.Request request,
        final ITextClassifierCallback callback) {
      Objects.requireNonNull(request);
      Objects.requireNonNull(callback);
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onSuggestSelection$0(
                  sessionId, request, callback);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onSuggestSelection$0(
      ...
      TextClassifierService.this.onSuggestSelection(
          sessionId, request, this.mCancellationSignal, new ProxyCallback(callback));
    }
    ...
    public void onClassifyText(
      ...
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onClassifyText$1(
                  sessionId, request, callback);
            }
          });
    }
    ...
    public void onGenerateLinks(
      ...
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onGenerateLinks$2(
                  sessionId, request, callback);
            }
          });
    }
    ...
    public void onSelectionEvent(
        final TextClassificationSessionId sessionId, final SelectionEvent event) {
      Objects.requireNonNull(event);
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onSelectionEvent$3(sessionId, event);
            }
          });
    }
    ...
    public void onTextClassifierEvent(
        final TextClassificationSessionId sessionId, final TextClassifierEvent event) {
      Objects.requireNonNull(event);
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onTextClassifierEvent$4(
                  sessionId, event);
            }
          });
    }
    ...
    public void onDetectLanguage(
      ...
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onDetectLanguage$5(
                  sessionId, request, callback);
            }
          });
    }
    ...
    public void onSuggestConversationActions(
      ...
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onSuggestConversationActions$6(
                  sessionId, request, callback);
            }
          });
    }
    ...
    public void onCreateTextClassificationSession(
        final TextClassificationContext context, final TextClassificationSessionId sessionId) {
      Objects.requireNonNull(context);
      Objects.requireNonNull(sessionId);
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onCreateTextClassificationSession$7(
                  context, sessionId);
            }
          });
    }
    ...
    public void onDestroyTextClassificationSession(final TextClassificationSessionId sessionId) {
      TextClassifierService.this.mMainThreadHandler.post(
          new Runnable() { // from class:
                           // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
              TextClassifierService.BinderC28021.this.lambda$onDestroyTextClassificationSession$8(
                  sessionId);
            }
          });
    }
    ...
    public void onConnectedStateChanged(int connected) {
      ...
      if (connected == 0) {
        ...
        runnable =
            new Runnable() { // from class:
                             // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
        ...
        runnable =
            new Runnable() { // from class:
                             // android.service.textclassifier.TextClassifierService$1$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public void onDetectLanguage(
      ...
      final TextLanguage.Request request,
      CancellationSignal cancellationSignal,
      final Callback<TextLanguage> callback) {
    this.mSingleThreadExecutor.submit(
        new Runnable() { // from class:
                         // android.service.textclassifier.TextClassifierService$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void onSuggestConversationActions(
      ...
      final ConversationActions.Request request,
      CancellationSignal cancellationSignal,
      final Callback<ConversationActions> callback) {
    this.mSingleThreadExecutor.submit(
        new Runnable() { // from class:
                         // android.service.textclassifier.TextClassifierService$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public static TextClassifier getDefaultTextClassifierImplementation(Context context) {
    String defaultTextClassifierPackageName =
    ...
    if (defaultTextClassifierPackageName.equals(context.getPackageName())) {
      throw new RuntimeException(
          "The default text classifier itself should not call"
              + " thegetDefaultTextClassifierImplementation() method.");
    }
    TextClassificationManager tcm =
        (TextClassificationManager) context.getSystemService(TextClassificationManager.class);
  ...
  public static ComponentName getServiceComponentName(
    ...
    if (ri == null || ri.serviceInfo == null) {
      Slog.m121w(
          LOG_TAG,
          String.format(
              "Package or service not found in package %s for user %d",
              packageName, Integer.valueOf(context.getUserId())));
      return null;
    }
    ...
    Slog.m121w(
        ...
        String.format(
            ...
            si.getComponentName(), Manifest.permission.BIND_TEXTCLASSIFIER_SERVICE, si.permission));
    return null;
  }
  ...
  private static final class ProxyCallback<T extends Parcelable> implements Callback<T> {
    ...
    private ProxyCallback(ITextClassifierCallback textClassifierCallback) {
      this.mTextClassifierCallback =
          (ITextClassifierCallback) Objects.requireNonNull(textClassifierCallback);
    }
    ...
    public void onSuccess(T result) {
      try {
        ...
        Slog.m113d(TextClassifierService.LOG_TAG, "Error calling callback");
      }
    }
    ...
    public void onFailure(CharSequence error) {
      try {
        Slog.m121w(TextClassifierService.LOG_TAG, "Request fail: " + ((Object) error));
