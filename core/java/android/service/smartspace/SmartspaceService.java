...
public abstract class SmartspaceService extends Service {
  ...
  private final ArrayMap<SmartspaceSessionId, ArrayList<CallbackWrapper>> mSessionCallbacks =
      new ArrayMap<>();
  private final ISmartspaceService mInterface = new BinderC27961();
  ...
  class BinderC27961 extends ISmartspaceService.Stub {
    BinderC27961() {}
                ...
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((SmartspaceService) obj)
                      .doCreateSmartspaceSession(
                          (SmartspaceConfig) obj2, (SmartspaceSessionId) obj3);
                }
              },
                ...
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((SmartspaceService) obj)
                      .notifySmartspaceEvent(
                          (SmartspaceSessionId) obj2, (SmartspaceTargetEvent) obj3);
                }
              },
              SmartspaceService.this,
              sessionId,
                ...
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((SmartspaceService) obj)
                      .doRegisterSmartspaceUpdates(
                          (SmartspaceSessionId) obj2, (ISmartspaceCallback) obj3);
                }
              },
              SmartspaceService.this,
              sessionId,
  ...
  public final IBinder onBind(Intent intent) {
    ...
    Slog.m121w(
        TAG,
        "Tried to bind to wrong intent (should be android.service.smartspace.SmartspaceService: "
            + intent);
    return null;
  }
  ...
  static final class CallbackWrapper
    ...
    CallbackWrapper(ISmartspaceCallback callback, Consumer<CallbackWrapper> onBinderDied) {
      ...
      if (onBinderDied != null) {
        try {
          ...
          Slog.m115e(SmartspaceService.TAG, "Failed to link to death: " + e);
        }
      }
    }
    ...
    public boolean isCallback(ISmartspaceCallback callback) {
      ...
      if (iSmartspaceCallback == null) {
        Slog.m115e(SmartspaceService.TAG, "Callback is null, likely the binder has died.");
        return false;
      }
    ...
    public void accept(List<SmartspaceTarget> smartspaceTargets) {
      try {
        ...
        Slog.m115e(SmartspaceService.TAG, "Error sending result:" + e);
      }
    }
