...
public abstract class MediaBrowserService extends Service {
  ...
  private static class ConnectionRecord implements IBinder.DeathRecipient {
    ...
    public void binderDied() {
      this.service.mHandler.post(
          new Runnable() { // from class:
                           // android.service.media.MediaBrowserService.ConnectionRecord.1
            @Override // java.lang.Runnable
            public void run() {
              ConnectionRecord.this.service.mConnections.remove(
                  ConnectionRecord.this.callbacks.asBinder());
            }
          });
    }
  }
    ...
    public void detach() {
      if (this.mDetachCalled) {
        throw new IllegalStateException(
            "detach() called when detach() had already been called for: " + this.mDebug);
      }
      if (this.mSendResultCalled) {
        throw new IllegalStateException(
            "detach() called when sendResult() had already been called for: " + this.mDebug);
      }
  ...
  private static class ServiceBinder extends IMediaBrowserService.Stub {
    ...
    public void connect(
        final String pkg, final Bundle rootHints, final IMediaBrowserServiceCallbacks callbacks) {
      ...
      service.mHandler.post(
          new Runnable() { // from class: android.service.media.MediaBrowserService.ServiceBinder.1
            @Override // java.lang.Runnable
            public void run() {
              IBinder b = callbacks.asBinder();
              service.mConnections.remove(b);
              MediaBrowserService mediaBrowserService = service;
              mediaBrowserService.mCurConnection =
                  new ConnectionRecord(
                      mediaBrowserService, pkg, pid, uid, rootHints, callbacks, null);
              BrowserRoot root = service.onGetRoot(pkg, uid, rootHints);
              service.mCurConnection = null;
              if (root == null) {
                Log.m98i(
                    MediaBrowserService.TAG,
                    "No root for client " + pkg + " from service " + getClass().getName());
                try {
                  ...
                  Log.m102w(
                      MediaBrowserService.TAG,
                      "Calling onConnectFailed() failed. Ignoring. pkg=" + pkg);
                  return;
                }
              }
              try {
                ConnectionRecord connection =
                    new ConnectionRecord(service, pkg, pid, uid, rootHints, callbacks, root);
                service.mConnections.put(b, connection);
                b.linkToDeath(connection, 0);
                if (service.mSession != null) {
                  callbacks.onConnect(
                      connection.root.getRootId(), service.mSession, connection.root.getExtras());
                }
              } catch (RemoteException e2) {
                Log.m102w(
                    MediaBrowserService.TAG,
                    "Calling onConnect() failed. Dropping client. pkg=" + pkg);
                service.mConnections.remove(b);
              }
            }
          });
    ...
    public void disconnect(final IMediaBrowserServiceCallbacks callbacks) {
      ...
      service.mHandler.post(
          new Runnable() { // from class: android.service.media.MediaBrowserService.ServiceBinder.2
            @Override // java.lang.Runnable
            public void run() {
              IBinder b = callbacks.asBinder();
    ...
    public void addSubscription(
      ...
      service.mHandler.post(
          new Runnable() { // from class: android.service.media.MediaBrowserService.ServiceBinder.3
            @Override // java.lang.Runnable
            public void run() {
              IBinder b = callbacks.asBinder();
              ...
              if (connection == null) {
                Log.m102w(
                    MediaBrowserService.TAG,
                    "addSubscription for callback that isn't registered id=" + id);
              } else {
    ...
    public void removeSubscription(
        final String id, final IBinder token, final IMediaBrowserServiceCallbacks callbacks) {
      final MediaBrowserService service = this.mService.get();
      if (service == null) {
        return;
      }
      service.mHandler.post(
          new Runnable() { // from class: android.service.media.MediaBrowserService.ServiceBinder.4
            @Override // java.lang.Runnable
            public void run() {
              IBinder b = callbacks.asBinder();
              ConnectionRecord connection = (ConnectionRecord) service.mConnections.get(b);
              if (connection == null) {
                Log.m102w(
                    MediaBrowserService.TAG,
                    "removeSubscription for callback that isn't registered id=" + id);
              } else if (!service.removeSubscription(id, connection, token)) {
                Log.m102w(
                    MediaBrowserService.TAG,
                    "removeSubscription called for " + id + " which is not subscribed");
              }
            }
          });
    }
    ...
    public void getMediaItem(
      ...
      service.mHandler.post(
          new Runnable() { // from class: android.service.media.MediaBrowserService.ServiceBinder.5
            @Override // java.lang.Runnable
            public void run() {
              IBinder b = callbacks.asBinder();
              ConnectionRecord connection = (ConnectionRecord) service.mConnections.get(b);
              if (connection == null) {
                Log.m102w(
                    MediaBrowserService.TAG,
                    "getMediaItem for callback that isn't registered id=" + mediaId);
              } else {
  ...
  public void setSessionToken(final MediaSession.Token token) {
    ...
    this.mSession = token;
    this.mHandler.post(
        new Runnable() { // from class: android.service.media.MediaBrowserService.1
          @Override // java.lang.Runnable
          public void run() {
            Iterator<ConnectionRecord> iter =
                MediaBrowserService.this.mConnections.values().iterator();
            while (iter.hasNext()) {
              ...
              try {
                ...
                Log.m102w(
                    MediaBrowserService.TAG,
                    "Connection for " + connection.pkg + " is no longer valid.");
                iter.remove();
              }
            }
          }
  ...
  public final Bundle getBrowserRootHints() {
    ...
    if (connectionRecord == null) {
      throw new IllegalStateException(
          "This should be called inside of onGetRoot or onLoadChildren or onLoadItem methods");
    }
  ...
  public final MediaSessionManager.RemoteUserInfo getCurrentBrowserInfo() {
    ...
    return new MediaSessionManager.RemoteUserInfo(
        connectionRecord.pkg, this.mCurConnection.pid, this.mCurConnection.uid);
  }
  ...
  private void notifyChildrenChangedInternal(final String parentId, final Bundle options) {
    ...
    this.mHandler.post(
        new Runnable() { // from class: android.service.media.MediaBrowserService.2
          @Override // java.lang.Runnable
          public void run() {
            for (IBinder binder : MediaBrowserService.this.mConnections.keySet()) {
              ConnectionRecord connection =
                  (ConnectionRecord) MediaBrowserService.this.mConnections.get(binder);
              ...
              if (callbackList != null) {
                for (Pair<IBinder, Bundle> callback : callbackList) {
                  if (MediaBrowserUtils.hasDuplicatedItems(options, callback.second)) {
                    MediaBrowserService.this.performLoadChildren(
                        parentId, connection, callback.second);
                  }
                }
              }
            }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public void addSubscription(
      String id, ConnectionRecord connection, IBinder token, Bundle options) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public void performLoadChildren(
    ...
    Result<List<MediaBrowser.MediaItem>> result =
        new Result<List<MediaBrowser.MediaItem>>(
            parentId) { // from class: android.service.media.MediaBrowserService.3
          ...
          public void onResultSent(List<MediaBrowser.MediaItem> list, int flag) {
            ...
            if (MediaBrowserService.this.mConnections.get(connection.callbacks.asBinder())
                != connection) {
              return;
            }
            List<MediaBrowser.MediaItem> filteredList =
                (flag & 1) != 0 ? MediaBrowserService.this.applyOptions(list, options) : list;
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public List<MediaBrowser.MediaItem> applyOptions(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public void performLoadItem(
      final String itemId, final ConnectionRecord connection, final ResultReceiver receiver) {
    Result<MediaBrowser.MediaItem> result =
        new Result<MediaBrowser.MediaItem>(
            itemId) { // from class: android.service.media.MediaBrowserService.4
          /* JADX INFO: Access modifiers changed from: package-private */
          @Override // android.service.media.MediaBrowserService.Result
