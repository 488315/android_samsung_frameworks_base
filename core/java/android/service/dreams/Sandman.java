...
public final class Sandman {
    ...
    public static boolean shouldStartDockApp(Context context, Intent intent) {
        ComponentName somnambulatorComponent = ComponentName.unflattenFromString(context.getResources().getString(C4337R.string.config_somnambulatorComponent));
    ...
    private static boolean isScreenSaverActivatedOnDock(Context context) {
        int def = context.getResources().getBoolean(C4337R.bool.config_dreamsActivatedOnDockByDefault) ? 1 : 0;
