...
public final class Sandman {
    ...
    public static boolean shouldStartDockApp(Context context, Intent intent) {
        ComponentName somnambulatorComponent =
                ComponentName.unflattenFromString(
                        context.getResources().getString(R.string.config_somnambulatorComponent));
        ...
        try {
            ...
            if (dreamManagerService != null && !dreamManagerService.isDreaming()) {
                if (docked) {
                    ...
                    powerManager.wakeUp(
                            SystemClock.uptimeMillis(), 3, "android.service.dreams:DREAM");
                } else {
    ...
    private static boolean isScreenSaverActivatedOnDock(Context context) {
        int def =
                context.getResources().getBoolean(R.bool.config_dreamsActivatedOnDockByDefault)
                        ? 1
                        : 0;
        return Settings.Secure.getIntForUser(
