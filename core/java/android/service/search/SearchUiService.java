...
public abstract class SearchUiService extends Service {
  ...
  private final ISearchUiService mInterface = new BinderC27801();
  ...
  class BinderC27801 extends ISearchUiService.Stub {
    BinderC27801() {}
          ...
          PooledLambda.obtainMessage(
              new TriConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((SearchUiService) obj)
                      .onSearchSessionCreated((SearchContext) obj2, (SearchSessionId) obj3);
                }
              },
      ...
      SearchUiService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new TriConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((SearchUiService) obj)
                      .onCreateSearchSession((SearchContext) obj2, (SearchSessionId) obj3);
                }
              },
              SearchUiService.this,
              context,
          ...
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((SearchUiService) obj)
                      .onNotifyEvent(
                          (SearchSessionId) obj2, (Query) obj3, (SearchTargetEvent) obj4);
                }
              },
              SearchUiService.this,
              sessionId,
          ...
          new CallbackWrapper(
              ...
              new Consumer() { // from class:
                ...
                public final void accept(Object obj) {
                  SearchUiService.this.lambda$doRegisterEmptyQueryResultUpdateCallback$1(
                      callbacks, (SearchUiService.CallbackWrapper) obj);
                }
              }));
      if (callbacks.size() == 1) {
  ...
  static final class CallbackWrapper
    ...
    CallbackWrapper(ISearchCallback callback, Consumer<CallbackWrapper> onBinderDied) {
      ...
      if (onBinderDied != null) {
        try {
          ...
          Slog.m115e(SearchUiService.TAG, "Failed to link to death:" + e);
        }
      }
    }
    ...
    public boolean isCallback(ISearchCallback callback) {
      ...
      if (iSearchCallback == null) {
        Slog.m115e(SearchUiService.TAG, "Callback is null, likely the binder has died.");
        return false;
      }
    ...
    public void accept(List<SearchTarget> searchTargets) {
      try {
        ...
        Slog.m115e(SearchUiService.TAG, "Error sending result:" + e);
      }
    }
