...
public interface ISearchUiService extends IInterface {
  ...
  void onCreateSearchSession(SearchContext searchContext, SearchSessionId searchSessionId)
  ...
  void onQuery(SearchSessionId searchSessionId, Query query, ISearchCallback iSearchCallback)
      throws RemoteException;

  void onRegisterEmptyQueryResultUpdateCallback(
      SearchSessionId searchSessionId, ISearchCallback iSearchCallback) throws RemoteException;

  void onUnregisterEmptyQueryResultUpdateCallback(
      SearchSessionId searchSessionId, ISearchCallback iSearchCallback) throws RemoteException;
  ...
  public static class Default implements ISearchUiService {
    ...
    @Override // android.service.search.ISearchUiService
    public void onNotifyEvent(SearchSessionId sessionId, Query input, SearchTargetEvent event)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements ISearchUiService {
