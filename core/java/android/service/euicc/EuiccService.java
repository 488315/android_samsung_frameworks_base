...
public abstract class EuiccService extends Service {
                ...
                new ThreadPoolExecutor(
                        ...
                        new ThreadFactory() { // from class: android.service.euicc.EuiccService.1
                            ...
                            public Thread newThread(Runnable r) {
                                return new Thread(
                                        r, "EuiccService #" + this.mCount.getAndIncrement());
                            }
                        });
    ...
    public long onGetAvailableMemoryInBytes(int slotId) {
        throw new UnsupportedOperationException(
                "The connected LPA does not"
                    + " implementEuiccService#onGetAvailableMemoryInBytes(int)");
    }
    ...
    class IEuiccServiceWrapper extends IEuiccService.Stub {
                    ...
                    new Runnable() { // from class:
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                Log.w(
                                        EuiccService.TAG,
                                        "The new onDownloadSubscription(int, int,"
                                            + " DownloadableSubscription, boolean, boolean, Bundle)"
                                            + " is not implemented. Fall back to the old one.",
                                        e);
                                result =
                                        EuiccService.this.onDownloadSubscription(
                                                slotId,
        ...
        public void getAvailableMemoryInBytes(
                final int slotId, final IGetAvailableMemoryInBytesCallback callback) {
            EuiccService.this.mExecutor.execute(
                    new Runnable() { // from class:
                                     // android.service.euicc.EuiccService$IEuiccServiceWrapper$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            EuiccService.IEuiccServiceWrapper.this
                                    .lambda$getAvailableMemoryInBytes$0(slotId, callback);
                        }
                    });
        }
                        ...
                        public void run() {
                            ...
                            if (switchAfterDownload) {
                                try {
                                    ...
                                    Log.w(
                                            EuiccService.TAG,
                                            "The new onGetDownloadableSubscriptionMetadata(int,"
                                                + " int, DownloadableSubscription, boolean) is not"
                                                + " implemented. Fall back to the old one.",
                                            e);
                                    result =
                                            EuiccService.this.onGetDownloadableSubscriptionMetadata(
        ...
        public void updateSubscriptionNickname(
            ...
            EuiccService.this.mExecutor.execute(
                    new Runnable() { // from class:
                        ...
                        public void run() {
                            int result =
                                    EuiccService.this.onUpdateSubscriptionNickname(
                                            slotId, iccid, nickname);
                            try {
                                callback.onComplete(result);
                            } catch (RemoteException e) {
                            }
        ...
        public void eraseSubscriptions(
                final int slotId, final IEraseSubscriptionsCallback callback) {
            EuiccService.this.mExecutor.execute(
                    new Runnable() { // from class:
        ...
        public void eraseSubscriptionsWithOptions(
                final int slotIndex,
                final int options,
                final IEraseSubscriptionsCallback callback) {
            EuiccService.this.mExecutor.execute(
                    new Runnable() { // from class:
        ...
        public void retainSubscriptionsForFactoryReset(
            ...
            EuiccService.this.mExecutor.execute(
                    new Runnable() { // from class:
                                     // android.service.euicc.EuiccService.IEuiccServiceWrapper.14
                        @Override // java.lang.Runnable
                        public void run() {
                            int result =
                                    EuiccService.this.onRetainSubscriptionsForFactoryReset(slotId);
                            try {
                                callback.onComplete(result);
                            } catch (RemoteException e) {
                            }
        ...
        public void dump(final IEuiccServiceDumpResultCallback callback) throws RemoteException {
            EuiccService.this.mExecutor.execute(
                    new Runnable() { // from class:
                                     // android.service.euicc.EuiccService.IEuiccServiceWrapper.15
                        @Override // java.lang.Runnable
                        public void run() {
                            try {
