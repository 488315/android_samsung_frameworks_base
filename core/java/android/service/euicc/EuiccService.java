...
public abstract class EuiccService extends Service {
  ...
  public static final String ACTION_RESOLVE_NO_EUICC_TARGET =
      "android.service.euicc.action.RESOLVE_NO_EUICC_TARGET";
  public static final String ACTION_RESOLVE_NO_PRIVILEGES =
      "android.service.euicc.action.RESOLVE_NO_PRIVILEGES";
  public static final String ACTION_RESOLVE_RESOLVABLE_ERRORS =
      "android.service.euicc.action.RESOLVE_RESOLVABLE_ERRORS";
  public static final String ACTION_RESOLVE_UPDATE_VERSION_AVAILABLE =
      "android.service.euicc.action.RESOLVE_UPDATE_VERSION_AVAILABLE";
  ...
  @Deprecated public static final int RESULT_NEED_CONFIRMATION_CODE = -2;
  ...
  public abstract GetDefaultDownloadableSubscriptionListResult
      onGetDefaultDownloadableSubscriptionList(int i, boolean z);

  public abstract GetDownloadableSubscriptionMetadataResult onGetDownloadableSubscriptionMetadata(
      int i, DownloadableSubscription downloadableSubscription, boolean z);
  ...
  public abstract void onStartOtaIfNecessary(
      int i, OtaStatusChangedCallback otaStatusChangedCallback);
  ...
  public void onCreate() {
    ...
    ThreadPoolExecutor threadPoolExecutor =
        new ThreadPoolExecutor(
            ...
            new ThreadFactory() { // from class: android.service.euicc.EuiccService.1
  ...
  @Deprecated
  public int onDownloadSubscription(
      int slotId,
      DownloadableSubscription subscription,
      boolean switchAfterDownload,
      boolean forceDeactivateSim) {
  ...
  private class IEuiccServiceWrapper extends IEuiccService.Stub {
    ...
    public void downloadSubscription(
        final int slotId,
        final int portIndex,
        final DownloadableSubscription subscription,
        final boolean switchAfterDownload,
        final boolean forceDeactivateSim,
        final Bundle resolvedBundle,
        final IDownloadSubscriptionCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.1
            ...
            public void run() {
              ...
              try {
                ...
                Log.m103w(
                    EuiccService.TAG,
                    "The new onDownloadSubscription(int, int, DownloadableSubscription, boolean,"
                        + " boolean, Bundle) is not implemented. Fall back to the old one.",
                    e);
                result =
                    EuiccService.this.onDownloadSubscription(
                        slotId,
    ...
    public void getEid(final int slotId, final IGetEidCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void startOtaIfNecessary(
        final int slotId, final IOtaStatusChangedCallback statusChangedCallback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.3
            @Override // java.lang.Runnable
            public void run() {
              EuiccService.this.onStartOtaIfNecessary(
                  slotId,
                  new OtaStatusChangedCallback() { // from class:
    ...
    public void getOtaStatus(final int slotId, final IGetOtaStatusCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.4
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void getDownloadableSubscriptionMetadata(
        ...
        final boolean switchAfterDownload,
        final boolean forceDeactivateSim,
        final IGetDownloadableSubscriptionMetadataCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.5
            @Override // java.lang.Runnable
            public void run() {
              ...
              if (switchAfterDownload) {
                try {
                  ...
                  Log.m103w(
                      EuiccService.TAG,
                      "The new onGetDownloadableSubscriptionMetadata(int, int,"
                          + " DownloadableSubscription, boolean) is not implemented. Fall back to"
                          + " the old one.",
                      e);
                  result =
                      EuiccService.this.onGetDownloadableSubscriptionMetadata(
    ...
    public void getDefaultDownloadableSubscriptionList(
        final int slotId,
        final boolean forceDeactivateSim,
        final IGetDefaultDownloadableSubscriptionListCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.6
            @Override // java.lang.Runnable
            public void run() {
    ...
    @Override // android.service.euicc.IEuiccService
    public void getEuiccProfileInfoList(
        final int slotId, final IGetEuiccProfileInfoListCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.7
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void getEuiccInfo(final int slotId, final IGetEuiccInfoCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.8
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void deleteSubscription(
        final int slotId, final String iccid, final IDeleteSubscriptionCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.9
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void switchToSubscription(
        ...
        final String iccid,
        final boolean forceDeactivateSim,
        final ISwitchToSubscriptionCallback callback,
        final boolean usePortIndex) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.10
            @Override // java.lang.Runnable
            public void run() {
              int result;
              if (usePortIndex) {
    ...
    public void updateSubscriptionNickname(
        ...
        final IUpdateSubscriptionNicknameCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.11
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void eraseSubscriptions(final int slotId, final IEraseSubscriptionsCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.12
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void eraseSubscriptionsWithOptions(
        final int slotIndex, final int options, final IEraseSubscriptionsCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.13
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void retainSubscriptionsForFactoryReset(
        final int slotId, final IRetainSubscriptionsForFactoryResetCallback callback) {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.14
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void dump(final IEuiccServiceDumpResultCallback callback) throws RemoteException {
      EuiccService.this.mExecutor.execute(
          new Runnable() { // from class: android.service.euicc.EuiccService.IEuiccServiceWrapper.15
            @Override // java.lang.Runnable
            public void run() {
              try {
