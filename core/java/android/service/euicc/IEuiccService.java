...
public interface IEuiccService extends IInterface {
  ...
  public static class Default implements IEuiccService {
    ...
    public void updateSubscriptionNickname(
        int slotId, String iccid, String nickname, IUpdateSubscriptionNicknameCallback callback)
        throws RemoteException {}
    ...
    public void eraseSubscriptionsWithOptions(
        int slotIndex, int options, IEraseSubscriptionsCallback callback) throws RemoteException {}

    @Override // android.service.euicc.IEuiccService
    public void retainSubscriptionsForFactoryReset(
        int slotId, IRetainSubscriptionsForFactoryResetCallback callback) throws RemoteException {}
          ...
          switch (code) {
            case 1:
              ...
              DownloadableSubscription _arg2 =
                  (DownloadableSubscription) data.readTypedObject(DownloadableSubscription.CREATOR);
            ...
            case 6:
              ...
              IGetEuiccProfileInfoListCallback _arg16 =
                  IGetEuiccProfileInfoListCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 11:
              ...
              IUpdateSubscriptionNicknameCallback _arg34 =
                  IUpdateSubscriptionNicknameCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 15:
              IEuiccServiceDumpResultCallback _arg015 =
                  IEuiccServiceDumpResultCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              dump(_arg015);
              return true;
            default:
