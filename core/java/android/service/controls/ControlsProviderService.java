            ...
            switch (msg.what) {
                case 1:
                    ...
                    Log.d(
                            ...
                            "createPublisherForAllAvailable mToken:"
                ...
                case 2:
                    ...
                    Log.d(
                            ...
                            "createPublisherFor mToken:"
                                    ...
                                    + sMsg.mControlIds);
                    ControlsProviderService.this
                            .createPublisherFor(sMsg.mControlIds)
                            .subscribe(proxy2);
                    break;
                case 3:
                ...
                case 4:
                    ...
                    if (publisher == null) {
                        Log.i(
                                ControlsProviderService.TAG,
                                "No publisher provided for suggested controls");
                        proxy3.onComplete();
                        break;
                    } else {
                        Log.d(
                                ControlsProviderService.TAG,
                                "createPublisherForSuggested mToken:"
                                        + ControlsProviderService.this.mToken);
                    ...
                    try {
                        cpis.onNext(
                                ...
                                (ControlsProviderInfo)
                                        ControlsProviderService.this.mControlsProviderInfoSupplier
                                                .get());
        ...
        public void onNext(Control control) {
            ...
            try {
                if (this.mEnforceStateless
                        && !ControlsProviderService.isStatelessControl(control)) {
                    Log.w(
                            ControlsProviderService.TAG,
                            "onNext(): control is not stateless. Use the Control.StatelessBuilder()"
