...
public abstract class ControlsProviderService extends Service {
  ...
  public static final String EXTRA_CONTROL_AUTO_ADD =
      "android.service.controls.extra.CONTROL_AUTO_ADD";
  ...
  public abstract void performControlAction(
      String str, ControlAction controlAction, Consumer<Integer> consumer);
  ...
  public final IBinder onBind(Intent intent) {
    ...
    return new IControlsProvider
        .Stub() { // from class: android.service.controls.ControlsProviderService.1
  ...
  class RequestHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        case 1:
          ...
          SubscriberProxy proxy =
              new SubscriberProxy(true, ControlsProviderService.this.mToken, cs);
          Log.m94d(
              ControlsProviderService.TAG,
              "createPublisherForAllAvailable mToken:" + ControlsProviderService.this.mToken);
        ...
        case 2:
          ...
          SubscriberProxy proxy2 =
              new SubscriberProxy(
                  controlsProviderService, false, controlsProviderService.mToken, sMsg.mSubscriber);
          Log.m94d(
              ControlsProviderService.TAG,
              "createPublisherFor mToken:"
                  + ControlsProviderService.this.mToken
                  + ", ControlIds:"
                  + sMsg.mControlIds);
        ...
        case 3:
          ...
          Log.m94d(
              ControlsProviderService.TAG,
              "performControlAction mToken:"
                  + ControlsProviderService.this.mToken
                  + ", ControlId:"
                  + aMsg.mControlId);
          ControlsProviderService.this.performControlAction(
              aMsg.mControlId, aMsg.mAction, consumerFor(aMsg.mControlId, aMsg.mCb));
          break;
        case 4:
          IControlsSubscriber cs2 = (IControlsSubscriber) msg.obj;
          SubscriberProxy proxy3 =
              new SubscriberProxy(true, ControlsProviderService.this.mToken, cs2);
          ...
          if (publisher == null) {
            ...
            Log.m94d(
                ControlsProviderService.TAG,
                "createPublisherForSuggested mToken:" + ControlsProviderService.this.mToken);
          ...
          try {
            cpis.onNext(
                ...
                (ControlsProviderInfo)
                    ControlsProviderService.this.mControlsProviderInfoSupplier.get());
    ...
    private Consumer<Integer> consumerFor(
        final String controlId, final IControlsActionCallback cb) {
      return new Consumer() { // from class:
                              // android.service.controls.ControlsProviderService$RequestHandler$$ExternalSyntheticLambda0
        @Override // java.util.function.Consumer
        public final void accept(Object obj) {
          ControlsProviderService.RequestHandler.this.lambda$consumerFor$0(
              cb, controlId, (Integer) obj);
        }
      };
    }
  ...
  private static class SubscriberProxy implements Flow.Subscriber<Control> {
    ...
    SubscriberProxy(
        Context context, boolean enforceStateless, IBinder token, IControlsSubscriber cs) {
    ...
    public void onNext(Control control) {
      ...
      try {
        if (this.mEnforceStateless && !ControlsProviderService.isStatelessControl(control)) {
          Log.m102w(
              ControlsProviderService.TAG,
              "onNext(): control is not stateless. Use the Control.StatelessBuilder() to build the"
                  + " control.");
  ...
  public static void requestAddControl(
      Context context, ComponentName componentName, Control control) {
  ...
  public static void requestAddControl(
      Context context, ComponentName componentName, Control control, boolean autoAdd) {
    Preconditions.checkNotNull(context);
    Preconditions.checkNotNull(componentName);
    Preconditions.checkNotNull(control);
    String controlsPackage = context.getString(C4337R.string.config_controlsPackage);
  ...
  public static void requestAddControls(
      Context context, ComponentName componentName, List<Control> controls, boolean autoAdd) {
    Preconditions.checkNotNull(context);
    Preconditions.checkNotNull(componentName);
