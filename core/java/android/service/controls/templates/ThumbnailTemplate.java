...
public final class ThumbnailTemplate extends ControlTemplate {
    ...
    public void prepareTemplateForBinder(Context context) {
        int width = context.getResources().getDimensionPixelSize(C4337R.dimen.controls_thumbnail_image_max_width);
        int height = context.getResources().getDimensionPixelSize(C4337R.dimen.controls_thumbnail_image_max_height);
