...
public abstract class TranslationService extends Service {
  ...
  private final ITranslationService mInterface = new BinderC28081();
  private final ITranslationDirectManager mClientInterface =
      new ITranslationDirectManager
          .Stub() { // from class: android.service.translation.TranslationService.2
        ...
        public void onTranslationRequest(
          ...
          TranslationService.this.mHandler.sendMessage(
              PooledLambda.obtainMessage(
                  new QuintConsumer() { // from class:
                                        // android.service.translation.TranslationService$2$$ExternalSyntheticLambda0
                    @Override // com.android.internal.util.function.QuintConsumer
                    public final void accept(
                        Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                      ((TranslationService) obj)
                          .onTranslationRequest(
                              (TranslationRequest) obj2,
                              ((Integer) obj3).intValue(),
                              (CancellationSignal) obj4,
                              (Consumer<TranslationResponse>) obj5);
                    }
                  },
          ...
          TranslationService.this.mHandler.sendMessage(
              PooledLambda.obtainMessage(
                  new BiConsumer() { // from class:
                                     // android.service.translation.TranslationService$2$$ExternalSyntheticLambda1
                    @Override // java.util.function.BiConsumer
                    public final void accept(Object obj, Object obj2) {
                      ((TranslationService) obj)
                          .onFinishTranslationSession(((Integer) obj2).intValue());
                    }
                  },
                  TranslationService.this,
                  Integer.valueOf(sessionId)));
  ...
  public abstract void onCreateTranslationSession(
      TranslationContext translationContext, int i, Consumer<Boolean> consumer);

  public abstract void onFinishTranslationSession(int i);

  public abstract void onTranslationCapabilitiesRequest(
      int i, int i2, Consumer<Set<TranslationCapability>> consumer);

  public abstract void onTranslationRequest(
      TranslationRequest translationRequest,
      int i,
      CancellationSignal cancellationSignal,
      Consumer<TranslationResponse> consumer);

  /* renamed from: android.service.translation.TranslationService$1 */
  class BinderC28081 extends ITranslationService.Stub {
    BinderC28081() {}
    ...
    public void onConnected(IBinder callback) {
      TranslationService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // android.service.translation.TranslationService$1$$ExternalSyntheticLambda1
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
      ...
      TranslationService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new Consumer() { // from class:
                               // android.service.translation.TranslationService$1$$ExternalSyntheticLambda2
      ...
      TranslationService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                                   // android.service.translation.TranslationService$1$$ExternalSyntheticLambda0
                @Override // com.android.internal.util.function.QuadConsumer
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((TranslationService) obj)
                      .handleOnCreateTranslationSession(
                          (TranslationContext) obj2,
                          ((Integer) obj3).intValue(),
    ...
    public void onTranslationCapabilitiesRequest(
        int sourceFormat, int targetFormat, ResultReceiver resultReceiver) throws RemoteException {
      TranslationService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                                   // android.service.translation.TranslationService$1$$ExternalSyntheticLambda3
                @Override // com.android.internal.util.function.QuadConsumer
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((TranslationService) obj)
                      .handleOnTranslationCapabilitiesRequest(
              ...
              TranslationService.this,
              Integer.valueOf(sourceFormat),
              Integer.valueOf(targetFormat),
              resultReceiver));
    }
  }
  ...
  public final IBinder onBind(Intent intent) {
    ...
    Log.m102w(
        TAG,
        "Tried to bind to wrong intent (should be android.service.translation.TranslationService: "
            + intent);
    return null;
  }
  ...
  public void onTranslationRequest(
      ...
      int sessionId,
      CancellationSignal cancellationSignal,
      OnTranslationResultCallback callback) {}
  ...
  public final void updateTranslationCapability(TranslationCapability capability) {
    ...
    if (callback == null) {
      Log.m102w(TAG, "updateTranslationCapability(): no server callback");
      return;
    }
    try {
  ...
  public void handleOnCreateTranslationSession(
    ...
    onCreateTranslationSession(
        translationContext,
        sessionId,
        new Consumer<Boolean>() { // from class: android.service.translation.TranslationService.3
          @Override // java.util.function.Consumer
          public void accept(Boolean created) {
            try {
              if (!created.booleanValue()) {
                Log.m102w(
                    TranslationService.TAG,
                    "handleOnCreateTranslationSession(): context="
                        + translationContext
              ...
              Log.m102w(TranslationService.TAG, "RemoteException sending client interface: " + e);
            }
          }
        });
  }
        ...
        new Consumer<
            Set<
                TranslationCapability>>() { // from class:
                                            // android.service.translation.TranslationService.4
          @Override // java.util.function.Consumer
          public void accept(Set<TranslationCapability> values) {
            ...
            ParceledListSlice<TranslationCapability> listSlice =
                new ParceledListSlice<>(
                    Arrays.asList(
                        (TranslationCapability[]) values.toArray(new TranslationCapability[0])));
