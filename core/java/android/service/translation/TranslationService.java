...
public abstract class TranslationService extends Service {
    ...
    class AnonymousClass1 extends ITranslationService.Stub {
        ...
        public void onTranslationCapabilitiesRequest(
                int sourceFormat, int targetFormat, ResultReceiver resultReceiver)
                throws RemoteException {
            TranslationService.this.mHandler.sendMessage(
                    PooledLambda.obtainMessage(
                            new QuadConsumer() { // from class:
    ...
    public void handleOnCreateTranslationSession(
        ...
        onCreateTranslationSession(
                ...
                sessionId,
                new Consumer<
                        Boolean>() { // from class: android.service.translation.TranslationService.3
                    @Override // java.util.function.Consumer
                    public void accept(Boolean created) {
                        try {
                            if (!created.booleanValue()) {
                                ...
                                extras.putBinder(
                                        "binder",
                                        TranslationService.this.mClientInterface.asBinder());
                            ...
                            Log.w(
                                    TranslationService.TAG,
                                    "RemoteException sending client interface: " + e);
                        }
                    }
                });
    }
        ...
        onTranslationCapabilitiesRequest(
                ...
                new Consumer<
                    ...
                    public void accept(Set<TranslationCapability> values) {
                        if (!TranslationService.this.isValidCapabilities(
                                sourceFormat, targetFormat, values)) {
                            throw new IllegalStateException(
                                    "Invalid capabilities and format compatibility");
                        }
