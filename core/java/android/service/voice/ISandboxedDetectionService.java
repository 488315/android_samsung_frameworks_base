...
public interface ISandboxedDetectionService extends IInterface {
    ...
    void registerRemoteStorageService(IDetectorSessionStorageService iDetectorSessionStorageService)
            throws RemoteException;
    ...
    void updateRecognitionServiceManager(IRecognitionServiceManager iRecognitionServiceManager)
            throws RemoteException;
    ...
    public static class Default implements ISandboxedDetectionService {
        ...
        @Override // android.service.voice.ISandboxedDetectionService
        public void updateContentCaptureManager(
                IContentCaptureManager contentCaptureManager, ContentCaptureOptions options)
                throws RemoteException {}

        @Override // android.service.voice.ISandboxedDetectionService
        public void updateRecognitionServiceManager(
                IRecognitionServiceManager recognitionServiceManager) throws RemoteException {}
        ...
        public void registerRemoteStorageService(
                IDetectorSessionStorageService detectorSessionStorageService)
                throws RemoteException {}
    ...
    public abstract static class Stub extends Binder implements ISandboxedDetectionService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
            ...
            switch (code) {
                case 1:
                    ...
                    IDspHotwordDetectionCallback _arg3 =
                            IDspHotwordDetectionCallback.Stub.asInterface(data.readStrongBinder());
                ...
                case 2:
                    ...
                    IDspHotwordDetectionCallback _arg4 =
                            IDspHotwordDetectionCallback.Stub.asInterface(data.readStrongBinder());
                    data.enforceNoDataAvail();
                    detectFromMicrophoneSource(_arg02, _arg12, _arg22, _arg32, _arg4);
                    return true;
                case 3:
                    IDetectorSessionVisualQueryDetectionCallback _arg03 =
                            IDetectorSessionVisualQueryDetectionCallback.Stub.asInterface(
                ...
                case 5:
                    ...
                    return true;
                case 6:
                    IContentCaptureManager _arg06 =
                            IContentCaptureManager.Stub.asInterface(data.readStrongBinder());
                    ContentCaptureOptions _arg14 =
                    ...
                    return true;
                case 7:
                    IRecognitionServiceManager _arg07 =
                            IRecognitionServiceManager.Stub.asInterface(data.readStrongBinder());
                    data.enforceNoDataAvail();
                    updateRecognitionServiceManager(_arg07);
                    return true;
                case 8:
                    IRemoteCallback _arg08 =
                            IRemoteCallback.Stub.asInterface(data.readStrongBinder());
                    data.enforceNoDataAvail();
                    ping(_arg08);
                    return true;
                case 9:
                    ...
                    return true;
                case 10:
                    IDetectorSessionStorageService _arg09 =
                            IDetectorSessionStorageService.Stub.asInterface(
                                    data.readStrongBinder());
                    data.enforceNoDataAvail();
        ...
        private static class Proxy implements ISandboxedDetectionService {
            ...
            public void detectWithVisualSignals(
                    IDetectorSessionVisualQueryDetectionCallback callback) throws RemoteException {
                Parcel _data = Parcel.obtain(asBinder());
                try {
                    _data.writeInterfaceToken(ISandboxedDetectionService.DESCRIPTOR);
                    _data.writeStrongInterface(callback);
