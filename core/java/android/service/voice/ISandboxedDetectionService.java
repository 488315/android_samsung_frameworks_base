...
public interface ISandboxedDetectionService extends IInterface {
  ...
  void detectWithVisualSignals(
      IDetectorSessionVisualQueryDetectionCallback iDetectorSessionVisualQueryDetectionCallback)
      throws RemoteException;
  ...
  void updateContentCaptureManager(
      IContentCaptureManager iContentCaptureManager, ContentCaptureOptions contentCaptureOptions)
      throws RemoteException;
          ...
          switch (code) {
            ...
            case 6:
              ...
              ContentCaptureOptions _arg14 =
                  (ContentCaptureOptions) data.readTypedObject(ContentCaptureOptions.CREATOR);
              data.enforceNoDataAvail();
