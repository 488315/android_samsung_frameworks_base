...
public final class HotwordAudioStream implements Parcelable {
  ...
  public static final Parcelable.Creator<HotwordAudioStream> CREATOR =
      new Parcelable.Creator<
          HotwordAudioStream>() { // from class: android.service.voice.HotwordAudioStream.1
  ...
  public Builder buildUpon() {
    return new Builder(this.mAudioFormat, this.mAudioStreamParcelFileDescriptor)
        .setTimestamp(this.mTimestamp)
        .setMetadata(this.mMetadata)
        .setInitialAudio(this.mInitialAudio);
  }
  ...
  HotwordAudioStream(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) audioFormat);
    this.mAudioStreamParcelFileDescriptor = audioStreamParcelFileDescriptor;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) audioStreamParcelFileDescriptor);
    this.mTimestamp = timestamp;
    this.mMetadata = metadata;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) metadata);
    this.mInitialAudio = initialAudio;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) initialAudio);
  }
  ...
  public String toString() {
    return "HotwordAudioStream { audioFormat = "
        + this.mAudioFormat
        + ", audioStreamParcelFileDescriptor = "
        + this.mAudioStreamParcelFileDescriptor
        + ", timestamp = "
        + this.mTimestamp
        + ", metadata = "
        + this.mMetadata
        + ", initialAudio = "
        + initialAudioToString()
        + " }";
  }
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(this.mAudioFormat, that.mAudioFormat)
        && Objects.equals(
            this.mAudioStreamParcelFileDescriptor, that.mAudioStreamParcelFileDescriptor)
        && Objects.equals(this.mTimestamp, that.mTimestamp)
        && Objects.equals(this.mMetadata, that.mMetadata)
        && Arrays.equals(this.mInitialAudio, that.mInitialAudio)) {
      return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    return (((((((_hash * 31) + Objects.hashCode(this.mAudioStreamParcelFileDescriptor)) * 31)
                        + Objects.hashCode(this.mTimestamp))
                    * 31)
                + Objects.hashCode(this.mMetadata))
            * 31)
  ...
  HotwordAudioStream(Parcel in) {
    ...
    AudioTimestamp timestamp =
        (flg & 4) == 0 ? null : (AudioTimestamp) in.readTypedObject(AudioTimestamp.CREATOR);
  ...
  public static final class Builder extends BaseBuilder {
    ...
    public HotwordAudioStream build() {
      ...
      HotwordAudioStream o =
          new HotwordAudioStream(
              this.mAudioFormat,
              this.mAudioStreamParcelFileDescriptor,
              this.mTimestamp,
              this.mMetadata,
