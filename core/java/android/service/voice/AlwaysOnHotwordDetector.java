...
public class AlwaysOnHotwordDetector extends AbstractDetector {
  ...
  public void triggerHardwareRecognitionEventForTest(
      ...
      byte[] data,
      List<SoundTrigger.KeyphraseRecognitionExtra> keyphraseRecognitionExtras) {
    Log.m94d(TAG, "triggerHardwareRecognitionEventForTest()");
    synchronized (this.mLock) {
      int i = this.mAvailability;
      if (i == -3 || i == 3) {
        throw new IllegalStateException(
            "triggerHardwareRecognitionEventForTest called on an invalid detector or error state");
      }
      try {
  ...
  private void detachSessionLocked() {
    try {
      IVoiceInteractionSoundTriggerSession iVoiceInteractionSoundTriggerSession =
          this.mSoundTriggerSession;
    ...
    synchronized (this.mLock) {
      ...
      if (i != -3 && i != -2 && i != 3) {
        if (this.mIsAvailabilityOverriddenByTestApi) {
          Slog.m121w(
              TAG,
              "Suppressing system availability update. Availability is overridden by test API.");
          return;
        }
        if (i == 2) {
          try {
            ...
            if (result == 0) {
              sendSoundTriggerFailure(
                  new SoundTriggerFailure(
                      0, "stopped recognition because of enrollment update", 4));
            }
            Log.m102w(TAG, "Failed to stop recognition after enrollment update: code=" + result);
          } catch (Exception e) {
            Slog.m122w(TAG, "Failed to stop recognition after enrollment update", e);
      ...
      Slog.m121w(
          TAG,
          "Received onSoundModelsChanged for an unsupported keyphrase/config or in the error"
              + " state");
    }
  }
    ...
    try {
      int code =
          this.mSoundTriggerSession.startRecognition(
              ...
              runInBatterySaver);
      if (code != 0) {
        Slog.m121w(TAG, "startRecognition() failed with error code " + code);
      }
      return code;
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
  ...
  private int stopRecognitionLocked() {
    try {
      ...
      if (code != 0) {
        Slog.m121w(TAG, "stopRecognition() failed with error code " + code);
      }
      return code;
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
  ...
  private int setParameterLocked(int modelParam, int value) {
    try {
      ...
      if (code != 0) {
        Slog.m121w(TAG, "setParameter failed with error code " + code);
      }
      return code;
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
  ...
  private ModelParamRange queryParameterLocked(int modelParam) {
    try {
      SoundTrigger.ModelParamRange modelParamRange =
          this.mSoundTriggerSession.queryParameter(this.mKeyphraseMetadata.getId(), modelParam);
  ...
  static final class SoundTriggerListener extends IHotwordRecognitionStatusCallback.Stub {
    ...
    public void onKeyphraseDetected(
      ...
      Slog.m117i(AlwaysOnHotwordDetector.TAG, "onDetected");
      Message.obtain(
              this.mHandler,
              2,
              new EventPayload.Builder(event).setHotwordDetectedResult(result).build())
          .sendToTarget();
    }
    ...
    public void onGenericSoundTriggerDetected(SoundTrigger.GenericRecognitionEvent event) {
      Slog.m121w(
          AlwaysOnHotwordDetector.TAG, "Generic sound trigger event detected at AOHD: " + event);
    }

    @Override // com.android.internal.app.IHotwordRecognitionStatusCallback
    public void onRejected(HotwordRejectedResult result) {
      Slog.m117i(AlwaysOnHotwordDetector.TAG, "onRejected");
    ...
    public void onUnknownFailure(String errorMessage) throws RemoteException {
      Slog.m119v(AlwaysOnHotwordDetector.TAG, "onUnknownFailure: " + errorMessage);
      Message.obtain(
              this.mHandler,
              11,
    ...
    public void onRecognitionPaused() {
      Slog.m117i(AlwaysOnHotwordDetector.TAG, "onRecognitionPaused");
      this.mHandler.sendEmptyMessage(4);
    }

    @Override // com.android.internal.app.IHotwordRecognitionStatusCallback
    public void onRecognitionResumed() {
      Slog.m117i(AlwaysOnHotwordDetector.TAG, "onRecognitionResumed");
      this.mHandler.sendEmptyMessage(5);
    }

    @Override // com.android.internal.app.IHotwordRecognitionStatusCallback
    public void onStatusReported(int status) {
      Slog.m117i(AlwaysOnHotwordDetector.TAG, "onStatusReported");
    ...
    public void onProcessRestarted() {
      Slog.m117i(AlwaysOnHotwordDetector.TAG, "onProcessRestarted");
  ...
  class MyHandler extends Handler {
    ...
    public /* synthetic */ void lambda$handleMessage$0(Message message) {
      Slog.m117i(AlwaysOnHotwordDetector.TAG, "handle message " + message.what);
      switch (message.what) {
        case 1:
        ...
        case 6:
          ...
          break;
        case 7:
          AlwaysOnHotwordDetector.this.mExternalCallback.onHotwordDetectionServiceInitialized(
              message.arg1);
          break;
        case 8:
  ...
  class RefreshAvailabilityTask extends AsyncTask<Void, Void, Void> {
    ...
    public Void doInBackground(Void... params) {
      try {
        ...
        Slog.m122w(AlwaysOnHotwordDetector.TAG, "Failed to refresh availability", e);
        synchronized (AlwaysOnHotwordDetector.this.mLock) {
        ...
        if (!CompatChanges.isChangeEnabled(AlwaysOnHotwordDetector.THROW_ON_INITIALIZE_IF_NO_DSP)) {
          try {
            SoundTrigger.ModuleProperties dspModuleProperties =
                AlwaysOnHotwordDetector.this.mSoundTriggerSession.getDspModuleProperties();
    ...
    private void internalUpdateEnrolledKeyphraseMetadata() {
      try {
        ...
        alwaysOnHotwordDetector.mKeyphraseMetadata =
            alwaysOnHotwordDetector.mModelManagementService.getEnrolledKeyphraseMetadata(
