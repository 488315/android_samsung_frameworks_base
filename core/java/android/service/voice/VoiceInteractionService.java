...
public class VoiceInteractionService extends Service {
  ...
  IVoiceInteractionService mInterface = new BinderC28401();
  ...
  class BinderC28401 extends IVoiceInteractionService.Stub {
    BinderC28401() {}
                  ...
                  new TriConsumer() { // from class:
                    ...
                    public final void accept(Object obj, Object obj2, Object obj3) {
                      ((VoiceInteractionService) obj)
                          .onHandleVoiceActionCheck((List) obj2, (IVoiceActionCheckCallback) obj3);
                    }
                  },
                  VoiceInteractionService.this,
                  voiceActions,
          ...
          .executeOrSendMessage(
              PooledLambda.obtainMessage(
                  new TriConsumer() { // from class:
                    ...
                    public final void accept(Object obj, Object obj2, Object obj3) {
                      ((VoiceInteractionService) obj)
                          .onPrepareToShowSession((Bundle) obj2, ((Integer) obj3).intValue());
                    }
                  },
                  VoiceInteractionService.this,
                  args,
    ...
    public void detectorRemoteExceptionOccurred(IBinder token, int detectorType) {
      Log.m94d(VoiceInteractionService.TAG, "detectorRemoteExceptionOccurred");
      Handler.getMain()
          .executeOrSendMessage(
              PooledLambda.obtainMessage(
                  new TriConsumer() { // from class:
                    ...
                    public final void accept(Object obj, Object obj2, Object obj3) {
                      ((VoiceInteractionService) obj)
                          .onDetectorRemoteException((IBinder) obj2, ((Integer) obj3).intValue());
                    }
                  },
                  VoiceInteractionService.this,
                  token,
  ...
  public void onDetectorRemoteException(final IBinder token, final int detectorType) {
    Log.m94d(
        TAG, "onDetectorRemoteException for " + HotwordDetector.detectorTypeToString(detectorType));
  ...
  public /* synthetic */ void lambda$new$1() {
    Log.m96e(TAG, "system service binder died shutting down");
    Handler.getMain()
        .executeOrSendMessage(
            PooledLambda.obtainMessage(
                new Consumer() { // from class:
  ...
  public final AlwaysOnHotwordDetector createAlwaysOnHotwordDetectorForTest(
    ...
    Objects.requireNonNull(callback);
    return createAlwaysOnHotwordDetectorInternal(
        keyphrase, locale, true, options, sharedMemory, moduleProperties, executor, callback);
  }
            ...
            for (HotwordDetector detector : this.mActiveDetectors) {
              if (detector.isUsingSandboxedDetectionService() != supportHotwordDetectionService) {
                throw new IllegalStateException(
                    "It disallows to create trusted and non-trusted detectors at the same time.");
              }
              try {
                if (detector instanceof AlwaysOnHotwordDetector) {
                  throw new IllegalStateException(
                      "There is already an active AlwaysOnHotwordDetector. It must be destroyed to"
                          + " create a new one.");
                }
              } catch (Throwable th) {
                e = th;
  ...
  public final HotwordDetector createHotwordDetector(
      PersistableBundle options, SharedMemory sharedMemory, HotwordDetector.Callback callback) {
      ...
      if (!CompatChanges.isChangeEnabled(MULTIPLE_ACTIVE_HOTWORD_DETECTORS)) {
        ...
        for (HotwordDetector detector : this.mActiveDetectors) {
          ...
          if (detector instanceof SoftwareHotwordDetector) {
            throw new IllegalStateException(
                "There is already an active SoftwareHotwordDetector. It must be destroyed to create"
                    + " a new one.");
          }
        }
      }
      softwareHotwordDetector =
          new SoftwareHotwordDetector(this.mSystemService, null, executor, callback);
  ...
  public final VisualQueryDetector createVisualQueryDetector(
    ...
    synchronized (this.mLock) {
      if (this.mActiveVisualQueryDetector != null) {
        throw new IllegalStateException(
            "There is already an active VisualQueryDetector. It must be destroyed to create a new"
                + " one.");
      }
      for (HotwordDetector detector : this.mActiveDetectors) {
        if (!detector.isUsingSandboxedDetectionService()) {
  ...
  public final boolean isKeyphraseAndLocaleSupportedForHotword(String keyphrase, Locale locale) {
    ...
    return (keyphraseEnrollmentInfo == null
            || keyphraseEnrollmentInfo.getKeyphraseMetadata(keyphrase, locale) == null)
        ? false
        : true;
  }
  ...
  public /* synthetic */ void lambda$safelyShutdownAllHotwordDetectors$4(
    ...
    try {
      ...
      if (visualQueryDetector == null
          || detector != visualQueryDetector.getInitializationDelegate()
          || shouldShutDownVisualQueryDetector) {
        detector.destroy();
      }
    } catch (Exception ex) {
      Log.m99i(TAG, "exception destroying HotwordDetector", ex);
    }
  }
