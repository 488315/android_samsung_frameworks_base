...
public abstract class VisualQueryDetectionService extends Service
    ...
    private final ISandboxedDetectionService mInterface =
            new ISandboxedDetectionService
                    .Stub() { // from class: android.service.voice.VisualQueryDetectionService.1
                ...
                public void updateState(
                    ...
                    Log.v(
                            VisualQueryDetectionService.TAG,
                ...
                public void detectFromDspSource(
                    ...
                    throw new UnsupportedOperationException(
                            "Not supported by VisualQueryDetectionService");
                }
                ...
                public void updateContentCaptureManager(
                    ...
                    VisualQueryDetectionService.this.mContentCaptureManager =
                ...
                public void registerRemoteStorageService(
                    ...
                    VisualQueryDetectionService.this.mDetectorSessionStorageService =
    ...
    public final void streamQuery(String partialQuery) throws IllegalStateException {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "#streamQuery must be only be triggered after calling #gainedAttention to be in"
    ...
    public final void rejectQuery() throws IllegalStateException {
        try {
            ...
            throw new IllegalStateException(
                    "#rejectQuery must be only be triggered after calling #streamQuery to be in the"
    ...
    public final void finishQuery() throws IllegalStateException {
        try {
            ...
            throw new IllegalStateException(
                    "#finishQuery must be only be triggered after calling #streamQuery to be in the"
                        + " query streaming state.");
        }
    }
        ...
        try {
            ...
            if (pfd == null) {
                throw new FileNotFoundException(
                        "File does not exist. Unable to open " + filename + MediaMetrics.SEPARATOR);
            }
