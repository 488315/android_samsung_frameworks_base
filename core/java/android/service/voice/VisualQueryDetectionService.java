...
public abstract class VisualQueryDetectionService extends Service
  ...
  private final ISandboxedDetectionService mInterface =
      new ISandboxedDetectionService
        ...
        public void detectWithVisualSignals(IDetectorSessionVisualQueryDetectionCallback callback) {
          Log.m100v(VisualQueryDetectionService.TAG, "#detectWithVisualSignals");
        ...
        public void stopDetection() {
          Log.m100v(VisualQueryDetectionService.TAG, "#stopDetection");
        ...
        public void updateContentCaptureManager(
          ...
          VisualQueryDetectionService.this.mContentCaptureManager =
              new ContentCaptureManager(VisualQueryDetectionService.this, manager, options);
        }
  ...
  public final void streamQuery(String partialQuery) throws IllegalStateException {
    ...
    try {
      ...
      throw new IllegalStateException(
          "#streamQuery must be only be triggered after calling #gainedAttention to be in the"
  ...
  public final void rejectQuery() throws IllegalStateException {
    try {
      ...
      throw new IllegalStateException(
          "#rejectQuery must be only be triggered after calling #streamQuery to be in the query"
              + " streaming state.");
    }
  }
  ...
  public final void finishQuery() throws IllegalStateException {
    try {
      ...
      throw new IllegalStateException(
          "#finishQuery must be only be triggered after calling #streamQuery to be in the query"
              + " streaming state.");
    }
  }
}
