...
public abstract class HotwordDetectionService extends Service
    ...
    public static final String KEY_SYSTEM_WILL_CLOSE_AUDIO_STREAM_AFTER_CALLBACK =
            "android.service.voice.HotwordDetectionService.KEY_SYSTEM_WILL_CLOSE_AUDIO_STREAM_AFTER_CALLBACK";
            ...
            new ISandboxedDetectionService
                ...
                public void detectFromMicrophoneSource(
                    ...
                    switch (audioSource) {
                        ...
                        default:
                            Log.i(
                                    HotwordDetectionService.TAG,
                                    "Unsupported audio source " + audioSource);
                            break;
                    }
                }
                ...
                public void detectWithVisualSignals(
                    ...
                    throw new UnsupportedOperationException(
                            "Not supported by HotwordDetectionService");
                }
    ...
    public Object getSystemService(String name) {
        ...
        if (Context.SPEECH_RECOGNITION_SERVICE.equals(name)
                && this.mIRecognitionServiceManager != null) {
