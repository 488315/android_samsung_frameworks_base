...
public abstract class HotwordDetectionService extends Service
  ...
  @Deprecated public static final int INITIALIZATION_STATUS_SUCCESS = 0;

  @Deprecated public static final int INITIALIZATION_STATUS_UNKNOWN = 100;
  ...
  private final ISandboxedDetectionService mInterface =
      new ISandboxedDetectionService
          .Stub() { // from class: android.service.voice.HotwordDetectionService.1
        ...
        public void updateState(
            ...
            throws RemoteException {
          Log.m100v(
              HotwordDetectionService.TAG,
              "#updateState" + (callback != null ? " with callback" : ""));
        ...
        public void detectFromMicrophoneSource(
          ...
          switch (audioSource) {
            ...
            case 2:
              HotwordDetectionService.this.onDetect(
                  audioStream, audioFormat, options, new Callback(callback));
              break;
            default:
              Log.m98i(HotwordDetectionService.TAG, "Unsupported audio source " + audioSource);
              break;
          }
        }
        ...
        public void updateContentCaptureManager(
            IContentCaptureManager manager, ContentCaptureOptions options) {
          HotwordDetectionService.this.mContentCaptureManager =
              new ContentCaptureManager(HotwordDetectionService.this, manager, options);
        }
  ...
  public final IBinder onBind(Intent intent) {
    ...
    Log.m102w(
        TAG,
        "Tried to bind to wrong intent (should be android.service.voice.HotwordDetectionService: "
            + intent);
    return null;
  }
  ...
  public Object getSystemService(String name) {
    ...
    if (Context.SPEECH_RECOGNITION_SERVICE.equals(name)
        && (iRecognitionServiceManager = this.mIRecognitionServiceManager) != null) {
  ...
  public void onDetect(
      AlwaysOnHotwordDetector.EventPayload eventPayload, long timeoutMillis, Callback callback) {
  ...
  public static final class Callback {
    ...
    public void onDetected(HotwordDetectedResult result) {
      ...
      if (!persistableBundle.isEmpty()
          && HotwordDetectedResult.getParcelableSize(persistableBundle)
