...
public abstract class RestrictionsReceiver extends BroadcastReceiver {
  ...
  public abstract void onRequestPermission(
      Context context, String str, String str2, String str3, PersistableBundle persistableBundle);
      ...
      PersistableBundle request =
          (PersistableBundle)
              intent.getParcelableExtra(
                  RestrictionsManager.EXTRA_REQUEST_BUNDLE, PersistableBundle.class);
