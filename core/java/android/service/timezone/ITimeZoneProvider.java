...
public interface ITimeZoneProvider extends IInterface {
  ...
  void startUpdates(ITimeZoneProviderManager iTimeZoneProviderManager, long j, long j2)
  ...
  public abstract static class Stub extends Binder implements ITimeZoneProvider {
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
      ...
      switch (code) {
        ...
        default:
          switch (code) {
            case 1:
              ITimeZoneProviderManager _arg0 =
                  ITimeZoneProviderManager.Stub.asInterface(data.readStrongBinder());
