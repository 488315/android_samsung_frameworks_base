...
public abstract class TimeZoneProviderService extends Service {
  ...
  private void reportSuggestionInternal(
      final TimeZoneProviderSuggestion suggestion, final TimeZoneProviderStatus providerStatus) {
  ...
  private boolean shouldSendEvent(TimeZoneProviderEvent newEvent) {
    ...
    long timeSinceLastEventMillis =
        newEvent.getCreationElapsedMillis() - this.mLastEventSent.getCreationElapsedMillis();
    ...
    public void startUpdates(
      ...
      TimeZoneProviderService.this.mHandler.post(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              TimeZoneProviderService.TimeZoneProviderServiceWrapper.this.lambda$startUpdates$0(
