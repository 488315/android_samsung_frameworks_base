...
public abstract class GameSessionService extends Service {
  ...
  private final IGameSessionService mInterface = new BinderC27201();
  ...
  class BinderC27201 extends IGameSessionService.Stub {
    BinderC27201() {}
          ...
          .post(
              PooledLambda.obtainRunnable(
                  new QuintConsumer() { // from class:
                                        // android.service.games.GameSessionService$1$$ExternalSyntheticLambda0
                    @Override // com.android.internal.util.function.QuintConsumer
                    public final void accept(
                        Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                      ((GameSessionService) obj)
                          .doCreate(
                              (IGameSessionController) obj2,
                              (CreateGameSessionRequest) obj3,
                              (GameSessionViewHostConfiguration) obj4,
                              (AndroidFuture) obj5);
                    }
                  },
                  GameSessionService.this,
  ...
  public void doCreate(
    ...
    if (display == null) {
      createGameSessionResultFuture.completeExceptionally(
          new IllegalStateException(
              "No display found for id: " + gameSessionViewHostConfiguration.mDisplayId));
      return;
    }
    ...
    CreateGameSessionResult createGameSessionResult =
        new CreateGameSessionResult(
            gameSession.mInterface, surfaceControlViewHost.getSurfacePackage());
