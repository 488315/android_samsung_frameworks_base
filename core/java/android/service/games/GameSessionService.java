...
public abstract class GameSessionService extends Service {
    ...
    public void doCreate(
        ...
        Display display =
                this.mDisplayManager.getDisplay(gameSessionViewHostConfiguration.mDisplayId);
        if (display == null) {
            createGameSessionResultFuture.completeExceptionally(
                    new IllegalStateException(
                            "No display found for id: "
        ...
        SurfaceControlViewHost surfaceControlViewHost =
                new SurfaceControlViewHost(
                        windowContext, display, new InputTransferToken(), "GameSessionService");
        gameSession.attach(
                gameSessionController,
