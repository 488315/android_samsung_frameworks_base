...
public abstract class GameSession {
  ...
  private int mTaskId;
  final IGameSession mInterface = new BinderC27171();
  ...
  class BinderC27171 extends IGameSession.Stub {
    BinderC27171() {}
  ...
  public void attach(
    ...
    GameSessionRootView gameSessionRootView =
        new GameSessionRootView(context, this.mSurfaceControlViewHost);
  ...
  public void moveToState(LifecycleState newLifecycleState) {
    ...
    switch (C27182.$SwitchMap$android$service$games$GameSession$LifecycleState[
        this.mLifecycleState.ordinal()]) {
      case 1:
  ...
  static /* synthetic */ class C27182 {
    ...
    static {
      ...
      try {
        $SwitchMap$android$service$games$GameSession$LifecycleState[
                LifecycleState.CREATED.ordinal()] =
            2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        $SwitchMap$android$service$games$GameSession$LifecycleState[
                LifecycleState.TASK_FOCUSED.ordinal()] =
            3;
      } catch (NoSuchFieldError e3) {
      }
      try {
        $SwitchMap$android$service$games$GameSession$LifecycleState[
                LifecycleState.TASK_UNFOCUSED.ordinal()] =
            4;
      } catch (NoSuchFieldError e4) {
      }
      try {
        $SwitchMap$android$service$games$GameSession$LifecycleState[
                LifecycleState.DESTROYED.ordinal()] =
            5;
  ...
  public final boolean restartGame() {
    try {
      ...
      Slog.m122w(TAG, "Failed to restart game", e);
      return false;
    }
  }
                ...
                new BiConsumer() { // from class:
                  ...
                  public final void accept(Object obj, Object obj2) {
                    GameSession.this.lambda$takeScreenshot$0(
                        callback, (GameScreenshotResult) obj, (Throwable) obj2);
                  }
                },
                executor);
    try {
  ...
  public void lambda$takeScreenshot$0(
    ...
    if (error != null) {
      Slog.m122w(TAG, error.getMessage(), error.getCause());
    ...
    switch (status) {
      case 0:
        ...
        break;
      case 1:
        Slog.m121w(TAG, "Error taking screenshot");
        callback.onFailure(0);
        break;
    }
  }
