...
public final class GrantTrustResult implements Parcelable {
    public static final Parcelable.Creator<GrantTrustResult> CREATOR =
            new Parcelable.Creator<
                    GrantTrustResult>() { // from class: android.service.trust.GrantTrustResult.1
    ...
    public GrantTrustResult(int status) {
        ...
        if (this.mStatus != 0 && this.mStatus != 1) {
            throw new IllegalArgumentException(
                    "status was "
                            + this.mStatus
                            + " but must be one of: STATUS_UNKNOWN(0), STATUS_UNLOCKED_BY_GRANT(1"
