...
public class TrustAgentService extends Service {
  ...
  public void onCreate() {
    ...
    try {
      ...
      Log.m96e(this.TAG, "Can't get ServiceInfo for " + component.toShortString());
    }
  }
  ...
  public void onError(String msg) {
    Slog.m119v(this.TAG, "Remote exception while " + msg);
  }
  ...
  public final void grantTrust(
    ...
    synchronized (this.mLock) {
      if (!this.mManagingTrust) {
        throw new IllegalStateException(
            "Cannot grant trust if agent is not managing trust. Call setManagingTrust(true)"
                + " first.");
      }
  ...
  public final void addEscrowToken(byte[] token, UserHandle user) {
    synchronized (this.mLock) {
      ITrustAgentServiceCallback iTrustAgentServiceCallback = this.mCallback;
      if (iTrustAgentServiceCallback == null) {
        Slog.m121w(this.TAG, "Cannot add escrow token if the agent is not connecting to framework");
  ...
  public final void unlockUserWithToken(long handle, byte[] token, UserHandle user) {
    ...
    if (um.isUserUnlocked(user)) {
      Slog.m117i(this.TAG, "User already unlocked");
      return;
    }
    synchronized (this.mLock) {
      ITrustAgentServiceCallback iTrustAgentServiceCallback = this.mCallback;
  ...
  public final void showKeyguardErrorMessage(CharSequence message) {
    ...
    synchronized (this.mLock) {
      ITrustAgentServiceCallback iTrustAgentServiceCallback = this.mCallback;
      if (iTrustAgentServiceCallback == null) {
        Slog.m121w(this.TAG, "Cannot show message because service is not connected to framework.");
        throw new IllegalStateException("Trust agent is not connected");
      }
      try {
