...
public abstract class InlineSuggestionRenderService extends Service {
  ...
  private final LruCache<InlineSuggestionUiImpl, Boolean> mActiveInlineSuggestions =
      new LruCache<InlineSuggestionUiImpl, Boolean>(
          30) { // from class: android.service.autofill.InlineSuggestionRenderService.1
        @Override // android.util.LruCache
        public void entryRemoved(
            boolean evicted, InlineSuggestionUiImpl key, Boolean oldValue, Boolean newValue) {
          if (evicted) {
            Log.m102w(
                InlineSuggestionRenderService.TAG,
                "Hit max=30 entries in the cache. Releasing oldest one to make space.");
  ...
  private Size measuredSize(View view, int width, int height, Size minSize, Size maxSize) {
    ...
    if (width == -2 || height == -2) {
      ...
      if (height == -2) {
        heightMeasureSpec =
            View.MeasureSpec.makeMeasureSpec(maxSize.getHeight(), Integer.MIN_VALUE);
      } else {
        heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(height, 1073741824);
      }
      view.measure(widthMeasureSpec, heightMeasureSpec);
      return new Size(
          Math.max(view.getMeasuredWidth(), minSize.getWidth()),
  ...
  public void handleRenderSuggestion(
    ...
    if (hostInputToken != null) {
      ...
      try {
        ...
        if (suggestionView == null) {
          Log.m102w(TAG, "ExtServices failed to render the inline suggestion view.");
          try {
            callback.onError();
          } catch (RemoteException e) {
            Log.m102w(TAG, "Null suggestion view returned by renderer");
          }
          updateDisplay(0);
          return;
        }
        ...
        Log.m100v(TAG, "width=" + width + ", height=" + height + ", measuredSize=" + measuredSize);
        ...
        WindowManager.LayoutParams lp =
            new WindowManager.LayoutParams(
                measuredSize.getWidth(), measuredSize.getHeight(), 2, 0, -2);
        final SurfaceControlViewHost host =
            new SurfaceControlViewHost(this, getDisplay(), hostInputToken, TAG);
        host.setView(suggestionRoot, lp);
        suggestionView.setFocusable(false);
        suggestionView.setOnClickListener(
            new View
                .OnClickListener() { // from class:
                                     // android.service.autofill.InlineSuggestionRenderService$$ExternalSyntheticLambda0
              @Override // android.view.View.OnClickListener
              public final void onClick(View view) {
                InlineSuggestionRenderService.lambda$handleRenderSuggestion$0(
                    IInlineSuggestionUiCallback.this, view);
              }
            });
        ...
        suggestionView.setOnLongClickListener(
            new View
                .OnLongClickListener() { // from class:
                                         // android.service.autofill.InlineSuggestionRenderService$$ExternalSyntheticLambda1
              @Override // android.view.View.OnLongClickListener
              public final boolean onLongClick(View view) {
                return InlineSuggestionRenderService.lambda$handleRenderSuggestion$1(
                    View.OnLongClickListener.this, callback, view);
              }
            });
        final InlineSuggestionUiImpl uiImpl =
            new InlineSuggestionUiImpl(host, this.mMainHandler, userId, sessionId);
        this.mActiveInlineSuggestions.put(uiImpl, true);
        this.mMainHandler.post(
            new Runnable() { // from class:
                             // android.service.autofill.InlineSuggestionRenderService$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
                InlineSuggestionRenderService.lambda$handleRenderSuggestion$2(
                    IInlineSuggestionUiCallback.this, uiImpl, host, measuredSize);
              }
            });
        return;
      } finally {
    ...
    try {
      ...
      Log.m102w(TAG, "RemoteException calling onError()");
    }
  }

  static /* synthetic */ void lambda$handleRenderSuggestion$0(
      IInlineSuggestionUiCallback callback, View v) {
    try {
      callback.onClick();
    } catch (RemoteException e) {
      Log.m102w(TAG, "RemoteException calling onClick()");
    }
  }

  static /* synthetic */ boolean lambda$handleRenderSuggestion$1(
      View.OnLongClickListener onLongClickListener, IInlineSuggestionUiCallback callback, View v) {
    ...
    try {
      ...
      Log.m102w(TAG, "RemoteException calling onLongClick()");
      return true;
    }
  }

  static /* synthetic */ void lambda$handleRenderSuggestion$2(
      IInlineSuggestionUiCallback callback,
      InlineSuggestionUiImpl uiImpl,
      SurfaceControlViewHost host,
      Size measuredSize) {
    try {
      callback.onContent(
          new InlineSuggestionUiWrapper(uiImpl),
          host.getSurfacePackage(),
          measuredSize.getWidth(),
          measuredSize.getHeight());
    } catch (RemoteException e) {
      Log.m102w(TAG, "RemoteException calling onContent()");
    }
  }
  ...
  public void handleDestroySuggestionViews(int userId, int sessionId) {
    Log.m100v(TAG, "handleDestroySuggestionViews called for " + userId + ":" + sessionId);
    for (InlineSuggestionUiImpl inlineSuggestionUi :
        this.mActiveInlineSuggestions.snapshot().keySet()) {
      if (inlineSuggestionUi.mUserId == userId && inlineSuggestionUi.mSessionId == sessionId) {
        Log.m100v(TAG, "Destroy " + inlineSuggestionUi);
  ...
  final class InlineSuggestionUiImpl {
    ...
    InlineSuggestionUiImpl(
        SurfaceControlViewHost viewHost, Handler handler, int userId, int sessionId) {
    ...
    public void releaseSurfaceControlViewHost() {
      this.mHandler.post(
          new Runnable() { // from class:
                           // android.service.autofill.InlineSuggestionRenderService$InlineSuggestionUiImpl$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              InlineSuggestionRenderService.InlineSuggestionUiImpl.this
                  .lambda$releaseSurfaceControlViewHost$0();
            }
          });
    }
    ...
    public /* synthetic */ void lambda$releaseSurfaceControlViewHost$0() {
      ...
      Log.m100v(InlineSuggestionRenderService.TAG, "Releasing inline suggestion view host");
      this.mViewHost.release();
      this.mViewHost = null;
      InlineSuggestionRenderService.this.mActiveInlineSuggestions.remove(this);
      Log.m100v(
          InlineSuggestionRenderService.TAG,
          "Removed the inline suggestion from the cache, current size="
    ...
    public void getSurfacePackage(final ISurfacePackageResultCallback callback) {
      Log.m94d(InlineSuggestionRenderService.TAG, "getSurfacePackage");
      this.mHandler.post(
          new Runnable() { // from class:
                           // android.service.autofill.InlineSuggestionRenderService$InlineSuggestionUiImpl$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              InlineSuggestionRenderService.InlineSuggestionUiImpl.this.lambda$getSurfacePackage$1(
                  callback);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$getSurfacePackage$1(ISurfacePackageResultCallback callback) {
      try {
        ...
        callback.onResult(
            surfaceControlViewHost == null ? null : surfaceControlViewHost.getSurfacePackage());
      } catch (RemoteException e) {
        Log.m102w(InlineSuggestionRenderService.TAG, "RemoteException calling onSurfacePackage");
      }
    }
  }
  ...
  public final IBinder onBind(Intent intent) {
    ...
    if (SERVICE_INTERFACE.equals(intent.getAction())) {
      return new BinderC26152().asBinder();
    }
    Log.m102w(
        TAG,
  ...
  class BinderC26152 extends IInlineSuggestionRenderService.Stub {
    BinderC26152() {}
    ...
    public void renderSuggestion(
        ...
        int userId,
        int sessionId) {
      InlineSuggestionRenderService.this.mMainHandler.sendMessage(
          PooledLambda.obtainMessage(
              new NonaConsumer() { // from class:
                                   // android.service.autofill.InlineSuggestionRenderService$2$$ExternalSyntheticLambda1
                ...
                public final void accept(
                    ...
                    Object obj8,
                    Object obj9) {
                  ((InlineSuggestionRenderService) obj)
                      .handleRenderSuggestion(
                          (IInlineSuggestionUiCallback) obj2,
                          (InlinePresentation) obj3,
              ...
              InlineSuggestionRenderService.this,
              callback,
              presentation,
      ...
      InlineSuggestionRenderService.this.mMainHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // android.service.autofill.InlineSuggestionRenderService$2$$ExternalSyntheticLambda2
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                  ((InlineSuggestionRenderService) obj)
                      .handleGetInlineSuggestionsRendererInfo((RemoteCallback) obj2);
                }
              },
              InlineSuggestionRenderService.this,
              callback));
      ...
      InlineSuggestionRenderService.this.mMainHandler.sendMessage(
          PooledLambda.obtainMessage(
              new TriConsumer() { // from class:
                                  // android.service.autofill.InlineSuggestionRenderService$2$$ExternalSyntheticLambda0
                @Override // com.android.internal.util.function.TriConsumer
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((InlineSuggestionRenderService) obj)
                      .handleDestroySuggestionViews(
  ...
  public View onRenderSuggestion(InlinePresentation presentation, int width, int height) {
    Log.m96e(
        TAG, "service implementation (" + getClass() + " does not implement onRenderSuggestion()");
    return null;
  }
}
