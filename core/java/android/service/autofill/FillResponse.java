          ...
          android.service.assist.classification.FieldClassification[] detectedFields =
              (android.service.assist.classification.FieldClassification[])
                  parcel.readParcelableArray(
                      null, android.service.assist.classification.FieldClassification.class);
  ...
  public static final class Builder {
    ...
    public Builder setDetectedFieldClassifications(
      ...
      this.mDetectedFieldTypes =
          (android.service.assist.classification.FieldClassification[])
              fieldInfos.toArray(new android.service.assist.classification.FieldClassification[0]);
      return this;
    }
    ...
    public Builder setAuthentication(
      ...
      return setAuthentication(
          ids, authentication, presentation, inlinePresentation, inlineTooltipPresentation, null);
    }
    ...
    public Builder setAuthentication(
      ...
      if ((presentation == null && inlinePresentation == null) ^ (authentication == null)) {
        throw new IllegalArgumentException(
            "authentication and presentation (dropdown or inline), must be both non-null or null");
      }
      this.mAuthentication = authentication;
      this.mPresentation = presentation;
      this.mInlinePresentation = inlinePresentation;
    ...
    public FillResponse build() {
      ...
      if (this.mAuthentication == null
        ...
        throw new IllegalStateException(
            "need to provide: at least one DataSet, or a SaveInfo, or an authentication with a"
                + " presentation, or a FieldsDetection, or a client state, or disable autofill");
      }
