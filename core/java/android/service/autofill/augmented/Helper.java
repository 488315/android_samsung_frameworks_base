  ...
  public static void logResponse(
    ...
    LogMaker log =
        new LogMaker(MetricsProto.MetricsEvent.AUTOFILL_AUGMENTED_RESPONSE)
            ...
            .addTaggedData(
                MetricsProto.MetricsEvent.FIELD_AUTOFILL_SESSION_ID, Integer.valueOf(mSessionId))
            .addTaggedData(MetricsProto.MetricsEvent.FIELD_AUTOFILL_SERVICE, servicePackageName)
            .addTaggedData(
                MetricsProto.MetricsEvent.FIELD_AUTOFILL_DURATION, Long.valueOf(durationMs));
