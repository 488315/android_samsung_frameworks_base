    ...
    public PresentationParams.SystemPopupPresentationParams getSmartSuggestionParams() {
      synchronized (this.mLock) {
        ...
        try {
          ...
          Log.m102w(
              AugmentedAutofillService.TAG, "Could not get coordinates for " + this.mFocusedId);
          return null;
        }
      }
    }
      ...
      synchronized (this.mLock) {
        ...
        if (iFillCallback != null) {
          try {
            ...
            Log.m97e(
                AugmentedAutofillService.TAG, "failed to check current pending request status", e);
          }
        ...
        case 1:
          ...
          if (this.mFirstOnSuccessTime == 0) {
            ...
            if (AugmentedAutofillService.sDebug) {
              Log.m94d(
                  AugmentedAutofillService.TAG,
                  "Service responded nothing in " + TimeUtils.formatDuration(duration));
              break;
            }
          }
          break;
