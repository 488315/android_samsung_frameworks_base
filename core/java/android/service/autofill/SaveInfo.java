      ...
      new Parcelable.Creator<SaveInfo>() { // from class: android.service.autofill.SaveInfo.1
        ...
        public SaveInfo createFromParcel(Parcel parcel) {
          ...
          CustomDescription customDescripton =
              (CustomDescription) parcel.readParcelable(null, CustomDescription.class);
          ...
          InternalSanitizer[] sanitizers =
              (InternalSanitizer[]) parcel.readParcelableArray(null, InternalSanitizer.class);
          if (sanitizers != null) {
  ...
  public static final class Builder {
    ...
    public Builder setValidator(Validator validator) {
      ...
      Preconditions.checkArgument(
          validator instanceof InternalValidator, "not provided by Android System: %s", validator);
    ...
    public Builder addSanitizer(Sanitizer sanitizer, AutofillId... ids) {
      ...
      Preconditions.checkArgument(
          sanitizer instanceof InternalSanitizer, "not provided by Android System: %s", sanitizer);
    ...
    public SaveInfo build() {
      throwIfDestroyed();
      Preconditions.checkState(
          (ArrayUtils.isEmpty(this.mRequiredIds)
                  && ArrayUtils.isEmpty(this.mOptionalIds)
                  && (this.mFlags & 4) == 0)
              ? false
              : true,
  ...
  public String toString() {
    ...
    StringBuilder builder =
        new StringBuilder("SaveInfo: [type=")
            .append(DebugUtils.flagsToString(SaveInfo.class, "SAVE_DATA_TYPE_", this.mType))
            .append(", requiredIds=")
            .append(Arrays.toString(this.mRequiredIds))
            .append(", negative style=")
            .append(
                DebugUtils.flagsToString(
                    SaveInfo.class, "NEGATIVE_BUTTON_STYLE_", this.mNegativeButtonStyle))
