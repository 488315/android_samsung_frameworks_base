...
public abstract class AutofillFieldClassificationService extends Service {
  ...
  @SystemApi
  @Deprecated
  public float[][] onGetScores(
      String algorithm,
      Bundle algorithmOptions,
      List<AutofillValue> actualValues,
      List<String> userDataValues) {
    Log.m96e(TAG, "service implementation (" + getClass() + " does not implement onGetScores()");
    return null;
  }

  @SystemApi
  public float[][] onCalculateScores(
      List<AutofillValue> actualValues,
      List<String> userDataValues,
      ...
      Map args) {
    Log.m96e(
        TAG, "service implementation (" + getClass() + " does not implement onCalculateScore()");
    return null;
  }
  ...
  final class AutofillFieldClassificationServiceWrapper
    ...
    public void calculateScores(
      ...
      AutofillFieldClassificationService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new NonaConsumer() { // from class:
                                   // android.service.autofill.AutofillFieldClassificationService$AutofillFieldClassificationServiceWrapper$$ExternalSyntheticLambda0
                ...
                public final void accept(
                    ...
                    Object obj8,
                    Object obj9) {
                  ((AutofillFieldClassificationService) obj)
                      .calculateScores(
                          (RemoteCallback) obj2,
                          (List) obj3,
                          (String[]) obj4,
  ...
  public static final class Scores implements Parcelable {
    ...
    public String toString() {
      ...
      StringBuilder builder =
          new StringBuilder("Scores [").append(size1).append("x").append(size2).append("] ");
      for (int i = 0; i < size1; i++) {
