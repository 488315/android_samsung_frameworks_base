...
public final class CustomDescription implements Parcelable {
  public static final Parcelable.Creator<CustomDescription> CREATOR =
      new Parcelable.Creator<
          CustomDescription>() { // from class: android.service.autofill.CustomDescription.1
        ...
        public CustomDescription createFromParcel(Parcel parcel) {
          ...
          InternalValidator[] conditions =
              (InternalValidator[]) parcel.readParcelableArray(null, InternalValidator.class);
          if (conditions != null) {
            BatchUpdates[] updates =
                (BatchUpdates[]) parcel.readParcelableArray(null, BatchUpdates.class);
  ...
  public static class Builder {
    ...
    public Builder batchUpdate(Validator condition, BatchUpdates updates) {
      throwIfDestroyed();
      Preconditions.checkArgument(
          condition instanceof InternalValidator, "not provided by Android System: %s", condition);
    ...
    public Builder addOnClickAction(int id, OnClickAction action) {
      throwIfDestroyed();
      Preconditions.checkArgument(
          action instanceof InternalOnClickAction, "not provided by Android System: %s", action);
  ...
  public String toString() {
    ...
    StringBuilder append =
        new StringBuilder("CustomDescription: [presentation=")
            .append(this.mPresentation)
            .append(", transformations=");
    ArrayList<Pair<Integer, InternalTransformation>> arrayList = this.mTransformations;
    StringBuilder append2 =
        append
            .append(arrayList == null ? "N/A" : Integer.valueOf(arrayList.size()))
            .append(", updates=");
    ArrayList<Pair<InternalValidator, BatchUpdates>> arrayList2 = this.mUpdates;
    StringBuilder append3 =
        append2
            .append(arrayList2 == null ? "N/A" : Integer.valueOf(arrayList2.size()))
            .append(", actions=");
    SparseArray<InternalOnClickAction> sparseArray = this.mActions;
    return append3
        .append(sparseArray != null ? Integer.valueOf(sparseArray.size()) : "N/A")
