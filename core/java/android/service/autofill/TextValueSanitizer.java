...
public final class TextValueSanitizer extends InternalSanitizer implements Sanitizer, Parcelable {
  public static final Parcelable.Creator<TextValueSanitizer> CREATOR =
      new Parcelable.Creator<
          TextValueSanitizer>() { // from class: android.service.autofill.TextValueSanitizer.1
  ...
  public AutofillValue sanitize(AutofillValue value) {
    if (value == null) {
      Slog.m121w(TAG, "sanitize() called with null value");
      return null;
    }
    if (!value.isText()) {
      if (Helper.sDebug) {
        Slog.m113d(TAG, "sanitize() called with non-text value: " + value);
      }
      return null;
    }
    ...
    try {
      ...
      if (!matcher.matches()) {
        if (Helper.sDebug) {
          Slog.m113d(TAG, "sanitize(): " + this.mRegex + " failed for " + value);
        }
        return null;
      }
      ...
      Slog.m121w(TAG, "Exception evaluating " + this.mRegex + "/" + this.mSubst + ": " + e);
      return null;
    }
  }
