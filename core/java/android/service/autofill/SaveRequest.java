...
public final class SaveRequest implements Parcelable {
  public static final Parcelable.Creator<SaveRequest> CREATOR =
      new Parcelable.Creator<SaveRequest>() { // from class: android.service.autofill.SaveRequest.1
  ...
  public SaveRequest(
      ArrayList<FillContext> fillContexts, Bundle clientState, ArrayList<String> datasetIds) {
  ...
  private SaveRequest(Parcel parcel) {
    this(
        parcel.createTypedArrayList(FillContext.CREATOR),
        parcel.readBundle(),
