...
public final class FillContext implements Parcelable {
  public static final Parcelable.Creator<FillContext> CREATOR =
      new Parcelable.Creator<FillContext>() { // from class: android.service.autofill.FillContext.1
  ...
  */
  ...
  public FillContext(int requestId, AssistStructure structure, AutofillId focusedId) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) structure);
    this.mFocusedId = focusedId;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) focusedId);
  }
