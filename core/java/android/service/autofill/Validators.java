...
public final class Validators {
  ...
  /* renamed from: or */
  public static Validator m64or(Validator... validators) {
  ...
  public static Validator not(Validator validator) {
    Preconditions.checkArgument(
        ...
        "validator not provided by Android System: %s",
        validator);
  ...
  private static InternalValidator[] getInternalValidators(Validator[] validators) {
    ...
    for (int i = 0; i < validators.length; i++) {
      Preconditions.checkArgument(
          validators[i] instanceof InternalValidator,
          "element %d not provided by Android System: %s",
          Integer.valueOf(i),
          validators[i]);
