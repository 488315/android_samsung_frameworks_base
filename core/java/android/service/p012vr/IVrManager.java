...
public interface IVrManager extends IInterface {
  ...
  void unregisterPersistentVrStateListener(IPersistentVrStateCallbacks iPersistentVrStateCallbacks)
      throws RemoteException;

  public static class Default implements IVrManager {
    @Override // android.service.p012vr.IVrManager
          ...
          switch (code) {
            ...
            case 8:
              Vr2dDisplayProperties _arg06 =
                  (Vr2dDisplayProperties) data.readTypedObject(Vr2dDisplayProperties.CREATOR);
              data.enforceNoDataAvail();
