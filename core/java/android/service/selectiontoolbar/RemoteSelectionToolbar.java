...
final class RemoteSelectionToolbar {
  ...
  private final Runnable mPreparePopupContentRTLHelper =
      new Runnable() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.1
  ...
  RemoteSelectionToolbar(
    ...
    this.mLineHeight =
        applyDefaultTheme
            .getResources()
            .getDimensionPixelSize(C4337R.dimen.floating_toolbar_height);
    ...
    this.mShowAnimation =
        createEnterAnimation(
            ...
            new AnimatorListenerAdapter() { // from class:
                                            // android.service.selectiontoolbar.RemoteSelectionToolbar.2
    ...
    this.mDismissAnimation =
        createExitAnimation(
            ...
            150,
            new AnimatorListenerAdapter() { // from class:
                                            // android.service.selectiontoolbar.RemoteSelectionToolbar.3
              @Override // android.animation.AnimatorListenerAdapter,
                        // android.animation.Animator.AnimatorListener
              public void onAnimationEnd(Animator animation) {
    ...
    this.mMenuItemButtonOnClickListener =
        new View
            .OnClickListener() { // from class:
                                 // android.service.selectiontoolbar.RemoteSelectionToolbar$$ExternalSyntheticLambda1
  ...
  public void updateFloatingToolbarRootContentRect() {
    ...
    this.mTempContentRectForRoot.set(
        contentLeft,
        contentTop,
        this.mContentContainer.getWidth() + contentLeft,
        this.mContentContainer.getHeight() + contentTop);
    root.setContentRect(this.mTempContentRectForRoot);
  }

  private WidgetInfo createWidgetInfo() {
    this.mTempContentRect.set(
        this.mRelativeCoordsForToolbar.f85x,
        this.mRelativeCoordsForToolbar.f86y,
        this.mRelativeCoordsForToolbar.f85x + this.mPopupWidth,
        this.mRelativeCoordsForToolbar.f86y + this.mPopupHeight);
  ...
  private SurfaceControlViewHost.SurfacePackage getSurfacePackage() {
    if (this.mSurfaceControlViewHost == null) {
      FloatingToolbarRoot contentHolder =
          new FloatingToolbarRoot(this.mContext, this.mHostInputToken, this.mTransferTouchListener);
      contentHolder.addView(this.mContentContainer);
      Context context = this.mContext;
      SurfaceControlViewHost surfaceControlViewHost =
          new SurfaceControlViewHost(context, context.getDisplay(), this.mHostInputToken, TAG);
  ...
  private void layoutMenuItems(List<ToolbarMenuItem> menuItems, int suggestedWidth) {
    ...
    clearPanels();
    List<ToolbarMenuItem> menuItems2 =
  ...
  private void refreshCoordinatesAndOverflowDirection(Rect contentRectOnScreen) {
    ...
    int x =
        Math.min(
            contentRectOnScreen.centerX() - (this.mPopupWidth / 2),
            this.mViewPortOnScreen.right - this.mPopupWidth);
  ...
  private void openOverflow() {
    ...
    Animation widthAnimation =
        new Animation() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.4
          @Override // android.view.animation.Animation
          protected void applyTransformation(float interpolatedTime, Transformation t) {
            int deltaWidth = (int) ((targetWidth - startWidth) * interpolatedTime);
            RemoteSelectionToolbar.setWidth(
                RemoteSelectionToolbar.this.mContentContainer, startWidth + deltaWidth);
            if (RemoteSelectionToolbar.this.isInRTLMode()) {
              ...
              RemoteSelectionToolbar.this.mContentContainer.setX(
                  right - RemoteSelectionToolbar.this.mContentContainer.getWidth());
              RemoteSelectionToolbar.this.mMainPanel.setX(
                  RemoteSelectionToolbar.this.mContentContainer.getWidth() - startWidth);
              RemoteSelectionToolbar.this.mOverflowPanel.setX(
                  RemoteSelectionToolbar.this.mContentContainer.getWidth() - targetWidth);
            }
          }
        };
    Animation heightAnimation =
        new Animation() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.5
          @Override // android.view.animation.Animation
          protected void applyTransformation(float interpolatedTime, Transformation t) {
            int deltaHeight = (int) ((targetHeight - startHeight) * interpolatedTime);
            RemoteSelectionToolbar.setHeight(
                RemoteSelectionToolbar.this.mContentContainer, startHeight + deltaHeight);
            if (RemoteSelectionToolbar.this.mOpenOverflowUpwards) {
              RemoteSelectionToolbar.this.mContentContainer.setY(
                  startY
                      - (RemoteSelectionToolbar.this.mContentContainer.getHeight() - startHeight));
    ...
    Animation overflowButtonAnimation =
        new Animation() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.6
          @Override // android.view.animation.Animation
          protected void applyTransformation(float interpolatedTime, Transformation t) {
            float f = overflowButtonStartX;
            float overflowButtonX = f + ((overflowButtonTargetX - f) * interpolatedTime);
            float deltaContainerWidth =
                RemoteSelectionToolbar.this.isInRTLMode()
                    ? 0.0f
                    : RemoteSelectionToolbar.this.mContentContainer.getWidth() - startWidth;
  ...
  private void closeOverflow() {
    ...
    final float right = left + this.mContentContainer.getWidth();
    Animation widthAnimation =
        new Animation() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.7
          @Override // android.view.animation.Animation
          protected void applyTransformation(float interpolatedTime, Transformation t) {
            int deltaWidth = (int) ((targetWidth - startWidth) * interpolatedTime);
            RemoteSelectionToolbar.setWidth(
    ...
    Animation heightAnimation =
        new Animation() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.8
          @Override // android.view.animation.Animation
          protected void applyTransformation(float interpolatedTime, Transformation t) {
            int deltaHeight = (int) ((targetHeight - startHeight) * interpolatedTime);
            RemoteSelectionToolbar.setHeight(
            ...
            if (RemoteSelectionToolbar.this.mOpenOverflowUpwards) {
              RemoteSelectionToolbar.this.mContentContainer.setY(
                  bottom - RemoteSelectionToolbar.this.mContentContainer.getHeight());
              RemoteSelectionToolbar.this.positionContentYCoordinatesIfOpeningOverflowUpwards();
            }
          }
        };
    ...
    Animation overflowButtonAnimation =
        new Animation() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.9
          @Override // android.view.animation.Animation
          protected void applyTransformation(float interpolatedTime, Transformation t) {
            float f = overflowButtonStartX;
            float overflowButtonX = f + ((overflowButtonTargetX - f) * interpolatedTime);
  ...
  public void setPanelsStatesAtRestingPosition() {
    ...
    if (hasOverflow()) {
      if (isInRTLMode()) {
        ...
        this.mContentContainer.setX(
            (this.mPopupWidth - containerSize.getWidth()) - this.mMarginHorizontal);
        this.mMainPanel.setX(0.0f);
      ...
      if (this.mOpenOverflowUpwards) {
        this.mContentContainer.setY(
            (this.mMarginVertical + this.mOverflowPanelSize.getHeight())
  ...
  private List<ToolbarMenuItem> layoutMainPanelItems(
      List<ToolbarMenuItem> menuItems, int toolbarWidth) {
    int i;
    int i2;
    ...
    while (!remainingMenuItems.isEmpty()) {
      ...
      View menuItemButton =
          createMenuItemButton(this.mContext, menuItem2, this.mIconTextSpacing, showIcon);
      if (!showIcon && (menuItemButton instanceof LinearLayout)) {
        ((LinearLayout) menuItemButton).setGravity(17);
      }
      if (isFirstItem) {
        menuItemButton.setPaddingRelative(
            (int) (menuItemButton.getPaddingStart() * 1.5d),
  ...
  private int calculateOverflowHeight(int maxItemSize) {
    int actualSize =
        Math.min(4, Math.min(Math.max(2, maxItemSize), this.mOverflowPanel.getCount()));
    int extension = 0;
  ...
  private ViewGroup createMainPanel() {
    return new LinearLayout(
        this.mContext) { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.10
      @Override // android.widget.LinearLayout, android.view.View
      protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (RemoteSelectionToolbar.this.isOverflowAnimating()) {
          widthMeasureSpec =
              View.MeasureSpec.makeMeasureSpec(
                  RemoteSelectionToolbar.this.mMainPanelSize.getWidth(), 1073741824);
        }
    ...
    final ImageButton overflowButton =
        (ImageButton)
            LayoutInflater.from(this.mContext)
                .inflate(C4337R.layout.floating_popup_overflow_button, (ViewGroup) null);
    overflowButton.setImageDrawable(this.mOverflow);
    overflowButton.setOnClickListener(
        new View
            .OnClickListener() { // from class:
                                 // android.service.selectiontoolbar.RemoteSelectionToolbar$$ExternalSyntheticLambda2
          @Override // android.view.View.OnClickListener
          public final void onClick(View view) {
  ...
  private OverflowPanel createOverflowPanel() {
    ...
    ArrayAdapter adapter =
        new ArrayAdapter<ToolbarMenuItem>(
            this.mContext,
            0) { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar.11
          @Override // android.widget.ArrayAdapter, android.widget.Adapter
          public View getView(int position, View convertView, ViewGroup parent) {
            return RemoteSelectionToolbar.this.mOverflowPanelViewHelper.getView(
                getItem(position),
                RemoteSelectionToolbar.this.mOverflowPanelSize.getWidth(),
                convertView);
          }
        };
    ...
    overflowPanel.setOnItemClickListener(
        new AdapterView
            .OnItemClickListener() { // from class:
                                     // android.service.selectiontoolbar.RemoteSelectionToolbar$$ExternalSyntheticLambda0
          @Override // android.widget.AdapterView.OnItemClickListener
          public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
            RemoteSelectionToolbar.this.lambda$createOverflowPanel$2(
  ...
  class AnimationAnimationListenerC278412 implements Animation.AnimationListener {
    AnimationAnimationListenerC278412() {}
    ...
    public void onAnimationEnd(Animation animation) {
      RemoteSelectionToolbar.this.mContentContainer.post(
          new Runnable() { // from class:
                           // android.service.selectiontoolbar.RemoteSelectionToolbar$12$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              RemoteSelectionToolbar.AnimationAnimationListenerC278412.this
  ...
  private Animation.AnimationListener createOverflowAnimationListener() {
    return new AnimationAnimationListenerC278412();
  }
  ...
  private static final class OverflowPanelViewHelper {
    ...
    public View getView(ToolbarMenuItem menuItem, int minimumWidth, View convertView) {
      ...
      if (convertView != null) {
        RemoteSelectionToolbar.updateMenuItemButton(
    ...
    private View createMenuButton(ToolbarMenuItem menuItem) {
      View button =
          RemoteSelectionToolbar.createMenuItemButton(
  ...
  public static View createMenuItemButton(
    ...
    View menuItemButton =
        LayoutInflater.from(context)
            .inflate(C4337R.layout.floating_popup_menu_button, (ViewGroup) null);
    if (menuItem != null) {
  ...
  public static void updateMenuItemButton(
      View menuItemButton, ToolbarMenuItem menuItem, int iconTextSpacing, boolean showIcon) {
    TextView buttonText =
  ...
  private static ViewGroup createContentContainer(Context context) {
    ViewGroup contentContainer =
        (ViewGroup)
            LayoutInflater.from(context)
                .inflate(C4337R.layout.floating_popup_container, (ViewGroup) null);
