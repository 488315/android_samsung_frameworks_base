...
final class RemoteSelectionToolbar {
    ...
    RemoteSelectionToolbar(Context context, long selectionToolbarToken, ShowInfo showInfo, SelectionToolbarRenderService.RemoteCallbackWrapper callbackWrapper, SelectionToolbarRenderService.TransferTouchListener transferTouchListener) {
        ...
        this.mMarginHorizontal = applyDefaultTheme.getResources().getDimensionPixelSize(C4337R.dimen.floating_toolbar_horizontal_margin);
        this.mMarginVertical = applyDefaultTheme.getResources().getDimensionPixelSize(C4337R.dimen.floating_toolbar_vertical_margin);
        this.mLineHeight = applyDefaultTheme.getResources().getDimensionPixelSize(C4337R.dimen.floating_toolbar_height);
        int dimensionPixelSize = applyDefaultTheme.getResources().getDimensionPixelSize(C4337R.dimen.floating_toolbar_icon_text_spacing);
    ...
    private WidgetInfo createWidgetInfo() {
        this.mTempContentRect.set(this.mRelativeCoordsForToolbar.f85x, this.mRelativeCoordsForToolbar.f86y, this.mRelativeCoordsForToolbar.f85x + this.mPopupWidth, this.mRelativeCoordsForToolbar.f86y + this.mPopupHeight);
    ...
    private int getAdjustedToolbarWidth(int suggestedWidth) {
        ...
        int maximumWidth = this.mViewPortOnScreen.width() - (this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.floating_toolbar_horizontal_margin) * 2);
        if (width <= 0) {
            width = this.mContext.getResources().getDimensionPixelSize(C4337R.dimen.floating_toolbar_preferred_width);
        }
    ...
    private ImageButton createOverflowButton() {
        final ImageButton overflowButton = (ImageButton) LayoutInflater.from(this.mContext).inflate(C4337R.layout.floating_popup_overflow_button, (ViewGroup) null);
        ...
        public void onAnimationEnd(Animation animation) {
            RemoteSelectionToolbar.this.mContentContainer.post(new Runnable() { // from class: android.service.selectiontoolbar.RemoteSelectionToolbar$12$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RemoteSelectionToolbar.AnimationAnimationListenerC278412.this.lambda$onAnimationEnd$0();
                }
            });
        }
    ...
    public static View createMenuItemButton(Context context, ToolbarMenuItem menuItem, int iconTextSpacing, boolean showIcon) {
        View menuItemButton = LayoutInflater.from(context).inflate(C4337R.layout.floating_popup_menu_button, (ViewGroup) null);
        if (menuItem != null) {
    ...
    private static ViewGroup createContentContainer(Context context) {
        ViewGroup contentContainer = (ViewGroup) LayoutInflater.from(context).inflate(C4337R.layout.floating_popup_container, (ViewGroup) null);
