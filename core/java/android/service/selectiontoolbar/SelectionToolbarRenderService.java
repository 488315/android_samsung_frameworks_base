...
public abstract class SelectionToolbarRenderService extends Service {
  ...
  private final SparseArray<Pair<RemoteCallbackWrapper, CleanCacheRunnable>> mCache =
      new SparseArray<>();
  private final ISelectionToolbarRenderService mInterface = new BinderC27931();
  ...
  public abstract void onShow(
      int i, ShowInfo showInfo, RemoteCallbackWrapper remoteCallbackWrapper);

  /* renamed from: android.service.selectiontoolbar.SelectionToolbarRenderService$1 */
  class BinderC27931 extends ISelectionToolbarRenderService.Stub {
    BinderC27931() {}
    ...
    public void onShow(int callingUid, ShowInfo showInfo, ISelectionToolbarCallback callback) {
      if (SelectionToolbarRenderService.this.mCache.indexOfKey(callingUid) < 0) {
        SelectionToolbarRenderService.this.mCache.put(
            callingUid,
            new Pair(
                new RemoteCallbackWrapper(callback),
                SelectionToolbarRenderService.this.new CleanCacheRunnable(callingUid)));
      }
      Pair<RemoteCallbackWrapper, CleanCacheRunnable> toolbarPair =
          (Pair) SelectionToolbarRenderService.this.mCache.get(callingUid);
      ...
      SelectionToolbarRenderService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                                   // android.service.selectiontoolbar.SelectionToolbarRenderService$1$$ExternalSyntheticLambda3
                @Override // com.android.internal.util.function.QuadConsumer
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((SelectionToolbarRenderService) obj)
                      .onShow(
                          ((Integer) obj2).intValue(),
                          (ShowInfo) obj3,
                          (SelectionToolbarRenderService.RemoteCallbackWrapper) obj4);
                }
              },
              SelectionToolbarRenderService.this,
      ...
      SelectionToolbarRenderService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // android.service.selectiontoolbar.SelectionToolbarRenderService$1$$ExternalSyntheticLambda2
    ...
    public void onDismiss(int callingUid, long widgetToken) {
      SelectionToolbarRenderService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // android.service.selectiontoolbar.SelectionToolbarRenderService$1$$ExternalSyntheticLambda0
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
    ...
    public void onConnected(IBinder callback) {
      SelectionToolbarRenderService.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // android.service.selectiontoolbar.SelectionToolbarRenderService$1$$ExternalSyntheticLambda1
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
  ...
  protected void transferTouch(IBinder source, IBinder target) {
    ISelectionToolbarRenderServiceCallback callback = this.mServiceCallback;
    if (callback == null) {
      Log.m96e(TAG, "transferTouch(): no server callback");
    } else {
      try {
  ...
  private class CleanCacheRunnable implements Runnable {
    ...
    public void run() {
      Pair<RemoteCallbackWrapper, CleanCacheRunnable> toolbarPair =
          (Pair) SelectionToolbarRenderService.this.mCache.get(this.mCleanUid);
      if (toolbarPair != null) {
        Log.m102w(
            SelectionToolbarRenderService.TAG,
            "CleanCacheRunnable: remove " + this.mCleanUid + " from cache.");
