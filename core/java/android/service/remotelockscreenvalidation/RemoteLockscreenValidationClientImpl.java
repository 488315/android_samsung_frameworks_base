...
public class RemoteLockscreenValidationClientImpl
  ...
  private ServiceInfo getServiceInfo(Context context, ComponentName serviceComponent) {
    try {
      return context
          .getPackageManager()
          .getServiceInfo(serviceComponent, PackageManager.ComponentInfoFlags.m10of(128L));
    } catch (PackageManager.NameNotFoundException e) {
      Log.m102w(
          TAG,
          TextUtils.formatSimple("Cannot resolve service %s", serviceComponent.getClassName()));
      return null;
    }
  }
