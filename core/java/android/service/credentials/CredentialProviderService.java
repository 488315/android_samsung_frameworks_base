...
public abstract class CredentialProviderService extends Service {
  ...
  private final ICredentialProviderService mInterface =
      new ICredentialProviderService
          .Stub() { // from class: android.service.credentials.CredentialProviderService.1
        @Override // android.service.credentials.ICredentialProviderService
        public void onBeginGetCredential(
            BeginGetCredentialRequest request, final IBeginGetCredentialCallback callback) {
          ...
          CredentialProviderService.this.mHandler.sendMessage(
              PooledLambda.obtainMessage(
                  new QuadConsumer() { // from class:
                                       // android.service.credentials.CredentialProviderService$1$$ExternalSyntheticLambda0
                    @Override // com.android.internal.util.function.QuadConsumer
                    public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                      ((CredentialProviderService) obj)
                          .onBeginGetCredential(
                              (BeginGetCredentialRequest) obj2,
                              (CancellationSignal) obj3,
                              (CredentialProviderService.BinderC26791.AnonymousClass1) obj4);
                    }
                  },
                  CredentialProviderService.this,
                  request,
        ...
        public void onBeginCreateCredential(
            BeginCreateCredentialRequest request, final IBeginCreateCredentialCallback callback) {
          Objects.requireNonNull(request);
          Objects.requireNonNull(callback);
          ICancellationSignal transport = CancellationSignal.createTransport();
          try {
          ...
          CredentialProviderService.this.mHandler.sendMessage(
              PooledLambda.obtainMessage(
                  new QuadConsumer() { // from class:
                                       // android.service.credentials.CredentialProviderService$1$$ExternalSyntheticLambda1
                    @Override // com.android.internal.util.function.QuadConsumer
                    public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                      ((CredentialProviderService) obj)
                          .onBeginCreateCredential(
                              (BeginCreateCredentialRequest) obj2,
                              (CancellationSignal) obj3,
                              (CredentialProviderService.BinderC26791.AnonymousClass2) obj4);
                    }
                  },
                  CredentialProviderService.this,
                  request,
        ...
        public void onClearCredentialState(
            ClearCredentialStateRequest request, final IClearCredentialStateCallback callback) {
          Objects.requireNonNull(request);
          Objects.requireNonNull(callback);
          ICancellationSignal transport = CancellationSignal.createTransport();
          try {
          ...
          CredentialProviderService.this.mHandler.sendMessage(
              PooledLambda.obtainMessage(
                  new QuadConsumer() { // from class:
                                       // android.service.credentials.CredentialProviderService$1$$ExternalSyntheticLambda2
                    @Override // com.android.internal.util.function.QuadConsumer
                    public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                      ((CredentialProviderService) obj)
                          .onClearCredentialState(
                              (ClearCredentialStateRequest) obj2,
                              (CancellationSignal) obj3,
                              (CredentialProviderService.BinderC26791.AnonymousClass3) obj4);
                    }
                  },
                  CredentialProviderService.this,
                  request,
  ...
  public abstract void onBeginCreateCredential(
      BeginCreateCredentialRequest beginCreateCredentialRequest,
      CancellationSignal cancellationSignal,
      OutcomeReceiver<BeginCreateCredentialResponse, CreateCredentialException> outcomeReceiver);

  public abstract void onBeginGetCredential(
      BeginGetCredentialRequest beginGetCredentialRequest,
      CancellationSignal cancellationSignal,
      OutcomeReceiver<BeginGetCredentialResponse, GetCredentialException> outcomeReceiver);

  public abstract void onClearCredentialState(
      ClearCredentialStateRequest clearCredentialStateRequest,
      CancellationSignal cancellationSignal,
      OutcomeReceiver<Void, ClearCredentialStateException> outcomeReceiver);
  ...
  public final IBinder onBind(Intent intent) {
    ...
    Slog.m121w(TAG, "Failed to bind with intent: " + intent);
    return null;
  }
}
