...
public final class BeginGetCredentialResponse implements Parcelable {
  public static final Parcelable.Creator<BeginGetCredentialResponse> CREATOR =
      new Parcelable.Creator<
          BeginGetCredentialResponse>() { // from class:
                                          // android.service.credentials.BeginGetCredentialResponse.1
  ...
  public BeginGetCredentialResponse() {
    this(
        new ParceledListSlice(new ArrayList()),
        new ParceledListSlice(new ArrayList()),
        new ParceledListSlice(new ArrayList()),
        null);
  }
  ...
  private BeginGetCredentialResponse(
      ParceledListSlice<CredentialEntry> credentialEntries,
      ParceledListSlice<Action> authenticationEntries,
      ParceledListSlice<Action> actions,
  ...
  private BeginGetCredentialResponse(Parcel in) {
    ...
    this.mAuthenticationEntries =
        (ParceledListSlice) in.readParcelable(null, ParceledListSlice.class);
  ...
  public static final class Builder {
    ...
    public Builder setActions(List<Action> actions) {
      this.mActions =
          (List) Preconditions.checkCollectionElementsNotNull(actions, Slice.HINT_ACTIONS);
      return this;
    }
    ...
    public Builder setCredentialEntries(List<CredentialEntry> credentialEntries) {
      this.mCredentialEntries =
          (List)
              Preconditions.checkCollectionElementsNotNull(credentialEntries, "credentialEntries");
      return this;
    }
    ...
    public BeginGetCredentialResponse build() {
      return new BeginGetCredentialResponse(
          new ParceledListSlice(this.mCredentialEntries),
          new ParceledListSlice(this.mAuthenticationEntries),
          new ParceledListSlice(this.mActions),
          this.mRemoteCredentialEntry);
    }
  }
}
