...
public abstract class DisplayHashingService extends Service {
    ...
    public abstract void onGenerateDisplayHash(
            byte[] bArr,
            HardwareBuffer hardwareBuffer,
            Rect rect,
            String str,
            DisplayHashResultCallback displayHashResultCallback);
    ...
    final class DisplayHashingServiceWrapper extends IDisplayHashingService.Stub {
        ...
        public void generateDisplayHash(
            ...
            DisplayHashingService.this.mHandler.sendMessage(
                    PooledLambda.obtainMessage(
                            new HexConsumer() { // from class:
                                                // android.service.displayhash.DisplayHashingService$DisplayHashingServiceWrapper$$ExternalSyntheticLambda3
                                ...
                                public final void accept(
                                        ...
                                        Object obj5,
                                        Object obj6) {
                                    ((DisplayHashingService) obj)
                                            .onGenerateDisplayHash(
                                                    (byte[]) obj2,
                                                    (HardwareBuffer) obj3,
                                                    (Rect) obj4,
                                                    (String) obj5,
                                                    (DisplayHashingService
                                                                    .DisplayHashingServiceWrapper
                                                                    .AnonymousClass1)
                                                            obj6);
                                }
                            },
                            DisplayHashingService.this,
                            salt,
                            buffer,
                            bounds,
                            hashAlgorithm,
                            new DisplayHashResultCallback() { // from class:
                                                              // android.service.displayhash.DisplayHashingService.DisplayHashingServiceWrapper.1
                                ...
                                public void onDisplayHashResult(DisplayHash displayHash) {
                                    ...
                                    result.putParcelable(
                                            DisplayHashResultCallback.EXTRA_DISPLAY_HASH,
                                            displayHash);
                                ...
                                public void onDisplayHashError(int errorCode) {
                                    Bundle result = new Bundle();
                                    result.putInt(
                                            DisplayHashResultCallback.EXTRA_DISPLAY_HASH_ERROR_CODE,
                                            errorCode);
                                    callback.sendResult(result);
                                }
                            }));
            ...
            DisplayHashingService.this.mHandler.sendMessage(
                    PooledLambda.obtainMessage(
                            new QuadConsumer() { // from class:
                                                 // android.service.displayhash.DisplayHashingService$DisplayHashingServiceWrapper$$ExternalSyntheticLambda2
            ...
            DisplayHashingService.this.mHandler.sendMessage(
                    PooledLambda.obtainMessage(
                            new BiConsumer() { // from class:
                                               // android.service.displayhash.DisplayHashingService$DisplayHashingServiceWrapper$$ExternalSyntheticLambda0
                                @Override // java.util.function.BiConsumer
                                public final void accept(Object obj, Object obj2) {
                                    ((DisplayHashingService) obj)
                                            .getDisplayHashAlgorithms((RemoteCallback) obj2);
                                }
                            },
                            DisplayHashingService.this,
                            callback));
        ...
        public void getIntervalBetweenRequestsMillis(RemoteCallback callback) {
            DisplayHashingService.this.mHandler.sendMessage(
                    PooledLambda.obtainMessage(
                            new BiConsumer() { // from class:
                                               // android.service.displayhash.DisplayHashingService$DisplayHashingServiceWrapper$$ExternalSyntheticLambda1
                                @Override // java.util.function.BiConsumer
                                public final void accept(Object obj, Object obj2) {
                                    ((DisplayHashingService) obj)
                                            .getDurationBetweenRequestsMillis(
                                                    (RemoteCallback) obj2);
                                }
                            },
                            DisplayHashingService.this,
