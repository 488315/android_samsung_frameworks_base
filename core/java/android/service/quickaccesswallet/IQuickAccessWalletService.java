...
public interface IQuickAccessWalletService extends IInterface {
  ...
  void onTargetActivityIntentRequested(
      IQuickAccessWalletServiceCallbacks iQuickAccessWalletServiceCallbacks) throws RemoteException;
  ...
  void unregisterWalletServiceEventListener(
      WalletServiceEventListenerRequest walletServiceEventListenerRequest) throws RemoteException;
          ...
          switch (code) {
            case 1:
              GetWalletCardsRequest _arg0 =
                  (GetWalletCardsRequest) data.readTypedObject(GetWalletCardsRequest.CREATOR);
              IQuickAccessWalletServiceCallbacks _arg1 =
                  IQuickAccessWalletServiceCallbacks.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
              onWalletCardsRequested(_arg0, _arg1);
              return true;
            case 2:
              SelectWalletCardRequest _arg02 =
                  (SelectWalletCardRequest) data.readTypedObject(SelectWalletCardRequest.CREATOR);
              data.enforceNoDataAvail();
