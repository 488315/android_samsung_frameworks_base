...
public final class ZenPolicy implements Parcelable {
  ...
  public static final Parcelable.Creator<ZenPolicy> CREATOR =
      new Parcelable.Creator<ZenPolicy>() { // from class: android.service.notification.ZenPolicy.1
        ...
        public ZenPolicy createFromParcel(Parcel source) {
          ...
          policy.mPriorityCategories =
              ZenPolicy.trimList(
                  source.readArrayList(Integer.class.getClassLoader(), Integer.class), 9);
          policy.mVisualEffects =
              ZenPolicy.trimList(
                  source.readArrayList(Integer.class.getClassLoader(), Integer.class), 7);
  ...
  public String toString() {
    return ZenPolicy.class.getSimpleName()
        + "{priorityCategories=["
        + priorityCategoriesToString()
        + "], visualEffects=["
        + visualEffectsToString()
        + "], priorityCallsSenders="
        + peopleTypeToString(this.mPriorityCalls)
        + ", priorityMessagesSenders="
        + peopleTypeToString(this.mPriorityMessages)
        + ", priorityConversationSenders="
        + conversationTypeToString(this.mConversationSenders)
        + ", appsToBypassDnd="
        + appsToBypassDndToString(this.mAppsToBypassDnd)
        + ", exceptionContacts="
        + appsToBypassDndToString(this.mExceptionContacts)
        + ", isContactsOverridden="
        + Boolean.toString(this.mIsContactsOverridden)
        + ", isAppBypassDndOverridden="
        + Boolean.toString(this.mIsAppBypassDndOverridden)
        + '}';
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(other.mPriorityCategories, this.mPriorityCategories)
  ...
  public void apply(ZenPolicy policyToApply) {
    ...
    for (int category = 0; category < this.mPriorityCategories.size(); category++) {
      if (this.mPriorityCategories.get(category).intValue() != 2
          && (newState = policyToApply.mPriorityCategories.get(category).intValue()) != 0) {
