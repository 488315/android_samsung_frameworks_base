...
public class ZenModeConfig implements Parcelable {
    ...
    private static boolean sameCondition(ZenRule rule) {
        ...
        return rule.conditionId == null ? rule.condition == null : rule.condition == null || rule.conditionId.equals(rule.condition.f478id);
    }
    ...
    public static Condition toTimeCondition(Context context, long time, int minutes, int userHandle, boolean shortVersion) {
        ...
        if (minutes < 60) {
            int summaryResId = shortVersion ? C4337R.string.zen_mode_duration_minutes_summary_short : C4337R.string.zen_mode_duration_minutes_summary;
            ...
            if (!shortVersion) {
                line1 = res.getQuantityString(C4337R.plurals.zen_mode_duration_time_minutes, minutes, Integer.valueOf(minutes));
            } else {
                line1 = PluralsMessageFormatter.format(res, arguments, C4337R.string.zen_mode_duration_minutes_short);
            }
            line2 = res.getString(C4337R.string.zen_mode_until, formattedTime);
        } else if (minutes < 1440) {
            int num = Math.round(minutes / 60.0f);
            int summaryResId2 = shortVersion ? C4337R.string.zen_mode_duration_hours_summary_short : C4337R.string.zen_mode_duration_hours_summary;
            ...
            if (shortVersion) {
                line1 = PluralsMessageFormatter.format(res, arguments, C4337R.string.zen_mode_duration_hours_short);
            } else {
                line1 = res.getQuantityString(C4337R.plurals.zen_mode_duration_time_hours, num, Integer.valueOf(num));
            }
            line2 = res.getString(C4337R.string.zen_mode_until, formattedTime);
        } else {
    ...
    public static class ScheduleInfo {
        ...
        public String toString() {
            return "ScheduleInfo{days=" + Arrays.toString(this.days) + ", startHour=" + this.startHour + ", startMinute=" + this.startMinute + ", endHour=" + this.endHour + ", endMinute=" + this.endMinute + ", exitAtAlarm=" + this.exitAtAlarm + ", nextAlarm=" + m65ts(this.nextAlarm) + '}';
        }
    ...
    */
    public static EventInfo tryParseEventConditionId(Uri conditionId) {
        boolean z;
        if (conditionId != null && "condition".equals(conditionId.getScheme()) && "android".equals(conditionId.getAuthority())) {
            z = true;
        ...
        for (ZenRule automaticRule : config.automaticRules.values()) {
            if (automaticRule.isAutomaticActive()) {
                if (summary.isEmpty()) {
                    ...
                    summary = context.getResources().getString(C4337R.string.zen_mode_rule_name_combination, summary, automaticRule.name);
                }
            }
        }
        return summary;
    ...
    public static class ZenRule implements Parcelable {
        ...
        public String toString() {
            StringBuilder append = new StringBuilder(ZenRule.class.getSimpleName()).append('[').append("id=").append(this.f482id).append(",state=");
        ...
        public boolean equals(Object o) {
            ...
            return other.enabled == this.enabled && other.snoozing == this.snoozing && Objects.equals(other.name, this.name) && other.zenMode == this.zenMode && Objects.equals(other.conditionId, this.conditionId) && Objects.equals(other.condition, this.condition) && Objects.equals(other.component, this.component) && Objects.equals(other.configurationActivity, this.configurationActivity) && Objects.equals(other.f482id, this.f482id) && Objects.equals(other.enabler, this.enabler) && Objects.equals(other.zenPolicy, this.zenPolicy) && Objects.equals(other.pkg, this.pkg) && other.modified == this.modified;
        }

        public int hashCode() {
            return Objects.hash(Boolean.valueOf(this.enabled), Boolean.valueOf(this.snoozing), this.name, Integer.valueOf(this.zenMode), this.conditionId, this.condition, this.component, this.configurationActivity, this.pkg, this.f482id, this.enabler, this.zenPolicy, Boolean.valueOf(this.modified));
        }
