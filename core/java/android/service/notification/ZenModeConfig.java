...
public class ZenModeConfig implements Parcelable {
  ...
  public static final Parcelable.Creator<ZenModeConfig> CREATOR =
      new Parcelable.Creator<
          ZenModeConfig>() { // from class: android.service.notification.ZenModeConfig.1
  ...
  public String toString() {
    ...
    return ZenModeConfig.class.getSimpleName()
        + "[user="
        + this.user
        + ",allowAlarms="
        + this.allowAlarms
        ...
        + this.allowMessages
        + ",allowConversations="
        + this.allowConversations
        + ",allowCallsFrom="
        + sourceToString(this.allowCallsFrom)
        + ",allowMessagesFrom="
        + sourceToString(this.allowMessagesFrom)
        + ",allowConvFrom="
        + ZenPolicy.conversationTypeToString(this.allowConversationsFrom)
        + ",allowExceptionContacts="
        + contacts
        + ",allowAppBypassDndList="
        + apps
        + ",suppressedVisualEffects="
        + this.suppressedVisualEffects
  ...
  private static boolean isValidAutomaticRule(ZenRule rule) {
    return (rule == null
            || TextUtils.isEmpty(rule.name)
            || !Settings.Global.isValidZenMode(rule.zenMode)
  ...
  private static boolean sameCondition(ZenRule rule) {
    ...
    return rule.conditionId == null
        ? rule.condition == null
        : rule.condition == null || rule.conditionId.equals(rule.condition.f478id);
  }
  ...
  public boolean equals(Object o) {
    ...
    return other.allowAlarms == this.allowAlarms
        && other.allowMedia == this.allowMedia
        && other.allowSystem == this.allowSystem
        && other.allowCalls == this.allowCalls
        && other.allowRepeatCallers == this.allowRepeatCallers
        && other.allowMessages == this.allowMessages
        && other.allowCallsFrom == this.allowCallsFrom
        && other.allowMessagesFrom == this.allowMessagesFrom
        && other.allowReminders == this.allowReminders
        && other.allowEvents == this.allowEvents
        && other.user == this.user
        && Objects.equals(other.automaticRules, this.automaticRules)
        && Objects.equals(other.manualRule, this.manualRule)
        && other.suppressedVisualEffects == this.suppressedVisualEffects
        && other.areChannelsBypassingDnd == this.areChannelsBypassingDnd
        && other.allowConversations == this.allowConversations
        && other.allowConversationsFrom == this.allowConversationsFrom
        && (list = other.allowExceptionContacts) != null
        && list.equals(this.allowExceptionContacts)
        && (list2 = other.allowAppBypassDndList) != null
        && list2.equals(this.allowAppBypassDndList);
  }

  public int hashCode() {
    List<String> list = this.allowExceptionContacts;
    String exceptionContactsString =
        (list == null || list.isEmpty())
            ? new String()
            : joinStrings(",", this.allowExceptionContacts);
    List<String> list2 = this.allowAppBypassDndList;
    String appBypassDndListString =
        (list2 == null || list2.isEmpty())
            ? new String()
            : joinStrings(",", this.allowAppBypassDndList);
    return Objects.hash(
        Boolean.valueOf(this.allowAlarms),
        Boolean.valueOf(this.allowMedia),
        Boolean.valueOf(this.allowSystem),
        Boolean.valueOf(this.allowCalls),
        Boolean.valueOf(this.allowRepeatCallers),
        Boolean.valueOf(this.allowMessages),
        Integer.valueOf(this.allowCallsFrom),
        Integer.valueOf(this.allowMessagesFrom),
        Boolean.valueOf(this.allowReminders),
        Boolean.valueOf(this.allowEvents),
        Integer.valueOf(this.user),
        this.automaticRules,
        this.manualRule,
        Integer.valueOf(this.suppressedVisualEffects),
        Boolean.valueOf(this.areChannelsBypassingDnd),
        Boolean.valueOf(this.allowConversations),
        Integer.valueOf(this.allowConversationsFrom),
        exceptionContactsString,
        appBypassDndListString);
  }
      ...
      if (type != 1) {
        ...
        if (type == 2) {
          if (ALLOW_TAG.equals(tag)) {
            ...
            String exceptionContactString =
                parser.getAttributeValue(str, ALLOW_ATT_EXCEPTION_CONTACTS);
            ...
            String appBypassDndListString =
                parser.getAttributeValue(str, ALLOW_ATT_APP_BYPASS_DND_LIST);
            synchronized (ZenConfigLock) {
            ...
            if (isValidSource(callsFrom) && isValidSource(messagesFrom)) {
              ...
              Slog.m117i(TAG, "Migrating existing shared 'from': " + sourceToString(from));
            ...
            if (readSuppressedEffects) {
              Slog.m113d(TAG, "Migrated visual effects to " + rt.suppressedVisualEffects);
            }
            str = null;
  ...
  public static ZenRule readRuleXml(TypedXmlPullParser parser) {
    ...
    if (rt.zenMode == -1) {
      Slog.m121w(TAG, "Bad zen mode in rule xml:" + zen);
      return null;
    }
    ...
    if (rt.zenMode != 1 && Condition.isValidId(rt.conditionId, "android")) {
      Slog.m117i(TAG, "Updating zenMode of automatic rule " + rt.name);
      rt.zenMode = 1;
    }
  ...
  public static Condition readConditionXml(TypedXmlPullParser parser) {
    ...
    if (id != null) {
      ...
      try {
        ...
        Slog.m122w(TAG, "Unable to read condition xml", e);
        return null;
      }
    }
    return null;
  ...
  public static void writeConditionXml(Condition c, TypedXmlSerializer out) throws IOException {
    out.attribute(null, "id", c.f478id.toString());
  ...
  public ZenPolicy toZenPolicy() {
    ...
    ZenPolicy.Builder allowRepeatCallers =
        builder.allowCalls(i).allowRepeatCallers(this.allowRepeatCallers);
    if (this.allowMessages) {
      i2 = getZenPolicySenders(this.allowMessagesFrom);
    } else {
      i2 = 4;
    }
    ZenPolicy.Builder builder2 =
        allowRepeatCallers
            .allowMessages(i2)
            .allowReminders(this.allowReminders)
            .allowEvents(this.allowEvents)
            .allowAlarms(this.allowAlarms)
            .allowMedia(this.allowMedia)
            .allowSystem(this.allowSystem)
            .allowConversations(this.allowConversations ? this.allowConversationsFrom : 3);
  ...
  public NotificationManager.Policy toNotificationPolicy(ZenPolicy zenPolicy) {
    ...
    if (zenPolicy.isCategoryAllowed(2, isPriorityCategoryEnabled(4, defaultPolicy))) {
      ...
      messageSenders =
          getNotificationPolicySenders(zenPolicy.getPriorityMessageSenders(), messageSenders);
    }
    if (zenPolicy.isCategoryAllowed(8, isPriorityCategoryEnabled(256, defaultPolicy))) {
      priorityCategories |= 256;
      conversationSenders =
          getConversationSendersWithDefault(
    ...
    boolean suppressFullScreenIntent =
        !zenPolicy.isVisualEffectAllowed(0, isVisualEffectAllowed(4, defaultPolicy));
    boolean suppressLights =
        !zenPolicy.isVisualEffectAllowed(1, isVisualEffectAllowed(8, defaultPolicy));
    boolean suppressAmbient =
        true ^ zenPolicy.isVisualEffectAllowed(5, isVisualEffectAllowed(128, defaultPolicy));
  ...
  public NotificationManager.Policy toNotificationPolicy() {
    ...
    int priorityConversationSenders =
        getConversationSendersWithDefault(this.allowConversationsFrom, 2);
    return new NotificationManager.Policy(
        priorityCategories,
        priorityCallSenders,
        priorityMessageSenders,
        this.suppressedVisualEffects,
        this.areChannelsBypassingDnd ? 1 : 0,
        priorityConversationSenders,
        this.allowExceptionContacts,
        this.allowAppBypassDndList);
  }
  ...
  public void applyNotificationPolicy(NotificationManager.Policy policy) {
    ...
    this.allowMessagesFrom =
        normalizePrioritySenders(policy.priorityMessageSenders, this.allowMessagesFrom);
    ...
    this.allowConversationsFrom =
        normalizeConversationSenders(
            z, policy.priorityConversationSenders, this.allowConversationsFrom);
    if (policy.state != -1) {
  ...
  public static Condition toTimeCondition(
      Context context, int minutesFromNow, int userHandle, boolean shortVersion) {
  ...
  public static Condition toTimeCondition(
      Context context, long time, int minutes, int userHandle, boolean shortVersion) {
    String line2;
    String line1;
    String summary;
    ...
    if (minutes < 60) {
      int summaryResId =
          shortVersion
              ? C4337R.string.zen_mode_duration_minutes_summary_short
              : C4337R.string.zen_mode_duration_minutes_summary;
      ...
      if (!shortVersion) {
        line1 =
            res.getQuantityString(
                C4337R.plurals.zen_mode_duration_time_minutes, minutes, Integer.valueOf(minutes));
      } else {
        line1 =
            PluralsMessageFormatter.format(
                res, arguments, C4337R.string.zen_mode_duration_minutes_short);
      }
      line2 = res.getString(C4337R.string.zen_mode_until, formattedTime);
    } else if (minutes < 1440) {
      int num = Math.round(minutes / 60.0f);
      int summaryResId2 =
          shortVersion
              ? C4337R.string.zen_mode_duration_hours_summary_short
              : C4337R.string.zen_mode_duration_hours_summary;
      ...
      if (shortVersion) {
        line1 =
            PluralsMessageFormatter.format(
                res, arguments, C4337R.string.zen_mode_duration_hours_short);
      } else {
        line1 =
            res.getQuantityString(
                C4337R.plurals.zen_mode_duration_time_hours, num, Integer.valueOf(num));
      }
      line2 = res.getString(C4337R.string.zen_mode_until, formattedTime);
    } else {
      String string = res.getString(C4337R.string.zen_mode_until_next_day, formattedTime);
      line2 = string;
      line1 = string;
      summary = string;
    }
  ...
  public static Condition toNextAlarmCondition(Context context, long alarm, int userHandle) {
    ...
    Resources res = context.getResources();
    String line1 = res.getString(C4337R.string.zen_mode_until, formattedTime);
    Uri id = toCountdownConditionId(alarm, true);
    return new Condition(id, "", line1, "", 0, 1, 1);
  }

  public static CharSequence getFormattedTime(
      Context context, long time, boolean isSameDay, int userHandle) {
    String skeleton =
        (!isSameDay ? "EEE " : "")
  ...
  public static boolean isToday(long time) {
    ...
    if (now.get(1) == endTime.get(1)
        && now.get(2) == endTime.get(2)
        && now.get(5) == endTime.get(5)) {
      return true;
    }
    return false;
  }
  ...
  public static long tryParseCountdownConditionId(Uri conditionId) {
    if (!Condition.isValidId(conditionId, "android")
        ...
        || !COUNTDOWN_PATH.equals(conditionId.getPathSegments().get(0))) {
      return 0L;
    }
    try {
      return Long.parseLong(conditionId.getPathSegments().get(1));
    } catch (RuntimeException e) {
      Slog.m122w(TAG, "Error parsing countdown condition: " + conditionId, e);
      return 0L;
    }
  }
  ...
  public static boolean isValidCountdownToAlarmConditionId(Uri conditionId) {
    if (tryParseCountdownConditionId(conditionId) == 0
        || conditionId.getPathSegments().size() < 4
        || !"alarm".equals(conditionId.getPathSegments().get(2))) {
      return false;
    }
    try {
      return Boolean.parseBoolean(conditionId.getPathSegments().get(3));
    } catch (RuntimeException e) {
      Slog.m122w(TAG, "Error parsing countdown alarm condition: " + conditionId, e);
      return false;
    }
  }
  ...
  public static Uri toScheduleConditionId(ScheduleInfo schedule) {
    return new Uri.Builder()
        ...
        .appendQueryParameter(
            "start", schedule.startHour + MediaMetrics.SEPARATOR + schedule.startMinute)
        .appendQueryParameter("end", schedule.endHour + MediaMetrics.SEPARATOR + schedule.endMinute)
  ...
  public static ScheduleInfo tryParseScheduleConditionId(Uri conditionId) {
    boolean isSchedule =
        conditionId != null
            && "condition".equals(conditionId.getScheme())
            && "android".equals(conditionId.getAuthority())
            && conditionId.getPathSegments().size() == 1
            && SCHEDULE_PATH.equals(conditionId.getPathSegments().get(0));
    if (!isSchedule) {
      return null;
    }
  ...
  public static class ScheduleInfo {
    ...
    public String toString() {
      return "ScheduleInfo{days="
          ...
          + this.exitAtAlarm
          + ", nextAlarm="
          + m65ts(this.nextAlarm)
          + '}';
    }

    /* renamed from: ts */
    protected static String m65ts(long time) {
  ...
  public static Uri toEventConditionId(EventInfo event) {
    return new Uri.Builder()
        ...
        .authority("android")
        .appendPath("event")
        .appendQueryParameter(IafdConstant.KEY_USER_ID, Long.toString(event.userId))
        .appendQueryParameter("calendar", event.calName != null ? event.calName : "")
        .appendQueryParameter(
            "calendarId", event.calendarId != null ? event.calendarId.toString() : "")
  ...
  */
  public static EventInfo tryParseEventConditionId(Uri conditionId) {
    ...
    rt.userId = tryParseInt(conditionId.getQueryParameter(IafdConstant.KEY_USER_ID), -10000);
  ...
  public static class EventInfo {
    ...
    public int hashCode() {
      return Objects.hash(
          Integer.valueOf(this.userId), this.calName, this.calendarId, Integer.valueOf(this.reply));
    }
    ...
    public boolean equals(Object o) {
      ...
      return this.userId == other.userId
          && Objects.equals(this.calName, other.calName)
  ...
  public static String getOwnerCaption(Context context, String owner) {
    ...
    try {
      ...
      Slog.m122w(TAG, "Error loading owner caption", e);
      return "";
    }
  }

  public static String getConditionSummary(
      Context context, ZenModeConfig config, int userHandle, boolean shortVersion) {
    return getConditionLine(context, config, userHandle, false, shortVersion);
  }

  private static String getConditionLine(
      Context context,
    ...
    if (zenRule != null) {
      ...
      if (config.manualRule.enabler != null) {
        ...
        summary = context.getString(C4337R.string.zen_mode_forever);
      } else {
        ...
        if (summary.isEmpty()) {
          ...
          summary =
              context
                  .getResources()
                  .getString(
                      C4337R.string.zen_mode_rule_name_combination, summary, automaticRule.name);
        }
      }
    }
    return summary;
  ...
  public static class ZenRule implements Parcelable {
    public static final Parcelable.Creator<ZenRule> CREATOR =
        new Parcelable.Creator<
            ZenRule>() { // from class: android.service.notification.ZenModeConfig.ZenRule.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public void writeToParcel(Parcel parcel, int i) {
      ...
      if (this.f482id != null) {
        parcel.writeInt(1);
        parcel.writeString(this.f482id);
      } else {
        parcel.writeInt(0);
      }
    ...
    public String toString() {
      StringBuilder append =
          new StringBuilder(ZenRule.class.getSimpleName())
              .append('[')
              .append("id=")
              .append(this.f482id)
              .append(",state=");
      ...
      return append
          .append(condition == null ? "STATE_FALSE" : Condition.stateToString(condition.state))
          .append(",enabled=")
          .append(String.valueOf(this.enabled).toUpperCase())
          .append(",snoozing=")
          .append(this.snoozing)
          .append(",name=")
          .append(this.name)
          .append(",zenMode=")
          .append(Settings.Global.zenModeToString(this.zenMode))
          .append(",conditionId=")
    ...
    public void dumpDebug(ProtoOutputStream proto, long fieldId) {
      ...
      proto.write(1138166333441L, this.f482id);
    ...
    public boolean equals(Object o) {
      ...
      return other.enabled == this.enabled
          && other.snoozing == this.snoozing
          && Objects.equals(other.name, this.name)
          && other.zenMode == this.zenMode
          && Objects.equals(other.conditionId, this.conditionId)
          && Objects.equals(other.condition, this.condition)
          && Objects.equals(other.component, this.component)
          && Objects.equals(other.configurationActivity, this.configurationActivity)
          && Objects.equals(other.f482id, this.f482id)
          && Objects.equals(other.enabler, this.enabler)
          && Objects.equals(other.zenPolicy, this.zenPolicy)
          && Objects.equals(other.pkg, this.pkg)
    ...
    public int hashCode() {
      return Objects.hash(
          ...
          Boolean.valueOf(this.snoozing),
          this.name,
          Integer.valueOf(this.zenMode),
          this.conditionId,
          this.condition,
          this.component,
  ...
  public static boolean areAllPriorityOnlyRingerSoundsMuted(NotificationManager.Policy policy) {
    ...
    boolean isExceptionContactsAllowed =
        (policy.getExceptionContacts() == null || policy.getExceptionContacts().isEmpty())
            ? false
            : true;
  ...
  public static boolean isZenOverridingRinger(
      int zen, NotificationManager.Policy consolidatedPolicy) {
    if (zen == 2 || zen == 3) {
      return true;
    }
  ...
  public static boolean areAllPriorityOnlyRingerSoundsMuted(ZenModeConfig config) {
    List<String> list;
    return (config.allowReminders
            || config.allowCalls
            || config.allowMessages
            || config.allowEvents
            || config.allowRepeatCallers
            || config.areChannelsBypassingDnd
            || config.allowSystem
            || (list = config.allowExceptionContacts) == null
            || !list.isEmpty())
        ? false
        : true;
  }
  ...
  public static String getDescription(
      Context context, boolean zenOn, ZenModeConfig config, boolean describeForeverCondition) {
    ...
    if (zenRule != null) {
      ...
      if (config.manualRule.enabler != null) {
        ...
        if (id == null) {
          ...
          return context.getString(C4337R.string.zen_mode_forever);
        }
        latestEndTime = tryParseCountdownConditionId(id);
        if (latestEndTime > 0) {
          CharSequence formattedTime =
              getFormattedTime(context, latestEndTime, isToday(latestEndTime), context.getUserId());
          secondaryText = context.getString(C4337R.string.zen_mode_until, formattedTime);
        }
      }
    }
    for (ZenRule automaticRule : config.automaticRules.values()) {
