...
public abstract class ConditionProviderService extends Service {
  ...
  private final HandlerC2737H mHandler = new HandlerC2737H();
  ...
  public boolean isBound() {
    if (!this.mIsConnected) {
      Log.m102w(this.TAG, "Condition provider service not yet bound.");
    }
  ...
  private final class HandlerC2737H extends Handler {
