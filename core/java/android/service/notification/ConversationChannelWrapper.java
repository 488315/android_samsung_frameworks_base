...
public final class ConversationChannelWrapper implements Parcelable {
  ...
  protected ConversationChannelWrapper(Parcel in) {
    this.mNotificationChannel =
        (NotificationChannel)
            in.readParcelable(
                NotificationChannel.class.getClassLoader(), NotificationChannel.class);
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(getNotificationChannel(), that.getNotificationChannel())
