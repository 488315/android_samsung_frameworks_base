      ...
      try {
        ...
        if (sbn == null) {
          Log.m102w(
              ...
              "onNotificationEnqueuedWithChannel: Error receiving StatusBarNotification");
          return;
        }
      ...
      switch (msg.what) {
        case 1:
          ...
          Adjustment adjustment =
              NotificationAssistantService.this.onNotificationEnqueued(sbn, channel, ranking);
          ...
          if (adjustment != null) {
            ...
            try {
              ...
              Log.m101v(
                  NotificationAssistantService.TAG, "Unable to contact notification manager", ex);
              throw ex.rethrowFromSystemServer();
