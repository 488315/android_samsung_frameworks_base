...
public abstract class NotificationListenerService extends Service {
  ...
  public final void cancelNotification(String pkg, String tag, int id) {
    if (isBound()) {
      try {
        ...
        Log.m101v(this.TAG, "Unable to contact notification manager", ex);
      }
    }
  }
  ...
  public final void snoozeNotification(String key, String snoozeCriterionId) {
    if (isBound()) {
      try {
        getNotificationInterface()
            .snoozeNotificationUntilContextFromListener(this.mWrapper, key, snoozeCriterionId);
      } catch (RemoteException ex) {
        Log.m101v(this.TAG, "Unable to contact notification manager", ex);
      }
    }
  ...
  public final void updateNotificationChannel(
    ...
    if (isBound()) {
      try {
        getNotificationInterface()
            .updateNotificationChannelFromPrivilegedListener(this.mWrapper, pkg, user, channel);
      } catch (RemoteException e) {
        Log.m101v(this.TAG, "Unable to contact notification manager", e);
  ...
  public final StatusBarNotification[] getSnoozedNotifications() {
    try {
      ParceledListSlice<StatusBarNotification> parceledList =
          getNotificationInterface().getSnoozedNotificationsFromListener(this.mWrapper, 0);
  ...
  public StatusBarNotification[] getActiveNotifications(String[] keys, int trim) {
    ...
    try {
      ParceledListSlice<StatusBarNotification> parceledList =
          getNotificationInterface().getActiveNotificationsFromListener(this.mWrapper, keys, trim);
      return cleanUpNotificationList(parceledList);
    } catch (RemoteException ex) {
      Log.m101v(this.TAG, "Unable to contact notification manager", ex);
      return null;
  ...
  protected boolean isBound() {
    if (this.mWrapper == null) {
      Log.m102w(this.TAG, "Notification listener service not yet bound.");
      return false;
    }
    return true;
  }
  ...
  protected class NotificationListenerWrapper extends INotificationListener.Stub {
    ...
    public void onNotificationPosted(
      ...
      try {
        ...
        try {
          ...
          Log.m102w(
              NotificationListenerService.this.TAG,
              "onNotificationPosted: can't rebuild notification from " + sbn.getPackageName());
          sbn = null;
        }
    ...
    public void onEdgeNotificationPosted(String pkg, int id, Bundle extra) {
      try {
        ...
        Log.m103w(
            NotificationListenerService.this.TAG, "Error running onInterruptionFilterChanged", t);
      }
    }
    ...
    public void onNotificationChannelGroupModification(
        String pkgName, UserHandle user, NotificationChannelGroup group, int modificationType) {
      SomeArgs args = SomeArgs.obtain();
      args.arg1 = pkgName;
      args.arg2 = user;
      args.arg3 = group;
  ...
  public static class Ranking {
    ...
    public boolean equals(Object o) {
      ...
      if (Objects.equals(this.mKey, other.mKey)
          ...
          && Objects.equals(
              Integer.valueOf(this.mVisibilityOverride), Integer.valueOf(other.mVisibilityOverride))
          && Objects.equals(
              Integer.valueOf(this.mSuppressedVisualEffects),
              Integer.valueOf(other.mSuppressedVisualEffects))
          && Objects.equals(Integer.valueOf(this.mImportance), Integer.valueOf(other.mImportance))
          ...
          && Objects.equals(Boolean.valueOf(this.mShowBadge), Boolean.valueOf(other.mShowBadge))
          && Objects.equals(
              Integer.valueOf(this.mUserSentiment), Integer.valueOf(other.mUserSentiment))
          && Objects.equals(Boolean.valueOf(this.mHidden), Boolean.valueOf(other.mHidden))
          && Objects.equals(
              Long.valueOf(this.mLastAudiblyAlertedMs), Long.valueOf(other.mLastAudiblyAlertedMs))
          && Objects.equals(Boolean.valueOf(this.mNoisy), Boolean.valueOf(other.mNoisy))) {
        ArrayList<Notification.Action> arrayList = this.mSmartActions;
        ...
        if (size == (arrayList2 == null ? 0 : arrayList2.size())
            ...
            && Objects.equals(Boolean.valueOf(this.mCanBubble), Boolean.valueOf(other.mCanBubble))
            && Objects.equals(
                Boolean.valueOf(this.mIsTextChanged), Boolean.valueOf(other.mIsTextChanged))
            && Objects.equals(
                Boolean.valueOf(this.mIsConversation), Boolean.valueOf(other.mIsConversation))) {
          ...
          if (Objects.equals(id, shortcutInfo2 == null ? 0 : shortcutInfo2.getId())
              && Objects.equals(
                  Integer.valueOf(this.mRankingAdjustment),
                  Integer.valueOf(other.mRankingAdjustment))
              && Objects.equals(Boolean.valueOf(this.mIsBubble), Boolean.valueOf(other.mIsBubble))
              && Objects.equals(
