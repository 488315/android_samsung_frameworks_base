...
public final class Condition implements Parcelable {
    ...
    public String toString() {
        return Condition.class.getSimpleName() + "[state=" + stateToString(this.state) + ",id=" + this.f478id + ",summary=" + this.summary + ",line1=" + this.line1 + ",line2=" + this.line2 + ",icon=" + this.icon + ",flags=" + this.flags + ']';
    }

    public void dumpDebug(ProtoOutputStream proto, long fieldId) {
        long token = proto.start(fieldId);
        proto.write(1138166333441L, this.f478id.toString());
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(other.f478id, this.f478id) && Objects.equals(other.summary, this.summary) && Objects.equals(other.line1, this.line1) && Objects.equals(other.line2, this.line2) && other.icon == this.icon && other.state == this.state && other.flags == this.flags;
    }

    public int hashCode() {
        return Objects.hash(this.f478id, this.summary, this.line1, this.line2, Integer.valueOf(this.icon), Integer.valueOf(this.state), Integer.valueOf(this.flags));
    }
