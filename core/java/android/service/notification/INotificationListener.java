...
public interface INotificationListener extends IInterface {
  ...
  void onNotificationChannelGroupModification(
      String str, UserHandle userHandle, NotificationChannelGroup notificationChannelGroup, int i)
      throws RemoteException;
  ...
  void onNotificationSnoozedUntilContext(
      IStatusBarNotificationHolder iStatusBarNotificationHolder, String str) throws RemoteException;
  ...
  public static class Default implements INotificationListener {
    ...
    public void onNotificationFeedbackReceived(
        String key, NotificationRankingUpdate update, Bundle feedback) throws RemoteException {}
