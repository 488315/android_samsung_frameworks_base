...
public interface IContentSuggestionsService extends IInterface {
  ...
  public static class Default implements IContentSuggestionsService {
    ...
    public void provideContextImage(
        int taskId, HardwareBuffer contextImage, int colorSpaceId, Bundle imageContextRequestExtras)
        throws RemoteException {}
    ...
    public void classifyContentSelections(
        ClassificationsRequest request, IClassificationsCallback callback) throws RemoteException {}
          ...
          switch (code) {
            ...
            case 3:
              ClassificationsRequest _arg03 =
                  (ClassificationsRequest) data.readTypedObject(ClassificationsRequest.CREATOR);
