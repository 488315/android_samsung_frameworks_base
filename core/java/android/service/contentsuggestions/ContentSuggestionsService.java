...
public abstract class ContentSuggestionsService extends Service {
    ...
    private final IContentSuggestionsService mInterface =
            new IContentSuggestionsService
                    .Stub() { // from class:
                              // android.service.contentsuggestions.ContentSuggestionsService.1
                ...
                public void provideContextImage(
                    ...
                    if (imageContextRequestExtras.containsKey(
                ...
                public void suggestContentSelections(
                    ...
                    ContentSuggestionsService.this.mHandler.sendMessage(
                            PooledLambda.obtainMessage(
                                    ...
                                    ContentSuggestionsService.this,
                                    request,
                                    ContentSuggestionsService.this.wrapSelectionsCallback(
                                            callback)));
                }
                ...
                public void classifyContentSelections(
                    ...
                    ContentSuggestionsService.this.mHandler.sendMessage(
                            PooledLambda.obtainMessage(
                                    ...
                                    ContentSuggestionsService.this,
                                    request,
                                    ContentSuggestionsService.this.wrapClassificationCallback(
                                            callback)));
                }
