...
public interface IWearableSensingService extends IInterface {
  ...
  void provideData(
      PersistableBundle persistableBundle, SharedMemory sharedMemory, RemoteCallback remoteCallback)
      throws RemoteException;

  void provideDataStream(ParcelFileDescriptor parcelFileDescriptor, RemoteCallback remoteCallback)
      throws RemoteException;
  ...
  public static class Default implements IWearableSensingService {
    ...
    @Override // android.service.wearable.IWearableSensingService
    public void queryServiceStatus(int[] eventTypes, String packageName, RemoteCallback callback)
        throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 2:
              ...
              return true;
            case 3:
              AmbientContextEventRequest _arg03 =
