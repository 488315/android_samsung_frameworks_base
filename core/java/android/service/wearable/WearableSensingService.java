...
public abstract class WearableSensingService extends Service {
    ...
    public abstract void onDataStreamProvided(
            ParcelFileDescriptor parcelFileDescriptor, Consumer<Integer> consumer);

    public abstract void onQueryServiceStatus(
            Set<Integer> set, String str, Consumer<AmbientContextDetectionServiceStatus> consumer);
    ...
    public abstract void onStartDetection(
            ...
            Consumer<AmbientContextDetectionResult> consumer2);
    ...
    class AnonymousClass1 extends IWearableSensingService.Stub {
        ...
        public void provideSecureConnection(
            ...
            Consumer<Integer> consumer =
                    WearableSensingService.createWearableStatusConsumer(callback);
        ...
        public void registerDataRequestObserver(
            ...
            synchronized (WearableSensingService.this.mDataRequestObserverIdToRequesterMap) {
                dataRequester =
                        (WearableSensingDataRequester)
                                WearableSensingService.this.mDataRequestObserverIdToRequesterMap
                                        .get(dataRequestObserverId);
                if (dataRequester == null) {
                    dataRequester = WearableSensingService.createDataRequester(dataRequestCallback);
                    WearableSensingService.this.mDataRequestObserverIdToRequesterMap.put(
                            dataRequestObserverId, dataRequester);
                }
            }
            Consumer<Integer> statusConsumer =
                    WearableSensingService.createWearableStatusConsumer(statusCallback);
        ...
        public void unregisterDataRequestObserver(
            ...
            synchronized (WearableSensingService.this.mDataRequestObserverIdToRequesterMap) {
                ...
                if (dataRequester == null) {
                    Slog.w(
                            WearableSensingService.TAG,
                            "dataRequestObserverId not found, cannot unregister data request"
                                + " observer.");
                    return;
                }
                WearableSensingService.this.mDataRequestObserverIdToRequesterMap.remove(
        ...
        public void startHotwordRecognition(
                final RemoteCallback wearableHotwordCallback, final RemoteCallback statusCallback) {
            Consumer<HotwordAudioStream> hotwordAudioConsumer =
                    new Consumer() { // from class:
                                     // android.service.wearable.WearableSensingService$1$$ExternalSyntheticLambda2
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            WearableSensingService.AnonymousClass1.lambda$startHotwordRecognition$0(
                                    RemoteCallback.this, (HotwordAudioStream) obj);
                        }
                    };
            Consumer<Integer> statusConsumer =
                    new Consumer() { // from class:
                                     // android.service.wearable.WearableSensingService$1$$ExternalSyntheticLambda3
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            WearableSensingService.AnonymousClass1.lambda$startHotwordRecognition$1(
                                    RemoteCallback.this, (Integer) obj);
                        }
                    };
        ...
        static /* synthetic */ void lambda$startHotwordRecognition$0(
                RemoteCallback wearableHotwordCallback, HotwordAudioStream hotwordAudioStream) {
            Bundle bundle = new Bundle();
            bundle.putParcelable(
                    WearableSensingService.HOTWORD_AUDIO_STREAM_BUNDLE_KEY, hotwordAudioStream);
            wearableHotwordCallback.sendResult(bundle);
        }

        static /* synthetic */ void lambda$startHotwordRecognition$1(
                RemoteCallback statusCallback, Integer response) {
            Bundle bundle = new Bundle();
            bundle.putInt(
                    "android.app.wearable.WearableSensingStatusBundleKey", response.intValue());
        ...
        public void stopHotwordRecognition(final RemoteCallback statusCallback) {
            Consumer<Integer> statusConsumer =
                    new Consumer() { // from class:
                                     // android.service.wearable.WearableSensingService$1$$ExternalSyntheticLambda4
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            WearableSensingService.AnonymousClass1.lambda$stopHotwordRecognition$2(
                                    RemoteCallback.this, (Integer) obj);
                        }
                    };
        ...
        static /* synthetic */ void lambda$stopHotwordRecognition$2(
                RemoteCallback statusCallback, Integer response) {
            Bundle bundle = new Bundle();
            bundle.putInt(
                    "android.app.wearable.WearableSensingStatusBundleKey", response.intValue());
        ...
        public void startDetection(
            ...
            Consumer<AmbientContextDetectionResult> detectionResultConsumer =
                    new Consumer() { // from class:
                                     // android.service.wearable.WearableSensingService$1$$ExternalSyntheticLambda0
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            WearableSensingService.AnonymousClass1.lambda$startDetection$3(
                                    RemoteCallback.this, (AmbientContextDetectionResult) obj);
                        }
                    };
            Consumer<AmbientContextDetectionServiceStatus> statusConsumer =
                    new Consumer() { // from class:
                                     // android.service.wearable.WearableSensingService$1$$ExternalSyntheticLambda1
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            WearableSensingService.AnonymousClass1.lambda$startDetection$4(
                                    RemoteCallback.this,
        ...
        static /* synthetic */ void lambda$startDetection$3(
        ...
        static /* synthetic */ void lambda$startDetection$4(
        ...
        public void queryServiceStatus(
            ...
            Consumer<AmbientContextDetectionServiceStatus> consumer =
                    new Consumer() { // from class:
                                     // android.service.wearable.WearableSensingService$1$$ExternalSyntheticLambda5
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            WearableSensingService.AnonymousClass1.lambda$queryServiceStatus$5(
                                    RemoteCallback.this,
                                    (AmbientContextDetectionServiceStatus) obj);
                        }
                    };
        ...
        static /* synthetic */ void lambda$queryServiceStatus$5(
    ...
    public void onStartHotwordRecognition(
            Consumer<HotwordAudioStream> hotwordAudioConsumer, Consumer<Integer> statusConsumer) {
    ...
    public FileInputStream openFileInput(String fileName) throws FileNotFoundException {
        ...
        try {
            ...
            throw ((FileNotFoundException)
                    new FileNotFoundException("Interrupted when opening a file.").initCause(e2));
        }
    }
    ...
    public static WearableSensingDataRequester createDataRequester(
        ...
        return new WearableSensingDataRequester() { // from class:
                                                    // android.service.wearable.WearableSensingService$$ExternalSyntheticLambda2
            @Override // android.service.wearable.WearableSensingDataRequester
            public final void requestData(
                    WearableSensingDataRequest wearableSensingDataRequest, Consumer consumer) {
                WearableSensingService.lambda$createDataRequester$1(
                        RemoteCallback.this, wearableSensingDataRequest, consumer);
            }
        };
    }

    static /* synthetic */ void lambda$createDataRequester$1(
            RemoteCallback dataRequestCallback,
            WearableSensingDataRequest request,
            final Consumer requestStatusConsumer) {
        Bundle bundle = new Bundle();
        ...
        RemoteCallback requestStatusCallback =
                new RemoteCallback(
                        new RemoteCallback.OnResultListener() { // from class:
                            // android.service.wearable.WearableSensingService$$ExternalSyntheticLambda0
    ...
    public static Consumer<Integer> createWearableStatusConsumer(
        ...
        return new Consumer() { // from class:
                                // android.service.wearable.WearableSensingService$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                WearableSensingService.lambda$createWearableStatusConsumer$2(
                        RemoteCallback.this, (Integer) obj);
            }
        };
    }

    static /* synthetic */ void lambda$createWearableStatusConsumer$2(
            RemoteCallback statusCallback, Integer response) {
        Bundle bundle = new Bundle();
