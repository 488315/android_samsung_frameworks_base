...
public abstract class WearableSensingService extends Service {
  ...
  public abstract void onDataProvided(
      PersistableBundle persistableBundle, SharedMemory sharedMemory, Consumer<Integer> consumer);
  ...
  class BinderC28611 extends IWearableSensingService.Stub {
    BinderC28611() {}

    @Override // android.service.wearable.IWearableSensingService
    public void provideDataStream(
        ParcelFileDescriptor parcelFileDescriptor, final RemoteCallback callback) {
      ...
      Consumer<Integer> consumer =
          new Consumer() { // from class:
            ...
            public final void accept(Object obj) {
              WearableSensingService.BinderC28611.lambda$provideDataStream$0(
    ...
    static /* synthetic */ void lambda$provideDataStream$0(
        RemoteCallback callback, Integer response) {
    ...
    public void provideData(
        PersistableBundle data, SharedMemory sharedMemory, final RemoteCallback callback) {
      ...
      Consumer<Integer> consumer =
          new Consumer() { // from class:
            ...
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              WearableSensingService.BinderC28611.lambda$provideData$1(
                  RemoteCallback.this, (Integer) obj);
            }
          };
    ...
    static /* synthetic */ void lambda$provideData$1(RemoteCallback callback, Integer response) {
      Bundle bundle = new Bundle();
      bundle.putInt("android.app.wearable.WearableSensingStatusBundleKey", response.intValue());
      callback.sendResult(bundle);
    }
    ...
    public void startDetection(
      ...
      Consumer<AmbientContextDetectionResult> detectionResultConsumer =
          new Consumer() { // from class:
            ...
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              WearableSensingService.BinderC28611.lambda$startDetection$2(
      ...
      Consumer<AmbientContextDetectionServiceStatus> statusConsumer =
          new Consumer() { // from class:
            ...
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              WearableSensingService.BinderC28611.lambda$startDetection$3(
                  RemoteCallback.this, (AmbientContextDetectionServiceStatus) obj);
            }
          };
      WearableSensingService.this.onStartDetection(
          request, packageName, statusConsumer, detectionResultConsumer);
      Slog.m113d(WearableSensingService.TAG, "startDetection " + request);
    }

    static /* synthetic */ void lambda$startDetection$2(
    ...
    public void queryServiceStatus(
      ...
      Consumer<AmbientContextDetectionServiceStatus> consumer =
          new Consumer() { // from class:
            ...
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              WearableSensingService.BinderC28611.lambda$queryServiceStatus$4(
                  RemoteCallback.this, (AmbientContextDetectionServiceStatus) obj);
            }
          };
    ...
    static /* synthetic */ void lambda$queryServiceStatus$4(
  ...
  public final IBinder onBind(Intent intent) {
    if (SERVICE_INTERFACE.equals(intent.getAction())) {
      return new BinderC28611();
    }
    Slog.m121w(TAG, "Incorrect service interface, returning null.");
    return null;
  }
