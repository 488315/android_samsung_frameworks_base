...
public final class RotationResolutionRequest implements Parcelable {
  ...
  public RotationResolutionRequest(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) foregroundPackageName);
    this.mCurrentRotation = currentRotation;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) Surface.Rotation.class, (Annotation) null, currentRotation);
    this.mProposedRotation = proposedRotation;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) Surface.Rotation.class, (Annotation) null, proposedRotation);
    this.mShouldUseCamera = shouldUseCamera;
    this.mTimeoutMillis = timeoutMillis;
    AnnotationValidations.validate(
        (Class<? extends Annotation>) DurationMillisLong.class, (Annotation) null, timeoutMillis);
  }
  ...
  public String toString() {
    return "RotationResolutionRequest { foregroundPackageName = "
        + this.mForegroundPackageName
        + ", currentRotation = "
        + this.mCurrentRotation
        + ", proposedRotation = "
        + this.mProposedRotation
        + ", shouldUseCamera = "
        + this.mShouldUseCamera
        + ", timeoutMillis = "
        + this.mTimeoutMillis
        + " }";
  }
