...
public abstract class RotationResolverService extends Service {
  ...
  class BinderC27791 extends IRotationResolverService.Stub {
    BinderC27791() {}
  ...
  public void resolveRotation(
    ...
    if (this.mPendingCallback != null
        && (((cancellationSignal = this.mCancellationSignal) == null
  ...
  public void sendRotationResult(IRotationResolverCallback internalCallback, int result) {
    ...
    if (rotationResolverCallbackWrapper != null
        && rotationResolverCallbackWrapper.mCallback == internalCallback) {
  ...
  public void sendFailureResult(IRotationResolverCallback internalCallback, int error) {
    RotationResolverCallbackWrapper rotationResolverCallbackWrapper = this.mPendingCallback;
    if (rotationResolverCallbackWrapper != null
        && internalCallback == rotationResolverCallbackWrapper.mCallback) {
  ...
  public static final class RotationResolverCallbackWrapper implements RotationResolverCallback {
    ...
    private RotationResolverCallbackWrapper(
        IRotationResolverCallback callback, RotationResolverService service, long expirationTime) {
          ...
          PooledLambda.obtainMessage(
              new TriConsumer() { // from class:
                ...
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((RotationResolverService) obj)
                      .sendRotationResult(
                          (IRotationResolverCallback) obj2, ((Integer) obj3).intValue());
                }
              },
              this.mService,
              this.mCallback,
