...
public interface IGateKeeperService extends IInterface {
  ...
  public static class Default implements IGateKeeperService {
    ...
    public GateKeeperResponse enroll(
        int userId, byte[] currentPasswordHandle, byte[] currentPassword, byte[] desiredPassword)
        throws RemoteException {
      return null;
    }
    ...
    public GateKeeperResponse verify(
        int userId, byte[] enrolledPasswordHandle, byte[] providedPassword) throws RemoteException {
      return null;
    }
