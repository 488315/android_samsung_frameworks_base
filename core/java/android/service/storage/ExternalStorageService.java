...
public abstract class ExternalStorageService extends Service {
  ...
  public abstract void onStartSession(
      String str, int i, ParcelFileDescriptor parcelFileDescriptor, File file, File file2)
      throws IOException;
  ...
  class ExternalStorageServiceWrapper extends IExternalStorageService.Stub {
    ...
    public void startSession(
        ...
        final int flag,
        final ParcelFileDescriptor deviceFd,
        final String upperPath,
        final String lowerPath,
        final RemoteCallback callback)
        throws RemoteException {
      ExternalStorageService.this.mHandler.post(
          new Runnable() { // from class:
                           // android.service.storage.ExternalStorageService$ExternalStorageServiceWrapper$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
              ExternalStorageService.ExternalStorageServiceWrapper.this.lambda$startSession$0(
                  sessionId, flag, deviceFd, upperPath, lowerPath, callback);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$startSession$0(
      ...
      try {
        ExternalStorageService.this.onStartSession(
            sessionId, flag, deviceFd, new File(upperPath), new File(lowerPath));
    ...
    public void notifyVolumeStateChanged(
        final String sessionId, final StorageVolume vol, final RemoteCallback callback) {
      ExternalStorageService.this.mHandler.post(
          new Runnable() { // from class:
                           // android.service.storage.ExternalStorageService$ExternalStorageServiceWrapper$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              ExternalStorageService.ExternalStorageServiceWrapper.this
                  .lambda$notifyVolumeStateChanged$1(vol, sessionId, callback);
            }
          });
    }
    ...
    public void freeCache(
      ...
      ExternalStorageService.this.mHandler.post(
          new Runnable() { // from class:
                           // android.service.storage.ExternalStorageService$ExternalStorageServiceWrapper$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              ExternalStorageService.ExternalStorageServiceWrapper.this.lambda$freeCache$2(
                  volumeUuid, bytes, sessionId, callback);
            }
          });
    }
    ...
    @Override // android.service.storage.IExternalStorageService
    public void endSession(final String sessionId, final RemoteCallback callback)
        throws RemoteException {
      ExternalStorageService.this.mHandler.post(
          new Runnable() { // from class:
                           // android.service.storage.ExternalStorageService$ExternalStorageServiceWrapper$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              ExternalStorageService.ExternalStorageServiceWrapper.this.lambda$endSession$3(
                  sessionId, callback);
            }
          });
    }
    ...
    @Override // android.service.storage.IExternalStorageService
    public void notifyAnrDelayStarted(
        final String packageName, final int uid, final int tid, final int reason)
        throws RemoteException {
      ExternalStorageService.this.mHandler.post(
          new Runnable() { // from class:
                           // android.service.storage.ExternalStorageService$ExternalStorageServiceWrapper$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              ExternalStorageService.ExternalStorageServiceWrapper.this
                  .lambda$notifyAnrDelayStarted$4(packageName, uid, tid, reason);
            }
          });
    }
    ...
    private void sendResult(String sessionId, Throwable throwable, RemoteCallback callback) {
      ...
      if (throwable != null) {
        bundle.putParcelable(
            ExternalStorageService.EXTRA_ERROR, new ParcelableException(throwable));
      }
