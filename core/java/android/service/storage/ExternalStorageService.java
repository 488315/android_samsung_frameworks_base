                    ...
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            ExternalStorageService.ExternalStorageServiceWrapper.this
                                    .lambda$startSession$0(
                                            sessionId, flag, deviceFd, upperPath, lowerPath,
                                            callback);
                        }
                    });
        }
        ...
        public void freeCache(
            ...
            ExternalStorageService.this.mHandler.post(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            ExternalStorageService.ExternalStorageServiceWrapper.this
                                    .lambda$freeCache$2(volumeUuid, bytes, sessionId, callback);
                        }
                    });
        }
        ...
        public void endSession(final String sessionId, final RemoteCallback callback)
            ...
            ExternalStorageService.this.mHandler.post(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            ExternalStorageService.ExternalStorageServiceWrapper.this
                                    .lambda$endSession$3(sessionId, callback);
                        }
                    });
        }
