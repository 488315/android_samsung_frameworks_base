...
public interface IExternalStorageService extends IInterface {
  ...
  public static class Default implements IExternalStorageService {
    ...
    public void notifyVolumeStateChanged(
        String sessionId, StorageVolume vol, RemoteCallback callback) throws RemoteException {}

    @Override // android.service.storage.IExternalStorageService
    public void freeCache(String sessionId, String volumeUuid, long bytes, RemoteCallback callback)
        throws RemoteException {}
