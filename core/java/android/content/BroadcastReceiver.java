...
public abstract class BroadcastReceiver {
  ...
  public static class PendingResult {
    ...
    public final void finish() {
      ...
      if (this.mType == 0) {
        ...
        if (QueuedWork.hasPendingWork()) {
          QueuedWork.queue(
              new Runnable() { // from class: android.content.BroadcastReceiver.PendingResult.1
    ...
    void checkSynchronousHint() {
      ...
      e.fillInStackTrace();
      Log.m97e("BroadcastReceiver", e.getMessage(), e);
    }
  }
  ...
  public final UserHandle getSendingUser() {
    return UserHandle.m55of(getSendingUserId());
  }
