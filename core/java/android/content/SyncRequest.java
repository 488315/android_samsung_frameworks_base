  ...
  public static class Builder {
    ...
    public Builder setDisallowMetered(boolean disallow) {
      if (this.mIgnoreSettings && disallow) {
        throw new IllegalArgumentException(
            "setDisallowMetered(true) after having specified that settings are ignored.");
      }
    ...
    public Builder setIgnoreSettings(boolean ignoreSettings) {
      if (this.mDisallowMetered && ignoreSettings) {
        throw new IllegalArgumentException(
            "setIgnoreSettings(true) after having specified sync settings with this builder.");
      }
    ...
    public SyncRequest build() {
      ...
      if ((this.mCustomExtras.getBoolean(ContentResolver.SYNC_EXTRAS_SCHEDULE_AS_EXPEDITED_JOB)
              || this.mScheduleAsExpeditedJob)
          && (ContentResolver.hasInvalidScheduleAsEjExtras(this.mCustomExtras)
              || ContentResolver.hasInvalidScheduleAsEjExtras(this.mSyncConfigExtras))) {
        throw new IllegalArgumentException("Illegal extras were set");
      }
      if (this.mSyncTarget == 0) {
        throw new IllegalArgumentException(
