...
public interface IRestrictionsManager extends IInterface {
  ...
  void requestPermission(String str, String str2, String str3, PersistableBundle persistableBundle)
      throws RemoteException;
  ...
  public static class Default implements IRestrictionsManager {
    ...
    @Override // android.content.IRestrictionsManager
    public List<Bundle> getApplicationRestrictionsPerAdminForUser(int userId, String packageName)
        throws RemoteException {
      return null;
    }
    ...
    public void requestPermission(
        String packageName, String requestType, String requestId, PersistableBundle requestData)
        throws RemoteException {}
