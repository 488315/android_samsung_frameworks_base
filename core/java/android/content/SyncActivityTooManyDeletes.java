...
public class SyncActivityTooManyDeletes extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence[] options = {getResources().getText(C4337R.string.sync_really_delete), getResources().getText(C4337R.string.sync_undo_deletes), getResources().getText(C4337R.string.sync_do_nothing)};
        ...
        CharSequence tooManyDeletesDescFormat = getResources().getText(C4337R.string.sync_too_many_deletes_desc);
