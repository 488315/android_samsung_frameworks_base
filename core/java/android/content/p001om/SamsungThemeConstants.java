...
public final class SamsungThemeConstants {
  ...
  public static HashMap<String, String> overlayTargetMap =
      new HashMap<String, String>() { // from class: android.content.om.SamsungThemeConstants.1
        {
          put("fwk", "android");
  ...
  public static ArrayList<String> protectedApps =
      new ArrayList<>(
          Arrays.asList(THEMECENTER_PACKAGE_NAME, "com.samsung.android.localeoverlaymanager"));
  ...
  public static ArrayList<String> mandatoryTargets =
      new ArrayList<>(
          Arrays.asList(
              "android",
              AsPackageName.SYSTEMUI,
  ...
  public static ArrayList<String> allowPostfixForCover =
      new ArrayList<>(
          Arrays.asList(THEME_OVERLAY_SAMSUNG_KEYBOARD_POSTFIX, THEME_OVERLAY_AOD_POSTFIX));
  ...
  public static ArrayList<String> allowSystemUIForCover =
      new ArrayList<>(Arrays.asList(THEME_OVERLAY_SYSTEMUI_POSTFIX, THEME_OVERLAY_LOCK_POSTFIX));
