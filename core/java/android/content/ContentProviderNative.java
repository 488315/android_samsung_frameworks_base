...
public abstract class ContentProviderNative extends Binder implements IContentProvider {
    ...
    public static IContentProvider asInterface(IBinder obj) {
        ...
        IContentProvider in =
                (IContentProvider) obj.queryLocalInterface(IContentProvider.descriptor);
        if (in != null) {
            return in;
        }
            ...
            switch (code) {
                case 1:
                    ...
                    if (cursor != null) {
                        ...
                        try {
                            CursorToBulkCursorAdaptor adaptor2 =
                ...
                case 3:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource3 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 4:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource4 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 10:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource5 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 13:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource6 =
                            AttributionSource.CREATOR.createFromParcel(data);
                    Uri url6 = Uri.CREATOR.createFromParcel(data);
                    ContentValues[] values3 =
                            (ContentValues[]) data.createTypedArray(ContentValues.CREATOR);
                ...
                case 14:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource7 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 15:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource8 =
                            AttributionSource.CREATOR.createFromParcel(data);
                    Uri url8 = Uri.CREATOR.createFromParcel(data);
                    String mode2 = data.readString();
                    ICancellationSignal signal2 =
                            ICancellationSignal.Stub.asInterface(data.readStrongBinder());
                    AssetFileDescriptor fd2 =
                            openAssetFile(attributionSource8, url8, mode2, signal2);
                    reply.writeNoException();
                    if (fd2 != null) {
                        reply.writeInt(1);
                ...
                case 20:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource9 =
                            AttributionSource.CREATOR.createFromParcel(data);
                    ...
                    ContentProviderResult[] results =
                            applyBatch(attributionSource9, authority, operations);
                    reply.writeNoException();
                    reply.writeTypedArray(results, 0);
                    return true;
                case 21:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource10 =
                            AttributionSource.CREATOR.createFromParcel(data);
                    ...
                    Bundle responseBundle =
                            call(attributionSource10, authority2, method, stringArg, extras4);
                    reply.writeNoException();
                    reply.writeBundle(responseBundle);
                    return true;
                case 22:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource11 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 23:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource12 =
                            AttributionSource.CREATOR.createFromParcel(data);
                    Uri url10 = Uri.CREATOR.createFromParcel(data);
                    String mimeType = data.readString();
                    Bundle opts = data.readBundle();
                    ICancellationSignal signal3 =
                            ICancellationSignal.Stub.asInterface(data.readStrongBinder());
                    AssetFileDescriptor fd3 =
                            openTypedAssetFile(attributionSource12, url10, mimeType, opts, signal3);
                    reply.writeNoException();
                    if (fd3 != null) {
                        reply.writeInt(1);
                ...
                case 25:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource13 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 26:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource14 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 28:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource16 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 29:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource17 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 30:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource18 =
                            AttributionSource.CREATOR.createFromParcel(data);
                ...
                case 31:
                    data.enforceInterface(IContentProvider.descriptor);
                    AttributionSource attributionSource19 =
                            AttributionSource.CREATOR.createFromParcel(data);
