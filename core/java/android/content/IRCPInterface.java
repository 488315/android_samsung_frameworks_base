...
public interface IRCPInterface extends IInterface {
  ...
  long moveUnlimitedFiles(int i, int i2, Uri uri, SemIRCPCallback semIRCPCallback)
      throws RemoteException;

  long moveUnlimitedFiles2(int i, int i2, Uri uri, SemIRCPCallback semIRCPCallback, String str)
      throws RemoteException;
  ...
  public static class Default implements IRCPInterface {
    ...
    @Override // android.content.IRCPInterface
    public long moveUnlimitedFiles(
        int srcContainerId, int destContainerId, Uri uri, SemIRCPCallback callback)
        throws RemoteException {
      return 0L;
    }

    @Override // android.content.IRCPInterface
    public long moveFilesForApp(
        int requestApp, List<String> srcFilePaths, List<String> destFilePaths)
        throws RemoteException {
      return 0L;
    }

    @Override // android.content.IRCPInterface
    public long moveUnlimitedFilesForApp(int requestApp, Uri uri, int fileCount, int containerId)
        throws RemoteException {
      return 0L;
    }
        ...
        default:
          switch (code) {
            ...
            case 12:
              ...
              data.enforceNoDataAvail();
              int _result12 =
                  copyChunks(_arg012, _arg111, _arg28, _arg37, _arg43, _arg5, _arg6, _arg7);
              reply.writeNoException();
