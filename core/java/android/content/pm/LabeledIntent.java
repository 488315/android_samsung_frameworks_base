...
public class LabeledIntent extends Intent {
  public static final Parcelable.Creator<LabeledIntent> CREATOR =
      new Parcelable.Creator<LabeledIntent>() { // from class: android.content.pm.LabeledIntent.1
  ...
  public CharSequence loadLabel(PackageManager pm) {
    ...
    if (i == 0
        || (str = this.mSourcePackage) == null
        || (label = pm.getText(str, i, null)) == null) {
      return null;
    }
    return label;
  }
  ...
  public Drawable loadIcon(PackageManager pm) {
    ...
    if (i == 0
        || (str = this.mSourcePackage) == null
        || (icon = pm.getDrawable(str, i, null)) == null) {
      return null;
    }
    return icon;
  }
