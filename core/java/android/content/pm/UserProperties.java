...
public final class UserProperties implements Parcelable {
  ...
  public static final Parcelable.Creator<UserProperties> CREATOR =
      new Parcelable.Creator<UserProperties>() { // from class: android.content.pm.UserProperties.1
    ...
    for (int i = 0; i < attributeCount; i++) {
      ...
      switch (c) {
        ...
        case '\n':
          ...
          break;
        default:
          Slog.m121w(LOG_TAG, "Skipping unknown property " + attributeName);
          break;
      }
    }
  }
  ...
  public void writeToXml(TypedXmlSerializer serializer) throws IOException, XmlPullParserException {
    ...
    if (isPresent(9L)) {
      serializer.attributeBoolean(
          null, ATTR_CREDENTIAL_SHAREABLE_WITH_PARENT, this.mCredentialShareableWithParent);
    }
    if (isPresent(10L)) {
