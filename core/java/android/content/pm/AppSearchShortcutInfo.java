...
public class AppSearchShortcutInfo extends GenericDocument {
      ...
      new AppSearchSchema.Builder(SCHEMA_TYPE)
          ...
          .addProperty(
              new AppSearchSchema.StringPropertyConfig.Builder(KEY_INTENTS)
                  ...
                  .build())
          .addProperty(
              new AppSearchSchema.BytesPropertyConfig.Builder(KEY_INTENT_PERSISTABLE_EXTRAS)
                  .setCardinality(1)
                  .build())
          .addProperty(
          ...
          .addProperty(
              new AppSearchSchema.StringPropertyConfig.Builder(KEY_LOCUS_ID)
                  ...
                  .build())
          .addProperty(
              new AppSearchSchema.BytesPropertyConfig.Builder(KEY_EXTRAS).setCardinality(2).build())
          .addProperty(
              new AppSearchSchema.StringPropertyConfig.Builder("flags")
                  ...
                  .build())
          .addProperty(
              new AppSearchSchema.LongPropertyConfig.Builder("iconResId").setCardinality(2).build())
          .addProperty(
              new AppSearchSchema.StringPropertyConfig.Builder(KEY_ICON_RES_NAME)
                  .setCardinality(2)
                  .setTokenizerType(0)
                  .setIndexingType(0)
                  .build())
          ...
          .addProperty(
              new AppSearchSchema.StringPropertyConfig.Builder(KEY_CAPABILITY)
                  ...
                  .build())
          .addProperty(
              new AppSearchSchema.StringPropertyConfig.Builder(KEY_CAPABILITY_BINDINGS)
                  .setCardinality(1)
                  .setTokenizerType(1)
                  .setIndexingType(2)
                  .build())
                  ...
                  .map(
                      new Function() { // from class:
                        ...
                        public final Object apply(Object obj) {
                          ...
                          transformToBundle =
                              AppSearchShortcutInfo.this.transformToBundle((byte[]) obj);
  ...
  public static class Builder extends GenericDocument.Builder<Builder> {
    ...
    public Builder setShortLabel(CharSequence shortLabel) {
      if (!TextUtils.isEmpty(shortLabel)) {
        setPropertyString(
            ...
            Preconditions.checkStringNotEmpty(shortLabel, "shortLabel cannot be empty").toString());
      }
      return this;
    }
    ...
    public Builder setLongLabel(CharSequence longLabel) {
      if (!TextUtils.isEmpty(longLabel)) {
        setPropertyString(
            ...
            Preconditions.checkStringNotEmpty(longLabel, "longLabel cannot be empty").toString());
      }
      return this;
    }
    ...
    public Builder setIntents(Intent[] intents) {
      ...
      for (int i = 0; i < intents.length; i++) {
        ...
        intentExtrases[i] =
            extras == null
                ? new byte[0]
                : AppSearchShortcutInfo.transformToByteArray(new PersistableBundle(extras));
      }
      setPropertyString(
    ...
    public Builder setExtras(PersistableBundle extras) {
      if (extras != null) {
        setPropertyBytes(
            AppSearchShortcutInfo.KEY_EXTRAS, AppSearchShortcutInfo.transformToByteArray(extras));
      }
      return this;
    }
                ...
                params.get(paramName).stream()
                    .map(
                        new Function() { // from class:
                          ...
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            return AppSearchShortcutInfo.Builder.lambda$setCapabilityBindings$3(
                                capabilityName, paramName, (String) obj);
                          }
                        });
