...
public class SplitPermissionInfoParcelable implements Parcelable {
  public static final Parcelable.Creator<SplitPermissionInfoParcelable> CREATOR =
      new Parcelable.Creator<
          SplitPermissionInfoParcelable>() { // from class:
  ...
  public SplitPermissionInfoParcelable(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) splitPermission);
    this.mNewPermissions = newPermissions;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) newPermissions);
    this.mTargetSdk = targetSdk;
    AnnotationValidations.validate(
        (Class<IntRange>) IntRange.class, (IntRange) null, targetSdk, "from", 0L);
    onConstructed();
  }
