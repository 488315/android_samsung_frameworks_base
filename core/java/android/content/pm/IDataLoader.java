          ...
          switch (code) {
            case 1:
              ...
              FileSystemControlParcel _arg2 =
                  (FileSystemControlParcel) data.readTypedObject(FileSystemControlParcel.CREATOR);
            ...
            case 5:
              ...
              InstallationFileParcel[] _arg12 =
                  (InstallationFileParcel[]) data.createTypedArray(InstallationFileParcel.CREATOR);
