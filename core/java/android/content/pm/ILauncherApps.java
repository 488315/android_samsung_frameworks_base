...
public interface ILauncherApps extends IInterface {
  ...
  void unregisterShortcutChangeCallback(String str, IShortcutChangeCallback iShortcutChangeCallback)
      throws RemoteException;
  ...
  public static class Default implements ILauncherApps {
    ...
    public LauncherActivityInfoInternal resolveLauncherActivityInternal(
        String callingPackage, ComponentName component, UserHandle user) throws RemoteException {
      return null;
    }
    ...
    public ParceledListSlice getShortcuts(
        String callingPackage, ShortcutQueryWrapper query, UserHandle user) throws RemoteException {
      return null;
    }
    ...
    public void pinShortcuts(
        String callingPackage, String packageName, List<String> shortcutIds, UserHandle user)
        throws RemoteException {}
    ...
    public int getShortcutIconResId(
        String callingPackage, String packageName, String id, int userId) throws RemoteException {
      return 0;
    }
    ...
    public PendingIntent getShortcutIntent(
        String callingPackage, String packageName, String shortcutId, Bundle opts, UserHandle user)
        throws RemoteException {
      return null;
    }
        ...
        default:
          switch (code) {
            ...
            case 14:
              ...
              ShortcutQueryWrapper _arg113 =
                  (ShortcutQueryWrapper) data.readTypedObject(ShortcutQueryWrapper.CREATOR);
            ...
            case 17:
              ...
              data.enforceNoDataAvail();
              boolean _result10 =
                  startShortcut(_arg017, _arg116, _arg214, _arg37, _arg44, _arg54, _arg64);
              reply.writeNoException();
            ...
            case 24:
              ...
              data.enforceNoDataAvail();
              PendingIntent _result17 =
                  getShortcutIntent(_arg024, _arg122, _arg219, _arg310, _arg45);
              reply.writeNoException();
              reply.writeTypedObject(_result17, 1);
              return true;
            case 25:
              String _arg025 = data.readString();
              IPackageInstallerCallback _arg123 =
            ...
            case 27:
              ...
              ShortcutQueryWrapper _arg124 =
                  (ShortcutQueryWrapper) data.readTypedObject(ShortcutQueryWrapper.CREATOR);
              IShortcutChangeCallback _arg220 =
            ...
            case 28:
              ...
              IShortcutChangeCallback _arg125 =
                  IShortcutChangeCallback.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 32:
              ...
              data.enforceNoDataAvail();
              Map<String, LauncherActivityInfoInternal> _result20 =
                  getActivityOverrides(_arg032, _arg129);
              reply.writeNoException();
              if (_result20 == null) {
                reply.writeInt(-1);
              } else {
                    ...
                    new BiConsumer() { // from class:
                      ...
                      public final void accept(Object obj, Object obj2) {
                        ILauncherApps.Stub.lambda$onTransact$0(
                            Parcel.this, (String) obj, (LauncherActivityInfoInternal) obj2);
                      }
                    });
              }
              return true;
