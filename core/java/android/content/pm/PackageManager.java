...
public abstract class PackageManager {
    ...
    @SystemApi public static final int APP_METADATA_SOURCE_APK = 1;

    @SystemApi public static final int APP_METADATA_SOURCE_INSTALLER = 2;

    @SystemApi public static final int APP_METADATA_SOURCE_SYSTEM_IMAGE = 3;

    @SystemApi public static final int APP_METADATA_SOURCE_UNKNOWN = 0;
    ...
    @SystemApi public static final int DELETE_ALL_USERS = 2;
    ...
    @SystemApi public static final int DELETE_FAILED_ABORTED = -5;
    public static final int DELETE_FAILED_APP_PINNED = -7;

    @SystemApi public static final int DELETE_FAILED_DEVICE_POLICY_MANAGER = -2;
    public static final int DELETE_FAILED_FOR_CHILD_PROFILE = -8;

    @SystemApi public static final int DELETE_FAILED_INTERNAL_ERROR = -1;

    @SystemApi public static final int DELETE_FAILED_OWNER_BLOCKED = -4;
    public static final int DELETE_FAILED_USED_SHARED_LIBRARY = -6;
    public static final int DELETE_FAILED_USER_RESTRICTED = -3;

    @SystemApi public static final int DELETE_KEEP_DATA = 1;

    @SystemApi public static final int DELETE_SUCCEEDED = 1;
    ...
    @SystemApi public static final String FEATURE_CONTEXT_HUB = "android.hardware.context_hub";
    ...
    @SystemApi public static final String FEATURE_EROFS = "android.software.erofs";

    @SystemApi public static final String FEATURE_EROFS_LEGACY = "android.software.erofs_legacy";
    ...
    @SystemApi public static final String FEATURE_GAME_SERVICE = "android.software.game_service";
    ...
    public static final String FEATURE_MOTIONRECOGNITION_SERVICE =
    ...
    @Deprecated public static final String FEATURE_NFC_HCE = "android.hardware.nfc.hce";
    ...
    @SystemApi public static final String FEATURE_REBOOT_ESCROW = "android.hardware.reboot_escrow";
    ...
    @Deprecated public static final String FEATURE_TELEVISION = "android.hardware.type.television";
    ...
    @Deprecated public static final String FEATURE_VR_MODE = "android.software.vr.mode";
    ...
    @SystemApi public static final int FLAGS_PERMISSION_RESERVED_PERMISSION_CONTROLLER = -268435456;
    public static final int FLAGS_PERMISSION_RESTRICTION_ANY_EXEMPT = 14336;

    @SystemApi public static final int FLAG_PERMISSION_APPLY_RESTRICTION = 16384;

    @SystemApi public static final int FLAG_PERMISSION_AUTO_REVOKED = 131072;

    @SystemApi public static final int FLAG_PERMISSION_GRANTED_BY_DEFAULT = 32;

    @SystemApi public static final int FLAG_PERMISSION_GRANTED_BY_ROLE = 32768;

    @SystemApi public static final int FLAG_PERMISSION_ONE_TIME = 65536;

    @SystemApi public static final int FLAG_PERMISSION_POLICY_FIXED = 4;

    @SystemApi public static final int FLAG_PERMISSION_RESTRICTION_INSTALLER_EXEMPT = 2048;

    @SystemApi public static final int FLAG_PERMISSION_RESTRICTION_SYSTEM_EXEMPT = 4096;

    @SystemApi public static final int FLAG_PERMISSION_RESTRICTION_UPGRADE_EXEMPT = 8192;

    @SystemApi public static final int FLAG_PERMISSION_REVIEW_REQUIRED = 64;

    @SystemApi public static final int FLAG_PERMISSION_REVOKED_COMPAT = 8;

    @SystemApi @Deprecated public static final int FLAG_PERMISSION_REVOKE_ON_UPGRADE = 8;

    @SystemApi public static final int FLAG_PERMISSION_REVOKE_WHEN_REQUESTED = 128;

    @SystemApi public static final int FLAG_PERMISSION_SELECTED_LOCATION_ACCURACY = 524288;

    @SystemApi public static final int FLAG_PERMISSION_SYSTEM_FIXED = 16;

    @SystemApi public static final int FLAG_PERMISSION_USER_FIXED = 2;

    @SystemApi public static final int FLAG_PERMISSION_USER_SENSITIVE_WHEN_DENIED = 512;

    @SystemApi public static final int FLAG_PERMISSION_USER_SENSITIVE_WHEN_GRANTED = 256;

    @SystemApi public static final int FLAG_PERMISSION_USER_SET = 1;
    ...
    @SystemApi public static final int FLAG_SUSPEND_QUARANTINED = 1;
    public static final int GET_ACTIVITIES = 1;
    public static final String GET_APP_LIST_PERMISSION =
            "com.samsung.android.permission.GET_APP_LIST";

    @Deprecated public static final int GET_ATTRIBUTIONS = Integer.MIN_VALUE;
    public static final long GET_ATTRIBUTIONS_LONG = 2147483648L;
    public static final int GET_CONFIGURATIONS = 16384;

    @Deprecated public static final int GET_DISABLED_COMPONENTS = 512;

    @Deprecated public static final int GET_DISABLED_UNTIL_USED_COMPONENTS = 32768;
    public static final int GET_GIDS = 256;
    public static final int GET_INSTRUMENTATION = 16;

    @Deprecated public static final int GET_INTENT_FILTERS = 32;
    ...
    @Deprecated public static final int GET_SIGNATURES = 64;
    public static final int GET_SIGNING_CERTIFICATES = 134217728;

    @Deprecated public static final int GET_UNINSTALLED_PACKAGES = 8192;
    ...
    @SystemApi public static final int INSTALL_FAILED_MISSING_FEATURE = -17;
    ...
    @SystemApi @Deprecated public static final int INTENT_FILTER_DOMAIN_VERIFICATION_STATUS_ASK = 1;
    ...
    @SystemApi @Deprecated public static final int INTENT_FILTER_VERIFICATION_FAILURE = -1;

    @SystemApi @Deprecated public static final int INTENT_FILTER_VERIFICATION_SUCCESS = 1;

    @SystemApi @Deprecated public static final int MASK_PERMISSION_FLAGS = 255;
    public static final int MASK_PERMISSION_FLAGS_ALL = 261119;
    public static final int MATCH_ALL = 131072;

    @SystemApi public static final int MATCH_ANY_USER = 4194304;
    public static final int MATCH_APEX = 1073741824;
    public static final long MATCH_ARCHIVED_PACKAGES = 4294967296L;

    @SystemApi @Deprecated public static final int MATCH_CLONE_PROFILE = 536870912;

    @SystemApi public static final long MATCH_CLONE_PROFILE_LONG = 17179869184L;

    @Deprecated public static final int MATCH_DEBUG_TRIAGED_MISSING = 268435456;
    ...
    @SystemApi public static final int MATCH_FACTORY_ONLY = 2097152;

    @SystemApi public static final int MATCH_HIDDEN_UNTIL_INSTALLED_COMPONENTS = 536870912;

    @SystemApi public static final int MATCH_INSTANT = 8388608;
    ...
    @SystemApi public static final int MODULE_APEX_NAME = 1;

    @Deprecated public static final int MOVE_EXTERNAL_MEDIA = 2;
    ...
    @Deprecated public static final int MOVE_INTERNAL = 1;
    ...
    @SystemApi public static final int RESTRICTION_HIDE_FROM_SUGGESTIONS = 1;

    @SystemApi public static final int RESTRICTION_HIDE_NOTIFICATIONS = 2;

    @SystemApi public static final int RESTRICTION_NONE = 0;

    @SystemApi public static final int ROLLBACK_DATA_POLICY_RESTORE = 0;

    @SystemApi public static final int ROLLBACK_DATA_POLICY_RETAIN = 2;

    @SystemApi public static final int ROLLBACK_DATA_POLICY_WIPE = 1;

    @SystemApi public static final int ROLLBACK_USER_IMPACT_HIGH = 1;

    @SystemApi public static final int ROLLBACK_USER_IMPACT_LOW = 0;

    @SystemApi public static final int ROLLBACK_USER_IMPACT_ONLY_MANUAL = 2;
    ...
    public static final String SEM_FEATURE_DEVICE_CATEGORY_PHONE =
            "com.samsung.feature.device_category_phone";
    public static final String SEM_FEATURE_DEVICE_CATEGORY_PHONE_HIGH_END =
            "com.samsung.feature.device_category_phone_high_end";
    public static final String SEM_FEATURE_DEVICE_CATEGORY_PHONE_LOW_END =
            "com.samsung.feature.device_category_phone_low_end";
    public static final String SEM_FEATURE_DEVICE_CATEGORY_TABLET =
            "com.samsung.feature.device_category_tablet";
    public static final String SEM_FEATURE_DEVICE_CATEGORY_TABLET_HIGH_END =
            "com.samsung.feature.device_category_tablet_high_end";
    public static final String SEM_FEATURE_DEVICE_CATEGORY_TABLET_LOW_END =
            "com.samsung.feature.device_category_tablet_low_end";
    public static final String SEM_FEATURE_DUAL_SCREEN = "com.sec.feature.dual_lcd";

    @Deprecated public static final String SEM_FEATURE_FINDO = "com.sec.feature.findo";
    ...
    public static final String SEM_FEATURE_MOTION_RECOGNITION_SERVICE =
            "com.sec.feature.motionrecognition_service";
    public static final String SEM_FEATURE_MST = "com.sec.feature.support_mst";
    public static final String SEM_FEATURE_SAMSUNG_EXPERIENCE_MOBILE =
            "com.samsung.feature.samsung_experience_mobile";
    public static final String SEM_FEATURE_SAMSUNG_EXPERIENCE_MOBILE_LITE =
    ...
    @SystemApi public static final int SYSTEM_APP_STATE_HIDDEN_UNTIL_INSTALLED_HIDDEN = 0;

    @SystemApi public static final int SYSTEM_APP_STATE_HIDDEN_UNTIL_INSTALLED_VISIBLE = 1;

    @SystemApi public static final int SYSTEM_APP_STATE_INSTALLED = 2;

    @SystemApi public static final int SYSTEM_APP_STATE_UNINSTALLED = 3;
    ...
    public abstract void addCrossProfileIntentFilter(
            IntentFilter intentFilter, int i, int i2, int i3);

    @SystemApi
    public abstract void addOnPermissionsChangeListener(
            OnPermissionsChangedListener onPermissionsChangedListener);
    ...
    public abstract void deleteApplicationCacheFilesAsUser(
            String str, int i, IPackageDataObserver iPackageDataObserver);

    public abstract void deletePackage(
            String str, IPackageDeleteObserver iPackageDeleteObserver, int i);
    ...
    public abstract void freeStorageAndNotify(
            String str, long j, IPackageDataObserver iPackageDataObserver);
    ...
    public abstract ApplicationInfo getApplicationInfoAsUser(String str, int i, int i2)
            throws NameNotFoundException;
    ...
    public abstract PackageInfo getPackageInfoAsUser(String str, int i, int i2)
            throws NameNotFoundException;

    public abstract PackageInstaller getPackageInstaller();

    @Deprecated
    public abstract void getPackageSizeInfoAsUser(
            String str, int i, IPackageStatsObserver iPackageStatsObserver);
    ...
    public abstract int getPreferredActivities(
            List<IntentFilter> list, List<ComponentName> list2, String str);
    ...
    public abstract Drawable getUserBadgedDrawableForDensity(
            Drawable drawable, UserHandle userHandle, Rect rect, int i);

    public abstract Drawable getUserBadgedIcon(Drawable drawable, UserHandle userHandle);

    public abstract CharSequence getUserBadgedLabel(
            CharSequence charSequence, UserHandle userHandle);
    ...
    @Deprecated
    public abstract int installExistingPackageAsUser(String str, int i)
            throws NameNotFoundException;
    ...
    public abstract Drawable loadItemIcon(
            PackageItemInfo packageItemInfo, ApplicationInfo applicationInfo);

    public abstract Drawable loadUnbadgedItemIcon(
            PackageItemInfo packageItemInfo, ApplicationInfo applicationInfo);
    ...
    @SystemApi
    public abstract void registerDexModule(
            String str, DexModuleRegisterCallback dexModuleRegisterCallback);
    ...
    public abstract boolean setApplicationHiddenSettingAsUser(
            String str, boolean z, UserHandle userHandle);
    ...
    public static final class Property implements Parcelable {
        public static final Parcelable.Creator<Property> CREATOR =
                new Parcelable.Creator<
                    ...
                    public Property createFromParcel(Parcel source) {
                        ...
                        if (type == 3) {
                            return new Property(
                                    name, source.readInt(), false, packageName, className);
                        }
                        if (type == 4) {
                            return new Property(
                                    name, source.readInt(), true, packageName, className);
                        }
                        if (type == 5) {
        ...
        public Property(
                String name, int value, boolean isResource, String packageName, String className) {
    ...
    public static final class ComponentEnabledSetting implements Parcelable {
        ...
        ComponentEnabledSetting(Parcel in) {
            ...
            AnnotationValidations.validate(
                    (Class<? extends Annotation>) EnabledState.class,
                    (Annotation) null,
                    this.mEnabledState);
            this.mEnabledFlags = enabledFlags;
            AnnotationValidations.validate(
                    (Class<? extends Annotation>) EnabledFlags.class,
                    (Annotation) null,
                    this.mEnabledFlags);
        }
    ...
    static {
        ...
        sApplicationInfoCache =
                new PropertyInvalidatedCache<ApplicationInfoQuery, ApplicationInfo>(
                        32,
                        str,
                        "getApplicationInfo") { // from class: android.content.pm.PackageManager.2
                    @Override // android.app.PropertyInvalidatedCache
                    public ApplicationInfo recompute(ApplicationInfoQuery query) {
                        return PackageManager.getApplicationInfoAsUserUncached(
        ...
        sPackageInfoCache =
                new PropertyInvalidatedCache<PackageInfoQuery, PackageInfo>(
                        64,
                        str,
                        "getPackageInfo") { // from class: android.content.pm.PackageManager.3
                    @Override // android.app.PropertyInvalidatedCache
                    public PackageInfo recompute(PackageInfoQuery query) {
                        return PackageManager.getPackageInfoAsUserUncached(
                                query.packageName, query.flags, query.userId);
                    }
    ...
    public IntentSender getLaunchIntentSenderForPackage(String packageName) {
        throw new UnsupportedOperationException(
                "getLaunchIntentSenderForPackage not implementedin subclass");
    }
    ...
    public ApplicationInfo getApplicationInfoAsUser(
            String packageName, ApplicationInfoFlags flags, int userId)
            throws NameNotFoundException {
        throw new UnsupportedOperationException(
    ...
    @SystemApi
    public ApplicationInfo getApplicationInfoAsUser(String packageName, int flags, UserHandle user)
            throws NameNotFoundException {
    ...
    @SystemApi
    public ApplicationInfo getApplicationInfoAsUser(
            String packageName, ApplicationInfoFlags flags, UserHandle user)
            throws NameNotFoundException {
        return getApplicationInfoAsUser(packageName, flags, user.getIdentifier());
    }
    ...
    public ActivityInfo getActivityInfo(ComponentName component, ComponentInfoFlags flags)
            throws NameNotFoundException {
        throw new UnsupportedOperationException("getActivityInfo not implemented in subclass");
    }

    public ActivityInfo getReceiverInfo(ComponentName component, ComponentInfoFlags flags)
            throws NameNotFoundException {
        throw new UnsupportedOperationException("getReceiverInfo not implemented in subclass");
    }

    public ServiceInfo getServiceInfo(ComponentName component, ComponentInfoFlags flags)
            throws NameNotFoundException {
        throw new UnsupportedOperationException("getServiceInfo not implemented in subclass");
    }

    public ProviderInfo getProviderInfo(ComponentName component, ComponentInfoFlags flags)
            throws NameNotFoundException {
    ...
    public List<PackageInfo> getPackagesHoldingPermissions(
            String[] permissions, PackageInfoFlags flags) {
        throw new UnsupportedOperationException(
    ...
    public boolean addWhitelistedRestrictedPermission(
            String packageName, String permName, int whitelistFlags) {
        return false;
    }
    ...
    public List<SharedLibraryInfo> getDeclaredSharedLibraries(
            String packageName, PackageInfoFlags flags) {
        throw new UnsupportedOperationException(
                "getDeclaredSharedLibraries() not implemented in subclass");
    }
    ...
    @SystemApi
    public List<ResolveInfo> queryIntentActivitiesAsUser(
            Intent intent, ResolveInfoFlags flags, UserHandle user) {
        return queryIntentActivitiesAsUser(intent, flags, user.getIdentifier());
    }

    public List<ResolveInfo> queryIntentActivityOptions(
            ComponentName caller, List<Intent> specifics, Intent intent, ResolveInfoFlags flags) {
        throw new UnsupportedOperationException(
    ...
    @SystemApi
    public List<ResolveInfo> queryBroadcastReceiversAsUser(
            Intent intent, ResolveInfoFlags flags, UserHandle userHandle) {
        return queryBroadcastReceiversAsUser(intent, flags, userHandle.getIdentifier());
    }
    ...
    public ProviderInfo resolveContentProviderAsUser(
            String providerName, ComponentInfoFlags flags, int userId) {
        throw new UnsupportedOperationException(
                "resolveContentProviderAsUser not implemented in subclass");
    }

    public List<ProviderInfo> queryContentProviders(
            String processName, int uid, ComponentInfoFlags flags) {
        throw new UnsupportedOperationException(
    ...
    public List<ProviderInfo> queryContentProviders(
            String processName, int uid, ComponentInfoFlags flags, String metaDataKey) {
        return queryContentProviders(processName, uid, flags);
    }
    ...
    public PackageInfo getPackageArchiveInfo(String archiveFilePath, PackageInfoFlags flags) {
        ...
        PackageParser2 parser2 =
                new PackageParser2(
                        null,
                        null,
                        null,
                        new PackageParser2
                                .Callback() { // from class: android.content.pm.PackageManager.1
    ...
    public void replacePreferredActivity(
            IntentFilter filter, int match, List<ComponentName> set, ComponentName activity) {
        replacePreferredActivity(
                filter, match, (ComponentName[]) set.toArray(new ComponentName[0]), activity);
    }
    ...
    public void setComponentEnabledSettings(List<ComponentEnabledSetting> settings) {
        throw new UnsupportedOperationException(
                "setComponentEnabledSettings not implementedin subclass");
    }
    ...
    public boolean applyRuntimePermissionsForMdm(
            String pkgName, List<String> permissions, int grant, int userId) {
        throw new UnsupportedOperationException(
                "applyRuntimePermissionsForMDM not implemented in subclass");
    }

    public boolean applyRuntimePermissionsForAllApplicationsForMdm(int grant, int userId) {
        throw new UnsupportedOperationException(
                "applyRuntimePermissionsForAllApplicationsForMDM not implemented in subclass");
    }

    public List<String> getRequestedRuntimePermissionsForMdm(String pkgName) {
        throw new UnsupportedOperationException(
                "getRequestedRuntimePermissionsForMDM not implemented in subclass");
    }
    ...
    public void requestChecksums(
            ...
            OnChecksumsReadyListener onChecksumsReadyListener)
    ...
    public boolean isDefaultApplicationIcon(Drawable drawable) {
        int resId =
                drawable instanceof AdaptiveIconDrawable
                        ? ((AdaptiveIconDrawable) drawable).getSourceDrawableResId()
                        : 0;
    ...
    public Property getPropertyAsUser(
    ...
    private static final class ApplicationInfoQuery {
        ...
        public String toString() {
            return String.format(
                    ...
                    this.packageName, Long.valueOf(this.flags), Integer.valueOf(this.userId));
        }

        public int hashCode() {
            int hash = Objects.hashCode(this.packageName);
            return (((hash * 13) + Objects.hashCode(Long.valueOf(this.flags))) * 13)
                    + Objects.hashCode(Integer.valueOf(this.userId));
        }
    ...
    public boolean isUnknownSourcePackage(String packageName) {
        throw new UnsupportedOperationException(
                "isUnknownSourcePackage not implemented in subclass");
    }

    public List<PackageInfo> getUnknownSourcePackages(int flags) {
        throw new UnsupportedOperationException(
                "getUnknownSourcePackagesAsUser not implemented in subclass");
    }
    ...
    public <T> T parseAndroidManifest(File apkFile, Function<XmlResourceParser, T> parserFunction)
            throws IOException {
        throw new UnsupportedOperationException("parseAndroidManifest not implemented in subclass");
    }

    public <T> T parseAndroidManifest(
            ParcelFileDescriptor apkFileDescriptor, Function<XmlResourceParser, T> parserFunction)
            throws IOException {
        throw new UnsupportedOperationException("parseAndroidManifest not implemented in subclass");
    }

    public TypedArray extractPackageItemInfoAttributes(
            PackageItemInfo info, String name, String rootTag, int[] attributes) {
    ...
    public boolean semIsPermissionRevokedByUserFixed(String permission, String packageName) {
        throw new UnsupportedOperationException(
                "semIsPermissionRevokedByUserFixed not implemented in subclass");
    }
    ...
    public boolean semCheckComponentMetadataForIconTray(String packageName, String componentName) {
        throw new UnsupportedOperationException(
                "semCheckComponentMetadataForIconTray not implemented in subclass");
    }

    public boolean semShouldPackIntoIconTray(String packageName) {
        throw new UnsupportedOperationException(
                "semShouldPackIntoIconTray not implemented in subclass");
    }
    ...
    public Drawable semGetDrawableForIconTray(Drawable icon, int mode) {
        throw new UnsupportedOperationException(
                "semGetDrawableForIconTray not implemented in subclass");
    }
    ...
    public void semFreeStorageAndNotify(
            long freeStorageSize, SemFreeStorageNotifyListener listener) {
    ...
    public void semUpdatePermissionFlags(
    ...
    public PackageInfo semGetPackageInfoAsUser(String packageName, int flags, int userId)
            throws NameNotFoundException {
        throw new UnsupportedOperationException(
                "semGetPackageInfoAsUser not implemented in subclass");
    }
    ...
    public Drawable getMonetizeBadgedIcon(Drawable icon) {
        throw new UnsupportedOperationException(
                "getMonetizeBadgedIcon not implemented in subclass");
    }

    public boolean shouldAppSupportBadgeIcon(String packageName, int userId) {
        throw new UnsupportedOperationException(
                "shouldAppSupportBadgeIcon not implemented in subclass");
    }

    public void setAppCategoryHintUser(String pkgName, int category) {
        throw new UnsupportedOperationException(
                "setAppCategoryHintUser not implemented in subclass");
    }
    ...
    public Map<String, String> getAppCategoryHintUserMap() {
        throw new UnsupportedOperationException(
                "getAppCategoryHintUserMap not implemented in subclass");
    }
