...
public final class SamsungThemeConstants {
    ...
    public static final String CURRENT_SEC_APPICON_THEME_PACKAGE =
            "current_sec_appicon_themepackage";
    ...
    public static final String PATH_OVERLAY_CURRENT_LOCALE_APKS =
    ...
    public static final String PATH_THEMEPARK_STATE_CHECK =
            "/data/overlays/themepark/state_applied.txt";
    public static final String PATH_THEME_PREFERENCES =
            "/data/overlays/preferences/samsung.andorid.themes.component_preference.xml";
    public static final String PENDING_MIGRATED_PACKAGES_UNINSTALL =
            "pending_migrated_packages_uninstall.txt";
    public static final String PERMISSION_OVERLAY_COMPONENT =
            "com.samsung.android.permission.SAMSUNG_OVERLAY_COMPONENT";
    public static final String PERMISSION_OVERLAY_LANGUAGE =
            "com.samsung.android.permission.SAMSUNG_OVERLAY_LANGUAGE";
    public static final String PERMISSION_OVERLAY_THEME =
            "com.samsung.android.permission.SAMSUNG_OVERLAY_THEME";
    public static final String PERMISSION_SAMSUNG_OVERLAY =
            "com.samsung.android.permission.SAMSUNG_OVERLAY_";
    ...
    public static final HashSet<String> changeableApps =
            new HashSet<>(
                    Arrays.asList(
                            SemDesktopModeManager.LAUNCHER_PACKAGE,
                            ...
                            "com.sec.unifiedwfc",
                            "com.samsung.advancedcalling",
                            SemPersonaManager.SECUREFOLDER_PACKAGE,
    ...
    public static HashMap<String, String> overlayTargetMap =
            new HashMap<
                    String, String>() { // from class: android.content.om.SamsungThemeConstants.1
                {
                    put("fwk", "android");
                    ...
                    put(
                            CoreSaConstant.PACKAGE_NAME_EDGE_SERVICE,
                            CoreSaConstant.PACKAGE_NAME_RECENTS);
                }
            };
    public static final String LEGACY_INCALLUI_PACKAGE_NAME = "com.android.incallui";
    public static ArrayList<String> immortalApps =
            new ArrayList<>(
                    Arrays.asList(
                            "android",
                            ...
                            AsPackageName.RINGTONE_PICKER,
                            LEGACY_INCALLUI_PACKAGE_NAME,
                            "com.android.phone",
                            AODManager.AOD_PACKAGE_NAME,
                            CoreSaConstant.PACKAGE_NAME_RECENTS,
    ...
    public static ArrayList<String> protectedApps =
            new ArrayList<>(
                    Arrays.asList(
                            THEMECENTER_PACKAGE_NAME, "com.samsung.android.localeoverlaymanager"));
    public static ArrayList<String> ignoreAppIconThemeHosts =
            new ArrayList<>(
                    Arrays.asList("com.nttdocomo.android.dhome", "com.nttdocomo.android.homezozo"));
    public static ArrayList<String> ignoreAppIconThemeList =
            new ArrayList<>(
                    Arrays.asList(
                            "SamsungElectronics.Tokyo2020.appicon",
                            "com.liquidanimation.DarkSideRC.appicon",
                            "D.OlympicGamesTokyo2020Theme.appicon"));
    public static ArrayList<String> nonAdaptiveIconPkgList =
            new ArrayList<>(
                    Arrays.asList(
                            "com.sec.android.app.camera",
                            SemPersonaManager.SECUREFOLDER_PACKAGE,
                            SemPersonaManager.APPSEPARATION_PACKAGE));
    public static final String THEME_OVERLAY_SAMSUNG_KEYBOARD_POSTFIX = ".honeyboard.apk";
    public static ArrayList<String> allowPostfixForCover =
            new ArrayList<>(Arrays.asList(THEME_OVERLAY_SAMSUNG_KEYBOARD_POSTFIX));
    ...
    public static ArrayList<String> allowSystemUIForCover =
            new ArrayList<>(
                    Arrays.asList(THEME_OVERLAY_SYSTEMUI_POSTFIX, THEME_OVERLAY_LOCK_POSTFIX));

    public static boolean localeDirsChanged(String[] overlayDir, String[] resDir) {
        Collection<? extends String> set1 =
                Arrays.asList(overlayDir == null ? new String[0] : overlayDir);
