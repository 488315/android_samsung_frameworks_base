...
public class WallpaperThemeUtils {
    ...
    public static boolean hasWallpaperThemeNotSupport(ApplicationInfo appInfo) {
        return (appInfo == null
                        ...
                        || !WallpaperThemeConstants.WALLPAPERTHEME_NOT_SUPPORT.equals(
                                appInfo.metaData.getString(WallpaperThemeConstants.THEMING_META)))
                ? false
                : true;
    }
    ...
    public static boolean hasWallpaperThemeMeta(ApplicationInfo appInfo) {
        return (appInfo == null
                        || appInfo.metaData == null
                        || !appInfo.metaData.containsKey(WallpaperThemeConstants.THEMING_META))
                ? false
                : true;
    }
    ...
    public static boolean hasWallpaperThemeTemplate(ApplicationInfo appInfo) {
        return (appInfo == null
                        || appInfo.metaData == null
                        || !appInfo.metaData.containsKey(WallpaperThemeConstants.THEMING_TEMPLATE))
                ? false
                : true;
    }
    ...
    public static boolean hasWallpaperThemeOverlays(Context context) {
        if (context == null
                ...
                || context.getApplicationInfo().overlayPaths == null) {
            return false;
        }
