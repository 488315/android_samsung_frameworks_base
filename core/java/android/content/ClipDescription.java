...
public class ClipDescription implements Parcelable {
  ...
  public static final Parcelable.Creator<ClipDescription> CREATOR =
      new Parcelable.Creator<ClipDescription>() { // from class: android.content.ClipDescription.1
  ...
  public static final String EXTRA_DRAG_SOURCE_TASK_ID =
      "com.samsung.android.content.clipdescription.extra.EXTRA_DRAG_SOURCE_TASK_ID";
  ...
  private Bundle confidencesToBundle() {
    ...
    for (int i = 0; i < size; i++) {
      bundle.putFloat(
          this.mEntityConfidence.keyAt(i), this.mEntityConfidence.valueAt(i).floatValue());
    }
    return bundle;
  }
  ...
  public ArrayList<String> semGetMimeTypes() {
    if (this.mMimeTypes == null) {
      Log.m102w("ClipDescription", "get mimetypes - null");
    }
