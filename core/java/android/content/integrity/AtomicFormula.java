...
public abstract class AtomicFormula extends IntegrityFormula {
  ...
  /* renamed from: EQ */
  public static final int f48EQ = 0;

  /* renamed from: GT */
  public static final int f49GT = 1;
  ...
  public static final class LongAtomicFormula extends AtomicFormula implements Parcelable {
    ...
    public String toString() {
      ...
      return String.format(
          "(%s %s %s)",
          keyToString(getKey()), operatorToString(this.mOperator.intValue()), this.mValue);
    }
  ...
  public static final class StringAtomicFormula extends AtomicFormula implements Parcelable {
    public static final Parcelable.Creator<StringAtomicFormula> CREATOR =
        new Parcelable.Creator<
            StringAtomicFormula>() { // from class:
    ...
    public StringAtomicFormula(int key, String value) {
      ...
      this.mIsHashedValue =
          Boolean.valueOf(key == 1 || key == 3 || key == 7 || key == 8 || !hashValue.equals(value));
    }
  ...
  public static final class BooleanAtomicFormula extends AtomicFormula implements Parcelable {
    public static final Parcelable.Creator<BooleanAtomicFormula> CREATOR =
        new Parcelable.Creator<
            BooleanAtomicFormula>() { // from class:
    ...
    public BooleanAtomicFormula(int key) {
      ...
      Preconditions.checkArgument(
          key == 5 || key == 6,
          String.format("Key %s cannot be used with BooleanAtomicFormula", keyToString(key)));
      this.mValue = null;
    }
    ...
    public boolean matches(AppInstallMetadata appInstallMetadata) {
      return this.mValue != null
          && getBooleanMetadataValue(appInstallMetadata, getKey()) == this.mValue.booleanValue();
    }
