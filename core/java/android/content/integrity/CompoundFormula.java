...
public final class CompoundFormula extends IntegrityFormula implements Parcelable {
    ...
    public CompoundFormula(int connector, List<IntegrityFormula> formulas) {
        Preconditions.checkArgument(
                isValidConnector(connector), "Unknown connector: %d", Integer.valueOf(connector));
    ...
    CompoundFormula(Parcel in) {
        ...
        Preconditions.checkArgument(
                length >= 0, "Must have non-negative length. Got %d", Integer.valueOf(length));
                        ...
                        .allMatch(
                                new Predicate() { // from class:
                                    ...
                                    public final boolean test(Object obj) {
                                        boolean matches;
                                        matches =
                                                ((IntegrityFormula) obj)
                                                        .matches(AppInstallMetadata.this);
                                        return matches;
                                    }
                                });
            case 1:
                        ...
                        new Predicate() { // from class:
                            ...
                            public final boolean test(Object obj) {
                                ...
                                isAppCertificateFormula =
                                        ((IntegrityFormula) obj).isAppCertificateFormula();
                ...
                .anyMatch(
                        new Predicate() { // from class:
                            ...
                            public final boolean test(Object obj) {
                                ...
                                isAppCertificateLineageFormula =
                                        ((IntegrityFormula) obj).isAppCertificateLineageFormula();
