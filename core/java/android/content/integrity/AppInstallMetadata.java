...
public final class AppInstallMetadata {
  ...
  public String toString() {
    ...
    return String.format(
        "AppInstallMetadata { PackageName = %s, AppCerts = %s, AppCertsLineage = %s, InstallerName"
            + " = %s, InstallerCerts = %s, VersionCode = %d, PreInstalled = %b, StampPresent = %b,"
            + " StampVerified = %b, StampTrusted = %b, StampCert = %s }",
        objArr);
  }
