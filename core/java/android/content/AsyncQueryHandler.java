      ...
      switch (event) {
        case 1:
          try {
            cursor =
                resolver.query(
                    args.uri, args.projection, args.selection, args.selectionArgs, args.orderBy);
            if (cursor != null) {
              cursor.getCount();
            }
          } catch (Exception e) {
            Log.m103w(AsyncQueryHandler.TAG, "Exception thrown during handling EVENT_ARG_QUERY", e);
            cursor = null;
          }
          args.result = cursor;
          break;
        ...
        case 3:
          args.result =
              Integer.valueOf(
                  resolver.update(args.uri, args.values, args.selection, args.selectionArgs));
          break;
        case 4:
          args.result =
              Integer.valueOf(resolver.delete(args.uri, args.selection, args.selectionArgs));
          break;
      }
