...
public final class Configuration implements Parcelable, Comparable<Configuration> {
  ...
  public static final Parcelable.Creator<Configuration> CREATOR =
      new Parcelable.Creator<Configuration>() { // from class: android.content.res.Configuration.1
  ...
  private void fixUpLocaleList() {
    ...
    if ((this.locale == null && !this.mLocaleList.isEmpty())
        || ((locale = this.locale) != null && !locale.equals(this.mLocaleList.get(0)))) {
      this.mLocaleList =
          this.locale == null ? LocaleList.getEmptyLocaleList() : new LocaleList(this.locale);
    }
  }
  ...
  public void dumpDebug(
      ProtoOutputStream protoOutputStream, long fieldId, boolean persisted, boolean critical) {
  ...
  */
        ...
        if (protoInputStream.nextField() == -1) {
          ...
          if (list.size() > 0) {
            configuration.setLocales(
                new LocaleList((Locale[]) list.toArray(new Locale[list.size()])));
          }
          ...
          switch (fieldNumber) {
                                ...
                                try {
                                  if (inListIndex == -1) {
                                    Slog.wtf(
                                        str3,
                                        str2
                                            + list.get(inListIndex)
                                            + ") found when trying to add: "
                                            + locale.toString());
                                  } else {
                                    list.add(locale);
                                  }
                                  ...
                                  Slog.m115e(
                                      str3,
                                      "readFromProto error building locale with: language-"
                                          + language
                                          + ";country-"
                                          + country
                                          + ";variant-"
                              ...
                              try {
                                ...
                                try {
                                  Slog.wtf(
                                      str5,
                                      append
                                          .append(list.get(inListIndex2))
                                          .append(") found when trying to add: ")
                                          .append(locale3.toString())
                                          .toString());
            ...
            case 9:
              configuration.keyboardHidden =
                  protoInputStream2.readInt(ConfigurationProto.KEYBOARD_HIDDEN);
              str = str8;
              token2 = token3;
              str8 = str;
              token3 = token2;
            case 10:
              configuration.hardKeyboardHidden =
                  protoInputStream2.readInt(ConfigurationProto.HARD_KEYBOARD_HIDDEN);
              str = str8;
              token2 = token3;
              str8 = str;
              token3 = token2;
            ...
            case 12:
              configuration.navigationHidden =
                  protoInputStream2.readInt(ConfigurationProto.NAVIGATION_HIDDEN);
              str = str8;
              token2 = token3;
              str8 = str;
              token3 = token2;
            ...
            case 15:
              configuration.screenWidthDp =
                  protoInputStream2.readInt(ConfigurationProto.SCREEN_WIDTH_DP);
              str = str8;
              token2 = token3;
              str8 = str;
              token3 = token2;
            case 16:
              configuration.screenHeightDp =
                  protoInputStream2.readInt(ConfigurationProto.SCREEN_HEIGHT_DP);
              str = str8;
              token2 = token3;
              str8 = str;
              token3 = token2;
            case 17:
              configuration.smallestScreenWidthDp =
                  protoInputStream2.readInt(ConfigurationProto.SMALLEST_SCREEN_WIDTH_DP);
              str = str8;
              token2 = token3;
              str8 = str;
              token3 = token2;
            ...
            case 20:
              ...
              try {
                try {
                  configuration.setLocales(
                      LocaleList.forLanguageTags(protoInputStream2.readString(1138166333460L)));
                  str = str8;
                  token2 = token7;
                } catch (Exception e13) {
                  Slog.m116e(TAG, "error parsing locale list in configuration.", e13);
                  str = str8;
                  token2 = token7;
                }
                str8 = str;
            ...
            case 21:
              configuration.fontWeightAdjustment =
                  protoInputStream2.readInt(ConfigurationProto.FONT_WEIGHT_ADJUSTMENT);
              str = str8;
              token2 = token3;
              str8 = str;
              token3 = token2;
            case 22:
              try {
                configuration.mGrammaticalGender =
                    protoInputStream2.readInt(ConfigurationProto.GRAMMATICAL_GENDER);
                str = str8;
                token2 = token3;
                str8 = str;
                token3 = token2;
  ...
  public int updateFrom(Configuration delta, boolean publicOnly) {
    ...
    if ((!CoreRune.MT_SUPPORT_COMPAT_SANDBOX || !publicOnly)
        && this.windowConfiguration.updateFrom(delta.windowConfiguration) != 0) {
      changed |= 536870912;
    }
  ...
  public int diff(Configuration delta, boolean compareUndefined, boolean publicOnly) {
    ...
    if ((compareUndefined || getScreenLayoutNoDirection(i) != 0)
    ...
    if (!publicOnly
        && this.windowConfiguration.diff(delta.windowConfiguration, compareUndefined) != 0) {
      changed |= 536870912;
    }
  ...
  public static boolean needNewResources(int configChanges, int interestingChanges) {
    return (configChanges
            & ((((Integer.MIN_VALUE | interestingChanges) | 1073741824) | 16777216) | 268435456))
        != 0;
  }
  ...
  public int hashCode() {
    ...
    return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((result * 31) + this.mcc) * 31)
                                                                        ...
                                                                        + this.boldFont)
                                                                    * 31)
                                                                + this.semButtonShapeEnabled)
                                                            * 31)
                                                        + Float.floatToIntBits(
                                                            this.semCursorThicknessScale))
                                                    * 31)
                                                + this.nightDim)
                                            * 31)
                                        + this.semDesktopModeEnabled)
                                    * 31)
                                + this.dexMode)
                            * 31)
  ...
  public static void readXmlAttrs(XmlPullParser parser, Configuration configOut)
    ...
    configOut.fontWeightAdjustment =
        XmlUtils.readIntAttribute(parser, XML_ATTR_FONT_WEIGHT_ADJUSTMENT, Integer.MAX_VALUE);
    configOut.mGrammaticalGender =
        XmlUtils.readIntAttribute(parser, XML_ATTR_GRAMMATICAL_GENDER, 0);
  }
