                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                ...
                                                                try {
                                                                    ...
                                                                    Slog.m115e(str3, "readFromProto error building locale with: language-" + language + ";country-" + country + ";variant-" + variant + ";script-" + script);
                                                                    throw wireTypeMismatchException;
                                                                }
                                                        ...
                                                        if (inListIndex2 != -1) {
                                                            ...
                                                            try {
                                                                ...
                                                                try {
                                                                    ...
                                                                    Slog.m115e(str5, "readFromProto error building locale with: language-" + language2 + ";country-" + country2 + ";variant-" + variant2 + ";script-" + script2);
                                                                    configuration = this;
                                                                    protoInputStream2 = protoInputStream;
                                                                    str7 = str4;
                                                                    str8 = str;
