...
public class ResourcesImpl {
    ...
    */
    ...
    Drawable loadDrawable(Resources wrapper, TypedValue value, int id, int density) throws Resources.NotFoundException {
        String name;
        boolean isColorDrawable;
        long key;
        Drawable.ConstantState cs;
    ...
    private boolean verifyPreloadConfig(int changingConfigurations, int allowVarying, int resourceId, String name) {
        ...
        if (((-1073745921) & changingConfigurations & (~allowVarying)) != 0) {
            ...
            Log.m102w(TAG, "Preloaded " + name + " resource #0x" + Integer.toHexString(resourceId) + " (" + resName + ") that varies with configuration!!");
            return false;
        }
        return true;
    }
