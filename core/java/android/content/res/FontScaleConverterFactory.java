...
public class FontScaleConverterFactory {
  ...
  static {
    ...
    put(
        ...
        new FontScaleConverter(
            new float[] {8.0f, 10.0f, 12.0f, 14.0f, 18.0f, 20.0f, 24.0f, 30.0f, 100.0f},
            new float[] {9.2f, 11.5f, 13.8f, 16.4f, 19.8f, 21.8f, 25.2f, 30.0f, 100.0f}));
    put(
        1.3f,
        new FontScaleConverter(
            new float[] {8.0f, 10.0f, 12.0f, 14.0f, 18.0f, 20.0f, 24.0f, 30.0f, 100.0f},
            new float[] {10.4f, 13.0f, 15.6f, 18.8f, 21.6f, 23.6f, 26.4f, 30.0f, 100.0f}));
    put(
        1.5f,
        new FontScaleConverter(
            new float[] {8.0f, 10.0f, 12.0f, 14.0f, 18.0f, 20.0f, 24.0f, 30.0f, 100.0f},
            new float[] {12.0f, 15.0f, 18.0f, 22.0f, 24.0f, 26.0f, 28.0f, 30.0f, 100.0f}));
    put(
        1.8f,
        new FontScaleConverter(
            new float[] {8.0f, 10.0f, 12.0f, 14.0f, 18.0f, 20.0f, 24.0f, 30.0f, 100.0f},
            new float[] {14.4f, 18.0f, 21.6f, 24.4f, 27.6f, 30.8f, 32.8f, 34.8f, 100.0f}));
    put(
        2.0f,
        new FontScaleConverter(
            new float[] {8.0f, 10.0f, 12.0f, 14.0f, 18.0f, 20.0f, 24.0f, 30.0f, 100.0f},
            new float[] {16.0f, 20.0f, 24.0f, 26.0f, 30.0f, 34.0f, 36.0f, 38.0f, 100.0f}));
  ...
  public static FontScaleConverter forScale(float fontScale) {
    ...
    return createInterpolatedTableBetween(
        sparseArray.valueAt(lowerIndex), sparseArray.valueAt(higherIndex), interpolationPoint);
  }
