...
public class ColorStateList extends ComplexColor implements Parcelable {
  ...
  public static final Parcelable.Creator<ColorStateList> CREATOR =
      new Parcelable.Creator<ColorStateList>() { // from class: android.content.res.ColorStateList.1
      ...
      if (type != i) {
        ...
        if (depth >= innerDepth2 || type != 3) {
          if (type != 2 || depth > innerDepth2) {
            ...
            TypedArray a =
                Resources.obtainAttributes(r, theme, attrs, C4337R.styleable.ColorStateListItem);
              ...
              if (stateResId != 16844359) {
                switch (stateResId) {
                  ...
                  default:
                    int j2 = j + 1;
                    stateSpec[j] =
                        attrs.getAttributeBooleanValue(i2, false) ? stateResId : -stateResId;
                    j = j2;
                    break;
                }
              }
            ...
            themeAttrsList =
                (int[][]) GrowingArrayUtils.append(themeAttrsList, listSize, themeAttrs);
  ...
  private void applyTheme(Resources.Theme t) {
    ...
    for (int i = 0; i < N; i++) {
      if (themeAttrsList[i] != null) {
        TypedArray a = t.resolveAttributes(themeAttrsList[i], C4337R.styleable.ColorStateListItem);
