...
public class ResourcesLoader {
  ...
  public List<ResourcesProvider> getProviders() {
    ...
    synchronized (this.mLock) {
      ...
      emptyList =
          resourcesProviderArr == null
              ? Collections.emptyList()
              : Arrays.asList(resourcesProviderArr);
    }
    return emptyList;
  }
  ...
  public void addProvider(ResourcesProvider resourcesProvider) {
    synchronized (this.mLock) {
      this.mProviders =
          (ResourcesProvider[])
              ArrayUtils.appendElement(ResourcesProvider.class, this.mProviders, resourcesProvider);
  ...
  public void removeProvider(ResourcesProvider resourcesProvider) {
    synchronized (this.mLock) {
      this.mProviders =
          (ResourcesProvider[])
              ArrayUtils.removeElement(ResourcesProvider.class, this.mProviders, resourcesProvider);
      notifyProvidersChangedLocked();
    }
  }
