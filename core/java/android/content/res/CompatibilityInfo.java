...
public class CompatibilityInfo implements Parcelable {
  ...
  public CompatibilityInfo(
      ApplicationInfo appInfo, int screenLayout, int sw, boolean forceCompat, float overrideScale) {
    int required;
  ...
  private static void scaleDisplayMetrics(
      float invertedRatio, DisplayMetrics inoutDm, boolean applyToSize) {
  ...
  public int hashCode() {
    ...
    return (((((result * 31) + this.applicationDensity) * 31)
                + Float.floatToIntBits(this.applicationScale))
            * 31)
        + Float.floatToIntBits(this.applicationInvertedScale);
  }
