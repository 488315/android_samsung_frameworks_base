...
public class GradientColor extends ComplexColor {
  ...
  public static GradientColor createFromXml(
      Resources r, XmlResourceParser parser, Resources.Theme theme)
  ...
  static GradientColor createFromXmlInner(
  ...
  private void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
      throws XmlPullParserException, IOException {
    TypedArray a = Resources.obtainAttributes(r, theme, attrs, C4337R.styleable.GradientColor);
  ...
  */
    ...
    while (true) {
      ...
      if (type != i && ((depth = parser.getDepth()) >= innerDepth2 || type != 3)) {
        if (type != 2) {
          ...
          TypedArray a =
              Resources.obtainAttributes(r, theme, attrs, C4337R.styleable.GradientColorItem);
  ...
  private void applyItemsAttrsTheme(Resources.Theme t) {
    ...
    for (int i = 0; i < N; i++) {
      if (themeAttrsList[i] != null) {
        TypedArray a = t.resolveAttributes(themeAttrsList[i], C4337R.styleable.GradientColorItem);
  ...
  private void onColorsChange() {
    ...
    if (tempColors.length < 2) {
      Log.m102w(
          TAG,
          "<gradient> tag requires 2 color values specified!"
              + tempColors.length
              + " "
  ...
  private void applyRootAttrsTheme(Resources.Theme t) {
    TypedArray a = t.resolveAttributes(this.mThemeAttrs, C4337R.styleable.GradientColor);
