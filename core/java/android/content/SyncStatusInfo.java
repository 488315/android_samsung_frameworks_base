...
public class SyncStatusInfo implements Parcelable {
  public static final Parcelable.Creator<SyncStatusInfo> CREATOR =
      new Parcelable.Creator<SyncStatusInfo>() { // from class: android.content.SyncStatusInfo.1
  ...
  public int getLastFailureMesgAsInt(int def) {
    ...
    Log.m94d(TAG, "Unknown lastFailureMesg:" + this.lastFailureMesg);
    return def;
  }
  ...
  public SyncStatusInfo(Parcel parcel) {
    ...
    if (version != 6 && version != 1) {
      Log.m102w("SyncStatusInfo", "Unknown version: " + version);
    }
    ...
    if (version < 4) {
      ...
      stats2.numSourcePeriodic =
          (((stats2.numSyncs - this.totalStats.numSourceLocal) - this.totalStats.numSourcePoll)
