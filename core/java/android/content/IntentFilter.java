...
public class IntentFilter implements Parcelable {
  ...
  public final boolean handlesWebUris(boolean onlyWebSchemes) {
    ...
    if (!hasAction("android.intent.action.VIEW")
        ...
        || (arrayList = this.mDataSchemes) == null
        || arrayList.size() == 0) {
      return false;
    }
  ...
  public final void addDataType(String type) throws MalformedMimeTypeException {
    processMimeType(
        type,
        new BiConsumer() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda0
  ...
  public final void addDynamicDataType(String type) throws MalformedMimeTypeException {
    processMimeType(
        type,
        new BiConsumer() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda1
          @Override // java.util.function.BiConsumer
          public final void accept(Object obj, Object obj2) {
  ...
  public final double getDoubleExtra(String name) {
    ...
    return persistableBundle == null
        ...
        : persistableBundle.getDouble(name);
  }
  ...
  public final boolean[] getBooleanArrayExtra(String name) {
    ...
    return persistableBundle == null
        ? EMPTY_BOOLEAN_ARRAY
        : persistableBundle.getBooleanArray(name);
  }
    ...
    return new Predicate() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda3
      ...
      public final boolean test(Object obj) {
        ...
        lambda$asPredicateWithTypeResolution$3 =
            IntentFilter.this.lambda$asPredicateWithTypeResolution$3(resolver, (Intent) obj);
  ...
  public final int match(
    ...
    return match(
        action, type, scheme, data, categories, logTag, supportWildcards, ignoreActions, null);
  }
        ...
        if (type != 3 || parser.getDepth() > outerDepth) {
          if (type != 3 && type != 4) {
            ...
            if (tagName.equals("action")) {
              ...
              Log.m102w(TAG, "Unknown tag parsing IntentFilter: " + tagName);
            }
