...
public class LoggingContentInterface implements ContentInterface {
  ...
  private class Logger implements AutoCloseable {
    ...
    /* renamed from: sb */
    private final StringBuilder f47sb = new StringBuilder();
    ...
    public Logger(String method, Object... args) {
      ...
      this.f47sb.append("callingUid=").append(Binder.getCallingUid()).append(' ');
      this.f47sb.append(method);
      this.f47sb.append('(').append(deepToString(args)).append(')');
    }
    ...
    public <T> T setResult(T res) {
      if (res instanceof Cursor) {
        this.f47sb.append('\n');
        DatabaseUtils.dumpCursor((Cursor) res, this.f47sb);
      } else {
        this.f47sb.append(" = ").append(deepToString(res));
      }
      return res;
    }
    ...
    public void close() {
      Log.m100v(LoggingContentInterface.this.tag, this.f47sb.toString());
    }
  }
  ...
  public Cursor query(
    ...
    try {
      try {
        Cursor cursor =
            (Cursor)
                l.setResult(this.delegate.query(uri, projection, queryArgs, cancellationSignal));
        l.close();
        return cursor;
      } catch (Exception res) {
        l.setResult(res);
    ...
    try {
      try {
        boolean booleanValue =
            ((Boolean)
                    l.setResult(
                        Boolean.valueOf(this.delegate.refresh(uri, args, cancellationSignal))))
                .booleanValue();
        l.close();
        return booleanValue;
      } catch (Exception res) {
  ...
  public int checkUriPermission(Uri uri, int uid, int modeFlags) throws RemoteException {
    Logger l =
        new Logger("checkUriPermission", uri, Integer.valueOf(uid), Integer.valueOf(modeFlags));
    try {
      try {
        int intValue =
            ((Integer)
                    l.setResult(
                        Integer.valueOf(this.delegate.checkUriPermission(uri, uid, modeFlags))))
                .intValue();
        l.close();
        return intValue;
      } catch (Exception res) {
  ...
  public int bulkInsert(Uri uri, ContentValues[] initialValues) throws RemoteException {
    ...
    try {
      try {
        int intValue =
            ((Integer) l.setResult(Integer.valueOf(this.delegate.bulkInsert(uri, initialValues))))
                .intValue();
        l.close();
        return intValue;
      } catch (Exception res) {
  ...
  public int delete(Uri uri, Bundle extras) throws RemoteException {
    ...
    try {
      try {
        int intValue =
            ((Integer) l.setResult(Integer.valueOf(this.delegate.delete(uri, extras)))).intValue();
        l.close();
        return intValue;
      } catch (Exception res) {
        l.setResult(res);
  ...
  public int update(Uri uri, ContentValues values, Bundle extras) throws RemoteException {
    ...
    try {
      try {
        int intValue =
            ((Integer) l.setResult(Integer.valueOf(this.delegate.update(uri, values, extras))))
                .intValue();
        l.close();
        return intValue;
      } catch (Exception res) {
    ...
    try {
      try {
        ParcelFileDescriptor parcelFileDescriptor =
            (ParcelFileDescriptor) l.setResult(this.delegate.openFile(uri, mode, signal));
        l.close();
    ...
    try {
      try {
        AssetFileDescriptor assetFileDescriptor =
            (AssetFileDescriptor) l.setResult(this.delegate.openAssetFile(uri, mode, signal));
        l.close();
  ...
  public AssetFileDescriptor openTypedAssetFile(
    ...
    try {
      try {
        AssetFileDescriptor assetFileDescriptor =
            (AssetFileDescriptor)
                l.setResult(this.delegate.openTypedAssetFile(uri, mimeTypeFilter, opts, signal));
        l.close();
        return assetFileDescriptor;
      } catch (Exception res) {
        l.setResult(res);
    ...
    try {
      try {
        ContentProviderResult[] contentProviderResultArr =
            (ContentProviderResult[]) l.setResult(this.delegate.applyBatch(authority, operations));
        l.close();
