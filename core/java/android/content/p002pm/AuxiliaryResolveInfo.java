...
public final class AuxiliaryResolveInfo {
  ...
  public AuxiliaryResolveInfo(
    ...
    this(
        failureActivity,
        null,
        Collections.singletonList(new AuxiliaryFilter(packageName, versionCode, splitName)));
  }
  ...
  public static final class AuxiliaryFilter extends IntentFilter {
    ...
    public AuxiliaryFilter(
        IntentFilter orig, InstantAppResolveInfo resolveInfo, String splitName, Bundle extras) {
      super(orig);
