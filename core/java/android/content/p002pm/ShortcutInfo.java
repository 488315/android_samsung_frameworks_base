...
public final class ShortcutInfo implements Parcelable {
  ...
  public static final Parcelable.Creator<ShortcutInfo> CREATOR =
      new Parcelable.Creator<ShortcutInfo>() { // from class: android.content.pm.ShortcutInfo.1
  ...
  public static String getDisabledReasonForRestoreIssue(Context context, int disabledReason) {
    ...
    switch (disabledReason) {
      case 3:
        return res.getString(C4337R.string.shortcut_disabled_reason_unknown);
      case 100:
        return res.getString(C4337R.string.shortcut_restored_on_lower_version);
      case 101:
        return res.getString(C4337R.string.shortcut_restore_not_supported);
      case 102:
        return res.getString(C4337R.string.shortcut_restore_signature_mismatch);
      case 103:
        return res.getString(C4337R.string.shortcut_restore_unknown_issue);
      default:
        return null;
    }
  }
  ...
  private ShortcutInfo(Builder b) {
    ...
    this.mId =
        getSafeId(
            (String) Preconditions.checkStringNotEmpty(b.mId, "Shortcut ID must be provided"));
  ...
  private CharSequence getResourceString(Resources res, int resId, CharSequence defValue) {
    try {
      ...
      Log.m96e(
          "Shortcut", "Resource for ID=" + resId + " not found in package " + this.mPackageName);
      return defValue;
    }
  }
    ...
    try {
      ...
      Log.m96e(
          ...
          "Resource name for ID="
              ...
              + packageName
              + ". Resource IDs may change when the application is upgraded, and the system may not"
              + " be able to find the correct resource.");
      return null;
    }
  }
  ...
  public static int lookUpResourceId(
    ...
    try {
      ...
      Log.m96e(
          "Shortcut",
          "Resource ID for name=" + resourceName + " not found in package " + packageName);
      return 0;
    }
  }
  ...
  public void lookupAndFillInResourceIds(Resources res) {
    ...
    this.mDisabledMessageResId =
        lookUpResourceId(res, this.mDisabledMessageResName, RES_TYPE_STRING, this.mPackageName);
  ...
  public static class Builder {
    ...
    public Builder setDisabledMessage(CharSequence disabledMessage) {
      ...
      this.mDisabledMessage =
          Preconditions.checkStringNotEmpty(disabledMessage, "disabledMessage cannot be empty");
      return this;
    }
  ...
  public UserHandle getUserHandle() {
    return UserHandle.m55of(this.mUserId);
  }
  ...
  public String toDumpString(String indent) {
    boolean isUserLow =
        Build.IS_USER && SystemProperties.get("ro.boot.debug_level", "0x4f4c").equals("0x4f4c");
