...
import android.content.p002pm.CapabilityParams;
...
public final class ShortcutInfo implements Parcelable {
    ...
    private CharSequence getResourceString(Resources res, int resId, CharSequence defValue) {
        try {
            ...
            Log.m96e("Shortcut", "Resource for ID=" + resId + " not found in package " + this.mPackageName);
            return defValue;
        }
    }
    ...
    public static String lookUpResourceName(Resources res, int resId, boolean withType, String packageName) {
        ...
        try {
            ...
            Log.m96e("Shortcut", "Resource name for ID=" + resId + " not found in package " + packageName + ". Resource IDs may change when the application is upgraded, and the system may not be able to find the correct resource.");
            return null;
        }
    }
    ...
    public static int lookUpResourceId(Resources res, String resourceName, String resourceType, String packageName) {
        try {
            ...
            Log.m96e("Shortcut", "Resource ID for name=" + resourceName + " not found in package " + packageName);
            return 0;
        }
    }
