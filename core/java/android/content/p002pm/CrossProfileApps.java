...
public class CrossProfileApps {
    ...
    private CharSequence getCallingApplicationLabel() {
        ...
        List<ResolveInfo> infos = pm.queryIntentActivities(launchIntent, PackageManager.ResolveInfoFlags.m12of(65536L));
        if (infos.size() > 0) {
    ...
    public String lambda$getProfileSwitchingLabel$0(boolean isManagedProfile, String label) {
        int stringRes = isManagedProfile ? C4337R.string.managed_profile_app_label : C4337R.string.user_owner_app_label;
