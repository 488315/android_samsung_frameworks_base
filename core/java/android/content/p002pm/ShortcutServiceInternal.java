...
public abstract class ShortcutServiceInternal {
  ...
  public abstract void cacheShortcuts(
      int i, String str, String str2, List<String> list, int i2, int i3);
  ...
  public abstract void createShortcutIntentsAsync(
      ...
      int i3,
      int i4,
      AndroidFuture<Intent[]> androidFuture);

  public abstract List<ShortcutManager.ShareShortcutInfo> getShareTargets(
      String str, IntentFilter intentFilter, int i);

  public abstract ParcelFileDescriptor getShortcutIconFd(
      int i, String str, String str2, String str3, int i2);

  public abstract void getShortcutIconFdAsync(
      int i,
      String str,
      String str2,
      String str3,
      int i2,
      AndroidFuture<ParcelFileDescriptor> androidFuture);
  ...
  public abstract void getShortcutIconUriAsync(
      int i, String str, String str2, String str3, int i2, AndroidFuture<String> androidFuture);

  public abstract String getShortcutStartingThemeResName(
      int i, String str, String str2, String str3, int i2);
  ...
  public abstract boolean isSharingShortcut(
  ...
  public abstract boolean requestPinAppWidget(
      String str,
  ...
  public abstract void uncacheShortcuts(
      int i, String str, String str2, List<String> list, int i2, int i3);
