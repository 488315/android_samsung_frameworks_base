...
import android.content.p002pm.dex.IArtManager;
...
public interface IPackageManager extends IInterface {
  ...
  void logAppProcessStartIfNeeded(String str, String str2, int i, String str3, String str4, int i2)
      throws RemoteException;
  ...
  void registerDexModule(
      String str, String str2, boolean z, IDexModuleRegisterCallback iDexModuleRegisterCallback)
      throws RemoteException;
  ...
  void setApplicationEnabledSettingWithList(
      List<String> list, int i, int i2, boolean z, boolean z2, int i3, String str)
      throws RemoteException;
  ...
  void setComponentEnabledSettings(
      List<PackageManager.ComponentEnabledSetting> list, int i, String str) throws RemoteException;
  ...
  public static class Default implements IPackageManager {
    @Override // android.content.p002pm.IPackageManager
    ...
    public ParceledListSlice queryContentProviders(
        String processName, int uid, long flags, String metaDataKey) throws RemoteException {
      return null;
    }
    ...
    @Override // android.content.p002pm.IPackageManager
    public ParceledListSlice queryInstrumentationAsUser(String targetPackage, int flags, int userId)
        throws RemoteException {
      return null;
    }
    ...
    public void setApplicationCategoryHint(
        String packageName, int categoryHint, String callerPackageName) throws RemoteException {}
    ...
    public void deletePackageVersioned(
        VersionedPackage versionedPackage, IPackageDeleteObserver2 observer, int userId, int flags)
        throws RemoteException {}
    ...
    public void setComponentEnabledSetting(
        ComponentName componentName, int newState, int flags, int userId, String callingPackage)
        throws RemoteException {}

    @Override // android.content.p002pm.IPackageManager
    public void setComponentEnabledSettings(
        List<PackageManager.ComponentEnabledSetting> settings, int userId, String callingPackage)
        throws RemoteException {}
    ...
    public void logAppProcessStartIfNeeded(
        String packageName, String processName, int uid, String seinfo, String apkFile, int pid)
        throws RemoteException {}
    ...
    public void freeStorageAndNotify(
        String volumeUuid, long freeStorageSize, int storageFlags, IPackageDataObserver observer)
        throws RemoteException {}
    ...
    public void deleteApplicationCacheFilesAsUser(
        String packageName, int userId, IPackageDataObserver observer) throws RemoteException {}

    @Override // android.content.p002pm.IPackageManager
    public void clearApplicationUserData(
        String packageName, IPackageDataObserver observer, int userId) throws RemoteException {}
    ...
    public void notifyDexLoad(
        String loadingPackageName, Map<String, String> classLoaderContextMap, String loaderIsa)
        throws RemoteException {}
    ...
    public boolean performDexOptSecondary(
        String packageName, String targetCompilerFilter, boolean force) throws RemoteException {
      return false;
    }
    ...
    public void extendVerificationTimeout(
        int id, int verificationCodeAtTimeout, long millisecondsToDelay) throws RemoteException {}
    ...
    public boolean[] canPackageQuery(
        String sourcePackageName, String[] targetPackageNames, int userId) throws RemoteException {
      return null;
    }
        ...
        default:
          switch (code) {
            ...
            case 66:
              ...
              data.enforceNoDataAvail();
              boolean _result48 =
                  removeCrossProfileIntentFilter(_arg064, _arg147, _arg236, _arg317, _arg47);
              reply.writeNoException();
            ...
            case 83:
              ...
              return true;
            case 84:
              List<PackageManager.ComponentEnabledSetting> _arg081 =
                  data.createTypedArrayList(PackageManager.ComponentEnabledSetting.CREATOR);
            ...
            case 108:
              ...
              data.enforceNoDataAvail();
              boolean _result66 =
                  performDexOptMode(_arg099, _arg177, _arg252, _arg326, _arg412, _arg56);
              reply.writeNoException();
            ...
            case 115:
              ...
              IMemorySaverPackageMoveObserver _arg254 =
                  IMemorySaverPackageMoveObserver.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
            ...
            case 119:
              ...
              data.enforceNoDataAvail();
              int _result75 =
                  installExistingPackageAsUser(_arg0109, _arg182, _arg255, _arg327, _arg413);
              reply.writeNoException();
            ...
            case 157:
              ...
              data.enforceNoDataAvail();
              ParceledListSlice _result108 =
                  getDeclaredSharedLibraries(_arg0138, _arg1106, _arg264);
              reply.writeNoException();
            ...
            case 185:
              ...
              requestPackageChecksums(
                  _arg0151, _arg1116, _arg268, _arg328, _arg414, _arg57, _arg63);
              reply.writeNoException();
              return true;
            case 186:
              ...
              data.enforceNoDataAvail();
              IntentSender _result131 =
                  getLaunchIntentSenderForPackage(_arg0152, _arg1117, _arg269, _arg329);
              reply.writeNoException();
            ...
            case 204:
              ...
              data.enforceNoDataAvail();
              PackageManager.Property _result142 =
                  getPropertyAsUser(_arg0169, _arg1130, _arg274, _arg330);
              reply.writeNoException();
            ...
            case 211:
              ...
              data.enforceNoDataAvail();
              boolean _result147 =
                  applyRuntimePermissionsForMDM(_arg0176, _arg1133, _arg275, _arg331);
              reply.writeNoException();
            ...
            case 212:
              ...
              data.enforceNoDataAvail();
              boolean _result148 =
                  applyRuntimePermissionsForAllApplicationsForMDM(_arg0177, _arg1134);
              reply.writeNoException();
            ...
            case 225:
              ...
              data.enforceNoDataAvail();
              setApplicationEnabledSettingWithList(
                  _arg0190, _arg1143, _arg279, _arg333, _arg415, _arg58, _arg64);
              reply.writeNoException();
              return true;
            case 226:
      ...
      public InstrumentationInfo getInstrumentationInfoAsUser(
        ...
        try {
          ...
          InstrumentationInfo _result =
              (InstrumentationInfo) _reply.readTypedObject(InstrumentationInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
            ...
            classLoaderContextMap.forEach(
                new BiConsumer() { // from class:
                  ...
                  public final void accept(Object obj, Object obj2) {
                    IPackageManager.Stub.Proxy.lambda$notifyDexLoad$0(
      ...
      public VerifierDeviceIdentity getVerifierDeviceIdentity() throws RemoteException {
        ...
        try {
          ...
          VerifierDeviceIdentity _result =
              (VerifierDeviceIdentity) _reply.readTypedObject(VerifierDeviceIdentity.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public PermissionGroupInfo getPermissionGroupInfo(String name, int flags)
        ...
        try {
          ...
          PermissionGroupInfo _result =
              (PermissionGroupInfo) _reply.readTypedObject(PermissionGroupInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public PackageManager.Property getPropertyAsUser(
        ...
        try {
          ...
          PackageManager.Property _result =
              (PackageManager.Property) _reply.readTypedObject(PackageManager.Property.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
