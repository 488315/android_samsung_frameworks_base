...
import android.content.p002pm.overlay.OverlayPaths;
import android.content.p002pm.parsing.result.ParseResult;
import android.content.p002pm.parsing.result.ParseTypeImpl;
import android.content.p002pm.permission.SplitPermissionInfoParcelable;
import android.content.p002pm.pkg.FrameworkPackageUserState;
...
public class PackageParser {
    ...
    private static PackageInfo generatePackageInfo(Package p, ApexInfo apexInfo, int[] gids, int flags, long firstInstallTime, long lastUpdateTime, Set<String> grantedPermissions, FrameworkPackageUserState state, int userId) {
        ...
        if ((134217728 & flags) != 0) {
            if (p.mSigningDetails != SigningDetails.UNKNOWN) {
                pi.signingInfo = new SigningInfo(new android.content.p002pm.SigningDetails(p.mSigningDetails.signatures, p.mSigningDetails.signatureSchemeVersion, p.mSigningDetails.publicKeys, p.mSigningDetails.pastSigningCertificates));
            } else {
                pi.signingInfo = null;
            }
        }
        ...
        while (true) {
            ...
            if (type != 3 && type != 4) {
                ...
                if (tagName.equals("application")) {
                    if (foundApp) {
                        Slog.m121w(TAG, "<manifest> has more than one <application>");
                    ...
                    Slog.m121w(TAG, "Unknown element under <manifest>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                    XmlUtils.skipCurrentTag(parser);
                }
            }
        }
    ...
    private static void collectCertificates(Package pkg, File apkFile, boolean skipVerify) throws PackageParserException {
        ParseResult<android.content.p002pm.SigningDetails> result;
        String apkPath = apkFile.getAbsolutePath();
        ...
        android.content.p002pm.SigningDetails verified = result.getResult();
        ...
        try {
            try {
                try {
                    ...
                    Slog.m122w(TAG, "Failed to parse " + apkPath, e);
    ...
    private static ApkLite parseApkLite(String codePath, XmlPullParser parser, AttributeSet attrs, SigningDetails signingDetails) throws IOException, XmlPullParserException, PackageParserException {
            ...
            if (type2 != 3 && type2 != 4 && parser.getDepth() == searchDepth) {
                if (TAG_PACKAGE_VERIFIER.equals(parser.getName())) {
                    ...
                    if (usesSplitName == null) {
                        ...
                        Slog.m121w(TAG, "Only one <uses-split> permitted. Ignoring others.");
                    }
        ...
        if (checkRequiredSystemProperties(requiredSystemPropertyName, requiredSystemPropertyValue)) {
            ...
            Slog.m117i(TAG, "Skipping target and overlay pair " + targetPackage2 + " and " + codePath + ": overlay ignored due to required system property: " + requiredSystemPropertyName + " with value: " + requiredSystemPropertyValue);
            targetPackage = null;
    ...
    private Package parseBaseApk(String apkPath, Resources res, XmlResourceParser parser, int flags, String[] outError) throws XmlPullParserException, IOException {
        try {
            ...
            TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifest);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x081f, code lost:
        ...
        com.samsung.android.core.p036pm.runtimemanifest.RuntimeManifestCoreOverlayUtils.applyRuntimeManifestIfNeeded(r36, r38);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0835, code lost:
        ...
        r1 = android.content.p002pm.PackageParser.NEW_PERMISSIONS.length;
        r2 = null;
        r0 = 0;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0841, code lost:
        ...
        r3 = android.content.p002pm.PackageParser.NEW_PERMISSIONS[r0];
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x088a, code lost:
        ...
        android.util.Slog.m117i(android.content.p002pm.PackageParser.TAG, r2.toString());
     */
    ...
    */
    private Package parseBaseApkCommon(Package pkg, Set<String> acceptedTags, Resources res, XmlResourceParser parser, int flags, String[] outError) throws XmlPullParserException, IOException {
        ...
        this.mParseInstrumentationArgs = null;
        TypedArray sa2 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifest);
        ...
        int resizeable5 = 1;
        int anyDensity2 = 1;
        int supportsLargeScreens5 = 0;
        int supportsXLargeScreens5 = 1;
        int supportsLargeScreens6 = 1;
            ...
            if (type4 != 3) {
                ...
                if (type4 == 4) {
                    ...
                    if (set == null || set.contains(tagName)) {
                        int supportsLargeScreens7 = supportsLargeScreens6;
                        int supportsNormalScreens6 = supportsNormalScreens5;
                        if (tagName.equals("application")) {
                            if (supportsLargeScreens5 != 0) {
                                Slog.m121w(TAG, "<manifest> has more than one <application>");
                                XmlUtils.skipCurrentTag(parser);
                                type2 = supportsSmallScreens2;
                                resizeable3 = resizeable5;
                                ...
                                supportsLargeScreens2 = supportsLargeScreens7;
                                ...
                                if (parseBaseApplication(pkg, res, parser, flags, outError)) {
                                    ...
                                    supportsLargeScreens5 = 1;
                                    supportsSmallScreens2 = type5;
                                    supportsLargeScreens6 = supportsLargeScreens7;
                                    supportsSmallScreens = anyDensity2;
                                    sa = null;
                                    anyDensity = 3;
                                    set = acceptedTags;
                            ...
                            if (tagName.equals("overlay")) {
                                TypedArray sa3 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestResourceOverlay);
                                ...
                                if (!checkRequiredSystemProperties(propName, propValue)) {
                                    Slog.m117i(TAG, "Skipping target and overlay pair " + pkg.mOverlayTarget + " and " + pkg.baseCodePath + ": overlay ignored due to required system property: " + propName + " with value: " + propValue);
                                ...
                                if (tagName.equals(TAG_KEY_SETS)) {
                                    ...
                                    sa = null;
                                    supportsLargeScreens4 = supportsLargeScreens7;
                                    resizeable3 = resizeable5;
                                    resizeable4 = anyDensity2;
                                    anyDensity = 3;
                                    ...
                                    if (tagName.equals(TAG_USES_PERMISSION_SDK_M)) {
                                        ...
                                        TypedArray sa4 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestUsesConfiguration);
                                        ...
                                        if (tagName.equals(TAG_USES_FEATURE)) {
                                            ...
                                            while (true) {
                                                ...
                                                if (type3 == 3 || type3 == 4) {
                                                    ...
                                                    if (innerTagName.equals(str3)) {
                                                        ...
                                                        str2 = str3;
                                                        innerDepth = innerDepth2;
                                                        Slog.m121w(TAG, "Unknown element under <feature-group>: " + innerTagName + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                                                    }
                                                    XmlUtils.skipCurrentTag(parser);
                                            ...
                                            int i = SDK_VERSION;
                                            if (i > 0) {
                                                TypedArray sa5 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestUsesSdk);
                                                int minVers = 1;
                                                String minCode = null;
                                                int targetVers = 0;
                                                ...
                                                int minSdkVersion = computeMinSdkVersion(minVers, minCode, i, strArr, outError);
                                                if (minSdkVersion < 0) {
                                                    this.mParseError = -12;
                                                    return null;
                                                }
                                            ...
                                            TypedArray sa6 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestSupportsScreens);
                                            ...
                                            int supportsLargeScreens8 = sa6.getInteger(3, supportsLargeScreens7);
                                            int supportsXLargeScreens7 = sa6.getInteger(5, supportsXLargeScreens4);
                                            int resizeable6 = sa6.getInteger(4, resizeable5);
                                            supportsSmallScreens = sa6.getInteger(0, anyDensity2);
                                            sa6.recycle();
                                            XmlUtils.skipCurrentTag(parser);
                                            ...
                                            supportsLargeScreens6 = supportsLargeScreens8;
                                        } else {
                                            resizeable3 = resizeable5;
                                            resizeable4 = anyDensity2;
                                            supportsXLargeScreens2 = supportsXLargeScreens4;
                                            ...
                                            if (tagName.equals(TAG_PROTECTED_BROADCAST)) {
                                                TypedArray sa7 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestProtectedBroadcast);
                                                ...
                                                TypedArray sa8 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestOriginalPackage);
                                                ...
                                                TypedArray sa9 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestOriginalPackage);
                                                ...
                                                if (tagName.equals(TAG_RESTRICT_UPDATE)) {
                                                    if ((flags & 16) != 0) {
                                                        TypedArray sa10 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestRestrictUpdate);
                                                        ...
                                                        if (hash != null) {
                                                            ...
                                                            for (int i2 = 0; i2 < hashLength; i2 += 2) {
                        ...
                        Slog.m121w(TAG, "Skipping unsupported element under <manifest>: " + tagName + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                        XmlUtils.skipCurrentTag(parser);
                        type2 = supportsSmallScreens2;
                        resizeable3 = resizeable5;
                        resizeable4 = anyDensity2;
    ...
    public static boolean checkRequiredSystemProperties(String rawPropNames, String rawPropValues) {
        if (TextUtils.isEmpty(rawPropNames) || TextUtils.isEmpty(rawPropValues)) {
            ...
            Slog.m121w(TAG, "Disabling overlay - incomplete property :'" + rawPropNames + "=" + rawPropValues + "' - require both requiredSystemPropertyName AND requiredSystemPropertyValue to be specified.");
            return false;
        }
        String[] propNames = rawPropNames.split(",");
        String[] propValues = rawPropValues.split(",");
        if (propNames.length != propValues.length) {
            Slog.m121w(TAG, "Disabling overlay - property :'" + rawPropNames + "=" + rawPropValues + "' - require both requiredSystemPropertyName AND requiredSystemPropertyValue lists to have the same size.");
            return false;
        }
    ...
    private FeatureInfo parseUsesFeature(Resources res, AttributeSet attrs) {
        ...
        TypedArray sa = res.obtainAttributes(attrs, C4337R.styleable.AndroidManifestUsesFeature);
    ...
    private boolean parseUsesStaticLibrary(Package pkg, Resources res, XmlResourceParser parser, String[] outError) throws XmlPullParserException, IOException {
        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestUsesStaticLibrary);
    ...
    */
        ...
        while (true) {
            ...
            if (type != 3 && type != 4) {
                ...
                if (nodeName.equals("additional-certificate")) {
                    TypedArray sa = resources.obtainAttributes(parser, C4337R.styleable.AndroidManifestAdditionalCertificate);
    ...
    private boolean parseUsesPermission(Package pkg, Resources res, XmlResourceParser parser) throws XmlPullParserException, IOException {
        Callback callback;
        Callback callback2;
        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestUsesPermission);
        ...
        if (index == -1) {
            ...
            Slog.m121w(TAG, "Ignoring duplicate uses-permissions/uses-permissions-sdk-m: " + name + " in package: " + pkg.packageName + " at: " + parser.getPositionDescription());
        }
        return true;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x02a9, code lost:
        ...
        android.util.Slog.m121w(android.content.p002pm.PackageParser.TAG, "Package" + r23.packageName + " AndroidManifext.xml 'key-set' " + r13 + " contained improper 'public-key' tags. Not including in package's defined key-sets.");
     */
    /* JADX WARN: Code restructure failed: missing block: B:36:0x027a, code lost:
    
        android.util.Slog.m121w(android.content.p002pm.PackageParser.TAG, "Package" + r23.packageName + " AndroidManifext.xml 'key-set' " + r13 + " has no valid associated 'public-key'. Not including in package's defined key-sets.");
     */
    ...
    */
            ...
            if (type != 1 && (type != 3 || parser.getDepth() > outerDepth2)) {
                if (type == 3) {
                    ...
                    if (tagName.equals("key-set")) {
                        ...
                        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestKeySet);
                        ...
                        if (tagName.equals("upgrade-key-set")) {
                            TypedArray sa2 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestUpgradeKeySet);
                            ...
                            Slog.m121w(TAG, "Unknown element under <key-sets>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                            XmlUtils.skipCurrentTag(parser);
                            outerDepth2 = outerDepth;
                            currentKeySetDepth2 = currentKeySetDepth;
                        }
                        ...
                        TypedArray sa3 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestPublicKey);
                        outerDepth = outerDepth2;
                        ...
                        if (encodedKey != null || publicKeys.get(publicKeyName) != null) {
                            ...
                            if (encodedKey != null) {
                                ...
                                if (currentKey == null) {
                                    Slog.m121w(TAG, "No recognized valid key in 'public-key' tag at " + parser.getPositionDescription() + " key-set " + currentKeySet + " will not be added to the package's defined key-sets.");
                                    sa3.recycle();
    ...
    private boolean parsePermissionGroup(Package owner, int flags, Resources res, XmlResourceParser parser, String[] outError) throws XmlPullParserException, IOException {
        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestPermissionGroup);
    ...
    */
    private boolean parsePermission(Package owner, Resources res, XmlResourceParser parser, String[] outError) throws XmlPullParserException, IOException {
        ...
        Permission perm;
        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestPermission);
        if (sa.hasValue(12)) {
            ...
            Slog.m121w(TAG, owner.packageName + " defines a background permission. Only the 'android' package can do that.");
        }
    ...
    private boolean parsePermissionTree(Package owner, Resources res, XmlResourceParser parser, String[] outError) throws XmlPullParserException, IOException {
        ...
        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestPermissionTree);
    ...
    private Instrumentation parseInstrumentation(Package owner, Resources res, XmlResourceParser parser, String[] outError) throws XmlPullParserException, IOException {
        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestInstrumentation);
        ...
        this.mParseInstrumentationArgs.f52sa = sa;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:187:0x07dd, code lost:
        ...
        java.util.Collections.sort(r14.activities, new android.content.p002pm.PackageParser$$ExternalSyntheticLambda0());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:189:0x07e9, code lost:
        ...
        java.util.Collections.sort(r14.receivers, new android.content.p002pm.PackageParser$$ExternalSyntheticLambda1());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:191:0x07f5, code lost:
        ...
        java.util.Collections.sort(r14.services, new android.content.p002pm.PackageParser$$ExternalSyntheticLambda2());
     */
    ...
    */
    private boolean parseBaseApplication(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError) throws XmlPullParserException, IOException {
        ...
        TypedArray sa = res.obtainAttributes(xmlResourceParser2, C4337R.styleable.AndroidManifestApplication);
        ...
        if (!parsePackageItemInfo(owner, ai2, outError, "<application>", sa, false, 3, 1, 2, 42, 22, 30)) {
            sa.recycle();
            packageParser3.mParseError = -108;
            return false;
        }
                ...
                if (tagName.equals("activity")) {
                    ...
                    if (tagName.equals("receiver")) {
                        ...
                        if (tagName.equals("service")) {
                            ...
                            hasServiceOrder |= z2;
                            str3 = pkgName2;
                        } else if (tagName.equals(RuntimeManifestUtils.TAG_PROVIDER)) {
                            ...
                            if (tagName.equals("static-library")) {
                                TypedArray sa2 = res.obtainAttributes(xmlResourceParser, C4337R.styleable.AndroidManifestStaticLibrary);
                                ...
                                if (lname != null && version >= 0) {
                                    ...
                                    if (r14.staticSharedLibName != null) {
                                ...
                                if (tagName.equals("library")) {
                                    TypedArray sa3 = res.obtainAttributes(xmlResourceParser, C4337R.styleable.AndroidManifestLibrary);
                                    ...
                                    if (tagName.equals("uses-library")) {
                                        TypedArray sa4 = res.obtainAttributes(xmlResourceParser, C4337R.styleable.AndroidManifestUsesLibrary);
                                        ...
                                        if (tagName.equals(TAG_PROFILEABLE)) {
                                            if (res.obtainAttributes(xmlResourceParser, C4337R.styleable.AndroidManifestProfileable).getBoolean(1, false)) {
                                                ai.privateFlags |= 8388608;
                                            }
                                            XmlUtils.skipCurrentTag(parser);
                                        } else {
                                            Slog.m121w(TAG, "Unknown element under <application>: " + tagName + " at " + packageParser2.mArchiveSourcePath + " " + parser.getPositionDescription());
                                            XmlUtils.skipCurrentTag(parser);
                                        }
                                    } else {
                                        XmlUtils.skipCurrentTag(parser);
    ...
    private boolean parseSplitApplication(android.content.pm.PackageParser.Package r24, android.content.res.Resources r25, android.content.res.XmlResourceParser r26, int r27, int r28, java.lang.String[] r29) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.content.p002pm.PackageParser.parseSplitApplication(android.content.pm.PackageParser$Package, android.content.res.Resources, android.content.res.XmlResourceParser, int, int, java.lang.String[]):boolean");
    }
    ...
    private Activity parseActivity(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError, CachedComponentArgs cachedArgs, boolean receiver, boolean hardwareAccelerated) throws XmlPullParserException, IOException {
        ...
        TypedArray sa = resources.obtainAttributes(parser, C4337R.styleable.AndroidManifestActivity);
        ...
        cachedArgs.mActivityArgs.f52sa = sa;
        ...
        if (parentName != null) {
            ...
            if (strArr[0] != null) {
                Log.m96e(TAG, "Activity " + a.info.name + " specified invalid parentActivityName " + parentName);
                i = 0;
                strArr[0] = null;
            } else {
                ...
                if (type == 3) {
                    ...
                    if (parser.getName().equals("intent-filter")) {
                        ...
                        if (intent3.countActions() == 0) {
                            Slog.m121w(TAG, "No actions in intent filter at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                            intent = intent3;
                        } else {
                        ...
                        if (!receiver && parser.getName().equals("preferred")) {
                            ...
                            if (intent4.countActions() == 0) {
                                Slog.m121w(TAG, "No actions in preferred at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                                intent2 = intent4;
                            } else {
                            ...
                            Slog.m121w(TAG, "Problem in package " + this.mArchiveSourcePath + ":");
                            if (receiver) {
                                Slog.m121w(TAG, "Unknown element under <receiver>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                            } else {
                                Slog.m121w(TAG, "Unknown element under <activity>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                            }
                            XmlUtils.skipCurrentTag(parser);
                            resources = res;
                            strArr = strArr3;
    ...
    private void parseLayout(Resources res, AttributeSet attrs, Activity a) {
        TypedArray sw = res.obtainAttributes(attrs, C4337R.styleable.AndroidManifestLayout);
        int width = -1;
    ...
    */
    private Activity parseActivityAlias(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError, CachedComponentArgs cachedArgs) throws XmlPullParserException, IOException {
        ...
        Resources resources = res;
        String[] strArr = outError;
        ?? obtainAttributes = resources.obtainAttributes(parser, C4337R.styleable.AndroidManifestActivityAlias);
        String targetActivity = obtainAttributes.getNonConfigurationString(7, 1024);
        ...
        cachedArgs.mActivityAliasArgs.f52sa = obtainAttributes;
        ...
        while (true) {
            ...
            Activity t = owner.activities.get(i2);
        ...
        info.transientBarShowingDelayMillis = target.info.transientBarShowingDelayMillis;
        Activity a = new Activity(cachedArgs.mActivityAliasArgs, info);
        if (strArr[r4] != null) {
            obtainAttributes.recycle();
            return null;
        }
        boolean setExported = obtainAttributes.hasValue(5);
        if (setExported) {
            a.info.exported = obtainAttributes.getBoolean(5, r4);
        }
        String str2 = obtainAttributes.getNonConfigurationString(3, r4);
        if (str2 != null) {
            a.info.permission = str2.length() > 0 ? str2.toString().intern() : null;
        }
        String parentName = obtainAttributes.getNonConfigurationString(9, 1024);
        String str3 = TAG;
        if (parentName != null) {
            String parentClassName = buildClassName(a.info.packageName, parentName, strArr);
            if (strArr[0] != null) {
                Log.m96e(TAG, "Activity alias " + a.info.name + " specified invalid parentActivityName " + parentName);
                strArr[0] = null;
            } else {
                a.info.parentActivityName = parentClassName;
            }
        ...
        int outerDepth = parser.getDepth();
        while (true) {
            TypedArray sa = obtainAttributes;
            int type = parser.next();
            if (type == i3) {
                i = i3;
                break;
            ...
            if (type == 3) {
                ...
                if (intent2.countActions() == 0) {
                    str = str4;
                    Slog.m121w(str, "No actions in intent filter at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                    intent = intent2;
                } else {
                    str = str4;
                ...
                if (parser.getName().equals("meta-data")) {
                    ...
                    Slog.m121w(str4, "Unknown element under <activity-alias>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                    XmlUtils.skipCurrentTag(parser);
                    str3 = str4;
                    resources = res;
                    strArr = strArr3;
    ...
    private Provider parseProvider(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError, CachedComponentArgs cachedArgs) throws XmlPullParserException, IOException {
        ...
        String str;
        TypedArray sa2 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestProvider);
        ...
        TypedArray sa3 = sa;
        cachedArgs.mProviderArgs.f52sa = sa3;
                ...
                if (type != 3 || parser.getDepth() > outerDepth) {
                    if (type != 3 && type != 4) {
                        if (parser.getName().equals("intent-filter")) {
                            ...
                            TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestGrantUriPermission);
                            ...
                            if (pa4 != null) {
                                ...
                                Slog.m121w(TAG, "Unknown element under <path-permission>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                                XmlUtils.skipCurrentTag(parser);
                            }
                        } else if (parser.getName().equals("path-permission")) {
                            TypedArray sa2 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestPathPermission);
                            ...
                            if (!havePerm) {
                                Slog.m121w(TAG, "No readPermission or writePermssion for <path-permission>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                                XmlUtils.skipCurrentTag(parser);
                            } else {
                                ...
                                if (pa3 != null) {
                                    ...
                                    Slog.m121w(TAG, "No path, pathPrefix, or pathPattern for <path-permission>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                                    XmlUtils.skipCurrentTag(parser);
                                }
                            }
                        } else {
                            Slog.m121w(TAG, "Unknown element under <provider>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                            XmlUtils.skipCurrentTag(parser);
                        }
                    }
                } else {
    ...
    */
    private Service parseService(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError, CachedComponentArgs cachedArgs) throws XmlPullParserException, IOException {
        ...
        String[] strArr = outError;
        TypedArray sa = resources.obtainAttributes(xmlResourceParser, C4337R.styleable.AndroidManifestService);
        ...
        cachedArgs.mServiceArgs.f52sa = sa;
        ...
        while (true) {
            ...
            if (type2 == 3) {
                ...
                if (parser.getName().equals("meta-data")) {
                    ...
                    Slog.m121w(TAG, "Unknown element under <service>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                    XmlUtils.skipCurrentTag(parser);
                    resources = res;
                    strArr = strArr3;
                    xmlResourceParser = xmlResourceParser3;
        ...
        while (true) {
            ...
            if (type != 3 && type != 4) {
                if (parser.getName().equals("meta-data")) {
                    ...
                    Slog.m121w(TAG, "Unknown element under " + tag + ": " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                    XmlUtils.skipCurrentTag(parser);
                }
            }
        }
    ...
    private Bundle parseMetaData(Resources res, XmlResourceParser parser, Bundle data, String[] outError) throws XmlPullParserException, IOException {
        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestMetaData);
        if (data == null) {
            data = new Bundle();
        }
        boolean z = false;
        ...
        if (v != null && v.resourceId != 0) {
            ...
            if (v2 == null) {
                ...
                Slog.m121w(TAG, "<meta-data> only supports string, integer, float, color, boolean, and resource reference types: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
            }
        }
        sa.recycle();
        XmlUtils.skipCurrentTag(parser);
    ...
    private static VerifierInfo parseVerifier(AttributeSet attrs) {
        ...
        if (packageName == null || packageName.length() == 0) {
            Slog.m117i(TAG, "verifier package name was null; skipping");
            return null;
        }
        PublicKey publicKey = parsePublicKey(encodedPublicKey);
        if (publicKey == null) {
            Slog.m117i(TAG, "Unable to parse verifier public key for " + packageName);
            return null;
        }
    ...
    public static final PublicKey parsePublicKey(String encodedPublicKey) {
        if (encodedPublicKey == null) {
            Slog.m121w(TAG, "Could not parse null public key");
            return null;
        }
        try {
            return parsePublicKey(Base64.decode(encodedPublicKey, 0));
        } catch (IllegalArgumentException e) {
            Slog.m121w(TAG, "Could not parse verifier public key; invalid Base64");
            return null;
        }
    }
    ...
    */
    private boolean parseIntent(Resources res, XmlResourceParser parser, boolean allowGlobs, boolean allowAutoVerify, IntentInfo outInfo, String[] outError) throws XmlPullParserException, IOException {
        int i;
        int i2;
        TypedArray sa = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestIntentFilter);
            ...
            if (type != i5 && (type != i3 || parser.getDepth() > outerDepth)) {
                if (type == i3 || type == i6) {
                    ...
                    if (nodeName.equals("action")) {
                        ...
                        TypedArray sa2 = res.obtainAttributes(parser, C4337R.styleable.AndroidManifestData);
                        ...
                        i = 3;
                        Slog.m121w(TAG, "Unknown element under <intent-filter>: " + parser.getName() + " at " + this.mArchiveSourcePath + " " + parser.getPositionDescription());
                        XmlUtils.skipCurrentTag(parser);
                    }
                    i3 = i;
                    i5 = 1;
        ...
        */
        private SigningDetails mergeLineageWithAncestorOrSelf(SigningDetails otherSigningDetails) {
            ...
            try {
                ...
                Slog.m116e(PackageParser.TAG, "Caught an exception creating the merged lineage: ", e);
                return this;
            }
        }
        ...
        public boolean checkCapability(SigningDetails oldDetails, int flags) {
            ...
            if (signatureArr.length == 0) {
                Slog.m115e(PackageParser.TAG, "There isn't any certificates in this package");
                return false;
            }
            if (signatureArr.length > 1) {
                return signaturesMatchExactly(oldDetails);
    ...
    public static abstract class Component<II extends IntentInfo> {
        ...
        public Component(ParsePackageItemArgs args, PackageItemInfo outInfo) {
            ...
            if (PackageParser.parsePackageItemInfo(args.owner, outInfo, args.outError, args.tag, args.f52sa, true, args.nameRes, args.labelRes, args.iconRes, args.roundIconRes, args.logoRes, args.bannerRes)) {
        ...
        public Component(ParseComponentArgs args, ComponentInfo outInfo) {
            ...
            if (args.processRes != 0) {
                if (this.owner.applicationInfo.targetSdkVersion >= 8) {
                    pname = args.f52sa.getNonConfigurationString(args.processRes, 1024);
                } else {
                    pname = args.f52sa.getNonResourceString(args.processRes);
                }
            ...
            if (args.descriptionRes != 0) {
                outInfo.descriptionRes = args.f52sa.getResourceId(args.descriptionRes, 0);
            }
            outInfo.enabled = args.f52sa.getBoolean(args.enabledRes, true);
        }
        ...
        private static <T extends IntentInfo> ArrayList<T> createIntentsList(Parcel parcel) {
            ...
            try {
                ...
                MediaController.C52592 c52592 = (ArrayList<T>) new ArrayList(readInt);
                for (int i = 0; i < readInt; i++) {
                    c52592.add((IntentInfo) constructor.newInstance(parcel));
                }
                return c52592;
    ...
    public static final class Permission extends Component<IntentInfo> implements Parcelable {
        ...
        @Override // android.content.pm.PackageParser.Component, android.p009os.Parcelable
        public void writeToParcel(Parcel parcel, int i) {
    ...
    public static void readConfigUseRoundIcon(Resources r) {
        if (r != null) {
            sUseRoundIcon = r.getBoolean(C4337R.bool.config_useRoundIcon);
            return;
        }
        try {
            ...
            sUseRoundIcon = overlayableRes.getBoolean(C4337R.bool.config_useRoundIcon);
