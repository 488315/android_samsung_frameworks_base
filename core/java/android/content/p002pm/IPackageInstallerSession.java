...
public interface IPackageInstallerSession extends IInterface {
  ...
  void requestChecksums(
      String str, int i, int i2, List list, IOnChecksumsReadyListener iOnChecksumsReadyListener)
  ...
  public static class Default implements IPackageInstallerSession {
    @Override // android.content.p002pm.IPackageInstallerSession
            ...
            case 27:
              PackageInstaller.PreapprovalDetails _arg016 =
                  (PackageInstaller.PreapprovalDetails)
                      data.readTypedObject(PackageInstaller.PreapprovalDetails.CREATOR);
      ...
      public DataLoaderParamsParcel getDataLoaderParams() throws RemoteException {
        ...
        try {
          ...
          DataLoaderParamsParcel _result =
              (DataLoaderParamsParcel) _reply.readTypedObject(DataLoaderParamsParcel.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
