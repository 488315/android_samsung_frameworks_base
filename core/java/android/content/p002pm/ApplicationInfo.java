...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
  ...
  private static Parcelling.BuiltIn.ForBoolean sForBoolean =
  ...
  public static final Parcelable.Creator<ApplicationInfo> CREATOR = new C06471();
  ...
  public static CharSequence getCategoryTitle(Context context, int category) {
    switch (category) {
      case 0:
        return context.getText(C4337R.string.app_category_game);
      case 1:
        return context.getText(C4337R.string.app_category_audio);
      case 2:
        return context.getText(C4337R.string.app_category_video);
      case 3:
        return context.getText(C4337R.string.app_category_image);
      case 4:
        return context.getText(C4337R.string.app_category_social);
      case 5:
        return context.getText(C4337R.string.app_category_news);
      case 6:
        return context.getText(C4337R.string.app_category_maps);
      case 7:
        return context.getText(C4337R.string.app_category_productivity);
      case 8:
        return context.getText(C4337R.string.app_category_accessibility);
      default:
        return null;
    }
  }
  ...
  public void dump(Printer pw, String prefix, int dumpFlags) {
    ...
    if ((dumpFlags & 1) != 0) {
      ...
      pw.println(
          prefix + "allowsPlaybackCapture=" + (isAudioPlaybackCaptureAllowed() ? "true" : "false"));
      ...
      if (this.requestRawExternalStorageAccess != null) {
        pw.println(
            prefix + "requestRawExternalStorageAccess=" + this.requestRawExternalStorageAccess);
      }
  ...
  @Override // android.content.p002pm.PackageItemInfo
  ...
  @Override // android.content.p002pm.PackageItemInfo, android.p009os.Parcelable
  ...
  class C06471 implements Parcelable.Creator<ApplicationInfo> {
    /* renamed from: $r8$lambda$PfZYudEWwKf_A2QDLQ4dHD9-bOs, reason: not valid java name */
    public static /* synthetic */ ApplicationInfo m1337$r8$lambda$PfZYudEWwKf_A2QDLQ4dHD9bOs(
        Parcel parcel) {
          ...
          source.readSquashed(
              new Parcel
                ...
                public final Object readRawParceled(Parcel parcel) {
                  return ApplicationInfo.C06471.m1337$r8$lambda$PfZYudEWwKf_A2QDLQ4dHD9bOs(parcel);
                }
              });
    }
  ...
  public Drawable loadDefaultIcon(PackageManager pm) {
    if ((this.flags & 262144) != 0 && isPackageUnavailable(pm)) {
      return Resources.getSystem().getDrawable(C4337R.drawable.sym_app_on_sd_unavailable_icon);
    }
