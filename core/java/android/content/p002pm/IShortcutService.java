...
import com.android.internal.p029os.IParcelFileDescriptorFactory;
...
public interface IShortcutService extends IInterface {
  ...
  void restoreBitmapsFromBackupService(
      ParcelFileDescriptor parcelFileDescriptor, String str, String str2) throws RemoteException;
  ...
  public static class Default implements IShortcutService {
    @Override // android.content.p002pm.IShortcutService
    public boolean setDynamicShortcuts(
        String packageName, ParceledListSlice shortcutInfoList, int userId) throws RemoteException {
      return false;
    }
    ...
    @Override // android.content.p002pm.IShortcutService
    public ParceledListSlice getShareTargets(String packageName, IntentFilter filter, int userId)
        throws RemoteException {
      return null;
    }
    ...
    @Override // android.content.p002pm.IShortcutService
    public void removeLongLivedShortcuts(String packageName, List<String> shortcutIds, int userId)
        throws RemoteException {}
      ...
      public IParcelFileDescriptorFactory getShortcutBitmapsFileDescriptor()
        ...
        try {
          ...
          IParcelFileDescriptorFactory _result =
              IParcelFileDescriptorFactory.Stub.asInterface(_reply.readStrongBinder());
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
