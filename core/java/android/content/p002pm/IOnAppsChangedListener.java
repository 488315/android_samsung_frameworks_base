...
public interface IOnAppsChangedListener extends IInterface {
  ...
  public static class Default implements IOnAppsChangedListener {
    ...
    @Override // android.content.p002pm.IOnAppsChangedListener
    public void onPackagesSuspended(UserHandle user, String[] packageNames, Bundle launcherExtras)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IOnAppsChangedListener {
    ...
    private static class Proxy implements IOnAppsChangedListener {
      ...
      public void onShortcutChanged(
          UserHandle user, String packageName, ParceledListSlice shortcuts) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
          _data.writeTypedObject(user, 0);
