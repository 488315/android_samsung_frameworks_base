package android.content.p002pm.parsing;

import android.Manifest;
import android.app.admin.DeviceAdminReceiver;
import android.content.p002pm.SigningDetails;
import android.content.p002pm.VerifierInfo;
...
public class ApkLiteParseUtils {
  ...
  public static ParseResult<PackageLite> composePackageLiteFromApks(
      ParseInput input, File packageDir, ApkLite baseApk, ArrayMap<String, ApkLite> splitApks) {
  ...
  private static ParseResult<ApkLite> parseApkLiteInner(
    ...
    try {
      try {
            ...
            try {
              try {
                ...
                ParseResult<ApkLite> parseApkLite =
                    parseApkLite(input, apkPath, parser2, signingDetails, flags);
                IoUtils.closeQuietly(parser2);
                if (apkAssets2 != null) {
                  try {
                    apkAssets2.close();
              ...
              parser = parser2;
              Exception e3 = e;
              Slog.m122w(TAG, "Failed to parse " + apkPath, e3);
        ...
        Slog.m122w(TAG, "Failed to parse " + apkPath, e5);
        ParseResult<ApkLite> error3 = input.error(-100, "Failed to parse " + apkPath, e5);
  ...
  */
  /* JADX WARN: Code restructure failed: missing block: B:22:0x0361, code lost:
     ...
     if (android.content.p002pm.parsing.FrameworkParsingPackageUtils.checkRequiredSystemProperties(r14, r11) != false) goto L116;
  */
  /* JADX WARN: Code restructure failed: missing block: B:23:0x0363, code lost:
     ...
     android.util.Slog.m117i(android.content.p002pm.parsing.ApkLiteParseUtils.TAG, r0);
  */
  ...
  */
  /* JADX WARN: Code restructure failed: missing block: B:27:0x0405, code lost:
     ...
     return r71.success(new android.content.p002pm.parsing.ApkLite(r72, r12, r6, r49, r51, r62, r50, r44, r45, r46, r8, r21, r74, r47, r56, r57, r58, r59, r61, r60, r48, r15, r63, r64, r14, r11, r55, r54, r65, r7.first, r7.second, r66, r67));
  */
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  private static ParseResult<ApkLite> parseApkLite(
      ParseInput input,
      String codePath,
    ...
    ParseResult<Pair<Set<String>, Set<String>>> requiredSplitTypesResult3 =
        parseRequiredSplitTypes(input, xmlResourceParser);
    ...
    int installLocation =
        xmlResourceParser.getAttributeIntValue(
            "http://schemas.android.com/apk/res/android", "installLocation", -1);
    int versionCode =
        xmlResourceParser.getAttributeIntValue(
            "http://schemas.android.com/apk/res/android", IafdConstant.KEY_VERSION_CODE, 0);
    int versionCodeMajor =
        xmlResourceParser.getAttributeIntValue(
            "http://schemas.android.com/apk/res/android", "versionCodeMajor", 0);
    int revisionCode =
        xmlResourceParser.getAttributeIntValue(
            "http://schemas.android.com/apk/res/android", "revisionCode", 0);
    ...
    boolean isolatedSplits =
        xmlResourceParser.getAttributeBooleanValue(
            "http://schemas.android.com/apk/res/android", "isolatedSplits", false);
    boolean isFeatureSplit =
        xmlResourceParser.getAttributeBooleanValue(
            "http://schemas.android.com/apk/res/android", "isFeatureSplit", false);
    boolean isSplitRequired =
        xmlResourceParser.getAttributeBooleanValue(
            "http://schemas.android.com/apk/res/android", "isSplitRequired", false);
    ...
    while (true) {
      ...
      if (type == 3 && parser.getDepth() < searchDepth2) {
        verifiers = verifiers5;
        break;
      }
      if (type == 3) {
        ...
        if ("application".equals(parser.getName())) {
          ...
          extractNativeLibs =
              xmlResourceParser.getAttributeBooleanValue(str2, "extractNativeLibs", true);
          useEmbeddedDex =
              xmlResourceParser.getAttributeBooleanValue(str2, "useEmbeddedDex", false);
          rollbackDataPolicy =
              xmlResourceParser.getAttributeIntValue(str2, "rollbackDataPolicy", 0);
          ...
          while (true) {
            ...
            if (innerType != 3 && innerType != 4 && parser.getDepth() == innerDepth + 1) {
              if ("profileable".equals(parser.getName())) {
                profilableByShell2 =
                    xmlResourceParser.getAttributeBooleanValue(str2, "shell", profilableByShell2);
                ...
                hasDeviceAdminReceiver |=
                    isDeviceAdminReceiver(xmlResourceParser, hasBindDeviceAdminPermission);
                verifiers6 = verifiers4;
                requiredSplitTypesResult3 = requiredSplitTypesResult2;
          ...
          if ("overlay".equals(parser.getName())) {
            requiredSystemPropertyName =
                xmlResourceParser.getAttributeValue(str2, "requiredSystemPropertyName");
            requiredSystemPropertyValue =
                xmlResourceParser.getAttributeValue(str2, "requiredSystemPropertyValue");
            ...
            String targetSdkVersionString =
                xmlResourceParser.getAttributeValue(str2, "targetSdkVersion");
            int minVer = 1;
  ...
  private static boolean isDeviceAdminReceiver(
    ...
    String permission =
        parser.getAttributeValue("http://schemas.android.com/apk/res/android", "permission");
  ...
  public static ParseResult<Pair<String, String>> parsePackageSplitNames(
    ...
    return input.success(
        Pair.create(packageName.intern(), splitName != null ? splitName.intern() : splitName));
  }
  ...
  public static ParseResult<Pair<Set<String>, Set<String>>> parseRequiredSplitTypes(
    ...
    String value2 =
        parser.getAttributeValue("http://schemas.android.com/apk/res/android", "splitTypes");
  ...
  private static ParseResult<Set<String>> separateAndValidateSplitTypes(
    ...
    for (String value : values.trim().split(",")) {
      ...
      if (!arraySet.add(type)) {
        Slog.m121w(TAG, type + " was defined multiple times");
      }
    }
