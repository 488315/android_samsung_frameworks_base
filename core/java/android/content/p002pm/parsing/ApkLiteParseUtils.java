...
public class ApkLiteParseUtils {
    ...
    */
    private static ParseResult<ApkLite> parseApkLite(ParseInput input, String codePath, XmlResourceParser parser, SigningDetails signingDetails, int flags) throws IOException, XmlPullParserException {
        ...
        int versionCode = xmlResourceParser.getAttributeIntValue("http://schemas.android.com/apk/res/android", IafdConstant.KEY_VERSION_CODE, 0);
        ...
        while (true) {
            ...
            if (type == 3) {
                ...
                if ("application".equals(parser.getName())) {
                    ...
                    boolean hasBindDeviceAdminPermission = Manifest.permission.BIND_DEVICE_ADMIN.equals(permission);
