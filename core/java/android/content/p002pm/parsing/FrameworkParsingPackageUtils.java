...
public class FrameworkParsingPackageUtils {
    ...
    if (TextUtils.isEmpty(rawPropNames) || TextUtils.isEmpty(rawPropValues)) {
      ...
      Slog.m121w(
          ...
          "Disabling overlay - incomplete property :'"
              ...
              + "="
              + rawPropValues
              + "' - require both requiredSystemPropertyName AND requiredSystemPropertyValue to be"
              + " specified.");
      return false;
    }
    ...
    if (propNames.length != propValues.length) {
      Slog.m121w(
          ...
          "Disabling overlay - property :'"
              ...
              + "="
              + rawPropValues
              + "' - require both requiredSystemPropertyName AND requiredSystemPropertyValue lists"
  ...
  public static ParseResult<SigningDetails> getSigningDetails(
    ...
    if (!Signature.areExactMatch(
        existingSigningDetails.getSignatures(), verified.getResult().getSignatures())) {
  ...
  public static ParseResult<Integer> computeMinSdkVersion(
    ...
    return input.error(
        -12, "Requires development platform " + minCode + " but this is a release platform.");
  }
  ...
  public static ParseResult<Integer> computeTargetSdkVersion(
    ...
    return input.error(
        -12, "Requires development platform " + targetCode + " but this is a release platform.");
  }
