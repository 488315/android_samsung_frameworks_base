package android.content.p002pm.parsing.result;
...
public class ParseTypeImpl implements ParseInput, ParseResult<Object> {
  ...
  static /* synthetic */ boolean lambda$forDefaultParsing$1(
      IPlatformCompat platformCompat, long changeId, String packageName, int targetSdkVersion) {
  ...
  @Override // android.content.p002pm.parsing.result.ParseInput
  ...
  public <ResultType> ParseResult<ResultType> error(ParseResult<?> intentResult) {
    return error(
        intentResult.getErrorCode(), intentResult.getErrorMessage(), intentResult.getException());
  }
  ...
  @Override // android.content.p002pm.parsing.result.ParseResult
