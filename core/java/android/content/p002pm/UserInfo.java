...
public class UserInfo implements Parcelable {
    ...
    public boolean isMaintenanceMode() {
        return (this.flags & 524288) == 524288 && this.f54id == 77;
    }
    ...
    private boolean canSwitchToHeadlessSystemUser() {
        return UserManager.USER_TYPE_SYSTEM_HEADLESS.equals(this.userType) && Resources.getSystem().getBoolean(C4337R.bool.config_canSwitchToHeadlessSystemUser);
    }
    ...
    public UserHandle getUserHandle() {
        return UserHandle.m55of(this.f54id);
    }

    public String toString() {
        return "UserInfo{" + this.f54id + ":" + this.name + ":" + Integer.toHexString(this.flags) + "}";
    }

    public String toFullString() {
        return "UserInfo[id=" + this.f54id + ", name=" + this.name + ", type=" + this.userType + ", flags=" + flagsToString(this.flags) + (this.preCreated ? " (pre-created)" : "") + (this.convertedFromPreCreated ? " (converted)" : "") + (this.partial ? " (partial)" : "") + NavigationBarInflaterView.SIZE_MOD_END;
    }
