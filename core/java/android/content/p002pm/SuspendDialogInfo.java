...
public final class SuspendDialogInfo implements Parcelable {
  ...
  public static SuspendDialogInfo restoreFromXml(TypedXmlPullParser in) {
    ...
    try {
      ...
      Slog.m116e(TAG, "Exception while parsing from xml. Some fields may default", e);
    }
  ...
  public int hashCode() {
    ...
    return (((((((((((((hashCode * 31) + this.mTitleResId) * 31) + Objects.hashCode(this.mTitle))
                                            * 31)
                                        + this.mNeutralButtonTextResId)
                                    * 31)
                                + Objects.hashCode(this.mNeutralButtonText))
                            * 31)
