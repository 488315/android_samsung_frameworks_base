...
public abstract class PackageManager {
  ...
  @SystemApi public static final String FEATURE_BROADCAST_RADIO = "android.hardware.broadcastradio";
  ...
  @SystemApi @Deprecated public static final int INTENT_FILTER_DOMAIN_VERIFICATION_STATUS_NEVER = 3;
  ...
  @SystemApi public static final int MATCH_CLONE_PROFILE = 536870912;
  ...
  public static final class ComponentEnabledSetting implements Parcelable {
    public static final Parcelable.Creator<ComponentEnabledSetting> CREATOR =
        new Parcelable.Creator<
            ComponentEnabledSetting>() { // from class:
    ...
    ComponentEnabledSetting(Parcel in) {
      ...
      ComponentName componentName =
          (flg & 2) == 0 ? null : (ComponentName) in.readTypedObject(ComponentName.CREATOR);
      ...
      AnnotationValidations.validate(
          (Class<? extends Annotation>) EnabledState.class, (Annotation) null, enabledState);
      this.mEnabledFlags = enabledFlags;
      AnnotationValidations.validate(
          (Class<? extends Annotation>) EnabledFlags.class, (Annotation) null, enabledFlags);
    }
  ...
  static {
    ...
    sApplicationInfoCache =
        new PropertyInvalidatedCache<ApplicationInfoQuery, ApplicationInfo>(
            32, str, "getApplicationInfo") { // from class: android.content.pm.PackageManager.1
    ...
    sPackageInfoCache =
        new PropertyInvalidatedCache<PackageInfoQuery, PackageInfo>(
            64, str, "getPackageInfo") { // from class: android.content.pm.PackageManager.2
          @Override // android.app.PropertyInvalidatedCache
  ...
  public static final class PackageInfoFlags extends Flags {
    ...
    /* renamed from: of */
    public static PackageInfoFlags m11of(long value) {
  ...
  public static final class ApplicationInfoFlags extends Flags {
    ...
    /* renamed from: of */
    public static ApplicationInfoFlags m9of(long value) {
  ...
  public static final class ComponentInfoFlags extends Flags {
    ...
    /* renamed from: of */
    public static ComponentInfoFlags m10of(long value) {
  ...
  public static final class ResolveInfoFlags extends Flags {
    ...
    /* renamed from: of */
    public static ResolveInfoFlags m12of(long value) {
  ...
  public boolean isSpeg(String packageName, int userId) {
    ...
    try {
      ...
      try {
        return new File(
                sourceDir, new StringBuilder().append("base.speg").append(info.uid).toString())
            .exists();
      } catch (SecurityException e) {
        Log.m102w("SPEG", "No permission to check status for uid " + info.uid);
        return false;
      }
  ...
  public ApplicationInfo getApplicationInfoAsUser(
      String packageName, ApplicationInfoFlags flags, int userId) throws NameNotFoundException {
  ...
  public List<ResolveInfo> queryBroadcastReceivers(Intent intent, int flags, int userId) {
    ...
    Log.m94d(TAG, "Shame on you for calling the hidden API queryBroadcastReceivers(). Shame!");
  ...
  public PackageInfo getPackageArchiveInfo(String archiveFilePath, int flags) {
    return getPackageArchiveInfo(archiveFilePath, PackageInfoFlags.m11of(flags));
  }
  ...
  public PackageInfo getPackageArchiveInfo(String archiveFilePath, PackageInfoFlags flags) {
    ...
    try {
      ...
      return PackageParser.generatePackageInfo(
          pkg, null, (int) flagsBits2, 0L, 0L, null, FrameworkPackageUserState.DEFAULT);
  ...
  public static final class UninstallCompleteCallback implements Parcelable {
    public static final Parcelable.Creator<UninstallCompleteCallback> CREATOR =
        new Parcelable.Creator<
            UninstallCompleteCallback>() { // from class:
  ...
  public boolean isDefaultApplicationIcon(Drawable drawable) {
    int resId =
        drawable instanceof AdaptiveIconDrawable
            ...
            : 0;
    return resId == 17301651 || resId == 17304333;
  }
