...
public class ActivityInfo extends ComponentInfo implements Parcelable {
  ...
  /* renamed from: OVERRIDE_ENABLE_COMPAT_IGNORE_ORIENTATION_REQUEST_WHEN_LOOP_DETECTED */
  public static final long f51x114d5990 = 273509367;
  ...
  public static int[] CONFIG_NATIVE_BITS = {
    2, 1, 4, 8, 16, 32, 64, 128, 2048, 4096, 512, 8192, 256, 16384, 65536, 131072, 131072, 32768,
    262144, 524288, 2097152, 1048576
  };
  public static final Parcelable.Creator<ActivityInfo> CREATOR =
      new Parcelable.Creator<ActivityInfo>() { // from class: android.content.pm.ActivityInfo.1
  ...
  public boolean isChangeEnabled(long changeId) {
    return CompatChanges.isChangeEnabled(
        ...
        UserHandle.getUserHandleForUid(this.applicationInfo.uid));
  }
  ...
  public void dump(Printer pw, String prefix, int dumpFlags) {
    ...
    if ((dumpFlags & 1) != 0) {
      pw.println(
          prefix + "lockTaskLaunchMode=" + lockTaskLaunchModeToString(this.lockTaskLaunchMode));
    }
  ...
  @Override // android.content.p002pm.ComponentInfo, android.content.p002pm.PackageItemInfo,
