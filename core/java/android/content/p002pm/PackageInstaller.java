...
import android.p009os.FileBridge;
...
public class PackageInstaller {
  ...
  public void uninstall(VersionedPackage versionedPackage, int flags, IntentSender statusReceiver) {
    ...
    try {
      this.mInstaller.uninstall(
          versionedPackage, this.mInstallerPackageName, flags, statusReceiver, this.mUserId);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
                          ...
                          r1.accept(
                              (PackageInstaller.InstallConstraintsResult)
                                  bundle.getParcelable(
                                      "result", PackageInstaller.InstallConstraintsResult.class));
                        }
                      });
                }
              });
  ...
  public void commitSessionAfterInstallConstraintsAreMet(
    ...
    try {
      ...
      IntentSender intentSender =
          new IntentSender(
              (IIntentSender)
                  new IIntentSender.Stub() { // from class: android.content.pm.PackageInstaller.1
          ...
          PooledLambda.obtainRunnable(
                  new TriConsumer() { // from class:
                    ...
                    public final void accept(Object obj, Object obj2, Object obj3) {
                      ((PackageInstaller.SessionCallback) obj)
                          .onProgressChanged(
                              ((Integer) obj2).intValue(), ((Float) obj3).floatValue());
                    }
                  },
                  this.mCallback,
                  Integer.valueOf(sessionId),
      ...
      this.mExecutor.execute(
          PooledLambda.obtainRunnable(
                  new TriConsumer() { // from class:
                    ...
                    public final void accept(Object obj, Object obj2, Object obj3) {
                      ((PackageInstaller.SessionCallback) obj)
                          .onFinished(((Integer) obj2).intValue(), ((Boolean) obj3).booleanValue());
                    }
                  },
                  this.mCallback,
                  Integer.valueOf(sessionId),
  ...
  public static class Session implements Closeable {
    ...
    public void setChecksums(String name, List<Checksum> checksums, byte[] signature)
      ...
      try {
        this.mSession.setChecksums(
            name, (Checksum[]) checksums.toArray(new Checksum[checksums.size()]), signature);
      } catch (RemoteException e) {
        throw e.rethrowFromSystemServer();
      } catch (RuntimeException e2) {
        ExceptionUtils.maybeUnwrapIOException(e2);
    ...
    public void requestChecksums(
      ...
      try {
        IOnChecksumsReadyListener onChecksumsReadyListenerDelegate =
            new BinderC06891(executor, onChecksumsReadyListener);
    ...
    class BinderC06891 extends IOnChecksumsReadyListener.Stub {
      final /* synthetic */ Executor val$executor;
      final /* synthetic */ PackageManager.OnChecksumsReadyListener val$onChecksumsReadyListener;

      BinderC06891(
          Executor executor, PackageManager.OnChecksumsReadyListener onChecksumsReadyListener) {
  ...
  public static class SessionParams implements Parcelable {
    ...
    public static final Parcelable.Creator<SessionParams> CREATOR =
        new Parcelable.Creator<
            SessionParams>() { // from class: android.content.pm.PackageInstaller.SessionParams.1
      ...
      DataLoaderParamsParcel dataLoaderParamsParcel =
          (DataLoaderParamsParcel)
              source.readParcelable(
                  DataLoaderParamsParcel.class.getClassLoader(), DataLoaderParamsParcel.class);
    ...
    public boolean areHiddenOptionsSet() {
      ...
      return ((1169536 & i) == i && this.abiOverride == null && this.volumeUuid == null)
          ? false
          : true;
    }
      ...
      if (TextUtils.isEmpty(permissionName)) {
        throw new IllegalArgumentException(
            "Provided permissionName cannot be "
                + (permissionName == null ? SemCapabilities.FEATURE_TAG_NULL : "empty"));
      }
      switch (state) {
        case 0:
      ...
      if (requireUserAction != 0 && requireUserAction != 1 && requireUserAction != 2) {
        throw new IllegalArgumentException(
            "requireUserAction set as invalid value of "
                + requireUserAction
                + ", but must be one of [USER_ACTION_UNSPECIFIED, USER_ACTION_REQUIRED,"
  ...
  public static class SessionInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<SessionInfo> CREATOR =
        new Parcelable.Creator<
            SessionInfo>() { // from class: android.content.pm.PackageInstaller.SessionInfo.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public Bitmap getAppIcon() {
      if (this.appIcon == null) {
        try {
          SessionInfo info =
              AppGlobals.getPackageManager().getPackageInstaller().getSessionInfo(this.sessionId);
    ...
    public static final class Builder {
      ...
      public PreapprovalDetails build() {
        ...
        PreapprovalDetails o =
            new PreapprovalDetails(this.mIcon, this.mLabel, this.mLocale, this.mPackageName);
        return o;
      }
  ...
  public static final class InstallConstraintsResult implements Parcelable {
    public static final Parcelable.Creator<InstallConstraintsResult> CREATOR =
        new Parcelable.Creator<
            InstallConstraintsResult>() { // from class:
  ...
  public static final class InstallConstraints implements Parcelable {
    ...
    public int hashCode() {
      ...
      return (((((((_hash * 31) + Boolean.hashCode(this.mAppNotForegroundRequired)) * 31)
                          + Boolean.hashCode(this.mAppNotInteractingRequired))
                      * 31)
