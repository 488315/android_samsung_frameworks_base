...
public class PackageInstaller {
    ...
    public static class Session implements Closeable {
        ...
        public void requestChecksums(String name, int required, List<Certificate> trustedInstallers, Executor executor, PackageManager.OnChecksumsReadyListener onChecksumsReadyListener) throws CertificateEncodingException, FileNotFoundException {
            ...
            try {
                IOnChecksumsReadyListener onChecksumsReadyListenerDelegate = new BinderC06891(executor, onChecksumsReadyListener);
        ...
        class BinderC06891 extends IOnChecksumsReadyListener.Stub {
            ...
            BinderC06891(Executor executor, PackageManager.OnChecksumsReadyListener onChecksumsReadyListener) {
