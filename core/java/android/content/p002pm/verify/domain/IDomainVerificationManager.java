...
public interface IDomainVerificationManager extends IInterface {
  ...
  public static class Default implements IDomainVerificationManager {
    @Override // android.content.p002pm.verify.domain.IDomainVerificationManager
    ...
    public int setDomainVerificationUserSelection(
        String domainSetId, DomainSet domains, boolean enabled, int userId) throws RemoteException {
      return 0;
    }
      ...
      public DomainVerificationInfo getDomainVerificationInfo(String packageName)
        ...
        try {
          ...
          DomainVerificationInfo _result =
              (DomainVerificationInfo) _reply.readTypedObject(DomainVerificationInfo.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
