package android.content.p002pm.verify.domain;
...
public final class DomainVerificationUserState implements Parcelable {
  ...
  public DomainVerificationUserState(
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) identifier);
    this.mPackageName = packageName;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) packageName);
    this.mUser = user;
    ...
    AnnotationValidations.validate(
        ...
        (NonNull) null,
        (Object) Boolean.valueOf(linkHandlingAllowed));
    this.mHostToStateMap = hostToStateMap;
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) hostToStateMap);
  }
  ...
  public String toString() {
    return "DomainVerificationUserState { identifier = "
        + this.mIdentifier
        + ", packageName = "
        + this.mPackageName
        + ", user = "
  ...
  public boolean equals(Object o) {
    ...
    if (Objects.equals(this.mIdentifier, that.mIdentifier)
        ...
        && Objects.equals(this.mUser, that.mUser)
        && this.mLinkHandlingAllowed == that.mLinkHandlingAllowed
  ...
  public int hashCode() {
    ...
    return (((((((_hash * 31) + Objects.hashCode(this.mPackageName)) * 31)
                        + Objects.hashCode(this.mUser))
                    * 31)
                + Boolean.hashCode(this.mLinkHandlingAllowed))
            * 31)
  ...
  static {
    ...
    CREATOR =
        new Parcelable.Creator<
            DomainVerificationUserState>() { // from class:
