...
public final class DomainVerificationRequest implements Parcelable {
  ...
  public DomainVerificationRequest(Set<String> packageNames) {
    ...
    AnnotationValidations.validate(
        (Class<NonNull>) NonNull.class, (NonNull) null, (Object) packageNames);
  }
  ...
  static {
    Parcelling<Set<String>> parcelling =
        Parcelling.Cache.get(Parcelling.BuiltIn.ForStringSet.class);
    ...
    CREATOR =
        new Parcelable.Creator<
            DomainVerificationRequest>() { // from class:
