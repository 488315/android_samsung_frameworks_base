        ...
        */
        public void startSync(ISyncContext syncContext, String authority, Account account, Bundle extras) {
            ...
            if (AbstractThreadedSyncAdapter.ENABLE_LOG) {
                ...
                Log.m94d(AbstractThreadedSyncAdapter.TAG, "startSync() start " + authority + " " + account + " " + extras);
            }
            try {
                try {
                    try {
        ...
        public void cancelSync(ISyncContext syncContext) {
            ...
            try {
                try {
                    ...
                    if (info != null) {
                        if (AbstractThreadedSyncAdapter.ENABLE_LOG) {
                            Log.m94d(AbstractThreadedSyncAdapter.TAG, "cancelSync() " + info.mAuthority + " " + info.mAccount);
                        }
