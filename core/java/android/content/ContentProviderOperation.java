...
public class ContentProviderOperation implements Parcelable {
  public static final Parcelable.Creator<ContentProviderOperation> CREATOR =
      new Parcelable.Creator<
          ContentProviderOperation>() { // from class: android.content.ContentProviderOperation.1
  ...
  public static class BackReference implements Parcelable {
    ...
    public Object resolve(ContentProviderResult[] backRefs, int numBackRefs) {
      ...
      if (i >= numBackRefs) {
        Log.m96e(ContentProviderOperation.TAG, toString());
  ...
  public static class Builder {
    ...
    public ContentProviderOperation build() {
      ...
      if (this.mType == 4
          && (((arrayMap = this.mValues) == null || arrayMap.isEmpty())
    ...
    public Builder withValueBackReferences(ContentValues contentValues) {
      ...
      for (int i = 0; i < values.size(); i++) {
        setValue(
            values.keyAt(i), new BackReference(((Integer) values.valueAt(i)).intValue(), null));
      }
      return this;
    }
    ...
    private void assertValuesAllowed() {
      switch (this.mType) {
        ...
        default:
          throw new IllegalArgumentException(
              "Values not supported for " + ContentProviderOperation.typeToString(this.mType));
      }
    }
    ...
    private void assertSelectionAllowed() {
      switch (this.mType) {
        ...
        default:
          throw new IllegalArgumentException(
              "Selection not supported for " + ContentProviderOperation.typeToString(this.mType));
      }
    }
    ...
    private void assertExtrasAllowed() {
      switch (this.mType) {
        ...
        default:
          throw new IllegalArgumentException(
              "Extras not supported for " + ContentProviderOperation.typeToString(this.mType));
      }
    }
  }
}
