...
public abstract class ContentProvider implements ContentInterface, ComponentCallbacks2 {
    ...
    class Transport extends ContentProviderNative {
        ...
        private void logGetTypeData(int callingUid, Uri uri, String type, boolean permissionCheckPassed) {
            ...
            try {
                ProviderInfo cpi = ContentProvider.this.mContext.getPackageManager().resolveContentProvider(uri.getAuthority(), PackageManager.ComponentInfoFlags.m10of(128L));
    ...
    private boolean isContentRedirectionAllowedForUser(int incomingUserId) {
        ...
        if (um != null && um.getUserProperties(UserHandle.m55of(incomingUserId)).isMediaSharedWithParent() && (parent = um.getProfileParent(UserHandle.m55of(incomingUserId))) != null && parent.equals(Process.myUserHandle())) {
    ...
    public void shutdown() {
        Log.m102w(TAG, "implement ContentProvider shutdown() to make sure all database connections are gracefully shutdown");
    }
    ...
    public Uri validateIncomingUri(Uri uri) throws SecurityException {
        ...
        if (encodedPath != null && encodedPath.indexOf("//") != -1) {
            ...
            Log.m102w(TAG, "Normalized " + uri + " to " + normalized + " to avoid possible security issues");
            return normalized;
        }
        return uri;
    }
