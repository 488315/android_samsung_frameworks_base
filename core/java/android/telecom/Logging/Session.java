...
public class Session {
  ...
  public static class Info implements Parcelable {
    public static final Parcelable.Creator<Info> CREATOR =
        new Parcelable.Creator<Info>() { // from class: android.telecom.Logging.Session.Info.1
  ...
  private String getFullSessionId(int parentCount) {
    if (parentCount >= 25) {
      Slog.m121w(LOG_TAG, "getFullSessionId: Hit recursion limit!");
  ...
  private Session getRootSession(String callingMethod) {
    ...
    while (true) {
      ...
      if (currParentCount >= 25) {
        Slog.m121w(LOG_TAG, "getRootSession: Hit recursion limit from " + callingMethod);
        break;
      }
  ...
  private void printSessionTree(int tabI, StringBuilder sb, int currChildCount) {
    if (currChildCount >= 25) {
      Slog.m121w(LOG_TAG, "printSessionTree: Hit recursion limit!");
  ...
  private synchronized void getFullMethodPath(
    ...
    if (parentCount >= 25) {
      Slog.m121w(LOG_TAG, "getFullMethodPath: Hit recursion limit!");
      sb.append(TRUNCATE_STRING);
      return;
    }
  ...
  public int hashCode() {
    ...
    int hashCode4 =
        (((((((hashCode3 + (arrayList != null ? arrayList.hashCode() : 0)) * 31)
  ...
  public boolean equals(Object o) {
    ...
    if (session2 == null
        ...
        : !session2.equals(session.mParentSession)) {
      return false;
    }
    ArrayList<Session> arrayList = this.mChildSessions;
    if (arrayList == null
        ? session.mChildSessions != null
        : !arrayList.equals(session.mChildSessions)) {
      return false;
    }
    String str3 = this.mOwnerInfo;
    if (str3 != null) {
