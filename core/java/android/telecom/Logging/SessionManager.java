...
public class SessionManager {
  ...
  public synchronized Session createSubsession(boolean isStartedFromActiveSession) {
    ...
    if (threadSession == null) {
      Log.m68d(
          LOGGING_TAG, "Log.createSubsession was called with no session active.", new Object[0]);
      return null;
    }
  ...
  public synchronized Session.Info getExternalSession(String ownerInfo) {
    ...
    if (threadSession == null) {
      Log.m68d(
          LOGGING_TAG, "Log.getExternalSession was called with no session active.", new Object[0]);
      return null;
    }
  ...
  public synchronized void continueSession(Session subsession, String shortMethodName) {
    ...
    if (parentSession == null) {
      Log.m72i(
          LOGGING_TAG,
          "Log.continueSession was called with no session active for method " + shortMethodName,
          new Object[0]);
      return;
    }
