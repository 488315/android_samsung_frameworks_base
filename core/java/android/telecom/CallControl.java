...
public final class CallControl {
  ...
  public CallControl(
      String callId,
      ICallControl serverInterface,
      ClientTransactionalServiceRepository repository,
  ...
  public void disconnect(
    ...
    if (iCallControl != null) {
      try {
        iCallControl.disconnect(
            this.mCallId,
            disconnectCause,
            new CallControlResultReceiver(MediaMetrics.Value.DISCONNECT, executor, callback));
        return;
      } catch (RemoteException e) {
        throw e.rethrowAsRuntimeException();
      }
  ...
  public void startCallStreaming(Executor executor, OutcomeReceiver<Void, CallException> callback) {
    ...
    if (iCallControl != null) {
      try {
        iCallControl.startCallStreaming(
            this.mCallId, new CallControlResultReceiver("startCallStreaming", executor, callback));
        return;
      } catch (RemoteException e) {
        throw e.rethrowAsRuntimeException();
      }
  ...
  public void requestCallEndpointChange(
      CallEndpoint callEndpoint, Executor executor, OutcomeReceiver<Void, CallException> callback) {
    ...
    if (iCallControl != null) {
      try {
        iCallControl.requestCallEndpointChange(
            callEndpoint, new CallControlResultReceiver("endpointChange", executor, callback));
        return;
      } catch (RemoteException e) {
        throw e.rethrowAsRuntimeException();
      }
  ...
  class CallControlResultReceiver extends ResultReceiver {
    ...
    CallControlResultReceiver(
        String method, Executor executor, OutcomeReceiver<Void, CallException> clientCallback) {
      super((Handler) null);
  ...
  public CallException getTransactionException(Bundle resultData) {
    if (resultData != null && resultData.containsKey(CallException.TRANSACTION_EXCEPTION_KEY)) {
      return (CallException)
          resultData.getParcelable(CallException.TRANSACTION_EXCEPTION_KEY, CallException.class);
    }
      ...
      throw new IllegalArgumentException(
          TextUtils.formatSimple(
              "The DisconnectCause code provided, %d , is not a valid Disconnect code. Valid"
                  ...
                  + " DisconnectCause.REMOTE, DisconnectCause.MISSED, or DisconnectCause.REJECTED]",
  ...
  private void validateVideoState(int videoState) {
    if (videoState != 1 && videoState != 2) {
      throw new IllegalArgumentException(
          TextUtils.formatSimple(
              "The VideoState argument passed in, %d , is not a valid VideoState. The VideoState"
                  + " choices are limited to CallAttributes.AUDIO_CALL orCallAttributes.VIDEO_CALL",
