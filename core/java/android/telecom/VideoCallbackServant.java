...
final class VideoCallbackServant {
    ...
    private final Handler mHandler =
            new Handler() { // from class: android.telecom.VideoCallbackServant.1
                ...
                private void internalHandleMessage(Message msg) throws RemoteException {
                    ...
                    switch (msg.what) {
                        case 0:
                            VideoCallbackServant.this.mDelegate.receiveSessionModifyRequest(
                                    (VideoProfile) msg.obj);
                            return;
                        case 1:
                            args = (SomeArgs) msg.obj;
                            try {
                                VideoCallbackServant.this.mDelegate.receiveSessionModifyResponse(
                                        args.argi1,
                        ...
                        case 2:
                            args = (SomeArgs) msg.obj;
                            try {
                                VideoCallbackServant.this.mDelegate.handleCallSessionEvent(
                                        args.argi1);
                                return;
                            } finally {
                            }
                        case 3:
                            args = (SomeArgs) msg.obj;
                            try {
                                VideoCallbackServant.this.mDelegate.changePeerDimensions(
                                        args.argi1, args.argi2);
                                return;
                            } finally {
                            }
                        case 4:
                            args = (SomeArgs) msg.obj;
                            try {
                                VideoCallbackServant.this.mDelegate.changeCallDataUsage(
                                        ((Long) args.arg1).longValue());
                                return;
                            } finally {
                            }
                        case 5:
                            VideoCallbackServant.this.mDelegate.changeCameraCapabilities(
    ...
    private final IVideoCallback mStub =
            new IVideoCallback.Stub() { // from class: android.telecom.VideoCallbackServant.2
                @Override // com.android.internal.telecom.IVideoCallback
                public void receiveSessionModifyRequest(VideoProfile videoProfile)
                        throws RemoteException {
                    VideoCallbackServant.this
                            .mHandler
                            .obtainMessage(0, videoProfile)
                            .sendToTarget();
                }
                ...
                public void changeCameraCapabilities(
                        VideoProfile.CameraCapabilities cameraCapabilities) throws RemoteException {
                    VideoCallbackServant.this
                            .mHandler
                            .obtainMessage(5, cameraCapabilities)
                            .sendToTarget();
                }
                ...
                public void changeVideoQuality(int videoQuality) throws RemoteException {
                    VideoCallbackServant.this
                            .mHandler
                            .obtainMessage(6, videoQuality, 0)
                            .sendToTarget();
                }
            };
