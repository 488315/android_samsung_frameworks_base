...
public final class Phone {
    ...
    final void internalAddCall(ParcelableCall parcelableCall) {
        if (this.mTargetSdkVersion < 30 && parcelableCall.getState() == 12) {
            Log.m71i(this, "Skipping adding audio processing call for sdk compatibility", new Object[0]);
            return;
        }
        ...
        Log.m75w(this, "Call %s added, but it was already present", call.internalGetCallId());
        checkCallTree(parcelableCall);
    ...
    final void internalUpdateCall(ParcelableCall parcelableCall) {
        if (this.mTargetSdkVersion < 30 && parcelableCall.getState() == 12) {
            Log.m71i(this, "removing audio processing call during update for sdk compatibility", new Object[0]);
            Call call = getCallById(parcelableCall.getId());
            if (call != null) {
        ...
        if (call2 != null) {
            ...
            if (parcelableCall.getState() == 4 || parcelableCall.getState() == 13) {
                Log.m71i(this, "adding call during update for sdk compatibility", new Object[0]);
