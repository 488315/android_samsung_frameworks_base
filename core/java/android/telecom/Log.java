...
public class Log {
  ...
  /* renamed from: d */
  public static void m68d(String prefix, String format, Object... args) {
    if (sIsUserExtendedLoggingEnabled) {
      maybeDisableLogging();
      Slog.m117i(TAG, buildMessage(prefix, format, args));
    } else if (DEBUG) {
      Slog.m113d(TAG, buildMessage(prefix, format, args));
    }
  }

  /* renamed from: d */
  public static void m67d(Object objectPrefix, String format, Object... args) {
    if (sIsUserExtendedLoggingEnabled) {
      maybeDisableLogging();
      Slog.m117i(TAG, buildMessage(getPrefixFromObject(objectPrefix), format, args));
    } else if (DEBUG) {
      Slog.m113d(TAG, buildMessage(getPrefixFromObject(objectPrefix), format, args));
    }
  }

  /* renamed from: i */
  public static void m72i(String prefix, String format, Object... args) {
    if (INFO) {
      Slog.m117i(TAG, buildMessage(prefix, format, args));
    }
  }
  ...
  /* renamed from: i */
  public static void m71i(Object objectPrefix, String format, Object... args) {
    if (INFO) {
      Slog.m117i(TAG, buildMessage(getPrefixFromObject(objectPrefix), format, args));
    }
  }
  ...
  /* renamed from: v */
  public static void m74v(String prefix, String format, Object... args) {
    if (sIsUserExtendedLoggingEnabled) {
      maybeDisableLogging();
      Slog.m117i(TAG, buildMessage(prefix, format, args));
    } else if (VERBOSE) {
      Slog.m119v(TAG, buildMessage(prefix, format, args));
    }
  }

  /* renamed from: v */
  public static void m73v(Object objectPrefix, String format, Object... args) {
    if (sIsUserExtendedLoggingEnabled) {
      maybeDisableLogging();
      Slog.m117i(TAG, buildMessage(getPrefixFromObject(objectPrefix), format, args));
    } else if (VERBOSE) {
      Slog.m119v(TAG, buildMessage(getPrefixFromObject(objectPrefix), format, args));
    }
  }

  /* renamed from: w */
  public static void m76w(String prefix, String format, Object... args) {
    if (WARN) {
      Slog.m121w(TAG, buildMessage(prefix, format, args));
    }
  }

  /* renamed from: w */
  public static void m75w(Object objectPrefix, String format, Object... args) {
    if (WARN) {
      Slog.m121w(TAG, buildMessage(getPrefixFromObject(objectPrefix), format, args));
    }
  }

  /* renamed from: e */
  public static void m70e(String prefix, Throwable tr, String format, Object... args) {
    if (ERROR) {
      Slog.m116e(TAG, buildMessage(prefix, format, args), tr);
    }
  }

  /* renamed from: e */
  public static void m69e(Object objectPrefix, Throwable tr, String format, Object... args) {
    if (ERROR) {
      Slog.m116e(TAG, buildMessage(getPrefixFromObject(objectPrefix), format, args), tr);
    }
  }
    ...
    if (args != null) {
      try {
        ...
        m70e(
            TAG,
            (Throwable) ife,
            "Log: IllegalFormatException: formatString='%s' numArgs=%d",
            format,
      ...
      if (args.length != 0) {
        ...
        msg = format2;
        Object obj = sLock;
        String isLocked = obj != null ? Thread.holdsLock(obj) ? "🔒" : "❗" : "";
  ...
  public static String getPackageAbbreviation(String packageName) {
    ...
    return (String)
        Arrays.stream(packageName.split("\\."))
            .map(
                new Function() { // from class: android.telecom.Log$$ExternalSyntheticLambda1
