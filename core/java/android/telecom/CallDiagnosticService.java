...
public abstract class CallDiagnosticService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        Log.m71i(this, "onBind!", new Object[0]);
    ...
    public void handleCallAdded(ParcelableCall parcelableCall) {
        ...
        Log.m71i(this, "handleCallAdded: callId=%s - added", telecomCallId);
    ...
    public void handleCallUpdated(ParcelableCall parcelableCall) {
        ...
        Log.m71i(this, "handleCallUpdated: callId=%s - updated", telecomCallId);
        final Call.Details newCallDetails = Call.Details.createFromParcelableCall(parcelableCall);
        synchronized (this.mLock) {
    ...
    public void handleCallRemoved(String telecomCallId) {
        ...
        Log.m71i(this, "handleCallRemoved: callId=%s - removed", telecomCallId);
        synchronized (this.mLock) {
    ...
    public void handleReceivedD2DMessage(String callId, final int message, final int value) {
        final CallDiagnostics callDiagnostics;
        Log.m71i(this, "handleReceivedD2DMessage: callId=%s, msg=%d/%d", callId, Integer.valueOf(message), Integer.valueOf(value));
        synchronized (this.mLock) {
    ...
    public void handleCallDisconnected(String callId, DisconnectCause disconnectCause) {
        ...
        Log.m71i(this, "handleCallDisconnected: call=%s; cause=%s", callId, disconnectCause);
        synchronized (this.mLock) {
            callDiagnostics = this.mDiagnosticCallByTelecomCallId.get(callId);
        }
        ...
        try {
            ...
            Log.m75w(this, "handleCallDisconnected: call=%s; cause=%s; %s", callId, disconnectCause, e);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void handleBluetoothCallQualityReport(final BluetoothCallQualityReport qualityReport) {
        Log.m71i(this, "handleBluetoothCallQualityReport; report=%s", qualityReport);
    ...
    public void handleCallQualityChanged(String callId, CallQuality callQuality) {
        CallDiagnostics callDiagnostics;
        Log.m71i(this, "handleCallQualityChanged; call=%s, cq=%s", callId, callQuality);
        synchronized (this.mLock) {
            callDiagnostics = this.mDiagnosticCallByTelecomCallId.get(callId);
        }
        if (callDiagnostics != null) {
    ...
    public void handleSendDeviceToDeviceMessage(CallDiagnostics callDiagnostics, int message, int value) {
        ...
        try {
            ...
            Log.m71i(this, "handleSendDeviceToDeviceMessage: call=%s; msg=%d/%d", callId, Integer.valueOf(message), Integer.valueOf(value));
        } catch (RemoteException e) {
            Log.m75w(this, "handleSendDeviceToDeviceMessage: call=%s; msg=%d/%d failed %s", callId, Integer.valueOf(message), Integer.valueOf(value), e);
        }
    }
    ...
    public void handleDisplayDiagnosticMessage(CallDiagnostics callDiagnostics, int messageId, CharSequence message) {
        ...
        try {
            ...
            Log.m71i(this, "handleDisplayDiagnosticMessage: call=%s; msg=%d/%s", callId, Integer.valueOf(messageId), message);
        } catch (RemoteException e) {
            Log.m75w(this, "handleDisplayDiagnosticMessage: call=%s; msg=%d/%s failed %s", callId, Integer.valueOf(messageId), message, e);
        }
    }
    ...
    public void handleClearDiagnosticMessage(CallDiagnostics callDiagnostics, int messageId) {
        ...
        try {
            ...
            Log.m71i(this, "handleClearDiagnosticMessage: call=%s; msg=%d", callId, Integer.valueOf(messageId));
        } catch (RemoteException e) {
            Log.m75w(this, "handleClearDiagnosticMessage: call=%s; msg=%d failed %s", callId, Integer.valueOf(messageId), e);
        }
    }
}
