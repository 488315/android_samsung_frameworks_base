...
public final class CallAttributes implements Parcelable {
  ...
  public static final Parcelable.Creator<CallAttributes> CREATOR =
      new Parcelable.Creator<CallAttributes>() { // from class: android.telecom.CallAttributes.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public CallAttributes createFromParcel(Parcel source) {
          return new CallAttributes(
              (PhoneAccountHandle)
                  source.readParcelable(getClass().getClassLoader(), PhoneAccountHandle.class),
  ...
  public static final class Builder {
      ...
      if (!isInRange(1, 2, callDirection)) {
        throw new IllegalArgumentException(
            TextUtils.formatSimple(
                "CallDirection=[%d] is invalid. CallDirections value should be within [%d, %d]",
    ...
    public Builder setCallType(int callType) {
      if (!isInRange(1, 2, callType)) {
        throw new IllegalArgumentException(
            TextUtils.formatSimple(
                "CallType=[%d] is invalid. CallTypes value should be within [%d, %d]",
