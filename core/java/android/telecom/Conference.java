...
public abstract class Conference extends Conferenceable {
    ...
    public final boolean addConnection(Connection connection) {
        Log.m67d(this, "Connection=%s, connection=", connection);
    ...
    public final void removeConnection(Connection connection) {
        Log.m67d(this, "removing %s from %s", connection, this.mChildConnections);
    ...
    public final void setVideoState(Connection c, int videoState) {
        Log.m67d(this, "setVideoState Conference: %s Connection: %s VideoState: %s", this, c, Integer.valueOf(videoState));
        for (Listener l : this.mListeners) {
    ...
    public final void setVideoProvider(Connection c, Connection.VideoProvider videoProvider) {
        Log.m67d(this, "setVideoProvider Conference: %s Connection: %s VideoState: %s", this, c, videoProvider);
        for (Listener l : this.mListeners) {
    ...
    public final void destroy() {
        Log.m67d(this, "destroying conference : %s", this);
        for (Connection connection : this.mChildConnections) {
            Log.m67d(this, "removing connection %s", connection);
            removeConnection(connection);
        }
        if (this.mState != 6) {
            Log.m67d(this, "setting to disconnected", new Object[0]);
    ...
    final Conference addListener(Listener listener) {
        Rlog.m77d(LOG_TAG, "addListener - listener: " + listener);
        this.mListeners.add(listener);
        return this;
    }

    final Conference removeListener(Listener listener) {
        Rlog.m77d(LOG_TAG, "removeListener - listener: " + listener);
    ...
    final void setCallAudioState(CallAudioState state) {
        Log.m67d(this, "setCallAudioState %s", state);
    ...
    public final void setCallDirection(int callDirection) {
        Log.m67d(this, "setDirection %d", Integer.valueOf(callDirection));
    ...
    public final void setCallerDisplayName(String callerDisplayName, int presentation) {
        Log.m67d(this, "setCallerDisplayName %s", SemTelephonyUtils.maskPii(callerDisplayName));
