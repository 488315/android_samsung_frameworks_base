...
public class DefaultDialerManager {
    ...
    public static boolean setDefaultDialerApplication(
            Context context, String packageName, int user) {
            ...
            try {
                ...
                Consumer<Boolean> callback =
                        new Consumer() { // from class:
                                         // android.telecom.DefaultDialerManager$$ExternalSyntheticLambda0
                            @Override // java.util.function.Consumer
                            public final void accept(Object obj) {
                                DefaultDialerManager.lambda$setDefaultDialerApplication$0(
                                        future, (Boolean) obj);
                            }
                        };
                ...
                Slog.e(
                        TAG,
                        "Failed to set default dialer to " + packageName + " for user " + user,
                        e);
                Binder.restoreCallingIdentity(identity);
                return false;
            }
    ...
    static /* synthetic */ void lambda$setDefaultDialerApplication$0(
                    ...
                    CollectionUtils.firstOrNull(
                            ((RoleManager) context.getSystemService(RoleManager.class))
                                    .getRoleHoldersAsUser(
                                            "android.app.role.DIALER", UserHandle.of(user)));
        } finally {
            Binder.restoreCallingIdentity(identity);
        }
    }
    ...
    private static List<String> filterByIntent(
            Context context, List<String> packageNames, Intent intent, int userId) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (info != null
                    && packageNames.contains(info.packageName)
