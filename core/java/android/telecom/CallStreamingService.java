...
public abstract class CallStreamingService extends Service {
      ...
      new Handler(Looper.getMainLooper()) { // from class: android.telecom.CallStreamingService.1
        ...
        public void handleMessage(Message msg) {
          ...
          switch (msg.what) {
            case 1:
              if (msg.obj != null) {
                Log.m71i(this, "MSG_SET_STREAMING_CALL_ADAPTER", new Object[0]);
              ...
              break;
            case 2:
              Log.m71i(this, "MSG_CALL_STREAMING_STARTED", new Object[0]);
              ...
              break;
            case 3:
              Log.m71i(this, "MSG_CALL_STREAMING_STOPPED", new Object[0]);
  ...
  private final class CallStreamingServiceBinder extends ICallStreamingService.Stub {
    ...
    public void setStreamingCallAdapter(IStreamingCallAdapter streamingCallAdapter)
      ...
      Log.m71i(this, "setCallStreamingAdapter", new Object[0]);
    ...
    public void onCallStreamingStarted(StreamingCall call) throws RemoteException {
      Log.m71i(this, "onCallStreamingStarted", new Object[0]);
