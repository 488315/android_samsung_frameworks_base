...
public final class InCallAdapter {
  ...
  class ResultReceiverC29471 extends ResultReceiver {
    final /* synthetic */ OutcomeReceiver val$callback;
    final /* synthetic */ Executor val$executor;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ResultReceiverC29471(Handler handler, Executor executor, OutcomeReceiver outcomeReceiver) {
      super(handler);
  ...
  public void requestCallEndpointChange(
    ...
    try {
      this.mAdapter.requestCallEndpointChange(
          endpoint, new ResultReceiverC29471(null, executor, callback));
    } catch (RemoteException e) {
