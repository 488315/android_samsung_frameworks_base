...
public final class PhoneAccountSuggestion implements Parcelable {
  public static final Parcelable.Creator<PhoneAccountSuggestion> CREATOR =
      new Parcelable.Creator<
          PhoneAccountSuggestion>() { // from class: android.telecom.PhoneAccountSuggestion.1
  ...
  private PhoneAccountSuggestion(Parcel in) {
    this.mHandle =
        (PhoneAccountHandle)
            in.readParcelable(PhoneAccountHandle.class.getClassLoader(), PhoneAccountHandle.class);
  ...
  public int hashCode() {
    return Objects.hash(
        this.mHandle, Integer.valueOf(this.mReason), Boolean.valueOf(this.mShouldAutoSelect));
  }
}
