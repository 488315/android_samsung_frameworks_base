...
public class RemoteConnectionManager {
    ...
    void addConnectionService(
            ...
            final IConnectionService outgoingConnectionServiceRpc) {
        this.mRemoteConnectionServices.computeIfAbsent(
                componentName,
                new Function() { // from class:
                                 // android.telecom.RemoteConnectionManager$$ExternalSyntheticLambda0
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                        RemoteConnectionService lambda$addConnectionService$0;
                        lambda$addConnectionService$0 =
                                RemoteConnectionManager.this.lambda$addConnectionService$0(
    ...
    public /* synthetic */ RemoteConnectionService lambda$addConnectionService$0(
        ...
        try {
            return new RemoteConnectionService(
                    outgoingConnectionServiceRpc, this.mOurConnectionServiceImpl);
    ...
    public RemoteConnection createRemoteConnection(
        ...
        if (remoteService == null) {
            throw new UnsupportedOperationException(
                    "accountHandle not supported: " + componentName);
        }
    ...
    public void conferenceRemoteConnections(RemoteConnection a, RemoteConnection b) {
        if (a.getConnectionService() == b.getConnectionService()) {
            ...
            Log.w(
                    this,
                    "Request to conference incompatible remote connections (%s,%s) (%s,%s)",
                    a.getConnectionService(),
                    a.getId(),
                    b.getConnectionService(),
                    b.getId());
        }
    }
}
