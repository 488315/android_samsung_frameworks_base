...
public final class CallAudioState implements Parcelable {
  public static final Parcelable.Creator<CallAudioState> CREATOR =
      new Parcelable.Creator<CallAudioState>() { // from class: android.telecom.CallAudioState.1
        ...
        public CallAudioState createFromParcel(Parcel source) {
          ...
          BluetoothDevice activeBluetoothDevice =
              (BluetoothDevice)
                  source.readParcelable(ClassLoader.getSystemClassLoader(), BluetoothDevice.class);
          ArrayList arrayList = new ArrayList();
          source.readParcelableList(
              arrayList, ClassLoader.getSystemClassLoader(), BluetoothDevice.class);
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.activeBluetoothDevice, state.activeBluetoothDevice)
  ...
  public String toString() {
    String bluetoothDeviceList =
        (String)
            this.supportedBluetoothDevices.stream()
                .map(
    ...
    return String.format(
        Locale.US,
        "[AudioState isMuted: %b, route: %s, supportedRouteMask: %s, activeBluetoothDevice: [%s],"
            + " supportedBluetoothDevices: [%s]]",
