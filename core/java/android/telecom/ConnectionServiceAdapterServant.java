        ...
        private void internalHandleMessage(Message msg) throws RemoteException {
          ...
          switch (msg.what) {
            case 1:
              ...
              try {
                ConnectionServiceAdapterServant.this.mDelegate.handleCreateConnectionComplete(
                    (String) args.arg1,
            ...
            case 7:
              ...
              return;
            case 8:
              ConnectionServiceAdapterServant.this.mDelegate.setConnectionCapabilities(
            ...
            case 13:
              args = (SomeArgs) msg.obj;
              try {
                ConnectionServiceAdapterServant.this.mDelegate.queryRemoteConnectionServices(
                    (RemoteServiceCallback) args.arg1, (String) args.arg2, null);
                return;
              } finally {
              }
            case 14:
            ...
            case 20:
              args = (SomeArgs) msg.obj;
              try {
                ConnectionServiceAdapterServant.this.mDelegate.setConferenceableConnections(
            ...
            case 21:
              args = (SomeArgs) msg.obj;
              try {
                ConnectionServiceAdapterServant.this.mDelegate.addExistingConnection(
                    (String) args.arg1, (ParcelableConnection) args.arg2, null);
                return;
              } finally {
              }
            case 22:
            ...
            case 23:
              args = (SomeArgs) msg.obj;
              try {
                ConnectionServiceAdapterServant.this.mDelegate.setConferenceMergeFailed(
            ...
            case 26:
              ...
              try {
                ConnectionServiceAdapterServant.this.mDelegate.onConnectionEvent(
                    (String) args.arg1, (String) args.arg2, (Bundle) args.arg3, null);
                return;
              } finally {
              }
            case 27:
            ...
            case 29:
              ...
              try {
                ConnectionServiceAdapterServant.this.mDelegate.setAudioRoute(
                    (String) args.arg1, args.argi1, (String) args.arg2, (Session.Info) args.arg3);
                return;
              } finally {
              }
            case 30:
            ...
            case 31:
              ...
              return;
            case 32:
              ConnectionServiceAdapterServant.this.mDelegate.onRttSessionRemotelyTerminated(
                  (String) msg.obj, null);
              return;
            case 33:
            ...
            case 34:
              args = (SomeArgs) msg.obj;
              try {
                ConnectionServiceAdapterServant.this.mDelegate.onPhoneAccountChanged(
                    (String) args.arg1, (PhoneAccountHandle) args.arg2, null);
                return;
              } finally {
              }
            case 35:
            ...
            case 37:
              args = (SomeArgs) msg.obj;
              try {
                ConnectionServiceAdapterServant.this.mDelegate.handleCreateConferenceComplete(
                    (String) args.arg1,
                    (ConnectionRequest) args.arg2,
  ...
  private final IConnectionServiceAdapter mStub =
      new IConnectionServiceAdapter
        ...
        public void addConferenceCall(
            String callId, ParcelableConference parcelableConference, Session.Info sessionInfo) {
          SomeArgs args = SomeArgs.obtain();
          args.arg1 = callId;
        ...
        public void queryRemoteConnectionServices(
            RemoteServiceCallback callback, String callingPackage, Session.Info sessionInfo) {
          SomeArgs args = SomeArgs.obtain();
          args.arg1 = callback;
        ...
        public void setVideoProvider(
            String connectionId, IVideoProvider videoProvider, Session.Info sessionInfo) {
          SomeArgs args = SomeArgs.obtain();
          args.arg1 = connectionId;
        ...
        public final void setAddress(
            String connectionId, Uri address, int presentation, Session.Info sessionInfo) {
          SomeArgs args = SomeArgs.obtain();
          args.arg1 = connectionId;
          args.arg2 = address;
        ...
        public final void addExistingConnection(
            String connectionId, ParcelableConnection connection, Session.Info sessionInfo) {
          SomeArgs args = SomeArgs.obtain();
          args.arg1 = connectionId;
        ...
        public final void onConnectionEvent(
            String connectionId, String event, Bundle extras, Session.Info sessionInfo) {
          SomeArgs args = SomeArgs.obtain();
          args.arg1 = connectionId;
          args.arg2 = event;
          args.arg3 = extras;
        ...
        public void onRttInitiationFailure(
            String connectionId, int reason, Session.Info sessionInfo) throws RemoteException {
          ConnectionServiceAdapterServant.this
              .mHandler
