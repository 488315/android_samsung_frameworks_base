...
public abstract class InCallService extends Service {
    ...
    private final Handler mHandler = new Handler(Looper.getMainLooper()) { // from class: android.telecom.InCallService.1
        ...
        public void handleMessage(Message msg) {
            ...
            Rlog.m77d(InCallService.LOG_TAG, "handleMessage: " + InCallService.eventToString(msg.what));
            switch (msg.what) {
                case 1:
    ...
    private final class InCallServiceBinder extends IInCallService.Stub {
        ...
        public void addCall(ParcelableCall call) {
            if (call == null) {
                Rlog.m77d(InCallService.LOG_TAG, "InCallServiceBinder - addCall: call is null");
            } else {
                Rlog.m77d(InCallService.LOG_TAG, "InCallServiceBinder - addCall: id(" + call.getId() + "), state(" + Call.stateToStringInternal(call.getState()) + "), " + Call.Details.capabilitiesToString(call.getCapabilities()));
            }
        ...
        public void updateCall(ParcelableCall call) {
            if (call == null) {
                Rlog.m77d(InCallService.LOG_TAG, "InCallServiceBinder - updateCall: call is null");
            } else {
                Rlog.m77d(InCallService.LOG_TAG, "InCallServiceBinder - updateCall: id(" + call.getId() + "), state(" + Call.stateToStringInternal(call.getState()) + "), " + Call.Details.capabilitiesToString(call.getCapabilities()));
            }
