...
public class CallerInfo {
        ...
        if (cursor.moveToFirst()) {
          ...
          if (columnIndex4 != -1 && (typeColumnIndex = cursor.getColumnIndex("type")) != -1) {
            ...
            info.phoneLabel =
                ContactsContract.CommonDataKinds.Phone.getDisplayLabel(
                        context, info.numberType, string)
                    .toString();
          }
          ...
          if (columnIndex5 == -1) {
            ...
            if (contactId != 0 && !ContactsContract.Contacts.isEnterpriseContactId(contactId)) {
              ...
              if (z2) {
                Log.m74v(
                    TAG, "==> got info.contactIdOrZero: " + info.contactIdOrZero, new Object[0]);
              }
            }
          ...
          int columnIndex8 =
              cursor.getColumnIndex(
                  ContactsContract.DataColumns.PREFERRED_PHONE_ACCOUNT_COMPONENT_NAME);
          ...
          int columnIndex9 =
              cursor.getColumnIndex(ContactsContract.DataColumns.PREFERRED_PHONE_ACCOUNT_ID);
  ...
  public static CallerInfo getCallerInfo(Context context, Uri contactRef) {
    ...
    try {
      CallerInfo info =
          getCallerInfo(context, contactRef, cr.query(contactRef, null, null, null, null));
      return info;
  ...
  public static CallerInfo getCallerInfo(Context context, String number, int subId) {
    ...
    Uri contactUri =
        Uri.withAppendedPath(
            ContactsContract.PhoneLookup.ENTERPRISE_CONTENT_FILTER_URI, Uri.encode(number));
    CallerInfo info =
    ...
    if (!previousResult.contactExists && PhoneNumberUtils.isUriNumber(number)) {
      ...
      if (PhoneNumberUtils.isGlobalPhoneNumber(username)) {
        return getCallerInfo(
            context,
            Uri.withAppendedPath(
                ContactsContract.PhoneLookup.ENTERPRISE_CONTENT_FILTER_URI, Uri.encode(username)));
      }
  ...
  public static String getGeoDescription(Context context, String number) {
    ...
    if (z) {
      try {
        Log.m74v(
            TAG, "parsing '" + number + "' for countryIso '" + countryIso + "'...", new Object[0]);
      } catch (NumberParseException e) {
        Log.m76w(
            TAG,
            "getGeoDescription: NumberParseException for incoming number '" + Log.pii(number) + "'",
            new Object[0]);
      }
    }
  ...
  private static String getCurrentCountryIso(Context context, Locale locale) {
    ...
    if (countryIso == null) {
      ...
      Log.m76w(
          TAG,
          "No CountryDetector; falling back to countryIso based on locale: " + countryIso2,
          new Object[0]);
      return countryIso2;
    }
    return countryIso;
  ...
  public String toString() {
    ...
    StringBuilder append3 =
        append.append(
            append2.append(str == null ? SemCapabilities.FEATURE_TAG_NULL : "non-null").toString());
