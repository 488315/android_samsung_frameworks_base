...
public abstract class CallScreeningService extends Service {
              ...
              try {
                try {
                  ...
                  if (callDetails.getCallDirection() == 1) {
                    CallScreeningService.this.mCallScreeningAdapter.onScreeningResponse(
                        callDetails.getTelecomCallId(),
                        new ComponentName(
                            CallScreeningService.this.getPackageName(), getClass().getName()),
                        null);
                  }
                } catch (RemoteException e) {
                  Log.m75w(this, "Exception when screening call: " + e, new Object[0]);
                }
                return;
              } finally {
                args.recycle();
  ...
  private final class CallScreeningBinder extends ICallScreeningService.Stub {
    ...
    public void screenCall(ICallScreeningAdapter adapter, ParcelableCall call) {
      Log.m73v(this, "screenCall", new Object[0]);
  ...
  public static class CallResponse {
    ...
    public boolean equals(Object o) {
      ...
      if (this.mShouldDisallowCall == that.mShouldDisallowCall
          ...
          && this.mShouldScreenCallViaAudioProcessing == that.mShouldScreenCallViaAudioProcessing
  ...
  public IBinder onBind(Intent intent) {
    Log.m73v(this, "onBind", new Object[0]);
    return new CallScreeningBinder();
  }

  @Override // android.app.Service
  public boolean onUnbind(Intent intent) {
    Log.m73v(this, "onUnbind", new Object[0]);
    return false;
  }
  ...
  public final void respondToCall(Call.Details callDetails, CallResponse response) {
    try {
      ...
      Log.m69e(this, e, "Got remote exception when returning response", new Object[0]);
    }
  }
}
