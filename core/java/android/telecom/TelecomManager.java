...
public class TelecomManager {
  ...
  static {
    String str =
        "60000".equals(SemTelephonyUtils.ONEUI_VERSION)
    ...
    if (service != null) {
      try {
        return service.getDefaultOutgoingPhoneAccount(
            uriScheme, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
      } catch (RemoteException e) {
        android.util.Log.m97e(
  ...
  public PhoneAccountHandle getUserSelectedOutgoingPhoneAccount() {
    ...
    if (service != null) {
      try {
        ...
        android.util.Log.m97e(
            TAG, "Error calling ITelecomService#getUserSelectedOutgoingPhoneAccount", e);
        return null;
      }
    }
    return null;
    ...
    if (service != null) {
      try {
        return service.getSimCallManager(
            SubscriptionManager.getDefaultSubscriptionId(), this.mContext.getPackageName());
      } catch (RemoteException e) {
  ...
  public List<PhoneAccountHandle> getPhoneAccountsSupportingScheme(String uriScheme) {
    ...
    if (service != null) {
      try {
        return service
            .getPhoneAccountsSupportingScheme(uriScheme, this.mContext.getOpPackageName())
            .getList();
      } catch (RemoteException e) {
        android.util.Log.m97e(
  ...
  public String getDefaultDialerPackage() {
    ...
    if (service != null) {
      try {
        ...
        android.util.Log.m97e(
            TAG, "RemoteException attempting to get the default dialer package name.", e);
        return null;
      }
    }
    return null;
  ...
  public String getSystemDialerPackage() {
    ...
    if (service != null) {
      try {
        ...
        android.util.Log.m97e(
            TAG, "RemoteException attempting to get the system dialer package name.", e);
        return null;
      }
    }
    return null;
    ...
    if (service != null) {
      try {
        return service.getVoiceMailNumber(
            accountHandle, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
      } catch (RemoteException e) {
        android.util.Log.m97e(
  ...
  public void addNewIncomingCall(PhoneAccountHandle phoneAccount, Bundle extras) {
    ...
    if (service != null) {
      if (extras != null) {
        try {
          if (extras.getBoolean("android.telecom.extra.IS_HANDOVER")
              && this.mContext.getApplicationContext().getApplicationInfo().targetSdkVersion > 27) {
            android.util.Log.m96e(
                "TAG", "addNewIncomingCall failed. Use public api acceptHandover for API > O-MR1");
            return;
          }
        } catch (RemoteException e) {
          android.util.Log.m97e(
      ...
      service.addNewIncomingCall(
          phoneAccount, extras == null ? new Bundle() : extras, this.mContext.getPackageName());
    }
  }
    ...
    if (service != null) {
      if (extras != null) {
        ...
        try {
          ...
          android.util.Log.m97e(
              TAG, "RemoteException adding a new incoming conference: " + phoneAccount, e);
          return;
        }
      }
    ...
    if (service != null) {
      try {
        service.showInCallScreen(
            showDialpad, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
      } catch (RemoteException e) {
  ...
  public void placeCall(Uri address, Bundle extras) {
    ...
    if (service != null) {
      ...
      service.placeCall(
          address, bundle, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
    }
  }
    ...
    if (service != null) {
      try {
        ClientTransactionalServiceWrapper transactionalServiceWrapper =
            this.mTransactionalServiceRepository.addNewCallForTransactionalServiceWrapper(
