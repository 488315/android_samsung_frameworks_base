...
public class SuggestionSpan extends CharacterStyle implements ParcelableSpan {
    ...
    public SuggestionSpan(Context context, Locale locale, String[] suggestions, int flags, Class<?> notificationTargetClass) {
        ...
        if (locale != null) {
            ...
            Log.m96e(TAG, "No locale or context specified in SuggestionSpan constructor");
            sourceLocale = null;
        }
    ...
    private void initStyle(Context context) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(null, C4337R.styleable.SuggestionSpan, C4337R.attr.textAppearanceMisspelledSuggestion, 0);
        ...
        typedArray.recycle();
        TypedArray typedArray2 = context.obtainStyledAttributes(null, C4337R.styleable.SuggestionSpan, C4337R.attr.textAppearanceGrammarErrorSuggestion, 0);
        ...
        typedArray2.recycle();
        TypedArray typedArray3 = context.obtainStyledAttributes(null, C4337R.styleable.SuggestionSpan, C4337R.attr.textAppearanceEasyCorrectSuggestion, 0);
        ...
        typedArray3.recycle();
        TypedArray typedArray4 = context.obtainStyledAttributes(null, C4337R.styleable.SuggestionSpan, C4337R.attr.textAppearanceAutoCorrectionSuggestion, 0);
    ...
    public void notifySelection(Context context, String original, int index) {
        Log.m102w(TAG, "notifySelection() is deprecated.  Does nothing.");
    }
}
