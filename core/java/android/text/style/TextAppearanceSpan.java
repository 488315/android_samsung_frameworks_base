...
public class TextAppearanceSpan extends MetricAffectingSpan implements ParcelableSpan {
  ...
  public TextAppearanceSpan(Context context, int appearance, int colorList) {
    TypedArray a = context.obtainStyledAttributes(appearance, C4337R.styleable.TextAppearance);
    ...
    a.recycle();
    if (colorList >= 0) {
      TypedArray a2 = context.obtainStyledAttributes(16973829, C4337R.styleable.Theme);
  ...
  public TextAppearanceSpan(Parcel src) {
    ...
    this.mTextLocales =
        (LocaleList) src.readParcelable(LocaleList.class.getClassLoader(), LocaleList.class);
