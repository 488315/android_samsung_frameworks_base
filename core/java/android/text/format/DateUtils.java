...
public class DateUtils {
  ...
  private static void initFormatStringsLocked() {
    ...
    if (configuration == null || !configuration.equals(cfg)) {
      sLastConfig = cfg;
      sElapsedFormatMMSS = r.getString(C4337R.string.elapsed_time_short_format_mm_ss);
      sElapsedFormatHMMSS = r.getString(C4337R.string.elapsed_time_short_format_h_mm_ss);
    }
  }
  ...
  public static java.util.Formatter formatDateRange(
      Context context, java.util.Formatter formatter, long startMillis, long endMillis, int flags) {
  ...
  public static CharSequence getRelativeTimeSpanString(
    ...
    synchronized (DateUtils.class) {
      ...
      if (span < 86400000 && sNowTime.weekDay == sThenTime.weekDay) {
        ...
        flags = C4337R.string.preposition_for_time;
      } else if (sNowTime.year != sThenTime.year) {
        result = formatDateRange(c, millis, millis, 131092);
        flags = C4337R.string.preposition_for_date;
      } else {
