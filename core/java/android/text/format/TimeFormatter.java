  ...
  public TimeFormatter() {
    synchronized (TimeFormatter.class) {
      ...
      if (locale2 == null || !locale.equals(locale2)) {
        ...
        sTimeOnlyFormat = r.getString(C4337R.string.time_of_day);
        sDateOnlyFormat = r.getString(C4337R.string.month_day_year);
        sDateTimeFormat = r.getString(C4337R.string.date_and_time);
      }
    ...
    while (true) {
      ...
      switch (currentChar) {
        ...
        case 103:
          ...
          if (currentChar == 86) {
            this.numberFormatter.format(
                getFormat(modifier, "%02d", "%2d", "%d", "%02d"), Integer.valueOf(w));
            return false;
          }
          if (currentChar == 103) {
        ...
        case 73:
          ...
          this.numberFormatter.format(
              getFormat(modifier, "%02d", "%2d", "%d", "%02d"), Integer.valueOf(hour));
          return false;
        case 77:
          this.numberFormatter.format(
              getFormat(modifier, "%02d", "%2d", "%d", "%02d"),
        ...
        case 87:
          int n =
              ((wallTime.getYearDay() + 7)
                      - (wallTime.getWeekDay() != 0 ? wallTime.getWeekDay() - 1 : 6))
                  / 7;
          this.numberFormatter.format(
        ...
        case 90:
          ...
          modifyAndAppend(
              TimeZone.getTimeZone(zoneInfoData.getID()).getDisplayName(isDst, 0), modifier);
          return false;
        case 97:
          if (wallTime.getWeekDay() >= 0 && wallTime.getWeekDay() < 7) {
        ...
        case 106:
          ...
          this.numberFormatter.format(
              getFormat(modifier, "%03d", "%3d", "%d", "%03d"), Integer.valueOf(yearDay));
          return false;
        case 107:
          this.numberFormatter.format(
              getFormat(modifier, "%2d", "%2d", "%d", "%02d"), Integer.valueOf(wallTime.getHour()));
          return false;
        case 108:
