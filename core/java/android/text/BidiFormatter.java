...
public final class BidiFormatter {
  ...
  public CharSequence unicodeWrap(
    ...
    if (getStereoReset() && isolate) {
      result.append(
          (CharSequence)
              markBefore(str, isRtl ? TextDirectionHeuristics.RTL : TextDirectionHeuristics.LTR));
    }
    ...
    if (isolate) {
      result.append(
          (CharSequence)
              markAfter(str, isRtl ? TextDirectionHeuristics.RTL : TextDirectionHeuristics.LTR));
    }
    return result;
  }
