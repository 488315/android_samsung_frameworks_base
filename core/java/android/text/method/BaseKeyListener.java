...
public abstract class BaseKeyListener extends MetaKeyKeyListener implements KeyListener {
  ...
  static /* synthetic */ class C35371 {
    ...
    static {
      ...
      try {
        $SwitchMap$android$text$method$TextKeyListener$Capitalize[
                TextKeyListener.Capitalize.WORDS.ordinal()] =
            2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        $SwitchMap$android$text$method$TextKeyListener$Capitalize[
                TextKeyListener.Capitalize.SENTENCES.ordinal()] =
            3;
  ...
  static int makeTextContentType(TextKeyListener.Capitalize caps, boolean autoText) {
    int contentType = 1;
    switch (C35371.$SwitchMap$android$text$method$TextKeyListener$Capitalize[caps.ordinal()]) {
      case 1:
        contentType = 1 | 4096;
        break;
      case 2:
