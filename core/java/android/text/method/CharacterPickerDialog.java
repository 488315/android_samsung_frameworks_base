...
public class CharacterPickerDialog extends Dialog
  ...
  public CharacterPickerDialog(
      Context context, View view, Editable text, String options, boolean insert) {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    params.type = 1003;
    params.flags |= 1;
    setContentView(C4337R.layout.character_picker);
    GridView grid = (GridView) findViewById(C4337R.id.characterPicker);
    grid.setAdapter((ListAdapter) new OptionsAdapter(getContext()));
    grid.setOnItemClickListener(this);
    Button button = (Button) findViewById(C4337R.id.cancel);
  ...
  private class OptionsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      Button b =
          (Button)
              CharacterPickerDialog.this.mInflater.inflate(
                  C4337R.layout.character_picker_button, (ViewGroup) null);
