...
public abstract class MetaKeyKeyListener {
  ...
  public static long handleKeyDown(long state, int keyCode, KeyEvent event) {
    if (keyCode != 59 && keyCode != 60) {
      if (keyCode != 57 && keyCode != 58 && keyCode != 78) {
        if (keyCode == 63) {
          return press(
              state, 4, META_SYM_MASK, 1024L, 4398046511104L, 1125899906842624L, 17179869184L);
        }
        return state;
      }
  ...
  public static long handleKeyUp(long state, int keyCode, KeyEvent event) {
    if (keyCode != 59 && keyCode != 60) {
      if (keyCode != 57 && keyCode != 58 && keyCode != 78) {
        if (keyCode == 63) {
          return release(
              state, 4, META_SYM_MASK, 4398046511104L, 1125899906842624L, 17179869184L, event);
        }
        return state;
      }
  ...
  private static long release(
      long state, int what, long mask, long pressed, long released, long used, KeyEvent event) {
    switch (event.getKeyCharacterMap().getModifierBehavior()) {
      case 1:
        if ((state & used) != 0) {
          return state & (~mask);
