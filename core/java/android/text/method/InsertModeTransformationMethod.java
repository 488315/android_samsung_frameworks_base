...
public class InsertModeTransformationMethod implements TransformationMethod, TextWatcher {
  ...
  public class TransformedText implements OffsetMapping, Spanned {
    ...
    public CharSequence subSequence(int start, int end) {
      ...
      int seg2End =
          MathUtils.constrain(end - InsertModeTransformationMethod.this.mEnd, 0, placeholderLength);
    ...
    public String toString() {
      return String.valueOf(this.mOriginal.subSequence(0, InsertModeTransformationMethod.this.mEnd))
          + ((Object) this.mPlaceholder)
          + ((Object)
              this.mOriginal.subSequence(
                  InsertModeTransformationMethod.this.mEnd, this.mOriginal.length()));
    }
    ...
    public <T> T[] getSpans(final int i, final int i2, final Class<T> cls) {
        ...
        objArr =
            ArrayUtils.filter(
                this.mSpannedOriginal.getSpans(
                    transformedToOriginal(i, 1), transformedToOriginal(i2, 1), cls),
                new IntFunction() { // from class:
                  ...
                  public final Object apply(int i3) {
                    return InsertModeTransformationMethod.TransformedText.lambda$getSpans$0(
                        cls, i3);
                  }
                },
                new Predicate() { // from class:
                  ...
                  public final boolean test(Object obj) {
                    ...
                    lambda$getSpans$1 =
                        InsertModeTransformationMethod.TransformedText.this.lambda$getSpans$1(
                            i, i2, obj);
      ...
      if (this.mSpannedPlaceholder != null
          && InsertModeTransformationMethod.intersect(
              ...
              InsertModeTransformationMethod.this.mEnd + this.mPlaceholder.length())) {
        objArr2 =
            this.mSpannedPlaceholder.getSpans(
                Math.max(i - InsertModeTransformationMethod.this.mEnd, 0),
                Math.min(i2 - InsertModeTransformationMethod.this.mEnd, this.mPlaceholder.length()),
                cls);
      }
