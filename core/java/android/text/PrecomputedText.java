...
public class PrecomputedText implements Spannable {
  ...
  public static final class Params {
    ...
    public int hashCode() {
      ...
      return Objects.hash(
          ...
          Integer.valueOf(lineBreakStyle));
    }
    ...
    public String toString() {
      ...
      int lineBreakWordStyle =
          lineBreakConfig2 != null ? lineBreakConfig2.getLineBreakWordStyle() : 0;
      return "{textSize="
      ...
      switch (checkResult) {
        case 1:
          if (params.getBreakStrategy() == hintParams.getBreakStrategy()
              && params.getHyphenationFrequency() == hintParams.getHyphenationFrequency()) {
  ...
  private static ParagraphInfo[] createMeasuredParagraphsFromPrecomputedText(
    ...
    boolean needHyphenation =
        (params.getBreakStrategy() == 0 || params.getHyphenationFrequency() == 0) ? false : true;
    if (needHyphenation) {
      ...
      result.add(
          new ParagraphInfo(
              ...
              MeasuredParagraph.buildForStaticLayout(
                  ...
                  hyphenationMode,
                  computeLayout,
                  precomputedText.getMeasuredParagraph(i),
                  null)));
      i++;
      precomputedText = pct;
  ...
  public static ParagraphInfo[] createMeasuredParagraphs(
      CharSequence text, Params params, int start, int end, boolean computeLayout) {
    int paraEnd;
    int i = end;
    ArrayList<ParagraphInfo> result = new ArrayList<>();
    ...
    while (true) {
      ...
      if (i < paragraphInfoArr.length) {
        ...
        throw new IndexOutOfBoundsException(
            new StringBuilder()
                .append("pos must be less than ")
                .append(this.mParagraphInfo[r2.length - 1].paragraphEnd)
                .append(", gave ")
                .append(pos)
                .toString());
      }
