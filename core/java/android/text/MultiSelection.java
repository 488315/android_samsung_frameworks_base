    ...
    public static void setSelection(Spannable text, int start, int stop) {
        ...
        if ((start2 > 0 && start2 < len) || (stop2 > 0 && stop2 < len)) {
            ...
            if (stop2 > 0 && stop2 < len) {
                ...
                } else if (!needCheckPosition2 && (TextUtils.isIndianChar(stopChar) || TextUtils.isThaiChar(stopChar) || TextUtils.isKhmerChar(stopChar) || TextUtils.isMyanmarChar(stopChar) || TextUtils.isLaoChar(stopChar))) {
