...
public abstract class Layout {
  ...
  public static final TextInclusionStrategy INCLUSION_STRATEGY_ANY_OVERLAP =
      new TextInclusionStrategy() { // from class: android.text.Layout$$ExternalSyntheticLambda2
  ...
  public static final TextInclusionStrategy INCLUSION_STRATEGY_CONTAINS_CENTER =
      new TextInclusionStrategy() { // from class: android.text.Layout$$ExternalSyntheticLambda3
        @Override // android.text.Layout.TextInclusionStrategy
        public final boolean isSegmentInside(RectF rectF, RectF rectF2) {
          boolean contains;
  ...
  public static final TextInclusionStrategy INCLUSION_STRATEGY_CONTAINS_ALL =
      new TextInclusionStrategy() { // from class: android.text.Layout$$ExternalSyntheticLambda4
        @Override // android.text.Layout.TextInclusionStrategy
        public final boolean isSegmentInside(RectF rectF, RectF rectF2) {
          boolean contains;
  ...
  public static float getDesiredWidth(
      CharSequence source, int start, int end, TextPaint paint, TextDirectionHeuristic textDir) {
    ...
    try {
      if (highlightPaths != null) {
        ...
        if (highlightPaints.size() != highlightPaths.size()) {
          throw new IllegalArgumentException(
              "The highlight path size is different from the size of highlight paints");
        }
    ...
    if (this.mSpannedText) {
        ...
        spans =
            (ParagraphStyle[])
                getParagraphSpans(
                    sp,
                    start,
                    sp.nextSpanTransition(start, this.mText.length(), ParagraphStyle.class),
      ...
      while (true) {
        ...
        if (spans[n2] instanceof LeadingMarginSpan.LeadingMarginSpan2) {
          int count =
              ((LeadingMarginSpan.LeadingMarginSpan2) spans[n2]).getLeadingMarginLineCount();
    ...
    while (lineNum4 <= lastLine) {
      ...
      if (!layout3.mSpannedText) {
        ...
        if (start3 != 0) {
          ...
          if (buf3.charAt(previousLineEnd4) != '\n') {
            ...
            if (start3 >= spanEnd2 && (lineNum4 == i2 || isFirstParaLine)) {
              ...
              ParagraphStyle[] spans8 =
                  (ParagraphStyle[]) getParagraphSpans(sp2, start3, spanEnd3, ParagraphStyle.class);
              ...
              while (true) {
                ...
                if (!(spans4[n] instanceof LeadingMarginSpan.LeadingMarginSpan2)) {
                  ...
                  int count =
                      ((LeadingMarginSpan.LeadingMarginSpan2) spans4[n])
        ...
        if (start3 >= spanEnd2) {
          ...
          ParagraphStyle[] spans82 =
              (ParagraphStyle[]) getParagraphSpans(sp2, start3, spanEnd32, ParagraphStyle.class);
          paraAlign2 = layout3.mAlignment;
          n4 = spans82.length - 1;
          while (true) {
            if (n4 >= 0) {}
      ...
      if (directions != DIRS_ALL_LEFT_TO_RIGHT || layout.mSpannedText || hasTab || justify) {
        ...
        tl.set(
            ...
            hasTab,
            tabStops2,
            layout.getEllipsisStart(lineNum5),
            layout.getEllipsisStart(lineNum5) + layout.getEllipsisCount(lineNum5),
        ...
        tl2.draw(canvas, x2, dir2, lbaseline6, lbottom);
      } else {
        int lbaseline7 = start;
        spans2 = spans;
        canvas.drawText(buf, lbaseline7, end, x, lbaseline, paint);
        tabStops3 = tabStops2;
        lineNum2 = lineNum5;
        tl2 = tl;
      }
        ...
        while (i <= lastLine) {
          ...
          while (n < spanEnd2) {
            ...
            lineBackgroundSpan.drawBackground(
                canvas, paint, 0, spansLength4, ltop, lbaseline, lbottom, buffer, start2, end2, i2);
            n++;
  ...
  private float getHorizontal(int offset, boolean trailing, int line, boolean clamped) {
    ...
    if (hasTab) {
      ...
      if (charSequence instanceof Spanned) {
        TabStopSpan[] tabs =
            (TabStopSpan[])
                getParagraphSpans((Spanned) charSequence, start, end, TabStopSpan.class);
        if (tabs.length > 0) {
  ...
  */
  ...
  private void fillHorizontalBoundsForLine(int line, float[] horizontalBounds) {
    ...
    if (hasTab) {
      ...
      if (charSequence instanceof Spanned) {
        TabStopSpan[] tabs =
            (TabStopSpan[])
                getParagraphSpans((Spanned) charSequence, lineStart, lineEnd, TabStopSpan.class);
        if (tabs.length > 0) {
          TabStops tabStops2 = new TabStops(TAB_INCREMENT, tabs);
          tabStops = tabStops2;
          TextLine tl = TextLine.obtain();
  ...
  public float getLineLeft(int line) {
    ...
    switch (C35351.$SwitchMap$android$text$Layout$Alignment[align.ordinal()]) {
      case 1:
        if (dir != -1) {
  ...
  */
  ...
  public int getOffsetForHorizontal(int line, float horiz, boolean primary) {
    ...
    if (line == getLineCount() - 1) {
      ...
      tl = tl2;
      max =
          tl.getOffsetToLeftRightOf(max2, !layout.isRtlCharAt(lineEndOffset - 1)) + lineStartOffset;
    }
  ...
  */
  private int getStartOrEndOffsetForAreaWithinLine(
    ...
    while (true) {
      ...
      int runEndOffset =
          Math.min(
              runStartOffset + directions2.getRunLength(runIndex2),
              lineEndOffset2 - lineStartOffset2);
  ...
  */
  private static int getStartOffsetForAreaWithinRun(
      ...
      boolean z,
      SegmentFinder segmentFinder,
      TextInclusionStrategy textInclusionStrategy) {
    int i7;
    ...
    if (f2 >= rectF.left && f <= rectF.right) {
      ...
      int nextEndBoundary = segmentFinder.nextEndBoundary(i3 + i7);
      if (nextEndBoundary == -1
          || (previousStartBoundary = segmentFinder.previousStartBoundary(nextEndBoundary))
              >= i3 + i6) {
        return -1;
      }
      int max = Math.max(previousStartBoundary, i3 + i5);
      int min = Math.min(nextEndBoundary, i3 + i6);
      RectF rectF2 = new RectF(0.0f, i, 0.0f, i2);
      while (true) {
        float f4 = i4 + fArr[((max - i3) * 2) + (z ? 1 : 0)];
        if ((z || f4 <= rectF.right) && (!z || f4 >= rectF.left)) {
          float f5 = i4 + fArr[(((min - i3) - 1) * 2) + (!z ? 1 : 0)];
          rectF2.left = z ? f5 : f4;
          rectF2.right = z ? f4 : f5;
          ...
          min = Math.min(segmentFinder.nextEndBoundary(max), i3 + i6);
        }
      }
    }
    return -1;
  ...
  */
  private static int getEndOffsetForAreaWithinRun(
    ...
    if (f2 >= rectF.left && f <= rectF.right) {
      ...
      int previousStartBoundary = segmentFinder.previousStartBoundary(i3 + i7 + 1);
      if (previousStartBoundary == -1
          || (nextEndBoundary = segmentFinder.nextEndBoundary(previousStartBoundary)) <= i3 + i5) {
        return -1;
      }
      int max = Math.max(previousStartBoundary, i3 + i5);
      int min = Math.min(nextEndBoundary, i3 + i6);
      RectF rectF2 = new RectF(0.0f, i, 0.0f, i2);
      while (true) {
        float f4 = i4 + fArr[(((min - i3) - 1) * 2) + (!z ? 1 : 0)];
        if ((z || f4 >= rectF.left) && (!z || f4 <= rectF.right)) {
          float f5 = i4 + fArr[((max - i3) * 2) + (z ? 1 : 0)];
          rectF2.left = z ? f4 : f5;
          rectF2.right = z ? f5 : f4;
          if (textInclusionStrategy.isSegmentInside(rectF2, rectF)) {
            return min;
          }
          ...
          max = Math.max(segmentFinder.previousStartBoundary(min), i3 + i5);
        }
      }
      return -1;
    }
  ...
  private int getOffsetAtStartOf(int offset) {
    ...
    if (this.mSpannedText) {
      ReplacementSpan[] spans =
          (ReplacementSpan[]) ((Spanned) text).getSpans(offset, offset, ReplacementSpan.class);
  ...
  public boolean shouldClampCursor(int line) {
    switch (C35351.$SwitchMap$android$text$Layout$Alignment[
        getParagraphAlignment(line).ordinal()]) {
      case 1:
  ...
  private void addSelection(
      int line, int start, int end, int top, int bottom, SelectionRectangleConsumer consumer) {
    int layout;
    Layout layout2 = this;
    int i = line;
    int linestart = getLineStart(line);
  ...
  public final Alignment getParagraphAlignment(int line) {
    ...
    if (this.mSpannedText) {
      ...
      AlignmentSpan[] spans =
          (AlignmentSpan[])
              getParagraphSpans(sp, getLineStart(line), getLineEnd(line), AlignmentSpan.class);
  ...
  */
  private static float measurePara(
      TextPaint paint, CharSequence text, int start, int end, TextDirectionHeuristic textDir) {
    TextLine tl;
      ...
      try {
        ...
        if (!(text instanceof Spanned)) {
          ...
          try {
            LeadingMarginSpan[] spans =
                (LeadingMarginSpan[])
                    getParagraphSpans((Spanned) text, start, end, LeadingMarginSpan.class);
