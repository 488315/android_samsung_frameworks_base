...
public class StaticLayout extends Layout {
    ...
    */
    void generate(Builder b, boolean includepad, boolean trackpad) {
        ...
        LineBreaker lineBreaker4 = new LineBreaker.Builder().setBreakStrategy(b.mBreakStrategy).setHyphenationFrequency(getBaseHyphenationFrequency(b.mHyphenationFrequency)).setJustificationMode(b.mJustificationMode).setIndents(indents).build();
        ...
        if (!(source5 instanceof PrecomputedText)) {
            ...
            z = false;
            ellipsize = ellipsize5;
            int checkResult = precomputed.checkResultUsable(bufStart4, bufEnd3, textDir4, paint4, b.mBreakStrategy, b.mHyphenationFrequency, b.mLineBreakConfig);
            switch (checkResult) {
                case 1:
                    PrecomputedText.Params newParams = new PrecomputedText.Params.Builder(paint4).setBreakStrategy(b.mBreakStrategy).setHyphenationFrequency(b.mHyphenationFrequency).setTextDirection(textDir4).setLineBreakConfig(b.mLineBreakConfig).build();
        ...
        if (paragraphInfo3 != null) {
            ...
            PrecomputedText.Params param = new PrecomputedText.Params(paint4, b.mLineBreakConfig, textDir4, b.mBreakStrategy, b.mHyphenationFrequency);
            paragraphInfo = PrecomputedText.createMeasuredParagraphs(source5, param, bufStart4, bufEnd3, z);
        }
        int fmAscent = 0;
        ...
        while (true) {
            if (fmAscent < paragraphInfo.length) {
                ...
                if (spanned == null) {
                    ...
                    LeadingMarginSpan[] sp2 = (LeadingMarginSpan[]) getParagraphSpans(spanned, paraStart2, paraEnd3, LeadingMarginSpan.class);
                    paint2 = paint4;
                    int i4 = 0;
                    while (true) {
                        bufStart2 = bufStart4;
                        if (i4 < sp2.length) {
                            ...
                            if (lms instanceof LeadingMarginSpan.LeadingMarginSpan2) {
                                ...
                                firstWidthLineCount3 = Math.max(firstWidthLineCount3, lms2.getLeadingMarginLineCount());
                            }
                            i4++;
                            textDir4 = textDir5;
                            bufStart4 = bufStart2;
                            ...
                            source3 = source5;
                            textDir2 = textDir4;
                            LineHeightSpan[] chooseHt2 = (LineHeightSpan[]) getParagraphSpans(spanned, paraStart2, paraEnd3, LineHeightSpan.class);
                ...
                if (spanned == null) {
                    ...
                    TabStopSpan[] spans = (TabStopSpan[]) getParagraphSpans(spanned, paraStart2, paraEnd3, TabStopSpan.class);
                    if (spans.length <= 0) {
                        variableTabStops = null;
                    } else {
                        ...
                        while (true) {
                            ...
                            if (i6 < spans.length) {
                                ...
                                LineBreaker.Result res3 = lineBreaker5.computeLineBreaks(measuredText, constraints5, paraIndex2);
                                ...
                                while (i < breakCount) {
                                    ...
                                    hyphenEdits[i] = packHyphenEdit(res3.getStartLineHyphenEdit(i), res3.getEndLineHyphenEdit(i));
                                    i++;
                                        ...
                                        while (true) {
                                            if (breakIndex < breakCount2) {
                                                ...
                                                if (paraStart2 + breaks[breakIndex] > breakIndex3) {
                                                    ...
                                                    v2 = out(source3, here3, endPos, ascent, descent, fmDescent5, spanStart3, outerWidth4, spacingmult, spacingadd, chooseHt, chooseHtv, fm5, hasTabs[breakIndex], hyphenEdits[breakIndex], needMultiply, measuredPara2, bufEnd4, includepad, trackpad, addLastLineSpacing, chs, paraStart3, ellipsize6, elipsizeWidth_span, lineWidths[breakIndex], paint5, moreChars);
                                                    if (endPos < spanEnd2) {
                                                        fm4 = fm5;
                                                        fmTop3 = fm4.top;
                                                        fmBottom2 = fm4.bottom;
                ...
                LineBreaker.Result res32 = lineBreaker52.computeLineBreaks(measuredText2, constraints52, paraIndex22);
        ...
        if (staticLayout.mLineCount < staticLayout.mMaximumVisibleLineCount) {
            MeasuredParagraph measuredPara4 = MeasuredParagraph.buildForBidi(source2, bufEnd, bufEnd, textDir, null);
            TextPaint paint6 = paint;
            paint6.getFontMetricsInt(fm2);
            out(source2, bufEnd, bufEnd, fm2.ascent, fm2.descent, fm2.top, fm2.bottom, fmDescent, spacingmult, spacingadd, null, null, fm2, false, 0, needMultiply, measuredPara4, bufEnd, includepad, trackpad, addLastLineSpacing, null, bufStart7, ellipsize2, ellipsizedWidth2, 0.0f, paint6, false);
        }
    }
    ...
    public int getHeight(boolean cap) {
        ...
        if (cap && this.mLineCount > this.mMaximumVisibleLineCount && this.mMaxLineHeight == -1 && Log.isLoggable(TAG, 5)) {
            Log.m102w(TAG, "maxLineHeight should not be -1.  maxLines:" + this.mMaximumVisibleLineCount + " lineCount:" + this.mLineCount);
        }
