...
public final class MessageQueue {
  ...
  private void updateOnFileDescriptorEventListenerLocked(
    ...
    if (sparseArray != null
        && (index = sparseArray.indexOfKey(fdNum)) >= 0
  ...
  */
  /* JADX WARN: Code restructure failed: missing block: B:62:0x00a6, code lost:
     ...
     android.util.Log.wtf(android.p009os.MessageQueue.TAG, "IdleHandler threw exception", r8);
  */
    ...
    while (true) {
      ...
      synchronized (this) {
        ...
        if (pendingIdleHandlerCount < 0
            && ((message = this.mMessages) == null || now < message.when)) {
        ...
        if (pendingIdleHandlerCount <= 0) {
          ...
          this.mPendingIdleHandlers =
              (IdleHandler[]) this.mIdleHandlers.toArray(this.mPendingIdleHandlers);
        }
      }
    }
    if (!keep) {
    ...
    synchronized (this) {
      ...
      if (p == null) {
        throw new IllegalStateException(
            "The specified message queue synchronization  barrier token has not been posted or has"
    ...
    synchronized (this) {
      ...
      while (p != null) {
        ...
        if (n2 != null
            && n2.target == h
            && n2.what == what
            && (object == null || object.equals(n2.obj))) {
          Message nn = n2.next;
          n2.recycleUnchecked();
          p.next = nn;
        } else {
