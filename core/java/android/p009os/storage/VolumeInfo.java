...
public class VolumeInfo implements Parcelable {
    ...
    static {
        ...
        sStateToDescrip.put(9, C4337R.string.ext_media_status_mounted);
        sStateToDescrip.put(10, C4337R.string.ext_media_status_mounted);
        sStateToDescrip.put(0, C4337R.string.ext_media_status_unmounted);
        sStateToDescrip.put(1, C4337R.string.ext_media_status_checking);
        sStateToDescrip.put(2, C4337R.string.ext_media_status_mounted);
        sStateToDescrip.put(3, C4337R.string.ext_media_status_mounted_ro);
        sStateToDescrip.put(4, C4337R.string.ext_media_status_formatting);
        sStateToDescrip.put(5, C4337R.string.ext_media_status_ejecting);
        sStateToDescrip.put(6, C4337R.string.ext_media_status_unmountable);
        sStateToDescrip.put(7, C4337R.string.ext_media_status_removed);
        sStateToDescrip.put(8, C4337R.string.ext_media_status_bad_removal);
    ...
    public VolumeInfo(String id, int type, DiskInfo disk, String partGuid) {
        ...
        this.state = 0;
        this.f345id = (String) Preconditions.checkNotNull(id);
        this.type = type;
        this.disk = disk;
    ...
    public VolumeInfo(Parcel parcel) {
        ...
        this.mountUserId = -10000;
        this.state = 0;
        this.f345id = parcel.readString8();
    ...
    public String getDescription() {
        if (ID_PRIVATE_INTERNAL.equals(this.f345id) || this.f345id.startsWith("emulated;")) {
            return Resources.getSystem().getString(C4337R.string.storage_internal);
        }
    ...
    public boolean isPrimaryEmulatedForUser(int userId) {
        return this.f345id.equals("emulated;" + userId);
    }
    ...
    public StorageVolume buildStorageVolume(Context context, int userId, boolean reportUnmounted) {
        ...
        return new StorageVolume(this.f345id, userPath, internalPath, description, isPrimary(), removable, emulated, externallyManaged, false, maxFileSize, new UserHandle(userId), uuid, derivedFsUuid, envState, mtpStorageId2, diskType, bAsec);
    }
    ...
    public void dump(IndentingPrintWriter pw) {
        pw.println("VolumeInfo{" + this.f345id + "}:");
        pw.increaseIndent();
    ...
    public boolean equals(Object o) {
        if (o instanceof VolumeInfo) {
            return Objects.equals(this.f345id, ((VolumeInfo) o).f345id);
        }
        return false;
    }

    public int hashCode() {
        return this.f345id.hashCode();
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        parcel.writeString8(this.f345id);
