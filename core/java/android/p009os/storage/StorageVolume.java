...
public final class StorageVolume implements Parcelable {
  ...
  public static final Parcelable.Creator<StorageVolume> CREATOR =
      new Parcelable.Creator<StorageVolume>() { // from class: android.os.storage.StorageVolume.1
  ...
  public int getFatVolumeId() {
    ...
    try {
      return (int)
          Long.parseLong(this.mFsUuid.replace(NativeLibraryHelper.CLEAR_ABI_OVERRIDE, ""), 16);
