...
public interface IStorageManager extends IInterface {
  ...
  public static class Default implements IStorageManager {
    @Override // android.p009os.storage.IStorageManager
    ...
    public void mountObb(
        String rawPath, String canonicalPath, IObbActionListener token, int nonce, ObbInfo obbInfo)
        throws RemoteException {}
  ...
  public abstract static class Stub extends Binder implements IStorageManager {
        ...
        default:
          switch (code) {
            ...
            case 203:
              ...
              data.enforceNoDataAvail();
              int _result35 =
                  createSecureContainer(_arg063, _arg138, _arg217, _arg39, _arg42, _arg5);
              reply.writeNoException();
    ...
    protected void runMaintenance_enforcePermission() throws SecurityException {
      this.mEnforcer.enforcePermission(
          Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS, getCallingPid(), getCallingUid());
    }
