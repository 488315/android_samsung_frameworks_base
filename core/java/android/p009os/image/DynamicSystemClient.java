...
public class DynamicSystemClient {
  ...
  private class DynSystemServiceConnection implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName className, IBinder service) {
      Slog.m119v(DynamicSystemClient.TAG, "onServiceConnected: " + className);
      ...
      try {
        ...
        Slog.m115e(DynamicSystemClient.TAG, "Unable to get status from installation service");
    ...
    public void onServiceDisconnected(ComponentName className) {
      Slog.m119v(DynamicSystemClient.TAG, "onServiceDisconnected: " + className);
  ...
  public void unbind() {
    ...
    if (this.mService != null) {
      try {
        ...
        Slog.m115e(TAG, "Unable to unregister from installation service");
      }
    }
    ...
    switch (msg.what) {
      case 3:
        ...
        ParcelableException t =
            (ParcelableException)
                bundle.getSerializable(KEY_EXCEPTION_DETAIL, ParcelableException.class);
