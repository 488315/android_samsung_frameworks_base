...
import com.android.internal.p029os.BinderCallHeavyHitterWatcher;
...
public class Binder implements IBinder {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:29:0x0078, code lost:
        ...
        r8 = android.p009os.Binder.sWorkSourceProvider.resolveWorkSourceUid(r18.readCallingWorkSourceUid());
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x00cc, code lost:
        ...
        android.p009os.StrictMode.clearGatheredViolations();
     */
    ...
    */
    ...
    public static synchronized void setHeavyHitterWatcherConfig(boolean enabled, int batchSize, float threshold, BinderCallHeavyHitterWatcher.BinderCallHeavyHitterListener listener) {
        synchronized (Binder.class) {
            Slog.m117i(TAG, "Setting heavy hitter watcher config: " + enabled + ", " + batchSize + ", " + threshold);
