...
import android.p009os.IThermalStatusListener;
import android.p009os.IWakeLockCallback;
...
public final class PowerManager {
    ...
    public int getMinimumScreenBrightnessSetting() {
        return this.mContext.getResources().getInteger(C4337R.integer.config_screenBrightnessSettingMinimum);
    }

    public int getMaximumScreenBrightnessSetting() {
        return this.mContext.getResources().getInteger(C4337R.integer.config_screenBrightnessSettingMaximum);
    }
    ...
    public int getDefaultScreenBrightnessSetting() {
        return this.mContext.getResources().getInteger(C4337R.integer.config_screenBrightnessSettingDefault);
    }

    public int getMaximumScreenBrightnessExtended() {
        return this.mContext.getResources().getInteger(C4337R.integer.config_screenBrightnessExtendedMaximum);
    }
    ...
    public boolean semIsSubAutoBrightnessSupported() {
        return this.mContext.getResources().getBoolean(C4337R.bool.config_cover_automatic_brightness_available);
    }
    ...
    public boolean isSustainedPerformanceModeSupported() {
        return this.mContext.getResources().getBoolean(C4337R.bool.config_sustainedPerformanceModeSupported);
    }
    ...
    public void addThermalStatusListener(Executor executor, OnThermalStatusChangedListener listener) {
        ...
        IThermalStatusListener internalListener = new IThermalStatusListenerStubC23533(executor, listener);
        try {
    ...
    class IThermalStatusListenerStubC23533 extends IThermalStatusListener.Stub {
        ...
        IThermalStatusListenerStubC23533(Executor executor, OnThermalStatusChangedListener onThermalStatusChangedListener) {
