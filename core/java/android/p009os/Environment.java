...
public class Environment {
  ...
  static {
    ...
    STANDARD_DIRECTORIES =
        new String[] {
          ...
          "Ringtones",
          "Alarms",
          SemPersonaManager.NOTIFICATIONS,
          "Pictures",
          "Movies",
          "Download",
          "DCIM",
  ...
  private static void addCanonicalFile(List<File> list, File file) {
    try {
      ...
      Log.m102w(TAG, "Failed to resolve " + file + ": " + e);
      list.add(file);
    }
  }
  ...
  public static boolean isExternalStorageLegacy(File path) {
    ...
    try {
      PackageManager.Property noAppStorageProp =
          packageManager.getProperty(PackageManager.PROPERTY_NO_APP_DATA_STORAGE, packageName);
