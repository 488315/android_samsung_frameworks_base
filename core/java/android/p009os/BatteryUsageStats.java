...
import com.android.internal.p029os.BatteryStatsHistory;
...
public final class BatteryUsageStats implements Parcelable, Closeable {
  ...
  public static final Parcelable.Creator<BatteryUsageStats> CREATOR =
      new Parcelable.Creator<BatteryUsageStats>() { // from class: android.os.BatteryUsageStats.1
  ...
  private BatteryUsageStats(Builder builder) {
    ...
    for (int i2 = 0; i2 < userBatteryConsumerCount; i2++) {
      UserBatteryConsumer consumer2 =
          ((UserBatteryConsumer.Builder) builder.mUserBatteryConsumerBuilders.valueAt(i2)).build();
  ...
  private BatteryUsageStats(Parcel source) {
    ...
    BatteryConsumer.BatteryConsumerDataLayout dataLayout =
        BatteryConsumer.createBatteryConsumerDataLayout(readStringArray, readBoolean, readBoolean2);
    ...
    for (int i = 0; i < numRows; i++) {
      BatteryConsumer.BatteryConsumerData data =
          new BatteryConsumer.BatteryConsumerData(
              this.mBatteryConsumersCursorWindow, i, dataLayout);
      ...
      while (i4 < length) {
        ...
        if (devicePowerMah == SContextConstants.ENVIRONMENT_VALUE_UNKNOWN
          ...
          printPowerComponent(
              ...
              devicePowerMah,
              appsPowerMah,
              deviceConsumer2.getPowerModel(key),
              deviceConsumer2.getUsageDurationMillis(key));
        }
        i4 = i + 1;
    ...
    while (true) {
      ...
      if (eventType == 2 && parser.getName().equals(XML_TAG_BATTERY_USAGE_STATS)) {
        ...
        boolean includesProcStateData =
            parser.getAttributeBoolean(null, XML_ATTR_PREFIX_INCLUDES_PROC_STATE_DATA, false);
        builder =
            new Builder(
  ...
  public static final class Builder {
    ...
    public Builder(
      ...
      CursorWindow cursorWindow =
          new CursorWindow((String) null, BatteryUsageStats.BATTERY_CONSUMER_CURSOR_WINDOW_SIZE);
      this.mBatteryConsumersCursorWindow = cursorWindow;
      BatteryConsumer.BatteryConsumerDataLayout createBatteryConsumerDataLayout =
      ...
      for (int scope = 0; scope < 2; scope++) {
        BatteryConsumer.BatteryConsumerData data =
            BatteryConsumer.BatteryConsumerData.create(
                this.mBatteryConsumersCursorWindow, this.mBatteryConsumerDataLayout);
