...
public interface IIncidentManager extends IInterface {
  ...
  void reportIncidentToDumpstate(
      FileDescriptor fileDescriptor, IIncidentReportStatusListener iIncidentReportStatusListener)
      throws RemoteException;
  ...
  public static class Default implements IIncidentManager {
    @Override // android.p009os.IIncidentManager
    public void reportIncident(IncidentReportArgs args) throws RemoteException {}

    @Override // android.p009os.IIncidentManager
    public void reportIncidentToStream(
        IncidentReportArgs args, IIncidentReportStatusListener listener, FileDescriptor stream)
        throws RemoteException {}

    @Override // android.p009os.IIncidentManager
    public void reportIncidentToDumpstate(
        FileDescriptor stream, IIncidentReportStatusListener listener) throws RemoteException {}
