...
import android.p009os.strictmode.CleartextNetworkViolation;
import android.p009os.strictmode.ContentUriWithoutPermissionViolation;
import android.p009os.strictmode.CredentialProtectedWhileLockedViolation;
import android.p009os.strictmode.CustomViolation;
import android.p009os.strictmode.DiskReadViolation;
import android.p009os.strictmode.DiskWriteViolation;
import android.p009os.strictmode.ExplicitGcViolation;
import android.p009os.strictmode.FileUriExposedViolation;
import android.p009os.strictmode.ImplicitDirectBootViolation;
import android.p009os.strictmode.IncorrectContextUseViolation;
import android.p009os.strictmode.InstanceCountViolation;
import android.p009os.strictmode.IntentReceiverLeakedViolation;
import android.p009os.strictmode.LeakedClosableViolation;
import android.p009os.strictmode.NetworkViolation;
import android.p009os.strictmode.NonSdkApiUsedViolation;
import android.p009os.strictmode.ResourceMismatchViolation;
import android.p009os.strictmode.ServiceConnectionLeakedViolation;
import android.p009os.strictmode.SqliteObjectLeakedViolation;
import android.p009os.strictmode.UnbufferedIoViolation;
import android.p009os.strictmode.UnsafeIntentLaunchViolation;
import android.p009os.strictmode.UntaggedSocketViolation;
import android.p009os.strictmode.Violation;
import android.p009os.strictmode.WebViewMethodCalledOnWrongThreadViolation;
...
public final class StrictMode {
  ...
  static {
    ViolationLogger violationLogger =
        new ViolationLogger() { // from class: android.os.StrictMode$$ExternalSyntheticLambda1
    ...
    sNonSdkApiUsageConsumer =
        new Consumer() { // from class: android.os.StrictMode$$ExternalSyntheticLambda2
    ...
    VM_ANDROID_POLICY =
        new BlockGuard.VmPolicy() { // from class: android.os.StrictMode.5
    ...
    sProcessIdleHandler =
        new MessageQueue.IdleHandler() { // from class: android.os.StrictMode.6
    ...
    NO_OP_SPAN =
        new Span() { // from class: android.os.StrictMode.7
  ...
  static /* synthetic */ void lambda$static$0(ViolationInfo info) {
    ...
    Log.m94d(TAG, msg + " " + info.getStackTrace());
  }
  ...
  public static final class VmPolicy {
    public static final VmPolicy LAX =
        new VmPolicy(0, StrictMode.EMPTY_CLASS_LIMIT_MAP, null, null);
    ...
    public static final class Builder {
      ...
      public Builder setClassInstanceLimit(Class klass, int instanceLimit) {
        ...
        if (this.mClassInstanceLimitNeedCow) {
          if (this.mClassInstanceLimit.containsKey(klass)
              && this.mClassInstanceLimit.get(klass).intValue() == instanceLimit) {
            return this;
          }
          this.mClassInstanceLimitNeedCow = false;
  ...
  public static ThreadPolicy getThreadPolicy() {
    return new ThreadPolicy(
        getThreadPolicyMask(), sThreadViolationListener.get(), sThreadViolationExecutor.get());
  }
  ...
  public static ThreadPolicy allowThreadDiskReads() {
    return new ThreadPolicy(
        allowThreadDiskReadsMask(), sThreadViolationListener.get(), sThreadViolationExecutor.get());
  }
  ...
  public static boolean isBundledSystemApp(ApplicationInfo ai) {
    ...
    if (!ai.isSystemApp()
        || ai.packageName.equals("com.android.vending")
        || ai.packageName.equals("com.android.chrome")
        || ai.packageName.equals("com.android.phone")) {
      return false;
    }
    return ai.packageName.equals("android")
  ...
  static class AndroidBlockGuardPolicy implements BlockGuard.Policy {
    ...
    void handleViolationWithTimingAttempt(ViolationInfo info) {
      ...
      final IWindowManager windowManager =
          info.penaltyEnabled(134217728) ? (IWindowManager) StrictMode.sWindowManager.get() : null;
      ...
      ((Handler) StrictMode.THREAD_HANDLER.get())
          .postAtFrontOfQueue(
              new Runnable() { // from class:
                               // android.os.StrictMode$AndroidBlockGuardPolicy$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                  StrictMode.AndroidBlockGuardPolicy.this.lambda$handleViolationWithTimingAttempt$0(
                      windowManager, records);
                }
              });
    }
    ...
    void onThreadPolicyViolation(ViolationInfo info) {
      ...
      if (StrictMode.LOG_V) {
        Log.m94d(StrictMode.TAG, "onThreadPolicyViolation; penalty=" + info.mPenaltyMask);
      }
      boolean z = true;
      ...
      if (StrictMode.sLogger == StrictMode.LOGCAT_LOGGER) {
        ...
        if (sparseLongArray != null) {
          ...
          StrictMode.clampViolationTimeMap(
              this.mRealLastViolationTime, Math.max(1000L, Math.max(30000L, 3000L)));
      ...
      final OnThreadViolationListener listener =
          (OnThreadViolationListener) StrictMode.sThreadViolationListener.get();
        ...
        try {
          executor.execute(
              new Runnable() { // from class:
                ...
                @Override // java.lang.Runnable
                public final void run() {
                  StrictMode.AndroidBlockGuardPolicy.lambda$onThreadPolicyViolation$1(
                      StrictMode.OnThreadViolationListener.this, violation);
                }
              });
        } catch (RejectedExecutionException e) {
          Log.m97e(StrictMode.TAG, "ThreadPolicy penaltyCallback failed", e);
        }
      }
    }

    static /* synthetic */ void lambda$onThreadPolicyViolation$1(
        OnThreadViolationListener listener, Violation violation) {
  ...
  public static void dropboxViolationAsync(final int penaltyMask, final ViolationInfo info) {
    ...
    if (LOG_V) {
      Log.m94d(TAG, "Dropboxing async; in-flight=" + outstanding);
    }
    BackgroundThread.getHandler()
        .post(
            new Runnable() { // from class: android.os.StrictMode$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
  ...
  static /* synthetic */ void lambda$dropboxViolationAsync$2(int penaltyMask, ViolationInfo info) {
    ...
    if (LOG_V) {
      Log.m94d(TAG, "Dropbox complete; in-flight=" + outstandingInner);
    }
  }
  ...
  public static void handleApplicationStrictModeViolation(int penaltyMask, ViolationInfo info) {
    ...
    try {
      try {
        ...
        if (am == null) {
          Log.m102w(TAG, "No activity manager; failed to Dropbox violation.");
        } else {
        ...
        if (!(e instanceof DeadObjectException)) {
          Log.m97e(TAG, "RemoteException handling StrictMode violation", e);
        }
      }
    } finally {
  ...
  public static void setVmPolicy(VmPolicy policy) {
    synchronized (StrictMode.class) {
      ...
      if (netd != null) {
        ...
        Log.m102w(TAG, "Dropping requested network policy due to missing service!");
      }
  ...
  public static void onCleartextNetworkDetected(byte[] firstPacket) {
    ...
    StringBuilder msg =
        new StringBuilder("Detected cleartext network traffic from UID ").append(uid);
    if (rawAddr != null) {
      try {
    ...
    if (vmIncorrectContextUseEnabled() && !context.isConfigurationContext()) {
      String errorMessage =
          "Tried to access the API:"
              + methodName
              + " which needs to have proper configuration from a non-UI Context:"
              + context;
      String message =
          "The API:"
              + methodName
              + " needs a proper configuration. Use UI contexts such as an activity or a context"
              + " created via createWindowContext(Display, int, Bundle) or "
      ...
      Log.m97e(TAG, errorMessage + " " + message, exception);
    }
  }
  ...
  public static void assertUiContext(Context context, String methodName) {
    if (vmIncorrectContextUseEnabled() && !context.isUiContext()) {
      String errorMessage =
          "Tried to access UI related API:" + methodName + " from a non-UI Context:" + context;
      String message =
          methodName
              + " should be accessed from Activity or other UI Contexts. Use an Activity or a"
              + " Context created with Context#createWindowContext(int, Bundle), which are adjusted"
              + " to the configuration and visual bounds of an area on screen.";
      Exception exception = new IllegalAccessException(errorMessage);
      onIncorrectContextUsed(message, exception);
      Log.m97e(TAG, errorMessage + " " + message, exception);
    }
  ...
  public static void onCredentialProtectedPathAccess(String path, int userId) {
    ...
    onVmPolicyViolation(
        new CredentialProtectedWhileLockedViolation(
            "Accessed credential protected path "
                + path
                + " while user "
                + userId
                + " was locked"));
    ...
    if (sVmPolicy.mListener != null && sVmPolicy.mCallbackExecutor != null) {
      ...
      try {
        sVmPolicy.mCallbackExecutor.execute(
            new Runnable() { // from class: android.os.StrictMode$$ExternalSyntheticLambda3
              @Override // java.lang.Runnable
              public final void run() {
                StrictMode.lambda$onVmPolicyViolation$3(
                    StrictMode.OnVmViolationListener.this, violation);
              }
            });
      } catch (RejectedExecutionException e) {
        Log.m97e(TAG, "VmPolicy penaltyCallback failed", e);
      }
    }
  }

  static /* synthetic */ void lambda$onVmPolicyViolation$3(
      OnVmViolationListener listener, Violation violation) {
  ...
  public static class Span {
    ...
    public void finish() {
      ...
      synchronized (state) {
        ...
        state.mActiveSize--;
        if (StrictMode.LOG_V) {
          Log.m94d(StrictMode.TAG, "Span finished=" + this.mName + "; size=" + state.mActiveSize);
        }
  ...
  public static Span enterCriticalSpan(String name) {
    ...
    synchronized (state) {
      ...
      if (LOG_V) {
        Log.m94d(TAG, "Span enter=" + name + "; size=" + state.mActiveSize);
      }
    }
    return span;
  }
  ...
  public static void incrementExpectedActivityCount(Class klass) {
    ...
    synchronized (StrictMode.class) {
      ...
      Integer newExpected =
          Integer.valueOf(
              expected == null
                  ? InstanceTracker.getInstanceCount(klass) + 1
                  : expected.intValue() + 1);
  ...
  */
  ...
  public static final class ViolationInfo implements Parcelable {
    ...
    ViolationInfo(Violation tr, int penaltyMask) {
      ...
      synchronized (state) {
        ...
        if (spanActiveCount != 0) {
          ...
          int index = 0;
          for (Span iter = state.mActiveHead;
    ...
    public ViolationInfo(Parcel in, boolean unsetGatheringBit) {
      ...
      this.numInstances = -1L;
      this.mViolation =
          (Violation) in.readSerializable(Violation.class.getClassLoader(), Violation.class);
