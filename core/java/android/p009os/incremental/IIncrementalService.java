...
public interface IIncrementalService extends IInterface {
  ...
  int makeFile(
      int i, String str, int i2, IncrementalNewFileParams incrementalNewFileParams, byte[] bArr)
      throws RemoteException;
  ...
  public static class Default implements IIncrementalService {
    @Override // android.p009os.incremental.IIncrementalService
    ...
    @Override // android.p009os.incremental.IIncrementalService
    public int makeBindMount(int storageId, String sourcePath, String targetFullPath, int bindType)
        throws RemoteException {
      return 0;
    }
    ...
    @Override // android.p009os.incremental.IIncrementalService
    public int makeFile(
        int storageId, String path, int mode, IncrementalNewFileParams params, byte[] content)
        throws RemoteException {
      return 0;
    }
    ...
    @Override // android.p009os.incremental.IIncrementalService
    public int makeLink(int sourceStorageId, String sourcePath, int destStorageId, String destPath)
        throws RemoteException {
      return 0;
    }
          ...
          switch (code) {
            ...
            case 2:
              ...
              DataLoaderParamsParcel _arg1 =
                  (DataLoaderParamsParcel) data.readTypedObject(DataLoaderParamsParcel.CREATOR);
            ...
            case 4:
              ...
              StorageHealthCheckParams _arg3 =
                  (StorageHealthCheckParams) data.readTypedObject(StorageHealthCheckParams.CREATOR);
              IStorageHealthListener _arg4 =
                  IStorageHealthListener.Stub.asInterface(data.readStrongBinder());
              PerUidReadTimeouts[] _arg5 =
                  (PerUidReadTimeouts[]) data.createTypedArray(PerUidReadTimeouts.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 10:
              ...
              IncrementalNewFileParams _arg33 =
                  (IncrementalNewFileParams) data.readTypedObject(IncrementalNewFileParams.CREATOR);
            ...
            case 23:
              ...
              IStorageLoadingProgressListener _arg116 =
                  IStorageLoadingProgressListener.Stub.asInterface(data.readStrongBinder());
              data.enforceNoDataAvail();
