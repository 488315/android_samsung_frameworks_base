...
public final class IncrementalManager {
  ...
  private void linkFiles(
    ...
    Files.walkFileTree(
        ...
        new SimpleFileVisitor<Path>() { // from class: android.os.incremental.IncrementalManager.1
  ...
  public void rmPackageDir(File codeFile) {
    try {
      ...
      Slog.m122w(TAG, "Failed to remove code path", e);
    }
  }
  ...
  private static class LoadingProgressCallbacks extends IStorageLoadingProgressListener.Stub {
    ...
    @Override // android.p009os.incremental.IStorageLoadingProgressListener
