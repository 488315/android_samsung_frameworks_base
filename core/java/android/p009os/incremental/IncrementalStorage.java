...
public final class IncrementalStorage {
  ...
  public void makeFileFromRange(String destPath, String sourcePath, long rangeStart, long rangeEnd)
      throws IOException {
    try {
      int res =
          this.mService.makeFileFromRange(this.mId, destPath, sourcePath, rangeStart, rangeEnd);
      if (res < 0) {
