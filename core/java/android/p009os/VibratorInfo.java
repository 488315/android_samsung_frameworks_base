...
public class VibratorInfo implements Parcelable {
  ...
  public VibratorInfo(
    ...
    this.mSupportedEffects = supportedEffects == null ? null : supportedEffects.m5441clone();
    this.mSupportedBraking = supportedBraking != null ? supportedBraking.m5441clone() : null;
    this.mSupportedPrimitives = supportedPrimitives.m5443clone();
  ...
  public boolean equals(Object o) {
    ...
    for (int i = 0; i < supportedPrimitivesCount; i++) {
      if (this.mSupportedPrimitives.keyAt(i) != that.mSupportedPrimitives.keyAt(i)
          || this.mSupportedPrimitives.valueAt(i) != that.mSupportedPrimitives.valueAt(i)) {
        return false;
      }
    }
    int i2 = this.mId;
  ...
  public SparseBooleanArray getSupportedBraking() {
    ...
    return sparseBooleanArray.m5441clone();
  }
  ...
  public SparseIntArray getSupportedPrimitives() {
    return this.mSupportedPrimitives.m5443clone();
  }
  ...
  private String[] getSupportedPrimitivesNames() {
    ...
    for (int i = 0; i < supportedPrimitivesCount; i++) {
      names[i] =
          VibrationEffect.Composition.primitiveToString(this.mSupportedPrimitives.keyAt(i))
  ...
  public static final class FrequencyProfile implements Parcelable {
    public static final Parcelable.Creator<FrequencyProfile> CREATOR =
        new Parcelable.Creator<
            FrequencyProfile>() { // from class: android.os.VibratorInfo.FrequencyProfile.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
    ...
    public FrequencyProfile(
      ...
      this.mFrequencyRangeHz =
          z & isValid
              ? Range.create(Float.valueOf(minFrequencyHz), Float.valueOf(maxFrequencyHz))
              : null;
    }
    ...
    public float getMaxAmplitude(float frequencyHz) {
      if (isEmpty()
          ...
          || !this.mFrequencyRangeHz.contains((Range<Float>) Float.valueOf(frequencyHz))) {
        return 0.0f;
      }
