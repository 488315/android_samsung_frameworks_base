...
public class VibrationConfig {
    ...
    public VibrationConfig(Resources resources) {
        this.mHapticChannelMaxVibrationAmplitude = loadFloat(resources, C4337R.dimen.config_hapticChannelMaxVibrationAmplitude, 0.0f);
        this.mRampDownDurationMs = loadInteger(resources, C4337R.integer.config_vibrationWaveformRampDownDuration, 0);
        this.mRampStepDurationMs = loadInteger(resources, C4337R.integer.config_vibrationWaveformRampStepDuration, 0);
        this.mDefaultAlarmVibrationIntensity = loadDefaultIntensity(resources, C4337R.integer.config_defaultAlarmVibrationIntensity);
        this.mDefaultHapticFeedbackIntensity = loadDefaultIntensity(resources, C4337R.integer.config_defaultHapticFeedbackIntensity);
        this.mDefaultMediaVibrationIntensity = loadDefaultIntensity(resources, C4337R.integer.config_defaultMediaVibrationIntensity);
        this.mDefaultNotificationVibrationIntensity = loadDefaultIntensity(resources, C4337R.integer.config_defaultNotificationVibrationIntensity);
        this.mDefaultRingVibrationIntensity = loadDefaultIntensity(resources, C4337R.integer.config_defaultRingVibrationIntensity);
    }
