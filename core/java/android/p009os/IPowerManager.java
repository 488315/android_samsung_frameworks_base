...
public interface IPowerManager extends IInterface {
  ...
  public static class Default implements IPowerManager {
    @Override // android.p009os.IPowerManager
    ...
    @Override // android.p009os.IPowerManager
    public void setBatteryDischargePrediction(ParcelDuration timeRemaining, boolean isCustomized)
        throws RemoteException {}
    ...
    public void acquireWakeLockAsync(
        IBinder lock, int flags, String tag, String packageName, WorkSource ws, String historyTag)
        throws RemoteException {}
        ...
        default:
          switch (code) {
            ...
            case 24:
              ...
              return true;
            case 25:
              BatterySaverPolicyConfig _arg021 =
                  (BatterySaverPolicyConfig) data.readTypedObject(BatterySaverPolicyConfig.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 26:
              ...
              return true;
            case 27:
              BatterySaverPolicyConfig _arg023 =
                  (BatterySaverPolicyConfig) data.readTypedObject(BatterySaverPolicyConfig.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 39:
              ...
              return true;
            case 40:
              LowPowerStandbyPolicy _arg029 =
                  (LowPowerStandbyPolicy) data.readTypedObject(LowPowerStandbyPolicy.CREATOR);
              data.enforceNoDataAvail();
      ...
      public BatterySaverPolicyConfig getFullPowerSavePolicy() throws RemoteException {
        ...
        try {
          ...
          BatterySaverPolicyConfig _result =
              (BatterySaverPolicyConfig) _reply.readTypedObject(BatterySaverPolicyConfig.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public LowPowerStandbyPolicy getLowPowerStandbyPolicy() throws RemoteException {
        ...
        try {
          ...
          LowPowerStandbyPolicy _result =
              (LowPowerStandbyPolicy) _reply.readTypedObject(LowPowerStandbyPolicy.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
