...
public abstract class CombinedVibration implements Parcelable {
  public static final Parcelable.Creator<CombinedVibration> CREATOR =
      new Parcelable.Creator<CombinedVibration>() { // from class: android.os.CombinedVibration.1
  ...
  public static final class SequentialCombination {
    ...
    public SequentialCombination addNext(int vibratorId, VibrationEffect effect, int delay) {
      return addNext(
          CombinedVibration.startParallel().addVibrator(vibratorId, effect).combine(), delay);
    }
    ...
    public SequentialCombination addNext(CombinedVibration effect, int delay) {
      if (effect instanceof Sequential) {
        ...
        arrayList.set(
            firstEffectIndex, Integer.valueOf(arrayList.get(firstEffectIndex).intValue() + delay));
      } else {
  ...
  public static final class Mono extends CombinedVibration {
    ...
    @Override // android.p009os.CombinedVibration
    ...
    @Override // android.p009os.CombinedVibration, android.p009os.Parcelable
    public int describeContents() {
      return 0;
    }
  ...
  public static final class Stereo extends CombinedVibration {
    public static final Parcelable.Creator<Stereo> CREATOR =
        new Parcelable.Creator<Stereo>() { // from class: android.os.CombinedVibration.Stereo.1
          /* JADX WARN: Can't rename method to resolve collision */
          @Override // android.os.Parcelable.Creator
