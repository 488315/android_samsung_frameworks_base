...
public interface ISpqrService extends IInterface {
  ...
  boolean createInvariantProfile(
      String str, String str2, int i, int i2, String str3, String str4, String str5, String str6)
      throws RemoteException;

  public static class Default implements ISpqrService {
    @Override // android.p009os.ISpqrService
        ...
        default:
          switch (code) {
            case 1:
              ...
              boolean _result =
                  createInvariantProfile(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
