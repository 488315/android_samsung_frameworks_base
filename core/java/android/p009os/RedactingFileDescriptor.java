...
public class RedactingFileDescriptor {
  ...
  private RedactingFileDescriptor(
    ...
    ProxyFileDescriptorCallback proxyFileDescriptorCallback =
        new ProxyFileDescriptorCallback() { // from class: android.os.RedactingFileDescriptor.1
          @Override // android.p009os.ProxyFileDescriptorCallback
          ...
          public int onRead(long offset, int size, byte[] data) throws ErrnoException {
            int res;
            ProxyFileDescriptorCallbackC23631 proxyFileDescriptorCallbackC23631 = this;
            long j = offset;
            int n = 0;
            while (n < size) {
              try {
            ...
            while (i < ranges.length) {
              ...
              while (i2 < length) {
                ...
                while (j3 < redactFreeEnd) {
                  data[(int) (j3 - j)] =
                      (byte) SemSdCardEncryption.STATUS_FREE.charAt((int) (j3 - freeOffset));
                  j3++;
                  j = offset;
                  freeEnd = freeEnd;
                }
              ...
              i += 2;
              proxyFileDescriptorCallbackC23631 = this;
              j = offset;
            }
            return n;
          }
          ...
          public int onWrite(long offset, int size, byte[] data) throws ErrnoException {
            ...
            redactingFileDescriptor.mRedactRanges =
                RedactingFileDescriptor.removeRange(
                    redactingFileDescriptor.mRedactRanges, offset, n + offset);
            return n;
          }
          ...
          public void onRelease() {
            Slog.m119v(RedactingFileDescriptor.TAG, "onRelease()");
      ...
      try {
        ...
        this.mOuter =
            ((StorageManager) context.getSystemService(StorageManager.class))
                .openProxyFileDescriptor(mode, proxyFileDescriptorCallback);
  ...
  public static ParcelFileDescriptor open(
      Context context, File file, int mode, long[] redactRanges, long[] freePositions)
      throws IOException {
