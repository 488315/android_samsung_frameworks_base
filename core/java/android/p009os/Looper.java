...
public final class Looper {
  ...
  */
  private static boolean loopOnce(Looper me, long ident, int thresholdOverride) {
    ...
    if (logging2 != null) {
      logging2.println(
          ">>>>> Dispatching to " + msg3.target + " " + msg3.callback + ": " + msg3.what);
    }
  ...
  public static void loop() {
    ...
    if (me.mInLoop) {
      Slog.m121w(
          TAG, "Loop again would have the queued messages be executed before this one completed.");
    }
    me.mInLoop = true;
