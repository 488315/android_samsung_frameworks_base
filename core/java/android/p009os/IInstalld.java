...
import android.p009os.storage.CrateMetadata;
...
public interface IInstalld extends IInterface {
  ...
  boolean reconcileSecondaryDexFile(
      String str, String str2, int i, String[] strArr, String str3, int i2) throws RemoteException;
  ...
  public static class Default implements IInstalld {
    @Override // android.p009os.IInstalld
    ...
    @Override // android.p009os.IInstalld
    public boolean copyKnoxAppData(String srcPath, int srcId, String dstPath, int dstId, int flags)
        throws RemoteException {
      return false;
    }
    ...
    @Override // android.p009os.IInstalld
    public boolean createEncAppData(String packageName, int userId, int appId, int targetSdkVersion)
        throws RemoteException {
      return false;
    }
          ...
          switch (code) {
            ...
            case 6:
              ReconcileSdkDataArgs _arg05 =
                  (ReconcileSdkDataArgs) data.readTypedObject(ReconcileSdkDataArgs.CREATOR);
              data.enforceNoDataAvail();
            ...
            case 19:
              ...
              boolean _result8 =
                  dexopt(
                      _arg018, _arg116, _arg213, _arg311, _arg46, _arg54, _arg63, _arg7, _arg8,
                      _arg9, _arg10, _arg11, _arg122, _arg132, _arg142, _arg152);
              reply.writeNoException();
            ...
            case 38:
              ...
              data.enforceNoDataAvail();
              boolean _result15 =
                  reconcileSecondaryDexFile(_arg037, _arg135, _arg225, _arg320, _arg48, _arg55);
              reply.writeNoException();
            ...
            case 42:
              ...
              data.enforceNoDataAvail();
              boolean _result18 =
                  prepareAppProfile(_arg040, _arg137, _arg227, _arg322, _arg410, _arg56);
              reply.writeNoException();
            ...
            case 54:
              ...
              int _result23 =
                  copyKnoxChunks(
                      _arg050, _arg146, _arg235, _arg328, _arg415, _arg59, _arg65, _arg72);
              reply.writeNoException();
    ...
    private static class Proxy implements IInstalld {
      ...
      public CreateAppDataResult createAppData(CreateAppDataArgs args) throws RemoteException {
        ...
        try {
          ...
          CreateAppDataResult _result =
              (CreateAppDataResult) _reply.readTypedObject(CreateAppDataResult.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public CreateAppDataResult[] createAppDataBatched(CreateAppDataArgs[] args)
        ...
        try {
          ...
          _reply.readException();
          CreateAppDataResult[] _result =
              (CreateAppDataResult[]) _reply.createTypedArray(CreateAppDataResult.CREATOR);
          return _result;
        } finally {
          _reply.recycle();
          _data.recycle();
      ...
      public boolean copyKnoxAppData(
          String srcPath, int srcId, String dstPath, int dstId, int flags) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
      ...
      public boolean createEncAppData(
          String packageName, int userId, int appId, int targetSdkVersion) throws RemoteException {
        Parcel _data = Parcel.obtain(asBinder());
        Parcel _reply = Parcel.obtain();
        try {
          _data.writeInterfaceToken(Stub.DESCRIPTOR);
