...
public final class WifiBatteryStats implements Parcelable {
  ...
  public boolean equals(Object other) {
    ...
    return this.mLoggingDurationMillis == otherStats.mLoggingDurationMillis
        ...
        && Arrays.equals(this.mTimeInSupplicantStateMillis, otherStats.mTimeInSupplicantStateMillis)
        && Arrays.equals(
            this.mTimeInRxSignalStrengthLevelMillis, otherStats.mTimeInRxSignalStrengthLevelMillis)
  ...
  public WifiBatteryStats(
    ...
    this.mTimeInSupplicantStateMillis =
        Arrays.copyOfRange(
            timeInSupplicantStateMillis, 0, Math.min(timeInSupplicantStateMillis.length, 13));
