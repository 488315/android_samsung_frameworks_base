...
public final class CellularBatteryStats implements Parcelable {
  public static final Parcelable.Creator<CellularBatteryStats> CREATOR =
      new Parcelable.Creator<
          CellularBatteryStats>() { // from class: android.os.connectivity.CellularBatteryStats.1
  ...
  public CellularBatteryStats(
    ...
    this.mTimeInRatMs =
        Arrays.copyOfRange(
            timeInRatMs, 0, Math.min(timeInRatMs.length, BatteryStats.NUM_DATA_CONNECTION_TYPES));
    ...
    this.mTxTimeMs =
        Arrays.copyOfRange(
            txTimeMs, 0, Math.min(txTimeMs.length, ModemActivityInfo.getNumTxPowerLevels()));
  ...
  public boolean equals(Object other) {
    ...
    return this.mLoggingDurationMs == otherStats.mLoggingDurationMs
        ...
        && Arrays.equals(
            this.mTimeInRxSignalStrengthLevelMs, otherStats.mTimeInRxSignalStrengthLevelMs)
        && Arrays.equals(this.mTxTimeMs, otherStats.mTxTimeMs)
        && this.mMonitoredRailChargeConsumedMaMs == otherStats.mMonitoredRailChargeConsumedMaMs;
  }
