...
public final class PersistableBundle extends BaseBundle
  ...
  static {
    ...
    CREATOR =
        new Parcelable.Creator<PersistableBundle>() { // from class: android.os.PersistableBundle.1
  ...
  private PersistableBundle(ArrayMap<String, Object> map, boolean throwException) {
    ...
    for (int i = N - 1; i >= 0; i--) {
      ...
      if (value instanceof ArrayMap) {
        ...
        String errorMsg =
            "Bad value in PersistableBundle key=" + this.mMap.keyAt(i) + " value=" + value;
        if (throwException) {
  ...
  public void saveToXml(TypedXmlSerializer out) throws IOException, XmlPullParserException {
    ...
    for (int i = this.mMap.size() - 1; i >= 0; i--) {
      ...
      if (!isValidType(value)) {
        Slog.m115e(TAG, "Dropping bad data before persisting: " + this.mMap.keyAt(i) + "=" + value);
        this.mMap.removeAt(i);
      }
    }
