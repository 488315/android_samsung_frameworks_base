...
public interface INfcFCardEmulation extends IInterface {
  ...
  boolean registerSystemCodeForService(int i, ComponentName componentName, String str)
      throws RemoteException;

  boolean removeSystemCodeForService(int i, ComponentName componentName) throws RemoteException;

  boolean setNfcid2ForService(int i, ComponentName componentName, String str)
      throws RemoteException;

  public static class Default implements INfcFCardEmulation {
    @Override // android.nfc.INfcFCardEmulation
    public String getSystemCodeForService(int userHandle, ComponentName service)
        throws RemoteException {
      return null;
    }
    ...
    public boolean registerSystemCodeForService(
        int userHandle, ComponentName service, String systemCode) throws RemoteException {
      return false;
    }

    @Override // android.nfc.INfcFCardEmulation
    public boolean removeSystemCodeForService(int userHandle, ComponentName service)
        throws RemoteException {
      return false;
    }

    @Override // android.nfc.INfcFCardEmulation
    public String getNfcid2ForService(int userHandle, ComponentName service)
        throws RemoteException {
      return null;
    }

    @Override // android.nfc.INfcFCardEmulation
    public boolean setNfcid2ForService(int userHandle, ComponentName service, String nfcid2)
        throws RemoteException {
      return false;
    }
  ...
  public abstract static class Stub extends Binder implements INfcFCardEmulation {
