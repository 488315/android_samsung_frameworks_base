...
public class NfcControllerAlwaysOnListener extends INfcControllerAlwaysOnListener.Stub {
      ...
      synchronized (this) {
        ...
        if (!this.mIsRegistered) {
          try {
            ...
            Log.m102w(TAG, "Failed to register");
          }
        }
      }
        ...
        if (this.mListenerMap.containsKey(listener)) {
          ...
          if (this.mListenerMap.isEmpty() && this.mIsRegistered) {
            try {
              ...
              Log.m102w(TAG, "Failed to unregister");
            }
  ...
  public /* synthetic */ void lambda$sendCurrentState$0(
      NfcAdapter.ControllerAlwaysOnListener listener) {
