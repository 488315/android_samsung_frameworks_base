...
public final class NfcFCardEmulation {
      ...
      try {
        ...
        if (!sIsInitialized) {
          ...
          if (!pm.hasSystemFeature(PackageManager.FEATURE_NFC_HOST_CARD_EMULATION_NFCF)) {
            Log.m96e(TAG, "This device does not support NFC-F card emulation");
            throw new UnsupportedOperationException();
          }
          sIsInitialized = true;
        }
        ...
        if (manager == null) {
          ...
          if (service == null) {
            Log.m96e(TAG, "This device does not implement the INfcFCardEmulation interface.");
            throw new UnsupportedOperationException();
          }
  ...
  public String getSystemCodeForService(ComponentName service) throws RuntimeException {
    ...
    try {
      ...
      try {
        return iNfcFCardEmulation.getSystemCodeForService(
  ...
  public boolean registerSystemCodeForService(ComponentName service, String systemCode)
    ...
    try {
      return sService.registerSystemCodeForService(
          this.mContext.getUser().getIdentifier(), service, systemCode);
    } catch (RemoteException e) {
      recoverService();
      INfcFCardEmulation iNfcFCardEmulation = sService;
      if (iNfcFCardEmulation == null) {
      ...
      try {
        return iNfcFCardEmulation.registerSystemCodeForService(
            this.mContext.getUser().getIdentifier(), service, systemCode);
      } catch (RemoteException ee) {
        Log.m96e(TAG, "Failed to reach CardEmulationService.");
        ee.rethrowAsRuntimeException();
  ...
  public boolean unregisterSystemCodeForService(ComponentName service) throws RuntimeException {
    ...
    try {
      ...
      try {
        return iNfcFCardEmulation.removeSystemCodeForService(
            this.mContext.getUser().getIdentifier(), service);
      } catch (RemoteException ee) {
        Log.m96e(TAG, "Failed to reach CardEmulationService.");
        ee.rethrowAsRuntimeException();
  ...
  public String getNfcid2ForService(ComponentName service) throws RuntimeException {
    ...
    try {
      ...
      try {
        return iNfcFCardEmulation.getNfcid2ForService(
            this.mContext.getUser().getIdentifier(), service);
      } catch (RemoteException ee) {
        Log.m96e(TAG, "Failed to reach CardEmulationService.");
        ee.rethrowAsRuntimeException();
  ...
  public boolean setNfcid2ForService(ComponentName service, String nfcid2) throws RuntimeException {
    ...
    try {
      ...
      try {
        return iNfcFCardEmulation.setNfcid2ForService(
            this.mContext.getUser().getIdentifier(), service, nfcid2);
      } catch (RemoteException ee) {
        Log.m96e(TAG, "Failed to reach CardEmulationService.");
        ee.rethrowAsRuntimeException();
        return false;
  ...
  public static boolean isValidSystemCode(String systemCode) {
    ...
    if (systemCode.length() != 4) {
      Log.m96e(TAG, "System Code " + systemCode + " is not a valid System Code.");
      return false;
    }
  ...
  public static boolean isValidNfcid2(String nfcid2) {
    ...
    if (nfcid2.length() != 16) {
      Log.m96e(TAG, "NFCID2 " + nfcid2 + " is not a valid NFCID2.");
      return false;
    }
