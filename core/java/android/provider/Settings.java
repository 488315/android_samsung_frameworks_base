...
public final class Settings {
    ...
    static /* bridge */ /* synthetic */ void m3617$$Nest$smmaybeCloseGenerationArray(
    ...
    private static final class GenerationTracker {
        ...
        public boolean isGenerationChanged() {
            ...
            if (SEC_PROVIDER_DEBUG) {
                Log.d(
                        Settings.TAG,
                        "isGenerationChanged() for "
                                + this.mName
                                + " is true. "
                                + currentGeneration
                                + ":"
                                + this.mCurrentGeneration);
                return true;
            }
            return true;
        }
    ...
    private static final class ContentProviderHolder {
        ...
        static /* bridge */ /* synthetic */ Uri m3624$$Nest$fgetmUri(
            ...
            synchronized (this.mLock) {
                if (this.mContentProvider == null) {
                    this.mContentProvider =
                            contentResolver.acquireProvider(this.mUri.getAuthority());
                }
    ...
    static class NameValueCache {
        ...
        private <T extends NameValueTable> NameValueCache(
            ...
            Settings.getPublicSettingsForClass(
                    callerClass,
                    this.mAllFields,
                    this.mReadableFields,
                    this.mReadableFieldsWithMaxTargetSdk);
        }
            ...
            if (!isCallerExemptFromReadableRestriction() && this.mAllFields.contains(name)) {
                if (!this.mReadableFields.contains(name)) {
                    throw new SecurityException(
                            "Settings key: <"
                                    + name
                                    + "> is not readable. From S+, settings keys annotated with"
                                    + " @hide are restricted to system_server and system apps only,"
                                    + " unless they are annotated with @Readable.");
                }
                if (this.mReadableFieldsWithMaxTargetSdk.containsKey(name)) {
                    ...
                    if (!targetSdkCheckOk) {
                        throw new SecurityException(
                                "Settings key: <"
                                        + name
                                        + "> is only readable to apps with targetSdkVersion lower"
                                        + " than or equal to: "
                                        + maxTargetSdk);
                    }
                }
                                ...
                                synchronized (this) {
                                    try {
                                                ...
                                                if (array == null || index < 0) {
                                                    ...
                                                    int generation =
                                                            b.getInt(
                                                                    ...
                                                                    0);
                                                    if (SEC_GENERATION_TRACKER_DEBUG.contains(
                                                            name)) {
                                                        try {
                                                            Log.i(
                                                                    Settings.TAG,
                                                                    "Received generation tracker"
                                                                        + " for setting:"
                                                                            + name
                                                                            + " type:"
                                                                            + this.mUri.getPath()
                                                    ...
                                                    GenerationTracker oldTracker =
                                                            this.mGenerationTrackers.get(name);
                                                    if (oldTracker != null) {
                                                        oldTracker.destroy();
                                                    }
                                                    value = value3;
                                        ...
                                        if (this.mGenerationTrackers.get(name) != null
                                                && !this.mGenerationTrackers
                                                        .get(name)
                                                        .isGenerationChanged()) {
                                            if (SEC_GENERATION_TRACKER_DEBUG.contains(name)) {
                                                Log.i(
                                                        Settings.TAG,
                                                        "Updating cache for setting:" + name);
                                            }
                    ...
                    try {
                        ...
                        if (!Settings.isInSystemServer()
                            ...
                            try {
                                ...
                                Log.w(
                                        Settings.TAG,
                                        "Can't get key " + name + " from " + this.mUri,
                                        e);
                                if (c2 != null) {
                                    c2.close();
                                }
                        ...
                        synchronized (this) {
                            if (this.mGenerationTrackers.get(name) != null
                                ...
                                if (SEC_GENERATION_TRACKER_DEBUG.contains(name)) {
                                    Log.i(
                                            Settings.TAG,
                                            "Updating cache for setting:" + name + " using query");
                                }
        ...
        private static boolean isCallerExemptFromReadableRestriction() {
            if (Settings.isInSystemServer()
                    || UserHandle.getAppId(Binder.getCallingUid()) < 10000) {
                return true;
            }
            Application application = ActivityThread.currentApplication();
        ...
        */
        ...
        public java.util.Map<java.lang.String, java.lang.String> getStringsForPrefixStripPrefix(
                ...
                java.util.List<java.lang.String> r28) {
            /*
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " android.provider.Settings.NameValueCache.getStringsForPrefixStripPrefix(android.content.ContentResolver,"
    ...
    public static final class System extends NameValueTable {
        ...
        @Readable
        public static final String BLUE_LIGHT_FILTER_ADAPTIVE_MODE =
        ...
        @Readable
        public static final String CALL_AUTOMATIC_ANSWERING =
                "automatic_answering_enable_sharedpref";
        ...
        @Readable
        public static final String COCKTAIL_BAR_ENABLED_COCKTAILS =
        ...
        @Readable public static final String DEFAULT_DEVICE_FONT_SCALE = "device_font_scale";
        ...
        @Readable public static final String DEX_AUTO_START = "dex_auto_start";
        ...
        @Readable
        public static final String DOCK_SCREEN_OFF_TIMEOUT_ENABLED =
        ...
        @Readable public static final String FOLD_LOCK_BEHAVIOR = "fold_lock_behavior_setting";
        ...
        @Readable public static final String POINTER_FILL_STYLE = "pointer_fill_style";

        @Readable public static final String POINTER_LOCATION = "pointer_location";

        @Readable public static final String POINTER_SCALE = "pointer_scale";
        ...
        @Readable
        public static final String RINGTONE_VIBRATION_SEP_INDEX_2 =
        ...
        @Readable
        public static final String SEM_ACCELEROMETER_ROTATION_SECOND =
                "accelerometer_rotation_second";
        ...
        @Readable
        public static final String SEM_CURRENT_APP_ICON_PACKAGE =
        ...
        @Readable @Deprecated public static final String SEM_EMERGENCY_MODE = "emergency_mode";
        ...
        @Readable
        public static final String SEM_NOTIFICATION_REMINDER_VIBRATE =
        ...
        @Readable
        public static final String SEM_RAPID_KEY_INPUT_MENU_CHECKED =
                "rapid_key_input_menu_checked";
        ...
        @Readable public static final String SETTINGS_COVER_TYPE_ID_KEY = "cover_type_id";
        ...
        @Readable public static final String SMARTVIEW_DND_ENABLED = "smartview_dnd_enabled";

        @Readable public static final String SMARTVIEW_DND_PLAYED = "smartview_dnd_played";
        ...
        @Readable
        public static final String SPEN_FEEDBACK_SOUND_AIR_COMMAND =
                "spen_feedback_sound_air_command";
        ...
        @Readable
        public static final String SYNC_VIBRATION_WITH_RINGTONE_2 =
        ...
        static {
            ...
            SAMSUNG_PUBLIC_SETTINGS.add(
                    WallpaperThemeConstants.SETTING_NAME_THEMEPARK_SINGLETHEME_STATE);
            ...
            CLONE_FROM_PARENT_ON_VALUE.put(
                    "notification_sound_CONSTANT_PATH", Secure.SYNC_PARENT_SOUNDS);
            CLONE_FROM_PARENT_ON_VALUE.put("ringtone_2_CONSTANT_PATH", Secure.SYNC_PARENT_SOUNDS);
            CLONE_FROM_PARENT_ON_VALUE.put(
                    "notification_sound_2_CONSTANT_PATH", Secure.SYNC_PARENT_SOUNDS);
        ...
        public static boolean putString(
            ...
            return putStringForUser(
                    resolver, name, value, resolver.getUserId(), overrideableByRestore);
        }
        ...
        public static void resetToDefaultsAsUser(
            ...
            try {
                ...
                cp.call(
                        ...
                        Settings.CALL_METHOD_RESET_SYSTEM,
                        null,
                        arg);
            } catch (RemoteException e) {
            ...
            if (MOVED_TO_GLOBAL.contains(name) || MOVED_TO_SECURE_THEN_GLOBAL.contains(name)) {
                Log.w(
                        ...
                        "Setting "
                                + name
                                + " has moved from android.provider.Settings.System to"
                                + " android.provider.Settings.Global, returning read-only global"
                                + " URI.");
        ...
        public static int semGetIntForUser(
                ContentResolver cr, String name, int def, int userHandle) {
        ...
        public static long getLongForUser(
                ContentResolver cr, String name, long def, int userHandle) {
            String v = getStringForUser(cr, name, userHandle);
        ...
        public static void adjustConfigurationForUser(
            ...
            if (localeValue != null) {
                ...
                putStringForUser(
                        cr,
                        SYSTEM_LOCALES,
                        outConfig.getLocales().toLanguageTags(),
                        userHandle,
                        false);
            }
        }
    ...
    public static final class Secure extends NameValueTable {
        ...
        @Readable public static final String ACCESSIBILITY_SLOW_KEYS = "accessibility_slow_keys";
        ...
        public static final String CDMA_ROAM_GUARD_CALL_INTERNATIONAL =
                "roam_guard_call_international";
        public static final String CDMA_ROAM_GUARD_DATA_DOMESTIC = "roam_guard_data_domestic";
        public static final String CDMA_ROAM_GUARD_DATA_INTERNATIONAL =
                "roam_guard_data_international";
        ...
        public static final String CDMA_ROAM_GUARD_SMS_INTERNATIONAL =
                "roam_guard_sms_international";
        ...
        @Readable
        public static final String COVER_SCREEN_SHOW_NOTIFICATION =
        ...
        @Readable
        public static final String DEVICE_CONTROLS_USE_COMPONENTS =
                "device_controls_use_components";
        ...
        @Readable
        public static final String LAST_SECURE_UI_NIGHT_MODE_POWER_MODE =
        ...
        @Readable
        public static final String MULTI_CONTROL_CONNECTION_STATE =
                "multi_control_connection_state";
        ...
        @Readable
        public static final String NOTIFICATION_PANEL_SHOW_FAVORITE_APP_NOTIFICATIONS =
        ...
        @Readable
        public static final String PMS_OVERRIDE_REFRESH_RATE_MODE =
                "pms_override_refresh_rate_mode";

        @Readable
        public static final String PMS_OVERRIDE_REFRESH_RATE_MODE_COVER =
                "pms_override_refresh_rate_mode_cover";
        ...
        public static final String RAMPART_BLOCKED_UNSECURE_WIFI_AUTOJOIN =
        ...
        public static final String RAMPART_IS_RESET_BY_AT_COMMAND =
                "rampart_is_reset_by_at_command";
        ...
        @Readable
        public static final String RGB_GAIN_API_DISPLAY_ACTIVATED =
                "rgb_gain_api_display_activated";

        @Readable
        public static final String RGB_GAIN_API_DISPLAY_BLUE_LEVEL =
                "rgb_gain_api_display_blue_level";
        ...
        @Readable
        public static final String RGB_GAIN_API_DISPLAY_RED_LEVEL =
                "rgb_gain_api_display_red_level";
        ...
        @Readable public static final String SCREEN_RESOLUTION_MODE = "screen_resolution_mode";
        ...
        @Readable
        public static final String SEM_APPLOCK_LOCKED_APPS_PACKAGES =
                "applock_locked_apps_packages";
        ...
        @Readable
        public static final String SEM_NFC_PAYMENT_DEFAULT_COMPONENT =
        ...
        @Readable
        public static final String SEM_SP_EDITION_FLIPFONT_CHANGED =
                "sem_sp_edition_flipfont_changed";

        @Readable
        public static final String SEM_SSECURE_HIDDEN_APPS_PACKAGES =
                "ssecure_hidden_apps_packages";
        ...
        @Readable
        public static final String SKIN_COLOR_DISPLAY_COLOR_LEVEL =
                "skin_color_display_color_level";
        ...
        @Readable
        public static final String WHITE_POINT_DISPLAY_COLOR_LEVEL =
                "white_point_display_color_level";
        ...
        @Readable
        public static final String WIFI_AP_MOBILE_DATA_LIMIT_VALUE =
                "wifi_ap_mobile_data_limit_value";

        @Readable
        public static final String WIFI_AP_MOBILE_DATA_USAGE_VALUE =
                "wifi_ap_mobile_data_usage_value";
        ...
        @Readable
        public static final String WIFI_AP_POWERSAVE_MODE_CHECKED =
                "wifi_ap_powersave_mode_checked";

        @Readable
        public static final String WIFI_AP_POWERSAVE_MODE_SETTINGS =
                "wifi_ap_powersave_mode_settings";
        ...
        @Readable
        public static final String WIFI_AP_SMART_HASH_D2D_FAMILYID =
        ...
        @Readable
        public static final String WIFI_CLIENT_SMART_TETHERING =
                "wifi_client_smart_tethering_settings";

        @Deprecated public static final String WIFI_IDLE_MS = "wifi_idle_ms";

        @Readable public static final String WIFI_IOT_SETUP_ENABLED = "sec_wifi_iot_setup_enabled";
        ...
        public static String getStringForUser(
            ...
            if (MOVED_TO_LOCK_SETTINGS.contains(name) && Process.myUid() != 1000) {
                ...
                throw new SecurityException(
                        "Settings.Secure."
                                + name
                                + " is deprecated and no longer accessible. See API documentation"
            ...
            if (MOVED_TO_GLOBAL.contains(name)) {
                Log.w(
                        ...
                        "Setting "
                                ...
                                + " has moved from android.provider.Settings.Secure to"
                                + " android.provider.Settings.Global");
                return Global.putStringForUser(
                        resolver, name, value, tag, makeDefault, userHandle, false);
            }
            return sNameValueCache.putStringForUser(
                    resolver, name, value, tag, makeDefault, userHandle, overrideableByRestore);
        }
        ...
        public static boolean putString(
                ...
                boolean makeDefault) {
            return putStringForUser(
                    resolver, name, value, tag, makeDefault, resolver.getUserId(), false);
        }
        ...
        public static boolean isLocationProviderEnabled(ContentResolver cr, String provider) {
            ...
            ILocationManager lm =
                    (ILocationManager)
                            Objects.requireNonNull(ILocationManager.Stub.asInterface(binder));
            try {
    ...
    public static final class Global extends NameValueTable {
        ...
        @Readable public static final String AUTO_DIM_SCREEN = "auto_dim_screen";
        ...
        @Readable
        public static final String BATTERY_PROTECTION_DEFAULT_VALUE =
                "battery_protection_default_value";
        ...
        @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
        @Readable
        public static final String BLUETOOTH_BTSNOOP_DEFAULT_MODE =
        ...
        public static final String CONTACT_ONLY_CONTACTS_WITH_PHONE_NUMBER =
                "only_contact_with_phone";
        ...
        @Readable
        public static final String CROSS_LAYER_OPTIMIZER_FOR_MOBILE_NETWORK =
        ...
        @Readable public static final String DARK_MODE_TAG = "dark_mode_state_tag";
        ...
        @Readable public static final String ENABLE_16K_PAGES = "enable_16k_pages";
        ...
        @Readable public static final String ERROR_KERNEL_LOG_PREFIX = "kernel_logs_for_";
        ...
        @Readable public static final String FREEFORM_CAPTION_TYPE = "freeform_caption_type";
        ...
        @Readable public static final String GPU_CONTROL_LAYER_APPS = "gpu_control_layer_apps";
        ...
        @Readable
        public static final String HEIMDALL_ALWAYS_RUNNING_GLOBAL_QUOTA =
                "heimdall_always_running_global_quota";
        ...
        @Readable public static final String HEIMDALL_SPEC_UPDATE = "heimdall_spec_update";
        ...
        @Readable
        public static final String NAVIGATIONBAR_USE_THEME_DEFAULT =
        ...
        @Readable
        public static final String PMS_SETTINGS_DARK_MODE_ENABLED =
                "pms_settings_dark_mode_enabled";

        @Readable
        public static final String PMS_SETTINGS_REFRESH_RATE_COVER_ENABLED =
                "pms_settings_refresh_rate_cover_enabled";

        @Readable
        public static final String PMS_SETTINGS_REFRESH_RATE_ENABLED =
                "pms_settings_refresh_rate_enabled";

        @Readable
        public static final String PMS_SETTINGS_SCREEN_TIME_OUT_ENABLED =
        ...
        @Readable public static final String REFRESH_RATE_COVER_TAG = "psm_refresh_rate_cover_tag";

        @Readable public static final String REFRESH_RATE_TAG = "psm_refresh_rate_tag";
        ...
        @Readable public static final String SCREEN_TIME_OUT_TAG = "screen_time_out_tag";
        ...
        @Readable
        public static final String SEM_AUTO_WIFI_BUBBLETIP_DO_NOT_SHOW_AGAIN =
                "sem_auto_wifi_bubbletip_do_not_show_again";

        @Readable
        public static final String SEM_AUTO_WIFI_FAVORITE_AP_COUNT =
                "sem_auto_wifi_favorite_ap_count";
        ...
        public static final String SEM_ENHANCED_CPU_RESPONSIVENESS =
                "sem_enhanced_cpu_responsiveness";

        @Readable public static final String SEM_FONT_SIZE = "font_size";

        @Readable
        public static final String SEM_LOW_POWER_BRIGHTNESS_LIMIT =
                "sem_low_power_brightness_limit";
        ...
        @Readable
        public static final String SEM_WIFI_ABTEST_USER_ACTIVATION =
                "sem_wifi_abtest_user_activation";

        @Readable
        public static final String SEM_WIFI_ALLOWED_OAUTH_PROVIDER =
                "sem_wifi_allowed_oauth_provider";
        ...
        @Readable public static final String SEM_WIFI_L4S_ENABLED = "sem_wifi_l4s_enabled";
        ...
        @Readable
        public static final String SEM_WIFI_SWITCH_TO_BETTER_WIFI_ON_SCREEN_ENABLED =
        ...
        @Readable
        public static final String SEM_WIFI_VI_EFFECT_FOR_SETTINGS =
                "sem_wifi_vi_effect_for_settings";
        ...
        @Readable
        public static final String SMART_VIEW_SHOW_NOTIFICATION_ON =
                "smart_view_show_notification_on";
        ...
        @Readable
        public static final String WIFI_ADAPTIVE_WIFI_CONTROL_ENABLED =
        ...
        @Readable public static final String WIFI_HANDOVER_AI_MODE = "wifi_handover_ai_mode";
        ...
        @Readable
        public static final String WIFI_SWITCH_TO_MOBILE_DATA_AI_MODE =
        ...
        public static void getPublicSettings(
            ...
            if (ActivityThread.currentApplication()
                ...
                Settings.getPublicSettingsForClass(
                        Wearable.class, allKeys, readableKeys, readableKeysWithMaxTargetSdk);
            }
        }
        ...
        public static boolean putString(ContentResolver resolver, String name, String value) {
            return putStringForUser(
                    resolver, name, value, null, false, resolver.getUserId(), false);
        }
    ...
    public static final class Config extends NameValueTable {
        ...
        public static void setMonitorCallback(
                ContentResolver resolver,
                Executor executor,
                DeviceConfig.MonitorCallback callback) {
        ...
        public static void registerContentObserver(
            ...
            ActivityThread.currentApplication()
                    ...
                    .registerContentObserver(
                            createNamespaceUri(namespace), notifyForDescendants, observer);
        }
                        ...
                        new RemoteCallback(
                                new RemoteCallback
                                    ...
                                    public final void onResult(Bundle bundle) {
                                        Settings.Config.handleMonitorCallback(
                                                bundle, executor, callback);
                                    }
                                }));
                IContentProvider cp = sProviderHolder.getProvider(resolver);
                cp.call(
        ...
        public static void handleMonitorCallback(
                Bundle result,
                Executor executor,
                final DeviceConfig.MonitorCallback monitorCallback) {
            char c;
                    ...
                    if (namespace != null && callingPackage != null) {
                        executor.execute(
                                new Runnable() { // from class:
                                    ...
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        monitorCallback.onDeviceConfigAccess(
    ...
    public static boolean checkAndNoteWriteSettingsOperation(
            Context context, int uid, String callingPackage, boolean throwException) {
        return checkAndNoteWriteSettingsOperation(
                context, uid, callingPackage, null, throwException);
    }
