...
public final class DocumentsContract {
  ...
  public static Bitmap getDocumentThumbnail(
    ...
    try {
      return ContentResolver.loadThumbnail(
          content, documentUri, new Size(size.f85x, size.f86y), signal, 1);
    } catch (Exception e) {
      if (!(e instanceof OperationCanceledException)) {
        Log.m102w(TAG, "Failed to load thumbnail for " + documentUri + ": " + e);
      }
  ...
  public static Uri createDocument(
    ...
    try {
      ...
      Bundle out =
          content.call(parentDocumentUri.getAuthority(), METHOD_CREATE_DOCUMENT, (String) null, in);
      return (Uri) out.getParcelable("uri", Uri.class);
    } catch (Exception e) {
      Log.m103w(TAG, "Failed to create document", e);
      rethrowIfNecessary(e);
      return null;
    }
  }
  ...
  public static boolean isChildDocument(
    ...
    try {
      ...
      Bundle out =
          content.call(
              parentDocumentUri.getAuthority(), METHOD_IS_CHILD_DOCUMENT, (String) null, in);
      if (out == null) {
  ...
  public static Uri renameDocument(ContentResolver content, Uri documentUri, String displayName)
    ...
    try {
      ...
      in.putString("_display_name", displayName);
      Bundle out =
          content.call(documentUri.getAuthority(), METHOD_RENAME_DOCUMENT, (String) null, in);
      Uri outUri = (Uri) out.getParcelable("uri", Uri.class);
      return outUri != null ? outUri : documentUri;
    } catch (Exception e) {
      Log.m103w(TAG, "Failed to rename document", e);
      rethrowIfNecessary(e);
      return null;
    }
  }
  ...
  public static boolean deleteDocument(ContentResolver content, Uri documentUri)
    ...
    try {
      ...
      Log.m103w(TAG, "Failed to delete document", e);
      rethrowIfNecessary(e);
      return false;
    }
  }
  ...
  public static Uri copyDocument(
    ...
    try {
      ...
      Bundle out =
          content.call(sourceDocumentUri.getAuthority(), METHOD_COPY_DOCUMENT, (String) null, in);
      return (Uri) out.getParcelable("uri", Uri.class);
    } catch (Exception e) {
      Log.m103w(TAG, "Failed to copy document", e);
      rethrowIfNecessary(e);
      return null;
    }
  }
  ...
  public static Uri moveDocument(
    ...
    try {
      ...
      in.putParcelable(EXTRA_TARGET_URI, targetParentDocumentUri);
      Bundle out =
          content.call(sourceDocumentUri.getAuthority(), METHOD_MOVE_DOCUMENT, (String) null, in);
      return (Uri) out.getParcelable("uri", Uri.class);
    } catch (Exception e) {
      Log.m103w(TAG, "Failed to move document", e);
      rethrowIfNecessary(e);
      return null;
    }
  }
  ...
  public static boolean removeDocument(
    ...
    try {
      ...
      Log.m103w(TAG, "Failed to remove document", e);
      rethrowIfNecessary(e);
      return false;
    }
  }
  ...
  public static void ejectRoot(ContentResolver content, Uri rootUri) {
    try {
      ...
      Log.m103w(TAG, "Failed to eject", e);
    }
  }
  ...
  public static Bundle getDocumentMetadata(ContentResolver content, Uri documentUri)
    ...
    try {
      ...
      Log.m102w(TAG, "Failed to get document metadata");
      rethrowIfNecessary(e);
      return null;
    }
  }
  ...
  public static Path findDocumentPath(ContentResolver content, Uri treeUri)
    ...
    try {
      ...
      Bundle out =
          content.call(treeUri.getAuthority(), METHOD_FIND_DOCUMENT_PATH, (String) null, in);
      return (Path) out.getParcelable("result", Path.class);
    } catch (Exception e) {
      Log.m103w(TAG, "Failed to find path", e);
      rethrowIfNecessary(e);
      return null;
    }
  }
  ...
  public static IntentSender createWebLinkIntent(ContentResolver content, Uri uri, Bundle options)
    ...
    try {
      ...
      Bundle out =
          content.call(uri.getAuthority(), METHOD_CREATE_WEB_LINK_INTENT, (String) null, in);
      return (IntentSender) out.getParcelable("result", IntentSender.class);
    } catch (Exception e) {
      Log.m103w(TAG, "Failed to create a web link intent", e);
      rethrowIfNecessary(e);
      return null;
    }
  }
  ...
  public static final class Path implements Parcelable {
    public static final Parcelable.Creator<Path> CREATOR =
        new Parcelable.Creator<Path>() { // from class: android.provider.DocumentsContract.Path.1
