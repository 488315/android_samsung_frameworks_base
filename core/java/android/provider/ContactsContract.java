...
public final class ContactsContract {
  ...
  protected interface DataColumns {
    ...
    @Deprecated public static final String CARRIER_PRESENCE = "carrier_presence";

    @Deprecated public static final int CARRIER_PRESENCE_VT_CAPABLE = 1;
    ...
    @Deprecated public static final String HASH_ID = "hash_id";
  ...
  protected interface DataUsageStatColumns {
    ...
    @Deprecated public static final String LAST_TIME_USED = "last_time_used";
    ...
    @Deprecated public static final String TIMES_USED = "times_used";
  }
  ...
  protected interface RawContactsColumns {
    ...
    @Deprecated public static final String METADATA_DIRTY = "metadata_dirty";
  ...
  protected interface StatusColumns {
    ...
    @Deprecated public static final String PRESENCE_CUSTOM_STATUS = "status";

    @Deprecated public static final String PRESENCE_STATUS = "mode";
  ...
  protected interface StreamItemPhotosColumns {
    ...
    @Deprecated public static final String PHOTO_FILE_ID = "photo_file_id";

    @Deprecated public static final String PHOTO_URI = "photo_uri";

    @Deprecated public static final String SORT_INDEX = "sort_index";

    @Deprecated public static final String STREAM_ITEM_ID = "stream_item_id";

    @Deprecated public static final String SYNC1 = "stream_item_photo_sync1";

    @Deprecated public static final String SYNC2 = "stream_item_photo_sync2";

    @Deprecated public static final String SYNC3 = "stream_item_photo_sync3";

    @Deprecated public static final String SYNC4 = "stream_item_photo_sync4";
  }

  @Deprecated
  protected interface StreamItemsColumns {

    @Deprecated public static final String ACCOUNT_NAME = "account_name";

    @Deprecated public static final String ACCOUNT_TYPE = "account_type";

    @Deprecated public static final String COMMENTS = "comments";

    @Deprecated public static final String CONTACT_ID = "contact_id";

    @Deprecated public static final String CONTACT_LOOKUP_KEY = "contact_lookup";

    @Deprecated public static final String DATA_SET = "data_set";

    @Deprecated public static final String RAW_CONTACT_ID = "raw_contact_id";

    @Deprecated public static final String RAW_CONTACT_SOURCE_ID = "raw_contact_source_id";

    @Deprecated public static final String RES_ICON = "icon";

    @Deprecated public static final String RES_LABEL = "label";

    @Deprecated public static final String RES_PACKAGE = "res_package";

    @Deprecated public static final String SYNC1 = "stream_item_sync1";

    @Deprecated public static final String SYNC2 = "stream_item_sync2";

    @Deprecated public static final String SYNC3 = "stream_item_sync3";

    @Deprecated public static final String SYNC4 = "stream_item_sync4";

    @Deprecated public static final String TEXT = "text";

    @Deprecated public static final String TIMESTAMP = "timestamp";
  }
  ...
  public static final class Directory implements BaseColumns {
    ...
    public static final Uri ENTERPRISE_FILE_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "directory_file_enterprise");
  ...
  public static final class SyncState implements SyncStateContract.Columns {
    ...
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "syncstate");
  ...
  public static class Contacts
    ...
    @Deprecated public static final Uri CONTENT_FREQUENT_URI;
    ...
    static {
      Uri withAppendedPath =
          Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, android.provider.Contacts.AUTHORITY);
      CONTENT_URI = withAppendedPath;
      ENTERPRISE_CONTENT_URI =
          Uri.withAppendedPath(withAppendedPath, ApnSetting.TYPE_ENTERPRISE_STRING);
    ...
    public static Uri getLookupUri(long contactId, String lookupKey) {
      ...
      return ContentUris.withAppendedId(
          Uri.withAppendedPath(CONTENT_LOOKUP_URI, lookupKey), contactId);
    }

    public static Uri lookupContact(ContentResolver resolver, Uri lookupUri) {
      Cursor c;
      if (lookupUri == null
          || (c = resolver.query(lookupUri, new String[] {"_id"}, null, null, null)) == null) {
        return null;
      }
      try {
        if (!c.moveToFirst()) {
    ...
    public static final class StreamItems implements StreamItemsColumns {
      ...
      @Deprecated public static final String CONTENT_DIRECTORY = "stream_items";
  ...
  public static final class DeletedContacts implements DeletedContactsColumns {
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "deleted_contacts");
  ...
  public static final class RawContacts
    ...
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "raw_contacts");
    ...
    public static Uri getContactLookupUri(ContentResolver resolver, Uri rawContactUri) {
      ...
      Cursor cursor =
          resolver.query(dataUri, new String[] {"contact_id", "lookup"}, null, null, null);
      if (cursor != null) {
        try {
    ...
    public static String getLocalAccountName(Context context) {
      return TextUtils.nullIfEmpty(
          context.getString(C4337R.string.config_rawContactsLocalAccountName));
    }

    public static String getLocalAccountType(Context context) {
      return TextUtils.nullIfEmpty(
          context.getString(C4337R.string.config_rawContactsLocalAccountType));
    }
      ...
      public android.content.Entity getEntityAndIncrementCursor(Cursor cursor)
        ...
        while (rawContactId == cursor.getLong(columnRawContactId)) {
          ...
          DatabaseUtils.cursorLongToContentValuesIfPresent(
              cursor, cv2, DataColumns.IS_SUPER_PRIMARY);
          ...
          DatabaseUtils.cursorStringToContentValuesIfPresent(
              cursor, cv2, CommonDataKinds.GroupMembership.GROUP_SOURCE_ID);
  ...
  public static final class StreamItems implements BaseColumns, StreamItemsColumns {
    ...
    @Deprecated public static final Uri CONTENT_LIMIT_URI;

    @Deprecated public static final Uri CONTENT_PHOTO_URI;

    @Deprecated public static final String CONTENT_TYPE = "vnd.android.cursor.dir/stream_item";

    @Deprecated public static final Uri CONTENT_URI;

    @Deprecated public static final String MAX_ITEMS = "max_items";
    ...
    static {
      ...
      CONTENT_LIMIT_URI =
          Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "stream_items_limit");
    }
  ...
  public static final class StreamItemPhotos implements BaseColumns, StreamItemPhotosColumns {
    ...
    @Deprecated public static final String PHOTO = "photo";
  ...
  public static final class Data implements DataColumnsWithJoins, ContactCounts {
    ...
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "data");
    static final Uri ENTERPRISE_CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "data_enterprise");
  ...
  public static final class RawContactsEntity
    ...
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "raw_contact_entities");
    public static final Uri CORP_CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "raw_contact_entities_corp");
    ...
    public static Map<String, List<ContentValues>> queryRawContactEntity(
      ...
      try {
        ...
        entityIterator =
            RawContacts.newEntityIterator(
                contentResolver.query(uri, null, "contact_id=?", selectionArgs, null));
        if (entityIterator == null) {
          Log.m96e(TAG, "EntityIterator is null");
          return contentValuesListMap;
        }
        if (!entityIterator.hasNext()) {
          Log.m102w(TAG, "Data does not exist. contactId: " + realContactId);
          if (entityIterator != null) {
  ...
  public static final class PhoneLookup
    ...
    public static final Uri CONTENT_FILTER_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "phone_lookup");
    public static final Uri ENTERPRISE_CONTENT_FILTER_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "phone_lookup_enterprise");
  ...
  public static class StatusUpdates implements StatusColumns, PresenceColumns {
    ...
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "status_updates");
    public static final Uri PROFILE_CONTENT_URI =
  ...
  public static final class CommonDataKinds {
    ...
    public static final class Nickname
        implements DataColumnsWithJoins, CommonColumns, ContactCounts {
    ...
    public static final class Phone implements DataColumnsWithJoins, CommonColumns, ContactCounts {
      ...
      static {
        Uri withAppendedPath =
            Uri.withAppendedPath(Data.CONTENT_URI, Contacts.People.Phones.CONTENT_DIRECTORY);
        CONTENT_URI = withAppendedPath;
        ENTERPRISE_CONTENT_URI =
            Uri.withAppendedPath(
                Data.ENTERPRISE_CONTENT_URI, Contacts.People.Phones.CONTENT_DIRECTORY);
        CONTENT_FILTER_URI = Uri.withAppendedPath(withAppendedPath, "filter");
        ENTERPRISE_CONTENT_FILTER_URI = Uri.withAppendedPath(withAppendedPath, "filter_enterprise");
      }
      ...
      public static final int getTypeLabelResource(int type) {
        switch (type) {
          case 1:
            return C4337R.string.phoneTypeHome;
          case 2:
            return C4337R.string.phoneTypeMobile;
          case 3:
            return C4337R.string.phoneTypeWork;
          case 4:
            return C4337R.string.phoneTypeFaxWork;
          case 5:
            return C4337R.string.phoneTypeFaxHome;
          case 6:
            return C4337R.string.phoneTypePager;
          case 7:
            return C4337R.string.phoneTypeOther;
          case 8:
            return C4337R.string.phoneTypeCallback;
          case 9:
            return C4337R.string.phoneTypeCar;
          case 10:
            return C4337R.string.phoneTypeCompanyMain;
          case 11:
            return C4337R.string.phoneTypeIsdn;
          case 12:
            return C4337R.string.phoneTypeMain;
          case 13:
            return C4337R.string.phoneTypeOtherFax;
          case 14:
            return C4337R.string.phoneTypeRadio;
          case 15:
            return C4337R.string.phoneTypeTelex;
          case 16:
            return C4337R.string.phoneTypeTtyTdd;
          case 17:
            return C4337R.string.phoneTypeWorkMobile;
          case 18:
            return C4337R.string.phoneTypeWorkPager;
          case 19:
            return C4337R.string.phoneTypeAssistant;
          case 20:
            return C4337R.string.phoneTypeMms;
          case 1021:
            return C4337R.string.phoneTypeConference;
          default:
            return C4337R.string.phoneTypeCustom;
        }
      }
    ...
    public static final class Email implements DataColumnsWithJoins, CommonColumns, ContactCounts {
      ...
      public static final int getTypeLabelResource(int type) {
        switch (type) {
          case 1:
            return C4337R.string.emailTypeHome;
          case 2:
            return C4337R.string.emailTypeWork;
          case 3:
            return C4337R.string.emailTypeOther;
          case 4:
            return C4337R.string.emailTypeMobile;
          default:
            return C4337R.string.emailTypeCustom;
        }
      }
    ...
    public static final class StructuredPostal
      ...
      public static final int getTypeLabelResource(int type) {
        switch (type) {
          case 1:
            return C4337R.string.postalTypeHome;
          case 2:
            return C4337R.string.postalTypeWork;
          case 3:
            return C4337R.string.postalTypeOther;
          default:
            return C4337R.string.postalTypeCustom;
        }
      }
    ...
    public static final class C2512Im
        implements DataColumnsWithJoins, CommonColumns, ContactCounts {
      ...
      @Deprecated public static final int PROTOCOL_NETMEETING = 8;
      ...
      public static final int getTypeLabelResource(int type) {
        switch (type) {
          case 1:
            return C4337R.string.imTypeHome;
          case 2:
            return C4337R.string.imTypeWork;
          case 3:
            return C4337R.string.imTypeOther;
          default:
            return C4337R.string.imTypeCustom;
        }
      }
      ...
      public static final int getProtocolLabelResource(int type) {
        switch (type) {
          case 0:
            return C4337R.string.imProtocolAim;
          case 1:
            return C4337R.string.imProtocolMsn;
          case 2:
            return C4337R.string.imProtocolYahoo;
          case 3:
            return C4337R.string.imProtocolSkype;
          case 4:
            return C4337R.string.imProtocolQq;
          case 5:
            return C4337R.string.imProtocolGoogleTalk;
          case 6:
            return C4337R.string.imProtocolIcq;
          case 7:
            return C4337R.string.imProtocolJabber;
          case 8:
            return C4337R.string.imProtocolNetMeeting;
          case 9:
            return C4337R.string.imProtocolWhatsApp;
          case 10:
            return C4337R.string.imProtocolFacebook;
          default:
            return C4337R.string.imProtocolCustom;
        }
      }

      public static final CharSequence getProtocolLabel(
          Resources res, int type, CharSequence label) {
    ...
    public static final class Organization
      ...
      public static final int getTypeLabelResource(int type) {
        switch (type) {
          case 1:
            return C4337R.string.orgTypeWork;
          case 2:
            return C4337R.string.orgTypeOther;
          default:
            return C4337R.string.orgTypeCustom;
        }
      }
    ...
    public static final class Relation
      ...
      public static final int getTypeLabelResource(int type) {
        switch (type) {
          case 1:
            return C4337R.string.relationTypeAssistant;
          case 2:
            return C4337R.string.relationTypeBrother;
          case 3:
            return C4337R.string.relationTypeChild;
          case 4:
            return C4337R.string.relationTypeDomesticPartner;
          case 5:
            return C4337R.string.relationTypeFather;
          case 6:
            return C4337R.string.relationTypeFriend;
          case 7:
            return C4337R.string.relationTypeManager;
          case 8:
            return C4337R.string.relationTypeMother;
          case 9:
            return C4337R.string.relationTypeParent;
          case 10:
            return C4337R.string.relationTypePartner;
          case 11:
            return C4337R.string.relationTypeReferredBy;
          case 12:
            return C4337R.string.relationTypeRelative;
          case 13:
            return C4337R.string.relationTypeSister;
          case 14:
            return C4337R.string.relationTypeSpouse;
          default:
            return C4337R.string.orgTypeCustom;
        }
      }
    ...
    public static final class Event implements DataColumnsWithJoins, CommonColumns, ContactCounts {
      ...
      public static int getTypeResource(Integer type) {
        if (type == null) {
          return C4337R.string.eventTypeOther;
        }
    ...
    public static final class SipAddress
      ...
      public static final int getTypeLabelResource(int type) {
        switch (type) {
          case 1:
            return C4337R.string.sipAddressTypeHome;
          case 2:
            return C4337R.string.sipAddressTypeWork;
          case 3:
            return C4337R.string.sipAddressTypeOther;
          default:
            return C4337R.string.sipAddressTypeCustom;
        }
      }
  ...
  public static final class Groups implements BaseColumns, GroupsColumns, SyncColumns {
    ...
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "groups");
    public static final Uri CONTENT_SUMMARY_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "groups_summary");
    ...
    private static class EntityIteratorImpl extends CursorEntityIterator {
      ...
      public Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
        ...
        DatabaseUtils.cursorLongToContentValuesIfPresent(
            cursor, values, GroupsColumns.GROUP_VISIBLE);
  ...
  public static final class AggregationExceptions implements BaseColumns {
    ...
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "aggregation_exceptions");
  ...
  public static final class SimContacts {
    ...
    @SystemApi
    public static void addSimAccount(
      ...
      ContactsContract.nullSafeCall(
          contentResolver, ContactsContract.AUTHORITY_URI, ADD_SIM_ACCOUNT_METHOD, null, extras);
    }
    ...
    public static void removeSimAccounts(ContentResolver contentResolver, int simSlotIndex) {
      ...
      extras.putInt(KEY_SIM_SLOT_INDEX, simSlotIndex);
      ContactsContract.nullSafeCall(
          contentResolver, ContactsContract.AUTHORITY_URI, REMOVE_SIM_ACCOUNT_METHOD, null, extras);
    }
  ...
  public static final class SimAccount implements Parcelable {
    ...
    public static final Parcelable.Creator<SimAccount> CREATOR =
        new Parcelable.Creator<
            SimAccount>() { // from class: android.provider.ContactsContract.SimAccount.1
    ...
    public boolean equals(Object obj) {
      ...
      try {
        ...
        if (this.mSimSlotIndex != toCompare.mSimSlotIndex
            || this.mEfType != toCompare.mEfType
            || !Objects.equals(this.mAccountName, toCompare.mAccountName)
            || !Objects.equals(this.mAccountType, toCompare.mAccountType)) {
          return false;
        }
        return true;
  ...
  public static final class Settings implements SettingsColumns {
    ...
    public static final Uri CONTENT_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "settings");
    ...
    public static void setDefaultAccount(ContentResolver resolver, Account account) {
      ...
      resolver.call(
          ContactsContract.AUTHORITY_URI, SET_DEFAULT_ACCOUNT_METHOD, (String) null, extras);
    }
  }
  ...
  public static final class QuickContact {
    ...
    @Deprecated public static final String EXTRA_TARGET_RECT = "android.provider.extra.TARGET_RECT";
    public static final int MODE_DEFAULT = 3;
    public static final int MODE_LARGE = 3;
    public static final int MODE_MEDIUM = 2;
    public static final int MODE_SMALL = 1;

    public static Intent composeQuickContactsIntent(
        Context context, View target, Uri lookupUri, int mode, String[] excludeMimes) {
    ...
    public static Intent composeQuickContactsIntent(
        Context context, Rect target, Uri lookupUri, int mode, String[] excludeMimes) {
    ...
    public static Intent rebuildManagedQuickContactsIntent(
        String lookupKey,
        long contactId,
      ...
      if (uri != null && directoryId != 0) {
        uri =
            uri.buildUpon().appendQueryParameter("directory", String.valueOf(directoryId)).build();
      }
      intent.setData(uri);
  ...
  public static final class DisplayPhoto {
    ...
    public static final Uri CONTENT_MAX_DIMENSIONS_URI =
        Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "photo_dimensions");
