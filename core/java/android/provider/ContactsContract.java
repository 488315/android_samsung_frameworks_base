...
public final class ContactsContract {
    ...
    public static final class RawContacts implements BaseColumns, RawContactsColumns, ContactOptionsColumns, ContactNameColumns, SyncColumns {
        ...
        public static String getLocalAccountName(Context context) {
            return TextUtils.nullIfEmpty(context.getString(C4337R.string.config_rawContactsLocalAccountName));
        }

        public static String getLocalAccountType(Context context) {
            return TextUtils.nullIfEmpty(context.getString(C4337R.string.config_rawContactsLocalAccountType));
        }
    ...
    public static final class CommonDataKinds {
        ...
        public static final class C2512Im implements DataColumnsWithJoins, CommonColumns, ContactCounts {
