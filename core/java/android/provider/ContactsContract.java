...
public final class ContactsContract {
    ...
    public static final class ProfileSyncState implements SyncStateContract.Columns {
        public static final String CONTENT_DIRECTORY = "syncstate";
        public static final Uri CONTENT_URI =
                Uri.withAppendedPath(Profile.CONTENT_URI, "syncstate");
    ...
    public static class Contacts
        ...
        public static final Uri CONTENT_URI =
                Uri.withAppendedPath(
                        ContactsContract.AUTHORITY_URI, android.provider.Contacts.AUTHORITY);
        public static final Uri ENTERPRISE_CONTENT_URI =
                Uri.withAppendedPath(CONTENT_URI, ApnSetting.TYPE_ENTERPRISE_STRING);
        public static final Uri CORP_CONTENT_URI =
                Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "contacts_corp");
        ...
        public static final Uri CONTENT_MULTI_VCARD_URI =
                Uri.withAppendedPath(CONTENT_URI, "as_multi_vcard");
        public static final Uri CONTENT_FILTER_URI = Uri.withAppendedPath(CONTENT_URI, "filter");
        public static final Uri ENTERPRISE_CONTENT_FILTER_URI =
                Uri.withAppendedPath(CONTENT_URI, "filter_enterprise");
        public static final Uri CONTENT_STREQUENT_URI =
                Uri.withAppendedPath(CONTENT_URI, "strequent");

        @Deprecated
        public static final Uri CONTENT_FREQUENT_URI =
                Uri.withAppendedPath(CONTENT_URI, CallLog.Calls.SEM_FREQUENT);

        public static final Uri CONTENT_STREQUENT_FILTER_URI =
                Uri.withAppendedPath(CONTENT_STREQUENT_URI, "filter");
        ...
        public static Uri lookupContact(ContentResolver resolver, Uri lookupUri) {
            Cursor c;
            if (lookupUri == null
                    || (c = resolver.query(lookupUri, new String[] {"_id"}, null, null, null))
                            == null) {
                return null;
            }
            try {
    ...
    public static final class Profile
        ...
        public static final Uri CONTENT_URI =
                Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "profile");
        public static final Uri CONTENT_VCARD_URI = Uri.withAppendedPath(CONTENT_URI, "as_vcard");
        public static final Uri CONTENT_RAW_CONTACTS_URI =
                Uri.withAppendedPath(CONTENT_URI, "raw_contacts");
    ...
    public static final class RawContacts
        ...
        public static Uri getContactLookupUri(ContentResolver resolver, Uri rawContactUri) {
            ...
            Cursor cursor =
                    resolver.query(
                            dataUri, new String[] {"contact_id", "lookup"}, null, null, null);
            if (cursor != null) {
                try {
        ...
        public static String getLocalAccountName(Context context) {
            return TextUtils.nullIfEmpty(
                    context.getString(R.string.config_rawContactsLocalAccountName));
        }

        public static String getLocalAccountType(Context context) {
            return TextUtils.nullIfEmpty(
                    context.getString(R.string.config_rawContactsLocalAccountType));
        }
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public android.content.Entity getEntityAndIncrementCursor(Cursor cursor)
                ...
                while (rawContactId == cursor.getLong(columnRawContactId)) {
                    ...
                    cv2.put(
                            "_id",
                            Long.valueOf(cursor.getLong(cursor.getColumnIndexOrThrow("data_id"))));
                    ...
                    DatabaseUtils.cursorLongToContentValuesIfPresent(
                            cursor, cv2, DataColumns.IS_PRIMARY);
                    DatabaseUtils.cursorLongToContentValuesIfPresent(
                            cursor, cv2, DataColumns.IS_SUPER_PRIMARY);
                    DatabaseUtils.cursorLongToContentValuesIfPresent(
                            cursor, cv2, DataColumns.DATA_VERSION);
    ...
    public static final class StreamItems implements BaseColumns, StreamItemsColumns {
        ...
        @Deprecated
        public static final Uri CONTENT_URI =
                Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "stream_items");
                ...
                entityIterator =
                        RawContacts.newEntityIterator(
                                contentResolver.query(
                                        uri, null, "contact_id=?", selectionArgs, null));
    ...
    public static final class CommonDataKinds {
        ...
        public static final class Callable
            ...
            public static final Uri CONTENT_FILTER_URI =
                    Uri.withAppendedPath(CONTENT_URI, "filter");
            public static final Uri ENTERPRISE_CONTENT_FILTER_URI =
                    Uri.withAppendedPath(CONTENT_URI, "filter_enterprise");
        }
        ...
        public static final class Contactables
            ...
            public static final String VISIBLE_CONTACTS_ONLY = "visible_contacts_only";
            public static final Uri CONTENT_URI =
                    Uri.withAppendedPath(Data.CONTENT_URI, "contactables");
            public static final Uri CONTENT_FILTER_URI =
                    Uri.withAppendedPath(CONTENT_URI, "filter");
        }
        ...
        public static final class Phone
            ...
            public static final Uri CONTENT_URI =
                    Uri.withAppendedPath(
                            Data.CONTENT_URI, Contacts.People.Phones.CONTENT_DIRECTORY);
            public static final Uri ENTERPRISE_CONTENT_URI =
                    Uri.withAppendedPath(
            ...
            public static final CharSequence getTypeLabel(
        ...
        public static final class Email
            ...
            public static final Uri CONTENT_LOOKUP_URI =
                    Uri.withAppendedPath(CONTENT_URI, "lookup");
    ...
    public static final class Groups implements BaseColumns, GroupsColumns, SyncColumns {
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                ...
                DatabaseUtils.cursorStringToContentValuesIfPresent(
                        cursor, values, GroupsColumns.TITLE_RES);
                DatabaseUtils.cursorLongToContentValuesIfPresent(
                ...
                DatabaseUtils.cursorStringToContentValuesIfPresent(
                        cursor, values, GroupsColumns.FAVORITES);
                DatabaseUtils.cursorStringToContentValuesIfPresent(
                        cursor, values, GroupsColumns.AUTO_ADD);
                cursor.moveToNext();
        ...
        public static List<SimAccount> getSimAccounts(ContentResolver contentResolver) {
            Bundle response =
                    ContactsContract.nullSafeCall(
                            ...
                            null,
                            null);
            List<SimAccount> result =
                    response.getParcelableArrayList(KEY_SIM_ACCOUNTS, SimAccount.class);
            if (result == null) {
                ...
                new Parcelable.Creator<
                    ...
                    public SimAccount createFromParcel(Parcel source) {
                        ...
                        SimAccount simAccount =
                                new SimAccount(accountName, accountType, simSlot, efType);
                        return simAccount;
                    }
    ...
    public static final class QuickContact {
        ...
        public static Intent rebuildManagedQuickContactsIntent(
            ...
            if (uri != null && directoryId != 0) {
                uri =
                        uri.buildUpon()
                                .appendQueryParameter("directory", String.valueOf(directoryId))
                                .build();
            }
            intent.setData(uri);
            ...
            intent.putExtra(
                    EXTRA_EXCLUDE_MIMES, originalIntent.getStringArrayExtra(EXTRA_EXCLUDE_MIMES));
            return intent;
        }
        ...
        public static void showQuickContact(
                Context context, View target, Uri lookupUri, int mode, String[] excludeMimes) {
            Intent intent =
                    composeQuickContactsIntent(context, target, lookupUri, mode, excludeMimes);
    ...
    public static final class MetadataSync implements BaseColumns, MetadataSyncColumns {
        ...
        public static final Uri METADATA_AUTHORITY_URI =
                Uri.parse("content://com.android.contacts.metadata");
        public static final Uri CONTENT_URI =
                Uri.withAppendedPath(METADATA_AUTHORITY_URI, "metadata_sync");
