...
public class Contacts {
  ...
  public static final class People
    ...
    public static long tryGetMyContactsGroupId(ContentResolver resolver) {
      Cursor groupsCursor =
          resolver.query(Groups.CONTENT_URI, GROUPS_PROJECTION, "system_id='Contacts'", null, null);
    ...
    public static Uri addToGroup(ContentResolver resolver, long personId, String groupName) {
      ...
      Cursor groupsCursor =
          resolver.query(
              Groups.CONTENT_URI, GROUPS_PROJECTION, "name=?", new String[] {groupName}, null);
      if (groupsCursor != null) {
        try {
          if (groupsCursor.moveToFirst()) {
    ...
    public static Uri createPersonInMyContactsGroup(
      ...
      if (contactUri == null) {
        Log.m96e("Contacts", "Failed to create the contact");
        return null;
      }
    ...
    public static Bitmap loadContactPhoto(
        Context context, Uri person, int placeholderImageResource, BitmapFactory.Options options) {
      if (person == null) {
  ...
  public static final class Groups implements BaseColumns, GroupsColumns {
    ...
    @Deprecated public static final String CONTENT_TYPE = "vnd.android.cursor.dir/contactsgroup";
  ...
  public static final class Phones implements BaseColumns, PhonesColumns, PeopleColumns {
    ...
    public static final CharSequence getDisplayLabel(
      ...
      if (type != 0) {
        CharSequence[] labels =
            labelArray != null ? labelArray : context.getResources().getTextArray(17235971);
        try {
  ...
  public static final class ContactMethods
    ...
    @Deprecated public static final String CONTENT_TYPE = "vnd.android.cursor.dir/contact-methods";
    ...
    interface ProviderNames {
      ...
      /* renamed from: QQ */
      public static final String f352QQ = "QQ";
  ...
  public static final class Organizations implements BaseColumns, OrganizationColumns {
    ...
    @Deprecated public static final Uri CONTENT_URI = Uri.parse("content://contacts/organizations");
  ...
  public static final class Extensions implements BaseColumns, ExtensionsColumns {
    ...
    @Deprecated public static final Uri CONTENT_URI = Uri.parse("content://contacts/extensions");
  ...
  public static final class Intents {
    ...
    public static final class C2511UI {
