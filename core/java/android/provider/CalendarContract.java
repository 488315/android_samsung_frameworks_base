...
public final class CalendarContract {
      ...
      public Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
        ...
        while (subCursor.moveToNext()) {
          try {
            ...
            attendeeValues.put(
                AttendeesColumns.ATTENDEE_RELATIONSHIP, Integer.valueOf(subCursor.getInt(2)));
            attendeeValues.put(
                AttendeesColumns.ATTENDEE_TYPE, Integer.valueOf(subCursor.getInt(3)));
            attendeeValues.put(
                AttendeesColumns.ATTENDEE_STATUS, Integer.valueOf(subCursor.getInt(4)));
  ...
  public static final class CalendarAlerts
    ...
    public static final Uri insert(
        ContentResolver cr, long eventId, long begin, long end, long alarmTime, int minutes) {
    ...
    public static final boolean alarmExists(
      ...
      Cursor cursor =
          cr.query(
              ...
              projection,
              WHERE_ALARM_EXISTS,
              new String[] {Long.toString(eventId), Long.toString(begin), Long.toString(alarmTime)},
              null);
      boolean found = false;
      if (cursor != null) {
        try {
