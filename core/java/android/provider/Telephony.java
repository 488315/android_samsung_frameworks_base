...
public final class Telephony {
  ...
  public interface TextBasedSmsChangesColumns {
    ...
    /* renamed from: ID */
    public static final String f355ID = "_id";
  ...
  public static final class Sms implements BaseColumns, TextBasedSmsColumns {
    ...
    public static Uri addMessageToUri(
      ...
      Rlog.m83v(Telephony.TAG, "Telephony addMessageToUri sub id: " + subId);
    ...
    public static final class Sent implements BaseColumns, TextBasedSmsColumns {
      ...
      public static Uri addMessage(
          ContentResolver resolver, String address, String body, String subject, Long date) {
        return Sms.addMessageToUri(
            SubscriptionManager.getDefaultSmsSubscriptionId(),
            resolver,
            CONTENT_URI,
    ...
    public static final class Intents {
      ...
      public static SmsMessage[] getMessagesFromIntent(Intent intent) {
        try {
          ...
          if (messages == null) {
            Rlog.m79e(Telephony.TAG, "pdus does not exist in the intent");
            return null;
          }
          ...
          if (subId != -1) {
            Rlog.m83v(Telephony.TAG, "getMessagesFromIntent with valid subId : " + subId);
            phoneId = SubscriptionManager.getPhoneId(subId);
          } else {
            Rlog.m83v(Telephony.TAG, "getMessagesFromIntent");
          }
          ...
          Rlog.m79e(Telephony.TAG, "getMessagesFromIntent: " + e);
          return null;
        }
      }
    }
  ...
  public static final class Threads implements ThreadsColumns {
    ...
    public static long getOrCreateThreadId(Context context, Set<String> recipients) {
      ...
      Cursor cursor =
          SqliteWrapper.query(
              context, context.getContentResolver(), uri, ID_PROJECTION, null, null, null);
      if (cursor != null) {
        try {
          if (!cursor.moveToFirst()) {
            Rlog.m79e(Telephony.TAG, "getOrCreateThreadId returned no rows!");
          } else {
      ...
      Rlog.m79e(
          Telephony.TAG, "getOrCreateThreadId failed with " + recipients.size() + " recipients");
  ...
  public static final class MmsSms implements BaseColumns {
    ...
    public static final class WordsTable {
      ...
      /* renamed from: ID */
      public static final String f354ID = "_id";
  ...
  public static final class Carriers implements BaseColumns {
    ...
    @SystemApi public static final String MTU_V4 = "mtu_v4";

    @SystemApi public static final String MTU_V6 = "mtu_v6";
    ...
    @SystemApi public static final String USER_EDITABLE = "user_editable";

    @SystemApi public static final int USER_EDITED = 1;

    @SystemApi public static final String USER_VISIBLE = "user_visible";
