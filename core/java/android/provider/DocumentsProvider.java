...
public abstract class DocumentsProvider extends ContentProvider {
  ...
  public abstract ParcelFileDescriptor openDocument(
      String str, String str2, CancellationSignal cancellationSignal) throws FileNotFoundException;
      ...
      switch (this.mMatcher.match(uri)) {
        ...
        case 3:
          return queryRecentDocuments(
              DocumentsContract.getRootId(uri), projection, queryArgs, cancellationSignal);
        case 4:
        ...
        case 8:
          ...
          if (DocumentsContract.isManageMode(uri)) {
            return queryChildDocumentsForManage(
                DocumentsContract.getDocumentId(uri), projection, getSortClause(queryArgs));
          }
  ...
  private Bundle callUnchecked(String method, String arg, Bundle extras)
    ...
    if (!this.mAuthority.equals(authority)) {
      throw new SecurityException(
          "Requested authority " + authority + " doesn't match provider " + this.mAuthority);
    }
    if (DocumentsContract.METHOD_IS_CHILD_DOCUMENT.equals(method)) {
      ...
      out.putBoolean(
          "result", this.mAuthority.equals(childAuthority) && isChildDocument(documentId, childId));
      ...
      if (isTreeUri) {
        ...
        if (path.getRootId() != null) {
          Log.wtf(
              TAG,
              "Provider returns root id :" + path.getRootId() + " unexpectedly. Erase root id.");
