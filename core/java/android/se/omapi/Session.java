  ...
  public void close() {
    ...
    synchronized (this.mLock) {
      try {
        ...
        Log.m97e(TAG, "Error closing session", e);
      }
    }
  }
  ...
  public void closeChannels() {
    ...
    synchronized (this.mLock) {
      try {
        ...
        Log.m97e(TAG, "Error closing channels", e);
      }
    }
  }
      ...
      try {
        try {
          ISecureElementChannel channel =
              this.mSession.openBasicChannel(aid, p2, this.mReader.getSEService().getListener());
          if (channel == null) {
            return null;
          }
  ...
  public Channel openLogicalChannel(byte[] aid, byte p2) throws IOException {
    ...
    synchronized (this.mLock) {
      try {
        try {
          ISecureElementChannel channel =
              this.mSession.openLogicalChannel(aid, p2, this.mReader.getSEService().getListener());
          if (channel == null) {
            return null;
          }
          return new Channel(this.mService, this, channel);
