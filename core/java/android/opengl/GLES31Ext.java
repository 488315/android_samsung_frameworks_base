...
public class GLES31Ext {
  ...
  public static native String[] glGetDebugMessageLogKHR(
      int i, IntBuffer intBuffer, IntBuffer intBuffer2, IntBuffer intBuffer3, IntBuffer intBuffer4);

  public static native String[] glGetDebugMessageLogKHR(
      int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4, int[] iArr4, int i5);
