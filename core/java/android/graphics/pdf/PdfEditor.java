...
public final class PdfEditor {
    ...
    public void setTransformAndClip(int pageIndex, Matrix transform, Rect clip) {
        ...
        if (clip == null) {
            ...
            synchronized (PdfRenderer.sPdfiumLock) {
                nativeSetTransformAndClip(this.mNativeDocument, pageIndex, transform.m16ni(), 0, 0, size.f85x, size.f86y);
            }
            return;
        }
        synchronized (PdfRenderer.sPdfiumLock) {
            nativeSetTransformAndClip(this.mNativeDocument, pageIndex, transform.m16ni(), clip.left, clip.top, clip.right, clip.bottom);
        }
    }
