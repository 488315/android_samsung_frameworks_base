...
public final class PdfRenderer implements AutoCloseable {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native void nativeRenderPage(
      long j, long j2, long j3, int i, int i2, int i3, int i4, long j4, int i5);
  ...
  public final class Page implements AutoCloseable {
    ...
    private Page(int index) {
      ...
      synchronized (PdfRenderer.sPdfiumLock) {
        this.mNativePage =
            PdfRenderer.nativeOpenPageAndGetSize(PdfRenderer.this.mNativeDocument, index, size);
      }
      this.mIndex = index;
      this.mWidth = size.f85x;
      this.mHeight = size.f86y;
      closeGuard.open("close");
    }
    ...
    public void render(Bitmap destination, Rect destClip, Matrix transform, int renderMode) {
      ...
      if (destClip != null
          && (destClip.left < 0
              || destClip.top < 0
              || destClip.right > destination2.getWidth()
              || destClip.bottom > destination2.getHeight())) {
      ...
      long transformPtr = transform2.m16ni();
      synchronized (PdfRenderer.sPdfiumLock) {
        try {
          try {
            PdfRenderer.nativeRenderPage(
                PdfRenderer.this.mNativeDocument,
                this.mNativePage,
                destination2.getNativeInstance(),
                contentLeft,
                contentTop,
                contentRight,
                contentBottom,
