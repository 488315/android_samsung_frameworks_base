...
public class Canvas extends BaseCanvas {
  ...
  public Canvas() {
    if (!isHardwareAccelerated()) {
      ...
      this.mFinalizer =
          NoImagePreloadHolder.sRegistry.registerNativeAllocation(this, this.mNativeCanvasWrapper);
    } else {
  ...
  public int saveLayerAlpha(
    ...
    return nSaveLayerAlpha(
        this.mNativeCanvasWrapper, left, top, right, bottom, Math.min(255, Math.max(0, alpha)));
  }
  ...
  private static void checkValidClipOp(Region.EnumC0836Op op) {
    if (sCompatiblityVersion >= 28
        && op != Region.EnumC0836Op.INTERSECT
        && op != Region.EnumC0836Op.DIFFERENCE) {
      throw new IllegalArgumentException(
  ...
  public boolean clipRect(RectF rect, Region.EnumC0836Op op) {
    checkValidClipOp(op);
    return nClipRect(
        this.mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, op.nativeInt);
  }
  ...
  public boolean clipRectUnion(Rect rect) {
    return nClipRect(
        ...
        rect.right,
        rect.bottom,
        Region.EnumC0836Op.UNION.nativeInt);
  }
  ...
  public boolean clipRect(RectF rect) {
    return nClipRect(
        ...
        rect.right,
        rect.bottom,
        Region.EnumC0836Op.INTERSECT.nativeInt);
  }
  ...
  public boolean clipOutRect(RectF rect) {
    return nClipRect(
        ...
        rect.right,
        rect.bottom,
        Region.EnumC0836Op.DIFFERENCE.nativeInt);
  }
