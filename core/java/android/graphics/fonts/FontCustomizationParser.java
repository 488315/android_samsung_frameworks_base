...
public class FontCustomizationParser {
  ...
  private static Result validateAndTransformToResult(
      List<FontConfig.NamedFamilyList> families, List<FontConfig.Alias> aliases) {
    ...
    for (int i = 0; i < families.size(); i++) {
      ...
      if (name != null) {
        ...
        throw new IllegalArgumentException(
            "new-named-family requires name attribute or new-default-fallback-familyrequires"
                + " fallackTarget attribute");
      }
    }
