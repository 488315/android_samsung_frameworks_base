...
public final class SystemFonts {
    ...
    */
    public static int resolveVarFamilyType(
            android.text.FontConfig.FontFamily r10, java.lang.String r11) {
        /*
            r0 = 0
            r1 = 0
            r2 = 0
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " android.graphics.fonts.SystemFonts.resolveVarFamilyType(android.text.FontConfig$FontFamily,"
                    + " java.lang.String):int");
    }

    private static void pushFamilyToFallback(
            FontConfig.FontFamily xmlFamily,
            ArrayMap<String, NativeFamilyListSet> fallbackMap,
        ...
        FontFamily defaultFamily =
                defaultFonts.isEmpty()
                        ? null
                        : createFontFamily(
                                defaultFonts,
                                languageTags,
                                variant,
                                resolveVarFamilyType(xmlFamily, null),
                                false,
                                cache);
                ...
                if (fallback2 == null) {
                    ...
                    FontFamily family =
                            createFontFamily(
                                    ...
                                    languageTags,
                                    variant,
                                    resolveVarFamilyType(xmlFamily, name),
                                    false,
                                    cache);
                    if (family != null) {
    ...
    private static FontFamily createFontFamily(
        ...
        for (int i = 0; i < fonts.size(); i++) {
            ...
            try {
                ...
                Font font =
                        new Font.Builder(buffer, new File(fullPath), languageTags)
    ...
    private static void appendNamedFamilyList(
            FontConfig.NamedFamilyList namedFamilyList,
            ArrayMap<String, ByteBuffer> bufferCache,
            ArrayMap<String, NativeFamilyListSet> fallbackListMap) {
        ...
        for (int i = 0; i < xmlFamilies.size(); i++) {
            ...
            FontFamily family =
                    createFontFamily(
                            ...
                            xmlFamily.getLocaleList().toLanguageTags(),
                            xmlFamily.getVariant(),
                            resolveVarFamilyType(xmlFamily, null),
                            true,
                            bufferCache);
            if (family == null) {
    ...
    public static FontConfig getSystemFontConfig(
            Map<String, File> updatableFontMap, long lastModifiedDate, int configVersion) {
        String fontsXml;
        ...
        if (getSpecificSalesCode()) {
            return getSystemFontConfigInternal(
                    FONTS_ADDITIONAL_XML,
                    SYSTEM_FONT_DIR,
                    OEM_XML,
                    OEM_FONT_DIR,
                    updatableFontMap,
    ...
    public static FontConfig getSystemFontConfigForTesting(
            String fontsXml,
    ...
    public static FontConfig getSystemPreinstalledFontConfig() {
        ...
        if (getSpecificSalesCode()) {
            return getSystemFontConfigInternal(
                    FONTS_ADDITIONAL_XML, SYSTEM_FONT_DIR, OEM_XML, OEM_FONT_DIR, null, 0L, 0);
        }
        return getSystemFontConfigInternal(
                fontsXml, SYSTEM_FONT_DIR, OEM_XML, OEM_FONT_DIR, null, 0L, 0);
    }

    public static FontConfig getSystemPreinstalledFontConfigFromLegacyXml() {
        return getSystemFontConfigInternal(
                LEGACY_FONTS_XML, SYSTEM_FONT_DIR, OEM_XML, OEM_FONT_DIR, null, 0L, 0);
    }

    static FontConfig getSystemFontConfigInternal(
            String fontsXml,
    ...
    public static Map<String, FontFamily[]> buildSystemFallback(
            FontConfig fontConfig, ArrayMap<String, ByteBuffer> outBufferCache) {
            ...
            if (customizations.isEmpty()) {
                ...
                for (int j2 = 0; j2 < customizations.size(); j2++) {
                    FontConfig.Customization.LocaleFallback localeFallback2 =
                            customizations.get(j2);
                    if (localeFallback2.getOperation() == 0) {
                        pushFamilyToFallback(
                                localeFallback2.getFamily(), fallbackListMap, outBufferCache);
                    }
                }
                int j3 = 0;
                for (int j4 = 0; j4 < customizations.size(); j4++) {
                    FontConfig.Customization.LocaleFallback localeFallback3 =
                            customizations.get(j4);
                    if (localeFallback3.getOperation() == 2) {
                        pushFamilyToFallback(
                                localeFallback3.getFamily(), fallbackListMap, outBufferCache);
                        j3 = 1;
                    }
                }
                if (j3 == 0) {
                ...
                for (int j5 = 0; j5 < customizations.size(); j5++) {
                    FontConfig.Customization.LocaleFallback localeFallback4 =
                            customizations.get(j5);
                    if (localeFallback4.getOperation() == 1) {
                        pushFamilyToFallback(
                                localeFallback4.getFamily(), fallbackListMap, outBufferCache);
                    }
                }
            }
        }
    ...
    public static Map<String, Typeface> buildSystemTypefaces(
            FontConfig fontConfig, Map<String, FontFamily[]> fallbackMap) {
        ...
        for (int i = 0; i < localeList.size(); i++) {
            ...
            if (locale != null) {
                ...
                if (targetScript.equals("Hani")) {
                    if (baseScript.equals("Hanb")
                            || baseScript.equals("Hans")
                            || baseScript.equals("Hant")
                            || baseScript.equals("Kore")
                            || baseScript.equals("Jpan")) {
                        return true;
                    }
                } else if ((targetScript.equals("Hira")
                                || targetScript.equals("Hrkt")
                                || targetScript.equals("Kana"))
                        && (baseScript.equals("Jpan") || baseScript.equals("Hrkt"))) {
                    return true;
                }
            }
        }
