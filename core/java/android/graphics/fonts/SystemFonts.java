...
public final class SystemFonts {
  ...
  private static void pushFamilyToFallback(
    ...
    FontFamily defaultFamily =
        defaultFonts.isEmpty()
            ? null
            : createFontFamily(defaultFonts, languageTags, variant, false, cache);
  ...
  public static FontConfig getSystemPreinstalledFontConfig() {
    ...
    return getSystemFontConfigInternal(
        FONTS_XML, SYSTEM_FONT_DIR, OEM_XML, OEM_FONT_DIR, null, 0L, 0);
  }
  ...
  static FontConfig getSystemFontConfigInternal(
    ...
    try {
      ...
      Log.m97e(TAG, "Failed to open/read system font configurations.", e);
      return new FontConfig(
          Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), 0L, 0);
    } catch (XmlPullParserException e2) {
      Log.m97e(TAG, "Failed to parse the system font configuration.", e2);
      return new FontConfig(
          Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), 0L, 0);
    }
  }
