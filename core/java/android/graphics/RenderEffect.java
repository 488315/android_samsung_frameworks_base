...
public final class RenderEffect {
    ...
    private static native long nativeCreateBitmapEffect(
            long j, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8);
    ...
    private static class RenderEffectHolder {
        public static final NativeAllocationRegistry RENDER_EFFECT_REGISTRY =
                NativeAllocationRegistry.createMalloced(
                        RenderEffect.class.getClassLoader(), RenderEffect.nativeGetFinalizer());
    ...
    public static RenderEffect createOffsetEffect(
            float offsetX, float offsetY, RenderEffect input) {
        return new RenderEffect(
                nativeCreateOffsetEffect(offsetX, offsetY, input.getNativeInstance()));
    }

    public static RenderEffect createBlurEffect(
            float radiusX, float radiusY, RenderEffect inputEffect, Shader.TileMode edgeTreatment) {
        long nativeInputEffect = inputEffect != null ? inputEffect.mNativeRenderEffect : 0L;
        return new RenderEffect(
                nativeCreateBlurEffect(
                        radiusX, radiusY, nativeInputEffect, edgeTreatment.nativeInt));
    }

    public static RenderEffect createBlurEffect(
            float radiusX, float radiusY, Shader.TileMode edgeTreatment) {
        return new RenderEffect(
                nativeCreateBlurEffect(radiusX, radiusY, 0L, edgeTreatment.nativeInt));
    }
    ...
    public static RenderEffect createColorFilterEffect(
            ColorFilter colorFilter, RenderEffect renderEffect) {
        return new RenderEffect(
                nativeCreateColorFilterEffect(
                        colorFilter.getNativeInstance(), renderEffect.getNativeInstance()));
    }
    ...
    public static RenderEffect createBlendModeEffect(
            RenderEffect dst, RenderEffect src, BlendMode blendMode) {
        return new RenderEffect(
    ...
    public static RenderEffect createChainEffect(RenderEffect outer, RenderEffect inner) {
        return new RenderEffect(
                nativeCreateChainEffect(outer.getNativeInstance(), inner.getNativeInstance()));
    }
    ...
    public static RenderEffect createRuntimeShaderEffect(
            RuntimeShader shader, String uniformShaderName) {
        return new RenderEffect(
                nativeCreateRuntimeShaderEffect(
                        shader.getNativeShaderBuilder(), uniformShaderName));
    }
