...
public final class RenderEffect {
  ...
  public static RenderEffect createBitmapEffect(Bitmap bitmap) {
    ...
    return new RenderEffect(
        nativeCreateBitmapEffect(
            bitmap.getNativeInstance(), 0.0f, 0.0f, right, bottom, 0.0f, 0.0f, right, bottom));
  }
  ...
  public static RenderEffect createBitmapEffect(Bitmap bitmap, Rect src, Rect dst) {
    ...
    return new RenderEffect(
        nativeCreateBitmapEffect(
            bitmapHandle, left, top, right, bottom, dst.left, dst.top, dst.right, dst.bottom));
  }
  ...
  public static RenderEffect createRuntimeShaderEffect(
    ...
    return new RenderEffect(
        nativeCreateRuntimeShaderEffect(shader.getNativeShaderBuilder(), uniformShaderName));
  }
