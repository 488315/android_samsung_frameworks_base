...
public class FontListParser {
  ...
  */
  public static FontConfig readFamilies(
      ...
      String fontDir,
      FontCustomizationParser.Result customization,
      Map<String, File> updatableFontMap,
      long lastModifiedDate,
      int configVersion,
    ...
    Map<String, FontConfig.NamedFamilyList> oemNamedFamilies =
        ...
        if (tag.equals("family")) {
          ...
          if (name == null) {
            ...
            FontConfig.NamedFamilyList namedFamilyList =
                readNamedFamily(parser, fontDir, updatableFontMap, allowNonExistingFile);
          ...
          FontConfig.NamedFamilyList namedFamilyList2 =
              readNamedFamilyList(parser, fontDir, updatableFontMap, allowNonExistingFile);
  ...
  private static void throwIfAttributeExists(String attrName, XmlPullParser parser) {
    if (parser.getAttributeValue(null, attrName) != null) {
      throw new IllegalArgumentException(
          attrName
              + " cannot be used in FontFamily inside  family or family-list with name attribute.");
    }
  }
