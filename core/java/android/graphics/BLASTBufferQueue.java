...
public final class BLASTBufferQueue {
    ...
    public BLASTBufferQueue(String name, SurfaceControl sc, int width, int height, int format) {
        ...
        Log.m98i(TAG, "new BLASTBufferQueue, mName= " + this.mName + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " sc.mNativeObject= " + (sc != null ? "0x" + Long.toHexString(sc.mNativeObject) : "0") + " caller= " + Debug.getCallers(10));
    ...
    public boolean syncNextTransaction(boolean acquireSingleBuffer, Consumer<SurfaceControl.Transaction> callback) {
        Log.m98i(TAG, "syncNextTransaction, mName= " + this.mName + " acquireSingleBuffer= " + acquireSingleBuffer + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " callback= " + callback + " caller= " + Debug.getCallers(6));
    ...
    public void stopContinuousSyncTransaction() {
        Log.m98i(TAG, "stopContinuousSyncTransaction, mName= " + this.mName + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " caller= " + Debug.getCallers(6));
    ...
    public void update(SurfaceControl sc, int width, int height, int format) {
        Log.m98i(TAG, "update, w= " + width + " h= " + height + " mName = " + this.mName + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " sc.mNativeObject= " + (sc != null ? "0x" + Long.toHexString(sc.mNativeObject) : "0") + " format= " + format + " caller= " + Debug.getCallers(6));
    ...
    public void mergeWithNextTransaction(SurfaceControl.Transaction t, long frameNumber) {
        if (DEBUG_MERGE) {
            Log.m98i(TAG, "mergeWithNextTransaction, mName= " + this.mName + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " t.mNativeObject= " + (t != null ? "0x" + Long.toHexString(t.mNativeObject) : "0") + " frameNumber= " + frameNumber + " caller= " + Debug.getCallers(6));
        }
    ...
    public void mergeWithNextTransaction(long nativeTransaction, long frameNumber) {
        if (DEBUG_MERGE) {
            Log.m98i(TAG, "mergeWithNextTransaction, mName= " + this.mName + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " nativeTransaction= " + Long.toHexString(nativeTransaction) + " frameNumber= " + frameNumber + " caller= " + Debug.getCallers(6));
        }
    ...
    public void applyPendingTransactions(long frameNumber) {
        Log.m98i(TAG, "applyPendingTransactions, mName= " + this.mName + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " frameNumber= " + frameNumber + " caller= " + Debug.getCallers(6));
        nativeApplyPendingTransactions(this.mNativeObject, frameNumber);
    }

    public long getLastAcquiredFrameNum() {
        Log.m98i(TAG, "getLastAcquiredFrameNum, mName= " + this.mName + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " caller= " + Debug.getCallers(6));
    ...
    public SurfaceControl.Transaction gatherPendingTransactions(long frameNumber) {
        Log.m98i(TAG, "gatherPendingTransactions, mName= " + this.mName + " mNativeObject= 0x" + Long.toHexString(this.mNativeObject) + " frameNumber= " + frameNumber + " caller= " + Debug.getCallers(6));
