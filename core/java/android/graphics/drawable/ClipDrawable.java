...
public class ClipDrawable extends DrawableWrapper {
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.ClipDrawable);
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state != null && state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.ClipDrawable);
      try {
        try {
          updateStateFromTypedArray(a);
          verifyRequiredAttributes(a);
      ...
      if (this.mState.mThemeAttrs == null || this.mState.mThemeAttrs[1] == 0) {
        throw new XmlPullParserException(
            a.getPositionDescription()
                + ": <clip> tag requires a 'drawable' attribute or child tag defining a drawable");
      }
    }
  }
