...
public class DrawableContainer extends Drawable implements Drawable.Callback {
  ...
  public int getChangingConfigurations() {
    return super.getChangingConfigurations()
        | this.mDrawableContainerState.getChangingConfigurations();
  }
    ...
    if (this.mEnterAnimationEnd != 0 || this.mExitAnimationEnd != 0) {
      ...
      if (runnable == null) {
        this.mAnimationRunnable =
            new Runnable() { // from class: android.graphics.drawable.DrawableContainer.1
    ...
    if (drawable != null) {
      ...
      if (j != 0) {
        if (j <= now) {
          ...
          int animAlpha =
              ((int) ((j - now) * 255)) / this.mDrawableContainerState.mEnterFadeDuration;
    ...
    if (drawable2 != null) {
      ...
      if (j2 != 0) {
        if (j2 <= now) {
          ...
          int animAlpha2 =
              ((int) ((j2 - now) * 255)) / this.mDrawableContainerState.mExitFadeDuration;
  ...
  public abstract static class DrawableContainerState extends Drawable.ConstantState {
    ...
    protected DrawableContainerState(
        DrawableContainerState orig, DrawableContainer owner, Resources res) {
      this.mDensity = 160;
      ...
      if (orig != null) {
        ...
        if (origDf != null) {
          this.mDrawableFutures = origDf.m5440clone();
        } else {
