...
public class ScaleDrawable extends DrawableWrapper {
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.ScaleDrawable);
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.ScaleDrawable);
      try {
        try {
          updateStateFromTypedArray(a);
          verifyRequiredAttributes(a);
      ...
      if (this.mState.mThemeAttrs == null || this.mState.mThemeAttrs[0] == 0) {
        throw new XmlPullParserException(
            a.getPositionDescription()
                + ": <scale> tag requires a 'drawable' attribute or child tag defining a drawable");
      }
    }
  }
