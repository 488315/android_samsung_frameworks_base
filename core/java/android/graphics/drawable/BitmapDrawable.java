...
public class BitmapDrawable extends Drawable {
  ...
  public BitmapDrawable(Resources res, String filepath) {
    ...
    try {
      ...
      try {
        Bitmap bitmap =
            ImageDecoder.decodeBitmap(
                ImageDecoder.createSource(res, stream),
                new ImageDecoder
                    .OnHeaderDecodedListener() { // from class:
                                                 // android.graphics.drawable.BitmapDrawable$$ExternalSyntheticLambda1
      ...
      init(new BitmapState((Bitmap) null), res);
      if (this.mBitmapState.mBitmap == null) {
        Log.m102w("BitmapDrawable", "BitmapDrawable cannot decode " + filepath);
      }
      throw th;
    }
    if (this.mBitmapState.mBitmap == null) {
      sb = new StringBuilder();
      Log.m102w(
          "BitmapDrawable", sb.append("BitmapDrawable cannot decode ").append(filepath).toString());
    }
  }
  ...
  public BitmapDrawable(Resources res, InputStream is) {
    ...
    try {
      Bitmap bitmap =
          ImageDecoder.decodeBitmap(
              ImageDecoder.createSource(res, is),
              new ImageDecoder
                  .OnHeaderDecodedListener() { // from class:
                                               // android.graphics.drawable.BitmapDrawable$$ExternalSyntheticLambda0
                @Override // android.graphics.ImageDecoder.OnHeaderDecodedListener
                public final void onHeaderDecoded(
                    ImageDecoder imageDecoder,
                    ImageDecoder.ImageInfo imageInfo,
      ...
      init(new BitmapState((Bitmap) null), res);
      if (this.mBitmapState.mBitmap == null) {
        Log.m102w("BitmapDrawable", "BitmapDrawable cannot decode " + is);
      }
      throw th;
    }
    if (this.mBitmapState.mBitmap == null) {
      sb = new StringBuilder();
      Log.m102w("BitmapDrawable", sb.append("BitmapDrawable cannot decode ").append(is).toString());
    }
  }
  ...
  public void draw(Canvas canvas) {
    ...
    if (bitmap.getConfig() == Bitmap.Config.HARDWARE
        && View.sCapturingCanvas
        && !canvas.isHardwareAccelerated()) {
      Log.m94d("BitmapDrawable", "skip drawing hardware bitmap while capturing canvas");
      return;
    }
    BitmapState state = this.mBitmapState;
  ...
  private void updateShaderMatrix(
      Bitmap bitmap, Paint paint, Shader shader, boolean needMirroring) {
  ...
  public void getOutline(Outline outline) {
    ...
    boolean opaqueOverShape =
        (this.mBitmapState.mBitmap == null || this.mBitmapState.mBitmap.hasAlpha()) ? false : true;
  ...
  public void setTintList(ColorStateList tint) {
    ...
    if (state.mTint != tint) {
      ...
      this.mBlendModeFilter =
          updateBlendModeFilter(this.mBlendModeFilter, tint, this.mBitmapState.mBlendMode);
      invalidateSelf();
    }
  }
  ...
  public void setTintBlendMode(BlendMode blendMode) {
    ...
    if (state.mBlendMode != blendMode) {
      ...
      this.mBlendModeFilter =
          updateBlendModeFilter(this.mBlendModeFilter, this.mBitmapState.mTint, blendMode);
      invalidateSelf();
    }
  }
  ...
  public boolean isStateful() {
    return (this.mBitmapState.mTint != null && this.mBitmapState.mTint.isStateful())
        || super.isStateful();
  }
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.BitmapDrawable);
    ...
    if (state.mBitmap == null) {
      if (state.mThemeAttrs == null || state.mThemeAttrs[1] == 0) {
        throw new XmlPullParserException(
            a.getPositionDescription() + ": <bitmap> requires a valid 'src' attribute");
      }
    }
  }
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.BitmapDrawable);
      try {
        try {
  ...
  public int getOpacity() {
    Bitmap bitmap;
    return (this.mBitmapState.mGravity == 119
            && (bitmap = this.mBitmapState.mBitmap) != null
            && !bitmap.hasAlpha()
            && this.mBitmapState.mPaint.getAlpha() >= 255)
        ? -1
        : -3;
  }
  ...
  private void updateLocalState(Resources res) {
    ...
    this.mBlendModeFilter =
        updateBlendModeFilter(
            this.mBlendModeFilter, this.mBitmapState.mTint, this.mBitmapState.mBlendMode);
    computeBitmapSize();
  }
}
