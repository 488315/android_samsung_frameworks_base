...
public class NinePatchDrawable extends Drawable {
  ...
  public NinePatchDrawable(
      Resources res, Bitmap bitmap, byte[] chunk, Rect padding, String srcName) {
  ...
  public void getOutline(Outline outline) {
    ...
    if (ninePatchState != null
        ...
        && (insets = ninePatchState.mNinePatch.getBitmap().getNinePatchInsets()) != null) {
      outline.setRoundRect(
          bounds.left + this.mOutlineInsets.left,
          bounds.top + this.mOutlineInsets.top,
          bounds.right - this.mOutlineInsets.right,
          bounds.bottom - this.mOutlineInsets.bottom,
          this.mOutlineRadius);
  ...
  public Insets getOpticalInsets() {
    ...
    if (needsMirroring()) {
      return Insets.m14of(
          opticalInsets.right, opticalInsets.top, opticalInsets.left, opticalInsets.bottom);
    }
  ...
  public void setTintList(ColorStateList tint) {
    ...
    this.mBlendModeFilter =
        updateBlendModeFilter(this.mBlendModeFilter, tint, this.mNinePatchState.mBlendMode);
    invalidateSelf();
  }
  ...
  public void setTintBlendMode(BlendMode blendMode) {
    ...
    this.mBlendModeFilter =
        updateBlendModeFilter(this.mBlendModeFilter, this.mNinePatchState.mTint, blendMode);
    invalidateSelf();
  }
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.NinePatchDrawable);
  ...
  private void updateStateFromTypedArray(TypedArray a) throws XmlPullParserException {
    ...
    if (srcResId != 0) {
            ...
            ImageDecoder.decodeBitmap(
                ...
                new ImageDecoder
                  ...
                  public final void onHeaderDecoded(
                    ...
                    NinePatchDrawable.lambda$updateStateFromTypedArray$0(
                        Rect.this, imageDecoder, imageInfo, source2);
                  }
                });
        is.close();
      } catch (IOException e) {
      ...
      state.mOpticalInsets = Insets.m15of(opticalInsets);
    }
  ...
  static /* synthetic */ void lambda$updateStateFromTypedArray$0(
      Rect padding, ImageDecoder decoder, ImageDecoder.ImageInfo info, ImageDecoder.Source src) {
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.NinePatchDrawable);
      try {
        try {
          updateStateFromTypedArray(a);
  ...
  public int getOpacity() {
    Paint paint;
    return (this.mNinePatchState.mNinePatch.hasAlpha()
            || ((paint = this.mPaint) != null && paint.getAlpha() < 255))
        ? -3
        : -1;
  }
  ...
  protected boolean onStateChange(int[] stateSet) {
    ...
    if (state.mTint != null && state.mBlendMode != null) {
      this.mBlendModeFilter =
          updateBlendModeFilter(this.mBlendModeFilter, state.mTint, state.mBlendMode);
      return true;
    }
    return false;
  }
  ...
  public boolean hasFocusStateSpecified() {
    return this.mNinePatchState.mTint != null
        && this.mNinePatchState.mTint.hasFocusStateSpecified();
  }
  ...
  static final class NinePatchState extends Drawable.ConstantState {
    ...
    NinePatchState(
        NinePatch ninePatch, Rect padding, Rect opticalInsets, boolean dither, boolean autoMirror) {
      this.mNinePatch = null;
      this.mTint = null;
      this.mBlendMode = Drawable.DEFAULT_BLEND_MODE;
      this.mPadding = null;
      ...
      this.mOpticalInsets = Insets.m15of(opticalInsets);
      this.mDither = dither;
  ...
  private void computeBitmapSize() {
    ...
    if (sourceOpticalInsets != Insets.NONE) {
      int left =
          Drawable.scaleFromDensity(sourceOpticalInsets.left, sourceDensity, targetDensity, true);
      int top =
          Drawable.scaleFromDensity(sourceOpticalInsets.top, sourceDensity, targetDensity, true);
      int right =
          Drawable.scaleFromDensity(sourceOpticalInsets.right, sourceDensity, targetDensity, true);
      int bottom =
          Drawable.scaleFromDensity(sourceOpticalInsets.bottom, sourceDensity, targetDensity, true);
    ...
    this.mBitmapHeight =
        Drawable.scaleFromDensity(ninePatch.getHeight(), sourceDensity, targetDensity, true);
    this.mBitmapWidth =
        Drawable.scaleFromDensity(ninePatch.getWidth(), sourceDensity, targetDensity, true);
    NinePatch.InsetStruct insets = ninePatch.getBitmap().getNinePatchInsets();
    if (insets != null) {
      Rect outlineRect = insets.outlineRect;
      this.mOutlineInsets =
          NinePatch.InsetStruct.scaleInsets(
              outlineRect.left,
              outlineRect.top,
              outlineRect.right,
              outlineRect.bottom,
      ...
      this.mOutlineRadius =
          Drawable.scaleFromDensity(insets.outlineRadius, sourceDensity, targetDensity);
      return;
    }
    this.mOutlineInsets = null;
  }
