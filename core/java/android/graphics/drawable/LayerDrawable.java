...
public class LayerDrawable extends Drawable implements Drawable.Callback {
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.LayerDrawable);
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.LayerDrawable);
      updateStateFromTypedArray(a);
      a.recycle();
    }
    ChildDrawable[] array = state.mChildren;
    ...
    for (int i = 0; i < N; i++) {
      ...
      if (layer.mThemeAttrs != null) {
        TypedArray a2 = t.resolveAttributes(layer.mThemeAttrs, C4337R.styleable.LayerDrawableItem);
      ...
      if (type2 != 1) {
        ...
        if (depth >= innerDepth || type2 != 3) {
          if (type2 == 2
            ...
            TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.LayerDrawableItem);
              ...
              if (type != 2) {
                throw new XmlPullParserException(
                    parser.getPositionDescription()
                        + ": <item> tag requires a 'drawable' attribute or child tag defining a"
                        + " drawable");
              }
        ...
        if (cs == null) {
          ...
          if (dr.getCallback() != null) {
            Log.m103w(
                ...
                "Invalid drawable added to LayerDrawable! Drawable already belongs to another owner"
                    + " but does not expose a constant state.",
