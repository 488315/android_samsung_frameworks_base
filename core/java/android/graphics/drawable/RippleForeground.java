...
class RippleForeground extends RippleComponent {
  ...
  public RippleForeground(
      RippleDrawable owner, Rect bounds, float startingX, float startingY, boolean forceSoftware) {
    super(owner, bounds);
    this.mTargetX = 0.0f;
    this.mTargetY = 0.0f;
    this.mOpacity = 0.0f;
    ...
    this.mAnimationListener =
        new AnimatorListenerAdapter() { // from class: android.graphics.drawable.RippleForeground.1
