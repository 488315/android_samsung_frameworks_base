...
public class AnimatedImageDrawable extends Drawable implements Animatable2 {
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.AnimatedImageDrawable);
      ...
      try {
        ...
        if (!(drawable instanceof AnimatedImageDrawable)) {
          throw new XmlPullParserException(
              a.getPositionDescription() + ": <animated-image> did not decode animated");
        }
        ...
        throw new XmlPullParserException(
            a.getPositionDescription() + ": <animated-image> requires a valid 'src' attribute",
            null,
            e);
      }
    }
  ...
  public AnimatedImageDrawable(
    ...
    State state =
        new State(
            nCreate(
                nativeImageDecoder, decoder, width2, height2, colorSpaceHandle, extended, cropRect),
            inputStream,
            afd);
    this.mState = state;
  ...
  public boolean unregisterAnimationCallback(Animatable2.AnimationCallback callback) {
    ...
    if (callback == null
        || (arrayList = this.mAnimationCallbacks) == null
