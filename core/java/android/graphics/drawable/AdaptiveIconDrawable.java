    ...
    public void applyTheme(Resources.Theme t) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (layer.mThemeAttrs != null) {
                TypedArray a = t.resolveAttributes(layer.mThemeAttrs, C4337R.styleable.AdaptiveIconDrawableLayer);
            ...
            if (type2 != 1) {
                ...
                if (depth >= innerDepth || type2 != 3) {
                    if (type2 == 2 && depth <= innerDepth) {
                        ...
                        TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.AdaptiveIconDrawableLayer);
                        updateLayerFromTypedArray(layer, a);
                        a.recycle();
