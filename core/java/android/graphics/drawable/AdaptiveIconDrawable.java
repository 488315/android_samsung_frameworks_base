...
public class AdaptiveIconDrawable extends Drawable implements Drawable.Callback {
  ...
  AdaptiveIconDrawable(LayerState state, Resources res) {
    ...
    sMask = PathParser.createPathFromPathData(r.getString(C4337R.string.config_icon_mask));
  ...
  public void draw(Canvas canvas) {
    ...
    if (this.mLayersShader == null) {
      ...
      BitmapShader bitmapShader =
          new BitmapShader(this.mLayersBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      if (layer.mThemeAttrs != null) {
        TypedArray a =
            t.resolveAttributes(layer.mThemeAttrs, C4337R.styleable.AdaptiveIconDrawableLayer);
          ...
          if (type2 == 2 && depth <= innerDepth) {
            ...
            switch (tagName.hashCode()) {
              case -1905977571:
                ...
                break;
              case -1332194002:
                if (tagName.equals(WallpaperThemeConstants.NAME_BACKGROUND)) {
                  c = 0;
                  break;
                }
                c = 65535;
            ...
            TypedArray a =
                obtainAttributes(r, theme, attrs, C4337R.styleable.AdaptiveIconDrawableLayer);
            updateLayerFromTypedArray(layer, a);
            a.recycle();
              ...
              if (type != 2) {
                throw new XmlPullParserException(
                    parser.getPositionDescription()
                        + ": <foreground> or <background> tag requires a 'drawable'attribute or"
                        + " child tag defining a drawable");
              }
              layer.mDrawable =
                  Drawable.createFromXmlInnerForDensity(
                      r, parser, attrs, this.mLayerState.mSrcDensityOverride, theme);
              layer.mDrawable.setCallback(this);
  ...
  static class ChildDrawable {
    ...
    public boolean canApplyTheme() {
      ...
      return this.mThemeAttrs != null
          || ((drawable = this.mDrawable) != null && drawable.canApplyTheme());
    }
