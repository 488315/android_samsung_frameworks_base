...
public abstract class DrawableWrapper extends Drawable implements Drawable.Callback {
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.DrawableWrapper);
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.DrawableWrapper);
      updateStateFromTypedArray(a);
      a.recycle();
    }
  }
  ...
  public boolean canApplyTheme() {
    DrawableWrapperState drawableWrapperState = this.mState;
    return (drawableWrapperState != null && drawableWrapperState.canApplyTheme())
        || super.canApplyTheme();
  }
  ...
  public int getChangingConfigurations() {
    ...
    return changingConfigurations
        | (drawableWrapperState != null ? drawableWrapperState.getChangingConfigurations() : 0)
  ...
  public Drawable mutate() {
    if (!this.mMutated && super.mutate() == this) {
      ...
      if (drawableWrapperState != null) {
        ...
        drawableWrapperState.mDrawableState =
            drawable2 != null ? drawable2.getConstantState() : null;
      }
      this.mMutated = true;
    }
    return this;
  ...
  abstract static class DrawableWrapperState extends Drawable.ConstantState {
    ...
    public boolean canApplyTheme() {
      ...
      return this.mThemeAttrs != null
          || ((constantState = this.mDrawableState) != null && constantState.canApplyTheme())
          || super.canApplyTheme();
    }
