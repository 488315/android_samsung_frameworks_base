        ...
        while (true) {
            ...
            if (eventType == 2) {
                ...
                if (ANIMATED_VECTOR.equals(tagName)) {
                    TypedArray a = obtainAttributes(res, theme, attrs, C4337R.styleable.AnimatedVectorDrawable);
                    ...
                    TypedArray a2 = obtainAttributes(res, theme, attrs, C4337R.styleable.AnimatedVectorDrawableTarget);
        ...
        public void prepareLocalAnimators(AnimatorSet animatorSet, Resources res) {
            if (this.mPendingAnims != null) {
                if (res != null) {
                    ...
                    Log.m96e(AnimatedVectorDrawable.LOGTAG, "Failed to load animators. Either the AnimatedVectorDrawable must be created using a Resources object or applyTheme() must be called with a non-null Theme object.");
                }
    ...
    public static class VectorDrawableAnimatorRT implements VectorDrawableAnimator, NativeVectorDrawableAnimator {
        ...
        private static int getFrameCount(long duration) {
            ...
            if (numAnimFrames > 300) {
                Log.m102w(AnimatedVectorDrawable.LOGTAG, "Duration for the animation is too long :" + duration + ", the animation will subsample the keyframe or path data.");
                return 300;
            }
