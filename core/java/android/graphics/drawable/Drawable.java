  ...
  */
    ...
    if (is.markSupported()) {
      ...
      if (b[0] == 83 && b[1] == 80 && b[2] == 82) {
        ...
        if (SprCreateFromStream == null) {
          SprCreateFromStream =
              SprClass.getMethod(
                  "createFromStream", String.class, InputStream.class, Resources.class);
        }
        return (Drawable) SprCreateFromStream.invoke(SprClass, srcName, is, res);
      }
    }
    if (opts == null) {
  ...
  private static Drawable getBitmapDrawable(Resources res, TypedValue value, InputStream is) {
    ...
    try {
      ...
      Log.m96e("Drawable", "Unable to decode stream: " + e);
      return null;
    }
  }
  ...
  static /* synthetic */ void lambda$getBitmapDrawable$1(
    ...
    decoder.setOnPartialImageListener(
        new ImageDecoder
            .OnPartialImageListener() { // from class:
  ...
  static Drawable createFromXmlInnerForDensity(
      Resources r, XmlPullParser parser, AttributeSet attrs, int density, Resources.Theme theme)
      throws XmlPullParserException, IOException {
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
      throws XmlPullParserException, IOException {
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.Drawable);
