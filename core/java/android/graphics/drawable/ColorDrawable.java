...
public class ColorDrawable extends Drawable {
  ...
  public void setTintList(ColorStateList tint) {
    ...
    this.mBlendModeColorFilter =
        updateBlendModeFilter(this.mBlendModeColorFilter, tint, this.mColorState.mBlendMode);
    invalidateSelf();
  }
  ...
  public void setTintBlendMode(BlendMode blendMode) {
    ...
    this.mBlendModeColorFilter =
        updateBlendModeFilter(this.mBlendModeColorFilter, this.mColorState.mTint, blendMode);
    invalidateSelf();
  }
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.ColorDrawable);
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.ColorDrawable);
      updateStateFromTypedArray(a);
      a.recycle();
    }
  ...
  private void updateLocalState(Resources r) {
    this.mBlendModeColorFilter =
        updateBlendModeFilter(
            this.mBlendModeColorFilter, this.mColorState.mTint, this.mColorState.mBlendMode);
  }
}
