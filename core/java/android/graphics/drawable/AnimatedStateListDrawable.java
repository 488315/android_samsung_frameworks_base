...
public class AnimatedStateListDrawable extends StateListDrawable {
  ...
  public <T extends Drawable & Animatable> void addTransition(
      int fromId, int toId, T transition, boolean reversible) {
    if (transition == null) {
  ...
  private boolean selectTransition(int toIndex) {
    ...
    if (current instanceof AnimationDrawable) {
      ...
      transition =
          new AnimationDrawableTransition((AnimationDrawable) current, reversed, hasReversibleFlag);
    } else if (current instanceof AnimatedVectorDrawable) {
      boolean reversed2 = state.isTransitionReversed(fromId, toId);
      transition =
          new AnimatedVectorDrawableTransition(
              (AnimatedVectorDrawable) current, reversed2, hasReversibleFlag);
    } else {
  ...
  private static class AnimatableTransition extends Transition {
    ...
    /* renamed from: mA */
    private final Animatable f96mA;
  ...
  private static class AnimationDrawableTransition extends Transition {
    ...
    public AnimationDrawableTransition(
        AnimationDrawable ad, boolean reversed, boolean hasReversibleFlag) {
      super();
  ...
  private static class AnimatedVectorDrawableTransition extends Transition {
    ...
    public AnimatedVectorDrawableTransition(
        AnimatedVectorDrawable avd, boolean reversed, boolean hasReversibleFlag) {
      super();
      this.mAvd = avd;
    ...
    public void reverse() {
      if (canReverse()) {
        ...
        Log.m102w(
            AnimatedStateListDrawable.LOGTAG,
            "Can't reverse, either the reversible is set to false, or the AnimatedVectorDrawable"
                + " can't reverse");
      }
    }
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.AnimatedStateListDrawable);
  ...
  public void applyTheme(Resources.Theme theme) {
    ...
    TypedArray a =
        theme.resolveAttributes(state.mAnimThemeAttrs, C4337R.styleable.AnimatedRotateDrawable);
    updateStateFromTypedArray(a);
    a.recycle();
    init();
  }
  ...
  private int parseTransition(
    ...
    int type;
    TypedArray a =
        obtainAttributes(r, theme, attrs, C4337R.styleable.AnimatedStateListDrawableTransition);
      ...
      if (type != 2) {
        throw new XmlPullParserException(
            parser.getPositionDescription()
                + ": <transition> tag requires a 'drawable' attribute or child tag defining a"
                + " drawable");
      }
  ...
  private int parseItem(
    ...
    int type;
    TypedArray a =
        obtainAttributes(r, theme, attrs, C4337R.styleable.AnimatedStateListDrawableItem);
  ...
  static class AnimatedStateListState extends StateListDrawable.StateListState {
    ...
    AnimatedStateListState(
        AnimatedStateListState orig, AnimatedStateListDrawable owner, Resources res) {
    ...
    void mutate() {
      this.mTransitions = this.mTransitions.m5432clone();
      this.mStateIds = this.mStateIds.m5443clone();
    }
