...
public class AnimatedStateListDrawable extends StateListDrawable {
    ...
    private static class AnimatedVectorDrawableTransition extends Transition {
        ...
        public void reverse() {
            if (canReverse()) {
                ...
                Log.m102w(AnimatedStateListDrawable.LOGTAG, "Can't reverse, either the reversible is set to false, or the AnimatedVectorDrawable can't reverse");
            }
        }
    ...
    public void applyTheme(Resources.Theme theme) {
        ...
        TypedArray a = theme.resolveAttributes(state.mAnimThemeAttrs, C4337R.styleable.AnimatedRotateDrawable);
        updateStateFromTypedArray(a);
        a.recycle();
        init();
    }
    ...
    private int parseTransition(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        int type;
        TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.AnimatedStateListDrawableTransition);
    ...
    private int parseItem(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        int type;
        TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.AnimatedStateListDrawableItem);
