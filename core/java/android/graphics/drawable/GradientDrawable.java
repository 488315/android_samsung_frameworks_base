                ...
                if (depth >= innerDepth || type != 3) {
                    if (type == 2 && depth <= innerDepth) {
                        ...
                        if (name.equals(Contract.DatabaseSize.PATH)) {
                            TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawableSize);
                            updateGradientDrawableSize(a);
                            a.recycle();
                        } else if (name.equals("gradient")) {
                            TypedArray a2 = obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawableGradient);
                            updateGradientDrawableGradient(r, a2);
                            a2.recycle();
                        } else if (name.equals("solid")) {
                            TypedArray a3 = obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawableSolid);
                            updateGradientDrawableSolid(a3);
                            a3.recycle();
                        } else if (name.equals(SemSmartClipMetaTagType.STROKE)) {
                            TypedArray a4 = obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawableStroke);
                            updateGradientDrawableStroke(a4);
                            a4.recycle();
                            ...
                            TypedArray a6 = obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawablePadding);
