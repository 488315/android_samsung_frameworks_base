...
public class GradientDrawable extends Drawable {
  ...
  public void draw(Canvas canvas) {
    ...
    boolean haveStroke =
        currStrokeAlpha > 0 && (paint = this.mStrokePaint) != null && paint.getStrokeWidth() > 0.0f;
    ...
    if (haveStroke
        ...
        && st.mShape != 2
        && currStrokeAlpha < 255
        && (this.mAlpha < 255 || colorFilter3 != null)) {
      z = true;
    }
    boolean useLayer = z;
    if (useLayer) {
      ...
      canvas.saveLayer(
          this.mRect.left - rad,
          this.mRect.top - rad,
          this.mRect.right + rad,
          this.mRect.bottom + rad,
          this.mLayerPaint);
    ...
    switch (st.mShape) {
      case 0:
        if (st.mRadiusArray == null) {
          if (st.mRadius > 0.0f) {
            float rad2 =
                Math.min(st.mRadius, Math.min(this.mRect.width(), this.mRect.height()) * 0.5f);
            ...
            if (this.mFillPaint.getColor() != 0
                || colorFilter != null
                || this.mFillPaint.getShader() != null) {
  ...
  protected boolean onStateChange(int[] stateSet) {
    ...
    if (s.mTint != null && s.mBlendMode != null) {
      this.mBlendModeColorFilter =
          updateBlendModeFilter(this.mBlendModeColorFilter, s.mTint, s.mBlendMode);
      invalidateSelf = true;
    }
    if (!invalidateSelf) {
      return false;
  ...
  public void setTintList(ColorStateList tint) {
    ...
    this.mBlendModeColorFilter =
        updateBlendModeFilter(this.mBlendModeColorFilter, tint, this.mGradientState.mBlendMode);
    invalidateSelf();
  }
  ...
  public void setTintBlendMode(BlendMode blendMode) {
    ...
    this.mBlendModeColorFilter =
        updateBlendModeFilter(this.mBlendModeColorFilter, this.mGradientState.mTint, blendMode);
    invalidateSelf();
  }

  @Override // android.graphics.drawable.Drawable
  public int getOpacity() {
    return (this.mAlpha == 255 && this.mGradientState.mOpaqueOverBounds && isOpaqueForState())
        ? -1
        : -3;
  }
    ...
    if (this.mGradientIsDirty) {
      ...
      if (gradientColors != null) {
        ...
        if (st.mGradient == 0) {
          ...
          switch (C08431.f97x8f1352bc[st.mOrientation.ordinal()]) {
            case 1:
              float x02 = r.left;
              float y02 = r.top;
          ...
          this.mFillPaint.setShader(
              new LinearGradient(
                  x0, y0, x1, y1, gradientColors, st.mPositions, Shader.TileMode.CLAMP));
          ...
          this.mFillPaint.setShader(
              new RadialGradient(
                  x010, y010, radius, gradientColors, (float[]) null, Shader.TileMode.CLAMP));
  ...
  static /* synthetic */ class C08431 {
    ...
    static final /* synthetic */ int[] f97x8f1352bc;
    ...
    static {
      ...
      try {
        f97x8f1352bc[Orientation.TR_BL.ordinal()] = 2;
      } catch (NoSuchFieldError e2) {
      }
      try {
        f97x8f1352bc[Orientation.RIGHT_LEFT.ordinal()] = 3;
      } catch (NoSuchFieldError e3) {
      }
      try {
        f97x8f1352bc[Orientation.BR_TL.ordinal()] = 4;
      } catch (NoSuchFieldError e4) {
      }
      try {
        f97x8f1352bc[Orientation.BOTTOM_TOP.ordinal()] = 5;
      } catch (NoSuchFieldError e5) {
      }
      try {
        f97x8f1352bc[Orientation.BL_TR.ordinal()] = 6;
      } catch (NoSuchFieldError e6) {
      }
      try {
        f97x8f1352bc[Orientation.LEFT_RIGHT.ordinal()] = 7;
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawable);
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.GradientDrawable);
      updateStateFromTypedArray(a);
      a.recycle();
    }
  ...
  private void applyThemeChildElements(Resources.Theme t) {
    ...
    if (st.mAttrSize != null) {
      TypedArray a2 = t.resolveAttributes(st.mAttrSize, C4337R.styleable.GradientDrawableSize);
      updateGradientDrawableSize(a2);
      a2.recycle();
    }
    if (st.mAttrGradient != null) {
      a = t.resolveAttributes(st.mAttrGradient, C4337R.styleable.GradientDrawableGradient);
      try {
    ...
    if (st.mAttrSolid != null) {
      TypedArray a3 = t.resolveAttributes(st.mAttrSolid, C4337R.styleable.GradientDrawableSolid);
      updateGradientDrawableSolid(a3);
      a3.recycle();
    }
    if (st.mAttrStroke != null) {
      TypedArray a4 = t.resolveAttributes(st.mAttrStroke, C4337R.styleable.GradientDrawableStroke);
      updateGradientDrawableStroke(a4);
      a4.recycle();
    }
    if (st.mAttrCorners != null) {
      a = t.resolveAttributes(st.mAttrCorners, C4337R.styleable.DrawableCorners);
      updateDrawableCorners(a);
    }
    if (st.mAttrPadding != null) {
      a = t.resolveAttributes(st.mAttrPadding, C4337R.styleable.GradientDrawablePadding);
        ...
        if (depth >= innerDepth || type != 3) {
          if (type == 2 && depth <= innerDepth) {
            ...
            if (name.equals(Contract.DatabaseSize.PATH)) {
              TypedArray a =
                  obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawableSize);
              updateGradientDrawableSize(a);
              a.recycle();
            } else if (name.equals("gradient")) {
              TypedArray a2 =
                  obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawableGradient);
              updateGradientDrawableGradient(r, a2);
              a2.recycle();
            } else if (name.equals("solid")) {
              TypedArray a3 =
                  obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawableSolid);
              updateGradientDrawableSolid(a3);
              a3.recycle();
            } else if (name.equals(SemSmartClipMetaTagType.STROKE)) {
              TypedArray a4 =
                  obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawableStroke);
              updateGradientDrawableStroke(a4);
              a4.recycle();
            } else if (name.equals("corners")) {
              TypedArray a5 = obtainAttributes(r, theme, attrs, C4337R.styleable.DrawableCorners);
              updateDrawableCorners(a5);
              a5.recycle();
            } else if (name.equals("padding")) {
              TypedArray a6 =
                  obtainAttributes(r, theme, attrs, C4337R.styleable.GradientDrawablePadding);
              updateGradientDrawablePadding(a6);
              a6.recycle();
            } else {
              Log.m102w("drawable", "Bad element under <shape>: " + name);
            }
          }
        } else {
          return;
  ...
  private void updateGradientDrawablePadding(TypedArray a) {
    ...
    pad.set(
        a.getDimensionPixelOffset(0, pad.left),
        a.getDimensionPixelOffset(1, pad.top),
        a.getDimensionPixelOffset(2, pad.right),
        a.getDimensionPixelOffset(3, pad.bottom));
    this.mPadding = pad;
  }
  ...
  public void getOutline(Outline outline) {
    ...
    boolean useFillOpacity =
        st.mOpaqueOverShape
            && (this.mGradientState.mStrokeWidth <= 0
                || (paint = this.mStrokePaint) == null
                || paint.getAlpha() == this.mFillPaint.getAlpha());
    if (useFillOpacity) {
  ...
  static final class GradientState extends Drawable.ConstantState {
    ...
    private void applyDensityScaling(int sourceDensity, int targetDensity) {
      ...
      if (this.mOpticalInsets != Insets.NONE) {
        int left =
            Drawable.scaleFromDensity(this.mOpticalInsets.left, sourceDensity, targetDensity, true);
        int top =
            Drawable.scaleFromDensity(this.mOpticalInsets.top, sourceDensity, targetDensity, true);
        int right =
            Drawable.scaleFromDensity(
                this.mOpticalInsets.right, sourceDensity, targetDensity, true);
        int bottom =
            Drawable.scaleFromDensity(
                this.mOpticalInsets.bottom, sourceDensity, targetDensity, true);
        this.mOpticalInsets = Insets.m14of(left, top, right, bottom);
      }
      Rect rect = this.mPadding;
      if (rect != null) {
      ...
      if (fArr != null) {
        ...
        this.mRadiusArray[1] =
            Drawable.scaleFromDensity((int) r0[1], sourceDensity, targetDensity, true);
        this.mRadiusArray[2] =
            Drawable.scaleFromDensity((int) r0[2], sourceDensity, targetDensity, true);
        this.mRadiusArray[3] =
            Drawable.scaleFromDensity((int) r0[3], sourceDensity, targetDensity, true);
      }
      ...
      if (this.mStrokeDashWidth > 0.0f) {
        this.mStrokeDashWidth =
            Drawable.scaleFromDensity(this.mStrokeDashGap, sourceDensity, targetDensity);
      }
      ...
      if (this.mGradientRadiusType == 0) {
        this.mGradientRadius =
            Drawable.scaleFromDensity(this.mGradientRadius, sourceDensity, targetDensity);
      }
      int i4 = this.mWidth;
      if (i4 > 0) {
    ...
    public boolean canApplyTheme() {
      ...
      return (this.mThemeAttrs == null
              && this.mAttrSize == null
              && this.mAttrGradient == null
              && this.mAttrSolid == null
              && this.mAttrStroke == null
              && this.mAttrCorners == null
              && this.mAttrPadding == null
              && ((colorStateList = this.mTint) == null || !colorStateList.canApplyTheme())
              && (((colorStateList2 = this.mStrokeColors) == null
                      || !colorStateList2.canApplyTheme())
                  && (((colorStateList3 = this.mSolidColors) == null
                          || !colorStateList3.canApplyTheme())
                      && !mGradientColorState
                      && !super.canApplyTheme())))
          ? false
          : true;
    ...
    public int getChangingConfigurations() {
      ...
      int changingConfigurations2 =
          changingConfigurations
              | (colorStateList2 != null ? colorStateList2.getChangingConfigurations() : 0);
      ColorStateList colorStateList3 = this.mTint;
      return changingConfigurations2
          | (colorStateList3 != null ? colorStateList3.getChangingConfigurations() : 0);
    }
    ...
    public void computeOpacity() {
      ...
      if (this.mGradientColors != null) {
        ...
        while (true) {
          ...
          if (colorStateList == null
              || GradientDrawable.isOpaque(colorStateList.getDefaultColor())) {
            i++;
          } else {
            return;
          }
  ...
  private void updateLocalState(Resources res) {
    ...
    if (state.mStrokeWidth >= 0) {
      ...
      if (state.mStrokeDashWidth != 0.0f) {
        DashPathEffect e =
            new DashPathEffect(new float[] {state.mStrokeDashWidth, state.mStrokeDashGap}, 0.0f);
        this.mStrokePaint.setPathEffect(e);
      }
    }
    this.mBlendModeColorFilter =
        updateBlendModeFilter(this.mBlendModeColorFilter, state.mTint, state.mBlendMode);
    this.mGradientIsDirty = true;
