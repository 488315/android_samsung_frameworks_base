...
public class InsetDrawable extends DrawableWrapper {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.InsetDrawable);
    ...
    public void applyTheme(Resources.Theme t) {
        ...
        if (state != null && state.mThemeAttrs != null) {
            TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.InsetDrawable);
            try {
                try {
                    updateStateFromTypedArray(a);
                    verifyRequiredAttributes(a);
    ...
    public Insets getOpticalInsets() {
        ...
        getInsets(this.mTmpInsetRect);
        return Insets.m14of(contentInsets.left + this.mTmpInsetRect.left, contentInsets.top + this.mTmpInsetRect.top, contentInsets.right + this.mTmpInsetRect.right, contentInsets.bottom + this.mTmpInsetRect.bottom);
    }
    ...
    static final class InsetState extends DrawableWrapper.DrawableWrapperState {
        ...
        InsetState(InsetState orig, Resources res) {
            super(orig, res);
            if (orig != null) {
                this.mInsetLeft = orig.mInsetLeft.m1692clone();
                this.mInsetTop = orig.mInsetTop.m1692clone();
                this.mInsetRight = orig.mInsetRight.m1692clone();
                this.mInsetBottom = orig.mInsetBottom.m1692clone();
