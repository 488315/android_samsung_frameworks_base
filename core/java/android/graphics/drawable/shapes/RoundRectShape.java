...
public class RoundRectShape extends RectShape {
  ...
  @Override // android.graphics.drawable.shapes.RectShape, android.graphics.drawable.shapes.Shape
  /* renamed from: clone */
  public RoundRectShape mo1783clone() throws CloneNotSupportedException {
    RoundRectShape shape = (RoundRectShape) super.mo1783clone();
    float[] fArr = this.mOuterRadii;
  ...
  public int hashCode() {
    int result =
        Objects.hash(Integer.valueOf(super.hashCode()), this.mInset, this.mInnerRect, this.mPath);
