...
public class ShapeDrawable extends Drawable {
  ...
  public void setTintList(ColorStateList tint) {
    ...
    this.mBlendModeColorFilter =
        updateBlendModeFilter(this.mBlendModeColorFilter, tint, this.mShapeState.mBlendMode);
    invalidateSelf();
  }
  ...
  public void setTintBlendMode(BlendMode blendMode) {
    ...
    this.mBlendModeColorFilter =
        updateBlendModeFilter(this.mBlendModeColorFilter, this.mShapeState.mTint, blendMode);
    invalidateSelf();
  }
  ...
  protected boolean inflateTag(String name, Resources r, XmlPullParser parser, AttributeSet attrs) {
    ...
    TypedArray a = r.obtainAttributes(attrs, C4337R.styleable.ShapeDrawablePadding);
    setPadding(
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    TypedArray a = obtainAttributes(r, theme, attrs, C4337R.styleable.ShapeDrawable);
    ...
    while (true) {
      ...
      if (type == 2) {
        ...
        if (!inflateTag(name, r, parser, attrs)) {
          Log.m102w("drawable", "Unknown element: " + name + " for ShapeDrawable " + this);
        }
      }
    }
    updateLocalState();
  ...
  public void applyTheme(Resources.Theme t) {
    ...
    if (state.mThemeAttrs != null) {
      TypedArray a = t.resolveAttributes(state.mThemeAttrs, C4337R.styleable.ShapeDrawable);
      updateStateFromTypedArray(a);
      a.recycle();
    }
  ...
  private void updateLocalState() {
    this.mBlendModeColorFilter =
        updateBlendModeFilter(
            this.mBlendModeColorFilter, this.mShapeState.mTint, this.mShapeState.mBlendMode);
  }
}
