...
public class HardwareRenderer {
    ...
    private static class ProcessInitializer {
        ...
        private void initDisplayInfo() {
            ...
            if (dm == null) {
                Log.m94d(HardwareRenderer.LOG_TAG, "Failed to find DisplayManager for display-based configuration");
                return;
            }
            boolean z = false;
            Display defaultDisplay = dm.getDisplay(0);
            if (defaultDisplay == null) {
                Log.m94d(HardwareRenderer.LOG_TAG, "Failed to find default display for display-based configuration");
                return;
            }
