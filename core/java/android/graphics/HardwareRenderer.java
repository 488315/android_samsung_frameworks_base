...
public class HardwareRenderer {
  ...
  public static native void nInitDisplayInfo(
      int i, int i2, float f, int i3, long j, long j2, boolean z, boolean z2);
  ...
  private static native void nSetPrepareSurfaceControlForWebviewCallback(
      long j, PrepareSurfaceControlForWebviewCallback prepareSurfaceControlForWebviewCallback);
  ...
  private static class ProcessInitializer {
    ...
    private IGraphicsStatsCallback mGraphicsStatsCallback =
        new IGraphicsStatsCallback
            .Stub() { // from class: android.graphics.HardwareRenderer.ProcessInitializer.1
    ...
    private void initDisplayInfo() {
      ...
      if (allDisplays.length == 0) {
        Log.m94d(HardwareRenderer.LOG_TAG, "Failed to query displays");
        return;
      }
