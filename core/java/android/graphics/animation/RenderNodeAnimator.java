...
public class RenderNodeAnimator extends Animator {
  ...
  /* renamed from: X */
  public static final int f93X = 8;

  /* renamed from: Y */
  public static final int f94Y = 9;

  /* renamed from: Z */
  public static final int f95Z = 10;
  ...
  private void checkMutable() {
    ...
    if (this.mNativePtr == null) {
      throw new IllegalStateException(
          "Animator's target has been destroyed (trying to modify an animation after activity"
              + " destroy?)");
    }
  }
