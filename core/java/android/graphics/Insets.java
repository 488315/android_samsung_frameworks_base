...
public final class Insets implements Parcelable {
    ...
    /* renamed from: of */
    public static Insets m14of(int left, int top, int right, int bottom) {
    ...
    /* renamed from: of */
    public static Insets m15of(Rect r) {
        return r == null ? NONE : m14of(r.left, r.top, r.right, r.bottom);
    }
    ...
    public static Insets add(Insets a, Insets b) {
        return m14of(a.left + b.left, a.top + b.top, a.right + b.right, a.bottom + b.bottom);
    }
    ...
    public static Insets max(Insets a, Insets b) {
        return m14of(Math.max(a.left, b.left), Math.max(a.top, b.top), Math.max(a.right, b.right), Math.max(a.bottom, b.bottom));
    }

    public static Insets min(Insets a, Insets b) {
        return m14of(Math.min(a.left, b.left), Math.min(a.top, b.top), Math.min(a.right, b.right), Math.min(a.bottom, b.bottom));
    }
