  ...
  private static class HardwareBufferRendererHolder {
    public static final NativeAllocationRegistry REGISTRY =
        NativeAllocationRegistry.createMalloced(
            HardwareBufferRenderer.class.getClassLoader(), HardwareBufferRenderer.nGetFinalizer());
  ...
  public final class RenderRequest {
    ...
    public void draw(final Executor executor, final Consumer<RenderResult> renderCallback) {
      ...
      throw new IllegalStateException(
          "Attempt to draw with a HardwareBufferRenderer instance that has already been closed");
    }
    ...
    public RenderRequest setBufferTransform(int bufferTransform) {
      ...
      throw new IllegalArgumentException(
          "Invalid transform provided, must be one ofthe SurfaceControl.BufferTransform values");
    }
  }
