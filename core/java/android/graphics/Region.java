...
public class Region implements Parcelable {
    ...
    public final boolean union(Rect r) {
        return m21op(r, EnumC0836Op.UNION);
    }

    /* renamed from: op */
    public boolean m21op(Rect r, EnumC0836Op op) {
        return nativeOp(this.mNativeRegion, r.left, r.top, r.right, r.bottom, op.nativeInt);
    }

    /* renamed from: op */
    public boolean m20op(int left, int top, int right, int bottom, EnumC0836Op op) {
        return nativeOp(this.mNativeRegion, left, top, right, bottom, op.nativeInt);
    }

    /* renamed from: op */
    public boolean m23op(Region region, EnumC0836Op op) {
        return m24op(this, region, op);
    }

    /* renamed from: op */
    public boolean m22op(Rect rect, Region region, EnumC0836Op op) {
        return nativeOp(this.mNativeRegion, rect, region.mNativeRegion, op.nativeInt);
    }

    /* renamed from: op */
    public boolean m24op(Region region1, Region region2, EnumC0836Op op) {
