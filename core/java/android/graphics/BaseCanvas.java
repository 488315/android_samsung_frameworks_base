...
public abstract class BaseCanvas {
  ...
  private static native void nDrawBitmap(
      long j, int[] iArr, int i, int i2, float f, float f2, int i3, int i4, boolean z, long j2);
  ...
  private static native void nDrawNinePatch(
      long j, long j2, long j3, float f, float f2, float f3, float f4, long j4, int i, int i2);
  ...
  private static native void nDrawTextRun(
      long j, String str, int i, int i2, int i3, int i4, float f, float f2, boolean z, long j2);
  ...
  public void drawRoundRect(
    ...
    throwIfHasHwFeaturesInSwMode(paint);
    nDrawRoundRect(
        this.mNativeCanvasWrapper, left, top, right, bottom, rx, ry, paint.getNativeInstance());
  }
  ...
  public void drawDoubleRoundRect(
    ...
    if (innerRadii == null
      ...
      throw new IllegalArgumentException(
          "Both inner and outer radii arrays must contain exactly 8 values");
    }
    float outerLeft = outer.left;
    float outerTop = outer.top;
    float outerRight = outer.right;
  ...
  public void drawGlyphs(
    ...
    if (positionOffset < 0 || positionOffset + (glyphCount * 2) > positions.length) {
      throw new IndexOutOfBoundsException(
          "positions must have at least " + (positionOffset + (glyphCount * 2)) + " of elements");
    }
    nDrawGlyphs(
        this.mNativeCanvasWrapper,
        glyphIds,
