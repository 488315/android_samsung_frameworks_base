...
public class Path {
  ...
  private static final NativeAllocationRegistry sRegistry =
      NativeAllocationRegistry.createMalloced(Path.class.getClassLoader(), nGetFinalizer());
  ...
  /* renamed from: op */
  public boolean m17op(Path path, EnumC0830Op op) {
    return m18op(this, path, op);
  }

  /* renamed from: op */
  public boolean m18op(Path path1, Path path2, EnumC0830Op op) {
  ...
  public void addPath(Path src, Matrix matrix) {
    nAddPath(this.mNativePath, src.mNativePath, matrix.m16ni());
  }
  ...
  public void transform(Matrix matrix, Path dst) {
    nTransform(this.mNativePath, matrix.m16ni(), dst != null ? dst.mNativePath : 0L);
  }

  public void transform(Matrix matrix) {
    nTransform(this.mNativePath, matrix.m16ni());
  }
