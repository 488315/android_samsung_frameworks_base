...
public class DateSorter {
    ...
    public DateSorter(Context context) {
        ...
        this.mLabels[2] = PluralsMessageFormatter.format(resources, arguments, C4337R.string.last_num_days);
        this.mLabels[3] = context.getString(C4337R.string.last_month);
        this.mLabels[4] = context.getString(C4337R.string.older);
    }
