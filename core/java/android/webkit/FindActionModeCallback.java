...
public class FindActionModeCallback implements ActionMode.Callback, TextWatcher, View.OnClickListener, WebView.FindListener {
    ...
    public FindActionModeCallback(Context context) {
        View inflate = LayoutInflater.from(context).inflate(C4337R.layout.webview_find, (ViewGroup) null);
    ...
    private void updateMatchesString() {
        if (this.mNumberOfMatches == 0) {
            ...
            this.mMatches.setText(PluralsMessageFormatter.format(this.mResources, arguments, C4337R.string.matches_found));
        }
