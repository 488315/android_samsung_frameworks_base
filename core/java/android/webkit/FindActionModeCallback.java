...
public class FindActionModeCallback
  ...
  public FindActionModeCallback(Context context) {
    View inflate =
        LayoutInflater.from(context).inflate(C4337R.layout.webview_find, (ViewGroup) null);
    ...
    setText("");
    this.mMatches = (TextView) this.mCustomView.findViewById(C4337R.id.matches);
  ...
  private void updateMatchesString() {
    if (this.mNumberOfMatches == 0) {
      this.mMatches.setText(C4337R.string.no_matches);
    } else {
      Map<String, Object> arguments = new HashMap<>();
      arguments.put(
          Contract.Events.Projection.COUNT_ONLY, Integer.valueOf(this.mActiveMatchIndex + 1));
      arguments.put("total", Integer.valueOf(this.mNumberOfMatches));
      this.mMatches.setText(
          PluralsMessageFormatter.format(this.mResources, arguments, C4337R.string.matches_found));
    }
  ...
  public boolean onCreateActionMode(ActionMode mode, Menu menu) {
    ...
    mode.getMenuInflater().inflate(C4337R.menu.webview_find, menu);
  ...
  public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
    ...
    switch (item.getItemId()) {
      case C4337R.id.find_next /* 16909048 */:
        findNext(true);
        return true;
      case C4337R.id.find_prev /* 16909049 */:
        findNext(false);
        return true;
      default:
        return false;
