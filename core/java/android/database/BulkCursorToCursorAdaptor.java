  ...
  */
  public boolean onMove(int oldPosition, int newPosition) {
    ...
    try {
      ...
      Log.m96e(TAG, "Unable to get window because the remote process is dead");
      return false;
    }
  }
  ...
  public void deactivate() {
    ...
    if (iBulkCursor != null) {
      try {
        ...
        Log.m102w(TAG, "Remote process exception when deactivating");
      }
    }
  }
    ...
    if (iBulkCursor != null) {
      try {
        try {
          ...
          Log.m102w(TAG, "Remote process exception when closing");
        }
      } finally {
  ...
  public boolean requery() {
    ...
    try {
      ...
      Log.m96e(TAG, "Unable to requery because the remote process exception " + ex.getMessage());
      deactivate();
      return false;
    }
  }
