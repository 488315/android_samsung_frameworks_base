...
public class DatabaseUtils {
  ...
  public static final void writeExceptionToParcel(Parcel reply, Exception e) {
    ...
    if (e instanceof FileNotFoundException) {
      ...
      Log.m97e(TAG, "Writing exception to parcel", e);
      return;
    }
    reply.writeInt(code);
  ...
  */
  ...
  public static boolean queryIsEmpty(SQLiteDatabase db, String table) {
    long isEmpty =
        longForQuery(
            db,
            "select exists(select 1 from " + table + NavigationBarInflaterView.KEY_CODE_END,
            null);
    return isEmpty == 0;
  }
  ...
  public static class InsertHelper {
    ...
    private void buildSQL() throws SQLException {
      ...
      try {
        cur =
            this.mDb.rawQuery(
                "PRAGMA table_info(" + this.mTableName + NavigationBarInflaterView.KEY_CODE_END,
                null);
    ...
    public long execute() {
      ...
      try {
        try {
          ...
          Log.m97e(
              DatabaseUtils.TAG, "Error executing InsertHelper with table " + this.mTableName, e);
    ...
    if (prefixSql.equals("ROL")) {
      ...
      if (isRollbackToSavepoint) {
        Log.m102w(
            ...
            "Statement '"
                + sql2
                + "' may not work on API levels 16-27, use ';"
                + sql2
                + "' instead");
        return 99;
      }
