        ...
        private long insertInternal(ContentValues values, boolean allowReplace) {
            ...
            try {
                try {
                    ...
                    Log.m97e(DatabaseUtils.TAG, "Error inserting " + values + " into table  " + this.mTableName, e2);
        ...
        public long execute() {
            ...
            try {
                try {
                    ...
                    Log.m97e(DatabaseUtils.TAG, "Error executing InsertHelper with table " + this.mTableName, e);
    ...
    public static int getSqlStatementType(String sql) {
        ...
        if (prefixSql.equals("ROL")) {
            ...
            if (isRollbackToSavepoint) {
                Log.m102w(TAG, "Statement '" + sql2 + "' may not work on API levels 16-27, use ';" + sql2 + "' instead");
                return 99;
            }
            return 6;
        }
