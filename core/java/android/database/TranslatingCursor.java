...
public class TranslatingCursor extends CrossProcessCursorWrapper {
  ...
  public static Cursor query(
    ...
    if (!requestedTranslateColumns) {
      return qb.query(
          db, projectionIn, selection, selectionArgs, groupBy, having, sortOrder, limit, signal);
    }
    if (!requestedAuxiliaryColumn) {
      projectionIn2 =
          (String[]) ArrayUtils.appendElement(String.class, projectionIn2, config.auxiliaryColumn);
    }
