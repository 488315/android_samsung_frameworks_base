...
public final class CursorJoiner implements Iterator<Result>, Iterable<Result> {
  ...
  public CursorJoiner(
      Cursor cursorLeft, String[] columnNamesLeft, Cursor cursorRight, String[] columnNamesRight) {
  ...
  public boolean hasNext() {
    ...
    switch (C07981.$SwitchMap$android$database$CursorJoiner$Result[this.mCompareResult.ordinal()]) {
      case 1:
  ...
  private void incrementCursors() {
    if (this.mCompareResultIsValid) {
      switch (C07981.$SwitchMap$android$database$CursorJoiner$Result[
          this.mCompareResult.ordinal()]) {
        case 1:
