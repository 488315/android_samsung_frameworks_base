...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    private Set<String> mReadOnlyFlagsSet =
            new HashSet(
                    Arrays.asList(
                            Flags.FLAG_SIMPLE_SQL_COMMENT_SCANNER,
                            Flags.FLAG_SQLITE_ALLOW_TEMP_TABLES,
                            Flags.FLAG_SQLITE_APIS_35,
                            ""));
    ...
    public boolean simpleSqlCommentScanner() {
        return getValue(
                ...
                new Predicate() { // from class:
                    // android.database.sqlite.CustomFeatureFlags$$ExternalSyntheticLambda0
    ...
    public boolean sqliteAllowTempTables() {
        return getValue(
                Flags.FLAG_SQLITE_ALLOW_TEMP_TABLES,
                new Predicate() { // from class:
                    // android.database.sqlite.CustomFeatureFlags$$ExternalSyntheticLambda2
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
    ...
    public boolean sqliteApis35() {
        return getValue(
                Flags.FLAG_SQLITE_APIS_35,
                new Predicate() { // from class:
                    // android.database.sqlite.CustomFeatureFlags$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
