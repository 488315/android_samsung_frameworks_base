...
public final class SQLiteGlobal {
    ...
    public static String getDefaultJournalMode() {
        return SystemProperties.get("debug.sqlite.journalmode", Resources.getSystem().getString(C4337R.string.db_default_journal_mode));
    }

    public static int getJournalSizeLimit() {
        return SystemProperties.getInt("debug.sqlite.journalsizelimit", Resources.getSystem().getInteger(C4337R.integer.db_journal_size_limit));
    }
    ...
    public static String getDefaultSyncMode() {
        ...
        return SystemProperties.get("debug.sqlite.syncmode", Resources.getSystem().getString(C4337R.string.db_default_sync_mode));
    }
    ...
    public static String getWALSyncMode() {
        ...
        return SystemProperties.get("debug.sqlite.wal.syncmode", Resources.getSystem().getString(C4337R.string.db_wal_sync_mode));
    }

    public static int getWALAutoCheckpoint() {
        int value = SystemProperties.getInt("debug.sqlite.wal.autocheckpoint", Resources.getSystem().getInteger(C4337R.integer.db_wal_autocheckpoint));
        return Math.max(1, value);
    }

    public static int getWALConnectionPoolSize() {
        int value = SystemProperties.getInt("debug.sqlite.wal.poolsize", Resources.getSystem().getInteger(C4337R.integer.db_connection_pool_size));
        return Math.max(2, value);
    }

    public static int getIdleConnectionTimeout() {
        return SystemProperties.getInt("debug.sqlite.idle_connection_timeout", Resources.getSystem().getInteger(C4337R.integer.db_default_idle_connection_timeout));
    }
    ...
    public static long getWALTruncateSize() {
        ...
        return SystemProperties.getInt("debug.sqlite.wal.truncatesize", Resources.getSystem().getInteger(C4337R.integer.db_wal_truncate_size));
    }
