...
public final class SQLiteDatabaseConfiguration {
  ...
  public SQLiteDatabaseConfiguration(String path, int openFlags) {
    ...
    SQLiteDatabaseSharedConfiguration sQLiteDatabaseSharedConfiguration =
        new SQLiteDatabaseSharedConfiguration(this);
  ...
  public void updateParametersFrom(SQLiteDatabaseConfiguration other) {
    ...
    this.customScalarFunctions.putAll(
        (ArrayMap<? extends String, ? extends UnaryOperator<String>>) other.customScalarFunctions);
