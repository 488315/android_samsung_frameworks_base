...
public class WrapFileClipData implements Serializable {
  ...
  private Object loadData() {
    ...
    if (file != null
        && file.getAbsolutePath().contains(CompatabilityHelper.OLD_CLIPBOARD_ROOT_PATH)) {
      this.mPath =
          new File(CompatabilityHelper.replacePathForCompatability(this.mPath.getAbsolutePath()));
      this.mDir =
          new File(CompatabilityHelper.replacePathForCompatability(this.mDir.getAbsolutePath()));
    }
