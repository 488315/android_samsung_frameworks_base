...
public class ClipboardDataBitmapUtil {
    ...
    public static Bitmap downloadSimpleBitmap(String urlname, int reqWidth, int reqHeight) {
        ...
        try {
            ...
            android.util.Log.m94d(TAG, "Return null because received bitmap size is invalid. bitmapOption.outWidth :" + bitmapOption.outWidth + ", bitmapOption.outHeight :" + bitmapOption.outHeight);
            return result;
        } catch (IOException e) {
    ...
    public static Bitmap getFilePathBitmap(String fileName, int reqWidth, int reqHeight) {
        ...
        try {
            ...
            android.util.Log.m98i(TAG, "Return null because received bitmap size is invalid. bitmapOption.outWidth :" + bitmapOption.outWidth + ", bitmapOption.outHeight :" + bitmapOption.outHeight);
            return result;
        } catch (Exception e) {
