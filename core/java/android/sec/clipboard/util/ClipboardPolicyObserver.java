...
public class ClipboardPolicyObserver extends ContentObserver {
    ...
    */
    private void updateClipboardDenyListMap(int userId) {
        ...
        try {
            try {
                cursor = this.mContext.getContentResolver().query(CLIPBOARD_APPLICATION_URI, null, "getPackagesFromDisableClipboardBlackListPerUidInternal", selectionArgs, null);
                if (cursor != null) {
    ...
    */
    private void updateClipboardAllowListMap(int userId) {
        ...
        try {
            try {
                cursor = this.mContext.getContentResolver().query(CLIPBOARD_APPLICATION_URI, null, "getPackagesFromDisableClipboardWhiteListPerUidInternal", selectionArgs, null);
                if (cursor != null) {
                    Bundle bundle = cursor.getExtras();
                    if (bundle != null) {
