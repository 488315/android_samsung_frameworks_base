...
public class PhoneRestrictionPolicy {
  ...
  public boolean getEmergencyCallOnly(boolean allAdmins) {
    try {
      ...
      Log.m94d(TAG, "PXY-getEmergencyCallOnly returning default value");
      return false;
    }
  }
  ...
  public boolean addNumberOfIncomingCalls() {
    try {
      ...
      Log.m94d(TAG, "PXY-addNumberOfIncomingCalls returning default value");
      return false;
    }
  }
  ...
  public boolean addNumberOfOutgoingCalls() {
    try {
      ...
      Log.m94d(TAG, "PXY-addNumberOfOutgoingCalls returning default value");
      return false;
    }
  }
  ...
  public boolean isLimitNumberOfSmsEnabled() {
    try {
      ...
      Log.m94d(TAG, "PXY-isLimitNumberOfSmsEnabled returning default value");
      return false;
    }
  }
  ...
  public boolean addNumberOfIncomingSms() {
    try {
      ...
      Log.m94d(TAG, "PXY-addNumberOfIncomingSms returning default value");
      return false;
    }
  }
  ...
  public boolean addNumberOfOutgoingSms() {
    try {
      ...
      Log.m94d(TAG, "PXY-addNumberOfOutgoingSms returning default value");
      return false;
    }
  }
  ...
  public boolean decreaseNumberOfOutgoingSms() {
    try {
      ...
      Log.m94d(TAG, "PXY-decreaseNumberOfOutgoingSms returning default value");
      return false;
    }
  }
  ...
  public boolean canOutgoingSms(String phoneNumber) {
    try {
      ...
      Log.m94d(TAG, "PXY-canOutgoingSms returning default value");
      return true;
    }
  }
  ...
  public boolean canIncomingSms(String phoneNumber) {
    try {
      ...
      Log.m94d(TAG, "PXY-canIncomingSms returning default value");
      return true;
    }
  }
  ...
  public boolean isSmsPatternCheckRequired() {
    try {
      ...
      Log.m94d(TAG, "PXY-isSmsPatternCheckRequired returning default value");
      return false;
    }
  }
  ...
  public boolean isIncomingSmsAllowed() {
    try {
      ...
      Log.m94d(TAG, "PXY-isIncomingSmsAllowed returning default value");
      return true;
    }
  }
  ...
  public boolean isOutgoingSmsAllowed() {
    try {
      ...
      Log.m94d(TAG, "PXY-isOutgoingSmsAllowed returning default value");
      return true;
    }
  }
  ...
  public boolean isIncomingMmsAllowed() {
    try {
      ...
      Log.m94d(TAG, "PXY-isIncomingMmsAllowed returning default value");
      return true;
    }
  }
  ...
  public boolean isBlockSmsWithStorageEnabled() {
    try {
      ...
      Log.m95d(TAG, "PXY-isBlockSmsWithStorageEnabled returning default value", e);
      return false;
    }
  }
  ...
  public boolean isBlockMmsWithStorageEnabled() {
    try {
      ...
      Log.m95d(TAG, "PXY-isBlockMmsWithStorageEnabled returning default value", e);
      return false;
    }
  }
  ...
  public void storeBlockedSmsMms(
    ...
    try {
      ...
      Log.m94d(TAG, "PXY-storeBlockedSmsMms fail to save sms/mms");
    }
  }
  ...
  public boolean isWapPushAllowed() {
    try {
      ...
      Log.m94d(TAG, "PXY-isWapPushAllowed returning default value");
      return true;
    }
  }
  ...
  public boolean isCopyContactToSimAllowed(int message) {
    try {
      ...
      Log.m103w(TAG, "PXY-isCopyContactToSimAllowed returning default value ", e);
      return true;
    }
  }
  ...
  public boolean isIncomingSmsAllowedFromSimSlot(int slotNum) {
    try {
      ...
      Log.m103w(TAG, "PXY-isIncomingSmsAllowedFromSimSlot returning default value ", e);
      return true;
    }
  }
  ...
  public boolean isOutgoingSmsAllowedFromSimSlot(int slotNum) {
    try {
      ...
      Log.m103w(TAG, "PXY-isOutgoingSmsAllowedFromSimSlot returning default value ", e);
      return true;
    }
  }
  ...
  public boolean isMmsAllowedFromSimSlot(int slotNum) {
    try {
      ...
      Log.m103w(TAG, "PXY-isMmsAllowedFromSimSlot returning default value ", e);
      return true;
    }
  }
  ...
  public boolean isOutgoingCallAllowedFromSimSlot(int simSlot) {
    try {
      ...
      Log.m103w(TAG, "PXY-phoneRestrictionPolicy returning default value ", e);
      return true;
    }
  }
  ...
  public boolean isIncomingCallAllowedFromSimSlot(int simSlot) {
    try {
      ...
      Log.m103w(TAG, "PXY-isIncomingCallAllowedFromSimSlot returning default value ", e);
      return true;
    }
  }
  ...
  public boolean canOutgoingCall(String dialNumber) {
    try {
      ...
      Log.m103w(TAG, "PXY-canOutgoingCall returning default value ", e);
      return true;
    }
  }
  ...
  public boolean canIncomingCall(String dialNumber) {
    try {
      ...
      Log.m103w(TAG, "PXY-canIncomingCall returning default value ", e);
      return true;
    }
  }
  ...
  public boolean isDataAllowedFromSimSlot(int simSlot) {
    try {
      ...
      Log.m103w(TAG, "PXY-isDataAllowedFromSimSlot returning default value ", e);
      return true;
    }
  }
}
