...
public class BrowserPolicy {
    ...
    public boolean getCookiesSetting() {
        try {
            ...
            Log.m94d(TAG, "PXY-getCookiesSetting returning default value");
            return true;
        }
    }
    ...
    public boolean getAutoFillSetting() {
        try {
            ...
            Log.m94d(TAG, "PXY-getAutoFillSetting returning default value");
            return true;
        }
    }
    ...
    public boolean getJavaScriptSetting() {
        try {
            ...
            Log.m94d(TAG, "PXY-getJavaScriptSetting returning default value");
            return true;
        }
    }
    ...
    public boolean getPopupsSetting() {
        try {
            ...
            Log.m94d(TAG, "PXY-getPopupsSetting returning default value");
        }
        return true;
    }
}
