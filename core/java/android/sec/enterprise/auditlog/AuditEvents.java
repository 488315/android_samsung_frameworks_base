...
public class AuditEvents {
  ...
  public static final String AUDIT_ADMIN_CREATED_DUALDAR_WITH_CONFIGURATION =
      "Admin created DualDAR with configuration, Type: %s, Version: %s, Lock Timeout: %s, Device"
          + " Encryption storage access restriction: %s, Whitelisted Packages: %s";
  ...
  public static final String AUDIT_ADMIN_HAS_ADDED_ACCOUNT_TO_THE_ADDITION_BLACKLIST =
      "Admin %d has added account %s to the addition blacklist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_ACCOUNT_TO_THE_ADDITION_WHITELIST =
      "Admin %d has added account %s to the addition whitelist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_ACCOUNT_TO_THE_REMOVAL_BLACKLIST =
      "Admin %d has added account %s to the removal blacklist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_ACCOUNT_TO_THE_REMOVAL_WHITELIST =
      "Admin %d has added account %s to the removal whitelist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_APPROVED_INSTALLER_BLACKLIST =
      "Admin %d has added approved installer blacklist %s.";
  public static final String AUDIT_ADMIN_HAS_ADDED_APPROVED_INSTALLER_WHITELIST =
      "Admin %d has added approved installer whitelist %s.";
  public static final String AUDIT_ADMIN_HAS_ADDED_SSID_TO_THE_RESTRICTION_BLACKLIST =
      "Admin %d has added SSID %s to the restriction blacklist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_SSID_TO_THE_RESTRICTION_WHITELIST =
      "Admin %d has added SSID %s to the restriction whitelist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_TO_APP_SIGNATURE_BLACKLIST =
      "Admin %d has added %s to app signature blacklist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_TO_APP_SIGNATURE_WHITELIST =
      "Admin %d has added %s to app signature whitelist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_TO_CAMERA_ALLOWLIST =
      "Admin %d has added %s : %s to camera allowlist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_TO_PACKAGE_NAME_BLACKLIST =
      "Admin %d has added %s to package name blacklist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_TO_PACKAGE_NAME_WHITELIST =
      "Admin %d has added %s to package name whitelist.";
  public static final String AUDIT_ADMIN_HAS_ADDED_TO_PERMISSION_BLACKLIST =
      "Admin %d has added %s to permission blacklist.";
  ...
  /* renamed from: AUDIT_ADMIN_HAS_ALLOWED_INSTALLATION_OF_NON_GOOGLE_PLAY_APPLICATION */
  public static final String f427x167c7286 =
  ...
  /* renamed from: AUDIT_ADMIN_HAS_ALLOWED_SHARING_CLIPBOARD_TO_OWNER_FROM_WORKSPACE */
  public static final String f428x5704a1f4 =
  ...
  /* renamed from: AUDIT_ADMIN_HAS_CHANGED_PASSWORD_MAXIMUM_CHARACTER_SEQUENCE_LENGTH */
  public static final String f429xce172f4f =
  ...
  public static final String AUDIT_ADMIN_HAS_DISABLED_AUTOSYNC_OF_GOOGLE_ACCOUNT =
  ...
  /* renamed from: AUDIT_ADMIN_HAS_DISALLOWED_INSTALLATION_OF_NON_GOOGLE_PLAY_APPLICATION */
  public static final String f430x567c51aa =
  ...
  /* renamed from: AUDIT_ADMIN_HAS_DISALLOWED_SHARING_CLIPBOARD_TO_OWNER_FROM_WORKSPACE */
  public static final String f431xbef9fa18 =
  ...
  public static final String AUDIT_ADMIN_HAS_ENABLED_AUTOSYNC_OF_GOOGLE_ACCOUNT =
  ...
  public static final String AUDIT_ADMIN_HAS_REMOVED_ACCOUNT_FROM_ADDITION_BLACKLIST =
      "Admin %d has removed account %s from addition blacklist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ACCOUNT_FROM_ADDITION_WHITELIST =
      "Admin %d has removed account %s from addition whitelist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ACCOUNT_FROM_REMOVAL_BLACKLIST =
      "Admin %d has removed account %s from removal blacklist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ACCOUNT_FROM_REMOVAL_WHITELIST =
      "Admin %d has removed account %s from removal whitelist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ALL_ACCOUNTS_FROM_ADDITION_BLACKLIST =
      "Admin %d has removed all accounts from addition blacklist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ALL_ACCOUNTS_FROM_ADDITION_WHITELIST =
      "Admin %d has removed all accounts from addition whitelist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ALL_ACCOUNTS_FROM_REMOVAL_BLACKLIST =
      "Admin %d has removed all accounts from removal blacklist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ALL_ACCOUNTS_FROM_REMOVAL_WHITELIST =
      "Admin %d has removed all accounts from removal whitelist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ALL_SSIDS_FROM_THE_RESTRICTION_WHITELIST =
      "Admin %d has removed all SSIDs from the restriction whitelist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_ALL_SSID_FROM_THE_RESTRICTION_BLACKLIST =
  ...
  public static final String AUDIT_ADMIN_HAS_REMOVED_APPROVED_INSTALLER_FROM_BLACKLIST =
      "Admin %d has removed approved installer from blacklist %s.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_APPROVED_INSTALLER_FROM_WHITELIST =
      "Admin %d has removed approved installer from whitelist %s.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_FROM_APP_SIGNATURE_BLACKLIST =
      "Admin %d has removed %s from app signature blacklist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_FROM_APP_SIGNATURE_WHITELIST =
      "Admin %d has removed %s from app signature whitelist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_FROM_CAMERA_ALLOWLIST =
      "Admin %d has removed %s : %s from camera allowlist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_FROM_PACKAGE_NAME_BLACKLIST =
      "Admin %d has removed %s from package name blacklist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_FROM_PACKAGE_NAME_WHITELIST =
      "Admin %d has removed %s from package name whitelist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_FROM_PERMISSION_BLACKLIST =
      "Admin %d has removed %s from permission blacklist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_SSID_FROM_THE_RESTRICTION_BLACKLIST =
      "Admin %d has removed SSID %s from the restriction blacklist.";
  public static final String AUDIT_ADMIN_HAS_REMOVED_SSID_FROM_THE_RESTRICTION_WHITELIST =
  ...
  /* renamed from: AUDIT_ADMIN_HAS_REQUESTED_TO_DELETE_CERTIFICATE_KEYSTORE_ALIAS_SUBJECT_ISSUER */
  public static final String f432xa8c63d56 =
      "Admin %d has requested to delete a certificate. Keystore(s) : %s, Alias : %s, Subject : %s,"
          + " Issuer : %s";
  ...
  /* renamed from: AUDIT_ADMIN_HAS_REQUESTED_TO_INSTALL_CERTIFICATE_KEYSTORE_AND_NAME */
  public static final String f433x6d918f4a =
  ...
  /* renamed from: AUDIT_APPLICATION_ACTION_FAILED_BECAUSE_OF_SIGNATURE_VERIFICATION_FAILURE */
  public static final String f434xec27a0b0 =
  ...
  public static final String AUDIT_APPLICATION_INSTALLATION_ALLOWED_BY_ADMIN_BLACKLIST =
      "Application %s installation is allowed by admin %s %s blacklist.";
  public static final String AUDIT_APPLICATION_INSTALLATION_ALLOWED_BY_ADMIN_WHITELIST =
      "Application %s installation is allowed by admin %s %s whitelist.";

  /* renamed from: AUDIT_APPLICATION_INSTALLATION_IS_ALLOWED_BY_ADMIN_FOR_SEPARATED_APPS */
  public static final String f435x27fbb384 =
      "Application %s installation is allowed by admin %s for Separated Apps";

  /* renamed from: AUDIT_APPLICATION_INSTALLATION_NOT_ALLOWED_BECAUSE_SIGNED_UNTRUSTED_CA */
  public static final String f436x7b060974 =
      "Application %s installation is not allowed because it is signed by untrusted CA";
  public static final String AUDIT_APPLICATION_INSTALLATION_NOT_ALLOWED_BY_ADMIN_BLACKLIST =
      "Application %s installation is not allowed by admin %s %s blacklist.";
  public static final String AUDIT_APPLICATION_INSTALLATION_NOT_ALLOWED_BY_ADMIN_WHITELIST =
      "Application %s installation is not allowed by admin %s %s whitelist.";
  ...
  public static final String AUDIT_CERTIFICATE_REVOCATION =
      "Certificate revocation : enableOcspCheck() or enableRevocationCheck() should be set on all"
          + " packages.";
  ...
  /* renamed from: AUDIT_CONNECTION_WITH_VPN_VENDOR_SERVICE_STOPPED_FOR_PROFILE_AFTER_REMOVING_ALL_THE_PACKAGES */
  public static final String f437xf388e19c =
      "Connection with vpn vendor service stopped for profile %s after removing all the packages";
  ...
  /* renamed from: AUDIT_ERROR_ADDING_VPN_PROFILE_INFO_IN_DATABASE_WHILE_ACTIVATING_PROFILE */
  public static final String f438x5b7f4dbf =
      "Error adding vpn profile info in database while activating profile %s";

  /* renamed from: AUDIT_ERROR_ADDING_VPN_PROFILE_INFO_IN_DATABASE_WHILE_DEACTIVATING_PROFILE */
  public static final String f439x24758ac0 =
      "Error adding vpn profile info in database while deactivating profile %s";

  /* renamed from: AUDIT_ERROR_GETTING_BINDER_FOR_PROFILE_VENDOR_SERVICE_MIGHT_NOT_BE_RUNNING */
  public static final String f440xc9e14a4d =
  ...
  public static final String AUDIT_ERROR_OCCURRED_WHILE_REMOVING_VPN_PROFILE =
      "Error occurred while removing vpn profile %s. Stop vpn connection before removing profile";

  /* renamed from: AUDIT_ERROR_OCCURRED_WHILE_VALIDATING_PROFILE_INFORMATION_FOR_VENDOR */
  public static final String f441xe8f1d046 =
      "Error occurred while validating profile information for vendor %s";

  /* renamed from: AUDIT_ERROR_RECEIVED_FROM_VENDOR_WHILE_CREATING_VPN_CONNECTION_FOR_PROFILE */
  public static final String f442x8205cc10 =
      "Error received from vendor while creating vpn connection for profile %s";

  /* renamed from: AUDIT_ERROR_RECEIVED_FROM_VENDOR_WHILE_REMOVING_VPN_CONNECTION_FOR_PROFILE */
  public static final String f443xf94f0188 =
  ...
  /* renamed from: AUDIT_ERROR_VALIDATING_INFORMATION_FROM_PROFILE_BEFORE_ACTIVATION */
  public static final String f444x4dd7f7af =
  ...
  /* renamed from: AUDIT_EXCEPTION_STOPPING_CONNECTION_FOR_PROFILE_AFTER_REMOVING_ALL_CONTAINER_PACKAGES */
  public static final String f445xe9808eae =
      "Exception stopping connection for profile %s after removing all container packages";

  /* renamed from: AUDIT_EXCEPTION_STOPPING_CONNECTION_FOR_PROFILE_AFTER_REMOVING_ALL_PACKAGES */
  public static final String f446x420fc50 =
      "Exception stopping connection for profile %s after removing all packages";

  /* renamed from: AUDIT_EXCEPTION_STOPPING_CONNECTION_FOR_PROFILE_AFTER_REMOVING_PACKAGES_FROM_VPN */
  public static final String f447xfe41a28c =
      "Exception stopping connection for profile %s after removing packages from vpn";

  /* renamed from: AUDIT_EXCEPTION_STOPPING_CONNECTION_FOR_PROFILE_AFTER_REMOVING_PACKAGE_LIST_BY_UID */
  public static final String f448xc3292a6b =
  ...
  /* renamed from: AUDIT_EXCEPTION_WHILE_REMOVING_ALL_CONTAINER_PACKAGES_FROM_VPN_FOR_PROFILE */
  public static final String f449x39984fed =
  ...
  /* renamed from: AUDIT_EXCEPTION_WHILE_REMOVING_PACKAGES_EXEMPTED_FROM_VPN_AFTER_UNINSTALLATION_FOR_PROFILE */
  public static final String f450x49054ebf =
      "Exception while removing packages exempted from vpn after uninstallation for profile %s";

  /* renamed from: AUDIT_EXCEPTION_WHILE_REMOVING_PACKAGES_FROM_VPN_AFTER_UNINSTALLATION_FOR_PROFILE */
  public static final String f451xe31e2414 =
  ...
  /* renamed from: AUDIT_NOT_ALLOWED_TO_START_CONNECTION_FOR_PROFILE_CHECK_VPN_AND_PROFILE_STATUS */
  public static final String f452x7f8a5fa5 =
  ...
  /* renamed from: AUDIT_PACKAGE_NAME_ADDED_TO_VPN_FOR_PROFILE_REMOVED_FROM_EXEMPT_LIST */
  public static final String f453x68625e4d =
  ...
  /* renamed from: AUDIT_PACKAGE_NAME_REMOVED_TO_VPN_FOR_PROFILE_ADDED_FROM_EXEMPT_LIST */
  public static final String f454xf2a0300d =
  ...
  public static final String AUDIT_PASSWORD_QUALITY =
      "Password quality : setPasswordQuality() should be set between alphanumeric and complex.";
  ...
  public static final String AUDIT_SCREEN_LOCK =
      "Screen lock : Screen lock should be set to Password above alphanumeric (Biometric lock is"
          + " available)";
  public static final String AUDIT_SCREEN_LOCK_OK = "Screen lock : OK";
  public static final String AUDIT_SD_CARD_STATUS =
      "SD card status : setRequireStorageCardEncryption() should be set to true, setSdCardState()"
          + " should be set to false or DISALLOW_MOUNT_PHYSICAL_MEDIA should be set to"
          + " addUserRestriction().";
  ...
  /* renamed from: AUDIT_SENDING_FILE_NAME_VIA_BLUETOOTH_OBEX_FAILED_DEVICE_NOT_ALLOWED */
  public static final String f455xdbde4778 =
  ...
  public static final String AUDIT_SMART_LOCK =
      "Smart lock : KEYGUARD_DISABLE_TRUST_AGENTS should be set to setKeyguardDisabledFeatures().";
  ...
  /* renamed from: AUDIT_SUCCESS_REMOVING_UID_FROM_EXEMPTED_LIST_AFTER_UNINSTALLATION_FOR_PROFILE */
  public static final String f456x3fcfe3b2 =
  ...
  /* renamed from: AUDIT_SUCCESS_WHILE_REMOVING_ALL_THE_PACKAGES_FROM_VPN_FOR_PROFILE */
  public static final String f457x56dcae29 =
  ...
  public static final String AUDIT_USER_ACTION_PAIRING_BLUETOOTH_FAILED_USER_CANCELED =
      "User Interaction: User action pairing bluetooth device %s failed. Reason: User canceled";
  ...
  /* renamed from: AUDIT_USER_HAS_CHANGED_THE_BLUETOOTH_PROFILE_ON_BLUETOOTH_DEVICE_TO_DISABLED */
  public static final String f458xe5c17a53 =
      "User has changed the bluetooth profile %s, on bluetooth device %s, to disabled.";

  /* renamed from: AUDIT_USER_HAS_CHANGED_THE_BLUETOOTH_PROFILE_ON_BLUETOOTH_DEVICE_TO_ENABLED */
  public static final String f459x5ca0f06a =
      "User has changed the bluetooth profile %s, on bluetooth device %s, to enabled.";
  ...
  /* renamed from: AUDIT_USER_HAS_EXCEEDED_NUMBER_OF_AUTHENTICATION_FAILURE_LIMIT_WHEN_USING_AUTHENTICATION */
  public static final String f460x1202c1c1 =
      "User %d has exceeded number of authentication failure limit when using %s authentication";

  /* renamed from: AUDIT_USER_HAS_EXCEEDED_NUMBER_OF_AUTHENTICATION_FAILURE_LIMIT_WHEN_USING_PATTERN_AUTHENTICATION */
  public static final String f461xeb979170 =
  ...
  /* renamed from: AUDIT_USER_INTERACTION_DISCOVERABLE_MODE_STATUS_HAS_FAILED_TO_CHANGE_REASON_MDM_POLICY */
  public static final String f462x713805be =
      "User Interaction: Discoverable mode status has failed to change to discoverable. Reason: MDM"
          + " policy";

  /* renamed from: AUDIT_USER_INTERACTION_ENABLING_BLUETOOTH_FAILED_REASON_MDM_POLICY */
  public static final String f463xaad9bfc7 =
  ...
  /* renamed from: AUDIT_USER_INTERACTION_STATUS_HAS_SUCCESSFULLY_CHANGED_TO_DISCOVERABLE */
  public static final String f464x68670759 =
      "User Interaction: Discoverable mode status has successfully changed to discoverable";

  /* renamed from: AUDIT_USER_INTERACTION_STATUS_HAS_SUCCESSFULLY_CHANGED_TO_NOT_DISCOVERABLE */
  public static final String f465xb46ec265 =
      "User Interaction: Discoverable mode status has successfully changed to not discoverable";
