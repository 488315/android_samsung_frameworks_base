...
public class RestrictionPolicy {
    ...
    public boolean isClipboardAllowed(boolean showMsg) {
        try {
            ...
            Log.m94d(TAG, "PXY-isClipboardAllowed returning default value");
            return true;
        }
    }
    ...
    public boolean isBackupAllowed(boolean showMsg) {
        try {
            ...
            Log.m94d(TAG, "PXY-isBackupAllowed returning default value");
            return true;
        }
    }
    ...
    public boolean isFactoryResetAllowed() {
        try {
            ...
            Log.m103w(TAG, "PXY-isFactoryResetAllowed returning default value", e);
            return true;
        }
    }
