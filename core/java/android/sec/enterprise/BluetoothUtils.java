...
public class BluetoothUtils {
    ...
    public static boolean isSocketAllowedBySecurityPolicy(
        ...
        if (1 == aPortType
                && (!service.getAllowBluetoothDataTransfer(true)
                        || !service.isProfileEnabled(128))) {
            Log.w(
                    "BluetoothUtils",
    ...
    private static boolean getBluetoothProfileEnabled(ParcelUuid uuid) {
        ...
        if (profile != -1) {
            return EnterpriseDeviceManager.getInstance()
                    .getBluetoothPolicy()
    ...
    public static boolean isSvcRfComPortNumberBlockedBySecurityPolicy(int aPortNum) {
        ...
        String[][] RESERVED_RFCOMM_CHANNELS = {
            new String[] {
                AudioParameter.VALUE_VM_CSD_500_WARNING,
                BluetoothPolicy.BluetoothUUID.OBEXOBJECTPUSH_UUID
            },
