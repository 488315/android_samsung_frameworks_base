...
public class BluetoothPolicy {
  ...
  public boolean getAllowBluetoothDataTransfer(boolean showMsg) {
    try {
      ...
      Log.m94d(TAG, "PXY-getAllowBluetoothDataTransfer returning default value");
      return true;
    }
  }
  ...
  public boolean isOutgoingCallsAllowed() {
    try {
      ...
      Log.m94d(TAG, "PXY-isOutgoingCallsAllowed returning default value");
      return true;
    }
  }
  ...
  public boolean isBluetoothUUIDAllowed(String uuid) {
    try {
      ...
      Log.m94d(TAG, "PXY-isBluetoothUUIDAllowed returning default value");
      return true;
    }
  }
  ...
  public boolean isProfileEnabled(int profile) {
    try {
      ...
      Log.m94d(TAG, "PXY-isProfileEnabled returning default value");
      return true;
    }
  }
  ...
  public boolean isBluetoothDeviceAllowed(String deviceAddress) {
    try {
      ...
      Log.m94d(TAG, "PXY-isBluetoothDeviceAllowed returning default value");
      return true;
    }
  }
  ...
  public boolean isPairingEnabled() {
    try {
      ...
      Log.m94d(TAG, "PXY-isPairingEnabled returning default value");
      return true;
    }
  }
  ...
  public boolean isDiscoverableEnabled() {
    try {
      ...
      Log.m94d(TAG, "PXY-isDiscoverableEnabled returning default value");
      return true;
    }
  }
  ...
  public boolean isBluetoothEnabled() {
    try {
      ...
      Log.m94d(TAG, "PXY-isBluetoothEnabled returning default value");
      return true;
    }
  }
  ...
  public boolean isBluetoothLogEnabled() {
    try {
      ...
      Log.m94d(TAG, "PXY-isBluetoothLogEnabled returning default value");
      return false;
    }
  }
  ...
  public void bluetoothLog(String tag, String msg) {
    try {
      ...
      Log.m94d(TAG, "PXY-bluetoothLog returning default value");
    }
  }
}
