...
public final class UidPermissionPolicy extends SchemePolicy {
    ...
    */
    public final void addPermissions(MutateStateScope mutateStateScope, PackageState packageState, ArraySet arraySet) {
        List list;
        int i;
        ...
        while (i4 < size) {
            ...
            Permission permission = parsedPermission.isTree() ? (Permission) systemState.getPermissionTrees().get(str2) : (Permission) systemState.getPermissions().get(str2);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void trimPermissions(MutateStateScope mutateStateScope, String str, ArraySet arraySet) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        if (packageState == null || androidPackage != null) {
            PackageState packageState2 = (PackageState) systemState.getDisabledSystemPackageStates().get(str);
            ...
            while (true) {
                ...
                if (Intrinsics.areEqual(((Permission) permissionTrees.valueAt(size)).getPermissionInfo().packageName, str)) {
                    if (packageState != null) {
                        Intrinsics.checkNotNull(androidPackage);
                        ...
                        while (true) {
                            ...
                            if (parsedPermission.isTree() && Intrinsics.areEqual(parsedPermission.getName(), str2)) {
                                z4 = false;
                                break;
                            }
                            i9++;
                    ...
                    if (androidPackage2 != null && (permissions2 = androidPackage2.getPermissions()) != null) {
                        ...
                        while (true) {
                            ...
                            if (parsedPermission2.isTree() && Intrinsics.areEqual(parsedPermission2.getName(), str2)) {
                                z3 = true;
                                break;
                            }
                            i10++;
            ...
            for (i = -1; i < size4; i = -1) {
                ...
                Permission updatePermissionIfDynamic = updatePermissionIfDynamic(mutateStateScope, (Permission) permissions4.valueAt(size4));
                ...
                if (Intrinsics.areEqual(updatePermissionIfDynamic.getPermissionInfo().packageName, str)) {
                    if (packageState != null) {
                        ...
                        while (true) {
                            ...
                            if (((parsedPermission3.isTree() || !Intrinsics.areEqual(parsedPermission3.getName(), str3)) ? i8 : i7) != 0) {
                                i6 = i8;
                                break;
                            }
                            i11++;
                    ...
                    if (androidPackage2 != null && (permissions = androidPackage2.getPermissions()) != null) {
                        ...
                        while (true) {
                            ...
                            if (((parsedPermission4.isTree() || !Intrinsics.areEqual(parsedPermission4.getName(), str3)) ? i8 : i7) != 0) {
                                i5 = i7;
                                break;
                            }
                            i12++;
            ...
            if (arrayMap != null) {
                ...
                while (-1 < size2) {
                    ...
                    if (!STORAGE_AND_MEDIA_PERMISSIONS.contains(str) || intValue == 0) {
                        ...
                        IndexedListSet indexedListSet = (IndexedListSet) oldState.getSystemState().getAppIds().get(i);
                        ...
                        while (true) {
                            ...
                            Object obj = oldState.getSystemState().getPackageStates().get((String) indexedListSet.elementAt(i4));
                            Intrinsics.checkNotNull(obj);
                        ...
                        AccessState newState = mutateStateScope.getNewState();
                        IndexedListSet indexedListSet3 = (IndexedListSet) newState.getSystemState().getAppIds().get(i);
                        ...
                        while (true) {
                            ...
                            Object obj2 = newState.getSystemState().getPackageStates().get((String) indexedListSet3.elementAt(i6));
                            Intrinsics.checkNotNull(obj2);
    ...
    public final void evaluatePermissionStateForAllPackages(MutateStateScope mutateStateScope, String str, PackageState packageState) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                AccessState newState = mutateStateScope.getNewState();
                IndexedListSet indexedListSet = (IndexedListSet) newState.getSystemState().getAppIds().get(keyAt);
                int size3 = indexedListSet.size();
                int i3 = 0;
                while (true) {
                    if (i3 >= size3) {
                    ...
                    Object obj = newState.getSystemState().getPackageStates().get((String) indexedListSet.elementAt(i3));
                    Intrinsics.checkNotNull(obj);
    ...
    */
    public final void evaluatePermissionState(MutateStateScope mutateStateScope, int i, int i2, String str, PackageState packageState) {
        ...
        boolean z15;
        boolean z16;
        IndexedListSet indexedListSet = (IndexedListSet) mutateStateScope.getNewState().getSystemState().getAppIds().get(i);
        ...
        while (true) {
            ...
            Object obj = mutateStateScope.getNewState().getSystemState().getPackageStates().get((String) indexedListSet.elementAt(i9));
            Intrinsics.checkNotNull(obj);
        ...
        if (permission.getPermissionInfo().getProtection() == 0) {
            ...
            if (packageState != null) {
                ...
                if (androidPackage.getRequestedPermissions().contains(str)) {
                    z13 = true;
                    AccessState newState = mutateStateScope.getNewState();
                    IndexedListSet indexedListSet2 = (IndexedListSet) newState.getSystemState().getAppIds().get(i);
                    ...
                    while (true) {
                        ...
                        Object obj2 = newState.getSystemState().getPackageStates().get((String) indexedListSet2.elementAt(i7));
                        Intrinsics.checkNotNull(obj2);
                        PackageState packageState2 = (PackageState) obj2;
                        AndroidPackage androidPackage2 = packageState2.getAndroidPackage();
                        if (androidPackage2 != null && androidPackage2.getRequestedPermissions().contains(str) && packageState2.isSystem()) {
                            z14 = true;
                            break;
                        }
                        i7++;
                    ...
                    IndexedListSet indexedListSet3 = (IndexedListSet) newState2.getSystemState().getAppIds().get(i);
                    ...
                    while (true) {
                        ...
                        Object obj3 = newState2.getSystemState().getPackageStates().get((String) indexedListSet3.elementAt(i8));
            ...
            IndexedListSet indexedListSet22 = (IndexedListSet) newState3.getSystemState().getAppIds().get(i);
            ...
            IndexedListSet indexedListSet32 = (IndexedListSet) newState22.getSystemState().getAppIds().get(i);
        ...
        if (permission.getPermissionInfo().getProtection() == 2) {
            ...
            if (!(permission.getPermissionInfo().getProtection() == 4)) {
                ...
                if (getAppIdTargetSdkVersion$default(this, mutateStateScope, i, str, null, 4, null) < 23) {
                    ...
                    IndexedListSet indexedListSet4 = (IndexedListSet) newState4.getSystemState().getAppIds().get(i);
                    ...
                    while (true) {
                        ...
                        Object obj4 = newState4.getSystemState().getPackageStates().get((String) indexedListSet4.elementAt(i11));
                    ...
                    IndexedListSet<String> indexedListSet5 = (IndexedListSet) mutateStateScope.getNewState().getSystemState().getImplicitToSourcePermissions().get(str);
                    if (indexedListSet5 != null) {
                        if (!indexedListSet5.isEmpty()) {
                            for (String str2 : indexedListSet5) {
                                Permission permission2 = (Permission) mutateStateScope.getNewState().getSystemState().getPermissions().get(str2);
                                if (permission2 == null) {
                ...
                setPermissionFlags(mutateStateScope, i, i2, str, z9 ? andInv4 | 524288 : IntExtensionsKt.andInv(andInv4, 524288));
                return;
            }
            i3 = 4;
            z2 = true;
        ...
        if (z && hasBits5) {
            ...
            if (IntExtensionsKt.hasBits(permission.getPermissionInfo().getProtectionFlags(), 16)) {
                ...
                IndexedListSet indexedListSet6 = (IndexedListSet) newState5.getSystemState().getAppIds().get(i);
                ...
                while (true) {
                    ...
                    Object obj5 = newState5.getSystemState().getPackageStates().get((String) indexedListSet6.elementAt(i12));
                    Intrinsics.checkNotNull(obj5);
                    PackageState packageState5 = (PackageState) obj5;
                    AndroidPackage androidPackage7 = packageState5.getAndroidPackage();
                    if ((androidPackage7 != null && androidPackage7.getRequestedPermissions().contains(str) && checkPrivilegedPermissionAllowlist(mutateStateScope, packageState5, permission)) ? z2 : false) {
                        z7 = z2;
                        break;
                    }
                    i12++;
                ...
                if (!z7) {
                    ...
                    if (permission.getPermissionInfo().getProtection() != 2 ? z2 : false) {
                        ...
                        IndexedListSet indexedListSet7 = (IndexedListSet) newState6.getSystemState().getAppIds().get(i);
                        ...
                        while (true) {
                            ...
                            Object obj6 = newState6.getSystemState().getPackageStates().get((String) indexedListSet7.elementAt(i13));
                            Intrinsics.checkNotNull(obj6);
                            PackageState packageState6 = (PackageState) obj6;
                            AndroidPackage androidPackage8 = packageState6.getAndroidPackage();
                            if ((androidPackage8 != null && androidPackage8.getRequestedPermissions().contains(str) && shouldGrantPermissionBySignature(mutateStateScope, packageState6, permission)) ? z2 : false) {
                                z6 = z2;
                                break;
                            }
                            i13++;
                        ...
                        if (z6) {
                            ...
                            IndexedListSet indexedListSet8 = (IndexedListSet) newState7.getSystemState().getAppIds().get(i);
                            ...
                            while (true) {
                                ...
                                Object obj7 = newState7.getSystemState().getPackageStates().get((String) indexedListSet8.elementAt(i4));
                                Intrinsics.checkNotNull(obj7);
                                PackageState packageState7 = (PackageState) obj7;
                                AndroidPackage androidPackage9 = packageState7.getAndroidPackage();
                                if ((androidPackage9 != null && androidPackage9.getRequestedPermissions().contains(str) && shouldGrantPermissionByProtectionFlags(mutateStateScope, packageState7, permission)) ? z2 : false) {
                                    z5 = z2;
                                    break;
                                }
                                i4++;
                    ...
                    IndexedListSet indexedListSet82 = (IndexedListSet) newState72.getSystemState().getAppIds().get(i);
            ...
            IndexedListSet indexedListSet822 = (IndexedListSet) newState722.getSystemState().getAppIds().get(i);
