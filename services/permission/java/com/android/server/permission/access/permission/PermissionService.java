...
public final class PermissionService implements PermissionManagerServiceInterface {
    ...
    public PermissionService(AccessCheckingService accessCheckingService) {
        ...
        Intrinsics.checkNotNull(m52x318e5b8b, "null cannot be cast to non-null type com.android.server.permission.access.permission.UidPermissionPolicy");
    ...
    */
    ...
    public final void setAppOpPermissionGranted(MutateStateScope mutateStateScope, PackageState packageState, int i, String str, boolean z) {
        ...
        Intrinsics.checkNotNull(m52x318e5b8b, "null cannot be cast to non-null type com.android.server.permission.access.appop.UidAppOpPolicy");
        ((UidAppOpPolicy) m52x318e5b8b).setAppOpMode(mutateStateScope, packageState.getAppId(), i, AppOpsManager.permissionToOp(str), z ? 0 : 2);
    }
