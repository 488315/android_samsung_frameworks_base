...
public final class PermissionService implements PermissionManagerServiceInterface {
  ...
  public PermissionService(AccessCheckingService accessCheckingService) {
    ...
    SchemePolicy m52x318e5b8b = accessCheckingService.m52x318e5b8b("uid", "permission");
    Intrinsics.checkNotNull(
        m52x318e5b8b,
        "null cannot be cast to non-null type"
            + " com.android.server.permission.access.permission.UidPermissionPolicy");
    this.policy = (UidPermissionPolicy) m52x318e5b8b;
  ...
  public final void initialize() {
    ...
    this.onPermissionsChangeListeners =
        new OnPermissionsChangeListeners(FgThread.get().getLooper());
    ...
    for (int i = 0; i < size; i++) {
      ...
      arrayList.add(
          new LegacyPermission(
              permission.getPermissionInfo(), permission.getType(), 0, EmptyArray.INT));
    }
    return arrayList;
  }
      ...
      if (!isUidInstantApp(withUnfilteredSnapshot, callingUid)) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
          ...
          PermissionGroupInfo permissionGroupInfo =
              (PermissionGroupInfo) permissionGroups.valueAt(i2);
          PermissionGroupInfo generatePermissionGroupInfo =
              isPackageVisibleToUid(
                  ...
                  ? generatePermissionGroupInfo(permissionGroupInfo, i)
                  : null;
  ...
  public PermissionGroupInfo getPermissionGroupInfo(String str, int i) {
    ...
    try {
      ...
      if (!isUidInstantApp(withUnfilteredSnapshot, callingUid)) {
        ...
        PermissionGroupInfo permissionGroupInfo =
            (PermissionGroupInfo)
                this.policy.getPermissionGroups(new GetStateScope(accessState)).get(str);
  ...
  public final PermissionGroupInfo generatePermissionGroupInfo(
      PermissionGroupInfo permissionGroupInfo, int i) {
    ...
    try {
      ...
      if (!isUidInstantApp(withUnfilteredSnapshot, callingUid)) {
        ...
        Permission permission =
            (Permission) this.policy.getPermissions(new GetStateScope(accessState)).get(str);
        if (permission != null) {
          ref$ObjectRef.element = permission;
          if (!isPackageVisibleToUid(
              withUnfilteredSnapshot, permission.getPermissionInfo().packageName, callingUid)) {
            AutoCloseableKt.closeFinally(withUnfilteredSnapshot, null);
            return null;
          }
  ...
  public static /* synthetic */ PermissionInfo generatePermissionInfo$default(
  ...
  public List queryPermissionsByGroup(String str, int i) {
    ...
    try {
      ...
      if (str != null) {
        PermissionGroupInfo permissionGroupInfo =
            (PermissionGroupInfo) this.policy.getPermissionGroups(getStateScope).get(str);
        if (permissionGroupInfo == null) {
          AutoCloseableKt.closeFinally(withUnfilteredSnapshot, null);
          return null;
        }
      ...
      for (int i2 = 0; i2 < size; i2++) {
        ...
        PermissionInfo generatePermissionInfo$default =
            (Intrinsics.areEqual(permission.getPermissionInfo().group, str)
                    && isPackageVisibleToUid(
                        withUnfilteredSnapshot,
                        permission.getPermissionInfo().packageName,
                        callingUid))
                ? generatePermissionInfo$default(this, permission, i, 0, 2, null)
                : null;
  ...
  public List getAllPermissionsWithProtection(int i) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      ...
      Permission permission = (Permission) permissions.valueAt(i2);
      PermissionInfo generatePermissionInfo$default =
          permission.getPermissionInfo().getProtection() == i
              ? generatePermissionInfo$default(this, permission, 0, 0, 2, null)
              : null;
      if (generatePermissionInfo$default != null) {
        arrayList.add(generatePermissionInfo$default);
      }
  ...
  public List getAllPermissionsWithProtectionFlags(int i) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      ...
      Permission permission = (Permission) permissions.valueAt(i2);
      PermissionInfo generatePermissionInfo$default =
          IntExtensionsKt.hasBits(permission.getPermissionInfo().getProtectionFlags(), i)
              ? generatePermissionInfo$default(this, permission, 0, 0, 2, null)
              : null;
      if (generatePermissionInfo$default != null) {
        arrayList.add(generatePermissionInfo$default);
  ...
  public Set getInstalledPermissions(String str) {
    if (str != null) {
      ...
      for (int i = 0; i < size; i++) {
        ...
        String str2 =
            Intrinsics.areEqual(permission.getPermissionInfo().packageName, str)
  ...
  public boolean addPermission(PermissionInfo permissionInfo, boolean z) {
    ...
    try {
      ...
      synchronized (accessCheckingService.stateLock) {
        ...
        this.policy.addPermission(
            mutateStateScope,
            new Permission(
                permissionInfo,
                true,
                2,
                andEnforcePermissionTree.getAppId(),
                null,
                false,
                48,
                null),
  ...
  public final Permission getAndEnforcePermissionTree(GetStateScope getStateScope, String str) {
    ...
    if (findPermissionTree != null
        && findPermissionTree.getAppId() == UserHandle.getAppId(callingUid)) {
  ...
  public final void enforcePermissionTreeSize(
      GetStateScope getStateScope, PermissionInfo permissionInfo, Permission permission) {
    if (permission.getAppId() != 1000
        && calculatePermissionTreeFootprint(getStateScope, permission)
                + permissionInfo.calculateFootprint()
            > 32768) {
      throw new SecurityException("Permission tree size cap exceeded");
    }
  }

  public final int calculatePermissionTreeFootprint(
      GetStateScope getStateScope, Permission permission) {
    ArrayMap permissions = this.policy.getPermissions(getStateScope);
    int size = permissions.size();
    int i = 0;
    for (int i2 = 0; i2 < size; i2++) {
      ...
      if (permission.getAppId() == permission2.getAppId()) {
        i +=
            permission2.getPermissionInfo().name.length()
                + permission2.getPermissionInfo().calculateFootprint();
      }
    }
    return i;
  }
  ...
  public int checkUidPermission(int i, String str) {
    ...
    if (packageStateInternal != null) {
      ...
      return isPermissionGranted(new GetStateScope(accessState), packageStateInternal, userId, str)
          ? 0
          : -1;
    }
    Log.e(
        LOG_TAG, "checkUidPermission: PackageState not found for AndroidPackage " + androidPackage);
    return -1;
  }
  ...
  public int checkPermission(String str, String str2, int i) {
    ...
    PackageManagerLocal.FilteredSnapshot withFilteredSnapshot =
        withFilteredSnapshot(packageManagerLocal, Binder.getCallingUid(), i);
    try {
  ...
  public final boolean isPermissionGranted(
      GetStateScope getStateScope, PackageState packageState, int i, String str) {
  ...
  public final boolean isSinglePermissionGranted(
      GetStateScope getStateScope, int i, int i2, boolean z, String str) {
    if (!PermissionFlags.INSTANCE.isPermissionGranted(
        this.policy.getPermissionFlags(getStateScope, i, i2, str))) {
      return false;
    }
    if (!z) {
      return true;
    ...
    return permission != null
        && IntExtensionsKt.hasBits(
            permission.getPermissionInfo().getProtectionFlags(), IInstalld.FLAG_USE_QUOTA);
  }
  ...
  public Set getGrantedPermissions(String str, int i) {
    ...
    try {
      ...
      if (packageState != null) {
        ...
        GetStateScope getStateScope = new GetStateScope(accessState);
        ArrayMap uidPermissionFlags =
            this.policy.getUidPermissionFlags(getStateScope, packageState.getAppId(), i);
  ...
  public void revokePostNotificationPermissionWithoutKillForTest(String str, int i) {
    setRuntimePermissionGranted$default(
        this, str, i, "android.permission.POST_NOTIFICATIONS", false, true, null, 32, null);
  }

  public static /* synthetic */ void setRuntimePermissionGranted$default(
      PermissionService permissionService,
      String str,
      int i,
      String str2,
  ...
  */
  public final void setRuntimePermissionGranted(
      String str, int i, String str2, boolean z, boolean z2, String str3) {
    boolean z3;
    ...
    String str5 =
        (String) ArraysKt___ArraysKt.first(packageManagerInternal.getKnownPackageNames(7, 0));
    PackageManagerLocal packageManagerLocal = this.packageManagerLocal;
    if (packageManagerLocal == null) {
      Intrinsics.throwUninitializedPropertyAccessException("packageManagerLocal");
      packageManagerLocal = null;
    ...
    try {
      PackageManagerLocal.FilteredSnapshot filtered =
          filtered(withUnfilteredSnapshot, callingUid, i);
      try {
          ...
          if (appId != packageState2.getAppId()) {
            ...
            synchronized (accessCheckingService.stateLock) {
              ...
              OnPermissionFlagsChangedListener onPermissionFlagsChangedListener2 =
                  this.onPermissionFlagsChangedListener;
              ...
              if (z2) {
                onPermissionFlagsChangedListener.skipKillRuntimePermissionRevokedUids(
                    mutateStateScope);
              }
              if (str3 != null) {
                onPermissionFlagsChangedListener.addKillRuntimePermissionRevokedUidsReason(
                    mutateStateScope, str3);
              }
              setRuntimePermissionGranted(
                  mutateStateScope,
                  (PackageState) ref$ObjectRef.element,
                  i,
                  str2,
                  z,
                  z3,
        ...
        z3 = true;
        if (this.context.checkCallingOrSelfPermission(
                "android.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY")
            == 0) {}
        accessCheckingService = this.service;
        synchronized (accessCheckingService.stateLock) {
  ...
  public final void setRequestedPermissionStates(
      PackageState packageState, int i, ArrayMap arrayMap) {
    Permission permission;
    int i2;
    int i3;
    AccessCheckingService accessCheckingService = this.service;
            ...
            if (!IntExtensionsKt.hasBits(permission.getPermissionInfo().getProtectionFlags(), 32)) {
              if (!(permission.getPermissionInfo().getProtection() == 1)) {
                if (IntExtensionsKt.hasBits(permission.getPermissionInfo().getProtectionFlags(), 64)
                    && PackageInstallerService.INSTALLER_CHANGEABLE_APP_OP_PERMISSIONS.contains(
                        str)) {
  ...
  public final void setRuntimePermissionGranted(
    ...
    if (!IntExtensionsKt.hasBits(permission.getPermissionInfo().getProtectionFlags(), 32)) {
      if (!IntExtensionsKt.hasBits(permission.getPermissionInfo().getProtectionFlags(), 67108864)) {
        ...
        if (z
          ...
          if (z4) {
            throw new SecurityException(
                "Cannot grant non-instant permission " + str + " to package " + packageName);
          }
          return;
        }
      } else if (!z2) {
    ...
    if (z
        && IntExtensionsKt.hasBits(permissionFlags, 524288)
    ...
    int updateRuntimePermissionGranted =
        PermissionFlags.INSTANCE.updateRuntimePermissionGranted(permissionFlags, z);
  ...
  public final void setAppOpPermissionGranted(
      MutateStateScope mutateStateScope, PackageState packageState, int i, String str, boolean z) {
    SchemePolicy m52x318e5b8b = this.service.m52x318e5b8b("uid", "app-op");
    Intrinsics.checkNotNull(
        m52x318e5b8b,
        "null cannot be cast to non-null type"
            + " com.android.server.permission.access.appop.UidAppOpPolicy");
    ((UidAppOpPolicy) m52x318e5b8b)
        .setAppOpMode(
            mutateStateScope,
            packageState.getAppId(),
            i,
            AppOpsManager.permissionToOp(str),
            z ? 0 : 2);
  }
  ...
  public int getPermissionFlags(String str, String str2, int i) {
    ...
    try {
      ...
      if (packageState != null) {
        ...
        return PermissionFlags.INSTANCE.toApiFlags(
            this.policy.getPermissionFlags(getStateScope, packageState.getAppId(), i, str2));
      }
  ...
  public boolean isPermissionRevokedByPolicy(String str, String str2, int i) {
    ...
    try {
      ...
      return IntExtensionsKt.hasBits(
          this.policy.getPermissionFlags(getStateScope, packageState.getAppId(), i, str2), 128);
    } finally {
    }
  }
  ...
  public boolean isPermissionsReviewRequired(String str, int i) {
    ...
    try {
      ...
      ArrayMap uidPermissionFlags =
          this.policy.getUidPermissionFlags(
              new GetStateScope(accessState), packageState.getAppId(), i);
      if (uidPermissionFlags == null) {
        return false;
      }
      int size = uidPermissionFlags.size();
  ...
  public boolean shouldShowRequestPermissionRationale(String str, String str2, int i) {
    ...
    PackageManagerLocal.FilteredSnapshot withFilteredSnapshot =
        withFilteredSnapshot(packageManagerLocal, callingUid, i);
    try {
      PackageState packageState = withFilteredSnapshot.getPackageState(str);
      AutoCloseableKt.closeFinally(withFilteredSnapshot, null);
      if (packageState == null
      ...
      int intValue =
          Integer.valueOf(this.policy.getPermissionFlags(getStateScope, appId, i, str2)).intValue();
      ...
      if (Intrinsics.areEqual(str2, "android.permission.ACCESS_BACKGROUND_LOCATION")) {
        ...
        try {
          try {
            ...
            z =
                iPlatformCompat.isChangeEnabledByPackageName(
                    BACKGROUND_RATIONALE_CHANGE_ID, str, i);
          } catch (RemoteException e) {
            Log.e(
                LOG_TAG,
                "shouldShowRequestPermissionRationale: Unable to check if compatibility change is"
                    + " enabled",
                e);
          }
          if (z) {
  ...
  */
  public void updatePermissionFlags(String str, String str2, int i, int i2, boolean z, int i3) {
    ...
    if (!isRootOrSystem(callingUid) && IntExtensionsKt.hasBits(i, 4)) {
      if (z) {
        this.context.enforceCallingOrSelfPermission(
            "android.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY",
            "Need android.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY to change policy flags");
      } else {
        PackageManagerInternal packageManagerInternal = this.packageManagerInternal;
        if (packageManagerInternal == null) {
          Intrinsics.throwUninitializedPropertyAccessException("packageManagerInternal");
        ...
        if (!(packageManagerInternal.getUidTargetSdkVersion(callingUid) < 29)) {
          throw new IllegalArgumentException(
              "android.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY needs to be checked for packages targeting 29 or later when changing policy flags"
                  .toString());
        }
      }
    }
    ...
    AndroidPackage androidPackage =
        packageStateInternal != null ? packageStateInternal.getAndroidPackage() : null;
    if (androidPackage != null) {
      ...
      if (!packageManagerInternal3.filterAppAccess(str, callingUid, i3, false)) {
        if (!androidPackage.getRequestedPermissions().contains(str2)) {
          ...
          synchronized (accessCheckingService.stateLock) {
            ...
            AccessState copy = accessState.copy();
            updatePermissionFlags(
                new MutateStateScope(accessState, copy),
                appId,
                i3,
                str2,
                i,
  ...
  public final void updatePermissionFlags(
    ...
    if (isRootOrSystem(callingUid)) {
      ...
      int i7 =
          ((isShell(callingUid) || NOTIFICATIONS_PERMISSIONS.contains(str)) ? 0 : 64)
              | 48
    ...
    this.policy.setPermissionFlags(
        mutateStateScope,
        i,
        i2,
        str,
        PermissionFlags.INSTANCE.updateFlags(permission, permissionFlags, i5, i6));
  }
  ...
  public ArrayList getAllowlistedRestrictedPermissions(String str, int i, int i2) {
    ...
    enforceCallingOrSelfCrossUserPermission(
        i2, false, false, "getAllowlistedRestrictedPermissions");
    int callingUid = Binder.getCallingUid();
    PackageManagerLocal packageManagerLocal = this.packageManagerLocal;
    if (packageManagerLocal == null) {
      Intrinsics.throwUninitializedPropertyAccessException("packageManagerLocal");
    ...
    PackageManagerLocal.FilteredSnapshot withFilteredSnapshot =
        withFilteredSnapshot(packageManagerLocal, callingUid, i2);
    try {
      PackageState packageState = withFilteredSnapshot.getPackageState(str);
      AutoCloseableKt.closeFinally(withFilteredSnapshot, null);
  ...
  public final ArrayList getAllowlistedRestrictedPermissionsUnchecked(int i, int i2, int i3) {
    ...
    ArrayMap uidPermissionFlags =
        this.policy.getUidPermissionFlags(new GetStateScope(accessState), i, i3);
    if (uidPermissionFlags == null) {
      return null;
    }
  ...
  public final void addAllowlistedRestrictedPermissionsUnchecked(
      AndroidPackage androidPackage, int i, List list, int i2) {
    List list2;
    ArrayList allowlistedRestrictedPermissionsUnchecked =
        getAllowlistedRestrictedPermissionsUnchecked(i, 2, i2);
    if (allowlistedRestrictedPermissionsUnchecked != null) {
      ...
      CollectionsKt__MutableCollectionsKt.addAll(
          arraySet, allowlistedRestrictedPermissionsUnchecked);
  ...
  public boolean removeAllowlistedRestrictedPermission(String str, String str2, int i, int i2) {
    ...
    if (enforceRestrictedPermission(str2)
        && (allowlistedRestrictedPermissions = getAllowlistedRestrictedPermissions(str, i, i2))
            != null
  ...
  public final boolean enforceRestrictedPermission(String str) {
    ...
    try {
      PackageState packageState =
          withFilteredSnapshot.getPackageState(permission.getPermissionInfo().packageName);
      AutoCloseableKt.closeFinally(withFilteredSnapshot, null);
      if (packageState == null) {
        return false;
      }
      if (IntExtensionsKt.hasBits(permission.getPermissionInfo().flags, 12)
          && IntExtensionsKt.hasBits(permission.getPermissionInfo().flags, 16)) {
        z = true;
      }
      if (!z
          || this.context.checkCallingOrSelfPermission(
  ...
  public final void setAllowlistedRestrictedPermissionsUnchecked(
    ...
    synchronized (accessCheckingService.stateLock) {
      ...
      ArrayMap uidPermissionFlags =
          uidPermissionPolicy.getUidPermissionFlags(mutateStateScope, i, i3);
      if (uidPermissionFlags != null) {
        ...
        while (i8 < size) {
          ...
          if (permission != null
              && IntExtensionsKt.hasBits(permission.getPermissionInfo().flags, 12)) {
                ...
                i10 =
                    list3.contains(str)
                        ...
                        : IntExtensionsKt.andInv(
                            i10, IInstalld.FLAG_CLEAR_APP_DATA_KEEP_ART_PROFILES);
              }
              size = i13;
  ...
  public String[] getAppOpPermissionPackages(String str) {
    ...
    Permission permission =
        (Permission) this.policy.getPermissions(new GetStateScope(accessState)).get(str);
    if (permission == null
        || !IntExtensionsKt.hasBits(permission.getPermissionInfo().getProtectionFlags(), 64)) {
    ...
    try {
      ...
      while (it.hasNext()) {
        AndroidPackage androidPackage =
            ((PackageState) ((Map.Entry) it.next()).getValue()).getAndroidPackage();
      ...
      while (it.hasNext()) {
        ...
        if (androidPackage != null) {
          for (String str : androidPackage.getRequestedPermissions()) {
            ...
            if (permission != null
                && IntExtensionsKt.hasBits(
                    permission.getPermissionInfo().getProtectionFlags(), 64)) {
  ...
  public byte[] backupRuntimePermissions(int i) {
    ...
    permissionControllerManager.getRuntimePermissionBackup(
        ...
        new Consumer() { // from class:
          // com.android.server.permission.access.permission.PermissionService$backupRuntimePermissions$1
  ...
  public void restoreDelayedRuntimePermissions(String str, final int i) {
    ...
    synchronized (this.isDelayedPermissionBackupFinished) {
      ...
      permissionControllerManager.applyStagedRuntimePermissionBackup(
          ...
          PermissionThread.getExecutor(),
          new Consumer() { // from class:
            // com.android.server.permission.access.permission.PermissionService$restoreDelayedRuntimePermissions$3
            @Override // java.util.function.Consumer
  ...
  public com.android.server.pm.permission.Permission getPermissionTEMP(String str) {
    ...
    return new com.android.server.pm.permission.Permission(
  ...
  public void writeLegacyPermissionsTEMP(LegacyPermissionSettings legacyPermissionSettings) {
    ...
    legacyPermissionSettings.replacePermissions(
        toLegacyPermissions(this.policy.getPermissions(getStateScope)));
    legacyPermissionSettings.replacePermissionTrees(
        toLegacyPermissions(this.policy.getPermissionTrees(getStateScope)));
  }
  ...
  public LegacyPermissionState getLegacyPermissionState(int i) {
    ...
    while (i2 < length) {
      ...
      ArrayMap uidPermissionFlags =
          permissionService.policy.getUidPermissionFlags(getStateScope, i, i3);
      if (uidPermissionFlags != null) {
        int size = uidPermissionFlags.size();
        int i4 = 0;
        while (i4 < size) {
  ...
  public void onUserCreated(int i) {
    this.service.m61xd61c3d34(i);
  }

  @Override // com.android.server.pm.permission.PermissionManagerServiceInterface
  public void onUserRemoved(int i) {
    this.service.m62x4ed10714(i);
  }

  @Override // com.android.server.pm.permission.PermissionManagerServiceInterface
  public void onStorageVolumeMounted(String str, boolean z) {
    this.service.m59xe2cba220(str, z);
  ...
  public void onPackageAdded(PackageState packageState, boolean z, AndroidPackage androidPackage) {
    synchronized (this.mountedStorageVolumes) {
      if (this.mountedStorageVolumes.contains(packageState.getVolumeUuid())) {
        Unit unit = Unit.INSTANCE;
        this.service.m55x9a5a53b7(packageState.getPackageName());
      }
    }
  }
  ...
  public void onPackageInstalled(
    ...
    synchronized (this.mountedStorageVolumes) {
      if (this.mountedStorageVolumes.contains(androidPackage.getVolumeUuid())) {
        ...
        for (int i3 : iArr) {
          this.service.m56x89669eb1(androidPackage.getPackageName(), i3);
        }
        for (int i4 : iArr) {
          PackageManagerInternal packageManagerInternal = this.packageManagerInternal;
          if (packageManagerInternal == null) {
          ...
          PackageStateInternal packageStateInternal =
              packageManagerInternal.getPackageStateInternal(androidPackage.getPackageName());
          ...
          addAllowlistedRestrictedPermissionsUnchecked(
              ...
              i4);
          setRequestedPermissionStates(
              packageStateInternal, i4, packageInstalledParams.getPermissionStates());
        }
      }
    }
  }
  ...
  public void onPackageUninstalled(
    ...
    for (int i3 : iArr) {
      this.service.m58x2b8d4f78(str, i, i3);
    }
    PackageManagerInternal packageManagerInternal2 = this.packageManagerInternal;
    if (packageManagerInternal2 == null) {
      Intrinsics.throwUninitializedPropertyAccessException("packageManagerInternal");
    ...
    if (((PackageStateInternal) packageManagerInternal.getPackageStates().get(str)) == null) {
      this.service.m57xfbe388d7(str, i);
    }
  }
  ...
  public final PackageManagerLocal.FilteredSnapshot withFilteredSnapshot(
      PackageManagerLocal packageManagerLocal, int i, int i2) {
    return packageManagerLocal.withFilteredSnapshot(i, UserHandle.of(i2));
  }

  public final PackageState getPackageState(
      PackageManagerLocal.UnfilteredSnapshot unfilteredSnapshot, String str) {
    return (PackageState) unfilteredSnapshot.getPackageStates().get(str);
  }

  public final boolean isUidInstantApp(
      PackageManagerLocal.UnfilteredSnapshot unfilteredSnapshot, int i) {
    PackageManagerInternal packageManagerInternal = this.packageManagerInternal;
    if (packageManagerInternal == null) {
      Intrinsics.throwUninitializedPropertyAccessException("packageManagerInternal");
      packageManagerInternal = null;
  ...
  public final boolean isPackageVisibleToUid(
  ...
  public final boolean isPackageVisibleToUid(
      PackageManagerLocal.UnfilteredSnapshot unfilteredSnapshot, String str, int i, int i2) {
  ...
  public final PackageManagerLocal.FilteredSnapshot filtered(
      PackageManagerLocal.UnfilteredSnapshot unfilteredSnapshot, int i, int i2) {
    return unfilteredSnapshot.filtered(i, UserHandle.of(i2));
  }

  public final void enforceCallingOrSelfCrossUserPermission(
      int i, boolean z, boolean z2, String str) {
    if (!(i >= 0)) {
    ...
    if (i != UserHandle.getUserId(callingUid)) {
      ...
      if (this.context.checkCallingOrSelfPermission(str2) != 0) {
        ...
        Intrinsics.checkNotNullExpressionValue(
            sb2, "StringBuilder().apply(builderAction).toString()");
    ...
    if (z2 && isShell(callingUid)) {
      ...
      if (userManagerInternal.hasUserRestriction("no_debugging_features", i)) {
        ...
        Intrinsics.checkNotNullExpressionValue(
            sb4, "StringBuilder().apply(builderAction).toString()");
  ...
  public final class OnPermissionFlagsChangedListener
      extends UidPermissionPolicy.OnPermissionFlagsChangedListener {
    ...
    public final void addKillRuntimePermissionRevokedUidsReason(
        MutateStateScope mutateStateScope, String str) {
    ...
    public void onPermissionFlagsChanged(int i, int i2, String str, int i3, int i4) {
      ...
      Permission permission =
          (Permission)
              permissionService.policy.getPermissions(new GetStateScope(accessState)).get(str);
      if (permission == null) {
        return;
      }
      PermissionFlags permissionFlags = PermissionFlags.INSTANCE;
    ...
    public void onStateMutated() {
      ...
      if (!this.isKillRuntimePermissionRevokedUidsSkipped) {
        final String joinToString$default =
            this.killRuntimePermissionRevokedUidsReasons.isEmpty() ^ true
                ? CollectionsKt___CollectionsKt.joinToString$default(
                    this.killRuntimePermissionRevokedUidsReasons,
                    ", ",
                    null,
                    null,
                    0,
      ...
      for (int i3 = 0; i3 < size3; i3++) {
        ...
        handler3.post(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public final void run() {
                PermissionService.this.killUid(
                    elementAt2, "permission grant or revoke changed gids");
              }
            });
      }
    ...
    public final boolean isAppBackupAndRestoreRunning(int i) {
      ...
      try {
        ...
        int userId = UserHandle.getUserId(i);
        return (Settings.Secure.getIntForUser(contentResolver, "user_setup_complete", userId) == 0)
            || (Settings.Secure.getIntForUser(
                    contentResolver, "user_setup_personalization_state", userId)
                == 1);
  ...
  public final class OnPermissionsChangeListeners extends Handler {
    ...
    public final void handleOnPermissionsChanged(final int i) {
      this.listeners.broadcast(
          new Consumer() { // from class:
            // com.android.server.permission.access.permission.PermissionService$OnPermissionsChangeListeners$handleOnPermissionsChanged$1
            @Override // java.util.function.Consumer
            public final void accept(IOnPermissionsChangeListener iOnPermissionsChangeListener) {
              try {
                ...
                Log.e(
                    PermissionService.LOG_TAG, "Error when calling OnPermissionsChangeListener", e);
              }
            }
          });
    }
  ...
  public void revokeInstallPermission(String str, String str2) {
    Log.w(
        this.TAG_SPEG,
        "Empty revokeInstallPermission(packageName = " + str + ", permissionName = " + str2 + ")");
  }
  ...
  public void grantInstallPermission(String str, String str2) {
    Log.w(
        this.TAG_SPEG,
        "Empty grantInstallPermission(packageName = " + str + ", permissionName = " + str2 + ")");
  }
