...
public final class AppOpService implements AppOpsCheckingServiceInterface {
  ...
  public AppOpService(AccessCheckingService accessCheckingService) {
    ...
    SchemePolicy m52x318e5b8b = accessCheckingService.m52x318e5b8b("package", "app-op");
    Intrinsics.checkNotNull(
        m52x318e5b8b,
        "null cannot be cast to non-null type"
            + " com.android.server.permission.access.appop.PackageAppOpPolicy");
    this.packagePolicy = (PackageAppOpPolicy) m52x318e5b8b;
    SchemePolicy m52x318e5b8b2 = accessCheckingService.m52x318e5b8b("uid", "app-op");
    Intrinsics.checkNotNull(
        m52x318e5b8b2,
        "null cannot be cast to non-null type"
            + " com.android.server.permission.access.appop.UidAppOpPolicy");
    this.uidPolicy = (UidAppOpPolicy) m52x318e5b8b2;
  ...
  public final SparseBooleanArray evalForegroundOps(
      ArrayMap arrayMap, SparseBooleanArray sparseBooleanArray) {
    if (arrayMap != null) {
  ...
  public int getUidMode(int i, int i2) {
    ...
    return this.uidPolicy.getAppOpMode(
        new GetStateScope(accessState), appId, userId, opToPublicName);
  }
  ...
  public boolean setUidMode(int i, int i2, int i3) {
    ...
    synchronized (accessCheckingService.stateLock) {
      ...
      ref$BooleanRef.element =
          Boolean.valueOf(
                  this.uidPolicy.setAppOpMode(
                      new MutateStateScope(accessState, copy), appId, userId, opToPublicName, i3))
              .booleanValue();
  ...
  public void setPackageMode(String str, int i, int i2, int i3) {
    ...
    synchronized (accessCheckingService.stateLock) {
      ...
      this.packagePolicy.setAppOpMode(
          new MutateStateScope(accessState, copy), str, i3, opToPublicName, i2);
      accessCheckingService.persistence.write(copy);
      accessCheckingService.state = copy;
      accessCheckingService.policy.onStateMutated(new GetStateScope(copy));
      Unit unit = Unit.INSTANCE;
  ...
  public boolean removePackage(String str, int i) {
    ...
    synchronized (accessCheckingService.stateLock) {
      ...
      ref$BooleanRef.element =
          Boolean.valueOf(
                  this.packagePolicy.removeAppOpModes(
                      new MutateStateScope(accessState, copy), str, i))
              .booleanValue();
      accessCheckingService.persistence.write(copy);
      accessCheckingService.state = copy;
      accessCheckingService.policy.onStateMutated(new GetStateScope(copy));
  ...
  public final SparseIntArray opNameMapToOpIntMap(ArrayMap arrayMap) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      sparseIntArray.put(
          AppOpsManager.strOpToOp((String) keyAt), ((Number) arrayMap.valueAt(i)).intValue());
    }
  ...
  public final boolean shouldIgnoreCallback(
      int i, OnOpModeChangedListener onOpModeChangedListener) {
  ...
  public void notifyOpChangedForAllPkgsInUid(
    ...
    synchronized (obj) {
      ...
      if (arraySet != null) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
          notifyOpChangedForAllPkgsInUid$associateListenerWithPackageNames(
              z, arrayMap, (OnOpModeChangedListener) arraySet.valueAt(i3), packagesForUid);
        }
      }
      for (String str : packagesForUid) {
        ...
        if (arraySet2 != null) {
          ...
          for (int i4 = 0; i4 < size2; i4++) {
            notifyOpChangedForAllPkgsInUid$associateListenerWithPackageNames(
                z, arrayMap, (OnOpModeChangedListener) arraySet2.valueAt(i4), new String[] {str});
          }
        }
      }
        ...
        handler.sendMessage(
            PooledLambda.obtainMessage(
                new QuintConsumer() { // from class:
                  // com.android.server.permission.access.appop.AppOpService$notifyOpChangedForAllPkgsInUid$2$1$1
                  public final void accept(
                      AppOpService appOpService2,
  ...
  public static final void notifyOpChangedForAllPkgsInUid$associateListenerWithPackageNames(
      boolean z,
      ArrayMap arrayMap,
  ...
  public final String[] getPackagesForUid(int i) {
    ...
    try {
      ...
      return (packageManager == null
              || (packagesForUid = packageManager.getPackagesForUid(i)) == null)
          ? EmptyArray.STRING
          : packagesForUid;
    } catch (RemoteException unused) {
      ...
      if (arraySet != null) {
        ...
        for (int i = 0; i < size; i++) {
          if (IntExtensionsKt.hasBits(
              ((OnOpModeChangedListener) arraySet.valueAt(i)).getFlags(), 1)) {
            z = true;
            break;
          }
        }
    ...
    if (this.opModeWatchers.size() > 0) {
      ...
      while (i4 < size) {
        ...
        if (i < 0 || i == keyAt) {
          ...
          while (i5 < size2) {
            OnOpModeChangedListener onOpModeChangedListener =
                (OnOpModeChangedListener) arraySet.valueAt(i5);
            if (str != null) {
        ...
        if (str == null || Intrinsics.areEqual(str, str2)) {
          ...
          for (int i7 = 0; i7 < size4; i7++) {
            OnOpModeChangedListener onOpModeChangedListener2 =
                (OnOpModeChangedListener) arraySet2.valueAt(i7);
            printWriter.print("      #");
