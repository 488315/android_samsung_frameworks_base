...
public class AppPredictionManagerService extends AbstractMasterSystemService {
  ...
  public AppPredictionManagerService(Context context) {
    super(
        context,
        new FrameworkResourcesServiceNameResolver(context, R.string.data_usage_limit_body),
        null,
        17);
  ...
  public void onServicePackageUpdatedLocked(int i) {
    AppPredictionPerUserService appPredictionPerUserService =
        (AppPredictionPerUserService) peekServiceForUserLocked(i);
  ...
  public class PredictionManagerServiceStub extends IPredictionManager.Stub {
    ...
    public void createPredictionSession(
        final AppPredictionContext appPredictionContext,
      ...
      runForUserLocked(
          ...
          new Consumer() { // from class:
            // com.android.server.appprediction.AppPredictionManagerService$PredictionManagerServiceStub$$ExternalSyntheticLambda7
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((AppPredictionPerUserService) obj)
                  .onCreatePredictionSessionLocked(
                      appPredictionContext, appPredictionSessionId, iBinder);
            }
          });
    }

    public void notifyAppTargetEvent(
        final AppPredictionSessionId appPredictionSessionId, final AppTargetEvent appTargetEvent) {
      runForUserLocked(
          "notifyAppTargetEvent",
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.appprediction.AppPredictionManagerService$PredictionManagerServiceStub$$ExternalSyntheticLambda5
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((AppPredictionPerUserService) obj)
                  .notifyAppTargetEventLocked(appPredictionSessionId, appTargetEvent);
            }
          });
    }
    ...
    public void notifyLaunchLocationShown(
      ...
      runForUserLocked(
          ...
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.appprediction.AppPredictionManagerService$PredictionManagerServiceStub$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((AppPredictionPerUserService) obj)
                  .notifyLaunchLocationShownLocked(appPredictionSessionId, str, parceledListSlice);
            }
          });
    }
    ...
    public void sortAppTargets(
      ...
      runForUserLocked(
          ...
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.appprediction.AppPredictionManagerService$PredictionManagerServiceStub$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((AppPredictionPerUserService) obj)
                  .sortAppTargetsLocked(
                      appPredictionSessionId, parceledListSlice, iPredictionCallback);
            }
          });
    }
    ...
    public void registerPredictionUpdates(
      ...
      runForUserLocked(
          ...
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.appprediction.AppPredictionManagerService$PredictionManagerServiceStub$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((AppPredictionPerUserService) obj)
                  .registerPredictionUpdatesLocked(appPredictionSessionId, iPredictionCallback);
            }
          });
    }
    ...
    public void unregisterPredictionUpdates(
      ...
      runForUserLocked(
          ...
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.appprediction.AppPredictionManagerService$PredictionManagerServiceStub$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((AppPredictionPerUserService) obj)
                  .unregisterPredictionUpdatesLocked(appPredictionSessionId, iPredictionCallback);
            }
          });
    }
    ...
    public void requestPredictionUpdate(final AppPredictionSessionId appPredictionSessionId) {
      runForUserLocked(
          ...
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.appprediction.AppPredictionManagerService$PredictionManagerServiceStub$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((AppPredictionPerUserService) obj)
                  .requestPredictionUpdateLocked(appPredictionSessionId);
            }
          });
    }
    ...
    public void onDestroyPredictionSession(final AppPredictionSessionId appPredictionSessionId) {
      runForUserLocked(
          ...
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.appprediction.AppPredictionManagerService$PredictionManagerServiceStub$$ExternalSyntheticLambda6
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((AppPredictionPerUserService) obj)
    ...
    public final void runForUserLocked(
        String str, AppPredictionSessionId appPredictionSessionId, Consumer consumer) {
      int handleIncomingUser =
          ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
              .handleIncomingUser(
                  ...
                  (String) null,
                  (String) null);
      if (AppPredictionManagerService.this
                  .getContext()
                  .checkCallingPermission("android.permission.PACKAGE_USAGE_STATS")
              != 0
          && !AppPredictionManagerService.this.mServiceNameResolver.isTemporary(handleIncomingUser)
          && !AppPredictionManagerService.this.mActivityTaskManagerInternal.isCallerRecents(
              Binder.getCallingUid())
        ...
        synchronized (AppPredictionManagerService.this.mLock) {
          consumer.accept(
              (AppPredictionPerUserService)
                  AppPredictionManagerService.this.getServiceForUserLocked(handleIncomingUser));
        }
      } finally {
