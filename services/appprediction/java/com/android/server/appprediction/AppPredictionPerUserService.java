...
public class AppPredictionPerUserService extends AbstractPerUserSystemService
  ...
  public void onCreatePredictionSessionLocked(
    ...
    boolean z =
        (appPredictionContext.getExtras() != null
                && appPredictionContext.getExtras().getBoolean("remote_app_predictor", false)
                && DeviceConfig.getBoolean(
                    "systemui", "dark_launch_remote_prediction_service_enabled", false))
            ? false
            : DeviceConfig.getBoolean(
                "systemui",
                "predict_using_people_service_" + appPredictionContext.getUiSurface(),
                false);
    if (!resolveService(
            ...
            new AbstractRemoteService.AsyncRequest() { // from class:
              // com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda5
              public final void run(IInterface iInterface) {
                ((IPredictionService) iInterface)
    ...
    AppPredictionSessionInfo appPredictionSessionInfo =
        new AppPredictionSessionInfo(
            ...
            new IBinder.DeathRecipient() { // from class:
              // com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda6
              @Override // android.os.IBinder.DeathRecipient
              public final void binderDied() {
                AppPredictionPerUserService.this.lambda$onCreatePredictionSessionLocked$1(
                    appPredictionSessionId);
              }
            });
  ...
  public /* synthetic */ void lambda$onCreatePredictionSessionLocked$1(
  ...
  public void notifyAppTargetEventLocked(
    ...
    resolveService(
        ...
        new AbstractRemoteService.AsyncRequest() { // from class:
          // com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda1
          public final void run(IInterface iInterface) {
            ((IPredictionService) iInterface)
                .notifyAppTargetEvent(appPredictionSessionId, appTargetEvent);
          }
        });
  }
  ...
  public void notifyLaunchLocationShownLocked(
    ...
    resolveService(
        ...
        appPredictionSessionInfo.mUsesPeopleService,
        new AbstractRemoteService.AsyncRequest() { // from class:
          // com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda3
          public final void run(IInterface iInterface) {
            ((IPredictionService) iInterface)
                .notifyLaunchLocationShown(appPredictionSessionId, str, parceledListSlice);
          }
        });
  }
  ...
  public void sortAppTargetsLocked(
    ...
    resolveService(
        ...
        appPredictionSessionInfo.mUsesPeopleService,
        new AbstractRemoteService.AsyncRequest() { // from class:
          // com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda8
          public final void run(IInterface iInterface) {
            ((IPredictionService) iInterface)
                .sortAppTargets(appPredictionSessionId, parceledListSlice, iPredictionCallback);
          }
        });
  }

  public void registerPredictionUpdatesLocked(
      final AppPredictionSessionId appPredictionSessionId,
      final IPredictionCallback iPredictionCallback) {
    AppPredictionSessionInfo appPredictionSessionInfo =
        (AppPredictionSessionInfo) this.mSessionInfos.get(appPredictionSessionId);
  ...
  public void unregisterPredictionUpdatesLocked(
      final AppPredictionSessionId appPredictionSessionId,
      final IPredictionCallback iPredictionCallback) {
    AppPredictionSessionInfo appPredictionSessionInfo =
        (AppPredictionSessionInfo) this.mSessionInfos.get(appPredictionSessionId);
    if (appPredictionSessionInfo != null
        && resolveService(
            ...
            appPredictionSessionInfo.mUsesPeopleService,
            new AbstractRemoteService.AsyncRequest() { // from class:
              // com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda0
              public final void run(IInterface iInterface) {
                ((IPredictionService) iInterface)
                    .unregisterPredictionUpdates(appPredictionSessionId, iPredictionCallback);
              }
            })) {
  ...
  public void requestPredictionUpdateLocked(final AppPredictionSessionId appPredictionSessionId) {
    ...
    resolveService(
        ...
        appPredictionSessionInfo.mUsesPeopleService,
        new AbstractRemoteService.AsyncRequest() { // from class:
          // com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda7
          public final void run(IInterface iInterface) {
  ...
  public void onDestroyPredictionSessionLocked(
      final AppPredictionSessionId appPredictionSessionId) {
    if (isDebug()) {
    ...
    resolveService(
        ...
        appPredictionSessionInfo.mUsesPeopleService,
        new AbstractRemoteService.AsyncRequest() { // from class:
          // com.android.server.appprediction.AppPredictionPerUserService$$ExternalSyntheticLambda4
          public final void run(IInterface iInterface) {
  ...
  public boolean resolveService(
      ...
      boolean z,
      boolean z2,
      AbstractRemoteService.AsyncRequest asyncRequest) {
    if (z2) {
    ...
    if (this.mRemoteService == null) {
      ...
      this.mRemoteService =
          new RemoteAppPredictionService(
              ...
              this.mUserId,
              this,
              ((AppPredictionManagerService) this.mMaster).isBindInstantServiceAllowed(),
              ((AppPredictionManagerService) this.mMaster).verbose);
    }
  ...
  public final class AppPredictionSessionInfo {
    ...
    public void resurrectSessionLocked(
        final AppPredictionPerUserService appPredictionPerUserService, IBinder iBinder) {
      this.mCallbacks.getRegisteredCallbackCount();
      appPredictionPerUserService.onCreatePredictionSessionLocked(
          this.mPredictionContext, this.mSessionId, iBinder);
          ...
          new Consumer() { // from class:
            ...
            public final void accept(Object obj) {
              AppPredictionPerUserService.AppPredictionSessionInfo.this
                  .lambda$resurrectSessionLocked$0(
                      appPredictionPerUserService, (IPredictionCallback) obj);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$resurrectSessionLocked$0(
      ...
      appPredictionPerUserService.registerPredictionUpdatesLocked(
          this.mSessionId, iPredictionCallback);
    }
  }
}
