...
public final class TextToSpeechManagerPerUserService extends AbstractPerUserSystemService {
  ...
  public TextToSpeechManagerPerUserService(
      TextToSpeechManagerService textToSpeechManagerService, Object obj, int i) {
  ...
  public void createSessionLocked(
    ...
    TextToSpeechSessionConnection.start(
        getContext(), this.mUserId, str, iTextToSpeechSessionCallback);
  }
  ...
  class TextToSpeechSessionConnection extends ServiceConnector.Impl {
    ...
    public static void start(
        ...
        int i,
        String str,
        ITextToSpeechSessionCallback iTextToSpeechSessionCallback) {
      new TextToSpeechSessionConnection(context, i, str, iTextToSpeechSessionCallback).start();
    }

    public TextToSpeechSessionConnection(
        Context context,
        int i,
        String str,
        ITextToSpeechSessionCallback iTextToSpeechSessionCallback) {
      super(
          context,
          new Intent("android.intent.action.TTS_SERVICE").setPackage(str),
          524289,
          i,
          new Function() { // from class:
                           // com.android.server.texttospeech.TextToSpeechManagerPerUserService$TextToSpeechSessionConnection$$ExternalSyntheticLambda0
      ...
      this.mUnbindOnDeathHandler =
          new IBinder
              .DeathRecipient() { // from class:
                                  // com.android.server.texttospeech.TextToSpeechManagerPerUserService$TextToSpeechSessionConnection$$ExternalSyntheticLambda1
    ...
    public final void start() {
      Slog.d(
          TextToSpeechManagerPerUserService.TAG,
          "Trying to start connection to TTS engine: " + this.mEngine);
      connect()
          .thenAccept(
              new Consumer() { // from class:
                               // com.android.server.texttospeech.TextToSpeechManagerPerUserService$TextToSpeechSessionConnection$$ExternalSyntheticLambda3
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  TextToSpeechManagerPerUserService.TextToSpeechSessionConnection.this
                      .lambda$start$2((ITextToSpeechService) obj);
                }
              })
          .exceptionally(
              new Function() { // from class:
                               // com.android.server.texttospeech.TextToSpeechManagerPerUserService$TextToSpeechSessionConnection$$ExternalSyntheticLambda4
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                  Void lambda$start$4;
                  lambda$start$4 =
                      TextToSpeechManagerPerUserService.TextToSpeechSessionConnection.this
                          .lambda$start$4((Throwable) obj);
    ...
    public /* synthetic */ void lambda$start$2(ITextToSpeechService iTextToSpeechService) {
      if (iTextToSpeechService != null) {
        Slog.d(
            TextToSpeechManagerPerUserService.TAG,
            "Connected successfully to TTS engine: " + this.mEngine);
        try {
          this.mCallback.onConnected(
              new ITextToSpeechSession
                  .Stub() { // from class:
                            // com.android.server.texttospeech.TextToSpeechManagerPerUserService.TextToSpeechSessionConnection.1
          ...
          Slog.w(
              TextToSpeechManagerPerUserService.TAG, "Error notifying the client on connection", e);
      ...
      TextToSpeechManagerPerUserService.runSessionCallbackMethod(
          new ThrowingRunnable() { // from class:
                                   // com.android.server.texttospeech.TextToSpeechManagerPerUserService$TextToSpeechSessionConnection$$ExternalSyntheticLambda5
    ...
    public /* synthetic */ Void lambda$start$4(final Throwable th) {
      ...
      TextToSpeechManagerPerUserService.runSessionCallbackMethod(
          new ThrowingRunnable() { // from class:
                                   // com.android.server.texttospeech.TextToSpeechManagerPerUserService$TextToSpeechSessionConnection$$ExternalSyntheticLambda6
            @Override // com.android.server.texttospeech.TextToSpeechManagerPerUserService.ThrowingRunnable
            public final void runOrThrow() {
              TextToSpeechManagerPerUserService.TextToSpeechSessionConnection.this.lambda$start$3(
                  th);
            }
          });
      return null;
    ...
    public void onServiceConnectionStatusChanged(
        ITextToSpeechService iTextToSpeechService, boolean z) {
      if (z) {
        return;
      }
      ...
      if (iTextToSpeechSessionCallback == null) {
        Slog.d(
            TextToSpeechManagerPerUserService.TAG,
            "mCallback is already null. Reset by java.lang.NullPointerException was avoided.");
        return;
      }
      Objects.requireNonNull(iTextToSpeechSessionCallback);
      TextToSpeechManagerPerUserService.runSessionCallbackMethod(
          new ThrowingRunnable() { // from class:
                                   // com.android.server.texttospeech.TextToSpeechManagerPerUserService$TextToSpeechSessionConnection$$ExternalSyntheticLambda2
            @Override // com.android.server.texttospeech.TextToSpeechManagerPerUserService.ThrowingRunnable
            public final void runOrThrow() {
    ...
    public final void unbindEngine(String str) {
      Slog.d(
          TextToSpeechManagerPerUserService.TAG,
          "Unbinding TTS engine: " + this.mEngine + ". Reason: " + str);
      unbind();
    }
  }
