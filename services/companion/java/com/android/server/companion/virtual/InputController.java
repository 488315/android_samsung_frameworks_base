...
class InputController {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native long nativeOpenUinputTouchscreen(
      String str, int i, int i2, String str2, int i3, int i4);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native boolean nativeWriteTouchEvent(
      long j, int i, int i2, int i3, float f, float f2, float f3, float f4, long j2);
  ...
  public InputController(final Handler handler, WindowManager windowManager) {
    this(
        ...
        handler,
        windowManager,
        new DeviceCreationThreadVerifier() { // from class:
          // com.android.server.companion.virtual.InputController$$ExternalSyntheticLambda1
  ...
  public InputController(
      ...
      DeviceCreationThreadVerifier deviceCreationThreadVerifier) {
    ...
    try {
      createDeviceInternal(
          ...
          new Supplier() { // from class:
            // com.android.server.companion.virtual.InputController$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
              Long lambda$createDpad$1;
              lambda$createDpad$1 =
                  InputController.this.lambda$createDpad$1(str, i, i2, createPhys);
  ...
  public void createKeyboard(
    ...
    try {
      createDeviceInternal(
          ...
          createPhys,
          new Supplier() { // from class:
            // com.android.server.companion.virtual.InputController$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
              Long lambda$createKeyboard$2;
              lambda$createKeyboard$2 =
                  InputController.this.lambda$createKeyboard$2(str, i, i2, createPhys);
  ...
  public void createMouse(final String str, final int i, final int i2, IBinder iBinder, int i3) {
    ...
    try {
      createDeviceInternal(
          ...
          createPhys,
          new Supplier() { // from class:
            // com.android.server.companion.virtual.InputController$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
              Long lambda$createMouse$3;
              lambda$createMouse$3 =
                  InputController.this.lambda$createMouse$3(str, i, i2, createPhys);
      ...
      createDeviceInternal(
          ...
          new Supplier() { // from class:
            ...
            public final Object get() {
              ...
              lambda$createTouchscreen$4 =
                  InputController.this.lambda$createTouchscreen$4(str, i, i2, createPhys, i4, i5);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ Long lambda$createTouchscreen$4(
      String str, int i, int i2, String str2, int i3, int i4) {
    return Long.valueOf(this.mNativeWrapper.openUinputTouchscreen(str, i, i2, str2, i3, i4));
  }

  public void createNavigationTouchpad(
      final String str,
      final int i,
      final int i2,
      IBinder iBinder,
    ...
    try {
      createDeviceInternal(
          ...
          createPhys,
          new Supplier() { // from class:
            // com.android.server.companion.virtual.InputController$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
              Long lambda$createNavigationTouchpad$5;
              lambda$createNavigationTouchpad$5 =
                  InputController.this.lambda$createNavigationTouchpad$5(
                      str, i, i2, createPhys, i4, i5);
      ...
      throw new RuntimeException(
          "Failed to create virtual navigation touchpad device '" + str + "'.", e);
    }
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ Long lambda$createNavigationTouchpad$5(
      String str, int i, int i2, String str2, int i3, int i4) {
    return Long.valueOf(this.mNativeWrapper.openUinputTouchscreen(str, i, i2, str2, i3, i4));
  }
  ...
  public void unregisterInputDevice(IBinder iBinder) {
    synchronized (this.mLock) {
      InputDeviceDescriptor inputDeviceDescriptor =
          (InputDeviceDescriptor) this.mInputDeviceDescriptors.remove(iBinder);
  ...
  public final void closeInputDeviceDescriptorLocked(
      IBinder iBinder, InputDeviceDescriptor inputDeviceDescriptor) {
    ...
    if (inputDeviceDescriptor.isMouse()
        && this.mInputManagerInternal.getVirtualMousePointerDisplayId()
  ...
  public int getInputDeviceId(IBinder iBinder) {
    ...
    synchronized (this.mLock) {
      InputDeviceDescriptor inputDeviceDescriptor =
          (InputDeviceDescriptor) this.mInputDeviceDescriptors.get(iBinder);
      if (inputDeviceDescriptor == null) {
  ...
  public final void updateActivePointerDisplayIdLocked() {
    ...
    for (int i = 0; i < this.mInputDeviceDescriptors.size(); i++) {
      InputDeviceDescriptor inputDeviceDescriptor2 =
          (InputDeviceDescriptor) this.mInputDeviceDescriptors.valueAt(i);
      if (inputDeviceDescriptor2.isMouse()
          && (inputDeviceDescriptor == null
              || inputDeviceDescriptor2.getCreationOrderNumber()
                  > inputDeviceDescriptor.getCreationOrderNumber())) {
        inputDeviceDescriptor = inputDeviceDescriptor2;
      }
    }
    if (inputDeviceDescriptor != null) {
      this.mInputManagerInternal.setVirtualMousePointerDisplayId(
          inputDeviceDescriptor.getDisplayId());
    } else {
  ...
  public final void validateDeviceName(String str) {
    if (str.getBytes(StandardCharsets.UTF_8).length >= 80) {
      throw new DeviceCreationException(
          "Input device name exceeds maximum length of 80bytes: " + str);
    }
    synchronized (this.mLock) {
      for (int i = 0; i < this.mInputDeviceDescriptors.size(); i++) {
  ...
  public final void setUniqueIdAssociation(int i, String str) {
    InputManagerGlobal.getInstance()
        .addUniqueIdAssociation(str, this.mDisplayManagerInternal.getDisplayInfo(i).uniqueId);
  }
  ...
  public boolean sendDpadKeyEvent(IBinder iBinder, VirtualKeyEvent virtualKeyEvent) {
    ...
    synchronized (this.mLock) {
      ...
      writeDpadKeyEvent =
          this.mNativeWrapper.writeDpadKeyEvent(
              inputDeviceDescriptor.getNativePointer(),
              virtualKeyEvent.getKeyCode(),
              virtualKeyEvent.getAction(),
              virtualKeyEvent.getEventTimeNanos());
    }
  ...
  public boolean sendKeyEvent(IBinder iBinder, VirtualKeyEvent virtualKeyEvent) {
    ...
    synchronized (this.mLock) {
      ...
      writeKeyEvent =
          this.mNativeWrapper.writeKeyEvent(
              inputDeviceDescriptor.getNativePointer(),
              virtualKeyEvent.getKeyCode(),
              virtualKeyEvent.getAction(),
              virtualKeyEvent.getEventTimeNanos());
  ...
  public boolean sendButtonEvent(IBinder iBinder, VirtualMouseButtonEvent virtualMouseButtonEvent) {
    ...
    synchronized (this.mLock) {
      ...
      writeButtonEvent =
          this.mNativeWrapper.writeButtonEvent(
              inputDeviceDescriptor.getNativePointer(),
              virtualMouseButtonEvent.getButtonCode(),
              virtualMouseButtonEvent.getAction(),
              virtualMouseButtonEvent.getEventTimeNanos());
    }
  ...
  public boolean sendTouchEvent(IBinder iBinder, VirtualTouchEvent virtualTouchEvent) {
    ...
    synchronized (this.mLock) {
      ...
      writeTouchEvent =
          this.mNativeWrapper.writeTouchEvent(
              inputDeviceDescriptor.getNativePointer(),
  ...
  public boolean sendRelativeEvent(
    ...
    synchronized (this.mLock) {
      ...
      writeRelativeEvent =
          this.mNativeWrapper.writeRelativeEvent(
              inputDeviceDescriptor.getNativePointer(),
              virtualMouseRelativeEvent.getRelativeX(),
              virtualMouseRelativeEvent.getRelativeY(),
              virtualMouseRelativeEvent.getEventTimeNanos());
    }
  ...
  public boolean sendScrollEvent(IBinder iBinder, VirtualMouseScrollEvent virtualMouseScrollEvent) {
    ...
    synchronized (this.mLock) {
      ...
      writeScrollEvent =
          this.mNativeWrapper.writeScrollEvent(
              inputDeviceDescriptor.getNativePointer(),
              virtualMouseScrollEvent.getXAxisMovement(),
              virtualMouseScrollEvent.getYAxisMovement(),
              virtualMouseScrollEvent.getEventTimeNanos());
    }
  ...
  public void dump(PrintWriter printWriter) {
    ...
    synchronized (this.mLock) {
      ...
      for (int i = 0; i < this.mInputDeviceDescriptors.size(); i++) {
        ...
        printWriter.println(
            "          creationOrder: " + inputDeviceDescriptor.getCreationOrderNumber());
  ...
  public void addDeviceForTesting(
      IBinder iBinder, long j, int i, int i2, String str, String str2, int i3) {
    synchronized (this.mLock) {
      this.mInputDeviceDescriptors.put(
          iBinder,
          new InputDeviceDescriptor(
              j,
              new IBinder.DeathRecipient() { // from class:
                // com.android.server.companion.virtual.InputController$$ExternalSyntheticLambda5
  ...
  public class NativeWrapper {
    ...
    public boolean writeTouchEvent(
        long j, int i, int i2, int i3, float f, float f2, float f3, float f4, long j2) {
  ...
  public class WaitForDevice implements AutoCloseable {
    ...
    public WaitForDevice(final String str, final int i, final int i2) {
      InputManager.InputDeviceListener inputDeviceListener =
          new InputManager.InputDeviceListener() { // from class:
            // com.android.server.companion.virtual.InputController.WaitForDevice.1
      ...
      InputManagerGlobal.getInstance()
          .registerInputDeviceListener(inputDeviceListener, InputController.this.mHandler);
    }
    ...
    public int waitForDeviceCreation() {
      try {
        ...
        throw new IllegalStateException(
            "Virtual input device was created with an invalid id=" + this.mInputDeviceId);
  ...
  public final void createDeviceInternal(
      int i, String str, int i2, int i3, IBinder iBinder, int i4, String str2, Supplier supplier) {
    if (!this.mThreadVerifier.isValidThread()) {
      throw new IllegalStateException(
          "Virtual device creation should happen on an auxiliary thread (e.g. binder thread) and"
              + " not from the handler's thread.");
    }
    ...
    try {
      ...
      try {
        ...
        if (longValue == 0) {
          throw new DeviceCreationException(
              "A native error occurred when creating virtual input device: " + str);
        }
        try {
          ...
          try {
            ...
            synchronized (this.mLock) {
              this.mInputDeviceDescriptors.put(
                  iBinder,
                  new InputDeviceDescriptor(
                      longValue, binderDeathRecipient, i, i4, str2, str, waitForDeviceCreation));
            }
