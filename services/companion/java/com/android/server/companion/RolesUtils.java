...
public abstract class RolesUtils {
  public static boolean isRoleHolder(Context context, int i, String str, String str2) {
    return ((RoleManager) context.getSystemService(RoleManager.class))
        .getRoleHoldersAsUser(str2, UserHandle.of(i))
        .contains(str);
  }
    ...
    try {
      roleManager.removeRoleHolderAsUser(
          ...
          new Consumer() { // from class:
            // com.android.server.companion.RolesUtils$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              RolesUtils.lambda$removeRoleHolderForAssociation$0(
                  userId, packageName, deviceProfile, (Boolean) obj);
            }
          });
    } finally {
  ...
  public static /* synthetic */ void lambda$removeRoleHolderForAssociation$0(
      int i, String str, String str2, Boolean bool) {
    if (bool.booleanValue()) {
      return;
    }
    Slog.e(
        "CDM_CompanionDeviceManagerService",
        "Failed to remove u" + i + "\\" + str + " from the list of " + str2 + " holders.");
  }
}
