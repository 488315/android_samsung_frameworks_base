...
public class BluetoothCompanionDeviceConnectionListener
  ...
  public BluetoothCompanionDeviceConnectionListener(
  ...
  public void init(BluetoothAdapter bluetoothAdapter) {
    bluetoothAdapter.registerBluetoothConnectionCallback(
        new HandlerExecutor(Handler.getMain()), this);
  ...
  public void onDeviceConnected(BluetoothDevice bluetoothDevice) {
    ...
    if (!this.mUserManager.isUserUnlockingOrUnlocked(UserHandle.myUserId())) {
      Slog.i(
          "CDM_BluetoothCompanionDeviceConnectionListener",
          "Current user is not in unlocking or unlocked stage yet. Notify the application when the"
              + " phone is unlocked");
