...
public class CrossDeviceCall {
  ...
  public CrossDeviceCall(
      Context context, Call call, Call.Details details, CallAudioState callAudioState) {
    boolean z = false;
    this.mStatus = 0;
    ...
    String str = "";
    String packageName =
        accountHandle != null ? details.getAccountHandle().getComponentName().getPackageName() : "";
  ...
  public String getReadableCallerId(boolean z) {
    ...
    return TextUtils.isEmpty(this.mContactDisplayName)
        ? getNonContactString()
