...
public class CompanionDeviceManagerService extends SystemService {
  ...
  public CompanionDeviceManagerService(Context context) {
    ...
    this.mAssociationStoreChangeListener =
        new AssociationStore.OnChangeListener() { // from class:
    ...
    this.mDevicePresenceCallback =
        new CompanionDevicePresenceMonitor.Callback() { // from class:
    ...
    this.mPackageMonitor =
        new PackageMonitor() { // from class:
          // com.android.server.companion.CompanionDeviceManagerService.3
          public void onPackageRemoved(String str, int i) {
            CompanionDeviceManagerService.this.onPackageRemoveOrDataClearedInternal(
                getChangingUserId(), str);
          }
    ...
    this.mOnPackageVisibilityChangeListener =
        new OnPackageVisibilityChangeListener(activityManager);
  }
  ...
  public void onStart() {
    ...
    this.mDevicePresenceMonitor =
        new CompanionDevicePresenceMonitor(
            this.mUserManager, this.mAssociationStore, this.mDevicePresenceCallback);
    this.mAssociationRequestsProcessor =
        new AssociationRequestsProcessor(this, this.mAssociationStore);
    this.mCompanionAppController =
        new CompanionApplicationController(
            context, this.mAssociationStore, this.mDevicePresenceMonitor);
    ...
    this.mSystemDataTransferProcessor =
        new SystemDataTransferProcessor(
            this,
            this.mAssociationStore,
            this.mSystemDataTransferRequestStore,
            this.mTransportManager);
    this.mCrossDeviceSyncController =
        new CrossDeviceSyncController(getContext(), this.mTransportManager);
  ...
  public void loadAssociationsFromDisk() {
    ...
    synchronized (this.mPreviouslyUsedIds) {
      this.mPersistentStore.readStateForUsers(
          this.mUserManager.getAliveUsers(), arraySet, this.mPreviouslyUsedIds);
    }
        ...
        .sendMessageDelayed(
            PooledLambda.obtainMessage(
                new Consumer() { // from class:
                  // com.android.server.companion.CompanionDeviceManagerService$$ExternalSyntheticLambda1
  ...
  public void onUserUnlocked(SystemService.TargetUser targetUser) {
    Set set =
        (Set)
            this.mDevicePresenceMonitor
                .getPendingConnectedDevices()
                .get(targetUser.getUserIdentifier());
    if (set != null) {
      Iterator it = set.iterator();
      while (it.hasNext()) {
        for (AssociationInfo associationInfo :
            this.mAssociationStore.getAssociationsByAddress(
                ((BluetoothDevice) it.next()).getAddress())) {
          Slog.i(
              "CDM_CompanionDeviceManagerService",
              "onUserUnlocked, device id( " + associationInfo.getId() + " ) is connected");
  ...
  public AssociationInfo getAssociationWithCallerChecks(int i, String str, String str2) {
    AssociationInfo sanitizeWithCallerChecks =
        PermissionsUtils.sanitizeWithCallerChecks(
            getContext(),
            this.mAssociationStore.getAssociationsForPackageWithAddress(i, str, str2));
    if (sanitizeWithCallerChecks != null) {
      return sanitizeWithCallerChecks;
    }
    throw new IllegalArgumentException(
        "Association does not exist or the caller does not have permissions to manage it (ie. it"
            + " belongs to a different package or a different user).");
  }

  public AssociationInfo getAssociationWithCallerChecks(int i) {
    AssociationInfo sanitizeWithCallerChecks =
        PermissionsUtils.sanitizeWithCallerChecks(
            getContext(), this.mAssociationStore.getAssociationById(i));
    if (sanitizeWithCallerChecks != null) {
      return sanitizeWithCallerChecks;
    }
    throw new IllegalArgumentException(
  ...
  public final boolean shouldBindPackage(int i, String str) {
    for (AssociationInfo associationInfo :
        this.mAssociationStore.getAssociationsForPackage(i, str)) {
      if (associationInfo.shouldBindWhenPresent()
          && this.mDevicePresenceMonitor.isDevicePresent(associationInfo.getId())) {
        return true;
      }
    }
    return false;
  ...
  public final void notifyListeners(final int i, final List list) {
    this.mListeners.broadcast(
        new BiConsumer() { // from class:
          // com.android.server.companion.CompanionDeviceManagerService$$ExternalSyntheticLambda5
          @Override // java.util.function.BiConsumer
          public final void accept(Object obj, Object obj2) {
            CompanionDeviceManagerService.lambda$notifyListeners$0(
                i, list, (IOnAssociationsChangedListener) obj, obj2);
          }
        });
  }

  public static /* synthetic */ void lambda$notifyListeners$0(
      int i, List list, IOnAssociationsChangedListener iOnAssociationsChangedListener, Object obj) {
      ...
      ((Set)
              map.computeIfAbsent(
                  ...
                  new Function() { // from class:
                    // com.android.server.companion.CompanionDeviceManagerService$$ExternalSyntheticLambda4
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                      Set lambda$markIdAsPreviouslyUsedForPackage$1;
                      lambda$markIdAsPreviouslyUsedForPackage$1 =
                          CompanionDeviceManagerService.lambda$markIdAsPreviouslyUsedForPackage$1(
                              (String) obj);
  ...
  public final void onPackageRemoveOrDataClearedInternal(int i, String str) {
    Log.i(
        "CDM_CompanionDeviceManagerService", "onPackageRemove_Or_DataCleared() u" + i + "/" + str);
  ...
  public final void onPackageModifiedInternal(int i, String str) {
    ...
    for (AssociationInfo associationInfo :
      ...
      if (updateSpecialAccessPermissionForAssociatedPackage(associationInfo) == null) {
        Log.i(
            "CDM_CompanionDeviceManagerService",
            "onPackageModifiedInternal pkg not available, but has association,so clearing it"
                + str);
        ...
        try {
          ...
          if (applicationEnabledSetting == 2
            ...
            Slog.d(
                "CDM_CompanionDeviceManagerService",
                "onPackageModified unregisterDevicePresence(device address = "
                    + associationInfo.getDeviceMacAddressAsString()
                    + " packageState = "
                    + applicationEnabledSetting
                    + ")");
            try {
              this.mImpl.unregisterDevicePresenceListenerService(
                  associationInfo.getDeviceMacAddressAsString(), str, i);
            } catch (RemoteException e) {
              Slog.w(
                  "CDM_CompanionDeviceManagerService",
                  "unregisterDevicePresenceListenerService RemoteException e=" + e.toString());
            }
          }
        } catch (IllegalArgumentException e2) {
          Slog.e(
              "CDM_CompanionDeviceManagerService",
              "Failed! to get getApplicationEnabledSetting for package " + str,
              e2);
        }
      }
    }
    ...
    for (AssociationInfo associationInfo : this.mAssociationStore.getAssociations()) {
      if (associationInfo.isSelfManaged()) {
        if (currentTimeMillis - associationInfo.getLastTimeConnectedMs().longValue() >= j) {
          ...
          Slog.i(
              "CDM_CompanionDeviceManagerService",
              "Removing inactive self-managed association id=" + id);
  ...
  public class CompanionDeviceManagerImpl extends ICompanionDeviceManager.Stub {
    ...
    public void associate(
      ...
      Slog.i(
          "CDM_CompanionDeviceManagerService",
          "associate() request=" + associationRequest + ", package=u" + i + "/" + str);
      PermissionsUtils.enforceCallerCanManageAssociationsForPackage(
          CompanionDeviceManagerService.this.getContext(), i, str, "create associations");
      CompanionDeviceManagerService.this.mAssociationRequestsProcessor.processNewAssociationRequest(
          associationRequest, str, i, iAssociationRequestCallback);
    }
    ...
    public PendingIntent buildAssociationCancellationIntent(String str, int i) {
      ...
      return CompanionDeviceManagerService.this.mAssociationRequestsProcessor
          .buildAssociationCancellationIntent(str, i);
    }

    public List getAssociations(String str, int i) {
      PermissionsUtils.enforceCallerCanManageAssociationsForPackage(
          CompanionDeviceManagerService.this.getContext(), i, str, "get associations");
      if (!PermissionsUtils.checkCallerCanManageCompanionDevice(
          CompanionDeviceManagerService.this.getContext())) {
        PackageUtils.enforceUsesCompanionDeviceFeature(
            CompanionDeviceManagerService.this.getContext(), i, str);
      }
    ...
    public List getAllAssociationsForUser(int i) {
      ...
      PermissionsUtils.enforceCallerCanManageCompanionDevice(
          CompanionDeviceManagerService.this.getContext(), "getAllAssociationsForUser");
    ...
    public void addOnAssociationsChangedListener(
      ...
      PermissionsUtils.enforceCallerIsSystemOrCanInteractWithUserId(
          CompanionDeviceManagerService.this.getContext(), i);
      PermissionsUtils.enforceCallerCanManageCompanionDevice(
          CompanionDeviceManagerService.this.getContext(), "addOnAssociationsChangedListener");
      CompanionDeviceManagerService.this.mListeners.register(
    ...
    public void removeOnAssociationsChangedListener(
      ...
      PermissionsUtils.enforceCallerIsSystemOrCanInteractWithUserId(
          CompanionDeviceManagerService.this.getContext(), i);
      PermissionsUtils.enforceCallerCanManageCompanionDevice(
          CompanionDeviceManagerService.this.getContext(), "removeOnAssociationsChangedListener");
    ...
    public void removeOnTransportsChangedListener(
        IOnTransportsChangedListener iOnTransportsChangedListener) {
      CompanionDeviceManagerService.this.mTransportManager.removeListener(
          iOnTransportsChangedListener);
    }
    ...
    public void legacyDisassociate(String str, String str2, int i) {
      Log.i(
          "CDM_CompanionDeviceManagerService",
          "legacyDisassociate() pkg=u"
              + i
              + "/"
              + str2
              + ", macAddress="
              + getMaskedMacAddress(str));
      Objects.requireNonNull(str);
      Objects.requireNonNull(str2);
      CompanionDeviceManagerService.this.disassociateInternal(
          CompanionDeviceManagerService.this.getAssociationWithCallerChecks(i, str2, str).getId());
    }

    public void disassociate(int i) {
      Log.i("CDM_CompanionDeviceManagerService", "disassociate() associationId=" + i);
      CompanionDeviceManagerService.this.disassociateInternal(
          CompanionDeviceManagerService.this.getAssociationWithCallerChecks(i).getId());
    }
      ...
      try {
        return PendingIntent.getActivityAsUser(
            ...
            NotificationAccessConfirmationActivityContract.launcherIntent(
                CompanionDeviceManagerService.this.getContext(), i, componentName),
            1409286144,
            null,
            new UserHandle(i));
      } finally {
    ...
    public boolean isDeviceAssociatedForWifiConnection(String str, final String str2, int i) {
      CompanionDeviceManagerService.this
          ...
          .enforceCallingOrSelfPermission(
              "android.permission.MANAGE_COMPANION_DEVICES", "isDeviceAssociated");
      if (CompanionDeviceManagerService.this
              .getContext()
              .getPackageManager()
              .checkPermission("android.permission.COMPANION_APPROVE_WIFI_CONNECTIONS", str)
          == 0) {
        return true;
      }
      return CollectionUtils.any(
          CompanionDeviceManagerService.this.mAssociationStore.getAssociationsForPackage(i, str),
          new Predicate() { // from class:
            ...
            public final boolean test(Object obj) {
              ...
              lambda$isDeviceAssociatedForWifiConnection$0 =
                  CompanionDeviceManagerService.CompanionDeviceManagerImpl
                      .lambda$isDeviceAssociatedForWifiConnection$0(str2, (AssociationInfo) obj);
              return lambda$isDeviceAssociatedForWifiConnection$0;
            }
          });
    }

    public static /* synthetic */ boolean lambda$isDeviceAssociatedForWifiConnection$0(
        String str, AssociationInfo associationInfo) {
    ...
    public PendingIntent buildPermissionTransferUserConsentIntent(String str, int i, int i2) {
      if (!FeatureUtils.isPermSyncEnabled()) {
        throw new UnsupportedOperationException(
            "Calling buildPermissionTransferUserConsentIntent, but this API is disabled by the"
                + " system.");
      }
      return CompanionDeviceManagerService.this.mSystemDataTransferProcessor
          .buildPermissionTransferUserConsentIntent(str, i, i2);
    }
    ...
    public void startSystemDataTransfer(
      ...
      if (!FeatureUtils.isPermSyncEnabled()) {
        throw new UnsupportedOperationException(
            "Calling startSystemDataTransfer, but this API is disabled by the system.");
      }
      CompanionDeviceManagerService.this.mSystemDataTransferProcessor.startSystemDataTransfer(
          str, i, i2, iSystemDataTransferCallback);
    }
    ...
    public void attachSystemDataTransport(
      ...
      CompanionDeviceManagerService.this.mTransportManager.attachSystemDataTransport(
          str, i, i2, parcelFileDescriptor);
    }
    ...
    public void notifyDeviceAppeared(int i) {
      ...
      CompanionDeviceManagerService.this.mAssociationStore.updateAssociation(
          AssociationInfo.builder(associationWithCallerChecks)
    ...
    public boolean isCompanionApplicationBound(String str, int i) {
      return CompanionDeviceManagerService.this.mCompanionAppController.isCompanionApplicationBound(
          i, str);
    }
    ...
    public final void registerDevicePresenceListenerActive(String str, String str2, boolean z) {
      Log.i(
          "CDM_CompanionDeviceManagerService",
          "registerDevicePresenceListenerActive() active="
              + z
              + " deviceAddress="
              + getMaskedMacAddress(str2));
      CompanionDeviceManagerService.this
          .getContext()
          .enforceCallingOrSelfPermission(
      ...
      AssociationInfo associationsForPackageWithAddress =
          CompanionDeviceManagerService.this.mAssociationStore.getAssociationsForPackageWithAddress(
              callingUserId, str, str2);
      if (associationsForPackageWithAddress == null) {
        throw new RemoteException(
            new DeviceNotAssociatedException(
                "App "
                    + str
                    + " is not associated with device "
                    + getMaskedMacAddress(str2)
                    + " for user "
                    + callingUserId));
      }
      ...
      AssociationInfo build =
          AssociationInfo.builder(associationsForPackageWithAddress)
              .setNotifyOnDeviceNearby(z)
              .build();
      CompanionDeviceManagerService.this.mAssociationStore.updateAssociation(build);
      if (z
          && CompanionDeviceManagerService.this.mDevicePresenceMonitor.isDevicePresent(
              build.getId())) {
      ...
      CompanionDeviceManagerService.this.mCompanionAppController.unbindCompanionApplication(
          callingUserId, str);
    }
    ...
    public void createAssociation(String str, String str2, int i, byte[] bArr) {
      ...
      CompanionDeviceManagerService.this
          .getContext()
          .enforceCallingOrSelfPermission(
              "android.permission.ASSOCIATE_COMPANION_DEVICES", "createAssociation");
      CompanionDeviceManagerService.this.createNewAssociation(
          i, str, MacAddress.fromString(str2), null, null, false);
    }
    ...
    public final void checkCanCallNotificationApi(String str, int i) {
      ...
      Preconditions.checkState(
          !ArrayUtils.isEmpty(
              CompanionDeviceManagerService.this.mAssociationStore.getAssociationsForPackage(
                  i, str)),
    ...
    public boolean canPairWithoutPrompt(String str, String str2, int i) {
      AssociationInfo associationsForPackageWithAddress =
          CompanionDeviceManagerService.this.mAssociationStore.getAssociationsForPackageWithAddress(
              i, str, str2);
      return associationsForPackageWithAddress != null
          && System.currentTimeMillis() - associationsForPackageWithAddress.getTimeApprovedMs()
              < 600000;
    }
    ...
    public int handleShellCommand(
      ...
      return new CompanionDeviceShellCommand(
              ...
              CompanionDeviceManagerService.this.mDevicePresenceMonitor,
  ...
  public void createNewAssociation(
      int i, String str, MacAddress macAddress, CharSequence charSequence, String str2, boolean z) {
    this.mAssociationRequestsProcessor.createAssociation(
        i, str, macAddress, charSequence, str2, null, z, null, null);
  }
  ...
  public int getNewAssociationIdForPackage(int i, String str) {
    ...
    synchronized (this.mPreviouslyUsedIds) {
      ...
      do {
        if (!sparseBooleanArray.get(firstAssociationIdForUser)
            && !previouslyUsedIdsForPackageLocked.contains(
                Integer.valueOf(firstAssociationIdForUser))) {}
        firstAssociationIdForUser++;
      } while (firstAssociationIdForUser <= lastAssociationIdForUser);
      throw new RuntimeException(
          "Cannot create a new Association ID for " + str + " for user " + i);
    }
  ...
  public void disassociateInternal(int i) {
    ...
    if (isDevicePresent
        && associationById.isNotifyOnDeviceNearby()
        && !CollectionUtils.any(
            this.mAssociationStore.getAssociationsForPackage(userId, packageName),
            new Predicate() { // from class:
              // com.android.server.companion.CompanionDeviceManagerService$$ExternalSyntheticLambda0
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$disassociateInternal$2;
                lambda$disassociateInternal$2 =
                    CompanionDeviceManagerService.this.lambda$disassociateInternal$2(
                        (AssociationInfo) obj);
  ...
  public /* synthetic */ boolean lambda$disassociateInternal$2(AssociationInfo associationInfo) {
    return associationInfo.isNotifyOnDeviceNearby()
        && this.mDevicePresenceMonitor.isDevicePresent(associationInfo.getId());
  }
  ...
  public final boolean maybeRemoveRoleHolderForAssociation(AssociationInfo associationInfo) {
    ...
    if (deviceProfile == null
        || deviceProfile.equals("android.app.role.SYSTEM_AUTOMOTIVE_PROJECTION")) {
      return true;
    }
    final int id = associationInfo.getId();
    int userId = associationInfo.getUserId();
    String packageName = associationInfo.getPackageName();
    if (CollectionUtils.any(
        this.mAssociationStore.getAssociationsForPackage(userId, packageName),
        new Predicate() { // from class:
          // com.android.server.companion.CompanionDeviceManagerService$$ExternalSyntheticLambda3
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$maybeRemoveRoleHolderForAssociation$3;
            lambda$maybeRemoveRoleHolderForAssociation$3 =
                CompanionDeviceManagerService.lambda$maybeRemoveRoleHolderForAssociation$3(
                    deviceProfile, id, (AssociationInfo) obj);
    ...
    if (getPackageProcessImportance(userId, packageName) <= 200) {
      Slog.i(
          "CDM_CompanionDeviceManagerService",
          "Cannot remove role holder for the removed association id="
              + id
  ...
  public static /* synthetic */ boolean lambda$maybeRemoveRoleHolderForAssociation$3(
      String str, int i, AssociationInfo associationInfo) {
    ...
    return ((Integer)
            Binder.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.companion.CompanionDeviceManagerService$$ExternalSyntheticLambda6
                  public final Object getOrThrow() {
                    Integer lambda$getPackageProcessImportance$4;
                    lambda$getPackageProcessImportance$4 =
                        CompanionDeviceManagerService.this.lambda$getPackageProcessImportance$4(
                            str, i);
  ...
  public /* synthetic */ Integer lambda$getPackageProcessImportance$4(String str, int i) {
    return Integer.valueOf(
        this.mActivityManager.getUidImportance(
            this.mPackageManagerInternal.getPackageUid(str, 0L, i)));
  }
  ...
  public final void addToPendingRoleHolderRemoval(AssociationInfo associationInfo) {
    ...
    synchronized (this.mRevokedAssociationsPendingRoleHolderRemoval) {
      ((Set) this.mRevokedAssociationsPendingRoleHolderRemoval.forUser(build.getUserId()))
          .add(build);
  ...
  public final void removeFromPendingRoleHolderRemoval(AssociationInfo associationInfo) {
    ...
    synchronized (this.mRevokedAssociationsPendingRoleHolderRemoval) {
      ((Set) this.mRevokedAssociationsPendingRoleHolderRemoval.forUser(userId))
          .remove(associationInfo);
      if (!CollectionUtils.any(
          getPendingRoleHolderRemovalAssociationsForUser(userId),
          new Predicate() { // from class:
            // com.android.server.companion.CompanionDeviceManagerService$$ExternalSyntheticLambda7
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$removeFromPendingRoleHolderRemoval$5;
              lambda$removeFromPendingRoleHolderRemoval$5 =
                  CompanionDeviceManagerService.lambda$removeFromPendingRoleHolderRemoval$5(
                      packageName, (AssociationInfo) obj);
  ...
  public static /* synthetic */ boolean lambda$removeFromPendingRoleHolderRemoval$5(
      String str, AssociationInfo associationInfo) {
  ...
  public final Set getPendingRoleHolderRemovalAssociationsForUser(int i) {
    ...
    synchronized (this.mRevokedAssociationsPendingRoleHolderRemoval) {
      arraySet =
          new ArraySet((Collection) this.mRevokedAssociationsPendingRoleHolderRemoval.forUser(i));
    }
    return arraySet;
  }
  ...
  public PackageInfo updateSpecialAccessPermissionForAssociatedPackage(
      AssociationInfo associationInfo) {
    final PackageInfo packageInfo =
        PackageUtils.getPackageInfo(
            getContext(), associationInfo.getUserId(), associationInfo.getPackageName());
    if (packageInfo == null) {
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils.ThrowingRunnable() { // from class:
          // com.android.server.companion.CompanionDeviceManagerService$$ExternalSyntheticLambda2
          public final void runOrThrow() {
            CompanionDeviceManagerService.this
                .lambda$updateSpecialAccessPermissionForAssociatedPackage$6(packageInfo);
          }
        });
    return packageInfo;
  }
  ...
  public final void lambda$updateSpecialAccessPermissionForAssociatedPackage$6(
      ...
      try {
        z =
            IDeviceIdleController.Stub.asInterface(ServiceManager.getService("deviceidle"))
                .isPowerSaveWhitelistApp(packageInfo.packageName);
        Slog.i(
            "CDM_CompanionDeviceManagerService",
            "Update SpAccess:" + packageInfo.packageName + " Unrestricted:" + z);
      } catch (RemoteException unused) {
        Slog.w(
            "CDM_CompanionDeviceManagerService",
            "RemoteException when calling isPowerSaveWhitelistApp");
      }
      if (!z) {
        try {
          ...
          Slog.w(
              ...
              packageInfo.packageName
                  + " can't be removed from power save whitelist. It might due to the package is"
      ...
      SharedPreferences sharedPreferences =
          getContext()
              .getSharedPreferences(
                  new File(
                      Environment.getUserSystemDirectory(i), "companion_device_preferences.xml"),
                  0);
      if (!sharedPreferences.getBoolean("auto_revoke_grants_done", false)) {
        try {
          for (AssociationInfo associationInfo : this.mAssociationStore.getAssociationsForUser(i)) {
            try {
              exemptFromAutoRevoke(
                  associationInfo.getPackageName(),
                  packageManager.getPackageUidAsUser(associationInfo.getPackageName(), i));
            } catch (PackageManager.NameNotFoundException e) {
              Slog.w(
                  "CDM_CompanionDeviceManagerService",
                  "Unknown companion package: " + associationInfo.getPackageName(),
                  e);
            }
          }
        } finally {
  ...
  public static Map deepUnmodifiableCopy(Map map) {
    ...
    for (Map.Entry entry : map.entrySet()) {
      hashMap.put(
          (String) entry.getKey(),
          Collections.unmodifiableSet(new HashSet((Collection) entry.getValue())));
    }
  ...
  public class LocalService implements CompanionDeviceManagerServiceInternal {
    ...
    public void registerCallMetadataSyncCallback(
      ...
      if (CompanionDeviceConfig.isEnabled("enable_context_sync_telecom")) {
        CompanionDeviceManagerService.this.mCrossDeviceSyncController
            .registerCallMetadataSyncCallback(crossDeviceSyncControllerCallback, i);
      }
    }
    ...
    public void crossDeviceSync(int i, Collection collection) {
      if (CompanionDeviceConfig.isEnabled("enable_context_sync_telecom")) {
        CompanionDeviceManagerService.this.mCrossDeviceSyncController.syncToAllDevicesForUserId(
            i, collection);
      }
    }
    ...
    public void crossDeviceSync(AssociationInfo associationInfo, Collection collection) {
      if (CompanionDeviceConfig.isEnabled("enable_context_sync_telecom")) {
        CompanionDeviceManagerService.this.mCrossDeviceSyncController.syncToSingleDevice(
            associationInfo, collection);
      }
    }
    ...
    public void sendCrossDeviceSyncMessageToAllDevices(int i, byte[] bArr) {
      if (CompanionDeviceConfig.isEnabled("enable_context_sync_telecom")) {
        CompanionDeviceManagerService.this.mCrossDeviceSyncController
            .syncMessageToAllDevicesForUserId(i, bArr);
      }
    }
  ...
  public class OnPackageVisibilityChangeListener
    ...
    public void startListening() {
      Binder.withCleanCallingIdentity(
          new FunctionalUtils.ThrowingRunnable() { // from class:
            // com.android.server.companion.CompanionDeviceManagerService$OnPackageVisibilityChangeListener$$ExternalSyntheticLambda0
            public final void runOrThrow() {
              CompanionDeviceManagerService.OnPackageVisibilityChangeListener.this
                  .lambda$startListening$0();
            }
          });
    }
    ...
    public void stopListening() {
      Binder.withCleanCallingIdentity(
          new FunctionalUtils.ThrowingRunnable() { // from class:
            // com.android.server.companion.CompanionDeviceManagerService$OnPackageVisibilityChangeListener$$ExternalSyntheticLambda1
            public final void runOrThrow() {
              CompanionDeviceManagerService.OnPackageVisibilityChangeListener.this
                  .lambda$stopListening$1();
            }
          });
    }
    ...
    public void onUidImportance(int i, int i2) {
      ...
      if (i2 > 200
          && (packageNameByUid = CompanionDeviceManagerService.this.getPackageNameByUid(i))
              != null) {
        int userId = UserHandle.getUserId(i);
        boolean z = false;
        for (AssociationInfo associationInfo :
            CompanionDeviceManagerService.this.getPendingRoleHolderRemovalAssociationsForUser(
                userId)) {
          if (packageNameByUid.equals(associationInfo.getPackageName())
              && CompanionDeviceManagerService.this.maybeRemoveRoleHolderForAssociation(
                  associationInfo)) {
