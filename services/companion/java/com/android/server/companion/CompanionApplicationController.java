...
public class CompanionApplicationController {
  ...
  public final CompanionServicesRegister mCompanionServicesRegister =
      new CompanionServicesRegister();
  public final AndroidPackageMap mBoundCompanionApplications = new AndroidPackageMap();
  public final AndroidPackageMap mScheduledForRebindingCompanionApplications =
      new AndroidPackageMap();

  /* JADX WARN: Multi-variable type inference failed */
  public CompanionApplicationController(
      Context context,
  ...
  public void bindCompanionApplication(int i, String str, boolean z) {
    ...
    if (forPackage.isEmpty()) {
      Slog.w(
          "CDM_CompanionApplicationController",
    ...
    synchronized (this.mBoundCompanionApplications) {
      ...
      while (i2 < forPackage.size()) {
        arrayList.add(
            CompanionDeviceServiceConnector.newInstance(
                this.mContext, i, (ComponentName) forPackage.get(i2), z, i2 == 0));
        i2++;
      }
      this.mBoundCompanionApplications.setValueForPackage(i, str, arrayList);
      Iterator it = arrayList.iterator();
      while (it.hasNext()) {
        ((CompanionDeviceServiceConnector) it.next())
            .setListener(
                new CompanionDeviceServiceConnector.Listener() { // from class:
                  // com.android.server.companion.CompanionApplicationController$$ExternalSyntheticLambda0
                  @Override // com.android.server.companion.CompanionDeviceServiceConnector.Listener
                  public final void onBindingDied(
                      int i3,
                      String str2,
                      CompanionDeviceServiceConnector companionDeviceServiceConnector) {
                    CompanionApplicationController.this.onBinderDied(
                        i3, str2, companionDeviceServiceConnector);
                  }
                });
      }
  ...
  public final void scheduleRebinding(
      final int i,
      final String str,
      final CompanionDeviceServiceConnector companionDeviceServiceConnector) {
    ...
    Handler.getMain()
        .postDelayed(
            new Runnable() { // from class:
              // com.android.server.companion.CompanionApplicationController$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
                CompanionApplicationController.this.lambda$scheduleRebinding$0(
                    i, str, companionDeviceServiceConnector);
              }
            },
            10000L);
  }
  ...
  public final boolean isRebindingCompanionApplicationScheduled(int i, String str) {
    boolean containsValueForPackage;
    synchronized (this.mScheduledForRebindingCompanionApplications) {
      containsValueForPackage =
          this.mScheduledForRebindingCompanionApplications.containsValueForPackage(i, str);
    }
    return containsValueForPackage;
  }

  /* renamed from: onRebindingCompanionApplicationTimeout, reason: merged with bridge method [inline-methods] */
  public final void lambda$scheduleRebinding$0(
      int i, String str, CompanionDeviceServiceConnector companionDeviceServiceConnector) {
    if (companionDeviceServiceConnector.isPrimary()) {
      synchronized (this.mBoundCompanionApplications) {
        if (!this.mBoundCompanionApplications.containsValueForPackage(i, str)) {
          this.mBoundCompanionApplications.setValueForPackage(
              i, str, Collections.singletonList(companionDeviceServiceConnector));
        }
      }
      synchronized (this.mScheduledForRebindingCompanionApplications) {
        this.mScheduledForRebindingCompanionApplications.removePackage(i, str);
  ...
  public void notifyCompanionApplicationDeviceAppeared(AssociationInfo associationInfo) {
    ...
    Log.i(
        "CDM_CompanionApplicationController",
        "notifyDevice_Appeared() id="
            + associationInfo.getId()
            + " u"
            + userId
            + "/"
            + packageName);
    CompanionDeviceServiceConnector primaryServiceConnector =
        getPrimaryServiceConnector(userId, packageName);
    if (primaryServiceConnector == null) {
      Log.e(
          "CDM_CompanionApplicationController",
          "notify_CompanionApplicationDevice_Appeared(): u"
              + userId
              + "/"
              + packageName
              + " is NOT bound.");
    ...
    Log.i(
        "CDM_CompanionApplicationController",
        "Calling onDeviceAppeared to userId=["
            + userId
            + "] package=["
            + packageName
            + "] associationId=["
  ...
  public void notifyCompanionApplicationDeviceDisappeared(AssociationInfo associationInfo) {
    ...
    if (primaryServiceConnector == null) {
      Log.e(
          "CDM_CompanionApplicationController",
          "notify_CompanionApplicationDevice_Disappeared(): u"
              + userId
              + "/"
              + packageName
              + " is NOT bound.");
    ...
    Log.i(
        "CDM_CompanionApplicationController",
        "Calling onDeviceDisappeared to userId=["
            + userId
            + "] package=["
            + packageName
            + "] associationId=["
  ...
  public final void onBinderDied(
    ...
    Slog.i(
        "CDM_CompanionApplicationController",
        "onBinderDied() u" + i + "/" + str + " isPrimary: " + isPrimary);
    synchronized (this.mBoundCompanionApplications) {
      if (companionDeviceServiceConnector.isPrimary()) {
  ...
  public class CompanionServicesRegister extends PerUser {
    ...
    public final Map create(int i) {
      return PackageUtils.getCompanionServicesForUser(
          CompanionApplicationController.this.mContext, i);
    }
  }
      ...
      for (int i = 0; i < size(); i++) {
        ...
        for (Map.Entry entry : map.entrySet()) {
          printWriter
              ...
              .append((CharSequence) String.valueOf(keyAt))
              .append("\\")
              .append((CharSequence) entry.getKey())
              .append(" -> ")
