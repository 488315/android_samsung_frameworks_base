...
public class AttestationVerifier {
  ...
  public int verifyAttestation(byte[] bArr, byte[] bArr2) {
    ...
    ((AttestationVerificationManager)
            this.mContext.getSystemService(AttestationVerificationManager.class))
        .verifyAttestation(
            ...
            new BiConsumer() { // from class:
              ...
              public final void accept(Object obj, Object obj2) {
                AttestationVerifier.lambda$verifyAttestation$0(
                    atomicInteger, countDownLatch, (Integer) obj, (VerificationToken) obj2);
              }
            });
    try {
  ...
  public static /* synthetic */ void lambda$verifyAttestation$0(
