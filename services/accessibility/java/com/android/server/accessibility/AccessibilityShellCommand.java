...
public final class AccessibilityShellCommand extends ShellCommand {
  ...
  public AccessibilityShellCommand(
  ...
  public final int runGetBindInstantServiceAllowed() {
    ...
    getOutPrintWriter()
        .println(
            Boolean.toString(this.mService.getBindInstantServiceAllowed(parseUserId.intValue())));
    return 0;
  }
  ...
  public final int runSetBindInstantServiceAllowed() {
    ...
    this.mService.setBindInstantServiceAllowed(
        parseUserId.intValue(), Boolean.parseBoolean(nextArgRequired));
    return 0;
  }
  ...
  public final int runNotifyGestureEvent() {
    ...
    this.mService.onGesture(
        new AccessibilityGestureEvent(parseInt, nextArg != null ? Integer.parseInt(nextArg) : 0));
    return 0;
  }
  ...
  public final int runNotifyKeyEvent() {
    ...
    if (nextArg == null) {
      ...
      this.mService.notifyKeyEvent(
          new KeyEvent(currentTimeMillis, currentTimeMillis, 0, parseInt, 0), 0);
      this.mService.notifyKeyEvent(
          new KeyEvent(currentTimeMillis, currentTimeMillis + 10, 1, parseInt, 0), 0);
    } else {
      int parseInt2 = Integer.parseInt(nextArg);
      long currentTimeMillis2 = System.currentTimeMillis();
      this.mService.notifyKeyEvent(
          new KeyEvent(currentTimeMillis2, currentTimeMillis2, parseInt2, parseInt, 0), 0);
    }
    return 0;
  }
  ...
  public final int runNotifyAccessibilityEvent() {
    ...
    AccessibilityEvent accessibilityEvent =
        new AccessibilityEvent(Integer.parseInt(nextArgRequired));
    if (nextArg != null) {
  ...
  public final int runToggleAccessibilityService() {
    ...
    setAccessibilityServiceState(
        this.mService.getContext(), new ComponentName(nextArgRequired, nextArgRequired2));
    return 0;
  }
  ...
  public final void setAccessibilityServiceState(Context context, ComponentName componentName) {
    ...
    Settings.Secure.putString(
        context.getContentResolver(), "enabled_accessibility_services", sb.toString());
  }
  ...
  public final int runSendMotionEventToInputFilter() {
    ...
    if (nextArg == null) {
      ...
      this.mService.injectInputEventToInputFilter(
          MotionEvent.obtain(
              uptimeMillis,
              uptimeMillis,
              0,
  ...
  public void onHelp() {
    ...
    if (isDebuggableBinary()) {
      ...
      outPrintWriter.println(
          "  notify-accessibilityevent-to-accessibilityservice <EVENT_TYPE> <(optional)"
              + " PACKAGE_NAME>");
      ...
      outPrintWriter.println(
          "      CLASS_NAME : com.google.android.marvin.talkback.TalkBackService");
