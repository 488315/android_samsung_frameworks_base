...
public class PolicyWarningUIController {
  ...
  public PolicyWarningUIController(
      Handler handler, Context context, NotificationController notificationController) {
    ...
    this.mMainHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.accessibility.PolicyWarningUIController$$ExternalSyntheticLambda0
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                PolicyWarningUIController.this.onSwitchUserInternal(
                    ((Integer) obj).intValue(), (Set) obj2);
              }
            },
            Integer.valueOf(i),
            set));
  ...
  public void onEnabledServicesChanged(int i, Set set) {
    this.mMainHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.accessibility.PolicyWarningUIController$$ExternalSyntheticLambda4
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                PolicyWarningUIController.this.onEnabledServicesChangedInternal(
                    ((Integer) obj).intValue(), (Set) obj2);
              }
            },
            Integer.valueOf(i),
  ...
  public void onEnabledServicesChangedInternal(int i, Set set) {
    ...
    handler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.accessibility.PolicyWarningUIController$$ExternalSyntheticLambda5
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                PolicyWarningUIController.NotificationController.this.onServicesDisabled(
                    ((Integer) obj).intValue(), (ArraySet) obj2);
              }
            },
            Integer.valueOf(i),
            arraySet));
  ...
  public void onNonA11yCategoryServiceBound(int i, ComponentName componentName) {
    this.mMainHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.accessibility.PolicyWarningUIController$$ExternalSyntheticLambda2
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                PolicyWarningUIController.this.setAlarm(
                    ((Integer) obj).intValue(), (ComponentName) obj2);
              }
            },
            Integer.valueOf(i),
            componentName));
  ...
  public void onNonA11yCategoryServiceUnbound(int i, ComponentName componentName) {
    this.mMainHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.accessibility.PolicyWarningUIController$$ExternalSyntheticLambda1
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                PolicyWarningUIController.this.cancelAlarm(
                    ((Integer) obj).intValue(), (ComponentName) obj2);
              }
            },
            Integer.valueOf(i),
  ...
  public final void setAlarm(int i, ComponentName componentName) {
    ...
    this.mAlarmManager.set(
        ...
        createPendingIntent(this.mContext, i, ACTION_SEND_NOTIFICATION, componentName));
  }

  public final void cancelAlarm(int i, ComponentName componentName) {
    this.mAlarmManager.cancel(
        createPendingIntent(this.mContext, i, ACTION_SEND_NOTIFICATION, componentName));
  }

  public static PendingIntent createPendingIntent(
      Context context, int i, String str, ComponentName componentName) {
    return PendingIntent.getBroadcast(
        context, 0, createIntent(context, i, str, componentName), 67108864);
  }
  ...
  public static Intent createIntent(
    ...
    intent
        ...
        .setIdentifier(componentName.flattenToShortString())
        .putExtra("android.intent.extra.COMPONENT_NAME", componentName)
        .putExtra("android.intent.extra.USER_ID", i)
        .putExtra("android.intent.extra.TIME", SystemClock.elapsedRealtime());
    return intent;
  }
    ...
    this.mMainHandler.sendMessage(
        PooledLambda.obtainMessage(
            new Consumer() { // from class:
              // com.android.server.accessibility.PolicyWarningUIController$$ExternalSyntheticLambda3
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                PolicyWarningUIController.this.enableSendingNonA11yToolNotificationInternal(
  ...
  public class NotificationController extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      ComponentName componentName =
          (ComponentName)
              intent.getParcelableExtra("android.intent.extra.COMPONENT_NAME", ComponentName.class);
    ...
    public final boolean trySendNotification(int i, ComponentName componentName) {
      ...
      while (true) {
        ...
        AccessibilityServiceInfo accessibilityServiceInfo =
            (AccessibilityServiceInfo) enabledServiceInfos.get(i2);
        if (!componentName
            .flattenToShortString()
            .equals(accessibilityServiceInfo.getComponentName().flattenToShortString())) {
          i2++;
        } else if (!accessibilityServiceInfo.isAccessibilityTool()
            && !this.mNotifiedA11yServices.contains(componentName)) {
          ...
          Drawable loadIcon =
              accessibilityServiceInfo.getResolveInfo().loadIcon(this.mContext.getPackageManager());
          ...
          sendNotification(
              ...
              componentName,
              loadLabel,
              ImageUtils.buildScaledBitmap(loadIcon, dimensionPixelSize, dimensionPixelSize));
          return true;
        }
      }
      return false;
    ...
    public final void sendNotification(
        int i, ComponentName componentName, CharSequence charSequence, Bitmap bitmap) {
      Notification.Builder builder =
          new Notification.Builder(
              this.mContext, SystemNotificationChannels.ACCESSIBILITY_SECURITY_POLICY);
      builder
          .setSmallIcon(R.drawable.ft_avd_tooverflow_animation)
          .setSmallIcon(R.drawable.pointer_wait_vector_49)
          .setColor(
              this.mContext
                  .getResources()
                  .getColor(R.color.accent_primary_variant_light_device_default))
          .setCategory("recommendation")
          .setContentTitle(this.mContext.getString(17043222))
          .setContentText(this.mContext.getString(17043221, charSequence))
          .setStyle(
              new Notification.BigTextStyle()
                  .bigText(this.mContext.getString(17043221, charSequence)))
          .setTicker(this.mContext.getString(17043222))
          .setOnlyAlertOnce(true)
          .setDeleteIntent(
              PolicyWarningUIController.createPendingIntent(
                  this.mContext,
                  i,
          ...
          .setContentIntent(
              PolicyWarningUIController.createPendingIntent(
                  this.mContext, i, PolicyWarningUIController.ACTION_A11Y_SETTINGS, componentName));
      if (bitmap != null) {
    ...
    public final void cancelSentNotifications() {
      this.mSentA11yServiceNotification.forEach(
          new Consumer() { // from class:
            // com.android.server.accessibility.PolicyWarningUIController$NotificationController$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PolicyWarningUIController.NotificationController.this
                  .lambda$cancelSentNotifications$0((ComponentName) obj);
            }
          });
