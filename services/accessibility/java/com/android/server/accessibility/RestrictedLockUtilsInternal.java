...
public abstract class RestrictedLockUtilsInternal {
  public static RestrictedLockUtils.EnforcedAdmin checkIfAccessibilityServiceDisallowed(
    ...
    RestrictedLockUtils.EnforcedAdmin profileOrDeviceOwner =
        RestrictedLockUtils.getProfileOrDeviceOwner(context, getUserHandleOf(i));
    ...
    RestrictedLockUtils.EnforcedAdmin profileOrDeviceOwner2 =
        RestrictedLockUtils.getProfileOrDeviceOwner(context, getUserHandleOf(managedProfileId));
  ...
  public static RestrictedLockUtils.EnforcedAdmin checkIfInputMethodDisallowed(
    ...
    if (managedProfileId != -10000) {
      ...
      if (enforcedAdmin != null
        ...
        z =
            devicePolicyManager
                .getParentProfileInstance(UserManager.get(context).getUserInfo(managedProfileId))
                .isInputMethodPermittedByAdmin(enforcedAdmin.component, str, managedProfileId);
      }
    } else {
      enforcedAdmin = null;
    }
