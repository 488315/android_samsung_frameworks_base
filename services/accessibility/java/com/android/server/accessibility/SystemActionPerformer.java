...
public class SystemActionPerformer {
  ...
  public SystemActionPerformer(
    ...
    this.mLegacyHomeAction =
        new AccessibilityNodeInfo.AccessibilityAction(
            2, context.getResources().getString(R.string.autofill_save_notnow));
    this.mLegacyBackAction =
        new AccessibilityNodeInfo.AccessibilityAction(
            1, context.getResources().getString(R.string.auto_data_switch_title));
    this.mLegacyRecentsAction =
        new AccessibilityNodeInfo.AccessibilityAction(
            3, context.getResources().getString(R.string.autofill_save_type_debit_card));
    this.mLegacyNotificationsAction =
        new AccessibilityNodeInfo.AccessibilityAction(
            4, context.getResources().getString(R.string.autofill_save_title_with_2types));
    this.mLegacyQuickSettingsAction =
        new AccessibilityNodeInfo.AccessibilityAction(
            5, context.getResources().getString(R.string.autofill_save_type_credit_card));
    this.mLegacyPowerDialogAction =
        new AccessibilityNodeInfo.AccessibilityAction(
            6, context.getResources().getString(R.string.autofill_save_type_address));
    this.mLegacyLockScreenAction =
        new AccessibilityNodeInfo.AccessibilityAction(
            8, context.getResources().getString(R.string.autofill_save_title));
    this.mLegacyTakeScreenshotAction =
        new AccessibilityNodeInfo.AccessibilityAction(
            9, context.getResources().getString(R.string.autofill_save_type_email_address));
  }
    ...
    try {
      synchronized (this.mSystemActionLock) {
        ...
        RemoteAction remoteAction =
            (RemoteAction) this.mRegisteredSystemActions.get(Integer.valueOf(i));
        if (remoteAction != null) {
          try {
            ...
            Slog.e(
                ...
                "canceled PendingIntent for global action " + ((Object) remoteAction.getTitle()),
                e);
            return false;
          }
        }
        switch (i) {
          case 1:
            sendDownAndUpKeyEvents(
                4, FrameworkStatsLog.HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__UP);
            return true;
          case 2:
            sendDownAndUpKeyEvents(
  ...
  public final void sendKeyEventIdentityCleared(int i, int i2, long j, long j2, int i3) {
    KeyEvent obtain =
        KeyEvent.obtain(
            ...
            8,
            i3,
            this.mDisplayUpdateCallBack.getLastNonProxyTopFocusedDisplayId(),
            null);
  ...
  public final boolean takeScreenshot() {
    ...
    (supplier != null ? (ScreenshotHelper) supplier.get() : new ScreenshotHelper(this.mContext))
        .takeScreenshot(4, new Handler(Looper.getMainLooper()), (Consumer) null);
    return true;
  }
}
