...
public class AutoclickController extends BaseEventStreamTransformation {
  ...
  public void onKeyEvent(KeyEvent keyEvent, int i) {
    if (this.mTrace.isA11yTracingEnabledForTypes(4096L)) {
      this.mTrace.logTrace(
          LOG_TAG + ".onKeyEvent", 4096L, "event=" + keyEvent + ";policyFlags=" + i);
    }
    if (this.mClickScheduler != null) {
  ...
  public final class ClickDelayObserver extends ContentObserver {
    ...
    public void start(ContentResolver contentResolver, ClickScheduler clickScheduler) {
      ...
      contentResolver.registerContentObserver(
          this.mAutoclickDelaySettingUri, false, this, this.mUserId);
    ...
    public void onChange(boolean z, Uri uri) {
      if (this.mAutoclickDelaySettingUri.equals(uri)) {
        this.mClickScheduler.updateDelay(
            Settings.Secure.getIntForUser(
                this.mContentResolver, "accessibility_autoclick_delay", 600, this.mUserId));
      }
    }
  }
