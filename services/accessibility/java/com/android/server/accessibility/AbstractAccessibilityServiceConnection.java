        ...
        synchronized (this.mLock) {
            ...
            try {
                if (i3 != 64 && i3 != 128) {
                    ...
                    if (!intConnTracingEnabled()) {
                        logTraceIntConn("performAccessibilityAction", j + KnoxVpnFirewallHelper.DELIMITER + i3 + KnoxVpnFirewallHelper.DELIMITER + bundle + KnoxVpnFirewallHelper.DELIMITER + i4 + KnoxVpnFirewallHelper.DELIMITER + iAccessibilityInteractionConnectionCallback + KnoxVpnFirewallHelper.DELIMITER + this.mFetchFlags + KnoxVpnFirewallHelper.DELIMITER + callingPid + KnoxVpnFirewallHelper.DELIMITER + j2);
                    }
