...
public abstract class AbstractAccessibilityServiceConnection
  ...
  public AbstractAccessibilityServiceConnection(
    ...
    this.mEventDispatchHandler =
        new Handler(handler.getLooper()) { // from class:
          // com.android.server.accessibility.AbstractAccessibilityServiceConnection.1
          @Override // android.os.Handler
          public void handleMessage(Message message) {
            AbstractAccessibilityServiceConnection.this.notifyAccessibilityEventInternal(
                message.what, (AccessibilityEvent) message.obj, message.arg1 != 0);
          }
        };
  ...
  public void setDynamicallyConfigurableProperties(
      AccessibilityServiceInfo accessibilityServiceInfo) {
  ...
  public boolean supportsFlagForNotImportantViews(
      AccessibilityServiceInfo accessibilityServiceInfo) {
    return accessibilityServiceInfo.getResolveInfo().serviceInfo.applicationInfo.targetSdkVersion
        >= 16;
  }
  ...
  public AccessibilityWindowInfo.WindowListSparseArray getWindows() {
    ...
    synchronized (this.mLock) {
      ...
      ArrayList displayListLocked =
          this.mA11yWindowManager.getDisplayListLocked(this.mDisplayTypes);
  ...
  public AccessibilityWindowInfo getWindow(int i) {
    ...
    synchronized (this.mLock) {
      ensureWindowsAvailableTimedLocked(
          i != -1
              ? this.mA11yWindowManager.getDisplayIdByUserIdAndWindowIdLocked(
                  this.mSystemSupport.getCurrentUserIdLocked(), i)
              : -1);
      if (!hasRightsToCurrentUserLocked()) {
        return null;
      }
  ...
  public String[] findAccessibilityNodeInfosByViewId(
    ...
    synchronized (this.mLock) {
      ...
      if (!this.mSecurityPolicy.canGetAccessibilityNodeInfoLocked(
          this.mSystemSupport.getCurrentUserIdLocked(), this, resolveAccessibilityWindowIdLocked)) {
        return null;
      }
      AccessibilityWindowManager.RemoteAccessibilityConnection connectionLocked =
          this.mA11yWindowManager.getConnectionLocked(
              this.mSystemSupport.getCurrentUserIdLocked(), resolveAccessibilityWindowIdLocked);
      ...
      Pair windowTransformationMatrixAndMagnificationSpec =
          getWindowTransformationMatrixAndMagnificationSpec(resolveAccessibilityWindowIdLocked);
      ...
      try {
        ...
        String[] computeValidReportedPackages =
            this.mSecurityPolicy.computeValidReportedPackages(
                connectionLocked.getPackageName(), connectionLocked.getUid());
        Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public String[] findFocus(
    ...
    synchronized (this.mLock) {
      ...
      if (!this.mSecurityPolicy.canGetAccessibilityNodeInfoLocked(
          this.mSystemSupport.getCurrentUserIdLocked(),
          this,
  ...
  public boolean isFingerprintGestureDetectionAvailable() {
    ...
    return this.mContext.getPackageManager().hasSystemFeature("android.hardware.fingerprint")
        ...
        && (fingerprintGestureDispatcher = this.mSystemSupport.getFingerprintGestureDispatcher())
            != null
        && fingerprintGestureDispatcher.isFingerprintGestureDetectionAvailable();
  }
  ...
  public Region getMagnificationRegion(int i) {
    ...
    synchronized (this.mLock) {
      ...
      MagnificationProcessor magnificationProcessor =
          this.mSystemSupport.getMagnificationProcessor();
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        magnificationProcessor.getFullscreenMagnificationRegion(
            i, obtain, this.mSecurityPolicy.canControlMagnification(this));
        return obtain;
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
  ...
  public float getMagnificationCenterX(int i) {
    ...
    synchronized (this.mLock) {
      ...
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        return magnificationProcessor.getCenterX(
            i, this.mSecurityPolicy.canControlMagnification(this));
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
  ...
  public float getMagnificationCenterY(int i) {
    ...
    synchronized (this.mLock) {
      ...
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        return magnificationProcessor.getCenterY(
            i, this.mSecurityPolicy.canControlMagnification(this));
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
  ...
  */
  ...
  public boolean setMagnificationConfig(int i, MagnificationConfig magnificationConfig, boolean z) {
    if (svcConnTracingEnabled()) {
      logTraceSvcConn(
          "setMagnificationSpec", "displayId=" + i + ", config=" + magnificationConfig.toString());
    }
    synchronized (this.mLock) {
      if (!hasRightsToCurrentUserLocked()) {
        return false;
      ...
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        return this.mSystemSupport
            .getMagnificationProcessor()
            .setMagnificationConfig(i, magnificationConfig, z, this.mId);
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
  ...
  public void takeScreenshotOfWindow(
    ...
    if (uptimeMillis
            - ((Long) this.mRequestTakeScreenshotOfWindowTimestampMs.get(i, 0L)).longValue()
        <= 333) {
    ...
    synchronized (this.mLock) {
      ...
      AccessibilityWindowManager.RemoteAccessibilityConnection connectionLocked =
          this.mA11yWindowManager.getConnectionLocked(
              this.mSystemSupport.getCurrentUserIdLocked(), resolveAccessibilityWindowIdLocked(i));
      if (connectionLocked == null) {
        ...
        connectionLocked
            ...
            .takeScreenshotOfWindow(
                i2, screenCaptureListener, iAccessibilityInteractionConnectionCallback);
      }
    }
  }
        ...
        this.mMainHandler.post(
            PooledLambda.obtainRunnable(
                    new Consumer() { // from class:
                      // com.android.server.accessibility.AbstractAccessibilityServiceConnection$$ExternalSyntheticLambda0
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        AbstractAccessibilityServiceConnection.this.lambda$takeScreenshot$0(
                            i, remoteCallback, obj);
                      }
                    },
                    (Object) null)
                .recycleOnUse());
  ...
  public /* synthetic */ void lambda$takeScreenshot$0(
      int i, RemoteCallback remoteCallback, Object obj) {
  ...
  public final void sendScreenshotFailure(final int i, final RemoteCallback remoteCallback) {
    this.mMainHandler.post(
        PooledLambda.obtainRunnable(
                new Consumer() { // from class:
                  // com.android.server.accessibility.AbstractAccessibilityServiceConnection$$ExternalSyntheticLambda1
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
                    AbstractAccessibilityServiceConnection.lambda$sendScreenshotFailure$1(
                        i, remoteCallback, obj);
                  }
                },
                (Object) null)
  ...
  public static /* synthetic */ void lambda$sendScreenshotFailure$1(
      int i, RemoteCallback remoteCallback, Object obj) {
    Bundle bundle = new Bundle();
  ...
  public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
    if (DumpUtils.checkDumpPermission(
      ...
      synchronized (this.mLock) {
        ...
        printWriter.append(
            (CharSequence) (", requestTouchExplorationMode=" + this.mRequestTouchExplorationMode));
        printWriter.append(
            (CharSequence) (", requestFilterKeyEvents=" + this.mRequestFilterKeyEvents));
        printWriter.append(
            (CharSequence) (", retrieveInteractiveWindows=" + this.mRetrieveInteractiveWindows));
        printWriter.append(
            (CharSequence) (", captureFingerprintGestures=" + this.mCaptureFingerprintGestures));
        printWriter.append(
            (CharSequence) (", requestAccessibilityButton=" + this.mRequestAccessibilityButton));
        printWriter.append(
            (CharSequence)
        ...
        printWriter.append(
            (CharSequence)
                (", nonInteractiveUiTimeout="
                    + this.mAccessibilityServiceInfo.getNonInteractiveUiTimeoutMillis()));
        printWriter.append(
            (CharSequence)
                (", interactiveUiTimeout="
                    + this.mAccessibilityServiceInfo.getInteractiveUiTimeoutMillis()));
        printWriter.append(
            (CharSequence)
                (", feedbackType"
                    + AccessibilityServiceInfo.feedbackTypeToString(this.mFeedbackType)));
        printWriter.append(
            (CharSequence) (", capabilities=" + this.mAccessibilityServiceInfo.getCapabilities()));
        printWriter.append(
            (CharSequence)
                (", eventTypes=" + AccessibilityEvent.eventTypeToString(this.mEventTypes)));
  ...
  public final void notifyAccessibilityEventInternal(
      int i, AccessibilityEvent accessibilityEvent, boolean z) {
    synchronized (this.mLock) {
      ...
      try {
        try {
          if (svcClientTracingEnabled()) {
            logTraceSvcClient(
                "onAccessibilityEvent", accessibilityEvent + KnoxVpnFirewallHelper.DELIMITER + z);
          }
          iAccessibilityServiceClient.onAccessibilityEvent(accessibilityEvent, z);
        } catch (RemoteException e) {
          Slog.e(
              "AbstractAccessibilityServiceConnection",
              "Error during sending " + accessibilityEvent + " to " + iAccessibilityServiceClient,
              e);
        }
      } finally {
  ...
  public void notifyMagnificationChangedLocked(
  ...
  public void setImeSessionEnabledLocked(
  ...
  public final void notifyMagnificationChangedInternal(
      int i, Region region, MagnificationConfig magnificationConfig) {
    ...
    if (serviceInterfaceSafely != null) {
      try {
        if (svcClientTracingEnabled()) {
          logTraceSvcClient(
              "onMagnificationChanged", i + ", " + region + ", " + magnificationConfig.toString());
        }
        serviceInterfaceSafely.onMagnificationChanged(i, region, magnificationConfig);
      } catch (RemoteException e) {
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "Error sending magnification changes to " + this.mService,
            e);
      }
    }
  }
  ...
  public final void notifySoftKeyboardShowModeChangedInternal(int i) {
    ...
    if (serviceInterfaceSafely != null) {
      try {
        ...
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "Error sending soft keyboard show mode changes to " + this.mService,
            e);
      }
    }
  }
  ...
  public final void notifyAccessibilityButtonClickedInternal(int i) {
    ...
    if (serviceInterfaceSafely != null) {
      try {
        ...
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "Error sending accessibility button click to " + this.mService,
            e);
      }
    }
  }
  ...
  public final void notifyAccessibilityButtonAvailabilityChangedInternal(boolean z) {
    if (this.mReceivedAccessibilityButtonCallbackSinceBind
    ...
    if (serviceInterfaceSafely != null) {
      try {
        ...
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "Error sending accessibility button availability change to " + this.mService,
            e);
      }
    }
  }
  ...
  public final void notifyGestureInternal(AccessibilityGestureEvent accessibilityGestureEvent) {
    ...
    if (serviceInterfaceSafely != null) {
      try {
        ...
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "Error during sending gesture " + accessibilityGestureEvent + " to " + this.mService,
            e);
      }
    }
  }
  ...
  public final void notifySystemActionsChangedInternal() {
    ...
    if (serviceInterfaceSafely != null) {
      try {
        ...
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "Error sending system actions change to " + this.mService,
            e);
      }
    }
  }
  ...
  public final void setImeSessionEnabledInternal(
      IAccessibilityInputMethodSession iAccessibilityInputMethodSession, boolean z) {
    IAccessibilityServiceClient serviceInterfaceSafely = getServiceInterfaceSafely();
  ...
  public final void bindInputInternal() {
    ...
    if (serviceInterfaceSafely != null) {
      try {
        ...
        Slog.e(
            "AbstractAccessibilityServiceConnection", "Error binding input to " + this.mService, e);
      }
    }
  }
  ...
  public final void unbindInputInternal() {
    ...
    if (serviceInterfaceSafely != null) {
      try {
        ...
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "Error unbinding input to " + this.mService,
            e);
      }
    }
  }

  public final void startInputInternal(
      IRemoteAccessibilityInputConnection iRemoteAccessibilityInputConnection,
      EditorInfo editorInfo,
      boolean z) {
    IAccessibilityServiceClient serviceInterfaceSafely = getServiceInterfaceSafely();
    if (serviceInterfaceSafely != null) {
      try {
        ...
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "Error starting input to " + this.mService,
            e);
      }
    }
  }
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final boolean performAccessibilityActionInternal(
      int i,
      int i2,
      long j,
      int i3,
    ...
    synchronized (this.mLock) {
      AccessibilityWindowManager.RemoteAccessibilityConnection connectionLocked =
          this.mA11yWindowManager.getConnectionLocked(i, i2);
      if (connectionLocked == null) {
        return false;
      }
      try {
        if (i3 != 64 && i3 != 128) {
          ...
          windowTokenForUserAndWindowIdLocked =
              z ? this.mA11yWindowManager.getWindowTokenForUserAndWindowIdLocked(i, i2) : null;
          ...
          if (findA11yWindowInfoByIdLocked != null
              ...
              && this.mA11yWindowManager.getPictureInPictureActionReplacingConnection() != null
              && !z) {
            connectionLocked =
                this.mA11yWindowManager.getPictureInPictureActionReplacingConnection();
          }
          int callingPid = Binder.getCallingPid();
        ...
        connectionLocked
            .getRemote()
            .performAccessibilityAction(
                j, i3, bundle, i4, iAccessibilityInteractionConnectionCallback, i5, callingPid, j2);
        Binder.restoreCallingIdentity(clearCallingIdentity);
        return true;
      } catch (RemoteException unused) {
        Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public final IAccessibilityInteractionConnectionCallback replaceCallbackIfNeeded(
    ...
    AccessibilityWindowManager.RemoteAccessibilityConnection
        pictureInPictureActionReplacingConnection =
            this.mA11yWindowManager.getPictureInPictureActionReplacingConnection();
    synchronized (this.mLock) {
      AccessibilityWindowInfo findA11yWindowInfoByIdLocked =
          this.mA11yWindowManager.findA11yWindowInfoByIdLocked(i);
      if (findA11yWindowInfoByIdLocked != null
          && findA11yWindowInfoByIdLocked.isInPictureInPictureMode()
          && pictureInPictureActionReplacingConnection != null) {
        return new ActionReplacingCallback(
            iAccessibilityInteractionConnectionCallback,
            pictureInPictureActionReplacingConnection.getRemote(),
            i2,
            i3,
            j);
      }
  ...
  public final List getWindowsByDisplayLocked(int i) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      AccessibilityWindowInfo obtain =
          AccessibilityWindowInfo.obtain((AccessibilityWindowInfo) windowListLocked.get(i2));
      obtain.setConnectionId(this.mId);
  ...
  public final class InvocationHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      int i = message.what;
      if (i == 1) {
        AbstractAccessibilityServiceConnection.this.notifyGestureInternal(
            (AccessibilityGestureEvent) message.obj);
        return;
      }
      if (i == 2) {
      ...
      switch (i) {
        case 5:
          ...
          AbstractAccessibilityServiceConnection.this.notifyMagnificationChangedInternal(
              someArgs.argi1, (Region) someArgs.arg1, (MagnificationConfig) someArgs.arg2);
          someArgs.recycle();
          return;
        case 6:
          AbstractAccessibilityServiceConnection.this.notifySoftKeyboardShowModeChangedInternal(
              message.arg1);
          return;
        case 7:
        ...
        case 8:
          AbstractAccessibilityServiceConnection.this
              .notifyAccessibilityButtonAvailabilityChangedInternal(message.arg1 != 0);
          return;
        case 9:
        ...
        case 10:
          ...
          return;
        case 11:
          AbstractAccessibilityServiceConnection.this.setImeSessionEnabledInternal(
              (IAccessibilityInputMethodSession) message.obj, message.arg1 != 0);
          return;
        case 12:
        ...
        case 14:
          ...
          AbstractAccessibilityServiceConnection.this.startInputInternal(
              (IRemoteAccessibilityInputConnection) someArgs2.arg1, (EditorInfo) someArgs2.arg2, z);
          someArgs2.recycle();
          return;
        default:
  ...
  public void logTrace(
    ...
    if (this.mTrace.isA11yTracingEnabledForTypes(j2)) {
      ...
      this.mTrace.logTrace(
          ...
          j3,
          i2,
          (StackTraceElement[]) arrayList.toArray(new StackTraceElement[arrayList.size()]),
  ...
  public void logTraceSvcClient(String str, String str2) {
    this.mTrace.logTrace(
        "AbstractAccessibilityServiceConnection.IAccessibilityServiceClient." + str, 2L, str2);
  }
  ...
  public void logTraceSvcConn(String str, String str2) {
    this.mTrace.logTrace(
        "AbstractAccessibilityServiceConnection.IAccessibilityServiceConnection." + str, 1L, str2);
  }
    ...
    public void sessionCreated(
      ...
      try {
        InputMethodManagerInternal.get()
            .onSessionForAccessibilityCreated(i, iAccessibilityInputMethodSession);
        Binder.restoreCallingIdentity(clearCallingIdentity);
        Trace.traceEnd(32L);
      } catch (Throwable th) {
        Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public void attachAccessibilityOverlayToWindow(int i, SurfaceControl surfaceControl) {
    ...
    synchronized (this.mLock) {
      ...
      if (connectionLocked == null) {
        Slog.e(
            "AbstractAccessibilityServiceConnection",
            "unable to get remote accessibility connection.");
      } else {
