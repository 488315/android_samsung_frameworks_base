  ...
  */
  ...
  public class ReceivedPointerTracker {
    ...
    public void clear() {
      ...
      for (int i = 0; i < 32; i++) {
        this.mReceivedPointers[i] = TouchState.this.new PointerDownInfo();
      }
    }
    ...
    public float getReceivedPointerDownX(int i) {
      return this.mReceivedPointers[i].f1623mX;
    }

    public float getReceivedPointerDownY(int i) {
      return this.mReceivedPointers[i].f1624mY;
    }
    ...
    public final void handleReceivedPointerDown(int i, MotionEvent motionEvent) {
      ...
      this.mReceivedPointers[pointerId].set(
          motionEvent.getX(i), motionEvent.getY(i), motionEvent.getEventTime());
  ...
  public class PointerDownInfo {
    ...
    /* renamed from: mX */
    public float f1623mX;

    /* renamed from: mY */
    public float f1624mY;
    ...
    public void clear() {
      this.f1623mX = DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
      this.f1624mY = DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
      this.mTime = 0L;
    }
  }
}
