...
public class TouchExplorer extends BaseEventStreamTransformation
  ...
  public TouchExplorer(
    ...
    this.mDispatcher =
        new EventDispatcher(context, accessibilityManagerService, super.getNext(), this.mState);
    ...
    this.mEdgeSwipeHeightPixels =
        (context.getResources().getDisplayMetrics().ydpi / GestureUtils.CM_PER_INCH) * 0.25f;
    ...
    this.mSendTouchExplorationEndDelayed =
        new SendAccessibilityEventDelayed(1024, this.mDetermineUserIntentTimeout);
    this.mSendTouchInteractionEndDelayed =
        new SendAccessibilityEventDelayed(2097152, this.mDetermineUserIntentTimeout);
  ...
  public void onMotionEvent(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    ...
    try {
      ...
      if (DEBUG || SEC_DEBUG) {
        Slog.d(
            "TouchExplorer",
            "Received event: " + motionEvent + ", policyFlags=0x" + Integer.toHexString(i));
        Slog.d("TouchExplorer", this.mState.toString());
      }
      this.mState.onReceivedMotionEvent(motionEvent, motionEvent2, i);
      if (shouldPerformGestureDetection(motionEvent)
          && this.mGestureDetector.onMotionEvent(motionEvent, motionEvent2, i)) {
        return;
      }
  ...
  public void onAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
    if (this.mAms.getTraceManager().isA11yTracingEnabledForTypes(12288L)) {
      this.mAms
          .getTraceManager()
          .logTrace("TouchExplorer.onAccessibilityEvent", 12288L, "event=" + accessibilityEvent);
    }
      ...
      if (isSendMotionEventsEnabled()) {
        dispatchGesture(
            new AccessibilityGestureEvent(
                18, this.mDisplayId, this.mGestureDetector.getMotionEvents()));
      }
  ...
  public boolean onDoubleTap(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    ...
    if (isSendMotionEventsEnabled()) {
      dispatchGesture(
          new AccessibilityGestureEvent(
              17, this.mDisplayId, this.mGestureDetector.getMotionEvents()));
    }
    if (this.mSendTouchExplorationEndDelayed.isPending()) {
    ...
    this.mDispatcher.sendAccessibilityEvent(2097152);
    this.mSendTouchInteractionEndDelayed.cancel();
    if (!this.mAms.performActionOnAccessibilityFocusedItem(
  ...
  public void onDoubleTap() {
    onDoubleTap(
        this.mState.getLastReceivedEvent(),
        this.mState.getLastReceivedRawEvent(),
        this.mState.getLastReceivedPolicyFlags());
  }
  ...
  public boolean onGestureCompleted(AccessibilityGestureEvent accessibilityGestureEvent) {
    if (this.mAms.getTraceManager().isA11yTracingEnabledForTypes(12288L)) {
      this.mAms
          .getTraceManager()
          .logTrace(
              "TouchExplorer.onGestureCompleted", 12288L, "event=" + accessibilityGestureEvent);
    }
    if (DEBUG) {
  ...
  public boolean onGestureCancelled(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    ...
    if (isSendMotionEventsEnabled()) {
      dispatchGesture(
          new AccessibilityGestureEvent(
              0, this.mDisplayId, this.mGestureDetector.getMotionEvents()));
    }
    return false;
  }

  public final void handleMotionEventStateClear(
    ...
    if (this.mState.isClear()) {
      ...
      if (this.mTouchExplorationPassthroughRegion.contains(
        ...
        this.mDispatcher.sendMotionEvent(
            obtainNoHistory, obtainNoHistory.getAction(), motionEvent2, -1, i);
        this.mSendHoverEnterAndMoveDelayed.cancel();
  ...
  public final void handleMotionEventStateTouchInteracting(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
  ...
  public final void handleMotionEventStateTouchExploring(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    int actionMasked = motionEvent.getActionMasked();
    if (actionMasked == 1) {
      handleActionUp(motionEvent, motionEvent2, i);
  ...
  public final void handleActionPointerDown(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    if (this.mSendHoverEnterAndMoveDelayed.isPending()) {
      this.mSendHoverEnterAndMoveDelayed.cancel();
      this.mSendHoverExitDelayed.cancel();
  ...
  public final void handleActionMoveStateTouchInteracting(
    ...
    int findPointerIndex =
        motionEvent.findPointerIndex(this.mReceivedPointerTracker.getPrimaryPointerId());
    if (this.mState.isServiceDetectingGestures()) {
      this.mAms.sendMotionEventToListeningServices(motionEvent2);
      this.mSendHoverEnterAndMoveDelayed.addEvent(motionEvent, motionEvent2);
      return;
    ...
    if (pointerCount == 2) {
      if (!this.mGestureDetector.isMultiFingerGesturesEnabled()
          || this.mGestureDetector.isTwoFingerPassthroughEnabled()) {
        this.mSendHoverEnterAndMoveDelayed.cancel();
        this.mSendHoverExitDelayed.cancel();
        if (this.mGestureDetector.isMultiFingerGesturesEnabled()
            && this.mGestureDetector.isTwoFingerPassthroughEnabled()) {
          ...
          for (int i2 = 0; i2 < motionEvent.getPointerCount(); i2++) {
            ...
            if (Math.hypot(
                    this.mReceivedPointerTracker.getReceivedPointerDownX(pointerId)
                        - motionEvent2.getX(i2),
                    this.mReceivedPointerTracker.getReceivedPointerDownY(pointerId)
        ...
        if (isDraggingGesture(obtainNoHistory)) {
          if (isSendMotionEventsEnabled()) {
            dispatchGesture(
                new AccessibilityGestureEvent(
                    -1, this.mDisplayId, this.mGestureDetector.getMotionEvents()));
          }
    ...
    if (this.mGestureDetector.isMultiFingerGesturesEnabled()) {
      if (this.mGestureDetector.isTwoFingerPassthroughEnabled()
          && motionEvent.getPointerCount() == 3
          && allPointersDownOnBottomEdge(motionEvent)) {
        if (DEBUG) {
  ...
  public final void handleActionMoveStateTouchExploring(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    ...
    if (pointerCount == 2) {
      if (!this.mGestureDetector.isMultiFingerGesturesEnabled()
        ...
        if (Math.hypot(
                this.mReceivedPointerTracker.getReceivedPointerDownX(primaryPointerId)
                    - motionEvent2.getX(findPointerIndex),
                this.mReceivedPointerTracker.getReceivedPointerDownY(primaryPointerId)
  ...
  public final void handleMotionEventStateDragging(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    int i2;
    if (!this.mGestureDetector.isMultiFingerGesturesEnabled()
        || this.mGestureDetector.isTwoFingerPassthroughEnabled()) {
      if (motionEvent.findPointerIndex(this.mDraggingPointerId) == -1) {
        Slog.e(
            "TouchExplorer",
            "mDraggingPointerId doesn't match any pointers on current event. mDraggingPointerId: "
                + Integer.toString(this.mDraggingPointerId)
                + ", Event: "
                + motionEvent);
        this.mDraggingPointerId = -1;
        i2 = 0;
      ...
      if (actionMasked == 0) {
        Slog.e(
            "TouchExplorer", "Dragging state can be reached only if two pointers are already down");
        clear(motionEvent, i);
        return;
      }
      if (actionMasked == 1) {
        if (motionEvent.getPointerId(GestureUtils.getActionIndex(motionEvent))
            == this.mDraggingPointerId) {
          this.mDraggingPointerId = -1;
  ...
  public final void handleMotionEventStateDelegating(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    int actionMasked = motionEvent.getActionMasked();
    if (actionMasked == 0) {
      Slog.e(
          "TouchExplorer",
          "Delegating state can only be reached if there is at least one pointer down!");
      clear(motionEvent, i);
    } else {
      if (actionMasked == 1) {
  ...
  public final void sendHoverExitAndTouchExplorationGestureEndIfNeeded(int i) {
    ...
    this.mDispatcher.sendMotionEvent(
        lastInjectedHoverEvent, 10, this.mState.getLastReceivedEvent(), pointerIdBits, i);
  }
  ...
  public final void sendTouchExplorationGestureStartAndHoverEnterIfNeeded(int i) {
    ...
    this.mDispatcher.sendMotionEvent(
        lastInjectedHoverEvent,
        9,
        this.mState.getLastReceivedEvent(),
        lastInjectedHoverEvent.getPointerIdBits(),
        i);
  }

  public final boolean isDraggingGesture(MotionEvent motionEvent) {
    return GestureUtils.isDraggingGesture(
        this.mReceivedPointerTracker.getReceivedPointerDownX(0),
        this.mReceivedPointerTracker.getReceivedPointerDownY(0),
        this.mReceivedPointerTracker.getReceivedPointerDownX(1),
        this.mReceivedPointerTracker.getReceivedPointerDownY(1),
        motionEvent.getX(0),
        motionEvent.getY(0),
        motionEvent.getX(1),
        motionEvent.getY(1),
  ...
  public final MotionEvent computeDownEventForDrag(MotionEvent motionEvent) {
    ...
    float receivedPointerDownY =
        this.mReceivedPointerTracker.getReceivedPointerDownY(this.mDraggingPointerId);
    long receivedPointerDownTime =
        this.mReceivedPointerTracker.getReceivedPointerDownTime(this.mDraggingPointerId);
  ...
  public final boolean allPointersDownOnBottomEdge(MotionEvent motionEvent) {
    ...
    for (int i = 0; i < motionEvent.getPointerCount(); i++) {
      float receivedPointerDownY =
          this.mReceivedPointerTracker.getReceivedPointerDownY(motionEvent.getPointerId(i));
  ...
  public final boolean shouldPerformGestureDetection(MotionEvent motionEvent) {
    if (this.mState.isServiceDetectingGestures()
        || this.mState.isDelegating()
        || this.mState.isDragging()) {
      return false;
    }
    if (motionEvent.getActionMasked() != 0) {
      return true;
    ...
    return (this.mTouchExplorationPassthroughRegion.contains(x, y)
            || this.mGestureDetectionPassthroughRegion.contains(x, y))
        ? false
        : true;
  }
  ...
  public void requestTouchExploration() {
    ...
    if (this.mState.isServiceDetectingGestures() && this.mState.isTouchInteracting()) {
      ...
      if (primaryPointerId == -1
          && (lastReceivedEvent = this.mState.getLastReceivedEvent()) != null) {
  ...
  public void requestDragging(int i) {
    if (this.mState.isServiceDetectingGestures()) {
      ...
      if (!this.mState.isTouchInteracting()) {
        Slog.e(
            ...
            "Error: Trying to drag from "
                + TouchState.getStateSymbolicName(this.mState.getState()));
        return;
      }
      ...
      if (computeDownEventForDrag != null) {
        this.mDispatcher.sendMotionEvent(
            computeDownEventForDrag, 0, lastReceivedRawEvent, i2, lastReceivedPolicyFlags);
        this.mDispatcher.sendMotionEvent(
            lastReceivedEvent, 2, lastReceivedRawEvent, i2, lastReceivedPolicyFlags);
      } else {
        this.mDispatcher.sendMotionEvent(
            lastReceivedEvent, 0, lastReceivedRawEvent, i2, lastReceivedPolicyFlags);
      }
    }
  }
  ...
  public void requestDelegating() {
    if (this.mState.isServiceDetectingGestures()) {
      ...
      if (this.mState.isDragging()) {
        this.mDispatcher.sendMotionEvent(
            lastReceivedEvent, 1, lastReceivedRawEvent, -1, lastReceivedPolicyFlags);
      }
      this.mState.startDelegating();
      this.mDispatcher.sendDownForAllNotInjectedPointers(
          lastReceivedEvent, lastReceivedPolicyFlags);
    }
  }
  ...
  public static void checkForMalformedEvent(MotionEvent motionEvent) {
    ...
    for (int i = 0; i < motionEvent.getPointerCount(); i++) {
      try {
        ...
        if (Float.isNaN(x)
            || Float.isNaN(y)
            || x < DisplayPowerController2.RATE_FROM_DOZE_TO_ON
            || y < DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
          throw new IllegalArgumentException("Invalid coordinates: (" + x + ", " + y + ")");
        }
      } catch (Exception e) {
        throw new IllegalArgumentException(
            "Encountered exception getting details of pointer "
                + i
                + " / "
      ...
      if (TouchExplorer.this.mReceivedPointerTracker.getReceivedPointerDownCount() > 1) {
        Slog.e(
            ...
            "Attempted touch exploration with "
                + TouchExplorer.this.mReceivedPointerTracker.getReceivedPointerDownCount()
                + " pointers down.");
        return;
      }
      TouchExplorer.this.mDispatcher.sendAccessibilityEvent(512);
      if (TouchExplorer.this.isSendMotionEventsEnabled()) {
        TouchExplorer.this.dispatchGesture(
            new AccessibilityGestureEvent(
                -2,
                TouchExplorer.this.mState.getLastReceivedEvent().getDisplayId(),
                TouchExplorer.this.mGestureDetector.getMotionEvents()));
      }
      if (!this.mEvents.isEmpty() && !this.mRawEvents.isEmpty()) {
        TouchExplorer.this.mDispatcher.sendMotionEvent(
            (MotionEvent) this.mEvents.get(0),
            9,
            (MotionEvent) this.mRawEvents.get(0),
            this.mPointerIdBits,
            this.mPolicyFlags);
        ...
        for (int i = 1; i < size; i++) {
          TouchExplorer.this.mDispatcher.sendMotionEvent(
              (MotionEvent) this.mEvents.get(i),
              7,
              (MotionEvent) this.mRawEvents.get(i),
              this.mPointerIdBits,
              this.mPolicyFlags);
          if (TouchExplorer.DEBUG) {
  ...
  public class SendHoverExitDelayed implements Runnable {
    ...
    public void run() {
      ...
      TouchExplorer.this.mDispatcher.sendMotionEvent(
          this.mPrototype, 10, this.mRawEvent, this.mPointerIdBits, this.mPolicyFlags);
  ...
  public String toString() {
    return "TouchExplorer { mTouchState: "
        + this.mState
