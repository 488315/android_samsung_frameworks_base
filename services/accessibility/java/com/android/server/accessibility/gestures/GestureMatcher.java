...
public abstract class GestureMatcher {
  ...
  public final void setState(int i, MotionEvent motionEvent, MotionEvent motionEvent2, int i2) {
    ...
    if (stateChangeListener != null) {
      stateChangeListener.onStateChanged(
          this.mGestureId, this.mState, motionEvent, motionEvent2, i2);
    }
  }
  ...
  public final void completeAfterLongPressTimeout(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    completeAfter(ViewConfiguration.getLongPressTimeout(), motionEvent, motionEvent2, i);
  }

  public final void completeAfter(
      long j, MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
    this.mDelayedTransition.cancel();
    this.mDelayedTransition.post(2, j, motionEvent, motionEvent2, i);
  }

  public final void completeAfterDoubleTapTimeout(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
