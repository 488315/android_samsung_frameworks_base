...
public class EventDispatcher {
  ...
  public void sendMotionEvent(
      MotionEvent motionEvent, int i, MotionEvent motionEvent2, int i2, int i3) {
    MotionEvent split;
    ...
    if (this.mLongPressingPointerId >= 0) {
      split =
          offsetEvent(split, -this.mLongPressingPointerDeltaX, -this.mLongPressingPointerDeltaY);
    }
    if (TouchExplorer.DEBUG) {
      Slog.d(
          "EventDispatcher",
          "Injecting event: " + split + ", policyFlags=0x" + Integer.toHexString(i3));
    }
  ...
  public final MotionEvent offsetEvent(MotionEvent motionEvent, int i, int i2) {
    ...
    MotionEvent.PointerProperties[] createArray =
        MotionEvent.PointerProperties.createArray(pointerCount);
  ...
  public void sendDownForAllNotInjectedPointers(MotionEvent motionEvent, int i) {
    ...
    for (int i3 = 0; i3 < pointerCount; i3++) {
      ...
      if (!this.mState.isInjectedPointerDown(pointerId)) {
        i2 |= 1 << pointerId;
        sendMotionEvent(
            motionEvent, computeInjectionAction(0, i3), this.mState.getLastReceivedEvent(), i2, i);
      }
    }
  }
  ...
  public final MotionEvent computeInjectionDownEvent(MotionEvent motionEvent) {
    ...
    for (int i = 0; i < pointerCount; i++) {
      ...
      float receivedPointerDownX =
          this.mState.getReceivedPointerTracker().getReceivedPointerDownX(pointerId);
      float receivedPointerDownY =
          this.mState.getReceivedPointerTracker().getReceivedPointerDownY(pointerId);
  ...
  public final int computeClickLocation(Point point) {
    if (this.mState.getLastInjectedHoverEventForClick() != null) {
      ...
      if (!this.mAms.accessibilityFocusOnlyInActiveWindow()
          || this.mState.getLastTouchedWindowId() == this.mAms.getActiveWindowId()) {
  ...
  public final void sendActionDownAndUp(
      MotionEvent motionEvent, MotionEvent motionEvent2, int i, boolean z) {
