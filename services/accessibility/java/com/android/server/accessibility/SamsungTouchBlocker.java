...
public class SamsungTouchBlocker extends BaseEventStreamTransformation {
  ...
  public SamsungTouchBlocker(Context context, int i) {
    Handler handler =
        new Handler() { // from class: com.android.server.accessibility.SamsungTouchBlocker.1
    ...
    if (this.mIsBlocking) {
      if (actionMasked == 0) {
        if (this.mTapIgnore == null) {
          this.mTapIgnore =
              new SamsungAccessibilityTappingUI(getDisplayContext(motionEvent.getDisplayId()), 1);
        }
  ...
  public final class TouchBlockingObserver extends ContentObserver {
    ...
    public void start(ContentResolver contentResolver) {
      ...
      contentResolver.registerContentObserver(
          this.mTouchBlockingSettingsUri, false, this, this.mUserId);
      this.mContentResolver.registerContentObserver(
          this.mTapDurationSettingsUri, false, this, this.mUserId);
    ...
    public void onChange(boolean z, Uri uri) {
      if (this.mTouchBlockingSettingsUri.equals(uri)) {
        SamsungTouchBlocker.this.mTouchBlockingPeriod =
            Settings.Secure.getFloatForUser(
                this.mContentResolver, "touch_blocking_period", 0.1f, this.mUserId);
        SamsungTouchBlocker samsungTouchBlocker = SamsungTouchBlocker.this;
        samsungTouchBlocker.mTouchBlockingPeriodMilli =
            (long) (samsungTouchBlocker.mTouchBlockingPeriod * 1000.0f);
      } else if (this.mTapDurationSettingsUri.equals(uri)) {
        SamsungTouchBlocker.this.mTapDurationEnabled =
            Settings.Secure.getIntForUser(
                    this.mContentResolver, "tap_duration_enabled", 0, this.mUserId)
                == 1;
      }
    }
  }
