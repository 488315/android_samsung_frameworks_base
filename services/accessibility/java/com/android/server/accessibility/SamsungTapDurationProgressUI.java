...
public class SamsungTapDurationProgressUI {
    ...
    public void setShortThresholdView(boolean z) {
        ...
        imageView.setVisibility(i);
        this.mHold.setVisibility(8);
        this.mSize = this.mContext.getResources().getDimensionPixelSize(z ? R.dimen.chooser_max_collapsed_height : 17106190);
    ...
    public final void makeView() {
        ...
        View inflate = LayoutInflater.from(this.mContext).inflate(R.layout.notification_material_action_emphasized, (ViewGroup) null);
        this.mView = inflate;
    ...
    public final int getNavigationBarHeight() {
        if (this.mContext.getResources().getBoolean(R.bool.config_predictShowStartingSurface)) {
            return this.mContext.getResources().getDimensionPixelSize(R.dimen.notification_custom_view_max_image_height_low_ram);
        }
        return 0;
    }
