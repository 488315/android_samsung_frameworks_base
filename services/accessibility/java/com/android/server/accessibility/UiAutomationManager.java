...
public class UiAutomationManager {
  ...
  public final IBinder.DeathRecipient mUiAutomationServiceOwnerDeathRecipient =
      new IBinder
          .DeathRecipient() { // from class: com.android.server.accessibility.UiAutomationManager.1
  ...
  public void registerUiTestAutomationServiceLocked(
    ...
    Slogf.m96i(
        "UiAutomationManager",
        "Registering UiTestAutomationService (id=%s) when called by user %d",
  ...
  public void unregisterUiTestAutomationServiceLocked(
      IAccessibilityServiceClient iAccessibilityServiceClient) {
    UiAutomationService uiAutomationService;
    synchronized (this.mLock) {
      if (useAccessibility()
          && ((uiAutomationService = this.mUiAutomationService) == null
              ...
              || iAccessibilityServiceClient.asBinder()
                  != this.mUiAutomationService.mServiceInterface.asBinder())) {
        throw new IllegalStateException(
            "UiAutomationService " + iAccessibilityServiceClient + " not registered!");
      }
      destroyUiAutomationService();
    }
  }
  ...
  public boolean suppressingAccessibilityServicesLocked() {
    return !(this.mUiAutomationService == null && useAccessibility())
  ...
  public void dumpUiAutomationService(
          ...
          if (this.mTrace.isA11yTracingEnabledForTypes(2L)) {
            this.mTrace.logTrace(
                ...
                "serviceConnection="
                    ...
                    + this.mId
                    + "windowToken="
                    + this.mOverlayWindowTokens.get(0));
          }
