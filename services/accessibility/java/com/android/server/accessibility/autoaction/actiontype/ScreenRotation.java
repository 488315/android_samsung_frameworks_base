...
public class ScreenRotation extends CornerActionType {
    ...
    public final void initDialog() {
        AlertDialog create = getAlertDialogBuilder(getSystemUiContext()).setTitle(17043028).setMessage(R.string.config_qualified_networks_service_package).setPositiveButton(17043038, new DialogInterface.OnClickListener() { // from class: com.android.server.accessibility.autoaction.actiontype.ScreenRotation.2
