    ...
    switch (str) {
      case "accessibility_button":
        if (Settings.Secure.getIntForUser(
                this.mContext.getContentResolver(), "accessibility_button_mode", 0, this.mUserId)
            != 1) {
      ...
      case "back":
        new Thread(
                new Runnable() { // from class:
                  // com.android.server.accessibility.autoaction.actiontype.NavigationBarAction.1
      ...
      case "recents":
        ...
        statusBarManagerInternal.toggleRecentAppsToType(
