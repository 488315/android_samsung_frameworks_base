...
public class Swipe extends CornerActionType {
    ...
    if (this.mLastMotionEvent != null) {
      new Thread(
              new Runnable() { // from class:
                // com.android.server.accessibility.autoaction.actiontype.Swipe.1
  ...
  public final void swipe(int i) {
    ...
    while (i4 < 6.0f) {
      ...
      int i5 = i3;
      MotionEvent obtain2 =
          MotionEvent.obtain(uptimeMillis, uptimeMillis3, 2, pointerCoords3.x, pointerCoords3.y, 1);
    ...
    MotionEvent obtain3 =
        MotionEvent.obtain(uptimeMillis, uptimeMillis4, 1, pointerCoords4.x, pointerCoords4.y, 1);
