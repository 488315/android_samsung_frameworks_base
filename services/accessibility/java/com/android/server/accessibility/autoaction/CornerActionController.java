...
public class CornerActionController {
  ...
  public ContentObserver mCornerActionTypeObserver =
  ...
  static {
    ...
    TTS_CORNER =
        new int[] {
          ...
          R.string.accessibility_system_action_on_screen_a11y_shortcut_label,
  ...
  public CornerActionController(Context context, int i) {
    ...
    this.mContentResolver.registerContentObserver(
        ...
        false,
        this.mCornerActionTypeObserver,
        i);
  ...
  public final void setCornerAction() {
    String stringForUser =
        Settings.Secure.getStringForUser(
            this.mContentResolver, "accessibility_corner_actions", this.mUserId);
  ...
  public int getCorner(float f, float f2, int i) {
    ...
    if ((f == i2 - 1 && f2 < 40.0f)
        || (i2 - f < 40.0f && f2 == DisplayPowerController2.RATE_FROM_DOZE_TO_ON)) {
      return 1;
    }
      ...
      case "double_click":
        ...
        int intForUser =
            Settings.Secure.getIntForUser(
                this.mContentResolver, "accessibility_corner_action_tip_shown", 0, this.mUserId);
  ...
  public int performGestureAction(MotionEvent motionEvent) {
    ...
    if (str.equals("drag") || str.equals("drag_and_drop")) {
      ...
      CornerActionType create =
          CornerActionType.create(this.mGestureAction, this.mContext, motionEvent);
  ...
  public final void showGestureActionTip(String str, int i, final int i2) {
    ...
    this.mTipPopup.setOnDismissListener(
        new SemTipPopup.OnDismissListener() { // from class:
    ...
    contentView.setAccessibilityDelegate(
        new View.AccessibilityDelegate() { // from class:
            ...
            accessibilityNodeInfo.addAction(
                new AccessibilityNodeInfo.AccessibilityAction(
                    ...
                    CornerActionController.this.mContext.getString(
                        R.string.config_supervisedUserCreationPackage)));
          }
        });
