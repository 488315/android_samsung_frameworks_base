...
public class Zoom extends CornerActionType {
  ...
  public void performCornerAction(final int i) {
    ...
    final int i4 =
        ("com.samsung.android.messaging".equals(topPackageName)
                || KnoxCustomManagerService.LAUNCHER_PACKAGE.equals(topPackageName))
            ? 20
            : 50;
    new Thread(
            new Runnable() { // from class:
              // com.android.server.accessibility.autoaction.actiontype.Zoom.1
  ...
  */
  public final void generateTouchEvent(int i, int i2, int i3, int i4, int i5, int i6) {
    ...
    while (true) {
      ...
      if (this.mInputManager.getInputDevice(i7) != null
          && this.mInputManager.getInputDevice(i7).getName() != null
          && this.mInputManager
              .getInputDevice(i7)
              .getName()
              .toLowerCase()
    ...
    MotionEvent obtain2 =
        MotionEvent.obtain(
            uptimeMillis, j2, 261, 2, iArr, pointerCoordsArr2, 0, 1.0f, 1.0f, i9, 0, 4098, 8388608);
    ...
    MotionEvent obtain5 =
        MotionEvent.obtain(
            uptimeMillis, j5, 1, 1, iArr, pointerCoordsArr, 0, 1.0f, 1.0f, i11, 0, 4098, 8388608);
