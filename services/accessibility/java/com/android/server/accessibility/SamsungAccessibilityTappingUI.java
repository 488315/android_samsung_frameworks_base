...
public class SamsungAccessibilityTappingUI {
  ...
  public SamsungAccessibilityTappingUI(Context context, int i) {
    ...
    if (context != null) {
      this.tappingType = i;
      this.size =
          context.getResources().getDimensionPixelSize(R.dimen.chooser_max_collapsed_height);
  ...
  public void updateView(float f, float f2) {
    ...
    runOnUiThread(
        new Runnable() { // from class:
          // com.android.server.accessibility.SamsungAccessibilityTappingUI$$ExternalSyntheticLambda1
  ...
  public void setIgnoreView(final boolean z) {
    runOnUiThread(
        new Runnable() { // from class:
          // com.android.server.accessibility.SamsungAccessibilityTappingUI$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void setViewOnOff(final boolean z) {
    runOnUiThread(
        new Runnable() { // from class:
          // com.android.server.accessibility.SamsungAccessibilityTappingUI$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
