...
public class FlashNotificationsController {
  ...
  public class C03993 extends AudioManager.AudioPlaybackCallback {
    public C03993() {}
              ...
              ? list.stream()
                  .anyMatch(
                      new Predicate() { // from class:
                        // com.android.server.accessibility.FlashNotificationsController$3$$ExternalSyntheticLambda0
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                          boolean lambda$onPlaybackConfigChanged$0;
                          lambda$onPlaybackConfigChanged$0 =
                              FlashNotificationsController.C03993.lambda$onPlaybackConfigChanged$0(
                                  (AudioPlaybackConfiguration) obj);
    ...
    public static /* synthetic */ boolean lambda$onPlaybackConfigChanged$0(
  ...
  public FlashNotificationsController(Context context) {
    this(
        context,
        getStartedHandler("FlashNotificationThread"),
        getStartedHandler("FlashNotifController"));
  }
  ...
  public FlashNotificationsController(Context context, Handler handler, Handler handler2) {
    ...
    this.mCameraId = null;
    this.mTorchCallback =
        new CameraManager.TorchCallback() { // from class:
          // com.android.server.accessibility.FlashNotificationsController.1
          @Override // android.hardware.camera2.CameraManager.TorchCallback
          public void onTorchModeChanged(String str, boolean z) {
            if (FlashNotificationsController.this.mCameraId == null
                || !FlashNotificationsController.this.mCameraId.equals(str)) {
              return;
            }
    ...
    this.mTorchAvailabilityCallback =
        new CameraManager.AvailabilityCallback() { // from class:
    ...
    this.mAudioPlaybackCallback = new C03993();
    ...
    DisplayManager.DisplayListener displayListener =
        new DisplayManager.DisplayListener() { // from class:
          ...
          public void onDisplayChanged(int i) {
            Display display;
            if (FlashNotificationsController.this.mDisplayManager == null
                || (display = FlashNotificationsController.this.mDisplayManager.getDisplay(i))
                    == null) {
              return;
            }
  ...
  public boolean startFlashNotificationSequence(final String str, int i, IBinder iBinder) {
    FlashNotification flashNotification =
        new FlashNotification(
            ...
            str,
            2,
            getScreenFlashColorPreference(i, str),
            iBinder,
            new IBinder.DeathRecipient() { // from class:
              // com.android.server.accessibility.FlashNotificationsController$$ExternalSyntheticLambda0
  ...
  public boolean startFlashNotificationEvent(String str, int i, String str2) {
    requestStartFlashNotification(
        new FlashNotification(this.mContext, str, str2, 1, getScreenFlashColorPreference(i, str2)));
    return true;
  }
  ...
  public final void startFlashNotificationShortPreview() {
    requestStartFlashNotification(
        new FlashNotification(
            this.mContext, "preview", "preview", 1, getScreenFlashColorPreference(4)));
  }
  ...
  public final void startFlashNotificationSequenceForAlarm() {
    requestStartFlashNotification(
        new FlashNotification("alarm", 2, getScreenFlashColorPreference(2)));
  }
  ...
  public final void requestStartFlashNotification(FlashNotification flashNotification) {
    ...
    if (isEnabled
        && Settings.System.getIntForUser(
                this.mContext.getContentResolver(), SETTING_KEY_SCREEN_FLASH_NOTIFICATION, 0, -2)
            != 0) {
      z = true;
    }
      ...
      this.mMainHandler.sendMessageDelayed(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                // com.android.server.accessibility.FlashNotificationsController$$ExternalSyntheticLambda1
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                  ((FlashNotificationsController) obj)
                      .startFlashNotification(
                          (FlashNotificationsController.FlashNotification) obj2);
                }
              },
              this,
              flashNotification),
  ...
  public final void showScreenNotificationOverlayView(int i) {
    this.mMainHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.accessibility.FlashNotificationsController$$ExternalSyntheticLambda4
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                ((FlashNotificationsController) obj)
                    .showScreenNotificationOverlayViewMainThread(((Integer) obj2).intValue());
              }
            },
            this,
            Integer.valueOf(i)));
  ...
  public final void hideScreenNotificationOverlayView() {
    ...
    this.mMainHandler.sendMessageDelayed(
        PooledLambda.obtainMessage(
            new Consumer() { // from class:
              // com.android.server.accessibility.FlashNotificationsController$$ExternalSyntheticLambda3
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
  ...
  public final void showScreenNotificationOverlayViewMainThread(int i) {
    ...
    WindowManager.LayoutParams layoutParams =
        new WindowManager.LayoutParams(-1, -1, 2015, FrameworkStatsLog.f87x84af90cd, -3);
    ...
    if (this.mScreenFlashNotificationOverlayView == null) {
      ...
      ((WindowManager) this.mContext.getSystemService(WindowManager.class))
          .addView(this.mScreenFlashNotificationOverlayView, layoutParams);
  ...
  public final void hideScreenNotificationOverlayViewMainThread() {
    ...
    if (view != null) {
      ...
      ((WindowManager) this.mContext.getSystemService(WindowManager.class))
          .removeView(this.mScreenFlashNotificationOverlayView);
  ...
  public final void startFlashNotification(FlashNotification flashNotification) {
    ...
    if (this.mIsCameraFlashNotificationEnabled
        && this.mCameraId == null
        && (flashNotification.mNotiType & 1) == 1) {
        ...
        if (i == 1 || i == 3) {
          if (this.mCurrentFlashNotification != null) {
            Log.i(
                ...
                "Default type of flash notification can not work because previous flash"
          ...
          Log.i(
              "FlashNotifController",
              "set service.cameraflashnoti.running to 0 cause of Unavailable noti type");
        }
      }
    } finally {
  ...
  public final FlashNotification removeFlashNotificationLocked(String str) {
    ...
    while (listIterator.hasNext()) {
      ...
      if (flashNotification != null && flashNotification.mTag.equals(str)) {
        ...
        Log.i(
            "FlashNotifController", "removeFlashNotificationLocked: tag=" + flashNotification.mTag);
  ...
  public final void stopFlashNotificationLocked() {
    if (this.mThread != null) {
      Log.i(
          "FlashNotifController",
          "stopFlashNotificationLocked: tag=" + this.mThread.mFlashNotification.mTag);
      this.mThread.cancel();
      this.mThread = null;
    }
  ...
  public final void startNextFlashNotificationLocked() {
    ...
    if (this.mFlashNotifications.size() <= 0) {
      ...
      Log.i(
          "FlashNotifController",
          "set service.cameraflashnoti.running to 0 in startNextFlashNotificationLocked");
      return;
    }
  ...
  public final void startFlashNotificationLocked(FlashNotification flashNotification) {
    Log.i(
        "FlashNotifController",
        "startFlashNotificationLocked: type="
            + flashNotification.mType
            + ", tag="
            + flashNotification.mTag);
    if (flashNotification.mNotiType == 0) {
      ...
      Log.i(
          "FlashNotifController",
          "set service.cameraflashnoti.running to 0 in startFlashNotificationLocked");
    } else {
  ...
  public final void doCameraFlashNotificationOn() {
    ...
    Log.i(
        "FlashNotifController",
        "doCameraFlashNotificationOn: isCameraFlashNotificationEnabled="
            + this.mIsCameraFlashNotificationEnabled
            + ", isTorchOn="
            + this.mIsTorchOn
            + ", isTorchTouched="
            + this.mIsTorchTouched);
  }
  ...
  public final void doScreenFlashNotificationOn(int i, boolean z) {
    ...
    Log.i(
        "FlashNotifController",
        "doScreenFlashNotificationOn: isScreenFlashNotificationEnabled="
            + this.mIsScreenFlashNotificationEnabled
            + ", isDozeMode="
            + isDozeMode
            + ", color="
  ...
  public final void doCameraFlashNotification(boolean z) {
    ...
    Log.d(
        "FlashNotifController",
        "doCameraFlashNotification: " + z + " mCameraId : " + this.mCameraId);
  ...
  public class FlashNotification {
    ...
    public FlashNotification(
        String str, int i, int i2, IBinder iBinder, IBinder.DeathRecipient deathRecipient) {
      this.mType = i;
      this.mTag = str;
      this.mColor = i2;
      this.mToken = iBinder;
      ...
      this.mOffDuration = FrameworkStatsLog.f446x58c6c32;
      this.mRepeat = 2;
      this.mForceStartScreenFlash = false;
    }
      ...
      if (!"alarm".equals(this.mTag) && !"preview".equals(this.mTag)) {
        int intForUser =
            Settings.System.getIntForUser(
                ...
                FlashNotificationsController.SETTING_KEY_SCREEN_FLASH_NOTIFICATION_COLOR_MODE,
                0,
                -2);
        ...
        if (intForUser == 1 && z) {
          this.mColor =
              Color.parseColor(
                  FlashNotificationsController.SCREEN_FLASH_NOTIFICATION_COLOR_APPS_ITEM_SEPARATOR
                      + screenFlashColorElements[1]);
          return;
        }
        return;
      }
    ...
    public final boolean isCameraFlashAvailableForPackage(Context context, String str) {
      String stringForUser =
          Settings.Secure.getStringForUser(
              context.getContentResolver(),
              FlashNotificationsController.SETTING_KEY_CAMERA_FLASH_NOTIFICATION_APP_LIST,
              -2);
      if (TextUtils.isEmpty(stringForUser)
          || FlashNotificationsController.CAMERA_FLASH_NOTIFICATION_ALL_APPS.equals(
              stringForUser)) {
        return true;
      }
      for (String str2 :
          stringForUser.split(
              Character.toString(
                  FlashNotificationsController
                      .SCREEN_FLASH_NOTIFICATION_COLOR_APPS_LIST_SEPARATOR))) {
        if (str2.equals(str)) {
          return true;
        }
      }
    ...
    public final String[] getScreenFlashColorElements(Context context, String str) {
      String stringForUser =
          Settings.Secure.getStringForUser(
              context.getContentResolver(),
              FlashNotificationsController.SETTING_KEY_SCREEN_FLASH_NOTIFICATION_COLOR_APPS,
              -2);
      if (TextUtils.isEmpty(stringForUser)) {
        return null;
      }
      for (String str2 :
        ...
        String[] split =
            str2.split(
                Character.toString(
                    FlashNotificationsController
                        .SCREEN_FLASH_NOTIFICATION_COLOR_APPS_ITEM_SEPARATOR));
  ...
  public class FlashNotificationThread extends Thread {
    ...
    public void run() {
      ...
      Log.d(
          "FlashNotifController",
          "mShouldDoScreenFlash: "
              + this.mShouldDoScreenFlash
              + ", mShouldDoCameraFlash: "
              + this.mShouldDoCameraFlash);
      synchronized (this) {
        FlashNotificationsController.this.mWakeLock.acquire(
        ...
        try {
          ...
          try {
            ...
            Log.e(
                "FlashNotifController",
                "Error while releasing FlashNotificationsController wakelock (already released by"
                    + " the system?)");
          }
        }
      }
      ...
      synchronized (this) {
        while (!this.mForceStop) {
          ...
          if (this.mShouldDoScreenFlash) {
            FlashNotificationsController.this.doScreenFlashNotificationOn(
                this.mColor, this.mFlashNotification.mForceStartScreenFlash);
          }
    ...
    public void onReceive(Context context, Intent intent) {
      if ("android.intent.action.BOOT_COMPLETED".equals(intent.getAction())) {
        ...
        if (FlashNotificationsController.this.mIsCameraFlashNotificationEnabled) {
          ...
          FlashNotificationsController.this.mCameraManager.unregisterTorchCallback(
              FlashNotificationsController.this.mTorchCallback);
        }
        FlashNotificationsController flashNotificationsController2 =
            FlashNotificationsController.this;
        flashNotificationsController2.mCameraManager =
            (CameraManager)
                flashNotificationsController2.mContext.getSystemService(CameraManager.class);
        ...
        cameraManager.registerAvailabilityCallback(
            flashNotificationsController3.mTorchAvailabilityCallback,
            flashNotificationsController3.mCallbackHandler);
        return;
      }
  ...
  public final class FlashContentObserver extends ContentObserver {
    ...
    public void onChange(boolean z, Uri uri) {
      ...
      if (this.mScreenFlashNotificationUri.equals(uri)) {
        FlashNotificationsController flashNotificationsController2 =
            FlashNotificationsController.this;
        flashNotificationsController2.mIsScreenFlashNotificationEnabled =
            Settings.System.getIntForUser(
