...
public class SamsungStickyKeys extends BaseEventStreamTransformation {
  ...
  public SamsungStickyKeys(Context context, int i) {
    Handler handler =
        new Handler() { // from class: com.android.server.accessibility.SamsungStickyKeys.1
          ...
          public void handleMessage(Message message) {
            ...
            if (SamsungStickyKeys.this.mModifierKeyUpEvent[i2] == null
                || SamsungStickyKeys.this.mNext == null) {
              return;
            }
            SamsungStickyKeys.this.debugLog(
                "send KEY_UP : "
                    + SamsungStickyKeys.this.mModifierKeyUpEvent[i2].getKeyCode()
                    + ", index : "
                    + i2);
            SamsungStickyKeys.this.mNext.onKeyEvent(
                SamsungStickyKeys.this.mModifierKeyUpEvent[i2],
                SamsungStickyKeys.this.mModifierKeyUpPolicyFlags[i2]);
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() { // from class:
          // com.android.server.accessibility.SamsungStickyKeys.2
    ...
    this.mContext.registerReceiver(
        broadcastReceiver, new IntentFilter("android.intent.action.CONFIGURATION_CHANGED"));
  ...
  public final void makeViews() {
    if (A11yRune.A11Y_COMMON_BOOL_SUPPORT_LARGE_COVER_SCREEN_FLIP) {
      ...
      Context createWindowContext =
          getSubDisplayContext(this.mContext, displayManager)
              .createWindowContext(displayManager.getDisplay(getDisplayId()), 2009, null);
    ...
    layoutParams.x = 0;
    layoutParams.y =
        (int) TypedValue.applyDimension(1, 32.0f, this.mContext.getResources().getDisplayMetrics());
    layoutParams.samsungFlags |= IInstalld.FLAG_CLEAR_APP_DATA_KEEP_ART_PROFILES;
    layoutParams.layoutInDisplayCutoutMode = 1;
    View inflate =
        LayoutInflater.from(this.mContext)
            .inflate(R.layout.notification_material_action, (ViewGroup) null);
    this.mStickyKeysView = inflate;
    inflate.bringToFront();
    this.mStickyKeysView.invalidate();
    this.mModifierKeys[0] = (TextView) this.mStickyKeysView.findViewById(R.id.verification_icon);
    this.mModifierKeys[1] = (TextView) this.mStickyKeysView.findViewById(R.id.datetime);
    this.mModifierKeys[2] = (TextView) this.mStickyKeysView.findViewById(R.id.always);
    this.mModifierKeys[3] =
        (TextView) this.mStickyKeysView.findViewById(R.id.notification_main_column);
  ...
  public final void setModifierKeyStatus(final int i, final int i2) {
    runOnUiThread(
        new Runnable() { // from class:
          // com.android.server.accessibility.SamsungStickyKeys$$ExternalSyntheticLambda0
  ...
  public /* synthetic */ void lambda$setModifierKeyStatus$0(int i, int i2) {
    ...
    if (i2 == 1) {
      textView.setBackgroundResource(17304307);
    ...
    if (this.mFoldStateListener == null) {
      this.mFoldStateListener =
          new SemWindowManager.FoldStateListener() { // from class:
            // com.android.server.accessibility.SamsungStickyKeys.3
            ...
            public void onFoldStateChanged(boolean z) {
              if (SamsungStickyKeys.this.mStickyKeysView != null) {
                SamsungStickyKeys.this.mWindowManager.removeView(
                    SamsungStickyKeys.this.mStickyKeysView);
  ...
  public final Context getSubDisplayContext(Context context, DisplayManager displayManager) {
    return context.createDisplayContext(
        displayManager.getDisplays("com.samsung.android.hardware.display.category.BUILTIN")[1]);
  }
