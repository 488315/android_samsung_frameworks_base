...
public class AccessibilityTraceManager implements AccessibilityTrace {
  ...
  public static AccessibilityTraceManager getInstance(
    ...
    if (sInstance == null) {
      sInstance =
          new AccessibilityTraceManager(
              accessibilityControllerInternal, accessibilityManagerService, obj);
    }
    return sInstance;
  }
  ...
  public int getTraceStateForAccessibilityManagerClientState() {
    ...
    return isA11yTracingEnabledForTypes(16384L)
    ...
    if (needToNotifyClients(j2)) {
      synchronized (this.mA11yMSLock) {
        ...
        accessibilityManagerService.scheduleUpdateClientsIfNeededLocked(
            accessibilityManagerService.getCurrentUserState());
      }
    }
