...
public class PanningScalingHandler extends GestureDetector.SimpleOnGestureListener
  ...
  public PanningScalingHandler(
      Context context, float f, float f2, boolean z, MagnificationDelegate magnificationDelegate) {
