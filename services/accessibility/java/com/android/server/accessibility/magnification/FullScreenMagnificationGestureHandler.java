...
public class FullScreenMagnificationGestureHandler extends MagnificationGestureHandler {
  ...
  public final FullScreenMagnificationController.MagnificationInfoChangedCallback
  ...
  public FullScreenMagnificationGestureHandler(
    ...
    if (MagnificationGestureHandler.DEBUG_ALL) {
      Log.i(
          this.mLogTag,
          "FullScreenMagnificationGestureHandler(detectTripleTap = "
              + z
    ...
    FullScreenMagnificationController.MagnificationInfoChangedCallback
        magnificationInfoChangedCallback =
            new FullScreenMagnificationController
                .MagnificationInfoChangedCallback() { // from class:
              // com.android.server.accessibility.magnification.FullScreenMagnificationGestureHandler.1
              ...
              public void onFullScreenMagnificationChanged(
                  int i2, Region region, MagnificationConfig magnificationConfig) {}
              ...
              public void onFullScreenMagnificationActivationState(int i2, boolean z3) {
                FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
                    FullScreenMagnificationGestureHandler.this;
  ...
  public final void handleEventWith(
      State state, MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
  ...
  public void onDestroy() {
    if (DEBUG_STATE_TRANSITIONS) {
      Slog.i(
          this.mLogTag,
          "onDestroy(); delayed = "
              + MotionEventInfo.toString(this.mDetectingState.mDelayedEventQueue));
    }
    try {
    ...
    this.mFullScreenMagnificationController.removeInfoChangedCallback(
        this.mMagnificationInfoChangedCallback);
    clearAndTransitionToStateDetecting();
  }
  ...
  public final class PanningScalingState extends GestureDetector.SimpleOnGestureListener
      implements ScaleGestureDetector.OnScaleGestureListener, State {
    ...
    public PanningScalingState(Context context) {
      ...
      context
          .getResources()
          .getValue(R.dimen.config_pictureInPictureMinAspectRatio, typedValue, false);
      this.mContext = context;
      this.mScalingThreshold = typedValue.getFloat();
      ScaleGestureDetector scaleGestureDetector =
          new ScaleGestureDetector(context, this, Handler.getMain());
    ...
    public void onMotionEvent(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
      ...
      if (actionMasked == 6 && motionEvent.getPointerCount() == 2) {
        ...
        ViewportDraggingState viewportDraggingState =
            fullScreenMagnificationGestureHandler.mViewportDraggingState;
    ...
    public final void checkShouldDetectPassPersistedScale() {
      ...
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
          FullScreenMagnificationGestureHandler.this;
      float scale =
          fullScreenMagnificationGestureHandler.mFullScreenMagnificationController.getScale(
              fullScreenMagnificationGestureHandler.mDisplayId);
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler2 =
          FullScreenMagnificationGestureHandler.this;
      float persistedScale =
          fullScreenMagnificationGestureHandler2.mFullScreenMagnificationController
              .getPersistedScale(fullScreenMagnificationGestureHandler2.mDisplayId);
      this.mDetectingPassPersistedScale =
          Math.abs(scale - persistedScale) / persistedScale
    ...
    public void persistScaleAndTransitionTo(State state) {
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
          FullScreenMagnificationGestureHandler.this;
      fullScreenMagnificationGestureHandler.mFullScreenMagnificationController.persistScale(
          fullScreenMagnificationGestureHandler.mDisplayId);
      clear();
    ...
    */
    public void setScaleAndClearIfNeeded(float f, float f2, float f3) {
      ...
      if (this.mDetectingPassPersistedScale) {
        FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
            FullScreenMagnificationGestureHandler.this;
        float persistedScale =
            fullScreenMagnificationGestureHandler.mFullScreenMagnificationController
                .getPersistedScale(fullScreenMagnificationGestureHandler.mDisplayId);
        if (Math.abs(f - persistedScale) / persistedScale < PASSING_PERSISTED_SCALE_THRESHOLD) {
          ...
          if (FullScreenMagnificationGestureHandler.DEBUG_PANNING_SCALING) {
            Slog.i(
                FullScreenMagnificationGestureHandler.this.mLogTag,
                "Scaled content to: " + f4 + "x");
          }
          FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler2 =
              FullScreenMagnificationGestureHandler.this;
          fullScreenMagnificationGestureHandler2.mFullScreenMagnificationController.setScale(
              fullScreenMagnificationGestureHandler2.mDisplayId, f4, f2, f3, false, 0);
          checkShouldDetectPassPersistedScale();
        }
      }
      f4 = f;
      if (FullScreenMagnificationGestureHandler.DEBUG_PANNING_SCALING) {}
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler22 =
          FullScreenMagnificationGestureHandler.this;
      fullScreenMagnificationGestureHandler22.mFullScreenMagnificationController.setScale(
          fullScreenMagnificationGestureHandler22.mDisplayId, f4, f2, f3, false, 0);
      checkShouldDetectPassPersistedScale();
    }
    ...
    public boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
          FullScreenMagnificationGestureHandler.this;
      if (fullScreenMagnificationGestureHandler.mCurrentState
          != fullScreenMagnificationGestureHandler.mPanningScalingState) {
        return true;
      }
      if (FullScreenMagnificationGestureHandler.DEBUG_PANNING_SCALING) {
        Slog.i(
            FullScreenMagnificationGestureHandler.this.mLogTag,
            "Panned content by scrollX: " + f + " scrollY: " + f2);
      }
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler2 =
          FullScreenMagnificationGestureHandler.this;
      fullScreenMagnificationGestureHandler2.mFullScreenMagnificationController
          .offsetMagnifiedRegion(fullScreenMagnificationGestureHandler2.mDisplayId, f, f2, 0);
      return true;
    }
    ...
    */
    public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
      if (!this.mScaling) {
        if (this.mInitialScaleFactor < DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
          this.mInitialScaleFactor = scaleGestureDetector.getScaleFactor();
          return false;
        }
        boolean z =
            Math.abs(scaleGestureDetector.getScaleFactor() - this.mInitialScaleFactor)
                > this.mScalingThreshold;
        this.mScaling = z;
        return z;
      }
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
      ...
      if (scaleFactor <= 8.0f || scaleFactor <= scale) {
        ...
        setScaleAndClearIfNeeded(
            scaleFactor, scaleGestureDetector.getFocusX(), scaleGestureDetector.getFocusY());
        return true;
      }
      scaleFactor = f;
      setScaleAndClearIfNeeded(
    ...
    public boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
          FullScreenMagnificationGestureHandler.this;
      return fullScreenMagnificationGestureHandler.mCurrentState
          == fullScreenMagnificationGestureHandler.mPanningScalingState;
    }
    ...
    public String toString() {
      return "PanningScalingState{mInitialScaleFactor="
  ...
  public final class ViewportDraggingState implements State {
      ...
      if (actionMasked != 0) {
        if (actionMasked != 1) {
          if (actionMasked == 2) {
            ...
            FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
                FullScreenMagnificationGestureHandler.this;
            if (fullScreenMagnificationGestureHandler.mFullScreenMagnificationController
                .magnificationRegionContains(
                    fullScreenMagnificationGestureHandler.mDisplayId, x, y)) {
              FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler2 =
                  FullScreenMagnificationGestureHandler.this;
              fullScreenMagnificationGestureHandler2.mFullScreenMagnificationController.setCenter(
                  fullScreenMagnificationGestureHandler2.mDisplayId,
                  x,
                  y,
                  this.mLastMoveOutsideMagnifiedRegion,
                  0);
        ...
        if (f >= 1.0f) {
          FullScreenMagnificationGestureHandler.this.zoomToScale(
        ...
        FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler3 =
            FullScreenMagnificationGestureHandler.this;
        fullScreenMagnificationGestureHandler3.transitionTo(
            fullScreenMagnificationGestureHandler3.mDetectingState);
        return;
      }
      throw new GestureException(
          "Unexpected event type: " + MotionEvent.actionToString(actionMasked));
    }

    public final boolean isAlwaysOnMagnificationEnabled() {
      return FullScreenMagnificationGestureHandler.this.mFullScreenMagnificationController
          .isAlwaysOnMagnificationEnabled();
    }
    ...
    public void prepareForZoomInTemporary(boolean z) {
      ...
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
          FullScreenMagnificationGestureHandler.this;
      if (fullScreenMagnificationGestureHandler.mFullScreenMagnificationController.isActivated(
          fullScreenMagnificationGestureHandler.mDisplayId)) {
      ...
      if (z2) {
        FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler2 =
            FullScreenMagnificationGestureHandler.this;
        f =
            fullScreenMagnificationGestureHandler2.mFullScreenMagnificationController.getScale(
                fullScreenMagnificationGestureHandler2.mDisplayId);
      } else {
        f = Float.NaN;
      }
    ...
    public final void clearAndTransitToPanningScalingState() {
      ...
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
          FullScreenMagnificationGestureHandler.this;
      fullScreenMagnificationGestureHandler.transitionTo(
          fullScreenMagnificationGestureHandler.mPanningScalingState);
    }
    ...
    public String toString() {
      return "ViewportDraggingState{mScaleToRecoverAfterDraggingEnd="
          + this.mScaleToRecoverAfterDraggingEnd
    ...
    public void onMotionEvent(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
      ...
      if (actionMasked == 0) {
        FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
            FullScreenMagnificationGestureHandler.this;
        fullScreenMagnificationGestureHandler.transitionTo(
            fullScreenMagnificationGestureHandler.mDelegatingState);
        this.mLastDelegatedDownEventTime = motionEvent.getDownTime();
      } else if (actionMasked == 1 || actionMasked == 3) {
        FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler2 =
            FullScreenMagnificationGestureHandler.this;
        fullScreenMagnificationGestureHandler2.transitionTo(
            fullScreenMagnificationGestureHandler2.mDetectingState);
      }
      if (FullScreenMagnificationGestureHandler.this.getNext() != null) {
        motionEvent.setDownTime(this.mLastDelegatedDownEventTime);
        FullScreenMagnificationGestureHandler.this.dispatchTransformedEvent(
            motionEvent, motionEvent2, i);
      }
    }
  }
  ...
  public final class DetectingState implements State, Handler.Callback {
    ...
    public DetectingState(Context context) {
      this.mMultiTapMaxDelay =
          ViewConfiguration.getDoubleTapTimeout()
              + context.getResources().getInteger(R.integer.config_screen_rotation_total_90);
    ...
    public void onMotionEvent(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
      ...
      if (actionMasked == 1) {
        ...
        FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler2 =
            FullScreenMagnificationGestureHandler.this;
        if (!fullScreenMagnificationGestureHandler2.mFullScreenMagnificationController
            .magnificationRegionContains(
                fullScreenMagnificationGestureHandler2.mDisplayId,
                motionEvent.getX(),
                motionEvent.getY())) {
        ...
        if (isMultiTapTriggered(3)) {
          ...
          if (isFingerDown()) {
            if (timeBetween(this.mLastDown, this.mLastUp) >= this.mLongTapMinDelay
                || GestureUtils.distance(this.mLastDown, this.mLastUp) >= this.mSwipeMinDistance) {
              transitionToDelegatingStateAndClear();
              return;
            }
            return;
      ...
      if (isFingerDown()
          && GestureUtils.distance(this.mLastDown, motionEvent) > this.mSwipeMinDistance) {
      ...
      if (isActivated()
          && secondPointerDownValid()
          && GestureUtils.distanceClosestPointerToPoint(
                  this.mSecondPointerDownLocation, motionEvent)
    ...
    public final void storeSecondPointerDownLocation(MotionEvent motionEvent) {
      ...
      this.mSecondPointerDownLocation.set(
          motionEvent.getX(actionIndex), motionEvent.getY(actionIndex));
    }

    public final boolean secondPointerDownValid() {
      return (Float.isNaN(this.mSecondPointerDownLocation.x)
              && Float.isNaN(this.mSecondPointerDownLocation.y))
          ? false
          : true;
    }
    ...
    public boolean isMultiTapTriggered(int i) {
      ...
      boolean z =
          FullScreenMagnificationGestureHandler.this.mDetectTripleTap
              && tapCount() >= i
              && isMultiTap(this.mPreLastDown, this.mLastDown)
              && isMultiTap(this.mPreLastUp, this.mLastUp);
      if (z && i > 2) {
    ...
    public final boolean isMultiTap(MotionEvent motionEvent, MotionEvent motionEvent2) {
      return GestureUtils.isMultiTap(
          motionEvent, motionEvent2, this.mMultiTapMaxDelay, this.mMultiTapMaxDistance);
    }
    ...
    public void afterLongTapTimeoutTransitionToDraggingState(MotionEvent motionEvent) {
      ...
      handler.sendMessageDelayed(
          handler.obtainMessage(1, MotionEvent.obtain(motionEvent)),
    ...
    public final void sendDelayedMotionEvents() {
      ...
      long min =
          Math.min(
              SystemClock.uptimeMillis() - this.mLastDetectingDownEventTime,
              this.mMultiTapMaxDelay);
      do {
        MotionEventInfo motionEventInfo = this.mDelayedEventQueue;
        ...
        FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
            FullScreenMagnificationGestureHandler.this;
        fullScreenMagnificationGestureHandler.handleEventWith(
            fullScreenMagnificationGestureHandler.mDelegatingState,
            motionEventInfo.event,
            motionEventInfo.rawEvent,
            motionEventInfo.policyFlags);
    ...
    public final void onTripleTap(MotionEvent motionEvent) {
      if (FullScreenMagnificationGestureHandler.DEBUG_DETECTING) {
        Slog.i(
            FullScreenMagnificationGestureHandler.this.mLogTag,
            "onTripleTap(); delayed: " + MotionEventInfo.toString(this.mDelayedEventQueue));
      }
      if (!isActivated() || this.mShortcutTriggered) {
        if (!FullScreenMagnificationGestureHandler.this.mDetectingState.mShortcutTriggered) {
          Settings.Secure.putIntForUser(
              this.mContext.getContentResolver(), "accessibility_magnification_activated", 1, -2);
        }
    ...
    public final boolean isActivated() {
      FullScreenMagnificationGestureHandler fullScreenMagnificationGestureHandler =
          FullScreenMagnificationGestureHandler.this;
      return fullScreenMagnificationGestureHandler.mFullScreenMagnificationController.isActivated(
          fullScreenMagnificationGestureHandler.mDisplayId);
    }
    ...
    public void transitionToViewportDraggingStateAndClear(MotionEvent motionEvent) {
      ...
      clear();
      AccessibilityStatsLogUtils.logMagnificationTripleTap(!isActivated());
      FullScreenMagnificationGestureHandler.this.mViewportDraggingState.prepareForZoomInTemporary(
          z);
      FullScreenMagnificationGestureHandler.this.zoomInTemporary(
    ...
    public String toString() {
      return "DetectingState{tapCount()="
          + tapCount()
          + ", mShortcutTriggered="
          + this.mShortcutTriggered
          + ", mDelayedEventQueue="
          + MotionEventInfo.toString(this.mDelayedEventQueue)
          + '}';
    }
    ...
    public void setShortcutTriggered(boolean z) {
      ...
      if (FullScreenMagnificationGestureHandler.DEBUG_DETECTING) {
        Slog.i(
            FullScreenMagnificationGestureHandler.this.mLogTag, "setShortcutTriggered(" + z + ")");
      }
    ...
    public boolean isTapOutOfDistanceSlop() {
      ...
      if (FullScreenMagnificationGestureHandler.this.mDetectTripleTap
          && (motionEvent = this.mPreLastDown) != null
          && (motionEvent2 = this.mLastDown) != null) {
        boolean z =
            GestureUtils.distance(motionEvent, motionEvent2) > ((double) this.mMultiTapMaxDistance);
        if (tapCount() > 0) {
          return z;
        }
        if (z
            && !GestureUtils.isTimedOut(
                this.mPreLastDown, this.mLastDown, this.mMultiTapMaxDelay)) {
          return true;
        }
      }
      return false;
  ...
  public final void zoomInTemporary(float f, float f2) {
    ...
    float constrain =
        MathUtils.constrain(
            this.mFullScreenMagnificationController.getPersistedScale(this.mDisplayId), 1.0f, 8.0f);
    if (this.mFullScreenMagnificationController.isActivated(this.mDisplayId)) {
  ...
  public final void zoomToScale(float f, float f2, float f3) {
    this.mFullScreenMagnificationController.setScaleAndCenter(
        this.mDisplayId, MathUtils.constrain(f, 1.0f, 8.0f), f2, f3, true, 0);
  }
  ...
  public final class MotionEventInfo {
    ...
    public static String toString(MotionEventInfo motionEventInfo) {
      ...
      return MotionEvent.actionToString(motionEventInfo.event.getAction()).replace("ACTION_", "")
          + " "
          + toString(motionEventInfo.mNext);
    }
  }
