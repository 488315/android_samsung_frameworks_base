...
public class WindowMagnificationManager
  ...
  protected final BroadcastReceiver mScreenStateReceiver = new BroadcastReceiver() { // from class:
        // com.android.server.accessibility.magnification.WindowMagnificationManager.1
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
          context.getDisplayId();
          int displayId =
              AccessibilityUtils.isFoldedLargeCoverScreen() ? 1 : context.getDisplayId();
  ...
  public WindowMagnificationManager(
      Context context,
      Object obj,
      Callback callback,
  ...
  public void setConnection(IWindowMagnificationConnection iWindowMagnificationConnection) {
    ...
    synchronized (this.mLock) {
      WindowMagnificationConnectionWrapper windowMagnificationConnectionWrapper =
      ...
      if (iWindowMagnificationConnection != null) {
        this.mConnectionWrapper =
            new WindowMagnificationConnectionWrapper(iWindowMagnificationConnection, this.mTrace);
      }
      try {
  ...
  public boolean requestConnection(boolean z) {
    ...
    Slog.d(
        "WindowMagnificationMgr",
        "requestConnection :" + z + " mConnectionState : " + this.mConnectionState);
    if (this.mTrace.isA11yTracingEnabledForTypes(128L)) {
      this.mTrace.logTrace(
          "WindowMagnificationMgr.requestWindowMagnificationConnection", 128L, "connect=" + z);
    }
    synchronized (this.mLock) {
      if (z) {
        try {
    ...
    synchronized (this.mLock) {
      for (int i2 = 0; i2 < this.mWindowMagnifiers.size(); i2++) {
        ...
        if (windowMagnifier != null
            && windowMagnifier.mEnabled
            && i == windowMagnifier.getIdOfLastServiceToControl()) {
    ...
    if (this.mMagnificationFollowTypingEnabled) {
      ...
      synchronized (this.mLock) {
        if (this.mIsImeVisibleArray.get(i, false)
            && !isPositionInSourceBounds(i, f, f2)
            && isTrackingTypingFocusEnabled(i)) {
          moveWindowMagnifierToPositionInternal(
              i, f, f2, MagnificationAnimationCallback.STUB_ANIMATION_CALLBACK);
        }
      }
    }
  }
  ...
  public boolean enableWindowMagnification(int i, float f, float f2, float f3) {
    return enableWindowMagnification(
        i, f, f2, f3, MagnificationAnimationCallback.STUB_ANIMATION_CALLBACK, 0);
  }

  public boolean enableWindowMagnification(
      int i,
      float f,
      float f2,
      float f3,
  ...
  public boolean enableWindowMagnification(int i, float f, float f2, float f3, int i2) {
    return enableWindowMagnification(
        i, f, f2, f3, MagnificationAnimationCallback.STUB_ANIMATION_CALLBACK, i2, 0);
  }
  ...
  public boolean enableWindowMagnification(
    ...
    synchronized (this.mLock) {
      ...
      enableWindowMagnificationInternal =
          windowMagnifier2.enableWindowMagnificationInternal(
              f, f2, f3, magnificationAnimationCallback, i2, i3);
  ...
  public boolean disableWindowMagnification(
    ...
    synchronized (this.mLock) {
      ...
      boolean disableWindowMagnificationInternal =
          windowMagnifier.disableWindowMagnificationInternal(magnificationAnimationCallback);
      if (z) {
      ...
      try {
        if (Settings.System.getIntForUser(
                this.mContext.getContentResolver(), "accessibility_am_magnification_mode", -2)
            == 1) {
  ...
  public boolean showMagnificationButton(int i, int i2) {
    ...
    synchronized (this.mLock) {
      WindowMagnificationConnectionWrapper windowMagnificationConnectionWrapper =
          this.mConnectionWrapper;
      z =
          windowMagnificationConnectionWrapper != null
              && windowMagnificationConnectionWrapper.showMagnificationButton(i, i2);
    }
    return z;
  }
  ...
  public boolean removeMagnificationButton(int i) {
    ...
    synchronized (this.mLock) {
      ...
      z =
          windowMagnificationConnectionWrapper != null
              && windowMagnificationConnectionWrapper.removeMagnificationButton(i);
    }
    return z;
  }
  ...
  public boolean removeMagnificationSettingsPanel(int i) {
    ...
    synchronized (this.mLock) {
      ...
      z =
          windowMagnificationConnectionWrapper != null
              && windowMagnificationConnectionWrapper.removeMagnificationSettingsPanel(i);
    }
    return z;
  }
  ...
  public class ConnectionCallback extends IWindowMagnificationConnectionCallback.Stub
    ...
    public void onWindowMagnifierBoundsChanged(int i, Rect rect) {
      if (WindowMagnificationManager.this.mTrace.isA11yTracingEnabledForTypes(256L)) {
        WindowMagnificationManager.this.mTrace.logTrace(
            "WindowMagnificationMgrConnectionCallback.onWindowMagnifierBoundsChanged",
            256L,
            "displayId=" + i + ";bounds=" + rect);
      }
      synchronized (WindowMagnificationManager.this.mLock) {
        WindowMagnifier windowMagnifier =
            (WindowMagnifier) WindowMagnificationManager.this.mWindowMagnifiers.get(i);
        if (windowMagnifier == null) {
    ...
    public void onChangeMagnificationMode(int i, int i2) {
      if (WindowMagnificationManager.this.mTrace.isA11yTracingEnabledForTypes(256L)) {
        WindowMagnificationManager.this.mTrace.logTrace(
            "WindowMagnificationMgrConnectionCallback.onChangeMagnificationMode",
            256L,
            "displayId=" + i + ";mode=" + i2);
      }
    ...
    public void onSourceBoundsChanged(int i, Rect rect) {
      if (WindowMagnificationManager.this.mTrace.isA11yTracingEnabledForTypes(256L)) {
        WindowMagnificationManager.this.mTrace.logTrace(
            "WindowMagnificationMgrConnectionCallback.onSourceBoundsChanged",
            256L,
    ...
    public void onPerformScaleAction(int i, float f) {
      if (WindowMagnificationManager.this.mTrace.isA11yTracingEnabledForTypes(256L)) {
        WindowMagnificationManager.this.mTrace.logTrace(
            "WindowMagnificationMgrConnectionCallback.onPerformScaleAction",
            256L,
            "displayId=" + i + ";scale=" + f);
      }
    ...
    public void onAccessibilityActionPerformed(int i) {
      if (WindowMagnificationManager.this.mTrace.isA11yTracingEnabledForTypes(256L)) {
        WindowMagnificationManager.this.mTrace.logTrace(
            "WindowMagnificationMgrConnectionCallback.onAccessibilityActionPerformed",
            256L,
            "displayId=" + i);
      }
    ...
    public void onMove(int i) {
      if (WindowMagnificationManager.this.mTrace.isA11yTracingEnabledForTypes(256L)) {
        WindowMagnificationManager.this.mTrace.logTrace(
            "WindowMagnificationMgrConnectionCallback.onMove", 256L, "displayId=" + i);
      }
    ...
    public void binderDied() {
      synchronized (WindowMagnificationManager.this.mLock) {
        Slog.w(
            "WindowMagnificationMgr", "binderDied DeathRecipient :" + this.mExpiredDeathRecipient);
  ...
  public class WindowMagnifier {
    public static final AtomicLongFieldUpdater SUM_TIME_UPDATER =
        AtomicLongFieldUpdater.newUpdater(WindowMagnifier.class, "mTrackingTypingFocusSumTime");
    ...
    public boolean enableWindowMagnificationInternal(
        float f,
        float f2,
        float f3,
        MagnificationAnimationCallback magnificationAnimationCallback,
      ...
      if (!windowMagnificationManager.enableWindowMagnificationInternal(
          i3, constrainScale, f2, f3, pointF.x, pointF.y, magnificationAnimationCallback)) {
        return false;
      }
    ...
    public boolean disableWindowMagnificationInternal(
        MagnificationAnimationCallback magnificationAnimationCallback) {
      if (!this.mEnabled
          || !this.mWindowMagnificationManager.disableWindowMagnificationInternal(
              this.mDisplayId, magnificationAnimationCallback)) {
        return false;
      }
      this.mEnabled = false;
    ...
    public void setScale(float f) {
      if (this.mEnabled) {
        float constrainScale = MagnificationScaleProvider.constrainScale(f);
        if (Float.compare(this.mScale, constrainScale) == 0
            || !this.mWindowMagnificationManager.setScaleInternal(this.mDisplayId, f)) {
          return;
        }
        this.mScale = constrainScale;
      }
    ...
    public void setTrackingTypingFocusEnabled(boolean z) {
      if (this.mWindowMagnificationManager.isWindowMagnifierEnabled(this.mDisplayId)
          && this.mWindowMagnificationManager.isImeVisible(this.mDisplayId)
          && z) {
    ...
    public void stopAndLogTrackingTypingFocusRecordIfNeeded() {
      ...
      this.mWindowMagnificationManager.logTrackingTypingFocus(
          this.mTrackingTypingFocusSumTime
              + (this.mTrackingTypingFocusStartTime != 0
                  ? SystemClock.uptimeMillis() - this.mTrackingTypingFocusStartTime
                  : 0L));
      this.mTrackingTypingFocusStartTime = 0L;
  ...
  public final boolean enableWindowMagnificationInternal(
    ...
    if (windowMagnificationConnectionWrapper == null) {
      Slog.w(
          "WindowMagnificationMgr",
          "enableWindowMagnificationInternal mConnectionWrapper is null. mConnectionState="
              + connectionStateToString(this.mConnectionState));
      return false;
    }
    return windowMagnificationConnectionWrapper.enableWindowMagnification(
        i, f, f2, f3, f4, f5, magnificationAnimationCallback);
  }

  public final boolean setScaleInternal(int i, float f) {
    WindowMagnificationConnectionWrapper windowMagnificationConnectionWrapper =
        this.mConnectionWrapper;
    return windowMagnificationConnectionWrapper != null
        && windowMagnificationConnectionWrapper.setScale(i, f);
  }
  ...
  public final boolean disableWindowMagnificationInternal(
    ...
    return windowMagnificationConnectionWrapper.disableWindowMagnification(
        i, magnificationAnimationCallback);
  }
  ...
  public final boolean moveWindowMagnifierInternal(int i, float f, float f2) {
    WindowMagnificationConnectionWrapper windowMagnificationConnectionWrapper =
        this.mConnectionWrapper;
    return windowMagnificationConnectionWrapper != null
        && windowMagnificationConnectionWrapper.moveWindowMagnifier(i, f, f2);
  }

  public final boolean moveWindowMagnifierToPositionInternal(
      int i, float f, float f2, MagnificationAnimationCallback magnificationAnimationCallback) {
    WindowMagnificationConnectionWrapper windowMagnificationConnectionWrapper =
        this.mConnectionWrapper;
    return windowMagnificationConnectionWrapper != null
        && windowMagnificationConnectionWrapper.moveWindowMagnifierToPosition(
            i, f, f2, magnificationAnimationCallback);
  }
}
