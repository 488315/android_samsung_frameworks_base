...
public class WindowMagnificationConnectionWrapper {
  ...
  public WindowMagnificationConnectionWrapper(
  ...
  public boolean enableWindowMagnification(
    ...
    if (this.mTrace.isA11yTracingEnabledForTypes(128L)) {
      this.mTrace.logTrace(
          "WindowMagnificationConnectionWrapper.enableWindowMagnification",
          128L,
          "displayId="
              + i
              + ";scale="
    ...
    try {
      this.mConnection.enableWindowMagnification(
          i,
          f,
          f2,
          f3,
          f4,
          f5,
          transformToRemoteCallback(magnificationAnimationCallback, this.mTrace));
      return true;
  ...
  public boolean setScale(int i, float f) {
    if (this.mTrace.isA11yTracingEnabledForTypes(128L)) {
      this.mTrace.logTrace(
          "WindowMagnificationConnectionWrapper.setScale", 128L, "displayId=" + i + ";scale=" + f);
    }
    try {
  ...
  public boolean disableWindowMagnification(
    ...
    if (this.mTrace.isA11yTracingEnabledForTypes(128L)) {
      this.mTrace.logTrace(
          "WindowMagnificationConnectionWrapper.disableWindowMagnification",
          128L,
          "displayId=" + i + ";callback=" + magnificationAnimationCallback);
    }
    try {
      this.mConnection.disableWindowMagnification(
          i, transformToRemoteCallback(magnificationAnimationCallback, this.mTrace));
      return true;
    } catch (RemoteException unused) {
      return false;
    }
  ...
  public boolean moveWindowMagnifier(int i, float f, float f2) {
    if (this.mTrace.isA11yTracingEnabledForTypes(128L)) {
      this.mTrace.logTrace(
          "WindowMagnificationConnectionWrapper.moveWindowMagnifier",
          128L,
  ...
  public boolean moveWindowMagnifierToPosition(
    ...
    try {
      this.mConnection.moveWindowMagnifierToPosition(
          i, f, f2, transformToRemoteCallback(magnificationAnimationCallback, this.mTrace));
      return true;
    } catch (RemoteException unused) {
      return false;
    }
  ...
  public boolean showMagnificationButton(int i, int i2) {
    if (this.mTrace.isA11yTracingEnabledForTypes(128L)) {
      this.mTrace.logTrace(
          "WindowMagnificationConnectionWrapper.showMagnificationButton",
          128L,
          "displayId=" + i + ";mode=" + i2);
    }
    try {
  ...
  public boolean removeMagnificationButton(int i) {
    if (this.mTrace.isA11yTracingEnabledForTypes(128L)) {
      this.mTrace.logTrace(
          "WindowMagnificationConnectionWrapper.removeMagnificationButton", 128L, "displayId=" + i);
    }
    try {
  ...
  public boolean removeMagnificationSettingsPanel(int i) {
    if (this.mTrace.isA11yTracingEnabledForTypes(128L)) {
      this.mTrace.logTrace(
          "WindowMagnificationConnectionWrapper.removeMagnificationSettingsPanel",
          128L,
          "displayId=" + i);
    }
    try {
  ...
  public boolean setConnectionCallback(
    ...
    if (this.mTrace.isA11yTracingEnabledForTypes(384L)) {
      this.mTrace.logTrace(
          "WindowMagnificationConnectionWrapper.setConnectionCallback",
          384L,
  ...
  public static IRemoteMagnificationAnimationCallback transformToRemoteCallback(
      MagnificationAnimationCallback magnificationAnimationCallback,
      AccessibilityTraceManager accessibilityTraceManager) {
