...
public class SamsungSlowKeys extends BaseEventStreamTransformation {
  ...
  public final Handler mHandler =
      new Handler() { // from class: com.android.server.accessibility.SamsungSlowKeys.1
        @Override // android.os.Handler
        public void handleMessage(Message message) {
          if (SamsungSlowKeys.this.mCurrentKeyEvent != null) {
            SamsungSlowKeys.this.debugLog(
                "onKeyEvent : " + SamsungSlowKeys.this.mCurrentKeyEvent.getKeyCode());
            if (SamsungSlowKeys.this.mNext != null) {
              SamsungSlowKeys.this.mCurrentKeyEvent.setTime(
                  SystemClock.uptimeMillis(), SystemClock.uptimeMillis());
              SamsungSlowKeys.this.mNext.onKeyEvent(
                  SamsungSlowKeys.this.mCurrentKeyEvent, SamsungSlowKeys.this.mPolicyFlags);
  ...
  public final class SlowKeysObserver extends ContentObserver {
    ...
    public void onChange(boolean z, Uri uri) {
      if (this.mSlowKeysSettingsUri.equals(uri)) {
        SamsungSlowKeys.this.mSlowKeysPeriodMilli =
            (long)
                (Settings.Secure.getFloatForUser(
                        this.mContentResolver, "slow_keys_period", 0.3f, this.mUserId)
                    * 1000.0f);
      }
    }
  }
