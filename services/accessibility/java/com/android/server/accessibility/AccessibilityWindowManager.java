...
public class AccessibilityWindowManager {
  ...
  public void setAccessibilityWindowAttributes(
    ...
    synchronized (this.mLock) {
      if (getWindowTokenForUserAndWindowIdLocked(
              this.mSecurityPolicy.resolveCallingUserIdEnforcingPermissionsLocked(i3), i2)
          == null) {
        return;
      }
    ...
    synchronized (this.mLock) {
      ...
      for (int i3 = 0; i3 < size; i3++) {
        ...
        if (displayWindowsObserver != null
            && displayWindowsObserver.findA11yWindowInfoByIdLocked(i) != null) {
  ...
  public final class DisplayWindowsObserver
    ...
    public void startTrackingWindowsLocked() {
      ...
      if (AccessibilityWindowManager.this.traceWMEnabled()) {
        AccessibilityWindowManager.this.logTraceWM(
            "setWindowsForAccessibilityCallback",
            "displayId=" + this.mDisplayId + ";callback=" + this);
      }
      AccessibilityWindowManager.this.mWindowManagerInternal.setWindowsForAccessibilityCallback(
          this.mDisplayId, this);
    }
    ...
    public void stopTrackingWindowsLocked() {
      if (this.mTrackingWindows) {
        if (AccessibilityWindowManager.this.traceWMEnabled()) {
          AccessibilityWindowManager.this.logTraceWM(
              "setWindowsForAccessibilityCallback",
              "displayId=" + this.mDisplayId + ";callback=null");
        }
        AccessibilityWindowManager.this.mWindowManagerInternal.setWindowsForAccessibilityCallback(
            this.mDisplayId, null);
    ...
    public AccessibilityWindowInfo getPictureInPictureWindowLocked() {
      ...
      for (int i = 0; i < size; i++) {
        AccessibilityWindowInfo accessibilityWindowInfo =
            (AccessibilityWindowInfo) this.mWindows.get(i);
    ...
    public void onWindowsForAccessibilityChanged(boolean z, int i, IBinder iBinder, List list) {
      synchronized (AccessibilityWindowManager.this.mLock) {
        ...
        if (shouldUpdateWindowsLocked(z, list)) {
          ...
          cacheWindows(list);
          updateWindowsLocked(
              AccessibilityWindowManager.this.mAccessibilityUserManager.getCurrentUserIdLocked(),
              list);
    ...
    public final void updateWindowsByWindowAttributesLocked(List list) {
      for (int size = list.size() - 1; size >= 0; size--) {
        ...
        updateWindowWithWindowAttributes(
            windowInfo,
            (AccessibilityWindowAttributes)
                AccessibilityWindowManager.this.mWindowAttributes.get(
                    accessibilityWindowManager.findWindowIdLocked(
    ...
    public final void updateWindowWithWindowAttributes(
        WindowInfo windowInfo, AccessibilityWindowAttributes accessibilityWindowAttributes) {
    ...
    public final boolean shouldUpdateWindowsLocked(boolean z, List list) {
      ...
      if (!this.mCachedWindowInfos.isEmpty() || !list.isEmpty()) {
        for (int i = 0; i < size; i++) {
          if (windowChangedNoLayer(
              (WindowInfo) this.mCachedWindowInfos.get(i), (WindowInfo) list.get(i))) {
            return true;
          }
        }
      }
    ...
    public final boolean windowChangedNoLayer(WindowInfo windowInfo, WindowInfo windowInfo2) {
      ...
      if (windowInfo == null
          || windowInfo2 == null
          || windowInfo.type != windowInfo2.type
          || windowInfo.focused != windowInfo2.focused) {
        return true;
      }
      IBinder iBinder = windowInfo.token;
      if (iBinder == null) {
      ...
      return ((list2 == null || (list = windowInfo2.childTokens) == null || list2.equals(list))
              && TextUtils.equals(windowInfo.title, windowInfo2.title)
              && windowInfo.accessibilityIdOfAnchor == windowInfo2.accessibilityIdOfAnchor
              && windowInfo.inPictureInPicture == windowInfo2.inPictureInPicture
              && windowInfo.hasFlagWatchOutsideTouch == windowInfo2.hasFlagWatchOutsideTouch
              && windowInfo.displayId == windowInfo2.displayId
              && windowInfo.taskId == windowInfo2.taskId
              && Arrays.equals(windowInfo.mTransformMatrix, windowInfo2.mTransformMatrix))
          ? false
          : true;
    }
    ...
    public final void updateWindowsLocked(int i, List list) {
      ...
      boolean z3 =
          this.mDisplayId == AccessibilityWindowManager.this.mAccessibilityFocusedDisplayId
              || (this.mIsProxy && this.mProxyDisplayAccessibilityFocusedWindow != -1);
      if (z2) {
        if (size > 0) {
          AccessibilityWindowManager accessibilityWindowManager = AccessibilityWindowManager.this;
          accessibilityWindowManager.mTopFocusedWindowId =
              accessibilityWindowManager.findWindowIdLocked(
                  i4, accessibilityWindowManager.mTopFocusedWindowToken);
        } else {
      ...
      if (size > 0) {
        ...
        if (z2) {
          if (AccessibilityWindowManager.this.mTouchInteractionInProgress && z6) {
            AccessibilityWindowManager accessibilityWindowManager2 =
                AccessibilityWindowManager.this;
            accessibilityWindowManager2.mActiveWindowId =
                accessibilityWindowManager2.mTopFocusedWindowId;
          }
          for (int i8 = 0; i8 < size2; i8++) {
            AccessibilityWindowInfo accessibilityWindowInfo2 =
                (AccessibilityWindowInfo) this.mWindows.get(i8);
            if (accessibilityWindowInfo2.getId()
                == AccessibilityWindowManager.this.mActiveWindowId) {
        ...
        if (z3) {
          for (int i9 = 0; i9 < size2; i9++) {
            AccessibilityWindowInfo accessibilityWindowInfo3 =
                (AccessibilityWindowInfo) this.mWindows.get(i9);
    ...
    public final void sendEventsForChangedWindowsLocked(List list, SparseArray sparseArray) {
        ...
        if (this.mA11yWindowInfoById.get(accessibilityWindowInfo.getId()) == null) {
          arrayList.add(
              AccessibilityEvent.obtainWindowsChangedEvent(
                  this.mDisplayId, accessibilityWindowInfo.getId(), 2));
        }
      }
      int size2 = this.mWindows.size();
      for (int i2 = 0; i2 < size2; i2++) {
        AccessibilityWindowInfo accessibilityWindowInfo2 =
            (AccessibilityWindowInfo) this.mWindows.get(i2);
        AccessibilityWindowInfo accessibilityWindowInfo3 =
            (AccessibilityWindowInfo) sparseArray.get(accessibilityWindowInfo2.getId());
        if (accessibilityWindowInfo3 == null) {
          arrayList.add(
              AccessibilityEvent.obtainWindowsChangedEvent(
                  this.mDisplayId, accessibilityWindowInfo2.getId(), 1));
        } else {
          int differenceFrom = accessibilityWindowInfo2.differenceFrom(accessibilityWindowInfo3);
          if (differenceFrom != 0) {
            arrayList.add(
                AccessibilityEvent.obtainWindowsChangedEvent(
                    this.mDisplayId, accessibilityWindowInfo2.getId(), differenceFrom));
          }
        }
      }
      int size3 = arrayList.size();
      for (int i3 = 0; i3 < size3; i3++) {
        AccessibilityWindowManager.this.mAccessibilityEventSender
            .sendAccessibilityEventForCurrentUserLocked((AccessibilityEvent) arrayList.get(i3));
      }
    }

    public final AccessibilityWindowInfo populateReportedWindowLocked(
        int i, WindowInfo windowInfo, SparseArray sparseArray) {
      int findWindowIdLocked =
          AccessibilityWindowManager.this.findWindowIdLocked(i, windowInfo.token);
      if (findWindowIdLocked < 0) {
        return null;
      }
      if (AccessibilityWindowManager.this.mHostEmbeddedMap.size() > 0
          && isEmbeddedHierarchyWindowsLocked(findWindowIdLocked)) {
        return null;
      }
      ...
      int findWindowIdLocked2 =
          AccessibilityWindowManager.this.findWindowIdLocked(i, windowInfo.parentToken);
      ...
      if (list != null) {
        int size = list.size();
        for (int i2 = 0; i2 < size; i2++) {
          int findWindowIdLocked3 =
              AccessibilityWindowManager.this.findWindowIdLocked(
                  i, (IBinder) windowInfo.childTokens.get(i2));
      ...
      AccessibilityWindowInfo accessibilityWindowInfo =
          (AccessibilityWindowInfo) sparseArray.get(findWindowIdLocked);
      if (accessibilityWindowInfo == null) {
    ...
    public final boolean isEmbeddedHierarchyWindowsLocked(int i) {
      ...
      for (int i2 = 0; i2 < AccessibilityWindowManager.this.mHostEmbeddedMap.size(); i2++) {
        if (((IBinder) AccessibilityWindowManager.this.mHostEmbeddedMap.keyAt(i2))
            .equals(iBinder)) {
          return true;
        }
      }
    ...
    public void dumpLocked(
        ...
        if (targetWindowId == -1) {
          ...
          while (it.hasNext()) {
            AccessibilityWindowInfo obtain =
                AccessibilityWindowInfo.obtain((AccessibilityWindowInfo) it.next());
            obtain.setConnectionId(connectionId);
            SamsungWindowDumpUtils.printNodeTreeOfWindow(
                printWriter, obtain, isPrintNodeSimple, isPrintNodeVisibleOnly);
          }
          return;
        }
        for (AccessibilityWindowInfo accessibilityWindowInfo : this.mWindows) {
          if (accessibilityWindowInfo.getId() == targetWindowId) {
            AccessibilityWindowInfo obtain2 =
                AccessibilityWindowInfo.obtain(accessibilityWindowInfo);
            obtain2.setConnectionId(connectionId);
            SamsungWindowDumpUtils.printNodeTreeOfWindow(
                printWriter, obtain2, isPrintNodeSimple, isPrintNodeVisibleOnly);
            return;
          }
        }
        return;
      ...
      printWriter.println(
          "Top focused display Id = " + AccessibilityWindowManager.this.mTopFocusedDisplayId);
      printWriter.println(
          "     Active Window Id = " + AccessibilityWindowManager.this.mActiveWindowId);
      printWriter.println(
          "     Top Focused Window Id = " + AccessibilityWindowManager.this.mTopFocusedWindowId);
      printWriter.println(
          "     Accessibility Focused Window Id = "
              + AccessibilityWindowManager.this.mAccessibilityFocusedWindowId
              + " ]");
      if (this.mIsProxy) {
        printWriter.println(
            "Proxy accessibility focused window = " + this.mProxyDisplayAccessibilityFocusedWindow);
      }
      printWriter.println();
      List list = this.mWindows;
      if (list != null) {
        ...
        for (int i = 0; i < size; i++) {
          ...
          WindowInfo findWindowInfoByIdLocked =
              findWindowInfoByIdLocked(accessibilityWindowInfo2.getId());
  ...
  public final class RemoteAccessibilityConnection implements IBinder.DeathRecipient {
    ...
    public void binderDied() {
      unlinkToDeath();
      synchronized (AccessibilityWindowManager.this.mLock) {
        AccessibilityWindowManager.this.removeAccessibilityInteractionConnectionLocked(
            this.mWindowId, this.mUserId);
      }
    }
  }
  ...
  public void moveNonProxyTopFocusedDisplayToTopIfNeeded() {
    int i;
    if (!this.mHasProxy
        || (i = this.mLastNonProxyTopFocusedDisplayId) == this.mTopFocusedDisplayId) {
      return;
    }
  ...
  public int addAccessibilityInteractionConnection(
    ...
    synchronized (this.mLock) {
      ...
      int uid =
          UserHandle.getUid(
              resolveCallingUserIdEnforcingPermissionsLocked, UserHandle.getCallingAppId());
      String resolveValidReportedPackageLocked =
      ...
      if (this.mSecurityPolicy.isCallerInteractingAcrossUsers(i)) {
        RemoteAccessibilityConnection remoteAccessibilityConnection =
            new RemoteAccessibilityConnection(
                i2,
        ...
        RemoteAccessibilityConnection remoteAccessibilityConnection2 =
            new RemoteAccessibilityConnection(
                i2,
                iAccessibilityInteractionConnection,
                resolveValidReportedPackageLocked,
        ...
        getInteractionConnectionsForUserLocked(resolveCallingUserIdEnforcingPermissionsLocked)
            .put(i2, remoteAccessibilityConnection2);
        getWindowTokensForUserLocked(resolveCallingUserIdEnforcingPermissionsLocked)
            .put(i2, asBinder);
      }
  ...
  public void removeAccessibilityInteractionConnection(IWindow iWindow) {
    synchronized (this.mLock) {
      this.mSecurityPolicy.resolveCallingUserIdEnforcingPermissionsLocked(
          UserHandle.getCallingUserId());
      IBinder asBinder = iWindow.asBinder();
      int removeAccessibilityInteractionConnectionInternalLocked =
          removeAccessibilityInteractionConnectionInternalLocked(
              asBinder, this.mGlobalWindowTokens, this.mGlobalInteractionConnections);
      if (removeAccessibilityInteractionConnectionInternalLocked >= 0) {
        onAccessibilityInteractionConnectionRemovedLocked(
            removeAccessibilityInteractionConnectionInternalLocked, asBinder);
        return;
      }
      int size = this.mWindowTokens.size();
      for (int i = 0; i < size; i++) {
        int keyAt = this.mWindowTokens.keyAt(i);
        int removeAccessibilityInteractionConnectionInternalLocked2 =
            removeAccessibilityInteractionConnectionInternalLocked(
                asBinder,
                getWindowTokensForUserLocked(keyAt),
                getInteractionConnectionsForUserLocked(keyAt));
        if (removeAccessibilityInteractionConnectionInternalLocked2 >= 0) {
          onAccessibilityInteractionConnectionRemovedLocked(
              removeAccessibilityInteractionConnectionInternalLocked2, asBinder);
          return;
        }
      }
    }
  ...
  public RemoteAccessibilityConnection getConnectionLocked(int i, int i2) {
    ...
    if (remoteAccessibilityConnection == null
        || remoteAccessibilityConnection.getRemote() == null) {
      return null;
    }
    return remoteAccessibilityConnection;
  }

  public final int removeAccessibilityInteractionConnectionInternalLocked(
    ...
    if (iBinder != null) {
      if (traceWMEnabled()) {
        logTraceWM(
            ...
            "token=" + iBinder + ";windowId=AccessibilityWindowInfo.UNDEFINED_WINDOW_ID");
      }
  ...
  public IBinder getWindowTokenForUserAndWindowIdLocked(int i, int i2) {
    ...
    return (iBinder == null && isValidUserForWindowTokensLocked(i))
  ...
  public int findWindowIdLocked(int i, IBinder iBinder) {
    ...
    if (!isValidUserForWindowTokensLocked(i)
  ...
  public int resolveParentWindowIdLocked(int i) {
    ...
    return (tokenLocked == null
            || (windowIdLocked = getWindowIdLocked(resolveTopParentTokenLocked(tokenLocked))) == -1)
        ? i
        : windowIdLocked;
  }
  ...
  public boolean computePartialInteractiveRegionForWindowLocked(int i, Region region) {
    ...
    if (displayWindowObserverByWindowIdLocked != null) {
      return displayWindowObserverByWindowIdLocked.computePartialInteractiveRegionForWindowLocked(
          resolveParentWindowIdLocked, resolveParentWindowIdLocked != i, region);
    }
    return false;
  }

  public void updateActiveAndAccessibilityFocusedWindowLocked(
      int i, int i2, long j, int i3, int i4) {
    if (i3 == 32) {
      synchronized (this.mLock) {
        if (!isTrackingWindowsLocked()) {
  ...
  public final void setActiveWindowLocked(int i) {
    ...
    if (this.mActiveWindowId != i) {
      ...
      if (i2 != -1
          && (displayWindowObserverByWindowIdLocked = getDisplayWindowObserverByWindowIdLocked(i2))
              != null) {
        arrayList.add(
            AccessibilityEvent.obtainWindowsChangedEvent(
                displayWindowObserverByWindowIdLocked.mDisplayId, this.mActiveWindowId, 32));
      }
      ...
      while (it.hasNext()) {
        this.mAccessibilityEventSender.sendAccessibilityEventForCurrentUserLocked(
            (AccessibilityEvent) it.next());
      }
    }
  }
    ...
    if (this.mAccessibilityFocusedWindowId != i) {
      ...
      for (int i4 = 0; i4 < size; i4++) {
        ...
        if (displayWindowsObserver != null
          ...
          arrayList.add(
              AccessibilityEvent.obtainWindowsChangedEvent(
                  displayWindowsObserver.mDisplayId, i, 128));
        }
      }
      Iterator it = arrayList.iterator();
      while (it.hasNext()) {
  ...
  public AccessibilityWindowInfo findA11yWindowInfoByIdLocked(int i) {
    ...
    DisplayWindowsObserver displayWindowObserverByWindowIdLocked =
        getDisplayWindowObserverByWindowIdLocked(resolveParentWindowIdLocked);
    if (displayWindowObserverByWindowIdLocked != null) {
      return displayWindowObserverByWindowIdLocked.findA11yWindowInfoByIdLocked(
  ...
  public WindowInfo findWindowInfoByIdLocked(int i) {
    ...
    DisplayWindowsObserver displayWindowObserverByWindowIdLocked =
        getDisplayWindowObserverByWindowIdLocked(resolveParentWindowIdLocked);
    if (displayWindowObserverByWindowIdLocked != null) {
      return displayWindowObserverByWindowIdLocked.findWindowInfoByIdLocked(
          resolveParentWindowIdLocked);
    }
    return null;
  }
  ...
  public int getFocusedWindowId(int i, int i2) {
    ...
    DisplayWindowsObserver displayWindowsObserver =
        (DisplayWindowsObserver) this.mDisplayWindowsObservers.get(i2);
    if (displayWindowsObserver != null && displayWindowsObserver.mIsProxy) {
  ...
  public AccessibilityWindowInfo getPictureInPictureWindowLocked() {
    ...
    for (int i = 0; i < size; i++) {
      DisplayWindowsObserver displayWindowsObserver =
          (DisplayWindowsObserver) this.mDisplayWindowsObservers.valueAt(i);
      if (displayWindowsObserver != null
          && (accessibilityWindowInfo = displayWindowsObserver.getPictureInPictureWindowLocked())
              != null) {
        break;
      }
    }
  ...
  public void setPictureInPictureActionReplacingConnection(
    ...
    synchronized (this.mLock) {
      RemoteAccessibilityConnection remoteAccessibilityConnection =
          this.mPictureInPictureActionReplacingConnection;
      if (remoteAccessibilityConnection != null) {
      ...
      if (iAccessibilityInteractionConnection != null) {
        RemoteAccessibilityConnection remoteAccessibilityConnection2 =
            new RemoteAccessibilityConnection(
                -3, iAccessibilityInteractionConnection, "foo.bar.baz", 1000, -1);
    ...
    synchronized (this.mLock) {
      ...
      if (displayWindowObserverByWindowIdLocked != null) {
        List watchOutsideTouchWindowIdLocked =
            displayWindowObserverByWindowIdLocked.getWatchOutsideTouchWindowIdLocked(i2);
        for (int i4 = 0; i4 < watchOutsideTouchWindowIdLocked.size(); i4++) {
          arrayList.add(
              getConnectionLocked(
                  i, ((Integer) watchOutsideTouchWindowIdLocked.get(i4)).intValue()));
        }
      }
    }
    ...
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new TriConsumer() { // from class:
              // com.android.server.accessibility.AccessibilityWindowManager$$ExternalSyntheticLambda0
              public final void accept(Object obj, Object obj2, Object obj3) {
                ((AccessibilityWindowManager) obj)
                    .clearAccessibilityFocusMainThread(
                        ((Integer) obj2).intValue(), ((Integer) obj3).intValue());
              }
            },
            this,
            Integer.valueOf(this.mAccessibilityUserManager.getCurrentUserIdLocked()),
            Integer.valueOf(i)));
  }
  ...
  public final DisplayWindowsObserver getDisplayWindowObserverByWindowIdLocked(int i) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      DisplayWindowsObserver displayWindowsObserver =
          (DisplayWindowsObserver) this.mDisplayWindowsObservers.valueAt(i2);
      if (displayWindowsObserver != null
          && displayWindowsObserver.findWindowInfoByIdLocked(i) != null) {
  ...
  public final boolean clearProxyFocusLocked(int i, int i2) {
    ...
    for (int i3 = 0; i3 < this.mDisplayWindowsObservers.size(); i3++) {
      DisplayWindowsObserver displayWindowsObserver =
          (DisplayWindowsObserver) this.mDisplayWindowsObservers.get(i3);
      if (displayWindowsObserver != null
          && displayWindowsObserver.mWindows != null
    ...
    for (int i2 = 0; i2 < this.mDisplayWindowsObservers.size(); i2++) {
      ...
      if (displayWindowsObserver != null
        ...
        if (i3 != -1) {
          ...
          this.mAccessibilityEventSender.sendAccessibilityEventForCurrentUserLocked(
              AccessibilityEvent.obtainWindowsChangedEvent(
                  displayWindowsObserver.mDisplayId, i3, 128));
        }
        displayWindowsObserver.mProxyDisplayAccessibilityFocusedWindow = i;
        this.mAccessibilityEventSender.sendAccessibilityEventForCurrentUserLocked(
            AccessibilityEvent.obtainWindowsChangedEvent(
                displayWindowsObserver.mDisplayId,
