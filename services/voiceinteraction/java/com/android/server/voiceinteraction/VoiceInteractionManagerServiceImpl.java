...
public class VoiceInteractionManagerServiceImpl
  ...
  public VoiceInteractionManagerServiceImpl(
      Context context,
      Handler handler,
          ...
          public void onReceive(Context context2, Intent intent) {
            ...
            if ("android.intent.action.CLOSE_SYSTEM_DIALOGS".equals(intent.getAction())) {
              ...
              if ("voiceinteraction".equals(stringExtra)
                  || TextUtils.equals("dream", stringExtra)
              ...
              synchronized (VoiceInteractionManagerServiceImpl.this.mServiceStub) {
                VoiceInteractionSessionConnection voiceInteractionSessionConnection =
                    VoiceInteractionManagerServiceImpl.this.mActiveSession;
                if (voiceInteractionSessionConnection != null
                    && (iVoiceInteractionSession = voiceInteractionSessionConnection.mSession)
                        != null) {
                  try {
    ...
    this.mConnection =
        new ServiceConnection() { // from class:
          ...
          public void onServiceConnected(ComponentName componentName2, IBinder iBinder) {
            synchronized (VoiceInteractionManagerServiceImpl.this.mServiceStub) {
              VoiceInteractionManagerServiceImpl.this.mService =
                  IVoiceInteractionService.Stub.asInterface(iBinder);
              try {
          ...
          public void onBindingDied(ComponentName componentName2) {
            ...
            try {
              VoiceInteractionManagerServiceImpl voiceInteractionManagerServiceImpl =
                  VoiceInteractionManagerServiceImpl.this;
              parceledListSlice =
                  voiceInteractionManagerServiceImpl.mAm.getHistoricalProcessExitReasons(
                      packageName, 0, 1, voiceInteractionManagerServiceImpl.mUser);
            } catch (RemoteException unused) {
            ...
            if (applicationExitInfo.getReason() == 10 && applicationExitInfo.getSubReason() == 23) {
              VoiceInteractionManagerServiceImpl voiceInteractionManagerServiceImpl2 =
                  VoiceInteractionManagerServiceImpl.this;
              voiceInteractionManagerServiceImpl2.mServiceStub.handleUserStop(
                  packageName, voiceInteractionManagerServiceImpl2.mUser);
            }
          }
        };
    ...
    try {
      VoiceInteractionServiceInfo voiceInteractionServiceInfo =
          new VoiceInteractionServiceInfo(context.getPackageManager(), componentName, i);
      this.mInfo = voiceInteractionServiceInfo;
      if (voiceInteractionServiceInfo.getParseError() != null) {
        Slog.w(
            "VoiceInteractionServiceManager",
            "Bad voice interaction service: " + voiceInteractionServiceInfo.getParseError());
      ...
      this.mValid = true;
      this.mSessionComponentName =
          new ComponentName(
              componentName.getPackageName(), voiceInteractionServiceInfo.getSessionService());
      String hotwordDetectionService = voiceInteractionServiceInfo.getHotwordDetectionService();
      this.mHotwordDetectionComponentName =
          hotwordDetectionService != null
              ? new ComponentName(componentName.getPackageName(), hotwordDetectionService)
              : null;
      String visualQueryDetectionService =
          voiceInteractionServiceInfo.getVisualQueryDetectionService();
      this.mVisualQueryDetectionComponentName =
          visualQueryDetectionService != null
              ? new ComponentName(componentName.getPackageName(), visualQueryDetectionService)
              : null;
      ...
      Slog.w(
          "VoiceInteractionServiceManager",
          "Voice interaction service not found: " + componentName,
          e);
      this.mInfo = null;
      this.mSessionComponentName = null;
      this.mHotwordDetectionComponentName = null;
  ...
  public void grantImplicitAccessLocked(int i, Intent intent) {
    ...
    this.mPackageManagerInternal.grantImplicitAccess(
        ...
        intent,
        appId,
        this.mInfo.getServiceInfo().applicationInfo.uid,
        true);
  }
  ...
  */
  public boolean showSessionLocked(
    ...
    try {
      ...
      if (iVoiceInteractionService != null) {
        try {
          ...
          Slog.w(
              "VoiceInteractionServiceManager",
              "RemoteException while calling prepareToShowSession",
              e);
          ...
          if (iBinder == null) {}
          return this.mActiveSession.showLocked(
              bundle2,
              i,
              str,
              this.mDisabledShowContext,
    ...
    if (!this.mActiveSession.mBound) {
      try {
        ...
        Slog.w(
            "VoiceInteractionServiceManager",
            "RemoteException while calling showSessionFailed",
            e3);
      }
    }
    ...
    if (iBinder == null) {
      ...
      while (true) {
        ...
        ActivityAssistInfo activityAssistInfo = (ActivityAssistInfo) topVisibleActivities2.get(i2);
    ...
    return this.mActiveSession.showLocked(
        bundle2, i, str, this.mDisabledShowContext, iVoiceInteractionSessionShowCallback, list);
  }
  ...
  public void getActiveServiceSupportedActions(
    ...
    if (iVoiceInteractionService == null) {
      Slog.w(
          "VoiceInteractionServiceManager",
          "Not bound to voice interaction service " + this.mComponent);
      try {
    ...
    try {
      ...
      Slog.w(
          "VoiceInteractionServiceManager",
          "RemoteException while calling getActiveServiceSupportedActions",
          e);
    }
  }
  ...
  public boolean deliverNewSessionLocked(
    ...
    voiceInteractionSessionConnection.deliverNewSessionLocked(
        iVoiceInteractionSession, iVoiceInteractor);
    return true;
  }

  public int startVoiceActivityLocked(
      String str, int i, int i2, IBinder iBinder, Intent intent, String str2) {
    try {
      VoiceInteractionSessionConnection voiceInteractionSessionConnection = this.mActiveSession;
      if (voiceInteractionSessionConnection != null
          && iBinder == voiceInteractionSessionConnection.mToken) {
        if (!voiceInteractionSessionConnection.mShown) {
          Slog.w(
              "VoiceInteractionServiceManager", "startVoiceActivity not allowed on hidden session");
          return -100;
        }
        ...
        return iActivityTaskManager.startVoiceActivity(
            packageName,
            str,
            i,
            i2,
            intent2,
            str2,
            voiceInteractionSessionConnection2.mSession,
            voiceInteractionSessionConnection2.mInteractor,
            0,
            (ProfilerInfo) null,
            (Bundle) null,
            this.mUser);
  ...
  public int startAssistantActivityLocked(
      String str, int i, int i2, IBinder iBinder, Intent intent, String str2, Bundle bundle) {
    try {
      VoiceInteractionSessionConnection voiceInteractionSessionConnection = this.mActiveSession;
      if (voiceInteractionSessionConnection != null
          && iBinder == voiceInteractionSessionConnection.mToken) {
        if (!voiceInteractionSessionConnection.mShown) {
          Slog.w(
              "VoiceInteractionServiceManager",
              "startAssistantActivity not allowed on hidden session");
          return -90;
        }
        Intent intent2 = new Intent(intent);
        intent2.addFlags(268435456);
        bundle.putInt("android.activity.activityType", 4);
        return this.mAtm.startAssistantActivity(
            this.mComponent.getPackageName(), str, i, i2, intent2, str2, bundle, this.mUser);
      }
      Slog.w(
          "VoiceInteractionServiceManager", "startAssistantActivity does not match active session");
      return -89;
    } catch (RemoteException e) {
      throw new IllegalStateException("Unexpected remote error", e);
    }
  ...
  public void requestDirectActionsLocked(
    ...
    if (voiceInteractionSessionConnection == null
      ...
      Slog.w(
          "VoiceInteractionServiceManager",
          "requestDirectActionsLocked does not match active session");
      remoteCallback2.sendResult((Bundle) null);
      return;
    }
    ActivityTaskManagerInternal.ActivityTokens attachedNonFinishingActivityForTask =
        ((ActivityTaskManagerInternal) LocalServices.getService(ActivityTaskManagerInternal.class))
            .getAttachedNonFinishingActivityForTask(i, null);
    if (attachedNonFinishingActivityForTask == null
        || attachedNonFinishingActivityForTask.getAssistToken() != iBinder2) {
      Slog.w("VoiceInteractionServiceManager", "Unknown activity to query for direct actions");
      this.mDirectActionsHandler.sendMessageDelayed(
          PooledLambda.obtainMessage(
              new HexConsumer() { // from class:
                // com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl$$ExternalSyntheticLambda0
                public final void accept(
                    Object obj, Object obj2, Object obj3, Object obj4, Object obj5, Object obj6) {
                  ((VoiceInteractionManagerServiceImpl) obj)
                      .retryRequestDirectActions(
                          (IBinder) obj2,
    ...
    try {
      attachedNonFinishingActivityForTask
          .getApplicationThread()
          .requestDirectActions(
              attachedNonFinishingActivityForTask.getActivityToken(),
              this.mActiveSession.mInteractor,
              remoteCallback,
              remoteCallback2);
    } catch (RemoteException e) {
  ...
  public final void retryRequestDirectActions(
      IBinder iBinder,
      int i,
      IBinder iBinder2,
      RemoteCallback remoteCallback,
    ...
    synchronized (this.mServiceStub) {
      ...
      if (voiceInteractionSessionConnection != null
        ...
        if (attachedNonFinishingActivityForTask == null
          ...
          Slog.w(
              "VoiceInteractionServiceManager",
              "Unknown activity to query for direct actions during retrying");
          remoteCallback2.sendResult((Bundle) null);
        } else {
          try {
            attachedNonFinishingActivityForTask
      ...
      Slog.w(
          "VoiceInteractionServiceManager",
          "retryRequestDirectActions does not match active session");
      remoteCallback2.sendResult((Bundle) null);
    }
  }

  public void performDirectActionLocked(
      IBinder iBinder,
      String str,
      Bundle bundle,
      int i,
    ...
    if (voiceInteractionSessionConnection == null
      ...
      Slog.w(
          "VoiceInteractionServiceManager",
          "performDirectActionLocked does not match active session");
      remoteCallback2.sendResult((Bundle) null);
      return;
    }
    ActivityTaskManagerInternal.ActivityTokens attachedNonFinishingActivityForTask =
  ...
  public void finishLocked(IBinder iBinder, boolean z) {
    VoiceInteractionSessionConnection voiceInteractionSessionConnection = this.mActiveSession;
    if (voiceInteractionSessionConnection == null
        || (!z && iBinder != voiceInteractionSessionConnection.mToken)) {
  ...
  public void startListeningVisibleActivityChangedLocked(IBinder iBinder) {
    ...
    if (voiceInteractionSessionConnection == null
      ...
      Slog.w(
          "VoiceInteractionServiceManager",
          "startListeningVisibleActivityChangedLocked does not match active session");
    } else {
  ...
  public final void verifyDetectorForHotwordDetectionLocked(
    ...
    if (this.mContext
            ...
            .checkPermission(
                "android.permission.BIND_HOTWORD_DETECTION_SERVICE",
                this.mInfo.getServiceInfo().packageName)
        == 0) {
      Slog.w(
          "VoiceInteractionServiceManager",
  ...
  public final void verifyDetectorForVisualQueryDetectionLocked(SharedMemory sharedMemory) {
    ...
    if (!isIsolatedProcessLocked(serviceInfoLocked)) {
      Slog.w(
          "VoiceInteractionServiceManager",
          "Visual query detection service not in isolated process");
  ...
  public void initAndVerifyDetectorLocked(
    ...
    if (!verifyProcessSharingLocked()) {
      Slog.w(
          "VoiceInteractionServiceManager",
          "Sandboxed detection service not in shared isolated process");
      throw new IllegalStateException(
          "VisualQueryDetectionService or HotworDetectionService not in a shared isolated process."
              + " Please make sure to set android:allowSharedIsolatedProcess and"
              + " android:isolatedProcess to be true and android:externalService to be false in the"
              + " manifest file");
    }
    if (this.mHotwordDetectionConnection == null) {
      this.mHotwordDetectionConnection =
          new HotwordDetectionConnection(
              ...
              false,
              i,
              new DetectorRemoteExceptionListener() { // from class:
                // com.android.server.voiceinteraction.VoiceInteractionManagerServiceImpl$$ExternalSyntheticLambda1
                ...
                public final void onDetectorRemoteException(IBinder iBinder2, int i2) {
                  VoiceInteractionManagerServiceImpl.this.lambda$initAndVerifyDetectorLocked$0(
                      iBinder2, i2);
                }
              });
    } else if (i != 3) {
    ...
    this.mHotwordDetectionConnection.createDetectorLocked(
        persistableBundle, sharedMemory, iBinder, iHotwordRecognitionStatusCallback, i);
  }
  ...
  public /* synthetic */ void lambda$initAndVerifyDetectorLocked$0(IBinder iBinder, int i) {
    try {
      ...
      Slog.w(
          "VoiceInteractionServiceManager",
          "Fail to notify client detector remote exception occurred.");
    }
  }
  ...
  public void destroyDetectorLocked(IBinder iBinder) {
    ...
    if (this.mHotwordDetectionConnection == null) {
      Slog.w(
          "VoiceInteractionServiceManager",
          "destroy detector callback, but no hotword detection connection");
    } else {
      this.mHotwordDetectionConnection.destroyDetectorLocked(iBinder);
    }
  }

  public final void logDetectorCreateEventIfNeeded(
      IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback,
      int i,
      boolean z,
      int i2) {
  ...
  public void setVisualQueryDetectionAttentionListenerLocked(
    ...
    this.mHotwordDetectionConnection.setVisualQueryDetectionAttentionListenerLocked(
  ...
  public void startPerceivingLocked(
    ...
    this.mHotwordDetectionConnection.startPerceivingLocked(
  ...
  public void stopPerceivingLocked() {
    if (this.mHotwordDetectionConnection == null) {
      Slog.w(
          "VoiceInteractionServiceManager",
          "stopPerceivingLocked() called but connection isn't established");
    } else {
  ...
  public void startListeningFromMicLocked(
    ...
    this.mHotwordDetectionConnection.startListeningFromMicLocked(
  ...
  public void startListeningFromExternalSourceLocked(
    ...
    this.mHotwordDetectionConnection.startListeningFromExternalSourceLocked(
  ...
  public void stopListeningFromMicLocked() {
    if (this.mHotwordDetectionConnection == null) {
      Slog.w(
          "VoiceInteractionServiceManager",
          "stopListeningFromMicLocked() called but connection isn't established");
    } else {
  ...
  public void triggerHardwareRecognitionEventForTestLocked(
    ...
    if (this.mHotwordDetectionConnection == null) {
      Slog.w(
          "VoiceInteractionServiceManager",
          "triggerHardwareRecognitionEventForTestLocked() called but connection isn't established");
    } else {
      this.mHotwordDetectionConnection.triggerHardwareRecognitionEventForTestLocked(
  ...
  public IRecognitionStatusCallback createSoundTriggerCallbackLocked(
    ...
    return new HotwordDetectionConnection.SoundTriggerCallback(
        context, iHotwordRecognitionStatusCallback, this.mHotwordDetectionConnection, identity);
  }
  ...
  public boolean verifyProcessSharingLocked() {
    ServiceInfo serviceInfoLocked =
        getServiceInfoLocked(this.mHotwordDetectionComponentName, this.mUser);
    ServiceInfo serviceInfoLocked2 =
        getServiceInfoLocked(this.mVisualQueryDetectionComponentName, this.mUser);
    if (serviceInfoLocked == null || serviceInfoLocked2 == null) {
      return true;
    }
    return ((serviceInfoLocked.flags & 16) == 0 || (serviceInfoLocked2.flags & 16) == 0)
        ? false
        : true;
  }
  ...
  public void setDebugHotwordLoggingLocked(boolean z) {
    if (this.mHotwordDetectionConnection == null) {
      Slog.w(
          "VoiceInteractionServiceManager",
          "Failed to set temporary debug logging: no hotword detection active");
    } else {
  ...
  public void startLocked() {
    ...
    boolean bindServiceAsUser =
        this.mContext.bindServiceAsUser(
            intent, this.mConnection, 68161537, new UserHandle(this.mUser));
    ...
    Slog.w(
        "VoiceInteractionServiceManager",
        "Failed binding to voice interaction service " + this.mComponent);
  }
  ...
  public void launchVoiceAssistFromKeyguard() {
    ...
    try {
      ...
      Slog.w(
          "VoiceInteractionServiceManager",
          "RemoteException while calling launchVoiceAssistFromKeyguard",
          e);
    }
  }
  ...
  public void notifySoundModelsChangedLocked() {
    ...
    try {
      ...
      Slog.w(
          "VoiceInteractionServiceManager", "RemoteException while calling soundModelsChanged", e);
    }
  }

  @Override // com.android.server.voiceinteraction.VoiceInteractionSessionConnection.Callback
  public void sessionConnectionGone(
      VoiceInteractionSessionConnection voiceInteractionSessionConnection) {
    synchronized (this.mServiceStub) {
