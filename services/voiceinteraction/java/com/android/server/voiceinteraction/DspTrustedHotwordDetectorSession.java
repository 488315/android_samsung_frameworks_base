...
public final class DspTrustedHotwordDetectorSession extends DetectorSession {
  ...
  public void detectFromDspSourceLocked(
      final SoundTrigger.KeyphraseRecognitionEvent keyphraseRecognitionEvent,
      final IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback) {
    final AtomicBoolean atomicBoolean = new AtomicBoolean(false);
    final IDspHotwordDetectionCallback.Stub stub =
        new IDspHotwordDetectionCallback.Stub() { // from class:
          // com.android.server.voiceinteraction.DspTrustedHotwordDetectorSession.1
          public void onDetected(HotwordDetectedResult hotwordDetectedResult) {
            synchronized (DspTrustedHotwordDetectorSession.this.mLock) {
              if (DspTrustedHotwordDetectorSession.this.mCancellationKeyPhraseDetectionFuture
                  != null) {
                DspTrustedHotwordDetectorSession.this.mCancellationKeyPhraseDetectionFuture.cancel(
                    true);
              }
              ...
              HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                  1, 5, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
              if (!DspTrustedHotwordDetectorSession.this.mValidatingDspTrigger) {
                Slog.i(
                    "DspTrustedHotwordDetectorSession",
                    "Ignoring #onDetected due to a process restart or previous #onRejected result ="
                        + " "
                        + DspTrustedHotwordDetectorSession.this.mLastHotwordRejectedResult);
                HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                    1, 7, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                return;
              }
              ...
              try {
                ...
                DspTrustedHotwordDetectorSession.this.enforceExtraKeyphraseIdNotLeaked(
                    hotwordDetectedResult, keyphraseRecognitionEvent);
                DspTrustedHotwordDetectorSession.this.saveProximityValueToBundle(
                    hotwordDetectedResult);
                try {
                  HotwordDetectedResult startCopyingAudioStreams =
                      DspTrustedHotwordDetectorSession.this.mHotwordAudioStreamCopier
                          .startCopyingAudioStreams(hotwordDetectedResult);
                  try {
                    iHotwordRecognitionStatusCallback.onKeyphraseDetected(
                        keyphraseRecognitionEvent, startCopyingAudioStreams);
                    Slog.i(
                        "DspTrustedHotwordDetectorSession",
                        "Egressed "
                    ...
                    if (DspTrustedHotwordDetectorSession.this.mDebugHotwordLogging) {
                      Slog.i(
                          "DspTrustedHotwordDetectorSession",
                          "Egressed detected result: " + startCopyingAudioStreams);
                    }
                  } catch (RemoteException e) {
                    DspTrustedHotwordDetectorSession.this.notifyOnDetectorRemoteException();
                    HotwordMetricsLogger.writeDetectorEvent(
                        1, 17, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                    throw e;
                  }
                  ...
                  try {
                    Slog.w(
                        "DspTrustedHotwordDetectorSession",
                        "Ignoring #onDetected due to a IOException",
                        e2);
                    iHotwordRecognitionStatusCallback.onHotwordDetectionServiceFailure(
                ...
                Slog.w(
                    "DspTrustedHotwordDetectorSession",
                    "Ignoring #onDetected due to a SecurityException",
                    e4);
                HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                    1, 8, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                try {
                  iHotwordRecognitionStatusCallback.onHotwordDetectionServiceFailure(
                  ...
                  DspTrustedHotwordDetectorSession.this.notifyOnDetectorRemoteException();
                  HotwordMetricsLogger.writeDetectorEvent(
                      1, 15, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                  throw e5;
                }
              }
            }
          ...
          public void onRejected(HotwordRejectedResult hotwordRejectedResult) {
            synchronized (DspTrustedHotwordDetectorSession.this.mLock) {
              ...
              HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                  1, 6, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
              if (!DspTrustedHotwordDetectorSession.this.mValidatingDspTrigger) {
                Slog.i(
                    "DspTrustedHotwordDetectorSession",
                    "Ignoring #onRejected due to a process restart");
                HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                    1, 9, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                return;
              }
              DspTrustedHotwordDetectorSession.this.mValidatingDspTrigger = false;
              try {
                ...
                if (DspTrustedHotwordDetectorSession.this.mDebugHotwordLogging
                    && hotwordRejectedResult != null) {
                  Slog.i(
                      "DspTrustedHotwordDetectorSession",
                      "Egressed rejected result: " + hotwordRejectedResult);
                }
              } catch (RemoteException e) {
                DspTrustedHotwordDetectorSession.this.notifyOnDetectorRemoteException();
                HotwordMetricsLogger.writeDetectorEvent(
                    1, 16, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                throw e;
              }
            }
          }
    ...
    this.mRemoteDetectionService.run(
        new ServiceConnector.VoidJob() { // from class:
          // com.android.server.voiceinteraction.DspTrustedHotwordDetectorSession$$ExternalSyntheticLambda0
          public final void runNoResult(Object obj) {
            DspTrustedHotwordDetectorSession.this.lambda$detectFromDspSourceLocked$1(
                atomicBoolean,
                iHotwordRecognitionStatusCallback,
  ...
  public /* synthetic */ void lambda$detectFromDspSourceLocked$1(
      final AtomicBoolean atomicBoolean,
      final IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback,
      SoundTrigger.KeyphraseRecognitionEvent keyphraseRecognitionEvent,
      IDspHotwordDetectionCallback iDspHotwordDetectionCallback,
      ISandboxedDetectionService iSandboxedDetectionService) {
    this.mCancellationKeyPhraseDetectionFuture =
        this.mScheduledExecutorService.schedule(
            new Runnable() { // from class:
              // com.android.server.voiceinteraction.DspTrustedHotwordDetectorSession$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
                DspTrustedHotwordDetectorSession.this.lambda$detectFromDspSourceLocked$0(
                    atomicBoolean, iHotwordRecognitionStatusCallback);
              }
            },
            4000L,
            TimeUnit.MILLISECONDS);
    iSandboxedDetectionService.detectFromDspSource(
        keyphraseRecognitionEvent,
        keyphraseRecognitionEvent.getCaptureFormat(),
        3000L,
        iDspHotwordDetectionCallback);
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$detectFromDspSourceLocked$0(
    ...
    try {
      iHotwordRecognitionStatusCallback.onHotwordDetectionServiceFailure(
          new HotwordDetectionServiceFailure(4, "Timeout to response to the detection result."));
    } catch (RemoteException e) {
