...
public abstract class HotwordMetricsLogger {
  ...
  public static void writeDetectorCreateEvent(int i, boolean z, int i2) {
    FrameworkStatsLog.write(
        FrameworkStatsLog.HOTWORD_DETECTOR_CREATE_REQUESTED,
        getCreateMetricsDetectorType(i),
        z,
        i2);
  }
  ...
  public static void writeServiceRestartEvent(int i, int i2, int i3) {
    FrameworkStatsLog.write(
        ...
        getRestartMetricsDetectorType(i),
        i2,
        i3);
  }
  ...
  public static void writeKeyphraseTriggerEvent(int i, int i2, int i3) {
    FrameworkStatsLog.write(
        FrameworkStatsLog.HOTWORD_DETECTOR_KEYPHRASE_TRIGGERED,
        getKeyphraseMetricsDetectorType(i),
        i2,
        i3);
  }
  ...
  public static void writeDetectorEvent(int i, int i2, int i3) {
    FrameworkStatsLog.write(
        FrameworkStatsLog.HOTWORD_DETECTOR_EVENTS, getDetectorMetricsDetectorType(i), i2, i3);
  }

  public static void writeAudioEgressEvent(int i, int i2, int i3, int i4, int i5, int i6) {
    FrameworkStatsLog.write(
        FrameworkStatsLog.HOTWORD_AUDIO_EGRESS_EVENT_REPORTED,
        getAudioEgressDetectorType(i),
        i2,
        i3,
        i4,
        i5,
