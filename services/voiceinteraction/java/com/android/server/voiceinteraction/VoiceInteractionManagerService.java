...
public class VoiceInteractionManagerService extends SystemService {
    ...
    public class LocalService extends VoiceInteractionManagerInternal {
        ...
        public void onPreCreatedUserConversion(int i) {
            Slogf.m88d("VoiceInteractionManager", "onPreCreatedUserConversion(%d): calling onRoleHoldersChanged() again", Integer.valueOf(i));
    ...
    public class VoiceInteractionManagerServiceStub extends IVoiceInteractionManagerService.Stub {
        ...
        */
        ...
        public String getDefaultRecognizer() {
            String string = VoiceInteractionManagerService.this.mContext.getString(R.string.config_systemSpeechRecognizer);
            if (TextUtils.isEmpty(string)) {
                return null;
            }
            return string;
        ...
        public boolean showSessionFromSession(IBinder iBinder, Bundle bundle, int i, String str) {
            ...
            synchronized (this) {
                String string = VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.data_usage_warning_title);
                String string2 = VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.data_usage_warning_body);
                if (bundle != null && bundle.containsKey(string)) {
                    ...
                    if (!bundle.getBoolean(VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.data_usage_wifi_limit_snoozed_title), true)) {
                        return false;
                    }
                    if (!VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.data_usage_wifi_limit_title).equals(getCurInteractor(Binder.getCallingUserHandle().getIdentifier()).getPackageName())) {
            ...
            public void onRoleHoldersChanged(String str, UserHandle userHandle) {
                ...
                if (str.equals("android.app.role.ASSISTANT")) {
                    ...
                    if (roleHoldersAsUser.isEmpty() && (userInfo = VoiceInteractionManagerService.this.mUserManagerInternal.getUserInfo(userHandle.getIdentifier())) != null && userInfo.preCreated) {
                        Slogf.m88d("VoiceInteractionManager", "onRoleHoldersChanged(): ignoring pre-created user %s for now, this method will be called again when it's converted to a real user", userInfo.toFullString());
                        return;
                    }
                ...
                if (z2 && z) {
                    synchronized (VoiceInteractionManagerServiceStub.this) {
                        ...
                        ((RoleManager) context.getSystemService(RoleManager.class)).clearRoleHoldersAsUser("android.app.role.ASSISTANT", 0, UserHandle.of(userId), context.getMainExecutor(), new Consumer() { // from class: com.android.server.voiceinteraction.VoiceInteractionManagerService$VoiceInteractionManagerServiceStub$2$$ExternalSyntheticLambda0
                            @Override // java.util.function.Consumer
                            public final void accept(Object obj) {
                                VoiceInteractionManagerService.VoiceInteractionManagerServiceStub.C28082.lambda$onHandleForceStop$0((Boolean) obj);
                            }
                        });
                    }
                } else if (z3 && z) {
        ...
        public final Intent getContextualSearchIntent(Bundle bundle) {
            String string = VoiceInteractionManagerService.this.mContext.getResources().getString(R.string.data_usage_wifi_limit_title);
            if (string.isEmpty()) {
                return null;
            }
