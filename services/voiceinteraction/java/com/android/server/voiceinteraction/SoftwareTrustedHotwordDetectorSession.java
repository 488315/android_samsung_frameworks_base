...
public final class SoftwareTrustedHotwordDetectorSession extends DetectorSession {
  ...
  public SoftwareTrustedHotwordDetectorSession(
  ...
  public void startListeningFromMicLocked(
    ...
    if (this.mPerformingSoftwareHotwordDetection) {
      Slog.i(
          ...
          "Hotword validation is already in progress, ignoring.");
    } else {
  ...
  public final void startListeningFromMicLocked() {
    final IDspHotwordDetectionCallback.Stub stub =
        new IDspHotwordDetectionCallback.Stub() { // from class:
          // com.android.server.voiceinteraction.SoftwareTrustedHotwordDetectorSession.1
          public void onDetected(HotwordDetectedResult hotwordDetectedResult) {
            synchronized (SoftwareTrustedHotwordDetectorSession.this.mLock) {
              HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                  2, 5, SoftwareTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
              if (!SoftwareTrustedHotwordDetectorSession.this.mPerformingSoftwareHotwordDetection) {
                Slog.i(
                    "SoftwareTrustedHotwordDetectorSession",
                    "Hotword detection has already completed");
                HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                    2, 7, SoftwareTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                return;
              }
              SoftwareTrustedHotwordDetectorSession.this.mPerformingSoftwareHotwordDetection =
                  false;
              try {
                SoftwareTrustedHotwordDetectorSession.this.enforcePermissionsForDataDelivery();
                SoftwareTrustedHotwordDetectorSession.this.saveProximityValueToBundle(
                    hotwordDetectedResult);
                try {
                  HotwordDetectedResult startCopyingAudioStreams =
                      SoftwareTrustedHotwordDetectorSession.this.mHotwordAudioStreamCopier
                          .startCopyingAudioStreams(hotwordDetectedResult);
                  try {
                    SoftwareTrustedHotwordDetectorSession.this.mSoftwareCallback.onDetected(
                    ...
                    HotwordMetricsLogger.writeDetectorEvent(
                        2,
                        17,
                        SoftwareTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                    throw e;
                  }
                  ...
                  Slog.w(
                      ...
                      e2);
                  try {
                    SoftwareTrustedHotwordDetectorSession.this.mSoftwareCallback
                ...
                Slog.w(
                    ...
                    e4);
                HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                    2, 8, SoftwareTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                try {
                  SoftwareTrustedHotwordDetectorSession.this.mSoftwareCallback
                      .onHotwordDetectionServiceFailure(
          ...
          public void onRejected(HotwordRejectedResult hotwordRejectedResult) {
            HotwordMetricsLogger.writeKeyphraseTriggerEvent(
                2, 6, SoftwareTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
          }
        };
    this.mRemoteDetectionService.run(
        new ServiceConnector.VoidJob() { // from class:
          // com.android.server.voiceinteraction.SoftwareTrustedHotwordDetectorSession$$ExternalSyntheticLambda1
          public final void runNoResult(Object obj) {
            ((ISandboxedDetectionService) obj)
                .detectFromMicrophoneSource(null, 1, null, null, stub);
          }
        });
  ...
  public void informRestartProcessLocked() {
    ...
    try {
      ...
      Slog.w(
          "SoftwareTrustedHotwordDetectorSession", "Failed to communicate #onProcessRestarted", e);
    ...
    if (this.mPerformingSoftwareHotwordDetection) {
      Slog.i(
          "SoftwareTrustedHotwordDetectorSession",
          "Process restarted: calling startRecognition() again");
      startListeningFromMicLocked();
    }
