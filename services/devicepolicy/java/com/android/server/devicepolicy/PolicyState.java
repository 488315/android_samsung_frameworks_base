...
public final class PolicyState {
    ...
    public android.app.admin.PolicyState getParcelablePolicyState() {
        ...
        return new android.app.admin.PolicyState(linkedHashMap, this.mCurrentResolvedPolicy, this.mPolicyDefinition.getResolutionMechanism().mo5258getParcelableResolutionMechanism());
    }
            ...
            switch (name) {
                case "policy-definition-entry":
                    ...
                    if (policyDefinition != null) {
                        ...
                        Slogf.wtf("PolicyState", "Error Parsing TAG_POLICY_DEFINITION_ENTRY, PolicyDefinition is null");
                        break;
                    }
                case "admin-policy-entry":
                    ...
                    while (XmlUtils.nextElementWithin(typedXmlPullParser, depth2)) {
                        ...
                        } else if (name2.equals("policy-value-entry") && (policyValue2 = policyDefinition.readPolicyValueFromXml(typedXmlPullParser)) == null) {
                    ...
                    if (enforcingAdmin != null) {
                        ...
                        Slogf.wtf("PolicyState", "Error Parsing TAG_ADMIN_POLICY_ENTRY, EnforcingAdmin is null");
                        break;
                    }
                case "resolved-value-entry":
                    if (policyDefinition == null) {
                        ...
                        if (policyValue != null) {
                            ...
                            Slogf.wtf("PolicyState", "Error Parsing TAG_RESOLVED_VALUE_ENTRY, currentResolvedPolicy is null");
                            break;
                        }
                    }
                default:
