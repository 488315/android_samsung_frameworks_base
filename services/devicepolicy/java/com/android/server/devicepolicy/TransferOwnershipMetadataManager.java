...
public class TransferOwnershipMetadataManager {
  ...
  public boolean saveMetadataFile(Metadata metadata) {
    ...
    File file =
        new File(this.mInjector.getOwnerTransferMetadataDir(), "owner-transfer-metadata.xml");
    ...
    try {
      ...
      insertSimpleTag(
          resolveSerializer, TAG_SOURCE_COMPONENT, metadata.sourceComponent.flattenToString());
      insertSimpleTag(
          resolveSerializer, TAG_TARGET_COMPONENT, metadata.targetComponent.flattenToString());
  ...
  public final void insertSimpleTag(
  ...
  public Metadata loadMetadataFile() {
    ...
    try {
      ...
      Slog.e(
          TAG,
          "Caught exception while trying to load the owner transfer params from file " + file,
          e);
      return null;
    }
  }
  ...
  */
  public final Metadata parseMetadataFile(TypedXmlPullParser typedXmlPullParser) {
  ...
  public boolean metadataFileExists() {
    return new File(this.mInjector.getOwnerTransferMetadataDir(), "owner-transfer-metadata.xml")
        .exists();
  }
  ...
  public class Metadata {
    ...
    public int hashCode() {
      return ((((((this.userId + 31) * 31) + this.sourceComponent.hashCode()) * 31)
                  + this.targetComponent.hashCode())
              * 31)
          + this.adminType.hashCode();
    }
  }
