...
public class ActiveAdmin {
  ...
  public void writeToXml(TypedXmlSerializer typedXmlSerializer) {
    ...
    if (this.isNetworkLoggingEnabled) {
      ...
      typedXmlSerializer.attributeInt(
          (String) null, "num-notifications", this.numNetworkLoggingNotifications);
      typedXmlSerializer.attributeLong(
          (String) null, "last-notification", this.lastNetworkLoggingNotificationTimeMs);
      ...
      for (Map.Entry entry : entrySet) {
        ...
        if (trustAgentInfo.options != null) {
          ...
          try {
            ...
            Slogf.m93e(
                "DevicePolicyManager", e, "Failed to save TrustAgent options", new Object[0]);
          }
    ...
    if (list != null && !list.isEmpty()) {
      writeAttributeValuesToXml(
          ...
          "provider",
          this.crossProfileWidgetProviders);
    }
    writePackageListToXml(
        typedXmlSerializer, "permitted-accessiblity-services", this.permittedAccessiblityServices);
    writePackageListToXml(typedXmlSerializer, "permitted-imes", this.permittedInputMethods);
    writePackageListToXml(
        typedXmlSerializer,
        "permitted-notification-listeners",
        this.permittedNotificationListeners);
    writePackageListToXml(
        typedXmlSerializer, "keep-uninstalled-packages", this.keepUninstalledPackages);
    writePackageListToXml(
        typedXmlSerializer, "metered_data_disabled_packages", this.meteredDisabledPackages);
    ...
    if (hasUserRestrictions()) {
      UserRestrictionsUtils.writeRestrictions(
          typedXmlSerializer, this.userRestrictions, "user-restrictions");
    }
    if (!this.defaultEnabledRestrictionsAlreadySet.isEmpty()) {
      writeAttributeValuesToXml(
          ...
          "restriction",
          this.defaultEnabledRestrictionsAlreadySet);
    }
    if (!TextUtils.isEmpty(this.shortSupportMessage)) {
      writeTextToXml(
          typedXmlSerializer, "short-support-message", this.shortSupportMessage.toString());
    }
    if (!TextUtils.isEmpty(this.longSupportMessage)) {
      writeTextToXml(
          typedXmlSerializer, "long-support-message", this.longSupportMessage.toString());
    }
    if (this.parentAdmin != null) {
    ...
    if (this.mProfileMaximumTimeOffMillis != 0) {
      writeAttributeValueToXml(
          typedXmlSerializer, "profile-off-deadline", this.mProfileOffDeadline);
    }
    ...
    writeAttributeValueToXml(
        ...
        this.mAdminCanGrantSensorsPermissions);
    ...
    writePackagePolicy(
        typedXmlSerializer, "credential-manager-policy", this.mCredentialManagerPolicy);
    ...
    writeAttributeValueToXml(
        typedXmlSerializer, "simplepassword-enabled", this.simplePasswordEnabled);
    ...
    writeAttributeValueToXml(
        typedXmlSerializer, "allow-internet-sharing", this.allowInternetSharing);
    ...
    writeAttributeValueToXml(
        typedXmlSerializer, "require-StorageCard-Encryption", this.requireStorageCardEncryption);
  }

  public final void writePackagePolicy(
      TypedXmlSerializer typedXmlSerializer, String str, PackagePolicy packagePolicy) {
    if (packagePolicy == null) {
      return;
    }
    typedXmlSerializer.startTag((String) null, str);
    typedXmlSerializer.attributeInt(
        (String) null, "package-policy-type", packagePolicy.getPolicyType());
    writePackageListToXml(
        typedXmlSerializer,
        ...
        set.stream()
            .map(
                new Function() { // from class:
                  // com.android.server.devicepolicy.ActiveAdmin$$ExternalSyntheticLambda1
  ...
  public void writeAttributeValueToXml(
  ...
  public void writeAttributeValueToXml(
      TypedXmlSerializer typedXmlSerializer, String str, boolean z) {
    typedXmlSerializer.startTag((String) null, str);
    typedXmlSerializer.attributeBoolean((String) null, "value", z);
    typedXmlSerializer.endTag((String) null, str);
  }

  public void writeAttributeValuesToXml(
      TypedXmlSerializer typedXmlSerializer, String str, String str2, Collection collection) {
    typedXmlSerializer.startTag((String) null, str);
  ...
  public void readFromXml(TypedXmlPullParser typedXmlPullParser, boolean z) {
    ...
    while (true) {
      ...
      if (next != 3 && next != 4) {
        ...
        if ("policies".equals(name)) {
          if (z) {
            Slogf.m86d("DevicePolicyManager", "Overriding device admin policies from XML.");
          ...
          this.mPasswordPolicy.nonLetter =
              typedXmlPullParser.getAttributeInt((String) null, "value");
          ...
          this.specifiesGlobalProxy =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
          ...
          this.disableContactsSearch =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
        } else if ("disable-bt-contacts-sharing".equals(name)) {
          this.disableBluetoothContactSharing =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
        } else if ("disable-screen-capture".equals(name)) {
          this.disableScreenCapture =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
        } else if ("require_auto_time".equals(name)) {
          this.requireAutoTime =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
        } else if ("force_ephemeral_users".equals(name)) {
          this.forceEphemeralUsers =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
        } else if ("is_network_logging_enabled".equals(name)) {
          this.isNetworkLoggingEnabled =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
          this.lastNetworkLoggingNotificationTimeMs =
              typedXmlPullParser.getAttributeLong((String) null, "last-notification");
          this.numNetworkLoggingNotifications =
              typedXmlPullParser.getAttributeInt((String) null, "num-notifications");
        } else if ("disable-keyguard-features".equals(name)) {
          this.disabledKeyguardFeatures =
              typedXmlPullParser.getAttributeInt((String) null, "value");
        } else if ("disable-account-management".equals(name)) {
          readAttributeValues(
              typedXmlPullParser, "account-type", this.accountTypesWithManagementDisabled);
          ...
          readAttributeValues(
              typedXmlPullParser, "restriction", this.defaultEnabledRestrictionsAlreadySet);
        } else if ("short-support-message".equals(name)) {
          if (typedXmlPullParser.next() == 4) {
            this.shortSupportMessage = typedXmlPullParser.getText();
          } else {
            Slogf.m102w("DevicePolicyManager", "Missing text when loading short support message");
          }
        } else if ("long-support-message".equals(name)) {
          if (typedXmlPullParser.next() == 4) {
            this.longSupportMessage = typedXmlPullParser.getText();
          } else {
            Slogf.m102w("DevicePolicyManager", "Missing text when loading long support message");
          }
          ...
          if (typedXmlPullParser.next() == 4) {
            ...
            Slogf.m102w("DevicePolicyManager", "Missing text when loading organization name");
          }
          ...
          if (typedXmlPullParser.next() == 4) {
            ...
            Slogf.m102w("DevicePolicyManager", "Missing text when loading start session message");
          }
        } else if ("end_user_session_message".equals(name)) {
          if (typedXmlPullParser.next() == 4) {
            this.endUserSessionMessage = typedXmlPullParser.getText();
          } else {
            Slogf.m102w("DevicePolicyManager", "Missing text when loading end session message");
          }
          ...
          this.mFactoryResetProtectionPolicy =
              FactoryResetProtectionPolicy.readFromXml(typedXmlPullParser);
        } else if ("suspend-personal-apps".equals(name)) {
          this.mSuspendPersonalApps =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
        } else if ("profile-max-time-off".equals(name)) {
          this.mProfileMaximumTimeOffMillis =
              typedXmlPullParser.getAttributeLong((String) null, "value");
          ...
          this.mNearbyNotificationStreamingPolicy =
              typedXmlPullParser.getAttributeInt((String) null, "value");
        } else if ("nearby-app-streaming-policy".equals(name)) {
          this.mNearbyAppStreamingPolicy =
              typedXmlPullParser.getAttributeInt((String) null, "value");
        } else if ("organization-id".equals(name)) {
          if (typedXmlPullParser.next() == 4) {
            this.mOrganizationId = typedXmlPullParser.getText();
          } else {
            Slogf.m102w("DevicePolicyManager", "Missing Organization ID.");
          }
        } else if ("enrollment-specific-id".equals(name)) {
          if (typedXmlPullParser.next() == 4) {
            this.mEnrollmentSpecificId = typedXmlPullParser.getText();
          } else {
            Slogf.m102w("DevicePolicyManager", "Missing Enrollment-specific ID.");
          }
        } else if ("admin-can-grant-sensors-permissions".equals(name)) {
          this.mAdminCanGrantSensorsPermissions =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", false);
        } else if ("usb-data-signaling".equals(name)) {
          this.mUsbDataSignalingEnabled =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", true);
        } else if ("wifi-min-security".equals(name)) {
          this.mWifiMinimumSecurityLevel =
              typedXmlPullParser.getAttributeInt((String) null, "value");
        } else if ("ssid-allowlist".equals(name)) {
          this.mWifiSsidPolicy =
              new WifiSsidPolicy(0, new ArraySet(readWifiSsids(typedXmlPullParser, "ssid")));
        } else if ("ssid-denylist".equals(name)) {
          this.mWifiSsidPolicy =
              new WifiSsidPolicy(1, new ArraySet(readWifiSsids(typedXmlPullParser, "ssid")));
        } else if ("preferential_network_service_configs".equals(name)) {
          List preferentialNetworkServiceConfigs =
              getPreferentialNetworkServiceConfigs(typedXmlPullParser, name);
          ...
          this.mManagedSubscriptionsPolicy =
              ManagedSubscriptionsPolicy.readFromXml(typedXmlPullParser);
          ...
          this.allowTextMessaging =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", true);
        } else if ("allow-popimap-email".equals(name)) {
          this.allowPOPIMAPEmail =
              typedXmlPullParser.getAttributeBoolean((String) null, "value", true);
          ...
          Slogf.m105w("DevicePolicyManager", "Unknown admin tag: %s", name);
  ...
  public final PackagePolicy readPackagePolicy(TypedXmlPullParser typedXmlPullParser) {
    return new PackagePolicy(
        typedXmlPullParser.getAttributeInt((String) null, "package-policy-type"),
        new ArraySet(readPackageList(typedXmlPullParser, "package-policy-packages")));
  }
  ...
  public final List readWifiSsids(TypedXmlPullParser typedXmlPullParser, String str) {
    ...
    return (List)
        arrayList.stream()
            .map(
                new Function() { // from class:
                  // com.android.server.devicepolicy.ActiveAdmin$$ExternalSyntheticLambda4
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
      ...
      if (next != 3 && next != 4) {
        ...
        if ("item".equals(name)) {
          ...
          if (attributeValue != null) {
            ...
            Slogf.m105w("DevicePolicyManager", "Package name missing under %s", name);
          }
        } else {
          Slogf.m105w("DevicePolicyManager", "Unknown tag under %s: ", str, name);
        }
      }
    }
    return arrayList;
  ...
  public final void readAttributeValues(
      TypedXmlPullParser typedXmlPullParser, String str, Collection collection) {
    collection.clear();
    int depth = typedXmlPullParser.getDepth();
    while (true) {
      int next = typedXmlPullParser.next();
      ...
      if (next != 3 && next != 4) {
        ...
        if (str.equals(name)) {
          ...
          Slogf.m92e("DevicePolicyManager", "Expected tag %s but found %s", str, name);
        }
      }
    }
  }
    ...
    while (true) {
      ...
      if (next != 3 && next != 4) {
        ...
        if ("component".equals(name)) {
          arrayMap.put(
              typedXmlPullParser.getAttributeValue((String) null, "value"),
              getTrustAgentInfo(typedXmlPullParser, str));
        } else {
          Slogf.m105w("DevicePolicyManager", "Unknown tag under %s: %s", str, name);
        }
      }
    }
    return arrayMap;
  ...
  public Bundle getLocalUserRestrictions(final int i) {
    return filterRestrictions(
        ...
        new Predicate() { // from class:
          // com.android.server.devicepolicy.ActiveAdmin$$ExternalSyntheticLambda0
  ...
  public Bundle getGlobalUserRestrictions(final int i) {
    return filterRestrictions(
        getEffectiveRestrictions(),
        new Predicate() { // from class:
          // com.android.server.devicepolicy.ActiveAdmin$$ExternalSyntheticLambda2
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean isGlobal;
  ...
  public void dumpPackagePolicy(
      final IndentingPrintWriter indentingPrintWriter, String str, PackagePolicy packagePolicy) {
      ...
      packagePolicy
          ...
          .forEach(
              new Consumer() { // from class:
                // com.android.server.devicepolicy.ActiveAdmin$$ExternalSyntheticLambda3
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    ...
    dumpPackagePolicy(
        indentingPrintWriter, "managedProfileCallerIdPolicy", this.mManagedProfileCallerIdAccess);
    dumpPackagePolicy(
        indentingPrintWriter, "managedProfileContactsPolicy", this.mManagedProfileContactsAccess);
    dumpPackagePolicy(
        indentingPrintWriter, "credentialManagerPolicy", this.mCredentialManagerPolicy);
