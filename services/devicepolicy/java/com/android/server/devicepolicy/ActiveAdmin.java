            ...
            for (Map.Entry entry : entrySet) {
                ...
                if (trustAgentInfo.options != null) {
                    ...
                    try {
                        ...
                        Slogf.m93e("DevicePolicyManager", e, "Failed to save TrustAgent options", new Object[0]);
                    }
        ...
        while (true) {
            ...
            if (next != 3 && next != 4) {
                ...
                if ("policies".equals(name)) {
                    ...
                    List preferentialNetworkServiceConfigs = getPreferentialNetworkServiceConfigs(typedXmlPullParser, name);
