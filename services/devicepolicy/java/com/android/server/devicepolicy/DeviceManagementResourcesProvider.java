...
public class DeviceManagementResourcesProvider {
  ...
  public boolean updateDrawables(List list) {
    ...
    for (int i = 0; i < list.size(); i++) {
      ...
      if ("UNDEFINED".equals(drawableSource)) {
        ...
        updateDrawableForSource =
            updateDrawableForSource(drawableId, drawableSource, drawableStyle, resource);
      }
  ...
  public final boolean updateDrawable(
      String str, String str2, ParcelableResource parcelableResource) {
    synchronized (this.mLock) {
      if (!this.mUpdatedDrawablesForStyle.containsKey(str)) {
        this.mUpdatedDrawablesForStyle.put(str, new HashMap());
      }
      if (parcelableResource.equals(
          (ParcelableResource) ((Map) this.mUpdatedDrawablesForStyle.get(str)).get(str2))) {
        return false;
      }
  ...
  public final boolean updateDrawableForSource(
      String str, String str2, String str3, ParcelableResource parcelableResource) {
    synchronized (this.mLock) {
  ...
  public boolean removeDrawables(List list) {
    synchronized (this.mLock) {
      ...
      while (true) {
        ...
        if (this.mUpdatedDrawablesForStyle.remove(str) == null
            && this.mUpdatedDrawablesForSource.remove(str) == null) {
          z2 = false;
        }
        z |= z2;
        i++;
  ...
  public ParcelableResource getDrawableForSourceLocked(String str, String str2, String str3) {
    if (this.mUpdatedDrawablesForSource.containsKey(str)
        && ((Map) this.mUpdatedDrawablesForSource.get(str)).containsKey(str3)) {
      return (ParcelableResource)
          ((Map) ((Map) this.mUpdatedDrawablesForSource.get(str)).get(str3)).get(str2);
    }
    return null;
  }
  ...
  public class ResourcesReaderWriter {
    ...
    public final void writeDrawablesForStylesInner(TypedXmlSerializer typedXmlSerializer) {
      if (DeviceManagementResourcesProvider.this.mUpdatedDrawablesForStyle == null
          || DeviceManagementResourcesProvider.this.mUpdatedDrawablesForStyle.isEmpty()) {
        return;
      }
      for (Map.Entry entry :
          DeviceManagementResourcesProvider.this.mUpdatedDrawablesForStyle.entrySet()) {
    ...
    public final void writeDrawablesForSourcesInner(TypedXmlSerializer typedXmlSerializer) {
      if (DeviceManagementResourcesProvider.this.mUpdatedDrawablesForSource == null
          || DeviceManagementResourcesProvider.this.mUpdatedDrawablesForSource.isEmpty()) {
        return;
      }
      for (Map.Entry entry :
          DeviceManagementResourcesProvider.this.mUpdatedDrawablesForSource.entrySet()) {
        for (Map.Entry entry2 : ((Map) entry.getValue()).entrySet()) {
          for (Map.Entry entry3 : ((Map) entry2.getValue()).entrySet()) {
            typedXmlSerializer.startTag((String) null, "drawable-source-entry");
            typedXmlSerializer.attribute((String) null, "drawable-id", (String) entry.getKey());
            typedXmlSerializer.attribute(
                (String) null, "drawable-source", (String) entry2.getKey());
    ...
    public final void writeStringsInner(TypedXmlSerializer typedXmlSerializer) {
      if (DeviceManagementResourcesProvider.this.mUpdatedStrings == null
          || DeviceManagementResourcesProvider.this.mUpdatedStrings.isEmpty()) {
        return;
      }
    ...
    */
    public final boolean readInner(TypedXmlPullParser typedXmlPullParser, int i, String str) {
      ...
      switch (c) {
        case 0:
          DeviceManagementResourcesProvider.this.mUpdatedStrings.put(
              typedXmlPullParser.getAttributeValue((String) null, "source-id"),
              ParcelableResource.createFromXml(typedXmlPullParser));
          return true;
        case 1:
          String attributeValue =
              typedXmlPullParser.getAttributeValue((String) null, "drawable-id");
          String attributeValue2 =
              typedXmlPullParser.getAttributeValue((String) null, "drawable-source");
          String attributeValue3 =
              typedXmlPullParser.getAttributeValue((String) null, "drawable-style");
          ParcelableResource createFromXml = ParcelableResource.createFromXml(typedXmlPullParser);
          if (!DeviceManagementResourcesProvider.this.mUpdatedDrawablesForSource.containsKey(
              attributeValue)) {
            DeviceManagementResourcesProvider.this.mUpdatedDrawablesForSource.put(
                attributeValue, new HashMap());
          }
          if (!((Map)
                  DeviceManagementResourcesProvider.this.mUpdatedDrawablesForSource.get(
                      attributeValue))
              .containsKey(attributeValue2)) {
            ((Map)
                    DeviceManagementResourcesProvider.this.mUpdatedDrawablesForSource.get(
                        attributeValue))
                .put(attributeValue2, new HashMap());
          }
          ((Map)
                  ((Map)
                          DeviceManagementResourcesProvider.this.mUpdatedDrawablesForSource.get(
                              attributeValue))
                      .get(attributeValue2))
              .put(attributeValue3, createFromXml);
          return true;
        case 2:
          ...
          if (!DeviceManagementResourcesProvider.this.mUpdatedDrawablesForStyle.containsKey(
              attributeValue4)) {
            DeviceManagementResourcesProvider.this.mUpdatedDrawablesForStyle.put(
                attributeValue4, new HashMap());
          }
          ((Map)
                  DeviceManagementResourcesProvider.this.mUpdatedDrawablesForStyle.get(
                      attributeValue4))
              .put(attributeValue5, createFromXml2);
          return true;
        default:
