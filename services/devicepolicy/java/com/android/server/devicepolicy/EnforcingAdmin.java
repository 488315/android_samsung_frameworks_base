...
public final class EnforcingAdmin {
  ...
  public static EnforcingAdmin createEnterpriseEnforcingAdmin(ComponentName componentName, int i) {
    ...
    return new EnforcingAdmin(
        componentName.getPackageName(), componentName, Set.of("enterprise"), i, null);
  }

  public static EnforcingAdmin createEnterpriseEnforcingAdmin(
      ComponentName componentName, int i, ActiveAdmin activeAdmin) {
    Objects.requireNonNull(componentName);
    return new EnforcingAdmin(
        componentName.getPackageName(), componentName, Set.of("enterprise"), i, activeAdmin);
  }

  public static EnforcingAdmin createDeviceAdminEnforcingAdmin(
      ComponentName componentName, int i, ActiveAdmin activeAdmin) {
    Objects.requireNonNull(componentName);
    return new EnforcingAdmin(
        componentName.getPackageName(), componentName, Set.of("device_admin"), i, activeAdmin);
  }
  ...
  public EnforcingAdmin(
      String str, ComponentName componentName, Set set, int i, ActiveAdmin activeAdmin) {
    Objects.requireNonNull(str);
  ...
  public android.app.admin.EnforcingAdmin getParcelableAdmin() {
    ...
    return new android.app.admin.EnforcingAdmin(
        this.mPackageName, unknownAuthority, UserHandle.of(this.mUserId));
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.mPackageName, enforcingAdmin.mPackageName)
        && Objects.equals(this.mComponentName, enforcingAdmin.mComponentName)
        && Objects.equals(
            Boolean.valueOf(this.mIsRoleAuthority),
            Boolean.valueOf(enforcingAdmin.mIsRoleAuthority))
        && hasMatchingAuthorities(this, enforcingAdmin);
  }

  public static boolean hasMatchingAuthorities(
      EnforcingAdmin enforcingAdmin, EnforcingAdmin enforcingAdmin2) {
  ...
  public void saveToXml(TypedXmlSerializer typedXmlSerializer) {
    ...
    typedXmlSerializer.attribute(
        (String) null,
        "authorities",
        String.join(KnoxVpnFirewallHelper.DELIMITER, getAuthorities()));
  }
  ...
  public static EnforcingAdmin readFromXml(TypedXmlPullParser typedXmlPullParser) {
    ...
    return new EnforcingAdmin(
        attributeValue,
        attributeValue3 != null ? new ComponentName(attributeValue, attributeValue3) : null,
        Set.of((Object[]) attributeValue2.split(KnoxVpnFirewallHelper.DELIMITER)),
        attributeInt,
        null);
  }
