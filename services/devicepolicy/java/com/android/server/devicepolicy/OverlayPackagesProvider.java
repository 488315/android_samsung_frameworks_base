...
public class OverlayPackagesProvider {
    ...
    public final int getCarrierRequiredAppsListArrayforManagedDevice() {
        return ("ATT".equals(this.salesCode) || "AIO".equals(this.salesCode)) ? R.array.config_builtInDisplayIsRoundArray : ("SPR".equals(this.salesCode) || "XAS".equals(this.salesCode) || "BST".equals(this.salesCode) || "VMU".equals(this.salesCode)) ? R.array.config_cdma_home_system : ("TMB".equals(this.salesCode) || "TMK".equals(this.salesCode)) ? R.array.config_cdma_international_roaming_indicators : ("VZW".equals(this.salesCode) || "VPP".equals(this.salesCode)) ? R.array.config_clockTickVibePattern : "USC".equals(this.salesCode) ? R.array.config_cell_retries_per_error_code : "DCM".equals(this.salesCode) ? R.array.config_callBarringMMI_for_ims : "SBM".equals(this.salesCode) ? R.array.config_cdma_dun_supported_types : "KDI".equals(this.salesCode) ? R.array.config_cameraPrivacyLightColors : "CCT".equals(this.salesCode) ? R.array.config_callBarringMMI : R.array.config_cameraPrivacyLightAlsLuxThresholds;
    }

    public final int getCarrierRequiredAppsListArrayforManagedProfile() {
        return ("ATT".equals(this.salesCode) || "AIO".equals(this.salesCode)) ? R.array.config_companionDeviceCerts : ("SPR".equals(this.salesCode) || "XAS".equals(this.salesCode) || "BST".equals(this.salesCode) || "VMU".equals(this.salesCode)) ? R.array.config_defaultAmbientContextServices : "TMB".equals(this.salesCode) ? R.array.config_defaultCloudSearchServices : ("VZW".equals(this.salesCode) || "VPP".equals(this.salesCode)) ? R.array.config_defaultImperceptibleKillingExemptionPkgs : "USC".equals(this.salesCode) ? R.array.config_defaultFirstUserRestrictions : "DCM".equals(this.salesCode) ? R.array.config_companionPermSyncEnabledCerts : "SBM".equals(this.salesCode) ? R.array.config_convert_to_emergency_number_map : "KDI".equals(this.salesCode) ? R.array.config_concurrentDisplayDeviceStates : "CCT".equals(this.salesCode) ? R.array.config_companionDevicePackages : R.array.config_companionPermSyncEnabledPackages;
    }

    public final int getCarrierDisallowedAppsListArrayforManagedDevice() {
        return ("ATT".equals(this.salesCode) || "AIO".equals(this.salesCode)) ? R.array.config_autoBrightnessButtonBacklightValues : ("SPR".equals(this.salesCode) || "XAS".equals(this.salesCode) || "BST".equals(this.salesCode) || "VMU".equals(this.salesCode)) ? R.array.config_autoBrightnessLevelsIdle : "TMB".equals(this.salesCode) ? R.array.config_autoKeyboardBacklightBrightnessValues : ("VZW".equals(this.salesCode) || "VPP".equals(this.salesCode)) ? R.array.config_autoKeyboardBacklightIncreaseLuxThreshold : "USC".equals(this.salesCode) ? R.array.config_autoKeyboardBacklightDecreaseLuxThreshold : "DCM".equals(this.salesCode) ? R.array.config_autoBrightnessDisplayValuesNitsIdle : "SBM".equals(this.salesCode) ? R.array.config_autoBrightnessLevels : "KDI".equals(this.salesCode) ? R.array.config_autoBrightnessLcdBacklightValues_doze : "CCT".equals(this.salesCode) ? R.array.config_autoBrightnessDisplayValuesNits : R.array.config_autoBrightnessLcdBacklightValues;
    }

    public final int getCarrierDisallowedAppsListArrayforManagedProfile() {
        return ("ATT".equals(this.salesCode) || "AIO".equals(this.salesCode)) ? R.array.config_autoRotationTiltTolerance : ("SPR".equals(this.salesCode) || "XAS".equals(this.salesCode) || "BST".equals(this.salesCode) || "VMU".equals(this.salesCode)) ? R.array.config_bg_current_drain_high_threshold_to_bg_restricted : "TMB".equals(this.salesCode) ? R.array.config_bg_current_drain_high_threshold_to_restricted_bucket : ("VZW".equals(this.salesCode) || "VPP".equals(this.salesCode)) ? R.array.config_bg_current_drain_threshold_to_restricted_bucket : "USC".equals(this.salesCode) ? R.array.config_bg_current_drain_threshold_to_bg_restricted : "DCM".equals(this.salesCode) ? R.array.config_availableColorModes : "SBM".equals(this.salesCode) ? R.array.config_batteryPackageTypeSystem : "KDI".equals(this.salesCode) ? R.array.config_batteryPackageTypeService : "CCT".equals(this.salesCode) ? R.array.config_autoTimeSourcesPriority : R.array.config_backGestureInsetScales;
    }
