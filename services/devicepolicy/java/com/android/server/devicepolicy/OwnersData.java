    ...
    public void writeInner(TypedXmlSerializer typedXmlSerializer) {
      ...
      if (ownerInfo != null) {
        ...
        typedXmlSerializer.attributeInt(
            (String) null, "userId", OwnersData.this.mDeviceOwnerUserId);
      ...
      typedXmlSerializer.attributeBoolean(
          (String) null, "migratedToPolicyEngine", OwnersData.this.mMigratedToPolicyEngine);
      typedXmlSerializer.attributeBoolean(
          (String) null, "migratedPostUpgrade", OwnersData.this.mPoliciesMigratedPostUpdate);
    ...
    public boolean readInner(TypedXmlPullParser typedXmlPullParser, int i, String str) {
      ...
      switch (c) {
        ...
        case 2:
          ...
          return true;
        case 3:
          OwnersData.this.mMigratedToPolicyEngine =
              typedXmlPullParser.getAttributeBoolean(
                  (String) null, "migratedToPolicyEngine", false);
          OwnersData.this.mPoliciesMigratedPostUpdate =
              typedXmlPullParser.getAttributeBoolean((String) null, "migratedPostUpgrade", false);
          return true;
        case 4:
          ...
          return true;
        case 5:
          OwnersData.this.mDeviceOwnerTypes.put(
              typedXmlPullParser.getAttributeValue((String) null, "package"),
              Integer.valueOf(typedXmlPullParser.getAttributeInt((String) null, "value", 0)));
          return true;
        case 6:
          ...
          return true;
        case 7:
          OwnersData.this.mSystemUpdatePolicy =
              SystemUpdatePolicy.restoreFromXml(typedXmlPullParser);
          return true;
        default:
    ...
    public static OwnerInfo readFromXml(TypedXmlPullParser typedXmlPullParser) {
      ...
      boolean equals =
          "true"
              ...
              | "true"
                  .equals(
                      typedXmlPullParser.getAttributeValue((String) null, "canAccessDeviceIds"));
