...
public final class LockTaskPolicySerializer extends PolicySerializer {
  ...
  public void saveToXml(
      PolicyKey policyKey, TypedXmlSerializer typedXmlSerializer, LockTaskPolicy lockTaskPolicy) {
    Objects.requireNonNull(lockTaskPolicy);
    typedXmlSerializer.attribute(
        (String) null,
        "packages",
        String.join(KnoxVpnFirewallHelper.DELIMITER, lockTaskPolicy.getPackages()));
  ...
  public LockTaskPolicy mo5067readFromXml(TypedXmlPullParser typedXmlPullParser) {
    ...
    try {
      return new LockTaskPolicy(
          Set.of((Object[]) attributeValue.split(KnoxVpnFirewallHelper.DELIMITER)),
