...
public final class FactoryResetter {
        ...
        new IResultReceiver
          ...
          public void send(int i, Bundle bundle) {
            ...
            try {
              ...
              Slogf.wtf(
                  FactoryResetter.TAG, e, "IOException calling underlying systems", new Object[0]);
            }
          }
        };
  ...
  public final void factoryResetInternalUnchecked() {
    ...
    Slogf.m96i(
        str,
        "factoryReset(): reason=%s, shutdown=%b, force=%b, wipeEuicc=%b, wipeAdoptableStorage=%b,"
            + " wipeFRP=%b",
        this.mReason,
        Boolean.valueOf(this.mShutdown),
        Boolean.valueOf(this.mForce),
        Boolean.valueOf(this.mWipeEuicc),
        Boolean.valueOf(this.mWipeAdoptableStorage),
        Boolean.valueOf(this.mWipeFactoryResetProtection));
    ...
    RecoverySystem.rebootWipeUserData(
        this.mContext, this.mShutdown, this.mReason, this.mForce, this.mWipeEuicc);
  }
