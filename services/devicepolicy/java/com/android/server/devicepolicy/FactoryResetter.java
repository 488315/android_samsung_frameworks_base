...
public final class FactoryResetter {
    ...
    public boolean factoryReset() {
        ...
        IResultReceiver.Stub stub = new IResultReceiver.Stub() { // from class: com.android.server.devicepolicy.FactoryResetter.1
            public void send(int i, Bundle bundle) {
                Slogf.m96i(FactoryResetter.TAG, "Factory reset confirmed by %s, proceeding", FactoryResetter.this.mSafetyChecker);
                try {
        ...
        Slogf.m96i(TAG, "Delaying factory reset until %s confirms", this.mSafetyChecker);
    ...
    public final void factoryResetInternalUnchecked() {
        String str = TAG;
        Slogf.m96i(str, "factoryReset(): reason=%s, shutdown=%b, force=%b, wipeEuicc=%b, wipeAdoptableStorage=%b, wipeFRP=%b", this.mReason, Boolean.valueOf(this.mShutdown), Boolean.valueOf(this.mForce), Boolean.valueOf(this.mWipeEuicc), Boolean.valueOf(this.mWipeAdoptableStorage), Boolean.valueOf(this.mWipeFactoryResetProtection));
        ...
        if (this.mWipeFactoryResetProtection) {
            ...
            if (persistentDataBlockManager != null) {
                Slogf.m102w(str, "Wiping factory reset protection");
                persistentDataBlockManager.wipe();
            } else {
                Slogf.m102w(str, "No need to wipe factory reset protection");
            }
        }
        if (this.mWipeAdoptableStorage) {
            Slogf.m102w(str, "Wiping adoptable storage");
