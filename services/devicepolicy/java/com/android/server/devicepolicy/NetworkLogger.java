...
public final class NetworkLogger {
  ...
  public final INetdEventCallback mNetdEventCallback =
      new BaseNetdEventCallback() { // from class: com.android.server.devicepolicy.NetworkLogger.1
        public void onDnsEvent(
          ...
          if (NetworkLogger.this.mIsLoggingEnabled.get() && shouldLogNetworkEvent(i5)) {
            sendNetworkEvent(
                new DnsEvent(str, strArr, i4, NetworkLogger.this.mPm.getNameForUid(i5), j));
          }
        }
        ...
        public final boolean shouldLogNetworkEvent(int i) {
          return NetworkLogger.this.mTargetUserId == -1
              || NetworkLogger.this.mTargetUserId == UserHandle.getUserId(i);
        }
      };
  ...
  public boolean startNetworkLogging() {
    ...
    try {
      ...
      NetworkLoggingHandler networkLoggingHandler =
          new NetworkLoggingHandler(this.mHandlerThread.getLooper(), this.mDpm, this.mTargetUserId);
