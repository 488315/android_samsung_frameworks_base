...
public class RemoteBugreportManager {
    ...
    public boolean requestBugreport() {
        ...
        if (this.mRemoteBugreportServiceIsActive.get() || this.mService.getDeviceOwnerRemoteBugreportUriAndHash() != null) {
            Slogf.m86d("DevicePolicyManager", "Remote bugreport wasn't started because there's already one running");
            return false;
        }
        ...
        do {
            try {
                ...
                Slogf.m91e("DevicePolicyManager", "Failed to make remote calls to start bugreportremote service", e);
                return false;
            } finally {
    ...
    public final void registerRemoteBugreportReceivers() {
        try {
            ...
            Slogf.m106w("DevicePolicyManager", e, "Failed to set type %s", "application/vnd.android.bugreport");
        }
