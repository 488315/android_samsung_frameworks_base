...
public abstract class ContentCaptureMetricsLogger {
  ...
  public static void writeSessionEvent(
      int i, int i2, int i3, ComponentName componentName, boolean z) {
    FrameworkStatsLog.write(
        208, i, i2, i3, ComponentName.flattenToShortString(componentName), (String) null, z);
  }

  public static void writeSessionFlush(
      int i,
