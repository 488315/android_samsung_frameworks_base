...
public final class ContentCaptureManagerServiceShellCommand extends ShellCommand {
  ...
  public final int setTemporaryService(PrintWriter printWriter) {
    ...
    printWriter.println(
        "ContentCaptureService temporarily set to "
            + nextArg
            + " for "
            + nextIntArgRequired2
            + "ms");
  ...
  public final int requestDestroy(PrintWriter printWriter) {
    ...
    final IResultReceiver.Stub stub =
        new IResultReceiver
            .Stub() { // from class:
                      // com.android.server.contentcapture.ContentCaptureManagerServiceShellCommand.1
    ...
    return requestSessionCommon(
        ...
        new Runnable() { // from class:
                         // com.android.server.contentcapture.ContentCaptureManagerServiceShellCommand$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
            ContentCaptureManagerServiceShellCommand.this.lambda$requestDestroy$0(
  ...
  public final int requestList(final PrintWriter printWriter) {
    ...
    final IResultReceiver.Stub stub =
        new IResultReceiver
            .Stub() { // from class:
                      // com.android.server.contentcapture.ContentCaptureManagerServiceShellCommand.2
          public void send(int i, Bundle bundle) {
    ...
    return requestSessionCommon(
        ...
        countDownLatch,
        new Runnable() { // from class:
                         // com.android.server.contentcapture.ContentCaptureManagerServiceShellCommand$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
            ContentCaptureManagerServiceShellCommand.this.lambda$requestList$1(
                userIdFromArgsOrAllUsers, stub);
          }
        });
  }
