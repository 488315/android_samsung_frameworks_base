...
public final class ContentCapturePerUserService extends AbstractPerUserSystemService
  ...
  public ContentCapturePerUserService(
      ContentCaptureManagerService contentCaptureManagerService, Object obj, boolean z, int i) {
  ...
  public final void updateRemoteServiceLocked(boolean z) {
    ...
    if (updateServiceInfoLocked == null) {
      ...
      if (((ContentCaptureManagerService) this.mMaster).debug) {
        Slog.d(
            TAG,
            "updateRemoteService(): creating new remote service for " + updateServiceInfoLocked);
      }
      Context context = ((ContentCaptureManagerService) this.mMaster).getContext();
      ContentCaptureServiceRemoteCallback contentCaptureServiceRemoteCallback =
          this.mRemoteServiceCallback;
      int i = this.mUserId;
      boolean isBindInstantServiceAllowed =
          ((ContentCaptureManagerService) this.mMaster).isBindInstantServiceAllowed();
      ...
      this.mRemoteService =
          new RemoteContentCaptureService(
              ...
              contentCaptureServiceRemoteCallback,
              i,
              this,
              isBindInstantServiceAllowed,
              ((ContentCaptureManagerService) abstractMasterSystemService).verbose,
              ((ContentCaptureManagerService) abstractMasterSystemService)
  ...
  public final void resurrectSessionsLocked() {
    ...
    if (((ContentCaptureManagerService) this.mMaster).debug) {
      Slog.d(
          TAG,
          "Ressurrecting remote service (" + this.mRemoteService + ") on " + size + " sessions");
    }
  ...
  public void startSessionLocked(
      IBinder iBinder,
      IBinder iBinder2,
    ...
    boolean z =
        ((ContentCaptureManagerService) this.mMaster)
                .mGlobalContentCaptureOptions.isWhitelisted(this.mUserId, componentName)
            || ((ContentCaptureManagerService) this.mMaster)
                .mGlobalContentCaptureOptions.isWhitelisted(
                    this.mUserId, componentName.getPackageName());
    ...
    if (!z) {
      ...
      ContentCaptureMetricsLogger.writeSessionEvent(
          i, 3, FrameworkStatsLog.ANR_LATENCY_REPORTED, serviceComponentName, false);
      return;
    }
  ...
  public ComponentName getServiceSettingsActivityLocked() {
    ...
    if (contentCaptureServiceInfo == null
        || (settingsActivity = contentCaptureServiceInfo.getSettingsActivity()) == null) {
      return null;
    }
  ...
  public boolean sendActivityAssistDataLocked(IBinder iBinder, Bundle bundle) {
    ...
    if (sessionId != 0) {
      ((ContentCaptureServerSession) this.mSessions.get(sessionId))
          .sendActivitySnapshotLocked(snapshotData);
      return true;
    }
    RemoteContentCaptureService remoteContentCaptureService = this.mRemoteService;
    if (remoteContentCaptureService == null) {
  ...
  public ArraySet getContentCaptureAllowlist() {
    ...
    synchronized (this.mLock) {
      whitelistedPackages =
          ((ContentCaptureManagerService) this.mMaster)
              .mGlobalContentCaptureOptions.getWhitelistedPackages(this.mUserId);
    }
  ...
  public final void resetContentCaptureWhitelistLocked() {
    ...
    ((ContentCaptureManagerService) this.mMaster)
        .mGlobalContentCaptureOptions.resetWhitelist(this.mUserId);
  }
  ...
  public final class ContentCaptureServiceRemoteCallback
    ...
    public void setContentCaptureWhitelist(List list, List list2) {
      ...
      ((ContentCaptureManagerService) ContentCapturePerUserService.this.mMaster)
          .mGlobalContentCaptureOptions.setWhitelist(
              ContentCapturePerUserService.this.mUserId, list, list2);
      EventLog.writeEvent(
          53201,
          Integer.valueOf(ContentCapturePerUserService.this.mUserId),
          Integer.valueOf(CollectionUtils.size(list)),
          Integer.valueOf(CollectionUtils.size(list2)));
      ContentCaptureMetricsLogger.writeSetWhitelistEvent(
          ContentCapturePerUserService.this.getServiceComponentName(), list, list2);
      ...
      for (int i = 0; i < size; i++) {
        ContentCaptureServerSession contentCaptureServerSession =
            (ContentCaptureServerSession) ContentCapturePerUserService.this.mSessions.valueAt(i);
        if (!((ContentCaptureManagerService) ContentCapturePerUserService.this.mMaster)
          ...
          if (((ContentCaptureManagerService) ContentCapturePerUserService.this.mMaster).debug) {
            Slog.d(
                ContentCapturePerUserService.TAG,
                "marking session "
                    + keyAt
                    + " ("
                    + contentCaptureServerSession.appComponentName
      ...
      synchronized (ContentCapturePerUserService.this.mLock) {
        for (int i2 = 0; i2 < size2; i2++) {
          ...
          ((ContentCaptureServerSession) ContentCapturePerUserService.this.mSessions.get(keyAt2))
    ...
    public void disableSelf() {
      ...
      try {
        Settings.Secure.putStringForUser(
            ContentCapturePerUserService.this.getContext().getContentResolver(),
    ...
    public void writeSessionFlush(
        ...
        int i2) {
      ContentCaptureMetricsLogger.writeSessionFlush(
          i,
    ...
    public final void updateContentCaptureOptions(ArraySet arraySet) {
      ...
      EventLog.writeEvent(
          53203, Integer.valueOf(ContentCapturePerUserService.this.mUserId), Integer.valueOf(size));
      for (int i = 0; i < size; i++) {
            ...
            .updateOptions(
                ...
                ((ContentCaptureManagerService) ContentCapturePerUserService.this.mMaster)
                    .mGlobalContentCaptureOptions.getOptions(
                        ContentCapturePerUserService.this.mUserId, str));
      }
    }
  }
}
