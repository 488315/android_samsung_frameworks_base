...
public final class ContentCaptureServerSession {
  ...
  public ContentCaptureServerSession(
    ...
    this.mContentCaptureContext =
        new ContentCaptureContext(null, activityId, componentName, i2, iBinder, i5);
  ...
  public void notifySessionStartedLocked(IResultReceiver iResultReceiver) {
    ...
    if (remoteContentCaptureService == null) {
      ...
      remoteContentCaptureService.onSessionStarted(
          this.mContentCaptureContext, this.mId, this.mUid, iResultReceiver, 2);
    }
  }
  ...
  public void resurrectLocked() {
    ...
    remoteContentCaptureService.onSessionStarted(
        new ContentCaptureContext(this.mContentCaptureContext, 4),
        this.mId,
        this.mUid,
