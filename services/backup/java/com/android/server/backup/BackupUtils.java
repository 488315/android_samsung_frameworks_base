...
public abstract class BackupUtils {
  public static boolean signaturesMatch(
      ArrayList arrayList, PackageInfo packageInfo, PackageManagerInternal packageManagerInternal) {
    boolean z;
    ...
    if (size == 1) {
      return packageManagerInternal.isDataRestoreSafe(
          (byte[]) arrayList.get(0), packageInfo.packageName);
    }
