...
public class TarBackupReader {
    ...
    public FileMetadata readTarHeaders() {
        ...
        try {
            ...
            fileMetadata.path = extractString(bArr, FrameworkStatsLog.MAGNIFICATION_USAGE_REPORTED, FrameworkStatsLog.f677xec66d03f);
    ...
    */
    public RestorePolicy chooseRestorePolicy(PackageManager packageManager, boolean z, FileMetadata fileMetadata, Signature[] signatureArr, PackageManagerInternal packageManagerInternal, int i, BackupEligibilityRules backupEligibilityRules, boolean z2) {
