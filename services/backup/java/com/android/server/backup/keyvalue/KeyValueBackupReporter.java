    ...
    this.mMonitor =
        BackupManagerMonitorUtils.monitorEvent(
            ...
            BackupManagerMonitorUtils.putMonitoringExtra(
                (Bundle) null, "android.app.backup.extra.LOG_ILLEGAL_KEY", str));
  ...
  public void onAgentTimedOut(PackageInfo packageInfo) {
    ...
    this.mMonitor =
        BackupManagerMonitorUtils.monitorEvent(
            ...
            2,
            BackupManagerMonitorUtils.putMonitoringExtra(
                (Bundle) null, "android.app.backup.extra.LOG_CANCEL_ALL", false));
  }
  ...
  public void onAgentCancelled(PackageInfo packageInfo) {
    ...
    this.mMonitor =
        BackupManagerMonitorUtils.monitorEvent(
            ...
            2,
            BackupManagerMonitorUtils.putMonitoringExtra(
                (Bundle) null, "android.app.backup.extra.LOG_CANCEL_ALL", true));
  }
