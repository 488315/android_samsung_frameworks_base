    ...
    */
    public int backupOnePackage() {
        ...
        if (initializeAgent()) {
            ...
            try {
                FullBackupRunner fullBackupRunner = new FullBackupRunner(this.backupManagerService, this.mPkg, this.mAgent, createPipe[1], this.mOpToken, this.mIncludeApks, this.mExtraFlag, this.mSmartSwitchBackupPath);
                createPipe[1].close();
                createPipe[1] = null;
