...
public class PerformFullTransportBackupTask extends FullBackupTask implements BackupRestoreTask {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(6:(13:(3:99|100|(1:102)(6:103|104|105|(11:107|108|109|110|(1:112)(1:129)|113|(1:115)|116|72|121|(1:123))(15:133|(2:403|404)|135|136|(1:(7:138|139|141|142|(1:144)(1:391)|145|124)(1:401))|367|(1:369)(1:386)|370|(1:372)|373|5ad|378|(1:380)|86|87)|27|28))|12|13|14|(1:16)(1:36)|17|(1:19)|20|672|25|(1:30)|27|28)|6|7|(1:9)(1:65)|10|11) */
                            ...
                            if (connect != null) {
                                ...
                                while (true) {
                                    ...
                                    try {
                                        ...
                                        PackageInfo packageInfo2 = (PackageInfo) this.mPackages.get(i10);
                                ...
                                Slog.i("PFTBT", "Full backup completed with status: " + i12);
    ...
    public class SinglePackageBackupRunner implements Runnable, BackupRestoreTask {
        ...
        */
        public void run() {
            ...
            PackageInfo packageInfo;
            PackageInfo packageInfo2;
            if (PerformFullTransportBackupTask.this.mAmInternal == null) {
                PerformFullTransportBackupTask.this.mAmInternal = (ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class);
            }
            if (PerformFullTransportBackupTask.this.mAmInternal != null && (packageInfo2 = this.mTarget) != null && packageInfo2.applicationInfo != null) {
                PerformFullTransportBackupTask.this.mAmInternal.updateBackupServicePkg(this.mTarget.applicationInfo.uid, true);
            }
            this.mEngine = new FullBackupEngine(PerformFullTransportBackupTask.this.mUserBackupManagerService, new FileOutputStream(this.mOutput.getFileDescriptor()), this.mPreflight, this.mTarget, false, this, this.mQuota, this.mCurrentOpToken, this.mTransportFlags, PerformFullTransportBackupTask.this.mBackupEligibilityRules, 0, false, null, PerformFullTransportBackupTask.this.mMonitor);
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        str = "PFTBT";
                        str2 = "Error closing transport pipe in runner";
                        Slog.w(str, str2);
                        if (PerformFullTransportBackupTask.this.mAmInternal == null) {
                        }
                    }
                ...
                if (PerformFullTransportBackupTask.this.mAmInternal == null || (packageInfo = this.mTarget) == null || packageInfo.applicationInfo == null) {
                    return;
                }
                PerformFullTransportBackupTask.this.mAmInternal.updateBackupServicePkg(this.mTarget.applicationInfo.uid, false);
            } catch (Throwable th3) {
                str = "PFTBT";
                str2 = "Error closing transport pipe in runner";
                try {
