...
public class ActiveRestoreSession extends IRestoreSession.Stub {
  ...
  public synchronized int getAvailableRestoreSets(
    ...
    this.mBackupManagerService
        .getContext()
        .enforceCallingOrSelfPermission("android.permission.BACKUP", "getAvailableRestoreSets");
    ...
    try {
      ...
      final TransportConnection transportClient =
      ...
      final UserBackupManagerService.BackupWakeLock wakelock =
          this.mBackupManagerService.getWakelock();
      wakelock.acquire();
                  ...
                  .obtainMessage(
                      ...
                      new RestoreGetSetsParams(
                          ...
                          new OnTaskFinishedListener() { // from class:
                                                         // com.android.server.backup.restore.ActiveRestoreSession$$ExternalSyntheticLambda2
                            @Override // com.android.server.backup.internal.OnTaskFinishedListener
                            public final void onFinished(String str) {
                              ActiveRestoreSession.lambda$getAvailableRestoreSets$0(
                                  TransportManager.this, transportClient, wakelock, str);
                            }
                          })));
      return 0;
    } catch (Exception e) {
  ...
  public static /* synthetic */ void lambda$getAvailableRestoreSets$0(
  ...
  public synchronized int restoreAll(
    ...
    this.mBackupManagerService
        .getContext()
        .enforceCallingOrSelfPermission("android.permission.BACKUP", "performRestore");
    Slog.d(
        "RestoreSession",
          ...
          try {
            return sendRestoreToHandlerLocked(
                new BiFunction() { // from class:
                                   // com.android.server.backup.restore.ActiveRestoreSession$$ExternalSyntheticLambda0
                  @Override // java.util.function.BiFunction
                  public final Object apply(Object obj, Object obj2) {
                    RestoreParams lambda$restoreAll$1;
                    lambda$restoreAll$1 =
                        ActiveRestoreSession.this.lambda$restoreAll$1(
                            iRestoreObserver,
                            iBackupManagerMonitor,
                            j,
                            restoreSet,
  ...
  public /* synthetic */ RestoreParams lambda$restoreAll$1(
    ...
    return RestoreParams.createForRestoreAll(
        transportConnection,
        iRestoreObserver,
        iBackupManagerMonitor,
        j,
            ...
            return sendRestoreToHandlerLocked(
                new BiFunction() { // from class:
                  ...
                  public final Object apply(Object obj, Object obj2) {
                    ...
                    lambda$restorePackages$2 =
                        ActiveRestoreSession.this.lambda$restorePackages$2(
                            iRestoreObserver,
                            iBackupManagerMonitor,
                            j,
                            strArr,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ RestoreParams lambda$restorePackages$2(
      IRestoreObserver iRestoreObserver,
      IBackupManagerMonitor iBackupManagerMonitor,
      long j,
      String[] strArr,
      ...
      TransportConnection transportConnection,
      OnTaskFinishedListener onTaskFinishedListener) {
    return RestoreParams.createForRestorePackages(
        transportConnection,
        iRestoreObserver,
        iBackupManagerMonitor,
        j,
  ...
  public final BackupEligibilityRules getBackupEligibilityRules(RestoreSet restoreSet) {
    return this.mBackupManagerService.getEligibilityRulesForOperation(
        "D2D".equals(restoreSet.device) ? 1 : 0);
  }
  ...
  public synchronized int restorePackage(
    ...
    try {
      final PackageInfo packageInfoAsUser =
          this.mBackupManagerService.getPackageManager().getPackageInfoAsUser(str, 0, this.mUserId);
      if (this.mBackupManagerService
        ...
        Slog.w(
            "RestoreSession",
            "restorePackage: bad packageName=" + str + " or calling uid=" + Binder.getCallingUid());
      ...
      try {
        ...
        Slog.v(
            "RestoreSession",
            "restorePackage pkg=" + str + " token=" + Long.toHexString(availableRestoreToken));
        ...
        return sendRestoreToHandlerLocked(
            new BiFunction() { // from class:
                               // com.android.server.backup.restore.ActiveRestoreSession$$ExternalSyntheticLambda3
              @Override // java.util.function.BiFunction
              public final Object apply(Object obj, Object obj2) {
                RestoreParams lambda$restorePackage$3;
                lambda$restorePackage$3 =
                    ActiveRestoreSession.this.lambda$restorePackage$3(
                        iRestoreObserver,
                        iBackupManagerMonitor,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ RestoreParams lambda$restorePackage$3(
      IRestoreObserver iRestoreObserver,
      IBackupManagerMonitor iBackupManagerMonitor,
      long j,
      ...
      TransportConnection transportConnection,
      OnTaskFinishedListener onTaskFinishedListener) {
    return RestoreParams.createForSinglePackage(
        transportConnection,
        iRestoreObserver,
        iBackupManagerMonitor,
        j,
  ...
  public final int sendRestoreToHandlerLocked(BiFunction biFunction, String str) {
    ...
    OnTaskFinishedListener onTaskFinishedListener =
        new OnTaskFinishedListener() { // from class:
                                       // com.android.server.backup.restore.ActiveRestoreSession$$ExternalSyntheticLambda4
          @Override // com.android.server.backup.internal.OnTaskFinishedListener
          public final void onFinished(String str2) {
            ActiveRestoreSession.lambda$sendRestoreToHandlerLocked$4(
                TransportManager.this, transportClient, wakelock, str2);
          }
        };
  ...
  public static /* synthetic */ void lambda$sendRestoreToHandlerLocked$4(
      TransportManager transportManager,
      TransportConnection transportConnection,
      UserBackupManagerService.BackupWakeLock backupWakeLock,
      String str) {
  ...
  public synchronized void endRestoreSession() {
    ...
    if (this.mTimedOut) {
      ...
      this.mBackupManagerService
          .getBackupHandler()
          .post(new EndRestoreRunnable(this.mBackupManagerService, this));
    }
  }
}
