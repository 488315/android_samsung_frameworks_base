...
public class PerformAdbRestoreTask implements Runnable {
    ...
    */
    public void run() {
        ...
        try {
            if (!this.mPrivilegeApp && !this.mBackupManagerService.backupPasswordMatches(this.mCurrentPassword)) {
            ...
            FullRestoreEngine fullRestoreEngine = new FullRestoreEngine(this.mBackupManagerService, this.mOperationStorage, null, this.mObserver, null, null, true, 0, true, this.mOperationTypeMIGRATION ? new BackupEligibilityRules(this.mBackupManagerService.getPackageManager(), (PackageManagerInternal) LocalServices.getService(PackageManagerInternal.class), this.mBackupManagerService.getUserId(), this.mBackupManagerService.getContext(), 1) : new BackupEligibilityRules(this.mBackupManagerService.getPackageManager(), (PackageManagerInternal) LocalServices.getService(PackageManagerInternal.class), this.mBackupManagerService.getUserId(), this.mBackupManagerService.getContext(), 2));
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static InputStream parseBackupFileHeaderAndReturnTarStream(InputStream inputStream, String str) {
        boolean z;
        boolean z2;
