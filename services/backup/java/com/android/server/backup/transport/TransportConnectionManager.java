...
public class TransportConnectionManager {
  ...
  public TransportConnectionManager(int i, Context context, TransportStats transportStats) {
    this(
        ...
        new Function() { // from class:
                         // com.android.server.backup.transport.TransportConnectionManager$$ExternalSyntheticLambda0
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            Intent realTransportIntent;
            realTransportIntent =
                TransportConnectionManager.getRealTransportIntent((ComponentName) obj);
  ...
  public TransportConnectionManager(
      int i, Context context, TransportStats transportStats, Function function) {
  ...
  public final TransportConnection getTransportClient(
      ComponentName componentName, String str, Intent intent) {
      ...
      for (TransportConnection transportConnection : this.mTransportClientsCallerMap.keySet()) {
        printWriter.println(
            "    "
                + transportConnection
                + " ["
                + ((String) this.mTransportClientsCallerMap.get(transportConnection))
                + "]");
