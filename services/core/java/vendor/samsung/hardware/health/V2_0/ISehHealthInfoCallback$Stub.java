...
public abstract class ISehHealthInfoCallback$Stub extends HwBinder implements IHealthInfoCallback {
    ...
    public final ArrayList interfaceChain() {
        return new ArrayList(
                Arrays.asList(
                        "vendor.samsung.hardware.health@2.0::ISehHealthInfoCallback",
                        "android.hardware.health@2.1::IHealthInfoCallback",
    ...
    public final void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) {
        ...
        if (i == 2) {
            ...
            android.hardware.health.V2_1.HealthInfo healthInfo3 =
            ...
            ((HealthHalCallbackHidl) this)
                    .mCallback.update(Translate.h2saTranslate(sehHealthInfo2));
            return;
        }
        if (i == 3) {
            ...
            ((HealthHalCallbackHidl) this)
                    .mCallback.update(Translate.h2saTranslate(sehHealthInfo3));
            return;
        }
        switch (i) {
            case 256067662:
