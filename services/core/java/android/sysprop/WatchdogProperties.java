...
public abstract class WatchdogProperties {
  ...
  public static Optional fatal_count() {
    return Optional.ofNullable(
        tryParseInteger(SystemProperties.get("framework_watchdog.fatal_count")));
  }

  public static Optional fatal_window_seconds() {
    return Optional.ofNullable(
        tryParseInteger(SystemProperties.get("framework_watchdog.fatal_window.second")));
  }

  public static Optional should_ignore_fatal_count() {
    return Optional.ofNullable(
        tryParseBoolean(SystemProperties.get("persist.debug.framework_watchdog.fatal_ignore")));
  }
}
