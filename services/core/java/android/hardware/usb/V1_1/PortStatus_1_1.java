...
public final class PortStatus_1_1 {
  ...
  public final boolean equals(Object obj) {
    ...
    return HidlSupport.deepEquals(this.status, portStatus_1_1.status)
        && HidlSupport.deepEquals(
            Integer.valueOf(this.supportedModes), Integer.valueOf(portStatus_1_1.supportedModes))
  ...
  public final String toString() {
    return "{.status = "
        + this.status
        + ", .supportedModes = "
        + PortMode_1_1.dumpBitfield(this.supportedModes)
        + ", .currentMode = "
        + PortMode_1_1.toString(this.currentMode)
        + "}";
  }
  ...
  public static final ArrayList readVectorFromParcel(HwParcel hwParcel) {
    ...
    HwBlob readEmbeddedBuffer =
        hwParcel.readEmbeddedBuffer(int32 * 48, readBuffer.handle(), 0L, true);
    arrayList.clear();
