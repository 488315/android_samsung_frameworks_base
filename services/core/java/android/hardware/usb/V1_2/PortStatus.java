...
public final class PortStatus {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(
            HidlSupport.deepHashCode(Integer.valueOf(this.supportedContaminantProtectionModes))),
        Integer.valueOf(
            HidlSupport.deepHashCode(
                Boolean.valueOf(this.supportsEnableContaminantPresenceProtection))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Integer.valueOf(this.contaminantProtectionStatus))),
        Integer.valueOf(
            HidlSupport.deepHashCode(
                Boolean.valueOf(this.supportsEnableContaminantPresenceDetection))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Integer.valueOf(this.contaminantDetectionStatus))));
  }
  ...
  public final String toString() {
    return "{.status_1_1 = "
        ...
        + ContaminantProtectionMode.dumpBitfield(this.supportedContaminantProtectionModes)
        + ", .supportsEnableContaminantPresenceProtection = "
        + this.supportsEnableContaminantPresenceProtection
        + ", .contaminantProtectionStatus = "
        + ContaminantProtectionStatus.toString(this.contaminantProtectionStatus)
        + ", .supportsEnableContaminantPresenceDetection = "
        + this.supportsEnableContaminantPresenceDetection
        + ", .contaminantDetectionStatus = "
        + ContaminantDetectionStatus.toString(this.contaminantDetectionStatus)
        + "}";
  }
  ...
  public static final ArrayList readVectorFromParcel(HwParcel hwParcel) {
    ...
    HwBlob readEmbeddedBuffer =
        hwParcel.readEmbeddedBuffer(int32 * 72, readBuffer.handle(), 0L, true);
    arrayList.clear();
