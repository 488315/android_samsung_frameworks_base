...
public final class AltModeData implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.hardware.usb.AltModeData.1
  ...
  public void readFromParcel(Parcel parcel) {
    ...
    if (readInt == 0) {
      _set(
          readInt, (DisplayPortAltModeData) parcel.readTypedObject(DisplayPortAltModeData.CREATOR));
      return;
    }
  ...
  public class DisplayPortAltModeData implements Parcelable {
    public static final Parcelable.Creator CREATOR =
        new Parcelable
            .Creator() { // from class: android.hardware.usb.AltModeData.DisplayPortAltModeData.1
          @Override // android.os.Parcelable.Creator
