...
public final class PortStatus {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.currentDataRole))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.currentPowerRole))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.currentMode))),
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.canChangeMode))),
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.canChangeDataRole))),
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.canChangePowerRole))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.supportedModes))));
  }
  ...
  public final String toString() {
    return "{.portName = "
        + this.portName
        + ", .currentDataRole = "
        + PortDataRole.toString(this.currentDataRole)
        + ", .currentPowerRole = "
        + PortPowerRole.toString(this.currentPowerRole)
        + ", .currentMode = "
        + PortMode.toString(this.currentMode)
        + ", .canChangeMode = "
        + this.canChangeMode
        + ", .canChangeDataRole = "
        + this.canChangeDataRole
        + ", .canChangePowerRole = "
        + this.canChangePowerRole
        + ", .supportedModes = "
        + PortMode.toString(this.supportedModes)
        + "}";
  }
