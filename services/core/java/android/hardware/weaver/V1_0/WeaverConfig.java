...
public final class WeaverConfig {
  ...
  public final boolean equals(Object obj) {
    ...
    return this.slots == weaverConfig.slots
        && this.keySize == weaverConfig.keySize
        && this.valueSize == weaverConfig.valueSize;
  }

  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.slots))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.keySize))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.valueSize))));
  }
