...
public interface IHdmiCecCallback extends IBase {
  ...
  static IHdmiCecCallback asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.tv.cec@1.0::IHdmiCecCallback");
  ...
  public abstract class Stub extends HwBinder implements IHdmiCecCallback {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList("android.hardware.tv.cec@1.0::IHdmiCecCallback", IBase.kInterfaceName));
    }
