...
public final class HdmiPortInfo {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.portId))),
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.cecSupported))),
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.arcSupported))),
        Integer.valueOf(HidlSupport.deepHashCode(Short.valueOf(this.physicalAddress))));
  }

  public final String toString() {
    return "{.type = "
        + HdmiPortType.toString(this.type)
        + ", .portId = "
        + this.portId
        + ", .cecSupported = "
        + this.cecSupported
