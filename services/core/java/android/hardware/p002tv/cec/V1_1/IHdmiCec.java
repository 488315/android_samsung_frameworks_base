...
import android.hardware.p002tv.cec.V1_0.CecMessage;
import android.hardware.p002tv.cec.V1_0.HdmiPortInfo;
...
public interface IHdmiCec extends android.hardware.p002tv.cec.V1_0.IHdmiCec {
  ...
  static IHdmiCec asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.tv.cec@1.1::IHdmiCec");
  ...
  public final class Proxy implements IHdmiCec {
    ...
    @Override // android.hardware.p002tv.cec.V1_1.IHdmiCec
    ...
    @Override // android.hardware.p002tv.cec.V1_1.IHdmiCec,
              // android.hardware.p002tv.cec.V1_0.IHdmiCec, android.hidl.base.V1_0.IBase
    ...
    public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) {
      switch (i) {
        ...
        case 3:
          ...
          getPhysicalAddress(
              new IHdmiCec
                  .getPhysicalAddressCallback() { // from class:
                                                  // android.hardware.tv.cec.V1_1.IHdmiCec.Stub.1
