...
public interface IAnnouncementListener extends IBase {
  ...
  static IAnnouncementListener asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.broadcastradio@2.0::IAnnouncementListener");
    ...
    try {
      ...
      while (it.hasNext()) {
        if (((String) it.next())
            .equals("android.hardware.broadcastradio@2.0::IAnnouncementListener")) {
          return proxy;
        }
      }
    ...
    public String toString() {
      try {
        ...
        return "[class or subclass of"
                   + " android.hardware.broadcastradio@2.0::IAnnouncementListener]@Proxy";
      }
    }
  ...
  public abstract class Stub extends HwBinder implements IAnnouncementListener {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList(
              "android.hardware.broadcastradio@2.0::IAnnouncementListener", IBase.kInterfaceName));
    }
