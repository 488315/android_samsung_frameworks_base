...
public interface ITunerCallback extends IBase {
  ...
  static ITunerCallback asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.broadcastradio@2.0::ITunerCallback");
  ...
  public abstract class Stub extends HwBinder implements ITunerCallback {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList(
              "android.hardware.broadcastradio@2.0::ITunerCallback", IBase.kInterfaceName));
    }
    ...
    public final ArrayList getHashChain() {
      return new ArrayList(
          Arrays.asList(
              new byte[] {
                -81, 36, -72, 124, -88, -72, -16, 47, -51, -30, 5, -28, 125, -74, -87, 96, -97, -57,
                -23, -41, 125, 115, -26, -108, -20, -113, -100, 80, -116, -95, -107, 117
              },
              new byte[] {
                -20,
                Byte.MAX_VALUE,
