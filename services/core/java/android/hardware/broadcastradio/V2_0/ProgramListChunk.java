...
public final class ProgramListChunk {
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.purge))),
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.complete))),
  ...
  public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
    ...
    HwBlob readEmbeddedBuffer =
        hwParcel.readEmbeddedBuffer(int32 * 120, hwBlob.handle(), j2 + 0, true);
    this.modified.clear();
