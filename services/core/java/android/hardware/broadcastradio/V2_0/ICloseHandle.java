...
public interface ICloseHandle extends IBase {
  ...
  static ICloseHandle asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.broadcastradio@2.0::ICloseHandle");
  ...
  public abstract class Stub extends HwBinder implements ICloseHandle {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList("android.hardware.broadcastradio@2.0::ICloseHandle", IBase.kInterfaceName));
    }
