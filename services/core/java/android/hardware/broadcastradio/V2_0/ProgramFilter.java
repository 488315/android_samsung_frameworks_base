...
public final class ProgramFilter {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.includeCategories))),
        Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.excludeModifications))));
  }
  ...
  public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
    ...
    HwBlob readEmbeddedBuffer2 =
        hwParcel.readEmbeddedBuffer(int322 * 16, hwBlob.handle(), j3 + 0, true);
