...
public final class Metadata implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.hardware.broadcastradio.Metadata.1
  ...
  public String toString() {
    switch (this._tag) {
      case 0:
        return "android.hardware.broadcastradio.Metadata.rdsPs("
            + Objects.toString(getRdsPs())
            + ")";
      case 1:
      ...
      case 3:
        return "android.hardware.broadcastradio.Metadata.rdsRt("
            + Objects.toString(getRdsRt())
            + ")";
      case 4:
        return "android.hardware.broadcastradio.Metadata.songTitle("
            + Objects.toString(getSongTitle())
            + ")";
      case 5:
        return "android.hardware.broadcastradio.Metadata.songArtist("
            + Objects.toString(getSongArtist())
            + ")";
      case 6:
        return "android.hardware.broadcastradio.Metadata.songAlbum("
            + Objects.toString(getSongAlbum())
            + ")";
      case 7:
      ...
      case 9:
        return "android.hardware.broadcastradio.Metadata.programName("
            + Objects.toString(getProgramName())
            + ")";
      case 10:
        return "android.hardware.broadcastradio.Metadata.dabEnsembleName("
            + Objects.toString(getDabEnsembleName())
            + ")";
      case 11:
        return "android.hardware.broadcastradio.Metadata.dabEnsembleNameShort("
            + Objects.toString(getDabEnsembleNameShort())
            + ")";
      case 12:
        return "android.hardware.broadcastradio.Metadata.dabServiceName("
            + Objects.toString(getDabServiceName())
            + ")";
      case 13:
        return "android.hardware.broadcastradio.Metadata.dabServiceNameShort("
            + Objects.toString(getDabServiceNameShort())
            + ")";
      case 14:
        return "android.hardware.broadcastradio.Metadata.dabComponentName("
            + Objects.toString(getDabComponentName())
            + ")";
      case 15:
        return "android.hardware.broadcastradio.Metadata.dabComponentNameShort("
            + Objects.toString(getDabComponentNameShort())
            + ")";
      default:
  ...
  public final void _assertTag(int i) {
    ...
    throw new IllegalStateException(
        "bad access: " + _tagString(i) + ", " + _tagString(getTag()) + " is available.");
  }
