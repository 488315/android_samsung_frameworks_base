...
public class Properties implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.hardware.broadcastradio.Properties.1
  ...
  public String toString() {
    ...
    stringJoiner.add(
        "supportedIdentifierTypes: "
            + IdentifierType$$.arrayToString(this.supportedIdentifierTypes));
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.deepEquals(this.maker, properties.maker)
        ...
        && Objects.deepEquals(this.supportedIdentifierTypes, properties.supportedIdentifierTypes)
