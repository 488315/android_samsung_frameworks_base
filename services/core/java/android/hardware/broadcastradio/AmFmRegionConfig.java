...
public class AmFmRegionConfig implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.hardware.broadcastradio.AmFmRegionConfig.1
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.deepEquals(this.ranges, amFmRegionConfig.ranges)
        && Objects.deepEquals(
            Integer.valueOf(this.fmDeemphasis), Integer.valueOf(amFmRegionConfig.fmDeemphasis))
        && Objects.deepEquals(Integer.valueOf(this.fmRds), Integer.valueOf(amFmRegionConfig.fmRds));
  }

  /* JADX WARN: Multi-variable type inference failed */
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(this.ranges, Integer.valueOf(this.fmDeemphasis), Integer.valueOf(this.fmRds))
            .toArray());
  }
