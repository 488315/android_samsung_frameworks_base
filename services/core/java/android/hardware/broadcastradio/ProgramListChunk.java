...
public class ProgramListChunk implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.hardware.broadcastradio.ProgramListChunk.1
      ...
      if (parcel.dataPosition() - dataPosition < readInt) {
        ...
        if (parcel.dataPosition() - dataPosition < readInt) {
          ...
          if (parcel.dataPosition() - dataPosition < readInt) {
            ...
            if (parcel.dataPosition() - dataPosition < readInt) {
              this.removed =
                  (ProgramIdentifier[]) parcel.createTypedArray(ProgramIdentifier.CREATOR);
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.deepEquals(Boolean.valueOf(this.purge), Boolean.valueOf(programListChunk.purge))
        && Objects.deepEquals(
