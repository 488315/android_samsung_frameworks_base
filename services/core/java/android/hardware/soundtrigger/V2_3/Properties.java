...
public final class Properties {
  ...
  public final boolean equals(Object obj) {
    ...
    return HidlSupport.deepEquals(this.base, properties.base)
        && HidlSupport.deepEquals(this.supportedModelArch, properties.supportedModelArch)
        && HidlSupport.deepEquals(
            Integer.valueOf(this.audioCapabilities), Integer.valueOf(properties.audioCapabilities));
  }

  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(this.base)),
        Integer.valueOf(HidlSupport.deepHashCode(this.supportedModelArch)),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.audioCapabilities))));
  }
