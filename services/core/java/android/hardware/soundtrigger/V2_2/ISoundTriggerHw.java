...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_1.ISoundTriggerHw {
  ...
  static ISoundTriggerHw asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.soundtrigger@2.2::ISoundTriggerHw");
          ...
          getProperties(
              new ISoundTriggerHw
                  .getPropertiesCallback() { // from class:
                                             // android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.1
          ...
          loadSoundModel(
              ...
              new ISoundTriggerHw
                  .loadSoundModelCallback() { // from class:
                                              // android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.2
          ...
          loadPhraseSoundModel(
              ...
              new ISoundTriggerHw
                  .loadPhraseSoundModelCallback() { // from class:
                                                    // android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.3
          ...
          loadSoundModel_2_1(
              ...
              new ISoundTriggerHw
                  .loadSoundModel_2_1Callback() { // from class:
                                                  // android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.4
          ...
          loadPhraseSoundModel_2_1(
              ...
              new ISoundTriggerHw
                  .loadPhraseSoundModel_2_1Callback() { // from class:
                                                        // android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.5
