...
public interface ISoundTriggerHwCallback extends IBase {
  ...
  static ISoundTriggerHwCallback asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.soundtrigger@2.0::ISoundTriggerHwCallback");
    ...
    try {
      ...
      while (it.hasNext()) {
        if (((String) it.next())
            .equals("android.hardware.soundtrigger@2.0::ISoundTriggerHwCallback")) {
          return proxy;
        }
      }
  ...
  public final class RecognitionEvent {
    ...
    public final boolean equals(Object obj) {
      ...
      return this.status == recognitionEvent.status
          && this.type == recognitionEvent.type
          && this.model == recognitionEvent.model
          && this.captureAvailable == recognitionEvent.captureAvailable
          && this.captureSession == recognitionEvent.captureSession
          && this.captureDelayMs == recognitionEvent.captureDelayMs
          && this.capturePreambleMs == recognitionEvent.capturePreambleMs
          && this.triggerInData == recognitionEvent.triggerInData
          && HidlSupport.deepEquals(this.audioConfig, recognitionEvent.audioConfig)
          && HidlSupport.deepEquals(this.data, recognitionEvent.data);
    }
    ...
    public final int hashCode() {
      return Objects.hash(
          ...
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.model))),
          Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.captureAvailable))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.captureSession))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.captureDelayMs))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.capturePreambleMs))),
          Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.triggerInData))),
    ...
    public final String toString() {
      return "{.status = "
          + RecognitionStatus.toString(this.status)
          + ", .type = "
  ...
  public final class PhraseRecognitionEvent {
    ...
    public final boolean equals(Object obj) {
      ...
      return HidlSupport.deepEquals(this.common, phraseRecognitionEvent.common)
          && HidlSupport.deepEquals(this.phraseExtras, phraseRecognitionEvent.phraseExtras);
    }

    public final int hashCode() {
      return Objects.hash(
          Integer.valueOf(HidlSupport.deepHashCode(this.common)),
          Integer.valueOf(HidlSupport.deepHashCode(this.phraseExtras)));
    }
  ...
  public final class ModelEvent {
    ...
    public final boolean equals(Object obj) {
      ...
      return this.status == modelEvent.status
          && this.model == modelEvent.model
          && HidlSupport.deepEquals(this.data, modelEvent.data);
    }
    ...
    public final String toString() {
      return "{.status = "
          + SoundModelStatus.toString(this.status)
          + ", .model = "
          + this.model
          + ", .data = "
          + this.data
    ...
    public String toString() {
      try {
        ...
        return "[class or subclass of"
                   + " android.hardware.soundtrigger@2.0::ISoundTriggerHwCallback]@Proxy";
      }
    }
  ...
  public abstract class Stub extends HwBinder implements ISoundTriggerHwCallback {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList(
              "android.hardware.soundtrigger@2.0::ISoundTriggerHwCallback", IBase.kInterfaceName));
    }
    ...
    public final ArrayList getHashChain() {
      return new ArrayList(
          Arrays.asList(
              new byte[] {
                26, 110, 43, -46, -119, -14, 41, 49, -59, 38, -78, 25, 22, -111, 15, 29, 76, 67,
                107, 122, -53, -107, 86, -28, 36, 61, -28, -50, -114, 108, -62, -28
              },
              new byte[] {
                -20,
                Byte.MAX_VALUE,
