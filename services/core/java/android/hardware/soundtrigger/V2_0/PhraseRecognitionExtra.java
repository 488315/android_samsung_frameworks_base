...
public final class PhraseRecognitionExtra {
  ...
  public final boolean equals(Object obj) {
    ...
    return this.f13id == phraseRecognitionExtra.f13id
  ...
  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f13id))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.recognitionModes))),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.confidenceLevel))),
  ...
  public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
    ...
    HwBlob readEmbeddedBuffer =
        hwParcel.readEmbeddedBuffer(int32 * 8, hwBlob.handle(), j2 + 0, true);
    this.levels.clear();
