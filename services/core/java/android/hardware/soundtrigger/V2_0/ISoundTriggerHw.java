...
public interface ISoundTriggerHw extends IBase {
  ...
  void loadPhraseSoundModel(
      ...
      int i,
      loadPhraseSoundModelCallback loadphrasesoundmodelcallback);

  void loadSoundModel(
      SoundModel soundModel,
      ISoundTriggerHwCallback iSoundTriggerHwCallback,
      int i,
      loadSoundModelCallback loadsoundmodelcallback);
  ...
  static ISoundTriggerHw getService(String str, boolean z) {
    return asInterface(
        HwBinder.getService("android.hardware.soundtrigger@2.0::ISoundTriggerHw", str, z));
  }
  ...
  public final class Properties {
    ...
    public final int hashCode() {
      return Objects.hash(
          ...
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.maxSoundModels))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.maxKeyPhrases))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.maxUsers))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.recognitionModes))),
          Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.captureTransition))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.maxBufferMs))),
          Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.concurrentCapture))),
          Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.triggerInEvent))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.powerConsumptionMw))));
    }
  ...
  public final class SoundModel {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
      ...
      HwBlob readEmbeddedBuffer =
          hwParcel.readEmbeddedBuffer(int32 * 1, hwBlob.handle(), j2 + 0, true);
      this.data.clear();
  ...
  public final class Phrase {
    ...
    public final boolean equals(Object obj) {
      ...
      return this.f12id == phrase.f12id
    ...
    public final int hashCode() {
      return Objects.hash(
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f12id))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.recognitionModes))),
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
      ...
      int int32 = hwBlob.getInt32(8 + j2);
      HwBlob readEmbeddedBuffer =
          hwParcel.readEmbeddedBuffer(int32 * 4, hwBlob.handle(), j2 + 0, true);
      this.users.clear();
      for (int i = 0; i < int32; i++) {
  ...
  public final class PhraseSoundModel {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
      ...
      int int32 = hwBlob.getInt32(8 + j2);
      HwBlob readEmbeddedBuffer =
          hwParcel.readEmbeddedBuffer(int32 * 56, hwBlob.handle(), j2 + 0, true);
      this.phrases.clear();
      for (int i = 0; i < int32; i++) {
  ...
  public final class RecognitionConfig {
    ...
    public final int hashCode() {
      return Objects.hash(
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.captureHandle))),
          Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.captureDevice))),
          Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.captureRequested))),
          Integer.valueOf(HidlSupport.deepHashCode(this.phrases)),
          Integer.valueOf(HidlSupport.deepHashCode(this.data)));
    }
    ...
    public final String toString() {
      return "{.captureHandle = "
          + this.captureHandle
          + ", .captureDevice = "
          + AudioDevice.toString(this.captureDevice)
          + ", .captureRequested = "
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
      ...
      HwBlob readEmbeddedBuffer =
          hwParcel.readEmbeddedBuffer(int32 * 32, hwBlob.handle(), j2 + 0, true);
      this.phrases.clear();
      for (int i = 0; i < int32; i++) {
      ...
      HwBlob readEmbeddedBuffer2 =
          hwParcel.readEmbeddedBuffer(int322 * 1, hwBlob.handle(), j3 + 0, true);
      this.data.clear();
  ...
  public abstract class Stub extends HwBinder implements ISoundTriggerHw {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList(
              "android.hardware.soundtrigger@2.0::ISoundTriggerHw", IBase.kInterfaceName));
    }
    ...
    public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) {
      switch (i) {
        case 1:
          ...
          getProperties(
              new getPropertiesCallback() { // from class:
                                            // android.hardware.soundtrigger.V2_0.ISoundTriggerHw.Stub.1
        ...
        case 2:
          ...
          loadSoundModel(
              ...
              hwParcel.readInt32(),
              new loadSoundModelCallback() { // from class:
                                             // android.hardware.soundtrigger.V2_0.ISoundTriggerHw.Stub.2
        ...
        case 3:
          ...
          loadPhraseSoundModel(
              ...
              ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()),
              hwParcel.readInt32(),
              new loadPhraseSoundModelCallback() { // from class:
                                                   // android.hardware.soundtrigger.V2_0.ISoundTriggerHw.Stub.3
