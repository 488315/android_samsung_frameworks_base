...
public interface ISoundTriggerHwCallback
    extends android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback {
  ...
  static ISoundTriggerHwCallback asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.soundtrigger@2.1::ISoundTriggerHwCallback");
    ...
    try {
      ...
      while (it.hasNext()) {
        if (((String) it.next())
            .equals("android.hardware.soundtrigger@2.1::ISoundTriggerHwCallback")) {
          return proxy;
        }
      }
  ...
  public final class RecognitionEvent {
    public ISoundTriggerHwCallback.RecognitionEvent header =
    ...
    public String toString() {
      try {
        ...
        return "[class or subclass of"
                   + " android.hardware.soundtrigger@2.1::ISoundTriggerHwCallback]@Proxy";
      }
    }
  ...
  public abstract class Stub extends HwBinder implements ISoundTriggerHwCallback {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList(
              "android.hardware.soundtrigger@2.1::ISoundTriggerHwCallback",
    ...
    public final ArrayList getHashChain() {
      return new ArrayList(
          Arrays.asList(
              new byte[] {
                -24, -56, 108, 105, -60, 56, -38, -115, 21, 73, -123, 108, 27, -77, -30, -47, -72,
                -38, 82, 114, 47, -126, 53, -1, 73, -93, 15, 44, -50, -111, 116, 44
              },
              new byte[] {
