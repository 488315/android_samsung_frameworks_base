...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_0.ISoundTriggerHw {
  ...
  void loadPhraseSoundModel_2_1(
      PhraseSoundModel phraseSoundModel,
      ISoundTriggerHwCallback iSoundTriggerHwCallback,
      int i,
      loadPhraseSoundModel_2_1Callback loadphrasesoundmodel_2_1callback);

  void loadSoundModel_2_1(
      SoundModel soundModel,
      ISoundTriggerHwCallback iSoundTriggerHwCallback,
      int i,
      loadSoundModel_2_1Callback loadsoundmodel_2_1callback);
  ...
  static ISoundTriggerHw asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.soundtrigger@2.1::ISoundTriggerHw");
  ...
  public final class SoundModel {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
      ...
      try {
        this.data =
            hwParcel.readEmbeddedHidlMemory(hwBlob.getFieldHandle(j2), hwBlob.handle(), j2).dup();
      } catch (IOException e) {
  ...
  public final class Proxy implements ISoundTriggerHw {
    ...
    public void loadSoundModel(
        ...
        android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback iSoundTriggerHwCallback,
        int i,
    ...
    public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) {
      switch (i) {
          ...
          getProperties(
              new ISoundTriggerHw
                  .getPropertiesCallback() { // from class:
                                             // android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.1
        ...
        case 2:
          ...
          loadSoundModel(
              soundModel,
              android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback.asInterface(
                  hwParcel.readStrongBinder()),
              hwParcel.readInt32(),
              new ISoundTriggerHw
                  .loadSoundModelCallback() { // from class:
                                              // android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.2
          ...
          loadPhraseSoundModel(
              ...
              new ISoundTriggerHw
                  .loadPhraseSoundModelCallback() { // from class:
                                                    // android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.3
        ...
        case 8:
          ...
          loadSoundModel_2_1(
              ...
              hwParcel.readInt32(),
              new loadSoundModel_2_1Callback() { // from class:
                                                 // android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.4
        ...
        case 9:
          ...
          loadPhraseSoundModel_2_1(
              ...
              ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()),
              hwParcel.readInt32(),
              new loadPhraseSoundModel_2_1Callback() { // from class:
                                                       // android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.5
