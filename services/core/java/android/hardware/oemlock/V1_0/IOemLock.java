...
public interface IOemLock extends IBase {
  ...
  void isOemUnlockAllowedByCarrier(
      isOemUnlockAllowedByCarrierCallback isoemunlockallowedbycarriercallback);

  void isOemUnlockAllowedByDevice(
      isOemUnlockAllowedByDeviceCallback isoemunlockallowedbydevicecallback);
  ...
  static IOemLock asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.oemlock@1.0::IOemLock");
  ...
  public final class Proxy implements IOemLock {
    ...
    @Override // android.hardware.oemlock.V1_0.IOemLock
    public void isOemUnlockAllowedByCarrier(
        isOemUnlockAllowedByCarrierCallback isoemunlockallowedbycarriercallback) {
      HwParcel hwParcel = new HwParcel();
      hwParcel.writeInterfaceToken("android.hardware.oemlock@1.0::IOemLock");
      HwParcel hwParcel2 = new HwParcel();
    ...
    @Override // android.hardware.oemlock.V1_0.IOemLock
    public void isOemUnlockAllowedByDevice(
        isOemUnlockAllowedByDeviceCallback isoemunlockallowedbydevicecallback) {
      HwParcel hwParcel = new HwParcel();
      hwParcel.writeInterfaceToken("android.hardware.oemlock@1.0::IOemLock");
      HwParcel hwParcel2 = new HwParcel();
  ...
  public abstract class Stub extends HwBinder implements IOemLock {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList("android.hardware.oemlock@1.0::IOemLock", IBase.kInterfaceName));
    }
    ...
    public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) {
      if (i == 1) {
        ...
        getName(
            new getNameCallback() { // from class: android.hardware.oemlock.V1_0.IOemLock.Stub.1
      ...
      if (i == 2) {
        ...
        int oemUnlockAllowedByCarrier =
            setOemUnlockAllowedByCarrier(hwParcel.readBool(), hwParcel.readInt8Vector());
        hwParcel2.writeStatus(0);
      ...
      if (i == 3) {
        ...
        isOemUnlockAllowedByCarrier(
            new isOemUnlockAllowedByCarrierCallback() { // from class:
                                                        // android.hardware.oemlock.V1_0.IOemLock.Stub.2
      ...
      if (i == 5) {
        ...
        isOemUnlockAllowedByDevice(
            new isOemUnlockAllowedByDeviceCallback() { // from class:
                                                       // android.hardware.oemlock.V1_0.IOemLock.Stub.3
