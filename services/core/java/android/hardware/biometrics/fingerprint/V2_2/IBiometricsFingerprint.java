...
public interface IBiometricsFingerprint
    extends android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint {
    ...
    public String toString() {
      try {
        ...
        return "[class or subclass of"
                   + " android.hardware.biometrics.fingerprint@2.2::IBiometricsFingerprint]@Proxy";
      }
    }
      ...
      switch (i) {
        case 1:
          ...
          long notify =
              setNotify(
                  android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback
                      .asInterface(hwParcel.readStrongBinder()));
