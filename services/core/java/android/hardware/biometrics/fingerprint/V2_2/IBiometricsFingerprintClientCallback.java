...
public interface IBiometricsFingerprintClientCallback
    extends android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback {
    ...
    public String toString() {
      try {
        ...
        return "[class or subclass of"
                   + " android.hardware.biometrics.fingerprint@2.2::IBiometricsFingerprintClientCallback]@Proxy";
      }
    }
  ...
  public abstract class Stub extends HwBinder implements IBiometricsFingerprintClientCallback {
    ...
    public final ArrayList getHashChain() {
      return new ArrayList(
          Arrays.asList(
              new byte[] {
                -126, -54, -39, -97, 95, -21, 46, -87, -68, -44, 87, -112, 85, -19, -12, -81, -113,
                -21, -97, -58, 2, -90, -28, -126, 125, -35, 114, 125, 37, 77, 73, -111
              },
              new byte[] {
                -86,
                -69,
