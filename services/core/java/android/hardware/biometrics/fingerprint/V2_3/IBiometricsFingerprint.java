...
public interface IBiometricsFingerprint
    extends android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint {
  ...
  static IBiometricsFingerprint asInterface(IHwBinder iHwBinder) {
    ...
    try {
      ...
      while (it.hasNext()) {
        if (((String) it.next())
            .equals("android.hardware.biometrics.fingerprint@2.3::IBiometricsFingerprint")) {
          return proxy;
        }
      }
    ...
    public String toString() {
      try {
        ...
        return "[class or subclass of"
                   + " android.hardware.biometrics.fingerprint@2.3::IBiometricsFingerprint]@Proxy";
      }
    }
    ...
    public final ArrayList getHashChain() {
      return new ArrayList(
          Arrays.asList(
              ...
              new byte[] {
                31, -67, -63, -8, 82, -8, -67, 46, 74, 108, 92, -77, 10, -62, -73, -122, 104, -55,
                -115, -50, 17, -118, 97, 118, 45, 64, 52, -82, -123, -97, 67, -40
              },
              new byte[] {
                -20,
                Byte.MAX_VALUE,
    ...
    public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) {
      switch (i) {
        case 1:
          ...
          long notify =
              setNotify(
                  IBiometricsFingerprintClientCallback.asInterface(hwParcel.readStrongBinder()));
