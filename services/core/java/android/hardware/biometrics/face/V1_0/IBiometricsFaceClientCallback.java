...
public interface IBiometricsFaceClientCallback extends IBase {
  ...
  static IBiometricsFaceClientCallback asInterface(IHwBinder iHwBinder) {
    ...
    if (queryLocalInterface != null
        && (queryLocalInterface instanceof IBiometricsFaceClientCallback)) {
    ...
    try {
      ...
      while (it.hasNext()) {
        if (((String) it.next())
            .equals("android.hardware.biometrics.face@1.0::IBiometricsFaceClientCallback")) {
          return proxy;
        }
      }
    ...
    public String toString() {
      try {
        ...
        return "[class or subclass of"
                   + " android.hardware.biometrics.face@1.0::IBiometricsFaceClientCallback]@Proxy";
      }
    }
