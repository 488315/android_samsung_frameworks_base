        ...
        default:
          switch (i) {
            ...
            case 4:
              ...
              NativeHandle nativeHandle =
                  (NativeHandle) parcel.readTypedObject(NativeHandle.CREATOR);
              parcel.enforceNoDataAvail();
              ICancellationSignal enroll =
                  enroll(hardwareAuthToken, readByte2, createByteArray, nativeHandle);
              parcel2.writeNoException();
            ...
            case 9:
              ...
              return true;
            case 10:
              HardwareAuthToken hardwareAuthToken2 =
                  (HardwareAuthToken) parcel.readTypedObject(HardwareAuthToken.CREATOR);
            ...
            case 12:
              ...
              return true;
            case 13:
              HardwareAuthToken hardwareAuthToken3 =
                  (HardwareAuthToken) parcel.readTypedObject(HardwareAuthToken.CREATOR);
              parcel.enforceNoDataAvail();
            ...
            case 15:
              ...
              OperationContext operationContext =
                  (OperationContext) parcel.readTypedObject(OperationContext.CREATOR);
              parcel.enforceNoDataAvail();
              ICancellationSignal authenticateWithContext =
                  authenticateWithContext(readLong3, operationContext);
              parcel2.writeNoException();
              parcel2.writeStrongInterface(authenticateWithContext);
              return true;
            case 16:
              HardwareAuthToken hardwareAuthToken4 =
                  (HardwareAuthToken) parcel.readTypedObject(HardwareAuthToken.CREATOR);
              byte readByte4 = parcel.readByte();
              byte[] createByteArray2 = parcel.createByteArray();
              NativeHandle nativeHandle2 =
                  (NativeHandle) parcel.readTypedObject(NativeHandle.CREATOR);
            ...
            case 17:
              ...
              ICancellationSignal detectInteractionWithContext =
                  detectInteractionWithContext(operationContext3);
              parcel2.writeNoException();
              parcel2.writeStrongInterface(detectInteractionWithContext);
              return true;
            case 18:
              OperationContext operationContext4 =
                  (OperationContext) parcel.readTypedObject(OperationContext.CREATOR);
              parcel.enforceNoDataAvail();
