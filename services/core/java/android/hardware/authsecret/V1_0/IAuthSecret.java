...
public interface IAuthSecret extends IBase {
  ...
  static IAuthSecret asInterface(IHwBinder iHwBinder) {
    ...
    IHwInterface queryLocalInterface =
        iHwBinder.queryLocalInterface("android.hardware.authsecret@1.0::IAuthSecret");
  ...
  public abstract class Stub extends HwBinder implements IAuthSecret {
    ...
    public final ArrayList interfaceChain() {
      return new ArrayList(
          Arrays.asList("android.hardware.authsecret@1.0::IAuthSecret", IBase.kInterfaceName));
    }
