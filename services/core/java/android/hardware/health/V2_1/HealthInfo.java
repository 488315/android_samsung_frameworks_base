...
public final class HealthInfo {
  public android.hardware.health.V2_0.HealthInfo legacy =
  ...
  public final boolean equals(Object obj) {
    ...
    return HidlSupport.deepEquals(this.legacy, healthInfo.legacy)
        && this.batteryCapacityLevel == healthInfo.batteryCapacityLevel
        && this.batteryChargeTimeToFullNowSeconds == healthInfo.batteryChargeTimeToFullNowSeconds
        && this.batteryFullChargeDesignCapacityUah == healthInfo.batteryFullChargeDesignCapacityUah;
  }

  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(this.legacy)),
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.batteryCapacityLevel))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Long.valueOf(this.batteryChargeTimeToFullNowSeconds))),
        Integer.valueOf(
            HidlSupport.deepHashCode(Integer.valueOf(this.batteryFullChargeDesignCapacityUah))));
  }
  ...
  public final String toString() {
    return "{.legacy = "
        ...
        + BatteryCapacityLevel.toString(this.batteryCapacityLevel)
        + ", .batteryChargeTimeToFullNowSeconds = "
        + this.batteryChargeTimeToFullNowSeconds
        + ", .batteryFullChargeDesignCapacityUah = "
        + this.batteryFullChargeDesignCapacityUah
        + "}";
  }
