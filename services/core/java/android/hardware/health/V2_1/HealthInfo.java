...
public final class HealthInfo {
    ...
    public final int hashCode() {
        return Objects.hash(
                ...
                AudioConfig$$ExternalSyntheticOutline0.m(this.batteryCapacityLevel),
                Integer.valueOf(
                        HidlSupport.deepHashCode(
                                Long.valueOf(this.batteryChargeTimeToFullNowSeconds))),
                AudioConfig$$ExternalSyntheticOutline0.m(this.batteryFullChargeDesignCapacityUah));
    }
    ...
    public final String toString() {
        ...
        return AmFmBandRange$$ExternalSyntheticOutline0.m(
                this.batteryFullChargeDesignCapacityUah, sb, "}");
    }
}
