...
public interface IHealth extends android.hardware.health.V2_0.IHealth {
  ...
  public final class Proxy implements IHealth {
    ...
    public int registerCallback(
        android.hardware.health.V2_0.IHealthInfoCallback iHealthInfoCallback) {
    ...
    public void getHealthInfo(IHealth.getHealthInfoCallback gethealthinfocallback) {
      ...
      try {
        ...
        android.hardware.health.V2_0.HealthInfo healthInfo =
            new android.hardware.health.V2_0.HealthInfo();
  ...
  public abstract class Stub extends HwBinder implements IHealth {
    ...
    public final ArrayList getHashChain() {
      return new ArrayList(
          Arrays.asList(
              new byte[] {
                -50, -115, -66, 118, -21, -98, -23, 75, 70, -17, -104, -9, 37, -66, -103, 46, 118,
                10, 87, 81, 7, 61, 79, 73, 18, 72, 64, 38, 84, 19, 113, -13
              },
              new byte[] {
                103,
                86,
      ...
      switch (i) {
        case 1:
          ...
          int registerCallback =
              registerCallback(
                  android.hardware.health.V2_0.IHealthInfoCallback.asInterface(
          ...
          getChargeCounter(
              new IHealth
                  .getChargeCounterCallback() { // from class:
                                                // android.hardware.health.V2_1.IHealth.Stub.1
          ...
          getCurrentNow(
              new IHealth
                  .getCurrentNowCallback() { // from class:
                                             // android.hardware.health.V2_1.IHealth.Stub.2
          ...
          getCurrentAverage(
              new IHealth
                  .getCurrentAverageCallback() { // from class:
                                                 // android.hardware.health.V2_1.IHealth.Stub.3
          ...
          getCapacity(
              new IHealth
                  .getCapacityCallback() { // from class:
                                           // android.hardware.health.V2_1.IHealth.Stub.4
          ...
          getEnergyCounter(
              new IHealth
                  .getEnergyCounterCallback() { // from class:
                                                // android.hardware.health.V2_1.IHealth.Stub.5
          ...
          getChargeStatus(
              new IHealth
                  .getChargeStatusCallback() { // from class:
                                               // android.hardware.health.V2_1.IHealth.Stub.6
        ...
        case 10:
          ...
          getStorageInfo(
              new IHealth
                  .getStorageInfoCallback() { // from class:
                                              // android.hardware.health.V2_1.IHealth.Stub.7
              });
          return;
        case 11:
          hwParcel.enforceInterface("android.hardware.health@2.0::IHealth");
          getDiskStats(
              new IHealth
                  .getDiskStatsCallback() { // from class:
                                            // android.hardware.health.V2_1.IHealth.Stub.8
              });
          return;
        case 12:
          hwParcel.enforceInterface("android.hardware.health@2.0::IHealth");
          getHealthInfo(
              new IHealth
                  .getHealthInfoCallback() { // from class:
                                             // android.hardware.health.V2_1.IHealth.Stub.9
        ...
        case 13:
          ...
          getHealthConfig(
              new getHealthConfigCallback() { // from class:
                                              // android.hardware.health.V2_1.IHealth.Stub.10
              });
          return;
        case 14:
          hwParcel.enforceInterface("android.hardware.health@2.1::IHealth");
          getHealthInfo_2_1(
              new getHealthInfo_2_1Callback() { // from class:
                                                // android.hardware.health.V2_1.IHealth.Stub.11
              });
          return;
        case 15:
          hwParcel.enforceInterface("android.hardware.health@2.1::IHealth");
          shouldKeepScreenOn(
              new shouldKeepScreenOnCallback() { // from class:
                                                 // android.hardware.health.V2_1.IHealth.Stub.12
              });
          return;
        default:
          switch (i) {
