...
public abstract class Translate {
  ...
  public static HealthInfo h2aTranslate(android.hardware.health.V2_1.HealthInfo healthInfo) {
    ...
    for (int i = 0; i < healthInfo.legacy.diskStats.size(); i++) {
      healthInfo2.diskStats[i] =
          h2aTranslate((android.hardware.health.V2_0.DiskStats) healthInfo.legacy.diskStats.get(i));
    }
    ...
    for (int i2 = 0; i2 < healthInfo.legacy.storageInfos.size(); i2++) {
      healthInfo2.storageInfos[i2] =
          h2aTranslate(
              (android.hardware.health.V2_0.StorageInfo) healthInfo.legacy.storageInfos.get(i2));
    }
