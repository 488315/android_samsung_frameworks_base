...
public class HealthInfo implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.hardware.health.HealthInfo.1
                                      ...
                                      if (parcel.dataPosition() - dataPosition < readInt) {
                                        ...
                                        if (parcel.dataPosition() - dataPosition < readInt) {
                                          ...
                                          if (parcel.dataPosition() - dataPosition < readInt) {
                                            this.diskStats =
                                                (DiskStats[])
                                                    parcel.createTypedArray(DiskStats.CREATOR);
                                            if (parcel.dataPosition() - dataPosition < readInt) {
                                              this.storageInfos =
                                                  (StorageInfo[])
                                                      parcel.createTypedArray(StorageInfo.CREATOR);
                                              if (parcel.dataPosition() - dataPosition < readInt) {
