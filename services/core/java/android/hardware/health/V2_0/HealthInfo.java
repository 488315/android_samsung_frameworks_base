...
public final class HealthInfo {
  ...
  public final int hashCode() {
    return Objects.hash(
        ...
        Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.batteryCurrentAverage))),
  ...
  public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
    ...
    HwBlob readEmbeddedBuffer =
        hwParcel.readEmbeddedBuffer(int32 * 112, hwBlob.handle(), j2 + 0, true);
    ...
    HwBlob readEmbeddedBuffer2 =
        hwParcel.readEmbeddedBuffer(int322 * 48, hwBlob.handle(), j3 + 0, true);
