...
public final class StorageInfo {
  ...
  public final boolean equals(Object obj) {
    ...
    return HidlSupport.deepEquals(this.attr, storageInfo.attr)
        && this.eol == storageInfo.eol
        && this.lifetimeA == storageInfo.lifetimeA
        && this.lifetimeB == storageInfo.lifetimeB
        && HidlSupport.deepEquals(this.version, storageInfo.version);
  }

  public final int hashCode() {
    return Objects.hash(
        Integer.valueOf(HidlSupport.deepHashCode(this.attr)),
        Integer.valueOf(HidlSupport.deepHashCode(Short.valueOf(this.eol))),
        Integer.valueOf(HidlSupport.deepHashCode(Short.valueOf(this.lifetimeA))),
        Integer.valueOf(HidlSupport.deepHashCode(Short.valueOf(this.lifetimeB))),
