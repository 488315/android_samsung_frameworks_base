...
public class IPv6ProvisioningLossQuirkParcelable implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable
          .Creator() { // from class:
                       // android.net.networkstack.aidl.quirks.IPv6ProvisioningLossQuirkParcelable.1
  ...
  public String toString() {
    ...
    return "android.net.networkstack.aidl.quirks.IPv6ProvisioningLossQuirkParcelable"
