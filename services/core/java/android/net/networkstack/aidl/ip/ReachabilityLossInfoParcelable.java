...
public class ReachabilityLossInfoParcelable implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable
          .Creator() { // from class:
                       // android.net.networkstack.aidl.ip.ReachabilityLossInfoParcelable.1
  ...
  public String toString() {
    ...
    return "android.net.networkstack.aidl.ip.ReachabilityLossInfoParcelable"
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.deepEquals(this.message, reachabilityLossInfoParcelable.message)
        && Objects.deepEquals(
            Integer.valueOf(this.reason), Integer.valueOf(reachabilityLossInfoParcelable.reason));
  }
