...
public class NetworkMonitorParameters implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable
          .Creator() { // from class: android.net.networkstack.aidl.NetworkMonitorParameters.1
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.deepEquals(this.networkAgentConfig, networkMonitorParameters.networkAgentConfig)
        && Objects.deepEquals(
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(this.networkAgentConfig, this.networkCapabilities, this.linkProperties)
            .toArray());
  }
