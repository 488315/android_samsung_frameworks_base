...
public final /* synthetic */ class NetworkStackClientBase$$ExternalSyntheticLambda0
        implements Consumer {
    ...
    public /* synthetic */ NetworkStackClientBase$$ExternalSyntheticLambda0(
        ...
        switch (this.$r8$classId) {
            case 0:
                NetworkStackClientBase.lambda$makeDhcpServer$0(
                        this.f$0,
                        (DhcpServingParamsParcel) this.f$1,
                        (IDhcpServerCallbacks) this.f$2,
                        (INetworkStackConnector) obj);
                break;
            default:
