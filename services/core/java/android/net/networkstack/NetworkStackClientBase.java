...
public abstract class NetworkStackClientBase {
  ...
  public void makeDhcpServer(
      final String str,
      final DhcpServingParamsParcel dhcpServingParamsParcel,
      final IDhcpServerCallbacks iDhcpServerCallbacks) {
    requestConnector(
        new Consumer() { // from class:
                         // android.net.networkstack.NetworkStackClientBase$$ExternalSyntheticLambda3
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            NetworkStackClientBase.lambda$makeDhcpServer$0(
                str, dhcpServingParamsParcel, iDhcpServerCallbacks, (INetworkStackConnector) obj);
          }
        });
  }
  ...
  public void makeIpClient(final String str, final IIpClientCallbacks iIpClientCallbacks) {
    requestConnector(
        new Consumer() { // from class:
                         // android.net.networkstack.NetworkStackClientBase$$ExternalSyntheticLambda2
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            NetworkStackClientBase.lambda$makeIpClient$1(
                str, iIpClientCallbacks, (INetworkStackConnector) obj);
          }
        });
  }
  ...
  public void makeNetworkMonitor(
      ...
      final String str,
      final INetworkMonitorCallbacks iNetworkMonitorCallbacks) {
    requestConnector(
        new Consumer() { // from class:
                         // android.net.networkstack.NetworkStackClientBase$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            NetworkStackClientBase.lambda$makeNetworkMonitor$2(
                network, str, iNetworkMonitorCallbacks, (INetworkStackConnector) obj);
          }
        });
  }
  ...
  public void fetchIpMemoryStore(final IIpMemoryStoreCallbacks iIpMemoryStoreCallbacks) {
    requestConnector(
        new Consumer() { // from class:
                         // android.net.networkstack.NetworkStackClientBase$$ExternalSyntheticLambda0
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            NetworkStackClientBase.lambda$fetchIpMemoryStore$3(
                IIpMemoryStoreCallbacks.this, (INetworkStackConnector) obj);
          }
        });
  }
