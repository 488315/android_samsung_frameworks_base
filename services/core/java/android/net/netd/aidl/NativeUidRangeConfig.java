...
public class NativeUidRangeConfig implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.net.netd.aidl.NativeUidRangeConfig.1
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.deepEquals(
        ...
        && Objects.deepEquals(
            Integer.valueOf(this.subPriority), Integer.valueOf(nativeUidRangeConfig.subPriority));
  }
  ...
  public int hashCode() {
    return Arrays.deepHashCode(
        Arrays.asList(
                Integer.valueOf(this.netId), this.uidRanges, Integer.valueOf(this.subPriority))
            .toArray());
  }
