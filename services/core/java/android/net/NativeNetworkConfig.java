...
public class NativeNetworkConfig implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.net.NativeNetworkConfig.1
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.deepEquals(
        ...
        && Objects.deepEquals(
            Integer.valueOf(this.networkType), Integer.valueOf(nativeNetworkConfig.networkType))
        && Objects.deepEquals(
            Integer.valueOf(this.permission), Integer.valueOf(nativeNetworkConfig.permission))
        && Objects.deepEquals(
