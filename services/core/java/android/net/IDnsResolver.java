          ...
          switch (i) {
            ...
            case 3:
              setResolverConfiguration(
                  (ResolverParamsParcel) parcel.readTypedObject(ResolverParamsParcel.CREATOR));
              parcel2.writeNoException();
              return true;
            case 4:
            ...
            case 13:
              registerUnsolicitedEventListener(
                  IDnsResolverUnsolicitedEventListener.Stub.asInterface(parcel.readStrongBinder()));
              parcel2.writeNoException();
              return true;
            case 14:
              setResolverOptions(
                  parcel.readInt(),
                  (ResolverOptionsParcel) parcel.readTypedObject(ResolverOptionsParcel.CREATOR));
              parcel2.writeNoException();
              return true;
            default:
