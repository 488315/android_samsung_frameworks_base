...
public class UidRangeParcel implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.net.UidRangeParcel.1
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.deepEquals(Integer.valueOf(this.start), Integer.valueOf(uidRangeParcel.start))
        && Objects.deepEquals(Integer.valueOf(this.stop), Integer.valueOf(uidRangeParcel.stop));
  }
