...
public class ProvisioningConfiguration {
    ...
    public class InformationElement {
      ...
      public static InformationElement fromStableParcelable(
        ...
        return new InformationElement(
            informationElementParcelable.f14id,
          ...
          (InformationElementParcelable[])
              ParcelableUtil.toParcelableArray(
                  ...
                  new Function() { // from class:
                                   // android.net.shared.ProvisioningConfiguration$ScanResultInfo$$ExternalSyntheticLambda0
    ...
    public static ScanResultInfo fromStableParcelable(
      ...
      arrayList.addAll(
          ParcelableUtil.fromParcelableArray(
              scanResultInfoParcelable.informationElements,
              new Function() { // from class:
                               // android.net.shared.ProvisioningConfiguration$ScanResultInfo$$ExternalSyntheticLambda1
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
    ...
    public static byte[] convertToByteArray(ByteBuffer byteBuffer) {
      ...
      try {
        try {
          ...
          Log.wtf(
              ProvisioningConfiguration.TAG, "Buffer under flow exception should never happen.");
          return bArr;
        }
  ...
  public ProvisioningConfigurationParcelable toStableParcelable() {
    ...
    provisioningConfigurationParcelable.staticIpConfig =
        this.mStaticIpConfig == null ? null : new StaticIpConfiguration(this.mStaticIpConfig);
  ...
  public static ProvisioningConfiguration fromStableParcelable(
    ...
    provisioningConfiguration.mStaticIpConfig =
        provisioningConfigurationParcelable.staticIpConfig == null
            ? null
            : new StaticIpConfiguration(provisioningConfigurationParcelable.staticIpConfig);
    ...
    provisioningConfiguration.mScanResultInfo =
        ScanResultInfo.fromStableParcelable(provisioningConfigurationParcelable.scanResultInfo);
    provisioningConfiguration.mLayer2Info =
        Layer2Information.fromStableParcelable(provisioningConfigurationParcelable.layer2Info);
