...
public class UidStatsParcel implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.net.UidStatsParcel.1
                                                ...
                                                if (parcel.dataPosition() - dataPosition
                                                  ...
                                                  if (parcel.dataPosition() - dataPosition
                                                    ...
                                                    if (parcel.dataPosition() - dataPosition
                                                      ...
                                                      if (parcel.dataPosition() - dataPosition
                                                          < readInt) {
                                                        this.maxTxInterPacketTime =
                                                            parcel.readLong();
                                                        if (parcel.dataPosition() - dataPosition
                                                            < readInt) {
                                                          this.minTxInterPacketTime =
                                                              parcel.readLong();
                                                          if (parcel.dataPosition() - dataPosition
                                                              < readInt) {
                                                            ...
                                                            if (parcel.dataPosition() - dataPosition
                                                                < readInt) {
                                                              this.maxRxPacketSize =
                                                                  parcel.readInt();
                                                              if (parcel.dataPosition()
                                                                      - dataPosition
                                                                  < readInt) {
                                                                this.minRxPacketSize =
                                                                    parcel.readInt();
                                                                if (parcel.dataPosition()
                                                                        - dataPosition
                                                                    < readInt) {
                                                                  this.maxRxInterPacketTime2 =
                                                                      parcel.readLong();
                                                                  if (parcel.dataPosition()
                                                                          - dataPosition
                                                                      < readInt) {
                                                                    this.maxRxInterPacketTime =
                                                                        parcel.readLong();
                                                                    if (parcel.dataPosition()
                                                                            - dataPosition
                                                                        < readInt) {
