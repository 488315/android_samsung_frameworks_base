...
public interface INetd extends IInterface {
  ...
  void ipSecApplyTransportModeTransform(
      ParcelFileDescriptor parcelFileDescriptor, int i, int i2, String str, String str2, int i3);
          ...
          switch (i) {
            ...
            case 2:
              boolean firewallReplaceUidChain =
                  firewallReplaceUidChain(
                      parcel.readString(), parcel.readBoolean(), parcel.createIntArray());
              parcel2.writeNoException();
            ...
            case 90:
              registerUnsolicitedEventListener(
                  INetdUnsolicitedEventListener.Stub.asInterface(parcel.readStrongBinder()));
              parcel2.writeNoException();
              return true;
            case 91:
            ...
            case 95:
              tetherStartWithConfiguration(
                  (TetherConfigParcel) parcel.readTypedObject(TetherConfigParcel.CREATOR));
              parcel2.writeNoException();
              return true;
            case 96:
            ...
            case 105:
              networkCreate(
                  (NativeNetworkConfig) parcel.readTypedObject(NativeNetworkConfig.CREATOR));
              parcel2.writeNoException();
              return true;
            case 106:
              networkAddUidRangesParcel(
                  (NativeUidRangeConfig) parcel.readTypedObject(NativeUidRangeConfig.CREATOR));
              parcel2.writeNoException();
              return true;
            case 107:
            ...
            case 108:
              ipSecMigrate(
                  (IpSecMigrateInfoParcel) parcel.readTypedObject(IpSecMigrateInfoParcel.CREATOR));
              parcel2.writeNoException();
              return true;
            case 109:
              setNetworkAllowlist(
                  (NativeUidRangeConfig[]) parcel.createTypedArray(NativeUidRangeConfig.CREATOR));
              parcel2.writeNoException();
              return true;
            default:
