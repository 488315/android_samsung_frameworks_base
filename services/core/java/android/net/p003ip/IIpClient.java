            ...
            case 5:
              startProvisioning(
                  (ProvisioningConfigurationParcelable)
                      parcel.readTypedObject(ProvisioningConfigurationParcelable.CREATOR));
              return true;
            case 6:
              stop();
              return true;
            ...
            case 10:
              addKeepalivePacketFilter(
                  ...
                  (TcpKeepalivePacketDataParcelable)
                      parcel.readTypedObject(TcpKeepalivePacketDataParcelable.CREATOR));
              return true;
            case 11:
            ...
            case 13:
              addNattKeepalivePacketFilter(
                  ...
                  (NattKeepalivePacketDataParcelable)
                      parcel.readTypedObject(NattKeepalivePacketDataParcelable.CREATOR));
              return true;
            case 14:
