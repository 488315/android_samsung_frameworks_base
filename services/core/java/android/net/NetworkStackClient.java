...
public class NetworkStackClient {
        ...
        new NetworkStackCallback() { // from class:
          ...
          public final void onNetworkStackConnected(INetworkStackConnector iNetworkStackConnector) {
            NetworkStackClient.lambda$makeDhcpServer$0(
                str, dhcpServingParamsParcel, iDhcpServerCallbacks, iNetworkStackConnector);
          }
        });
  }
  ...
  public void makeIpClient(final String str, final IIpClientCallbacks iIpClientCallbacks) {
    requestConnector(
        new NetworkStackCallback() { // from class:
                                     // android.net.NetworkStackClient$$ExternalSyntheticLambda1
          @Override // android.net.NetworkStackClient.NetworkStackCallback
          public final void onNetworkStackConnected(INetworkStackConnector iNetworkStackConnector) {
        ...
        new NetworkStackCallback() { // from class:
          ...
          public final void onNetworkStackConnected(INetworkStackConnector iNetworkStackConnector) {
            NetworkStackClient.lambda$makeNetworkMonitor$2(
                network, str, iNetworkMonitorCallbacks, iNetworkStackConnector);
          }
        });
  }
  ...
  public void fetchIpMemoryStore(final IIpMemoryStoreCallbacks iIpMemoryStoreCallbacks) {
    requestConnector(
        new NetworkStackCallback() { // from class:
                                     // android.net.NetworkStackClient$$ExternalSyntheticLambda3
          @Override // android.net.NetworkStackClient.NetworkStackCallback
          public final void onNetworkStackConnected(INetworkStackConnector iNetworkStackConnector) {
