...
public class NetworkAttributesParcelable implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable
          .Creator() { // from class: android.net.ipmemorystore.NetworkAttributesParcelable.1
                ...
                if (parcel.dataPosition() - dataPosition < readInt) {
                  this.ipv6ProvisioningLossQuirk =
                      (IPv6ProvisioningLossQuirkParcelable)
                          parcel.readTypedObject(IPv6ProvisioningLossQuirkParcelable.CREATOR);
  ...
  public String toString() {
    ...
    stringJoiner.add(
        "ipv6ProvisioningLossQuirk: " + Objects.toString(this.ipv6ProvisioningLossQuirk));
