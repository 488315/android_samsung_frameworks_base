...
public class NetworkAttributes {
  ...
  */
  ...
  public NetworkAttributesParcelable toParcelable() {
    ...
    networkAttributesParcelable.ipv6ProvisioningLossQuirk =
        iPv6ProvisioningLossQuirk != null ? iPv6ProvisioningLossQuirk.toStableParcelable() : null;
  ...
  public float getNetworkGroupSamenessConfidence(NetworkAttributes networkAttributes) {
    float samenessContribution =
        samenessContribution(300.0f, this.assignedV4Address, networkAttributes.assignedV4Address)
            + samenessContribution(
                0.0f, this.assignedV4AddressExpiry, networkAttributes.assignedV4AddressExpiry)
            + samenessContribution(300.0f, this.cluster, networkAttributes.cluster)
            + samenessContribution(
                WEIGHT_DNSADDRESSES, this.dnsAddresses, networkAttributes.dnsAddresses)
            + samenessContribution(WEIGHT_MTU, this.mtu, networkAttributes.mtu)
            + samenessContribution(
                0.0f, this.ipv6ProvisioningLossQuirk, networkAttributes.ipv6ProvisioningLossQuirk);
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.assignedV4Address, networkAttributes.assignedV4Address)
        && Objects.equals(this.assignedV4AddressExpiry, networkAttributes.assignedV4AddressExpiry)
        ...
        && Objects.equals(
            this.ipv6ProvisioningLossQuirk, networkAttributes.ipv6ProvisioningLossQuirk);
  }
