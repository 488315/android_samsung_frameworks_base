...
public interface IOnBlobRetrievedListener extends IInterface {
    public static final String DESCRIPTOR =
            "android$net$ipmemorystore$IOnBlobRetrievedListener".replace('$', '.');
    ...
    public class Default implements IOnBlobRetrievedListener {
        ...
        public void onBlobRetrieved(
                StatusParcelable statusParcelable, String str, String str2, Blob blob)
    ...
    public abstract class Stub extends Binder implements IOnBlobRetrievedListener {
        ...
        public final class Proxy implements IOnBlobRetrievedListener {
            ...
            @Override // android.net.ipmemorystore.IOnBlobRetrievedListener
            public final void onBlobRetrieved(
                    StatusParcelable statusParcelable, String str, String str2, Blob blob) {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(IOnBlobRetrievedListener.DESCRIPTOR);
        ...
        public static IOnBlobRetrievedListener asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface =
                    iBinder.queryLocalInterface(IOnBlobRetrievedListener.DESCRIPTOR);
            if (queryLocalInterface != null
                    && (queryLocalInterface instanceof IOnBlobRetrievedListener)) {
