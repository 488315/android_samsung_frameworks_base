...
public interface OnSameL3NetworkResponseListener {
    static IOnSameL3NetworkResponseListener toAIDL(
        ...
        return new IOnSameL3NetworkResponseListener
                .Stub() { // from class: android.net.ipmemorystore.OnSameL3NetworkResponseListener.1
            ...
            public final void onSameL3NetworkResponse(
                ...
                OnSameL3NetworkResponseListener onSameL3NetworkResponseListener2 =
                        OnSameL3NetworkResponseListener.this;
                if (onSameL3NetworkResponseListener2 != null) {
                    onSameL3NetworkResponseListener2.onSameL3NetworkResponse(
