...
public interface IIpMemoryStore extends IInterface {
    ...
    public class Default implements IIpMemoryStore {
        ...
        public void delete(
                String str, boolean z, IOnStatusAndCountListener iOnStatusAndCountListener)
        ...
        public void findL2Key(
                ...
                IOnL2KeyResponseListener iOnL2KeyResponseListener)
                throws RemoteException {}
        ...
        public void isSameNetwork(
                String str,
                String str2,
                IOnSameL3NetworkResponseListener iOnSameL3NetworkResponseListener)
                throws RemoteException {}
        ...
        public void retrieveBlob(
                ...
                String str2,
                String str3,
                IOnBlobRetrievedListener iOnBlobRetrievedListener)
                throws RemoteException {}

        @Override // android.net.IIpMemoryStore
        public void retrieveNetworkAttributes(
                String str,
                IOnNetworkAttributesRetrievedListener iOnNetworkAttributesRetrievedListener)
                throws RemoteException {}
        ...
        public void storeBlob(
                ...
                String str3,
                Blob blob,
                IOnStatusListener iOnStatusListener)
                throws RemoteException {}
    ...
    public abstract class Stub extends Binder implements IIpMemoryStore {
        ...
        public final class Proxy implements IIpMemoryStore {
            ...
            @Override // android.net.IIpMemoryStore
            public final void deleteCluster(
                    String str, boolean z, IOnStatusAndCountListener iOnStatusAndCountListener) {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(IIpMemoryStore.DESCRIPTOR);
            ...
            @Override // android.net.IIpMemoryStore
            public final void isSameNetwork(
                    String str,
                    String str2,
                    IOnSameL3NetworkResponseListener iOnSameL3NetworkResponseListener) {
                Parcel obtain = Parcel.obtain();
            ...
            @Override // android.net.IIpMemoryStore
            public final void retrieveBlob(
                    String str,
                    String str2,
                    String str3,
                    IOnBlobRetrievedListener iOnBlobRetrievedListener) {
            ...
            @Override // android.net.IIpMemoryStore
            public final void retrieveNetworkAttributes(
                    String str,
                    IOnNetworkAttributesRetrievedListener iOnNetworkAttributesRetrievedListener) {
                Parcel obtain = Parcel.obtain();
                try {
                    ...
                    if (this.mRemote.transact(5, obtain, null, 1)) {
                        ...
                        throw new RemoteException(
                                "Method retrieveNetworkAttributes is unimplemented.");
                    }
                } finally {
                    obtain.recycle();
                }
            ...
            @Override // android.net.IIpMemoryStore
            public final void storeNetworkAttributes(
                    String str,
                    NetworkAttributesParcelable networkAttributesParcelable,
                    IOnStatusListener iOnStatusListener) {
                Parcel obtain = Parcel.obtain();
                try {
                    ...
                    if (this.mRemote.transact(1, obtain, null, 1)) {
                        ...
                        throw new RemoteException(
                                "Method storeNetworkAttributes is unimplemented.");
                    }
                } finally {
                    obtain.recycle();
                }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2)
            ...
            switch (i) {
                case 1:
                    storeNetworkAttributes(
                            parcel.readString(),
                            (NetworkAttributesParcelable)
                                    parcel.readTypedObject(NetworkAttributesParcelable.CREATOR),
                            IOnStatusListener.Stub.asInterface(parcel.readStrongBinder()));
                    return true;
                case 2:
                    storeBlob(
                            parcel.readString(),
                            parcel.readString(),
                            parcel.readString(),
                            (Blob) parcel.readTypedObject(Blob.CREATOR),
                            IOnStatusListener.Stub.asInterface(parcel.readStrongBinder()));
                    return true;
                case 3:
                    findL2Key(
                            (NetworkAttributesParcelable)
                                    parcel.readTypedObject(NetworkAttributesParcelable.CREATOR),
                            IOnL2KeyResponseListener.Stub.asInterface(parcel.readStrongBinder()));
                    return true;
                case 4:
                    isSameNetwork(
                            parcel.readString(),
                            parcel.readString(),
                            IOnSameL3NetworkResponseListener.Stub.asInterface(
                                    parcel.readStrongBinder()));
                    return true;
                case 5:
                    retrieveNetworkAttributes(
                            parcel.readString(),
                            IOnNetworkAttributesRetrievedListener.Stub.asInterface(
                                    parcel.readStrongBinder()));
                    return true;
                case 6:
                    retrieveBlob(
                            ...
                            parcel.readString(),
                            parcel.readString(),
                            IOnBlobRetrievedListener.Stub.asInterface(parcel.readStrongBinder()));
                    return true;
                case 7:
                    factoryReset();
                    return true;
                case 8:
                    delete(
                            parcel.readString(),
                            parcel.readBoolean(),
                            IOnStatusAndCountListener.Stub.asInterface(parcel.readStrongBinder()));
                    return true;
                case 9:
                    deleteCluster(
                            parcel.readString(),
    ...
    void retrieveBlob(
            String str, String str2, String str3, IOnBlobRetrievedListener iOnBlobRetrievedListener)
            throws RemoteException;

    void retrieveNetworkAttributes(
            String str, IOnNetworkAttributesRetrievedListener iOnNetworkAttributesRetrievedListener)
            throws RemoteException;

    void storeBlob(
            String str, String str2, String str3, Blob blob, IOnStatusListener iOnStatusListener)
            throws RemoteException;

    void storeNetworkAttributes(
            String str,
            NetworkAttributesParcelable networkAttributesParcelable,
            IOnStatusListener iOnStatusListener)
            throws RemoteException;
