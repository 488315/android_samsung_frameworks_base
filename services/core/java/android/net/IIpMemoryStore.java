...
public interface IIpMemoryStore extends IInterface {
  ...
  void isSameNetwork(
      String str, String str2, IOnSameL3NetworkResponseListener iOnSameL3NetworkResponseListener);
          ...
          switch (i) {
            ...
            case 4:
              isSameNetwork(
                  parcel.readString(),
                  parcel.readString(),
                  IOnSameL3NetworkResponseListener.Stub.asInterface(parcel.readStrongBinder()));
              return true;
            case 5:
