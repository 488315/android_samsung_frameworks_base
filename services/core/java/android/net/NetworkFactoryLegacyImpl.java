...
public class NetworkFactoryLegacyImpl extends Handler implements NetworkFactoryShim {
  ...
  public void register(String str) {
    ...
    this.mProvider =
        new NetworkProvider(
            this.mContext, getLooper(), str) { // from class: android.net.NetworkFactoryLegacyImpl.1
  ...
  public void terminate() {
    ...
    ((ConnectivityManager) this.mContext.getSystemService("connectivity"))
        .unregisterNetworkProvider(this.mProvider);
  ...
  public void handleAddRequest(NetworkRequest networkRequest, int i, int i2) {
    NetworkRequestInfo networkRequestInfo =
        (NetworkRequestInfo) this.mNetworkRequests.get(networkRequest);
  ...
  public final boolean shouldNeedNetworkFor(NetworkRequestInfo networkRequestInfo) {
    return !networkRequestInfo.requested
        ...
        && acceptRequest(networkRequestInfo.request);
  }
  ...
  public void releaseRequestAsUnfulfillableByAnyFactory(final NetworkRequest networkRequest) {
    post(
        new Runnable() { // from class:
          ...
          @Override // java.lang.Runnable
          public final void run() {
            NetworkFactoryLegacyImpl.this.lambda$releaseRequestAsUnfulfillableByAnyFactory$0(
                networkRequest);
          }
        });
  }
  ...
  public /* synthetic */ void lambda$releaseRequestAsUnfulfillableByAnyFactory$0(
