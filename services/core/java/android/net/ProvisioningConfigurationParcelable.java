...
public class ProvisioningConfigurationParcelable implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: android.net.ProvisioningConfigurationParcelable.1
                ...
                if (parcel.dataPosition() - dataPosition < readInt) {
                  this.initialConfig =
                      (InitialConfigurationParcelable)
                          parcel.readTypedObject(InitialConfigurationParcelable.CREATOR);
                  if (parcel.dataPosition() - dataPosition < readInt) {
                    this.staticIpConfig =
                                ...
                                if (parcel.dataPosition() - dataPosition < readInt) {
                                  this.scanResultInfo =
                                      (ScanResultInfoParcelable)
                                          parcel.readTypedObject(ScanResultInfoParcelable.CREATOR);
                                  if (parcel.dataPosition() - dataPosition < readInt) {
                                    this.layer2Info =
                                        (Layer2InformationParcelable)
                                            parcel.readTypedObject(
                                                Layer2InformationParcelable.CREATOR);
                                    if (parcel.dataPosition() - dataPosition < readInt) {
                                      this.options =
                                          parcel.createTypedArrayList(DhcpOption.CREATOR);
                                      if (parcel.dataPosition() - dataPosition < readInt) {
