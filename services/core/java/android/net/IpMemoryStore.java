...
public class IpMemoryStore extends IpMemoryStoreClient {
  ...
  public IpMemoryStore(Context context) {
    ...
    getModuleNetworkStackClient(context)
        .fetchIpMemoryStore(
            new IIpMemoryStoreCallbacks.Stub() { // from class: android.net.IpMemoryStore.1
  ...
  public static /* synthetic */ CompletableFuture lambda$runWhenServiceReady$1(
    ...
    return completableFuture.handle(
        new BiFunction() { // from class: android.net.IpMemoryStore$$ExternalSyntheticLambda0
  ...
  public void runWhenServiceReady(final Consumer consumer) {
    this.mTailNode.getAndUpdate(
        new UnaryOperator() { // from class: android.net.IpMemoryStore$$ExternalSyntheticLambda1
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            CompletableFuture lambda$runWhenServiceReady$1;
            lambda$runWhenServiceReady$1 =
                IpMemoryStore.lambda$runWhenServiceReady$1(consumer, (CompletableFuture) obj);
