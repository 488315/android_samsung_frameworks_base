...
public class NetworkFactoryImpl extends NetworkFactoryLegacyImpl {
  ...
  public NetworkFactoryImpl(
    ...
    this.mRequestCallback =
        new NetworkProvider.NetworkOfferCallback() { // from class: android.net.NetworkFactoryImpl.1
    ...
    this.mExecutor =
        new Executor() { // from class: android.net.NetworkFactoryImpl$$ExternalSyntheticLambda0
  ...
  public final void register(String str, boolean z) {
    ...
    this.mProvider =
        new NetworkProvider(
            this.mContext, getLooper(), str) { // from class: android.net.NetworkFactoryImpl.2
  ...
  public final void handleOfferNetwork(NetworkScore networkScore) {
    this.mProvider.registerNetworkOffer(
        networkScore, this.mCapabilityFilter, this.mExecutor, this.mRequestCallback);
  }
