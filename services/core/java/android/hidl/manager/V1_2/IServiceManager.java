...
public interface IServiceManager extends android.hidl.manager.V1_1.IServiceManager {
  ...
  @Override // android.hidl.manager.V1_1.IServiceManager, android.hidl.manager.V1_0.IServiceManager,
  ...
  public abstract class Stub extends HwBinder implements IServiceManager {
    ...
    public final ArrayList getHashChain() {
      return new ArrayList(
          Arrays.asList(
              new byte[] {
                111, 58, -118, 63, -44, -65, -67, 2, -28, -26, 28, 115, 45, 45, -10, 22, -1, 105,
                67, 74, 30, -40, 60, -38, 51, 115, 3, -83, -58, -41, 20, -33
              },
              new byte[] {
              ...
              new byte[] {
                -123, 57, 79, -118, 13, 21, -25, -5, 46, -28, 92, 82, -47, -5, -117, -113, -45, -63,
                60, 51, 62, 99, -57, -116, 74, -95, -1, -122, -124, 12, -10, -36
              },
              new byte[] {
                -20,
                Byte.MAX_VALUE,
