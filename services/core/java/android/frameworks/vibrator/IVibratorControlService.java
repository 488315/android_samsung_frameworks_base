...
public interface IVibratorControlService extends IInterface {
    ...
    public abstract class Stub extends Binder implements IVibratorControlService {
        ...
        public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            if (i == 1) {
                IVibratorController asInterface =
                        IVibratorController.Stub.asInterface(parcel.readStrongBinder());
                ...
                synchronized (vibratorControlService.mLock) {
                    vibratorControlService.mVibratorControllerHolder.setVibratorController(
                            asInterface);
                }
            } else if (i == 2) {
                IVibratorController asInterface2 =
                        IVibratorController.Stub.asInterface(parcel.readStrongBinder());
                parcel.enforceNoDataAvail();
                ...
                synchronized (vibratorControlService2.mLock) {
                    try {
                        IVibratorController iVibratorController =
                                vibratorControlService2
                                        .mVibratorControllerHolder
                                        .mVibratorController;
                        if (iVibratorController == null) {
                            Slog.w(
                                    "VibratorControlService",
                                    "Received request to unregister IVibratorController = "
                                            + asInterface2
                                            + ", but no controller was previously registered."
                                            + " Request Ignored.");
                        } else if (Objects.equals(
                                ((IVibratorController.Stub.Proxy) iVibratorController).mRemote,
                                ((IVibratorController.Stub.Proxy) asInterface2).mRemote)) {
                            vibratorControlService2.mVibrationScaler.mAdaptiveHapticsScales.clear();
                            vibratorControlService2.mVibratorControllerHolder.setVibratorController(
                                    null);
                            vibratorControlService2.endOngoingRequestVibrationParamsLocked(true);
                        } else {
                            Slog.wtf(
                                    "VibratorControlService",
                                    "Failed to unregister IVibratorController. The provided"
                                        + " controller doesn't match the registered one. "
                                            + vibratorControlService2);
                        }
                    } finally {
                    }
                ...
                VibrationParam[] vibrationParamArr =
                        (VibrationParam[]) parcel.createTypedArray(VibrationParam.CREATOR);
                IVibratorController asInterface3 =
                        IVibratorController.Stub.asInterface(parcel.readStrongBinder());
                parcel.enforceNoDataAvail();
                ...
                synchronized (vibratorControlService3.mLock) {
                    try {
                        IVibratorController iVibratorController2 =
                                vibratorControlService3
                                        .mVibratorControllerHolder
                                        .mVibratorController;
                        if (iVibratorController2 == null) {
                            Slog.w(
                                    "VibratorControlService",
                                    "Received request to set VibrationParams for"
                                        + " IVibratorController = "
                                            + asInterface3
                                            + ", but no controller was previously registered."
                                            + " Request Ignored.");
                                ...
                                ((IVibratorController.Stub.Proxy) asInterface3).mRemote)) {
                            Slog.wtf(
                                    "VibratorControlService",
                                    "Failed to set new VibrationParams. The provided controller"
                            ...
                            vibratorControlService3.recordUpdateVibrationParams(
                                    vibrationParamArr, false);
                        }
                    } finally {
                    }
                }
                ...
                IVibratorController asInterface4 =
                        IVibratorController.Stub.asInterface(parcel.readStrongBinder());
                parcel.enforceNoDataAvail();
                ...
                VibrationParam[] vibrationParamArr2 =
                        (VibrationParam[]) parcel.createTypedArray(VibrationParam.CREATOR);
                parcel.enforceNoDataAvail();
                ...
                synchronized (vibratorControlService4.mLock) {
                    try {
                        VibratorControlService.VibrationParamRequest vibrationParamRequest =
                                vibratorControlService4.mVibrationParamRequest;
                        if (vibrationParamRequest == null) {
                            Slog.wtf(
                                    "VibratorControlService",
                                    "New vibration params received but no token was cached in the"
                                        + " service. New vibration params ignored.");
                            ...
                            VibratorControlService.VibrationParamRequest vibrationParamRequest2 =
                                    vibratorControlService4.mVibrationParamRequest;
                            long j = uptimeMillis - vibrationParamRequest2.uptimeMs;
                            VibratorFrameworkStatsLogger vibratorFrameworkStatsLogger =
                                    vibratorControlService4.mStatsLogger;
                            int i3 = vibrationParamRequest2.uid;
                            vibratorFrameworkStatsLogger.getClass();
                            VibratorFrameworkStatsLogger.sVibrationParamRequestLatencyHistogram
                                    .logSampleWithUid(i3, j);
                            if (vibrationParamArr2 == null) {
                                ...
                                vibratorControlService4.updateAdaptiveHapticsScales(
                                        vibrationParamArr2);
                                vibratorControlService4.endOngoingRequestVibrationParamsLocked(
                                        false);
                                vibratorControlService4.recordUpdateVibrationParams(
                                        vibrationParamArr2, true);
                            }
                        } else {
                            Slog.w(
                                    "VibratorControlService",
                                    "New vibration params received but the provided token does not"
                                        + " match the cached one. New vibration params ignored.");
                            vibratorControlService4.mStatsLogger.getClass();
                            Counter.logIncrement("vibrator.value_vibration_param_response_ignored");
                        }
                    } finally {
