...
public abstract class UsageStatsManagerInternal {
  ...
  public abstract void registerLaunchTimeChangedListener(
      EstimatedLaunchTimeChangedListener estimatedLaunchTimeChangedListener);
  ...
  public abstract void reportEvent(
      ComponentName componentName, int i, int i2, int i3, ComponentName componentName2);
  ...
  public abstract void reportLocusUpdate(
      ComponentName componentName, int i, LocusId locusId, IBinder iBinder);
