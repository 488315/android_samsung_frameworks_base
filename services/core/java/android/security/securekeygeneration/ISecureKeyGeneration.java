...
public interface ISecureKeyGeneration extends IInterface {
  public static final String DESCRIPTOR =
      "android$security$securekeygeneration$ISecureKeyGeneration".replace('$', '.');
  ...
  public class Default implements ISecureKeyGeneration {
    ...
    public SecureKeyInfo generateSecureKey(
        KeyParameter[] keyParameterArr, KeyParameter[] keyParameterArr2) {
      return null;
    }
  }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
      ...
      if (i == 1) {
        KeyParameter[] keyParameterArr =
            (KeyParameter[]) parcel.createTypedArray(KeyParameter.CREATOR);
