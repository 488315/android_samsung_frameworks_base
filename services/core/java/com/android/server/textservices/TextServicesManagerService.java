...
public class TextServicesManagerService extends ITextServicesManager.Stub {
    ...
    public final void initializeTextServicesData() {
      ...
      List queryIntentServicesAsUser =
          this.mContext
              ...
              .queryIntentServicesAsUser(
                  new Intent("android.service.textservice.SpellCheckerService"), 128, this.mUserId);
      ...
      for (int i = 0; i < size; i++) {
        ...
        if (!"android.permission.BIND_TEXT_SERVICE".equals(serviceInfo.permission)) {
          Slog.w(
              TextServicesManagerService.TAG,
              "Skipping text service "
                  + componentName
                  + ": it does not require the permission android.permission.BIND_TEXT_SERVICE");
        } else {
          try {
            ...
            if (spellCheckerInfo.getSubtypeCount() <= 0) {
              Slog.w(
                  TextServicesManagerService.TAG,
                  "Skipping text service " + componentName + ": it does not contain subtypes.");
            } else {
    ...
    public final void dump(PrintWriter printWriter) {
      ...
      for (Map.Entry entry : this.mSpellCheckerBindGroups.entrySet()) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
          ...
          printWriter.println(
              "        mScLocale=" + sessionRequest.mLocale + " mUid=" + sessionRequest.mUid);
        }
        ...
        for (int i3 = 0; i3 < size2; i3++) {
          ...
          printWriter.println(
              "        mScLocale=" + sessionRequest2.mLocale + " mUid=" + sessionRequest2.mUid);
        }
        ...
        for (int i4 = 0; i4 < registeredCallbackCount; i4++) {
          ISpellCheckerSessionListener registeredCallbackItem =
              spellCheckerBindGroup.mListeners.getRegisteredCallbackItem(i4);
  ...
  public final void initializeInternalStateLocked(int i) {
    ...
    if (textServicesData.getCurrentSpellChecker() == null) {
      setCurrentSpellCheckerLocked(
          findAvailSystemSpellCheckerLocked(null, textServicesData), textServicesData);
    }
  }
    ...
    public void onSomePackagesChanged() {
      ...
      synchronized (TextServicesManagerService.this.mLock) {
        TextServicesData textServicesData =
            (TextServicesData) TextServicesManagerService.this.mUserData.get(changingUserId);
        if (textServicesData == null) {
          return;
        }
        ...
        if (textServicesData.isSpellCheckerEnabled()) {
          if (currentSpellChecker == null) {
            TextServicesManagerService.this.setCurrentSpellCheckerLocked(
                TextServicesManagerService.this.findAvailSystemSpellCheckerLocked(
  ...
  public final boolean bindCurrentSpellCheckerService(
      Intent intent, ServiceConnection serviceConnection, int i, int i2) {
  ...
  public final SpellCheckerInfo findAvailSystemSpellCheckerLocked(
    ...
    ArrayList suitableLocalesForSpellChecker =
  ...
  public SpellCheckerSubtype getCurrentSpellCheckerSubtype(int i, boolean z) {
    ...
    synchronized (this.mLock) {
      ...
      int i2 = 0;
      int selectedSpellCheckerSubtype =
          dataFromCallingUserIdLocked.getSelectedSpellCheckerSubtype(0);
      ...
      if (currentSpellChecker != null && currentSpellChecker.getSubtypeCount() != 0) {
        ...
        while (i2 < currentSpellChecker.getSubtypeCount()) {
          ...
          if (spellCheckerSubtype == null
              && localeObject != null
              && TextUtils.equals(locale.getLanguage(), localeObject.getLanguage())) {
      ...
      if (hashMap.containsKey(str)) {
        ...
        if (canCallerAccessSpellChecker(spellCheckerInfo, callingUid, i)) {
          SpellCheckerBindGroup spellCheckerBindGroup =
              (SpellCheckerBindGroup) dataFromCallingUserIdLocked.mSpellCheckerBindGroups.get(str);
  ...
  public final SpellCheckerBindGroup startSpellCheckerServiceInnerLocked(
    ...
    if (!bindCurrentSpellCheckerService(
        intent, internalServiceConnection, 8388609, textServicesData.mUserId)) {
  ...
  public final boolean canCallerAccessSpellChecker(
    ...
    if (currentSpellCheckerForUser == null
      ...
      return !((PackageManagerInternal) LocalServices.getService(PackageManagerInternal.class))
          .filterAppAccess(spellCheckerInfo.getPackageName(), i, i2);
    }
    return true;
  }

  public final void setCurrentSpellCheckerLocked(
      SpellCheckerInfo spellCheckerInfo, TextServicesData textServicesData) {
    if (spellCheckerInfo != null) {
  ...
  public final class SpellCheckerBindGroup {
        ...
        Predicate predicate =
            new Predicate() { // from class:
              ...
              public final boolean test(Object obj) {
                ...
                lambda$removeListener$0 =
                    TextServicesManagerService.SpellCheckerBindGroup.lambda$removeListener$0(
                        asBinder, (TextServicesManagerService.SessionRequest) obj);
    ...
    public static /* synthetic */ boolean lambda$removeListener$0(
        IBinder iBinder, SessionRequest sessionRequest) {
    ...
    public void removeAllLocked() {
      ...
      for (int registeredCallbackCount = this.mListeners.getRegisteredCallbackCount() - 1;
    ...
    public void onSessionCreated(
        ISpellCheckerSession iSpellCheckerSession, SessionRequest sessionRequest) {
      synchronized (TextServicesManagerService.this.mLock) {
        if (this.mUnbindCalled) {
          return;
        }
