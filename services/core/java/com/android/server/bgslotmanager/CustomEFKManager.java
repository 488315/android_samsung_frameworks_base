...
public class CustomEFKManager {
  ...
  public final void setEFKBoost() {
    ...
    if (i != -1) {
      BgAppPropManager.setSystemPropertyString(
          "sys.sysctl.extra_free_kbytes", Integer.toString(i + this.v_bonusEFKWhileBoot));
    }
  }
  ...
  public final void setEFKDecreaseBoost() {
    ...
    if (i != -1) {
      ...
      if (i2 > 0) {
        BgAppPropManager.setSystemPropertyString(
            "sys.sysctl.extra_free_kbytes", Integer.toString(i2));
      } else {
        BgAppPropManager.setSystemPropertyString(
            "sys.sysctl.extra_free_kbytes", Integer.toString(i / 3));
      }
    }
  }
  ...
  public final void restoreWatermarkScaleFactor() {
    ...
    if (i > 10) {
      BgAppPropManager.setSystemPropertyString(
          "sys.sysctl.watermark_scale_factor", Integer.toString(i));
    }
  }
  ...
  public final void setWatermarkScaleFactorDecreaseBoost() {
    ...
    if (i > 10) {
      ...
      if (i3 > 0) {
        BgAppPropManager.setSystemPropertyString(
            "sys.sysctl.watermark_scale_factor", Integer.toString(i3));
      } else {
        BgAppPropManager.setSystemPropertyString(
            "sys.sysctl.watermark_scale_factor", Integer.toString(i2));
      }
    }
  }
  ...
  public void runBootEFKBoost() {
    if (BOOTING_EFK_BOOST_ENABLE) {
      setEFKBoost();
      new CountDownTimer(
          180000L, 15000L) { // from class: com.android.server.bgslotmanager.CustomEFKManager.1
    ...
    while (true) {
      ...
      if (i < strArr.length) {
        ...
        if (this.v_watermark_scale > 10) {
          ...
          new CountDownTimer(
              i2, i2) { // from class: com.android.server.bgslotmanager.CustomEFKManager.2
            @Override // android.os.CountDownTimer
            public void onTick(long j) {}
        ...
        new CountDownTimer(
            i3, i3) { // from class: com.android.server.bgslotmanager.CustomEFKManager.3
          @Override // android.os.CountDownTimer
          public void onTick(long j) {}
  ...
  public int getBonusEFK() {
    int i =
        (mTotalMemMb < 3072 || ActivityManager.isLowRamDeviceStatic())
            ? 0
            : (int) (r0 * 1024 * 0.01d);
  ...
  public void setOriginEFKWithSetProperty(int i) {
    this.origin_EFK = i;
    BgAppPropManager.setSystemPropertyString(
        "sys.sysctl.origin_extra_free_kbytes", Integer.toString(i));
  }

  public void setWatermarkBoostFactor(int i) {
    BgAppPropManager.setSystemPropertyString(
        "sys.sysctl.watermark_boost_factor", Integer.toString(i));
  }
  ...
  public class WatermarkScaleTimer extends CountDownTimer {
    ...
    public void onTick(long j) {
      ...
      if (i2 > 2 && !CustomEFKManager.this.isStillDecEFK) {
        ...
        if (i != 0
            && CustomEFKManager.this.last_Watermark_EFK != -1
            && ((i <= watermarkScaleInfo
        ...
        if (z) {
          ...
          Slog.i(
              "DynamicHiddenApp_CustomEFKManager",
              "curWatermarkScale : " + CustomEFKManager.this.v_watermark_scale);
          CustomEFKManager.this.last_Watermark_EFK = this.reserve;
  ...
  public void getCurWatermarkFactorScale(int i) {
    if (APP_EFK_DECREASE_BOOST_ENABLE) {
      ...
      new WatermarkScaleTimer(this.vWatermarkScaleGetTime, this.vWatermarkScaleGetPerTickTime, i)
          .start();
    }
  }
