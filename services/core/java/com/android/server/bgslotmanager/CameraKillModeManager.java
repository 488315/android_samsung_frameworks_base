...
public class CameraKillModeManager extends CameraManager.SemCameraDeviceStateCallback {
  ...
  public void initCameraKillModeManager(
      Context context, Handler handler, DynamicHiddenApp dynamicHiddenApp) {
    ...
    if (CAMERA_DHA_VER > 0) {
      this.mMinFreeMax = dynamicHiddenApp.getMemLevel(999);
    }
    if (CAMERA_DHA_VER > 1) {
      int i = 0;
      ...
      this.dha_camera_map.put(
          DynamicHiddenApp.decodeToStr("Y29tLnNlYy5hbmRyb2lkLmFwcC5jYW1lcmE="), -1);
    }
  ...
  public void onCameraDeviceStateChanged(String str, int i, int i2, String str2) {
    ...
    if (DynamicHiddenApp.DEBUG) {
      Slog.i(
          "DynamicHiddenApp_CameraKillModeManager",
          "Camera Callback on DHA [id] "
              + str
              + " [faceing] "
              + i
              + " [newState] "
  ...
  public void doLmkdCameraKillMode(int i, String str) {
    int intValue;
    if (this.dha_cameraclientexcept_map.containsKey(str)
        || str.contains("vendor.")
        || str.contains("client.")) {
      return;
    }
  ...
  public class CameraKillModeOperator {
      ...
      if (CameraKillModeManager.this.isOriginBG) {
        ...
        Slog.i(
            ...
            "Available Mem: "
                ...
                + " CAM TH "
                + ((long)
                    (CameraKillModeManager.this.mMinFreeMax
                        * CameraKillModeManager.this.mSzDHAThresholdRate)));
        if (availableMemLegacy
            < ((long)
                (CameraKillModeManager.this.mMinFreeMax
                    * CameraKillModeManager.this.mSzDHAThresholdRate))) {
    ...
    public void runLmkdCameraKillMode(int i, int i2) {
      if (CameraKillModeManager.this.mDynamicHiddenApp != null) {
        CameraKillModeManager.this.mDynamicHiddenApp.setLmkdCameraKillBoost(
            this.cameraState, i, i2);
      }
    }
