...
public class MemInfoGetter {
  public final int[][] memoryMBToGBPool = {
    new int[] {12288, 16},
    new int[] {IInstalld.FLAG_FORCE, 12},
    new int[] {6144, 8},
    new int[] {IInstalld.FLAG_USE_QUOTA, 6},
    new int[] {3072, 4},
    new int[] {IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES, 3},
    new int[] {1024, 2},
    new int[] {0, 1}
  };
  ...
  public long getAvailableMemLegacy() {
    readLightMemInfo();
    return (this.mInfoInner.getFreeSize() + this.mInfoInner.getCachedSizeLegacy())
        - (this.mInfoInner.getRbinTotalSize() - this.mInfoInner.getRbinAllocedSize());
  }
