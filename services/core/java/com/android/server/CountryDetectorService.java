...
public class CountryDetectorService extends ICountryDetector.Stub {
  ...
  public void systemRunning() {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.CountryDetectorService$$ExternalSyntheticLambda3
  ...
  public void initialize() {
    String string = this.mContext.getString(R.string.country_detector);
  ...
  public /* synthetic */ void lambda$initialize$2(final Country country) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.CountryDetectorService$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void setCountryListener(final CountryListener countryListener) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.CountryDetectorService$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
