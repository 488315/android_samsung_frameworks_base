...
public class ThermalStatusRestriction extends JobRestriction {
  ...
  public ThermalStatusRestriction(JobSchedulerService jobSchedulerService) {
    ...
    this.mSIOPTracker =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.job.restrictions.ThermalStatusRestriction.2
          ...
          public void onReceive(Context context, Intent intent) {
            ...
            if (ThermalStatusRestriction.this.mForceRestricted != booleanExtra) {
              ...
              thermalStatusRestriction.mService.onRestrictionStateChanged(
                  thermalStatusRestriction,
                  thermalStatusRestriction.mForceRestricted
                      || ThermalStatusRestriction.this.mIncrease);
            }
          }
        };
  ...
  public void onSystemServicesReady() {
    ((PowerManager) this.mService.getTestableContext().getSystemService(PowerManager.class))
        .addThermalStatusListener(
            new PowerManager
              ...
              public void onThermalStatusChanged(int i) {
                boolean z =
                    (i >= 1 && i <= 3)
                        || (ThermalStatusRestriction.this.mThermalStatus >= 1 && i < 1)
                        || (ThermalStatusRestriction.this.mThermalStatus < 3 && i > 3);
                ThermalStatusRestriction thermalStatusRestriction = ThermalStatusRestriction.this;
                ...
                if (z) {
                  Slog.i(
                      "ThermalStatusRestriction",
                      "ThermalStatus changed to " + ThermalStatusRestriction.this.mThermalStatus);
                  ...
                  thermalStatusRestriction2.mService.onRestrictionStateChanged(
                      thermalStatusRestriction2, thermalStatusRestriction2.mIncrease);
                }
              }
            });
  }
  ...
  public boolean isJobRestricted(JobStatus jobStatus) {
    if (jobStatus.overrideState == 2
        ...
        && (jobStatus.getJobId() == 800 || jobStatus.getJobId() == 801)) {
      return false;
    }
