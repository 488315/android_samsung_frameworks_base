...
public final class GrantedUriPermissions {
  ...
  public static GrantedUriPermissions createFromIntent(
      Intent intent, int i, String str, int i2, String str2) {
    ...
    GrantedUriPermissions grantUri =
        data != null ? grantUri(data, i, str, i2, flags, str2, null) : null;
    ClipData clipData = intent.getClipData();
    return clipData != null ? grantClip(clipData, i, str, i2, flags, str2, grantUri) : grantUri;
  }

  public static GrantedUriPermissions createFromClip(
      ClipData clipData, int i, String str, int i2, int i3, String str2) {
  ...
  public static GrantedUriPermissions grantClip(
    ...
    for (int i4 = 0; i4 < itemCount; i4++) {
      grantedUriPermissions2 =
          grantItem(clipData.getItemAt(i4), i, str, i2, i3, str2, grantedUriPermissions2);
    }
  ...
  public static GrantedUriPermissions grantItem(
      ClipData.Item item,
      int i,
      String str,
      int i2,
    ...
    return (intent == null || intent.getData() == null)
        ? grantedUriPermissions2
        : grantUri(intent.getData(), i, str, i2, i3, str2, grantedUriPermissions2);
  }
