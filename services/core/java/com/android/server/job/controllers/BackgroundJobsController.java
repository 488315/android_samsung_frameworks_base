...
public final class BackgroundJobsController extends StateController {
  ...
  public BackgroundJobsController(JobSchedulerService jobSchedulerService) {
    ...
    AppStateTrackerImpl.Listener listener =
  ...
  public void maybeStartTrackingJobLocked(JobStatus jobStatus, JobStatus jobStatus2) {
    updateSingleJobRestrictionLocked(
        jobStatus, JobSchedulerService.sElapsedRealtimeClock.millis(), 0);
  }
    ...
    this.mService
        ...
        .forEachJob(
            ...
            new Consumer() { // from class:
                             // com.android.server.job.controllers.BackgroundJobsController$$ExternalSyntheticLambda1
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                BackgroundJobsController.this.lambda$dumpControllerStateLocked$0(
  ...
  public /* synthetic */ void lambda$dumpControllerStateLocked$0(
    ...
    if (this.mAppStateTracker.isUidPowerSaveExempt(sourceUid)
        || this.mAppStateTracker.isUidTempPowerSaveExempt(sourceUid)) {
    ...
    indentingPrintWriter.print(
        this.mAppStateTracker.isRunAnyInBackgroundAppOpsAllowed(sourceUid, sourcePackageName)
            ? "allowed]"
            : "disallowed]");
    ...
    this.mService
        ...
        .forEachJob(
            ...
            new Consumer() { // from class:
              ...
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                BackgroundJobsController.this.lambda$dumpControllerStateLocked$1(
  ...
  public /* synthetic */ void lambda$dumpControllerStateLocked$1(
    ...
    protoOutputStream.write(
        1133871366149L,
        this.mAppStateTracker.isUidPowerSaveExempt(sourceUid)
            || this.mAppStateTracker.isUidTempPowerSaveExempt(sourceUid));
    protoOutputStream.write(
        1133871366150L,
        this.mAppStateTracker.isRunAnyInBackgroundAppOpsAllowed(sourceUid, sourcePackageName));
    ...
    if (z) {
      Slog.d(
          ...
          String.format(
              ...
              Integer.valueOf(this.mUpdateJobFunctor.mCheckedCount),
              Integer.valueOf(this.mUpdateJobFunctor.mTotalCount),
  ...
  public boolean updateSingleJobRestrictionLocked(JobStatus jobStatus, long j, int i) {
    ...
    String sourcePackageName = jobStatus.getSourcePackageName();
    boolean z2 =
        (this.mActivityManagerInternal.isBgAutoRestrictedBucketFeatureFlagEnabled()
                || this.mAppStateTracker.isRunAnyInBackgroundAppOpsAllowed(
                    sourceUid, sourcePackageName))
            ? false
            : true;
    boolean z3 =
        ((jobStatus.startedWithForegroundFlag && z2 && this.mService.getUidProcState(sourceUid) > 5)
                || this.mAppStateTracker.areJobsRestricted(
                    sourceUid, sourcePackageName, jobStatus.canRunInBatterySaver()))
            ? false
            : true;
    if (i == 0) {
    ...
    return jobStatus.setUidActive(z)
        | jobStatus.setBackgroundNotRestrictedConstraintSatisfied(j, z3, z2);
  }
