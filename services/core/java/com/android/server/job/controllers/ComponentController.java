...
public class ComponentController extends StateController {
  ...
  public ComponentController(JobSchedulerService jobSchedulerService) {
        ...
        new BroadcastReceiver() { // from class:
          ...
          public void onReceive(Context context, Intent intent) {
            ...
            switch (c) {
              case 0:
              case 2:
                ComponentController.this.updateComponentStateForUser(
              ...
              case 1:
                ...
                if (schemeSpecificPart != null
                  ...
                  ComponentController.this.updateComponentStateForPackage(
    ...
    this.mContext.registerReceiverAsUser(
        broadcastReceiver, UserHandle.ALL, intentFilter2, null, null);
  }
    ...
    try {
      serviceInfo =
          this.mContext
              ...
              .getPackageManager()
              .getServiceInfo(serviceComponent, 268435456);
    } catch (PackageManager.NameNotFoundException unused) {
      if (this.mService.areUsersStartedLocked(jobStatus)) {
        Slog.e(
            "JobScheduler.Component",
            "Job exists for non-existent package: " + serviceComponent.getPackageName());
      }
      serviceInfo = null;
    }
  ...
  public final void clearComponentsForPackageLocked(int i, String str) {
    ...
    for (int numElementsForKey = this.mServiceProcessCache.numElementsForKey(i) - 1;
        numElementsForKey >= 0;
        numElementsForKey--) {
      ComponentName componentName =
          (ComponentName) this.mServiceProcessCache.keyAt(indexOfKey, numElementsForKey);
    ...
    synchronized (this.mLock) {
      ...
      updateComponentStatesLocked(
          new Predicate() { // from class:
                            // com.android.server.job.controllers.ComponentController$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$updateComponentStateForPackage$0;
              lambda$updateComponentStateForPackage$0 =
                  ComponentController.lambda$updateComponentStateForPackage$0(
                      i, str, (JobStatus) obj);
  ...
  public static /* synthetic */ boolean lambda$updateComponentStateForPackage$0(
      int i, String str, JobStatus jobStatus) {
    return jobStatus.getUserId() == i
        && jobStatus.getServiceComponent().getPackageName().equals(str);
  }
  ...
  public final void updateComponentStateForUser(final int i) {
    synchronized (this.mLock) {
      ...
      updateComponentStatesLocked(
          new Predicate() { // from class:
                            // com.android.server.job.controllers.ComponentController$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$updateComponentStateForUser$1;
              lambda$updateComponentStateForUser$1 =
                  ComponentController.lambda$updateComponentStateForUser$1(i, (JobStatus) obj);
  ...
  public static /* synthetic */ boolean lambda$updateComponentStateForUser$1(
  ...
  public final void updateComponentStatesLocked(Predicate predicate) {
    ...
    if (this.mComponentStateUpdateFunctor.mChangedJobs.size() > 0) {
      this.mStateChangedListener.onControllerStateChanged(
          this.mComponentStateUpdateFunctor.mChangedJobs);
    }
  }
