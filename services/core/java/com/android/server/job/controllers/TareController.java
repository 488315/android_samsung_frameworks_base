...
public class TareController extends StateController {
  ...
  static {
    ...
    BILL_JOB_START_MIN =
        new EconomyManagerInternal.ActionBill(
            List.of(
                new EconomyManagerInternal.AnticipatedAction(1610612740, 1, 0L),
                new EconomyManagerInternal.AnticipatedAction(1610612741, 0, 120000L)));
    BILL_JOB_RUNNING_MIN =
        new EconomyManagerInternal.ActionBill(
            List.of(new EconomyManagerInternal.AnticipatedAction(1610612741, 0, 60000L)));
    BILL_JOB_START_LOW =
        new EconomyManagerInternal.ActionBill(
            List.of(
                new EconomyManagerInternal.AnticipatedAction(1610612740, 1, 0L),
                new EconomyManagerInternal.AnticipatedAction(1610612741, 0, 60000L)));
    BILL_JOB_RUNNING_LOW =
        new EconomyManagerInternal.ActionBill(
            List.of(new EconomyManagerInternal.AnticipatedAction(1610612741, 0, 30000L)));
    BILL_JOB_START_DEFAULT =
        new EconomyManagerInternal.ActionBill(
            List.of(
                new EconomyManagerInternal.AnticipatedAction(1610612740, 1, 0L),
                new EconomyManagerInternal.AnticipatedAction(1610612741, 0, 30000L)));
    BILL_JOB_RUNNING_DEFAULT =
        new EconomyManagerInternal.ActionBill(
            List.of(new EconomyManagerInternal.AnticipatedAction(1610612741, 0, 1000L)));
    BILL_JOB_START_HIGH =
        new EconomyManagerInternal.ActionBill(
            List.of(
                new EconomyManagerInternal.AnticipatedAction(1610612738, 1, 0L),
                new EconomyManagerInternal.AnticipatedAction(1610612739, 0, 30000L)));
    BILL_JOB_RUNNING_HIGH =
        new EconomyManagerInternal.ActionBill(
            List.of(new EconomyManagerInternal.AnticipatedAction(1610612739, 0, 1000L)));
    BILL_JOB_START_MAX =
        new EconomyManagerInternal.ActionBill(
            List.of(
                new EconomyManagerInternal.AnticipatedAction(1610612736, 1, 0L),
                new EconomyManagerInternal.AnticipatedAction(1610612737, 0, 30000L)));
    BILL_JOB_RUNNING_MAX =
        new EconomyManagerInternal.ActionBill(
            List.of(new EconomyManagerInternal.AnticipatedAction(1610612737, 0, 1000L)));
    BILL_JOB_START_MAX_EXPEDITED =
        new EconomyManagerInternal.ActionBill(
            List.of(
                new EconomyManagerInternal.AnticipatedAction(1610612736, 1, 0L),
                new EconomyManagerInternal.AnticipatedAction(1610612737, 0, 30000L)));
    BILL_JOB_RUNNING_MAX_EXPEDITED =
        new EconomyManagerInternal.ActionBill(
            List.of(new EconomyManagerInternal.AnticipatedAction(1610612737, 0, 1000L)));
    BILL_JOB_START_HIGH_EXPEDITED =
        new EconomyManagerInternal.ActionBill(
            List.of(
                new EconomyManagerInternal.AnticipatedAction(1610612738, 1, 0L),
                new EconomyManagerInternal.AnticipatedAction(1610612739, 0, 30000L)));
    BILL_JOB_RUNNING_HIGH_EXPEDITED =
        new EconomyManagerInternal.ActionBill(
            List.of(new EconomyManagerInternal.AnticipatedAction(1610612739, 0, 1000L)));
  }
  ...
  */
          ...
          if (!z && !hasEnoughWealthLocked(jobStatus)) {
            ...
            if (jobStatus.isRequestedExpeditedJob()
                && setExpeditedTareApproved(
                    jobStatus, millis, canAffordExpeditedBillLocked(jobStatus))) {
              arraySet2.add(jobStatus);
            }
          }
          z2 = true;
    ...
    this.mAffordabilityChangeListener =
        new EconomyManagerInternal
            .AffordabilityChangeListener() { // from class:
                                             // com.android.server.job.controllers.TareController$$ExternalSyntheticLambda0
          @Override // com.android.server.tare.EconomyManagerInternal.AffordabilityChangeListener
          public final void onAffordabilityChanged(
              int i, String str, EconomyManagerInternal.ActionBill actionBill, boolean z) {
  ...
  public void maybeStartTrackingJobLocked(JobStatus jobStatus, JobStatus jobStatus2) {
    ...
    for (int i = 0; i < possibleStartBills.size(); i++) {
      addJobToBillList(
          jobStatus, (EconomyManagerInternal.ActionBill) possibleStartBills.valueAt(i));
    }
  }
  ...
  public void prepareForExecutionLocked(JobStatus jobStatus) {
    ...
    ArrayMap arrayMap =
        (ArrayMap) this.mRegisteredBillsAndJobs.get(sourceUserId, sourcePackageName);
    if (arrayMap == null) {
      Slog.e(
          "JobScheduler.TARE",
          "Job is being prepared but doesn't have a pre-existing billToJobMap");
    } else {
    ...
    this.mEconomyManagerInternal.noteOngoingEventStarted(
        sourceUserId,
        sourcePackageName,
        getRunningActionId(jobStatus),
  ...
  public void unprepareFromExecutionLocked(JobStatus jobStatus) {
    ...
    if (!this.mTopStartedJobs.remove(jobStatus)) {
      this.mEconomyManagerInternal.noteOngoingEventStopped(
          sourceUserId,
          sourcePackageName,
          getRunningActionId(jobStatus),
          String.valueOf(jobStatus.getJobId()));
    ...
    if (arrayMap == null) {
      Slog.e(
          "JobScheduler.TARE",
          "Job was just unprepared but didn't have a pre-existing billToJobMap");
    } else {
      for (int i = 0; i < arrayMap.size(); i++) {
        removeJobFromBillList(jobStatus, (EconomyManagerInternal.ActionBill) arrayMap.keyAt(i));
      }
    ...
    for (int i2 = 0; i2 < possibleStartBills.size(); i2++) {
      addJobToBillList(
          jobStatus, (EconomyManagerInternal.ActionBill) possibleStartBills.valueAt(i2));
    }
  }
      ...
      AppSchedulingModuleThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.job.controllers.TareController$$ExternalSyntheticLambda2
      ...
      this.mService
          ...
          .forEachJob(
              new Consumer() { // from class:
                               // com.android.server.job.controllers.TareController$$ExternalSyntheticLambda3
  ...
  public long getMaxJobExecutionTimeMsLocked(JobStatus jobStatus) {
    ...
    return this.mEconomyManagerInternal.getMaxDurationMs(
        jobStatus.getSourceUserId(), jobStatus.getSourcePackageName(), getRunningBill(jobStatus));
  }

  public final void addJobToBillList(
      JobStatus jobStatus, EconomyManagerInternal.ActionBill actionBill) {
    int sourceUserId = jobStatus.getSourceUserId();
    String sourcePackageName = jobStatus.getSourcePackageName();
    ArrayMap arrayMap =
        (ArrayMap) this.mRegisteredBillsAndJobs.get(sourceUserId, sourcePackageName);
    ...
    if (arraySet.add(jobStatus)) {
      this.mEconomyManagerInternal.registerAffordabilityChangeListener(
          sourceUserId, sourcePackageName, this.mAffordabilityChangeListener, actionBill);
    }
  }

  public final void removeJobFromBillList(
      JobStatus jobStatus, EconomyManagerInternal.ActionBill actionBill) {
    int sourceUserId = jobStatus.getSourceUserId();
    String sourcePackageName = jobStatus.getSourcePackageName();
    ArrayMap arrayMap =
    ...
    if (arrayMap != null) {
      ...
      if (arraySet == null || (arraySet.remove(jobStatus) && arraySet.size() == 0)) {
        this.mEconomyManagerInternal.unregisterAffordabilityChangeListener(
            sourceUserId, sourcePackageName, this.mAffordabilityChangeListener, actionBill);
        ArrayMap arrayMap2 =
            (ArrayMap) this.mAffordabilityCache.get(sourceUserId, sourcePackageName);
        if (arrayMap2 != null) {
  ...
  public final ArraySet getPossibleStartBills(JobStatus jobStatus) {
    ...
    if (effectivePriority == 100) {
      ...
      Slog.wtf(
          "JobScheduler.TARE",
          "Unexpected priority: " + JobInfo.getPriorityString(jobStatus.getEffectivePriority()));
    }
    return arraySet;
  }
  ...
  public final boolean canAffordBillLocked(
    ...
    boolean canPayFor =
        this.mEconomyManagerInternal.canPayFor(sourceUserId, sourcePackageName, actionBill);
  ...
  public void dumpControllerStateLocked(
      final IndentingPrintWriter indentingPrintWriter, Predicate predicate) {
    ...
    this.mAffordabilityCache.forEach(
        new SparseArrayMap
            .TriConsumer() { // from class:
                             // com.android.server.job.controllers.TareController$$ExternalSyntheticLambda1
          public final void accept(int i, Object obj, Object obj2) {
            TareController.this.lambda$dumpControllerStateLocked$3(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$dumpControllerStateLocked$3(
    ...
    if (size > 0) {
      ...
      for (int i2 = 0; i2 < size; i2++) {
        indentingPrintWriter.print(
            getBillName((EconomyManagerInternal.ActionBill) arrayMap.keyAt(i2)));
        indentingPrintWriter.print(": ");
