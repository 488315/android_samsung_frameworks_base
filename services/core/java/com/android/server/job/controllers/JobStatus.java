...
public final class JobStatus {
    ...
    */
    public JobStatus(JobInfo jobInfo, int i, String str, int i2, int i3, String str2, String str3, int i4, int i5, long j, long j2, long j3, long j4, long j5, int i6, int i7) {
        int i8;
        String str4;
        boolean z;
        ...
        if (i2 != -1 && str != null) {
            ...
            if (str4 != null) {
                for (int size = BASIC_PII_FILTERS.size() - 1; size >= 0; size--) {
                    ...
                    str4 = ((Pattern) arrayMap.keyAt(size)).matcher(str4).replaceAll((String) arrayMap.valueAt(size));
                }
            }
            String str6 = str4 == null ? str5 + str4 + XmlUtils.STRING_ARRAY_SEPARATOR + jobInfo.getService().getPackageName() : str5 + jobInfo.getService().flattenToShortString();
            ...
            constraintFlags = UidRestrictController.isUidIgnored(this.sourceUid) ? constraintFlags : constraintFlags | 1048576;
