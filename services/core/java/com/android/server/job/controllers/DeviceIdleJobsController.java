...
public final class DeviceIdleJobsController extends StateController {
  ...
  public /* synthetic */ boolean lambda$new$0(JobStatus jobStatus) {
    return jobStatus.isRequestedExpeditedJob()
        || this.mForegroundUids.get(jobStatus.getSourceUid());
  }
  ...
  public DeviceIdleJobsController(JobSchedulerService jobSchedulerService) {
    ...
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.job.controllers.DeviceIdleJobsController.1
            ...
            switch (action) {
              case "android.os.action.POWER_SAVE_TEMP_WHITELIST_CHANGED":
                synchronized (DeviceIdleJobsController.this.mLock) {
                  ...
                  deviceIdleJobsController.mPowerSaveTempWhitelistAppIds =
                      deviceIdleJobsController.mLocalDeviceIdleController
                          .getPowerSaveTempWhitelistAppIds();
                  if (DeviceIdleJobsController.DEBUG) {
                    Slog.d(
                        "JobScheduler.DeviceIdle",
                        "Got temp whitelist "
                            + Arrays.toString(
                                DeviceIdleJobsController.this.mPowerSaveTempWhitelistAppIds));
                  }
                  ArraySet arraySet = new ArraySet();
                  long millis = JobSchedulerService.sElapsedRealtimeClock.millis();
                  for (i = 0; i < DeviceIdleJobsController.this.mAllowInIdleJobs.size(); i++) {
                    DeviceIdleJobsController deviceIdleJobsController2 =
                        DeviceIdleJobsController.this;
                    if (deviceIdleJobsController2.updateTaskStateLocked(
                        (JobStatus) deviceIdleJobsController2.mAllowInIdleJobs.valueAt(i),
                        millis)) {
                      arraySet.add(
                          (JobStatus) DeviceIdleJobsController.this.mAllowInIdleJobs.valueAt(i));
                    }
                  }
                  if (arraySet.size() > 0) {
              ...
              case "android.os.action.POWER_SAVE_WHITELIST_CHANGED":
                synchronized (DeviceIdleJobsController.this.mLock) {
                  DeviceIdleJobsController deviceIdleJobsController3 =
                      DeviceIdleJobsController.this;
                  deviceIdleJobsController3.mDeviceIdleWhitelistAppIds =
                      deviceIdleJobsController3.mLocalDeviceIdleController
                  ...
                  if (DeviceIdleJobsController.DEBUG) {
                    Slog.d(
                        ...
                        "Got whitelist "
                            + Arrays.toString(
                                DeviceIdleJobsController.this.mDeviceIdleWhitelistAppIds));
                  }
                }
                return;
              ...
              case "android.os.action.DEVICE_IDLE_MODE_CHANGED":
                ...
                if (deviceIdleJobsController4.mPowerManager == null
                    || (!DeviceIdleJobsController.this.mPowerManager.isDeviceIdleMode()
                        && !DeviceIdleJobsController.this.mPowerManager.isLightDeviceIdleMode())) {
                  z = false;
                }
    ...
    this.mShouldRushEvaluation =
        new Predicate() { // from class:
                          // com.android.server.job.controllers.DeviceIdleJobsController$$ExternalSyntheticLambda2
  ...
  public void updateIdleMode(boolean z) {
    ...
    synchronized (this.mLock) {
      ...
      if (z) {
        ...
        this.mService
            .getJobStore()
            .forEachJob(this.mShouldRushEvaluation, this.mDeviceIdleUpdateFunctor);
    ...
    if (z != this.mForegroundUids.get(i)) {
      ...
      if (this.mDeviceIdleUpdateFunctor.mChangedJobs.size() > 0) {
        this.mStateChangedListener.onControllerStateChanged(
            this.mDeviceIdleUpdateFunctor.mChangedJobs);
      }
    }
  }
  ...
  public boolean isWhitelistedLocked(JobStatus jobStatus) {
    return Arrays.binarySearch(
            this.mDeviceIdleWhitelistAppIds, UserHandle.getAppId(jobStatus.getSourceUid()))
        >= 0;
  }

  public boolean isTempWhitelistedLocked(JobStatus jobStatus) {
    return ArrayUtils.contains(
        this.mPowerSaveTempWhitelistAppIds, UserHandle.getAppId(jobStatus.getSourceUid()));
  }

  public final boolean updateTaskStateLocked(JobStatus jobStatus, long j) {
    boolean z = true;
    boolean z2 =
        (jobStatus.getFlags() & 2) != 0
            && (this.mForegroundUids.get(jobStatus.getSourceUid())
                || isTempWhitelistedLocked(jobStatus));
    ...
    this.mService
        ...
        .forEachJob(
            ...
            new Consumer() { // from class:
                             // com.android.server.job.controllers.DeviceIdleJobsController$$ExternalSyntheticLambda1
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                DeviceIdleJobsController.this.lambda$dumpControllerStateLocked$1(
                    indentingPrintWriter, (JobStatus) obj);
              }
            });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$dumpControllerStateLocked$1(
      IndentingPrintWriter indentingPrintWriter, JobStatus jobStatus) {
    ...
    indentingPrintWriter.print(
        (jobStatus.satisfiedConstraints & 33554432) != 0 ? " RUNNABLE" : " WAITING");
  ...
  @Override // com.android.server.job.controllers.StateController
  public void dumpControllerStateLocked(
      final ProtoOutputStream protoOutputStream, long j, Predicate predicate) {
    ...
    this.mService
        ...
        .forEachJob(
            predicate,
            new Consumer() { // from class:
                             // com.android.server.job.controllers.DeviceIdleJobsController$$ExternalSyntheticLambda0
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                DeviceIdleJobsController.this.lambda$dumpControllerStateLocked$2(
                    protoOutputStream, (JobStatus) obj);
              }
            });
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$dumpControllerStateLocked$2(
      ProtoOutputStream protoOutputStream, JobStatus jobStatus) {
    ...
    public void handleMessage(Message message) {
      ...
      synchronized (DeviceIdleJobsController.this.mLock) {
        ...
        DeviceIdleJobsController.this
            .mService
            .getJobStore()
            .forEachJob(DeviceIdleJobsController.this.mDeviceIdleUpdateFunctor);
        if (DeviceIdleJobsController.this.mDeviceIdleUpdateFunctor.mChangedJobs.size() > 0) {
          DeviceIdleJobsController deviceIdleJobsController = DeviceIdleJobsController.this;
          deviceIdleJobsController.mStateChangedListener.onControllerStateChanged(
              deviceIdleJobsController.mDeviceIdleUpdateFunctor.mChangedJobs);
        }
      }
    }
  }
