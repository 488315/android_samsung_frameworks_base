...
public final class JobServiceContext implements ServiceConnection {
    ...
    public final class JobCallback extends IJobCallback.Stub {
                        ...
                        if (arrayList != null) {
                            ...
                            for (int i3 = 0; i3 < size; i3++) {
                                JobWorkItem jobWorkItem =
                                        (JobWorkItem) jobStatus.executingWork.get(i3);
                                if (jobWorkItem.getWorkId() == i2) {
                                    ...
                                    jobServiceContext.mService.mJobs.touchJob(
                                            jobServiceContext.mRunningJob);
                                }
                            }
                        }
                        return false;
        ...
        */
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.job.JobServiceContext.JobCallback.dequeueWork(int):android.app.job.JobWorkItem");
        }
                ...
                synchronized (jobServiceContext.mLock) {
                    if (jobServiceContext.verifyCallerLocked(this)) {
                        ...
                        if (callingUid != jobStatus.callingUid) {
                            Slog.wtfStack(
                                    "JobServiceContext",
                                    "Calling UID isn't the same as running job's UID...");
                            throw new SecurityException(
                                    "Can't post notification on behalf of another app");
                        }
                        jobServiceContext.mNotificationCoordinator.enqueueNotification(
                                jobServiceContext,
                                jobStatus.job.getService().getPackageName(),
                                callingPid,
                                callingUid,
                                i2,
                                notification,
        ...
        public final void updateEstimatedNetworkBytes(
                int i, JobWorkItem jobWorkItem, long j, long j2) {
            JobServiceContext jobServiceContext = JobServiceContext.this;
            synchronized (jobServiceContext.mLock) {
                try {
                    if (jobServiceContext.verifyCallerLocked(this)) {
                        Counter.logIncrementWithUid(
                                ...
                                jobServiceContext.mRunningJob.callingUid);
                        JobServiceContext.sUpdatedEstimatedNetworkDownloadKBLogger.logSample(
                                JobSchedulerService.safelyScaleBytesToKBForHistogram(j));
                        JobServiceContext.sUpdatedEstimatedNetworkUploadKBLogger.logSample(
                ...
                try {
                    if (jobServiceContext.verifyCallerLocked(this)) {
                        Counter.logIncrementWithUid(
                                ...
                                jobServiceContext.mRunningJob.callingUid);
                        JobServiceContext.sTransferredNetworkDownloadKBHighWaterMarkLogger
                                .logSample(JobSchedulerService.safelyScaleBytesToKBForHistogram(j));
                        JobServiceContext.sTransferredNetworkUploadKBHighWaterMarkLogger.logSample(
                                JobSchedulerService.safelyScaleBytesToKBForHistogram(j2));
                    ...
                    if (obj == jobServiceContext.mRunningCallback) {
                        ...
                        if (jobCallback.mStoppedReason != null) {
                            ...
                            TimeUtils.formatDuration(
                                    SystemClock.elapsedRealtime() - jobCallback.mStoppedTime, sb);
                            sb.append(" because: ");
    ...
    public static void m621$$Nest$mhandleOpTimeoutLocked(JobServiceContext jobServiceContext) {
        ...
        if (i == 0) {
            jobServiceContext.onSlowAppResponseLocked(
        ...
        if (i == 1) {
            jobServiceContext.onSlowAppResponseLocked(
                    ...
                    CompatChanges.isChangeEnabled(
                            258236856L, jobServiceContext.mRunningJob.callingUid),
        ...
        if (jobServiceContext.mPendingStopReason != 0) {
            if (!jobServiceContext.mService.isReadyToBeExecutedLocked(
                    jobServiceContext.mRunningJob, false)) {
                Slog.i(
                        "JobServiceContext",
                        "JS was waiting to stop this job. Sending onStop: "
                                + jobServiceContext.getRunningJobNameLocked());
                jobServiceContext.mParams.setStopReason(
                        jobServiceContext.mPendingStopReason,
                        jobServiceContext.mPendingInternalStopReason,
                        jobServiceContext.mPendingDebugStopReason);
        ...
        String shouldStopRunningJobLocked =
                jobServiceContext.mJobConcurrencyManager.shouldStopRunningJobLocked(
                        jobServiceContext);
    ...
    public final boolean assertCallerLocked(JobCallback jobCallback) {
        ...
        if (!this.mPreviousJobHadSuccessfulFinish
                && elapsedRealtime - this.mLastUnsuccessfulFinishElapsed < 15000) {
            return false;
        }
        StringBuilder m =
                BootReceiver$$ExternalSyntheticOutline0.m(128, "Caller no longer running");
        if (jobCallback.mStoppedReason != null) {
        ...
        if (i3 == 4 || i3 == 3) {
            if (DEBUG) {
                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                        new StringBuilder("Too late to process cancel for context (verb="),
                        this.mVerb,
                        "), ignoring.",
                        "JobServiceContext");
                return;
    ...
    */
    public final void closeAndCleanupJobLocked(java.lang.String r83, boolean r84) {
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.job.JobServiceContext.closeAndCleanupJobLocked(java.lang.String,"
                    + " boolean):void");
    }
    ...
    public final void doCallbackLocked(String str, boolean z) {
        ...
        if (z2) {
            ...
            BootReceiver$$ExternalSyntheticOutline0.m(
                    sb, VERB_STRINGS[this.mVerb], "JobServiceContext");
        }
        ...
        if (i != 1) {
            Slog.e(
                    "JobServiceContext",
                    "Handling started job but job wasn't starting! Was "
        ...
        if (this.mCancelled) {
            if (z2) {
                Slog.d(
                        "JobServiceContext",
                        "Job cancelled while waiting for onStartJob to complete.");
            }
    ...
    public final void doServiceBoundLocked() {
        ...
        if (this.mVerb != 0) {
            BinaryTransparencyService$$ExternalSyntheticOutline0.m$1(
                    new StringBuilder("Sending onStartJob for a job that isn't pending. "),
                    VERB_STRINGS[this.mVerb],
                    "JobServiceContext");
        ...
        try {
            ...
            Slog.e(
                    ...
                    "Error sending onStart message to '"
                            + this.mRunningJob.job.getService().getShortClassName()
                            + "' ",
                    e);
        }
    }
    ...
    public final void dumpLocked(IndentingPrintWriter indentingPrintWriter, long j) {
        ...
        TimeUtils.formatDuration(
                (this.mExecutionStartTimeElapsed + this.mMaxExecutionTimeMillis) - j,
                indentingPrintWriter);
        indentingPrintWriter.print("]");
    ...
    */
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean executeRunnableJob(
            com.android.server.job.controllers.JobStatus r77, int r78) {
        /*
    ...
    public final void handleCancelLocked(String str) {
        ...
        if (i == 0 || i == 1) {
            ...
            VaultKeeperService$$ExternalSyntheticOutline0.m(
                    new StringBuilder("Cancelling a job without a valid verb: "),
                    this.mVerb,
                    "JobServiceContext");
        }
    }
    ...
    public final void informOfNetworkChangeLocked(Network network) {
        ...
        if (network != null
            ...
            if (DEBUG) {
                Slog.d(
                        "JobServiceContext",
                        "Skipping network change call because of missing permissions");
                return;
            }
            return;
        }
        if (this.mVerb == 2) {
            try {
                ...
                closeAndCleanupJobLocked(
                        "host crashed when trying to inform of network change", true);
                return;
            }
        }
        Slog.w(
    ...
    public final void onSlowAppResponseLocked(
        ...
        if (z3) {
            ...
            activityManagerInternal.appNotResponding(
                    jobStatus.serviceProcessName,
                    jobStatus.callingUid,
                    TimeoutRecord.forJobService(str3));
        }
