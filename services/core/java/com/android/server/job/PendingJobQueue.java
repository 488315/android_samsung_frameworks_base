...
public class PendingJobQueue {
  ...
  public final PriorityQueue mOrderedQueues =
      new PriorityQueue(
          new Comparator() { // from class:
                             // com.android.server.job.PendingJobQueue$$ExternalSyntheticLambda0
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
              int lambda$new$0;
              lambda$new$0 =
                  PendingJobQueue.lambda$new$0(
                      (PendingJobQueue.AppJobQueue) obj, (PendingJobQueue.AppJobQueue) obj2);
              return lambda$new$0;
            }
          });
  public int mSize = 0;
  ...
  public static /* synthetic */ int lambda$new$0(
      AppJobQueue appJobQueue, AppJobQueue appJobQueue2) {
  ...
  public JobStatus next() {
    ...
    if (appJobQueue2 != null) {
      ...
      this.mPullCount = i;
      if (i >= min
          || ((jobStatus != null && appJobQueue2.peekNextOverrideState() != jobStatus.overrideState)
  ...
  public final class AppJobQueue {
    ...
    public static final Comparator sJobComparator =
        new Comparator() { // from class:
                           // com.android.server.job.PendingJobQueue$AppJobQueue$$ExternalSyntheticLambda0
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            int lambda$static$0;
            lambda$static$0 =
                PendingJobQueue.AppJobQueue.lambda$static$0(
                    (PendingJobQueue.AppJobQueue.AdjustedJobStatus) obj,
                    (PendingJobQueue.AppJobQueue.AdjustedJobStatus) obj2);
    ...
    public static /* synthetic */ int lambda$static$0(
        AdjustedJobStatus adjustedJobStatus, AdjustedJobStatus adjustedJobStatus2) {
      JobStatus jobStatus;
      JobStatus jobStatus2;
      int effectivePriority;
      int effectivePriority2;
      if (adjustedJobStatus == adjustedJobStatus2
          || (jobStatus = adjustedJobStatus.job) == (jobStatus2 = adjustedJobStatus2.job)) {
        return 0;
      }
      ...
      if (Objects.equals(jobStatus.getNamespace(), jobStatus2.getNamespace())
          && (effectivePriority = jobStatus.getEffectivePriority())
              != (effectivePriority2 = jobStatus2.getEffectivePriority())) {
    ...
    public void add(JobStatus jobStatus) {
      ...
      if (binarySearch > 0) {
        adjustedJobStatus.adjustedEnqueueTime =
            Math.max(
                ((AdjustedJobStatus) this.mJobs.get(binarySearch - 1)).adjustedEnqueueTime,
                adjustedJobStatus.adjustedEnqueueTime);
      }
    ...
    public void addAll(List list) {
      ...
      for (int max = Math.max(i, 1); max < size2; max++) {
        ...
        adjustedJobStatus2.adjustedEnqueueTime =
            Math.max(
                adjustedJobStatus2.adjustedEnqueueTime,
                ((AdjustedJobStatus) this.mJobs.get(max - 1)).adjustedEnqueueTime);
      }
    }
