...
public class JobConcurrencyManager {
    ...
    public JobConcurrencyManager(JobSchedulerService jobSchedulerService, Injector injector) {
        ...
        this.mShouldRestrictBgUser = testableContext.getResources().getBoolean(R.bool.config_freeformWindowManagement);
    }
    ...
    */
    public void determineAssignmentsLocked(ArraySet arraySet, ArraySet arraySet2, List list, List list2, AssignmentInfo assignmentInfo) {
        boolean z;
                        ...
                        if (!hasImmediacyPrivilegeLocked) {
                            ...
                            if (contextAssignment3 == null) {
                                ...
                                if (this.mIdleContexts.size() > 0) {
                                    ...
                                    createNewJobServiceContext2 = (JobServiceContext) arraySet5.removeAt(arraySet5.size() - 1);
                                } else {
                            ...
                            if (contextAssignment2 == null && this.mMaxWaitTimeBypassEnabled) {
                                ...
                                if (z5) {
                                    ...
                                    if (this.mIdleContexts.size() > 0) {
                                        ...
                                        createNewJobServiceContext = (JobServiceContext) arraySet6.removeAt(arraySet6.size() - 1);
                                    } else {
                                        createNewJobServiceContext = createNewJobServiceContext();
                                    }
                                    contextAssignment2.context = createNewJobServiceContext;
    ...
    public void dumpLocked(final IndentingPrintWriter indentingPrintWriter, long j, long j2) {
        ...
        try {
            ...
            this.mActivePkgStats.forEach(new Consumer() { // from class: com.android.server.job.JobConcurrencyManager$$ExternalSyntheticLambda3
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    JobConcurrencyManager.PackageStats.m7463$$Nest$mdumpLocked((JobConcurrencyManager.PackageStats) obj, indentingPrintWriter);
                }
            });
            indentingPrintWriter.decreaseIndent();
            indentingPrintWriter.println();
    ...
    class GracePeriodObserver extends UserSwitchObserver {
        ...
        public GracePeriodObserver(Context context) {
            this.mGracePeriod = Math.max(0, context.getResources().getInteger(R.integer.config_longPressOnHomeBehavior));
        }
    ...
    class PackageStats {
        ...
        public static /* bridge */ /* synthetic */ void m7463$$Nest$mdumpLocked(PackageStats packageStats, IndentingPrintWriter indentingPrintWriter) {
