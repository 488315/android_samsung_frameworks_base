...
public class JobConcurrencyManager {
  ...
  static {
        ...
        new WorkConfigLimitsPerMemoryTrimLevel(
            ...
            new WorkTypeConfig(
                ...
                List.of(
                    ...
                    Pair.create(32, Float.valueOf(0.1f)),
                    Pair.create(64, Float.valueOf(0.1f)))));
    sDeterminationComparator =
        new Comparator() { // from class:
                           // com.android.server.job.JobConcurrencyManager$$ExternalSyntheticLambda2
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            int lambda$static$0;
            lambda$static$0 =
                JobConcurrencyManager.lambda$static$0(
                    (JobConcurrencyManager.ContextAssignment) obj,
                    (JobConcurrencyManager.ContextAssignment) obj2);
    ...
    sConcurrencyHistogramLogger =
        new Histogram(
            ...
            new Histogram.UniformOptions(100, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, 99.0f));
  }
  ...
  public static /* synthetic */ int lambda$static$0(
      ContextAssignment contextAssignment, ContextAssignment contextAssignment2) {
    ...
    return Long.compare(
        contextAssignment2.context.getExecutionStartTimeElapsed(),
        contextAssignment.context.getExecutionStartTimeElapsed());
  }
  ...
  public JobConcurrencyManager(JobSchedulerService jobSchedulerService, Injector injector) {
    ...
    this.mPackageStatsStagingCountClearer =
        new Consumer() { // from class:
                         // com.android.server.job.JobConcurrencyManager$$ExternalSyntheticLambda0
          ...
          public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
              ...
              case "android.os.action.DEVICE_IDLE_MODE_CHANGED":
                if (JobConcurrencyManager.this.mPowerManager == null
                    || !JobConcurrencyManager.this.mPowerManager.isDeviceIdleMode()) {
                  return;
                }
              ...
              case "android.os.action.POWER_SAVE_MODE_CHANGED":
                if (JobConcurrencyManager.this.mPowerManager == null
                    || !JobConcurrencyManager.this.mPowerManager.isPowerSaveMode()) {
                  return;
                }
                synchronized (JobConcurrencyManager.this.mLock) {
    ...
    this.mShouldRestrictBgUser =
        testableContext.getResources().getBoolean(R.bool.config_freeformWindowManagement);
  }
  ...
  public void onSystemReady() {
    ...
    try {
      ActivityManager.getService()
          .registerUserSwitchObserver(this.mGracePeriodObserver, "JobScheduler.Concurrency");
  ...
  public void onThirdPartyAppsCanStart() {
    ...
    for (int i = 0; i < this.mSteadyStateConcurrencyLimit; i++) {
      ...
      arraySet.add(
          injector.createJobServiceContext(
              jobSchedulerService,
              this,
              this.mNotificationCoordinator,
              asInterface,
              jobSchedulerService.mJobPackageTracker,
  ...
  public final void rampUpForScreenOff() {
    synchronized (this.mLock) {
      if (this.mEffectiveInteractiveState) {
        ...
        if (this.mLastScreenOffRealtime + this.mScreenOffAdjustmentDelayMs
  ...
  public final boolean isSimilarJobRunningLocked(JobStatus jobStatus) {
    for (int size = this.mRunningJobs.size() - 1; size >= 0; size--) {
      ...
      if (jobStatus.matches(
          jobStatus2.getUid(), jobStatus2.getNamespace(), jobStatus2.getJobId())) {
        return true;
      }
    }
    return false;
  ...
  public final void updateCounterConfigLocked() {
    if (refreshSystemStateLocked()) {
      WorkConfigLimitsPerMemoryTrimLevel workConfigLimitsPerMemoryTrimLevel =
          this.mEffectiveInteractiveState ? CONFIG_LIMITS_SCREEN_ON : CONFIG_LIMITS_SCREEN_OFF;
  ...
  public final void assignJobsToContextsInternalLocked() {
    ...
    if (z) {
      Slog.d(
          "JobScheduler.Concurrency",
          printAssignments(
              "running jobs initial", this.mRecycledStoppable, this.mRecycledPreferredUidOnly));
    }
  ...
  */
  public void determineAssignmentsLocked(
      ArraySet arraySet, ArraySet arraySet2, List list, List list2, AssignmentInfo assignmentInfo) {
    boolean z;
    ...
    List list4 = this.mActiveServices;
    ...
    while (true) {
      ...
      if (this.mRunningJobs.contains(next)) {
        ...
        boolean z11 = z10;
        boolean hasImmediacyPrivilegeLocked =
            hasImmediacyPrivilegeLocked(next, this.mRecycledPrivilegedState);
        ...
        if (arraySet2.size() > 0) {
          ...
          contextAssignment = (ContextAssignment) arraySet4.valueAt(size3);
          i = size2;
          boolean z16 =
              contextAssignment.preferredUid == next.getUid()
                  || contextAssignment.preferredUid == -1;
          ...
          if (z16 && z13 && canJobStart2 != 0) {
            ...
            if (contextAssignment == null && list2.size() > 0) {
              size = list2.size() - 1;
              while (size >= 0) {
                ContextAssignment contextAssignment5 = (ContextAssignment) list3.get(size);
                ...
                if (hasImmediacyPrivilegeLocked || z14) {
                  ...
                  contextAssignment4 = contextAssignment;
                  z6 =
                      runningJobLocked.lastEvaluatedBias < 40
                          || this.mService.evaluateJobBiasLocked(runningJobLocked) < 40
                          || assignmentInfo2.numRunningImmediacyPrivileged
                              > this.mWorkTypeConfig.getMaxTotal() / 2;
                }
                ...
                if (z6
                    && (canJobStart =
                            this.mWorkCountTracker.canJobStart(
                                jobWorkTypes, contextAssignment5.context.getRunningJobWorkType()))
                        != 0) {
            ...
            if (contextAssignment2 == null || (z14 && !hasImmediacyPrivilegeLocked)) {
              ...
              while (size4 >= 0) {
                ContextAssignment contextAssignment6 = (ContextAssignment) list.get(size4);
                JobStatus runningJobLocked2 = contextAssignment6.context.getRunningJobLocked();
                boolean z18 = z17;
                long j6 = min;
                if (runningJobLocked2.getUid() == next.getUid()
                    && (i3 = this.mService.evaluateJobBiasLocked(runningJobLocked2))
                        < next.lastEvaluatedBias) {
            ...
            if (!hasImmediacyPrivilegeLocked) {
              if (contextAssignment2 == null
                  || contextAssignment2.context.getRunningJobLocked() == null) {
                arraySet3 = arraySet;
              ...
              if (contextAssignment3 == null) {
                ...
                ContextAssignment contextAssignment7 =
                    (ContextAssignment) this.mContextAssignmentPool.acquire();
                ...
                if (this.mIdleContexts.size() > 0) {
                  ArraySet arraySet5 = this.mIdleContexts;
                  createNewJobServiceContext2 =
                      (JobServiceContext) arraySet5.removeAt(arraySet5.size() - 1);
                } else {
              ...
              if (contextAssignment2 == null && this.mMaxWaitTimeBypassEnabled) {
                ...
                if (z5) {
                  ...
                  ContextAssignment contextAssignment8 =
                      (ContextAssignment) this.mContextAssignmentPool.acquire();
                  ...
                  if (this.mIdleContexts.size() > 0) {
                    ArraySet arraySet6 = this.mIdleContexts;
                    createNewJobServiceContext =
                        (JobServiceContext) arraySet6.removeAt(arraySet6.size() - 1);
                  } else {
                    createNewJobServiceContext = createNewJobServiceContext();
                  }
                  contextAssignment2.context = createNewJobServiceContext;
                ...
                i2 = i;
                PackageStats pkgStatsLocked =
                    getPkgStatsLocked(next.getSourceUserId(), next.getSourcePackageName());
                if (contextAssignment2 != null) {
                  arraySet3.add(contextAssignment2);
                ...
                if (z4) {
                  ...
                  this.mActivePkgStats.add(
                      next.getSourceUserId(), next.getSourcePackageName(), pkgStatsLocked);
                }
                arraySet4 = arraySet2;
                j3 = j2;
    ...
    for (int size = arraySet.size() - 1; size >= 0; size--) {
      ...
      if (runningJobLocked != null) {
        ...
        contextAssignment.context.cancelExecutingJobLocked(
            contextAssignment.preemptReasonCode, 2, contextAssignment.preemptReason);
      } else {
        ...
        if (DEBUG) {
          Slog.d(
              ...
              "About to run job on context "
                  + contextAssignment.context.getId()
                  + ", job: "
                  + jobStatus);
        }
  ...
  public final void cleanUpAfterAssignmentChangesLocked(
      ArraySet arraySet,
      ArraySet arraySet2,
      List list,
      List list2,
  ...
  public boolean hasImmediacyPrivilegeLocked(JobStatus jobStatus, SparseIntArray sparseIntArray) {
    ...
    BackgroundStartPrivileges backgroundStartPrivileges =
        activityManagerInternal.getBackgroundStartPrivileges(sourceUid);
    if (DEBUG) {
      Slog.d(
          "JobScheduler.Concurrency",
          "Job " + jobStatus.toShortString() + " bsp state: " + backgroundStartPrivileges);
    }
  ...
  public void maybeStopOvertimeJobsLocked(JobRestriction jobRestriction) {
    for (int size = this.mActiveServices.size() - 1; size >= 0; size--) {
      ...
      if (runningJobLocked != null
          && !jobServiceContext.isWithinExecutionGuaranteeTime()
          && jobRestriction.isJobRestricted(runningJobLocked)) {
        jobServiceContext.cancelExecutingJobLocked(
            jobRestriction.getStopReason(),
            jobRestriction.getInternalReason(),
            JobParameters.getInternalReasonCodeDescription(jobRestriction.getInternalReason()));
      }
    }
  }
  ...
  public void markJobsForUserStopLocked(int i, String str, String str2) {
    for (int size = this.mActiveServices.size() - 1; size >= 0; size--) {
      ...
      JobStatus runningJobLocked = jobServiceContext.getRunningJobLocked();
      if (runningJobLocked != null
          && i == runningJobLocked.getUserId()
          && runningJobLocked.getServiceComponent().getPackageName().equals(str)) {
    ...
    for (int i = 0; i < this.mActiveServices.size(); i++) {
      ...
      if (runningJobLocked != null) {
        if (!runningJobLocked.isReady()) {
          if (runningJobLocked.getEffectiveStandbyBucket() == 5
              && runningJobLocked.getStopReason() == 12) {
            jobServiceContext.cancelExecutingJobLocked(
                runningJobLocked.getStopReason(), 6, "cancelled due to restricted bucket");
          } else {
            jobServiceContext.cancelExecutingJobLocked(
                runningJobLocked.getStopReason(), 1, "cancelled due to unsatisfied constraints");
          }
        } else {
          ...
          if (checkIfRestricted != null) {
            ...
            jobServiceContext.cancelExecutingJobLocked(
                checkIfRestricted.getStopReason(),
                internalReason,
                "restricted due to "
  ...
  public final void noteConcurrency(boolean z) {
    this.mService.mJobPackageTracker.noteConcurrency(
        this.mRunningJobs.size(), this.mWorkCountTracker.getRunningJobCount(1));
    if (z) {
  ...
  public boolean isPkgConcurrencyLimitedLocked(JobStatus jobStatus) {
    PackageStats packageStats;
    if (jobStatus.lastEvaluatedBias < 40
        && this.mService.getPendingJobQueue().size() + this.mRunningJobs.size()
            >= this.mWorkTypeConfig.getMaxTotal()
        && (packageStats =
                (PackageStats)
      ...
      return jobStatus.shouldTreatAsExpeditedJob()
          ? packageStats.numRunningEj + packageStats.numStagedEj >= this.mPkgConcurrencyLimitEj
  ...
  public final void startJobLocked(
      JobServiceContext jobServiceContext, JobStatus jobStatus, int i) {
    List list = this.mService.mControllers;
    int size = list.size();
    PowerManager.WakeLock newWakeLock = this.mPowerManager.newWakeLock(1, jobStatus.getTag());
    newWakeLock.setWorkSource(
        this.mService.deriveWorkSource(jobStatus.getSourceUid(), jobStatus.getSourcePackageName()));
    ...
    if (!jobServiceContext.executeRunnableJob(jobStatus, i)) {
      ...
      JobSchedulerPackageFilter.getInstance()
          .addRunningJobs(jobStatus.getJob(), jobStatus.getUid());
      ...
      this.mActivePkgStats.add(
          jobStatus.getSourceUserId(), jobStatus.getSourcePackageName(), pkgStatsLocked);
  ...
  public void onJobCompletedLocked(
      JobServiceContext jobServiceContext, JobStatus jobStatus, int i) {
    String str;
    int jobWorkTypes;
    int canJobStart;
    ...
    PackageStats packageStats =
        (PackageStats)
            this.mActivePkgStats.get(jobStatus.getSourceUserId(), jobStatus.getSourcePackageName());
    if (packageStats == null) {
      ...
      if (this.mMaxWaitTimeBypassEnabled) {
        ...
        for (int size = this.mActiveServices.size() - 1; size >= 0; size--) {
          j =
              Math.min(
                  j,
                  ((JobServiceContext) this.mActiveServices.get(size))
                      .getRemainingGuaranteedTimeMs(millis));
        }
        z =
            true
                ^ (this.mWorkCountTracker.getPendingJobCount(4) <= 0
                    ? !(this.mWorkCountTracker.getPendingJobCount(8) <= 0
                        ? j < this.mMaxWaitRegularMs
                        : j < this.mMaxWaitEjMs)
                    : j >= this.mMaxWaitUIMs);
      }
      if (z) {
    ...
    if (jobServiceContext.getPreferredUid() != -1) {
      ...
      while (true) {
        ...
        if (this.mRunningJobs.contains(next)) {
          ...
          if (jobServiceContext.getPreferredUid() != next.getUid()) {
            if (jobStatus3 == null
                && !isPkgConcurrencyLimitedLocked(next)
                && (canJobStart2 =
                        this.mWorkCountTracker.canJobStart((jobWorkTypes2 = getJobWorkTypes(next))))
                    != 0) {
              i5 = jobWorkTypes2;
              jobStatus3 = next;
              i4 = canJobStart2;
            }
          } else if ((next.lastEvaluatedBias > jobStatus.lastEvaluatedBias
                  || !isPkgConcurrencyLimitedLocked(next))
              && (jobStatus2 == null || jobStatus2.lastEvaluatedBias < next.lastEvaluatedBias)) {
      ...
      if (jobStatus2 != null) {
        ...
        if (z2) {
          Slog.d(
              "JobScheduler.Concurrency",
              "Couldn't find preemption job for uid " + jobServiceContext.getPreferredUid());
        }
        jobServiceContext.clearPreferredUid();
        if (jobStatus3 != null) {
          if (z2) {
      ...
      if (pendingJobQueue.size() > 0) {
        ...
        while (true) {
          ...
          if (this.mRunningJobs.contains(next2)) {
            ...
            if (!isPkgConcurrencyLimitedLocked(next2)
                && (canJobStart =
                        this.mWorkCountTracker.canJobStart((jobWorkTypes = getJobWorkTypes(next2))))
                    != 0
                && (jobStatus2 == null || jobStatus2.lastEvaluatedBias < next2.lastEvaluatedBias)) {
              jobStatus2 = next2;
              i7 = jobWorkTypes;
              i6 = canJobStart;
            }
  ...
  public String shouldStopRunningJobLocked(JobServiceContext jobServiceContext) {
    ...
    if (checkIfRestricted != null) {
      return "restriction:"
          + JobParameters.getInternalReasonCodeDescription(checkIfRestricted.getInternalReason());
    }
    updateCounterConfigLocked();
    int runningJobWorkType = jobServiceContext.getRunningJobWorkType();
    if (this.mRunningJobs.size() > this.mWorkTypeConfig.getMaxTotal()
        || this.mWorkCountTracker.isOverTypeLimit(runningJobWorkType)) {
    ...
    if (!runningJobLocked.shouldTreatAsExpeditedJob() && !runningJobLocked.startedAsExpeditedJob) {
      ...
      do {
        ...
        int jobWorkTypes = getJobWorkTypes(next);
        if ((jobWorkTypes & i) > 0
            && this.mWorkCountTracker.canJobStart(jobWorkTypes, runningJobWorkType) != 0) {
    ...
    if (runningJobWorkType == 32 || runningJobWorkType == 64) {
      ...
      if (this.mWorkCountTracker.getPendingJobCount(8) > 0
          && this.mWorkCountTracker.canJobStart(8, runningJobWorkType) != 0) {
  ...
  public boolean executeStopCommandLocked(
  ...
  public Pair getEstimatedNetworkBytesLocked(String str, int i, String str2, int i2) {
    for (int i3 = 0; i3 < this.mActiveServices.size(); i3++) {
      ...
      JobStatus runningJobLocked = jobServiceContext.getRunningJobLocked();
      if (runningJobLocked != null
          && runningJobLocked.matches(i, str2, i2)
          && runningJobLocked.getSourcePackageName().equals(str)) {
  ...
  public boolean isNotificationAssociatedWithAnyUserInitiatedJobs(int i, int i2, String str) {
    return this.mNotificationCoordinator.isNotificationAssociatedWithAnyUserInitiatedJobs(
        i, i2, str);
  }

  public boolean isNotificationChannelAssociatedWithAnyUserInitiatedJobs(
      String str, int i, String str2) {
    return this.mNotificationCoordinator.isNotificationChannelAssociatedWithAnyUserInitiatedJobs(
        str, i, str2);
  }

  public final JobServiceContext createNewJobServiceContext() {
    return this.mInjector.createJobServiceContext(
        this.mService,
        this,
        this.mNotificationCoordinator,
        IBatteryStats.Stub.asInterface(ServiceManager.getService("batterystats")),
        this.mService.mJobPackageTracker,
        AppSchedulingModuleThread.get().getLooper());
  }
  ...
  public void updateConfigLocked() {
    ...
    this.mSteadyStateConcurrencyLimit =
        Math.max(
            8, Math.min(64, properties.getInt("concurrency_limit", DEFAULT_CONCURRENCY_LIMIT)));
  ...
  public void dumpLocked(final IndentingPrintWriter indentingPrintWriter, long j, long j2) {
    ...
    try {
      ...
      indentingPrintWriter
          ...
          .println();
      indentingPrintWriter
          .print(KEY_PKG_CONCURRENCY_LIMIT_EJ, Integer.valueOf(this.mPkgConcurrencyLimitEj))
          .println();
      indentingPrintWriter
          .print(
              KEY_PKG_CONCURRENCY_LIMIT_REGULAR, Integer.valueOf(this.mPkgConcurrencyLimitRegular))
          .println();
      indentingPrintWriter
          .print(KEY_ENABLE_MAX_WAIT_TIME_BYPASS, Boolean.valueOf(this.mMaxWaitTimeBypassEnabled))
          .println();
      ...
      this.mActivePkgStats.forEach(
          new Consumer() { // from class:
            ...
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              JobConcurrencyManager.PackageStats.m7463$$Nest$mdumpLocked(
                  (JobConcurrencyManager.PackageStats) obj, indentingPrintWriter);
            }
          });
      indentingPrintWriter.decreaseIndent();
      indentingPrintWriter.println();
  ...
  public void dumpContextInfoLocked(
      IndentingPrintWriter indentingPrintWriter, Predicate predicate, long j, long j2) {
      ...
      if (runningJobLocked == null || predicate.test(runningJobLocked)) {
        ...
        if (runningJobLocked != null) {
          ...
          TimeUtils.formatDuration(
              runningJobLocked.madeActive - runningJobLocked.madePending, indentingPrintWriter);
          indentingPrintWriter.decreaseIndent();
          indentingPrintWriter.println();
        }
      }
  ...
  public boolean shouldRunAsFgUserJob(JobStatus jobStatus) {
    ...
    return ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
            ...
            == sourceUserId
        || userInfo.isPrimary()
        || this.mGracePeriodObserver.isWithinGracePeriodForUser(sourceUserId);
  }
  ...
  class WorkTypeConfig {
    ...
    public WorkTypeConfig(String str, int i, int i2, List list, List list2) {
      ...
      for (int size = list.size() - 1; size >= 0; size--) {
        ...
        if (floatValue < DisplayPowerController2.RATE_FROM_DOZE_TO_ON || 1.0f <= floatValue) {
          throw new IllegalArgumentException(
              "Invalid default min ratio: wt=" + intValue + " minRatio=" + floatValue);
        }
      ...
      for (int size2 = list2.size() - 1; size2 >= 0; size2--) {
        ...
        if (floatValue2 < Float.intBitsToFloat(this.mDefaultMinReservedSlotsRatio.get(intValue2, 0))
            || floatValue2 <= DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
          throw new IllegalArgumentException(
              "Invalid default config: t=" + i2 + " min=" + list + " max=" + list2);
        }
    ...
    public void update(DeviceConfig.Properties properties, int i) {
      this.mMaxTotal =
          Math.max(
              ...
              Math.min(
                  i,
                  properties.getInt(
                      KEY_PREFIX_MAX_TOTAL + this.mConfigIdentifier, this.mDefaultMaxTotal)));
      int floatToIntBits = Float.floatToIntBits(1.0f);
      this.mMaxAllowedSlots.clear();
      int maxValue =
          getMaxValue(
              properties, "concurrency_max_ratio_top_" + this.mConfigIdentifier, 1, floatToIntBits);
      this.mMaxAllowedSlots.put(1, maxValue);
      int maxValue2 =
          getMaxValue(
              properties, "concurrency_max_ratio_fgs_" + this.mConfigIdentifier, 2, floatToIntBits);
      this.mMaxAllowedSlots.put(2, maxValue2);
      int maxValue3 =
          getMaxValue(
              properties, "concurrency_max_ratio_ui_" + this.mConfigIdentifier, 4, floatToIntBits);
      this.mMaxAllowedSlots.put(4, maxValue3);
      int maxValue4 =
          getMaxValue(
              properties, "concurrency_max_ratio_ej_" + this.mConfigIdentifier, 8, floatToIntBits);
      this.mMaxAllowedSlots.put(8, maxValue4);
      int maxValue5 =
          getMaxValue(
              properties, "concurrency_max_ratio_bg_" + this.mConfigIdentifier, 16, floatToIntBits);
      this.mMaxAllowedSlots.put(16, maxValue5);
      int maxValue6 =
          getMaxValue(
              properties,
              "concurrency_max_ratio_bguser_important_" + this.mConfigIdentifier,
              32,
              floatToIntBits);
      ...
      int maxValue7 =
          getMaxValue(
              properties,
              "concurrency_max_ratio_bguser_" + this.mConfigIdentifier,
              64,
              floatToIntBits);
      ...
      int minValue =
          getMinValue(
              properties,
              "concurrency_min_ratio_top_" + this.mConfigIdentifier,
              1,
              1,
      ...
      int minValue2 =
          getMinValue(
              properties,
              "concurrency_min_ratio_fgs_" + this.mConfigIdentifier,
              2,
              0,
      ...
      int minValue3 =
          getMinValue(
              properties,
              "concurrency_min_ratio_ui_" + this.mConfigIdentifier,
              4,
              0,
      ...
      int minValue4 =
          getMinValue(
              properties,
              "concurrency_min_ratio_ej_" + this.mConfigIdentifier,
              8,
              0,
      ...
      int minValue5 =
          getMinValue(
              properties,
              "concurrency_min_ratio_bg_" + this.mConfigIdentifier,
              16,
              0,
      ...
      int minValue6 =
          getMinValue(
              properties,
              "concurrency_min_ratio_bguser_important_" + this.mConfigIdentifier,
              32,
              0,
      ...
      this.mMinReservedSlots.put(
          ...
          getMinValue(
              properties,
              "concurrency_min_ratio_bguser_" + this.mConfigIdentifier,
              64,
              0,
          ...
          (int)
              (this.mMaxTotal
                  * Math.min(
                      ...
                      properties.getFloat(
                          str,
                          Float.intBitsToFloat(this.mDefaultMaxAllowedSlotsRatio.get(i, i2))))));
    }
              ...
              (int)
                  (this.mMaxTotal
                      * Math.min(
                          ...
                          properties.getFloat(
                              str,
                              Float.intBitsToFloat(this.mDefaultMinReservedSlotsRatio.get(i)))))));
    }
    ...
    public void dump(IndentingPrintWriter indentingPrintWriter) {
      indentingPrintWriter
          .print(KEY_PREFIX_MAX_TOTAL + this.mConfigIdentifier, Integer.valueOf(this.mMaxTotal))
          .println();
      indentingPrintWriter
          .print(
              "concurrency_min_ratio_top_" + this.mConfigIdentifier,
      ...
      indentingPrintWriter
          .print(
              "concurrency_max_ratio_top_" + this.mConfigIdentifier,
      ...
      indentingPrintWriter
          .print(
              "concurrency_max_ratio_fgs_" + this.mConfigIdentifier,
      ...
      indentingPrintWriter
          .print(
              "concurrency_max_ratio_ui_" + this.mConfigIdentifier,
      ...
      indentingPrintWriter
          .print(
              "concurrency_max_ratio_ej_" + this.mConfigIdentifier,
      ...
      indentingPrintWriter
          .print(
              "concurrency_max_ratio_bg_" + this.mConfigIdentifier,
  ...
  class GracePeriodObserver extends UserSwitchObserver {
    ...
    public GracePeriodObserver(Context context) {
      this.mGracePeriod =
          Math.max(0, context.getResources().getInteger(R.integer.config_longPressOnHomeBehavior));
    }
  ...
  class WorkCountTracker {
    ...
    public void setConfig(WorkTypeConfig workTypeConfig) {
      ...
      for (int size = this.mNumRunningJobs.size() - 1; size >= 0; size--) {
        this.mNumUnspecializedRemaining -=
            Math.max(
                this.mNumRunningJobs.valueAt(size),
                this.mConfigNumReservedSlots.get(this.mNumRunningJobs.keyAt(size)));
      }
    }
      ...
      if (max < this.mNumActuallyReservedSlots.get(i)) {
        ...
        for (int i3 = 0; i3 < this.mNumActuallyReservedSlots.size(); i3++) {
          ...
          if (i2 == 0 || keyAt < i2) {
            ...
            if (this.mNumActuallyReservedSlots.valueAt(i3) < this.mConfigAbsoluteMaxSlots.get(keyAt)
      ...
      for (int i3 = 1; i3 < 127; i3 <<= 1) {
        ...
        int max =
            Math.max(
                ...
                Math.min(
                    this.mNumUnspecializedRemaining,
                    Math.min(i4, this.mConfigNumReservedSlots.get(i3) - i5)));
      ...
      for (int i6 = 1; i6 < 127; i6 <<= 1) {
        ...
        int max2 =
            Math.max(
                ...
                Math.min(
                    this.mNumUnspecializedRemaining,
                    Math.min(this.mConfigAbsoluteMaxSlots.get(i6), i7) - i8));
    ...
    public int canJobStart(int i) {
      for (int i2 = 1; i2 <= i; i2 <<= 1) {
        if ((i & i2) == i2) {
          if (this.mNumRunningJobs.get(i2) + this.mNumStartingJobs.get(i2)
              < Math.min(
                  this.mConfigAbsoluteMaxSlots.get(i2),
                  this.mNumActuallyReservedSlots.get(i2) + this.mNumUnspecializedRemaining)) {
            return i2;
          }
        }
      }
  ...
  class PackageStats {
    ...
    public static /* bridge */ /* synthetic */ void m7463$$Nest$mdumpLocked(
        PackageStats packageStats, IndentingPrintWriter indentingPrintWriter) {
  ...
  public void addRunningJobForTesting(JobStatus jobStatus) {
    JobServiceContext createNewJobServiceContext;
    this.mRunningJobs.add(jobStatus);
    getPackageStatsForTesting(jobStatus.getSourceUserId(), jobStatus.getSourcePackageName())
  ...
  class Injector {
    public JobServiceContext createJobServiceContext(
        JobSchedulerService jobSchedulerService,
        JobConcurrencyManager jobConcurrencyManager,
        JobNotificationCoordinator jobNotificationCoordinator,
