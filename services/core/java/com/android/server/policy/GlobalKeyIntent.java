...
public final class GlobalKeyIntent {
  ...
  public Intent getIntent() {
    return new Intent("android.intent.action.GLOBAL_BUTTON")
        .setComponent(this.mComponentName)
        .setFlags(268435456)
        .putExtra("android.intent.extra.KEY_EVENT", this.mKeyEvent)
        .putExtra("EXTRA_BEGAN_FROM_NON_INTERACTIVE", this.mBeganFromNonInteractive);
  }
}
