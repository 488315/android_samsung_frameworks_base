...
public class GlobalActions implements GlobalActionsProvider.GlobalActionsListener {
  ...
  public static /* bridge */ /* synthetic */ LegacyGlobalActions
      m10045$$Nest$fgetmLegacyGlobalActions(GlobalActions globalActions) {
  ...
  public GlobalActions(Context context, WindowManagerPolicy.WindowManagerFuncs windowManagerFuncs) {
    ...
    GlobalActionsProvider globalActionsProvider =
        (GlobalActionsProvider) LocalServices.getService(GlobalActionsProvider.class);
  ...
  public boolean isDialogPowerOptionHidden() {
    ...
    if (proKioskManager != null && proKioskManager.getProKioskState()) {
      ...
      Slog.d(
          "GlobalActions",
          "Knox Custom: getPowerDialogOptionMode() : "
              + powerDialogOptionMode
              + " returning : "
              + r0);
    }
    return r0;
