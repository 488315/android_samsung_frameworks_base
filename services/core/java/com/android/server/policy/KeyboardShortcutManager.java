...
public class KeyboardShortcutManager {
  ...
  public String getShortcutSettingsValue(int i) {
    return Settings.System.getStringForUser(
        this.mContext.getContentResolver(), (String) this.mShortcutMap.get(Integer.valueOf(i)), -2);
  }
  ...
  public boolean interceptKeyBeforeDispatching(KeyEvent keyEvent, boolean z, int i) {
    ...
    if (!z2) {
      if (KeyCustomizationConstants.isSafeDebugInput()) {
        Log.d(
            ...
            "interceptKeyTi, up, triggered="
                + this.mIsTriggeredMeta
                + " consumed="
                + this.mIsConsumedMeta);
      }
    ...
    if (!shortcutSettingsValue.contains("android.intent.category.")) {
      if (shortcutSettingsValue.contains("android.app.role.")) {
        i2 = 2;
      } else if ("com.sec.android.app.launcher/com.sec.android.app.launcher.search.SearchActivity"
          .equals(shortcutSettingsValue)) {
        i2 = 3;
    ...
    public void startTargetApp(int i) {
      ...
      if (this.mPolicyExt.showCoverToast(fillInIntent, this.mIntent)) {
        ...
        phoneWindowManagerExt.setPendingIntentAfterUnlock(
            phoneWindowManagerExt.getPendingIntentActivityAsUser(this.mIntent, UserHandle.CURRENT),
            fillInIntent);
        return;
      }
  ...
  public final boolean launch(int i, int i2, String str) {
    ...
    Log.d(
        "KeyboardShortcutManager",
        "launch type=" + typeToString(i2) + " componentName=" + str + " " + preloadBehaviorMap);
  ...
  public boolean launchCustomizationShortcut(int i, int i2, String str, int i3) {
    ...
    if (i2 == 4) {
      Log.v(
          "KeyboardShortcutManager",
          "launch type=settings shortcutSetting=" + str + " keyCode=" + i3);
      return false;
    }
    if (i2 == 5) {
      Log.v(
          "KeyboardShortcutManager", "launch type=HOME shortcutSetting=" + str + " keyCode=" + i3);
    ...
    Log.d(
        "KeyboardShortcutManager",
        "launch type=" + typeToString(i2) + " shortcutSetting= " + str + " " + behavior);
  ...
  public class DefaultBehavior extends Behavior {
    ...
    public DefaultBehavior(
        Context context, PhoneWindowManagerExt phoneWindowManagerExt, String str) {
      super(context, phoneWindowManagerExt);
  ...
  public class GameBoosterToggleMenuBehavior extends Behavior {
    public GameBoosterToggleMenuBehavior(
        Context context, PhoneWindowManagerExt phoneWindowManagerExt) {
      super(context, phoneWindowManagerExt);
    ...
    public boolean preCondition() {
      ...
      try {
        return !this.mContext
            .getPackageManager()
            .getApplicationInfo("com.samsung.android.game.gametools", 128)
            .metaData
  ...
  public final String typeToString(int i) {
    return i != 0
        ? i != 1
            ? i != 2 ? i != 3 ? i != 4 ? Integer.toString(i) : "META_Z" : "META_U" : "META_G"
            : "META_F"
        : "DEFAULT";
  }
}
