...
public class KeyCombinationManager {
        ...
        synchronized (this.mLock) {
            if (forAllActiveRules(new ToBooleanFunction() { // from class: com.android.server.policy.KeyCombinationManager$$ExternalSyntheticLambda1
                public final boolean apply(Object obj) {
                    ...
                    lambda$isPowerKeyIntercepted$5 = KeyCombinationManager.lambda$isPowerKeyIntercepted$5((KeyCombinationManager.TwoKeysCombinationRule) obj);
    ...
    public static /* synthetic */ boolean lambda$isPowerKeyIntercepted$5(TwoKeysCombinationRule twoKeysCombinationRule) {
