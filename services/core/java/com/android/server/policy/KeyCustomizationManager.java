...
public class KeyCustomizationManager {
  ...
  public void init() {
    ...
    this.defaultLongPressTimeout =
        this.mContext
            .getResources()
            .getInteger(R.integer.config_letterboxDefaultPositionForVerticalReachability);
  }
  ...
  */
  public final void checkValidInputKeyCustomizationInfo(
      SemWindowManager.KeyCustomizationInfo keyCustomizationInfo) {
    int i;
    int i2;
    if (keyCustomizationInfo == null) {
      throw new IllegalArgumentException("KeyCustomizationInfo is null.");
    }
    int i3 = keyCustomizationInfo.press;
    int i4 = keyCustomizationInfo.keyCode;
    int i5 = keyCustomizationInfo.action;
    int i6 = keyCustomizationInfo.id;
    if (i4 != 3) {
      if (i4 != 4) {
        if (i4 != 79) {
          if (i4 != 187) {
              ...
              switch (i4) {
                ...
                default:
                  switch (i4) {
                    ...
                    case 1095:
                    case 1096:
                      if ((i3 & 3) == 0 || (i3 & 4) != 0 || (i3 & 8) != 0) {
                        throw new IllegalArgumentException(
                            pressToString(i3)
                                + " is not supported in the requested keyCode("
                                + i4
                                + ").");
                      }
                      break;
                    default:
                      if (KeyEvent.keyCodeFromString(Integer.toString(i4)) == 0
                          || (i3 & 3) == 0
                          || i5 != 4
                          || i6 != 10) {
                        throw new IllegalArgumentException(
                            "requested keyCode("
                                + i4
                                + ") was wrong. The keyCode is not supported.");
                      }
                      break;
                  }
              }
        ...
        if (i5 != 0) {
          if (i6 < 1100 || i6 > 1107) {
            throw new IllegalArgumentException(
                "requested " + actionToString(i5) + " and " + idToString(i6) + " was wrong.");
          }
        } else if (i5 != 1 && i5 != 2 && i5 != 3 && i5 != 4) {
          throw new IllegalArgumentException(
              "requested " + actionToString(i5) + " was wrong. The action is not supported.");
        }
        i = keyCustomizationInfo.dispatching;
        if (i == 0 && i != -1) {
          throw new IllegalArgumentException("requested dispatching(" + i + ") was wrong.");
        }
        if (i6 == 10
            && i6 != 30
            && i6 != 50
            && i6 != 951
            && ((i6 < 1100 || i6 > 1107) && (i6 < 2000 || i6 > 2003))) {
          throw new IllegalArgumentException(
              "requested " + idToString(i6) + " was wrong. The id is not supported.");
        }
        String str = keyCustomizationInfo.ownerPackage;
        if (i6 != 2003 && TextUtils.isEmpty(str)) {
          throw new IllegalArgumentException("requested ownerPackage was empty.");
        }
        i2 = i3 & 3;
        if (i2 != 0
            && (i3 & 4) == 0
            ...
            && (i3 & 64) == 0) {
          throw new IllegalArgumentException(
              "requested " + pressToString(i3) + " was wrong. The press is not supported.");
        }
        if (!CoreRune.FW_TRIPLE_PRESS_POWER_LAUNCH_PANIC_CALL && i4 == 26 && (i3 & 16) != 0) {
          throw new IllegalArgumentException("Triple press of Power key is not supported.");
        }
        if ((!CoreRune.FW_QUINTUPLE_PRESS_POWER_EMERGENCY_SOS
                || CoreRune.FW_TRIPLE_PRESS_POWER_LAUNCH_PANIC_CALL)
            && i4 == 26
            && (i3 & 64) != 0) {
          throw new IllegalArgumentException("Quintuple press of Power key is not supported.");
        }
        int i7 = i3 & 4;
        if ((i7 != 0 || (i3 & 8) != 0) && i6 == 1107) {
          throw new IllegalArgumentException(
              "The long or double press is not supported with mouse button id.");
        }
        long j = keyCustomizationInfo.longPressTimeout;
        if (j != 0 && j < this.defaultLongPressTimeout) {
          throw new IllegalArgumentException("The longPressTimeout was wrong.");
        }
        if (j > 0 && i7 == 0) {
          throw new IllegalArgumentException("The longPressTimeout only supported with long press");
        }
        if (keyCustomizationInfo.multiPressTimeout != 0) {
          if (i2 == 0 && i7 == 0) {
            return;
          }
          throw new IllegalArgumentException(
              "The multiPressTimeout is not supported with " + pressToString(i3));
        }
        return;
      }
    } else if (CoreRune.FW_SUPPORT_SEARCLE_HOME_LONG && (i3 & 4) != 0 && !isKnoxId(i6)) {
      throw new IllegalArgumentException(
          pressToString(i3)
              + " and "
              + idToString(i6)
              + " are not supported in the requested keyCode("
              + i4
              + ").");
    }
    if ((i3 & 3) != 0 && (i5 == 1 || i5 == 3)) {
  ...
  public void putKeyCustomizationInfo(SemWindowManager.KeyCustomizationInfo keyCustomizationInfo) {
    ...
    if (i >= 8 && i3 == 4 && !this.mPolicyExt.mPolicy.mSingleKeyGestureDetector.hasRule(i2)) {
      if (KeyCustomizationConstants.isSafeDebugInput()) {
        Slog.d(
            ...
            "No need to block double press behavior. Because there is no added Rule.");
        return;
      }
      return;
    }
    ...
    if (KeyCustomizationConstants.isSafeDebugInput()) {
      Slog.d(
          "KeyCustomizationManager",
          "putKeyCustomizationInfo keyCode="
              + i2
              + " id="
              + idToString(keyCustomizationInfo.id)
              + " ownerPackage="
              + str
              + " Caller="
              + Debug.getCallers(5));
  ...
  public void removeKeyCustomizationInfoByPackage(String str, int i, int i2) {
    if (KeyCustomizationConstants.isSafeDebugInput()) {
      Slog.d(
          "KeyCustomizationManager",
          "removeKeyCustomizationInfoByPackage ownerPackage="
              + str
              + " keyCode="
              + i2
              + " "
  ...
  public void removeKeyCustomizationInfo(int i, String str, int i2, int i3) {
    ...
    if (this.mKeyCustomizationInfoManager.remove(i, str, i2, i3)) {
      ...
      long multiPressTimeout2 =
          this.mPolicyExt.mPolicy.mSingleKeyGestureDetector.getMultiPressTimeout(i3);
  ...
  public void clearKeyCustomizationInfoByPackage(String str) {
    ...
    if (!this.mKeyCustomizationInfoManager.clearByPackage(str)) {
      Slog.d(
          "KeyCustomizationManager",
          "clearKeyCustomizationInfoByPackage, Requested info is empty. packageName=" + str);
      return;
    }
    for (int i : KeyCustomizationConstants.ALL_KEYCODE_TYPE) {
      if (i == 26) {
  ...
  public void clearKeyCustomizationInfoByKeyCode(int i, int i2) {
    if (KeyCustomizationConstants.isSafeDebugInput()) {
      Slog.d(
          "KeyCustomizationManager",
          "clearKeyCustomizationInfoByKeyCode, " + idToString(i) + " keyCode=" + i2);
    }
    if (!this.mKeyCustomizationInfoManager.clearByKeyCode(i, i2)) {
      Slog.d(
          "KeyCustomizationManager",
          "clearKeyCustomizationInfoByKeyCode, Requested info is empty. "
              + idToString(i)
              + " keyCode="
              + i2);
      return;
    ...
    if (i2 == 26) {
      for (int i3 : KeyCustomizationConstants.NEEDED_UPDATE_BEHAVIOR_MULTI_PRESS_TYPE) {
        if ((!CoreRune.FW_TRIPLE_PRESS_POWER_LAUNCH_PANIC_CALL || (i3 & 16) == 0)
            && (i3 & 64) == 0) {
  ...
  public void clearKeyCustomizationInfoByAction(int i, int i2, int i3) {
    if (KeyCustomizationConstants.isSafeDebugInput()) {
      Slog.d(
          "KeyCustomizationManager",
          "clearKeyCustomizationInfoByAction, "
              + idToString(i)
              + " keyCode="
              + i2
              + " "
    ...
    if (!this.mKeyCustomizationInfoManager.clearByAction(i, i2, i3)) {
      Slog.d(
          "KeyCustomizationManager",
          "clearKeyCustomizationInfoByAction, Requested info is empty. "
              + idToString(i)
              + " keyCode="
              + i2
              + " "
  ...
  public long getMultiPressTimeout(int i, int i2, int i3) {
    SemWindowManager.KeyCustomizationInfo keyCustomizationInfo =
        this.mKeyCustomizationInfoManager.get(i, i2, i3);
    if (keyCustomizationInfo == null) {
      return 0L;
    }
  ...
  public int getLastAction(int i, int i2) {
    SemWindowManager.KeyCustomizationInfo lastKeyCustomizationInfo =
        getLastKeyCustomizationInfo(i, i2);
  ...
  public final void updateMultiPressTimeoutIfNeeded(int i, int i2, long j, boolean z) {
    if ((i & 3) == 0 && (i & 4) == 0) {
      if (j != 0 || z) {
        long multiPressTimeout =
            this.mPolicyExt.mPolicy.mSingleKeyGestureDetector.getMultiPressTimeout(i2);
  ...
  */
  public int sendBroadcast(
    ...
    boolean z2;
    boolean z3;
    boolean migrationForKnoxPolicy;
    Intent intent;
    if (i == 0) {
      return 0;
    }
    int keyCode = keyEvent.getKeyCode();
    if (hasHigherIdWithAllPress(i, keyCode)) {
      return 0;
    }
    if (keyCustomizationInfo == null) {
      SemWindowManager.KeyCustomizationInfo last =
          this.mKeyCustomizationInfoManager.getLast(i, keyCode);
      if (last == null) {
        return 0;
      }
      keyCustomizationInfo2 = last;
    } else {
      keyCustomizationInfo2 = keyCustomizationInfo;
    }
    int i2 = keyCustomizationInfo2.id;
    int i3 = keyCustomizationInfo2.userId;
    boolean z4 = keyEvent.getAction() == 0;
    Intent intent2 = keyCustomizationInfo2.intent;
    if ((i & 4) != 0) {
      z2 = true;
      z3 = false;
    } else if ((i & 8) != 0) {
    ...
    if (intent2 == null) {
      intent2 = getDefaultIntentForKnoxId(i2, keyEvent, z2, z3, z);
    } else if (CoreRune.FW_B2B_DEDICATED_APP && i2 == 951) {
      if (!this.mPolicyExt.mPolicy.isUserSetupComplete()) {
        Log.d("KeyCustomizationManager", "Can not sendBroadcast. The user setup is not complete");
        return 0;
      }
      updateKeyInfoExtra(intent2, keyEvent);
    } else if (isKnoxId(i2)) {
      migrationForKnoxPolicy = migrationForKnoxPolicy(intent2, keyEvent, z2, z3);
      if (!z4 && z) {
        intent2.putExtra(
            "com.samsung.android.knox.intent.extra.EXTRA_REPORT_TYPE_NEW_LONG_UP", true);
      }
      intent = intent2;
      if (intent != null) {
        Log.e(
            "KeyCustomizationManager",
            "Can not sendBroadcast. intent is null. keyCode=" + keyCode + " " + pressToString(i));
        return 0;
      }
      if (!migrationForKnoxPolicy) {
        sendBroadcastAsUser(intent, i3);
      }
      if (isBlockedDispatchingByKnoxPolicy(i2, z4, keyEvent.getRepeatCount(), intent, keyCode)
          || isForceBlockDispatchingLongByKnoxPolicy(i2, i, keyCode)) {
        return -1;
      }
      int i4 = keyCustomizationInfo2.dispatching;
      if (i4 == -1 && isAllowHandleDispatching(keyCode)) {
        return i4;
      }
      return 0;
    }
    intent = intent2;
    migrationForKnoxPolicy = false;
    if (intent != null) {}
  }
  ...
  public void startActivity(SemWindowManager.KeyCustomizationInfo keyCustomizationInfo) {
    ...
    Log.i(
        "KeyCustomizationManager",
        "startActivity. userId=" + i + " Callers=" + Debug.getCallers(3));
    if (this.mPolicyExt.mPolicy.isKeyguardShowing()) {
      this.mPolicyExt.setPendingIntentAfterUnlock(
          this.mPolicyExt.getPendingIntentActivityAsUser(intent, new UserHandle(i)), fillInIntent);
  ...
  public void startService(
    ...
    if (CoreRune.FW_B2B_DEDICATED_APP
        && i3 == 951
  ...
  public void launchPressSendBroadcast(KeyEvent keyEvent, int i, boolean z) {
    SemWindowManager.KeyCustomizationInfo lastKeyCustomizationInfo =
        getLastKeyCustomizationInfo(3, i);
    if (lastKeyCustomizationInfo == null) {
      return;
    }
    Log.d(
  ...
  public final boolean launchPressAction(int i, KeyEvent keyEvent, int i2, boolean z) {
    ...
    Log.d(
        "KeyCustomizationManager",
        "launchPressAction, keyCode=" + i2 + " " + actionToString(i) + " forceDispatching=" + z);
    return true;
  }
  ...
  public boolean launchLongPressAction(int i, KeyEvent keyEvent, int i2) {
    ...
    Log.d(
        "KeyCustomizationManager",
        "launchLongPressAction, keyCode=" + i2 + " " + actionToString(i));
    if (i == 1) {
      startActivity(4, i2);
    } else if (i != 2) {
      if (i == 3) {
        ...
        if (CoreRune.SAFE_DEBUG) {
          Slog.d(
              "KeyCustomizationManager",
              "launchLongPressAction. " + actionToString(i) + " was wrong.");
        }
        return false;
      }
  ...
  public void launchMultiPressAction(KeyEvent keyEvent, int i) {
    ...
    if (i3 == 0
        || (lastKeyCustomizationInfo =
                getLastKeyCustomizationInfo(i3, (keyCode = keyEvent.getKeyCode())))
            == null
        || (i2 = lastKeyCustomizationInfo.action) == 4
    ...
    Log.e(
        "KeyCustomizationManager",
        "launchMultiPressAction, count=" + i + " " + actionToString(i2) + " was wrong.");
  }
  ...
  public int dispatchKeyCustomizationKeyEvent(KeyEvent keyEvent, boolean z) {
    ...
    if (KeyCustomizationConstants.isDebugInput()) {
      Slog.d(
          ...
          "dispatchKeyEvent: keyCode="
              ...
              + isLongPress
              + " pressAction="
              + actionToString(lastAction)
              + " longPressAction="
              + actionToString(lastAction2)
              + " forceDispatching="
              + z3);
    }
    ...
    if (z2) {
      ...
      if (isLongPress) {
        ...
        if (CoreRune.FW_ACTIVE_OR_XCOVER_KEY && hasXCoverTopKeyAndId(4, keyCode)) {
          if (launchXCoverLongActionIfNeeded(keyCode, false)) {
            if (KeyCustomizationConstants.isDebugInput()) {
              Slog.d(
                  "KeyCustomizationManager",
                  "dispatchKeyEvent:longPress - XCoverTopKey Action, NO_NEED_NEXT_STEP");
            }
          ...
          if (KeyCustomizationConstants.isDebugInput()) {
            Slog.d(
                "KeyCustomizationManager",
                "dispatchKeyEvent:longPress - XCoverTopKey Action, NEEDED_NEXT_STEP");
          }
          return 2;
        }
        ...
        if (KeyCustomizationConstants.isDebugInput()) {
          Slog.d(
              "KeyCustomizationManager", "dispatchKeyEvent:longPress, NEEDED_ONLY_LONG_PRESS_STEP");
        }
        return 3;
      }
      ...
      if (lastAction == 2 && sendBroadcast(keyEvent, 3, this.mIsKeyLongPressed) == -1) {
        if (KeyCustomizationConstants.isDebugInput()) {
          Slog.d(
              "KeyCustomizationManager", "dispatchKeyEvent:up - sendBroadcast, NO_NEED_NEXT_STEP");
        }
        return 1;
      }
      if (CoreRune.FW_ACTIVE_OR_XCOVER_KEY) {
        if (!this.mIsKeyLongPressed) {
          if (hasXCoverTopKeyAndId(3, keyCode)) {
            if (launchXCoverPressActionIfNeeded(keyCode, false)) {
              if (KeyCustomizationConstants.isDebugInput()) {
                Slog.d(
                    "KeyCustomizationManager",
                    "dispatchKeyEvent:up - XCoverTopKey Action, NO_NEED_NEXT_STEP");
              }
              return 1;
            }
            if (KeyCustomizationConstants.isDebugInput()) {
          ...
          if (KeyCustomizationConstants.isDebugInput()) {
            Slog.d(
                "KeyCustomizationManager",
                "dispatchKeyEvent:up - XCoverTopKey Action, No longPress consumed,"
                    + " NEEDED_NEXT_STEP");
          }
          return 2;
        }
      ...
      if (!this.mIsKeyLongPressed) {
        ...
        if (CoreRune.FW_B2B_DEDICATED_APP && startMCPTTServiceIfNeeded(keyCode, keyEvent)) {
          if (KeyCustomizationConstants.isDebugInput()) {
            Slog.d(
                "KeyCustomizationManager", "dispatchKeyEvent:up - launch MCPTT, NO_NEED_NEXT_STEP");
          }
          return 1;
        }
  ...
  public boolean canDispatchXCoverTopKeyEvent(int i) {
    ...
    if (hasHigherIdThanDefaultWithXCoverTopPress(i)) {
      Log.d(
          "KeyCustomizationManager",
          "Allow XCover or Top key event dispatching even though screen is turned off by knox"
              + " policy.");
      return true;
    }
    ...
    Log.d(
        "KeyCustomizationManager",
        "After screen is turned off, disallow XCover or Top key event dispatching, because single"
            + " or long press has a ID_SETTING_UI_XCOVER_TOP.");
    return false;
  }
  ...
  public boolean launchXCoverLongActionIfNeeded(int i, boolean z) {
    ...
    if (launchXCoverTopDedicatedLongAction(flattenToString, i)
        || launchXCoverTopDedicatedAction(flattenToString, 4, i)) {
      return true;
    }
  ...
  public final boolean launchXCoverDefaultAction(String str, int i, int i2, boolean z) {
    if ("torch/torch".equals(str)
        && this.mPolicyExt.handleTorchForXCoverKey(isOnLockScreen(i2), i2)) {
  ...
  public void prepareVoiceToTextMessage(int i, KeyEvent keyEvent) {
    ...
    if (isXCoverOrTopKey(i)
        && (lastComponentName = getLastComponentName(4, i)) != null
        && "quickMessageSender/quickMessageSender".equals(lastComponentName.flattenToString())) {
    ...
    if ("home/home".equals(str)) {
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.policy.KeyCustomizationManager$$ExternalSyntheticLambda0
  ...
  public final boolean launchXCoverTopDedicatedLongAction(String str, int i) {
    ...
    if (phoneWindowManagerExt.mIsSamsungKeyboard) {
      ...
      phoneWindowManagerExt.showToast(context, context.getResources().getString(17043223));
    }
  ...
  public final boolean startMCPTTServiceIfNeeded(int i, KeyEvent keyEvent) {
    ...
    Intent intent;
    if (!isXCoverOrTopKey(i)
        || (lastKeyCustomizationInfo = getLastKeyCustomizationInfo(3, i)) == null
        || (intent = lastKeyCustomizationInfo.intent) == null
  ...
  public final boolean hasHigherIdWithOppositePress(int i, int i2) {
    ...
    Log.d(
        "KeyCustomizationManager",
        "hasHigherIdInOppositePress, press=" + i + " keyCode=" + i2 + " id=" + lastId);
    return true;
  }

  public final Intent getDefaultIntentForKnoxId(
      int i, KeyEvent keyEvent, boolean z, boolean z2, boolean z3) {
    if (!isKnoxId(i)) {
      return null;
    }
    int keyCode = keyEvent.getKeyCode();
  ...
  public final boolean migrationForKnoxPolicy(
      Intent intent, KeyEvent keyEvent, boolean z, boolean z2) {
    boolean z3;
    boolean z4;
    int keyCode = keyEvent.getKeyCode();
    boolean z5 = keyEvent.getAction() == 0;
  ...
  public final boolean shouldSkipActionForKnoxPolicy(
      int i, boolean z, boolean z2, Bundle bundle, boolean z3, boolean z4) {
    if (!z3) {
  ...
  public final void updateIntentForKnoxPolicy(
      Intent intent, boolean z, boolean z2, boolean z3, boolean z4) {
    int i;
    if (z3) {
      i = 4;
    } else if (z4) {
  ...
  public final boolean isBlockedDispatchingByKnoxPolicy(
      int i, boolean z, int i2, Intent intent, int i3) {
    if (!isKnoxId(i)) {
      return false;
    }
    ...
    return z
        && i2 == 0
        && isReportedKey(true, intent.getExtras())
        && isBlockedKey(true, intent.getExtras());
  }
  ...
  public final boolean isForceBlockDispatchingLongByKnoxPolicy(int i, int i2, int i3) {
    ...
    Log.i(
        "KeyCustomizationManager",
        "Long press of key(" + i3 + ") action should be blocked by knox policy");
    return true;
  }
        ...
        : (i & 4) != 0
            ...
            : (i & 8) != 0
                ...
                : (i & 16) != 0
                    ...
                    : (i & 32) != 0
                        ? "KEY_PRESS_QUADRUPLE"
                        : (i & 64) != 0 ? "KEY_PRESS_QUINTUPLE" : Integer.toString(i);
  }
