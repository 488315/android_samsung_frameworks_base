        ...
        */
        public final void addPermissionAppOp(PackageInfo packageInfo, AndroidPackage androidPackage, PermissionInfo permissionInfo) {
            ...
            if (shouldGrantAppOp(packageInfo, androidPackage, permissionInfo)) {
                ...
                if (str3 != null) {
                    PermissionInfo permissionInfo2 = (PermissionInfo) this.mRuntimeAndTheirBgPermissionInfos.get(str3);
                    if (!(permissionInfo2 != null && shouldGrantAppOp(packageInfo, androidPackage, permissionInfo2))) {
                        c = 4;
                        if (!PermissionPolicyService.this.mIsVivo && "com.android.systemui".equals(packageInfo.packageName)) {
                            if (!"android.permission.ACCESS_FINE_LOCATION".equals(permissionInfo.name) || "android.permission.ACCESS_COARSE_LOCATION".equals(permissionInfo.name)) {
                                Slog.d(PermissionPolicyService.LOG_TAG, "Ignore " + permissionInfo.name + " for " + packageInfo.packageName);
                            }
                        }
        ...
        public class C22531 implements ActivityInterceptorCallback {
            ...
            public void onActivityLaunched(final TaskInfo taskInfo, final ActivityInfo activityInfo, final ActivityInterceptorCallback.ActivityInterceptorInfo activityInterceptorInfo) {
                ...
                PermissionPolicyService.this.mHandler.post(new Runnable() { // from class: com.android.server.policy.PermissionPolicyService$Internal$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        PermissionPolicyService.Internal.C22531.this.lambda$onActivityLaunched$0(activityInfo, taskInfo, activityInterceptorInfo);
                    }
                });
            }
