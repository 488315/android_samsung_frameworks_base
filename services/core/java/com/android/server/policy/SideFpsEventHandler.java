...
public class SideFpsEventHandler implements View.OnClickListener {
    ...
    public static /* bridge */ /* synthetic */ SideFpsToast m10210$$Nest$fgetmDialog(SideFpsEventHandler sideFpsEventHandler) {
    ...
    public SideFpsEventHandler(Context context, Handler handler, PowerManager powerManager, DialogProvider dialogProvider) {
        ...
        this.mDismissDialogTimeout = context.getResources().getInteger(R.integer.config_smartSelectionInitializedTimeoutMillis);
    }
                    ...
                    public void onStateChanged(final int i) {
                        ...
                        if (i == 0) {
                            this.mStateRunnable = new Runnable() { // from class: com.android.server.policy.SideFpsEventHandler$2$1$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    SideFpsEventHandler.C23112.AnonymousClass1.this.lambda$onStateChanged$0(i);
                                }
                            };
