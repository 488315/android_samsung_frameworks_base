...
public class KeyCustomizationInfoManager {
    ...
    synchronized (this.mLock) {
      ...
      Log.d(
          ...
          "loadSettings duration="
              ...
              + " version="
              + this.mXmlUtils.getXmlVersion()
              + " userId="
              + i
              + " userSwitching="
              + z);
      long uptimeMillis2 = SystemClock.uptimeMillis();
      if (this.mXmlUtils.getXmlFileErrorCode()
          == KeyCustomizationInfoXmlUtils.ErrorCode.FILE_NOT_FOUND) {
      ...
      } else if (this.mXmlUtils.getXmlFileErrorCode()
          == KeyCustomizationInfoXmlUtils.ErrorCode.SUCCESS) {
        boolean checkHomeLongPressInfo =
            CoreRune.FW_SUPPORT_SEARCLE_HOME_LONG ? false | checkHomeLongPressInfo() : false;
        if (!z) {
        ...
        Log.e(
            "KeyCustomizationInfoManager",
            "Xml file error code was wrong. code=" + this.mXmlUtils.getXmlFileErrorCode());
      }
      Log.d(
          "KeyCustomizationInfoManager",
          "initKeyCustomizationInfo duration=" + (SystemClock.uptimeMillis() - uptimeMillis2));
    }
  }
  ...
  public final boolean remove(int i, String str, int i2, int i3, boolean z) {
    synchronized (this.mLock) {
      ...
      if (i == 2003 && !TextUtils.isEmpty(str) && !str.equals(keyCustomizationInfo.ownerPackage)) {
        Slog.d(
            "KeyCustomizationInfoManager",
            "Can not remove data, There is no matched with ownerPackage=" + str);
        return false;
      }
        ...
        for (int i2 : KeyCustomizationConstants.ALL_KEYCODE_TYPE) {
          ...
          if (sparseArray != null
              && (keyCustomizationInfo =
                      (SemWindowManager.KeyCustomizationInfo) sparseArray.get(2003))
                  != null
  ...
  public boolean clearByAction(int i, int i2, int i3) {
    ...
    synchronized (this.mLock) {
      ...
      for (int i4 : KeyCustomizationConstants.SUPPORT_PRESS_TYPE_ALL) {
        ...
        if (sparseArray != null
            && (keyCustomizationInfo = (SemWindowManager.KeyCustomizationInfo) sparseArray.get(i))
                != null
            && keyCustomizationInfo.action == i3) {
          sparseArray.remove(i);
  ...
  */
  public void initKeyCustomizationInfoLocked(int i, int i2, boolean z) {
    if (KeyCustomizationConstants.isSafeDebugInput()) {
      Log.d(
          "KeyCustomizationInfoManager",
          "initKeyCustomizationInfoLocked,"
              + KeyCustomizationManager.pressToString(i)
              + " keyCode="
              + i2
              + " isFirstBoot="
              + z
    ...
    } else if (shouldLaunchCameraByHomeDouble()
        && (i & 8) != 0
    ...
    synchronized (this.mLock) {
      ...
      for (int i : ALL_HOT_KEYCODE) {
        ...
        if (componentName != null && str.equals(componentName.getPackageName())) {
          Slog.d(
              "KeyCustomizationInfoManager", "removeHotKey keyCode=" + i + " packageName=" + str);
      ...
      while (it.hasNext()) {
        ...
        if (keyCustomizationInfo != null) {
          ...
          if (i != 1090 && i != 1091 && i != 1092) {
            Slog.d(
                "KeyCustomizationInfoManager",
                "restoreKeyCustomizationInfo keyCode="
                    + i
                    + KeyCustomizationManager.pressToString(keyCustomizationInfo.press)
                    + " "
                    + KeyCustomizationManager.actionToString(keyCustomizationInfo.action)
                    + keyCustomizationInfo.intent);
        ...
        for (SemWindowManager.KeyCustomizationInfo keyCustomizationInfo2 : arrayList) {
          if (keyCustomizationInfo2 != null) {
            ...
            if (intent == null) {
              Log.d(
                  "KeyCustomizationInfoManager",
                  "restoreKeyCustomizationInfo, keyCode=" + i2 + " intent is null.");
            } else {
              ComponentName component = intent.getComponent();
              if (component == null) {
                Log.d(
                    "KeyCustomizationInfoManager",
                    "restoreKeyCustomizationInfo, keyCode=" + i2 + " componentName is null.");
              } else {
  ...
  public final SemWindowManager.KeyCustomizationInfo getXCoverKeyPressInfoFromSetting() {
    ...
    String stringForUser =
        Settings.System.getStringForUser(this.mContext.getContentResolver(), "short_press_app", -2);
    Log.d(
        "KeyCustomizationInfoManager",
        "getXCoverKeyPressInfoFromSetting xcoverKeyPressApp=" + stringForUser);
    return getXCoverTopKeyCustomizationInfo(3, 1015, stringForUser);
  }

  public final SemWindowManager.KeyCustomizationInfo getXCoverTopKeyCustomizationInfo(
  ...
  public final SemWindowManager.KeyCustomizationInfo getXCoverKeyLongInfoFromSetting() {
    String stringForUser =
        Settings.System.getStringForUser(this.mContext.getContentResolver(), "long_press_app", -2);
    Log.d(
        "KeyCustomizationInfoManager",
        "getXCoverKeyLongInfoFromSetting xcoverKeyLongPressLaunchApp=" + stringForUser);
  ...
  public final SemWindowManager.KeyCustomizationInfo getTopKeyPressInfoFromSetting() {
    String stringForUser =
        Settings.System.getStringForUser(
            this.mContext.getContentResolver(), "xcover_top_short_press_app", -2);
    Log.d(
        "KeyCustomizationInfoManager",
        "getTopKeyPressInfoFromSetting topKeyPressLaunchApp=" + stringForUser);
  ...
  public final SemWindowManager.KeyCustomizationInfo getSideKeyLongInfoFromGlobalSetting() {
    ...
    Log.d(
        "KeyCustomizationInfoManager",
        "getSideKeyLongInfoFromGlobalSetting sideKeyLongPressType=" + i2);
    if (i2 == 0) {
      unflattenFromString = ComponentName.unflattenFromString("wakeBixby/wakeBixby");
      i = 3;
    } else {
      unflattenFromString =
          i2 != 1 ? null : ComponentName.unflattenFromString("globalAction/globalAction");
    }
    int i3 = i;
  ...
  public SemWindowManager.KeyCustomizationInfo getSideKeyDoubleInfoFromGlobalSetting() {
    ...
    Log.d(
        "KeyCustomizationInfoManager",
        "getSideKeyDoubleInfoFromGlobalSetting enabled=" + z + " type=" + i + " appInfo=" + string);
    ...
    return new SemWindowManager.KeyCustomizationInfo(
        8, 1104, 26, typeToBehavior.getAction(), typeToBehavior.getIntent());
  }
  ...
  public final SemWindowManager.KeyCustomizationInfo getQuickLaunchCameraInfoFromSetting(int i) {
    ...
    Log.d(
        "KeyCustomizationInfoManager",
        "getQuickLaunchCameraInfoFromSetting behavior=" + doublePressLaunchCamera);
  ...
  public final boolean getDoublePowerTvModeEnable() {
    ContentResolver contentResolver = this.mContext.getContentResolver();
    return (Settings.System.getInt(contentResolver, "tvmode_state", 0) == 1)
  ...
  public final SemWindowManager.KeyCustomizationInfo getSideKeyDoubleTvModeInfoFromSetting() {
    ...
    intent.setComponent(
        ComponentName.unflattenFromString(
            "com.samsung.tvmode/com.samsung.tvmode.activity.MainActivity"));
  ...
  */
  ...
  public final SemWindowManager.KeyCustomizationInfo getMcpttInfo(int i) {
    ...
    intent.setComponent(
        ComponentName.unflattenFromString(
            "com.att.firstnet.grey/com.samsung.android.sptt.keyevent.KeyEventService"));
  ...
  public final boolean initKodiakDedicatedPttApp(
      SemWindowManager.KeyCustomizationInfo keyCustomizationInfo, int i) {
  ...
  public final boolean initKodiakDedicatedPtt(
      SemWindowManager.KeyCustomizationInfo keyCustomizationInfo, int i, String str) {
    Intent intent;
    ...
    if (keyCustomizationInfo == null
        ...
        || (intent = keyCustomizationInfo.intent) == null
        || !str.equals(intent.getPackage())) {
      return false;
    }
    remove(951, 3, i);
    return false;
  ...
  */
  ...
  public void onUserRemove(int i) {
    File file =
        new File(KeyCustomizationInfoXmlUtils.getKeyCustomizationDir(i), "key_customize_info.xml");
  ...
  public final void backupGlobalSideKeyInfo() {
    ...
    if (keyCustomizationInfo != null) {
      this.mGlobalSideKeyLongInfo =
          new SemWindowManager.KeyCustomizationInfo(
              keyCustomizationInfo.press,
              keyCustomizationInfo.id,
              keyCustomizationInfo.keyCode,
              keyCustomizationInfo.action,
              keyCustomizationInfo.intent);
    } else {
    ...
    if (keyCustomizationInfo2 != null) {
      this.mGlobalSideKeyDoubleInfo =
          new SemWindowManager.KeyCustomizationInfo(
              keyCustomizationInfo2.press,
              keyCustomizationInfo2.id,
              keyCustomizationInfo2.keyCode,
              keyCustomizationInfo2.action,
              keyCustomizationInfo2.intent);
    } else {
  ...
  public final void restoreGlobalSideKeyInfo() {
    ...
    if (this.mGlobalSideKeyLongInfo != null) {
      if ((keyCustomizationInfo == null && last == null)
          || (keyCustomizationInfo != null && keyCustomizationInfo.id == 1104)) {
    ...
    } else if ((keyCustomizationInfo == null && last == null)
        || (keyCustomizationInfo != null && keyCustomizationInfo.id == 1104)) {
    ...
    if (this.mGlobalSideKeyDoubleInfo != null) {
      if ((keyCustomizationInfo3 == null && last2 == null)
          || (keyCustomizationInfo3 != null && keyCustomizationInfo3.id == 1104)) {
        SemWindowManager.KeyCustomizationInfo keyCustomizationInfo4 = this.mGlobalSideKeyDoubleInfo;
        put(
            new SemWindowManager.KeyCustomizationInfo(
                keyCustomizationInfo4.press,
                keyCustomizationInfo4.id,
                keyCustomizationInfo4.keyCode,
                keyCustomizationInfo4.action,
                keyCustomizationInfo4.intent),
            true);
      }
    } else if ((keyCustomizationInfo3 == null && last2 == null)
        || (keyCustomizationInfo3 != null && keyCustomizationInfo3.id == 1104)) {
      SemWindowManager.KeyCustomizationInfo sideKeyDoubleInfoFromGlobalSetting =
          getSideKeyDoubleInfoFromGlobalSetting();
  ...
  public final boolean checkHomeLongPressInfo() {
    ...
    for (Integer num : arrayList) {
      SemWindowManager.KeyCustomizationInfo keyCustomizationInfo2 =
          (SemWindowManager.KeyCustomizationInfo) sparseArray.get(num.intValue());
      Log.d(
          "KeyCustomizationInfoManager", "checkHomeLongPressInfo, remove " + keyCustomizationInfo2);
      if (keyCustomizationInfo2 != null) {
        sparseArray.remove(num.intValue());
        if (num.intValue() == 2003) {
          ...
          Log.d(
              "KeyCustomizationInfoManager",
              "Remove home key long press info, ID(" + num + "), ownerPackage=" + str);
        } else {
  ...
  public final void dumpKeyCustomizationInfoPressMap(
      String str, PrintWriter printWriter, SparseArray sparseArray) {
  ...
  public final void dumpKeyCustomizationInfoKeyCodeMap(
      String str, PrintWriter printWriter, SparseArray sparseArray) {
    for (int i = 0; i < sparseArray.size(); i++) {
      SemWindowManager.KeyCustomizationInfo keyCustomizationInfo =
