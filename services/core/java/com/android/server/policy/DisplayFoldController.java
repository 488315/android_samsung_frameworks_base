...
public class DisplayFoldController {
        ...
        .registerCallback(
            ...
            new DeviceStateManager.FoldStateListener(
                ...
                new Consumer() { // from class:
                                 // com.android.server.policy.DisplayFoldController$$ExternalSyntheticLambda1
  ...
  public final void setDeviceFolded(boolean z) {
    ...
    if (bool == null || bool.booleanValue() != z) {
      ...
      if (rect != null) {
        if (z) {
          this.mDisplayManagerInternal.getNonOverrideDisplayInfo(
              this.mDisplayId, this.mNonOverrideDisplayInfo);
          int width = ((this.mNonOverrideDisplayInfo.logicalWidth - rect.width()) / 2) - rect.left;
          int height =
              ((this.mNonOverrideDisplayInfo.logicalHeight - rect.height()) / 2) - rect.top;
          this.mDisplayManagerInternal.setDisplayScalingDisabled(this.mDisplayId, true);
          this.mWindowManagerInternal.setForcedDisplaySize(
              this.mDisplayId, rect.width(), rect.height());
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$registerDisplayFoldListener$1(
  ...
  public static DisplayFoldController create(Context context, int i) {
    ...
    return new DisplayFoldController(
        context,
