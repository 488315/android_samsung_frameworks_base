...
public final /* synthetic */ class PhoneWindowManagerExt$$ExternalSyntheticLambda2
        implements Consumer {
    ...
    public final void accept(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                RCPManagerService$$ExternalSyntheticOutline0.m(
                        ...
                        BatteryService$$ExternalSyntheticOutline0.m(
                                "updateSettings tvModeEnabled=", ", ", z),
                        phoneWindowManagerExt.mTvModeEnabled);
            ...
            case 1:
                ...
                boolean z2 =
                        Settings.System.getInt(
                                        phoneWindowManagerExt2.mContext.getContentResolver(),
                                        "pwrkey_owner_status",
                                        0)
                                == 1;
                RCPManagerService$$ExternalSyntheticOutline0.m(
                        "PhoneWindowManagerExt",
                        BatteryService$$ExternalSyntheticOutline0.m(
                                "updateSettings tvModeDoublePressEnabled=", ", ", z2),
                        phoneWindowManagerExt2.mTvModeDoublePressEnabled);
            ...
            case 2:
                ...
                String string =
                        Settings.System.getString(
                                phoneWindowManagerExt3.mContext.getContentResolver(),
                                "double_tab_launch_component");
                Log.d(
                        "PhoneWindowManagerExt",
                        "updateSettings doublePressLaunchComponent=" + string);
                phoneWindowManagerExt3.updateDoublePressLaunchInfo(string);
                if (InputRune.PWM_POWER_KEY_DOUBLE_PRESS_ATT_TV_MODE) {
                    ComponentName componentName =
                            phoneWindowManagerExt3.mDoublePressLaunchComponentName;
            ...
            case 3:
                ...
                phoneWindowManagerExt4.mQuickLaunchCameraBehavior =
                        Settings.System.getInt(
                                phoneWindowManagerExt4.mContext.getContentResolver(),
                                "double_tab_launch",
                                2);
                GestureWakeup$$ExternalSyntheticOutline0.m(
                        new StringBuilder("updateSettings, mQuickLaunchCameraBehavior="),
                        phoneWindowManagerExt4.mQuickLaunchCameraBehavior,
                        "PhoneWindowManagerExt");
                ...
                KeyCustomizationManager keyCustomizationManager =
                        phoneWindowManagerExt4.mKeyCustomizationPolicy;
                SemWindowManager.KeyCustomizationInfo keyCustomizationInfo =
                        keyCustomizationManager.mKeyCustomizationInfoManager.get(2001, 8, i3, null);
                if (i2 == 3 || i2 == 1) {
                    if (keyCustomizationInfo == null) {
                        keyCustomizationManager.putKeyCustomizationInfo(
                                new SemWindowManager.KeyCustomizationInfo(8, 2001, i3, 1));
                    }
            ...
            case 4:
                ...
                String stringForUser =
                        Settings.System.getStringForUser(
                                phoneWindowManagerExt5.mContext.getContentResolver(),
                                "pen_detachment_notification",
                                -2);
                phoneWindowManagerExt5.mPenSoundFilePath = stringForUser;
                if (!TextUtils.isEmpty(stringForUser)
                        && (penSoundInfo = phoneWindowManagerExt5.mPenSoundInfo) != null
                        && !phoneWindowManagerExt5.mPenSoundFilePath.equals(
                                penSoundInfo.mPenSoundPath)) {
                    phoneWindowManagerExt5.mPenSoundInfo.updatePenSound(
                            phoneWindowManagerExt5.mPenSoundFilePath);
                    break;
                }
                break;
            default:
                PhoneWindowManagerExt.SettingsObserver settingsObserver =
                        (PhoneWindowManagerExt.SettingsObserver) obj2;
                boolean z3 =
                        Settings.System.getIntForUser(
                                        ...
                                        -2)
                                == 1;
                OneHandOpPolicy oneHandOpPolicy =
                ...
                if (oneHandOpPolicy.mBootCompleted) {
                    OneHandOpPolicy.OneHandOpMonitor oneHandOpMonitor =
                            oneHandOpPolicy.mOneHandOpMonitor;
                    if (!z3) {
                        if (oneHandOpMonitor.mWatcher != null) {
                            ActivityManagerService$$ExternalSyntheticOutline0.m(
                                    3,
                                    new StringBuilder("stopService(), caller="),
                                    "OneHandOpPolicy");
                            oneHandOpPolicy.mReasonToStart = -1;
                            oneHandOpPolicy.mHandler.post(
                                    new OneHandOpPolicy$$ExternalSyntheticLambda0(
                                            oneHandOpPolicy, 2));
                            break;
                        }
