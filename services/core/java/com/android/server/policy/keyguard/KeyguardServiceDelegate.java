...
public class KeyguardServiceDelegate {
    ...
    public void bindService(Context context) {
        ...
        ComponentName unflattenFromString = ComponentName.unflattenFromString(context.getApplicationContext().getResources().getString(R.string.duration_days_relative_future));
        intent.addFlags(256);
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            if (KeyguardServiceDelegate.this.mKeyguardState.systemIsReady) {
                ...
                if (KeyguardServiceDelegate.this.mKeyguardState.screenState == 2 || KeyguardServiceDelegate.this.mKeyguardState.screenState == 1) {
                    ...
                    keyguardServiceWrapper.onScreenTurningOn(keyguardServiceDelegate3.new KeyguardShowDelegate(keyguardServiceDelegate3.mDrawnListenerWhenConnect));
                }
