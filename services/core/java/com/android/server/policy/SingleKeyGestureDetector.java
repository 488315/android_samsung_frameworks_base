...
public final class SingleKeyGestureDetector {
  ...
  public abstract class SingleKeyRule {
    ...
    public boolean supportLongPress() {
      int i = this.mKeyCode;
      return i == 3 || i == 4 || i == 24 || i == 25 || i == 79 || i == 187 || i == 1015
          || i == 1079;
    }
    ...
    public final void sendBroadcastIfNeeded(KeyEvent keyEvent) {
      if ((!SingleKeyGestureDetector.KEYCODE_KEY_DISPATCHING_ALLOWLIST.contains(
                  Integer.valueOf(this.mKeyCode))
              || (keyEvent.getFlags() & 268435456) == 0)
          && SingleKeyGestureDetector.mKeyCustomizationPolicy.getLastAction(3, this.mKeyCode)
              == 2) {
  ...
  public static SingleKeyGestureDetector get(
      Context context, KeyCustomizationManager keyCustomizationManager) {
    SingleKeyGestureDetector singleKeyGestureDetector = new SingleKeyGestureDetector();
    sDefaultLongPressTimeout =
        context
            .getResources()
            .getInteger(R.integer.config_letterboxDefaultPositionForVerticalReachability);
    sDefaultVeryLongPressTimeout =
        context.getResources().getInteger(R.integer.config_volte_replacement_rat);
  ...
  public final void interceptKeyDown(KeyEvent keyEvent, int i) {
    ...
    if (i2 == keyCode) {
      if (this.mActiveRule == null
          ...
          || !this.mActiveRule.supportLongPress()
          || this.mHandledByLongPress
          || this.mActiveRule.hasExtensionLongPressTimeout()) {
        return;
      }
      ...
      Message obtainMessage =
          this.mHandler.obtainMessage(
              0, keyCode, 0, getKeyHandlerObj(new KeyEvent(keyEvent), this.mActiveRule, i, 1));
      obtainMessage.setAsynchronous(true);
      this.mHandler.sendMessage(obtainMessage);
      return;
    }
    if (i2 != 0
        || ((singleKeyRule = this.mActiveRule) != null
            && !singleKeyRule.shouldInterceptKey(keyCode))) {
      if (DEBUG) {
    ...
    if (i3 == 1) {
      if (this.mActiveRule.supportLongPress()) {
        ...
        Message obtainMessage2 =
            this.mHandler.obtainMessage(
                0, keyCode, 0, getKeyHandlerObj(new KeyEvent(keyEvent), this.mActiveRule, i, 2));
      ...
      if (this.mActiveRule.supportVeryLongPress()) {
        Message obtainMessage3 =
            this.mHandler.obtainMessage(
                1, keyCode, 0, getKeyHandlerObj(new KeyEvent(keyEvent), this.mActiveRule, i));
        obtainMessage3.setAsynchronous(true);
        this.mHandler.sendMessageDelayed(
            obtainMessage3, this.mActiveRule.getVeryLongPressTimeoutMs());
        return;
      }
      return;
    }
    ...
    if (CoreRune.FW_SKIP_TOO_FAST_DOUBLE_PRESS) {
      ...
      if (!z && this.mKeyReleaseTime != 0 && eventTime < this.mKeyReleaseTime + 50) {
        ...
        Log.d(
            "SingleKeyGesture",
            "interceptKeyDown keyCode="
                + keyCode
                + ", mKeyReleaseTime("
                + this.mKeyReleaseTime
                + ") -  eventTime("
                + eventTime
                + ")="
                + (eventTime - this.mKeyReleaseTime));
      }
    }
    if (this.mKeyPressCounter > 1) {
      ...
      Log.i(
          "SingleKeyGesture",
          "Trigger multi press, mTriggeredMultiPressTime=" + this.mTriggeredMultiPressTime);
    }
    if (this.mActiveRule.getMaxMultiPressCount() <= 1
        || this.mKeyPressCounter != this.mActiveRule.getMaxMultiPressCount()) {
      return;
    }
    if (DEBUG) {
      Log.i(
          "SingleKeyGesture",
          "Trigger multi press "
              + this.mActiveRule.toString()
              + " for it reached the max count "
              + this.mKeyPressCounter);
    }
    Message obtainMessage4 =
        this.mHandler.obtainMessage(
            ...
            keyCode,
            this.mKeyPressCounter,
            getKeyHandlerObj(new KeyEvent(keyEvent), this.mActiveRule, i));
  ...
  public final boolean interceptKeyUp(KeyEvent keyEvent, int i) {
    Log.d(
        "SingleKeyGesture",
        "interceptKeyUp, longPress="
            + this.mHandledByLongPress
            + " info : "
            + this.mHandleLongPressInfo);
    this.mDownKeyCode = 0;
    if (this.mActiveRule == null) {
    ...
    if (!this.mHandledByLongPress) {
      ...
      if (eventTime < this.mLastDownTime + this.mActiveRule.getVeryLongPressTimeoutMs()) {
        ...
        this.mHandledByLongPress =
            this.mActiveRule.supportVeryLongPress() | this.mHandledByLongPress;
      }
    }
    int keyCode = keyEvent.getKeyCode();
      ...
      if (i3 == 0) {
        ...
        Log.i(
            ...
            "Detect long press "
                ...
                + longPressType
                + " info : "
                + SingleKeyGestureDetector.this.mHandleLongPressInfo);
        if (SingleKeyGestureDetector.this.mHandleLongPressInfo.hasInfo(i)) {
          ...
          singleKeyRule.onLongPress(
              SingleKeyGestureDetector.this.mLastDownTime, keyEvent, policyFlags);
          return;
        }
      }
      if (i3 == 1) {
  ...
  public final KeyHandlerObj getKeyHandlerObj(
      KeyEvent keyEvent, SingleKeyRule singleKeyRule, int i) {
    return new KeyHandlerObj(keyEvent, singleKeyRule, i, 0);
  }

  public final KeyHandlerObj getKeyHandlerObj(
      KeyEvent keyEvent, SingleKeyRule singleKeyRule, int i, int i2) {
