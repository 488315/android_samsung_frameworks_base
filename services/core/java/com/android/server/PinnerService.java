...
public final class PinnerService extends SystemService {
  ...
  public PinnerService(Context context) {
    ...
    this.mConfiguredToPinHome =
        context.getResources().getBoolean(R.bool.config_maskSecondaryBuiltInDisplayCutout);
  ...
  public void update(ArraySet arraySet, boolean z) {
    ...
    for (int size = pinKeys.size() - 1; size >= 0; size--) {
      ...
      if (infoForKey != null && arraySet.contains(infoForKey.packageName)) {
        Slog.i(
            "PinnerService", "Updating pinned files for " + infoForKey.packageName + " force=" + z);
  ...
  public List dumpDataForStatsd() {
    ...
    synchronized (this) {
      ...
      while (it2.hasNext()) {
        ...
        Iterator it3 =
            ((PinnedApp) this.mPinnedApps.get(Integer.valueOf(intValue))).mFiles.iterator();
        while (it3.hasNext()) {
  ...
  public final void handlePinOnStart() {
    String[] strArr;
    for (String str :
        this.mContext.getResources().getStringArray(R.array.config_sfps_sensor_props)) {
          ...
          try {
            strArr =
                DexFile.getDexFileOutputPaths(
                    str, VMRuntime.getInstructionSet(Build.SUPPORTED_ABIS[0]));
  ...
  public final void registerUserSetupCompleteListener() {
    ...
    this.mContext
        ...
        .registerContentObserver(
            uriFor,
            false,
            new ContentObserver(null) { // from class: com.android.server.PinnerService.2
  ...
  public class UidObserverC03103 extends UidObserver {
    public UidObserverC03103() {}

    public void onUidGone(int i, boolean z) {
      PinnerService.this.mPinnerHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                // com.android.server.PinnerService$3$$ExternalSyntheticLambda0
    ...
    public void onUidActive(int i) {
      PinnerService.this.mPinnerHandler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                // com.android.server.PinnerService$3$$ExternalSyntheticLambda1
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
  ...
  public final void registerUidListener() {
    try {
      this.mAm.registerUidObserver(new UidObserverC03103(), 10, 0, (String) null);
  ...
  public final ApplicationInfo getCameraInfo(int i) {
    ApplicationInfo applicationInfoForIntent =
        getApplicationInfoForIntent(
            new Intent("android.media.action.STILL_IMAGE_CAMERA"), i, false);
    if (applicationInfoForIntent == null) {
      applicationInfoForIntent =
          getApplicationInfoForIntent(
              new Intent("android.media.action.STILL_IMAGE_CAMERA_SECURE"), i, false);
    }
    return applicationInfoForIntent == null
        ? getApplicationInfoForIntent(
            new Intent("android.media.action.STILL_IMAGE_CAMERA"), i, true)
        : applicationInfoForIntent;
  }
  ...
  public final ApplicationInfo getApplicationInfoForIntent(Intent intent, int i, boolean z) {
    ...
    Iterator it =
        this.mContext.getPackageManager().queryIntentActivitiesAsUser(intent, 851968, i).iterator();
  ...
  public final void sendPinAppsMessage(int i) {
    this.mPinnerHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.PinnerService$$ExternalSyntheticLambda1
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
    ...
    this.mPinnerHandler.sendMessage(
        PooledLambda.obtainMessage(
            new Consumer() { // from class:
              // com.android.server.PinnerService$$ExternalSyntheticLambda2
    ...
    if (z) {
      ...
      synchronized (this) {
        if (!this.mPinnedApps.isEmpty()) {
          Slog.e(
              "PinnerService",
              "Attempted to update a list of apps, but apps were already pinned. Skipping.");
          return;
        }
        this.mPinKeys = createPinKeys;
      }
    ...
    this.mPinnerHandler.sendMessage(
        PooledLambda.obtainMessage(
            new QuadConsumer() { // from class:
              // com.android.server.PinnerService$$ExternalSyntheticLambda0
  ...
  public final void pinApp(int i, ApplicationInfo applicationInfo) {
    ...
    try {
      strArr =
          DexFile.getDexFileOutputPaths(
              applicationInfo.getBaseCodePath(), VMRuntime.getInstructionSet(str3));
    } catch (IOException unused) {
    }
    if (strArr == null) {
      return;
  ...
  public static ZipFile maybeOpenZip(String str) {
    try {
      ...
      Slog.w(
          "PinnerService", String.format("could not open \"%s\" as zip: pinning as blob", str), e);
      return null;
    }
  }
  ...
  public static InputStream maybeOpenPinMetaInZip(ZipFile zipFile, String str) {
    ...
    try {
      ...
      Slog.w(
          "PinnerService",
          String.format("error reading pin metadata \"%s\": pinning as blob", str),
          e);
      return null;
    }
  }
  ...
  public final class BinderService extends Binder {
      ...
      if (DumpUtils.checkDumpPermission(
        ...
        synchronized (PinnerService.this) {
          ...
          while (it2.hasNext()) {
            int intValue = ((Integer) it2.next()).intValue();
            PinnedApp pinnedApp =
                (PinnedApp) PinnerService.this.mPinnedApps.get(Integer.valueOf(intValue));
          ...
          if (!PinnerService.this.mPendingRepin.isEmpty()) {
            ...
            while (it4.hasNext()) {
              printWriter.print(
                  PinnerService.this.getNameForKey(((Integer) it4.next()).intValue()));
              printWriter.print(' ');
            }
            printWriter.println();
          }
    ...
    public void onShellCommand(
      ...
      if (str.equals("repin")) {
        ...
        printError(
            fileDescriptor2,
            String.format("Unknown pinner command: %s. Supported commands: repin", str));
        resultReceiver.send(-1, null);
      }
    }
  }
