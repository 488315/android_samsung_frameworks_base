...
public final class PinnerService extends SystemService {
    ...
    public PinnerService(Context context) {
        ...
        this.mConfiguredToPinCamera = context.getResources().getBoolean(R.bool.config_maskMainBuiltInDisplayCutout);
        this.mConfiguredToPinHome = context.getResources().getBoolean(R.bool.config_maskSecondaryBuiltInDisplayCutout);
        this.mConfiguredToPinAssistant = context.getResources().getBoolean(R.bool.config_mainBuiltInDisplayIsRound);
    ...
    public final void handlePinOnStart() {
        String[] strArr;
        for (String str : this.mContext.getResources().getStringArray(R.array.config_sfps_sensor_props)) {
