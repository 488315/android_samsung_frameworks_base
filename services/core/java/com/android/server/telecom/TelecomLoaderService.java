...
public class TelecomLoaderService extends SystemService {
      ...
      try {
        ...
        synchronized (TelecomLoaderService.this.mLock) {
          ...
          if (TelecomLoaderService.this.mDefaultSimCallManagerRequests != null
              && (simCallManager =
                      ((TelecomManager)
                              TelecomLoaderService.this.mContext.getSystemService("telecom"))
                          .getSimCallManager())
                  != null) {
            ...
            for (int i = size - 1; i >= 0; i--) {
              ...
              legacyPermissionManagerInternal.grantDefaultPermissionsToDefaultSimCallManager(
                  packageName, i2);
            }
          }
        }
  ...
  public final void registerDefaultAppProviders() {
    LegacyPermissionManagerInternal legacyPermissionManagerInternal =
        (LegacyPermissionManagerInternal)
            LocalServices.getService(LegacyPermissionManagerInternal.class);
    legacyPermissionManagerInternal.setSmsAppPackagesProvider(
        new LegacyPermissionManagerInternal
          ...
          public final String[] getPackages(int i) {
            ...
            lambda$registerDefaultAppProviders$0 =
                TelecomLoaderService.this.lambda$registerDefaultAppProviders$0(i);
            return lambda$registerDefaultAppProviders$0;
          }
        });
    legacyPermissionManagerInternal.setDialerAppPackagesProvider(
        new LegacyPermissionManagerInternal
            .PackagesProvider() { // from class:
                                  // com.android.server.telecom.TelecomLoaderService$$ExternalSyntheticLambda1
          @Override // com.android.server.pm.permission.LegacyPermissionManagerInternal.PackagesProvider
          public final String[] getPackages(int i) {
            String[] lambda$registerDefaultAppProviders$1;
            lambda$registerDefaultAppProviders$1 =
                TelecomLoaderService.this.lambda$registerDefaultAppProviders$1(i);
            return lambda$registerDefaultAppProviders$1;
          }
        });
    legacyPermissionManagerInternal.setSimCallManagerPackagesProvider(
        new LegacyPermissionManagerInternal
            .PackagesProvider() { // from class:
                                  // com.android.server.telecom.TelecomLoaderService$$ExternalSyntheticLambda2
          @Override // com.android.server.pm.permission.LegacyPermissionManagerInternal.PackagesProvider
          public final String[] getPackages(int i) {
            String[] lambda$registerDefaultAppProviders$2;
            lambda$registerDefaultAppProviders$2 =
                TelecomLoaderService.this.lambda$registerDefaultAppProviders$2(i);
  ...
  public /* synthetic */ String[] lambda$registerDefaultAppProviders$2(int i) {
    synchronized (this.mLock) {
      ...
      for (int i2 : subscriptionManager.getActiveSubscriptionIdList()) {
        PhoneAccountHandle simCallManagerForSubscription =
            telecomManager.getSimCallManagerForSubscription(i2);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$registerDefaultAppNotifier$3(
  ...
  public final void registerCarrierConfigChangedReceiver() {
    this.mContext.registerReceiverAsUser(
        new BroadcastReceiver() { // from class: com.android.server.telecom.TelecomLoaderService.1
  ...
  public final void updateSimCallManagerPermissions(int i) {
    ...
    if (simCallManager != null) {
      ...
      legacyPermissionManagerInternal.grantDefaultPermissionsToDefaultSimCallManager(
          simCallManager.getComponentName().getPackageName(), i);
    }
  }
}
