...
public final class WallpaperEffectsGenerationManagerService extends AbstractMasterSystemService {
    ...
    /* compiled from: qb/89523975 b19e8d3036bb0bb04c0b123e55579fdc5d41bbd9c06260ba21f1b25f8ce00bef */
    public final class WallpaperEffectsGenerationManagerStub
        ...
        public final void generateCinematicEffect(
                final CinematicEffectRequest cinematicEffectRequest,
                final ICinematicEffectListener iCinematicEffectListener) {
            if (runForUser(
                    ...
                    new Consumer() { // from class:
                        ...
                        public final void accept(Object obj) {
                            ...
                            ICinematicEffectListener iCinematicEffectListener2 =
                                    iCinematicEffectListener;
                            WallpaperEffectsGenerationPerUserService
                                    wallpaperEffectsGenerationPerUserService =
                                            (WallpaperEffectsGenerationPerUserService) obj;
                            wallpaperEffectsGenerationPerUserService.getClass();
                            String taskId = cinematicEffectRequest2.getTaskId();
                            WallpaperEffectsGenerationPerUserService.CinematicEffectListenerWrapper
                                    cinematicEffectListenerWrapper =
                                            wallpaperEffectsGenerationPerUserService
                                                    .mCinematicEffectListenerWrapper;
                            AbstractMasterSystemService abstractMasterSystemService =
                                    wallpaperEffectsGenerationPerUserService.mMaster;
                            if (cinematicEffectListenerWrapper != null) {
                                try {
                                    iCinematicEffectListener2.onCinematicEffectGenerated(
                                            cinematicEffectListenerWrapper.mTaskId.equals(taskId)
                                                    ? new CinematicEffectResponse.Builder(3, taskId)
                                                            .build()
                                                    : new CinematicEffectResponse.Builder(4, taskId)
                                                            .build());
                                    return;
                                    ...
                                    if (abstractMasterSystemService.debug) {
                                        ProfileService$1$$ExternalSyntheticOutline0.m(
                                                new StringBuilder(
                                                        "RemoteException invoking cinematic effect"
                                                            + " listener for task["),
                                                wallpaperEffectsGenerationPerUserService
                                                        .mCinematicEffectListenerWrapper
                                                        .mTaskId,
                            ...
                            RemoteWallpaperEffectsGenerationService ensureRemoteServiceLocked =
                                    wallpaperEffectsGenerationPerUserService
                                            .ensureRemoteServiceLocked();
                            if (ensureRemoteServiceLocked != 0) {
                                ensureRemoteServiceLocked.executeOnResolvedService(
                                        new AbstractRemoteService.AsyncRequest() { // from class:
                                            // com.android.server.wallpapereffectsgeneration.WallpaperEffectsGenerationPerUserService$$ExternalSyntheticLambda0
                                            public final void run(IInterface iInterface) {
                                                ((IWallpaperEffectsGenerationService) iInterface)
                                                        .onGenerateCinematicEffect(
                                                                cinematicEffectRequest2);
                                            }
                                        });
                                wallpaperEffectsGenerationPerUserService
                                                .mCinematicEffectListenerWrapper =
                                        new WallpaperEffectsGenerationPerUserService
                                                .CinematicEffectListenerWrapper(
                                                taskId, iCinematicEffectListener2);
                                return;
                            }
                            if (abstractMasterSystemService.debug) {
                                Slog.d(
                            ...
                            try {
                                iCinematicEffectListener2.onCinematicEffectGenerated(
                                        new CinematicEffectResponse.Builder(0, taskId).build());
                            } catch (RemoteException unused2) {
                                if (abstractMasterSystemService.debug) {
                                    DeviceIdleController$$ExternalSyntheticOutline0.m(
                                            "Failed to invoke cinematic effect listener for task [",
                                            taskId,
                                            "]",
                                            "WallpaperEffectsGenerationPerUserService");
                                }
            ...
            try {
                iCinematicEffectListener.onCinematicEffectGenerated(
                        new CinematicEffectResponse.Builder(0, cinematicEffectRequest.getTaskId())
                                .build());
            } catch (RemoteException unused) {
            }
        }
        ...
        public final void returnCinematicEffectResponse(
                final CinematicEffectResponse cinematicEffectResponse) {
            runForUser(
                    "returnCinematicResponse",
                    false,
                    new Consumer() { // from class:
                                     // com.android.server.wallpapereffectsgeneration.WallpaperEffectsGenerationManagerService$WallpaperEffectsGenerationManagerStub$$ExternalSyntheticLambda0
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            ((WallpaperEffectsGenerationPerUserService) obj)
        ...
        public final boolean runForUser(String str, boolean z, Consumer consumer) {
            ...
            if (z
                    && WallpaperEffectsGenerationManagerService.this
                            ...
                            != 0
                    && !WallpaperEffectsGenerationManagerService.this.mServiceNameResolver
                            .isTemporary(handleIncomingUser)
                    && !WallpaperEffectsGenerationManagerService.this.mActivityTaskManagerInternal
                            .isCallerRecents(Binder.getCallingUid())) {
                StringBuilder m =
                        DumpUtils$$ExternalSyntheticOutline0.m(
                                "Permission Denial: Cannot call ", str, " from pid=");
                        ...
                        if (wallpaperEffectsGenerationPerUserService != null) {
                            if (!z
                                    && wallpaperEffectsGenerationPerUserService
                                            ...
                                            != callingUid) {
                                String str2 =
                                        "Permission Denial: cannot call "
                                                + str
                                                + ", uid["
                                                + callingUid
                                                + "] doesn't match service implementation";
    ...
    public WallpaperEffectsGenerationManagerService(Context context) {
        super(
                ...
                new FrameworkResourcesServiceNameResolver(
                        context, R.string.device_state_notification_settings_button),
                null,
                17);
    ...
    public final void onServicePackageRestartedLocked(int i) {
        WallpaperEffectsGenerationPerUserService wallpaperEffectsGenerationPerUserService =
                (WallpaperEffectsGenerationPerUserService) peekServiceForUserLocked(i);
        if (wallpaperEffectsGenerationPerUserService != null) {
    ...
    public final void onStart() {
        publishBinderService(
                "wallpaper_effects_generation", new WallpaperEffectsGenerationManagerStub());
    }
}
