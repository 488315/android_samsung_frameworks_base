...
public class VpnManagerService extends IVpnManager.Stub {
    ...
    public String[] getDnsServerListForInterface(String str) {
        ...
        try {
            ...
            while (true) {
                ...
                if (linkProperties.getInterfaceName() != null && linkProperties.getInterfaceName().equals(str)) {
                    break;
                }
                i++;
            }
    ...
    */
    public boolean prepareEnterpriseVpnExt(String str, boolean z) {
        ...
        int callingUid = Binder.getCallingUid();
        try {
            if (Binder.getCallingUid() != 1000 && !getService().checkIfCallerIsVpnVendor(Binder.getCallingUid())) {
            ...
            if (getService().checkIfVendorCreatedKnoxProfile(str, callingUid, userId)) {
                ...
                if (knoxVpnProfileType == 1) {
                    synchronized (this.knoxVpnLock) {
                        if (this.mEnterpriseVpnStoreObj.get(userId) != null && (enterpriseVpn = (EnterpriseVpn) ((HashMap) this.mEnterpriseVpnStoreObj.get(userId)).get(str)) != null) {
