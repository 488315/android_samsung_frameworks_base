...
public abstract class IntentResolver {
  public static final Comparator mResolvePrioritySorter =
      new Comparator() { // from class: com.android.server.IntentResolver.1
  ...
  public void addFilter(PackageDataSnapshot packageDataSnapshot, Object obj) {
    ...
    int register_intent_filter =
        register_intent_filter(
            obj, intentFilter.schemesIterator(), this.mSchemeToFilter, "      Scheme: ");
    int register_mime_types = register_mime_types(obj, "      Type: ");
    if (register_intent_filter == 0 && register_mime_types == 0) {
      register_intent_filter(
          obj, intentFilter.actionsIterator(), this.mActionToFilter, "      Action: ");
    }
    if (register_mime_types != 0) {
      register_intent_filter(
          obj, intentFilter.actionsIterator(), this.mTypedActionToFilter, "      TypedAction: ");
    }
  }
    ...
    if (z) {
      Slog.v(
          ...
          "Filter did not match: "
              + (match != -4
                  ? match != -3
                      ? match != -2 ? match != -1 ? "unknown reason" : "type" : "data"
                      : "action"
                  : "category"));
    }
    return false;
  ...
  public ArrayList findFilters(IntentFilter intentFilter) {
    if (intentFilter.countDataSchemes() == 1) {
      return collectFilters(
          (Object[]) this.mSchemeToFilter.get(intentFilter.getDataScheme(0)), intentFilter);
    }
    if (intentFilter.countDataTypes() != 0 && intentFilter.countActions() == 1) {
      return collectFilters(
          (Object[]) this.mTypedActionToFilter.get(intentFilter.getAction(0)), intentFilter);
    }
    if (intentFilter.countDataTypes() == 0
        && intentFilter.countDataSchemes() == 0
        && intentFilter.countActions() == 1) {
      return collectFilters(
          (Object[]) this.mActionToFilter.get(intentFilter.getAction(0)), intentFilter);
    }
    ...
    while (i < arrayMap.size()) {
      ...
      if (!z2 || z) {
        ...
        while (i4 < arrayMap3.size()) {
          ...
          dumpFilterLabel(
              printWriter, str7, arrayMap3.keyAt(i4), ((MutableInt) arrayMap3.valueAt(i4)).value);
          i4++;
          z3 = true;
        }
  ...
  public boolean dump(
    ...
    if (dumpMap(
        printWriter, str6, "MIME Typed Actions:", str4, this.mTypedActionToFilter, str3, z, z2)) {
      str6 = str5;
    }
    return str6 == str5;
  }
  ...
  public class IteratorWrapper implements Iterator {
    ...
    public boolean hasNext() {
      return this.f1618mI.hasNext();
    }

    @Override // java.util.Iterator
    public Object next() {
      Object next = this.f1618mI.next();
      this.mCur = next;
      return next;
    }
  ...
  public List queryIntentFromList(
      Computer computer, Intent intent, String str, boolean z, ArrayList arrayList, int i, long j) {
  ...
  */
  public final List queryIntent(
    ...
    if (str != null && (indexOf = str.indexOf(47)) > 0) {
      ...
      if (!substring.equals("*")) {
        if (str.length() != indexOf + 2 || str.charAt(indexOf + 1) != '*') {
          objArr = (Object[]) this.mTypeToFilter.get(str);
          if (z2) {
            Slog.v("IntentResolver", "First type cut: " + Arrays.toString(objArr));
          }
          objArr6 = (Object[]) this.mWildTypeToFilter.get(substring);
          if (z2) {
            Slog.v("IntentResolver", "Second type cut: " + Arrays.toString(objArr6));
          }
        } else {
          objArr = (Object[]) this.mBaseTypeToFilter.get(substring);
          if (z2) {
            Slog.v("IntentResolver", "First type cut: " + Arrays.toString(objArr));
          }
          objArr6 = (Object[]) this.mWildTypeToFilter.get(substring);
        ...
        Object[] objArr7 = (Object[]) this.mWildTypeToFilter.get("*");
        if (z2) {
          Slog.v("IntentResolver", "Third type cut: " + Arrays.toString(objArr7));
        }
        objArr3 = objArr7;
        objArr2 = objArr6;
        if (scheme != null) {
          Object[] objArr8 = (Object[]) this.mSchemeToFilter.get(scheme);
          if (z2) {
            Slog.v("IntentResolver", "Scheme list: " + Arrays.toString(objArr8));
          }
          objArr4 = objArr8;
        } else {
          objArr4 = null;
        ...
        if (str == null || scheme != null || intent.getAction() == null) {
          ...
          Object[] objArr9 = (Object[]) this.mActionToFilter.get(intent.getAction());
          if (z2) {
            Slog.v("IntentResolver", "Action list: " + Arrays.toString(objArr9));
          }
          objArr5 = objArr9;
        }
        FastImmutableArraySet fastIntentCategories = getFastIntentCategories(intent);
        ...
        if (objArr2 != null) {
          buildResolveList(
              computer, intent, fastIntentCategories, z2, z, str, scheme, objArr2, arrayList, i, j);
        }
        if (objArr3 != null) {
          buildResolveList(
              computer, intent, fastIntentCategories, z2, z, str, scheme, objArr3, arrayList, i, j);
        }
        if (objArr4 != null) {
          buildResolveList(
              computer, intent, fastIntentCategories, z2, z, str, scheme, objArr4, arrayList, i, j);
        }
      ...
      if (intent.getAction() != null) {
        objArr = (Object[]) this.mTypedActionToFilter.get(intent.getAction());
        if (z2) {
          Slog.v("IntentResolver", "Typed Action list: " + Arrays.toString(objArr));
        }
        objArr2 = null;
        objArr3 = null;
        if (scheme != null) {}
        if (str == null) {}
        objArr5 = objArr;
        FastImmutableArraySet fastIntentCategories2 = getFastIntentCategories(intent);
    ...
    if (str == null) {}
    objArr5 = objArr;
    FastImmutableArraySet fastIntentCategories22 = getFastIntentCategories(intent);
  ...
  public final int unregister_intent_filter(
      Object obj, Iterator it, ArrayMap arrayMap, String str) {
    int i = 0;
    if (it == null) {
      return 0;
    }
  ...
  public final void buildResolveList(
    ...
    while (i4 < length) {
      ...
      if (isExcludingStopped && isFilterStopped(computer, obj, i)) {
        ...
        if (allowFilterResult(obj, list)) {
          ...
          int match =
              intentFilter.match(str5, str, str2, data, fastImmutableArraySet, "IntentResolver");
          if (match >= 0) {
            if (z) {
              Slog.v(
                  "IntentResolver",
    ...
    if (z && z3) {
      if (list.size() == 0) {
        Slog.v(
            "IntentResolver", "resolveIntent failed: found match, but none with CATEGORY_DEFAULT");
      } else if (list.size() > 1) {
        Slog.v(
            "IntentResolver", "resolveIntent: multiple matches, only some with CATEGORY_DEFAULT");
      }
    }
  }
