...
public class GrammaticalInflectionService extends SystemService {
  ...
  public GrammaticalInflectionService(Context context) {
    ...
    this.mService =
        new IGrammaticalInflectionManager
            .Stub() { // from class:
                      // com.android.server.grammaticalinflection.GrammaticalInflectionService.1
  ...
  public void onStart() {
    ...
    LocalServices.addService(
        GrammaticalInflectionManagerInternal.class, new GrammaticalInflectionManagerInternalImpl());
  }
  ...
  public void setRequestedApplicationGrammaticalGender(String str, int i, int i2) {
    ...
    ActivityTaskManagerInternal.PackageConfigurationUpdater createPackageConfigurationUpdater =
        this.mActivityTaskManagerInternal.createPackageConfigurationUpdater(str, i);
    if (SystemProperties.getBoolean("i18n.grammatical_Inflection.enabled", true)) {
      FrameworkStatsLog.write(
          FrameworkStatsLog.GRAMMATICAL_INFLECTION_CHANGED,
          2,
          this.mPackageManagerInternal.getPackageUid(str, 0L, i),
          i2 != 0,
          applicationGrammaticalGender != 0);
