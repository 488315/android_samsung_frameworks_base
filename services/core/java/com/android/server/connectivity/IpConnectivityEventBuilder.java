...
public abstract class IpConnectivityEventBuilder {
  ...
  public static byte[] serialize(int i, List list) {
    ...
    IpConnectivityLogClass.IpConnectivityEvent[] ipConnectivityEventArr =
        (IpConnectivityLogClass.IpConnectivityEvent[])
            list.toArray(new IpConnectivityLogClass.IpConnectivityEvent[list.size()]);
  ...
  public static List toProto(List list) {
    ...
    while (it.hasNext()) {
      IpConnectivityLogClass.IpConnectivityEvent proto =
          toProto((ConnectivityMetricsEvent) it.next());
      if (proto != null) {
        arrayList.add(proto);
      }
    }
  ...
  public static IpConnectivityLogClass.IpConnectivityEvent toProto(ConnectStats connectStats) {
    ...
    IpConnectivityLogClass.IpConnectivityEvent buildEvent =
        buildEvent(connectStats.netId, connectStats.transports, null);
  ...
  public static IpConnectivityLogClass.IpConnectivityEvent toProto(DnsEvent dnsEvent) {
    ...
    IpConnectivityLogClass.IpConnectivityEvent buildEvent =
        buildEvent(dnsEvent.netId, dnsEvent.transports, null);
  ...
  public static IpConnectivityLogClass.IpConnectivityEvent toProto(
    ...
    defaultNetworkEvent2.previousDefaultNetworkLinkLayer =
        transportsToLinkLayer(defaultNetworkEvent.previousTransports);
    IpConnectivityLogClass.IpConnectivityEvent buildEvent =
        buildEvent(defaultNetworkEvent.netId, defaultNetworkEvent.transports, null);
  ...
  public static boolean setEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent, Parcelable parcelable) {
  ...
  public static void setDhcpErrorEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent,
      DhcpErrorEvent dhcpErrorEvent) {
  ...
  public static void setDhcpClientEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent,
      DhcpClientEvent dhcpClientEvent) {
    IpConnectivityLogClass.DHCPEvent dHCPEvent = new IpConnectivityLogClass.DHCPEvent();
  ...
  public static void setIpManagerEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent,
      IpManagerEvent ipManagerEvent) {
  ...
  public static void setIpReachabilityEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent,
      IpReachabilityEvent ipReachabilityEvent) {
    IpConnectivityLogClass.IpReachabilityEvent ipReachabilityEvent2 =
  ...
  public static void setNetworkEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent, NetworkEvent networkEvent) {
  ...
  public static void setValidationProbeEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent,
  ...
  public static void setApfProgramEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent,
  ...
  public static void setApfStats(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent, ApfStats apfStats) {
  ...
  public static void setRaEvent(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent, RaEvent raEvent) {
  ...
  public static void inferLinkLayer(
      IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent) {
