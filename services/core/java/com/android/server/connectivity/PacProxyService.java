...
public class PacProxyService extends IPacProxyManager.Stub {
  ...
  public Runnable mPacDownloader =
  ...
  public final void setDownloadIn(int i) {
    getAlarmManager()
        .set(
            3,
            (getDownloadDelay(i) * 1000) + SystemClock.elapsedRealtime(),
            this.mPacRefreshIntent);
  }
  ...
  public final void bind() {
    ...
    ServiceConnection serviceConnection =
        new ServiceConnection() { // from class: com.android.server.connectivity.PacProxyService.2
    ...
    ServiceConnection serviceConnection2 =
        new ServiceConnection() { // from class: com.android.server.connectivity.PacProxyService.3
          @Override // android.content.ServiceConnection
          public void onServiceDisconnected(ComponentName componentName) {}
            ...
            if (asInterface != null) {
              try {
                asInterface.getProxyPort(
                    new IProxyPortListener
                        .Stub() { // from class: com.android.server.connectivity.PacProxyService.3.1
                      public void setProxyPort(int i) {
                        ...
                        Log.e(
                            "PacProxyService",
                            "Received invalid port from Local Proxy, PAC will not be operational");
                      }
                    });
              } catch (RemoteException e) {
                e.printStackTrace();
    ...
    this.mContext.bindServiceAsUser(
        intent2, serviceConnection2, 1073741829, this.mNetThreadHandler, UserHandle.SYSTEM);
  }
