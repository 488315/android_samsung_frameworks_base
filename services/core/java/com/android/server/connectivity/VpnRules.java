...
public class VpnRules {
  ...
  public int setTcpPortBypassRule(
      boolean z, int i, int i2, int i3, int i4, String str, String str2) {
    if (i > 0
        && i2 > 0
        && i3 > 0
        && i4 > 0
  ...
  public final synchronized void runVpnRulesCommand(int i, String str) {
    ...
    try {
      ...
      Log.d(
          "VpnRules",
          "runCmd: cmd = {"
              + str.replaceAll(KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, "|")
              + "} param.len="
  ...
  public final synchronized String runShellCommand(String str) {
    ...
    try {
      ...
      String runTcpMonitorShellCommand =
          this.mOemNetd.runTcpMonitorShellCommand(str, stringBuffer2);
