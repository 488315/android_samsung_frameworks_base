...
public class NetdEventListenerService extends BaseNetdEventListener {
  ...
  public NetdEventListenerService(ConnectivityManager connectivityManager) {
        ...
        new BroadcastReceiver() { // from class:
          ...
          public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("com.samsung.android.mobiledoctor.GETMOBILEDATAFILES")
                || action.equals("com.samsung.android.action.ACTION_REQUEST_INTERNET_LOG")) {
    ...
    connectivityManager.registerNetworkCallback(
        new NetworkRequest.Builder().clearCapabilities().build(), transportForNetIdNetworkCallback);
  }
  ...
  public final void collectPendingMetricsSnapshot(long j, boolean z) {
    if (z || Math.abs(j - this.mLastSnapshot) > 60000) {
      ...
      NetworkMetricsSnapshot collect =
          NetworkMetricsSnapshot.collect(projectSnapshotTime, this.mNetworkMetrics);
  ...
  @Override // com.android.net.module.util.BaseNetdEventListener,
  // android.net.metrics.INetdEventListener
  public synchronized void onDnsEvent(
  ...
  public void dnsHandleEvent(DnsResultParams dnsResultParams) {
    ...
    if (i2 != 0 && this.mContext != null) {
      ...
      boolean isUidNetworkingBlocked =
          this.mPolicyManager.isUidNetworkingBlocked(i3, !r4.hasCapability(11));
      String str = TAG;
      Log.d(
          str,
          "DNS Requested by "
              + dnsResultParams.mNetId
              + ", "
              + i3
              + ", "
              + i2
      ...
      TelephonyManager telephonyManager =
          new TelephonyManager(this.mContext, defaultDataSubscriptionId);
      ...
      if (this.mFailCount == 20 && type == 0 && i6 != this.mCheckedNetId) {
        ...
        try {
          ...
          try {
            ...
            datagramSocket.send(
                new DatagramPacket(
                    byteArray, byteArray.length, InetAddress.parseNumericAddress("8.8.8.8"), 53));
  ...
  @Override // com.android.net.module.util.BaseNetdEventListener,
  // android.net.metrics.INetdEventListener
  public synchronized void onWakeupEvent(
      String str,
      int i,
      int i2,
      int i3,
    ...
    if (batteryStatsInternal != null) {
      batteryStatsInternal.noteCpuWakingNetworkPacket(
          fromNetworkHandle,
          (SystemClock.elapsedRealtime() + wakeupEvent.timestampMs) - System.currentTimeMillis(),
          wakeupEvent.uid);
    }
  ...
  @Override // com.android.net.module.util.BaseNetdEventListener,
  // android.net.metrics.INetdEventListener
  public synchronized void onTcpSocketStatsEvent(
    ...
    if (iArr.length == iArr2.length
      ...
      for (int i = 0; i < iArr.length; i++) {
        int i2 = iArr[i];
        getMetricsForNetwork(currentTimeMillis, i2)
  ...
  public synchronized void list(PrintWriter printWriter) {
    NetworkMetricsSnapshot collect =
        NetworkMetricsSnapshot.collect(System.currentTimeMillis(), this.mNetworkMetrics);
    if (!collect.stats.isEmpty()) {
      this.mNetworkMetricsSnapshots.append(collect);
    }
    ...
    for (int i = 0; i < this.mNetworkMetrics.size(); i++) {
      arrayList.add(
          IpConnectivityEventBuilder.toProto(
              ((NetworkMetrics) this.mNetworkMetrics.valueAt(i)).connectMetrics));
    }
    for (int i2 = 0; i2 < this.mNetworkMetrics.size(); i2++) {
      arrayList.add(
          IpConnectivityEventBuilder.toProto(
              ((NetworkMetrics) this.mNetworkMetrics.valueAt(i2)).dnsMetrics));
    }
    for (int i3 = 0; i3 < this.mWakeupStats.size(); i3++) {
      arrayList.add(
          IpConnectivityEventBuilder.toProto((WakeupStats) this.mWakeupStats.valueAt(i3)));
    }
    return arrayList;
  }
    ...
    public void log(String str) {
      ...
      append(
          String.format(
              ...
              calendar, calendar, calendar, calendar, calendar, calendar, str));
    }
  ...
  public void writeMobileDataDnsFile() {
    ...
    try {
      this.mDnsErrorInfoLog.dump(printWriter);
      printWriter.flush();
      printWriter.close();
    } catch (Exception e2) {
      e = e2;
