...
public final class IpConnectivityMetrics extends SystemService {
  public static final ToIntFunction READ_BUFFER_SIZE = new ToIntFunction() { // from class:
        // com.android.server.connectivity.IpConnectivityMetrics$$ExternalSyntheticLambda0
  ...
  public final boolean isRateLimited(ConnectivityMetricsEvent connectivityMetricsEvent) {
    TokenBucket tokenBucket =
        (TokenBucket) this.mBuckets.get(connectivityMetricsEvent.data.getClass());
  ...
  public static /* synthetic */ void lambda$cmdListAsTextProto$0(
      PrintWriter printWriter, IpConnectivityLogClass.IpConnectivityEvent ipConnectivityEvent) {
        ...
        .forEach(
            new Consumer() { // from class:
              ...
              public final void accept(Object obj) {
                IpConnectivityMetrics.lambda$cmdListAsTextProto$0(
                    printWriter, (IpConnectivityLogClass.IpConnectivityEvent) obj);
              }
            });
  }
    ...
    */
    ...
    public final void enforcePermission(String str) {
      IpConnectivityMetrics.this
          .getContext()
          .enforceCallingOrSelfPermission(str, IpConnectivityMetrics.TAG);
    }
    ...
    public void logDefaultNetworkValidity(boolean z) {
      NetworkStack.checkNetworkStackPermission(IpConnectivityMetrics.this.getContext());
      IpConnectivityMetrics.this.mDefaultNetworkMetrics.logDefaultNetworkValidity(
    ...
    public void logDefaultNetworkEvent(
      ...
      NetworkStack.checkNetworkStackPermission(IpConnectivityMetrics.this.getContext());
      IpConnectivityMetrics.this.mDefaultNetworkMetrics.logDefaultNetworkEvent(
  ...
  public static /* synthetic */ int lambda$static$1(Context context) {
    int i =
        Settings.Global.getInt(
            context.getContentResolver(), "connectivity_metrics_buffer_size", 2000);
    if (i <= 0) {
      return 2000;
    }
