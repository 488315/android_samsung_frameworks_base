                ...
                if (i3 != 23) {
                    if (i3 == 52) {
                        ...
                        switch (i3) {
                            ...
                            case 4:
                            case 5:
                                AudioDeviceBroker.this.onSetForceUse(message.arg1, message.arg2, i3 == 5, (String) message.obj);
                                break;
                            case 6:
                                synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                ...
                                synchronized (AudioDeviceBroker.this.mSetModeLock) {
                                    synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                        ...
                                        if (btDeviceInfo.mProfile == 22 && !btDeviceInfo.mIsLeOutput) {
                                            ...
                                            audioDeviceInventory.onSetBtActiveDevice(btDeviceInfo, bluetoothContextualVolumeStream);
                                            i2 = btDeviceInfo.mProfile;
                                            if (i2 != 22 || i2 == 21) {
                                                AudioDeviceBroker audioDeviceBroker2 = AudioDeviceBroker.this;
                                                audioDeviceBroker2.onUpdateCommunicationRouteClient(audioDeviceBroker2.isBluetoothScoRequested(), "setBluetoothActiveDevice");
                                            }
                                        }
                                        bluetoothContextualVolumeStream = AudioDeviceBroker.this.mAudioService.getBluetoothContextualVolumeStream();
                                        audioDeviceInventory.onSetBtActiveDevice(btDeviceInfo, bluetoothContextualVolumeStream);
                                        i2 = btDeviceInfo.mProfile;
                                        if (i2 != 22) {
                                        }
                                        AudioDeviceBroker audioDeviceBroker22 = AudioDeviceBroker.this;
                                        audioDeviceBroker22.onUpdateCommunicationRouteClient(audioDeviceBroker22.isBluetoothScoRequested(), "setBluetoothActiveDevice");
                                    }
                                    break;
                                }
                            default:
                                    ...
                                    case 15:
                                        synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                            ...
                                            if (AudioDeviceBroker.this.isDualModeActive()) {
                                                AudioDeviceBroker.this.mBtHelper.setLeAudioVolume(message.arg1, AudioDeviceBroker.this.mAudioService.getMaxVssVolumeForStream(3), 3);
                                            }
                                        }
                                        break;
                                    case 16:
                                        synchronized (AudioDeviceBroker.this.mSetModeLock) {
                                            synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                                boolean isBluetoothScoRequested = AudioDeviceBroker.this.isBluetoothScoRequested();
                                                ...
                                                if (AudioDeviceBroker.this.mAudioModeOwner.mUid != AudioDeviceBroker.this.mRequestScoUid) {
                                                    AudioDeviceBroker.this.resetRequestBtSco();
                                                }
                                                if (AudioDeviceBroker.this.mAudioModeOwner.mMode != 1) {
                                                    AudioDeviceBroker.this.onUpdateCommunicationRouteClient(isBluetoothScoRequested, "setNewModeOwner");
                                                }
                                            }
                                            break;
                                        }
                                                ...
                                                switch (i3) {
                                                    case 42:
                                                        ...
                                                        synchronized (AudioDeviceBroker.this.mCommunicationDeviceLock) {
                                                            if (AudioDeviceBroker.this.mCommunicationDeviceUpdateCount > 0) {
                                                                ...
                                                                Log.e("AS.AudioDeviceBroker", "mCommunicationDeviceUpdateCount already 0 in MSG_L_SET_COMMUNICATION_DEVICE_FOR_CLIENT");
                                                            }
                                                    ...
                                                    case 43:
                                                        synchronized (AudioDeviceBroker.this.mSetModeLock) {
                                                            synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                                                ...
                                                                audioDeviceBroker3.onUpdateCommunicationRouteClient(r3, (String) message.obj);
                                                            }
                                                            break;
                                                        }
                                                    case 44:
                                                    ...
                                                    case 45:
                                                        ...
                                                        if (btDeviceInfo2.mDevice != null) {
                                                            AudioService.sDeviceLogger.enqueue(new EventLogger.StringEvent("msg: onBluetoothActiveDeviceChange  state=" + btDeviceInfo2.mState + " addr=" + btDeviceInfo2.mDevice.getAddress() + " prof=" + btDeviceInfo2.mProfile + " supprNoisy=" + btDeviceInfo2.mSupprNoisy + " src=" + btDeviceInfo2.mEventSource).printLog("AS.AudioDeviceBroker"));
                                                            synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                                                if (btDeviceInfo2.mProfile == 26 && btDeviceInfo2.mState == 2) {
                                                                    AudioExecutor.execute(new Runnable() { // from class: com.android.server.audio.AudioDeviceBroker$BrokerHandler$$ExternalSyntheticLambda0
                                                                        @Override // java.lang.Runnable
                                                                        public final void run() {
                                                                            AudioDeviceBroker.BrokerHandler.this.lambda$handleMessage$0();
                                                                        }
                                                                    });
                                                                }
                                                    ...
                                                    case 46:
                                                        ...
                                                        synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                                            ...
                                                            if (AudioDeviceBroker.this.isDualModeActive() && bleVolumeInfo.mStreamType == 3) {
                                                                AudioDeviceBroker.this.mBtHelper.setAvrcpAbsoluteVolumeIndex(bleVolumeInfo.mIndex);
                                                            }
                                                        }
                                                        break;
                                                    case 47:
                                                    ...
                                                    default:
                                                        switch (i3) {
                                                            case 2759:
                                                                AudioDeviceBroker.this.mDualA2dpManager = new DualA2dpVolumeManager(AudioDeviceBroker.this.mContext, AudioDeviceBroker.this.mBrokerHandler, AudioService.MAX_STREAM_VOLUME[3]);
                                                                break;
                                                            case 2760:
                                                                synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                                                    AudioDeviceBroker.this.mDeviceInventory.onSetDeviceConnectionStateForceByUser((AudioDeviceInventory.SetForceDeviceState) message.obj);
                                                                }
                                                                break;
                                                            case 2761:
                                                                AudioDeviceBroker.this.setActiveBluetoothDevice((BluetoothDevice) message.obj);
                                                                break;
                                                            default:
                        ...
                        if (AudioDeviceBroker.this.mAudioModeOwner.mPid != 0) {
                            AudioService.sScoPreventionLogger.enqueue(new EventLogger.StringEvent("MSG_CHECK_ABNORMAL_SCO skipped to remove SCO client mode 0 uid = " + i5 + " mAudioModeOwner  = " + AudioDeviceBroker.this.mAudioModeOwner).printLog("AS.AudioDeviceBroker"));
                        } else {
                            synchronized (AudioDeviceBroker.this.mDeviceStateLock) {
                                ...
                                while (it.hasNext()) {
                                    ...
                                    if (communicationRouteClient.getDevice().getType() == 7) {
                                        ...
                                        if (i5 == communicationRouteClient.getUid()) {
                                            ...
                                            it.remove();
                                            i--;
                                            AudioService.sScoPreventionLogger.enqueue(new EventLogger.StringEvent("MSG_CHECK_ABNORMAL_SCO removed SCO client uid = " + communicationRouteClient.getUid()).printLog("AS.AudioDeviceBroker"));
                                        }
                                    }
                                }
                            }
                            if (i == 0 && AudioDeviceBroker.this.mBtHelper.isBluetoothScoOn() && AudioDeviceBroker.this.mBtHelper.isScoStateInternal()) {
                                AudioService.sScoPreventionLogger.enqueue(new EventLogger.StringEvent("MSG_CHECK_ABNORMAL_SCO stopScoUsingVirtualVoiceCall()").printLog("AS.AudioDeviceBroker"));
