...
public final class FadeOutManager {
    ...
    public synchronized void unfadeOutUid(int i, HashMap hashMap) {
        ...
        CurrentDeviceManager$$ExternalSyntheticThrowCCEIfNotNull0.m4m(this.mFadedApps.remove(Integer.valueOf(i)));
    }

    public synchronized void checkFade(AudioPlaybackConfiguration audioPlaybackConfiguration) {
        CurrentDeviceManager$$ExternalSyntheticThrowCCEIfNotNull0.m4m(this.mFadedApps.get(Integer.valueOf(audioPlaybackConfiguration.getClientUid())));
    }
