...
public final /* synthetic */ class AudioService$$ExternalSyntheticLambda12 implements BiConsumer {
    ...
    public /* synthetic */ AudioService$$ExternalSyntheticLambda12(
    ...
    public final void accept(Object obj, Object obj2) {
        switch (this.$r8$classId) {
            case 0:
                ...
                int[] iArr = this.f$2;
                IMuteAwaitConnectionCallback iMuteAwaitConnectionCallback =
                        (IMuteAwaitConnectionCallback) obj;
                ...
                try {
                    if (!bool.booleanValue()) {
                        audioDeviceAttributes =
                                AudioService.anonymizeAudioDeviceAttributesUnchecked(
                                        audioDeviceAttributes);
                    }
                    iMuteAwaitConnectionCallback.dispatchOnUnmutedEvent(
                            3, audioDeviceAttributes, iArr);
                    break;
            ...
            case 1:
                ...
                int[] iArr2 = this.f$2;
                IMuteAwaitConnectionCallback iMuteAwaitConnectionCallback2 =
                        (IMuteAwaitConnectionCallback) obj;
                ...
                try {
                    if (!bool2.booleanValue()) {
                        audioDeviceAttributes2 =
                                AudioService.anonymizeAudioDeviceAttributesUnchecked(
                                        audioDeviceAttributes2);
                    }
                    iMuteAwaitConnectionCallback2.dispatchOnMutedUntilConnection(
                            audioDeviceAttributes2, iArr2);
                    break;
            ...
            default:
                ...
                int[] iArr3 = this.f$2;
                IMuteAwaitConnectionCallback iMuteAwaitConnectionCallback3 =
                        (IMuteAwaitConnectionCallback) obj;
                ...
                try {
                    if (!bool3.booleanValue()) {
                        audioDeviceAttributes3 =
                                AudioService.anonymizeAudioDeviceAttributesUnchecked(
                                        audioDeviceAttributes3);
                    }
                    iMuteAwaitConnectionCallback3.dispatchOnUnmutedEvent(
                            1, audioDeviceAttributes3, iArr3);
                    break;
