...
public class BtHelper {
  ...
  public BluetoothProfile.ServiceListener mBluetoothProfileServiceListener =
      new BluetoothProfile.ServiceListener() { // from class: com.android.server.audio.BtHelper.1
  ...
  public synchronized void onSystemReady() {
    ...
    if (defaultAdapter != null) {
      defaultAdapter.getProfileProxy(
          this.mDeviceBroker.getContext(), this.mBluetoothProfileServiceListener, 2);
      defaultAdapter.getProfileProxy(
          this.mDeviceBroker.getContext(), this.mBluetoothProfileServiceListener, 21);
      defaultAdapter.getProfileProxy(
          this.mDeviceBroker.getContext(), this.mBluetoothProfileServiceListener, 22);
      defaultAdapter.getProfileProxy(
          this.mDeviceBroker.getContext(), this.mBluetoothProfileServiceListener, 26);
    }
    this.mVibratorManagerInternal =
        (VibratorManagerInternal) LocalServices.getService(VibratorManagerInternal.class);
  }

  public synchronized void onAudioServerDiedRestoreA2dp() {
    this.mDeviceBroker.setForceUse_Async(
        1, this.mDeviceBroker.getBluetoothA2dpEnabled() ? 0 : 10, "onAudioServerDied()");
  }
  ...
  public synchronized void setAvrcpAbsoluteVolumeIndex(int i) {
    if (this.mA2dp == null) {
      AudioService.sVolumeLogger.enqueue(
          new EventLogger.StringEvent("setAvrcpAbsoluteVolumeIndex: bailing due to null mA2dp")
              .printLog("AS.BtHelper"));
      return;
    }
    if (!this.mAvrcpAbsVolSupported) {
      AudioService.sVolumeLogger.enqueue(
          new EventLogger.StringEvent("setAvrcpAbsoluteVolumeIndex: abs vol not supported ")
              .printLog("AS.BtHelper"));
      return;
    }
  ...
  public synchronized void receiveBtEvent(Intent intent) {
    ...
    Log.i(
        "AS.BtHelper",
        "receiveBtEvent action: " + action + " mScoAudioState: " + this.mScoAudioState);
    if (action.equals("android.bluetooth.headset.profile.action.ACTIVE_DEVICE_CHANGED")) {
      setBtScoActiveDevice(
          (BluetoothDevice)
      ...
      if (intExtra == 12) {
        int intExtra2 =
            intent.getIntExtra("com.samsung.bt.hfp.intent.extra.HEADSET_SCO_VOLUME", 7) * 10;
      ...
      if (intExtra3 == 2 && intExtra4 != 1) {
        setBtScoActiveDevice(
            (BluetoothDevice) intent.getParcelableExtra("android.bluetooth.device.extra.DEVICE"));
      }
    }
  }
      ...
      case 10:
        ...
        if (Rune.SEC_AUDIO_REMOTE_MIC
            && Settings.System.getIntForUser(
                    this.mDeviceBroker.getContext().getContentResolver(),
                    "run_amplify_ambient_sound",
                    0,
                    -2)
                == 2) {
          Intent intent =
              new Intent("android.samsung.media.action.ACTION_AUDIO_REMOTEMIC_SCO_RESUME");
        ...
        if (this.mScoAudioState == 1
            ...
            && connectBluetoothScoAudioHelper(
                bluetoothHeadset, bluetoothDevice, this.mScoAudioMode)) {
  ...
  public synchronized void setHearingAidVolume(int i, int i2, boolean z) {
    ...
    Log.i(
        "AS.BtHelper",
        "setHearingAidVolume: calling mHearingAid.setVolume idx=" + i + " gain=" + streamVolumeDB);
    if (z) {
  ...
  public synchronized void onBtProfileConnected(int i, BluetoothProfile bluetoothProfile) {
    ...
    if (bluetoothProfile.getConnectionState(bluetoothDevice) == 2) {
      this.mDeviceBroker.queueOnBluetoothActiveDeviceChanged(
          new AudioDeviceBroker.BtDeviceChangedData(
              bluetoothDevice,
              null,
              new BluetoothProfileConnectionInfo(i),
  ...
  */
    ...
    if (i == 1 || i == 4) {
      ...
      if (bluetoothHeadset2 != null && (bluetoothDevice = this.mBluetoothHeadsetDevice) != null) {
        if (i == 1) {
          z =
              connectBluetoothScoAudioHelper(
                  bluetoothHeadset2, bluetoothDevice, this.mScoAudioMode);
          if (z) {
            this.mScoAudioState = 3;
          }
        } else if (i == 4) {
  ...
  public final boolean handleBtScoActiveDeviceChange(BluetoothDevice bluetoothDevice, boolean z) {
    ...
    if (z) {
      z2 =
          this.mDeviceBroker.handleDeviceConnection(
    ...
    return this.mDeviceBroker.handleDeviceConnection(
            new AudioDeviceAttributes(
                -2147483640,
                btHeadsetDeviceToAudioDevice.getAddress(),
                btHeadsetDeviceToAudioDevice.getName()),
  ...
  public final void setBtScoActiveDevice(BluetoothDevice bluetoothDevice) {
    Log.i(
        "AS.BtHelper",
        "setBtScoActiveDevice: "
            + getAnonymizedAddress(this.mBluetoothHeadsetDevice)
            + " -> "
            + getAnonymizedAddress(bluetoothDevice));
    ...
    if (!handleBtScoActiveDeviceChange(bluetoothDevice2, false)) {
      Log.w(
          "AS.BtHelper",
          "setBtScoActiveDevice() failed to remove previous device "
              + getAnonymizedAddress(bluetoothDevice2));
    }
    if (!handleBtScoActiveDeviceChange(bluetoothDevice, true)) {
      Log.e(
          "AS.BtHelper",
          "setBtScoActiveDevice() failed to add new device "
              + getAnonymizedAddress(bluetoothDevice));
    ...
    SemAudioSystem.setPolicyParameters(
        "l_smart_view_split_sound_enable=" + ScreenSharingHelper.isSplitSoundEnabled());
      ...
      if (i3 == 0) {
          ...
          if (this.mBluetoothHeadsetDevice != null) {
            int i4 =
                Settings.Global.getInt(
                    this.mDeviceBroker.getContentResolver(),
                    "bluetooth_sco_channel_" + this.mBluetoothHeadsetDevice.getAddress(),
                    0);
        ...
        if (bluetoothHeadset == null) {
          if (getBluetoothHeadset()) {
            ...
            Log.w(
                "AS.BtHelper",
                "requestScoState: getBluetoothHeadset failed during connection, mScoAudioMode="
                    + this.mScoAudioMode);
            broadcastScoConnectionState(0);
            return false;
          }
          ...
          if (connectBluetoothScoAudioHelper(
            ...
            Log.w(
                "AS.BtHelper",
                "requestScoState: connect to "
                    + getAnonymizedAddress(this.mBluetoothHeadsetDevice)
                    + " failed, mScoAudioMode="
                    + this.mScoAudioMode);
            broadcastScoConnectionState(0);
            return false;
          }
      ...
      if (i5 == 1) {
        ...
        if (bluetoothHeadset2 == null) {
          if (getBluetoothHeadset()) {
            ...
            Log.w(
                "AS.BtHelper",
                "requestScoState: getBluetoothHeadset failed during disconnection, mScoAudioMode="
                    + this.mScoAudioMode);
            this.mScoAudioState = 0;
            broadcastScoConnectionState(0);
            return false;
          ...
          if (bluetoothDevice2 == null) {
            this.mScoAudioState = 0;
            broadcastScoConnectionState(0);
          } else if (disconnectBluetoothScoAudioHelper(
              bluetoothHeadset2, bluetoothDevice2, this.mScoAudioMode)) {
            this.mScoAudioState = 5;
          } else {
            this.mScoAudioState = 0;
            broadcastScoConnectionState(0);
  ...
  public static boolean disconnectBluetoothScoAudioHelper(
      BluetoothHeadset bluetoothHeadset, BluetoothDevice bluetoothDevice, int i) {
    if (i == 0) {
  ...
  public static boolean connectBluetoothScoAudioHelper(
      BluetoothHeadset bluetoothHeadset, BluetoothDevice bluetoothDevice, int i) {
    if (i == 0) {
  ...
  public final void checkScoAudioState() {
    ...
    if (bluetoothHeadset == null
        || (bluetoothDevice = this.mBluetoothHeadsetDevice) == null
        || this.mScoAudioState != 0
        || bluetoothHeadset.getAudioState(bluetoothDevice) == 10) {
      return;
    }
    this.mScoAudioState = 2;
  }
  ...
  public final boolean getBluetoothHeadset() {
    ...
    boolean profileProxy =
        defaultAdapter != null
            ? defaultAdapter.getProfileProxy(
                this.mDeviceBroker.getContext(), this.mBluetoothProfileServiceListener, 1)
            : false;
  ...
  public void dump(PrintWriter printWriter, String str) {
    ...
    if (bluetoothDevice != null && (bluetoothClass = bluetoothDevice.getBluetoothClass()) != null) {
      printWriter.println(
          str
              + "mBluetoothHeadsetDevice.DeviceClass: "
    ...
    printWriter.println(
        KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + str + "mHearingAid: " + this.mHearingAid);
    printWriter.println(
        KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + str + "mLeAudio: " + this.mLeAudio);
  ...
  public synchronized boolean isBluetoothScoSupported() {
    BluetoothHeadset bluetoothHeadset = this.mBluetoothHeadset;
    if (bluetoothHeadset != null
        && !bluetoothHeadset.getDevicesMatchingConnectionStates(new int[] {2, 1, 3}).isEmpty()) {
      BluetoothDevice bluetoothDevice = this.mBluetoothHeadsetDevice;
      if (bluetoothDevice == null) {
        return false;
      }
  ...
  public boolean isWatchOrBudsWearingOff() {
    ...
    return BtUtils.isSamsungWatch(bluetoothDevice, this.mBluetoothHeadset)
        || BtUtils.isBudsWearingOff(this.mBluetoothHeadsetDevice);
  }
  ...
  public void updateBtAppList(Context context) {
    ...
    eventLogger.enqueue(
        new EventLogger.StringEvent("updateBtAppList for BLE broadcast").printLog("AS.BtHelper"));
    try {
      ...
      if (bluetoothLeBroadcast != null) {
        ...
        if (auracastDbVersion <= j && j != 0) {
          if (auracastDbVersion == 0) {
            eventLogger.enqueue(
                new EventLogger.StringEvent(
                        "updateBtAppList skipped version update : DB version is 0")
                    .printLog("AS.BtHelper"));
          }
        }
        ...
        if (blockPlayerList != null) {
          eventLogger.enqueue(
              new EventLogger.StringEvent(
                      "updateBtAppList get list from BT. version = "
                          + auracastDbVersion
                          + " list size = "
                          + blockPlayerList.size())
                  .printLog("AS.BtHelper"));
          BtUtils.updateBtAppList(context, blockPlayerList, auracastDbVersion);
        } else {
          eventLogger.enqueue(
              new EventLogger.StringEvent("updateBtAppList list is null").printLog("AS.BtHelper"));
        }
      }
    } catch (Exception e) {
      e.printStackTrace();
