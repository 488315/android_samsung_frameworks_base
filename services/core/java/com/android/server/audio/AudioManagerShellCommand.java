        ...
        switch (c) {
            ...
            case 1:
                ...
                if (nextArg2 == null) {
                    ...
                    try {
                        ...
                        if (parseInt >= 0) {
                            ((AudioManager)
                                            this.mService.mContext.getSystemService(
                                                    AudioManager.class))
                        ...
                        getErrPrintWriter()
                                .println("Error: wrong format specified for encoded surround mode");
                    }
                }
                return 1;
            case 2:
            ...
            case 5:
                ...
                if (nextArg3 == null) {
                    ...
                    getErrPrintWriter()
                            .println("Error: no enabled value for surroundFormat specified");
                } else {
                    try {
                        ...
                        if (parseInt2 >= 0) {
                            ((AudioManager)
                                            this.mService.mContext.getSystemService(
                                                    AudioManager.class))
                                    .setSurroundFormatEnabled(parseInt2, parseBoolean);
                            return 0;
                        }
                        getErrPrintWriter().println("Error: invalid value of surroundFormat");
                    } catch (NumberFormatException unused2) {
                        getErrPrintWriter()
                                .println("Error: wrong format specified for surroundFormat");
                    }
                }
                return 1;
            case 6:
            ...
            case 7:
                if (!SystemProperties.getBoolean("ro.product_ship", true)) {
                    ...
                    Intent intent =
                            new Intent(KnoxCustomManagerService.ACTION_SCPM_POLICY_CLEAR_DATA);
            ...
            case '\n':
                AudioDeviceVolumeManager audioDeviceVolumeManager =
                        (AudioDeviceVolumeManager)
                                this.mService.mContext.getSystemService("audio_device_volume");
                int readIntArg7 = readIntArg();
                int readIntArg8 = readIntArg();
                int readIntArg9 = readIntArg();
                VolumeInfo build =
                        new VolumeInfo.Builder(readIntArg7).setVolumeIndex(readIntArg8).build();
                AudioDeviceAttributes audioDeviceAttributes =
                        new AudioDeviceAttributes(readIntArg9, "foo");
                getOutPrintWriter()
                        .println(
                        ...
                        if (parseInt3 >= 0) {
                            ...
                            StringBuilder m =
                                    BatteryService$$ExternalSyntheticOutline0.m(
                                            parseInt3, "Value of enabled for ", " is: ");
            ...
            case 15:
                ...
                getOutPrintWriter()
                        .println(
                                "Encoded surround mode: " + audioManager8.getEncodedSurroundMode());
                return 0;
            case 16:
                ...
                getOutPrintWriter()
                        .println(
                                DualAppManagerService$$ExternalSyntheticOutline0.m(
                                        readIntArg10,
                                        readIntArg11,
                                        "calling AudioManager.setStreamVolume(",
                                        ", ",
                                        ", 0)"));
