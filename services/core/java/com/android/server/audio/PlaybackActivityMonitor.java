...
public final class PlaybackActivityMonitor
  ...
  public static final VolumeShaper.Configuration DUCK_VSHAPE =
      new VolumeShaper.Configuration.Builder()
          .setId(1)
          .setCurve(
              new float[] {DisplayPowerController2.RATE_FROM_DOZE_TO_ON, 1.0f},
              new float[] {1.0f, 0.2f})
          .setOptionFlags(2)
          .setDuration(
              MediaFocusControl.getFocusRampTimeMs(
                  3, new AudioAttributes.Builder().setUsage(5).build()))
          .build();
  ...
  public final FrequentWorker mNotifierSoundAliveForDVFS =
      new FrequentWorker() { // from class: com.android.server.audio.PlaybackActivityMonitor.2
        {
          this.mPeriodMs = 5000;
        ...
        public Void func() {
          ...
          PlaybackActivityMonitor.this.mAudioHandler.sendMessage(
              PlaybackActivityMonitor.this.mAudioHandler.obtainMessage(2762, 2, 0));
          return null;
        }
      };
  ...
  static {
    VolumeShaper.Operation build =
        new VolumeShaper.Operation.Builder(VolumeShaper.Operation.PLAY).createIfNeeded().build();
    ...
    MUTE_AWAIT_CONNECTION_VSHAPE =
        new VolumeShaper.Configuration.Builder()
            ...
            .setCurve(
                new float[] {DisplayPowerController2.RATE_FROM_DOZE_TO_ON, 1.0f},
                new float[] {1.0f, DisplayPowerController2.RATE_FROM_DOZE_TO_ON})
            .setOptionFlags(2)
            .setDuration(100L)
            .build();
    ...
    sEventLoggerSoundPool =
        new EventLogger(50, "SoundPool playback activity. It displays only start event");
  ...
  public PlaybackActivityMonitor(
      Context context, int i, Consumer consumer, AudioService audioService) {
  ...
  public final boolean checkBanPlayer(
    ...
    if (z) {
      ...
      try {
        ...
        Log.e(
            "AS.PlaybackActivityMon", "error banning player " + playerInterfaceId + " uid:" + i, e);
      }
    }
    return z;
  }
  ...
  public int trackPlayer(PlayerBase.PlayerIdCard playerIdCard) {
    ...
    AudioPlaybackConfiguration audioPlaybackConfiguration =
        new AudioPlaybackConfiguration(
            playerIdCard, newAudioPlayerId, Binder.getCallingUid(), Binder.getCallingPid());
    if (audioPlaybackConfiguration.getAudioAttributes().getTags().contains("FAST_PRE_OPEN")) {
      Log.i(
          "AS.PlaybackActivityMon",
          "Skip piid " + newAudioPlayerId + " by dummy audio for fast pre open");
    ...
    synchronized (this.mAllowedCapturePolicies) {
      ...
      if (this.mAllowedCapturePolicies.containsKey(Integer.valueOf(clientUid))) {
        updateAllowedCapturePolicy(
            audioPlaybackConfiguration,
            ((Integer) this.mAllowedCapturePolicies.get(Integer.valueOf(clientUid))).intValue());
      }
    }
  ...
  public void playerAttributes(int i, AudioAttributes audioAttributes, int i2) {
    boolean z;
    synchronized (this.mAllowedCapturePolicies) {
      if (this.mAllowedCapturePolicies.containsKey(Integer.valueOf(i2))
          && audioAttributes.getAllowedCapturePolicy()
              < ((Integer) this.mAllowedCapturePolicies.get(Integer.valueOf(i2))).intValue()) {
        audioAttributes =
            new AudioAttributes.Builder(audioAttributes)
          ...
          while (it.hasNext()) {
            if (checkBanPlayer(audioPlaybackConfiguration, ((Integer) it.next()).intValue())) {
              sEventLogger.enqueue(
                  new EventLogger.StringEvent("not starting piid:" + i + " ,is banned"));
              return;
            }
          }
  ...
  public void portEvent(int i, int i2, PersistableBundle persistableBundle, int i3) {
    ...
    synchronized (this.mPlayerLock) {
      ...
      AudioPlaybackConfiguration audioPlaybackConfiguration =
          (AudioPlaybackConfiguration) this.mPlayers.get(Integer.valueOf(i4));
      if (audioPlaybackConfiguration == null) {
        return;
      }
  ...
  public final void updateAllowedCapturePolicy(
      AudioPlaybackConfiguration audioPlaybackConfiguration, int i) {
    ...
    audioPlaybackConfiguration.handleAudioAttributesEvent(
        new AudioAttributes.Builder(audioPlaybackConfiguration.getAudioAttributes())
            .setAllowedCapturePolicy(i)
            .build());
  }
    ...
    synchronized (this.mPlayerLock) {
      for (AudioPlaybackConfiguration audioPlaybackConfiguration : this.mPlayers.values()) {
        if (audioPlaybackConfiguration.isActive()
            && audioPlaybackConfiguration.getClientUid() == i) {
          return true;
        }
      }
      return false;
  ...
  public boolean hasActiveMediaPlaybackOnSubmixWithAddress(String str) {
    synchronized (this.mPlayerLock) {
      for (AudioPlaybackConfiguration audioPlaybackConfiguration : this.mPlayers.values()) {
        ...
        if (audioPlaybackConfiguration.getAudioAttributes().getUsage() == 1
            && audioPlaybackConfiguration.isActive()
            && audioDeviceInfo != null
            && audioDeviceInfo.getInternalType() == 32768
            && str.equals(audioDeviceInfo.getAddress())) {
          return true;
        }
      }
      return false;
  ...
  public void dump(PrintWriter printWriter) {
    ...
    synchronized (this.mPlayerLock) {
      ...
      while (it2.hasNext()) {
        AudioPlaybackConfiguration audioPlaybackConfiguration =
            (AudioPlaybackConfiguration) this.mPlayers.get((Integer) it2.next());
        if (audioPlaybackConfiguration != null) {
          if (this.mDoNotLogPiidList.contains(
      ...
      for (int i = 0; i < this.mPortIdToPiid.size(); i++) {
        printWriter.println(
            "  portId: " + this.mPortIdToPiid.keyAt(i) + " piid: " + this.mPortIdToPiid.valueAt(i));
      }
      printWriter.println(KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
              ...
              .sorted(
                  Comparator.comparing(
                          new Function() { // from class:
                            // com.android.server.audio.PlaybackActivityMonitor$$ExternalSyntheticLambda0
                            @Override // java.util.function.Function
                            public final Object apply(Object obj) {
                              return Integer.valueOf(
                                  ((AudioPlaybackConfiguration) obj).getPlayerState());
                            }
                          })
                      .reversed())
              .toList();
  ...
  public boolean duckPlayers(
    ...
    synchronized (this.mPlayerLock) {
      ...
      for (AudioPlaybackConfiguration audioPlaybackConfiguration : this.mPlayers.values()) {
        if (!focusRequester.hasSameUid(audioPlaybackConfiguration.getClientUid())
          ...
          if (ArrayUtils.contains(
              UNDUCKABLE_PLAYER_TYPES, audioPlaybackConfiguration.getPlayerType())) {
            Log.v(
                "AS.PlaybackActivityMon",
                "not ducking player "
                    + audioPlaybackConfiguration.getPlayerInterfaceId()
      ...
      this.mDuckingManager.duckUid(
          focusRequester2.getClientUid(), arrayList, reqCausesStrongDuck(focusRequester));
      return true;
    }
  }

  public final boolean reqCausesStrongDuck(FocusRequester focusRequester) {
    return focusRequester.getGainRequest() == 3
        && focusRequester.getAudioAttributes().getUsage() == 16;
  }
              ...
              sEventLogger.enqueue(
                  new EventLogger.StringEvent(
                          "call: muting piid:"
                              ...
                              + " uid:"
                              + audioPlaybackConfiguration.getClientUid())
                      .printLog("AS.PlaybackActivityMon"));
              audioPlaybackConfiguration
                  .getPlayerProxy()
                  .setVolume(DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
  ...
  public void unmutePlayersForCall() {
    synchronized (this.mPlayerLock) {
      ...
      while (it.hasNext()) {
        ...
        AudioPlaybackConfiguration audioPlaybackConfiguration =
            (AudioPlaybackConfiguration) this.mPlayers.get(Integer.valueOf(intValue));
        if (audioPlaybackConfiguration != null) {
          try {
            sEventLogger.enqueue(
    ...
    synchronized (this.mPlayers) {
      ...
      synchronized (this.mPlayerLock) {
        anonymizeForPublicConsumption =
            anonymizeForPublicConsumption(new ArrayList(this.mPlayers.values()));
      }
  ...
  public final class PlayMonitorClient implements IBinder.DeathRecipient {
    ...
    public synchronized boolean equalsDispatcher(
  ...
  public final class DuckingManager {
    ...
    public synchronized void checkDuck(AudioPlaybackConfiguration audioPlaybackConfiguration) {
      DuckedApp duckedApp =
          (DuckedApp) this.mDuckers.get(Integer.valueOf(audioPlaybackConfiguration.getClientUid()));
      if (duckedApp == null) {
        return;
      }
    ...
    public final class DuckedApp {
      ...
      public void addDuck(AudioPlaybackConfiguration audioPlaybackConfiguration, boolean z) {
        ...
        try {
          PlaybackActivityMonitor.sEventLogger.enqueue(
              new DuckEvent(audioPlaybackConfiguration, z, this.mUseStrongDuck)
                  .printLog("AS.PlaybackActivityMon"));
          audioPlaybackConfiguration
              .getPlayerProxy()
              .applyVolumeShaper(
          ...
          Log.e(
              "AS.PlaybackActivityMon",
              "Error ducking player piid:" + intValue + " uid:" + this.mUid,
              e);
        }
      }
      ...
      public void removeUnduckAll(HashMap hashMap) {
        ...
        while (it.hasNext()) {
          int intValue = ((Integer) it.next()).intValue();
          AudioPlaybackConfiguration audioPlaybackConfiguration =
              (AudioPlaybackConfiguration) hashMap.get(Integer.valueOf(intValue));
          if (audioPlaybackConfiguration != null) {
            try {
              PlaybackActivityMonitor.sEventLogger.enqueue(
              ...
              Log.e(
                  "AS.PlaybackActivityMon",
                  "Error unducking player piid:" + intValue + " uid:" + this.mUid,
                  e);
            }
          }
        }
  ...
  public final class PlayerEvent extends EventLogger.Event {
    ...
    public String eventToString() {
      ...
      if (i == 6) {
        return AudioPlaybackConfiguration.toLogFriendlyPlayerState(this.mEvent)
            + " portId:"
            + this.mEventValue
  ...
  public final class AudioAttrEvent extends EventLogger.Event {
    ...
    public String eventToString() {
      return new String(
          "player piid:" + this.mPlayerIId + " new AudioAttributes:" + this.mPlayerAttr);
    }
  }
  ...
  public void cancelMuteAwaitConnection(String str) {
    sEventLogger.enqueueAndLog(
        "cancelMuteAwaitConnection() from:" + str, 0, "AS.PlaybackActivityMon");
    synchronized (this.mPlayerLock) {
      this.mEventHandler.removeMessages(1);
    ...
    while (it.hasNext()) {
      ...
      if (audioPlaybackConfiguration != null) {
        try {
          ...
          audioPlaybackConfiguration
              .getPlayerProxy()
              .applyVolumeShaper(MUTE_AWAIT_CONNECTION_VSHAPE, VolumeShaper.Operation.REVERSE);
        } catch (Exception e) {
          Log.e(
              "AS.PlaybackActivityMon",
              "Error unmuting player "
                  + intValue
                  + " uid:"
                  + audioPlaybackConfiguration.getClientUid(),
              e);
  ...
  public final void initEventHandler() {
    ...
    this.mEventHandler =
        new Handler(
            this.mEventThread
                .getLooper()) { // from class: com.android.server.audio.PlaybackActivityMonitor.1
            ...
            if (i == 3) {
              ...
              synchronized (PlaybackActivityMonitor.this.mPlayerLock) {
                ...
                synchronized (PlaybackActivityMonitor.this.mPlayerLock) {
                  audioPlaybackConfiguration =
                      (AudioPlaybackConfiguration)
                          PlaybackActivityMonitor.this.mPlayers.get(Integer.valueOf(i3));
                }
                if (audioPlaybackConfiguration != null
                    && audioPlaybackConfiguration.handleMutedEvent(i2)) {
            ...
            AudioPlaybackConfiguration.FormatInfo formatInfo =
                new AudioPlaybackConfiguration.FormatInfo(
                    persistableBundle2.getBoolean(
                        "android.media.extra.PLAYER_EVENT_SPATIALIZED", false),
                    persistableBundle2.getInt("android.media.extra.PLAYER_EVENT_CHANNEL_MASK", 0),
                    persistableBundle2.getInt("android.media.extra.PLAYER_EVENT_SAMPLE_RATE", 0));
            PlaybackActivityMonitor.sEventLogger.enqueue(
                new PlayerFormatEvent(message.arg1, formatInfo));
            synchronized (PlaybackActivityMonitor.this.mPlayerLock) {
              audioPlaybackConfiguration2 =
                  (AudioPlaybackConfiguration)
                      PlaybackActivityMonitor.this.mPlayers.get(Integer.valueOf(message.arg1));
            }
            if (audioPlaybackConfiguration2 == null
                || !audioPlaybackConfiguration2.handleFormatEvent(formatInfo)) {
              return;
            }
            PlaybackActivityMonitor.this.dispatchPlaybackChange(false);
          }
  ...
  public void setCallbackPackageName(
      IPlaybackConfigDispatcher iPlaybackConfigDispatcher, String str) {
    if (iPlaybackConfigDispatcher == null) {
      return;
    }
    Iterator it = this.mClients.iterator();
  ...
  public final boolean checkMuteStrategy(
    ...
    if (!ACTIVE_CHECK_PLAYER_TYPES.contains(
            Integer.valueOf(audioPlaybackConfiguration.getPlayerType()))
        || audioPlaybackConfiguration.isActive()) {
      return z;
    }
    return false;
  ...
  public final void updateGoodCatch(AudioPlaybackConfiguration audioPlaybackConfiguration) {
    ...
    String packageName =
        getPackageName(
            audioPlaybackConfiguration.getClientUid(), audioPlaybackConfiguration.getClientPid());
    if (!this.mPackageTimeMap.containsKey(packageName)
        || currentTimeMillis - ((Long) this.mPackageTimeMap.get(packageName)).longValue() > 10000) {
      if ("com.android.systemui".equals(packageName)
          && mGoodCatchSystemUiStream.contains(Integer.valueOf(legacyStreamType))) {
        Log.d(
            "AS.PlaybackActivityMon", "updateGoodCatch systemui sound, so skip updateSoundPlayed");
        return;
      }
