    ...
    switch (i) {
      ...
      case 5:
        ...
        MediaMetrics.Item item =
            new MediaMetrics.Item("audio.volume.event")
                .set(MediaMetrics.Property.CALLING_PACKAGE, this.mCaller);
        ...
        item.set(key, str2)
            ...
            .set(MediaMetrics.Property.FLAGS, Integer.valueOf(this.mVal2))
            .set(MediaMetrics.Property.STREAM_TYPE, AudioSystem.streamToString(this.mStream))
            .record();
        break;
      case 2:
        new MediaMetrics.Item("audio.volume.event")
            ...
            .set(MediaMetrics.Property.FLAGS, Integer.valueOf(this.mVal2))
            .set(MediaMetrics.Property.INDEX, Integer.valueOf(this.mVal1))
            .set(MediaMetrics.Property.STREAM_TYPE, AudioSystem.streamToString(this.mStream))
            .record();
        break;
      case 3:
        new MediaMetrics.Item("audio.volume.event")
            ...
            .set(MediaMetrics.Property.GAIN_DB, Double.valueOf(this.mVal2))
            .set(MediaMetrics.Property.INDEX, Integer.valueOf(this.mVal1))
            .record();
        break;
      case 4:
      ...
      case 6:
        new MediaMetrics.Item("audio.volume.event")
            ...
            .set(MediaMetrics.Property.INDEX, Integer.valueOf(this.mVal1))
            .set(MediaMetrics.Property.STATE, this.mVal2 == 1 ? "active" : "inactive")
            .set(MediaMetrics.Property.STREAM_TYPE, AudioSystem.streamToString(this.mStream))
            .record();
        break;
      case 7:
        new MediaMetrics.Item("audio.volume.event")
            ...
            .set(MediaMetrics.Property.INDEX, Integer.valueOf(this.mVal1))
            .set(MediaMetrics.Property.MODE, AudioSystem.modeToString(this.mVal2))
            .set(MediaMetrics.Property.STREAM_TYPE, AudioSystem.streamToString(this.mStream))
            .record();
        break;
      case 8:
        new MediaMetrics.Item("audio.volume.event")
            ...
            .set(MediaMetrics.Property.FLAGS, Integer.valueOf(this.mVal2))
            .set(MediaMetrics.Property.GROUP, this.mGroupName)
            .set(MediaMetrics.Property.INDEX, Integer.valueOf(this.mVal1))
            .record();
        break;
      case 10:
        new MediaMetrics.Item("audio.volume.event")
            ...
            .set(MediaMetrics.Property.INDEX, Integer.valueOf(this.mVal1))
            .set(MediaMetrics.Property.MAX_INDEX, Integer.valueOf(this.mVal2))
            .record();
        break;
      case 11:
    ...
    switch (this.mOp) {
      case 0:
        return "adjustSuggestedStreamVolume(sugg:"
            + AudioSystem.streamToString(this.mStream)
            + " dir:"
            + AudioManager.adjustToString(this.mVal1)
            + " flags:0x"
            + Integer.toHexString(this.mVal2)
            + ") from "
            + this.mCaller;
      case 1:
      ...
      case 7:
        return "setMode("
            + AudioSystem.modeToString(this.mVal2)
            + ") causes setting HEARING_AID volume to idx:"
            + this.mVal1
            + " stream:"
            + AudioSystem.streamToString(this.mStream);
      case 8:
        return "setVolumeIndexForAttributes(group: group: "
            + this.mGroupName
            + " index:"
            + this.mVal1
            + " flags:0x"
      ...
      case 11:
        return "adjustVolumeGroupVolume(group:"
            + this.mGroupName
            + " dir:"
            + AudioManager.adjustToString(this.mVal1)
            + " flags:0x"
