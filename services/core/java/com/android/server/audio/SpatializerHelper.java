...
public class SpatializerHelper {
  ...
  public static final SparseIntArray SPAT_MODE_FOR_DEVICE_TYPE =
      new SparseIntArray(14) { // from class: com.android.server.audio.SpatializerHelper.1
        {
          append(2, 1);
          append(3, 0);
          append(4, 0);
  ...
  public static final AudioFormat DEFAULT_FORMAT =
      new AudioFormat.Builder().setEncoding(2).setSampleRate(48000).setChannelMask(252).build();
  ...
  public SpatializerHeadTrackingCallback mSpatHeadTrackingCallback =
    ...
    return i != 0
        ? i != 1
            ? i != 3
                ? i != 4
                    ? i != 5
                        ? i != 6 ? "invalid state" : "STATE_DISABLED_AVAILABLE"
                        : "STATE_ENABLED_AVAILABLE"
  ...
  public synchronized void init(boolean z, String str) {
    ...
    if (supportedLevels != null
        ...
        && (supportedLevels.length != 1 || supportedLevels[0] != 0)) {
      ...
      if (isHeadTrackingSupported) {
        ...
        for (byte b2 : supportedHeadTrackingModes) {
          if (b2 != 0 && b2 != 1) {
            if (b2 == 2 || b2 == 3) {
              ...
              Log.e(
                  "AS.SpatializerHelper",
                  "Unexpected head tracking mode:" + ((int) b2),
        ...
        this.mActualHeadTrackingMode =
            headTrackingModeTypeToSpatializerInt(spatializer.getActualHeadTrackingMode());
      } else {
      ...
      while (true) {
        ...
        if ((valueAt == 0 && this.mBinauralSupported)
            || (valueAt == 1 && this.mTransauralSupported)) {
      ...
      if (i != 0) {
        ...
        if (i != 1) {
          ...
          AudioDeviceAttributes audioDeviceAttributes =
              (AudioDeviceAttributes) sRoutingDevices.get(0);
          ...
          if (((Boolean) evaluateState.second).booleanValue()) {
            ...
            loglogi(
                "onRoutingUpdated: can spatialize media 5.1:"
                    + z
                    + " on device:"
          ...
          if (z2) {
            loglogi(
                "Enabling Spatial Audio since enabled for media device:" + audioDeviceAttributes);
          } else {
            loglogi(
                "Disabling Spatial Audio since disabled for media device:" + audioDeviceAttributes);
          }
          if (this.mSpat != null) {
            if (!z2) {
              b = 0;
  ...
  public final class SpatializerCallback extends INativeSpatializerCallback.Stub {
    ...
    public void onLevelChanged(byte b) {
      ...
      synchronized (SpatializerHelper.this) {
        SpatializerHelper.this.mSpatLevel =
            SpatializerHelper.spatializationLevelToSpatializerInt(b);
      }
  ...
  public final class SpatializerHeadTrackingCallback extends ISpatializerHeadTrackingCallback.Stub {
    ...
    public void onHeadTrackingModeChanged(byte b) {
      ...
      synchronized (this) {
        ...
        SpatializerHelper.this.mActualHeadTrackingMode =
            SpatializerHelper.headTrackingModeTypeToSpatializerInt(b);
        i2 = SpatializerHelper.this.mActualHeadTrackingMode;
      }
      SpatializerHelper.loglogi(
          "SpatializerHeadTrackingCallback.onHeadTrackingModeChanged mode:"
              + Spatializer.headtrackingModeToString(i2));
      if (i != i2) {
    ...
    public void onHeadToSoundStagePoseUpdated(float[] fArr) {
      if (fArr == null) {
        Log.e(
            "AS.SpatializerHelper",
            "SpatializerHeadTrackingCallback.onHeadToStagePoseUpdatednull transform");
        return;
      }
      if (fArr.length != 6) {
        Log.e(
            "AS.SpatializerHelper",
            "SpatializerHeadTrackingCallback.onHeadToStagePoseUpdated invalid transform length"
                + fArr.length);
        return;
      }
  ...
  public final void addCompatibleAudioDevice(
      AudioDeviceAttributes audioDeviceAttributes, boolean z) {
    if (isDeviceCompatibleWithSpatializationModes(audioDeviceAttributes)) {
      ...
      SADeviceState findDeviceStateForAudioDeviceAttributes =
          findDeviceStateForAudioDeviceAttributes(audioDeviceAttributes);
      if (findDeviceStateForAudioDeviceAttributes != null) {
        ...
        if (canonicalDeviceType == 0) {
          Log.e(
              "AS.SpatializerHelper",
              "addCompatibleAudioDevice with incompatible AudioDeviceAttributes "
                  + audioDeviceAttributes);
          return;
        }
        findDeviceStateForAudioDeviceAttributes =
            new SADeviceState(canonicalDeviceType, audioDeviceAttributes.getAddress());
  ...
  public final void logDeviceState(SADeviceState sADeviceState, String str) {
    new MediaMetrics.Item(
            "audio.spatializer.device."
                + AudioSystem.getDeviceName(
                    AudioDeviceInfo.convertDeviceTypeToInternalDevice(sADeviceState.mDeviceType)))
        .set(MediaMetrics.Property.ADDRESS, sADeviceState.mDeviceAddress)
        .set(MediaMetrics.Property.ENABLED, sADeviceState.mEnabled ? "true" : "false")
        .set(MediaMetrics.Property.EVENT, TextUtils.emptyIfNull(str))
        .set(
            MediaMetrics.Property.HAS_HEAD_TRACKER,
            sADeviceState.mHasHeadTracker ? "true" : "false")
        .set(
            MediaMetrics.Property.HEAD_TRACKER_ENABLED,
            sADeviceState.mHeadTrackerEnabled ? "true" : "false")
        .record();
  }

  public synchronized void removeCompatibleAudioDevice(
      AudioDeviceAttributes audioDeviceAttributes) {
    loglogi("removeCompatibleAudioDevice: dev=" + audioDeviceAttributes);
    SADeviceState findDeviceStateForAudioDeviceAttributes =
        findDeviceStateForAudioDeviceAttributes(audioDeviceAttributes);
    if (findDeviceStateForAudioDeviceAttributes != null
        && findDeviceStateForAudioDeviceAttributes.mEnabled) {
  ...
  public final SADeviceState findDeviceStateForAudioDeviceAttributes(
      AudioDeviceAttributes audioDeviceAttributes) {
    ...
    while (it.hasNext()) {
      SADeviceState sADeviceState = (SADeviceState) it.next();
      if (sADeviceState.mDeviceType == canonicalDeviceType
          && (!isWireless
              || audioDeviceAttributes.getAddress().equals(sADeviceState.mDeviceAddress))) {
  ...
  public final synchronized Pair evaluateState(AudioDeviceAttributes audioDeviceAttributes) {
    ...
    if (!this.mSACapableDeviceTypes.contains(Integer.valueOf(type))) {
      Log.i(
          "AS.SpatializerHelper",
          "Device incompatible with Spatial Audio dev:" + audioDeviceAttributes);
    ...
    if (findDeviceStateForAudioDeviceAttributes == null) {
      Log.i(
          "AS.SpatializerHelper",
          "no spatialization device state found for Spatial Audio device:" + audioDeviceAttributes);
      Boolean bool3 = Boolean.FALSE;
      return new Pair(bool3, bool3);
    }
    return new Pair(
        Boolean.valueOf(findDeviceStateForAudioDeviceAttributes.mEnabled), Boolean.TRUE);
  }

  public final synchronized void addWirelessDeviceIfNew(
      AudioDeviceAttributes audioDeviceAttributes) {
    if (isDeviceCompatibleWithSpatializationModes(audioDeviceAttributes)) {
      if (findDeviceStateForAudioDeviceAttributes(audioDeviceAttributes) == null) {
        ...
        if (canonicalDeviceType == 0) {
          Log.e(
              "AS.SpatializerHelper",
              "addWirelessDeviceIfNew with incompatible AudioDeviceAttributes "
                  + audioDeviceAttributes);
          return;
        }
        SADeviceState sADeviceState =
            new SADeviceState(canonicalDeviceType, audioDeviceAttributes.getAddress());
  ...
  public final synchronized boolean canBeSpatializedOnDevice(
      AudioAttributes audioAttributes, AudioFormat audioFormat, ArrayList arrayList) {
    ...
    return AudioSystem.canBeSpatialized(
        audioAttributes,
        audioFormat,
        (AudioDeviceAttributes[]) arrayList.toArray(new AudioDeviceAttributes[arrayList.size()]));
  }

  public final boolean isDeviceCompatibleWithSpatializationModes(
      AudioDeviceAttributes audioDeviceAttributes) {
  ...
  public final synchronized void setDispatchFeatureEnabledState(boolean z, String str) {
    if (z) {
      ...
      if (i == 3) {
        ...
        if (i == 4 || i == 5) {
          loglogi(
              "setDispatchFeatureEnabledState("
                  + z
                  + ") no dispatch: mState:"
                  + spatStateString(this.mState)
                  + " src:"
                  + str);
          return;
        }
  ...
  public synchronized boolean canBeSpatialized(
      AudioAttributes audioAttributes, AudioFormat audioFormat) {
    int i = this.mState;
    if (i == 0 || i == 1 || i == 3 || i == 4) {
    ...
    boolean canBeSpatializedOnDevice =
        canBeSpatializedOnDevice(audioAttributes, audioFormat, routingDevices);
    logd(
        "canBeSpatialized usage:"
            + audioAttributes.getUsage()
            + " format:"
            + audioFormat.toLogFriendlyString()
            + " returning "
            + canBeSpatializedOnDevice);
    return canBeSpatializedOnDevice;
  }

  public synchronized void registerHeadTrackingModeCallback(
  ...
  public synchronized void unregisterHeadTrackingModeCallback(
      ISpatializerHeadTrackingModeCallback iSpatializerHeadTrackingModeCallback) {
    this.mHeadTrackingModeCallbacks.unregister(iSpatializerHeadTrackingModeCallback);
  }

  public synchronized void registerHeadTrackerAvailableCallback(
  ...
  public synchronized void setDesiredHeadTrackingMode(int i) {
    if (checkSpatializerForHeadTracking("setDesiredHeadTrackingMode")) {
      ...
      try {
        ...
        Log.i(
            "AS.SpatializerHelper",
            "setDesiredHeadTrackingMode(" + Spatializer.headtrackingModeToString(i) + ")");
  ...
  public synchronized void setHeadTrackerEnabled(
      boolean z, AudioDeviceAttributes audioDeviceAttributes) {
    if (!this.mIsHeadTrackingSupported) {
      Log.v(
          "AS.SpatializerHelper",
          "no headtracking support, ignoring setHeadTrackerEnabled to "
              + z
              + " for "
              + audioDeviceAttributes);
    }
    ...
    if (!findDeviceStateForAudioDeviceAttributes.mHasHeadTracker) {
      Log.e(
          "AS.SpatializerHelper",
          "Called setHeadTrackerEnabled enabled:"
              + z
              + " device:"
              + audioDeviceAttributes
              + " on a device without headtracker");
      return;
    }
    Log.i(
        "AS.SpatializerHelper",
        "setHeadTrackerEnabled enabled:" + z + " device:" + audioDeviceAttributes);
    ...
    if (audioDeviceAttributes2.getType() == audioDeviceAttributes.getType()
        && audioDeviceAttributes2.getAddress().equals(audioDeviceAttributes.getAddress())) {
  ...
  public synchronized boolean hasHeadTracker(AudioDeviceAttributes audioDeviceAttributes) {
    ...
    if (!this.mIsHeadTrackingSupported) {
      Log.v(
          "AS.SpatializerHelper",
          "no headtracking support, hasHeadTracker always false for " + audioDeviceAttributes);
      return false;
    }
    SADeviceState findDeviceStateForAudioDeviceAttributes =
        findDeviceStateForAudioDeviceAttributes(audioDeviceAttributes);
    if (findDeviceStateForAudioDeviceAttributes != null
        && findDeviceStateForAudioDeviceAttributes.mHasHeadTracker) {
      z = true;
    }
    return z;
  }
  ...
  public synchronized boolean setHasHeadTracker(AudioDeviceAttributes audioDeviceAttributes) {
    if (!this.mIsHeadTrackingSupported) {
      Log.v(
          "AS.SpatializerHelper",
          "no headtracking support, setHasHeadTracker always false for " + audioDeviceAttributes);
      return false;
    }
    SADeviceState findDeviceStateForAudioDeviceAttributes =
        findDeviceStateForAudioDeviceAttributes(audioDeviceAttributes);
    ...
    Log.e(
        "AS.SpatializerHelper", "setHasHeadTracker: device not found for:" + audioDeviceAttributes);
    return false;
  }
  ...
  public synchronized boolean isHeadTrackerEnabled(AudioDeviceAttributes audioDeviceAttributes) {
    ...
    if (!this.mIsHeadTrackingSupported) {
      Log.v(
          "AS.SpatializerHelper",
          "no headtracking support, isHeadTrackerEnabled always false for "
              + audioDeviceAttributes);
      return false;
    }
    SADeviceState findDeviceStateForAudioDeviceAttributes =
    ...
    if (findDeviceStateForAudioDeviceAttributes != null
        && findDeviceStateForAudioDeviceAttributes.mHasHeadTracker
        && findDeviceStateForAudioDeviceAttributes.mHeadTrackerEnabled) {
      z = true;
    }
    return z;
  }
  ...
  public final boolean checkSpatializer(String str) {
    ...
    Log.e(
        "AS.SpatializerHelper",
        "checkSpatializer(): called from "
            + str
            + "(), native spatializer should not be null in state: "
            + this.mState);
    postReset();
    return false;
  }
  ...
  public final void dispatchActualHeadTrackingMode(int i) {
    ...
    for (int i2 = 0; i2 < beginBroadcast; i2++) {
      try {
        this.mHeadTrackingModeCallbacks
            .getBroadcastItem(i2)
            .dispatchSpatializerActualHeadTrackingModeChanged(i);
      } catch (RemoteException e) {
        Log.e(
            "AS.SpatializerHelper",
            "Error in dispatchSpatializerActualHeadTrackingModeChanged(" + i + ")",
            e);
      }
    }
  ...
  public final void dispatchDesiredHeadTrackingMode(int i) {
    ...
    for (int i2 = 0; i2 < beginBroadcast; i2++) {
      try {
        this.mHeadTrackingModeCallbacks
            .getBroadcastItem(i2)
            .dispatchSpatializerDesiredHeadTrackingModeChanged(i);
      } catch (RemoteException e) {
        Log.e(
            "AS.SpatializerHelper",
            "Error in dispatchSpatializerDesiredHeadTrackingModeChanged(" + i + ")",
            e);
      }
    }
    this.mHeadTrackingModeCallbacks.finishBroadcast();
  ...
  public final void dispatchHeadTrackerAvailable(boolean z) {
    ...
    for (int i = 0; i < beginBroadcast; i++) {
      try {
        ...
        Log.e(
            "AS.SpatializerHelper",
            "Error in dispatchSpatializerHeadTrackerAvailable(" + z + ")",
            e);
      }
    }
  ...
  public synchronized void registerHeadToSoundstagePoseCallback(
  ...
  public synchronized void unregisterHeadToSoundstagePoseCallback(
      ISpatializerHeadToSoundStagePoseCallback iSpatializerHeadToSoundStagePoseCallback) {
  ...
  public synchronized void setEffectParameter(int i, byte[] bArr) {
    ...
    if ((i2 == 3 || i2 == 4 || i2 == 5 || i2 == 6) && this.mSpat == null) {
      Log.e(
          "AS.SpatializerHelper",
          "setParameter(" + i + "): null spatializer in state: " + this.mState);
      return;
    }
    try {
  ...
  public synchronized void getEffectParameter(int i, byte[] bArr) {
    ...
    if ((i2 == 3 || i2 == 4 || i2 == 5 || i2 == 6) && this.mSpat == null) {
      Log.e(
          "AS.SpatializerHelper",
          "getParameter(" + i + "): null spatializer in state: " + this.mState);
      return;
    }
    try {
  ...
  public synchronized void registerSpatializerOutputCallback(
      ISpatializerOutputCallback iSpatializerOutputCallback) {
    this.mOutputCallbacks.register(iSpatializerOutputCallback);
  }

  public synchronized void unregisterSpatializerOutputCallback(
      ISpatializerOutputCallback iSpatializerOutputCallback) {
  ...
  public synchronized void onInitSensors() {
    ...
    if (z2) {
      if (this.mSensorManager == null) {
        try {
          this.mSensorManager =
              (SensorManager) this.mAudioService.mContext.getSystemService("sensor");
          HelperDynamicSensorCallback helperDynamicSensorCallback2 =
              new HelperDynamicSensorCallback();
      ...
      if (sensorManager != null
          && (helperDynamicSensorCallback = this.mDynSensorCallback) != null) {
  ...
  public void dump(PrintWriter printWriter) {
    ...
    printWriter.println(
        "\tmDesiredHeadTrackingMode:"
            + Spatializer.headtrackingModeToString(this.mDesiredHeadTrackingMode));
    printWriter.println(
        "\tmActualHeadTrackingMode:"
            + Spatializer.headtrackingModeToString(this.mActualHeadTrackingMode));
    ...
    printWriter.println(
        "\tsupports binaural:"
            + this.mBinauralSupported
            + " / transaural:"
            + this.mTransauralSupported);
  ...
  public final class SADeviceState {
    ...
    public boolean equals(Object obj) {
      ...
      return this.mDeviceType == sADeviceState.mDeviceType
          && this.mDeviceAddress.equals(sADeviceState.mDeviceAddress)
          && this.mEnabled == sADeviceState.mEnabled
          && this.mHasHeadTracker == sADeviceState.mHasHeadTracker
          && this.mHeadTrackerEnabled == sADeviceState.mHeadTrackerEnabled;
    }
    ...
    public String toString() {
      return "type: "
          ...
          + this.mEnabled
          + " HT: "
          + this.mHasHeadTracker
          + " HTenabled: "
          + this.mHeadTrackerEnabled;
    }
  ...
  public synchronized void setSADeviceSettings(String str) {
    ...
    for (String str2 : TextUtils.split(str, "\\|")) {
      ...
      if (fromPersistedString != null) {
        ...
        if (i == getCanonicalDeviceType(i)
            && isDeviceCompatibleWithSpatializationModes(
                fromPersistedString.getAudioDeviceAttributes())) {
  ...
  */
  public synchronized void setSecHeadTrackerAvailable(boolean z) {
    boolean z2;
    this.mSecHeadTrackerAvailable = z;
    if (!z && !this.mHeadTrackerAvailable) {
      z2 = false;
      Log.i(
          "AS.SpatializerHelper",
          "setSecHeadTrackerAvailable:"
              + this.mSecHeadTrackerAvailable
              + " mHeadTrackerAvailable:"
              + this.mHeadTrackerAvailable);
      if (this.mGlobalHeadTrackerAvailable != z2) {
        this.mGlobalHeadTrackerAvailable = z2;
