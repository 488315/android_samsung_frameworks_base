...
public class DefaultAudioPolicyFacade implements AudioPolicyFacade, IBinder.DeathRecipient {
  ...
  public final IAudioPolicyService getAudioPolicyOrInit() {
    synchronized (this.mServiceLock) {
      ...
      IAudioPolicyService asInterface =
          IAudioPolicyService.Stub.asInterface(ServiceManager.checkService("media.audio_policy"));
      if (asInterface == null) {
        throw new IllegalStateException(
            "DefaultAudioPolicyFacade: Unable to connect to AudioPolicy");
      }
      try {
        ...
        throw new IllegalStateException(
            "DefaultAudioPolicyFacade: Unable to link deathListener to AudioPolicy", e);
      }
    }
  }
}
