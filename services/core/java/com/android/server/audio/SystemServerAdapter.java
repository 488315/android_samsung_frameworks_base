...
public class SystemServerAdapter {
  ...
  public void sendMicrophoneMuteChangedIntent() {
    this.mContext.sendBroadcastAsUser(
        new Intent("android.media.action.MICROPHONE_MUTE_CHANGED").setFlags(1073741824),
        UserHandle.ALL);
  }
  ...
  public void registerUserStartedReceiver(Context context) {
    ...
    context.registerReceiverAsUser(
        new BroadcastReceiver() { // from class: com.android.server.audio.SystemServerAdapter.1
          ...
          public void onReceive(Context context2, Intent intent) {
            ...
            if (!"android.intent.action.USER_STARTED".equals(intent.getAction())
                || (intExtra = intent.getIntExtra("android.intent.extra.user_handle", -10000))
                    == -10000
                || (profileParent =
                        ((UserManager) context2.getSystemService(UserManager.class))
                            .getProfileParent(intExtra))
                    == null) {
              return;
            }
            SystemServerAdapter.this.broadcastProfileParentStickyIntent(
                context2, "android.media.action.HDMI_AUDIO_PLUG", intExtra, profileParent.id);
            SystemServerAdapter.this.broadcastProfileParentStickyIntent(
                context2, "android.intent.action.HEADSET_PLUG", intExtra, profileParent.id);
          }
        },
        UserHandle.ALL,
        intentFilter,
  ...
  public final void broadcastProfileParentStickyIntent(Context context, String str, int i, int i2) {
    Intent registerReceiverAsUser =
        context.registerReceiverAsUser(null, UserHandle.of(i2), new IntentFilter(str), null, null);
