...
public class DirEncryptServiceHelper {
        ...
        if (!this.mStop) {
          ...
          notificationManager.createNotificationChannel(
              new NotificationChannel(
                  DirEncryptServiceHelper.mNotificationChannelID,
                  this.mContext.getResources().getString(17042541),
                  2));
  ...
  public DirEncryptServiceHelper(Context context) {
    ...
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.DirEncryptServiceHelper.1
    ...
    synchronized (mSync) {
      ...
      switch (i) {
        ...
        case FrameworkStatsLog.MEDIA_CODEC_RENDERED /* 684 */:
          Log.i(
              "DirEncryptServiceHelper",
              "DirEncryptServiceHelperVoldResponse.PROGRESS percentage("
                  + i3
                  + "), storage("
                  + i4
                  + ")");
  ...
  public final void doWorkForUSBState(String str) {
    ...
    if ("MoveMount".equals(str)) {
      if (!isSdCardEncryped() && this.mLastError != 8) {
        Log.i(
            "DirEncryptServiceHelper", "Since encrypt is OFF: no final mount command (DECRYPTED)");
        setStatus(0);
      ...
      if (!isSdCardEncryped()) {
        Log.i(
            "DirEncryptServiceHelper",
            "looks like encryption policies were received while SD card decryption was on going"
                + " (DECRYPTING)!!");
        showNotification(2, 0, "success");
        setStatus(0);
  ...
  public final boolean isCryptSDCardSettings() {
    ...
    return getTopClassName() != null
        && getTopClassName().equals("com.android.settings.Settings$CryptSDCardSettingsActivity");
  }
  ...
  public final void showNotification(int i, int i2, String str) {
    ...
    String str4 = "";
    if (i != 1) {
      int i6 = R.drawable.dropdown_ic_arrow_focused_holo_light;
      if (i != 2) {
        if (i == 3) {
          if (i2 == 1) {
          ...
          if (i == 6) {
            ...
            if (i2 == 1) {
              ...
              string5 = this.mContext.getResources().getString(17042537);
              string6 = this.mContext.getResources().getString(17042534);
              i6 = R.drawable.cab_background_top_holo_dark;
            }
            activity2 =
                PendingIntent.getActivity(
                    this.mContext,
            ...
            pendingIntent =
                PendingIntent.getActivity(this.mContext, 0, getSecurityIntent(), 201326592);
            i4 = R.drawable.dropdown_ic_arrow_normal_holo_dark;
          } else if (i == 10) {
            ...
            PendingIntent broadcast =
                PendingIntent.getBroadcast(
                    this.mContext,
                    0,
                    new Intent("com.samsung.android.security.SemSdCardEncryption.UNMOUNT_POLICY"),
                    201326592);
            this.mLastError = 0;
            str2 = string8;
            str3 = string9;
        ...
        if ("success".equals(str)) {
          ...
          this.mLastError = 0;
          i5 = R.drawable.dropdown_ic_arrow_normal_holo_dark;
        ...
        if ("success".equals(str)) {
          ...
          this.mLastError = 0;
          i5 = R.drawable.cab_background_top_holo_light;
        } else if ("exception".equals(str)) {
          String string11 = this.mContext.getResources().getString(17042535);
          this.mLastError = 8;
          string4 = string11;
          i5 = R.drawable.cab_background_top_holo_dark;
        } else {
          activity =
              PendingIntent.getActivity(
                  this.mContext,
    ...
    if (build != null) {
      ...
      notificationManager.createNotificationChannel(
          new NotificationChannel(
              mNotificationChannelID, this.mContext.getResources().getString(17042541), 2));
