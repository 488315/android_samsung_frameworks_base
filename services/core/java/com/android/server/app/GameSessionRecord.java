...
public final class GameSessionRecord {
  ...
  public GameSessionRecord withGameSessionRequested() {
    return new GameSessionRecord(
        this.mTaskId, State.GAME_SESSION_REQUESTED, this.mRootComponentName, null, null);
  }
  ...
  public GameSessionRecord withGameSession(
      IGameSession iGameSession, SurfaceControlViewHost.SurfacePackage surfacePackage) {
  ...
  public GameSessionRecord withGameSessionEndedOnProcessDeath() {
    return new GameSessionRecord(
        this.mTaskId, State.GAME_SESSION_ENDED_PROCESS_DEATH, this.mRootComponentName, null, null);
  }
  ...
  public int hashCode() {
    ...
    return Objects.hash(
        valueOf, state, this.mRootComponentName, this.mIGameSession, state, this.mSurfacePackage);
  }
}
