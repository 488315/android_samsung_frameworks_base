...
public class GameManagerShellCommand extends ShellCommand {
  ...
  public static String gameModeIntToString(int i) {
    return i != 0
        ? i != 1 ? i != 2 ? i != 3 ? i != 4 ? "" : "custom" : "battery" : "performance" : "standard"
        : "unsupported";
  }
  ...
  public final int runListGameModeConfigs(PrintWriter printWriter) {
    ...
    String interventionList =
        ((GameManagerService) ServiceManager.getService("game"))
            .getInterventionList(nextArgRequired, ActivityManager.getCurrentUser());
  ...
  public final int runSetGameMode(PrintWriter printWriter) {
    ...
    switch (c) {
      ...
      case 4:
        ...
        printWriter.println(
            "Game mode: " + nextArgRequired2 + " not supported by " + nextArgRequired3);
        return -1;
      case 1:
      case 6:
      ...
      while (true) {
        ...
        if (nextOption != null) {
          ...
          switch (c) {
            case 0:
              if (str2 == null) {
                String nextArgRequired = getNextArgRequired();
                if (nextArgRequired != null
                    && GameManagerService.getFpsInt(nextArgRequired) == -1) {
          ...
          gameManagerService.setGameModeConfigOverride(
              nextArgRequired3, currentUser, i2, str2, str3);
          printWriter.println(
