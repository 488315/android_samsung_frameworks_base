...
public class GameManagerSettings {
  ...
  public int getGameModeLocked(String str) {
    ...
    if (!this.mGameModes.containsKey(str)
        || (intValue = ((Integer) this.mGameModes.get(str)).intValue()) == 0) {
      return 1;
    }
    return intValue;
  }
  ...
  public void setConfigOverride(
      String str, GameManagerService.GamePackageConfiguration gamePackageConfiguration) {
  ...
  public void writePersistentDataLocked() {
    ...
    try {
      ...
      while (it.hasNext()) {
        ...
        if (this.mGameModes.containsKey(str)) {
          resolveSerializer.attributeInt(
              (String) null, "gameMode", ((Integer) this.mGameModes.get(str)).intValue());
        }
        writeGameModeConfigTags(
            resolveSerializer,
            (GameManagerService.GamePackageConfiguration) this.mConfigOverrides.get(str));
      ...
      Slog.wtf(
          ...
          "Unable to write game manager service settings, current changes will be lost at reboot",
          e);
    }
  }

  public final void writeGameModeConfigTags(
    ...
    for (int i : gamePackageConfiguration.getAvailableGameModes()) {
      GameManagerService.GamePackageConfiguration.GameModeConfiguration gameModeConfiguration =
          gamePackageConfiguration.getGameModeConfiguration(i);
      if (gameModeConfiguration != null) {
        ...
        typedXmlSerializer.attributeBoolean(
            (String) null, "useAngle", gameModeConfiguration.getUseAngle());
        ...
        typedXmlSerializer.attributeInt(
            (String) null, "loadingBoost", gameModeConfiguration.getLoadingBoostDuration());
      ...
      while (true) {
        ...
        if (next2 != 3 && next2 != 4) {
          ...
          if (next2 == 2 && "package".equals(name)) {
            ...
            Slog.w(
                "GameManagerService_GameManagerSettings",
                "Unknown element under packages tag: " + name + " with type: " + next2);
          }
        }
      }
      return true;
  ...
  public final void readPackage(TypedXmlPullParser typedXmlPullParser) {
    ...
    try {
      this.mGameModes.put(
          attributeValue,
          Integer.valueOf(typedXmlPullParser.getAttributeInt((String) null, "gameMode")));
    } catch (XmlPullParserException unused) {
      Slog.v(
          "GameManagerService_GameManagerSettings",
          "No game mode selected by user for package" + attributeValue);
    }
    int depth = typedXmlPullParser.getDepth();
    GameManagerService.GamePackageConfiguration gamePackageConfiguration =
        new GameManagerService.GamePackageConfiguration(attributeValue);
    while (true) {
      ...
      if (next != 3 && next != 4) {
        ...
        if (next == 2 && "gameModeConfig".equals(name)) {
          ...
          Slog.w(
              "GameManagerService_GameManagerSettings",
              "Unknown element under package tag: " + name + " with type: " + next);
        }
      }
    }
  ...
  public final void readGameModeConfig(
    ...
    try {
      GameManagerService.GamePackageConfiguration.GameModeConfiguration
          orAddDefaultGameModeConfiguration =
              gamePackageConfiguration.getOrAddDefaultGameModeConfiguration(
                  typedXmlPullParser.getAttributeInt((String) null, "gameMode"));
      try {
        orAddDefaultGameModeConfiguration.setScaling(
            typedXmlPullParser.getAttributeFloat((String) null, "scaling"));
      } catch (XmlPullParserException e) {
        String attributeValue = typedXmlPullParser.getAttributeValue((String) null, "scaling");
        if (attributeValue != null) {
          Slog.wtf(
              "GameManagerService_GameManagerSettings",
              "Invalid scaling value in config tag: " + attributeValue,
              e);
        }
      }
      ...
      try {
        orAddDefaultGameModeConfiguration.setUseAngle(
            typedXmlPullParser.getAttributeBoolean((String) null, "useAngle"));
      } catch (XmlPullParserException e2) {
        String attributeValue3 = typedXmlPullParser.getAttributeValue((String) null, "useAngle");
        if (attributeValue3 != null) {
          Slog.wtf(
              "GameManagerService_GameManagerSettings",
              "Invalid useAngle value in config tag: " + attributeValue3,
              e2);
        }
      }
      try {
        orAddDefaultGameModeConfiguration.setLoadingBoostDuration(
            typedXmlPullParser.getAttributeInt((String) null, "loadingBoost"));
      } catch (XmlPullParserException e3) {
        String attributeValue4 =
            typedXmlPullParser.getAttributeValue((String) null, "loadingBoost");
        if (attributeValue4 != null) {
          Slog.wtf(
              "GameManagerService_GameManagerSettings",
              "Invalid loading boost in config tag: " + attributeValue4,
              e3);
        }
      }
      ...
      Slog.wtf(
          "GameManagerService_GameManagerSettings",
          "Invalid game mode value in config tag: "
              + typedXmlPullParser.getAttributeValue((String) null, "gameMode"),
          e4);
    }
  }
}
