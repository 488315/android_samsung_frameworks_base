...
public class RotationChangeNotifier {
  ...
  public boolean registerRotationChangeListener(
    ...
    synchronized (this.mRotationChangedListeners) {
      ...
      try {
        ...
        RotationChangedListenerInfo rotationChangedListenerInfo =
            new RotationChangedListenerInfo(
                iRotationChangeListener, str, Binder.getCallingPid(), Binder.getCallingUid(), i);
  ...
  public boolean unregisterRotationChangeListener(IRotationChangeListener iRotationChangeListener) {
    synchronized (this.mRotationChangedListeners) {
      RotationChangedListenerInfo rotationChangedListenerInfo =
          (RotationChangedListenerInfo)
              this.mRotationChangedListeners.remove(iRotationChangeListener.asBinder());
  ...
  public class RotationChangedListenerInfo extends ListenerInfo {
    ...
    public RotationChangedListenerInfo(
        IRotationChangeListener iRotationChangeListener, String str, int i, int i2, int i3) {
      super(str, i, i2);
    ...
    public void binderDied() {
      ...
      synchronized (RotationChangeNotifier.this.mRotationChangedListeners) {
        ...
        try {
          ...
          Log.m82e(RotationChangeNotifier.TAG, " binderDied: RemoteException " + e.getMessage());
        }
      }
