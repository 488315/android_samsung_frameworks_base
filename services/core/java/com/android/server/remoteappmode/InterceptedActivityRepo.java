...
public class InterceptedActivityRepo {
    ...
    public void put(Intent intent, InterceptedActivityInfo interceptedActivityInfo) {
        ...
        Log.m81d("[RAMS] InterceptedActivityRepo", "mInterceptedActivityInfoMap.put - hashcode : " + hashCode + ", intent : " + intent.toString());
        synchronized (this.mLock) {
            this.mInterceptedActivityInfoMap.put(Integer.valueOf(hashCode), interceptedActivityInfo);
            Log.m81d("[RAMS] InterceptedActivityRepo", "mInterceptedActivityInfoMap size = " + this.mInterceptedActivityInfoMap.size());
        }
    }
    ...
    public void remove(Intent intent) {
        int hashCode = intent.toString().hashCode();
        Log.m81d("[RAMS] InterceptedActivityRepo", "mInterceptedActivityInfoMap.remove - hashcode : " + hashCode + ", intent : " + intent.toString());
        synchronized (this.mLock) {
