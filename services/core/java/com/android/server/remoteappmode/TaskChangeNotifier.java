...
public class TaskChangeNotifier {
    ...
    public final void unregisterWatcherFromActivityManager() {
        try {
            ...
            Log.m82e("TaskChangeNotifier", " unregisterTaskWatcher: SecurityException " + e2.getMessage());
        }
    }
    ...
    public void deinitTaskWatcherThread() {
        synchronized (this.lockObject) {
            try {
                ...
                Log.m82e("TaskChangeNotifier", " unregisterTaskChangeListener: SecurityException " + e.getMessage());
            }
