...
public class SecureAppNotifier {
  ...
  public boolean registerSecureAppChangedListener(
      ISecureAppChangedListener iSecureAppChangedListener, String str) {
    synchronized (this.mSecureAppChangedListeners) {
      ...
      try {
        ...
        SecureAppChangedListenerInfo secureAppChangedListenerInfo =
            new SecureAppChangedListenerInfo(
                iSecureAppChangedListener, str, Binder.getCallingPid(), Binder.getCallingUid());
  ...
  public boolean unregisterSecureAppChangedListener(
      ISecureAppChangedListener iSecureAppChangedListener) {
    synchronized (this.mSecureAppChangedListeners) {
      SecureAppChangedListenerInfo secureAppChangedListenerInfo =
          (SecureAppChangedListenerInfo)
              this.mSecureAppChangedListeners.remove(iSecureAppChangedListener.asBinder());
      ...
      secureAppChangedListenerInfo
          .listener
          .asBinder()
          .unlinkToDeath(secureAppChangedListenerInfo, 0);
      return true;
    }
  }
  ...
  public void releaseAllListeners() {
    synchronized (this.mSecureAppChangedListeners) {
      for (IBinder iBinder : this.mSecureAppChangedListeners.keySet()) {
        try {
          SecureAppChangedListenerInfo secureAppChangedListenerInfo =
              (SecureAppChangedListenerInfo) this.mSecureAppChangedListeners.get(iBinder);
