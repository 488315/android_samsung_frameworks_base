...
public class IcccManagerService extends IIntegrityControlCheckCenter.Stub {
  ...
  public BroadcastReceiver icccBroadcastReceiver =
      new BroadcastReceiver() { // from class: com.android.server.IcccManagerService.1
            ...
            try {
              if (intent.getExtras() == null) {
                ...
                if ("AT+ICCCINFO=1,0,0".equalsIgnoreCase(stringExtra)) {
                  ...
                  String str =
                      IcccManagerService.this.get_iccc_response_data(
                          "AT+ICCCINFO=1,0,0\r\n+ICCCINFO:1,1,");
                  Log.d(IcccManagerService.TAG, "iccc_response - " + str);
                  intent2.putExtra("response", str);
                  IcccManagerService.mContext.sendBroadcast(
                      intent2, "com.sec.android.phone.permission.AT_COMMAND");
                }
              }
  ...
  public static int checkCallerPermissionFor(String str) {
    if (ServiceKeeper.isAuthorized(
            mContext, Binder.getCallingPid(), Binder.getCallingUid(), "IcccManagerService", str)
        != 0) {
  ...
  public final synchronized String get_iccc_response_data(String str) {
    return ((str + Integer.toString(iccc_readData_platform(-1048564)) + ",")
