...
public final class VibrationSettings {
    ...
    public VibrationSettings(Context context, Handler handler, VibrationConfig vibrationConfig, VibratorManagerService vibratorManagerService) {
        ...
        VibrationEffect createEffectFromResource2 = createEffectFromResource(R.array.device_state_notification_power_save_contents);
        VibrationEffect createEffectFromResource3 = createEffectFromResource(R.array.vendor_required_apps_managed_device);
        VibrationEffect createEffectFromResource4 = createEffectFromResource(R.array.config_safeModeEnabledVibePattern);
