...
public final class ClippingAmplitudeAndFrequencyAdapter
    implements VibrationEffectAdapters.SegmentsAdapter {
  ...
  public final StepSegment apply(StepSegment stepSegment, VibratorInfo vibratorInfo) {
    ...
    return new StepSegment(
        clampAmplitude(vibratorInfo, clampFrequency, stepSegment.getAmplitude()),
        clampFrequency,
  ...
  public final RampSegment apply(RampSegment rampSegment, VibratorInfo vibratorInfo) {
    ...
    return new RampSegment(
        clampAmplitude(vibratorInfo, clampFrequency, rampSegment.getStartAmplitude()),
        clampAmplitude(vibratorInfo, clampFrequency2, rampSegment.getEndAmplitude()),
        clampFrequency,
        clampFrequency2,
