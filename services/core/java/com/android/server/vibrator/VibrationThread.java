...
public final class VibrationThread extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            ...
            this.mVibratorManagerHooks.onVibrationThreadReleased(this.mExecutingConductor.getVibration().f1733id);
            synchronized (this.mLock) {
                this.mLock.notifyAll();
            }
    ...
    public final void clientVibrationCompleteIfNotAlready(Vibration.EndInfo endInfo) {
        ...
        this.mVibratorManagerHooks.onVibrationCompleted(this.mExecutingConductor.getVibration().f1733id, endInfo);
    }
