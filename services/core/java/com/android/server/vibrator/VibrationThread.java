...
public final class VibrationThread extends Thread {
  ...
  public VibrationThread(
      PowerManager.WakeLock wakeLock, VibratorManagerHooks vibratorManagerHooks) {
  ...
  public void run() {
    ...
    while (true) {
      ...
      this.mVibratorManagerHooks.onVibrationThreadReleased(
          this.mExecutingConductor.getVibration().f1733id);
      synchronized (this.mLock) {
        this.mLock.notifyAll();
      }
  ...
  public boolean isRunningVibrationId(long j) {
    ...
    synchronized (this.mLock) {
      VibrationStepConductor vibrationStepConductor = this.mRequestedActiveConductor;
      z = vibrationStepConductor != null && vibrationStepConductor.getVibration().f1733id == j;
    }
    return z;
  }
  ...
  public final void runCurrentVibrationWithWakeLock() {
    this.mWakeLock.setWorkSource(
        new WorkSource(this.mExecutingConductor.getVibration().callerInfo.uid));
  ...
  public final void clientVibrationCompleteIfNotAlready(Vibration.EndInfo endInfo) {
    ...
    this.mVibratorManagerHooks.onVibrationCompleted(
        this.mExecutingConductor.getVibration().f1733id, endInfo);
  }
  ...
  public final void playVibration() {
    ...
    try {
      ...
      while (!this.mExecutingConductor.isFinished()) {
        ...
        if (!this.mCalledVibrationCompleteCallback
            && (calculateVibrationEndInfo = this.mExecutingConductor.calculateVibrationEndInfo())
                != null) {
