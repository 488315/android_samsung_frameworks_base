...
public final class AccessPolicy {
    ...
    public static final void _init_$lambda$1$addPolicy(
            MutableIndexedMap mutableIndexedMap, SchemePolicy schemePolicy) {
    ...
    public final void onPackageAdded(
            MutateStateScope mutateStateScope, Map map, Map map2, IntMap intMap, String str) {
        boolean z;
        ...
        if (packageState == null) {
            throw new IllegalStateException(
                    XmlUtils$$ExternalSyntheticOutline0.m(
                                    "Added package ",
                                    str,
                                    " isn't found in packageStates in onPackageAdded()")
                            .toString());
        }
        ...
        MutableIntReferenceMap mutableIntReferenceMap =
                (MutableIntReferenceMap) mutateExternalState.appIdPackageNamesReference.mutate();
        ...
        for (int i3 = 0; i3 < size3; i3++) {
            ...
            for (int i4 = 0; i4 < size4; i4++) {
                ((SchemePolicy) indexedMap3.map.valueAt(i4))
                        .onPackageAdded(mutateStateScope, packageState);
            }
        }
    ...
    public final void onPackageInstalled(
        ...
        if (packageState == null) {
            throw new IllegalStateException(
                    XmlUtils$$ExternalSyntheticOutline0.m(
                                    "Installed package ",
                                    str,
                                    " isn't found in packageStates in onPackageInstalled()")
                            .toString());
        }
        IndexedMap indexedMap = this.schemePolicies;
        int size = indexedMap.map.size();
        for (int i2 = 0; i2 < size; i2++) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ((SchemePolicy) indexedMap2.map.valueAt(i3))
                        .onPackageInstalled(mutateStateScope, packageState, i);
            }
        }
    }
    ...
    */
    public final void onPackageRemoved(
            com.android.server.permission.access.MutateStateScope r8,
            java.util.Map r9,
            java.util.Map r10,
            com.android.server.permission.access.immutable.IntMap r11,
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.permission.access.AccessPolicy.onPackageRemoved(com.android.server.permission.access.MutateStateScope,"
                    + " java.util.Map, java.util.Map,"
                    + " com.android.server.permission.access.immutable.IntMap, java.lang.String,"
                    + " int):void");
    }
    ...
    public final void onPackageUninstalled(
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                ((SchemePolicy) indexedMap2.map.valueAt(i4))
                        .onPackageUninstalled(mutateStateScope, str, i2);
            }
        }
    }
    ...
    public final void onStorageVolumeMounted(
            ...
            if (!packageState.isApex() && Intrinsics.areEqual(packageState.getVolumeUuid(), str)) {
                if (packageState.getAndroidPackage() != null && !list.contains(str2)) {
                    throw new IllegalStateException(
                            XmlUtils$$ExternalSyntheticOutline0.m(
                                            ...
                                            " on storage volume ",
                                            str,
                                            " didn't receive onPackageAdded() before"
                ...
                MutableIntReferenceMap mutableIntReferenceMap =
                        (MutableIntReferenceMap)
                                mutateExternalState.appIdPackageNamesReference.mutate();
                Immutable mutate = mutableIntReferenceMap.mutate(appId);
                if (mutate == null) {
        ...
        for (int i4 = 0; i4 < size4; i4++) {
            ...
            for (int i5 = 0; i5 < size5; i5++) {
                ((SchemePolicy) indexedMap3.map.valueAt(i5))
                        .onStorageVolumeMounted(mutateStateScope, list, z);
            }
        }
        Iterator it = map.entrySet().iterator();
        while (it.hasNext()) {
            PackageState packageState2 = (PackageState) ((Map.Entry) it.next()).getValue();
            if (!packageState2.isApex()
                    && Intrinsics.areEqual(packageState2.getVolumeUuid(), str)) {
                MutableIntReferenceMap userStates = mutableAccessState.getUserStates();
    ...
    public final void onUserAdded(MutateStateScope mutateStateScope, int i) {
        MutableAccessState mutableAccessState = mutateStateScope.newState;
        ((MutableIntSet) mutableAccessState.mutateExternalState().userIdsReference.mutate())
                .array.put(i, true);
        IntReferenceMapExtensionsKt.set(
                (MutableIntReferenceMap) mutableAccessState.userStatesReference.mutate(),
                i,
                new MutableUserState());
        IndexedMap indexedMap = this.schemePolicies;
        int size = indexedMap.map.size();
        for (int i2 = 0; i2 < size; i2++) {
            Object keyAt = indexedMap.map.keyAt(i2);
    ...
    public final void onUserRemoved(MutateStateScope mutateStateScope, int i) {
        ...
        IntReferenceMapExtensionsKt.minusAssign(
                (MutableIntReferenceMap) mutableAccessState.userStatesReference.mutate(), i);
        IndexedMap indexedMap = this.schemePolicies;
        int size = indexedMap.map.size();
        for (int i2 = 0; i2 < size; i2++) {
            Object keyAt = indexedMap.map.keyAt(i2);
    ...
    */
    public final void parseSystemState(
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.permission.access.AccessPolicy.parseSystemState(com.android.modules.utils.BinaryXmlPullParser,"
                    + " com.android.server.permission.access.MutableAccessState):void");
    }
    ...
    */
    public final void parseUserState(
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.permission.access.AccessPolicy.parseUserState(com.android.modules.utils.BinaryXmlPullParser,"
    ...
    public final void serializeSystemState(
        ...
        for (int i = 0; i < size; i++) {
            ...
            int size2 = indexedMap2.map.size();
            for (int i2 = 0; i2 < size2; i2++) {
                ((SchemePolicy) indexedMap2.map.valueAt(i2))
                        .serializeSystemState(binaryXmlSerializer, accessState);
            }
        }
    ...
    public final void serializeUserState(
        ...
        IndexedMap indexedMap =
                (IndexedMap) ((MutableUserState) immutable).packageVersionsReference.immutable;
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            ...
            for (int i4 = 0; i4 < size3; i4++) {
                ((SchemePolicy) indexedMap3.map.valueAt(i4))
                        .serializeUserState(binaryXmlSerializer, accessState, i);
            }
        }
        binaryXmlSerializer.endTag((String) null, "access");
    }

    public final void upgradePackageVersion(
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ((SchemePolicy) indexedMap2.map.valueAt(i3))
                        .upgradePackageState(mutateStateScope, packageState, i, num.intValue());
            }
        }
