...
public final class AppIdPermissionUpgrade {
    ...
    public static final MutableIndexedSet STORAGE_PERMISSIONS =
            IndexedSetExtensionsKt.indexedSetOf(
                    "android.permission.READ_EXTERNAL_STORAGE",
                    "android.permission.WRITE_EXTERNAL_STORAGE");
    ...
    public static final MutableIndexedSet VISUAL_MEDIA_PERMISSIONS =
            IndexedSetExtensionsKt.indexedSetOf(
                    "android.permission.READ_MEDIA_IMAGES",
                    "android.permission.READ_MEDIA_VIDEO",
                    "android.permission.ACCESS_MEDIA_LOCATION");
    ...
    public final void grantRuntimePermission(
            MutateStateScope mutateStateScope, PackageState packageState, int i, String str) {
        GmsAlarmManager$$ExternalSyntheticOutline0.m(
                InitialConfiguration$$ExternalSyntheticOutline0.m(
                        "Granting runtime permission for package: ",
        ...
        if (!packageState.getUserStateOrDefault(i).isInstantApp()
                || IntExtensionsKt.hasBits(permission.permissionInfo.getProtectionFlags(), 4096)) {
            int appId = packageState.getAppId();
            this.policy.getClass();
            int permissionFlags =
                    AppIdPermissionPolicy.getPermissionFlags(mutateStateScope.state, appId, i, str);
            if (!IntExtensionsKt.hasAnyBit(
                    permissionFlags, SystemService.PHASE_LOCK_SETTINGS_READY)) {
                this.policy.updatePermissionFlags(
                        mutateStateScope, appId, i, str, -1, (permissionFlags | 16) & (-7345153));
                return;
            }
            Slog.v(
                    "AppIdPermissionUpgrade",
                    "Not allowed to grant " + str + " to package " + packageState.getPackageName());
        }
    }
}
