...
public final /* synthetic */ class SmartspacePerUserService$$ExternalSyntheticLambda1
        implements AbstractRemoteService.AsyncRequest {
    public final /* synthetic */ int $r8$classId = 1;
    public final /* synthetic */ SmartspaceSessionId f$0;
    public final /* synthetic */ Object f$1;

    public /* synthetic */ SmartspacePerUserService$$ExternalSyntheticLambda1(
        ...
        switch (this.$r8$classId) {
            case 0:
                ((ISmartspaceService) iInterface)
                        .notifySmartspaceEvent(this.f$0, (SmartspaceTargetEvent) this.f$1);
                break;
            default:
                ((ISmartspaceService) iInterface)
                        .onCreateSmartspaceSession((SmartspaceConfig) this.f$1, this.f$0);
                break;
        }
    }
}
