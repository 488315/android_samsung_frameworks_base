        ...
        if (jobScheduler.getPendingJob(i2) == null) {
            jobScheduler.schedule(
                    new JobInfo.Builder(
                                    i2,
                                    new ComponentName(
                                            context, (Class<?>) DataMaintenanceService.class))
    ...
    public final boolean onStartJob(final JobParameters jobParameters) {
        ...
        new Thread(
                        new Runnable() { // from class:
                                         // com.android.server.people.data.DataMaintenanceService$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                DataMaintenanceService dataMaintenanceService =
                                        DataMaintenanceService.this;
                                int i = jobId;
                                ...
                                ((PeopleServiceInternal)
                                        ...
                                        .pruneDataForUser(i, dataMaintenanceService.mSignal);
                                dataMaintenanceService.jobFinished(
                                        jobParameters2,
                                        dataMaintenanceService.mSignal.isCanceled());
                            }
                        })
                .start();
        return true;
