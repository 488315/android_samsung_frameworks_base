...
public final class UsageStatsQueryHelper {
    ...
    public UsageStatsQueryHelper(
            int i,
            DataManager$UsageStatsQueryRunnable$$ExternalSyntheticLambda0
                    dataManager$UsageStatsQueryRunnable$$ExternalSyntheticLambda0,
            DataManager.UsageStatsQueryRunnable usageStatsQueryRunnable) {
        this.mUserId = i;
    ...
    public final void onInAppConversationEnded(PackageData packageData, UsageEvents.Event event) {
        UsageEvents.Event event2 =
                (UsageEvents.Event)
                        ((ArrayMap) this.mConvoStartEvents)
                                .remove(
                                        new ComponentName(
        ...
        ConversationInfo conversationByLocusId =
                packageData.mConversationStore.getConversationByLocusId(locusId);
