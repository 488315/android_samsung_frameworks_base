...
public final /* synthetic */ class DevicePolicyManagerService$$ExternalSyntheticLambda173
    ...
    public /* synthetic */ DevicePolicyManagerService$$ExternalSyntheticLambda173(
    ...
    public /* synthetic */ DevicePolicyManagerService$$ExternalSyntheticLambda173(
            DevicePolicyManagerService devicePolicyManagerService, String str, int i, String str2) {
        this.f$0 = devicePolicyManagerService;
        this.f$1 = str;
        this.f$2 = i;
        this.f$3 = str2;
    ...
    public /* synthetic */ DevicePolicyManagerService$$ExternalSyntheticLambda173(
            DevicePolicyManagerService devicePolicyManagerService, String str, String str2, int i) {
        this.f$0 = devicePolicyManagerService;
        this.f$1 = str;
        this.f$3 = str2;
        this.f$2 = i;
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                Settings.Secure.putStringForUser(
                        devicePolicyManagerService.mInjector.mContext.getContentResolver(),
                        str,
                        str2,
                        i);
                if (str.equals("location_mode") && Integer.parseInt(str2) != 0) {
                    devicePolicyManagerService.showLocationSettingsEnabledNotification(
                            UserHandle.of(i));
                    break;
                }
                break;
            case 1:
                ...
                Settings.System.putStringForUser(
                        devicePolicyManagerService2.mInjector.mContext.getContentResolver(),
                        (String) this.f$1,
                        (String) this.f$3,
                        this.f$2);
                break;
