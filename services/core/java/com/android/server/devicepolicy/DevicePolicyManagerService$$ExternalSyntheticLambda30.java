...
public final /* synthetic */ class DevicePolicyManagerService$$ExternalSyntheticLambda30
    ...
    public /* synthetic */ DevicePolicyManagerService$$ExternalSyntheticLambda30(
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                if (Flags.headlessSingleUserFixes()
                        && devicePolicyManagerService.getHeadlessDeviceOwnerModeForDeviceOwner()
                                == 2) {
                ...
                String str =
                        z3
                                ? "no_factory_reset"
                                : devicePolicyManagerService.isManagedProfile(i)
                                        ? "no_remove_managed_profile"
                                        : "no_remove_user";
                if (devicePolicyManagerService.isAdminAffectedByRestriction(
                        componentName, i, str)) {
                    throw new SecurityException(
                            SensitiveContentProtectionManagerService$SensitiveContentProtectionManagerServiceBinder$$ExternalSyntheticOutline0
                                    .m(
                                            ...
                                            "Cannot wipe data. ",
                                            str,
                                            " restriction is set for user "));
                }
                if (i == 0) {
                    devicePolicyManagerService.mInjector.getClass();
                    KnoxPolicyHelper knoxPolicyHelper =
                            devicePolicyManagerService.mKnoxPolicyHelper;
                    knoxPolicyHelper.getClass();
                    try {
                        if (knoxPolicyHelper.getService() != null) {
                            boolean isFactoryResetAllowed =
                                    knoxPolicyHelper.mRestrictionService.isFactoryResetAllowed(
                                            new ContextInfo(Binder.getCallingUid(), i));
                            Log.d(
                                    "KnoxPolicyHelper",
                                    "isFactoryResetAllowed = " + isFactoryResetAllowed);
                    ...
                    try {
                        ...
                        throw new SecurityException(
                                "Cannot wipe data. Factory reset is not allowed from Restriction"
                                    + " Policy.");
                    } catch (Throwable th) {
                        Binder.restoreCallingIdentity(clearCallingIdentity);
                        throw th;
            ...
            case 1:
                ...
                for (int i3 : devicePolicyManagerService2.mUserManagerInternal.getUserIds()) {
                    devicePolicyManagerService2.mUserManager.setUserRestriction(
                            "no_add_managed_profile", true, UserHandle.of(i3));
                    devicePolicyManagerService2.mUserManager.setUserRestriction(
                            "no_add_clone_profile", true, UserHandle.of(i3));
                    devicePolicyManagerService2.mUserManager.setUserRestriction(
                            "no_add_private_profile", true, UserHandle.of(i3));
                }
                devicePolicyManagerService2.mInjector.getClass();
                devicePolicyManagerService2.mKnoxAnalyticsHelper.sendOwnerChangedBroadcastWithExtra(
                        i2, componentName2.getPackageName(), true);
                return;
            case 2:
            ...
            default:
                ...
                synchronized (devicePolicyManagerService3.getLockObject()) {
                    try {
                        ...
                        if (devicePolicyManagerService3.isDeviceOwner(i4, componentName3)) {
                            devicePolicyManagerService3.clearDeviceOwnerLocked(
                                    i4, devicePolicyManagerService3.getDeviceOwnerAdminLocked());
                        }
                        if (devicePolicyManagerService3.isProfileOwner(i4, componentName3)) {
                            z =
                                    devicePolicyManagerService3
                                            .isProfileOwnerOfOrganizationOwnedDevice(i4);
                            devicePolicyManagerService3.clearProfileOwnerLocked(
                                    i4,
                                    devicePolicyManagerService3.getActiveAdminUncheckedLocked(
                                            i4, componentName3, false));
                        } else {
                            z = false;
                        }
                    } catch (Throwable th2) {
                ...
                if (z) {
                    UserHandle of =
                            UserHandle.of(devicePolicyManagerService3.getProfileParentId(i4));
                    devicePolicyManagerService3.mUserManager.setUserRestriction(
                            "no_remove_managed_profile", false, of);
                    devicePolicyManagerService3.mUserManager.setUserRestriction(
                            "no_add_user", false, of);
                    devicePolicyManagerService3.clearOrgOwnedProfileOwnerDeviceWidePolicies(
                            of.getIdentifier());
                }
                Slogf.i(
                        "DevicePolicyManager",
                        "Admin " + componentName3 + " removed from user " + i4);
                return;
        }
    }
}
