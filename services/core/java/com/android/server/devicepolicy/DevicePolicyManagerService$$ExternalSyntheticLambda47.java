...
public final /* synthetic */ class DevicePolicyManagerService$$ExternalSyntheticLambda47
    ...
    public /* synthetic */ DevicePolicyManagerService$$ExternalSyntheticLambda47(
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                synchronized (deviceManagementResourcesProvider.mLock) {
                    try {
                        ParcelableResource drawableForSourceLocked =
                                deviceManagementResourcesProvider.getDrawableForSourceLocked(
                                        str, str2, str3);
            ...
            case 1:
                ...
                String str4 =
                        devicePolicyManagerService2.isManagedProfile(userHandle.getIdentifier())
                                ? "no_remove_managed_profile"
                                : "no_remove_user";
                if (!devicePolicyManagerService2.isAdminAffectedByRestriction(
                        componentName, UserHandle.getUserId(callerIdentity.mUid), str4)) {
                    return Boolean.valueOf(
                            devicePolicyManagerService2.mUserManagerInternal
                                    .removeUserEvenWhenDisallowed(userHandle.getIdentifier()));
                }
                Slogf.w(
                        "DevicePolicyManager",
                        "The device owner cannot remove a user because %s is enabled, and was not"
            ...
            default:
                ...
                devicePolicyManagerService3.getClass();
                int i2 = 0;
                if (devicePolicyManagerService3.getTargetSdk(
                    ...
                    try {
                        PackageState packageState =
                                (PackageState) withUnfilteredSnapshot.getPackageStates().get(str5);
                        if (packageState == null) {
                            Slog.w(
                                    "DevicePolicyManager",
                                    "Can't get permission state for missing package " + str5);
                            ...
                            Slog.w(
                                    "DevicePolicyManager",
                                    "Can't get permission state for uninstalled package " + str5);
                        }
                        withUnfilteredSnapshot.close();
                ...
                i =
                        devicePolicyManagerService3.mIPackageManager.checkPermission(
                                str6, str5, userId);
                if ((devicePolicyManagerService3
                                        .mInjector
                                        .mContext
                                        .getPackageManager()
                                        .getPermissionFlags(str6, str5, UserHandle.of(userId))
                                & 4)
                        == 4) {
                    i2 = i == 0 ? 1 : 2;
                }
