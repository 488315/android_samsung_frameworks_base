...
public final /* synthetic */ class DevicePolicyManagerService$$ExternalSyntheticLambda177
    ...
    public /* synthetic */ DevicePolicyManagerService$$ExternalSyntheticLambda177(
            DevicePolicyManagerService.LocalService localService, String str, int i, List list) {
        ...
        switch (this.$r8$classId) {
                ...
                while (it.hasNext()) {
                    List roleHoldersAsUser =
                            roleManager.getRoleHoldersAsUser(
                                    str, ((UserInfo) it.next()).getUserHandle());
            ...
            case 1:
                ...
                Bundle applicationRestrictions =
                        localService.this$0.mUserManager.getApplicationRestrictions(
                                str2, UserHandle.of(i2));
            ...
            default:
                ...
                return Boolean.valueOf(
                        ((TelephonyManager) this.f$2)
                                .modifyDevicePolicyOverrideApn(
