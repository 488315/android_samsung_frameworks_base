...
public abstract class KnoxUtils {
    public static void disableComponent(int i, ComponentName componentName) {
        try {
            IPackageManager.Stub.asInterface(ServiceManager.getService("package"))
                    .setComponentEnabledSetting(componentName, 2, 1, i, "KnoxUtils");
        } catch (RemoteException e) {
            NetdService$$ExternalSyntheticOutline0.m(
                    "This should not happen.", e, "DevicePolicyManager::KnoxUtils");
        } catch (Exception unused) {
            Log.w(
                    "DevicePolicyManager::KnoxUtils",
                    "Component not found, not changing enabled setting: "
    ...
    public static void setKnoxWorkChallengeRequiredComponent(Context context, int i, int i2) {
        ...
        Settings.Secure.putIntForUser(
                context.getContentResolver(), "knox_screen_off_timeout", 0, i2);
        try {
            ...
            DirEncryptServiceHelper$$ExternalSyntheticOutline0.m(
                    e,
                    "Failed to set default kcm biometric password policy ",
                    "DevicePolicyManager::KnoxUtils");
            throw e;
        }
    }
