...
public final class PolicyDefinition {
    ...
    static {
        ...
        MostRestrictive mostRestrictive2 =
                new MostRestrictive(
                                ...
                                switch (i) {
                                    case 0:
                                        ...
                                        Slogf.w(
                                                ...
                                                "Trying to enforce setAutoTimezoneEnabled while"
                                                    + " flag is off.");
                                        return Boolean.TRUE;
                                    case 1:
                                        ...
                                        devicePolicyManagerInternal.enforceSecurityLoggingPolicy(
                                                bool.equals((Boolean) obj));
                                        return bool;
                                    case 2:
                                        ((Integer) obj3).intValue();
                                        DevicePolicyManagerInternal devicePolicyManagerInternal2 =
                                                (DevicePolicyManagerInternal)
                                                        LocalServices.getService(
                                                                DevicePolicyManagerInternal.class);
                                        Boolean bool2 = Boolean.TRUE;
                                        devicePolicyManagerInternal2.enforceAuditLoggingPolicy(
                                                bool2.equals((Boolean) obj));
                                        return bool2;
                                    case 3:
                                        ...
                                        Binder.withCleanCallingIdentity(
                                                new DevicePolicyManagerService$$ExternalSyntheticLambda101(
                                                        intValue, context, emptyList));
                                        Binder.withCleanCallingIdentity(
                                                new FunctionalUtils
                                                        .ThrowingRunnable() { // from class:
                                                    // com.android.server.devicepolicy.DevicePolicyManagerService$$ExternalSyntheticLambda204
                                    ...
                                    case 4:
                                        ...
                                        ProtectedPackagesFilter protectedPackagesFilter =
                                                ProtectedPackagesFilter
                                                        .ProtectedPackagesFilterHolder.INSTANCE;
                                        List<String> list =
                                                set == null ? null : set.stream().toList();
                                        protectedPackagesFilter.getClass();
                                        Slog.d(
                                                "ProtectedPackagesFilter",
                                                "updateProtectedPackages is called. userId "
                                                        + intValue2
                                                        + " package names : "
                                                        + list);
                                        synchronized (protectedPackagesFilter.mProtectedPackages) {
                                            try {
                                                if (list == null) {
                                                    protectedPackagesFilter.mProtectedPackages
                                                            .remove(intValue2);
                                                } else {
                                                    protectedPackagesFilter.mProtectedPackages.put(
                                                            intValue2, new ArraySet(list));
                                                }
                                            } catch (Throwable th) {
                                                throw th;
                                            }
                                        ...
                                        if (list != null) {
                                            for (String str : list) {
                                                ...
                                                if (!MARsPolicyManager.MARsPolicyManagerHolder
                                                        .INSTANCE
                                                        .cancelDisablePolicy(str, intValue2, 0)) {
                                                    BootReceiver$$ExternalSyntheticOutline0.m(
                                                            "cancelDisablePolicy failed. package :"
                                                                + " ",
                                                            str,
                                                            "MARsPolicyManager");
                                                }
                                        ...
                                        Binder.withCleanCallingIdentity(
                                                new PolicyEnforcerCallbacks$$ExternalSyntheticLambda0(
                                                        context2, intValue2, set));
                                        return Boolean.TRUE;
                                    case 5:
                                        Binder.withCleanCallingIdentity(
                                                new PolicyEnforcerCallbacks$$ExternalSyntheticLambda0(
                                    ...
                                    case 6:
                                        return Boolean.valueOf(
                                                Boolean.TRUE.equals(
                                                        Binder.withCleanCallingIdentity(
                                                                new PolicyEnforcerCallbacks$$ExternalSyntheticLambda3(
                                                                        (PolicyKey) obj4,
                                                                        (Boolean) obj,
                                                                        ((Integer) obj3).intValue(),
                                                                        1))));
                                    case 7:
                                        ...
                                        Binder.withCleanCallingIdentity(
                                                new FunctionalUtils
                                                    ...
                                                    public final void runOrThrow() {
                                                        PackagePolicyKey packagePolicyKey =
                                                                policyKey;
                                                        Context context4 = context3;
                                                        Integer num2 = num;
                                                        String packageName =
                                                                packagePolicyKey.getPackageName();
                                                        ...
                                                        context4.sendBroadcastAsUser(
                                                                intent,
                                                                UserHandle.of(num2.intValue()));
                                                    }
                                                });
                                        return Boolean.TRUE;
                                    case 8:
                                        ...
                                        Binder.withCleanCallingIdentity(
                                                new FunctionalUtils
                                                    ...
                                                    public final void runOrThrow() {
                                                        ...
                                                        if (devicePolicyCache
                                                                instanceof DevicePolicyCacheImpl) {
                                                            ...
                                                            boolean z2 =
                                                                    bool4 != null
                                                                            && bool4.booleanValue();
                                                            synchronized (
                                                                    devicePolicyCacheImpl.mLock) {
                                                                try {
                                                                    if (z2) {
                                                                        ((HashSet)
                                                                                        devicePolicyCacheImpl
                                                                                                .mScreenCaptureDisallowedUsers)
                                                                                .add(
                                                                                        Integer
                                                                                                .valueOf(
                                                                                                        i4));
                                                            ...
                                                            BackgroundThread.getHandler()
                                                                    .post(
                                                                            new PolicyEnforcerCallbacks$$ExternalSyntheticLambda10());
                                                        }
                                                    }
                                                });
                                        return Boolean.TRUE;
                                    ...
                                    case 16:
                                        ...
                                        Boolean bool5 =
                                                (Boolean)
                                                        Binder.withCleanCallingIdentity(
                                                                new FunctionalUtils
                                                                        .ThrowingSupplier() { // from class: com.android.server.devicepolicy.PolicyEnforcerCallbacks$$ExternalSyntheticLambda2
                                                                    public final Object
                                                                            getOrThrow() {
                                    ...
                                    default:
                                        ...
                                        Slogf.w(
                                                "PolicyEnforcerCallbacks",
                                                "Trying to enforce setPermissionGrantState while"
                                                    + " flag is off.");
                                        return Boolean.TRUE;
                                }
                            }
        ...
        final int i3 = 1;
        PolicyDefinition policyDefinition3 =
                new PolicyDefinition(
                        new NoArgsPolicyKey("securityLogging"),
                        mostRestrictive2,
                        1,
                        new QuadFunction() { // from class:
                            // com.android.server.devicepolicy.PolicyDefinition$$ExternalSyntheticLambda0
        ...
        final int i4 = 2;
        PolicyDefinition policyDefinition4 =
                new PolicyDefinition(
                        new NoArgsPolicyKey("auditLogging"),
                        mostRestrictive2,
                        1,
                        new QuadFunction() { // from class:
                            // com.android.server.devicepolicy.PolicyDefinition$$ExternalSyntheticLambda0
        ...
        final int i5 = 3;
        PolicyDefinition policyDefinition5 =
                new PolicyDefinition(
                        new NoArgsPolicyKey("lockTask"),
                        new TopPriority(
                                List.of(
                                        "role:android.app.role.SYSTEM_FINANCED_DEVICE_CONTROLLER",
                                        "enterprise")),
                        2,
                        new QuadFunction() { // from class:
                            // com.android.server.devicepolicy.PolicyDefinition$$ExternalSyntheticLambda0
        ...
        final int i6 = 4;
        PolicyDefinition policyDefinition6 =
                new PolicyDefinition(
        ...
        final int i7 = 5;
        PolicyDefinition policyDefinition7 =
                new PolicyDefinition(
        ...
        final int i8 = 6;
        PolicyDefinition policyDefinition8 =
                new PolicyDefinition(
        ...
        final int i9 = 7;
        PolicyDefinition policyDefinition9 =
                new PolicyDefinition(
        ...
        final int i10 = 8;
        PolicyDefinition policyDefinition10 =
                new PolicyDefinition(
        ...
        final int i11 = 10;
        PolicyDefinition policyDefinition11 =
                new PolicyDefinition(
                        ...
                        new IntegerPolicySerializer());
        final int i12 = 11;
        PolicyDefinition policyDefinition12 =
                new PolicyDefinition(
        ...
        final int i13 = 12;
        PolicyDefinition policyDefinition13 =
                new PolicyDefinition(
        ...
        final int i14 = 13;
        PolicyDefinition policyDefinition14 =
                new PolicyDefinition(
        ...
        final int i15 = 14;
        PolicyDefinition policyDefinition15 =
                new PolicyDefinition(
        ...
        final int i16 = 15;
        PolicyDefinition policyDefinition16 =
                new PolicyDefinition(
        ...
        final int i17 = 16;
        PolicyDefinition policyDefinition17 =
                new PolicyDefinition(
                        new NoArgsPolicyKey("usbDataSignaling"),
                        mostRestrictive,
                        1,
                        new QuadFunction() { // from class:
                            // com.android.server.devicepolicy.PolicyDefinition$$ExternalSyntheticLambda0
        ...
        final int i18 = 17;
        PolicyDefinition policyDefinition18 =
                new PolicyDefinition(
                        new NoArgsPolicyKey("contentProtection"),
                        new MostRecent(),
                        2,
                        new QuadFunction() { // from class:
                            // com.android.server.devicepolicy.PolicyDefinition$$ExternalSyntheticLambda0
        ...
        final int i19 = 10;
        PolicyDefinition policyDefinition19 =
                new PolicyDefinition(
                        new NoArgsPolicyKey("passwordComplexity"),
                        new MostRestrictive(
                                List.of(
                                        new IntegerPolicyValue(327680),
                                        new IntegerPolicyValue(196608),
        ...
        final int i20 = 13;
        PolicyDefinition policyDefinition20 =
                new PolicyDefinition(
                        new NoArgsPolicyKey("packagesSuspended"),
                        new PackageSetUnion(),
                        0,
                        new QuadFunction() { // from class:
                            // com.android.server.devicepolicy.PolicyDefinition$$ExternalSyntheticLambda0
        ...
        for (String str : hashMap2.keySet()) {
            ...
            int i21 = intValue | 20;
            final int i22 = 9;
            PolicyDefinition policyDefinition21 =
                    new PolicyDefinition(
                            ...
                            new QuadFunction() { // from class:
                                ...
                                public final Object apply(
                                    ...
                                    switch (i22) {
                                        case 0:
                                            String[] strArr =
                                                    DevicePolicyManagerService.DELEGATIONS;
                                            Slogf.w(
                                                    "PolicyEnforcerCallbacks",
                                                    "Trying to enforce setAutoTimezoneEnabled while"
                                                        + " flag is off.");
                                        ...
                                        case 1:
                                            ...
                                            Boolean bool = Boolean.TRUE;
                                            devicePolicyManagerInternal
                                                    .enforceSecurityLoggingPolicy(
                                                            bool.equals((Boolean) obj));
                                            return bool;
                                        case 2:
                                            ((Integer) obj3).intValue();
                                            DevicePolicyManagerInternal
                                                    devicePolicyManagerInternal2 =
                                                            (DevicePolicyManagerInternal)
                                                                    LocalServices.getService(
                                                                            DevicePolicyManagerInternal
                                                                                    .class);
                                        ...
                                        case 3:
                                            ...
                                            if (lockTaskPolicy != null) {
                                                emptyList =
                                                        List.copyOf(lockTaskPolicy.getPackages());
                                        ...
                                        default:
                                            ...
                                            Slogf.w(
                                                    "PolicyEnforcerCallbacks",
                                                    "Trying to enforce setPermissionGrantState"
                                                        + " while flag is off.");
                                            return Boolean.TRUE;
                                    }
                                }
                            ...
                            new BooleanPolicySerializer());
            ((HashMap) POLICY_DEFINITIONS)
                    .put(userRestrictionPolicyKey.getIdentifier(), policyDefinition21);
        }
    }
    ...
    public static PolicyDefinition getPolicyDefinitionForUserRestriction(String str) {
        ...
        throw new IllegalArgumentException(
                ConnectivityModuleConnector$$ExternalSyntheticOutline0.m(
                        "Unsupported user restriction ", str));
    }
    ...
    public static PolicyKey readPolicyKeyFromXml(TypedXmlPullParser typedXmlPullParser) {
        ...
        PolicyDefinition policyDefinition =
                (PolicyDefinition)
                        ((HashMap) POLICY_DEFINITIONS)
                                .get(readGenericPolicyKeyFromXml.getIdentifier());
        if (policyDefinition != null) {
            return policyDefinition.mPolicyKey.readFromXml(typedXmlPullParser);
        }
        Slogf.wtf(
                "PolicyDefinition",
                "Error parsing PolicyKey, Unknown generic policy key: "
                        + readGenericPolicyKeyFromXml);
        return null;
    }
