...
public final class BackupRestoreProcessor {
    ...
    public BackupRestoreProcessor(
            Context context,
            PackageManagerInternal packageManagerInternal,
            AssociationStore associationStore,
            AssociationDiskStore associationDiskStore,
    ...
    public final void applyRestoredPayload(byte[] bArr, int i) {
        ...
        CustomizedBinderCallsStatsInternal$$ExternalSyntheticOutline0.m(
                BatteryService$$ExternalSyntheticOutline0.m(
                        i, "applyRestoredPayload() userId=[", "], payload size=["),
                bArr.length,
                "].",
        ...
        try {
            ...
            try {
                ...
                try {
                    associations =
                            AssociationDiskStore.readAssociationsFromInputStream(
                                    i,
            ...
            try {
                ...
                try {
                    TypedXmlPullParser resolvePullParser =
                            Xml.resolvePullParser(byteArrayInputStream);
                    XmlUtils.beginDocument(resolvePullParser, "requests");
                    arrayList =
                            SystemDataTransferRequestStore.readRequestsFromXml(
                                    i, resolvePullParser);
                    byteArrayInputStream.close();
                } finally {
                }
                ...
                Slog.e(
                        ...
                        "Error while reading requests file",
                        e2);
                arrayList = new ArrayList();
            }
            List installedApplications =
                    this.mPackageManagerInternal.getInstalledApplications(
                            i, UserHandle.getCallingUserId(), 0L);
            for (final AssociationInfo associationInfo : associations2.mAssociations) {
                if (!associationInfo.isRevoked()) {
                    final int i4 = 0;
                    List<SystemDataTransferRequest> filter =
                            CollectionUtils.filter(
                                    arrayList,
                                    new Predicate() { // from class:
                                                      // com.android.server.companion.BackupRestoreProcessor$$ExternalSyntheticLambda1
                                        ...
                                        public final boolean test(Object obj) {
                                            ...
                                            switch (i5) {
                                                case 0:
                                                    return ((SystemDataTransferRequest) obj)
                                                                    .getAssociationId()
                                                            == associationInfo2.getId();
                                                default:
                                                    AssociationInfo associationInfo3 =
                                                            (AssociationInfo) obj;
                    ...
                    AssociationInfo associationInfo2 =
                            (AssociationInfo)
                                    CollectionUtils.find(
                                            associationStore.getActiveAssociationsByPackage(
                                                    userId, packageName),
                                            new Predicate() { // from class:
                                                              // com.android.server.companion.BackupRestoreProcessor$$ExternalSyntheticLambda1
                                                @Override // java.util.function.Predicate
                                                public final boolean test(Object obj) {
                                                    int i52 = i5;
                                                    AssociationInfo associationInfo22 =
                                                            associationInfo;
                                                    switch (i52) {
                                                        case 0:
                                                            return ((SystemDataTransferRequest) obj)
                                                                            .getAssociationId()
                                                                    == associationInfo22.getId();
                                                        default:
                                                            AssociationInfo associationInfo3 =
                                                                    (AssociationInfo) obj;
                                                            return Objects.equals(
                    ...
                    if (associationInfo2 == null) {
                        ...
                        AssociationInfo build =
                                new AssociationInfo.Builder(i3, i, packageName2, associationInfo)
                                        .build();
                        final int i6 = 0;
                        if (installedApplications.stream()
                                .anyMatch(
                                        new Predicate() { // from class:
                                                          // com.android.server.companion.BackupRestoreProcessor$$ExternalSyntheticLambda2
                                            @Override // java.util.function.Predicate
                                            public final boolean test(Object obj) {
                                                int i7 = i6;
                            ...
                            RolesUtils.addRoleHolderForAssociation(
                                    ...
                                    build,
                                    new AssociationRequestsProcessor$$ExternalSyntheticLambda1(
                                            associationRequestsProcessor, build, null, null));
                        } else {
                            associationStore.addAssociation(
                                    new AssociationInfo.Builder(build).setPending(true).build());
                        }
                        Iterator it = filter.iterator();
                        while (it.hasNext()) {
                            SystemDataTransferRequest copyWithNewId =
                                    ((SystemDataTransferRequest) it.next()).copyWithNewId(i3);
                        ...
                        Slog.d(
                                "CDM_BackupRestoreProcessor",
                                "Conflict detected with association id="
                                        + associationInfo2.getId()
                                        + " while restoring CDM backup. Keeping local"
                                        + " association.");
                        List readRequestsByAssociationId =
                                systemDataTransferRequestStore.readRequestsByAssociationId(
                                        i, associationInfo2.getId());
                        for (final SystemDataTransferRequest systemDataTransferRequest : filter) {
                            final int i7 = 1;
                            if (!CollectionUtils.any(
                                    readRequestsByAssociationId,
                                    new Predicate() { // from class:
                                                      // com.android.server.companion.BackupRestoreProcessor$$ExternalSyntheticLambda2
                                        @Override // java.util.function.Predicate
                                        public final boolean test(Object obj) {
                                            ...
                                            switch (i72) {
                                                ...
                                                default:
                                                    return ((SystemDataTransferRequest) obj)
                                                                    .getDataType()
                                                            == ((SystemDataTransferRequest) obj2)
                                                                    .getDataType();
                                            }
                                        }
                                    })) {
                                Slog.d(
                                        ...
                                        "Restoring "
                                                + systemDataTransferRequest
                                                        .getClass()
                                                        .getSimpleName()
                                                + " to an existing association id=["
                                                + associationInfo2.getId()
                                                + "].");
                                SystemDataTransferRequest copyWithNewId2 =
                                        systemDataTransferRequest.copyWithNewId(
                                                associationInfo2.getId());
    ...
    public final byte[] getBackupPayload(int i) {
        ...
        BootReceiver$$ExternalSyntheticOutline0.m(
                i, "getBackupPayload() userId=[", "].", "CDM_BackupRestoreProcessor");
        ...
        Slog.i(
                ...
                "Fetching stored state data for user " + i + " from disk");
        ...
        AtomicFile storageFileForUser2 =
                this.mSystemDataTransferRequestStore.getStorageFileForUser(i);
        ...
        return ByteBuffer.allocate(length + 12 + length2)
                .putInt(0)
                .putInt(length)
                .put(fileToByteArray)
                .putInt(length2)
                .put(fileToByteArray2)
                .array();
    }
}
