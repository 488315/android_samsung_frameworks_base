...
public class CallMetadataSyncConnectionService extends ConnectionService {
    ...
    final CrossDeviceSyncControllerCallback mCrossDeviceSyncControllerCallback =
            new CrossDeviceSyncControllerCallback() { // from class:
                                                      // com.android.server.companion.datatransfer.contextsync.CallMetadataSyncConnectionService.1
                                            ...
                                            CallMetadataSyncConnectionService
                                                    ...
                                                    callMetadataSyncConnection =
                                                            (CallMetadataSyncConnectionService
                                                                    ...
                                                                    obj;
                                            if (!set.contains(
                                                    callMetadataSyncConnection.mCall.mId)) {
                                                return false;
                                            }
                                            callMetadataSyncConnection.setDisconnected(
                                                    new DisconnectCause(3));
                                            return true;
                                        }
                                    });
                }
                ...
                public final void processContextSyncMessage(
                    ...
                    while (true) {
                        ...
                        CallMetadataSyncConnectionService callMetadataSyncConnectionService =
                                CallMetadataSyncConnectionService.this;
                        if (!hasNext) {
                            callMetadataSyncConnectionService
                                    .mActiveConnections
                                    ...
                                    .removeIf(
                                            new Predicate() { // from class:
                                                ...
                                                public final boolean test(Object obj) {
                                                    int i2 = i;
                                                    CallMetadataSyncData callMetadataSyncData2 =
                        ...
                        CallMetadataSyncConnection callMetadataSyncConnection =
                                (CallMetadataSyncConnection)
                                        callMetadataSyncConnectionService.mActiveConnections.get(
                                                new CallMetadataSyncConnectionIdentifier(
                                                        i, call.mId));
                        if (callMetadataSyncConnection != null) {
                            CallMetadataSyncConnection.m345$$Nest$mupdate(
                                    callMetadataSyncConnection, call);
                        } else {
                            Iterator it2 =
                                    callMetadataSyncConnectionService
                                            .mActiveConnections
                            ...
                            while (true) {
                                ...
                                if (((CallMetadataSyncConnection) entry.getValue()).mAssociationId
                                                == i
                                        && !((CallMetadataSyncConnection) entry.getValue())
                                                .mIsIdFinalized
                                        && call.mId.endsWith(
                                                ((CallMetadataSyncConnection) entry.getValue())
                                                        .mCall
                            ...
                            if (callMetadataSyncConnectionIdentifier != null) {
                                CallMetadataSyncConnection callMetadataSyncConnection2 =
                                        (CallMetadataSyncConnection)
                                                callMetadataSyncConnectionService.mActiveConnections
                                                        .remove(
                                                                callMetadataSyncConnectionIdentifier);
                                CallMetadataSyncConnection.m345$$Nest$mupdate(
                                        callMetadataSyncConnection2, call);
                                callMetadataSyncConnectionService.mActiveConnections.put(
                                        new CallMetadataSyncConnectionIdentifier(i, call.mId),
    ...
    public final class AnonymousClass2 extends CallMetadataSyncConnectionCallback {
        ...
        public /* synthetic */ AnonymousClass2(
                CallMetadataSyncConnectionService callMetadataSyncConnectionService, int i) {
            this.$r8$classId = i;
    ...
    class CallMetadataSyncConnection extends Connection {
        ...
        public static void m345$$Nest$mupdate(
                CallMetadataSyncConnection callMetadataSyncConnection,
            ...
            if (i != callMetadataSyncConnection.getState()) {
                if (i == 2) {
                    ...
                    Slog.e(
                            "CallMetadataSyncConnectionService",
                            "Could not update call to unknown state");
                }
            }
            ...
            int i3 =
                    (callMetadataSyncConnection.mCall.hasControl(7)
                                    || callMetadataSyncConnection.mCall.hasControl(8))
                            ? connectionCapabilities | 1
                            : connectionCapabilities & (-2);
            int i4 =
                    (callMetadataSyncConnection.mCall.hasControl(4)
                                    || callMetadataSyncConnection.mCall.hasControl(5))
                            ? i3 | 64
                            : i3 & (-65);
            callMetadataSyncConnection.mAudioManager.setMicrophoneMute(
                    callMetadataSyncConnection.mCall.hasControl(5));
    ...
    final class CallMetadataSyncConnectionIdentifier {
        ...
        public final boolean equals(Object obj) {
            ...
            return callMetadataSyncConnectionIdentifier.mAssociationId == this.mAssociationId
                    && (str = this.mCallId) != null
                    && str.equals(callMetadataSyncConnectionIdentifier.mCallId);
        }
    ...
    public final void onCreate() {
        ...
        CompanionDeviceManagerService.LocalService localService =
                (CompanionDeviceManagerService.LocalService)
                        LocalServices.getService(CompanionDeviceManagerService.LocalService.class);
    ...
    public final void onCreateConnectionComplete(Connection connection) {
        ...
        if (connection instanceof CallMetadataSyncConnection) {
            ...
            if (str != null) {
                ...
                callMetadataSyncConnection.setAddress(
                        Uri.fromParts("custom", callMetadataSyncConnection.mCall.mCallerId, null),
                        1);
            }
            ...
            this.mActiveConnections.put(
                    new CallMetadataSyncConnectionIdentifier(
                            callMetadataSyncConnection.mAssociationId,
                            callMetadataSyncConnection.mCall.mId),
                    callMetadataSyncConnection);
        }
    }
    ...
    public final Connection onCreateIncomingConnection(
    ...
    @Override // android.telecom.ConnectionService
    public final void onCreateIncomingConnectionFailed(
            PhoneAccountHandle phoneAccountHandle, ConnectionRequest connectionRequest) {
    ...
    @Override // android.telecom.ConnectionService
    public final Connection onCreateOutgoingConnection(
            PhoneAccountHandle phoneAccountHandle, ConnectionRequest connectionRequest) {
        ...
        call.mFacilitator =
                new CallMetadataSyncData.CallFacilitator(
                        phoneAccount != null
                                ...
                                : phoneAccountHandle.getComponentName().getShortClassName(),
                        phoneAccount != null
                                ? phoneAccount
                                        .getExtras()
                                        .getString(
        ...
        localService.getClass();
        if (CompanionDeviceConfig.isEnabled()) {
            CompanionDeviceManagerService.this.mCrossDeviceSyncController.mCallManager
                    .mSelfOwnedCalls.add(str);
        }
        CompanionDeviceManagerService.LocalService localService2 = this.mCdmsi;
        byte[] createCallCreateMessage =
        ...
        localService2.getClass();
        if (CompanionDeviceConfig.isEnabled()) {
            CompanionDeviceManagerService.this.mCrossDeviceSyncController.syncMessageToDevice(
                    i, createCallCreateMessage);
        }
        callMetadataSyncConnection.setInitializing();
        return callMetadataSyncConnection;
    }
    ...
    @Override // android.telecom.ConnectionService
    public final void onCreateOutgoingConnectionFailed(
            PhoneAccountHandle phoneAccountHandle, ConnectionRequest connectionRequest) {
        BootReceiver$$ExternalSyntheticOutline0.m(
                "onCreateOutgoingConnectionFailed for: ",
                phoneAccountHandle != null ? phoneAccountHandle.getId() : "unknown PhoneAccount",
