...
public final class SystemDataTransferProcessor {
    ...
    public final AnonymousClass2 mOnSystemDataTransferRequestConfirmationReceiver =
            new ResultReceiver(
                    Handler
                            .getMain()) { // from class:
                ...
                public final void onReceiveResult(int i, Bundle bundle) {
                    ...
                    if (i != 0 && i != 1) {
                        NandswapManager$$ExternalSyntheticOutline0.m(
                                i, "Unknown result code:", "CDM_SystemDataTransferProcessor");
                        return;
                    }
                    SystemDataTransferRequest systemDataTransferRequest =
                            (PermissionSyncRequest)
                                    bundle.getParcelable(
                                            "permission_sync_request", PermissionSyncRequest.class);
                    if (systemDataTransferRequest != null) {
                        ...
                        SystemDataTransferProcessor.this.mSystemDataTransferRequestStore
                                .writeRequest(
                                        systemDataTransferRequest.getUserId(),
    ...
    public SystemDataTransferProcessor(
                ...
                new IOnMessageReceivedListener() { // from class:
                    ...
                    public final void onMessageReceived(int i, final byte[] bArr) {
                        ...
                        if (!Build.isDebuggable()
                            ...
                            Slog.e(
                                    "CDM_SystemDataTransferProcessor",
                                    "Permissions restore is only available on watch.");
                            return;
                        }
                                ...
                                new FunctionalUtils
                                    ...
                                    public final void runOrThrow() {
                                        ...
                                        systemDataTransferProcessor2.mPermissionControllerManager
                                                .stageAndApplyRuntimePermissionsBackup(bArr, user);
                                    }
                                });
                    }
                });
        ...
        this.mCompanionDeviceDataTransferActivity =
                ComponentName.createRelative(
                        context.getString(R.string.csd_momentary_exposure_warning),
    ...
    public final PermissionSyncRequest getPermissionSyncRequest(int i) {
        Iterator it =
                ((ArrayList)
                                this.mSystemDataTransferRequestStore.readRequestsByAssociationId(
