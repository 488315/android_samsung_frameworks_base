...
public final class CompanionDeviceManagerService extends SystemService {
    ...
    public final class CompanionDeviceManagerImpl extends ICompanionDeviceManager.Stub {
        ...
        public final void addOnAssociationsChangedListener(
                IOnAssociationsChangedListener iOnAssociationsChangedListener, int i) {
            addOnAssociationsChangedListener_enforcePermission();
            PermissionsUtils.enforceCallerIsSystemOrCanInteractWithUserId(
                    CompanionDeviceManagerService.this.getContext(), i);
            AssociationStore associationStore =
                    CompanionDeviceManagerService.this.mAssociationStore;
            synchronized (associationStore.mRemoteListeners) {
                associationStore.mRemoteListeners.register(
                        iOnAssociationsChangedListener, Integer.valueOf(i));
            }
        }

        public final void addOnMessageReceivedListener(
                int i, IOnMessageReceivedListener iOnMessageReceivedListener) {
            addOnMessageReceivedListener_enforcePermission();
            CompanionDeviceManagerService.this.mTransportManager.addListener(
                    i, iOnMessageReceivedListener);
        }

        public final void addOnTransportsChangedListener(
                IOnTransportsChangedListener iOnTransportsChangedListener) {
        ...
        public final void applyRestoredPayload(byte[] bArr, int i) {
            CompanionDeviceManagerService.this.mBackupRestoreProcessor.applyRestoredPayload(
                    bArr, i);
        }
        ...
        */
        public final void associate(
                android.companion.AssociationRequest r19,
                android.companion.IAssociationRequestCallback r20,
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.companion.CompanionDeviceManagerService.CompanionDeviceManagerImpl.associate(android.companion.AssociationRequest,"
                        + " android.companion.IAssociationRequestCallback, java.lang.String,"
                        + " int):void");
        }
        ...
        public final void attachSystemDataTransport(
            ...
            CompanionTransportManager companionTransportManager =
                    CompanionDeviceManagerService.this.mTransportManager;
            companionTransportManager.getClass();
            Slog.i(
                    "CDM_CompanionTransportManager",
                    "Attaching transport for association id=[" + i2 + "]...");
        ...
        public final PendingIntent buildAssociationCancellationIntent(String str, int i) {
            Slog.i(
                    ...
                    "buildAssociationCancellationIntent() package=u" + i + "/" + str);
            PermissionsUtils.enforceCallerCanManageAssociationsForPackage(
                    i,
                    CompanionDeviceManagerService.this.getContext(),
                    str,
            ...
            PackageUtils.enforceUsesCompanionDeviceFeature(
                    associationRequestsProcessor.mContext, str, i);
            int packageUid =
                    associationRequestsProcessor.mPackageManagerInternal.getPackageUid(str, 0L, i);
            ...
            return (PendingIntent)
                    Binder.withCleanCallingIdentity(
                            new AssociationRequestsProcessor$$ExternalSyntheticLambda2(
                                    associationRequestsProcessor, packageUid, intent));
        }

        public final PendingIntent buildPermissionTransferUserConsentIntent(
                String str, int i, final int i2) {
            final SystemDataTransferProcessor systemDataTransferProcessor =
                    CompanionDeviceManagerService.this.mSystemDataTransferProcessor;
            if (PackageUtils.isPackageAllowlisted(
                    systemDataTransferProcessor.mContext,
                    systemDataTransferProcessor.mPackageManager,
                    str,
                    R.array.config_screenBrightnessNits,
                    R.array.config_screenBrightnessBacklight)) {
                Slog.i(
                        "CDM_SystemDataTransferProcessor",
                        "User consent Intent should be skipped. Returning null.");
                if (systemDataTransferProcessor.getPermissionSyncRequest(i2) == null) {
                    ...
                    systemDataTransferProcessor.mSystemDataTransferRequestStore.writeRequest(
                            i, permissionSyncRequest);
                }
                return null;
            }
            Slog.i(
                    ...
                    DualAppManagerService$$ExternalSyntheticOutline0.m(
                            i,
                            i2,
                            "Creating permission sync intent for userId [",
                            "] associationId [",
                            "]"));
            AssociationInfo associationWithCallerChecks =
                    systemDataTransferProcessor.mAssociationStore.getAssociationWithCallerChecks(
                            i2);
            Bundle bundle = new Bundle();
            ...
            bundle.putCharSequence(
                    "companion_device_name", associationWithCallerChecks.getDisplayName());
            Parcel obtain = Parcel.obtain();
            systemDataTransferProcessor.mOnSystemDataTransferRequestConfirmationReceiver
                    ...
                    Binder.withCleanCallingIdentity(
                            new FunctionalUtils
                                    .ThrowingSupplier() { // from class:
                                                          // com.android.server.companion.datatransfer.SystemDataTransferProcessor$$ExternalSyntheticLambda1
                                public final Object getOrThrow() {
                                    SystemDataTransferProcessor systemDataTransferProcessor2 =
                                            SystemDataTransferProcessor.this;
                                    return PendingIntent.getActivityAsUser(
                                            systemDataTransferProcessor2.mContext,
                                            i2,
                                            intent,
                                            1409286144,
        ...
        public final boolean canPairWithoutPrompt(String str, String str2, int i) {
            AssociationInfo firstAssociationByAddress =
                    CompanionDeviceManagerService.this.mAssociationStore
                            .getFirstAssociationByAddress(i, str, str2);
            return firstAssociationByAddress != null
                    && System.currentTimeMillis() - firstAssociationByAddress.getTimeApprovedMs()
                            < 600000;
        }
        ...
        public final void checkCanCallNotificationApi(int i, String str) {
                ...
                if (UserHandle.getCallingUserId() != i) {
                    throw new SecurityException(
                            DualAppManagerService$$ExternalSyntheticOutline0.m(
                                    ...
                                    i,
                                    "Calling UserId (",
                                    ") does not match the expected UserId (",
                                    ")"));
                }
                if (!PermissionsUtils.checkPackage(callingUid, str)) {
                    throw new SecurityException(
                            str + " doesn't belong to calling uid (" + callingUid + ")");
                }
            }
            ...
            PackageUtils.enforceUsesCompanionDeviceFeature(
                    CompanionDeviceManagerService.this.getContext(), str, i);
        ...
        public final void createAssociation(String str, String str2, int i, byte[] bArr) {
            ...
            if (!CompanionDeviceManagerService.this
                    .getContext()
                    .getPackageManager()
                    .hasSigningCertificate(str, bArr, 1)) {
                Slog.e(
                        "CDM_CompanionDeviceManagerService",
                        "Given certificate doesn't match the package certificate.");
            } else {
                CompanionDeviceManagerService.this.mAssociationRequestsProcessor.createAssociation(
                        i, str, MacAddress.fromString(str2), null, null, null, false, null, null);
            }
        }
        ...
        public final void disableSystemDataSync(int i, int i2) {
            AssociationStore associationStore =
                    CompanionDeviceManagerService.this
                            ...
                            .mAssociationStore;
            AssociationInfo associationWithCallerChecks =
                    associationStore.getAssociationWithCallerChecks(i);
            associationStore.updateAssociation(
                    new AssociationInfo.Builder(associationWithCallerChecks)
                            .setSystemDataSyncFlags(
                                    associationWithCallerChecks.getSystemDataSyncFlags() & (~i2))
                            .build());
        }
            ...
            if (DumpUtils.checkDumpAndUsageStatsPermission(
                ...
                if (associationStore.getActiveAssociations().isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        printWriter
                                .append("  ")
                                .append((CharSequence) ((AssociationInfo) it.next()).toString())
                                .append('\n');
                    }
                }
                DevicePresenceProcessor devicePresenceProcessor =
                        CompanionDeviceManagerService.this.mDevicePresenceProcessor;
                devicePresenceProcessor.getClass();
                printWriter.append("Companion Device Present: ");
                if (((HashSet) devicePresenceProcessor.mConnectedBtDevices).isEmpty()
                        && ((HashSet) devicePresenceProcessor.mNearbyBleDevices).isEmpty()
                        && ((HashSet) devicePresenceProcessor.mReportedSelfManagedDevices)
                                .isEmpty()) {
                    printWriter.append("<empty>\n");
                } else {
                    printWriter.append("\n");
                    ...
                    boolean isEmpty =
                            ((HashSet) devicePresenceProcessor.mConnectedBtDevices).isEmpty();
                    ...
                    if (isEmpty) {
                        ...
                        printWriter.append("\n");
                        Iterator it2 =
                                ((HashSet) devicePresenceProcessor.mConnectedBtDevices).iterator();
                        while (it2.hasNext()) {
                            printWriter
                                    .append("    ")
                                    .append(
                    ...
                    if (((HashSet) devicePresenceProcessor.mNearbyBleDevices).isEmpty()) {
                        ...
                        printWriter.append("\n");
                        Iterator it3 =
                                ((HashSet) devicePresenceProcessor.mNearbyBleDevices).iterator();
                        while (it3.hasNext()) {
                            printWriter
                                    .append("    ")
                                    .append(
                ...
                CompanionAppBinder companionAppBinder =
                        CompanionDeviceManagerService.this.mCompanionAppBinder;
                            ...
                            for (Map.Entry entry :
                                ...
                                printWriter
                                        ...
                                        .append(
                                                (CharSequence)
                                                        String.valueOf(
                                                                ((Pair) entry.getKey()).first))
                                        .append(", ")
                                        .append((CharSequence) ((Pair) entry.getKey()).second)
                                        .append(">");
                    ...
                    try {
                        if (((HashSet)
                            ...
                            while (it6.hasNext()) {
                                ...
                                printWriter
                                        .append("<u")
                                        .append((CharSequence) String.valueOf(pair.first))
                                        .append(", ")
                                        .append((CharSequence) pair.second)
                                        .append(">");
                            }
                        }
                    } finally {
                ...
                synchronized (companionTransportManager.mTransports) {
                    try {
                        ...
                        if (companionTransportManager.mTransports.size() == 0) {
                            ...
                            printWriter.append("\n");
                            for (int i2 = 0;
                                    i2 < companionTransportManager.mTransports.size();
                                    i2++) {
                                printWriter
                                        .append("  ")
                                        .append(
                ...
                SystemDataTransferRequestStore systemDataTransferRequestStore =
                        CompanionDeviceManagerService.this.mSystemDataTransferRequestStore;
                synchronized (systemDataTransferRequestStore.mLock) {
                    try {
                        ...
                        if (systemDataTransferRequestStore.mCachedPerUser.size() == 0) {
                            ...
                            printWriter.append("\n");
                            for (i = 0;
                                    i < systemDataTransferRequestStore.mCachedPerUser.size();
                                    i++) {
                                int keyAt = systemDataTransferRequestStore.mCachedPerUser.keyAt(i);
                                Iterator it7 =
                                        ((ArrayList)
                                                        systemDataTransferRequestStore
                                                                .mCachedPerUser.get(keyAt))
                                                .iterator();
                                while (it7.hasNext()) {
                                    printWriter
                                            .append("  u")
                                            .append((CharSequence) String.valueOf(keyAt))
                                            .append(" -> ")
                                            .append(
                                                    (CharSequence)
                                                            ((SystemDataTransferRequest) it7.next())
                                                                    .toString())
                                            .append('\n');
                                }
                            }
        ...
        public final List getAllAssociationsForUser(int i) {
            ...
            PermissionsUtils.enforceCallerIsSystemOrCanInteractWithUserId(
                    CompanionDeviceManagerService.this.getContext(), i);
            return i == -1
                    ? CompanionDeviceManagerService.this.mAssociationStore.getActiveAssociations()
                    : CompanionDeviceManagerService.this.mAssociationStore
        ...
        public final List getAssociations(String str, int i) {
            PermissionsUtils.enforceCallerCanManageAssociationsForPackage(
                    i, CompanionDeviceManagerService.this.getContext(), str, "get associations");
            return CompanionDeviceManagerService.this.mAssociationStore
                    .getActiveAssociationsByPackage(i, str);
        }
        ...
        public final PermissionSyncRequest getPermissionSyncRequest(int i) {
            return CompanionDeviceManagerService.this.mSystemDataTransferProcessor
        ...
        public final int handleShellCommand(
            ...
            return new CompanionDeviceShellCommand(
                            ...
                            companionDeviceManagerService.mAssociationStore,
                            companionDeviceManagerService.mDevicePresenceProcessor,
                            companionDeviceManagerService.mTransportManager,
                            companionDeviceManagerService.mSystemDataTransferProcessor,
                            companionDeviceManagerService.mAssociationRequestsProcessor,
                            companionDeviceManagerService.mBackupRestoreProcessor,
                            companionDeviceManagerService.mDisassociationProcessor)
                    .exec(
                            this,
        ...
        public final boolean hasNotificationAccess(ComponentName componentName) {
            checkCanCallNotificationApi(
                    UserHandle.getCallingUserId(), componentName.getPackageName());
        ...
        public final boolean isCompanionApplicationBound(String str, int i) {
            return CompanionDeviceManagerService.this.mCompanionAppBinder
                    .isCompanionApplicationBound(i, str);
        }

        public final boolean isDeviceAssociatedForWifiConnection(
                String str, final String str2, int i) {
            isDeviceAssociatedForWifiConnection_enforcePermission();
            if (CompanionDeviceManagerService.this
                            .getContext()
                            .getPackageManager()
                            .checkPermission(
                                    "android.permission.COMPANION_APPROVE_WIFI_CONNECTIONS", str)
                    == 0) {
                return true;
            }
            return CollectionUtils.any(
                    ...
                    new Predicate() { // from class:
                                      // com.android.server.companion.CompanionDeviceManagerService$CompanionDeviceManagerImpl$$ExternalSyntheticLambda1
        ...
        public final boolean isPermissionTransferUserConsented(String str, int i, int i2) {
            ...
            PermissionSyncRequest permissionSyncRequest =
                    systemDataTransferProcessor.getPermissionSyncRequest(i2);
        ...
        public final void legacyDisassociate(String str, String str2, int i) {
            ...
            AssociationInfo firstAssociationByAddress =
                    associationStore.getFirstAssociationByAddress(i, str2, str);
            if (firstAssociationByAddress == null) {
                throw new IllegalArgumentException(
                        XmlUtils$$ExternalSyntheticOutline0.m(
                                "Association for mac address=[", str, "] doesn't exist"));
            }
        ...
        public final void legacyStartObservingDevicePresence(String str, String str2, int i) {
            ...
            Slog.i(
                    ...
                    "Start observing device=["
                            ...
                            + "]...");
            PermissionsUtils.enforceCallerCanManageAssociationsForPackage(
                    i, devicePresenceProcessor.mContext, str2, null);
            AssociationInfo firstAssociationByAddress =
                    devicePresenceProcessor.mAssociationStore.getFirstAssociationByAddress(
                            i, str2, str);
            if (firstAssociationByAddress != null) {
                devicePresenceProcessor.startObservingDevicePresence(
                        new ObservingDevicePresenceRequest.Builder()
                                .setAssociationId(firstAssociationByAddress.getId())
                                .build(),
                        str2,
                        i,
                        true);
                ...
                StringBuilder m =
                        InitialConfiguration$$ExternalSyntheticOutline0.m(
                                "App ", str2, " is not associated with device ", str, " for user ");
                m.append(i);
        ...
        public final void legacyStopObservingDevicePresence(String str, String str2, int i) {
            ...
            AssociationInfo firstAssociationByAddress =
                    devicePresenceProcessor.mAssociationStore.getFirstAssociationByAddress(
                            i, str2, str);
            if (firstAssociationByAddress != null) {
                devicePresenceProcessor.stopObservingDevicePresence(
                        new ObservingDevicePresenceRequest.Builder()
                                .setAssociationId(firstAssociationByAddress.getId())
                                .build(),
                        str2,
        ...
        public final boolean removeBond(int i, String str, int i2) {
            ...
            DeviceIdleController$$ExternalSyntheticOutline0.m(
                    ArrayUtils$$ExternalSyntheticOutline0.m(
                            i, i2, "removeBond() associationId=", ", package=u", "/"),
                    str,
                    "CDM_CompanionDeviceManagerService");
            PermissionsUtils.enforceCallerCanManageAssociationsForPackage(
                    i2, CompanionDeviceManagerService.this.getContext(), str, "remove bonds");
            ...
            if (deviceMacAddress != null) {
                return ((BluetoothManager)
                        ...
                        .getAdapter()
                        .getRemoteDevice(deviceMacAddress.toString().toUpperCase())
                        .removeBond();
            }
            throw new IllegalArgumentException(
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            i, "Association id=[", "] doesn't have a device address."));
        }

        public final void removeOnAssociationsChangedListener(
                IOnAssociationsChangedListener iOnAssociationsChangedListener, int i) {
        ...
        public final void removeOnMessageReceivedListener(
                int i, IOnMessageReceivedListener iOnMessageReceivedListener) {
        ...
        public final void removeOnTransportsChangedListener(
                IOnTransportsChangedListener iOnTransportsChangedListener) {
            removeOnTransportsChangedListener_enforcePermission();
            CompanionTransportManager companionTransportManager =
                    CompanionDeviceManagerService.this.mTransportManager;
            synchronized (companionTransportManager.mTransportsListeners) {
                companionTransportManager.mTransportsListeners.unregister(
                        iOnTransportsChangedListener);
            }
        }

        public final PendingIntent requestNotificationAccess(
                final ComponentName componentName, final int i) {
                ...
                return (PendingIntent)
                        Binder.withCleanCallingIdentity(
                                new FunctionalUtils.ThrowingSupplier() { // from class:
                                    // com.android.server.companion.CompanionDeviceManagerService$CompanionDeviceManagerImpl$$ExternalSyntheticLambda0
                                    public final Object getOrThrow() {
                                        Intent launcherIntent;
                                        CompanionDeviceManagerService.CompanionDeviceManagerImpl
                                                companionDeviceManagerImpl =
                                                        CompanionDeviceManagerService
                                                                .CompanionDeviceManagerImpl.this;
                                        ...
                                        if (z) {
                                            launcherIntent =
                                                    NotificationAccessConfirmationActivityContract
                                                            .launcherIntent(
                                                                    CompanionDeviceManagerService
                                                                            .this
                                                                            .getContext(),
                                            ...
                                            Slog.e(
                                                    "CDM_CompanionDeviceManagerService",
                                                    "Side loaded app must enable restricted setting"
                                                        + " before request the notification"
                                                        + " access");
                                            if (!Flags.enhancedConfirmationModeApisEnabled()) {
                                                return null;
                                            }
                                                    ...
                                                    ((EnhancedConfirmationManager)
                                                                    CompanionDeviceManagerService
                                                                            ...
                                                                            .getSystemService(
                                                                                    EnhancedConfirmationManager
                                                                                            .class))
                                                            .createRestrictedSettingDialogIntent(
                                                                    str,
                                                                    "android:access_notifications");
                                        }
                                        return PendingIntent.getActivityAsUser(
        ...
        public final void setAssociationTag(int i, String str) {
            ...
            sb.append(i);
            DeviceIdleController$$ExternalSyntheticOutline0.m(
                    sb, "]...", "CDM_AssociationRequestsProcessor");
            AssociationStore associationStore = associationRequestsProcessor.mAssociationStore;
            associationStore.updateAssociation(
                    new AssociationInfo.Builder(associationStore.getAssociationWithCallerChecks(i))
                            .setTag(str)
                            .build());
        }

        public final void startObservingDevicePresence(
            ...
            CompanionDeviceManagerService.this.mDevicePresenceProcessor
                    .startObservingDevicePresence(observingDevicePresenceRequest, str, i, true);
        }

        public final void startSystemDataTransfer(
                String str,
                final int i,
                final int i2,
                final ISystemDataTransferCallback iSystemDataTransferCallback) {
            final SystemDataTransferProcessor systemDataTransferProcessor =
                    CompanionDeviceManagerService.this.mSystemDataTransferProcessor;
            systemDataTransferProcessor.getClass();
            Slog.i(
                    "CDM_SystemDataTransferProcessor",
                    "Start system data transfer for package ["
                            + str
                            + "] userId ["
                            + i
                            + "] associationId ["
            ...
            if (permissionSyncRequest != null && permissionSyncRequest.isUserConsented()) {
                Binder.withCleanCallingIdentity(
                        new FunctionalUtils.ThrowingRunnable() { // from class:
                            // com.android.server.companion.datatransfer.SystemDataTransferProcessor$$ExternalSyntheticLambda2
                            public final void runOrThrow() {
                                final SystemDataTransferProcessor systemDataTransferProcessor2 =
                                        SystemDataTransferProcessor.this;
                                int i3 = i;
                                final int i4 = i2;
                                final ISystemDataTransferCallback iSystemDataTransferCallback2 =
                                        iSystemDataTransferCallback;
                                systemDataTransferProcessor2.mPermissionControllerManager
                                        .getRuntimePermissionBackup(
                                                UserHandle.of(i3),
                                                systemDataTransferProcessor2.mExecutor,
                                                new Consumer() { // from class:
                                                    // com.android.server.companion.datatransfer.SystemDataTransferProcessor$$ExternalSyntheticLambda3
                                                    @Override // java.util.function.Consumer
                                                    public final void accept(Object obj) {
                                                        Future failedFuture;
                                                        SystemDataTransferProcessor
                                                                systemDataTransferProcessor3 =
                                                                        SystemDataTransferProcessor
                                                                                .this;
                                                        int i5 = i4;
                                                        ISystemDataTransferCallback
                                                                iSystemDataTransferCallback3 =
                                                                        iSystemDataTransferCallback2;
                                                        byte[] bArr = (byte[]) obj;
                                                        CompanionTransportManager
                                                                companionTransportManager =
                                                                        systemDataTransferProcessor3
                                                        ...
                                                        try {
                                                            try {
                                                                ...
                                                                if (iSystemDataTransferCallback3
                                                                        != null) {
                                                                    iSystemDataTransferCallback3
                                                                            .onResult();
                                                                }
            ...
            String m =
                    DualAppManagerService$$ExternalSyntheticOutline0.m(
                            ...
                            i2,
                            "User ",
                            " hasn't consented permission sync for associationId [",
                            ".");
        ...
        public final void stopObservingDevicePresence(
                ObservingDevicePresenceRequest observingDevicePresenceRequest, String str, int i) {
            stopObservingDevicePresence_enforcePermission();
            CompanionDeviceManagerService.this.mDevicePresenceProcessor.stopObservingDevicePresence(
                    observingDevicePresenceRequest, str, i, true);
        }
    }
    ...
    public final class LocalService {
        ...
        public final void registerCallMetadataSyncCallback(
                CrossDeviceSyncControllerCallback crossDeviceSyncControllerCallback, int i) {
            if (CompanionDeviceConfig.isEnabled()) {
                CrossDeviceSyncController crossDeviceSyncController =
                        CompanionDeviceManagerService.this.mCrossDeviceSyncController;
                crossDeviceSyncController.getClass();
                if (i != 2) {
                    if (i == 1) {
                        crossDeviceSyncController.mConnectionServiceCallbackRef =
                                new WeakReference(crossDeviceSyncControllerCallback);
                        return;
                    } else {
                        NandswapManager$$ExternalSyntheticOutline0.m(
                                i,
                                "Cannot register callback of unknown type: ",
                                "CrossDeviceSyncController");
                        return;
                    }
                }
                crossDeviceSyncController.mInCallServiceCallbackRef =
                        new WeakReference(crossDeviceSyncControllerCallback);
                Iterator it =
                        ((ArrayList) crossDeviceSyncController.mConnectedAssociations).iterator();
                while (it.hasNext()) {
                    AssociationInfo associationInfo = (AssociationInfo) it.next();
                    if (CrossDeviceSyncController.isAssociationBlocked(associationInfo)) {
                        ((HashSet) crossDeviceSyncController.mBlocklist)
                                .add(Integer.valueOf(associationInfo.getId()));
                    } else {
                        ((HashSet) crossDeviceSyncController.mBlocklist)
                                .remove(Integer.valueOf(associationInfo.getId()));
                        crossDeviceSyncControllerCallback.updateNumberOfActiveSyncAssociations(
                                associationInfo.getUserId(), true);
            ...
            if (CompanionDeviceConfig.isEnabled()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (associationInfo.getUserId() == i
                            && !CrossDeviceSyncController.isAssociationBlocked(associationInfo)) {
                ...
                if (hashSet.isEmpty()) {
                    ...
                    crossDeviceSyncController.mCompanionTransportManager.sendMessage(
                            1667729539,
                            bArr,
                            hashSet.stream()
    ...
    public static void m344$$Nest$monPackageRemoveOrDataClearedInternal(
            CompanionDeviceManagerService companionDeviceManagerService, int i, String str) {
        List associationsByPackage =
                companionDeviceManagerService.mAssociationStore.getAssociationsByPackage(i, str);
        if (!associationsByPackage.isEmpty()) {
            Slog.i(
                    "CDM_CompanionDeviceManagerService",
                    AccountManagerService$$ExternalSyntheticOutline0.m(
                            i,
                            "Package removed or data cleared for user=[",
                            "], package=[",
                            str,
                            "]. Cleaning up CDM data..."));
        }
        Iterator it = associationsByPackage.iterator();
        while (it.hasNext()) {
            companionDeviceManagerService.mDisassociationProcessor.disassociate(
                    ((AssociationInfo) it.next()).getId());
        }
        ObservableUuidStore observableUuidStore =
                companionDeviceManagerService.mObservableUuidStore;
        Iterator it2 =
                ((ArrayList) observableUuidStore.getObservableUuidsForPackage(i, str)).iterator();
        while (it2.hasNext()) {
            observableUuidStore.removeObservableUuid(i, ((ObservableUuid) it2.next()).mUuid, str);
        }
        CompanionAppBinder.CompanionServicesRegister companionServicesRegister =
                companionDeviceManagerService.mCompanionAppBinder.mCompanionServicesRegister;
    ...
    public CompanionDeviceManagerService(Context context) {
        ...
        this.mAssociationStoreChangeListener =
                new AssociationStore
                        .OnChangeListener() { // from class:
                                              // com.android.server.companion.CompanionDeviceManagerService.1
                    ...
                    public final void onAssociationChanged(int i, AssociationInfo associationInfo) {
                        Slog.d(
                                "CDM_CompanionDeviceManagerService",
                                "onAssociationChanged changeType=["
                                        + i
                                        + "], association=["
                                        + associationInfo);
                        ...
                        CompanionDeviceManagerService companionDeviceManagerService =
                                CompanionDeviceManagerService.this;
                        companionDeviceManagerService.updateAtm(
                                userId,
                                companionDeviceManagerService.mAssociationStore
                        ...
                        Intent intent = PackageUtils.COMPANION_SERVICE_INTENT;
                        Binder.withCleanCallingIdentity(
                                new CompanionDeviceManagerService$$ExternalSyntheticLambda1(
                                        companionDeviceManagerService,
                                        (PackageInfo)
                                                Binder.withCleanCallingIdentity(
                                                        new PackageUtils$$ExternalSyntheticLambda1(
        ...
        this.mPackageMonitor =
                new PackageMonitor() { // from class:
                                       // com.android.server.companion.CompanionDeviceManagerService.2
                    public final void onPackageAdded(String str, int i) {
                        List<AssociationInfo> filter;
                        CompanionDeviceManagerService companionDeviceManagerService =
                                CompanionDeviceManagerService.this;
                        int changingUserId = getChangingUserId();
                        final BackupRestoreProcessor backupRestoreProcessor =
                                companionDeviceManagerService.mBackupRestoreProcessor;
                        AssociationStore associationStore =
                                backupRestoreProcessor.mAssociationStore;
                        synchronized (associationStore.mLock) {
                            filter =
                                    CollectionUtils.filter(
                                            associationStore.getAssociations(),
                                            new AssociationStore$$ExternalSyntheticLambda7(
                                                    changingUserId, 0, str));
                        }
                        if (!filter.isEmpty()) {
                            BootReceiver$$ExternalSyntheticOutline0.m58m(
                                    "Found pending associations for package=[",
                                    str,
                                    "]. Restoring...",
                                    "CDM_BackupRestoreProcessor");
                        }
                        for (final AssociationInfo associationInfo : filter) {
                            final AssociationInfo build =
                                    new AssociationInfo.Builder(associationInfo)
                                            .setPending(false)
                                            .build();
                            RolesUtils.addRoleHolderForAssociation(
                                    backupRestoreProcessor.mContext,
                                    build,
                                    new Consumer() { // from class:
                                                     // com.android.server.companion.BackupRestoreProcessor$$ExternalSyntheticLambda0
                                        @Override // java.util.function.Consumer
                                        public final void accept(Object obj) {
                                            BackupRestoreProcessor backupRestoreProcessor2 =
                                                    BackupRestoreProcessor.this;
                                            ...
                                            backupRestoreProcessor2.mAssociationStore
                                                    .updateAssociation(associationInfo2);
                                            Slog.i(
                                                    "CDM_BackupRestoreProcessor",
                                                    "Association=["
                                                            + associationInfo3
                    ...
                    public final void onPackageDataCleared(String str, int i) {
                        CompanionDeviceManagerService
                                .m344$$Nest$monPackageRemoveOrDataClearedInternal(
                                        CompanionDeviceManagerService.this,
                                        getChangingUserId(),
                                        str);
                    }
                    ...
                    public final void onPackageModified(String str) {
                        ...
                        for (AssociationInfo associationInfo :
                                companionDeviceManagerService.mAssociationStore
                                        .getAssociationsByPackage(changingUserId, str)) {
                            int userId = associationInfo.getUserId();
                            String packageName = associationInfo.getPackageName();
                            Context context2 = companionDeviceManagerService.getContext();
                            Intent intent = PackageUtils.COMPANION_SERVICE_INTENT;
        ...
        AssociationStore associationStore =
                new AssociationStore(context, userManager, associationDiskStore);
        this.mAssociationStore = associationStore;
        SystemDataTransferRequestStore systemDataTransferRequestStore =
                new SystemDataTransferRequestStore();
        ...
        AssociationRequestsProcessor associationRequestsProcessor =
                new AssociationRequestsProcessor(context, packageManagerInternal, associationStore);
        this.mAssociationRequestsProcessor = associationRequestsProcessor;
        this.mBackupRestoreProcessor =
                new BackupRestoreProcessor(
                        context,
                        packageManagerInternal,
                        associationStore,
                        associationDiskStore,
                        systemDataTransferRequestStore,
        ...
        CompanionTransportManager companionTransportManager =
                new CompanionTransportManager(context, associationStore);
        this.mTransportManager = companionTransportManager;
        this.mDisassociationProcessor =
                new DisassociationProcessor(
                        ...
                        systemDataTransferRequestStore,
                        companionTransportManager);
        this.mSystemDataTransferProcessor =
                new SystemDataTransferProcessor(
                        this,
                        packageManagerInternal,
                        associationStore,
                        systemDataTransferRequestStore,
                        companionTransportManager);
        this.mCrossDeviceSyncController =
                new CrossDeviceSyncController(getContext(), companionTransportManager);
    }
    ...
    public final void exemptFromAutoRevoke(int i, String str) {
        try {
            ...
            Slog.w(
                    "CDM_CompanionDeviceManagerService",
                    "Error while granting auto revoke exemption for " + str,
                    e);
        }
    }
    ...
    public final void onBootPhase(int i) {
        ...
        if (i != 500) {
            if (i == 1000) {
                ...
                Slog.i(
                        ...
                        "Scheduling the Association Removal job");
                ((JobScheduler) context2.getSystemService(JobScheduler.class))
                        .forNamespace("companion")
                        .schedule(
                                new JobInfo.Builder(
                                                1,
                                                new ComponentName(
                                        ...
                                        .setPeriodic(
                                                InactiveAssociationsRemovalService.ONE_DAY_INTERVAL)
                                        .build());
                CrossDeviceSyncController crossDeviceSyncController =
                        this.mCrossDeviceSyncController;
                crossDeviceSyncController.getClass();
                if (CompanionDeviceConfig.isEnabled()) {
                    crossDeviceSyncController.mPhoneAccountManager.mTelecomManager
                            .clearPhoneAccounts();
                    TelecomManager telecomManager =
                            (TelecomManager)
                                    crossDeviceSyncController.mContext.getSystemService(
                                            TelecomManager.class);
                    if (telecomManager == null
                            || telecomManager.getCallCapablePhoneAccounts().size() == 0
                            ...
                            || (phoneAccount =
                                            telecomManager.getPhoneAccount(
                                                    defaultOutgoingPhoneAccount))
                                    == null
                            || phoneAccount.getLabel() == null) {
                        return;
                    }
                    ((ArrayList) crossDeviceSyncController.mCallFacilitators)
                            .add(
        ...
        BluetoothManager bluetoothManager =
                (BluetoothManager) context.getSystemService("bluetooth");
        ...
        BluetoothDeviceProcessor bluetoothDeviceProcessor =
                devicePresenceProcessor.mBluetoothDeviceProcessor;
        bluetoothDeviceProcessor.getClass();
        adapter.registerBluetoothConnectionCallback(
                new HandlerExecutor(Handler.getMain()), bluetoothDeviceProcessor);
        ...
        BleDeviceProcessor.AnonymousClass1 anonymousClass1 =
                bleDeviceProcessor.new AnonymousClass1();
    ...
    public final void onStart() {
        ...
        associationStore.getClass();
        Binder.withCleanCallingIdentity(
                new AssociationStore$$ExternalSyntheticLambda3(associationStore));
    ...
    public final void onUserUnlocked(SystemService.TargetUser targetUser) {
        ...
        this.mDevicePresenceProcessor.sendDevicePresenceEventOnUnlocked(
    ...
    public final void onUserUnlocking(SystemService.TargetUser targetUser) {
        ...
        List activeAssociationsByUser =
                this.mAssociationStore.getActiveAssociationsByUser(userIdentifier);
        ...
        BackgroundThread.getHandler()
                .sendMessageDelayed(
                        PooledLambda.obtainMessage(
                                new CompanionDeviceManagerService$$ExternalSyntheticLambda0(),
                                this),
    ...
    public final void updateAtm(int i, List list) {
        ...
        while (it.hasNext()) {
            int packageUid =
                    this.mPackageManagerInternal.getPackageUid(
                            ((AssociationInfo) it.next()).getPackageName(), 0L, i);
            if (packageUid >= 0) {
        ...
        if (activityTaskManagerInternal != null) {
            ...
            synchronized (windowManagerGlobalLock) {
                try {
                    ((ArrayMap) ActivityTaskManagerService.this.mCompanionAppUidsMap)
                            .put(Integer.valueOf(i), arraySet);
                } catch (Throwable th) {
