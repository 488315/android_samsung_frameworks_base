...
public final class DevicePresenceProcessor implements AssociationStore.OnChangeListener {
    ...
    public final BleDeviceDisappearedScheduler mSchedulerHelper =
            new BleDeviceDisappearedScheduler(this, 1);
    public final BleDeviceDisappearedScheduler mBleDeviceDisappearedScheduler =
        ...
        public final void handleMessage(Message message) {
            switch (this.$r8$classId) {
                case 0:
                    ...
                    synchronized (this.this$0.mBtDisconnectedDevices) {
                        try {
                            ...
                            if (((HashSet) this.this$0.mBtDisconnectedDevices)
                                ...
                                Slog.i(
                                        ...
                                        "Device ( "
                                                + i
                                                + " ) is likely BLE out of range, sending callback"
                                                + " with event ( 1 )");
                                DevicePresenceProcessor devicePresenceProcessor = this.this$0;
                                devicePresenceProcessor.onDevicePresenceEvent(
                                        devicePresenceProcessor.mNearbyBleDevices, i, 1);
                            }
                            ((HashSet) this.this$0.mBtDisconnectedDevices)
                ...
                default:
                    ...
                    if (((HashSet) devicePresenceProcessor2.mSimulated)
                            .contains(Integer.valueOf(i2))) {
                        devicePresenceProcessor2.onDevicePresenceEvent(
                                devicePresenceProcessor2.mSimulated, i2, 1);
                        return;
                    }
                    return;
            }
        ...
        public void unScheduleDeviceDisappeared(int i) {
            if (hasMessages(i)) {
                BootReceiver$$ExternalSyntheticOutline0.m(
                        i,
                        "unScheduleDeviceDisappeared for Device( ",
                        " )",
                        "CDM_DevicePresenceProcessor");
                synchronized (this.this$0.mBtDisconnectedDevices) {
    ...
    public DevicePresenceProcessor(
            Context context,
        ...
        this.mBluetoothDeviceProcessor =
                new BluetoothDeviceProcessor(associationStore, observableUuidStore, this);
    ...
    public final void bindApplicationIfNeeded(int i, String str, boolean z) {
        ...
        if (list.isEmpty()) {
            Slog.e(
                    ...
                    AccountManagerService$$ExternalSyntheticOutline0.m(
                            i,
                            "Can not bind companion applications u",
                            "/",
                            str,
        ...
        synchronized (companionAppBinder.mBoundCompanionApplications) {
            try {
                if (((HashMap) companionAppBinder.mBoundCompanionApplications)
                        .containsKey(new Pair(Integer.valueOf(i), str))) {
                ...
                ((HashMap) companionAppBinder.mBoundCompanionApplications)
                        .put(new Pair(Integer.valueOf(i), str), arrayList);
                Iterator it = arrayList.iterator();
                while (it.hasNext()) {
                    ((CompanionServiceConnector) it.next())
                            .setListener(devicePresenceProcessor$$ExternalSyntheticLambda0);
                }
            ...
            synchronized (this.mBtDisconnectedDevices) {
                try {
                    if (associationInfo.isNotifyOnDeviceNearby()) {
                        ...
                        Slog.i(
                                "CDM_DevicePresenceProcessor",
                                "The BLE scan cannot be stopped, device( "
                                        + id
                                        + " ) is not yet connected OR the BLE is not current"
                                        + " present Or is pending to report BLE lost");
                        return false;
                    }
                } finally {
                }
    ...
    public final void legacyNotifyDevicePresenceEvent(AssociationInfo associationInfo, boolean z) {
        Slog.i(
                "CDM_DevicePresenceProcessor",
                "legacyNotifyDevicePresenceEvent() association=["
                        + associationInfo.toShortString()
                        + "], isAppeared=["
                        + z
                        + "]");
        CompanionServiceConnector primaryServiceConnector =
                this.mCompanionAppBinder.getPrimaryServiceConnector(
                        associationInfo.getUserId(), associationInfo.getPackageName());
        if (primaryServiceConnector == null) {
            Slog.e("CDM_DevicePresenceProcessor", "Package is not bound.");
        } else if (z) {
            primaryServiceConnector.post(
                    new CompanionServiceConnector$$ExternalSyntheticLambda2(0, associationInfo));
        } else {
            primaryServiceConnector.post(
                    new CompanionServiceConnector$$ExternalSyntheticLambda2(1, associationInfo));
        }
    }

    public final void notifyDevicePresenceEvent(
            int i, String str, DevicePresenceEvent devicePresenceEvent) {
        StringBuilder m =
                DirEncryptService$$ExternalSyntheticOutline0.m(
                        i,
                        "notifyCompanionDevicePresenceEvent userId=[",
                        "], packageName=[",
                        str,
                        "], event=[");
        ...
        CompanionServiceConnector primaryServiceConnector =
                this.mCompanionAppBinder.getPrimaryServiceConnector(i, str);
        if (primaryServiceConnector == null) {
            Slog.e("CDM_DevicePresenceProcessor", "Package is NOT bound.");
        } else {
            primaryServiceConnector.post(
                    new CompanionServiceConnector$$ExternalSyntheticLambda2(devicePresenceEvent));
        }
    }

    public final void notifySelfManagedDevicePresenceEvent(int i, boolean z) {
        HermesService$3$$ExternalSyntheticOutline0.m(
                i, "notifySelfManagedDeviceAppeared() id=", "CDM_DevicePresenceProcessor");
        ...
        if (!associationWithCallerChecks.isSelfManaged()) {
            throw new IllegalArgumentException(
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            i, "Association id=[", "] is not self-managed."));
        }
        ...
        if ("android.app.role.SYSTEM_AUTOMOTIVE_PROJECTION".equals(deviceProfile)) {
            Slog.i(
                    "CDM_DevicePresenceProcessor",
                    "Enable hint mode for device device profile: " + deviceProfile);
    ...
    public final void onBleCompanionDeviceFound(int i, int i2) {
        BootReceiver$$ExternalSyntheticOutline0.m(
                i,
                "onBleCompanionDeviceFound associationId( ",
                " )",
                "CDM_DevicePresenceProcessor");
        ...
        synchronized (this.mBtDisconnectedDevices) {
            try {
                if (((HashSet) this.mBtDisconnectedDevices).contains(Integer.valueOf(i))) {
                    Slog.i(
                            "CDM_DevicePresenceProcessor",
                            "Device ( " + i + " ) is reconnected within 10s.");
                    this.mBleDeviceDisappearedScheduler.unScheduleDeviceDisappeared(i);
                }
                Slog.i(
                        "CDM_DevicePresenceProcessor",
                        "onBluetoothCompanionDeviceConnected: associationId( " + i + " )");
    ...
    public final void onBluetoothCompanionDeviceDisconnected(int i, int i2) {
        ...
        if (((HashSet) this.mNearbyBleDevices).contains(Integer.valueOf(i))) {
            ...
            BleDeviceDisappearedScheduler bleDeviceDisappearedScheduler =
                    this.mBleDeviceDisappearedScheduler;
            if (bleDeviceDisappearedScheduler.hasMessages(i)) {
                bleDeviceDisappearedScheduler.removeMessages(i);
            }
            BootReceiver$$ExternalSyntheticOutline0.m(
                    i,
                    "scheduleBleDeviceDisappeared for Device: ( ",
                    " ).",
                    "CDM_DevicePresenceProcessor");
    ...
    public final void onDeviceLocked(final int i, int i2, int i3, final ParcelUuid parcelUuid) {
                        ...
                        if (list != null) {
                            ...
                            list.removeIf(
                                    new Predicate() { // from class:
                                                      // com.android.server.companion.devicepresence.DevicePresenceProcessor$$ExternalSyntheticLambda1
                                            ...
                                            switch (i4) {
                                                case 0:
                                                    ...
                                                    DevicePresenceEvent devicePresenceEvent =
                                                            (DevicePresenceEvent) obj;
                                                    if (devicePresenceEvent.getEvent() != 0
                                                            || !Objects.equals(
                                                                    devicePresenceEvent.getUuid(),
                                                                    parcelUuid2)
                                                            || devicePresenceEvent
                                                                            .getAssociationId()
                                                                    != i5) {}
                                                ...
                                                default:
                                                    ...
                                                    int i6 = i;
                                                    DevicePresenceEvent devicePresenceEvent2 =
                                                            (DevicePresenceEvent) obj;
                                                    if (devicePresenceEvent2.getEvent() != 2
                                                            || !Objects.equals(
                                                                    devicePresenceEvent2.getUuid(),
                                                                    parcelUuid3)
                                                            || devicePresenceEvent2
                                                                            .getAssociationId()
                                                                    != i6) {}
                                                    break;
                                            }
            ...
            if (i3 != 2) {
                if (i3 != 3) {
                    FileDescriptorWatcher$FileDescriptorLeakWatcher$$ExternalSyntheticOutline0.m(
                            i3, "Event: ", "is not supported", "CDM_DevicePresenceProcessor");
                    return;
                }
                synchronized (this.mPendingDevicePresenceEvents) {
                    try {
        ...
        Slog.i(
                "CDM_DevicePresenceProcessor",
                "Current user is not in unlocking or unlocked stage yet. Notify the application"
    ...
    public final void onDevicePresenceEvent(Set set, int i, int i2) {
        Slog.i(
                ...
                DualAppManagerService$$ExternalSyntheticOutline0.m(
                        i, i2, "onDevicePresenceEvent() id=[", "], event=[", "]..."));
                ...
                try {
                    if (((HashSet) this.mBtDisconnectedDevices).contains(Integer.valueOf(i))) {
                        Slog.i(
                                ...
                                "Device ( "
                                        + i
                                        + " ) is present, do not need to send the callback with"
                                        + " event ( 0 ).");
    ...
    public final void onDevicePresenceEventByUuid(ObservableUuid observableUuid, int i) {
        Slog.i(
                "CDM_DevicePresenceProcessor",
                "onDevicePresenceEventByUuid ObservableUuid=["
                        + observableUuid
                        + "], event=["
                        + i
                        + "]...");
        ...
        if (i != 3) {
            FileDescriptorWatcher$FileDescriptorLeakWatcher$$ExternalSyntheticOutline0.m(
                    i, "Event: ", " is not supported", "CDM_DevicePresenceProcessor");
            return;
        }
        ...
        for (DevicePresenceEvent devicePresenceEvent : list) {
            if (devicePresenceEvent.getUuid() != null) {
                ...
                AssociationInfo associationById =
                        this.mAssociationStore.getAssociationById(
                                devicePresenceEvent.getAssociationId());
                if (associationById == null) {
                    return;
                }
                if (event == 0) {
                    ...
                    FileDescriptorWatcher$FileDescriptorLeakWatcher$$ExternalSyntheticOutline0.m(
                            event, "Event: ", "is not supported", "CDM_DevicePresenceProcessor");
                } else {
                    onBluetoothCompanionDeviceConnected(
                            associationById.getId(), associationById.getUserId());
                }
            }
        }
        synchronized (this.mPendingDevicePresenceEvents) {
    ...
    public final boolean shouldBindPackage(int i, String str) {
        List<AssociationInfo> activeAssociationsByPackage =
                this.mAssociationStore.getActiveAssociationsByPackage(i, str);
        List observableUuidsForPackage =
                this.mObservableUuidStore.getObservableUuidsForPackage(i, str);
        for (AssociationInfo associationInfo : activeAssociationsByPackage) {
            if (associationInfo.shouldBindWhenPresent()
                    && isDevicePresent(associationInfo.getId())) {
                return true;
            }
        }
        Iterator it = ((ArrayList) observableUuidsForPackage).iterator();
        while (it.hasNext()) {
            if (((HashSet) this.mConnectedUuidDevices)
                    .contains(((ObservableUuid) it.next()).mUuid)) {
                return true;
            }
        }
        return false;
    ...
    public final void simulateDeviceEvent(int i, int i2) {
        ...
        if (associationStore.getAssociationById(i) == null) {
            throw new IllegalArgumentException(
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            i, "Association with id ", " does not exist."));
        }
    ...
    public final void startObservingDevicePresence(
            ObservingDevicePresenceRequest observingDevicePresenceRequest,
            String str,
            int i,
            boolean z) {
        ...
        if (uuid != null) {
            ...
            if (this.mObservableUuidStore.isUuidBeingObserved(i, uuid, str)) {
                ...
                CustomizedBinderCallsStatsInternal$$ExternalSyntheticOutline0.m(
                        sb, i, "] is already being observed.", "CDM_DevicePresenceProcessor");
                return;
            }
            final ObservableUuid observableUuid =
                    new ObservableUuid(i, uuid, str, Long.valueOf(System.currentTimeMillis()));
            ObservableUuidStore observableUuidStore = this.mObservableUuidStore;
            observableUuidStore.getClass();
            Slog.i("CDM_ObservableUuidStore", "Writing uuid=[" + uuid + "] to store...");
            synchronized (observableUuidStore.mLock) {
                readObservableUuidsFromCache = observableUuidStore.readObservableUuidsFromCache(i);
                readObservableUuidsFromCache.removeIf(
                        new Predicate() { // from class:
                                          // com.android.server.companion.devicepresence.ObservableUuidStore$$ExternalSyntheticLambda4
                            @Override // java.util.function.Predicate
                            public final boolean test(Object obj) {
                                ObservableUuid observableUuid2 = ObservableUuid.this;
                                ObservableUuid observableUuid3 = (ObservableUuid) obj;
                                return observableUuid3.mUuid.equals(observableUuid2.mUuid)
                                        && observableUuid3.mPackageName.equals(
                                                observableUuid2.mPackageName);
                            }
                        });
                readObservableUuidsFromCache.add(observableUuid);
                observableUuidStore.mCachedPerUser.set(i, readObservableUuidsFromCache);
            }
            observableUuidStore.mExecutor.execute(
                    new ObservableUuidStore$$ExternalSyntheticLambda2(
                            observableUuidStore, i, readObservableUuidsFromCache, 1));
        } else {
            ...
            if (associationWithCallerChecks.isNotifyOnDeviceNearby()) {
                Slog.i(
                        ...
                        "Associated device id=["
                                + associationWithCallerChecks.getId()
                                + "] is already being observed. No-op.");
                return;
            }
            this.mAssociationStore.updateAssociation(
                    new AssociationInfo.Builder(associationWithCallerChecks)
            ...
            if (isDevicePresent(associationId)) {
                Slog.i(
                        "CDM_DevicePresenceProcessor",
                        "Device is already present. Triggering callback.");
                if (((HashSet) this.mNearbyBleDevices).contains(Integer.valueOf(associationId))) {
                    ...
                    if (((HashSet) this.mConnectedBtDevices)
                            .contains(Integer.valueOf(associationId))) {
    ...
    public final void stopObservingDevicePresence(
        ...
        if (uuid != null) {
            ...
            if (!observableUuidStore.isUuidBeingObserved(i, uuid, str)) {
                ...
                sb.append("], userId=[");
                CustomizedBinderCallsStatsInternal$$ExternalSyntheticOutline0.m(
                        sb, i, "] is already not being observed.", "CDM_DevicePresenceProcessor");
                return;
            }
            ...
            AssociationStore associationStore = this.mAssociationStore;
            AssociationInfo associationWithCallerChecks =
                    associationStore.getAssociationWithCallerChecks(associationId);
            if (!associationWithCallerChecks.isNotifyOnDeviceNearby()) {
                Slog.i(
                        "CDM_DevicePresenceProcessor",
                        "Associated device id=["
