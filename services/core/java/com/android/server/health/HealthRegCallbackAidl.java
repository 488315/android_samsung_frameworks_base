...
public class HealthRegCallbackAidl {
  ...
  public static void unregisterCallback(
      ISehHealth iSehHealth, ISehHealthInfoCallback iSehHealthInfoCallback) {
    ...
    try {
      ...
      Slog.w(
          "HealthRegCallbackAidl",
          "health: cannot unregister previous callback (transaction error): " + e.getMessage());
    }
  }
  ...
  public static void registerCallback(
    ...
    try {
      ...
      Slog.e(
          "HealthRegCallbackAidl",
          "health: cannot register callback, framework may cease to receive updates on health /"
              + " battery info!",
          e2);
    }
  }
