...
public class HealthServiceWrapperAidl extends HealthServiceWrapper {
    ...
    */
    public HealthServiceWrapperAidl(HealthRegCallbackAidl healthRegCallbackAidl, ServiceManagerStub serviceManagerStub) {
        ...
        try {
            ...
            Slog.d("HealthServiceWrapperAidl", "HealthServiceWrapperAidl: newService: " + waitForDeclaredService);
            ...
            try {
                if (allowBlocking != null) {
                    try {
                        ...
                        Slog.e("HealthServiceWrapperAidl", "Unable to register DeathRecipient for " + ((Object) null));
                    }
