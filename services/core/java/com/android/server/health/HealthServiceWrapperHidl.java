...
public final class HealthServiceWrapperHidl extends HealthServiceWrapper {
      ...
      switch (i) {
        case 1:
          iHealth.getChargeCounter(
              new IHealth
                  .getChargeCounterCallback() { // from class:
                ...
                public final void onValues(int i2, int i3) {
                  HealthServiceWrapperHidl.lambda$getProperty$0(
                      mutableInt, batteryProperty, i2, i3);
                }
              });
          break;
        case 2:
          iHealth.getCurrentNow(
              new IHealth
                  .getCurrentNowCallback() { // from class:
                                             // com.android.server.health.HealthServiceWrapperHidl$$ExternalSyntheticLambda1
                @Override // android.hardware.health.V2_0.IHealth.getCurrentNowCallback
                public final void onValues(int i2, int i3) {
                  HealthServiceWrapperHidl.lambda$getProperty$1(
                      mutableInt, batteryProperty, i2, i3);
                }
              });
          break;
        case 3:
          iHealth.getCurrentAverage(
              new IHealth
                  .getCurrentAverageCallback() { // from class:
                                                 // com.android.server.health.HealthServiceWrapperHidl$$ExternalSyntheticLambda2
                @Override // android.hardware.health.V2_0.IHealth.getCurrentAverageCallback
                public final void onValues(int i2, int i3) {
                  HealthServiceWrapperHidl.lambda$getProperty$2(
                      mutableInt, batteryProperty, i2, i3);
                }
              });
          break;
        case 4:
          iHealth.getCapacity(
              new IHealth
                  .getCapacityCallback() { // from class:
                                           // com.android.server.health.HealthServiceWrapperHidl$$ExternalSyntheticLambda3
                @Override // android.hardware.health.V2_0.IHealth.getCapacityCallback
                public final void onValues(int i2, int i3) {
                  HealthServiceWrapperHidl.lambda$getProperty$3(
                      mutableInt, batteryProperty, i2, i3);
                }
              });
          break;
        case 5:
          iHealth.getEnergyCounter(
              new IHealth
                  .getEnergyCounterCallback() { // from class:
                                                // com.android.server.health.HealthServiceWrapperHidl$$ExternalSyntheticLambda5
        ...
        case 6:
          iHealth.getChargeStatus(
              new IHealth
                  .getChargeStatusCallback() { // from class:
                                               // com.android.server.health.HealthServiceWrapperHidl$$ExternalSyntheticLambda4
                @Override // android.hardware.health.V2_0.IHealth.getChargeStatusCallback
                public final void onValues(int i2, int i3) {
                  HealthServiceWrapperHidl.lambda$getProperty$4(
                      mutableInt, batteryProperty, i2, i3);
                }
              });
          break;
  ...
  public static /* synthetic */ void lambda$getProperty$0(
      MutableInt mutableInt, BatteryProperty batteryProperty, int i, int i2) {
    mutableInt.value = i;
    if (i == 0) {
  ...
  public static /* synthetic */ void lambda$getProperty$1(
      MutableInt mutableInt, BatteryProperty batteryProperty, int i, int i2) {
    mutableInt.value = i;
    if (i == 0) {
      batteryProperty.setLong(i2);
  ...
  public static /* synthetic */ void lambda$getProperty$2(
      MutableInt mutableInt, BatteryProperty batteryProperty, int i, int i2) {
    mutableInt.value = i;
    if (i == 0) {
      batteryProperty.setLong(i2);
  ...
  public static /* synthetic */ void lambda$getProperty$3(
      MutableInt mutableInt, BatteryProperty batteryProperty, int i, int i2) {
    mutableInt.value = i;
    if (i == 0) {
      batteryProperty.setLong(i2);
  ...
  public static /* synthetic */ void lambda$getProperty$4(
      MutableInt mutableInt, BatteryProperty batteryProperty, int i, int i2) {
    mutableInt.value = i;
    if (i == 0) {
      batteryProperty.setLong(i2);
  ...
  public static /* synthetic */ void lambda$getProperty$5(
      MutableInt mutableInt, BatteryProperty batteryProperty, int i, long j) {
    mutableInt.value = i;
    if (i == 0) {
    ...
    getHandlerThread()
        ...
        .post(
            new Runnable() { // from class:
                             // com.android.server.health.HealthServiceWrapperHidl$$ExternalSyntheticLambda6
  ...
  public HealthInfo getHealthInfo() {
    ...
    iHealth.getHealthInfo(
        new IHealth
            .getHealthInfoCallback() { // from class:
                                       // com.android.server.health.HealthServiceWrapperHidl$$ExternalSyntheticLambda7
          ...
          public final void onValues(int i, android.hardware.health.V2_0.HealthInfo healthInfo) {
            HealthServiceWrapperHidl.lambda$getHealthInfo$7(
                HealthServiceWrapperHidl.Mutable.this, i, healthInfo);
          }
        });
    return (HealthInfo) mutable.value;
  }

  public static /* synthetic */ void lambda$getHealthInfo$7(
      Mutable mutable, int i, android.hardware.health.V2_0.HealthInfo healthInfo) {
    if (i == 0) {
  ...
  public HealthServiceWrapperHidl(
    ...
    if (str == null || iHealth == null) {
      throw new NoSuchElementException(
          String.format(
              "IHealth service instance %s isn't available. Perhaps no permission?", "default"));
    }
    if (callback != null) {
    ...
    try {
      iServiceManagerSupplier
          ...
          .registerForNotifications(
              "android.hardware.health@2.0::IHealth", this.mInstanceName, this.mNotification);
      traceEnd();
      Slog.i(
          "HealthServiceWrapperHidl",
          "health: HealthServiceWrapper listening to instance " + this.mInstanceName);
    } finally {
      traceEnd();
    }
  }
            ...
            .post(
                new Runnable() { // from class:
                  ...
                  public void run() {
                    try {
                      IHealth iHealth =
                          HealthServiceWrapperHidl.this.mHealthSupplier.get(
                              HealthServiceWrapperHidl.this.mInstanceName);
                      IHealth iHealth2 =
                          (IHealth) HealthServiceWrapperHidl.this.mLastService.getAndSet(iHealth);
                      ...
                      HealthServiceWrapperHidl.this.mCallback.onRegistration(
                          iHealth2, iHealth, HealthServiceWrapperHidl.this.mInstanceName);
