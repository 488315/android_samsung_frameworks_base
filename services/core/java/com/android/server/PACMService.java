                            ...
                            if (!isAutoBlocker() || PACMClassifier.hasAutoBlockerAttribute(command2)) {
                                ...
                                if (command2 == null) {
                                    if (isDevAndNoship() && !isForceTestUser()) {
                                        Slog.e("PACMSOCKET", "This command is unregistered. But it is temporarily allowed.");
                                    ...
                                    switch (command2.getType()) {
                                        case 161:
                                            ...
                                            if (1 != checkClassStatus(28)) {
                                                i3 = PACMClassifier.checkAttribute(command2, isSecureLock(), checkAtdDdex());
                                                if (i3 != 195 || !PACMService.mGalaxyDiag) {
                                                    if (i3 != 161) {
                                                        Slog.i("PACMSOCKET", "This Command is not USER_OPEN_AT_COMMAND because of attribute");
                                                        z = true;
                                                        break;
                                                    }
                                                } else {
                                                    Slog.i("PACMSOCKET", "This Command is now open becauese there is Galaxy Diag Tool");
                                                }
                                            }
                                            i3 = 161;
                                            break;
                                    ...
                                    if (i3 != 161 && isDevAndNoship() && !isForceTestUser()) {
                                        Slog.e("PACMSOCKET", "This command is be temporarily allowed. but it will be blocked");
                                        i3 = 161;
                                    }
                                }
                                checkClassStatus = i3;
