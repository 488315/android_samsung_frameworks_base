...
public class StatsPullAtomService extends SystemService {
      ...
      try {
        if (i == 10006) {
          synchronized (StatsPullAtomService.this.mBluetoothBytesTransferLock) {
            pullBluetoothBytesTransferLocked =
                StatsPullAtomService.this.pullBluetoothBytesTransferLocked(i, list);
          }
        ...
        if (i == 10007) {
          synchronized (StatsPullAtomService.this.mBluetoothActivityInfoLock) {
            pullBluetoothActivityInfoLocked =
                StatsPullAtomService.this.pullBluetoothActivityInfoLocked(i, list);
          }
          Trace.traceEnd(524288L);
        ...
        if (i == 10052) {
          synchronized (StatsPullAtomService.this.mTimeZoneDataInfoLock) {
            pullTimeZoneDataInfoLocked =
                StatsPullAtomService.this.pullTimeZoneDataInfoLocked(i, list);
          }
          Trace.traceEnd(524288L);
        ...
        if (i == 10053) {
          synchronized (StatsPullAtomService.this.mExternalStorageInfoLock) {
            pullExternalStorageInfoLocked =
                StatsPullAtomService.this.pullExternalStorageInfoLocked(i, list);
          }
          Trace.traceEnd(524288L);
        ...
        if (i == 10066) {
          synchronized (StatsPullAtomService.this.mNotificationRemoteViewsLock) {
            pullNotificationRemoteViewsLocked =
                StatsPullAtomService.this.pullNotificationRemoteViewsLocked(i, list);
          }
          Trace.traceEnd(524288L);
        ...
        if (i != 10067) {
          if (i == 10069) {
            synchronized (StatsPullAtomService.this.mRuntimeAppOpAccessMessageLock) {
              pullRuntimeAppOpAccessMessageLocked =
                  StatsPullAtomService.this.pullRuntimeAppOpAccessMessageLocked(i, list);
            }
            Trace.traceEnd(524288L);
            ...
            switch (i) {
              ...
              case 10004:
                synchronized (StatsPullAtomService.this.mKernelWakelockLock) {
                  pullKernelWakelockLocked =
                      StatsPullAtomService.this.pullKernelWakelockLocked(i, list);
                }
                Trace.traceEnd(524288L);
                ...
                switch (i) {
                  case FrameworkStatsLog.CPU_TIME_PER_UID /* 10009 */:
                    synchronized (StatsPullAtomService.this.mCpuTimePerUidLock) {
                      pullCpuTimePerUidLocked =
                          StatsPullAtomService.this.pullCpuTimePerUidLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                  ...
                  case FrameworkStatsLog.CPU_TIME_PER_UID_FREQ /* 10010 */:
                    synchronized (StatsPullAtomService.this.mCpuTimePerUidFreqLock) {
                      pullCpuTimePerUidFreqLocked =
                          StatsPullAtomService.this.pullCpuTimePerUidFreqLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                  ...
                  case FrameworkStatsLog.WIFI_ACTIVITY_INFO /* 10011 */:
                    synchronized (StatsPullAtomService.this.mWifiActivityInfoLock) {
                      pullWifiActivityInfoLocked =
                          StatsPullAtomService.this.pullWifiActivityInfoLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                  ...
                  case FrameworkStatsLog.MODEM_ACTIVITY_INFO /* 10012 */:
                    synchronized (StatsPullAtomService.this.mModemActivityInfoLock) {
                      pullModemActivityInfoLocked =
                          StatsPullAtomService.this.pullModemActivityInfoLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                  ...
                  case FrameworkStatsLog.PROCESS_MEMORY_STATE /* 10013 */:
                    synchronized (StatsPullAtomService.this.mProcessMemoryStateLock) {
                      pullProcessMemoryStateLocked =
                          StatsPullAtomService.this.pullProcessMemoryStateLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                  ...
                  case FrameworkStatsLog.SYSTEM_ELAPSED_REALTIME /* 10014 */:
                    synchronized (StatsPullAtomService.this.mSystemElapsedRealtimeLock) {
                      pullSystemElapsedRealtimeLocked =
                          StatsPullAtomService.this.pullSystemElapsedRealtimeLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                  ...
                  case FrameworkStatsLog.SYSTEM_UPTIME /* 10015 */:
                    synchronized (StatsPullAtomService.this.mSystemUptimeLock) {
                      pullSystemUptimeLocked =
                          StatsPullAtomService.this.pullSystemUptimeLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                  ...
                  case FrameworkStatsLog.CPU_ACTIVE_TIME /* 10016 */:
                    synchronized (StatsPullAtomService.this.mCpuActiveTimeLock) {
                      pullCpuActiveTimeLocked =
                          StatsPullAtomService.this.pullCpuActiveTimeLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                  ...
                  case FrameworkStatsLog.CPU_CLUSTER_TIME /* 10017 */:
                    synchronized (StatsPullAtomService.this.mCpuClusterTimeLock) {
                      pullCpuClusterTimeLocked =
                          StatsPullAtomService.this.pullCpuClusterTimeLocked(i, list);
                    }
                    Trace.traceEnd(524288L);
                    ...
                    switch (i) {
                      ...
                      case FrameworkStatsLog.BATTERY_VOLTAGE /* 10030 */:
                        synchronized (StatsPullAtomService.this.mHealthHalLock) {
                          pullHealthHalLocked =
                              StatsPullAtomService.this.pullHealthHalLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.TEMPERATURE /* 10021 */:
                        synchronized (StatsPullAtomService.this.mTemperatureLock) {
                          pullTemperatureLocked =
                              StatsPullAtomService.this.pullTemperatureLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.BINDER_CALLS /* 10022 */:
                        synchronized (StatsPullAtomService.this.mBinderCallsStatsLock) {
                          pullBinderCallsStatsLocked =
                              StatsPullAtomService.this.pullBinderCallsStatsLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.BINDER_CALLS_EXCEPTIONS /* 10023 */:
                        synchronized (StatsPullAtomService.this.mBinderCallsStatsExceptionsLock) {
                          pullBinderCallsStatsExceptionsLocked =
                              StatsPullAtomService.this.pullBinderCallsStatsExceptionsLocked(
                                  i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.LOOPER_STATS /* 10024 */:
                        synchronized (StatsPullAtomService.this.mLooperStatsLock) {
                          pullLooperStatsLocked =
                              StatsPullAtomService.this.pullLooperStatsLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.DISK_STATS /* 10025 */:
                        synchronized (StatsPullAtomService.this.mDiskStatsLock) {
                          pullDiskStatsLocked =
                              StatsPullAtomService.this.pullDiskStatsLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.DIRECTORY_USAGE /* 10026 */:
                        synchronized (StatsPullAtomService.this.mDirectoryUsageLock) {
                          pullDirectoryUsageLocked =
                              StatsPullAtomService.this.pullDirectoryUsageLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.CATEGORY_SIZE /* 10028 */:
                        synchronized (StatsPullAtomService.this.mCategorySizeLock) {
                          pullCategorySizeLocked =
                              StatsPullAtomService.this.pullCategorySizeLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.PROC_STATS /* 10029 */:
                        synchronized (StatsPullAtomService.this.mProcStatsLock) {
                          pullProcStatsLocked =
                              StatsPullAtomService.this.pullProcStatsLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.NUM_FINGERPRINTS_ENROLLED /* 10031 */:
                        synchronized (StatsPullAtomService.this.mNumBiometricsEnrolledLock) {
                          pullNumBiometricsEnrolledLocked =
                              StatsPullAtomService.this.pullNumBiometricsEnrolledLocked(1, i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.POWER_PROFILE /* 10033 */:
                        synchronized (StatsPullAtomService.this.mPowerProfileLock) {
                          pullPowerProfileLocked =
                              StatsPullAtomService.this.pullPowerProfileLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                        return pullPowerProfileLocked;
                      case FrameworkStatsLog.PROC_STATS_PKG_PROC /* 10034 */:
                        synchronized (StatsPullAtomService.this.mProcStatsLock) {
                          pullProcStatsLocked2 =
                              StatsPullAtomService.this.pullProcStatsLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.PROCESS_CPU_TIME /* 10035 */:
                        synchronized (StatsPullAtomService.this.mProcessCpuTimeLock) {
                          pullProcessCpuTimeLocked =
                              StatsPullAtomService.this.pullProcessCpuTimeLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.CPU_TIME_PER_THREAD_FREQ /* 10037 */:
                        synchronized (StatsPullAtomService.this.mCpuTimePerThreadFreqLock) {
                          pullCpuTimePerThreadFreqLocked =
                              StatsPullAtomService.this.pullCpuTimePerThreadFreqLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.DEVICE_CALCULATED_POWER_USE /* 10039 */:
                        synchronized (StatsPullAtomService.this.mDeviceCalculatedPowerUseLock) {
                          pullDeviceCalculatedPowerUseLocked =
                              StatsPullAtomService.this.pullDeviceCalculatedPowerUseLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                        return pullDeviceCalculatedPowerUseLocked;
                      case FrameworkStatsLog.PROCESS_MEMORY_SNAPSHOT /* 10064 */:
                        int pullProcessMemorySnapshot =
                            StatsPullAtomService.this.pullProcessMemorySnapshot(i, list);
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.ATTRIBUTED_APP_OPS /* 10075 */:
                        synchronized (StatsPullAtomService.this.mAttributedAppOpsLock) {
                          pullAttributedAppOpsLocked =
                              StatsPullAtomService.this.pullAttributedAppOpsLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.SETTING_SNAPSHOT /* 10080 */:
                        synchronized (StatsPullAtomService.this.mSettingsStatsLock) {
                          pullSettingsStatsLocked =
                              StatsPullAtomService.this.pullSettingsStatsLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.CPU_TIME_PER_CLUSTER_FREQ /* 10095 */:
                        synchronized (StatsPullAtomService.this.mCpuTimePerClusterFreqLock) {
                          pullCpuTimePerClusterFreqLocked =
                              StatsPullAtomService.this.pullCpuTimePerClusterFreqLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                        return pullCpuTimePerClusterFreqLocked;
                      case FrameworkStatsLog.CPU_CYCLES_PER_UID_CLUSTER /* 10096 */:
                        synchronized (StatsPullAtomService.this.mCpuTimePerUidFreqLock) {
                          pullCpuCyclesPerUidClusterLocked =
                              StatsPullAtomService.this.pullCpuCyclesPerUidClusterLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.CPU_CYCLES_PER_THREAD_GROUP_CLUSTER /* 10098 */:
                        int pullCpuCyclesPerThreadGroupCluster =
                            StatsPullAtomService.this.pullCpuCyclesPerThreadGroupCluster(i, list);
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.TIME_ZONE_DETECTOR_STATE /* 10102 */:
                        synchronized (StatsPullAtomService.this.mTimeZoneDetectionInfoLock) {
                          pullTimeZoneDetectorStateLocked =
                              StatsPullAtomService.this.pullTimeZoneDetectorStateLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.KEYSTORE2_CRASH_STATS /* 10125 */:
                        int pullKeystoreAtoms =
                            StatsPullAtomService.this.pullKeystoreAtoms(i, list);
                        Trace.traceEnd(524288L);
                        return pullKeystoreAtoms;
                      case FrameworkStatsLog.PROCESS_DMABUF_MEMORY /* 10105 */:
                        int pullProcessDmabufMemory =
                            StatsPullAtomService.this.pullProcessDmabufMemory(i, list);
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.INSTALLED_INCREMENTAL_PACKAGE /* 10114 */:
                        synchronized (StatsPullAtomService.this.mInstalledIncrementalPackagesLock) {
                          pullInstalledIncrementalPackagesLocked =
                              StatsPullAtomService.this.pullInstalledIncrementalPackagesLocked(
                                  i, list);
                        }
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.ACCESSIBILITY_SHORTCUT_STATS /* 10127 */:
                        int pullAccessibilityShortcutStatsLocked =
                            StatsPullAtomService.this.pullAccessibilityShortcutStatsLocked(i, list);
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.ACCESSIBILITY_FLOATING_MENU_STATS /* 10128 */:
                        int pullAccessibilityFloatingMenuStatsLocked =
                            StatsPullAtomService.this.pullAccessibilityFloatingMenuStatsLocked(
                                i, list);
                        Trace.traceEnd(524288L);
                        return pullAccessibilityFloatingMenuStatsLocked;
                      case FrameworkStatsLog.MEDIA_CAPABILITIES /* 10130 */:
                        int pullMediaCapabilitiesStats =
                            StatsPullAtomService.this.pullMediaCapabilitiesStats(i, list);
                        Trace.traceEnd(524288L);
                      ...
                      case FrameworkStatsLog.PINNED_FILE_SIZES_PER_PACKAGE /* 10150 */:
                        int pullSystemServerPinnerStats =
                            StatsPullAtomService.this.pullSystemServerPinnerStats(i, list);
                        Trace.traceEnd(524288L);
                        return pullSystemServerPinnerStats;
                      case FrameworkStatsLog.PENDING_INTENTS_PER_PACKAGE /* 10151 */:
                        int pullPendingIntentsPerPackage =
                            StatsPullAtomService.this.pullPendingIntentsPerPackage(i, list);
                        Trace.traceEnd(524288L);
                        return pullPendingIntentsPerPackage;
                      case FrameworkStatsLog.PROCESS_STATE /* 10171 */:
                        synchronized (StatsPullAtomService.this.mProcStatsLock) {
                          pullProcessStateLocked =
                              StatsPullAtomService.this.pullProcessStateLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                        return pullProcessStateLocked;
                      case FrameworkStatsLog.PROCESS_ASSOCIATION /* 10172 */:
                        synchronized (StatsPullAtomService.this.mProcStatsLock) {
                          pullProcessAssociationLocked =
                              StatsPullAtomService.this.pullProcessAssociationLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                        return pullProcessAssociationLocked;
                      case FrameworkStatsLog.HDR_CAPABILITIES /* 10175 */:
                        int pullHdrCapabilities =
                            StatsPullAtomService.this.pullHdrCapabilities(i, list);
                        Trace.traceEnd(524288L);
                        return pullHdrCapabilities;
                      case FrameworkStatsLog.UWB_ACTIVITY_INFO /* 10188 */:
                        synchronized (StatsPullAtomService.this.mUwbActivityInfoLock) {
                          pullUwbActivityInfoLocked =
                              StatsPullAtomService.this.pullUwbActivityInfoLocked(i, list);
                        }
                        Trace.traceEnd(524288L);
                        return pullUwbActivityInfoLocked;
                      case FrameworkStatsLog.CACHED_APPS_HIGH_WATERMARK /* 10189 */:
                        int pullCachedAppsHighWatermark =
                            StatsPullAtomService.this.pullCachedAppsHighWatermark(i, list);
                        Trace.traceEnd(524288L);
                      ...
                      default:
                        switch (i) {
                          case FrameworkStatsLog.PROCESS_MEMORY_HIGH_WATER_MARK /* 10042 */:
                            synchronized (
                                StatsPullAtomService.this.mProcessMemoryHighWaterMarkLock) {
                              pullProcessMemoryHighWaterMarkLocked =
                                  StatsPullAtomService.this.pullProcessMemoryHighWaterMarkLocked(
                                      i, list);
                            }
                            Trace.traceEnd(524288L);
                          ...
                          case FrameworkStatsLog.BUILD_INFORMATION /* 10044 */:
                            synchronized (StatsPullAtomService.this.mBuildInformationLock) {
                              pullBuildInformationLocked =
                                  StatsPullAtomService.this.pullBuildInformationLocked(i, list);
                            }
                            Trace.traceEnd(524288L);
                          ...
                          case FrameworkStatsLog.DEBUG_ELAPSED_CLOCK /* 10046 */:
                            synchronized (StatsPullAtomService.this.mDebugElapsedClockLock) {
                              pullDebugElapsedClockLocked =
                                  StatsPullAtomService.this.pullDebugElapsedClockLocked(i, list);
                            }
                            Trace.traceEnd(524288L);
                          ...
                          case FrameworkStatsLog.DEBUG_FAILING_ELAPSED_CLOCK /* 10047 */:
                            synchronized (StatsPullAtomService.this.mDebugFailingElapsedClockLock) {
                              pullDebugFailingElapsedClockLocked =
                                  StatsPullAtomService.this.pullDebugFailingElapsedClockLocked(
                                      i, list);
                            }
                            Trace.traceEnd(524288L);
                          ...
                          case FrameworkStatsLog.NUM_FACES_ENROLLED /* 10048 */:
                            synchronized (StatsPullAtomService.this.mNumBiometricsEnrolledLock) {
                              pullNumBiometricsEnrolledLocked2 =
                                  StatsPullAtomService.this.pullNumBiometricsEnrolledLocked(
                                      4, i, list);
                            }
                            Trace.traceEnd(524288L);
                          ...
                          case FrameworkStatsLog.ROLE_HOLDER /* 10049 */:
                            synchronized (StatsPullAtomService.this.mRoleHolderLock) {
                              pullRoleHolderLocked =
                                  StatsPullAtomService.this.pullRoleHolderLocked(i, list);
                            }
                            Trace.traceEnd(524288L);
                            ...
                            switch (i) {
                              case FrameworkStatsLog.SYSTEM_ION_HEAP_SIZE /* 10056 */:
                                synchronized (StatsPullAtomService.this.mSystemIonHeapSizeLock) {
                                  pullSystemIonHeapSizeLocked =
                                      StatsPullAtomService.this.pullSystemIonHeapSizeLocked(
                                          i, list);
                                }
                                Trace.traceEnd(524288L);
                              ...
                              case FrameworkStatsLog.APPS_ON_EXTERNAL_STORAGE_INFO /* 10057 */:
                                synchronized (
                                    StatsPullAtomService.this.mAppsOnExternalStorageInfoLock) {
                                  pullAppsOnExternalStorageInfoLocked =
                                      StatsPullAtomService.this.pullAppsOnExternalStorageInfoLocked(
                                          i, list);
                                }
                                Trace.traceEnd(524288L);
                              ...
                              case FrameworkStatsLog.FACE_SETTINGS /* 10058 */:
                                synchronized (StatsPullAtomService.this.mFaceSettingsLock) {
                                  pullFaceSettingsLocked =
                                      StatsPullAtomService.this.pullFaceSettingsLocked(i, list);
                                }
                                Trace.traceEnd(524288L);
                              ...
                              case FrameworkStatsLog.COOLING_DEVICE /* 10059 */:
                                synchronized (StatsPullAtomService.this.mCooldownDeviceLock) {
                                  pullCooldownDeviceLocked =
                                      StatsPullAtomService.this.pullCooldownDeviceLocked(i, list);
                                }
                                Trace.traceEnd(524288L);
                              ...
                              case FrameworkStatsLog.APP_OPS /* 10060 */:
                                synchronized (StatsPullAtomService.this.mAppOpsLock) {
                                  pullAppOpsLocked =
                                      StatsPullAtomService.this.pullAppOpsLocked(i, list);
                                }
                                Trace.traceEnd(524288L);
                                return pullAppOpsLocked;
                              case FrameworkStatsLog.PROCESS_SYSTEM_ION_HEAP_SIZE /* 10061 */:
                                synchronized (
                                    StatsPullAtomService.this.mProcessSystemIonHeapSizeLock) {
                                  pullProcessSystemIonHeapSizeLocked =
                                      StatsPullAtomService.this.pullProcessSystemIonHeapSizeLocked(
                                          i, list);
                                }
                                Trace.traceEnd(524288L);
          ...
          synchronized (StatsPullAtomService.this.mDataBytesTransferLock) {
            pullDataBytesTransferLocked =
                StatsPullAtomService.this.pullDataBytesTransferLocked(i, list);
          }
          Trace.traceEnd(524288L);
          return pullDataBytesTransferLocked;
        }
        synchronized (StatsPullAtomService.this.mDangerousPermissionStateLock) {
          pullDangerousPermissionStateLocked =
              StatsPullAtomService.this.pullDangerousPermissionStateLocked(i, list);
        }
        Trace.traceEnd(524288L);
  ...
  public void onBootPhase(int i) {
    ...
    if (i == 500) {
      BackgroundThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda0
      ...
      BackgroundThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
  ...
  public void initializePullersState() {
    ...
    this.mSubscriptionManager =
        (SubscriptionManager) this.mContext.getSystemService("telephony_subscription_service");
    ...
    this.mNetworkStatsManager =
        (NetworkStatsManager) this.mContext.getSystemService(NetworkStatsManager.class);
    ...
    this.mKernelCpuThreadReader =
        KernelCpuThreadReaderSettingsObserver.getSettingsModifiedReader(this.mContext);
    try {
    ...
    this.mSurfaceFlingerProcessCpuThreadReader =
  ...
  public void registerEventListeners() {
    ...
    ((ConnectivityManager) this.mContext.getSystemService("connectivity"))
        .registerNetworkCallback(
            new NetworkRequest.Builder().build(), new ConnectivityStatsCallback());
  ...
  public final void initAndRegisterNetworkStatsPullers() {
    ...
    this.mNetworkStatsBaselines.addAll(
        collectNetworkStatsSnapshotForAtom(FrameworkStatsLog.BYTES_TRANSFER_BY_TAG_AND_METERED));
    this.mNetworkStatsBaselines.addAll(
    ...
    this.mSubscriptionManager.addOnSubscriptionsChangedListener(
        BackgroundThread.getExecutor(), this.mStatsSubscriptionsListener);
  ...
  public final void initAndRegisterDeferredPullers() {
    this.mUwbManager =
        this.mContext.getPackageManager().hasSystemFeature("android.hardware.uwb")
            ? (UwbManager) this.mContext.getSystemService(UwbManager.class)
            : null;
                ...
                .linkToDeath(
                    new IBinder
                        .DeathRecipient() { // from class:
                                            // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda7
  ...
  public final IKeystoreMetrics getIKeystoreMetricsService() {
    ...
    synchronized (this.mKeystoreLock) {
      if (this.mIKeystoreMetrics == null) {
        IKeystoreMetrics asInterface =
            IKeystoreMetrics.Stub.asInterface(
          ...
          try {
            asInterface
                ...
                .linkToDeath(
                    new IBinder
                        .DeathRecipient() { // from class:
                                            // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda6
                      @Override // android.os.IBinder.DeathRecipient
                      public final void binderDied() {
        ...
        try {
          iStoraged
              ...
              .linkToDeath(
                  new IBinder
                      .DeathRecipient() { // from class:
                                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda21
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
  ...
  public final INotificationManager getINotificationManagerService() {
    synchronized (this.mNotificationStatsLock) {
      if (this.mNotificationManagerService == null) {
        this.mNotificationManagerService =
        ...
        try {
          iNotificationManager
              ...
              .linkToDeath(
                  new IBinder
                      .DeathRecipient() { // from class:
                                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda22
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
        ...
        try {
          iProcessStats
              ...
              .linkToDeath(
                  new IBinder
                      .DeathRecipient() { // from class:
                                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda25
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
  ...
  public final List collectNetworkStatsSnapshotForAtom(int i) {
    ...
    if (i == 10082) {
      ...
      NetworkStats uidNetworkStatsSnapshotForTemplate =
          getUidNetworkStatsSnapshotForTemplate(new NetworkTemplate.Builder(4).build(), true);
      NetworkStats uidNetworkStatsSnapshotForTemplate2 =
          getUidNetworkStatsSnapshotForTemplate(
              new NetworkTemplate.Builder(1).setMeteredness(1).build(), true);
      if (uidNetworkStatsSnapshotForTemplate != null
          && uidNetworkStatsSnapshotForTemplate2 != null) {
        arrayList.add(
            new NetworkStatsExt(
                sliceNetworkStatsByUidTagAndMetered(
                    uidNetworkStatsSnapshotForTemplate.add(uidNetworkStatsSnapshotForTemplate2)),
                new int[] {1, 0},
                false,
                true,
                true,
      ...
      switch (i) {
        case 10000:
          NetworkStats uidNetworkStatsSnapshotForTransport =
              getUidNetworkStatsSnapshotForTransport(1);
          if (uidNetworkStatsSnapshotForTransport != null) {
            arrayList.add(
                new NetworkStatsExt(
                    sliceNetworkStatsByUid(uidNetworkStatsSnapshotForTransport),
                    new int[] {1},
                    false));
            break;
          }
          break;
        case 10001:
          NetworkStats uidNetworkStatsSnapshotForTransport2 =
              getUidNetworkStatsSnapshotForTransport(1);
          if (uidNetworkStatsSnapshotForTransport2 != null) {
            arrayList.add(
                new NetworkStatsExt(
                    sliceNetworkStatsByUidAndFgbg(uidNetworkStatsSnapshotForTransport2),
                    new int[] {1},
                    true));
            break;
          }
          break;
        case 10002:
          NetworkStats uidNetworkStatsSnapshotForTransport3 =
              getUidNetworkStatsSnapshotForTransport(0);
          if (uidNetworkStatsSnapshotForTransport3 != null) {
            arrayList.add(
                new NetworkStatsExt(
                    sliceNetworkStatsByUid(uidNetworkStatsSnapshotForTransport3),
                    new int[] {0},
                    false));
            break;
          }
          break;
        case 10003:
          NetworkStats uidNetworkStatsSnapshotForTransport4 =
              getUidNetworkStatsSnapshotForTransport(0);
          if (uidNetworkStatsSnapshotForTransport4 != null) {
            arrayList.add(
                new NetworkStatsExt(
                    sliceNetworkStatsByUidAndFgbg(uidNetworkStatsSnapshotForTransport4),
                    new int[] {0},
                    true));
            break;
          }
  ...
  public final int pullDataBytesTransferLocked(int i, List list) {
    List<NetworkStatsExt> collectNetworkStatsSnapshotForAtom =
        collectNetworkStatsSnapshotForAtom(i);
    int i2 = 1;
    ...
    for (final NetworkStatsExt networkStatsExt : collectNetworkStatsSnapshotForAtom) {
      NetworkStatsExt networkStatsExt2 =
          (NetworkStatsExt)
              CollectionUtils.find(
                  this.mNetworkStatsBaselines,
                  new Predicate() { // from class:
                                    // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda8
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$pullDataBytesTransferLocked$7;
                      lambda$pullDataBytesTransferLocked$7 =
                          StatsPullAtomService.lambda$pullDataBytesTransferLocked$7(
                              NetworkStatsExt.this, (NetworkStatsExt) obj);
      ...
      NetworkStatsExt networkStatsExt3 =
          new NetworkStatsExt(
              removeEmptyEntries(networkStatsExt.stats.subtract(networkStatsExt2.stats)),
              networkStatsExt.transports,
              networkStatsExt.slicedByFgbg,
              networkStatsExt.slicedByTag,
              networkStatsExt.slicedByMetered,
              networkStatsExt.ratType,
              networkStatsExt.subInfo,
              networkStatsExt.oemManaged);
  ...
  public static /* synthetic */ boolean lambda$pullDataBytesTransferLocked$7(
      NetworkStatsExt networkStatsExt, NetworkStatsExt networkStatsExt2) {
  ...
  public static NetworkStats removeEmptyEntries(NetworkStats networkStats) {
    ...
    while (it.hasNext()) {
      ...
      if (entry.getRxBytes() != 0
          || entry.getRxPackets() != 0
          || entry.getTxBytes() != 0
          || entry.getTxPackets() != 0
          || entry.getOperations() != 0) {
  ...
  public final void addBytesTransferByTagAndMeteredAtoms(
      NetworkStatsExt networkStatsExt, List list) {
    Iterator it = networkStatsExt.stats.iterator();
    while (it.hasNext()) {
      NetworkStats.Entry entry = (NetworkStats.Entry) it.next();
      list.add(
  ...
  public final List getDataUsageBytesTransferSnapshotForOemManaged() {
    ...
    for (Pair pair : of) {
      ...
      while (i2 < i) {
        ...
        NetworkStats uidNetworkStatsSnapshotForTemplate =
            getUidNetworkStatsSnapshotForTemplate(
                new NetworkTemplate.Builder(num.intValue()).setOemManaged(i3).build(), false);
        Integer num2 = (Integer) pair.second;
        if (uidNetworkStatsSnapshotForTemplate != null) {
          arrayList.add(
              new NetworkStatsExt(
                  sliceNetworkStatsByUidAndFgbg(uidNetworkStatsSnapshotForTemplate),
                  new int[] {num2.intValue()},
                  true,
                  false,
                  false,
                  0,
  ...
  public final NetworkStats getUidNetworkStatsSnapshotForTemplate(
      NetworkTemplate networkTemplate, boolean z) {
    ...
    NetworkStats fromPublicNetworkStats =
        NetworkStatsUtils.fromPublicNetworkStats(
            this.mNetworkStatsManager.querySummary(networkTemplate, j2, millis));
    return !z
        ? fromPublicNetworkStats
        : fromPublicNetworkStats.add(
            NetworkStatsUtils.fromPublicNetworkStats(
                this.mNetworkStatsManager.queryTaggedSummary(networkTemplate, j2, millis)));
  }
  ...
  public final List getDataUsageBytesTransferSnapshotForSub(SubInfo subInfo) {
    ...
    while (i2 < length) {
      ...
      if (uidNetworkStatsSnapshotForTemplate != null) {
        arrayList.add(
            new NetworkStatsExt(
                sliceNetworkStatsByFgbg(uidNetworkStatsSnapshotForTemplate),
                new int[] {i},
                true,
                false,
                false,
  ...
  public final NetworkStats sliceNetworkStatsByUid(NetworkStats networkStats) {
    return sliceNetworkStats(
        networkStats,
        new Function() { // from class:
                         // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda4
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            NetworkStats.Entry lambda$sliceNetworkStatsByUid$8;
            lambda$sliceNetworkStatsByUid$8 =
                StatsPullAtomService.lambda$sliceNetworkStatsByUid$8((NetworkStats.Entry) obj);
            return lambda$sliceNetworkStatsByUid$8;
          }
        });
  }

  public static /* synthetic */ NetworkStats.Entry lambda$sliceNetworkStatsByUid$8(
  ...
  public final NetworkStats sliceNetworkStatsByFgbg(NetworkStats networkStats) {
    return sliceNetworkStats(
        networkStats,
        new Function() { // from class:
                         // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda2
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            NetworkStats.Entry lambda$sliceNetworkStatsByFgbg$9;
            lambda$sliceNetworkStatsByFgbg$9 =
                StatsPullAtomService.lambda$sliceNetworkStatsByFgbg$9((NetworkStats.Entry) obj);
            return lambda$sliceNetworkStatsByFgbg$9;
          }
        });
  }

  public static /* synthetic */ NetworkStats.Entry lambda$sliceNetworkStatsByFgbg$9(
      NetworkStats.Entry entry) {
    return new NetworkStats.Entry(
        (String) null,
        -1,
  ...
  public final NetworkStats sliceNetworkStatsByUidAndFgbg(NetworkStats networkStats) {
    return sliceNetworkStats(
        networkStats,
        new Function() { // from class:
                         // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda3
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            NetworkStats.Entry lambda$sliceNetworkStatsByUidAndFgbg$10;
            lambda$sliceNetworkStatsByUidAndFgbg$10 =
                StatsPullAtomService.lambda$sliceNetworkStatsByUidAndFgbg$10(
                    (NetworkStats.Entry) obj);
            return lambda$sliceNetworkStatsByUidAndFgbg$10;
          }
        });
  }

  public static /* synthetic */ NetworkStats.Entry lambda$sliceNetworkStatsByUidAndFgbg$10(
      NetworkStats.Entry entry) {
    return new NetworkStats.Entry(
        (String) null,
        entry.getUid(),
  ...
  public final NetworkStats sliceNetworkStatsByUidTagAndMetered(NetworkStats networkStats) {
    return sliceNetworkStats(
        networkStats,
        new Function() { // from class:
                         // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda5
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            NetworkStats.Entry lambda$sliceNetworkStatsByUidTagAndMetered$11;
            lambda$sliceNetworkStatsByUidTagAndMetered$11 =
                StatsPullAtomService.lambda$sliceNetworkStatsByUidTagAndMetered$11(
                    (NetworkStats.Entry) obj);
  ...
  public static /* synthetic */ NetworkStats.Entry lambda$sliceNetworkStatsByUidTagAndMetered$11(
      NetworkStats.Entry entry) {
    return new NetworkStats.Entry(
        (String) null,
        entry.getUid(),
  ...
  public final NetworkStats sliceNetworkStats(NetworkStats networkStats, Function function) {
    ...
    while (it.hasNext()) {
      networkStats2 =
          networkStats2.addEntry(
              (NetworkStats.Entry) function.apply((NetworkStats.Entry) it.next()));
    }
    return networkStats2;
  }
  ...
  public final void registerBluetoothBytesTransfer() {
    this.mStatsManager.setPullAtomCallback(
        ...
        new StatsManager.PullAtomMetadata.Builder().setAdditiveFields(new int[] {2, 3}).build(),
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
      ...
      defaultAdapter.requestControllerActivityEnergyInfo(
          ...
          new BluetoothAdapter
              .OnBluetoothActivityEnergyInfoCallback() { // from class:
                                                         // com.android.server.stats.pull.StatsPullAtomService.1
  ...
  public int pullBluetoothBytesTransferLocked(int i, List list) {
    ...
    for (UidTraffic uidTraffic : fetchBluetoothData.getUidTraffic()) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i, uidTraffic.getUid(), uidTraffic.getRxBytes(), uidTraffic.getTxBytes()));
    }
    return 0;
  }
  ...
  public int pullKernelWakelockLocked(int i, List list) {
    for (Map.Entry entry :
        this.mKernelWakelockReader.readKernelWakelockStats(this.mTmpWakelockStats).entrySet()) {
      String str = (String) entry.getKey();
      KernelWakelockStats.Entry entry2 = (KernelWakelockStats.Entry) entry.getValue();
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i, str, entry2.mCount, entry2.mVersion, entry2.mTotalTime));
    }
    return 0;
  }
  ...
  public final void registerCpuTimePerClusterFreq() {
    if (KernelCpuBpfTracking.isSupported()) {
      this.mStatsManager.setPullAtomCallback(
          FrameworkStatsLog.CPU_TIME_PER_CLUSTER_FREQ,
          new StatsManager.PullAtomMetadata.Builder().setAdditiveFields(new int[] {3}).build(),
          ConcurrentUtils.DIRECT_EXECUTOR,
          this.mStatsCallbackImpl);
    }
  }
  ...
  public int pullCpuTimePerUidLocked(final int i, final List list) {
    this.mCpuUidUserSysTimeReader.readAbsolute(
        new KernelCpuUidTimeReader
            .Callback() { // from class:
                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda23
  ...
  public static /* synthetic */ void lambda$pullCpuTimePerUidLocked$12(
      List list, int i, int i2, long[] jArr) {
  ...
  public final void registerCpuCyclesPerUidCluster() {
    if (KernelCpuBpfTracking.isSupported() || KernelCpuBpfTracking.getClusters() > 0) {
      this.mStatsManager.setPullAtomCallback(
          FrameworkStatsLog.CPU_CYCLES_PER_UID_CLUSTER,
          new StatsManager.PullAtomMetadata.Builder()
  ...
  public int pullCpuCyclesPerUidClusterLocked(int i, List list) {
    ...
    this.mCpuUidFreqTimeReader.readAbsolute(
        new KernelCpuUidTimeReader
            .Callback() { // from class:
                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda16
          public final void onUidCpuTime(int i6, Object obj) {
            StatsPullAtomService.lambda$pullCpuCyclesPerUidClusterLocked$13(
                sparseArray, clusters, freqsClusters, freqs, dArr, i6, (long[]) obj);
          }
        });
      ...
      for (int i7 = 0; i7 < clusters; i7++) {
        ...
        list.add(
            FrameworkStatsLog.buildStatsEvent(
                ...
                keyAt,
                i7,
                (long) (dArr2[i8] / 1000000.0d),
                (long) dArr2[i8 + 1],
                (long) (dArr2[i8 + 2] / 1000.0d)));
      }
    }
    return 0;
  }

  public static /* synthetic */ void lambda$pullCpuCyclesPerUidClusterLocked$13(
  ...
  public int pullCpuTimePerUidFreqLocked(int i, List list) {
    ...
    this.mCpuUidFreqTimeReader.readAbsolute(
        new KernelCpuUidTimeReader
            .Callback() { // from class:
                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda15
          public final void onUidCpuTime(int i2, Object obj) {
            StatsPullAtomService.lambda$pullCpuTimePerUidFreqLocked$14(
                sparseArray, i2, (long[]) obj);
          }
        });
    int size = sparseArray.size();
  ...
  public static /* synthetic */ void lambda$pullCpuTimePerUidFreqLocked$14(
      SparseArray sparseArray, int i, long[] jArr) {
  ...
  public final void registerCpuCyclesPerThreadGroupCluster() {
    if (KernelCpuBpfTracking.isSupported()) {
      this.mStatsManager.setPullAtomCallback(
          FrameworkStatsLog.CPU_CYCLES_PER_THREAD_GROUP_CLUSTER,
          new StatsManager.PullAtomMetadata.Builder().setAdditiveFields(new int[] {3, 4}).build(),
          ConcurrentUtils.DIRECT_EXECUTOR,
          this.mStatsCallbackImpl);
    }
  }
  ...
  public int pullCpuCyclesPerThreadGroupCluster(int i, List list) {
    ...
    addCpuCyclesPerThreadGroupClusterAtoms(
        i, list, 2, systemServiceCpuThreadTimes.threadCpuTimesUs);
    addCpuCyclesPerThreadGroupClusterAtoms(
        i, list, 1, systemServiceCpuThreadTimes.binderThreadCpuTimesUs);
    KernelSingleProcessCpuThreadReader.ProcessCpuUsage readAbsolute =
        this.mSurfaceFlingerProcessCpuThreadReader.readAbsolute();
  ...
  public final void registerCpuActiveTime() {
    this.mStatsManager.setPullAtomCallback(
        ...
        new StatsManager.PullAtomMetadata.Builder().setAdditiveFields(new int[] {2}).build(),
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }

  public int pullCpuActiveTimeLocked(final int i, final List list) {
    this.mCpuUidActiveTimeReader.readAbsolute(
        new KernelCpuUidTimeReader
            .Callback() { // from class:
                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda14
          public final void onUidCpuTime(int i2, Object obj) {
  ...
  public static /* synthetic */ void lambda$pullCpuActiveTimeLocked$15(
      List list, int i, int i2, Long l) {
  ...
  public int pullCpuClusterTimeLocked(final int i, final List list) {
    this.mCpuUidClusterTimeReader.readAbsolute(
        new KernelCpuUidTimeReader
            .Callback() { // from class:
                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda26
          public final void onUidCpuTime(int i2, Object obj) {
  ...
  public static /* synthetic */ void lambda$pullCpuClusterTimeLocked$16(
      List list, int i, int i2, long[] jArr) {
    for (int i3 = 0; i3 < jArr.length; i3++) {
  ...
  public int pullWifiActivityInfoLocked(int i, List list) {
    ...
    try {
      final SynchronousResultReceiver synchronousResultReceiver =
          new SynchronousResultReceiver("wifi");
      this.mWifiManager.getWifiActivityEnergyInfoAsync(
          new Executor() { // from class: com.android.server.stats.pull.StatsPullAtomService.2
          ...
          new WifiManager
              .OnWifiActivityEnergyInfoListener() { // from class:
                                                    // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda27
            public final void onWifiActivityEnergyInfo(
                WifiActivityEnergyInfo wifiActivityEnergyInfo) {
              StatsPullAtomService.lambda$pullWifiActivityInfoLocked$17(
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i,
              awaitControllerInfo.getTimeSinceBootMillis(),
              awaitControllerInfo.getStackState(),
              awaitControllerInfo.getControllerTxDurationMillis(),
              awaitControllerInfo.getControllerRxDurationMillis(),
              awaitControllerInfo.getControllerIdleDurationMillis(),
              awaitControllerInfo.getControllerEnergyUsedMicroJoules()));
  ...
  public static /* synthetic */ void lambda$pullWifiActivityInfoLocked$17(
      SynchronousResultReceiver synchronousResultReceiver,
      WifiActivityEnergyInfo wifiActivityEnergyInfo) {
    Bundle bundle = new Bundle();
    ...
    try {
      ...
      this.mTelephony.requestModemActivityInfo(
          ...
          new OutcomeReceiver() { // from class:
                                  // com.android.server.stats.pull.StatsPullAtomService.3
      ...
      ModemActivityInfo modemActivityInfo =
          (ModemActivityInfo) completableFuture.get(2000L, TimeUnit.MILLISECONDS);
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              ...
              modemActivityInfo.getTransmitDurationMillisAtPowerLevel(0),
              modemActivityInfo.getTransmitDurationMillisAtPowerLevel(1),
              modemActivityInfo.getTransmitDurationMillisAtPowerLevel(2),
              modemActivityInfo.getTransmitDurationMillisAtPowerLevel(3),
              modemActivityInfo.getTransmitDurationMillisAtPowerLevel(4),
  ...
  public int pullBluetoothActivityInfoLocked(int i, List list) {
    ...
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i,
            fetchBluetoothData.getTimestampMillis(),
            fetchBluetoothData.getBluetoothStackState(),
            fetchBluetoothData.getControllerTxTimeMillis(),
            fetchBluetoothData.getControllerRxTimeMillis(),
            fetchBluetoothData.getControllerIdleTimeMillis(),
            fetchBluetoothData.getControllerEnergyUsed()));
    return 0;
  }
  ...
  public final void registerUwbActivityInfo() {
    ...
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.UWB_ACTIVITY_INFO,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullUwbActivityInfoLocked(int i, List list) {
    ...
    try {
      final SynchronousResultReceiver synchronousResultReceiver =
          new SynchronousResultReceiver("uwb");
      this.mUwbManager.getUwbActivityEnergyInfoAsync(
          new SystemServerInitThreadPool$$ExternalSyntheticLambda1(),
          new Consumer() { // from class:
                           // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda17
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              StatsPullAtomService.lambda$pullUwbActivityInfoLocked$18(
                  synchronousResultReceiver, (UwbActivityEnergyInfo) obj);
            }
          });
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              ...
              awaitControllerInfo.getControllerRxDurationMillis(),
              awaitControllerInfo.getControllerIdleDurationMillis(),
              awaitControllerInfo.getControllerWakeCount()));
      Binder.restoreCallingIdentity(clearCallingIdentity);
      return 0;
    } catch (RuntimeException e) {
  ...
  public static /* synthetic */ void lambda$pullUwbActivityInfoLocked$18(
      SynchronousResultReceiver synchronousResultReceiver,
      UwbActivityEnergyInfo uwbActivityEnergyInfo) {
    Bundle bundle = new Bundle();
  ...
  public final void registerSystemElapsedRealtime() {
    this.mStatsManager.setPullAtomCallback(
        ...
        new StatsManager.PullAtomMetadata.Builder()
            .setCoolDownMillis(1000L)
            .setTimeoutMillis(500L)
            .build(),
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullProcessMemoryStateLocked(int i, List list) {
    for (ProcessMemoryState processMemoryState :
        ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
            .getMemoryStateForProcesses()) {
      MemoryStatUtil.MemoryStat readMemoryStatFromFilesystem =
          MemoryStatUtil.readMemoryStatFromFilesystem(
              processMemoryState.uid, processMemoryState.pid);
      if (readMemoryStatFromFilesystem != null) {
        list.add(
            FrameworkStatsLog.buildStatsEvent(
                i,
                processMemoryState.uid,
                processMemoryState.processName,
                processMemoryState.oomScore,
                readMemoryStatFromFilesystem.pgfault,
                readMemoryStatFromFilesystem.pgmajfault,
                readMemoryStatFromFilesystem.rssInBytes,
                readMemoryStatFromFilesystem.cacheInBytes,
                readMemoryStatFromFilesystem.swapInBytes,
                -1L,
                -1L,
                -1));
      }
  ...
  public int pullProcessMemoryHighWaterMarkLocked(int i, List list) {
    List<ProcessMemoryState> memoryStateForProcesses =
        ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
            .getMemoryStateForProcesses();
    for (ProcessMemoryState processMemoryState : memoryStateForProcesses) {
      ProcfsMemoryUtil.MemorySnapshot readMemorySnapshotFromProcfs =
          ProcfsMemoryUtil.readMemorySnapshotFromProcfs(processMemoryState.pid);
    ...
    memoryStateForProcesses.forEach(
        new Consumer() { // from class:
                         // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda24
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            StatsPullAtomService.lambda$pullProcessMemoryHighWaterMarkLocked$19(
                processCmdlines, (ProcessMemoryState) obj);
          }
        });
    int size = processCmdlines.size();
    for (int i4 = 0; i4 < size; i4++) {
      ProcfsMemoryUtil.MemorySnapshot readMemorySnapshotFromProcfs2 =
          ProcfsMemoryUtil.readMemorySnapshotFromProcfs(processCmdlines.keyAt(i4));
  ...
  public static /* synthetic */ void lambda$pullProcessMemoryHighWaterMarkLocked$19(
      SparseArray sparseArray, ProcessMemoryState processMemoryState) {
    sparseArray.delete(processMemoryState.pid);
  }

  public final void registerProcessMemorySnapshot() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.PROCESS_MEMORY_SNAPSHOT,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullProcessMemorySnapshot(int i, List list) {
      ...
      if (readMemorySnapshotFromProcfs != null) {
        ...
        list.add(
            FrameworkStatsLog.buildStatsEvent(
                ...
                processMemoryState.hasForegroundServices,
                readMemorySnapshotFromProcfs.rssShmemKilobytes,
                processMemoryState.mHostingComponentTypes,
                processMemoryState.mHistoricalHostingComponentTypes));
      }
    }
    final SparseArray processCmdlines = ProcfsMemoryUtil.getProcessCmdlines();
    memoryStateForProcesses.forEach(
        new Consumer() { // from class:
                         // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda12
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            StatsPullAtomService.lambda$pullProcessMemorySnapshot$20(
                processCmdlines, (ProcessMemoryState) obj);
          }
        });
    int size = processCmdlines.size();
    for (int i8 = 0; i8 < size; i8++) {
      ...
      ProcfsMemoryUtil.MemorySnapshot readMemorySnapshotFromProcfs2 =
          ProcfsMemoryUtil.readMemorySnapshotFromProcfs(keyAt);
      if (readMemorySnapshotFromProcfs2 != null) {
        ...
        list.add(
            FrameworkStatsLog.buildStatsEvent(
                ...
                i12,
                i11 + i12,
                sparseIntArray.get(keyAt),
                false,
                readMemorySnapshotFromProcfs2.rssShmemKilobytes,
                0,
                0));
      }
    }
  ...
  public static /* synthetic */ void lambda$pullProcessMemorySnapshot$20(
      SparseArray sparseArray, ProcessMemoryState processMemoryState) {
    sparseArray.delete(processMemoryState.pid);
  }
  ...
  public final void registerSystemIonHeapSize() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.SYSTEM_ION_HEAP_SIZE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullSystemIonHeapSizeLocked(int i, List list) {
    list.add(
        FrameworkStatsLog.buildStatsEvent(i, IonMemoryUtil.readSystemIonHeapSizeFromDebugfs()));
    return 0;
  }
  ...
  public final void registerIonHeapSize() {
    if (new File("/sys/kernel/ion/total_heaps_kb").exists()) {
      this.mStatsManager.setPullAtomCallback(
          FrameworkStatsLog.ION_HEAP_SIZE,
          (StatsManager.PullAtomMetadata) null,
          ConcurrentUtils.DIRECT_EXECUTOR,
          this.mStatsCallbackImpl);
    }
  ...
  public int pullProcessSystemIonHeapSizeLocked(int i, List list) {
    for (IonMemoryUtil.IonAllocations ionAllocations :
        IonMemoryUtil.readProcessSystemIonHeapSizesFromDebugfs()) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i,
              Process.getUidForPid(ionAllocations.pid),
              ProcfsMemoryUtil.readCmdlineFromProcfs(ionAllocations.pid),
              (int) (ionAllocations.totalSizeInBytes / 1024),
              ionAllocations.count,
              (int) (ionAllocations.maxSizeInBytes / 1024)));
    }
    return 0;
  }
  ...
  public final void registerProcessDmabufMemory() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.PROCESS_DMABUF_MEMORY,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullProcessDmabufMemory(int i, List list) {
    KernelAllocationStats.ProcessDmabuf[] dmabufAllocations =
    ...
    for (KernelAllocationStats.ProcessDmabuf processDmabuf : dmabufAllocations) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i,
              processDmabuf.uid,
              processDmabuf.processName,
              processDmabuf.oomScore,
              processDmabuf.retainedSizeKb,
              processDmabuf.retainedBuffersCount,
              0,
              0,
              processDmabuf.surfaceFlingerSizeKb,
              processDmabuf.surfaceFlingerCount));
    }
    return 0;
  }
  ...
  public final void registerSystemMemory() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.SYSTEM_MEMORY,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
      ...
      for (Temperature temperature : iThermalService.getCurrentTemperatures()) {
        list.add(
            FrameworkStatsLog.buildStatsEvent(
                ...
                temperature.getType(),
                temperature.getName(),
                (int) (temperature.getValue() * 10.0f),
                temperature.getStatus()));
      }
      return 0;
    } catch (RemoteException unused) {
      Slog.e(
          "StatsPullAtomService", "Disconnected from thermal service. Cannot pull temperatures.");
      return 1;
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
  ...
  public final void registerCoolingDevice() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.COOLING_DEVICE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
    ...
    try {
      for (CoolingDevice coolingDevice : iThermalService.getCurrentCoolingDevices()) {
        list.add(
            FrameworkStatsLog.buildStatsEvent(
                i,
                coolingDevice.getType(),
                coolingDevice.getName(),
                (int) coolingDevice.getValue()));
      }
      return 0;
    } catch (RemoteException unused) {
      Slog.e(
  ...
  public final void registerBinderCallsStats() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.BINDER_CALLS,
        new StatsManager.PullAtomMetadata.Builder()
  ...
  public int pullBinderCallsStatsLocked(int i, List list) {
    BinderCallsStatsService.Internal internal =
        (BinderCallsStatsService.Internal)
            LocalServices.getService(BinderCallsStatsService.Internal.class);
    if (internal == null) {
      Slog.e("StatsPullAtomService", "failed to get binderStats");
      return 1;
    }
    ArrayList<BinderCallsStats.ExportedCallStat> exportedCallStats =
        internal.getExportedCallStats();
    internal.reset();
    for (BinderCallsStats.ExportedCallStat exportedCallStat : exportedCallStats) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i,
              exportedCallStat.workSourceUid,
              exportedCallStat.className,
              exportedCallStat.methodName,
              exportedCallStat.callCount,
              exportedCallStat.exceptionCount,
              exportedCallStat.latencyMicros,
              exportedCallStat.maxLatencyMicros,
              exportedCallStat.cpuTimeMicros,
              exportedCallStat.maxCpuTimeMicros,
              exportedCallStat.maxReplySizeBytes,
              exportedCallStat.maxRequestSizeBytes,
              exportedCallStat.recordedCallCount,
              exportedCallStat.screenInteractive,
              exportedCallStat.callingUid));
    }
    return 0;
  }
  ...
  public int pullBinderCallsStatsExceptionsLocked(int i, List list) {
    ...
    while (it.hasNext()) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i, (String) ((Map.Entry) it.next()).getKey(), ((Integer) r0.getValue()).intValue()));
    }
    return 0;
  }
    ...
    for (LooperStats.ExportedEntry exportedEntry : entries) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              ...
              exportedEntry.messageCount,
              exportedEntry.exceptionCount,
              exportedEntry.recordedMessageCount,
              exportedEntry.totalLatencyMicros,
              exportedEntry.cpuUsageMicros,
              exportedEntry.isInteractive,
              exportedEntry.maxCpuUsageMicros,
              exportedEntry.maxLatencyMicros,
              exportedEntry.recordedDelayMessageCount,
              exportedEntry.delayMillis,
              exportedEntry.maxDelayMillis));
    }
    return 0;
  }
  ...
  */
  ...
  public final void registerDirectoryUsage() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.DIRECTORY_USAGE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullDirectoryUsageLocked(int i, List list) {
    ...
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i, 1, statFs.getAvailableBytes(), statFs.getTotalBytes()));
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i, 2, statFs3.getAvailableBytes(), statFs3.getTotalBytes()));
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i, 3, statFs2.getAvailableBytes(), statFs2.getTotalBytes()));
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i, 4, statFs4.getAvailableBytes(), statFs4.getTotalBytes()));
    return 0;
  }
  ...
  public int pullAppSizeLocked(int i, List list) {
    try {
      JSONObject jSONObject =
          new JSONObject(IoUtils.readFileAsString("/data/system/diskstats_cache.json"));
      ...
      if (jSONArray2.length() == length
          && jSONArray3.length() == length
          && jSONArray4.length() == length) {
        int i2 = 0;
        while (i2 < length) {
          list.add(
              FrameworkStatsLog.buildStatsEvent(
                  ...
                  jSONArray2.optLong(i2, -1L),
                  jSONArray3.optLong(i2, -1L),
                  jSONArray4.optLong(i2, -1L),
                  optLong));
          i2++;
  ...
  public final void registerCategorySize() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.CATEGORY_SIZE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullCategorySizeLocked(int i, List list) {
    try {
      ...
      long optLong = jSONObject.optLong("queryTime", -1L);
      list.add(
          FrameworkStatsLog.buildStatsEvent(i, 1, jSONObject.optLong("appSize", -1L), optLong));
      list.add(
          FrameworkStatsLog.buildStatsEvent(i, 2, jSONObject.optLong("appDataSize", -1L), optLong));
      list.add(
          FrameworkStatsLog.buildStatsEvent(i, 3, jSONObject.optLong("cacheSize", -1L), optLong));
      list.add(
          FrameworkStatsLog.buildStatsEvent(i, 4, jSONObject.optLong("photosSize", -1L), optLong));
      list.add(
          FrameworkStatsLog.buildStatsEvent(i, 5, jSONObject.optLong("videosSize", -1L), optLong));
      list.add(
          FrameworkStatsLog.buildStatsEvent(i, 6, jSONObject.optLong("audioSize", -1L), optLong));
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i, 7, jSONObject.optLong("downloadsSize", -1L), optLong));
      list.add(
          FrameworkStatsLog.buildStatsEvent(i, 8, jSONObject.optLong("systemSize", -1L), optLong));
      list.add(
          FrameworkStatsLog.buildStatsEvent(i, 9, jSONObject.optLong("otherSize", -1L), optLong));
      return 0;
    } catch (IOException | JSONException unused) {
  ...
  public final void registerNumFacesEnrolled() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.NUM_FACES_ENROLLED,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerProcessState() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.PROCESS_STATE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerProcessAssociation() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.PROCESS_ASSOCIATION,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final ProcessStats getStatsFromProcessStatsService(int i) {
    ...
    try {
      ...
      long committedStatsMerged =
          iProcessStatsService.getCommittedStatsMerged(
              readProcStatsHighWaterMark, 31, true, (List) null, processStats);
      new File(
              this.mBaseDir.getAbsolutePath()
                  + "/"
                  + highWaterMarkFilePrefix(i)
                  + "_"
                  + readProcStatsHighWaterMark)
          .delete();
      new File(
              this.mBaseDir.getAbsolutePath()
                  + "/"
  ...
  public final long readProcStatsHighWaterMark(final int i) {
    try {
      File[] listFiles =
          this.mBaseDir.listFiles(
              new FilenameFilter() { // from class:
                                     // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda10
                @Override // java.io.FilenameFilter
                public final boolean accept(File file, String str) {
                  boolean lambda$readProcStatsHighWaterMark$21;
                  lambda$readProcStatsHighWaterMark$21 =
                      StatsPullAtomService.this.lambda$readProcStatsHighWaterMark$21(i, file, str);
      ...
      if (listFiles != null && listFiles.length != 0) {
        if (listFiles.length > 1) {
          Slog.e(
              "StatsPullAtomService",
              "Only 1 file expected for high water mark. Found " + listFiles.length);
        }
  ...
  public int pullDiskIOLocked(final int i, final List list) {
    this.mStoragedUidIoStatsReader.readAbsolute(
        new StoragedUidIoStatsReader
            .Callback() { // from class:
                          // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda9
          public final void onUidStorageStats(
              int i2,
              long j,
              long j2,
              long j3,
              ...
              long j9,
              long j10) {
            StatsPullAtomService.lambda$pullDiskIOLocked$22(
                list, i, i2, j, j2, j3, j4, j5, j6, j7, j8, j9, j10);
          }
        });
    return 0;
  }

  public static /* synthetic */ void lambda$pullDiskIOLocked$22(
      List list,
      int i,
      int i2,
      long j,
  ...
  public final void registerProcessCpuTime() {
    this.mStatsManager.setPullAtomCallback(
        ...
        new StatsManager.PullAtomMetadata.Builder().setCoolDownMillis(5000L).build(),
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullProcessCpuTimeLocked(int i, List list) {
    ...
    for (int i2 = 0; i2 < this.mProcessCpuTracker.countStats(); i2++) {
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i, stats.uid, stats.name, stats.base_utime, stats.base_stime));
    }
    return 0;
  }
  ...
  public int pullCpuTimePerThreadFreqLocked(int i, List list) {
    ...
    if (cpuFrequenciesKhz.length > 8) {
      Slog.w(
          "StatsPullAtomService",
          "Expected maximum 8 frequencies, but got " + cpuFrequenciesKhz.length);
      return 1;
    }
    for (int i2 = 0; i2 < processCpuUsageDiffed.size(); i2++) {
      KernelCpuThreadReader.ProcessCpuUsage processCpuUsage =
          (KernelCpuThreadReader.ProcessCpuUsage) processCpuUsageDiffed.get(i2);
      ArrayList arrayList = processCpuUsage.threadCpuUsages;
      for (int i3 = 0; i3 < arrayList.size(); i3++) {
        KernelCpuThreadReader.ThreadCpuUsage threadCpuUsage =
            (KernelCpuThreadReader.ThreadCpuUsage) arrayList.get(i3);
        if (threadCpuUsage.usageTimesMillis.length != cpuFrequenciesKhz.length) {
          Slog.w(
              "StatsPullAtomService",
              "Unexpected number of usage times, expected "
                  + cpuFrequenciesKhz.length
                  + " but got "
                  + threadCpuUsage.usageTimesMillis.length);
          return 1;
        }
        int[] iArr = new int[8];
        int[] iArr2 = new int[8];
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              ...
              milliAmpHrsToNanoAmpSecs(
                  ((BatteryStatsManager) this.mContext.getSystemService(BatteryStatsManager.class))
  ...
  public final void registerDebugElapsedClock() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.DEBUG_ELAPSED_CLOCK,
        new StatsManager.PullAtomMetadata.Builder()
  ...
  public int pullDebugElapsedClockLocked(int i, List list) {
    ...
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i, this.mDebugElapsedClockPullCount, elapsedRealtime, elapsedRealtime, j2, 1));
  ...
  public final void registerDebugFailingElapsedClock() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.DEBUG_FAILING_ELAPSED_CLOCK,
        new StatsManager.PullAtomMetadata.Builder()
            .setAdditiveFields(new int[] {1, 2, 3, 4})
            .build(),
        ConcurrentUtils.DIRECT_EXECUTOR,
  ...
  public int pullDebugFailingElapsedClockLocked(int i, List list) {
    ...
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i, j2, elapsedRealtime, elapsedRealtime, j3 == 0 ? 0L : elapsedRealtime - j3));
    this.mDebugFailingElapsedClockPreviousValue = elapsedRealtime;
    return 0;
  }
  ...
  public int pullRoleHolderLocked(int i, List list) {
    ...
    try {
      ...
      RoleManagerLocal roleManagerLocal =
          (RoleManagerLocal) LocalManagerRegistry.getManager(RoleManagerLocal.class);
          ...
          for (String str2 : (Set) entry.getValue()) {
            try {
              list.add(
                  FrameworkStatsLog.buildStatsEvent(
                      i,
                      packageManager.getPackageInfoAsUser(str2, 0, identifier).applicationInfo.uid,
                      str2,
                      str));
  ...
  public int pullDangerousPermissionStateLocked(int i, List list) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    float f =
        DeviceConfig.getFloat("permissions", "dangerous_permission_state_sample_rate", 0.015f);
    HashSet hashSet = new HashSet();
    try {
      PackageManager packageManager = this.mContext.getPackageManager();
      List users = ((UserManager) this.mContext.getSystemService(UserManager.class)).getUsers();
      ...
      while (i6 < size) {
        ...
        List installedPackagesAsUser =
            packageManager.getInstalledPackagesAsUser(
                IInstalld.FLAG_USE_QUOTA, userHandle2.getIdentifier());
        ...
        while (i7 < size2) {
          ...
          if (packageInfo2.requestedPermissions != null
              && !hashSet.contains(Integer.valueOf(packageInfo2.applicationInfo.uid))) {
                  ...
                  try {
                    int permissionFlags =
                        packageManager.getPermissionFlags(
                            str, packageInfo2.packageName, userHandle2);
                    i2 = size2;
                    ...
                    if (i5 == 10050) {
                      ...
                      buildStatsEvent =
                          FrameworkStatsLog.buildStatsEvent(
                              ...
                              z,
                              permissionFlags,
                              permissionInfo.getProtection() | permissionInfo.getProtectionFlags());
                    } else {
                      packageInfo = packageInfo2;
                      list2 = installedPackagesAsUser;
                      userHandle = userHandle2;
                      ...
                      buildStatsEvent =
                          FrameworkStatsLog.buildStatsEvent(
                              ...
                              (packageInfo.requestedPermissionsFlags[i4] & 2) != 0,
                              permissionFlags,
                              permissionInfo.getProtection() | permissionInfo.getProtectionFlags());
                    }
                    list.add(buildStatsEvent);
  ...
  public final void registerTimeZoneDataInfo() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.TIME_ZONE_DATA_INFO,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerTimeZoneDetectorState() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.TIME_ZONE_DETECTOR_STATE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
    ...
    try {
      try {
        MetricsTimeZoneDetectorState generateMetricsState =
            ((TimeZoneDetectorInternal) LocalServices.getService(TimeZoneDetectorInternal.class))
                .generateMetricsState();
        list.add(
            FrameworkStatsLog.buildStatsEvent(
                i,
                generateMetricsState.isTelephonyDetectionSupported(),
                generateMetricsState.isGeoDetectionSupported(),
                generateMetricsState.getUserLocationEnabledSetting(),
                generateMetricsState.getAutoDetectionEnabledSetting(),
                generateMetricsState.getGeoDetectionEnabledSetting(),
                convertToMetricsDetectionMode(generateMetricsState.getDetectionMode()),
                generateMetricsState.getDeviceTimeZoneIdOrdinal(),
                convertTimeZoneSuggestionToProtoBytes(
                    generateMetricsState.getLatestManualSuggestion()),
                convertTimeZoneSuggestionToProtoBytes(
                    generateMetricsState.getLatestTelephonySuggestion()),
                convertTimeZoneSuggestionToProtoBytes(
                    generateMetricsState.getLatestGeolocationSuggestion()),
                generateMetricsState.isTelephonyTimeZoneFallbackSupported(),
                generateMetricsState.getDeviceTimeZoneId(),
                generateMetricsState.isEnhancedMetricsCollectionEnabled(),
                generateMetricsState.getGeoDetectionRunInBackgroundEnabled()));
        Binder.restoreCallingIdentity(clearCallingIdentity);
        return 0;
      } catch (RuntimeException e) {
  ...
  public static byte[] convertTimeZoneSuggestionToProtoBytes(
      MetricsTimeZoneDetectorState.MetricsTimeZoneSuggestion metricsTimeZoneSuggestion) {
  ...
  public final void registerExternalStorageInfo() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.EXTERNAL_STORAGE_INFO,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullAppsOnExternalStorageInfoLocked(int i, List list) {
    ...
    for (ApplicationInfo applicationInfo :
      ...
      if (uuid != null
          && (findVolumeByUuid = this.mStorageManager.findVolumeByUuid(uuid.toString())) != null
          && (disk = findVolumeByUuid.getDisk()) != null) {
        if (disk.isSd()) {
          i2 = 1;
        } else if (disk.isUsb()) {
          i2 = 2;
  ...
  public final void registerFaceSettings() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.FACE_SETTINGS,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerRuntimeAppOpAccessMessage() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.RUNTIME_APP_OP_ACCESS,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullAppOpsLocked(int i, List list) {
    ...
    try {
      ...
      appOpsManager.getHistoricalOps(
          new AppOpsManager.HistoricalOpsRequest.Builder(0L, Long.MAX_VALUE).setFlags(9).build(),
          AsyncTask.THREAD_POOL_EXECUTOR,
          new StatsPullAtomService$$ExternalSyntheticLambda11(completableFuture));
      if (sampleAppOps(
              list,
              processHistoricalOps(
                  (AppOpsManager.HistoricalOps) completableFuture.get(2000L, TimeUnit.MILLISECONDS),
                  i,
                  100),
              i,
              100)
        ...
        if (i5 == 10075) {
          ...
          buildStatsEvent =
              FrameworkStatsLog.buildStatsEvent(
                  i,
                  appOpEntry.mUid,
                  appOpEntry.mPackageName,
                  appOpEntry.mAttributionTag,
                  appOpEntry.mOp.getOpCode(),
                  appOpEntry.mOp.getForegroundAccessCount(9),
                  appOpEntry.mOp.getBackgroundAccessCount(9),
                  appOpEntry.mOp.getForegroundRejectCount(9),
                  appOpEntry.mOp.getBackgroundRejectCount(9),
                  appOpEntry.mOp.getForegroundAccessDuration(9),
                  appOpEntry.mOp.getBackgroundAccessDuration(9),
                  this.mDangerousAppOpsList.contains(Integer.valueOf(appOpEntry.mOp.getOpCode())),
                  i2);
        } else {
          i3 = i7;
          i4 = size;
  ...
  public final void registerAttributedAppOps() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.ATTRIBUTED_APP_OPS,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
    ...
    try {
      ...
      if (this.mAppOpsSamplingRate == 0) {
        this.mContext
            ...
            .postDelayed(
                new Runnable() { // from class: com.android.server.stats.pull.StatsPullAtomService.4
                  @Override // java.lang.Runnable
                  public void run() {
                    try {
      ...
      this.mAppOpsSamplingRate =
          Math.min(
              this.mAppOpsSamplingRate,
              sampleAppOps(
                  list,
                  processHistoricalOps(historicalOps, i, this.mAppOpsSamplingRate),
                  i,
                  this.mAppOpsSamplingRate));
      Binder.restoreCallingIdentity(clearCallingIdentity);
      return 0;
  ...
  public final void estimateAppOpsSamplingRate() {
    ...
    appOpsManager.getHistoricalOps(
        new AppOpsManager.HistoricalOpsRequest.Builder(
                Math.max(
                    Instant.now().minus(1L, (TemporalUnit) ChronoUnit.DAYS).toEpochMilli(), 0L),
                Long.MAX_VALUE)
            .setFlags(9)
            .build(),
        AsyncTask.THREAD_POOL_EXECUTOR,
        new StatsPullAtomService$$ExternalSyntheticLambda11(completableFuture));
    List processHistoricalOps =
        processHistoricalOps(
            (AppOpsManager.HistoricalOps) completableFuture.get(2000L, TimeUnit.MILLISECONDS),
            FrameworkStatsLog.ATTRIBUTED_APP_OPS,
            100);
      ...
      for (int i4 = 0; i4 < uidOpsAt.getPackageCount(); i4++) {
        ...
        if (i == 10075) {
          ...
          while (i5 < packageOpsAt.getAttributedOpsCount()) {
            int i6 = 0;
            for (AppOpsManager.AttributedHistoricalOps attributedOpsAt =
                    packageOpsAt.getAttributedOpsAt(i5);
                i6 < attributedOpsAt.getOpCount();
                attributedOpsAt = attributedOpsAt) {
              processHistoricalOp(
                  attributedOpsAt.getOpAt(i6),
                  arrayList,
                  uid,
                  i2,
                  packageOpsAt.getPackageName(),
                  attributedOpsAt.getTag());
              i6++;
              i5 = i5;
            }
            i5++;
          ...
          for (int i7 = 0; i7 < packageOpsAt.getOpCount(); i7++) {
            processHistoricalOp(
                packageOpsAt.getOpAt(i7), arrayList, uid, i2, packageOpsAt.getPackageName(), null);
          }
        }
      }
    }
  ...
  public final void processHistoricalOp(
      AppOpsManager.HistoricalOp historicalOp, List list, int i, int i2, String str, String str2) {
    int i3;
    ...
    AppOpEntry appOpEntry =
        new AppOpEntry(str, str2 == null ? null : str2.substring(i3), historicalOp, i);
  ...
  public int pullRuntimeAppOpAccessMessageLocked(int i, List list) {
    ...
    try {
      RuntimeAppOpAccessMessage collectRuntimeAppOpAccessMessage =
          ((AppOpsManager) this.mContext.getSystemService(AppOpsManager.class))
              .collectRuntimeAppOpAccessMessage();
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i,
              collectRuntimeAppOpAccessMessage.getUid(),
              collectRuntimeAppOpAccessMessage.getPackageName(),
              "",
              collectRuntimeAppOpAccessMessage.getAttributionTag() == null
                  ? ""
                  : collectRuntimeAppOpAccessMessage.getAttributionTag(),
              collectRuntimeAppOpAccessMessage.getMessage(),
              collectRuntimeAppOpAccessMessage.getSamplingStrategy(),
              AppOpsManager.strOpToOp(collectRuntimeAppOpAccessMessage.getOp())));
      return 0;
    } catch (Throwable th) {
      try {
  ...
  public static void unpackStreamedData(int i, List list, List list2) {
    ParcelFileDescriptor.AutoCloseInputStream autoCloseInputStream =
        new ParcelFileDescriptor.AutoCloseInputStream((ParcelFileDescriptor) list2.get(0));
    int[] iArr = new int[1];
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i, Arrays.copyOf(readFully(autoCloseInputStream, iArr), iArr[0])));
  }
  ...
  public static byte[] readFully(InputStream inputStream, int[] iArr) {
    ...
    while (true) {
      ...
      Slog.i(
          "StatsPullAtomService", "Read " + read + " bytes at " + i + " of avail " + bArr.length);
      if (read < 0) {
  ...
  public final void registerNotificationRemoteViews() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.NOTIFICATION_REMOTE_VIEWS,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullNotificationRemoteViewsLocked(int i, List list) {
    ...
    try {
      long currentTimeMicro =
          (SystemClock.currentTimeMicro() * 1000) - TimeUnit.NANOSECONDS.convert(1L, TimeUnit.DAYS);
      ArrayList arrayList = new ArrayList();
  ...
  public final void registerDangerousPermissionStateSampled() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.DANGEROUS_PERMISSION_STATE_SAMPLED,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerBatteryCycleCount() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.BATTERY_CYCLE_COUNT,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerSettingsStats() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.SETTING_SNAPSHOT,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerInstalledIncrementalPackages() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.INSTALLED_INCREMENTAL_PACKAGE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
        ...
        for (int i2 :
          ...
          for (PackageInfo packageInfo : packageManager.getInstalledPackagesAsUser(0, i2)) {
            if (IncrementalManager.isIncrementalPath(
                packageInfo.applicationInfo.getBaseCodePath())) {
              IncrementalStatesInfo incrementalStatesInfo =
                  packageManagerInternal.getIncrementalStatesInfo(
                      packageInfo.packageName, 1000, i2);
              list.add(
                  FrameworkStatsLog.buildStatsEvent(
                      i,
                      packageInfo.applicationInfo.uid,
                      incrementalStatesInfo.isLoading(),
                      incrementalStatesInfo.getLoadingCompletedTime()));
            }
          }
        }
        return 0;
  ...
  public final void registerAccessibilityFloatingMenuStats() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.ACCESSIBILITY_FLOATING_MENU_STATS,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerMediaCapabilitiesStats() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.MEDIA_CAPABILITIES,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int parseKeystoreKeyCreationWithGeneralInfo(KeystoreAtom[] keystoreAtomArr, List list) {
    for (KeystoreAtom keystoreAtom : keystoreAtomArr) {
      ...
      KeyCreationWithGeneralInfo keyCreationWithGeneralInfo =
          keystoreAtom.payload.getKeyCreationWithGeneralInfo();
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              FrameworkStatsLog.KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO,
              keyCreationWithGeneralInfo.algorithm,
              keyCreationWithGeneralInfo.key_size,
              keyCreationWithGeneralInfo.ec_curve,
              keyCreationWithGeneralInfo.key_origin,
              keyCreationWithGeneralInfo.error_code,
              keyCreationWithGeneralInfo.attestation_requested,
              keystoreAtom.count));
    }
    return 0;
  }
  ...
  public int parseKeystoreKeyCreationWithAuthInfo(KeystoreAtom[] keystoreAtomArr, List list) {
    for (KeystoreAtom keystoreAtom : keystoreAtomArr) {
      ...
      KeyCreationWithAuthInfo keyCreationWithAuthInfo =
          keystoreAtom.payload.getKeyCreationWithAuthInfo();
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              FrameworkStatsLog.KEYSTORE2_KEY_CREATION_WITH_AUTH_INFO,
              keyCreationWithAuthInfo.user_auth_type,
              keyCreationWithAuthInfo.log10_auth_key_timeout_seconds,
              keyCreationWithAuthInfo.security_level,
              keystoreAtom.count));
    }
    return 0;
  }

  public int parseKeystoreKeyCreationWithPurposeModesInfo(
      KeystoreAtom[] keystoreAtomArr, List list) {
    for (KeystoreAtom keystoreAtom : keystoreAtomArr) {
      if (keystoreAtom.payload.getTag() != 3) {
        return 1;
      }
      KeyCreationWithPurposeAndModesInfo keyCreationWithPurposeAndModesInfo =
          keystoreAtom.payload.getKeyCreationWithPurposeAndModesInfo();
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              FrameworkStatsLog.KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO,
              keyCreationWithPurposeAndModesInfo.algorithm,
              keyCreationWithPurposeAndModesInfo.purpose_bitmap,
              keyCreationWithPurposeAndModesInfo.padding_mode_bitmap,
              keyCreationWithPurposeAndModesInfo.digest_bitmap,
              keyCreationWithPurposeAndModesInfo.block_mode_bitmap,
              keystoreAtom.count));
    }
    return 0;
  }
  ...
  public int parseKeystoreAtomWithOverflow(KeystoreAtom[] keystoreAtomArr, List list) {
    for (KeystoreAtom keystoreAtom : keystoreAtomArr) {
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              FrameworkStatsLog.KEYSTORE2_ATOM_WITH_OVERFLOW,
              keystoreAtom.payload.getKeystore2AtomWithOverflow().atom_id,
              keystoreAtom.count));
    }
    return 0;
  }

  public int parseKeystoreKeyOperationWithPurposeModesInfo(
      KeystoreAtom[] keystoreAtomArr, List list) {
    for (KeystoreAtom keystoreAtom : keystoreAtomArr) {
      ...
      KeyOperationWithPurposeAndModesInfo keyOperationWithPurposeAndModesInfo =
          keystoreAtom.payload.getKeyOperationWithPurposeAndModesInfo();
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              FrameworkStatsLog.KEYSTORE2_KEY_OPERATION_WITH_PURPOSE_AND_MODES_INFO,
              keyOperationWithPurposeAndModesInfo.purpose,
              keyOperationWithPurposeAndModesInfo.padding_mode_bitmap,
              keyOperationWithPurposeAndModesInfo.digest_bitmap,
              keyOperationWithPurposeAndModesInfo.block_mode_bitmap,
              keystoreAtom.count));
    }
    return 0;
  }
  ...
  public int parseKeystoreKeyOperationWithGeneralInfo(KeystoreAtom[] keystoreAtomArr, List list) {
    for (KeystoreAtom keystoreAtom : keystoreAtomArr) {
      ...
      KeyOperationWithGeneralInfo keyOperationWithGeneralInfo =
          keystoreAtom.payload.getKeyOperationWithGeneralInfo();
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              FrameworkStatsLog.KEYSTORE2_KEY_OPERATION_WITH_GENERAL_INFO,
              keyOperationWithGeneralInfo.outcome,
              keyOperationWithGeneralInfo.error_code,
              keyOperationWithGeneralInfo.key_upgraded,
              keyOperationWithGeneralInfo.security_level,
              keystoreAtom.count));
    }
    return 0;
  }
  ...
  public int parseRkpErrorStats(KeystoreAtom[] keystoreAtomArr, List list) {
    for (KeystoreAtom keystoreAtom : keystoreAtomArr) {
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              FrameworkStatsLog.RKP_ERROR_STATS,
              rkpErrorStats.rkpError,
              keystoreAtom.count,
              rkpErrorStats.security_level));
    }
    return 0;
  }
  ...
  public int parseKeystoreCrashStats(KeystoreAtom[] keystoreAtomArr, List list) {
    for (KeystoreAtom keystoreAtom : keystoreAtomArr) {
      ...
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              FrameworkStatsLog.KEYSTORE2_CRASH_STATS,
              keystoreAtom.payload.getCrashStats().count_of_crash_events));
    }
    return 0;
  }
      ...
      while (it.hasNext()) {
        ...
        if (isAccessibilityShortcutUser(this.mContext, identifier)) {
          list.add(
              FrameworkStatsLog.buildStatsEvent(
                  i,
                  convertToAccessibilityShortcutType(
                      Settings.Secure.getIntForUser(
                          contentResolver, "accessibility_button_mode", 0, identifier)),
                  countAccessibilityServices(
                      Settings.Secure.getStringForUser(
                          contentResolver, "accessibility_button_targets", identifier)),
                  2,
                  countAccessibilityServices(
                      Settings.Secure.getStringForUser(
                          contentResolver, "accessibility_shortcut_target_service", identifier)),
                  3,
                  Settings.Secure.getIntForUser(
                      contentResolver,
        ...
        if (isAccessibilityFloatingMenuUser(this.mContext, identifier)) {
          list.add(
              FrameworkStatsLog.buildStatsEvent(
                  i,
                  Settings.Secure.getIntForUser(
                      contentResolver, "accessibility_floating_menu_size", 0, identifier),
                  Settings.Secure.getIntForUser(
                      contentResolver, "accessibility_floating_menu_icon_type", 0, identifier),
                  Settings.Secure.getIntForUser(
                          contentResolver,
                  ...
                  Settings.Secure.getFloatForUser(
                      contentResolver, "accessibility_floating_menu_opacity", 0.55f, identifier)));
        }
      }
    } catch (RuntimeException e) {
      Slog.e(
          "StatsPullAtomService",
          "pulling accessibility floating menu stats failed at getUsers",
          e);
      return 1;
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public int pullMediaCapabilitiesStats(int i, List list) {
    ...
    byte[] bytes5 =
        hdrCapabilities != null ? toBytes(hdrCapabilities.getSupportedHdrTypes()) : new byte[0];
    byte[] bytes6 = toBytes(display.getSupportedModes());
    List<UUID> supportedCryptoSchemes = MediaDrm.getSupportedCryptoSchemes();
    try {
      i2 =
          !supportedCryptoSchemes.isEmpty()
              ? new MediaDrm(supportedCryptoSchemes.get(0)).getConnectedHdcpLevel()
              : -1;
    ...
    Display.Mode globalUserPreferredDisplayMode =
        displayManager.getGlobalUserPreferredDisplayMode();
    int physicalWidth =
        globalUserPreferredDisplayMode != null
            ? globalUserPreferredDisplayMode.getPhysicalWidth()
            : -1;
    int physicalHeight =
        globalUserPreferredDisplayMode != null
            ? globalUserPreferredDisplayMode.getPhysicalHeight()
            : -1;
    float refreshRate =
        globalUserPreferredDisplayMode != null
            ? globalUserPreferredDisplayMode.getRefreshRate()
            : DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
    try {
      z =
          Settings.Secure.getIntForUser(
                  this.mContext.getContentResolver(), "minimal_post_processing_allowed", 1)
              == 0;
    } catch (Settings.SettingNotFoundException e2) {
      Slog.e(
          "StatsPullAtomService",
          "unable to find setting for MINIMAL_POST_PROCESSING_ALLOWED.",
          e2);
      z = false;
    }
    list.add(
  ...
  public final void registerPendingIntentsPerPackagePuller() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.PENDING_INTENTS_PER_PACKAGE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final int pullHdrCapabilities(int i, List list) {
    ...
    list.add(
        FrameworkStatsLog.buildStatsEvent(
            i,
            toBytes(displayManager.getSupportedHdrOutputTypes()),
            conversionMode == 1,
            preferredHdrOutputType == -1 ? 0 : preferredHdrOutputType,
            hasDolbyVisionIssue(display),
            conversionMode != 0));
    return 0;
  }
  ...
  public final int pullCachedAppsHighWatermark(int i, List list) {
    list.add(
        ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
            .getCachedAppsHighWatermarkStats(i, true));
    return 0;
  }
  ...
  public final boolean hasDolbyVisionIssue(Display display) {
    ...
    Arrays.stream(display.getSupportedModes())
        .map(
            new Function() { // from class:
                             // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda18
              @Override // java.util.function.Function
              public final Object apply(Object obj) {
        ...
        .filter(
            new Predicate() { // from class:
                              // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda19
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$hasDolbyVisionIssue$24;
                lambda$hasDolbyVisionIssue$24 =
                    StatsPullAtomService.lambda$hasDolbyVisionIssue$24((int[]) obj);
                return lambda$hasDolbyVisionIssue$24;
              }
            })
        .forEach(
            new Consumer() { // from class:
                             // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda20
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
    ...
    return Arrays.stream(iArr)
        .anyMatch(
            new IntPredicate() { // from class:
                                 // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda28
              @Override // java.util.function.IntPredicate
              public final boolean test(int i) {
                boolean lambda$hasDolbyVisionIssue$23;
                lambda$hasDolbyVisionIssue$23 =
                    StatsPullAtomService.lambda$hasDolbyVisionIssue$23(i);
  ...
  public final int pullPendingIntentsPerPackage(int i, List list) {
    for (PendingIntentStats pendingIntentStats :
        ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
            .getPendingIntentStats()) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i, pendingIntentStats.uid, pendingIntentStats.count, pendingIntentStats.sizeKb));
    }
    return 0;
  }
  ...
  public final void registerPinnerServiceStats() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.PINNED_FILE_SIZES_PER_PACKAGE,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerHdrCapabilitiesPuller() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.HDR_CAPABILITIES,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public final void registerCachedAppsHighWatermarkPuller() {
    this.mStatsManager.setPullAtomCallback(
        FrameworkStatsLog.CACHED_APPS_HIGH_WATERMARK,
        (StatsManager.PullAtomMetadata) null,
        ConcurrentUtils.DIRECT_EXECUTOR,
        this.mStatsCallbackImpl);
  }
  ...
  public int pullSystemServerPinnerStats(int i, List list) {
    for (PinnerService.PinnedFileStats pinnedFileStats :
        ((PinnerService) LocalServices.getService(PinnerService.class)).dumpDataForStatsd()) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              i, pinnedFileStats.uid, pinnedFileStats.filename, pinnedFileStats.sizeKb));
    }
    return 0;
  }
  ...
  public final byte[] toBytes(Display.Mode[] modeArr) {
    ...
    for (Display.Mode mode : modeArr) {
      ...
      protoOutputStream2.write(
          1120986464260L,
          ((Integer) createModeGroups.get(Integer.valueOf(mode.getModeId()))).intValue());
    ...
    for (Display.Mode mode : modeArr) {
      if (!arrayMap.containsKey(Integer.valueOf(mode.getModeId()))) {
        ...
        for (float f : mode.getAlternativeRefreshRates()) {
          int findModeId =
              findModeId(modeArr, mode.getPhysicalWidth(), mode.getPhysicalHeight(), f);
    ...
    int count =
        (int)
            str.chars()
                .filter(
                    new IntPredicate() { // from class:
                                         // com.android.server.stats.pull.StatsPullAtomService$$ExternalSyntheticLambda13
                      @Override // java.util.function.IntPredicate
                      public final boolean test(int i) {
                        boolean lambda$countAccessibilityServices$26;
                        lambda$countAccessibilityServices$26 =
                            StatsPullAtomService.lambda$countAccessibilityServices$26(i);
  ...
  public final boolean isAccessibilityShortcutUser(Context context, int i) {
    ...
    String stringForUser =
        Settings.Secure.getStringForUser(contentResolver, "accessibility_button_targets", i);
    String stringForUser2 =
        Settings.Secure.getStringForUser(
            contentResolver, "accessibility_shortcut_target_service", i);
    return (TextUtils.isEmpty(stringForUser) ^ true)
        || ((Settings.Secure.getIntForUser(
                    contentResolver, "accessibility_shortcut_dialog_shown", 0, i)
                == 1)
            && !TextUtils.isEmpty(stringForUser2))
        || (Settings.Secure.getIntForUser(
                contentResolver, "accessibility_display_magnification_enabled", 0, i)
            == 1);
  }

  public final boolean isAccessibilityFloatingMenuUser(Context context, int i) {
    ContentResolver contentResolver = context.getContentResolver();
    return Settings.Secure.getIntForUser(contentResolver, "accessibility_button_mode", 0, i) == 1
        && !TextUtils.isEmpty(
            Settings.Secure.getStringForUser(contentResolver, "accessibility_button_targets", i));
  }
  ...
  public final class StatsSubscriptionsListener
    ...
    public void onSubscriptionsChanged() {
      for (final SubscriptionInfo subscriptionInfo :
          this.mSm.getCompleteActiveSubscriptionInfoList()) {
        if (((SubInfo)
                CollectionUtils.find(
                    StatsPullAtomService.this.mHistoricalSubs,
                    new Predicate() { // from class:
                                      // com.android.server.stats.pull.StatsPullAtomService$StatsSubscriptionsListener$$ExternalSyntheticLambda0
                      @Override // java.util.function.Predicate
                      public final boolean test(Object obj) {
                        boolean lambda$onSubscriptionsChanged$0;
                        lambda$onSubscriptionsChanged$0 =
                            StatsPullAtomService.StatsSubscriptionsListener
                                .lambda$onSubscriptionsChanged$0(subscriptionInfo, (SubInfo) obj);
          ...
          String subscriberId =
              StatsPullAtomService.this.mTelephony.getSubscriberId(subscriptionId);
          if (TextUtils.isEmpty(subscriberId)
              || TextUtils.isEmpty(mccString)
              || TextUtils.isEmpty(mncString)
              || subscriptionInfo.getCarrierId() == -1) {
            Slog.e(
                "StatsPullAtomService",
                "subInfo of subId " + subscriptionId + " is invalid, ignored.");
          } else {
            SubInfo subInfo =
                new SubInfo(
                    subscriptionId,
            ...
            Slog.i(
                "StatsPullAtomService",
                "subId " + subscriptionId + " added into historical sub list");
            synchronized (StatsPullAtomService.this.mDataBytesTransferLock) {
              StatsPullAtomService.this.mHistoricalSubs.add(subInfo);
              StatsPullAtomService.this.mNetworkStatsBaselines.addAll(
                  StatsPullAtomService.this.getDataUsageBytesTransferSnapshotForSub(subInfo));
            }
          }
        }
      }
    ...
    public static /* synthetic */ boolean lambda$onSubscriptionsChanged$0(
        SubscriptionInfo subscriptionInfo, SubInfo subInfo) {
