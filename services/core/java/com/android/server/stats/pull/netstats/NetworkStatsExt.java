...
public class NetworkStatsExt {
  ...
  public boolean hasSameSlicing(NetworkStatsExt networkStatsExt) {
    return Arrays.equals(this.transports, networkStatsExt.transports)
        && this.slicedByFgbg == networkStatsExt.slicedByFgbg
        && this.slicedByTag == networkStatsExt.slicedByTag
        && this.slicedByMetered == networkStatsExt.slicedByMetered
        && this.ratType == networkStatsExt.ratType
        && Objects.equals(this.subInfo, networkStatsExt.subInfo)
        && this.oemManaged == networkStatsExt.oemManaged;
  }
}
