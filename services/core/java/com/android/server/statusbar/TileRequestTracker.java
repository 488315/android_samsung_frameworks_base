...
public class TileRequestTracker {
  ...
  public TileRequestTracker(Context context) {
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.statusbar.TileRequestTracker.1
            ...
            if (intent.hasExtra("android.intent.extra.UID")) {
              ...
              synchronized (TileRequestTracker.this.mLock) {
                ...
                int numElementsForKey =
                    TileRequestTracker.this.mTrackingMap.numElementsForKey(userId);
                int indexOfKey = TileRequestTracker.this.mTrackingMap.indexOfKey(userId);
                for (int i = 0; i < numElementsForKey; i++) {
                  ComponentName componentName =
                      (ComponentName) TileRequestTracker.this.mTrackingMap.keyAt(indexOfKey, i);
                ...
                for (int i2 = 0; i2 < size; i2++) {
                  TileRequestTracker.this.mTrackingMap.delete(
                      userId,
                      (ComponentName) TileRequestTracker.this.mComponentsToRemove.valueAt(i2));
                }
              }
            }
          }
  ...
  public void addDenial(int i, ComponentName componentName) {
    synchronized (this.mLock) {
      this.mTrackingMap.add(
          i,
          componentName,
          Integer.valueOf(
              ((Integer) this.mTrackingMap.getOrDefault(i, componentName, 0)).intValue() + 1));
    }
  }
  ...
  public void dump(
    ...
    synchronized (this.mLock) {
      this.mTrackingMap.forEach(
          new SparseArrayMap
              .TriConsumer() { // from class:
                               // com.android.server.statusbar.TileRequestTracker$$ExternalSyntheticLambda0
            public final void accept(int i, Object obj, Object obj2) {
              TileRequestTracker.lambda$dump$0(
                  indentingPrintWriter, i, (ComponentName) obj, (Integer) obj2);
            }
          });
    }
  ...
  public static /* synthetic */ void lambda$dump$0(
      IndentingPrintWriter indentingPrintWriter, int i, ComponentName componentName, Integer num) {
