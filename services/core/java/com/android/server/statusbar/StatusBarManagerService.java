...
public final class StatusBarManagerService extends IStatusBarService.Stub
        ...
        public final void abortTransientToType(int i, int i2, int i3) {
            ...
            synchronized (StatusBarManagerService.this.mBarLock) {
                if (StatusBarManagerService.this.mBarMap.get(Integer.valueOf(i3)) != null) {
                    try {
                        ((IStatusBar) StatusBarManagerService.this.mBarMap.get(Integer.valueOf(i3)))
                                .abortTransient(i, i2);
                    } catch (RemoteException unused) {
                        Slog.i("StatusBarManagerService", "RemoteException for abortTransient");
                    }
                } else if (CoreRune.CARLIFE_NAVBAR
                        && i3 == 2
        ...
        public final void sendKeyEventToDesktopTaskbarToType(KeyEvent keyEvent, int i) {
            ...
            try {
                if (statusBarManagerService.mBarMap.get(Integer.valueOf(i)) != null) {
                    try {
                        ((IStatusBar) StatusBarManagerService.this.mBarMap.get(Integer.valueOf(i)))
                                .sendKeyEventToDesktopTaskbar(keyEvent);
                    } catch (RemoteException unused) {
                    }
                }
                ...
                try {
                    ...
                    for (Map.Entry entry : StatusBarManagerService.this.mBarMap.entrySet()) {
                        if (((Integer) entry.getKey()).intValue() != 0
                                && (iStatusBar = (IStatusBar) entry.getValue()) != null) {
    ...
    public final class DisableRecord implements IBinder.DeathRecipient {
        ...
        public final void binderDied() {
            DeviceIdleController$$ExternalSyntheticOutline0.m(
                    new StringBuilder("binder died for pkg="), this.pkg, "StatusBarManagerService");
            StatusBarManagerService.this.disableForUserToType(
                    0, this.token, this.pkg, this.userId, this.barType);
            StatusBarManagerService.this.disable2ForUserToType(
                    0, this.token, this.pkg, this.userId, this.barType);
        ...
        public final int getFlags(int i) {
            ...
            DeviceIdleController$$ExternalSyntheticOutline0.m(
                    i, "Can't get unsupported disable flag ", "StatusBarManagerService");
            return 0;
        }
            ...
            if (i2 == 1) {
                ...
                StringBuilder m =
                        BatteryService$$ExternalSyntheticOutline0.m(
                                i2, "Can't set unsupported disable flag ", ": 0x");
        ...
        public final String toString() {
            return String.format(
                    "barType=%d userId=%d what1=0x%08X what2=0x%08X pkg=%s token=%s",
                    Integer.valueOf(this.barType),
                    Integer.valueOf(this.userId),
                    Integer.valueOf(this.what1),
                    Integer.valueOf(this.what2),
                    this.pkg,
                    this.token);
        }
    }
    ...
    public static void m960$$Nest$msetDisableFlags(
            StatusBarManagerService statusBarManagerService, int i, int i2, String str, int i3) {
        ...
        if (i4 != 0) {
            Slog.e(
                    ...
                    AudioChannelMask$$ExternalSyntheticOutline0.m(
                            new StringBuilder("Unknown disable flags: 0x"), i4),
                    new RuntimeException());
        }
        synchronized (statusBarManagerService.mLock) {
            statusBarManagerService.disableLocked(
                    i,
                    statusBarManagerService.mCurrentUserId,
                    i2,
                    1,
                    i3,
                    statusBarManagerService.mSysUiVisToken,
                    str);
        }
    }
        ...
        SemDesktopModeManager.DesktopModeListener desktopModeListener =
                new SemDesktopModeManager
                        .DesktopModeListener() { // from class:
                                                 // com.android.server.statusbar.StatusBarManagerService.1
                    public final void onDesktopModeStateChanged(
                            SemDesktopModeState semDesktopModeState) {
                        Slog.d(
                                "StatusBarManagerService",
                                "onDesktopModeStateChanged state = " + semDesktopModeState);
                        if (semDesktopModeState.getState() == 20
                                && semDesktopModeState.getEnabled() == 1) {
                            synchronized (StatusBarManagerService.this.mLock) {
                                try {
                                    for (int size =
                                                    StatusBarManagerService.this.mDisableRecords
                                                                    .size()
                                                            - 1;
                                            -1 < size;
                                            size--) {
                                        ...
                                        if (disableRecord.barType == 1) {
                                            Slog.d(
                                                    "StatusBarManagerService",
                                                    "remove record of STATUS_BAR_DEX r = "
                                                            + disableRecord);
                                            StatusBarManagerService.this.mDisableRecords.remove(
                                                    size);
    ...
    public final void checkCallingUidPackage(int i, int i2, String str) {
        if (UserHandle.getAppId(i)
                != UserHandle.getAppId(this.mPackageManagerInternal.getPackageUid(str, 0L, i2))) {
            throw new SecurityException(
                    SensitiveContentProtectionManagerService$SensitiveContentProtectionManagerServiceBinder$$ExternalSyntheticOutline0
                            .m(i, "Package ", str, " does not belong to the calling uid "));
        }
    }
    ...
    public final boolean checkCanCollapseStatusBar(String str) {
        ...
        if (this.mContext.checkPermission("android.permission.STATUS_BAR", callingPid, callingUid)
                == 0) {
            return true;
        }
        ...
        Slog.e(
                "StatusBarManagerService",
                "Permission Denial: Method "
                        + str
                        + "() requires permission android.permission.STATUS_BAR, ignoring call.");
        return false;
    }
    ...
    public final void clearInlineReplyUriPermissions(String str) {
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .clearInlineReplyUriPermissions(str);
        } finally {
    ...
    public final void disableLocked(
            int i, int i2, int i3, int i4, int i5, IBinder iBinder, String str) {
        int i6;
        IBinder iBinder2;
        String str2;
        String str3;
                    ...
                    if (disableRecord2.displayId == i) {
                        ...
                        StringBuilder m =
                                BatteryService$$ExternalSyntheticOutline0.m(
                                        i3,
                                        "Ignored flags(",
                                        "), displayId is mismatched. record.display: ");
        ...
        final int gatherDisableActionsLocked =
                SemFloatingFeature.getInstance()
                                .getString(
                                        "SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_SUBDISPLAY_POLICY")
                                .contains("LARGESCREEN")
                        ? gatherDisableActionsLocked(this.mCurrentUserId, 1, i5, i)
                        : gatherDisableActionsLocked(this.mCurrentUserId, 1, i5);
        int gatherDisableActionsLocked2 = gatherDisableActionsLocked(this.mCurrentUserId, 2, i5);
        UiState uiState = getUiState(i, i5);
        if (uiState.mDisabled1 != gatherDisableActionsLocked
                || uiState.mDisabled2 != gatherDisableActionsLocked2) {
            uiState.mDisabled1 = gatherDisableActionsLocked;
            uiState.mDisabled2 = gatherDisableActionsLocked2;
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // com.android.server.statusbar.StatusBarManagerService$$ExternalSyntheticLambda3
                        ...
                        public final void run() {
                            ...
                            NotificationManagerService.AnonymousClass2 anonymousClass2 =
                                    (NotificationManagerService.AnonymousClass2)
                                            statusBarManagerService.mNotificationDelegate;
                            synchronized (NotificationManagerService.this.mNotificationLock) {
                                NotificationAttentionHelper notificationAttentionHelper =
                                        NotificationManagerService.this.mAttentionHelper;
            ...
            synchronized (this.mBarLock) {
                ...
                if (iStatusBar != null) {
                    try {
                        iStatusBar.disable(
                                i, gatherDisableActionsLocked, gatherDisableActionsLocked2);
                    } catch (RemoteException e) {
        ...
        if (this.mEdgeInternal == null) {
            this.mEdgeInternal =
                    (EdgeManagerInternal) LocalServices.getService(EdgeManagerInternal.class);
        }
        EdgeManagerInternal edgeManagerInternal = this.mEdgeInternal;
        if (edgeManagerInternal != null) {
            edgeManagerInternal.statusBarDisabled(
                    gatherDisableActionsLocked, gatherDisableActionsLocked2);
        }
    }
            ...
            synchronized (this.mLock) {
                for (int i = 0; i < this.mDisplayUiState.size(); i++) {
                    try {
                        ...
                        printWriter.println(
                                "    mDisabled1=0x" + Integer.toHexString(uiState.mDisabled1));
                        printWriter.println(
                                "    mDisabled2=0x" + Integer.toHexString(uiState.mDisabled2));
                    } finally {
                    }
                }
                for (int i2 = 0; i2 < this.mDisplayUiStateDex.size(); i2++) {
                    ...
                    printWriter.println(
                            "    mDexDisabled1=0x" + Integer.toHexString(uiState2.mDisabled1));
                    printWriter.println(
                            "    mDexDisabled2=0x" + Integer.toHexString(uiState2.mDisabled2));
                }
                int size = this.mDisableRecords.size();
                printWriter.println("  mDisableRecords.size=" + size);
                for (int i3 = 0; i3 < size; i3++) {
                    printWriter.println(
                            "    [" + i3 + "] " + ((DisableRecord) this.mDisableRecords.get(i3)));
                }
                ...
                printWriter.println("  ]");
                this.mTileRequestTracker.dump(
                        new IndentingPrintWriter(printWriter, "  ").increaseIndent());
            }
            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                    new StringBuilder("  mSysUiSafeMode="), this.mSysUiSafeMode, printWriter);
            synchronized (this.mDisableHistoryList) {
                try {
                    ...
                    for (int i5 = 0; i5 < size3; i5++) {
                        printWriter.println(
                                "    [" + i5 + "] " + ((String) this.mDisableHistoryList.get(i5)));
                    }
                } finally {
                }
            }
                    ...
                    for (int i6 = 0; i6 < size4; i6++) {
                        printWriter.println(
                                "    ["
                                        + i6
                                        + "] "
                                        + ((String) this.mStatusBarHistoryList.get(i6)));
                    }
                } finally {
                }
            }
    ...
    public final void enforceExpandStatusBar() {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.EXPAND_STATUS_BAR", "StatusBarManagerService");
        makeStatusBarHistory(1);
    }

    public final void enforceStatusBar() {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.STATUS_BAR", "StatusBarManagerService");
    ...
    public final void enforceStatusBarService() {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.STATUS_BAR_SERVICE", "StatusBarManagerService");
    ...
    public final void expandNotificationsPanelToType(int i) {
        ...
        synchronized (this.mBarLock) {
            if (this.mBarMap.get(Integer.valueOf(i)) != null) {
                try {
                    ((IStatusBar) this.mBarMap.get(Integer.valueOf(i)))
    ...
    public final void expandSettingsPanelToType(String str, int i) {
        ...
        synchronized (this.mBarLock) {
            if (this.mBarMap.get(Integer.valueOf(i)) != null) {
                try {
                    ((IStatusBar) this.mBarMap.get(Integer.valueOf(i)))
                            .animateExpandSettingsPanel(str);
                } catch (RemoteException unused) {
                }
            }
        }
        ...
        synchronized (this.mLock) {
            ...
            try {
                if (iBinder == null && i == -1) {
                    ...
                    DisableRecord disableRecord =
                            (DisableRecord) findMatchingRecordLocked(i, iBinder, 0).second;
        ...
        synchronized (this.mLock) {
            ...
            try {
                if (iBinder == null && i == -1) {
                    ...
                    DisableRecord disableRecord =
                            (DisableRecord) findMatchingRecordLocked(i, iBinder, i2).second;
                    if (disableRecord != null) {
        ...
        try {
            int intForUser =
                    Settings.Secure.getIntForUser(
                            this.mContext.getContentResolver(), "nav_bar_kids_mode", i);
            Binder.restoreCallingIdentity(clearCallingIdentity);
            return intForUser;
    ...
    public final void grantInlineReplyUriPermission(
            String str, Uri uri, UserHandle userHandle, String str2) {
        enforceStatusBarService();
        int callingUid = Binder.getCallingUid();
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .grantInlineReplyUriPermission(str, uri, userHandle, str2, callingUid);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void hideAuthenticationDialog(long j) {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.MANAGE_BIOMETRIC_DIALOG", "StatusBarManagerService");
        if (this.mBar != null) {
            try {
        ...
        try {
            ...
            if (context != null
                    && Settings.System.getInt(
                                    context.getContentResolver(), "attfota_forceinstall_FN_sim", 0)
                            == 1) {
                Slog.d(
                        "StatusBarManagerService",
                        "FOTA update available when asking recovery system");
                z = true;
            }
            return z;
        } finally {
    ...
    public final void makeDisableHistory(
            int i, int i2, IBinder iBinder, String str, String str2, int i3, int i4, int i5) {
    ...
    public final void onBubbleMetadataFlagChanged(String str, int i) {
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onBubbleMetadataFlagChanged(str, i);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onClearAllNotifications(int i) {
        ...
        try {
            NotificationManagerService.AnonymousClass2 anonymousClass2 =
                    (NotificationManagerService.AnonymousClass2) this.mNotificationDelegate;
            synchronized (NotificationManagerService.this.mNotificationLock) {
                NotificationManagerService.this.cancelAllLocked(
                        callingUid, callingPid, i, 3, null, true, 8192);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    ...
    public final void onNotificationActionClick(
            String str,
            int i,
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationActionClick(
                            callingUid, callingPid, str, i, action, notificationVisibility, z);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onNotificationBubbleChanged(String str, boolean z, int i) {
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationBubbleChanged(str, z, i);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onNotificationClear(
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationClear(
                            callingUid, callingPid, str, i, str2, i2, i3, notificationVisibility);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onNotificationClick(
            String str, NotificationVisibility notificationVisibility) {
        enforceStatusBarService();
        int callingUid = Binder.getCallingUid();
        int callingPid = Binder.getCallingPid();
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationClick(callingUid, callingPid, str, notificationVisibility);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onNotificationDataUpdateFromPDC(List list) {
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationDataUpdateFromPDC(list);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onNotificationDirectReplied(String str) {
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationDirectReplied(str);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onNotificationError(
            String str, String str2, int i, int i2, int i3, String str3, int i4) {
        enforceStatusBarService();
        int callingUid = Binder.getCallingUid();
        int callingPid = Binder.getCallingPid();
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationError(callingUid, callingPid, i, i2, i3, i4, str, str2, str3);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onNotificationExpansionChanged(String str, boolean z, boolean z2, int i) {
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationExpansionChanged(str, z, z2, i);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onNotificationFeedbackReceived(String str, Bundle bundle) {
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationFeedbackReceived(str, bundle);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
        ...
        try {
            ...
            synchronized (NotificationManagerService.this.mNotificationLock) {
                NotificationRecord notificationRecord =
                        (NotificationRecord)
                                NotificationManagerService.this.mNotificationsByKey.get(str);
    ...
    public final void onNotificationSmartReplySent(
            String str, int i, CharSequence charSequence, int i2, boolean z) {
        enforceStatusBarService();
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationSmartReplySent(str, i, charSequence, i2, z);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }

    public final void onNotificationSmartSuggestionsAdded(
    ...
    public final void onNotificationVisibilityChanged(
        ...
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .onNotificationVisibilityChanged(
                            notificationVisibilityArr, notificationVisibilityArr2);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    public final void onSessionEnded(int i, InstanceId instanceId) {
        ...
        if (!StatusBarManager.ALL_SESSIONS.contains(Integer.valueOf(i))) {
            ExtendedEthernetServiceImpl$1$$ExternalSyntheticOutline0.m(
                    i, "invalid onSessionEnded sessionType=", "SessionMonitor");
            return;
        }
        synchronized (sessionMonitor.mSessionToListeners) {
            for (ISessionListener iSessionListener :
                    (Set) ((HashMap) sessionMonitor.mSessionToListeners).get(Integer.valueOf(i))) {
                try {
                    iSessionListener.onSessionEnded(i, instanceId);
                } catch (RemoteException e) {
                    Log.e(
                            "SessionMonitor",
                            "unable to send session end to listener=" + iSessionListener,
                            e);
                }
            }
        }
    ...
    public final void onSessionStarted(int i, InstanceId instanceId) {
        ...
        if (!StatusBarManager.ALL_SESSIONS.contains(Integer.valueOf(i))) {
            ExtendedEthernetServiceImpl$1$$ExternalSyntheticOutline0.m(
                    i, "invalid onSessionStarted sessionType=", "SessionMonitor");
            return;
        }
        synchronized (sessionMonitor.mSessionToListeners) {
            for (ISessionListener iSessionListener :
                ...
                try {
                    ...
                    Log.e(
                            "SessionMonitor",
                            "unable to send session start to listener=" + iSessionListener,
                            e);
                }
            }
        }
    ...
    public final void onShellCommand(
        ...
        new StatusBarShellCommand(this, this.mContext)
                .exec(
                        this,
                        fileDescriptor,
                        fileDescriptor2,
    ...
    public final void reboot(final boolean z) {
        ...
        try {
            ...
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // com.android.server.statusbar.StatusBarManagerService$$ExternalSyntheticLambda6
                        @Override // java.lang.Runnable
                        public final void run() {
                            boolean z2 = z;
                            String str2 = str;
                            if (z2) {
                                ShutdownThread.rebootSafeMode(
                                        StatusBarManagerService.getUiContext());
                            } else {
                                ShutdownThread.reboot(
                                        StatusBarManagerService.getUiContext(), str2, false);
                            }
                        }
                    });
        } finally {
    ...
    public final void rebootByBixby(final boolean z) {
        ...
        try {
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // com.android.server.statusbar.StatusBarManagerService$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            if (z) {
                                ShutdownThread.rebootSafeMode(
    ...
    public final void registerNearbyMediaDevicesProvider(
            INearbyMediaDevicesProvider iNearbyMediaDevicesProvider) {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.MEDIA_CONTENT_CONTROL", "StatusBarManagerService");
        IStatusBar iStatusBar = this.mBar;
        if (iStatusBar != null) {
            try {
    ...
    public final void registerSessionListener(int i, ISessionListener iSessionListener) {
        SessionMonitor sessionMonitor = this.mSessionMonitor;
        if ((i & 1) != 0) {
            sessionMonitor.mContext.enforceCallingOrSelfPermission(
        ...
        synchronized (sessionMonitor.mSessionToListeners) {
            try {
                for (Integer num : StatusBarManager.ALL_SESSIONS) {
                    if ((num.intValue() & i) != 0) {
                        ((Set) ((HashMap) sessionMonitor.mSessionToListeners).get(num))
                                .add(iSessionListener);
                    }
                }
            } catch (Throwable th) {
                throw th;
    ...
    public final RegisterStatusBarResult registerStatusBar(IStatusBar iStatusBar) {
        ...
        try {
            ...
            Slog.e(
                    "StatusBarManagerService",
                    "Unable to register Death Recipient for status bar",
                    e);
        }
        ...
        synchronized (this.mLock) {
            ...
            registerStatusBarResult =
                    new RegisterStatusBarResult(
                            arrayMap,
                            gatherDisableActionsLocked(this.mCurrentUserId, 1, 0),
                            uiState.mAppearance,
                            uiState.mAppearanceRegions,
                            uiState.mImeWindowVis,
                            uiState.mImeBackDisposition,
                            uiState.mShowImeSwitcher,
                            gatherDisableActionsLocked(this.mCurrentUserId, 2, 0),
                            uiState.mImeToken,
                            uiState.mNavbarColorManagedByIme,
                            uiState.mBehavior,
                            uiState.mRequestedVisibleTypes,
                            uiState.mPackageName,
                            uiState.mTransientBarTypes,
                            uiState.mLetterboxDetails);
        }
        return registerStatusBarResult;
    }

    public final RegisterStatusBarResult registerStatusBarAsType(
            IStatusBar iStatusBar, final int i) {
        ArrayMap arrayMap;
        RegisterStatusBarResult registerStatusBarResult;
        enforceStatusBarService();
        ...
        try {
                    ...
                    .linkToDeath(
                            new IBinder
                                    .DeathRecipient() { // from class:
                                                        // com.android.server.statusbar.StatusBarManagerService.4
                                @Override // android.os.IBinder.DeathRecipient
                                public final void binderDied() {
                                    synchronized (StatusBarManagerService.this.mBarLock) {
                                        StatusBarManagerService.this.mBarMap.remove(
                                                Integer.valueOf(i));
                                    }
            ...
            Slog.e(
                    "StatusBarManagerService",
                    "Unable to register Death Recipient for DEX status bar",
                    e);
        }
        notifyBarAttachChanged();
        synchronized (this.mIcons) {
        ...
        synchronized (this.mLock) {
            ...
            registerStatusBarResult =
                    new RegisterStatusBarResult(
                            arrayMap,
                            gatherDisableActionsLocked(this.mCurrentUserId, 1, 1),
                            uiState.mAppearance,
                            uiState.mAppearanceRegions,
                            uiState.mImeWindowVis,
                            uiState.mImeBackDisposition,
                            uiState.mShowImeSwitcher,
                            gatherDisableActionsLocked(this.mCurrentUserId, 2, 1),
                            uiState.mImeToken,
                            uiState.mNavbarColorManagedByIme,
                            uiState.mBehavior,
                            uiState.mRequestedVisibleTypes,
    ...
    public final void registerStatusBarForCarLife(IStatusBarCarLife iStatusBarCarLife) {
        if (CoreRune.CARLIFE_NAVBAR) {
            ...
            Slog.i(
                    "StatusBarManagerService",
                    "registerStatusBarForCarLife bar=" + iStatusBarCarLife);
    ...
    */
    public final void requestAddTile(
            final android.content.ComponentName r22,
            java.lang.CharSequence r23,
            android.graphics.drawable.Icon r24,
            final int r25,
            final com.android.internal.statusbar.IAddTileResultCallback r26) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.statusbar.StatusBarManagerService.requestAddTile(android.content.ComponentName,"
                    + " java.lang.CharSequence, android.graphics.drawable.Icon, int,"
                    + " com.android.internal.statusbar.IAddTileResultCallback):void");
    }
    ...
    public final void requestTileServiceListeningState(ComponentName componentName, int i) {
        ...
        if (bool != null) {
            ...
            try {
                serviceInfo =
                        this.mContext.getPackageManager().getServiceInfo(componentName, 787072);
            ...
            if (handleIncomingUser != currentUserId && profileParentId != currentUserId) {
                if (!CompatChanges.isChangeEnabled(242194868L, callingUid)) {
                    throw new IllegalArgumentException(
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    handleIncomingUser, "User ", " is not the current user."));
                }
                return;
            }
        }
    ...
    public final void setBiometicContextListener(
            IBiometricContextListener iBiometricContextListener) {
        enforceStatusBarService();
        synchronized (this.mLock) {
    ...
    public final void setIcon(String str, String str2, int i, int i2, String str3) {
        ...
        synchronized (this.mIcons) {
            StatusBarIcon statusBarIcon =
                    new StatusBarIcon(
                            str2, UserHandle.SYSTEM, i, i2, 0, str3, StatusBarIcon.Type.SystemIcon);
    ...
    public final void setImeWindowStatus(
            final int i, final IBinder iBinder, final int i2, final int i3, final boolean z) {
        enforceStatusBar();
        synchronized (this.mLock) {
            ...
            this.mHandler.post(
                    new Runnable() { // from class:
                                     // com.android.server.statusbar.StatusBarManagerService$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            StatusBarManagerService statusBarManagerService =
                                    StatusBarManagerService.this;
                            ...
                            try {
                                statusBarManagerService.mBar.setImeWindowStatus(
                                        i4, iBinder2, i5, i6, z2);
                            } catch (RemoteException unused) {
                            }
                        }
                    });
        ...
        if (i != 0 && i != 1) {
            throw new IllegalArgumentException(
                    VibrationParam$1$$ExternalSyntheticOutline0.m(
                            i, "Supplied navBarMode not supported: "));
        }
        int i2 = this.mCurrentUserId;
        int userId = UserHandle.getUserId(Binder.getCallingUid());
        if (this.mCurrentUserId != userId
                && this.mContext.checkCallingPermission(
                                "android.permission.INTERACT_ACROSS_USERS_FULL")
                        != 0
                && this.mContext.checkCallingPermission("android.permission.INTERACT_ACROSS_USERS")
                        != 0) {
            throw new SecurityException(
                    AmFmBandRange$$ExternalSyntheticOutline0.m(
                            ...
                            BatteryService$$ExternalSyntheticOutline0.m(
                                    userId,
                                    "Calling user id: ",
                                    ", cannot call on behalf of current user id: "),
                            "."));
        }
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            try {
                Settings.Secure.putIntForUser(
                        this.mContext.getContentResolver(), "nav_bar_kids_mode", i, i2);
                Settings.Secure.putIntForUser(
                        this.mContext.getContentResolver(), "nav_bar_force_visible", i, i2);
                    ...
                    try {
                        if (this.mContext
                            ...
                            overlayManager.setEnabledExclusiveInCategory(
                                    KnoxCustomManagerService.NAV_BAR_MODE_3BUTTON_OVERLAY, i2);
                        }
                    } catch (PackageManager.NameNotFoundException unused) {
                    }
                }
    ...
    public final void setPanelExpandStateToType(boolean z, int i) {
        Slog.d(
                "StatusBarManagerService",
                "  setPanelExpandStateToType : state = " + z + ", barType = " + i);
    ...
    public final void setUdfpsRefreshRateCallback(
    ...
    public final void showAuthenticationDialog(
        ...
        if (this.mBar != null) {
            try {
                this.mBar.showAuthenticationDialog(
                        promptInfo, iBiometricSysuiReceiver, iArr, z, z2, i, j, str, j2);
            } catch (RemoteException unused) {
            }
        }
    }
    ...
    public final void showRearDisplayDialog(int i) {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.CONTROL_DEVICE_STATE", "StatusBarManagerService");
        IStatusBar iStatusBar = this.mBar;
        if (iStatusBar != null) {
            try {
    ...
    public final void shutdown() {
        enforceStatusBarService();
        ShutdownCheckPoints.INSTANCE.recordCheckPointInternal(
                Binder.getCallingPid(), "userrequested");
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            ((NotificationManagerService.AnonymousClass2) this.mNotificationDelegate)
                    .prepareForPossibleShutdown();
    ...
    public final void togglePanel() {
        if (!checkCanCollapseStatusBar("togglePanel")
                || (((UiState) this.mDisplayUiState.get(0)).mDisabled2 & 4) == 4
                || this.mBar == null) {
            return;
        }
        try {
    ...
    public final void unregisterNearbyMediaDevicesProvider(
            INearbyMediaDevicesProvider iNearbyMediaDevicesProvider) {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.MEDIA_CONTENT_CONTROL", "StatusBarManagerService");
        IStatusBar iStatusBar = this.mBar;
    ...
    public final void updateMediaTapToTransferReceiverDisplay(
        ...
        if (iStatusBar != null) {
            try {
                iStatusBar.updateMediaTapToTransferReceiverDisplay(
                        i, mediaRoute2Info, icon, charSequence);
            } catch (RemoteException e) {
    ...
    public final void updateMediaTapToTransferSenderDisplay(
            int i,
        ...
        if (iStatusBar != null) {
            try {
                iStatusBar.updateMediaTapToTransferSenderDisplay(
                        i, mediaRoute2Info, iUndoMediaTransferCallback);
            } catch (RemoteException e) {
