...
public class PendingReports {
    ...
    public final class PendingReportRec {
        ...
        public Uri getUri() {
            Uri.Builder appendQueryParameter = new Uri.Builder().scheme("content").authority("android.os.IncidentManager").path("/pending").appendQueryParameter("id", Integer.toString(this.f1704id)).appendQueryParameter("pkg", this.callingPackage).appendQueryParameter("flags", Integer.toString(this.flags)).appendQueryParameter(KnoxAnalyticsDataConverter.TIMESTAMP, Long.toString(this.addedWalltime));
    ...
    public final void lambda$authorizeReport$0(int i, String str, String str2, String str3, int i2, final IIncidentAuthListener iIncidentAuthListener) {
        ...
        if ((Build.IS_USERDEBUG || Build.IS_ENG) && (i2 & 2) != 0) {
            if (this.mPermissionManager.checkPermissionForDataDelivery("android.permission.CAPTURE_CONSENTLESS_BUGREPORT_ON_USERDEBUG_BUILD", new AttributionSource.Builder(i).setPackageName(str).build(), (String) null) == 0) {
                ...
                if (z) {
                    try {
                        Log.d("IncidentCompanionService", "approving consentless report: " + new PendingReportRec(str, str2, str3, i2, iIncidentAuthListener).getUri());
