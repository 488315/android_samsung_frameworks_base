...
public class PendingReports {
  ...
  public final class PendingReportRec {
    ...
    public PendingReportRec(
        String str, String str2, String str3, int i, IIncidentAuthListener iIncidentAuthListener) {
    ...
    public Uri getUri() {
      Uri.Builder appendQueryParameter =
          new Uri.Builder()
              ...
              .path("/pending")
              .appendQueryParameter("id", Integer.toString(this.f1704id))
              .appendQueryParameter("pkg", this.callingPackage)
              .appendQueryParameter("flags", Integer.toString(this.flags))
              .appendQueryParameter(
                  KnoxAnalyticsDataConverter.TIMESTAMP, Long.toString(this.addedWalltime));
    ...
    this.mRequestQueue.enqueue(
        ...
        new Runnable() { // from class:
          ...
          public final void run() {
            PendingReports.this.lambda$authorizeReport$0(
                i, str, str2, str3, i2, iIncidentAuthListener);
          }
        });
  }
        ...
        for (int i = 0; i < size; i++) {
          ...
          printWriter.println(
              String.format(
                  ...
                  simpleDateFormat.format(new Date(pendingReportRec.addedWalltime)),
  ...
  */
  public final void lambda$authorizeReport$0(
      int i,
      String str,
      String str2,
      String str3,
    ...
    if (currentUserIfAdmin == -10000 || !isSameProfileGroupUser(userId, currentUserIfAdmin)) {
      Log.w(
          ...
          "Calling user "
              + userId
              + " doesn't belong to the same profile group of the current admin user "
              + currentUserIfAdmin);
      denyReportBeforeAddingRec(iIncidentAuthListener, str);
      return;
    }
    ...
    if ((Build.IS_USERDEBUG || Build.IS_ENG) && (i2 & 2) != 0) {
      if (this.mPermissionManager.checkPermissionForDataDelivery(
          ...
          try {
            Log.d(
                ...
                "approving consentless report: "
                    + new PendingReportRec(str, str2, str3, i2, iIncidentAuthListener).getUri());
            iIncidentAuthListener.onReportApproved();
            return;
          } catch (RemoteException e) {
            Log.e(
                "IncidentCompanionService",
                "authorizeReportImpl listener.onReportApproved RemoteException: ",
                e);
          }
        }
        synchronized (this.mLock) {
        ...
        try {
              ...
              .linkToDeath(
                  new IBinder
                    ...
                    public final void binderDied() {
                      PendingReports.this.lambda$authorizeReportImpl$2(
                          iIncidentAuthListener, approverComponent, currentUserIfAdmin);
                    }
                  },
                  0);
          ...
          Log.e(
              "IncidentCompanionService",
              "Remote died while trying to register death listener: " + pendingReportRec.getUri());
  ...
  public /* synthetic */ void lambda$authorizeReportImpl$2(
  ...
  public final PendingReportRec findAndRemovePendingReportRecLocked(String str) {
    try {
      ...
      while (it.hasNext()) {
        ...
        if (pendingReportRec.f1704id == parseInt) {
          it.remove();
  ...
  public final void removePendingReportRecLocked(IIncidentAuthListener iIncidentAuthListener) {
    ...
    while (it.hasNext()) {
      ...
      if (pendingReportRec.listener.asBinder() == iIncidentAuthListener.asBinder()) {
        Log.i(
            "IncidentCompanionService",
            "  ...Removed PendingReportRec index=" + it + ": " + pendingReportRec.getUri());
        it.remove();
      }
    }
  }

  public final void denyReportBeforeAddingRec(
  ...
  public final ComponentName getApproverComponent(int i) {
    List queryBroadcastReceiversAsUser =
        this.mPackageManager.queryBroadcastReceiversAsUser(
            new Intent("android.intent.action.PENDING_INCIDENT_REPORTS_CHANGED"), 1835008, i);
    ...
    Log.w(
        ...
        "Didn't find exactly one BroadcastReceiver to handle"
            + " android.intent.action.PENDING_INCIDENT_REPORTS_CHANGED. The report will be denied."
            + " size="
