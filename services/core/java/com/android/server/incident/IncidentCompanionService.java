...
public class IncidentCompanionService extends SystemService {
  ...
  public final class BinderService extends IIncidentCompanion.Stub {
    ...
    public void authorizeReport(
      ...
      try {
        IncidentCompanionService.this.mPendingReports.authorizeReport(
    ...
    public IncidentManager.IncidentReport getIncidentReport(String str, String str2, String str3) {
      ...
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        return IncidentCompanionService.this
            .getIIncidentManager()
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          IncidentCompanionService.this.getContext(), "IncidentCompanionService", printWriter)) {
    ...
    public final void dumpRestrictedImages(FileDescriptor fileDescriptor) {
      if (Build.IS_ENG || Build.IS_USERDEBUG) {
        for (String str :
            IncidentCompanionService.this.getContext().getResources().getStringArray(17236280)) {
    ...
    public final void enforceAuthorizePermission() {
      IncidentCompanionService.this
          .getContext()
          .enforceCallingOrSelfPermission("android.permission.APPROVE_INCIDENT_REPORTS", null);
    }
      ...
      try {
        ...
        ApplicationInfo applicationInfoAsUser =
            IncidentCompanionService.this
                .getContext()
                .getPackageManager()
                .getApplicationInfoAsUser(str, 0, UserHandle.getCallingUserId());
        ...
        throw new SecurityException(
            "Unknown package " + str + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + e);
      }
    }
  }
  ...
  public static int getCurrentUserIfAdmin() {
    try {
      ...
      if (currentUser == null) {
        Log.w(
            "IncidentCompanionService",
            "No current user.  Nobody to approve the report. The report will be denied.");
        return -10000;
      }
      if (!currentUser.isAdmin()) {
        Log.w(
            "IncidentCompanionService",
            "Only an admin user running in foreground can approve bugreports, but the current"
                + " foreground user is not an admin user. The report will be denied.");
        return -10000;
      }
