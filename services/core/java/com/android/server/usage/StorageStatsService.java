...
public final class StorageStatsService extends IStorageStatsManager.Stub {
    ...
    public final class H extends Handler {
        ...
        public static void recalculateQuotas(CacheQuotaStrategy cacheQuotaStrategy) {
            ...
            if (cacheQuotaStrategy.mServiceConnection == null) {
                cacheQuotaStrategy.mServiceConnection =
                            ...
                            public final class RunnableC00241 implements Runnable {
                                ...
                                public final void run() {
                                    synchronized (CacheQuotaStrategy.this.mLock) {
                                        CacheQuotaStrategy.this.mRemoteService =
                                                ICacheQuotaService.Stub.asInterface(r2);
                                        List m961$$Nest$mgetUnfulfilledRequests =
                                                CacheQuotaStrategy
                                                        .m961$$Nest$mgetUnfulfilledRequests(
                                        ...
                                        try {
                                            ...
                                            Slog.w(
                                                    "CacheQuotaStrategy",
                                                    "Remote exception occurred while trying to get"
                                                        + " cache quota",
                                                    e);
                                        }
                                    }
                            ...
                            public final void onServiceConnected(
                                ...
                                AsyncTask.execute(
                                        new Runnable() { // from class:
                                            // com.android.server.storage.CacheQuotaStrategy.1.1
                                            public final /* synthetic */ IBinder val$service;
                                            ...
                                            public final void run() {
                                                synchronized (CacheQuotaStrategy.this.mLock) {
                                                    ...
                                                    try {
                                                        ...
                                                        Slog.w(
                                                                "CacheQuotaStrategy",
                                                                "Remote exception occurred while"
                                                                    + " trying to get cache quota",
                                                                e);
                                                    }
                                                }
                                            }
            ...
            if (servicesSystemSharedLibraryPackageName == null) {
                Slog.w(
                        "CacheQuotaStrategy",
                        "could not access the cache quota service: no package!");
            } else {
            ...
            if (componentName != null) {
                ...
                cacheQuotaStrategy.mContext.bindServiceAsUser(
                        intent, cacheQuotaStrategy.mServiceConnection, 1, UserHandle.CURRENT);
            }
        }
        ...
        public final CacheQuotaStrategy getInitializedStrategy() {
            ...
            return new CacheQuotaStrategy(
                    storageStatsService.mContext,
                    usageStatsManagerInternal,
                    storageStatsService.mInstaller,
                    storageStatsService.mCacheQuotas);
        }

        @Override // android.os.Handler
        public final void handleMessage(Message message) {
            long j;
            if (StorageStatsService.isCacheQuotaCalculationsEnabled(
                    StorageStatsService.this.mContext.getContentResolver())) {
                switch (message.what) {
                    case 100:
                    ...
                    case 101:
                        ...
                        try {
                            ...
                            Slog.e(
                                    "StorageStatsService",
                                    "An error occurred while reading the cache quota file.",
                                    e);
    ...
    public final class LocalService implements StorageStatsManagerLocal {
        ...
        public final void registerStorageStatsAugmenter(
                StorageStatsManagerLocal.StorageStatsAugmenter storageStatsAugmenter, String str) {
            StorageStatsService.this.mStorageStatsAugmenters.add(
                    Pair.create(str, storageStatsAugmenter));
        }
    }
    ...
    public StorageStatsService(Context context) {
        ...
        storageManager.registerListener(
                new StorageEventListener() { // from class:
                                             // com.android.server.usage.StorageStatsService.1
        ...
        DeviceConfig.addOnPropertiesChangedListener(
                "storage_native_boot",
                context2.getMainExecutor(),
                new DeviceConfig
                        .OnPropertiesChangedListener() { // from class:
                                                         // com.android.server.usage.StorageStatsService$$ExternalSyntheticLambda3
    ...
    public static void checkEquals(
            String str, PackageStats packageStats, PackageStats packageStats2) {
        checkEquals(
                packageStats.codeSize,
                packageStats2.codeSize,
                ConnectivityModuleConnector$$ExternalSyntheticOutline0.m$1(str, " codeSize"));
        checkEquals(
                packageStats.dataSize,
                packageStats2.dataSize,
                AudioOffloadInfo$$ExternalSyntheticOutline0.m(
                        new StringBuilder(), str, " dataSize"));
        checkEquals(
                packageStats.cacheSize,
                packageStats2.cacheSize,
                AudioOffloadInfo$$ExternalSyntheticOutline0.m(
                        new StringBuilder(), str, " cacheSize"));
        checkEquals(
                packageStats.externalCodeSize,
                packageStats2.externalCodeSize,
                AudioOffloadInfo$$ExternalSyntheticOutline0.m(
                        new StringBuilder(), str, " externalCodeSize"));
        checkEquals(
                packageStats.externalDataSize,
                packageStats2.externalDataSize,
                AudioOffloadInfo$$ExternalSyntheticOutline0.m(
                        new StringBuilder(), str, " externalDataSize"));
        checkEquals(
                packageStats.externalCacheSize,
                packageStats2.externalCacheSize,
                AudioOffloadInfo$$ExternalSyntheticOutline0.m(
                        new StringBuilder(), str, " externalCacheSize"));
    }

    public static void computeAppStatsByDataTypes(
            PackageStats packageStats, String str, String str2) {
        ...
        try {
            ArtManagedFileStats artManagedFileStats =
                    DexOptHelper.getArtManagerLocal()
                            .getArtManagedFileStats(withFilteredSnapshot, str2);
            if (withFilteredSnapshot != null) {
                withFilteredSnapshot.close();
            }
            packageStats.dexoptSize =
                    artManagedFileStats.getTotalSizeBytesByType(0) + packageStats.dexoptSize;
            packageStats.refProfSize =
                    artManagedFileStats.getTotalSizeBytesByType(1) + packageStats.refProfSize;
            packageStats.curProfSize =
                    artManagedFileStats.getTotalSizeBytesByType(2) + packageStats.curProfSize;
        } catch (Throwable th) {
            if (withFilteredSnapshot != null) {
                try {
                    withFilteredSnapshot.close();
    ...
    public static List convertCrateInfoFrom(CrateMetadata[] crateMetadataArr) {
        ...
        for (CrateMetadata crateMetadata : crateMetadataArr) {
            if (crateMetadata != null
                    && !TextUtils.isEmpty(crateMetadata.id)
                    && !TextUtils.isEmpty(crateMetadata.packageName)
                    && (copyFrom =
                                    CrateInfo.copyFrom(
                                            crateMetadata.uid,
                                            crateMetadata.packageName,
                                            crateMetadata.id))
                            != null) {
        ...
        if (noteOp != 3) {
            StringBuilder m =
                    StorageManagerService$$ExternalSyntheticOutline0.m(
                            i, "Package ", str, " from UID ", " blocked by mode ");
            m.append(noteOp);
            return m.toString();
        }
        if (this.mContext.checkCallingOrSelfPermission("android.permission.PACKAGE_USAGE_STATS")
                == 0) {
            return null;
        }
        return SensitiveContentProtectionManagerService$SensitiveContentProtectionManagerServiceBinder$$ExternalSyntheticOutline0
                .m(
                        i,
                        "Caller does not have android.permission.PACKAGE_USAGE_STATS;"
                            + " callingPackage=",
                        str,
                        ", callingUid=");
    }
    ...
    public final void forEachStorageStatsAugmenter(String str, Consumer consumer) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            StorageStatsManagerLocal.StorageStatsAugmenter storageStatsAugmenter =
                    (StorageStatsManagerLocal.StorageStatsAugmenter) pair.second;
    ...
    public final long getCacheQuotaBytes(String str, int i, String str2) {
        enforceStatsPermission(Binder.getCallingUid(), str2);
        return this.mCacheQuotas.containsKey(str)
                ? ((SparseLongArray) this.mCacheQuotas.get(str)).get(i, DEFAULT_QUOTA)
                : DEFAULT_QUOTA;
    }
        ...
        try {
            try {
                ...
                if (isQuotaSupported(str, "android")) {
                    usableSpace =
                            findPathForUuid.getUsableSpace()
                                    + Math.max(
                                            0L,
                                            getCacheBytes(str, "android")
                                                    - this.mStorage.getStorageCacheBytes(
                                                            findPathForUuid, 0));
                } else {
    ...
    public final long getTotalBytes(String str, String str2) {
            ...
            throw new ParcelableException(
                    new IOException(
                            ConnectivityModuleConnector$$ExternalSyntheticOutline0.m(
                                    "Failed to find storage device for UUID ", str)));
        }
        ...
        return roundStorageSize - internalStorageBlockDeviceSize <= dataUnit.toBytes(3L)
                ? roundStorageSize
                : internalStorageBlockDeviceSize;
    }
    ...
    public final ParceledListSlice queryCratesForPackage(
            String str, String str2, int i, String str3) {
        checkCratesEnable();
        if (i != UserHandle.getCallingUserId()) {
            this.mContext.enforceCallingOrSelfPermission(
                    "android.permission.INTERACT_ACROSS_USERS", "StorageStatsService");
        }
        try {
            if (Binder.getCallingUid()
                    != this.mPackage.getApplicationInfoAsUser(str2, 8192, i).uid) {
                Binder.getCallingUid();
                this.mContext.enforceCallingOrSelfPermission(
                        "android.permission.MANAGE_CRATES", str3);
            }
    ...
    public final StorageStats queryStatsForPackage(
            String str, final String str2, int i, String str3) {
        final boolean z;
        if (i != UserHandle.getCallingUserId()) {
            this.mContext.enforceCallingOrSelfPermission(
                    "android.permission.INTERACT_ACROSS_USERS", "StorageStatsService");
        ...
        try {
            ApplicationInfo applicationInfoAsUser =
                    this.mPackage.getApplicationInfoAsUser(str2, 8192, i);
            ...
            if (ArrayUtils.defeatNullable(
                                    this.mPackage.getPackagesForUid(applicationInfoAsUser.uid))
                            .length
                    == 1) {
            ...
            if ((!applicationInfoAsUser.isSystemApp() || applicationInfoAsUser.isUpdatedSystemApp())
                    && applicationInfoAsUser.getCodePath() != null) {
                strArr2 =
                        (String[])
                                ArrayUtils.appendElement(
                                        String.class, strArr2, applicationInfoAsUser.getCodePath());
            }
            ...
            try {
                ...
                if (str == StorageManager.UUID_PRIVATE_INTERNAL) {
                    ...
                    forEachStorageStatsAugmenter(
                            "queryStatsForPackage",
                            new Consumer() { // from class:
                                             // com.android.server.usage.StorageStatsService$$ExternalSyntheticLambda2
                                @Override // java.util.function.Consumer
                                public final void accept(Object obj) {
                                    ((StorageStatsManagerLocal.StorageStatsAugmenter) obj)
                                            .augmentStatsForPackageForUser(
                                                    packageStats, str2, of, z);
                                }
                            });
                }
    ...
    public final StorageStats queryStatsForUid(String str, final int i, String str2) {
        ...
        for (int i2 = 0; i2 < defeatNullable.length; i2++) {
            try {
                ApplicationInfo applicationInfoAsUser =
                        this.mPackage.getApplicationInfoAsUser(defeatNullable[i2], 8192, userId);
                if (!applicationInfoAsUser.isSystemApp()
                        || applicationInfoAsUser.isUpdatedSystemApp()) {
                        ...
                        strArr =
                                (String[])
                                        ArrayUtils.appendElement(
                                                String.class,
                                                strArr,
                                                applicationInfoAsUser.getCodePath());
                    }
                    ...
                    if (android.app.usage.Flags.getAppBytesByDataTypeApi()) {
                        try {
                            computeAppStatsByDataTypes(
                                    packageStats2,
                                    applicationInfoAsUser.sourceDir,
                                    defeatNullable[i2]);
                        } catch (NullPointerException e) {
                            Slog.e(
                                    "StorageStatsService",
                                    defeatNullable[i2] + " sourceDir is null",
                                    e);
                        }
                    }
                    strArr = strArr2;
        ...
        try {
            this.mInstaller.getAppSize(
                    str,
                    defeatNullable,
                    userId,
                    SystemProperties.getBoolean("fw.disable_quota", false) ? 0 : 4096,
                    appId,
                    jArr,
                    strArr,
                    packageStats2);
            if (SystemProperties.getBoolean("fw.verify_storage", false)) {
                ...
                this.mInstaller.getAppSize(
                        str, defeatNullable, userId, 0, appId, jArr, strArr, packageStats3);
            ...
            if (str == StorageManager.UUID_PRIVATE_INTERNAL) {
                forEachStorageStatsAugmenter(
                        "queryStatsForUid",
                        new Consumer() { // from class:
                                         // com.android.server.usage.StorageStatsService$$ExternalSyntheticLambda1
                            @Override // java.util.function.Consumer
                            public final void accept(Object obj) {
                                ((StorageStatsManagerLocal.StorageStatsAugmenter) obj)
                                        .augmentStatsForUid(packageStats, i, z2);
                            }
                        });
            }
            return translate(packageStats);
        ...
        try {
            ...
            if (str == StorageManager.UUID_PRIVATE_INTERNAL) {
                ...
                forEachStorageStatsAugmenter(
                        "queryStatsForUser",
                        new Consumer() { // from class:
                                         // com.android.server.usage.StorageStatsService$$ExternalSyntheticLambda0
                            @Override // java.util.function.Consumer
                            public final void accept(Object obj) {
                                ((StorageStatsManagerLocal.StorageStatsAugmenter) obj)
                                        .augmentStatsForUser(packageStats, of);
                            }
                        });
            }
            return translate(packageStats);
    ...
    public final void updateConfig() {
        synchronized (this.mLock) {
            this.mStorageThresholdPercentHigh =
                    DeviceConfig.getInt(
                            "storage_native_boot", "storage_threshold_percent_high", 20);
        }
    }
}
