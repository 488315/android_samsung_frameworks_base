...
public final class CallerValidatorImpl implements CallerValidator {
    ...
    public final UserHandle handleIncomingUser(int i, int i2, UserHandle userHandle, String str) {
        ...
        if (this.mContext.checkPermission("android.permission.INTERACT_ACROSS_USERS_FULL", i, i2)
                == 0) {
            try {
                ...
                StringBuilder m =
                        DumpUtils$$ExternalSyntheticOutline0.m(
                                "Package: ", str, " haven't installed for user ");
        ...
        throw new SecurityException(
                "Permission denied while calling from uid "
                        ...
                        + " with "
                        + userHandle
                        + "; Requires permission: android.permission.INTERACT_ACROSS_USERS_FULL");
    }
    ...
    public final String validateCallingPackage(String str) {
        ...
        try {
            try {
                i =
                        this.mContext
                                .createContextAsUser(UserHandle.getUserHandleForUid(callingUid), 0)
                                .getPackageManager()
                                .getPackageUid(str, 0);
            } catch (PackageManager.NameNotFoundException unused) {
                i = -1;
    ...
    @Override // com.android.server.appfunctions.CallerValidator
    public final AndroidFuture verifyCallerCanExecuteAppFunction(
            int i,
            int i2,
        ...
        if (this.mContext.checkPermission("android.permission.EXECUTE_APP_FUNCTIONS_TRUSTED", i2, i)
                != 0) {
            boolean isSystemAppOrPrivilegedApp =
                    appFunctionAgentPolicyManager.isSystemAppOrPrivilegedApp(str);
                    ...
                    try {
                        if (((ArrayList)
                                        appFunctionAgentPolicyManager
                                                .appliedAgentPolicyInfo
                                                .trustedAgentList)
                                .contains(str)) {
                            z2 = true;
                            Slog.d(
                                    "AppFunctionAgentPolicyManager",
                                    "packageName : " + str + " / isTrustedAgentPackage : " + z2);
                        }
                    } finally {
                    }
                }
            ...
            if (!z2) {
                if (this.mContext.checkPermission("android.permission.EXECUTE_APP_FUNCTIONS", i2, i)
                        != 0) {
                    boolean isSystemAppOrPrivilegedApp2 =
                            appFunctionAgentPolicyManager.isSystemAppOrPrivilegedApp(str);
                    synchronized (appFunctionAgentPolicyManager.mLock) {
                        if (isSystemAppOrPrivilegedApp2) {
                            try {
                                if (((ArrayList)
                                    ...
                                    Slog.d(
                                            "AppFunctionAgentPolicyManager",
                                            "packageName : " + str + " / isAgentPackage : " + z);
                                }
                            } finally {
                            }
                        }
                ...
                final String documentIdForAppFunction =
                        AppFunctionStaticMetadataHelper.getDocumentIdForAppFunction(str2, str3);
                GetByDocumentIdRequest build =
                        new GetByDocumentIdRequest.Builder("app_functions")
                                .addIds(documentIdForAppFunction)
                                .build();
                Objects.requireNonNull(build);
                return futureAppSearchSessionImpl
                        .getSessionAsync()
                        .thenCompose(
                                new FutureAppSearchSessionImpl$$ExternalSyntheticLambda0(
                                        futureAppSearchSessionImpl, build, 4))
                        .thenApply(
                                new Function() { // from class:
                                                 // com.android.server.appfunctions.CallerValidatorImpl$$ExternalSyntheticLambda0
                                    @Override // java.util.function.Function
                                    public final Object apply(Object obj) {
                                        String str4 = documentIdForAppFunction;
                                        AppSearchBatchResult appSearchBatchResult =
                                                (AppSearchBatchResult) obj;
                                        if (appSearchBatchResult.isSuccess()) {
                                            return (GenericDocument)
                                                    appSearchBatchResult.getSuccesses().get(str4);
                                        }
                        ...
                        .thenApply(new CallerValidatorImpl$$ExternalSyntheticLambda1())
                        .whenComplete(
                                new BiConsumer() { // from class:
                                                   // com.android.server.appfunctions.CallerValidatorImpl$$ExternalSyntheticLambda2
