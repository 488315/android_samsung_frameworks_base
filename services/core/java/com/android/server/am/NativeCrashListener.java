...
public final class NativeCrashListener extends Thread {
  ...
  public void consumeNativeCrashData(FileDescriptor fileDescriptor) {
    ...
    ByteArrayOutputStream byteArrayOutputStream =
        new ByteArrayOutputStream(IInstalld.FLAG_USE_QUOTA);
    try {
      StructTimeval fromMillis = StructTimeval.fromMillis(10000L);
      Os.setsockoptTimeval(
          fileDescriptor, OsConstants.SOL_SOCKET, OsConstants.SO_RCVTIMEO, fromMillis);
      Os.setsockoptTimeval(
          fileDescriptor, OsConstants.SOL_SOCKET, OsConstants.SO_SNDTIMEO, fromMillis);
