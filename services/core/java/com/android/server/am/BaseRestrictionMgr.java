...
public class BaseRestrictionMgr {
  ...
  public final boolean isBlockAssociatedActivity(ActivityInfo activityInfo) {
    if (MARsPolicyManager.getInstance().checkIsChinaModel()
      ...
      if (MARsVersionManager.getInstance()
          .isAdjustRestrictionMatch(27, activityInfo.taskAffinity, null, null)) {
        return true;
      }
  ...
  public boolean isRestrictedPackage(
      ...
      int i3,
      int i4) {
    return isRestrictedPackage(
        componentName, str, i, str2, intent, null, i2, false, false, null, str3, i3, i4);
  }
  ...
  public boolean isRestrictedPackage(
      ...
      int i4) {
    return isRestrictedPackage(
        componentName, str, i, str2, intent, null, i2, false, false, activityInfo, str3, i3, i4);
  }
  ...
  public boolean isRestrictedPackage(
      ...
      int i4) {
    return isRestrictedPackage(
        componentName, str, i, str2, intent, str3, i2, z, z2, null, str4, i3, i4);
  }
  ...
  */
  public boolean isRestrictedPackage(
    ...
    synchronized (MARsPolicyManager.MARsLock) {
      MARsPackageInfo mARsPackageInfo4 =
          (!MARsComponentTracker.getInstance().getEnabled()
                  || MARsPolicyManager.getInstance().mMARsTargetPackages == null
                  || MARsPolicyManager.getInstance().mMARsTargetPackages.size() == 0)
              ? null
              : MARsPolicyManager.getInstance()
                  .getMARsPackageInfo(
                      MARsPolicyManager.getInstance().mMARsTargetPackages, packageName, i2);
      int i17 = -1;
      ...
      if (!z3
          && MARsPolicyManager.getInstance().mMARsRestrictedPackages != null
          && MARsPolicyManager.getInstance().mMARsRestrictedPackages.size() != 0
          && (sparseArray =
                  (SparseArray)
                      MARsPolicyManager.getInstance()
                          .mMARsRestrictedPackages
                          .getMap()
                          .get(packageName))
              != null) {
      ...
      if (!z3) {
        if (MARsComponentTracker.getInstance().getEnabled()) {
          MARsComponentTracker.getInstance()
              .sendCTInfo(
                  mARsPackageInfo4 != null ? mARsPackageInfo4.getCurLevel() : i17,
                  i4,
                  i3,
                  packageName,
                  str,
      ...
      int autorunForFreezedPackage =
          z4 ? MARsPolicyManager.getInstance().getAutorunForFreezedPackage(packageName, i8) : i9;
      int i20 =
          (mARsPackageInfo == null || mARsPackageInfo.getAppliedPolicy() == null)
              ? z4 ? 4 : 0
              : mARsPackageInfo.getAppliedPolicy().num;
      if (mARsPackageInfo != null) {
      ...
      int restrictionsByCurrentLevel =
          getRestrictionsByCurrentLevel(
              i10,
              z4 && freecessPkgStatus != null && freecessPkgStatus.freezedRecord.isLcdOnFreezed);
      if (i20 == 4 && (restrictionsByCurrentLevel & 0) != 0) {
        z3 = false;
      }
      if ((33554432 & restrictionsByCurrentLevel) != 0
          && !MARsPolicyManager.getInstance().getScreenOnState()) {
        z3 = false;
      }
      if ((67108864 & restrictionsByCurrentLevel) != 0
          && MARsPolicyManager.getInstance().getScreenOnState()) {
        z3 = false;
      }
      if ((134217728 & restrictionsByCurrentLevel) != 0
          && !MARsPolicyManager.getInstance().getCarModeOnState()) {
        z3 = false;
      }
      if ((268435456 & restrictionsByCurrentLevel) != 0
          && MARsPolicyManager.getInstance().getCarModeOnState()) {
        z3 = false;
      }
      if (z3) {
        if ("activity".equals(str2)) {
          if ((restrictionsByCurrentLevel & 1) != 0) {
            ...
            if ((restrictionsByCurrentLevel & 8) == 0
                || isSelfIntent(packageName, str)
                || !(isBlockAssociatedActivity(activityInfo)
                    || MARsVersionManager.getInstance()
                        .isAdjustRestrictionMatch(8, componentName.getClassName(), null, null))) {
              z9 = z15;
              i11 = i20;
              mARsPackageInfo2 = mARsPackageInfo;
              i12 = i8;
              ...
              Slog.d(
                  ...
                  "Block activity: "
                      ...
                      + " --- isBlockAssociatedActivity which is not started by itself.");
              z9 = z15;
              i11 = i20;
              mARsPackageInfo2 = mARsPackageInfo;
              i12 = i8;
          ...
          if (!"startService".equals(str2) && !"bindService".equals(str2)) {
            if ("provider".equals(str2)) {
              ...
              if (INetd.IF_FLAG_BROADCAST.equals(str2)) {
                if (intent != null
                    && (restrictionsByCurrentLevel & IInstalld.FLAG_USE_QUOTA) == 0) {
                  ...
                  if ((32768 & restrictionsByCurrentLevel) != 0) {
                    if ("com.google.android.c2dm.intent.RECEIVE"
      ...
      if (FreecessController.getInstance().getFreecessEnabled()
          && FreecessController.getInstance().isFreezedPackage(packageName, i14)
          && !z5) {
        if ("provider".equals(str2)) {
        ...
        Slog.d(
            ...
            "Package: "
                ...
                + ", hostingType: "
                + str2
                + " is allowed by freecess, caller is: "
                + str);
        if (MARsComponentTracker.getInstance().getEnabled()) {
          MARsComponentTracker.getInstance()
              .sendCTInfo(
                  mARsPackageInfo4 != null ? mARsPackageInfo4.getCurLevel() : i13,
                  i4,
                  i3,
                  packageName,
                  str,
      ...
      if (!z5
          && (mARsPackageInfo3 = mARsPackageInfo2) != null
          && !mARsPackageInfo3.isSCPMTarget()) {
      ...
      if (MARsDebugConfig.DEBUG_MARs && z5) {
        Slog.d(
            ...
            "Package: "
                ...
                + ", hostingType: "
                + str2
                + " is Restricted by policy: "
                + i11
                + " caller is: "
                + str);
      }
      if (!MARsPolicyManager.getInstance().getCarModeOnState()
          && MARsPolicyManager.App_StartUp_History
          && this.mContext.getUserId() == i14) {
        MARsComponentTracker.getInstance()
            .trackComponent(z5, str2, str, packageName, autorunForFreezedPackage, i7, z4);
      }
  ...
  public final int isPolicyBlockedPackage(
      String str, int i, ComponentName componentName, String str2, Intent intent, int i2, int i3) {
    String packageName = componentName.getPackageName();
    ...
    if (i3 != 4 && !FreecessController.getInstance().isCalmModeOnoff()) {
      if (MARsPolicyManager.getInstance().checkIsChinaModel()
          && !UidStateMgr.getInstance().isUidGone(i2)) {
        return 1;
      }
      if (!MARsPolicyManager.getInstance().checkIsChinaModel()
          && UidStateMgr.getInstance().isUidRunning(i2)) {
        return 1;
      }
    }
    if ((("startService".equals(str2) || "bindService".equals(str2))
            && isShouldSkipCaseForPolicy(str, i, packageName, intent))
        || "com.sec.android.app.samsungapps".equals(packageName)) {
      return 1;
    }
  ...
  public final boolean isShouldSkipCaseForPolicy(String str, int i, String str2, Intent intent) {
    ...
    if ("android".equals(str)
        && action == null
        && AccessibilityAppFilter.getInstance().isEnabledAccessibilityApp(str2)) {
      Slog.d(TAG, "isShouldSkipCase: Enable AccessibilityService callee = " + str2);
      return true;
    }
    if (MARsPolicyManager.getInstance().isChinaPolicyEnabled()
        && MARsVersionManager.getInstance().isAdjustRestrictionMatch(1, str2, str, action)) {
      return true;
    }
    if (!MARsPolicyManager.getInstance().isChinaPolicyEnabled()
        || !MARsVersionManager.getInstance().isAdjustRestrictionMatch(7, str2, str, action)
        || !MARsPolicyManager.getInstance().isForegroundPackage(str, i)) {
      return false;
    }
  ...
  public final boolean isSamsungService(String str, int i) {
    ...
    if ("com.baidu.BaiduMap".equals(str)
        || "com.baidu.searchbox_samsung".equals(str)
        || "com.baidu.netdisk_ss".equals(str)
        || !isSystemPackage(str, i)) {
      return false;
    }
    if (MARsDebugConfig.DEBUG_MARs) {
        ...
        if (getLaunchIntentForPackage(str, i) == null) {
          if (MARsPolicyManager.getInstance().isMARsTarget(str, i)) {
            if (MARsDebugConfig.DEBUG_MARs) {
              Slog.d(
                  TAG,
                  "AutoRun Policy isLauncherableApp -- Not launcherable 3rd party package:" + str);
            }
            return true;
          }
          if (!MARsDebugConfig.DEBUG_MARs) {
  ...
  public final boolean isShouldBlockCase(String str, String str2, Intent intent) {
    ...
    return MARsPolicyManager.getInstance().isChinaPolicyEnabled()
        && MARsVersionManager.getInstance().isAdjustRestrictionMatch(2, str2, str, action);
  }
  ...
  public final boolean isJobSchedulerPackage(String str, ComponentName componentName, int i) {
    ...
    try {
      ...
      Slog.d(
          TAG,
          "AutoRun Policy isJobSchedulerPackage -- package = " + componentName.getPackageName());
      return true;
  ...
  public final boolean isSyncManagerPackage(
      String str, ComponentName componentName, Intent intent) {
    boolean z = false;
    if (str == null) {
      return false;
    }
    try {
      if (intent.getAction() == null
          || !"android".equals(str)
          || !"android.content.SyncAdapter".equals(intent.getAction())) {
        return false;
      }
      z = true;
      Slog.d(
          TAG,
          "AutoRun Policy isSyncManagerPackage -- package = " + componentName.getPackageName());
      return true;
    } catch (Exception e) {
  ...
  public final boolean isBindNotificationListenerPackage(
      String str, ComponentName componentName, int i) {
    IPackageManager packageManager;
    boolean z = false;
    if (str == null || (packageManager = AppGlobals.getPackageManager()) == null) {
      return false;
    ...
    try {
      ServiceInfo serviceInfo = packageManager.getServiceInfo(componentName, 0L, i);
      if (serviceInfo == null
          || !"android.permission.BIND_NOTIFICATION_LISTENER_SERVICE".equals(serviceInfo.permission)
          || !"android".equals(str)) {
        return false;
      }
      z = true;
      Slog.d(
          TAG,
          "AutoRun Policy isBindNotificationListenerPackage -- package = "
  ...
  public final boolean isSystemPackage(String str, int i) {
    try {
      ApplicationInfo applicationInfoAsUser =
          this.mContext.getPackageManager().getApplicationInfoAsUser(str, 0, i);
