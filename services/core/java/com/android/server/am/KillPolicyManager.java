...
public class KillPolicyManager {
  ...
  public static int sPolicyTrigger =
      Integer.parseInt(SystemProperties.get("ro.slmk.kpm_policy_trigger", Integer.toString(50)));
  ...
  public static boolean MEMORY_CRITICAL_LOW_USE_PACKAGE_RATIO =
  ...
  public final BroadcastReceiver mIdleModeReceiver =
      new BroadcastReceiver() { // from class: com.android.server.am.KillPolicyManager.1
        ...
        public void onReceive(Context context, Intent intent) {
          ...
          if (action.equals("android.os.action.DEVICE_IDLE_MODE_CHANGED")) {
            boolean isDeviceIdleMode =
                ((PowerManager) KillPolicyManager.this.mContext.getSystemService("power"))
                    .isDeviceIdleMode();
            ChimeraTriggerManager.getInstance(KillPolicyManager.this.mContext)
                .onDeviceIdleChanged(isDeviceIdleMode);
            if (isDeviceIdleMode) {
              KillPolicyManager.this.mLastAwakeRealTimeMillis =
                  System.currentTimeMillis() - KillPolicyManager.this.mLastIdleExitRealTimeMillis;
              KillPolicyManager.this.mLastAwakeUpTimeMillis =
                  SystemClock.uptimeMillis() - KillPolicyManager.this.mLastIdleExitUpTimeMillis;
              ...
              KillPolicyManager.this.mLastIdleRealTimeMillis =
                  System.currentTimeMillis() - KillPolicyManager.this.mLastIdleEnterRealTimeMillis;
              ...
              if (KillPolicyManager.KPM_DEBUG) {
                Slog.i(
                    "ActivityManager_kpm",
                    "Idle realtime : " + KillPolicyManager.this.mLastIdleRealTimeMillis);
              }
            }
  ...
  public class AutoRestartParameterReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (KillPolicyManager.KPM_DEBUG) {
        Slog.d(
            "ActivityManager_kpm",
            "Auto Restart Parameter Updated. {sMinTriggerSize="
                + KillPolicyManager.sMinTriggerSize
                + ", sNeverCollectWithin="
                + KillPolicyManager.sNeverCollectWithin
                + ", sCompactTriggerSize="
                + KillPolicyManager.sCompactTriggerSize
                + ", sNativeFloodRatio="
                + KillPolicyManager.sNativeFloodRatio
                + ", sSyspersFloodRatio="
                + KillPolicyManager.sSyspersFloodRatio
                + "}");
      }
    }
  }
  ...
  public static boolean isDetectCritcialLowEnabled() {
    boolean parseBoolean =
        Boolean.parseBoolean(
            SystemProperties.get("persist.sys.kpm_cri_mem_detect", String.valueOf(true)));
  ...
  public final boolean isSCPMAvailable() {
    ...
    return this.mContext
            .getPackageManager()
            .resolveContentProvider("com.samsung.android.sm.policy", 0)
        != null;
  }
  ...
  public final boolean isNeedUpdateSCPMPolicy() {
    Cursor cursor;
    if (DEBUG_SCPM) {
      Slog.d("ActivityManager_kpm", "isNeedUpdateSCPMPolicy");
    }
    try {
      cursor =
          this.mContext.getContentResolver().query(this.SCPM_URI_POLICY, null, null, null, null);
    } catch (Exception unused) {
      Slog.d("ActivityManager_kpm", "policy list is null");
      cursor = null;
    }
    boolean z = false;
    if (cursor != null) {
      while (true) {
        ...
        if ("kpm".equals(string)) {
          Slog.d(
              "ActivityManager_kpm",
              "isNeedUpdateSCPMPolicy: policyName=" + string + " , policyVersion=" + string2);
          z = true;
          break;
        }
      }
  ...
  public final boolean hasValidItemFromDB() {
    ...
    try {
      cursor =
          this.mContext.getContentResolver().query(this.SCPM_URI_KPM, strArr, null, null, null);
    } catch (Exception e) {
      ...
      while (cursor.moveToNext()) {
        if (cursor.getString(0) != null) {
          ...
          if (string != null
              && string2 != null
              && string3 != null
              && "kpmEnable".equals(string)
              && "switch".equals(string2)) {
            ...
            if (DEBUG_SCPM) {
              Slog.d(
                  "ActivityManager_kpm",
                  "getSCPMPolicyItemFromDB: CATEGORY = "
                      + string2
                      + ", SCPM PKG: data1 = "
                      + string3
                      + ", KPM ENABLE = "
                      + ActivityManagerService.sPmmEnabledBySpcm);
            }
          }
        }
      }
  ...
  public void initKillPolicyManager(
  ...
  public final void scheduleDailyUserTrendRandomSample() {
    ...
    PendingIntent broadcast =
        PendingIntent.getBroadcast(
            this.mContext, 0, new Intent("com.samsung.KPM_USER_TREND_DAILY_SAMPLING"), 67108864);
    this.mDailyRandomSampleReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.KillPolicyManager.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if (KillPolicyManager.KPM_DEBUG) {
              Slog.d("ActivityManager_kpm", "report daily random sample time : " + timeInMillis);
            }
    ...
    this.mContext.registerReceiver(
        this.mDailyRandomSampleReceiver,
        new IntentFilter("com.samsung.KPM_USER_TREND_DAILY_SAMPLING"));
    this.mContext.registerReceiver(
        this.mIdleModeReceiver, new IntentFilter("android.os.action.DEVICE_IDLE_MODE_CHANGED"));
  ...
  public boolean isSkipPackage(String str) {
    return str.contains(this.mAm.currentLauncherName)
        || str.equals("android")
        || resumeSkipPackage.contains(str);
  }
  ...
  public final void reportResetState(String str) {
    ...
    intent.putExtra(
        "nativeStart",
        ((Integer) this.mMemoryFloodDetector.mLastCalculatedNative.first).intValue());
    intent.putExtra(
        "nativeEnd", ((Integer) this.mMemoryFloodDetector.mLastCalculatedNative.second).intValue());
    intent.putExtra(
        "sysPersStart",
        ((Integer) this.mMemoryFloodDetector.mLastCalculatedSysPers.first).intValue());
    intent.putExtra(
        "sysPersEnd",
        ((Integer) this.mMemoryFloodDetector.mLastCalculatedSysPers.second).intValue());
    intent.putExtra("pmmCyclePlatform", this.mPolicyMetric);
    intent.putExtra(
        "pmmCycleKernel",
        this.mPolicyMetric + this.mMemoryFloodDetector.mPmmCycleCountOnPlatformReset);
    intent.putExtra(
        "uptimeSystemBoot", SystemClock.uptimeMillis() - this.mPlatformStartUpTimeMillis);
    this.mContext.sendBroadcast(intent);
  ...
  public void updateKpmBigdata() {
    ...
    if (chimeraManagerService != null
        && (chimeraStat = chimeraManagerService.getChimeraStat()) != null) {
      currentKpmRawBigdata.chimeraDataInfo =
          ChimeraDataInfo.getDiff(chimeraStat, this.mRecentChimeraData);
  ...
  public void updateKpmCycleData() {
    ...
    if (currentKpmRawPolicy != null && (i = currentKpmRawPolicy.appCnt) != 0 && i % 5 == 0) {
      ...
      currentKpmRawPolicy.tinyKpmState[((currentKpmRawPolicy.appCnt / 5) - 1) % 10] =
          changeTinyKpmState(currentKpmRawPolicy);
      if (KPM_DEBUG) {
    ...
    if (chimeraManagerService != null
        && (chimeraStat = chimeraManagerService.getChimeraStat()) != null) {
      currentKpmRawPolicy.chimeraDataInfo =
          ChimeraDataInfo.getDiff(chimeraStat, this.mRecentChimeraData);
      this.mRecentChimeraData = chimeraStat;
    }
  ...
  */
  public void updateKpmPsiData() {
    ...
    KpmRaw currentKpmRawPolicy = getCurrentKpmRawPolicy();
    KpmRaw currentKpmRawBigdata = getCurrentKpmRawBigdata();
    if (this.mHasPsiCpuPermission) {
      PsiFile psiFile = getPsiFile(PsiFileType.CPU, PsiDataType.AVG10);
      if (psiFile.isEmpty()) {
        this.mHasPsiCpuPermission = false;
        Slog.d("ActivityManager", "No permission - psi cpu");
      } else {
        d = psiFile.getSomeAvg10();
        if (this.mHasPsiMemoryPermission) {
          PsiFile psiFile2 = getPsiFile(PsiFileType.MEMORY, PsiDataType.AVG10);
          if (psiFile2.isEmpty()) {
            this.mHasPsiMemoryPermission = false;
            Slog.d("ActivityManager", "No permission - psi memory");
          } else {
            d2 = psiFile2.getSomeAvg10();
            if (this.mHasPsiIoPermission) {
              PsiFile psiFile3 = getPsiFile(PsiFileType.IO, PsiDataType.AVG10);
              if (psiFile3.isEmpty()) {
                this.mHasPsiIoPermission = false;
                Slog.d("ActivityManager", "No permission - psi io");
              } else {
                d3 = psiFile3.getSomeAvg10();
                if (currentKpmRawPolicy != null) {
                  currentKpmRawPolicy.updatePsiInfo(d, d2, d3);
                }
                if (currentKpmRawBigdata == null) {
                  currentKpmRawBigdata.updatePsiInfo(d, d2, d3);
                  return;
                }
                return;
              }
  ...
  public boolean isKpmSafe(String str) {
    ...
    if (KPM_DEBUG) {
      Slog.d(
          "ActivityManager_kpm",
          "isKpmSafe() callingPackage : " + str + ", mPrevPackage : " + this.mPrevPackage);
    }
    return z;
  }
    ...
    synchronized (this.mPrevProcessList) {
      ...
      if (KPM_DEBUG) {
        for (int i = 0; i < this.mPrevProcessList.size(); i++) {
          Slog.i(
              "ActivityManager_kpm",
              "idx[" + i + "] Process name : " + ((String) this.mPrevProcessList.get(i)));
        }
      }
    }
  }
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public void calculateLmkdStatus(int i) {
    int curAdj;
    KpmRaw currentKpmRawPolicy = getCurrentKpmRawPolicy();
    KpmRaw currentKpmRawBigdata = getCurrentKpmRawBigdata();
    if (currentKpmRawPolicy == null || currentKpmRawBigdata == null) {
      return;
    }
    String currentProcess = getCurrentProcess();
    String prevProcess = getPrevProcess();
    String str = get2ndPrevProcess();
    ProcessRecord processRecord = null;
    for (int i2 = 0; i2 < this.mAm.mProcessList.getLruProcessesLOSP().size(); i2++) {
      try {
        try {
          ProcessRecord processRecord2 =
              (ProcessRecord) this.mAm.mProcessList.getLruProcessesLOSP().get(i2);
          if (processRecord2 != null && i == processRecord2.mPid) {
            try {
              if (KPM_DEBUG) {
                Slog.i(
                    "ActivityManager_kpm",
                    "getLruProcessesLOSP() pid[" + i + "] " + processRecord2.processName);
              }
              processRecord = processRecord2;
              break;
              ...
              curAdj = processRecord.mState.getCurAdj();
              boolean hasActivities = processRecord.hasActivities();
              if (KPM_DEBUG) {}
              if (curAdj == -10000) {}
            }
          }
    ...
    if (processRecord == null) {
      for (int i3 = 0; i3 < this.mAm.mProcessList.mRemovedProcesses.size(); i3++) {
        try {
          try {
            ProcessRecord processRecord3 =
                (ProcessRecord) this.mAm.mProcessList.mRemovedProcesses.get(i3);
            if (processRecord3 != null && i == processRecord3.mPid) {
              try {
                if (KPM_DEBUG) {
                  Slog.i(
                      "ActivityManager_kpm",
                      "mRemovedProcesses pid[" + i + "] " + processRecord3.processName);
                }
                processRecord = processRecord3;
                break;
                ...
                if (processRecord == null) {}
                curAdj = processRecord.mState.getCurAdj();
                boolean hasActivities2 = processRecord.hasActivities();
                if (KPM_DEBUG) {}
                if (curAdj == -10000) {}
              }
            }
      ...
      if (processRecord == null) {
        Slog.i(
            "ActivityManager_kpm", "calculateLmkdStatus pid[" + i + "] but don't get process info");
        return;
      }
    }
    curAdj = processRecord.mState.getCurAdj();
    boolean hasActivities22 = processRecord.hasActivities();
    if (KPM_DEBUG) {
      ...
      sb.append(" adj[");
      sb.append(curAdj);
      sb.append("] hasActivities ");
      sb.append(hasActivities22);
      Slog.i("ActivityManager_kpm", sb.toString());
    }
    if (curAdj == -10000) {
      return;
    }
    if (currentProcess != null
        && hasActivities22
        && currentProcess.equals(processRecord.processName)) {
      LmkdState lmkdState = LmkdState.LEVEL_14;
      currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState);
      currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState);
      String str2 = processRecord.processName + "_" + curAdj;
      Slog.i("ActivityManager_kpm", "calculateLmkdStatus currentProcess Killed " + str2);
      currentKpmRawPolicy.lmkdKilledProcessInfo.add(str2);
      currentKpmRawBigdata.lmkdKilledProcessInfo.add(str2);
    } else if (prevProcess != null
        && hasActivities22
        && prevProcess.equals(processRecord.processName)) {
      LmkdState lmkdState2 = LmkdState.LEVEL_10;
      currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState2);
      currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState2);
      if (!this.mProcessHeavyMemory.isThreadRunning) {
        this.mProcessHeavyMemory.clearHeavyList();
        this.mProcessHeavyMemory.gatherHeavyProcessThread(
            currentKpmRawPolicy, currentKpmRawBigdata);
      }
    } else if (str != null && hasActivities22 && str.equals(processRecord.processName)) {
      LmkdState lmkdState3 = LmkdState.LEVEL_8;
      currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState3);
      currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState3);
    } else if (curAdj < 830) {
      if (curAdj >= 50 && curAdj <= 250) {
        LmkdState lmkdState4 = LmkdState.LEVEL_12;
        currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState4);
        currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState4);
      } else {
        LmkdState lmkdState5 = LmkdState.LEVEL_5;
        currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState5);
        currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState5);
      }
    } else if (!hasActivities22) {
      LmkdState lmkdState6 = LmkdState.LEVEL_1;
      currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState6);
      currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState6);
    } else if (curAdj > 900) {
      LmkdState lmkdState7 = LmkdState.LEVEL_2;
      currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState7);
      currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState7);
    } else if (curAdj == 900) {
      LmkdState lmkdState8 = LmkdState.LEVEL_3;
      currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState8);
      currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState8);
    } else if (curAdj >= 830) {
      LmkdState lmkdState9 = LmkdState.LEVEL_4;
      currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState9);
      currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState9);
    } else {
      LmkdState lmkdState10 = LmkdState.LEVEL_6;
      currentKpmRawPolicy.updateLmkdStateAndCount(lmkdState10);
      currentKpmRawBigdata.updateLmkdStateAndCount(lmkdState10);
    }
    if (this.mProcessHeavyMemory.isThreadRunning) {
      this.mProcessHeavyMemory.setPeakLmkdKillLevel(curAdj);
    }
    if (KPM_DEBUG) {
      StringBuilder sb2 = new StringBuilder(128);
      Slog.i(
          "ActivityManager_kpm",
          "kpmRawBigdata lmkdState : " + currentKpmRawBigdata.lmkdState.getLevel());
      sb2.append("kpmRawBigdata lmkdStateCount [");
      for (LmkdState lmkdState11 : LmkdState.values()) {
        sb2.append(currentKpmRawBigdata.lmkdStateCount[lmkdState11.ordinal()]);
        sb2.append(", ");
      }
      sb2.append("]");
      Slog.i("ActivityManager_kpm", sb2.toString());
    }
  }
  ...
  public void calculateKpmStats(String str, String str2, int i) {
    ...
    PersonalizedMemoryManager.getInstance()
        .onMemoryEvent(this.mContext, PersonalizedMemoryManager.MemoryEventType.APP_LAUNCHED);
  }
  ...
  public KpmState changeState(KpmRaw kpmRaw) {
    ...
    if (lmkdCounter.cycleSeedbedKillCount
            + lmkdCounter.cyclePickedKillCount
            + kpmRaw.cachedNormalKillCount
        > 0) {
  ...
  public KpmState changeTinyKpmState(KpmRaw kpmRaw) {
    ...
    } else if (lmkdCounter.tinyCycleCachedMinKillCount + lmkdCounter.tinyCycleBServiceKillCount
        > 0) {
      kpmState = KpmState.HEAVY;
    } else if (lmkdCounter.tinyCycleSeedbedKillCount
            + lmkdCounter.tinyCyclePickedKillCount
            + (kpmRaw.cachedNormalKillCount - kpmRaw.prevTinyCachedNormalKillCount)
        > 0) {
  ...
  public void applyPolicy() {
    if (this.mPolicyMetric > 4) {
      float ordinal =
          (((this.mKpmRawPolicy[(r0 - 1) % 24].nextKpmState.ordinal()
                          + this.mKpmRawPolicy[(this.mPolicyMetric - 2) % 24].nextKpmState
                              .ordinal())
                      + this.mKpmRawPolicy[(this.mPolicyMetric - 3) % 24].nextKpmState.ordinal())
                  + this.mKpmRawPolicy[(this.mPolicyMetric - 4) % 24].nextKpmState.ordinal())
              / 4.0f;
      ...
      if (KPM_DEBUG) {
        Slog.d(
            "ActivityManager_kpm", "Current policy : " + kpmState + ", eval policy : " + kpmState);
      }
  ...
  public void dump(PrintWriter printWriter, String[] strArr) {
    if (strArr != null && strArr.length > 1) {
      ...
      if (str.equals("leak.dmabuf")) {
        ...
        PersonalizedMemoryManager.getInstance()
            .onMemoryEvent(this.mContext, PersonalizedMemoryManager.MemoryEventType.LMKD_KILL);
    ...
    if (this.mPolicyMetric >= 1) {
      ...
      printWriter.println(
          " [idx, peakLmkdKillAdj, [procMemInfo], [{native(Pss SwapPss"
              + " Rss)}{sys}{pers}{persvc}{fore}{vis}{percept}{perceptl}{perceptm}{backup}{heavy}{servicea}{home}{prev}{serviceb}{archived}{picked}{cached}],"
              + " [Process name, Process version, Package name, Package version, label, pss, swap,"
              + " rss, procstats_dumpPssUssRss], ...]");
      for (int i5 = 0; i5 < min; i5++) {
        printWriter.println(
            this.mKpmRawPolicy[i].getKpmHeavyPssData(this.mPolicyMetric).toString());
        i--;
        if (i < 0) {
          i = 23;
        }
    ...
    if (this.mBigdataMetric >= 1) {
      ...
      for (int i8 = 0; i8 < min2; i8++) {
        printWriter.println(
            this.mKpmRawBigdata[i2].getKpmHeavyPssData(this.mBigdataMetric).toString());
        i2--;
        if (i2 < 0) {
          i2 = 29;
        }
    ...
    printWriter.println(
        " MEMORY_CRITICAL_LOW_PROCESS_KILL_RATIO_TH : " + getCriticalLowProcessKillRatioTH() + "%");
    ...
    printWriter.println(
        " MEMORY_CRITICAL_LOW_PROCESS_KILL_PACKAGE_RATIO_TH : "
            + getCriticalLowPackageKillRatioTH()
            + "%");
    ...
    printWriter.println(
        " KPM_POLICY_SWAPPINESS_CURRENT : " + this.mSwappinessController.getValue());
    printWriter.println(" ");
  ...
  public void fillChimeraDataIfExist(KpmRaw kpmRaw, JSONObject jSONObject) {
    ...
    if (chimeraDataInfo != null) {
      jSONObject.put(
          "CHWT",
          new JSONArray()
              .put((int) ((chimeraDataInfo.getLruWight() * 100.0f) + 0.5d))
              .put((int) ((chimeraDataInfo.getStdBktWeight() * 100.0f) + 0.5d))
              .put((int) ((chimeraDataInfo.getMemWeight() * 100.0f) + 0.5d)));
      int[] triggerCntSrc = chimeraDataInfo.getTriggerCntSrc();
      ChimeraCommonUtil.TriggerSource triggerSource =
      ...
      ChimeraCommonUtil.TriggerSource triggerSource2 =
      ...
      ChimeraCommonUtil.TriggerSource triggerSource3 =
    ...
    if (str2 != null) {
      boolean sendHWParamToHQM =
          semHqmManager.sendHWParamToHQM(
              KPM_DEBUG ? 1 : 0, "Sluggish", str, "ph", "1.1", "sec", "", str2, "");
      if (KPM_DEBUG) {
        if (sendHWParamToHQM) {
  ...
  public void reportMemInfo() {
    ...
    try {
      ...
      for (int i2 = 0; i2 < 17; i2++) {
        ...
        long j = 0;
        long longValue =
            this.mVmStats.containsKey(str4) ? ((Long) this.mVmStats.get(str4)).longValue() : 0L;
  ...
  public void reportUserTrend(int i, KpmRaw kpmRaw) {
    ...
    try {
      ...
      jSONObject.put(
          "LNCT", new JSONArray().put(kpmRaw.hotCount).put(kpmRaw.warmCount).put(kpmRaw.coldCount));
        ...
        for (String str4 : ActivityManagerService.DUMP_MEM_OOM_COMPACT_LABEL) {
          jSONArray.put(
              kpmRaw.procsAdjPss.containsKey(str4)
                  ? (long) ((((long[]) kpmRaw.procsAdjPss.get(r9))[1] / 1024.0d) + 0.5d)
                  : 0L);
        }
        for (String str5 : ActivityManagerService.DUMP_MEM_OOM_COMPACT_LABEL) {
          jSONArray.put(
              kpmRaw.procsAdjPss.containsKey(str5)
                  ? (long) ((((long[]) kpmRaw.procsAdjPss.get(r9))[2] / 1024.0d) + 0.5d)
                  : 0L);
        }
      }
      ...
      if (arrayList != null && arrayList.size() > 0) {
        ...
        for (int i4 = 0; i4 < kpmRaw.dumpHeavyProcessList.size(); i4++) {
          ...
          jSONArray6
              ...
              .put((int) ((dumpHeavyProcessInfo.memoryInfo.swap_out / 1024.0d) + 0.5d))
  ...
  public enum LmkdCount {
    ...
    BORA_APP_ADJ(350),
    BACKUP_APP_ADJ(300),
    PERCEPTIBLE_LOW_APP_ADJ(FrameworkStatsLog.f446x58c6c32),
  ...
  public class KpmRaw {
    ...
    public KpmRaw(int i) {
      ...
      initLmkdPrevCount();
      this.lmkdCounter =
          KillPolicyManager.this.new LmkdCounter(this, KillPolicyManager.this.mLmkdReader);
    ...
    public void updateCycleInfo() {
      ...
      if (KillPolicyManager.this.mPolicyMetric != 1) {
        ...
        } else if (((System.currentTimeMillis() - KillPolicyManager.this.mKpmStartTime) / 1000) / 60
            >= 180) {
          this.nextKpmState = KillPolicyManager.this.changeState(this);
        } else {
    ...
    public final void dumpLmkdCount() {
      for (LmkdCount lmkdCount : LmkdCount.values()) {
        Integer lmkdKillCount = ProcessList.getLmkdKillCount(0, lmkdCount.getADJ());
        if (lmkdKillCount != null) {
          this.lmkdCurrentCount[lmkdCount.ordinal()] =
              lmkdKillCount.longValue() - this.lmkdPrevCount[lmkdCount.ordinal()];
          if (KillPolicyManager.KPM_DEBUG) {
            Slog.i(
                "ActivityManager_kpm",
    ...
    public final void checkMemCriticalLowTH() {
      ...
      if (i >= KillPolicyManager.MEMORY_CRITICAL_LOW_PROCESS_KILL_RATIO_TH) {
        if (!KillPolicyManager.MEMORY_CRITICAL_LOW_USE_PACKAGE_RATIO
            || KillPolicyManager.this.isCriticalKilledManyPakages(this.killedPackageRatio)) {
          i2 = 1;
        } else if (KillPolicyManager.KPM_DEBUG) {
          Slog.d(
              "ActivityManager_kpm",
              "checkMemCriticalLowTH() killRatio is over thrshold but not occurred many apps, so"
                  + " result not accepted");
        }
      }
      this.resetStatus = i2;
      if (KillPolicyManager.KPM_DEBUG) {
        Slog.d(
            "ActivityManager_kpm",
            "checkMemCriticalLowTH() memory critical status is " + this.resetStatus);
      }
      if (SystemClock.uptimeMillis() > Duration.ofDays(1L).toMillis()
          && KillPolicyManager.isDetectCritcialLowEnabled()
          && !this.isWarmUpCycle) {
    ...
    public final void updateRawProcessCount() {
      ...
      int i5 = 0;
      for (int i6 = 0;
          i6 < KillPolicyManager.this.mAm.mProcessList.getLruProcessesLOSP().size();
          i6++) {
        try {
          try {
            ProcessRecord processRecord =
                (ProcessRecord)
                    KillPolicyManager.this.mAm.mProcessList.getLruProcessesLOSP().get(i6);
            if (processRecord != null) {
    ...
    public final void addLaunchedPackage(String str) {
      ...
      if (KillPolicyManager.KPM_DEBUG && this == KillPolicyManager.this.getCurrentKpmRawPolicy()) {
        Slog.d(
            "ActivityManager_kpm",
            "add addLaunchedPackage : "
                + str
                + ", cur count : "
                + this.launchedAndKilledPackageMap.size());
      }
    }

    public final void markKilledPackage(String str, int i) {
      if (str == null
          || !this.launchedAndKilledPackageMap.containsKey(str)
          || ((Integer) this.launchedAndKilledPackageMap.get(str)).intValue() <= i) {
        return;
      }
      ...
      if (KillPolicyManager.KPM_DEBUG) {
        Slog.d(
            ...
            "markKilledPackage : "
                ...
                + i
                + ", killed adj : "
                + this.launchedAndKilledPackageMap.get(str));
      }
    }
    ...
    public final void updateRawResetStatus() {
      ...
      this.killedPackageRatio =
          KillPolicyManager.this.calcKilledPackageRatio(
              killedPackageCountOfAdj, this.launchedPackageCount);
    }
    ...
    public final void updateProcessHeavyPssList(
        ArrayList arrayList, ProcMemInfo procMemInfo, int i) {
    ...
    public StringBuilder getKpmHeavyPssData(int i) {
      ...
      if (this.dumpHeavyProcessList == null) {
        ...
        for (int i2 = 0; i2 < this.dumpHeavyProcessList.size(); i2++) {
          DumpHeavyProcessInfo dumpHeavyProcessInfo =
              (DumpHeavyProcessInfo) this.dumpHeavyProcessList.get(i2);
          sb.append(",[");
          ...
          sb.append(" mb, ");
          sb.append(
              KillPolicyManager.this.mProcessHeavyMemory.dumpPssUssRssToString(
                  dumpHeavyProcessInfo.pssUssRssInfo));
          sb.append("]");
        }
      }
      return sb;
  ...
  public class LmkdCountReader {
    ...
    public void readLmkdKillCount() {
      ...
      this.visToFgCountOfLmkd =
          getKillCountForAdjRange(0, FrameworkStatsLog.f690xa4f1b8b3, this.visToFgCountOfLmkd);
      if (KillPolicyManager.KPM_DEBUG) {
        StringBuilder sb = new StringBuilder(128);
  ...
  public class LmkdCounter {
    ...
    public void getCycleLmkdKillCountByADJ(LmkdCountReader lmkdCountReader) {
      ...
      this.cycleSeedbedKillCount =
          lmkdCountReader.seedbedCountOfLmkd - this.prevCycleSeedbedCountOfLmkd;
    ...
    public void getLmkdPreviousAndBServiceKillCount(LmkdCountReader lmkdCountReader) {
      ...
      this.cachedMinKillCount =
          lmkdCountReader.cachedMinCountOfLmkd - this.prevCachedMinCountOfLmkd;
      ...
      if (KillPolicyManager.KPM_DEBUG
          && this.kpmRaw == KillPolicyManager.this.getCurrentKpmRawPolicy()) {
        StringBuilder sb = new StringBuilder(128);
    ...
    public void fillTinyCycleLmkdKillCountByADJ(LmkdCountReader lmkdCountReader) {
      this.tinyCycleCachedMinKillCount =
          lmkdCountReader.cachedMinCountOfLmkd - this.prevTinyCycleCachedMinCountOfLmkd;
      this.tinyCycleSeedbedKillCount =
          lmkdCountReader.seedbedCountOfLmkd - this.prevTinyCycleSeedbedCountOfLmkd;
      this.tinyCyclePickedKillCount =
          lmkdCountReader.pickedCountOfLmkd - this.prevTinyCyclePickedCountOfLmkd;
      this.tinyCycleBServiceKillCount =
          lmkdCountReader.bServiceCountOfLmkd - this.prevTinyCycleBServiceCountOfLmkd;
      this.tinyCyclePreviousKillCount =
          lmkdCountReader.previousCountOfLmkd - this.prevTinyCyclePreviousCountOfLmkd;
      if (KillPolicyManager.KPM_DEBUG) {
        StringBuilder sb = new StringBuilder(128);
  ...
  public class ProcessMemoryHeavyInfo {
    ...
    public final ArrayList getPssUssRssInfo(ProcessState processState) {
      ...
      for (int i = 0; i < ProcessStats.ALL_SCREEN_ADJ.length; i++) {
        for (int i2 = 0; i2 < ProcessStats.ALL_MEM_ADJ.length; i2++) {
          for (int i3 = 0; i3 < ProcessStats.ALL_PROC_STATES.length; i3++) {
            int i4 =
                ((ProcessStats.ALL_SCREEN_ADJ[i] + ProcessStats.ALL_MEM_ADJ[i2]) * 16)
                    + ProcessStats.ALL_PROC_STATES[i3];
            long pssSampleCount = processState.getPssSampleCount(i4);
            if (pssSampleCount > 0) {
              DumpPssUssRssInfo dumpPssUssRssInfo = KillPolicyManager.this.new DumpPssUssRssInfo();
      ...
      if (arrayList.size() == 0) {
        DumpPssUssRssInfo dumpPssUssRssInfo2 = KillPolicyManager.this.new DumpPssUssRssInfo();
    ...
    public void gatherHeavyProcessThread(final KpmRaw kpmRaw, final KpmRaw kpmRaw2) {
      Thread thread =
          new Thread(
              "PMMProcessHeavyDumpThread") { // from class:
                                             // com.android.server.am.KillPolicyManager.ProcessMemoryHeavyInfo.1
            ...
            public void run() {
              try {
                ...
                KpmRaw kpmRaw3 = kpmRaw2;
                if (kpmRaw3 != null && !kpmRaw3.isGetPssDump) {
                  ProcessMemoryHeavyInfo processMemoryHeavyInfo2 = ProcessMemoryHeavyInfo.this;
                  processMemoryHeavyInfo2.getProcessMemoryDumpInformation(
                      true, processMemoryHeavyInfo2.procMemInfo);
                  KpmRaw kpmRaw4 = kpmRaw2;
                  ProcessMemoryHeavyInfo processMemoryHeavyInfo3 = ProcessMemoryHeavyInfo.this;
                  kpmRaw4.updateProcessHeavyPssList(
                      processMemoryHeavyInfo3.dumpHeavyProcessList,
                      processMemoryHeavyInfo3.procMemInfo,
                      processMemoryHeavyInfo3.peakLmkdKillAdj);
                  kpmRaw2.updateMemoryUsageByAdj(ProcessMemoryHeavyInfo.this.memoryUsageByAdj);
                  ...
                  processMemoryHeavyInfo4.getProcessMemoryDumpInformation(
                      false, processMemoryHeavyInfo4.procMemInfo);
                }
                KpmRaw kpmRaw5 = kpmRaw;
                if (kpmRaw5 != null) {
                  ProcessMemoryHeavyInfo processMemoryHeavyInfo5 = ProcessMemoryHeavyInfo.this;
                  kpmRaw5.updateProcessHeavyPssList(
                      processMemoryHeavyInfo5.dumpHeavyProcessList,
                      processMemoryHeavyInfo5.procMemInfo,
                      processMemoryHeavyInfo5.peakLmkdKillAdj);
                  kpmRaw.updateMemoryUsageByAdj(ProcessMemoryHeavyInfo.this.memoryUsageByAdj);
                }
                if (KillPolicyManager.KPM_DEBUG) {
                  Slog.d(
                      "ActivityManager_kpm",
                      "ProcessMemoryHeavy peakLmkdKillAdj : "
                          + ProcessMemoryHeavyInfo.this.peakLmkdKillAdj);
                  ProcessMemoryHeavyInfo processMemoryHeavyInfo6 = ProcessMemoryHeavyInfo.this;
                  processMemoryHeavyInfo6.showDebugHeavyProcess(
                      processMemoryHeavyInfo6.dumpHeavyProcessList);
      ...
      this.mProcessMemoryDumpThread = thread;
    ...
    public final void fillMemoryUsageByAdj(ActivityManagerService.MemDumpInfo memDumpInfo) {
      if (!this.memoryUsageByAdj.containsKey(memDumpInfo.label)) {
        this.memoryUsageByAdj.put(
            memDumpInfo.label, new long[] {memDumpInfo.pss, memDumpInfo.swap_out, memDumpInfo.rss});
        return;
      }
    ...
    public final void fillDumpHeavyProcessTop5ByAdj(
      ...
      if (!this.dumpHeavyProcessByAdj.containsKey(memDumpInfo.label)) {
        ...
        DumpHeavyProcessInfo dumpHeavyProcessInfo =
            KillPolicyManager.this.new DumpHeavyProcessInfo();
      ...
      if (arrayList2.size() < 5) {
        DumpHeavyProcessInfo dumpHeavyProcessInfo2 =
            KillPolicyManager.this.new DumpHeavyProcessInfo();
    ...
    public final void reportHeavyProcessTop5ByAdj() {
      ...
      try {
        ...
        while (i4 < length2) {
          ...
          if (!this.dumpHeavyProcessByAdj.containsKey(str2)
              || (arrayList = (ArrayList) this.dumpHeavyProcessByAdj.get(str2)) == null
              || arrayList.size() <= 0) {
            strArr = strArr2;
            i = length2;
            i2 = i4;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void getProcessMemoryDumpInformation(boolean z, ProcMemInfo procMemInfo) {
      int i;
      DumpHeavyProcessInfo dumpHeavyProcessInfo;
      boolean z2;
      long j;
      ...
      long currentTimeMillis = System.currentTimeMillis();
      if (this.procMemInfo != null) {
        i = procMemInfo.memTotal;
      } else {
        i = KillPolicyManager.this.mTotalMem * 1024;
      }
      long j2 = (long) ((i * 1024 * 0.3d) + 0.5d);
      List dumpMemoryInfo = KillPolicyManager.this.mAm.getDumpMemoryInfo(z);
      this.procMemDumpInfoList = dumpMemoryInfo;
      long j3 = 0;
      if (dumpMemoryInfo != null && dumpMemoryInfo.size() > 0) {
        ArrayList arrayList2 =
            new ArrayList(KillPolicyManager.this.mAm.mProcessList.getLruProcessesLOSP());
        this.procMemDumpInfoList.sort(new PssComparator());
        Iterator it = this.procMemDumpInfoList.iterator();
        while (it.hasNext()) {
          ActivityManagerService.MemDumpInfo memDumpInfo =
              (ActivityManagerService.MemDumpInfo) it.next();
          if (memDumpInfo.procName != null) {
            Iterator it2 = it;
            ProcessState processState = null;
            if (this.dumpHeavyProcessList.size() < 5) {
              DumpHeavyProcessInfo dumpHeavyProcessInfo2 =
                  KillPolicyManager.this.new DumpHeavyProcessInfo();
              this.dumpHeavyProcessList.add(dumpHeavyProcessInfo2);
              dumpHeavyProcessInfo2.memoryInfo = memDumpInfo;
              z2 = true;
              dumpHeavyProcessInfo = dumpHeavyProcessInfo2;
            } else {
              dumpHeavyProcessInfo = null;
              z2 = false;
            }
            if (z2 || z) {
              j = currentTimeMillis;
              ...
              while (true) {
                try {
                  ...
                  try {
                    ProcessRecord processRecord = (ProcessRecord) arrayList2.get(i2);
                    if (processRecord != null) {
                      arrayList = arrayList2;
                      try {
                        try {
                          if (memDumpInfo.procName.equals(processRecord.processName)) {
                            processState = processRecord.mProfile.getBaseProcessTracker();
                            break;
                          }
                        } catch (IndexOutOfBoundsException e) {
                          e = e;
                        ...
                        e = e2;
                        Slog.e("ActivityManager_kpm", Log.getStackTraceString(e));
                        fillMemoryUsageByAdj(memDumpInfo);
                        if (!"vis".equals(memDumpInfo.label)) {}
                        j3 += memDumpInfo.pss + memDumpInfo.swap_out;
                        this.fgsMemDumpList.add(memDumpInfo);
                        if (KillPolicyManager.KPM_DEBUG) {}
                        it = it2;
                        currentTimeMillis = j;
                        arrayList2 = arrayList;
              ...
              if (z2) {
                fillProcessPackageNameAndVersion(processState2, dumpHeavyProcessInfo);
                dumpHeavyProcessInfo.pssUssRssInfo = getPssUssRssInfo(processState2);
              }
              if (z) {
                fillDumpHeavyProcessTop5ByAdj(memDumpInfo, processState2);
              }
            } else {
              j = currentTimeMillis;
              arrayList = arrayList2;
            ...
            fillMemoryUsageByAdj(memDumpInfo);
            if (!"vis".equals(memDumpInfo.label)
                || "percept".equals(memDumpInfo.label)
                || "perceptl".equals(memDumpInfo.label)
                || "perceptm".equals(memDumpInfo.label)) {
              j3 += memDumpInfo.pss + memDumpInfo.swap_out;
              this.fgsMemDumpList.add(memDumpInfo);
            }
            if (KillPolicyManager.KPM_DEBUG) {
              StringBuilder sb = new StringBuilder(128);
              sb.append("getProcessMemoryDumpInformation() process : ");
              sb.append(memDumpInfo.procName);
              sb.append(", adj: ");
              sb.append(memDumpInfo.label);
              sb.append(", pss: ");
              sb.append((int) ((memDumpInfo.pss / 1024.0d) + 0.5d));
              sb.append(" mb, swap: ");
              sb.append((int) ((memDumpInfo.swap_out / 1024.0d) + 0.5d));
              sb.append(" mb, rss: ");
              sb.append((int) ((memDumpInfo.rss / 1024.0d) + 0.5d));
              sb.append(" mb");
              Slog.d("ActivityManager_kpm", sb.toString());
            }
            it = it2;
      ...
      Slog.i(
          "ActivityManager_kpm",
          "fgsMemDumpList total size " + j5 + " kb, Threshold(30%) " + j2 + " kb");
      if (KillPolicyManager.KPM_DEBUG) {
        long currentTimeMillis2 = System.currentTimeMillis() - j4;
        if (j5 >= j2) {
          for (int i3 = 0; i3 < this.fgsMemDumpList.size(); i3++) {
            ActivityManagerService.MemDumpInfo memDumpInfo2 =
                (ActivityManagerService.MemDumpInfo) this.fgsMemDumpList.get(i3);
            StringBuilder sb2 = new StringBuilder(128);
            sb2.append("fgsMemDumpList process : ");
            sb2.append(memDumpInfo2.procName);
            sb2.append(", adj: ");
            sb2.append(memDumpInfo2.label);
            sb2.append(", pss: ");
            sb2.append((int) ((memDumpInfo2.pss / 1024.0d) + 0.5d));
            sb2.append(" mb, swap: ");
            sb2.append((int) ((memDumpInfo2.swap_out / 1024.0d) + 0.5d));
            sb2.append(" mb, rss: ");
            sb2.append((int) ((memDumpInfo2.rss / 1024.0d) + 0.5d));
            sb2.append(" mb");
            Slog.d("ActivityManager_kpm", sb2.toString());
          }
        }
        if (z) {
          for (String str : ActivityManagerService.DUMP_MEM_OOM_COMPACT_LABEL) {
            if (this.dumpHeavyProcessByAdj.containsKey(str)) {
              ArrayList arrayList3 = (ArrayList) this.dumpHeavyProcessByAdj.get(str);
              Slog.d("ActivityManager_kpm", "[ADJ Label] : " + str + " - Top " + arrayList3.size());
              showDebugHeavyProcess(arrayList3);
            } else {
        ...
        Slog.i(
            "ActivityManager_kpm",
            "getProcessMemoryDumpInformation() elapsed time " + currentTimeMillis2 + " ms");
      }
    }
  ...
  public class ProcessMemoryUsageInfo {
    ...
    public void getProcDumpMemInfoThread(final KpmRaw kpmRaw) {
      Thread thread =
          new Thread(
              "KPMProcessMemoryDumpThread") { // from class:
                                              // com.android.server.am.KillPolicyManager.ProcessMemoryUsageInfo.1
            @Override // java.lang.Thread, java.lang.Runnable
            public void run() {
              try {
                ...
                kpmRaw.updateProcAdjPss(ProcessMemoryUsageInfo.this.procsMemoryPssKbByADJ);
                KpmRaw kpmRaw2 = kpmRaw;
                if (kpmRaw2.isStateChanged) {
                  KillPolicyManager.this.reportUserTrend(0, kpmRaw2);
                }
                KpmRaw kpmRaw3 = kpmRaw;
                if (kpmRaw3.isDailyBigdata) {
                  KillPolicyManager.this.reportUserTrend(1, kpmRaw3);
                }
              } catch (Exception e) {
                e.printStackTrace();
              }
      ...
      this.mProcDumpMemThread = thread;
      thread.start();
    }
    ...
    public final void getProcDumpMemInfoInternal(int i, String str) {
      ...
      if (!this.procsMemoryPssKbByADJ.containsKey(str)) {
        this.procsMemoryPssKbByADJ.put(
            str, new long[] {smapsRollupPid[0], smapsRollupPid[1], smapsRollupPid[2], 1});
      } else {
    ...
    public final void getProcDumpMemInfo() {
      ...
      KillPolicyManager.this.mAm.mAppProfiler.forAllCpuStats(
          new Consumer() { // from class:
                           // com.android.server.am.KillPolicyManager$ProcessMemoryUsageInfo$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              KillPolicyManager.ProcessMemoryUsageInfo.this.lambda$getProcDumpMemInfo$0(
                  sparseArray, (ProcessCpuTracker.Stats) obj);
            }
          });
        ...
        while (true) {
          ...
          if (i >= iArr.length) {
            ...
            break;
              ...
              || (setAdjWithServices >= iArr[i] && setAdjWithServices < iArr[i + 1])) {
            break;
          } else {
            i++;
          }
    ...
    public /* synthetic */ void lambda$getProcDumpMemInfo$0(
        SparseArray sparseArray, ProcessCpuTracker.Stats stats) {
  ...
  public class PsiFile {
    ...
    public PsiFile(String str, final PsiDataType psiDataType) {
      if (!TextUtils.isEmpty(str)) {
        Arrays.stream(str.split(KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE))
            .forEach(
                new Consumer() { // from class:
                                 // com.android.server.am.KillPolicyManager$PsiFile$$ExternalSyntheticLambda0
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
  ...
  public class SwappinessController {
    ...
    public void setValue(int i) {
      if (i <= this.mDefaultValue) {
        Slog.i(
            "ActivityManager",
            "SwappinessController() - new value is lower than default value, go back to default");
        i = this.mDefaultValue;
      }
      SystemProperties.set("sys.sysctl.swappiness", String.valueOf(i));
      Slog.i(
          "ActivityManager",
          "SwappinessController() - changed from " + this.mCurrentValue + " -> " + i);
  ...
  public class ChimeraTriggerManager {
    public static final float PMM_CRITICAL_SCORE_THRESHOLD =
        Float.parseFloat(
            SystemProperties.get("persist.sys.kpm.debug.chimera_critical_score_threshold", "3.0"));
    ...
    public void onDeviceIdleChanged(boolean z) {
      Log.d(
          "ActivityManager",
          "ChimeraTriggerManager::onReceive() -  deviceInDoze: "
              + z
              + ", chimeraTriggerRequired: "
              + this.mChimeraTriggerRequired);
      if (z && this.mChimeraTriggerRequired) {
        long currentTimeMillis = System.currentTimeMillis() - this.mLastTriggeredTime;
        Log.d(
            "ActivityManager",
            "ChimeraTriggerManager::onReceive() - need to trigger, elapsedTime: "
                + currentTimeMillis);
        if (currentTimeMillis < TRIGGER_MIN_INTERVAL) {
          Log.d(
              "ActivityManager",
              "ChimeraTriggerManager::onReceive() - Not enough time has passed since the previous"
                  + " trigger.");
        } else {
          Log.d(
              "ActivityManager",
              "ChimeraTriggerManager::onReceive() - PMM_CRITICAL_TRIGGER_ACTION has been fired.");
          Intent intent = new Intent("com.samsung.PMM_CRITICAL_TRIGGER");
          intent.setPackage("android");
          this.mContext.sendBroadcastAsUser(
              intent,
              UserHandle.ALL,
              "com.samsung.android.permission.BROADCAST_PMM_CRITICAL_TRIGGER");
  ...
  public class MemoryFloodDetector {
    ...
    public void onDeviceIdleChanged(boolean z) {
      if (z) {
        ...
        long currentTimeMillis = System.currentTimeMillis();
        if (uptimeMillis - this.mLastUptimeMillis > Duration.ofDays(2L).toMillis()
            || currentTimeMillis - this.mLastRealTimeMillis > Duration.ofDays(2L).toMillis()) {
          recordPmmDump();
        }
        if (uptimeMillis - this.mLastUptimeMillis
                > Duration.ofHours(KillPolicyManager.sNeverCollectWithin).toMillis()
            || currentTimeMillis - this.mLastRealTimeMillis
                > Duration.ofHours(KillPolicyManager.sNeverCollectWithin).toMillis()) {
          recordIdleMemDump();
      ...
      try {
        ...
        if (split.length >= 3) {
          ...
          for (int i = 0; i < parseInt; i++) {
            this.mNativeMemDumpList.add(
                KillPolicyManager.this
                .new MemoryDumpItem(
                    (long) ((i * parseDouble2) + parseDouble), MemoryLoggingType.IdleDump));
          }
          if (split.length >= 4) {
      ...
      if (this.mNativeMemDumpList.size() > 1) {
        try {
          ...
          SystemProperties.set(
              "sys.pmm.nativemse",
              Double.toString(((Double) linearRegressionFactor.first).doubleValue())
                  + ","
                  + Double.toString(((Double) linearRegressionFactor.second).doubleValue())
                  + ","
                  + Integer.toString(this.mNativeMemDumpList.size())
                  + ","
                  + (this.mPmmCycleCountOnPlatformReset + KillPolicyManager.this.mPolicyMetric));
        } catch (Exception e) {
    ...
    public void recordPmmDump() {
      ...
      if (Long.MAX_VALUE != j) {
        ...
        list.add(killPolicyManager.new MemoryDumpItem(j, memoryLoggingType));
        this.mSystemMemDumpList.add(
            KillPolicyManager.this.new MemoryDumpItem(j2, memoryLoggingType));
        this.mPersistentMemDumpList.add(
            KillPolicyManager.this.new MemoryDumpItem(j4 + j3, memoryLoggingType));
      }
      Slog.i(
          "ActivityManager_kpm",
          "recordPmmDump ("
    ...
    public void recordIdleMemDump() {
      ...
      long j2;
      long j3;
      if (this.mNativeMemDumpList.size() > KillPolicyManager.sCompactTriggerSize) {
        this.mNativeMemDumpList = getCompactList(this.mNativeMemDumpList);
      }
      if (this.mSystemMemDumpList.size() > KillPolicyManager.sCompactTriggerSize) {
        this.mSystemMemDumpList = getCompactList(this.mSystemMemDumpList);
      }
      if (this.mPersistentMemDumpList.size() > KillPolicyManager.sCompactTriggerSize) {
        this.mPersistentMemDumpList = getCompactList(this.mPersistentMemDumpList);
      }
      List<ActivityManagerService.MemDumpInfo> dumpMemoryInfo =
          KillPolicyManager.this.mAm.getDumpMemoryInfo();
      if (dumpMemoryInfo == null || dumpMemoryInfo.size() <= 0) {
        j = 0;
        j2 = 0;
        j3 = 0;
        ...
        j2 = 0;
        j3 = 0;
        for (ActivityManagerService.MemDumpInfo memDumpInfo : dumpMemoryInfo) {
          if (!TextUtils.isEmpty(memDumpInfo.label)) {
            String str = memDumpInfo.label;
            str.hashCode();
            switch (str) {
              case "native":
                j += memDumpInfo.pss + memDumpInfo.swap_out;
                break;
              case "persvc":
              case "pers":
                j3 += memDumpInfo.pss + memDumpInfo.swap_out;
                break;
              case "sys":
                j2 += memDumpInfo.pss + memDumpInfo.swap_out;
                break;
            }
          }
        }
      ...
      if (j > 0) {
        this.mNativeMemDumpList.add(
            KillPolicyManager.this.new MemoryDumpItem(j, MemoryLoggingType.IdleDump));
      }
      if (j2 > 0) {
        this.mSystemMemDumpList.add(
            KillPolicyManager.this.new MemoryDumpItem(j2, MemoryLoggingType.IdleDump));
      }
      if (j3 > 0) {
        this.mPersistentMemDumpList.add(
            KillPolicyManager.this.new MemoryDumpItem(j3, MemoryLoggingType.IdleDump));
      }
      Slog.i(
          "ActivityManager_kpm",
          "recordIdleMemDump ("
              ...
              + ") added. total size : "
              + this.mNativeMemDumpList.size());
      reportMemoryFlood2Hqm();
      this.mLastUptimeMillis = SystemClock.uptimeMillis();
          ...
          list.stream()
              .mapToLong(
                  new ToLongFunction() { // from class:
                                         // com.android.server.am.KillPolicyManager$MemoryFloodDetector$$ExternalSyntheticLambda0
                    @Override // java.util.function.ToLongFunction
                    public final long applyAsLong(Object obj) {
                      long lambda$getJsonSummary$0;
                      lambda$getJsonSummary$0 =
                          KillPolicyManager.MemoryFloodDetector.lambda$getJsonSummary$0(
                              (KillPolicyManager.MemoryDumpItem) obj);
                      return lambda$getJsonSummary$0;
                    }
                  })
              .summaryStatistics();
      jSONArray
          .put((int) ((((MemoryDumpItem) list.get(list.size() - 1)).mDumpSize / 1024) + 0.5d))
    ...
    public void reportMemoryFlood2Hqm() {
      ...
      try {
        ...
        JSONArray jSONArray = new JSONArray();
        jSONArray
            .put((int) ((KillPolicyManager.this.mLastAwakeRealTimeMillis / 1000.0f) + 0.5d))
            .put((int) ((KillPolicyManager.this.mLastAwakeUpTimeMillis / 1000.0f) + 0.5d))
            .put((int) ((KillPolicyManager.this.mLastIdleRealTimeMillis / 1000.0f) + 0.5d))
            .put((int) (((System.currentTimeMillis() - this.mLastRealTimeMillis) / 1000.0f) + 0.5d))
            .put((int) (((SystemClock.uptimeMillis() - this.mLastUptimeMillis) / 1000.0f) + 0.5d));
    ...
    public boolean isFlood(double d, double d2, boolean z) {
      return d
              * ((double)
                  ((z ? KillPolicyManager.sNativeFloodRatio : KillPolicyManager.sSyspersFloodRatio)
                      + 100))
          < d2 * 100.0d;
    }
    ...
    public void calculateMemoryFlood() {
      if (this.mNativeMemDumpList.size() >= KillPolicyManager.sMinTriggerSize) {
        ...
        double doubleValue2 =
            (((Double) linearRegressionFactor.first).doubleValue() * size) + doubleValue;
        Slog.i(
            "ActivityManager_kpm",
            "nativeFactor : "
                ...
                + ", "
                + doubleValue2);
        this.mLastCalculatedNative =
            new Pair(Integer.valueOf((int) doubleValue), Integer.valueOf((int) doubleValue2));
      }
      if (this.mSystemMemDumpList.size() >= KillPolicyManager.sMinTriggerSize) {
        ...
        double d = size2;
        double doubleValue4 =
            (((Double) linearRegressionFactor2.first).doubleValue() * d)
        ...
        Slog.i(
            ...
            "sysFactor : "
                ...
                + ", "
                + doubleValue4);
        this.mLastCalculatedSysPers =
            new Pair(Integer.valueOf((int) doubleValue3), Integer.valueOf((int) doubleValue4));
      }
    }
    ...
    public boolean isRequiredPlatformReset() {
      ...
      return isFlood(
          ((Integer) this.mLastCalculatedSysPers.first).intValue(),
          ((Integer) this.mLastCalculatedSysPers.second).intValue(),
          false);
    }
    ...
    public boolean isRequiredKernelReset() {
      ...
      return isFlood(
          ((Integer) this.mLastCalculatedNative.first).intValue(),
          ((Integer) this.mLastCalculatedNative.second).intValue(),
          true);
    }
  ...
  public abstract class ProcFileInfoGetter {
    ...
    public static long getLMKCountInfo() {
      ...
      Process.readProcFile(
          "/sys/module/lowmemorykiller/parameters/lmkcount", new int[] {8224}, null, jArr, null);
      return jArr[0];
    }
