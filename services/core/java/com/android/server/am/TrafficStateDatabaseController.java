...
public class TrafficStateDatabaseController {
  ...
  public static final Uri CONTENT_URI =
      Uri.parse("content://com.tmobile.oem.echolocate.system.provider/trafficstats");
  public static final String[] DELETE_QUERY_VALUE = {"0"};
  public static final Signature ECHO_APP_SIG =
      new Signature(
  ...
  public static final INetdEventCallback mNetdEventCallback =
      new BaseNetdEventCallback() { // from class:
                                    // com.android.server.am.TrafficStateDatabaseController.1
        public void onConnectEvent(String str, int i, long j, int i2) {}

        public void onDnsEvent(
            int i, int i2, int i3, String str, String[] strArr, int i4, long j, int i5) {
          String str2 = "-1";
          try {
            if (TrafficStateDatabaseController.objTrafficStats.size() >= 200
                || !TrafficStateDatabaseController.ismInsertList()
                || !TrafficStateDatabaseController.isTMONetworkCode()) {
              TrafficStateDatabaseController.setmInsertList(false);
              TrafficStateDatabaseController.log(
                  "onDnsEvent(): Max List Size= "
                      + TrafficStateDatabaseController.objTrafficStats.size()
                      + ", mInsertList= "
                      + TrafficStateDatabaseController.ismInsertList()
                      + "mInsertDb= "
                      + TrafficStateDatabaseController.ismInsertDb());
              if (TrafficStateDatabaseController.ismInsertDb()) {
            ...
            if (i4 > 0) {
              TrafficStateDatabaseController.log(
                  "onDnsEvent():  objTrafficStats.size= "
                      + TrafficStateDatabaseController.objTrafficStats.size()
                      + ", mInsertList= "
                      + TrafficStateDatabaseController.ismInsertList());
              TrafficStateDatabaseController.setmInsertDb(true);
              String arrays = strArr != null ? Arrays.toString(strArr) : "000.000.00.00";
              long cellId = TrafficStateDatabaseController.getCellId();
              int rsrp = TrafficStateDatabaseController.getRsrp();
              String techType = TrafficStateDatabaseController.getTechType();
              ...
              if (TrafficStateDatabaseController.isWifiConnected()) {
              ...
              contentValues.put("rsrp", Integer.valueOf(rsrp));
      ...
      if (sInstance == null) {
        ...
        if (ShouldReport()) {
          IIpConnectivityMetrics asInterface =
              IIpConnectivityMetrics.Stub.asInterface(ServiceManager.getService("connmetrics"));
  ...
  public static boolean isEchoAppSigPresent() {
    try {
      Signature[] signatureArr =
          mContext.getPackageManager().getPackageInfo("com.tmobile.echolocate", 64).signatures;
  ...
  public static boolean isTMONetworkCode() {
    return "TMB"
        .equals(
            TelephonyFeatures.getNetworkCode(
  ...
  public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      if (intent == null
          ...
          || !intent.getAction().equals("com.samsung.intent.ACTION_INSERT_TRAFFIC_STATE_DB")) {
        return;
      }
      TrafficStateDatabaseController.log("onReceive(): ACTION_DELETE_TRAFFIC_STATE_DB");
      final BroadcastReceiver.PendingResult goAsync = goAsync();
      TrafficStateDatabaseController.getAsyncHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.am.TrafficStateDatabaseController$AlarmReceiver$$ExternalSyntheticLambda0
    ...
    synchronized (TrafficStateDatabaseController.class) {
      ...
      if (ShouldReport()) {
        ...
        if (telephonyManager != null
            && (trafficStatsTelephonyCallback = mTelephonyCallback) != null) {
  ...
  public class TrafficStatsTelephonyCallback extends TelephonyCallback
    ...
    public void onPhysicalChannelConfigChanged(List list) {
      if (list == null || !TrafficStateDatabaseController.isTMONetworkCode()) {
        return;
      }
      TrafficStateDatabaseController.log("PhysicalChannelConfigChanged");
      TrafficStateDatabaseController.bandNumber = TrafficStateDatabaseController.bandFromCP();
    }
  }
  ...
  public static void insertValues() {
    try {
      if (objTrafficStats != null) {
        ...
        setmInsertList(true);
        log(
            "after Clear objTrafficStats.Size = "
                + objTrafficStats.size()
                + ", mInsertList= "
                + ismInsertList());
        return;
      }
  ...
  public static String getMD5Hash(String str) {
    try {
      String bigInteger =
          new BigInteger(
                  1,
                  MessageDigest.getInstance("MD5").digest(str.getBytes(Charset.forName("UTF-8"))))
              .toString(16);
  ...
  public static String[] invokeOemRilRequestRaw(int i) {
    if (mSubscriptionManager != null && mTelephonyManager != null) {
      ...
      int invokeOemRilRequestRawForSubscriber =
          mTelephonyManager.invokeOemRilRequestRawForSubscriber(
              defaultDataSubscriptionId, getCommandsToCp(i), bArr);
      ...
      logD(
          "invokeOemRilRequestRaw: msg= "
              + i
              + ", resultFromCp= "
              + Arrays.toString(resultsFromBytes));
  ...
  public static String bandFromCP() {
    ...
    primaryBandwidth = "-1";
    if (invokeOemRilRequestRaw != null
        && (getTechTypeFromCp(invokeOemRilRequestRaw[1]).equals("NR")
            || getTechTypeFromCp(invokeOemRilRequestRaw[1]).equals("LTE"))) {
