...
public class CarConnectedFilter implements IFilter {
    ...
    public void init(Context context) {
        ...
        listener = new OnCarConnectionStateListener() { // from class: com.android.server.am.mars.filter.filter.CarConnectedFilter.1
            ...
            public void onCarConnected() {
                ...
                MARsPolicyManager.getInstance().addFilterDebugInfoToHistory("FILTER 31", "android auto on");
            }

            @Override // com.android.server.am.mars.filter.filter.CarConnectedFilter.OnCarConnectionStateListener
            public void onCarDisconnected() {
                CarConnectedFilter.this.isCarConnected.set(false);
                MARsPolicyManager.getInstance().addFilterDebugInfoToHistory("FILTER 31", "android auto off");
            }
        };
        registerReceiver();
        queryForState();
    ...
    public void onAutoAppBind(String str, int i) {
        synchronized (this.userIdPackageListSelfLocked) {
            ArrayList arrayList = (ArrayList) this.userIdPackageListSelfLocked.computeIfAbsent(Integer.valueOf(i), new Function() { // from class: com.android.server.am.mars.filter.filter.CarConnectedFilter$$ExternalSyntheticLambda0
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    ArrayList lambda$onAutoAppBind$0;
                    lambda$onAutoAppBind$0 = CarConnectedFilter.lambda$onAutoAppBind$0((Integer) obj);
