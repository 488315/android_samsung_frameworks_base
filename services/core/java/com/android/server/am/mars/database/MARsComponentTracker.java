...
public class MARsComponentTracker {
  ...
  public void trackComponent(
      boolean z, String str, String str2, String str3, int i, int i2, boolean z2) {
    ...
    if (z) {
      if (i == 0) {
        MARsDBManager.getInstance()
            .sendUpdateAppStartUpInfoMsgToDBHandler(str3, str2, z, currentTimeMillis);
        return;
      }
      return;
    }
  ...
  public void sendCTInfo(
    ...
    FrameworkStatsLog.write(
        FrameworkStatsLog.COMPONENT_TRACKER_REPORTED,
        i2,
        isSystem(str7) ? "system" : str7,
        i3,
        str6,
        getHostingType(str3),
        str4,
  ...
  public void sendBHInfo(int i, String str, String str2, int i2) {
    FrameworkStatsLog.write(
        FrameworkStatsLog.BOTTLENECK_HINT_REPORTED, i, getBottleneckReason(str), i2, str2);
  }
}
