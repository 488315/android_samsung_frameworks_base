...
public final class CameraInFgsFilter implements IFilter {
    ...
    public final AnonymousClass1 mCameraDeviceStateCallback =
            new CameraManager
                    .SemCameraDeviceStateCallback() { // from class:
                                                      // com.android.server.am.mars.filter.filter.CameraInFgsFilter.1
    ...
    public final int filter(int i, int i2, int i3, String str) {
        ...
        return (MARsPolicyManager.MARsPolicyManagerHolder.INSTANCE.getForegroundServiceStartTime(i2)
                                == 0
                        || (set = this.mCameraUsingList) == null
    ...
    public final void init(Context context) {
        ...
        this.mCameraManager.registerSemCameraDeviceStateCallback(
