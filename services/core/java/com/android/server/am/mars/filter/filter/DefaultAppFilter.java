...
public final class DefaultAppFilter implements IFilter {
    ...
    public final class DefaultAppChangedReceiver extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            if ("android.telecom.action.DEFAULT_DIALER_CHANGED".equals(action)) {
                DefaultAppFilter.this.mDefaultDialerPackage =
            ...
            if ("android.provider.action.DEFAULT_SMS_PACKAGE_CHANGED_INTERNAL".equals(action)) {
                ComponentName defaultSmsApplicationAsUser =
                        SmsApplication.getDefaultSmsApplicationAsUser(
                                context, false, (UserHandle) null);
                DefaultAppFilter.this.mDefaultSmsPackage =
                ...
                defaultAppFilter.mDefaultHomePackage =
                        homeActivities != null ? homeActivities.getPackageName() : null;
            }
        }
    }
    ...
    public final void deInit() {
        try {
            if (this.mInputMethodObserverRegistered) {
                this.mContext
                        .getContentResolver()
                        .unregisterContentObserver(this.mInputMethodObserver);
                this.mInputMethodObserverRegistered = false;
            }
        } catch (IllegalArgumentException unused) {
            Slog.e(
                    "MARs:DefaultAppFilter",
                    "IllegalArgumentException occurred in unregisterDefaultIMEContentObserver()");
        }
    ...
    public final int filter(int i, int i2, int i3, String str) {
        ...
        if (this.mDefaultIMEList != null) {
            ...
            if ((!MARsPolicyManager.isChinaModel || MARsUtils.getScreenOnState())
                    && (str2 = (String) this.mDefaultIMEList.get(Integer.valueOf(i))) != null
                    && str2.equals(str)) {
                return 11;
            }
        }
    ...
    public final void getDefaultIMEPackage(int i) {
        ...
        if (i < 0) {
            NandswapManager$$ExternalSyntheticOutline0.m(
                    i,
                    "getDefaultIMEPackage called with invalid userId : ",
                    "MARs:DefaultAppFilter");
            return;
        }
    ...
    public final void init(Context context) {
        ...
        this.mDefaultSmsPackage =
                defaultSmsApplication != null ? defaultSmsApplication.getPackageName() : null;
        getDefaultIMEPackage(userId);
        ComponentName homeActivities =
                this.mContext.getPackageManager().getHomeActivities(new ArrayList());
        ...
        if (!this.mInputMethodObserverRegistered) {
            this.mInputMethodObserver =
                    new ContentObserver(
                            new Handler()) { // from class:
                                             // com.android.server.am.mars.filter.filter.DefaultAppFilter.1
                        ...
                        public final void onChange(boolean z, Uri uri) {
                            ...
                            DefaultAppFilter defaultAppFilter = DefaultAppFilter.this;
                            defaultAppFilter.getDefaultIMEPackage(
                                    defaultAppFilter.mContext.getUserId());
                            if (DefaultAppFilter.this.mContext.getUserId() == 0) {
                                DefaultAppFilter defaultAppFilter2 = DefaultAppFilter.this;
                                if (!defaultAppFilter2.mSecureFolderEnabled
                                        || (i = defaultAppFilter2.mSecureFolderUserId) < 150
                                        || i > 160) {
                                    return;
                                }
        ...
        this.mContext.registerReceiverAsUser(
                defaultAppChangedReceiver, UserHandle.of(userId), m, null, null, 2);
