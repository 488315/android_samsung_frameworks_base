...
public class FASDataManager {
    ...
    */
    public final Boolean checkPreBatteryUsageColumnExist() {
        ...
        try {
            try {
                cursor = getContext().getContentResolver().query(FASTableContract.SMART_MGR_FORCED_APP_STANDBY_URI, FASTableContract.preBattetyUsageProjection, null, null, null);
    ...
    */
    public final Boolean checkDisableReasonColumnExist() {
        ...
        try {
            try {
                cursor = getContext().getContentResolver().query(FASTableContract.SMART_MGR_FORCED_APP_STANDBY_URI, FASTableContract.disableReasonProjection, null, null, null);
