...
public class MARsVersionManager {
  ...
  public static final String[][] mMARsSettingsInfoDefault = {
    new String[] {"marsversion", "1020230413"},
    new String[] {"skipratio", "90"},
    new String[] {"killthreshold", "100"},
    new String[] {"restrictionthreshold", "100"},
    new String[] {"unused_app_period_days", "32"},
    new String[] {"restriction_flag", "255"}
  };
  public static final String[][] mPolicyInfoDefault = {
    new String[] {"1", "1", "13", "354255120", "12", "10", "10", "337379600"},
    new String[] {"2", "0", "21", "270272648", "10", "10", "5", "270272640"},
    new String[] {"4", "0", "25", "270272648", "26", "5", "1", "270272640"},
    new String[] {"8", "1", "26", "0", "2", "5", "0", "0"}
  };
  public static final String[] mAutoRunParameterDefault = {"2", "15", "300", "1", "1"};
  public static final String[][] mCurrentImportantDefault = {
    new String[] {"0", "8000"},
    new String[] {"1", "18284"},
    new String[] {"2", "65529"},
    new String[] {"4", "24032"},
  ...
  public final class PolicyInfo {
    ...
    public String toString() {
      return this.name
          ...
          + this.action
          + ", firstTriggerTime="
          + this.firstTriggerTime
          + ", repeatTriggerTime = "
          + this.repeatTriggerTime;
    }
  ...
  public class AdjustTargetExcludePackage {
    ...
    public String toString() {
      return "AdjustTargetExcludePackage: policyNum="
          + this.policyNum
          + ", condition="
          + this.condition
          + ", pkgNameMatchType="
          + this.pkgNameMatchType
          + ", packageName="
          + this.packageName;
    }
  }
  ...
  public class AdjustTargetCurrentImportant {
    ...
    public String toString() {
      return "AdjustTargetCurrentImportant: policyNum="
          + this.policyNum
          + ", importantValue="
          + this.importantValue;
    }
  ...
  public class AdjustRestriction {
    ...
    public String toString() {
      return "AdjustRestriction: restrictionType="
  ...
  public final void convertListToMap(ArrayList arrayList) {
    ...
    if (arrayMap != null) {
      ...
      for (int i = 0; i < arrayList.size(); i++) {
        this.mIsCurrentImportantMap.put(
            Integer.valueOf(((AdjustTargetCurrentImportant) arrayList.get(i)).policyNum),
            Integer.valueOf(((AdjustTargetCurrentImportant) arrayList.get(i)).importantValue));
      }
      return;
    }
  ...
  public void getIsCurrentImportantFromDefaultValue() {
    ...
    for (String[] strArr : mCurrentImportantDefault) {
      arrayList.add(
          new AdjustTargetCurrentImportant(
              Integer.parseInt(strArr[0]), Integer.parseInt(strArr[1])));
    }
  ...
  public final boolean isAdjustRestrictionMatchInternal(
      AdjustRestriction adjustRestriction, String str, String str2, String str3) {
    ...
    return !(adjustRestriction.action == null
            || str3 == null
            || !isActionMatch(adjustRestriction, str3))
        || adjustRestriction.action == null;
  }
  ...
  public boolean isAdjustRestrictionMatch(int i, String str, String str2, String str3) {
    ...
    while (it.hasNext()) {
      ...
      if (i == adjustRestriction.restrictionType
          && isAdjustRestrictionMatchInternal(adjustRestriction, str, str2, str3)) {
        ...
        Slog.d(
            "MARsVersionManager",
            " restrictionType = "
                + convertRestrictionTypeToName(i)
                + " isAllowed = "
                + isRestrictionTypeAllowed(i)
                + " callee = "
                + str
                + " caller = "
                + str2
  ...
  public static String toNormalText(String str) {
    return (str == null || !str.startsWith("##"))
        ? str
        : new String(Base64.getDecoder().decode(str.substring(2)));
  }
}
