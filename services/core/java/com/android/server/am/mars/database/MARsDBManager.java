...
public class MARsDBManager {
  ...
  public MARsDBManager() {
    ...
    this.mFASDBupdateRunnable =
        new Runnable() { // from class: com.android.server.am.mars.database.MARsDBManager.1
    ...
    public void handleMessage(Message message) {
      ...
      switch (message.what) {
        ...
        case 4:
          ...
          if (data3 != null) {
            MARsDBManager.this.updateCompHistory(
                data3.getString("callee", null),
                data3.getString("caller", null),
                data3.getBoolean("isblock", true),
                data3.getLong("requesttime", System.currentTimeMillis()));
            break;
          }
          break;
        case 5:
        ...
        case 6:
          ...
          if (data5 != null) {
            ...
            if (MARsDebugConfig.DEBUG_MARs) {
              Slog.d(
                  MARsDBManager.this.TAG,
                  "Received MARS_DB_SM_CHANGED_MSG, --mDBCreate = "
                      + MARsDBManager.this.mDBCreate
                      + " --onUpgrade = "
                      + z
                      + " --onInit = "
                      + z2
                      + " --mDBUpdated = "
                      + MARsDBManager.this.mDBUpdated);
            }
            if (z2) {
        ...
        case 7:
          ...
          if (data6 != null) {
            Context contextForUser =
                MARsDBManager.this.getContextForUser(new UserHandle(data6.getInt("userId", -1)));
  ...
  public void sendMigrateMsgToDBHandler() {
    ...
    this.mMARsDBManagerHandler.sendMessageDelayed(
        this.mMARsDBManagerHandler.obtainMessage(8), 1000L);
  }
  ...
  public void sendGetSCPMPolicyMsgToDBHandler() {
    ...
    this.mMARsDBManagerHandler.sendMessageDelayed(
        this.mMARsDBManagerHandler.obtainMessage(11), 1000L);
  ...
  public void updatePkgToSMDB(FASEntity fASEntity) {
    ...
    try {
      doUpdatePkgToSMDB(
          fASEntity.getStrPkgName() != null ? fASEntity.getStrPkgName() : null,
          fASEntity.getStrUid() != null ? fASEntity.getStrUid() : null,
          fASEntity.getStrMode() != null ? fASEntity.getStrMode() : null,
          fASEntity.getStrNew() != null ? fASEntity.getStrNew() : null,
          fASEntity.getStrFasReason() != null ? fASEntity.getStrFasReason() : null,
          fASEntity.getStrExtras() != null ? fASEntity.getStrExtras() : null,
          fASEntity.getStrResetTime() != null ? fASEntity.getStrResetTime() : null,
          fASEntity.getStrPackageType() != null ? fASEntity.getStrPackageType() : null,
          fASEntity.getStrLevel() != null ? fASEntity.getStrLevel() : null,
          fASEntity.getStrDisableType() != null ? fASEntity.getStrDisableType() : null,
          fASEntity.getStrDisableResetTime() != null ? fASEntity.getStrDisableResetTime() : null,
          fASEntity.getStrPreBatteryUsage() != null ? fASEntity.getStrPreBatteryUsage() : null,
          fASEntity.getStrDisableReason() != null ? fASEntity.getStrDisableReason() : null);
    } catch (Exception e) {
      Slog.e(this.TAG, "Exception on handling DB : " + e.getMessage());
      e.printStackTrace();
    }
  ...
  public final void doUpdatePkgToSMDB(
      String str,
      String str2,
      String str3,
      String str4,
      ...
      this.mContext
          ...
          .update(
              FASTableContract.SMART_MGR_FORCED_APP_STANDBY_URI
                  .buildUpon()
                  .appendQueryParameter("MARs-self", "true")
                  .build(),
              contentValues,
  ...
  public void doUpdateCompHistory(boolean z) {
    ...
    try {
      ...
      this.mCurrentContext
          .getContentResolver()
          .bulkInsert(FASTableContract.SMART_MGR_APP_STARTUP_URI, contentValuesArr);
      if (z) {
        return;
      }
            ...
            try {
              if ("deep_sleep_notification_time".equals(string)) {
                MARsPolicyManager.getInstance()
                    .setLastNotiSentTimeForDisabled(Long.parseLong(string2));
              }
            } catch (Exception e) {
  ...
  public final void getPolicyDefaultInfoFromSMToMARs(boolean z) {
    if (isCompareDBVersion()) {
      ...
      if (initMARsSettingsDefinitionInternal != null
          && initMARsSettingsDefinitionInternal.size() > 0) {
        MARsVersionManager.getInstance()
            .setMARsSettingsInfoList(initMARsSettingsDefinitionInternal);
      } else {
      ...
      if (initAdjustTargetExcludePackageInternal != null
          && initAdjustTargetExcludePackageInternal.size() > 0) {
        MARsVersionManager.getInstance()
            .setAdjustTargetExcludePackage(initAdjustTargetExcludePackageInternal);
      } else {
        MARsVersionManager.getInstance().getExcludeTargetFromDefaultValue();
      }
      ArrayList initAdjustTargetIsCurrentImportantInternal =
          initAdjustTargetIsCurrentImportantInternal();
      if (initAdjustTargetIsCurrentImportantInternal != null
          && initAdjustTargetIsCurrentImportantInternal.size() > 0) {
        MARsVersionManager.getInstance()
            .setAdjustTargetCurrentImportant(initAdjustTargetIsCurrentImportantInternal);
      } else {
    ...
    MARsPolicyManager.getInstance()
        .setFakeTopActivityList(MARsVersionManager.getInstance().mRestrictionList);
  ...
  public final ArrayList initMARsSettingsDefinitionInternal() {
    ...
    try {
      cursor =
          this.mContext
              .getContentResolver()
              .query(MARsTableContract.MARS_SETTINGS_URI, strArr, null, null, null);
    } catch (Exception e) {
  ...
  public final ArrayList initPolicyDefinitionInternal() {
    ...
    try {
      cursor =
          this.mContext
              .getContentResolver()
              .query(MARsTableContract.MARS_POLICY_DEFINITION, strArr2, null, null, null);
    } catch (Exception e) {
    ...
    if (cursor != null) {
      while (cursor.moveToNext()) {
        if (cursor.getString(0) != null) {
          ...
          String convertPolicyNumToName =
              MARsVersionManager.getInstance().convertPolicyNumToName(parseInt);
          MARsVersionManager mARsVersionManager = MARsVersionManager.getInstance();
          Objects.requireNonNull(mARsVersionManager);
          arrayList.add(
              mARsVersionManager
              .new PolicyInfo(
                  convertPolicyNumToName,
                  parseInt,
                  parseInt2,
                  parseInt3,
                  parseInt4,
    ...
    try {
      cursor =
          this.mContext
              .getContentResolver()
              .query(
                  MARsTableContract.MARS_ADJUST_TARGET_EXCLUDE_PACKAGE, strArr, null, null, null);
    } catch (Exception e) {
    ...
    if (cursor != null) {
      while (cursor.moveToNext()) {
        if (cursor.getString(0) != null) {
          ...
          arrayList.add(
              mARsVersionManager
              .new AdjustTargetExcludePackage(parseInt, parseInt2, string, string2));
        }
      }
      cursor.close();
    } else {
    ...
    try {
      cursor =
          this.mContext
              .getContentResolver()
              .query(
                  MARsTableContract.MARS_ADJUST_TARGET_CURRENT_IMPORTANT, strArr, null, null, null);
    } catch (Exception e) {
  ...
  public final ArrayList initAdjustRestrictionInternal() {
    ...
    try {
      cursor =
          this.mContext
              .getContentResolver()
              .query(MARsTableContract.MARS_ADJUST_RESTRICTION, strArr, null, null, null);
    } catch (Exception e) {
      ...
      while (cursor.moveToNext()) {
        if (cursor.getString(0) != null) {
          ...
          if (parseInt == 12) {
            ...
            arrayList.add(
                mARsVersionManager
                .new AdjustRestriction(
                    parseInt, string, normalText, normalText2, string2, normalText3));
          }
        }
      }
      cursor.close();
  ...
  */
      ...
      Bundle call =
          this.mContext
              ...
              .call(
                  ...
                  "dc_scpm_get_deep_sleep_specific_list",
                  (String) null,
                  new Bundle());
    ...
    try {
      ...
      if (call.getBoolean(KnoxCustomManagerService.SPCM_KEY_RESULT)) {
        FreecessController.getInstance()
            .setFreecessPolicyFromSCPM(call.getString("app_freeze_settings_json"));
      }
    } catch (Exception e) {
  ...
  public final boolean isCompareDBVersion() {
    ...
    return str2 != null
        && str != null
        && str.equals(str2)
        && Integer.parseInt(this.MARsDBVersion) >= Integer.parseInt(this.MARsLocalVersion);
  }
  ...
  public boolean isSMProviderExist() {
    try {
      Cursor query =
          this.mCurrentContext
              .getContentResolver()
              .query(FASTableContract.SMART_MGR_SETTINGS_URI, null, null, null, null);
      if (query == null) {
        return false;
      }
      query.close();
    ...
    try {
      cursor =
          this.mCurrentContext
              .getContentResolver()
              .query(
                  FASTableContract.SMART_MGR_DEFAULT_ALLOWED_LIST_URI,
    ...
    try {
      cursor =
          this.mCurrentContext
              .getContentResolver()
              .query(
                  FASTableContract.SMART_MGR_SETTINGS_URI,
                  new String[] {"key", "value"},
                  null,
                  null,
                  null);
      ...
      while (cursor.moveToNext()) {
        ...
        try {
          if ("spcm_locking_time".equals(string)) {
            MARsPolicyManager.getInstance()
                .setPackagesUnusedLockingTime(Integer.parseInt(cursor.getString(1)));
          }
          if ("spcm_switch".equals(string)) {
            MARsPolicyManager.getInstance()
                .setAllPoliciesOnOffState(Integer.parseInt(cursor.getString(1)), z);
          }
          if ("ConfigCompTracing".equals(string)) {
            MARsComponentTracker.getInstance()
                .setEnabled(Integer.parseInt(cursor.getString(1)) > 0);
          }
        } catch (Exception e2) {
      ...
      try {
        cursor =
            this.mContext
                .getContentResolver()
                .query(
                    FASTableContract.SMART_MGR_FREEZE_EXCLUDE_LIST_URI,
                    new String[] {"package_name"},
                    null,
                    null);
        if (cursor != null) {
  ...
  public void registerContentObservers(Context context) {
    try {
      if (!this.mRegisteredSmartManagerSettingsObserver) {
        this.mSmartManagerSettingsObserver =
            new SmartManagerSettingsObserver(this.mMARsDBManagerHandler);
        context
            .getContentResolver()
            .registerContentObserver(
                FASTableContract.SMART_MGR_SETTINGS_URI,
      ...
      if (!this.mRegisteredSmartManagerDefaultAllowedListObserver) {
        this.mSmartManagerDefaultAllowedListObserver =
            new SmartManagerDefaultAllowedListObserver(this.mMARsDBManagerHandler);
        context
            .getContentResolver()
            .registerContentObserver(
                FASTableContract.SMART_MGR_DEFAULT_ALLOWED_LIST_URI,
      ...
      if (this.mRegisteredSmartManagerFreezeExcludeListObserver
          || !MARsPolicyManager.getInstance().isChinaPolicyEnabled()) {
        return;
      }
      this.mSmartManagerFreezeExcludeListObserver =
          new SmartManagerFreezeExcludeListObserver(this.mMARsDBManagerHandler);
      this.mContext
          .getContentResolver()
          .registerContentObserver(
              FASTableContract.SMART_MGR_FREEZE_EXCLUDE_LIST_URI,
  ...
  public void unregisterContentObservers(Context context, boolean z) {
    try {
      ...
      if (this.mRegisteredSmartManagerFreezeExcludeListObserver) {
        this.mContext
            .getContentResolver()
            .unregisterContentObserver(this.mSmartManagerFreezeExcludeListObserver);
        this.mRegisteredSmartManagerFreezeExcludeListObserver = false;
      }
      if (this.mRegisteredSmartManagerDefaultAllowedListObserver) {
        context
            .getContentResolver()
            .unregisterContentObserver(this.mSmartManagerDefaultAllowedListObserver);
        this.mRegisteredSmartManagerDefaultAllowedListObserver = false;
      }
