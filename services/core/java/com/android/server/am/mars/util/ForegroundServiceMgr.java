...
public final class ForegroundServiceMgr
    ...
    public final AnonymousClass1 mProcessObserver =
            new IProcessObserver
                    .Stub() { // from class: com.android.server.am.mars.util.ForegroundServiceMgr.1
                        ...
                        if (str != null) {
                            ...
                            if (ForegroundServiceMgr.isFGSTarget(str)) {
                                ForegroundServiceRecord foregroundServiceRecord =
                                        (ForegroundServiceRecord)
                                                ForegroundServiceMgr.this.mMapFGSRecord.get(
                                                        Integer.valueOf(i2));
                                if (foregroundServiceRecord == null) {
                                    foregroundServiceRecord = new ForegroundServiceRecord(str);
                                    ForegroundServiceMgr.this.mMapFGSRecord.put(
                                            Integer.valueOf(i2), foregroundServiceRecord);
                                }
    ...
    public final ForegroundServiceMgr$$ExternalSyntheticLambda0 mGetUsingFGSTypeRunnable =
            new Runnable() { // from class:
                             // com.android.server.am.mars.util.ForegroundServiceMgr$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ForegroundServiceMgr.GetAccesesTimeHelper getAccesesTimeHelper =
                            ForegroundServiceMgr.this.getAccesesTimeHelper;
                    ForegroundServiceMgr.GetAccesesTimeHelper.CustomVisitor customVisitor =
                            getAccesesTimeHelper.visitor;
                    try {
    ...
    public final class GetAccesesTimeHelper {
        ...
        public final class CustomVisitor implements AppOpsManager.HistoricalOpsVisitor {
            ...
            public final void visitHistoricalOp(AppOpsManager.HistoricalOp historicalOp) {
                ArrayList arrayList =
                        (ArrayList)
                                this.accessTimePerOp.computeIfAbsent(
                                        historicalOp.getOpName(),
                                        new ForegroundServiceMgr$GetAccesesTimeHelper$CustomVisitor$$ExternalSyntheticLambda0());
                int discreteAccessCount = historicalOp.getDiscreteAccessCount();
                if (discreteAccessCount > 0) {
                    arrayList.add(
                            Long.valueOf(
                                    historicalOp
                                            .getDiscreteAccessAt(discreteAccessCount - 1)
                                            .getLastAccessTime(31)));
                }
            }
            ...
            public final void visitHistoricalUidOps(
        ...
        public final void getAccessTimeOfOp(int i, String str) {
            ForegroundServiceRecord foregroundServiceRecord =
                    (ForegroundServiceRecord)
                            ForegroundServiceMgr.this.mMapFGSRecord.get(Integer.valueOf(i));
            ...
            BootReceiver$$ExternalSyntheticOutline0.m(
                    BatteryService$$ExternalSyntheticOutline0.m("access at ", longValue, ", "),
                    longValue == 0
                            ? String.format("%16s", "null")
                            : new SimpleDateFormat("yyyy/MM/dd HH:mm").format(new Date(longValue)),
                    "ForegroundServiceMgr");
            if (foregroundServiceRecord != null) {
                ...
                if (roundDownToMinute2 <= 0
                        || roundDownToMinute3 < roundDownToMinute2
                        || roundDownToMinute2 > roundDownToMinute
                        || roundDownToMinute > roundDownToMinute3) {
                    return;
                }
                int i3 = 0;
                if (str != null) {
                ...
                foregroundServiceRecord.mUsingForegroundType =
                        i3 | foregroundServiceRecord.mUsingForegroundType;
            }
        }
    }
    ...
    public final void onForegroundServiceNotificationUpdated(
            String str, int i, int i2, boolean z) {}

    public final void onForegroundServiceStateChanged(
            final String str, final int i, int i2, boolean z) {
        if (isFGSTarget(str)) {
            ForegroundServiceRecord foregroundServiceRecord =
                    (ForegroundServiceRecord) this.mMapFGSRecord.get(Integer.valueOf(i));
            if (foregroundServiceRecord == null) {
                foregroundServiceRecord = new ForegroundServiceRecord(str);
            ...
            getAccesesTimeHelper.mAppOpsService =
            ...
            if (iAppOpsService != null) {
                Runnable runnable = new Runnable() { // from class:
                            // com.android.server.am.mars.util.ForegroundServiceMgr$GetAccesesTimeHelper$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                final ForegroundServiceMgr.GetAccesesTimeHelper
                                        getAccesesTimeHelper2 =
                                                ForegroundServiceMgr.GetAccesesTimeHelper.this;
                                int i3 = i;
                                String str2 = str;
                                getAccesesTimeHelper2.getClass();
                                try {
                                    getAccesesTimeHelper2.mAppOpsService.getHistoricalOps(
                                            i3,
                                            str2,
                                            (String) null,
                                            (List) null,
                                            ...
                                            new RemoteCallback(
                                                    new RemoteCallback
                                                        ...
                                                        // com.android.server.am.mars.util.ForegroundServiceMgr$GetAccesesTimeHelper$$ExternalSyntheticLambda1
                                                        public final void onResult(Bundle bundle) {
                                                            ForegroundServiceMgr
                                                                            .GetAccesesTimeHelper
                                                                    getAccesesTimeHelper3 =
                                                                            ForegroundServiceMgr
                                                                                    .GetAccesesTimeHelper
                                                                                    .this;
            ...
            ForegroundServiceMgr$$ExternalSyntheticLambda0
                    foregroundServiceMgr$$ExternalSyntheticLambda0 =
                            ForegroundServiceMgr.this.mGetUsingFGSTypeRunnable;
            boolean z3 = MARsUtils.IS_SUPPORT_FREEZE_FG_SERVICE_FEATURE;
            mARsHandler.mMainHandler.postDelayed(
                    foregroundServiceMgr$$ExternalSyntheticLambda0, 1000L);
        }
    }
}
