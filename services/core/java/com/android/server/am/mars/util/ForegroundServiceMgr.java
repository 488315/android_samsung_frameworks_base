...
public class ForegroundServiceMgr
        ...
        new IProcessObserver
          ...
          public void onForegroundServicesChanged(int i, int i2, int i3) {
            ...
            if (packageNameByUid == null
                || !ForegroundServiceMgr.this.isFGSTarget(packageNameByUid)) {
              return;
            }
            ForegroundServiceRecord foregroundServiceRecord =
                (ForegroundServiceRecord)
                    ForegroundServiceMgr.this.mMapFGSRecord.get(Integer.valueOf(i2));
  ...
  public class GetAccesesTimeHelper {
    ...
    public void getAllAccessTimeOfPackage(int i, String str) {
      ...
      if (iAppOpsService != null) {
        try {
          iAppOpsService.getHistoricalOps(
              i,
              str,
              (String) null,
              (List) null,
                  ...
                  new RemoteCallback
                    ...
                    public final void onResult(Bundle bundle) {
                      ForegroundServiceMgr.GetAccesesTimeHelper.this
                          .lambda$getAllAccessTimeOfPackage$0(bundle);
                    }
                  }));
          MARsHandler.getInstance()
              .getHandler()
              .postDelayed(ForegroundServiceMgr.this.mGetUsingFGSTypeRunnable, 1000L);
        } catch (Exception e) {
    ...
    public /* synthetic */ void lambda$getAllAccessTimeOfPackage$0(Bundle bundle) {
      try {
        ((AppOpsManager.HistoricalOps)
                bundle.getParcelable("historical_ops", AppOpsManager.HistoricalOps.class))
            .accept(this.visitor);
      } catch (Exception e) {
        Slog.d(ForegroundServiceMgr.TAG, "exception", e);
      }
    ...
    public void getAccessTimeOfOp(String str, int i) {
      ForegroundServiceRecord foregroundServiceRecord =
          (ForegroundServiceRecord) ForegroundServiceMgr.this.mMapFGSRecord.get(Integer.valueOf(i));
      ...
      Slog.d(
          ForegroundServiceMgr.TAG,
          "access at " + longValue + ", " + ForegroundServiceMgr.this.formatDateTime(longValue));
      if (foregroundServiceRecord == null
          || !ForegroundServiceMgr.this.isInDuration(
              longValue,
              foregroundServiceRecord.getFGSStartTime(),
              foregroundServiceRecord.getFGSEndTime())) {
        return;
      }
    ...
    public class CustomVisitor implements AppOpsManager.HistoricalOpsVisitor {
      ...
      public void visitHistoricalPackageOps(
      ...
      public void visitHistoricalOp(AppOpsManager.HistoricalOp historicalOp) {
            ...
            (ArrayList)
                this.accessTimePerOp.computeIfAbsent(
                    ...
                    new Function() { // from class:
                                     // com.android.server.am.mars.util.ForegroundServiceMgr$GetAccesesTimeHelper$CustomVisitor$$ExternalSyntheticLambda0
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        ArrayList lambda$visitHistoricalOp$0;
                        lambda$visitHistoricalOp$0 =
                            ForegroundServiceMgr.GetAccesesTimeHelper.CustomVisitor
                                .lambda$visitHistoricalOp$0((String) obj);
        ...
        if (discreteAccessCount > 0) {
          arrayList.add(
              Long.valueOf(
                  historicalOp.getDiscreteAccessAt(discreteAccessCount - 1).getLastAccessTime(31)));
        }
      }
