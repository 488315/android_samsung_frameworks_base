...
public class FilterChainFactory {
  ...
  public final FilterChain getForceFilterChain() {
    ...
    return new FilterChainBuilder()
        .add(filterFactory.getFilter(9))
        .add(filterFactory.getFilter(10))
        .add(filterFactory.getFilter(11))
        .add(filterFactory.getFilter(12))
        .add(filterFactory.getFilter(17))
        .build();
  }
  ...
  public final FilterChain getAppLockerFilterChain() {
    FilterFactory filterFactory = FilterFactory.getInstance();
    return new FilterChainBuilder()
        .add(filterFactory.getFilter(3))
        .add(filterFactory.getFilter(4))
        .add(filterFactory.getFilter(6))
        .add(filterFactory.getFilter(7))
        .add(filterFactory.getFilter(9))
        .add(filterFactory.getFilter(10))
        .add(filterFactory.getFilter(11))
        .add(filterFactory.getFilter(14))
        .add(filterFactory.getFilter(16))
        .add(filterFactory.getFilter(17))
        .build();
  }
  ...
  public final FilterChain getAutoRunFilterChain() {
    FilterFactory filterFactory = FilterFactory.getInstance();
    return new FilterChainBuilder()
        .add(filterFactory.getFilter(1))
        .add(filterFactory.getFilter(4))
        .add(filterFactory.getFilter(5))
        .add(filterFactory.getFilter(6))
        .add(filterFactory.getFilter(7))
        .add(filterFactory.getFilter(8))
        .add(filterFactory.getFilter(9))
        .add(filterFactory.getFilter(10))
        .add(filterFactory.getFilter(11))
        .add(filterFactory.getFilter(12))
        .add(filterFactory.getFilter(13))
        .add(filterFactory.getFilter(14))
        .add(filterFactory.getFilter(15))
        .add(filterFactory.getFilter(16))
        .add(filterFactory.getFilter(17))
        .add(filterFactory.getFilter(27))
        .add(filterFactory.getFilter(28))
        .build();
  }
  ...
  public final FilterChain getFreecessFilterChain() {
    ...
    return new FilterChainBuilder()
        ...
        .add(filterFactory.getFilter(14))
        .add(filterFactory.getFilter(17))
        .add(filterFactory.getFilter(18))
        .add(filterFactory.getFilter(26))
        .add(filterFactory.getFilter(27))
        .add(filterFactory.getFilter(28))
        .add(filterFactory.getFilter(31))
        .build();
  }
  ...
  public final FilterChain getDisablerFilterChain() {
    ...
    return new FilterChainBuilder()
        ...
        .add(filterFactory.getFilter(14))
        .add(filterFactory.getFilter(12))
        .add(filterFactory.getFilter(21))
        .add(filterFactory.getFilter(22))
        .add(filterFactory.getFilter(25))
        .add(filterFactory.getFilter(27))
        .add(filterFactory.getFilter(30))
        .build();
  }
  ...
  public final FilterChain getGameFilterChain() {
    ...
    return new FilterChainBuilder()
        ...
        .add(filterFactory.getFilter(14))
        .add(filterFactory.getFilter(17))
        .add(filterFactory.getFilter(19))
        .add(filterFactory.getFilter(24))
        .build();
  }
  ...
  public final FilterChain getEnhancedFilterChain() {
    ...
    return new FilterChainBuilder()
        ...
        .add(filterFactory.getFilter(17))
        .add(filterFactory.getFilter(18))
        .add(filterFactory.getFilter(23))
        .add(filterFactory.getFilter(26))
        .add(filterFactory.getFilter(27))
        .add(filterFactory.getFilter(10))
        .add(filterFactory.getFilter(28))
        .add(filterFactory.getFilter(29))
        .add(filterFactory.getFilter(31))
        .build();
  }
}
