...
public final /* synthetic */ class ProcessStatsService$$ExternalSyntheticLambda0
        implements Runnable {
    public final /* synthetic */ ProcessStatsService f$0;
    public final /* synthetic */ boolean f$1;
    public final /* synthetic */ boolean f$2 = false;

    public /* synthetic */ ProcessStatsService$$ExternalSyntheticLambda0(
    ...
    public final void run() {
        ...
        synchronized (activityManagerProcLock) {
            try {
                processStatsService.mAm.mAppProfiler.requestPssAllProcsLPr(
                        SystemClock.uptimeMillis(), z);
            } catch (Throwable th) {
