...
public class AppErrors {
    ...
    */
    public final void crashApplicationInner(final ProcessRecord processRecord, ApplicationErrorReport.CrashInfo crashInfo, int i, int i2) {
        String str;
        String str2;
        Object obj;
        Intent intent;
        ...
        if (str3 != null && str4 != null) {
            ...
            AuditLog.logAsUser(3, 5, false, Process.myPid(), "AppErrors", String.format("Application %s crashed due to %s", str2, crashInfo.exceptionClassName), "", i3);
            Object obj2 = "crash";
            this.mService.mActivityTaskManager.isForceStopDisabled(str2, i3, "crash", crashInfo.throwClassName, crashInfo.exceptionClassName, false, false);
            if (processRecord != null) {
                    ...
                    try {
                        ...
                        if (!"Native crash".equals(crashInfo.exceptionClassName)) {
                            ...
                            if (processRecord == null && Process.myPid() == i) {
                                ...
                                Debug.saveDump(bugreportParams2, processRecord == null ? null : processRecord.info.packageName);
                            }
                        }
                        int i4 = computeRelaunchReason;
                        String str6 = str;
                        if (handleAppCrashInActivityController(processRecord, crashInfo, str3, str, str5, currentTimeMillis, i, i2)) {
                            return;
                        }
                        if (i4 == 2) {
                            ActivityManagerService.resetPriorityAfterLockedSection();
                        ...
                        if (processRecord != null && processRecord.uid >= 10000) {
                            new Thread("AppCrashHistoryBroadcastThread") { // from class: com.android.server.am.AppErrors.1
                                @Override // java.lang.Thread, java.lang.Runnable
                                public void run() {
                                    Slog.w("ActivityManager", "crash : " + processRecord.info.packageName + "," + processRecord.uid);
                                    ...
                                    AppErrors.this.mContext.sendBroadcastAsUser(intent3, UserHandle.ALL, "com.samsung.permission.WRITE_SDHMS_DATA");
                                }
                            }.start();
                        }
                        ...
                        if (processRecord != null && makeAppCrashingLocked(processRecord, str3, str6, str5, data)) {
                            ...
                            MetricsLogger.action(this.mContext, FrameworkStatsLog.APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_SHELL, i6);
                            if (i6 == 6 || i6 == 7) {
                                i6 = 1;
                            }
                            if (i6 == 1) {
                                ...
                                if (i5 != -1) {
                                    try {
                                        this.mService.startActivityFromRecents(i5, ActivityOptions.makeBasic().toBundle());
    ...
    */
    public void handleShowAppErrorUi(Message message) {
        ...
        boolean z4 = Settings.Secure.getIntForUser(this.mContext.getContentResolver(), "anr_show_background", 0, this.mService.mUserController.getCurrentUserId()) != 0;
        ActivityManagerGlobalLock activityManagerGlobalLock = this.mProcLock;
        ActivityManagerService.boostPriorityForProcLockedSection();
        synchronized (activityManagerGlobalLock) {
            try {
                ...
                boolean z5 = UserHandle.getAppId(processRecord3.uid) >= 10000 && processRecord3.getPid() != ActivityManagerService.MY_PID;
                ...
                synchronized (this.mBadProcessLock) {
                    ...
                    boolean z6 = Settings.Global.getInt(this.mContext.getContentResolver(), "show_first_crash_dialog", 0) != 0;
                    boolean z7 = Settings.Secure.getIntForUser(this.mContext.getContentResolver(), "show_first_crash_dialog_dev_option", 0, this.mService.mUserController.getCurrentUserId()) != 0;
                    ...
                    if (l != null) {
                        ...
                        if (uptimeMillis < l.longValue() + ActivityManagerConstants.MIN_CRASH_INTERVAL) {
                            z = true;
                            if ((!this.mService.mAtmInternal.canShowErrorDialogs() || z4) && !z8 && !z && (z6 || z7 || data.repeating)) {
                                ...
                                z2 = iAFDDiagnosis.parseExpType(str2, str3, i3, i4, i5, crashInfo.exceptionClassName, crashInfo.exceptionMessage, crashInfo.stackTrace);
                                if (z2) {
                                    Slog.d("ActivityManager", "step1: IAFD parse pass, will call showIAFDCrashDialogs");
                                    if (appErrorResult != null) {
                    ...
                    z2 = iAFDDiagnosis2.parseExpType(str22, str32, i32, i42, i52, crashInfo2.exceptionClassName, crashInfo2.exceptionMessage, crashInfo2.stackTrace);
                    if (z2) {
                    }
                    if (!processRecord2.isolated) {
                    }
                ...
                try {
                    ...
                    iAFDDiagnosis3.showIAFDCrashDialogs(processRecord4.userId, processRecord4.info.uid, data.proc.info.packageName);
    ...
    public void handleShowAnrUi(Message message) {
        ...
        synchronized (activityManagerGlobalLock) {
            try {
                ...
                List packageListWithVersionCode = !processRecord.isPersistent() ? processRecord.getPackageListWithVersionCode() : null;
