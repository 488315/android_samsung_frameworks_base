    ...
    */
                    ...
                    if (pendingIntentRecord == null) {
                        ...
                        if (pendingIntentRecord.key.userId == i) {
                            ...
                            if (pendingIntentRecord.key.activity != null) {
                                this.f1632mH.sendMessage(PooledLambda.obtainMessage(new PendingIntentController$$ExternalSyntheticLambda0(), this, pendingIntentRecord.key.activity, pendingIntentRecord.ref));
                            }
                        }
    ...
    public final void makeIntentSenderCanceled(PendingIntentRecord pendingIntentRecord) {
        ...
        if (detachCancelListenersLocked != null) {
            this.f1632mH.sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.am.PendingIntentController$$ExternalSyntheticLambda1
