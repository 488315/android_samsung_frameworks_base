...
public class MARsTrigger {
  ...
  public MARsTrigger() {
    ...
    this.mTriggerIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if (intent == null || intent.getAction() == null) {
              return;
            ...
            if (action.equals("android.intent.action.SCREEN_OFF")) {
              ...
              if (FreecessController.getInstance().getIsDumpstateWorking()
    ...
    this.mPolicyIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.3
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            Bundle extras;
            String action = intent.getAction();
            ...
            if (action.equals("FIRST_ALARM_TRIGGER_ACTION")) {
              ...
              if (!MARsPolicyManager.getInstance().getScreenOnState()
                  && !FreecessController.getInstance().getIsDumpstateWorking()) {
                MARsHandler.getInstance().sendFirstTriggerMsgToMainHandler();
                MARsHandler.getInstance().sendRepeatTriggerMsgToMainHandler();
              }
            }
            if (!action.equals("com.samsung.android.server.am.ACTION_UI_TRIGGER_POLICY")
                || (extras = intent.getExtras()) == null) {
              return;
            }
            int policyNameToInt =
                MARsTrigger.this.policyNameToInt(extras.getString("POLICY_NAME", ""));
            ...
            MARsHandler.getInstance()
                .sendRunPolicySpecificPkgMsgToMainHandler(
                    stringArrayList, policyNameToInt, null, MARsTrigger.this.mContext.getUserId());
          }
        };
    this.mPolicyUDSIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.4
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("com.android.server.am.MARS_TRIGGER_UDS_POLICY")) {
              ...
              if (extras == null
                  || (stringArrayList = extras.getStringArrayList("PACKAGE_NAME")) == null) {
                return;
              }
              MARsHandler.getInstance()
                  .sendRunPolicySpecificPkgMsgToMainHandler(
                      stringArrayList,
                      5,
                      MARsTrigger.this.actionToString(action),
                      MARsTrigger.this.mContext.getUserId());
              return;
            }
                ...
                if (stringArrayList2 != null) {
                  MARsHandler.getInstance()
                      .sendCancelPolicyMsgToMainHandler(
                          stringArrayList2, 5, MARsTrigger.this.mContext.getUserId());
                  return;
                }
                return;
              }
              MARsHandler.getInstance()
                  .sendCancelPolicyMsgToMainHandler(null, 5, MARsTrigger.this.mContext.getUserId());
            }
          }
        };
    this.mPolicySBikeIntentReceiver =
            ...
            if (action.equals("com.android.server.am.MARS_CANCEL_SBIKE_MODE_POLICY")) {
              ...
              if (extras2 != null) {
                ...
                if (stringArrayList2 != null) {
                  MARsHandler.getInstance()
                      .sendCancelPolicyMsgToMainHandler(
                          stringArrayList2, 6, MARsTrigger.this.mContext.getUserId());
                  return;
                }
                return;
              }
              MARsHandler.getInstance()
                  .sendCancelPolicyMsgToMainHandler(null, 6, MARsTrigger.this.mContext.getUserId());
            }
          }
        };
    this.mTCPUReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.6
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            MARsHandler.getInstance()
                .sendTCPUMsgToMainHandler(intent.getIntegerArrayListExtra("pid"));
            Slog.d("MARsTrigger", "broadcast received action TCPU: " + intent.getAction());
          }
        };
    this.mPolicyGameIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.7
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if (intent == null || intent.getAction() == null) {
              return;
            ...
            if (stringExtra == null || "com.samsung.android.game.gos".equals(stringExtra)) {
              ...
              if (action.equals("com.android.server.am.MARS_TRIGGER_GAME_MODE_POLICY")) {
                ...
                if (extras != null) {
                  ...
                  LatestProtectedPackageFilter.getInstance()
                      .setProtectAppCntForGame(extras.getInt("lru_num"));
    ...
    this.mPolicyMPSMIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.8
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            ArrayList<String> stringArrayList;
            if (intent == null || intent.getAction() == null) {
            ...
            if (action.equals("com.android.server.am.MARS_CANCEL_MPSM_POLICY")) {
              ...
              if (extras2 != null) {
                ...
                if (stringArrayList2 != null) {
                  MARsHandler.getInstance()
                      .sendCancelPolicyMsgToMainHandler(
                          stringArrayList2, 10, MARsTrigger.this.mContext.getUserId());
                  return;
                }
                return;
              }
              MARsHandler.getInstance()
                  .sendCancelPolicyMsgToMainHandler(
                      null, 10, MARsTrigger.this.mContext.getUserId());
            }
          }
        };
    this.mTimeIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.9
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if (intent == null
            ...
            MARsHandler.getInstance()
                .sendTimeChangedMsgToMainHandler(
                    currentTimeMillis
                        - (MARsTrigger.this.mLastTimeChangeClockTime
                            + (elapsedRealtime - MARsTrigger.this.mLastTimeChangeRealtime)));
            MARsTrigger.this.mLastTimeChangeClockTime = currentTimeMillis;
            MARsTrigger.this.mLastTimeChangeRealtime = elapsedRealtime;
          }
        };
    this.mUserActionReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.10
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            UserInfo userInfo;
            UserInfo userInfo2;
            ...
            if ("android.intent.action.USER_STOPPED".equals(action)) {
              ...
              if (userManager == null
                  || (userInfo3 = userManager.getUserInfo(intExtra)) == null
            ...
            if ("android.intent.action.USER_STARTED".equals(action)) {
              ...
              if (userManager2 == null
                  || (userInfo2 = userManager2.getUserInfo(intExtra)) == null
            ...
            if ("android.intent.action.USER_ADDED".equals(action)) {
              ...
              if (userManager3 == null
                  || (userInfo = userManager3.getUserInfo(intExtra)) == null
    ...
    this.mUserIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.11
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if (intent == null || intent.getAction() == null) {
              return;
    ...
    this.mAppStartUpIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.12
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if (intent == null || intent.getAction() == null) {
              return;
    ...
    this.mEmergencyStateChangedReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.13
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if (intent == null
                || intent.getAction() == null
                || !intent.getAction().equals("com.samsung.intent.action.EMERGENCY_STATE_CHANGED")
    ...
    this.mSMDBChangedReceiver =
        new BroadcastReceiver() { // from class: com.android.server.am.MARsTrigger.14
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            boolean z;
            boolean z2;
  ...
  public void registerReceiver(boolean z) {
    ...
    this.mContext.registerReceiverAsUser(
        this.mUserActionReceiver, UserHandle.ALL, intentFilter4, null, null);
  ...
  public final void setAlarm(String str, long j) {
    if (str.equals("FIRST_ALARM_TRIGGER_ACTION")) {
      if (this.mMARsFirstTriggerPolicyAlarmIntent == null) {
        this.mMARsFirstTriggerPolicyAlarmIntent =
            PendingIntent.getBroadcastAsUser(
                this.mContext,
                0,
                new Intent(str).setPackage("android").setFlags(1073741824),
                67108864,
                this.user);
      }
      this.mAlarm.setExact(
          1, System.currentTimeMillis() + j, this.mMARsFirstTriggerPolicyAlarmIntent);
    }
  }
}
