...
public class BroadcastConstants {
    ...
    synchronized (this) {
      try {
        try {
          ...
          this.DEFERRAL_DECAY_FACTOR =
              this.mParser.getFloat("bcast_deferral_decay_factor", this.DEFERRAL_DECAY_FACTOR);
          ...
          this.ALLOW_BG_ACTIVITY_START_TIMEOUT =
              this.mParser.getLong(
                  "bcast_allow_bg_activity_start_timeout", this.ALLOW_BG_ACTIVITY_START_TIMEOUT);
        } catch (IllegalArgumentException e) {
          Slog.e(
              "BroadcastConstants", "Bad broadcast settings in key '" + this.mSettingsKey + "'", e);
        }
      } catch (Throwable th) {
        throw th;
      }
  ...
  public final boolean getDeviceConfigBoolean(String str, boolean z) {
    return SystemProperties.getBoolean(
        propertyOverrideFor(str), SystemProperties.getBoolean(propertyFor(str), z));
  }

  public final int getDeviceConfigInt(String str, int i) {
    return SystemProperties.getInt(
        propertyOverrideFor(str), SystemProperties.getInt(propertyFor(str), i));
  }

  public final long getDeviceConfigLong(String str, long j) {
    return SystemProperties.getLong(
        propertyOverrideFor(str), SystemProperties.getLong(propertyFor(str), j));
  }
  ...
  public final void updateDeviceConfigConstants() {
    synchronized (this) {
      ...
      this.MAX_RUNNING_PROCESS_QUEUES =
          getDeviceConfigInt(
              "bcast_max_running_process_queues", DEFAULT_MAX_RUNNING_PROCESS_QUEUES);
      this.EXTRA_RUNNING_URGENT_PROCESS_QUEUES =
          getDeviceConfigInt("bcast_extra_running_urgent_process_queues", 1);
      this.MAX_CONSECUTIVE_URGENT_DISPATCHES =
          getDeviceConfigInt("bcast_max_consecutive_urgent_dispatches", 3);
      this.MAX_CONSECUTIVE_NORMAL_DISPATCHES =
          getDeviceConfigInt("bcast_max_consecutive_normal_dispatches", 10);
      this.MAX_RUNNING_ACTIVE_BROADCASTS =
          getDeviceConfigInt(
              "bcast_max_running_active_broadcasts", DEFAULT_MAX_RUNNING_ACTIVE_BROADCASTS);
      ...
      this.MAX_PENDING_BROADCASTS =
          getDeviceConfigInt("bcast_max_pending_broadcasts", DEFAULT_MAX_PENDING_BROADCASTS);
      ...
      this.DELAY_FOREGROUND_PROC_MILLIS =
          getDeviceConfigLong("bcast_delay_foreground_proc_millis", -120000L);
      this.DELAY_PERSISTENT_PROC_MILLIS =
          getDeviceConfigLong("bcast_delay_persistent_proc_millis", -120000L);
      this.MAX_HISTORY_COMPLETE_SIZE = ActivityManager.isLowRamDeviceStatic() ? 256 : 1024;
      this.MAX_HISTORY_SUMMARY_SIZE =
      ...
      this.PENDING_COLD_START_CHECK_INTERVAL_MILLIS =
          getDeviceConfigLong("pending_cold_start_check_interval_millis", 30000L);
    }
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    synchronized (this) {
      ...
      indentingPrintWriter
          .print("bcast_slow_time", TimeUtils.formatDuration(this.SLOW_TIME))
          .println();
      indentingPrintWriter
          .print("bcast_deferral", TimeUtils.formatDuration(this.DEFERRAL))
          .println();
      indentingPrintWriter
          .print("bcast_deferral_decay_factor", Float.valueOf(this.DEFERRAL_DECAY_FACTOR))
          .println();
      indentingPrintWriter
          .print("bcast_deferral_floor", Long.valueOf(this.DEFERRAL_FLOOR))
          .println();
      indentingPrintWriter
          .print(
              "bcast_allow_bg_activity_start_timeout",
              TimeUtils.formatDuration(this.ALLOW_BG_ACTIVITY_START_TIMEOUT))
          .println();
      ...
      indentingPrintWriter.increaseIndent();
      indentingPrintWriter
          .print("modern_queue_enabled", Boolean.valueOf(this.MODERN_QUEUE_ENABLED))
          .println();
      indentingPrintWriter
          .print(
              "bcast_max_running_process_queues", Integer.valueOf(this.MAX_RUNNING_PROCESS_QUEUES))
          .println();
      indentingPrintWriter
          .print(
              "bcast_max_running_active_broadcasts",
              Integer.valueOf(this.MAX_RUNNING_ACTIVE_BROADCASTS))
          .println();
      indentingPrintWriter
          .print(
              "bcast_max_core_running_blocking_broadcasts",
              Integer.valueOf(this.MAX_CORE_RUNNING_BLOCKING_BROADCASTS))
          .println();
      indentingPrintWriter
          .print(
              "bcast_max_core_running_non_blocking_broadcasts",
              Integer.valueOf(this.MAX_CORE_RUNNING_NON_BLOCKING_BROADCASTS))
          .println();
      indentingPrintWriter
          .print("bcast_max_pending_broadcasts", Integer.valueOf(this.MAX_PENDING_BROADCASTS))
          .println();
      indentingPrintWriter
          .print("bcast_delay_normal_millis", TimeUtils.formatDuration(this.DELAY_NORMAL_MILLIS))
          .println();
      indentingPrintWriter
          .print("bcast_delay_cached_millis", TimeUtils.formatDuration(this.DELAY_CACHED_MILLIS))
          .println();
      indentingPrintWriter
          .print("bcast_delay_urgent_millis", TimeUtils.formatDuration(this.DELAY_URGENT_MILLIS))
          .println();
      indentingPrintWriter
          .print(
              "bcast_delay_foreground_proc_millis",
              TimeUtils.formatDuration(this.DELAY_FOREGROUND_PROC_MILLIS))
          .println();
      indentingPrintWriter
          .print(
              "bcast_delay_persistent_proc_millis",
              TimeUtils.formatDuration(this.DELAY_PERSISTENT_PROC_MILLIS))
          .println();
      indentingPrintWriter
          .print("bcast_max_history_complete_size", Integer.valueOf(this.MAX_HISTORY_COMPLETE_SIZE))
          .println();
      indentingPrintWriter
          .print("bcast_max_history_summary_size", Integer.valueOf(this.MAX_HISTORY_SUMMARY_SIZE))
          .println();
      indentingPrintWriter
          .print(
              "bcast_max_consecutive_urgent_dispatches",
              Integer.valueOf(this.MAX_CONSECUTIVE_URGENT_DISPATCHES))
          .println();
      indentingPrintWriter
          .print(
              "bcast_max_consecutive_normal_dispatches",
              Integer.valueOf(this.MAX_CONSECUTIVE_NORMAL_DISPATCHES))
          .println();
      indentingPrintWriter
          .print("bcast_core_defer_until_active", Boolean.valueOf(this.CORE_DEFER_UNTIL_ACTIVE))
          .println();
      indentingPrintWriter
          .print(
              "pending_cold_start_check_interval_millis",
              Long.valueOf(this.PENDING_COLD_START_CHECK_INTERVAL_MILLIS))
          .println();
      indentingPrintWriter.decreaseIndent();
      indentingPrintWriter.println();
    }
