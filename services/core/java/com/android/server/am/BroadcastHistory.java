    ...
    public boolean dumpLocked(PrintWriter printWriter, String str, String str2, SimpleDateFormat simpleDateFormat, boolean z, boolean z2) {
        ...
        if (isEmpty) {
            ...
            for (int size = broadcastHistory.mPendingBroadcasts.size() - 1; size >= 0; size--) {
                BroadcastRecord broadcastRecord = (BroadcastRecord) broadcastHistory.mPendingBroadcasts.get(size);
        ...
        if (str == null) {
            ...
            while (true) {
                ...
                if (str5 != null) {
                    ...
                    printWriter.print("    ");
                    TimeUtils.formatDuration(this.mSummaryHistoryDispatchTime[i] - this.mSummaryHistoryEnqueueTime[i], printWriter);
                    printWriter.print(" dispatch ");
                    TimeUtils.formatDuration(this.mSummaryHistoryFinishTime[i] - this.mSummaryHistoryDispatchTime[i], printWriter);
