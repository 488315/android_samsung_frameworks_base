...
public final /* synthetic */ class BroadcastQueueModernImpl$$ExternalSyntheticLambda4
    ...
    public void accept(BroadcastRecord broadcastRecord, int i) {
        ...
        switch (i2) {
            case 1:
                ...
                broadcastQueueModernImpl.setDeliveryState(
                        null,
                        null,
                        broadcastRecord,
                        i,
            ...
            case 2:
                ...
                broadcastQueueModernImpl2.setDeliveryState(
                        null,
                        null,
                        broadcastRecord,
                        i,
            ...
            case 3:
                ...
                broadcastQueueModernImpl3.setDeliveryState(
                        null,
                        null,
                        broadcastRecord,
                        i,
            ...
            default:
                ...
                broadcastQueueModernImpl4.setDeliveryState(
                        null,
                        null,
                        broadcastRecord,
                        i,
    ...
    public boolean test(BroadcastRecord broadcastRecord, int i) {
        return ((String) this.f$0)
                .equals(BroadcastRecord.getReceiverPackageName(broadcastRecord.receivers.get(i)));
    }
}
