...
public class FreecessHandler {
    ...
    public class NetLinkReceiverThread extends Thread {
        ...
        public void run() {
            ...
            if (z) {
                FreecessHandler.this.mFreecessThread = FreecessHandler.this.new FreecessThread("FreecessHandler", 0);
    ...
    public class BlueToothThread extends HandlerThread {
        ...
        @Override // android.os.HandlerThread
        public void onLooperPrepared() {
            FreecessHandler.this.mBluetoothHandler = FreecessHandler.this.new BluetoothHandler(getLooper());
        }
    }
