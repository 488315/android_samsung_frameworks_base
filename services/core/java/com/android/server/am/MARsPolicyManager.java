...
public class MARsPolicyManager {
    ...
    public class MARsAppIdleStateChangeListener extends AppStandbyInternal.AppIdleStateChangeListener {
        ...
        */
        public void onAppIdleStateChanged(String str, int i, boolean z, int i2, int i3) {
            FASEntity fASEntity;
            if (MARsDebugConfig.DEBUG_ENG) {
                Slog.d("MARsPolicyManager", "onAppIdleStateChanged() " + str + "|bucket : " + i2 + "|reason : " + i3);
            }
                ...
                if (mARsPackageInfo != null) {
                    if (mARsPackageInfo.getFasType() != 2 && mARsPackageInfo.getFasType() != 256) {
                        if (i2 >= 40) {
                            ...
                            fASEntity = new FASEntityBuilder().setStrPkgName(mARsPackageInfo.getName()).setStrUid(Integer.toString(mARsPackageInfo.getUid())).setStrLevel(Integer.toString(mARsPackageInfo.getMaxLevel())).setStrResetTime(Long.toString(mARsPackageInfo.getResetTime())).build();
                            if (MARsDebugConfig.DEBUG_ENG) {
                                Slog.d("MARsPolicyManager", "update resetTime : " + str + "[" + MARsPolicyManager.this.formatDateTimeWithoutYear(mARsPackageInfo.getResetTime()) + "]");
                            }
                        } else if (i2 <= 10 && !mARsPackageInfo.getDisabled() && MARsPolicyManager.this.levelChange(1024, mARsPackageInfo) && mARsPackageInfo.getFasType() == 128) {
                            fASEntity = new FASEntityBuilder().setStrPkgName(mARsPackageInfo.getName()).setStrUid(Integer.toString(mARsPackageInfo.getUid())).setStrMode(mARsPackageInfo.getFASEnabled() ? "1" : "0").setStrFasReason(FASTableContract.convertFASTypeToReason(mARsPackageInfo.getFasType())).setStrDisableReason(FASTableContract.convertDisableReasonToDBValue(mARsPackageInfo.getDisableReason())).setStrExtras(FASTableContract.convertStateToDBExtrasValue(mARsPackageInfo.getState())).setStrLevel(Integer.toString(mARsPackageInfo.getMaxLevel())).setStrResetTime(Long.toString(mARsPackageInfo.getResetTime())).build();
                        }
                        if (fASEntity == null) {
    ...
    */
    public void checkUnusedTargetForDeepSleep() {
        ...
        long j2 = 0;
        if (j != 0) {
            if (currentTimeMillis - j <= (this.isTimeChangedForDebug ? this.mAutoDeepSleepTimeForDebug * 2 : 1296000000L)) {
                return;
            }
        }
        ArrayList arrayList2 = new ArrayList();
        long j3 = this.isTimeChangedForDebug ? this.mAutoDeepSleepTimeForDebug : this.mAutoDisabledLockingTime;
        synchronized (MARsLock) {
            int i3 = 0;
            while (i3 < this.mMARsTargetPackages.getMap().size()) {
                ...
                while (i4 < sparseArray2.size()) {
                    ...
                    if (mARsPackageInfo.getFasType() != 256 && !mARsPackageInfo.getDisabled() && isCurrentUser(mARsPackageInfo.getUserId())) {
                        if (mARsPackageInfo.getDisableResetTime() > j2 && System.currentTimeMillis() - mARsPackageInfo.getDisableResetTime() < j3) {
                            i = i4;
                            ...
                            i3 = i2;
                            j2 = 0;
                        } else if (FilterManager.getInstance().filterForSpecificPolicy(7, mARsPackageInfo.getName(), mARsPackageInfo.getUserId(), mARsPackageInfo.getUid()) == 0) {
                            i = i4;
                            sparseArray = sparseArray2;
                            i2 = i3;
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            ...
            if (!getPackageStoppedState(pkgStatusInfo2.name, pkgStatusInfo2.userId)) {
                synchronized (MARsLock) {
                    MARsPackageInfo mARsPackageInfo2 = getMARsPackageInfo(this.mMARsTargetPackages, pkgStatusInfo2.name, pkgStatusInfo2.userId);
                    if (mARsPackageInfo2 != null && levelChange(4, mARsPackageInfo2)) {
                        arrayList2.add(new FASEntityBuilder().setStrPkgName(mARsPackageInfo2.getName()).setStrUid(Integer.toString(mARsPackageInfo2.getUid())).setStrLevel(Integer.toString(mARsPackageInfo2.getMaxLevel())).setStrExtras(FASTableContract.convertStateToDBExtrasValue(mARsPackageInfo2.getState())).build());
    ...
    */
    public boolean levelChange(int i, MARsPackageInfo mARsPackageInfo) {
        if (MARsDebugConfig.DEBUG_ENG) {
            Slog.d("MARsPolicyManager", "levelChange:" + mARsPackageInfo.getName() + "(" + mARsPackageInfo.getUid() + ") state:" + i);
        }
        if (i <= 8 && (AllowListFilter.getInstance().isInDefaultAllowList(mARsPackageInfo.getName()) || !mARsPackageInfo.getHasAppIcon())) {
            return false;
        }
        if (i == 1) {
            ...
            if (!mARsPackageInfo.getFASEnabled()) {
                MARsHandler.getInstance().sendCallSetModeMsgToMainHandler(mARsPackageInfo.getName(), mARsPackageInfo.getUid(), 1);
                if (this.ENABLE_RESTRICTED_BUCKET) {
                    MARsHandler.getInstance().sendCallSetAppStandbyBucketMsgToMainHandler(mARsPackageInfo.getName(), mARsPackageInfo.getUserId(), 45, false);
                }
                mARsPackageInfo.setFASEnabled(true);
                mARsPackageInfo.setState(4);
                mARsPackageInfo.setFasType(1);
                mARsPackageInfo.setFasReason(FASTableContract.convertFASTypeToReason(mARsPackageInfo.getFasType()));
            }
        } else {
            switch (i) {
                case 4:
                    if (!MARsVersionManager.getInstance().isAdjustRestrictionMatch(21, mARsPackageInfo.getName(), null, null)) {
                ...
                case 64:
                    ...
                    if (this.ENABLE_RESTRICTED_BUCKET) {
                        ...
                        MARsHandler.getInstance().sendCallSetAppStandbyBucketMsgToMainHandler(mARsPackageInfo.getName(), mARsPackageInfo.getUserId(), 45, true);
                        break;
                    }
                    break;
                case 128:
                ...
                case 256:
                    ...
                    if (this.ENABLE_RESTRICTED_BUCKET) {
                        ...
                        MARsHandler.getInstance().sendCallSetAppStandbyBucketMsgToMainHandler(mARsPackageInfo.getName(), mARsPackageInfo.getUserId(), 10, true);
                        break;
                    }
                    break;
                case 512:
                ...
                case 1024:
                    if (!isDisabledByUser(mARsPackageInfo.getDisableReason())) {
                        if (mARsPackageInfo.getFASEnabled()) {
                            if (mARsPackageInfo.getFasType() == 1 || mARsPackageInfo.getFasType() == 64 || (!isChinaPolicyEnabled() && mARsPackageInfo.getFasType() == 0)) {
                                mARsPackageInfo.setMaxLevel(1);
                                MARsHandler.getInstance().sendCallSetModeMsgToMainHandler(mARsPackageInfo.getName(), mARsPackageInfo.getUid(), 0);
                                mARsPackageInfo.setFASEnabled(false);
                        ...
                        mARsPackageInfo.setResetTime(0L);
                        mARsPackageInfo.setState(1);
                        if (isChinaPolicyEnabled() && mARsPackageInfo.getFASEnabled() && (!FreecessController.getInstance().getFreecessEnabled() || mARsPackageInfo.getSharedUidName() != null)) {
    ...
    */
    public final void setMaxLevel(int i, String str) {
        ...
        int i2;
        synchronized (MARsLock) {
            MARsPackageInfo mARsPackageInfo = getMARsPackageInfo(this.mMARsTargetPackages, str, this.mContext.getUserId());
            if (mARsPackageInfo != null) {
                if (i != 1) {
                    i2 = 2;
                    if (i != 2) {
                        ...
                        MARsHandler.getInstance().sendCallSetAppStandbyBucketMsgToMainHandler(mARsPackageInfo.getName(), mARsPackageInfo.getUserId(), this.ENABLE_RESTRICTED_BUCKET ? 45 : 40, false);
                    }
                } else {
                    i2 = 1024;
                }
                ...
                if (levelChange(i2, mARsPackageInfo)) {
                    fASEntity = new FASEntityBuilder().setStrPkgName(mARsPackageInfo.getName()).setStrUid(Integer.toString(mARsPackageInfo.getUid())).setStrMode(mARsPackageInfo.getFASEnabled() ? "1" : "0").setStrNew(mARsPackageInfo.getFASEnabled() ? "1" : "0").setStrFasReason(mARsPackageInfo.getFasReason()).setStrExtras(FASTableContract.convertStateToDBExtrasValue(mARsPackageInfo.getState())).setStrResetTime(Long.toString(mARsPackageInfo.getResetTime())).setStrLevel(Integer.toString(mARsPackageInfo.getMaxLevel())).setStrDisableReason(FASTableContract.convertDisableReasonToDBValue(mARsPackageInfo.getDisableReason())).build();
                    if (fASEntity == null) {
                        MARsDBManager.getInstance().sendUpdateResetTimeSpecificMsgToDBHandler(fASEntity);
                        return;
                    }
            ...
            for (int i2 = 0; i2 < this.mMARsTargetPackages.getMap().size(); i2++) {
                ...
                for (int i3 = 0; i3 < sparseArray.size(); i3++) {
                    ...
                    if (mARsPackageInfo != null && isCurrentUser(mARsPackageInfo.getUserId())) {
                        if (i == 0) {
                            if (mARsPackageInfo.getMaxLevel() == 4) {
                                convertDisableReasonToDBValue = FASTableContract.convertDisableReasonToDBValue(mARsPackageInfo.getDisableReason());
                            ...
                            if (mARsPackageInfo.getFASEnabled()) {
                                convertDisableReasonToDBValue = FASTableContract.convertFASTypeToReason(mARsPackageInfo.getFasType());
                                if (convertDisableReasonToDBValue == null) {
                                }
                            }
                            convertDisableReasonToDBValue = null;
                            ...
                            if (i == 3 && !mARsPackageInfo.getFASEnabled() && mARsPackageInfo.getFasType() == 256) {
                                convertDisableReasonToDBValue = FASTableContract.convertFASTypeToReason(mARsPackageInfo.getFasType());
                                if (convertDisableReasonToDBValue == null) {
                                    arrayList.add(new SemAppRestrictionManager.AppRestrictionInfo(mARsPackageInfo.getName(), mARsPackageInfo.getUid(), new SemAppRestrictionManager.RestrictionInfo(i, 1, convertDisableReasonToDBValue)));
                                }
                            }
                            convertDisableReasonToDBValue = null;
                            if (convertDisableReasonToDBValue == null) {
                    ...
                    if (mARsPackageInfo != null) {
                        if (mARsPackageInfo.getMaxLevel() == 4) {
                            ...
                            if (mARsPackageInfo.getFASEnabled()) {
                                ...
                                mARsPackageInfo.setFasType(FASTableContract.convertFASReasonToValue(str));
                                mARsPackageInfo.setFasReason(str);
                                arrayList2.add(new FASEntityBuilder().setStrPkgName(mARsPackageInfo.getName()).setStrUid(Integer.toString(mARsPackageInfo.getUid())).setStrMode(!mARsPackageInfo.getFASEnabled() ? "1" : "0").setStrFasReason(FASTableContract.convertFASTypeToReason(mARsPackageInfo.getFasType())).setStrExtras(FASTableContract.convertStateToDBExtrasValue(mARsPackageInfo.getState())).setStrResetTime(Long.toString(mARsPackageInfo.getResetTime())).setStrLevel(Integer.toString(mARsPackageInfo.getMaxLevel())).build());
                                arrayList3.add(Integer.valueOf(mARsPackageInfo.getUid()));
                                if (isChinaPolicyEnabled() && i == 64 && z) {
                                    addRestrictListAvoidAssoicationLaunch(packageName, userId, "auto run off", "UserChangeFAS");
                                }
                            }
            ...
            synchronized (MARsLock) {
                ...
                if (mARsPackageInfo2 != null) {
                    ...
                    if (enableAction && levelChange(i, mARsPackageInfo2)) {
                        ...
                        arrayList2.add(new FASEntityBuilder().setStrPkgName(mARsPackageInfo2.getName()).setStrUid(Integer.toString(mARsPackageInfo2.getUid())).setStrMode(mARsPackageInfo2.getFASEnabled() ? "1" : "0").setStrFasReason(FASTableContract.convertFASTypeToReason(mARsPackageInfo2.getFasType())).setStrExtras(FASTableContract.convertStateToDBExtrasValue(mARsPackageInfo2.getState())).setStrResetTime(Long.toString(mARsPackageInfo2.getResetTime())).setStrLevel(Integer.toString(mARsPackageInfo2.getMaxLevel())).setStrDisableReason(FASTableContract.convertDisableReasonToDBValue(mARsPackageInfo2.getDisableReason())).build());
    ...
    */
    public void setSCPMList(ArrayList arrayList) {
        ...
        for (Iterator it2 = arrayList.iterator(); it2.hasNext(); it2 = it) {
            ...
            if (!z || pkgStatusInfo == null) {
                ...
                try {
                    ...
                    applicationEnabledSetting = asInterface.getApplicationEnabledSetting(pkgStatusInfo.name, pkgStatusInfo.userId);
                    i2 = 1;
                } catch (Exception e) {
                    e = e;
                    i2 = 1;
                    ...
                    if (pkgStatusInfo == null && z2) {
                        synchronized (MARsLock) {
                            ...
                            if (mARsPackageInfo2 != null) {
                                ...
                                arrayList2.add(new FASEntityBuilder().setStrPkgName(mARsPackageInfo2.getName()).setStrUid(Integer.toString(mARsPackageInfo2.getUid())).setStrMode(mARsPackageInfo2.getFASEnabled() ? "1" : null).setStrNew(mARsPackageInfo2.getFASEnabled() ? "1" : null).setStrFasReason(mARsPackageInfo2.getFasType() == i2 ? FASTableContract.convertFASTypeToReason(mARsPackageInfo2.getFasType()) : null).setStrDisableReason(FASTableContract.convertDisableReasonToDBValue(i)).setStrExtras(FASTableContract.convertStateToDBExtrasValue(mARsPackageInfo2.getState())).setStrLevel(Integer.toString(mARsPackageInfo2.getMaxLevel())).build());
                            }
                        }
                    }
                } else {
        ...
        if (arrayList2.size() > 0) {
            MARsDBManager.getInstance().sendUpdateResetTimeMsgToDBHandler(arrayList2);
            MARsHandler.getInstance().sendNotifyDeviceCareMsgToMainHandler("deepsleepspecific", arrayList3, arrayList4);
        }
    }
