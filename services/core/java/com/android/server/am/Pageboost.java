    ...
    public final class PageboostAppInfo {
        ...
        */
        public void getIoinfo(long[] jArr) {
            ...
            Throwable th;
            try {
                BufferedReader bufferedReader = new BufferedReader(new FileReader("/proc/" + this.mPid + "/ioinfo"));
                i = 0;
                while (true) {
                    try {
                    ...
                    while (true) {
                        try {
                            ...
                            if (readAllBytes[i2] == 10) {
                                String[] split = new String(Arrays.copyOfRange(readAllBytes, i3, i2), StandardCharsets.UTF_8).split(" ");
                                if (split.length != 2) {
                                    break;
                                }
                                if (split[0].equals("mapped")) {
                                    ...
                                    if (z) {
                                        i = i4;
                                        PageboostFileDBHelper.insertTable(Pageboost.mFileDB, str2, str, parseInt, copyOfRange, parseInt2, 0);
                                    } else {
                                        i = i4;
                                    }
                                    i3 = i5;
    ...
    public abstract class PageboostAppCapture {
        ...
        */
        public static void snapshot(PageboostAppInfo pageboostAppInfo, int i) {
            ...
            if (Pageboost.mZygote64FileMap == null || !Pageboost.mZygote64FileMap.isCorrect() || Pageboost.mZygoteFileMap == null || !Pageboost.mZygoteFileMap.isCorrect()) {
                return;
            }
            ...
            String createTable = PageboostFileDBHelper.createTable(Pageboost.mFileDB, pageboostAppInfo.mNameTrimmed);
            if (createTable == null) {
                return;
            }
            long j3 = 0;
            if (2 <= PAGEBOOST_IO_PREFETCH_LEVEL) {
                ...
                if (fileMapList.isCorrect()) {
                    ...
                    while (true) {
                        ...
                        if (isCaptureTarget(str2) && (!check64Bit || !Pageboost.mZygote64FileMap.contain(str2))) {
                            if (check64Bit || !Pageboost.mZygoteFileMap.contain(str2)) {
                                ...
                                if (fileMapInfo.isCorrect()) {
                                    it = it2;
                                    z3 = z5;
                                    long[] fileMapInfo2 = fileMapInfo.getFileMapInfo(str2, true, createTable, pageboostAppInfo.mApkPath);
                                    if (fileMapInfo2 != null) {
                                        ...
                                        if (j7 > 131072) {
                                            Slog.i(Pageboost.TAG, "IO Capture 'map' over dbsize limit : " + j7 + "/" + IInstalld.FLAG_CLEAR_APP_DATA_KEEP_ART_PROFILES);
                                            break;
                                        }
                                        j5 = j7;
                                        z4 = true;
                    ...
                    Slog.i(Pageboost.TAG, "IO Capture 'mapped files' pid : " + i + " size : " + j9 + " time : " + (currentTimeMillis3 - currentTimeMillis2));
                    j2 = j9;
                    j = j8;
                    ...
                    if (1 <= i2 && (str = pageboostAppInfo.mApkPath) != null && isCaptureTarget(str)) {
                        ...
                        if (file.exists()) {
                            ...
                            if (i4 > 0) {
                                ...
                                int i5 = i3;
                                PageboostFileDBHelper.insertTable(Pageboost.mFileDB, createTable, str, 0, bArr, i4, 0);
                    ...
                    Slog.i(Pageboost.TAG, "IO Capture end for : " + pageboostAppInfo.mName + "pid : " + i + " done correctly? " + z);
                }
            }
            j = 0;
            j2 = 0;
        ...
        try {
            ...
            if (printWriter != null && mGlobalAppLRU != null) {
                ...
                if (strArr.length <= 2 || !"heimdall".equals(strArr[1])) {
                    ...
                    printWriter.println("- Bigdata: " + BigDataProxy.ENABLED + ",  String: " + BigDataProxy.makeString());
