...
public class AssistDataRequester extends IAssistDataReceiver.Stub {
    ...
    */
    public final void requestData(List list, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, int i, String str, String str2, boolean z8) {
        boolean z9;
        ...
        if (z2) {
            if (this.mAppOpsManager.noteOpNoThrow(this.mRequestStructureAppOps, i, str, str2, (String) null) == 0 && z11) {
                int size = list.size();
                int i2 = 0;
                while (i2 < size) {
            ...
            if (z3) {
                if (this.mAppOpsManager.noteOpNoThrow(this.mRequestScreenshotAppOps, i, str, str2, (String) null) == 0 && z10) {
                    try {
