...
public abstract class PersistentConnection {
          ...
          synchronized (PersistentConnection.this.mLock) {
            if (!PersistentConnection.this.mBound) {
              Log.w(
                  ...
                  "Connected: "
                      + PersistentConnection.this.mComponentName.flattenToShortString()
                      + " u"
  ...
  public final Runnable mBindForBackoffRunnable =
  ...
  public final Runnable mStableCheck =
      new Runnable() { // from class:
                       // com.android.server.am.PersistentConnection$$ExternalSyntheticLambda1
        @Override // java.lang.Runnable
        public final void run() {
  ...
  public final void unbindLocked() {
    ...
    if (this.mBound) {
      Log.i(
          this.mTag,
          "Stopping: " + this.mComponentName.flattenToShortString() + " u" + this.mUserId);
      this.mBound = false;
  ...
  public void scheduleRebindLocked() {
    ...
    this.mNextBackoffMs =
        Math.min(
            ...
            (long) (((double) this.mNextBackoffMs) * this.mRebindBackoffIncrease));
  ...
  public final void stableConnectionCheck() {
    synchronized (this.mLock) {
      long injectUptimeMillis =
          (this.mLastConnectedTime + this.mResetBackoffDelay) - injectUptimeMillis();
