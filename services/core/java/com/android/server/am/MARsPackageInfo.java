...
public class MARsPackageInfo {
    ...
    */
    public MARsPackageInfo(FASEntity fASEntity) {
        ...
        int convertDBValueToDisableReason = FASTableContract.convertDBValueToDisableReason(fASEntity.getStrDisableReason());
        try {
        ...
        try {
            ...
            try {
                parseLong = fASEntity.getStrResetTime() != null ? Long.parseLong(fASEntity.getStrResetTime()) : 0L;
                try {
                    i4 = fASEntity.getStrPackageType() != null ? Integer.parseInt(fASEntity.getStrPackageType()) : 0;
                    try {
                        ...
                        i5 = fASEntity.getStrDisableType() != null ? Integer.parseInt(fASEntity.getStrDisableType()) : -1;
        ...
        try {
            r9 = fASEntity.getStrDisableResetTime() != null ? Long.parseLong(fASEntity.getStrDisableResetTime()) : 0L;
            i6 = i4;
            i7 = i5;
            d = fASEntity.getStrPreBatteryUsage() != null ? Double.parseDouble(fASEntity.getStrPreBatteryUsage()) : 0.0d;
            j2 = parseLong;
