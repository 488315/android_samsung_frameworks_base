...
public final class SameProcessApplicationThread extends IApplicationThread.Default {
    ...
    public final void schedulePing(RemoteCallback remoteCallback) {
        this.mHandler.post(
                new SameProcessApplicationThread$$ExternalSyntheticLambda2(
        ...
        this.mHandler.post(
                new Runnable() { // from class:
                    ...
                    public final void run() {
                        SameProcessApplicationThread sameProcessApplicationThread =
                                SameProcessApplicationThread.this;
                        ...
                        try {
                            sameProcessApplicationThread.mWrapped.scheduleReceiver(
                                    intent2,
                                    activityInfo2,
                                    compatibilityInfo2,
                                    i5,
    ...
    public final void scheduleReceiverList(List list) {
        this.mHandler.post(
                new SameProcessApplicationThread$$ExternalSyntheticLambda2(this, list, 1));
    }

    public final void scheduleRegisteredReceiver(
        ...
        this.mHandler.post(
                new Runnable() { // from class:
                    ...
                    public final void run() {
                        ...
                        sameProcessApplicationThread.getClass();
                        try {
                            sameProcessApplicationThread.mWrapped.scheduleRegisteredReceiver(
                                    iIntentReceiver2,
                                    intent2,
                                    i5,
                                    str3,
