...
public final class ActivityManagerConstants extends ContentObserver {
    ...
    public ActivityManagerConstants(Context context, ActivityManagerService activityManagerService, Handler handler) {
        ...
        this.mSystemServerAutomaticHeapDumpEnabled = Build.IS_DEBUGGABLE && context.getResources().getBoolean(R.bool.config_cecTvSendStandbyOnSleepDisabled_allowed);
        this.mSystemServerAutomaticHeapDumpPackageName = context.getPackageName();
        this.mSystemServerAutomaticHeapDumpPssThresholdBytes = Math.max(102400L, context.getResources().getInteger(R.integer.config_defaultRefreshRateInHbmSunlight));
        this.mDefaultImperceptibleKillExemptPackages = Arrays.asList(context.getResources().getStringArray(R.array.config_securityStatePackages));
        this.mDefaultImperceptibleKillExemptProcStates = (List) Arrays.stream(context.getResources().getIntArray(R.array.config_serialPorts)).boxed().collect(Collectors.toList());
        ...
        boolean z = context.getResources().getBoolean(R.bool.config_cecTvSendStandbyOnSleepEnabled_default);
        this.mDefaultBinderHeavyHitterWatcherEnabled = z;
        int integer = context.getResources().getInteger(R.integer.config_default_cellular_usage_setting);
        ...
        boolean z2 = context.getResources().getBoolean(R.bool.config_cecTvSendStandbyOnSleepEnabled_allowed);
        ...
        arraySet.addAll((Collection) Arrays.stream(context.getResources().getStringArray(R.array.special_locale_codes)).map(new Function() { // from class: com.android.server.am.ActivityManagerConstants$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return ComponentName.unflattenFromString((String) obj);
            }
        }).collect(Collectors.toSet()));
        this.mCustomizedMaxCachedProcesses = context.getResources().getInteger(R.integer.config_defaultPeakRefreshRate);
