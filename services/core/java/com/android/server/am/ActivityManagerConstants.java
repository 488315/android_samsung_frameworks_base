...
public final class ActivityManagerConstants extends ContentObserver {
  ...
  public final DeviceConfig.OnPropertiesChangedListener
  ...
  public ActivityManagerConstants(
      Context context, ActivityManagerService activityManagerService, Handler handler) {
    super(handler);
    ...
    this.mOnDeviceConfigChangedListener =
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.am.ActivityManagerConstants.1
    ...
    this.mOnDeviceConfigChangedForComponentAliasListener =
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.am.ActivityManagerConstants.2
          public void onPropertiesChanged(DeviceConfig.Properties properties) {
            String str;
            Iterator it = properties.getKeyset().iterator();
            while (it.hasNext() && (str = (String) it.next()) != null) {
              if (str.equals("enable_experimental_component_alias")
                  || str.equals("component_alias_overrides")) {
    ...
    this.mSystemServerAutomaticHeapDumpEnabled =
        Build.IS_DEBUGGABLE
            && context
                .getResources()
                .getBoolean(R.bool.config_cecTvSendStandbyOnSleepDisabled_allowed);
    ...
    this.mDefaultImperceptibleKillExemptPackages =
        Arrays.asList(context.getResources().getStringArray(R.array.config_securityStatePackages));
    this.mDefaultImperceptibleKillExemptProcStates =
        (List)
            Arrays.stream(context.getResources().getIntArray(R.array.config_serialPorts))
                .boxed()
                .collect(Collectors.toList());
    this.IMPERCEPTIBLE_KILL_EXEMPT_PACKAGES.addAll(this.mDefaultImperceptibleKillExemptPackages);
    this.IMPERCEPTIBLE_KILL_EXEMPT_PROC_STATES.addAll(
        this.mDefaultImperceptibleKillExemptProcStates);
    boolean z =
        context.getResources().getBoolean(R.bool.config_cecTvSendStandbyOnSleepEnabled_default);
    this.mDefaultBinderHeavyHitterWatcherEnabled = z;
    int integer =
        context.getResources().getInteger(R.integer.config_default_cellular_usage_setting);
    this.mDefaultBinderHeavyHitterWatcherBatchSize = integer;
    float f = context.getResources().getFloat(R.dimen.config_am_pssToRssThresholdModifier);
    this.mDefaultBinderHeavyHitterWatcherThreshold = f;
    boolean z2 =
        context.getResources().getBoolean(R.bool.config_cecTvSendStandbyOnSleepEnabled_allowed);
    this.mDefaultBinderHeavyHitterAutoSamplerEnabled = z2;
    int integer2 = context.getResources().getInteger(R.integer.config_defaultVibrationAmplitude);
    this.mDefaultBinderHeavyHitterAutoSamplerBatchSize = integer2;
    float f2 = context.getResources().getFloat(R.dimen.config_alertDialogSelectionScrollOffset);
    ...
    arraySet.addAll(
        (Collection)
            Arrays.stream(context.getResources().getStringArray(R.array.special_locale_codes))
                .map(
                    new Function() { // from class:
                                     // com.android.server.am.ActivityManagerConstants$$ExternalSyntheticLambda0
    ...
    this.mCustomizedMaxCachedProcesses =
        context.getResources().getInteger(R.integer.config_defaultPeakRefreshRate);
  ...
  public void start(ContentResolver contentResolver) {
    ...
    this.mResolver.registerContentObserver(
        FOREGROUND_SERVICE_STARTS_LOGGING_ENABLED_URI, false, this);
    if (this.mSystemServerAutomaticHeapDumpEnabled) {
      this.mResolver.registerContentObserver(
          ENABLE_AUTOMATIC_SYSTEM_SERVER_HEAP_DUMPS_URI, false, this);
    }
    updateConstants();
    if (this.mSystemServerAutomaticHeapDumpEnabled) {
  ...
  public final void loadDeviceConfigConstants() {
    this.mOnDeviceConfigChangedListener.onPropertiesChanged(
        DeviceConfig.getProperties("activity_manager", new String[0]));
    this.mOnDeviceConfigChangedForComponentAliasListener.onPropertiesChanged(
  ...
  public final void updateConstants() {
    ...
    synchronized (activityManagerService) {
      try {
        ...
        this.MEMORY_INFO_THROTTLE_TIME =
            this.mParser.getLong(
                "memory_info_throttle_time",
                BackupAgentTimeoutParameters.DEFAULT_FULL_BACKUP_AGENT_TIMEOUT_MILLIS);
        this.TOP_TO_ALMOST_PERCEPTIBLE_GRACE_DURATION =
            this.mParser.getDurationMillis("top_to_almost_perceptible_grace_duration", 15000L);
  ...
  public final void updateOomAdjUpdatePolicy() {
    this.OOMADJ_UPDATE_QUICK =
        DeviceConfig.getInt("activity_manager", "oomadj_update_policy", 1) == 1;
  }

  public final void updateForceRestrictedBackgroundCheck() {
    this.FORCE_BACKGROUND_CHECK_ON_RESTRICTED_APPS =
        DeviceConfig.getBoolean("activity_manager", "force_bg_check_on_restricted", true);
  }

  public final void updateBootTimeTempAllowListDuration() {
    this.mBootTimeTempAllowlistDuration =
        DeviceConfig.getLong("activity_manager", "boot_time_temp_allowlist_duration", 20000L);
  }

  public final void updateFgToBgFgsGraceDuration() {
    this.mFgToBgFgsGraceDuration =
        DeviceConfig.getLong("activity_manager", "fg_to_bg_fgs_grace_duration", 5000L);
  }

  public final void updateFgsStartForegroundTimeout() {
    this.mFgsStartForegroundTimeoutMs =
        DeviceConfig.getLong("activity_manager", "fgs_start_foreground_timeout", 10000L);
  }

  public final void updateFgsAtomSamplePercent() {
    this.mFgsAtomSampleRate =
        DeviceConfig.getFloat("activity_manager", "fgs_atom_sample_rate", 1.0f);
  }

  public final void updateFgsStartAllowedLogSamplePercent() {
    this.mFgsStartAllowedLogSampleRate =
        DeviceConfig.getFloat("activity_manager", "fgs_start_allowed_log_sample_rate", 0.25f);
  }

  public final void updateFgsStartDeniedLogSamplePercent() {
    this.mFgsStartDeniedLogSampleRate =
        DeviceConfig.getFloat("activity_manager", "fgs_start_denied_log_sample_rate", 1.0f);
  }

  public final void updateKillBgRestrictedCachedIdle() {
    this.mKillBgRestrictedAndCachedIdle =
        DeviceConfig.getBoolean("activity_manager", "kill_bg_restricted_cached_idle", true);
  }

  public final void updateKillBgRestrictedCachedIdleSettleTime() {
    long j = this.mKillBgRestrictedAndCachedIdleSettleTimeMs;
    this.mKillBgRestrictedAndCachedIdleSettleTimeMs =
        DeviceConfig.getLong(
            "activity_manager", "kill_bg_restricted_cached_idle_settle_time", 60000L);
    if (this.mKillBgRestrictedAndCachedIdleSettleTimeMs < j) {
      this.mService.mHandler.sendEmptyMessageDelayed(
          58, this.mKillBgRestrictedAndCachedIdleSettleTimeMs);
    }
  }
  ...
  public final void updateExtraServiceRestartDelayOnMemPressure() {
    ...
    synchronized (activityManagerService) {
      try {
        ...
        this.mService.mServices.performRescheduleServiceRestartOnMemoryPressureLocked(
            parseLongArray[lastMemoryLevelLocked],
  ...
  public final void updateEnableExtraServiceRestartDelayOnMemPressure() {
    ...
    synchronized (activityManagerService) {
      try {
        ...
        boolean z2 =
            DeviceConfig.getBoolean(
                "activity_manager", "enable_extra_delay_svc_restart_mem_pressure", true);
  ...
  public final void updatePrioritizeAlarmBroadcasts() {
    ...
    this.mPrioritizeAlarmBroadcasts =
        TextUtils.isEmpty(string) ? true : Boolean.parseBoolean(string);
  }

  public final void updateDeferBootCompletedBroadcast() {
    this.mDeferBootCompletedBroadcast =
        DeviceConfig.getInt("activity_manager", "defer_boot_completed_broadcast", 6);
  }

  public final void updateNoKillCachedProcessesUntilBootCompleted() {
    this.mNoKillCachedProcessesUntilBootCompleted =
        DeviceConfig.getBoolean(
            "activity_manager", "no_kill_cached_processes_until_boot_completed", false);
  }
  ...
  public final void updateNoKillCachedProcessesPostBootCompletedDurationMillis() {
    this.mNoKillCachedProcessesPostBootCompletedDurationMillis =
        DeviceConfig.getLong(
            "activity_manager", "no_kill_cached_processes_post_boot_completed_duration_millis", 0L);
  }

  public final void updateMaxEmptyTimeMillis() {
    this.mMaxEmptyTimeMillis =
        DeviceConfig.getLong("activity_manager", "max_empty_time_millis", 3600000000L);
  }

  public final void updateNetworkAccessTimeoutMs() {
    this.mNetworkAccessTimeoutMs =
        DeviceConfig.getLong("activity_manager", "network_access_timeout_ms", 200L);
  }

  public final void updateServiceStartForegroundTimeoutMs() {
    this.mServiceStartForegroundTimeoutMs =
        DeviceConfig.getInt("activity_manager", "service_start_foreground_timeout_ms", 30000);
  }

  public final void updateServiceStartForegroundAnrDealyMs() {
    this.mServiceStartForegroundAnrDelayMs =
        DeviceConfig.getInt("activity_manager", "service_start_foreground_anr_delay_ms", 10000);
  }

  public final void updateServiceBindAlmostPerceptibleTimeoutMs() {
    this.mServiceBindAlmostPerceptibleTimeoutMs =
        DeviceConfig.getLong(
            "activity_manager", "service_bind_almost_perceptible_timeout_ms", 15000L);
  }
  ...
  public final void updateComponentAliases() {
    this.mEnableComponentAlias =
        DeviceConfig.getBoolean(
            "activity_manager_ca", "enable_experimental_component_alias", false);
    this.mComponentAliasOverrides =
        DeviceConfig.getString("activity_manager_ca", "component_alias_overrides", "");
    this.mService.mComponentAliasResolver.update(
        this.mEnableComponentAlias, this.mComponentAliasOverrides);
  }

  public final void updateProcessKillTimeout() {
    this.mProcessKillTimeoutMs =
        DeviceConfig.getLong("activity_manager", "process_kill_timeout", 10000L);
  }
  ...
  public final void updateImperceptibleKillExemptions() {
    ...
    String string =
        DeviceConfig.getString(
            "activity_manager", "imperceptible_kill_exempt_packages", (String) null);
    if (!TextUtils.isEmpty(string)) {
    ...
    String string2 =
        DeviceConfig.getString(
            "activity_manager", "imperceptible_kill_exempt_proc_states", (String) null);
    ...
    Arrays.asList(string2.split(",")).stream()
        .forEach(
            new Consumer() { // from class:
                             // com.android.server.am.ActivityManagerConstants$$ExternalSyntheticLambda1
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                ActivityManagerConstants.this.lambda$updateImperceptibleKillExemptions$0(
                    (String) obj);
              }
            });
  }
  ...
  public final void updateEnableAutomaticSystemServerHeapDumps() {
    if (!this.mSystemServerAutomaticHeapDumpEnabled) {
      Slog.wtf(
          ...
          "updateEnableAutomaticSystemServerHeapDumps called when leak detection disabled");
    } else {
      this.mService.setDumpHeapDebugLimit(
          null,
          0,
          Settings.Global.getInt(this.mResolver, "enable_automatic_system_server_heap_dumps", 1)
                  == 1
              ? this.mSystemServerAutomaticHeapDumpPssThresholdBytes
              : 0L,
  ...
  public final void updateProactiveKillsEnabled() {
    PROACTIVE_KILLS_ENABLED =
        DeviceConfig.getBoolean("activity_manager", "proactive_kills_enabled", false);
  }

  public final void updateLowSwapThresholdPercent() {
    LOW_SWAP_THRESHOLD_PERCENT =
        DeviceConfig.getFloat("activity_manager", "low_swap_threshold_percent", 0.1f);
  }

  public final void updateTopToFgsGraceDuration() {
    this.TOP_TO_FGS_GRACE_DURATION =
        DeviceConfig.getLong("activity_manager", "top_to_fgs_grace_duration", 15000L);
  }
  ...
  public final void updateBinderHeavyHitterWatcher() {
    BINDER_HEAVY_HITTER_WATCHER_ENABLED =
        DeviceConfig.getBoolean(
            "activity_manager",
            "binder_heavy_hitter_watcher_enabled",
            this.mDefaultBinderHeavyHitterWatcherEnabled);
    BINDER_HEAVY_HITTER_WATCHER_BATCHSIZE =
        DeviceConfig.getInt(
            "activity_manager",
            "binder_heavy_hitter_watcher_batchsize",
            this.mDefaultBinderHeavyHitterWatcherBatchSize);
    BINDER_HEAVY_HITTER_WATCHER_THRESHOLD =
        DeviceConfig.getFloat(
            "activity_manager",
            "binder_heavy_hitter_watcher_threshold",
            this.mDefaultBinderHeavyHitterWatcherThreshold);
    BINDER_HEAVY_HITTER_AUTO_SAMPLER_ENABLED =
        DeviceConfig.getBoolean(
            "activity_manager",
            "binder_heavy_hitter_auto_sampler_enabled",
            this.mDefaultBinderHeavyHitterAutoSamplerEnabled);
    BINDER_HEAVY_HITTER_AUTO_SAMPLER_BATCHSIZE =
        DeviceConfig.getInt(
            "activity_manager",
            "binder_heavy_hitter_auto_sampler_batchsize",
            this.mDefaultBinderHeavyHitterAutoSamplerBatchSize);
    BINDER_HEAVY_HITTER_WATCHER_THRESHOLD =
        DeviceConfig.getFloat(
            "activity_manager",
            "binder_heavy_hitter_auto_sampler_threshold",
            this.mDefaultBinderHeavyHitterAutoSamplerThreshold);
  ...
  public final void updateMaxServiceConnectionsPerProcess() {
    this.mMaxServiceConnectionsPerProcess =
        DeviceConfig.getInt("activity_manager", "max_service_connections_per_process", 3000);
  }

  public final void updateShortFgsTimeoutDuration() {
    this.mShortFgsTimeoutDuration =
        DeviceConfig.getLong("activity_manager", "short_fgs_timeout_duration", 180000L);
  }

  public final void updateShortFgsProcStateExtraWaitDuration() {
    this.mShortFgsProcStateExtraWaitDuration =
        DeviceConfig.getLong("activity_manager", "short_fgs_proc_state_extra_wait_duration", 5000L);
  }

  public final void updateShortFgsAnrExtraWaitDuration() {
    this.mShortFgsAnrExtraWaitDuration =
        DeviceConfig.getLong("activity_manager", "short_fgs_anr_extra_wait_duration", 10000L);
  }

  public final void updateEnableWaitForFinishAttachApplication() {
    this.mEnableWaitForFinishAttachApplication =
        DeviceConfig.getBoolean(
            "activity_manager", "enable_wait_for_finish_attach_application", false);
  }

  public final void updateUseTieredCachedAdj() {
    this.USE_TIERED_CACHED_ADJ =
        DeviceConfig.getBoolean("activity_manager", "use_tiered_cached_adj", false);
    this.TIERED_CACHED_ADJ_DECAY_TIME =
        DeviceConfig.getLong("activity_manager", "tiered_cached_adj_decay_time", 60000L);
  }
