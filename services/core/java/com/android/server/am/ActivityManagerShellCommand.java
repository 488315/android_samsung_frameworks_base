...
public final class ActivityManagerShellCommand extends ShellCommand {
    ...
    public class ProgressWaiter extends IProgressListener.Stub {
        ...
        public void onProgress(int i, int i2, Bundle bundle) {
            Slogf.m88d("ActivityManager", "ProgressWaiter[user=%d]: onProgress(%d, %d)", Integer.valueOf(this.mUserId), Integer.valueOf(i), Integer.valueOf(i2));
        }

        public void onFinished(int i, Bundle bundle) {
            Slogf.m88d("ActivityManager", "ProgressWaiter[user=%d]: onFinished(%d)", Integer.valueOf(this.mUserId), Integer.valueOf(i));
    ...
    */
    public int runStartActivity(PrintWriter printWriter) {
        ...
        try {
            ...
            while (true) {
                ...
                if (this.mForceWindowingMode != 0) {
                    if (activityOptions5 == null) {
                        activityOptions6 = ActivityOptions.makeBasic();
                    }
                    activityOptions6.setForceLaunchWindowingMode(this.mForceWindowingMode);
                ...
                if (this.mWindowingMode == 5) {
                    ...
                    activityOptions8.setApplyBigFreeformSize(r14);
                ...
                if (CoreRune.MT_NEW_DEX_LAUNCH_POLICY) {
                    ...
                    activityOptions10 = activityOptions9;
                    if (this.mForceLaunchTaskOnHome) {
                        if (activityOptions9 == null) {
                            activityOptions11 = ActivityOptions.makeBasic();
                        }
                        activityOptions11.setForceLaunchTaskOnHome();
                        activityOptions10 = activityOptions11;
                    }
                }
                ActivityOptions activityOptions12 = activityOptions10;
                ActivityOptions activityOptions13 = activityOptions10;
                if (this.mActivityType != 0) {
                    if (activityOptions10 == null) {
                        activityOptions12 = ActivityOptions.makeBasic();
                    }
                    activityOptions12.setLaunchActivityType(this.mActivityType);
                ...
                if (this.mTaskId != i6) {
                    ...
                    activityOptions14.setLaunchTaskId(this.mTaskId);
                    activityOptions15 = activityOptions14;
                    if (this.mIsTaskOverlay) {
                        activityOptions14.setTaskOverlay(r14, r14);
                        activityOptions15 = activityOptions14;
                    }
                }
                ActivityOptions activityOptions16 = activityOptions15;
                ActivityOptions activityOptions17 = activityOptions15;
                if (this.mIsLockTask) {
                    if (activityOptions15 == null) {
                        activityOptions16 = ActivityOptions.makeBasic();
                    }
                    activityOptions16.setLockTaskEnabled(r14);
                    activityOptions17 = activityOptions16;
                }
                ActivityOptions activityOptions18 = activityOptions17;
                ActivityOptions activityOptions19 = activityOptions17;
                if (this.mShowSplashScreen) {
                    if (activityOptions17 == null) {
                        activityOptions18 = ActivityOptions.makeBasic();
                    }
                    activityOptions18.setSplashScreenStyle(r14);
                    activityOptions19 = activityOptions18;
                }
                ActivityOptions activityOptions20 = activityOptions19;
                ActivityOptions activityOptions21 = activityOptions19;
                if (this.mDismissKeyguard) {
                    if (activityOptions19 == null) {
                        activityOptions20 = ActivityOptions.makeBasic();
                    }
                    activityOptions20.setDismissKeyguard();
                    activityOptions21 = activityOptions20;
                }
                if (this.mWaitOption) {
                    i = 0;
                    i2 = i6;
                    Bundle startActivityAndWait = this.mInternal.startActivityAndWait(null, "com.android.shell", null, makeIntent, resolveType, null, null, 0, this.mStartFlags, profilerInfo, activityOptions21 != null ? activityOptions21.toBundle() : null, this.mUserId);
                    startActivityAsUserWithFeature = ((WaitResult) startActivityAndWait).result;
                    r17 = startActivityAndWait;
                } else {
                    i = 0;
                    i2 = i6;
                    startActivityAsUserWithFeature = this.mInternal.startActivityAsUserWithFeature(null, "com.android.shell", null, makeIntent, resolveType, null, null, 0, this.mStartFlags, profilerInfo, activityOptions21 != null ? activityOptions21.toBundle() : null, this.mUserId);
                }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public int runStartActivityForCarlife(PrintWriter printWriter) {
        ParcelFileDescriptor parcelFileDescriptor;
        ProfilerInfo profilerInfo;
        ActivityOptions activityOptions;
        int i;
        ...
        try {
            ...
            if (CoreRune.BAIDU_CARLIFE) {
                makeIntent = BaiduCarlifeADBConnectUtils.repackIntent(makeIntent);
            }
            String resolveType = makeIntent.resolveType(this.mInternal.mContext);
            do {
                if (this.mStopOption) {
                ...
                if (CoreRune.BAIDU_CARLIFE && BaiduCarlifeADBConnectUtils.isCarlifeForceConnect() && BaiduCarlifeADBConnectUtils.isCarLinkIntent(makeIntent)) {
                    BaiduCarlifeADBConnectUtils.printForCarlifeStart(printWriter);
                } else {
                    printWriter.println("Starting: " + makeIntent);
                }
                printWriter.flush();
                ...
                if (this.mTaskDisplayAreaFeatureId != -1) {
                    if (activityOptions == null) {
                        activityOptions = ActivityOptions.makeBasic();
                    }
                    activityOptions.setLaunchTaskDisplayAreaFeatureId(this.mTaskDisplayAreaFeatureId);
                }
                if (this.mWindowingMode != 0) {
                    if (activityOptions == null) {
                        activityOptions = ActivityOptions.makeBasic();
                    }
                    activityOptions.setLaunchWindowingMode(this.mWindowingMode);
                }
                if (this.mForceWindowingMode != 0) {
                    if (activityOptions == null) {
                        activityOptions = ActivityOptions.makeBasic();
                    }
                    activityOptions.setForceLaunchWindowingMode(this.mForceWindowingMode);
                }
                if (this.mWindowingMode == 5) {
                    if (activityOptions == null) {
                        activityOptions = ActivityOptions.makeBasic();
                    }
                    activityOptions.setApplyBigFreeformSize(true);
                }
                if (this.mActivityType != 0) {
                    if (activityOptions == null) {
                        activityOptions = ActivityOptions.makeBasic();
                    }
                    activityOptions.setLaunchActivityType(this.mActivityType);
                }
                if (this.mTaskId != -1) {
                    if (activityOptions == null) {
                        activityOptions = ActivityOptions.makeBasic();
                ...
                if (this.mWaitOption) {
                    i = 0;
                    WaitResult startActivityAndWait = this.mInternal.startActivityAndWait(null, "com.android.shell", null, makeIntent, resolveType, null, null, 0, this.mStartFlags, profilerInfo, activityOptions != null ? activityOptions.toBundle() : null, this.mUserId);
                    startActivityAsUserWithFeature = startActivityAndWait.result;
                    waitResult2 = startActivityAndWait;
                } else {
                    i = 0;
                    startActivityAsUserWithFeature = this.mInternal.startActivityAsUserWithFeature(null, "com.android.shell", null, makeIntent, resolveType, null, null, 0, this.mStartFlags, profilerInfo, activityOptions != null ? activityOptions.toBundle() : null, this.mUserId);
                }
                long uptimeMillis2 = SystemClock.uptimeMillis();
                PrintWriter errPrintWriter = this.mWaitOption ? printWriter : getErrPrintWriter();
                if (CoreRune.BAIDU_CARLIFE && BaiduCarlifeADBConnectUtils.isCarlifeForceConnect() && BaiduCarlifeADBConnectUtils.isCarLinkIntent(makeIntent)) {
                    BaiduCarlifeADBConnectUtils.printForCarlifeStartWarning(errPrintWriter);
                } else {
                    if (startActivityAsUserWithFeature == -98) {
                        errPrintWriter.println("Error: Not allowed to start background user activity that shouldn't be displayed for all users.");
                    } else if (startActivityAsUserWithFeature == -97) {
                        ...
                        if (this.mWaitOption && i2 != 0) {
                            ...
                            printWriter.println(sb.toString());
                            printWriter.println("LaunchState: " + WaitResult.launchStateToString(waitResult.launchState));
    ...
    public int runSendBroadcast(PrintWriter printWriter) {
        ...
        try {
            ...
            Slogf.m96i("ActivityManager", "Enqueued broadcast %s: " + broadcastIntentWithFeature, makeIntent);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final int runProfile(PrintWriter printWriter) {
        String str;
        boolean z;
        int i;
        ProfilerInfo profilerInfo;
    ...
    public int runStartUser(PrintWriter printWriter) {
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                Slogf.m88d("ActivityManager", "runStartUser(): userId=%d, parentUserId=%d, currentUserId=%d, isProfile=%b, isVisibleProfile=%b, display=%d, waiter=%s", Integer.valueOf(parseInt), Integer.valueOf(profileParentId), Integer.valueOf(currentUserId), Boolean.valueOf(z2), Boolean.valueOf(z3), Integer.valueOf(i), progressWaiter);
                Trace.traceBegin(64L, "shell_runStartUser" + parseInt);
                String str = "";
                try {
                    if (z3) {
                        Slogf.m88d("ActivityManager", "calling startProfileWithListener(%d, %s)", Integer.valueOf(parseInt), progressWaiter);
                        startUserInBackgroundVisibleOnDisplay = this.mInterface.startProfileWithListener(parseInt, progressWaiter);
                    } else if (i == -1) {
                        Slogf.m88d("ActivityManager", "calling startUserInBackgroundWithListener(%d)", Integer.valueOf(parseInt));
                        ...
                        Slogf.m88d("ActivityManager", "calling startUserInBackgroundVisibleOnDisplay(%d, %d, %s)", Integer.valueOf(parseInt), Integer.valueOf(i), progressWaiter);
                    ...
                    if (z && startUserInBackgroundVisibleOnDisplay) {
                        Slogf.m88d("ActivityManager", "waiting %d ms", 120000);
    ...
    public final class StopUserCallback extends IStopUserCallback.Stub {
        ...
        public synchronized void waitForFinish() {
            ...
            Slogf.m88d("ActivityManager", "user %d finished stopping", Integer.valueOf(this.mUserId));
        }

        public synchronized void userStopped(int i) {
            Slogf.m88d("ActivityManager", "StopUserCallback: userStopped(%d)", Integer.valueOf(i));
            this.mFinished = true;
            notifyAll();
        }

        public synchronized void userStopAborted(int i) {
            Slogf.m88d("ActivityManager", "StopUserCallback: userStopAborted(%d)", Integer.valueOf(i));
            this.mFinished = true;
            notifyAll();
        }
    ...
    public int runStopUser(PrintWriter printWriter) {
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                Slogf.m88d("ActivityManager", "Calling stopUser(%d, %b, %s)", Integer.valueOf(parseInt), Boolean.valueOf(z2), stopUserCallback);
    ...
    public int runNoHomeScreen(PrintWriter printWriter) {
        ...
        printWriter.println(resources.getBoolean(R.bool.config_lidControlsSleep));
        return 0;
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final int runCompat(PrintWriter printWriter) {
        long lookupChangeId;
        int i;
        boolean z;
        char c;
    ...
    public final int runSetStopUserOnSwitch(PrintWriter printWriter) {
        ...
        String nextArg = getNextArg();
        if (nextArg == null) {
            Slogf.m94i("ActivityManager", "setStopUserOnSwitch(): resetting to default value");
        ...
        Slogf.m96i("ActivityManager", "runSetStopUserOnSwitch(): setting to %d (%b)", Integer.valueOf(parseBoolean ? 1 : 0), Boolean.valueOf(parseBoolean));
