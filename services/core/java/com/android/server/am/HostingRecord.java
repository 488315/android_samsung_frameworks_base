...
public final class HostingRecord {
  ...
  public HostingRecord(
      String str, ComponentName componentName, String str2, String str3, String str4) {
  ...
  public static HostingRecord byWebviewZygote(
      ComponentName componentName, String str, int i, String str2) {
    return new HostingRecord(
        "", componentName.toShortString(), 1, str, i, false, str2, null, "unknown");
  }

  public static HostingRecord byAppZygote(
      ComponentName componentName, String str, int i, String str2) {
    return new HostingRecord(
        "", componentName.toShortString(), 2, str, i, false, str2, null, "unknown");
  }
