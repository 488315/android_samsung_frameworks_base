...
public final class AppBindServiceEventsTracker extends BaseAppStateTimeSlotEventsTracker
  ...
  public AppBindServiceEventsTracker(
  ...
  public BaseAppStateTimeSlotEventsTracker.SimpleAppStateTimeslotEvents createAppStateEvents(
    ...
    return new BaseAppStateTimeSlotEventsTracker.SimpleAppStateTimeslotEvents(
        i,
        str,
        ((AppBindServiceEventsPolicy) this.mInjector.getPolicy()).getTimeSlotSize(),
        "ActivityManager",
  ...
  public final class AppBindServiceEventsPolicy
    ...
    public AppBindServiceEventsPolicy(
        BaseAppStateTracker.Injector injector,
        AppBindServiceEventsTracker appBindServiceEventsTracker) {
      super(
          injector,
          appBindServiceEventsTracker,
          "bg_bind_svc_monitor_enabled",
          true,
          "bg_bind_svc_window",
          BackupManagerConstants.DEFAULT_FULL_BACKUP_INTERVAL_MILLISECONDS,
          "bg_ex_bind_svc_threshold",
          10000);
    }
