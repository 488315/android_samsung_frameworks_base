...
public class DataConnectionStats extends BroadcastReceiver {
  ...
  public void startMonitoring() {
    ((TelephonyManager) this.mContext.getSystemService(TelephonyManager.class))
        .listen(this.mPhoneStateListener, FrameworkStatsLog.DREAM_UI_EVENT_REPORTED);
  ...
  public final void notePhoneDataConnectionState() {
    ...
    int accessNetworkTechnology =
        networkRegistrationInfo != null ? networkRegistrationInfo.getAccessNetworkTechnology() : 0;
    if (this.mNrState == 3) {
