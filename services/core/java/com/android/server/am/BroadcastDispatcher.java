...
public class BroadcastDispatcher {
  ...
  public final AlarmManagerInternal.InFlightListener mAlarmListener =
      new AlarmManagerInternal
          .InFlightListener() { // from class: com.android.server.am.BroadcastDispatcher.1
        ...
        public void broadcastAlarmPending(int i) {
          synchronized (BroadcastDispatcher.this.mLock) {
            int i2 = 0;
            BroadcastDispatcher.this.mAlarmUids.put(
                i, BroadcastDispatcher.this.mAlarmUids.get(i, 0) + 1);
            ...
            while (true) {
              ...
              if (i == ((Deferrals) BroadcastDispatcher.this.mDeferredBroadcasts.get(i2)).uid) {
                BroadcastDispatcher.this.mAlarmDeferrals.add(
                    (Deferrals) BroadcastDispatcher.this.mDeferredBroadcasts.remove(i2));
                break;
              }
              i2++;
            }
            ...
            if (i3 <= 0) {
              ...
              while (true) {
                ...
                if (i == ((Deferrals) BroadcastDispatcher.this.mAlarmDeferrals.get(i2)).uid) {
                  BroadcastDispatcher.insertLocked(
                      BroadcastDispatcher.this.mDeferredBroadcasts,
                      (Deferrals) BroadcastDispatcher.this.mAlarmDeferrals.remove(i2));
                  break;
                }
                i2++;
              }
  ...
  public final Runnable mScheduleRunnable =
      new Runnable() { // from class: com.android.server.am.BroadcastDispatcher.2
  ...
  public class Dumper {
    ...
    public Dumper(
        PrintWriter printWriter, String str, String str2, SimpleDateFormat simpleDateFormat) {
  ...
  public class DeferredBootCompletedBroadcastPerUser {
    ...
    public void updateUidReady(int i) {
      if (!this.mLockedBootCompletedBroadcastReceived
          || this.mDeferredLockedBootCompletedBroadcasts.size() != 0) {
        this.mUidReadyForLockedBootCompletedBroadcast.put(i, true);
      }
      if (this.mBootCompletedBroadcastReceived
          && this.mDeferredBootCompletedBroadcasts.size() == 0) {
        return;
      }
    ...
    public void enqueueBootCompletedBroadcasts(String str, SparseArray sparseArray) {
      if ("android.intent.action.LOCKED_BOOT_COMPLETED".equals(str)) {
        enqueueBootCompletedBroadcasts(
            sparseArray,
            this.mDeferredLockedBootCompletedBroadcasts,
            this.mUidReadyForLockedBootCompletedBroadcast);
        this.mLockedBootCompletedBroadcastReceived = true;
      } else if ("android.intent.action.BOOT_COMPLETED".equals(str)) {
        enqueueBootCompletedBroadcasts(
            sparseArray,
            this.mDeferredBootCompletedBroadcasts,
            this.mUidReadyForBootCompletedBroadcast);
        this.mBootCompletedBroadcastReceived = true;
      }
    }

    public final void enqueueBootCompletedBroadcasts(
        SparseArray sparseArray, SparseArray sparseArray2, SparseBooleanArray sparseBooleanArray) {
    ...
    public BroadcastRecord dequeueDeferredBootCompletedBroadcast(boolean z) {
      BroadcastRecord dequeueDeferredBootCompletedBroadcast =
          dequeueDeferredBootCompletedBroadcast(
              this.mDeferredLockedBootCompletedBroadcasts,
              this.mUidReadyForLockedBootCompletedBroadcast,
              z);
      return dequeueDeferredBootCompletedBroadcast == null
          ? dequeueDeferredBootCompletedBroadcast(
              this.mDeferredBootCompletedBroadcasts, this.mUidReadyForBootCompletedBroadcast, z)
          : dequeueDeferredBootCompletedBroadcast;
    }

    public final BroadcastRecord dequeueDeferredBootCompletedBroadcast(
        SparseArray sparseArray, SparseBooleanArray sparseBooleanArray, boolean z) {
    ...
    public void dumpDebug(ProtoOutputStream protoOutputStream, long j) {
      ...
      for (int i = 0; i < size; i++) {
        ((BroadcastRecord) this.mDeferredLockedBootCompletedBroadcasts.valueAt(i))
            .dumpDebug(protoOutputStream, j);
      }
      int size2 = this.mDeferredBootCompletedBroadcasts.size();
      for (int i2 = 0; i2 < size2; i2++) {
        ((BroadcastRecord) this.mDeferredBootCompletedBroadcasts.valueAt(i2))
            .dumpDebug(protoOutputStream, j);
      }
    }
  }
  ...
  public final DeferredBootCompletedBroadcastPerUser getDeferredPerUser(int i) {
    ...
    DeferredBootCompletedBroadcastPerUser deferredBootCompletedBroadcastPerUser =
        new DeferredBootCompletedBroadcastPerUser(i);
  ...
  public final BroadcastRecord dequeueDeferredBootCompletedBroadcast() {
    ...
    for (int i = 0; i < size; i++) {
      broadcastRecord =
          ((DeferredBootCompletedBroadcastPerUser) this.mUser2Deferred.valueAt(i))
              .dequeueDeferredBootCompletedBroadcast(z);
  ...
  public boolean isEmpty() {
    ...
    synchronized (this.mLock) {
      z =
          isIdle()
              && getBootCompletedBroadcastsUidsSize("android.intent.action.LOCKED_BOOT_COMPLETED")
                  == 0
              && getBootCompletedBroadcastsUidsSize("android.intent.action.BOOT_COMPLETED") == 0;
    }
    return z;
  }
    ...
    synchronized (this.mLock) {
      z =
          this.mCurrentBroadcast == null
              && this.mOrderedBroadcasts.isEmpty()
              && this.mAlarmQueue.isEmpty()
              && isDeferralsListEmpty(this.mDeferredBroadcasts)
              && isDeferralsListEmpty(this.mAlarmDeferrals);
    }
    return z;
  }
  ...
  public boolean isBeyondBarrier(long j) {
    synchronized (this.mLock) {
      ...
      if (isBeyondBarrier(this.mOrderedBroadcasts, j)
          && isBeyondBarrier(this.mAlarmQueue, j)
          && isDeferralsBeyondBarrier(this.mDeferredBroadcasts, j)
          && isDeferralsBeyondBarrier(this.mAlarmDeferrals, j)) {
        z = true;
      }
      return z;
    }
  ...
  public boolean isDispatched(Intent intent) {
    synchronized (this.mLock) {
      ...
      if (isDispatched(this.mOrderedBroadcasts, intent)
          && isDispatched(this.mAlarmQueue, intent)
          && isDispatchedInDeferrals(this.mDeferredBroadcasts, intent)
          && isDispatchedInDeferrals(this.mAlarmDeferrals, intent)) {
        z = true;
      }
      return z;
    }
  ...
  public String describeStateLocked() {
    ...
    int bootCompletedBroadcastsUidsSize =
        getBootCompletedBroadcastsUidsSize("android.intent.action.LOCKED_BOOT_COMPLETED");
    if (bootCompletedBroadcastsUidsSize > 0) {
      ...
      sb.append(
          getBootCompletedBroadcastsReceiversSize("android.intent.action.LOCKED_BOOT_COMPLETED"));
      sb.append(" receivers");
    }
    int bootCompletedBroadcastsUidsSize2 =
        getBootCompletedBroadcastsUidsSize("android.intent.action.BOOT_COMPLETED");
  ...
  public void enqueueOrderedBroadcastLocked(BroadcastRecord broadcastRecord) {
    ...
    if ("android.intent.action.LOCKED_BOOT_COMPLETED".equals(broadcastRecord.intent.getAction())) {
      ...
      getDeferredPerUser(broadcastRecord.userId)
          .enqueueBootCompletedBroadcasts(
              "android.intent.action.LOCKED_BOOT_COMPLETED",
              broadcastRecord.splitDeferredBootCompletedBroadcastLocked(
                  activityManagerService.mInternal,
                  activityManagerService.mConstants.mDeferBootCompletedBroadcast));
    ...
    if ("android.intent.action.BOOT_COMPLETED".equals(broadcastRecord.intent.getAction())) {
      ...
      getDeferredPerUser(broadcastRecord.userId)
          .enqueueBootCompletedBroadcasts(
              ...
              broadcastRecord.splitDeferredBootCompletedBroadcastLocked(
                  activityManagerService2.mInternal,
                  activityManagerService2.mConstants.mDeferBootCompletedBroadcast));
      if (broadcastRecord.receivers.isEmpty()) {
        return;
      }
      this.mOrderedBroadcasts.add(broadcastRecord);
  ...
  public final int getBootCompletedBroadcastsUidsSize(String str) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      i +=
          ((DeferredBootCompletedBroadcastPerUser) this.mUser2Deferred.valueAt(i2))
              .getBootCompletedBroadcastsUidsSize(str);
    }
    return i;
  }
  ...
  public final int getBootCompletedBroadcastsReceiversSize(String str) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      i +=
          ((DeferredBootCompletedBroadcastPerUser) this.mUser2Deferred.valueAt(i2))
              .getBootCompletedBroadcastsReceiversSize(str);
    }
    return i;
  }

  public BroadcastRecord replaceBroadcastLocked(BroadcastRecord broadcastRecord, String str) {
    BroadcastRecord replaceBroadcastLocked =
        replaceBroadcastLocked(this.mOrderedBroadcasts, broadcastRecord, str);
    ...
    if (replaceBroadcastLocked == null) {
      replaceBroadcastLocked =
          replaceDeferredBroadcastLocked(this.mAlarmDeferrals, broadcastRecord, str);
    }
    return replaceBroadcastLocked == null
        ? replaceDeferredBroadcastLocked(this.mDeferredBroadcasts, broadcastRecord, str)
        : replaceBroadcastLocked;
  }

  public final BroadcastRecord replaceDeferredBroadcastLocked(
      ArrayList arrayList, BroadcastRecord broadcastRecord, String str) {
    int size = arrayList.size();
    for (int i = 0; i < size; i++) {
      BroadcastRecord replaceBroadcastLocked =
          replaceBroadcastLocked(((Deferrals) arrayList.get(i)).broadcasts, broadcastRecord, str);
      if (replaceBroadcastLocked != null) {
  ...
  public final BroadcastRecord replaceBroadcastLocked(
      ArrayList arrayList, BroadcastRecord broadcastRecord, String str) {
    Intent intent = broadcastRecord.intent;
    for (int size = arrayList.size() - 1; size >= 0; size--) {
      BroadcastRecord broadcastRecord2 = (BroadcastRecord) arrayList.get(size);
      if (broadcastRecord2.userId == broadcastRecord.userId
          && intent.filterEquals(broadcastRecord2.intent)) {
  ...
  public boolean cleanupDisabledPackageReceiversLocked(String str, Set set, int i, boolean z) {
    ...
    boolean cleanupBroadcastListDisabledReceiversLocked =
        cleanupBroadcastListDisabledReceiversLocked(this.mOrderedBroadcasts, str, set, i, z);
    if (z || !cleanupBroadcastListDisabledReceiversLocked) {
      cleanupBroadcastListDisabledReceiversLocked =
          cleanupBroadcastListDisabledReceiversLocked(this.mAlarmQueue, str, set, i, z);
    }
    if (z || !cleanupBroadcastListDisabledReceiversLocked) {
      ...
      cleanupBroadcastListDisabledReceiversLocked =
          cleanupBroadcastListDisabledReceiversLocked(arrayList, str, set, i, z);
    }
    if (z || !cleanupBroadcastListDisabledReceiversLocked) {
      ...
      for (int i4 = 0; i4 < size3; i4++) {
        SparseArray sparseArray2 =
            ((DeferredBootCompletedBroadcastPerUser) this.mUser2Deferred.valueAt(i4))
                .mDeferredBootCompletedBroadcasts;
      ...
      cleanupBroadcastListDisabledReceiversLocked =
          cleanupBroadcastListDisabledReceiversLocked(arrayList2, str, set, i, z);
    }
    if (z || !cleanupBroadcastListDisabledReceiversLocked) {
      cleanupBroadcastListDisabledReceiversLocked |=
          cleanupDeferralsListDisabledReceiversLocked(this.mAlarmDeferrals, str, set, i, z);
    }
    if (z || !cleanupBroadcastListDisabledReceiversLocked) {
      cleanupBroadcastListDisabledReceiversLocked |=
          cleanupDeferralsListDisabledReceiversLocked(this.mDeferredBroadcasts, str, set, i, z);
    }
    return ((z || !cleanupBroadcastListDisabledReceiversLocked)
            && (broadcastRecord = this.mCurrentBroadcast) != null)
        ? cleanupBroadcastListDisabledReceiversLocked
            | broadcastRecord.cleanupDisabledPackageReceiversLocked(str, set, i, z)
        : cleanupBroadcastListDisabledReceiversLocked;
  }

  public final boolean cleanupDeferralsListDisabledReceiversLocked(
      ArrayList arrayList, String str, Set set, int i, boolean z) {
    Iterator it = arrayList.iterator();
    boolean z2 = false;
    while (it.hasNext()) {
      z2 =
          cleanupBroadcastListDisabledReceiversLocked(
              ((Deferrals) it.next()).broadcasts, str, set, i, z);
      if (!z && z2) {
        return true;
      }
    }
  ...
  public final boolean cleanupBroadcastListDisabledReceiversLocked(
      ArrayList arrayList, String str, Set set, int i, boolean z) {
    Iterator it = arrayList.iterator();
    boolean z2 = false;
    while (it.hasNext()) {
  ...
  public BroadcastRecord getNextBroadcastLocked(long j) {
    ...
    BroadcastRecord broadcastRecord2 =
        !this.mAlarmQueue.isEmpty() ? (BroadcastRecord) this.mAlarmQueue.remove(0) : null;
  ...
  public void retireBroadcastLocked(BroadcastRecord broadcastRecord) {
    if (broadcastRecord != this.mCurrentBroadcast) {
      Slog.wtf(
          ...
          "Retiring broadcast "
              + broadcastRecord
              + " doesn't match current outgoing "
              + this.mCurrentBroadcast);
    }
    this.mCurrentBroadcast = null;
  }
  ...
  public boolean isDeferringLocked(int i) {
    ...
    if (findUidLocked == null
        || !findUidLocked.broadcasts.isEmpty()
        || SystemClock.uptimeMillis() < findUidLocked.deferUntil) {
  ...
  public void startDeferring(int i) {
    synchronized (this.mLock) {
      ...
      if (findUidLocked == null) {
        Deferrals deferrals =
            new Deferrals(
                i, SystemClock.uptimeMillis(), this.mConstants.DEFERRAL, this.mAlarmUids.get(i, 0));
  ...
  public final long calculateDeferral(long j) {
    ...
    return Math.max(
        broadcastConstants.DEFERRAL_FLOOR, (long) (j * broadcastConstants.DEFERRAL_DECAY_FACTOR));
  }
  ...
  public boolean dumpLocked(
    ...
    for (int i = 0; i < size; i++) {
      ((DeferredBootCompletedBroadcastPerUser) this.mUser2Deferred.valueAt(i))
          .dump(dumper, "android.intent.action.LOCKED_BOOT_COMPLETED");
    }
    ...
    for (int i2 = 0; i2 < size2; i2++) {
      ((DeferredBootCompletedBroadcastPerUser) this.mUser2Deferred.valueAt(i2))
          .dump(dumper, "android.intent.action.BOOT_COMPLETED");
    }
