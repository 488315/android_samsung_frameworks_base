    ...
    public final void dispatchUidsChangedForObserver(IUidObserver iUidObserver, UidObserverRegistration uidObserverRegistration, int i) {
        ...
        while (i3 < i) {
            try {
                ...
                if (uidObserverRegistration.isWatchingUid(changeRecord.uid) && ((UserHandle.getUserId(changeRecord.uid) == UserHandle.getUserId(uidObserverRegistration.mUid) || uidObserverRegistration.mCanInteractAcrossUsers) && ((i4 != Integer.MIN_VALUE || (uidObserverRegistration.mWhich & 1) != 0) && (i4 != 64 || (uidObserverRegistration.mWhich & 64) != 0)))) {
                    if ((i4 & 2) != 0) {
