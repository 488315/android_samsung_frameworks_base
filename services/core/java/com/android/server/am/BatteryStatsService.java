...
public final class BatteryStatsService extends IBatteryStats.Stub implements PowerManagerInternal.LowPowerModeListener, BatteryStatsImpl.PlatformIdleStateCallback, BatteryStatsImpl.EnergyStatsRetriever, Watchdog.Monitor {
            ...
            if (this.mPowerStatsInternal != null && !this.mEntityNames.isEmpty() && !this.mStateNames.isEmpty()) {
                try {
                    ...
                    for (StateResidencyResult stateResidencyResult : stateResidencyResultArr) {
                        RpmStats.PowerStateSubsystem subsystem = rpmStats.getSubsystem((String) this.mEntityNames.get(Integer.valueOf(stateResidencyResult.f11id)));
                        int i = 0;
                        while (true) {
                            ...
                            if (i < stateResidencyArr.length) {
                                ...
                                subsystem.putState((String) ((Map) this.mStateNames.get(Integer.valueOf(stateResidencyResult.f11id))).get(Integer.valueOf(stateResidency.f10id)), stateResidency.totalTimeInStateMs, (int) stateResidency.totalStateEntryCount);
                                i++;
                            }
                        }
                    }
            ...
            if (this.mPowerStatsInternal != null && !this.mEntityNames.isEmpty() && !this.mStateNames.isEmpty()) {
                try {
                    ...
                    while (true) {
                        ...
                        sb2.append(" name=" + ((String) this.mEntityNames.get(Integer.valueOf(stateResidencyResult.f11id))));
                        int i3 = 0;
                        while (true) {
                            StateResidency[] stateResidencyArr = stateResidencyResult.stateResidencyData;
                            ...
                            sb2.append(" name=" + ((String) ((Map) this.mStateNames.get(Integer.valueOf(stateResidencyResult.f11id))).get(Integer.valueOf(stateResidency.f10id))));
    ...
    public BatteryStatsService(Context context, File file, Handler handler) {
        ...
        batteryStatsImpl.setRadioScanningTimeoutLocked(context.getResources().getInteger(R.integer.config_satellite_demo_mode_nb_iot_inactivity_timeout_millis) * 1000);
        batteryStatsImpl.setPowerProfileLocked(powerProfile);
        batteryStatsImpl.setBatteryStatsConfig(new BatteryStatsImpl.BatteryStatsConfig.Builder().setResetOnUnplugHighBatteryLevel(context.getResources().getBoolean(R.bool.config_batterySaverStickyBehaviourDisabled)).setResetOnUnplugAfterSignificantCharge(context.getResources().getBoolean(R.bool.config_awareSettingAvailable)).build());
