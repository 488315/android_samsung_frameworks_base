...
public final class PendingIntentRecord extends IIntentSender.Stub {
  ...
  public final class Key {
    ...
    public Key(
      ...
      this.hashCode =
          ((((str4 != null ? (i5 * 37) + str4.hashCode() : i5) * 37)
    ...
    public boolean equals(Object obj) {
      ...
      try {
        ...
        if (this.type != key.type
            ...
            || !Objects.equals(this.featureId, key.featureId)
            || this.activity != key.activity
            || !Objects.equals(this.who, key.who)
            || this.requestCode != key.requestCode) {
          return false;
        }
    ...
    public String typeName() {
      ...
      return i != 1
          ? i != 2
              ? i != 3
                  ? i != 4
                      ? i != 5 ? Integer.toString(i) : "startForegroundService"
                      : "startService"
                  : "activityResult"
              : "startActivity"
          : "broadcastIntent";
  ...
  public static BackgroundStartPrivileges getBackgroundStartPrivilegesAllowedByCaller(
      ActivityOptions activityOptions, int i, String str) {
    if (activityOptions == null) {
  ...
  public static BackgroundStartPrivileges getBackgroundStartPrivilegesAllowedByCaller(
      Bundle bundle, int i, String str) {
  ...
  public static BackgroundStartPrivileges getDefaultBackgroundStartPrivileges(int i, String str) {
    ...
    if (str != null) {
      isChangeEnabled =
          CompatChanges.isChangeEnabled(244637991L, str, UserHandle.getUserHandleForUid(i));
    } else {
  ...
  */
    ...
    synchronized (pendingIntentRecord2.controller.mLock) {
      if (pendingIntentRecord2.canceled) {
        Slog.d(
            "ActivityManager",
            "Received intent "
                + pendingIntentRecord2.key.type
                + ","
                + Integer.toHexString(System.identityHashCode(this))
                + " "
                + pendingIntentRecord2.key.toSecureString(true)
                + " is canceled from UID:"
                + pendingIntentRecord2.canceledFromUID
                + " PID:"
                + pendingIntentRecord2.canceledFromPID);
        return -96;
      }
      ...
      Intent intent3 =
          pendingIntentRecord2.key.requestIntent != null
              ? new Intent(pendingIntentRecord2.key.requestIntent)
              : new Intent();
      ...
      if ((67108864 & i13) != 0) {
        ...
        if (intent != null) {
          str4 =
              (intent3.fillIn(intent, i13) & 2) == 0
                  ? pendingIntentRecord2.key.requestResolvedType
                  : str;
          if (intent.getLaunchTaskIdForAliasManagedTarget() > 0) {
            intent3.setLaunchTaskIdForAliasManagedTarget(
                intent.getLaunchTaskIdForAliasManagedTarget());
          ...
          if (intent.getLaunchTaskIdForSingleInstancePerTask() > 0) {
            intent3.setLaunchTaskIdForSingleInstancePerTask(
                intent.getLaunchTaskIdForSingleInstancePerTask());
            z = true;
          }
          if (z && bundle != null) {
      ...
      TempAllowListDuration tempAllowListDuration =
          arrayMap != null ? (TempAllowListDuration) arrayMap.get(iBinder) : null;
      ...
      try {
        if (tempAllowListDuration != null) {
          ...
          intent2 = intent3;
          pendingIntentRecord2.controller.mAmInternal.tempAllowlistForPendingIntent(
              i8,
              i7,
              pendingIntentRecord2.uid,
              tempAllowListDuration.duration,
              tempAllowListDuration.type,
              tempAllowListDuration.reasonCode,
              sb.toString());
        } else {
          intent2 = intent3;
          if (pendingIntentRecord2.key.type == 5 && bundle != null) {
            ...
            if (broadcastOptions.getTemporaryAppAllowlistDuration() > 0) {
              pendingIntentRecord2.controller.mAmInternal.tempAllowlistForPendingIntent(
                  ...
                  i7,
                  pendingIntentRecord2.uid,
                  broadcastOptions.getTemporaryAppAllowlistDuration(),
                  broadcastOptions.getTemporaryAppAllowlistType(),
                  broadcastOptions.getTemporaryAppAllowlistReasonCode(),
                  broadcastOptions.getTemporaryAppAllowlistReason());
            }
          }
        }
        ...
        if (iIntentReceiver != null && iApplicationThread == null) {
          Slog.w(
              ...
              "Sending of "
                  ...
                  + " requested resultTo without an IApplicationThread!",
              new Throwable());
        }
        ...
        if (i18 != 1) {
          if (i18 != 2) {
            if (i18 == 3) {
              Slog.d(
                  "ActivityManager",
                  "Received ACTIVITY RESULT intent 0x"
                      + Integer.toHexString(System.identityHashCode(this))
                      + " "
                      + pendingIntentRecord2.key.toSecureString(true)
                      + " from uid "
              ...
              ActivityTaskManagerInternal activityTaskManagerInternal =
                  pendingIntentRecord2.controller.mAtmInternal;
              Key key4 = pendingIntentRecord2.key;
              activityTaskManagerInternal.sendActivityResult(
                  -1, key4.activity, key4.who, key4.requestCode, i, intent2);
            } else if (i18 == 4 || i18 == 5) {
              try {
                BackgroundStartPrivileges backgroundStartPrivilegesForActivitySender =
                    pendingIntentRecord2.getBackgroundStartPrivilegesForActivitySender(
                        pendingIntentRecord2.mAllowBgActivityStartsForServiceSender,
                        iBinder,
                        bundle,
                        i7);
                ActivityManagerInternal activityManagerInternal =
                    pendingIntentRecord2.controller.mAmInternal;
                int i19 = pendingIntentRecord2.uid;
                Key key5 = pendingIntentRecord2.key;
                activityManagerInternal.startServiceInPackage(
                    iApplicationThread,
                    i19,
                    intent2,
                    str5,
                    ...
                    key5.featureId,
                    i17,
                    backgroundStartPrivilegesForActivitySender);
                Slog.d(
                    "ActivityManager",
                    "Received SERVICE intent 0x"
                        + Integer.toHexString(System.identityHashCode(this))
                        + " "
                        + pendingIntentRecord2.key.toSecureString(true)
                        + " from uid "
              ...
              try {
                if (intentArr4 != null && intentArr4.length > 1) {
                  ...
                  startActivityInPackage =
                      pendingIntentRecord2.controller.mAtmInternal.startActivitiesInPackage(
                          pendingIntentRecord2.uid,
                          i8,
                          i7,
                          key3.packageName,
                  ...
                  BackgroundStartPrivileges backgroundStartPrivilegesForActivitySender2 =
                      pendingIntentRecord2.getBackgroundStartPrivilegesForActivitySender(iBinder);
                  SafeActivityOptions safeActivityOptions3 = safeActivityOptions;
                  i12 = i20;
                  pendingIntentRecord2 = null;
                  try {
                    startActivityInPackage =
                        activityTaskManagerInternal2.startActivityInPackage(
                            i21,
                            i8,
                            i20,
                            str7,
                            ...
                            false,
                            this,
                            backgroundStartPrivilegesForActivitySender2);
          ...
          if (z4 && i10 != -96) {
            try {
              iIntentReceiver.performReceive(
                  ...
                  false,
                  false,
                  pendingIntentRecord.key.userId);
        ...
        i9 = 0;
        try {
          BackgroundStartPrivileges backgroundStartPrivilegesForActivitySender3 =
              pendingIntentRecord2.getBackgroundStartPrivilegesForActivitySender(
                  pendingIntentRecord2.mAllowBgActivityStartsForBroadcastSender,
                  iBinder,
                  bundle,
                  i22);
          ...
          try {
            int broadcastIntentInPackage =
                activityManagerInternal2.broadcastIntentInPackage(
                    iApplicationThread,
                    key6.packageName,
                    key6.featureId,
                    pendingIntentRecord2.uid,
                    ...
                    false,
                    i17,
                    backgroundStartPrivilegesForActivitySender3,
                    (int[]) null);
  ...
  public final BackgroundStartPrivileges getBackgroundStartPrivilegesForActivitySender(
      IBinder iBinder) {
  ...
  public final BackgroundStartPrivileges getBackgroundStartPrivilegesForActivitySender(
      ArraySet arraySet, IBinder iBinder, Bundle bundle, int i) {
  ...
  public void finalize() {
    try {
      if (!this.canceled) {
        this.controller.f1632mH.sendMessage(
            PooledLambda.obtainMessage(
                new Consumer() { // from class:
                                 // com.android.server.am.PendingIntentRecord$$ExternalSyntheticLambda0
  ...
  public void dump(PrintWriter printWriter, String str) {
    ...
    if (this.mAllowlistDuration != null) {
      ...
      for (int i = 0; i < this.mAllowlistDuration.size(); i++) {
        ...
        TempAllowListDuration tempAllowListDuration =
            (TempAllowListDuration) this.mAllowlistDuration.valueAt(i);
        printWriter.print(
            Integer.toHexString(System.identityHashCode(this.mAllowlistDuration.keyAt(i))));
        ...
        printWriter.print("/");
        printWriter.print(
            PowerWhitelistManager.reasonCodeToString(tempAllowListDuration.reasonCode));
        printWriter.print("/");
