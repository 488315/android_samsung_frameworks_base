...
public final /* synthetic */ class BatteryStatsService$$ExternalSyntheticLambda84
        implements Runnable {
    ...
    public /* synthetic */ BatteryStatsService$$ExternalSyntheticLambda84(
                ...
                synchronized (batteryStatsService.mStats) {
                    ...
                    while (i2 < size) {
                        ...
                        BatteryStatsImpl.Uid uidStatsLocked =
                                batteryStatsImpl.getUidStatsLocked(
                                        batteryStatsImpl.mapUid(workSource.getUid(i2)), j, j2);
                        if (uidStatsLocked.mBluetoothScanResultCounter == null) {
                            uidStatsLocked.mBluetoothScanResultCounter =
                                    new BatteryStatsImpl.Counter(
                                            uidStatsLocked.mBsi.mOnBatteryTimeBase);
                        }
                        uidStatsLocked.mBluetoothScanResultCounter.addAtomic(i);
                        if (uidStatsLocked.mBluetoothScanResultBgCounter == null) {
                            uidStatsLocked.mBluetoothScanResultBgCounter =
                                    new BatteryStatsImpl.Counter(
                                            uidStatsLocked.mOnBatteryBackgroundTimeBase);
                        }
                    ...
                    if (workChains != null) {
                        for (int i4 = 0; i4 < workChains.size(); i4++) {
                            BatteryStatsImpl.Uid uidStatsLocked2 =
                                    batteryStatsImpl.getUidStatsLocked(
                            ...
                            if (uidStatsLocked2.mBluetoothScanResultCounter == null) {
                                uidStatsLocked2.mBluetoothScanResultCounter =
                                        new BatteryStatsImpl.Counter(
                                                uidStatsLocked2.mBsi.mOnBatteryTimeBase);
                            }
                            uidStatsLocked2.mBluetoothScanResultCounter.addAtomic(i);
                            if (uidStatsLocked2.mBluetoothScanResultBgCounter == null) {
                                uidStatsLocked2.mBluetoothScanResultBgCounter =
                                        new BatteryStatsImpl.Counter(
                                                uidStatsLocked2.mOnBatteryBackgroundTimeBase);
                            }
            ...
            default:
                ...
                synchronized (batteryStatsService2.mStats) {
                    ...
                    for (int i6 = 0; i6 < size2; i6++) {
                        batteryStatsImpl2
                                .getUidStatsLocked(
                                        batteryStatsImpl2.mapUid(workSource2.getUid(i6)), j3, j4)
                                .noteWifiBatchedScanStartedLocked(i5, j3);
                    }
                            ...
                            batteryStatsImpl2
                                    .getUidStatsLocked(
                                            batteryStatsImpl2.mapUid(
                                                    ((WorkSource.WorkChain) workChains2.get(i7))
                                                            .getAttributionUid()),
                                            j3,
                                            j4)
                                    .noteWifiBatchedScanStartedLocked(i5, j3);
