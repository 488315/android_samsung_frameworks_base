...
public class ProcessErrorStateRecord {
  ...
  */
  public void appNotResponding(
    ...
    captureAtraceLog();
    this.mApp
        .getWindowProcessController()
        .appEarlyNotResponding(
            str4,
            new Runnable() { // from class:
                             // com.android.server.am.ProcessErrorStateRecord$$ExternalSyntheticLambda0
    ...
    Future<?> submit =
        isMonitorCpuUsage()
            ? executorService.submit(
                new Runnable() { // from class:
                                 // com.android.server.am.ProcessErrorStateRecord$$ExternalSyntheticLambda1
                  @Override // java.lang.Runnable
                  public final void run() {
    ...
    synchronized (activityManagerService) {
      try {
        ...
        EventLog.writeEvent(
            30008,
            Integer.valueOf(this.mApp.userId),
            Integer.valueOf(pid),
            processRecord.processName,
            Integer.valueOf(processRecord.info.flags),
            str4);
        ...
        if (traceErrorLogger == null || !traceErrorLogger.isAddErrorIdEnabled()) {
          ...
          this.mService.mTraceErrorLogger.addProcessInfoAndErrorIdToTrace(
              this.mApp.processName, pid, generateErrorId);
          this.mService.mTraceErrorLogger.addSubjectToTrace(str4, generateErrorId);
          uuid = generateErrorId;
        }
        FrameworkStatsLog.write(
            FrameworkStatsLog.ANR_OCCURRED_PROCESSING_STARTED, this.mApp.processName);
        arrayList.add(Integer.valueOf(pid));
        final boolean isSilentAnr = isSilentAnr();
        if (!isSilentAnr && !z2) {
          final int pid2 =
              (windowProcessController == null || windowProcessController.getPid() <= 0)
                  ? pid
                  : windowProcessController.getPid();
          if (pid2 != pid) {
          ...
          this.mService.mProcessList.forEachLruProcessesLOSP(
              ...
              new Consumer() { // from class:
                               // com.android.server.am.ProcessErrorStateRecord$$ExternalSyntheticLambda2
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  ProcessErrorStateRecord.lambda$appNotResponding$2(
                      pid, pid2, arrayList, sparseBooleanArray, (ProcessRecord) obj);
                }
              });
        }
        ...
        String logLinesForTraceFile =
            criticalEventLog.logLinesForTraceFile(
                processClassEnum, processRecord2.processName, processRecord2.uid);
        ...
        criticalEventLog2.logAnr(
            str4,
            processClassEnum2,
            processRecord3.processName,
            processRecord3.uid,
            processRecord3.mPid);
        ...
        AnrController anrController =
            this.mService.mActivityTaskManager.getAnrController(applicationInfo);
        ...
        Future submit2 =
            executorService.submit(
                new Callable() { // from class:
                                 // com.android.server.am.ProcessErrorStateRecord$$ExternalSyntheticLambda3
                  @Override // java.util.concurrent.Callable
                  public final Object call() {
                    ArrayList lambda$appNotResponding$3;
                    lambda$appNotResponding$3 =
                        ProcessErrorStateRecord.this.lambda$appNotResponding$3(
                            anrLatencyTracker, isSilentAnr, z2);
        ...
        File dumpStackTraces =
            StackTracesDumpHelper.dumpStackTraces(
                ...
                atomicLong,
                str4,
                logLinesForTraceFile,
                buildMemoryHeadersFor,
                executorService,
                future,
                anrLatencyTracker);
        ...
        if (this.mApp.info != null
          ...
          if (codePath != null
            ...
            Slog.e(
                "ActivityManager",
                "App ANR on incremental package "
                    + this.mApp.info.packageName
                    + " which is "
                    + ((int) (r7 * 100.0f))
                    + "% loaded.");
            ...
            if (service != null) {
              incrementalMetrics =
                  new IncrementalManager(IIncrementalService.Stub.asInterface(service))
                      .getMetrics(codePath);
              ...
              FrameworkStatsLog.write(
                  79,
                  processRecord5.uid,
                  processRecord5.processName,
                  str != null ? "unknown" : str,
                  str4,
                  processRecord5.info == null ? this.mApp.info.isInstantApp() ? 2 : 1 : 0,
                  !this.mApp.isInterestingToUserLocked() ? 2 : 1,
                  this.mApp.getProcessClassEnum(),
                  this.mApp.info == null ? this.mApp.info.packageName : "",
                  incrementalMetrics == null,
                  r7,
                  incrementalMetrics == null
                      ? incrementalMetrics.getMillisSinceOldestPendingRead()
                      : -1L,
                  incrementalMetrics == null ? incrementalMetrics.getStorageHealthStatusCode() : -1,
                  incrementalMetrics == null ? incrementalMetrics.getDataLoaderStatusCode() : -1,
                  incrementalMetrics == null && incrementalMetrics.getReadLogsEnabled(),
                  incrementalMetrics == null
                      ? incrementalMetrics.getMillisSinceLastDataLoaderBind()
                      : -1L,
                  incrementalMetrics == null
                      ? incrementalMetrics.getDataLoaderBindDelayMillis()
                      : -1L,
                  incrementalMetrics == null ? incrementalMetrics.getTotalDelayedReads() : -1,
                  incrementalMetrics == null ? incrementalMetrics.getTotalFailedReads() : -1,
                  incrementalMetrics != null ? incrementalMetrics.getLastReadErrorUid() : -1,
                  incrementalMetrics == null
                      ? incrementalMetrics.getMillisSinceLastReadError()
                      : -1L,
                  incrementalMetrics == null ? incrementalMetrics.getLastReadErrorNumber() : 0,
                  incrementalMetrics != null
                      ? incrementalMetrics.getTotalDelayedReadsDurationMillis()
                      : -1L);
              ProcessRecord processRecord6 =
                  windowProcessController == null
                      ? (ProcessRecord) windowProcessController.mOwner
                      : null;
              BinderTransaction.BinderProcsInfo binderTransactionInfo =
                  !ActivityManagerService.DEBUG_LEVEL_LOW
                      ? null
                      : StackTracesDumpHelper.getBinderTransactionInfo(pid);
              ActivityManagerService activityManagerService2 = this.mService;
              ProcessRecord processRecord7 = this.mApp;
              activityManagerService2.addErrorToDropBox(
                  "anr",
                  processRecord7,
                  processRecord7.processName,
                  str,
                  str2,
                  processRecord6,
                  null,
              ...
              if (this.mApp
                  ...
                  .appNotResponding(
                      ...
                      new Runnable() { // from class:
                                       // com.android.server.am.ProcessErrorStateRecord$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                ...
                synchronized (activityManagerService3) {
                  try {
                    ...
                    if (batteryStatsService != null) {
                      ...
                      batteryStatsService.noteProcessAnr(
                          processRecord8.processName, processRecord8.uid);
                    }
                    ...
                    if (this.mService.mUiHandler != null) {
                      ...
                      obtain.what = 2;
                      obtain.obj =
                          new AppNotRespondingDialog.Data(this.mApp, applicationInfo, z, z3);
        ...
        FrameworkStatsLog.write(
            79,
            processRecord52.uid,
            processRecord52.processName,
            str != null ? "unknown" : str,
            str4,
            processRecord52.info == null ? this.mApp.info.isInstantApp() ? 2 : 1 : 0,
            !this.mApp.isInterestingToUserLocked() ? 2 : 1,
            this.mApp.getProcessClassEnum(),
            this.mApp.info == null ? this.mApp.info.packageName : "",
            incrementalMetrics == null,
            r7,
            incrementalMetrics == null ? incrementalMetrics.getMillisSinceOldestPendingRead() : -1L,
            incrementalMetrics == null ? incrementalMetrics.getStorageHealthStatusCode() : -1,
            incrementalMetrics == null ? incrementalMetrics.getDataLoaderStatusCode() : -1,
            incrementalMetrics == null && incrementalMetrics.getReadLogsEnabled(),
            incrementalMetrics == null
                ? incrementalMetrics.getMillisSinceLastDataLoaderBind()
                : -1L,
            incrementalMetrics == null ? incrementalMetrics.getDataLoaderBindDelayMillis() : -1L,
            incrementalMetrics == null ? incrementalMetrics.getTotalDelayedReads() : -1,
            incrementalMetrics == null ? incrementalMetrics.getTotalFailedReads() : -1,
            incrementalMetrics != null ? incrementalMetrics.getLastReadErrorUid() : -1,
            incrementalMetrics == null ? incrementalMetrics.getMillisSinceLastReadError() : -1L,
            incrementalMetrics == null ? incrementalMetrics.getLastReadErrorNumber() : 0,
            incrementalMetrics != null
                ? incrementalMetrics.getTotalDelayedReadsDurationMillis()
                : -1L);
        ...
        activityManagerService22.addErrorToDropBox(
            "anr",
            processRecord72,
            processRecord72.processName,
            str,
            str2,
            processRecord6,
            null,
  ...
  public /* synthetic */ void lambda$appNotResponding$0(
      AnrLatencyTracker anrLatencyTracker, String str) {
    anrLatencyTracker.waitingOnAMSLockStarted();
    ActivityManagerService activityManagerService = this.mService;
    ActivityManagerService.boostPriorityForLockedSection();
    synchronized (activityManagerService) {
  ...
  public static /* synthetic */ void lambda$appNotResponding$2(
      int i,
      int i2,
      ArrayList arrayList,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ ArrayList lambda$appNotResponding$3(
      AnrLatencyTracker anrLatencyTracker, boolean z, boolean z2) {
    String[] strArr;
  ...
  public final void makeAppNotRespondingLSP(String str, String str2, String str3) {
    ...
    if (appErrors != null) {
      this.mNotRespondingReport =
          appErrors.generateProcessError(this.mApp, 2, str, str2, str3, null);
    }
    startAppProblemLSP();
      ...
      if (processRecord.userId == i) {
        this.mErrorReportReceiver =
            ApplicationErrorReport.getErrorReportReceiver(
                this.mService.mContext, processRecord.info.packageName, this.mApp.info.flags);
      }
    }
  ...
  public final boolean isInterestingForBackgroundTraces() {
    if (this.mApp.getPid() == ActivityManagerService.MY_PID
        || this.mApp.isInterestingToUserLocked()) {
      return true;
    }
    return (this.mApp.info != null && "com.android.systemui".equals(this.mApp.info.packageName))
        || this.mApp.mState.hasTopUi()
        || this.mApp.mState.hasOverlayUi();
  }
  ...
  public final String buildMemoryHeadersFor(int i) {
    ...
    ProcfsMemoryUtil.MemorySnapshot readMemorySnapshotFromProcfs =
        ProcfsMemoryUtil.readMemorySnapshotFromProcfs(i);
    if (readMemorySnapshotFromProcfs == null) {
      Slog.i("ActivityManager", "Failed to get memory snapshot for pid:" + i);
      return null;
    }
    return "RssHwmKb: "
        + readMemorySnapshotFromProcfs.rssHighWaterMarkInKilobytes
        + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE
        + "RssKb: "
        + readMemorySnapshotFromProcfs.rssInKilobytes
        + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE
        + "RssAnonKb: "
        + readMemorySnapshotFromProcfs.anonRssInKilobytes
        + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE
        + "RssShmemKb: "
        + readMemorySnapshotFromProcfs.rssShmemKilobytes
        + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE
        + "VmSwapKb: "
        + readMemorySnapshotFromProcfs.swapInKilobytes
        + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE;
  }
  ...
  public void dump(PrintWriter printWriter, String str, long j) {
    ...
    synchronized (activityManagerGlobalLock) {
      try {
        if (this.mCrashing
            || this.mDialogController.hasCrashDialogs()
            || this.mNotResponding
            || this.mDialogController.hasAnrDialogs()
            || this.mBad) {
