...
public final class ProcessList {
    ...
    public final class IsolatedUidRangeAllocator {
        ...
        public IsolatedUidRange getOrCreateIsolatedUidRangeLocked(String str, int i) {
            ...
            IsolatedUidRange isolatedUidRange = ProcessList.this.new IsolatedUidRange(this.mFirstUid + (nextSetBit * this.mNumUidsPerRange), (r2 + r1) - 1);
    ...
    */
    public /* synthetic */ void lambda$handleProcessStart$1(ProcessRecord processRecord, String str, int[] iArr, int i, int i2, int i3, String str2, String str3, String str4, long j) {
        ...
        try {
            processList = this;
            try {
                startProcess = processList.startProcess(processRecord.getHostingRecord(), str, processRecord, processRecord.getStartUid(), iArr, i, i2, i3, processRecord.getSeInfo(), str2, str3, str4, processRecord.getStartTime());
    ...
    */
        ...
        try {
            ...
            if (FreecessController.getInstance().getFreecessEnabled()) {
                ...
                if (MARsPolicyManager.getInstance().checkIsChinaModel()) {
                    FreecessController.getInstance().protectFreezePackage(processRecord.info.packageName, processRecord.userId, "startProcess" + sb2, 2000L);
                } else {
                    FreecessController.getInstance().protectFreezePackage(processRecord.info.packageName, processRecord.userId, "startProcess" + sb2, 10000L);
                }
            }
                ...
                if (packageAppDataInfoMap == null || !storageManagerInternal.isFuseMounted(userId)) {
                    ...
                    if (!hostingRecord.usesWebviewZygote()) {
                        ...
                        if (hostingRecord.usesAppZygote()) {
                            ...
                            if ((!"next-top-activity".equals(type) || "activelaunch".equals(type)) && start != null) {
                                processList = this;
                                ...
                                if (activityManagerPerformance != null) {
                                    if (CoreRune.SYSFW_APP_SPEG) {
                                        PackageManager packageManager = processList.mService.mContext.getPackageManager();
                                        if (!(packageManager == null ? z3 : packageManager.isSpeg(processRecord.info.packageName, processRecord.userId))) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final ProcessRecord startProcessLocked(String str, ApplicationInfo applicationInfo, boolean z, int i, HostingRecord hostingRecord, int i2, boolean z2, boolean z3, int i3, boolean z4, int i4, String str2, String str3, String str4, String[] strArr, Runnable runnable, boolean z5, int i5) {
        ...
        if (processRecord == null || processRecord.getPid() <= 0) {
            ...
            if (z3) {
                ...
                ProcessRecord processRecord3 = (ProcessRecord) this.mDyingProcesses.get(str, applicationInfo.uid);
            ...
            if ((!z && !processRecord.isKilled()) || processRecord.getThread() == null) {
                ...
                if ((processRecord.isActiveLaunch() || processRecord.getIpmLaunchtype() == 0) && !z5 && i5 == -1) {
        ...
        if (processRecord == null) {
            ...
            if (z5 && "activelaunch".equals(hostingRecord.getType())) {
                ...
                processList = this;
                ComponentName homeActivities = processList.mService.mContext.getPackageManager().getHomeActivities(new ArrayList());
                String packageName = homeActivities == null ? homeActivities.getPackageName() : null;
                if (applicationInfo != null && (z || ((str5 = applicationInfo.packageName) != null && str5.equals(packageName)))) {
                    try {
                        applicationInfo2 = AppGlobals.getPackageManager().getApplicationInfo(applicationInfo.packageName, 0L, UserHandle.semGetUserId(applicationInfo.uid));
                    } catch (RemoteException e) {
                        e.printStackTrace();
                ...
                if (processList.mService.isImsProcess(processRecord.info.packageName) && (processRecord.info.flags & 9) == 9) {
                    processRecord.setPersistent(true);
                    processRecord.mState.setMaxAdj(-800);
                    Slog.d("ActivityManager", "[IMS-AM] startProcessLocked () Set [" + processRecord.info.packageName + XmlUtils.STRING_ARRAY_SEPARATOR + processRecord.info.uid + "] as persistent");
                }
                j2 = j4;
                processList.checkSlow(j2, "startProcess: done creating new process record");
            }
            ...
            processList = this;
            ComponentName homeActivities2 = processList.mService.mContext.getPackageManager().getHomeActivities(new ArrayList());
    ...
    public String isProcStartValidLocked(ProcessRecord processRecord, long j) {
        ...
        if (!processRecord.isPendingStart()) {
            if (processRecord.mIsCancelFromSeq && processRecord.getStartSeq() == j) {
                ...
                Slog.d("ActivityManager", "Don't abort Starting process. It's Target Seq. App=" + processRecord);
            } else {
                if (sb == null) {
                    sb = new StringBuilder();
                }
        ...
        if (processRecord.getStartSeq() > j) {
            ...
            sb.append("seq=" + processRecord.getStartSeq() + ",expected=" + j + KnoxVpnFirewallHelper.DELIMITER);
    ...
    */
    public boolean killPackageProcessesLSP(String str, int i, int i2, int i3, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, int i4, int i5, String str2) {
        ...
        boolean z9 = i >= 10000 && i <= 19999 && FreecessController.getInstance().freezeTargetProcess(str, uid);
        if (z9) {
