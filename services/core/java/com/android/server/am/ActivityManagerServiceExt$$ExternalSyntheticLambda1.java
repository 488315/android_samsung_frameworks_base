...
public final /* synthetic */ class ActivityManagerServiceExt$$ExternalSyntheticLambda1
        implements Consumer {
    ...
    public /* synthetic */ ActivityManagerServiceExt$$ExternalSyntheticLambda1(
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                ActivityManagerServiceExt.updateNeverKill(
                        (RemoteCallback) obj, true, str, processRecord.mPid);
                break;
            default:
                ...
                ActivityManagerServiceExt.updateNeverKill(
                        (RemoteCallback) obj, true, str2, processRecord2.mPid);
                break;
        }
    }
}
