...
public final class AppFGSTracker extends BaseAppStateDurationsTracker
    ...
    public final class AppFGSPolicy extends BaseAppStateEventsTracker.BaseAppStateEventsPolicy {
        ...
        public final void dump(PrintWriter printWriter, String str) {
            ...
            if (this.mTrackerEnabled) {
                ...
                ActivityManagerConstants$$ExternalSyntheticOutline0.m(
                        this.mBgFgsLongRunningThresholdMs,
                        printWriter,
                        str2,
                        "bg_fgs_media_playback_threshold");
                printWriter.print('=');
                ActivityManagerConstants$$ExternalSyntheticOutline0.m(
                        this.mBgFgsMediaPlaybackThresholdMs,
                        printWriter,
                        str2,
                        "bg_fgs_location_threshold");
                printWriter.print('=');
        ...
        public final String getExemptionReasonString(int i, int i2, String str) {
            ...
            long totalDurationsSince =
                    ((AppFGSTracker) this.mTracker)
                            .mAppRestrictionController.mInjector.mAppFGSTracker
                                    .getTotalDurationsSince(
                                            i,
                                            AppFGSTracker.foregroundServiceTypeToIndex(8),
                                            str,
                                            max,
                                            elapsedRealtime);
            return OptionalBool$$ExternalSyntheticOutline0.m(
                    ...
                    totalDurationsSince > 0
                            && totalDurationsSince >= this.mBgFgsLocationThresholdMs);
        }

        @Override // com.android.server.am.BaseAppStateEventsTracker.BaseAppStateEventsPolicy
        public final void onMaxTrackingDurationChanged() {
            AppFGSTracker.m175$$Nest$monBgFgsLongRunningThresholdChanged(
                    (AppFGSTracker) this.mTracker);
        }
        ...
        public final void onPropertiesChanged(String str) {
            switch (str) {
                case "bg_fgs_location_threshold":
                    this.mBgFgsLocationThresholdMs =
                ...
                case "bg_fgs_long_running_threshold":
                    long j =
                            DeviceConfig.getLong(
                                    "activity_manager", "bg_fgs_long_running_threshold", 72000000L);
        ...
        public final void onTrackerEnabled(boolean z) {
            ...
            if (z) {
                ...
                try {
                    appFGSTracker.mNotificationListener.registerAsSystemService(
                            appFGSTracker.mContext,
                            new ComponentName(
                                    appFGSTracker.mContext, (Class<?>) NotificationListener.class),
                            -1);
                    return;
        ...
        public final boolean shouldExemptMediaPlaybackFGS(int i, long j, long j2, String str) {
            AppRestrictionController appRestrictionController =
                    ((AppFGSTracker) this.mTracker).mAppRestrictionController;
            appRestrictionController.getClass();
            long max = Math.max(0L, j - j2);
            long max2 =
                    Math.max(
                            appRestrictionController.mInjector.mAppMediaSessionTracker
                                    .getTotalDurationsSince(i, 0, str, max, j),
                            appRestrictionController.mInjector.mAppFGSTracker
                                    .getTotalDurationsSince(
                                            i,
                                            AppFGSTracker.foregroundServiceTypeToIndex(2),
                                            str,
                                            max,
                                            j));
    ...
    public final class MyHandler extends Handler {
        ...
        public final void handleMessage(Message message) {
            ...
            switch (message.what) {
                case 0:
                    AppFGSTracker.m174$$Nest$mhandleForegroundServicesChanged(
                            this.mTracker, (String) message.obj, message.arg2, true);
                    return;
                case 1:
                    AppFGSTracker.m174$$Nest$mhandleForegroundServicesChanged(
                            this.mTracker, (String) message.obj, message.arg2, false);
                    return;
                case 2:
                    ...
                    if (((AppFGSPolicy) appFGSTracker.mInjector.mAppStatePolicy).mTrackerEnabled) {
                        int backgroundRestrictionExemptionReason =
                                ((AppFGSPolicy) appFGSTracker.mInjector.mAppStatePolicy)
                                        .mTracker.mAppRestrictionController
                                                .getBackgroundRestrictionExemptionReason(i);
                        long elapsedRealtime = SystemClock.elapsedRealtime();
                        synchronized (appFGSTracker.mLock) {
                            try {
                                PackageDurations packageDurations =
                                        (PackageDurations) appFGSTracker.mPkgEvents.get(i, str);
                                if (packageDurations == null) {
                                    packageDurations =
                                            new PackageDurations(
                                                    i,
                                                    str,
                                                    (BaseAppStateEventsTracker
                                                                    .BaseAppStateEventsPolicy)
                                                            appFGSTracker.mInjector.mAppStatePolicy,
                                                    appFGSTracker);
                                    appFGSTracker.mPkgEvents.put(str, i, packageDurations);
                                }
                                packageDurations.setForegroundServiceType(i2, elapsedRealtime);
                                packageDurations.mExemptReason =
                    ...
                    synchronized (appFGSTracker2.mLock) {
                        try {
                            SparseBooleanArray sparseBooleanArray =
                                    (SparseBooleanArray)
                                            appFGSTracker2.mFGSNotificationIDs.get(i3, str2);
                            if (!booleanValue) {
                                if (sparseBooleanArray == null) {
                                    sparseBooleanArray = new SparseBooleanArray();
                                    appFGSTracker2.mFGSNotificationIDs.put(
                                            str2, i3, sparseBooleanArray);
                                }
                                sparseBooleanArray.put(i4, false);
                            } else if (sparseBooleanArray != null
                                    && (indexOfKey = sparseBooleanArray.indexOfKey(i4)) >= 0) {
                                boolean valueAt = sparseBooleanArray.valueAt(indexOfKey);
                                sparseBooleanArray.removeAt(indexOfKey);
                                if (sparseBooleanArray.size() == 0) {
                                    UidProcessMap uidProcessMap =
                                            appFGSTracker2.mFGSNotificationIDs;
                                    int indexOfKey4 = uidProcessMap.mMap.indexOfKey(i3);
                                    if (indexOfKey4 >= 0
                                            && (arrayMap =
                                                            (ArrayMap)
                                                                    uidProcessMap.mMap.valueAt(
                                                                            indexOfKey4))
                                                    != null) {
                                ...
                                if (valueAt) {
                                    appFGSTracker2.notifyListenersOnStateChange(
                                            i3, 8, SystemClock.elapsedRealtime(), str2, false);
                                }
                            }
                        } finally {
                        }
                    ...
                    synchronized (appFGSTracker3.mLock) {
                        try {
                            SparseBooleanArray sparseBooleanArray2 =
                                    (SparseBooleanArray)
                                            appFGSTracker3.mFGSNotificationIDs.get(i5, str3);
                            if (sparseBooleanArray2 != null
                                    && (indexOfKey2 = sparseBooleanArray2.indexOfKey(i6)) >= 0) {
                                ...
                                if (!z) {
                                    appFGSTracker3.notifyListenersOnStateChange(
                                            i5, 8, SystemClock.elapsedRealtime(), str3, true);
                                }
                                return;
                            }
                            return;
                    ...
                    synchronized (appFGSTracker4.mLock) {
                        try {
                            SparseBooleanArray sparseBooleanArray3 =
                                    (SparseBooleanArray)
                                            appFGSTracker4.mFGSNotificationIDs.get(i7, str4);
                            if (sparseBooleanArray3 != null
                                    && (indexOfKey3 = sparseBooleanArray3.indexOfKey(i8)) >= 0) {
                                if (sparseBooleanArray3.valueAt(indexOfKey3)) {
                                    sparseBooleanArray3.setValueAt(indexOfKey3, false);
                                    for (int size3 = sparseBooleanArray3.size() - 1;
                                            size3 >= 0;
                                            size3--) {
                                    ...
                                    appFGSTracker4.notifyListenersOnStateChange(
                                            i7, 8, SystemClock.elapsedRealtime(), str4, false);
                                    return;
                                }
                                return;
                            }
    ...
    public final class PackageDurations extends BaseAppStateDurations {
        ...
        public final void addEvent(long j, boolean z) {
            BaseAppStateTimeEvents$BaseTimeEvent baseAppStateTimeEvents$BaseTimeEvent =
                    new BaseAppStateTimeEvents$BaseTimeEvent(j);
            int i = DEFAULT_INDEX;
        ...
        public final void setForegroundServiceType(int i, long j) {
            ...
            while (highestOneBit != 0) {
                int foregroundServiceTypeToIndex =
                        AppFGSTracker.foregroundServiceTypeToIndex(highestOneBit);
                LinkedList[] linkedListArr = this.mEvents;
                if (foregroundServiceTypeToIndex < linkedListArr.length) {
                    if ((i & highestOneBit) != 0) {
                        ...
                        if (!isActive(foregroundServiceTypeToIndex)) {
                            this.mEvents[foregroundServiceTypeToIndex].add(
                                    new BaseAppStateTimeEvents$BaseTimeEvent(j));
                            notifyListenersOnStateChangeIfNecessary(highestOneBit, j, true);
                        }
                    } else if (linkedListArr[foregroundServiceTypeToIndex] != null
                            && isActive(foregroundServiceTypeToIndex)) {
                        this.mEvents[foregroundServiceTypeToIndex].add(
                                new BaseAppStateTimeEvents$BaseTimeEvent(j));
        ...
        if (size3 > 0) {
            ...
            Arrays.sort(
                    ...
                    new Comparator() { // from class:
                                       // com.android.server.am.AppFGSTracker$$ExternalSyntheticLambda0
                        @Override // java.util.Comparator
                        public final int compare(Object obj, Object obj2) {
                            ArrayMap arrayMap4 = arrayMap2;
                            return Long.compare(
                                    ((Long) arrayMap4.valueAt(((Integer) obj).intValue()))
                                            .longValue(),
                                    ((Long) arrayMap4.valueAt(((Integer) obj2).intValue()))
                                            .longValue());
                        }
                    });
            int i6 = size3 - 1;
            while (i6 >= 0) {
                PackageDurations packageDurations2 =
                        (PackageDurations) arrayMap2.keyAt(numArr2[i6].intValue());
                ...
                if (packageDurations2.mExemptReason == -1) {
                    ...
                    if (!appFGSPolicy2.shouldExemptMediaPlaybackFGS(
                            i7, elapsedRealtime2, j3, str2)) {
                        long totalDurationsSince =
                                ((AppFGSTracker) appFGSPolicy2.mTracker)
                                        .mAppRestrictionController.mInjector.mAppFGSTracker
                                                .getTotalDurationsSince(
                                                        i7,
                                                        foregroundServiceTypeToIndex(8),
                                                        str2,
                                                        max2,
                                                        elapsedRealtime2);
                        if (totalDurationsSince <= 0
                                || totalDurationsSince < appFGSPolicy2.mBgFgsLocationThresholdMs) {
                            AppRestrictionController.NotificationHelper notificationHelper =
                                    ((AppFGSTracker) appFGSPolicy2.mTracker)
                            ...
                            FrameworkStatsLog.write(
                                    ...
                                    i7,
                                    notificationHelper.mBgController.mRestrictionSettings
                                            .getRestrictionLevel(i7),
                                    0,
                                    3,
                                    notificationHelper.mInjector.mAppFGSTracker
                                            .getTrackerInfoForStatsd(i7),
                                    (byte[]) null,
                                    (byte[]) null,
                                    (byte[]) null,
                                    PowerExemptionManager.getExemptionReasonForStatsd(
                                            notificationHelper.mBgController
                                                    .getBackgroundRestrictionExemptionReason(i7)),
                                    0,
                                    0,
                            ...
                            if (notificationHelper
                                    .mBgController
                                    .mConstantsObserver
                                    .mBgPromptFgsOnLongRunning) {
                                if (!notificationHelper
                                        .mBgController
                                        .mConstantsObserver
                                        .mBgPromptFgsWithNotiOnLongRunning) {
                                    AppFGSTracker appFGSTracker2 =
                                            notificationHelper
                                                    .mBgController
                                                    .mInjector
                                                    .mAppFGSTracker;
                                    synchronized (appFGSTracker2.mLock) {
                                        hasForegroundServiceNotificationsLocked =
                                                appFGSTracker2
                                                        .hasForegroundServiceNotificationsLocked(
                                                                i7, str2);
                                    }
                                ...
                                synchronized (notificationHelper.mSettingsLock) {
                                    try {
                                        AppRestrictionController.RestrictionSettings.PkgSettings
                                                restrictionSettingsLocked =
                                                        notificationHelper.mBgController
                                                                .mRestrictionSettings
                                        ...
                                        if (restrictionSettingsLocked == null) {
                                            ...
                                            if (j4 != 0) {
                                                ...
                                                if (j4
                                                                + notificationHelper
                                                                        .mBgController
                                                                        .mConstantsObserver
                                                                        .mBgLongFgsNotificationMinIntervalMs
                                                        > currentTimeMillis) {
                                                    i4 = 0;
                                                }
                                            } else {
                                            ...
                                            restrictionSettingsLocked.setLastNotificationTime(
                                                    1, currentTimeMillis, true);
                                            ...
                                            if (i4 <= 0) {
                                                ...
                                                if (iArr == null) {
                                                    restrictionSettingsLocked.mNotificationId =
                                                            new int[2];
                                                }
                                ...
                                if (i4 <= 0) {
                                    ...
                                    PackageManagerInternal packageManagerInternal =
                                            notificationHelper.mInjector
                                                    .getPackageManagerInternal();
                                    PackageManager packageManager =
                                            notificationHelper.mInjector.mContext
                                                    .getPackageManager();
                                    PendingIntent pendingIntent2 = pendingIntent;
                                    ApplicationInfo applicationInfo =
                                            packageManagerInternal.getApplicationInfo(
                                                    1000, UserHandle.getUserId(i7), 819200L, str2);
                                    String string =
                                            notificationHelper.mContext.getString(
                                                    R.string.silent_mode_ring);
                                    String string2 =
                                            notificationHelper.mContext.getString(
                                                    R.string.share,
                                    ...
                                    notificationHelper.mNotificationManager.notifyAsUser(
                                            ...
                                            new Notification.Builder(
                                                    ...
                                                    .setGroup("com.android.app.abusive_bg_apps")
                                                    .setGroupSummary(true)
                                                    .setStyle(new Notification.BigTextStyle())
                                                    .setSmallIcon(R.drawable.stat_sys_warning)
                                                    .setColor(
                                                            notificationHelper.mContext.getColor(
                                                                    R.color
                                    ...
                                    build.extras.putString(
                                            "android.intent.extra.PACKAGE_NAME", str2);
                                    notificationHelper.mNotificationManager.notifyAsUser(
                                            null, i4, build, of);
                                    i6 = i - 1;
                                    arrayMap2 = arrayMap;
    ...
    public static void m174$$Nest$mhandleForegroundServicesChanged(
            AppFGSTracker appFGSTracker, String str, int i, boolean z) {
        int i2;
        boolean z2;
        if (((AppFGSPolicy) appFGSTracker.mInjector.mAppStatePolicy).mTrackerEnabled) {
            long elapsedRealtime = SystemClock.elapsedRealtime();
                ...
                synchronized (notificationHelper.mSettingsLock) {
                    try {
                        AppRestrictionController.RestrictionSettings.PkgSettings
                                restrictionSettingsLocked =
                                        notificationHelper.mBgController.mRestrictionSettings
                                                .getRestrictionSettingsLocked(i, str);
                        if (restrictionSettingsLocked != null) {
                            int[] iArr = restrictionSettingsLocked.mNotificationId;
                            if (iArr != null) {
                                i2 = iArr[1];
    ...
    public AppFGSTracker(Context context, AppRestrictionController appRestrictionController) {
        ...
        this.mProcessObserver =
                new IProcessObserver.Stub() { // from class: com.android.server.am.AppFGSTracker.1
                        ...
                        synchronized (activityManagerService.mPidsSelfLocked) {
                            try {
                                ProcessRecord processRecord =
                                        activityManagerService.mPidsSelfLocked.get(i);
                                str =
                                        (processRecord == null
        ...
        AppFGSPolicy appFGSPolicy =
                new AppFGSPolicy(
                        injector,
                        this,
                        "bg_fgs_monitor_enabled",
                        true,
                        "bg_fgs_long_running_window",
                        BackupManagerConstants.DEFAULT_FULL_BACKUP_INTERVAL_MILLISECONDS);
        appFGSPolicy.mBgFgsLongRunningThresholdMs = 72000000L;
        appFGSPolicy.mBgFgsMediaPlaybackThresholdMs =
                BackupManagerConstants.DEFAULT_KEY_VALUE_BACKUP_INTERVAL_MILLISECONDS;
        appFGSPolicy.mBgFgsLocationThresholdMs =
                BackupManagerConstants.DEFAULT_KEY_VALUE_BACKUP_INTERVAL_MILLISECONDS;
    ...
    public final BaseAppStateEvents createAppStateEvents(int i, String str) {
        return new PackageDurations(
                i,
                str,
                (BaseAppStateEventsTracker.BaseAppStateEventsPolicy) this.mInjector.mAppStatePolicy,
                this);
    }
    ...
    public final long getTotalDurations(PackageDurations packageDurations, long j) {
        ...
        synchronized (this.mLock) {
            try {
                BaseAppStateDurations baseAppStateDurations =
                        (BaseAppStateDurations) this.mPkgEvents.get(i, str);
                j2 = 0;
                if (baseAppStateDurations != null) {
                    BaseAppStateDurationsTracker.UidStateDurations uidStateDurations =
                            (BaseAppStateDurationsTracker.UidStateDurations)
                                    this.mUidStateDurations.get(i);
                    if (uidStateDurations == null || uidStateDurations.isEmpty()) {
                        j2 =
                                baseAppStateDurations.getTotalDurationsSince(
                                        foregroundServiceTypeToIndex,
                                        baseAppStateDurations.getEarliest(0L),
                                        j);
                    } else {
                        BaseAppStateDurations baseAppStateDurations2 =
                                (BaseAppStateDurations) createAppStateEvents(baseAppStateDurations);
                        baseAppStateDurations2.subtract(
                                uidStateDurations, foregroundServiceTypeToIndex);
                        j2 =
                                baseAppStateDurations2.getTotalDurationsSince(
                                        foregroundServiceTypeToIndex,
                                        baseAppStateDurations2.getEarliest(0L),
                                        j);
                    }
                }
            } finally {
    ...
    public final byte[] getTrackerInfoForStatsd(int i) {
        ...
        synchronized (this.mLock) {
            try {
                BaseAppStateDurations baseAppStateDurations =
                        (BaseAppStateDurations) getUidEventsLocked(i);
                if (baseAppStateDurations == null) {
                    totalDurationsSince = 0;
                } else {
                    BaseAppStateDurationsTracker.UidStateDurations uidStateDurations =
                            (BaseAppStateDurationsTracker.UidStateDurations)
                                    this.mUidStateDurations.get(i);
                    if (uidStateDurations != null && !uidStateDurations.isEmpty()) {
                        baseAppStateDurations.subtract(
                                uidStateDurations, foregroundServiceTypeToIndex);
                    }
                    totalDurationsSince =
                            baseAppStateDurations.getTotalDurationsSince(
    ...
    public final boolean hasForegroundServiceNotificationsLocked(int i, String str) {
        SparseBooleanArray sparseBooleanArray =
                (SparseBooleanArray) this.mFGSNotificationIDs.get(i, str);
    ...
    public final void scheduleDurationCheckLocked(long j) {
        ...
        for (int size = sparseArray.size() - 1; size >= 0; size--) {
            ...
            for (int size2 = arrayMap.size() - 1; size2 >= 0; size2--) {
                ...
                if (packageDurations.isActive(PackageDurations.DEFAULT_INDEX)
                        && !packageDurations.mIsLongRunning) {
        ...
        if (j2 >= 0) {
            this.mHandler.sendEmptyMessageDelayed(
                    ...
                    Math.max(
                                    0L,
                                    ((AppFGSPolicy) this.mInjector.mAppStatePolicy)
                                                    .mBgFgsLongRunningThresholdMs
                                            - j2)
                            + this.mInjector.mActivityManagerInternal
                                    .getServiceStartForegroundTimeout());
        }
    }
}
