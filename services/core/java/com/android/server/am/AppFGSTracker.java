...
public final class AppFGSTracker extends BaseAppStateDurationsTracker
  ...
  public class MyHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      switch (message.what) {
        case 0:
          this.mTracker.handleForegroundServicesChanged(
              (String) message.obj, message.arg1, message.arg2, true);
          break;
        case 1:
          this.mTracker.handleForegroundServicesChanged(
              (String) message.obj, message.arg1, message.arg2, false);
          break;
        case 2:
          this.mTracker.handleForegroundServicesChanged(
              (String) message.obj, message.arg1, message.arg2);
          break;
        case 3:
          SomeArgs someArgs = (SomeArgs) message.obj;
          this.mTracker.handleForegroundServiceNotificationUpdated(
              (String) someArgs.arg1,
              someArgs.argi1,
              someArgs.argi2,
              ((Boolean) someArgs.arg2).booleanValue());
          someArgs.recycle();
          break;
        case 4:
  ...
  public PackageDurations createAppStateEvents(int i, String str) {
    return new PackageDurations(
        i, str, (BaseAppStateEvents.MaxTrackingDurationConfig) this.mInjector.getPolicy(), this);
  }
  ...
  public final void handleForegroundServiceNotificationUpdated(
    ...
    synchronized (this.mLock) {
      ...
      if (!z) {
        ...
        sparseBooleanArray.put(i2, false);
          ...
          && (indexOfKey = sparseBooleanArray.indexOfKey(i2)) >= 0) {
  ...
  public final void scheduleDurationCheckLocked(long j) {
    ...
    if (j2 >= 0) {
      this.mHandler.sendEmptyMessageDelayed(
          4,
          this.mInjector.getServiceStartForegroundTimeout()
              + Math.max(
                  0L,
                  ((AppFGSPolicy) this.mInjector.getPolicy()).getFgsLongRunningThreshold() - j2));
    }
  }
    ...
    synchronized (this.mLock) {
      ...
      while (size >= 0) {
        ...
        while (size2 >= 0) {
          ...
          if (packageDurations.hasForegroundServices()
              && packageDurations.getForegroundServiceType() == 0) {
            j = fgsLongRunningThreshold;
            MARsHandler.getInstance()
                .sendFGSRestrictionTargetMsgToMainHandler(
                    packageDurations.mPackageName, packageDurations.mUid);
          } else {
            j = fgsLongRunningThreshold;
          }
          size2--;
      ...
      Arrays.sort(
          ...
          new Comparator() { // from class:
            ...
            public final int compare(Object obj, Object obj2) {
              ...
              lambda$checkLongRunningFgs$0 =
                  AppFGSTracker.lambda$checkLongRunningFgs$0(
                      arrayMap, (Integer) obj, (Integer) obj2);
              return lambda$checkLongRunningFgs$0;
            }
          });
      for (int i3 = size3 - 1; i3 >= 0; i3--) {
        PackageDurations packageDurations2 =
            (PackageDurations) arrayMap.keyAt(numArr[i3].intValue());
        appFGSPolicy.onLongRunningFgs(
            packageDurations2.mPackageName,
            packageDurations2.mUid,
            packageDurations2.mExemptReason);
      }
      arrayMap.clear();
    }
    synchronized (this.mLock) {
  ...
  public static /* synthetic */ int lambda$checkLongRunningFgs$0(
      ArrayMap arrayMap, Integer num, Integer num2) {
    return Long.compare(
        ((Long) arrayMap.valueAt(num.intValue())).longValue(),
        ((Long) arrayMap.valueAt(num2.intValue())).longValue());
  }
  ...
  public long getTotalDurations(PackageDurations packageDurations, long j) {
    return getTotalDurations(
        packageDurations.mPackageName, packageDurations.mUid, j, foregroundServiceTypeToIndex(0));
  }
  ...
  public class PackageDurations extends BaseAppStateDurations {
    ...
    public PackageDurations(
        int i,
        String str,
        BaseAppStateEvents.MaxTrackingDurationConfig maxTrackingDurationConfig,
      ...
      while (true) {
        ...
        if (i < linkedListArr.length) {
          if (linkedListArr[i] != null && isActive(i)) {
            ...
            notifyListenersOnStateChangeIfNecessary(
                false, j, AppFGSTracker.indexToForegroundServiceType(i));
          }
          i++;
        } else {
  ...
  public final class AppFGSPolicy extends BaseAppStateEventsTracker.BaseAppStateEventsPolicy {
    ...
    public void onLongRunningFgs(String str, int i, int i2) {
      ...
      if (shouldExemptMediaPlaybackFGS(str, i, elapsedRealtime, fgsLongRunningWindowSize)
          || shouldExemptLocationFGS(str, i, elapsedRealtime, max)) {
        return;
      }
      ((AppFGSTracker) this.mTracker)
          .mAppRestrictionController.postLongRunningFgsIfNecessary(str, i);
    }

    public boolean shouldExemptMediaPlaybackFGS(String str, int i, long j, long j2) {
      long compositeMediaPlaybackDurations =
          ((AppFGSTracker) this.mTracker)
              .mAppRestrictionController.getCompositeMediaPlaybackDurations(str, i, j, j2);
      return compositeMediaPlaybackDurations > 0
          && compositeMediaPlaybackDurations >= getFGSMediaPlaybackThreshold();
    }

    public boolean shouldExemptLocationFGS(String str, int i, long j, long j2) {
      long foregroundServiceTotalDurationsSince =
          ((AppFGSTracker) this.mTracker)
              .mAppRestrictionController.getForegroundServiceTotalDurationsSince(str, i, j2, j, 8);
      return foregroundServiceTotalDurationsSince > 0
          && foregroundServiceTotalDurationsSince >= getLocationFGSThreshold();
    }
    ...
    public String getExemptionReasonString(String str, int i, int i2) {
      ...
      return "{mediaPlayback="
          + shouldExemptMediaPlaybackFGS(str, i, elapsedRealtime, getFgsLongRunningWindowSize())
          + ", location="
          + shouldExemptLocationFGS(
              str,
              i,
              elapsedRealtime,
              Math.max(0L, elapsedRealtime - getFgsLongRunningWindowSize()))
          + "}";
    }

    public void onLongRunningFgsGone(String str, int i) {
      ((AppFGSTracker) this.mTracker)
          .mAppRestrictionController.cancelLongRunningFGSNotificationIfNecessary(str, i);
    }
