...
public final /* synthetic */ class UserController$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ UserController$$ExternalSyntheticLambda1(
            UserController userController, int i, UserState userState, boolean z, int i2) {
        this.$r8$classId = i2;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                ...
                userController.mHandler.post(
                        new UserController$$ExternalSyntheticLambda1(
                                userController, this.f$1, this.f$2, this.f$3, 1));
                return;
            case 1:
                ...
                synchronized (userController2.mLock) {
                    try {
                        if (userState.state != 4) {
                            UserJourneyLogger.UserJourneySession logUserJourneyFinishWithError =
                                    userController2
                                            .mInjector
                                            .getUserManager()
                                            .mUserJourneyLogger
                                            .logUserJourneyFinishWithError(
                                                    -1, userController2.getUserInfo(i), 5, 3);
                            if (logUserJourneyFinishWithError != null) {
                                userController2.mHandler.removeMessages(
                                        200, logUserJourneyFinishWithError);
                            } else {
                                userController2
                                        .mInjector
                                        .getUserManager()
                                        .mUserJourneyLogger
                                        .logUserJourneyFinishWithError(
                                                -1, userController2.getUserInfo(i), 5, 0);
                            }
                        } else {
                            userState.setState(5);
                            TimingsTraceAndSlog timingsTraceAndSlog2 = new TimingsTraceAndSlog();
                            timingsTraceAndSlog2.traceBegin(
                                    "setUserState-STATE_SHUTDOWN-" + i + "-[stopUser]");
                            userController2
                                    .mInjector
                                    .getUserManagerInternal()
                                    .setUserState(i, userState.state);
                            timingsTraceAndSlog2.traceEnd();
                            userController2.mInjector.mService.mBatteryStatsService.noteEvent(
                                    16391, Integer.toString(i), i);
                            SystemServiceManager systemServiceManager =
                                    userController2.mInjector.mService.mSystemServiceManager;
                            systemServiceManager.getClass();
                            EventLog.writeEvent(30086, i);
                            systemServiceManager.onUser(i, "Stop");
                            UserController$$ExternalSyntheticLambda1
                                    userController$$ExternalSyntheticLambda1 =
                                            new UserController$$ExternalSyntheticLambda1(
                                                    userController2, i, userState, z, 2);
                            if (userController2.mInjector.getUserManager().isPreCreated(i)) {
                                ...
                                UserController.asyncTraceBegin(
                                        i, "broadcast-ACTION_SHUTDOWN-" + i + "-[stopUser]");
                                userController2.mInjector.broadcastIntent(
                                        intent,
                                        anonymousClass5,
                                        null,
                                        null,
            ...
            case 2:
                ...
                userController3.mHandler.post(
                        new UserController$$ExternalSyntheticLambda1(
                                userController3, this.f$1, this.f$2, this.f$3, 3));
                return;
            default:
