...
public final class AppPermissionTracker extends BaseAppStateTracker
  ...
  public final void handleAppOpsInit() {
    ...
    for (Pair pair :
        ((AppPermissionPolicy) this.mInjector.getPolicy()).getBgPermissionsInMonitor()) {
          ...
          while (i6 < length) {
            ...
            UidGrantedPermissionState uidGrantedPermissionState =
                new UidGrantedPermissionState(
                    applicationInfo2.uid, (String) pair.first, ((Integer) pair.second).intValue());
  ...
  public final void handleOpChanged(int i, int i2, String str) {
    ...
    for (Pair pair : bgPermissionsInMonitor) {
      if (((Integer) pair.second).intValue() == i) {
        UidGrantedPermissionState uidGrantedPermissionState =
            new UidGrantedPermissionState(i2, (String) pair.first, i);
        synchronized (this.mLock) {
          handlePermissionsChangedLocked(
              i2, new UidGrantedPermissionState[] {uidGrantedPermissionState});
        }
        return;
      }
    }
  ...
  public final void handlePermissionsChanged(int i) {
    ...
    UidGrantedPermissionState[] uidGrantedPermissionStateArr =
        new UidGrantedPermissionState[bgPermissionsInMonitor.length];
    for (int i2 = 0; i2 < bgPermissionsInMonitor.length; i2++) {
      Pair pair = bgPermissionsInMonitor[i2];
      uidGrantedPermissionStateArr[i2] =
          new UidGrantedPermissionState(i, (String) pair.first, ((Integer) pair.second).intValue());
    }
    synchronized (this.mLock) {
  ...
  public class UidGrantedPermissionState {
      ...
      if (TextUtils.isEmpty(this.mPermission)) {
        ...
        this.mPermissionGranted =
            AppPermissionTracker.this
                    ...
                    .checkUidPermission(this.mUid, this.mPermission)
                == 0;
      }
    }
    ...
    public void updateAppOps() {
      ...
      String[] packagesForUid =
          AppPermissionTracker.this.mInjector.getPackageManager().getPackagesForUid(this.mUid);
  ...
  public void dump(PrintWriter printWriter, String str) {
    ...
    Pair[] bgPermissionsInMonitor =
        ((AppPermissionPolicy) appPermissionTracker.mInjector.getPolicy())
            .getBgPermissionsInMonitor();
    String str4 = "  " + str;
    String str5 = "  " + str4;
    int length = bgPermissionsInMonitor.length;
    int i = 0;
      ...
      synchronized (appPermissionTracker.mLock) {
        ...
        while (i2 < size) {
          ...
          while (true) {
            ...
            pairArr2 = bgPermissionsInMonitor;
            str3 = str4;
            if (uidGrantedPermissionState.mAppOp == ((Integer) pair.second).intValue()
                && TextUtils.equals(
                    uidGrantedPermissionState.mPermission, (CharSequence) pair.first)) {
              if (z) {
                printWriter.print(',');
              }
  ...
  public final class AppPermissionPolicy extends BaseAppStatePolicy {
    ...
    public AppPermissionPolicy(
        BaseAppStateTracker.Injector injector, AppPermissionTracker appPermissionTracker) {
        ...
        try {
          ...
          pairArr[i2] =
              Pair.create(
                  ...
                  Integer.valueOf(
                      TextUtils.isEmpty(strArr[i3]) ? -1 : AppOpsManager.strOpToOp(strArr[i3])));
    ...
    public final void updateBgPermissionsInMonitor() {
      String string =
          DeviceConfig.getString("activity_manager", "bg_permission_in_monitor", (String) null);
