...
public final /* synthetic */ class ActivityManagerService$$ExternalSyntheticLambda9
        implements Runnable {
            ...
            case 2:
                ActivityTaskManagerService.LocalService localService =
                        (ActivityTaskManagerService.LocalService)
                                ((ActivityTaskManagerInternal) obj);
                    ...
                    try {
                        try {
                            if (AppGlobals.getPackageManager().hasSystemUidErrors()) {
                                Slog.e(
                                        "ActivityTaskManager",
                                        "UIDs on the system are inconsistent, you need to wipe your"
                                            + " data partition or your device will be unstable.");
                                ActivityTaskManagerService.this.mUiHandler.post(
                                        new ActivityTaskManagerService$LocalService$$ExternalSyntheticLambda0(
                                                localService, 2));
                            }
                ...
                return;
            default:
                ActivityManagerService.AnonymousClass12 anonymousClass12 =
                        (ActivityManagerService.AnonymousClass12) obj;
                ActivityManagerProcLock activityManagerProcLock =
                        ActivityManagerService.this.mProcLock;
                ActivityManagerService.boostPriorityForProcLockedSection();
                synchronized (activityManagerProcLock) {
                    try {
                        ActivityManagerService.this.mAppProfiler.requestPssAllProcsLPr(
