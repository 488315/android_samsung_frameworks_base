...
public abstract class PreBootBroadcaster extends IIntentReceiver.Stub {
    ...
    public void sendNext() {
        ...
        if (this.mProgress != null) {
            this.mProgress.setProgress(this.mIndex, this.mTargets.size(), this.mService.mContext.getString(R.string.call_notification_answer_video_action, resolveInfo.activityInfo.loadLabel(this.mService.mContext.getPackageManager())));
        }
