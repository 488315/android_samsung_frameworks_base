...
public final /* synthetic */ class ActivityManagerService$$ExternalSyntheticLambda11
        implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ ActivityManagerService f$0;

    public /* synthetic */ ActivityManagerService$$ExternalSyntheticLambda11(
            ActivityManagerService activityManagerService, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        ...
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                activityManagerService2.mActivityTaskManager.mAppLockPolicy =
                        AppLockPolicy.getInstance(
                                activityManagerService2.mContext, activityManagerService2.mHandler);
                return;
            case 2:
                ...
                synchronized (activityManagerProcLock) {
                    try {
                        if (ActivityManagerConstants.BINDER_HEAVY_HITTER_WATCHER_ENABLED) {
                            ...
                            final int i2 = 0;
                            binderCallHeavyHitterListener =
                                    new BinderCallHeavyHitterWatcher
                                            .BinderCallHeavyHitterListener() { // from class:
                                                                               // com.android.server.am.ActivityManagerService$$ExternalSyntheticLambda33
                                        public final void onHeavyHit(
                                                final List list,
                                                final int i3,
                                                final float f2,
                                                final long j) {
                                            switch (i2) {
                                                case 0:
                                                    ...
                                                    final int i4 = 1;
                                                    activityManagerService4.mHandler.post(
                                                            new Runnable() { // from class:
                                                                             // com.android.server.am.ActivityManagerService$$ExternalSyntheticLambda42
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                                                    switch (i4) {
                                                                        case 0:
                                                ...
                                                case 1:
                                                    final ActivityManagerService
                                                            activityManagerService5 =
                                                                    activityManagerService3;
                                                    final int i5 = 0;
                                                    activityManagerService5.mHandler.post(
                                                            new Runnable() { // from class:
                                                                             // com.android.server.am.ActivityManagerService$$ExternalSyntheticLambda42
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                                ...
                                                default:
                                                    final ActivityManagerService
                                                            activityManagerService6 =
                                                                    activityManagerService3;
                                                    final int i6 = 2;
                                                    activityManagerService6.mHandler.post(
                                                            new Runnable() { // from class:
                                                                             // com.android.server.am.ActivityManagerService$$ExternalSyntheticLambda42
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                            ...
                            final int i4 = 1;
                            BinderCallHeavyHitterWatcher.BinderCallHeavyHitterListener
                                    binderCallHeavyHitterListener2 =
                                            new BinderCallHeavyHitterWatcher
                                                    .BinderCallHeavyHitterListener() { // from
                                                                                       // class:
                                                                                       // com.android.server.am.ActivityManagerService$$ExternalSyntheticLambda33
                                                public final void onHeavyHit(
                                                        final List list,
                ...
                synchronized (activityManagerService5) {
                    try {
                        ActivityManagerServiceExt activityManagerServiceExt =
                                activityManagerService5.mExt;
                        activityManagerServiceExt.mCanTmoPkgAvoidForceStop =
            ...
            default:
                ...
                ActivityManagerProcLock activityManagerProcLock2 =
                        activityManagerService6.mProcLock;
                ActivityManagerService.boostPriorityForProcLockedSection();
                synchronized (activityManagerProcLock2) {
                    try {
                        ...
                        if (activityManagerService6.mLastBinderHeavyHitterAutoSamplerStart
                        ...
                        int i5 =
                                ActivityManagerConstants.BINDER_HEAVY_HITTER_AUTO_SAMPLER_BATCHSIZE;
                        float f3 =
                                ActivityManagerConstants.BINDER_HEAVY_HITTER_AUTO_SAMPLER_THRESHOLD;
                        ActivityManagerService.resetPriorityAfterProcLockedSection();
                        activityManagerService6.mLastBinderHeavyHitterAutoSamplerStart =
                                uptimeMillis;
                        final int i6 = 2;
                        Binder.setHeavyHitterWatcherConfig(
                                true,
                                i5,
                                f3,
                                new BinderCallHeavyHitterWatcher
                                    ...
                                    public final void onHeavyHit(
                                        ...
                                        switch (i6) {
                                            case 0:
                                                final ActivityManagerService
                                                        activityManagerService42 =
                                                                activityManagerService6;
                                                final int i42 = 1;
                                                activityManagerService42.mHandler.post(
                                                        new Runnable() { // from class:
                                                                         // com.android.server.am.ActivityManagerService$$ExternalSyntheticLambda42
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                            ...
                                            case 1:
                                                final ActivityManagerService
                                                        activityManagerService52 =
                                                                activityManagerService6;
                                                final int i52 = 0;
                                                activityManagerService52.mHandler.post(
                                                        new Runnable() { // from class:
                                                                         // com.android.server.am.ActivityManagerService$$ExternalSyntheticLambda42
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                            ...
                                            default:
                                                final ActivityManagerService
                                                        activityManagerService62 =
                                                                activityManagerService6;
                                                final int i62 = 2;
                                                activityManagerService62.mHandler.post(
                                                        new Runnable() { // from class:
                                                                         // com.android.server.am.ActivityManagerService$$ExternalSyntheticLambda42
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                        ...
                        ActivityManagerService.UiHandler uiHandler =
                                activityManagerService6.mHandler;
