...
public class OomAdjProfiler {
    ...
    synchronized (this) {
      if (this.mOomAdjStarted) {
        long currentThreadTimeMicro =
            SystemClock.currentThreadTimeMicro() - this.mOomAdjStartTimeUs;
      ...
      Message obtainMessage =
          PooledLambda.obtainMessage(
              new QuadConsumer() { // from class:
                                   // com.android.server.am.OomAdjProfiler$$ExternalSyntheticLambda0
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  ((OomAdjProfiler) obj)
                      .updateSystemServerCpuTime(
              ...
              this,
              Boolean.valueOf(this.mLastScheduledOnBattery),
              Boolean.valueOf(this.mLastScheduledScreenOff),
              Boolean.TRUE);
  ...
  public final void updateSystemServerCpuTime(boolean z, boolean z2, boolean z3) {
    ...
    synchronized (this) {
      ...
      this.mSystemServerCpuTime.addCpuTimeMs(
          cpuTimeForPid - this.mLastSystemServerCpuTimeMs, z, z2);
  ...
  public void dump(PrintWriter printWriter) {
    synchronized (this) {
      if (this.mSystemServerCpuTimeUpdateScheduled) {
        ...
        updateSystemServerCpuTime(
            this.mLastScheduledOnBattery, this.mLastScheduledScreenOff, false);
      } else {
        updateSystemServerCpuTime(this.mOnBattery, this.mScreenOff, false);
      }
      printWriter.println(
          "System server and oomAdj runtimes (ms) in recent battery sessions (most recent first):");
      if (!this.mSystemServerCpuTime.isEmpty()) {
        printWriter.print("  ");
  ...
  public class CpuTimes {
    ...
    public String toString() {
      return "["
          + (this.mOnBatteryTimeUs / 1000)
          + ","
          + (this.mOnBatteryScreenOffTimeUs / 1000)
          + "]";
    }
  }
}
