...
public abstract class EventLogTags {
  ...
  public static void writeAmCrash(
      int i, int i2, String str, int i3, String str2, String str3, String str4, int i4, int i5) {
    EventLog.writeEvent(
        30039,
        Integer.valueOf(i),
        Integer.valueOf(i2),
  ...
  public static void writeAmWtf(int i, int i2, String str, int i3, String str2, String str3) {
    EventLog.writeEvent(
        30040, Integer.valueOf(i), Integer.valueOf(i2), str, Integer.valueOf(i3), str2, str3);
  }
  ...
  public static void writeAmPss(
      int i, int i2, String str, long j, long j2, long j3, long j4, int i3, int i4, long j5) {
    EventLog.writeEvent(
        30047,
        Integer.valueOf(i),
        Integer.valueOf(i2),
  ...
  public static void writeBootProgressAmsState(int i, int i2, int i3, String str, String str2) {
    EventLog.writeEvent(
        1000100, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), str, str2);
  }
