...
public final /* synthetic */ class BatteryStatsService$$ExternalSyntheticLambda61
        implements Runnable {
    ...
    public /* synthetic */ BatteryStatsService$$ExternalSyntheticLambda61(
    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                ...
                batteryStatsService.mStats.updateWifiState(
                        (WifiActivityEnergyInfo) this.f$1, -1L, this.f$2, this.f$3, this.f$4);
                break;
            default:
                BatteryStatsService batteryStatsService2 = this.f$0;
                batteryStatsService2.mStats.noteModemControllerActivity(
                        (ModemActivityInfo) this.f$1, -1L, this.f$2, this.f$3, this.f$4);
                break;
        }
    }
}
