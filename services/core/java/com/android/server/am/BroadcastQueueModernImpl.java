...
public class BroadcastQueueModernImpl extends BroadcastQueue {
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean dispatchReceivers(BroadcastProcessQueue broadcastProcessQueue, BroadcastRecord broadcastRecord, int i) {
        Object obj;
        boolean z;
        int i2;
        Object obj2;
        ...
        if (this.mService.mProcessesReady && !broadcastRecord.timeoutExempt && !isAssumedDelivered) {
            ...
            int i5 = (int) (broadcastRecord.isForeground() ? this.mFgConstants.TIMEOUT : this.mBgConstants.TIMEOUT);
            Handler handler = this.mLocalHandler;
        ...
        setDeliveryState(broadcastProcessQueue, processRecord, broadcastRecord, i, obj3, 4, "scheduleReceiverWarmLocked");
                ...
                if (obj3 instanceof BroadcastFilter) {
                    ...
                    try {
                        ...
                        if (z4) {
                            ...
                            } catch (BadParcelableException | RemoteException | ConcurrentModificationException e2) {
                                e = e2;
                                i2 = 2;
                                z = false;
                            }
                        ...
                        z = false;
                        try {
                            onewayThread.scheduleRegisteredReceiver(iIntentReceiver, receiverIntent, i6, str, bundle, z2, z3, isAssumedDelivered, i3, reportedProcState, i4, z4 ? broadcastRecord.callerPackage : null);
                            if (!isAssumedDelivered) {
                                return true;
                            }
                            finishReceiverActiveLocked(broadcastProcessQueue, 1, "assuming delivered");
                            return false;
                        } catch (BadParcelableException | RemoteException | ConcurrentModificationException e3) {
                            e = e3;
                            i2 = 2;
                        }
                    ...
                    try {
                        ...
                        onewayThread.scheduleReceiver(receiverIntent, activityInfo, (CompatibilityInfo) null, i7, str2, bundle2, z5, isAssumedDelivered, i8, reportedProcState2, z6 ? broadcastRecord.callingUid : -1, z6 ? broadcastRecord.callerPackage : null);
                        return true;
