...
public final class ProfcollectForwardingService extends SystemService {
  ...
  public ProfcollectForwardingService(Context context) {
    ...
    this.mProviderStatusCallback =
        new IProviderStatusCallback
            .Stub() { // from class: com.android.server.profcollect.ProfcollectForwardingService.1
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() { // from class:
          ...
          public void onReceive(Context context2, Intent intent) {
            if ("com.android.server.profcollect.UPLOAD_PROFILES".equals(intent.getAction())) {
              Log.d(
                  "ProfcollectForwardingService", "Received broadcast to pack and upload reports");
    ...
    BackgroundThread.get()
        ...
        .post(
            new Runnable() { // from class:
              // com.android.server.profcollect.ProfcollectForwardingService$$ExternalSyntheticLambda0
  ...
  public final void registerProviderStatusCallback() {
    ...
    try {
      ...
      Log.e(
          ...
          "Failed to register provider status callback: " + e.getMessage());
    }
  }
  ...
  public final boolean connectNativeService() {
    try {
      IProfCollectd asInterface =
          IProfCollectd.Stub.asInterface(ServiceManager.getServiceOrThrow("profcollectd"));
  ...
  public class ProfcollectBGJobService extends JobService {
    ...
    public static void schedule(Context context) {
      ((JobScheduler) context.getSystemService(JobScheduler.class))
          .schedule(
              new JobInfo.Builder(260817, JOB_SERVICE_NAME)
                  .setRequiresDeviceIdle(true)
                  .setRequiresCharging(true)
                  .setPeriodic(ProfcollectForwardingService.BG_PROCESS_PERIOD)
                  .setPriority(100)
                  .build());
    }
    ...
    public boolean onStartJob(JobParameters jobParameters) {
      ...
      BackgroundThread.get()
          ...
          .post(
              new Runnable() { // from class:
                // com.android.server.profcollect.ProfcollectForwardingService$ProfcollectBGJobService$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static /* synthetic */ void lambda$onStartJob$0() {
      try {
        ...
        Log.e(
            "ProfcollectForwardingService",
            "Failed to process profiles in background: " + e.getMessage());
      }
    }
  }
  ...
  public final void registerObservers() {
    BackgroundThread.get()
        ...
        .post(
            new Runnable() { // from class:
              // com.android.server.profcollect.ProfcollectForwardingService$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public final void registerAppLaunchObserver() {
    ((ActivityTaskManagerInternal) LocalServices.getService(ActivityTaskManagerInternal.class))
        ...
        .registerLaunchObserver(this.mAppLaunchObserver);
  }
  ...
  public final void registerOTAObserver() {
    new UpdateEngine()
        .bind(
            new UpdateEngineCallback() { // from class:
              // com.android.server.profcollect.ProfcollectForwardingService.3
              ...
              public void onStatusUpdate(int i, float f) {
                if (ProfcollectForwardingService.DEBUG) {
                  Log.d(
                      "ProfcollectForwardingService",
                      "Received OTA status update, status: " + i + ", percent: " + f);
                }
                if (i == 6) {
                  ProfcollectForwardingService.this.packAndUploadReport();
                }
  ...
  public final void packAndUploadReport() {
    ...
    BackgroundThread.get()
        ...
        .post(
            new Runnable() { // from class:
              // com.android.server.profcollect.ProfcollectForwardingService$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public /* synthetic */ void lambda$packAndUploadReport$3(Context context) {
    ...
    try {
      ...
      if (!context.getResources().getBoolean(R.bool.config_navBarAlwaysShowOnSideEdgeGesture)) {
