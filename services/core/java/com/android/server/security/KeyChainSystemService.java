...
public class KeyChainSystemService extends SystemService {
  ...
  public KeyChainSystemService(Context context) {
    ...
    this.mPackageReceiver =
        new BroadcastReceiver() { // from class: com.android.server.security.KeyChainSystemService.1
          ...
          public void onReceive(Context context2, Intent intent) {
            ...
            try {
              ...
              ComponentName resolveSystemService =
                  intent2.resolveSystemService(
                      KeyChainSystemService.this.getContext().getPackageManager(), 0);
              if (resolveSystemService == null) {
                return;
              }
              intent2.setComponent(resolveSystemService);
              intent2.setAction(intent.getAction());
              KeyChainSystemService.this.startServiceInBackgroundAsUser(
                  intent2, UserHandle.of(getSendingUserId()));
            } catch (RuntimeException e) {
              Slog.e(
                  "KeyChainSystemService",
                  "Unable to forward package removed broadcast to KeyChain",
                  e);
            }
          }
        };
  ...
  public final void startServiceInBackgroundAsUser(Intent intent, UserHandle userHandle) {
    ...
    ((DeviceIdleInternal) LocalServices.getService(DeviceIdleInternal.class))
        .addPowerSaveTempWhitelistApp(
            ...
            false,
            FrameworkStatsLog.f85x3da64833,
            "keychain");
