...
public class KeyChainSystemService extends SystemService {
    ...
    public final void startServiceInBackgroundAsUser(Intent intent, UserHandle userHandle) {
        ...
        ((DeviceIdleInternal) LocalServices.getService(DeviceIdleInternal.class)).addPowerSaveTempWhitelistApp(Process.myUid(), intent.getComponent().getPackageName(), 30000L, userHandle.getIdentifier(), false, FrameworkStatsLog.f85x3da64833, "keychain");
