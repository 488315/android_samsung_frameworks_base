...
public class FileIntegrityService extends SystemService {
  ...
  public FileIntegrityService(Context context) {
    ...
    this.mService =
        new IFileIntegrityService
            .Stub() { // from class: com.android.server.security.FileIntegrityService.1
          ...
          public boolean isAppSourceCertificateTrusted(byte[] bArr, String str) {
            ...
            try {
              ...
              synchronized (FileIntegrityService.this.mTrustedCertificates) {
                contains =
                    FileIntegrityService.this.mTrustedCertificates.contains(
                        FileIntegrityService.toCertificate(bArr));
              }
              return contains;
          ...
          public final void checkCallerPermission(String str) {
            ...
            if (callingUid
              ...
              throw new SecurityException(
                  "Calling uid " + callingUid + " does not own package " + str);
            }
            if (FileIntegrityService.this
                ...
                && ((AppOpsManager)
                        ...
                        .checkOpNoThrow(66, callingUid, str)
                    != 0) {
              throw new SecurityException(
    ...
    public int onCommand(String str) {
      ...
      if (!str.equals("append-cert")) {
        if (str.equals("remove-last-cert")) {
          synchronized (FileIntegrityService.this.mTrustedCertificates) {
            ...
            FileIntegrityService.this.mTrustedCertificates.remove(
                FileIntegrityService.this.mTrustedCertificates.size() - 1);
      ...
      try {
        FileIntegrityService.this.collectCertificate(
            new ParcelFileDescriptor.AutoCloseInputStream(openFileForSystem).readAllBytes());
