        ...
        public final void onResult(Object obj) {
            try {
                this.mCallback.onSuccess(
                        new RemoteProvisioningRegistration(
                                (RegistrationProxy) obj, this.mExecutor));
            } catch (RemoteException e) {
                Log.e(
                        "RemoteProvisionSysSvc",
    ...
    public final class RemoteProvisioningImpl extends IRemoteProvisioning.Stub {
        ...
        public final void dump(
            ...
            if (DumpUtils.checkDumpPermission(
                ...
                try {
                    new RemoteProvisioningShellCommand(
                                    RemoteProvisioningService.this.getContext(), callingUidOrThrow)
                            .dump(printWriter);
                } finally {
        ...
        public final void getRegistration(
                String str, IGetRegistrationCallback iGetRegistrationCallback) {
            int callingUidOrThrow = Binder.getCallingUidOrThrow();
            long clearCallingIdentity = Binder.clearCallingIdentity();
