        ...
        new IAttestationVerificationManagerService
          ...
          public void verifyAttestation(
            ...
            try {
              ...
              AttestationVerificationManagerService.this.verifyAttestationForAllVerifiers(
                  attestationProfile, i, bundle, bArr, androidFuture);
            } catch (Throwable th) {
          ...
          public final void enforceUsePermission() {
            AttestationVerificationManagerService.this
                ...
                .enforceCallingOrSelfPermission(
                    "android.permission.USE_ATTESTATION_VERIFICATION_SERVICE", null);
          }
        };
    this.mPeerDeviceVerifier = new AttestationVerificationPeerDeviceVerifier(context);
  }

  public final void verifyAttestationForAllVerifiers(
      AttestationProfile attestationProfile,
      int i,
      Bundle bundle,
      byte[] bArr,
