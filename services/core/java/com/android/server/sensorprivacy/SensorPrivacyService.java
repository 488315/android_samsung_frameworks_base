...
public final class SensorPrivacyService extends SystemService {
  ...
  public void onUserSwitching(
    ...
    this.mSensorPrivacyServiceImpl.userSwitching(
        targetUser.getUserIdentifier(), targetUser2.getUserIdentifier());
  }
  ...
  public class SensorPrivacyServiceImpl extends ISensorPrivacyManager.Stub
    ...
    public class SensorUseReminderDialogInfo {
      ...
      public boolean equals(Object obj) {
        ...
        return this.mTaskId == sensorUseReminderDialogInfo.mTaskId
            ...
            && Objects.equals(this.mPackageName, sensorUseReminderDialogInfo.mPackageName);
      }
    ...
    public SensorPrivacyServiceImpl() {
      final SensorPrivacyHandler sensorPrivacyHandler =
          SensorPrivacyService.this
          .new SensorPrivacyHandler(FgThread.get().getLooper(), SensorPrivacyService.this.mContext);
      ...
      SensorPrivacyService.this.mContext.registerReceiver(
          new BroadcastReceiver() { // from class:
            ...
            public void onReceive(Context context, Intent intent) {
              SensorPrivacyServiceImpl.this.setToggleSensorPrivacy(
                  ((UserHandle)
                          intent.getParcelableExtra("android.intent.extra.USER", UserHandle.class))
                      .getIdentifier(),
                  5,
          ...
          2);
      SensorPrivacyService.this.mContext.registerReceiver(
          new C25072(SensorPrivacyService.this),
      ...
      sensorPrivacyStateController.setAllSensorPrivacyListener(
          sensorPrivacyHandler,
          new SensorPrivacyStateController
              .AllSensorPrivacyListener() { // from class:
      ...
      this.mSensorPrivacyStateController.setSensorPrivacyListener(
          sensorPrivacyHandler,
          new SensorPrivacyStateController
              .SensorPrivacyListener() { // from class:
                                         // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$$ExternalSyntheticLambda1
            ...
            public final void onSensorPrivacyChanged(
                int i, int i2, int i3, SensorState sensorState) {
              SensorPrivacyService.SensorPrivacyServiceImpl.this.lambda$new$0(
                  i, i2, i3, sensorState);
            }
          });
    }
    ...
    public class C25072 extends BroadcastReceiver {
      public final /* synthetic */ SensorPrivacyService val$this$0;

      public C25072(SensorPrivacyService sensorPrivacyService) {
        this.val$this$0 = sensorPrivacyService;
      }

      @Override // android.content.BroadcastReceiver
      public void onReceive(Context context, Intent intent) {
        SensorPrivacyServiceImpl.this.mSensorPrivacyStateController.forEachState(
            new SensorPrivacyStateController
                .SensorPrivacyStateConsumer() { // from class:
                                                // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$2$$ExternalSyntheticLambda0
              ...
              public final void accept(int i, int i2, int i3, SensorState sensorState) {
                SensorPrivacyService.SensorPrivacyServiceImpl.C25072.this.lambda$onReceive$0(
                    i, i2, i3, sensorState);
              }
            });
        SensorPrivacyServiceImpl.this.removeSensorUseReminderNotification(
            intent.getIntExtra(SensorPrivacyManager.EXTRA_SENSOR, 0));
      }
      ...
      public /* synthetic */ void lambda$onReceive$0(
          int i, int i2, int i3, SensorState sensorState) {
        SensorPrivacyServiceImpl.this.logSensorPrivacyToggle(
            5, i3, sensorState.isEnabled(), sensorState.getLastChange(), true);
      }
    }
    ...
    public final void correctStateIfNeeded() {
      this.mSensorPrivacyStateController.forEachState(
          new SensorPrivacyStateController
              .SensorPrivacyStateConsumer() { // from class:
                                              // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$$ExternalSyntheticLambda7
            @Override // com.android.server.sensorprivacy.SensorPrivacyStateController.SensorPrivacyStateConsumer
            public final void accept(int i, int i2, int i3, SensorState sensorState) {
              SensorPrivacyService.SensorPrivacyServiceImpl.this.lambda$correctStateIfNeeded$1(
                  i, i2, i3, sensorState);
            }
          });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$correctStateIfNeeded$1(
        int i, int i2, int i3, SensorState sensorState) {
        ...
        synchronized (this.mLock) {
          ...
          for (int i3 = 0; i3 < size; i3++) {
            ...
            if (runningTaskInfo.isVisible) {
              if (runningTaskInfo.topActivity.getPackageName().equals(str)) {
                if (!SensorPrivacyService.this.mIsLargeCoverScreen
                    && SensorPrivacyService.this.mIsFlipModel
                  ...
                  Log.d(
                      SensorPrivacyService.TAG,
                      "popup will not be displayed at view cover display : " + runningTaskInfo);
                } else {
                  ...
                  arrayList.add(runningTaskInfo);
                      ...
                      .equals(
                          getSensorUseActivityName(
                              new ArraySet(Arrays.asList(Integer.valueOf(i2)))))
          ...
          if (arrayList.size() == 1) {
            enqueueSensorUseReminderDialogAsync(
                ((ActivityManager.RunningTaskInfo) arrayList.get(0)).taskId, of, str, i2);
            return;
          }
          if (arrayList.size() > 1) {
          ...
          if (i2 == 1
              ...
              && SensorPrivacyService.this.mKeyguardManager != null
              && SensorPrivacyService.this.mKeyguardManager.isKeyguardLocked()) {
                          ...
                          SensorPrivacyService.this
                              ...
                              .getString(
                                  ...
                                  SensorPrivacyService.this
                                      ...
                                      .loadLabel(
                                          SensorPrivacyService.this.mContext.getPackageManager())),
                          0),
                      0)
                  .show();
          ...
          List<ActivityManager.RunningServiceInfo> runningServices =
              SensorPrivacyService.this.mActivityManager.getRunningServices(Integer.MAX_VALUE);
          ...
          String packageName =
              stringForUser != null
                  ? ComponentName.unflattenFromString(stringForUser).getPackageName()
                  : null;
          try {
            int uidCapability =
                SensorPrivacyService.this.mActivityManagerInternal.getUidCapability(i);
            if (i2 == 1) {
              ...
              if (TextUtils.equals(str, packageName) && (uidCapability & 4) != 0) {
                ...
                return;
                  ...
                  && SensorPrivacyService.this.mIsLargeCoverScreen
                  && SensorPrivacyService.this.mIsFlipModel
                  && SensorPrivacyService.this.mIsFolded) {
                enqueueSensorUseReminderDialogAsync(-1, of, str, i2);
                return;
              }
            }
    ...
    public final void enqueueSensorUseReminderDialogAsync(
        int i, UserHandle userHandle, String str, int i2) {
      this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new QuintConsumer() { // from class:
                                    // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$$ExternalSyntheticLambda6
    ...
    public final void enqueueSensorUseReminderDialog(
        int i, UserHandle userHandle, String str, int i2) {
      SensorUseReminderDialogInfo sensorUseReminderDialogInfo =
          new SensorUseReminderDialogInfo(i, userHandle, str);
      if (!this.mQueuedSensorUseReminderDialogs.containsKey(sensorUseReminderDialogInfo)) {
        ArraySet arraySet = new ArraySet();
        if ((i2 == 1 && this.mSuppressReminders.containsKey(new Pair(2, userHandle)))
            || (i2 == 2 && this.mSuppressReminders.containsKey(new Pair(1, userHandle)))) {
          arraySet.add(1);
          arraySet.add(2);
        } else {
      ...
      ((ArraySet) this.mQueuedSensorUseReminderDialogs.get(sensorUseReminderDialogInfo))
          .add(Integer.valueOf(i2));
    }

    public final void showSensorUserReminderDialog(
        SensorUseReminderDialogInfo sensorUseReminderDialogInfo) {
      Slog.d(
          SensorPrivacyService.TAG,
          "showSensorUserReminderDialog  taskId="
              + sensorUseReminderDialogInfo.mTaskId
              + "  mIsFolded="
              + SensorPrivacyService.this.mIsFolded
              + "  "
              + sensorUseReminderDialogInfo.mPackageName);
      ArraySet arraySet =
          (ArraySet) this.mQueuedSensorUseReminderDialogs.get(sensorUseReminderDialogInfo);
      ...
      if (arraySet == null) {
        Log.e(
            SensorPrivacyService.TAG,
            "Unable to show sensor use dialog because sensor set is null. Was the dialog queue"
                + " modified from outside the handler thread?");
        return;
      }
      ...
      intent.putExtra(
          "android.intent.extra.PACKAGE_NAME", sensorUseReminderDialogInfo.mPackageName);
      if (arraySet.size() == 1) {
        ...
        Log.e(
            SensorPrivacyService.TAG,
            "Attempted to show sensor use dialog for " + arraySet.size() + " sensors");
        return;
      }
    ...
    public final int getDisplayIdWhenNoTask() {
      return (SensorPrivacyService.this.mIsFolded && SensorPrivacyService.this.mIsLargeCoverScreen)
          ? 1
          : 0;
    }
      ...
      while (it.hasNext()) {
        if (isToggleSensorPrivacyEnabled(2, ((Integer) it.next()).intValue())) {
          return SensorPrivacyService.this
              .mContext
              .getResources()
              .getString(R.string.ext_media_move_success_message);
        }
      }
      return SensorPrivacyService.this
          .mContext
    ...
    public final void showSensorUseReminderNotification(UserHandle userHandle, String str, int i) {
      ...
      try {
        ...
        if (i == 1) {
          i2 = R.drawable.ic_menu_redo_material;
          i3 = 17042772;
          i4 = 17042574;
          i5 = 65;
        } else {
          i2 = R.drawable.ic_bt_laptop;
          i3 = 17042770;
          i4 = 17042573;
          i5 = 66;
        }
        NotificationManager notificationManager =
            (NotificationManager)
                SensorPrivacyService.this.mContext.getSystemService(NotificationManager.class);
        NotificationChannel notificationChannel =
            new NotificationChannel(
                "sensor_privacy", SensorPrivacyService.this.getUiContext().getString(17042769), 4);
        ...
        Icon createWithResource =
            Icon.createWithResource(SensorPrivacyService.this.getUiContext().getResources(), i2);
        notificationManager.notify(
            i5,
            new Notification.Builder(SensorPrivacyService.this.mContext, "sensor_privacy")
                .setContentTitle(SensorPrivacyService.this.getUiContext().getString(i3))
                .setContentText(
                    Html.fromHtml(
                        SensorPrivacyService.this.getUiContext().getString(i4, loadLabel), 0))
                .setSmallIcon(createWithResource)
                .addAction(
                    new Notification.Action.Builder(
                            createWithResource,
                            SensorPrivacyService.this.getUiContext().getString(17042771),
                            PendingIntent.getBroadcast(
                                SensorPrivacyService.this.mContext,
                                i,
                                new Intent(
                                        SensorPrivacyService.ACTION_DISABLE_TOGGLE_SENSOR_PRIVACY)
                                    .setPackage(SensorPrivacyService.this.mContext.getPackageName())
                                    .putExtra(SensorPrivacyManager.EXTRA_SENSOR, i)
                                    .putExtra("android.intent.extra.USER", userHandle),
                                201326592))
                        .build())
                .setContentIntent(
                    PendingIntent.getActivity(
                        SensorPrivacyService.this.mContext,
                        i,
                        new Intent("android.settings.PRIVACY_SETTINGS"),
                        201326592))
                .extend(new Notification.TvExtender())
                .setTimeoutAfter(isTelevision(SensorPrivacyService.this.mContext) ? 1L : 0L)
                .setAutoCancel(true)
                .build());
      } catch (PackageManager.NameNotFoundException unused) {
    ...
    public final void showSensorStateChangedActivity(int i, int i2) {
      String string =
          SensorPrivacyService.this
              .mContext
              .getResources()
              .getString(R.string.ext_media_move_failure_title);
          ...
          new Runnable() { // from class:
            ...
            public final void run() {
              SensorPrivacyService.SensorPrivacyServiceImpl.this
                  .lambda$setToggleSensorPrivacyUnchecked$3(i, i2, i4, jArr, z, i3);
            }
          });
      if (z) {
        return;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setToggleSensorPrivacyUnchecked$3(
        int i, final int i2, final int i3, final long[] jArr, final boolean z, final int i4) {
      jArr[0] = this.mSensorPrivacyStateController.getState(i, i2, i3).getLastChange();
      this.mSensorPrivacyStateController.setState(
          i,
          i2,
          i3,
          z,
          this.mHandler,
          new SensorPrivacyStateController
              .SetStateResultCallback() { // from class:
                                          // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$$ExternalSyntheticLambda11
            @Override // com.android.server.sensorprivacy.SensorPrivacyStateController.SetStateResultCallback
            public final void callback(boolean z2) {
              SensorPrivacyService.SensorPrivacyServiceImpl.this
                  .lambda$setToggleSensorPrivacyUnchecked$2(i2, i4, i3, z, jArr, z2);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setToggleSensorPrivacyUnchecked$2(
        int i, int i2, int i3, boolean z, long[] jArr, boolean z2) {
      if (z2 && i == SensorPrivacyService.this.mUserManagerInternal.getProfileParentId(i)) {
        this.mHandler.sendMessage(
            PooledLambda.obtainMessage(
                new HexConsumer() { // from class:
                                    // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$$ExternalSyntheticLambda12
                  public final void accept(
                      Object obj, Object obj2, Object obj3, Object obj4, Object obj5, Object obj6) {
                    ((SensorPrivacyService.SensorPrivacyServiceImpl) obj)
                        .logSensorPrivacyToggle(
                            ((Integer) obj2).intValue(),
    ...
    public final boolean canChangeToggleSensorPrivacy(int i, int i2) {
      ...
      if (requiresAuthentication()
          && SensorPrivacyService.this.mKeyguardManager != null
          && SensorPrivacyService.this.mKeyguardManager.isDeviceLocked(i)) {
    ...
    public void setToggleSensorPrivacyForProfileGroup(
        int i, final int i2, final int i3, final boolean z) {
      enforceManageSensorPrivacyPermission();
      if (i == -2) {
        i = SensorPrivacyService.this.mCurrentUser;
      }
      ...
      SensorPrivacyService.this.forAllUsers(
          new FunctionalUtils
              .ThrowingConsumer() { // from class:
                                    // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$$ExternalSyntheticLambda2
            public final void acceptOrThrow(Object obj) {
              SensorPrivacyService.SensorPrivacyServiceImpl.this
                  .lambda$setToggleSensorPrivacyForProfileGroup$4(
                      profileParentId, i2, i3, z, (Integer) obj);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setToggleSensorPrivacyForProfileGroup$4(
        int i, int i2, int i3, boolean z, Integer num) {
    ...
    public void setToggleSensorPrivacyForProfileGroupWithConfirmPopup(
        ...
        this.mHandler.sendMessage(
            PooledLambda.obtainMessage(
                new TriConsumer() { // from class:
                                    // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$$ExternalSyntheticLambda3
                  public final void accept(Object obj, Object obj2, Object obj3) {
                    SensorPrivacyService.SensorPrivacyServiceImpl.this.showConfirmDialog(
      ...
      SensorPrivacyService.this.forAllUsers(
          new FunctionalUtils
            ...
            public final void acceptOrThrow(Object obj) {
              SensorPrivacyService.SensorPrivacyServiceImpl.this
                  .lambda$setToggleSensorPrivacyForProfileGroupWithConfirmPopup$5(
                      profileParentId, i2, i3, z, (Integer) obj);
            }
          });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setToggleSensorPrivacyForProfileGroupWithConfirmPopup$5(
        int i, int i2, int i3, boolean z, Integer num) {
      if (i == SensorPrivacyService.this.mUserManagerInternal.getProfileParentId(num.intValue())) {
        setToggleSensorPrivacy(num.intValue(), i2, i3, z);
      }
    ...
    public final void showConfirmDialog(int i, int i2, int i3) {
      ...
      AlertDialog create =
          new AlertDialog.Builder(
              ...
              .setTitle(str)
              .setMessage(str2)
              .setPositiveButton(17043043, new DialogInterfaceOnClickListenerC25094(i, i2, i3))
              .setNegativeButton(
                  R.string.cancel,
                  new DialogInterface
                      .OnClickListener() { // from class:
                                           // com.android.server.sensorprivacy.SensorPrivacyService.SensorPrivacyServiceImpl.3
    ...
    /* renamed from: com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$4 */
    public class DialogInterfaceOnClickListenerC25094 implements DialogInterface.OnClickListener {
      public final /* synthetic */ int val$sensor;
      public final /* synthetic */ int val$source;
      public final /* synthetic */ int val$userId;

      public DialogInterfaceOnClickListenerC25094(int i, int i2, int i3) {
        this.val$userId = i;
        this.val$source = i2;
        this.val$sensor = i3;
      }
      ...
      public void onClick(DialogInterface dialogInterface, int i) {
        ...
        sensorPrivacyService.forAllUsers(
            new FunctionalUtils
                .ThrowingConsumer() { // from class:
                                      // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$4$$ExternalSyntheticLambda0
              public final void acceptOrThrow(Object obj) {
                SensorPrivacyService.SensorPrivacyServiceImpl.DialogInterfaceOnClickListenerC25094
                    .this
                    .lambda$onClick$0(profileParentId, i3, i4, (Integer) obj);
              }
            });
      }
      ...
      public /* synthetic */ void lambda$onClick$0(int i, int i2, int i3, Integer num) {
        if (i
            == SensorPrivacyService.this.mUserManagerInternal.getProfileParentId(num.intValue())) {
      ...
      if (UserHandle.getCallingAppId()
          == UserHandle.getAppId(
              SensorPrivacyService.this.mPackageManagerInternal.getPackageUid(
                  SensorPrivacyService.this.mContext.getString(R.string.config_systemUi),
                  1048576L,
                  0))) {
        return;
      }
      ...
      if (i == 1) {
        ...
        if (i2 == 1) {
          return SensorPrivacyService.this
              .mContext
              .getResources()
              .getBoolean(R.bool.config_showUserSwitcherByDefault);
        }
        if (i2 == 2) {
          return SensorPrivacyService.this
              .mContext
              .getResources()
              .getBoolean(R.bool.config_showSysuiShutdown);
        }
      }
    ...
    public void showSensorUseDialog(int i) {
      ...
      if (isCombinedToggleSensorPrivacyEnabled(i)) {
        Slog.d(
            SensorPrivacyService.TAG,
            "showSensorUseDialog  sensor=" + i + "  pid=" + Binder.getCallingPid());
        enqueueSensorUseReminderDialogAsync(
            -1, UserHandle.of(SensorPrivacyService.this.mCurrentUser), "android", i);
      }
    }
    ...
    public final void userSwitching(final int i, final int i2) {
      ...
      this.mSensorPrivacyStateController.atomic(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              SensorPrivacyService.SensorPrivacyServiceImpl.this.lambda$userSwitching$6(
                  zArr3, i, zArr4, zArr, i2, zArr2);
            }
          });
      this.mSensorPrivacyStateController.atomic(
          new Runnable() { // from class:
                           // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyServiceImpl$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
              SensorPrivacyService.SensorPrivacyServiceImpl.this.lambda$userSwitching$7(
                  zArr3, i, zArr4, zArr, i2, zArr2);
            }
          });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$userSwitching$6(
        boolean[] zArr, int i, boolean[] zArr2, boolean[] zArr3, int i2, boolean[] zArr4) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$userSwitching$7(
        boolean[] zArr, int i, boolean[] zArr2, boolean[] zArr3, int i2, boolean[] zArr4) {
    ...
    public final void setGlobalRestriction(int i, boolean z) {
      if (i != 1) {
        ...
        SensorPrivacyService.this.mAppOpsManagerInternal.setGlobalRestriction(
            26, z, SensorPrivacyService.this.mAppOpsRestrictionToken);
        SensorPrivacyService.this.mAppOpsManagerInternal.setGlobalRestriction(
            101, z, SensorPrivacyService.this.mAppOpsRestrictionToken);
        return;
      }
      SensorPrivacyService.this.mAppOpsManagerInternal.setGlobalRestriction(
          27, z, SensorPrivacyService.this.mAppOpsRestrictionToken);
      SensorPrivacyService.this.mAppOpsManagerInternal.setGlobalRestriction(
          100, z, SensorPrivacyService.this.mAppOpsRestrictionToken);
      SensorPrivacyService.this.mAppOpsManagerInternal.setGlobalRestriction(
          120, z, SensorPrivacyService.this.mAppOpsRestrictionToken);
      SensorPrivacyService.this.mAppOpsManagerInternal.setGlobalRestriction(
          121,
          z
              && !(Settings.Global.getInt(
                      ...
                      1)
                  == 1),
          SensorPrivacyService.this.mAppOpsRestrictionToken);
    }
    ...
    public final void registerSettingsObserver() {
      SensorPrivacyService.this
          ...
          .registerContentObserver(
              Settings.Global.getUriFor("receive_explicit_user_interaction_audio_enabled"),
              false,
              new ContentObserver(
                  this
                      .mHandler) { // from class:
                ...
                public void onChange(boolean z) {
                  ...
                  sensorPrivacyServiceImpl.setGlobalRestriction(
                      1, sensorPrivacyServiceImpl.isCombinedToggleSensorPrivacyEnabled(1));
                }
              });
    }
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      ...
      if (DumpUtils.checkDumpPermission(
          SensorPrivacyService.this.mContext, SensorPrivacyService.TAG, printWriter)) {
        int i = 0;
        boolean z = false;
        ...
        try {
          if (z) {
            this.mSensorPrivacyStateController.dump(
      ...
      new ShellCommand() { // from class:
        ...
        public int onCommand(String str) {
          ...
          if (str.equals("enable")) {
            ...
            SensorPrivacyServiceImpl.this.setToggleSensorPrivacy(
                parseInt, 4, sensorStrToId2, false);
          } else {
            return handleDefaultCommands(str);
          }
          return 0;
  ...
  public final class SensorPrivacyHandler extends Handler {
    ...
    public void handleSensorPrivacyChanged(boolean z) {
      ...
      for (int i = 0; i < beginBroadcast; i++) {
        ...
        try {
          ...
          Log.e(
              SensorPrivacyService.TAG,
              "Caught an exception notifying listener " + broadcastItem + ": ",
              e);
        }
      }
    ...
    public void handleSensorPrivacyChanged(int i, int i2, int i3, boolean z) {
      ...
      if (i == SensorPrivacyService.this.mCurrentUser) {
        SensorPrivacyService.this.mSensorPrivacyServiceImpl.setGlobalRestriction(
            i3,
            SensorPrivacyService.this.mSensorPrivacyServiceImpl
                .isCombinedToggleSensorPrivacyEnabled(i3));
      }
      if (i != SensorPrivacyService.this.mCurrentUser) {
        return;
      }
    ...
    public void removeSuppressPackageReminderToken(Pair pair, IBinder iBinder) {
      sendMessage(
          PooledLambda.obtainMessage(
              new TriConsumer() { // from class:
                                  // com.android.server.sensorprivacy.SensorPrivacyService$SensorPrivacyHandler$$ExternalSyntheticLambda0
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((SensorPrivacyService.SensorPrivacyServiceImpl) obj)
  ...
  public class SensorPrivacyManagerInternalImpl extends SensorPrivacyManagerInternal {
    ...
    public boolean isSensorPrivacyEnabled(int i, int i2) {
      return SensorPrivacyService.this.mSensorPrivacyServiceImpl
          .isToggleSensorPrivacyEnabledInternal(i, 1, i2);
    }
    ...
    public void addSensorPrivacyListenerForAllUsers(
        int i,
        SensorPrivacyManagerInternal.OnUserSensorPrivacyChangedListener
            onUserSensorPrivacyChangedListener) {
      synchronized (this.mLock) {
  ...
  public class CallStateHelper {
    ...
    public OutgoingEmergencyStateCallback mEmergencyStateCallback =
    ...
    public CallStateHelper() {
      SensorPrivacyService.this.mTelephonyManager.registerTelephonyCallback(
          FgThread.getExecutor(), this.mEmergencyStateCallback);
      SensorPrivacyService.this.mTelephonyManager.registerTelephonyCallback(
          FgThread.getExecutor(), this.mCallStateCallback);
    ...
    public class OutgoingEmergencyStateCallback extends TelephonyCallback
    ...
    public class CallStateCallback extends TelephonyCallback
      ...
      public void onCallStateChanged(int i) {
        ...
        if (SensorPrivacyService.this.mSensorPrivacyServiceImpl.isToggleSensorPrivacyEnabled(
            1, 1)) {
    ...
    public final void onEmergencyCall() {
      synchronized (this.mCallStateLock) {
        if (!this.mIsInEmergencyCall) {
          ...
          if (SensorPrivacyService.this.mSensorPrivacyServiceImpl.isToggleSensorPrivacyEnabled(
              1, 1)) {
            SensorPrivacyService.this.mSensorPrivacyServiceImpl.setToggleSensorPrivacyUnchecked(
                1, SensorPrivacyService.this.mCurrentUser, 5, 1, false);
            this.mMicUnmutedForEmergencyCall = true;
          } else {
            this.mMicUnmutedForEmergencyCall = false;
          }
          if (SensorPrivacyService.this.mSensorPrivacyServiceImpl.isToggleSensorPrivacyEnabled(
              SensorPrivacyService.this.mCurrentUser, 2)) {
            SensorPrivacyService.this.mSensorPrivacyServiceImpl.setToggleSensorPrivacyUnchecked(
                1, SensorPrivacyService.this.mCurrentUser, 5, 2, false);
      ...
      synchronized (this.mCallStateLock) {
        if (this.mIsInEmergencyCall) {
          ...
          if (this.mMicUnmutedForEmergencyCall) {
            SensorPrivacyService.this.mSensorPrivacyServiceImpl.setToggleSensorPrivacyUnchecked(
                1, SensorPrivacyService.this.mCurrentUser, 5, 1, true);
            this.mMicUnmutedForEmergencyCall = false;
          }
          if (this.mCameraBlockedForEmergencyCall) {
            SensorPrivacyService.this.mSensorPrivacyServiceImpl.setToggleSensorPrivacyUnchecked(
                1, SensorPrivacyService.this.mCurrentUser, 5, 2, true);
            this.mCameraBlockedForEmergencyCall = false;
          }
        }
      }
    ...
    public final void readGuideString(final int i) {
      this.mHandler.postDelayed(
          new Runnable() { // from class:
                           // com.android.server.sensorprivacy.SensorPrivacyService.CallStateHelper.2
            @Override // java.lang.Runnable
            public void run() {
              Locale defaultLanguage = CallStateHelper.this.mTts.getDefaultLanguage();
              Locale locale = Locale.ENGLISH;
              Locale normalizeTTSLocale =
                  defaultLanguage != null ? TtsEngines.normalizeTTSLocale(defaultLanguage) : locale;
              int language = CallStateHelper.this.mTts.setLanguage(normalizeTTSLocale);
              Log.d(
                  SensorPrivacyService.TAG,
                  "readGuideString ttsLanguage="
                      + normalizeTTSLocale
                      + " result="
                      + language
                      + " callState= "
              ...
              String localeStringResource =
                  callStateHelper.getLocaleStringResource(
                      locale, 17042572, SensorPrivacyService.this.mContext);
              int i2 = i;
