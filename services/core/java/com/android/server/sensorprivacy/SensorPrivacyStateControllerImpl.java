...
public class SensorPrivacyStateControllerImpl extends SensorPrivacyStateController {
  ...
  public void setStateLocked(
      ...
      boolean z,
      Handler handler,
      SensorPrivacyStateController.SetStateResultCallback setStateResultCallback) {
    SensorState state = this.mPersistedState.getState(i, i2, i3);
    if (state == null) {
      if (!z) {
      ...
      handler.sendMessage(
          PooledLambda.obtainMessage(
              new QuintConsumer() { // from class:
                                    // com.android.server.sensorprivacy.SensorPrivacyStateControllerImpl$$ExternalSyntheticLambda1
                public final void accept(
                    Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                  ((SensorPrivacyStateController.SensorPrivacyListener) obj)
  ...
  @Override // com.android.server.sensorprivacy.SensorPrivacyStateController
  public void setSensorPrivacyListenerLocked(
      Handler handler, SensorPrivacyStateController.SensorPrivacyListener sensorPrivacyListener) {
  ...
  @Override // com.android.server.sensorprivacy.SensorPrivacyStateController
  public void forEachStateLocked(
      final SensorPrivacyStateController.SensorPrivacyStateConsumer sensorPrivacyStateConsumer) {
    PersistedState persistedState = this.mPersistedState;
    Objects.requireNonNull(sensorPrivacyStateConsumer);
    persistedState.forEachKnownState(
        new QuadConsumer() { // from class:
                             // com.android.server.sensorprivacy.SensorPrivacyStateControllerImpl$$ExternalSyntheticLambda0
          public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
            SensorPrivacyStateController.SensorPrivacyStateConsumer.this.accept(
