  ...
  */
  public AllSensorStateController() {
    AtomicFile atomicFile =
        new AtomicFile(new File(Environment.getDataSystemDirectory(), "sensor_privacy.xml"));
      ...
      try {
        ...
        try {
          ...
          while (true) {
            ...
            if ("user".equals(name)
                && XmlUtils.readIntAttribute(resolvePullParser, "id", -1) == 0) {
  ...
  public void setAllSensorStateLocked(boolean z) {
    ...
    if (this.mEnabled != z) {
      this.mEnabled = z;
      final SensorPrivacyStateController.AllSensorPrivacyListener allSensorPrivacyListener =
          this.mListener;
      ...
      handler.sendMessage(
          PooledLambda.obtainMessage(
              new Consumer() { // from class:
                               // com.android.server.sensorprivacy.AllSensorStateController$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  SensorPrivacyStateController.AllSensorPrivacyListener.this
                      .onAllSensorPrivacyChanged(((Boolean) obj).booleanValue());
                }
              },
              Boolean.valueOf(z)));
    }
  ...
  public void setAllSensorPrivacyListenerLocked(
      Handler handler,
      SensorPrivacyStateController.AllSensorPrivacyListener allSensorPrivacyListener) {
  ...
  public void schedulePersistLocked() {
    IoThread.getHandler()
        .sendMessage(
            PooledLambda.obtainMessage(
                new Consumer() { // from class:
                                 // com.android.server.sensorprivacy.AllSensorStateController$$ExternalSyntheticLambda0
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
