...
public final class SpeechRecognitionManagerServiceImpl extends AbstractPerUserSystemService {
  ...
  public SpeechRecognitionManagerServiceImpl(
      SpeechRecognitionManagerService speechRecognitionManagerService, Object obj, int i) {
  ...
  public void createSessionLocked(
      ComponentName componentName,
      final IBinder iBinder,
      boolean z,
      final IRecognitionServiceManagerCallback iRecognitionServiceManagerCallback) {
    if (((SpeechRecognitionManagerService) this.mMaster).debug) {
      Slog.i(
          TAG,
          String.format(
              "#createSessionLocked, component=%s, onDevice=%s",
              componentName, Boolean.valueOf(z)));
    }
    if (z) {
    ...
    final IBinder.DeathRecipient deathRecipient =
        new IBinder
            .DeathRecipient() { // from class:
                                // com.android.server.speech.SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda0
          @Override // android.os.IBinder.DeathRecipient
          public final void binderDied() {
            SpeechRecognitionManagerServiceImpl.this.lambda$createSessionLocked$0(
                iBinder, callingUid, createService);
          }
        };
    try {
      ...
      createService
          ...
          .thenAccept(
              new Consumer() { // from class:
                               // com.android.server.speech.SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  SpeechRecognitionManagerServiceImpl.this.lambda$createSessionLocked$1(
  ...
  public /* synthetic */ void lambda$createSessionLocked$0(
      IBinder iBinder, int i, RemoteSpeechRecognitionService remoteSpeechRecognitionService) {
    handleClientDeath(iBinder, i, remoteSpeechRecognitionService, true);
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$createSessionLocked$1(
    ...
    if (iRecognitionService != null) {
      try {
        iRecognitionServiceManagerCallback.onSuccess(
            new IRecognitionService
                .Stub() { // from class:
                          // com.android.server.speech.SpeechRecognitionManagerServiceImpl.1
              public void startListening(
                  Intent intent,
                  IRecognitionListener iRecognitionListener,
                  AttributionSource attributionSource) {
                attributionSource.enforceCallingUid();
                if (!attributionSource.isTrusted(
                    ((SpeechRecognitionManagerService)
                            SpeechRecognitionManagerServiceImpl.this.mMaster)
                        .getContext())) {
                  attributionSource =
                      ((PermissionManager)
                              ((SpeechRecognitionManagerService)
                ...
                remoteSpeechRecognitionService.startListening(
                    intent, iRecognitionListener, attributionSource);
                remoteSpeechRecognitionService.associateClientWithActiveListener(
                    iBinder, iRecognitionListener);
              }
              ...
              public void cancel(IRecognitionListener iRecognitionListener, boolean z) {
                ...
                if (z) {
                  SpeechRecognitionManagerServiceImpl.this.handleClientDeath(
                      iBinder, i, remoteSpeechRecognitionService, false);
              ...
              public void checkRecognitionSupport(
                ...
                remoteSpeechRecognitionService.checkRecognitionSupport(
                    intent, attributionSource, iRecognitionSupportCallback);
              }
              ...
              public void triggerModelDownload(
                ...
                remoteSpeechRecognitionService.triggerModelDownload(
                    intent, attributionSource, iModelDownloadListener);
              }
            });
        return;
  ...
  public final void handleClientDeath(
      IBinder iBinder,
      int i,
      RemoteSpeechRecognitionService remoteSpeechRecognitionService,
      boolean z) {
    if (z) {
  ...
  public final RemoteSpeechRecognitionService createService(
      int i, final ComponentName componentName) {
    synchronized (this.mLock) {
            ...
            set.stream()
                .filter(
                    new Predicate() { // from class:
                                      // com.android.server.speech.SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda2
                      @Override // java.util.function.Predicate
                      public final boolean test(Object obj) {
                        boolean lambda$createService$2;
                        lambda$createService$2 =
                            SpeechRecognitionManagerServiceImpl.lambda$createService$2(
                                componentName, (RemoteSpeechRecognitionService) obj);
      ...
      RemoteSpeechRecognitionService remoteSpeechRecognitionService =
          new RemoteSpeechRecognitionService(getContext(), componentName, getUserId(), i);
      ((Set)
              this.mRemoteServicesByUid.computeIfAbsent(
                  Integer.valueOf(i),
                  new Function() { // from class:
                                   // com.android.server.speech.SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda3
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                      Set lambda$createService$3;
                      lambda$createService$3 =
                          SpeechRecognitionManagerServiceImpl.lambda$createService$3((Integer) obj);
  ...
  public static /* synthetic */ boolean lambda$createService$2(
      ComponentName componentName, RemoteSpeechRecognitionService remoteSpeechRecognitionService) {
      ...
      List queryIntentServicesAsUser =
          getContext()
              ...
              .queryIntentServicesAsUser(
                  new Intent("android.speech.RecognitionService"), 0, getUserId());
  ...
  public final void removeService(
      int i, RemoteSpeechRecognitionService remoteSpeechRecognitionService) {
    synchronized (this.mLock) {
      Set set = (Set) this.mRemoteServicesByUid.get(Integer.valueOf(i));
      if (set != null) {
  ...
  public static void tryRespondWithError(
      IRecognitionServiceManagerCallback iRecognitionServiceManagerCallback, int i) {
    try {
