...
public abstract class ConversionUtil {
  ...
  public static Properties hidl2aidlProperties(
    ...
    hidl2aidlProperties.audioCapabilities =
        hidl2aidlAudioCapabilities(properties.audioCapabilities);
  ...
  public static String hidl2aidlUuid(Uuid uuid) {
    ...
    return String.format(
        ...
        Integer.valueOf(uuid.timeLow),
        Short.valueOf(uuid.timeMid),
        Short.valueOf(uuid.versionAndTimeHigh),
        Short.valueOf(uuid.variantAndClockSeqHigh),
        Byte.valueOf(uuid.node[0]),
        Byte.valueOf(uuid.node[1]),
        Byte.valueOf(uuid.node[2]),
        Byte.valueOf(uuid.node[3]),
        Byte.valueOf(uuid.node[4]),
        Byte.valueOf(uuid.node[5]));
  }
  ...
  public static Uuid aidl2hidlUuid(String str) {
    ...
    uuid.node =
        new byte[] {
          (byte) Integer.parseUnsignedInt(matcher.group(5), 16),
  ...
  public static ISoundTriggerHw.PhraseSoundModel aidl2hidlPhraseSoundModel(
  ...
  public static RecognitionConfig aidl2hidlRecognitionConfig(
      android.media.soundtrigger.RecognitionConfig recognitionConfig, int i, int i2) {
    ...
    for (PhraseRecognitionExtra phraseRecognitionExtra :
      ...
      recognitionConfig2.base.header.phrases.add(
          aidl2hidlPhraseRecognitionExtra(phraseRecognitionExtra));
    }
    recognitionConfig2.base.data =
        HidlMemoryUtil.byteArrayToHidlMemory(
            recognitionConfig.data, "SoundTrigger RecognitionConfig");
    recognitionConfig2.audioCapabilities = recognitionConfig.audioCapabilities;
    return recognitionConfig2;
  }

  public static android.hardware.soundtrigger.V2_0.PhraseRecognitionExtra
      aidl2hidlPhraseRecognitionExtra(PhraseRecognitionExtra phraseRecognitionExtra) {
    android.hardware.soundtrigger.V2_0.PhraseRecognitionExtra phraseRecognitionExtra2 =
        new android.hardware.soundtrigger.V2_0.PhraseRecognitionExtra();
    phraseRecognitionExtra2.f13id = phraseRecognitionExtra.id;
    phraseRecognitionExtra2.recognitionModes =
        aidl2hidlRecognitionModes(phraseRecognitionExtra.recognitionModes);
  ...
  public static PhraseRecognitionExtra hidl2aidlPhraseRecognitionExtra(
      android.hardware.soundtrigger.V2_0.PhraseRecognitionExtra phraseRecognitionExtra) {
    ...
    phraseRecognitionExtra2.recognitionModes =
        hidl2aidlRecognitionModes(phraseRecognitionExtra.recognitionModes);
    phraseRecognitionExtra2.confidenceLevel = phraseRecognitionExtra.confidenceLevel;
    ...
    for (int i = 0; i < phraseRecognitionExtra.levels.size(); i++) {
      phraseRecognitionExtra2.levels[i] =
          hidl2aidlConfidenceLevel(
              (android.hardware.soundtrigger.V2_0.ConfidenceLevel)
                  phraseRecognitionExtra.levels.get(i));
    }
    return phraseRecognitionExtra2;
  }

  public static android.hardware.soundtrigger.V2_0.ConfidenceLevel aidl2hidlConfidenceLevel(
      ConfidenceLevel confidenceLevel) {
    android.hardware.soundtrigger.V2_0.ConfidenceLevel confidenceLevel2 =
  ...
  public static ConfidenceLevel hidl2aidlConfidenceLevel(
      android.hardware.soundtrigger.V2_0.ConfidenceLevel confidenceLevel) {
  ...
  public static RecognitionEvent hidl2aidlRecognitionEvent(
      ISoundTriggerHwCallback.RecognitionEvent recognitionEvent) {
  ...
  public static PhraseRecognitionEvent hidl2aidlPhraseRecognitionEvent(
    ...
    phraseRecognitionEvent2.phraseExtras =
        new PhraseRecognitionExtra[phraseRecognitionEvent.phraseExtras.size()];
    for (int i = 0; i < phraseRecognitionEvent.phraseExtras.size(); i++) {
      phraseRecognitionEvent2.phraseExtras[i] =
          hidl2aidlPhraseRecognitionExtra(
              (android.hardware.soundtrigger.V2_0.PhraseRecognitionExtra)
                  phraseRecognitionEvent.phraseExtras.get(i));
    }
    return phraseRecognitionEvent2;
  }

  public static AudioConfig hidl2aidlAudioConfig(
      android.hardware.audio.common.V2_0.AudioConfig audioConfig, boolean z) {
    AudioConfig audioConfig2 = new AudioConfig();
    audioConfig2.base =
        hidl2aidlAudioConfigBase(
            audioConfig.sampleRateHz, audioConfig.channelMask, audioConfig.format, z);
    audioConfig2.offloadInfo = hidl2aidlOffloadInfo(audioConfig.offloadInfo);
    audioConfig2.frameCount = audioConfig.frameCount;
    return audioConfig2;
  }

  public static AudioOffloadInfo hidl2aidlOffloadInfo(
      android.hardware.audio.common.V2_0.AudioOffloadInfo audioOffloadInfo) {
    AudioOffloadInfo audioOffloadInfo2 = new AudioOffloadInfo();
    audioOffloadInfo2.base =
        hidl2aidlAudioConfigBase(
            audioOffloadInfo.sampleRateHz,
            audioOffloadInfo.channelMask,
            audioOffloadInfo.format,
            false);
    audioOffloadInfo2.streamType =
        AidlConversion.legacy2aidl_audio_stream_type_t_AudioStreamType(audioOffloadInfo.streamType);
    ...
    audioOffloadInfo2.usage =
        AidlConversion.legacy2aidl_audio_usage_t_AudioUsage(audioOffloadInfo.usage);
  ...
  public static AudioConfigBase hidl2aidlAudioConfigBase(int i, int i2, int i3, boolean z) {
    ...
    audioConfigBase.channelMask =
        AidlConversion.legacy2aidl_audio_channel_mask_t_AudioChannelLayout(i2, z);
    audioConfigBase.format = AidlConversion.legacy2aidl_audio_format_t_AudioFormatDescription(i3);
    return audioConfigBase;
  }

  public static ModelParameterRange hidl2aidlModelParameterRange(
      android.hardware.soundtrigger.V2_3.ModelParameterRange modelParameterRange) {
  ...
  public static HidlMemory parcelFileDescriptorToHidlMemory(
