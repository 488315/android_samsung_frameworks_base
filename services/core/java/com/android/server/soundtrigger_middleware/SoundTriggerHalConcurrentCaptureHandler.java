...
public class SoundTriggerHalConcurrentCaptureHandler
  ...
  public SoundTriggerHalConcurrentCaptureHandler(
      ISoundTriggerHal iSoundTriggerHal, ICaptureStateNotifier iCaptureStateNotifier) {
  ...
  public final void abortAllActiveModels() {
    ...
    while (true) {
      ...
      final LoadedModel loadedModel =
          (LoadedModel) this.mLoadedModels.get(Integer.valueOf(intValue));
  ...
  public int loadPhraseSoundModel(
    ...
    int loadPhraseSoundModel =
        this.mDelegate.loadPhraseSoundModel(phraseSoundModel, new CallbackWrapper(modelCallback));
    this.mLoadedModels.put(
        Integer.valueOf(loadPhraseSoundModel), new LoadedModel(0, modelCallback));
  ...
  public /* synthetic */ void lambda$registerCallback$1(
      final ISoundTriggerHal.GlobalCallback globalCallback) {
    CallbackThread callbackThread = this.mCallbackThread;
    Objects.requireNonNull(globalCallback);
    callbackThread.push(
        new Runnable() { // from class:
          // com.android.server.soundtrigger_middleware.SoundTriggerHalConcurrentCaptureHandler$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void registerCallback(final ISoundTriggerHal.GlobalCallback globalCallback) {
    ISoundTriggerHal.GlobalCallback globalCallback2 =
        new ISoundTriggerHal.GlobalCallback() { // from class:
          // com.android.server.soundtrigger_middleware.SoundTriggerHalConcurrentCaptureHandler$$ExternalSyntheticLambda1
  ...
  public /* synthetic */ void lambda$linkToDeath$2(final IBinder.DeathRecipient deathRecipient) {
    ...
    callbackThread.push(
        new Runnable() { // from class:
          // com.android.server.soundtrigger_middleware.SoundTriggerHalConcurrentCaptureHandler$$ExternalSyntheticLambda4
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void linkToDeath(final IBinder.DeathRecipient deathRecipient) {
    IBinder.DeathRecipient deathRecipient2 = new IBinder.DeathRecipient() { // from class:
          // com.android.server.soundtrigger_middleware.SoundTriggerHalConcurrentCaptureHandler$$ExternalSyntheticLambda0
  ...
  public class CallbackWrapper implements ISoundTriggerHal.ModelCallback {
    ...
    public void recognitionCallback(final int i, final RecognitionEventSys recognitionEventSys) {
      synchronized (SoundTriggerHalConcurrentCaptureHandler.this.mActiveModels) {
        if (SoundTriggerHalConcurrentCaptureHandler.this.mActiveModels.contains(
            Integer.valueOf(i))) {
          ...
          SoundTriggerHalConcurrentCaptureHandler.this.mCallbackThread.push(
              new Runnable() { // from class:
                // com.android.server.soundtrigger_middleware.SoundTriggerHalConcurrentCaptureHandler$CallbackWrapper$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                  SoundTriggerHalConcurrentCaptureHandler.CallbackWrapper.this
                      .lambda$recognitionCallback$0(i, recognitionEventSys);
                }
              });
        }
      }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$recognitionCallback$0(
        int i, RecognitionEventSys recognitionEventSys) {
      this.mDelegateCallback.recognitionCallback(i, recognitionEventSys);
    }

    @Override // com.android.server.soundtrigger_middleware.ISoundTriggerHal.ModelCallback
    public void phraseRecognitionCallback(
        final int i, final PhraseRecognitionEventSys phraseRecognitionEventSys) {
      synchronized (SoundTriggerHalConcurrentCaptureHandler.this.mActiveModels) {
        if (SoundTriggerHalConcurrentCaptureHandler.this.mActiveModels.contains(
            Integer.valueOf(i))) {
          ...
          SoundTriggerHalConcurrentCaptureHandler.this.mCallbackThread.push(
              new Runnable() { // from class:
                // com.android.server.soundtrigger_middleware.SoundTriggerHalConcurrentCaptureHandler$CallbackWrapper$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                  SoundTriggerHalConcurrentCaptureHandler.CallbackWrapper.this
                      .lambda$phraseRecognitionCallback$1(i, phraseRecognitionEventSys);
                }
              });
        }
      }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$phraseRecognitionCallback$1(
    ...
    public void modelUnloaded(final int i) {
      SoundTriggerHalConcurrentCaptureHandler.this.mCallbackThread.push(
          new Runnable() { // from class:
            // com.android.server.soundtrigger_middleware.SoundTriggerHalConcurrentCaptureHandler$CallbackWrapper$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              SoundTriggerHalConcurrentCaptureHandler.CallbackWrapper.this.lambda$modelUnloaded$2(
                  i);
            }
          });
    }
