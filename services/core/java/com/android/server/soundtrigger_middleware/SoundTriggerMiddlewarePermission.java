...
public final class SoundTriggerMiddlewarePermission
    ...
    public final class ModuleWrapper extends ISoundTriggerModule.Stub {
        ...
        public final class CallbackWrapper implements ISoundTriggerCallback {
            ...
            public final void enforcePermissions(String str) {
                ...
                SoundTriggerMiddlewarePermission soundTriggerMiddlewarePermission =
                        SoundTriggerMiddlewarePermission.this;
                ...
                int checkPermissionForPreflight =
                        PermissionChecker.checkPermissionForPreflight(
                                legacyPermissionManagerService.mContext,
                ...
                if (checkPermissionForPreflight == 0) {
                    ((AppOpsManager)
                                    legacyPermissionManagerService.mContext.getSystemService(
                                            AppOpsManager.class))
                            .noteOpNoThrow(120, i, str2, str3, str);
                }
                if (checkPermissionForPreflight != 0) {
                    throw new SecurityException(
                            ConnectivityModuleConnector$$ExternalSyntheticOutline0.m(
                                    "Failed to obtain permission RECORD_AUDIO for identity ",
                                    ObjectPrinter.print(identity)));
                }
                if (PermissionUtil.checkPermissionForDataDelivery(
                                soundTriggerMiddlewarePermission.mContext,
                                identity,
                    ...
                    throw new SecurityException(
                            ConnectivityModuleConnector$$ExternalSyntheticOutline0.m(
                                    "Failed to obtain permission"
                                        + " android.permission.CAPTURE_AUDIO_HOTWORD for identity ",
                                    ObjectPrinter.print(identity)));
                }
            }
    ...
    public SoundTriggerMiddlewarePermission(
            SoundTriggerMiddlewareValidation soundTriggerMiddlewareValidation, Context context) {
        this.mDelegate = soundTriggerMiddlewareValidation;
        this.mContext = context;
    }

    public static void enforcePermissionForPreflight(
            Context context, Identity identity, String str) {
        int checkPermissionForPreflight =
