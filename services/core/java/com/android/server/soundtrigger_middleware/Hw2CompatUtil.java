...
public abstract class Hw2CompatUtil {
  public static ISoundTriggerHw.SoundModel convertSoundModel_2_1_to_2_0(
  ...
  public static ISoundTriggerHwCallback.RecognitionEvent convertRecognitionEvent_2_0_to_2_1(
      ISoundTriggerHwCallback.RecognitionEvent recognitionEvent) {
    ISoundTriggerHwCallback.RecognitionEvent recognitionEvent2 =
        new ISoundTriggerHwCallback.RecognitionEvent();
    recognitionEvent2.header = recognitionEvent;
    recognitionEvent2.data =
        HidlMemoryUtil.byteListToHidlMemory(recognitionEvent.data, "SoundTrigger RecognitionEvent");
    recognitionEvent2.header.data = new ArrayList();
    return recognitionEvent2;
  }

  public static ISoundTriggerHwCallback.PhraseRecognitionEvent
      convertPhraseRecognitionEvent_2_0_to_2_1(
          ISoundTriggerHwCallback.PhraseRecognitionEvent phraseRecognitionEvent) {
    ISoundTriggerHwCallback.PhraseRecognitionEvent phraseRecognitionEvent2 =
        new ISoundTriggerHwCallback.PhraseRecognitionEvent();
    phraseRecognitionEvent2.common =
        convertRecognitionEvent_2_0_to_2_1(phraseRecognitionEvent.common);
    phraseRecognitionEvent2.phraseExtras = phraseRecognitionEvent.phraseExtras;
    return phraseRecognitionEvent2;
  }

  public static ISoundTriggerHw.PhraseSoundModel convertPhraseSoundModel_2_1_to_2_0(
  ...
  public static ISoundTriggerHw.RecognitionConfig convertRecognitionConfig_2_3_to_2_1(
      RecognitionConfig recognitionConfig) {
    return recognitionConfig.base;
  }

  public static ISoundTriggerHw.RecognitionConfig convertRecognitionConfig_2_3_to_2_0(
      RecognitionConfig recognitionConfig) {
