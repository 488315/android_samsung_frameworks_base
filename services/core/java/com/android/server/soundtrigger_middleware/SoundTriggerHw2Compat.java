...
public final class SoundTriggerHw2Compat implements ISoundTriggerHal {
  ...
  public static ISoundTriggerHal create(
  ...
  public static ISoundTriggerHal create(
      IHwBinder iHwBinder, Runnable runnable, ICaptureStateNotifier iCaptureStateNotifier) {
    ...
    SoundTriggerHalMaxModelLimiter soundTriggerHalMaxModelLimiter =
        new SoundTriggerHalMaxModelLimiter(
            soundTriggerHw2Compat, soundTriggerHw2Compat.mProperties.maxSoundModels);
    return !soundTriggerHw2Compat.mProperties.concurrentCapture
        ? new SoundTriggerHalConcurrentCaptureHandler(
            soundTriggerHalMaxModelLimiter, iCaptureStateNotifier)
        : soundTriggerHalMaxModelLimiter;
  }
  ...
  public final void initUnderlying(IHwBinder iHwBinder) {
    android.hardware.soundtrigger.V2_3.ISoundTriggerHw asInterface =
        android.hardware.soundtrigger.V2_3.ISoundTriggerHw.asInterface(iHwBinder);
    if (asInterface != null) {
    ...
    android.hardware.soundtrigger.V2_2.ISoundTriggerHw asInterface2 =
        android.hardware.soundtrigger.V2_2.ISoundTriggerHw.asInterface(iHwBinder);
    ...
    android.hardware.soundtrigger.V2_1.ISoundTriggerHw asInterface3 =
        android.hardware.soundtrigger.V2_1.ISoundTriggerHw.asInterface(iHwBinder);
  ...
  public final Properties getPropertiesInternal() {
    try {
      ...
      try {
        as2_3()
            .getProperties_2_3(
                new ISoundTriggerHw.getProperties_2_3Callback() { // from class:
                  // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda0
                  @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw.getProperties_2_3Callback
                  public final void onValues(
                      int i, android.hardware.soundtrigger.V2_3.Properties properties) {
                    SoundTriggerHw2Compat.lambda$getPropertiesInternal$0(
                        atomicInteger, atomicReference, i, properties);
                  }
                });
        handleHalStatus(atomicInteger.get(), "getProperties_2_3");
        return ConversionUtil.hidl2aidlProperties(
            (android.hardware.soundtrigger.V2_3.Properties) atomicReference.get());
  ...
  public static /* synthetic */ void lambda$getPropertiesInternal$0(
      ...
      try {
        ...
        try {
          as2_1()
              .loadSoundModel_2_1(
                  aidl2hidlSoundModel,
                  new ModelCallbackWrapper(modelCallback),
                  0,
                  new ISoundTriggerHw.loadSoundModel_2_1Callback() { // from class:
                    // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda2
                    ...
                    public final void onValues(int i, int i2) {
                      SoundTriggerHw2Compat.lambda$loadSoundModel$1(
                          atomicInteger, atomicInteger2, i, i2);
                    }
                  });
  ...
  public static /* synthetic */ void lambda$loadSoundModel$1(
      AtomicInteger atomicInteger, AtomicInteger atomicInteger2, int i, int i2) {
    atomicInteger.set(i);
  ...
  public int loadPhraseSoundModel(
    ...
    ISoundTriggerHw.PhraseSoundModel aidl2hidlPhraseSoundModel =
        ConversionUtil.aidl2hidlPhraseSoundModel(phraseSoundModel);
    try {
      try {
        final AtomicInteger atomicInteger = new AtomicInteger(-1);
        final AtomicInteger atomicInteger2 = new AtomicInteger(0);
        try {
          as2_1()
              .loadPhraseSoundModel_2_1(
                  ...
                  new ModelCallbackWrapper(modelCallback),
                  0,
                  new ISoundTriggerHw.loadPhraseSoundModel_2_1Callback() { // from class:
                    // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda4
                    @Override // android.hardware.soundtrigger.V2_1.ISoundTriggerHw.loadPhraseSoundModel_2_1Callback
                    public final void onValues(int i, int i2) {
                      SoundTriggerHw2Compat.lambda$loadPhraseSoundModel$2(
                          atomicInteger, atomicInteger2, i, i2);
                    }
                  });
          ...
          int loadPhraseSoundModel_2_0 =
              loadPhraseSoundModel_2_0(aidl2hidlPhraseSoundModel, modelCallback);
  ...
  public static /* synthetic */ void lambda$loadPhraseSoundModel$2(
      AtomicInteger atomicInteger, AtomicInteger atomicInteger2, int i, int i2) {
    atomicInteger.set(i);
    atomicInteger2.set(i2);
  }
  ...
  public void startRecognition(int i, int i2, int i3, RecognitionConfig recognitionConfig) {
    android.hardware.soundtrigger.V2_3.RecognitionConfig aidl2hidlRecognitionConfig =
        ConversionUtil.aidl2hidlRecognitionConfig(recognitionConfig, i2, i3);
    try {
      try {
        handleHalStatus(
            as2_3().startRecognition_2_3(i, aidl2hidlRecognitionConfig), "startRecognition_2_3");
      } catch (NotSupported unused) {
    ...
    try {
      as2_3()
          .getParameter(
              i,
              i2,
              new ISoundTriggerHw.getParameterCallback() { // from class:
                // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda1
                @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw.getParameterCallback
                public final void onValues(int i3, int i4) {
                  SoundTriggerHw2Compat.lambda$getModelParameter$3(
                      atomicInteger, atomicInteger2, i3, i4);
                }
              });
  ...
  public static /* synthetic */ void lambda$getModelParameter$3(
      AtomicInteger atomicInteger, AtomicInteger atomicInteger2, int i, int i2) {
    atomicInteger.set(i);
    atomicInteger2.set(i2);
  }
    ...
    try {
      as2_3()
          .queryParameter(
              i,
              i2,
              new ISoundTriggerHw.queryParameterCallback() { // from class:
                // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda5
                ...
                public final void onValues(
                  ...
                  SoundTriggerHw2Compat.lambda$queryParameter$4(
                      atomicInteger, atomicReference, i3, optionalModelParameterRange);
                }
              });
      ...
      if (((OptionalModelParameterRange) atomicReference.get()).getDiscriminator() == 1) {
        return ConversionUtil.hidl2aidlModelParameterRange(
            ((OptionalModelParameterRange) atomicReference.get()).range());
      }
      return null;
    } catch (RemoteException e) {
      throw e.rethrowAsRuntimeException();
  ...
  public static /* synthetic */ void lambda$queryParameter$4(
      AtomicInteger atomicInteger,
      AtomicReference atomicReference,
      int i,
  ...
  public void linkToDeath(final IBinder.DeathRecipient deathRecipient) {
    IHwBinder.DeathRecipient deathRecipient2 = new IHwBinder.DeathRecipient() { // from class:
          // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda3
  ...
  public final Properties getProperties_2_0() {
    ...
    as2_0()
        .getProperties(
            new ISoundTriggerHw.getPropertiesCallback() { // from class:
              // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda8
              ...
              public final void onValues(int i, ISoundTriggerHw.Properties properties) {
                SoundTriggerHw2Compat.lambda$getProperties_2_0$6(
                    atomicInteger, atomicReference, i, properties);
              }
            });
    handleHalStatus(atomicInteger.get(), "getProperties");
    return ConversionUtil.hidl2aidlProperties(
        Hw2CompatUtil.convertProperties_2_0_to_2_3(
            (ISoundTriggerHw.Properties) atomicReference.get()));
  }

  public static /* synthetic */ void lambda$getProperties_2_0$6(
      AtomicInteger atomicInteger,
      AtomicReference atomicReference,
      int i,
  ...
  public final int loadSoundModel_2_0(
      ISoundTriggerHw.SoundModel soundModel, ISoundTriggerHal.ModelCallback modelCallback) {
    ISoundTriggerHw.SoundModel convertSoundModel_2_1_to_2_0 =
        Hw2CompatUtil.convertSoundModel_2_1_to_2_0(soundModel);
    final AtomicInteger atomicInteger = new AtomicInteger(-1);
    final AtomicInteger atomicInteger2 = new AtomicInteger(0);
    as2_0()
        .loadSoundModel(
            convertSoundModel_2_1_to_2_0,
            new ModelCallbackWrapper(modelCallback),
            0,
            new ISoundTriggerHw.loadSoundModelCallback() { // from class:
              // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda7
              @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHw.loadSoundModelCallback
              public final void onValues(int i, int i2) {
                SoundTriggerHw2Compat.lambda$loadSoundModel_2_0$7(
                    atomicInteger, atomicInteger2, i, i2);
              }
            });
  ...
  public static /* synthetic */ void lambda$loadSoundModel_2_0$7(
      AtomicInteger atomicInteger, AtomicInteger atomicInteger2, int i, int i2) {
    atomicInteger.set(i);
    atomicInteger2.set(i2);
  }

  public final int loadPhraseSoundModel_2_0(
      ISoundTriggerHw.PhraseSoundModel phraseSoundModel,
      ISoundTriggerHal.ModelCallback modelCallback) {
    ISoundTriggerHw.PhraseSoundModel convertPhraseSoundModel_2_1_to_2_0 =
        Hw2CompatUtil.convertPhraseSoundModel_2_1_to_2_0(phraseSoundModel);
    final AtomicInteger atomicInteger = new AtomicInteger(-1);
    final AtomicInteger atomicInteger2 = new AtomicInteger(0);
    as2_0()
        .loadPhraseSoundModel(
            convertPhraseSoundModel_2_1_to_2_0,
            new ModelCallbackWrapper(modelCallback),
            0,
            new ISoundTriggerHw.loadPhraseSoundModelCallback() { // from class:
              // com.android.server.soundtrigger_middleware.SoundTriggerHw2Compat$$ExternalSyntheticLambda6
              @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHw.loadPhraseSoundModelCallback
              public final void onValues(int i, int i2) {
                SoundTriggerHw2Compat.lambda$loadPhraseSoundModel_2_0$8(
                    atomicInteger, atomicInteger2, i, i2);
              }
            });
    handleHalStatus(atomicInteger.get(), "loadSoundModel");
  ...
  public static /* synthetic */ void lambda$loadPhraseSoundModel_2_0$8(
      AtomicInteger atomicInteger, AtomicInteger atomicInteger2, int i, int i2) {
    atomicInteger.set(i);
    atomicInteger2.set(i2);
  }

  public final void startRecognition_2_1(
      int i, android.hardware.soundtrigger.V2_3.RecognitionConfig recognitionConfig) {
    try {
      try {
        handleHalStatus(
            as2_1()
                .startRecognition_2_1(
                    i,
                    Hw2CompatUtil.convertRecognitionConfig_2_3_to_2_1(recognitionConfig),
                    new ModelCallbackWrapper(
                        (ISoundTriggerHal.ModelCallback)
                            this.mModelCallbacks.get(Integer.valueOf(i))),
                    0),
            "startRecognition_2_1");
      } catch (NotSupported unused) {
  ...
  public final void startRecognition_2_0(
      int i, android.hardware.soundtrigger.V2_3.RecognitionConfig recognitionConfig) {
    handleHalStatus(
        as2_0()
            .startRecognition(
                i,
                Hw2CompatUtil.convertRecognitionConfig_2_3_to_2_0(recognitionConfig),
                new ModelCallbackWrapper(
                    (ISoundTriggerHal.ModelCallback) this.mModelCallbacks.get(Integer.valueOf(i))),
                0),
        "startRecognition");
  }
  ...
  public class ModelCallbackWrapper extends ISoundTriggerHwCallback.Stub {
    ...
    public void recognitionCallback_2_1(
        ISoundTriggerHwCallback.RecognitionEvent recognitionEvent, int i) {
      RecognitionEventSys recognitionEventSys = new RecognitionEventSys();
      recognitionEventSys.recognitionEvent =
    ...
    public void phraseRecognitionCallback_2_1(
        ISoundTriggerHwCallback.PhraseRecognitionEvent phraseRecognitionEvent, int i) {
      ...
      this.mDelegate.phraseRecognitionCallback(
          phraseRecognitionEvent.common.header.model, phraseRecognitionEventSys);
    }

    @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback
    public void recognitionCallback(
        ISoundTriggerHwCallback.RecognitionEvent recognitionEvent, int i) {
      recognitionCallback_2_1(
          Hw2CompatUtil.convertRecognitionEvent_2_0_to_2_1(recognitionEvent), i);
    }
    ...
    public void phraseRecognitionCallback(
      ...
      phraseRecognitionCallback_2_1(
          Hw2CompatUtil.convertPhraseRecognitionEvent_2_0_to_2_1(phraseRecognitionEvent), i);
    }
  }
}
