...
public final class AppStateTrackerImpl implements AppStateTracker {
    ...
    public final AnonymousClass2 mAppBackgroundRestrictionListener =
            new ActivityManagerInternal
                    .AppBackgroundRestrictionListener() { // from class:
                        ...
                        case 2:
                            ...
                            synchronized (AppStateTrackerImpl.this.mLock) {
                                ...
                                AppStateTrackerImpl.this.mRunAnyRestrictedPackages.remove(
                                        Pair.create(
                                                Integer.valueOf(intExtra2), schemeSpecificPart));
                                AppStateTrackerImpl.this
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.AppStateTrackerImpl.AppOpsWatcher.opChanged(int,"
    ...
    class FeatureFlagsObserver extends ContentObserver {
        ...
        public final void onChange(boolean z, Uri uri) {
            if (!Settings.Global.getUriFor("forced_app_standby_for_small_battery_enabled")
                    .equals(uri)) {
                Slog.w("AppStateTracker", "Unexpected feature flag uri encountered: " + uri);
                return;
            }
            boolean z2 =
                    AppStateTrackerImpl.this.injectGetGlobalSettingInt(
            ...
            synchronized (AppStateTrackerImpl.this.mLock) {
                try {
                    ...
                    if (appStateTrackerImpl.mStarted) {
                        ...
                        switch (message.what) {
                            case 0:
                                Listener[] m39$$Nest$mcloneListeners =
                                        AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                AppStateTrackerImpl.this);
                            ...
                            case 3:
                                for (Listener listener2 :
                                    ...
                                    listener2.getClass();
                                    listener2.updateJobsForUidPackage(
                                            i3, appStateTrackerImpl.isUidActive(i3));
                                    if (!appStateTrackerImpl.areAlarmsRestricted(i3, str)) {
                                        listener2.unblockAlarmsForUidPackage(i3, str);
                                    }
                                    if (appStateTrackerImpl.isRunAnyInBackgroundAppOpsAllowed(
                                            i3, str)) {
                                        Slog.v(
                                                "AppStateTracker",
                                                AppStateTrackerImpl$MyHandler$$ExternalSyntheticOutline0
                                                        .m(
                                                                i3,
                                                                "Package ",
                                                                str,
                                                                "/",
                                                                " toggled out of fg service"
                                                                    + " restriction"));
                                        listener2.updateBackgroundRestrictedForUidPackage(
                                                i3, str, false);
                                    } else {
                                        Slog.v(
                                                "AppStateTracker",
                                ...
                                return;
                            case 4:
                                Listener[] m39$$Nest$mcloneListeners2 =
                                        AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                AppStateTrackerImpl.this);
                                ...
                                return;
                            case 5:
                                Listener[] m39$$Nest$mcloneListeners3 =
                                        AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                AppStateTrackerImpl.this);
                                ...
                                return;
                            case 6:
                                Listener[] m39$$Nest$mcloneListeners4 =
                                        AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                AppStateTrackerImpl.this);
                                ...
                                return;
                            case 7:
                                Listener[] m39$$Nest$mcloneListeners5 =
                                        AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                AppStateTrackerImpl.this);
                            ...
                            case 8:
                                ...
                                return;
                            case 10:
                                Listener[] m39$$Nest$mcloneListeners6 =
                                        AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                AppStateTrackerImpl.this);
                            ...
                            case 11:
                                z = message.arg1 == 1;
                                Listener[] m39$$Nest$mcloneListeners7 =
                                        AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                AppStateTrackerImpl.this);
                            ...
                            case 12:
                                ...
                                synchronized (AppStateTrackerImpl.this.mLock) {
                                    SparseBooleanArray sparseBooleanArray =
                                            AppStateTrackerImpl.this.mActiveUids;
                                    if (!UserHandle.isCore(i4) && !sparseBooleanArray.get(i4)) {
                                        sparseBooleanArray.put(i4, true);
                                        AppStateTrackerImpl.this
                                                .mHandler
                                                .obtainMessage(0, i4, 0)
                                                .sendToTarget();
                                    }
                                }
                                return;
                            case 13:
                                ...
                                if (message.arg2 != 0) {
                                    int i5 = message.arg1;
                                    Listener[] m39$$Nest$mcloneListeners8 =
                                            AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                    AppStateTrackerImpl.this);
                            ...
                            case 14:
                                ...
                                if (message.arg2 != 0) {
                                    int i6 = message.arg1;
                                    Listener[] m39$$Nest$mcloneListeners9 =
                                            AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                    AppStateTrackerImpl.this);
                            ...
                            case 15:
                                int i7 = message.arg1;
                                z = message.arg2 != 0;
                                Listener[] m39$$Nest$mcloneListeners10 =
                                        AppStateTrackerImpl.m39$$Nest$mcloneListeners(
                                                AppStateTrackerImpl.this);
    ...
    public final class StandbyTracker extends AppStandbyInternal.AppIdleStateChangeListener {
        ...
        public final void onAppIdleStateChanged(String str, int i, boolean z, int i2, int i3) {
            synchronized (AppStateTrackerImpl.this.mLock) {
                try {
                    if (i2 == 5
                            ? AppStateTrackerImpl.this.mExemptedBucketPackages.add(i, str)
                            : AppStateTrackerImpl.this.mExemptedBucketPackages.remove(i, str)) {
                        MyHandler myHandler = AppStateTrackerImpl.this.mHandler;
    ...
    public final void addBackgroundRestrictedAppListener(
        ...
        addListener(
                new Listener() { // from class: com.android.server.AppStateTrackerImpl.1
                    ...
                    public final void updateBackgroundRestrictedForUidPackage(
                            int i, String str, boolean z) {
                        backgroundRestrictedAppListener.updateBackgroundRestrictedForUidPackage(
                                i, str, z);
                    }
                });
    }
        ...
        synchronized (this.mLock) {
            try {
                ...
                if (!this.mActivityManagerInternal.isBgAutoRestrictedBucketFeatureFlagEnabled()
                        && findForcedAppStandbyUidPackageIndexLocked(i, str) >= 0) {
                    z = true;
                }
                return z;
            } catch (Throwable th) {
            ...
            try {
                ...
                for (int i = 0; i < sparseBooleanArray.size(); i++) {
                    if (sparseBooleanArray.valueAt(i)) {
                        ...
                        indentingPrintWriter.print(
                                UserHandle.formatUid(sparseBooleanArray.keyAt(i)));
                        str = " ";
                    }
                }
                ...
                for (int i2 = 0; i2 < this.mExemptedBucketPackages.size(); i2++) {
                    ...
                    for (int i3 = 0; i3 < this.mExemptedBucketPackages.sizeAt(i2); i3++) {
                        indentingPrintWriter.print(
                                (String) this.mExemptedBucketPackages.valueAt(i2, i3));
                        indentingPrintWriter.println();
                    }
                ...
                while (it.hasNext()) {
                    ...
                    indentingPrintWriter.print(
                            UserHandle.formatUid(((Integer) pair.first).intValue()));
                    indentingPrintWriter.print(" ");
                ...
                for (int i5 = 0; i5 < this.mExemptedBucketPackages.size(); i5++) {
                    for (int i6 = 0; i6 < this.mExemptedBucketPackages.sizeAt(i5); i6++) {
                        ...
                        protoOutputStream.write(
                                1120986464257L, this.mExemptedBucketPackages.keyAt(i5));
                        protoOutputStream.write(
                                1138166333442L,
                                (String) this.mExemptedBucketPackages.valueAt(i5, i6));
            ...
            try {
                for (int size = this.mRunAnyRestrictedPackages.size() - 1; size >= 0; size--) {
                    if (UserHandle.getUserId(
                                    ((Integer)
                                                    ((Pair)
                                                                    this.mRunAnyRestrictedPackages
                                                                            .valueAt(size))
                                                            .first)
                                            .intValue())
                            == i) {
    ...
    public final void onSystemServicesReady() {
        synchronized (this.mLock) {
            try {
                ...
                if (AppStateTrackerImpl.this.injectGetGlobalSettingInt(
                                "forced_app_standby_for_small_battery_enabled", 0)
                        != 1) {
                    z = false;
                }
                ...
                try {
                    this.mIActivityManager.registerUidObserver(
                            new UidObserver(), 30, -1, (String) null);
                ...
                this.mPowerManagerInternal.registerLowPowerModeObserver(
                        ...
                        new Consumer() { // from class:
                            ...
                            public final void accept(Object obj) {
                                ...
                                synchronized (appStateTrackerImpl.mLock) {
                                    appStateTrackerImpl.mBatterySaverEnabled =
                                            powerSaveState.batterySaverEnabled;
                                    appStateTrackerImpl.updateForceAllAppStandbyState();
                                }
                            }
                        });
            ...
            for (int i2 = 0; i2 < ops.size(); i2++) {
                ...
                if (opEntry.getOp() == 70 && opEntry.getMode() != 0) {
                    this.mRunAnyRestrictedPackages.add(
                            Pair.create(
                                    Integer.valueOf(packageOps.getUid()),
