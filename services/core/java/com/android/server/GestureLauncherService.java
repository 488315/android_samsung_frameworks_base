...
public class GestureLauncherService extends SystemService {
          ...
          public void onReceive(Context context2, Intent intent) {
            if ("android.intent.action.USER_SWITCHED".equals(intent.getAction())) {
              ...
              GestureLauncherService.this
                  .mContext
                  .getContentResolver()
                  .unregisterContentObserver(GestureLauncherService.this.mSettingObserver);
  ...
  public void onBootPhase(int i) {
    if (i == 600) {
      if (isGestureLauncherEnabled(this.mContext.getResources())) {
        ...
        this.mHasFeatureWatch =
            this.mContext.getPackageManager().hasSystemFeature("android.hardware.type.watch");
        this.mVibrateMilliSecondsForPanicGesture =
            r5.getInteger(R.integer.config_mobile_hotspot_provision_check_period);
      }
    }
  }
  ...
  public final void registerContentObservers() {
    this.mContext
        ...
        .registerContentObserver(
            Settings.Secure.getUriFor("camera_gesture_disabled"),
            false,
            this.mSettingObserver,
            this.mUserId);
    this.mContext
    ...
    this.mContext
        .getContentResolver()
        .registerContentObserver(
            Settings.Global.getUriFor("emergency_gesture_power_button_cooldown_period_ms"),
            false,
            this.mSettingObserver,
            this.mUserId);
  }
  ...
  public void updateCameraDoubleTapPowerEnabled() {
    boolean isCameraDoubleTapPowerSettingEnabled =
        isCameraDoubleTapPowerSettingEnabled(this.mContext, this.mUserId);
    synchronized (this) {
  ...
  public void updateEmergencyGestureEnabled() {
    boolean isEmergencyGestureSettingEnabled =
        isEmergencyGestureSettingEnabled(this.mContext, this.mUserId);
    synchronized (this) {
  ...
  public void updateEmergencyGesturePowerButtonCooldownPeriodMs() {
    int emergencyGesturePowerButtonCooldownPeriodMs =
        getEmergencyGesturePowerButtonCooldownPeriodMs(this.mContext, this.mUserId);
    synchronized (this) {
      this.mEmergencyGesturePowerButtonCooldownPeriodMs =
          emergencyGesturePowerButtonCooldownPeriodMs;
    }
  }
  ...
  public final void unregisterCameraLaunchGesture() {
    if (this.mCameraLaunchRegistered) {
      ...
      ((SensorManager) this.mContext.getSystemService("sensor"))
          .unregisterListener(this.mGestureListener);
    }
  }
  ...
  public final void registerCameraLaunchGesture(Resources resources) {
    ...
    int integer = resources.getInteger(R.integer.config_defaultDisplayDefaultColorMode);
    if (integer != -1) {
      this.mCameraLaunchRegistered = false;
      String string = resources.getString(R.string.confirm_battery_saver);
      ...
      if (defaultSensor != null) {
        if (string.equals(defaultSensor.getStringType())) {
          this.mCameraLaunchRegistered =
              sensorManager.registerListener(this.mGestureListener, this.mCameraLaunchSensor, 0);
          return;
        }
        throw new RuntimeException(
            String.format(
                "Wrong configuration. Sensor type and sensor string type don't match: %s in"
                    + " resources, %s in the sensor.",
                string, this.mCameraLaunchSensor.getStringType()));
      }
    }
  }
  ...
  public final void unregisterCameraLiftTrigger() {
    if (this.mCameraLiftRegistered) {
      ...
      ((SensorManager) this.mContext.getSystemService("sensor"))
          .cancelTriggerSensor(this.mCameraLiftTriggerListener, this.mCameraLiftTriggerSensor);
    }
  }
        ...
        if (string.equals(defaultSensor.getStringType())) {
          this.mCameraLiftRegistered =
              sensorManager.requestTriggerSensor(
                  this.mCameraLiftTriggerListener, this.mCameraLiftTriggerSensor);
          return;
        }
        throw new RuntimeException(
            String.format(
                "Wrong configuration. Sensor type and sensor string type don't match: %s in"
                    + " resources, %s in the sensor.",
                string, this.mCameraLiftTriggerSensor.getStringType()));
      }
    }
  }
  ...
  public static boolean isCameraLiftTriggerSettingEnabled(Context context, int i) {
    return isCameraLiftTriggerEnabled(context.getResources())
        && Settings.Secure.getIntForUser(
                context.getContentResolver(), "camera_lift_trigger_enabled", 1, i)
            != 0;
  }
  ...
  public static boolean isEmergencyGestureSettingEnabled(Context context, int i) {
    return isEmergencyGestureEnabled(context.getResources())
        && Settings.Secure.getIntForUser(
                ...
                isDefaultEmergencyGestureEnabled(context.getResources()) ? 1 : 0,
                i)
            != 0;
  }
  ...
  public static boolean isCameraLaunchEnabled(Resources resources) {
    return (resources.getInteger(R.integer.config_defaultDisplayDefaultColorMode) != -1)
        && !SystemProperties.getBoolean("gesture.disable_camera_launch", false);
  }

  public static boolean isCameraDoubleTapPowerEnabled(Resources resources) {
    return resources.getBoolean(R.bool.config_batterySaver_full_forceBackgroundCheck);
  }

  public static boolean isCameraLiftTriggerEnabled(Resources resources) {
    return resources.getInteger(R.integer.config_defaultHapticFeedbackIntensity) != -1;
  }

  public static boolean isEmergencyGestureEnabled(Resources resources) {
    return resources.getBoolean(R.bool.config_dockBigOverlayWindows);
  }

  public static boolean isDefaultEmergencyGestureEnabled(Resources resources) {
    return resources.getBoolean(R.bool.config_cecTvSendStandbyOnSleep_userConfigurable);
  }
  ...
  public boolean interceptPowerKeyDown(
      KeyEvent keyEvent, boolean z, MutableBoolean mutableBoolean) {
    long eventTime;
    boolean z2;
    boolean z3;
    boolean z4;
    if (this.mEmergencyGestureEnabled && this.mEmergencyGesturePowerButtonCooldownPeriodMs >= 0) {
      ...
      if (eventTime2 < i) {
        Slog.i(
            ...
            String.format(
                "Suppressing power button: within %dms cooldown period after Emergency Gesture."
                    + " Begin=%dms, end=%dms.",
                Integer.valueOf(i),
                Long.valueOf(this.mLastEmergencyGestureTriggered),
                Long.valueOf(
                    this.mLastEmergencyGestureTriggered
                        + this.mEmergencyGesturePowerButtonCooldownPeriodMs)));
    ...
    synchronized (this) {
      ...
      if (this.mEmergencyGestureEnabled) {
        ...
        if (i2 == 5) {
          ...
          if (eventTime3
            ...
            Slog.i(
                "GestureLauncherService",
                "Emergency gesture detected but it's too fast. Gesture time: "
                    + eventTime3
                    + " ms");
            this.mFirstPowerDown = keyEvent.getEventTime();
            this.mPowerButtonConsecutiveTaps = 1;
            ...
            Slog.i(
                "GestureLauncherService",
                "Emergency gesture detected. Gesture time: " + eventTime3 + " ms");
      ...
      if (this.mCameraDoubleTapPowerEnabled
          && eventTime < CAMERA_POWER_DOUBLE_TAP_MAX_TIME_MS
          && this.mPowerButtonConsecutiveTaps == 2) {
        z4 = true;
      } else {
        z4 = false;
        z = z3;
    ...
    if (this.mPowerButtonConsecutiveTaps > 1 || this.mPowerButtonSlowConsecutiveTaps > 1) {
      Slog.i(
          "GestureLauncherService",
          Long.valueOf(this.mPowerButtonConsecutiveTaps)
              + " consecutive power button taps detected, "
              + Long.valueOf(this.mPowerButtonSlowConsecutiveTaps)
              + " consecutive slow power button taps detected");
    }
    if (z4) {
      Slog.i(
          "GestureLauncherService",
          "Power button double tap gesture detected, launching camera. Interval="
              + eventTime
              + "ms");
      z4 = handleCameraGesture(false, 1);
      if (z4) {
        this.mMetricsLogger.action(
            IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT, (int) eventTime);
    ...
    this.mMetricsLogger.histogram(
        "power_consecutive_short_tap_count", this.mPowerButtonSlowConsecutiveTaps);
    ...
    try {
      if (isUserSetupComplete()) {
        ...
        ((StatusBarManagerInternal) LocalServices.getService(StatusBarManagerInternal.class))
            .onCameraLaunchGestureDetected(i);
        Trace.traceEnd(64L);
        return true;
      }
      Trace.traceEnd(64L);
  ...
  public final void onEmergencyGestureDetectedOnWatch() {
    ...
    if (resolveActivity == null) {
      Slog.w(
          "GestureLauncherService",
          "Couldn't find an app to process the emergency intent " + intent.getAction());
      return;
    }
    ((Vibrator) this.mContext.getSystemService(Vibrator.class))
        .vibrate(VibrationEffect.createOneShot(this.mVibrateMilliSecondsForPanicGesture, -1));
  ...
  public final class GestureEventListener implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
      if (GestureLauncherService.this.mCameraLaunchRegistered
          && sensorEvent.sensor == GestureLauncherService.this.mCameraLaunchSensor
          && GestureLauncherService.this.handleCameraGesture(true, 0)) {
  ...
  public final class CameraLiftTriggerEventListener extends TriggerEventListener {
    ...
    public void onTrigger(TriggerEvent triggerEvent) {
      if (GestureLauncherService.this.mCameraLiftRegistered
          && triggerEvent.sensor == GestureLauncherService.this.mCameraLiftTriggerSensor) {
        GestureLauncherService.this.mContext.getResources();
        SensorManager sensorManager =
            (SensorManager) GestureLauncherService.this.mContext.getSystemService("sensor");
        boolean isKeyguardShowingAndNotOccluded =
            GestureLauncherService.this.mWindowManagerInternal.isKeyguardShowingAndNotOccluded();
        ...
        gestureLauncherService.mCameraLiftRegistered =
            sensorManager.requestTriggerSensor(
                gestureLauncherService.mCameraLiftTriggerListener,
                GestureLauncherService.this.mCameraLiftTriggerSensor);
      }
    }
  }
}
