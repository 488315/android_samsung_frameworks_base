...
public class GestureLauncherService extends SystemService {
    ...
    public void onBootPhase(int i) {
        if (i == 600) {
            if (isGestureLauncherEnabled(this.mContext.getResources())) {
                ...
                this.mVibrateMilliSecondsForPanicGesture = r5.getInteger(R.integer.config_mobile_hotspot_provision_check_period);
            }
        }
    }
    ...
    public final void registerCameraLiftTrigger(Resources resources) {
        ...
        if (integer != -1) {
            this.mCameraLiftRegistered = false;
            String string = resources.getString(R.string.connected_display_thermally_unavailable_notification_content);
            Sensor defaultSensor = sensorManager.getDefaultSensor(integer, true);
    ...
    public static boolean isCameraLaunchEnabled(Resources resources) {
        return (resources.getInteger(R.integer.config_defaultDisplayDefaultColorMode) != -1) && !SystemProperties.getBoolean("gesture.disable_camera_launch", false);
    }
