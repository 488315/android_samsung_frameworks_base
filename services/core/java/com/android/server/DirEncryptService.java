...
public class DirEncryptService extends IDirEncryptService.Stub {
      ...
      new IVoldTaskListener.Stub() { // from class: com.android.server.DirEncryptService.1
        ...
        public void onStatus(final int i, final PersistableBundle persistableBundle) {
          ...
          if (DirEncryptService.this.mHandler != null) {
            DirEncryptService.this.mHandler.post(
                new Runnable() { // from class: com.android.server.DirEncryptService.1.1
      ...
      try {
        ...
        if (fileChannel2 != null) {
          try {
            ...
            Log.e("DirEncryptService", "Error close FileChannel : " + e6.getMessage());
            throw th;
          }
        }
        if (fileChannel != null) {
  ...
  public final String getCallingProcessPkg(int i) {
    ...
    if (activityManagerService != null
        && (runningAppProcesses = activityManagerService.getRunningAppProcesses()) != null) {
  ...
  public final String findRequester(int i) {
    ...
    Log.i(
        "DirEncryptService", "Package name uidApp = " + this.mPm.getNameForUid(i) + " uid = " + i);
    Log.i(
        "DirEncryptService",
  ...
  public int setStorageCardEncryptionPolicy(int i, int i2, int i3) {
    ...
    if (!SemSdCardEncryption.isEncryptionFeatureEnabled()) {
      if (i == 2) {
        AuditLog.log(
            1, 1, false, Process.myPid(), "DirEncryptService", "Encrypting storage card failed");
      } else {
        AuditLog.log(
            1, 1, false, Process.myPid(), "DirEncryptService", "Decrypting storage card failed");
      }
      return 200;
    }
    ...
    synchronized (this.mSync) {
      ...
      if (this.mHelper.getCurrentStatus() != 0) {
        Log.i(
            "DirEncryptService", "Cannot save the policy if SD card is being encrypted/decrypted");
        Binder.restoreCallingIdentity(clearCallingIdentity);
        return 15;
      }
      ...
      if (authByUid(callingUid)) {
        if (!"user".equals(findRequester) && !z) {
          Log.i(
              "DirEncryptService",
              "Do not need to disable SD card encryption policy by EAS/MDM requests");
        }
        i4 = 8;
      } else {
  ...
  public int isStorageCardEncryptionPoliciesApplied() {
    ...
    int isStorageCardEncryptionPoliciesApplied =
        this.mHelper.isStorageCardEncryptionPoliciesApplied();
    Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public int setPassword(String str) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    boolean z =
        checkSystemUid(callingUid)
            || this.mPm.getNameForUid(callingUid).matches(".*android.uid.systemui.*");
