...
public class ConsumerIrService extends IConsumerIrService.Stub {
  ...
  public ConsumerIrService(Context context) {
    ...
    PowerManager.WakeLock newWakeLock =
        ((PowerManager) context.getSystemService("power")).newWakeLock(1, "ConsumerIrService");
  ...
  public final boolean getHalService() {
    IConsumerIr asInterface =
        IConsumerIr.Stub.asInterface(
            ServiceManager.waitForDeclaredService(IConsumerIr.DESCRIPTOR + "/default"));
