...
public final class ContainerDependencyWrapper {
    ...
    public static void addAppPackageNameToAllowList(int i, Context context2, List list) {
        ...
        try {
            ...
            ActivityManagerService$$ExternalSyntheticOutline0.m(
                    e, new StringBuilder("Exception: "), "ContainerDependencyWrapper");
        }
    }

    public static void checkCallerPermissionFor(Context context2, String str, String str2) {
        if (ServiceKeeper.isAuthorized(
                        Binder.getCallingPid(), Binder.getCallingUid(), context2, str, str2)
                == 0) {
            return;
        }
        ...
        SecurityException securityException =
                new SecurityException(
                        AudioOffloadInfo$$ExternalSyntheticOutline0.m(sb, str, "] service"));
    ...
    public static void deletePackageAsUserAndPersona(
            ...
            final String str,
            final PersonaManagerService.PackageDeleteObs packageDeleteObs,
            final int i) {
        ...
        Log.d(
                ...
                "START PACKAGE DELETE: observer{"
                        + Integer.valueOf(packageDeleteObs.hashCode())
                        + "}\npkg{<packageName>}\nuser{"
                        + i
                        + "}\n");
        ...
        AccessibilityManagerService$$ExternalSyntheticOutline0.m(
                callingUid,
                i,
                "deletePackageAsUser : uid = ",
                " userId = ",
                "PersonaServiceHelper");
        if (UserHandle.getUserId(callingUid) != i) {
            context2.enforceCallingOrSelfPermission(
            ...
            handler.post(
                    new Runnable() { // from class: com.android.server.pm.PersonaServiceHelper.4
                        ...
                        public AnonymousClass4(
                                ...
                                final String str2,
                                final PackageManagerService packageManagerService2,
                                final int i2,
                                final Settings settings2,
                                final PersonaManagerService.PackageDeleteObs packageDeleteObs2,
                                final Context context22) {
                            r1 = handler2;
                            r2 = str2;
                        ...
                        public final void run() {
                            ...
                            try {
                                if (PersonaServiceHelper.getApplicationPolicyService() == null
                                    ...
                                    PmLog.logDebugInfoAndLogcat(
                                            "deletePackageXForKnox: pkg{"
                                                    + str2
                                                    + "}, user{"
                                                    + i3
                                                    + "}, flags{4}");
                                    i2 =
                                            packageManagerService2.mDeletePackageHelper
                                                    .deletePackageX(i3, 4, -1L, str2, true);
                                    try {
                                    ...
                                    Log.w(
                                            "PersonaServiceHelper",
                                            "This app uninstallation is not allowed");
                                    i2 = -1;
                                }
                            ...
                            if (r6 != null) {
                                try {
                                    Log.d(
                                            "PersonaServiceHelper",
                                            "return delete result to caller: " + r6.hashCode());
        ...
        try {
            if (SemPersonaManager.isKnoxId(i)) {
                ApplicationInfo applicationInfo =
                        ActivityThread.getPackageManager().getApplicationInfo(str, 786560L, i);
    ...
    public static boolean isRequiredAppForKnox(int i, String str) {
        ...
        try {
            if (SemPersonaManager.isKnoxId(i)) {
                ApplicationInfo applicationInfo =
                        ActivityThread.getPackageManager().getApplicationInfo(str, 786560L, 0);
                if (applicationInfo == null) {
                    return false;
                }
                bundle = applicationInfo.metaData;
