...
public class ProxyAgentWrapper {
      ...
      new ServiceConnection() { // from class:
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
          DDLog.m36v(
              ...
              "Knox Proxy Agent started : " + ProxyAgentWrapper.this.mInfo.toString(),
              new Object[0]);
            ...
            ProxyAgentWrapper.this
                ...
                .sendMessage(
                    ProxyAgentWrapper.this
                        .mService
                        .getHandler()
                        .obtainMessage(4, ProxyAgentWrapper.this.mInfo));
          }
        }
        ...
        public void onServiceDisconnected(ComponentName componentName) {
          DDLog.m33d(
              "KnoxService::ProxyAgentWrapper",
              "Knox Proxy Agent disconnected : " + ProxyAgentWrapper.this.mInfo.toString(),
              new Object[0]);
          synchronized (ProxyAgentWrapper.this.mProxyAgentLock) {
        ...
        public void onNullBinding(ComponentName componentName) {
          DDLog.m33d(
              "KnoxService::ProxyAgentWrapper",
              "onNullBinding : " + ProxyAgentWrapper.this.mInfo.toString(),
              new Object[0]);
          synchronized (ProxyAgentWrapper.this.mProxyAgentLock) {
            ProxyAgentWrapper.this.mProxyAgent = null;
            ProxyAgentWrapper.this.mBindPending = false;
        ...
        public void onBindingDied(ComponentName componentName) {
          DDLog.m33d(
              "KnoxService::ProxyAgentWrapper",
              "onBindingDied : " + ProxyAgentWrapper.this.mInfo.toString(),
              new Object[0]);
          synchronized (ProxyAgentWrapper.this.mProxyAgentLock) {
            ProxyAgentWrapper.this.mProxyAgent = null;
            ProxyAgentWrapper.this.mBindPending = false;
  ...
  public boolean connectSync() {
    ...
    DDLog.m33d(
        "KnoxService::ProxyAgentWrapper",
        "try connectSync : " + this.mInfo.toString(),
        new Object[0]);
    try {
      synchronized (this.mProxyAgentLock) {
        if (!isServiceConnected()) {
          ...
          if (!this.mIsNotify) {
            DDLog.m33d(
                "KnoxService::ProxyAgentWrapper", "thread waken up without notify", new Object[0]);
            return false;
          }
        }
        return true;
  ...
  public boolean connectAsync() {
    DDLog.m33d(
        "KnoxService::ProxyAgentWrapper",
        "try connectAsync : " + this.mInfo.toString(),
        new Object[0]);
    synchronized (this.mProxyAgentLock) {
  ...
  public final void triggerRestart() {
    if (!this.mIsStale) {
      ...
      this.mService
          .getHandler()
          .sendMessage(this.mService.getHandler().obtainMessage(1, this.mInfo));
      return;
    }
    DDLog.m33d(
        "KnoxService::ProxyAgentWrapper",
  ...
  public final void onAgentReconnected() {
    try {
      if (this.mProxyAgent != null) {
        DDLog.m33d(
            "KnoxService::ProxyAgentWrapper", "sending onAgentReconnected signal", new Object[0]);
      ...
      DDLog.m34e(
          ...
          "RemoteException: name:"
              + this.mInfo.mCompName.flattenToShortString()
              + " -- onAgentReconnected",
          new Object[0]);
      e.printStackTrace();
    }
  ...
  public Bundle relay(int i, String str, String str2, Bundle bundle) {
    ...
    try {
      ...
      if (hashCode == 681038700 && str2.equals("TERMINATE_SECURE_SESSION")) {
        c = 1;
        if (c != 0) {
          String initializeSecureSession =
              this.mProxyAgent.initializeSecureSession(i, str, string, string2);
          bundle2 = new Bundle();
