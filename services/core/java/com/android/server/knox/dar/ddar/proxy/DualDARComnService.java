...
public class DualDARComnService extends IProxyService.Stub implements EnterpriseServiceCallback {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.PACKAGE_ADDED".equals(action) || "android.intent.action.PACKAGE_CHANGED".equals(action)) {
                try {
                    ...
                    DDLog.m34e("DualDARComnService", "package added or changed uri runtime exception occurred", new Object[0]);
                    e.printStackTrace();
                    return;
                }
            }
    ...
    public final void ensureProxyAgentBinding(String str) {
        ...
        if (findAgent(str) == null) {
            DDLog.m34e("DualDARComnService", "Stop to ensure binding due to agent not registered", new Object[0]);
            return;
        }
    ...
    public final boolean registerAgentByActionInternal(String str, int i, String str2, String str3, boolean z) {
        synchronized (this.mRegisteredProxyAgentsLock) {
            ...
            if (proxyAgentInfo != null) {
                DDLog.m33d("DualDARComnService", "Knox Proxy Agent Already Registered Agent = " + proxyAgentInfo + "No action taken", new Object[0]);
                return true;
            }
    ...
    */
    public final ProxyAgentInfo findProxyAgentByAction(String str, int i, String str2, String str3) {
        DDLog.m33d("DualDARComnService", "findProxyAgentByAction : agent = " + str + "User = " + i + " packageName = " + str2 + " actionName = " + str3, new Object[0]);
        ProxyAgentInfo proxyAgentInfo = null;
        try {
            Intent intent = new Intent(str3);
            intent.setPackage(str2);
            List queryIntentServicesAsUser = this.mContext.getPackageManager().queryIntentServicesAsUser(intent, 0, i);
            DDLog.m33d("DualDARComnService", "Number of Apps with action = " + str3 + " = " + String.valueOf(queryIntentServicesAsUser.size()), new Object[0]);
        ...
        if (proxyAgentInfo == null) {
            DDLog.m34e("DualDARComnService", "Knox Proxy Agent Not Found : for package:" + str2 + " for action:" + str3 + " for user:" + i, new Object[0]);
        } else {
            DDLog.m33d("DualDARComnService", "Knox Proxy Agent Found =   " + proxyAgentInfo, new Object[0]);
        }
        return proxyAgentInfo;
    }
    ...
    public final boolean registerAgentByMetadataInternal(String str, int i, String str2, String str3, boolean z) {
        synchronized (this.mRegisteredProxyAgentsLock) {
            ProxyAgentInfo findAgent = findAgent(str);
            if (findAgent != null) {
                DDLog.m33d("DualDARComnService", "Knox Proxy Agent Already Registered Agent = " + findAgent + "No action taken", new Object[0]);
                return true;
            }
    ...
    public final void deregisterAgentInternal(String str) {
        synchronized (this.mRegisteredProxyAgentsLock) {
            ProxyAgentInfo proxyAgentInfo = (ProxyAgentInfo) this.mRegisteredProxyAgents.get(str);
            if (proxyAgentInfo == null) {
                DDLog.m33d("DualDARComnService", "Knox Proxy Agent Not Registered Agent = " + proxyAgentInfo + "No action taken", new Object[0]);
                return;
            }
    ...
    public Bundle relayAsync(final String str, final String str2, final String str3, final Bundle bundle) {
        if (str.equalsIgnoreCase("SYSTEM_PROXY_AGENT")) {
            this.mBackgroundHandler.post(new Runnable() { // from class: com.android.server.knox.dar.ddar.proxy.DualDARComnService.4
                ...
                public void run() {
                    DDLog.m33d("DualDARComnService", "relayAsync from bg thread, relay start to System proxy agent : " + str, new Object[0]);
                    SystemProxyAgent.getInstance(DualDARComnService.this.mContext).relay(Binder.getCallingUid(), str2, str3, bundle);
                    DDLog.m33d("DualDARComnService", "relayAsync from bg thread, relay end to System proxy agent : " + str, new Object[0]);
                }
            });
    ...
    public /* synthetic */ void lambda$relayAsync$0(ProxyAgentInfo proxyAgentInfo, String str, String str2, String str3, Bundle bundle) {
        ...
        DDLog.m33d("DualDARComnService", "relayAsync from bg thread, relay start to agent : " + str, new Object[0]);
        if (connectProxyAgentSync != null) {
            connectProxyAgentSync.relay(Binder.getCallingUid(), str2, str3, bundle);
        } else {
            DDLog.m34e("DualDARComnService", "ProxyAgentWrapper is NULL !", new Object[0]);
        }
        DDLog.m33d("DualDARComnService", "relayAsync from bg thread, relay end to agent : " + str, new Object[0]);
    }
    ...
    public /* synthetic */ void lambda$addKPUAppToWhitelist$1(int i, IDualDARPolicy iDualDARPolicy) {
        ...
        try {
            ...
            DDLog.m34e("DualDARComnService", "addKPUAppToWhitelist failed ! Component may be null" + e.getMessage(), new Object[0]);
            i2 = -1;
        }
        try {
    ...
    public final ProxyAgentWrapper connectProxyAgentSync(ProxyAgentInfo proxyAgentInfo) {
        ...
        if (proxyAgentWrapper != null) {
            ...
            if (proxyAgentWrapper.isProxyAgentBindPending()) {
                ...
                DDLog.m34e("DualDARComnService", "Failed to bind to " + proxyAgentInfo.toString(), new Object[0]);
                return null;
            }
            synchronized (this.mProxyAgentWrapperLock) {
    ...
    public final ProxyAgentWrapper connectProxyAgentASync(ProxyAgentInfo proxyAgentInfo) {
        ...
        synchronized (this.mProxyAgentWrapperLock) {
            if (this.mProxyAgentWrapperMap.containsKey(proxyAgentInfo)) {
                ...
                DDLog.m35i("DualDARComnService", "Proxy Agent is already bound or pending bound: Agent = " + proxyAgentInfo.mName, new Object[0]);
                return proxyAgentWrapper;
            }
            ProxyAgentWrapper proxyAgentWrapper2 = new ProxyAgentWrapper(this.mContext, this, proxyAgentInfo);
    ...
    public void handleAgentDied(ProxyAgentInfo proxyAgentInfo) {
        ...
        try {
            if (!IPackageManager.Stub.asInterface(ServiceManager.getService("package")).isPackageAvailable(proxyAgentInfo.mCompName.getPackageName(), proxyAgentInfo.mUserId)) {
                DDLog.m34e("DualDARComnService", "Not installed service " + proxyAgentInfo.toString(), new Object[0]);
                return;
            }
            ProxyAgentWrapper connectProxyAgentASync = connectProxyAgentASync(proxyAgentInfo);
            if (connectProxyAgentASync != null) {
    ...
    public final void handleAgentStated(ProxyAgentInfo proxyAgentInfo) {
        DDLog.m33d("DualDARComnService", "handleAgentStarted : " + proxyAgentInfo.mCompName.getPackageName(), new Object[0]);
        try {
            if (!IPackageManager.Stub.asInterface(ServiceManager.getService("package")).isPackageAvailable(proxyAgentInfo.mCompName.getPackageName(), proxyAgentInfo.mUserId)) {
                DDLog.m34e("DualDARComnService", "Not installed service " + proxyAgentInfo.toString(), new Object[0]);
                return;
        ...
        public void scheduleChecker(String str) {
            if (str == null || str.isEmpty()) {
                synchronized (this.mCheckerLock) {
                    DDLog.m34e("DualDARComnService", "Binding Checker : Invalid agent... cancel scheduling", new Object[0]);
            ...
            if (DualDARComnService.this.checkProxyAgentBound(str)) {
                synchronized (this.mCheckerLock) {
                    DDLog.m33d("DualDARComnService", "Binding Checker : Found out bound agent", new Object[0]);
                    this.mCheckerLock.notifyAll();
                }
                return;
            }
