...
public class AuthResult {
  ...
  public AuthResult(ASN1Primitive aSN1Primitive) {
    ...
    if (!(aSN1Primitive instanceof ASN1Sequence)) {
      throw new CertificateParsingException(
          "Expected sequence for root of trust, found " + aSN1Primitive.getClass().getName());
    }
  ...
  public String statusToString(int i, boolean z) {
    return i != 0
        ? i != 1 ? (i == 2 || z) ? "Not support" : Integer.toHexString(i) : "Abnormal"
        : "Normal";
  }

  public String toString() {
    return "        Caller Auth Result : "
        + statusToString(this.mCallerAuthResult, false)
        + "\n        Calling Package : "
        + new String(this.mCallingPackage)
        + "\n        Calling Package Signatures : "
        + new String(this.mCallingPackageSigs)
        + "\n        Calling Package Auth Result : "
        + statusToString(this.mCallingPackageAuthResult, true);
  }
}
