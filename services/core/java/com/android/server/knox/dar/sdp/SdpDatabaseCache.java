...
public class SdpDatabaseCache {
  public final HashMap mCache =
      new LinkedHashMap(
          10, 0.75f, true) { // from class: com.android.server.knox.dar.sdp.SdpDatabaseCache.1
  ...
  public final void putInternal(int i, String str, String str2) {
    ...
    try {
      try {
        ...
        this.mDbWritable.delete(
            "sdp_info", "name=? AND user=?", new String[] {str, Integer.toString(i)});
  ...
  public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sQLiteDatabase) {
      ...
      sQLiteDatabase.execSQL(
          "CREATE TABLE sdp_info (_id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT,user"
              + " INTEGER,value TEXT);");
    }
