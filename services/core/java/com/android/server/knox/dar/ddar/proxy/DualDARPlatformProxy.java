    ...
    */
    ...
    public /* synthetic */ Bundle lambda$getConfig$0(Bundle bundle, IDualDARPolicy iDualDARPolicy) {
        ...
        try {
            ...
            DDLog.m34e("DualDARPlatformProxy", "getConfig failed ! Component may be null" + e.getMessage(), new Object[0]);
            i = -1;
        }
        try {
    ...
    public /* synthetic */ void lambda$setClientInfo$1(Bundle bundle, IDualDARPolicy iDualDARPolicy) {
        ...
        try {
            ...
            e = e2;
            DDLog.m34e("DualDARPlatformProxy", "setClientInfo failed ! Component may be null" + e.getMessage(), new Object[0]);
            ...
            DDLog.m33d("DualDARPlatformProxy", "setClientInfo packageName " + string2 + "packageSig " + string3 + "client version " + string4 + "user id " + i, new Object[0]);
        ...
        DDLog.m33d("DualDARPlatformProxy", "setClientInfo packageName " + string22 + "packageSig " + string32 + "client version " + string42 + "user id " + i, new Object[0]);
        try {
