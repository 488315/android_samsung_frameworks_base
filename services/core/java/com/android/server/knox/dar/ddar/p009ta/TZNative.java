...
class TZNative {
    ...
    public TZNative(int i, String str, String str2, String str3, int i2, int i3) {
        DDLog.m33d("DualDAR:TZNative", "TZNative constructor: taId = " + i, new Object[0]);
        this.mTAId = i;
    ...
    public boolean loadTA(int i, long j, long j2) {
        if (this.mDDARTZNativePtr_ != 0) {
            DDLog.m34e("DualDAR:TZNative", "TZNative::loadTA called for TA that is already loaded. Call Ignored", new Object[0]);
            return true;
        }
        if (j > 2147483647L || j2 > 2147483647L) {
            DDLog.m34e("DualDAR:TZNative", "loadTA: cannot get ta offset or size", new Object[0]);
            return false;
        }
        ...
        if (nativeDDARCreateTLCommunicationContext == 0) {
            DDLog.m34e("DualDAR:TZNative", "Error: nativeDDARCreateTLCommunicationContext failed", new Object[0]);
            return false;
        }
        synchronized (TZNative.class) {
            this.mIsLoaded = true;
        }
        DDLog.m33d("DualDAR:TZNative", "TZNative::loadTA: mDDARTZNativePtr_ = " + this.mDDARTZNativePtr_, new Object[0]);
        return true;
    }
    ...
    public void unloadTA() {
        synchronized (TZNative.class) {
            if (this.mDDARTZNativePtr_ != 0 && this.mIsLoaded) {
                ...
                this.mDDARTZNativePtr_ = 0L;
                DDLog.m33d("DualDAR:TZNative", "TZNative::unloadTA called", new Object[0]);
                return;
            }
            DDLog.m34e("DualDAR:TZNative", "TZNative::unloadTA called for TA that is not loaded. Call Ignored: ta loaded: " + this.mIsLoaded, new Object[0]);
        }
    }

    public TACommandResponse processTACommand(TACommandRequest tACommandRequest) {
        DDLog.m33d("DualDAR:TZNative", "TZNative::processTACommand: request = " + tACommandRequest + "; mDDARTZNativePtr_ = " + this.mDDARTZNativePtr_, new Object[0]);
        ...
        DDLog.m34e("DualDAR:TZNative", "TZNative::processTACommand: Error: nativeDDARProcessTACommand returned failure", new Object[0]);
        return null;
    }
}
