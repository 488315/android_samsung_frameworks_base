    ...
    public Bundle relay(int i, String str, String str2, Bundle bundle) {
        ...
        try {
            ...
            if (hashCode == 681038700 && str2.equals("TERMINATE_SECURE_SESSION")) {
                c = 1;
                if (c != 0) {
                    String establishSecureSession = establishSecureSession(i, str, bundle.getString("SECURE_CLIENT_ID"), bundle.getString("SECURE_CLIENT_PUB_KEY"));
                    bundle2 = new Bundle();
                    bundle2.putString("dual_dar_response", establishSecureSession);
                } else if (c == 1) {
                    boolean teardownSecureSession = teardownSecureSession(i, str, bundle.getString("SECURE_CLIENT_ID"));
                    bundle2 = new Bundle();
            ...
            DDLog.m34e("SystemProxyAgent", "RemoteException: name:" + str + " command:" + str2, new Object[0]);
            e.printStackTrace();
            return null;
        }
    }
