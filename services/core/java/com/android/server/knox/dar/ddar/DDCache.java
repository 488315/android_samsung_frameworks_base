        ...
        try {
            ...
            if (hashCode == 1729581666 && str.equals("SET_DATA_CMD")) {
                if (c != 0) {
                    ...
                    set(bundle.getInt("DUAL_DAR_USER_ID"), bundle.getString("DUAL_DAR_KEY"), bundle.getString("DUAL_DAR_VALUE"));
                    bundle2.putBoolean("dual_dar_response", true);
                } else if (c == 1) {
                    bundle2.putString("DUAL_DAR_VALUE", get(bundle.getInt("DUAL_DAR_USER_ID"), bundle.getString("DUAL_DAR_KEY")));
                    bundle2.putBoolean("dual_dar_response", true);
                } else if (c == 2) {
                    enforceCallingUser(i);
