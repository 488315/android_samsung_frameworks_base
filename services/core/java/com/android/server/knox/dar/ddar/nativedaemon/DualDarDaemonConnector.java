    ...
    public void run() {
        while (this.mIsListening) {
            try {
                ...
                DDLog.m34e("DualDarDaemonConnector", "Error connectiong to DualDAR daemon in NativeDaemonConnector: " + e, new Object[0]);
    ...
    public synchronized NativeDaemonEvent executeSync(String str, String str2, Object... objArr) {
        ...
        synchronized (this.mDaemonLock) {
            if (this.mOutputStream == null) {
                DDLog.m34e("DualDarDaemonConnector", "Missing Output stream - cannot write commands!", new Object[0]);
            } else {
                try {
            ...
            while (true) {
                DDLog.m33d("DualDarDaemonConnector", "Command Sent : sequence Number " + incrementAndGet + "task is " + str + " Command is " + str2, new Object[0]);
                remove = this.mResponseQueue.remove(incrementAndGet, str2, 60000);
                if (remove == null) {
                    DDLog.m34e("DualDarDaemonConnector", "timed-out waiting for response to " + str2, new Object[0]);
                    break;
                }
            ...
            if (remove != null && remove.isClassClientError()) {
                DDLog.m34e("DualDarDaemonConnector", "event = null or isClassClientError = true", new Object[0]);
            }
    ...
    */
    public final void listenToSocket() {
        ...
        try {
            try {
                ...
                try {
                    localSocket2.connect(new LocalSocketAddress(this.mSocket, LocalSocketAddress.Namespace.RESERVED));
                            ...
                            for (int i4 = 0; i4 < i2; i4++) {
                                if (bArr[i4] == 0) {
                                    ...
                                    try {
                                        ...
                                        DDLog.m34e("DualDarDaemonConnector", "Problem parsing message " + e, new Object[0]);
                                    }
                                    i3 = i4 + 1;
                                }
                            }
                    ...
                    DDLog.m34e("DualDarDaemonConnector", "got " + read + " reading with start = " + i, new Object[0]);
                    ...
                    synchronized (this.mDaemonLock) {
                        if (this.mOutputStream != null) {
                            try {
                                DDLog.m34e("DualDarDaemonConnector", "closing stream for " + this.mSocket, new Object[0]);
                                this.mOutputStream.close();
                            } catch (IOException e2) {
                                DDLog.m34e("DualDarDaemonConnector", "Failed closing output stream: " + e2, new Object[0]);
                            }
                ...
                synchronized (this.mDaemonLock) {
                    if (this.mOutputStream != null) {
                        try {
                            ...
                            DDLog.m34e("DualDarDaemonConnector", "Failed closing output stream: " + e5, new Object[0]);
                        }
                        this.mOutputStream = null;
                    }
                }
    ...
    public boolean handleMessage(Message message) {
        ...
        try {
            ...
            DDLog.m36v("DualDarDaemonConnector", String.format("Unhandled event '%s'", str), new Object[0]);
            return true;
        } catch (Exception e) {
            ...
            synchronized (this.mPendingCmds) {
                ...
                if (pendingCmd == null) {
                    while (this.mPendingCmds.size() >= this.mMaxCount) {
                        DDLog.m34e("DualDarDaemonConnector", "more buffered than allowed: " + this.mPendingCmds.size() + " >= " + this.mMaxCount, new Object[0]);
                        PendingCmd pendingCmd2 = (PendingCmd) this.mPendingCmds.remove();
                        DDLog.m34e("DualDarDaemonConnector", "Removing request: " + pendingCmd2.cmd + " (" + pendingCmd2.cmdNum + ")", new Object[0]);
                    }
