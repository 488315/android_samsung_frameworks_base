...
public class SeamLessSwitchHandler {
    ...
    public void launchSeamLessForSF() {
        ...
        if (!SemEmergencyManager.isEmergencyMode(this.f1706c) && !SemEmergencyManager.isMinimalBatteryUseMode(this.f1706c) && (launchUserId == -1 || !this.mUserManager.isUserRunning(launchUserId))) {
    ...
    public final boolean isSeamLessSwitchSupported(ActivityManager.RunningTaskInfo runningTaskInfo, ComponentName componentName, int i) {
        ...
        if (SemEmergencyManager.isEmergencyMode(this.f1706c) || SemEmergencyManager.isMinimalBatteryUseMode(this.f1706c) || this.SEAMLESS_NOTALLOWED_EXCEPTIONAL_LIST.contains(componentName.getPackageName()) || runningTaskInfo.configuration.windowConfiguration.getWindowingMode() != 1 || isPopupWindowRunning() || this.f1705am.isInLockTaskMode()) {
            return false;
        }
    ...
    public final void launchFolderContainerOrHome(int i, boolean z) {
        ...
        ResolveInfo resolveActivityAsUser = this.f1706c.getPackageManager().resolveActivityAsUser(intent, 65536, 0);
    ...
    public final boolean isAppLaunchable(String str, int i) {
        List queryIntentActivitiesAsUser = this.f1707pm.queryIntentActivitiesAsUser(new Intent("android.intent.action.MAIN", (Uri) null).addCategory("android.intent.category.LAUNCHER").setPackage(str), 786432, i);
    ...
    public final boolean isSecureFolderHidden() {
        return Settings.Secure.getIntForUser(this.f1706c.getContentResolver(), "hide_secure_folder_flag", 0, 0) == 1;
    }
            ...
            public void run() {
                try {
                    ...
                    if (SeamLessSwitchHandler.DEBUG) {
                        Log.d("SeamLessSwitchHandler", "insertSALog tracking_id=493-399-9953101, feature=" + str + " ,extra=" + str2);
                    }
                } catch (Exception e) {
