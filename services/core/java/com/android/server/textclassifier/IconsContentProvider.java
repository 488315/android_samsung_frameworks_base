...
public final class IconsContentProvider extends ContentProvider {
  public final ContentProvider.PipeDataWriter mWriter =
      new ContentProvider
        ...
        public final void writeDataToPipe(
            ...
            Bundle bundle,
            Object obj) {
          IconsContentProvider.this.lambda$new$0(
              parcelFileDescriptor, uri, str, bundle, (Pair) obj);
        }
      };
  ...
  public /* synthetic */ void lambda$new$0(
      ParcelFileDescriptor parcelFileDescriptor, Uri uri, String str, Bundle bundle, Pair pair) {
    try {
      ...
      try {
        ...
        getBitmap(
                Icon.createWithResource(resourceInfo.packageName, resourceInfo.f1728id)
                    .loadDrawableAsUser(getContext(), ((Integer) pair.second).intValue()))
            .compress(Bitmap.CompressFormat.PNG, 100, autoCloseOutputStream);
  ...
  public ParcelFileDescriptor openFile(Uri uri, String str) {
    ...
    try {
      return openPipeHelper(
          ...
          "image/png",
          null,
          new Pair(resourceInfo, Integer.valueOf(UserHandle.getCallingUserId())),
          this.mWriter);
    } catch (IOException e) {
