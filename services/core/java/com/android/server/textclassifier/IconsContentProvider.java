    ...
    public /* synthetic */ void lambda$new$0(ParcelFileDescriptor parcelFileDescriptor, Uri uri, String str, Bundle bundle, Pair pair) {
        try {
            ...
            try {
                ...
                getBitmap(Icon.createWithResource(resourceInfo.packageName, resourceInfo.f1728id).loadDrawableAsUser(getContext(), ((Integer) pair.second).intValue())).compress(Bitmap.CompressFormat.PNG, 100, autoCloseOutputStream);
