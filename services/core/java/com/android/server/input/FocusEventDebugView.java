...
public class FocusEventDebugView extends LinearLayout {
  ...
  public FocusEventDebugView(Context context) {
    ...
    this.mOuterPadding =
        (int)
            TypedValue.applyDimension(
                1, 16.0f, ((LinearLayout) this).mContext.getResources().getDisplayMetrics());
    setOrientation(0);
    setLayoutDirection(1);
    setGravity(8388691);
    PressedKeyContainer pressedKeyContainer =
        new PressedKeyContainer(((LinearLayout) this).mContext);
    ...
    final HorizontalScrollView horizontalScrollView =
        new HorizontalScrollView(((LinearLayout) this).mContext);
    ...
    horizontalScrollView.addOnLayoutChangeListener(
        new View
            .OnLayoutChangeListener() { // from class:
                                        // com.android.server.input.FocusEventDebugView$$ExternalSyntheticLambda0
    ...
    if (inputEvent instanceof KeyEvent) {
      post(
          new Runnable() { // from class:
                           // com.android.server.input.FocusEventDebugView$$ExternalSyntheticLambda1
  ...
  public final void handleKeyEvent(KeyEvent keyEvent) {
    PressedKeyContainer pressedKeyContainer;
    Pair pair =
        new Pair(Integer.valueOf(keyEvent.getDeviceId()), Integer.valueOf(keyEvent.getScanCode()));
    ...
    if (action != 0) {
      ...
      PressedKeyView pressedKeyView2 =
          new PressedKeyView(((LinearLayout) this).mContext, getLabel(keyEvent));
    ...
    switch (keyCode) {
      ...
      default:
        switch (keyCode) {
          ...
          case 269:
            return "↙";
          case FrameworkStatsLog.f392x1636cc72 /* 270 */:
            return "↗";
          case FrameworkStatsLog.f391x9ea7cdac /* 271 */:
            return "↘";
          default:
            ...
            return keyCodeToString.startsWith("KEYCODE_")
                ? keyCodeToString.substring(8)
                : keyCodeToString;
        }
    }
  }
  ...
  public class PressedKeyContainer extends LinearLayout {
    ...
    public PressedKeyContainer(Context context) {
      super(context);
      int applyDimension =
          (int) TypedValue.applyDimension(1, 16.0f, context.getResources().getDisplayMetrics());
    ...
    public void handleKeyRelease(PressedKeyView pressedKeyView) {
      ...
      pressedKeyView
          .animate()
          .alpha(DisplayPowerController2.RATE_FROM_DOZE_TO_ON)
          .setDuration(1000L)
          .setInterpolator(new AccelerateInterpolator())
          .withEndAction(
              new Runnable() { // from class:
                               // com.android.server.input.FocusEventDebugView$PressedKeyContainer$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
