...
public class WirelessKeyboardMouseShare {
  ...
  public Executor mExecutor =
      new Executor() { // from class: com.android.server.input.WirelessKeyboardMouseShare.1
  ...
  public class StatusInfo {
    ...
    public void setInfo(
      ...
      this.mFocusedDeviceToString =
          bluetoothDevice2 != null ? bluetoothDevice2.getAddress() : "null";
  ...
  public final void initializing() {
    String stringForUser =
        Settings.Secure.getStringForUser(
            this.mContext.getContentResolver(), "wireless_keyboard_setting_repository", 0);
  ...
  public WirelessKeyboardMouseShare(
      Context context, InputManagerService inputManagerService, ToastDialog toastDialog) {
    ...
    this.mCallback =
        new BluetoothHidDevice
            .Callback() { // from class: com.android.server.input.WirelessKeyboardMouseShare.4
              ...
              try {
                ...
                if (i == 2) {
                  if (WirelessKeyboardMouseShare.this.mAddIndex == 4) {
                    ...
                    wirelessKeyboardMouseShare.mAddIndex =
                        wirelessKeyboardMouseShare.getFirstEmptySlot();
                  }
                  WirelessKeyboardMouseShare wirelessKeyboardMouseShare2 =
                      WirelessKeyboardMouseShare.this;
                  i2 =
                      wirelessKeyboardMouseShare2.addPairedDevicesListLocked(
                          bluetoothDevice, wirelessKeyboardMouseShare2.mAddIndex);
                  if (i2 == 0) {
                    ...
                    if (wirelessKeyboardMouseShare3.existBluetoothDeviceLocked(
                      ...
                      WirelessKeyboardMouseShare wirelessKeyboardMouseShare4 =
                          WirelessKeyboardMouseShare.this;
                      wirelessKeyboardMouseShare4.sendMessageConnectDeviceLocked(
                          wirelessKeyboardMouseShare4.mFocusedDevice);
                    }
                    return;
                  }
                } else {
                ...
                if (i == 2) {
                  ...
                  if (!bluetoothDevice.equals(WirelessKeyboardMouseShare.this.mPluggedDevice)) {
                    ...
                    WirelessKeyboardMouseShare.this.mLastestConnectedName =
                  ...
                  WirelessKeyboardMouseShare.this
                      .mHandler
                      .obtainMessage(6, WirelessKeyboardMouseShare.this.mToLocalTablet ? 1 : 0, 0)
                      .sendToTarget();
                  WirelessKeyboardMouseShare.this.sendMessageStatus();
                  if (i2 == 2) {
                  ...
                  if (i == 0) {
                    ...
                    if (!WirelessKeyboardMouseShare.this.mDisconnectWithoutUnregister) {
                      if (WirelessKeyboardMouseShare.this.mPluggedDevice != null
                          && WirelessKeyboardMouseShare.this.mPluggedDevice.equals(
                              bluetoothDevice)) {
                        WirelessKeyboardMouseShare.this.stopHIDDevice();
                      } else {
                        if (WirelessKeyboardMouseShare.this.mHandler.hasMessages(11)) {
                        ...
                        WirelessKeyboardMouseShare.this.mHandler.sendMessageDelayed(
                            WirelessKeyboardMouseShare.this.mHandler.obtainMessage(11), 5000L);
                      }
                    }
                ...
                if (CoreRune.IFW_WIRELESS_KEYBOARD_SA_LOGGING && i == 2) {
                  for (int i3 = 1; i3 <= 3; i3++) {
                    BluetoothDevice bluetoothDevice2 =
                        WirelessKeyboardMouseShare.this.mPairedDevices[i3];
                    if (bluetoothDevice2 != null && bluetoothDevice.equals(bluetoothDevice2)) {
                      if (WirelessKeyboardMouseShare.this.mLogInfos.get(Integer.valueOf(i3))
                          != null) {
                        WirelessKeyboardMouseShare.this.mLogInfos.put(
                            Integer.valueOf(i3),
                            Integer.valueOf(
                                ((Integer)
                                            WirelessKeyboardMouseShare.this.mLogInfos.get(
                                                Integer.valueOf(i3)))
                                        .intValue()
                                    + 1));
                        return;
          ...
          public void onInterruptData(BluetoothDevice bluetoothDevice, byte b, byte[] bArr) {
            Slog.d(
                "WirelessKeyboardMouseShare",
                "intr data: reportId=" + ((int) b) + " data=" + Arrays.toString(bArr));
          }
          ...
          public void onGetReport(BluetoothDevice bluetoothDevice, byte b, byte b2, int i) {
            ...
            ReportData reportData =
                (ReportData) WirelessKeyboardMouseShare.this.mOutputReportCache.get(b2);
            if (reportData == null) {
          ...
          public void onSetReport(BluetoothDevice bluetoothDevice, byte b, byte b2, byte[] bArr) {
            ...
            if (b2 == 1) {
              ...
              Log.v(
                  "WirelessKeyboardMouseShare",
                  "onSetReport(), mouse report id, sending successful handshake for set report");
    ...
    context.registerReceiver(
        broadcastReceiver, intentFilter, null, wirelessKeyboardMouseShareHandler);
  }
    ...
    synchronized (this.innerLock) {
      ...
      if (!z) {
        ...
        if (bluetoothDevice2 != null
            && bluetoothDevice2.getAddress().equals(findBluetoothDeviceFromString.getAddress())) {
      ...
      if ((bluetoothDevice3 == null || !existBluetoothDeviceLocked(bluetoothDevice3)) && !z) {
        ...
        while (true) {
          ...
          if (bluetoothDevice4 != null) {
            ...
            Slog.d(
                "WirelessKeyboardMouseShare",
                "last connected device must be slot[" + i + "] " + this.mFocusedDevice.toString());
            break;
          }
          i++;
        }
  ...
  public void setHostRoleWirelessKeyboardShare() {
    synchronized (this.innerLock) {
      ...
      Slog.d(
          "WirelessKeyboardMouseShare", "setHostRoleWirelessKeyboardShare : -> Host role(tablet)");
    }
  }
  ...
  public void sendReadyToConnectIntent() {
    synchronized (this.innerLock) {
      ...
      Slog.d(
          "WirelessKeyboardMouseShare",
          "mReadyToConnect : " + this.mReadyToConnect + "mFinishNewDevice" + this.mFinishNewDevice);
      ...
      if (Equals != 0 || this.mNotiTurnOnBT || this.mNeedNoti || this.mNeedNotiTablet) {
        ...
        if (i2 != 0) {
          if (this.mPluggedDevice != null) {
            this.mToastDialog.showToastWKSDeviceSwitching(
                this.mContext.getResources().getString(17043401, getLastestConnectedName()));
          } else {
            this.mToastDialog.showToastWKSUnregister(
                this.mContext.getResources().getString(17043402, getLastestConnectedName()));
          }
        }
        if ((i3 != 0 || this.mNotiTurnOnBT) && isToLocalTablet()) {
          this.mToastDialog.showToastWKSDeviceSwitching(
              this.mContext.getResources().getString(17043401, getTabletName()));
        }
        if (this.mNeedNoti) {
          this.mToastDialog.showToastWKSParingFail(
              this.mContext.getResources().getString(17043396, getTabletName()));
          this.mUnregisterWhenConnectionFail = true;
          if (this.mHandler.hasMessages(11)) {
            this.mHandler.removeMessages(11);
          }
          ...
          SemContinuityManager semContinuityManager =
              (SemContinuityManager) this.mContext.getSystemService("SemContinuityService");
          ...
          this.mToastDialog.showAlertDialogWKS(
              this.mContext.getResources().getString(17043399),
              nearbyDeviceCount == 0
                  ? this.mContext.getResources().getString(17043400)
                  : this.mContext.getResources().getString(17043397)
                      + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE
                      + this.mContext.getResources().getString(17043398));
        }
        if (Equals != 0) {
  ...
  public boolean startHIDDevice() {
    synchronized (this.innerLock) {
      if (!this.mPogoConnected) {
        Slog.d(
            "WirelessKeyboardMouseShare", "startHIDDevice mPogoConnected : " + this.mPogoConnected);
        return false;
      }
      if (this.mAdapter == null) {
        this.mAdapter = BluetoothAdapter.getDefaultAdapter();
      ...
      registerApp();
      Slog.d(
          "WirelessKeyboardMouseShare", "startHIDDevice mAppRegistered : " + this.mAppRegistered);
  ...
  public final void unregisterApp() {
    synchronized (this.innerLock) {
      Slog.d(
          "WirelessKeyboardMouseShare", "unregisterApp(): mAppRegistered=" + this.mAppRegistered);
      if (this.mHandler.hasMessages(11)) {
        this.mHandler.removeMessages(11);
      }
      if (this.mAppRegistered) {
  ...
  public final int addPairedDevicesListLocked(BluetoothDevice bluetoothDevice, int i) {
    ...
    if (bluetoothDevice3 != null) {
      Slog.d(
          "WirelessKeyboardMouseShare", "not empty slot " + i + " " + bluetoothDevice3.toString());
    }
  ...
  public final void removePairedDevicesListLocked(String str, int i) {
        ...
        try {
          ...
          if (this.mLogInfos.get(Integer.valueOf(i)) != null) {
            CoreSaLogger.logForBasic(
                this.CONN_ID[i2],
                this.mLogInfos.get(Integer.valueOf(i)) + " " + bluetoothDevice.getName());
    ...
    for (int i3 = 1; i3 < 4; i3++) {
      ...
      if (address.equals(str)) {
        Slog.d(
            "WirelessKeyboardMouseShare",
            "exist other slot[" + i3 + "] requested_index=" + i + ", device=" + str);
      ...
      switch (message.what) {
        case 1:
          try {
            Slog.d(
                "WirelessKeyboardMouseShare",
                "registerApp()="
                    + WirelessKeyboardMouseShare.this.mHidDevice.registerApp(
                        ...
                        new BluetoothHidDeviceAppQosSettings(2, 900, 9, 900, 10000, 10000),
                        WirelessKeyboardMouseShare.this.mExecutor,
                        WirelessKeyboardMouseShare.this.mCallback));
            return;
        ...
        case 3:
          ...
          synchronized (WirelessKeyboardMouseShare.this.innerLock) {
            if (reportData != null) {
              WirelessKeyboardMouseShare.this.mHidDevice.replyReport(
                  WirelessKeyboardMouseShare.this.mPluggedDevice, (byte) 1, b, reportData.data);
            } else {
              new ReportData();
              if (b == 1) {
                byte[] bArr = new byte[8];
                ...
                WirelessKeyboardMouseShare.this.mHidDevice.replyReport(
                    WirelessKeyboardMouseShare.this.mPluggedDevice, (byte) 1, b, bArr);
              } else if (b == 2) {
                ...
                WirelessKeyboardMouseShare.this.mHidDevice.replyReport(
                    WirelessKeyboardMouseShare.this.mPluggedDevice, (byte) 1, b, bArr2);
              } else {
                Slog.d(
                    "WirelessKeyboardMouseShare",
                    "Get Report for Invalid report id = " + ((int) b));
                WirelessKeyboardMouseShare.this.mHidDevice.reportError(
                    WirelessKeyboardMouseShare.this.mPluggedDevice, (byte) 2);
              }
            }
          }
          return;
        case 4:
          Slog.d(
              "WirelessKeyboardMouseShare",
              "MESSAGE_SET_REPORT_RECEIVED for id = " + ((int) ((byte) message.arg1)));
          Slog.d(
              "WirelessKeyboardMouseShare",
              "onSetReport(), sending successful handshake for set report");
          WirelessKeyboardMouseShare.this.mHidDevice.reportError(
              WirelessKeyboardMouseShare.this.mPluggedDevice, (byte) 0);
          return;
        case 5:
        ...
        case 9:
          synchronized (WirelessKeyboardMouseShare.this.innerLock) {
            if (WirelessKeyboardMouseShare.this.mPluggedDevice == null
                && WirelessKeyboardMouseShare.this.isRegistered()) {
              if (WirelessKeyboardMouseShare.this.mHidDevice != null
                  && WirelessKeyboardMouseShare.this.mNextConnectedDevice != null
                  && WirelessKeyboardMouseShare.this.mRetryNum < 3) {
                Slog.d(
                    "WirelessKeyboardMouseShare",
                    "will connect "
                        + WirelessKeyboardMouseShare.this.mNextConnectedDevice.toString()
                        + " "
                        + WirelessKeyboardMouseShare.this.mRetryNum);
                WirelessKeyboardMouseShare.this.mHidDevice.connect(
                    WirelessKeyboardMouseShare.this.mNextConnectedDevice);
                WirelessKeyboardMouseShare.this.mRetryNum = 0;
              } else if (WirelessKeyboardMouseShare.this.mRetryNum > 2) {
                Slog.d(
                    "WirelessKeyboardMouseShare",
                    "retry count : " + WirelessKeyboardMouseShare.this.mRetryNum);
                WirelessKeyboardMouseShare.this.stopHIDDevice();
                WirelessKeyboardMouseShare.this.mRetryNum = 0;
              }
            }
            ...
            if (WirelessKeyboardMouseShare.this.mRetryNum < 3) {
              WirelessKeyboardMouseShare wirelessKeyboardMouseShare =
                  WirelessKeyboardMouseShare.this;
              wirelessKeyboardMouseShare.sendMessageConnectDeviceLocked(
                  wirelessKeyboardMouseShare.mNextConnectedDevice);
            } else {
              WirelessKeyboardMouseShare.this.mRetryNum = 0;
            }
          }
        ...
        case 10:
          synchronized (WirelessKeyboardMouseShare.this.innerLock) {
            if (WirelessKeyboardMouseShare.this.mAdapter != null
                && !WirelessKeyboardMouseShare.this.mAdapter.isEnabled()) {
              Slog.d("WirelessKeyboardMouseShare", "startHIDDeviceByKey need to turn on bt.");
              WirelessKeyboardMouseShare.this.mNeedToTurnOnBT = true;
              WirelessKeyboardMouseShare.this.mAdapter.enable();
              return;
            } else if (WirelessKeyboardMouseShare.this.isRegistered()
        ...
        case 11:
          synchronized (WirelessKeyboardMouseShare.this.innerLock) {
            ...
            if (WirelessKeyboardMouseShare.this.isRegistered()
                && WirelessKeyboardMouseShare.this.mUnregisterWhenConnectionFail) {
              WirelessKeyboardMouseShare.this.stopHIDDevice();
            }
          }
          return;
  ...
  public class Keyboard {
    ...
    public void clear(boolean z) {
      ...
      synchronized (WirelessKeyboardMouseShare.this.innerLock) {
        ...
        try {
          WirelessKeyboardMouseShare.this.mHidDevice.sendReport(
              WirelessKeyboardMouseShare.this.mPluggedDevice, this.mId, this.mBuffer);
        } catch (NullPointerException unused) {
  ...
  public /* synthetic */ void lambda$notifySALogging$1(Map.Entry entry) {
    try {
      ...
      CoreSaLogger.logForBasic(
          this.CONN_ID[intValue - 1], intValue2 + " " + this.mPairedDevices[intValue].getName());
    } catch (NullPointerException unused) {
      Slog.d("WirelessKeyboardMouseShare", "notifySALogging nullpointer exception");
    }
  }
