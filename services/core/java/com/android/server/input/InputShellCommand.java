...
public class InputShellCommand extends ShellCommand {
  ...
  public final void onHelp() {
    ...
    try {
      ...
      outPrintWriter.println(
          "      keyevent [--longpress|--doubletap] <key code number or name> ... (Default:"
              + " keyboard)");
  ...
  public final void runText(int i, int i2) {
    sendText(
        getSource(i, FrameworkStatsLog.HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__UP),
        getNextArgRequired(),
        i2);
  }
    ...
    if (z) {
      ...
      injectKeyEvent(
          KeyEvent.changeTimeRepeat(
              keyEvent, uptimeMillis + ViewConfiguration.getLongPressTimeout(), 1, 128));
    }
  ...
  public final void sendTap(int i, float f, float f2, int i2) {
    ...
    injectMotionEvent(
        i, 1, uptimeMillis, uptimeMillis, f, f2, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, i2);
  }
  ...
  public final void sendSwipe(int i, int i2, boolean z) {
    ...
    while (uptimeMillis2 < j) {
      ...
      injectMotionEvent(
          ...
          uptimeMillis,
          uptimeMillis2,
          lerp(parseFloat, parseFloat3, f),
          lerp(parseFloat2, parseFloat4, f),
          1.0f,
          i2);
  ...
  public final void sendMove(int i, float f, float f2, int i2) {
    long uptimeMillis = SystemClock.uptimeMillis();
    injectMotionEvent(
        i, 2, uptimeMillis, uptimeMillis, f, f2, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, i2);
  }
