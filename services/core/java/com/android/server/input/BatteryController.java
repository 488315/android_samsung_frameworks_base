...
public final class BatteryController {
  ...
  interface BluetoothBatteryManager {
    ...
    void addMetadataListener(
        String str, BluetoothAdapter.OnMetadataChangedListener onMetadataChangedListener);
  ...
  public BatteryController(
      Context context, NativeInputManagerService nativeInputManagerService, Looper looper) {
    this(
        context,
        nativeInputManagerService,
        looper,
        new UEventManager() { // from class: com.android.server.input.BatteryController.1
        },
  ...
  public BatteryController(
      ...
      BluetoothBatteryManager bluetoothBatteryManager) {
    this.mLock = new Object();
    this.mListenerRecords = new ArrayMap();
    this.mDeviceMonitors = new ArrayMap();
    this.mIsPolling = false;
    this.mIsInteractive = true;
    this.mInputDeviceListener =
        new InputManager
            .InputDeviceListener() { // from class: com.android.server.input.BatteryController.2
          ...
          public void onInputDeviceAdded(int i) {
            synchronized (BatteryController.this.mLock) {
              if (BatteryController.this.isUsiDevice(i)
                  && !BatteryController.this.mDeviceMonitors.containsKey(Integer.valueOf(i))) {
                BatteryController.this.mDeviceMonitors.put(
                    Integer.valueOf(i), BatteryController.this.new UsiDeviceMonitor(i));
              }
            }
          }
          ...
          public void onInputDeviceChanged(int i) {
            synchronized (BatteryController.this.mLock) {
              DeviceMonitor deviceMonitor =
                  (DeviceMonitor) BatteryController.this.mDeviceMonitors.get(Integer.valueOf(i));
  ...
  public void registerBatteryListener(
      int i, IInputDeviceBatteryListener iInputDeviceBatteryListener, int i2) {
    synchronized (this.mLock) {
      ListenerRecord listenerRecord =
          (ListenerRecord) this.mListenerRecords.get(Integer.valueOf(i2));
      ...
      if (listenerRecord.mListener.asBinder() != iInputDeviceBatteryListener.asBinder()) {
        throw new SecurityException(
            "Cannot register a new battery listener when there is already another registered"
                + " listener for pid "
                + i2);
      }
      if (!listenerRecord.mMonitoredDevices.add(Integer.valueOf(i))) {
        throw new IllegalArgumentException(
            "The battery listener for pid " + i2 + " is already monitoring deviceId " + i);
      }
  ...
  public static void notifyBatteryListener(ListenerRecord listenerRecord, State state) {
    ...
    if (DEBUG) {
      Slog.d(
          TAG,
          "Notified battery listener from pid "
              + listenerRecord.mPid
              + " of state of deviceId "
              + ((IInputDeviceBatteryState) state).deviceId);
    }
  }
  ...
  public final void notifyAllListenersForDevice(final State state) {
    synchronized (this.mLock) {
      ...
      this.mListenerRecords.forEach(
          new BiConsumer() { // from class:
                             // com.android.server.input.BatteryController$$ExternalSyntheticLambda10
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
              BatteryController.lambda$notifyAllListenersForDevice$0(
                  BatteryController.State.this,
                  (Integer) obj,
                  (BatteryController.ListenerRecord) obj2);
            }
          });
    }
  }

  public static /* synthetic */ void lambda$notifyAllListenersForDevice$0(
      State state, Integer num, ListenerRecord listenerRecord) {
    if (listenerRecord.mMonitoredDevices.contains(
        Integer.valueOf(((IInputDeviceBatteryState) state).deviceId))) {
  ...
  public final void updatePollingLocked(boolean z) {
    if (!this.mIsInteractive
        || !anyOf(
            this.mDeviceMonitors,
            new Predicate() { // from class:
                              // com.android.server.input.BatteryController$$ExternalSyntheticLambda3
      ...
      this.mHandler.postDelayed(
          new BatteryController$$ExternalSyntheticLambda4(this), z ? POLLING_PERIOD_MILLIS : 0L);
    }
  }
    ...
    return (String)
        processInputDevice(
            ...
            new Function() { // from class:
                             // com.android.server.input.BatteryController$$ExternalSyntheticLambda5
  ...
  public final boolean hasBattery(int i) {
    return ((Boolean)
            processInputDevice(
                ...
                Boolean.FALSE,
                new Function() { // from class:
                                 // com.android.server.input.BatteryController$$ExternalSyntheticLambda2
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
  ...
  public final boolean isUsiDevice(int i) {
    return ((Boolean)
            processInputDevice(
                ...
                Boolean.FALSE,
                new Function() { // from class:
                                 // com.android.server.input.BatteryController$$ExternalSyntheticLambda8
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
                    Boolean lambda$isUsiDevice$1;
                    lambda$isUsiDevice$1 =
                        BatteryController.lambda$isUsiDevice$1((InputDevice) obj);
    ...
    return getBluetoothDevice(
        ...
        (String)
            processInputDevice(
                ...
                null,
                new Function() { // from class:
                                 // com.android.server.input.BatteryController$$ExternalSyntheticLambda6
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
  ...
  public final DeviceMonitor getDeviceMonitorOrThrowLocked(int i) {
    ...
    Objects.requireNonNull(
        deviceMonitor, "Maps are out of sync: Cannot find device state for deviceId " + i);
  ...
  public void unregisterBatteryListener(
    ...
    synchronized (this.mLock) {
      ...
      if (listenerRecord == null) {
        throw new IllegalArgumentException(
            "Cannot unregister battery callback: No listener registered for pid " + i2);
      }
      if (listenerRecord.mListener.asBinder() != iInputDeviceBatteryListener.asBinder()) {
        throw new IllegalArgumentException(
            "Cannot unregister battery callback: The listener is not the one that is registered for"
                + " pid "
                + i2);
      }
      if (!listenerRecord.mMonitoredDevices.contains(Integer.valueOf(i))) {
        throw new IllegalArgumentException(
            "Cannot unregister battery callback: The device is not being monitored for deviceId "
                + i);
      }
  ...
  public final void unregisterRecordLocked(ListenerRecord listenerRecord, int i) {
    ...
    if (!listenerRecord.mMonitoredDevices.remove(Integer.valueOf(i))) {
      throw new IllegalStateException(
          "Cannot unregister battery callback: The deviceId "
              + i
  ...
  public final boolean hasRegisteredListenerForDeviceLocked(int i) {
    for (int i2 = 0; i2 < this.mListenerRecords.size(); i2++) {
      if (((ListenerRecord) this.mListenerRecords.valueAt(i2))
          .mMonitoredDevices.contains(Integer.valueOf(i))) {
        return true;
      }
    }
    return false;
  ...
  public final void handleListeningProcessDied(int i) {
    synchronized (this.mLock) {
      ListenerRecord listenerRecord =
          (ListenerRecord) this.mListenerRecords.get(Integer.valueOf(i));
      if (listenerRecord == null) {
        return;
      }
      if (DEBUG) {
  ...
  public final void handlePollEvent() {
    synchronized (this.mLock) {
      if (this.mIsPolling) {
        ...
        this.mDeviceMonitors.forEach(
            new BiConsumer() { // from class:
                               // com.android.server.input.BatteryController$$ExternalSyntheticLambda9
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
        ...
        this.mHandler.postDelayed(
            new BatteryController$$ExternalSyntheticLambda4(this), POLLING_PERIOD_MILLIS);
      }
    }
  }
      ...
      DeviceMonitor deviceMonitor =
          (DeviceMonitor)
              findIf(
                  this.mDeviceMonitors,
                  new Predicate() { // from class:
                                    // com.android.server.input.BatteryController$$ExternalSyntheticLambda7
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$handleBluetoothBatteryLevelChange$3;
                      lambda$handleBluetoothBatteryLevelChange$3 =
                          BatteryController.lambda$handleBluetoothBatteryLevelChange$3(
                              str, (BatteryController.DeviceMonitor) obj);
  ...
  public static /* synthetic */ boolean lambda$handleBluetoothBatteryLevelChange$3(
      String str, DeviceMonitor deviceMonitor) {
    return deviceMonitor.mBluetoothDevice != null
        && str.equals(deviceMonitor.mBluetoothDevice.getAddress());
  }

  public final void handleBluetoothMetadataChange(
      final BluetoothDevice bluetoothDevice, int i, byte[] bArr) {
    synchronized (this.mLock) {
      DeviceMonitor deviceMonitor =
          (DeviceMonitor)
              findIf(
                  this.mDeviceMonitors,
                  new Predicate() { // from class:
                                    // com.android.server.input.BatteryController$$ExternalSyntheticLambda11
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$handleBluetoothMetadataChange$4;
                      lambda$handleBluetoothMetadataChange$4 =
                          BatteryController.lambda$handleBluetoothMetadataChange$4(
                              bluetoothDevice, (BatteryController.DeviceMonitor) obj);
  ...
  public static /* synthetic */ boolean lambda$handleBluetoothMetadataChange$4(
      BluetoothDevice bluetoothDevice, DeviceMonitor deviceMonitor) {
  ...
  public void dump(PrintWriter printWriter) {
    ...
    synchronized (this.mLock) {
      ...
      indentingPrintWriter.println(
          "State: Polling = " + this.mIsPolling + ", Interactive = " + this.mIsInteractive);
  ...
  public class ListenerRecord {
      ...
      this.mDeathRecipient =
          new IBinder
              .DeathRecipient() { // from class:
                                  // com.android.server.input.BatteryController$ListenerRecord$$ExternalSyntheticLambda0
    ...
    public String toString() {
      return "pid="
          + this.mPid
          + ", monitored devices="
          + Arrays.toString(this.mMonitoredDevices.toArray());
    }
  }
  ...
  public final State queryBatteryStateFromNative(int i, long j, boolean z) {
    return new State(
        ...
        j,
        z,
        z ? this.mNative.getBatteryStatus(i) : 1,
        z ? this.mNative.getBatteryCapacity(i) / 100.0f : Float.NaN);
  }
  ...
  public final void updateBluetoothBatteryMonitoring() {
    synchronized (this.mLock) {
      if (anyOf(
          this.mDeviceMonitors,
          new Predicate() { // from class:
                            // com.android.server.input.BatteryController$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$updateBluetoothBatteryMonitoring$5;
              lambda$updateBluetoothBatteryMonitoring$5 =
                  BatteryController.lambda$updateBluetoothBatteryMonitoring$5(
                      (BatteryController.DeviceMonitor) obj);
        ...
        if (this.mBluetoothBatteryListener == null) {
          ...
          BluetoothBatteryManager.BluetoothBatteryListener bluetoothBatteryListener =
              new BluetoothBatteryManager
                  .BluetoothBatteryListener() { // from class:
                                                // com.android.server.input.BatteryController$$ExternalSyntheticLambda1
  ...
  public static /* synthetic */ boolean lambda$updateBluetoothBatteryMonitoring$5(
      DeviceMonitor deviceMonitor) {
    return deviceMonitor.mBluetoothDevice != null;
  }
  ...
  public class DeviceMonitor {
    ...
    public void onConfiguration(long j) {
      processChangesAndNotify(
          j,
          new Consumer() { // from class:
                           // com.android.server.input.BatteryController$DeviceMonitor$$ExternalSyntheticLambda3
    ...
    public final void configureDeviceMonitor(long j) {
      ...
      if (this.mBluetoothDevice != null) {
        this.mBluetoothBatteryLevel =
            BatteryController.this.mBluetoothBatteryManager.getBatteryLevel(
    ...
    public final void startNativeMonitoring() {
      String batteryDevicePath =
          BatteryController.this.mNative.getBatteryDevicePath(
              ((IInputDeviceBatteryState) this.mState).deviceId);
      if (batteryDevicePath == null) {
        return;
      }
      final int i = ((IInputDeviceBatteryState) this.mState).deviceId;
      this.mUEventBatteryListener =
          new UEventManager
              .UEventBatteryListener() { // from class:
                                         // com.android.server.input.BatteryController.DeviceMonitor.1
      ...
      BatteryController.this.mUEventManager.addListener(
          this.mUEventBatteryListener, "DEVPATH=" + formatDevPath(batteryDevicePath));
    }
    ...
    public final void startBluetoothMetadataMonitoring(long j) {
      ...
      this.mBluetoothMetadataListener =
          new BluetoothAdapter
              .OnMetadataChangedListener() { // from class:
                                             // com.android.server.input.BatteryController$DeviceMonitor$$ExternalSyntheticLambda2
      ...
      BatteryController.this.mBluetoothBatteryManager.addMetadataListener(
          this.mBluetoothDevice.getAddress(), this.mBluetoothMetadataListener);
      updateBluetoothMetadataState(
          j,
          18,
          BatteryController.this.mBluetoothBatteryManager.getMetadata(
              this.mBluetoothDevice.getAddress(), 18));
      updateBluetoothMetadataState(
          j,
          19,
          BatteryController.this.mBluetoothBatteryManager.getMetadata(
              this.mBluetoothDevice.getAddress(), 19));
    }
    ...
    public final void stopBluetoothMetadataMonitoring() {
      ...
      Objects.requireNonNull(this.mBluetoothDevice);
      BatteryController.this.mBluetoothBatteryManager.removeMetadataListener(
          this.mBluetoothDevice.getAddress(), this.mBluetoothMetadataListener);
    ...
    public void updateBatteryStateFromNative(long j) {
      ...
      state.updateIfChanged(
          BatteryController.this.queryBatteryStateFromNative(
              ((IInputDeviceBatteryState) state).deviceId, j, this.mHasBattery));
    }

    public void onPoll(long j) {
      processChangesAndNotify(
          j, new BatteryController$DeviceMonitor$$ExternalSyntheticLambda1(this));
    }
    ...
    public void onBluetoothBatteryChanged(long j, final int i) {
      processChangesAndNotify(
          j,
          new Consumer() { // from class:
                           // com.android.server.input.BatteryController$DeviceMonitor$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              BatteryController.DeviceMonitor.this.lambda$onBluetoothBatteryChanged$0(
                  i, (Long) obj);
            }
          });
    }
    ...
    public void onBluetoothMetadataChanged(long j, final int i, final byte[] bArr) {
      processChangesAndNotify(
          j,
          new Consumer() { // from class:
                           // com.android.server.input.BatteryController$DeviceMonitor$$ExternalSyntheticLambda5
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              BatteryController.DeviceMonitor.this.lambda$onBluetoothMetadataChanged$1(
                  i, bArr, (Long) obj);
            }
          });
    }
    ...
    public final void updateBluetoothMetadataState(long j, int i, byte[] bArr) {
      ...
      if (bArr != null) {
        try {
          ...
          Slog.wtf(
              BatteryController.TAG,
              "Failed to parse bluetooth METADATA_MAIN_BATTERY with value '"
                  + new String(bArr)
                  + "' for device "
    ...
    public State getBatteryStateForReporting() {
      return (State)
          Objects.requireNonNullElseGet(
              resolveBluetoothBatteryState(),
              new Supplier() { // from class:
                               // com.android.server.input.BatteryController$DeviceMonitor$$ExternalSyntheticLambda0
                @Override // java.util.function.Supplier
                public final Object get() {
                  BatteryController.State lambda$getBatteryStateForReporting$2;
                  lambda$getBatteryStateForReporting$2 =
                      BatteryController.DeviceMonitor.this.lambda$getBatteryStateForReporting$2();
    ...
    public State resolveBluetoothBatteryState() {
      ...
      return new State(
          ((IInputDeviceBatteryState) this.mState).deviceId,
          this.mBluetoothEventTime,
          true,
          this.mBluetoothMetadataBatteryStatus,
          i / 100.0f);
    }
    ...
    public String toString() {
      ...
      sb.append(", Name='");
      sb.append(
          BatteryController.this.getInputDeviceName(
              ((IInputDeviceBatteryState) this.mState).deviceId));
  ...
  public class UsiDeviceMonitor extends DeviceMonitor {
    ...
    public void onUEvent(long j) {
      processChangesAndNotify(
          j,
          new Consumer() { // from class:
                           // com.android.server.input.BatteryController$UsiDeviceMonitor$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onStylusGestureStarted(long j) {
      processChangesAndNotify(
          j,
          new Consumer() { // from class:
                           // com.android.server.input.BatteryController$UsiDeviceMonitor$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public /* synthetic */ void lambda$onStylusGestureStarted$1(Long l) {
      if ((this.mValidityTimeoutCallback != null)
          || ((IInputDeviceBatteryState) this.mState).capacity
    ...
    public void onTimeout(long j) {
      processChangesAndNotify(
          j,
          new Consumer() { // from class:
                           // com.android.server.input.BatteryController$UsiDeviceMonitor$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onConfiguration(long j) {
      ...
      if (!this.mHasBattery) {
        throw new IllegalStateException(
            "UsiDeviceMonitor: USI devices are always expected to report a valid battery, but no"
      ...
      if (this.mValidityTimeoutCallback != null) {
        ...
        this.mValidityTimeoutCallback =
            new Runnable() { // from class:
                             // com.android.server.input.BatteryController$UsiDeviceMonitor$$ExternalSyntheticLambda2
    ...
    public State getBatteryStateForReporting() {
      return (State)
          Objects.requireNonNullElseGet(
              resolveBluetoothBatteryState(),
              new Supplier() { // from class:
                               // com.android.server.input.BatteryController$UsiDeviceMonitor$$ExternalSyntheticLambda1
                @Override // java.util.function.Supplier
                public final Object get() {
                  BatteryController.State lambda$getBatteryStateForReporting$4;
                  lambda$getBatteryStateForReporting$4 =
                      BatteryController.UsiDeviceMonitor.this
                          .lambda$getBatteryStateForReporting$4();
    ...
    public /* synthetic */ State lambda$getBatteryStateForReporting$4() {
      return this.mValidityTimeoutCallback != null
          ? new State(this.mState)
          : new State(((IInputDeviceBatteryState) this.mState).deviceId);
    }
  ...
  interface UEventManager {
    ...
    public abstract class UEventBatteryListener {
      public final UEventObserver mObserver =
          new UEventObserver() { // from class:
                                 // com.android.server.input.BatteryController.UEventManager.UEventBatteryListener.1
            public void onUEvent(UEventObserver.UEvent uEvent) {
              long uptimeMillis = SystemClock.uptimeMillis();
              if (BatteryController.DEBUG) {
                Slog.d(
                    BatteryController.TAG,
                    "UEventListener: Received UEvent: " + uEvent + " eventTime: " + uptimeMillis);
              }
              if ("CHANGE".equalsIgnoreCase(uEvent.get("ACTION"))
                  && "POWER_SUPPLY".equalsIgnoreCase(uEvent.get("SUBSYSTEM"))) {
  ...
  public class LocalBluetoothBatteryManager implements BluetoothBatteryManager {
    public final BroadcastReceiver mBroadcastReceiver =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.input.BatteryController.LocalBluetoothBatteryManager.1
            ...
            if ("android.bluetooth.device.action.BATTERY_LEVEL_CHANGED".equals(intent.getAction())
                && (bluetoothDevice =
                        (BluetoothDevice)
                            intent.getParcelableExtra(
                                "android.bluetooth.device.extra.DEVICE", BluetoothDevice.class))
                    != null) {
              ...
              synchronized (LocalBluetoothBatteryManager.this.mBroadcastReceiver) {
                if (LocalBluetoothBatteryManager.this.mRegisteredListener != null) {
                  LocalBluetoothBatteryManager.this.mRegisteredListener.onBluetoothBatteryChanged(
                      SystemClock.uptimeMillis(), bluetoothDevice.getAddress(), intExtra);
                }
              }
            }
          }
    ...
    public void addMetadataListener(
      ...
      bluetoothManager
          ...
          .addOnMetadataChangedListener(
              BatteryController.getBluetoothDevice(this.mContext, str),
              this.mExecutor,
    ...
    public void removeMetadataListener(
      ...
      bluetoothManager
          ...
          .removeOnMetadataChangedListener(
              BatteryController.getBluetoothDevice(this.mContext, str), onMetadataChangedListener);
    }
  ...
  public class State extends IInputDeviceBatteryState {
    ...
    public final void copyFrom(IInputDeviceBatteryState iInputDeviceBatteryState) {
      initialize(
          iInputDeviceBatteryState.deviceId,
          iInputDeviceBatteryState.updateTime,
          iInputDeviceBatteryState.isPresent,
          iInputDeviceBatteryState.status,
          iInputDeviceBatteryState.capacity);
    }
    ...
    public String toString() {
      ...
      return "State{time="
          + ((IInputDeviceBatteryState) this).updateTime
          + ", isPresent="
          + ((IInputDeviceBatteryState) this).isPresent
          + ", status="
          + ((IInputDeviceBatteryState) this).status
          + ", capacity="
          + ((IInputDeviceBatteryState) this).capacity
          + "}";
    }
  }
