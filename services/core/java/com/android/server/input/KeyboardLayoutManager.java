...
public final class KeyboardLayoutManager implements InputManager.InputDeviceListener {
    ...
    public final void showConfiguredKeyboardLayoutNotification() {
        Resources resources = this.mContext.getResources();
        if (this.mConfiguredKeyboards.size() != 1) {
            showKeyboardLayoutNotification(resources.getString(android.R.string.needPuk2), resources.getString(android.R.string.needPuk), null);
            return;
        }
        InputDevice inputDevice = getInputDevice(this.mConfiguredKeyboards.keyAt(0));
        ...
        showKeyboardLayoutNotification(resources.getString(android.R.string.network_available_sign_in, inputDevice.getName()), createConfiguredNotificationText(this.mContext, keyboardConfiguration.getConfiguredLayouts()), inputDevice);
    }
    ...
    public final String createConfiguredNotificationText(Context context, Set set) {
        ...
        if (size == 2) {
            return resources.getString(android.R.string.network_logging_notification_text, arrayList.get(0), arrayList.get(1));
        }
        if (size == 3) {
            return resources.getString(android.R.string.network_available_sign_in_detailed, arrayList.get(0), arrayList.get(1), arrayList.get(2));
        }
        return resources.getString(android.R.string.nas_upgrade_notification_title, arrayList.get(0), arrayList.get(1), arrayList.get(2));
    }
