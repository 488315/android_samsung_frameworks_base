...
public class Vr2dDisplay {
  ...
  public final IPersistentVrStateCallbacks mVrStateCallbacks =
      new IPersistentVrStateCallbacks.Stub() { // from class: com.android.server.vr.Vr2dDisplay.1
  ...
  */
  public void setVirtualDisplayProperties(Vr2dDisplayProperties vr2dDisplayProperties) {
    ...
    synchronized (this.mVdLock) {
      ...
      if (width >= 1 && height >= 1 && dpi >= 1) {
        ...
        if (virtualDisplay != null && z && this.mIsVirtualDisplayAllowed) {
          virtualDisplay.resize(
              this.mVirtualDisplayWidth, this.mVirtualDisplayHeight, this.mVirtualDisplayDpi);
      ...
      Log.i(
          "Vr2dDisplay", "Ignoring Width/Height/Dpi values of " + width + "," + height + "," + dpi);
      z = false;
      if ((vr2dDisplayProperties.getAddedFlags() & 1) != 1) {}
      virtualDisplay = this.mVirtualDisplay;
  ...
  public final void startVirtualDisplay() {
    ...
    synchronized (this.mVdLock) {
      ...
      VirtualDisplay createVirtualDisplay =
          this.mDisplayManager.createVirtualDisplay(null, builder.build(), null, null);
  ...
  public final void startImageReader() {
    if (this.mImageReader == null) {
      this.mImageReader =
          ImageReader.newInstance(this.mVirtualDisplayWidth, this.mVirtualDisplayHeight, 1, 2);
      Log.i(
          "Vr2dDisplay",
          "VD startImageReader: res = "
              + this.mVirtualDisplayWidth
              + "X"
              + this.mVirtualDisplayHeight
              + ", dpi = "
  ...
  public final boolean shouldRunVirtualDisplay() {
    return this.mIsVirtualDisplayAllowed
        && (this.mBootsToVr || this.mIsPersistentVrModeEnabled || this.mIsVrModeOverrideEnabled);
  }
}
