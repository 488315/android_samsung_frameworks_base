...
public class VrManagerService extends SystemService
  ...
  public static final ManagedApplicationService.BinderChecker sBinderChecker =
      new ManagedApplicationService
          .BinderChecker() { // from class: com.android.server.vr.VrManagerService.3
      ...
      this.mPendingState =
          (!z3 || (managedApplicationService = this.mCurrentVrService) == null)
              ...
              : new VrState(
                  z3,
                  this.mRunning2dInVr,
                  managedApplicationService.getComponent(),
                  this.mCurrentVrService.getUserId(),
  ...
  public final class LocalService extends VrManagerInternal {
    ...
    public void setVrMode(
        boolean z, ComponentName componentName, int i, int i2, ComponentName componentName2) {
    ...
    @Override // com.android.server.vr.VrManagerInternal
    public void addPersistentVrModeStateListener(
  ...
  public VrManagerService(Context context) {
    ...
    this.mEventCallback =
        new ManagedApplicationService
            .EventCallback() { // from class: com.android.server.vr.VrManagerService.1
          ...
          public void onServiceEvent(ManagedApplicationService.LogEvent logEvent) {
            ...
            synchronized (VrManagerService.this.mLock) {
              component =
                  VrManagerService.this.mCurrentVrService == null
                      ? null
                      : VrManagerService.this.mCurrentVrService.getComponent();
              if (component != null
                  && component.equals(logEvent.component)
          ...
          public void handleMessage(Message message) {
            ...
            if (i == 1) {
              ...
              if (i == 2) {
                z = message.arg1 == 1;
                int beginBroadcast2 =
                    VrManagerService.this.mPersistentVrStateRemoteCallbacks.beginBroadcast();
    ...
    this.mVrManager =
        new IVrManager.Stub() { // from class: com.android.server.vr.VrManagerService.4
          public void registerListener(IVrStateCallbacks iVrStateCallbacks) {
            VrManagerService.this.enforceCallerPermissionAnyOf(
                "android.permission.ACCESS_VR_MANAGER", "android.permission.ACCESS_VR_STATE");
          ...
          public void registerPersistentVrStateListener(
              IPersistentVrStateCallbacks iPersistentVrStateCallbacks) {
            VrManagerService.this.enforceCallerPermissionAnyOf(
                "android.permission.ACCESS_VR_MANAGER", "android.permission.ACCESS_VR_STATE");
          ...
          public void unregisterPersistentVrStateListener(
              IPersistentVrStateCallbacks iPersistentVrStateCallbacks) {
            VrManagerService.this.enforceCallerPermissionAnyOf(
                "android.permission.ACCESS_VR_MANAGER", "android.permission.ACCESS_VR_STATE");
            if (iPersistentVrStateCallbacks == null) {
          ...
          public void dump(
            ...
            if (DumpUtils.checkDumpPermission(
              ...
              sb3.append(
                  VrManagerService.this.mCurrentVrService == null
                      ? "None"
                      : VrManagerService.this.mCurrentVrService.getComponent().flattenToString());
              printWriter.println(sb3.toString());
              StringBuilder sb4 = new StringBuilder();
              sb4.append("Currently bound VR compositor service: ");
              sb4.append(
                  VrManagerService.this.mCurrentVrCompositorService == null
                      ? "None"
                      : VrManagerService.this
                          .mCurrentVrCompositorService
                          .getComponent()
                          .flattenToString());
              ...
              while (true) {
                ...
                printWriter.print("  ");
                printWriter.print(
                    VrManagerService.this.mVrStateRemoteCallbacks.getBroadcastItem(i));
                if (i > 0) {
                  printWriter.println(",");
                }
                beginBroadcast = i;
              ...
              while (true) {
                ...
                printWriter.print("  ");
                printWriter.print(
                    VrManagerService.this.mPersistentVrStateRemoteCallbacks.getBroadcastItem(i2));
                if (i2 > 0) {
                  printWriter.println(",");
                }
                beginBroadcast2 = i2;
  ...
  public void onBootPhase(int i) {
    if (i == 500) {
      ...
      synchronized (this.mLock) {
        ...
        arrayList.add(this);
        EnabledComponentsObserver build =
            EnabledComponentsObserver.build(
                this.mContext,
                handler,
      ...
      getContext()
          .registerReceiver(
              new BroadcastReceiver() { // from class: com.android.server.vr.VrManagerService.5
  ...
  public final boolean updateCurrentVrServiceLocked(
      boolean z,
      boolean z2,
      ComponentName componentName,
      int i,
    ...
    try {
      ...
      String packageName =
          managedApplicationService != null
              ? managedApplicationService.getComponent().getPackageName()
              : null;
      ...
      if (!z7) {
        if (this.mCurrentVrService != null) {
          Slog.i(
              "VrManagerService",
              "Leaving VR mode, disconnecting "
                  + this.mCurrentVrService.getComponent()
                  + " for user "
                  + this.mCurrentVrService.getUserId());
      ...
      if (((componentName2 != null || this.mPersistentVrModeEnabled)
              && !Objects.equals(componentName2, this.mCurrentVrModeComponent))
      ...
      updateDependentAppOpsLocked(
          managedApplicationService3 != null
              ? managedApplicationService3.getComponent().getPackageName()
              : null,
          this.mCurrentVrModeUser,
          packageName,
          i3);
  ...
  public final void callFocusedActivityChangedLocked() {
    ...
    this.mCurrentVrService.sendEvent(
        new ManagedApplicationService
            .PendingEvent() { // from class: com.android.server.vr.VrManagerService.6
  ...
  public final void grantNotificationPolicyAccess(String str) {
    ((NotificationManager) this.mContext.getSystemService(NotificationManager.class))
        .setNotificationPolicyAccessGranted(str, true);
  }
  ...
  public final void grantCoarseLocationPermissionIfNeeded(String str, int i) {
    ...
    try {
      ...
      Slog.w(
          "VrManagerService",
          "Could not grant coarse location permission, package " + str + " was removed.");
    }
  }
  ...
  public final void revokeCoarseLocationPermissionIfNeeded(String str, int i) {
    ...
    try {
      ...
      Slog.w(
          "VrManagerService",
          "Could not revoke coarse location permission, package " + str + " was removed.");
    }
  }

  public final boolean isPermissionUserUpdated(String str, String str2, int i) {
    return (this.mContext.getPackageManager().getPermissionFlags(str, str2, new UserHandle(i)) & 3)
        != 0;
  }
  ...
  public final ManagedApplicationService createVrListenerService(
      ComponentName componentName, int i) {
    return ManagedApplicationService.build(
        this.mContext,
        componentName,
        i,
        17043252,
  ...
  public final ManagedApplicationService createVrCompositorService(
      ComponentName componentName, int i) {
    return ManagedApplicationService.build(
        this.mContext,
        componentName,
  ...
  public final void logStateLocked() {
    ...
    logEvent(
        new VrState(
            this.mVrModeEnabled,
            this.mRunning2dInVr,
            managedApplicationService == null ? null : managedApplicationService.getComponent(),
            this.mCurrentVrModeUser,
            this.mVrAppProcessId,
            this.mCurrentVrModeComponent,
            this.mWasDefaultGranted));
  }
  ...
  public final void dumpStateTransitions(PrintWriter printWriter) {
    ...
    synchronized (this.mLoggingDeque) {
      ...
      while (it.hasNext()) {
        printWriter.println(
            ((ManagedApplicationService.LogFormattable) it.next()).toLogString(simpleDateFormat));
      }
    }
  }
  ...
  */
  ...
  public final void updateCompositorServiceLocked(int i, ComponentName componentName) {
    ...
    if (managedApplicationService != null
        && managedApplicationService.disconnectIfNotMatching(componentName, i)) {
      Slog.i(
          "VrManagerService",
          "Disconnecting compositor service: " + this.mCurrentVrCompositorService.getComponent());
    ...
    ManagedApplicationService createVrCompositorService =
        createVrCompositorService(componentName, i);
  ...
  public final boolean isCurrentVrListener(String str, int i) {
    synchronized (this.mLock) {
      ...
      if (managedApplicationService.getComponent().getPackageName().equals(str)
          && i == this.mCurrentVrService.getUserId()) {
        z = true;
      }
      return z;
    }
  ...
  public final void addPersistentStateCallback(
      IPersistentVrStateCallbacks iPersistentVrStateCallbacks) {
    this.mPersistentVrStateRemoteCallbacks.register(iPersistentVrStateCallbacks);
  }

  public final void removePersistentStateCallback(
      IPersistentVrStateCallbacks iPersistentVrStateCallbacks) {
