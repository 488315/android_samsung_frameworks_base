...
public class EnabledComponentsObserver implements SettingsObserver.SettingChangeListener {
  ...
  public EnabledComponentsObserver(
      Context context, String str, String str2, String str3, Object obj, Collection collection) {
  ...
  public static EnabledComponentsObserver build(
      Context context,
      Handler handler,
      String str,
      Looper looper,
    ...
    EnabledComponentsObserver enabledComponentsObserver =
        new EnabledComponentsObserver(context, str, str2, str3, obj, collection);
    ...
    synchronized (this.mLock) {
      ...
      for (int i : getCurrentProfileIds()) {
        ...
        ArraySet loadComponentNamesFromSetting =
            loadComponentNamesFromSetting(this.mSettingName, i);
  ...
  public final ArraySet loadComponentNamesForUser(int i) {
    return loadComponentNames(
        this.mContext.getPackageManager(), i, this.mServiceName, this.mServicePermission);
  }
