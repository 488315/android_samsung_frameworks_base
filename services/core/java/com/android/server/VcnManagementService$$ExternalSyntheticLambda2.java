...
public final /* synthetic */ class VcnManagementService$$ExternalSyntheticLambda2
        implements FunctionalUtils.ThrowingRunnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ Object f$0;
    public final /* synthetic */ Object f$1;

    public /* synthetic */ VcnManagementService$$ExternalSyntheticLambda2(
    ...
    public /* synthetic */ VcnManagementService$$ExternalSyntheticLambda2(
            VcnManagementService vcnManagementService, Object obj, int i) {
        this.$r8$classId = i;
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                synchronized (vcnManagementService.mLock) {
                    ...
                    boolean containsKey =
                            ((ArrayMap) vcnManagementService.mVcns).containsKey(parcelUuid);
                    vcnManagementService.stopVcnLocked(parcelUuid);
                    if (containsKey) {
                        vcnManagementService.notifyAllPermissionedStatusCallbacksLocked(
                                parcelUuid, 0);
                    }
            ...
            case 1:
                ...
                if (!Objects.equals(userManager.getMainUser(), (UserHandle) this.f$1)) {
                    throw new SecurityException(
                            "VcnManagementService can only be used by callers running as the main"
                                + " user");
                }
                return;
            default:
                ...
                VcnManagementService.PolicyListenerBinderDeath policyListenerBinderDeath =
                        (VcnManagementService.PolicyListenerBinderDeath) this.f$1;
