...
public class TimeDetectorShellCommand extends ShellCommand {
  ...
  public final int runIsAutoDetectionEnabled() {
    getOutPrintWriter()
        .println(
            this.mInterface.getCapabilitiesAndConfig().getConfiguration().isAutoDetectionEnabled());
    return 0;
  }
    ...
    Supplier supplier =
        new Supplier() { // from class:
          ...
          public final Object get() {
            ...
            lambda$runSuggestManualTime$0 =
                TimeDetectorShellCommand.this.lambda$runSuggestManualTime$0();
  ...
  public final int runSuggestTelephonyTime() {
    Supplier supplier =
        new Supplier() { // from class:
                         // com.android.server.timedetector.TimeDetectorShellCommand$$ExternalSyntheticLambda6
          @Override // java.util.function.Supplier
          public final Object get() {
            TelephonyTimeSuggestion lambda$runSuggestTelephonyTime$1;
            lambda$runSuggestTelephonyTime$1 =
                TimeDetectorShellCommand.this.lambda$runSuggestTelephonyTime$1();
    ...
    return runSuggestTime(
        supplier,
        new Consumer() { // from class:
                         // com.android.server.timedetector.TimeDetectorShellCommand$$ExternalSyntheticLambda7
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public final int runSuggestNetworkTime() {
    Supplier supplier =
        new Supplier() { // from class:
                         // com.android.server.timedetector.TimeDetectorShellCommand$$ExternalSyntheticLambda8
          @Override // java.util.function.Supplier
          public final Object get() {
            NetworkTimeSuggestion lambda$runSuggestNetworkTime$2;
            lambda$runSuggestNetworkTime$2 =
                TimeDetectorShellCommand.this.lambda$runSuggestNetworkTime$2();
    ...
    return runSuggestTime(
        supplier,
        new Consumer() { // from class:
                         // com.android.server.timedetector.TimeDetectorShellCommand$$ExternalSyntheticLambda9
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public final int runSuggestGnssTime() {
    Supplier supplier =
        new Supplier() { // from class:
                         // com.android.server.timedetector.TimeDetectorShellCommand$$ExternalSyntheticLambda4
          @Override // java.util.function.Supplier
          public final Object get() {
            GnssTimeSuggestion lambda$runSuggestGnssTime$3;
            lambda$runSuggestGnssTime$3 =
                TimeDetectorShellCommand.this.lambda$runSuggestGnssTime$3();
    ...
    return runSuggestTime(
        supplier,
        new Consumer() { // from class:
                         // com.android.server.timedetector.TimeDetectorShellCommand$$ExternalSyntheticLambda5
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public final int runSuggestExternalTime() {
    Supplier supplier =
        new Supplier() { // from class:
                         // com.android.server.timedetector.TimeDetectorShellCommand$$ExternalSyntheticLambda2
          @Override // java.util.function.Supplier
          public final Object get() {
            ExternalTimeSuggestion lambda$runSuggestExternalTime$4;
            lambda$runSuggestExternalTime$4 =
                TimeDetectorShellCommand.this.lambda$runSuggestExternalTime$4();
    ...
    return runSuggestTime(
        supplier,
        new Consumer() { // from class:
                         // com.android.server.timedetector.TimeDetectorShellCommand$$ExternalSyntheticLambda3
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public final int runConfirmTime() {
    getOutPrintWriter()
        .println(this.mInterface.confirmTime(UnixEpochTime.parseCommandLineArgs(this)));
    return 0;
  }
  ...
  public final int runSetSystemClockNetworkTime() {
    ...
    this.mInterface.setNetworkTimeForSystemClockForTests(
        parseCommandLineArg.getUnixEpochTime(), parseCommandLineArg.getUncertaintyMillis());
    return 0;
  }
