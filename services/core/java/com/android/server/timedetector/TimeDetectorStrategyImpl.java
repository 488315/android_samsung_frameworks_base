...
public final class TimeDetectorStrategyImpl implements TimeDetectorStrategy {
  ...
  public static TimeDetectorStrategy create(
      Context context, Handler handler, ServiceConfigAccessor serviceConfigAccessor) {
    return new TimeDetectorStrategyImpl(
  ...
  public TimeDetectorStrategyImpl(
    ...
    synchronized (this) {
      serviceConfigAccessor2.addConfigurationInternalChangeListener(
  ...
  public synchronized void suggestExternalTime(ExternalTimeSuggestion externalTimeSuggestion) {
    Slog.d(
        "time_detector",
        "External suggestion received. currentUserConfig="
    ...
    if (validateAutoSuggestionTime(
        externalTimeSuggestion.getUnixEpochTime(), externalTimeSuggestion)) {
      this.mLastExternalSuggestion.set(externalTimeSuggestion);
      doAutoTimeDetection(
          "External time suggestion received: suggestion=" + externalTimeSuggestion);
    }
  }
  ...
  public synchronized boolean suggestManualTime(
      int i, ManualTimeSuggestion manualTimeSuggestion, boolean z) {
    ...
    TimeCapabilities capabilities =
        configurationInternal.createCapabilitiesAndConfig(z).getCapabilities();
  ...
  public synchronized TimeState getTimeState() {
    return new TimeState(
        new UnixEpochTime(
            this.mEnvironment.elapsedRealtimeMillis(), this.mEnvironment.systemClockMillis()),
        this.mEnvironment.systemClockConfidence() < 100);
  }
  ...
  public synchronized void setTimeState(TimeState timeState) {
    ...
    try {
      setSystemClockAndConfidenceUnderWakeLock(
          2, timeState.getUnixEpochTime(), i, "setTimeZoneState()");
    } finally {
  ...
  public synchronized boolean confirmTime(UnixEpochTime unixEpochTime) {
    ...
    try {
      ...
      isTimeWithinConfidenceThreshold =
          isTimeWithinConfidenceThreshold(unixEpochTime, elapsedRealtimeMillis, systemClockMillis);
  ...
  public synchronized boolean updateConfiguration(
      int i, TimeConfiguration timeConfiguration, boolean z) {
  ...
  public synchronized void suggestTelephonyTime(TelephonyTimeSuggestion telephonyTimeSuggestion) {
    ...
    if (validateAutoSuggestionTime(
        telephonyTimeSuggestion.getUnixEpochTime(), telephonyTimeSuggestion)) {
  ...
  public final void updateCurrentConfigurationInternalIfRequired(String str) {
    ConfigurationInternal currentUserConfigurationInternal =
        this.mServiceConfigAccessor.getCurrentUserConfigurationInternal();
    ConfigurationInternal configurationInternal = this.mCurrentConfigurationInternal;
    ...
    addDebugLogEntry(
        str
            ...
            + ", newConfiguration="
            + currentUserConfigurationInternal
            + "]");
  ...
  public synchronized void dump(IndentingPrintWriter indentingPrintWriter, String[] strArr) {
    ...
    indentingPrintWriter.println(
        "[Capabilities="
            + this.mCurrentConfigurationInternal.createCapabilitiesAndConfig(false)
            + "]");
  ...
  public final boolean storeTelephonySuggestion(TelephonyTimeSuggestion telephonyTimeSuggestion) {
    ...
    TelephonyTimeSuggestion telephonyTimeSuggestion2 =
        (TelephonyTimeSuggestion) this.mSuggestionBySlotIndex.get(Integer.valueOf(slotIndex));
  ...
  public final boolean validateSuggestionCommon(UnixEpochTime unixEpochTime, Object obj) {
    ...
    if (unixEpochTime.getUnixEpochTimeMillis()
        <= this.mCurrentConfigurationInternal.getSuggestionUpperBound().toEpochMilli()) {
      return true;
    }
    Slog.w(
        "time_detector",
  ...
  public final boolean validateAutoSuggestionTime(UnixEpochTime unixEpochTime, Object obj) {
    return validateSuggestionCommon(unixEpochTime, obj)
        && validateSuggestionAgainstLowerBound(
            unixEpochTime, obj, this.mCurrentConfigurationInternal.getAutoSuggestionLowerBound());
  }

  public final boolean validateManualSuggestionTime(UnixEpochTime unixEpochTime, Object obj) {
    return validateSuggestionCommon(unixEpochTime, obj)
        && validateSuggestionAgainstLowerBound(
            unixEpochTime, obj, this.mCurrentConfigurationInternal.getManualSuggestionLowerBound());
  }

  public final boolean validateSuggestionAgainstLowerBound(
        ...
        if (i == 5) {
          ...
          Slog.w(
              ...
              "Unknown or unsupported origin="
                  + i
                  + " in "
                  + Arrays.toString(autoOriginPriorities)
                  + ": Skipping");
        }
        str2 = null;
      }
  ...
  public final TelephonyTimeSuggestion findBestTelephonySuggestion() {
    ...
    for (int i2 = 0; i2 < this.mSuggestionBySlotIndex.size(); i2++) {
      ...
      TelephonyTimeSuggestion telephonyTimeSuggestion2 =
          (TelephonyTimeSuggestion) this.mSuggestionBySlotIndex.valueAt(i2);
      if (telephonyTimeSuggestion2 == null) {
        Slog.w(
            "time_detector", "Latest suggestion unexpectedly null for slotIndex. slotIndex=" + num);
      } else if (telephonyTimeSuggestion2.getUnixEpochTime() == null) {
        Slog.w(
            "time_detector",
            "Latest suggestion unexpectedly empty.  candidateSuggestion="
                + telephonyTimeSuggestion2);
      } else {
        int scoreTelephonySuggestion =
            scoreTelephonySuggestion(elapsedRealtimeMillis, telephonyTimeSuggestion2);
        if (scoreTelephonySuggestion != -1) {
          if (telephonyTimeSuggestion == null || i < scoreTelephonySuggestion) {
            ...
            if (telephonyTimeSuggestion2.getSlotIndex()
  ...
  public static int scoreTelephonySuggestion(
      long j, TelephonyTimeSuggestion telephonyTimeSuggestion) {
    UnixEpochTime unixEpochTime = telephonyTimeSuggestion.getUnixEpochTime();
    if (!validateSuggestionUnixEpochTime(j, unixEpochTime)) {
      Slog.w(
          "time_detector",
          "Existing suggestion found to be invalid elapsedRealtimeMillis="
              + j
              + ", suggestion="
              + telephonyTimeSuggestion);
      return -1;
    ...
    int elapsedRealtimeMillis =
        (int)
            ((j - unixEpochTime.getElapsedRealtimeMillis())
  ...
  public final NetworkTimeSuggestion findLatestValidNetworkSuggestion() {
    ...
    if (validateSuggestionUnixEpochTime(
        this.mEnvironment.elapsedRealtimeMillis(), networkTimeSuggestion.getUnixEpochTime())) {
  ...
  public final GnssTimeSuggestion findLatestValidGnssSuggestion() {
    ...
    if (validateSuggestionUnixEpochTime(
        this.mEnvironment.elapsedRealtimeMillis(), gnssTimeSuggestion.getUnixEpochTime())) {
  ...
  public final ExternalTimeSuggestion findLatestValidExternalSuggestion() {
    ...
    if (validateSuggestionUnixEpochTime(
        this.mEnvironment.elapsedRealtimeMillis(), externalTimeSuggestion.getUnixEpochTime())) {
  ...
  public final boolean setSystemClockAndConfidenceIfRequired(
    ...
    if (isOriginAutomatic(i)) {
      if (!this.mCurrentConfigurationInternal.getAutoDetectionEnabledBehavior()
        ...
        Slog.d(
            "time_detector",
            "Auto time detection is not enabled / no confidence update is needed. origin="
                + TimeDetectorStrategy.originToString(i)
                + ", time="
                + unixEpochTime
                + ", cause="
                + str);
      ...
      Slog.d(
          "time_detector",
          "Auto time detection is enabled. origin="
              + TimeDetectorStrategy.originToString(i)
              + ", time="
              + unixEpochTime
              + ", cause="
  ...
  public final void upgradeSystemClockConfidenceIfRequired(
      UnixEpochTime unixEpochTime, String str) {
    int systemClockConfidence = this.mEnvironment.systemClockConfidence();
    if (systemClockConfidence < 100) {
      this.mEnvironment.acquireWakeLock();
      try {
        ...
        long systemClockMillis = this.mEnvironment.systemClockMillis();
        if (isTimeWithinConfidenceThreshold(
            unixEpochTime, elapsedRealtimeMillis, systemClockMillis)) {
          String str2 =
  ...
  public final boolean isTimeWithinConfidenceThreshold(
      UnixEpochTime unixEpochTime, long j, long j2) {
    return Math.abs(unixEpochTime.at(j).getUnixEpochTimeMillis() - j2)
        <= ((long) this.mCurrentConfigurationInternal.getSystemClockConfidenceThresholdMillis());
  }

  public final boolean setSystemClockAndConfidenceUnderWakeLock(
      int i, UnixEpochTime unixEpochTime, int i2, String str) {
    long j;
    UnixEpochTime unixEpochTime2;
    long elapsedRealtimeMillis = this.mEnvironment.elapsedRealtimeMillis();
    ...
    if (isOriginAutomatic && (unixEpochTime2 = this.mLastAutoSystemClockTimeSet) != null) {
      ...
      if (Math.abs(unixEpochTimeMillis - systemClockMillis) > 2000) {
        Slog.w(
            "time_detector",
            "System clock has not tracked elapsed real time clock. A clock may be inaccurate or"
                + " something unexpectedly set the system clock. origin="
                + TimeDetectorStrategy.originToString(i)
                + " elapsedRealtimeMillis="
                + elapsedRealtimeMillis
                + " expectedTimeMillis="
    ...
    long systemClockUpdateThresholdMillis =
        this.mCurrentConfigurationInternal.getSystemClockUpdateThresholdMillis();
    ...
    if (z) {
      String str2 =
          "Set system clock & confidence. origin="
              + TimeDetectorStrategy.originToString(i)
              + " newTime="
              + unixEpochTime
              + " newTimeConfidence="
      ...
      Slog.d(
          "time_detector",
          "Not setting system clock or confidence. origin="
              + TimeDetectorStrategy.originToString(i)
              + " newTime="
              + unixEpochTime
              + " newTimeConfidence="
