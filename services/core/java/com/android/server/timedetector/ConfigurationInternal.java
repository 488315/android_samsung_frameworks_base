...
public final class ConfigurationInternal {
  ...
  public final TimeCapabilities timeCapabilities(boolean z) {
    ...
    builder.setConfigureAutoDetectionEnabledCapability(
        !isAutoDetectionSupported() ? 10 : !z2 ? 20 : 40);
    if (z2) {
  ...
  public boolean equals(Object obj) {
    ...
    return this.mAutoDetectionSupported == configurationInternal.mAutoDetectionSupported
        ...
        && this.mAutoSuggestionLowerBound.equals(configurationInternal.mAutoSuggestionLowerBound)
  ...
  public int hashCode() {
    return (Objects.hash(
            ...
            * 31)
        + Arrays.hashCode(this.mOriginPriorities);
  }
            ...
            Arrays.stream(this.mOriginPriorities)
                .mapToObj(
                    new IntFunction() { // from class:
                                        // com.android.server.timedetector.ConfigurationInternal$$ExternalSyntheticLambda0
