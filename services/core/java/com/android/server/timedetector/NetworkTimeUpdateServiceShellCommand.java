    ...
    public final int onCommand(String str) {
        ...
        switch (str) {
                    ...
                    if (nextArg == null) {
                        if (arrayList.isEmpty()) {
                            throw new IllegalArgumentException(
                                    "Missing required option: ----server");
                        }
                        if (duration == null) {
                            throw new IllegalArgumentException(
                                    "Missing required option: ----timeout_millis");
                        }
            ...
            case "force_refresh":
                ...
                networkTimeUpdateService.mContext.enforceCallingPermission(
                ...
                try {
                    ...
                    if (network == null) {
                        ...
                        NetworkTimeUpdateService.EngineImpl engineImpl =
                                networkTimeUpdateService.mEngine;
                        NetworkTimeUpdateService.AnonymousClass1 anonymousClass1 =
                                networkTimeUpdateService.mRefreshCallbacks;
                        ...
                        engineImpl.logToDebugAndDumpsys(
                                "forceRefreshForTests: refreshSuccessful=" + forceRefresh);
                        if (forceRefresh) {
                            NtpTrustedTime.TimeResult cachedTimeResult =
                                    engineImpl.mNtpTrustedTime.getCachedTimeResult();
                            if (cachedTimeResult == null) {
                                engineImpl.logToDebugAndDumpsys(
                                        "forceRefreshForTests: cachedTimeResult unexpectedly null");
                            } else {
                                NetworkTimeUpdateService.EngineImpl.makeNetworkTimeSuggestion(
                                        cachedTimeResult,
