...
public class TimeDetectorInternalImpl implements TimeDetectorInternal {
  ...
  public void suggestNetworkTime(final NetworkTimeSuggestion networkTimeSuggestion) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.timedetector.TimeDetectorInternalImpl$$ExternalSyntheticLambda1
  ...
  public /* synthetic */ void lambda$suggestNetworkTime$0(
  ...
  public void suggestGnssTime(final GnssTimeSuggestion gnssTimeSuggestion) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.timedetector.TimeDetectorInternalImpl$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
