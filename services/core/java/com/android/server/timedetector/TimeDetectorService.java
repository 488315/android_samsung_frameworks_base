...
public final class TimeDetectorService extends ITimeDetectorService.Stub
  ...
  public class Lifecycle extends SystemService {
    ...
    public void onStart() {
      ...
      ServiceConfigAccessor serviceConfigAccessorImpl =
          ServiceConfigAccessorImpl.getInstance(context);
      TimeDetectorStrategy create =
          TimeDetectorStrategyImpl.create(context, handler, serviceConfigAccessorImpl);
      publishLocalService(
          TimeDetectorInternal.class,
  ...
  public TimeDetectorService(
      Context context,
      Handler handler,
      CallerIdentityInjector callerIdentityInjector,
    ...
    timeDetectorStrategy2.addChangeListener(
        new StateChangeListener() { // from class:
                                    // com.android.server.timedetector.TimeDetectorService$$ExternalSyntheticLambda2
  ...
  public /* synthetic */ void lambda$new$0() {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.timedetector.TimeDetectorService$$ExternalSyntheticLambda4
  ...
  public boolean updateConfiguration(int i, TimeConfiguration timeConfiguration) {
    ...
    long clearCallingIdentity = this.mCallerIdentityInjector.clearCallingIdentity();
    try {
      return this.mTimeDetectorStrategy.updateConfiguration(
          handleIncomingUser, timeConfiguration, false);
    } finally {
      this.mCallerIdentityInjector.restoreCallingIdentity(clearCallingIdentity);
    }
  }
      ...
      if (!z) {
        Slog.w(
            ...
            "Client asked to remove listener="
                ...
                + ", but no listeners were removed. mListeners="
                + this.mListeners);
      }
    }
  }
      ...
      if (!z) {
        Slog.w(
            ...
            "Notified of binder death for who="
                + iBinder
                + ", but did not remove any listeners. mListeners="
                + this.mListeners);
      }
    }
  }
  ...
  public final void handleChangeOnHandlerThread() {
    synchronized (this.mListeners) {
      ...
      for (int i = 0; i < size; i++) {
        ITimeDetectorListener iTimeDetectorListener =
            (ITimeDetectorListener) this.mListeners.valueAt(i);
        try {
  ...
  public boolean setManualTime(ManualTimeSuggestion manualTimeSuggestion) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      return this.mTimeDetectorStrategy.suggestManualTime(
          callingUserId, manualTimeSuggestion, false);
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
  }
  ...
  public void suggestTelephonyTime(final TelephonyTimeSuggestion telephonyTimeSuggestion) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.timedetector.TimeDetectorService$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$suggestTelephonyTime$1(
  ...
  public void suggestNetworkTime(final NetworkTimeSuggestion networkTimeSuggestion) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.timedetector.TimeDetectorService$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$suggestNetworkTime$2(
  ...
  public UnixEpochTime latestNetworkTime() {
    ...
    if (TimeDetectorNetworkTimeHelper.isInUse()) {
      ...
      networkTimeSuggestion =
          cachedTimeResult != null
              ? new NetworkTimeSuggestion(
                  new UnixEpochTime(
                      cachedTimeResult.getElapsedRealtimeMillis(),
                      cachedTimeResult.getTimeMillis()),
                  cachedTimeResult.getUncertaintyMillis())
              : null;
    }
  ...
  public void suggestGnssTime(final GnssTimeSuggestion gnssTimeSuggestion) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.timedetector.TimeDetectorService$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void suggestExternalTime(final ExternalTimeSuggestion externalTimeSuggestion) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.timedetector.TimeDetectorService$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$suggestExternalTime$4(
  ...
  public void setNetworkTimeForSystemClockForTests(UnixEpochTime unixEpochTime, int i) {
    ...
    if (TimeDetectorNetworkTimeHelper.isInUse()) {
      ...
      this.mNtpTrustedTime.setCachedTimeResult(
  ...
  public void onShellCommand(
    ...
    new TimeDetectorShellCommand(this)
        .exec(
            this,
            fileDescriptor,
            fileDescriptor2,
  ...
  public final void enforceSuggestManualTimePermission() {
    this.mContext.enforceCallingPermission(
        "android.permission.SUGGEST_MANUAL_TIME_AND_ZONE", "suggest manual time and time zone");
  }
  ...
  public final void enforceSuggestExternalTimePermission() {
    this.mContext.enforceCallingPermission(
        "android.permission.SUGGEST_EXTERNAL_TIME", "suggest time from external source");
  }
