    ...
    public final class CocktailOrderComparator implements Comparator {
        ...
        public final int compare(Object obj, Object obj2) {
            ...
            try {
                ...
                return (this.mOrderInfoMap.get(str) != null
            ...
            try {
                ...
                if (arrayList != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        stringBuffer.append(
                                ((CocktailOrderInfo) this.mCocktailOrderedList.get(i)).mCocktailId);
                        stringBuffer.append(" ");
                    }
                    stringBuffer.append("\n");
                } else {
    ...
    */
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.cocktailbar.settings.CocktailOrderManager.readStateFromFileLocked(java.io.FileInputStream):void");
    }
    ...
    public final boolean writeStateToFileLocked(FileOutputStream fileOutputStream) {
        try {
            ...
            for (int i = 0; i < size; i++) {
                CocktailOrderInfo cocktailOrderInfo =
                        (CocktailOrderInfo) this.mCocktailOrderedList.get(i);
                ...
                if (componentName != null) {
                    ...
                    fastXmlSerializer.attribute(
                            (String) null, "order", String.valueOf(cocktailOrderInfo.mOrder));
                    fastXmlSerializer.attribute(
                            (String) null, "user_id", String.valueOf(cocktailOrderInfo.mUserId));
                    fastXmlSerializer.attribute(
                            (String) null,
                            "cocktail_id",
                            String.valueOf(cocktailOrderInfo.mCocktailId));
                    fastXmlSerializer.attribute(
                            (String) null, "package", componentName.getPackageName());
                    fastXmlSerializer.attribute(
            ...
            DeviceIdleController$$ExternalSyntheticOutline0.m(
                    "Failed to write state: ", e, "CocktailOrderManager");
            return false;
        }
    }
}
