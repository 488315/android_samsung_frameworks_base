...
public abstract class AbsPrivateMode implements CocktailBarMode {
  ...
  public AbsPrivateMode(
      Context context, int i, CocktailBarMode.OnCocktailBarModeListener onCocktailBarModeListener) {
  ...
  public AbsPrivateMode(
      ...
      CocktailBarMode.OnCocktailBarModeListener onCocktailBarModeListener) {
