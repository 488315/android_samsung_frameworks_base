...
public class CocktailBarModeManager implements CocktailBarMode.OnCocktailBarModeListener {
  ...
  public CocktailBarModeManager(
      Context context,
      CocktailBarManagerServiceListener cocktailBarManagerServiceListener,
  ...
  public final void setupPrivateMode(CocktailBarMode cocktailBarMode) {
    ...
    Log.e(
        TAG, "setupPrivateMode : exist duplicated privateMode : " + cocktailBarMode.getModeName());
  }
