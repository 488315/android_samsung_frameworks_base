...
public final class CocktailPolicyManager {
    ...
    public final boolean canUpdateCocktail(
            Cocktail cocktail,
    ...
    public final AbsCocktailPolicy findMatchedPolicy(Cocktail cocktail) {
        ...
        while (it.hasNext()) {
            ...
            if (absCocktailPolicy.isMatchedPolicy(cocktail)) {
                Slog.i(
                        "CocktailPolicyManager",
                        "findMatchedPolicy: find policy = " + absCocktailPolicy.getCocktailType());
                return absCocktailPolicy;
            }
        }
        return null;
    ...
    public final void onRemoveUpdatableCocktail(int i) {
        ...
        CocktailBarManagerServiceContainer cocktailBarManagerServiceContainer =
                (CocktailBarManagerServiceContainer) this.mListener;
        if (!cocktailBarManagerServiceContainer.enforceCocktailBarService()
                || CocktailBarManagerServiceContainer.isNotEdgeRunnableId(i2)) {
            return;
        }
        CocktailBarManagerServiceImpl implForUser =
                cocktailBarManagerServiceContainer.getImplForUser(i2);
