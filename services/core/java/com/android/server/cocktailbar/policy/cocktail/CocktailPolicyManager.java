...
public class CocktailPolicyManager implements CocktailPolicy.OnCocktailPolicyListener {
  ...
  public CocktailPolicyManager(
      Context context, OnCocktailBarPolicyListener onCocktailBarPolicyListener) {
    ...
    if (categoryIds == 0 || (categoryIds & FrameworkStatsLog.f636xd07885aa) != 0) {
  ...
  public void enableUpdatableCocktail(int i, int i2) {
    UpadatableCocktailInfo upadatableCocktailInfo =
        (UpadatableCocktailInfo) this.mUpdatableCocktailMap.get(i2);
  ...
  public boolean canUpdateCocktail(
      Cocktail cocktail,
    ...
    if (findMatchedPolicy != null) {
      return findMatchedPolicy.isAcceptUpdateCocktail(
          cocktail,
          cocktailBarSettings,
          cocktailBarModeManager,
          i,
          isUpdatedCocktail(cocktail.getCocktailId(), i));
    }
    return false;
  }

  public boolean canShowCocktail(
      Cocktail cocktail,
      CocktailBarSettings cocktailBarSettings,
      int i,
      CocktailBarModeManager cocktailBarModeManager) {
    ...
    CocktailPolicy findMatchedPolicy = findMatchedPolicy(cocktail);
    if (findMatchedPolicy != null) {
      return findMatchedPolicy.isAcceptShowCocktail(
          cocktail, cocktailBarSettings, i, isUpdatedCocktail(cocktail.getCocktailId(), i));
    }
    return false;
  }

  public boolean canCloseCocktail(
      Cocktail cocktail,
      CocktailBarSettings cocktailBarSettings,
      int i,
      CocktailBarModeManager cocktailBarModeManager) {
    ...
    CocktailPolicy findMatchedPolicy = findMatchedPolicy(cocktail);
    if (findMatchedPolicy != null) {
      return findMatchedPolicy.isAcceptCloseCocktail(
          cocktail, cocktailBarSettings, i, isUpdatedCocktail(cocktail.getCocktailId(), i));
    }
    return false;
  }
