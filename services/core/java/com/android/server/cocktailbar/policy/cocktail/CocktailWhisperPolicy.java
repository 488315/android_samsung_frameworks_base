...
public class CocktailWhisperPolicy extends AbsCocktailPolicy {
  ...
  @Override // com.android.server.cocktailbar.policy.cocktail.CocktailPolicy
  public boolean isAcceptShowCocktail(
      Cocktail cocktail, CocktailBarSettings cocktailBarSettings, int i, boolean z) {
    return false;
  }

  public CocktailWhisperPolicy(
      Context context, CocktailPolicy.OnCocktailPolicyListener onCocktailPolicyListener) {
  ...
  @Override // com.android.server.cocktailbar.policy.cocktail.CocktailPolicy
  public boolean isAcceptUpdateCocktail(
      Cocktail cocktail,
  ...
  @Override // com.android.server.cocktailbar.policy.cocktail.CocktailPolicy
  public boolean isAcceptCloseCocktail(
      Cocktail cocktail, CocktailBarSettings cocktailBarSettings, int i, boolean z) {
    if (!z) {
      return true;
    }
  ...
  @Override // com.android.server.cocktailbar.policy.cocktail.AbsCocktailPolicy,
            // com.android.server.cocktailbar.policy.cocktail.CocktailPolicy
        ...
        if (i == 1 || i == 2) {
          if (cocktail.getProviderInfo().whisper != null) {
            this.mWhisperInfoList.put(
                ...
                new WhisperInfo(this.mContext, cocktail.getProviderInfo().whisper, cocktail));
          } else {
  ...
  public class WhisperInfo {
    ...
    public WhisperInfo(Cocktail cocktail) {
      ...
      this.packageName =
          cocktail.getProvider() != null ? cocktail.getProvider().getPackageName() : null;
