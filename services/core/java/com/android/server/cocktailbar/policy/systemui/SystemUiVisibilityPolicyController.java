...
public class SystemUiVisibilityPolicyController {
  ...
  public void unregisterSystemUiVisibilityListenerCallback(IBinder iBinder) {
    synchronized (this.mStateListeners) {
      ...
      while (it.hasNext()) {
        SystemUiVisibilityListenerInfo systemUiVisibilityListenerInfo2 =
            (SystemUiVisibilityListenerInfo) it.next();
        if (systemUiVisibilityListenerInfo2 != null
            && iBinder.equals(systemUiVisibilityListenerInfo2.token)) {
          systemUiVisibilityListenerInfo = systemUiVisibilityListenerInfo2;
        }
      }
      if (systemUiVisibilityListenerInfo == null) {
  ...
  public final void createHandlerThreadLocked() {
    if (this.mSystemUiVisibilityThread == null) {
      ...
      synchronized (this.mLock) {
        ...
        systemUiVisibilityHandler.post(
            new Runnable() { // from class:
                             // com.android.server.cocktailbar.policy.systemui.SystemUiVisibilityPolicyController.1
  ...
  public final class SystemUiVisibilityHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      ...
      if (i == 1) {
        ...
        SystemUiVisibilityPolicyController.this.notifySystemUiVisibilityToBinder(
            (IBinder) message.obj, message.arg1);
      } else {
        if (i != 101) {
          return;
        }
  ...
  public class SystemUiVisibilityListenerInfo implements IBinder.DeathRecipient {
    ...
    public SystemUiVisibilityListenerInfo(
    ...
    public void onSystemUiVisibilityChanged(int i) {
      ...
      if (iBinder == null) {
        Slog.w(
            SystemUiVisibilityPolicyController.TAG, "onSystemUiVisibilityChanged : token is null");
        return;
      }
      try {
        ...
        Slog.e(
            SystemUiVisibilityPolicyController.TAG,
