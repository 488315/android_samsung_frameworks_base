...
public class IsrbManagerServiceImpl extends IIsrbManager.Stub {
    ...
    public void showSystemErrDialog() {
        ...
        if (!this.mIsNetworkReady) {
            ...
            builder.setPositiveButton(R.string.mmiFdnError, new DialogInterface.OnClickListener() { // from class: com.android.server.isrb.IsrbManagerServiceImpl.2
            ...
            if (this.mErrAlertNum < 12) {
                builder.setNegativeButton(R.string.mmiErrorWhileRoaming, new DialogInterface.OnClickListener() { // from class: com.android.server.isrb.IsrbManagerServiceImpl.3
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i2) {
                    }
                });
            }
            builder.setPositiveButton(R.string.mobile_no_internet, new DialogInterface.OnClickListener() { // from class: com.android.server.isrb.IsrbManagerServiceImpl.4
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i2) {
