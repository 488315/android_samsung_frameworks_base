...
public class AccountAuthenticatorCache extends RegisteredServicesCache
  ...
  public /* bridge */ /* synthetic */ RegisteredServicesCache.ServiceInfo getServiceInfo(
  ...
  public AuthenticatorDescription m1375parseServiceAttributes(
      Resources resources, String str, AttributeSet attributeSet) {
    TypedArray obtainAttributes =
        resources.obtainAttributes(attributeSet, R.styleable.AccountAuthenticator);
    try {
      ...
      if (!TextUtils.isEmpty(string)) {
        return new AuthenticatorDescription(
            string, str, resourceId, resourceId2, resourceId3, resourceId4, z);
      }
  ...
  public class MySerializer implements XmlSerializerAndParser {
    ...
    public void writeAsXml(
        AuthenticatorDescription authenticatorDescription, TypedXmlSerializer typedXmlSerializer) {
    ...
    public AuthenticatorDescription m1376createFromXml(TypedXmlPullParser typedXmlPullParser) {
