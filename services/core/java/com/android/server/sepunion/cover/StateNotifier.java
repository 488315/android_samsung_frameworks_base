...
public final class StateNotifier {
  ...
  public final HandlerC2566H mHandler;
  ...
  public StateNotifier(Looper looper, Context context) {
    ...
    this.mHandler = new HandlerC2566H(looper);
  ...
  /* renamed from: com.android.server.sepunion.cover.StateNotifier$H */
  public final class HandlerC2566H extends Handler {
    public HandlerC2566H(Looper looper) {
  ...
  public void registerListenerCallback(IBinder iBinder, ComponentName componentName, int i) {
    if (componentName != null
        && "com.samsung.android.incallui".equals(componentName.getPackageName())) {
  ...
  public boolean unregisterCallback(IBinder iBinder) {
    synchronized (this.mHighPriorityListeners) {
      CoverStateListenerInfo findListenerOnListLocked =
          findListenerOnListLocked(iBinder, this.mHighPriorityListeners);
      if (findListenerOnListLocked != null) {
        return removeListenerFromListLocked(
            iBinder, findListenerOnListLocked, this.mHighPriorityListeners);
      }
      synchronized (this.mListeners) {
        CoverStateListenerInfo findListenerOnListLocked2 =
            findListenerOnListLocked(iBinder, this.mListeners);
  ...
  public final CoverStateListenerInfo findListenerOnListLocked(
      IBinder iBinder, ArrayList arrayList) {
  ...
  public final boolean removeListenerFromListLocked(
      IBinder iBinder, CoverStateListenerInfo coverStateListenerInfo, ArrayList arrayList) {
  ...
  public void updateCoverAttachState(boolean z, int i, boolean z2) {
    ...
    if (Feature.getInstance(this.mContext).isSupportSecureCover()
        || checkSystemFeatureForCoverType(i)) {
  ...
  public void updatePowerState(int i, boolean z) {
    ...
    if (i != 0) {
      ...
      if (i != 100) {
        if (i != 7) {
          if (i == 8
              && Feature.getInstance(this.mContext).isSupportClearCover()
              && this.mPowerManager.isInteractive()) {
            this.mPowerManager.userActivity(SystemClock.uptimeMillis(), 0, 0);
            return;
          }
    ...
    if (this.mLcdOffDisabledByApp) {
      synchronized (this.mLcdOffDisableListeners) {
        if (!this.mLcdOffDisableListeners.isEmpty()) {
          ...
          Log.addLogString(
              "CoverManager_", "goToSleep by cover close : mLcdOffDisableListeners is empty");
    ...
    if (this.mBootComplete) {
      ...
      this.mGoToSleepRunnable =
          new Runnable() { // from class:
                           // com.android.server.sepunion.cover.StateNotifier$$ExternalSyntheticLambda0
  ...
  public boolean disableLcdOffByCover(IBinder iBinder, ComponentName componentName) {
    ...
    synchronized (this.mLcdOffDisableListeners) {
      ...
      LcdOffDisableListenerInfo lcdOffDisableListenerInfo2 =
          new LcdOffDisableListenerInfo(
              iBinder, componentName, Binder.getCallingPid(), Binder.getCallingUid());
  ...
  public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
    ...
    synchronized (this.mHighPriorityListeners) {
      printWriter.println(
          "  Live high priority listeners (" + this.mHighPriorityListeners.size() + "):");
