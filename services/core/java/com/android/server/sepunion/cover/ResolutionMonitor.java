    ...
    public ResolutionMonitor(Context context, Looper looper, Runnable runnable) {
        ...
        context.registerReceiver(
                new BroadcastReceiver() { // from class:
                                          // com.android.server.sepunion.cover.ResolutionMonitor.1
                    @Override // android.content.BroadcastReceiver
                    public final void onReceive(Context context2, Intent intent) {
                        if ("android.intent.action.CONFIGURATION_CHANGED"
                                .equals(intent.getAction())) {
                            Configuration configuration =
                                    ResolutionMonitor.this
                                            .mContext
                                            .getResources()
                                            .getConfiguration();
                            int updateFrom =
                                    ResolutionMonitor.this.mConfiguration.updateFrom(configuration);
                            ...
                            if ((updateFrom & 536875008) == 536875008) {
                                ...
                                resolutionMonitor.mHandler.post(
                                        resolutionMonitor.mCallbackRunnable);
                            }
                            ResolutionMonitor.this.mConfiguration =
