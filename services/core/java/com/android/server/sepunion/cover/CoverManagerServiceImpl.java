...
public class CoverManagerServiceImpl
    implements CoverServiceManager.OnCoverStateProvider, StateNotifier.LcdOffDisabledByAppListener {
  ...
  public Runnable mAnimationStartCallback =
      new Runnable() { // from class: com.android.server.sepunion.cover.CoverManagerServiceImpl.1
        ...
        public void run() {
          synchronized (CoverManagerServiceImpl.this.mCoverStateLock) {
            ...
            CoverManagerServiceImpl.this.mStateNotifier.updateCoverSwitchState(
                cloneCoverStateLocked, false);
          }
        }
      };
  public Runnable mResolutionMonitorCallback =
      new Runnable() { // from class: com.android.server.sepunion.cover.CoverManagerServiceImpl.2
        @Override // java.lang.Runnable
        public void run() {
          synchronized (CoverManagerServiceImpl.this.mCoverStateLock) {
            CoverManagerServiceImpl.this.mCoverState.updateVisibleRect(
                CoverManagerServiceImpl.this.mCoverState.getType());
            CoverState cloneCoverStateLocked = CoverManagerServiceImpl.this.cloneCoverStateLocked();
            CoverManagerServiceImpl.this.updateCoverStateToWindowManagerLocked(
                cloneCoverStateLocked);
            CoverManagerServiceImpl.this.mCoverServiceManager.updateCoverState(
  ...
  public final IDisplayFoldListener.Stub mDisplayFoldListener =
      new IDisplayFoldListener
        ...
        public void onDisplayFoldChanged(int i, boolean z) {
          Log.i(
              CoverManagerServiceImpl.TAG,
              "onDisplayFoldChanged: displayId = " + i + ", folded = " + z);
          if (i == 0) {
            if (z) {
              CoverManagerServiceImpl.this.notifyCoverSwitchStateChanged(
                  System.nanoTime(),
                  CoverManagerServiceImpl.this.getCoverSwitchStateFromInputManager() != 1);
            } else {
  ...
  public CoverManagerServiceImpl(Context context) {
    ...
    coverManagerHandler.post(
        new Runnable() { // from class: com.android.server.sepunion.cover.CoverManagerServiceImpl.4
          @Override // java.lang.Runnable
          public void run() {
    ...
    this.mCoverServiceManager =
        new CoverServiceManager(this.mContext, coverManagerHandler.getLooper(), this);
    ...
    this.mResolutionMonitor =
        new ResolutionMonitor(
            this.mContext, handlerThread.getLooper(), this.mResolutionMonitorCallback);
            ...
            new CoverTestModeUtils
              ...
              public void onCoverTestModeChanged(int i, boolean z) {
                if (CoverManagerServiceImpl.this.mSystemReady) {
                  if (i == 255) {
                    CoverManagerServiceImpl.this.notifySmartCoverAttachStateChangedInternal(
                        z,
                        new CoverState(
                            true,
      ...
      new Handler()
          .postDelayed(
              new Runnable() { // from class:
                               // com.android.server.sepunion.cover.CoverManagerServiceImpl.6
                @Override // java.lang.Runnable
                public void run() {
  ...
  public final SensorEventListener getHallicSensorEventListener() {
    if (this.mHallicSensorEventListener == null) {
      this.mHallicSensorEventListener =
          new SensorEventListener() { // from class:
                                      // com.android.server.sepunion.cover.CoverManagerServiceImpl.7
  ...
  public final void registerListenerCallbackInternal(
      IBinder iBinder, ComponentName componentName, int i, boolean z) {
    if (z
  ...
  public void notifySmartCoverAttachStateChanged(long j, boolean z, CoverState coverState) {
    ...
    if (coverState != null
        ...
        && !CoverServiceManager.verifySystemFeature(this.mContext, coverState.getType())) {
      Log.d(
          TAG,
      ...
      Log.addLogString(
          "CoverManager_",
          "cover attach is failed - not supported cover type = " + coverState.getType());
      return;
    }
    Log.d(TAG, "notifySmartCoverAttachStateChanged : attach = " + z);
    if (coverState != null) {
      Log.addLogString(
          "CoverManager_", "cover attach : " + z + ", cover type : " + coverState.getType());
    }
  ...
  public final void sendCoverAttachStateLocked(boolean z, CoverState coverState) {
    ...
    if (FactoryTest.isFactoryBinary()
        || (this.mAutoScreenOn.support() && this.mAutoScreenOn.off())) {
      z2 = true;
    }
    ...
    if (Feature.getInstance(this.mContext).isSupportSecureCover()) {
      this.mStateNotifier.updateCoverAttachState(
          isCoverAttached, type, this.mCoverState.getSwitchState());
      return;
    }
    ...
    Log.d(
        TAG,
        "sendCoverAttachStateLocked : coverAttached = " + isCoverAttached + ", switchState=" + z2);
  }

  public final void sendCoverInformationToAgentLocked(boolean z) {
    if (Feature.getInstance(this.mContext).isNfcAuthEnabled()) {
      CoverManagerUtils.sendCoverInformationToAgent(
          this.mContext, this.mCoverState.getSerialNumber(), z);
    }
  }
  ...
  public final void updateCoverSwitchState(boolean z, boolean z2) {
    synchronized (this.mCoverStateLock) {
      ...
      if (!Feature.getInstance(this.mContext).isNfcAuthEnabled()
          && !Feature.getInstance(this.mContext).isSupportDetectCover()) {
  ...
  public final boolean sendCoverSwitchStateLocked(boolean z, boolean z2, boolean z3, boolean z4) {
    ...
    if (!CoverServiceManager.verifySystemFeature(this.mContext, type)) {
      Log.w(
          TAG,
          "sendCoverSwitchStateLocked : return false because type(" + type + ") is not supported");
      Log.addLogString(
          "CoverManager_", "cover switch fail because type(" + type + ") is not supported");
      return false;
    }
    if (CoverManagerUtils.isBackCover(this.mCoverState)) {
      ...
      if (z5 && !z) {
        Log.d(
            TAG,
            "sendCoverSwitchStateLocked : return because attach state is changed, but switch is"
                + " false "
                + z);
        return false;
      }
    ...
    if ((CoverManagerUtils.isClearCover(this.mCoverState)
            || (type == 11 && !this.mStateNotifier.isLcdOffByDisabledByApp()))
        && z4
        && z) {
      if (this.mPowerManager.isInteractive()) {
        this.mHandler.post(
            new Runnable() { // from class:
              ...
              @Override // java.lang.Runnable
              public void run() {
                CoverManagerServiceImpl.this.mCoverHideAnimator.playCoverHideAnimation(
                    CoverManagerServiceImpl.this.mAnimationStartCallback);
                synchronized (CoverManagerServiceImpl.this.mCoverStateLock) {
                  CoverManagerServiceImpl.this.mStateNotifier.updatePowerState(
                      CoverManagerServiceImpl.this.mCoverState.getType(),
        ...
        if (i == 11) {
          if (Feature.getInstance(this.mContext).isSupportNeonCover()
            ...
            this.mGenericCoverServiceController =
                new GenericCoverServiceController(this.mThread.getLooper(), this.mContext);
            return;
          }
          return;
        }
  ...
  public final void initializeLedCoverController() {
    ...
    if (supportNfcLedCoverLevel == 30
        || supportNfcLedCoverLevel == 40
        || supportNfcLedCoverLevel == 50
        || supportNfcLedCoverLevel == 60
        || supportNfcLedCoverLevel == 70
        || supportNfcLedCoverLevel == 80
        || supportNfcLedCoverLevel == 90
        || supportNfcLedCoverLevel == 100) {
      this.mNfcLedCoverController =
    ...
    Log.e(
        TAG,
        "initializeLedCoverController : unsupported NfcLedCover level " + supportNfcLedCoverLevel);
  }
  ...
  public void disableCoverManager(boolean z, IBinder iBinder, String str) {
    ...
    if (this.mCoverDisabler.disableCoverManager(z, iBinder, str)) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.sepunion.cover.CoverManagerServiceImpl.10
            @Override // java.lang.Runnable
            public void run() {
              synchronized (CoverManagerServiceImpl.this.mCoverStateLock) {
  ...
  public void sendDataToCover(int i, byte[] bArr) {
    ...
    } else if ("com.android.systemui"
        .equals(
            this.mCoverManagerAllowLists.getPackageForPid(this.mContext, Binder.getCallingPid()))) {
  ...
  public boolean unregisterNfcTouchListenerCallback(IBinder iBinder) {
    ...
    BaseNfcLedCoverController baseNfcLedCoverController = this.mNfcLedCoverController;
    boolean unRegisterNfcTouchListenerCallback =
        baseNfcLedCoverController != null
            ? baseNfcLedCoverController.unRegisterNfcTouchListenerCallback(iBinder)
            : false;
    GenericCoverServiceController genericCoverServiceController =
        this.mGenericCoverServiceController;
    return unRegisterNfcTouchListenerCallback
        || (genericCoverServiceController != null
            ? genericCoverServiceController.unRegisterNfcTouchListenerCallback(iBinder)
            : false);
  }
  ...
  public boolean requestCoverAuthentication(IBinder iBinder, ComponentName componentName) {
    ...
    return baseNfcLedCoverController != null
        && baseNfcLedCoverController.requestCoverAuthentication(nanoTime, iBinder, componentName);
  }
  ...
  public final void updateCoverWindowSize() {
    synchronized (this.mCoverStateLock) {
      ...
      if (type == 7 || type == 8 || type == 11) {
        Log.d(
            TAG,
            "updateCoverWindowSize: updating cover window for type: " + this.mCoverState.getType());
    ...
    if (DumpUtils.checkDumpPermission(this.mContext, TAG, printWriter)) {
      if (!CoverTestModeUtils.SHIPPED && strArr != null && strArr.length > 0) {
        ...
        if ("on".equals(str) || "off".equals(str)) {
          ...
          if (equals && strArr.length > 1) {
            ...
            switch (str2.hashCode()) {
              ...
              case 99:
                ...
                break;
              case 102:
                if (str2.equals(KnoxAnalyticsDataConverter.FEATURE)) {
                  c = 2;
                  break;
                }
                c = 65535;
          ...
          printCoverDebugModeGuide(printWriter);
          return;
        }
        if ("open".equals(str) || "close".equals(str)) {
          ...
          notifyCoverSwitchStateChanged(System.nanoTime(), z);
          return;
        }
        if ("vr".equals(str)) {
          try {
          ...
          this.mCoverTestModeUtils.setTestVisibleRectToSetting(rect);
          printWriter.println("TEST MODE: CLEAR VIEW COVER VISIBLE AREA " + rect);
          return;
        }
      }
      ...
      synchronized (this.mCoverStateLock) {
        ...
        printWriter.println("  ");
        this.mCoverVerifier.dump(fileDescriptor, printWriter, strArr);
      }
      Feature.getInstance(this.mContext).dump(fileDescriptor, printWriter, strArr);
      this.mCoverServiceManager.dump(fileDescriptor, printWriter, strArr);
      this.mStateNotifier.dump(fileDescriptor, printWriter, strArr);
      this.mCoverDisabler.dump(fileDescriptor, printWriter, strArr);
      BaseNfcLedCoverController baseNfcLedCoverController = this.mNfcLedCoverController;
      if (baseNfcLedCoverController != null) {
        baseNfcLedCoverController.dump(fileDescriptor, printWriter, strArr);
      }
      GenericCoverServiceController genericCoverServiceController =
          this.mGenericCoverServiceController;
      if (genericCoverServiceController != null) {
        genericCoverServiceController.dump(fileDescriptor, printWriter, strArr);
      }
      if (this.mAutoScreenOn.support()) {
        this.mAutoScreenOn.dump(fileDescriptor, printWriter, strArr);
      }
      this.mCoverTestModeUtils.dump(fileDescriptor, printWriter, strArr);
      Log.dump("CoverManager_", fileDescriptor, printWriter, strArr);
      SAccessoryManagerInternal sAccessoryManagerInternal =
          (SAccessoryManagerInternal) LocalServices.getService(SAccessoryManagerInternal.class);
