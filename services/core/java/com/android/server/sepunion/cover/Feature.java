...
public final class Feature {
  ...
  public final void updateSystemFeature(Context context) {
    ...
    sSupportNfcLedCoverLevel =
        SemFloatingFeature.getInstance()
            .getInteger("SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_NFC_LED_COVER_LEVEL");
    ...
    sIsSupportMiniSviewWalletCover =
        packageManager.hasSystemFeature("com.sec.feature.cover.minisviewwalletcover");
    sIsSupportClearCameraViewCover =
        packageManager.hasSystemFeature("com.sec.feature.cover.clearcameraviewcover");
  ...
  public final void updateDeviceSupportFeature() {
    ...
    sIsDeviceSupportVerifyCover =
        CoverManagerUtils.isFileExists("/sys/devices/w1_bus_master1/w1_master_check_id")
            && CoverManagerUtils.isFileExists("/sys/devices/w1_bus_master1/w1_master_check_color");
    sIsDeviceSupportDetectCover =
        CoverManagerUtils.isFileExists("/sys/bus/w1/devices/w1_bus_master1/w1_master_check_detect");
