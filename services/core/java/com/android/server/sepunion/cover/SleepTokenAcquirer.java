...
public class SleepTokenAcquirer {
  ...
  public final Runnable mSleepTokenTask =
  ...
  public final Runnable mDefaultSleepToken =
      new Runnable() { // from class:
                       // com.android.server.sepunion.cover.SleepTokenAcquirer$$ExternalSyntheticLambda1
        @Override // java.lang.Runnable
        public final void run() {
  ...
  public final ActivityTaskManagerInternal.SleepTokenAcquirer getSleepTokenAcquirer(int i) {
    if (i == 0) {
      ...
      Log.d(TAG, "createSleepTokenAcquirer " + i);
      this.mVirtualAcquirer =
          this.mActivityTaskManagerInternal.createSleepTokenAcquirer("cover-virtual");
    }
