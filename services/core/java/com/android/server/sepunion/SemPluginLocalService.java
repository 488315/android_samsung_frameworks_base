...
public final class SemPluginLocalService extends SemPluginManagerLocal {
    ...
    public final void addLedNotification(Bundle bundle) {
        ...
        if (Binder.getCallingUid() != Process.myUid()) {
            if (!coverManagerServiceImpl.mCoverManagerAllowLists.isAllowedToUse(
                    coverManagerServiceImpl.mContext,
                    Binder.getCallingUid(),
                    Binder.getCallingPid())) {
                Log.w(
                        "CoverManager_CoverManagerServiceImpl",
                        "addLedNotification : caller is invalid");
                return;
            }
        }
    ...
    public final void disableCoverManager(boolean z, IBinder iBinder, String str) {
        ...
        if (!CoverTestModeUtils.isTestMode()
                ...
                && !coverManagerServiceImpl.mCoverManagerAllowLists.isAllowedToUse(
                        coverManagerServiceImpl.mContext,
                        Binder.getCallingUid(),
                        Binder.getCallingPid())) {
            Log.w(
                    "CoverManager_CoverManagerServiceImpl",
                    "disableCoverManager : caller is invalid");
            return;
        }
        ...
        if (disableCoverManagerLocked) {
            ...
            coverManagerServiceImpl.mHandler.post(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            synchronized (CoverManagerServiceImpl.this.mCoverStateLock) {
                                CoverManagerServiceImpl.this.sendCoverSwitchStateLocked(
                                        r2, false, false, true);
                            }
                        }
                    });
    ...
    public final CoverManagerServiceImpl getCoverManagerServiceImpl() {
        SemPluginManagerService semPluginManagerService =
                (SemPluginManagerService) SemUnionMainServiceImpl.getSemSystemService();
    ...
    public final boolean getCoverSwitchState() {
        ...
        if (!CoverTestModeUtils.isTestMode() && Binder.getCallingUid() != Process.myUid()) {
            if (!coverManagerServiceImpl.mCoverManagerAllowLists.isAllowedToUse(
                ...
                Log.w(
                        "CoverManager_CoverManagerServiceImpl",
                        "getCoverSwitchState : caller is invalid");
                return true;
            }
        }
        CoverDisabler coverDisabler = coverManagerServiceImpl.mCoverDisabler;
        return coverDisabler.mCoverManagerDisabled
                ? coverDisabler.mRealCoverSwitchState
                : coverManagerServiceImpl.mCoverState.getSwitchState();
    }
    ...
    public final int onCoverAppCovered(boolean z) {
        ...
        SleepTokenAcquirer$$ExternalSyntheticLambda0 sleepTokenAcquirer$$ExternalSyntheticLambda0 =
            ...
            synchronized (coverServiceManager2.mLock) {
                try {
                    if (coverServiceManager2.mActiveServices.size() != 0) {
                        ...
                        while (it2.hasNext()) {
                            CoverServiceManager.CoverServiceInfo coverServiceInfo =
                                    (CoverServiceManager.CoverServiceInfo) it2.next();
                            if (CoverServiceManager.SYSTEM_UI_COVER.equals(
                                    coverServiceInfo.component)) {
            ...
            synchronized (stateNotifier.mListeners) {
                ...
                while (it.hasNext()) {
                    StateNotifier.CoverStateListenerInfo coverStateListenerInfo =
                            (StateNotifier.CoverStateListenerInfo) it.next();
                    IBinder iBinder = coverStateListenerInfo.token;
                    if (iBinder == null) {
                        Log.w(
                                "CoverManager_StateNotifier",
                                "onCoverAppStateChanged : token is null");
                    } else if ((coverStateListenerInfo.type & 4) != 0) {
                        ICoverWindowStateListenerCallback asInterface =
                                ICoverWindowStateListenerCallback.Stub.asInterface(iBinder);
                        if (asInterface != null) {
    ...
    public final void registerListenerCallbackForExternal(
        ...
        Log.e(
                "CoverManager_CoverManagerServiceImpl",
                "deprecated registerListenerCallbackForExternal "
                        + this.mCoverManagerServiceImpl.mPackageManager.getNameForUid(
                                Binder.getCallingUid()));
    }
    ...
    public final void registerNfcTouchListenerCallback(
        ...
        try {
            this.mCoverManagerServiceImpl.registerNfcTouchListenerCallback(
                    i, iBinder, componentName);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public final void removeLedNotification(Bundle bundle) {
        ...
        if (Binder.getCallingUid() != Process.myUid()) {
            if (!coverManagerServiceImpl.mCoverManagerAllowLists.isAllowedToUse(
                ...
                Log.w(
                        "CoverManager_CoverManagerServiceImpl",
                        "removeLedNotification : caller is invalid");
                return;
            }
        }
    ...
    public final void sendDataToCover(int i, byte[] bArr) {
        ...
        CoverManagerAllowLists coverManagerAllowLists =
                coverManagerServiceImpl.mCoverManagerAllowLists;
        if (callingUid != myUid
                && !coverManagerAllowLists.isAllowedToUse(
                        coverManagerServiceImpl.mContext,
                        Binder.getCallingUid(),
                        Binder.getCallingPid())) {
        ...
        if (Constants.SYSTEMUI_PACKAGE_NAME.equals(
                CoverManagerAllowLists.getPackageForPid(context, callingPid))) {
            Log.w(
                    "CoverManager_CoverManagerServiceImpl",
                    "sendDataToCover : ignoring call from SystemUI");
        }
    }
    ...
    public final void sendDataToNfcLedCover(int i, byte[] bArr) {
        ...
        if (callingUid != myUid
            ...
            Log.w(
                    "CoverManager_CoverManagerServiceImpl",
                    "sendStateDataToCover : caller is invalid");
            return;
        }
        Context context = coverManagerServiceImpl.mContext;
        int callingPid = Binder.getCallingPid();
        ...
        if (i != -1 && i != -2) {
            ...
            BaseNfcLedCoverController baseNfcLedCoverController2 =
                    coverManagerServiceImpl.mNfcLedCoverController;
    ...
    public final void sendPowerKeyToCover() {
        ...
        GenericCoverServiceController genericCoverServiceController =
                coverManagerServiceImpl.mGenericCoverServiceController;
    ...
    public final void sendSystemEvent(Bundle bundle) {
        ...
        if (Binder.getCallingUid() != Process.myUid()) {
            if (!coverManagerServiceImpl.mCoverManagerAllowLists.isAllowedToUse(
                ...
                Log.w(
                        "CoverManager_CoverManagerServiceImpl",
                        "sendSystemEvent : caller is invalid");
                return;
            }
        }
        BaseNfcLedCoverController baseNfcLedCoverController =
            ...
            try {
                ...
                while (true) {
                    ...
                    if (coverStateListenerInfo != null
                            && iBinder.equals(coverStateListenerInfo.token)) {
                        break;
                    }
                }
                if (coverStateListenerInfo != null) {
                    ...
                    synchronized (stateNotifier.mListeners) {
                        try {
                            ...
                            while (true) {
                                ...
                                StateNotifier.CoverStateListenerInfo coverStateListenerInfo2 =
                                        (StateNotifier.CoverStateListenerInfo) it2.next();
                                if (coverStateListenerInfo2 != null
                                        && iBinder.equals(coverStateListenerInfo2.token)) {
    ...
    public final boolean unregisterCallbackForExternal(IBinder iBinder) {
        ...
        Log.e(
                "CoverManager_CoverManagerServiceImpl",
                "deprecated unregisterCallbackForExternal "
                        + this.mCoverManagerServiceImpl.mPackageManager.getNameForUid(
                                Binder.getCallingUid()));
        return false;
    }
    ...
    public final boolean unregisterNfcTouchListenerCallback(IBinder iBinder) {
        ...
        if (Binder.getCallingUid() != Process.myUid()
            ...
            Log.w(
                    "CoverManager_CoverManagerServiceImpl",
                    "unregisterNfcTouchListenerCallback : caller is invalid");
            return false;
        }
        BaseNfcLedCoverController baseNfcLedCoverController =
                coverManagerServiceImpl.mNfcLedCoverController;
        ...
        if (genericCoverServiceController != null) {
            Log.d(
                    ...
                    "unRegisterNfcTouchListenerCallback: binder = "
                            + iBinder
                            + ", pid : "
                            + Binder.getCallingPid()
                            + ", uid : "
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (genericPressEventListenerInfo != null
                                && iBinder.equals(genericPressEventListenerInfo.token)) {
                            Log.e(
                                    "CoverManager_GenericCoverServiceController",
                                    "remove listener: " + genericPressEventListenerInfo.pid);
                            genericCoverServiceController.mListeners.remove(
                                    genericPressEventListenerInfo);
