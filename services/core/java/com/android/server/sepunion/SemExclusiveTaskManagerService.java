...
public class SemExclusiveTaskManagerService extends ISemExclusiveTaskManager.Stub
  ...
  public BroadcastReceiver mUserSwitchedReceiver =
      new BroadcastReceiver() { // from class:
                                // com.android.server.sepunion.SemExclusiveTaskManagerService.1
  ...
  public final ContentObserver mExclusiveTaskObserver =
      new ContentObserver(
          new Handler()) { // from class:
                           // com.android.server.sepunion.SemExclusiveTaskManagerService.2
        @Override // android.database.ContentObserver
        public void onChange(boolean z, Uri uri, int i) {
          String substring = uri.toString().substring(19);
          Log.d(
              SemExclusiveTaskManagerService.TAG,
              "ExclusiveTaskObserver : key : " + substring + ", user : " + i);
          ...
          if ("system/accreset_state".equals(substring)) {
            userStatus.mIsA11yReset =
                Settings.System.getIntForUser(
                        SemExclusiveTaskManagerService.this.mContext.getContentResolver(),
                        "accreset_state",
                        0,
                        i)
                    == 1;
  ...
  public final void userSwitch(int i) {
    ...
    userStatus.mPreA11yServiceValue =
  ...
  public final void registerExclusiveTaskObserver() {
    ...
    while (it.hasNext()) {
      ((Task) this.mTaskMapByKey.get((String) it.next()))
          .setting.registerObserver(
              this.mContext.getContentResolver(), this.mExclusiveTaskObserver);
    }
    this.mContext
        .getContentResolver()
        .registerContentObserver(
            Settings.System.getUriFor("accreset_state"), false, this.mExclusiveTaskObserver, -1);
  }
  ...
  public final Task getA11yServiceTask(UserStatus userStatus) {
    ...
    Set<ComponentName> enabledServicesFromSettings =
        getEnabledServicesFromSettings(this.mContext, false);
    Set<ComponentName> enabledServicesFromSettings2 =
        getEnabledServicesFromSettings(this.mContext, true);
    String str = TAG;
  ...
  public final String getChangedA11yServiceName(Set set) {
    ...
    while (it.hasNext()) {
      ...
      if ("com.samsung.android.accessibility.talkback/com.samsung.android.marvin.talkback.TalkBackService"
          .equals(componentName.flattenToShortString())) {
        Log.d(str, "talkback se status has changed");
        return "talkback_se";
      }
      if ("com.google.android.marvin.talkback/.TalkBackService"
          .equals(componentName.flattenToShortString())) {
        Log.d(str, "talkback status has changed");
        return "talkback";
      }
      if ("com.samsung.accessibility/.universalswitch.UniversalSwitchService"
          .equals(componentName.flattenToShortString())) {
        Log.d(str, "universal switch status has changed");
        return "universal_switch";
      }
      if ("com.samsung.accessibility/.assistantmenu.serviceframework.AssistantMenuService"
          .equals(componentName.flattenToShortString())) {
  ...
  public final void updateProfile(String str) {
    ...
    if ("mute_all_sound".equals(str)) {
      AccessibilityUtils.updateProfile(
          this.mContext,
          "com.android.settings/com.samsung.android.settings.accessibility.shortcut.MuteAllShortcut");
    } else if ("talkback".equals(str)) {
      AccessibilityUtils.updateProfile(
          this.mContext, "com.google.android.marvin.talkback/.TalkBackService");
  ...
  public final void proccessTurningOffTask(Task task, UserStatus userStatus) {
    ...
    if (userStatus.mExclusiveTaskMap.containsKey(task.getName())) {
      ...
      Iterator it =
          ((ExclusiveTask) userStatus.mExclusiveTaskMap.get(task.getName()))
              .manipulatedList.iterator();
      while (it.hasNext()) {
  ...
  public final void executePostProccess(Task task, boolean z, UserStatus userStatus) {
    ...
    switch (c) {
      case 0:
        ...
        if (z) {
          userStatus.mPreReduceAnimationValue =
              Settings.System.getIntForUser(
                  this.mContext.getContentResolver(), "reduce_animations", 0, userStatus.mUserId);
          Settings.System.putIntForUser(
              this.mContext.getContentResolver(), "reduce_animations", 1, userStatus.mUserId);
          break;
        ...
        try {
          if (z) {
            ...
            if (!z2) {
              ...
              windowManagerService2.putKeyCustomizationInfo(
                  new SemWindowManager.KeyCustomizationInfo(8, 1106, 3, 0, intent));
            }
          } else {
      ...
      case 4:
        if (z) {
          for (int i = 0; i < this.mMagnificationShortcut.size(); i++) {
            if (((Integer) this.mMagnificationShortcut.get(i)).intValue() == 4) {
              ...
              ShortcutUtils.optInValueToSettings(
                  this.mContext,
                  ((Integer) this.mMagnificationShortcut.get(i)).intValue(),
          ...
          if (ShortcutUtils.isComponentIdExistingInSettings(
              this.mContext, 1, "com.android.server.accessibility.MagnificationController")) {
            this.mMagnificationShortcut.add(1);
            ShortcutUtils.optOutValueFromSettings(
                this.mContext, 1, "com.android.server.accessibility.MagnificationController");
          }
          if (ShortcutUtils.isComponentIdExistingInSettings(
              this.mContext, 2, "com.android.server.accessibility.MagnificationController")) {
            this.mMagnificationShortcut.add(2);
            ShortcutUtils.optOutValueFromSettings(
                this.mContext, 2, "com.android.server.accessibility.MagnificationController");
          }
          if (ShortcutUtils.isComponentIdExistingInSettings(
              this.mContext, 3, "com.android.server.accessibility.MagnificationController")) {
      ...
      case 7:
        ...
        intent5.setComponent(
            ComponentName.unflattenFromString(
                "com.samsung.accessibility/.interactioncontrol.AccessControlMainService"));
        if (z) {
      ...
      case '\b':
        ...
        if (z) {
          accessibilityManager.semEnableMdnieColorFilter(
              Settings.Secure.getIntForUser(
                  this.mContext.getContentResolver(), "color_lens_type", 0, userStatus.mUserId),
              Settings.Secure.getIntForUser(
                  this.mContext.getContentResolver(), "color_lens_opacity", 0, userStatus.mUserId));
          break;
        } else {
      ...
      case '\t':
        ...
        if (Settings.Secure.getIntForUser(
                this.mContext.getContentResolver(), "color_adjustment_type", 2, userStatus.mUserId)
            == 0) {
          setGrayScale(this.mContext, z);
          break;
        } else {
          setGrayScale(this.mContext, false);
          accessibilityManager2.semSetMdnieColorBlind(
              z,
  ...
  public class Task {
    ...
    public final boolean getSettingsStatus(UserStatus userStatus) {
      if (getType() == 1) {
        SemExclusiveTaskManagerService semExclusiveTaskManagerService =
            SemExclusiveTaskManagerService.this;
        return semExclusiveTaskManagerService.isAccessibilityServiceEnabled(
            semExclusiveTaskManagerService.mContext, this.componentName);
      }
    ...
    public final void turnOnOff(boolean z, UserStatus userStatus) {
      if (getType() == 1) {
        ...
        SemExclusiveTaskManagerService semExclusiveTaskManagerService =
            SemExclusiveTaskManagerService.this;
        semExclusiveTaskManagerService.setAccessibilityServiceState(
            semExclusiveTaskManagerService.mContext, unflattenFromString, z, userStatus.mUserId);
    ...
    public final boolean canTurnOnFeature(UserStatus userStatus) {
      ...
      while (it.hasNext()) {
        ...
        if (task.getSettingsStatus(userStatus)) {
          Log.d(
              SemExclusiveTaskManagerService.TAG,
              "canTurnOnFeature() returns false : " + task.getName() + " is on");
          return false;
        }
      }
      return true;
  ...
  public class TaskSettings {
    ...
    */
    ...
    public void registerObserver(ContentResolver contentResolver, ContentObserver contentObserver) {
      ...
      if (i == 1) {
        contentResolver.registerContentObserver(
            Settings.System.getUriFor(this.key), false, contentObserver, -1);
      } else if (i == 2) {
        contentResolver.registerContentObserver(
            Settings.Secure.getUriFor(this.key), false, contentObserver, -1);
      } else {
        if (i != 3) {
          return;
        }
        contentResolver.registerContentObserver(
            Settings.Global.getUriFor(this.key), false, contentObserver, -1);
      }
    }
    ...
    public void putCurrentSettingsValue(int i, UserStatus userStatus) {
      ...
      if (i2 == 1) {
        ...
        Settings.Global.putInt(
            SemExclusiveTaskManagerService.this.mContext.getContentResolver(), this.key, i);
      }
    ...
    public final boolean isExceptionalCase() {
      return this.key.equals("any_screen_enabled")
    ...
    try {
      Document parse =
          DocumentBuilderFactory.newInstance()
              .newDocumentBuilder()
              .parse(new File("/system/etc/task_action.xml"));
          ...
          if (item.getNodeType() == 1
            ...
            for (int i3 = 0; i3 < attributes.getLength(); i3++) {
              ...
              if (c == 0) {
                ...
                task.exclusiveListSet.addAll(
                    new ArrayList(
                        Arrays.asList(item2.getNodeValue().replaceAll(" ", "").split(","))));
              } else if (c == 4) {
  ...
  public void setAccessibilityServiceState(
    ...
    Settings.Secure.putStringForUser(
        context.getContentResolver(), "enabled_accessibility_services", sb.toString(), i);
    Settings.Secure.putIntForUser(
        context.getContentResolver(),
        "accessibility_enabled",
        !enabledServicesFromSettings.isEmpty() ? 1 : 0,
        i);
  }
  ...
  public Set getEnabledServicesFromSettings(Context context, boolean z) {
    ...
    if (z) {
      str =
          Settings.Secure.getStringForUser(
              context.getContentResolver(), "enabled_accessibility_services", -2);
    } else {
      UserStatus userStatus = getUserStatus(ActivityManager.getCurrentUser());
  ...
  public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
    ...
    while (it2.hasNext()) {
      UserStatus userStatus =
          (UserStatus) this.mUserStatus.get(Integer.valueOf(((Integer) it2.next()).intValue()));
      ...
      while (it3.hasNext()) {
        ExclusiveTask exclusiveTask =
            (ExclusiveTask) userStatus.mExclusiveTaskMap.get((String) it3.next());
