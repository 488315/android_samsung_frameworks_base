...
public final class TipsManagerService extends ITipsManager.Stub implements AbsSemSystemService {
    ...
    public final class TipsHandler extends Handler {
        ...
        public final void handleMessage(Message message) {
            ...
            if (SemEmergencyManager.getInstance(tipsManagerService.mContext) != null
                    ? SemEmergencyManager.isEmergencyMode(tipsManagerService.mContext)
                    : false) {
                Long l = TipsManagerService.mLastDeviceConnectMsgTime;
                Log.d(
                        "TipsManagerService",
                        "[GalaxyTips] Fail to send intent to Tips at emergency mode.");
                return;
            }
            int i = message.what;
            if (i != 10001) {
                ...
                try {
                    tipsManagerService.mContext.startForegroundServiceAsUser(
                    ...
                    Log.d(
                            "TipsManagerService",
                            "[GalaxyTips] Fail to send FOTA DONE intent to Tips.");
                    return;
                }
            }
            if (tipsManagerService.mTipsNetworkGranted
                    || tipsManagerService.mHUNDisplayCount >= 3) {
                return;
            }
            ...
            TipsManagerService.m873$$Nest$smsendMsg(
                    tipsManagerService.mTipsHandler, 10001, 604800000);
        }
    }
            ...
            if ("com.samsung.android.app.tips"
                ...
                IntentFilter m =
                        GmsAlarmManager$$ExternalSyntheticOutline0.m(
                                ...
                                "samsung.galaxy.tips.application.terminated",
                ...
                context.registerReceiverAsUser(
                        TipsManagerService.this.mTipReceiver, UserHandle.ALL, m, null, null, 2);
    ...
    public final class TipsReceiver extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                TipsManagerService tipsManagerService = TipsManagerService.this;
                if (!tipsManagerService.mTipsHUNAlreadyShown
                        && !tipsManagerService.mWaitingCallEnd
                ...
                if (TipsManagerService.this.mWaitingCallEnd
                    ...
                    if (extras == null
                            || !extras.getString(LauncherConfigurationInternal.KEY_STATE_BOOLEAN)
                    ...
                    if (tipsManagerService2.mDialCount != 5) {
                        ContentResolver contentResolver =
                                tipsManagerService2.mContext.getContentResolver();
                    ...
                    if (!tipsManagerService4.mTipsNetworkGranted) {
                        TipsManagerService.m873$$Nest$smsendMsg(
                                tipsManagerService4.mTipsHandler, 10001, 60000);
                    }
                ...
                if (!TipsManagerService.this.mTipsNetworkGranted
                    ...
                    Settings.System.putIntForUser(
                            tipsManagerService5.mContext.getContentResolver(),
                ...
                if (TipsManagerService.this.mBootupCompleted
                    ...
                    Log.d(
                            "TipsManagerService",
                            "USER_SWITCHED isNetworkGranted "
                                    + TipsManagerService.this.mTipsNetworkGranted);
                    return;
                }
                if (TipsManagerService.this.mBootupCompleted
                    ...
                    if (tipsManagerService6.mTipsPackageExist) {
                        TipsManagerService.m873$$Nest$smsendMsg(
                                tipsManagerService6.mTipsHandler, 10004, 120000);
                    }
                }
            } catch (Exception unused2) {
    ...
    public static void m873$$Nest$smsendMsg(Handler handler, int i, int i2) {
        ...
        synchronized (mLastDeviceConnectMsgTime) {
            handler.sendMessageAtTime(
                    handler.obtainMessage(i, 0, 0, null), SystemClock.uptimeMillis() + i2);
        }
    }
    ...
    public TipsManagerService(Context context) {
        ...
        try {
            ...
            int intForUser =
                    Settings.System.getIntForUser(
                            context.getContentResolver(), "tips_trigger_count", 0, -2);
            this.mDialCount = intForUser;
            if (intForUser == 1000) {
                this.mTipsHUNAlreadyShown = true;
            }
            if (Settings.System.getIntForUser(
                            context.getContentResolver(), "gtips_network_granted", 0, -2)
                    == 1) {
            ...
            context.registerReceiverAsUser(
                    tipsReceiver, UserHandle.ALL, intentFilter, null, null, 2);
        ...
        this.mContext.registerReceiverAsUser(
                this.mPackageReceiver, UserHandle.ALL, intentFilter2, null, null, 2);
