...
public class SemGoodCatchService extends IGoodCatchManager.Stub implements AbsSemSystemService {
  ...
  public BroadcastReceiver mIntentReceiver =
      new BroadcastReceiver() { // from class: com.android.server.sepunion.SemGoodCatchService.1
        public final Signature[] trustedSignatures = {
          new Signature(
        ...
        public void onReceive(Context context, Intent intent) {
          Log.v(
              SemGoodCatchService.TAG,
              "onReceive((Context context, Intent intent : " + intent.toString());
          if (intent.getAction().equals("com.samsung.android.app.goodcatch.GOOD_CATCH_URI")) {
            ...
            if (stringExtra == null
                || stringExtra2 == null
                || stringExtra3 == null
                || !verifyAuthorities(stringExtra, stringExtra2, stringExtra3)) {
              return;
            }
            ...
            SemGoodCatchService.this.mFeatureEvent.mo84on();
            Log.v(SemGoodCatchService.TAG, "sendMsg(mGoodCatchHandler, MSG_CREATE_OBSERVER,...)");
            SemGoodCatchService.sendMsg(
                SemGoodCatchService.this.mGoodCatchHandler, 3, 0, 0, null, 0);
          }
        }
        ...
        public final boolean verifyAuthorities(String... strArr) {
          ...
          Log.d(
              SemGoodCatchService.TAG,
              "Since it will not be shipped, continues whatever verified or not.");
          return true;
        }
  ...
  public void onBootPhase(int i) {
    if (i == 1000) {
      sendBroadcastToUser(
          new Intent("com.android.server.sepunion.semgoodcatchservice.GOOD_CATCH_STATE_CHANGED"),
          UserHandle.CURRENT);
      Log.d(
          TAG,
          "PHASE_BOOT_COMPLETED, send"
  ...
  public void registerListener(
    ...
    synchronized (this.mGoodCatchClients) {
      this.mGoodCatchClients.put(
          iBinder, new GoodCatchClient(str, strArr, iGoodCatchDispatcher, iBinder));
    }
  }
    ...
    public void dump(PrintWriter printWriter) {
      ...
      synchronized (this.mFunctions) {
        for (Map.Entry entry : this.mFunctions.entrySet()) {
          printWriter.println(
              "    Function:" + ((String) entry.getKey()) + ", " + entry.getValue());
        }
      }
    }
  }
  ...
  public static void sendMsg(Handler handler, int i, int i2, int i3, Object obj, int i4) {
    handler.sendMessageAtTime(
        handler.obtainMessage(i, i2, i3, obj), SystemClock.uptimeMillis() + i4);
  }
  ...
  public class GoodCatchHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      ...
      if (i == 2) {
        ...
        SemGoodCatchService.this.mFeatureEvent.update(
            strArr[0], strArr[1], strArr[2], strArr[3], strArr[4], strArr[5], strArr[6]);
      } else if (i == 3) {
  ...
  public final void createObserver() {
    ...
    Log.v(
        str,
        "mFeatureSetting.getUri() : "
            + this.mFeatureSetting.getUri()
            + ", mFeatureEvent.getUri() : "
            + this.mFeatureEvent.getUri()
            + "mFeatureSettingsProvider.getUri() : "
            + this.mFeatureSettingsProvider.getUri());
    if (this.mGoodCatchObserver == null
        && this.mFeatureSetting.getUri() != null
        && this.mFeatureEvent.getUri() != null
        && this.mFeatureSettingsProvider.getUri() != null) {
  ...
  public class GoodCatchObserver extends ContentObserver {
    public GoodCatchObserver() {
      super(new Handler());
      SemGoodCatchService.this.mContentResolver.registerContentObserver(
          SemGoodCatchService.this.mFeatureSetting.getUri(), false, this, -2);
      Log.v(
          SemGoodCatchService.TAG,
          "mContentResolver.registerContentObserver(mFeatureSetting.getUri() : "
              + SemGoodCatchService.this.mFeatureSetting.getUri());
      update();
    }
  ...
  public class FeatureSetting extends SecFeature {
    ...
    */
    public void update() {
      ...
      String str2;
      if (getUri() == null) {
        Log.e(SemGoodCatchService.TAG, "uri is null");
        return;
      }
      synchronized (SemGoodCatchService.this.mGoodCatchClients) {
        Cursor cursor = null;
        try {
          try {
            cursor =
                SemGoodCatchService.this.mContentResolver.query(getUri(), null, null, null, null);
            if (cursor != null) {
              Log.v(SemGoodCatchService.TAG, "query, cur.getCount() : " + cursor.getCount());
            } else {
              Log.e(SemGoodCatchService.TAG, "query, cur is null");
            }
            loop0:
            while (true) {
              boolean z = false;
              while (cursor != null) {
                ...
                Log.d(
                    SemGoodCatchService.TAG,
                    "module='" + string + "', function='" + string2 + "', value='" + string3 + "'");
                if (string != null && string2 != null && string3 != null) {
                  Iterator it = SemGoodCatchService.this.mGoodCatchClients.values().iterator();
                  while (true) {
                    if (it.hasNext()) {
                      GoodCatchClient goodCatchClient = (GoodCatchClient) it.next();
                      if (goodCatchClient.has(string, string2)) {
                        break;
                      }
                    }
                  }
                ...
                Log.e(
                    SemGoodCatchService.TAG, "It is abnormal that query results have null string.");
              }
              sb.append(str2);
              sb.append("'");
            ...
            Log.e(SemGoodCatchService.TAG, "update error " + e);
          }
        } finally {
          if (cursor != null) {
            cursor.close();
    ...
    public void mo84on() {
      ...
      SemGoodCatchService.this.mContext.registerReceiver(
          new BroadcastReceiver() { // from class:
                                    // com.android.server.sepunion.SemGoodCatchService.FeatureSetting.1
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
              String str;
              if (intent != null) {
              ...
              if ("android.intent.action.PACKAGE_REMOVED".equals(r4)
                  && "com.samsung.android.app.goodcatch".equals(str)) {
  ...
  public class FeatureEvent extends SecFeature {
    ...
    public void update(
      ...
      try {
        SemGoodCatchService.this.mContentResolver.insert(
            SemGoodCatchService.this.mFeatureEvent.getUri(), contentValues);
      } catch (Exception e) {
    ...
    public FeatureDetectAds() {
      ...
      this.mProcessObserver =
          new IProcessObserver
              .Stub() { // from class:
                        // com.android.server.sepunion.SemGoodCatchService.FeatureDetectAds.1
            ...
            public void onForegroundActivitiesChanged(int i, int i2, boolean z) {
              if (z) {
                ...
                if (!FeatureDetectAds.this.isActiveState()
                    || FeatureDetectAds.this.mPreviousUid == FeatureDetectAds.this.mForegroundUid) {
                  return;
                }
                Log.d(
                    SemGoodCatchService.TAG,
                    "mForegroundUid = " + FeatureDetectAds.this.mForegroundUid + "(" + str + ")");
      ...
      this.mReceiver =
          new BroadcastReceiver() { // from class:
                                    // com.android.server.sepunion.SemGoodCatchService.FeatureDetectAds.2
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
              String action = intent.getAction();
              if (action.equals("android.intent.action.SCREEN_ON")) {
                ...
                SemGoodCatchService.sendMsg(
                    SemGoodCatchService.this.mGoodCatchHandler, 4, 0, 0, null, 2000);
      ...
      this.mOnStateListener =
          new SemGoodCatchManager
              .OnStateChangeListener() { // from class:
                                         // com.android.server.sepunion.SemGoodCatchService.FeatureDetectAds.3
            public void onStart(String str) {
              Log.d(SemGoodCatchService.TAG, "onStart " + str);
              FeatureDetectAds.this.mo84on();
            }
      ...
      SemGoodCatchService.this.mContext.registerReceiver(
          new BroadcastReceiver() { // from class:
                                    // com.android.server.sepunion.SemGoodCatchService.FeatureDetectAds.4
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
              if (intent
                  .getAction()
                  .equals(
                      "com.android.server.sepunion.semgoodcatchservice.GOOD_CATCH_STATE_CHANGED")) {
                FeatureDetectAds.this.mSemGoodCatchManager =
                    new SemGoodCatchManager(
                        SemGoodCatchService.this.mContext,
                        "FeatureDetectAds",
                        new String[] {"detectads"},
                        FeatureDetectAds.this.mOnStateListener);
              }
            }
          },
          intentFilter);
  ...
  public class FeatureWakeUp extends SecFeature {
    ...
    public FeatureWakeUp() {
      ...
      this.mOnStateListener =
          new SemGoodCatchManager
              .OnStateChangeListener() { // from class:
                                         // com.android.server.sepunion.SemGoodCatchService.FeatureWakeUp.1
            public void onStart(String str) {
              Log.d(SemGoodCatchService.TAG, "onStart " + str);
              FeatureWakeUp.this.mo84on();
      ...
      SemGoodCatchService.this.mContext.registerReceiver(
          new BroadcastReceiver() { // from class:
                                    // com.android.server.sepunion.SemGoodCatchService.FeatureWakeUp.2
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
              if (intent
                  .getAction()
                  .equals(
                      "com.android.server.sepunion.semgoodcatchservice.GOOD_CATCH_STATE_CHANGED")) {
                FeatureWakeUp.this.mSemGoodCatchManager =
                    new SemGoodCatchManager(
                        SemGoodCatchService.this.mContext,
                        "FeatureWakeUp",
                        new String[] {"wakeup"},
                        FeatureWakeUp.this.mOnStateListener);
              }
            }
          },
          intentFilter);
    ...
    public void update() {
      PowerHistorian.getInstance()
          .getWakeUpRecords()
          .forEach(
              new Consumer() { // from class:
                               // com.android.server.sepunion.SemGoodCatchService$FeatureWakeUp$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  SemGoodCatchService.FeatureWakeUp.this.lambda$update$0(
                      (PowerHistorian.WakeUpRecord) obj);
                }
              });
    ...
    public /* synthetic */ void lambda$update$0(PowerHistorian.WakeUpRecord wakeUpRecord) {
      if (wakeUpRecord.isOn()) {
        ...
        Log.d(
            SemGoodCatchService.TAG,
            "MODULE : FeatureWakeUp, FUNCTION : wakeup, opPackageName : "
                + opPackageName
                + ", reasonInt : "
                + reasonInt
                + ", reasonStr : "
                ...
                + foregroundPackageName);
        SemGoodCatchService.sendMsg(
            SemGoodCatchService.this.mGoodCatchHandler,
            2,
            0,
            0,
            new String[] {
              ...
              "wakeup",
              opPackageName,
              Long.toString(recordedTimeMillis),
              Integer.toString(reasonInt),
              reasonStr,
              foregroundPackageName
            },
            0);
    ...
    public void doneTrigger() {
      ...
      try {
        SemGoodCatchService.this.mContentResolver.update(
            SemGoodCatchService.this.mFeatureSetting.getUri(),
            contentValues,
            "function LIKE ?",
            strArr);
  ...
  public class FeatureSettingsProvider extends SecFeature {
    ...
    public List getSelectedSettingKey() {
      ...
      try {
        cursor =
            SemGoodCatchService.this.mContentResolver.query(
                SemGoodCatchService.this.mFeatureSettingsProvider.getUri(),
                new String[] {"db_key"},
                null,
                null,
                null);
      ...
      Log.d(
          SemGoodCatchService.TAG,
          "getSelectedSettingKey() returns " + arrayList.size() + " keys.");
      return arrayList;
    }
