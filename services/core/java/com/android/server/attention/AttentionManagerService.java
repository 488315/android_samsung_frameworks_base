...
public class AttentionManagerService extends SystemService {
  ...
  public AttentionManagerService(
      Context context, PowerManager powerManager, Object obj, AttentionHandler attentionHandler) {
    super(context);
  ...
  public void onBootPhase(int i) {
    if (i == 500) {
      this.mContext.registerReceiver(
          new ScreenStateReceiver(), new IntentFilter("android.intent.action.SCREEN_OFF"));
  ...
  public boolean checkAttention(
    ...
    if (!this.mIsServiceEnabled) {
      Slog.w(
          "AttentionManagerService", "Trying to call checkAttention() on an unsupported device.");
      return false;
    }
    ...
    synchronized (this.mLock) {
      ...
      AttentionCheckCache last =
          attentionCheckCacheBuffer == null ? null : attentionCheckCacheBuffer.getLast();
      ...
      if (attentionCheck != null
          && (!attentionCheck.mIsDispatched || !this.mCurrentAttentionCheck.mIsFulfilled)) {
        return false;
      }
  ...
  public boolean onStartProximityUpdates(
    ...
    synchronized (this.mLock) {
      ...
      if (proximityUpdate != null && proximityUpdate.mStartedUpdates) {
        ...
        Slog.w(
            "AttentionManagerService",
            "New proximity update cannot be processed because there is already an ongoing update");
        return false;
      }
  ...
  public void onStopProximityUpdates(
    ...
    synchronized (this.mLock) {
      ...
      if (proximityUpdate != null
          && proximityUpdate.mCallbackInternal.equals(proximityUpdateCallbackInternal)
          && this.mCurrentProximityUpdate.mStartedUpdates) {
  ...
  public static ComponentName resolveAttentionService(Context context) {
    ...
    ResolveInfo resolveService =
        context
            .getPackageManager()
            .resolveService(
                new Intent("android.service.attention.AttentionService").setPackage(str), i);
    if (resolveService == null || (serviceInfo = resolveService.serviceInfo) == null) {
      Slog.wtf(
          "AttentionManagerService",
          String.format(
              "Service %s not found in package %s",
              "android.service.attention.AttentionService", serviceConfigPackage));
      return null;
    }
  ...
  public final void dumpInternal(IndentingPrintWriter indentingPrintWriter) {
    ...
    indentingPrintWriter.println(
        "AttentionServicePackageName=" + getServiceConfigPackage(this.mContext));
      ...
      this.mIAttentionCallback =
          new IAttentionCallback
            ...
            public void onSuccess(int i, long j) {
              ...
              logStats(i);
              attentionManagerService.appendResultToAttentionCacheBuffer(
  ...
  final class ProximityUpdate {
    ...
    public ProximityUpdate(
      ...
      this.mIProximityUpdateCallback =
    ...
    if (iAttentionService2 != null) {
      try {
        iAttentionService2.onStartProximityUpdates(
            this.mCurrentProximityUpdate.mIProximityUpdateCallback);
        return;
      } catch (RemoteException e) {
        Slog.e("AttentionManagerService", "Cannot call into the AttentionService", e);
        return;
    ...
    synchronized (this.mLock) {
      ...
      this.mAttentionHandler.post(
          new Runnable() { // from class:
                           // com.android.server.attention.AttentionManagerService$$ExternalSyntheticLambda1
  ...
  public final void bindLocked() {
    ...
    this.mAttentionHandler.post(
        new Runnable() { // from class:
                         // com.android.server.attention.AttentionManagerService$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$bindLocked$2() {
    this.mContext.bindServiceAsUser(
        new Intent("android.service.attention.AttentionService").setComponent(this.mComponentName),
        this.mConnection,
        67112961,
        UserHandle.CURRENT);
  }
  ...
  public final class AttentionManagerServiceShellCommand extends ShellCommand {
    ...
    public class TestableAttentionCallbackInternal
    ...
    public class TestableProximityUpdateCallbackInternal
    ...
    public final int cmdSetTestableAttentionService(String str) {
      ...
      outPrintWriter.println(
          AttentionManagerService.this.mComponentName != null ? "true" : "false");
      return 0;
    }
    ...
    public final int cmdCallCheckAttention() {
      getOutPrintWriter()
          .println(
              AttentionManagerService.this.checkAttention(2000L, this.mTestableAttentionCallback)
                  ? "true"
                  : "false");
      return 0;
    }
    ...
    public final int cmdResolveAttentionServiceComponent() {
      ...
      ComponentName resolveAttentionService =
          AttentionManagerService.resolveAttentionService(AttentionManagerService.this.mContext);
      outPrintWriter.println(
          resolveAttentionService != null ? resolveAttentionService.flattenToShortString() : "");
      return 0;
    }
    ...
    public final void resetStates() {
      ...
      attentionManagerService2.mComponentName =
          AttentionManagerService.resolveAttentionService(attentionManagerService2.mContext);
    }
    ...
    public void onHelp() {
      ...
      outPrintWriter.println(
          "  setTestableAttentionService <service_package>: Bind to a custom implementation of"
              + " attention service");
      ...
      outPrintWriter.println("  ---returns:");
      outPrintWriter.println(
          "       := If valid, the component string (in shorten form) for the currently bound"
              + " service.");
      outPrintWriter.println("       := else, empty string");
      outPrintWriter.println("  call checkAttention: Calls check attention");
      outPrintWriter.println("  ---returns:");
      outPrintWriter.println(
          "       := true, if the call was successfully dispatched to the service implementation."
      ...
      outPrintWriter.println("  ---returns:");
      outPrintWriter.println(
          "       := An integer, representing the last callback code received from the bounded"
              + " implementation. If none, it will return -1");
      outPrintWriter.println("  getLastTestProximityUpdateCallbackCode");
      outPrintWriter.println("  ---returns:");
      outPrintWriter.println(
          "       := A double, representing the last proximity value received from the bounded"
              + " implementation. If none, it will return -1.0");
    }
  }
  ...
  public final class BinderService extends Binder {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          AttentionManagerService.this.mContext, "AttentionManagerService", printWriter)) {
