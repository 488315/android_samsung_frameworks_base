...
public class CriticalEventLog {
  ...
  public CriticalEventLogProto getOutputLogProto(int i, String str, int i2) {
    ...
    CriticalEventProto[] recentEventsWithMinTimestamp =
        recentEventsWithMinTimestamp(criticalEventLogProto.timestampMs - this.mWindowMs);
    ...
    for (int i = 0; i < criticalEventProtoArr.length; i++) {
      if (criticalEventProtoArr[i].timestampMs >= j) {
        return (CriticalEventProto[])
            Arrays.copyOfRange(criticalEventProtoArr, i, criticalEventProtoArr.length);
      }
    }
  ...
  public final void saveLogToFile() {
    if (this.mLoadAndSaveImmediately) {
      ...
      if (this.mHandler.hasCallbacks(this.mSaveRunnable)
          || this.mHandler.postDelayed(this.mSaveRunnable, saveDelayMs())) {
        return;
      }
  ...
  public class LogSanitizer {
    ...
    public static CriticalEventProto sanitizeAnr(CriticalEventProto criticalEventProto) {
      ...
      CriticalEventProto sanitizeCriticalEventProto =
          sanitizeCriticalEventProto(criticalEventProto);
    ...
    public static CriticalEventProto sanitizeCriticalEventProto(
