...
public class DualAppManagerService extends ISemDualAppManager.Stub {
    ...
    */
    public static Intent startDAChooserActivity(Intent intent, int i, int i2, String str, int i3) {
        ...
        String str3;
        String str4;
        if (!"com.bst.floatingmsgproxy".equals(str) && !"com.bst.airmessage".equals(str) && !"com.samsung.android.da.daagent".equals(str) && !"com.samsung.android.spay".equals(str)) {
            try {
                boolean isDualAppId = SemDualAppManager.isDualAppId(i);
                if (new ComponentName("com.samsung.android.da.daagent", "com.samsung.android.da.daagent.activity.ForwardShareActivity").equals(intent.getComponent())) {
                    intent.setClassName("com.samsung.android.da.daagent", "com.samsung.android.da.daagent.activity.EmptyActivity");
                ...
                if ((!"android.intent.action.SEND".equals(intent.getAction()) && !"android.intent.action.SEND_MULTIPLE".equals(intent.getAction())) || (!isDualAppId && i != 0)) {
                    if ((i2 == 0 || SemDualAppManager.isDualAppId(i2)) && intent.getComponent() != null && i3 != 1000 && !intent.getComponent().getPackageName().equals(str) && isInstalledWhitelistedPackageInternal(intent.getComponent().getPackageName()) && !"com.sina.weibo".equals(str) && SemDualAppManager.isChooserRequired(intent.getComponent().getClassName())) {
                        createChooser = Intent.createChooser(new Intent(), mContext.getString(17043293));
                    } else if (intent.getData() != null && "mqqapi".equals(intent.getData().getScheme()) && (isInstalledWhitelistedPackageInternal("com.tencent.mobileqq") || isInstalledWhitelistedPackageInternal("com.tencent.mobileqqi"))) {
                    ...
                    } else if (intent.getData() != null && "weixin".equals(intent.getData().getScheme()) && isInstalledWhitelistedPackageInternal("com.tencent.mm")) {
                        createChooser = Intent.createChooser(new Intent(), mContext.getString(17043293));
                        if ((KnoxCustomManagerService.SBROWSER_CHAMELEON_PACKAGE_NAME.equals(str) || "com.android.chrome".equals(str)) && intent.hasCategory("android.intent.category.BROWSABLE")) {
                            createChooser.addFlags(335544320);
                            Log.d("DualAppManagerService", "startDAChooserActivity addFlags for chooserIntent");
                        }
                    } else if (intent.getData() != null && "mqqwallet".equals(intent.getData().getScheme()) && (isInstalledWhitelistedPackageInternal("com.tencent.mobileqq") || isInstalledWhitelistedPackageInternal("com.tencent.mobileqqi"))) {
                        createChooser = Intent.createChooser(new Intent(), mContext.getString(17043293));
                    } else {
                        if (i2 == 0 && Binder.getCallingUid() != 1000 && ("com.taobao.taobao".equals(str) || "com.eg.android.AlipayGphone".equals(str) || "com.tmall.wireless".equals(str))) {
                            if (intent.getComponent() != null) {
                                str3 = intent.getComponent().getPackageName();
                            } else {
                                str3 = intent.getPackage();
                            }
                            if (str != null && str3 != null && !str.equals(str3) && isInstalledWhitelistedPackageInternal(str3) && SemDualAppManager.isChinaDualApp(str3)) {
                                createChooser = Intent.createChooser(new Intent(), mContext.getString(17043310));
                            }
                            createChooser = null;
                            z = false;
                        } else {
                            if (!"vnd.android.cursor.item/vnd.com.tencent.mm.chatting.profile".equals(intent.getType()) && !"vnd.android.cursor.item/vnd.com.tencent.mm.chatting.voip".equals(intent.getType()) && !"vnd.android.cursor.item/vnd.com.tencent.mm.plugin.sns.timeline".equals(intent.getType()) && !"vnd.android.cursor.item/vnd.com.tencent.mm.chatting.voiceaction".equals(intent.getType())) {
                                if (intent.getDataString() != null && intent.getDataString().contains("kakaotalk://settings/theme/") && isInstalledWhitelistedPackageInternal("com.kakao.talk")) {
                            ...
                            if (isInstalledWhitelistedPackageInternal("com.tencent.mm") && !isInstalledWhitelistedPackageInternal(str)) {
                ...
                if (str != null && str2 != null && !str.equals(str2) && isInstalledWhitelistedPackageInternal(str2)) {
                    createChooser = Intent.createChooser(new Intent(), mContext.getString(17043310));
                    z = true;
                    if (z) {
                    }
