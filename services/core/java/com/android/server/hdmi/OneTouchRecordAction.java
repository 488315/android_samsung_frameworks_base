...
public final class OneTouchRecordAction extends HdmiCecFeatureAction {
    ...
    public final void handleTimerEvent(int i) {
        if (this.mState != i) {
            ...
            ((HdmiCecLocalDeviceTv) this.mSource)
                    .announceOneTouchRecordResult(this.mRecorderAddress, 49);
            finish(true);
        }
    }
    ...
    public final boolean processCommand(HdmiCecMessage hdmiCecMessage) {
        ...
        int i2;
        if (this.mState != 1
                || (i2 = this.mRecorderAddress) != (i = hdmiCecMessage.mSource)
                || hdmiCecMessage.mOpcode != 10
                || i != i2) {
            return false;
        }
        ...
        SystemServiceManager$$ExternalSyntheticOutline0.m(
                sb, hdmiCecMessage.mSource, "OneTouchRecordAction");
        if (b == 1 || b == 2 || b == 3 || b == 4) {
            this.mState = 2;
    ...
    public final void start() {
        this.mService.sendCecCommand(
                HdmiCecMessage.build(
                        getSourceAddress(), this.mRecorderAddress, 9, this.mRecordSource),
                new HdmiControlService
                        .SendMessageCallback() { // from class:
                                                 // com.android.server.hdmi.OneTouchRecordAction.1
                    @Override // com.android.server.hdmi.HdmiControlService.SendMessageCallback
                    public final void onSendCompleted(int i) {
                        if (i != 0) {
                            OneTouchRecordAction oneTouchRecordAction = OneTouchRecordAction.this;
                            ((HdmiCecLocalDeviceTv) oneTouchRecordAction.mSource)
                                    .announceOneTouchRecordResult(
                                            oneTouchRecordAction.mRecorderAddress, 49);
