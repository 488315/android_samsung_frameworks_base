...
public class HdmiCecMessage {
  ...
  public static String validationResultToString(int i) {
    return i != 0
        ? i != 1
            ? i != 2
                ? i != 3 ? i != 4 ? "unknown error" : "short parameters" : "invalid parameters"
                : "invalid destination"
            : "invalid source"
        : "ok";
  }
  ...
  public HdmiCecMessage(int i, int i2, int i3, byte[] bArr) {
    this(
        ...
        i3,
        bArr,
        HdmiCecMessageValidator.validate(
            i, i2, i3 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT, bArr));
  }
  ...
  public boolean equals(Object obj) {
    ...
    return this.mSource == hdmiCecMessage.getSource()
        && this.mDestination == hdmiCecMessage.getDestination()
        && this.mOpcode == hdmiCecMessage.getOpcode()
        && Arrays.equals(this.mParams, hdmiCecMessage.getParams())
        && this.mValidationResult == hdmiCecMessage.getValidationResult();
  }
    ...
    if (this.mParams.length > 0) {
      if (filterMessageParameters(this.mOpcode)) {
        ...
        if (isUserControlPressedMessage(this.mOpcode)) {
          sb.append(
              String.format(
                  " <Keycode type = %s>", HdmiCecKeycode.getKeycodeType(this.mParams[0])));
        } else {
  ...
  public static String opcodeToString(int i) {
    ...
    switch (i) {
      ...
      case FrameworkStatsLog.f642x8c80549a /* 166 */:
        return "Report Features";
      case FrameworkStatsLog.f641xaad26533 /* 167 */:
