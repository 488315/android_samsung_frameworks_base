...
public final class HdmiCecLocalDeviceTv extends HdmiCecLocalDevice {
  ...
  public HdmiCecLocalDeviceTv(HdmiControlService hdmiControlService) {
    ...
    this.mTvInputCallback =
        new TvInputManager
            .TvInputCallback() { // from class: com.android.server.hdmi.HdmiCecLocalDeviceTv.1
          @Override // android.media.tv.TvInputManager.TvInputCallback
          public void onInputAdded(String str) {
            HdmiDeviceInfo hdmiDeviceInfo;
            TvInputInfo tvInputInfo =
                HdmiCecLocalDeviceTv.this.mService.getTvInputManager().getTvInputInfo(str);
            ...
            if (hdmiDeviceInfo.isCecDevice()) {
              HdmiCecLocalDeviceTv.this.processDelayedActiveSource(
  ...
  public void onAddressAllocated(int i, int i2) {
    ...
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildReportPhysicalAddressCommand(
            ...
            this.mService.getPhysicalAddress(),
            this.mDeviceType));
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildDeviceVendorIdCommand(
            getDeviceInfo().getLogicalAddress(), this.mService.getVendorId()));
    this.mService
        .getHdmiCecNetwork()
        .addCecSwitch(this.mService.getHdmiCecNetwork().getPhysicalAddress());
    ...
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildRequestActiveSource(getDeviceInfo().getLogicalAddress()));
  }
  ...
  public int dispatchMessage(HdmiCecMessage hdmiCecMessage) {
    ...
    if (this.mService.isPowerStandby()
        && !this.mService.isWakeUpMessageReceived()
        && this.mStandbyHandler.handleCommand(hdmiCecMessage)) {
      return -1;
    }
    ...
    if (this.mSkipRoutingControl) {
      ...
      this.mService.sendCecCommand(
          HdmiCecMessageBuilder.buildActiveSource(
              getDeviceInfo().getLogicalAddress(), this.mService.getPhysicalAddress()));
    }
  }

  public void updateActiveSource(int i, int i2, String str) {
    assertRunOnServiceThread();
    updateActiveSource(HdmiCecLocalDevice.ActiveSource.m28of(i, i2), str);
  }
  ...
  public void updateActiveSource(HdmiCecLocalDevice.ActiveSource activeSource, String str) {
    ...
    if (this.mService.getHdmiCecNetwork().getCecDeviceInfo(i) == null
        || i == getDeviceInfo().getLogicalAddress()
        || this.mService.pathToPortId(activeSource.physicalAddress) != getActivePortId()) {
      return;
    }
  ...
  public void updateActiveInput(int i, boolean z) {
    ...
    if (z) {
      HdmiDeviceInfo cecDeviceInfo =
          this.mService.getHdmiCecNetwork().getCecDeviceInfo(getActiveSource().logicalAddress);
      if (cecDeviceInfo == null
          && (cecDeviceInfo = this.mService.getDeviceInfoByPort(getActivePortId())) == null) {
  ...
  public void doManualPortSwitching(int i, IHdmiControlCallback iHdmiControlCallback) {
    ...
    int portIdToPath =
        getActivePortId() != -1
            ? this.mService.portIdToPath(getActivePortId())
  ...
  public void startRoutingControl(int i, int i2, IHdmiControlCallback iHdmiControlCallback) {
    ...
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildRoutingChange(getDeviceInfo().getLogicalAddress(), i, i2));
  ...
  public int findKeyReceiverAddress() {
    ...
    HdmiDeviceInfo deviceInfoByPath =
        this.mService.getHdmiCecNetwork().getDeviceInfoByPath(getActivePath());
  ...
  public int handleActiveSource(HdmiCecMessage hdmiCecMessage) {
    ...
    if (isInputReady(cecDeviceInfo.getId()) || cecDeviceInfo.getDeviceType() == 5) {
      ...
      ActiveSourceHandler.create(this, null)
          .process(
              HdmiCecLocalDevice.ActiveSource.m28of(source, twoBytesToInt),
              cecDeviceInfo.getDeviceType());
      return -1;
    }
    HdmiLogger.debug(
  ...
  public int handleInactiveSource(HdmiCecMessage hdmiCecMessage) {
    ...
    if (prevPortId != -1) {
      HdmiDeviceInfo cecDeviceInfo =
          this.mService.getHdmiCecNetwork().getCecDeviceInfo(hdmiCecMessage.getSource());
      if (cecDeviceInfo == null
          || this.mService.pathToPortId(cecDeviceInfo.getPhysicalAddress()) == prevPortId) {
        return -1;
      }
  ...
  public boolean broadcastMenuLanguage(String str) {
    assertRunOnServiceThread();
    HdmiCecMessage buildSetMenuLanguageCommand =
        HdmiCecMessageBuilder.buildSetMenuLanguageCommand(getDeviceInfo().getLogicalAddress(), str);
  ...
  public int handleReportPhysicalAddress(HdmiCecMessage hdmiCecMessage) {
    ...
    startNewDeviceAction(HdmiCecLocalDevice.ActiveSource.m28of(source, twoBytesToInt), b);
    return -1;
  }
  ...
  public void startNewDeviceAction(HdmiCecLocalDevice.ActiveSource activeSource, int i) {
    ...
    addAndStartAction(
        new NewDeviceAction(this, activeSource.logicalAddress, activeSource.physicalAddress, i));
  }
  ...
  public int handleReportAudioStatus(HdmiCecMessage hdmiCecMessage) {
    ...
    setAudioStatus(
        HdmiUtils.isAudioStatusMute(hdmiCecMessage),
        ...
        new DeviceDiscoveryAction(
            ...
            new DeviceDiscoveryAction
              ...
              public void onDeviceDiscoveryDone(List list) {
                ...
                if (HdmiCecLocalDeviceTv.this
                    .getActions(PowerStatusMonitorAction.class)
                    .isEmpty()) {
                  HdmiCecLocalDeviceTv hdmiCecLocalDeviceTv2 = HdmiCecLocalDeviceTv.this;
                  hdmiCecLocalDeviceTv2.addAndStartAction(
                      new PowerStatusMonitorAction(hdmiCecLocalDeviceTv2));
                }
  ...
  public void onNewAvrAdded(HdmiDeviceInfo hdmiDeviceInfo) {
    ...
    } else if (isConnected(hdmiDeviceInfo.getPortId())
        && isArcFeatureEnabled(hdmiDeviceInfo.getPortId())
    ...
    if (avrDeviceInfo == null) {
      ...
      addAndStartAction(
          new SystemAudioActionFromTv(
              this, avrDeviceInfo.getLogicalAddress(), z, iHdmiControlCallback));
    }
  }
  ...
  public void setSystemAudioMode(boolean z) {
    if (!isSystemAudioControlFeatureEnabled() && z) {
      HdmiLogger.debug(
          "Cannot turn on system audio mode because the System Audio Control feature is disabled.",
          new Object[0]);
      return;
    }
    HdmiLogger.debug(
  ...
  public final void updateAudioManagerForSystemAudio(boolean z) {
    HdmiLogger.debug(
        ...
        Boolean.valueOf(z),
        Integer.valueOf(this.mService.getAudioManager().setHdmiSystemAudioSupported(z)));
  }
                        ...
                        .map(
                            new Function() { // from class:
                              ...
                              public final Object apply(Object obj) {
                                ...
                                lambda$notifyArcStatusToAudioService$0 =
                                    HdmiCecLocalDeviceTv.lambda$notifyArcStatusToAudioService$0(
                                        (byte[]) obj);
  ...
  public static /* synthetic */ AudioDescriptor lambda$notifyArcStatusToAudioService$0(
      byte[] bArr) {
  ...
  public void startArcAction(boolean z, IHdmiControlCallback iHdmiControlCallback) {
    ...
    if (z && this.mService.earcBlocksArcConnection()) {
      Slog.i(
          "HdmiCecLocalDeviceTv",
          "ARC connection blocked because eARC connection is established or being established.");
      invokeCallback(iHdmiControlCallback, 6);
      return;
    }
    if (z) {
      ...
      if (hasAction(RequestArcInitiationAction.class)) {
        ((RequestArcInitiationAction) getActions(RequestArcInitiationAction.class).get(0))
            .addCallback(iHdmiControlCallback);
        return;
      } else {
        addAndStartAction(
            new RequestArcInitiationAction(
                this, avrDeviceInfo.getLogicalAddress(), iHdmiControlCallback));
        return;
      }
    }
    removeAction(RequestArcInitiationAction.class);
    if (hasAction(RequestArcTerminationAction.class)) {
      ((RequestArcTerminationAction) getActions(RequestArcTerminationAction.class).get(0))
          .addCallback(iHdmiControlCallback);
    } else {
      addAndStartAction(
  ...
  public void changeVolume(int i, int i2, int i3) {
    ...
    if (getAvrDeviceInfo() == null
        ...
        || this.mService.getHdmiCecVolumeControl() == 0) {
      return;
    }
    ...
    synchronized (this.mLock) {
      ...
      if (actions.isEmpty()) {
        addAndStartAction(
            new VolumeControlAction(this, getAvrDeviceInfo().getLogicalAddress(), i2 > 0));
      } else {
    ...
    synchronized (this.mLock) {
      if (this.mSystemAudioMute == z) {
        ...
        sendUserControlPressedAndReleased(
            getAvrDeviceInfo().getLogicalAddress(), HdmiCecKeycode.getMuteKey(z));
      }
    }
  }
  ...
  public final boolean canStartArcUpdateAction(int i, boolean z) {
    ...
    if (z) {
      return isConnected(avrDeviceInfo.getPortId())
          && isArcFeatureEnabled(avrDeviceInfo.getPortId())
          && isDirectConnectAddress(avrDeviceInfo.getPhysicalAddress());
    }
    return true;
  }
  ...
  public int handleSetSystemAudioMode(HdmiCecMessage hdmiCecMessage) {
    ...
    if (!isMessageForSystemAudio(hdmiCecMessage)) {
      ...
      HdmiLogger.debug(
          "Ignoring <Set System Audio Mode> message because the System Audio Control feature is"
              + " disabled: %s",
          hdmiCecMessage);
      return 4;
    }
    ...
    addAndStartAction(
        new SystemAudioActionFromAvr(
            this, hdmiCecMessage.getSource(), parseCommandParamSystemAudioStatus, null));
    return -1;
  }
  ...
  public int handleSystemAudioModeStatus(HdmiCecMessage hdmiCecMessage) {
    ...
    if (avrDeviceInfo == null) {
      ...
      addAndStartAction(
          new SystemAudioActionFromTv(
              this, avrDeviceInfo.getLogicalAddress(), isSystemAudioControlFeatureEnabled, null));
    } else {
  ...
  public int handleRecordTvScreen(HdmiCecMessage hdmiCecMessage) {
    ...
    if (!actions.isEmpty()) {
      if (((OneTouchRecordAction) actions.get(0)).getRecorderAddress()
          == hdmiCecMessage.getSource()) {
        return 2;
      }
  ...
  public final boolean isMessageForSystemAudio(HdmiCecMessage hdmiCecMessage) {
    return this.mService.isCecControlEnabled()
        && hdmiCecMessage.getSource() == 5
        && (hdmiCecMessage.getDestination() == 0 || hdmiCecMessage.getDestination() == 15)
  ...
  public void disableDevice(
      boolean z, HdmiCecLocalDevice.PendingActionClearedCallback pendingActionClearedCallback) {
    assertRunOnServiceThread();
  ...
  public void onStandby(boolean z, int i) {
    ...
    if (this.mService.isCecControlEnabled()) {
      ...
      this.mService.sendCecCommand(
          HdmiCecMessageBuilder.buildStandby(getDeviceInfo().getLogicalAddress(), 15));
    }
  }
  ...
  public int startOneTouchRecord(int i, byte[] bArr) {
    ...
    Slog.i(
        "HdmiCecLocalDeviceTv",
        "Start new [One Touch Record]-Target:" + i + ", recordSource:" + Arrays.toString(bArr));
    return -1;
  }
  ...
  public void stopOneTouchRecord(int i) {
    ...
    removeAction(OneTouchRecordAction.class);
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildRecordOff(getDeviceInfo().getLogicalAddress(), i));
    Slog.i("HdmiCecLocalDeviceTv", "Stop [One Touch Record]-Target:" + i);
  }

  public final boolean checkRecorder(int i) {
    return this.mService.getHdmiCecNetwork().getCecDeviceInfo(i) != null
  ...
  public final void sendClearTimerMessage(final int i, int i2, byte[] bArr) {
    ...
    if (i2 == 1) {
      buildClearDigitalTimer =
          HdmiCecMessageBuilder.buildClearDigitalTimer(
              getDeviceInfo().getLogicalAddress(), i, bArr);
    } else if (i2 == 2) {
      buildClearDigitalTimer =
    ...
    this.mService.sendCecCommand(
        ...
        new HdmiControlService
            .SendMessageCallback() { // from class: com.android.server.hdmi.HdmiCecLocalDeviceTv.3
  ...
  public void sendStandby(int i) {
    ...
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildStandby(
            getDeviceInfo().getLogicalAddress(), deviceInfo.getLogicalAddress()));
  }
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    ...
    indentingPrintWriter.println(
        "mSystemAudioControlFeatureEnabled: " + this.mSystemAudioControlFeatureEnabled);
