...
public class HdmiControlService extends SystemService {
  ...
  static {
    ...
    AVB_AUDIO_OUTPUT_DEVICES =
        Collections.unmodifiableList(
            Arrays.asList(audioDeviceAttributes, audioDeviceAttributes2, audioDeviceAttributes3));
  ...
  public HdmiControlService(
    ...
    this.mSettingChangeListener = new C158025();
  ...
  public List readDeviceTypes() {
              ...
              .map(
                  new Function() { // from class:
                    ...
                    public final Object apply(Object obj) {
                      ...
                      enumToIntDeviceType =
                          HdmiControlService.enumToIntDeviceType(
                              (HdmiProperties.cec_device_types_values) obj);
                      return enumToIntDeviceType;
                    }
                  })
              .filter(
                  new Predicate() { // from class:
                                    // com.android.server.hdmi.HdmiControlService$$ExternalSyntheticLambda1
    ...
    if (deviceTypes.contains(null)) {
      Slog.w(
          "HdmiControlService",
          "Error parsing ro.hdmi.device_type: " + SystemProperties.get("ro.hdmi.device_type"));
    }
    return (List)
        deviceTypes.stream()
            .filter(
  ...
  /* renamed from: com.android.server.hdmi.HdmiControlService$28 */
  public abstract /* synthetic */ class AbstractC158328 {

    /* renamed from: $SwitchMap$android$sysprop$HdmiProperties$cec_device_types_values */
    public static final /* synthetic */ int[] f1702x776a6083;
    ...
    static {
      ...
      try {
        f1702x776a6083[HdmiProperties.cec_device_types_values.RECORDING_DEVICE.ordinal()] = 2;
      } catch (NoSuchFieldError unused2) {
      }
      try {
        f1702x776a6083[HdmiProperties.cec_device_types_values.RESERVED.ordinal()] = 3;
      } catch (NoSuchFieldError unused3) {
      }
      try {
        f1702x776a6083[HdmiProperties.cec_device_types_values.TUNER.ordinal()] = 4;
      } catch (NoSuchFieldError unused4) {
      }
      try {
        f1702x776a6083[HdmiProperties.cec_device_types_values.PLAYBACK_DEVICE.ordinal()] = 5;
      } catch (NoSuchFieldError unused5) {
      }
      try {
        f1702x776a6083[HdmiProperties.cec_device_types_values.AUDIO_SYSTEM.ordinal()] = 6;
      } catch (NoSuchFieldError unused6) {
      }
      try {
        f1702x776a6083[HdmiProperties.cec_device_types_values.PURE_CEC_SWITCH.ordinal()] = 7;
      } catch (NoSuchFieldError unused7) {
      }
      try {
        f1702x776a6083[HdmiProperties.cec_device_types_values.VIDEO_PROCESSOR.ordinal()] = 8;
      } catch (NoSuchFieldError unused8) {
      }
    }
  }

  public static Integer enumToIntDeviceType(
      HdmiProperties.cec_device_types_values cec_device_types_valuesVar) {
    if (cec_device_types_valuesVar == null) {
      return null;
    }
    switch (AbstractC158328.f1702x776a6083[cec_device_types_valuesVar.ordinal()]) {
      case 1:
        break;
      case 2:
        break;
      ...
      default:
        Slog.w(
            "HdmiControlService",
            "Unrecognized device type in ro.hdmi.cec_device_types: "
                + cec_device_types_valuesVar.getPropValue());
        break;
    }
    return null;
  }
  ...
  public void initService() {
    ...
    this.mSoundbarModeFeatureFlagEnabled =
        this.mDeviceConfig.getBoolean("enable_soundbar_mode", false);
    this.mEarcTxFeatureFlagEnabled = this.mDeviceConfig.getBoolean("enable_earc_tx", false);
    this.mTransitionFromArcToEarcTxEnabled =
        this.mDeviceConfig.getBoolean("transition_arc_to_earc_tx", false);
    this.mNumericSoundbarVolumeUiOnTvFeatureFlagEnabled =
        this.mDeviceConfig.getBoolean("enable_numeric_soundbar_volume_ui_on_tv", false);
    ...
    this.mHdmiCecConfig.registerChangeListener(
        "hdmi_cec_enabled",
        new HdmiCecConfig
            .SettingChangeListener() { // from class: com.android.server.hdmi.HdmiControlService.2
          @Override // com.android.server.hdmi.HdmiCecConfig.SettingChangeListener
          public void onChange(String str) {
            HdmiControlService.this.setCecEnabled(
                HdmiControlService.this.mHdmiCecConfig.getIntValue("hdmi_cec_enabled"));
          }
        },
        this.mServiceThreadExecutor);
    this.mHdmiCecConfig.registerChangeListener(
        "hdmi_cec_version",
        new HdmiCecConfig
            .SettingChangeListener() { // from class: com.android.server.hdmi.HdmiControlService.3
          @Override // com.android.server.hdmi.HdmiCecConfig.SettingChangeListener
          public void onChange(String str) {
    ...
    this.mHdmiCecConfig.registerChangeListener(
        "routing_control",
        new HdmiCecConfig
            .SettingChangeListener() { // from class: com.android.server.hdmi.HdmiControlService.4
          @Override // com.android.server.hdmi.HdmiCecConfig.SettingChangeListener
          public void onChange(String str) {
    ...
    this.mHdmiCecConfig.registerChangeListener(
        ...
        new HdmiCecConfig
            .SettingChangeListener() { // from class: com.android.server.hdmi.HdmiControlService.5
          @Override // com.android.server.hdmi.HdmiCecConfig.SettingChangeListener
          public void onChange(String str) {
            boolean z =
                HdmiControlService.this.mHdmiCecConfig.getIntValue("system_audio_control") == 1;
            if (HdmiControlService.this.isTvDeviceEnabled()) {
              HdmiControlService.this.m30tv().setSystemAudioControlFeatureEnabled(z);
            }
            if (HdmiControlService.this.isAudioSystemDevice()) {
              if (HdmiControlService.this.audioSystem() == null) {
                Slog.e(
                    "HdmiControlService",
                    "Audio System device has not registered yet. Can't turn system audio mode on.");
              } else {
    ...
    this.mHdmiCecConfig.registerChangeListener(
        ...
        new HdmiCecConfig
            .SettingChangeListener() { // from class: com.android.server.hdmi.HdmiControlService.6
          @Override // com.android.server.hdmi.HdmiCecConfig.SettingChangeListener
          public void onChange(String str) {
            HdmiControlService hdmiControlService = HdmiControlService.this;
            hdmiControlService.setHdmiCecVolumeControlEnabledInternal(
                hdmiControlService.getHdmiCecConfig().getIntValue("volume_control_enabled"));
          }
        },
        this.mServiceThreadExecutor);
    this.mHdmiCecConfig.registerChangeListener(
        ...
        new HdmiCecConfig
            .SettingChangeListener() { // from class: com.android.server.hdmi.HdmiControlService.7
          @Override // com.android.server.hdmi.HdmiCecConfig.SettingChangeListener
          public void onChange(String str) {
            if (HdmiControlService.this.isTvDeviceEnabled()) {
              HdmiControlService.this.mCecController.enableWakeupByOtp(
                  HdmiControlService.this.m30tv().getAutoWakeup());
            }
          }
        },
        this.mServiceThreadExecutor);
    if (isTvDevice()) {
      this.mDeviceConfig.addOnPropertiesChangedListener(
          getContext().getMainExecutor(),
          new DeviceConfig
              .OnPropertiesChangedListener() { // from class:
                                               // com.android.server.hdmi.HdmiControlService.8
            public void onPropertiesChanged(DeviceConfig.Properties properties) {
              int i = 0;
              HdmiControlService.this.mEarcTxFeatureFlagEnabled =
                  properties.getBoolean("enable_earc_tx", false);
    ...
    this.mHdmiCecConfig.registerChangeListener(
        "earc_enabled",
        new HdmiCecConfig
            .SettingChangeListener() { // from class: com.android.server.hdmi.HdmiControlService.9
          @Override // com.android.server.hdmi.HdmiCecConfig.SettingChangeListener
          public void onChange(String str) {
    ...
    this.mDeviceConfig.addOnPropertiesChangedListener(
        ...
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.hdmi.HdmiControlService.10
          public void onPropertiesChanged(DeviceConfig.Properties properties) {
            int i = 0;
            HdmiControlService.this.mSoundbarModeFeatureFlagEnabled =
                properties.getBoolean("enable_soundbar_mode", false);
    ...
    this.mHdmiCecConfig.registerChangeListener(
        "soundbar_mode",
        new HdmiCecConfig
            .SettingChangeListener() { // from class: com.android.server.hdmi.HdmiControlService.11
          @Override // com.android.server.hdmi.HdmiCecConfig.SettingChangeListener
          public void onChange(String str) {
            int i = 0;
            boolean z = HdmiControlService.this.mHdmiCecConfig.getIntValue("soundbar_mode") == 1;
    ...
    this.mDeviceConfig.addOnPropertiesChangedListener(
        ...
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.hdmi.HdmiControlService.12
          public void onPropertiesChanged(DeviceConfig.Properties properties) {
            HdmiControlService.this.mTransitionFromArcToEarcTxEnabled =
                properties.getBoolean("transition_arc_to_earc_tx", false);
          }
        });
    this.mDeviceConfig.addOnPropertiesChangedListener(
        getContext().getMainExecutor(),
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.hdmi.HdmiControlService.13
          public void onPropertiesChanged(DeviceConfig.Properties properties) {
            HdmiControlService.this.mNumericSoundbarVolumeUiOnTvFeatureFlagEnabled =
                properties.getBoolean("enable_numeric_soundbar_volume_ui_on_tv", false);
      ...
      if (i == 1000) {
        runOnServiceThread(
            new Runnable() { // from class:
                             // com.android.server.hdmi.HdmiControlService$$ExternalSyntheticLambda4
        ...
        .addOnDeviceVolumeBehaviorChangedListener(
            ...
            new AudioDeviceVolumeManager
                .OnDeviceVolumeBehaviorChangedListener() { // from class:
                                                           // com.android.server.hdmi.HdmiControlService$$ExternalSyntheticLambda3
        ...
        audioSystem.addAndStartAction(
            new ArcTerminationActionFromAvr(
                ...
                new IHdmiControlCallback
                    .Stub() { // from class: com.android.server.hdmi.HdmiControlService.14
  ...
  public boolean isDeviceDiscoveryHandledByPlayback() {
    HdmiCecLocalDevicePlayback playback = playback();
    if (playback != null) {
      return playback.hasAction(DeviceDiscoveryAction.class)
  ...
  public final void onInitializeCecComplete(int i) {
    ...
    if (isTvDeviceEnabled()) {
      this.mCecController.enableWakeupByOtp(m30tv().getAutoWakeup());
    }
    if (i == 0) {
      i2 = 1;
    } else if (i != 1) {
  ...
  public final void updatePowerStatusOnInitializeCecComplete() {
    if (this.mPowerStatusController.isPowerStatusTransientToOn()) {
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    public void onChange(boolean z, Uri uri) {
      ...
      boolean readBooleanSetting =
          HdmiControlService.this.readBooleanSetting(lastPathSegment, true);
      ...
      switch (c) {
        case 0:
          HdmiControlService.this.setDisplayName(
              HdmiControlService.this.readStringSetting(lastPathSegment, Build.MODEL));
          break;
        case 1:
          HdmiControlService.this.setMhlInputChangeEnabled(readBooleanSetting);
          break;
        case 2:
          HdmiControlService.this.mMhlController.setOption(
              102, HdmiControlService.toInt(readBooleanSetting));
          break;
      }
    }
  }
  ...
  public final void initializeCec(int i) {
    ...
    this.mCecVersion =
        Math.max(
            5,
            Math.min(
                getHdmiCecConfig().getIntValue("hdmi_cec_version"),
                this.mCecController.getVersion()));
  ...
  public final List getCecLocalDeviceTypes() {
    ...
    if (this.mHdmiCecConfig.getIntValue("soundbar_mode") == 1
        ...
        && SystemProperties.getBoolean("persist.sys.hdmi.property_arc_support", true)
        && this.mSoundbarModeFeatureFlagEnabled) {
      arrayList.add(5);
    }
    return arrayList;
  ...
  public void allocateLogicalAddress(final ArrayList arrayList, final int i) {
    ...
    while (it.hasNext()) {
      ...
      this.mCecController.allocateLogicalAddress(
          hdmiCecLocalDevice.getType(),
          hdmiCecLocalDevice.getPreferredAddress(),
          new HdmiCecController
              .AllocateAddressCallback() { // from class:
                                           // com.android.server.hdmi.HdmiControlService.15
            ...
            public void onAllocated(int i2, int i3) {
              if (i3 == 15) {
                ...
                HdmiControlService hdmiControlService = HdmiControlService.this;
                hdmiCecLocalDevice.setDeviceInfo(
                    hdmiControlService.createDeviceInfo(
                        i3, i2, 0, hdmiControlService.getCecVersion()));
                HdmiControlService.this.mHdmiCecNetwork.addLocalDevice(i2, hdmiCecLocalDevice);
                HdmiControlService.this.mHdmiCecNetwork.addCecDevice(
                    hdmiCecLocalDevice.getDeviceInfo());
              ...
              if (size == i4) {
                ...
                if (HdmiControlService.this.mDisplayStatusCallback != null) {
                  HdmiControlService hdmiControlService2 = HdmiControlService.this;
                  hdmiControlService2.queryDisplayStatus(
                      hdmiControlService2.mDisplayStatusCallback);
                ...
                if (HdmiControlService.this.mOtpCallbackPendingAddressAllocation != null) {
                  ...
                  hdmiControlService3.oneTouchPlay(
                      hdmiControlService3.mOtpCallbackPendingAddressAllocation);
  ...
  public final void notifyAddressAllocated(ArrayList arrayList, int i) {
    ...
    while (it.hasNext()) {
      ...
      hdmiCecLocalDevice.handleAddressAllocated(
          hdmiCecLocalDevice.getDeviceInfo().getLogicalAddress(), buffer, i);
    }
    if (isTvDeviceEnabled()) {
      m30tv().setSelectRequestBuffer(this.mSelectRequestBuffer);
    }
  }
  ...
  public final boolean verifyPhysicalAddress(byte[] bArr, int i) {
    ...
    return (twoBytesToInt != 65535 && twoBytesToInt == getPhysicalAddress())
        || pathToPortId(twoBytesToInt) != -1;
  }
  ...
  public final boolean sourceAddressIsLocal(HdmiCecMessage hdmiCecMessage) {
    Iterator it = getAllCecLocalDevices().iterator();
    while (it.hasNext()) {
      if (hdmiCecMessage.getSource()
              == ((HdmiCecLocalDevice) it.next()).getDeviceInfo().getLogicalAddress()
          && hdmiCecMessage.getSource() != 15) {
        HdmiLogger.warning(
            "Unexpected source: message sent from device itself, " + hdmiCecMessage, new Object[0]);
        return true;
      }
    }
    return false;
  ...
  public void checkLogicalAddressConflictAndReallocate(int i, int i2) {
    ...
    for (HdmiCecLocalDevice hdmiCecLocalDevice : getAllCecLocalDevices()) {
      if (hdmiCecLocalDevice.getDeviceInfo().getLogicalAddress() == i) {
        HdmiLogger.debug(
            "allocate logical address for " + hdmiCecLocalDevice.getDeviceInfo(), new Object[0]);
        ArrayList arrayList = new ArrayList();
  ...
  public void setAudioStatus(boolean z, int i) {
    if (isTvDeviceEnabled()
        && m30tv().isSystemAudioActivated()
        && m30tv().isArcEstablished()
      ...
      audioManager.setStreamVolume(
          3, i, FrameworkStatsLog.HDMI_CEC_MESSAGE_REPORTED__USER_CONTROL_PRESSED_COMMAND__UP);
    }
  }
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        invokeSystemAudioModeChangeLocked(
            ((SystemAudioModeChangeListenerRecord) it.next()).mListener, z);
      }
    }
  }
  ...
  public final HdmiDeviceInfo createDeviceInfo(int i, int i2, int i3, int i4) {
    return HdmiDeviceInfo.cecDeviceBuilder()
        ...
        .setDisplayName(readStringSetting("device_name", Build.MODEL))
        .setDevicePowerStatus(i3)
        .setCecVersion(i4)
        .build();
  }
  ...
  public final void setDisplayName(String str) {
    for (HdmiCecLocalDevice hdmiCecLocalDevice : getAllCecLocalDevices()) {
      ...
      if (!deviceInfo.getDisplayName().equals(str)) {
        ...
        sendCecCommand(
            HdmiCecMessageBuilder.buildSetOsdNameCommand(deviceInfo.getLogicalAddress(), 0, str));
      }
    }
  }
  ...
  public final class HdmiControlStatusChangeListenerRecord implements IBinder.DeathRecipient {
    ...
    public boolean equals(Object obj) {
      if (obj instanceof HdmiControlStatusChangeListenerRecord) {
        return obj == this
            || ((HdmiControlStatusChangeListenerRecord) obj).mListener == this.mListener;
      }
      return false;
    }
  ...
  public final void enforceAccessPermission() {
    getContext()
        .enforceCallingOrSelfPermission("android.permission.HDMI_CEC", "HdmiControlService");
  }
  ...
  public final class BinderService extends IHdmiControlService.Stub {
    ...
    public void deviceSelect(final int i, final IHdmiControlCallback iHdmiControlCallback) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.1
            @Override // java.lang.Runnable
            public void run() {
              ...
              if (!HdmiControlService.this.mAddressAllocated) {
                HdmiControlService.this.mSelectRequestBuffer.set(
                    SelectRequestBuffer.newDeviceSelect(
                        HdmiControlService.this, i, iHdmiControlCallback));
    ...
    public void portSelect(final int i, final IHdmiControlCallback iHdmiControlCallback) {
      HdmiControlService.this.initBinderCall();
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.2
            @Override // java.lang.Runnable
            public void run() {
              if (iHdmiControlCallback == null) {
                Slog.e("HdmiControlService", "Callback cannot be null");
              ...
              HdmiCecLocalDeviceTv m30tv = HdmiControlService.this.m30tv();
              if (m30tv != null) {
                m30tv.doManualPortSwitching(i, iHdmiControlCallback);
                return;
              }
              ...
              if (audioSystem != null) {
                ...
                HdmiControlService.this.mSelectRequestBuffer.set(
                    SelectRequestBuffer.newPortSelect(
                        HdmiControlService.this, i, iHdmiControlCallback));
              } else {
    ...
    public void sendKeyEvent(final int i, final int i2, final boolean z) {
      HdmiControlService.this.initBinderCall();
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.3
            @Override // java.lang.Runnable
            public void run() {
              HdmiControlService.this.mMhlController.getLocalDevice(
                  HdmiControlService.this.mActivePortId);
    ...
    public void sendVolumeKeyEvent(final int i, final int i2, final boolean z) {
      HdmiControlService.this.initBinderCall();
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.4
            @Override // java.lang.Runnable
            public void run() {
              if (HdmiControlService.this.mCecController == null) {
                Slog.w(
                    "HdmiControlService", "CEC controller not available to send volume key event.");
                return;
              }
              HdmiCecLocalDevice localDevice =
                  HdmiControlService.this.mHdmiCecNetwork.getLocalDevice(i);
              if (localDevice == null) {
                Slog.w(
                    "HdmiControlService",
                    "Local device " + i + " not available to send volume key event.");
                return;
              }
    ...
    public void oneTouchPlay(final IHdmiControlCallback iHdmiControlCallback) {
      ...
      Slog.d(
          "HdmiControlService",
          "Process pid: " + Binder.getCallingPid() + " is calling oneTouchPlay.");
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.5
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void toggleAndFollowTvPower() {
      ...
      Slog.d(
          "HdmiControlService",
          "Process pid: " + Binder.getCallingPid() + " is calling toggleAndFollowTvPower.");
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.6
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void queryDisplayStatus(final IHdmiControlCallback iHdmiControlCallback) {
      HdmiControlService.this.initBinderCall();
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.7
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void removeHdmiControlStatusChangeListener(
        IHdmiControlStatusChangeListener iHdmiControlStatusChangeListener) {
      HdmiControlService.this.initBinderCall();
      HdmiControlService.this.removeHdmiControlStatusChangeListener(
    ...
    public boolean canChangeSystemAudioMode() {
      ...
      return m30tv.hasSystemAudioDevice();
    }
    ...
    public boolean getSystemAudioMode() {
      ...
      HdmiCecLocalDeviceTv m30tv = HdmiControlService.this.m30tv();
      HdmiCecLocalDeviceAudioSystem audioSystem = HdmiControlService.this.audioSystem();
      return (m30tv != null && m30tv.isSystemAudioActivated())
    ...
    public void setSystemAudioMode(
        final boolean z, final IHdmiControlCallback iHdmiControlCallback) {
      HdmiControlService.this.initBinderCall();
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.8
            @Override // java.lang.Runnable
            public void run() {
              HdmiCecLocalDeviceTv m30tv = HdmiControlService.this.m30tv();
              if (m30tv == null) {
                ...
                m30tv.changeSystemAudioMode(z, iHdmiControlCallback);
              }
            }
          });
    }
    ...
    public void removeSystemAudioModeChangeListener(
        IHdmiSystemAudioModeChangeListener iHdmiSystemAudioModeChangeListener) {
      HdmiControlService.this.initBinderCall();
      HdmiControlService.this.removeSystemAudioModeChangeListener(
    ...
    public List getInputDevices() {
      HdmiControlService.this.initBinderCall();
      return HdmiUtils.mergeToUnmodifiableList(
          HdmiControlService.this.mHdmiCecNetwork.getSafeExternalInputsLocked(),
          HdmiControlService.this.getMhlDevicesLocked());
    }
    ...
    public void powerOffRemoteDevice(final int i, final int i2) {
      HdmiControlService.this.initBinderCall();
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.BinderService.9
            @Override // java.lang.Runnable
            public void run() {
              Slog.w(
                  "HdmiControlService",
                  "Device " + i + " power status is " + i2 + " before standby command sent out");
              HdmiControlService hdmiControlService = HdmiControlService.this;
              hdmiControlService.sendCecCommand(
                  HdmiCecMessageBuilder.buildStandby(
                      hdmiControlService.getRemoteControlSourceAddress(), i));
            }
          });
    }
    ...
    public void powerOnRemoteDevice(final int i, final int i2) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.10
            @Override // java.lang.Runnable
            public void run() {
              Slog.i(
                  "HdmiControlService",
                  "Device " + i + " power status is " + i2 + " before power on command sent out");
              if (HdmiControlService.this.getSwitchDevice() != null) {
                ...
                Slog.e(
                    "HdmiControlService", "Can't get the correct local device to handle routing.");
              }
            }
          });
    }
    ...
    public void askRemoteDeviceToBecomeActiveSource(final int i) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.11
            @Override // java.lang.Runnable
            public void run() {
              HdmiCecMessage buildSetStreamPath =
                  HdmiCecMessageBuilder.buildSetStreamPath(
                      HdmiControlService.this.getRemoteControlSourceAddress(), i);
          ...
          new Runnable() { // from class:
            ...
            public void run() {
              ...
              if (m30tv == null) {
                ...
                int i4 = i;
                m30tv.changeVolume(i4, i2 - i4, i3);
              }
            }
          });
    }
    ...
    public void setSystemAudioMute(final boolean z) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.13
            @Override // java.lang.Runnable
            public void run() {
              HdmiCecLocalDeviceTv m30tv = HdmiControlService.this.m30tv();
              if (m30tv == null) {
    ...
    public void setArcMode(final boolean z) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.14
            @Override // java.lang.Runnable
            public void run() {
              HdmiCecLocalDeviceTv m30tv = HdmiControlService.this.m30tv();
              if (m30tv == null) {
              ...
              if (localDevice == null) {
                ...
                HdmiControlService.this.sendCecCommand(
                    HdmiCecMessageBuilder.buildVendorCommandWithId(
                        ...
                        i2,
                        HdmiControlService.this.getVendorId(),
                        bArr));
              } else {
                HdmiControlService.this.sendCecCommand(
                    HdmiCecMessageBuilder.buildVendorCommand(
                        localDevice.getDeviceInfo().getLogicalAddress(), i2, bArr));
              }
            }
          });
    }
    ...
    public void sendStandby(final int i, final int i2) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.16
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void startOneTouchRecord(final int i, final byte[] bArr) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.17
            @Override // java.lang.Runnable
            public void run() {
              if (!HdmiControlService.this.isTvDeviceEnabled()) {
                Slog.w("HdmiControlService", "TV device is not enabled.");
              } else {
                HdmiControlService.this.m30tv().startOneTouchRecord(i, bArr);
              }
            }
          });
    }
    ...
    public void stopOneTouchRecord(final int i) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.18
            @Override // java.lang.Runnable
            public void run() {
              if (!HdmiControlService.this.isTvDeviceEnabled()) {
                Slog.w("HdmiControlService", "TV device is not enabled.");
              } else {
                HdmiControlService.this.m30tv().stopOneTouchRecord(i);
              }
            }
          });
    }
    ...
    public void startTimerRecording(final int i, final int i2, final byte[] bArr) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.19
            @Override // java.lang.Runnable
            public void run() {
              if (!HdmiControlService.this.isTvDeviceEnabled()) {
                Slog.w("HdmiControlService", "TV device is not enabled.");
              } else {
                HdmiControlService.this.m30tv().startTimerRecording(i, i2, bArr);
              }
            }
          });
    }
    ...
    public void clearTimerRecording(final int i, final int i2, final byte[] bArr) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.20
            @Override // java.lang.Runnable
            public void run() {
              if (!HdmiControlService.this.isTvDeviceEnabled()) {
                Slog.w("HdmiControlService", "TV device is not enabled.");
              } else {
                HdmiControlService.this.m30tv().clearTimerRecording(i, i2, bArr);
              }
            }
          });
    }
    ...
    public void sendMhlVendorCommand(final int i, final int i2, final int i3, final byte[] bArr) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.21
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void setStandbyMode(final boolean z) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.22
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void reportAudioStatus(final int i, int i2, int i3, boolean z) {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.23
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void setSystemAudioModeOnForAudioOnlySource() {
      ...
      HdmiControlService.this.runOnServiceThread(
          new Runnable() { // from class:
                           // com.android.server.hdmi.HdmiControlService.BinderService.24
            @Override // java.lang.Runnable
            public void run() {
              if (!HdmiControlService.this.isAudioSystemDevice()) {
                Slog.e(
                    "HdmiControlService",
                    "Not an audio system device. Won't set system audio mode on");
                return;
              }
              if (HdmiControlService.this.audioSystem() == null) {
                Slog.e("HdmiControlService", "Audio System local device is not registered");
              } else if (!HdmiControlService.this
                  .audioSystem()
                  .checkSupportAndSetSystemAudioMode(true)) {
                Slog.e("HdmiControlService", "System Audio Mode is not supported.");
              } else {
                HdmiControlService hdmiControlService = HdmiControlService.this;
                hdmiControlService.sendCecCommand(
                    HdmiCecMessageBuilder.buildSetSystemAudioMode(
                        hdmiControlService.audioSystem().getDeviceInfo().getLogicalAddress(),
                        15,
                        true));
              }
            }
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
        ...
        indentingPrintWriter.println(
            "mPowerStatus: " + HdmiControlService.this.mPowerStatusController.getPowerStatus());
        ...
        indentingPrintWriter.println(
            "mMhlInputChangeEnabled: " + HdmiControlService.this.isMhlInputChangeEnabled());
        indentingPrintWriter.println(
            "mSystemAudioActivated: " + HdmiControlService.this.isSystemAudioActivated());
        indentingPrintWriter.println(
            "mHdmiCecVolumeControlEnabled: " + HdmiControlService.this.getHdmiCecVolumeControl());
        ...
        return HdmiControlService.this.getHdmiCecConfig().getAllowedIntValues(str).stream()
            .mapToInt(
                new ToIntFunction() { // from class:
                                      // com.android.server.hdmi.HdmiControlService$BinderService$$ExternalSyntheticLambda0
  ...
  public void oneTouchPlay(IHdmiControlCallback iHdmiControlCallback) {
    ...
    if (!this.mAddressAllocated) {
      ...
      Slog.d(
          "HdmiControlService",
          "Local device is under address allocation. Save OTP callback for later process.");
      return;
    }
  ...
  public void queryDisplayStatus(IHdmiControlCallback iHdmiControlCallback) {
    ...
    if (!this.mAddressAllocated) {
      ...
      Slog.d(
          "HdmiControlService",
          "Local device is under address allocation. Queue display callback for later process.");
      return;
    }
    HdmiCecLocalDeviceSource playback = playback();
    if (playback == null) {
  ...
  public HdmiDeviceInfo getActiveSource() {
    ...
    if (localActiveSource.isValid()) {
      HdmiDeviceInfo safeCecDeviceInfo =
          this.mHdmiCecNetwork.getSafeCecDeviceInfo(localActiveSource.logicalAddress);
    ...
    if (m30tv() == null || (activePath = m30tv().getActivePath()) == 65535) {
      return null;
    }
    HdmiDeviceInfo safeDeviceInfoByPath = this.mHdmiCecNetwork.getSafeDeviceInfoByPath(activePath);
    return safeDeviceInfoByPath != null
        ? safeDeviceInfoByPath
        : HdmiDeviceInfo.hardwarePort(activePath, m30tv().getActivePortId());
  }

  public void addHdmiControlStatusChangeListener(
      final IHdmiControlStatusChangeListener iHdmiControlStatusChangeListener) {
    final HdmiControlStatusChangeListenerRecord hdmiControlStatusChangeListenerRecord =
    ...
    try {
      ...
      runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.16
            @Override // java.lang.Runnable
            public void run() {
              synchronized (HdmiControlService.this.mLock) {
                if (HdmiControlService.this.mHdmiControlStatusChangeListenerRecords.contains(
                    hdmiControlStatusChangeListenerRecord)) {
                  synchronized (HdmiControlService.this.mLock) {
                    HdmiControlService hdmiControlService = HdmiControlService.this;
                    hdmiControlService.invokeHdmiControlStatusChangeListenerLocked(
                        iHdmiControlStatusChangeListener, hdmiControlService.mHdmiControlEnabled);
                  }
                }
              }
            }
    ...
    synchronized (this.mLock) {
      ...
      while (true) {
        ...
        if (hdmiControlStatusChangeListenerRecord.mListener.asBinder()
          ...
          this.mHdmiControlStatusChangeListenerRecords.remove(
              hdmiControlStatusChangeListenerRecord);
          break;
        }
      }
  ...
  public void addHdmiCecVolumeControlFeatureListener(
      final IHdmiCecVolumeControlFeatureListener iHdmiCecVolumeControlFeatureListener) {
    this.mHdmiCecVolumeControlFeatureListenerRecords.register(iHdmiCecVolumeControlFeatureListener);
    runOnServiceThread(
        new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.17
          @Override // java.lang.Runnable
          public void run() {
            synchronized (HdmiControlService.this.mLock) {
              try {
                iHdmiCecVolumeControlFeatureListener.onHdmiCecVolumeControlFeature(
                    HdmiControlService.this.mHdmiCecVolumeControl);
  ...
  public final void addHotplugEventListener(
      final IHdmiHotplugEventListener iHdmiHotplugEventListener) {
    final HotplugEventListenerRecord hotplugEventListenerRecord =
        new HotplugEventListenerRecord(iHdmiHotplugEventListener);
    try {
      ...
      runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.18
            @Override // java.lang.Runnable
            public void run() {
              synchronized (HdmiControlService.this.mLock) {
                  ...
                  for (HdmiPortInfo hdmiPortInfo : HdmiControlService.this.getPortInfo()) {
                    HdmiHotplugEvent hdmiHotplugEvent =
                        new HdmiHotplugEvent(
                            hdmiPortInfo.getId(),
                            HdmiControlService.this.mCecController.isConnected(
                                hdmiPortInfo.getId()));
                    synchronized (HdmiControlService.this.mLock) {
                      HdmiControlService.this.invokeHotplugEventListenerLocked(
                          iHdmiHotplugEventListener, hdmiHotplugEvent);
                    }
                  }
                }
              }
  ...
  public final void addDeviceEventListener(IHdmiDeviceEventListener iHdmiDeviceEventListener) {
    DeviceEventListenerRecord deviceEventListenerRecord =
        new DeviceEventListenerRecord(iHdmiDeviceEventListener);
    try {
  ...
  public final void addSystemAudioModeChangeListner(
      IHdmiSystemAudioModeChangeListener iHdmiSystemAudioModeChangeListener) {
  ...
  public final void invokeSystemAudioModeChangeLocked(
      IHdmiSystemAudioModeChangeListener iHdmiSystemAudioModeChangeListener, boolean z) {
    try {
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        invokeHotplugEventListenerLocked(
            ((HotplugEventListenerRecord) it.next()).mListener, hdmiHotplugEvent);
      }
    }
  }

  public final void invokeHotplugEventListenerLocked(
      IHdmiHotplugEventListener iHdmiHotplugEventListener, HdmiHotplugEvent hdmiHotplugEvent) {
    try {
      iHdmiHotplugEventListener.onReceived(hdmiHotplugEvent);
    } catch (RemoteException e) {
      Slog.e(
          "HdmiControlService", "Failed to report hotplug event:" + hdmiHotplugEvent.toString(), e);
    }
  }
  ...
  public final void invokeHdmiControlStatusChangeListenerLocked(
      IHdmiControlStatusChangeListener iHdmiControlStatusChangeListener, int i) {
    invokeHdmiControlStatusChangeListenerLocked(
        Collections.singletonList(iHdmiControlStatusChangeListener), i);
  }

  public final void invokeHdmiControlStatusChangeListenerLocked(
      final Collection collection, final int i) {
    if (i == 1) {
      queryDisplayStatus(
          new IHdmiControlCallback
              .Stub() { // from class: com.android.server.hdmi.HdmiControlService.19
            public void onComplete(int i2) {
              ...
              HdmiControlService hdmiControlService = HdmiControlService.this;
              hdmiControlService.invokeHdmiControlStatusChangeListenerLocked(
                  collection, i, hdmiControlService.mIsCecAvailable);
            }
          });
      return;
    }
  ...
  public final void invokeHdmiControlStatusChangeListenerLocked(
      Collection collection, int i, boolean z) {
    ...
    while (it.hasNext()) {
      try {
        ...
        Slog.e(
            "HdmiControlService",
            "Failed to report HdmiControlStatusChange: " + i + " isAvailable: " + z,
            e);
      }
    }
  }
      ...
      this.mHdmiCecVolumeControlFeatureListenerRecords.broadcast(
          new Consumer() { // from class:
            ...
            public final void accept(Object obj) {
              HdmiControlService.lambda$announceHdmiCecVolumeControlFeatureChange$2(
                  i, (IHdmiCecVolumeControlFeatureListener) obj);
            }
          });
    }
  }

  public static /* synthetic */ void lambda$announceHdmiCecVolumeControlFeatureChange$2(
      int i, IHdmiCecVolumeControlFeatureListener iHdmiCecVolumeControlFeatureListener) {
    try {
  ...
  /* renamed from: tv */
  public HdmiCecLocalDeviceTv m30tv() {
  ...
  public boolean isPowerOnOrTransient() {
    assertRunOnServiceThread();
    return this.mPowerStatusController.isPowerStatusOn()
        || this.mPowerStatusController.isPowerStatusTransientToOn();
  }

  public boolean isPowerStandbyOrTransient() {
    assertRunOnServiceThread();
    return this.mPowerStatusController.isPowerStatusStandby()
        || this.mPowerStatusController.isPowerStatusTransientToStandby();
  }
  ...
  public void onStandby(final int i) {
    ...
    disableCecLocalDevices(
        new HdmiCecLocalDevice
            .PendingActionClearedCallback() { // from class:
          ...
          public void onCleared(HdmiCecLocalDevice hdmiCecLocalDevice) {
            Slog.v(
                "HdmiControlService",
                "On standby-action cleared:" + hdmiCecLocalDevice.mDeviceType);
  ...
  public final void onLanguageChanged(String str) {
    ...
    if (isTvDeviceEnabled()) {
      m30tv().broadcastMenuLanguage(str);
  ...
  public final void disableCecLocalDevices(
  ...
  public boolean invokeVendorCommandListenersOnReceived(
      int i, int i2, int i3, byte[] bArr, boolean z) {
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        ...
        if (z) {
          if (vendorCommandListenerRecord.mVendorId
              != ((bArr[0] & 255) << 16) + ((bArr[1] & 255) << 8) + (bArr[2] & 255)) {
            continue;
          }
        }
        try {
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        try {
          ...
          Slog.e(
              "HdmiControlService", "Failed to notify control-state-changed to vendor handler", e);
        }
      }
      return true;
    }
  ...
  public final void addHdmiMhlVendorCommandListener(
    ...
    HdmiMhlVendorCommandListenerRecord hdmiMhlVendorCommandListenerRecord =
        new HdmiMhlVendorCommandListenerRecord(iHdmiMhlVendorCommandListener);
    try {
  ...
  public void setStandbyMode(boolean z) {
    ...
    if (playback() != null) {
      oneTouchPlay(
          new IHdmiControlCallback
              .Stub() { // from class: com.android.server.hdmi.HdmiControlService.21
  ...
  public void setCecEnabled(int i) {
    ...
    if (i == 1) {
      ...
      runOnServiceThread(
          new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.22
            @Override // java.lang.Runnable
            public void run() {
  ...
  public final void onDisableCec() {
    disableCecLocalDevices(
        new HdmiCecLocalDevice
            .PendingActionClearedCallback() { // from class:
                                              // com.android.server.hdmi.HdmiControlService.23
          @Override // com.android.server.hdmi.HdmiCecLocalDevice.PendingActionClearedCallback
          public void onCleared(HdmiCecLocalDevice hdmiCecLocalDevice) {
            HdmiControlService.this.assertRunOnServiceThread();
            HdmiControlService.this.mCecController.flush(
                new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.23.1
                  @Override // java.lang.Runnable
                  public void run() {
  ...
  public void setActiveSource(int i, int i2, String str) {
    ...
    getAtomWriter()
        .activeSourceChanged(i, i2, HdmiUtils.pathRelationship(getPhysicalAddress(), i2));
    for (HdmiCecLocalDevice hdmiCecLocalDevice : getAllCecLocalDevices()) {
      hdmiCecLocalDevice.addActiveSourceHistoryItem(
          new HdmiCecLocalDevice.ActiveSource(i, i2),
          i == hdmiCecLocalDevice.getDeviceInfo().getLogicalAddress() && i2 == getPhysicalAddress(),
          str);
    }
    runOnServiceThread(new HdmiControlService$$ExternalSyntheticLambda2(this));
  }
  ...
  public class C157924 extends IHdmiControlCallback.Stub {
  ...
  /* renamed from: com.android.server.hdmi.HdmiControlService$25 */
  public class C158025 implements HdmiCecConfig.SettingChangeListener {
    public C158025() {}
    ...
    public void onChange(final String str) {
      synchronized (HdmiControlService.this.mLock) {
        if (HdmiControlService.this.mHdmiCecSettingChangeListenerRecords.containsKey(str)) {
          ((RemoteCallbackList)
                  HdmiControlService.this.mHdmiCecSettingChangeListenerRecords.get(str))
              .broadcast(
                  new Consumer() { // from class:
                                   // com.android.server.hdmi.HdmiControlService$25$$ExternalSyntheticLambda0
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                      HdmiControlService.C158025.this.lambda$onChange$0(
                          str, (IHdmiCecSettingChangeListener) obj);
                    }
                  });
        }
      }
    ...
    public /* synthetic */ void lambda$onChange$0(
        String str, IHdmiCecSettingChangeListener iHdmiCecSettingChangeListener) {
      HdmiControlService.this.invokeCecSettingChangeListenerLocked(
          str, iHdmiCecSettingChangeListener);
    }
  }
  ...
  public final void addCecSettingChangeListener(
    ...
    synchronized (this.mLock) {
      ...
      ((RemoteCallbackList) this.mHdmiCecSettingChangeListenerRecords.get(str))
  ...
  public final void removeCecSettingChangeListener(
    ...
    synchronized (this.mLock) {
      if (this.mHdmiCecSettingChangeListenerRecords.containsKey(str)) {
        ...
        if (((RemoteCallbackList) this.mHdmiCecSettingChangeListenerRecords.get(str))
  ...
  public final void invokeCecSettingChangeListenerLocked(
      String str, IHdmiCecSettingChangeListener iHdmiCecSettingChangeListener) {
    try {
  ...
  public boolean isAbsoluteVolumeBehaviorEnabled() {
    ...
    if ((!isTvDevice() && !isPlaybackDevice())
        || (avbAudioOutputDevice = getAvbAudioOutputDevice()) == null) {
      return false;
    }
  ...
  public final AudioDeviceAttributes getAvbAudioOutputDevice() {
    if (m30tv() != null) {
      return m30tv().getSystemAudioOutputDevice();
    }
    if (playback() != null) {
  ...
  public void checkAndUpdateAbsoluteVolumeBehavior() {
    ...
    if (setAudioVolumeLevelSupport == 0) {
      if (m30tv() == null || !this.mNumericSoundbarVolumeUiOnTvFeatureFlagEnabled) {
        switchToFullVolumeBehavior();
        return;
      } else {
  ...
  public final void switchToFullVolumeBehavior() {
    if (playback() != null) {
      ...
      m30tv().removeAvbAudioStatusAction();
    }
  ...
  public void enableAbsoluteVolumeBehavior(AudioStatus audioStatus) {
    HdmiCecLocalDevice playback = isPlaybackDevice() ? playback() : m30tv();
    HdmiDeviceInfo deviceInfo = getDeviceInfo(playback.findAudioReceiverAddress());
    VolumeInfo build =
    ...
    if (deviceInfo.getDeviceFeatures().getSetAudioVolumeLevelSupport() == 1) {
      getAudioDeviceVolumeManager()
          .setDeviceAbsoluteVolumeBehavior(
              getAvbAudioOutputDevice(),
              build,
              this.mServiceThreadExecutor,
              this.mAbsoluteVolumeChangedListener,
              true);
    } else if (m30tv() != null) {
      getAudioDeviceVolumeManager()
  ...
  class AbsoluteVolumeChangedListener
      ...
      HdmiControlService.this.sendCecCommand(
          ...
          new SendMessageCallback() { // from class:
            ...
            public final void onSendCompleted(int i) {
              HdmiControlService.AbsoluteVolumeChangedListener.this
                  .lambda$onAudioDeviceVolumeChanged$0(volumeInfo, logicalAddress, i);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onAudioDeviceVolumeChanged$0(
        VolumeInfo volumeInfo, int i, int i2) {
      if (i2 == 0) {
        boolean isTvDevice = HdmiControlService.this.isTvDevice();
        HdmiControlService hdmiControlService = HdmiControlService.this;
        (isTvDevice ? hdmiControlService.m30tv() : hdmiControlService.playback())
            .updateAvbVolume(volumeInfo.getVolumeIndex());
        return;
      }
      HdmiControlService.this.sendCecCommand(
          HdmiCecMessageBuilder.buildGiveAudioStatus(
              i, this.mSystemAudioDevice.getLogicalAddress()));
    }
    ...
    */
    public void onAudioDeviceVolumeAdjusted(
      ...
      i3 = FrameworkStatsLog.f636xd07885aa;
      if (i2 != 0) {}
    }
  }
  ...
  public void notifyAvbVolumeChange(int i) {
    if (isAbsoluteVolumeBehaviorEnabled()
        && getAudioManager()
            ...
            .contains(getAvbAudioOutputDevice())) {
  ...
  public void notifyAvbMuteChange(boolean z) {
    if (isAbsoluteVolumeBehaviorEnabled()
        && getAudioManager()
            ...
            .contains(getAvbAudioOutputDevice())) {
      getAudioManager()
          .adjustStreamVolume(3, z ? -100 : 100, isTvDevice() ? 8193 : IInstalld.FLAG_FORCE);
    }
  }
  ...
  public void setEarcEnabled(int i) {
    ...
    synchronized (this.mLock) {
      ...
      if (!isEarcSupported()) {
        Slog.i(
            "HdmiControlService",
            "Enabled/disabled eARC setting, but the hardware doesn´t support eARC. This settings"
                + " change doesn´t have an effect.");
      } else if (this.mEarcEnabled) {
        onEnableEarc();
      } else {
        runOnServiceThread(
            new Runnable() { // from class: com.android.server.hdmi.HdmiControlService.26
              @Override // java.lang.Runnable
              public void run() {
  ...
  public void setEarcEnabledInHal(final boolean z, boolean z2) {
    ...
    if (z2) {
      startArcAction(
          false,
          new IHdmiControlCallback
              .Stub() { // from class: com.android.server.hdmi.HdmiControlService.27
            public void onComplete(int i) {
              if (i != 0) {
                Slog.w(
                    "HdmiControlService",
                    "ARC termination before enabling eARC in the HAL failed with result: " + i);
              }
              HdmiControlService.this.mEarcController.setEarcEnabled(z);
              HdmiControlService.this.mCecController.setHpdSignalType(
                  z ? 1 : 0, HdmiControlService.this.mEarcPortId);
            }
          });
      return;
    }
  ...
  public void handleEarcStateChange(int i, int i2) {
    ...
    if (!getPortInfo(i2).isEarcSupported()) {
      Slog.w(
          "HdmiControlService", "Tried to update eARC status on a port that doesn't support eARC.");
      return;
    }
    HdmiEarcLocalDevice hdmiEarcLocalDevice = this.mEarcLocalDevice;
    if (hdmiEarcLocalDevice != null) {
  ...
  public void notifyEarcStatusToAudioService(boolean z, List list) {
    getAudioManager()
        .setWiredDeviceConnectionState(
            new AudioDeviceAttributes(2, 29, "", "", new ArrayList(), list), z ? 1 : 0);
  }
  ...
  public void startArcAction(boolean z, IHdmiControlCallback iHdmiControlCallback) {
    if (!isTvDeviceEnabled()) {
      ...
      m30tv().startArcAction(z, iHdmiControlCallback);
    }
  }
}
