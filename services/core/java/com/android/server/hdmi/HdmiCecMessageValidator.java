...
public abstract class HdmiCecMessageValidator {
    ...
    static {
        ...
        addValidationInfo(FrameworkStatsLog.f664xb094ac9f, new MinimumOneByteRangeValidator(0, 6), 32767, 32767);
        addValidationInfo(FrameworkStatsLog.f643xde3a78eb, fixedLengthValidator, GnssNative.GNSS_AIDING_TYPE_ALL, 32767);
    ...
    public static boolean isValidUiSoundPresenationControl(int i) {
        int i2 = i & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT;
        return i2 == 32 || i2 == 48 || i2 == 128 || i2 == 144 || i2 == 160 || isWithinRange(i2, 177, FrameworkStatsLog.f633xa546c0ca) || isWithinRange(i2, 193, 195);
    }
