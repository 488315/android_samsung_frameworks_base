...
public abstract class SystemAudioAction extends HdmiCecFeatureAction {
  ...
  public void sendSystemAudioModeRequest() {
    ...
    if (!actions.isEmpty()) {
      this.mState = 1;
      ((RoutingControlAction) actions.get(0))
  ...
  public final void sendSystemAudioModeRequestInternal() {
    sendCommand(
        HdmiCecMessageBuilder.buildSystemAudioModeRequest(
            ...
            getSystemAudioModeRequestParam(),
            this.mTargetAudioStatus),
        new HdmiControlService
            .SendMessageCallback() { // from class: com.android.server.hdmi.SystemAudioAction.2
  ...
  public final int getSystemAudioModeRequestParam() {
    if (m27tv().getActiveSource().isValid()) {
      return m27tv().getActiveSource().physicalAddress;
    }
    int activePath = m27tv().getActivePath();
    if (activePath != 65535) {
      return activePath;
    }
    return 0;
  ...
  public final boolean processCommand(HdmiCecMessage hdmiCecMessage) {
    ...
    if (hdmiCecMessage.getOpcode() == 114
        && HdmiUtils.checkCommandSource(
            hdmiCecMessage, this.mAvrLogicalAddress, "SystemAudioAction")) {
