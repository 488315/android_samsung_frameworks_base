...
public final class SetArcTransmissionStateAction extends HdmiCecFeatureAction {
  ...
  public boolean start() {
    if (this.mEnabled) {
      addAndStartAction(
          new RequestSadAction(
              localDevice(),
              5,
              new RequestSadAction
                  .RequestSadCallback() { // from class:
                                          // com.android.server.hdmi.SetArcTransmissionStateAction.1
                ...
                public void onRequestSadDone(List list) {
                  ...
                  SetArcTransmissionStateAction.this.m27tv().enableArc(list);
  ...
  public final void sendReportArcInitiated() {
    sendCommand(
        HdmiCecMessageBuilder.buildReportArcInitiated(getSourceAddress(), this.mAvrAddress),
        new HdmiControlService
            .SendMessageCallback() { // from class:
                                     // com.android.server.hdmi.SetArcTransmissionStateAction.2
  ...
  public final void disableArc() {
    ...
    m27tv().disableArc();
    sendCommand(
        HdmiCecMessageBuilder.buildReportArcTerminated(getSourceAddress(), this.mAvrAddress));
  }

  @Override // com.android.server.hdmi.HdmiCecFeatureAction
  public boolean processCommand(HdmiCecMessage hdmiCecMessage) {
    if (this.mState != 1
        || hdmiCecMessage.getOpcode() != 0
        || (hdmiCecMessage.getParams()[0] & 255) != 193) {
      return false;
    }
