...
public class HdmiCecLocalDevicePlayback extends HdmiCecLocalDeviceSource {
  ...
  public HdmiCecLocalDevicePlayback(HdmiControlService hdmiControlService) {
    ...
    this.mPlaybackDeviceActionOnRoutingControl =
    ...
    if (this.mService.audioSystem() == null) {
      this.mService.sendCecCommand(
          HdmiCecMessageBuilder.buildGiveSystemAudioModeStatus(
              getDeviceInfo().getLogicalAddress(), 5),
          new HdmiControlService
              .SendMessageCallback() { // from class:
                                       // com.android.server.hdmi.HdmiCecLocalDevicePlayback.1
        ...
        new DeviceDiscoveryAction(
            ...
            new DeviceDiscoveryAction
                .DeviceDiscoveryCallback() { // from class:
                                             // com.android.server.hdmi.HdmiCecLocalDevicePlayback.2
              ...
              public void onDeviceDiscoveryDone(List list) {
                ...
                Iterator it2 =
                    HdmiCecLocalDevicePlayback.this.mService.getAllCecLocalDevices().iterator();
                while (it2.hasNext()) {
                  HdmiCecLocalDevicePlayback.this
                      .mService
                      .getHdmiCecNetwork()
                      .addCecDevice(((HdmiCecLocalDevice) it2.next()).getDeviceInfo());
                }
                if (HdmiCecLocalDevicePlayback.this
  ...
  public class DelayedStandbyRunnable implements Runnable {
    ...
    public void run() {
      if (HdmiCecLocalDevicePlayback.this
        ...
        HdmiCecLocalDevicePlayback.this.mDelayedStandbyHandler.postDelayed(
            HdmiCecLocalDevicePlayback.this.new DelayedStandbyRunnable(), 30000L);
      }
    }
  }
  ...
  public void onStandby(boolean z, int i) {
    ...
    if (this.mService.isCecControlEnabled()) {
      ...
      this.mService.setActiveSource(
          -1, GnssNative.GNSS_AIDING_TYPE_ALL, "HdmiCecLocalDevicePlayback#onStandby()");
      if (isActiveSource) {
        if (z) {
          this.mService.sendCecCommand(
        ...
        switch (stringValue) {
          case "to_tv_and_audio_system":
            this.mService.sendCecCommand(
                HdmiCecMessageBuilder.buildStandby(getDeviceInfo().getLogicalAddress(), 0));
            this.mService.sendCecCommand(
                HdmiCecMessageBuilder.buildStandby(getDeviceInfo().getLogicalAddress(), 5));
            break;
          case "broadcast":
            this.mService.sendCecCommand(
                HdmiCecMessageBuilder.buildStandby(getDeviceInfo().getLogicalAddress(), 15));
  ...
  public void onInitializeCecComplete(int i) {
    if (i == 2
        && !this.mService.getHdmiCecConfig().getStringValue("power_control_mode").equals("none")) {
      oneTouchPlay(
          new IHdmiControlCallback
              .Stub() { // from class: com.android.server.hdmi.HdmiCecLocalDevicePlayback.3
            public void onComplete(int i2) {
              if (i2 != 0) {
                Slog.w(
                    "HdmiCecLocalDevicePlayback",
                    "Failed to complete One Touch Play. result=" + i2);
              }
            }
          });
    }
  ...
  public final ActiveWakeLock getWakeLock() {
    ...
    if (this.mWakeLock == null) {
      if (SystemProperties.getBoolean("persist.sys.hdmi.keep_awake", true)) {
        ...
        this.mWakeLock =
            new ActiveWakeLock() { // from class:
                                   // com.android.server.hdmi.HdmiCecLocalDevicePlayback.4
  ...
  public void onActiveSourceLost() {
    ...
    String stringValue =
        this.mService.getHdmiCecConfig().getStringValue("power_state_change_on_active_source_lost");
    stringValue.hashCode();
    ...
    try {
      ...
      String localeToMenuLanguage =
          HdmiControlService.localeToMenuLanguage(
              this.mService.getContext().getResources().getConfiguration().locale);
      HdmiLogger.debug(
      ...
      for (LocalePicker.LocaleInfo localeInfo :
          LocalePicker.getAllAssetLocales(this.mService.getContext(), false)) {
      ...
      try {
        ...
        intent.setComponent(
            ComponentName.unflattenFromString(
                context.getResources().getString(R.string.done_label)));
  ...
  public int handleSetSystemAudioMode(HdmiCecMessage hdmiCecMessage) {
    ...
    if (hdmiCecMessage.getDestination() == 15
        ...
        && this.mService.audioSystem() == null
  ...
  public int handleSystemAudioModeStatus(HdmiCecMessage hdmiCecMessage) {
    boolean parseCommandParamSystemAudioStatus;
    if (hdmiCecMessage.getDestination() != getDeviceInfo().getLogicalAddress()
        || hdmiCecMessage.getSource() != 5
        || this.mService.isSystemAudioActivated()
            == (parseCommandParamSystemAudioStatus =
                HdmiUtils.parseCommandParamSystemAudioStatus(hdmiCecMessage))) {
  ...
  public int handleRoutingChange(HdmiCecMessage hdmiCecMessage) {
    ...
    handleRoutingChangeAndInformation(
        HdmiUtils.twoBytesToInt(hdmiCecMessage.getParams(), 2), hdmiCecMessage);
    return -1;
  }
  ...
  public int handleRoutingInformation(HdmiCecMessage hdmiCecMessage) {
    assertRunOnServiceThread();
    handleRoutingChangeAndInformation(
        HdmiUtils.twoBytesToInt(hdmiCecMessage.getParams()), hdmiCecMessage);
    return -1;
  }
  ...
  public void handleRoutingChangeAndInformation(int i, HdmiCecMessage hdmiCecMessage) {
    ...
    int i2 = AbstractC15575.f1701x34455e89[this.mPlaybackDeviceActionOnRoutingControl.ordinal()];
    if (i2 == 1) {
      setAndBroadcastActiveSource(
          hdmiCecMessage, i, "HdmiCecLocalDevicePlayback#handleRoutingChangeAndInformation()");
    } else {
      if (i2 != 2) {
        return;
      }
  ...
  public abstract /* synthetic */ class AbstractC15575 {

    /* renamed from: $SwitchMap$android$sysprop$HdmiProperties$playback_device_action_on_routing_control_values */
    public static final /* synthetic */ int[] f1701x34455e89;

    static {
      int[] iArr =
          new int[HdmiProperties.playback_device_action_on_routing_control_values.values().length];
      f1701x34455e89 = iArr;
      try {
        iArr[
                HdmiProperties.playback_device_action_on_routing_control_values
      ...
      try {
        f1701x34455e89[
                HdmiProperties.playback_device_action_on_routing_control_values.NONE.ordinal()] =
            3;
  ...
  public void preprocessBufferedMessages(List list) {
    ...
    while (it.hasNext()) {
      ...
      if (hdmiCecMessage.getOpcode() == 128
          || hdmiCecMessage.getOpcode() == 134
          || hdmiCecMessage.getOpcode() == 130) {
