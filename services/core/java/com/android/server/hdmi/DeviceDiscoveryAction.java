...
public final class DeviceDiscoveryAction extends HdmiCecFeatureAction {
  ...
  public final class DeviceInfo {
    ...
    public final HdmiDeviceInfo toHdmiDeviceInfo() {
      return HdmiDeviceInfo.cecDeviceBuilder()
          .setLogicalAddress(this.mLogicalAddress)
          .setPhysicalAddress(this.mPhysicalAddress)
          .setPortId(this.mPortId)
          .setVendorId(this.mVendorId)
          .setDeviceType(this.mDeviceType)
          .setDisplayName(this.mDisplayName)
          .setDevicePowerStatus(this.mPowerStatus)
          .build();
    }
  }
  ...
  public DeviceDiscoveryAction(
      HdmiCecLocalDevice hdmiCecLocalDevice, DeviceDiscoveryCallback deviceDiscoveryCallback) {
  ...
  public final void handleReportPhysicalAddress(HdmiCecMessage hdmiCecMessage) {
    ...
    if (this.mIsTvDevice) {
      localDevice()
          ...
          .getHdmiCecNetwork()
          .updateCecSwitchInfo(
              deviceInfo.mLogicalAddress, deviceInfo.mDeviceType, deviceInfo.mPhysicalAddress);
    }
  ...
  public final int getPortId(int i) {
    return this.mIsTvDevice ? m27tv().getPortId(i) : source().getPortId(i);
  }
  ...
  public final void handleSetOsdName(HdmiCecMessage hdmiCecMessage) {
    ...
    try {
      ...
      Slog.w(
          "DeviceDiscoveryAction", "Failed to decode display name: " + hdmiCecMessage.toString());
    }
  ...
  public final void wrapUpAndFinish() {
    ...
    finish();
    if (this.mIsTvDevice) {
      m27tv().processAllDelayedMessages();
    }
  }
  ...
  public void handleTimerEvent(int i) {
    ...
    Slog.v(
        "DeviceDiscoveryAction",
        "Timeout[State=" + this.mState + ", Processed=" + this.mProcessedDeviceCount);
    int i4 = this.mState;
    if (i4 != 6 && i4 != 3) {
