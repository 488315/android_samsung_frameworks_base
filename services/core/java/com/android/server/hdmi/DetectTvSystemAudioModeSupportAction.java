...
public class DetectTvSystemAudioModeSupportAction extends HdmiCecFeatureAction {
  ...
  public DetectTvSystemAudioModeSupportAction(
      HdmiCecLocalDevice hdmiCecLocalDevice,
      HdmiCecLocalDeviceAudioSystem.TvSystemAudioModeSupportedCallback
          tvSystemAudioModeSupportedCallback) {
  ...
  public boolean processCommand(HdmiCecMessage hdmiCecMessage) {
    if (hdmiCecMessage.getOpcode() != 0
        || this.mState != 1
        || HdmiUtils.getAbortFeatureOpcode(hdmiCecMessage) != 114) {
      return false;
    }
  ...
  public void sendSetSystemAudioMode() {
    sendCommand(
        HdmiCecMessageBuilder.buildSetSystemAudioMode(getSourceAddress(), 0, true),
        new HdmiControlService
            .SendMessageCallback() { // from class:
                                     // com.android.server.hdmi.DetectTvSystemAudioModeSupportAction$$ExternalSyntheticLambda0
