...
public abstract class HdmiCecLocalDeviceSource extends HdmiCecLocalDevice {
  ...
  public void toggleAndFollowTvPower() {
    ...
    this.mService.queryDisplayStatus(
        new IHdmiControlCallback
            .Stub() { // from class: com.android.server.hdmi.HdmiCecLocalDeviceSource.1
          public void onComplete(int i) {
            ...
            if (i == 0 || i == 2) {
              ...
              HdmiCecLocalDeviceSource.this.oneTouchPlay(
                  new IHdmiControlCallback
                      .Stub() { // from class: com.android.server.hdmi.HdmiCecLocalDeviceSource.1.1
  ...
  public void setActiveSource(int i, String str) {
    assertRunOnServiceThread();
    setActiveSource(HdmiCecLocalDevice.ActiveSource.m28of(-1, i), str);
  }
  ...
  public int handleActiveSource(HdmiCecMessage hdmiCecMessage) {
    ...
    HdmiCecLocalDevice.ActiveSource m28of =
        HdmiCecLocalDevice.ActiveSource.m28of(source, twoBytesToInt);
    if (!getActiveSource().equals(m28of)) {
      setActiveSource(m28of, "HdmiCecLocalDeviceSource#handleActiveSource()");
    }
  ...
  public int handleSetStreamPath(HdmiCecMessage hdmiCecMessage) {
    ...
    if (twoBytesToInt == this.mService.getPhysicalAddress() && this.mService.isPlaybackDevice()) {
      setAndBroadcastActiveSource(
          hdmiCecMessage, twoBytesToInt, "HdmiCecLocalDeviceSource#handleSetStreamPath()");
  ...
  public void setAndBroadcastActiveSource(HdmiCecMessage hdmiCecMessage, int i, String str) {
    this.mService.setAndBroadcastActiveSource(
        i, getDeviceInfo().getDeviceType(), hdmiCecMessage.getSource(), str);
  }
  ...
  public boolean isActiveSource() {
    ...
    return getActiveSource()
        .equals(getDeviceInfo().getLogicalAddress(), getDeviceInfo().getPhysicalAddress());
  }
