...
public final class HdmiEarcController {
  ...
  public final class EarcNativeWrapperImpl implements EarcNativeWrapper, IBinder.DeathRecipient {
    ...
    public boolean connectToHal() {
      IEArc asInterface =
          IEArc.Stub.asInterface(ServiceManager.getService(IEArc.DESCRIPTOR + "/default"));
    ...
    public void nativeSetEarcEnabled(boolean z) {
      try {
        ...
        HdmiLogger.error(
            "Could not set eARC enabled to " + z + ". Error: ", Integer.valueOf(e.errorCode));
      } catch (RemoteException e2) {
        HdmiLogger.error(
            "Could not set eARC enabled to " + z + ":. Exception: ", e2, new Object[0]);
      }
    }
    ...
    public byte[] nativeGetLastReportedAudioCapabilities(int i) {
      try {
        ...
        HdmiLogger.error(
            "Could not read last reported audio capabilities. Exception: ", e, new Object[0]);
        return null;
      }
    }
  }
  ...
  public HdmiEarcController(
      HdmiControlService hdmiControlService, EarcNativeWrapper earcNativeWrapper) {
  ...
  public static HdmiEarcController createWithNativeWrapper(
      HdmiControlService hdmiControlService, EarcNativeWrapper earcNativeWrapper) {
    HdmiEarcController hdmiEarcController =
        new HdmiEarcController(hdmiControlService, earcNativeWrapper);
