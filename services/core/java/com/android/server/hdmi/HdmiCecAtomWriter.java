...
public class HdmiCecAtomWriter {
  ...
  public void messageReported(HdmiCecMessage hdmiCecMessage, int i, int i2, int i3) {
    messageReportedBase(
        createMessageReportedGenericArgs(hdmiCecMessage, i, i3, i2),
        createMessageReportedSpecialArgs(hdmiCecMessage));
  }
  ...
  public final MessageReportedGenericArgs createMessageReportedGenericArgs(
      HdmiCecMessage hdmiCecMessage, int i, int i2, int i3) {
    return new MessageReportedGenericArgs(
        i3,
        i,
        hdmiCecMessage.getSource(),
        hdmiCecMessage.getDestination(),
        hdmiCecMessage.getOpcode(),
        i2 == -1 ? 0 : i2 + 10);
  }

  public final MessageReportedSpecialArgs createMessageReportedSpecialArgs(
  ...
  public final MessageReportedSpecialArgs createUserControlPressedSpecialArgs(
      HdmiCecMessage hdmiCecMessage) {
  ...
  public final MessageReportedSpecialArgs createFeatureAbortSpecialArgs(
      HdmiCecMessage hdmiCecMessage) {
    MessageReportedSpecialArgs messageReportedSpecialArgs = new MessageReportedSpecialArgs();
    if (hdmiCecMessage.getParams().length > 0) {
  ...
  public final void messageReportedBase(
      MessageReportedGenericArgs messageReportedGenericArgs,
      MessageReportedSpecialArgs messageReportedSpecialArgs) {
    writeHdmiCecMessageReportedAtom(
        messageReportedGenericArgs.mUid,
        messageReportedGenericArgs.mDirection,
        messageReportedGenericArgs.mInitiatorLogicalAddress,
        messageReportedGenericArgs.mDestinationLogicalAddress,
        messageReportedGenericArgs.mOpcode,
        messageReportedGenericArgs.mSendMessageResult,
        messageReportedSpecialArgs.mUserControlPressedCommand,
        messageReportedSpecialArgs.mFeatureAbortOpcode,
        messageReportedSpecialArgs.mFeatureAbortReason);
  }
