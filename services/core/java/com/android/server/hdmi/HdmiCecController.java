...
public final class HdmiCecController {
    ...
    public ArrayBlockingQueue mMessageHistory = new ArrayBlockingQueue(FrameworkStatsLog.f446x58c6c32);
    ...
    public final void runDevicePolling(final int i, final List list, final int i2, final HdmiControlService.DevicePollingCallback devicePollingCallback, final List list2) {
        assertRunOnServiceThread();
        if (!list.isEmpty()) {
    ...
    public final class NativeWrapperImpl11 implements NativeWrapper, IHwBinder.DeathRecipient, IHdmiCec.getPhysicalAddressCallback {
        ...
        public HdmiPortInfo[] nativeGetPortInfos() {
            try {
                ...
                int i = 0;
                while (it.hasNext()) {
                    android.hardware.p002tv.cec.V1_0.HdmiPortInfo hdmiPortInfo = (android.hardware.p002tv.cec.V1_0.HdmiPortInfo) it.next();
