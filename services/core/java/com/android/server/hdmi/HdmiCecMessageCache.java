...
public final class HdmiCecMessageCache {
    public static final FastImmutableArraySet CACHEABLE_OPCODES = new FastImmutableArraySet(new Integer[]{71, 132, 135, Integer.valueOf(FrameworkStatsLog.f679x663f9746)});
