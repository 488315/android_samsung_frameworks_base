...
public class SystemAudioInitiationActionFromAvr extends HdmiCecFeatureAction {
  ...
  public void sendRequestActiveSource() {
    sendCommand(
        HdmiCecMessageBuilder.buildRequestActiveSource(getSourceAddress()),
        new HdmiControlService
            .SendMessageCallback() { // from class:
                                     // com.android.server.hdmi.SystemAudioInitiationActionFromAvr$$ExternalSyntheticLambda1
  ...
  public void sendSetSystemAudioMode(final boolean z, final int i) {
    sendCommand(
        HdmiCecMessageBuilder.buildSetSystemAudioMode(getSourceAddress(), i, z),
        new HdmiControlService
            .SendMessageCallback() { // from class:
                                     // com.android.server.hdmi.SystemAudioInitiationActionFromAvr$$ExternalSyntheticLambda2
          @Override // com.android.server.hdmi.HdmiControlService.SendMessageCallback
    ...
    audioSystem()
        .queryTvSystemAudioModeSupport(
            new HdmiCecLocalDeviceAudioSystem
                .TvSystemAudioModeSupportedCallback() { // from class:
                                                        // com.android.server.hdmi.SystemAudioInitiationActionFromAvr$$ExternalSyntheticLambda0
