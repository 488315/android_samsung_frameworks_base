...
public abstract class HdmiCecLocalDevice extends HdmiLocalDevice {
  ...
  public class ActiveSource {
    ...
    /* renamed from: of */
    public static ActiveSource m29of(ActiveSource activeSource) {
      return new ActiveSource(activeSource.logicalAddress, activeSource.physicalAddress);
    }

    /* renamed from: of */
    public static ActiveSource m28of(int i, int i2) {
            ...
            switch (opcode) {
              ...
              default:
                switch (opcode) {
                  ...
                  default:
                    switch (opcode) {
                      case FrameworkStatsLog.f681x729e24be /* 157 */:
                        return handleInactiveSource(hdmiCecMessage);
                      case FrameworkStatsLog.f679x663f9746 /* 158 */:
                        return handleCecVersion();
                      case FrameworkStatsLog.f680x89db317 /* 159 */:
                      ...
                      default:
                        switch (opcode) {
                          ...
                          case FrameworkStatsLog.f643xde3a78eb /* 165 */:
  ...
  public int handleGivePhysicalAddress(HdmiCecMessage hdmiCecMessage) {
    ...
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildReportPhysicalAddressCommand(
            this.mDeviceInfo.getLogicalAddress(), physicalAddress, this.mDeviceType));
    return -1;
  }
  ...
  public int handleGiveDeviceVendorId(HdmiCecMessage hdmiCecMessage) {
    ...
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildDeviceVendorIdCommand(
            this.mDeviceInfo.getLogicalAddress(), vendorId));
    return -1;
  }
  ...
  public int handleGetCecVersion(HdmiCecMessage hdmiCecMessage) {
    ...
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildCecVersion(
            hdmiCecMessage.getDestination(),
            hdmiCecMessage.getSource(),
            this.mService.getCecVersion()));
    return -1;
  }
    ...
    if (buildSetOsdNameCommand != null) {
      this.mService.sendCecCommand(
          ...
          new HdmiControlService
              .SendMessageCallback() { // from class: com.android.server.hdmi.HdmiCecLocalDevice.2
            @Override // com.android.server.hdmi.HdmiControlService.SendMessageCallback
            public void onSendCompleted(int i2) {
              if (i2 != 0) {
                HdmiLogger.debug(
                    "Failed to send cec command " + buildSetOsdNameCommand, new Object[0]);
              }
            }
          });
      return;
  ...
  public int handleReportPhysicalAddress(HdmiCecMessage hdmiCecMessage) {
    ...
    if (cecDeviceInfo != null
        && cecDeviceInfo.getDisplayName().equals(HdmiUtils.getDefaultDeviceName(source))) {
      this.mService.sendCecCommand(
          HdmiCecMessageBuilder.buildGiveOsdNameCommand(
              this.mDeviceInfo.getLogicalAddress(), source));
    }
    return -1;
  }
  ...
  public int handleStandby(HdmiCecMessage hdmiCecMessage) {
    ...
    if (!this.mService.isCecControlEnabled()
        ...
        || !this.mService.isPowerOnOrTransient()) {
      return 1;
    }
  ...
  */
  ...
  public int handleMenuRequest(HdmiCecMessage hdmiCecMessage) {
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildReportMenuStatus(
            this.mDeviceInfo.getLogicalAddress(), hdmiCecMessage.getSource(), 0));
    return -1;
  }

  public int handleVendorCommand(HdmiCecMessage hdmiCecMessage) {
    return !this.mService.invokeVendorCommandListenersOnReceived(
            this.mDeviceType,
            hdmiCecMessage.getSource(),
            hdmiCecMessage.getDestination(),
  ...
  public void querySetAudioVolumeLevelSupport(final int i) {
    ...
    if (this.mService.getCecVersion() >= 6) {
      this.mService.sendCecCommand(
          HdmiCecMessageBuilder.buildGiveFeatures(getDeviceInfo().getLogicalAddress(), i));
    }
    if (getActions(SetAudioVolumeLevelDiscoveryAction.class).stream()
        .noneMatch(
            new Predicate() { // from class:
                              // com.android.server.hdmi.HdmiCecLocalDevice$$ExternalSyntheticLambda1
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$querySetAudioVolumeLevelSupport$0;
                lambda$querySetAudioVolumeLevelSupport$0 =
                    HdmiCecLocalDevice.lambda$querySetAudioVolumeLevelSupport$0(
                        i, (SetAudioVolumeLevelDiscoveryAction) obj);
      ...
      addAndStartAction(
          new SetAudioVolumeLevelDiscoveryAction(
              ...
              new IHdmiControlCallback
                  .Stub() { // from class: com.android.server.hdmi.HdmiCecLocalDevice.3
  ...
  public static /* synthetic */ boolean lambda$querySetAudioVolumeLevelSupport$0(
      int i, SetAudioVolumeLevelDiscoveryAction setAudioVolumeLevelDiscoveryAction) {
  ...
  public void checkIfPendingActionsCleared() {
    ...
    if (!this.mActions.isEmpty()
        || (pendingActionClearedCallback = this.mPendingActionClearedCallback) == null) {
      return;
    }
    this.mPendingActionClearedCallback = null;
  ...
  public void disableDevice(
      boolean z, final PendingActionClearedCallback pendingActionClearedCallback) {
    removeAction(AbsoluteVolumeAudioStatusAction.class);
    removeAction(SetAudioVolumeLevelDiscoveryAction.class);
    removeAction(ActiveSourceAction.class);
    this.mPendingActionClearedCallback =
        new PendingActionClearedCallback() { // from class:
                                             // com.android.server.hdmi.HdmiCecLocalDevice.4
  ...
  public void sendKeyEvent(int i, boolean z) {
    ...
    if (findKeyReceiverAddress == -1
        || findKeyReceiverAddress == this.mDeviceInfo.getLogicalAddress()) {
      Slog.w(
          "HdmiCecLocalDevice",
          "Discard key event: "
              + i
  ...
  public void sendVolumeKeyEvent(int i, boolean z) {
    ...
    if (findAudioReceiverAddress == -1
        || this.mService.getAllCecLocalDevices().stream()
            .anyMatch(
                new Predicate() { // from class:
                                  // com.android.server.hdmi.HdmiCecLocalDevice$$ExternalSyntheticLambda0
                  @Override // java.util.function.Predicate
                  public final boolean test(Object obj) {
                    boolean lambda$sendVolumeKeyEvent$1;
                    lambda$sendVolumeKeyEvent$1 =
                        HdmiCecLocalDevice.lambda$sendVolumeKeyEvent$1(
                            findAudioReceiverAddress, (HdmiCecLocalDevice) obj);
  ...
  public static /* synthetic */ boolean lambda$sendVolumeKeyEvent$1(
      int i, HdmiCecLocalDevice hdmiCecLocalDevice) {
  ...
  public void sendUserControlPressedAndReleased(int i, int i2) {
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildUserControlPressed(this.mDeviceInfo.getLogicalAddress(), i, i2));
    this.mService.sendCecCommand(
        HdmiCecMessageBuilder.buildUserControlReleased(this.mDeviceInfo.getLogicalAddress(), i));
  }

  public void addActiveSourceHistoryItem(ActiveSource activeSource, boolean z, String str) {
    ActiveSourceHistoryRecord activeSourceHistoryRecord =
        new ActiveSourceHistoryRecord(activeSource, z, str);
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    ...
    indentingPrintWriter.println(
        String.format("mActiveRoutingPath: 0x%04x", Integer.valueOf(this.mActiveRoutingPath)));
  }
