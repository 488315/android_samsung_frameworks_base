...
public final /* synthetic */ class SaveUi$$ExternalSyntheticLambda7
    ...
    public final void onClick(View view) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                ((SaveUi.AnonymousClass2) this.f$0)
                        .this$0.mListener.onCancel(
                                ((SaveInfo) this.f$1).semGetNegativeSecondActionListener());
                break;
        }
    }
}
