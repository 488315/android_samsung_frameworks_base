...
public final class RemoteInlineSuggestionViewConnector {
    ...
    public final RemoteInlineSuggestionViewConnector$$ExternalSyntheticLambda2
            mStartIntentSenderFromClientApp;
    ...
    public RemoteInlineSuggestionViewConnector(
        ...
        this.mOnErrorCallback =
                new RemoteInlineSuggestionViewConnector$$ExternalSyntheticLambda0(
                        inlineSuggestionUiCallback, 0);
        this.mOnInflateCallback =
                new RemoteInlineSuggestionViewConnector$$ExternalSyntheticLambda0(
                        inlineSuggestionUiCallback, 1);
        this.mStartIntentSenderFromClientApp =
                new RemoteInlineSuggestionViewConnector$$ExternalSyntheticLambda2(
