...
public final class InlineContentProviderImpl extends IInlineContentProvider.Stub {
    ...
    public final void provideContent(
        ...
        this.mHandler.post(
                new Runnable() { // from class:
                    ...
                    public final void run() {
                        InlineContentProviderImpl inlineContentProviderImpl =
                                InlineContentProviderImpl.this;
                        int i3 = i;
                        int i4 = i2;
                        ...
                        if (remoteInlineSuggestionUi == null
                                || remoteInlineSuggestionUi.mWidth != i3
                                || remoteInlineSuggestionUi.mHeight != i4) {
                            inlineContentProviderImpl.mRemoteInlineSuggestionUi =
                                    new RemoteInlineSuggestionUi(
                                            ...
                                            i3,
                                            i4,
                                            inlineContentProviderImpl.mHandler);
                        }
                        ...
                        remoteInlineSuggestionUi2.mHandler.post(
                                new RemoteInlineSuggestionUi$$ExternalSyntheticLambda1(
                                        0, remoteInlineSuggestionUi2, iInlineContentCallback2));
                        RemoteInlineSuggestionUi remoteInlineSuggestionUi3 =
                                inlineContentProviderImpl.mRemoteInlineSuggestionUi;
                        remoteInlineSuggestionUi3.getClass();
                        remoteInlineSuggestionUi3.mHandler.post(
                                new RemoteInlineSuggestionUi$$ExternalSyntheticLambda0(
                                        remoteInlineSuggestionUi3, 0));
                    }
                });
    }
