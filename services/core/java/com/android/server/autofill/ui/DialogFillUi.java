...
public final class DialogFillUi {
    ...
    public final class AnnounceFilterResult implements Runnable {
        ...
        public final void run() {
            ...
            if (count <= 0) {
                format =
                        DialogFillUi.this.mContext.getString(
                                R.string
                                        .config_customAdbWifiNetworkConfirmationSecondaryUserComponent);
            } else {
                ...
                format =
                        PluralsMessageFormatter.format(
                                ...
                                hashMap,
                                R.string.config_customCountryDetector);
            }
        ...
        public final class AnonymousClass1 extends Filter {
                                        ...
                                        .filter(
                                                new Predicate() { // from class:
                                                    ...
                                                    public final boolean test(Object obj) {
                                                        ...
                                                        DialogFillUi.ViewItem viewItem =
                                                                (DialogFillUi.ViewItem) obj;
                                                        viewItem.getClass();
                                                        ...
                                                        if (viewItem.filterable) {
                                                            ...
                                                            if (viewItem.dataset.getAuthentication()
                                                                    == null) {
                                                                return true;
                                                            }
                                                        }
            ...
            public final void publishResults(
                ...
                if (filterResults.count > 0) {
                    ((ArrayList) ItemsAdapter.this.mFilteredItems)
                ...
                if (size != ((ArrayList) ItemsAdapter.this.mFilteredItems).size()) {
                    ...
                    if (AccessibilityManager.getInstance(dialogFillUi.mContext).isEnabled()) {
                        if (dialogFillUi.mAnnounceFilterResult == null) {
                            dialogFillUi.mAnnounceFilterResult =
                                    dialogFillUi.new AnnounceFilterResult();
                        }
                        AnnounceFilterResult announceFilterResult =
                                dialogFillUi.mAnnounceFilterResult;
    ...
    public DialogFillUi(
            ...
            boolean z,
            AutoFillUI.AnonymousClass3 anonymousClass3) {
        int integer;
        boolean z2;
        String str3;
        Object obj;
        ...
        View inflate =
                LayoutInflater.from(contextThemeWrapper)
                        .inflate(R.layout.car_preference_category, (ViewGroup) null);
            ...
            if (Helper.sDebug) {
                Slog.d(
                        ...
                        DualAppManagerService$$ExternalSyntheticOutline0.m(
                                minimumWidth, minimumHeight, "Adding service icon (", "x", ")"));
            }
        ...
        if (sanitizeRemoteView != null) {
            ...
            viewGroup2.addView(
                    sanitizeRemoteView.applyWithTheme(
                            contextThemeWrapper,
                            (ViewGroup) inflate,
                            new DialogFillUi$$ExternalSyntheticLambda5(this, 2),
                            i));
        ...
        if (AutofillManagerService.getVisibleDatasetsMaxCount() > 0) {
            ...
            if (Helper.sVerbose) {
                ProxyManager$$ExternalSyntheticOutline0.m(
                        integer, "overriding maximum visible datasets to ", "DialogFillUi");
            }
        } else {
            integer =
                    contextThemeWrapper
                            .getResources()
                            .getInteger(R.integer.autofill_max_visible_datasets);
        }
        ...
        if (fillResponse.getAuthentication() != null) {
            ...
            DialogFillUi$$ExternalSyntheticLambda5 dialogFillUi$$ExternalSyntheticLambda5 =
                    new DialogFillUi$$ExternalSyntheticLambda5(this, 1);
                ...
                if (indexOf >= 0) {
                    ...
                    if (sanitizeRemoteView2 != null) {
                        try {
                            ...
                            View applyWithTheme =
                                    sanitizeRemoteView2.applyWithTheme(
                                            this.mContext,
                                            viewGroup,
                                            dialogFillUi$$ExternalSyntheticLambda5,
                                            this.mThemeId);
                            Dataset.DatasetFieldFilter filter = dataset.getFilter(indexOf);
                            if (filter == null) {
                                AutofillValue autofillValue =
                                        (AutofillValue) dataset.getFieldValues().get(indexOf);
                                str3 =
            ...
            final AdapterView.OnItemClickListener onItemClickListener =
                    new AdapterView
                        ...
                        public final void onItemClick(
                            ...
                            DialogFillUi dialogFillUi = DialogFillUi.this;
                            DialogFillUi.ViewItem viewItem =
                                    (DialogFillUi.ViewItem)
                                            ((ArrayList) dialogFillUi.mAdapter.mFilteredItems)
                                                    .get(i3);
                            ...
                            synchronized (anonymousClass32.val$sessionLock) {
                                PresentationStatsEventLogger presentationStatsEventLogger =
                                        anonymousClass32.val$presentationStatsEventLogger;
                                if (presentationStatsEventLogger != null) {
                                    presentationStatsEventLogger.mEventInternal.ifPresent(
                                            new PresentationStatsEventLogger$$ExternalSyntheticLambda0(
                                                    5));
                                }
                            }
                            ...
                            if (AutoFillUI.this.mCallback != null) {
                                ...
                                ((Session) AutoFillUI.this.mCallback)
                                        .fill(
                                                anonymousClass32.val$response.getRequestId(),
                                                indexOf2,
                                                dataset2,
                                                3);
                            }
                ...
                View.OnClickListener onClickListener =
                        new View
                            ...
                            public final void onClick(View view) {
                                ...
                                switch (i4) {
                                    case 0:
                                        ((AdapterView.OnItemClickListener) obj3)
                                                .onItemClick(null, null, 0, 0L);
                                        return;
                                    default:
                                        AutoFillUI.AnonymousClass3 anonymousClass32 =
                                                ((DialogFillUi) obj3).mCallback;
                                        anonymousClass32.log(5);
                                        synchronized (anonymousClass32.val$sessionLock) {
                                            PresentationStatsEventLogger
                                                    presentationStatsEventLogger =
                                                            anonymousClass32
                                                                    .val$presentationStatsEventLogger;
                                            if (presentationStatsEventLogger != null) {
                                                presentationStatsEventLogger.mEventInternal
                                                        .ifPresent(
                                                                new PresentationStatsEventLogger$$ExternalSyntheticLambda0(
                                                                        4));
                                            }
                                        }
                                        AutoFillUI.this.hideFillDialogUiThread(
                                                anonymousClass32.val$callback);
                                        ((Session) anonymousClass32.val$callback)
                                                .requestShowSoftInput(
                                                        anonymousClass32.val$focusedId);
                                        ((Session) anonymousClass32.val$callback)
                                                .requestFallbackFromFillDialog();
                                        return;
                                }
                            }
                        };
            ...
            itemsAdapter.new AnonymousClass1()
                    .filter(
                            this.mFilterText,
                            new Filter
                                    .FilterListener() { // from class:
                                ...
                                public final void onFilterComplete(int i4) {
                                    ...
                                    if (i4 <= 0) {
                                        if (Helper.sDebug) {
                                            ...
                                            DeviceIdleController$$ExternalSyntheticOutline0.m(
                                                    ...
                                                    "No dataset matches filter with ",
                                                    " chars",
                                                    "DialogFillUi");
                                        }
                                    ...
                                    if (itemsAdapter2.getCount()
                                            > dialogFillUi.mVisibleDatasetsMaxCount) {
                        ...
                        switch (i42) {
                            ...
                            default:
                                ...
                                AutoFillUI.this.hideFillDialogUiThread(
                                        anonymousClass32.val$callback);
                                ((Session) anonymousClass32.val$callback)
                                        .requestShowSoftInput(anonymousClass32.val$focusedId);
                                ((Session) anonymousClass32.val$callback)
                                        .requestFallbackFromFillDialog();
                                return;
                        }
        ...
        attributes.width =
                Math.min(
                        ...
                        this.mContext
                                .getResources()
                                .getDimensionPixelSize(R.dimen.button_bar_layout_start_padding));
        attributes.accessibilityTitle =
                this.mContext.getString(R.string.config_customAdbWifiNetworkConfirmationComponent);
        ...
        dialog.setOnShowListener(
                new DialogInterface
                    ...
                    public final void onShow(DialogInterface dialogInterface) {
                        ...
                        ((Session) AutoFillUI.this.mCallback)
                                .onShown(3, anonymousClass32.val$response.getDatasets().size());
                    }
                });
    ...
    public final void initialAuthenticationLayout(View view, final FillResponse fillResponse) {
        ...
        viewGroup.addView(
                sanitizeRemoteView.applyWithTheme(
                        this.mContext,
                        (ViewGroup) view,
                        new DialogFillUi$$ExternalSyntheticLambda5(this, 0),
                        this.mThemeId));
