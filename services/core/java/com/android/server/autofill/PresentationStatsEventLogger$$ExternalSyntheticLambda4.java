...
public final /* synthetic */ class PresentationStatsEventLogger$$ExternalSyntheticLambda4
        implements Consumer {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ Object f$0;

    public /* synthetic */ PresentationStatsEventLogger$$ExternalSyntheticLambda4(
            int i, Object obj) {
        this.$r8$classId = i;
        this.f$0 = obj;
    }
            ...
            case 0:
                ...
                if (autofillId.isVirtualInt()) {
                    presentationStatsEventInternal.mFocusedVirtualAutofillId =
                            autofillId.getVirtualChildIntId() % 100;
                    break;
                }
                break;
            case 1:
                ...
                PresentationStatsEventLogger.PresentationStatsEventInternal
                        presentationStatsEventInternal2 =
                                (PresentationStatsEventLogger.PresentationStatsEventInternal) obj;
                ArraySet arraySet = presentationStatsEventInternal2.mAutofillIdsAttemptedAutofill;
                if (arraySet != null) {
                    if (!arraySet.contains(autofillId2)) {
                        if (!presentationStatsEventInternal2.mAlreadyFilledAutofillIds.contains(
                                autofillId2)) {
                            Slog.w(
                                    "PresentationStatsEventLogger",
                                    "Successfully filled autofillId:"
                                            + autofillId2
                                            + " not found in list of attempted autofill ids: "
                                            + arraySet);
                            presentationStatsEventInternal2.mViewFilledButUnexpectedCount =
                                    presentationStatsEventInternal2.mViewFilledButUnexpectedCount
                                            + 1;
                            break;
                        ...
                        if (Helper.sVerbose) {
                            Slog.v(
                                    "PresentationStatsEventLogger",
                                    "Logging autofill for id:" + autofillId2);
                        }
                    ...
                    Slog.w(
                            "PresentationStatsEventLogger",
                            "Attempted autofill ids is null, but received autofillId:"
                                    + autofillId2
                                    + " successfully filled");
                    presentationStatsEventInternal2.mViewFilledButUnexpectedCount =
                            presentationStatsEventInternal2.mViewFilledButUnexpectedCount + 1;
                    break;
                }
                break;
            default:
                PresentationStatsEventLogger.PresentationStatsEventInternal
                        presentationStatsEventInternal3 =
                                (PresentationStatsEventLogger.PresentationStatsEventInternal) obj;
