...
public final class AutofillManagerServiceShellCommand extends ShellCommand {
    ...
    public final class AnonymousClass1 extends IResultReceiver.Stub {
        ...
        public /* synthetic */ AnonymousClass1(
                PrintWriter printWriter, CountDownLatch countDownLatch, int i) {
            this.$r8$classId = i;
    ...
    */
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.autofill.AutofillManagerServiceShellCommand.onCommand(java.lang.String):int");
    }
    ...
    public final void onHelp() {
        ...
        try {
            ...
            outPrintWriter.println("");
            outPrintWriter.println(
                    "  set temporary-detection-service USER_ID [COMPONENT_NAME DURATION]");
            outPrintWriter.println(
            ...
            outPrintWriter.println(
                    "    Checks whether the default augmented autofill service is enabled for the"
                        + " user.");
            outPrintWriter.println("");
    ...
    public final int requestGet(final PrintWriter printWriter) {
        ...
        switch (c) {
            case 0:
                ...
                autofillManagerService.enforceCallingPermissionForManagement();
                new FieldClassificationStrategy(autofillManagerService.getContext(), -2)
                        .calculateScores(
                                remoteCallback,
                                Arrays.asList(AutofillValue.forText(nextArgRequired2)),
                                new String[] {nextArgRequired3},
                                new String[] {null},
                                str,
                                null,
                                null,
                    ...
                    try {
                        AutofillManagerServiceImpl autofillManagerServiceImpl =
                                (AutofillManagerServiceImpl)
                                        autofillManagerService2.getServiceForUserLocked(
                                                nextIntArgRequired);
                        isPccClassificationEnabled =
                                autofillManagerServiceImpl != null
                                        ? autofillManagerServiceImpl.isPccClassificationEnabled()
                                        : false;
                    } finally {
                    }
                }
            ...
            case 4:
                ...
                AnonymousClass1 anonymousClass1 =
                        new AnonymousClass1(printWriter, countDownLatch2, i3);
                ...
                synchronized (autofillManagerService3.mLock) {
                    AutofillManagerServiceImpl autofillManagerServiceImpl2 =
                            (AutofillManagerServiceImpl)
                                    autofillManagerService3.peekServiceForUserLocked(
                                            nextIntArgRequired2);
                    if (autofillManagerServiceImpl2 != null) {
                        ...
                        Slog.v(
                                ...
                                "requestSavedPasswordCount(): no service for "
                                        + nextIntArgRequired2);
                    }
                }
                return 0;
            ...
            case 6:
                ...
                FrameworkResourcesServiceNameResolver frameworkResourcesServiceNameResolver =
                        autofillManagerService5.mAugmentedAutofillResolver;
                synchronized (frameworkResourcesServiceNameResolver.mLock) {
                    z2 =
                            !frameworkResourcesServiceNameResolver.mDefaultServicesDisabled.get(
                                    nextIntArgRequired3);
                }
