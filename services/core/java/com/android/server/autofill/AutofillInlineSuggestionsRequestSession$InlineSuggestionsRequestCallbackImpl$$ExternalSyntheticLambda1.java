...
class AutofillInlineSuggestionsRequestSession$InlineSuggestionsRequestCallbackImpl$$ExternalSyntheticLambda1
                    ...
                    try {
                        if (!autofillInlineSuggestionsRequestSession.mDestroyed
                            ...
                            if (inlineSuggestionsRequest != null
                                    && iInlineSuggestionsResponseCallback != null) {
                                autofillInlineSuggestionsRequestSession.mImeRequest =
                                        inlineSuggestionsRequest;
                                autofillInlineSuggestionsRequestSession.mResponseCallback =
                                        iInlineSuggestionsResponseCallback;
                                autofillInlineSuggestionsRequestSession
                                        .handleOnReceiveImeStatusUpdated(
                                                autofillInlineSuggestionsRequestSession.mAutofillId,
                                                true,
                                                false);
                            }
                            Consumer consumer =
                                    autofillInlineSuggestionsRequestSession.mImeRequestConsumer;
                            if (consumer != null) {
                                consumer.accept(
                                        autofillInlineSuggestionsRequestSession.mImeRequest);
