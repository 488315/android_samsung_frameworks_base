...
final class RemoteFieldClassificationService extends ServiceConnector.Impl {
    ...
    public static void m297$$Nest$mlogFieldClassificationEvent(
        ...
        if (fieldClassificationServiceCallbacks == null) {
            FieldClassificationEventLogger fieldClassificationEventLogger =
                    new FieldClassificationEventLogger();
            ...
            fieldClassificationEventLogger.mEventInternal.ifPresent(
                    new Consumer() { // from class:
                                     // com.android.server.autofill.FieldClassificationEventLogger$$ExternalSyntheticLambda3
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            ((FieldClassificationEventLogger.FieldClassificationEventInternal) obj)
            ...
            fieldClassificationEventLogger.mEventInternal.ifPresent(
                    new Consumer() { // from class:
                                     // com.android.server.autofill.FieldClassificationEventLogger$$ExternalSyntheticLambda7
            ...
            fieldClassificationEventLogger.mEventInternal.ifPresent(
                    new Consumer() { // from class:
                                     // com.android.server.autofill.FieldClassificationEventLogger$$ExternalSyntheticLambda0
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            int i3 = i2;
                            int i4 = i;
                            FieldClassificationEventLogger.FieldClassificationEventInternal
                                    fieldClassificationEventInternal =
                                            (FieldClassificationEventLogger
                                                            .FieldClassificationEventInternal)
                                                    obj;
                            switch (i3) {
                                case 0:
        ...
        FieldClassificationEventLogger fieldClassificationEventLogger2 =
                new FieldClassificationEventLogger();
        ...
        fieldClassificationEventLogger2.mEventInternal.ifPresent(
                new Consumer() { // from class:
                                 // com.android.server.autofill.FieldClassificationEventLogger$$ExternalSyntheticLambda3
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
        ...
        final int size =
                fieldClassificationResponse != null
                        ? fieldClassificationResponse.getClassifications().size()
                        : -1;
        final int i11 = 0;
        fieldClassificationEventLogger2.mEventInternal.ifPresent(
                new Consumer() { // from class:
    ...
    public RemoteFieldClassificationService(Context context, ComponentName componentName, int i) {
        super(
                ...
                0,
                i,
                new RemoteFieldClassificationService$$ExternalSyntheticLambda0());
        this.mComponentName = componentName;
        if (Helper.sDebug) {
            Slog.d(
                    "AutofillRemoteFieldClassificationService",
                    "About to connect to serviceName: " + componentName);
        }
        connect();
    }
    ...
    public final void onServiceConnectionStatusChanged(IInterface iInterface, boolean z) {
        IFieldClassificationService iFieldClassificationService =
                (IFieldClassificationService) iInterface;
        try {
            if (z) {
