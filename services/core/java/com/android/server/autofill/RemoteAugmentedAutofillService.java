...
final class RemoteAugmentedAutofillService extends ServiceConnector.Impl {
    ...
    public static void $r8$lambda$IXYPMbjPeMt7KfClcttRpU_yFvU(
        ...
        if (th instanceof CancellationException) {
            ...
            Handler.getMain()
                    .post(
                            new RemoteAugmentedAutofillService$$ExternalSyntheticLambda4(
                                    iCancellationSignal));
            return;
        }
        if (!(th instanceof TimeoutException)) {
            if (th != null) {
                Slog.e(
                        ...
                        "exception handling getAugmentedAutofillClient() for " + i + ": ",
                        th);
                return;
            }
            return;
        ...
        Slog.w(
                ...
                "PendingAutofillRequest timed out ("
                        + remoteAugmentedAutofillService.mRequestTimeoutMs
                        + "ms) for "
                        + remoteAugmentedAutofillService);
    ...
    public static void m296$$Nest$mmaybeRequestShowInlineSuggestions(
            RemoteAugmentedAutofillService remoteAugmentedAutofillService,
            final int i,
        ...
        synchronized (autofillManagerServiceImpl.mLock) {
            str = null;
            autofillManagerServiceImpl.mAugmentedAutofillEventHistory =
                    new FillEventHistory(i, null);
        }
                        ...
                        function.apply(
                                new InlineFillUi(
                                        ...
                                        InlineSuggestionFactory.createInlineSuggestions(
                                                ...
                                                list,
                                                new InlineFillUi
                                                        .InlineSuggestionUiCallback() { // from
                                                    // class:
                                                    ...
                                                    public final void authenticate() {
                                                        ...
                                                        Slog.e(
                                                                "RemoteAugmentedAutofillService",
                                                                "authenticate not implemented for"
                                                                    + " augmented autofill");
                                                    }

                                                    @Override // com.android.server.autofill.ui.InlineFillUi.InlineSuggestionUiCallback
                                                    public final void autofill(
                                                            Dataset dataset, int i3) {
                                                        boolean z = true;
                                                        if (dataset.getAuthentication() != null) {
                                                            ...
                                                            synchronized (
                                                                ...
                                                                try {
                                                                    FillEventHistory
                                                                            fillEventHistory =
                                                                                    autofillManagerServiceImpl2
                                                                                            .mAugmentedAutofillEventHistory;
                                                            ...
                                                            int makeAuthenticationId =
                                                                    AutofillManager
                                                                            .makeAuthenticationId(
                                                                                    1, i3);
                                                    ...
                                                    @Override // com.android.server.autofill.ui.InlineFillUi.InlineSuggestionUiCallback
                                                    public final void startIntentSender(
                                                ...
                                                false))))
                .booleanValue()) {
            AutofillManagerServiceImpl autofillManagerServiceImpl2 =
                    AutofillManagerServiceImpl.this;
            synchronized (autofillManagerServiceImpl2.mLock) {
                try {
                    FillEventHistory fillEventHistory =
                            autofillManagerServiceImpl2.mAugmentedAutofillEventHistory;
                    if (fillEventHistory != null && fillEventHistory.getSessionId() == i) {
                        autofillManagerServiceImpl2.mAugmentedAutofillEventHistory.addEvent(
                                new FillEventHistory.Event(
                                        5, null, bundle, null, null, null, null, null, null, null,
                                        null, 0, 2));
                    }
                } finally {
                }
    ...
    public RemoteAugmentedAutofillService(
            ...
            ComponentName componentName,
            int i2,
            AutofillManagerServiceImpl.AnonymousClass1 anonymousClass1,
            boolean z,
            int i3,
            int i4) {
        super(
                ...
                z ? 4194304 : 0,
                i2,
                new RemoteAugmentedAutofillService$$ExternalSyntheticLambda0());
    ...
    public final void onRequestAutofillLocked(
            final int i,
            final IAutoFillManagerClient iAutoFillManagerClient,
            final int i2,
            final ComponentName componentName,
            ...
            final Session.AugmentedAutofillInlineSuggestionsResponseCallback
                    augmentedAutofillInlineSuggestionsResponseCallback,
            final Session.AugmentedAutofillErrorCallback augmentedAutofillErrorCallback,
        ...
        postAsync(
                        new ServiceConnector.Job() { // from class:
                            ...
                            public final Object run(Object obj) {
                                final RemoteAugmentedAutofillService
                                        remoteAugmentedAutofillService =
                                                RemoteAugmentedAutofillService.this;
                                final IAutoFillManagerClient iAutoFillManagerClient2 =
                                        iAutoFillManagerClient;
                                final int i4 = i;
                                final int i5 = i2;
                                ...
                                final RemoteInlineSuggestionRenderService
                                        remoteInlineSuggestionRenderService2 =
                                                remoteInlineSuggestionRenderService;
                                final int i6 = i3;
                                ...
                                final Session.AugmentedAutofillInlineSuggestionsResponseCallback
                                        augmentedAutofillInlineSuggestionsResponseCallback2 =
                                                (Session
                                                                .AugmentedAutofillInlineSuggestionsResponseCallback)
                                                        function;
                                final Session.AugmentedAutofillErrorCallback
                                        augmentedAutofillErrorCallback2 =
                                                (Session.AugmentedAutofillErrorCallback) runnable;
                                iAutoFillManagerClient2.getAugmentedAutofillClient(
                                        new IResultReceiver.Stub() { // from class:
                                            // com.android.server.autofill.RemoteAugmentedAutofillService.1
                                                ...
                                                iAugmentedAutofillService.onFillRequest(
                                                        ...
                                                        new IFillCallback.Stub() { // from class:
                                                            ...
                                                            public final void onSuccess(
                                                                ...
                                                                RemoteAugmentedAutofillService
                                                                        .m296$$Nest$mmaybeRequestShowInlineSuggestions(
                                                                                RemoteAugmentedAutofillService
                                                                                        .this,
                                                                                i4,
                                                                                inlineSuggestionsRequest2,
                ...
                .whenComplete(
                        new BiConsumer() { // from class:
                            ...
                            public final void accept(Object obj, Object obj2) {
                                RemoteAugmentedAutofillService
                                        .$r8$lambda$IXYPMbjPeMt7KfClcttRpU_yFvU(
                                                RemoteAugmentedAutofillService.this,
                                                atomicReference,
                                                componentName,
                                                i,
    ...
    public final void onServiceConnectionStatusChanged(IInterface iInterface, boolean z) {
        IAugmentedAutofillService iAugmentedAutofillService =
                (IAugmentedAutofillService) iInterface;
        try {
            if (z) {
