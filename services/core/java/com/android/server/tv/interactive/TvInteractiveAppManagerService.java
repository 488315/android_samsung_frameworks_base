...
public class TvInteractiveAppManagerService extends SystemService {
        ...
        while (it.hasNext()) {
            ...
            if ("android.permission.BIND_TV_INTERACTIVE_APP".equals(serviceInfo.permission)) {
                try {
                    ...
                    Slogf.m91e("TvInteractiveAppManagerService", "failed to load TV Interactive App service " + serviceInfo.name, e);
                }
            } else {
    ...
    public final int getInteractiveAppUid(TvInteractiveAppServiceInfo tvInteractiveAppServiceInfo) {
        try {
            ...
            Slogf.m103w("TvInteractiveAppManagerService", "Unable to get UID for  " + tvInteractiveAppServiceInfo, e);
            return -1;
        }
    }
        ...
        public void registerAppLinkInfo(String str, AppLinkInfo appLinkInfo, int i) {
            ...
            try {
                ...
                synchronized (TvInteractiveAppManagerService.this.mLock) {
                    ...
                    if (tvInteractiveAppState == null) {
                        Slogf.m90e("TvInteractiveAppManagerService", "failed to registerAppLinkInfo - unknown TIAS id " + str);
                        return;
                    }
        ...
        public void unregisterAppLinkInfo(String str, AppLinkInfo appLinkInfo, int i) {
            ...
            try {
                ...
                synchronized (TvInteractiveAppManagerService.this.mLock) {
                    ...
                    TvInteractiveAppState tvInteractiveAppState = (TvInteractiveAppState) orCreateUserStateLocked.mIAppMap.get(str);
                    if (tvInteractiveAppState == null) {
                        Slogf.m90e("TvInteractiveAppManagerService", "failed to unregisterAppLinkInfo - unknown TIAS id " + str);
                        return;
                    }
                    ComponentName component = tvInteractiveAppState.mInfo.getComponent();
                    ServiceState serviceState = (ServiceState) orCreateUserStateLocked.mServiceStateMap.get(component);
        ...
        public void sendAppLinkCommand(String str, Bundle bundle, int i) {
            ...
            try {
                ...
                synchronized (TvInteractiveAppManagerService.this.mLock) {
                    ...
                    TvInteractiveAppState tvInteractiveAppState = (TvInteractiveAppState) orCreateUserStateLocked.mIAppMap.get(str);
                    if (tvInteractiveAppState == null) {
                        Slogf.m90e("TvInteractiveAppManagerService", "failed to sendAppLinkCommand - unknown TIAS id " + str);
                        return;
                    }
                    ComponentName component = tvInteractiveAppState.mInfo.getComponent();
                    ServiceState serviceState = (ServiceState) orCreateUserStateLocked.mServiceStateMap.get(component);
                ...
                try {
                    synchronized (TvInteractiveAppManagerService.this.mLock) {
                        try {
                            ...
                            TvInteractiveAppState tvInteractiveAppState = (TvInteractiveAppState) orCreateUserStateLocked.mIAppMap.get(str);
                            if (tvInteractiveAppState == null) {
                                Slogf.m102w("TvInteractiveAppManagerService", "Failed to find state for iAppServiceId=" + str);
                                TvInteractiveAppManagerService.this.sendSessionTokenToClientLocked(iTvInteractiveAppClient, str, null, null, i2);
                                Binder.restoreCallingIdentity(clearCallingIdentity);
                                return;
                            }
            ...
            try {
                synchronized (TvInteractiveAppManagerService.this.mLock) {
                    try {
                        ...
                        Slogf.m91e("TvInteractiveAppManagerService", "error in notifyTimeShiftPlaybackParams", e);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            ...
            try {
                synchronized (TvInteractiveAppManagerService.this.mLock) {
                    try {
                        ...
                        Slogf.m91e("TvInteractiveAppManagerService", "error in notifyTimeShiftStatusChanged", e);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            ...
            try {
                synchronized (TvInteractiveAppManagerService.this.mLock) {
                    try {
                        ...
                        Slogf.m91e("TvInteractiveAppManagerService", "error in notifyTimeShiftStartPositionChanged", e);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            ...
            try {
                synchronized (TvInteractiveAppManagerService.this.mLock) {
                    try {
                        ...
                        Slogf.m91e("TvInteractiveAppManagerService", "error in notifyTimeShiftCurrentPositionChanged", e);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            ...
            try {
                synchronized (TvInteractiveAppManagerService.this.mLock) {
                    try {
                        ...
                        Slogf.m91e("TvInteractiveAppManagerService", "error in notifyRecordingConnectionFailed", e);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    */
    ...
    public final void removeSessionStateLocked(IBinder iBinder, int i) {
        ...
        if (sessionState == null) {
            Slogf.m90e("TvInteractiveAppManagerService", "sessionState null, no more remove session action!");
            return;
        }
                ...
                if (clientState != null) {
                    while (clientState.mSessionTokens.size() > 0) {
                        ...
                        if (clientState.mSessionTokens.contains(iBinder)) {
                            Slogf.m86d("TvInteractiveAppManagerService", "remove sessionToken " + iBinder + " for " + this.mClientToken);
                            clientState.mSessionTokens.remove(iBinder);
                        }
                    }
                }
    ...
    public final class InteractiveAppServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            synchronized (TvInteractiveAppManagerService.this.mLock) {
                ...
                if (serviceState.mCallback == null) {
                    serviceState.mCallback = TvInteractiveAppManagerService.this.new ServiceCallback(this.mComponent, this.mUserId);
                    try {
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            try {
                                ...
                                Slogf.m91e("TvInteractiveAppManagerService", "error in notifyAppLinkInfo(" + pair + ") when onServiceConnected", e2);
                            }
                        } finally {
                        }
                    }
                    ...
                    while (it2.hasNext()) {
                        ...
                        try {
                            try {
                                ...
                                Slogf.m91e("TvInteractiveAppManagerService", "error in sendAppLinkCommand(" + bundle + ") when onServiceConnected", e3);
                            }
                        } finally {
                        }
                    }
