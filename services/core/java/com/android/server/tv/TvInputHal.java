...
final class TvInputHal implements Handler.Callback {
  ...
  public int addOrUpdateStream(int i, Surface surface, TvStreamConfig tvStreamConfig) {
    synchronized (this.mLock) {
      ...
      return nativeAddOrUpdateStream(this.mPtr, i, tvStreamConfig.getStreamId(), surface) == 0
          ? 0
          : -3;
    }
  }
  ...
  public int setTvMessageEnabled(int i, TvStreamConfig tvStreamConfig, int i2, boolean z) {
    synchronized (this.mLock) {
      ...
      return nativeSetTvMessageEnabled(this.mPtr, i, tvStreamConfig.getStreamId(), i2, z) == 0
          ? 0
          : -3;
    }
  }
  ...
  public boolean handleMessage(Message message) {
    ...
    if (i == 1) {
      ...
      synchronized (this.mLock) {
        ...
        tvStreamConfigArr =
            (TvStreamConfig[]) this.mStreamConfigs.get(tvInputHardwareInfo.getDeviceId());
      }
