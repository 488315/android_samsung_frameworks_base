...
public final class TvInputManagerService extends SystemService {
  ...
  public TvInputManagerService(Context context) {
    ...
    this.mWatchLogHandler =
        new WatchLogHandler(context.getContentResolver(), IoThread.get().getLooper());
  ...
  public final void registerBroadcastReceivers() {
    new PackageMonitor() { // from class: com.android.server.tv.TvInputManagerService.1
      ...
      public final void buildTvInputList(String[] strArr) {
        ...
        synchronized (TvInputManagerService.this.mLock) {
          if (TvInputManagerService.this.mCurrentUserId == changingUserId
              || TvInputManagerService.this.mRunningProfiles.contains(
                  Integer.valueOf(changingUserId))) {
    ...
    this.mContext.registerReceiverAsUser(
        new BroadcastReceiver() { // from class: com.android.server.tv.TvInputManagerService.2
          ...
          public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.USER_REMOVED".equals(action)) {
              TvInputManagerService.this.removeUser(
                  intent.getIntExtra("android.intent.extra.user_handle", 0));
              return;
            }
            if ("android.intent.action.USER_STARTED".equals(action)) {
              TvInputManagerService.this.startUser(
                  intent.getIntExtra("android.intent.extra.user_handle", 0));
            } else if ("android.intent.action.USER_STOPPED".equals(action)) {
              TvInputManagerService.this.stopUser(
                  intent.getIntExtra("android.intent.extra.user_handle", 0));
            }
          }
        },
  ...
  public static boolean hasHardwarePermission(
      PackageManager packageManager, ComponentName componentName) {
    return packageManager.checkPermission(
            "android.permission.TV_INPUT_HARDWARE", componentName.getPackageName())
        == 0;
  }
      ...
      if ("android.permission.BIND_TV_INPUT".equals(serviceInfo.permission)) {
        ...
        if (hasHardwarePermission(packageManager, componentName)) {
          ...
          ServiceState serviceState =
              (ServiceState) orCreateUserStateLocked.serviceStateMap.get(componentName);
          if (serviceState == null) {
            orCreateUserStateLocked.serviceStateMap.put(
                componentName, new ServiceState(componentName, i));
    ...
    Collections.sort(
        ...
        Comparator.comparing(
            new Function() { // from class:
                             // com.android.server.tv.TvInputManagerService$$ExternalSyntheticLambda0
    ...
    for (String str2 : orCreateUserStateLocked.inputMap.keySet()) {
      if (!hashMap.containsKey(str2)) {
        ServiceState serviceState2 =
            (ServiceState)
                orCreateUserStateLocked.serviceStateMap.get(
    ...
    Iterator<ResolveInfo> it =
        this.mContext
            ...
            .queryBroadcastReceivers(
                new Intent("android.media.tv.action.QUERY_CONTENT_RATING_SYSTEMS"), 128)
            .iterator();
    while (it.hasNext()) {
      ...
      if (bundle != null) {
        ...
        if (i2 == 0) {
          Slog.w(
              "TvInputManagerService",
              "Missing meta-data 'android.media.tv.metadata.CONTENT_RATING_SYSTEMS' on receiver "
                  + activityInfo.packageName
                  + "/"
                  + activityInfo.name);
        } else {
          orCreateUserStateLocked.contentRatingSystemList.add(
    ...
    synchronized (this.mLock) {
      if (i != this.mCurrentUserId && !this.mRunningProfiles.contains(Integer.valueOf(i))) {
        ...
        if (userInfo.isProfile()
            && profileParent != null
            && profileParent.id == this.mCurrentUserId) {
  ...
  public final void unbindServiceOfUserLocked(int i) {
    ...
    while (it.hasNext()) {
      ServiceState serviceState =
          (ServiceState) userStateLocked.serviceStateMap.get((ComponentName) it.next());
  ...
  public final void clearSessionAndNotifyClientLocked(SessionState sessionState) {
    ...
    for (SessionState sessionState2 :
        getOrCreateUserStateLocked(sessionState.userId).sessionStateMap.values()) {
  ...
  public final ServiceState getServiceStateLocked(ComponentName componentName, int i) {
    ServiceState serviceState =
        (ServiceState) getOrCreateUserStateLocked(i).serviceStateMap.get(componentName);
    if (serviceState != null) {
      return serviceState;
    }
    ...
    if (serviceState.service == null && z) {
      ...
      serviceState.bound =
          this.mContext.bindServiceAsUser(
              new Intent("android.media.tv.TvInputService").setComponent(componentName),
  ...
  public final void abortPendingCreateSessionRequestsLocked(
    ...
    while (it.hasNext()) {
      SessionState sessionState =
          (SessionState) orCreateUserStateLocked.sessionStateMap.get((IBinder) it.next());
  ...
  public final boolean createSessionInternalLocked(
      ITvInputService iTvInputService, IBinder iBinder, int i) {
    boolean z;
    SessionState sessionState =
        (SessionState) getOrCreateUserStateLocked(i).sessionStateMap.get(iBinder);
  ...
  public final void sendSessionTokenToClientLocked(
  ...
  */
  ...
  public final void removeSessionStateLocked(IBinder iBinder, int i) {
    ...
    SessionState sessionState =
        (SessionState) orCreateUserStateLocked.sessionStateMap.remove(iBinder);
    if (sessionState == null) {
      Slog.e("TvInputManagerService", "sessionState null, no more remove session action!");
      return;
    }
    ClientState clientState =
        (ClientState) orCreateUserStateLocked.clientStateMap.get(sessionState.client.asBinder());
    if (clientState != null) {
    ...
    ServiceState serviceState =
        (ServiceState) orCreateUserStateLocked.serviceStateMap.get(sessionState.componentName);
    if (serviceState != null) {
  ...
  public final void setMainLocked(IBinder iBinder, boolean z, int i, int i2) {
    try {
      ...
      if (sessionStateLocked.hardwareSessionToken != null) {
        sessionStateLocked =
            getSessionStateLocked(sessionStateLocked.hardwareSessionToken, 1000, i2);
      }
  ...
  public final void notifyInputStateChangedLocked(
      UserState userState, String str, int i, ITvInputManagerCallback iTvInputManagerCallback) {
  ...
  public final void setStateLocked(String str, int i, int i2) {
    ...
    ServiceState serviceState =
        (ServiceState)
            orCreateUserStateLocked.serviceStateMap.get(tvInputState.info.getComponent());
  ...
  public final class BinderService extends ITvInputManager.Stub {
    ...
    public List getTvInputList(int i) {
      ArrayList arrayList;
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "getTvInputList");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
              TvInputManagerService.this.getOrCreateUserStateLocked(resolveCallingUserId);
    ...
    public TvInputInfo getTvInputInfo(String str, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "getTvInputInfo");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          TvInputState tvInputState =
              (TvInputState)
                  TvInputManagerService.this
                      .getOrCreateUserStateLocked(resolveCallingUserId)
                      .inputMap
                      .get(str);
    ...
    public void updateTvInputInfo(TvInputInfo tvInputInfo, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "updateTvInputInfo");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          TvInputManagerService.this.updateTvInputInfoLocked(
              TvInputManagerService.this.getOrCreateUserStateLocked(resolveCallingUserId),
              tvInputInfo);
        }
      } finally {
    ...
    public int getTvInputState(String str, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "getTvInputState");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          TvInputState tvInputState =
    ...
    public List getAvailableExtensionInterfaceNames(String str, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              callingPid, callingUid, i, "getAvailableExtensionInterfaceNames");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
          ...
          iTvInputService =
              (tvInputState == null
                      || (serviceState =
                              (ServiceState)
                                  orCreateUserStateLocked.serviceStateMap.get(
                                      tvInputState.info.getComponent()))
                          == null
        ...
        if (iTvInputService != null) {
          try {
            ...
            Slog.e(
                "TvInputManagerService",
                "error in getAvailableExtensionInterfaceNames or getExtensionInterfacePermission",
                e);
          }
        }
    ...
    public IBinder getExtensionInterface(String str, String str2, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              callingPid, callingUid, i, "getExtensionInterface");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
    ...
    public List getTvContentRatingSystemList(int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "getTvContentRatingSystemList");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          list =
    ...
    public void sendTvInputNotifyIntent(Intent intent, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "sendTvInputNotifyIntent");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        TvInputManagerService.this
            .getContext()
            .sendBroadcastAsUser(intent, new UserHandle(resolveCallingUserId));
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
    ...
    public void registerCallback(ITvInputManagerCallback iTvInputManagerCallback, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              callingPid, callingUid, i, "registerCallback");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
          ...
          if (!orCreateUserStateLocked.mCallbacks.register(iTvInputManagerCallback)) {
            ...
            orCreateUserStateLocked.callbackPidUidMap.put(
                iTvInputManagerCallback,
                Pair.create(Integer.valueOf(callingPid), Integer.valueOf(callingUid)));
          }
        }
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public void unregisterCallback(ITvInputManagerCallback iTvInputManagerCallback, int i) {
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "unregisterCallback");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
    ...
    public boolean isParentalControlsEnabled(int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "isParentalControlsEnabled");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
    ...
    public void setParentalControlsEnabled(boolean z, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "setParentalControlsEnabled");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          TvInputManagerService.this
    ...
    public boolean isRatingBlocked(String str, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "isRatingBlocked");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          isRatingBlocked =
              TvInputManagerService.this
                  .getOrCreateUserStateLocked(resolveCallingUserId)
                  .persistentDataStore
                  .isRatingBlocked(TvContentRating.unflattenFromString(str));
        }
    ...
    public List getBlockedRatings(int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "getBlockedRatings");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
          ...
          for (TvContentRating tvContentRating :
              orCreateUserStateLocked.persistentDataStore.getBlockedRatings()) {
    ...
    public void addBlockedRating(String str, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "addBlockedRating");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          TvInputManagerService.this
              .getOrCreateUserStateLocked(resolveCallingUserId)
              .persistentDataStore
              .addBlockedRating(TvContentRating.unflattenFromString(str));
        }
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    ...
    public void removeBlockedRating(String str, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "removeBlockedRating");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          TvInputManagerService.this
              .getOrCreateUserStateLocked(resolveCallingUserId)
              .persistentDataStore
              .removeBlockedRating(TvContentRating.unflattenFromString(str));
        }
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    ...
    public void createSession(
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              callingPid, callingUid, i2, "createSession");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      String uuid = UUID.randomUUID().toString();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          if (i2 != TvInputManagerService.this.mCurrentUserId
              && !TvInputManagerService.this.mRunningProfiles.contains(Integer.valueOf(i2))
              && !z) {
            TvInputManagerService.this.sendSessionTokenToClientLocked(
          ...
          ServiceState serviceState =
              (ServiceState)
                  orCreateUserStateLocked.serviceStateMap.get(tvInputInfo.getComponent());
          if (serviceState == null) {
            int i3 =
                PackageManager.getApplicationInfoAsUserCached(
                        tvInputInfo.getComponent().getPackageName(), 0L, resolveCallingUserId)
                    .uid;
          ...
          if (serviceState2.service == null) {
            TvInputManagerService.this.updateServiceConnectionLocked(
                tvInputInfo.getComponent(), resolveCallingUserId);
          } else if (!TvInputManagerService.this.createSessionInternalLocked(
              serviceState2.service, binder, resolveCallingUserId)) {
    ...
    public void releaseSession(IBinder iBinder, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "releaseSession");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          releaseSessionLocked =
              TvInputManagerService.this.releaseSessionLocked(
                  iBinder, callingUid, resolveCallingUserId);
          userStateLocked = TvInputManagerService.this.getUserStateLocked(i);
        }
        if (releaseSessionLocked != null) {
          TvInputManagerService.this.logTuneStateChanged(
              4,
              releaseSessionLocked,
              TvInputManagerService.getTvInputState(releaseSessionLocked, userStateLocked));
        }
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    ...
    public void setMainSession(IBinder iBinder, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "setMainSession");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
    ...
    */
    public void setSurface(IBinder iBinder, Surface surface, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "setSurface");
      long clearCallingIdentity = Binder.clearCallingIdentity();
            ...
            try {
              ...
              try {
                ...
                if (sessionState.hardwareSessionToken == null) {
                  ...
                  TvInputManagerService.this
                      .getSessionLocked(
                          sessionState.hardwareSessionToken, 1000, resolveCallingUserId)
                      .setSurface(surface);
                }
              ...
              try {
                ...
                if (0 != 0) {
                  TvInputManagerService.this.logTuneStateChanged(
                      surface != null ? 2 : 3,
                      null,
                      TvInputManagerService.getTvInputState(null, i));
                }
                Binder.restoreCallingIdentity(clearCallingIdentity);
                throw th;
              }
    ...
    public void dispatchSurfaceChanged(IBinder iBinder, int i, int i2, int i3, int i4) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i4, "dispatchSurfaceChanged");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
            SessionState sessionStateLocked =
                TvInputManagerService.this.getSessionStateLocked(
                    iBinder, callingUid, resolveCallingUserId);
            TvInputManagerService.this
                .getSessionLocked(sessionStateLocked)
                .dispatchSurfaceChanged(i, i2, i3);
            if (sessionStateLocked.hardwareSessionToken != null) {
              TvInputManagerService.this
                  .getSessionLocked(
                      sessionStateLocked.hardwareSessionToken, 1000, resolveCallingUserId)
                  .dispatchSurfaceChanged(i, i2, i3);
            }
          } catch (RemoteException | SessionNotFoundException e) {
    ...
    public void setVolume(IBinder iBinder, float f, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "setVolume");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
            ...
            if (sessionStateLocked.hardwareSessionToken != null) {
              ITvInputSession sessionLocked =
                  TvInputManagerService.this.getSessionLocked(
                      sessionStateLocked.hardwareSessionToken, 1000, resolveCallingUserId);
    ...
    public void tune(IBinder iBinder, Uri uri, Bundle bundle, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "tune");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
            TvInputManagerService.this
                .getSessionLocked(iBinder, callingUid, resolveCallingUserId)
                .tune(uri, bundle);
            orCreateUserStateLocked =
                TvInputManagerService.this.getOrCreateUserStateLocked(resolveCallingUserId);
            sessionStateLocked =
                TvInputManagerService.this.getSessionStateLocked(
                    iBinder, callingUid, orCreateUserStateLocked);
            if (!sessionStateLocked.isCurrent
                || !Objects.equals(sessionStateLocked.currentChannel, uri)) {
          ...
          TvInputManagerService.this.logTuneStateChanged(
              5,
              sessionStateLocked,
              TvInputManagerService.getTvInputState(sessionStateLocked, orCreateUserStateLocked));
          SomeArgs obtain = SomeArgs.obtain();
    ...
    public void unblockContent(IBinder iBinder, String str, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "unblockContent");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void setCaptionEnabled(IBinder iBinder, boolean z, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "setCaptionEnabled");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void selectAudioPresentation(IBinder iBinder, int i, int i2, int i3) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i3, "selectAudioPresentation");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void selectTrack(IBinder iBinder, int i, String str, int i2) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i2, "selectTrack");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void setInteractiveAppNotificationEnabled(IBinder iBinder, boolean z, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "setInteractiveAppNotificationEnabled");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void sendAppPrivateCommand(IBinder iBinder, String str, Bundle bundle, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "sendAppPrivateCommand");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void createOverlayView(IBinder iBinder, IBinder iBinder2, Rect rect, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "createOverlayView");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void relayoutOverlayView(IBinder iBinder, Rect rect, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "relayoutOverlayView");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void removeOverlayView(IBinder iBinder, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "removeOverlayView");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void timeShiftPlay(IBinder iBinder, Uri uri, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "timeShiftPlay");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void timeShiftPause(IBinder iBinder, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "timeShiftPause");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void timeShiftResume(IBinder iBinder, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "timeShiftResume");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void timeShiftSeekTo(IBinder iBinder, long j, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "timeShiftSeekTo");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void timeShiftSetPlaybackParams(IBinder iBinder, PlaybackParams playbackParams, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "timeShiftSetPlaybackParams");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void timeShiftSetMode(IBinder iBinder, int i, int i2) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i2, "timeShiftSetMode");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void timeShiftEnablePositionTracking(IBinder iBinder, boolean z, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "timeShiftEnablePositionTracking");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void notifyTvMessage(IBinder iBinder, int i, Bundle bundle, int i2) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i2, "notifyTvmessage");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void setTvMessageEnabled(IBinder iBinder, int i, boolean z, int i2) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i2, "setTvMessageEnabled");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
            TvInputManagerService.this.mTvInputHardwareManager.setTvMessageEnabled(
                TvInputManagerService.this.getSessionStateLocked(iBinder, callingUid, i2).inputId,
                i,
                z);
            TvInputManagerService.this
                .getSessionLocked(iBinder, callingUid, resolveCallingUserId)
    ...
    public void startRecording(IBinder iBinder, Uri uri, Bundle bundle, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "startRecording");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void stopRecording(IBinder iBinder, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "stopRecording");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void pauseRecording(IBinder iBinder, Bundle bundle, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "pauseRecording");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void resumeRecording(IBinder iBinder, Bundle bundle, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "resumeRecording");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public ITvInputHardware acquireTvInputHardware(
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i2, "acquireTvInputHardware");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        return TvInputManagerService.this.mTvInputHardwareManager.acquireHardware(
            i, iTvInputHardwareCallback, tvInputInfo, callingUid, resolveCallingUserId, str, i3);
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
    ...
    public void releaseTvInputHardware(int i, ITvInputHardware iTvInputHardware, int i2) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i2, "releaseTvInputHardware");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        TvInputManagerService.this.mTvInputHardwareManager.releaseHardware(
            i, iTvInputHardware, callingUid, resolveCallingUserId);
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
        ...
        for (String str2 : file.list()) {
          ...
          if (matcher2.find()) {
            ...
            for (int i = 0; i < length; i++) {
              Matcher matcher3 =
                  TvInputManagerService.sFrontEndInAdapterDirPattern.matcher(list[i]);
              if (matcher3.find()) {
      ...
      try {
        ...
        try {
          ParcelFileDescriptor open =
              ParcelFileDescriptor.open(new File(format), 2 == i ? 805306368 : 268435456);
          Binder.restoreCallingIdentity(clearCallingIdentity);
          return open;
    ...
    public List getAvailableTvStreamConfigList(String str, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "getAvailableTvStreamConfigList");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        return TvInputManagerService.this.mTvInputHardwareManager.getAvailableTvStreamConfigList(
            str, callingUid, resolveCallingUserId);
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
    ...
    public boolean captureFrame(String str, Surface surface, TvStreamConfig tvStreamConfig, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "captureFrame");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
          ...
          while (true) {
            ...
            if (sessionState.inputId.equals(str) && sessionState.hardwareSessionToken != null) {
              str2 =
                  ((SessionState)
                          orCreateUserStateLocked.sessionStateMap.get(
                              sessionState.hardwareSessionToken))
                      .inputId;
              break;
            }
          }
          return TvInputManagerService.this.mTvInputHardwareManager.captureFrame(
              str2 != null ? str2 : str, surface, tvStreamConfig, callingUid, resolveCallingUserId);
        }
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    ...
    public boolean isSingleSessionActive(int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "isSingleSessionActive");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          UserState orCreateUserStateLocked =
          ...
          SessionState[] sessionStateArr =
              (SessionState[])
                  orCreateUserStateLocked.sessionStateMap.values().toArray(new SessionState[2]);
    ...
    public void requestChannelBrowsable(Uri uri, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), Binder.getCallingUid(), i, "requestChannelBrowsable");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
    ...
    public void requestBroadcastInfo(
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "requestBroadcastInfo");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void removeBroadcastInfo(IBinder iBinder, int i, int i2) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i2, "removeBroadcastInfo");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void requestAd(IBinder iBinder, AdRequest adRequest, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "requestAd");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        synchronized (TvInputManagerService.this.mLock) {
          try {
    ...
    public void notifyAdBufferReady(IBinder iBinder, AdBuffer adBuffer, int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              Binder.getCallingPid(), callingUid, i, "notifyAdBuffer");
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        try {
          synchronized (TvInputManagerService.this.mLock) {
    ...
    public int getClientPriority(int i, String str) {
      ...
      int clientPriority =
          ((TunerResourceManager)
                  TvInputManagerService.this.mContext.getSystemService("tv_tuner_resource_mgr"))
    ...
    public List getCurrentTunedInfos(int i) {
      ...
      int resolveCallingUserId =
          TvInputManagerService.this.resolveCallingUserId(
              callingPid, callingUid, i, "getTvCurrentChannelInfos");
      synchronized (TvInputManagerService.this.mLock) {
    ...
    public final int getClientPidLocked(String str) {
      ...
      return ((SessionState) TvInputManagerService.this.mSessionIdToSessionStateMap.get(str))
          .callingPid;
    }
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      ...
      if (DumpUtils.checkDumpPermission(
          TvInputManagerService.this.mContext, "TvInputManagerService", indentingPrintWriter)) {
        synchronized (TvInputManagerService.this.mLock) {
          indentingPrintWriter.println(
              "User Ids (Current user: " + TvInputManagerService.this.mCurrentUserId + "):");
          indentingPrintWriter.increaseIndent();
          for (int i = 0; i < TvInputManagerService.this.mUserStates.size(); i++) {
            indentingPrintWriter.println(
                Integer.valueOf(TvInputManagerService.this.mUserStates.keyAt(i)));
          }
          ...
          for (int i2 = 0; i2 < TvInputManagerService.this.mUserStates.size(); i2++) {
            ...
            for (Map.Entry entry4 : orCreateUserStateLocked.sessionStateMap.entrySet()) {
              ...
              indentingPrintWriter.println(
                  "hardwareSessionToken: " + sessionState.hardwareSessionToken);
              indentingPrintWriter.decreaseIndent();
            }
            indentingPrintWriter.decreaseIndent();
            ...
            for (int i3 = 0; i3 < beginBroadcast; i3++) {
              indentingPrintWriter.println(
                  orCreateUserStateLocked.mCallbacks.getRegisteredCallbackItem(i3));
            }
            orCreateUserStateLocked.mCallbacks.finishBroadcast();
            indentingPrintWriter.decreaseIndent();
            indentingPrintWriter.println(
                "mainSessionToken: " + orCreateUserStateLocked.mainSessionToken);
            indentingPrintWriter.decreaseIndent();
          }
        }
        TvInputManagerService.this.mTvInputHardwareManager.dump(
    ...
    for (SessionState sessionState : userState.sessionStateMap.values()) {
      if (sessionState.isCurrent) {
        ...
        arrayList.add(
            new TunedInfo(
                sessionState.inputId,
                hasAccessWatchedProgramsPermission ? sessionState.currentChannel : null,
  ...
  public final boolean hasAccessWatchedProgramsPermission(int i, int i2) {
    return this.mContext.checkPermission(
            "com.android.providers.tv.permission.ACCESS_WATCHED_PROGRAMS", i, i2)
        == 0;
  }
  ...
  public final void logTuneStateChanged(
      int i, SessionState sessionState, TvInputState tvInputState) {
    int i2;
    int i3;
    int i4;
    int i5;
    ...
    FrameworkStatsLog.write(
        FrameworkStatsLog.TIF_TUNE_CHANGED,
        ...
        if (clientState != null) {
          while (clientState.sessionTokens.size() > 0) {
            ...
            if (clientState.sessionTokens.contains(iBinder)) {
              Slog.d(
                  "TvInputManagerService",
                  "remove sessionToken " + iBinder + " for " + this.clientToken);
              clientState.sessionTokens.remove(iBinder);
            }
          }
        }
  ...
  public final class ServiceState {
    ...
    public ServiceState(ComponentName componentName, int i) {
      ...
      this.isHardware =
          TvInputManagerService.hasHardwarePermission(
              TvInputManagerService.this.mContext.getPackageManager(), componentName);
    }
  }
  ...
  public final class InputServiceConnection implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      synchronized (TvInputManagerService.this.mLock) {
        ...
        ServiceState serviceState =
            (ServiceState) userStateLocked.serviceStateMap.get(this.mComponent);
        ...
        if (serviceState.isHardware && serviceState.callback == null) {
          serviceState.callback =
              TvInputManagerService.this.new ServiceCallback(this.mComponent, this.mUserId);
          try {
        ...
        for (IBinder iBinder2 : serviceState.sessionTokens) {
          if (!TvInputManagerService.this.createSessionInternalLocked(
              serviceState.service, iBinder2, this.mUserId)) {
        ...
        for (TvInputState tvInputState : userStateLocked.inputMap.values()) {
          if (tvInputState.info.getComponent().equals(componentName) && tvInputState.state != 0) {
            TvInputManagerService.this.notifyInputStateChangedLocked(
                userStateLocked, tvInputState.info.getId(), tvInputState.state, null);
          }
        }
        if (serviceState.isHardware) {
          serviceState.hardwareInputMap.clear();
          Iterator it2 =
              TvInputManagerService.this.mTvInputHardwareManager.getHardwareList().iterator();
          while (it2.hasNext()) {
            try {
          ...
          Iterator it3 =
              TvInputManagerService.this.mTvInputHardwareManager.getHdmiDeviceList().iterator();
          while (it3.hasNext()) {
            try {
    ...
    public void onServiceDisconnected(ComponentName componentName) {
      ...
      synchronized (TvInputManagerService.this.mLock) {
        ServiceState serviceState =
            (ServiceState)
                TvInputManagerService.this
                    .getOrCreateUserStateLocked(this.mUserId)
                    .serviceStateMap
                    .get(this.mComponent);
        if (serviceState != null) {
  ...
  public final class ServiceCallback extends ITvInputServiceCallback.Stub {
    ...
    public final void addHardwareInputLocked(TvInputInfo tvInputInfo) {
      TvInputManagerService.this
          .getServiceStateLocked(this.mComponent, this.mUserId)
          .hardwareInputMap
  ...
  public final class SessionCallback extends ITvInputSessionCallback.Stub {
    ...
    public void onSessionCreated(ITvInputSession iTvInputSession, IBinder iBinder) {
      synchronized (TvInputManagerService.this.mLock) {
        ...
        if (iTvInputSession != null && addSessionTokenToClientStateLocked(iTvInputSession)) {
          TvInputManagerService.this.sendSessionTokenToClientLocked(
              this.mSessionState.client,
              this.mSessionState.inputId,
              this.mSessionState.sessionToken,
              this.mChannels[0],
              this.mSessionState.seq);
        } else {
          TvInputManagerService.this.removeSessionStateLocked(
              this.mSessionState.sessionToken, this.mSessionState.userId);
          TvInputManagerService.this.sendSessionTokenToClientLocked(
              this.mSessionState.client,
              this.mSessionState.inputId,
              null,
    ...
    public final boolean addSessionTokenToClientStateLocked(ITvInputSession iTvInputSession) {
      try {
        ...
        UserState orCreateUserStateLocked =
            TvInputManagerService.this.getOrCreateUserStateLocked(this.mSessionState.userId);
        ClientState clientState =
            (ClientState) orCreateUserStateLocked.clientStateMap.get(asBinder);
        if (clientState == null) {
          clientState =
              TvInputManagerService.this.new ClientState(asBinder, this.mSessionState.userId);
          try {
      ...
      synchronized (TvInputManagerService.this.mLock) {
        ...
        try {
          ...
          if (!this.mSessionState.isCurrent
              || !Objects.equals(this.mSessionState.currentChannel, uri)) {
            UserState orCreateUserStateLocked =
                TvInputManagerService.this.getOrCreateUserStateLocked(this.mSessionState.userId);
    ...
    public void onVideoAvailable() {
      synchronized (TvInputManagerService.this.mLock) {
        if (this.mSessionState.session != null && this.mSessionState.client != null) {
          ...
          TvInputState tvInputState =
              TvInputManagerService.getTvInputState(
                  sessionState,
                  tvInputManagerService.getUserStateLocked(tvInputManagerService.mCurrentUserId));
          try {
    ...
    public void onBroadcastInfoResponse(BroadcastInfoResponse broadcastInfoResponse) {
      synchronized (TvInputManagerService.this.mLock) {
        ...
        try {
          this.mSessionState.client.onBroadcastInfoResponse(
              broadcastInfoResponse, this.mSessionState.seq);
        } catch (RemoteException e) {
  ...
  public final class HardwareListener implements TvInputHardwareManager.Listener {
    ...
    public void onHardwareDeviceAdded(TvInputHardwareInfo tvInputHardwareInfo) {
      synchronized (TvInputManagerService.this.mLock) {
        ...
        for (ServiceState serviceState :
            tvInputManagerService
                .getOrCreateUserStateLocked(tvInputManagerService.mCurrentUserId)
                .serviceStateMap
                .values()) {
    ...
    public void onHdmiDeviceUpdated(String str, HdmiDeviceInfo hdmiDeviceInfo) {
      ...
      synchronized (TvInputManagerService.this.mLock) {
        ...
        if (devicePowerStatus == 0) {
          ...
          num =
              (devicePowerStatus == 1 || devicePowerStatus == 2 || devicePowerStatus == 3)
                  ? 1
                  : null;
        }
        if (num != null) {
          TvInputManagerService.this.setStateLocked(
              str, num.intValue(), TvInputManagerService.this.mCurrentUserId);
        }
        TvInputManagerService tvInputManagerService = TvInputManagerService.this;
        for (ServiceState serviceState :
            tvInputManagerService
    ...
    public void onTvMessage(String str, int i, Bundle bundle) {
      synchronized (TvInputManagerService.this.mLock) {
        TvInputManagerService tvInputManagerService = TvInputManagerService.this;
        UserState orCreateUserStateLocked =
            tvInputManagerService.getOrCreateUserStateLocked(tvInputManagerService.mCurrentUserId);
        TvInputState tvInputState = (TvInputState) orCreateUserStateLocked.inputMap.get(str);
        if (tvInputState == null) {
        ...
        while (it.hasNext()) {
          try {
            ...
            if (!sessionStateLocked.isRecordingSession
                && sessionStateLocked.hardwareSessionToken != null) {
