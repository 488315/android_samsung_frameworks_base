...
public class TvInputHardwareManager implements TvInputHal.Callback {
  ...
  public TvInputHardwareManager(Context context, Listener listener) {
    ...
    this.mVolumeReceiver =
        new BroadcastReceiver() { // from class: com.android.server.tv.TvInputHardwareManager.1
  ...
  public void onDeviceAvailable(
      TvInputHardwareInfo tvInputHardwareInfo, TvStreamConfig[] tvStreamConfigArr) {
  ...
  @Override // com.android.server.tv.TvInputHal.Callback
  public void onStreamConfigurationChanged(
      final int i, TvStreamConfig[] tvStreamConfigArr, int i2) {
    synchronized (this.mLock) {
      Connection connection = (Connection) this.mConnections.get(i);
      if (connection == null) {
      ...
      if (str != null) {
        ...
        this.mPendingTvinputInfoEvents.removeIf(
            new Predicate() { // from class:
                              // com.android.server.tv.TvInputHardwareManager$$ExternalSyntheticLambda0
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$onStreamConfigurationChanged$0;
                lambda$onStreamConfigurationChanged$0 =
                    TvInputHardwareManager.lambda$onStreamConfigurationChanged$0(i, (Message) obj);
  ...
  public static /* synthetic */ boolean lambda$onStreamConfigurationChanged$0(
  ...
  public final boolean checkUidChangedLocked(Connection connection, int i, int i2) {
    ...
    return callingUidLocked == null
        || resolvedUserIdLocked == null
        || callingUidLocked.intValue() != i
        || resolvedUserIdLocked.intValue() != i2;
  }
  ...
  public void addHardwareInput(int i, TvInputInfo tvInputInfo) {
    ...
    synchronized (this.mLock) {
      ...
      if (str2 != null) {
        Slog.w(
            TAG,
            "Trying to override previous registration: old = "
                + this.mInputMap.get(str2)
      ...
      for (int i2 = 0; i2 < this.mHdmiStateMap.size(); i2++) {
        TvInputHardwareInfo findHardwareInfoForHdmiPortLocked =
            findHardwareInfoForHdmiPortLocked(this.mHdmiStateMap.keyAt(i2));
        if (findHardwareInfoForHdmiPortLocked != null
            && (str =
                    (String)
                        this.mHardwareInputIdMap.get(
                            findHardwareInfoForHdmiPortLocked.getDeviceId()))
                != null
            && str.equals(tvInputInfo.getId())) {
          this.mHandler
              .obtainMessage(1, this.mHdmiStateMap.valueAt(i2) ? 0 : 1, 0, str)
              .sendToTarget();
          return;
        }
      }
      ...
      if (connection != null) {
        this.mHandler
            .obtainMessage(1, connection.getInputStateLocked(), 0, tvInputInfo.getId())
            .sendToTarget();
      }
    }
  }
  ...
  public ITvInputHardware acquireHardware(
      int i,
    ...
    TunerResourceManager tunerResourceManager =
        (TunerResourceManager) this.mContext.getSystemService("tv_tuner_resource_mgr");
    synchronized (this.mLock) {
      Connection connection = (Connection) this.mConnections.get(i);
      if (connection == null) {
      ...
      ResourceClientProfile resourceClientProfileLocked =
          connection.getResourceClientProfileLocked();
      if (resourceClientProfileLocked != null
          && tunerResourceManager != null
          && !tunerResourceManager.isHigherPriority(
              resourceClientProfile, resourceClientProfileLocked)) {
        Slog.d(
            TAG, "Acquiring does not show higher priority than the current holder. Device id:" + i);
        return null;
      }
      TvInputHardwareImpl tvInputHardwareImpl =
  ...
  public void releaseHardware(int i, ITvInputHardware iTvInputHardware, int i2, int i3) {
    synchronized (this.mLock) {
      ...
      if (connection.getHardwareLocked() == iTvInputHardware
          && !checkUidChangedLocked(connection, i2, i3)) {
        ITvInputHardwareCallback callbackLocked = connection.getCallbackLocked();
        if (callbackLocked != null) {
  ...
  public final int findDeviceIdForInputIdLocked(String str) {
    for (int i = 0; i < this.mConnections.size(); i++) {
      ...
      if (connection != null
          && connection.getInfoLocked() != null
          && connection.getInfoLocked().getId().equals(str)) {
        return keyAt;
      }
    }
    return -1;
  ...
  public List getAvailableTvStreamConfigList(String str, int i, int i2) {
    ...
    synchronized (this.mLock) {
      ...
      TvStreamConfig[] configsLocked =
          ((Connection) this.mConnections.get(findDeviceIdForInputIdLocked)).getConfigsLocked();
  ...
  public boolean setTvMessageEnabled(String str, int i, boolean z) {
    synchronized (this.mLock) {
      ...
      boolean z2 = true;
      for (TvStreamConfig tvStreamConfig :
          ((Connection) this.mConnections.get(findDeviceIdForInputIdLocked)).getConfigsLocked()) {
        z2 =
            z2
                && this.mHal.setTvMessageEnabled(findDeviceIdForInputIdLocked, tvStreamConfig, i, z)
                    == 0;
      }
      return z2;
    }
  ...
  public boolean captureFrame(
      String str, Surface surface, final TvStreamConfig tvStreamConfig, int i, int i2) {
    synchronized (this.mLock) {
      int findDeviceIdForInputIdLocked = findDeviceIdForInputIdLocked(str);
      if (findDeviceIdForInputIdLocked < 0) {
        Slog.e(TAG, "Invalid inputId : " + str);
      ...
      if (startCapture) {
        connection.setOnFirstFrameCapturedLocked(
            new Runnable() { // from class: com.android.server.tv.TvInputHardwareManager.2
  ...
  public final void handleVolumeChange(Context context, Intent intent) {
    ...
    if (action.equals("android.media.VOLUME_CHANGED_ACTION")) {
      if (intent.getIntExtra("android.media.EXTRA_VOLUME_STREAM_TYPE", -1) != 3
          || (intExtra = intent.getIntExtra("android.media.EXTRA_VOLUME_STREAM_VALUE", 0))
              == this.mCurrentIndex) {
        return;
      } else {
    ...
    synchronized (this.mLock) {
      for (int i = 0; i < this.mConnections.size(); i++) {
        TvInputHardwareImpl hardwareImplLocked =
            ((Connection) this.mConnections.valueAt(i)).getHardwareImplLocked();
        if (hardwareImplLocked != null) {
      ...
      synchronized (this.mLock) {
        ...
        for (int i = 0; i < this.mConnections.size(); i++) {
          indentingPrintWriter.println(
              this.mConnections.keyAt(i) + ": " + ((Connection) this.mConnections.valueAt(i)));
        }
        ...
        for (int i2 = 0; i2 < this.mHardwareInputIdMap.size(); i2++) {
          indentingPrintWriter.println(
              this.mHardwareInputIdMap.keyAt(i2)
                  + ": "
                  + ((String) this.mHardwareInputIdMap.valueAt(i2)));
        }
        indentingPrintWriter.decreaseIndent();
        ...
        for (int i3 = 0; i3 < this.mHdmiInputIdMap.size(); i3++) {
          indentingPrintWriter.println(
              this.mHdmiInputIdMap.keyAt(i3) + ": " + ((String) this.mHdmiInputIdMap.valueAt(i3)));
        }
        indentingPrintWriter.decreaseIndent();
  ...
  public class Connection implements IBinder.DeathRecipient {
    ...
    public String toString() {
      return "Connection{ mHardwareInfo: "
          + this.mHardwareInfo
          + ", mInfo: "
          + this.mInfo
          + ", mCallback: "
          ...
          + this.mHardware
          + ", mConfigs: "
          + Arrays.toString(this.mConfigs)
          + ", mCallingUid: "
          + this.mCallingUid
          + ", mResolvedUserId: "
          + this.mResolvedUserId
          + ", mResourceClientProfile: "
          + this.mResourceClientProfile
          + " }";
    }
  ...
  public class TvInputHardwareImpl extends ITvInputHardware.Stub {
    ...
    public TvInputHardwareImpl(TvInputHardwareInfo tvInputHardwareInfo) {
      AudioManager.OnAudioPortUpdateListener onAudioPortUpdateListener =
          new AudioManager
              .OnAudioPortUpdateListener() { // from class:
                                             // com.android.server.tv.TvInputHardwareManager.TvInputHardwareImpl.1
      ...
      TvInputHardwareManager.this.mAudioManager.registerAudioPortUpdateListener(
          onAudioPortUpdateListener);
      if (tvInputHardwareInfo.getAudioType() != 0) {
        this.mAudioSource =
            findAudioDevicePort(
                tvInputHardwareInfo.getAudioType(), tvInputHardwareInfo.getAudioAddress());
    ...
    public final void findAudioSinkFromAudioPolicy(List list) {
      ...
      while (it.hasNext()) {
        ...
        if ((audioDevicePort.type() & devicesForStream) != 0
            && (audioDevicePort.type() & Integer.MIN_VALUE) == 0) {
    ...
    public void release() {
      synchronized (this.mImplLock) {
        TvInputHardwareManager.this.mAudioManager.unregisterAudioPortUpdateListener(
            this.mAudioListener);
    ...
    public boolean setSurface(Surface surface, TvStreamConfig tvStreamConfig) {
      ...
      synchronized (this.mImplLock) {
        ...
        if (surface == null) {
          ...
          i2 =
              TvInputHardwareManager.this.mHal.removeStream(
                  this.mInfo.getDeviceId(), this.mActiveConfig);
          this.mActiveConfig = null;
        } else {
          ...
          if (i == 0) {
            i2 =
                TvInputHardwareManager.this.mHal.addOrUpdateStream(
                    this.mInfo.getDeviceId(), surface, tvStreamConfig);
            if (i2 == 0) {
    ...
    */
    public final void updateAudioConfigLocked() {
      ...
      float mediaStreamVolume =
          this.mSourceVolume * TvInputHardwareManager.this.getMediaStreamVolume();
      int i4 = 0;
      int i5 = 1;
      if (this.mAudioSource.gains().length > 0 && mediaStreamVolume != this.mCommittedVolume) {
        ...
        if (audioGain != null) {
          ...
          if (mediaStreamVolume < 1.0f) {
            maxValue =
                minValue
                    + (audioGain.stepValue() * ((int) ((maxValue2 * mediaStreamVolume) + 0.5d)));
          } else {
            maxValue = audioGain.maxValue();
          }
          audioGainConfig =
              audioGain.buildConfig(1, audioGain.channelMask(), new int[] {maxValue}, 0);
          ...
          for (AudioDevicePort audioDevicePort : this.mAudioSink) {
            ...
            if (activeConfig2 == null
                || activeConfig2.samplingRate() != i7
                || activeConfig2.channelMask() != i8
                || activeConfig2.format() != i9) {
              if (!TvInputHardwareManager.intArrayContains(audioDevicePort.samplingRates(), i7)
                  && audioDevicePort.samplingRates().length > 0) {
          ...
          if (activeConfig == null && audioGainConfig == null) {
            ...
            if (!TvInputHardwareManager.intArrayContains(
                this.mAudioSource.samplingRates(), audioPortConfig.samplingRate())) {
              i = audioPortConfig.samplingRate();
            } else {
              i =
                  this.mAudioSource.samplingRates().length > 0
                      ? this.mAudioSource.samplingRates()[0]
                      : 0;
            }
            ...
            while (true) {
              ...
              i3 = channelMasks[i2];
              if (AudioFormat.channelCountFromOutChannelMask(audioPortConfig.channelMask())
                  == AudioFormat.channelCountFromInChannelMask(i3)) {
                break;
              } else {
                i2++;
              }
            ...
            activeConfig =
                this.mAudioSource.buildConfig(
                    i,
                    i3,
                    !TvInputHardwareManager.intArrayContains(
                            this.mAudioSource.formats(), audioPortConfig.format())
                        ? audioPortConfig.format()
                        : 1,
                    audioGainConfig);
            z = true;
          }
          if (z) {
            ...
            if (audioPatch2 == null || updateAudioSinkLocked || updateAudioSourceLocked) {
              ...
              AudioManager.createAudioPatch(
                  audioPatchArr,
                  new AudioPortConfig[] {activeConfig},
                  (AudioPortConfig[]) arrayList.toArray(new AudioPortConfig[arrayList.size()]));
    ...
    public final boolean startCapture(Surface surface, TvStreamConfig tvStreamConfig) {
      synchronized (this.mImplLock) {
        ...
        if (surface != null && tvStreamConfig != null) {
          ...
          return TvInputHardwareManager.this.mHal.addOrUpdateStream(
                  this.mInfo.getDeviceId(), surface, tvStreamConfig)
              == 0;
        }
        return false;
    ...
    public final boolean stopCapture(TvStreamConfig tvStreamConfig) {
      synchronized (this.mImplLock) {
        ...
        return TvInputHardwareManager.this.mHal.removeStream(
                this.mInfo.getDeviceId(), tvStreamConfig)
            == 0;
      }
    }
    ...
    public final boolean updateAudioSourceLocked() {
      ...
      AudioDevicePort findAudioDevicePort =
          findAudioDevicePort(this.mInfo.getAudioType(), this.mInfo.getAudioAddress());
    ...
    public final void handleMessage(Message message) {
      ...
      switch (message.what) {
        case 1:
          ...
          return;
        case 2:
          TvInputHardwareManager.this.mListener.onHardwareDeviceAdded(
              (TvInputHardwareInfo) message.obj);
          return;
        case 3:
          TvInputHardwareManager.this.mListener.onHardwareDeviceRemoved(
              (TvInputHardwareInfo) message.obj);
          return;
        case 4:
        ...
        case 6:
          ...
          if (str != null) {
            ...
            Slog.w(
                TvInputHardwareManager.TAG,
                "Could not resolve input ID matching the device info; ignoring.");
            return;
          }
        case 7:
          int i = message.arg1;
          ...
          if (str2 != null) {
            if (connection.updateCableConnectionStatusLocked(i2)) {
              if (inputStateLocked != connection.getInputStateLocked()) {
                TvInputHardwareManager.this
                    .mHandler
                    .obtainMessage(1, connection.getInputStateLocked(), 0, str2)
                    .sendToTarget();
                return;
              }
              return;
        ...
        case 8:
          ...
          TvInputHardwareManager.this.mListener.onTvMessage(
              (String) someArgs.arg1, message.arg1, (Bundle) someArgs.arg2);
          someArgs.recycle();
          return;
        default:
  ...
  public final class HdmiHotplugEventListener extends IHdmiHotplugEventListener.Stub {
    ...
    public void onReceived(HdmiHotplugEvent hdmiHotplugEvent) {
      synchronized (TvInputHardwareManager.this.mLock) {
        TvInputHardwareManager.this.mHdmiStateMap.put(
            hdmiHotplugEvent.getPort(), hdmiHotplugEvent.isConnected());
        TvInputHardwareInfo findHardwareInfoForHdmiPortLocked =
            TvInputHardwareManager.this.findHardwareInfoForHdmiPortLocked(
                hdmiHotplugEvent.getPort());
        if (findHardwareInfoForHdmiPortLocked == null) {
          return;
        }
        String str =
            (String)
                TvInputHardwareManager.this.mHardwareInputIdMap.get(
                    findHardwareInfoForHdmiPortLocked.getDeviceId());
        if (str == null) {
          return;
        }
        TvInputHardwareManager.this
            .mHandler
            .obtainMessage(1, hdmiHotplugEvent.isConnected() ? 0 : 1, 0, str)
            .sendToTarget();
      }
    }
  }
      ...
      if (hdmiDeviceInfo.isSourceType()) {
        synchronized (TvInputHardwareManager.this.mLock) {
          try {
            if (i != 1) {
              if (i == 2) {
                if (!TvInputHardwareManager.this.mHdmiDeviceList.remove(
                    findHdmiDeviceInfo(hdmiDeviceInfo.getId()))) {
                  Slog.w(
                      TvInputHardwareManager.TAG,
                      "The list doesn't contain " + hdmiDeviceInfo + "; ignoring.");
                  return;
                }
                i2 = 5;
              } else if (i == 3) {
                ...
                Message obtainMessage =
                    TvInputHardwareManager.this.mHandler.obtainMessage(i2, 0, 0, hdmiDeviceInfo2);
                if (TvInputHardwareManager.this.findHardwareInfoForHdmiPortLocked(
              ...
              Slog.w(
                  TvInputHardwareManager.TAG,
                  "The list already contains " + hdmiDeviceInfo + "; ignoring.");
              return;
            }
  ...
  public final class HdmiSystemAudioModeChangeListener
    ...
    public void onStatusChanged(boolean z) {
      synchronized (TvInputHardwareManager.this.mLock) {
        for (int i = 0; i < TvInputHardwareManager.this.mConnections.size(); i++) {
          TvInputHardwareImpl hardwareImplLocked =
              ((Connection) TvInputHardwareManager.this.mConnections.valueAt(i))
                  .getHardwareImplLocked();
          if (hardwareImplLocked != null) {
