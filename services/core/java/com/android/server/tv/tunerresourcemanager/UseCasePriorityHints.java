...
public class UseCasePriorityHints {
  ...
  /* renamed from: NS */
  public static final String f1730NS = null;
  ...
  public void parseInternal(InputStream inputStream) {
    ...
    for (int i = 0; i < this.mPriorityHints.size(); i++) {
      ...
      if (DEBUG) {
        ...
        Slog.d(
            "UseCasePriorityHints",
            "{useCase=" + keyAt + ", fg=" + iArr[0] + ", bg=" + iArr[1] + "}");
      }
    }
  }

  public final void readUseCase(TypedXmlPullParser typedXmlPullParser) {
    typedXmlPullParser.require(2, f1730NS, "config");
    while (typedXmlPullParser.next() != 3) {
      if (typedXmlPullParser.getEventType() == 2) {
        ...
        if (name.equals("useCaseDefault")) {
          ...
          typedXmlPullParser.require(3, f1730NS, name);
          ...
          if (formatTypeToNum == -1) {
            ...
            addNewUseCasePriority(
                formatTypeToNum,
                readAttributeToInt("fgPriority", typedXmlPullParser),
                readAttributeToInt("bgPriority", typedXmlPullParser));
            typedXmlPullParser.nextTag();
            typedXmlPullParser.require(3, f1730NS, name);
          }
