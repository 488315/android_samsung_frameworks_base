...
public class TunerResourceManagerService extends SystemService implements IBinder.DeathRecipient {
  ...
  public final class BinderService extends ITunerResourceManager.Stub {
    ...
    public void registerClientProfile(
      ...
      if (!TunerResourceManagerService.this.mPriorityCongfig.isDefinedUseCase(
          resourceClientProfile.useCase)) {
    ...
    public boolean requestFrontend(TunerFrontendRequest tunerFrontendRequest, int[] iArr) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        if (!TunerResourceManagerService.this.checkClientExists(tunerFrontendRequest.clientId)) {
          Slog.e(
              "TunerResourceManagerService",
              "Request frontend from unregistered client: " + tunerFrontendRequest.clientId);
          return false;
        }
        if (!TunerResourceManagerService.this
            .getClientProfile(tunerFrontendRequest.clientId)
    ...
    public boolean setMaxNumberOfFrontends(int i, int i2) {
      ...
      if (i2 < 0) {
        Slog.w(
            "TunerResourceManagerService",
            "setMaxNumberOfFrontends failed with maxUsableNum:" + i2 + " frontendType:" + i);
        return false;
      }
      synchronized (TunerResourceManagerService.this.mLock) {
        maxNumberOfFrontendsInternal =
            TunerResourceManagerService.this.setMaxNumberOfFrontendsInternal(i, i2);
      }
    ...
    public int getMaxNumberOfFrontends(int i) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        maxNumberOfFrontendsInternal =
            TunerResourceManagerService.this.getMaxNumberOfFrontendsInternal(i);
      }
      return maxNumberOfFrontendsInternal;
    }
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        ...
        if (TunerResourceManagerService.this
          ...
          throw new RemoteException(
              "Request to share frontend with a client that has no frontend resources. Target"
                  + " client id:"
                  + i2);
        }
    ...
    public boolean requestDemux(TunerDemuxRequest tunerDemuxRequest, int[] iArr) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        if (!TunerResourceManagerService.this.checkClientExists(tunerDemuxRequest.clientId)) {
          throw new RemoteException(
              "Request demux from unregistered client:" + tunerDemuxRequest.clientId);
        }
        requestDemuxInternal =
            TunerResourceManagerService.this.requestDemuxInternal(tunerDemuxRequest, iArr);
      }
    ...
    public boolean requestDescrambler(TunerDescramblerRequest tunerDescramblerRequest, int[] iArr) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        if (!TunerResourceManagerService.this.checkClientExists(tunerDescramblerRequest.clientId)) {
          throw new RemoteException(
              "Request descrambler from unregistered client:" + tunerDescramblerRequest.clientId);
        }
    ...
    public boolean requestCasSession(CasSessionRequest casSessionRequest, int[] iArr) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        if (!TunerResourceManagerService.this.checkClientExists(casSessionRequest.clientId)) {
          throw new RemoteException(
              "Request cas from unregistered client:" + casSessionRequest.clientId);
        }
        requestCasSessionInternal =
            TunerResourceManagerService.this.requestCasSessionInternal(casSessionRequest, iArr);
      }
    ...
    public boolean requestCiCam(TunerCiCamRequest tunerCiCamRequest, int[] iArr) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        if (!TunerResourceManagerService.this.checkClientExists(tunerCiCamRequest.clientId)) {
          throw new RemoteException(
              "Request ciCam from unregistered client:" + tunerCiCamRequest.clientId);
        }
        requestCiCamInternal =
            TunerResourceManagerService.this.requestCiCamInternal(tunerCiCamRequest, iArr);
      }
    ...
    public boolean requestLnb(TunerLnbRequest tunerLnbRequest, int[] iArr) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        ...
        requestLnbInternal =
            TunerResourceManagerService.this.requestLnbInternal(tunerLnbRequest, iArr);
      }
    ...
    public void releaseFrontend(int i, int i2) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        ...
        ClientProfile clientProfile =
            TunerResourceManagerService.this.getClientProfile(ownerClientId);
        if (ownerClientId != i2
            && clientProfile != null
            && !clientProfile.getShareFeClientIds().contains(Integer.valueOf(i2))) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        ...
        CasResource casResource =
            TunerResourceManagerService.this.getCasResource(
                TunerResourceManagerService.this.getClientProfile(i2).getInUseCasSystemId());
        if (casResource == null) {
    ...
    public void releaseCiCam(int i, int i2) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        ...
        CiCamResource ciCamResource =
            TunerResourceManagerService.this.getCiCamResource(inUseCiCamId);
    ...
    public boolean isHigherPriority(
        ResourceClientProfile resourceClientProfile, ResourceClientProfile resourceClientProfile2) {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      ...
      synchronized (TunerResourceManagerService.this.mLock) {
        ...
        tunerResourceManagerService.dumpMap(
        ...
        tunerResourceManagerService2.dumpMap(
        ...
        tunerResourceManagerService3.dumpSIA(
        ...
        tunerResourceManagerService4.dumpSIA(
        ...
        tunerResourceManagerService5.dumpSIA(
        ...
        tunerResourceManagerService6.dumpMap(
        ...
        tunerResourceManagerService7.dumpSIA(
        ...
        tunerResourceManagerService8.dumpSIA(
        ...
        tunerResourceManagerService9.dumpSIA(
        ...
        tunerResourceManagerService10.dumpMap(
        ...
        TunerResourceManagerService tunerResourceManagerService11 =
            TunerResourceManagerService.this;
        tunerResourceManagerService11.dumpMap(
        ...
        TunerResourceManagerService tunerResourceManagerService12 =
            TunerResourceManagerService.this;
        tunerResourceManagerService12.dumpMap(
        ...
        TunerResourceManagerService tunerResourceManagerService13 =
            TunerResourceManagerService.this;
        tunerResourceManagerService13.dumpMap(
        ...
        TunerResourceManagerService tunerResourceManagerService14 =
            TunerResourceManagerService.this;
        tunerResourceManagerService14.dumpMap(
  ...
  public void registerClientProfileInternal(
    ...
    if (tvInputManager == null) {
      Slog.e(
          "TunerResourceManagerService", "TvInputManager is null. Can't register client profile.");
      return;
    }
    ...
    ClientProfile build =
        new ClientProfile.Builder(iArr[0])
            .tvInputSessionId(resourceClientProfile.tvInputSessionId)
            .useCase(resourceClientProfile.useCase)
            .processId(clientPid)
            .build();
    build.setPriority(
        getClientPriority(resourceClientProfile.useCase, checkIsForeground(clientPid)));
  ...
  public void unregisterClientProfileInternal(int i) {
    ...
    if (iResourceManagerService != null) {
      try {
        ...
        Slog.e(
            "TunerResourceManagerService",
            "Could not overridePid in resourceManagerSercice when unregister, remote exception: "
                + e);
      }
    }
  }
  ...
  public boolean updateClientPriorityInternal(int i, int i2, int i3) {
    if (DEBUG) {
      Slog.d(
          "TunerResourceManagerService",
          "updateClientPriority(clientId=" + i + ", priority=" + i2 + ", niceValue=" + i3 + ")");
    }
  ...
  public boolean isLowestPriorityInternal(int i, int i2) {
    ...
    for (FrontendResource frontendResource : getFrontendResources().values()) {
      if (frontendResource.getType() == i2
          && frontendResource.isInUse()
          && priority > updateAndGetOwnerClientPriority(frontendResource.getOwnerClientId())) {
        return false;
      }
    }
    return true;
    ...
    for (int i = 0; i < tunerFrontendInfoArr.length; i++) {
      if (getFrontendResource(tunerFrontendInfoArr[i].handle) != null) {
        if (DEBUG) {
          Slog.d(
              "TunerResourceManagerService",
              "Frontend handle=" + tunerFrontendInfoArr[i].handle + "exists.");
        }
        hashSet.remove(Integer.valueOf(tunerFrontendInfoArr[i].handle));
      } else {
        addFrontendResource(
            new FrontendResource.Builder(tunerFrontendInfoArr[i].handle)
                .type(tunerFrontendInfoArr[i].type)
                .exclusiveGroupId(tunerFrontendInfoArr[i].exclusiveGroupId)
                .build());
      }
    }
    ...
    for (int i = 0; i < tunerDemuxInfoArr.length; i++) {
      if (getDemuxResource(tunerDemuxInfoArr[i].handle) != null) {
        if (DEBUG) {
          Slog.d(
              "TunerResourceManagerService",
              "Demux handle=" + tunerDemuxInfoArr[i].handle + "exists.");
        }
        hashSet.remove(Integer.valueOf(tunerDemuxInfoArr[i].handle));
      } else {
        addDemuxResource(
            new DemuxResource.Builder(tunerDemuxInfoArr[i].handle)
                .filterTypes(tunerDemuxInfoArr[i].filterTypes)
                .build());
      }
    }
    Iterator it = hashSet.iterator();
  ...
  public void updateCasInfoInternal(int i, int i2) {
    if (DEBUG) {
      Slog.d(
          "TunerResourceManagerService",
          "updateCasInfo(casSystemId=" + i + ", maxSessionNum=" + i2 + ")");
    }
    if (i2 == 0) {
      removeCasResource(i);
  ...
  public boolean requestFrontendInternal(TunerFrontendRequest tunerFrontendRequest, int[] iArr) {
    ...
    if (DEBUG) {
      Slog.d(
          "TunerResourceManagerService", "requestFrontend(request=" + tunerFrontendRequest + ")");
    }
    iArr[0] = -1;
    ...
    while (true) {
      ...
      if (frontendResource.getType() == tunerFrontendRequest.frontendType
          && (!z || resourceIdFromHandle == tunerFrontendRequest.desiredId)) {
        if (frontendResource.isInUse()) {
          if (i2 == -1
              && i
                  > (frontendHighestClientPriority =
                      getFrontendHighestClientPriority(frontendResource.getOwnerClientId()))) {
            int handle = frontendResource.getHandle();
            z2 =
                clientProfile.getProcessId()
                    == getClientProfile(frontendResource.getOwnerClientId()).getProcessId();
            i3 = handle;
    ...
    if (i3 == -1
        || ((clientProfile.getPriority() <= i && !(clientProfile.getPriority() == i && z2))
            || !reclaimResource(getFrontendResource(i3).getOwnerClientId(), 0))) {
      return false;
    }
    iArr[0] = i3;
  ...
  public final boolean transferFeOwner(int i, int i2) {
    ...
    while (it2.hasNext()) {
      ...
      if (ownerClientId != i2) {
        Slog.e(
            "TunerResourceManagerService",
            "something is wrong in transferFeOwner:" + intValue + ", " + ownerClientId + ", " + i2);
        return false;
      }
    }
    return true;
  ...
  public boolean requestLnbInternal(TunerLnbRequest tunerLnbRequest, int[] iArr) {
    ...
    while (true) {
      ...
      int updateAndGetOwnerClientPriority =
          updateAndGetOwnerClientPriority(lnbResource.getOwnerClientId());
      if (i2 > updateAndGetOwnerClientPriority) {
        i3 = lnbResource.getHandle();
        z =
            clientProfile.getProcessId()
                == getClientProfile(lnbResource.getOwnerClientId()).getProcessId();
    ...
    if (i3 <= -1
        || ((clientProfile.getPriority() <= i2 && !(clientProfile.getPriority() == i2 && z))
            || !reclaimResource(getLnbResource(i3).getOwnerClientId(), 3))) {
      return false;
    }
    iArr[0] = i3;
  ...
  public boolean requestCasSessionInternal(CasSessionRequest casSessionRequest, int[] iArr) {
    ...
    if (casResource == null) {
      casResource =
          new CasResource.Builder(casSessionRequest.casSystemId)
    ...
    if (i2 <= -1
        || ((clientProfile.getPriority() <= i && !(clientProfile.getPriority() == i && z))
            || !reclaimResource(i2, 4))) {
      return false;
    }
    iArr[0] = generateResourceHandle(4, casResource.getSystemId());
    updateCasClientMappingOnNewGrant(casSessionRequest.casSystemId, casSessionRequest.clientId);
  ...
  public boolean requestCiCamInternal(TunerCiCamRequest tunerCiCamRequest, int[] iArr) {
    ...
    if (ciCamResource == null) {
      ciCamResource =
          new CiCamResource.Builder(tunerCiCamRequest.ciCamId)
              .maxSessionNum(Integer.MAX_VALUE)
              .build();
  ...
  public boolean isHigherPriorityInternal(
    ...
    return getClientPriority(resourceClientProfile.useCase, checkIsForeground(clientPid))
        > getClientPriority(resourceClientProfile2.useCase, checkIsForeground(clientPid2));
  }
  ...
  public void releaseFrontendInternal(FrontendResource frontendResource, int i) {
    ...
    if (DEBUG) {
      Slog.d(
          "TunerResourceManagerService",
          "releaseFrontend(id=" + frontendResource.getHandle() + ", clientId=" + i + " )");
    }
    if (i == frontendResource.getOwnerClientId()
        && (clientProfile = getClientProfile(frontendResource.getOwnerClientId())) != null) {
  ...
  public void releaseDemuxInternal(DemuxResource demuxResource) {
    if (DEBUG) {
      Slog.d(
          "TunerResourceManagerService",
          "releaseDemux(DemuxHandle=" + demuxResource.getHandle() + ")");
    }
  ...
  public void releaseLnbInternal(LnbResource lnbResource) {
    if (DEBUG) {
      Slog.d(
          "TunerResourceManagerService", "releaseLnb(lnbHandle=" + lnbResource.getHandle() + ")");
    }
  ...
  public void releaseCasSessionInternal(CasResource casResource, int i) {
    if (DEBUG) {
      Slog.d(
          "TunerResourceManagerService",
          "releaseCasSession(sessionResourceId=" + casResource.getSystemId() + ")");
    }
  ...
  public void releaseCiCamInternal(CiCamResource ciCamResource, int i) {
    if (DEBUG) {
      Slog.d(
          "TunerResourceManagerService",
          "releaseCiCamInternal(ciCamId=" + ciCamResource.getCiCamId() + ")");
    }
  ...
  public boolean requestDemuxInternal(TunerDemuxRequest tunerDemuxRequest, int[] iArr) {
          ...
          if (i2 > numOfCaps) {
            ...
            && i
                >= (updateAndGetOwnerClientPriority =
                    updateAndGetOwnerClientPriority(demuxResource.getOwnerClientId()))) {
          int numOfCaps2 = demuxResource.getNumOfCaps();
          if (i > updateAndGetOwnerClientPriority) {
            z3 =
                clientProfile.getProcessId()
                    == getClientProfile(demuxResource.getOwnerClientId()).getProcessId();
            i = updateAndGetOwnerClientPriority;
            z = true;
          } else {
            z = false;
    ...
    if (i4 == -1
        || ((clientProfile.getPriority() <= i && !(clientProfile.getPriority() == i && z3))
            || !reclaimResource(getDemuxResource(i4).getOwnerClientId(), 1))) {
      return false;
    }
    iArr[0] = i4;
  ...
  public void clientPriorityUpdateOnRequest(ClientProfile clientProfile) {
    ...
    clientProfile.setPriority(
        getClientPriority(
            clientProfile.getUseCase(), checkIsForeground(clientProfile.getProcessId())));
  }
  ...
  public final boolean lockForTunerApiLock(int i, long j, String str) {
    try {
      ...
      Slog.e(
          "TunerResourceManagerService",
          "exception thrown in " + str + XmlUtils.STRING_ARRAY_SEPARATOR + e);
  ...
  public final boolean acquireLockInternal(int i, long j, long j2) {
    ...
    try {
      ...
      try {
          ...
          if (j == this.mTunerApiLockHolderThreadId) {
            ...
            while (!z3 && !z2) {
              ...
              if (elapsedTime > 0) {
                Slog.e(
                    "TunerResourceManagerService",
                    "FAILED:acquireLockInternal("
                        + i
                        + ", "
                        + j
                        + ", "
                        + j2
                        + ") - timed out, but will grant the lock to the callee by stealing it from"
                        + " the current holder:"
                        + this.mTunerApiLockHolder
                        + "("
                        + this.mTunerApiLockHolderThreadId
                        + "), who likely failed to call releaseLock(), to prevent this from"
                        + " becoming an unrecoverable error");
                z4 = true;
                break;
              }
              ...
              if (!z3) {
                Slog.w(
                    ...
                    "acquireLockInternal("
                        ...
                        + ", "
                        + j2
                        + ") - woken up from cond wait, but "
                        + this.mTunerApiLockHolder
                        + "("
                        + this.mTunerApiLockHolderThreadId
                        + ") is already holding the lock. Going to wait again if timeout hasn't"
                        + " reached yet");
              }
              uptimeMillis = j3;
            }
            ...
            if (DEBUG) {
              Slog.d(
                  "TunerResourceManagerService",
                  "SUCCESS:acquireLockInternal(" + i + ", " + j + ", " + j2 + ")");
            }
            if (this.mTunerApiLockNestedCount != 0) {
              Slog.w(
                  "TunerResourceManagerService",
                  "Something is wrong as nestedCount("
                      + this.mTunerApiLockNestedCount
        ...
        Slog.e(
            "TunerResourceManagerService",
            "exception thrown in acquireLockInternal(" + i + ", " + j + ", " + j2 + "):" + e);
        if (!this.mLockForTRMSLock.isHeldByCurrentThread()) {
          return false;
        }
        this.mLockForTRMSLock.unlock();
  ...
  */
  ...
  public final void addResourcesReclaimListener(
      int i, IResourcesReclaimListener iResourcesReclaimListener) {
    if (iResourcesReclaimListener == null) {
      if (DEBUG) {
    ...
    ResourcesReclaimListenerRecord resourcesReclaimListenerRecord =
        new ResourcesReclaimListenerRecord(iResourcesReclaimListener, i);
    try {
  ...
  public boolean reclaimResource(int i, int i2) {
    ...
    while (it.hasNext()) {
      int intValue = ((Integer) it.next()).intValue();
      try {
        ((ResourcesReclaimListenerRecord) this.mListeners.get(Integer.valueOf(intValue)))
            .getListener()
            .onReclaimResources();
        clearAllResourcesAndClientMapping(getClientProfile(intValue));
      } catch (RemoteException e) {
        Slog.e(
            "TunerResourceManagerService", "Failed to reclaim resources on client " + intValue, e);
        return false;
      }
    }
    if (DEBUG) {
    ...
    try {
      ((ResourcesReclaimListenerRecord) this.mListeners.get(Integer.valueOf(i)))
          .getListener()
          .onReclaimResources();
  ...
  public final int getFrontendHighestClientPriority(int i) {
    ...
    while (it.hasNext()) {
      int updateAndGetOwnerClientPriority2 =
          updateAndGetOwnerClientPriority(((Integer) it.next()).intValue());
  ...
  public final boolean setMaxNumberOfFrontendsInternal(int i, int i2) {
    ...
    Slog.e(
        ...
        "max number of frontend for frontendType: "
            + i
            + " cannot be set to a value lower than the current usage count. (requested max num = "
            + i2
            + ", current usage = "
            + i3);
    return false;
  ...
  public final void dumpMap(
      Map map, String str, String str2, IndentingPrintWriter indentingPrintWriter) {
    if (map != null) {
  ...
  public final void addFrontendResource(FrontendResource frontendResource) {
    ...
    while (true) {
      ...
      if (frontendResource2.getExclusiveGroupId() == frontendResource.getExclusiveGroupId()) {
        ...
        frontendResource.addExclusiveGroupMemberFeHandles(
            frontendResource2.getExclusiveGroupMemberFeHandles());
        Iterator it2 = frontendResource2.getExclusiveGroupMemberFeHandles().iterator();
        while (it2.hasNext()) {
          getFrontendResource(((Integer) it2.next()).intValue())
              .addExclusiveGroupMemberFeHandle(frontendResource.getHandle());
        }
  ...
  public final void removeFrontendResource(int i) {
    ...
    while (it2.hasNext()) {
      getFrontendResource(((Integer) it2.next()).intValue())
          .removeExclusiveGroupMemberFeId(frontendResource.getHandle());
    }
  ...
  public final void addClientProfile(
      int i, ClientProfile clientProfile, IResourcesReclaimListener iResourcesReclaimListener) {
  ...
  public final void removeClientProfile(int i) {
    ...
    synchronized (this.mLock) {
      ResourcesReclaimListenerRecord resourcesReclaimListenerRecord =
          (ResourcesReclaimListenerRecord) this.mListeners.remove(Integer.valueOf(i));
  ...
  public final void clearFrontendAndClientMapping(ClientProfile clientProfile) {
    ...
    if (primaryFrontend != -1
        && (frontendResource = getFrontendResource(primaryFrontend)) != null) {
  ...
  public final int generateResourceHandle(int i, int i2) {
    int i3 =
        ((i & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT) << 24) | (i2 << 16);
  ...
  public final void enforceTrmAccessPermission(String str) {
    getContext()
        .enforceCallingOrSelfPermission(
            "android.permission.TUNER_RESOURCE_ACCESS", "TunerResourceManagerService: " + str);
  }

  public final void enforceTunerAccessPermission(String str) {
    getContext()
        .enforceCallingPermission(
            "android.permission.ACCESS_TV_TUNER", "TunerResourceManagerService: " + str);
  }

  public final void enforceDescramblerAccessPermission(String str) {
    getContext()
        .enforceCallingPermission(
            "android.permission.ACCESS_TV_DESCRAMBLER", "TunerResourceManagerService: " + str);
  }
}
