...
public final /* synthetic */ class MediaRouter2ServiceImpl$$ExternalSyntheticLambda12
        implements OctConsumer {
    ...
    public final void accept(
        ...
        switch (this.$r8$classId) {
            case 0:
                MediaRouter2ServiceImpl.$r8$lambda$VwOkF_wuq7S_wu2mL143qz8S5B4(
                        (MediaRouter2ServiceImpl.UserHandler) obj,
                        ((Long) obj2).longValue(),
                        (UserHandle) obj3,
                        (String) obj4,
                        (MediaRouter2ServiceImpl.RouterRecord) obj5,
                        (String) obj6,
                        (MediaRoute2Info) obj7,
            ...
            default:
                ...
                try {
                    ...
                    routerRecord.mRouter.requestCreateSessionByManager(
                            longValue, routingSessionInfo, mediaRoute2Info);
                    break;
                } catch (RemoteException e) {
                    Slog.w(
                            "MR2ServiceImpl",
                            "getSessionHintsForCreatingSessionOnHandler: Failed to request. Router"
                                + " probably died.",
                            e);
                    MediaRouter2ServiceImpl.UserHandler.notifyRequestFailedToManager(
                            managerRecord.mManager, (int) longValue, 0);
                }
        }
    }
}
