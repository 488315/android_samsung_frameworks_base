...
public final class MediaRoute2ProviderWatcher {
    ...
    public final AnonymousClass1 mScanPackagesReceiver =
            new BroadcastReceiver() { // from class:
                                      // com.android.server.media.MediaRoute2ProviderWatcher.1
                ...
                public final void onReceive(Context context, Intent intent) {
                    ...
                    MediaRoute2ProviderWatcher mediaRoute2ProviderWatcher =
                            MediaRoute2ProviderWatcher.this;
    ...
    public static void $r8$lambda$uxDP7YbvEhxettSyL1qhqc8pTDY(
        ...
        if (mediaRoute2ProviderWatcher.mRunning) {
            Iterator it =
                    mediaRoute2ProviderWatcher
                            ...
                            .queryIntentServicesAsUser(
                                    ...
                                    RESOLVE_INFO_FLAGS,
                                    mediaRoute2ProviderWatcher.mUserId)
                            .iterator();
            int i = 0;
            while (true) {
                    ...
                    while (true) {
                        ...
                        MediaRoute2ProviderServiceProxy mediaRoute2ProviderServiceProxy =
                                (MediaRoute2ProviderServiceProxy)
                                        mediaRoute2ProviderWatcher.mProxies.get(i2);
                    ...
                    if (i2 < 0) {
                        MediaRoute2ProviderServiceProxy mediaRoute2ProviderServiceProxy2 =
                                new MediaRoute2ProviderServiceProxy(
                                        mediaRoute2ProviderWatcher.mContext,
                                        mediaRoute2ProviderWatcher.mHandler.getLooper(),
                                        new ComponentName(
                        ...
                        int i3 = i + 1;
                        mediaRoute2ProviderWatcher.mProxies.add(
                                i, mediaRoute2ProviderServiceProxy2);
                        ...
                        mediaRoute2ProviderServiceProxy2.updateDiscoveryPreference(
                                userRecord.mActivelyScanningPackages,
                                userRecord.mCompositeDiscoveryPreference);
                        i = i3;
                    } else if (i2 >= i) {
                        ((MediaRoute2ProviderServiceProxy)
                                        mediaRoute2ProviderWatcher.mProxies.get(i2))
                                .start(!Flags.enablePreventionOfKeepAliveRouteProviders());
            ...
            if (i < mediaRoute2ProviderWatcher.mProxies.size()) {
                for (int size2 = mediaRoute2ProviderWatcher.mProxies.size() - 1;
                        size2 >= i;
                        size2--) {
                    MediaRoute2ProviderServiceProxy mediaRoute2ProviderServiceProxy3 =
                            (MediaRoute2ProviderServiceProxy)
                                    mediaRoute2ProviderWatcher.mProxies.get(size2);
                    Slog.i(
                            "MR2ProviderWatcher",
                            "Disabling proxy for MediaRoute2ProviderService: "
                                    + mediaRoute2ProviderServiceProxy3.mComponentName);
                    ((MediaRouter2ServiceImpl.UserHandler) callback)
                            .mRouteProviders.remove(mediaRoute2ProviderServiceProxy3);
