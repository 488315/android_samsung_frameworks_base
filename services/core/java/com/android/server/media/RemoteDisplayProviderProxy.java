...
public final class RemoteDisplayProviderProxy implements ServiceConnection {
  ...
  public final Runnable mDisplayStateChanged =
      new Runnable() { // from class: com.android.server.media.RemoteDisplayProviderProxy.1
        ...
        public void run() {
          ...
          if (RemoteDisplayProviderProxy.this.mDisplayStateCallback != null) {
            ...
            callback.onDisplayStateChanged(
                remoteDisplayProviderProxy, remoteDisplayProviderProxy.mDisplayState);
          }
        }
      };
  ...
  public final void onDisplayStateChanged(
      Connection connection, RemoteDisplayState remoteDisplayState) {
    if (this.mActiveConnection == connection) {
      if (DEBUG) {
  ...
  public final class Connection implements IBinder.DeathRecipient {
      ...
      try {
        ...
        RemoteDisplayProviderProxy.this.mHandler.post(
            new Runnable() { // from class:
              // com.android.server.media.RemoteDisplayProviderProxy.Connection.1
              @Override // java.lang.Runnable
              public void run() {
    ...
    public void binderDied() {
      RemoteDisplayProviderProxy.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.media.RemoteDisplayProviderProxy.Connection.2
            @Override // java.lang.Runnable
            public void run() {
              Connection connection = Connection.this;
