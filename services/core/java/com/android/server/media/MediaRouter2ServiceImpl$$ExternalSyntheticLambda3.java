...
public final /* synthetic */ class MediaRouter2ServiceImpl$$ExternalSyntheticLambda3
    ...
    public final void accept(Object obj, Object obj2, Object obj3) {
        ...
        switch (this.$r8$classId) {
            case 0:
                MediaRouter2ServiceImpl.m654$r8$lambda$l439RW2gb6MOGygsuamHEVj0Rk(
                        userHandler, (String) obj2, (RouteDiscoveryPreference) obj3);
                break;
            case 1:
                ...
                MediaRouter2ServiceImpl.UserHandler.notifySessionCreationFailedToRouter(
                        (MediaRouter2ServiceImpl.RouterRecord) obj2, intValue);
                break;
            case 2:
            ...
            case 3:
                MediaRouter2ServiceImpl.$r8$lambda$heOK_4zIzngS8WMr61qD_midgrQ(
                        userHandler, (String) obj2, (RouteListingPreference) obj3);
                break;
            case 4:
                ...
                while (it.hasNext()) {
                    try {
                        ((IMediaRouter2Manager) it.next())
                                .notifySessionReleased(routingSessionInfo);
                    } catch (RemoteException e2) {
                        Slog.w(
                                "MR2ServiceImpl",
                                "notifySessionReleasedToManagers: Failed to notify. Manager"
                                    + " probably died.",
                                e2);
                    }
                }
                MediaRouter2ServiceImpl.RouterRecord routerRecord2 =
                        (MediaRouter2ServiceImpl.RouterRecord)
                                ((ArrayMap) userHandler.mSessionToRouterMap)
                                        .get(routingSessionInfo.getId());
                if (routerRecord2 == null) {
                    ...
                    try {
                        ...
                        Slog.w(
                                "MR2ServiceImpl",
                                "Failed to notify router of the session release. Router probably"
                                    + " died.",
                                e3);
                        return;
                    }
            ...
            default:
                ...
                while (it2.hasNext()) {
                    try {
                        ...
                        Slog.w(
                                "MR2ServiceImpl",
                                "notifySessionUpdatedToManagers: Failed to notify. Manager probably"
                                    + " died.",
                                e4);
                    }
                }
                ...
                if (mediaRoute2Provider != systemMediaRoute2Provider) {
                    MediaRouter2ServiceImpl.RouterRecord routerRecord3 =
                            (MediaRouter2ServiceImpl.RouterRecord)
                                    ((ArrayMap) userHandler.mSessionToRouterMap)
                                            .get(routingSessionInfo2.getId());
                    if (routerRecord3 != null) {
                        MediaRouter2ServiceImpl.UserHandler.notifySessionInfoChangedToRouters(
                                Arrays.asList(routerRecord3), routingSessionInfo2);
                        break;
                    } else {
                        Slog.w(
                                "MR2ServiceImpl",
                                "onSessionInfoChangedOnHandler: No matching router found for"
                                    + " session="
                                        + routingSessionInfo2);
                        break;
                    }
                    ...
                    MediaRouter2ServiceImpl.UserHandler.notifySessionInfoChangedToRouters(
                            userHandler.getRouterRecords(true), routingSessionInfo2);
                    MediaRouter2ServiceImpl.UserHandler.notifySessionInfoChangedToRouters(
                            userHandler.getRouterRecords(false),
                            systemMediaRoute2Provider.mDefaultSessionInfo);
                    break;
                }
                break;
        }
