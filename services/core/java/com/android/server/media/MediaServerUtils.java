...
public abstract class MediaServerUtils {
  public static boolean isValidActivityComponentName(
      Context context, ComponentName componentName, String str, UserHandle userHandle) {
  ...
  public static void enforcePackageName(String str, int i) {
    ...
    if (UserHandle.isSameApp(
        ...
        ((PackageManagerInternal) LocalServices.getService(PackageManagerInternal.class))
            .getPackageUid(str, 0L, UserHandle.getUserId(i)))) {
      return;
    }
    throw new IllegalArgumentException(
        "packageName does not belong to the calling uid; pkg=" + str + ", uid=" + i);
  }
