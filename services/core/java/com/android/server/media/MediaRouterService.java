...
public final class MediaRouterService extends IMediaRouterService.Stub implements Watchdog.Monitor {
  ...
  public MediaRouterService(Context context) {
    ...
    this.mDefaultAudioRouteId = resources.getString(R.string.fingerprint_error_user_canceled);
    this.mBluetoothA2dpRouteId =
        resources.getString(R.string.config_defaultOnDeviceSpeechRecognitionService);
  ...
  public void systemRunning() {
    ActivityManager.getService()
        .registerUserSwitchObserver(
            new UserSwitchObserver() { // from class: com.android.server.media.MediaRouterService.1
  ...
  public void registerClientGroupId(IMediaRouterClient iMediaRouterClient, String str) {
    if (this.mContext.checkCallingOrSelfPermission("android.permission.CONFIGURE_WIFI_DISPLAY")
      ...
      Log.w(
          "MediaRouterService",
          "Ignoring client group request because the client doesn't have the CONFIGURE_WIFI_DISPLAY"
              + " permission.");
      return;
    }
    long clearCallingIdentity = Binder.clearCallingIdentity();
  ...
  public boolean showMediaOutputSwitcher(String str) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      if (((ActivityManager) this.mContext.getSystemService(ActivityManager.class))
              .getPackageImportance(str)
          > 100) {
        Slog.w(
            "MediaRouterService", "showMediaOutputSwitcher only works when called from foreground");
        Binder.restoreCallingIdentity(clearCallingIdentity);
        return false;
      }
      synchronized (this.mLock) {
        ((StatusBarManagerInternal) LocalServices.getService(StatusBarManagerInternal.class))
            .showMediaOutputSwitcher(str);
      }
      Binder.restoreCallingIdentity(clearCallingIdentity);
      return true;
    } catch (Throwable th) {
  ...
  public void requestCreateSessionWithRouter2(
      ...
      Bundle bundle) {
    this.mService2.requestCreateSessionWithRouter2(
  ...
  public RoutingSessionInfo getSystemSessionInfoForPackage(
      IMediaRouter2Manager iMediaRouter2Manager, String str) {
    boolean z;
    ...
    synchronized (this.mLock) {
      ...
      Iterator it =
          (userRecord != null ? userRecord.mClientRecords : Collections.emptyList()).iterator();
      while (true) {
        if (!it.hasNext()) {
          z = false;
          break;
        ...
        if (TextUtils.equals(clientRecord.mPackageName, str)
  ...
  public void requestCreateSessionWithManager(
      ...
      RoutingSessionInfo routingSessionInfo,
      MediaRoute2Info mediaRoute2Info) {
    this.mService2.requestCreateSessionWithManager(
        iMediaRouter2Manager, i, routingSessionInfo, mediaRoute2Info);
  }
  ...
  public void restoreRoute(int i) {
    ...
    synchronized (this.mLock) {
      UserRecord userRecord =
          (UserRecord) this.mUserRecords.get(UserHandle.getUserHandleForUid(i).getIdentifier());
  ...
  public final void setSelectedRouteLocked(
    ...
    if (clientRecord != null) {
      String str2 =
          (this.mDefaultAudioRouteId.equals(clientRecord.mSelectedRouteId)
                  || this.mBluetoothA2dpRouteId.equals(clientRecord.mSelectedRouteId))
              ? null
  ...
  public final void requestSetVolumeLocked(
  ...
  public final void requestUpdateVolumeLocked(
      IMediaRouterClient iMediaRouterClient, String str, int i) {
    ClientRecord clientRecord =
        (ClientRecord) this.mAllClientRecords.get(iMediaRouterClient.asBinder());
    if (clientRecord != null) {
  ...
  public final class UserRecord {
    ...
    public void dump(final PrintWriter printWriter, String str) {
      ...
      if (this.mHandler.runWithScissors(
          new Runnable() { // from class: com.android.server.media.MediaRouterService.UserRecord.1
    ...
    public void addToGroup(String str, ClientRecord clientRecord) {
      ...
      if (clientGroup == null) {
        clientGroup = MediaRouterService.this.new ClientGroup();
  ...
  public final class UserHandler extends Handler
    ...
    public void dump(PrintWriter printWriter, String str) {
      ...
      sb.append(
          this.mConnectionTimeoutReason != 0
              ? TimeUtils.formatUptime(this.mConnectionTimeoutStartTime)
              : "<n/a>");
    ...
    public final void updateDiscoveryRequest() {
      ...
      if (this.mDiscoveryMode != i4) {
        ...
        for (i = 0; i < size2; i++) {
          ((ProviderRecord) this.mProviderRecords.get(i))
              .getProvider()
              .setDiscoveryMode(this.mDiscoveryMode);
        }
      }
    }
    ...
    public final void selectRoute(String str) {
      ...
      if (str != null) {
        ...
        if ((routeRecord == null || !str.equals(routeRecord.getUniqueId()))
            && (findRouteRecord = findRouteRecord(str)) != null) {
          unselectSelectedRoute();
    ...
    public final void unselectRoute(String str) {
      ...
      if (str == null
          || (routeRecord = this.mSelectedRouteRecord) == null
          || !str.equals(routeRecord.getUniqueId())) {
        return;
      }
      unselectSelectedRoute();
    }
    ...
    public final void updateProvider(
      ...
      int findProviderRecord = findProviderRecord(remoteDisplayProviderProxy);
      if (findProviderRecord < 0
          || !((ProviderRecord) this.mProviderRecords.get(findProviderRecord))
    ...
    public final void checkSelectedRouteState() {
      ...
      Slog.i(
          "MediaRouterService",
          "checkSelectedRouteState: mTriggeredBySmartView=" + this.mTriggeredBySmartView);
    ...
    public final void connectionTimedOut() {
      ...
      if (i == 1) {
        ...
        Slog.i(
            "MediaRouterService", "Selected route connection lost: " + this.mSelectedRouteRecord);
      } else if (i == 3) {
        Slog.i(
            "MediaRouterService",
            "Selected route timed out while waiting for connection attempt to begin after "
                + (SystemClock.uptimeMillis() - this.mConnectionTimeoutStartTime)
                + " ms: "
        ...
        synchronized (this.mService.mLock) {
          ...
          for (int i2 = 0; i2 < size2; i2++) {
            try {
              ...
              Slog.w(
                  "MediaRouterService",
                  "Failed to call onSelectedRouteChanged. Client probably died.");
            }
          }
        }
      } finally {
    ...
    public final int findProviderRecord(RemoteDisplayProviderProxy remoteDisplayProviderProxy) {
      int size = this.mProviderRecords.size();
      for (int i = 0; i < size; i++) {
        if (((ProviderRecord) this.mProviderRecords.get(i)).getProvider()
    ...
    public final RouteRecord findRouteRecord(String str) {
      int size = this.mProviderRecords.size();
      for (int i = 0; i < size; i++) {
        RouteRecord findRouteByUniqueId =
            ((ProviderRecord) this.mProviderRecords.get(i)).findRouteByUniqueId(str);
    ...
    public final class ProviderRecord {
      ...
      public ProviderRecord(RemoteDisplayProviderProxy remoteDisplayProviderProxy) {
        ...
        this.mUniquePrefix =
            remoteDisplayProviderProxy.getFlattenedComponentName()
            ...
            if (remoteDisplayState.isValid()) {
              ...
              for (int i2 = 0; i2 < size2; i2++) {
                RemoteDisplayState.RemoteDisplayInfo remoteDisplayInfo =
                    (RemoteDisplayState.RemoteDisplayInfo) arrayList.get(i2);
                ...
                if (findRouteByDescriptorId < 0) {
                  ...
                  Slog.w(
                      "MediaRouterService",
                      "Ignoring route descriptor with duplicate id: " + remoteDisplayInfo);
                } else {
                  RouteRecord routeRecord2 =
                      (RouteRecord) this.mRoutes.get(findRouteByDescriptorId);
              ...
              while (size >= i) {
                ((RouteRecord) this.mRoutes.remove(size)).updateDescriptor(null);
                size--;
                z = true;
              }
            } else {
              Slog.w(
                  "MediaRouterService",
                  "Ignoring invalid descriptor from media route provider: "
                      + this.mProvider.getFlattenedComponentName());
            }
          }
          i = 0;
          size = this.mRoutes.size() - 1;
    ...
    public final class RouteRecord {
      ...
      public static int computePlaybackStream(
          RemoteDisplayState.RemoteDisplayInfo remoteDisplayInfo) {
        return 3;
      }

      public static int computePlaybackType(
          RemoteDisplayState.RemoteDisplayInfo remoteDisplayInfo) {
        return 1;
      }

      public static int computeSupportedTypes(
          RemoteDisplayState.RemoteDisplayInfo remoteDisplayInfo) {
        return 7;
      }
      ...
      public static String computeDescription(
          RemoteDisplayState.RemoteDisplayInfo remoteDisplayInfo) {
      ...
      public static int computeVolumeHandling(
          RemoteDisplayState.RemoteDisplayInfo remoteDisplayInfo) {
        return remoteDisplayInfo.volumeHandling != 1 ? 0 : 1;
      }

      public static int computePresentationDisplayId(
          RemoteDisplayState.RemoteDisplayInfo remoteDisplayInfo) {
  ...
  public class AudioPlayerActiveStateChangedListenerImpl
    ...
    public void onAudioPlayerActiveStateChanged(
      ...
      if (z2) {
        ...
        i =
            MediaRouterService.this.mActivePlayerUidMinPriorityQueue.size() > 0
                ? MediaRouterService.this.mActivePlayerUidMinPriorityQueue.get(
                    MediaRouterService.this.mActivePlayerUidMinPriorityQueue.size() - 1)
                : -1;
      }
      ...
      if (MediaRouterService.DEBUG) {
        Slog.d(
            "MediaRouterService",
            "onAudioPlayerActiveStateChanged: uid=" + clientUid + ", active=" + z2 + ", delaying");
      }
    }
  }
