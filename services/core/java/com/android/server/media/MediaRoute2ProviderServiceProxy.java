...
public final class MediaRoute2ProviderServiceProxy extends MediaRoute2Provider
  ...
  public MediaRoute2ProviderServiceProxy(
  ...
  public void updateDiscoveryPreference(
    ...
    this.mLastDiscoveryPreferenceIncludesThisPackage =
        set.contains(this.mComponentName.getPackageName());
    if (this.mConnectionReady) {
  ...
  public boolean hasComponentName(String str, String str2) {
    return this.mComponentName.getPackageName().equals(str)
        && this.mComponentName.getClassName().equals(str2);
  }
  ...
  public final boolean shouldBind() {
    ...
    if (routeDiscoveryPreference != null
        && !routeDiscoveryPreference.getPreferredFeatures().isEmpty()) {
      z = true;
    }
  ...
  public final void bind() {
    ...
    try {
      boolean bindServiceAsUser =
          this.mContext.bindServiceAsUser(intent, this, 67108865, new UserHandle(this.mUserId));
  ...
  public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
    ...
    if (this.mBound) {
      disconnect();
      IMediaRoute2ProviderService asInterface =
          IMediaRoute2ProviderService.Stub.asInterface(iBinder);
      if (asInterface != null) {
  ...
  public final void onProviderUpdated(
      Connection connection, MediaRoute2ProviderInfo mediaRoute2ProviderInfo) {
    if (this.mActiveConnection != connection) {
      return;
    }
    if (DEBUG) {
  ...
  public final void onSessionCreated(
      Connection connection, long j, RoutingSessionInfo routingSessionInfo) {
    if (this.mActiveConnection != connection) {
      return;
    }
    if (routingSessionInfo == null) {
      Slog.w(
          "MR2ProviderSvcProxy",
          "onSessionCreated: Ignoring null session sent from " + this.mComponentName);
      return;
    }
    ...
    synchronized (this.mLock) {
      if (!this.mSessionInfos.stream()
              .anyMatch(
                  new Predicate() { // from class:
                    // com.android.server.media.MediaRoute2ProviderServiceProxy$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$onSessionCreated$0;
                      lambda$onSessionCreated$0 =
                          MediaRoute2ProviderServiceProxy.lambda$onSessionCreated$0(
                              id, (RoutingSessionInfo) obj);
                      return lambda$onSessionCreated$0;
                    }
                  })
          && !this.mReleasingSessions.stream()
              .anyMatch(
                  new Predicate() { // from class:
                    // com.android.server.media.MediaRoute2ProviderServiceProxy$$ExternalSyntheticLambda2
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$onSessionCreated$1;
                      lambda$onSessionCreated$1 =
                          MediaRoute2ProviderServiceProxy.lambda$onSessionCreated$1(
                              id, (RoutingSessionInfo) obj);
      ...
      Slog.w(
          "MR2ProviderSvcProxy", "onSessionCreated: Duplicate session already exists. Ignoring.");
    }
  }

  public static /* synthetic */ boolean lambda$onSessionCreated$0(
      String str, RoutingSessionInfo routingSessionInfo) {
    return TextUtils.equals(routingSessionInfo.getId(), str);
  }

  public static /* synthetic */ boolean lambda$onSessionCreated$1(
      String str, RoutingSessionInfo routingSessionInfo) {
    return TextUtils.equals(routingSessionInfo.getId(), str);
  }
  ...
  public final int findSessionByIdLocked(RoutingSessionInfo routingSessionInfo) {
    for (int i = 0; i < this.mSessionInfos.size(); i++) {
      if (TextUtils.equals(
          ((RoutingSessionInfo) this.mSessionInfos.get(i)).getId(), routingSessionInfo.getId())) {
        return i;
      }
    }
    return -1;
  ...
  public final void onSessionsUpdated(Connection connection, List list) {
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        RoutingSessionInfo routingSessionInfo = (RoutingSessionInfo) it.next();
        if (routingSessionInfo != null) {
          RoutingSessionInfo assignProviderIdForSession =
              assignProviderIdForSession(routingSessionInfo);
          ...
          if (findSessionByIdLocked < 0) {
            ...
            Slog.w(
                "MR2ProviderSvcProxy",
                "Ignoring duplicate session ID: " + assignProviderIdForSession.getId());
          } else {
  ...
  public final void onSessionReleased(
      Connection connection, RoutingSessionInfo routingSessionInfo) {
    boolean z;
    if (this.mActiveConnection != connection) {
      return;
    }
    if (routingSessionInfo == null) {
      Slog.w(
          "MR2ProviderSvcProxy",
          "onSessionReleased: Ignoring null session sent from " + this.mComponentName);
      return;
    }
    RoutingSessionInfo assignProviderIdForSession = assignProviderIdForSession(routingSessionInfo);
    synchronized (this.mLock) {
    ...
    handler.sendMessage(
        PooledLambda.obtainMessage(
            new TriConsumer() { // from class:
              // com.android.server.media.MediaRoute2ProviderServiceProxy$$ExternalSyntheticLambda4
              public final void accept(Object obj, Object obj2, Object obj3) {
                MediaRoute2Provider.Callback.this.onSessionCreated(
                    (MediaRoute2ProviderServiceProxy) obj,
                    ((Long) obj2).longValue(),
    ...
    handler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.media.MediaRoute2ProviderServiceProxy$$ExternalSyntheticLambda0
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                MediaRoute2Provider.Callback.this.onSessionUpdated(
                    (MediaRoute2ProviderServiceProxy) obj, (RoutingSessionInfo) obj2);
              }
            },
            this,
            routingSessionInfo));
  ...
  public final void dispatchSessionReleased(RoutingSessionInfo routingSessionInfo) {
    ...
    handler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
              // com.android.server.media.MediaRoute2ProviderServiceProxy$$ExternalSyntheticLambda3
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                MediaRoute2Provider.Callback.this.onSessionReleased(
                    (MediaRoute2ProviderServiceProxy) obj, (RoutingSessionInfo) obj2);
              }
            },
            this,
  ...
  public final RoutingSessionInfo assignProviderIdForSession(
      RoutingSessionInfo routingSessionInfo) {
    return new RoutingSessionInfo.Builder(routingSessionInfo)
        .setOwnerPackageName(this.mComponentName.getPackageName())
  ...
  public String getDebugString() {
    ...
    return TextUtils.formatSimple(
        "ProviderServiceProxy - package: %s, bound: %b, connection (active:%b, ready:%b)", objArr);
  }
  ...
  public final class Connection implements IBinder.DeathRecipient {
      ...
      try {
        ...
        MediaRoute2ProviderServiceProxy.this.mHandler.post(
            new Runnable() { // from class:
              // com.android.server.media.MediaRoute2ProviderServiceProxy$Connection$$ExternalSyntheticLambda6
    ...
    public void binderDied() {
      MediaRoute2ProviderServiceProxy.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.media.MediaRoute2ProviderServiceProxy$Connection$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$postProviderUpdated$2(
    ...
    public void postProviderUpdated(final MediaRoute2ProviderInfo mediaRoute2ProviderInfo) {
      MediaRoute2ProviderServiceProxy.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.media.MediaRoute2ProviderServiceProxy$Connection$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              MediaRoute2ProviderServiceProxy.Connection.this.lambda$postProviderUpdated$2(
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$postSessionCreated$3(
    ...
    public void postSessionCreated(final long j, final RoutingSessionInfo routingSessionInfo) {
      MediaRoute2ProviderServiceProxy.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.media.MediaRoute2ProviderServiceProxy$Connection$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
              MediaRoute2ProviderServiceProxy.Connection.this.lambda$postSessionCreated$3(
                  j, routingSessionInfo);
            }
          });
    }
    ...
    public void postSessionsUpdated(final List list) {
      MediaRoute2ProviderServiceProxy.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.media.MediaRoute2ProviderServiceProxy$Connection$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$postSessionReleased$5(
        RoutingSessionInfo routingSessionInfo) {
    ...
    public void postSessionReleased(final RoutingSessionInfo routingSessionInfo) {
      MediaRoute2ProviderServiceProxy.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.media.MediaRoute2ProviderServiceProxy$Connection$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              MediaRoute2ProviderServiceProxy.Connection.this.lambda$postSessionReleased$5(
                  routingSessionInfo);
            }
          });
    }
    ...
    public void postRequestFailed(final long j, final int i) {
      MediaRoute2ProviderServiceProxy.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.media.MediaRoute2ProviderServiceProxy$Connection$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
