...
public final /* synthetic */ class MediaSessionRecord$$ExternalSyntheticLambda2
    ...
    public final void performOn(
        ...
        switch (i) {
            case 0:
                iSessionControllerCallbackHolder.mCallback.onVolumeInfoChanged(
                        (MediaController.PlaybackInfo) obj);
                break;
            case 1:
            ...
            case 3:
                ...
                break;
            case 4:
                iSessionControllerCallbackHolder.mCallback.onPlaybackStateChanged(
                        (PlaybackState) obj);
                break;
            default:
