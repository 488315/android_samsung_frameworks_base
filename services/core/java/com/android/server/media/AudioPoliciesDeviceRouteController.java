...
public final class AudioPoliciesDeviceRouteController implements DeviceRouteController {
    ...
    public final MediaRoute2Info createRouteFromAudioInfo(int i) {
        ...
        int i2 = (i == 3 || i == 4) ? R.string.fingerprint_or_screen_lock_dialog_default_subtitle : i != 9 ? i != 11 ? i != 13 ? R.string.fingerprint_error_vendor_unknown : R.string.fingerprint_name_template : R.string.fingerprint_recalibrate_notification_content : R.string.fingerprint_or_screen_lock_app_setting_name;
        synchronized (this) {
