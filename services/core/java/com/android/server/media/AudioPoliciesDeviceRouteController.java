...
public final class AudioPoliciesDeviceRouteController implements DeviceRouteController {
  ...
  public AudioPoliciesDeviceRouteController(
      Context context,
      AudioManager audioManager,
      IAudioService iAudioService,
      DeviceRouteController.OnDeviceRouteChangedListener onDeviceRouteChangedListener) {
    ...
    int i2 =
        (i == 3 || i == 4)
            ...
            : i != 9
                ? i != 11
                    ? i != 13
                        ? R.string.fingerprint_error_vendor_unknown
                        : R.string.fingerprint_name_template
                    : R.string.fingerprint_recalibrate_notification_content
                : R.string.fingerprint_or_screen_lock_app_setting_name;
    synchronized (this) {
      build =
          new MediaRoute2Info.Builder(
                  "DEVICE_ROUTE", this.mContext.getResources().getText(i2).toString())
              .setVolumeHandling(this.mAudioManager.isVolumeFixed() ? 0 : 1)
              .setVolume(this.mDeviceVolume)
  ...
  public class AudioRoutesObserver extends IAudioRoutesObserver.Stub {
    ...
    public void dispatchAudioRoutesChanged(AudioRoutesInfo audioRoutesInfo) {
      ...
      MediaRoute2Info createRouteFromAudioInfo =
          AudioPoliciesDeviceRouteController.this.createRouteFromAudioInfo(audioRoutesInfo);
      ...
      if (z) {
        AudioPoliciesDeviceRouteController.this.mOnDeviceRouteChangedListener.onDeviceRouteChanged(
