...
public class MediaSessionRecord implements IBinder.DeathRecipient, MediaSessionRecordImpl {
  ...
  public final Runnable mClearOptimisticVolumeRunnable =
      new Runnable() { // from class: com.android.server.media.MediaSessionRecord.3
        @Override // java.lang.Runnable
        public void run() {
          boolean z =
              MediaSessionRecord.this.mOptimisticVolume != MediaSessionRecord.this.mCurrentVolume;
  ...
  public static int getVolumeStream(AudioAttributes audioAttributes) {
    ...
    return volumeControlStream == Integer.MIN_VALUE
        ? DEFAULT_ATTRIBUTES.getVolumeControlStream()
        : volumeControlStream;
  }
  ...
  public MediaSessionRecord(
    ...
    this.mVolumeAdjustmentForRemoteGroupSessions =
        context.getResources().getBoolean(R.bool.config_sustainedPerformanceModeSupported);
  ...
  public void adjustVolume(
      String str, String str2, int i, int i2, boolean z, int i3, int i4, boolean z2) {
    int i5 = i4 & 4;
    ...
    if (this.mVolumeControlType == 0) {
      ...
      if (z3) {
        Log.w(
            "MediaSessionRecord",
            "adjusting volume, pkg=" + str + ", asSystemService=" + z + ", dir=" + i3);
      }
  ...
  public final void setVolumeTo(
      String str, final String str2, final int i, final int i2, final int i3, final int i4) {
    if (this.mVolumeType == 1) {
      final int volumeStream = getVolumeStream(this.mAudioAttrs);
      this.mHandler.post(
          new Runnable() { // from class: com.android.server.media.MediaSessionRecord.1
            @Override // java.lang.Runnable
            public void run() {
              try {
                MediaSessionRecord.this.mAudioManager.setStreamVolumeForUid(
                    volumeStream,
                    i3,
                    i4,
                    str2,
                    i2,
                    i,
                    MediaSessionRecord.this.mContext.getApplicationInfo().targetSdkVersion);
              } catch (IllegalArgumentException | SecurityException e) {
                Log.e(
                    "MediaSessionRecord",
                    "Cannot set volume: stream=" + volumeStream + ", value=" + i3 + ", flags=" + i4,
                    e);
              }
            }
          });
    ...
    if (this.mVolumeControlType != 2) {
      ...
      Log.d(
          "MediaSessionRecord",
          "Set optimistic volume to " + this.mOptimisticVolume + " max is " + this.mMaxVolume);
    }
  ...
  public void close() {
    ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
        .logFgsApiEnd(4, Binder.getCallingUid(), Binder.getCallingPid());
  ...
  public boolean canHandleVolumeKey() {
    ...
    boolean z = true;
    boolean z2 = false;
    for (RoutingSessionInfo routingSessionInfo :
        MediaRouter2Manager.getInstance(this.mContext).getRoutingSessions(this.mPackageName)) {
  ...
  public void dump(PrintWriter printWriter, String str) {
    ...
    printWriter
        ...
        .append("volumeType=")
        .append(toVolumeTypeString(this.mVolumeType))
        .append(", controlType=")
        .append(toVolumeControlTypeString(this.mVolumeControlType))
        .append(", max=")
        .append(Integer.toString(this.mMaxVolume))
        .append(", current=")
        .append(Integer.toString(this.mCurrentVolume))
        .append(", volumeControlId=")
        .append(this.mVolumeControlId)
        .println();
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        printWriter.print(
            sb2 + sb2 + ((ISessionControllerCallbackHolder) it.next()).mPackageName + " ");
        printWriter.println();
      }
    }
  }
  ...
  public static String toVolumeControlTypeString(int i) {
    return i != 0
        ? i != 1
            ? i != 2
                ? TextUtils.formatSimple("unknown(%d)", new Object[] {Integer.valueOf(i)})
                : "ABSOLUTE"
            : "RELATIVE"
        : "FIXED";
  }
  ...
  public final void postAdjustLocalVolume(
      final int i,
      final int i2,
      final int i3,
      String str,
    ...
    this.mHandler.post(
        new Runnable() { // from class: com.android.server.media.MediaSessionRecord.2
          @Override // java.lang.Runnable
          public void run() {
            try {
              if (z2) {
                if (AudioSystem.isStreamActive(i, 0)) {
                  MediaSessionRecord.this.mAudioManager.adjustSuggestedStreamVolumeForUid(
                      i,
                      i2,
                      i3,
                      str2,
                ...
                MediaSessionRecord.this.mAudioManager.adjustStreamVolumeForUid(
                    i,
                    i2,
                    i3,
                    str2,
  ...
  public final void logCallbackException(
      String str,
      ISessionControllerCallbackHolder iSessionControllerCallbackHolder,
      Exception exc) {
    Log.v(
        "MediaSessionRecord",
        str
            ...
            + this
            + ", callback package="
            + iSessionControllerCallbackHolder.mPackageName
            + ", exception="
            + exc);
  }
  ...
  public final void pushPlaybackStateUpdate() {
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        ISessionControllerCallbackHolder iSessionControllerCallbackHolder =
            (ISessionControllerCallbackHolder) it.next();
        try {
          ...
          logCallbackException(
              "unexpected exception in pushPlaybackStateUpdate",
              iSessionControllerCallbackHolder,
              e2);
        }
      }
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        ...
        try {
          ...
          arrayList.add(iSessionControllerCallbackHolder);
          logCallbackException(
              "Removing dead callback in pushMetadataUpdate", iSessionControllerCallbackHolder, e);
        } catch (RemoteException e2) {
          logCallbackException(
              "unexpected exception in pushMetadataUpdate", iSessionControllerCallbackHolder, e2);
        }
      }
      if (arrayList != null) {
        this.mControllerCallbackHolders.removeAll(arrayList);
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        ...
        try {
          ...
          logCallbackException(
              "Removing dead callback in pushQueueUpdate", iSessionControllerCallbackHolder, e);
        } catch (RemoteException e2) {
          logCallbackException(
              "unexpected exception in pushQueueUpdate", iSessionControllerCallbackHolder, e2);
        }
      }
      if (arrayList2 != null) {
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        ...
        try {
          ...
          arrayList.add(iSessionControllerCallbackHolder);
          logCallbackException(
              "Removing dead callback in pushQueueTitleUpdate",
              iSessionControllerCallbackHolder,
              e);
        } catch (RemoteException e2) {
          logCallbackException(
              "unexpected exception in pushQueueTitleUpdate", iSessionControllerCallbackHolder, e2);
        }
      }
      if (arrayList != null) {
        this.mControllerCallbackHolders.removeAll(arrayList);
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        ...
        try {
          ...
          arrayList.add(iSessionControllerCallbackHolder);
          logCallbackException(
              "Removing dead callback in pushExtrasUpdate", iSessionControllerCallbackHolder, e);
        } catch (RemoteException e2) {
          logCallbackException(
              "unexpected exception in pushExtrasUpdate", iSessionControllerCallbackHolder, e2);
        }
      }
      if (arrayList != null) {
        this.mControllerCallbackHolders.removeAll(arrayList);
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        ...
        try {
          ...
          arrayList.add(iSessionControllerCallbackHolder);
          logCallbackException(
              "Removing dead callback in pushVolumeUpdate", iSessionControllerCallbackHolder, e);
        } catch (RemoteException e2) {
          logCallbackException(
              "unexpected exception in pushVolumeUpdate", iSessionControllerCallbackHolder, e2);
        }
      }
      if (arrayList != null) {
        this.mControllerCallbackHolders.removeAll(arrayList);
    ...
    synchronized (this.mLock) {
      ...
      while (it.hasNext()) {
        ...
        try {
          ...
          arrayList.add(iSessionControllerCallbackHolder);
          logCallbackException(
              "Removing dead callback in pushEvent", iSessionControllerCallbackHolder, e);
        } catch (RemoteException e2) {
          logCallbackException(
              "unexpected exception in pushEvent", iSessionControllerCallbackHolder, e2);
        }
      }
      if (arrayList != null) {
        this.mControllerCallbackHolders.removeAll(arrayList);
      ...
      if (this.mDestroyed) {
        ...
        while (it.hasNext()) {
          ...
          try {
            ...
            logCallbackException(
                "Removing dead callback in pushSessionDestroyed",
                iSessionControllerCallbackHolder,
                e);
          } catch (RemoteException e2) {
            logCallbackException(
                "unexpected exception in pushSessionDestroyed",
                iSessionControllerCallbackHolder,
                e2);
          } catch (NoSuchElementException e3) {
            logCallbackException(
                "error unlinking to binder death", iSessionControllerCallbackHolder, e3);
          }
        }
  ...
  public final PlaybackState getStateWithUpdatedPosition() {
    synchronized (this.mLock) {
      ...
      if (playbackState2 != null
          && (playbackState2.getState() == 3
              || playbackState2.getState() == 4
              || playbackState2.getState() == 5)) {
        long lastPositionUpdateTime = playbackState2.getLastPositionUpdateTime();
        long elapsedRealtime = SystemClock.elapsedRealtime();
        if (lastPositionUpdateTime > 0) {
          long playbackSpeed =
              ((long)
                      (playbackState2.getPlaybackSpeed()
                          * (elapsedRealtime - lastPositionUpdateTime)))
                  + playbackState2.getPosition();
          ...
          builder.setState(
              playbackState2.getState(), j2, playbackState2.getPlaybackSpeed(), elapsedRealtime);
  ...
  public final int getControllerHolderIndexForCb(
    ...
    for (int size = this.mControllerCallbackHolders.size() - 1; size >= 0; size--) {
      if (asBinder.equals(
          ((ISessionControllerCallbackHolder) this.mControllerCallbackHolders.get(size))
              .mCallback.asBinder())) {
        return size;
      }
    }
  ...
  public final MediaController.PlaybackInfo getVolumeAttributes() {
    synchronized (this.mLock) {
      ...
      if (i == 2) {
        ...
        return new MediaController.PlaybackInfo(
            this.mVolumeType,
            this.mVolumeControlType,
            this.mMaxVolume,
            i2,
            this.mAudioAttrs,
      ...
      return new MediaController.PlaybackInfo(
          i,
          2,
          this.mAudioManager.getStreamMaxVolume(volumeStream),
          this.mAudioManager.getStreamVolume(volumeStream),
          audioAttributes,
          null);
    }
  }
  ...
  public static boolean componentNameExists(ComponentName componentName, Context context, int i) {
    ...
    return !context
        ...
        .queryBroadcastReceiversAsUser(
            intent, PackageManager.ResolveInfoFlags.of(0L), UserHandle.of(i))
        .isEmpty();
  }
  ...
  public final class SessionStub extends ISession.Stub {
    ...
    public void setActive(boolean z) {
      ...
      if (z) {
        ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
            .logFgsApiBegin(4, callingUid, callingPid);
      } else {
        ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
            .logFgsApiEnd(4, callingUid, callingPid);
      }
    ...
    public void setFlags(int i) {
      int i2 = 65536 & i;
      if (i2 != 0) {
        MediaSessionRecord.this.mService.enforcePhoneStatePermission(
    ...
    public void setMediaButtonReceiver(PendingIntent pendingIntent) {
      ...
      try {
        ...
        if (pendingIntent != null && pendingIntent.isActivity()) {
          Log.w(
              "MediaSessionRecord",
              "Ignoring invalid media button receiver targeting an activity: " + pendingIntent);
          return;
        }
        MediaSessionRecord mediaSessionRecord = MediaSessionRecord.this;
        mediaSessionRecord.mMediaButtonReceiverHolder =
            MediaButtonReceiverHolder.create(
                mediaSessionRecord.mUserId, pendingIntent, MediaSessionRecord.this.mPackageName);
    ...
    public void setMediaButtonBroadcastReceiver(ComponentName componentName) {
      ...
      if (componentName != null) {
        try {
          if (!TextUtils.equals(
              MediaSessionRecord.this.mPackageName, componentName.getPackageName())) {
            EventLog.writeEvent(1397638484, "238177121", -1, "");
            throw new IllegalArgumentException(
                "receiver does not belong to package name provided to MediaSessionRecord. Pkg = "
                    + MediaSessionRecord.this.mPackageName
                    + ", Receiver Pkg = "
      ...
      if (!MediaSessionRecord.componentNameExists(
          componentName, MediaSessionRecord.this.mContext, MediaSessionRecord.this.mUserId)) {
        ...
        Log.w(
            "MediaSessionRecord",
            "setMediaButtonBroadcastReceiver(): Ignoring invalid component name=" + componentName);
        return;
      }
      MediaSessionRecord mediaSessionRecord = MediaSessionRecord.this;
      mediaSessionRecord.mMediaButtonReceiverHolder =
          MediaButtonReceiverHolder.create(mediaSessionRecord.mUserId, componentName);
      MediaSessionRecord.this.mService.onMediaButtonReceiverChanged(MediaSessionRecord.this);
    }
      ...
      for (String str : MediaSessionRecord.ART_URIS) {
        ...
        if (!TextUtils.isEmpty(string)) {
          ...
          if ("content".equals(parse.getScheme())) {
            try {
              MediaSessionRecord.this.mUgmInternal.checkGrantUriPermission(
                  MediaSessionRecord.this.getUid(),
                  MediaSessionRecord.this.getPackageName(),
                  ContentProvider.getUriWithoutUserId(parse),
                  1,
                  ContentProvider.getUserIdFromUri(parse, MediaSessionRecord.this.getUserId()));
    ...
    public void setPlaybackState(PlaybackState playbackState) {
      boolean z = false;
      int state =
          MediaSessionRecord.this.mPlaybackState == null
              ? 0
              : MediaSessionRecord.this.mPlaybackState.getState();
      int state2 = playbackState == null ? 0 : playbackState.getState();
      if (MediaSessionRecord.ALWAYS_PRIORITY_STATES.contains(Integer.valueOf(state2))
          || (!MediaSessionRecord.TRANSITION_PRIORITY_STATES.contains(Integer.valueOf(state))
              && MediaSessionRecord.TRANSITION_PRIORITY_STATES.contains(Integer.valueOf(state2)))) {
        z = true;
      }
      synchronized (MediaSessionRecord.this.mLock) {
    ...
    public IBinder getBinderForSetQueue() {
      return new ParcelableListBinder(
          MediaSession.QueueItem.class,
          new Consumer() { // from class:
            // com.android.server.media.MediaSessionRecord$SessionStub$$ExternalSyntheticLambda0
  ...
  public class SessionCb {
    ...
    public boolean sendMediaButton(
      ...
      try {
        if (KeyEvent.isMediaSessionKey(keyEvent.getKeyCode())) {
          MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
              MediaSessionRecord.this.getUid(),
              MediaSessionRecord.this.getPackageName(),
              i,
              i2,
        ...
        if (z) {
          this.mCb.onMediaButton(
              MediaSessionRecord.this.mContext.getPackageName(),
              Process.myPid(),
              1000,
    ...
    public void sendCustomAction(String str, int i, int i2, String str2, Bundle bundle) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:custom-" + str2);
    ...
    public void prepareFromMediaId(String str, int i, int i2, String str2, Bundle bundle) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:prepareFromMediaId");
    ...
    public void prepareFromSearch(String str, int i, int i2, String str2, Bundle bundle) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:prepareFromSearch");
    ...
    public void prepareFromUri(String str, int i, int i2, Uri uri, Bundle bundle) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:prepareFromUri");
    ...
    public void playFromMediaId(String str, int i, int i2, String str2, Bundle bundle) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:playFromMediaId");
    ...
    public void playFromSearch(String str, int i, int i2, String str2, Bundle bundle) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:playFromSearch");
    ...
    public void playFromUri(String str, int i, int i2, Uri uri, Bundle bundle) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:playFromUri");
    ...
    public void skipToTrack(String str, int i, int i2, long j) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:skipToTrack");
    ...
    public void fastForward(String str, int i, int i2) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:fastForward");
    ...
    public void setPlaybackSpeed(String str, int i, int i2, float f) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:setPlaybackSpeed");
    ...
    public void adjustVolume(String str, int i, int i2, boolean z, int i3) {
      try {
        ...
        if (z) {
          this.mCb.onAdjustVolume(
              MediaSessionRecord.this.mContext.getPackageName(), Process.myPid(), 1000, i3);
        } else {
    ...
    public void setVolumeTo(String str, int i, int i2, int i3) {
      try {
        MediaSessionRecord.this.mService.tempAllowlistTargetPkgIfPossible(
            ...
            i2,
            str,
            "MediaSessionRecord:setVolumeTo");
  ...
  public class ControllerStub extends ISessionController.Stub {
    ...
    public void sendCommand(String str, String str2, Bundle bundle, ResultReceiver resultReceiver) {
      MediaSessionRecord.this.mSessionCb.sendCommand(
          str, Binder.getCallingPid(), Binder.getCallingUid(), str2, bundle, resultReceiver);
    }

    public boolean sendMediaButton(String str, KeyEvent keyEvent) {
      return MediaSessionRecord.this.mSessionCb.sendMediaButton(
          str, Binder.getCallingPid(), Binder.getCallingUid(), false, keyEvent);
    }

    public void registerCallback(
        String str, final ISessionControllerCallback iSessionControllerCallback) {
      synchronized (MediaSessionRecord.this.mLock) {
        ...
        if (MediaSessionRecord.this.getControllerHolderIndexForCb(iSessionControllerCallback) < 0) {
          ISessionControllerCallbackHolder iSessionControllerCallbackHolder =
              ...
              .new ISessionControllerCallbackHolder(
                  ...
                  new IBinder.DeathRecipient() { // from class:
                    // com.android.server.media.MediaSessionRecord$ControllerStub$$ExternalSyntheticLambda0
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
                      MediaSessionRecord.ControllerStub.this.lambda$registerCallback$0(
                          iSessionControllerCallback);
                    }
                  });
          ...
          try {
            iSessionControllerCallback
                .asBinder()
                .linkToDeath(iSessionControllerCallbackHolder.mDeathMonitor, 0);
          } catch (RemoteException e) {
      ...
      synchronized (MediaSessionRecord.this.mLock) {
        ...
        while (it.hasNext()) {
          ...
          if (asBinder.equals(iSessionControllerCallbackHolder.mCallback.asBinder())) {
            ...
            MediaSessionRecord.this.mControllerCallbackHolders.remove(
                iSessionControllerCallbackHolder);
            if (MediaSessionRecord.DEBUG) {
              Log.d(
                  "MediaSessionRecord",
                  "unregistering callback " + iSessionControllerCallback + " / " + asBinder);
            }
            return;
          }
        }
    ...
    public void adjustVolume(String str, String str2, int i, int i2) {
      ...
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        MediaSessionRecord.this.adjustVolume(
            str, str2, callingPid, callingUid, false, i, i2, false);
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
    ...
    public void prepareFromMediaId(String str, String str2, Bundle bundle) {
      MediaSessionRecord.this.mSessionCb.prepareFromMediaId(
          str, Binder.getCallingPid(), Binder.getCallingUid(), str2, bundle);
    }

    public void prepareFromSearch(String str, String str2, Bundle bundle) {
      MediaSessionRecord.this.mSessionCb.prepareFromSearch(
          str, Binder.getCallingPid(), Binder.getCallingUid(), str2, bundle);
    }

    public void prepareFromUri(String str, Uri uri, Bundle bundle) {
      MediaSessionRecord.this.mSessionCb.prepareFromUri(
          str, Binder.getCallingPid(), Binder.getCallingUid(), uri, bundle);
    }
    ...
    public void playFromMediaId(String str, String str2, Bundle bundle) {
      MediaSessionRecord.this.mSessionCb.playFromMediaId(
          str, Binder.getCallingPid(), Binder.getCallingUid(), str2, bundle);
    }

    public void playFromSearch(String str, String str2, Bundle bundle) {
      MediaSessionRecord.this.mSessionCb.playFromSearch(
          str, Binder.getCallingPid(), Binder.getCallingUid(), str2, bundle);
    }

    public void playFromUri(String str, Uri uri, Bundle bundle) {
      MediaSessionRecord.this.mSessionCb.playFromUri(
          str, Binder.getCallingPid(), Binder.getCallingUid(), uri, bundle);
    }

    public void skipToQueueItem(String str, long j) {
      MediaSessionRecord.this.mSessionCb.skipToTrack(
          str, Binder.getCallingPid(), Binder.getCallingUid(), j);
    }
    ...
    public void seekTo(String str, long j) {
      MediaSessionRecord.this.mSessionCb.seekTo(
          str, Binder.getCallingPid(), Binder.getCallingUid(), j);
    }

    public void rate(String str, Rating rating) {
      MediaSessionRecord.this.mSessionCb.rate(
          str, Binder.getCallingPid(), Binder.getCallingUid(), rating);
    }

    public void setPlaybackSpeed(String str, float f) {
      MediaSessionRecord.this.mSessionCb.setPlaybackSpeed(
          str, Binder.getCallingPid(), Binder.getCallingUid(), f);
    }

    public void sendCustomAction(String str, String str2, Bundle bundle) {
      MediaSessionRecord.this.mSessionCb.sendCustomAction(
          str, Binder.getCallingPid(), Binder.getCallingUid(), str2, bundle);
    }
    ...
    public ParceledListSlice getQueue() {
      ...
      synchronized (MediaSessionRecord.this.mLock) {
        parceledListSlice =
            MediaSessionRecord.this.mQueue == null
                ? null
                : new ParceledListSlice(MediaSessionRecord.this.mQueue);
      }
  ...
  public class ISessionControllerCallbackHolder {
    ...
    public ISessionControllerCallbackHolder(
        ISessionControllerCallback iSessionControllerCallback,
        String str,
        int i,
