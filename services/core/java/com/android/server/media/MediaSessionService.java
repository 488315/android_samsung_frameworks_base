...
public class MediaSessionService extends SystemService implements Watchdog.Monitor {
    ...
    public static /* bridge */ /* synthetic */ MediaKeyDispatcher m8558$$Nest$fgetmCustomMediaKeyDispatcher(MediaSessionService mediaSessionService) {
    ...
    */
        ...
        try {
            ...
            if (i != i3) {
                ...
                if (!canAllowWhileInUsePermissionInFgs && !this.mActivityManagerLocal.canStartForegroundService(i2, i3, str2)) {
                    ...
                    if (z) {
                        ((PowerExemptionManager) this.mContext.createContextAsUser(UserHandle.of(UserHandle.getUserId(i)), 0).getSystemService(PowerExemptionManager.class)).addToTemporaryAllowList(str, FrameworkStatsLog.f90x54490b7, str3, MediaSessionDeviceConfig.getMediaSessionCallbackFgsAllowlistDurationMs());
                    }
                }
                z = true;
            ...
            if (str != null) {
                try {
                    if (!TextUtils.isEmpty(str)) {
                        CurrentDeviceManager$$ExternalSyntheticThrowCCEIfNotNull0.m4m(Class.forName(str).getDeclaredConstructor(Context.class).newInstance(this.mContext));
                    }
        ...
        public void addSessionsListener(IActiveSessionsListener iActiveSessionsListener, ComponentName componentName, int i) {
            ...
            try {
                ...
                synchronized (MediaSessionService.this.mLock) {
                    ...
                    SessionsListenerRecord sessionsListenerRecord = MediaSessionService.this.new SessionsListenerRecord(iActiveSessionsListener, componentName, verifySessionsRequest, callingPid, callingUid);
                    try {
            ...
            try {
                ...
                synchronized (MediaSessionService.this.mLock) {
                    if (MediaSessionService.this.findIndexOfSession2TokensListenerLocked(iSession2TokensListener) >= 0) {
                        ...
                        MediaSessionService.this.mSession2TokensListenerRecords.add(MediaSessionService.this.new Session2TokensListenerRecord(iSession2TokensListener, handleIncomingUser));
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
        ...
        */
        ...
        public final void dispatchMediaKeyEventLocked(String str, int i, int i2, boolean z, KeyEvent keyEvent, boolean z2) {
            ...
            if (MediaSessionService.this.mHighPriorityMediaKeyReceiver != null) {
                ...
                makeBasic.setTemporaryAppAllowlist(MediaSessionDeviceConfig.getMediaButtonReceiverFgsAllowlistDurationMs(), 0, FrameworkStatsLog.f89x74364b3b, "");
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    synchronized (MediaSessionService.this.mLock) {
                        ...
                        sessionManagerImpl.dispatchAdjustVolumeLocked(this.mPackageName, this.mOpPackageName, MediaSessionService.this.mSystemServerPid, 1000, true, this.mStream, this.mDirection, this.mFlags, z);
                    }
                }
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final MediaSessionRecord getMultiSoundSessionLocked(KeyEvent keyEvent, MediaSessionRecord mediaSessionRecord) {
        InputDevice device;
        if ((mediaSessionRecord != null && mediaSessionRecord.hasFlag(65536)) || (device = InputDevice.getDevice(keyEvent.getDeviceId())) == null) {
            return mediaSessionRecord;
        }
        ...
        if (fullUserRecordLocked == null) {
            Log.w("MediaSessionService", "getFullUserRecordLocked failed. No user with id=" + currentUserId);
            return mediaSessionRecord;
        }
        List<MediaSessionRecord> activeSessionsSortedPlayback = fullUserRecordLocked.mPriorityStack.getActiveSessionsSortedPlayback(currentUserId);
        ...
        for (MediaSessionRecord mediaSessionRecord3 : activeSessionsSortedPlayback) {
            if (mediaSessionRecord3.hasFlag(65536)) {
                ...
                if ((z && appDevice == 128) || ((equals && appDevice == 8) || (this.mIsAppCastingOn && appDevice != 32768))) {
                    mediaSessionRecord2 = mediaSessionRecord3;
                }
            }
        }
        if (mediaSessionRecord2 == null) {
            return (mediaSessionRecord != null || activeSessionsSortedPlayback.size() == 0) ? mediaSessionRecord : (MediaSessionRecord) activeSessionsSortedPlayback.get(0);
        }
        Log.d("MediaSessionService", "package " + mediaSessionRecord2.getPackageName() + " is selected");
