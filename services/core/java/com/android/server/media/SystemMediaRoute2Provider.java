...
public class SystemMediaRoute2Provider extends MediaRoute2Provider {
  ...
  public final AudioManager.OnDevicesForAttributesChangedListener
  ...
  public class C18991 implements AudioManager.OnDevicesForAttributesChangedListener {
    public C18991() {}

    public void onDevicesForAttributesChanged(AudioAttributes audioAttributes, final List list) {
      Log.i(
          "MR2SystemProvider",
          "onDevicesForAttributesChanged AudioDeviceAttributes = "
              + audioAttributes.toString()
              + " devices = "
              + list.toString());
      ...
      SystemMediaRoute2Provider.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.media.SystemMediaRoute2Provider$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              SystemMediaRoute2Provider.C18991.this.lambda$onDevicesForAttributesChanged$0(list);
            }
          });
    }
  ...
  public SystemMediaRoute2Provider(Context context, UserHandle userHandle) {
    ...
    this.mOnDevicesForAttributesChangedListener = c18991;
    ...
    this.mBluetoothRouteController =
        BluetoothRouteController.createInstance(
            context,
            new BluetoothRouteController.BluetoothRoutesUpdatedListener() { // from class:
              // com.android.server.media.SystemMediaRoute2Provider$$ExternalSyntheticLambda3
    ...
    this.mDeviceRouteController =
        DeviceRouteController.createInstance(
            context,
            new DeviceRouteController.OnDeviceRouteChangedListener() { // from class:
              // com.android.server.media.SystemMediaRoute2Provider$$ExternalSyntheticLambda4
    ...
    audioManager.addOnDevicesForAttributesChangedListener(
        audioAttributes, context.getMainExecutor(), c18991);
  ...
  public /* synthetic */ void lambda$new$2(MediaRoute2Info mediaRoute2Info) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.media.SystemMediaRoute2Provider$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void start() {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.media.SystemMediaRoute2Provider$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void stop() {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.media.SystemMediaRoute2Provider$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public RoutingSessionInfo generateDeviceRouteSelectedSessionInfo(String str) {
    synchronized (this.mLock) {
      ...
      RoutingSessionInfo.Builder systemSession =
          new RoutingSessionInfo.Builder("SYSTEM_SESSION", str).setSystemSession(true);
  ...
  public final void updateSelectedAudioDevice(List list) {
    ...
    if (AudioAttributesUtils.isDeviceOutputAttributes(audioDeviceAttributes)) {
      this.mDeviceRouteController.selectRoute(
          Integer.valueOf(AudioAttributesUtils.mapToMediaRouteType(audioDeviceAttributes)));
  ...
  public boolean updateSessionInfosIfNeeded() {
    ...
    synchronized (this.mLock) {
      RoutingSessionInfo routingSessionInfo =
          this.mSessionInfos.isEmpty() ? null : (RoutingSessionInfo) this.mSessionInfos.get(0);
      RoutingSessionInfo.Builder systemSession =
          new RoutingSessionInfo.Builder("SYSTEM_SESSION", "").setSystemSession(true);
      MediaRoute2Info deviceRoute = this.mDeviceRouteController.getDeviceRoute();
      ...
      this.mDefaultRoute =
          new MediaRoute2Info.Builder("DEFAULT_ROUTE", deviceRoute)
              .setSystemRoute(true)
      ...
      this.mDefaultSessionInfo =
          new RoutingSessionInfo.Builder("SYSTEM_SESSION", "")
              .setProviderId(this.mUniqueId)
              .setSystemSession(true)
              .addSelectedRoute("DEFAULT_ROUTE")
              .build();
      return true;
    }
  }
  ...
  public class AudioManagerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      if (intent
        ...
        if (intent.getIntExtra("com.samsung.android.bluetooth.cast.device.extra.REMOTEROLE", 0)
            == 2) {
        ...
        SystemMediaRoute2Provider.this.postDeviceRoute(
            "SCREEN_MIRRORING",
            intent.getIntExtra(LauncherConfigurationInternal.KEY_STATE_BOOLEAN, 0) == 1,
            25);
      }
      if ((intent.getAction().equals("android.media.VOLUME_CHANGED_ACTION")
              || intent.getAction().equals("android.media.STREAM_DEVICES_CHANGED_ACTION"))
  ...
  public final MediaRoute2Info buildDeviceRoute(String str, boolean z, int i) {
    ...
    MediaRoute2Info build =
        new MediaRoute2Info.Builder(
                ...
                this.mContext
                    .getResources()
                    .getText(R.string.fingerprint_error_vendor_unknown)
                    .toString())
            .setVolumeHandling(!this.mAudioManager.isVolumeFixed() ? 1 : 0)
            ...
            .addFeature("android.media.route.feature.LIVE_VIDEO")
