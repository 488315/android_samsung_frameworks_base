...
public class LegacyBluetoothRouteController implements BluetoothRouteController {
    ...
    for (BluetoothRouteInfo bluetoothRouteInfo : this.mActiveRoutes) {
      if (bluetoothRouteInfo.mRoute.getType() == i3) {
        bluetoothRouteInfo.mRoute =
            new MediaRoute2Info.Builder(bluetoothRouteInfo.mRoute).setVolume(i2).build();
        z = true;
      }
    }
    if (z) {
  ...
  public final void addActiveDevices(BluetoothDevice bluetoothDevice) {
    BluetoothRouteInfo bluetoothRouteInfo =
        (BluetoothRouteInfo) this.mBluetoothRoutes.get(bluetoothDevice.getAddress());
    if (bluetoothRouteInfo == null) {
    ...
    for (BluetoothRouteInfo bluetoothRouteInfo2 : this.mBluetoothRoutes.values()) {
      if (TextUtils.equals(bluetoothRouteInfo2.mRoute.getId(), bluetoothRouteInfo.mRoute.getId())
          && !TextUtils.equals(
  ...
  public final class BluetoothProfileListener implements BluetoothProfile.ServiceListener {
    ...
    public void onServiceConnected(int i, BluetoothProfile bluetoothProfile) {
      ...
      if (i == 2) {
        ...
        LegacyBluetoothRouteController.this.mHearingAidProfile =
      ...
      for (BluetoothDevice bluetoothDevice : bluetoothProfile.getConnectedDevices()) {
        BluetoothRouteInfo bluetoothRouteInfo =
            (BluetoothRouteInfo)
                LegacyBluetoothRouteController.this.mBluetoothRoutes.get(
                    bluetoothDevice.getAddress());
        if (bluetoothRouteInfo == null) {
          bluetoothRouteInfo =
              LegacyBluetoothRouteController.this.createBluetoothRoute(bluetoothDevice);
          LegacyBluetoothRouteController.this.mBluetoothRoutes.put(
              bluetoothDevice.getAddress(), bluetoothRouteInfo);
        }
  ...
  public class DeviceStateChangedReceiver extends BroadcastReceiver {
      ...
      switch (action) {
        ...
        case "android.bluetooth.action.LE_AUDIO_ACTIVE_DEVICE_CHANGED":
          ...
          if (bluetoothDevice != null) {
            if (LegacyBluetoothRouteController.DEBUG) {
              Log.d(
                  "LBtRouteProvider", "Setting active le audio devices. device=" + bluetoothDevice);
            }
        ...
        case "android.bluetooth.a2dp.profile.action.ACTIVE_DEVICE_CHANGED":
          ...
          if (bluetoothDevice != null) {
            ...
            legacyBluetoothRouteController.addActiveRoute(
                (BluetoothRouteInfo)
                    legacyBluetoothRouteController.mBluetoothRoutes.get(
                        bluetoothDevice.getAddress()));
          }
          LegacyBluetoothRouteController.this.notifyBluetoothRoutesUpdated();
          break;
        case "android.bluetooth.hearingaid.profile.action.ACTIVE_DEVICE_CHANGED":
          ...
          if (bluetoothDevice != null) {
            if (LegacyBluetoothRouteController.DEBUG) {
              Log.d(
                  "LBtRouteProvider",
                  "Setting active hearing aid devices. device=" + bluetoothDevice);
            }
            LegacyBluetoothRouteController.this.addActiveDevices(bluetoothDevice);
          }
          LegacyBluetoothRouteController.this.notifyBluetoothRoutesUpdated();
    ...
    public final void handleConnectionStateChanged(
      ...
      if ((intExtra == 3 || intExtra == 0) && bluetoothRouteInfo != null) {
        ...
        if (bluetoothRouteInfo.mConnectedProfiles.size() == 0) {
          LegacyBluetoothRouteController legacyBluetoothRouteController =
              LegacyBluetoothRouteController.this;
          legacyBluetoothRouteController.removeActiveRoute(
              (BluetoothRouteInfo)
                  legacyBluetoothRouteController.mBluetoothRoutes.remove(
                      bluetoothDevice.getAddress()));
          LegacyBluetoothRouteController.this.notifyBluetoothRoutesUpdated();
        }
      }
