...
public final class MediaMetricsManagerService extends SystemService {
  ...
  public final class BinderService extends IMediaMetricsManager.Stub {
    ...
    public void reportPlaybackMetrics(String str, PlaybackMetrics playbackMetrics, int i) {
      ...
      StatsLog.write(
          StatsEvent.newBuilder()
              ...
              .writeString(Base64.encodeToString(playbackMetrics.getDrmSessionId(), 0))
              .usePooledBuffer()
              .build());
    }
    ...
    public void releaseSessionId(String str, int i) {
      Slog.v(
          "MediaMetricsManagerService",
          "Releasing sessionId " + str + " for userId " + i + " [NOP]");
    }
    ...
    public void reportTrackChangeEvent(String str, TrackChangeEvent trackChangeEvent, int i) {
      ...
      StatsLog.write(
          StatsEvent.newBuilder()
              .setAtomId(FrameworkStatsLog.f58x60da79b1)
              .writeString(str)
        ...
        if (MediaMetricsManagerService.this.mMode == null) {
          ...
          try {
            MediaMetricsManagerService.this.mMode =
                Integer.valueOf(DeviceConfig.getInt("media", "media_metrics_mode", 2));
            Binder.restoreCallingIdentity(clearCallingIdentity);
          } catch (Throwable th) {
            Binder.restoreCallingIdentity(clearCallingIdentity);
            throw th;
          ...
          if (MediaMetricsManagerService.this.mMode.intValue() == 2) {
            if (MediaMetricsManagerService.this.mBlockList == null) {
              ...
              mediaMetricsManagerService.mBlockList =
                  mediaMetricsManagerService.getListLocked("player_metrics_app_blocklist");
              if (MediaMetricsManagerService.this.mBlockList == null) {
                Slog.v(
                    "MediaMetricsManagerService",
                    "Logging level blocked: Failed to get PLAYER_METRICS_APP_BLOCKLIST.");
                return 99999;
              }
            }
            ...
            if (MediaMetricsManagerService.this.mNoUidBlocklist == null) {
              ...
              mediaMetricsManagerService2.mNoUidBlocklist =
                  mediaMetricsManagerService2.getListLocked(
          ...
          if (MediaMetricsManagerService.this.mMode.intValue() == 3) {
            if (MediaMetricsManagerService.this.mNoUidAllowlist == null) {
              ...
              mediaMetricsManagerService3.mNoUidAllowlist =
                  mediaMetricsManagerService3.getListLocked(
            ...
            if (MediaMetricsManagerService.this.mAllowlist == null) {
              ...
              mediaMetricsManagerService4.mAllowlist =
                  mediaMetricsManagerService4.getListLocked("player_metrics_app_allowlist");
              if (MediaMetricsManagerService.this.mAllowlist == null) {
                Slog.v(
                    "MediaMetricsManagerService",
                    "Logging level blocked: Failed to get PLAYER_METRICS_APP_ALLOWLIST.");
                return 99999;
              }
            }
