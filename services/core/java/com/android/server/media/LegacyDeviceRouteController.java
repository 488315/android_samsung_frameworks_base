...
public final class LegacyDeviceRouteController implements DeviceRouteController {
  ...
  public LegacyDeviceRouteController(
    ...
    try {
      ...
      Slog.w(
          "LDeviceRouteController", "Cannot connect to audio service to start listen to routes", e);
    }
  ...
  */
  public final MediaRoute2Info createRouteFromAudioInfo(AudioRoutesInfo audioRoutesInfo) {
    ...
    if (audioRoutesInfo != null) {
      ...
      int i4 = i3 & 2;
      i = R.string.fingerprint_or_screen_lock_dialog_default_subtitle;
      if (i4 != 0) {
        i2 = 4;
      } else if ((i3 & 1) != 0) {
        i2 = 3;
        ...
        i2 = 13;
        i = R.string.fingerprint_name_template;
      } else if ((i3 & 8) != 0) {
        i2 = 9;
        i = R.string.fingerprint_or_screen_lock_app_setting_name;
      } else if ((i3 & 16) != 0) {
        i2 = 11;
        i = R.string.fingerprint_recalibrate_notification_content;
      }
      synchronized (this) {
        build =
            new MediaRoute2Info.Builder(
                    "DEVICE_ROUTE", this.mContext.getResources().getText(i).toString())
    ...
    i = R.string.fingerprint_error_vendor_unknown;
    i2 = 2;
    synchronized (this) {
    }
  }
