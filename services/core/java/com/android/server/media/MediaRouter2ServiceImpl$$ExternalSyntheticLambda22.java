...
public final /* synthetic */ class MediaRouter2ServiceImpl$$ExternalSyntheticLambda22
        ...
        switch (i) {
            case 0:
                return TextUtils.equals(
                        ((MediaRouter2ServiceImpl.ManagerRecord) obj).mOwnerPackageName,
                        (String) obj2);
            case 1:
                ...
                if (managerRecord.mScanningState == 1) {
                    if (mediaRouter2ServiceImpl.mActivityManager.getPackageImportance(
            ...
            default:
                ...
                return ((MediaRouter2ServiceImpl) obj2)
                                        .mActivityManager.getPackageImportance(
                                                routerRecord.mPackageName)
                                <= 100
                        || routerRecord.mScanningState == 2;
        }
    }
}
