...
public final /* synthetic */ class CountryDetectorService$$ExternalSyntheticLambda1
        implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ CountryDetectorService f$0;
    public final /* synthetic */ Object f$1;

    public /* synthetic */ CountryDetectorService$$ExternalSyntheticLambda1(
            CountryDetectorService countryDetectorService, Object obj, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                ...
                countryDetectorService.mCountryDetector.setCountryListener(
                        (CountryListener) this.f$1);
                return;
            default:
                ...
                synchronized (countryDetectorService2.mReceivers) {
                    ...
                    while (it.hasNext()) {
                        try {
                            ((CountryDetectorService.Receiver) it.next())
