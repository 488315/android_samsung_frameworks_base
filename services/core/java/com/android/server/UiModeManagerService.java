...
public final class UiModeManagerService extends SystemService {
                    ...
                    if (UiModeManagerService.this.mNightMode == 0) {
                        ...
                        if (uiModeManagerService.mSystemReady) {
                            ...
                            if (UiModeManagerService.this.mAutoModeChangeImmediately) {
                                LogWrapper.m0i(UiModeManagerService.TAG, "Twilight state is changed immediately after MODE_NIGHT_AUTO setting");
                            }
                            UiModeManagerService.this.updateLocked(0, 0);
                        }
                    }
    ...
    public void onStart() {
        ...
        this.mStartDreamImmediatelyOnDock = resources.getBoolean(R.bool.config_searchAllEntrypointsEnabledDefault);
        this.mDreamsDisabledByAmbientModeSuppression = resources.getBoolean(R.bool.config_disableLockscreenByDefault);
        this.mNightMode = resources.getInteger(R.integer.config_displayWhiteBalanceBrightnessSensorRate);
        this.mDefaultUiModeType = resources.getInteger(R.integer.config_displayWhiteBalanceTransitionTimeIncrease);
        this.mCarModeKeepsScreenOn = resources.getInteger(R.integer.config_defaultNightDisplayAutoMode) == 1;
        this.mDeskModeKeepsScreenOn = resources.getInteger(R.integer.config_doubleTapOnHomeBehavior) == 1;
        ...
        this.mNightModeLocked = resources.getBoolean(R.bool.config_isCameraCompatControlForStretchedIssuesEnabled);
    ...
    public final void updateNightModeFromSettingsLocked(Context context, Resources resources, int i) {
        ...
        this.mNightMode = Settings.Secure.getIntForUser(context.getContentResolver(), "ui_night_mode", resources.getInteger(R.integer.config_displayWhiteBalanceBrightnessSensorRate), i);
                ...
                synchronized (UiModeManagerService.this.mLock) {
                    UiModeManagerService.this.setCarModeLocked(false, i2, ((Integer) UiModeManagerService.this.mCarModePackagePriority.entrySet().stream().filter(new Predicate() { // from class: com.android.server.UiModeManagerService$15$$ExternalSyntheticLambda0
                        ...
                        public final boolean test(Object obj) {
                            ...
                            lambda$disableCarModeByCallingPackage$0 = UiModeManagerService.IUiModeManagerStubC036615.lambda$disableCarModeByCallingPackage$0(str, (Map.Entry) obj);
            ...
            try {
                synchronized (UiModeManagerService.this.mLock) {
                    if (UiModeManagerService.this.mNightMode != i || UiModeManagerService.this.mNightModeCustomType != i2) {
                        ...
                        LogWrapper.m0i(UiModeManagerService.TAG, "setNightMode : " + i + ", customModeType : " + i2 + ", by " + Binder.getCallingPid() + ", " + UiModeManagerService.this.getContext().getPackageManager().getNameForUid(Binder.getCallingUid()) + ", " + UiModeManagerService.this.getPackageName());
        ...
        */
        public final boolean setNightModeActivatedForModeInternal(int i, boolean z) {
            ...
            if (!UiModeManagerService.this.canSetNightMode()) {
                Log.i(UiModeManagerService.TAG, "Ignore setNightModeActivated : " + z + ", mNightMode " + UiModeManagerService.this.mNightMode);
                return false;
            }
            ...
            synchronized (UiModeManagerService.this.mLock) {
                ...
                try {
                    if (UiModeManagerService.this.mNightMode != 0 && UiModeManagerService.this.mNightMode != 3) {
                        ...
                        LogWrapper.m0i(UiModeManagerService.TAG, "setNightModeActivated : " + z + " by " + callingPid + ", " + nameForUid + ", " + packageName + ", mNightMode " + UiModeManagerService.this.mNightMode + ", mNightModeCustomType " + UiModeManagerService.this.mNightModeCustomType);
                        UiModeManagerService.this.updateConfigurationLocked();
    ...
    */
    ...
    public final void adjustStatusBarCarModeLocked() {
        ...
        if (notificationManager != null) {
            if (this.mCarModeEnabled) {
                this.mNotificationManager.notifyAsUser(null, 10, new Notification.Builder(context, SystemNotificationChannels.CAR_MODE).setSmallIcon(17304204).setDefaults(4).setOngoing(true).setWhen(0L).setColor(context.getColor(R.color.system_notification_accent_color)).setContentTitle(context.getString(R.string.config_mobile_hotspot_provision_app_no_ui)).setContentText(context.getString(R.string.config_mms_user_agent_profile_url)).setContentIntent(PendingIntent.getActivityAsUser(context, 0, new Intent(context, (Class<?>) DisableCarModeActivity.class), 33554432, null, UserHandle.CURRENT)).build(), UserHandle.ALL);
            } else {
    ...
    public final class LocalService extends UiModeManagerInternal {
        ...
        public void onEarlySwitchUser(int i) {
            ...
            synchronized (UiModeManagerService.this.mLock) {
                ...
                UiModeManagerService.this.resetNightModeOverrideLocked();
                LogWrapper.m0i(UiModeManagerService.TAG, "onEarlySwitchUser : " + UiModeManagerService.this.mNightMode + " userID : " + i);
                UiModeManagerService.this.updateLocked(0, 0);
                UiModeManagerService.this.cancelCustomAlarm();
