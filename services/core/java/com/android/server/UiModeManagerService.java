...
public final class UiModeManagerService extends SystemService {
  ...
  public UiModeManagerService(
    ...
    this.mResultReceiver =
        new BroadcastReceiver() { // from class: com.android.server.UiModeManagerService.1
          ...
          public void onReceive(Context context2, Intent intent) {
            ...
            synchronized (UiModeManagerService.this.mLock) {
              UiModeManagerService.this.updateAfterBroadcastLocked(
                  intent.getAction(), intExtra, intExtra2);
            }
          }
        };
    this.mDockModeReceiver =
        new BroadcastReceiver() { // from class: com.android.server.UiModeManagerService.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            UiModeManagerService.this.updateDockState(
                intent.getIntExtra("android.intent.extra.DOCK_STATE", 0));
          }
        };
    this.mBatteryReceiver =
        new BroadcastReceiver() { // from class: com.android.server.UiModeManagerService.3
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
              ...
              if (uiModeManagerService.mSystemReady
                  && (uiModeManagerService.mCarModeEnabled
                      || UiModeManagerService.isDeskDockState(
                          UiModeManagerService.this.mDockState))) {
    ...
    this.mTwilightListener =
        new TwilightListener() { // from class: com.android.server.UiModeManagerService.4
              ...
              if (UiModeManagerService.this.mNightMode == 0) {
                ...
                if (uiModeManagerService.mSystemReady) {
                  if (!uiModeManagerService.shouldApplyAutomaticChangesImmediately()
                      && !UiModeManagerService.this.mAutoModeChangeImmediately) {
                    UiModeManagerService.this.registerScreenOffEventLocked();
                  }
                  if (UiModeManagerService.this.mAutoModeChangeImmediately) {
                    LogWrapper.m0i(
                        UiModeManagerService.TAG,
                        "Twilight state is changed immediately after MODE_NIGHT_AUTO setting");
                  }
                  UiModeManagerService.this.updateLocked(0, 0);
                }
              }
    ...
    this.mOnScreenOffHandler =
        new BroadcastReceiver() { // from class: com.android.server.UiModeManagerService.5
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            synchronized (UiModeManagerService.this.mLock) {
    ...
    this.mOnTimeChangedHandler =
        new BroadcastReceiver() { // from class: com.android.server.UiModeManagerService.6
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            synchronized (UiModeManagerService.this.mLock) {
    ...
    this.mVrStateCallbacks =
        new IVrStateCallbacks.Stub() { // from class: com.android.server.UiModeManagerService.7
    ...
    this.mSetupWizardObserver =
        new ContentObserver(handler) { // from class: com.android.server.UiModeManagerService.8
            ...
            synchronized (UiModeManagerService.this.mLock) {
              if (UiModeManagerService.this.setupWizardCompleteForCurrentUser() && !z2) {
                ...
                UiModeManagerService.this
                    .getContext()
                    .getContentResolver()
                    .unregisterContentObserver(UiModeManagerService.this.mSetupWizardObserver);
                Context context2 = UiModeManagerService.this.getContext();
                UiModeManagerService.this.updateNightModeFromSettingsLocked(
                    context2, context2.getResources(), UserHandle.getCallingUserId());
                UiModeManagerService.this.updateLocked(0, 0);
              }
            }
          }
    ...
    this.mDarkThemeObserver =
        new ContentObserver(handler) { // from class: com.android.server.UiModeManagerService.9
          @Override // android.database.ContentObserver
          public void onChange(boolean z2, Uri uri) {
            UiModeManagerService.this.updateSystemProperties();
          }
        };
    this.mContrastObserver = new C036110(handler);
    this.mOnPackageAdded =
        new BroadcastReceiver() { // from class: com.android.server.UiModeManagerService.12
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            int intExtra;
            ...
            if (!("android.intent.action.PACKAGE_ADDED".equals(action)
                ...
                && UiModeManagerService.this.isNightPriorityAllowed(schemeSpecificPart)) {
              Log.i(
                  UiModeManagerService.TAG,
                  "onReceive : " + action + ", package : " + schemeSpecificPart + ", " + intExtra);
              ...
              synchronized (UiModeManagerService.this.mPackagesNeedToShowDialog) {
                UiModeManagerService.this.mPackagesNeedToShowDialog.putValue(
                    intExtra, schemeSpecificPart, Boolean.TRUE);
              }
            }
          }
        };
    this.mOnShutdown =
        new BroadcastReceiver() { // from class: com.android.server.UiModeManagerService.13
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            if (UiModeManagerService.this.mNightMode == 0) {
              UiModeManagerService uiModeManagerService = UiModeManagerService.this;
    ...
    this.mSettingsRestored =
        new BroadcastReceiver() { // from class: com.android.server.UiModeManagerService.14
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            if (Arrays.asList(
                    "ui_night_mode", "dark_theme_custom_start_time", "dark_theme_custom_end_time")
                .contains(intent.getExtras().getCharSequence("setting_name"))) {
              synchronized (UiModeManagerService.this.mLock) {
                UiModeManagerService.this.updateNightModeFromSettingsLocked(
                    context2, context2.getResources(), UserHandle.getCallingUserId());
    ...
    this.mService = new IUiModeManagerStubC036615();
    ...
    this.mNightPriorityAppliedPackages =
        new PackageFeatureUserChange(
            IInstalld.FLAG_USE_QUOTA, str, "NightModePriorityAppliedPackages");
    this.mPackagesNeedToShowDialog =
        new PackageFeatureUserChange(IInstalld.FLAG_FORCE, str, "NightModeShowDialogPackages");
  ...
  public class C036110 extends ContentObserver {
    public C036110(Handler handler) {
      super(handler);
    }
        ...
        if (UiModeManagerService.this.updateContrastLocked()) {
          ...
          ((RemoteCallbackList)
                  UiModeManagerService.this.mUiModeManagerCallbacks.get(
                      UiModeManagerService.this.mCurrentUser, new RemoteCallbackList()))
              .broadcast(
                  FunctionalUtils.ignoreRemoteException(
                      new FunctionalUtils.RemoteExceptionIgnoringConsumer() { // from class:
                        // com.android.server.UiModeManagerService$10$$ExternalSyntheticLambda0
  ...
  public final void updateSystemProperties() {
    int intForUser =
        Settings.Secure.getIntForUser(
            getContext().getContentResolver(), "ui_night_mode", this.mNightMode, 0);
      ...
      synchronized (this.mLock) {
        ...
        context
            ...
            .registerContentObserver(
                Settings.Secure.getUriFor("ui_night_mode"), false, this.mDarkThemeObserver, 0);
        context
            .getContentResolver()
            .registerContentObserver(
                Settings.Secure.getUriFor("contrast_level"), false, this.mContrastObserver, -1);
        context.registerReceiver(
            this.mDockModeReceiver, new IntentFilter("android.intent.action.DOCK_EVENT"));
        context.registerReceiver(
            this.mBatteryReceiver, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
        context.registerReceiver(
            this.mSettingsRestored, new IntentFilter("android.os.action.SETTING_RESTORED"));
        context.registerReceiver(
            this.mOnShutdown, new IntentFilter("android.intent.action.ACTION_SHUTDOWN"));
        ...
        context
            ...
            .registerContentObserver(
                ...
                false,
                new ContentObserver(
                    this.mHandler) { // from class: com.android.server.UiModeManagerService.11
                  @Override // android.database.ContentObserver
                  public void onChange(boolean z2, Uri uri) {
  ...
  public void onStart() {
    ...
    this.mStartDreamImmediatelyOnDock =
        resources.getBoolean(R.bool.config_searchAllEntrypointsEnabledDefault);
    this.mDreamsDisabledByAmbientModeSuppression =
        resources.getBoolean(R.bool.config_disableLockscreenByDefault);
    this.mNightMode =
        resources.getInteger(R.integer.config_displayWhiteBalanceBrightnessSensorRate);
    this.mDefaultUiModeType =
        resources.getInteger(R.integer.config_displayWhiteBalanceTransitionTimeIncrease);
    this.mCarModeKeepsScreenOn =
        resources.getInteger(R.integer.config_defaultNightDisplayAutoMode) == 1;
    this.mDeskModeKeepsScreenOn =
        resources.getInteger(R.integer.config_doubleTapOnHomeBehavior) == 1;
    this.mEnableCarDockLaunch = resources.getBoolean(R.bool.config_dozePulsePickup);
    this.mUiModeLocked = resources.getBoolean(R.bool.config_isCompatFakeFocusEnabled);
    this.mNightModeLocked =
        resources.getBoolean(R.bool.config_isCameraCompatControlForStretchedIssuesEnabled);
  ...
  public final void updateNightModeFromSettingsLocked(Context context, Resources resources, int i) {
    ...
    this.mCustomAutoNightModeStartMilliseconds =
        LocalTime.ofNanoOfDay(getCustomTimeToNano(longForUser));
    this.mCustomAutoNightModeEndMilliseconds =
        LocalTime.ofNanoOfDay(getCustomTimeToNano(longForUser2));
    if (this.mNightMode == 0) {
      this.mComputedNightMode =
          Settings.Secure.getIntForUser(
                  context.getContentResolver(), "ui_night_mode_last_computed", 0, i)
              != 0;
    }
    LogWrapper.m0i(TAG, "updateNightModeFromSettings : " + this.mNightMode + " userID : " + i);
  ...
  public final void registerScreenOffEventLocked() {
    ...
    getContext()
        .registerReceiver(
            this.mOnScreenOffHandler, new IntentFilter("android.intent.action.SCREEN_OFF"));
  }
  ...
  /* renamed from: com.android.server.UiModeManagerService$15 */
  public class IUiModeManagerStubC036615 extends IUiModeManager.Stub {
    public IUiModeManagerStubC036615() {}
    ...
    public void addCallback(IUiModeManagerCallback iUiModeManagerCallback) {
      ...
      synchronized (UiModeManagerService.this.mLock) {
        ...
        ((RemoteCallbackList) UiModeManagerService.this.mUiModeManagerCallbacks.get(callingUserId))
    ...
    public void enableCarMode(int i, int i2, String str) {
      ...
      if (i2 != 0
          && UiModeManagerService.this
                  .getContext()
                  .checkCallingOrSelfPermission("android.permission.ENTER_CAR_MODE_PRIORITIZED")
              != 0) {
      ...
      try {
        synchronized (UiModeManagerService.this.mLock) {
          UiModeManagerService.this.setCarModeLocked(
              ...
              i2,
              ((Integer)
                      UiModeManagerService.this.mCarModePackagePriority.entrySet().stream()
                          .filter(
                              new Predicate() { // from class:
                                // com.android.server.UiModeManagerService$15$$ExternalSyntheticLambda0
                                @Override // java.util.function.Predicate
                                public final boolean test(Object obj) {
                                  boolean lambda$disableCarModeByCallingPackage$0;
                                  lambda$disableCarModeByCallingPackage$0 =
                                      UiModeManagerService.IUiModeManagerStubC036615
                                          .lambda$disableCarModeByCallingPackage$0(
                                              str, (Map.Entry) obj);
                          ...
                          .findFirst()
                          .map(new UiModeManagerService$15$$ExternalSyntheticLambda1())
                          .orElse(0))
                  .intValue(),
              str);
          UiModeManagerService uiModeManagerService = UiModeManagerService.this;
    ...
    public static /* synthetic */ boolean lambda$disableCarModeByCallingPackage$0(
        String str, Map.Entry entry) {
    ...
    public final void setNightModeInternal(int i, int i2) {
      if (isNightModeLocked()
          && UiModeManagerService.this
                  .getContext()
                  .checkCallingOrSelfPermission("android.permission.MODIFY_DAY_NIGHT_MODE")
              != 0) {
        Slog.e(
            UiModeManagerService.TAG,
      ...
      try {
        synchronized (UiModeManagerService.this.mLock) {
          if (UiModeManagerService.this.mNightMode != i
              || UiModeManagerService.this.mNightModeCustomType != i2) {
            if (UiModeManagerService.this.mNightMode == 0
                || UiModeManagerService.this.mNightMode == 3) {
              UiModeManagerService.this.unregisterScreenOffEventLocked();
            ...
            LogWrapper.m0i(
                ...
                "setNightMode : "
                    ...
                    + ", "
                    + UiModeManagerService.this.getPackageName());
            UiModeManagerService.this.persistNightModeSettingDB(-2);
            if ((UiModeManagerService.this.mNightMode == 0
                    || UiModeManagerService.this.mNightMode == 3)
                && !UiModeManagerService.this.shouldApplyAutomaticChangesImmediately()
                && !UiModeManagerService.this.isWithInCustomScheduled()
                && !UiModeManagerService.this.mAutoModeChangeImmediately) {
              UiModeManagerService.this.registerScreenOffEventLocked();
            }
            UiModeManagerService.this.unregisterScreenOffEventLocked();
    ...
    public void setApplicationNightMode(int i) {
      ...
      ActivityTaskManagerInternal.PackageConfigurationUpdater createPackageConfigurationUpdater =
          UiModeManagerService.this.mActivityTaskManager.createPackageConfigurationUpdater();
    ...
    public int getPackageNightMode(String str, int i) {
      ...
      if (isNightPriorityApplied) {
        ActivityTaskManagerInternal.PackageConfig applicationConfig =
            UiModeManagerService.this.mActivityTaskManager.getApplicationConfig(str, i);
    ...
    public void setNightPriorityAllowedPackagesFromScpm(List list) {
      if (UiModeManagerService.this
              .getContext()
              .checkCallingOrSelfPermission("android.permission.INTERACT_ACROSS_USERS_FULL")
          != 0) {
        Slog.e(
            UiModeManagerService.TAG,
            "setNightPriorityAllowedPackagesFromScpm requires INTERACT_ACROSS_USERS_FULL"
                + " permission");
        return;
      }
      if (list == null) {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          UiModeManagerService.this.getContext(), UiModeManagerService.TAG, printWriter)) {
    ...
    */
    public final boolean setNightModeActivatedForModeInternal(int i, boolean z) {
      ...
      if (Binder.getCallingUserHandle().getIdentifier() != UiModeManagerService.this.mCurrentUser
          && UiModeManagerService.this
                  .getContext()
                  .checkCallingOrSelfPermission("android.permission.INTERACT_ACROSS_USERS")
              != 0) {
        Slog.e(
            UiModeManagerService.TAG,
            "Target user is not current user, INTERACT_ACROSS_USERS permission is required");
        return false;
      }
      if (i == 1) {
      ...
      if (!UiModeManagerService.this.canSetNightMode()) {
        Log.i(
            UiModeManagerService.TAG,
            "Ignore setNightModeActivated : "
                + z
                + ", mNightMode "
      ...
      String packageName = UiModeManagerService.this.getPackageName();
      synchronized (UiModeManagerService.this.mLock) {
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
          if (UiModeManagerService.this.mNightMode != 0
          ...
          if (UiModeManagerService.this.mComputedNightMode != z) {
            UiModeManagerService.this.mWaitForScreenOff = false;
          }
          UiModeManagerService.this.mComputedNightMode = z;
          Settings.System.putIntForUser(
              UiModeManagerService.this.getContext().getContentResolver(),
              "display_night_theme",
              z ? 1 : 0,
      ...
      synchronized (UiModeManagerService.this.mLock) {
        ...
        ProjectionHolder projectionHolder =
            new ProjectionHolder(
                ...
                i,
                iBinder,
                new ProjectionHolder.ProjectionReleaser() { // from class:
                  // com.android.server.UiModeManagerService$15$$ExternalSyntheticLambda2
                  ...
                  public final boolean release(int i3, String str2) {
                    ...
                    releaseProjectionUnchecked =
                        UiModeManagerService.this.releaseProjectionUnchecked(i3, str2);
    ...
    public int getActiveProjectionTypes() {
      ...
      UiModeManagerService.this
          ...
          .enforceCallingOrSelfPermission(
              "android.permission.READ_PROJECTION_STATE", "getActiveProjectionTypes");
      synchronized (UiModeManagerService.this.mLock) {
        i = 0;
        if (UiModeManagerService.this.mProjectionHolders != null) {
          int i2 = 0;
    ...
    public List getProjectingPackages(int i) {
      ...
      UiModeManagerService.this
          .getContext()
          .enforceCallingOrSelfPermission(
              "android.permission.READ_PROJECTION_STATE", "getProjectionState");
      synchronized (UiModeManagerService.this.mLock) {
    ...
    public void addOnProjectionStateChangedListener(
      ...
      UiModeManagerService.this
          .getContext()
          .enforceCallingOrSelfPermission(
              "android.permission.READ_PROJECTION_STATE", "addOnProjectionStateChangedListener");
      if (i == 0) {
        return;
      }
      synchronized (UiModeManagerService.this.mLock) {
        ...
        if (((RemoteCallbackList) UiModeManagerService.this.mProjectionListeners.get(i))
          ...
          if (!arrayList.isEmpty()) {
            try {
              ...
              Slog.w(
                  UiModeManagerService.TAG,
                  "Failed a call to onProjectionStateChanged() during listener registration.");
            }
          }
        }
      }
    ...
    public void removeOnProjectionStateChangedListener(
      ...
      UiModeManagerService.this
          .getContext()
          .enforceCallingOrSelfPermission(
              "android.permission.READ_PROJECTION_STATE", "removeOnProjectionStateChangedListener");
      synchronized (UiModeManagerService.this.mLock) {
        if (UiModeManagerService.this.mProjectionListeners != null) {
          for (int i = 0; i < UiModeManagerService.this.mProjectionListeners.size(); i++) {
            ((RemoteCallbackList) UiModeManagerService.this.mProjectionListeners.valueAt(i))
    ...
    if ((i & 1) != 0) {
      getContext()
          .enforceCallingPermission(
              "android.permission.TOGGLE_AUTOMOTIVE_PROJECTION", "toggleProjection");
    }
  }
  ...
  public final boolean releaseProjectionUnchecked(int i, String str) {
    ...
    synchronized (this.mLock) {
      ...
      if (z) {
        ...
        Slog.w(
            TAG,
            str + " tried to release projection type " + i + " but was not set by that package.");
      }
    }
    return z;
  }
  ...
  public final boolean updateContrastLocked() {
    float floatForUser =
        Settings.Secure.getFloatForUser(
            ...
            this.mCurrentUser);
    if (Math.abs(
            ((Float) this.mContrasts.get(this.mCurrentUser, Float.valueOf(Float.MAX_VALUE)))
                    .floatValue()
                - floatForUser)
        < 1.0E-10d) {
      return false;
  ...
  public class ProjectionHolder implements IBinder.DeathRecipient {
    ...
    public ProjectionHolder(
        String str, int i, IBinder iBinder, ProjectionReleaser projectionReleaser) {
    ...
    public final boolean linkToDeath() {
      try {
        ...
        Slog.e(
            UiModeManagerService.TAG,
            "linkToDeath failed for projection requester: " + this.mPackageName + ".",
            e);
        return false;
      }
    }
    ...
    public void binderDied() {
      Slog.w(
          ...
          "Projection holder "
              + this.mPackageName
              + " died. Releasing projection type "
      ...
      if ((i & keyAt) != 0) {
        ...
        for (int i3 = 0; i3 < beginBroadcast; i3++) {
          try {
            remoteCallbackList
                .getBroadcastItem(i3)
                .onProjectionStateChanged(populateWithRelevantActivePackageNames, arrayList);
          } catch (RemoteException unused) {
    ...
    if (this.mCarModeEnabled != isCarModeEnabled) {
      ...
      if (!isCarModeEnabled) {
        ...
        updateNightModeFromSettingsLocked(
            context, context.getResources(), UserHandle.getCallingUserId());
      }
    }
  ...
  public final void disableCarMode(int i, int i2, String str) {
    ...
    if (!(i2 == 0)
        && ((!contains
                || !((String) this.mCarModePackagePriority.get(Integer.valueOf(i2))).equals(str))
            && !z2)) {
      z = false;
    }
    if (z) {
  ...
  public final void notifyCarModeEnabled(int i, String str) {
    ...
    getContext()
        .sendBroadcastAsUser(intent, UserHandle.ALL, "android.permission.HANDLE_CAR_MODE_CHANGES");
  }
  ...
  public final void persistNightMode(int i) {
    ...
    Settings.Secure.putIntForUser(
        getContext().getContentResolver(), "ui_night_mode", this.mNightMode, i);
  ...
  public final void updateConfigurationLocked() {
    ...
    int computedUiModeConfiguration =
        (!this.mPowerSave || this.mCarModeEnabled || this.mCar)
            ? getComputedUiModeConfiguration(i)
            : (i & (-17)) | 32;
  ...
  public final boolean computeCustomNightMode() {
    return TimeUtils.isTimeBetween(
        LocalTime.now(),
        this.mCustomAutoNightModeStartMilliseconds,
        this.mCustomAutoNightModeEndMilliseconds);
  }
  ...
  public final void scheduleNextCustomTimeListener() {
    ...
    this.mAlarmManager.setExact(
        1,
        dateTimeAfter.atZone(ZoneId.systemDefault()).toInstant().toEpochMilli(),
        TAG,
        this.mCustomTimeListener,
        null);
  }
    ...
    if (str != null) {
      ...
      getContext()
          .sendOrderedBroadcastAsUser(
              intent, UserHandle.CURRENT, null, this.mResultReceiver, null, -1, null, null);
  ...
  */
    ...
    if (str != null) {
      ...
      if (Sandman.shouldStartDockApp(getContext(), buildHomeIntent)) {
        ...
        if (ActivityManager.isStartResultSuccessful(startActivityWithConfig)) {
          ...
          boolean z2 =
              !this.mDreamsDisabledByAmbientModeSuppression
                  && this.mLocalPowerManager.isAmbientDisplaySuppressed();
          if (str == null || z || z2) {
            return;
          }
          if (this.mStartDreamImmediatelyOnDock
        ...
        if (startActivityWithConfig != -91) {
          Slog.e(
              TAG,
              "Could not start dock app: "
                  + intent
                  + ", startActivityWithConfig result "
                  + startActivityWithConfig);
        }
      }
    }
      ...
      if (this.mCarModeEnabled) {
        this.mNotificationManager.notifyAsUser(
            ...
            new Notification.Builder(context, SystemNotificationChannels.CAR_MODE)
                .setSmallIcon(17304204)
                .setDefaults(4)
                .setOngoing(true)
                .setWhen(0L)
                .setColor(context.getColor(R.color.system_notification_accent_color))
                .setContentTitle(
                    context.getString(R.string.config_mobile_hotspot_provision_app_no_ui))
                .setContentText(context.getString(R.string.config_mms_user_agent_profile_url))
                .setContentIntent(
                    PendingIntent.getActivityAsUser(
                        context,
                        0,
                        new Intent(context, (Class<?>) DisableCarModeActivity.class),
                        33554432,
                        null,
                        UserHandle.CURRENT))
                .build(),
    ...
    if (this.mOverrideNightModeOff && z) {
      ...
      if (i == 0
          && ((twilightManager = this.mTwilightManager) == null
              || twilightManager.getLastTwilightState() == null)) {
        return;
      }
  ...
  public final boolean canSetNightMode() {
    String string =
        Settings.System.getString(
            getContext().getContentResolver(), "current_sec_active_themepackage");
    if (string != null && !string.isEmpty()) {
      r1 =
          Settings.System.getInt(
                  getContext().getContentResolver(), "current_theme_support_night_mode", 0)
              == 1;
      if (!r1) {
  ...
  public final void persistNightModeSettingDB(int i) {
    ...
    if (i2 == 0) {
      ...
      this.mHandler.postDelayed(
          new Runnable() { // from class: com.android.server.UiModeManagerService.16
            @Override // java.lang.Runnable
            public void run() {
  ...
  public final void updateThemeImmediately() {
    ...
    if (!z && !isMinimalBatteryUseEnabled(getContext())) {
      this.mHandler.postDelayed(
          new Runnable() { // from class: com.android.server.UiModeManagerService.17
            @Override // java.lang.Runnable
            public void run() {
              Toast.makeText(
                      new ContextThemeWrapper(
                          UiModeManagerService.this.getContext(),
                          R.style.Theme.DeviceDefault.Light),
                      UiModeManagerService.this.getContext().getString(17042667),
                      1)
                  .show();
            }
          },
  ...
  public final boolean setPackageNightModeInner(String str, int i, int i2) {
    ...
    ActivityTaskManagerInternal.PackageConfigurationUpdater createPackageConfigurationUpdater =
        this.mActivityTaskManager.createPackageConfigurationUpdater(str, i);
      ...
      return i != 0
          ? i != 1
              ? i != 2
                  ? i != 3
                      ? "unknown"
                      : i2 == 0 ? "custom_schedule" : i2 == 1 ? "custom_bedtime" : "unknown"
                  : "yes"
              : "no"
          : "auto";
    }
    ...
    */
    ...
    public final int handleCustomTime() {
      ...
      if (nextArg.equals("end")) {
        this.mInterface.setCustomNightModeEnd(
            UiModeManagerService.toMilliSeconds(LocalTime.parse(getNextArg())));
        return 0;
      }
      if (nextArg.equals("start")) {
        this.mInterface.setCustomNightModeStart(
            UiModeManagerService.toMilliSeconds(LocalTime.parse(getNextArg())));
        return 0;
      }
    ...
    public final void printCustomTime() {
      getOutPrintWriter()
          .println(
              "start "
                  + UiModeManagerService.fromMilliseconds(this.mInterface.getCustomNightModeStart())
                      .toString());
      getOutPrintWriter()
          .println(
              "end "
                  + UiModeManagerService.fromMilliseconds(this.mInterface.getCustomNightModeEnd())
                      .toString());
    }
    ...
    public final int handleNightMode() {
      ...
      if (strToNightMode >= 0) {
        ...
        if (CoreRune.SAFE_DEBUG && !TextUtils.isEmpty(nextArg2)) {
          this.mInterface.setPackageNightMode(
              nextArg2, ActivityManager.getCurrentUser(), strToNightMode);
          return 0;
        }
      ...
      errPrintWriter.println(
          "Error: mode must be 'yes', 'no', or 'auto', or 'custom_schedule', or 'custom_bedtime'");
      return -1;
    }
    ...
    public final void printCurrentNightMode() {
      getOutPrintWriter()
          .println(
              "Night mode: "
                  + nightModeToStr(
                      this.mInterface.getNightMode(), this.mInterface.getNightModeCustomType()));
    }
  ...
  public final class LocalService extends UiModeManagerInternal {
    ...
    public void onEarlySwitchUser(int i) {
      ...
      synchronized (UiModeManagerService.this.mLock) {
        ...
        uiModeManagerService.updateNightModeFromSettingsLocked(
            uiModeManagerService.getContext(),
            UiModeManagerService.this.getContext().getResources(),
            i);
        UiModeManagerService.this.resetNightModeOverrideLocked();
        LogWrapper.m0i(
            UiModeManagerService.TAG,
            "onEarlySwitchUser : " + UiModeManagerService.this.mNightMode + " userID : " + i);
        UiModeManagerService.this.updateLocked(0, 0);
        UiModeManagerService.this.cancelCustomAlarm();
    ...
    public boolean applyPackageNightModeIfNeeded(String str, int i) {
      if (!UiModeManagerService.this.isNightPriorityAllowed(str)
          || UiModeManagerService.this.isNightPriorityApplied(str, i)) {
        return false;
      }
    ...
    public boolean needToShowNightModeDialog(String str, int i) {
      ...
      if (UiModeManagerService.this.isNightPriorityAllowed(str)) {
        synchronized (UiModeManagerService.this.mPackagesNeedToShowDialog) {
          try {
            z =
                ((Boolean) UiModeManagerService.this.mPackagesNeedToShowDialog.getValue(i, str))
                    .equals(Boolean.TRUE);
          } catch (Exception e) {
  ...
  public abstract class LogWrapper {
    ...
    static {
      try {
        ...
        fileHandler2.setFormatter(
            new Formatter() { // from class: com.android.server.UiModeManagerService.LogWrapper.1
