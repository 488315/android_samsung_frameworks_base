...
public class WeaverHidlAdapter implements IWeaver {
  ...
  public WeaverConfig getConfig() {
    ...
    this.mImpl.getConfig(
        new IWeaver
            .getConfigCallback() { // from class:
                                   // com.android.server.locksettings.WeaverHidlAdapter$$ExternalSyntheticLambda1
          @Override // android.hardware.weaver.V1_0.IWeaver.getConfigCallback
          public final void onValues(
              int i, android.hardware.weaver.V1_0.WeaverConfig weaverConfig) {
  ...
  public static /* synthetic */ void lambda$getConfig$0(
      WeaverConfig[] weaverConfigArr,
      int i,
      android.hardware.weaver.V1_0.WeaverConfig weaverConfig) {
    if (i == 0) {
    ...
    Slog.e(
        "WeaverHidlAdapter",
        "Failed to get HIDL weaver config. status: " + i + ", slots: " + weaverConfig.slots);
  }
  ...
  public WeaverReadResponse read(int i, byte[] bArr) {
    ...
    this.mImpl.read(
        ...
        new IWeaver
          ...
          public final void onValues(
              int i2, android.hardware.weaver.V1_0.WeaverReadResponse weaverReadResponse) {
  ...
  public static /* synthetic */ void lambda$read$1(
      WeaverReadResponse[] weaverReadResponseArr,
      int i,
      android.hardware.weaver.V1_0.WeaverReadResponse weaverReadResponse) {
