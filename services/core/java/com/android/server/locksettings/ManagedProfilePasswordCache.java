  ...
  public void storePassword(int i, LockscreenCredential lockscreenCredential, long j) {
    ...
    synchronized (this.mEncryptedPasswords) {
      ...
      try {
        ...
        keyGenerator.init(
            new KeyGenParameterSpec.Builder(encryptionKeyName, 3)
                .setKeySize(256)
                .setBlockModes("GCM")
        ...
        try {
          ...
          this.mEncryptedPasswords.put(
              ...
              ArrayUtils.concat(
                  new byte[][] {
                    cipher.getIV(), cipher.doFinal(lockscreenCredential.getCredential())
                  }));
      ...
      try {
        ...
        try {
          try {
            ...
            LockscreenCredential createManagedPassword =
                LockscreenCredential.createManagedPassword(doFinal);
