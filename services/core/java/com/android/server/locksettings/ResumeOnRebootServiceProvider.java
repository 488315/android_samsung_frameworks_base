...
public class ResumeOnRebootServiceProvider {
  public static final String PROVIDER_PACKAGE =
      DeviceConfig.getString("ota", "resume_on_reboot_service_package", "");
  ...
  public final ServiceInfo resolveService() {
    ...
    for (ResolveInfo resolveInfo : this.mPackageManager.queryIntentServices(intent, i)) {
      ...
      if (serviceInfo != null
          && "android.permission.BIND_RESUME_ON_REBOOT_SERVICE".equals(serviceInfo.permission)) {
  ...
  public class ResumeOnRebootServiceConnection {
      ...
      if (iResumeOnRebootService == null || !iResumeOnRebootService.asBinder().isBinderAlive()) {
        ...
        ServiceConnection serviceConnection =
            new ServiceConnection() { // from class:
                                      // com.android.server.locksettings.ResumeOnRebootServiceProvider.ResumeOnRebootServiceConnection.1
              @Override // android.content.ServiceConnection
              public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                ResumeOnRebootServiceConnection.this.mBinder =
                    IResumeOnRebootService.Stub.asInterface(iBinder);
        ...
        if (!this.mContext.bindServiceAsUser(
          ...
          Slog.e(
              ...
              "Binding: " + this.mComponentName + " u" + UserHandle.SYSTEM + " failed.");
          return;
        }
    ...
    public byte[] wrapBlob(byte[] bArr, long j, long j2) {
      ...
      ResumeOnRebootServiceCallback resumeOnRebootServiceCallback =
          new ResumeOnRebootServiceCallback(countDownLatch);
        ...
        throwTypedException(
            (ParcelableException)
                resumeOnRebootServiceCallback
                    .getResult()
                    .getParcelable("exception_key", ParcelableException.class));
      }
    ...
    public final void throwTypedException(ParcelableException parcelableException) {
      ...
      throw new RemoteException(
          "ResumeOnRebootServiceConnection wrap/unwrap failed", parcelableException, true, true);
    }
