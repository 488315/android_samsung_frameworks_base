...
public class LockSettingsStrongAuth {
    ...
    protected final Handler mHandler = new Handler(Looper.getMainLooper()) { // from class:
                ...
                public final void handleMessage(Message message) {
                    ...
                    switch (i) {
                        case 1:
                            ...
                            if (i3 == -1) {
                                for (int i4 = 0;
                                        i4 < lockSettingsStrongAuth.mStrongAuthForUser.size();
                                        i4++) {
                                    int keyAt = lockSettingsStrongAuth.mStrongAuthForUser.keyAt(i4);
                                    int i5 =
                                            lockSettingsStrongAuth.mStrongAuthForUser.get(
                                                    keyAt,
                                                    lockSettingsStrongAuth.mDefaultStrongAuthFlags);
                                    int i6 = i2 == 0 ? 0 : i5 | i2;
                                    if (i5 != i6) {
                                ...
                                int i7 =
                                        lockSettingsStrongAuth.mStrongAuthForUser.get(
                                                i3, lockSettingsStrongAuth.mDefaultStrongAuthFlags);
                                r8 = i2 != 0 ? i7 | i2 : 0;
                                if (i7 != r8) {
                        ...
                        case 2:
                            ...
                            for (int i8 = 0;
                                    i8 < lockSettingsStrongAuth.mStrongAuthForUser.size();
                                    i8++) {
                                try {
                                    iStrongAuthTracker.onStrongAuthRequiredChanged(
                                            lockSettingsStrongAuth.mStrongAuthForUser.valueAt(i8),
                                            lockSettingsStrongAuth.mStrongAuthForUser.keyAt(i8));
                                } catch (RemoteException e) {
                                    Slog.e(
                                            "LockSettingsStrongAuth",
                                            "Exception while adding StrongAuthTracker.",
                                            e);
                                }
                            }
                            while (r8
                                    < lockSettingsStrongAuth.mIsNonStrongBiometricAllowedForUser
                                            .size()) {
                                try {
                                    iStrongAuthTracker.onIsNonStrongBiometricAllowedChanged(
                                            lockSettingsStrongAuth
                                                    .mIsNonStrongBiometricAllowedForUser.valueAt(
                                                    r8),
                                            lockSettingsStrongAuth
                                                    .mIsNonStrongBiometricAllowedForUser.keyAt(r8));
                                } catch (RemoteException e2) {
                                    Slog.e(
                                            "LockSettingsStrongAuth",
                                            "Exception while adding StrongAuthTracker:"
                                                + " IsNonStrongBiometricAllowedChanged.",
                                            e2);
                                }
                                r8++;
                            }
                            break;
                        case 3:
                            lockSettingsStrongAuth.mTrackers.unregister(
                                    (IStrongAuthTracker) message.obj);
                            break;
                        case 4:
                            int i9 = message.arg1;
                            int indexOfKey =
                                    lockSettingsStrongAuth.mStrongAuthForUser.indexOfKey(i9);
                            if (indexOfKey >= 0) {
                                lockSettingsStrongAuth.mStrongAuthForUser.removeAt(indexOfKey);
                                lockSettingsStrongAuth.notifyStrongAuthTrackers(
                                        lockSettingsStrongAuth.mDefaultStrongAuthFlags, i9);
                            }
                            int indexOfKey2 =
                                    lockSettingsStrongAuth.mIsNonStrongBiometricAllowedForUser
                                            .indexOfKey(i9);
                            if (indexOfKey2 >= 0) {
                                lockSettingsStrongAuth.mIsNonStrongBiometricAllowedForUser.removeAt(
                                        indexOfKey2);
                                lockSettingsStrongAuth
                        ...
                        case 5:
                            ...
                            if (LockSettingsStrongAuth.DEBUG) {
                                ...
                                Slog.d(
                                        "LockSettingsStrongAuth",
                                        "handleScheduleStrongAuthTimeout for userId=" + i10);
                            }
                            lockSettingsStrongAuth.rescheduleStrongAuthTimeoutAlarm(
                                    i10, lockSettingsStrongAuth.mInjector.getElapsedRealtimeMs());
                        ...
                        case 6:
                            ...
                            if (i12 == -1) {
                                while (r8 < lockSettingsStrongAuth.mStrongAuthForUser.size()) {
                                    int keyAt2 =
                                            lockSettingsStrongAuth.mStrongAuthForUser.keyAt(r8);
                                    int i13 =
                                            lockSettingsStrongAuth.mStrongAuthForUser.get(
                                                    keyAt2,
                                                    lockSettingsStrongAuth.mDefaultStrongAuthFlags);
                        ...
                        case 7:
                            ...
                            if (z4) {
                                AnyMotionDetector$$ExternalSyntheticOutline0.m(
                                        i17,
                                        "handleScheduleNonStrongBiometricTimeout for userId=",
                                        "LockSettingsStrongAuth");
                            }
                            long j =
                                    SystemProperties.getLong(
                                            "persist.lock.non_strong_biometric_timeout", 0L);
                            ...
                            long nextAlarmTimeMs =
                                    lockSettingsStrongAuth.mInjector.getNextAlarmTimeMs(j);
                            if (((NonStrongBiometricTimeoutAlarmListener)
                                            lockSettingsStrongAuth
                                                    .mNonStrongBiometricTimeoutAlarmListener.get(
                                                    Integer.valueOf(i17)))
                                    == null) {
                                if (z4) {
                                    Slog.d(
                                            "LockSettingsStrongAuth",
                                            "Schedule a new alarm for non-strong biometric fallback"
                                                + " timeout");
                                }
                                NonStrongBiometricTimeoutAlarmListener
                                        nonStrongBiometricTimeoutAlarmListener =
                                                lockSettingsStrongAuth
                                                .new NonStrongBiometricTimeoutAlarmListener(i17);
                                lockSettingsStrongAuth.mNonStrongBiometricTimeoutAlarmListener.put(
                                        Integer.valueOf(i17),
                                        nonStrongBiometricTimeoutAlarmListener);
                                lockSettingsStrongAuth.updateStrongAuthTimeoutInfo(
                                        i17, "lockscreen.non_strong_bio_timeout", nextAlarmTimeMs);
                                lockSettingsStrongAuth.mAlarmManager.setExact(
                                        2,
                                        nextAlarmTimeMs,
                                        LockSettingsStrongAuth
                                                .NON_STRONG_BIOMETRIC_TIMEOUT_ALARM_TAG,
                                        nonStrongBiometricTimeoutAlarmListener,
                                        lockSettingsStrongAuth.mHandler);
                            } else if (z4) {
                                Slog.d(
                                        "LockSettingsStrongAuth",
                                        "There is an existing alarm for non-strong biometric"
                        ...
                        case 8:
                            ...
                            if (LockSettingsStrongAuth.DEBUG) {
                                ...
                                Slog.d(
                                        "LockSettingsStrongAuth",
                                        "handleStrongBiometricUnlock for userId=" + i18);
                            }
                        ...
                        case 9:
                            ...
                            if (z6) {
                                AnyMotionDetector$$ExternalSyntheticOutline0.m(
                                        i19,
                                        "handleScheduleNonStrongBiometricIdleTimeout for userId=",
                                        "LockSettingsStrongAuth");
                            }
                            long j2 =
                                    SystemProperties.getLong(
                                            "persist.lock.non_strong_biometric_idle_timeout", 0L);
                            if (!SystemProperties.get("ro.build.tags", "").equals("test-keys")
                                    || j2 == 0) {
                                j2 =
                                        BackupManagerConstants
                            ...
                            long nextAlarmTimeMs2 =
                                    lockSettingsStrongAuth.mInjector.getNextAlarmTimeMs(j2);
                            NonStrongBiometricIdleTimeoutAlarmListener
                                    nonStrongBiometricIdleTimeoutAlarmListener =
                                            (NonStrongBiometricIdleTimeoutAlarmListener)
                                                    lockSettingsStrongAuth
                                                            .mNonStrongBiometricIdleTimeoutAlarmListener
                                                            .get(Integer.valueOf(i19));
                            if (nonStrongBiometricIdleTimeoutAlarmListener != null) {
                                if (z6) {
                                    Slog.d(
                                            "LockSettingsStrongAuth",
                                            "Cancel existing alarm for non-strong biometric idle"
                                                + " timeout");
                                }
                                lockSettingsStrongAuth.mAlarmManager.cancel(
                                        nonStrongBiometricIdleTimeoutAlarmListener);
                            } else {
                                nonStrongBiometricIdleTimeoutAlarmListener =
                                        lockSettingsStrongAuth
                                        .new NonStrongBiometricIdleTimeoutAlarmListener(i19);
                                lockSettingsStrongAuth.mNonStrongBiometricIdleTimeoutAlarmListener
                                        .put(
                                                Integer.valueOf(i19),
                                                nonStrongBiometricIdleTimeoutAlarmListener);
                            }
                            ...
                            if (z6) {
                                Slog.d(
                                        "LockSettingsStrongAuth",
                                        "Schedule a new alarm for non-strong biometric idle"
                                            + " timeout");
                            }
                            lockSettingsStrongAuth.updateStrongAuthTimeoutInfo(
                                    i19,
                                    "lockscreen.non_strong_bio_idle_timeout",
                                    nextAlarmTimeMs2);
                            lockSettingsStrongAuth.mAlarmManager.setExact(
                                    2,
                                    nextAlarmTimeMs2,
                        ...
                        case 10:
                            ...
                            StrongAuthTimeoutAlarmListener strongAuthTimeoutAlarmListener =
                                    (StrongAuthTimeoutAlarmListener)
                                            lockSettingsStrongAuth
                                                    .mStrongAuthTimeoutAlarmListenerForUser.get(
                                                    Integer.valueOf(i20));
                            if (strongAuthTimeoutAlarmListener != null) {
                                lockSettingsStrongAuth.rescheduleStrongAuthTimeoutAlarm(
                                        i20, strongAuthTimeoutAlarmListener.mLatestStrongAuthTime);
                                break;
                            }
                            break;
                    }
    ...
    public final void cancelNonStrongBiometricAlarmListener(int i) {
        ...
        if (z) {
            AnyMotionDetector$$ExternalSyntheticOutline0.m(
                    i,
                    "cancelNonStrongBiometricAlarmListener for userId=",
                    "LockSettingsStrongAuth");
        }
        ...
        if (nonStrongBiometricTimeoutAlarmListener != null) {
            if (z) {
                Slog.d(
                        "LockSettingsStrongAuth",
                        "Cancel alarm for non-strong biometric fallback timeout");
            }
    ...
    public final void cancelNonStrongBiometricIdleAlarmListener(int i) {
        ...
        if (z) {
            AnyMotionDetector$$ExternalSyntheticOutline0.m(
                    i,
                    "cancelNonStrongBiometricIdleAlarmListener for userId=",
                    "LockSettingsStrongAuth");
        }
        ...
        if (nonStrongBiometricIdleTimeoutAlarmListener != null) {
            if (z) {
                Slog.d(
                        "LockSettingsStrongAuth",
                        "Cancel alarm for non-strong biometric idle timeout");
            }
            ...
            try {
                try {
                    this.mTrackers
                            ...
                            .onStrongAuthRequiredChanged(i, i2);
                } catch (RemoteException e) {
                    Slog.e(
                            "LockSettingsStrongAuth",
                            "Exception while notifying StrongAuthTracker.",
                            e);
                }
            } finally {
    ...
    public final void rescheduleStrongAuthTimeoutAlarm(int i, long j) {
        ...
        this.mAlarmManager.setExact(
                ...
                strongAuthTimeoutAlarmListener2,
                this.mHandler);
    }
    ...
    public void setIsNonStrongBiometricAllowed(boolean z, int i) {
        ...
        for (int i2 = 0; i2 < this.mIsNonStrongBiometricAllowedForUser.size(); i2++) {
            setIsNonStrongBiometricAllowedOneUser(
                    this.mIsNonStrongBiometricAllowedForUser.keyAt(i2), z);
        }
    }
    ...
    public final void setIsNonStrongBiometricAllowedOneUser(int i, boolean z) {
        ...
        if (z != z3) {
            if (z2) {
                Slog.d(
                        "LockSettingsStrongAuth",
                        "mIsNonStrongBiometricAllowedForUser value changed: oldValue="
                                + z3
                                + ", allowed="
                                + z);
            }
    ...
    public final void updateStrongAuthTimeoutInfo(int i, String str, long j) {
        this.mLockPatternUtils.setBiometricStrongAuthTimeout(
                str,
                j != 0 ? (System.currentTimeMillis() + j) - SystemClock.elapsedRealtime() : 0L,
                i);
    }
}
