...
abstract class SyntheticPasswordCrypto {
  ...
  public static byte[] encrypt(byte[] bArr, byte[] bArr2, byte[] bArr3) {
    try {
      return encrypt(
          new SecretKeySpec(Arrays.copyOf(personalizedHash(bArr2, bArr), 32), "AES"), bArr3);
    } catch (IOException
        | InvalidKeyException
    ...
    try {
      ...
      try {
        ...
        Slog.w(
            ...
            "Rollback-resistant keys unavailable.  Falling back to non-rollback-resistant key");
  ...
  public static boolean migrateLockSettingsKey(String str) {
    ...
    Slog.e(
        ...
        TextUtils.formatSimple(
            "Failed to migrate key: %d", new Object[] {Integer.valueOf(migrateKeyNamespace)}));
    return false;
  }
