...
public class RecoverableKeyStoreDbHelper extends SQLiteOpenHelper {
  ...
  public void onCreate(SQLiteDatabase sQLiteDatabase) {
    sQLiteDatabase.execSQL(
        "CREATE TABLE keys( _id INTEGER PRIMARY KEY,user_id INTEGER,uid INTEGER,alias TEXT,nonce"
            + " BLOB,wrapped_key BLOB,platform_key_generation_id INTEGER,last_synced_at"
            + " INTEGER,recovery_status INTEGER,key_metadata BLOB,UNIQUE(uid,alias))");
    sQLiteDatabase.execSQL(
        "CREATE TABLE user_metadata( _id INTEGER PRIMARY KEY,user_id INTEGER"
            + " UNIQUE,platform_key_generation_id INTEGER,user_serial_number INTEGER DEFAULT"
            + " -1,bad_remote_guess_counter INTEGER DEFAULT 0)");
    sQLiteDatabase.execSQL(
        "CREATE TABLE recovery_service_metadata (_id INTEGER PRIMARY KEY,user_id INTEGER,uid"
            + " INTEGER,snapshot_version INTEGER,should_create_snapshot"
            + " INTEGER,active_root_of_trust TEXT,public_key BLOB,cert_path BLOB,cert_serial"
            + " INTEGER,secret_types TEXT,counter_id INTEGER,server_params"
            + " BLOB,UNIQUE(user_id,uid))");
    sQLiteDatabase.execSQL(
        "CREATE TABLE root_of_trust (_id INTEGER PRIMARY KEY,user_id INTEGER,uid INTEGER,root_alias"
            + " TEXT,cert_path BLOB,cert_serial INTEGER,UNIQUE(user_id,uid,root_alias))");
  }
  ...
  public final void upgradeDbForVersion4(SQLiteDatabase sQLiteDatabase) {
    ...
    sQLiteDatabase.execSQL(
        "CREATE TABLE root_of_trust (_id INTEGER PRIMARY KEY,user_id INTEGER,uid INTEGER,root_alias"
            + " TEXT,cert_path BLOB,cert_serial INTEGER,UNIQUE(user_id,uid,root_alias))");
    addColumnToTable(
        sQLiteDatabase, "recovery_service_metadata", "active_root_of_trust", "TEXT", null);
  }
  ...
  public final void upgradeDbForVersion6(SQLiteDatabase sQLiteDatabase) {
    ...
    addColumnToTable(
        sQLiteDatabase, "user_metadata", "user_serial_number", "INTEGER DEFAULT -1", null);
  }
  ...
  public final void upgradeDbForVersion7(SQLiteDatabase sQLiteDatabase) {
    ...
    addColumnToTable(
        sQLiteDatabase, "user_metadata", "bad_remote_guess_counter", "INTEGER DEFAULT 0", null);
  }

  public static void addColumnToTable(
      SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String str4) {
