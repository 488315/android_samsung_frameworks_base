...
public abstract class KeyChainSnapshotDeserializer {
  ...
  */
          ...
          switch (c) {
            ...
            case 2:
              builder.setEncryptedRecoveryKeyBlob(
                  readBlobTag(resolvePullParser, "recoveryKeyMaterial"));
              break;
            case 3:
              try {
                builder.setTrustedHardwareCertPath(
                    readCertPathTag(resolvePullParser, "thmCertPath"));
                break;
            ...
            case 6:
              ...
              break;
            case 7:
              builder.setKeyChainProtectionParams(
                  readKeyChainProtectionParamsList(resolvePullParser));
              break;
            case '\b':
            ...
            default:
              throw new KeyChainSnapshotParserException(
                  String.format(Locale.US, "Unexpected tag %s in keyChainSnapshot", name));
          }
        }
      } else {
  ...
  public static WrappedApplicationKey readWrappedApplicationKey(
    ...
    while (typedXmlPullParser.next() != 3) {
      if (typedXmlPullParser.getEventType() == 2) {
        ...
        switch (name) {
          ...
          default:
            throw new KeyChainSnapshotParserException(
                String.format(Locale.US, "Unexpected tag %s in wrappedApplicationKey", name));
        }
      }
    }
  ...
  public static KeyChainProtectionParams readKeyChainProtectionParams(
      TypedXmlPullParser typedXmlPullParser) {
    String name;
    ...
    while (typedXmlPullParser.next() != 3) {
      if (typedXmlPullParser.getEventType() == 2) {
        ...
        switch (name) {
          ...
          default:
            throw new KeyChainSnapshotParserException(
                String.format(Locale.US, "Unexpected tag %s in keyChainProtectionParams", name));
        }
      }
    }
  ...
  */
    ...
    while (true) {
      ...
      if (typedXmlPullParser.getEventType() == 2) {
        ...
        switch (z) {
          ...
          default:
            throw new KeyChainSnapshotParserException(
                String.format(Locale.US, "Unexpected tag %s in keyDerivationParams", name));
        }
      }
    }
  }
  ...
  public static int readIntTag(TypedXmlPullParser typedXmlPullParser, String str) {
    ...
    try {
      ...
      throw new KeyChainSnapshotParserException(
          String.format(Locale.US, "%s expected int but got '%s'", str, readText), e);
    }
  }
  ...
  public static long readLongTag(TypedXmlPullParser typedXmlPullParser, String str) {
    ...
    try {
      ...
      throw new KeyChainSnapshotParserException(
          String.format(Locale.US, "%s expected long but got '%s'", str, readText), e);
    }
  }
  ...
  public static byte[] readBlobTag(TypedXmlPullParser typedXmlPullParser, String str) {
    ...
    try {
      ...
      throw new KeyChainSnapshotParserException(
          String.format(Locale.US, "%s expected base64 encoded bytes but got '%s'", str, readText),
          e);
    }
  }
  ...
  public static CertPath readCertPathTag(TypedXmlPullParser typedXmlPullParser, String str) {
    try {
      return CertificateFactory.getInstance("X.509")
          .generateCertPath(new ByteArrayInputStream(readBlobTag(typedXmlPullParser, str)));
    } catch (CertificateException e) {
