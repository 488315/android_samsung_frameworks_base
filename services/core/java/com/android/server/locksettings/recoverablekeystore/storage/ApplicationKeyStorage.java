...
public class ApplicationKeyStorage {
  ...
  public String getGrantAlias(int i, int i2, String str) {
    Log.i(
        ...
        String.format(Locale.US, "Get %d/%d/%s", Integer.valueOf(i), Integer.valueOf(i2), str));
  ...
  public void setSymmetricKeyEntry(int i, int i2, String str, byte[] bArr) {
    Log.i(
        ...
        String.format(
            Locale.US,
            "Set %d/%d/%s: %d bytes of key material",
            Integer.valueOf(i),
            Integer.valueOf(i2),
            str,
    ...
    try {
      this.mKeyStore.setEntry(
          getInternalAlias(i, i2, str),
          new KeyStore.SecretKeyEntry(new SecretKeySpec(bArr, "AES")),
  ...
  public void deleteEntry(int i, int i2, String str) {
    Log.i(
        "RecoverableAppKeyStore",
        String.format(Locale.US, "Del %d/%d/%s", Integer.valueOf(i), Integer.valueOf(i2), str));
    try {
  ...
  public final String getInternalAlias(int i, int i2, String str) {
    return "com.android.server.locksettings.recoverablekeystore/application/"
        + i
        + "/"
        + i2
        + "/"
  ...
  public final String makeKeystoreEngineGrantString(int i, String str) {
    ...
    try {
      return String.format(
          "%s%016X",
          "recoverable_key:",
          Long.valueOf(KeyStore2.getInstance().grant(keyDescriptor, i, 261).nspace));
