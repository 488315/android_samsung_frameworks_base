...
public class RecoverableKeyStoreDb {
  ...
  public static RecoverableKeyStoreDb newInstance(Context context) {
    RecoverableKeyStoreDbHelper recoverableKeyStoreDbHelper =
        new RecoverableKeyStoreDbHelper(context);
  ...
  public long insertKey(int i, int i2, String str, WrappedKey wrappedKey) {
    ...
    contentValues.put(
        "platform_key_generation_id", Integer.valueOf(wrappedKey.getPlatformKeyGenerationId()));
  ...
  public boolean removeKey(int i, String str) {
    return this.mKeyStoreDbHelper
            .getWritableDatabase()
            .delete("keys", "uid = ? AND alias = ?", new String[] {Integer.toString(i), str})
        > 0;
  }
  ...
  public Map getStatusForAllKeys(int i) {
    Cursor query =
        this.mKeyStoreDbHelper
            ...
            .query(
                "keys",
                new String[] {KnoxCustomManagerService.f1773ID, "alias", "recovery_status"},
                "uid = ?",
    ...
    try {
      ...
      while (query.moveToNext()) {
        hashMap.put(
            query.getString(query.getColumnIndexOrThrow("alias")),
            Integer.valueOf(query.getInt(query.getColumnIndexOrThrow("recovery_status"))));
      }
      query.close();
      return hashMap;
    } catch (Throwable th) {
  ...
  public int setRecoveryStatus(int i, String str, int i2) {
    ...
    return writableDatabase.update(
        "keys", contentValues, "uid = ? AND alias = ?", new String[] {String.valueOf(i), str});
  }
      ...
      while (query.moveToNext()) {
        ...
        hashMap.put(
            ...
            new WrappedKey(
                blob,
                blob2,
                query.isNull(columnIndexOrThrow) ? null : query.getBlob(columnIndexOrThrow),
                i3,
                i4));
      }
      query.close();
    ...
    try {
      ...
      while (query.moveToNext()) {
        arrayMap.put(
            ...
            Long.valueOf(query.getLong(query.getColumnIndexOrThrow("user_serial_number"))));
      }
      query.close();
      return arrayMap;
    } catch (Throwable th) {
  ...
  public CertPath getRecoveryServiceCertPath(int i, int i2, String str) {
    ...
    try {
      ...
      Log.wtf(
          ...
          String.format(
              Locale.US,
              "Recovery service CertPath entry cannot be decoded for userId=%d uid=%d.",
              Integer.valueOf(i),
              Integer.valueOf(i2)),
          e);
      return null;
  ...
  public PublicKey getRecoveryServicePublicKey(int i, int i2) {
    ...
    try {
      ...
      Log.wtf(
          ...
          String.format(
              Locale.US,
              "Recovery service public key entry cannot be decoded for userId=%d uid=%d.",
              Integer.valueOf(i),
              Integer.valueOf(i2)));
      return null;
    }
    ...
    Arrays.stream(iArr)
        .forEach(
            new IntConsumer() { // from class:
                                // com.android.server.locksettings.recoverablekeystore.storage.RecoverableKeyStoreDb$$ExternalSyntheticLambda0
  ...
  public static /* synthetic */ void lambda$setRecoverySecretTypes$0(
      StringJoiner stringJoiner, int i) {
  ...
  public int[] getRecoverySecretTypes(int i, int i2) {
    Cursor query =
        this.mKeyStoreDbHelper
            ...
            .query(
                "recovery_service_metadata",
                new String[] {KnoxCustomManagerService.f1773ID, "user_id", "uid", "secret_types"},
                "user_id = ? AND uid = ?",
    ...
    try {
      ...
      if (count > 1) {
        Log.wtf(
            ...
            String.format(
                Locale.US,
                "%d deviceId entries found for userId=%d uid=%d. Should only ever be 0 or 1.",
    ...
    Cursor query =
        this.mKeyStoreDbHelper
            ...
            .query(
                "recovery_service_metadata",
                new String[] {
                  KnoxCustomManagerService.f1773ID, "user_id", "uid", "active_root_of_trust"
                },
                "user_id = ? AND uid = ?",
                new String[] {Integer.toString(i), Integer.toString(i2)},
                null,
  ...
  public final Long getLong(int i, int i2, String str) {
    Cursor query =
        this.mKeyStoreDbHelper
            ...
            .query(
                "recovery_service_metadata",
                new String[] {KnoxCustomManagerService.f1773ID, "user_id", "uid", str},
                "user_id = ? AND uid = ?",
                new String[] {Integer.toString(i), Integer.toString(i2)},
                null,
                null,
    ...
    try {
      ...
      if (count > 1) {
        Log.wtf(
            ...
            String.format(
                Locale.US,
                "%d entries found for userId=%d uid=%d. Should only ever be 0 or 1.",
                Integer.valueOf(count),
                Integer.valueOf(i),
                Integer.valueOf(i2)));
        query.close();
    ...
    Cursor query =
        this.mKeyStoreDbHelper
            ...
            .query(
                "root_of_trust",
                new String[] {
                  KnoxCustomManagerService.f1773ID, "user_id", "uid", "root_alias", str2
                },
                "user_id = ? AND uid = ? AND root_alias = ?",
                new String[] {
                  Integer.toString(i),
                  Integer.toString(i2),
                  this.mTestOnlyInsecureCertificateHelper.getDefaultCertificateAliasIfEmpty(str)
                },
                null,
                null,
                null);
  ...
  public final boolean removeUserFromRecoveryServiceMetadataTable(int i) {
    return this.mKeyStoreDbHelper
            .getWritableDatabase()
            .delete("recovery_service_metadata", "user_id = ?", new String[] {Integer.toString(i)})
        > 0;
  }
  ...
  public static CertPath decodeCertPath(byte[] bArr) {
    try {
      return CertificateFactory.getInstance("X.509")
          .generateCertPath(new ByteArrayInputStream(bArr), "PkiPath");
    } catch (CertificateException e) {
      throw new RuntimeException(e);
    }
  }
