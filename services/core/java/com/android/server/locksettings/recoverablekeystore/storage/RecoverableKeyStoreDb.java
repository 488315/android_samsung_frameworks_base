...
public class RecoverableKeyStoreDb {
    ...
    public Map getStatusForAllKeys(int i) {
        Cursor query = this.mKeyStoreDbHelper.getReadableDatabase().query("keys", new String[]{KnoxCustomManagerService.f1773ID, "alias", "recovery_status"}, "uid = ?", new String[]{Integer.toString(i)}, null, null, null);
        try {
    ...
    public Map getAllKeys(int i, int i2, int i3) {
        Cursor query = this.mKeyStoreDbHelper.getReadableDatabase().query("keys", new String[]{KnoxCustomManagerService.f1773ID, "nonce", "wrapped_key", "alias", "recovery_status", "key_metadata"}, "user_id = ? AND uid = ? AND platform_key_generation_id = ?", new String[]{Integer.toString(i), Integer.toString(i2), Integer.toString(i3)}, null, null, null);
        try {
            HashMap hashMap = new HashMap();
            while (query.moveToNext()) {
    ...
    public int[] getRecoverySecretTypes(int i, int i2) {
        Cursor query = this.mKeyStoreDbHelper.getReadableDatabase().query("recovery_service_metadata", new String[]{KnoxCustomManagerService.f1773ID, "user_id", "uid", "secret_types"}, "user_id = ? AND uid = ?", new String[]{Integer.toString(i), Integer.toString(i2)}, null, null, null);
        try {
    ...
    public String getActiveRootOfTrust(int i, int i2) {
        Cursor query = this.mKeyStoreDbHelper.getReadableDatabase().query("recovery_service_metadata", new String[]{KnoxCustomManagerService.f1773ID, "user_id", "uid", "active_root_of_trust"}, "user_id = ? AND uid = ?", new String[]{Integer.toString(i), Integer.toString(i2)}, null, null, null);
        try {
            int count = query.getCount();
            if (count == 0) {
                query.close();
    ...
    public final Long getLong(int i, int i2, String str) {
        Cursor query = this.mKeyStoreDbHelper.getReadableDatabase().query("recovery_service_metadata", new String[]{KnoxCustomManagerService.f1773ID, "user_id", "uid", str}, "user_id = ? AND uid = ?", new String[]{Integer.toString(i), Integer.toString(i2)}, null, null, null);
        try {
            int count = query.getCount();
            if (count == 0) {
                query.close();
