...
public class SignedConfigService {
  ...
  public final PackageManagerInternal mPacMan =
  ...
  public void handlePackageBroadcast(Intent intent) {
    ...
    PackageInfo packageInfo =
        this.mPacMan.getPackageInfo(schemeSpecificPart, 128L, 1000, identifier);
    if (packageInfo == null) {
      Slog.w(
          "SignedConfig",
    ...
    if (bundle != null
      ...
      try {
        ...
        new GlobalSettingsConfigApplicator(this.mContext, schemeSpecificPart, signedConfigEvent)
            .applyConfig(
                new String(
                    Base64.getDecoder().decode(bundle.getString("android.settings.global")),
                    StandardCharsets.UTF_8),
                bundle.getString("android.settings.global.signature"));
      } catch (IllegalArgumentException unused) {
        Slog.e(
            "SignedConfig",
            "Failed to base64 decode global settings config from " + schemeSpecificPart);
