...
public class GlobalSettingsConfigApplicator {
  public static final Set ALLOWED_KEYS =
      Collections.unmodifiableSet(
          new ArraySet(Arrays.asList("hidden_api_policy", "hidden_api_blacklist_exemptions")));
  ...
  public final void updateCurrentConfig(int i, Map map) {
    for (Map.Entry entry : map.entrySet()) {
      Settings.Global.putString(
          this.mContext.getContentResolver(), (String) entry.getKey(), (String) entry.getValue());
    }
  ...
  public void applyConfig(String str, String str2) {
    if (!checkSignature(str, str2)) {
      Slog.e(
          "SignedConfig",
          "Signature check on global settings in package "
              + this.mSourcePackage
              + " failed; ignoring");
      return;
    }
    try {
      ...
      Slog.e(
          "SignedConfig", "Failed to parse global settings from package " + this.mSourcePackage, e);
