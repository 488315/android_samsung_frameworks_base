            ...
            if (context == null) {
                ...
                if (userManager == null) {
                    ...
                    if (semPersonaManager != null) {
                        ...
                        IntentFilter intentFilter = new IntentFilter("com.samsung.android.plugin.ACTION_PLUGIN_CHANGE_NOTI");
                        ...
                        Log.d(TAG, "initService End, " + (currentTimeMillis3 - currentTimeMillis2) + "ms elapsed");
                        return true;
                    }
