...
public class IntelligentBatterySaverGoogleAppPolicy {
  ...
  public void addPackageNameGoogleAppsList(String str, Integer num) {
    Slog.d(
        ...
        "addPackageNameGoogleAppsList pkg= " + str + "value = " + num);
    synchronized (this.mLockGoogleAppsList) {
      try {
        this.mGoogleAppsList.put(
            Integer.valueOf(this.mContext.getPackageManager().getPackageUid(str, 0)), num);
  ...
  public void setGoogAppNetworkForceReset() {
    Slog.d(
        "IntelligentBatterySaverGoogleAppPolicy",
        "setGoogAppNetworkForceReset mNetworkLimited = " + this.mNetworkLimited);
