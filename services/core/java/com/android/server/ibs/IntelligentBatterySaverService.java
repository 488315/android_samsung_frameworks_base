...
public final class IntelligentBatterySaverService extends IIntelligentBatterySaverService.Stub {
        ...
        public SCPMReceiver(IntelligentBatterySaverService intelligentBatterySaverService, int i) {
            ...
            switch (i) {
                case 1:
                    ...
                    intelligentBatterySaverService.mContext.registerReceiver(
                            this,
                ...
                default:
                    ...
                    intelligentBatterySaverService.mContext.registerReceiver(
                            ...
                            DirEncryptServiceHelper$$ExternalSyntheticOutline0.m(
                                    "com.samsung.android.scpm.policy.UPDATE.ibs",
            ...
            switch (this.$r8$classId) {
                case 0:
                    ...
                    if (!"com.samsung.android.scpm.policy.UPDATE.ibs".equals(action)) {
                        if (KnoxCustomManagerService.ACTION_SCPM_POLICY_CLEAR_DATA.equals(action)) {
                            Slog.d(
                                    "IntelligentBatterySaverService",
                                    "SCPM clear broadcast received, policy updated 1 min later!");
                            this.this$0.mServiceHandler.postDelayed(
                                    new Runnable() { // from class:
                                                     // com.android.server.ibs.IntelligentBatterySaverService.SCPMReceiver.1
                ...
                default:
                    if ("android.intent.action.BOOT_COMPLETED".equals(intent.getAction())) {
                        Slog.d(
                                "IntelligentBatterySaverService",
                                "ACTION_BOOT_COMPLETED broadcast received: " + intent.getAction());
                        IntelligentBatterySaverScpmManager intelligentBatterySaverScpmManager =
                                this.this$0.mIBSScpmManager;
                        if (intelligentBatterySaverScpmManager != null) {
                            intelligentBatterySaverScpmManager.registerScpm();
                        }
                        Optional.ofNullable(this.this$0.mIBSFastDrainPolicy)
                                .ifPresent(
                                        new IntelligentBatterySaverService$BootCompleteReceiver$$ExternalSyntheticLambda0());
                        this.this$0.mServiceHandler.sendEmptyMessage(1);
                        break;
                    }
                    break;
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.ibs.IntelligentBatterySaverService.ServiceHandler.handleMessage(android.os.Message):void");
        }
    }
    ...
    public IntelligentBatterySaverService(Context context) {
        ...
        if (mIBSEnable) {
            ...
            synchronized (IntelligentBatterySaverLogger.class) {
                try {
                    if (IntelligentBatterySaverLogger.sInstance == null) {
                        IntelligentBatterySaverLogger intelligentBatterySaverLogger2 =
                                new IntelligentBatterySaverLogger();
            ...
            IntelligentBatterySaverSurvey intelligentBatterySaverSurvey =
                    new IntelligentBatterySaverSurvey();
            intelligentBatterySaverSurvey.mBigdataEnable =
                    SemFloatingFeature.getInstance()
                            .getBoolean("SEC_FLOATING_FEATURE_CONTEXTSERVICE_ENABLE_SURVEY_MODE");
            intelligentBatterySaverSurvey.mContext = context;
            IntelligentBatterySaverGather intelligentBatterySaverGather =
                    new IntelligentBatterySaverGather(context, this);
            final IntelligentBatterySaverSettingsObserver intelligentBatterySaverSettingsObserver =
                    new IntelligentBatterySaverSettingsObserver();
            intelligentBatterySaverSettingsObserver.mRunnable =
                    new Runnable() { // from class:
                                     // com.android.server.ibs.IntelligentBatterySaverSettingsObserver$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            IntelligentBatterySaverFastDrainPolicy intelligentBatterySaverFastDrainPolicy =
                    new IntelligentBatterySaverFastDrainPolicy(
                            context,
                            handlerThread,
                            intelligentBatterySaverLogger,
            ...
            IntelligentBatterySaverGoogleAppPolicy intelligentBatterySaverGoogleAppPolicy =
                    new IntelligentBatterySaverGoogleAppPolicy(context, handlerThread);
            ...
            intelligentBatterySaverGather.mReceiver =
                    intelligentBatterySaverGather.new IntelligentBatterySaverGatherReceiver();
            IntentFilter intentFilter = new IntentFilter();
            intelligentBatterySaverGather.mFilter = intentFilter;
            intentFilter.addAction("android.intent.action.BATTERY_CHANGED");
            context.registerReceiver(
                    intelligentBatterySaverGather.mReceiver,
                    intelligentBatterySaverGather.mFilter,
                    2);
            ((DisplayManager) context.getSystemService("display"))
                    .registerDisplayListener(intelligentBatterySaverGather.mDisplayListener, null);
            if (intelligentBatterySaverSettingsObserver.mSettingsObserver == null) {
                intelligentBatterySaverSettingsObserver.mSettingsObserver =
                        intelligentBatterySaverSettingsObserver.new SettingsObserver();
                final ContentResolver contentResolver = context.getContentResolver();
                final int i = 0;
                Optional.ofNullable(Settings.Global.getUriFor("ibs_switch"))
                        .ifPresent(
                                new Consumer() { // from class:
                                                 // com.android.server.ibs.IntelligentBatterySaverSettingsObserver$$ExternalSyntheticLambda1
                ...
                final int i2 = 1;
                Optional.ofNullable(Settings.Global.getUriFor("ibs_start_hour"))
                        .ifPresent(
                                new Consumer() { // from class:
                                                 // com.android.server.ibs.IntelligentBatterySaverSettingsObserver$$ExternalSyntheticLambda1
                                    @Override // java.util.function.Consumer
                ...
                final int i3 = 2;
                Optional.ofNullable(Settings.Global.getUriFor("ibs_start_minute"))
                        .ifPresent(
                                new Consumer() { // from class:
                                                 // com.android.server.ibs.IntelligentBatterySaverSettingsObserver$$ExternalSyntheticLambda1
                                    @Override // java.util.function.Consumer
                ...
                final int i4 = 3;
                Optional.ofNullable(Settings.Global.getUriFor("ibs_end_hour"))
                        .ifPresent(
                                new Consumer() { // from class:
                                                 // com.android.server.ibs.IntelligentBatterySaverSettingsObserver$$ExternalSyntheticLambda1
                                    @Override // java.util.function.Consumer
                ...
                final int i5 = 4;
                Optional.ofNullable(Settings.Global.getUriFor("ibs_end_minute"))
                        .ifPresent(
                                new Consumer() { // from class:
                                                 // com.android.server.ibs.IntelligentBatterySaverSettingsObserver$$ExternalSyntheticLambda1
                                    @Override // java.util.function.Consumer
            ...
            intelligentBatterySaverFastDrainPolicy.mDisplayManager =
                    (DisplayManager)
                            intelligentBatterySaverFastDrainPolicy.mContext.getSystemService(
                                    "display");
            intelligentBatterySaverFastDrainPolicy.mSensorManager =
                    (SensorManager)
                            intelligentBatterySaverFastDrainPolicy.mContext.getSystemService(
                                    "sensor");
            int integer =
                    intelligentBatterySaverFastDrainPolicy
                            .mContext
                            .getResources()
                            .getInteger(R.integer.config_carDockKeepsScreenOn);
            if (integer > 0) {
                intelligentBatterySaverFastDrainPolicy.mMotionSensor =
                        intelligentBatterySaverFastDrainPolicy.mSensorManager.getDefaultSensor(
                                integer, true);
            }
            if (intelligentBatterySaverFastDrainPolicy.mMotionSensor == null
                    && intelligentBatterySaverFastDrainPolicy
                            .mContext
                            .getResources()
                            .getBoolean(R.bool.config_autoResetAirplaneMode)) {
                intelligentBatterySaverFastDrainPolicy.mMotionSensor =
                        intelligentBatterySaverFastDrainPolicy.mSensorManager.getDefaultSensor(
                                26, true);
            }
            ...
            Slog.d(
                    ...
                    "addPackageNameGoogleAppsList pkg= com.android.vendingvalue = " + ((Object) 1));
            synchronized (intelligentBatterySaverGoogleAppPolicy.mLockGoogleAppsList) {
                try {
                    intelligentBatterySaverGoogleAppPolicy.mGoogleAppsList.put(
                            Integer.valueOf(
                                    intelligentBatterySaverGoogleAppPolicy
                                            .mContext
                                            .getPackageManager()
                                            .getPackageUid("com.android.vending", 0)),
                            1);
            ...
            if (service != null) {
                intelligentBatterySaverGoogleAppPolicy.mNetworkService =
        ...
        ibsQuickDim.mQkDimHandler =
                ibsQuickDim.new qkDimHandler(ibsQuickDim.mHandlerThread.getLooper());
        ibsQuickDim.mResolver = ibsQuickDim.mContext.getContentResolver();
        try {
            IWindowManager.Stub.asInterface(ServiceManager.getService("window"))
                    .registerPointerEventListener(ibsQuickDim.mPointerEventListener, 0);
        } catch (Exception e2) {
            Log.e("IbsQuickDim", "Exception - registerPointerEventListener");
            e2.printStackTrace();
        }
        ibsQuickDim.mPowerManagerInternal =
        ...
        ibsQuickDim.mScreenOffTimeoutSetting =
                Settings.System.getIntForUser(
                        ibsQuickDim.mResolver, "screen_off_timeout", 60000, -2);
        ibsQuickDim.mSmartStayEnabledSetting =
                Settings.System.getIntForUser(
                                ibsQuickDim.mResolver, "intelligent_sleep_mode", 0, -2)
                        != 0;
        ibsQuickDim.mBrightness =
                Settings.System.getIntForUser(ibsQuickDim.mResolver, "screen_brightness", 0, -2);
        ...
        ibsQuickDim.mResolver.registerContentObserver(
                Settings.System.getUriFor("screen_off_timeout"),
                false,
                ibsQuickDim.mSettingsObserver,
                -1);
        ibsQuickDim.mResolver.registerContentObserver(
                Settings.System.getUriFor("intelligent_sleep_mode"),
                false,
                ibsQuickDim.mSettingsObserver,
                -1);
        ibsQuickDim.mResolver.registerContentObserver(
                ...
                ibsQuickDim.mSettingsObserver,
                -1);
        IbsQuickDim.SQLiteSQDwhilteList sQLiteSQDwhilteList =
                new IbsQuickDim.SQLiteSQDwhilteList(
                        ibsQuickDim.mContext, "SQD_whilte_list", null, 2);
        sQLiteSQDwhilteList.mDb = null;
        sQLiteSQDwhilteList.mDb = sQLiteSQDwhilteList.getWritableDatabase();
        sQLiteSQDwhilteList.mBlockDataOperator =
                new IbsQuickDim.SQLiteSQDwhilteList.AllowDataOperator(sQLiteSQDwhilteList, 1);
        sQLiteSQDwhilteList.mAllowDataOperator =
                new IbsQuickDim.SQLiteSQDwhilteList.AllowDataOperator(sQLiteSQDwhilteList, 0);
        ibsQuickDim.mSQLiteSQDwhilteList = sQLiteSQDwhilteList;
        try {
            ActivityManagerNative.getDefault()
                    .registerProcessObserver(ibsQuickDim.mProcessObserver);
        ...
        this.mSleepModePolicyController =
                new SleepModePolicyController(context, this.mHandlerThread, sleepModeLogger);
        IntelligentBatterySaverDexoptManager intelligentBatterySaverDexoptManager =
                new IntelligentBatterySaverDexoptManager();
        this.mIBSDexoptManager = intelligentBatterySaverDexoptManager;
        try {
            intelligentBatterySaverDexoptManager.mArtManagerLocal =
                    (ArtManagerLocal) LocalManagerRegistry.getManagerOrThrow(ArtManagerLocal.class);
            intelligentBatterySaverDexoptManager.mPackageManagerLocal =
                    (PackageManagerLocal)
                            LocalManagerRegistry.getManagerOrThrow(PackageManagerLocal.class);
        } catch (LocalManagerRegistry.ManagerNotFoundException e4) {
            Slog.e(
                    "IntelligentBatterySaverDexoptManager",
                    "failed to get local manager " + e4.getMessage());
        }
    }

    public final boolean addScreenQuickDimApp(String str, int i) {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.CONNECTIVITY_INTERNAL", "IntelligentBatterySaverService");
    ...
    public final void dump(
            FileDescriptor fileDescriptor, final PrintWriter printWriter, final String[] strArr) {
        if (this.mContext.checkCallingOrSelfPermission("android.permission.DUMP") != 0) {
            printWriter.println(
                    "Permission Denial: can't dump IntelligentBatterySaverService from pid="
        ...
        if (mIBSEnable) {
            ...
            if (strArr.length == 2 && "ibs".equals(strArr[0])) {
                ...
                printWriter.println(
                        "get updated mSysState :"
                                + Integer.toBinaryString(
                                        intelligentBatterySaverFastDrainPolicy.mSysState));
            }
            IntelligentBatterySaverGoogleAppPolicy intelligentBatterySaverGoogleAppPolicy =
                    this.mIBSGoogleAppPolicy;
            intelligentBatterySaverGoogleAppPolicy.getClass();
            printWriter.println("");
            printWriter.println("IntelligentBatterySaverGoogleAppPolicy ");
            for (int i = 0;
                    i < intelligentBatterySaverGoogleAppPolicy.mGoogleAppsList.size();
                    i++) {
                StringBuilder m =
                        BatteryService$$ExternalSyntheticOutline0.m(
                                i, "SCPM GoogleApps uid ", "is ");
                m.append(intelligentBatterySaverGoogleAppPolicy.mGoogleAppsList.keyAt(i));
                printWriter.println(m.toString());
                printWriter.println(
                        "SCPM GoogleApps stats "
                                + i
                                + "= "
                                + intelligentBatterySaverGoogleAppPolicy.mGoogleAppsList.valueAt(
                                        i));
            }
            ...
            if (intelligentBatterySaverLogger.mIsUsed) {
                ...
                intelligentBatterySaverLogger.mIBSLog.dump(
                        (FileDescriptor) null, printWriter, (String[]) null);
                printWriter.println();
            }
        }
        IbsQuickDim ibsQuickDim = this.mIBSQuickDim;
        if (ibsQuickDim != null) {
            ...
            StringBuilder m2 =
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            new StringBuilder("UI on-off : "),
                            ibsQuickDim.mUiControlEnabled,
                            printWriter,
                            "mCharging : ");
            ...
            StringBuilder m3 =
                    KillPolicyManager$$ExternalSyntheticOutline0.m(
                            m2, ibsQuickDim.mSQDPowerSave, printWriter, "policy status : ");
            m3.append(ibsQuickDim.mQuickDimMode);
            printWriter.println(m3.toString());
            printWriter.println("block List:");
            ibsQuickDim.mBlockUnDimUidSet.forEach(
                    new IbsQuickDim$$ExternalSyntheticLambda1(0, printWriter));
            printWriter.println("allow List:");
            ibsQuickDim.mAllowDimUidSet.forEach(
                    new IbsQuickDim$$ExternalSyntheticLambda1(0, printWriter));
        ...
        IntelligentBatterySaverScpmManager intelligentBatterySaverScpmManager =
                this.mIBSScpmManager;
        if (intelligentBatterySaverScpmManager != null) {
            printWriter.println("");
            printWriter.println("IntelligentBatterySaverScpmManager adapt to scpm v2 ");
            printWriter.println(
                    "IBS 's mPolicyControlSwitch:"
                            + Integer.toBinaryString(
                                    intelligentBatterySaverScpmManager.mPolicyControlSwitch));
        }
        final int i2 = 0;
        Optional.ofNullable(this.mSleepModePolicyController)
                .ifPresent(
                        new Consumer() { // from class:
                            // com.android.server.ibs.IntelligentBatterySaverService$$ExternalSyntheticLambda0
                            @Override // java.util.function.Consumer
                            public final void accept(Object obj) {
                                switch (i2) {
                                    case 0:
                                        ...
                                        SleepModePolicyController sleepModePolicyController =
                                                (SleepModePolicyController) obj;
                                        sleepModePolicyController.getClass();
                                        printWriter2.println("");
                                        printWriter2.println("SleepModePolicy ");
                                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                                new StringBuilder("get current state :"),
                                                sleepModePolicyController.mSleepModeEnabled,
                                                printWriter2);
                                        if (sleepModePolicyController.mSleepModeEnabled) {
                                            if (SleepModeUtil.getTime(
                                                            sleepModePolicyController.mStartTime
                                                                    .toString())
                                                    > SleepModeUtil.getTime(
                                                            sleepModePolicyController.mEndTime
                                                                    .toString())) {
                                                printWriter2.println(
                                                        "Set time from "
                                        ...
                                        if (strArr2.length != 2
                                                || !"sleepMode".equals(strArr2[0])) {
                                            if (strArr2.length != 4
                                                    || !"sleepMode".equals(strArr2[0])) {
                                                if (strArr2.length != 1
                                                        || !"getSleepTime".equals(strArr2[0])) {
                                                    if (strArr2.length == 2
                                                            && "rubinEvent".equals(strArr2[0])) {
                                                        sleepModePolicyController.setRubinEvent(
                                                                strArr2[1]);
                                                    ...
                                                    if (sleepTime != null) {
                                                        printWriter2.println(
                                                                "start time is: "
                                                                        + sleepTime.getLong(
                                                                                "bundle_start_sleep_time_key"));
                                                        printWriter2.println(
                                                                "end time is: "
                                                                        + sleepTime.getLong(
                                                                                "bundle_end_sleep_time_key"));
                                                        break;
                                                    }
                                                }
                                            } else {
                                                int parseInt2 = Integer.parseInt(strArr2[1]);
                                                AccountManagerServiceShellCommand$$ExternalSyntheticOutline0
                                                        .m(
                                                                printWriter2,
                                                                "set new state :",
                                                                parseInt2);
                                                if (parseInt2 == 1) {
                                                    sleepModePolicyController.setSleepModeEnable(
                                                            true);
                                                    printWriter2.println("enable sleep mode");
                                                    sleepModePolicyController.setSleepTime(
                                                            SleepModeUtil.getTime(strArr2[2]),
                                                            SleepModeUtil.getTime(strArr2[3]));
                                            ...
                                            AccountManagerServiceShellCommand$$ExternalSyntheticOutline0
                                                    .m(printWriter2, "set new state :", parseInt3);
                                            if (parseInt3 == 0) {
                                    ...
                                    default:
                                        ...
                                        IntelligentBatterySaverDexoptManager
                                                intelligentBatterySaverDexoptManager =
                                                        (IntelligentBatterySaverDexoptManager) obj;
        ...
        Optional.ofNullable(this.mSleepModeLogger)
                .ifPresent(
                        new Consumer(
                                printWriter,
                                strArr) { // from class:
                                          // com.android.server.ibs.IntelligentBatterySaverService$$ExternalSyntheticLambda1
                            ...
                            public final void accept(Object obj) {
                                ...
                                if (sleepModeLogger.mIsUsed) {
                                    ...
                                    sleepModeLogger.mSleepModeLog.dump(
                                            (FileDescriptor) null, printWriter2, (String[]) null);
                                    printWriter2.println();
                                }
                            }
                        });
        final int i3 = 1;
        Optional.ofNullable(this.mIBSDexoptManager)
                .ifPresent(
                        new Consumer() { // from class:
                            // com.android.server.ibs.IntelligentBatterySaverService$$ExternalSyntheticLambda0
                            @Override // java.util.function.Consumer
    ...
    public final Bundle getOperationHistory() {
        ...
        long j =
                SharePrefUtils.getLong(
                        sleepModePolicyController.mContext, "pref_sleep_mode_trigger_time_key", 0L);
        long j2 =
                SharePrefUtils.getLong(
                        sleepModePolicyController.mContext, "pref_sleep_mode_cancel_time_key", 0L);
        if (j == 0 || j2 == 0) {
            return null;
        }
        int i = 0;
        try {
            i =
                    sleepModePolicyController
                            ...
                            .getInt("pref_sleep_mode_policy_state_key", 0);
        ...
        bundle.putBoolean(
                "bundle_camera_flash_notification_key", sleepModePolicyController.testState(128));
        return bundle;
    }
    ...
    public final boolean isEnableSerive() {
        ...
        AnyMotionDetector$$ExternalSyntheticOutline0.m(
                "SleepModePolicyController",
                new StringBuilder("isEnableSerive: "),
                sleepModePolicyController.mSleepModeEnabled);
    ...
    public final boolean removeScreenQuickDimApp(String str, int i) {
        ...
        int delete =
                ibsQuickDim
                        .mSQLiteSQDwhilteList
                        .getDataOperator(1)
                        .delete(new String[] {str, Integer.toString(i)});
