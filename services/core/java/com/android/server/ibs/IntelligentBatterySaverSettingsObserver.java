...
public class IntelligentBatterySaverSettingsObserver {
  ...
  public IntelligentBatterySaverSettingsObserver(
    ...
    if (this.mSettingsObserver == null) {
      ...
      this.mContext
          ...
          .registerContentObserver(
              Settings.Global.getUriFor("ibs_switch"), false, this.mSettingsObserver, -1);
    }
  ...
  public class SettingsObserver extends ContentObserver {
    ...
    public void onChange(boolean z, Uri uri) {
      if (Settings.Global.getInt(
              IntelligentBatterySaverSettingsObserver.this.mContext.getContentResolver(),
              "ibs_switch",
              1)
          == 0) {
        IntelligentBatterySaverSettingsObserver.this.mIBSService.mIBSFastDrainPolicy
            .setIBSFastDrainActionEnable(false);
      } else {
        IntelligentBatterySaverSettingsObserver.this.mIBSService.mIBSFastDrainPolicy
            .setIBSFastDrainActionEnable(true);
      }
    }
  }
}
