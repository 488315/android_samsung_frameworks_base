...
public class IntelligentBatterySaverFastDrainPolicy {
  ...
  public final AlarmManager.OnAlarmListener mTimeoutAlarmListener =
  ...
  public final AlarmManager.OnAlarmListener mSafeCheckTimeoutAlarmListener =
      new AlarmManager.OnAlarmListener() { // from class:
        // com.android.server.ibs.IntelligentBatterySaverFastDrainPolicy$$ExternalSyntheticLambda1
        @Override // android.app.AlarmManager.OnAlarmListener
        public final void onAlarm() {
  ...
  public final AlarmManager.OnAlarmListener mMotionTimeoutAlarmListener =
      new AlarmManager.OnAlarmListener() { // from class:
        // com.android.server.ibs.IntelligentBatterySaverFastDrainPolicy$$ExternalSyntheticLambda2
        @Override // android.app.AlarmManager.OnAlarmListener
        public final void onAlarm() {
          IntelligentBatterySaverFastDrainPolicy.this.lambda$new$2();
        }
      };
  public final AlarmManager.OnAlarmListener mInactiveTimeoutAlarmListener =
      new AlarmManager.OnAlarmListener() { // from class:
        // com.android.server.ibs.IntelligentBatterySaverFastDrainPolicy$$ExternalSyntheticLambda3
        @Override // android.app.AlarmManager.OnAlarmListener
        public final void onAlarm() {
  ...
  public IntelligentBatterySaverFastDrainTrafficStat mTrafiicStat =
      new IntelligentBatterySaverFastDrainTrafficStat();
  public IntelligentBatterySaverFastDrainBatteryInfo mBatteryInfo =
      new IntelligentBatterySaverFastDrainBatteryInfo();
  public IntelligentBatterySaverBatteryBigData mIBSBigData =
  ...
  public void init() {
    ...
    int integer =
        this.mContext.getResources().getInteger(R.integer.config_burnInProtectionMinVerticalOffset);
    if (integer > 0) {
  ...
  public final void checkDownloadSafe() {
    ...
    long j =
        (totalTxBytes + totalRxBytes) - (this.mTrafiicStat.txBytes + this.mTrafiicStat.rxBytes);
  ...
  public final void checkBatteryInfo(int i, int i2) {
    ...
    Slog.d(
        "IntelligentBatterySaverFastDrainPolicy",
        "checkBatteryInfo level = " + i + " scale = " + i2 + " timeDelta = " + j);
    this.mIntelligentBatterySaverLogger.add(
        "checkBatteryInfo level = " + i + " scale = " + i2 + " timeDelta = " + j);
    if (this.mBatteryInfo.level - i4 == 1) {
      ...
      float f = ((batteryCapacity / 100.0f) * 3600.0f) / j;
      boolean z =
          Settings.System.getInt(this.mContext.getContentResolver(), "aod_show_state", 0) != 0;
      if (z) {
  ...
  public final void lambda$new$0() {
    ...
    updateNextAlarm(
        Boolean.valueOf(
            calendar.before(
                this.mEndTime.getDateTimeAfter(this.mStartTime.getDateTimeBefore(calendar)))),
        calendar);
  }
  ...
  public final void updateFastDrainInternalState() {
    ...
    switch (this.mFastDrainInternalState) {
      ...
      case 3:
        if (!testState(15)) {
          moveToStateOFF(
              "move to off state from inactive", this.mInactiveTimeoutAlarmListener, false);
          break;
        } else {
      ...
      case 5:
        if (!testState(15)) {
          moveToStateOFF(
              "move to off state from safe check", this.mSafeCheckTimeoutAlarmListener, true);
          break;
        } else if (!testState(16)) {
          moveToStateOFF(
          ...
          if (alarmManager != null
              && (onAlarmListener = this.mSafeCheckTimeoutAlarmListener) != null) {
            alarmManager.cancel(onAlarmListener);
          }
      ...
      for (int i = 0; i <= 1; i++) {
        ...
        while (it.hasNext()) {
          ...
          try {
            Slog.d(
                "IntelligentBatterySaverFastDrainPolicy",
                " do fast drain restriction " + actionEntry.tag);
  ...
  public final void updateBigData() {
    ...
    this.mIBSBigData.restrictedCurrent =
        (((this.mEstimatedBatteryCapacity / 100.0f) * (this.mEnterIBSBatteryLevel - r2)) * 3600.0f)
            / j2;
  ...
  public final void registerIntelligentBatterySaverFastDrainAction(
      String str,
    ...
    if (i < 0 || i > 1 || iIntelligentBatterySaverFastDrainCallBack == null) {
      Slog.d(
          "IntelligentBatterySaverFastDrainPolicy",
          " registerIntelligentBatterySaverFastDrainAction error : level  "
              + i
              + ", callBack "
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      switch (action) {
        case "android.intent.action.TIME_SET":
          if (IntelligentBatterySaverFastDrainPolicy.this.mAlarmManager != null
              && IntelligentBatterySaverFastDrainPolicy.this.mTimeoutAlarmListener != null) {
            IntelligentBatterySaverFastDrainPolicy.this.mAlarmManager.cancel(
                IntelligentBatterySaverFastDrainPolicy.this.mTimeoutAlarmListener);
          }
          IntelligentBatterySaverFastDrainPolicy.this.lambda$new$0();
          break;
  ...
  public final class MotionListener extends TriggerEventListener implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
      synchronized (IntelligentBatterySaverFastDrainPolicy.this) {
        IntelligentBatterySaverFastDrainPolicy.this.mSensorManager.unregisterListener(
            this, IntelligentBatterySaverFastDrainPolicy.this.mMotionSensor);
        this.active = false;
      }
    }
    ...
    public boolean registerLocked() {
      ...
      if (IntelligentBatterySaverFastDrainPolicy.this.mMotionSensor.getReportingMode() == 2) {
        registerListener =
            IntelligentBatterySaverFastDrainPolicy.this.mSensorManager.requestTriggerSensor(
                IntelligentBatterySaverFastDrainPolicy.this.mMotionListener,
                IntelligentBatterySaverFastDrainPolicy.this.mMotionSensor);
      } else {
        registerListener =
            IntelligentBatterySaverFastDrainPolicy.this.mSensorManager.registerListener(
                IntelligentBatterySaverFastDrainPolicy.this.mMotionListener,
                IntelligentBatterySaverFastDrainPolicy.this.mMotionSensor,
                3);
      }
      if (registerListener) {
        ...
        Slog.e(
            "IntelligentBatterySaverFastDrainPolicy",
            "Unable to register for " + IntelligentBatterySaverFastDrainPolicy.this.mMotionSensor);
      }
    ...
    public void unregisterLocked() {
      if (IntelligentBatterySaverFastDrainPolicy.this.mMotionSensor.getReportingMode() == 2) {
        IntelligentBatterySaverFastDrainPolicy.this.mSensorManager.cancelTriggerSensor(
            IntelligentBatterySaverFastDrainPolicy.this.mMotionListener,
            IntelligentBatterySaverFastDrainPolicy.this.mMotionSensor);
      } else {
        IntelligentBatterySaverFastDrainPolicy.this.mSensorManager.unregisterListener(
    ...
    public void handleMessage(Message message) {
      switch (message.what) {
        ...
        case 5:
          ...
          break;
        case 6:
          if (IntelligentBatterySaverFastDrainPolicy.this.isCheckBatteryDropState()
              || IntelligentBatterySaverFastDrainPolicy.this.isFastDrainRestrictionOn()) {
            IntelligentBatterySaverFastDrainPolicy.this.checkBatteryInfo(
        ...
        case 8:
          ...
          intelligentBatterySaverFastDrainPolicy.setSysState(
              i | intelligentBatterySaverFastDrainPolicy.mSysState);
          break;
        case 9:
          int i2 = message.arg1;
          IntelligentBatterySaverFastDrainPolicy intelligentBatterySaverFastDrainPolicy2 =
              IntelligentBatterySaverFastDrainPolicy.this;
          intelligentBatterySaverFastDrainPolicy2.setSysState(
              (~i2) & intelligentBatterySaverFastDrainPolicy2.mSysState);
          break;
        case 10:
  ...
  public class IntelligentBatterySaverFastDrainAction {
    ...
    public IntelligentBatterySaverFastDrainAction(Context context) {
      this.mContext = context;
      this.gpsCallBack =
          new IIntelligentBatterySaverFastDrainCallBack() { // from class:
            ...
            public void doFastDrainRestriction() {
              int i =
                  Settings.Secure.getInt(
                      IntelligentBatterySaverFastDrainAction.this.mContext.getContentResolver(),
                      "location_mode",
                      0);
              if (i != 0) {
                if (1
                        == Settings.System.getInt(
                            IntelligentBatterySaverFastDrainAction.this.mContext
                                .getContentResolver(),
                ...
                Settings.Secure.putInt(
                    ...
                    0);
                Slog.d(
                    IntelligentBatterySaverFastDrainAction.this.TAG,
                    "gpsState = " + i + " gps set disable");
                IntelligentBatterySaverFastDrainPolicy.this.mIntelligentBatterySaverLogger.add(
                    "gpsState = " + i + " gps set disable");
            ...
            public void cancelFastDrainRestriction() {
              int intState =
                  IntelligentBatterySaverFastDrainPolicy.this.getIntState("disable_gps_by_ibs");
              if (intState != 0) {
                if (1
                        == Settings.System.getInt(
                            IntelligentBatterySaverFastDrainAction.this.mContext
          ...
          new IIntelligentBatterySaverFastDrainCallBack() { // from class:
            ...
            public void doFastDrainRestriction() {
              WifiManager wifiManager =
                  (WifiManager)
                      IntelligentBatterySaverFastDrainAction.this.mContext.getSystemService("wifi");
              ...
              if (wifiManager != null) {
                ...
                Slog.d(
                    ...
                    "Disable wifi check wifiApState = "
                        ...
                        + this.wifiState);
                IntelligentBatterySaverFastDrainPolicy.this.mIntelligentBatterySaverLogger.add(
                    "wifi wifiState = " + this.wifiState + " wifiApState = " + this.wifiApState);
                ...
                IntelligentBatterySaverFastDrainPolicy.this.saveBooleanState(
                    true, "disable_wifi_by_ibs");
              }
            }
            ...
            public void cancelFastDrainRestriction() {
              ...
              if (wifiManager != null) {
                ...
                Slog.d(
                    ...
                    "Recover wifi check wifiState = "
                        + this.wifiState
                        + ", operWifiState = "
                        + IntelligentBatterySaverFastDrainPolicy.this.getBooleanState(
                            "disable_wifi_by_ibs"));
                if (!this.wifiState
                    && IntelligentBatterySaverFastDrainPolicy.this.getBooleanState(
                        "disable_wifi_by_ibs")) {
              ...
              IntelligentBatterySaverFastDrainPolicy.this.saveBooleanState(
                  false, "disable_wifi_by_ibs");
            }
          };
      this.mobiledataCallBack =
          new IIntelligentBatterySaverFastDrainCallBack() { // from class:
            // com.android.server.ibs.IntelligentBatterySaverFastDrainPolicy.IntelligentBatterySaverFastDrainAction.3
            ...
            public void doFastDrainRestriction() {
              ...
              TelephonyManager from =
                  TelephonyManager.from(IntelligentBatterySaverFastDrainAction.this.mContext);
              ...
              if (from != null) {
                ...
                IntelligentBatterySaverFastDrainPolicy.this.saveBooleanState(
                    true, "disable_mobile_data_by_ibs");
              }
            }
            ...
            public void cancelFastDrainRestriction() {
              ...
              IntelligentBatterySaverFastDrainPolicy.this.saveBooleanState(
                  false, "disable_mobile_data_by_ibs");
            }
          };
    }

    public void regisiterAction() {
      IntelligentBatterySaverFastDrainPolicy.this.registerIntelligentBatterySaverFastDrainAction(
          "GPS_IBSFastDrainAction", this.gpsCallBack, 1);
      IntelligentBatterySaverFastDrainPolicy.this.registerIntelligentBatterySaverFastDrainAction(
          "wifi_IBSFastDrainAction", this.wifiCallBack, 1);
      IntelligentBatterySaverFastDrainPolicy.this.registerIntelligentBatterySaverFastDrainAction(
          "mobiledata_IBSFastDrainAction", this.mobiledataCallBack, 1);
    }
  }
  ...
  public final void saveBooleanState(boolean z, String str) {
    if (this.mSharedPreferences == null && this.mContext != null) {
      Slog.d(
          "IntelligentBatterySaverFastDrainPolicy", "Create shared preferences when save state.");
  ...
  public final void saveIntState(int i, String str) {
    ...
    if (sharedPreferences != null) {
      SharedPreferences.Editor edit = sharedPreferences.edit();
      Slog.d(
          "IntelligentBatterySaverFastDrainPolicy", "saveIntState type = " + str + " state = " + i);
      edit.putInt(str, i);
      edit.apply();
    }
  }
