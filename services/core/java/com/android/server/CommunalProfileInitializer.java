...
public final class CommunalProfileInitializer {
    ...
    public static void removeCommunalProfileIfPresent() {
        ...
        Slogf.d(
                ...
                "Removing existing Communal Profile, userId=%d",
                Integer.valueOf(communalProfileId));
        if (userManagerInternal.removeUserEvenWhenDisallowed(communalProfileId)) {
            return;
        }
        Slogf.e(
                "CommunalProfileInitializer",
                "Failed to remove Communal Profile, userId=%d",
                Integer.valueOf(communalProfileId));
    }
    ...
    public final void init(TimingsTraceAndSlog timingsTraceAndSlog) {
        ...
        if (communalProfileId != -10000) {
            Slogf.d(
                    "CommunalProfileInitializer",
                    "Found existing Communal Profile, userId=%d",
                    Integer.valueOf(communalProfileId));
        } else {
            ...
            try {
                Slogf.i(
                        "CommunalProfileInitializer",
                        "Successfully created Communal Profile, userId=%d",
                        Integer.valueOf(
                ...
                Slogf.wtf(
                        "CommunalProfileInitializer",
                        "Communal Profile creation failed",
                        (Throwable) e);
            }
        }
