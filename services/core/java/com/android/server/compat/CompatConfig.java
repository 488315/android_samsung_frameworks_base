...
public final class CompatConfig {
  ...
  public static CompatConfig create(
      AndroidBuildClassifier androidBuildClassifier, Context context) {
    ...
    compatConfig.initConfigFromLib(
        Environment.buildPath(
            Environment.getRootDirectory(), new String[] {"system_ext", "etc", "compatconfig"}));
  ...
  public synchronized void addAllPackageOverrides(
      CompatibilityOverridesByPackageConfig compatibilityOverridesByPackageConfig, boolean z) {
    for (String str : compatibilityOverridesByPackageConfig.packageNameToOverrides.keySet()) {
      addPackageOverridesWithoutSaving(
          (CompatibilityOverrideConfig)
              compatibilityOverridesByPackageConfig.packageNameToOverrides.get(str),
          str,
          z);
    }
    saveOverrides();
  ...
  public synchronized void addPackageOverrides(
  ...
  public final void addPackageOverridesWithoutSaving(
    ...
    for (Long l : compatibilityOverrideConfig.overrides.keySet()) {
      if (z && !isKnownChangeId(l.longValue())) {
        Slog.w(
            "CompatConfig",
            "Trying to add overrides for unknown Change ID " + l + ". Skipping Change ID.");
      } else {
        addOverrideUnsafe(
            l.longValue(), str, (PackageOverride) compatibilityOverrideConfig.overrides.get(l));
      }
    }
  }
  ...
  public final boolean addOverrideUnsafe(
    ...
    OverrideAllowedState overrideAllowedState =
        this.mOverrideValidator.getOverrideAllowedState(j, str);
            ...
            this.mChanges.computeIfAbsent(
                ...
                new Function() { // from class:
                  ...
                  public final Object apply(Object obj) {
                    ...
                    lambda$addOverrideUnsafe$0 =
                        CompatConfig.lambda$addOverrideUnsafe$0(atomicBoolean, j, (Long) obj);
  ...
  public static /* synthetic */ CompatChange lambda$addOverrideUnsafe$0(
      AtomicBoolean atomicBoolean, long j, Long l) {
  ...
  public final boolean removeOverrideUnsafe(CompatChange compatChange, String str, Long l) {
    return compatChange.removePackageOverride(
        str, this.mOverrideValidator.getOverrideAllowedState(compatChange.getId(), str), l);
  }

  public synchronized void removeAllPackageOverrides(
      CompatibilityOverridesToRemoveByPackageConfig compatibilityOverridesToRemoveByPackageConfig) {
    boolean z = false;
    for (String str :
        compatibilityOverridesToRemoveByPackageConfig.packageNameToOverridesToRemove.keySet()) {
      z |=
          removePackageOverridesWithoutSaving(
              (CompatibilityOverridesToRemoveConfig)
                  compatibilityOverridesToRemoveByPackageConfig.packageNameToOverridesToRemove.get(
                      str),
              str);
    }
    if (z) {
  ...
  public synchronized void removePackageOverrides(
  ...
  public final boolean removePackageOverridesWithoutSaving(
    ...
    for (Long l : compatibilityOverridesToRemoveConfig.changeIds) {
      if (isKnownChangeId(l.longValue())) {
        ...
        Slog.w(
            "CompatConfig",
            "Trying to remove overrides for unknown Change ID " + l + ". Skipping Change ID.");
      }
    }
    return z;
  }
  ...
  public final long[] getAllowedChangesSinceTargetSdkForPackage(String str, int i) {
    ...
    for (CompatChange compatChange : this.mChanges.values()) {
      if (compatChange.getEnableSinceTargetSdk() == i
          && this.mOverrideValidator.getOverrideAllowedState(compatChange.getId(), str).state
              == 0) {
        longArray.add(compatChange.getId());
      }
    }
  ...
  public int enableTargetSdkChangesForPackage(String str, int i) {
    long[] allowedChangesSinceTargetSdkForPackage =
        getAllowedChangesSinceTargetSdkForPackage(str, i);
    boolean z = false;
            ...
            this.mChanges.computeIfAbsent(
                ...
                new Function() { // from class:
                  ...
                  public final Object apply(Object obj) {
                    ...
                    lambda$registerListener$1 =
                        CompatConfig.this.lambda$registerListener$1(atomicBoolean, j, (Long) obj);
  ...
  public /* synthetic */ CompatChange lambda$registerListener$1(
      AtomicBoolean atomicBoolean, long j, Long l) {
    atomicBoolean.set(false);
    invalidateCache();
    return new CompatChange(j);
  ...
  public CompatibilityChangeInfo[] dumpChanges() {
    CompatibilityChangeInfo[] compatibilityChangeInfoArr =
        new CompatibilityChangeInfo[this.mChanges.size()];
    Iterator it = this.mChanges.values().iterator();
    int i = 0;
    while (it.hasNext()) {
        ...
        try {
          ...
          for (ChangeOverrides changeOverrides : read.getChangeOverrides()) {
            ...
            if (compatChange == null) {
              Slog.w(
                  "CompatConfig",
                  "Change ID " + changeId + " not found. Skipping overrides for it.");
            } else {
      ...
      if (this.mOverridesFile != null && this.mBackupOverridesFile != null) {
        ...
        if (this.mOverridesFile.exists()) {
          if (this.mBackupOverridesFile.exists()) {
            ...
            Slog.e(
                "CompatConfig",
                "Couldn't rename file " + this.mOverridesFile + " to " + this.mBackupOverridesFile);
            return;
          }
        }
        try {
    ...
    for (CompatChange compatChange : this.mChanges.values()) {
      z |=
          compatChange.recheckOverride(
              str,
              this.mOverrideValidator.getOverrideAllowedStateForRecheck(compatChange.getId(), str),
              versionCodeOrNull);
    }
    if (z) {
      invalidateCache();
  ...
  public final Long getVersionCodeOrNull(String str) {
    try {
      return Long.valueOf(
          this.mContext.getPackageManager().getApplicationInfo(str, 4194304).longVersionCode);
