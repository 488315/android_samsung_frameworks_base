...
public class OverrideValidatorImpl extends IOverrideValidator.Stub {
  ...
  public OverrideValidatorImpl(
      AndroidBuildClassifier androidBuildClassifier, Context context, CompatConfig compatConfig) {
  ...
  public final OverrideAllowedState getOverrideAllowedStateInternal(long j, String str, boolean z) {
    ...
    boolean z2 =
        this.mAndroidBuildClassifier.isDebuggableBuild() && !this.mForceNonDebuggableFinalBuild;
    ...
    try {
      ...
      if (this.mCompatConfig.isOverridable(j)
          && (z
  ...
  public void registerContentObserver() {
    this.mContext
        ...
        .registerContentObserver(
            Settings.Global.getUriFor("force_non_debuggable_final_build_for_compat"),
            false,
