...
public class WearableAmbientContextManagerPerUserService
  ...
  public int getAmbientContextEventArrayExtraKeyConfig() {
    return R.string.face_acquired_mouth_covering_detected;
  }

  @Override // com.android.server.ambientcontext.AmbientContextManagerPerUserService
  public int getAmbientContextPackageNameExtraKeyConfig() {
    return R.string.face_acquired_mouth_covering_detected_alt;
  }
  ...
  public WearableAmbientContextManagerPerUserService(
    ...
    Slog.d(
        TAG,
        "Created WearableAmbientContextManagerPerUserServiceand service type: "
            + serviceType.name()
            + " and service name: "
            + str);
  }
  ...
  public void ensureRemoteServiceInitiated() {
    if (this.mRemoteService == null) {
      this.mRemoteService =
          new RemoteWearableSensingService(getContext(), this.mComponentName, getUserId());
    }
  }
