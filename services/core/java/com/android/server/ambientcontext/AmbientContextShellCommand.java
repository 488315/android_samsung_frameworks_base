...
public final class AmbientContextShellCommand extends ShellCommand {
    ...
    public static final AmbientContextEventRequest REQUEST =
            new AmbientContextEventRequest.Builder()
                    .addEventType(1)
                    .addEventType(2)
                    .addEventType(3)
                    .build();
    public static final AmbientContextEventRequest WEARABLE_REQUEST =
            new AmbientContextEventRequest.Builder()
                    .addEventType(FrameworkStatsLog.GPS_ENGINE_STATE_CHANGED)
                    .build();
    public static final AmbientContextEventRequest MIXED_REQUEST =
            new AmbientContextEventRequest.Builder()
                    .addEventType(1)
                    .addEventType(FrameworkStatsLog.GPS_ENGINE_STATE_CHANGED)
                    .build();
    ...
    public final class TestableCallbackInternal {
        ...
        public static AnonymousClass1 m212$$Nest$mcreateAmbientContextObserver(
                TestableCallbackInternal testableCallbackInternal) {
        ...
        switch (str) {
            case "get-bound-package":
                ...
                synchronized (ambientContextManagerService.mLock) {
                    try {
                        AmbientContextManagerPerUserService serviceForType =
                                ambientContextManagerService.getServiceForType(
                                        parseInt, serviceType);
                        componentName =
                                serviceForType != null ? serviceForType.getComponentName() : null;
                    } finally {
                    }
                }
            ...
            case "stop-detection":
                ...
                ambientContextManagerService2.mContext.enforceCallingOrSelfPermission(
                ...
                synchronized (ambientContextManagerService2.mLock) {
                    try {
                        for (AmbientContextManagerService.ClientRequest clientRequest :
                                ambientContextManagerService2.mExistingClientRequests) {
            ...
            case "query-mixed-service-status":
                ...
                testableCallbackInternal.getClass();
                ambientContextManagerService3.queryServiceStatus(
                        parseInt3,
                        nextArgRequired2,
                        iArr,
                        new RemoteCallback(
                                new RemoteCallback.OnResultListener() { // from class:
                                    // com.android.server.ambientcontext.AmbientContextShellCommand$TestableCallbackInternal$$ExternalSyntheticLambda0
                                    public final void onResult(Bundle bundle) {
                                        AmbientContextShellCommand.TestableCallbackInternal
                                                testableCallbackInternal2 =
                                                        AmbientContextShellCommand
                                                                .TestableCallbackInternal.this;
            ...
            case "start-detection-wearable":
                ...
                ambientContextManagerService4.startDetection(
                        parseInt4,
                        ambientContextEventRequest,
                        nextArgRequired3,
                        TestableCallbackInternal.m212$$Nest$mcreateAmbientContextObserver(
                                testableCallbackInternal2));
                this.mService.newClientAdded(
                        parseInt4,
                        ambientContextEventRequest,
                        nextArgRequired3,
                        testableCallbackInternal2.new AnonymousClass1());
                return 0;
            case "start-detection-mixed":
                ...
                ambientContextManagerService5.startDetection(
                        parseInt5,
                        ambientContextEventRequest2,
                        nextArgRequired4,
                        TestableCallbackInternal.m212$$Nest$mcreateAmbientContextObserver(
                                testableCallbackInternal3));
                this.mService.newClientAdded(
                        parseInt5,
                        ambientContextEventRequest2,
                        nextArgRequired4,
                        testableCallbackInternal3.new AnonymousClass1());
                return 0;
            case "set-temporary-services":
                ...
                if (nextArg == null || nextArg2 == null) {
                    ...
                    Slog.i(
                            ambientContextManagerService6.mTag,
                            ActiveServices$$ExternalSyntheticOutline0.m(
                                    ...
                                    BatteryService$$ExternalSyntheticOutline0.m(
                                            parseInt6, "setTemporaryService(", ") to ")));
                        ...
                        if (parseInt7 > 30000) {
                            throw new IllegalArgumentException(
                                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                            parseInt7, "Max duration is 30000 (called with ", ")"));
                        }
                        synchronized (ambientContextManagerService6.mLock) {
                            try {
                                AbstractPerUserSystemService peekServiceForUserLocked =
                                        ambientContextManagerService6.peekServiceForUserLocked(
                                                parseInt6);
                                if (peekServiceForUserLocked != null) {
                                    peekServiceForUserLocked.removeSelfFromCache();
                                }
                                ambientContextManagerService6.mServiceNameResolver
                                        .setTemporaryServices(parseInt6, parseInt7, strArr);
                            } finally {
                            }
                        }
                    }
                    StringBuilder sb =
                            new StringBuilder("AmbientContextDetectionService temporarily set to ");
                    sb.append(strArr[0]);
                    sb.append(" and ");
                    Slog.w(
                            "AmbientContextShellCommand",
                            ActiveServices$$ExternalSyntheticOutline0.m(
                                    parseInt7, strArr[1], " for ", "ms", sb));
                    StringBuilder sb2 =
                            new StringBuilder("AmbientContextDetectionService temporarily set to ");
                    sb2.append(strArr[0]);
                    sb2.append(" and ");
            ...
            case "query-wearable-service-status":
                ...
                final TestableCallbackInternal testableCallbackInternal4 =
                        sTestableCallbackInternal;
                testableCallbackInternal4.getClass();
                ambientContextManagerService7.queryServiceStatus(
                        parseInt8,
                        nextArgRequired5,
                        iArr2,
                        new RemoteCallback(
                ...
                if (nextArg3 == null) {
                    ...
                    outPrintWriter3.println(
                            ActiveServices$$ExternalSyntheticOutline0.m(
                                    ...
                                    "ms",
                                    new StringBuilder(
                                            "AmbientContextDetectionService temporarily set to ")));
                }
                return 0;
            case "query-service-status":
                AmbientContextManagerService ambientContextManagerService8 = this.mService;
                final TestableCallbackInternal testableCallbackInternal5 =
                        sTestableCallbackInternal;
                testableCallbackInternal5.getClass();
                ambientContextManagerService8.queryServiceStatus(
            ...
            case "start-detection":
                ...
                ambientContextManagerService9.startDetection(
                        parseInt11,
                        ambientContextEventRequest3,
                        nextArgRequired6,
                        TestableCallbackInternal.m212$$Nest$mcreateAmbientContextObserver(
                                testableCallbackInternal6));
                this.mService.newClientAdded(
                        parseInt11,
                        ambientContextEventRequest3,
                        nextArgRequired6,
                        testableCallbackInternal6.new AnonymousClass1());
                return 0;
            default:
                return handleDefaultCommands(str);
        }
    ...
    public final void onHelp() {
        ...
        BatteryService$$ExternalSyntheticOutline0.m(
                outPrintWriter,
                "  start-detection-wearable USER_ID PACKAGE_NAME: Starts AmbientContextEvent"
                    + " detection for wearable.",
                "  start-detection-mixed USER_ID PACKAGE_NAME:  Starts AmbientContextEvent"
                    + " detection for mixed events.",
        ...
        BatteryService$$ExternalSyntheticOutline0.m(
                ...
                "  query-wearable-service-status USER_ID PACKAGE_NAME: Prints the service status"
                    + " code for wearable.",
                "  query-mixed-service-status USER_ID PACKAGE_NAME: Prints the service status code"
                    + " for mixed events.",
        ...
        BatteryService$$ExternalSyntheticOutline0.m(
                ...
                "  set-temporary-services USER_ID [FIRST_PACKAGE_NAME] [SECOND_PACKAGE_NAME]"
