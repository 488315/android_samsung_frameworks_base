...
public abstract class AmbientContextManagerPerUserService extends AbstractPerUserSystemService {
  ...
  public AmbientContextManagerPerUserService(
      AmbientContextManagerService ambientContextManagerService, Object obj, int i) {
            ...
            .queryServiceStatus(
                ...
                getServerStatusCallback(
                    new Consumer() { // from class:
                                     // com.android.server.ambientcontext.AmbientContextManagerPerUserService$$ExternalSyntheticLambda0
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        AmbientContextManagerPerUserService.this.lambda$onQueryServiceStatus$0(
                            remoteCallback, (Integer) obj);
                      }
                    }));
      }
    }
  ...
  public /* synthetic */ void lambda$onQueryServiceStatus$0(
      RemoteCallback remoteCallback, Integer num) {
  ...
  public void onStartConsentActivity(int[] iArr, String str) {
    ...
    try {
      ParceledListSlice recentTasks =
          ActivityTaskManager.getService().getRecentTasks(1, 0, getUserId());
      ...
      try {
        try {
          ...
          String string =
              context.getResources().getString(getAmbientContextPackageNameExtraKeyConfig());
          String string2 =
              context.getResources().getString(getAmbientContextEventArrayExtraKeyConfig());
    ...
    synchronized (this.mLock) {
      if (!setUpServiceIfNeeded()) {
        ...
        ((AmbientContextManagerService) this.mMaster)
            .newClientAdded(this.mUserId, ambientContextEventRequest, str, iAmbientContextObserver);
      }
    }
  }
  ...
  public void startDetection(
      AmbientContextEventRequest ambientContextEventRequest,
      String str,
      final IAmbientContextObserver iAmbientContextObserver) {
    String str2 = TAG;
      ...
      if (setUpServiceIfNeeded()) {
        ...
        getRemoteService()
            .startDetection(
                ...
                getServerStatusCallback(
                    new Consumer() { // from class:
                                     // com.android.server.ambientcontext.AmbientContextManagerPerUserService$$ExternalSyntheticLambda1
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        AmbientContextManagerPerUserService.this.lambda$startDetection$1(
                            iAmbientContextObserver, (Integer) obj);
                      }
                    }));
      } else {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$startDetection$1(
      IAmbientContextObserver iAmbientContextObserver, Integer num) {
  ...
  public void completeRegistration(IAmbientContextObserver iAmbientContextObserver, int i) {
    try {
      ...
      Slog.w(
          TAG, "Failed to call IAmbientContextObserver.onRegistrationComplete: " + e.getMessage());
    }
  }
    ...
    return new RemoteCallback(
        new RemoteCallback
            .OnResultListener() { // from class:
                                  // com.android.server.ambientcontext.AmbientContextManagerPerUserService$$ExternalSyntheticLambda3
          public final void onResult(Bundle bundle) {
            AmbientContextManagerPerUserService.this.lambda$createDetectionResultRemoteCallback$2(
                bundle);
          }
        });
  }
  ...
  public /* synthetic */ void lambda$createDetectionResultRemoteCallback$2(Bundle bundle) {
    AmbientContextDetectionResult ambientContextDetectionResult =
        (AmbientContextDetectionResult)
            bundle.get("android.app.ambientcontext.AmbientContextDetectionResultBundleKey");
    String packageName = ambientContextDetectionResult.getPackageName();
    IAmbientContextObserver clientRequestObserver =
        ((AmbientContextManagerService) this.mMaster)
            .getClientRequestObserver(this.mUserId, packageName);
    ...
    try {
      try {
        ...
        Slog.i(
            TAG,
            "Got detection result of "
                + ambientContextDetectionResult.getEvents()
                + " for "
                + packageName);
      } catch (RemoteException e) {
  ...
  private boolean setUpServiceIfNeeded() {
    if (getComponentName() == null) {
      ...
      int i = AbstractC06531.f1636x6db1e84a[getServiceType().ordinal()];
      if (i == 1) {
    ...
    try {
      return AppGlobals.getPackageManager().getServiceInfo(getComponentName(), 0L, this.mUserId)
          != null;
    } catch (RemoteException unused) {
  ...
  public abstract /* synthetic */ class AbstractC06531 {
    ...
    static {
      ...
      try {
        f1636x6db1e84a[ServiceType.WEARABLE.ordinal()] = 2;
  ...
  public final RemoteCallback getServerStatusCallback(final Consumer consumer) {
    return new RemoteCallback(
        new RemoteCallback
            .OnResultListener() { // from class:
                                  // com.android.server.ambientcontext.AmbientContextManagerPerUserService$$ExternalSyntheticLambda2
          public final void onResult(Bundle bundle) {
  ...
  public static /* synthetic */ void lambda$getServerStatusCallback$3(
      Consumer consumer, Bundle bundle) {
    AmbientContextDetectionServiceStatus ambientContextDetectionServiceStatus =
        (AmbientContextDetectionServiceStatus)
            bundle.get("android.app.ambientcontext.AmbientContextServiceStatusBundleKey");
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      ...
      Slog.i(
          TAG,
          "Got detection status of "
              + statusCode
              + " for "
              + ambientContextDetectionServiceStatus.getPackageName());
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
  }
