...
final class RemoteWearableSensingService extends ServiceConnector.Impl
  ...
  public RemoteWearableSensingService(Context context, ComponentName componentName, int i) {
    super(
        context,
        new Intent("android.service.wearable.WearableSensingService").setComponent(componentName),
        67112960,
        i,
        new RemoteWearableSensingService$$ExternalSyntheticLambda1());
    connect();
  }
  ...
  public void stopDetection(final String str) {
    ...
    post(
        new ServiceConnector
            .VoidJob() { // from class:
                         // com.android.server.ambientcontext.RemoteWearableSensingService$$ExternalSyntheticLambda0
          public final void runNoResult(Object obj) {
