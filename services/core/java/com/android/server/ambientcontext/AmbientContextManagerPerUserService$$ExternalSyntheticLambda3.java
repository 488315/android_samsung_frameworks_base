...
public final /* synthetic */ class AmbientContextManagerPerUserService$$ExternalSyntheticLambda3
        implements RemoteCallback.OnResultListener {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ Object f$0;

    public /* synthetic */ AmbientContextManagerPerUserService$$ExternalSyntheticLambda3(
            int i, Object obj) {
        this.$r8$classId = i;
        this.f$0 = obj;
    }
        ...
        switch (i) {
            case 0:
                AmbientContextManagerPerUserService ambientContextManagerPerUserService =
                        (AmbientContextManagerPerUserService) obj;
                ...
                AmbientContextManagerService ambientContextManagerService =
                        (AmbientContextManagerService) ambientContextManagerPerUserService.mMaster;
                int i2 = ambientContextManagerPerUserService.mUserId;
                synchronized (ambientContextManagerService.mExistingClientRequests) {
                    try {
                        Iterator it =
                                ambientContextManagerService.mExistingClientRequests.iterator();
                        while (true) {
                            if (it.hasNext()) {
                                AmbientContextManagerService.ClientRequest clientRequest =
                                        (AmbientContextManagerService.ClientRequest) it.next();
                ...
                try {
                    try {
                        ...
                        Slog.w(
                                "AmbientContextManagerPerUserService",
                                "Failed to call IAmbientContextObserver.onEvents: "
                                        + e.getMessage());
                    }
                    return;
                } finally {
