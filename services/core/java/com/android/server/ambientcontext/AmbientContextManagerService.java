...
public class AmbientContextManagerService extends AbstractMasterSystemService {
  ...
  public AmbientContextManagerService(Context context) {
    super(
        ...
        new FrameworkResourcesServiceNameResolver(
            context, R.array.config_screenThresholdLevels, true),
        null,
        68);
  ...
  public void onBootPhase(int i) {
    if (i == 500) {
      ...
      this.mIsServiceEnabled =
          DeviceConfig.getBoolean("ambient_context_manager_service", "service_enabled", true);
  ...
  public List newServiceListLocked(int i, boolean z, String[] strArr) {
    ...
    if (strArr.length == 2) {
      Slog.i(
          TAG,
          "Not using default services, services provided for testing should be exactly two"
              + " services.");
    ...
    for (String str : strArr) {
      ...
      if (serviceType == serviceType2) {
        arrayList.add(
            new WearableAmbientContextManagerPerUserService(
                this, this.mLock, i, serviceType2, str));
      } else {
        arrayList.add(
            new DefaultAmbientContextManagerPerUserService(
                this, this.mLock, i, AmbientContextManagerPerUserService.ServiceType.DEFAULT, str));
      }
    }
    return arrayList;
  }
  ...
  public void onServiceRemoved(
      AmbientContextManagerPerUserService ambientContextManagerPerUserService, int i) {
  ...
  public void stopAmbientContextEvent(int i, String str) {
    this.mContext.enforceCallingOrSelfPermission(
        "android.permission.ACCESS_AMBIENT_CONTEXT_EVENT", TAG);
    synchronized (this.mLock) {
      for (ClientRequest clientRequest : this.mExistingClientRequests) {
        String str2 = TAG;
        ...
        if (clientRequest.hasUserIdAndPackageName(i, str)) {
          ...
          AmbientContextManagerPerUserService ambientContextManagerPerUserServiceForEventTypes =
              getAmbientContextManagerPerUserServiceForEventTypes(
                  i, clientRequest.getRequest().getEventTypes());
          if (ambientContextManagerPerUserServiceForEventTypes != null) {
  ...
  public void queryServiceStatus(int i, String str, int[] iArr, RemoteCallback remoteCallback) {
    ...
    synchronized (this.mLock) {
      AmbientContextManagerPerUserService ambientContextManagerPerUserServiceForEventTypes =
          getAmbientContextManagerPerUserServiceForEventTypes(i, intArrayToIntegerSet(iArr));
      if (ambientContextManagerPerUserServiceForEventTypes != null) {
  ...
  public final AmbientContextManagerPerUserService.ServiceType getServiceType(String str) {
    String string =
        this.mContext.getResources().getString(R.string.default_audio_route_name_external_device);
  ...
  public final boolean isDefaultService(String str) {
    String string = this.mContext.getResources().getString(R.string.data_saver_enable_title);
  ...
  public final class AmbientContextManagerInternal extends IAmbientContextManager.Stub {
    ...
    public void registerObserver(
      ...
      final AmbientContextManagerPerUserService ambientContextManagerPerUserServiceForEventTypes =
          AmbientContextManagerService.this.getAmbientContextManagerPerUserServiceForEventTypes(
              UserHandle.getCallingUserId(), ambientContextEventRequest.getEventTypes());
      registerObserverWithCallback(
          ...
          new IAmbientContextObserver
            ...
            public void onEvents(List list) {
              ambientContextManagerPerUserServiceForEventTypes.sendDetectionResultIntent(
                  pendingIntent, list);
            }

            public void onRegistrationComplete(int i) {
              ambientContextManagerPerUserServiceForEventTypes.sendStatusCallback(
                  remoteCallback, i);
            }
          });
    }
    ...
    public void registerObserverWithCallback(
        ...
        IAmbientContextObserver iAmbientContextObserver) {
      Slog.i(
          AmbientContextManagerService.TAG,
      ...
      AmbientContextManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.ACCESS_AMBIENT_CONTEXT_EVENT", AmbientContextManagerService.TAG);
      ...
      int checkStatusCode =
          checkStatusCode(
              ...
              AmbientContextManagerService.integerSetToIntArray(
      ...
      if (checkStatusCode == 1) {
        ...
        ambientContextManagerPerUserServiceForEventTypes.completeRegistration(
          ...
          if (clientRequest != null && clientRequest.getPackageName().equals(str)) {
            AmbientContextManagerPerUserService ambientContextManagerPerUserServiceForEventTypes =
                AmbientContextManagerService.this
                    .getAmbientContextManagerPerUserServiceForEventTypes(
                        UserHandle.getCallingUserId(), clientRequest.getRequest().getEventTypes());
            if (ambientContextManagerPerUserServiceForEventTypes != null) {
              ambientContextManagerPerUserServiceForEventTypes.onUnregisterObserver(str);
            } else {
              Slog.w(
                  AmbientContextManagerService.TAG,
                  "onUnregisterObserver unavailable user_id: " + UserHandle.getCallingUserId());
            }
          }
        }
      }
      ...
      synchronized (AmbientContextManagerService.this.mLock) {
        AmbientContextManagerPerUserService ambientContextManagerPerUserServiceForEventTypes =
            AmbientContextManagerService.this.getAmbientContextManagerPerUserServiceForEventTypes(
                ...
                AmbientContextManagerService.this.intArrayToIntegerSet(iArr));
        if (ambientContextManagerPerUserServiceForEventTypes == null) {
          Slog.w(
              AmbientContextManagerService.TAG,
              "queryServiceStatus unavailable user_id: " + UserHandle.getCallingUserId());
          return;
        }
        int checkStatusCode =
        ...
        if (checkStatusCode == 1) {
          ...
          ambientContextManagerPerUserServiceForEventTypes.sendStatusCallback(
              remoteCallback, checkStatusCode);
        }
      }
    }
    ...
    public void startConsentActivity(int[] iArr, String str) {
      ...
      Slog.w(
          AmbientContextManagerService.TAG,
          "startConsentActivity unavailable user_id: " + UserHandle.getCallingUserId());
    }

    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          AmbientContextManagerService.this.mContext,
          AmbientContextManagerService.TAG,
          printWriter)) {
        synchronized (AmbientContextManagerService.this.mLock) {
    ...
    public final int checkStatusCode(
        AmbientContextManagerPerUserService ambientContextManagerPerUserService, int[] iArr) {
