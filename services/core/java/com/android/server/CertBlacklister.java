...
public class CertBlacklister extends Binder {
  ...
  public class BlacklistObserver extends ContentObserver {
    ...
    public BlacklistObserver(
        String str, String str2, String str3, ContentResolver contentResolver) {
      super(null);
      this.mKey = str;
      this.mName = str2;
      this.mPath = str3;
    ...
    public final void writeBlacklist() {
      new Thread("BlacklistUpdater") { // from class:
        // com.android.server.CertBlacklister.BlacklistObserver.1
          ...
          synchronized (BlacklistObserver.this.mTmpDir) {
            ...
            if (value != null) {
              ...
              try {
                try {
                  createTempFile =
                      File.createTempFile("journal", "", BlacklistObserver.this.mTmpDir);
  ...
  public final void registerObservers(ContentResolver contentResolver) {
    contentResolver.registerContentObserver(
        Settings.Secure.getUriFor("pubkey_blacklist"), true, buildPubkeyObserver(contentResolver));
    contentResolver.registerContentObserver(
        Settings.Secure.getUriFor("serial_blacklist"), true, buildSerialObserver(contentResolver));
  }
}
