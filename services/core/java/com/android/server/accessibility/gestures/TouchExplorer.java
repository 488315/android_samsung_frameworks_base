...
public final class TouchExplorer extends BaseEventStreamTransformation
    ...
    public final class SendHoverExitDelayed implements Runnable {
        ...
        public void clear() {
            ...
            for (int size2 = ((ArrayList) ((List) this.mRawEvent)).size() - 1;
                    size2 >= 0;
                    size2--) {
        ...
        public final void run() {
            switch (this.$r8$classId) {
                case 0:
                    ...
                    this.this$0.mDispatcher.sendMotionEvent(
                            10,
                            this.mPointerIdBits,
                            this.mPolicyFlags,
                            (MotionEvent) this.mPrototype,
                            (MotionEvent) this.mRawEvent);
                    if (!this.this$0.mSendTouchExplorationEndDelayed.isPending()) {
                        this.this$0.mSendTouchExplorationEndDelayed.cancel();
                        SendAccessibilityEventDelayed sendAccessibilityEventDelayed =
                                this.this$0.mSendTouchExplorationEndDelayed;
                        TouchExplorer.this.mHandler.postDelayed(
                                sendAccessibilityEventDelayed,
                                sendAccessibilityEventDelayed.mDelay);
                    }
                    if (this.this$0.mSendTouchInteractionEndDelayed.isPending()) {
                        this.this$0.mSendTouchInteractionEndDelayed.cancel();
                        SendAccessibilityEventDelayed sendAccessibilityEventDelayed2 =
                                this.this$0.mSendTouchInteractionEndDelayed;
                        TouchExplorer.this.mHandler.postDelayed(
                                sendAccessibilityEventDelayed2,
                                sendAccessibilityEventDelayed2.mDelay);
                    }
                    MotionEvent motionEvent = (MotionEvent) this.mPrototype;
                    if (motionEvent != null) {
                        motionEvent.recycle();
                    ...
                    break;
                default:
                    if (Integer.bitCount(this.this$0.mReceivedPointerTracker.mReceivedPointersDown)
                            > 1) {
                        Slog.e(
                                "TouchExplorer",
                                "Attempted touch exploration with "
                                        + Integer.bitCount(
                                                this.this$0
                                                        ...
                                                        .mReceivedPointersDown)
                                        + " pointers down.");
                        break;
                    } else if (((ArrayList) ((List) this.mPrototype)).size() != 0) {
                        Flags.sendHoverEventsBasedOnEventStream();
                        this.this$0.sendHoverExitAndTouchExplorationGestureEndIfNeeded(
                                this.mPolicyFlags);
                        this.this$0.mDispatcher.sendAccessibilityEvent(512);
                        if (this.this$0.mGestureDetector.mSendMotionEventsEnabled) {
                            this.this$0.dispatchGesture(
                                    new AccessibilityGestureEvent(
                                            -2,
                                            this.this$0.mState.mLastReceivedEvent.getDisplayId(),
                                            this.this$0.mGestureDetector.mEvents));
                        }
                        if (!((ArrayList) ((List) this.mPrototype)).isEmpty()
                                && !((ArrayList) ((List) this.mRawEvent)).isEmpty()) {
                            this.this$0.mDispatcher.sendMotionEvent(
                                    9,
                                    this.mPointerIdBits,
                                    this.mPolicyFlags,
                                    (MotionEvent) ((ArrayList) ((List) this.mPrototype)).get(0),
                                    (MotionEvent) ((ArrayList) ((List) this.mRawEvent)).get(0));
                            if (TouchExplorer.DEBUG) {
                                Slog.d(
                            ...
                            for (int i = 1; i < size; i++) {
                                this.this$0.mDispatcher.sendMotionEvent(
                                        ...
                                        this.mPointerIdBits,
                                        this.mPolicyFlags,
                                        (MotionEvent) ((ArrayList) ((List) this.mPrototype)).get(i),
                                        (MotionEvent) ((ArrayList) ((List) this.mRawEvent)).get(i));
                                if (TouchExplorer.DEBUG) {
                                    Slog.d(
                                            "SendHoverEnterAndMoveDelayed",
    ...
    public TouchExplorer(
        ...
        this.mDispatcher =
                new EventDispatcher(context, accessibilityManagerService, this.mNext, touchState);
        ...
        this.mEdgeSwipeHeightPixels =
                (context.getResources().getDisplayMetrics().ydpi / 2.54f) * 0.25f;
    ...
    public static void checkForMalformedEvent(MotionEvent motionEvent) {
        if (motionEvent.getPointerCount() < 0) {
            throw new IllegalArgumentException(
                    "Invalid pointer count: " + motionEvent.getPointerCount());
        }
        for (int i = 0; i < motionEvent.getPointerCount(); i++) {
            try {
                ...
                if (Float.isNaN(x)
                        || Float.isNaN(y)
                        || x < FullScreenMagnificationGestureHandler.MAX_SCALE
                ...
                StringBuilder m =
                        BatteryService$$ExternalSyntheticOutline0.m(
                                i, "Encountered exception getting details of pointer ", " / ");
    ...
    public final void clear(int i, MotionEvent motionEvent) {
        ...
        for (int i3 = 0; i3 < pointerCount; i3++) {
            ...
            if (touchState2.isInjectedPointerDown(pointerId)) {
                eventDispatcher.sendMotionEvent(
                        eventDispatcher.computeInjectionAction(6, i3),
                        i2,
                        i,
                        motionEvent,
                        touchState2.mLastReceivedEvent);
                i2 = (~(1 << pointerId)) & i2;
            }
        }
        this.mSendHoverEnterAndMoveDelayed.cancel();
        this.mSendHoverExitDelayed.cancel();
        ExitGestureDetectionModeDelayed exitGestureDetectionModeDelayed =
                this.mExitGestureDetectionModeDelayed;
    ...
    public final MotionEvent computeDownEventForDrag(MotionEvent motionEvent) {
        ...
        float receivedPointerDownY =
                receivedPointerTracker.getReceivedPointerDownY(this.mDraggingPointerId);
    ...
    public final void dispatchGesture(AccessibilityGestureEvent accessibilityGestureEvent) {
        if (DEBUG) {
            Slog.d(
                    "TouchExplorer",
                    "Dispatching gesture event:" + accessibilityGestureEvent.toString());
        }
        AccessibilityManagerService accessibilityManagerService = this.mAms;
        synchronized (accessibilityManagerService.mLock) {
            try {
                if (!accessibilityManagerService.notifyGestureLocked(
                        accessibilityGestureEvent, false)) {
                    accessibilityManagerService.notifyGestureLocked(
                            accessibilityGestureEvent, true);
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        if (this.mState.mState == 0) {
            if (this.mSendHoverEnterAndMoveDelayed.isPending()) {
                ...
                if (this.mState.mServiceDetectsGestures) {
                    ...
                    sendHoverExitDelayed2.this$0.mHandler.postDelayed(
                            sendHoverExitDelayed2, r0.mDetermineUserIntentTimeout);
                }
            }
            ...
            if (this.mTouchExplorationPassthroughRegion.contains(
                    (int) motionEvent.getX(), (int) motionEvent.getY())) {
                this.mState.setState(4);
                MotionEvent obtainNoHistory = MotionEvent.obtainNoHistory(motionEvent);
                this.mDispatcher.sendMotionEvent(
                        obtainNoHistory.getAction(), -1, i, obtainNoHistory, motionEvent2);
                this.mSendHoverEnterAndMoveDelayed.cancel();
            } else if (this.mGestureDetectionPassthroughRegion.contains(
                    (int) motionEvent.getX(), (int) motionEvent.getY())) {
    ...
    public final void handleActionMoveStateTouchInteracting(
            MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
        MotionEvent obtain;
        TouchState.ReceivedPointerTracker receivedPointerTracker = this.mReceivedPointerTracker;
        int findPointerIndex =
                motionEvent.findPointerIndex(receivedPointerTracker.getPrimaryPointerId());
        TouchState touchState = this.mState;
            ...
            if (!gestureManifold.mMultiFingerGesturesEnabled
                ...
                if (gestureManifold.mMultiFingerGesturesEnabled
                    ...
                    while (i3 < motionEvent.getPointerCount()) {
                        int pointerId = motionEvent.getPointerId(i3);
                        if (!((receivedPointerTracker.mReceivedPointersDown & (1 << pointerId)) != 0
                                ? true
                                : z2)) {
                            NandswapManager$$ExternalSyntheticOutline0.m(
                                    pointerId, "Invalid pointer id: ", "TouchExplorer");
                        }
                        EventDispatcher eventDispatcher2 = eventDispatcher;
                        if (Math.hypot(
                                        receivedPointerTracker.getReceivedPointerDownX(pointerId)
                                                - motionEvent2.getX(i3),
                                        receivedPointerTracker.getReceivedPointerDownY(pointerId)
                                                - motionEvent2.getY(i3))
                                < this.mTouchSlop * 2) {
                            return;
                        }
                        i3++;
                ...
                if (!isDraggingGesture(obtainNoHistory)) {
                    if (gestureManifold.mSendMotionEventsEnabled) {
                        dispatchGesture(
                                new AccessibilityGestureEvent(-1, i2, gestureManifold.mEvents));
                    }
                ...
                if (computeDownEventForDrag != null) {
                    this.mDispatcher.sendMotionEvent(
                            0, i4, i, computeDownEventForDrag, motionEvent2);
        ...
        if (!gestureManifold.mMultiFingerGesturesEnabled) {
            ...
            touchState.setState(4);
            eventDispatcher.sendDownForAllNotInjectedPointers(
        ...
        while (true) {
            ...
            if (i5 >= pointerCount2) {
                ...
                if (pointerCount4
                        != Integer.bitCount(
                                touchState2.mReceivedPointerTracker.mReceivedPointersDown)) {
                    Slog.w(
                            "EventDispatcher",
                            "The pointer count doesn't match the received count.");
                    obtain = MotionEvent.obtain(motionEvent);
                } else {
                    MotionEvent.PointerCoords[] pointerCoordsArr =
                            new MotionEvent.PointerCoords[pointerCount4];
                    MotionEvent.PointerProperties[] pointerPropertiesArr =
                            new MotionEvent.PointerProperties[pointerCount4];
                    for (int i6 = 0; i6 < pointerCount4; i6++) {
                        int pointerId2 = motionEvent.getPointerId(i6);
                        TouchState.ReceivedPointerTracker receivedPointerTracker2 =
                                touchState2.mReceivedPointerTracker;
                        float receivedPointerDownX =
                                receivedPointerTracker2.getReceivedPointerDownX(pointerId2);
                        float receivedPointerDownY =
                                receivedPointerTracker2.getReceivedPointerDownY(pointerId2);
                        MotionEvent.PointerCoords pointerCoords = new MotionEvent.PointerCoords();
                ...
                for (int i8 = 0; i8 < pointerCount3; i8++) {
                    ...
                    if (!touchState2.isInjectedPointerDown(pointerId3)) {
                        ...
                        eventDispatcher.sendMotionEvent(
                                eventDispatcher.computeInjectionAction(0, i8),
                                i9,
                                i,
                                motionEvent3,
                                touchState2.mLastReceivedEvent);
            ...
            float receivedPointerDownY2 =
                    receivedPointerTracker.getReceivedPointerDownY(motionEvent.getPointerId(i5));
            if (receivedPointerDownY2 < j - this.mEdgeSwipeHeightPixels) {
                if (z3) {
                    Slog.d(
                            "TouchExplorer",
                            "The pointer is not on the bottom edge" + receivedPointerDownY2);
                    return;
                }
                return;
            }
    ...
    public final void handleActionUp(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
        ...
        if (sendHoverExitDelayed.isPending()) {
            if (sendHoverExitDelayed.isPending()) {
                ...
                sendHoverExitDelayed.this$0.mHandler.postDelayed(
                        sendHoverExitDelayed, r2.mDetermineUserIntentTimeout);
            }
            ...
            sendHoverExitDelayed2.mPolicyFlags = i;
            sendHoverExitDelayed2.this$0.mHandler.postDelayed(
                    sendHoverExitDelayed2, r7.mDetermineUserIntentTimeout);
        } else {
            sendHoverExitAndTouchExplorationGestureEndIfNeeded(i);
        }
        SendAccessibilityEventDelayed sendAccessibilityEventDelayed =
                this.mSendTouchInteractionEndDelayed;
        if (sendAccessibilityEventDelayed.isPending()) {
            return;
        }
        TouchExplorer.this.mHandler.postDelayed(
                sendAccessibilityEventDelayed, sendAccessibilityEventDelayed.mDelay);
    }
    ...
    public final void onAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (accessibilityManagerService.mTraceManager.isA11yTracingEnabledForTypes(12288L)) {
            accessibilityManagerService.mTraceManager.logTrace(
                    "TouchExplorer.onAccessibilityEvent", 12288L, "event=" + accessibilityEvent);
        }
        int eventType = accessibilityEvent.getEventType();
        if (eventType == 256 && !this.mSendHoverExitDelayed.isPending()) {
            Flags.sendA11yEventsBasedOnState();
            SendAccessibilityEventDelayed sendAccessibilityEventDelayed =
                    this.mSendTouchExplorationEndDelayed;
            ...
            if (eventType2 == 128 || eventType2 == 256) {
                ...
                if (eventType2 == 2097152) {
                    AccessibilityWindowManager accessibilityWindowManager =
                            touchState.mAms.mA11yWindowManager;
                    if (accessibilityWindowManager.mHasProxy
                            && (i = accessibilityWindowManager.mLastNonProxyTopFocusedDisplayId)
                                    != accessibilityWindowManager.mTopFocusedDisplayId) {
                        accessibilityWindowManager.mWindowManagerInternal.moveDisplayToTopIfAllowed(
                                i);
                    }
                }
            }
    ...
    public final void onDoubleTap(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
        ...
        if (gestureManifold.mSendMotionEventsEnabled) {
            dispatchGesture(
                    new AccessibilityGestureEvent(17, this.mDisplayId, gestureManifold.mEvents));
        }
        SendAccessibilityEventDelayed sendAccessibilityEventDelayed =
                this.mSendTouchExplorationEndDelayed;
        if (sendAccessibilityEventDelayed.isPending()) {
        ...
        AccessibilityNodeInfo accessibilityFocusNotLocked =
                accessibilityManagerService.getInteractionBridge().getAccessibilityFocusNotLocked();
        if ((accessibilityFocusNotLocked == null
                        || !accessibilityFocusNotLocked
                                .getActionList()
                                .contains(accessibilityAction))
                ? false
                : accessibilityFocusNotLocked.performAction(accessibilityAction.getId())) {
            return;
        }
        Slog.e(
                "TouchExplorer",
                "ACTION_CLICK failed. Dispatching motion events to simulate click.");
    ...
    public final void onDoubleTapAndHold(MotionEvent motionEvent, MotionEvent motionEvent2, int i) {
        ...
        eventDispatcher.mLongPressingPointerDeltaX =
                ((int) motionEvent.getX(actionIndex)) - point.x;
        eventDispatcher.mLongPressingPointerDeltaY =
                ((int) motionEvent.getY(actionIndex)) - point.y;
        eventDispatcher.sendDownForAllNotInjectedPointers(i, motionEvent);
        sendHoverExitAndTouchExplorationGestureEndIfNeeded(i);
        GestureManifold gestureManifold = this.mGestureDetector;
        if (gestureManifold.mSendMotionEventsEnabled) {
            dispatchGesture(
                    new AccessibilityGestureEvent(18, this.mDisplayId, gestureManifold.mEvents));
        }
        this.mState.setState(4);
    }
    ...
    public final void onGestureCompleted(AccessibilityGestureEvent accessibilityGestureEvent) {
        ...
        if (accessibilityManagerService.mTraceManager.isA11yTracingEnabledForTypes(12288L)) {
            accessibilityManagerService.mTraceManager.logTrace(
                    "TouchExplorer.onGestureCompleted",
                    12288L,
                    "event=" + accessibilityGestureEvent);
        }
        if (DEBUG) {
            Slog.d(
                    "TouchExplorer",
                    "onGestureCompleted() : " + accessibilityGestureEvent.getGestureId());
        }
    ...
    public final void onGestureStarted() {
        ...
        if (accessibilityManagerService.mTraceManager.isA11yTracingEnabledForTypes(12288L)) {
            accessibilityManagerService.mTraceManager.logTrace(
                    "TouchExplorer.onGestureStarted", 12288L);
        }
        if (DEBUG) {
    ...
    */
    public final void onMotionEvent(
            android.view.MotionEvent r17, android.view.MotionEvent r18, int r19) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.accessibility.gestures.TouchExplorer.onMotionEvent(android.view.MotionEvent,"
    ...
    public final void sendHoverExitAndTouchExplorationGestureEndIfNeeded(int i) {
        ...
        this.mDispatcher.sendMotionEvent(
                10, pointerIdBits, i, motionEvent, touchState.mLastReceivedEvent);
    }
    ...
    public final void sendTouchExplorationGestureStartAndHoverEnterIfNeeded(int i) {
        ...
        this.mDispatcher.sendMotionEvent(
                9, motionEvent.getPointerIdBits(), i, motionEvent, touchState.mLastReceivedEvent);
    }

    @Override // com.android.server.accessibility.BaseEventStreamTransformation,
              // com.android.server.accessibility.EventStreamTransformation
    ...
    public final void setServiceDetectsGestures(boolean z) {
        ...
        if (DEBUG) {
            DeviceIdleController$$ExternalSyntheticOutline0.m(
                    "serviceDetectsGestures: ", "TouchState", z);
        }
