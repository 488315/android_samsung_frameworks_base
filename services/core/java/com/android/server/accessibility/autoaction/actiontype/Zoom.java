        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.accessibility.autoaction.actiontype.Zoom.generateTouchEvent(int,"
        ...
        new Thread(
                        new Runnable() { // from class:
                            ...
                            public final void run() {
                                ...
                                int i8 = i;
                                Display display =
                                        ((DisplayManager) zoom.mContext.getSystemService("display"))
                                                .getDisplay(i8);
                                ...
                                int dimensionPixelSize =
                                        zoom.mContext
                                                .getResources()
                                                .getDimensionPixelSize(17106439);
