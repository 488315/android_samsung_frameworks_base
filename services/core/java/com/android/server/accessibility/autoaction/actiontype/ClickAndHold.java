        ...
        if (this.mLastMotionEvent != null) {
            new Thread(
                            new Runnable() { // from class:
                                             // com.android.server.accessibility.autoaction.actiontype.ClickAndHold.1
                                ...
                                public final void run() {
                                    ...
                                    int actionIndex =
                                            clickAndHold.mLastMotionEvent.getActionIndex();
                                    MotionEvent.PointerCoords pointerCoords =
                                            new MotionEvent.PointerCoords();
                                    MotionEvent.PointerCoords[] pointerCoordsArr = {pointerCoords};
                                    clickAndHold.mLastMotionEvent.getPointerCoords(
                                            actionIndex, pointerCoords);
                                    InputManager inputManager =
                                            (InputManager)
                                                    clickAndHold.mContext.getSystemService("input");
