...
public abstract class SemSamsungThemeUtils {
  ...
  public static boolean hasSamsungOverlayPermission(List list) {
    ...
    while (it.hasNext()) {
      ...
      if (str != null
          && (str.startsWith("com.samsung.android.permission.SAMSUNG_OVERLAY_")
              || str.startsWith("com.samsung.android.permission.SAMSUNG_OVERLAY_COMPONENT"))) {
        return true;
      }
    }
    return false;
  ...
  public static boolean isZippedLocaleOverlay(AndroidPackage androidPackage) {
    return (androidPackage == null
            ...
            || !androidPackage
                .getBaseApkPath()
                .startsWith("/data/overlays/current_locale_apks/files")
            || !androidPackage.getMetaData().getBoolean("com.samsung.android.zippedOverlay"))
        ? false
        : true;
  }
  ...
  public static void createLocaleOverlayPreferenceDir(File file) {
    ...
    if (!file.mkdirs()) {
      Log.e(
          "OverlayManager",
          "createLocaleOverlayPreferenceDir: Unable to create dir for new user - " + file);
      return;
    }
  ...
  public static boolean shouldBeDisabledInMaintenanceMode(
