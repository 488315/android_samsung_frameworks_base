...
public class OverlayGenerator {
  ...
  public OverlayGenerator(
      MetaDataManager metaDataManager, TemplateManager templateManager, ThemePalette themePalette) {
  ...
  public final FabricatedOverlay createOverlayForPkg(String str, MetaDataManager.Package r5) {
    ...
    FabricatedOverlay build =
        new FabricatedOverlay.Builder(
                "android", str + "_" + r5.getPackageName(), r5.getPackageName())
            .build();
        ...
        if (type == 1) {
          ...
          if (colors != null) {
            ...
            for (String str : split) {
              ...
              fabricatedOverlay.setResourceValue(
                  str2, 28, ((Integer) colors.get(0)).intValue(), (String) null);
              fabricatedOverlay.setResourceValue(
                  str2, 28, ((Integer) colors.get(1)).intValue(), "night");
            }
          }
        } else if (type == 2) {
          ...
          if (integer != null) {
            for (String str3 : split) {
              fabricatedOverlay.setResourceValue(
                  "integer/" + str3.trim(), 16, integer.intValue(), (String) null);
            }
          }
          ...
          for (String str4 : split) {
            ...
            fabricatedOverlay.setResourceValue(
                str5, 18, ((Boolean) booleans.get(0)).booleanValue() ? 1 : 0, (String) null);
            fabricatedOverlay.setResourceValue(
                str5, 18, ((Boolean) booleans.get(1)).booleanValue() ? 1 : 0, "night");
          }
        }
      }
    }
