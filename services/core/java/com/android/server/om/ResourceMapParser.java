...
public abstract class ResourceMapParser {
    ...
    public static void parseResourceEntries(
            String str,
            Resources resources,
                ...
                if (next != 4) {
                    ...
                    if (!"match".equals(name) || attributeValue == null) {
                        ...
                        while (true) {
                            ...
                            if (next2 == i4
                                    || (next2 == i5 && xmlResourceParser.getDepth() <= depth2)) {
                                break;
                            }
                            if (next2 == i5
                                    || next2 == i6
                                    || !"original".equals(xmlResourceParser.getName())) {
                                i4 = 1;
                            } else {
                                if (xmlResourceParser.next() == i6) {
                                    ...
                                    if (text == null || text.isEmpty()) {
                                        ...
                                        if (ordinal != 0) {
                                            ...
                                            i2 = depth;
                                            identifier =
                                                    resources.getIdentifier(text, "drawable", str);
                                        }
                                        if (identifier != 0) {
                                            arrayList.add(text);
                                        }
    ...
    public static void parseResourceMap(AndroidPackage androidPackage) {
        ...
        try {
            try {
                ...
                int identifier =
                        resources.getIdentifier(
                                "resource_map", "xml", androidPackage.getPackageName());
                if (identifier != 0) {
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.om.ResourceMapParser.parseResourceMapToFile(java.lang.String,"
