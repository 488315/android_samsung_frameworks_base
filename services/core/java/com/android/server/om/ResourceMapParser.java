...
public abstract class ResourceMapParser {
    ...
    try {
      try {
        APKContents aPKContents =
            new APKContents(((AndroidPackageSplit) androidPackage.getSplits().get(0)).getPath());
        assetManager = aPKContents.getAssets();
        try {
          Resources resources = aPKContents.getResources();
          int identifier =
              resources.getIdentifier("resource_map", "xml", androidPackage.getPackageName());
          if (identifier != 0) {
            xmlResourceParser = resources.getXml(identifier);
            parseResourceMapToFile(
  ...
  */
  public static void parseResourceMapToFile(
      String str, String str2, Resources resources, XmlResourceParser xmlResourceParser) {
    String name;
      ...
      if (next != 3 && next != 4 && (name = xmlResourceParser.getName()) != null) {
        if (z) {
          if ("drawable".equals(name)) {
            ...
            if (!parseResourceEntries(
                str, resources, xmlResourceParser, arrayMap, ResourceType.DRAWABLE)) {
              return;
            }
            ...
            if (!parseResourceEntries(
                str, resources, xmlResourceParser, arrayMap, ResourceType.COLOR)) {
              return;
            }
          } else {
            continue;
  ...
  */
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public static boolean parseResourceEntries(
      String str,
      Resources resources,
        ...
        if ("match".equals(name) && attributeValue != null) {
          ...
          if (!arrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
              ...
              int i =
                  AbstractC20531.$SwitchMap$com$android$server$om$ResourceMapParser$ResourceType[
          ...
          Log.w(
              "ResourceMapParser",
              "Unknown element under <resource-map>: "
  ...
  public abstract /* synthetic */ class AbstractC20531 {
    public static final /* synthetic */ int[]
        $SwitchMap$com$android$server$om$ResourceMapParser$ResourceType;
  ...
  public static boolean parseEntry(
      String str,
      Resources resources,
      XmlResourceParser xmlResourceParser,
      ArrayList arrayList,
