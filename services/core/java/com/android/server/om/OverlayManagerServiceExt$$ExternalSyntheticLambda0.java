...
public final /* synthetic */ class OverlayManagerServiceExt$$ExternalSyntheticLambda0
        implements Function {
    ...
    public /* synthetic */ OverlayManagerServiceExt$$ExternalSyntheticLambda0(
    ...
    public final Object apply(Object obj) {
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                while (length >= 0) {
                    ...
                    PackageState packageStateForUser =
                            overlayManagerServiceExt.mPackageManager.packageManagerHelper
                                    .getPackageStateForUser(
                                            i3, overlayInfoExt.info.targetPackageName);
                    AndroidPackage androidPackage =
                            packageStateForUser == null
                                    ? null
                                    : packageStateForUser.getAndroidPackage();
                    if (i3 == i2
                        ...
                        OverlayManagerSettings overlayManagerSettings =
                                overlayManagerServiceExt.mSettings;
                        if (i4 != 0) {
                            try {
                        ...
                        OverlayManagerSettings.SettingsItem.m739$$Nest$mgetOverlayInfo(
                                settingsItem);
                        overlayManagerServiceExt.updateOverlayState(
                                androidPackage2,
                                overlayInfoExt,
                                i3,
                                androidPackage2 != null ? z2 ? 3 : 2 : 0);
                    } else {
                        Slog.i(
                                "OverlayManagerExt",
                                "skip to update overlay : "
                            ...
                            .post(
                                    new Runnable() { // from class:
                                        ...
                                        public final void run() {
                                            int i7;
                                            OverlayManagerServiceExt overlayManagerServiceExt2 =
                                                    OverlayManagerServiceExt.this;
                                            OverlayInfoExt overlayInfoExt2 = overlayInfoExt;
                                            int i8 = i6;
                                            ISamsungOverlayCallback iSamsungOverlayCallback2 =
                                                    iSamsungOverlayCallback;
                                            overlayManagerServiceExt2.getClass();
                                            try {
                                                i7 =
                                                        overlayManagerServiceExt2.mSettings
                                                                .getState(
                                                                        overlayInfoExt2
                                                                                .getOverlayIdentifier(),
                                                                        i8);
                                            } catch (
                                                    OverlayManagerSettings.BadKeyException
                                                            unused2) {
                                                i7 = -1;
                                            }
                                            try {
                                                OverlayInfo overlayInfo2 = overlayInfoExt2.info;
                                                iSamsungOverlayCallback2.onOverlayStateChanged(
                                                        overlayInfo2.baseCodePath,
                                                        overlayInfo2.packageName,
                                                        i7);
            ...
            default:
                ...
                int[] userIds2 =
                        overlayManagerServiceExt2.getUserIds(overlayInfoExt2.configFlags, i7);
                for (int length2 = userIds2.length - 1; length2 >= 0; length2--) {
                    int i8 = userIds2[length2];
                    overlayManagerServiceExt2.mSettings.remove(
                            overlayInfoExt2.info.getOverlayIdentifier(), i8);
                    ...
                    FgThread.getHandler()
                            .post(
                                    new Runnable() { // from class:
                                        ...
                                        public final void run() {
                                            int i72;
                                            OverlayManagerServiceExt overlayManagerServiceExt22 =
                                                    OverlayManagerServiceExt.this;
                                            OverlayInfoExt overlayInfoExt22 = overlayInfoExt2;
                                            int i82 = i7;
                                            ISamsungOverlayCallback iSamsungOverlayCallback22 =
                                                    iSamsungOverlayCallback2;
                                            overlayManagerServiceExt22.getClass();
                                            try {
                                                i72 =
                                                        overlayManagerServiceExt22.mSettings
                                                                .getState(
                                                                        overlayInfoExt22
                                                                                .getOverlayIdentifier(),
                                                                        i82);
                                            ...
                                            try {
                                                ...
                                                iSamsungOverlayCallback22.onOverlayStateChanged(
                                                        overlayInfo2.baseCodePath,
                                                        overlayInfo2.packageName,
                                                        i72);
                                            } catch (RemoteException unused3) {
