    ...
    try {
      try {
        ...
        if (idmapDaemon.verifyIdmap(
            path, overlayInfo2.baseCodePath, overlayInfo2.overlayName, 1, false, i)) {
          return 1;
        }
      } catch (Exception e) {
      ...
      return idmapDaemon2.createIdmap(
                  path, overlayInfo3.baseCodePath, overlayInfo3.overlayName, 1, false, i)
              != null
          ? 3
          : 0;
      ...
      Slog.e(
          "OverlayManagerExt",
          "failed to generate idmap for " + path + " and " + overlayInfoExt.info.baseCodePath,
          e2);
      return 0;
    }
  }
