...
public final class RealTimeTokenService extends IRealTimeTokenService.Stub {
  ...
  public final BroadcastReceiver mNetWorkReceiver =
      new BroadcastReceiver() { // from class: com.android.server.RealTimeTokenService.2
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
          Slog.i("RealTimeTokenService", "Broadcast NetWork received:" + intent.getAction());
          try {
            if (!RealTimeTokenService.this.isNetworkAvailable(context)
                && RealTimeTokenService.this.getActiveTokenNumber() > 0) {
              ...
              try {
                if (RealTimeTokenService.this.mTimerObserve == null) {
                  ...
                  RealTimeTokenService.this.mTimerObserve.schedule(
                      RealTimeTokenService.this.mTimerTask, 0L, 21600000L);
                  return;
                }
                return;
              } catch (Exception e) {
  ...
  public final BroadcastReceiver mTimeChangedReceiver =
      new BroadcastReceiver() { // from class: com.android.server.RealTimeTokenService.3
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
          intent.getAction();
          ...
          RealTimeTokenService.this.getSystemTime();
          long j =
              (RealTimeTokenService.this.bootingTime + RealTimeTokenService.this.elapsedTime)
                  / 1000;
          Slog.i(
              ...
              "setUserTime: "
                  + j
                  + "|"
                  + RealTimeTokenService.this.bootingTime
                  + "|"
                  + RealTimeTokenService.this.elapsedTime);
  ...
  public final BroadcastReceiver mBootCompletedReceiver =
      new BroadcastReceiver() { // from class: com.android.server.RealTimeTokenService.4
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
          Slog.i("RealTimeTokenService", "Boot Completed Receiver");
          RealTimeTokenService.this.getSystemTime();
          RealTimeTokenService realTimeTokenService = RealTimeTokenService.this;
          realTimeTokenService.bootingTime =
              realTimeTokenService.currentTime - RealTimeTokenService.this.elapsedTime;
  ...
  public void makeTimerTask() {
    this.mTimerTask =
        new TimerTask() { // from class: com.android.server.RealTimeTokenService.1
