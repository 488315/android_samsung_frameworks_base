...
public class ExplicitHealthCheckController {
  ...
  public void setCallbacks(Consumer consumer, Consumer consumer2, Runnable runnable) {
    synchronized (this.mLock) {
      if (this.mPassedConsumer != null
          || this.mSupportedConsumer != null
          || this.mNotifySyncRunnable != null) {
    ...
    if (!z) {
      ...
      getSupportedPackages(
          new Consumer() { // from class:
            // com.android.server.ExplicitHealthCheckController$$ExternalSyntheticLambda0
  ...
  public /* synthetic */ void lambda$syncRequests$3(final Set set, final List list) {
    ...
    getRequestedPackages(
        new Consumer() { // from class:
          // com.android.server.ExplicitHealthCheckController$$ExternalSyntheticLambda2
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public /* synthetic */ void lambda$syncRequests$2(List list, Set set, List list2) {
    synchronized (this.mLock) {
      ...
      actOnDifference(
          ...
          set,
          new Consumer() { // from class:
            // com.android.server.ExplicitHealthCheckController$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
      ...
      actOnDifference(
          ...
          list2,
          new Consumer() { // from class:
            // com.android.server.ExplicitHealthCheckController$$ExternalSyntheticLambda5
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  public final void actOnDifference(
      Collection collection, Collection collection2, Consumer consumer) {
      ...
      if (prepareServiceLocked("request health check for " + str)) {
        ...
        try {
          ...
          Slog.w(
              ...
              "Failed to request health check for package " + str,
              e);
        }
      }
    }
    ...
    synchronized (this.mLock) {
      if (prepareServiceLocked("cancel health check for " + str)) {
        ...
        try {
          ...
          Slog.w(
              "ExplicitHealthCheckController",
              "Failed to cancel health check for package " + str,
              e);
        }
      }
    }
  ...
  public final void getSupportedPackages(final Consumer consumer) {
    synchronized (this.mLock) {
      if (prepareServiceLocked("get health check supported packages")) {
        ...
        try {
          this.mRemoteService.getSupportedPackages(
              new RemoteCallback(
                  new RemoteCallback.OnResultListener() { // from class:
                    // com.android.server.ExplicitHealthCheckController$$ExternalSyntheticLambda1
          ...
          Slog.w(
              "ExplicitHealthCheckController", "Failed to get health check supported packages", e);
        }
      }
    }
  }

  public static /* synthetic */ void lambda$getSupportedPackages$4(
      Consumer consumer, Bundle bundle) {
    ArrayList parcelableArrayList =
        bundle.getParcelableArrayList(
            "android.service.watchdog.extra.supported_packages",
            ExplicitHealthCheckService.PackageConfig.class);
    Slog.i(
        "ExplicitHealthCheckController",
        "Explicit health check supported packages " + parcelableArrayList);
  ...
  public final void getRequestedPackages(final Consumer consumer) {
    synchronized (this.mLock) {
      if (prepareServiceLocked("get health check requested packages")) {
        ...
        try {
          this.mRemoteService.getRequestedPackages(
              new RemoteCallback(
                  new RemoteCallback.OnResultListener() { // from class:
                    // com.android.server.ExplicitHealthCheckController$$ExternalSyntheticLambda3
                    public final void onResult(Bundle bundle) {
          ...
          Slog.w(
              "ExplicitHealthCheckController", "Failed to get health check requested packages", e);
        }
      }
    }
  }

  public static /* synthetic */ void lambda$getRequestedPackages$5(
      Consumer consumer, Bundle bundle) {
    ArrayList<String> stringArrayList =
        bundle.getStringArrayList("android.service.watchdog.extra.requested_packages");
    Slog.i(
        "ExplicitHealthCheckController",
        "Explicit health check requested packages " + stringArrayList);
  ...
  */
    ...
    synchronized (this.mLock) {
      ...
      if (z && this.mConnection == null && this.mRemoteService == null) {
        ...
        ServiceConnection serviceConnection = new ServiceConnection() { // from class:
              // com.android.server.ExplicitHealthCheckController.1
              @Override // android.content.ServiceConnection
              public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                Slog.i(
                    "ExplicitHealthCheckController",
                    "Explicit health check service is connected " + componentName);
              ...
              public void onServiceDisconnected(ComponentName componentName) {
                Slog.i(
                    "ExplicitHealthCheckController",
                    "Explicit health check service is disconnected " + componentName);
              ...
              public void onBindingDied(ComponentName componentName) {
                Slog.i(
                    "ExplicitHealthCheckController",
                    "Explicit health check service binding is dead. Rebind: " + componentName);
              ...
              public void onNullBinding(ComponentName componentName) {
                Slog.wtf(
                    "ExplicitHealthCheckController",
                    "Explicit health check service binding is null?? " + componentName);
              }
            };
      ...
      if (this.mRemoteService != null) {
        Slog.i(
            "ExplicitHealthCheckController", "Not binding to service, service already connected");
      } else {
        Slog.i(
            "ExplicitHealthCheckController", "Not binding to service, service already connecting");
      }
    }
  }
  ...
  public final ComponentName getServiceComponentNameLocked() {
    ...
    ComponentName componentName =
        new ComponentName(serviceInfoLocked.packageName, serviceInfoLocked.name);
    if ("android.permission.BIND_EXPLICIT_HEALTH_CHECK_SERVICE"
    ...
    Slog.w(
        ...
        componentName.flattenToShortString()
            + " does not require permission android.permission.BIND_EXPLICIT_HEALTH_CHECK_SERVICE");
    return null;
  }
  ...
  public final void initState(IBinder iBinder) {
    synchronized (this.mLock) {
      if (!this.mEnabled) {
        Slog.w(
            "ExplicitHealthCheckController",
            "Attempting to connect disabled service?? Unbinding...");
        unbindService();
        return;
      }
      IExplicitHealthCheckService asInterface =
          IExplicitHealthCheckService.Stub.asInterface(iBinder);
      this.mRemoteService = asInterface;
      try {
        asInterface.setCallback(
            new RemoteCallback(
                new RemoteCallback.OnResultListener() { // from class:
                  // com.android.server.ExplicitHealthCheckController$$ExternalSyntheticLambda6
                  public final void onResult(Bundle bundle) {
        ...
        Slog.wtf(
            "ExplicitHealthCheckController",
            "Could not setCallback on explicit health check service");
      }
  ...
  public /* synthetic */ void lambda$initState$6(Bundle bundle) {
    ...
    if (!TextUtils.isEmpty(string)) {
      ...
      if (consumer == null) {
        Slog.wtf(
            "ExplicitHealthCheckController",
            "Health check passed for package " + string + "but no consumer registered.");
        return;
      }
