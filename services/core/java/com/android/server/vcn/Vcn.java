...
public final class Vcn extends Handler {
    ...
    public final class VcnGatewayStatusCallbackImpl implements VcnGatewayStatusCallback {
        ...
        public final void onGatewayConnectionError(int i, String str, String str2, String str3) {
            ((VcnManagementService.VcnCallbackImpl) Vcn.this.mVcnCallback)
                    .onGatewayConnectionError(i, str, str2, str3);
        }
    ...
    public Vcn(
        ...
        vcnContentResolver.mImpl.registerContentObserver(
    ...
    public final void dump(IndentingPrintWriter indentingPrintWriter) {
        ...
        indentingPrintWriter.increaseIndent();
        for (VcnGatewayConnection vcnGatewayConnection :
                ((HashMap) this.mVcnGatewayConnections).values()) {
            vcnGatewayConnection.mVcnContext.ensureRunningOnLooperThread();
            indentingPrintWriter.println(
                    "VcnGatewayConnection ("
                            + vcnGatewayConnection.mConnectionConfig.getGatewayConnectionName()
                            + "):");
            indentingPrintWriter.increaseIndent();
            StringBuilder sb = new StringBuilder("Current state: ");
            sb.append(
                    vcnGatewayConnection.getCurrentState() == null
                            ? null
                            : vcnGatewayConnection.getCurrentState().getClass().getSimpleName());
            indentingPrintWriter.println(sb.toString());
            StringBuilder m =
                    AttentionManagerService$AttentionCheck$$ExternalSyntheticOutline0.m(
                            AttentionManagerService$AttentionCheck$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("mIsQuitting: "),
                                    vcnGatewayConnection.mIsQuitting.mValue,
                                    indentingPrintWriter,
                                    "mIsInSafeMode: "),
                            vcnGatewayConnection.mIsInSafeMode,
                            indentingPrintWriter,
                            "mCurrentToken: ");
            m.append(vcnGatewayConnection.mCurrentToken);
            indentingPrintWriter.println(m.toString());
            indentingPrintWriter.println(
                    "mFailedAttempts: " + vcnGatewayConnection.mFailedAttempts);
            StringBuilder sb2 = new StringBuilder("mNetworkAgent.getNetwork(): ");
            VcnGatewayConnection.VcnNetworkAgent vcnNetworkAgent =
                    vcnGatewayConnection.mNetworkAgent;
            ...
            UnderlyingNetworkController underlyingNetworkController =
                    vcnGatewayConnection.mUnderlyingNetworkController;
            ...
            sb3.append(
                    persistableBundleWrapper != null
                            ? persistableBundleWrapper.mBundle.getInt(
                                    "vcn_network_selection_wifi_entry_rssi_threshold", -70)
                            : -70);
            ...
            sb4.append(
                    persistableBundleWrapper2 != null
                            ? persistableBundleWrapper2.mBundle.getInt(
                                    "vcn_network_selection_wifi_exit_rssi_threshold", -74)
                            : -74);
            ...
            UnderlyingNetworkRecord underlyingNetworkRecord =
                    underlyingNetworkController.mCurrentRecord;
            ...
            if (underlyingNetworkController.mRouteSelectionCallback != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (builder.isValid()) {
                        ...
                        indentingPrintWriter.println(
                                "mNetworkCapabilities: " + build.networkCapabilities);
                    ...
                    StringBuilder m2 =
                            AttentionManagerService$AttentionCheck$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("mIsSelected: "),
                                    underlyingNetworkEvaluator.mIsSelected,
                                    indentingPrintWriter,
                                    "mPriorityClass: ");
                    m2.append(underlyingNetworkEvaluator.mPriorityClass);
                    indentingPrintWriter.println(m2.toString());
                    indentingPrintWriter.println(
                            "mIsPenalized: " + underlyingNetworkEvaluator.mIsPenalized);
                    indentingPrintWriter.decreaseIndent();
                }
            }
            indentingPrintWriter.decreaseIndent();
    ...
    public final boolean getMobileDataStatus() {
        ...
        while (it.hasNext()) {
            if (((TelephonyManager)
                            this.mVcnContext.mContext.getSystemService(TelephonyManager.class))
                    .createForSubscriptionId(((Integer) it.next()).intValue())
                    .isDataEnabled()) {
                return true;
            }
        }
    ...
    public Set getVcnGatewayConnections() {
        return Collections.unmodifiableSet(
                new HashSet(((HashMap) this.mVcnGatewayConnections).values()));
    }
    ...
    public final void handleMessage(Message message) {
        ...
        if (this.mCurrentStatus == 2 || this.mCurrentStatus == 3) {
            ...
            if (i == 0) {
                ...
                for (Map.Entry entry : ((HashMap) this.mVcnGatewayConnections).entrySet()) {
                    ...
                    VcnGatewayConnection vcnGatewayConnection =
                            (VcnGatewayConnection) entry.getValue();
                    if (!this.mConfig
                            .getGatewayConnectionConfigs()
                            .contains(vcnGatewayConnectionConfig)) {
                        if (vcnGatewayConnection == null) {
                            ...
                            logInfo(
                                    "Config updated, restarting gateway "
                                            + vcnGatewayConnection.getLogPrefix());
            ...
            if (i == 1) {
                ...
                for (VcnGatewayConnectionConfig vcnGatewayConnectionConfig2 :
                        this.mConfig.getGatewayConnectionConfigs()) {
                    if (isRequestSatisfiedByGatewayConnectionConfig(
                            networkRequest, vcnGatewayConnectionConfig2)) {
                        if (this.mIsMobileDataEnabled) {
                            set = vcnGatewayConnectionConfig2.getAllExposedCapabilities();
                        } else {
                            ArraySet arraySet =
                                    new ArraySet(
                                            vcnGatewayConnectionConfig2
                                                    .getAllExposedCapabilities());
                            arraySet.removeAll(CAPS_REQUIRING_MOBILE_DATA);
                            set = arraySet;
                        }
                        if (!set.isEmpty()) {
                            if (((HashMap) this.mVcnGatewayConnections)
                                    .containsKey(vcnGatewayConnectionConfig2)) {
                                logWtf(
                                        "Attempted to bring up VcnGatewayConnection for config with"
                                            + " existing VcnGatewayConnection");
                                return;
                            }
                            logInfo(
                                    "Bringing up new VcnGatewayConnection for request "
                                            + networkRequest);
                            ParcelUuid parcelUuid = this.mSubscriptionGroup;
                            TelephonySubscriptionTracker.TelephonySubscriptionSnapshot
                                    telephonySubscriptionSnapshot = this.mLastSnapshot;
                            VcnGatewayStatusCallbackImpl vcnGatewayStatusCallbackImpl =
                                    new VcnGatewayStatusCallbackImpl(vcnGatewayConnectionConfig2);
                            boolean z2 = this.mIsMobileDataEnabled;
                            this.mDeps.getClass();
                            ((HashMap) this.mVcnGatewayConnections)
                                    .put(
                                            vcnGatewayConnectionConfig2,
                                            new VcnGatewayConnection(
                                                    ...
                                                    telephonySubscriptionSnapshot,
                                                    vcnGatewayConnectionConfig2,
                                                    vcnGatewayStatusCallbackImpl,
                                                    z2,
                                                    new VcnGatewayConnection.Dependencies()));
                            return;
                        }
                    }
                }
            ...
            if (i != 2) {
                if (i == 3) {
                    VcnGatewayConnectionConfig vcnGatewayConnectionConfig3 =
                            (VcnGatewayConnectionConfig) message.obj;
                ...
                if (i == 4) {
                    ...
                    while (true) {
                        ...
                        VcnGatewayConnection vcnGatewayConnection2 =
                                (VcnGatewayConnection) it2.next();
                    ...
                    if (i2 != this.mCurrentStatus) {
                        VcnManagementService.VcnCallbackImpl vcnCallbackImpl =
                                (VcnManagementService.VcnCallbackImpl) this.mVcnCallback;
                        synchronized (VcnManagementService.this.mLock) {
                            try {
                                if (((ArrayMap) VcnManagementService.this.mVcns)
                                        .containsKey(vcnCallbackImpl.mSubGroup)) {
                                    int i3 = z ? 3 : 2;
                        ...
                        logInfo(
                                "Safe mode "
                                        .concat(this.mCurrentStatus == 3 ? "entered" : "exited"));
                        return;
                    }
                    return;
                }
                ...
                while (it4.hasNext()) {
                    ((TelephonyManager)
                                    this.mVcnContext.mContext.getSystemService(
                                            TelephonyManager.class))
                            .unregisterTelephonyCallback(
                                    (VcnUserMobileDataStateListener) it4.next());
                }
            ...
            for (VcnGatewayConnection vcnGatewayConnection3 :
                    ((HashMap) this.mVcnGatewayConnections).values()) {
                TelephonySubscriptionTracker.TelephonySubscriptionSnapshot
                        telephonySubscriptionSnapshot2 = this.mLastSnapshot;
                ...
                UnderlyingNetworkController underlyingNetworkController =
                        vcnGatewayConnection3.mUnderlyingNetworkController;
                underlyingNetworkController.getClass();
                TelephonySubscriptionTracker.TelephonySubscriptionSnapshot
                        telephonySubscriptionSnapshot3 = underlyingNetworkController.mLastSnapshot;
                underlyingNetworkController.mLastSnapshot = telephonySubscriptionSnapshot2;
                underlyingNetworkController.mCarrierConfig =
                        telephonySubscriptionSnapshot2.getCarrierConfigForSubGrp(
                                underlyingNetworkController.mSubscriptionGroup);
                for (UnderlyingNetworkEvaluator underlyingNetworkEvaluator :
                        ((ArrayMap) underlyingNetworkController.mUnderlyingNetworkRecords)
                                .values()) {
                    ...
                    TelephonySubscriptionTracker.TelephonySubscriptionSnapshot
                            telephonySubscriptionSnapshot4 =
                                    underlyingNetworkController.mLastSnapshot;
                    PersistableBundleUtils.PersistableBundleWrapper persistableBundleWrapper =
                            underlyingNetworkController.mCarrierConfig;
                    ...
                    underlyingNetworkEvaluator.mPenalizedTimeoutMs =
                            TimeUnit.MINUTES.toMillis(iArr[0]);
                    Iterator it5 =
                            ((ArrayList) underlyingNetworkEvaluator.mMetricMonitors).iterator();
                    while (it5.hasNext()) {
                        IpSecPacketLossDetector ipSecPacketLossDetector =
                                (IpSecPacketLossDetector) ((NetworkMetricMonitor) it5.next());
                        ipSecPacketLossDetector.getClass();
                        ipSecPacketLossDetector.mPollIpSecStateIntervalMs =
                        ...
                        if (Flags.handleSeqNumLeap()) {
                            ipSecPacketLossDetector.mPacketLossRatePercentThreshold =
                                    persistableBundleWrapper != null
                                            ? persistableBundleWrapper.mBundle.getInt(
                                                    "vcn_network_selection_ipsec_packet_loss_percent_threshold",
                                                    12)
                                            : 12;
                            ipSecPacketLossDetector.mMaxSeqNumIncreasePerSecond =
                                    IpSecPacketLossDetector.getMaxSeqNumIncreasePerSecond(
                                            persistableBundleWrapper);
                        }
                        if (Flags.allowDisableIpsecLossDetector()) {
                            NetworkMetricMonitor.IpSecTransformWrapper ipSecTransformWrapper =
                                    ipSecPacketLossDetector.mInboundTransform;
                ...
                if (!((ArraySet)
                                telephonySubscriptionSnapshot3.getAllSubIdsInGroup(
                                        underlyingNetworkController.mSubscriptionGroup))
                        .equals(
                                telephonySubscriptionSnapshot2.getAllSubIdsInGroup(
                                        underlyingNetworkController.mSubscriptionGroup))) {
                    underlyingNetworkController.registerOrUpdateNetworkRequests();
                } else if (underlyingNetworkController.mVcnContext
                                .isFlagNetworkMetricMonitorEnabled()
    ...
    public final boolean isRequestSatisfiedByGatewayConnectionConfig(
        ...
        if (this.mIsMobileDataEnabled) {
            ...
            ArraySet arraySet =
                    new ArraySet(vcnGatewayConnectionConfig.getAllExposedCapabilities());
            arraySet.removeAll(CAPS_REQUIRING_MOBILE_DATA);
            set = arraySet;
        }
    ...
    public final void updateMobileDataStateListeners() {
        ...
        while (true) {
            ...
            if (!((ArrayMap) this.mMobileDataStateListeners).containsKey(num)) {
                ...
                ((ArrayMap) this.mMobileDataStateListeners)
                        .put(num, vcnUserMobileDataStateListener);
            }
        }
        ...
        while (it2.hasNext()) {
            ...
            if (!arraySet.contains(entry.getKey())) {
                ((TelephonyManager) vcnContext.mContext.getSystemService(TelephonyManager.class))
                        .unregisterTelephonyCallback((TelephonyCallback) entry.getValue());
                it2.remove();
            }
        }
    }
