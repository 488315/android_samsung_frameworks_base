            ...
            switch (message.what) {
                ...
                case 6:
                    ...
                    for (int i = 0; i < parallelTunnelCount - 1; i++) {
                        ...
                        VcnGatewayConnection vcnGatewayConnection3 = VcnGatewayConnection.this;
                        vcnIkeSession.openChildSession(buildOpportunisticChildParams, vcnGatewayConnection3.new VcnChildSessionCallback(vcnGatewayConnection3.mCurrentToken, true));
                    }
                    break;
                case 7:
                    handleDisconnectRequested((EventDisconnectRequestedInfo) message.obj);
