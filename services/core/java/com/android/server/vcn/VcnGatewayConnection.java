...
public class VcnGatewayConnection extends StateMachine {
    ...
    public boolean equals(Object obj) {
      if (obj instanceof EventUnderlyingNetworkChangedInfo) {
        return Objects.equals(
            this.newUnderlying, ((EventUnderlyingNetworkChangedInfo) obj).newUnderlying);
      }
      return false;
    }
  }
  ...
  public class EventTransformCreatedInfo implements EventInfo {
    ...
    public boolean equals(Object obj) {
      ...
      return this.direction == eventTransformCreatedInfo.direction
          && Objects.equals(this.transform, eventTransformCreatedInfo.transform);
    }
  }
  ...
  public class EventSetupCompletedInfo implements EventInfo {
    ...
    public boolean equals(Object obj) {
      if (obj instanceof EventSetupCompletedInfo) {
        return Objects.equals(
            this.childSessionConfig, ((EventSetupCompletedInfo) obj).childSessionConfig);
      }
      return false;
    }
  }
  ...
  public class EventDisconnectRequestedInfo implements EventInfo {
    ...
    public boolean equals(Object obj) {
      ...
      EventDisconnectRequestedInfo eventDisconnectRequestedInfo =
          (EventDisconnectRequestedInfo) obj;
      return this.reason.equals(eventDisconnectRequestedInfo.reason)
          && this.shouldQuit == eventDisconnectRequestedInfo.shouldQuit;
    }
  }
  ...
  public class EventMigrationCompletedInfo implements EventInfo {
    ...
    public EventMigrationCompletedInfo(
    ...
    public boolean equals(Object obj) {
      ...
      return Objects.equals(this.inTransform, eventMigrationCompletedInfo.inTransform)
          && Objects.equals(this.outTransform, eventMigrationCompletedInfo.outTransform);
    }
  }
  ...
  public class EventIkeConnectionInfoChangedInfo implements EventInfo {
    ...
    public boolean equals(Object obj) {
      if (obj instanceof EventIkeConnectionInfoChangedInfo) {
        return Objects.equals(
            this.ikeConnectionInfo, ((EventIkeConnectionInfoChangedInfo) obj).ikeConnectionInfo);
      }
      return false;
    }
  }
  ...
  public VcnGatewayConnection(
      ...
      Vcn.VcnGatewayStatusCallback vcnGatewayStatusCallback,
      boolean z) {
    this(
        vcnContext,
        parcelUuid,
  ...
  */
  public VcnGatewayConnection(
    ...
    VcnUnderlyingNetworkControllerCallback vcnUnderlyingNetworkControllerCallback =
        new VcnUnderlyingNetworkControllerCallback();
    ...
    this.mUnderlyingNetworkController =
    ...
    this.mIpSecManager =
        (IpSecManager) vcnContext.getContext().getSystemService(IpSecManager.class);
    ...
    ConnectivityDiagnosticsManager connectivityDiagnosticsManager =
        (ConnectivityDiagnosticsManager)
            vcnContext.getContext().getSystemService(ConnectivityDiagnosticsManager.class);
    this.mConnectivityDiagnosticsManager = connectivityDiagnosticsManager;
    VcnConnectivityDiagnosticsCallback vcnConnectivityDiagnosticsCallback =
        new VcnConnectivityDiagnosticsCallback();
    ...
    if (vcnGatewayConnectionConfig.hasGatewayOption(0)) {
      connectivityDiagnosticsManager.registerConnectivityDiagnosticsCallback(
          new NetworkRequest.Builder().addTransportType(0).build(),
  ...
  public class VcnConnectivityDiagnosticsCallback
    ...
    public void onDataStallSuspected(
      ...
      VcnGatewayConnection.this.sendMessageAndAcquireWakeLock(
          13, Integer.MIN_VALUE, new EventDataStallSuspectedInfo(network));
    }
  }

  public class VcnUnderlyingNetworkControllerCallback
      implements UnderlyingNetworkController.UnderlyingNetworkControllerCallback {
    ...
    public void onSelectedUnderlyingNetworkChanged(
      ...
      if (underlyingNetworkRecord == null) {
        if (VcnGatewayConnection.this.mDeps.isAirplaneModeOn(
            VcnGatewayConnection.this.mVcnContext)) {
          VcnGatewayConnection.this.sendMessageAndAcquireWakeLock(
              1, Integer.MIN_VALUE, new EventUnderlyingNetworkChangedInfo(null));
          VcnGatewayConnection.this.sendDisconnectRequestedAndAcquireWakelock(
              "Underlying Network lost", false);
          return;
        }
      ...
      VcnGatewayConnection.this.sendMessageAndAcquireWakeLock(
          1, Integer.MIN_VALUE, new EventUnderlyingNetworkChangedInfo(underlyingNetworkRecord));
    }
  }
  ...
  public final WakeupMessage createScheduledAlarm(String str, final Message message, long j) {
    ...
    if (handler == null) {
      logWarn(
          "Attempted to schedule alarm after StateMachine has quit", new IllegalStateException());
      return null;
    }
    WakeupMessage newWakeupMessage =
        this.mDeps.newWakeupMessage(
            this.mVcnContext,
            handler,
            str,
            new Runnable() { // from class:
                             // com.android.server.vcn.VcnGatewayConnection$$ExternalSyntheticLambda0
  ...
  public final void setTeardownTimeoutAlarm() {
    ...
    this.mTeardownTimeoutAlarm =
        createScheduledAlarm(
            TEARDOWN_TIMEOUT_ALARM,
            obtainMessage(8, this.mCurrentToken),
    ...
    this.mDisconnectRequestAlarm =
        createScheduledAlarm(
            ...
            obtainMessage(
                ...
                Integer.MIN_VALUE,
                0,
                new EventDisconnectRequestedInfo("Underlying Network lost", false)),
  ...
  public final void setRetryTimeoutAlarm(long j) {
    ...
    this.mRetryTimeoutAlarm =
        createScheduledAlarm(RETRY_TIMEOUT_ALARM, obtainMessage(2, this.mCurrentToken), j);
  }
  ...
  public final void sessionLost(int i, Exception exc) {
    if (exc != null) {
      this.mGatewayStatusCallback.onGatewayConnectionError(
          this.mConnectionConfig.getGatewayConnectionName(),
          0,
          RuntimeException.class.getName(),
          "Received " + exc.getClass().getSimpleName() + " with message: " + exc.getMessage());
    }
    sessionLostWithoutCallback(i, exc);
  }

  public static boolean isIkeAuthFailure(Exception exc) {
    return (exc instanceof IkeProtocolException)
        && ((IkeProtocolException) exc).getErrorType() == 24;
  }
  ...
  public final void notifyStatusCallbackForSessionClosed(Exception exc) {
    ...
    logDbg(
        "Encountered error; code=" + i + ", exceptionClass=" + name + ", exceptionMessage=" + str);
    this.mGatewayStatusCallback.onGatewayConnectionError(
        this.mConnectionConfig.getGatewayConnectionName(), i, name, str);
  }

  public final void ikeConnectionInfoChanged(
      int i, IkeSessionConnectionInfo ikeSessionConnectionInfo) {
    sendMessageAndAcquireWakeLock(
        12, i, new EventIkeConnectionInfoChangedInfo(ikeSessionConnectionInfo));
  }
  ...
  public final void migrationCompleted(
      int i, IpSecTransform ipSecTransform, IpSecTransform ipSecTransform2) {
    sendMessageAndAcquireWakeLock(
        11, i, new EventMigrationCompletedInfo(ipSecTransform, ipSecTransform2));
  }
  ...
  public abstract class BaseState extends State {
    ...
    public void enter() {
      try {
        ...
        VcnGatewayConnection.this.sendDisconnectRequestedAndAcquireWakelock(
            "Uncaught exception: " + e.toString(), true);
      }
    }
    ...
    public final boolean processMessage(Message message) {
      int i = message.arg1;
      if (!isValidToken(i)) {
        VcnGatewayConnection.this.logDbg(
            "Message called with obsolete token: " + i + "; what: " + message.what);
        return true;
      }
      try {
    ...
    public void handleDisconnectRequested(
        EventDisconnectRequestedInfo eventDisconnectRequestedInfo) {
      VcnGatewayConnection.this.logInfo(
          "Tearing down. Cause: "
              + eventDisconnectRequestedInfo.reason
              + "; quitting = "
              + eventDisconnectRequestedInfo.shouldQuit);
    ...
    public void logUnexpectedEvent(int i) {
      VcnGatewayConnection.this.logVdbg(
          "Unexpected event code " + i + " in state " + getClass().getSimpleName());
    }

    public void logWtfUnknownEvent(int i) {
      VcnGatewayConnection.this.logWtf(
          "Unknown event code " + i + " in state " + getClass().getSimpleName());
    }
  }
  ...
  public class DisconnectedState extends BaseState {
    ...
    public void processStateMsg(Message message) {
      int i = message.what;
      if (i == 1) {
        VcnGatewayConnection.this.mUnderlying =
            ((EventUnderlyingNetworkChangedInfo) message.obj).newUnderlying;
  ...
  public class DisconnectingState extends ActiveBaseState {
    ...
    public void enterState() {
      if (VcnGatewayConnection.this.mIkeSession == null) {
        VcnGatewayConnection.this.logWtf(
            "IKE session was already closed when entering Disconnecting state.");
        VcnGatewayConnection vcnGatewayConnection = VcnGatewayConnection.this;
    ...
    public void processStateMsg(Message message) {
      ...
      if (i == 1) {
        ...
        if (i == 4) {
          ...
          if (!VcnGatewayConnection.this.mIsQuitting.getValue()
              && VcnGatewayConnection.this.mUnderlying != null) {
            VcnGatewayConnection vcnGatewayConnection = VcnGatewayConnection.this;
            vcnGatewayConnection.transitionTo(
                this.mSkipRetryTimeout
                    ? vcnGatewayConnection.mConnectingState
                    : vcnGatewayConnection.mRetryTimeoutState);
            return;
          } else {
            teardownNetwork();
            VcnGatewayConnection vcnGatewayConnection2 = VcnGatewayConnection.this;
        ...
        if (i == 7) {
          EventDisconnectRequestedInfo eventDisconnectRequestedInfo =
              (EventDisconnectRequestedInfo) message.obj;
          if (eventDisconnectRequestedInfo.shouldQuit) {
            VcnGatewayConnection.this.mIsQuitting.setTrue();
          }
          teardownNetwork();
  ...
  public class ConnectingState extends ActiveBaseState {
    ...
    public void enterState() {
      ...
      VcnGatewayConnection vcnGatewayConnection = VcnGatewayConnection.this;
      vcnGatewayConnection.mIkeSession =
          vcnGatewayConnection.buildIkeSession(vcnGatewayConnection.mUnderlying.network);
    }
    ...
    public void processStateMsg(Message message) {
      ...
      if (underlyingNetworkRecord == null) {
        VcnGatewayConnection.this.logWtf(
            "Old underlying network was null in connected state. Bug?");
      }
      if (VcnGatewayConnection.this.mUnderlying == null) {
        ...
        return;
      } else if (underlyingNetworkRecord != null
          && VcnGatewayConnection.this.mUnderlying.network.equals(
              underlyingNetworkRecord.network)) {
        return;
      } else {
  ...
  public abstract class ConnectedStateBase extends ActiveBaseState {
    ...
    public void updateNetworkAgent(
        IpSecManager.IpSecTunnelInterface ipSecTunnelInterface,
      ...
      NetworkCapabilities buildNetworkCapabilities =
          VcnGatewayConnection.buildNetworkCapabilities(
              VcnGatewayConnection.this.mConnectionConfig,
              VcnGatewayConnection.this.mUnderlying,
              VcnGatewayConnection.this.mIsMobileDataEnabled);
      VcnGatewayConnection vcnGatewayConnection = VcnGatewayConnection.this;
      LinkProperties buildConnectedLinkProperties =
          vcnGatewayConnection.buildConnectedLinkProperties(
              vcnGatewayConnection.mConnectionConfig,
              ipSecTunnelInterface,
              vcnChildSessionConfiguration,
              VcnGatewayConnection.this.mUnderlying,
      ...
      vcnNetworkAgent.setUnderlyingNetworks(
          VcnGatewayConnection.this.mUnderlying == null
              ? null
              : Collections.singletonList(VcnGatewayConnection.this.mUnderlying.network));
    }

    public VcnNetworkAgent buildNetworkAgent(
        IpSecManager.IpSecTunnelInterface ipSecTunnelInterface,
        VcnChildSessionConfiguration vcnChildSessionConfiguration,
        IkeSessionConnectionInfo ikeSessionConnectionInfo) {
      NetworkCapabilities buildNetworkCapabilities =
          VcnGatewayConnection.buildNetworkCapabilities(
              ...
              VcnGatewayConnection.this.mIsMobileDataEnabled);
      VcnGatewayConnection vcnGatewayConnection = VcnGatewayConnection.this;
      VcnNetworkAgent newNetworkAgent =
          VcnGatewayConnection.this.mDeps.newNetworkAgent(
              VcnGatewayConnection.this.mVcnContext,
              VcnGatewayConnection.TAG,
              ...
              new NetworkAgentConfig.Builder()
                  .setLegacyType(0)
                  .setLegacyTypeName(VcnGatewayConnection.NETWORK_INFO_NETWORK_TYPE_STRING)
                  .setLegacySubType(0)
                  .setLegacySubTypeName(TelephonyManager.getNetworkTypeName(0))
                  .setLegacyExtraInfo(VcnGatewayConnection.NETWORK_INFO_EXTRA_INFO)
                  .build(),
              VcnGatewayConnection.this.mVcnContext.getVcnNetworkProvider(),
              new Consumer() { // from class:
                               // com.android.server.vcn.VcnGatewayConnection$ConnectedStateBase$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  VcnGatewayConnection.ConnectedStateBase.this.lambda$buildNetworkAgent$0(
                      (VcnGatewayConnection.VcnNetworkAgent) obj);
                }
              },
              new Consumer() { // from class:
                               // com.android.server.vcn.VcnGatewayConnection$ConnectedStateBase$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  VcnGatewayConnection.ConnectedStateBase.this.lambda$buildNetworkAgent$1(
                      (Integer) obj);
                }
              });
    ...
    public /* synthetic */ void lambda$buildNetworkAgent$1(Integer num) {
      ...
      if (intValue == 2) {
        if (VcnGatewayConnection.this.mUnderlying != null) {
          VcnGatewayConnection.this.mConnectivityManager.reportNetworkConnectivity(
              VcnGatewayConnection.this.mUnderlying.network, false);
        }
        VcnGatewayConnection.this.setSafeModeAlarm();
      } else {
    ...
    public void applyTransform(
      ...
      try {
        ...
        VcnGatewayConnection.this.mIpSecManager.applyTunnelModeTransform(
            ipSecTunnelInterface, i2, ipSecTransform);
        Set allExposedCapabilities =
            VcnGatewayConnection.this.mConnectionConfig.getAllExposedCapabilities();
        if (i2 == 0 && allExposedCapabilities.contains(2)) {
          VcnGatewayConnection.this.mIpSecManager.applyTunnelModeTransform(
              ipSecTunnelInterface, 2, ipSecTransform);
        }
      } catch (IOException e) {
    ...
    public void setupInterface(
      ...
      try {
        ...
        for (LinkAddress linkAddress2 : arraySet4) {
          ipSecTunnelInterface.removeAddress(
  ...
  public class ConnectedState extends ConnectedStateBase {
    ...
    public void enterState() {
      if (VcnGatewayConnection.this.mTunnelIface == null) {
        try {
          ...
          vcnGatewayConnection.mTunnelIface =
              ipSecManager.createIpSecTunnelInterface(
                  inetAddress, inetAddress, VcnGatewayConnection.this.mUnderlying.network);
    ...
    public void processStateMsg(Message message) {
      switch (message.what) {
        ...
        case 4:
          ...
          break;
        case 5:
          EventTransformCreatedInfo eventTransformCreatedInfo =
              (EventTransformCreatedInfo) message.obj;
          applyTransform(
              VcnGatewayConnection.this.mCurrentToken,
              VcnGatewayConnection.this.mTunnelIface,
              VcnGatewayConnection.this.mUnderlying.network,
              eventTransformCreatedInfo.transform,
              eventTransformCreatedInfo.direction);
          break;
        case 6:
          VcnChildSessionConfiguration vcnChildSessionConfiguration =
              VcnGatewayConnection.this.mChildConfig;
          VcnGatewayConnection.this.mChildConfig =
              ((EventSetupCompletedInfo) message.obj).childSessionConfig;
          setupInterfaceAndNetworkAgent(
              VcnGatewayConnection.this.mCurrentToken,
              VcnGatewayConnection.this.mTunnelIface,
              VcnGatewayConnection.this.mChildConfig,
              vcnChildSessionConfiguration,
              VcnGatewayConnection.this.mIkeConnectionInfo);
          int parallelTunnelCount =
              VcnGatewayConnection.this.mDeps.getParallelTunnelCount(
                  VcnGatewayConnection.this.mLastSnapshot,
                  VcnGatewayConnection.this.mSubscriptionGroup);
          ...
          for (int i = 0; i < parallelTunnelCount - 1; i++) {
            ...
            ChildSessionParams buildOpportunisticChildParams =
                VcnGatewayConnection.this.buildOpportunisticChildParams();
            VcnGatewayConnection vcnGatewayConnection3 = VcnGatewayConnection.this;
            vcnIkeSession.openChildSession(
                buildOpportunisticChildParams,
                vcnGatewayConnection3
                .new VcnChildSessionCallback(vcnGatewayConnection3.mCurrentToken, true));
          }
          break;
        case 7:
          handleDisconnectRequested((EventDisconnectRequestedInfo) message.obj);
        ...
        case 12:
          VcnGatewayConnection.this.mIkeConnectionInfo =
              ((EventIkeConnectionInfoChangedInfo) message.obj).ikeConnectionInfo;
          break;
        case 13:
    ...
    public final void handleMigrationCompleted(
        EventMigrationCompletedInfo eventMigrationCompletedInfo) {
      VcnGatewayConnection.this.logInfo(
          "Migration completed: " + VcnGatewayConnection.this.mUnderlying.network);
      applyTransform(
          VcnGatewayConnection.this.mCurrentToken,
          VcnGatewayConnection.this.mTunnelIface,
          VcnGatewayConnection.this.mUnderlying.network,
          eventMigrationCompletedInfo.inTransform,
          0);
      applyTransform(
          VcnGatewayConnection.this.mCurrentToken,
          VcnGatewayConnection.this.mTunnelIface,
          VcnGatewayConnection.this.mUnderlying.network,
          eventMigrationCompletedInfo.outTransform,
          1);
      updateNetworkAgent(
          VcnGatewayConnection.this.mTunnelIface,
          VcnGatewayConnection.this.mNetworkAgent,
          VcnGatewayConnection.this.mChildConfig,
          VcnGatewayConnection.this.mIkeConnectionInfo);
      VcnGatewayConnection.this.mConnectivityManager.reportNetworkConnectivity(
          VcnGatewayConnection.this.mNetworkAgent.getNetwork(), false);
    }
    ...
    public final void handleUnderlyingNetworkChanged(Message message) {
      ...
      if (underlyingNetworkRecord == null
          || !underlyingNetworkRecord.network.equals(
              VcnGatewayConnection.this.mUnderlying.network)) {
        VcnGatewayConnection.this.logInfo(
            "Migrating to new network: " + VcnGatewayConnection.this.mUnderlying.network);
        VcnGatewayConnection.this.mIkeSession.setNetwork(
            VcnGatewayConnection.this.mUnderlying.network);
        return;
      }
      if (VcnGatewayConnection.this.mNetworkAgent == null
          || VcnGatewayConnection.this.mChildConfig == null) {
        return;
      }
      updateNetworkAgent(
          VcnGatewayConnection.this.mTunnelIface,
    ...
    public final void handleDataStallSuspected(Network network) {
      if (VcnGatewayConnection.this.mUnderlying == null
          || VcnGatewayConnection.this.mNetworkAgent == null
          || !VcnGatewayConnection.this.mNetworkAgent.getNetwork().equals(network)) {
        return;
      }
      VcnGatewayConnection.this.logInfo(
          "Perform Mobility update to recover from suspected data stall");
      VcnGatewayConnection.this.mIkeSession.setNetwork(
          VcnGatewayConnection.this.mUnderlying.network);
    }

    public void setupInterfaceAndNetworkAgent(
        int i,
        IpSecManager.IpSecTunnelInterface ipSecTunnelInterface,
        VcnChildSessionConfiguration vcnChildSessionConfiguration,
        VcnChildSessionConfiguration vcnChildSessionConfiguration2,
        IkeSessionConnectionInfo ikeSessionConnectionInfo) {
      setupInterface(
          i, ipSecTunnelInterface, vcnChildSessionConfiguration, vcnChildSessionConfiguration2);
      if (VcnGatewayConnection.this.mNetworkAgent == null) {
        VcnGatewayConnection.this.mNetworkAgent =
            buildNetworkAgent(
                ipSecTunnelInterface, vcnChildSessionConfiguration, ikeSessionConnectionInfo);
      } else {
        updateNetworkAgent(
            ipSecTunnelInterface,
            VcnGatewayConnection.this.mNetworkAgent,
  ...
  public class RetryTimeoutState extends ActiveBaseState {
    ...
    public final long getNextRetryIntervalsMs() {
      ...
      long[] retryIntervalsMillis =
          VcnGatewayConnection.this.mConnectionConfig.getRetryIntervalsMillis();
  ...
  public static NetworkCapabilities buildNetworkCapabilities(
    ...
    if (underlyingNetworkRecord != null) {
      ...
      if (networkCapabilities.getOwnerUid() > 0
          && Arrays.binarySearch(administratorUids, networkCapabilities.getOwnerUid()) < 0) {
      ...
      if (networkCapabilities.hasTransport(1)
        ...
        builder.setTransportInfo(
            new VcnTransportInfo(
                (WifiInfo) networkCapabilities.getTransportInfo(),
                vcnGatewayConnectionConfig.getMinUdpPort4500NatTimeoutSeconds()));
        ...
        Slog.wtf(
            TAG,
            "Unknown transport type or missing TransportInfo/NetworkSpecifier for non-null"
                + " underlying network");
      }
  ...
  public LinkProperties buildConnectedLinkProperties(
      VcnGatewayConnectionConfig vcnGatewayConnectionConfig,
      IpSecManager.IpSecTunnelInterface ipSecTunnelInterface,
      VcnChildSessionConfiguration vcnChildSessionConfiguration,
      UnderlyingNetworkRecord underlyingNetworkRecord,
    ...
    IkeTunnelConnectionParams tunnelConnectionParams =
        vcnGatewayConnectionConfig.getTunnelConnectionParams();
    ...
    if (underlyingNetworkRecord != null) {
      ...
      i =
          (mtu != 0 || linkProperties2.getInterfaceName() == null)
              ? mtu
              : this.mDeps.getUnderlyingIfaceMtu(linkProperties2.getInterfaceName());
    } else {
      Slog.wtf(
          TAG, "No underlying network while building link properties", new IllegalStateException());
    }
    linkProperties.setMtu(
        MtuUtils.getMtu(
            tunnelConnectionParams.getTunnelModeChildSessionParams().getSaProposals(),
            vcnGatewayConnectionConfig.getMaxMtu(),
            i,
            ikeSessionConnectionInfo.getLocalAddress() instanceof Inet4Address));
  ...
  public class IkeSessionCallbackImpl implements IkeSessionCallback {
    ...
    public void onOpened(IkeSessionConfiguration ikeSessionConfiguration) {
      ...
      VcnGatewayConnection.this.ikeConnectionInfoChanged(
          this.mToken, ikeSessionConfiguration.getIkeSessionConnectionInfo());
    }
    ...
    public void onClosedExceptionally(IkeException ikeException) {
      VcnGatewayConnection.this.logInfo(
          "IkeClosedExceptionally for token " + this.mToken, ikeException);
    ...
    public void onIkeSessionConnectionInfoChanged(
        IkeSessionConnectionInfo ikeSessionConnectionInfo) {
      VcnGatewayConnection.this.logDbg(
          "onIkeSessionConnectionInfoChanged for token " + this.mToken);
  ...
  public class VcnChildSessionCallback implements ChildSessionCallback {
    ...
    public void onOpened(VcnChildSessionConfiguration vcnChildSessionConfiguration) {
      ...
      if (this.mIsOpportunistic) {
        VcnGatewayConnection.this.logDbg(
            "ChildOpened for opportunistic child; suppressing event message");
    ...
    public void onClosedExceptionally(IkeException ikeException) {
      VcnGatewayConnection.this.logInfo(
          "ChildClosedExceptionally for token " + this.mToken, ikeException);
      if (this.mIsOpportunistic && !this.mIsChildOpened) {
        VcnGatewayConnection.this.logInfo(
            "ChildClosedExceptionally for unopened opportunistic child; ignoring");
      } else {
    ...
    public void onIpSecTransformCreated(IpSecTransform ipSecTransform, int i) {
      VcnGatewayConnection.this.logDbg(
          "ChildTransformCreated; Direction: " + i + "; token " + this.mToken);
    ...
    public void onIpSecTransformDeleted(IpSecTransform ipSecTransform, int i) {
      VcnGatewayConnection.this.logDbg(
          "ChildTransformDeleted; Direction: " + i + "; for token " + this.mToken);
    }
  }
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    indentingPrintWriter.println(
        "VcnGatewayConnection (" + this.mConnectionConfig.getGatewayConnectionName() + "):");
  ...
  public UnderlyingNetworkController.UnderlyingNetworkControllerCallback
      getUnderlyingNetworkControllerCallback() {
    return this.mUnderlyingNetworkControllerCallback;
  }

  public ConnectivityDiagnosticsManager.ConnectivityDiagnosticsCallback
  ...
  public final IkeSessionParams buildIkeParams(Network network) {
    IkeSessionParams.Builder builder =
        new IkeSessionParams.Builder(
            this.mConnectionConfig.getTunnelConnectionParams().getIkeSessionParams());
  ...
  public final ChildSessionParams buildOpportunisticChildParams() {
    TunnelModeChildSessionParams tunnelModeChildSessionParams =
        this.mConnectionConfig.getTunnelConnectionParams().getTunnelModeChildSessionParams();
    ...
    Iterator<IkeTrafficSelector> it2 =
        tunnelModeChildSessionParams.getInboundTrafficSelectors().iterator();
    while (it2.hasNext()) {
      builder.addInboundTrafficSelectors(it2.next());
    }
    Iterator<IkeTrafficSelector> it3 =
        tunnelModeChildSessionParams.getOutboundTrafficSelectors().iterator();
    while (it3.hasNext()) {
      builder.addOutboundTrafficSelectors(it3.next());
    }
    builder.setLifetimeSeconds(
        tunnelModeChildSessionParams.getHardLifetimeSeconds(),
        tunnelModeChildSessionParams.getSoftLifetimeSeconds());
    return builder.build();
  }
  ...
  public VcnIkeSession buildIkeSession(Network network) {
    ...
    return this.mDeps.newIkeSession(
        this.mVcnContext,
        buildIkeParams(network),
        buildChildParams(),
        new IkeSessionCallbackImpl(i),
        new VcnChildSessionCallback(this, i));
  }
  ...
  public class Dependencies {
    public UnderlyingNetworkController newUnderlyingNetworkController(
        ...
        ParcelUuid parcelUuid,
        TelephonySubscriptionTracker.TelephonySubscriptionSnapshot telephonySubscriptionSnapshot,
        UnderlyingNetworkController.UnderlyingNetworkControllerCallback
    ...
    public WakeupMessage newWakeupMessage(
        VcnContext vcnContext, Handler handler, String str, Runnable runnable) {
    ...
    public boolean isAirplaneModeOn(VcnContext vcnContext) {
      return Settings.Global.getInt(
              vcnContext.getContext().getContentResolver(), "airplane_mode_on", 0)
          != 0;
    }
    ...
    public int getParallelTunnelCount(
      ...
      return Math.max(
          1,
          carrierConfigForSubGrp != null
              ? carrierConfigForSubGrp.getInt("vcn_tunnel_aggregation_sa_count_max", 1)
              : 1);
    }
  }
  ...
  public class VcnWakeLock {
    ...
    public VcnWakeLock(Context context, int i, String str) {
      PowerManager.WakeLock newWakeLock =
          ((PowerManager) context.getSystemService(PowerManager.class)).newWakeLock(i, str);
    ...
    public VcnNetworkAgent(
      ...
      this.mImpl =
          new NetworkAgent(
              ...
              networkScore,
              networkAgentConfig,
              networkProvider) { // from class:
                                 // com.android.server.vcn.VcnGatewayConnection.VcnNetworkAgent.1
