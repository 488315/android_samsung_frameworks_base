...
public class UnderlyingNetworkRecord {
  ...
  public static Comparator getComparator() {
    return new Comparator() { // from class:
                              // com.android.server.vcn.routeselection.UnderlyingNetworkRecord$$ExternalSyntheticLambda0
      @Override // java.util.Comparator
      public final int compare(Object obj, Object obj2) {
        int lambda$getComparator$0;
        lambda$getComparator$0 =
            UnderlyingNetworkRecord.lambda$getComparator$0(
                (UnderlyingNetworkRecord) obj, (UnderlyingNetworkRecord) obj2);
        return lambda$getComparator$0;
      }
    };
  }

  public static /* synthetic */ int lambda$getComparator$0(
      UnderlyingNetworkRecord underlyingNetworkRecord,
  ...
  public static boolean isSelected(
      Network network, UnderlyingNetworkRecord underlyingNetworkRecord) {
