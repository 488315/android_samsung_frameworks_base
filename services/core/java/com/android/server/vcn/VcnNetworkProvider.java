...
public class VcnNetworkProvider extends NetworkProvider {
  ...
  public void register() {
    ((ConnectivityManager) this.mContext.getSystemService(ConnectivityManager.class))
        .registerNetworkProvider(this);
    this.mDeps.registerNetworkOffer(
        this,
        Vcn.getNetworkScore(),
        buildCapabilityFilter(),
        new HandlerExecutor(this.mHandler),
        new NetworkProvider
            .NetworkOfferCallback() { // from class: com.android.server.vcn.VcnNetworkProvider.1
  ...
  public final void notifyListenerForEvent(
      NetworkRequestListener networkRequestListener, NetworkRequest networkRequest) {
  ...
  public class Dependencies {
    public void registerNetworkOffer(
        ...
        Executor executor,
        NetworkProvider.NetworkOfferCallback networkOfferCallback) {
      vcnNetworkProvider.registerNetworkOffer(
          networkScore, networkCapabilities, executor, networkOfferCallback);
    }
  }
}
