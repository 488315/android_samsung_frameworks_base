...
public class AppOpsCheckingServiceTracingDecorator implements AppOpsCheckingServiceInterface {
  ...
  public void startWatchingOpModeChanged(OnOpModeChangedListener onOpModeChangedListener, int i) {
    Trace.traceBegin(
        64L, "TaggedTracingAppOpsCheckingServiceInterfaceImpl#startWatchingOpModeChanged");
    try {
  ...
  public void startWatchingPackageModeChanged(
    ...
    Trace.traceBegin(
        64L, "TaggedTracingAppOpsCheckingServiceInterfaceImpl#startWatchingPackageModeChanged");
    try {
  ...
  public ArraySet getOpModeChangedListeners(int i) {
    Trace.traceBegin(
        64L, "TaggedTracingAppOpsCheckingServiceInterfaceImpl#getOpModeChangedListeners");
    try {
  ...
  public ArraySet getPackageModeChangedListeners(String str) {
    Trace.traceBegin(
        64L, "TaggedTracingAppOpsCheckingServiceInterfaceImpl#getPackageModeChangedListeners");
    try {
  ...
  public void notifyOpChangedForAllPkgsInUid(
    ...
    Trace.traceBegin(
        64L, "TaggedTracingAppOpsCheckingServiceInterfaceImpl#notifyOpChangedForAllPkgsInUid");
    try {
  ...
  public SparseBooleanArray evalForegroundPackageOps(
    ...
    Trace.traceBegin(
        64L, "TaggedTracingAppOpsCheckingServiceInterfaceImpl#evalForegroundPackageOps");
    try {
