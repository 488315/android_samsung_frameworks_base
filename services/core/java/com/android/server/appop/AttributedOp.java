...
public final class AttributedOp {
  ...
  public final AppOpsService.C0712Op parent;
  public final String tag;

  public AttributedOp(AppOpsService appOpsService, String str, AppOpsService.C0712Op c0712Op) {
  ...
  public void accessed(int i, String str, String str2, int i2, int i3) {
    ...
    AppOpsService.C0712Op c0712Op = this.parent;
    ...
    AppOpsService.C0712Op c0712Op2 = this.parent;
    int i4 = c0712Op2.f1638op;
    int i5 = c0712Op2.uid;
    String str3 = c0712Op2.packageName;
    String str4 = this.tag;
    appOpsService.writePermissionAccessInformation(
        i4, i5, str3, str, str4 == null ? str2 : str4, i2);
  }
  ...
  public void accessed(long j, long j2, int i, String str, String str2, int i2, int i3) {
    ...
    AppOpsManager.OpEventProxyInfo acquire =
        i != -1 ? this.mAppOpsService.mOpEventProxyInfoPool.acquire(i, str, str2) : null;
  ...
  public void rejected(int i, int i2) {
    ...
    HistoricalRegistry historicalRegistry = this.mAppOpsService.mHistoricalRegistry;
    AppOpsService.C0712Op c0712Op = this.parent;
    historicalRegistry.incrementOpRejected(
        c0712Op.f1638op, c0712Op.uid, c0712Op.packageName, this.tag, i, i2);
  }
  ...
  public void rejected(long j, int i, int i2) {
    ...
    if (noteOpEvent != null) {
      noteOpEvent.reinit(
          j, -1L, (AppOpsManager.OpEventProxyInfo) null, this.mAppOpsService.mOpEventProxyInfoPool);
    } else {
      this.mRejectEvents.put(
          makeKey, new AppOpsManager.NoteOpEvent(j, -1L, (AppOpsManager.OpEventProxyInfo) null));
    }
  }

  public void started(
      IBinder iBinder, int i, String str, String str2, int i2, int i3, int i4, int i5) {
    started(iBinder, i, str, str2, i2, i3, true, i4, i5);
  }

  public final void started(
      IBinder iBinder, int i, String str, String str2, int i2, int i3, boolean z, int i4, int i5) {
  ...
  */
  public final void startedOrPaused(
    ...
    if (z && !this.parent.isRunning() && z2) {
      ...
      appOpsService.scheduleOpActiveChangedIfNeededLocked(
          c0712Op.f1638op, c0712Op.uid, c0712Op.packageName, this.tag, true, i4, i5);
    }
    ...
    long currentTimeMillis = System.currentTimeMillis();
    InProgressStartOpEvent inProgressStartOpEvent = (InProgressStartOpEvent) arrayMap.get(iBinder);
    if (inProgressStartOpEvent == null) {
      inProgressStartOpEvent =
          this.mAppOpsService.mInProgressStartOpEventPool.acquire(
              currentTimeMillis,
              ...
              PooledLambda.obtainRunnable(
                  new BiConsumer() { // from class:
                                     // com.android.server.appop.AttributedOp$$ExternalSyntheticLambda0
      ...
      AppOpsService.C0712Op c0712Op2 = attributedOp.parent;
      historicalRegistry.incrementOpAccessedCount(
          c0712Op2.f1638op,
          c0712Op2.uid,
          c0712Op2.packageName,
          attributedOp.tag,
          i2,
          i3,
          currentTimeMillis,
      ...
      AppOpsService.C0712Op c0712Op3 = attributedOp.parent;
      int i6 = c0712Op3.f1638op;
      int i7 = c0712Op3.uid;
      String str3 = c0712Op3.packageName;
      String str4 = attributedOp.tag;
      appOpsService2.writePermissionAccessInformation(
          i6, i7, str3, null, str4 == null ? str2 : str4, i2);
      return;
    }
    attributedOp = this;
    inProgressStartOpEvent.mNumUnfinishedStarts++;
  ...
  public final void finishOrPause(IBinder iBinder, boolean z, boolean z2) {
    ...
    InProgressStartOpEvent inProgressStartOpEvent =
        (InProgressStartOpEvent) this.mInProgressEvents.valueAt(indexOfKey);
    if (!z2) {
      inProgressStartOpEvent.mNumUnfinishedStarts--;
    }
    if (inProgressStartOpEvent.mNumUnfinishedStarts == 0 || z2) {
      ...
      AppOpsManager.NoteOpEvent noteOpEvent =
          new AppOpsManager.NoteOpEvent(
              inProgressStartOpEvent.getStartTime(),
              SystemClock.elapsedRealtime() - inProgressStartOpEvent.getStartElapsedTime(),
              inProgressStartOpEvent.getProxy() != null
                  ? new AppOpsManager.OpEventProxyInfo(inProgressStartOpEvent.getProxy())
                  : null);
      this.mAccessEvents.put(
          AppOpsManager.makeKey(
              inProgressStartOpEvent.getUidState(), inProgressStartOpEvent.getFlags()),
          noteOpEvent);
      HistoricalRegistry historicalRegistry = this.mAppOpsService.mHistoricalRegistry;
      AppOpsService.C0712Op c0712Op = this.parent;
      historicalRegistry.increaseOpAccessDuration(
          c0712Op.f1638op,
          c0712Op.uid,
          c0712Op.packageName,
          this.tag,
          inProgressStartOpEvent.getUidState(),
          inProgressStartOpEvent.getFlags(),
          noteOpEvent.getNoteTime(),
          noteOpEvent.getDuration(),
          inProgressStartOpEvent.getAttributionFlags(),
          inProgressStartOpEvent.getAttributionChainId());
      if (z2) {
        return;
      }
  ...
  public final void finishPossiblyPaused(IBinder iBinder, boolean z) {
    ...
    InProgressStartOpEvent inProgressStartOpEvent =
        (InProgressStartOpEvent) this.mPausedInProgressEvents.valueAt(indexOfKey);
  ...
  public void pause() {
    if (isRunning()) {
      ...
      for (int i = 0; i < this.mInProgressEvents.size(); i++) {
        ...
        this.mPausedInProgressEvents.put(
            inProgressStartOpEvent.getClientId(), inProgressStartOpEvent);
  ...
  public void resume() {
    if (isPaused()) {
      ...
      for (int i = 0; i < this.mPausedInProgressEvents.size(); i++) {
        InProgressStartOpEvent inProgressStartOpEvent =
            (InProgressStartOpEvent) this.mPausedInProgressEvents.valueAt(i);
        ...
        AppOpsService.C0712Op c0712Op3 = this.parent;
        appOpsService2.scheduleOpStartedIfNeededLocked(
            c0712Op3.f1638op,
            c0712Op3.uid,
            c0712Op3.packageName,
            this.tag,
            inProgressStartOpEvent.getFlags(),
            0,
            2,
  ...
  public void onClientDeath(IBinder iBinder) {
    synchronized (this.mAppOpsService) {
      if (isPaused() || isRunning()) {
        InProgressStartOpEvent inProgressStartOpEvent =
            (InProgressStartOpEvent)
                (isPaused() ? this.mPausedInProgressEvents : this.mInProgressEvents).get(iBinder);
        if (inProgressStartOpEvent != null) {
  ...
  public void onUidStateChanged(int i) {
    ...
    if (isPaused() || isRunning()) {
      ...
      while (i4 < size) {
        InProgressStartOpEvent inProgressStartOpEvent =
            (InProgressStartOpEvent) arrayMap3.get(arrayList.get(i4));
        if (inProgressStartOpEvent == null || inProgressStartOpEvent.getUidState() == i) {
          ...
          try {
            ...
            if (proxy != null) {
              ...
              try {
                startedOrPaused(
                    inProgressStartOpEvent.getClientId(),
                    proxy.getUid(),
            ...
            try {
              InProgressStartOpEvent inProgressStartOpEvent2 =
                  (InProgressStartOpEvent) arrayMap3.get(arrayList.get(i2));
  ...
  public final LongSparseArray add(
  ...
  public void add(AttributedOp attributedOp) {
    if (attributedOp.isRunning() || attributedOp.isPaused()) {
      ArrayMap arrayMap =
          attributedOp.isRunning()
              ? attributedOp.mInProgressEvents
              : attributedOp.mPausedInProgressEvents;
      Slog.w(
          "AppOps",
          "Ignoring " + arrayMap.size() + " app-ops, running: " + attributedOp.isRunning());
      int size = arrayMap.size();
      for (int i = 0; i < size; i++) {
        InProgressStartOpEvent inProgressStartOpEvent =
            (InProgressStartOpEvent) arrayMap.valueAt(i);
        inProgressStartOpEvent.finish();
        this.mAppOpsService.mInProgressStartOpEventPool.release(inProgressStartOpEvent);
      }
    }
  ...
  public boolean hasAnyTime() {
    ...
    return (longSparseArray2 != null && longSparseArray2.size() > 0)
        || ((longSparseArray = this.mRejectEvents) != null && longSparseArray.size() > 0);
  }
  ...
  public final LongSparseArray deepClone(LongSparseArray longSparseArray) {
    ...
    for (int i = 0; i < size; i++) {
      longSparseArray2.put(
          ...
          new AppOpsManager.NoteOpEvent((AppOpsManager.NoteOpEvent) longSparseArray.valueAt(i)));
    }
    return longSparseArray2;
  }
    ...
    if (isRunning()) {
      ...
      for (int i = 0; i < size; i++) {
        ...
        deepClone.append(
            ...
            new AppOpsManager.NoteOpEvent(
                inProgressStartOpEvent.getStartTime(),
                elapsedRealtime - inProgressStartOpEvent.getStartElapsedTime(),
                inProgressStartOpEvent.getProxy()));
      }
    }
    return new AppOpsManager.AttributedOpEntry(
        this.parent.f1638op, isRunning(), deepClone, deepClone(this.mRejectEvents));
  }
  ...
  public class InProgressStartOpEventPool extends Pools.SimplePool {
    ...
    public InProgressStartOpEvent acquire(
        long j,
        long j2,
        IBinder iBinder,
        String str,
      ...
      AppOpsManager.OpEventProxyInfo acquire =
          i != -1 ? this.mOpEventProxyInfoPool.acquire(i, str2, str3) : null;
      if (inProgressStartOpEvent != null) {
        inProgressStartOpEvent.reinit(
            j, j2, iBinder, str, runnable, i2, i3, acquire, i4, i5, this.mOpEventProxyInfoPool);
