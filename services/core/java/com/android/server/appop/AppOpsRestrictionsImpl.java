...
public class AppOpsRestrictionsImpl implements AppOpsRestrictions {
  ...
  public boolean setGlobalRestriction(Object obj, int i, boolean z) {
    if (z) {
      ...
      SparseBooleanArray sparseBooleanArray =
          (SparseBooleanArray) this.mGlobalRestrictions.get(obj);
  ...
  @Override // com.android.server.appop.AppOpsRestrictions
  public boolean setUserRestriction(
      Object obj, int i, int i2, boolean z, PackageTagsList packageTagsList) {
    int[] resolveUserId = resolveUserId(i);
    boolean z2 = false;
    for (int i3 = 0; i3 < resolveUserId.length; i3++) {
      z2 =
          z2
              | putUserRestriction(obj, resolveUserId[i3], i2, z)
              | putUserRestrictionExclusions(obj, resolveUserId[i3], packageTagsList);
    }
    return z2;
  }
  ...
  public final boolean getUserRestriction(Object obj, int i, int i2) {
    ...
    if (sparseArray == null
        || (sparseBooleanArray = (SparseBooleanArray) sparseArray.get(i)) == null) {
      return false;
    }
  ...
  public final boolean putUserRestriction(Object obj, int i, int i2, boolean z) {
    ...
    if (sparseArray2 == null
        || (sparseBooleanArray = (SparseBooleanArray) sparseArray2.get(i)) == null) {
      return false;
    }
  ...
  public final boolean putUserRestrictionExclusions(
      Object obj, int i, PackageTagsList packageTagsList) {
  ...
  public void dumpRestrictions(PrintWriter printWriter, int i, String str, boolean z) {
    ...
    while (true) {
      ...
      printWriter2.println(
          "  Global restrictions for token " + keyAt + XmlUtils.STRING_ARRAY_SEPARATOR);
    ...
    if (z) {
      ...
      while (i7 < size3) {
        ...
        SparseArray sparseArray3 =
            (SparseArray) appOpsRestrictionsImpl.mUserRestrictionExcludedPackageTags.get(keyAt2);
              ...
              if (str != null ? packageTagsList.includes(str) : true) {
                ...
                if (!z3) {
                  indentingPrintWriter.println(
                      "User restrictions for token " + keyAt2 + XmlUtils.STRING_ARRAY_SEPARATOR);
                  z3 = true;
                }
                indentingPrintWriter.increaseIndent();
                if (!z5) {
