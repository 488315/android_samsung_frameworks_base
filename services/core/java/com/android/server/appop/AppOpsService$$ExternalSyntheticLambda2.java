...
public final /* synthetic */ class AppOpsService$$ExternalSyntheticLambda2 implements DecConsumer {
    public final void accept(
        ...
        try {
            ...
            int i = 0;
            while (i < size) {
                AppOpsService.ActiveCallback activeCallback =
                        (AppOpsService.ActiveCallback) arraySet2.valueAt(i);
                try {
                    arraySet = arraySet2;
                    try {
                        if (!appOpsService.shouldIgnoreCallback(
                                intValue, activeCallback.mCallingPid, activeCallback.mCallingUid)) {
                            activeCallback.mCallback.opActiveChanged(
                                    intValue,
                                    intValue2,
                                    str,
                                    str2,
