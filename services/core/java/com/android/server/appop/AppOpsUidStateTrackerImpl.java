...
public class AppOpsUidStateTrackerImpl implements AppOpsUidStateTracker {
  ...
  public class C07131 implements DelayableExecutor {
    public final /* synthetic */ Handler val$handler;
    public final /* synthetic */ Executor val$lockingExecutor;

    public C07131(Handler handler, Executor executor) {
    ...
    public void execute(final Runnable runnable) {
      ...
      handler.post(
          new Runnable() { // from class:
                           // com.android.server.appop.AppOpsUidStateTrackerImpl$1$$ExternalSyntheticLambda0
    ...
    public void executeDelayed(final Runnable runnable, long j) {
      ...
      handler.postDelayed(
          new Runnable() { // from class:
                           // com.android.server.appop.AppOpsUidStateTrackerImpl$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              executor.execute(runnable);
            }
  ...
  public final int evalModeInternal(int i, int i2, int i3, int i4) {
    if (!getUidAppWidgetVisible(i)
        && !this.mActivityManagerInternal.isPendingTopUid(i)
        && !this.mActivityManagerInternal.isTempAllowlistedForFgsWhileInUse(i)) {
  ...
  @Override // com.android.server.appop.AppOpsUidStateTracker
  public void addUidStateChangedCallback(
      Executor executor, AppOpsUidStateTracker.UidStateChangedCallback uidStateChangedCallback) {
      ...
      this.mExecutor.executeDelayed(
          PooledLambda.obtainRunnable(
              new BiConsumer() { // from class:
                                 // com.android.server.appop.AppOpsUidStateTrackerImpl$$ExternalSyntheticLambda0
            ...
            .execute(
                PooledLambda.obtainRunnable(
                    new QuadConsumer() { // from class:
                                         // com.android.server.appop.AppOpsUidStateTrackerImpl$$ExternalSyntheticLambda1
                      public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                        ((AppOpsUidStateTracker.UidStateChangedCallback) obj)
                            .onUidStateChanged(
                    ...
                    (AppOpsUidStateTracker.UidStateChangedCallback)
  ...
  public class EventLog {
      ...
      this.mExecutor.execute(
          PooledLambda.obtainRunnable(
              new QuintConsumer() { // from class:
                                    // com.android.server.appop.AppOpsUidStateTrackerImpl$EventLog$$ExternalSyntheticLambda1
                public final void accept(
                    Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                  ((AppOpsUidStateTrackerImpl.EventLog) obj)
                      .logUpdateUidProcStateAsync(
                          ((Long) obj2).longValue(),
                          ((Integer) obj3).intValue(),
      ...
      this.mExecutor.execute(
          PooledLambda.obtainRunnable(
              new HeptConsumer() { // from class:
                                   // com.android.server.appop.AppOpsUidStateTrackerImpl$EventLog$$ExternalSyntheticLambda2
                public final void accept(
                    Object obj,
                    Object obj2,
                    Object obj3,
    ...
    public void logEvalForegroundMode(int i, int i2, int i3, int i4, int i5) {
      this.mExecutor.execute(
          PooledLambda.obtainRunnable(
              new HeptConsumer() { // from class:
                                   // com.android.server.appop.AppOpsUidStateTrackerImpl$EventLog$$ExternalSyntheticLambda0
                public final void accept(
                    Object obj,
                    Object obj2,
                    Object obj3,
    ...
    public void dumpEvents(PrintWriter printWriter) {
      ...
      while (true) {
        ...
        long j2 =
            i2 < this.mCommitUidStateLogSize
                ? this.mCommitUidStateLogTimestamps[i6]
                : Long.MAX_VALUE;
        long j3 =
            i3 < this.mEvalForegroundModeLogSize
                ? this.mEvalForegroundModeLogTimestamps[i7]
                : Long.MAX_VALUE;
        if (j <= j2 && j <= j3) {
