...
public class DisplayAreaOrganizerController extends IDisplayAreaOrganizerController.Stub {
  ...
  public class DeathRecipient implements IBinder.DeathRecipient {
    ...
    public void binderDied() {
      WindowManagerGlobalLock windowManagerGlobalLock =
          DisplayAreaOrganizerController.this.mGlobalLock;
      WindowManagerService.boostPriorityForLockedSection();
      synchronized (windowManagerGlobalLock) {
        try {
          IDisplayAreaOrganizer organizerByFeature =
              DisplayAreaOrganizerController.this.getOrganizerByFeature(this.mFeature);
          if (organizerByFeature != null) {
            ...
            if (!asBinder.equals(this.mOrganizer.asBinder()) && asBinder.isBinderAlive()) {
              Slog.d(
                  ...
                  "Dead organizer replaced for feature=" + this.mFeature);
              WindowManagerService.resetPriorityAfterLockedSection();
              return;
            }
            ((DisplayAreaOrganizerState)
                    DisplayAreaOrganizerController.this.mOrganizersByFeatureIds.remove(
                        Integer.valueOf(this.mFeature)))
                .destroy();
          }
          WindowManagerService.resetPriorityAfterLockedSection();
        } catch (Throwable th) {
  ...
  public class DisplayAreaOrganizerState {
    ...
    public DisplayAreaOrganizerState(IDisplayAreaOrganizer iDisplayAreaOrganizer, int i) {
      ...
      DeathRecipient deathRecipient =
          DisplayAreaOrganizerController.this.new DeathRecipient(iDisplayAreaOrganizer, i);
    ...
    public void destroy() {
      ...
      DisplayAreaOrganizerController.this.mService.mRootWindowContainer.forAllDisplayAreas(
          new Consumer() { // from class:
                           // com.android.server.wm.DisplayAreaOrganizerController$DisplayAreaOrganizerState$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              DisplayAreaOrganizerController.DisplayAreaOrganizerState.this.lambda$destroy$0(
                  asBinder, (DisplayArea) obj);
            }
          });
  ...
  public IDisplayAreaOrganizer getOrganizerByFeature(int i) {
    DisplayAreaOrganizerState displayAreaOrganizerState =
        (DisplayAreaOrganizerState) this.mOrganizersByFeatureIds.get(Integer.valueOf(i));
  ...
  public ParceledListSlice registerOrganizer(
      final IDisplayAreaOrganizer iDisplayAreaOrganizer, final int i) {
        ...
        try {
          if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
            ProtoLogImpl.v(
                ...
                (String) null,
                new Object[] {
                  String.valueOf(iDisplayAreaOrganizer.asBinder()), Long.valueOf(callingUid)
                });
          }
          if (this.mOrganizersByFeatureIds.get(Integer.valueOf(i)) != null) {
            ((DisplayAreaOrganizerState) this.mOrganizersByFeatureIds.remove(Integer.valueOf(i)))
                .destroy();
            Slog.d("DisplayAreaOrganizerController", "Replacing dead organizer for feature=" + i);
          }
          DisplayAreaOrganizerState displayAreaOrganizerState =
              new DisplayAreaOrganizerState(iDisplayAreaOrganizer, i);
          final ArrayList arrayList = new ArrayList();
          this.mService.mRootWindowContainer.forAllDisplays(
              new Consumer() { // from class:
                               // com.android.server.wm.DisplayAreaOrganizerController$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  DisplayAreaOrganizerController.this.lambda$registerOrganizer$1(
                      i, arrayList, iDisplayAreaOrganizer, (DisplayContent) obj);
                }
              });
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$registerOrganizer$1(
      final int i,
      final List list,
      final IDisplayAreaOrganizer iDisplayAreaOrganizer,
    ...
    if (!displayContent.isTrusted()) {
      if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
        ProtoLogImpl.w(
            ...
            1,
            (String) null,
            new Object[] {Long.valueOf(displayContent.getDisplayId())});
        return;
      }
      return;
    }
    displayContent.forAllDisplayAreas(
        new Consumer() { // from class:
                         // com.android.server.wm.DisplayAreaOrganizerController$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DisplayAreaOrganizerController.this.lambda$registerOrganizer$0(
                i, list, iDisplayAreaOrganizer, (DisplayArea) obj);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$registerOrganizer$0(
      int i, List list, IDisplayAreaOrganizer iDisplayAreaOrganizer, DisplayArea displayArea) {
    ...
    try {
      ...
      synchronized (windowManagerGlobalLock) {
        try {
          ...
          this.mOrganizersByFeatureIds
              .entrySet()
              .removeIf(
                  new Predicate() { // from class:
                                    // com.android.server.wm.DisplayAreaOrganizerController$$ExternalSyntheticLambda3
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$unregisterOrganizer$2;
                      lambda$unregisterOrganizer$2 =
                          DisplayAreaOrganizerController.lambda$unregisterOrganizer$2(
                              iDisplayAreaOrganizer, (Map.Entry) obj);
  ...
  public static /* synthetic */ boolean lambda$unregisterOrganizer$2(
      IDisplayAreaOrganizer iDisplayAreaOrganizer, Map.Entry entry) {
    boolean equals =
        ((DisplayAreaOrganizerState) entry.getValue())
            .mOrganizer
            .asBinder()
            .equals(iDisplayAreaOrganizer.asBinder());
    if (equals) {
  ...
  public DisplayAreaAppearedInfo createTaskDisplayArea(
      IDisplayAreaOrganizer iDisplayAreaOrganizer, int i, final int i2, String str) {
        ...
        try {
          if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
            ProtoLogImpl.v(
                ...
                1,
                (String) null,
                new Object[] {Long.valueOf(callingUid)});
          }
          ...
          RootDisplayArea rootDisplayArea =
              (RootDisplayArea)
                  displayContent.getItemFromDisplayAreas(
                      new Function() { // from class:
                                       // com.android.server.wm.DisplayAreaOrganizerController$$ExternalSyntheticLambda1
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                          RootDisplayArea lambda$createTaskDisplayArea$3;
                          lambda$createTaskDisplayArea$3 =
                              DisplayAreaOrganizerController.lambda$createTaskDisplayArea$3(
                                  i2, (DisplayArea) obj);
                          return lambda$createTaskDisplayArea$3;
                        }
                      });
          TaskDisplayArea taskDisplayArea =
              rootDisplayArea == null
                  ? (TaskDisplayArea)
                      displayContent.getItemFromTaskDisplayAreas(
                          new Function() { // from class:
                                           // com.android.server.wm.DisplayAreaOrganizerController$$ExternalSyntheticLambda2
                            @Override // java.util.function.Function
                            public final Object apply(Object obj) {
                              TaskDisplayArea lambda$createTaskDisplayArea$4;
                              lambda$createTaskDisplayArea$4 =
                                  DisplayAreaOrganizerController.lambda$createTaskDisplayArea$4(
                                      i2, (TaskDisplayArea) obj);
          ...
          if (rootDisplayArea == null && taskDisplayArea == null) {
            throw new IllegalArgumentException(
                "Can't find a parent DisplayArea with featureId=" + i2);
          }
          int i3 = this.mNextTaskDisplayAreaFeatureId;
          this.mNextTaskDisplayAreaFeatureId = i3 + 1;
          DisplayAreaOrganizerState displayAreaOrganizerState =
              new DisplayAreaOrganizerState(iDisplayAreaOrganizer, i3);
  ...
  public static /* synthetic */ RootDisplayArea lambda$createTaskDisplayArea$3(
      int i, DisplayArea displayArea) {
  ...
  public static /* synthetic */ TaskDisplayArea lambda$createTaskDisplayArea$4(
      ...
      synchronized (windowManagerGlobalLock) {
        try {
          ...
          if (!asTaskDisplayArea.mCreatedByOrganizer) {
            throw new IllegalArgumentException(
                "Attempt to delete TaskDisplayArea not created by organizer TaskDisplayArea="
                    + asTaskDisplayArea);
          }
          ((DisplayAreaOrganizerState)
                  this.mOrganizersByFeatureIds.remove(
                      Integer.valueOf(asTaskDisplayArea.mFeatureId)))
              .destroy();
        } catch (Throwable th) {
          WindowManagerService.resetPriorityAfterLockedSection();
          throw th;
  ...
  public void onDisplayAreaAppeared(
      IDisplayAreaOrganizer iDisplayAreaOrganizer, DisplayArea displayArea) {
    if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
      ProtoLogImpl.v(
          ProtoLogGroup.WM_DEBUG_WINDOW_ORGANIZER,
          -1980468143,
          0,
          (String) null,
          new Object[] {String.valueOf(displayArea.getName())});
    }
    try {
  ...
  public void onDisplayAreaVanished(
    ...
    if (!iDisplayAreaOrganizer.asBinder().isBinderAlive()) {
      Slog.d(
          "DisplayAreaOrganizerController", "Organizer died before sending onDisplayAreaVanished");
    } else {
      try {
  ...
  public void onDisplayAreaInfoChanged(
      IDisplayAreaOrganizer iDisplayAreaOrganizer, DisplayArea displayArea) {
    if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
      ProtoLogImpl.v(
          ProtoLogGroup.WM_DEBUG_WINDOW_ORGANIZER,
  ...
  public final DisplayAreaAppearedInfo organizeDisplayArea(
      IDisplayAreaOrganizer iDisplayAreaOrganizer, DisplayArea displayArea, String str) {
    displayArea.setOrganizer(iDisplayAreaOrganizer, true);
    return new DisplayAreaAppearedInfo(
        displayArea.getDisplayAreaInfo(), new SurfaceControl(displayArea.getSurfaceControl(), str));
  }

  public final TaskDisplayArea createTaskDisplayArea(
      final RootDisplayArea rootDisplayArea, String str, int i) {
    TaskDisplayArea taskDisplayArea =
        new TaskDisplayArea(
            rootDisplayArea.mDisplayContent, rootDisplayArea.mWmService, str, i, true);
    DisplayArea displayArea =
        (DisplayArea)
            rootDisplayArea.getItemFromDisplayAreas(
                new Function() { // from class:
                                 // com.android.server.wm.DisplayAreaOrganizerController$$ExternalSyntheticLambda5
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
                    DisplayArea lambda$createTaskDisplayArea$5;
                    lambda$createTaskDisplayArea$5 =
                        DisplayAreaOrganizerController.lambda$createTaskDisplayArea$5(
                            RootDisplayArea.this, (DisplayArea) obj);
                    return lambda$createTaskDisplayArea$5;
                  }
                });
    if (displayArea == null) {
      throw new IllegalStateException(
          "Root must either contain TDA or DAG root=" + rootDisplayArea);
    }
  ...
  public static /* synthetic */ DisplayArea lambda$createTaskDisplayArea$5(
      RootDisplayArea rootDisplayArea, DisplayArea displayArea) {
  ...
  public final TaskDisplayArea createTaskDisplayArea(
      TaskDisplayArea taskDisplayArea, String str, int i) {
    TaskDisplayArea taskDisplayArea2 =
        new TaskDisplayArea(
            taskDisplayArea.mDisplayContent, taskDisplayArea.mWmService, str, i, true);
