...
public class DexDockingController implements IController {
    ...
    for (int size = this.mDockingBounds.size() - 1; size >= 0; size--) {
      ...
      if (rect.equals(launchBounds)) {
        ...
        Slog.d(
            TAG,
            "addOtherTask - ["
                + WindowConfiguration.dexTaskDockingStateToString(otherPosition)
                + "]="
                + task2
                + "\n["
  ...
  public void resizeOtherTaskIfNeeded(final Task task, final Rect rect) {
    ...
    this.mAtm.mRootWindowContainer.forAllTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.DexDockingController$$ExternalSyntheticLambda2
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DexDockingController.this.lambda$resizeOtherTaskIfNeeded$0(
                otherPosition, task, rect, (Task) obj);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$resizeOtherTaskIfNeeded$0(
      int i, Task task, Rect rect, Task task2) {
  ...
  public void moveTaskToFrontIfNeeded(Task task) {
    ...
    this.mAtm.mRootWindowContainer.forAllTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.DexDockingController$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public /* synthetic */ void lambda$moveTaskToFrontIfNeeded$1(int i, Task task) {
    if (task.getDexTaskDockingState() != i
        || task.getRootTask() == null
        || this.mSkipMoveToFrontList.contains(task)) {
      return;
    }
  ...
  public void updateDexDockingIfNeeded(final Task task) {
    ...
    this.mAtm.mRootWindowContainer.forAllTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.DexDockingController$$ExternalSyntheticLambda3
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public int calculateMaxWidth(int i, int i2, int i3) {
    ...
    Task task =
        this.mAtm.mRootWindowContainer.getTask(
            new Predicate() { // from class:
                              // com.android.server.wm.DexDockingController$$ExternalSyntheticLambda0
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$calculateMaxWidth$4;
                lambda$calculateMaxWidth$4 =
                    DexDockingController.lambda$calculateMaxWidth$4(otherPosition, (Task) obj);
