...
public class DisplayRotation {
  ...
  public DisplayRotation(
    ...
    this(
        ...
        windowManagerService.mDisplayWindowSettings,
        windowManagerService.mContext,
        windowManagerService.getWindowManagerLock(),
  ...
  public DisplayRotation(
      ...
      DisplayWindowSettings displayWindowSettings,
      Context context,
      Object obj,
      DeviceStateController deviceStateController,
      DisplayRotationCoordinator displayRotationCoordinator) {
    ...
    this.mCompatPolicyForImmersiveApps =
        initImmersiveAppCompatPolicy(windowManagerService, displayContent);
    boolean z2 = context.getResources().getBoolean(R.bool.config_settingsHelpLinksEnabled);
    this.mSupportAutoRotation = z2;
    this.mAllowRotationResolver =
        context.getResources().getBoolean(R.bool.config_allowRotationResolver);
    this.mLidOpenRotation = readRotation(R.integer.config_maxResolverActivityColumns);
    this.mCarDockRotation = readRotation(R.integer.config_defaultNightDisplayCustomEndTime);
    this.mDeskDockRotation = readRotation(R.integer.config_doublelineClockDefault);
    this.mUndockedHdmiRotation = readRotation(R.integer.config_vibrationWaveformRampDownDuration);
    ...
    Runnable runnable =
        new Runnable() { // from class:
                         // com.android.server.wm.DisplayRotation$$ExternalSyntheticLambda2
    ...
    if (DisplayRotationCoordinator.isSecondaryInternalDisplay(displayContent)
        && deviceStateController.shouldMatchBuiltInDisplayOrientationToReverseDefaultDisplay()) {
      displayRotationCoordinator.setDefaultDisplayRotationChangedCallback(runnable);
    }
    if (z) {
      Handler handler = UiThread.getHandler();
      OrientationListener orientationListener =
          new OrientationListener(context, handler, readDefaultDisplayRotation);
      ...
      if (z2
          && context
              .getResources()
              .getBoolean(R.bool.config_tvExternalInputLoggingDisplayNameFilterEnabled)) {
  ...
  public DisplayRotationImmersiveAppCompatPolicy initImmersiveAppCompatPolicy(
    ...
    return DisplayRotationImmersiveAppCompatPolicy.createIfNeeded(
        windowManagerService.mLetterboxConfiguration, this, displayContent);
  }
  ...
  public final int readDefaultDisplayRotation(DisplayAddress displayAddress) {
    ...
    String str =
        SystemProperties.get(
            "ro.bootanim.set_orientation_"
                + ((DisplayAddress.Physical) displayAddress).getPhysicalDisplayId(),
            "ORIENTATION_0");
  ...
  public void updateUserDependentConfiguration(Resources resources) {
    this.mAllowSeamlessRotationDespiteNavBarMoving =
        resources.getBoolean(R.bool.config_allowSeamlessRotationDespiteNavBarMoving);
  }
  ...
  public void configure(int i, int i2) {
    ...
    if (i > i2) {
      ...
      if (resources.getBoolean(R.bool.config_notificationHeaderClickableForExpand)) {
      ...
      if (!displayContent.isDefaultDisplay && displayContent.isNewDexMode()) {
        ...
        this.mDefaultFixedToUserRotation =
            (hasSystemFeature
                    || hasSystemFeature2
                    || this.mService.mIsPc
                    || this.mDisplayContent.forceDesktopMode()
                    || z2
                    || z)
  ...
  public boolean updateRotationUnchecked(boolean z) {
    ...
    if (!z) {
      if (this.mDeferredRotationPauseCount > 0) {
        if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
          ProtoLogImpl.v(
              ProtoLogGroup.WM_DEBUG_ORIENTATION, 1497304204, 0, (String) null, (Object[]) null);
        }
        return false;
      }
      if (this.mDisplayContent.inTransition()
          && this.mDisplayContent.getDisplayPolicy().isScreenOnFully()
          && !this.mDisplayContent.mTransitionController.useShellTransitionsRotation()) {
        if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
          ProtoLogImpl.v(
              ProtoLogGroup.WM_DEBUG_ORIENTATION, 292904800, 0, (String) null, (Object[]) null);
        }
        return false;
      }
      if (this.mService.mDisplayFrozen) {
        if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
          ProtoLogImpl.v(
              ProtoLogGroup.WM_DEBUG_ORIENTATION, 1947239194, 0, (String) null, (Object[]) null);
        }
        return false;
      }
    ...
    if (!this.mService.mDisplayEnabled) {
      if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_ORIENTATION, -1117599386, 0, (String) null, (Object[]) null);
      }
      return false;
    }
    ...
    if (foldController != null && foldController.shouldRevertOverriddenRotation()) {
      ...
      if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
        ProtoLogImpl.v(
            ...
            (String) null,
            new Object[] {
              String.valueOf(Surface.rotationToString(revertOverriddenRotation)),
              String.valueOf(Surface.rotationToString(i)),
              String.valueOf(Surface.rotationToString(rotationForOrientation))
            });
      }
    ...
    if (DisplayRotationCoordinator.isSecondaryInternalDisplay(this.mDisplayContent)
      ...
      rotationForOrientation =
          RotationUtils.reverseRotationDirectionAroundZAxis(
              this.mDisplayRotationCoordinator.getDefaultDisplayCurrentRotation());
    }
    if (ProtoLogCache.WM_FORCE_DEBUG_ORIENTATION_enabled) {
      ProtoLogImpl.v(
          ProtoLogGroup.WM_FORCE_DEBUG_ORIENTATION,
          -1717651004,
          4372,
          "Computed rotation=%s (%d) for display id=%d based on lastOrientation=%s (%d) and"
              + " oldRotation=%s (%d), caller=%s",
          new Object[] {
            String.valueOf(Surface.rotationToString(rotationForOrientation)),
            Long.valueOf(rotationForOrientation),
            Long.valueOf(displayId),
            String.valueOf(ActivityInfo.screenOrientationToString(i2)),
            Long.valueOf(i2),
            String.valueOf(Surface.rotationToString(i)),
            Long.valueOf(i),
    ...
    if (this.mDisplayContent.mTransitionController.isShellTransitionsEnabled()) {
      ...
      this.mDisplayContent.requestChangeTransitionIfNeeded(
          536870912,
          isCollecting
              ? displayChange
              : new TransitionRequestInfo.DisplayChange(
                  this.mDisplayContent.getDisplayId(), i, this.mRotation));
      if (isCollecting) {
        startRemoteRotation(i, this.mRotation);
      }
      DisplayContent displayContent = this.mDisplayContent;
      if (displayContent.mDisplayAreaPolicy != null
          && displayContent.getDefaultTaskDisplayArea().isSplitScreenStarting()) {
    ...
    windowManagerService.f1749mH.sendNewMessageDelayed(11, this.mDisplayContent, 2000L);
    ...
    this.mDisplayContent.mRemoteDisplayChangeController.performRemoteDisplayChange(
        ...
        new RemoteDisplayChangeController
            .ContinueRemoteDisplayChangeCallback() { // from class:
                                                     // com.android.server.wm.DisplayRotation$$ExternalSyntheticLambda0
  ...
  public final void lambda$startRemoteRotation$0(
      int i, WindowContainerTransaction windowContainerTransaction) {
    if (i != this.mRotation) {
      return;
    }
    if (this.mDisplayContent.mTransitionController.isShellTransitionsEnabled()) {
    ...
    try {
      ...
      if (windowContainerTransaction != null) {
        this.mService.mAtmService.mWindowOrganizerController.applyTransaction(
  ...
  public void prepareNormalRotationAnimation() {
    ...
    this.mService.startFreezingDisplay(
        selectRotationAnimation.mExit, selectRotationAnimation.mEnter, this.mDisplayContent);
  }
    ...
    if (this.mRotatingSeamlessly) {
      this.mDisplayContent.forAllWindows(
          new Consumer() { // from class:
                           // com.android.server.wm.DisplayRotation$$ExternalSyntheticLambda3
  ...
  */
  public boolean shouldRotateSeamlessly(int i, int i2, boolean z) {
    ...
    if (this.isDefaultDisplay) {
      ...
      boolean isSplitScreenVisible = defaultTaskDisplayArea.isSplitScreenVisible();
      boolean isSplitScreenStarting = defaultTaskDisplayArea.isSplitScreenStarting();
      if (isSplitScreenVisible
          || isSplitScreenStarting
          || this.mDisplayContent.hasVisibleFreeformTask()) {
        if (isSplitScreenStarting) {
          this.mDisplayContent.setFadeInOutAnimationNeeded(true, "reject_seamless_rot(starting)");
        }
        z2 = true;
        if (!this.mDisplayContent.hasTopFixedRotationLaunchingApp()) {
          ...
          this.mDisplayContent.setFadeInOutAnimationNeeded(true, "reject_seamless_rot");
          return false;
        }
        if (z2
            || (topFullscreenOpaqueWindow = this.mDisplayPolicy.getTopFullscreenOpaqueWindow())
                == null
            || topFullscreenOpaqueWindow != this.mDisplayContent.mCurrentFocus
            || ((topFullscreenOpaqueWindow.getAttrs().rotationAnimation != 3
                    && !topFullscreenOpaqueWindow.isAllowedSeamlessRotation())
                || topFullscreenOpaqueWindow.inMultiWindowMode()
                || topFullscreenOpaqueWindow.isAnimatingLw()
                || (!canRotateSeamlessly(i, i2)
                    && !topFullscreenOpaqueWindow.isAllowedSeamlessRotation()))) {
          return false;
        }
        ...
        if ((activityRecord == null || activityRecord.matchParentBounds())
            && !this.mDisplayContent.getDefaultTaskDisplayArea().hasPinnedTask()
            && !this.mDisplayContent.hasAlertWindowSurfaces()) {
          return z
              || this.mDisplayContent.getWindow(
                      new Predicate() { // from class:
                                        // com.android.server.wm.DisplayRotation$$ExternalSyntheticLambda1
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                          boolean z3;
                          z3 = ((WindowState) obj).mSeamlesslyRotated;
                          return z3;
                        }
                      })
                  == null;
  ...
  public boolean canRotateSeamlessly(int i, int i2) {
    if (this.mAllowSeamlessRotationDespiteNavBarMoving
        || this.mDisplayPolicy.navigationBarCanMove()) {
      return true;
    }
  ...
  public void markForSeamlessRotation(WindowState windowState, boolean z) {
    ...
    Slog.d(
        ...
        "markForSeamlessRotation, seamlesslyRotated="
            + z
            + ", w="
            + windowState
            + ", caller="
    ...
    if (this.mSeamlessRotationCount == 0) {
      if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
        ProtoLogImpl.i(
            ProtoLogGroup.WM_DEBUG_ORIENTATION, -576070986, 0, (String) null, (Object[]) null);
      }
      this.mRotatingSeamlessly = false;
      this.mDisplayContent.finishAsyncRotationIfPossible();
  ...
  public final RotationAnimationPair selectRotationAnimation() {
    boolean z =
        (this.mDisplayPolicy.isScreenOnFully() && this.mService.mPolicy.okToAnimate(false))
            ? false
            : true;
    ...
    if (ProtoLogCache.WM_DEBUG_ANIM_enabled) {
      ProtoLogImpl.i(
          ...
          (String) null,
          new Object[] {
            String.valueOf(topFullscreenOpaqueWindow),
            Long.valueOf(
                topFullscreenOpaqueWindow == null
                    ? 0L
                    : topFullscreenOpaqueWindow.getAttrs().rotationAnimation),
            Boolean.valueOf(z)
          });
    }
    if (z) {
      RotationAnimationPair rotationAnimationPair = this.mTmpRotationAnim;
      rotationAnimationPair.mExit = R.anim.task_fragment_clear_top_close_exit;
      rotationAnimationPair.mEnter = R.anim.task_fragment_clear_top_close_enter;
    ...
    if (topFullscreenOpaqueWindow != null) {
      ...
      if (rotationAnimationHint != 1) {
        if (rotationAnimationHint == 2) {
          ...
          rotationAnimationPair2.mExit = R.anim.task_fragment_clear_top_close_exit;
          rotationAnimationPair2.mEnter = R.anim.task_fragment_clear_top_close_enter;
      ...
      rotationAnimationPair4.mExit = R.anim.task_fragment_clear_top_open_enter;
      rotationAnimationPair4.mEnter = R.anim.task_fragment_clear_top_close_enter;
    } else {
  ...
  public boolean validateRotationAnimation(int i, int i2, boolean z) {
    switch (i) {
      case R.anim.task_fragment_clear_top_close_exit:
      case R.anim.task_fragment_clear_top_open_enter:
        if (z) {
          return false;
        }
        RotationAnimationPair selectRotationAnimation = selectRotationAnimation();
  ...
  public void restoreSettings(int i, int i2, int i3) {
    ...
    if (i != 0 && i != 1) {
      Slog.w(
          StartingSurfaceController.TAG,
          "Trying to restore an invalid user rotation mode " + i + " for " + this.mDisplayContent);
      i = 0;
    }
    if (i2 < 0 || i2 > 3) {
      Slog.w(
          StartingSurfaceController.TAG,
          "Trying to restore an invalid user rotation " + i2 + " for " + this.mDisplayContent);
      i2 = 0;
    }
  ...
  public boolean isRotationFrozen() {
    return !this.isDefaultDisplay
        ? this.mUserRotationMode == 1
        : Settings.System.getIntForUser(
                this.mContext.getContentResolver(), "accelerometer_rotation", 0, -2)
            == 0;
  }
  ...
  public final void updateOrientationListenerLw() {
    ...
    if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
      ProtoLogImpl.v(
          ...
          (String) null,
          new Object[] {
            Boolean.valueOf(isScreenOnEarly),
            Boolean.valueOf(isAwake),
            Long.valueOf(this.mCurrentAppOrientation),
            Boolean.valueOf(this.mOrientationListener.mEnabled),
            Boolean.valueOf(isKeyguardDrawComplete),
            Boolean.valueOf(isWindowManagerDrawComplete)
          });
    }
    if (isScreenOnEarly
        && ((isAwake || this.mOrientationListener.shouldStayEnabledWhileDreaming())
            && isKeyguardDrawComplete
            && isWindowManagerDrawComplete
            && needSensorRunning())) {
  ...
  public final boolean needSensorRunning() {
    ...
    if (this.mSupportAutoRotation
        && ((i = this.mCurrentAppOrientation) == 4 || i == 10 || i == 7 || i == 6)) {
      return true;
    }
    int dockMode = this.mDisplayPolicy.getDockMode();
    if ((this.mDisplayPolicy.isCarDockEnablesAccelerometer() && dockMode == 2)
        || (this.mDisplayPolicy.isDeskDockEnablesAccelerometer()
            && (dockMode == 1 || dockMode == 3 || dockMode == 4))) {
      return true;
    }
  ...
  */
  public int rotationForOrientation(int i, int i2) {
    ...
    if (ProtoLogCache.WM_FORCE_DEBUG_ORIENTATION_enabled) {
      ProtoLogImpl.v(
          ...
          new Object[] {
            ...
            Long.valueOf(i),
            String.valueOf(Surface.rotationToString(i2)),
            Long.valueOf(i2),
            String.valueOf(Surface.rotationToString(this.mUserRotation)),
            Long.valueOf(this.mUserRotation),
            this.mUserRotationMode == 1 ? "USER_ROTATION_LOCKED" : ""
          });
    }
    Slog.d(
        StartingSurfaceController.TAG,
        "rotationForOrientation, orientationSource="
            + this.mDisplayContent.getLastOrientationSource());
    if (CoreRune.FW_ORIENTATION_CONTROL) {
      this.mService.mAtmService.mExt.mOrientationController.logInRotationForOrientation(
          this.mDisplayContent);
    }
    ...
    int proposedRotation =
        orientationListener != null ? orientationListener.getProposedRotation() : -1;
    FoldController foldController = this.mFoldController;
    ...
    if (!this.isDefaultDisplay) {
      ...
      if (dockMode != 2 || (!isCarDockEnablesAccelerometer && this.mCarDockRotation < 0)) {
        if ((dockMode == 1 || dockMode == 3 || dockMode == 4)
            && !((!isDeskDockEnablesAccelerometer && this.mDeskDockRotation < 0)
                || i == 14
                || i == 5)) {
          ...
          if (i != 14) {
            if (this.mSupportAutoRotation) {
              if (((this.mUserRotationMode == 0 || isTabletopAutoRotateOverrideEnabled())
                      && (i == 2 || i == -1 || i == 11 || i == 12 || i == 13))
                  || i == 4
                  || i == 10
                  || i == 6
                  || i == 7) {
              ...
              } else if (this.mUserRotationMode == 1
                  && i != 5
                  && i != 0
                  && i != 1
                  && i != 8
    ...
    return isLandscapeOrSeascape(i5)
        ? i5
        : isLandscapeOrSeascape(i2) ? i2 : this.mLandscapeRotation;
  }
  ...
  public final boolean isRotationChoiceAllowed(int i) {
    int dockMode;
    DisplayRotationImmersiveAppCompatPolicy displayRotationImmersiveAppCompatPolicy =
        this.mCompatPolicyForImmersiveApps;
    if (!(displayRotationImmersiveAppCompatPolicy != null
            && displayRotationImmersiveAppCompatPolicy.isRotationLockEnforced(i))
        && this.mUserRotationMode != 1) {
      return false;
    }
    FoldController foldController = this.mFoldController;
    ...
    if ((this.mDisplayPolicy.getLidState() == 1 && this.mLidOpenRotation >= 0)
        || (dockMode = this.mDisplayPolicy.getDockMode()) == 2) {
      return false;
    }
    boolean isDeskDockEnablesAccelerometer = this.mDisplayPolicy.isDeskDockEnablesAccelerometer();
    ...
    if ((isHdmiPlugged && dockMode == 0 && this.mUndockedHdmiRotation >= 0)
        || this.mDemoRotationLock
        || this.mDisplayPolicy.isPersistentVrModeEnabled()
        || !this.mSupportAutoRotation) {
      return false;
    }
    int i2 = this.mCurrentAppOrientation;
    if (i2 != -1 && i2 != 2) {
    ...
    synchronized (this.mLock) {
      ...
      int intForUser =
          ActivityManager.isLowRamDeviceStatic()
              ? 0
              : Settings.Secure.getIntForUser(contentResolver, "show_rotation_suggestions", 1, -2);
      ...
      int i =
          Settings.System.getIntForUser(contentResolver, "accelerometer_rotation", 0, -2) != 0
              ? 0
              : 1;
      if (this.mUserRotationMode != i) {
        this.mUserRotationMode = i;
  ...
  public void onSetRequestedOrientation() {
    int i;
    if (this.mCompatPolicyForImmersiveApps == null
        || (i = this.mRotationChoiceShownToUserForConfirmation) == -1) {
      return;
    }
  ...
  public void dump(String str, PrintWriter printWriter) {
    ...
    printWriter.println(
        str
            ...
            + ActivityInfo.screenOrientationToString(this.mCurrentAppOrientation));
    ...
    printWriter.print(
        str + "  mLandscapeRotation=" + Surface.rotationToString(this.mLandscapeRotation));
    StringBuilder sb2 = new StringBuilder();
    sb2.append(" mSeascapeRotation=");
    sb2.append(Surface.rotationToString(this.mSeascapeRotation));
    printWriter.println(sb2.toString());
    printWriter.print(
        str + "  mPortraitRotation=" + Surface.rotationToString(this.mPortraitRotation));
    ...
    printWriter.println();
    printWriter.print(
        str + "  mCarDockRotation=" + Surface.rotationToString(this.mCarDockRotation));
    ...
    printWriter.print(
        str
            + "  mUserRotationMode="
            + WindowManagerPolicy.userRotationModeToString(this.mUserRotationMode));
    ...
    printWriter.println(
        " mAllowAllRotations=" + allowAllRotationsToString(this.mAllowAllRotations));
    printWriter.print(
        str + "  mDemoHdmiRotation=" + Surface.rotationToString(this.mDemoHdmiRotation));
    StringBuilder sb6 = new StringBuilder();
    sb6.append(" mDemoHdmiRotationLock=");
    sb6.append(this.mDemoHdmiRotationLock);
    printWriter.print(sb6.toString());
    printWriter.println(
        " mUndockedHdmiRotation=" + Surface.rotationToString(this.mUndockedHdmiRotation));
    printWriter.println(
        str + "  mLidOpenRotation=" + Surface.rotationToString(this.mLidOpenRotation));
    ...
    if (this.mFoldController != null) {
      ...
      printWriter.println(
          str
              + "  mPauseAutorotationDuringUnfolding="
              + this.mFoldController.mPauseAutorotationDuringUnfolding);
      printWriter.println(
          str
              + "  mShouldDisableRotationSensor="
              + this.mFoldController.mShouldDisableRotationSensor);
      printWriter.println(
          str
              + "  mShouldIgnoreSensorRotation="
              + this.mFoldController.mShouldIgnoreSensorRotation);
      printWriter.println(
          str + "  mLastDisplaySwitchTime=" + this.mFoldController.mLastDisplaySwitchTime);
      printWriter.println(
          str + "  mLastHingeAngleEventTime=" + this.mFoldController.mLastHingeAngleEventTime);
  ...
  public class FoldController {
    ...
    public FoldController() {
      int[] intArray =
          DisplayRotation.this
              .mContext
              .getResources()
              .getIntArray(R.array.config_supported_cellular_usage_settings);
      if (intArray != null) {
        for (int i : intArray) {
          if (i == 0) {
        ...
        ProtoLogImpl.w(
            ProtoLogGroup.WM_DEBUG_ORIENTATION, 939638078, 0, (String) null, (Object[]) null);
      }
      this.mIsDisplayAlwaysSeparatingHinge =
          DisplayRotation.this
              .mContext
              .getResources()
              .getBoolean(R.bool.config_flipToScreenOffEnabled);
      this.mActivityBoundsUpdateCallback = new RunnableC29111(DisplayRotation.this);
      boolean z =
          DisplayRotation.this
              .mContext
              .getResources()
              .getBoolean(R.bool.config_ui_enableFadingMarquee);
      ...
      if (z) {
        this.mDisplaySwitchRotationBlockTimeMs =
            DisplayRotation.this
                .mContext
                .getResources()
                .getInteger(R.integer.config_reduceBrightColorsStrengthDefault);
    ...
    public class RunnableC29111 implements Runnable {
      public final /* synthetic */ DisplayRotation val$this$0;

      public RunnableC29111(DisplayRotation displayRotation) {
      ...
      public void run() {
        ...
        if (FoldController.this.mDeviceState == DeviceStateController.DeviceState.OPEN
            || FoldController.this.mDeviceState == DeviceStateController.DeviceState.HALF_FOLDED) {
          synchronized (DisplayRotation.this.mLock) {
            Task task =
                DisplayRotation.this.mDisplayContent.getTask(
                    new Predicate() { // from class:
                                      // com.android.server.wm.DisplayRotation$FoldController$1$$ExternalSyntheticLambda0
                      @Override // java.util.function.Predicate
                      public final boolean test(Object obj) {
                        boolean lambda$run$0;
                        lambda$run$0 =
                            DisplayRotation.FoldController.RunnableC29111.lambda$run$0((Task) obj);
                        return lambda$run$0;
                      }
                    });
    ...
    public final void registerSensorManager() {
      ...
      SensorManager sensorManager =
          (SensorManager) DisplayRotation.this.mContext.getSystemService(SensorManager.class);
      ...
      SensorEventListener sensorEventListener =
          new SensorEventListener() { // from class:
                                      // com.android.server.wm.DisplayRotation.FoldController.2
      ...
      this.mSensorManager.registerListener(
          sensorEventListener, defaultSensor, 0, DisplayRotation.this.getHandler());
    }
    ...
    public void onDisplayRemoved() {
      ...
      if (sensorManager == null
          || (sensorEventListener = this.mHingeAngleSensorEventListener) == null) {
        return;
      }
    ...
    public boolean isDeviceInPosture(DeviceStateController.DeviceState deviceState, boolean z) {
      ...
      return deviceState2 != DeviceStateController.DeviceState.HALF_FOLDED
          || z == this.mTabletopRotations.contains(Integer.valueOf(DisplayRotation.this.mRotation));
    }

    public boolean isSeparatingHinge() {
      DeviceStateController.DeviceState deviceState = this.mDeviceState;
      return deviceState == DeviceStateController.DeviceState.HALF_FOLDED
    ...
    public boolean shouldRevertOverriddenRotation() {
      return this.mDeviceState == DeviceStateController.DeviceState.OPEN
          && !this.mShouldIgnoreSensorRotation
          && this.mInHalfFoldTransition
          && DisplayRotation.this
              .mDisplayContent
              .getRotationReversionController()
              .isOverrideActive(2)
          && DisplayRotation.this.mUserRotationMode == 1;
    }
      ...
      if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
        ...
        ProtoLogImpl.v(
            ...
            new Object[] {
              ...
              Long.valueOf(j),
              Long.valueOf(j2),
              Long.valueOf(displayRotation.mLastSensorRotation),
              Long.valueOf(displayRotation.mLastOrientation),
              Long.valueOf(DisplayRotation.this.mRotation)
            });
      }
      DeviceStateController.DeviceState deviceState2 = this.mDeviceState;
    ...
    public final void updateSensorRotationBlockIfNeeded() {
      ...
      boolean z =
          uptimeMillis - this.mLastDisplaySwitchTime
                  < ((long) this.mDisplaySwitchRotationBlockTimeMs)
              || uptimeMillis - this.mLastHingeAngleEventTime
                  < ((long) this.mHingeAngleRotationBlockTimeMs);
    ...
    public void onPhysicalDisplayChanged() {
      if (this.mPauseAutorotationDuringUnfolding) {
        ...
        DisplayRotation.this
            ...
            .postDelayed(
                new Runnable() { // from class:
                                 // com.android.server.wm.DisplayRotation$FoldController$$ExternalSyntheticLambda0
                  @Override // java.lang.Runnable
                  public final void run() {
    ...
    public void onHingeAngleChanged(float f) {
      if (f < this.mMaxHingeAngle) {
        ...
        DisplayRotation.this
            ...
            .postDelayed(
                new Runnable() { // from class:
                                 // com.android.server.wm.DisplayRotation$FoldController$$ExternalSyntheticLambda1
                  @Override // java.lang.Runnable
                  public final void run() {
  ...
  public class OrientationListener extends WindowOrientationListener implements Runnable {
    ...
    public boolean isRotationResolverEnabled() {
      return DisplayRotation.this.mAllowRotationResolver
          && DisplayRotation.this.mUserRotationMode == 0
          && DisplayRotation.this.mCameraRotationMode == 1
          && !DisplayRotation.this.mService.mPowerManager.isPowerSaveMode();
    }
    ...
    public void onProposedRotationChanged(int i) {
      ...
      if (DisplayRotation.this.isRotationChoiceAllowed(i)) {
        ...
        DisplayRotation.this.sendProposedRotationChangeToStatusBarInternal(
            i, DisplayRotation.this.isValidRotationChoice(i));
      } else {
    ...
    public void enable() {
      ...
      if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_ORIENTATION, -1568331821, 0, (String) null, (Object[]) null);
      }
    }
    ...
    public void disable() {
      ...
      if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_ORIENTATION, -439951996, 0, (String) null, (Object[]) null);
      }
    }
  ...
  public class SettingsObserver extends ContentObserver {
    ...
    public void observe() {
      ...
      contentResolver.registerContentObserver(
          Settings.Secure.getUriFor("show_rotation_suggestions"), false, this, -1);
      contentResolver.registerContentObserver(
          Settings.System.getUriFor("accelerometer_rotation"), false, this, -1);
      contentResolver.registerContentObserver(
          Settings.System.getUriFor("user_rotation"), false, this, -1);
      contentResolver.registerContentObserver(
          Settings.Secure.getUriFor("camera_autorotate"), false, this, -1);
  ...
  public class RotationHistory {
    ...
    public class Record {
      ...
      public Record(DisplayRotation displayRotation, int i, int i2) {
        ...
        this.mSensorRotation =
            (orientationListener == null || !orientationListener.mEnabled)
                ? -2
                : displayRotation.mLastSensorRotation;
        ...
        TaskDisplayArea orientationRequestingTaskDisplayArea =
            displayContent.getOrientationRequestingTaskDisplayArea();
        if (orientationRequestingTaskDisplayArea == null) {
          displayArea = "none";
        } else {
          displayArea =
              orientationRequestingTaskDisplayArea != displayContent.getDefaultTaskDisplayArea()
                  ? orientationRequestingTaskDisplayArea.toString()
                  : null;
        }
        ...
        this.mDisplayRotationCompatPolicySummary =
            displayRotationCompatPolicy != null
                ? displayRotationCompatPolicy.getSummaryForDisplayRotationHistoryRecord()
                : null;
        this.mRotationReversionSlots =
            displayRotation.mDisplayContent.getRotationReversionController().getSlotsCopy();
      }

      public void dump(String str, PrintWriter printWriter) {
        printWriter.println(
            str
                + TimeUtils.logTimeOfDay(this.mTimestamp)
                + " "
                + Surface.rotationToString(this.mFromRotation)
                + " to "
                + Surface.rotationToString(this.mToRotation));
        StringBuilder sb = new StringBuilder();
        sb.append(str);
        sb.append("  source=");
        ...
        printWriter.println(
            str
                ...
                + WindowManagerPolicy.userRotationModeToString(this.mUserRotationMode)
                + " user="
                + Surface.rotationToString(this.mUserRotation)
                + " sensor="
                + Surface.rotationToString(this.mSensorRotation));
        ...
        if (this.mHalfFoldSavedRotation != -2) {
          printWriter.println(
              str
                  + " halfFoldSavedRotation="
                  + this.mHalfFoldSavedRotation
        ...
        if (this.mRotationReversionSlots != null) {
          printWriter.println(
              str
                  + " reversionSlots= NOSENSOR "
                  + this.mRotationReversionSlots[0]
                  + ", CAMERA "
                  + this.mRotationReversionSlots[1]
                  + " HALF_FOLD "
                  + this.mRotationReversionSlots[2]);
        }
      }
    }
    ...
    public void addRecord(DisplayRotation displayRotation, int i) {
      ...
      this.mRecords.addLast(
          new Record(
              displayRotation,
              displayRotation.mDisplayContent.getWindowConfiguration().getRotation(),
              i));
    }
  }
  ...
  public final boolean shouldDisableRotationSensor() {
    ...
    if (WmCoverState.isEnabled()
        && (coverPolicy = this.mDisplayPolicy.mExt.mCoverPolicy) != null
        && coverPolicy.isLastCoverAppOpened()
        && WmCoverState.getInstance().isViewCoverClosed()) {
      Slog.d(
          StartingSurfaceController.TAG,
          "shouldDisableRotationSensor, rotation sensor is disabled due to cover policy");
      return true;
    }
    ...
    Slog.d(
        StartingSurfaceController.TAG,
        "shouldDisableRotationSensor, rotation sensor is disabled due to proximity sensor");
    return true;
  }
