...
public final class ActivityManagerPerformance {
    ...
    public final Set mBigdataSlugSkipPackage =
            new HashSet(
                    Arrays.asList(
                            x("YW5kcm9pZA=="),
                            x("Y29tLmdvb2dsZS5hbmRyb2lkLnBhY2thZ2VpbnN0YWxsZXI="),
                            x("Y29tLnRydWVjYWxsZXI="),
                            x("Y29tLmdvb2dsZS5hbmRyb2lkLnBlcm1pc3Npb25jb250cm9sbGVy"),
                            x("Y29tLnNlYy5hbmRyb2lkLmFwcC5sYXVuY2hlcg=="),
                            x("c3lzdGVtdWk=")));
    ...
    public final AnonymousClass1 mDeviceStateCallback =
            new DeviceStateManager
                    .DeviceStateCallback() { // from class:
                                             // com.android.server.wm.ActivityManagerPerformance.1
                public final void onDeviceStateChanged(DeviceState deviceState) {
                    ActivityManagerPerformance.this.mIsFolded =
                            deviceState.hasProperties(new int[] {1});
    ...
    public final AnonymousClass2 mIntentReceiver = new BroadcastReceiver() { // from class:
                ...
                */
                public final void onReceive(
                        android.content.Context r31, android.content.Intent r32) {
                    /*
                    ...
                    */
                    throw new UnsupportedOperationException(
                            "Method not decompiled:"
                                + " com.android.server.wm.ActivityManagerPerformance.AnonymousClass2.onReceive(android.content.Context,"
    ...
    public final class AppLaunchTimeDBHelper extends SQLiteOpenHelper {
        ...
        public final class AppLaunchTimeDBErrorHandler implements DatabaseErrorHandler {
            ...
            public final void onCorruption(SQLiteDatabase sQLiteDatabase) {
                Slog.e(
                        "ActivityManagerPerformance",
                        "app launch time db is deleted by AppLaunchTimeDBErrorHandler");
                SQLiteDatabase.deleteDatabase(new File(sQLiteDatabase.getPath()));
            }
        }

        /* renamed from: -$$Nest$mdeleteDBData, reason: not valid java name */
        public static void m1050$$Nest$mdeleteDBData(
                AppLaunchTimeDBHelper appLaunchTimeDBHelper, SQLiteDatabase sQLiteDatabase) {
            int i;
            ...
            synchronized (dbLock) {
                try {
                    ...
                    if (i > 0) {
                        appLaunchTimeDBHelper.mLastModifiedTime =
                                Calendar.getInstance().getTimeInMillis();
                    }
                } catch (SQLException e) {
                    Slog.e(
                            "ActivityManagerPerformance",
                            "AppLaunchTime Failed to delete. " + e.getMessage());
                    i = -1;
                }
            }
            if (i <= 0) {
                Slog.e(
                        "ActivityManagerPerformance",
                        "AppLaunchTime Failed to delete AppLaunchTimeCountStats");
            }
        }

        /* renamed from: -$$Nest$mfetch, reason: not valid java name */
        public static void m1051$$Nest$mfetch(
                AppLaunchTimeDBHelper appLaunchTimeDBHelper, SQLiteDatabase sQLiteDatabase) {
            Cursor cursor;
            appLaunchTimeDBHelper.getClass();
            try {
                ...
                Slog.e(
                        "ActivityManagerPerformance:AppLaunchTime",
                        "Failed to query. " + e.getMessage());
                cursor = null;
            }
        ...
        public static void m1052$$Nest$mupdateDataInTable(
                AppLaunchTimeDBHelper appLaunchTimeDBHelper,
            ...
            if ("AppLaunchTimeCountStats".equals(str)) {
                ...
                try {
                    Iterator it =
                            ((HashMap) ActivityManagerPerformance.this.mAppLaunchTimeCountStats)
                                    .entrySet()
                                    .iterator();
                    while (it.hasNext()) {
                    ...
                    Slog.e(
                            "ActivityManagerPerformance",
                            "failed to getJsonFromAppLaunchTimeCountStats");
                }
                valueOf = jSONObject.length() > 0 ? jSONObject.toString() : "";
            } else {
                valueOf =
                        "DayOfWeek".equals(str)
                                ? String.valueOf(appLaunchTimeDBHelper.mDBDayOfWeek)
                                : "lastModifiedTime".equals(str)
                                        ? String.valueOf(appLaunchTimeDBHelper.mLastModifiedTime)
                                        : "startTimeOfGatheredData".equals(str)
                                                ? String.valueOf(
                                                        appLaunchTimeDBHelper.mStartTimeGathered)
                                                : "buildVersion".equals(str)
                                                        ? appLaunchTimeDBHelper.mBuildVersion
                                                        : "devicePowerOnCount".equals(str)
                                                                ? String.valueOf(
                                                                        appLaunchTimeDBHelper
                                                                                .mDevicePowerOnCount)
                                                                : null;
            }
            if (valueOf == null) {
            ...
            if (i <= 0) {
                synchronized (dbLock) {
                    ...
                    try {
                        ...
                        Slog.e(
                                "ActivityManagerPerformance:AppLaunchTime",
                                "Failed to insert. " + e2.getMessage());
                    }
                }
                j = insert;
                if (j < 0) {
                    Slog.e(
                            "ActivityManagerPerformance",
                            "AppLaunchTime Failed to insert ".concat(str));
                }
            }
        }
        ...
        public AppLaunchTimeDBHelper(Context context) {
            super(
                    context,
                    "/data/misc/AppLaunchTime/app_launch_time.db",
                    null,
                    1,
                    new AppLaunchTimeDBErrorHandler());
        ...
        */
        public final void fetchAppLaunchTimeCountStatsFromDBValue(java.lang.String r28) {
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.wm.ActivityManagerPerformance.AppLaunchTimeDBHelper.fetchAppLaunchTimeCountStatsFromDBValue(java.lang.String):void");
        }
        ...
        public final void onCreate(SQLiteDatabase sQLiteDatabase) {
            try {
                sQLiteDatabase.execSQL(
                        "CREATE TABLE IF NOT EXISTS AppLaunchTime (NAME TEXT unique, VALUE TEXT);");
        ...
        */
        public final void handleMessage(android.os.Message r24) {
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.wm.ActivityManagerPerformance.MainHandler.handleMessage(android.os.Message):void");
        }
    }
    ...
    public static void m1049$$Nest$mwriteAppLaunchTimeCountStatsToDB(
        ...
        try {
            if (writableDatabase == null) {
                Slog.e(
                        "ActivityManagerPerformance",
                        "failed DB writable open to writeAppLaunchTimeCountStatsToDB.");
                return;
            }
            try {
                AppLaunchTimeDBHelper appLaunchTimeDBHelper = mAppLaunchDBHelper;
                Objects.requireNonNull(appLaunchTimeDBHelper);
                AppLaunchTimeDBHelper.m1052$$Nest$mupdateDataInTable(
                        appLaunchTimeDBHelper, writableDatabase, "AppLaunchTimeCountStats");
                ...
                AppLaunchTimeDBHelper.m1052$$Nest$mupdateDataInTable(
                        appLaunchTimeDBHelper2, sQLiteDatabase, "lastModifiedTime");
                if (z) {
                ...
                if (z) {
                    Slog.e(
                            "ActivityManagerPerformance",
                            "failed writeAppLaunchTimeCountStatsToDB, " + e.getMessage());
                }
            }
        } finally {
            mAppLaunchDB.close();
    ...
    static {
        ...
        if (!(!"user".equals(Build.TYPE))
                && !"true".equals(SystemProperties.get("sys.config.amp_debug", "false"))) {
            z = false;
        }
        DEBUG = z;
        ...
        sLowPerformancePkgList =
                new String[] {
                    x("Y29tLnNlYy5hbmRyb2lkLmFwcC5zYnJvd3Nlcg=="), x("Y29tLmFuZHJvaWQuY2hyb21l")
                };
        mAppLaunchPackagesTimeOutLM =
                new String[] {
                    x("Y29tLnNlYy5hbmRyb2lkLmFwcC5zYnJvd3Nlcg=="),
                    x("Y29tLnNhbXN1bmcuYW5kcm9pZC5ob21laHVi"),
                    x("Y29tLm5obi5hbmRyb2lkLnNlYXJjaA=="),
                    x("Y29tLmdvb2dsZS5hbmRyb2lkLmdt"),
                    x("Y29tLnNhbXN1bmcuYW5kcm9pZC5lbWFpbC51aQ=="),
                    x("Y29tLmFuZHJvaWQudmVuZGluZw=="),
                    x("Y29tLnNhbXN1bmcuZXZlcmdsYWRlcy52aWRlbw=="),
                    x("Y29tLnNhbXN1bmcuYW5kcm9pZC52aWRlbw=="),
                    x("Y29tLnNlYy5hbmRyb2lkLmdhbGxlcnkzZA=="),
                    x("Y29tLmdvb2dsZS5hbmRyb2lkLmFwcHMubWFwcw=="),
                    x("Y29tLmJhaWR1LmFwcHNlYXJjaA=="),
                    x("Y29tLnNpbmEud2VpYm8="),
                    x("Y29tLmJhaWR1LkJhaWR1TWFw"),
                    x("Y29tLnR3aXR0ZXIuYW5kcm9pZA==")
                };
        ...
        mAppLaunchDB = null;
        sNextTimeToSendSlugBigdata =
                Duration.ofMinutes(30L).toMillis() + System.currentTimeMillis();
        ...
        gSystemuiPkgs =
                new String[] {
                    x("Y29tLmFuZHJvaWQuc3lzdGVtdWk="), x("Y29tLnNlYy5hbmRyb2lkLmRleHN5c3RlbXVp")
                };
    }
    ...
    public ActivityManagerPerformance(
        ...
        this.mHandler =
                new MainHandler(
                        Watchdog$$ExternalSyntheticOutline0.m(-2, "AmpHandlerThread", false)
                                .getLooper());
        ...
        IntentFilter m =
                VcnManagementService$$ExternalSyntheticOutline0.m(
                        ...
                        "com.sec.android.sdhms.action.INIT_COMPLETED",
                        "com.sec.android.intent.action.BIGDATA_EVERY_DAY_UPDATE",
                        "com.sec.android.intent.action.BIGDATA_EVERY_WEEK_CLEANUP");
        ...
        try {
            ...
            if (e.getMessage().contains("malformed database")) {
                ...
                File databasePath =
                        mContext.getDatabasePath("/data/misc/AppLaunchTime/app_launch_time.db");
            ...
            NandswapManager$$ExternalSyntheticOutline0.m(
                    e2, new StringBuilder("Exception for appDB "), "ActivityManagerPerformance");
        }
        SQLiteDatabase sQLiteDatabase = mAppLaunchDB;
        if (sQLiteDatabase != null) {
            try {
                ...
                try {
                    ...
                    Slog.e(
                            "ActivityManagerPerformance:AppLaunchTime",
                            "Failed to drop table. " + e3.getMessage());
                }
            ...
            if (j3 <= 0) {
                ...
                if (writableDatabase != null) {
                    try {
                        try {
                            ...
                            AppLaunchTimeDBHelper.m1052$$Nest$mupdateDataInTable(
                                    appLaunchTimeDBHelper4,
                                    sQLiteDatabase3,
                                    "startTimeOfGatheredData");
                        } finally {
                        }
                    } catch (Exception e4) {
                        if (z) {
                            Slog.e(
                                    "ActivityManagerPerformance",
                                    "failed checkStartTimeGathered, " + e4.getMessage());
                        }
                    }
                    mAppLaunchDB.close();
                }
                if (z) {
                    BatteryService$$ExternalSyntheticOutline0.m(
                            new StringBuilder("setStartTimeGathered : "),
                            mAppLaunchDBHelper.mStartTimeGathered,
                            "ActivityManagerPerformance");
                }
            } else if (z) {
            ...
            try {
                if (writableDatabase2 != null) {
                    try {
                        ...
                        AppLaunchTimeDBHelper.m1052$$Nest$mupdateDataInTable(
                                appLaunchTimeDBHelper5, writableDatabase2, "devicePowerOnCount");
                    } catch (Exception e5) {
                        if (z) {
                            Slog.e(
                                    "ActivityManagerPerformance",
                                    "failed checkDevicePowerOnCount, " + e5.getMessage());
                        }
                    }
                    mAppLaunchDB.close();
                }
                if (z) {
                    BatteryService$$ExternalSyntheticOutline0.m(
                            new StringBuilder("setDevicePowerOnCount : "),
                            mAppLaunchDBHelper.mDevicePowerOnCount,
                            "ActivityManagerPerformance");
                }
                    ...
                    if (writableDatabase3 != null) {
                        try {
                            try {
                                ...
                                AppLaunchTimeDBHelper.m1052$$Nest$mupdateDataInTable(
                                        appLaunchTimeDBHelper6, writableDatabase3, "buildVersion");
                                mAppLaunchDBHelper.mStartTimeGathered = System.currentTimeMillis();
                            ...
                            if (z) {
                                Slog.e(
                                        "ActivityManagerPerformance",
                                        "failed checkBuildVersionChanged, " + e6.getMessage());
                            }
                        }
                    }
                    if (z) {
                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                "detect New build version : ", str3, "ActivityManagerPerformance");
                    }
                } else if (z) {
                    ...
                    if (writableDatabase4 != null) {
                        try {
                            try {
                                ...
                                AppLaunchTimeDBHelper.m1052$$Nest$mupdateDataInTable(
                                        appLaunchTimeDBHelper9, writableDatabase4, "DayOfWeek");
                            } finally {
                            }
                        } catch (Exception e7) {
                            if (z) {
                                Slog.e(
                                        "ActivityManagerPerformance",
                                        "failed registerAlarm - dayOfWeek, " + e7.getMessage());
                            }
                        }
                    }
                    i2 = nextInt;
                ...
                if (z) {
                    AnyMotionDetector$$ExternalSyntheticOutline0.m(
                            i2, "TTLS Day of Week : ", "ActivityManagerPerformance");
                }
                PendingIntent broadcast2 =
                        PendingIntent.getBroadcast(mContext, 0, new Intent(str), 67108864);
                calendar.set(7, i2);
                calendar.set(11, 0);
                calendar.set(12, 0);
                ...
                long millis =
                        (j2 - mAppLaunchDBHelper.mLastModifiedTime)
                ...
                if (millis > 7) {
                    ...
                    if (z) {
                        Slog.d(
                                "ActivityManagerPerformance",
                                "did cleanup the data old the last week.");
                    }
                } else if (z) {
        ...
        if (this.mDeviceStateManager == null) {
            this.mDeviceStateManager =
                    (DeviceStateManager) mContext.getSystemService(DeviceStateManager.class);
        }
                ...
                if (AMP_ENABLE && curTopAct != activityRecord) {
                    int i =
                            activityRecord.isActivityTypeHome()
                                    ? 2
                                    : activityRecord.isActivityTypeRecents() ? 3 : 4;
                    boolean z = DEBUG;
                    if (z) {
                        String str =
                        ...
                        if (z2) {
                            ...
                            sb3.append(
                                    activityRecord5 != null ? activityRecord5.packageName : null);
                            sb3.append(", cur: ");
                    ...
                    if (CoreRune.ALLIED_PROC_PROTECTION_LMKD
                        ...
                        } else if (!activityRecord.packageName.equals(
                                activityRecord3.packageName)) {
                                        ...
                                        if (z) {
                                            Slog.d(
                                                    ...
                                                    activityRecord.resultTo.packageName
                                                            + " allied process eligble for LMKD"
                                                            + " kill protect");
                                        }
                                    }
                        ...
                        if (AMP_PERF_ENABLE
                            ...
                            if (i == 2) {
                                if (z) {
                                    Slog.d(
                                            "ActivityManagerPerformance",
                                            "notifyCurTopAct() call setBoosterHome()");
                                }
                            ...
                            if (i2 == 3 && (i == 4 || i == 1)) {
                                try {
                                    ...
                                    if (activityRecord7 != null) {
                                        if (activityRecord7 != activityRecord
                                                && !activityRecord.processName.equals(
                                                        activityRecord7.processName)) {}
                                    }
                                    ActivityManagerPerformance activityManagerPerformance2 =
                                            booster;
                                    if (activityManagerPerformance2.isMultiWindowResume
                                            && curTopState == 4) {
                                        activityManagerPerformance2.isMultiWindowResume = false;
                                        if (z) {
                                            Slog.d(
                                                    "ActivityManagerPerformance",
                                                    "notifyCurTopAct() skipped."
                                                        + " isMultiWindowResume: true");
                                        }
                                        return;
                                    } else {
                                        if (z) {
                    ...
                    if (activityManagerPerformance3 != null
                        ...
                        activityManagerPerformance3.setLowPower(
                                hashSet.contains(activityRecord2.packageName));
                    }
                }
            } catch (Throwable th) {
                throw th;
                                ...
                                ? i != 3
                                        ? i != 4
                                                ? VibrationParam$1$$ExternalSyntheticOutline0.m(
                                                        i, "NO_STATE_NUM_OF_")
                                                : "TOP_STATE_APP"
                                        : "TOP_STATE_RECENTS_APP"
                                : "TOP_STATE_HOME"
                        : "TOP_STATE_IS_CREATING"
                : "TOP_STATE_INIT";
    }
    ...
    public final void deleteDBTableAndClear() {
        ...
        try {
            if (writableDatabase == null) {
                Slog.e(
                        "ActivityManagerPerformance",
                        "failed DB writable open to deleteDBTableAndClear.");
                return;
            }
            try {
                AppLaunchTimeDBHelper appLaunchTimeDBHelper = mAppLaunchDBHelper;
                Objects.requireNonNull(appLaunchTimeDBHelper);
                AppLaunchTimeDBHelper.m1050$$Nest$mdeleteDBData(
                        appLaunchTimeDBHelper, writableDatabase);
                AppLaunchTimeDBHelper appLaunchTimeDBHelper2 = mAppLaunchDBHelper;
                SQLiteDatabase sQLiteDatabase = mAppLaunchDB;
                Objects.requireNonNull(appLaunchTimeDBHelper2);
                AppLaunchTimeDBHelper.m1052$$Nest$mupdateDataInTable(
                ...
                if (z) {
                    Slog.e(
                            "ActivityManagerPerformance",
                            "failed deleteDBTableAndClear, " + e.getMessage());
                }
            }
        } finally {
            mAppLaunchDB.close();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void gatherAppLaunchTime(
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.ActivityManagerPerformance.gatherAppLaunchTime(java.lang.String,"
    ...
    public final String getCurBoostInfoStr() {
        ...
        if (z) {
            StringBuilder m =
                    Preconditions$$ExternalSyntheticOutline0.m(sb3, "\nTIMEOUT_ACT_RESUME: ");
        ...
        StringBuilder m3 =
                Preconditions$$ExternalSyntheticOutline0.m(
                        ConnectivityModuleConnector$$ExternalSyntheticOutline0.m$1(sb, "\n"),
                        "\n[curTopState] ");
        ...
        m9.append(")");
        return ConnectivityModuleConnector$$ExternalSyntheticOutline0.m$1(
        ...
        if (AMP_RELAUNCH_RESUME_ON) {
            ...
            if (this.mBoosterRelaunchResume == null) {
                SemDvfsManager createInstance =
                        SemDvfsManager.createInstance(mContext, "AMS_RELAUNCH_RESUME");
            ...
            if (semDvfsManager == null) {
                Slog.e(
                        "ActivityManagerPerformance",
                        "setBoosterRelaunchResume() skipped. SemDvfsManager.createInstance()"
                            + " failed");
                return;
            }
            try {
    ...
    public final void onActivityStartLocked(ActivityRecord activityRecord) {
        ...
        if (!this.mIsScreenOn) {
            if (z) {
                Slog.d(
                        "ActivityManagerPerformance",
                        "onActivityStartLocked() skipped. mIsScreenOn: false");
                return;
            }
            return;
        }
            ...
            try {
                ...
                if (activityRecord3 != activityRecord
                    ...
                    if (z) {
                        Slog.d(
                                "ActivityManagerPerformance",
                                "onActivityStartLocked() skipped. already boosted "
                                        + activityRecord.processName);
                        return;
                    }
                    return;
    ...
    public final void onActivityVisibleLocked(ActivityRecord activityRecord) {
        if (DEBUG) {
            if (activityRecord == null) {
                Slog.e(
                        "ActivityManagerPerformance",
                        "onActivityVisibleLocked() ActivityRecord is Null");
                return;
            }
        ...
        synchronized (this.mLockAppLaunch) {
            try {
                if (this.mBoosterAppLaunch == null) {
                    this.mBoosterAppLaunch =
                            SemDvfsManager.createInstance(mContext, "AMS_APP_LAUNCH");
                }
                if (this.mBoosterAppLaunch != null) {
    ...
    public final synchronized void sendHqmBigData(String str, String str2, String str3) {
        try {
            ...
            if (!semHqmManager.sendHWParamToHQM(
                    0, "Sluggish", str, "ph", str2, "sec", "", str3, "")) {
    ...
    */
    public final void setBoosterActResume(boolean r8, com.android.server.wm.ActivityRecord r9) {
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.ActivityManagerPerformance.setBoosterActResume(boolean,"
    ...
    */
    public final void setBoosterActStart(boolean r7, com.android.server.wm.ActivityRecord r8) {
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.ActivityManagerPerformance.setBoosterActStart(boolean,"
                    + " com.android.server.wm.ActivityRecord):void");
    }
    ...
    */
    public final void setBoosterAppSwitch(boolean r10, com.android.server.wm.ActivityRecord r11) {
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.ActivityManagerPerformance.setBoosterAppSwitch(boolean,"
                    + " com.android.server.wm.ActivityRecord):void");
    }
    ...
    */
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void setBoosterHome(
            com.android.server.wm.ActivityRecord r11, boolean r12, boolean r13) {
        /*
            Method dump skipped, instructions count: 518
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.ActivityManagerPerformance.setBoosterHome(com.android.server.wm.ActivityRecord,"
    ...
    public final void setBoosterTail(boolean z, ActivityRecord activityRecord) {
        ...
        if (!this.mIsScreenOn) {
            if (z2) {
                Slog.d(
                        "ActivityManagerPerformance",
                        "setBoosterTail() skipped. mIsScreenOn: false");
                return;
            }
            return;
        }
        if ((z && this.rCurBoostActStart != null) || (!z && rCurBoostAppSwitch != null)) {
            if (z2) {
                DeviceIdleController$$ExternalSyntheticOutline0.m(
                        new StringBuilder("setBoosterTail() skipped. "),
                        !z ? "AppSwitch" : "ActStart",
                        " is not finished",
                        "ActivityManagerPerformance");
                return;
            }
        ...
        if (this.mBoosterTail == null) {
            SemDvfsManager createInstance =
                    SemDvfsManager.createInstance(mContext, "AMS_RESUME_TAIL");
        ...
        if (this.mBoosterLazy == null) {
            SemDvfsManager createInstance2 =
                    SemDvfsManager.createInstance(mContext, "AMS_ACT_LAZY");
