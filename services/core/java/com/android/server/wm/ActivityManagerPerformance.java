...
public class ActivityManagerPerformance {
    ...
    static {
        ...
        sLowPerformancePkgList = new String[]{m113x("Y29tLnNlYy5hbmRyb2lkLmFwcC5zYnJvd3Nlcg=="), m113x("Y29tLmFuZHJvaWQuY2hyb21l")};
        mAppLaunchPackagesTimeOutLM = new String[]{m113x("Y29tLnNlYy5hbmRyb2lkLmFwcC5zYnJvd3Nlcg=="), m113x("Y29tLnNhbXN1bmcuYW5kcm9pZC5ob21laHVi"), m113x("Y29tLm5obi5hbmRyb2lkLnNlYXJjaA=="), m113x("Y29tLmdvb2dsZS5hbmRyb2lkLmdt"), m113x("Y29tLnNhbXN1bmcuYW5kcm9pZC5lbWFpbC51aQ=="), m113x("Y29tLmFuZHJvaWQudmVuZGluZw=="), m113x("Y29tLnNhbXN1bmcuZXZlcmdsYWRlcy52aWRlbw=="), m113x("Y29tLnNhbXN1bmcuYW5kcm9pZC52aWRlbw=="), m113x("Y29tLnNlYy5hbmRyb2lkLmdhbGxlcnkzZA=="), m113x("Y29tLmdvb2dsZS5hbmRyb2lkLmFwcHMubWFwcw=="), m113x("Y29tLmJhaWR1LmFwcHNlYXJjaA=="), m113x("Y29tLnNpbmEud2VpYm8="), m113x("Y29tLmJhaWR1LkJhaWR1TWFw"), m113x("Y29tLnR3aXR0ZXIuYW5kcm9pZA==")};
        mAppLaunchPackagesTimeOutM = new String[]{m113x("Y29tLnNlYy5hbmRyb2lkLmFwcC5jYW1lcmE=")};
        gHotLaunchBoosterPkgs = new String[]{m113x("Y29tLnNlYy5hbmRyb2lkLmFwcC5jYW1lcmE="), m113x("Y29tLnNlYy5hbmRyb2lkLmFwcC5zYnJvd3Nlcg==")};
        ...
        gSystemuiPkgs = new String[]{m113x("Y29tLmFuZHJvaWQuc3lzdGVtdWk="), m113x("Y29tLnNlYy5hbmRyb2lkLmRleHN5c3RlbXVp")};
    }
    ...
    public final void setBoosterActResume(boolean z, ActivityRecord activityRecord) {
        ...
        if (DEBUG) {
            ...
            if (activityRecord2 != null) {
                ...
                Slog.d("ActivityManagerPerformance", "setBoosterActResume() onoff: " + z + ", r: " + str3 + " (" + activityRecord + "), curBoost: " + str + " (" + this.rCurBoostActResume + ")");
                if (DEBUG_TRACE) {
                    Slog.d("ActivityManagerPerformance", "setBoosterActResume() Trace\n" + getCurBoostInfoStr());
                    new Exception().printStackTrace();
                }
            }
            str = null;
        ...
        if (semDvfsManager == null) {
            Slog.e("ActivityManagerPerformance", "setBoosterActResume() skipped. SemDvfsManager.createInstance() failed");
            return;
        }
        if (z) {
            int i = (activityRecord == null || !activityRecord.isActivityTypeHome()) ? TIMEOUT_ACT_RESUME : 500;
            ...
            try {
                ...
                if (DEBUG) {
                    Slog.e("ActivityManagerPerformance", "AMP_acquire() ACT_RESUME failed[" + str4 + "] e: " + e2 + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + getCurBoostInfoStr());
                }
        ...
        try {
            ...
            if (DEBUG) {
                Slog.e("ActivityManagerPerformance", "AMP_release() ACT_RESUME failed. e: " + e3 + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + getCurBoostInfoStr());
            }
            e3.printStackTrace();
        }
    }
    ...
    public final void setBoosterActStart(boolean z, ActivityRecord activityRecord) {
        ...
        if (DEBUG) {
            ...
            if (activityRecord2 != null) {
                ...
                Slog.d("ActivityManagerPerformance", "setBoosterActStart() onoff: " + z + ", r: " + str3 + " (" + activityRecord + "), curBoost: " + str2 + " (" + this.rCurBoostActStart + ")");
                if (DEBUG_TRACE) {
                    Slog.d("ActivityManagerPerformance", "setBoosterActStart() Trace\n" + getCurBoostInfoStr());
                    new Exception().printStackTrace();
                }
            }
            str2 = null;
        ...
        if (isChinaModel && activityRecord != null && (activityInfo = activityRecord.info) != null && (str = activityInfo.name) != null && str.contains("LuckyMoneyReceiveUI")) {
            if (z) {
                if (this.mLuckyMoneyBooster == null) {
                    SemDvfsManager createInstance = SemDvfsManager.createInstance(this.mContext, "LuckyMoneyBooster", 12);
                    ...
                    if (createInstance != null) {
                        ...
                        if (supportedFrequency != null) {
                            ...
                            Slog.e("ActivityManagerPerformance", "setBoosterActStart() skipped. Hongbao getSupportedFrequency() failed. AMP_PERF_ENABLE: " + AMP_PERF_ENABLE);
                            return;
                        }
                    } else {
                        Slog.e("ActivityManagerPerformance", "setBoosterActStart() skipped. Hongbao SemDvfsManager.createInstance() failed. AMP_PERF_ENABLE: " + AMP_PERF_ENABLE);
                        return;
                    }
                }
        ...
        SemDvfsManager semDvfsManager = AMP_PERF_ENABLE ? this.mBoosterActStart : this.mBoosterPrevResume;
        if (semDvfsManager == null) {
            Slog.e("ActivityManagerPerformance", "setBoosterActStart() skipped. SemDvfsManager.createInstance() failed. AMP_PERF_ENABLE: " + AMP_PERF_ENABLE);
            return;
        }
        if (z) {
            int i = (activityRecord == null || !activityRecord.isActivityTypeHome()) ? AMP_PERF_ENABLE ? TIMEOUT_ACT_START : TIMEOUT_PREV_RESUME : 500;
            ...
            try {
                ...
                if (DEBUG) {
                    Slog.e("ActivityManagerPerformance", "AMP_acquire() ACT_START failed. [" + str4 + "] e: " + e2 + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + getCurBoostInfoStr());
                }
        ...
        try {
            ...
            if (DEBUG) {
                Slog.e("ActivityManagerPerformance", "AMP_release() ACT_START failed. e: " + e3 + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + getCurBoostInfoStr());
            }
            e3.printStackTrace();
        }
    }
    ...
    */
    public final void setBoosterAppSwitch(boolean z, ActivityRecord activityRecord) {
        ...
        if (DEBUG) {
            ...
            if (activityRecord2 != null) {
                str = activityRecord2.processName;
                Slog.d("ActivityManagerPerformance", "setBoosterAppSwitch() onoff: " + z + ", r: " + str4 + " (" + activityRecord + "), curBoost: " + str + " (" + this.rCurBoostAppSwitch + ")");
                if (DEBUG_TRACE) {
                    Slog.d("ActivityManagerPerformance", "setBoosterAppSwitch() Trace\n" + getCurBoostInfoStr());
                    new Exception().printStackTrace();
                }
            }
            str = null;
        ...
        if (z && str2 != null && str2.equals(str3)) {
            if (DEBUG) {
                Slog.d("ActivityManagerPerformance", "setBoosterAppSwitch() skipped. Background activity start on abnormal app : " + str3);
                return;
            }
            return;
        }
        ...
        if (semDvfsManager == null) {
            Slog.e("ActivityManagerPerformance", "setBoosterAppSwitch() skipped. SemDvfsManager.createInstance() failed");
            return;
        }
        if (z) {
            int i = (activityRecord == null || !activityRecord.isActivityTypeHome()) ? TIMEOUT_APP_SWITCH : 500;
            ...
            try {
                ...
                if (FreecessController.getInstance().getFreecessEnabled() && !isMultiWindowScenario(curTopAct, activityRecord)) {
                ...
                if (DEBUG) {
                    Slog.e("ActivityManagerPerformance", "AMP_acquire() APP_SWITCH failed. [" + str5 + "] e: " + e2 + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + getCurBoostInfoStr());
                }
        ...
        try {
            ...
            if (DEBUG) {
                Slog.e("ActivityManagerPerformance", "setBoosterAppSwitch() AMP_release failed. e: " + e3 + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE + getCurBoostInfoStr());
            }
            e3.printStackTrace();
        }
    }
    ...
    */
    public void onActivityResumeLocked(ActivityRecord activityRecord) {
        if (DEBUG) {
            Slog.d("ActivityManagerPerformance", "onActivityResumeLocked() r: " + activityRecord.processName + " (" + activityRecord + ")");
            if (DEBUG_TRACE) {
                Slog.d("ActivityManagerPerformance", "onActivityResumeLocked() Trace\n" + getCurBoostInfoStr());
                new Exception().printStackTrace();
            }
        }
        if (!AMP_ENABLE || isSpeg(activityRecord.packageName, activityRecord.launchedFromPackage) || isBlockedApp(activityRecord.packageName)) {
        ...
        if (!this.mIsScreenOn) {
            if (DEBUG) {
                Slog.d("ActivityManagerPerformance", "onActivityResumeLocked() skipped. mIsScreenOn: false");
                return;
            }
            return;
        }
        ...
        if (this.needSkipResume) {
            if (DEBUG) {
                Slog.d("ActivityManagerPerformance", "onActivityResumeLocked() skipped. needSkipResume is true");
            }
            this.needSkipResume = false;
            return;
        }
        if (!AMP_PERF_ENABLE) {
            try {
                ActivityRecord activityRecord2 = this.rCurBoostActStart;
                if (activityRecord2 == activityRecord || (activityRecord2 != null && activityRecord.processName.equals(activityRecord2.processName))) {
                    if (DEBUG) {
                        Slog.d("ActivityManagerPerformance", "onActivityResumeLocked() skipped. already boosted " + activityRecord.processName);
                        return;
                    }
                    return;
                }
        ...
        if (activityRecord.isActivityTypeRecents()) {
            try {
                ActivityRecord activityRecord3 = this.rCurBoostActResume;
                ActivityRecord activityRecord4 = this.rCurBoostActStart;
                if (activityRecord4 == activityRecord || activityRecord3 == activityRecord || ((activityRecord4 != null && activityRecord.processName.equals(activityRecord4.processName)) || (activityRecord3 != null && activityRecord.processName.equals(activityRecord3.processName)))) {
                    if (DEBUG) {
                        Slog.d("ActivityManagerPerformance", "onActivityResumeLocked() skipped. already boosted " + activityRecord.processName);
                        return;
                    }
        ...
        if (activityRecord5 != null && activityRecord5.processName.equals(activityRecord.processName)) {
            try {
                ...
                if (activityRecord8 == activityRecord || activityRecord7 == activityRecord || activityRecord6 == activityRecord || ((activityRecord8 != null && activityRecord.processName.equals(activityRecord8.processName)) || ((activityRecord7 != null && activityRecord.processName.equals(activityRecord7.processName)) || (activityRecord6 != null && activityRecord.processName.equals(activityRecord6.processName))))) {
                    if (DEBUG) {
                        Slog.d("ActivityManagerPerformance", "onActivityResumeLocked() skipped. already boosted " + activityRecord.processName);
                        return;
                    }
        ...
        if (activityRecord9 == null && this.rCurBoostActStart == null) {
            try {
                ...
                if (activityRecord10 == activityRecord || (activityRecord10 != null && activityRecord.processName.equals(activityRecord10.processName))) {
                    if (DEBUG) {
                        Slog.d("ActivityManagerPerformance", "onActivityResumeLocked() skipped. already boosted " + activityRecord.processName);
                        return;
                    }
