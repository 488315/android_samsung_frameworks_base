...
class MultiTaskingAppCompatAspectRatioOverrides$$ExternalSyntheticLambda0 implements BiConsumer {
    public final /* synthetic */ MultiTaskingAppCompatAspectRatioOverrides f$0;
    public final /* synthetic */ int f$1;

    public /* synthetic */ MultiTaskingAppCompatAspectRatioOverrides$$ExternalSyntheticLambda0(
    ...
    public final void accept(Object obj, Object obj2) {
        ...
        if (floatValue != -1.0f
                && floatValue != FullScreenMagnificationGestureHandler.MAX_SCALE
                && floatValue != 1.7777778f
                && floatValue != 1.3333334f) {
            Slog.d(
                    "MultiTaskingAppCompat",
                    "setUserMinAspectRatio:" + f + " is unknown min aspect ratio.");
        ...
        try {
            AppGlobals.getPackageManager()
                    .setUserMinAspectRatio(
                            str,
                            i,
                            f.floatValue() == 1.7777778f
                                    ? 4
                                    : f.floatValue() == 1.3333334f ? 3 : 7);
            ...
            Slog.w(
                    ...
                    SensitiveContentProtectionManagerService$SensitiveContentProtectionManagerServiceBinder$$ExternalSyntheticOutline0
                            .m(
                                    i,
                                    "Unable to set user min aspect ratio override. packageName=",
                                    str,
                                    ", userId="),
                    e);
        } catch (Throwable th) {
