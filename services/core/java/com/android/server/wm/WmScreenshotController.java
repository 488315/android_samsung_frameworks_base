...
public class WmScreenshotController {
    ...
    public final void takeScreenshot(final WmScreenshotInfo wmScreenshotInfo) {
        ...
        synchronized (this.mScreenshotLock) {
            ...
            final ServiceConnection serviceConnection = new ServiceConnection() { // from class: com.android.server.wm.WmScreenshotController.1
            ...
            if (this.mContext.bindServiceAsUser(intent, serviceConnection, 1, userHandle)) {
                this.mScreenshotConnections.put(serviceConnection, new Runnable() { // from class: com.android.server.wm.WmScreenshotController$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        WmScreenshotController.this.lambda$takeScreenshot$0(serviceConnection);
                    }
                });
                this.mHandler.postDelayed((Runnable) this.mScreenshotConnections.get(serviceConnection), 10000L);
            }
        }
    }
    ...
    public final void sendScreenshotMessage(IBinder iBinder, final ServiceConnection serviceConnection, WmScreenshotInfo wmScreenshotInfo) {
        synchronized (this.mScreenshotLock) {
    ...
    */
    public ScreenshotResult takeScreenshotToTargetWindow(int i, int i2, boolean z, Rect rect, int i3, int i4, boolean z2, boolean z3, boolean z4) {
        String str;
        StringBuilder sb;
                ...
                try {
                    ...
                    if (displayContent == null) {
                        ...
                        if (WindowManagerPolicyExt.isSystemWindowType(i2)) {
                            findTargetSurfaceForAppWindowTarget = findTargetSurfaceForSystemWindowTarget(displayContent, i2, z, sb2);
                        } else if (WindowManagerPolicyExt.isAppWindowType(i2)) {
                            findTargetSurfaceForAppWindowTarget = findTargetSurfaceForAppWindowTarget(displayContent);
                        } else {
                            surfaceControl = null;
                            Log.d(StartingSurfaceController.TAG, "takeScreenshotToTargetWindow: targetSurface=" + surfaceControl + ", sourceCrop=" + rect);
                            final DisplayContent displayContent2 = !CoreRune.FW_SCREENSHOT_FOR_HDR ? displayContent : null;
                            WindowManagerService.resetPriorityAfterLockedSection();
                            ...
                            if (displayInfo != null) {
                                ...
                                if (CoreRune.FW_SCREENSHOT_FOR_HDR && z4) {
                                    this.mHandler.postDelayed(new Runnable() { // from class: com.android.server.wm.WmScreenshotController$$ExternalSyntheticLambda0
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            WmScreenshotController.this.lambda$takeScreenshotToTargetWindow$2(displayContent2);
                                        }
                                    }, 500L);
                                }
                                if (bitmap == null) {
        ...
        builder.setCapturedBitmap(bitmap).setFailedReason(this.mReasonForFailure).setTargetWindowName(sb2.toString()).setSecuredWindowName(this.mSecuredWindowName);
