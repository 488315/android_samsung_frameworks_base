...
public final class CoreStateController {
    ...
    public final void notifyCoreStatesChangedLocked(
            int i,
            MultiWindowEnableController$$ExternalSyntheticLambda0
                    multiWindowEnableController$$ExternalSyntheticLambda0) {
        int i2;
        ...
        for (int size = sparseArray.size() - 1; size >= 0; size--) {
            WindowProcessController windowProcessController =
                    (WindowProcessController) sparseArray.get(sparseArray.keyAt(size));
            if (windowProcessController.mPid != ActivityManagerService.MY_PID
                    && ((i2 = windowProcessController.mUserId) == i
                            || (z
                                    && i2 == 0
    ...
    public final void onCoreStateChanged(
            Bundle bundle,
            int i,
            boolean z,
            MultiWindowEnableController$$ExternalSyntheticLambda0
        ...
        synchronized (windowManagerGlobalLock) {
            if (z) {
                try {
                    notifyCoreStatesChangedLocked(
                            i, multiWindowEnableController$$ExternalSyntheticLambda0);
                } catch (Throwable th) {
    ...
    public final void setVolatileState(
            String str,
            Object obj,
            int i,
            boolean z,
        ...
        synchronized (windowManagerGlobalLock) {
            try {
                this.mObserverController.setVolatileState(
                        str, obj, i, z, z2, multiWindowEnableController$$ExternalSyntheticLambda0);
            } catch (Throwable th) {
                WindowManagerService.resetPriorityAfterLockedSection();
                throw th;
            }
    ...
    public final void startUserLocked(int i, boolean z, boolean z2) {
        ...
        Slog.d(
                "CoreStateObserverController",
                "startUserLocked: " + coreStateObserverController.mStartedUserIds + ", u" + i);
        coreStateObserverController.mStartedUserIds.add(Integer.valueOf(i));
        if (z2
                && (coreStateSettingObserver = coreStateObserverController.mSettingObserver)
                        != null) {
    ...
    public final void stopUserLocked(int i, boolean z) {
        ...
        Slog.d(
                "CoreStateObserverController",
                "stopUserLocked: " + coreStateObserverController.mStartedUserIds + ", u" + i);
        coreStateObserverController.mStartedUserIds.remove(Integer.valueOf(i));
        final CoreStateSettingObserver coreStateSettingObserver =
                coreStateObserverController.mSettingObserver;
        if (coreStateSettingObserver != null) {
            ArraySet arraySet = coreStateObserverController.mStartedUserIds;
            Slog.d(
                    "CoreStateSettingObserver",
                    "endObserveCoreStateSettingsForSingleUser(u" + i + ")");
            BackgroundThread.getHandler()
                    .post(
                            new Runnable() { // from class:
                                             // com.samsung.android.server.corestate.CoreStateSettingObserver$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    CoreStateSettingObserver coreStateSettingObserver2 =
                                            CoreStateSettingObserver.this;
                                    coreStateSettingObserver2
                                            .mContext
                                            .getContentResolver()
                                            .unregisterContentObserver(coreStateSettingObserver2);
                                }
                            });
        ...
        if (z
                && (coreStateVolatileObserver = coreStateObserverController.mVolatileObserver)
                        != null) {
            Iterator it2 =
                    ((HashMap) coreStateVolatileObserver.mVolatileStatesRepository)
                            .entrySet()
                            .iterator();
            while (it2.hasNext()) {
