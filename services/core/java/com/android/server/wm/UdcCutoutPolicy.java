...
public class UdcCutoutPolicy {
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static boolean executeShellCommandLocked(String str, String[] strArr, PrintWriter printWriter, WindowManagerService windowManagerService) {
        ...
        printWriter.println("Error: -udc requires [packageName | packageName:packageName:...] [true/false]");
        printWriter.println("Error: -udc_a requires [ComponentName | ComponentName:ComponentName:...] [true/false]");
        printWriter.println("Error: -udc_w requires [WindowTitle | WindowTitle:WindowTitle:...] [true/false]");
        return true;
    }
