...
public final class ImeInsetsSourceProvider extends InsetsSourceProvider {
  ...
  public InsetsSourceControl getControl(InsetsControlTarget insetsControlTarget) {
    ...
    if (control != null && insetsControlTarget != null && insetsControlTarget.getWindow() != null) {
      ...
      TaskSnapshot taskSnapshot =
          window.getRootTask() != null
              ? window.mWmService.getTaskSnapshot(window.getRootTask().mTaskId, 0, false, false)
              : null;
  ...
  public void setClientVisible(boolean z) {
    ...
    if (!isClientVisible
        && isClientVisible()
        && (controlTarget = getControlTarget()) != null
        && controlTarget.getWindow() != null
        && controlTarget.getWindow().mActivityRecord == null) {
  ...
  public final void reportImeDrawnForOrganizerIfNeeded(InsetsControlTarget insetsControlTarget) {
    ...
    WindowToken windowToken =
        this.mWindowContainer.asWindowState() != null
            ...
            : null;
    if (this.mDisplayContent.getAsyncRotationController() == null
        || !this.mDisplayContent.getAsyncRotationController().isTargetToken(windowToken)) {
  ...
  public final void reportImeDrawnForOrganizer(InsetsControlTarget insetsControlTarget) {
    ...
    this.mWindowContainer.mWmService.mAtmService.mTaskOrganizerController.reportImeDrawnOnTask(
        insetsControlTarget.getWindow().getTask());
  }
  ...
  public final void onSourceChanged() {
    ...
    DisplayContent displayContent = this.mDisplayContent;
    displayContent.mWmService.f1749mH.obtainMessage(41, displayContent).sendToTarget();
  }

  public void scheduleShowImePostLayout(
    ...
    if (isTargetChangedWithinActivity) {
      ...
      if (this.mImeRequester.getWindow() != null
    ...
    if (isReadyToShowIme()) {
      ...
      if (ProtoLogCache.WM_DEBUG_IME_enabled) {
        ProtoLogImpl.i(
            ...
            (String) null,
            new Object[] {
              String.valueOf(imeTarget.getWindow() != null ? imeTarget.getWindow().getName() : "")
            });
      }
      setImeShowing(true);
      ...
      if (imeTarget != insetsControlTarget
          && insetsControlTarget != null
          && ProtoLogCache.WM_DEBUG_IME_enabled) {
        ProtoLogImpl.w(
            ProtoLogGroup.WM_DEBUG_IME,
            -1554521902,
            0,
  ...
  public void checkShowImePostLayout() {
    ...
    if (this.mIsImeLayoutDrawn
        || (isReadyToShowIme() && asWindowState.isDrawn() && !asWindowState.mGivenInsetsPending)) {
  ...
  public boolean isReadyToShowIme() {
    ...
    if (imeTarget == null
        || this.mImeRequester == null
        || this.mDisplayContent.getImeTarget(2) == null) {
      return false;
    }
    if (ProtoLogCache.WM_DEBUG_IME_enabled) {
      ProtoLogImpl.d(
    ...
    return isImeLayeringTarget(this.mImeRequester, imeTarget)
        || isAboveImeLayeringTarget(this.mImeRequester, imeTarget)
        || isImeFallbackTarget(this.mImeRequester)
        || isImeInputTarget(this.mImeRequester)
        || sameAsImeControlTarget();
  }

  public static boolean isImeLayeringTarget(
      InsetsControlTarget insetsControlTarget, InsetsControlTarget insetsControlTarget2) {
    return !isImeTargetWindowClosing(insetsControlTarget2.getWindow())
  ...
  public static boolean isAboveImeLayeringTarget(
    ...
    return insetsControlTarget.getWindow() != null
        ...
        && insetsControlTarget2.getWindow().mSubLayer > insetsControlTarget.getWindow().mSubLayer;
  }
  ...
  public final boolean sameAsImeControlTarget() {
    InsetsControlTarget imeTarget = this.mDisplayContent.getImeTarget(2);
    InsetsControlTarget insetsControlTarget = this.mImeRequester;
    return imeTarget == insetsControlTarget
        && (insetsControlTarget.getWindow() == null
            || !isImeTargetWindowClosing(this.mImeRequester.getWindow()));
  }
  ...
  public static boolean isImeTargetWindowClosing(WindowState windowState) {
    ...
    return windowState.mAnimatingExit
        || ((activityRecord = windowState.mActivityRecord) != null
            && ((activityRecord.isInTransition()
                    && !windowState.mActivityRecord.isVisibleRequested())
                || windowState.mActivityRecord.willCloseOrEnterPip()));
  }

  public final boolean isTargetChangedWithinActivity(InsetsControlTarget insetsControlTarget) {
    InsetsControlTarget insetsControlTarget2;
    return (insetsControlTarget == null
            || insetsControlTarget.getWindow() == null
            || (insetsControlTarget2 = this.mImeRequester) == insetsControlTarget
