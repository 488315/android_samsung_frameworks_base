...
public class TaskPositioner implements IBinder.DeathRecipient {
        ...
        synchronized (windowManagerGlobalLock3) {
          try {
            ...
            if (activityManagerPerformance != null
                && (activityRecord = activityTaskManagerService.mLastResumedActivity) != null) {
  ...
  public CompletableFuture register(
      final DisplayContent displayContent, final WindowState windowState) {
    ...
    this.mInputEventReceiver =
        new BatchedInputEventReceiver.SimpleBatchedInputEventReceiver(
            this.mClientChannel,
            this.mService.mAnimationHandler.getLooper(),
            this.mService.mAnimator.getChoreographer(),
            new BatchedInputEventReceiver.SimpleBatchedInputEventReceiver
    ...
    this.mDragApplicationHandle =
        new InputApplicationHandle(
            new Binder(), "TaskPositioner", InputConstants.DEFAULT_DISPATCHING_TIMEOUT_MILLIS);
    InputWindowHandle inputWindowHandle =
        new InputWindowHandle(this.mDragApplicationHandle, displayContent.getDisplayId());
    ...
    if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
      ProtoLogImpl.d(
          ProtoLogGroup.WM_DEBUG_ORIENTATION, 791468751, 0, (String) null, (Object[]) null);
    }
    this.mDisplayContent.getDisplayRotation().pause();
    return this.mService
        .mTaskPositioningController
        .showInputSurface(windowState.getDisplayId())
        .thenRun(
      ...
      try {
        ...
        this.mMinVisibleWidth =
            WindowManagerService.dipToPixel(
                WindowState.MINIMUM_VISIBLE_WIDTH_IN_DP, displayMetrics);
  ...
  public void unregister() {
    ...
    if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
      ProtoLogImpl.d(
          ProtoLogGroup.WM_DEBUG_ORIENTATION, 1422781269, 0, (String) null, (Object[]) null);
    }
  ...
  public static TaskPositioner create(WindowManagerService windowManagerService) {
    if (sFactory == null) {
      sFactory =
          new Factory() { // from class: com.android.server.wm.TaskPositioner.1
          };
    }
