            ...
            if (task != null) {
                ...
                if (i == i2) {
                    ...
                    if (activityRecord.getPid() == this.mOrganizerPid) {
                        ...
                        TaskFragmentOrganizerController.this.mAtmService.mWindowManager.f1749mH.postDelayed(new Runnable() { // from class: com.android.server.wm.TaskFragmentOrganizerController$TaskFragmentOrganizerState$$ExternalSyntheticLambda0
