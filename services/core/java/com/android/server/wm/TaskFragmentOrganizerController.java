...
public class TaskFragmentOrganizerController extends ITaskFragmentOrganizerController.Stub {
  ...
  public class TaskFragmentOrganizerState implements IBinder.DeathRecipient {
    ...
    public TaskFragmentOrganizerState(
        ITaskFragmentOrganizer iTaskFragmentOrganizer, int i, int i2) {
    ...
    public boolean addTaskFragment(TaskFragment taskFragment) {
      if (taskFragment.mTaskFragmentAppearedSent
          || this.mOrganizedTaskFragments.contains(taskFragment)) {
        return false;
      }
      ...
      while (!this.mOrganizedTaskFragments.isEmpty()) {
        try {
          ...
          if (taskFragment.isEmbedded()) {
            TaskFragmentOrganizerController.this.mAtmService.mDexController.embeddedDisposed(
                taskFragment);
          }
        } catch (Throwable th) {
    ...
    public TaskFragmentTransaction.Change prepareTaskFragmentAppeared(TaskFragment taskFragment) {
      if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
        ProtoLogImpl.v(
            ...
            0,
            (String) null,
            new Object[] {String.valueOf(taskFragment.getName())});
      }
      ...
      return new TaskFragmentTransaction.Change(1)
          .setTaskFragmentToken(taskFragment.getFragmentToken())
    ...
    public TaskFragmentTransaction.Change prepareTaskFragmentInfoChanged(
        TaskFragment taskFragment) {
      TaskFragmentInfo taskFragmentInfo = taskFragment.getTaskFragmentInfo();
      TaskFragmentInfo taskFragmentInfo2 =
          (TaskFragmentInfo) this.mLastSentTaskFragmentInfos.get(taskFragment);
      if (taskFragmentInfo.equalsForTaskFragmentOrganizer(taskFragmentInfo2)
          && WindowOrganizerController.configurationsAreEqualForOrganizer(
              taskFragmentInfo.getConfiguration(), taskFragmentInfo2.getConfiguration())) {
        return null;
      }
      if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
        ProtoLogImpl.v(
    ...
    public TaskFragmentTransaction.Change prepareTaskFragmentParentInfoChanged(Task task) {
      ...
      TaskFragmentParentInfo taskFragmentParentInfo2 =
          (TaskFragmentParentInfo) this.mLastSentTaskFragmentParentInfos.get(i);
      Configuration configuration =
          taskFragmentParentInfo2 != null ? taskFragmentParentInfo2.getConfiguration() : null;
      if (taskFragmentParentInfo.equalsForTaskFragmentOrganizer(taskFragmentParentInfo2)
          && WindowOrganizerController.configurationsAreEqualForOrganizer(
              taskFragmentParentInfo.getConfiguration(), configuration)) {
        return null;
      }
      if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
        ProtoLogImpl.v(
            ...
            4,
            (String) null,
            new Object[] {String.valueOf(task.getName()), Long.valueOf(i)});
      }
      this.mLastSentTaskFragmentParentInfos.put(
          i, new TaskFragmentParentInfo(taskFragmentParentInfo));
      return new TaskFragmentTransaction.Change(4)
          .setTaskId(i)
          .setTaskFragmentParentInfo(taskFragmentParentInfo);
    }

    public TaskFragmentTransaction.Change prepareTaskFragmentError(
        IBinder iBinder, TaskFragment taskFragment, int i, Throwable th) {
      if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_WINDOW_ORGANIZER,
            743418423,
            0,
            (String) null,
            new Object[] {String.valueOf(th.toString())});
      }
      return new TaskFragmentTransaction.Change(5)
          .setErrorCallbackToken(iBinder)
          .setErrorBundle(
              TaskFragmentOrganizer.putErrorInfoInBundle(
                  th, taskFragment != null ? taskFragment.getTaskFragmentInfo() : null, i));
    }

    public TaskFragmentTransaction.Change prepareActivityReparentedToTask(
        ActivityRecord activityRecord) {
      IBinder iBinder;
      if (activityRecord.finishing) {
        Slog.d(
            "TaskFragmentOrganizerController",
            "Reparent activity=" + activityRecord.token + " is finishing");
        return null;
      }
      ...
      if (task != null) {
        ...
        if (i == i2) {
          if (task.isAllowedToEmbedActivity(activityRecord, i2) != 0
              || !task.isAllowedToEmbedActivityInTrustedMode(activityRecord, this.mOrganizerUid)) {
            Slog.d(
                "TaskFragmentOrganizerController",
                "Reparent activity="
          ...
          if (activityRecord.getPid() == this.mOrganizerPid) {
            ...
            TaskFragmentOrganizerController.this.mAtmService.mWindowManager.f1749mH.postDelayed(
                new Runnable() { // from class:
                                 // com.android.server.wm.TaskFragmentOrganizerController$TaskFragmentOrganizerState$$ExternalSyntheticLambda0
                  @Override // java.lang.Runnable
                  public final void run() {
                    TaskFragmentOrganizerController.TaskFragmentOrganizerState.this
                        .lambda$prepareActivityReparentedToTask$0(binder);
                  }
                },
                5000L);
            iBinder = binder;
          ...
          if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
            ProtoLogImpl.v(
                ...
                4,
                (String) null,
                new Object[] {String.valueOf(activityRecord.token), Long.valueOf(task.mTaskId)});
          }
          return new TaskFragmentTransaction.Change(6)
              .setTaskId(task.mTaskId)
              .setActivityIntent(TaskFragmentOrganizerController.trimIntent(activityRecord.intent))
        ...
        if (CoreRune.MW_EMBED_ACTIVITY) {
          ...
          while (true) {
            ...
            if (change.getType() == 4
                && change.getTaskId() != -1
                && (anyTaskForId =
                        TaskFragmentOrganizerController.this.mAtmService.mRootWindowContainer
                            .anyTaskForId(change.getTaskId(), 0))
                    != null
    ...
    public void onTransactionStarted(IBinder iBinder) {
      if (TaskFragmentOrganizerController.this
        ...
        if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_enabled) {
          ProtoLogImpl.v(
              ...
              1,
              (String) null,
              new Object[] {Long.valueOf(collectingTransitionId), String.valueOf(iBinder)});
        }
        ...
        if (!TaskFragmentOrganizerController.this
          ...
          if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_enabled) {
            ProtoLogImpl.w(
                ...
                1,
                (String) null,
                new Object[] {Long.valueOf(intValue), String.valueOf(iBinder)});
            return;
          }
          return;
        }
  ...
  public ActivityRecord getReparentActivityFromTemporaryToken(
      ITaskFragmentOrganizer iTaskFragmentOrganizer, IBinder iBinder) {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        this.mTaskFragmentOrganizerState.put(
            ...
            new TaskFragmentOrganizerState(iTaskFragmentOrganizer, callingPid, callingUid));
  ...
  public void onTransactionHandled(
      IBinder iBinder, WindowContainerTransaction windowContainerTransaction, int i, boolean z) {
    WindowManagerGlobalLock windowManagerGlobalLock = this.mGlobalLock;
    WindowManagerService.boostPriorityForLockedSection();
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        TaskFragmentOrganizerState taskFragmentOrganizerState =
            taskFragmentOrganizer != null
                ? (TaskFragmentOrganizerState)
                    this.mTaskFragmentOrganizerState.get(taskFragmentOrganizer.asBinder())
                : null;
        if (taskFragmentOrganizerState != null) {
  ...
  public void applyTransaction(
      WindowContainerTransaction windowContainerTransaction, int i, boolean z) {
    WindowManagerGlobalLock windowManagerGlobalLock = this.mGlobalLock;
    WindowManagerService.boostPriorityForLockedSection();
    synchronized (windowManagerGlobalLock) {
      try {
        if (!isValidTransaction(windowContainerTransaction)) {
          ...
          this.mWindowOrganizerController.applyTaskFragmentTransactionLocked(
              windowContainerTransaction, i, z);
          WindowManagerService.resetPriorityAfterLockedSection();
        }
      } catch (Throwable th) {
        WindowManagerService.resetPriorityAfterLockedSection();
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        if (taskFragmentOrganizerState == null) {
          Slog.e(
              "TaskFragmentOrganizerController",
              "TaskFragmentOrganizer has been unregistered or died when trying to play animation on"
                  + " its organized windows.");
          WindowManagerService.resetPriorityAfterLockedSection();
          return null;
        }
        RemoteAnimationDefinition remoteAnimationDefinition =
  ...
  public void onTaskFragmentAppeared(
      ITaskFragmentOrganizer iTaskFragmentOrganizer, TaskFragment taskFragment) {
    ...
    if (taskFragment.getTask() == null) {
      Slog.w(
          "TaskFragmentOrganizerController",
          "onTaskFragmentAppeared failed because it is not attached tf=" + taskFragment);
      return;
    }
    if (validateAndGetState(iTaskFragmentOrganizer).addTaskFragment(taskFragment)
        && getPendingTaskFragmentEvent(taskFragment, 0) == null) {
      addPendingEvent(
          new PendingTaskFragmentEvent.Builder(0, iTaskFragmentOrganizer)
  ...
  public void onTaskFragmentInfoChanged(
    ...
    if (taskFragment.mTaskFragmentAppearedSent) {
      PendingTaskFragmentEvent lastPendingLifecycleEvent =
          getLastPendingLifecycleEvent(taskFragment);
      if (lastPendingLifecycleEvent == null) {
        lastPendingLifecycleEvent =
            new PendingTaskFragmentEvent.Builder(2, iTaskFragmentOrganizer)
                .setTaskFragment(taskFragment)
                .build();
      } else {
  ...
  public void onTaskFragmentVanished(
    ...
    addPendingEvent(
        new PendingTaskFragmentEvent.Builder(1, iTaskFragmentOrganizer)
            .setTaskFragment(taskFragment)
            .build());
  ...
  public void onTaskFragmentError(
    ...
    if (taskFragment == null || !taskFragment.mTaskFragmentVanishedSent) {
      ...
      addPendingEvent(
          new PendingTaskFragmentEvent.Builder(4, iTaskFragmentOrganizer)
              .setErrorCallbackToken(iBinder)
              .setTaskFragment(taskFragment)
              .setException(th)
              .setOpType(i)
  ...
  public void onActivityReparentedToTask(ActivityRecord activityRecord) {
          ...
          .forAllLeafTaskFragments(
              new Predicate() { // from class:
                ...
                public final boolean test(Object obj) {
                  ...
                  lambda$onActivityReparentedToTask$0 =
                      TaskFragmentOrganizerController.lambda$onActivityReparentedToTask$0(
                          taskFragmentArr, (TaskFragment) obj);
    ...
    if (!isOrganizerRegistered(iTaskFragmentOrganizer)) {
      ...
      addPendingEvent(
          new PendingTaskFragmentEvent.Builder(5, iTaskFragmentOrganizer)
              .setActivity(activityRecord)
              .build());
    }
  }

  public static /* synthetic */ boolean lambda$onActivityReparentedToTask$0(
      TaskFragment[] taskFragmentArr, TaskFragment taskFragment) {
  ...
  public void onTaskFragmentParentInfoChanged(
      ITaskFragmentOrganizer iTaskFragmentOrganizer, Task task) {
    validateAndGetState(iTaskFragmentOrganizer);
    if (getLastPendingParentInfoChangedEvent(iTaskFragmentOrganizer, task) == null) {
      addPendingEvent(
          new PendingTaskFragmentEvent.Builder(3, iTaskFragmentOrganizer).setTask(task).build());
    }
  }

  public final PendingTaskFragmentEvent getLastPendingParentInfoChangedEvent(
      ITaskFragmentOrganizer iTaskFragmentOrganizer, Task task) {
    List list = (List) this.mPendingTaskFragmentEvents.get(iTaskFragmentOrganizer.asBinder());
    for (int size = list.size() - 1; size >= 0; size--) {
  ...
  public final TaskFragmentOrganizerState validateAndGetState(
    ...
    throw new IllegalArgumentException(
        "TaskFragmentOrganizer has not been registered. Organizer=" + iTaskFragmentOrganizer);
  }
  ...
  public boolean isValidTransaction(WindowContainerTransaction windowContainerTransaction) {
    ...
    if (windowContainerTransaction.getTaskFragmentOrganizer() != null
        && isOrganizerRegistered(taskFragmentOrganizer)) {
      return true;
    }
    Slog.e(
        "TaskFragmentOrganizerController",
  ...
  public class PendingTaskFragmentEvent {
    ...
    public class Builder {
      ...
      public PendingTaskFragmentEvent build() {
        return new PendingTaskFragmentEvent(
            this.mEventType,
            this.mTaskFragmentOrg,
            this.mTaskFragment,
  ...
  public final PendingTaskFragmentEvent getLastPendingLifecycleEvent(TaskFragment taskFragment) {
    List list =
        (List)
            this.mPendingTaskFragmentEvents.get(taskFragment.getTaskFragmentOrganizer().asBinder());
    for (int size = list.size() - 1; size >= 0; size--) {
      PendingTaskFragmentEvent pendingTaskFragmentEvent = (PendingTaskFragmentEvent) list.get(size);
      if (taskFragment == pendingTaskFragmentEvent.mTaskFragment
          && pendingTaskFragmentEvent.isLifecycleEvent()) {
        return pendingTaskFragmentEvent;
      }
    }
    return null;
  ...
  public void dispatchPendingEvents() {
    if (this.mAtmService.mWindowManager.mWindowPlacerLocked.isLayoutDeferred()
        || this.mPendingTaskFragmentEvents.isEmpty()) {
      return;
    }
    ...
    for (int i = 0; i < size; i++) {
      dispatchPendingEvents(
          (TaskFragmentOrganizerState)
              this.mTaskFragmentOrganizerState.get(this.mPendingTaskFragmentEvents.keyAt(i)),
          (List) this.mPendingTaskFragmentEvents.valueAt(i));
    }
  }

  public final void dispatchPendingEvents(
      TaskFragmentOrganizerState taskFragmentOrganizerState, List list) {
      ...
      if (pendingTaskFragmentEvent.mEventType == 0 || pendingTaskFragmentEvent.mEventType == 2) {
        ...
        if (this.mTmpTaskSet.add(task)) {
          taskFragmentTransaction.addChange(
              prepareChange(
                  new PendingTaskFragmentEvent.Builder(3, taskFragmentOrganizerState.mOrganizer)
                      .setTask(task)
                      .build()));
        }
      }
  ...
  public final boolean shouldDeferPendingEvents(
      TaskFragmentOrganizerState taskFragmentOrganizerState, List list) {
    Task task;
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (pendingTaskFragmentEvent.mEventType != 3
          && pendingTaskFragmentEvent.mEventType != 2
          && pendingTaskFragmentEvent.mEventType != 0) {
        return false;
      }
      if (pendingTaskFragmentEvent.mEventType == 3) {
      ...
      if ((task.lastActiveTime > pendingTaskFragmentEvent.mDeferTime
              && isTaskVisible(task, arrayList, arrayList2))
          || shouldSendEventWhenTaskInvisible(
              task, taskFragmentOrganizerState, pendingTaskFragmentEvent)) {
        return false;
      }
  ...
  public final boolean shouldSendEventWhenTaskInvisible(
      Task task,
      TaskFragmentOrganizerState taskFragmentOrganizerState,
      PendingTaskFragmentEvent pendingTaskFragmentEvent) {
    TaskFragmentParentInfo taskFragmentParentInfo =
        (TaskFragmentParentInfo)
            taskFragmentOrganizerState.mLastSentTaskFragmentParentInfos.get(task.mTaskId);
    ...
    TaskFragmentInfo taskFragmentInfo =
        (TaskFragmentInfo)
            taskFragmentOrganizerState.mLastSentTaskFragmentInfos.get(
                pendingTaskFragmentEvent.mTaskFragment);
    return taskFragmentInfo == null
        || taskFragmentInfo.isEmpty()
            != (pendingTaskFragmentEvent.mTaskFragment.getNonFinishingActivityCount() == 0);
  }
  ...
  public void dispatchPendingInfoChangedEvent(TaskFragment taskFragment) {
    ...
    taskFragmentTransaction.addChange(
        prepareChange(
            new PendingTaskFragmentEvent.Builder(3, taskFragmentOrganizer)
                .setTask(taskFragment.getTask())
                .build()));
    taskFragmentTransaction.addChange(prepareChange(pendingTaskFragmentEvent));
    validateAndGetState.dispatchTransaction(taskFragmentTransaction);
    ((List) this.mPendingTaskFragmentEvents.get(taskFragmentOrganizer.asBinder()))
        .remove(pendingTaskFragmentEvent);
  }
  ...
  public final TaskFragmentTransaction.Change prepareChange(
    ...
    if (i == 3) {
      return taskFragmentOrganizerState.prepareTaskFragmentParentInfoChanged(
          pendingTaskFragmentEvent.mTask);
    }
    if (i == 4) {
      return taskFragmentOrganizerState.prepareTaskFragmentError(
          pendingTaskFragmentEvent.mErrorCallbackToken,
          taskFragment,
          pendingTaskFragmentEvent.mOpType,
          pendingTaskFragmentEvent.mException);
    }
    if (i == 5) {
      return taskFragmentOrganizerState.prepareActivityReparentedToTask(
          pendingTaskFragmentEvent.mActivity);
    }
    throw new IllegalArgumentException(
        "Unknown TaskFragmentEvent=" + pendingTaskFragmentEvent.mEventType);
  }
