...
public class PinnedTaskController {
    ...
    public final void reloadResources() {
        ...
        this.mMaxAspectRatio = resources.getFloat(R.dimen.config_letterboxDefaultMinAspectRatioForUnresizableApps);
    }
    ...
    public void deferOrientationChangeForEnteringPipFromFullScreenIfNeeded() {
        ...
        this.mService.f1749mH.postDelayed(this.mDeferOrientationTimeoutRunnable, (int) (Math.max(1.0f, this.mService.getCurrentAnimatorScale()) * 1000.0f));
    }
