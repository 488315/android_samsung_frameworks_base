...
public abstract class WindowManagerInternal {
  ...
  public interface AccessibilityControllerInternal {
    ...
    void setUiChangesForAccessibilityCallbacks(
        UiChangesForAccessibilityCallbacks uiChangesForAccessibilityCallbacks);
  ...
  public abstract void registerKeyguardExitAnimationStartListener(
      KeyguardExitAnimationStartListener keyguardExitAnimationStartListener);
  ...
  public interface IDragDropCallback {
    ...
    default boolean prePerformDrag(
        IWindow iWindow,
        IBinder iBinder,
        int i,
        float f,
    ...
    default CompletableFuture registerInputChannel(
          ...
          .thenApply(
              new Function() { // from class:
                ...
                public final Object apply(Object obj) {
                  ...
                  lambda$registerInputChannel$0 =
                      WindowManagerInternal.IDragDropCallback.lambda$registerInputChannel$0(
                          InputManagerService.this, inputChannel, dragState, (Void) obj);
                  return lambda$registerInputChannel$0;
                }
              });
    }

    static /* synthetic */ Boolean lambda$registerInputChannel$0(
        InputManagerService inputManagerService,
        InputChannel inputChannel,
        DragState dragState,
        Void r3) {
      return Boolean.valueOf(
          inputManagerService.transferTouchFocus(inputChannel, dragState.getInputChannel(), true));
    }
  }
