...
public class WindowAnimationSpec implements LocalAnimationAdapter.AnimationSpec {
  ...
  public WindowAnimationSpec(
      Animation animation, Point point, Rect rect, boolean z, int i, boolean z2, float f) {
    ...
    this.mThreadLocalTmps =
        ThreadLocal.withInitial(
            new Supplier() { // from class:
                             // com.android.server.wm.WindowAnimationSpec$$ExternalSyntheticLambda0
      ...
      if (findTranslateAnimation.isXAxisTransition()
            ...
            SystemClock.uptimeMillis()
                ...
                + ((long)
                    (findTranslateAnimation.getDuration()
                        * findMiddleOfTranslationFraction(
        ...
        uptimeMillis =
            SystemClock.uptimeMillis()
                ...
                + ((long)
                    (findTranslateAnimation.getDuration()
                        * findAlmostThereFraction(findTranslateAnimation.getInterpolator())));
        j = 120;
      }
  ...
  public static float findInterpolationAdjustedTargetFraction(
      Interpolator interpolator, float f, float f2) {
    float f3 = 0.5f;
