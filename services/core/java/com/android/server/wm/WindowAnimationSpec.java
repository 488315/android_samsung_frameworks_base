    ...
    public long calculateStatusBarTransitionStartTime() {
        ...
        if (findTranslateAnimation != null) {
            if (findTranslateAnimation.isXAxisTransition() && findTranslateAnimation.isFullWidthTranslate()) {
                uptimeMillis = SystemClock.uptimeMillis() + findTranslateAnimation.getStartOffset() + ((long) (findTranslateAnimation.getDuration() * findMiddleOfTranslationFraction(findTranslateAnimation.getInterpolator())));
                j = 60;
            } else {
                uptimeMillis = SystemClock.uptimeMillis() + findTranslateAnimation.getStartOffset() + ((long) (findTranslateAnimation.getDuration() * findAlmostThereFraction(findTranslateAnimation.getInterpolator())));
                j = 120;
            }
