...
public class DisplayPolicy {
    ...
    public DisplayPolicy(WindowManagerService windowManagerService, DisplayContent displayContent) {
        ...
        this.mCarDockEnablesAccelerometer = resources.getBoolean(R.bool.config_battery_percentage_setting_available);
        this.mDeskDockEnablesAccelerometer = resources.getBoolean(R.bool.config_cecVolumeControlModeDisabled_allowed);
        this.mCanSystemBarsBeShownByUser = !resources.getBoolean(R.bool.config_remoteInsetsControllerControlsSystemBars) || resources.getBoolean(R.bool.config_navBarTapThrough);
        ...
        if (!ViewRootImpl.CLIENT_TRANSIENT) {
            this.mSystemGestures = new SystemGesturesPointerEventListener(this.mUiContext, policyHandler, new C29051());
        ...
        if (displayContent.isDefaultDisplay) {
            ...
            this.mHasNavigationBar = createDisplayContext.getResources().getBoolean(R.bool.config_predictShowStartingSurface);
        } else {
    ...
    public final TwoFingerSwipeGestureDetector.GestureListener createGestureListener(final TwoFingerSwipeGestureDetector twoFingerSwipeGestureDetector) {
            ...
            public void onDetecting() {
                synchronized (DisplayPolicy.this.mLock) {
                    if (!DisplayPolicy.this.mDisplayContent.mAtmService.mMultiTaskingController.isFullToSplitEnabled()) {
                        ...
                        twoFingerSwipeGestureDetector.init(DisplayPolicy.this.mDisplayContent.getBounds(), DisplayPolicy.this.mDisplayContent.mBaseDisplayDensity / 160, 13);
                    }
                }
            }
    ...
    */
    public void adjustWindowParamsLw(WindowState windowState, WindowManager.LayoutParams layoutParams) {
        ...
        if (i != 1) {
            ...
            if (layoutParams.isFullscreen() && (activityRecord = windowState.mActivityRecord) != null && activityRecord.fillsParent() && (windowState.mAttrs.privateFlags & 32768) != 0 && layoutParams.getFitInsetsTypes() != 0) {
            ...
            if (windowState.isPopOver()) {
                ...
                this.mDisplayContent.mPopOverController.updatePopOverDimAttributesLw(windowState, layoutParams);
        ...
        insetsFlags.appearance = this.mExt.getForceLightNavigationBar(layoutParams) | insetsFlags.appearance;
    }
                                    ...
                                    switch (i3) {
                                        case 2621:
                                            if (!isDexStandAloneMode()) {
                                                Slog.w(StartingSurfaceController.TAG, "validateAddingWindowLw: failed, TYPE_STATUS_BAR_STANDALONE");
                                                break;
                                            }
                                            break;
                                        case 2622:
                                            if (!isDexStandAloneMode()) {
                                                Slog.w(StartingSurfaceController.TAG, "validateAddingWindowLw: failed, TYPE_NOTIFICATION_SHADE_STANDALONE");
                                                break;
                                            }
                                            break;
                                        case 2623:
                                            if (!isDexStandAloneMode()) {
                                                Slog.w(StartingSurfaceController.TAG, "validateAddingWindowLw: failed, TYPE_NAVIGATION_BAR_STANDALONE");
                                                break;
                                            }
                                            break;
                                    }
    ...
    */
            ...
            if (i != 2019) {
                if (i != 2040) {
                    ...
                    if (insetsFrameProviderArr != null) {
                        ...
                        if (windowState.mAttrs.type == 2024 && windowState.getControllableInsetProvider() != null && windowState.getControllableInsetProvider().getSource().getType() == WindowInsets.Type.navigationBars()) {
    ...
    public void onConfigurationChanged() {
        ...
        if (this.mDisplayContent.isDefaultDisplay) {
            this.mHasNavigationBar = currentUserResources.getBoolean(R.bool.config_predictShowStartingSurface);
        }
        ...
        this.mNavBarOpacityMode = currentUserResources.getInteger(R.integer.config_notificationsBatteryLedOff);
        ...
        this.mNavigationBarAlwaysShowOnSideGesture = currentUserResources.getBoolean(R.bool.config_letterboxIsDisplayRotationImmersiveAppCompatPolicyEnabled);
    ...
    public void updateConfigurationAndScreenSizeDependentBehaviors() {
        Resources currentUserResources = getCurrentUserResources();
        DisplayContent displayContent = this.mDisplayContent;
        this.mNavigationBarCanMove = displayContent.mBaseDisplayWidth != displayContent.mBaseDisplayHeight && currentUserResources.getBoolean(R.bool.config_letterboxIsEducationEnabled);
    ...
    */
    public void updateSystemBarAttributes() {
        ...
        if (shouldKeepSystemUiControllingWindow()) {
            if (CoreRune.SAFE_DEBUG) {
                Slog.d(StartingSurfaceController.TAG, "updateSystemBarAttributes: keep " + this.mSystemUiControllingWindow);
                return;
            }
            return;
        }
        ...
        if (this.mRelaunchingSystemBarColorApps.isEmpty()) {
            ...
            boolean z4 = chooseNavigationColorWindowLw != null && chooseNavigationColorWindowLw == this.mDisplayContent.mInputMethodWindow;
            boolean canBeNavColorWinLw = this.mExt.canBeNavColorWinLw(windowState2, chooseNavigationColorWindowLw);
            int i4 = windowState2.mAttrs.insetsFlags.appearance;
            if (windowState2.inMultiWindowMode() && (i4 & 4) != 0) {
                i4 &= -5;
            }
            if (CoreRune.MW_EMBED_ACTIVITY_SYSTEM_BAR_POLICY && z4 && (windowState = this.mNavBarBackgroundWindow) != null && windowState.isSplitEmbedded() && (updateSystemBarsLw & 256) != 0) {
                updateSystemBarsLw &= -257;
            }
            final int updateLightNavigationBarLw = updateLightNavigationBarLw(i4, canBeNavColorWinLw ? windowState2 : chooseNavigationColorWindowLw) | updateSystemBarsLw;
            ...
            boolean z5 = (windowState2.isRequestedVisible(WindowInsets.Type.statusBars()) && windowState2.isRequestedVisible(WindowInsets.Type.navigationBars(), true)) ? false : true;
            if (isInImmersiveSplitMode) {
                inSplitScreenWindowingMode = windowState2.getWindowType() == 2226 || windowState2.getWindowType() == 2040;
            } else {
                inSplitScreenWindowingMode = windowState2.inSplitScreenWindowingMode();
            }
            boolean z6 = (inSplitScreenWindowingMode || windowState2.isRequestedVisible(WindowInsets.Type.statusBars()) || windowState2.isRequestedVisible(WindowInsets.Type.navigationBars())) ? false : true;
            ...
            final int naturalBarTypeByDisplayId = StatusBarManager.getNaturalBarTypeByDisplayId(this.mContext, displayId);
            if (this.mLastDisableFlags != disableFlags) {
                ...
                callStatusBarSafely(new Consumer() { // from class: com.android.server.wm.DisplayPolicy$$ExternalSyntheticLambda0
                    ...
                    public final void accept(Object obj) {
                        ((StatusBarManagerInternal) obj).setDisableFlagsToType(displayId, disableFlags, windowState4, naturalBarTypeByDisplayId);
                    }
                });
            } else {
                str = StartingSurfaceController.TAG;
            ...
            if (this.mLastAppearance == updateLightNavigationBarLw && this.mLastBehavior == i5 && this.mLastRequestedVisibleTypes == requestedVisibleTypes && Objects.equals(this.mFocusedApp, str2) && this.mLastFocusIsFullscreen == z5 && this.mLastFocusIsFullscreenAll == z6 && Arrays.equals(this.mLastStatusBarAppearanceRegions, appearanceRegionArr) && Arrays.equals(this.mLastLetterboxDetails, letterboxDetailsArr)) {
                return;
            }
            if (this.mDisplayContent.isDefaultDisplay && (this.mLastFocusIsFullscreen != z5 || ((this.mLastAppearance ^ updateLightNavigationBarLw) & 4) != 0)) {
                this.mService.mInputManager.setSystemUiLightsOut(z5 || (updateLightNavigationBarLw & 4) != 0);
            } else if (getDisplayId() == 2 && (this.mLastFocusIsFullscreen != z5 || ((this.mLastAppearance ^ updateLightNavigationBarLw) & 4) != 0)) {
                ...
                callStatusBarSafely(new Consumer() { // from class: com.android.server.wm.DisplayPolicy$$ExternalSyntheticLambda1
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        ((StatusBarManagerInternal) obj).onSystemBarAttributesChanged(displayId, updateLightNavigationBarLw, appearanceRegionArr, z7, i6, requestedVisibleTypes, str2, letterboxDetailsArr);
                    }
                });
                if (CoreRune.CARLIFE_NAVBAR && this.mDisplayContent.isCarLifeDisplay() && this.mLastFocusIsFullscreenAll != z3) {
                    final boolean z8 = z4;
                    callStatusBarSafely(new Consumer() { // from class: com.android.server.wm.DisplayPolicy$$ExternalSyntheticLambda2
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            ((StatusBarManagerInternal) obj).onSystemBarAttributesChangedToType(displayId, updateLightNavigationBarLw, appearanceRegionArr, z8, i2, requestedVisibleTypes, str2, letterboxDetailsArr, 2);
                        }
                    });
                }
                if (this.mLastFocusIsFullscreenAll == z3) {
                    ...
                    callCocktailBarSafely(new Consumer() { // from class: com.android.server.wm.DisplayPolicy$$ExternalSyntheticLambda3
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            DisplayPolicy.lambda$updateSystemBarAttributes$9(displayId, i3, appearanceRegionArr, z3, (CocktailBarManagerInternal) obj);
                        }
                    });
                } else {
                    i3 = updateLightNavigationBarLw;
                }
                Slog.d(str, "updateSystemBarAttributes: displayId=" + displayId + ", win=" + windowState2 + ", navColorWin=" + chooseNavigationColorWindowLw + ", focusedCanBeNavColorWin=" + canBeNavColorWinLw + ", behavior=" + i2 + ", appearance=" + i3 + ", statusBarAppearanceRegions=" + this.mStatusBarAppearanceRegionList + ", requestedVisibilities=" + requestedVisibleTypes + ", from=" + Debug.getCallers(3));
            }
            z = z6;
            this.mLastAppearance = updateLightNavigationBarLw;
            this.mLastBehavior = i5;
            ...
            callStatusBarSafely(new Consumer() { // from class: com.android.server.wm.DisplayPolicy$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    ((StatusBarManagerInternal) obj).onSystemBarAttributesChanged(displayId, updateLightNavigationBarLw, appearanceRegionArr, z72, i62, requestedVisibleTypes, str2, letterboxDetailsArr);
                }
            });
            if (CoreRune.CARLIFE_NAVBAR) {
                ...
                callStatusBarSafely(new Consumer() { // from class: com.android.server.wm.DisplayPolicy$$ExternalSyntheticLambda2
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        ((StatusBarManagerInternal) obj).onSystemBarAttributesChangedToType(displayId, updateLightNavigationBarLw, appearanceRegionArr, z82, i2, requestedVisibleTypes, str2, letterboxDetailsArr, 2);
                    }
                });
            }
            if (this.mLastFocusIsFullscreenAll == z3) {
    ...
    */
    public final int configureNavBarOpacity(int i, boolean z, boolean z2, boolean z3) {
        ...
        boolean z4 = true;
        if (i2 == 2) {
            if (z2 && (this.mIsFreeformWindowOverlappingWithNavBar || this.mFreeformTaskSurfaceOverlappingWithNavBar)) {
            ...
            if (z || z2) {
                if (this.mIsFreeformWindowOverlappingWithNavBar || this.mFreeformTaskSurfaceOverlappingWithNavBar) {
                    clearNavBarOpaqueFlag = clearNavBarOpaqueFlag(i);
                    i = clearNavBarOpaqueFlag | 128;
                }
            } else if (drawsBarBackground) {
        ...
        if (!isFullyTransparentAllowed(this.mNavBarBackgroundWindow, WindowInsets.Type.navigationBars()) || z3) {
            i |= 64;
        }
        ...
        if (CoreRune.MW_EMBED_ACTIVITY_SYSTEM_BAR_POLICY && (windowState = this.mNavBarBackgroundWindow) != null && windowState.isSplitEmbedded()) {
            return clearNavBarOpaqueFlag(i) | 256;
        }
        if (z2 && drawsBarBackground) {
            WindowState windowState2 = this.mNavBarBackgroundWindow;
            if (windowState2 == null || windowState2.isRequestedVisible(WindowInsets.Type.navigationBars())) {
                return clearNavBarOpaqueFlag(i);
            }
            return 128;
        }
        if (this.mIsPipWindowOverlappingWithNavBar && this.mDisplayContent.getDefaultTaskDisplayArea().isRootTaskVisible(2)) {
            ...
            if (CoreRune.MW_SPLIT_TRANSPARENT_NAVIGATION_BAR) {
                ...
                if (windowState3 == null) {
                    ...
                    if (windowState3.inSplitScreenWindowingMode()) {
                        ...
                        boolean z5 = this.mNavBarBackgroundWindow.isRequestedVisible(WindowInsets.Type.navigationBars()) && (attrs.flags & Integer.MIN_VALUE) != 0;
        ...
        if (this.mNavigationBar != null) {
            ...
            if (this.mCurrentUserResources != null) {
                ...
                if (this.mDisplayContent.isDexMode()) {
                    ...
                    printWriter.println(this.mCurrentUserResources.getDimensionPixelSize(R.dimen.notification_custom_view_max_image_height_low_ram));
                }
            }
        }
