...
public final class PopOverController {
    ...
    public final void updatePopOverDimAttributesLw(
                                        ...
                                        alphaAnimation.setAnimationListener(
                                                new Animation
                                                        .AnimationListener() { // from class:
                                                                               // com.android.server.wm.PopOverController.1
                                                    @Override // android.view.animation.Animation.AnimationListener
                                                    public final void onAnimationEnd(
                                                            Animation animation) {
                                                        WindowManagerGlobalLock
                                                                windowManagerGlobalLock =
                                                                        PopOverController.this
                                                                                .mDisplayContent
                                                                                .mWmService
                                                                                .mGlobalLock;
        ...
        if (zArr[0]) {
            ...
            ((PhoneWindowManager) displayContent.mWmService.mPolicy)
                    .mExt.performHapticFeedback(
                            Process.myUid(),
                            0,
                            displayContent.mWmService.mContext.getOpPackageName(),
