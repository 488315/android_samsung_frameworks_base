...
public class PopOverState {
  ...
  public void setupOptions(ActivityOptions activityOptions, ActivityRecord activityRecord) {
    ...
    if (supportsPopOver(this.mActivityRecord.info)) {
      ...
      if (!activityOptions.mPopOverInheritOptions
          || activityRecord == null
          || activityRecord.getTask() == null
          || activityRecord.getTask().mTaskId == -1
          || (activityOptions2 = activityRecord.mPopOverState.mOptions) == null
          || !activityOptions2.mPopOverInheritOptions) {
        return;
      }
  ...
  public void adjustOptions(int[] iArr, int[] iArr2, Point[] pointArr, int[] iArr3) {
    ...
    activityRecord.mAtmService.mChangeTransitController.handlePopOverChangeTransitionRequest(
        activityRecord, bounds);
  }
  ...
  public boolean isInLargeSizeTask() {
    return this.mActivityRecord.getTask() != null
        && this.mActivityRecord.getTask().getConfiguration().smallestScreenWidthDp >= 600;
  }

  public final void activate() {
    if (this.mIsActivated
        || this.mOptions == null
        || this.mActivityRecord.getTask() == null
        || this.mActivityRecord.getTask().mTaskId != this.mOriginTaskId
    ...
    if (!this.mActivityRecord.getDisplayContent().mWaitingForConfig
        && this.mActivityRecord.isVisible()
        && this.mActivityRecord.getTask().shouldBeVisible(null)) {
      if (this.mActivityRecord.getTask().inSplitScreenWindowingMode()) {
        this.mActivityRecord.getParent().getParent().asTask().mPendingEnsureVisibleForPopOver =
            true;
  ...
  public final void inactivate() {
    if (this.mIsActivated) {
      ...
      this.mActivityRecord.forAllWindows(
          new Consumer() { // from class:
                           // com.android.server.wm.PopOverState$$ExternalSyntheticLambda2
            ...
            || this.mActivityRecord
                    ...
                    .getActivity(
                        new Predicate() { // from class:
                                          // com.android.server.wm.PopOverState$$ExternalSyntheticLambda0
                          @Override // java.util.function.Predicate
                          public final boolean test(Object obj) {
                            boolean lambda$isAboveAnotherOpaquePopOver$1;
                            lambda$isAboveAnotherOpaquePopOver$1 =
                                PopOverState.this.lambda$isAboveAnotherOpaquePopOver$1(
                                    (ActivityRecord) obj);
  ...
  public /* synthetic */ boolean lambda$isAboveAnotherOpaquePopOver$1(
  ...
  public boolean isBelowAnotherOpaquePopOver() {
    ...
    return (this.mActivityRecord.getTask() == null
            || this.mActivityRecord
                    ...
                    .getActivity(
                        new Predicate() { // from class:
                                          // com.android.server.wm.PopOverState$$ExternalSyntheticLambda1
                          @Override // java.util.function.Predicate
                          public final boolean test(Object obj) {
                            boolean lambda$isBelowAnotherOpaquePopOver$2;
                            lambda$isBelowAnotherOpaquePopOver$2 =
                                PopOverState.lambda$isBelowAnotherOpaquePopOver$2(
                                    bounds, (ActivityRecord) obj);
  ...
  public static /* synthetic */ boolean lambda$isBelowAnotherOpaquePopOver$2(
      Rect rect, ActivityRecord activityRecord) {
    return activityRecord.mPopOverState.isActivated()
        && !activityRecord.finishing
        && activityRecord.getBounds().contains(rect)
        && activityRecord.mPopOverState.mLastOccludesParent;
  }
  ...
  public final void updateOccludeTargetIfNeeded() {
    if (this.mLastOccludesParent) {
      ...
      TransitionController transitionController =
          activityRecord.mDisplayContent.mTransitionController;
      activityRecord.mWmService.mExt.updateOccludeTargetIfNeeded(
  ...
  public void dump(PrintWriter printWriter, String str) {
    ...
    printWriter.println(
        str
            + " size=land("
            + this.mOptions.mPopOverWidthDp[0]
            + ","
            + this.mOptions.mPopOverHeightDp[0]
            + ")/port("
            + this.mOptions.mPopOverWidthDp[1]
            + ","
            + this.mOptions.mPopOverHeightDp[1]
            + ")");
    ...
    printWriter.println(
        str
            + " position=land(0x"
            + Integer.toHexString(this.mOptions.mPopOverAnchorPosition[0])
            + ")/port(0x"
            + Integer.toHexString(this.mOptions.mPopOverAnchorPosition[1])
            + ")");
    if (this.mIsActivated) {
      printWriter.println(
          str
              + " inherit="
              + this.mOptions.mPopOverInheritOptions
              + ", mLastOccludesParent="
              + this.mLastOccludesParent
              + ", isBelowAnotherOpaquePopOver="
              + isBelowAnotherOpaquePopOver()
              + ", isAboveAnotherOpaquePopOver="
              + isAboveAnotherOpaquePopOver());
    }
  }
  ...
  public static boolean supportsPopOver(ActivityInfo activityInfo) {
    ...
    return activityInfo.applicationInfo.metaData.getBoolean(
        "com.samsung.android.supports_pop_over", true);
  }
}
