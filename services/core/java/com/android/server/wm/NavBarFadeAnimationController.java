...
public class NavBarFadeAnimationController extends FadeAnimationController {
  ...
  public static final Interpolator FADE_OUT_INTERPOLATOR =
      new PathInterpolator(0.2f, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, 1.0f, 1.0f);
  ...
  @Override // com.android.server.wm.FadeAnimationController
  public FadeAnimationController.FadeAnimationAdapter createAdapter(
      LocalAnimationAdapter.AnimationSpec animationSpec, boolean z, WindowToken windowToken) {
  ...
  public void fadeOutAndInSequentially(
      long j, SurfaceControl surfaceControl, SurfaceControl surfaceControl2) {
