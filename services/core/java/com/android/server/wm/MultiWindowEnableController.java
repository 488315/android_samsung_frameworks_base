...
public class MultiWindowEnableController implements IController, CoreStateCallback {
  ...
  public void initialize() {
    this.f1744mH = new Handler(this.mAtm.f1734mH.getLooper());
      ...
      try {
        ...
        if (!rootTasks.isEmpty()) {
          ...
          transitionController.registerLegacyListener(
              new TransitionListener(rootTasks, transitionController));
        }
  ...
  public final void updateDeviceSupportsMultiWindow() {
    this.mDeviceSupportsMultiWindow =
        ActivityTaskManager.deviceSupportsMultiWindow(this.mAtm.mContext);
    ...
    synchronized (windowManagerGlobalLock) {
      ...
      try {
        if (supportsMultiWindow && z4) {
          ...
          activityTaskManagerService.mSupportsSplitScreenMultiWindow =
  ...
  public List getMWDisableRequestersLocked() {
    ArrayList arrayList =
        (ArrayList) this.mMWOffRequesters.get(this.mAtm.mWindowManager.mCurrentUserId);
  ...
  public final void setMultiWindowDynamicEnabled(
      final String str, final boolean z, final int i, boolean z2, boolean z3) {
    boolean z4 = false;
    ...
    this.mCoreStateController.setVolatileState(
        ...
        new Runnable() { // from class:
                         // com.android.server.wm.MultiWindowEnableController$$ExternalSyntheticLambda0
  ...
  public final boolean isInMultiWindowModeLocked(int i) {
    ...
    final int indexOf =
        defaultTaskDisplayArea.mChildren.indexOf(defaultTaskDisplayArea.getRootHomeTask());
    return (defaultTaskDisplayArea.getRootTask(
                new Predicate() { // from class:
                  ...
                  public final boolean test(Object obj) {
                    ...
                    lambda$isInMultiWindowModeLocked$1 =
                        MultiWindowEnableController.lambda$isInMultiWindowModeLocked$1(
                            TaskDisplayArea.this, indexOf, (Task) obj);
  ...
  public static /* synthetic */ boolean lambda$isInMultiWindowModeLocked$1(
      TaskDisplayArea taskDisplayArea, int i, Task task) {
    return task.inFreeformWindowingMode() && taskDisplayArea.mChildren.indexOf(task) > i;
  }

  /* renamed from: scheduleEnableChangedBroadcast, reason: merged with bridge method [inline-methods] */
  public final void lambda$setMultiWindowDynamicEnabled$0(
      final String str, final boolean z, final int i, final boolean z2) {
    this.f1744mH.post(
        new Runnable() { // from class:
                         // com.android.server.wm.MultiWindowEnableController$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* renamed from: sendEnableChangedBroadcast, reason: merged with bridge method [inline-methods] */
  public final void lambda$scheduleEnableChangedBroadcast$2(
      String str, boolean z, int i, boolean z2) {
    ...
    this.mAtm.mContext.sendBroadcastAsUser(
        intent, UserHandle.ALL, "com.samsung.android.permission.MULTI_WINDOW_MONITOR", -1);
  }
  ...
  public void initializeLocked(int i) {
    ...
    if (this.mDeviceSupportsMultiWindow) {
      setMultiWindowDynamicEnabled(
          "Initialize",
          isMultiWindowForceOnRequested(i) || !isMultiWindowOffRequested(i),
          i,
          false,
          false);
    }
  ...
  public final void dumpMWRequesterLocked(
  ...
  public final void dumpMWFeatureLocked(
  ...
  public final void dumpMWFeatureWithIntLocked(
      PrintWriter printWriter, ArrayList arrayList, String[] strArr) {
    try {
      printWriter.println(
          "    "
              + strArr[0]
              + " = "
              + MultiWindowCoreState.class.getField(strArr[0]).getInt(MultiWindowCoreState.class));
      if (arrayList.size() > 0) {
        dumpMWRequesterLocked(printWriter, arrayList, strArr[1] + " : ");
      }
    } catch (Throwable unused) {
  ...
  public void dumpLocked(PrintWriter printWriter, String str) {
    ...
    if (this.mMWOffRequestersLogForAllUsers.size() > 0) {
      dumpMWRequesterLocked(
          printWriter, this.mMWOffRequestersLogForAllUsers, "MWOffRequestersLogForAllUsers : ");
    }
    ...
    if (this.mMWForceOnRequestersForAllUsers.size() > 0) {
      dumpMWRequesterLocked(
          printWriter, this.mMWForceOnRequestersForAllUsers, "MWForceOnRequestersForAllUsers : ");
    }
    ...
    dumpMWFeatureWithIntLocked(
        printWriter,
        this.mCDRequestLogs,
        new String[] {"MW_MULTISTAR_CUSTOM_DENSITY_DYNAMIC_ENABLED", "mCDRequestLog"});
    dumpMWFeatureLocked(
        printWriter,
        this.mELSRequestLog,
    ...
    dumpMWFeatureLocked(
        ...
        new String[] {
          "MW_NAVISTAR_SPLIT_IMMERSIVE_MODE_ENABLED", "mNaviStarSplitImmersiveModeRequestLog"
        });
  ...
  public void setSplitImmersiveModeLocked(boolean z) {
    this.mSplitImmersiveModeRequestLog.add(
        "("
            + z
            + ", "
            + this.mSimpleDateFormat.format(Long.valueOf(System.currentTimeMillis()))
  ...
  public void setNaviStarImmersiveSplitModeLocked(boolean z) {
    this.mNaviStarSplitImmersiveModeRequestLog.add(
        "("
            + z
            + ", "
            + this.mSimpleDateFormat.format(Long.valueOf(System.currentTimeMillis()))
  ...
  public void setCornerGestureEnabled(boolean z) {
    this.mCornerGestureRequestLogs.add(
        "("
            + z
            + ", "
            + this.mSimpleDateFormat.format(Long.valueOf(System.currentTimeMillis()))
  ...
  public void setBlockedMinimizeFreeformEnabled(boolean z) {
    this.mMultiStarBlockedMinimizeRequestLog.add(
        "("
            + z
            + ", "
            + this.mSimpleDateFormat.format(Long.valueOf(System.currentTimeMillis()))
  ...
  public void setStayFocusAndTopResumedActivityEnabled(boolean z, boolean z2) {
    ...
    while (it.hasNext()) {
      ...
      this.mCoreStateController.setVolatileState(
          "stay_top_resumed_activity", Integer.valueOf(z2 ? 1 : 0), intValue, true, true, null);
    }
  }

  public void setCustomDensityEnabled(int i) {
    this.mCDRequestLogs.add(
        "("
            + i
            + ", "
            + this.mSimpleDateFormat.format(Long.valueOf(System.currentTimeMillis()))
    ...
    while (it.hasNext()) {
      this.mCoreStateController.setVolatileState(
          "custom_density", Integer.valueOf(i), ((Integer) it.next()).intValue(), true, true, null);
    }
  }

  public void setEnsureLaunchSplitEnabled(boolean z) {
    this.mELSRequestLog.add(
        "("
            + z
            + ", "
            + this.mSimpleDateFormat.format(Long.valueOf(System.currentTimeMillis()))
  ...
  public class TransitionListener extends WindowManagerInternal.AppTransitionListener {
    ...
    public final void handleExitAnimatingTasks(String str) {
      for (Task task : this.mExitAnimatingTasks) {
        ...
        Slog.d(
            MultiWindowEnableController.TAG,
