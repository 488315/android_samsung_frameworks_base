...
public class LockTaskController {
      ...
      if (activityRecord != task.getRootActivity() || activityRecord != topNonFinishingActivity) {
        ...
        if (taskFragment.asTask() == null
            && ((taskFragment.isDelayLastActivityRemoval()
                    || (CoreRune.MW_EMBED_ACTIVITY && taskFragment.isEmbedded()))
                && adjacentTaskFragment != null)) {
          if (taskFragment.getActivity(
                  new Predicate() { // from class:
                    ...
                    public final boolean test(Object obj) {
                      ...
                      lambda$activityBlockedFromFinish$0 =
                          LockTaskController.lambda$activityBlockedFromFinish$0(
          ...
          if (task.getActivity(
                  new Predicate() { // from class:
                    ...
                    public final boolean test(Object obj) {
                      ...
                      lambda$activityBlockedFromFinish$1 =
                          LockTaskController.lambda$activityBlockedFromFinish$1(
                              ActivityRecord.this, adjacentTaskFragment, (ActivityRecord) obj);
  ...
  public static /* synthetic */ boolean lambda$activityBlockedFromFinish$0(
  ...
  public static /* synthetic */ boolean lambda$activityBlockedFromFinish$1(
      ActivityRecord activityRecord, TaskFragment taskFragment, ActivityRecord activityRecord2) {
    return (activityRecord2.finishing
            || activityRecord2 == activityRecord
            || activityRecord2.getTaskFragment() == taskFragment)
        ? false
        : true;
  }
  ...
  public boolean isLockTaskModeViolation(Task task, boolean z) {
    if ((isTaskLocked(task) && !z)
        || !isLockTaskModeViolationInternal(task, task.mUserId, task.intent, task.mLockTaskAuth)) {
      return false;
    }
    showLockTaskToast();
    return true;
  ...
  public boolean isNewTaskLockTaskModeViolation(ActivityRecord activityRecord) {
    ...
    if (!isLockTaskModeViolationInternal(
        ...
        getLockTaskAuth(activityRecord, null))) {
      return false;
    }
    showLockTaskToast();
    return true;
  ...
  public final boolean isLockTaskModeViolationInternal(
      WindowContainer windowContainer, int i, Intent intent, int i2) {
    if (windowContainer.isActivityTypeRecents() && isRecentsAllowed(i)) {
      return false;
    }
    return ((isKeyguardAllowed(i) && isEmergencyCallIntent(intent))
            || windowContainer.isActivityTypeDream()
            || isWirelessEmergencyAlert(intent)
            || isTaskAuthAllowlisted(i2)
            || this.mLockTaskModeTasks.isEmpty())
        ? false
        : true;
  }
  ...
  public final boolean isWirelessEmergencyAlert(Intent intent) {
    ...
    return (intent == null
            || (defaultCellBroadcastAlertDialogComponent =
                    CellBroadcastUtils.getDefaultCellBroadcastAlertDialogComponent(this.mContext))
                == null
            || !defaultCellBroadcastAlertDialogComponent.equals(intent.getComponent()))
        ? false
        : true;
  }
  ...
  public final boolean isEmergencyCallIntent(Intent intent) {
    ...
    if (TelecomManager.EMERGENCY_DIALER_COMPONENT.equals(intent.getComponent())
        || "android.intent.action.CALL_EMERGENCY".equals(intent.getAction())) {
      return true;
    }
    TelecomManager telecomManager = getTelecomManager();
    String systemDialerPackage =
        telecomManager != null ? telecomManager.getSystemDialerPackage() : null;
    return (systemDialerPackage == null
            || intent.getComponent() == null
            || !systemDialerPackage.equals(intent.getComponent().getPackageName()))
        ? false
        : true;
  }
      ...
      if (this.mLockTaskModeTasks.isEmpty()) {
        if (ProtoLogCache.WM_DEBUG_LOCKTASK_enabled) {
          ProtoLogImpl.d(
              ...
              0,
              (String) null,
              new Object[] {String.valueOf(task), String.valueOf(Debug.getCallers(3))});
        }
        this.mHandler.post(
            new Runnable() { // from class:
                             // com.android.server.wm.LockTaskController$$ExternalSyntheticLambda5
  ...
  public void startLockTaskMode(Task task, boolean z, int i) {
    ...
    if (i2 == 0) {
      if (ProtoLogCache.WM_DEBUG_LOCKTASK_enabled) {
        ProtoLogImpl.w(
            ProtoLogGroup.WM_DEBUG_LOCKTASK, -1075136930, 0, (String) null, (Object[]) null);
        return;
      }
      return;
    }
    if (!z) {
      ...
      if (i2 == 1) {
        if (ProtoLogCache.WM_DEBUG_LOCKTASK_enabled) {
          ProtoLogImpl.w(
              ProtoLogGroup.WM_DEBUG_LOCKTASK, 1401295262, 0, (String) null, (Object[]) null);
        }
    ...
    if (ProtoLogCache.WM_DEBUG_LOCKTASK_enabled) {
      ProtoLogImpl.w(
          ...
          0,
          (String) null,
          new Object[] {z ? "Locking pinned" : "Locking fully"});
    }
  ...
  public final void setLockTaskMode(final Task task, final int i, String str, boolean z) {
    if (task.mLockTaskAuth == 0) {
      if (ProtoLogCache.WM_DEBUG_LOCKTASK_enabled) {
        ProtoLogImpl.w(
            ProtoLogGroup.WM_DEBUG_LOCKTASK, 950074526, 0, (String) null, (Object[]) null);
        return;
      }
      return;
    }
    ...
    if (this.mLockTaskModeTasks.isEmpty() && intent != null) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.wm.LockTaskController$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    if (ProtoLogCache.WM_DEBUG_LOCKTASK_enabled) {
      ProtoLogImpl.w(
          ...
          0,
          (String) null,
          new Object[] {String.valueOf(task), String.valueOf(Debug.getCallers(4))});
    }
    ...
    if (!z) {
      if (i != 0) {
        ...
        activityTaskSupervisor.handleNonResizableTaskIfNeeded(
            task,
            0,
            activityTaskSupervisor.mRootWindowContainer.getDefaultTaskDisplayArea(),
            task.getRootTask(),
            true);
        return;
      }
  ...
  public final void performStartLockTask(String str, int i, int i2) {
    ...
    try {
      boolean isInteractionControlEnabled =
          this.mWindowManager.mExt.mPolicyExt.isInteractionControlEnabled();
      this.mInteractionControlEnabled = isInteractionControlEnabled;
      if (i2 == 2
          && !isInteractionControlEnabled
          && (statusBarService = getStatusBarService()) != null) {
      ...
      if (this.mLockTaskModeState == 1 && task.mUserId == i && z3 && !z4) {
        if (ProtoLogCache.WM_DEBUG_LOCKTASK_enabled) {
          ProtoLogImpl.d(
              ...
              0,
              (String) null,
              new Object[] {String.valueOf(task), String.valueOf(task.lockTaskAuthToString())});
        }
        removeLockedTask(task);
        task.performClearTaskForReuse(false);
        z2 = true;
    ...
    if (this.mLockTaskModeTasks.isEmpty() && task2 != null && task2.mLockTaskAuth == 2) {
      if (ProtoLogCache.WM_DEBUG_LOCKTASK_enabled) {
        ProtoLogImpl.d(
            ...
            0,
            (String) null,
            new Object[] {String.valueOf(task2)});
      }
  ...
  public final void setKeyguardState(int i, int i2) {
    ...
    if (i == 1) {
      if (isKeyguardAllowed(i2)) {
        ...
        this.mWindowManager.dismissKeyguard(new C29401(i2), null);
        return;
      } else {
  ...
  public class C29401 extends IKeyguardDismissCallback.Stub {
    ...
    public void onDismissSucceeded() {
      ...
      handler.post(
          new Runnable() { // from class:
                           // com.android.server.wm.LockTaskController$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              LockTaskController.C29401.this.lambda$onDismissSucceeded$0(i);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onDismissSucceeded$0(int i) {
      if (LockTaskController.this.mPendingDisableFromDismiss == i) {
        ...
        lockTaskController.mWindowManager.disableKeyguard(
            lockTaskController.mToken, "Lock-to-App", i);
  ...
  public final boolean shouldLockKeyguard(int i) {
    try {
      if (Settings.Secure.getIntForUser(
              this.mContext.getContentResolver(), "lock_to_app_exit_locked", -2)
          != 0) {
        if (Settings.System.getInt(this.mContext.getContentResolver(), "lock_to_app_enabled", 0)
            != 0) {
          return true;
        }
      }
      ...
      if (Settings.System.getInt(this.mContext.getContentResolver(), "access_control_use", 0)
          != 0) {
        return Settings.System.getInt(
                this.mContext.getContentResolver(), "interaction_control_exit_locked", 0)
            != 0;
      }
  ...
  public final IDevicePolicyManager getDevicePolicyManager() {
    if (this.mDevicePolicyManager == null) {
      IDevicePolicyManager asInterface =
          IDevicePolicyManager.Stub.asInterface(ServiceManager.checkService("device_policy"));
  ...
  public void dump(PrintWriter printWriter, String str) {
    ...
    for (int i2 = 0; i2 < this.mLockTaskPackages.size(); i2++) {
      printWriter.println(
          str2
              + "  u"
              + this.mLockTaskPackages.keyAt(i2)
              + XmlUtils.STRING_ARRAY_SEPARATOR
              + Arrays.toString((Object[]) this.mLockTaskPackages.valueAt(i2)));
    }
    printWriter.println();
  }
