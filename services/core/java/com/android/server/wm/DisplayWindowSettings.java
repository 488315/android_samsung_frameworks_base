...
public class DisplayWindowSettings {
  ...
  public DisplayWindowSettings(
      WindowManagerService windowManagerService, SettingsProvider settingsProvider) {
  ...
  public void setUserRotation(DisplayContent displayContent, int i, int i2) {
    ...
    SettingsProvider.SettingsEntry overrideSettings =
        this.mSettingsProvider.getOverrideSettings(displayInfo);
  ...
  public void setForcedSize(DisplayContent displayContent, int i, int i2) {
    ...
    if (displayContent.isDefaultDisplay) {
      ...
      Settings.Global.putString(
          this.mService.mContext.getContentResolver(), "display_size_forced", str);
    }
    DisplayInfo displayInfo = displayContent.getDisplayInfo();
    SettingsProvider.SettingsEntry overrideSettings =
        this.mSettingsProvider.getOverrideSettings(displayInfo);
  ...
  public void setForcedScalingMode(DisplayContent displayContent, int i) {
    if (displayContent.isDefaultDisplay) {
      Settings.Global.putInt(
          this.mService.mContext.getContentResolver(), "display_scaling_force", i);
    }
    DisplayInfo displayInfo = displayContent.getDisplayInfo();
    SettingsProvider.SettingsEntry overrideSettings =
        this.mSettingsProvider.getOverrideSettings(displayInfo);
  ...
  public final int getWindowingModeLocked(
      SettingsProvider.SettingsEntry settingsEntry, DisplayContent displayContent) {
    ...
    boolean z =
        (displayContent.isDefaultDisplay && displayContent.isDexMode())
            || displayContent.getDisplayId() == 2
            || (CoreRune.MT_NEW_DEX_DISPLAY_MANAGEMENT
                && displayContent.getDisplayId()
                    == this.mService.mAtmService.mNewDexController.mPrimaryDesktopDisplayId);
    WindowManagerService windowManagerService = this.mService;
    return (windowManagerService.mAtmService.mSupportsFreeformWindowManagement
            && (windowManagerService.mIsPc || displayContent.forceDesktopMode() || z))
        ? 5
        : 1;
  }

  public int getWindowingModeLocked(DisplayContent displayContent) {
    return getWindowingModeLocked(
        this.mSettingsProvider.getSettings(displayContent.getDisplayInfo()), displayContent);
  }
  ...
  public boolean shouldShowWithInsecureKeyguardLocked(DisplayContent displayContent) {
    Boolean bool =
        this.mSettingsProvider.getSettings(displayContent.getDisplayInfo())
  ...
  public void setShouldShowWithInsecureKeyguardLocked(DisplayContent displayContent, boolean z) {
    if (!displayContent.isPrivate() && z) {
      throw new IllegalArgumentException(
          "Public display can't be allowed to show content when locked");
    }
    DisplayInfo displayInfo = displayContent.getDisplayInfo();
    SettingsProvider.SettingsEntry overrideSettings =
        this.mSettingsProvider.getOverrideSettings(displayInfo);
  ...
  public boolean shouldShowSystemDecorsLocked(DisplayContent displayContent) {
    ...
    Boolean bool =
        this.mSettingsProvider.getSettings(displayContent.getDisplayInfo()).mShouldShowSystemDecors;
    if (bool != null) {
      return bool.booleanValue();
    }
    return false;
  ...
  public int getImePolicyLocked(DisplayContent displayContent) {
    ...
    SettingsProvider.SettingsEntry settings =
        this.mSettingsProvider.getSettings(displayContent.getDisplayInfo());
  ...
  public void applySettingsToDisplayLocked(DisplayContent displayContent, boolean z) {
    ...
    displayContent
        .getDisplayRotation()
        .restoreSettings(intValue, intValue2, num3 != null ? num3.intValue() : 0);
    ...
    displayContent.mDontMoveToTop =
        !displayContent.canStealTopFocus() || (bool2 != null ? bool2.booleanValue() : false);
    if (z) {
  ...
  public boolean updateSettingsForDisplay(DisplayContent displayContent) {
    TaskDisplayArea defaultTaskDisplayArea = displayContent.getDefaultTaskDisplayArea();
    if (defaultTaskDisplayArea == null
        || defaultTaskDisplayArea.getWindowingMode() == getWindowingModeLocked(displayContent)) {
      return false;
    }
  ...
  public void clearForcedDensity(DisplayContent displayContent) {
    SettingsProvider.SettingsEntry overrideSettings =
        this.mSettingsProvider.getOverrideSettings(displayContent.getDisplayInfo());
    ...
    this.mService.mExt.mMultiResolutionController.updateDefaultDisplaySizeDensityChangedReason(
        "clearForcedDensity: OldDensity=" + str);
  }
  ...
  public interface SettingsProvider {
    ...
    public class SettingsEntry {
      ...
      public boolean setTo(SettingsEntry settingsEntry) {
        ...
        if (!Objects.equals(
            settingsEntry.mShouldShowWithInsecureKeyguard, this.mShouldShowWithInsecureKeyguard)) {
        ...
        if (!Objects.equals(
            settingsEntry.mIgnoreOrientationRequest, this.mIgnoreOrientationRequest)) {
      ...
      public boolean equals(Object obj) {
        ...
        return this.mWindowingMode == settingsEntry.mWindowingMode
            ...
            && Objects.equals(this.mUserRotationMode, settingsEntry.mUserRotationMode)
            && Objects.equals(this.mUserRotation, settingsEntry.mUserRotation)
            && Objects.equals(this.mForcedScalingMode, settingsEntry.mForcedScalingMode)
            && Objects.equals(
                this.mShouldShowWithInsecureKeyguard, settingsEntry.mShouldShowWithInsecureKeyguard)
            && Objects.equals(this.mShouldShowSystemDecors, settingsEntry.mShouldShowSystemDecors)
            && Objects.equals(this.mImePolicy, settingsEntry.mImePolicy)
            && Objects.equals(this.mFixedToUserRotation, settingsEntry.mFixedToUserRotation)
            && Objects.equals(
                this.mIgnoreOrientationRequest, settingsEntry.mIgnoreOrientationRequest)
            && Objects.equals(this.mIgnoreDisplayCutout, settingsEntry.mIgnoreDisplayCutout)
            && Objects.equals(this.mDontMoveToTop, settingsEntry.mDontMoveToTop);
      }
