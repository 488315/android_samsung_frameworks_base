...
public class PointerEventDispatcher extends InputEventReceiver {
      ...
      if ((inputEvent instanceof MotionEvent) && (inputEvent.getSource() & 2) != 0) {
        ...
        synchronized (this.mListeners) {
          if (this.mListenersArray == null) {
            WindowManagerPolicyConstants.PointerEventListener[] pointerEventListenerArr2 =
                new WindowManagerPolicyConstants.PointerEventListener[this.mListeners.size()];
  ...
  public void registerInputEventListener(
    ...
    synchronized (this.mListeners) {
      if (this.mListeners.contains(pointerEventListener)) {
        throw new IllegalStateException(
            "registerInputEventListener: trying to register" + pointerEventListener + " twice.");
      }
  ...
  public void unregisterInputEventListener(
    ...
    synchronized (this.mListeners) {
      if (!this.mListeners.contains(pointerEventListener)) {
        throw new IllegalStateException(
            "registerInputEventListener: " + pointerEventListener + " not registered.");
      }
