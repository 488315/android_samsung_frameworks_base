...
public class MultiTaskingTaskLaunchParamsModifier implements LaunchParamsController.LaunchParamsModifier {
    ...
    */
    public final int calculate(Task task, ActivityInfo.WindowLayout windowLayout, ActivityRecord activityRecord, ActivityRecord activityRecord2, ActivityOptions activityOptions, ActivityStarter.Request request, int i, LaunchParamsController.LaunchParams launchParams, LaunchParamsController.LaunchParams launchParams2) {
        ...
        appendLog("display-id=" + displayContent2.getDisplayId() + " task-display-area-windowing-mode=" + preferredLaunchTaskDisplayArea.getWindowingMode() + " suggested-display-area=" + preferredLaunchTaskDisplayArea);
        if (activityRecord != null && (intent = activityRecord.intent) != null && (launchOverTargetTaskId = intent.getLaunchOverTargetTaskId()) != -1) {
            if (launchOverTargetTaskId == -10000 && preferredLaunchTaskDisplayArea.getFocusedRootTask() != null) {
                anyTaskForId = preferredLaunchTaskDisplayArea.getFocusedRootTask().getTopMostTask();
            } else {
                anyTaskForId = this.mSupervisor.mRootWindowContainer.anyTaskForId(launchOverTargetTaskId, 0);
            }
            TaskDisplayArea displayArea = anyTaskForId != null ? anyTaskForId.getDisplayArea() : null;
            if (displayArea != null && (displayArea.getDisplayId() != 2 || this.mSupervisor.mService.mDexController.getDexModeLocked() == 2)) {
                launchParams2.mPreferredTaskDisplayArea = displayArea;
                appendLog("tda-from-lott=" + displayArea + " dc=" + displayArea.getDisplayContent() + " display-windowing-mode=" + displayArea.getWindowingMode());
            }
        }
        if (i20 == 0) {
            return 2;
        ...
        if (displayContent2.isDesktopModeEnabled()) {
            this.mDefaultFreeformStepHorizontal = Math.round(resources.getDimension(R.dimen.dialog_fixed_height_minor));
            this.mDefaultFreeformStepVertical = Math.round(resources.getDimension(R.dimen.dialog_fixed_height_major));
        } else {
            this.mDefaultFreeformStepHorizontal = Math.round(resources.getDimension(R.dimen.timepicker_ampm_label_size));
            this.mDefaultFreeformStepVertical = Math.round(resources.getDimension(R.dimen.timepicker_ampm_horizontal_padding));
        }
        ...
        if (launchWindowingMode == 0 && canInheritWindowingModeFromSource(displayContent2, preferredLaunchTaskDisplayArea, activityRecord2, task)) {
            if (activityRecord2.getTask().inPinnedWindowingMode() && !activityRecord2.inPinnedWindowingMode()) {
                launchWindowingMode = activityRecord2.getWindowingMode();
            } else {
                launchWindowingMode = activityRecord2.getTask().getWindowingMode();
            }
            appendLog("inherit-from-source=" + WindowConfiguration.windowingModeToString(launchWindowingMode));
        }
        if (launchWindowingMode == 0 && task != null && task.getTaskDisplayArea() == preferredLaunchTaskDisplayArea && !task.getRootTask().mReparentLeafTaskIfRelaunch && (!task.inFreeformWindowingMode() || preferredLaunchTaskDisplayArea.getDisplayId() != 0)) {
            launchWindowingMode = task.getWindowingMode();
            appendLog("inherit-from-task=" + WindowConfiguration.windowingModeToString(launchWindowingMode));
        }
        int i21 = launchWindowingMode;
        boolean canApplyDexPolicy = canApplyDexPolicy(displayContent2, i21);
        boolean canCalculateBoundsForFullscreenTask = canCalculateBoundsForFullscreenTask(preferredLaunchTaskDisplayArea, i21);
        boolean canApplyFreeformWindowPolicy = canApplyFreeformWindowPolicy(preferredLaunchTaskDisplayArea, i21, activityRecord8, activityOptions, activityRecord2);
        boolean z10 = windowLayout != null && (canApplyFreeformWindowPolicy || canCalculateBoundsForFullscreenTask);
        if (this.mSupervisor.canUseActivityOptionsLaunchBounds(activityOptions)) {
            i2 = i21;
            if (canApplyFreeformWindowPolicy || canApplyPipWindowPolicy(i2) || canCalculateBoundsForFullscreenTask) {
                z = true;
                if (z) {
                    ...
                    if (canApplyDexPolicy) {
                        ...
                        if (canApplyFreeformWindowPolicy) {
                            ...
                            i7 = 0;
                            if (canApplyDexPersistentBounds(displayContent, launchParams3) && getPersistentDexBounds(dexModeLocked, displayContent.getDisplayId(), launchParams3, this.mTmpBounds)) {
                                if (!this.mTmpBounds.isEmpty()) {
                                    adjustBoundsToFitInDisplayArea(preferredLaunchTaskDisplayArea, this.mTmpLayout, this.mTmpBounds);
                                    i6 = 1;
                                } else {
                                    i6 = 1;
                                ...
                                i6 = 1;
                                if (CoreRune.MT_NEW_DEX_PERSIST_BOUNDS && canApplyNewDexPersistentBounds(displayContent, launchParams3) && getPersistentNewDexBounds(dexModeLocked, launchParams3, this.mTmpBounds)) {
                                    if (!this.mTmpBounds.isEmpty()) {
                                        adjustBoundsToFitInDisplayArea(preferredLaunchTaskDisplayArea, this.mTmpLayout, this.mTmpBounds);
                                    } else {
                                    ...
                                    if (task == null || !task.mTakeInitBounds) {
                                        ...
                                        if (getDexMetaDataBounds(preferredLaunchTaskDisplayArea, task, activityRecord4, this.mTmpBounds)) {
                                    ...
                                    if (windowLayout != null && windowLayout.hasSpecifiedSize()) {
                                        getLayoutBounds(preferredLaunchTaskDisplayArea, activityRecord4, recalculateLayout(preferredLaunchTaskDisplayArea, windowLayout, activityRecord), this.mTmpBounds);
                                        appendLog("dex-layout-bounds=" + this.mTmpBounds);
                                        if (this.mTmpBounds.isEmpty()) {
                                            getInitialDexBounds(preferredLaunchTaskDisplayArea, activityRecord4, this.mTmpBounds);
                        ...
                        if (z10) {
                        ...
                        } else if (i2 == 6 && activityOptions != null && activityOptions.getLaunchBounds() != null) {
                            ...
                            i5 = 1;
                            z4 = false;
                        } else if (canApplyFreeformWindowPolicy && canApplyFreeformPersistentBounds(displayContent, launchParams3)) {
                            adjustPersistFreeformBounds(task, displayContent, launchParams3, launchParams2.mBounds);
                    ...
                    i3 = (displayContent2.isDexMode() && activityOptions.getLaunchBounds() != null && activityOptions.getLaunchBounds().isEmpty()) ? 1 : (i2 == 2 && !(i2 == 0 && canApplyFreeformWindowPolicy)) ? i2 : 5;
                ...
                if (task == null && task.isDesktopModeEnabled() && i3 == 1) {
                    ...
                    updateSnappingBounds(preferredLaunchTaskDisplayArea, task, activityRecord5, launchParams, windowLayout, this.mSnappingBounds);
                ...
                if (launchParams.isEmpty() && !z2 && ((taskDisplayArea5 = launchParams4.mPreferredTaskDisplayArea) == null || taskDisplayArea5.getDisplayId() == displayContent.getDisplayId())) {
                    ...
                    if (launchParams4.mBounds.isEmpty() || launchParams4.mOrientation != displayContent.getConfiguration().orientation) {
                        i9 = i18;
                        z5 = z8;
                    } else {
                ...
                if (displayContent.getConfiguration().dexMode == 1 || activityRecord5.isResizeable()) {
                    if (taskDisplayArea.inFreeformWindowingMode()) {
                    ...
                    } else if (CoreRune.MT_DEX_SIZE_COMPAT_MODE && interceptCalculateIfDexSizeCompatMode(activityRecord5, taskDisplayArea, launchParams2, task, activityRecord, activityOptions)) {
                        if (!launchParams2.mBounds.isEmpty()) {
                            adjustBoundsToAvoidConflictInDisplayArea(taskDisplayArea, launchParams2.mBounds, null, null, task);
                        }
                        ...
                        if (shouldLaunchUnresizableAppInFreeform(activityRecord9, taskDisplayArea6, activityOptions)) {
                            if (launchParams2.mBounds.isEmpty()) {
                                taskDisplayArea2 = taskDisplayArea6;
                                activityRecord6 = activityRecord9;
                                getTaskBounds(activityRecord9, taskDisplayArea6, windowLayout, 5, z2, launchParams2.mBounds);
                                z6 = true;
                            } else {
                                taskDisplayArea2 = taskDisplayArea6;
                                activityRecord6 = activityRecord9;
                            ...
                            i10 = 5;
                            if (i10 == 0 && (rootTask = activityRecord6.getRootTask()) != null && rootTask.inFreeformWindowingMode()) {
                                if (!taskDisplayArea2.isUnderHomeTask(rootTask) && !rootTask.isMinimized()) {
                                    i12 = displayContent.getWindowingMode();
                                    appendLog("notMinimizedFreeform-to-display-windowing-mode=" + WindowConfiguration.windowingModeToString(i12));
                                    i11 = 5;
                                ...
                                if (i12 != i11) {
                                    ...
                                    launchParams2.mWindowingMode = i12 == taskDisplayArea2.getWindowingMode() ? 0 : i12;
                                }
                                if (task == null && task.isDexCompatEnabled() && displayContent.isDexMode()) {
                                    ...
                                    this.mSupervisor.mService.mDexCompatController.getCompatBounds(task, this.mTmpBounds, activityRecord);
                                    if (this.mTmpBounds.isEmpty()) {
                                        windowLayout2 = windowLayout;
                                        i13 = 0;
                                    } else {
                                        if (i4 != 0 && !isEmpty && !task.isDexCompatUiFullscreen()) {
                                            ...
                                            if (task.isDexCompatUiFullscreen()) {
                                                ...
                                                windowLayout2 = windowLayout;
                                                i13 = i17;
                                                adjustBoundsToFitInDisplayArea(taskDisplayArea2, windowLayout2, this.mTmpBounds);
                                            }
                                        }
                                        i17 = 0;
                                        windowLayout2 = windowLayout;
                                    ...
                                    launchParams2.mBounds.set(this.mTmpBounds);
                                    appendLog("dex-compat-windowing-mode=" + WindowConfiguration.windowingModeToString(i28));
                                ...
                                if (activityOptions == null || (activityOptions.getLaunchTaskDisplayArea() == null && activityOptions.getLaunchTaskDisplayAreaFeatureId() == -1)) {
                                    ...
                                    final int resolveActivityType = this.mSupervisor.mRootWindowContainer.resolveActivityType(activityRecord10, activityOptions, task);
                                    displayContent.forAllTaskDisplayAreas(new Predicate() { // from class: com.android.server.wm.MultiTaskingTaskLaunchParamsModifier$$ExternalSyntheticLambda0
                                        @Override // java.util.function.Predicate
                                        public final boolean test(Object obj) {
                                            boolean lambda$calculate$0;
                                            lambda$calculate$0 = MultiTaskingTaskLaunchParamsModifier.this.lambda$calculate$0(windowingMode, resolveActivityType, (TaskDisplayArea) obj);
                                    ...
                                    if (taskDisplayArea7 != null && taskDisplayArea7 != taskDisplayArea2) {
                                        ...
                                        if (z3) {
                                            ...
                                            getLayoutBounds(this.mTmpDisplayArea, activityRecord10, windowLayout2, launchParams2.mBounds);
                                            ...
                                            i16 = windowingMode;
                                            getTaskBounds(activityRecord10, this.mTmpDisplayArea, windowLayout, i14, z2, launchParams2.mBounds);
                                            taskDisplayArea3 = this.mTmpDisplayArea;
                                            if (taskDisplayArea3 == null) {
                                                this.mTmpDisplayArea = null;
                                                appendLog("overridden-display-area=[" + WindowConfiguration.activityTypeToString(i15) + ", " + WindowConfiguration.windowingModeToString(i16) + ", " + taskDisplayArea3 + "]");
                                ...
                                if (z5) {
                                    ...
                                    if (launchParams4.mPreferredTaskDisplayArea != taskDisplayArea4) {
                                        adjustBoundsToFitInDisplayArea(taskDisplayArea4, windowLayout2, launchParams2.mBounds);
                                    }
                                    adjustBoundsToAvoidConflictInDisplayArea(taskDisplayArea4, launchParams2.mBounds);
                                    return 2;
                                }
                                int i29 = i16;
                                if (taskDisplayArea4.getDisplayId() == 0 && activityOptions != null && activityOptions.isApplyBigFreeformSize() && launchParams2.mBounds.isEmpty()) {
                                ...
                                if (activityRecord2 != null && activityRecord2.inFreeformWindowingMode() && i29 == 5 && launchParams2.mBounds.isEmpty() && activityRecord2.getDisplayArea() == taskDisplayArea4 && !activityRecord2.mIsAliasActivity) {
                                    cascadeBounds(activityRecord2.getConfiguration().windowConfiguration.getBounds(), taskDisplayArea4, launchParams2.mBounds);
                                }
                                if (i5 != 0) {
                                    getTaskBounds(activityRecord7, taskDisplayArea4, windowLayout, i29, z7, launchParams2.mBounds, activityRecord2);
                                }
                                if (!displayContent.isDesktopModeEnabled() || i5 != 0 || z4) {
                                    return 2;
                                }
                                adjustBoundsToAvoidConflictInDisplayArea(taskDisplayArea2, launchParams2.mBounds, null, null, task);
                                return 2;
                            }
                            i11 = 5;
                            i12 = i10;
