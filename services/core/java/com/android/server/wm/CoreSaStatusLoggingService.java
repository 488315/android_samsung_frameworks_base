      ...
      if (sCoreSaStatusLoggers == null) {
        ...
        SafetySystemService.registerForSystemReady(
            new SafetySystemService
                .Callback() { // from class:
                              // com.android.server.wm.CoreSaStatusLoggingService$$ExternalSyntheticLambda0
  ...
  public static void schedule() {
    try {
      ...
      jobScheduler.schedule(
          new JobInfo.Builder(
                  415377471,
                  new ComponentName("android", CoreSaStatusLoggingService.class.getName()))
      ...
      try {
        try {
          ...
          while (it.hasNext()) {
            ...
            Slog.d(
                CoreSaStatusLoggingService.TAG,
                "Starting IdleLoggingJob run, logger=" + coreSaStatusLogger.getName());
