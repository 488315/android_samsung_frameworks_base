...
public class ActivityTaskManagerServiceExt {
  ...
  public final PackageFeatureManagerService mPackageFeatureManagerService =
  ...
  public void startAppLockService(IBinder iBinder, Intent intent, boolean z, String str) {
    ...
    if (zArr != null) {
      ...
      if (this.mService.mAppLockPolicy.isAppLockBypassList(
          ActivityRecord.forTokenLocked(iBinder).info.name)) {
        return;
      }
      ...
      if (z3 || z2 || this.mAppLockIsInMultiWindowMode || z5) {
        ...
        if (SemPersonaManager.isKnoxId(UserHandle.getUserId(callingUid))
            || this.mService.mAppLockPolicy.isManagedProfileUserId(
                UserHandle.getUserId(callingUid))) {
          return;
        }
        if ((SemDualAppManager.isDualAppId(UserHandle.getUserId(callingUid))
                && AppLockPolicy.isSupportSSecure())
            || z4) {
          return;
        }
      ...
      if (z3) {
        ...
        Slog.w(
            ...
            "AppLock checkAppLockState locked:"
                ...
                + str
                + " isInMultiWindowMode:"
                + this.mAppLockIsInMultiWindowMode
                + " showWhenLocked:"
                + z);
        if (!z4 || z) {
          ...
          Runnable runnable =
              new Runnable() { // from class:
                               // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                  ActivityTaskManagerServiceExt.this.lambda$checkAppLockState$0(
                      str, callingUid, z, intent);
                }
              };
          if (z2) {
            runnable.run();
          } else {
            this.mService.f1734mH.post(runnable);
          }
        }
      }
    } catch (Exception e) {
  ...
  public /* synthetic */ void lambda$checkAppLockState$0(
      String str, int i, boolean z, Intent intent) {
    ...
    try {
      ...
      Slog.e(
          "ActivityTaskManagerServiceExt", "AppLock service start failed for intent:" + intent2, e);
    }
  }
  ...
  public void startAppLockActivity(final ActivityRecord activityRecord) {
    ...
    boolean z =
        activityInfo == null
            || !this.mService.mAppLockPolicy.isActivityInExceptionList(activityInfo.name);
    if (!isAppLockedPackage || isAppLockedVerifying) {
      return;
    }
    if ((!activityRecord.isLaunchRequestedFromNotification() || activityRecord.getDisplayId() == 1)
        && z
        && activityRecord.isState(ActivityRecord.State.RESUMED)
        && !activityRecord.isNewDexMode()) {
          ...
          this.mService
              ...
              .forAllActivities(
                  new Consumer() { // from class:
                                   // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda0
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                      ActivityTaskManagerServiceExt.lambda$startAppLockActivity$1(
                          ActivityRecord.this, atomicBoolean2, (ActivityRecord) obj);
                    }
                  });
        }
      }
  ...
  public static /* synthetic */ void lambda$startAppLockActivity$1(
      ActivityRecord activityRecord, AtomicBoolean atomicBoolean, ActivityRecord activityRecord2) {
    if (activityRecord2.getTask().inMultiWindowMode()
        && activityRecord2.packageName.equals(activityRecord.packageName)
        && !activityRecord2.equals(activityRecord)) {
      atomicBoolean.set(true);
    }
  }
  ...
  public void setAppLockedUnLockPackage(String str) {
    ...
    if (!isSystemUid(callingUid)) {
      throw new SecurityException(
          callingUid + " cannot call setAppLockedUnLockPackage(" + str + ")");
    }
    AppLockPolicy appLockPolicy = this.mService.mAppLockPolicy;
    if (appLockPolicy != null) {
  ...
  public void setAppLockedVerifying(String str, boolean z) {
    ...
    if (!isSystemUid(callingUid) && !isCallerSetSelf(callingUid, str)) {
      throw new SecurityException(
          callingUid + " is not system uid or the packageNmae is not itself's");
    }
    AppLockPolicy appLockPolicy = this.mService.mAppLockPolicy;
    if (appLockPolicy != null) {
    ...
    try {
      try {
        ...
        return applicationInfo != null
            && UserHandle.getAppId(applicationInfo.uid) == UserHandle.getAppId(i);
      ...
      try {
        ...
        if (forTokenLocked == null) {
          throw new IllegalArgumentException(
              "AppLockLaunchingFromActivity: No activity record matching token=" + iBinder);
        }
  ...
  public ActivityTaskManagerServiceExt(
    ...
    this.PKG_SYSTEMUI = context.getString(R.string.config_systemUi);
    SafetySystemService.registerForSystemReady(
        new SafetySystemService
            .Callback() { // from class:
                          // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda1
  ...
  public boolean removeTaskWithFlagsLocked(int i, int i2) {
    ...
    try {
      return this.mService.mTaskSupervisor.removeTaskById(
          i,
          true,
          (i2 & 16) == 0,
          CoreRune.MW_FREEFORM_DISMISS_VIEW && (i2 & 128) != 0,
  ...
  public final void removeTaskByIdIfNeededLocked(Task task, int i) {
    if (task.mUserId != this.mService.mRootWindowContainer.mCurrentUser) {
      HashSet hashSet =
          new HashSet(
              Arrays.asList(
                  (Integer[])
                      Arrays.stream(this.mService.mAmInternal.getCurrentProfileIds())
                          .boxed()
                          .toArray(
                              new IntFunction() { // from class:
                                                  // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda3
                                @Override // java.util.function.IntFunction
                                public final Object apply(int i2) {
                                  Integer[] lambda$removeTaskByIdIfNeededLocked$3;
                                  lambda$removeTaskByIdIfNeededLocked$3 =
                                      ActivityTaskManagerServiceExt
                                          .lambda$removeTaskByIdIfNeededLocked$3(i2);
    ...
    this.mService.mTaskSupervisor.removeTaskById(
        task.mTaskId, true, (i & 16) == 0, "remove-task-by-id", Binder.getCallingUid());
  }
    ...
    if (activityRecord != null) {
      if (z) {
        if (this.mKeepAliveActivities.size() < 2) {
          ...
          Slog.w(
              "ActivityTaskManagerServiceExt",
              "Max count exceeded! Cannot set keepAlive for taskId=" + task.mTaskId);
          return;
        }
      }
  ...
  public boolean checkScreenDpSizeChanges(
      Configuration configuration, Configuration configuration2) {
    int i;
    int i2 = configuration2.screenWidthDp;
    return ((i2 == 0 || configuration.screenWidthDp == i2)
            && ((i = configuration2.screenHeightDp) == 0 || configuration.screenHeightDp == i))
        ? false
        : true;
  }
  ...
  public int getForegroundTaskId(int i) {
        ...
        || (activity =
                displayContent.getActivity(
                    new Predicate() { // from class:
                                      // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda6
                      @Override // java.util.function.Predicate
                      public final boolean test(Object obj) {
                        boolean isValidActivityForForeground;
                        isValidActivityForForeground =
                            ActivityTaskManagerServiceExt.isValidActivityForForeground(
                                (ActivityRecord) obj);
    ...
    if (DesktopModeFeature.DEBUG) {
      Log.i(
          "ActivityTaskManagerServiceExt",
          "getForegroundTaskId(), displayId=" + i + ", taskId=" + i2 + ", task=" + task);
    }
    return i2;
  }
  ...
  public void clearHomeStack(int i) {
    ...
    if (DesktopModeFeature.DEBUG) {
      Log.d(
          "ActivityTaskManagerServiceExt",
          "clearHomeStack(), displayId=" + i + ", defaultHomePkgName=" + defaultHomePackageName);
    }
    WindowManagerGlobalLock windowManagerGlobalLock = this.mService.mGlobalLock;
    WindowManagerService.boostPriorityForLockedSection();
    synchronized (windowManagerGlobalLock) {
        ...
        if (displayContent != null) {
          displayContent.forAllTasks(
              new Consumer() { // from class:
                ...
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  ActivityTaskManagerServiceExt.this.lambda$clearHomeStack$6(
                      defaultHomePackageName, (Task) obj);
                }
              },
              true);
        }
  ...
  public /* synthetic */ void lambda$clearHomeStack$6(String str, Task task) {
    if ((task.isActivityTypeHome() || task.isActivityTypeRecents()) && !task.isRootTask()) {
      ...
      if (componentName == null || !componentName.getPackageName().equals(str)) {
        ...
        this.mService.mTaskSupervisor.removeTask(
            task,
            task.isActivityTypeRecents(),
            true,
            "ActivityTaskManagerServiceExt#clearHomeStack");
      }
    }
  }
  ...
  public final String getDefaultHomePackageName() {
    List roleHoldersAsUser =
        ((RoleManager) this.mContext.getSystemService("role"))
            .getRoleHoldersAsUser("android.app.role.HOME", Process.myUserHandle());
  ...
  public boolean hasPackageTask(int i, final String str, final int i2) {
    ...
    return (displayContent == null
            || displayContent.getTask(
                    new Predicate() { // from class:
                                      // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda8
                      @Override // java.util.function.Predicate
                      public final boolean test(Object obj) {
                        boolean lambda$hasPackageTask$7;
                        lambda$hasPackageTask$7 =
                            ActivityTaskManagerServiceExt.lambda$hasPackageTask$7(
                                i2, str, (Task) obj);
  ...
  public void setSystemUiPidIfNeed(WindowProcessController windowProcessController) {
    String str;
    if (windowProcessController.mUserId == 0
        && (str = this.PKG_SYSTEMUI) != null
        && str.equals(windowProcessController.mName)) {
      Slog.d(
          "ActivityTaskManagerServiceExt",
          "setSystemUiPidIfNeed : " + windowProcessController.getPid());
