...
public final class ActivityTaskManagerServiceExt {
    ...
    public ActivityTaskManagerServiceExt(
            Context context, ActivityTaskManagerService activityTaskManagerService) {
        this.mLowRefreshRateList =
                CoreRune.FW_VRR_LOW_REFRESH_RATE_LIST
                        ? new RefreshRateBlockList(PackageFeature.LOW_REFRESH_RATE)
                        : null;
        this.mNaviAppLowRefreshRateList =
                CoreRune.FW_VRR_NAVIGATION_LOW_REFRESH_RATE
                        ? new RefreshRateBlockList(PackageFeature.NAVIGATION_LOW_REFRESH_RATE)
                        : null;
        this.mHighRefreshRateBlockList =
                CoreRune.FW_VRR_HIGH_REFRESH_RATE_BLOCK_LIST
                        ? new RefreshRateBlockList(PackageFeature.HIGH_REFRESH_RATE)
                        : null;
    ...
    public final void checkAppLockState(
            final Intent intent, final boolean z, final String str, boolean z2) {
        ...
        try {
            ...
            if (z3) {
                ...
                StringBuilder m =
                        FullScreenMagnificationGestureHandler$$ExternalSyntheticOutline0.m(
                                "AppLock checkAppLockState locked:",
                                z3,
                                " verifying:",
                                z4,
                                " pkgName = ");
                ...
                if (!z4 || z) {
                    ...
                    Runnable runnable = new Runnable() { // from class:
                                // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda4
                                @Override // java.lang.Runnable
                                public final void run() {
                                    ActivityTaskManagerServiceExt activityTaskManagerServiceExt =
                                            ActivityTaskManagerServiceExt.this;
                                    String str2 = str;
                                    int i = callingUid;
                                    boolean z5 = z;
                                    ...
                                    Intent intent3 =
                                            new Intent(
                                                    "com.samsung.android.intent.action.CHECK_APPLOCK_SERVICE");
                                    ...
                                    intent3.putExtra(
                                            "LOCKED_PACKAGE_USERID", UserHandle.getUserId(i));
                                    ...
                                    try {
                                        ...
                                        Slog.e(
                                                "ActivityTaskManagerServiceExt",
                                                "AppLock service start failed for intent:"
                                                        + intent3,
                                                e);
                                    }
                                }
            ...
            Slog.e(
                    "ActivityTaskManagerServiceExt",
                    "Exception while checking App Lock locked / verifying state : ",
                    e);
        }
    }
            ...
            try {
                ...
                if (forTokenLocked == null) {
                    throw new IllegalArgumentException(
                            "AppLockLaunchingFromActivity: No activity record matching token="
                                    + iBinder);
                }
                ...
                if (this.mService.mAppLockPolicy.isActivityInExceptionList(
                        forTokenLocked.info.name)) {
                    zArr[2] = true;
                } else {
                    zArr[2] = false;
                }
        ...
        if (displayContent == null
                || (activity =
                                displayContent.getActivity(
                                        new ActivityTaskManagerServiceExt$$ExternalSyntheticLambda6()))
                        == null) {
            task = null;
        } else {
            task = activity.task;
        ...
        if (DesktopModeFeature.DEBUG) {
            StringBuilder m =
                    ArrayUtils$$ExternalSyntheticOutline0.m(
                            i, i2, "getForegroundTaskId(), displayId=", ", taskId=", ", task=");
            m.append(task);
                ...
                boolean z =
                        displayContent.getTask(
                                        new Predicate() { // from class:
                                                          // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda9
                                            ...
                                            public final boolean test(Object obj) {
                                                ...
                                                Task task = (Task) obj;
                                                return task.getActivityType() == this.f$0
    ...
    public final void installSystemProvidersLocked() {
        ...
        CoreStateObserverController coreStateObserverController =
                new CoreStateObserverController(
                        activityTaskManagerService.mContext,
                        coreStateController,
                        new Handler(activityTaskManagerService.mH.getLooper()));
        coreStateController.mObserverController = coreStateObserverController;
        coreStateObserverController.mStartedUserIds.add(0);
        CoreStateSystemFeatureObserver coreStateSystemFeatureObserver =
                coreStateObserverController.mSystemFeatureObserver;
        Iterator it = coreStateSystemFeatureObserver.mSystemFeaturesList.iterator();
        while (it.hasNext()) {
            String str = (String) it.next();
            ((HashMap) coreStateSystemFeatureObserver.mSystemFeaturesRepository)
                    .put(
                            str,
                            Boolean.valueOf(
                                    coreStateSystemFeatureObserver
                                            .mContext
                                            .getPackageManager()
                                            .hasSystemFeature(str)));
        }
        ...
        MultiWindowEnableController multiWindowEnableController =
                this.mService.mMultiWindowEnableController;
        multiWindowEnableController.mDeviceSupportsMultiWindow =
                ActivityTaskManager.deviceSupportsMultiWindow(
                        multiWindowEnableController.mAtm.mContext);
        AnyMotionDetector$$ExternalSyntheticOutline0.m(
                "MultiWindowEnableController",
                new StringBuilder("updateDeviceSupportsMultiWindow: support="),
                multiWindowEnableController.mDeviceSupportsMultiWindow);
        if (multiWindowEnableController.mDeviceSupportsMultiWindow) {
            multiWindowEnableController.setMultiWindowDynamicEnabled(
                    0,
                    "Initialize",
                    multiWindowEnableController.isMultiWindowForceOnRequested(0)
                            || !multiWindowEnableController.isMultiWindowOffRequested(0),
                    false,
                    false);
        }
    }
        ...
        if (activityRecord != null) {
            ...
            if (this.mKeepAliveActivities.size() >= 2) {
                HeapdumpWatcher$$ExternalSyntheticOutline0.m(
                        new StringBuilder("Max count exceeded! Cannot set keepAlive for taskId="),
                        task.mTaskId,
                        "ActivityTaskManagerServiceExt");
            } else {
    ...
    public final void onSystemReady() {
        ...
        final MultiTaskingAppCompatController multiTaskingAppCompatController =
                this.mService.mMultiTaskingAppCompatController;
        multiTaskingAppCompatController.mAtmService.mH.post(
                new Runnable() { // from class:
                    // com.android.server.wm.MultiTaskingAppCompatController$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        MultiTaskingAppCompatController multiTaskingAppCompatController2 =
                                MultiTaskingAppCompatController.this;
                        ...
                        context2.registerReceiver(
                                new BroadcastReceiver() { // from class:
                                    // com.android.server.wm.CompatChangeableAppsCache.1
                                    public final /* synthetic */ CompatChangeableAppsCache this$0 =
                                            LazyHolder.sCache;
                                    ...
                                    public final void onReceive(Context context3, Intent intent) {
                                        ...
                                        if (data == null) {
                                            Slog.w(
                                                    "CompatChangeableApps",
                                                    "Failed to get package name in package"
                                                        + " receiver");
                                            return;
                                        }
                                        ...
                                        if (action == null) {
                                            Slog.w(
                                                    "CompatChangeableApps",
                                                    "Failed to get action in package receiver");
                                            return;
                                        }
                                        switch (action) {
                                            ...
                                            case "android.intent.action.PACKAGE_ADDED":
                                                CompatChangeableAppsCache
                                                        compatChangeableAppsCache2 = this.this$0;
                                                synchronized (compatChangeableAppsCache2) {
                                                    try {
                                                        SparseArray sparseArray =
                                                                compatChangeableAppsCache2
                                                                        .mAppsArray;
                                                        if (sparseArray == null) {
                                                            return;
                                                        }
                                            ...
                                            default:
                                                Slog.w(
                                                        "CompatChangeableApps",
                                                        "Unsupported action in package receiver: "
                                                                .concat(action));
                                                return;
                                        }
                                    }
                        ...
                        if (CoreRune.MT_APP_COMPAT_STATUS_LOGGING) {
                            MultiTaskingAppCompatStatusLogger multiTaskingAppCompatStatusLogger =
                                    multiTaskingAppCompatController2
                                            .mMultiTaskingAppCompatStatusLogger;
                            ...
                            Slog.d(
                                    "CoreSaStatusLoggingService",
                                    "registerCoreSaStatusLogger"
                                        + " logger=MultiTaskingAppCompatStatusLogger");
                        }
                    }
                });
        this.mService.mH.post(
                new Runnable() { // from class:
                    // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        ActivityTaskManagerServiceExt activityTaskManagerServiceExt =
                                ActivityTaskManagerServiceExt.this;
                        activityTaskManagerServiceExt.getClass();
                        final PackageFeatureManagerService packageFeatureManagerService =
                                PackageFeatureManagerService.LazyHolder.sInstance;
                        final Context context2 = activityTaskManagerServiceExt.mContext;
                        final ActivityTaskManagerService.H h =
                                activityTaskManagerServiceExt.mService.mH;
                        PackageFeatureController packageFeatureController =
                                packageFeatureManagerService.mPackageFeatureController;
                            ...
                            try {
                                if (packageFeatureController.mStarted) {
                                    packageFeatureController.mLogger.log(
                                            5, "The controller has already been started.", null);
                                } else {
                                    packageFeatureController.mContext = context2;
                                    packageFeatureController.mHandler = h;
                                    packageFeatureController.mLogger = coreLogger;
                                    packageFeatureController.mPackageFeatures =
                                            new PackageFeatures(context2, h, coreLogger);
                                    packageFeatureController.mSettings =
                                            new PackageFeatureSettings(
                                                    context2, h, packageFeatureController, z);
                                    h.post(
                                            new PackageFeatureController$$ExternalSyntheticLambda0(
                                                    packageFeatureController, 1));
                                    packageFeatureController.mStarted = true;
                                }
                            } finally {
                            }
                        }
                        PackageFeatureController packageFeatureController2 =
                                packageFeatureManagerService.mPackageFeatureController;
                        ScpmController scpmController =
                                packageFeatureManagerService.mScpmController;
                        Objects.requireNonNull(scpmController);
                        PackageFeatureManagerService$$ExternalSyntheticLambda1
                                packageFeatureManagerService$$ExternalSyntheticLambda1 =
                                        new PackageFeatureManagerService$$ExternalSyntheticLambda1(
                                                scpmController);
                        synchronized (packageFeatureController2.mLock) {
                            packageFeatureController2.mGetFileDescriptor =
                                    packageFeatureManagerService$$ExternalSyntheticLambda1;
                        }
                        ScpmController scpmController2 =
                                packageFeatureManagerService.mScpmController;
                        final Set groupNames =
                                packageFeatureManagerService.mPackageFeatureController
                                        .getGroupNames();
                        PackageFeatureController packageFeatureController3 =
                                packageFeatureManagerService.mPackageFeatureController;
                        CoreLogger coreLogger2 = packageFeatureManagerService.mLogger;
                        final ScpmControllerImpl scpmControllerImpl =
                                (ScpmControllerImpl) scpmController2;
                        synchronized (scpmControllerImpl.mLock) {
                            try {
                                if (!scpmControllerImpl.mStarted) {
                                    ...
                                    h.post(
                                            new Runnable() { // from class:
                                                // com.samsung.android.server.corescpm.ScpmControllerImpl$$ExternalSyntheticLambda2
                                                @Override // java.lang.Runnable
                                                public final void run() {
                                                    ScpmControllerImpl scpmControllerImpl2 =
                                                            ScpmControllerImpl.this;
                                                    Set set = groupNames;
                                                    ...
                                                    try {
                                                        ...
                                                        intentFilter.addAction(
                                                                KnoxCustomManagerService
                                                                        .ACTION_SCPM_POLICY_CLEAR_DATA);
                                                        Iterator it = set.iterator();
                                                        while (it.hasNext()) {
                                                            intentFilter.addAction(
                                                                    "com.samsung.android.scpm.policy.UPDATE."
                                                                            + ((String) it.next()));
                                                        }
                                                        context3.registerReceiver(
                                                                scpmControllerImpl2,
                                                                intentFilter,
                                                                2);
                                                        handler.postDelayed(
                                                                scpmControllerImpl2
                                                                        .mOnLazyBootCompletedTimeout,
                                                                ClipboardService
                        ...
                        synchronized (packageFeatureManagerService) {
                            try {
                                ...
                                if (map == null) {
                                    Slog.e(
                                            "PackageFeature",
                                            "The package feature manager service has already been"
                                                + " started.");
                                } else {
                                    ((HashMap) map)
                                            .forEach(
                                                    new BiConsumer() { // from class:
                                                        // com.samsung.android.server.packagefeature.core.PackageFeatureManagerService$$ExternalSyntheticLambda2
                                                        @Override // java.util.function.BiConsumer
                                                        public final void accept(
                                                                Object obj, Object obj2) {
                                                            PackageFeatureManagerService
                                                                    packageFeatureManagerService2 =
                                                                            PackageFeatureManagerService
                                                                                    .this;
                        ...
                        while (it.hasNext()) {
                            PackageFeatureUserChange[] packageFeatureUserChangeArr =
                                    ((PackagesChange) it.next()).mUserChanges;
                            if (packageFeatureUserChangeArr != null) {
                                for (PackageFeatureUserChange packageFeatureUserChange :
                                        packageFeatureUserChangeArr) {
                                    packageFeatureUserChange.onLoadFileCompletedAndSystemReady(
                                            true, false);
                                }
                            }
                        }
    ...
    public final void removeTaskByCmpName() {
        ...
        if (callingPid != Process.myPid()) {
            FileDescriptorWatcher$FileDescriptorLeakWatcher$$ExternalSyntheticOutline0.m(
                    callingPid, "Pid ", " cannot clear task!", "ActivityTaskManagerServiceExt");
            return;
        }
        DeviceIdleController$$ExternalSyntheticOutline0.m(
                callingPid,
                "removeTaskByCmpName:com.android.settings/.password.ChooseLockGeneric$InternalActivity"
                    + " user:0 callerPid:",
        ...
        synchronized (windowManagerGlobalLock) {
            try {
                try {
                    for (int childCount = this.mService.mRootWindowContainer.getChildCount() - 1;
                            childCount >= 0;
                            childCount--) {
                        DisplayContent displayContent =
                                (DisplayContent)
                                        this.mService.mRootWindowContainer.getChildAt(childCount);
                        if (displayContent == null) {
                            WindowManagerService.resetPriorityAfterLockedSection();
                            return;
                        }
                        displayContent.forAllRootTasks(
                                new Consumer() { // from class:
                                    // com.android.server.wm.ActivityTaskManagerServiceExt$$ExternalSyntheticLambda5
                                    ...
                                    public final void accept(Object obj) {
                                        ...
                                        if (task2.topRunningActivityLocked() != null) {
                                            ArrayList dumpActivitiesLocked =
                                                    task2.getDumpActivitiesLocked(-1, "all");
                                            for (int size = dumpActivitiesLocked.size() - 1;
                                                    size >= 0;
                                                    size--) {
                                                ActivityRecord activityRecord =
                                                        (ActivityRecord)
                                                                dumpActivitiesLocked.get(size);
                                                if (activityRecord != null
                                                    ...
                                                    try {
                                                        activityTaskManagerServiceExt.mService
                                                                .mTaskSupervisor.removeTask(
                                                                task,
                                                                true,
                                                                true,
                                                                "remove-task-by-knox");
    ...
    public final boolean removeTaskWithFlagsLocked(int i, int i2) {
        ...
        if (i3 == 0 && (i2 & 32) == 0) {
            try {
                return activityTaskManagerService.mTaskSupervisor.removeTaskById(
                        i,
                        Binder.getCallingUid(),
                        Binder.getCallingPid(),
                        "remove-task-with-flags",
                        true,
                        (i2 & 16) == 0,
                        CoreRune.MW_DND_FREEFORM_DISMISS_VIEW && (i2 & 128) != 0);
            } finally {
                if ((i2 & 4) != 0) {
        ...
        for (int size = rawTasks.size() - 1; size >= 0; size--) {
            if (size != 0 || (i2 & 32) == 0) {
                ...
                if (!task.isActivityTypeHome() && !task.isActivityTypeRecents()) {
                    if (task.mUserId
                            != activityTaskManagerService.mRootWindowContainer.mCurrentUser) {
                        HashSet hashSet =
                                new HashSet(
                                        Arrays.asList(
                                                (Integer[])
                                                        Arrays.stream(
                                                                ...
                                                                .boxed()
                                                                .toArray(
                                                                        new ActivityTaskManagerServiceExt$$ExternalSyntheticLambda0())));
                        hashSet.add(
                                Integer.valueOf(
                                        activityTaskManagerService
    ...
    */
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.ActivityTaskManagerServiceExt.setAppLockedVerifying(java.lang.String,"
                    + " boolean):void");
    }
    ...
    public final void startAppLockActivity(ActivityRecord activityRecord) {
        ...
        boolean isAppLockedPackage =
                appLockPolicy != null
                        ? appLockPolicy.isAppLockedPackage(activityRecord.packageName)
                        : false;
        String str4 = activityRecord.packageName;
        AppLockPolicy appLockPolicy2 = activityTaskManagerService.mAppLockPolicy;
        boolean isAppLockedVerifying =
                appLockPolicy2 != null ? appLockPolicy2.isAppLockedVerifying(str4) : false;
        boolean z =
                activityInfo == null
                        || !activityTaskManagerService.mAppLockPolicy.isActivityInExceptionList(
                                activityInfo.name);
        if (!isAppLockedPackage || isAppLockedVerifying) {
            return;
        }
        if ((activityRecord.mLaunchingRequestedFromNotification
                        && activityRecord.getDisplayId() != 1)
                || !z
        ...
        if (task.inFreeformWindowingMode() && task.isDexMode()) {
            ...
            if (!task.isDexMode()) {
                ...
                activityTaskManagerService.mRootWindowContainer.mDefaultDisplay.forAllActivities(
                        new ActivityTaskManagerServiceExt$$ExternalSyntheticLambda1(
                                activityRecord, atomicBoolean2));
            }
        }
        if (SemPersonaManager.isKnoxId(i)
                || activityTaskManagerService.mAppLockPolicy.isManagedProfileUserId(i)) {
            return;
        }
        if ((SemDualAppManager.isDualAppId(i) && AppLockPolicy.isSupportSSecure())
                || inMultiWindowMode) {
            return;
        }
        ...
        Intent intent =
                new Intent(
                        appLockPolicy3 != null ? appLockPolicy3.getAppLockedCheckAction() : null);
        ...
        ActivityInfo activityInfo2 =
                activityTaskSupervisor.resolveIntent(
                                intent, resolveTypeIfNeeded, i, 0, i2, Binder.getCallingPid())
                        .activityInfo;
        ...
        try {
            ...
            try {
                ...
                Log.e(
                        str,
                        "Exception while launching AppLock Confirm Activity for"
                                + activityRecord
                                + ", Exception is : "
                                + e);
            }
