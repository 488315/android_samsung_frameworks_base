...
public class FreeformPersistBoundsParams {
  ...
  public void saveToXml(TypedXmlSerializer typedXmlSerializer) {
    typedXmlSerializer.attribute(
        (String) null, "freeform_bounds", this.mFreeformBounds.flattenToString());
    typedXmlSerializer.attribute(
        (String) null, "display_bounds", this.mDisplayBounds.flattenToString());
  ...
  public boolean isValid() {
    return (this.mFreeformBounds.isEmpty() || this.mDisplayBounds.isEmpty() || this.mRotation == -1)
        ? false
        : true;
  }
  ...
  public int hashCode() {
    return (((this.mFreeformBounds.hashCode() * 31) + this.mDisplayBounds.hashCode()) * 31)
        + this.mRotation;
  }
}
