...
public class TaskPositioningController {
  ...
  public void hideInputSurface(int i) {
    ...
    if (displayContent == null
        || displayContent.getDisplayId() != i
        || (surfaceControl = this.mInputSurface) == null) {
      return;
    }
  ...
  public CompletableFuture showInputSurface(int i) {
    ...
    this.mTransaction
        ...
        .setInputWindowInfo(this.mInputSurface, dragWindowHandleLocked)
        ...
        .addWindowInfosReportedListener(
            new Runnable() { // from class:
                             // com.android.server.wm.TaskPositioningController$$ExternalSyntheticLambda3
  ...
  public void handleTapOutsideTask(final DisplayContent displayContent, final int i, final int i2) {
    this.mService.f1749mH.post(
        new Runnable() { // from class:
                         // com.android.server.wm.TaskPositioningController$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$handleTapOutsideTask$2(
        ...
        if (findTaskForResizePoint != null && findTaskForResizePoint.isResizeable()) {
          CompletableFuture startPositioningLocked =
              startPositioningLocked(
                  findTaskForResizePoint.getTopVisibleAppMainWindow(),
                  true,
                  findTaskForResizePoint.preserveOrientationOnResize(),
                  i,
                  i2);
          try {
            if (((Boolean) startPositioningLocked.get()).booleanValue()) {
  ...
  public final CompletableFuture startPositioningLocked(
    ...
    return create
        .register(displayContent, windowState)
        .thenApply(
            new Function() { // from class:
              ...
              public final Object apply(Object obj) {
                ...
                lambda$startPositioningLocked$3 =
                    TaskPositioningController.this.lambda$startPositioningLocked$3(
                        windowState, displayContent, z, z2, f, f2, (Void) obj);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ Boolean lambda$startPositioningLocked$3(
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        if (windowState2 != null
            ...
            && windowState2.mActivityRecord == windowState.mActivityRecord) {
          windowState = windowState2;
        }
        if (!this.mService.mInputManager.transferTouchFocus(
            windowState.mInputChannel, this.mTaskPositioner.mClientChannel, false)) {
          Slog.e(
              StartingSurfaceController.TAG,
              "startPositioningLocked: Unable to transfer touch focus");
  ...
  public void finishTaskPositioning() {
    this.mService.mAnimationHandler.post(
        new Runnable() { // from class:
                         // com.android.server.wm.TaskPositioningController$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
