...
public final class DeviceStateController {
    ...
    public DeviceStateController(Context context, WindowManagerGlobalLock windowManagerGlobalLock) {
        ...
        this.mHalfFoldedDeviceStates = context.getResources().getIntArray(R.array.preloaded_freeform_multi_window_drawables);
        ...
        this.mConcurrentDisplayDeviceState = context.getResources().getInteger(R.integer.config_downloadDataDirLowSpaceThreshold);
        this.mReverseRotationAroundZAxisStates = context.getResources().getIntArray(R.array.config_supportedDreamComplications);
        this.mMatchBuiltInDisplayOrientationToDefaultDisplay = context.getResources().getBoolean(R.bool.config_keepRestrictedProfilesInBackground);
    }
