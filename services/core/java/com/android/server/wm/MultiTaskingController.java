...
public class MultiTaskingController implements IController {
    ...
    public final void registerDemoResetReceiver() {
        ...
        this.mAtm.mContext.registerReceiver(this.mDemoResetStartedReceiver, intentFilter, "android.permission.MANAGE_ACTIVITY_STACKS", this.f1743mH);
    }
    ...
    public void notifySecureWindowAdded(WindowState windowState) {
        ...
        this.f1743mH.sendMessage(this.f1743mH.obtainMessage(1, task.mTaskId, 1, windowState.getOwningPackage()));
    }
    ...
    public void notifySecureWindowRemoved(WindowState windowState) {
        ...
        this.f1743mH.sendMessage(this.f1743mH.obtainMessage(1, task.mTaskId, 0, windowState.getOwningPackage()));
    }
    ...
    public void notifyFocusedDisplayChangedLocked(final int i) {
        this.f1743mH.post(new Runnable() { // from class: com.android.server.wm.MultiTaskingController$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void startUser(final int i, boolean z, boolean z2) {
        this.f1743mH.post(new Runnable() { // from class: com.android.server.wm.MultiTaskingController$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void removeEmbedActivityTaskAndProcessIfNeeded(final Task task) {
        ...
        if (rootProcess != null) {
            ...
            this.f1743mH.post(new Runnable() { // from class: com.android.server.wm.MultiTaskingController$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
        ...
        try {
            ...
            if (packageInfoAsUser != null) {
                ...
                if (processController != null) {
                    ...
                    this.f1743mH.post(new Runnable() { // from class: com.android.server.wm.MultiTaskingController$$ExternalSyntheticLambda14
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    */
        ...
        synchronized (windowManagerGlobalLock) {
            try {
                ...
                if (iBinder instanceof ActivityRecord.Token) {
                    ...
                    z4 = false;
                } else if ((iBinder instanceof WindowContainer.RemoteToken) && (((WindowContainer.RemoteToken) iBinder).getContainer() instanceof Task)) {
                    ...
                    if (activityRecord2 != null && task != null && task.getDisplayArea() != null) {
                        ...
                        if (!WindowConfiguration.isSplitScreenWindowingMode(task.getWindowConfiguration()) && task.getDisplayArea().isSplitScreenModeActivated()) {
                            ...
                            Slog.w(TAG, "exitMultiWindow: invalid windowing mode to request mode=" + activityRecord2.getWindowingMode() + ", r=" + activityRecord2);
                        }
    ...
    public void registerMinimizeAllReceiver() {
        ...
        this.mAtm.mContext.registerReceiver(this.mMinimizeAllReceiver, intentFilter, "android.permission.MANAGE_ACTIVITY_STACKS", this.f1743mH);
    }
    ...
    */
    public int getMultiWindowModeForAssistantHotKeyLocked() {
        ...
        Task task = defaultTaskDisplayArea.getTask(new Predicate() { // from class: com.android.server.wm.MultiTaskingController$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$getMultiWindowModeForAssistantHotKeyLocked$21;
                lambda$getMultiWindowModeForAssistantHotKeyLocked$21 = MultiTaskingController.lambda$getMultiWindowModeForAssistantHotKeyLocked$21((Task) obj);
