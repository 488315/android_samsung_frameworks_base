...
public final class MultiTaskingController implements IController {
    ...
    public final MultiTaskingController$$ExternalSyntheticLambda5 mNotifyStartRecentsAnimation =
            new MultiTaskingController$$ExternalSyntheticLambda5(0);
    public final MultiTaskingController$$ExternalSyntheticLambda5 mNotifyFinishRecentsAnimation =
            new MultiTaskingController$$ExternalSyntheticLambda5(1);
    public final MultiTaskingController$$ExternalSyntheticLambda5 mNotifyStartHomeAnimation =
            new MultiTaskingController$$ExternalSyntheticLambda5(2);
    public final MultiTaskingController$$ExternalSyntheticLambda5
            mNotifyWallpaperVisibilityChanged =
                    new MultiTaskingController$$ExternalSyntheticLambda5(3);
    ...
    public final class H extends Handler {
        ...
        public final void handleMessage(Message message) {
                ...
                synchronized (windowManagerGlobalLock) {
                    try {
                        MultiTaskingController.this.mAtm.mFreeformController
                                .setFreeformWindowingModeByCornerGestureLocked(i2, rect, i3);
                    } catch (Throwable th) {
            ...
            if (i == 1) {
                ...
                if (remoteAppModeManagerInternal == null) {
                    HeapdumpWatcher$$ExternalSyntheticOutline0.m(
                            new StringBuilder("handleMessage: can't find localService, what="),
                            message.what,
            ...
            if (i == 3) {
                ...
                MultiTaskingController.m1065$$Nest$mforAllRemoteAppTransitionListeners(
                        multiTaskingController,
                        multiTaskingController.mNotifyStartRecentsAnimation,
                        message);
                return;
            }
            if (i == 4) {
                ...
                MultiTaskingController.m1065$$Nest$mforAllRemoteAppTransitionListeners(
                        multiTaskingController2,
                        multiTaskingController2.mNotifyFinishRecentsAnimation,
                        message);
            } else if (i == 5) {
                MultiTaskingController multiTaskingController3 = MultiTaskingController.this;
                MultiTaskingController.m1065$$Nest$mforAllRemoteAppTransitionListeners(
                        multiTaskingController3,
                        multiTaskingController3.mNotifyStartHomeAnimation,
                        message);
            } else {
                if (i != 6) {
                    return;
                ...
                MultiTaskingController.m1065$$Nest$mforAllRemoteAppTransitionListeners(
                        multiTaskingController4,
                        multiTaskingController4.mNotifyWallpaperVisibilityChanged,
                        message);
            }
        }
    }
    ...
    public final class SettingsObserver extends ContentObserver {
        ...
        public SettingsObserver(Handler handler) {
            ...
            this.mDexStandaloneRotationUri =
                    Uri.withAppendedPath(uri, "standalone_mode_rotate_app");
            ...
            this.mDexForceImmersiveModeEnabledUri =
                    Uri.withAppendedPath(uri, "taskbar_hide_bar_enabled");
            ...
            this.mDexStarShowingDelayTimeUri =
                    Uri.withAppendedPath(uri, "mouse_immersive_time_control");
        }
        ...
        public final void readSettings(boolean z, Uri uri) {
            ...
            if (CoreRune.MW_FREEFORM_SMART_POPUP_VIEW
                    && MultiTaskingController.this.mAtm.mAmInternal.isBooted()
                    && (z
                ...
                FreeformController freeformController2 =
                        MultiTaskingController.this.mAtm.mFreeformController;
            ...
            if (z || this.mSwipeForPopUpViewCornerAreaUri.equals(uri)) {
                ...
                int cornerGestureCustomValue =
                        MultiWindowEdgeDetector.getCornerGestureCustomValue(
                                Settings.Global.getInt(
                                        contentResolver, "freeform_corner_gesture_level", 2));
                WindowManagerGlobalLock windowManagerGlobalLock =
                    ...
                    try {
                        Iterator it =
                                multiTaskingController
                                        .mAtm
                                        .mExt
                                        .getStartedUserIdsLocked()
                                        .iterator();
                        while (it.hasNext()) {
                            multiTaskingController.mAtm.mExt.mCoreStateController.setVolatileState(
                                    "corner_gesture_custom_value",
                                    Integer.valueOf(cornerGestureCustomValue),
            ...
            if (CoreRune.MW_SHELL_FREEFORM_CAPTION_TYPE
                ...
                MultiTaskingController.this.mAtm.mFreeformController.updateFreeformCaptionType(
                        Settings.Global.getInt(contentResolver, "freeform_caption_type", 0));
            }
            if (z || this.mSplitGestureUri.equals(uri)) {
                MultiTaskingController.this.mIsFullToSplitEnabled =
                        Settings.Global.getInt(contentResolver, "open_in_split_screen_view", 0)
                                == 1;
            }
            if (z || this.mEdgeUri.equals(uri)) {
                boolean z2 =
                        Settings.Secure.getIntForUser(contentResolver, "edge_enable", 0, -2) == 1;
            ...
            if (z || this.mDexForceImmersiveModeSettingUri.equals(uri)) {
                ActivityTaskManagerService activityTaskManagerService =
                        MultiTaskingController.this.mAtm;
                activityTaskManagerService.mDexController.updateForceImmersiveModeSetting(
                        DesktopModeSettings.getSettingsAsUser(
            ...
            if (z || this.mDexForceImmersiveModeEnabledUri.equals(uri)) {
                ActivityTaskManagerService activityTaskManagerService2 =
                        MultiTaskingController.this.mAtm;
                activityTaskManagerService2.mDexController.updateForceImmersiveModeState(
                        DesktopModeSettings.getSettingsAsUser(
                                activityTaskManagerService2.mContext.getContentResolver(),
            ...
            if (z || this.mDexTouchPadUsingUri.equals(uri)) {
                boolean settingsAsUser2 =
                        DesktopModeSettings.getSettingsAsUser(
                                ...
                                false,
                                DesktopModeSettings.sCurrentUserId);
                WindowManagerGlobalLock windowManagerGlobalLock4 =
                        MultiTaskingController.this.mAtm.mGlobalLock;
                WindowManagerService.boostPriorityForLockedSection();
                synchronized (windowManagerGlobalLock4) {
                    try {
                        DexController dexController2 =
                                MultiTaskingController.this.mAtm.mDexController;
                        if (dexController2.mDexTouchPadEnabled != settingsAsUser2) {
                            dexController2.mDexTouchPadEnabled = settingsAsUser2;
                            Slog.i(
                                    "DexController",
                                    "setDexTouchPadEnabledLocked: enabled="
                                            + dexController2.mDexTouchPadEnabled);
                        }
                    } finally {
                    }
                }
                ...
                float parseFloat =
                        Float.parseFloat(
                                DesktopModeSettings.getSettingsAsUser(
                                        ...
                                        Float.toString(1.0f),
                                        DesktopModeSettings.sCurrentUserId));
                MultiTaskingController.this.mAtm.mDexController.updateDexFontScaleIfNeeded(
                        parseFloat);
                Slog.d(
                        "MultiTaskingController",
                        "SettingsObserver_readSettings: dex_font_scale=" + parseFloat);
            }
            if (z || this.mDexStarShowingDelayTimeUri.equals(uri)) {
                ActivityTaskManagerService activityTaskManagerService3 =
                        MultiTaskingController.this.mAtm;
                activityTaskManagerService3.mDexController.updateDexStarShowingDelayTime(
                        DesktopModeSettings.getSettingsAsUser(
                                activityTaskManagerService3.mContext.getContentResolver(),
    ...
    public static void m1065$$Nest$mforAllRemoteAppTransitionListeners(
            MultiTaskingController multiTaskingController,
            MultiTaskingController$$ExternalSyntheticLambda5
                    multiTaskingController$$ExternalSyntheticLambda5,
            Message message) {
        synchronized (multiTaskingController.mRemoteAppTransitionListeners) {
            for (int beginBroadcast =
                            multiTaskingController.mRemoteAppTransitionListeners.beginBroadcast()
                                    - 1;
                    beginBroadcast >= 0;
                    beginBroadcast--) {
                try {
                    multiTaskingController$$ExternalSyntheticLambda5.accept(
                            (IRemoteAppTransitionListener)
                                    multiTaskingController.mRemoteAppTransitionListeners
    ...
    public MultiTaskingController(ActivityTaskManagerService activityTaskManagerService) {
        ...
        this.mMinimizeAllReceiver =
                new BroadcastReceiver(
                        this) { // from class: com.android.server.wm.MultiTaskingController.1
                            ...
                            default:
                                ...
                                if (!"com.samsung.sea.rm.DEMO_RESET_STARTED".equals(action2)) {
                                    if ("com.samsung.intent.action.SETTINGS_SOFT_RESET"
                                        ...
                                        SmartPopupViewUtil.resetPackageListStr(
                                                this.this$0.mAtm.mContext);
                                        return;
                                    }
                                    return;
                                }
                                if (SmartPopupViewUtil.isShopDemo(this.this$0.mAtm.mContext)) {
                                    ...
                                    MultiWindowManager.getInstance()
                                            .setCornerGestureEnabledWithSettings(false);
                                    return;
                                }
                                return;
                        }
    ...
    public static void printAllTasksLocked(
        ...
        for (int size = asTask.mChildren.size() - 1; size >= 0; size--) {
            printAllTasksLocked(
                    ...
                    (WindowContainer) asTask.mChildren.get(size),
                    size);
        }
    }

    public static void printTaskDisplayAreaLocked(
    ...
    public final void dumpLocked(PrintWriter printWriter) {
        ...
        if (CoreRune.MW_MULTI_SPLIT_ENSURE_APP_SIZE) {
            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            new StringBuilder("  mSplitFeasibleMode="),
                            this.mSplitFeasibleMode,
                            printWriter,
                            "  mIsDisplaySizeOverride="),
                    this.mIsDisplaySizeOverride,
                    printWriter);
        }
        printWriter.println("  (CONFIGURATION CONTAINERS)");
        ActivityTaskManagerService activityTaskManagerService = this.mAtm;
        activityTaskManagerService.mRootWindowContainer.dumpConfigurationLocked(
                printWriter, "  ", 0);
        printWriter.println();
        ...
        while (true) {
            ...
            displayContent.forAllTaskDisplayAreas(
                    new MultiTaskingController$$ExternalSyntheticLambda10(this, printWriter));
        }
        printWriter.println();
        printWriter.println("  (FOCUS INFO)");
        RootWindowContainer rootWindowContainer = activityTaskManagerService.mRootWindowContainer;
        printWriter.println(
                "    TopDisplayFocusedTask=" + rootWindowContainer.getTopDisplayFocusedRootTask());
        printWriter.println(
                "    TopResumedActivity=" + rootWindowContainer.getTopResumedActivity());
        printWriter.println();
        for (int childCount2 = rootWindowContainer.getChildCount() + (-1);
                childCount2 >= 0;
                childCount2 += -1) {
            DisplayContent displayContent2 =
                    (DisplayContent) rootWindowContainer.getChildAt(childCount2);
            StringBuilder m =
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
        ...
        if (transitionController != null) {
            ...
            if (transitionController.mCollectingTransition != null) {
                printWriter.println(
                        "    mCollectingTransition=" + transitionController.mCollectingTransition);
            }
            if (!transitionController.mWaitingTransitions.isEmpty()) {
                printWriter.println(
                        "    mWaitingTransitions=" + transitionController.mWaitingTransitions);
            }
            if (transitionController.mFinishingTransition != null) {
                printWriter.println(
                        "    mFinishingTransition=" + transitionController.mFinishingTransition);
            }
        }
        printWriter.println();
    }
    ...
    public final boolean exitMultiWindow(IBinder iBinder) {
        ...
        synchronized (windowManagerGlobalLock) {
            try {
                ...
                Slog.w(
                        "MultiTaskingController",
                        "exitMultiWindow: cannot find task, token=" + iBinder);
                WindowManagerService.resetPriorityAfterLockedSection();
                return false;
            } catch (Throwable th) {
                WindowManagerService.resetPriorityAfterLockedSection();
    ...
    */
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.MultiTaskingController.getMultiSplitFlags():int");
    }
            ...
            try {
                ...
                for (int childCount = this.mAtm.mRootWindowContainer.getChildCount() - 1;
                    ...
                    ((DisplayContent) this.mAtm.mRootWindowContainer.getChildAt(childCount))
                            .forAllActivities(
                                    new MultiTaskingController$$ExternalSyntheticLambda10(
                                            str, arrayList2, arrayList));
                }
    ...
    public final boolean handleAltTabKeyIfNeededLocked() {
        ...
        if (this.mFocusableTaskIds.isEmpty()) {
            ...
            Task rootTask =
                    defaultTaskDisplayArea.getRootTask(
                            new TaskDisplayArea$$ExternalSyntheticLambda7(2));
            if (rootTask != null) {
                for (int childCount = rootTask.getChildCount() - 1; childCount >= 0; childCount--) {
                    ...
                    if (childAt.asTask() != null && childAt.inSplitScreenWindowingMode()) {
                        ...
                        if (asTask.getStageType() != stageType
                                && asTask.isVisible()
                                && (topMostTask = asTask.getTopMostTask()) != null) {
                            ((LinkedList) this.mFocusableTaskIds)
                                    .add(Integer.valueOf(topMostTask.mTaskId));
                        }
                    }
                }
            }
            ...
            Slog.d(
                    "MultiTaskingController",
                    "collectFocusableSplitScreenTasksLocked:" + this.mFocusableTaskIds);
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean interceptStartActivityFromRecentsLocked(
            com.android.server.wm.Task r22, android.app.ActivityOptions r23) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.MultiTaskingController.interceptStartActivityFromRecentsLocked(com.android.server.wm.Task,"
    ...
    */
    public final boolean interceptStartActivityLocked(
            ...
            int r21,
            int r22,
            android.app.ActivityOptions r23,
            com.android.server.uri.NeededUriGrants r24,
            com.android.server.wm.Task r25,
            com.android.server.wm.ActivityStarter.Request r26) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.MultiTaskingController.interceptStartActivityLocked(com.android.server.wm.Task,"
                    + " com.android.server.wm.ActivityRecord, com.android.server.wm.ActivityRecord,"
                    + " int, int, android.app.ActivityOptions,"
                    + " com.android.server.uri.NeededUriGrants, com.android.server.wm.Task,"
    ...
    public final boolean isVisibleTaskByTaskIdInDexDisplay(int i) {
        ...
        if (i != -1) {
            ...
            if (activityTaskManagerService.mDexController.getDexModeLocked() == 2
                    && (anyTaskForId =
                                    activityTaskManagerService.mRootWindowContainer.anyTaskForId(
                                            i, 1, null, false))
                            != null
        ...
        if (pendingIntent != null) {
            ...
            if (activityTaskManagerService.mDexController.getDexModeLocked() == 2) {
                ...
                if (!queryIntentComponents.isEmpty()
                        && (activityInfo =
                                        ((ResolveInfo) queryIntentComponents.get(0)).activityInfo)
                                != null) {
                    ApplicationInfo applicationInfo = activityInfo.applicationInfo;
                    if (!activityTaskManagerService
                            .mDexController
                            .getTaskLocked(
                                    applicationInfo.uid, 0, applicationInfo.processName, true)
                            .isEmpty()) {
                        return true;
                    }
                }
    ...
    public final void minimizeAllTasksLocked(int i, boolean z) {
        ...
        try {
            ...
            displayContent
                    ...
                    .forAllRootTasks(
                            (Consumer)
                                    new MultiTaskingController$$ExternalSyntheticLambda2(
                                            this, arrayList, 1),
                            true);
            ...
            if (CoreRune.MT_NEW_DEX_PIP && (activityRecord = this.mTmpPipCandidate) != null) {
                ...
                if (activityTaskManagerService.mActivityClientController
                        .requestPictureInPictureMode(activityRecord)) {
                    Slog.d(
                            "MultiTaskingController",
                            "minimizeAllTasksLocked: entered pip, r=" + activityRecord);
                } else {
                    activityRecord.supportsEnterPipOnTaskSwitch = false;
                    Slog.d(
                            "MultiTaskingController",
                            "minimizeAllTasksLocked: failed to enter pip, r=" + activityRecord);
                }
            }
            if (z3) {
                activityTaskManagerService.mFreeformController
                        .continueMinimizeStateChangedCallbacks();
            }
    ...
    public final boolean minimizeTaskLocked(int i, int i2, final Task task, final boolean z) {
        ...
        if (!task.canMinimize()) {
            Slog.w(
                    "MultiTaskingController",
                    "minimizeTaskLocked: fail, task can't minimize. t=" + task);
        ...
        if (displayContent == null
                ...
                || (windowState = displayContent.mInputMethodWindow) == null
                || !windowState.isVisible()
                || (inputTarget = displayContent.mImeInputTarget) == null
                || inputTarget.getWindowState() == null
                || displayContent.mImeInputTarget.getWindowState().getTask() != task
                || !displayContent.mInsetsStateController.getImeSourceProvider().mImeShowing
                || !displayContent.mInsetsStateController.getImeSourceProvider().mImeShowing) {
            ...
            if (packageInfoAsUser != null) {
                ...
                final WindowProcessController processController =
                        activityTaskManagerService.getProcessController(
                                applicationInfo.uid, applicationInfo.processName);
                if (processController == null
                        || processController.mPid == ActivityManagerService.MY_PID) {
                    return;
                }
                this.mH.post(
                        new Runnable() { // from class:
    ...
    public final boolean removeFocusedTask(int i) {
        ...
        synchronized (windowManagerGlobalLock) {
            try {
                ...
                boolean[] zArr = {false};
                displayContent.forAllTaskDisplayAreas(
                        new MultiTaskingController$$ExternalSyntheticLambda2(this, zArr, i2));
                boolean z = zArr[0];
                WindowManagerService.resetPriorityAfterLockedSection();
                return z;
            } catch (Throwable th) {
    ...
    public final void setEmbedActivityPackageEnabled(final String str, boolean z, final int i) {
        ...
        ActivityEmbeddedController activityEmbeddedController =
                this.mAtm.mExt.mActivityEmbeddedController;
        activityEmbeddedController.mUserChange.putValue(
                str, activityEmbeddedController.findTargetUserId(i), Integer.valueOf(i2));
        WindowManagerGlobalLock windowManagerGlobalLock = this.mAtm.mGlobalLock;
        WindowManagerService.boostPriorityForLockedSection();
        synchronized (windowManagerGlobalLock) {
            try {
                        ...
                        .forAllLeafTasks(
                                new Consumer() { // from class:
                                    ...
                                    public final void accept(Object obj) {
                                        ...
                                        Task task = (Task) obj;
                                        if (multiTaskingController.mAtm.mExt
                                                                .mActivityEmbeddedController
                                                                .findTargetUserId(task.mUserId)
                                                        == i3
                                                && (componentName = task.realActivity) != null
                                                && componentName.getPackageName().equals(str2)) {
                                            arrayList2.add(task);
                                        }
                                    }
                                },
                ...
                while (it.hasNext()) {
                    ...
                    if (task.isVisible()) {
                        ...
                        if (windowProcessController != null
                                && windowProcessController.mPid != ActivityManagerService.MY_PID) {
                            this.mH.post(
                                    new MultiTaskingController$$ExternalSyntheticLambda14(
                                            this, task, windowProcessController));
                        }
                    }
                }
                WindowManagerService.resetPriorityAfterLockedSection();
    ...
    public final boolean shouldDeferEnterSplit(List list, List list2) {
        ...
        while (it.hasNext()) {
            ...
            if (!queryIntentComponents.isEmpty()
                    && (activityInfo = ((ResolveInfo) queryIntentComponents.get(0)).activityInfo)
                            != null) {
                ApplicationInfo applicationInfo = activityInfo.applicationInfo;
                ArrayList taskLocked =
                        activityTaskManagerService.mDexController.getTaskLocked(
                                applicationInfo.uid, 0, applicationInfo.processName, true);
        ...
        while (it3.hasNext()) {
            Task anyTaskForId =
                    activityTaskManagerService.mRootWindowContainer.anyTaskForId(
                            ((Integer) it3.next()).intValue(), 1, null, false);
    ...
    public final void startAssistantActivityToSplitLocked(Intent intent, float f) {
            ...
            if (activityTaskManagerService.mDexController.getDexModeLocked() == 2) {
                try {
                    activityTaskManagerService
                            .mContext
                            .getPackageManager()
                            .getApplicationInfo(resolveActivity.activityInfo.packageName, 128);
                } catch (PackageManager.NameNotFoundException e) {
                    e.printStackTrace();
                }
            }
            if (MultiWindowUtils.isAiKeyTrampolineActivity(
        ...
        Task task =
                activityTaskManagerService
                        ...
                        .mDefaultDisplay
                        .getDefaultTaskDisplayArea()
                        .getTask(new MultiTaskingController$$ExternalSyntheticLambda0(0));
        DisplayContent displayContent =
                activityTaskManagerService.mRootWindowContainer.getDisplayContent(0);
        DisplayRotation displayRotation =
                displayContent != null ? displayContent.mDisplayRotation : null;
        if (displayRotation != null) {
            ...
            if (i == 1
                ...
                activityTaskManagerService.mTaskOrganizerController.onSplitLayoutChangeRequested(
                        taskOrganizerInfo.toBundle());
            }
        }
        z = false;
        ...
        activityTaskManagerService.mTaskOrganizerController.onSplitLayoutChangeRequested(
                taskOrganizerInfo2.toBundle());
    }

    public final void updateEmbedActivityPackageEnabled(int i, int i2, String str, boolean z) {
        ActivityTaskManagerService activityTaskManagerService = this.mAtm;
        if (activityTaskManagerService.mExt.mActivityEmbeddedController.getEnabled(i2, str) == 0
                || z) {
            ActivityEmbeddedController activityEmbeddedController =
                    activityTaskManagerService.mExt.mActivityEmbeddedController;
            activityEmbeddedController.mUserChange.putValue(
                    str, activityEmbeddedController.findTargetUserId(i2), Integer.valueOf(i));
        }
    }
    ...
    public final void updateMultiSplitAppMinimumSizeLocked() {
        if (CoreRune.MW_MULTI_SPLIT_ENSURE_APP_SIZE) {
            ...
            int dimensionPixelSize =
                    currentUserResources.getDimensionPixelSize(R.dimen.harmful_app_padding_top)
                            - (currentUserResources.getDimensionPixelSize(
                                            R.dimen.harmful_app_name_padding_top)
                                    * 2);
            int dimensionPixelSize2 =
                    currentUserResources.getConfiguration().densityDpi
                            ...
                            : currentUserResources.getDimensionPixelSize(
                                    R.dimen.progress_bar_size_small);
            int i2 = 0;
            while (true) {
                if (i2 >= 4) {
                    break;
