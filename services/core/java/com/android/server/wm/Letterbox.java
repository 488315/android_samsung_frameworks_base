...
public class Letterbox {
  ...
  public final boolean useFullWindowSurface() {
    return ((Boolean) this.mAreCornersRounded.get()).booleanValue()
        || ((Boolean) this.mHasWallpaperBackgroundSupplier.get()).booleanValue();
  }
  ...
  public final class TapEventReceiver extends InputEventReceiver {
    ...
    public TapEventReceiver(InputChannel inputChannel, Context context) {
      ...
      this.mDoubleTapDetector =
          new GestureDetector(context, doubleTapListener, UiThread.getHandler());
    }
  ...
  public class DoubleTapListener extends GestureDetector.SimpleOnGestureListener {
    ...
    public boolean onSingleTapUp(MotionEvent motionEvent) {
      ...
      if (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED_FOR_BOUNDS_COMPAT_UI_EXPERIENCE
          && (intConsumer = Letterbox.this.mSingleTapCallback) != null) {
  ...
  public final class InputInterceptor {
    ...
    public InputInterceptor(String str, WindowState windowState) {
      ...
      this.mInputEventReceiver =
          Letterbox.this.new TapEventReceiver(createInputChannel, windowManagerService.mContext);
      IBinder token = createInputChannel.getToken();
      this.mToken = token;
      InputWindowHandle inputWindowHandle =
          new InputWindowHandle((InputApplicationHandle) null, windowState.getDisplayId());
  ...
  public class LetterboxSurface {
    ...
    public final void createSurface(SurfaceControl.Transaction transaction) {
      SurfaceControl build =
          ((SurfaceControl.Builder) Letterbox.this.mSurfaceControlFactory.get())
    ...
    public void attachInput(WindowState windowState) {
      ...
      this.mInputInterceptor =
          Letterbox.this.new InputInterceptor("Letterbox_" + this.mType + "_", windowState);
    }
    ...
    public void applySurfaceChanges(SurfaceControl.Transaction transaction) {
      ...
      if (needsApplySurfaceChanges()) {
        ...
        if (!this.mSurfaceFrameRelative.isEmpty()
            && (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED_FOR_BOUNDS_COMPAT_UI_EXPERIENCE
                || !CoreRune.FW_CUSTOM_LETTERBOX
                || Letterbox.this.canHaveLetterboxSurface())) {
          if (this.mSurface == null) {
          ...
          this.mHasWallpaperBackground =
              ((Boolean) Letterbox.this.mHasWallpaperBackgroundSupplier.get()).booleanValue();
    ...
    public final void updateAlphaAndBlur(SurfaceControl.Transaction transaction) {
      ...
      transaction.setAlpha(
          this.mSurface, ((Float) Letterbox.this.mDarkScrimAlphaSupplier.get()).floatValue());
      if (((Integer) Letterbox.this.mBlurRadiusSupplier.get()).intValue() <= 0) {
        transaction.setBackgroundBlurRadius(this.mSurface, 0);
        return;
      }
      if (CoreRune.FW_BLUR_WALLPAPER_LETTERBOX
          && (supplier = Letterbox.this.mBlurColorCurveSupplier) != null
          && (colorCurve = (SemBlurInfo.ColorCurve) supplier.get()) != null) {
        transaction.setBackgroundBlurColorCurve(this.mSurface, colorCurve);
      }
      transaction.setBackgroundBlurRadius(
          this.mSurface, ((Integer) Letterbox.this.mBlurRadiusSupplier.get()).intValue());
    }
    ...
    public boolean needsApplySurfaceChanges() {
      return (this.mSurfaceFrameRelative.equals(this.mLayoutFrameRelative)
              && (this.mSurfaceFrameRelative.isEmpty()
                  || (((Boolean) Letterbox.this.mHasWallpaperBackgroundSupplier.get())
                              .booleanValue()
                          == this.mHasWallpaperBackground
                      && ((Color) Letterbox.this.mColorSupplier.get()).equals(this.mColor)
                      && Letterbox.this.mParentSurfaceSupplier.get() == this.mParentSurface)))
          ? false
          : true;
    }
  }
  ...
  public final void applyLetterboxSurfaceChanges(
      SurfaceControl.Transaction transaction, LetterboxSurface letterboxSurface) {
    if (letterboxSurface.mInputInterceptor == null) {
  ...
  public final void removeLetterboxSurface(
      SurfaceControl.Transaction transaction, LetterboxSurface letterboxSurface) {
  ...
  public int getDirection(int i, int i2, int i3, int i4) {
    ...
    if (i3 <= 0 || this.mTop.mSurfaceFrameRelative.isEmpty() || i3 != this.mTop.getHeight()) {
      return (i4 <= 0
              || this.mBottom.mSurfaceFrameRelative.isEmpty()
              || i4 != this.mBottom.getHeight())
          ? 0
          : 8;
    }
    return 4;
  ...
  public boolean reparentToWallpaperParentImmediately(
    ...
    if (!useFullWindowSurface()
        || this.mFullWindowSurface.mSurface == null
        || this.mFullWindowSurface.mSurfaceFrameRelative.isEmpty()) {
      return false;
    }
