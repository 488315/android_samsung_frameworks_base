...
public final /* synthetic */ class TransitionController$$ExternalSyntheticLambda2
        implements Consumer {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ Transition f$0;

    public /* synthetic */ TransitionController$$ExternalSyntheticLambda2(
            ...
            case 0:
                ...
                if (task.isVisible()) {
                    ...
                    if (CoreRune.MW_EMBED_ACTIVITY_ANIMATION && task.inFreeformWindowingMode()) {
                        ...
                        for (int size = task.mChildren.size() - 1; size >= 0; size--) {
                            WindowContainer windowContainer =
                                    (WindowContainer) task.mChildren.get(size);
                    ...
                    if (CoreRune.FW_SHELL_TRANSITION_BUG_FIX
                            && Flags.removePrepareSurfaceInPlacement()) {
                        task.forAllActivities(
                                new TransitionController$$ExternalSyntheticLambda2(transition, 1));
                        break;
                    }
                }
                break;
