...
public final class WindowManagerConstants {
  ...
  public WindowManagerConstants(
      ...
      DeviceConfigInterface deviceConfigInterface) {
    this(
        windowManagerService.mGlobalLock,
        new Runnable() { // from class:
                         // com.android.server.wm.WindowManagerConstants$$ExternalSyntheticLambda2
  ...
  public static /* synthetic */ void lambda$new$0(WindowManagerService windowManagerService) {
    windowManagerService.mRoot.forAllDisplays(
        new Consumer() { // from class:
                         // com.android.server.wm.WindowManagerConstants$$ExternalSyntheticLambda3
  ...
  public WindowManagerConstants(
    ...
    this.mListenerAndroid =
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.wm.WindowManagerConstants$$ExternalSyntheticLambda0
          public final void onPropertiesChanged(DeviceConfig.Properties properties) {
            WindowManagerConstants.this.onAndroidPropertiesChanged(properties);
          }
        };
    this.mListenerWindowManager =
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.wm.WindowManagerConstants$$ExternalSyntheticLambda1
          public final void onPropertiesChanged(DeviceConfig.Properties properties) {
  ...
  public void start(Executor executor) {
    ...
    this.mDeviceConfig.addOnPropertiesChangedListener(
        "window_manager", executor, this.mListenerWindowManager);
  ...
  */
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        for (String str : properties.getKeyset()) {
          ...
          if (str.hashCode() == -125834358
              && str.equals("system_gesture_exclusion_log_debounce_millis")) {
            c = 0;
            if (c != 0) {
              updateSystemGestureExclusionLogDebounceMillis();
            }
  ...
  public final void updateSystemGestureExclusionLogDebounceMillis() {
    this.mSystemGestureExclusionLogDebounceTimeoutMillis =
        this.mDeviceConfig.getLong(
            "window_manager", "system_gesture_exclusion_log_debounce_millis", 0L);
  }

  public final void updateSystemGestureExclusionLimitDp() {
    this.mSystemGestureExclusionLimitDp =
        Math.max(200, this.mDeviceConfig.getInt("android", "system_gesture_exclusion_limit_dp", 0));
  }

  public final void updateSystemGestureExcludedByPreQStickyImmersive() {
    this.mSystemGestureExcludedByPreQStickyImmersive =
        this.mDeviceConfig.getBoolean(
            "android", "system_gestures_excluded_by_pre_q_sticky_immersive", false);
  }
