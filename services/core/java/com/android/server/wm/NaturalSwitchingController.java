...
public class NaturalSwitchingController implements IController {
  ...
  public final void assignRelativeLayerForPipTask(IBinder iBinder) {
    ...
    if (windowState == null || windowState.getDisplayArea() == null) {
      Slog.w(
          "NaturalSwitchingController",
          "assignRelativeLayerForPipTask: failed, cannot find win, " + windowState);
      return;
    }
    ...
    if (parentSurfaceControl == null || !parentSurfaceControl.isValid()) {
      Slog.w(
          "NaturalSwitchingController",
          "assignRelativeLayerForPipTask: failed, invalid parent, " + parentSurfaceControl);
      return;
    }
    ...
    if (rootPinnedTask == null || !rootPinnedTask.isVisible()) {
      Slog.w(
          "NaturalSwitchingController",
          "assignRelativeLayerForPipTask: failed, wrong pip, " + rootPinnedTask);
      return;
    }
    Slog.d(
        "NaturalSwitchingController",
        "assignRelativeLayerForPipTask: tid #" + rootPinnedTask.mTaskId);
  ...
  public final void reassignPipTaskLayerIfNeeded() {
    if (this.mNaturalSwitchingPipTask != null) {
      Slog.d(
          "NaturalSwitchingController",
          "reassignPipTaskLayerIfNeeded: tid #" + this.mNaturalSwitchingPipTask.mTaskId);
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        if (findTaskForFreezerSnapshotLocked == null) {
          Slog.w(
              "NaturalSwitchingController",
              "getSurfaceFreezerSnapshot: failed, cannot find tid=" + i);
          WindowManagerService.resetPriorityAfterLockedSection();
          return null;
        }
        DisplayContent displayContent = findTaskForFreezerSnapshotLocked.getDisplayContent();
        if (displayContent != null
            && findTaskForFreezerSnapshotLocked.getDisplayArea() != null
            && findTaskForFreezerSnapshotLocked.getParentSurfaceControl() != null) {
          findTaskForFreezerSnapshotLocked.getBounds(this.mTmpRect);
          ScreenCapture.ScreenshotHardwareBuffer createSnapshotBuffer =
              SurfaceFreezer.createSnapshotBuffer(
                  findTaskForFreezerSnapshotLocked.getSurfaceControl(), this.mTmpRect);
          WindowState topVisibleAppMainWindow =
              findTaskForFreezerSnapshotLocked.getTopVisibleAppMainWindow();
          Bitmap screenshotWallpaperLocked =
              (topVisibleAppMainWindow == null || !topVisibleAppMainWindow.hasWallpaper())
                  ? null
                  : displayContent.mWallpaperController.screenshotWallpaperLocked(this.mTmpRect);
          WindowManagerService.resetPriorityAfterLockedSection();
          HardwareBuffer hardwareBuffer =
              createSnapshotBuffer != null ? createSnapshotBuffer.getHardwareBuffer() : null;
          if (hardwareBuffer == null
              || hardwareBuffer.getWidth() <= 1
              || hardwareBuffer.getHeight() <= 1) {
            Slog.w(
                "NaturalSwitchingController",
                "getSurfaceFreezerSnapshot: failed to get buffer, tid=" + i);
            return null;
          }
          GraphicBuffer createFromHardwareBuffer =
          ...
          Bitmap wrapHardwareBuffer =
              Bitmap.wrapHardwareBuffer(
                  HardwareBuffer.createFromGraphicBuffer(createFromHardwareBuffer), null);
          if (wrapHardwareBuffer == null) {
            Slog.w(
                "NaturalSwitchingController",
                "getSurfaceFreezerSnapshot: failed to create bitmap, tid=" + i);
            return null;
          }
          return new SurfaceFreezerSnapshot(
              wrapHardwareBuffer,
              i,
              containsSecureLayers,
              hasProtectedContent,
              screenshotWallpaperLocked);
        }
        Slog.w(
            "NaturalSwitchingController",
            "getSurfaceFreezerSnapshot: failed, not attached tid=" + i);
        WindowManagerService.resetPriorityAfterLockedSection();
        return null;
      } catch (Throwable th) {
        WindowManagerService.resetPriorityAfterLockedSection();
  ...
  public final Task findTaskForFreezerSnapshotLocked(int i) {
    ...
    if (anyTaskForId == null) {
      Slog.w(
          "NaturalSwitchingController",
          "findTaskForFreezerSnapshotLocked: failed, cannot find tid=" + i);
      return null;
    }
  ...
  public boolean preventNaturalSwitching(int i) {
    ...
    if (defaultTaskDisplayArea.isSplitScreenModeActivated()) {
      ...
      if (defaultTaskDisplayArea.getRootSideStageTask() != null
          && (topMostTask = defaultTaskDisplayArea.getRootSideStageTask().getTopMostTask()) != null
