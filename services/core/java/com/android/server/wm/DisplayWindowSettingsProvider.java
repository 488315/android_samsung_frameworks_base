...
public class DisplayWindowSettingsProvider implements DisplayWindowSettings.SettingsProvider {
  ...
  public DisplayWindowSettingsProvider() {
    this(
        new AtomicFileStorage(getVendorSettingsFile()),
  ...
  public DisplayWindowSettings.SettingsProvider.SettingsEntry getSettings(DisplayInfo displayInfo) {
    DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry =
        this.mBaseSettings.getSettingsEntry(displayInfo);
    ...
    DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry2 =
        new DisplayWindowSettings.SettingsProvider.SettingsEntry(settingsEntry);
    settingsEntry2.updateFrom(orCreateSettingsEntry);
    return settingsEntry2;
  }

  @Override // com.android.server.wm.DisplayWindowSettings.SettingsProvider
  public DisplayWindowSettings.SettingsProvider.SettingsEntry getOverrideSettings(
  ...
  public void updateOverrideSettings(
      DisplayInfo displayInfo, DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry) {
  ...
  public class ReadableSettings {
    ...
    public final DisplayWindowSettings.SettingsProvider.SettingsEntry getSettingsEntry(
        DisplayInfo displayInfo) {
      String identifier = getIdentifier(displayInfo);
      DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry =
          (DisplayWindowSettings.SettingsProvider.SettingsEntry) this.mSettings.get(identifier);
      if (settingsEntry != null) {
        return settingsEntry;
      }
      DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry2 =
          (DisplayWindowSettings.SettingsProvider.SettingsEntry)
              this.mSettings.get(displayInfo.name);
  ...
  public final class WritableSettings extends ReadableSettings {
    ...
    public DisplayWindowSettings.SettingsProvider.SettingsEntry getOrCreateSettingsEntry(
        DisplayInfo displayInfo) {
      String identifier = getIdentifier(displayInfo);
      DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry =
          (DisplayWindowSettings.SettingsProvider.SettingsEntry) this.mSettings.get(identifier);
      ...
      DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry3 =
    ...
    public void updateSettingsEntry(
        DisplayInfo displayInfo,
        DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry) {
  ...
  public static AtomicFile getOverrideSettingsFile() {
    return new AtomicFile(
        new File(Environment.getDataDirectory(), "system/display_settings.xml"), "wm-displays");
  }
  ...
  */
      ...
      while (true) {
        ...
        if (next2 == 1 || (next2 == 3 && resolvePullParser.getDepth() <= depth)) {
          ...
          if (name.equals("display")) {
            ...
            Slog.w(
                StartingSurfaceController.TAG,
                "Unknown element under <display-settings>: " + resolvePullParser.getName());
  ...
  public static Integer getIntegerAttribute(
      TypedXmlPullParser typedXmlPullParser, String str, Integer num) {
    try {
  ...
  public static Boolean getBooleanAttribute(
      TypedXmlPullParser typedXmlPullParser, String str, Boolean bool) {
    try {
  ...
  public static void readDisplay(TypedXmlPullParser typedXmlPullParser, FileData fileData) {
    ...
    if (attributeValue != null) {
      ...
      settingsEntry.mUserRotationMode =
          getIntegerAttribute(typedXmlPullParser, "userRotationMode", null);
      ...
      settingsEntry.mForcedScalingMode =
          getIntegerAttribute(typedXmlPullParser, "forcedScalingMode", null);
      settingsEntry.mRemoveContentMode =
          getIntAttribute(typedXmlPullParser, "removeContentMode", 0);
      settingsEntry.mShouldShowWithInsecureKeyguard =
          getBooleanAttribute(typedXmlPullParser, "shouldShowWithInsecureKeyguard", null);
      settingsEntry.mShouldShowSystemDecors =
          getBooleanAttribute(typedXmlPullParser, "shouldShowSystemDecors", null);
      ...
      settingsEntry.mFixedToUserRotation =
          getIntegerAttribute(typedXmlPullParser, "fixedToUserRotation", null);
      settingsEntry.mIgnoreOrientationRequest =
          getBooleanAttribute(typedXmlPullParser, "ignoreOrientationRequest", null);
      settingsEntry.mIgnoreDisplayCutout =
          getBooleanAttribute(typedXmlPullParser, "ignoreDisplayCutout", null);
  ...
  public static void writeSettings(
      WritableSettingsStorage writableSettingsStorage, FileData fileData) {
    try {
      ...
      try {
        try {
          ...
          for (Map.Entry entry : fileData.mSettings.entrySet()) {
            ...
            DisplayWindowSettings.SettingsProvider.SettingsEntry settingsEntry =
                (DisplayWindowSettings.SettingsProvider.SettingsEntry) entry.getValue();
            if (!settingsEntry.isEmpty()) {
              ...
              if (i2 != 0 && settingsEntry.mForcedHeight != 0) {
                ...
                resolveSerializer.attributeInt(
                    (String) null, "forcedHeight", settingsEntry.mForcedHeight);
              }
              ...
              if (bool != null) {
                resolveSerializer.attributeBoolean(
                    (String) null, "shouldShowWithInsecureKeyguard", bool.booleanValue());
              }
              Boolean bool2 = settingsEntry.mShouldShowSystemDecors;
              if (bool2 != null) {
                resolveSerializer.attributeBoolean(
                    (String) null, "shouldShowSystemDecors", bool2.booleanValue());
              }
              ...
              if (bool3 != null) {
                resolveSerializer.attributeBoolean(
                    (String) null, "ignoreOrientationRequest", bool3.booleanValue());
              }
              Boolean bool4 = settingsEntry.mIgnoreDisplayCutout;
              if (bool4 != null) {
                resolveSerializer.attributeBoolean(
                    (String) null, "ignoreDisplayCutout", bool4.booleanValue());
              }
