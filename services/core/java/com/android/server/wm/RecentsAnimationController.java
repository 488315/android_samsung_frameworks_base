...
public class RecentsAnimationController implements IBinder.DeathRecipient {
  ...
  public final Runnable mFailsafeRunnable =
      new Runnable() { // from class:
                       // com.android.server.wm.RecentsAnimationController$$ExternalSyntheticLambda0
  ...
  public final WindowManagerInternal.AppTransitionListener mAppTransitionListener =
      new WindowManagerInternal
          .AppTransitionListener() { // from class:
                                     // com.android.server.wm.RecentsAnimationController.1
        ...
        public final void continueDeferredCancel() {
          ...
          if (!RecentsAnimationController.this.mCanceled
              && RecentsAnimationController.this.mCancelOnNextTransitionStart) {
            ...
            recentsAnimationController.cancelAnimationWithScreenshot(
                recentsAnimationController.mCancelDeferredWithScreenshot);
          }
        }
      };
  public final IRecentsAnimationController mController =
      new IRecentsAnimationController
          .Stub() { // from class: com.android.server.wm.RecentsAnimationController.2
        public TaskSnapshot screenshotTask(int i) {
          if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
            ProtoLogImpl.d(
                ...
                184362060,
                13,
                "screenshotTask(%d): mCanceled=%b",
                new Object[] {
                  Long.valueOf(i), Boolean.valueOf(RecentsAnimationController.this.mCanceled)
                });
          }
          ...
          try {
            synchronized (RecentsAnimationController.this.mService.getWindowManagerLock()) {
              ...
              for (int size = RecentsAnimationController.this.mPendingAnimations.size() - 1;
                  size >= 0;
                  size--) {
                Task task =
                    ((TaskAnimationAdapter)
                            RecentsAnimationController.this.mPendingAnimations.get(size))
                        .mTask;
                if (task.mTaskId == i) {
                  TaskSnapshotController taskSnapshotController =
                      RecentsAnimationController.this.mService.mTaskSnapshotController;
        ...
        public void setFinishTaskTransaction(
          ...
          if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
            ProtoLogImpl.d(
                ...
                -163974242,
                1,
                "setFinishTaskTransaction(%d): transaction=%s",
                new Object[] {Long.valueOf(i), String.valueOf(pictureInPictureSurfaceTransaction)});
          }
          long clearCallingIdentity = Binder.clearCallingIdentity();
          try {
            synchronized (RecentsAnimationController.this.mService.getWindowManagerLock()) {
              ...
              while (true) {
                ...
                TaskAnimationAdapter taskAnimationAdapter =
                    (TaskAnimationAdapter)
                        RecentsAnimationController.this.mPendingAnimations.get(size);
        ...
        public void finish(boolean z, boolean z2) {
          if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
            ProtoLogImpl.d(
                ...
                -445944810,
                15,
                "finish(%b): mCanceled=%b",
                new Object[] {
                  Boolean.valueOf(z), Boolean.valueOf(RecentsAnimationController.this.mCanceled)
                });
          }
          long clearCallingIdentity = Binder.clearCallingIdentity();
          try {
        ...
        public void setInputConsumerEnabled(boolean z) {
          if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
            ProtoLogImpl.d(
                ...
                -1219773477,
                12,
                "setInputConsumerEnabled(%s): mCanceled=%b",
                new Object[] {
                  String.valueOf(z), Boolean.valueOf(RecentsAnimationController.this.mCanceled)
                });
          }
          long clearCallingIdentity = Binder.clearCallingIdentity();
          try {
            synchronized (RecentsAnimationController.this.mService.getWindowManagerLock()) {
              ...
              RecentsAnimationController.this
                  .mDisplayContent
                  .getInputMonitor()
        ...
        public void setDeferCancelUntilNextTransition(boolean z, boolean z2) {
          WindowManagerGlobalLock windowManagerGlobalLock =
              RecentsAnimationController.this.mService.mGlobalLock;
  ...
  public RecentsAnimationController(
      ...
      RecentsAnimationCallbacks recentsAnimationCallbacks,
      int i) {
  ...
  public void initialize(
      int i, SparseBooleanArray sparseBooleanArray, ActivityRecord activityRecord) {
    this.mTargetActivityType = i;
    this.mDisplayContent.mAppTransition.registerListenerLocked(this.mAppTransitionListener);
    final ArrayList visibleTasks =
        this.mDisplayContent.getDefaultTaskDisplayArea().getVisibleTasks();
    Task rootTask = this.mDisplayContent.getDefaultTaskDisplayArea().getRootTask(0, i);
    if (rootTask != null) {
      rootTask.forAllLeafTasks(
          new Consumer() { // from class:
                           // com.android.server.wm.RecentsAnimationController$$ExternalSyntheticLambda1
    ...
    for (int size = visibleTasks.size() - 1; size >= 0; size--) {
      ...
      if (!skipAnimation(task)) {
        ...
        addAnimation(
            task,
            !sparseBooleanArray.get(task.mTaskId),
            false,
            new SurfaceAnimator
                .OnAnimationFinishedCallback() { // from class:
                                                 // com.android.server.wm.RecentsAnimationController$$ExternalSyntheticLambda2
    ...
    try {
      ...
      if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
        ProtoLogImpl.d(
            ...
            0,
            "setHomeApp(%s)",
            new Object[] {String.valueOf(activityRecord.getName())});
      }
  ...
  public static /* synthetic */ void lambda$initialize$2(
      Task task, final int i, final AnimationAdapter animationAdapter) {
    task.forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.RecentsAnimationController$$ExternalSyntheticLambda3
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public boolean isInterestingForAllDrawn(WindowState windowState) {
    return (isTargetApp(windowState.getActivityRecord())
            && windowState.getWindowType() != 1
            && windowState.getAttrs().alpha == DisplayPowerController2.RATE_FROM_DOZE_TO_ON)
        ? false
        : true;
  }
  ...
  public TaskAnimationAdapter addAnimation(
      Task task,
      boolean z,
      boolean z2,
    ...
    if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
      ProtoLogImpl.d(
          ...
          0,
          "addAnimation(%s)",
          new Object[] {String.valueOf(task.getName())});
    }
    TaskAnimationAdapter taskAnimationAdapter = new TaskAnimationAdapter(task, z);
    task.startAnimation(
        task.getPendingTransaction(), taskAnimationAdapter, z2, 8, onAnimationFinishedCallback);
  ...
  public void removeAnimation(TaskAnimationAdapter taskAnimationAdapter) {
    if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
      ProtoLogImpl.d(
          ...
          1,
          "removeAnimation(%d)",
          new Object[] {Long.valueOf(taskAnimationAdapter.mTask.mTaskId)});
    }
  ...
  public void startAnimation() {
    ...
    if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
      ProtoLogImpl.d(
          ...
          17696244,
          15,
          "startAnimation(): mPendingStart=%b mCanceled=%b",
          new Object[] {Boolean.valueOf(this.mPendingStart), Boolean.valueOf(this.mCanceled)});
    }
    ...
    if (targetAppMainWindow != null) {
      rect =
          targetAppMainWindow
              ...
              .calculateInsets(
                  this.mTargetActivityRecord.getBounds(), WindowInsets.Type.systemBars(), false)
              .toRect();
    } else {
      this.mService.getStableInsets(this.mDisplayId, this.mTmpRect);
      rect = this.mTmpRect;
    }
    this.mRunner.onAnimationStart(
        this.mController, createAppAnimations, createWallpaperAnimations, rect, (Rect) null);
    if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
      ProtoLogImpl.d(
          ProtoLogGroup.WM_DEBUG_RECENTS_ANIMATIONS,
          -1207757583,
          ...
          new Object[] {
            String.valueOf(
                this.mPendingAnimations.stream()
                    .map(
                        new Function() { // from class:
                                         // com.android.server.wm.RecentsAnimationController$$ExternalSyntheticLambda5
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            Integer lambda$startAnimation$3;
                            lambda$startAnimation$3 =
                                RecentsAnimationController.lambda$startAnimation$3(
                                    (RecentsAnimationController.TaskAnimationAdapter) obj);
    ...
    if (this.mTargetActivityRecord != null) {
      ...
      this.mService
          ...
          .notifyTransitionStarting(arrayMap);
    }
  }

  public static /* synthetic */ Integer lambda$startAnimation$3(
      TaskAnimationAdapter taskAnimationAdapter) {
  ...
  public final void attachNavigationBarToApp() {
    ...
    if (this.mDisplayContent.getDisplayPolicy().shouldAttachNavBarToAppDuringTransition()
        && this.mDisplayContent.getAsyncRotationController() == null) {
      ...
      if (this.mNavBarAttachedApp == null
          || navigationBarWindow == null
          || (windowToken = navigationBarWindow.mToken) == null) {
        return;
      }
      this.mNavigationBarAttachedToApp = true;
      windowToken.cancelAnimation();
      SurfaceControl.Transaction pendingTransaction =
          navigationBarWindow.mToken.getPendingTransaction();
  ...
  public void animateNavigationBarForAppLaunch(long j) {
    if (!this.mDisplayContent.getDisplayPolicy().shouldAttachNavBarToAppDuringTransition()
        || this.mDisplayContent.getAsyncRotationController() != null
        || this.mNavigationBarAttachedToApp
        || this.mNavBarAttachedApp == null) {
      return;
    }
    new NavBarFadeAnimationController(this.mDisplayContent)
        .fadeOutAndInSequentially(j, null, this.mNavBarAttachedApp.getSurfaceControl());
  }

  public void addTaskToTargets(
      Task task, SurfaceAnimator.OnAnimationFinishedCallback onAnimationFinishedCallback) {
  ...
  public void sendTasksAppeared() {
    ...
    try {
      this.mRunner.onTasksAppeared(
          (RemoteAnimationTarget[]) this.mPendingTaskAppears.toArray(new RemoteAnimationTarget[0]));
  ...
  public final void collectTaskRemoteAnimations(
      Task task,
      final int i,
      final SurfaceAnimator.OnAnimationFinishedCallback onAnimationFinishedCallback) {
    final SparseBooleanArray recentTaskIds =
        this.mService.mAtmService.getRecentTasks().getRecentTaskIds();
    task.forAllLeafTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RecentsAnimationController$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RecentsAnimationController.this.lambda$collectTaskRemoteAnimations$4(
                recentTaskIds, onAnimationFinishedCallback, i, (Task) obj);
          }
        },
        false);
  }
  ...
  public /* synthetic */ void lambda$collectTaskRemoteAnimations$4(
    ...
    if (task.shouldBeVisible(null)) {
      int i2 = task.mTaskId;
      TaskAnimationAdapter addAnimation =
          addAnimation(task, !sparseBooleanArray.get(i2), true, onAnimationFinishedCallback);
      this.mPendingNewTaskTargets.add(i2);
      RemoteAnimationTarget createRemoteAnimationTarget =
          addAnimation.createRemoteAnimationTarget(i2, i);
      if (createRemoteAnimationTarget != null) {
        ...
        if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
          ProtoLogImpl.d(
              ...
              1151072840,
              0,
              "collectTaskRemoteAnimations, target: %s",
              new Object[] {String.valueOf(createRemoteAnimationTarget)});
        }
      }
    }
  }
  ...
  public final boolean removeTaskInternal(int i) {
    for (int size = this.mPendingAnimations.size() - 1; size >= 0; size--) {
      TaskAnimationAdapter taskAnimationAdapter =
          (TaskAnimationAdapter) this.mPendingAnimations.get(size);
  ...
  public final RemoteAnimationTarget[] createAppAnimations() {
    ...
    for (int size = this.mPendingAnimations.size() - 1; size >= 0; size--) {
      TaskAnimationAdapter taskAnimationAdapter =
          (TaskAnimationAdapter) this.mPendingAnimations.get(size);
      RemoteAnimationTarget createRemoteAnimationTarget =
          taskAnimationAdapter.createRemoteAnimationTarget(-1, -1);
      if (createRemoteAnimationTarget != null) {
  ...
  public final RemoteAnimationTarget[] createWallpaperAnimations() {
    ...
    return WallpaperAnimationAdapter.startWallpaperAnimations(
        ...
        0L,
        new Consumer() { // from class:
                         // com.android.server.wm.RecentsAnimationController$$ExternalSyntheticLambda6
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RecentsAnimationController.this.lambda$createWallpaperAnimations$5(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$createWallpaperAnimations$5(
  ...
  public void cancelAnimationForHomeStart() {
    cancelAnimation(
        (this.mTargetActivityType == 2 && this.mWillFinishToHome) ? 1 : 0,
        true,
  ...
  public final void cancelAnimation(int i, boolean z, String str) {
    ...
    synchronized (this.mService.getWindowManagerLock()) {
      ...
      this.mService.f1749mH.removeCallbacks(this.mFailsafeRunnable);
      this.mCanceled = true;
  ...
  public void cleanupAnimation(int i) {
    if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
      ProtoLogImpl.d(
          ...
          -1434147454,
          5,
          "cleanupAnimation(): Notify animation finished mPendingAnimations=%d reorderMode=%d",
          new Object[] {Long.valueOf(this.mPendingAnimations.size()), Long.valueOf(i)});
    }
  ...
  public void scheduleFailsafe() {
    this.mService.f1749mH.postDelayed(this.mFailsafeRunnable, 1000L);
  }
  ...
  public boolean isWallpaperVisible(WindowState windowState) {
    ...
    return windowState != null
        ...
        && (((activityRecord = windowState.mActivityRecord) != null
                && this.mTargetActivityRecord == activityRecord)
            || isAnimatingTask(windowState.getTask()))
        && isTargetOverWallpaper()
        && windowState.isOnScreen();
  }

  public boolean shouldApplyInputConsumer(ActivityRecord activityRecord) {
    return this.mInputConsumerEnabled
        && activityRecord != null
        && !isTargetApp(activityRecord)
        && isAnimatingApp(activityRecord);
  }
  ...
  public final boolean isAnimatingApp(ActivityRecord activityRecord) {
    for (int size = this.mPendingAnimations.size() - 1; size >= 0; size--) {
      if (activityRecord.isDescendantOf(
          ((TaskAnimationAdapter) this.mPendingAnimations.get(size)).mTask)) {
        return true;
      }
    }
    return false;
  ...
  class TaskAnimationAdapter implements AnimationAdapter {
    ...
    public RemoteAnimationTarget createRemoteAnimationTarget(int i, int i2) {
      ...
      WindowState findMainWindow =
          topRealVisibleActivity != null ? topRealVisibleActivity.findMainWindow() : null;
      ...
      Rect rect =
          findMainWindow
              .getInsetsStateWithVisibilityOverride()
              .calculateInsets(this.mBounds, WindowInsets.Type.systemBars(), false)
              .toRect();
      ...
      if (i2 != -1) {
        ...
        i3 =
            topRealVisibleActivity.getActivityType()
                    == RecentsAnimationController.this.mTargetActivityType
                ? 0
                : 1;
      }
      ...
      this.mTarget =
          new RemoteAnimationTarget(
              ...
              rect,
              prefixOrderIndex,
              new Point(rect3.left, rect3.top),
              this.mLocalBounds,
              this.mBounds,
              this.mTask.getWindowConfiguration(),
              this.mIsRecentTaskInvisible,
              (SurfaceControl) null,
              (Rect) null,
              this.mTask.getTaskInfo(),
              topRealVisibleActivity.checkEnterPictureInPictureAppOpsState());
      ActivityRecord topNonFinishingActivity = this.mTask.getTopNonFinishingActivity();
      if (topNonFinishingActivity != null
          && (startingData = topNonFinishingActivity.mStartingData) != null
    ...
    public void setSnapshotOverlay(TaskSnapshot taskSnapshot) {
      ...
      this.mSnapshotOverlay =
          ((SurfaceControl.Builder)
                  RecentsAnimationController.this.mService.mSurfaceControlFactory.apply(
                      new SurfaceSession()))
              .setName("RecentTaskScreenshotSurface")
              .setCallsite("TaskAnimationAdapter.setSnapshotOverlay")
              .setFormat(hardwareBuffer.getFormat())
              .setParent(this.mCapturedLeash)
              .setBLASTLayer()
              .build();
      float width = (this.mTask.getBounds().width() * 1.0f) / hardwareBuffer.getWidth();
      this.mTask
          .getPendingTransaction()
          .setBuffer(this.mSnapshotOverlay, GraphicBuffer.createFromHardwareBuffer(hardwareBuffer))
          .setColorSpace(this.mSnapshotOverlay, taskSnapshot.getColorSpace())
          .setLayer(this.mSnapshotOverlay, Integer.MAX_VALUE)
          .setMatrix(
              this.mSnapshotOverlay,
              width,
    ...
    public void onCleanup() {
      ...
      if (this.mFinishTransaction != null) {
        ...
        PictureInPictureSurfaceTransaction.apply(
            this.mFinishTransaction, this.mTask.mSurfaceControl, pendingTransaction);
        this.mTask.setLastRecentsAnimationTransaction(this.mFinishTransaction, this.mFinishOverlay);
        if (RecentsAnimationController.this.mDisplayContent.isFixedRotationLaunchingApp(
            RecentsAnimationController.this.mTargetActivityRecord)) {
          RecentsAnimationController.this.mDisplayContent.mPinnedTaskController
              .setEnterPipTransaction(this.mFinishTransaction);
        }
        if (this.mTask.getActivityType() != RecentsAnimationController.this.mTargetActivityType
            && this.mFinishTransaction.getShouldDisableCanAffectSystemUiFlags()) {
  ...
  public void dump(PrintWriter printWriter, String str) {
    ...
    printWriter.print(str);
    printWriter.println(
        RecentsAnimationController.class.getSimpleName() + XmlUtils.STRING_ARRAY_SEPARATOR);
    ...
    printWriter.print(str2);
    printWriter.println(
        "mRequestDeferCancelUntilNextTransition=" + this.mRequestDeferCancelUntilNextTransition);
    printWriter.print(str2);
    ...
    printWriter.print(str2);
    printWriter.println(
        "mPendingCancelWithScreenshotReorderMode=" + this.mPendingCancelWithScreenshotReorderMode);
  }
}
