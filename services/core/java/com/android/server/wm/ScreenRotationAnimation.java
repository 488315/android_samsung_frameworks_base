...
public class ScreenRotationAnimation {
  ...
  public ScreenRotationAnimation(DisplayContent displayContent, int i) {
    ...
    if (CoreRune.FW_BLACK_SNAPSHOT_TRANSITION) {
      ...
      if (CoreRune.SAFE_DEBUG && shouldHasBlackSnapshot) {
        Slog.d(
            ...
            "BlackScreenshot is triggered, isScreenTurnedOn="
                + windowManagerService.mExt.mPolicyExt.isScreenTurnedOn());
      }
    }
      ...
      if (CoreRune.FW_BLACK_SNAPSHOT_TRANSITION && this.mHasBlackSnapshot) {
        ...
        if (z4) {
          ...
          if (!(physical instanceof DisplayAddress.Physical)) {
            Slog.e(
                StartingSurfaceController.TAG,
                "Display does not have a physical address: " + displayId);
            return;
          }
          IBinder physicalDisplayToken =
              DisplayControl.getPhysicalDisplayToken(physical.getPhysicalDisplayId());
          ...
          captureLayers =
              ScreenCapture.captureDisplay(
                  new ScreenCapture.DisplayCaptureArgs.Builder(physicalDisplayToken)
          ...
          captureLayers =
              ScreenCapture.captureLayers(
                  new ScreenCapture.LayerCaptureArgs.Builder(displayContent.getSurfaceControl())
                      .setCaptureSecureLayers(true)
                      .setAllowProtected(true)
                      .setSourceCrop(new Rect(0, 0, width, height))
                      .setHintForSeamlessTransition(true)
        ...
        if (captureLayers == null) {
          Slog.w(
              StartingSurfaceController.TAG, "Unable to take screenshot of display " + displayId);
          return;
        }
        ...
        this.mStartLuma =
            TransitionAnimation.getBorderLuma(hardwareBuffer, captureLayers.getColorSpace());
        Trace.traceEnd(32L);
    ...
    if (this.mScreenshotLayer == null || !z4) {
      ...
      displayContent
          ...
          .setGeometry(
              this.mScreenshotLayer,
              new Rect(0, 0, this.mOriginalWidth, this.mOriginalHeight),
              new Rect(0, 0, i6, i7),
              0);
    }
    if (ProtoLogCache.WM_SHOW_SURFACE_ALLOC_enabled) {
      ProtoLogImpl.i(
          ...
          i2,
          (String) null,
          new Object[] {String.valueOf(this.mScreenshotLayer)});
    }
    if (i == i3) {
  ...
  public void setSkipScreenshotForRoundedCornerOverlays(
      final boolean z, final SurfaceControl.Transaction transaction) {
    this.mDisplayContent.forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.ScreenRotationAnimation$$ExternalSyntheticLambda0
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            ScreenRotationAnimation.lambda$setSkipScreenshotForRoundedCornerOverlays$0(
                transaction, z, (WindowState) obj);
          }
        },
        false);
    if (z) {
  ...
  public static /* synthetic */ void lambda$setSkipScreenshotForRoundedCornerOverlays$0(
      SurfaceControl.Transaction transaction, boolean z, WindowState windowState) {
    if (windowState.mToken.mRoundedCornerOverlay
        && windowState.isVisible()
        && windowState.mWinAnimator.hasSurface()) {
  ...
  public void setRotation(SurfaceControl.Transaction transaction, int i) {
    this.mCurRotation = i;
    CoordinateTransforms.computeRotationMatrix(
        RotationUtils.deltaRotation(i, this.mOriginalRotation),
        this.mOriginalWidth,
        this.mOriginalHeight,
        this.mSnapshotInitialMatrix);
    setRotationTransform(transaction, this.mSnapshotInitialMatrix);
  }
  ...
  */
  public final boolean startAnimation(
      SurfaceControl.Transaction transaction, long j, float f, int i, int i2, int i3, int i4) {
    boolean z;
    if (this.mScreenshotLayer == null) {
      return false;
    }
    ...
    if (i3 != 0 && i4 != 0) {
      ...
      if (!CoreRune.FW_BLACK_SNAPSHOT_TRANSITION || !this.mHasBlackSnapshot) {
        this.mRotateAlphaAnimation =
            AnimationUtils.loadAnimation(
                this.mContext, R.anim.ft_avd_tooverflow_rectangle_path_2_animation);
        z = true;
        if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
          ProtoLogImpl.d(
              ...
              new Object[] {
                String.valueOf(z),
                String.valueOf(Surface.rotationToString(this.mCurRotation)),
                String.valueOf(Surface.rotationToString(this.mOriginalRotation))
              });
        }
        ...
        if (z && this.mEnteringBlackFrame == null) {
          try {
            this.mEnteringBlackFrame =
                new BlackFrame(
                    this.mService.mTransactionFactory,
                    transaction,
                    new Rect(-i, -i2, i * 2, i2 * 2),
                    new Rect(0, 0, i, i2),
                    2010000,
      ...
      this.mRotateExitAnimation =
          AnimationUtils.loadAnimation(
              this.mContext, R.anim.ft_avd_tooverflow_rectangle_2_pivot_animation);
      this.mRotateEnterAnimation =
          AnimationUtils.loadAnimation(this.mContext, R.anim.task_fragment_clear_top_close_enter);
    } else if (deltaRotation == 1) {
      this.mRotateExitAnimation =
          AnimationUtils.loadAnimation(this.mContext, R.anim.ic_bluetooth_transient_animation_2);
      this.mRotateEnterAnimation =
          AnimationUtils.loadAnimation(
              this.mContext,
              CoreRune.FW_CUSTOM_BASIC_ANIM
                  ? R.anim.voice_layer_exit
                  : R.anim.ic_bluetooth_transient_animation_1);
    } else if (deltaRotation == 2) {
      this.mRotateExitAnimation =
          AnimationUtils.loadAnimation(
              this.mContext, R.anim.ft_avd_tooverflow_rectangle_3_pivot_animation);
      this.mRotateEnterAnimation =
          AnimationUtils.loadAnimation(
              this.mContext,
              CoreRune.FW_CUSTOM_BASIC_ANIM
                  ? R.anim.voice_activity_open_exit
                  : R.anim.ft_avd_tooverflow_rectangle_3_animation);
    } else if (deltaRotation == 3) {
      this.mRotateExitAnimation =
          AnimationUtils.loadAnimation(this.mContext, R.anim.ic_bluetooth_transient_animation_0);
      this.mRotateEnterAnimation =
          AnimationUtils.loadAnimation(
              this.mContext,
              CoreRune.FW_CUSTOM_BASIC_ANIM
                  ? R.anim.voice_layer_enter
  ...
  public boolean dismiss(
    ...
    if (!this.mStarted) {
      this.mEndLuma =
          TransitionAnimation.getBorderLuma(this.mDisplayContent.getWindowingLayer(), i, i2);
  ...
  public void kill() {
    SurfaceRotationAnimationController surfaceRotationAnimationController =
        this.mSurfaceRotationAnimationController;
    ...
    if (surfaceControl != null) {
      if (ProtoLogCache.WM_SHOW_SURFACE_ALLOC_enabled) {
        ProtoLogImpl.i(
            ...
            0,
            (String) null,
            new Object[] {String.valueOf(surfaceControl)});
      }
      SurfaceControl.Transaction transaction =
      ...
      if (this.mRoundedCornerOverlay != null) {
        if (this.mDisplayContent.getRotationAnimation() == null
            || this.mDisplayContent.getRotationAnimation() == this) {
  ...
  public boolean isAnimating() {
    SurfaceRotationAnimationController surfaceRotationAnimationController =
        this.mSurfaceRotationAnimationController;
    return surfaceRotationAnimationController != null
  ...
  public class SurfaceRotationAnimationController {
    ...
    public final SimpleSurfaceAnimatable.Builder initializeBuilder() {
      ...
      SimpleSurfaceAnimatable.Builder syncTransactionSupplier =
          builder.setSyncTransactionSupplier(
              new Supplier() { // from class:
                               // com.android.server.wm.ScreenRotationAnimation$SurfaceRotationAnimationController$$ExternalSyntheticLambda1
      ...
      SimpleSurfaceAnimatable.Builder pendingTransactionSupplier =
          syncTransactionSupplier.setPendingTransactionSupplier(
              new Supplier() { // from class:
                               // com.android.server.wm.ScreenRotationAnimation$SurfaceRotationAnimationController$$ExternalSyntheticLambda2
                @Override // java.util.function.Supplier
                public final Object get() {
      ...
      SimpleSurfaceAnimatable.Builder commitTransactionRunnable =
          pendingTransactionSupplier.setCommitTransactionRunnable(
              new Runnable() { // from class:
                               // com.android.server.wm.ScreenRotationAnimation$SurfaceRotationAnimationController$$ExternalSyntheticLambda3
      ...
      return commitTransactionRunnable.setAnimationLeashSupplier(
          new Supplier() { // from class:
                           // com.android.server.wm.ScreenRotationAnimation$SurfaceRotationAnimationController$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
    ...
    public final SurfaceAnimator startDisplayRotation() {
      SurfaceAnimator startAnimation =
          startAnimation(
              initializeBuilder()
                  .setAnimationLeashParent(
                      ScreenRotationAnimation.this.mDisplayContent.getSurfaceControl())
                  .setSurfaceControl(
                      ScreenRotationAnimation.this.mDisplayContent.getWindowingLayer())
                  .setParentSurfaceControl(
                      ScreenRotationAnimation.this.mDisplayContent.getSurfaceControl())
                  .setWidth(ScreenRotationAnimation.this.mDisplayContent.getSurfaceWidth())
                  .setHeight(ScreenRotationAnimation.this.mDisplayContent.getSurfaceHeight())
                  .build(),
              createWindowAnimationSpec(ScreenRotationAnimation.this.mRotateEnterAnimation),
              new C2967x5a652b8e(this));
      Rect bounds = ScreenRotationAnimation.this.mDisplayContent.getBounds();
      ScreenRotationAnimation.this
          .mDisplayContent
          .getPendingTransaction()
          .setWindowCrop(startAnimation.mLeash, bounds.width(), bounds.height());
    ...
    public final SurfaceAnimator startScreenshotAlphaAnimation() {
      return startAnimation(
          initializeBuilder()
              .setSurfaceControl(ScreenRotationAnimation.this.mScreenshotLayer)
              .setAnimationLeashParent(
                  ScreenRotationAnimation.this.mDisplayContent.getOverlayLayer())
              .setWidth(ScreenRotationAnimation.this.mDisplayContent.getSurfaceWidth())
              .setHeight(ScreenRotationAnimation.this.mDisplayContent.getSurfaceHeight())
              .build(),
          createWindowAnimationSpec(ScreenRotationAnimation.this.mRotateAlphaAnimation),
          new C2967x5a652b8e(this));
    }
    ...
    public final SurfaceAnimator startEnterBlackFrameAnimation() {
      return startAnimation(
          initializeBuilder()
              .setSurfaceControl(ScreenRotationAnimation.this.mEnterBlackFrameLayer)
              .setAnimationLeashParent(
                  ScreenRotationAnimation.this.mDisplayContent.getOverlayLayer())
              .build(),
          createWindowAnimationSpec(ScreenRotationAnimation.this.mRotateEnterAnimation),
      ...
      return startAnimation(
          initializeBuilder()
              ...
              .setAnimationLeashParent(
                  ScreenRotationAnimation.this.mDisplayContent.getOverlayLayer())
              .build(),
          createWindowAnimationSpec(ScreenRotationAnimation.this.mRotateExitAnimation),
          new C2967x5a652b8e(this));
    }

    public final void startColorAnimation() {
      if (CoreRune.FW_BLACK_SNAPSHOT_TRANSITION
          && ScreenRotationAnimation.this.mBackColorSurface == null) {
        return;
      }
      final int integer =
          ScreenRotationAnimation.this
              .mContext
              .getResources()
              .getInteger(R.integer.config_screenshotChordKeyTimeout);
      SurfaceAnimationRunner surfaceAnimationRunner =
          ScreenRotationAnimation.this.mService.mSurfaceAnimationRunner;
      final float[] fArr = new float[3];
      final int rgb =
          Color.rgb(
              ScreenRotationAnimation.this.mStartLuma,
              ScreenRotationAnimation.this.mStartLuma,
              ScreenRotationAnimation.this.mStartLuma);
      final int rgb2 =
          Color.rgb(
              ...
              ScreenRotationAnimation.this.mEndLuma,
              ScreenRotationAnimation.this.mEndLuma);
      final long currentAnimatorScale =
          integer * ((long) ScreenRotationAnimation.this.mService.getCurrentAnimatorScale());
      ...
      surfaceAnimationRunner.startAnimation(
          new LocalAnimationAdapter
              .AnimationSpec() { // from class:
                                 // com.android.server.wm.ScreenRotationAnimation.SurfaceRotationAnimationController.1
                  ...
                  Color.valueOf(
                      ((Integer)
                              argbEvaluator.evaluate(
                                  getFraction(j), Integer.valueOf(rgb), Integer.valueOf(rgb2)))
                          .intValue());
              fArr[0] = valueOf.red();
          ...
          ScreenRotationAnimation.this.mBackColorSurface,
          ScreenRotationAnimation.this.mDisplayContent.getPendingTransaction(),
          null);
    }

    public final WindowAnimationSpec createWindowAnimationSpec(Animation animation) {
      return new WindowAnimationSpec(
          animation, new Point(0, 0), false, DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
    }

    public final SurfaceAnimator startAnimation(
      ...
      SurfaceAnimator surfaceAnimator =
          new SurfaceAnimator(
              animatable, onAnimationFinishedCallback, ScreenRotationAnimation.this.mService);
      surfaceAnimator.startAnimation(
          ScreenRotationAnimation.this.mDisplayContent.getPendingTransaction(),
          new LocalAnimationAdapter(
              animationSpec, ScreenRotationAnimation.this.mService.mSurfaceAnimationRunner),
          false,
          2);
    ...
    public final void onAnimationEnd(int i, AnimationAdapter animationAdapter) {
      WindowManagerGlobalLock windowManagerGlobalLock =
          ScreenRotationAnimation.this.mService.mGlobalLock;
      ...
      synchronized (windowManagerGlobalLock) {
        try {
            ...
            if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
              ...
              String valueOf =
                  String.valueOf(
                      surfaceAnimator != null
                          ? Boolean.valueOf(surfaceAnimator.isAnimating())
                          : null);
              SurfaceAnimator surfaceAnimator2 = this.mEnterBlackFrameAnimator;
              String valueOf2 =
                  String.valueOf(
                      surfaceAnimator2 != null
                          ? Boolean.valueOf(surfaceAnimator2.isAnimating())
                          : null);
              SurfaceAnimator surfaceAnimator3 = this.mRotateScreenAnimator;
              String valueOf3 =
                  String.valueOf(
                      surfaceAnimator3 != null
                          ? Boolean.valueOf(surfaceAnimator3.isAnimating())
                          : null);
              ...
              ProtoLogImpl.v(
                  ...
                  new Object[] {
                    ...
                    valueOf3,
                    String.valueOf(
                        surfaceAnimator4 != null
                            ? Boolean.valueOf(surfaceAnimator4.isAnimating())
                            : null)
                  });
            }
          ...
          if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
            ProtoLogImpl.d(
                ProtoLogGroup.WM_DEBUG_ORIENTATION, 200829729, 0, (String) null, (Object[]) null);
          }
          ...
          ScreenRotationAnimation rotationAnimation =
              ScreenRotationAnimation.this.mDisplayContent.getRotationAnimation();
          ...
          if (rotationAnimation == screenRotationAnimation) {
            ...
            if (ScreenRotationAnimation.this.mDisplayContent.mDisplayRotationCompatPolicy != null) {
              ScreenRotationAnimation.this.mDisplayContent.mDisplayRotationCompatPolicy
    ...
    public void cancel() {
      ...
      if (ScreenRotationAnimation.this.mBackColorSurface != null) {
        ScreenRotationAnimation.this.mService.mSurfaceAnimationRunner.onAnimationCancelled(
            ScreenRotationAnimation.this.mBackColorSurface);
      }
    }
    ...
    public boolean isAnimating() {
      ...
      SurfaceAnimator surfaceAnimator4 = this.mDisplayAnimator;
      return (surfaceAnimator4 != null && surfaceAnimator4.isAnimating())
          || ((surfaceAnimator = this.mEnterBlackFrameAnimator) != null
              && surfaceAnimator.isAnimating())
          || (((surfaceAnimator2 = this.mRotateScreenAnimator) != null
                  && surfaceAnimator2.isAnimating())
              || ((surfaceAnimator3 = this.mScreenshotRotationAnimator) != null
                  && surfaceAnimator3.isAnimating()));
    }
  }
  ...
  public final boolean shouldHasBlackSnapshot() {
    ...
    if (displayContent.getDisplayId() == 2
        && this.mService.mAtmService.mDexController.getDexModeLocked() == 2) {
      return false;
    }
