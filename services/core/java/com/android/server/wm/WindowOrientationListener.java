...
public abstract class WindowOrientationListener {
    ...
    public boolean shouldStayEnabledWhileDreaming() {
        if (this.mContext.getResources().getBoolean(R.bool.config_enableServerNotificationEffectsForAutomotive)) {
            return true;
        }
    ...
    public final class AccelSensorJudge extends OrientationJudge {
        ...
        public AccelSensorJudge(Context context) {
            ...
            int[] intArray = context.getResources().getIntArray(R.array.config_notificationSignalExtractors);
        ...
        */
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            synchronized (WindowOrientationListener.this.mLock) {
                ...
                if (j >= j2 && j <= j2 + 1000000000 && (f != DisplayPowerController2.RATE_FROM_DOZE_TO_ON || f2 != DisplayPowerController2.RATE_FROM_DOZE_TO_ON || f3 != DisplayPowerController2.RATE_FROM_DOZE_TO_ON)) {
                        ...
                        if (sqrt < 1.0f) {
                            ...
                            if (this.mOverhead) {
                                ...
                                if (isTiltAngleAcceptableLocked(i3, round) && isOrientationAngleAcceptableLocked(i3, round2)) {
                                    ...
                                    if (WindowOrientationListener.LOG) {
                                        Slog.v("WindowOrientationListener", "Predicted: tiltAngle=" + round + ", orientationAngle=" + round2 + ", predictedRotation=" + this.mPredictedRotation + ", predictedRotationAgeMS=" + ((j - this.mPredictedRotationTimestampNanos) * 1.0E-6f));
                                    }
                                } else {
                                    if (WindowOrientationListener.LOG) {
