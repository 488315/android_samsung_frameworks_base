...
public final class VrController {
  ...
  public final IPersistentVrStateCallbacks mPersistentVrModeListener =
      new IPersistentVrStateCallbacks.Stub() { // from class: com.android.server.wm.VrController.1
  ...
  public void setPersistentVrThreadLocked(
      int i, int i2, WindowProcessController windowProcessController) {
    if (!hasPersistentVrFlagSet()) {
  ...
  public final boolean changeVrModeLocked(
      boolean z, WindowProcessController windowProcessController) {
    int i = this.mVrState;
    if (z) {
      this.mVrState |= 1;
    } else {
  ...
  public final int setPersistentVrRenderThreadLocked(int i, boolean z) {
    if (!hasPersistentVrFlagSet()) {
      if (!z) {
        Slog.w(
            "VrController",
            "Failed to set persistent VR thread, system not in persistent VR mode.");
      }
      return this.mVrRenderThreadTid;
    }
        ...
        Slog.w(
            ...
            "Failed to set VR thread, "
                + (!inVrMode
                    ...
                    : hasPersistentVrFlagSet
                        ? "system in persistent VR mode."
                        : "caller is not the current top application."));
      }
      return this.mVrRenderThreadTid;
    }
    return updateVrRenderThreadLocked(i, z);
  ...
  public void dumpDebug(ProtoOutputStream protoOutputStream, long j) {
    ...
    ProtoUtils.writeBitWiseFlagsToProtoEnum(
        protoOutputStream, 2259152797697L, this.mVrState, ORIG_ENUMS, PROTO_ENUMS);
