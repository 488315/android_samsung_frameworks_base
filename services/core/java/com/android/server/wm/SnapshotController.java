...
public class SnapshotController {
  ...
  public final ActivityOrderCheck.AnalysisResult mResultHandler =
      new ActivityOrderCheck
          .AnalysisResult() { // from class:
                              // com.android.server.wm.SnapshotController$$ExternalSyntheticLambda0
        @Override // com.android.server.wm.SnapshotController.ActivityOrderCheck.AnalysisResult
        public final void onCheckResult(
            int i, ActivityRecord activityRecord, ActivityRecord activityRecord2) {
  ...
  public class ActivityOrderCheck {
    ...
    public void analysisOrder(
        ArraySet arraySet, ArraySet arraySet2, Task task, AnalysisResult analysisResult) {
