...
public abstract class PopOverBoundsCalculator {
            ...
            .getActivity(
                new Predicate() { // from class:
                  ...
                  public final boolean test(Object obj) {
                    ...
                    lambda$getBounds$0 =
                        PopOverBoundsCalculator.lambda$getBounds$0(
                            ActivityRecord.this, displayContent, (ActivityRecord) obj);
  ...
  public static /* synthetic */ boolean lambda$getBounds$0(
      ActivityRecord activityRecord,
      DisplayContent displayContent,
      ActivityRecord activityRecord2) {
    return activityRecord2 != activityRecord
        && displayContent.isFixedRotationLaunchingApp(activityRecord2)
        && activityRecord2.inFullscreenWindowingMode()
        && !activityRecord2.mPopOverState.isActivated();
  }

  public static Rect getAvailableArea(
      ActivityRecord activityRecord,
      DisplayContent displayContent,
      int i,
      float f,
  ...
  public static void applyInsets(
      DisplayContent displayContent, ActivityRecord activityRecord, int i, Rect rect) {
    Rect rect2 = new Rect();
    boolean z = true;
    boolean z2 = i == 1 || i == 3;
    Rect rect3 =
        new Rect(
            displayContent
                ...
                .getDecorInsetsInfo(
                    i,
                    z2 ? displayContent.mBaseDisplayHeight : displayContent.mBaseDisplayWidth,
                    z2 ? displayContent.mBaseDisplayWidth : displayContent.mBaseDisplayHeight)
                .mConfigInsets);
    ...
    if (task.isDesktopModeEnabled()) {
      ...
      if (z) {
        if (task.inFullscreenWindowingMode()) {
          rect.top +=
              getPopOverShadow(displayContent.getDisplayPolicy().getContext().getResources());
        }
    ...
    Rect safeInsets =
        displayContent
            .calculateDisplayCutoutForRotation(i, activityRecord.isConfigurationNeededInUdcCutout())
            .getSafeInsets();
