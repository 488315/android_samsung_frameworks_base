                ...
                if (selectAnimation != -1) {
                    ...
                    if (loadAnimationAttr != null) {
                        ...
                        if (CoreRune.MW_FREEFORM_SHELL_TRANSITION && this.mWin.inFreeformWindowingMode()) {
                            Animation loadWindowAnimationIfNeeded = FreeformController.loadWindowAnimationIfNeeded(loadAnimationAttr, this.mWin, i);
                            ...
                            loadAnimationAttr.setDuration(this.mContext.getResources().getInteger(R.integer.config_shortAnimTime));
                        }
