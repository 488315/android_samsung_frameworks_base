...
public class ShellRoot {
  ...
  public ShellRoot(IWindow iWindow, DisplayContent displayContent, final int i) {
    ...
    IBinder.DeathRecipient deathRecipient =
        new IBinder
            .DeathRecipient() { // from class:
                                // com.android.server.wm.ShellRoot$$ExternalSyntheticLambda0
    ...
    try {
      ...
      WindowToken build =
          new WindowToken.Builder(displayContent.mWmService, iWindow.asBinder(), this.mWindowType)
      ...
      this.mSurfaceControl =
          build
              ...
              .setContainerLayer()
              .setName("Shell Root Leash " + displayContent.getDisplayId())
      ...
      Slog.e(
          "ShellRoot",
          "Unable to add shell root layer " + i + " on display " + displayContent.getDisplayId(),
          e);
    }
  }
    ...
    if (iWindow != null) {
      try {
        this.mAccessibilityWindowDeath =
            new IBinder
                .DeathRecipient() { // from class:
                                    // com.android.server.wm.ShellRoot$$ExternalSyntheticLambda1
              @Override // android.os.IBinder.DeathRecipient
              public final void binderDied() {
