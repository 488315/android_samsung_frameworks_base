...
public class TaskSnapshotController extends AbsAppSnapshotController {
  ...
  public TaskSnapshotController(
    ...
    initialize(
        new TaskSnapshotCache(
            windowManagerService, new AppSnapshotLoader(createPersistInfoProvider)));
    setSnapshotEnabled(
  ...
  public void systemReady() {
    ...
    this.mService.mSnapshotController.registerTransitionStateConsumer(
        ...
        new Consumer() { // from class:
                         // com.android.server.wm.TaskSnapshotController$$ExternalSyntheticLambda0
    ...
    float f2 =
        CoreRune.FW_LOW_TASK_SNAPSHOT_SCALE_FOR_TABLET
            ...
            : windowManagerService
                .mContext
                .getResources()
                .getFloat(R.dimen.config_fixedOrientationLetterboxAspectRatio);
  ...
  public TaskSnapshot getSnapshot(int i, int i2, boolean z, boolean z2) {
    return ((TaskSnapshotCache) this.mCache)
        .getSnapshot(i, i2, z, z2 && this.mPersistInfoProvider.enableLowResSnapshots());
  }
  ...
  public final ScreenCapture.ScreenshotHardwareBuffer createImeSnapshot(Task task, int i) {
    ...
    return ScreenCapture.captureLayers(
        new ScreenCapture.LayerCaptureArgs.Builder(windowState.getSurfaceControl())
            .setSourceCrop(parentFrame)
            .setFrameScale(1.0f)
            .setPixelFormat(i)
  ...
  public void getClosingTasksInner(Task task, ArraySet arraySet) {
    ...
    if (CoreRune.MW_MULTI_SPLIT_FOLDING_POLICY
        && this.mService.mAtmService.mMultiWindowFoldController.isHoldingSplitScreen()
  ...
  public void screenTurningOff(
      final int i, final WindowManagerPolicy.ScreenOffListener screenOffListener) {
    if (shouldDisableSnapshots()) {
  ...
  public /* synthetic */ void lambda$screenTurningOff$0(
  ...
  public void snapshotForSleeping(int i, boolean z) {
    ...
    if (windowManagerService.mDisplayEnabled
      ...
      displayContent.forAllTasks(
          new Consumer() { // from class:
                           // com.android.server.wm.TaskSnapshotController$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
