...
public class AsyncRotationController extends FadeAnimationController implements Consumer {
    ...
    */
    public void accept(WindowState windowState) {
        ...
        if ((windowState.mHasSurface && canBeAsync(windowState.mToken)) || (CoreRune.MW_FREEFORM_MINIMIZE_CONTAINER && windowState.getAttrs().type == 2604 && (surfaceControl = windowState.mToken.mSurfaceControl) != null && surfaceControl.isValid())) {
            ...
            if (i != 3 && (!windowState.mForceSeamlesslyRotate || (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX && !windowState.isOnScreen()))) {
                i2 = 2;
            }
            this.mTargetWindowTokens.put(windowState.mToken, new Operation(i2));
        }
    ...
    public void setupStartTransaction(SurfaceControl.Transaction transaction) {
        ...
        transaction.addTransactionCommittedListener(new HandlerExecutor(this.mService.f1749mH), new SurfaceControl.TransactionCommittedListener() { // from class: com.android.server.wm.AsyncRotationController$$ExternalSyntheticLambda3
    ...
    public Animation getFadeInAnimation() {
        if (this.mHasScreenRotationAnimation) {
            if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX && this.mAlwaysWaitForStartTransaction && this.mHideImmediately && this.mTransitionOp == 2) {
                return AnimationUtils.loadAnimation(this.mContext, R.anim.task_fragment_clear_top_close_enter);
            }
    ...
    public Animation getFadeOutAnimation() {
        ...
        if (CoreRune.FW_CUSTOM_SHELL_TRANSITION) {
            return AnimationUtils.loadAnimation(this.mContext, R.anim.ft_avd_tooverflow_rectangle_1_pivot_animation);
        }
