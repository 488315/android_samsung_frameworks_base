...
public class WindowContextListenerController {
  ...
  public void registerWindowContainerListener(
      IBinder iBinder, WindowContainer windowContainer, int i, int i2, Bundle bundle) {
    registerWindowContainerListener(iBinder, windowContainer, i, i2, bundle, true);
  }

  public void registerWindowContainerListener(
      IBinder iBinder, WindowContainer windowContainer, int i, int i2, Bundle bundle, boolean z) {
    WindowContextListenerImpl windowContextListenerImpl =
        (WindowContextListenerImpl) this.mListeners.get(iBinder);
  ...
  public void dispatchPendingConfigurationIfNeeded(int i) {
    for (int size = this.mListeners.size() - 1; size >= 0; size--) {
      WindowContextListenerImpl windowContextListenerImpl =
          (WindowContextListenerImpl) this.mListeners.valueAt(size);
      if (windowContextListenerImpl.getWindowContainer().getDisplayContent().getDisplayId() == i
  ...
  public boolean assertCallerCanModifyListener(IBinder iBinder, boolean z, int i) {
    ...
    if (windowContextListenerImpl == null) {
      if (ProtoLogCache.WM_DEBUG_ADD_REMOVE_enabled) {
        ProtoLogImpl.i(
            ProtoLogGroup.WM_DEBUG_ADD_REMOVE, -1136467585, 0, (String) null, (Object[]) null);
      }
      return false;
    }
    ...
    throw new UnsupportedOperationException(
        "Uid mismatch. Caller uid is "
            + i
            + ", while the listener's owner is from "
            + windowContextListenerImpl.mOwnerUid);
  }
  ...
  public void dump(PrintWriter printWriter, String str) {
    ...
    for (int i = 0; i < size; i++) {
      WindowContextListenerImpl windowContextListenerImpl =
          (WindowContextListenerImpl) this.mListeners.valueAt(i);
  ...
  class WindowContextListenerImpl implements WindowContainerListener {
    ...
    public WindowContextListenerImpl(
        IBinder iBinder, WindowContainer windowContainer, int i, int i2, Bundle bundle) {
      ...
      try {
        ...
        if (ProtoLogCache.WM_ERROR_enabled) {
          ProtoLogImpl.e(
              ...
              -2014162875,
              0,
              "Could not register window container listener token=%s, container=%s",
              new Object[] {String.valueOf(iBinder), String.valueOf(this.mContainer)});
        }
      }
      this.mPackageName =
    ...
    public final void reportConfigToWindowTokenClient() {
      ...
      if (displayContent.isReady()) {
        if (!WindowProviderService.isWindowProviderService(this.mOptions)
            && Display.isSuspendedState(displayContent.getDisplayInfo().state)) {
        ...
        if (configuration.equals(this.mLastReportedConfig)
            && displayId == this.mLastReportedDisplay) {
          return;
        }
    ...
    public void onRemoved() {
      ...
      if (asWindowToken != null
          && asWindowToken.isFromClient()
          && (displayContent =
                  asWindowToken.mWmService.mRoot.getDisplayContent(this.mLastReportedDisplay))
              != null) {
      ...
      try {
        ...
        if (ProtoLogCache.WM_ERROR_enabled) {
          ProtoLogImpl.w(
              ...
              90764070,
              0,
              "Could not report token removal to the window token client.",
              (Object[]) null);
        }
      }
      unregister();
    ...
    public String toString() {
      return "WindowContextListenerImpl{clientToken="
          + this.mClientToken.asBinder()
          + ", container="
          + this.mContainer
          + ", "
          + this.mPackageName
    ...
    public class DeathRecipient implements IBinder.DeathRecipient {
      ...
      public void binderDied() {
        WindowManagerGlobalLock windowManagerGlobalLock =
            WindowContextListenerImpl.this.mContainer.mWmService.mGlobalLock;
