...
public class ClientLifecycleManager {
  ...
  public void scheduleTransaction(
    ...
    scheduleTransaction(
        transactionWithCallback(iApplicationThread, iBinder, clientTransactionItem));
  }
  ...
  public static ClientTransaction transactionWithState(
      IApplicationThread iApplicationThread,
      IBinder iBinder,
      ActivityLifecycleItem activityLifecycleItem) {
  ...
  public static ClientTransaction transactionWithCallback(
      IApplicationThread iApplicationThread,
      IBinder iBinder,
      ClientTransactionItem clientTransactionItem) {
    ClientTransaction obtain = ClientTransaction.obtain(iApplicationThread, iBinder);
