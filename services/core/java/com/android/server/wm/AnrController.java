...
public class AnrController {
  ...
  public void notifyAppUnresponsive(
      InputApplicationHandle inputApplicationHandle, TimeoutRecord timeoutRecord) {
      ...
      synchronized (windowManagerGlobalLock) {
        try {
          ...
          ActivityRecord forTokenLocked =
              ActivityRecord.forTokenLocked(inputApplicationHandle.token);
          if (forTokenLocked == null) {
            Slog.e(
                StartingSurfaceController.TAG,
                "Unknown app appToken:"
                    + inputApplicationHandle.name
            ...
            DisplayContent displayContent =
                this.mService.mRoot.getDisplayContent(forTokenLocked.getDisplayId());
            IBinder iBinder =
                displayContent != null ? displayContent.getInputMonitor().mInputFocus : null;
            ...
            if (inputTargetFromToken != null) {
              ...
              if (SystemClock.uptimeMillis()
                      - displayContent.getInputMonitor().mInputFocusRequestTimeMillis
                  >= ActivityTaskManagerService.getInputDispatchingTimeoutMillisLocked(
                      windowState.getActivityRecord())) {
                z = true;
              }
            } else {
              windowState = null;
            ...
            if (!z) {
              Slog.i(
                  StartingSurfaceController.TAG,
                  "ANR in " + forTokenLocked.getName() + ".  Reason: " + timeoutRecord.mReason);
  ...
  public void notifyWindowUnresponsive(
      IBinder iBinder, OptionalInt optionalInt, TimeoutRecord timeoutRecord) {
    try {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        ActivityRecord activityRecord =
            windowState.mInputChannelToken == iBinder ? windowState.mActivityRecord : null;
        Slog.i(
            StartingSurfaceController.TAG,
        ...
        if (activityRecord != null) {
          ...
          this.mService.mAmInternal.inputDispatchingTimedOut(
              pid, isWindowAboveSystem, timeoutRecord);
        }
  ...
  public final void notifyWindowUnresponsive(int i, TimeoutRecord timeoutRecord) {
    Slog.i(
        StartingSurfaceController.TAG,
        "ANR in input window owned by pid=" + i + ". Reason: " + timeoutRecord.mReason);
  ...
  public void onFocusChanged(WindowState windowState) {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ActivityRecord activityRecord =
            (ActivityRecord) this.mUnresponsiveAppByDisplay.get(windowState.getDisplayId());
        ...
        try {
          ...
          arrayMap.put(
              ...
              new Runnable() { // from class:
                               // com.android.server.wm.AnrController$$ExternalSyntheticLambda0
            ...
            new Thread() { // from class: com.android.server.wm.AnrController.1
              ...
              public void run() {
                ...
                if (uptimeMillis2 > AnrController.PRE_DUMP_MONITOR_TIMEOUT_MS) {
                  Slog.i(
                      StartingSurfaceController.TAG,
                      "Pre-dump acquired " + str + " in " + uptimeMillis2 + "ms");
                  return;
                }
          ...
          if (dumpStackTraces != null) {
            dumpStackTraces.renameTo(
                new File(dumpStackTraces.getParent(), dumpStackTraces.getName() + "_pre"));
          }
        } finally {
          Trace.traceEnd(64L);
        }
  ...
  public final void preDumpIfLockTooSlow_onlyForAnr(int i) {
    ...
    if (this.mLastPreDumpTimeMs_onlyForAnr <= 0
        || uptimeMillis - this.mLastPreDumpTimeMs_onlyForAnr >= PRE_DUMP_MIN_INTERVAL_MS) {
  ...
  public final void dumpAnrStateAsync(
      final ActivityRecord activityRecord, final WindowState windowState, final String str) {
    FgThread.getExecutor()
        .execute(
            new Runnable() { // from class:
                             // com.android.server.wm.AnrController$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public /* synthetic */ void lambda$dumpAnrStateAsync$0(
      ActivityRecord activityRecord, WindowState windowState, String str) {
    try {
  ...
  public final boolean isWindowAboveSystem(WindowState windowState) {
    return windowState.mBaseLayer
        > this.mService.mPolicy.getWindowLayerFromTypeLw(
            2038, windowState.mOwnerCanAddInternalSystemWindow);
  }
}
