...
public final class WindowOrganizerController extends IWindowOrganizerController.Stub
    ...
    public WindowOrganizerController(ActivityTaskManagerService activityTaskManagerService) {
        ...
        this.mDisplayAreaOrganizerController =
                new DisplayAreaOrganizerController(activityTaskManagerService);
        this.mTaskFragmentOrganizerController =
                new TaskFragmentOrganizerController(activityTaskManagerService, this);
        this.mTransitionController = new TransitionController(activityTaskManagerService);
    }

    public static boolean configurationsAreEqualForOrganizer(
        ...
        if ((((536870912 & diff) != 0
                                ? (int)
                                        configuration.windowConfiguration.diff(
                                                configuration2.windowConfiguration, true)
                                : 0)
                        & 10485763)
                == 0) {
            diff &= -536870913;
    ...
    public final int applyChanges(
        ...
        if (CoreRune.MW_SHELL_CHANGE_TRANSITION && change.hasChangeTransitMode()) {
            ChangeTransitionController changeTransitionController =
                    this.mService.mChangeTransitController;
            ...
            if (asTask2 == null) {
                Slog.w(
                        ...
                        "handleWindowContainerTransaction: failed, we support Task only now!, wc="
                                + windowContainer
                                + ", reason="
                                + changeTransitReason);
            } else {
                ...
                Task task =
                        asTask2.isLeafTask()
                                ? asTask2
                                : asTask2.getTask(
                                        new ChangeTransitionController$$ExternalSyntheticLambda4(
                                                1));
                if (task == null || task.isChangeTransitionBlockedByCommonPolicy()) {
                    StringBuilder sb =
                            new StringBuilder("handleWindowContainerTransaction: failed, tid #");
                    ...
                    Slog.d(
                            "ChangeTransitionController",
                            "handleWindowContainerTransaction: requested #"
                                    + asTask2.mTaskId
                                    + ", target="
                                    + task.mTaskId
                                    + ", startBounds="
                                    + changeTransitStartBounds
                                    + ", reason="
                                    + changeTransitReason);
                    if (changeTransitStartBounds == null) {
                        changeTransitStartBounds = task.getBounds();
                    }
                    changeTransitionController.requestChangeTransition(
                            task,
                            changeTransitMode,
                            task.getWindowingMode(),
                            new Rect(changeTransitStartBounds),
                            changeTransitReason,
                            changeTransitFlags);
                    if (CoreRune.MW_NATURAL_SWITCHING_PIP && task.inPinnedWindowingMode()) {
                        Transition.ChangeInfo findCollectingChangeInfo =
                                changeTransitionController.findCollectingChangeInfo(task);
                        Transition transition =
                                changeTransitionController
                                        .mTransitionController
                                        .mCollectingTransition;
                        if (transition != null
                                && findCollectingChangeInfo != null
                                && findCollectingChangeInfo.mChangeLeash != null) {
                            changeTransitionController.mTransitionToChangingPipTask.put(
                                    transition, task);
                            DeviceIdleController$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("addToChangingPipTaskIfPossible: tid #"),
                                    task.mTaskId,
                                    "ChangeTransitionController");
                        }
                    }
        ...
        if (change.hasChangeFreeformStashMode() || change.hasChangeFreeformStashScale()) {
            ...
            if (asTask3 == null) {
                Slog.w(
                        ...
                        "updateFocusForFreeformStash: failed, we support Task only now!, wc="
                                + windowContainer);
            } else {
                if (!asTask3.isLeafTask()) {
                    asTask3 =
                            asTask3.getTask(
                                    new MultiTaskingController$$ExternalSyntheticLambda0(1));
                }
                if (asTask3 == null || !asTask3.inFreeformWindowingMode()) {
                    StringBuilder sb2 =
                            new StringBuilder("updateFocusForFreeformStash: failed, tid #");
        ...
        if (windowContainer.asTask() != null && change.isOrganizedTaskViewTask()) {
            windowContainer.asTask().mTaskViewTaskOrganizerTaskId =
                    change.getTaskViewTaskOrganizerTaskId();
        }
        ...
        if (((windowContainer.asTask() == null
                                || windowContainer.getTaskDisplayArea() == null
                                || windowContainer.getParent() == null
                                || !windowContainer.getParent().inSplitScreenWindowingMode())
                        ? false
                        : true)
                && windowingMode == 5) {
            windowContainer.reparent(windowContainer.getTaskDisplayArea(), Integer.MAX_VALUE);
        } else if (CoreRune.MT_NEW_DEX_LAUNCH_POLICY
                && this.mService.getConfiguration().isNewDexMode()
            ...
            windowContainer.reparent(
                    taskDisplayArea,
                    taskDisplayArea.mChildren.indexOf(windowContainer.asTask().getRootTask()) + 1);
        }
        if (CoreRune.MT_SIZE_COMPAT_POLICY) {
            ...
            DexSizeCompatController.DexSizeCompatPolicy compatPolicy =
                    SizeCompatPolicyManager.getCompatPolicy(asTask4, false);
            if (compatPolicy != null) {
                int windowingMode2 = change.getWindowingMode();
                WindowConfiguration windowConfiguration =
                        change.getConfiguration().windowConfiguration;
                Task task2 = compatPolicy.mTask;
                if (task2.mDisplayContent == null) {
                    Slog.w(
                            "SizeCompatPolicy",
                            "ensureTransaction: DisplayContent is null. task=" + task2);
                } else {
                    if (windowingMode2 >= 0 && windowingMode2 != task2.getWindowingMode()) {
                        if (windowingMode2 != 1) {
                            if (windowingMode2 == 5) {
                                ...
                                Slog.w(
                                        "SizeCompatPolicy",
                                        "ensureTransaction: Unsupported windowing mode, mode="
                        ...
                        if (CoreRune.MT_SIZE_COMPAT_POLICY_DRAG
                                && configSetMask != 0
                                && task2.inFreeformWindowingMode()) {
                            DexSizeCompatController.DexSizeCompatPolicy dexSizeCompatPolicy =
                                    CoreRune.MT_DEX_SIZE_COMPAT_DRAG ? compatPolicy : null;
                            if (dexSizeCompatPolicy != null) {
                                dexSizeCompatPolicy.ensureDragBounds(
        ...
        if (configSetMask != 0) {
            if (windowingMode <= -1 || windowingMode == windowContainer.getWindowingMode()) {
                Configuration configuration =
                        new Configuration(windowContainer.getRequestedOverrideConfiguration());
                configuration.setTo(change.getConfiguration(), configSetMask, windowSetMask);
                if (windowContainer.getWindowingMode() == 6
                        && (change.getConfigSetMask() & 1024) != 0
                    ...
                    if (configuration.screenWidthDp == 0 || configuration.screenHeightDp == 0) {
                        ...
                        if (requestedOverrideBounds.width() == bounds.width()
                                && requestedOverrideBounds.height() == bounds.height()) {
                ...
                windowContainer
                        ...
                        .setTo(change.getConfiguration(), configSetMask, windowSetMask);
            }
            i = (windowSetMask == 0 || !windowContainer.isEmbedded()) ? 1 : 3;
        } else {
            i = 0;
        }
        if ((change.getChangeMask() & 1) != 0
                && windowContainer.setFocusable(change.getFocusable())) {
            i |= 2;
        }
        if (windowingMode <= -1) {
            return i;
        }
        if (this.mService.isInLockTaskMode()
                && WindowConfiguration.inMultiWindowMode(windowingMode)
                && (!CoreRune.MW_EMBED_ACTIVITY
                        || !windowContainer.isEmbedded()
                        || windowContainer.asTaskFragment() == null
                        || windowContainer.getParent() == null
                        || WindowConfiguration.inMultiWindowMode(
                                windowContainer.getParent().getWindowingMode()))) {
            Slog.w(
                    "WindowOrganizerController",
                    "Dropping unsupported request to set multi-window windowing mode during locked"
                        + " task mode.");
            return i;
        }
        if (windowingMode == 2) {
    ...
    */
    public final int applyHierarchyOp(
            final android.window.WindowContainerTransaction.HierarchyOp r26,
            int r27,
            int r28,
            com.android.server.wm.Transition r29,
            boolean r30,
            final com.android.server.wm.WindowOrganizerController.CallerInfo r31,
            final android.os.IBinder r32,
            android.window.ITaskFragmentOrganizer r33,
            com.android.server.wm.Transition r34,
            boolean r35) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.WindowOrganizerController.applyHierarchyOp(android.window.WindowContainerTransaction$HierarchyOp,"
                    + " int, int, com.android.server.wm.Transition, boolean,"
                    + " com.android.server.wm.WindowOrganizerController$CallerInfo,"
                    + " android.os.IBinder, android.window.ITaskFragmentOrganizer,"
                    + " com.android.server.wm.Transition, boolean):int");
    }

    /* JADX WARN: Finally extract failed */
    public final int applySyncTransaction(
            ...
            synchronized (windowManagerGlobalLock) {
                try {
                    ...
                    ActivityManagerPerformance activityManagerPerformance =
                            activityTaskManagerService.mAMBooster;
                    if (activityManagerPerformance != null
                            && (activityRecord = activityTaskManagerService.mLastResumedActivity)
                                    != null) {
                    ...
                    final BLASTSyncEngine.SyncGroup syncGroup =
                            bLASTSyncEngine.new SyncGroup(this, i, "Organizer");
                    this.mTransactionCallbacksByPendingSyncId.put(
                            Integer.valueOf(syncGroup.mSyncId),
                            iWindowContainerTransactionCallback);
                    final int i2 = syncGroup.mSyncId;
                    if (this.mTransitionController.isShellTransitionsEnabled()) {
                        this.mTransitionController.startLegacySyncOrQueue(
                                syncGroup,
                                new WindowOrganizerController$$ExternalSyntheticLambda1(
                                        this, windowContainerTransaction, i2, callerInfo));
                        ...
                        Runnable runnable =
                                new Runnable() { // from class:
                                                 // com.android.server.wm.WindowOrganizerController$$ExternalSyntheticLambda2
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        WindowOrganizerController windowOrganizerController =
                                                WindowOrganizerController.this;
                                        windowOrganizerController.mService.mWindowManager
                                                .mSyncEngine.startSyncSet(syncGroup, 5000L, false);
                                    }
                                };
                        Runnable runnable2 =
                                new Runnable() { // from class:
                                                 // com.android.server.wm.WindowOrganizerController$$ExternalSyntheticLambda3
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        WindowOrganizerController windowOrganizerController =
                                                WindowOrganizerController.this;
                        ...
                        if (CoreRune.FW_SHELL_TRANSITION_LOG) {
                            ActivityManagerService$$ExternalSyntheticOutline0.m(
                                    6,
                                    new StringBuilder("queueSyncSet, caller="),
                                    "BLASTSyncEngine");
                        }
                        BLASTSyncEngine.PendingSyncSet pendingSyncSet =
                                new BLASTSyncEngine.PendingSyncSet();
                        ...
                        this.mService.mWindowManager.mSyncEngine.startSyncSet(
                                syncGroup, 5000L, false);
                        applyTransaction(
                                windowContainerTransaction,
                                i2,
                                (Transition) null,
    ...
    public final void applyTaskFragmentTransactionLocked(
            final WindowContainerTransaction windowContainerTransaction,
            int i,
            boolean z,
        ...
        for (Map.Entry entry : windowContainerTransaction.getChanges().entrySet()) {
            ...
            WindowContainerTransaction.Change change =
                    (WindowContainerTransaction.Change) entry.getValue();
            if (fromBinder == null) {
                Slog.e(
                        "WindowOrganizerController",
                        "Attempt to operate on task fragment that no longer exists");
            } else {
                TaskFragment asTaskFragment = fromBinder.asTaskFragment();
                if (asTaskFragment == null
                        || asTaskFragment.mTaskFragmentOrganizer == null
                        || !taskFragmentOrganizer
                                .asBinder()
                                .equals(asTaskFragment.mTaskFragmentOrganizer.asBinder())) {
                    String str =
                            "Permission Denial: applyTaskFragmentTransaction() from pid="
                                    + Binder.getCallingPid()
                                    + ", uid="
                                    + Binder.getCallingUid()
                                    + " trying to modify window container not belonging to the"
                                    + " TaskFragmentOrganizer="
                                    + taskFragmentOrganizer;
                ...
                int i4 =
                        this.mTaskFragmentOrganizerController.isSystemOrganizer(
                                        taskFragmentOrganizer.asBinder())
                                ? changeMask & (-138)
                                : changeMask;
                if ((i4 & 512) == 0
                        || (536870912 & configSetMask) == 0
                        || (windowSetMask & 1) == 0) {
                    i2 = windowSetMask;
                    i3 = configSetMask;
                } else {
        ...
        for (int size = hierarchyOps.size() - 1; size >= 0; size--) {
            WindowContainerTransaction.HierarchyOp hierarchyOp =
                    (WindowContainerTransaction.HierarchyOp) hierarchyOps.get(size);
            ...
            if (type != 14) {
                ...
                if (hierarchyOp.getTaskFragmentOperation() != null
                        && hierarchyOp.getTaskFragmentOperation().getSecondaryFragmentToken()
                                != null) {
        ...
        if (remoteTransition != null
                && !this.mTaskFragmentOrganizerController.isSystemOrganizer(
                        windowContainerTransaction.getTaskFragmentOrganizer().asBinder())) {
            ...
            if (!this.mService.mWindowManager.mSyncEngine.hasActiveSync() || z) {
                final Transition transition =
                        new Transition(
                                ...
                                this.mService.mWindowManager.mSyncEngine);
                this.mTransitionController.startCollectOrQueue(
                        transition,
                        new TransitionController
                                .OnStartCollect() { // from class:
                                                    // com.android.server.wm.WindowOrganizerController$$ExternalSyntheticLambda4
                            ...
                            public final void onCollectStarted(boolean z2) {
                                ...
                                if (z2
                                        && !windowOrganizerController
                                                ...
                                                .isValidTransaction(windowContainerTransaction2)) {
                                    transition2.abort();
                                } else if (windowOrganizerController.applyTransaction(
                                                        windowContainerTransaction2,
                                                        -1,
                                                        transition2,
                                                        callerInfo,
                                                        z2)
                                                == 0
                                        && transition2.mParticipants.isEmpty()) {
                                    transition2.abort();
                                } else {
                                    windowOrganizerController.mTransitionController
                                            .requestStartTransition(
                                                    transition2, null, remoteTransition2, null);
                                    windowOrganizerController.setAllReadyIfNeeded(
                                            transition2, windowContainerTransaction2);
                                }
                            }
                        });
                Binder.restoreCallingIdentity(clearCallingIdentity);
                ...
                if (transition2 == null
                        && ProtoLogImpl_54989576.Cache.WM_DEBUG_WINDOW_TRANSITIONS_enabled[3]) {
                    ProtoLogImpl_54989576.w(
                            ProtoLogGroup.WM_DEBUG_WINDOW_TRANSITIONS,
                            6110791601270766802L,
                            0,
                            null,
                            null);
                }
                applyTransaction(
                        windowContainerTransaction, -1, transition2, callerInfo, (Transition) null);
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } catch (Throwable th) {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int applyTransaction(
            android.window.WindowContainerTransaction r28,
            int r29,
            com.android.server.wm.Transition r30,
            com.android.server.wm.WindowOrganizerController.CallerInfo r31,
            com.android.server.wm.Transition r32) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.WindowOrganizerController.applyTransaction(android.window.WindowContainerTransaction,"
                    + " int, com.android.server.wm.Transition,"
                    + " com.android.server.wm.WindowOrganizerController$CallerInfo,"
                    + " com.android.server.wm.Transition):int");
    }
    ...
    public final int applyTransaction(
        ...
        if (!z) {
            return applyTransaction(
                    windowContainerTransaction, i, transition, callerInfo, (Transition) null);
        }
        try {
            return applyTransaction(
                    windowContainerTransaction, i, transition, callerInfo, (Transition) null);
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int applyWindowContainerChange(
            com.android.server.wm.WindowContainer r11,
            final android.window.WindowContainerTransaction.Change r12,
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.WindowOrganizerController.applyWindowContainerChange(com.android.server.wm.WindowContainer,"
                    + " android.window.WindowContainerTransaction$Change, android.os.IBinder):int");
    }

    public final void enforceTaskFragmentOrganized(
            IBinder iBinder, ITaskFragmentOrganizer iTaskFragmentOrganizer) {
        Objects.requireNonNull(iBinder);
        TaskFragment taskFragment = (TaskFragment) this.mLaunchTaskFragments.get(iBinder);
        if (taskFragment != null) {
            if (taskFragment.mTaskFragmentOrganizer == null
                    || !iTaskFragmentOrganizer
                            .asBinder()
                            .equals(taskFragment.mTaskFragmentOrganizer.asBinder())) {
                String str =
                        "Permission Denial: applyTaskFragmentTransaction() from pid="
                                + Binder.getCallingPid()
                                + ", uid="
                                + Binder.getCallingUid()
                                + " trying to modify TaskFragment not belonging to the"
                                + " TaskFragmentOrganizer="
                                + iTaskFragmentOrganizer;
                Slog.w("WindowOrganizerController", str);
                throw new SecurityException(str);
    ...
    public final void finishAllTransitions(
            IBinder iBinder,
            WindowContainerTransaction windowContainerTransaction,
            WindowContainerTransaction windowContainerTransaction2) {
            ...
            try {
                ...
                synchronized (windowManagerGlobalLock) {
                    if (windowContainerTransaction2 != null) {
                        try {
                            transferTransitionTokens =
                                    windowContainerTransaction2.getTransferTransitionTokens();
                        } catch (Throwable th) {
                            WindowManagerService.resetPriorityAfterLockedSection();
                            throw th;
                        }
                    ...
                    ArrayList mergedTransitionTokens =
                            windowContainerTransaction2 != null
                                    ? windowContainerTransaction2.getMergedTransitionTokens()
                                    : null;
    ...
    public final void finishTransition(
            IBinder iBinder, WindowContainerTransaction windowContainerTransaction) {
    ...
    public final boolean isLockTaskModeViolation(
            WindowContainer windowContainer, Task task, boolean z) {
        ...
        if (!isLockTaskModeViolation && windowContainer.asTask() != null) {
            isLockTaskModeViolation =
                    lockTaskController.isLockTaskModeViolation(windowContainer.asTask(), false);
        }
        if (isLockTaskModeViolation) {
            Slog.w(
                    "WindowOrganizerController",
                    "Can't support the operation since in lock task mode violation.  Task: "
                            + task
                            + " Parent : "
                            + windowContainer);
        }
    ...
    public final void onTransactionReady(SurfaceControl.Transaction transaction, int i) {
        ...
        try {
            ((IWindowContainerTransactionCallback)
                            this.mTransactionCallbacksByPendingSyncId.get(Integer.valueOf(i)))
                    .onTransactionReady(i, transaction);
        } catch (RemoteException e) {
            Slog.e(
                    "WindowOrganizerController",
                    "Failed to notify transaction (" + i + ") ready",
                    e);
            transaction.apply();
        }
    ...
    public final void registerTransitionPlayer(ITransitionPlayer iTransitionPlayer) {
        ...
        try {
            ...
            synchronized (windowManagerGlobalLock) {
                try {
                    this.mTransitionController.registerTransitionPlayer(
                            iTransitionPlayer,
                            this.mService.getProcessController(callingPid, callingUid));
                } catch (Throwable th) {
                    WindowManagerService.resetPriorityAfterLockedSection();
                    throw th;
                }
    ...
    */
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int reparentChildrenTasksHierarchyOp(
            final android.window.WindowContainerTransaction.HierarchyOp r19,
            com.android.server.wm.Transition r20,
            int r21,
            final boolean r22,
            boolean r23) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.wm.WindowOrganizerController.reparentChildrenTasksHierarchyOp(android.window.WindowContainerTransaction$HierarchyOp,"
                    + " com.android.server.wm.Transition, int, boolean, boolean):int");
    }

    public final int sanitizeAndApplyHierarchyOp(
            WindowContainer windowContainer, WindowContainerTransaction.HierarchyOp hierarchyOp) {
        ActivityRecord activityRecord;
        ...
        if (!hierarchyOp.isReparent()) {
            if (hierarchyOp.getToTop() && asTask.isRootTask()) {
                Task.enableEnterPipOnTaskSwitch(
                        ...
                        Task.findEnterPipOnTaskSwitchCandidate(
                                asTask.getDisplayArea().getTopRootTask()),
                        null,
                        asTask);
            }
            asTask.getParent()
                    .positionChildAt(
                            hierarchyOp.getToTop() ? Integer.MAX_VALUE : Integer.MIN_VALUE,
                            asTask,
                            hierarchyOp.includingParents());
            TaskDisplayArea defaultTaskDisplayArea = displayContent.getDefaultTaskDisplayArea();
            if (CoreRune.MW_SPLIT_FLEX_PANEL_MODE
                    && (activityRecord = displayContent.mFocusedApp) != null
                ...
                ActivityRecord activityRecord2 =
                        task2 != null ? task2.topRunningActivity(false) : null;
            ...
            if (!hierarchyOp.getToTop()
                    || defaultTaskDisplayArea == null
                    || !asTask.inSplitScreenWindowingMode()
                    || defaultTaskDisplayArea.getTopRootTaskInStageType(asTask.getStageType())
                            == null) {
                return 2;
            }
        ...
        WindowContainer defaultTaskDisplayArea2 =
                hierarchyOp.getNewParent() == null
                        ? displayContent.getDefaultTaskDisplayArea()
                        : WindowContainer.fromBinder(hierarchyOp.getNewParent());
        ...
        if (asTask.getParent() == defaultTaskDisplayArea2) {
            ...
            asTask.getDisplayArea()
                    .positionChildAt(
                            hierarchyOp.getToTop() ? Integer.MAX_VALUE : Integer.MIN_VALUE,
                            (Task) defaultTaskDisplayArea2,
                            false);
            return 2;
        }
        ...
        if (defaultTaskDisplayArea2.asTask() == null) {
            throw new RuntimeException(
                    "Can only reparent task to another task or taskDisplayArea, but not "
                            + defaultTaskDisplayArea2);
        }
        if (defaultTaskDisplayArea2.inMultiWindowMode() && asTask.isLeafTask()) {
            if (defaultTaskDisplayArea2.inPinnedWindowingMode()) {
                Slog.w(
                        "WindowOrganizerController",
                        "Can't support moving a task to another PIP window... newParent="
                                + defaultTaskDisplayArea2
                                + " task="
                                + asTask);
                return 0;
            }
            if (!asTask.supportsMultiWindowInDisplayArea(
                    defaultTaskDisplayArea2.asTask().getDisplayArea(), false)) {
                Slog.w(
                        "WindowOrganizerController",
                        "Can't support task that doesn't support multi-window mode in multi-window"
                            + " mode... newParent="
                                + defaultTaskDisplayArea2
                                + " task="
                                + asTask);
    ...
    public final void sendTaskFragmentOperationFailure(
        ...
        TaskFragmentOrganizerController taskFragmentOrganizerController =
                this.mService.mTaskFragmentOrganizerController;
        if (taskFragment != null) {
    ...
    public final void setAllReadyIfNeeded(
            Transition transition, WindowContainerTransaction windowContainerTransaction) {
        int i = 0;
        while (true) {
            if (i >= windowContainerTransaction.getHierarchyOps().size()) {
                break;
            }
            if (((WindowContainerTransaction.HierarchyOp)
        ...
        for (int i2 = 0; i2 < windowContainerTransaction.getHierarchyOps().size(); i2++) {
            WindowContainerTransaction.HierarchyOp hierarchyOp =
                    (WindowContainerTransaction.HierarchyOp)
                            windowContainerTransaction.getHierarchyOps().get(i2);
            if (hierarchyOp.getType() == 17
                    && hierarchyOp.getTaskFragmentOperation().getOpType() == 0) {
                TaskFragment taskFragment =
                        (TaskFragment)
                                this.mLaunchTaskFragments.get(
                                        hierarchyOp
                                                .getTaskFragmentOperation()
                                                .getTaskFragmentCreationParams()
                                                .getFragmentToken());
    ...
    /* JADX WARN: Finally extract failed */
    public final int startLegacyTransition(
            int i,
                ...
                try {
                    ...
                    if (this.mTransitionController.getTransitionPlayer() != null) {
                        throw new IllegalArgumentException(
                                "Can't use legacy transitions in when shell transitions are"
                                    + " enabled.");
                    }
                    DisplayContent displayContent =
                            this.mService.mRootWindowContainer.getDisplayContent(0);
    ...
    /* JADX WARN: Finally extract failed */
    public final Transition.Token startTransition(
            int i, IBinder iBinder, WindowContainerTransaction windowContainerTransaction) {
            ...
            synchronized (windowManagerGlobalLock) {
                try {
                    ...
                    if (this.mTransitionController.getTransitionPlayer() == null
                        ...
                        Slog.w(
                                "WindowOrganizerController",
                                "Using shell transitions API for legacy transitions.");
                        if (windowContainerTransaction == null) {
                            throw new IllegalArgumentException(
                                    "Can't use legacy transitions in compatibility mode with no"
                                        + " WCT.");
                        }
                        applyTransaction(
                                windowContainerTransaction,
                    ...
                    if (fromBinder != null) {
                        ...
                        if (fromBinder.isCollecting() || fromBinder.mForcePlaying) {
                            ...
                            if (fromBinder.shouldApplyOnDisplayThread()) {
                                ...
                                this.mService.mH.post(
                                        new Runnable() { // from class:
                                                         // com.android.server.wm.WindowOrganizerController$$ExternalSyntheticLambda6
                                            @Override // java.lang.Runnable
                                            public final void run() {
                                                WindowOrganizerController
                                                        windowOrganizerController =
                                                ...
                                                WindowContainerTransaction
                                                        windowContainerTransaction3 =
                                                                windowContainerTransaction2;
                                                WindowOrganizerController.CallerInfo callerInfo2 =
                                                        callerInfo;
                                                Transition.ReadyCondition readyCondition3 =
                                                        readyCondition2;
                            ...
                            Slog.e(
                                    "WindowOrganizerController",
                                    "Trying to start a transition that isn't collecting. This"
                                        + " probably means Shell took too long to respond to a"
                                        + " request. WM State may be incorrect now, please file a"
                                        + " bug");
                            applyTransaction(
                                    windowContainerTransaction2,
                                    -1,
                        ...
                        if (i < 0) {
                            throw new IllegalArgumentException(
                                    "Can't create transition with no type");
                        }
                        final Transition.ReadyCondition readyCondition3 =
                                new Transition.ReadyCondition("start WCT applied");
                        final boolean z =
                                (windowContainerTransaction == null
                                                || (CoreRune.MW_SHELL_TRANSITION
                                                        && windowContainerTransaction.avoidReady()))
                                        ? false
                                        : true;
                        final Transition transition =
                                new Transition(
                        ...
                        this.mTransitionController.startCollectOrQueue(
                                ...
                                new TransitionController
                                        .OnStartCollect() { // from class:
                                                            // com.android.server.wm.WindowOrganizerController$$ExternalSyntheticLambda5
                                    @Override // com.android.server.wm.TransitionController.OnStartCollect
                                    public final void onCollectStarted(boolean z2) {
                                        ...
                                        if (z) {
                                            windowOrganizerController.setAllReadyIfNeeded(
                                                    transition2, windowContainerTransaction3);
                                        }
                                    }
                                });
    ...
    public final boolean validateTaskFragment(
            TaskFragment taskFragment,
            int i,
            IBinder iBinder,
            ITaskFragmentOrganizer iTaskFragmentOrganizer) {
            ...
            sendTaskFragmentOperationFailure(
                    ...
                    new IllegalArgumentException(
                            VibrationParam$1$$ExternalSyntheticOutline0.m(
                                    i,
                                    "Not allowed to apply operation on invalid fragment tokens"
                                        + " opType=")));
            return false;
        }
        if (!taskFragment.isEmbeddedTaskFragmentInPip()
                || (i == 1 && taskFragment.getTopNonFinishingActivity(true, true) == null)) {
            return true;
        }
        sendTaskFragmentOperationFailure(
                iTaskFragmentOrganizer,
                ...
                taskFragment,
                i,
                new IllegalArgumentException("Not allowed to apply operation on PIP TaskFragment"));
        return false;
    }

    public final int waitAsyncStart(final IntSupplier intSupplier) {
        final Integer[] numArr = {null};
        (Looper.myLooper() == this.mService.mH.getLooper()
                        ? this.mService.mWindowManager.mAnimationHandler
                        : this.mService.mH)
                .post(
                        new Runnable() { // from class:
                                         // com.android.server.wm.WindowOrganizerController$$ExternalSyntheticLambda18
                            @Override // java.lang.Runnable
                            public final void run() {
                                WindowOrganizerController windowOrganizerController =
                                        WindowOrganizerController.this;
                                ...
                                WindowManagerGlobalLock windowManagerGlobalLock =
                                        windowOrganizerController.mGlobalLock;
                                WindowManagerService.boostPriorityForLockedSection();
                                synchronized (windowManagerGlobalLock) {
                                    try {
