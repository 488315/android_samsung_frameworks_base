...
public class SizeCompatPolicyManager {
  ...
  public void setActiveMode(int i, int i2) {
    ...
    Slog.d(
        "SizeCompatPolicy",
        "ActiveMode is changed from " + intValue + " to " + i2 + ", displayId=" + i);
  ...
  public boolean shouldCreateCompatPolicy(
      Task task, ActivityRecord activityRecord, TaskDisplayArea taskDisplayArea, int i) {
  ...
  public boolean shouldCreateCompatPolicy(
    ...
    return (activityRecord.isResizeable()
  ...
  public int applySizeScaleCompatPolicy(
      ActivityRecord activityRecord, Configuration configuration, int i) {
    ...
    if (compatPolicy != null) {
      return compatPolicy.resolveOverrideConfiguration(activityRecord, configuration)
          | 0
          | compatPolicy.updateResolvedBoundsPosition(activityRecord, configuration);
    }
  ...
  public void performDisplayOverrideConfigUpdate(
      final DisplayContent displayContent, final Configuration configuration) {
        ...
        displayContent.forAllTasks(
            new Consumer() { // from class:
              ...
              public final void accept(Object obj) {
                SizeCompatPolicyManager.this.lambda$performDisplayOverrideConfigUpdate$0(
                    displayContent, configuration, (Task) obj);
              }
            });
      }
    }
  ...
  public /* synthetic */ void lambda$performDisplayOverrideConfigUpdate$0(
      DisplayContent displayContent, Configuration configuration, Task task) {
    SizeCompatPolicy compatPolicy = getCompatPolicy(task);
    if (compatPolicy == null) {
      return;
    }
  ...
  public void ensureTransaction(Task task, WindowContainerTransaction.Change change, int i) {
    ...
    compatPolicy.ensureTransaction(
        change.getWindowingMode(), change.getConfiguration().windowConfiguration, i);
  }
