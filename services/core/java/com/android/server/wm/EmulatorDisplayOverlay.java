  ...
  public EmulatorDisplayOverlay(
    ...
    try {
      ...
      InputMonitor.setTrustedOverlayInputInfo(
          surfaceControl, transaction, displayContent.getDisplayId(), "EmulatorDisplayOverlay");
    } catch (Surface.OutOfResourcesException unused) {
    }
    SurfaceControl surfaceControl2 = surfaceControl;
    this.mSurfaceControl = surfaceControl2;
    this.mDrawNeeded = true;
    this.mOverlay = context.getDrawable(R.drawable.dropdown_ic_arrow_disabled_holo_light);
    Point point2 = this.mScreenSize;
    BLASTBufferQueue bLASTBufferQueue =
        new BLASTBufferQueue("EmulatorDisplayOverlay", surfaceControl2, point2.x, point2.y, 1);
