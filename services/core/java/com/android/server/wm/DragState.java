...
public class DragState {
    ...
    public class InputInterceptor {
        ...
        public InputInterceptor(Display display) {
            ...
            this.mInputEventReceiver = new DragInputEventReceiver(this.mClientChannel, DragState.this.mService.f1749mH.getLooper(), DragState.this.mDragDropController);
    ...
    public void endAnimator(final int i) {
        this.mService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.DragState$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
