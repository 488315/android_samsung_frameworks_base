...
public class WallpaperController {
    ...
    */
    public /* synthetic */ boolean lambda$new$1(WindowState windowState) {
        ...
        if (this.mService.mPolicy.isKeyguardLocked() && (windowState.canShowWhenLocked() || isShowWhenLockedFreeform(windowState))) {
            if (!this.mService.mPolicy.isKeyguardOccluded()) {
                if (isShellTransitionsEnabled) {
                }
                boolean z2 = !windowState.hasWallpaper() || (animatingContainer == null && animatingContainer.getAnimation() != null && animatingContainer.getAnimation().getShowWallpaper());
                ...
                if (this.mService.mAtmService.mMultiTaskingController.shouldNotSupportWallpaper() && windowState.inMultiWindowMode()) {
                    return false;
                }
                ...
                return windowState.mActivityRecord != null || (CoreRune.FW_INFINITY_WALLPAPER_IN_AOD && this.mService.mPolicy.isKeyguardHostWindow(windowState.mAttrs));
            }
    ...
    public WallpaperController(WindowManagerService windowManagerService, DisplayContent displayContent) {
        ...
        this.mShouldOffsetWallpaperCenter = resources.getBoolean(R.bool.config_lockscreenWeatherEnabledByDefault);
