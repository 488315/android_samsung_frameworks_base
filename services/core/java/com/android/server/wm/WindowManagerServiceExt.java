    ...
    */
    public boolean applyScreenRatioToSizeDensity(DisplayContent displayContent, String str, int i) {
        ...
        if (displayContent.mBaseDisplayWidth != i3 || displayContent.mBaseDisplayHeight != i4) {
            ...
            z = false;
            Slog.d("WindowManagerServiceExt", "applyScreenRatioToSizeDensity" + (" init size: " + displayContent.mInitialDisplayWidth + "x" + displayContent.mInitialDisplayHeight + " " + displayContent.mInitialDisplayDensity + "dpi base size: " + displayContent.mBaseDisplayWidth + "x" + displayContent.mBaseDisplayHeight + " " + displayContent.mBaseDisplayDensity + "dpi baseScreenRatio: 0.75"));
            if (z) {
                if (displayContent.mInitialDisplayWidth != i3 || displayContent.mInitialDisplayHeight != i4) {
                    displayContent.mIsSizeForced = true;
                }
                if (displayContent.mInitialDisplayDensity != i5) {
                    displayContent.mIsDensityForced = true;
                }
                this.mService.mDisplayWindowSettings.setForcedSize(displayContent, displayContent.mBaseDisplayWidth, displayContent.mBaseDisplayHeight);
                this.mService.mDisplayWindowSettings.setForcedDensity(displayContent.getDisplayInfo(), displayContent.mBaseDisplayDensity, 0);
            }
            return z;
        }
        z = true;
    ...
    public void postRotationInfoForAudioManager() {
        this.mService.f1749mH.removeCallbacks(new Runnable() { // from class: com.android.server.wm.WindowManagerServiceExt$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                WindowManagerServiceExt.this.setRotationInfoForAudioManager();
            }
        });
        this.mService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.WindowManagerServiceExt$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                WindowManagerServiceExt.this.setRotationInfoForAudioManager();
            }
