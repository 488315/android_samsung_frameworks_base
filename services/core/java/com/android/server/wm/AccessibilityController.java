...
public final class AccessibilityController {
  ...
  public boolean setMagnificationCallbacks(
    ...
    if (magnificationCallbacks != null) {
      ...
      if (displayContent == null
          || (display = displayContent.getDisplay()) == null
          || display.getType() == 4) {
        return false;
      }
      DisplayMagnifier displayMagnifier =
          new DisplayMagnifier(this.mService, displayContent, display, magnificationCallbacks);
  ...
  public void setWindowsForAccessibilityCallback(
      int i,
  ...
  public void performComputeChangedWindowsNot(int i, boolean z) {
    ...
    if (this.mAccessibilityTracing.isTracingEnabled(1024L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".performComputeChangedWindowsNot", 1024L, "displayId=" + i + "; forceSend=" + z);
    }
  ...
  public Surface forceShowMagnifierSurface(int i) {
    ...
    displayMagnifier.mMagnifedViewport.mWindow.setAlpha(
  ...
  public void onDisplaySizeChanged(DisplayContent displayContent) {
    if (this.mAccessibilityTracing.isTracingEnabled(3072L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".onRotationChanged", 3072L, "displayContent={" + displayContent + "}");
    }
    DisplayMagnifier displayMagnifier =
        (DisplayMagnifier) this.mDisplayMagnifiers.get(displayContent.getDisplayId());
    if (displayMagnifier != null) {
  ...
  public void onAppWindowTransition(int i, int i2) {
    if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".onAppWindowTransition", 2048L, "displayId=" + i + "; transition=" + i2);
    }
    DisplayMagnifier displayMagnifier = (DisplayMagnifier) this.mDisplayMagnifiers.get(i);
    if (displayMagnifier != null) {
  ...
  public void onWMTransition(int i, int i2) {
    if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".onAppWindowTransition", 2048L, "displayId=" + i + "; type=" + i2);
    }
    DisplayMagnifier displayMagnifier = (DisplayMagnifier) this.mDisplayMagnifiers.get(i);
    if (displayMagnifier != null) {
  ...
  public void onWindowTransition(WindowState windowState, int i) {
    if (this.mAccessibilityTracing.isTracingEnabled(3072L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".onWindowTransition", 3072L, "windowState={" + windowState + "}; transition=" + i);
    }
    DisplayMagnifier displayMagnifier =
  ...
  public void onWindowFocusChangedNot(int i) {
    ...
    if (this.mAccessibilityTracing.isTracingEnabled(1024L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".onWindowFocusChangedNot", 1024L, "displayId=" + i);
    }
    WindowManagerGlobalLock windowManagerGlobalLock = this.mService.mGlobalLock;
    WindowManagerService.boostPriorityForLockedSection();
    synchronized (windowManagerGlobalLock) {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        for (int size = this.mWindowsForAccessibilityObserver.size() - 1; size >= 0; size--) {
          WindowsForAccessibilityObserver windowsForAccessibilityObserver =
              (WindowsForAccessibilityObserver) this.mWindowsForAccessibilityObserver.valueAt(size);
        ...
        for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
          WindowsForAccessibilityObserver windowsForAccessibilityObserver2 =
              (WindowsForAccessibilityObserver) arrayList.get(size2);
  ...
  public void drawMagnifiedRegionBorderIfNeeded(int i) {
    if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".drawMagnifiedRegionBorderIfNeeded", 2048L, "displayId=" + i);
    }
    DisplayMagnifier displayMagnifier = (DisplayMagnifier) this.mDisplayMagnifiers.get(i);
    if (displayMagnifier != null) {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        if (windowState != null) {
          ...
          if (hasCallbacks()
              && (magnificationSpecForWindow = getMagnificationSpecForWindow(windowState)) != null
              && !magnificationSpecForWindow.isNop()) {
  ...
  public MagnificationSpec getMagnificationSpecForWindow(WindowState windowState) {
    if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".getMagnificationSpecForWindow", 2048L, "windowState={" + windowState + "}");
    }
    DisplayMagnifier displayMagnifier =
        (DisplayMagnifier) this.mDisplayMagnifiers.get(windowState.getDisplayId());
    if (displayMagnifier != null) {
  ...
  public void setForceShowMagnifiableBounds(int i, boolean z) {
    if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".setForceShowMagnifiableBounds", 2048L, "displayId=" + i + "; show=" + z);
    }
    DisplayMagnifier displayMagnifier = (DisplayMagnifier) this.mDisplayMagnifiers.get(i);
    if (displayMagnifier != null) {
  ...
  public void updateImeVisibilityIfNeeded(int i, boolean z) {
    if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
      this.mAccessibilityTracing.logTrace(
          TAG + ".updateImeVisibilityIfNeeded", 2048L, "displayId=" + i + ";shown=" + z);
    }
  ...
  public void dump(final PrintWriter printWriter, final String str) {
    DumpUtils.dumpSparseArray(
        printWriter,
        str,
        this.mDisplayMagnifiers,
        "magnification display",
        new DumpUtils
            .KeyDumper() { // from class:
                           // com.android.server.wm.AccessibilityController$$ExternalSyntheticLambda0
          public final void dump(int i, int i2) {
            AccessibilityController.lambda$dump$0(printWriter, str, i, i2);
          }
        },
        new DumpUtils
            .ValueDumper() { // from class:
                             // com.android.server.wm.AccessibilityController$$ExternalSyntheticLambda1
          public final void dump(Object obj) {
            ((AccessibilityController.DisplayMagnifier) obj).dump(printWriter, "");
          }
        });
    DumpUtils.dumpSparseArrayValues(
        printWriter,
        str,
        this.mWindowsForAccessibilityObserver,
  ...
  public final class DisplayMagnifier {
    ...
    public DisplayMagnifier(
      ...
      AccessibilityControllerInternalImpl accessibilityControllerInternal =
          AccessibilityController.getAccessibilityControllerInternal(windowManagerService);
    ...
    public void setMagnificationSpec(MagnificationSpec magnificationSpec) {
      if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
        this.mAccessibilityTracing.logTrace(
            "WindowManager.setMagnificationSpec", 2048L, "spec={" + magnificationSpec + "}");
      }
    ...
    public void setForceShowMagnifiableBounds(boolean z) {
      if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
        this.mAccessibilityTracing.logTrace(
            "WindowManager.setForceShowMagnifiableBounds", 2048L, "show=" + z);
      }
    ...
    public void onDisplaySizeChanged(DisplayContent displayContent) {
      if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
        this.mAccessibilityTracing.logTrace(
            "WindowManager.onDisplaySizeChanged", 2048L, "displayContent={" + displayContent + "}");
      }
    ...
    public void onAppWindowTransition(int i, int i2) {
      if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
        this.mAccessibilityTracing.logTrace(
            "WindowManager.onAppWindowTransition", 2048L, "displayId=" + i + "; transition=" + i2);
      }
    ...
    public void onWMTransition(int i, int i2) {
      if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
        this.mAccessibilityTracing.logTrace(
            "WindowManager.onWMTransition", 2048L, "displayId=" + i + "; type=" + i2);
      }
      if (isForceShowingMagnifiableBounds()) {
        if (i2 != 1 && i2 != 2) {
          if (i2 == 3) {
    ...
    public void onWindowTransition(WindowState windowState, int i) {
      ...
      if ((i == 1 || i == 3) && isForceShowingMagnifiableBounds) {
        ...
        this.mCallbacks.onRectangleOnScreenRequested(
    ...
    public void drawMagnifiedRegionBorderIfNeeded() {
      if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
        this.mAccessibilityTracing.logTrace(
            "WindowManager.drawMagnifiedRegionBorderIfNeeded", 2048L);
      }
    ...
    public final class MagnifiedViewport {
      ...
      public MagnifiedViewport() {
        ...
        float dimension =
            DisplayMagnifier.this
                .mDisplayContext
                .getResources()
                .getDimension(R.dimen.accessibility_magnification_indicator_width);
      ...
      public void updateMagnificationSpec(MagnificationSpec magnificationSpec) {
        if (magnificationSpec != null) {
          this.mMagnificationSpec.initialize(
              magnificationSpec.scale, magnificationSpec.offsetX, magnificationSpec.offsetY);
        } else {
        ...
        setMagnifiedRegionBorderShown(
            DisplayMagnifier.this.isForceShowingMagnifiableBounds(), true);
      }
      ...
      public void recomputeBounds() {
        ...
        if (DisplayMagnifier.this.mDisplayContent.isDefaultDisplay
            && DisplayMagnifier.this
                .mDisplayContent
        ...
        for (int size = sparseArray.size() - 1; size >= 0; size--) {
          ...
          if (!isExcludedWindowType(windowState.mAttrs.type)) {
            ...
            if ((2097152 & i3) == 0 && (i3 & 1048576) == 0) {
              ...
              if (AccessibilityController.isUntouchableNavigationBar(
                  windowState, DisplayMagnifier.this.mTempRegion3)) {
                Rect systemBarInsetsFrame =
                    AccessibilityController.getSystemBarInsetsFrame(windowState);
      ...
      public void onDisplaySizeChanged() {
        if (DisplayMagnifier.this.isForceShowingMagnifiableBounds()) {
          ...
          DisplayMagnifier.this.mHandler.sendMessageDelayed(
              DisplayMagnifier.this.mHandler.obtainMessage(5),
              (long)
                  (DisplayMagnifier.this.mLongAnimationDuration
                      * DisplayMagnifier.this.mService.getWindowAnimationScaleLocked()));
        }
        recomputeBounds();
      ...
      public final void populateWindowsOnScreen(final SparseArray sparseArray) {
        this.mTempLayer = 0;
        DisplayMagnifier.this.mDisplayContent.forAllWindows(
            new Consumer() { // from class:
                             // com.android.server.wm.AccessibilityController$DisplayMagnifier$MagnifiedViewport$$ExternalSyntheticLambda0
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                AccessibilityController.DisplayMagnifier.MagnifiedViewport.this
                    .lambda$populateWindowsOnScreen$0(sparseArray, (WindowState) obj);
              }
            },
            false);
      }
      ...
      public /* synthetic */ void lambda$populateWindowsOnScreen$0(
          SparseArray sparseArray, WindowState windowState) {
        ...
        public ViewportWindow(Context context) {
          ...
          BLASTBufferQueue bLASTBufferQueue =
              new BLASTBufferQueue(
                  ...
                  surfaceControl,
                  MagnifiedViewport.this.mScreenSize.x,
                  MagnifiedViewport.this.mScreenSize.y,
                  1);
          this.mBlastBufferQueue = bLASTBufferQueue;
          SurfaceControl.Transaction transaction =
              (SurfaceControl.Transaction) DisplayMagnifier.this.mService.mTransactionFactory.get();
          transaction
              .setLayer(
                  surfaceControl,
                  DisplayMagnifier.this.mService.mPolicy.getWindowLayerFromTypeLw(2027) * 10000)
              .setPosition(
                  surfaceControl,
          ...
          InputMonitor.setTrustedOverlayInputInfo(
              surfaceControl,
              transaction,
              DisplayMagnifier.this.mDisplayContent.getDisplayId(),
              "Magnification Overlay");
          transaction.apply();
          this.mTransaction = transaction;
          this.mSurface = bLASTBufferQueue.createSurface();
          this.mAnimationController =
              new AnimationController(context, DisplayMagnifier.this.mService.f1749mH.getLooper());
          TypedValue typedValue = new TypedValue();
          context.getTheme().resolveAttribute(R.attr.colorActivatedHighlight, typedValue, true);
          context.getColor(typedValue.resourceId);
          int color = context.getColor(R.color.system_theme_app_dark);
            ...
            try {
              ...
              if (i <= 0 && this.mPreviousAlpha <= 0) {
                ...
                if (z) {
                  ...
                  this.mDirtyRect.inset(
                      -MagnifiedViewport.this.mHalfBorderWidth,
                      -MagnifiedViewport.this.mHalfBorderWidth);
                ...
                if (z) {
                  ...
                  this.mPreviousAlpha = i;
                }
                z2 = i <= 0;
                if (!z2 && !this.mLastSurfaceShown) {
                  this.mTransaction.show(this.mSurfaceControl).apply();
                  this.mLastSurfaceShown = true;
                  return;
                } else if (z2 && this.mLastSurfaceShown) {
  ...
  public static Rect getSystemBarInsetsFrame(WindowState windowState) {
    ...
    return controllableInsetProvider != null
        ? controllableInsetProvider.getSource().getFrame()
        : EMPTY_RECT;
  }
  ...
  public final class WindowsForAccessibilityObserver {
    ...
    public static boolean isReportedWindowType(int i) {
      return (i == 2013 || i == 2021 || i == 2026 || i == 2016 || i == 2022 || i == 2018
              || i == 2027 || i == 1004 || i == 2015 || i == 2030)
          ? false
          : true;
    }
    ...
    public void computeChangedWindows(boolean z) {
      ...
      synchronized (windowManagerGlobalLock) {
        try {
          ...
          if (displayContent == null) {
            Slog.w(
                StartingSurfaceController.TAG, "display content is null, should be created later");
            WindowManagerService.resetPriorityAfterLockedSection();
            return;
          }
          ...
          for (int i3 = 0; i3 < size; i3++) {
            AccessibilityWindowsPopulator.AccessibilityWindow accessibilityWindow =
                (AccessibilityWindowsPopulator.AccessibilityWindow) list.get(i3);
            ...
            if (windowMattersToAccessibility(accessibilityWindow, region2, region)) {
              ...
              region.op(
                  AccessibilityController.getSystemBarInsetsFrame(
                      (WindowState)
                          this.mService.mWindowMap.get(accessibilityWindow.getWindowInfo().token)),
                  region,
    ...
    public final boolean windowMattersToUnaccountedSpaceComputation(
        AccessibilityWindowsPopulator.AccessibilityWindow accessibilityWindow) {
      return (accessibilityWindow.isTouchable()
              || accessibilityWindow.getType() == 2034
              || !accessibilityWindow.isTrustedOverlay())
          && accessibilityWindow.getType() != 2032;
    }

    public final boolean windowMattersToAccessibility(
        AccessibilityWindowsPopulator.AccessibilityWindow accessibilityWindow,
        Region region,
        Region region2) {
      ...
      return (accessibilityWindow.isTouchable()
              || accessibilityWindow.getType() == 2034
              || accessibilityWindow.isPIPMenu())
          && !region2.quickReject(region)
          && isReportedWindowType(accessibilityWindow.getType());
    }

    public final void updateUnaccountedSpace(
        AccessibilityWindowsPopulator.AccessibilityWindow accessibilityWindow, Region region) {
    ...
    public static void addPopulatedWindowInfo(
        AccessibilityWindowsPopulator.AccessibilityWindow accessibilityWindow,
        Region region,
        List list,
        Set set) {
  ...
  public final class AccessibilityControllerInternalImpl
    ...
    public static AccessibilityControllerInternalImpl getInstance(
        WindowManagerService windowManagerService) {
    ...
    public AccessibilityControllerInternalImpl(WindowManagerService windowManagerService) {
      this.mLooper = windowManagerService.f1749mH.getLooper();
    ...
    public void setUiChangesForAccessibilityCallbacks(
      ...
      if (isTracingEnabled(2048L)) {
        logTrace(
            AccessibilityController.TAG + ".setAccessibilityWindowManagerCallbacks",
            2048L,
            "callbacks={" + uiChangesForAccessibilityCallbacks + "}");
      }
      if (uiChangesForAccessibilityCallbacks != null) {
        ...
        this.mCallbacksDispatcher =
            new UiChangesForAccessibilityCallbacksDispatcher(
                this, this.mLooper, uiChangesForAccessibilityCallbacks);
      } else {
        if (this.mCallbacksDispatcher == null) {
    ...
    public void onRectangleOnScreenRequested(int i, Rect rect) {
      if (isTracingEnabled(2048L)) {
        logTrace(
            AccessibilityController.TAG + ".onRectangleOnScreenRequested",
            2048L,
            "rectangle={" + rect + "}");
      }
      UiChangesForAccessibilityCallbacksDispatcher uiChangesForAccessibilityCallbacksDispatcher =
          this.mCallbacksDispatcher;
    ...
    public final class UiChangesForAccessibilityCallbacksDispatcher {
      ...
      public void onRectangleOnScreenRequested(int i, Rect rect) {
        if (this.mAccessibilityTracing.isTracingEnabled(2048L)) {
          this.mAccessibilityTracing.logTrace(
              "WindowManager.onRectangleOnScreenRequested", 2048L, "rectangle={" + rect + "}");
        }
        final WindowManagerInternal.AccessibilityControllerInternal
                .UiChangesForAccessibilityCallbacks
            uiChangesForAccessibilityCallbacks = this.mCallbacks;
  ...
  public final class AccessibilityTracing {
    ...
    public void logState(
      ...
      if (this.mEnabled) {
        log(
            ...
            Process.myPid() + XmlUtils.STRING_ARRAY_SEPARATOR + Application.getProcessName(),
    ...
    public final String toStackTraceString(StackTraceElement[] stackTraceElementArr, Set set) {
      ...
      public void handleMessage(Message message) {
        ...
        try {
          ...
          protoOutputStream.write(
              1138166333442L, simpleDateFormat.format(Long.valueOf(time)).toString());
          ...
          protoOutputStream.write(
              1138166333447L, packageManagerInternal.getNameForUid(message.arg1));
          protoOutputStream.write(1138166333448L, (String) someArgs.arg5);
          protoOutputStream.write(
              1138166333449L,
              AccessibilityTracing.this.toStackTraceString(
                  (StackTraceElement[]) someArgs.arg6, (Set) someArgs.arg4));
          protoOutputStream.write(1146756268042L, (byte[]) someArgs.arg7);
          long start2 = protoOutputStream.start(1146756268043L);
          WindowManagerGlobalLock windowManagerGlobalLock =
              AccessibilityTracing.this.mService.mGlobalLock;
          WindowManagerService.boostPriorityForLockedSection();
          synchronized (windowManagerGlobalLock) {
            try {
    ...
    public final String printCpuStats(long j) {
      Pair appProfileStatsForDebugging =
          this.mService.mAmInternal.getAppProfileStatsForDebugging(j, 5);
      return ((String) appProfileStatsForDebugging.first)
