    ...
    public final class DisplayMagnifier {
        ...
        public final class MagnifiedViewport {
            ...
            public MagnifiedViewport() {
                ...
                this.mTempLayer = 0;
                float dimension = DisplayMagnifier.this.mDisplayContext.getResources().getDimension(R.dimen.accessibility_magnification_indicator_width);
            ...
            public final class ViewportWindow implements Runnable {
                ...
                public ViewportWindow(Context context) {
                    ...
                    this.mAnimationController = new AnimationController(context, DisplayMagnifier.this.mService.f1749mH.getLooper());
