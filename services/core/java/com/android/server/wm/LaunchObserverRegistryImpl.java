...
public class LaunchObserverRegistryImpl extends ActivityMetricsLaunchObserver
    ...
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
                               // com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda4
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                ((LaunchObserverRegistryImpl) obj)
                    .handleRegisterLaunchObserver((ActivityMetricsLaunchObserver) obj2);
              }
            },
            this,
  ...
  @Override // com.android.server.wm.ActivityMetricsLaunchObserverRegistry
  public void unregisterLaunchObserver(
      ActivityMetricsLaunchObserver activityMetricsLaunchObserver) {
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
                               // com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda6
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                ((LaunchObserverRegistryImpl) obj)
                    .handleUnregisterLaunchObserver((ActivityMetricsLaunchObserver) obj2);
              }
            },
            this,
            activityMetricsLaunchObserver));
    ...
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new TriConsumer() { // from class:
                                // com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda0
              public final void accept(Object obj, Object obj2, Object obj3) {
                ((LaunchObserverRegistryImpl) obj)
                    .handleOnIntentStarted((Intent) obj2, ((Long) obj3).longValue());
              }
            },
            this,
            intent,
  ...
  public void onIntentFailed(long j) {
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
                               // com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda3
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
    ...
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new QuadConsumer() { // from class:
                                 // com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda5
              public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                ((LaunchObserverRegistryImpl) obj)
                    .handleOnActivityLaunched(
                        ((Long) obj2).longValue(),
                        (ComponentName) obj3,
  ...
  public void onActivityLaunchCancelled(long j) {
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new BiConsumer() { // from class:
                               // com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda7
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                ((LaunchObserverRegistryImpl) obj)
                    .handleOnActivityLaunchCancelled(((Long) obj2).longValue());
              }
            },
            this,
            Long.valueOf(j)));
  ...
  public void onActivityLaunchFinished(long j, ComponentName componentName, long j2) {
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new QuadConsumer() { // from class:
                                 // com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda2
              public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                ((LaunchObserverRegistryImpl) obj)
                    .handleOnActivityLaunchFinished(
                        ((Long) obj2).longValue(), (ComponentName) obj3, ((Long) obj4).longValue());
              }
            },
            this,
            Long.valueOf(j),
  ...
  public void onReportFullyDrawn(long j, long j2) {
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new TriConsumer() { // from class:
                                // com.android.server.wm.LaunchObserverRegistryImpl$$ExternalSyntheticLambda1
              public final void accept(Object obj, Object obj2, Object obj3) {
                ((LaunchObserverRegistryImpl) obj)
                    .handleOnReportFullyDrawn(((Long) obj2).longValue(), ((Long) obj3).longValue());
              }
            },
            this,
            Long.valueOf(j),
  ...
  public final void handleRegisterLaunchObserver(
      ActivityMetricsLaunchObserver activityMetricsLaunchObserver) {
    this.mList.add(activityMetricsLaunchObserver);
  }

  public final void handleUnregisterLaunchObserver(
      ActivityMetricsLaunchObserver activityMetricsLaunchObserver) {
  ...
  public final void handleOnActivityLaunchFinished(long j, ComponentName componentName, long j2) {
    for (int i = 0; i < this.mList.size(); i++) {
      ((ActivityMetricsLaunchObserver) this.mList.get(i))
          .onActivityLaunchFinished(j, componentName, j2);
    }
  }
