...
public final /* synthetic */ class ActivityTaskManagerService$$ExternalSyntheticLambda26
    ...
    public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
        ...
        if (windowProcessController == null
                || (service = NotificationManager.getService()) == null) {
            return;
        }
        try {
            Context createPackageContext =
                    activityTaskManagerService.mContext.createPackageContext(
                            windowProcessController.mInfo.packageName, 0);
            String string =
                    activityTaskManagerService.mContext.getString(
                            R.string.miniresolver_switch,
            ...
            try {
                service.enqueueNotificationWithTag(
                        ...
                        new Notification.Builder(
                                ...
                                .setTicker(string)
                                .setColor(
                                        activityTaskManagerService.mContext.getColor(
                                                R.color.system_notification_accent_color))
                                .setContentTitle(string)
                                .setContentText(
                                        activityTaskManagerService.mContext.getText(
                                                R.string.miniresolver_switch_to_work))
                                .setContentIntent(
