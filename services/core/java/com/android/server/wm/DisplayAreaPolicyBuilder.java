...
class DisplayAreaPolicyBuilder {
  ...
  private void validate() {
    ...
    boolean containsDefaultTaskDisplayArea =
        containsDefaultTaskDisplayArea(this.mRootHierarchyBuilder);
    for (int i = 0; i < this.mDisplayAreaGroupHierarchyBuilders.size(); i++) {
      ...
      if (containsDefaultTaskDisplayArea) {
        if (containsDefaultTaskDisplayArea(hierarchyBuilder)) {
          throw new IllegalStateException(
              "Only one TaskDisplayArea can have the feature id of FEATURE_DEFAULT_TASK_CONTAINER");
        }
      } else {
    ...
    if (!containsDefaultTaskDisplayArea) {
      throw new IllegalStateException(
          "There must be a default TaskDisplayArea with id of FEATURE_DEFAULT_TASK_CONTAINER.");
    }
  }
  ...
  private static void validateIds(HierarchyBuilder hierarchyBuilder, Set set, Set set2) {
    ...
    if (!set2.add(Integer.valueOf(i)) || !set.add(Integer.valueOf(i))) {
      throw new IllegalStateException(
          "RootDisplayArea must have unique id, but id=" + i + " is not unique.");
    }
    if (i > 20001) {
      throw new IllegalStateException(
    ...
    for (int i2 = 0; i2 < hierarchyBuilder.mTaskDisplayAreas.size(); i2++) {
      ...
      if (!set2.add(Integer.valueOf(i3)) || !set.add(Integer.valueOf(i3))) {
        throw new IllegalStateException(
            "TaskDisplayArea must have unique id, but id=" + i3 + " is not unique.");
      }
      if (i3 > 20001) {
        throw new IllegalStateException(
    ...
    for (int i4 = 0; i4 < hierarchyBuilder.mFeatures.size(); i4++) {
      ...
      if (set.contains(Integer.valueOf(id))) {
        throw new IllegalStateException(
            "Feature must not have same id with any RootDisplayArea or TaskDisplayArea, but id="
                + id
                + " is used");
      }
      if (!arraySet.add(Integer.valueOf(id))) {
        throw new IllegalStateException(
            "Feature below the same root must have unique id, but id=" + id + " is not unique.");
      }
      if (id > 20001) {
        throw new IllegalStateException(
  ...
  public Result build(WindowManagerService windowManagerService) {
    ...
    if (this.mSelectRootForWindowFunc == null) {
      this.mSelectRootForWindowFunc =
          new DefaultSelectRootForWindowFunction(this.mRootHierarchyBuilder.mRoot, arrayList);
    }
    return new Result(
  ...
  public class DefaultSelectTaskDisplayAreaFunction implements Function {
    ...
    public TaskDisplayArea apply(Bundle bundle) {
      ...
      TaskDisplayArea asTaskDisplayArea =
          WindowContainer.fromBinder(launchTaskDisplayArea.asBinder()).asTaskDisplayArea();
      if (asTaskDisplayArea == null) {
        if (ProtoLogCache.WM_DEBUG_WINDOW_ORGANIZER_enabled) {
          ProtoLogImpl.w(
              ...
              0,
              (String) null,
              new Object[] {String.valueOf(launchTaskDisplayArea)});
        }
        return this.mDefaultTaskDisplayArea;
      }
      ...
      throw new IllegalArgumentException(
          "The specified TaskDisplayArea must attach to Display#"
              ...
              + asTaskDisplayArea.getDisplayId());
    }
  }
  ...
  public class HierarchyBuilder {
    ...
    public final void build(List list) {
      ...
      for (int i6 = 0; i6 < maxWindowLayer; i6++) {
        ...
        if (pendingArea3 == null
            || pendingArea3.mParent != pendingAreaArr[i6]
            || typeOfLayer != i5) {
    ...
    public static int typeOfLayer(WindowManagerPolicy windowManagerPolicy, int i) {
      ...
      return (i == windowManagerPolicy.getWindowLayerFromTypeLw(2011)
              || i == windowManagerPolicy.getWindowLayerFromTypeLw(2012))
          ? 2
          : 0;
    }
  }
  ...
  public class Feature {
    ...
    public class Builder {
      ...
      public NewDisplayAreaSupplier mNewDisplayAreaSupplier =
          new NewDisplayAreaSupplier() { // from class:
                                         // com.android.server.wm.DisplayAreaPolicyBuilder$Feature$Builder$$ExternalSyntheticLambda0
      ...
      public Feature build() {
        ...
        return new Feature(
            this.mName, this.mId, (boolean[]) this.mLayers.clone(), this.mNewDisplayAreaSupplier);
      }
  ...
  public class Result extends DisplayAreaPolicy {
    ...
    public Result(
      ...
      TaskDisplayArea taskDisplayArea =
          (TaskDisplayArea)
              this.mRoot.getItemFromTaskDisplayAreas(
                  new Function() { // from class:
                                   // com.android.server.wm.DisplayAreaPolicyBuilder$Result$$ExternalSyntheticLambda0
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                      TaskDisplayArea lambda$new$0;
                      lambda$new$0 =
                          DisplayAreaPolicyBuilder.Result.lambda$new$0((TaskDisplayArea) obj);
                      return lambda$new$0;
                    }
                  });
      this.mDefaultTaskDisplayArea = taskDisplayArea;
      ...
      this.mSelectTaskDisplayAreaFunc =
          function == null ? new DefaultSelectTaskDisplayAreaFunction(taskDisplayArea) : function;
    }
    ...
    public DisplayArea.Tokens findAreaForWindowType(int i, Bundle bundle, boolean z, boolean z2) {
      return ((RootDisplayArea) this.mSelectRootForWindowFunc.apply(Integer.valueOf(i), bundle))
  ...
  public class PendingArea {
    ...
    public int computeMaxLayer() {
      for (int i = 0; i < this.mChildren.size(); i++) {
        this.mMaxLayer =
            Math.max(this.mMaxLayer, ((PendingArea) this.mChildren.get(i)).computeMaxLayer());
      }
      ...
      this.mChildren.sort(
          Comparator.comparingInt(
              new ToIntFunction() { // from class:
                                    // com.android.server.wm.DisplayAreaPolicyBuilder$PendingArea$$ExternalSyntheticLambda0
    ...
    public final DisplayArea createArea(DisplayArea displayArea, DisplayArea.Tokens[] tokensArr) {
      ...
      if (feature == null) {
        DisplayArea.Tokens tokens =
            new DisplayArea.Tokens(
                displayArea.mWmService,
                type,
                "Leaf:" + this.mMinLayer + XmlUtils.STRING_ARRAY_SEPARATOR + this.mMaxLayer);
        fillAreaForLayers(tokens, tokensArr);
        return tokens;
      }
      return feature.mNewDisplayAreaSupplier.create(
          displayArea.mWmService,
          type,
          this.mFeature.mName
