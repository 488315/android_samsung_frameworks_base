...
public class DeprecatedAbiDialog extends AppWarnings.BaseDialog {
    public DeprecatedAbiDialog(final AppWarnings appWarnings, Context context, ApplicationInfo applicationInfo) {
        ...
        }).setMessage(context.getString(R.string.font_family_display_2_material)).setTitle(applicationInfo.loadSafeLabel(context.getPackageManager(), 1000.0f, 5)).create();
        this.mDialog = create;
        create.create();
