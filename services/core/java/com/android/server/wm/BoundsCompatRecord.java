    ...
    */
    public void prepare() {
        ...
        if (task != null && task.inPinnedWindowingMode()) {
            ...
            if (!activityRecord.mWaitForEnteringPinnedMode && activityRecord.getRequestedOverrideWindowingMode() == 1) {
                z = true;
                ...
                if (this.mActivityRecord.getRequestedOverrideWindowingMode() != 1 && task != null && task.inMultiWindowMode()) {
                    clearPolicy(2);
                    return;
