...
public class InputConsumerImpl implements IBinder.DeathRecipient {
  ...
  public InputConsumerImpl(
    ...
    InputApplicationHandle inputApplicationHandle =
        new InputApplicationHandle(
            new Binder(), str, InputConstants.DEFAULT_DISPATCHING_TIMEOUT_MILLIS);
    ...
    this.mInputSurface =
        windowManagerService
            .makeSurfaceBuilder(windowManagerService.mRoot.getDisplayContent(i2).getSession())
            .setContainerLayer()
  ...
  public void dump(PrintWriter printWriter, String str, String str2) {
    printWriter.println(
        str2 + "  name=" + str + " pid=" + this.mClientPid + " user=" + this.mClientUser);
  }
}
