...
public class DisplayContent extends RootDisplayArea implements WindowManagerPolicy.DisplayContentInfo {
    ...
    public /* synthetic */ void lambda$new$2(WindowState windowState) {
        ...
        if (windowState.mAttrs.type == 2005 && windowState.mOwnerUid == i && !handlerC2998H.hasMessages(52, windowState)) {
            handlerC2998H.sendMessageDelayed(handlerC2998H.obtainMessage(52, windowState), windowState.mAttrs.hideTimeoutMilliseconds);
        }
    }
    ...
    public DisplayContent(Display display, RootWindowContainer rootWindowContainer, DeviceStateController deviceStateController) {
        ...
        if (this.isDefaultDisplay && !TextUtils.isEmpty(this.mWmService.mContext.getString(R.string.duration_hours_relative))) {
        ...
        deviceStateController.registerDeviceStateCallback(consumer, new HandlerExecutor(this.mWmService.f1749mH));
        this.mCloseToSquareMaxAspectRatio = this.mWmService.mContext.getResources().getFloat(R.dimen.circular_display_mask_thickness);
        ...
        boolean z = this.mWmService.mContext.getResources().getBoolean(R.bool.config_cecTvWakeOnOneTouchPlayDisabled_default);
        this.mInTouchMode = z;
    ...
    public final void sendApplicationFocusMonitoringIntent(String str, String str2, int i, boolean z) {
        ...
        this.mWmService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.DisplayContent.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    public final int getMinimalTaskSizeDp() {
        ...
        if (typedValue.type != 5 || i2 != 1) {
            throw new IllegalArgumentException("Resource ID #0x" + Integer.toHexString(R.dimen.dialog_corner_radius) + " is not in valid type or unit");
        }
    ...
    */
    public final boolean handleTopActivityLaunchingInDifferentOrientation(ActivityRecord activityRecord, ActivityRecord activityRecord2, boolean z) {
        ...
        if ((!activityRecord.occludesParent() || activityRecord.isReportedDrawn()) && !(activityRecord.mPopOverState.isActivated() && (activityRecord3 = this.mFixedRotationLaunchingApp) != null && activityRecord3.getTask() == activityRecord.getTask())) {
            return false;
        }
        if (z) {
            if (this.mTransitionController.isShellTransitionsEnabled()) {
        ...
        if ((this.mLastWallpaperVisible && activityRecord.windowsCanBeWallpaperTarget() && this.mFixedRotationTransitionListener.mAnimatingRecents == null && !this.mTransitionController.isTransientLaunch(activityRecord) && ((!CoreRune.FW_CUSTOM_SHELL_TRANSITION_LATE_TRANSIENT_LAUNCH || !this.mTransitionController.isLateTransientLaunch(activityRecord)) && !this.mWmService.mAtmService.mKeyguardController.isKeyguardGoingAway(this.mDisplayId))) || (rotationForActivityInDifferentOrientation = rotationForActivityInDifferentOrientation(activityRecord2)) == -1 || handleFixedRotationForMultiWindow(activityRecord) || !activityRecord.getDisplayArea().matchParentBounds()) {
            return false;
        }
    ...
    public final boolean startAsyncRotation(boolean z) {
        if (z) {
            this.mWmService.f1749mH.postDelayed(new Runnable() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda43
                @Override // java.lang.Runnable
                public final void run() {
    ...
    */
    public void computeScreenConfiguration(Configuration configuration) {
        ...
        for (int i5 = 0; i5 < length; i5++) {
            ...
            if (!inputDevice.isVirtual() && (this.mWmService.mInputManager.canDispatchToDisplay(inputDevice.getId(), this.mDisplayId) || shouldApplyInputDeviceToDisplay(inputDevice.getId()))) {
    ...
    public void setForcedSize(int i, int i2, float f, float f2, boolean z, boolean z2, boolean z3) {
        ...
        if (CoreRune.FW_VRR_RESOLUTION_POLICY_FOR_SHELL_TRANSITION && displayToken != null) {
            ...
            if (inTransition() && getSyncTransaction() == this.mSyncTransaction) {
                getSyncTransaction().addTransactionCommittedListener(new HandlerExecutor(this.mWmService.f1749mH), transactionCommittedListener);
            } else {
    ...
    public boolean updateFocusedWindowLocked(int i, boolean z, int i2) {
        ...
        if (this.mWmService.mAccessibilityController.hasCallbacks()) {
            this.mWmService.f1749mH.sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda30
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
    ...
    public void updateImeControlTarget(boolean z) {
        ...
        this.mWmService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void updateImeParent() {
        ...
        assignRelativeLayerForIme(getSyncTransaction(), true);
        scheduleAnimation();
        this.mWmService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.DisplayContent$$ExternalSyntheticLambda25
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean shouldWaitForSystemDecorWindowsOnBoot() {
        ...
        boolean z = this.mWmService.mContext.getResources().getBoolean(R.bool.config_enableFusedLocationOverlay) && this.mWmService.mContext.getResources().getBoolean(R.bool.config_cecSystemAudioModeMutingDisabled_allowed);
    ...
    public boolean updateDisplayOverrideConfigurationLocked() {
        ...
        this.mAtmService.f1734mH.sendMessage(PooledLambda.obtainMessage(new ActivityTaskManagerService$$ExternalSyntheticLambda9(), this.mAtmService.mAmInternal, Integer.valueOf(this.mDisplayId)));
        if (isDexMode()) {
    ...
    public class RemoteInsetsControlTarget implements InsetsControlTarget {
        ...
        public RemoteInsetsControlTarget(IDisplayWindowInsetsController iDisplayWindowInsetsController) {
            ...
            this.mCanShowTransient = DisplayContent.this.mWmService.mContext.getResources().getBoolean(R.bool.config_navBarTapThrough);
        }
    ...
    public final void updateIsOverlappingWithCutoutAsDefault() {
        ...
        int dimensionPixelSize = this.mDisplayPolicy.getCurrentUserResources().getDimensionPixelSize(R.dimen.timepicker_center_dot_radius);
