    ...
    public final class TaskOrganizerPendingEventsQueue {
        ...
        */
        public final void dispatchTaskInfoChanged(Task task, boolean z) {
            ...
            ActivityManager.RunningTaskInfo runningTaskInfo2 = (ActivityManager.RunningTaskInfo) this.mLastSentTaskInfos.get(task);
            ...
            try {
                ...
                if (this.mTmpTaskInfo.equalsForTaskOrganizer(runningTaskInfo2) && WindowOrganizerController.configurationsAreEqualForOrganizer(this.mTmpTaskInfo.configuration, runningTaskInfo2.configuration)) {
                    z2 = false;
                    if (!z2 || z) {
