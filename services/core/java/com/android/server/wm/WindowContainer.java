...
public abstract class WindowContainer extends ConfigurationContainer
  ...
  public interface IAnimationStarter {
    void startAnimation(
        ...
        boolean z,
        int i,
        AnimationAdapter animationAdapter2);
  }
  ...
  public static /* synthetic */ boolean lambda$getBottomMostActivity$3(
        ...
        new SurfaceAnimator(
            ...
            new SurfaceAnimator
                .OnAnimationFinishedCallback() { // from class:
                                                 // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda4
  ...
  public void updateAboveInsetsState(
    ...
    SparseArray createMergedSparseArray =
        createMergedSparseArray(sparseArray, this.mLocalInsetsSources);
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      ((WindowContainer) this.mChildren.get(size))
          .updateAboveInsetsState(insetsState, createMergedSparseArray, arraySet);
    }
  }

  public static SparseArray createMergedSparseArray(
  ...
  public final void setParent(WindowContainer windowContainer) {
    ...
    if (windowContainer3 != null
        && (displayContent = windowContainer3.mDisplayContent) != null
  ...
  public void setInitialSurfaceControlProperties(SurfaceControl.Builder builder) {
    setSurfaceControl(
        builder.setCallsite("WindowContainer.setInitialSurfaceControlProperties").build());
  ...
  public void migrateToNewSurfaceControl(SurfaceControl.Transaction transaction) {
    ...
    setInitialSurfaceControlProperties(
        this.mWmService.makeSurfaceBuilder(null).setContainerLayer().setName(getName()));
    SurfaceControl surfaceControl = this.mSurfaceControl;
    WindowContainer windowContainer = this.mParent;
    transaction.reparent(
        surfaceControl, windowContainer != null ? windowContainer.getSurfaceControl() : null);
    ...
    for (int i = 0; i < this.mChildren.size(); i++) {
      SurfaceControl surfaceControl3 =
          ((WindowContainer) this.mChildren.get(i)).getSurfaceControl();
  ...
  public void addChild(WindowContainer windowContainer, Comparator comparator) {
    ...
    if (!windowContainer.mReparenting && windowContainer.getParent() != null) {
      throw new IllegalArgumentException(
          "addChild: container="
              + windowContainer.getName()
              + " is already a child of container="
              + windowContainer.getParent().getName()
              + " can't add to container="
              + getName());
    }
    if (comparator != null) {
    ...
    if (!windowContainer.mReparenting && windowContainer.getParent() != null) {
      throw new IllegalArgumentException(
          "addChild: container="
              ...
              + getName()
              + "\n callers="
              + Debug.getCallers(15, KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE));
    }
    if ((i < 0 && i != POSITION_BOTTOM) || (i > this.mChildren.size() && i != Integer.MAX_VALUE)) {
      throw new IllegalArgumentException(
          "addChild: invalid position=" + i + ", children number=" + this.mChildren.size());
    }
  ...
  public final int getPrefixOrderIndex(WindowContainer windowContainer) {
    ...
    for (int i2 = 0;
        i2 < this.mChildren.size()
            && windowContainer != (windowContainer2 = (WindowContainer) this.mChildren.get(i2));
        i2++) {
  ...
  public void onRequestedOverrideConfigurationChanged(Configuration configuration) {
    int diffRequestedOverrideBounds =
        diffRequestedOverrideBounds(configuration.windowConfiguration.getBounds());
  ...
  public void onDisplayChanged(DisplayContent displayContent) {
    ...
    if (displayContent != this
        && (sparseArray = this.mLocalInsetsSources) != null
        && (!CoreRune.MW_CAPTION_SHELL_BUG_FIX || z)) {
      sparseArray.clear();
    }
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
  ...
  public static /* synthetic */ boolean lambda$isAppTransitioning$0(ActivityRecord activityRecord) {
  ...
  public boolean isAppTransitioning() {
    return getActivity(
            new Predicate() { // from class:
                              // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda15
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$isAppTransitioning$0;
                lambda$isAppTransitioning$0 =
                    WindowContainer.lambda$isAppTransitioning$0((ActivityRecord) obj);
  ...
  public boolean setVisibleRequested(boolean z) {
    ...
    for (int size = this.mListeners.size() - 1; size >= 0; size--) {
      ((WindowContainerListener) this.mListeners.get(size))
          .onVisibleRequestedChanged(this.mVisibleRequested);
    }
    return true;
  }
  ...
  public void setOrientation(int i, WindowContainer windowContainer) {
    ...
    if ((CoreRune.FW_ORIENTATION_CONTROL_WITH_ASPECT_RATIO
            && this.mWmService.mAtmService.mExt.mOrientationController
                .interceptSetOrientationIfNeeded(asActivityRecord()))
        || (parent = getParent()) == null) {
      return;
    }
    if (getConfiguration().orientation != getRequestedConfigurationOrientation()
        && (inMultiWindowMode() || !handlesOrientationChangeFromDescendant(i))) {
  ...
  public int getOrientation(int i) {
    ...
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      ...
      if (CoreRune.FW_ORIENTATION_CONTROL
          && (adjustedOrientation =
                  this.mWmService.mAtmService.mExt.mOrientationController.getAdjustedOrientation(
                      windowContainer.asActivityRecord(), size, false, i))
              != -2) {
      ...
      if (orientation == 3) {
        ...
        i = orientation;
          ...
          && (windowContainer.providesOrientation() || orientation != -1)) {
        if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
          ProtoLogImpl.v(
              ...
              (String) null,
              new Object[] {
                String.valueOf(windowContainer.toString()),
                Long.valueOf(orientation),
                String.valueOf(ActivityInfo.screenOrientationToString(orientation))
              });
        }
        this.mLastOrientationSource = windowContainer;
        return orientation;
  ...
  public WindowContainer getLastOrientationSource() {
    ...
    return (windowContainer == null
            ...
            || (lastOrientationSource = windowContainer.getLastOrientationSource()) == null)
        ? windowContainer
        : lastOrientationSource;
  }
  ...
  public final boolean forAllActivities(
      Predicate predicate, WindowContainer windowContainer, boolean z, boolean z2) {
    return forAllActivities(predicate, windowContainer, z, z2, new boolean[1]);
  }

  public final boolean forAllActivities(
      Predicate predicate, WindowContainer windowContainer, boolean z, boolean z2, boolean[] zArr) {
    if (z2) {
      for (int size = this.mChildren.size() - 1; size >= 0; size--) {
        if (processForAllActivitiesWithBoundary(
            predicate, windowContainer, z, z2, zArr, (WindowContainer) this.mChildren.get(size))) {
          return true;
        }
      }
    } else {
      ...
      for (int i = 0; i < size2; i++) {
        if (processForAllActivitiesWithBoundary(
            predicate, windowContainer, z, z2, zArr, (WindowContainer) this.mChildren.get(i))) {
          return true;
        }
      }
    }
  ...
  public final boolean processForAllActivitiesWithBoundary(
      Predicate predicate,
  ...
  public final ActivityRecord getActivity(
    ...
    if (z2) {
      for (int size = this.mChildren.size() - 1; size >= 0; size--) {
        ActivityRecord processGetActivityWithBoundary =
            processGetActivityWithBoundary(
                predicate,
                windowContainer,
                z,
                z2,
    ...
    int size2 = this.mChildren.size();
    for (int i = 0; i < size2; i++) {
      ActivityRecord processGetActivityWithBoundary2 =
          processGetActivityWithBoundary(
              predicate, windowContainer, z, z2, zArr, (WindowContainer) this.mChildren.get(i));
  ...
  public final ActivityRecord processGetActivityWithBoundary(
      Predicate predicate,
      WindowContainer windowContainer,
      boolean z,
      boolean z2,
  ...
  public ActivityRecord getActivityAbove(ActivityRecord activityRecord) {
    return getActivity(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda11
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getActivityAbove$1;
            lambda$getActivityAbove$1 =
                WindowContainer.lambda$getActivityAbove$1((ActivityRecord) obj);
  ...
  public ActivityRecord getActivityBelow(ActivityRecord activityRecord) {
    return getActivity(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda7
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getActivityBelow$2;
            lambda$getActivityBelow$2 =
                WindowContainer.lambda$getActivityBelow$2((ActivityRecord) obj);
  ...
  public ActivityRecord getBottomMostActivity() {
    return getActivity(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda14
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getBottomMostActivity$3;
            lambda$getBottomMostActivity$3 =
                WindowContainer.lambda$getBottomMostActivity$3((ActivityRecord) obj);
  ...
  public ActivityRecord getTopMostActivity() {
    return getActivity(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda9
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getTopMostActivity$4;
            lambda$getTopMostActivity$4 =
                WindowContainer.lambda$getTopMostActivity$4((ActivityRecord) obj);
  ...
  public ActivityRecord getTopActivity(boolean z, boolean z2) {
    if (z) {
      if (z2) {
        return getActivity(
            new Predicate() { // from class:
                              // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda0
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$getTopActivity$5;
                lambda$getTopActivity$5 =
                    WindowContainer.lambda$getTopActivity$5((ActivityRecord) obj);
      ...
      return getActivity(
          new Predicate() { // from class:
                            // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$getTopActivity$6;
              lambda$getTopActivity$6 =
                  WindowContainer.lambda$getTopActivity$6((ActivityRecord) obj);
    ...
    if (z2) {
      return getActivity(
          new Predicate() { // from class:
                            // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$getTopActivity$7;
              lambda$getTopActivity$7 =
                  WindowContainer.lambda$getTopActivity$7((ActivityRecord) obj);
    ...
    return getActivity(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda3
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
  ...
  public Task getTaskAbove(Task task) {
    return getTask(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda13
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
  ...
  public Task getTaskBelow(Task task) {
    return getTask(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda10
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
  ...
  public Task getBottomMostTask() {
    return getTask(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda12
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
  ...
  public Task getTopMostTask() {
    return getTask(
        new Predicate() { // from class:
                          // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda8
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
  ...
  public final Task getTask(
    ...
    if (z2) {
      for (int size = this.mChildren.size() - 1; size >= 0; size--) {
        Task processGetTaskWithBoundary =
            processGetTaskWithBoundary(
                predicate,
                windowContainer,
                z,
                z2,
    ...
    int size2 = this.mChildren.size();
    for (int i = 0; i < size2; i++) {
      Task processGetTaskWithBoundary2 =
          processGetTaskWithBoundary(
              predicate, windowContainer, z, z2, zArr, (WindowContainer) this.mChildren.get(i));
  ...
  public final Task processGetTaskWithBoundary(
      Predicate predicate,
      WindowContainer windowContainer,
      boolean z,
      boolean z2,
  ...
  public TaskFragment getTaskFragment(Predicate predicate) {
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      TaskFragment taskFragment =
          ((WindowContainer) this.mChildren.get(size)).getTaskFragment(predicate);
  ...
  public Object reduceOnAllTaskDisplayAreas(BiFunction biFunction, Object obj, boolean z) {
    ...
    while (i >= 0 && i < size) {
      obj =
          ((WindowContainer) this.mChildren.get(i)).reduceOnAllTaskDisplayAreas(biFunction, obj, z);
      i += z ? -1 : 1;
    }
    return obj;
  }
  ...
  public Object getItemFromDisplayAreas(Function function) {
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      Object itemFromDisplayAreas =
          ((WindowContainer) this.mChildren.get(size)).getItemFromDisplayAreas(function);
  ...
  public Object getItemFromTaskDisplayAreas(Function function, boolean z) {
    ...
    while (i >= 0 && i < size) {
      Object itemFromTaskDisplayAreas =
          ((WindowContainer) this.mChildren.get(i)).getItemFromTaskDisplayAreas(function, z);
  ...
  */
  public int compareTo(WindowContainer windowContainer) {
    ...
    if (windowContainer2 != null && windowContainer2 == windowContainer.mParent) {
      WindowList windowList = windowContainer2.mChildren;
      return windowList.indexOf(this) > windowList.indexOf(windowContainer) ? 1 : -1;
    }
    LinkedList linkedList = this.mTmpChain1;
    LinkedList linkedList2 = this.mTmpChain2;
    try {
      getParents(linkedList);
      windowContainer.getParents(linkedList2);
      WindowContainer windowContainer3 = (WindowContainer) linkedList.peekLast();
      WindowContainer windowContainer4 = null;
      for (WindowContainer windowContainer5 = (WindowContainer) linkedList2.peekLast();
          windowContainer3 != null
              && windowContainer5 != null
              && windowContainer3 == windowContainer5;
          windowContainer5 = (WindowContainer) linkedList2.peekLast()) {
        windowContainer4 = (WindowContainer) linkedList.removeLast();
        linkedList2.removeLast();
        windowContainer3 = (WindowContainer) linkedList.peekLast();
      }
      throw new IllegalArgumentException(
          "No in the same hierarchy this=" + linkedList + " other=" + linkedList2);
    } finally {
  ...
  public void assignLayer(SurfaceControl.Transaction transaction, int i, boolean z) {
    if ((CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX && z)
        || this.mTransitionController.canAssignLayers(this)) {
  ...
  public void assignRelativeLayer(
    ...
    boolean z2 =
        (i == this.mLastLayer && this.mLastRelativeToLayer == surfaceControl) ? false : true;
    if (this.mSurfaceControl != null) {
      if (z2 || z) {
  ...
  public void reparentSurfaceControl(
  ...
  public final ForAllWindowsConsumerWrapper obtainConsumerWrapper(Consumer consumer) {
    ForAllWindowsConsumerWrapper forAllWindowsConsumerWrapper =
        (ForAllWindowsConsumerWrapper) this.mConsumerWrapperPool.acquire();
  ...
  public void applyMagnificationSpec(
      SurfaceControl.Transaction transaction, MagnificationSpec magnificationSpec) {
    if (shouldMagnify()) {
      SurfaceControl surfaceControl = this.mSurfaceControl;
      float f = magnificationSpec.scale;
      SurfaceControl.Transaction matrix =
    ...
    for (int i = 0; i < this.mChildren.size(); i++) {
      ((WindowContainer) this.mChildren.get(i))
          .applyMagnificationSpec(transaction, magnificationSpec);
    }
  }
  ...
  public void startAnimation(
    ...
    if (ProtoLogCache.WM_DEBUG_ANIM_enabled) {
      ProtoLogImpl.v(
          ...
          4,
          (String) null,
          new Object[] {String.valueOf(this), Long.valueOf(i), String.valueOf(animationAdapter)});
    }
  ...
  public void startAnimation(
      SurfaceControl.Transaction transaction, AnimationAdapter animationAdapter, boolean z, int i) {
  ...
  public void cancelAnimation(SurfaceControl.Transaction transaction) {
    doAnimationFinished(
        this.mSurfaceAnimator.getAnimationType(), this.mSurfaceAnimator.getAnimation());
  ...
  public boolean canStartChangeTransition() {
    return (this.mWmService.mDisableTransitionAnimation
            ...
            || this.mDisplayContent.inTransition()
            || !isVisible()
            || !isVisibleRequested()
            || !okToAnimate()
  ...
  public SurfaceControl getFreezeSnapshotTarget() {
    if (this.mDisplayContent.mAppTransition.containsTransitRequest(6)
        && this.mDisplayContent.mChangingContainers.contains(this)) {
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public Pair getAnimationAdapter(
      WindowManager.LayoutParams layoutParams, int i, boolean z, boolean z2) {
    boolean z3;
    int i2;
    Rect rect;
    RemoteAnimationController.RemoteAnimationRecord createRemoteAnimationRecord;
    boolean z4 = true;
    int appRootTaskClipMode =
        (CoreRune.MW_FREEFORM_SHELL_TRANSITION && inFreeformWindowingMode())
            ? 1
            : getDisplayContent().mAppTransition.getAppRootTaskClipMode();
    ...
    RemoteAnimationController remoteAnimationController =
        appTransition.getRemoteAnimationController();
    Object[] objArr = AppTransition.isChangeTransitOld(i) && z && isChangingAppTransition();
    if (remoteAnimationController == null || this.mSurfaceAnimator.isAnimationStartDelayed()) {
      if (objArr != false) {
        ...
        LocalAnimationAdapter localAnimationAdapter =
            new LocalAnimationAdapter(
                new WindowChangeAnimationSpec(
                    this.mSurfaceFreezer.mFreezeBounds,
                    this.mTmpRect,
                    displayInfo,
                    transitionAnimationScaleLocked,
                    true,
                    false),
    ...
    if (CoreRune.FW_MERGE_REMOTE_ANIMATION
        && mergeAnimationIfNeeded(i, remoteAnimationController)) {
      return new Pair(null, null);
    }
    if (remoteAnimationController.isFromActivityEmbedding()) {
      if (objArr != false) {
        boolean z5 = getDisplayContent().mChangingContainers.size() > 1;
        ...
        if (nextAppRequestedAnimation != null) {
          z3 = nextAppRequestedAnimation.getShowBackdrop();
      ...
      if (objArr != false && !z && isClosingWhenResizing()) {
        createRemoteAnimationRecord =
            remoteAnimationController.createRemoteAnimationRecord(
                ...
                rect,
                animationBounds,
                (Rect) getDisplayContent().mClosingChangingContainers.remove(this),
                z3,
                false);
      } else {
        createRemoteAnimationRecord =
            remoteAnimationController.createRemoteAnimationRecord(
                ...
                rect,
                animationBounds,
                objArr == true ? this.mSurfaceFreezer.mFreezeBounds : null,
                z3);
      }
      if (i2 != 0) {
      ...
      return new Pair(
          createRemoteAnimationRecord.mAdapter, createRemoteAnimationRecord.mThumbnailAdapter);
    }
    z3 = false;
    i2 = 0;
    rect = new Rect(this.mTmpRect);
  ...
  public void applyAnimationUnchecked(
      WindowManager.LayoutParams layoutParams, boolean z, int i, boolean z2, ArrayList arrayList) {
    ...
    if (asTask != null && !z && !asTask.isActivityTypeHomeOrRecents()) {
      ...
      if (imeTarget != null
          && imeTarget.getWindow() != null
          && imeTarget.getWindow().getTask() == asTask) {
        z3 = true;
      }
    ...
    if (animationAdapter2 != null) {
      ...
      if (animationAdapter2.getShowBackground()
          && ((asActivityRecord != null && AppTransition.isActivityTransitOld(i))
              || (asTaskFragment != null
                  && asTaskFragment.isEmbedded()
                  && AppTransition.isTaskFragmentTransitOld(i)))) {
        if (animationAdapter2.getBackgroundColor() != 0) {
          ...
          if (organizedTaskFragment != null
              && organizedTaskFragment.getAnimationParams().getAnimationBackgroundColor() != 0) {
            backgroundColor =
                organizedTaskFragment.getAnimationParams().getAnimationBackgroundColor();
          } else {
            if (asActivityRecord != null) {
        ...
        animationRunnerBuilder.setTaskBackgroundColor(
            ColorUtils.setAlphaComponent(
                backgroundColor, IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT));
      }
      animationRunnerBuilder
          .build()
          .startAnimation(
              getPendingTransaction(), animationAdapter2, !isVisible(), 1, animationAdapter3);
  ...
  public final int getTaskAnimationBackgroundColor() {
    ...
    int color = systemUiContext.getColor(R.color.ratingbar_background_material);
  ...
  public final Animation loadAnimation(
    ...
    if (ProtoLogCache.WM_FORCE_DEBUG_APP_TRANSITIONS_enabled) {
      ProtoLogImpl.d(
          ...
          new Object[] {
            ...
            Boolean.valueOf(z3),
            String.valueOf(rect),
            String.valueOf(rect3),
            String.valueOf(rect5)
          });
    }
    ...
    if (loadAnimation != null) {
      ...
      if (ProtoLogImpl.isEnabled(ProtoLogGroup.WM_DEBUG_ANIM)
          && ProtoLogCache.WM_DEBUG_ANIM_enabled) {
        ProtoLogImpl.i(
            ProtoLogGroup.WM_DEBUG_ANIM,
            769218938,
            16,
            (String) null,
            new Object[] {
              String.valueOf(loadAnimation),
              String.valueOf(this),
              Long.valueOf(loadAnimation.getDuration()),
              String.valueOf(Debug.getCallers(20))
            });
      }
      if (asActivityRecord() != null
          && asActivityRecord().mPopOverState.isActivated()
          && (AppTransition.isTaskTransitOld(i)
              || AppTransition.isKeyguardGoingAwayTransitOld(i))) {
  ...
  public final void doAnimationFinished(int i, AnimationAdapter animationAdapter) {
    for (int i2 = 0; i2 < this.mSurfaceAnimationSources.size(); i2++) {
      ((WindowContainer) this.mSurfaceAnimationSources.valueAt(i2))
          .onAnimationFinished(i, animationAdapter);
    }
  ...
  public WindowContainer getAnimatingContainer(int i, int i2) {
    ...
    for (int i3 = 0; i3 < this.mChildren.size(); i3++) {
      WindowContainer animatingContainer =
          ((WindowContainer) this.mChildren.get(i3)).getAnimatingContainer(i & (-3), i2);
  ...
  public boolean isSelfAnimating(int i, int i2) {
    if (!this.mSurfaceAnimator.isAnimating()
        || (i2 & this.mSurfaceAnimator.getAnimationType()) <= 0) {
  ...
  public void updateSurfacePosition(SurfaceControl.Transaction transaction) {
    ...
    if (isClosingWhenResizing()) {
      getRelativePosition(
          (Rect) this.mDisplayContent.mClosingChangingContainers.get(this), this.mTmpPos);
    } else {
    ...
    if (this.mTmpPos.equals(this.mLastSurfacePosition)
        && relativeDisplayRotation == this.mLastDeltaRotation) {
      return;
    }
    SurfaceControl surfaceControl = this.mSurfaceControl;
    ...
    if (this.mTransitionController.isShellTransitionsEnabled()
        && !this.mTransitionController.useShellTransitionsRotation()) {
      if (relativeDisplayRotation != 0) {
        updateSurfaceRotation(transaction, relativeDisplayRotation, null);
        getPendingTransaction()
            .setFixedTransformHint(
                this.mSurfaceControl, getWindowConfiguration().getDisplayRotation());
  ...
  public void updateSurfaceRotation(
    ...
    RotationUtils.rotatePoint(
        this.mTmpPos,
        i,
        z ? bounds.height() : bounds.width(),
        z ? bounds.width() : bounds.height());
    if (surfaceControl == null) {
  ...
  public int getRelativeDisplayRotation() {
    ...
    return RotationUtils.deltaRotation(
        getWindowConfiguration().getDisplayRotation(),
        parent.getWindowConfiguration().getDisplayRotation());
  }

  public void waitForAllWindowsDrawn() {
    forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda5
  ...
  public void setSyncGroup(BLASTSyncEngine.SyncGroup syncGroup) {
    if (ProtoLogCache.WM_DEBUG_SYNC_ENGINE_enabled) {
      ProtoLogImpl.v(
          ...
          1,
          (String) null,
          new Object[] {Long.valueOf(syncGroup.mSyncId), String.valueOf(this)});
    }
    BLASTSyncEngine.SyncGroup syncGroup2 = this.mSyncGroup;
    if (syncGroup2 != null && syncGroup2 != syncGroup) {
      throw new IllegalStateException(
          "Can't sync on 2 groups simultaneously currentSyncId="
              + this.mSyncGroup.mSyncId
              + " newSyncId="
              + syncGroup.mSyncId
              + " wc="
              + this);
  ...
  public BLASTSyncEngine.SyncGroup getSyncGroup() {
    ...
    for (WindowContainer windowContainer = this.mParent;
  ...
  public boolean isSyncFinished(BLASTSyncEngine.SyncGroup syncGroup) {
    ...
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      WindowContainer windowContainer = (WindowContainer) this.mChildren.get(size);
      boolean z =
          syncGroup.isIgnoring(windowContainer) || windowContainer.isSyncFinished(syncGroup);
  ...
  public final void onSyncReparent(
      WindowContainer windowContainer, WindowContainer windowContainer2) {
    if (this.mSyncState != 0
        && windowContainer != null
        && windowContainer2 != null
        && windowContainer.getDisplayContent() != null
        && windowContainer2.getDisplayContent() != null
        && windowContainer.getDisplayContent() != windowContainer2.getDisplayContent()) {
  ...
  public void registerWindowContainerListener(
      WindowContainerListener windowContainerListener, boolean z) {
  ...
  public static void overrideConfigurationPropagation(
      WindowContainer windowContainer, WindowContainer windowContainer2) {
    overrideConfigurationPropagation(windowContainer, windowContainer2, null);
  }

  public static WindowContainerListener overrideConfigurationPropagation(
      final WindowContainer windowContainer,
      final WindowContainer windowContainer2,
      final ConfigurationMerger configurationMerger) {
    final ConfigurationContainerListener configurationContainerListener =
        new ConfigurationContainerListener() { // from class:
                                               // com.android.server.wm.WindowContainer.1
          ...
          public void onMergedOverrideConfigurationChanged(Configuration configuration) {
            ...
            if (configurationMerger2 != null) {
              configuration2 =
                  configurationMerger2.merge(
                      configuration, windowContainer.getRequestedOverrideConfiguration());
            } else {
    ...
    WindowContainerListener windowContainerListener =
        new WindowContainerListener() { // from class: com.android.server.wm.WindowContainer.2
  ...
  public class AnimationRunnerBuilder {
    ...
    public final void setTaskBackgroundColor(int i) {
      ...
      Runnable runnable =
          new Runnable() { // from class:
                           // com.android.server.wm.WindowContainer$AnimationRunnerBuilder$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              WindowContainer.AnimationRunnerBuilder.lambda$setTaskBackgroundColor$0(
                  atomicInteger, taskDisplayArea);
            }
          };
    ...
    public static /* synthetic */ void lambda$setTaskBackgroundColor$0(
        AtomicInteger atomicInteger, TaskDisplayArea taskDisplayArea) {
    ...
    public final void hideInsetSourceViewOverflows() {
      SparseArray sourceProviders =
          WindowContainer.this.getDisplayContent().getInsetsStateController().getSourceProviders();
      for (int size = sourceProviders.size(); size >= 0; size--) {
        final InsetsSourceProvider insetsSourceProvider =
            (InsetsSourceProvider) sourceProviders.valueAt(size);
        if (!insetsSourceProvider.getSource().insetsRoundedCornerFrame()) {
          return;
        }
        insetsSourceProvider.setCropToProvidingInsetsBounds(
            WindowContainer.this.getPendingTransaction());
        this.mOnAnimationFinished.add(
            new Runnable() { // from class:
                             // com.android.server.wm.WindowContainer$AnimationRunnerBuilder$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
                WindowContainer.AnimationRunnerBuilder.this.lambda$hideInsetSourceViewOverflows$1(
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$hideInsetSourceViewOverflows$1(
        InsetsSourceProvider insetsSourceProvider) {
      insetsSourceProvider.removeCropToProvidingInsetsBounds(
          WindowContainer.this.getPendingTransaction());
    }

    public final IAnimationStarter build() {
      return new IAnimationStarter() { // from class:
                                       // com.android.server.wm.WindowContainer$AnimationRunnerBuilder$$ExternalSyntheticLambda1
        ...
        public final void startAnimation(
            ...
            int i,
            AnimationAdapter animationAdapter2) {
          WindowContainer.AnimationRunnerBuilder.this.lambda$build$4(
              transaction, animationAdapter, z, i, animationAdapter2);
        }
      };
    }
    ...
    public /* synthetic */ void lambda$build$4(
      ...
      windowContainer.startAnimation(
          windowContainer.getPendingTransaction(),
          animationAdapter,
          !WindowContainer.this.isVisible(),
          i,
          new SurfaceAnimator
              .OnAnimationFinishedCallback() { // from class:
                                               // com.android.server.wm.WindowContainer$AnimationRunnerBuilder$$ExternalSyntheticLambda3
            @Override // com.android.server.wm.SurfaceAnimator.OnAnimationFinishedCallback
          ...
          new Runnable() { // from class:
                           // com.android.server.wm.WindowContainer$AnimationRunnerBuilder$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void addTrustedOverlay(
      SurfaceControlViewHost.SurfacePackage surfacePackage, WindowState windowState) {
    ...
    if (windowState != null) {
      try {
        surfacePackage
            .getRemoteInterface()
            .onInsetsChanged(windowState.getInsetsState(), getBounds());
      } catch (Exception unused2) {
        if (ProtoLogCache.WM_DEBUG_ANIM_enabled) {
          ProtoLogImpl.e(
              ProtoLogGroup.WM_DEBUG_ANIM, 1288920916, 0, (String) null, (Object[]) null);
        }
        removeTrustedOverlay(surfacePackage);
      }
    }
  ...
  public boolean hasRelativeLayer() {
    WindowContainer windowContainer;
    return this.mLastRelativeToLayer != null
        || ((windowContainer = this.mParent) != null && windowContainer.hasRelativeLayer());
  }
  ...
  public final boolean inUdcCutoutMode() {
    ...
    return (displayContent == null
            || (udcCutoutPolicy = displayContent.mUdcCutoutPolicy) == null
            || !udcCutoutPolicy.hasUdcCutout()
            || inMultiWindowMode())
        ? false
        : true;
  }
  ...
  public void resolveOverrideConfiguration(Configuration configuration) {
    ...
    if (!isConfigurationNeededInUdcCutout()
        || this.mDisplayContent.mUdcCutoutPolicy.mUdcConfiguration == null) {
      return;
    }
    getResolvedOverrideConfiguration()
        .updateFrom(this.mDisplayContent.mUdcCutoutPolicy.mUdcConfiguration);
  }

  public boolean mergeAnimationIfNeeded(
      int i, RemoteAnimationController remoteAnimationController) {
    if (AppTransition.isKeyguardTransit(i)
        || this.mSurfaceAnimator.getAnimation() == null
        || !(this.mSurfaceAnimator.getAnimation()
            instanceof RemoteAnimationController.RemoteAnimationAdapterWrapper)) {
      return false;
    }
    final RemoteAnimationAdapter remoteAnimationAdapter =
        ((RemoteAnimationController.RemoteAnimationAdapterWrapper)
                this.mSurfaceAnimator.getAnimation())
            .mOuterRemoteAnimationAdapter;
    RemoteAnimationAdapter remoteAnimationAdapter2 =
        remoteAnimationController.mRemoteAnimationAdapter;
    Slog.d(
        "WindowManager",
        "mergeAnimationIfNeeded, try not to use new remote anim, oldAnimPid="
            + remoteAnimationAdapter.getCallingPid()
            + ", newAnimPid="
            + remoteAnimationAdapter2.getCallingPid()
            + ", oldMergeCallback="
            + remoteAnimationAdapter.getMergeCallback()
            + ", newMergeCallback="
            + remoteAnimationAdapter2.getMergeCallback());
    if (remoteAnimationAdapter.getCallingPid() != remoteAnimationAdapter2.getCallingPid()
        || remoteAnimationAdapter.getMergeCallback() == null
        || remoteAnimationAdapter2.getMergeCallback() != null
        || remoteAnimationAdapter.mMergedState < 1) {
      return false;
    }
    Slog.d(
        "WindowManager", "mergeAnimationIfNeeded, not to use new remote anim, container=" + this);
    if (remoteAnimationAdapter.mMergedState != 2) {
      remoteAnimationAdapter.mMergedState = 2;
      this.mWmService.mAnimator.addAfterPrepareSurfacesRunnable(
          new Runnable() { // from class:
                           // com.android.server.wm.WindowContainer$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public static /* synthetic */ void lambda$mergeAnimationIfNeeded$14(
  ...
  public int getCaptionHeight(boolean z, int i) {
    ...
    return this.mWmService.mAtmService.mFreeformController.getDecorCaptionHeight(
        this.mDisplayContent.getDisplayPolicy().getCurrentUserResources(), this, z, i);
  }
  ...
  public int getFreeformThickness() {
    ...
    return this.mWmService.mAtmService.mFreeformController.getFreeformThickness(
        this.mDisplayContent.getDisplayPolicy().getCurrentUserResources());
  }
  ...
  public boolean shouldSkipTransition() {
    return this.mWmService.mExt.mExtraDisplayPolicy.shouldSkipAppTransition(
