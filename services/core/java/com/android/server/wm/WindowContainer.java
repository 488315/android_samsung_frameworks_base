    ...
    public boolean isAppTransitioning() {
        return getActivity(new Predicate() { // from class: com.android.server.wm.WindowContainer$$ExternalSyntheticLambda15
            ...
            public final boolean test(Object obj) {
                ...
                lambda$isAppTransitioning$0 = WindowContainer.lambda$isAppTransitioning$0((ActivityRecord) obj);
    ...
    */
    public int compareTo(WindowContainer windowContainer) {
        ...
        try {
            ...
            for (WindowContainer windowContainer5 = (WindowContainer) linkedList2.peekLast(); windowContainer3 != null && windowContainer5 != null && windowContainer3 == windowContainer5; windowContainer5 = (WindowContainer) linkedList2.peekLast()) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public Pair getAnimationAdapter(WindowManager.LayoutParams layoutParams, int i, boolean z, boolean z2) {
        boolean z3;
        int i2;
        Rect rect;
        RemoteAnimationController.RemoteAnimationRecord createRemoteAnimationRecord;
        boolean z4 = true;
        int appRootTaskClipMode = (CoreRune.MW_FREEFORM_SHELL_TRANSITION && inFreeformWindowingMode()) ? 1 : getDisplayContent().mAppTransition.getAppRootTaskClipMode();
        ...
        if (remoteAnimationController == null || this.mSurfaceAnimator.isAnimationStartDelayed()) {
            if (objArr != false) {
                ...
                Pair pair = new Pair(localAnimationAdapter, surfaceFreezer.mSnapshot != null ? new LocalAnimationAdapter(new WindowChangeAnimationSpec(surfaceFreezer.mFreezeBounds, this.mTmpRect, displayInfo, transitionAnimationScaleLocked, true, true), getSurfaceAnimationRunner()) : null);
                this.mTransit = i;
            ...
            if (loadAnimation != null) {
                float windowCornerRadius = !inMultiWindowMode() ? getDisplayContent().getWindowCornerRadius() : DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
                ...
                Pair pair2 = new Pair(new LocalAnimationAdapter(new WindowAnimationSpec(loadAnimation, this.mTmpPoint, this.mTmpRect, getDisplayContent().mAppTransition.canSkipFirstFrame(), appRootTaskClipMode, true, windowCornerRadius, allowEdgeExtension()), getSurfaceAnimationRunner()), null);
        ...
        if (CoreRune.FW_MERGE_REMOTE_ANIMATION && mergeAnimationIfNeeded(i, remoteAnimationController)) {
            return new Pair(null, null);
        }
        if (remoteAnimationController.isFromActivityEmbedding()) {
            ...
            if (objArr != false && !z && isClosingWhenResizing()) {
                createRemoteAnimationRecord = remoteAnimationController.createRemoteAnimationRecord(this, this.mTmpPoint, rect, animationBounds, (Rect) getDisplayContent().mClosingChangingContainers.remove(this), z3, false);
            } else {
                createRemoteAnimationRecord = remoteAnimationController.createRemoteAnimationRecord(this, this.mTmpPoint, rect, animationBounds, objArr == true ? this.mSurfaceFreezer.mFreezeBounds : null, z3);
            }
            if (i2 != 0) {
