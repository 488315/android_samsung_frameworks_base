...
public final /* synthetic */ class LaunchObserverRegistryImpl$$ExternalSyntheticLambda2
                ...
                for (int i = 0; i < launchObserverRegistryImpl.mList.size(); i++) {
                    ((ActivityMetricsLaunchObserver) launchObserverRegistryImpl.mList.get(i))
                            .onActivityLaunchFinished(
                                    longValue, componentName, longValue2, intValue);
                }
                break;
            default:
                ...
                for (int i2 = 0; i2 < launchObserverRegistryImpl2.mList.size(); i2++) {
                    ((ActivityMetricsLaunchObserver) launchObserverRegistryImpl2.mList.get(i2))
                            .onActivityLaunched(intValue2, intValue3, longValue3, componentName2);
                }
                break;
        }
    }
