...
public final class ActivityRecord extends WindowToken implements WindowManagerService.AppFreezeListener {
    ...
    public final void updateEnterpriseThumbnailDrawable(final Context context) {
        this.mEnterpriseThumbnailDrawable = ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getResources().getDrawable("WORK_PROFILE_ICON", "OUTLINE", "PROFILE_SWITCH_ANIMATION", new Supplier() { // from class: com.android.server.wm.ActivityRecord$$ExternalSyntheticLambda30
            ...
            public final Object get() {
                ...
                lambda$updateEnterpriseThumbnailDrawable$0 = ActivityRecord.lambda$updateEnterpriseThumbnailDrawable$0(context);
                return lambda$updateEnterpriseThumbnailDrawable$0;
            }
        });
    }

    public static /* synthetic */ Drawable lambda$updateEnterpriseThumbnailDrawable$0(Context context) {
    ...
    public /* synthetic */ void lambda$new$2(final float[] fArr, final float[] fArr2) {
        this.mWmService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.ActivityRecord$$ExternalSyntheticLambda29
    ...
    public ActivityRecord(ActivityTaskManagerService activityTaskManagerService, WindowProcessController windowProcessController, int i, int i2, String str, String str2, Intent intent, String str3, ActivityInfo activityInfo, Configuration configuration, ActivityRecord activityRecord, String str4, int i3, boolean z, boolean z2, ActivityTaskSupervisor activityTaskSupervisor, ActivityOptions activityOptions, ActivityRecord activityRecord2, PersistableBundle persistableBundle, ActivityManager.TaskDescription taskDescription, long j) {
        ...
        this.mCameraCompatControlEnabled = this.mWmService.mContext.getResources().getBoolean(R.bool.config_fingerprintSupportsGestures);
        ...
        this.shouldDockBigOverlays = this.mWmService.mContext.getResources().getBoolean(R.bool.config_defaultEmergencyGestureSoundEnabled);
        if (j > 0) {
            this.createTime = j;
        }
    ...
    */
    ...
    public boolean checkEnterPictureInPictureState(String str, boolean z, boolean z2) {
        ...
        int i = AbstractC28617.$SwitchMap$com$android$server$wm$ActivityRecord$State[this.mState.ordinal()];
        if (i == 1) {
            return z2;
        }
        if (i != 2) {
    ...
    public final void finishActivityResults(final int i, final Intent intent, final NeededUriGrants neededUriGrants) {
        ...
        if (activityRecord != null) {
            ...
            if (this.mForceSendResultForMediaProjection || this.resultTo.isState(State.RESUMED)) {
                ...
                this.mAtmService.f1734mH.post(new Runnable() { // from class: com.android.server.wm.ActivityRecord$$ExternalSyntheticLambda14
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    */
    public int finishIfPossible(int i, Intent intent, NeededUriGrants neededUriGrants, String str, boolean z) {
        ...
        int i2 = 1;
        boolean z3 = (isState(state) || rootTask2.getTopResumedActivity() == null) && rootTask2.isFocusedRootTaskOnDisplay() && !this.task.isClearingToReuseTask();
        ...
        try {
            ...
            Transition requestCloseTransitionIfNeeded = this.mTransitionController.requestCloseTransitionIfNeeded(z5 ? task : this);
            if (!"clear-task-all".equals(str) && !"clear-task-stack".equals(str) && !"clear-task-top".equals(str)) {
                z2 = false;
                if (!z2 && task.isDexCompatEnabled() && (activityRecord2 = rootTask2.topRunningActivity()) != null) {
                    this.mAtmService.mDexCompatController.changeWindowingModeIfNeeded(rootTask2, task, activityRecord2);
                }
                if (CoreRune.MW_SHELL_CHANGE_TRANSITION) {
                    this.mAtmService.mChangeTransitController.onActivityFinished(this);
                }
                if (CoreRune.MW_EMBED_ACTIVITY && this.app != null && !z5 && isSplitEmbedded() && task.getTopMostActivity() == this && task.getNonFinishingActivityCount() != 0) {
                    this.app.updateTopActivityIfNeeded(null);
                }
                if (CoreRune.MW_SPLIT_SHELL_TRANSITION && inSplitScreenWindowingMode() && this.mTransitionController.getCollectingTransitionType() == 3) {
                    changeInfo = (Transition.ChangeInfo) this.mTransitionController.getCollectingTransition().mChanges.get(task);
                ...
                if (!isState(state)) {
                    ...
                    if (CoreRune.MW_SHELL_CHANGE_TRANSITION && CoreRune.MW_SHELL_TRANSITION_BUG_FIX && !z5 && this.mAtmService.mChangeTransitController.isInChangeTransition(task)) {
                        rootTask2.ensureActivitiesVisible(null, 0, false);
                    }
                    if (CoreRune.MW_SHELL_TRANSITION_BUG_FIX && this.noDisplay && inFreeformWindowingMode() && z5 && task != (rootTask = this.mDisplayContent.getRootTask(5, 1)) && rootTask != null && rootTask.isAliasManaged()) {
    ...
    public ActivityRecord completeFinishing(boolean z, String str) {
        ...
        if (activityRecord != null && taskFragment != null && taskFragment.isEmbedded()) {
            ...
            if (adjacentTaskFragment != null && activityRecord.isDescendantOf(adjacentTaskFragment) && organizedTaskFragment.topRunningActivity() == null) {
                ...
                z3 = activityRecord == null && !((activityRecord.nowVisible && activityRecord.isVisibleRequested()) || inPinnedWindowingMode());
                ...
                if (!z5) {
                    if (CoreRune.MW_FREEFORM_SHELL_TRANSITION && !z2 && inFreeformWindowingMode() && (task = this.task) != null && task.isRemovalRequested()) {
    ...
    */
    public void onRemovedFromDisplay() {
        ...
        if (isAnimating && (!isEmpty() || (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX && this.mTransitionController.inTransition(this)))) {
            if (ProtoLogCache.WM_DEBUG_ADD_REMOVE_enabled) {
    ...
    public void makeInvisible() {
        if (this.mVisibleRequested) {
            try {
                ...
                setVisibility(false);
                switch (AbstractC28617.$SwitchMap$com$android$server$wm$ActivityRecord$State[getState().ordinal()]) {
                    case 1:
                    case 2:
                    case 3:
                    case 4:
    ...
    public void attachCrossProfileAppsThumbnailAnimation() {
        ...
        if (isAnimating(2, 1)) {
            ...
            if (this.task.mUserId == this.mWmService.mCurrentUserId) {
                drawable = this.mAtmService.getUiContext().getDrawable(R.drawable.grid_selector_background_focus);
            } else {
    ...
    */
    public final void resolveSizeCompatModeConfiguration(Configuration configuration, CompatDisplayInsets compatDisplayInsets) {
        ...
        if (CoreRune.FW_ORIENTATION_CONTROL_WITH_ROTATION_COMPAT) {
            BoundsCompatRecord boundsCompatRecord = this.mCompatRecord;
            if (boundsCompatRecord.mRotationCompatModeInherited && boundsCompatRecord.mIsTaskOrientationMismatched) {
                requestedConfigurationOrientation = this.mAtmService.mExt.mOrientationController.getPreferredConfigurationOrientation(this, this.task.getConfiguration().orientation);
            }
        }
        ...
        DisplayContent displayContent2 = this.mDisplayContent;
        boolean z2 = displayContent2 == null || displayContent2.getDisplayRotation().isFixedToUserRotation();
        if (CoreRune.FW_ORIENTATION_CONTROL_WITH_ROTATION_COMPAT && compatDisplayInsets.mCanRotationCompatMode && this.mCompatRecord.mIsTaskOrientationMismatched && (displayContent = this.mDisplayContent) != null) {
            int compatRotationForOrientation = displayContent.getDisplayRotation().getCompatRotationForOrientation(requestedConfigurationOrientation, rotation);
    ...
    */
    public final boolean applyAspectRatio(Rect rect, Rect rect2, Rect rect3, float f) {
        ...
        if (this.task == null || rootTask == null || (((rootTask.inMultiWindowMode() || rootTask.isFullscreenRootForStageTask()) && !this.mCompatRecord.mWaitForChangingPinnedMode) || ((maxAspectRatio < 1.0f && minAspectRatio < 1.0f && f < 1.0f && boundsCompatController == null) || isInVrUiMode(getConfiguration()) || !(organizedTaskFragment == null || organizedTaskFragment.fillsParent())))) {
            return false;
        }
        Task task = this.task;
        ...
        if (computeAspectRatio - minAspectRatio > 0.005f) {
            if (CoreRune.FW_FIXED_ASPECT_RATIO_MODE && this.mCompatRecord.isFixedAspectRatioController(boundsCompatController)) {
                return false;
            }
            if (width < height) {
        ...
        } else if (minAspectRatio - computeAspectRatio > 0.005f || (CoreRune.FW_ORIENTATION_CONTROL && boundsCompatController != null && this.mCompatRecord.mIsTaskOrientationMismatched)) {
            int requestedConfigurationOrientation = getRequestedConfigurationOrientation();
        ...
        if (boundsCompatController2 != null) {
            this.mCompatRecord.onApplyAspectRatio(boundsCompatController2, computeAspectRatio, minAspectRatio, rect);
        }
        return true;
    }
    ...
    */
    public boolean hasDeskResources() {
        ...
        try {
            ...
            Slog.w("ActivityTaskManager", "Exception thrown during checking for desk resources " + this, e);
        }
    ...
    public void restartProcessIfVisible() {
        ...
        if (attachedToProcess()) {
            ...
            if (!this.mVisibleRequested || this.mHaveState) {
                this.mAtmService.f1734mH.post(new Runnable() { // from class: com.android.server.wm.ActivityRecord$$ExternalSyntheticLambda17
                    @Override // java.lang.Runnable
                    public final void run() {
