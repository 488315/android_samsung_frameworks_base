...
public class MultiWindowPointerEventListener
  ...
  public final DisplayContent.TaskIdFromPointSearchResult mTaskIdFromPointSearchResult =
      new DisplayContent.TaskIdFromPointSearchResult();
  ...
  public void onDisplayReady() {
    ...
    this.mStatusBarManager =
        (SemStatusBarManager) this.mService.mContext.getSystemService(SemStatusBarManager.class);
  }
  ...
  public final void loadDimens() {
    this.mDefaultMinimalSizeOfResizeableTask =
        this.mService.mContext.getResources().getDimensionPixelSize(R.dimen.dialog_corner_radius);
    this.mFreeformGuideFullscreenDimViewMargin =
        this.mService
            .mContext
            .getResources()
            .getDimensionPixelSize(R.dimen.harmful_app_name_padding_right);
    if (SAFE_DEBUG) {
      Slog.i(
          "MultiWindowPointerEventListener",
          "mDefaultMinimalSizeOfResizeableTask=" + this.mDefaultMinimalSizeOfResizeableTask);
    }
  }
        ...
        if (isEdge) {
          ...
          if (Math.abs(x - this.mStartX) > this.mTouchSlop
            ...
            if (this.mReadyToFreeform && this.mFreeformResizeGuide == null) {
              if (CoreRune.MT_SUPPORT_SIZE_COMPAT_DRAG
                  && (sizeCompatDragPolicy = this.mSizeCompatDragPolicy) != null) {
            ...
            if (this.mPersona == null) {
              this.mPersona =
                  (SemPersonaManager) this.mService.mContext.getSystemService("persona");
            }
            ...
            if (this.mReadyToFreeform) {
              ...
              boolean adjustMinimalTaskBounds =
                  MultiWindowEdgeDetector.Utils.adjustMinimalTaskBounds(
                      this.mTmpRect, edgeFlags, this.mMinWidth, this.mMinHeight);
            ...
            if (freeformResizeGuide4 != null) {
              if (CoreRune.MT_SUPPORT_SIZE_COMPAT_DRAG
                  && freeformResizeGuide4.asSizeCompatResizeGuide() != null
                  && this.mSizeCompatDragPolicy != null) {
    ...
    if (CoreRune.MT_SUPPORT_SIZE_COMPAT_DRAG
      ...
      if (i == -1 || (task = this.mTask) == null) {
        ...
        this.mService
            ...
            .f1743mH
            .obtainMessage(
                0, i, task.getWindowConfiguration().getRotation(), new Rect(this.mTmpRect))
            .sendToTarget();
      }
    }
    reset();
        ...
        this.mDisplayContent.getItemFromTaskDisplayAreas(
            new Function() { // from class:
              ...
              public final Object apply(Object obj) {
                ...
                lambda$findTargetTaskBounds$0 =
                    MultiWindowPointerEventListener.this.lambda$findTargetTaskBounds$0(
                        i, i2, (TaskDisplayArea) obj);
  ...
  public /* synthetic */ Integer lambda$findTargetTaskBounds$0(
      int i, int i2, TaskDisplayArea taskDisplayArea) {
    return Integer.valueOf(
        taskDisplayArea.taskIdFromPoint(i, i2, this.mTaskIdFromPointSearchResult));
  }

  public final void vibrate(int i) {
    this.mDisplayContent.mWmService.mPolicy.performHapticFeedback(
        Process.myUid(),
        this.mDisplayContent.mWmService.mContext.getOpPackageName(),
  ...
  public final void showToast() {
    Toast.makeText(
            new ContextThemeWrapper(this.mService.mContext, R.style.Theme.DeviceDefault.Light),
            this.mService.mContext.getString(R.string.httpErrorOk),
            0)
        .show();
  }
  ...
  public final boolean interceptFindTargetTaskBounds(Rect rect) {
    ...
    SizeCompatDragPolicy asSizeCompatDragPolicy =
        compatPolicy != null ? compatPolicy.asSizeCompatDragPolicy() : null;
    if (asSizeCompatDragPolicy != null
        && asSizeCompatDragPolicy.supportsToFreeformByCornerGesture()) {
      sizeCompatDragPolicy = asSizeCompatDragPolicy;
    }
    ...
    this.mSizeCompatDragPolicy.getTargetDragBounds(
        this.mTmpRect, rect, this.mSizeCompatInfo, edgeFlags);
  ...
  public final void cancelAnimation() {
    this.mFreeformResizeGuide
        .asSizeCompatResizeGuide()
        .cancelAnimation(this.mTmpRect, this.mDisplayContent.getBounds(), (Consumer) null);
  }
