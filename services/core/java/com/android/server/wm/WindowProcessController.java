...
public class WindowProcessController extends ConfigurationContainer implements ConfigurationContainerListener {
    ...
    public void postPendingUiCleanMsg(boolean z) {
        this.mAtm.f1734mH.sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda11
    ...
    public void updateRapidActivityLaunch(ActivityRecord activityRecord, long j, long j2) {
        ...
        if (this.mRapidActivityLaunchCount > 500) {
            ...
            this.mAtm.f1734mH.post(new Runnable() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda9
    ...
    public void clearProfilerIfNeeded() {
        this.mAtm.f1734mH.sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda0
    ...
    public void updateProcessInfo(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        this.mAtm.f1734mH.sendMessage(PooledLambda.obtainMessage(new WindowProcessController$$ExternalSyntheticLambda5(), this.mListener, Boolean.valueOf(z), Boolean.valueOf(z2), Boolean.valueOf(z3)));
    }
    ...
    public void scheduleUpdateOomAdj() {
        ...
        handlerC2878H.sendMessage(PooledLambda.obtainMessage(windowProcessController$$ExternalSyntheticLambda5, windowProcessListener, bool, bool, Boolean.TRUE));
    }
    ...
    public void updateServiceConnectionActivities() {
        this.mAtm.f1734mH.sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda7
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void setPendingUiCleanAndForceProcessStateUpTo(int i) {
        this.mAtm.f1734mH.sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda12
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void onStartActivity(int i, ActivityInfo activityInfo) {
        ...
        prepareOomAdjustment();
        this.mAtm.f1734mH.sendMessageAtFrontOfQueue(PooledLambda.obtainMessage(new QuintConsumer() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda6
    ...
    public void appDied(String str) {
        this.mAtm.f1734mH.sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda8
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    */
    public void onConfigurationChanged(Configuration configuration) {
        ...
        boolean z = false;
        if (this.mAtm.mDexCompatController.shouldBeApplyDexCompatConfigurationLocked(null, this.mInfo, this.mDisplayId)) {
            configuration2 = new Configuration(configuration);
            this.mAtm.mDexCompatController.applyDexCompatConfigurationLocked(null, this.mInfo, configuration2, "updateConfiguration");
            ...
            if (!(this.mLastReportedConfiguration.equals(configuration3) & (!z))) {
                ...
                if (Build.IS_DEBUGGABLE && this.mHasImeService) {
                    Slog.w("ActivityTaskManager", "Current config: " + configuration3 + " unchanged for IME proc " + this.mName);
                    return;
                }
                return;
            }
    ...
    */
    ...
    public void onTopProcChanged() {
        if (this.mAtm.mVrController.isInterestingToSchedGroup()) {
            this.mAtm.f1734mH.post(new Runnable() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void updateRunningRemoteOrRecentsAnimation() {
        this.mAtm.f1734mH.sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.wm.WindowProcessController$$ExternalSyntheticLambda1
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
