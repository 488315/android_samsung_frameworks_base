...
public class RecentsAnimation
    implements RecentsAnimationController.RecentsAnimationCallbacks,
        TaskDisplayArea.OnRootTaskOrderChangedListener {
  ...
  public RecentsAnimation(
    ...
    this.mDefaultTaskDisplayArea =
        activityTaskManagerService.mRootWindowContainer.getDefaultTaskDisplayArea();
    ...
    this.mTargetActivityType =
        (intent.getComponent() == null || !componentName.equals(intent.getComponent())) ? 2 : 3;
  }
  ...
  public void preloadRecentsActivity() {
    if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
      ProtoLogImpl.d(
          ...
          -106400104,
          0,
          "Preload recents with %s",
          new Object[] {String.valueOf(this.mTargetIntent)});
    }
    ActivityRecord targetActivity =
        getTargetActivity(this.mDefaultTaskDisplayArea.getRootTask(0, this.mTargetActivityType));
      ...
      if (targetActivity.attachedToProcess()) {
        ...
        if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
          ProtoLogImpl.d(
              ...
              0,
              "Updated config=%s",
              new Object[] {String.valueOf(targetActivity.getConfiguration())});
        }
      }
    } else {
      if (this.mDefaultTaskDisplayArea.getActivity(
              new Predicate() { // from class:
                                // com.android.server.wm.RecentsAnimation$$ExternalSyntheticLambda1
    ...
    if (!targetActivity.attachedToProcess()) {
      ...
      if (targetActivity.getDisplayContent() != null) {
        targetActivity
            .getDisplayContent()
            .mUnknownAppVisibilityController
  ...
  public void startRecentsActivity(IRecentsAnimationRunner iRecentsAnimationRunner, long j) {
    ...
    if (this.mWindowManager.getRecentsAnimationController() != null) {
      this.mWindowManager
          ...
          .forceCancelAnimation(2, "startRecentsActivity");
    }
    ...
    if (z2) {
      ...
      if (rootTaskAbove == null && rootTask.getTopMostTask() == targetActivity.getTask()) {
        ...
        if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
          ProtoLogImpl.d(
              ...
              -8483143,
              0,
              "No root task above target root task=%s",
              new Object[] {String.valueOf(rootTask)});
          return;
        }
        return;
      }
      if (this.mService.mController != null) {
        try {
          z =
              !this.mService.mController.activityStarting(
                  this.mTargetIntent.cloneFilter(), targetActivity.packageName);
    ...
    ActivityMetricsLogger.LaunchingState notifyActivityLaunching =
        this.mTaskSupervisor.getActivityMetricsLogger().notifyActivityLaunching(this.mTargetIntent);
    ...
    try {
      try {
        if (z2) {
          ...
          if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
            ProtoLogImpl.d(
                ...
                1191587912,
                0,
                "Moved rootTask=%s behind rootTask=%s",
                new Object[] {
                  String.valueOf(rootTask),
                  String.valueOf(TaskDisplayArea.getRootTaskAbove(rootTask))
                });
          }
          ...
          if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
            ProtoLogImpl.d(
                ...
                "Moved rootTask=%s behind rootTask=%s",
                new Object[] {
                  String.valueOf(rootTask2),
                  String.valueOf(TaskDisplayArea.getRootTaskAbove(rootTask2))
                });
          }
        ...
        this.mWindowManager.initializeRecentsAnimation(
            this.mTargetActivityType,
            iRecentsAnimationRunner,
            this,
            this.mDefaultTaskDisplayArea.getDisplayId(),
            this.mTaskSupervisor.mRecentTasks.getRecentTaskIds(),
            activityRecord);
        ...
        this.mTaskSupervisor
            ...
            .notifyActivityLaunched(
                notifyActivityLaunching, 2, !z2, activityRecord, activityOptions);
      ...
      try {
        ...
        if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
          ProtoLogImpl.d(
              ...
              new Object[] {
                String.valueOf(this.mWindowManager.getRecentsAnimationController()), Long.valueOf(i)
              });
        }
        this.mDefaultTaskDisplayArea.unregisterRootTaskOrderChangedListener(this);
        final RecentsAnimationController recentsAnimationController =
            this.mWindowManager.getRecentsAnimationController();
        ...
        this.mWindowManager.inSurfaceTransaction(
            new Runnable() { // from class:
                             // com.android.server.wm.RecentsAnimation$$ExternalSyntheticLambda2
  ...
  */
  public /* synthetic */ void lambda$finishAnimation$0(
      int i, boolean z, RecentsAnimationController recentsAnimationController) {
    Task task;
    ...
    try {
      try {
        ...
        Task rootTask = this.mDefaultTaskDisplayArea.getRootTask(0, this.mTargetActivityType);
        ActivityRecord isInTask =
            rootTask != null ? rootTask.isInTask(this.mLaunchedTargetActivity) : null;
        if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
          ProtoLogImpl.d(
              ProtoLogGroup.WM_DEBUG_RECENTS_ANIMATIONS,
              1781673113,
              ...
              new Object[] {
                String.valueOf(rootTask),
                String.valueOf(isInTask),
                String.valueOf(this.mRestoreTargetBehindRootTask)
              });
        }
        if (isInTask != null) {
          ...
          if (i == 1) {
            ...
            if (ProtoLogGroup.WM_DEBUG_RECENTS_ANIMATIONS.isLogToAny()
                && (topNonAlwaysOnTopRootTask = getTopNonAlwaysOnTopRootTask()) != rootTask
                && ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
              ProtoLogImpl.w(
                  ProtoLogGroup.WM_DEBUG_RECENTS_ANIMATIONS,
                  -302468788,
                  0,
                  "Expected target rootTask=%s to be top most but found rootTask=%s",
                  new Object[] {
                    String.valueOf(rootTask), String.valueOf(topNonAlwaysOnTopRootTask)
                  });
            }
          } else if (i == 2) {
            isInTask
                .getDisplayArea()
                .moveRootTaskBehindRootTask(rootTask, this.mRestoreTargetBehindRootTask);
            if (ProtoLogGroup.WM_DEBUG_RECENTS_ANIMATIONS.isLogToAny()) {
              Task rootTaskAbove = TaskDisplayArea.getRootTaskAbove(rootTask);
              Task task2 = this.mRestoreTargetBehindRootTask;
              if (task2 != null
                  && rootTaskAbove != task2
                  && ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
                ProtoLogImpl.w(
                    ...
                    1822314934,
                    0,
                    "Expected target rootTask=%s to restored behind rootTask=%s but it is behind"
                        + " rootTask=%s",
                    new Object[] {
                      String.valueOf(rootTask),
                      String.valueOf(this.mRestoreTargetBehindRootTask),
                      String.valueOf(rootTaskAbove)
                    });
              }
            }
            if (CoreRune.FW_BOUNDS_COMPAT_UI
                && (task = this.mRestoreTargetBehindRootTask) != null) {
              task.dispatchTaskInfoChangedByBoundsCompat();
            }
          } else {
            if (!recentsAnimationController.shouldDeferCancelWithScreenshot()
          ...
          Slog.d(TAG, "[TWODND] Clear mIsAnimatingByRecentsAndDragSourceTask");
          Task dragSourceTask = this.mWindowManager.mDragDropController.getDragSourceTask();
          if (dragSourceTask != null) {
            dragSourceTask.mIsAnimatingByRecentsAndDragSourceTask = false;
          }
          this.mWindowManager.prepareAppTransitionNone();
  ...
  public void onRootTaskOrderChanged(final Task task) {
    ...
    if (ProtoLogCache.WM_DEBUG_RECENTS_ANIMATIONS_enabled) {
      ProtoLogImpl.d(
          ...
          -1069336896,
          0,
          "onRootTaskOrderChanged(): rootTask=%s",
          new Object[] {String.valueOf(task)});
    }
    if (this.mDefaultTaskDisplayArea.getRootTask(
                new Predicate() { // from class:
                                  // com.android.server.wm.RecentsAnimation$$ExternalSyntheticLambda4
                  @Override // java.util.function.Predicate
                  public final boolean test(Object obj) {
                    boolean lambda$onRootTaskOrderChanged$1;
                    lambda$onRootTaskOrderChanged$1 =
                        RecentsAnimation.lambda$onRootTaskOrderChanged$1(Task.this, (Task) obj);
                    return lambda$onRootTaskOrderChanged$1;
                  }
                })
            == null
        || !task.shouldBeVisible(null)
        || (recentsAnimationController = this.mWindowManager.getRecentsAnimationController())
            == null) {
      return;
    }
    if ((!recentsAnimationController.isAnimatingTask(task.getTopMostTask())
            || recentsAnimationController.isTargetApp(task.getTopNonFinishingActivity()))
        && recentsAnimationController.shouldDeferCancelUntilNextTransition()) {
      this.mWindowManager.prepareAppTransitionNone();
  ...
  public final void startRecentsActivityInBackground(String str) {
    ...
    this.mActivityStartController
        .obtainStarter(this.mTargetIntent, str)
        .setCallingUid(this.mRecentsUid)
        .setCallingPackage(this.mRecentsComponent.getPackageName())
        .setCallingFeatureId(this.mRecentsFeatureId)
        .setActivityOptions(new SafeActivityOptions(makeBasic))
        .setUserId(this.mUserId)
        .execute();
  }

  public static void notifyAnimationCancelBeforeStart(
  ...
  public final Task getTopNonAlwaysOnTopRootTask() {
    return this.mDefaultTaskDisplayArea.getRootTask(
        new Predicate() { // from class:
                          // com.android.server.wm.RecentsAnimation$$ExternalSyntheticLambda3
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getTopNonAlwaysOnTopRootTask$2;
            lambda$getTopNonAlwaysOnTopRootTask$2 =
                RecentsAnimation.lambda$getTopNonAlwaysOnTopRootTask$2((Task) obj);
    ...
    PooledPredicate obtainPredicate =
        PooledLambda.obtainPredicate(
            new BiPredicate() { // from class:
                                // com.android.server.wm.RecentsAnimation$$ExternalSyntheticLambda0
  ...
  public final boolean matchesTarget(Task task) {
    return task.getNonFinishingActivityCount() > 0
        && task.mUserId == this.mUserId
        && task.getBaseIntent().getComponent().equals(this.mTargetIntent.getComponent());
  }
}
