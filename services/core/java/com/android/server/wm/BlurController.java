...
public final class BlurController {
  ...
  public TunnelModeEnabledListener mTunnelModeListener =
      new TunnelModeEnabledListener(
          new SystemServerInitThreadPool$$ExternalSyntheticLambda1()) { // from class:
  ...
  public BlurController(Context context, final PowerManager powerManager) {
    ...
    context
        ...
        .registerContentObserver(
            ...
            false,
            new ContentObserver(null) { // from class: com.android.server.wm.BlurController.3
  ...
  public final boolean getBlurDisabledSetting() {
    return Settings.Global.getInt(this.mContext.getContentResolver(), "disable_window_blurs", 0)
        == 1;
  }
}
