...
public class ActivityClientController extends IActivityClientController.Stub {
    ...
    */
    ...
    public final ActivityRecord ensureValidPictureInPictureActivityParams(String str, IBinder iBinder, PictureInPictureParams pictureInPictureParams) {
        ...
        float f = this.mContext.getResources().getFloat(R.dimen.config_letterboxHorizontalPositionMultiplier);
        float f2 = this.mContext.getResources().getFloat(R.dimen.config_letterboxDefaultMinAspectRatioForUnresizableApps);
            ...
            synchronized (windowManagerGlobalLock) {
                try {
                    ...
                    if (isInRootTaskLocked != null) {
                        ...
                        WindowManagerService.resetPriorityAfterLockedSection();
                        if (intent == null && isTopActivityInTaskFragment2 && isLaunchSourceType2 && ActivityRecord.isMainIntent(intent)) {
