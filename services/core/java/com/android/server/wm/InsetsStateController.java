        ...
        public void notifyInsetsControlChanged() {
            ...
            for (InsetsSourceControl insetsSourceControl : controlsForDispatch) {
                if (insetsSourceControl.getType() == WindowInsets.Type.ime()) {
                    InsetsStateController.this.mDisplayContent.mWmService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.InsetsStateController$1$$ExternalSyntheticLambda0
