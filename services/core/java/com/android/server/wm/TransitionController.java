...
public class TransitionController {
  ...
  public static final int SYNC_METHOD =
      SystemProperties.getBoolean("persist.wm.debug.shell_transit_blast", false) ? 1 : 0;
  ...
  public final TransitionMetricsReporter mTransitionMetricsReporter =
      new TransitionMetricsReporter();
  ...
  public TransitionController(
      ActivityTaskManagerService activityTaskManagerService, final Runnable runnable) {
    this.mAtm = activityTaskManagerService;
    this.mRemotePlayer = new RemotePlayer(activityTaskManagerService);
    this.mTransitionPlayerDeath =
        new IBinder
            .DeathRecipient() { // from class:
                                // com.android.server.wm.TransitionController$$ExternalSyntheticLambda3
  ...
  public void setSyncEngine(BLASTSyncEngine bLASTSyncEngine) {
    ...
    bLASTSyncEngine.addOnIdleListener(
        new Runnable() { // from class:
                         // com.android.server.wm.TransitionController$$ExternalSyntheticLambda2
  ...
  public final void detachPlayer() {
    ...
    this.mAtm.f1734mH.post(
        new Runnable() { // from class:
                         // com.android.server.wm.TransitionController$$ExternalSyntheticLambda9
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final Transition createTransition(int i, int i2) {
    ...
    if (this.mCollectingTransition != null) {
      throw new IllegalStateException(
          "Trying to directly start transition collection while  collection is already ongoing. Use"
              + " {@link #startCollectOrQueue} if possible.");
    }
    ...
    if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_enabled) {
      ProtoLogImpl.v(
          ...
          0,
          (String) null,
          new Object[] {String.valueOf(transition)});
    }
    ...
    if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_LOG) {
      if (ProtoLogCache.WM_FORCE_DEBUG_WINDOW_TRANSITIONS_enabled) {
        ProtoLogImpl.v(
            ...
            1811081988,
            0,
            "Start collecting in Transition: %s, caller=%s",
            new Object[] {
              String.valueOf(this.mCollectingTransition), String.valueOf(Debug.getCallers(5))
            });
      }
      ...
      ProtoLogImpl.v(
          ...
          0,
          (String) null,
          new Object[] {String.valueOf(this.mCollectingTransition)});
    }
  ...
  public void registerTransitionPlayer(
      ITransitionPlayer iTransitionPlayer, final WindowProcessController windowProcessController) {
    try {
      ...
      this.mAtm.f1734mH.post(
          new Runnable() { // from class:
                           // com.android.server.wm.TransitionController$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$registerTransitionPlayer$2(
      WindowProcessController windowProcessController) {
    this.mAtm.mAmInternal.updateTransitionPlayerPid(
        windowProcessController != null ? windowProcessController.getPid() : -1);
  }
  ...
  public boolean inPlayingTransition(WindowContainer windowContainer, boolean z) {
    ...
    for (int size = this.mPlayingTransitions.size() - 1; size >= 0; size--) {
      ...
      if (z
          && (transitionInfo = transition.mLogger.mInfo) != null
          && transitionInfo.getChanges().isEmpty()
          && transition.mType >= 1000) {
        Slog.d(
            "TransitionController",
            "continue inPlayingTransition checkCustomTransition playing=" + transition);
  ...
  public final boolean isValidPlaying() {
    for (int size = this.mPlayingTransitions.size() - 1; size >= 0; size--) {
      TransitionInfo transitionInfo =
          ((Transition) this.mPlayingTransitions.get(size)).mLogger.mInfo;
  ...
  public boolean canAssignLayers(WindowContainer windowContainer) {
    ...
    if (CoreRune.MW_FREEFORM_MINIMIZE_SHELL_TRANSITION
        && (transition = this.mCollectingTransition) != null
        && (changeInfo = (Transition.ChangeInfo) transition.mChanges.get(windowContainer)) != null
        && changeInfo.mMinimizeAnimState == 2) {
      return true;
    }
    if (CoreRune.MW_NATURAL_SWITCHING_PIP
        && windowContainer.asTask() != null
        && this.mAtm.mNaturalSwitchingController.isNaturalSwitchingPipTask(
    ...
    if (CoreRune.MD_DEX_SHELL_TRANSITION
        ...
        && windowContainer.isDesktopModeEnabled()
        && !isValidPlaying()) {
      return true;
    }
  ...
  public int getWindowingModeAtStart(WindowContainer windowContainer) {
    ...
    Transition.ChangeInfo changeInfo =
        (Transition.ChangeInfo) transition.mChanges.get(windowContainer);
    if (changeInfo == null) {
      return windowContainer.getWindowingMode();
    }
  ...
  public Transition requestTransitionIfNeeded(
      int i, int i2, WindowContainer windowContainer, WindowContainer windowContainer2) {
    return requestTransitionIfNeeded(i, i2, windowContainer, windowContainer2, null, null);
  }

  public final void setDisplaySyncMethod(
    ...
    if ((width2 > width) == (height2 > height)) {
      ...
      displayContent.forAllWindows(
          new Consumer() { // from class:
                           // com.android.server.wm.TransitionController$$ExternalSyntheticLambda0
  ...
  public Transition requestTransitionIfNeeded(
    ...
    if (isCollecting()) {
      if (displayChange != null) {
        Slog.e(
            "TransitionController",
            "Provided displayChange for a non-new request",
            new Throwable());
      }
      ...
      requestStartTransition =
          requestStartTransition(
              createTransition(i, i2),
              windowContainer != null ? windowContainer.asTask() : null,
              remoteTransition,
              displayChange);
      if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BLACK_SNAPSHOT
          && windowContainer != null
          && windowContainer.asDisplayContent() != null
          && windowContainer.asDisplayContent().mHasBlackSnapshot) {
        Slog.d("TransitionController", "Ignore to set the blast method by black snapshot");
      } else if (requestStartTransition != null
          && displayChange != null
          && windowContainer != null
          && windowContainer.asDisplayContent() != null) {
        setDisplaySyncMethod(
            displayChange, requestStartTransition, windowContainer.asDisplayContent());
      }
    }
  ...
  public Transition requestStartTransition(
    ...
    if (this.mIsWaitingForDisplayEnabled) {
      if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_enabled) {
        ProtoLogImpl.v(
            ...
            1,
            (String) null,
            new Object[] {Long.valueOf(transition.getSyncId())});
      }
      transition.mIsPlayerEnabled = false;
      transition.mLogger.mRequestTimeNs = SystemClock.uptimeNanos();
      this.mAtm.f1734mH.post(
          new Runnable() { // from class:
                           // com.android.server.wm.TransitionController$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    try {
      if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_LOG) {
        if (ProtoLogCache.WM_FORCE_DEBUG_WINDOW_TRANSITIONS_enabled) {
          ProtoLogImpl.v(
              ...
              2128359968,
              0,
              "Requesting StartTransition: %s, caller=%s",
              new Object[] {String.valueOf(transition), String.valueOf(Debug.getCallers(5))});
        }
      } else if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_WINDOW_TRANSITIONS,
      ...
      TransitionRequestInfo transitionRequestInfo =
          new TransitionRequestInfo(
              transition.mType, runningTaskInfo, remoteTransition, displayChange);
  ...
  public Transition requestCloseTransitionIfNeeded(WindowContainer windowContainer) {
    ...
    Task task =
        windowContainer.asActivityRecord() != null
            ? windowContainer.asActivityRecord().getTask()
            : windowContainer.asTask();
    if (task != null && task.isFreeformForceHidden()) {
      Slog.d(
          "TransitionController", "requestCloseTransitionIfNeeded: skip, force hidden, t=" + task);
      return null;
    }
    ...
    if (asTask != null
        && ((asTask.mHiddenWhileActivatingDrag || asTask.mIsAnimatingByRecentsAndDragSourceTask)
            && asActivityRecord != null
            && asActivityRecord.isFinishing())) {
      Slog.d(
          "TransitionController",
          "requestCloseTransitionIfNeeded: skip, force hidden by dragging, t=" + asTask);
      return null;
    }
    if (windowContainer.isVisibleRequested()) {
      r1 =
          isCollecting()
              ? null
              : requestStartTransition(
                  createTransition(2, 0), windowContainer.asTask(), null, null);
      collectExistenceChange(windowContainer);
    } else {
      collect(windowContainer);
    }
  ...
  public void setHideWhileTwoHandDragging(WindowContainer windowContainer) {
    ...
    Transition transition = this.mCollectingTransition;
    if (transition == null
        || (changeInfo = (Transition.ChangeInfo) transition.mChanges.get(windowContainer))
            == null) {
      return;
    }
  ...
  public void setResumedAffordance(WindowContainer windowContainer) {
    ...
    ((Transition.ChangeInfo) this.mCollectingTransition.mChanges.get(windowContainer))
            .mResumedAffordance =
        true;
  }
  ...
  public void collectForDisplayAreaChange(DisplayArea displayArea) {
    ...
    displayArea.forAllLeafTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.TransitionController$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
    ...
    if (asDisplayContent != null) {
      ...
      displayArea.forAllWindows(
          new Consumer() { // from class:
                           // com.android.server.wm.TransitionController$$ExternalSyntheticLambda5
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              TransitionController.this.lambda$collectForDisplayAreaChange$6(
                  z, transition, (WindowState) obj);
            }
          },
          true);
    }
  ...
  public static /* synthetic */ void lambda$collectForDisplayAreaChange$5(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$collectForDisplayAreaChange$6(
      boolean z, Transition transition, WindowState windowState) {
    if (windowState.mActivityRecord == null
        && windowState.isVisible()
        && !isCollecting(windowState.mToken)) {
  ...
  public void collectReparentChange(
  ...
  public void setOverrideAnimation(
    ...
    if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_LOG) {
      if (ProtoLogCache.WM_FORCE_DEBUG_WINDOW_TRANSITIONS_enabled) {
        ProtoLogImpl.v(
            ...
            2054808080,
            0,
            "Finish Transition: %s, caller=%s",
            new Object[] {String.valueOf(transition), String.valueOf(Debug.getCallers(3))});
      }
    } else if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_enabled) {
      ProtoLogImpl.v(
          ProtoLogGroup.WM_DEBUG_WINDOW_TRANSITIONS,
  ...
  public final void validateStates() {
    ...
    for (int i3 = 0; i3 < this.mValidateActivityCompat.size(); i3++) {
      ...
      if (activityRecord3.getSurfaceControl() != null) {
        ...
        activityRecord3
            .getSyncTransaction()
            .setPosition(activityRecord3.getSurfaceControl(), r3.x, r3.y);
      }
    }
    ...
    if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX) {
      for (int i4 = 0; i4 < this.mValidateDisplayVis.size(); i4++) {
        DisplayContent displayContent =
            this.mAtm.mWindowManager.mRoot.getDisplayContent(
                ((Integer) this.mValidateDisplayVis.get(i4)).intValue());
  ...
  public void onVisibleWithoutCollectingTransition(
      final WindowContainer windowContainer, String str) {
    boolean z = !this.mPlayingTransitions.isEmpty();
    Slog.e(
        "TransitionController",
        "Set visible without transition " + windowContainer + " playing=" + z + " caller=" + str);
    if (!z) {
      enforceSurfaceVisible(windowContainer);
    } else {
      this.mStateValidators.add(
          new Runnable() { // from class:
                           // com.android.server.wm.TransitionController$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
              TransitionController.this.lambda$onVisibleWithoutCollectingTransition$7(
                  windowContainer);
            }
          });
    }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onVisibleWithoutCollectingTransition$7(
      WindowContainer windowContainer) {
    if (windowContainer.isVisibleRequested()) {
      enforceSurfaceVisible(windowContainer);
    }
  ...
  public void enforceSurfaceVisible(WindowContainer windowContainer) {
    ...
    for (WindowContainer parent = windowContainer.getParent();
        parent != null && parent != windowContainer.mDisplayContent;
  ...
  public final boolean canStartCollectingNow(Transition transition) {
    ...
    if (!transition2.isPopulated()
        || !getCanBeIndependent(this.mCollectingTransition, transition)) {
      return false;
    }
    for (int i = 0; i < this.mWaitingTransitions.size(); i++) {
  ...
  public void tryStartCollectFromQueue() {
    ...
    if (this.mCollectingTransition != null) {
      ...
      if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_MIN_enabled) {
        ProtoLogImpl.v(
            ...
            -266707683,
            1,
            "Moving #%d from collecting to waiting.",
            new Object[] {Long.valueOf(this.mCollectingTransition.getSyncId())});
      }
    ...
    if (transition3 != null && transition3.mType == 12) {
      ...
      this.mAtm.f1734mH.post(
          new Runnable() { // from class:
                           // com.android.server.wm.TransitionController$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void moveToPlaying(Transition transition) {
    if (transition == this.mCollectingTransition) {
      ...
      Slog.e(
          "TransitionController",
          "moveToPlaying: Trying to move non-collecting transition to playing, mWaitingTransitions="
              + this.mWaitingTransitions
              + ", transition="
              + transition
              + ", syncId="
  ...
  public boolean getCanBeIndependent(Transition transition, Transition transition2) {
    if (transition2 != null
        && transition2.mParallelCollectType == 1
        && transition.mParallelCollectType == 1) {
      return true;
    }
    if (transition2 != null && transition2.mParallelCollectType == 2) {
      ...
      for (int i = 0; i < transition.mParticipants.size(); i++) {
        ...
        if (asActivityRecord == null
            ...
            && windowContainer.asWindowToken() == null) {
          return false;
        }
  ...
  public static boolean getIsIndependent(Transition transition, Transition transition2) {
    ...
    if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_LATE_TRANSIENT_LAUNCH
        && i == 3
        && transition.hasLateTransientLaunch()) {
    ...
    for (int i3 = 0; i3 < transition.mTargets.size(); i3++) {
      WindowContainer windowContainer =
          ((Transition.ChangeInfo) transition.mTargets.get(i3)).mContainer;
      ActivityRecord asActivityRecord = windowContainer.asActivityRecord();
      if (asActivityRecord == null
          && windowContainer.asWindowState() == null
          && windowContainer.asWindowToken() == null) {
  ...
  public void assignTrack(Transition transition, TransitionInfo transitionInfo) {
    ...
    while (true) {
      ...
      if (this.mPlayingTransitions.get(i2) != transition
          && !getIsIndependent((Transition) this.mPlayingTransitions.get(i2), transition)) {
        if (i >= 0) {
          if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX
              && i2 == this.mPlayingTransitions.size() - 1) {
            ...
            if (transition2.mParallelCollectType == 2) {
              ...
              Slog.d(
                  ...
                  "Not mark as SYNC for SyncId#"
                      + transition.getSyncId()
                      + " due to transient launch on track#"
                      + i);
            }
          }
          if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_LOG && CoreRune.SAFE_DEBUG) {
            Slog.d(
                StartingSurfaceController.TAG,
                "Possible to mark as SYNC for SyncId#"
                    + transition.getSyncId()
                    + " due to "
                    + ((Transition) this.mPlayingTransitions.get(i2)).getSyncId()
                    + " on track#"
                    + ((Transition) this.mPlayingTransitions.get(i2)).mAnimationTrack);
      ...
      if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_LOG) {
        if (ProtoLogCache.WM_FORCE_DEBUG_WINDOW_TRANSITIONS_enabled) {
          ProtoLogImpl.v(
              ...
              2057242484,
              5,
              "Playing #%d in parallel on track #%d",
              new Object[] {Long.valueOf(transition.getSyncId()), Long.valueOf(i3)});
        }
      } else if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_WINDOW_TRANSITIONS,
  ...
  public void updateAnimatingState(SurfaceControl.Transaction transaction) {
    Transition transition;
    boolean z =
        !this.mPlayingTransitions.isEmpty()
            || ((transition = this.mCollectingTransition) != null && transition.isStarted());
  ...
  public final void updateRunningRemoteAnimation(Transition transition, boolean z) {
    ...
    if (remoteAnimationApp == null
        || remoteAnimationApp == this.mTransitionPlayerProc.getThread()
        || (processController = this.mAtm.getProcessController(remoteAnimationApp)) == null) {
      return;
    }
  ...
  public void registerLegacyListener(
      WindowManagerInternal.AppTransitionListener appTransitionListener) {
    this.mLegacyListeners.add(appTransitionListener);
  }

  public void unregisterLegacyListener(
      WindowManagerInternal.AppTransitionListener appTransitionListener) {
  ...
  public void dispatchLegacyAppTransitionPending() {
    for (int i = 0; i < this.mLegacyListeners.size(); i++) {
      ((WindowManagerInternal.AppTransitionListener) this.mLegacyListeners.get(i))
  ...
  public void dispatchLegacyAppTransitionStarting(TransitionInfo transitionInfo, long j) {
    for (int i = 0; i < this.mLegacyListeners.size(); i++) {
      ((WindowManagerInternal.AppTransitionListener) this.mLegacyListeners.get(i))
          .onAppTransitionStartingLocked(SystemClock.uptimeMillis() + j, 120L);
    }
  }
  ...
  public void dispatchLegacyAppTransitionFinished(ActivityRecord activityRecord) {
    for (int i = 0; i < this.mLegacyListeners.size(); i++) {
      ((WindowManagerInternal.AppTransitionListener) this.mLegacyListeners.get(i))
          .onAppTransitionFinishedLocked(activityRecord.token);
    }
  }
  ...
  public void dumpDebugLegacy(ProtoOutputStream protoOutputStream, long j) {
    ...
    if (this.mPlayingTransitions.isEmpty()) {
      Transition transition = this.mCollectingTransition;
      i =
          ((transition == null || !transition.getLegacyIsReady())
                  && !this.mSyncEngine.hasPendingSyncSets())
              ? 0
              : 1;
    } else {
      i = 2;
  ...
  public void startLegacySyncOrQueue(BLASTSyncEngine.SyncGroup syncGroup, final Consumer consumer) {
    if (!this.mQueuedTransitions.isEmpty() || this.mSyncEngine.hasActiveSync()) {
      this.mQueuedTransitions.add(
          new QueuedTransition(
              syncGroup,
              new OnStartCollect() { // from class:
                                     // com.android.server.wm.TransitionController$$ExternalSyntheticLambda6
      ...
      if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_MIN_enabled) {
        ProtoLogImpl.v(
            ...
            1463355909,
            0,
            "Queueing legacy sync-set: %s",
            new Object[] {String.valueOf(syncGroup.mSyncId)});
        return;
      }
      return;
    }
  ...
  public void notifyAbort(Transition transition) {
    ...
    if (transition.mLogger.mRequest == null
        || (iTransitionPlayer = this.mTransitionPlayer) == null) {
      return;
    }
    try {
  ...
  public void setHasTopUiIfNeeded(final boolean z) {
    if (this.mRequestHasTopUi != z) {
      ...
      if (windowProcessController != null) {
        ...
        this.mAtm.f1734mH.post(
            new Runnable() { // from class:
                             // com.android.server.wm.TransitionController$$ExternalSyntheticLambda10
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public class RemotePlayer {
    ...
    public void update(WindowProcessController windowProcessController, boolean z, boolean z2) {
        ...
        synchronized (this.mDelegateProcesses) {
          ...
          while (true) {
            if (size < 0) {
              ...
              if (((DelegateProcess) this.mDelegateProcesses.valueAt(size)).mProc
      ...
      if (windowProcessController.isRunningRemoteTransition()
      ...
      if (z2) {
        ...
        this.mAtm.f1734mH.postDelayed(delegateProcess, 100L);
      }
      synchronized (this.mDelegateProcesses) {
        this.mDelegateProcesses.put(
            windowProcessController.getThread().asBinder(), delegateProcess);
      }
    }
    ...
    public void clear() {
      synchronized (this.mDelegateProcesses) {
        for (int size = this.mDelegateProcesses.size() - 1; size >= 0; size--) {
          ((DelegateProcess) this.mDelegateProcesses.valueAt(size))
              .mProc.setRunningRemoteAnimation(false);
        }
    ...
    public boolean reportRunning(IApplicationThread iApplicationThread) {
      ...
      synchronized (this.mDelegateProcesses) {
        ...
        if (delegateProcess != null && delegateProcess.mNeedReport) {
          ...
          this.mAtm.f1734mH.removeCallbacks(delegateProcess);
        }
      }
    ...
    public void logOnSend() {
      if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_MIN_enabled) {
        ProtoLogImpl.v(
            ...
            0,
            "%s",
            new Object[] {String.valueOf(buildOnSendLog())});
      }
      if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_MIN_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_WINDOW_TRANSITIONS_MIN,
            ...
            0,
            "    startWCT=%s",
            new Object[] {String.valueOf(this.mStartWCT)});
      }
      if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_MIN_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_WINDOW_TRANSITIONS_MIN,
            ...
            0,
            "    info=%s",
            new Object[] {String.valueOf(this.mInfo.toString("    "))});
      }
    }
    ...
    public void logOnFinish() {
      if (ProtoLogCache.WM_DEBUG_WINDOW_TRANSITIONS_MIN_enabled) {
        ProtoLogImpl.v(
            ...
            0,
            "%s",
            new Object[] {String.valueOf(buildOnFinishLog())});
      }
    }
  }
        ...
        try {
          ...
          while (true) {
            WindowManagerGlobalLock windowManagerGlobalLock2 =
                TransitionController.this.mAtm.mGlobalLock;
            WindowManagerService.boostPriorityForLockedSection();
