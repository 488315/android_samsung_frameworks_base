...
public final /* synthetic */ class ActivityTaskManagerService$$ExternalSyntheticLambda13
        implements Consumer {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ ActivityTaskManagerService f$0;
    public final /* synthetic */ int f$1;

    public /* synthetic */ ActivityTaskManagerService$$ExternalSyntheticLambda13(
            ActivityTaskManagerService activityTaskManagerService, int i, int i2) {
        this.$r8$classId = i2;
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                KeyguardController keyguardController =
                        activityTaskManagerService.mKeyguardController;
                int i2 = ((DisplayContent) obj).mDisplayId;
                KeyguardController.KeyguardDisplayState displayState =
                        keyguardController.getDisplayState(i2);
                if (!displayState.mKeyguardShowing || displayState.mKeyguardGoingAway) {
                    StringBuilder m =
                            BatteryService$$ExternalSyntheticOutline0.m(
                                    i2, "keyguardGoingAway returned, d=", ", flags=0x");
                ...
                if (z3 && z) {
                    WindowManagerServiceExt windowManagerServiceExt =
                            keyguardController.mWindowManager.mExt;
                    boolean z4 = z3 && z;
                    PhoneWindowManagerExt phoneWindowManagerExt =
                            windowManagerServiceExt.mPolicyExt;
                    phoneWindowManagerExt.getClass();
                    Slog.d("PhoneWindowManagerExt", "UnlockFP triggered. isWakeAndUnlock=" + z4);
                    if (z4) {
                        PhoneWindowManagerExt.PolicyExtHandler policyExtHandler =
                                phoneWindowManagerExt.mHandler;
                        PhoneWindowManagerExt$$ExternalSyntheticLambda1
                                phoneWindowManagerExt$$ExternalSyntheticLambda1 =
                                        phoneWindowManagerExt.mWakeAndUnlockRunning;
                        policyExtHandler.removeCallbacks(
                                phoneWindowManagerExt$$ExternalSyntheticLambda1);
                        phoneWindowManagerExt.mWakeAndUnlockTriggered = true;
                        phoneWindowManagerExt.mHandler.postDelayed(
                                phoneWindowManagerExt$$ExternalSyntheticLambda1, 1000L);
                    }
                ...
                try {
                    EventLogTags.writeWmSetKeyguardShown(
                            i2,
                            displayState.mKeyguardShowing ? 1 : 0,
                            displayState.mAodShowing ? 1 : 0,
                            1,
                            displayState.mOccluded ? 1 : 0,
                            "keyguardGoingAway");
                    int i3 =
                            (i & 1) != 0
                                    ? FrameworkStatsLog
                    ...
                    DisplayContent displayContent =
                            keyguardController.mRootWindowContainer.mDefaultDisplay;
                    displayContent.prepareAppTransition(7, i3);
                    displayContent.mAtmService.mWindowOrganizerController.mTransitionController
                            .requestTransitionIfNeeded(4, i3, null, displayContent);
                    ...
                    RootWindowContainer rootWindowContainer =
                            keyguardController.mRootWindowContainer;
                    rootWindowContainer.getClass();
                    rootWindowContainer.forAllActivities(
                            new RootWindowContainer$$ExternalSyntheticLambda2(
                                    rootWindowContainer, new ArrayList(), 1));
                    if (CoreRune.FW_APPLOCK) {
                        Task rootTask =
                                keyguardController.mRootWindowContainer.mDefaultDisplay.getRootTask(
                                        1, 1);
                        if (rootTask != null) {
                            ActivityRecord topActivity = rootTask.getTopActivity(false, true);
                            if (topActivity != null) {
                                if (keyguardController.mTaskSupervisor.mTopResumedActivity
                                        != topActivity) {
                                    ...
                                    Log.d(
                                            "ActivityTaskManager",
                                            "Applock Activity record " + topActivity);
                                    activityTaskManagerService2.mExt.startAppLockActivity(
                                            topActivity);
                                }
                            }
                        }
