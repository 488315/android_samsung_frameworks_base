...
public final class TaskDisplayArea extends DisplayArea {
  ...
  public class LaunchRootTaskDef {
    ...
    public boolean contains(int i, int i2) {
      return ArrayUtils.contains(this.windowingModes, i)
          && ArrayUtils.contains(this.activityTypes, i2);
    }
  }

  public TaskDisplayArea(
      DisplayContent displayContent, WindowManagerService windowManagerService, String str, int i) {
  ...
  public Task getRootTask(final int i, final int i2) {
    ...
    return getRootTask(
        new Predicate() { // from class:
                          // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda10
  ...
  public void addChild(WindowContainer windowContainer, int i) {
    if (windowContainer.asTaskDisplayArea() != null) {
      ...
      throw new IllegalArgumentException(
          "TaskDisplayArea can only add Task and TaskDisplayArea, but found " + windowContainer);
    }
  }
  ...
  public final void addChildTask(Task task, int i) {
    ...
    if (this.mPreferredTopFocusableRootTask != null
        && task.isFocusable()
        && this.mPreferredTopFocusableRootTask.compareTo((WindowContainer) task) < 0) {
  ...
  public void removeChild(WindowContainer windowContainer) {
    if (windowContainer.asTaskDisplayArea() != null) {
      ...
      throw new IllegalArgumentException(
          "TaskDisplayArea can only remove Task and TaskDisplayArea, but found " + windowContainer);
    }
  }
  ...
  public final void positionChildTaskAt(int i, Task task, boolean z) {
    ...
    if (task.isAlwaysOnTop() && !z2) {
      if (FreeformController.useAlwaysOnTopFreeform(
          task.getWindowingMode(), this.mDisplayContent)) {
    ...
    if ((!this.mDisplayContent.isTrusted() || this.mDisplayContent.mDontMoveToTop)
        && !getParent().isOnTop()) {
      z = false;
    }
    ...
    if (task.getTopResumedActivity() == null && i == Integer.MIN_VALUE) {
      ...
      if (rootMainStageTask != null
          && rootMainStageTask.isDescendantOf(task)
  ...
  public void onLeafTaskMoved(Task task, boolean z, boolean z2) {
    if (z2) {
      this.mAtmService
          ...
          .notifyTaskMovedToBack(task.getTaskInfo());
    }
    if (!z) {
      if (task.mTaskId == this.mLastLeafTaskToFrontId) {
        ...
        if (topMostActivity != null) {
          this.mAtmService
              .getTaskChangeNotificationController()
              .notifyTaskMovedToFront(topMostActivity.getTask().getTaskInfo());
          return;
        }
        return;
      }
    ...
    this.mAtmService
        .getTaskChangeNotificationController()
        .notifyTaskMovedToFront(task.getTaskInfo());
  }
  ...
  public final int findMinPositionForRootTask(Task task) {
    ...
    while (true) {
      ...
      if (i2 >= this.mChildren.size()
          || getPriority((WindowContainer) this.mChildren.get(i2)) >= getPriority(task)) {
        break;
      }
      i3 = i2 + 1;
    }
  ...
  public int getOrientation(final int i) {
      ...
      return ((Integer)
              reduceOnAllTaskDisplayAreas(
                  new BiFunction() { // from class:
                                     // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda5
                    @Override // java.util.function.BiFunction
                    public final Object apply(Object obj, Object obj2) {
                      Integer lambda$getOrientation$3;
                      lambda$getOrientation$3 =
                          TaskDisplayArea.this.lambda$getOrientation$3(
                              i, (TaskDisplayArea) obj, (Integer) obj2);
    ...
    if (orientation != -2 && orientation != 3) {
      if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
        ProtoLogImpl.v(
            ...
            (String) null,
            new Object[] {
              Long.valueOf(orientation), Long.valueOf(this.mDisplayContent.mDisplayId)
            });
      }
      return orientation;
    }
    if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
      ProtoLogImpl.v(
          ...
          (String) null,
          new Object[] {
            Long.valueOf(this.mDisplayContent.getLastOrientation()),
  ...
  public /* synthetic */ Integer lambda$getOrientation$3(
      int i, TaskDisplayArea taskDisplayArea, Integer num) {
    return (taskDisplayArea == this || num.intValue() != -2)
        ? num
        : Integer.valueOf(taskDisplayArea.getOrientation(i));
  }
  ...
  public void assignRootTaskOrdering(SurfaceControl.Transaction transaction) {
    ...
    for (int i = 0; i < this.mChildren.size(); i++) {
      ...
      if (asTaskDisplayArea != null) {
        ...
        } else if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_SEPARATE_RECENTS
            && topRootTask.isActivityTypeRecents()) {
    ...
    if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_SEPARATE_RECENTS) {
      adjustRootTaskLayer =
          adjustRootTaskLayer(transaction, this.mTmpRecentsChildren, adjustRootTaskLayer);
    }
    int adjustRootTaskLayer2 =
        adjustRootTaskLayer(transaction, this.mTmpNormalChildren, adjustRootTaskLayer);
    ...
    int adjustRootTaskLayer3 =
        adjustRootTaskLayer(
            transaction,
            this.mTmpFreeformPinnedChildren,
            adjustRootTaskLayer(transaction, this.mTmpFreeformChildren, adjustRootTaskLayer2));
  ...
  public final boolean childrenNeedZBoost() {
    ...
    forAllRootTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda0
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void setBackgroundColor(int i, boolean z) {
    ...
    if (this.mSurfaceControl != null) {
      getPendingTransaction()
          .setColor(
              this.mSurfaceControl, new float[] {valueOf.red(), valueOf.green(), valueOf.blue()});
      scheduleAnimation();
    }
  }
  ...
  public Task getOrCreateRootTask(
      int i, int i2, boolean z, Task task, Task task2, ActivityOptions activityOptions, int i3) {
    Rect rect;
    ...
    if (!DisplayContent.alwaysCreateRootTask(windowingMode, i2)) {
      ...
      if (this.mDisplayContent.isDefaultDisplay
          ...
          && task.getDisplayArea() != this
          && (launchRootTask == null || !launchRootTask.inSplitScreenWindowingMode())) {
      ...
      if (launchRootTask != null) {
        ...
        if (task.isVisible() && task.inSplitScreenWindowingMode()) {
          ...
          this.mAtmService.mTaskOrganizerController.onSplitLayoutChangeRequested(
      ...
      if ((i != 0 && task.isRootTask() && task.getWindowingMode() != i)
          || ForceLaunchWindowingModeUtils.shouldApplyForceLaunchWindowingMode(
              activityOptions, null, task)) {
        task.mTransitionController.collect(task);
        if (CoreRune.MW_FREEFORM_SHELL_TRANSITION
            && i == 5
            && !this.mAtmService.mTaskSupervisor.isRootVisibilityUpdateDeferred()) {
        ...
        if (i == 5
            ...
            && ((rect = task.mLastNonFullscreenBounds) == null || rect.isEmpty())) {
          ...
          this.mAtmService
              ...
              .layoutTask(
                  ...
                  topNonFinishingActivity != null
                      ? topNonFinishingActivity.info.windowLayout
                      : null,
    ...
    return new Task.Builder(this.mAtmService)
        .setWindowingMode(i)
        .setActivityType(i2)
        .setOnTop(z)
        .setParent(this)
  ...
  public Task getOrCreateRootTask(
    ...
    return getOrCreateRootTask(
        validateWindowingMode(launchWindowingMode, activityRecord, task),
        i2,
        z,
        task,
        task2,
  ...
  public void setLaunchRootTask(Task task, int[] iArr, int[] iArr2) {
    if (!task.mCreatedByOrganizer) {
      throw new IllegalArgumentException(
          "Can't set not mCreatedByOrganizer as launch root tr=" + task);
    }
  ...
  public void setLaunchAdjacentFlagRootTask(Task task) {
    if (task != null) {
      if (!task.mCreatedByOrganizer) {
        throw new IllegalArgumentException(
            "Can't set not mCreatedByOrganizer as launch adjacent flag root tr=" + task);
      }
      if (task.getAdjacentTaskFragment() == null) {
        throw new UnsupportedOperationException(
            "Can't set non-adjacent root as launch adjacent flag root tr=" + task);
      }
    }
  ...
  public Task getLaunchRootTask(
    ...
    if ((i3 & IInstalld.FLAG_USE_QUOTA) != 0 && this.mLaunchAdjacentFlagRootTask != null) {
      if ((task != null
          ...
          || ((task != null && (task.inFreeformWindowingMode() || task.inPinnedWindowingMode()))
              || isDexMode())) {
        Slog.d(StartingSurfaceController.TAG, "getLaunchRootTask: Skip adjacent flag, " + task);
      } else if (task == null || task != task2) {
        if (task != null
            && this.mLaunchAdjacentFlagRootTask.getAdjacentTaskFragment() != null
            && (task == (task3 = this.mLaunchAdjacentFlagRootTask) || task.isDescendantOf(task3))) {
          if (task.topRunningActivity() != null
              && ActivityRecord.isResolverActivity(
                  task.topRunningActivity().mActivityComponent.getClassName())) {
      ...
      if (size < 0) {
        if (task != null && (task2 == null || task2.getWindowingMode() != 2)) {
          ...
          if (adjacentTask != null) {
            return (task2 == null || !(task2 == adjacentTask || task2.isDescendantOf(adjacentTask)))
  ...
  public void updateLastFocusedRootTask(Task task, String str) {
    ...
    EventLogTags.writeWmFocusedRootTask(
        i, i2, rootTaskId, task2 != null ? task2.getRootTaskId() : -1, str);
  }
    ...
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      ...
      if (windowContainer.asTaskDisplayArea() != null) {
        ...
        ActivityRecord topResumedActivity =
            ((WindowContainer) this.mChildren.get(size)).asTask().getTopResumedActivity();
  ...
  public boolean pauseBackTasks(final ActivityRecord activityRecord) {
    ...
    forAllLeafTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda12
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public static /* synthetic */ void lambda$pauseBackTasks$6(
      ActivityRecord activityRecord, int[] iArr, Task task) {
    ...
    try {
      ...
      for (int size = this.mTmpTasks.size() - 1; size >= 0; size--) {
        ...
        for (int i = 0; i < task2.getChildCount(); i++) {
          ...
          childAt.forAllActivities(
              new Consumer() { // from class:
                               // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda7
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
      ...
      if (orCreateRootHomeTask != null
          && (((topRootTaskInWindowingMode2 != null && !isTopRootTask(orCreateRootHomeTask))
                  || task != null)
              && taskArr[0] == null)) {
      ...
      if (orCreateRootHomeTask2 != null
          && (((topRootTaskInWindowingMode != null && !isTopRootTask(orCreateRootHomeTask2))
                  || task != null)
              && taskArr[0] == null)) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onStageSplitScreenDismissed$7(
      Task[] taskArr, Task task, Task task2) {
  ...
  public int resolveWindowingMode(
  ...
  public ActivityRecord topRunningActivity(boolean z) {
    Task focusedRootTask = getFocusedRootTask();
    ActivityRecord activityRecord =
        focusedRootTask != null ? focusedRootTask.topRunningActivity() : null;
      ...
      for (int size = this.mChildren.size() - 1; size >= 0; size--) {
        ...
        if (windowContainer.asTaskDisplayArea() != null) {
          ...
          if (asTask != focusedRootTask
              ...
              && (activityRecord = asTask.topRunningActivity()) != null) {
            break;
          }
        }
      }
    ...
    if (activityRecord == null
        ...
        || !this.mRootWindowContainer
            ...
            .isKeyguardLocked(activityRecord.getDisplayId())
  ...
  public int getRootTaskCount() {
    ...
    forAllRootTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda3
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public boolean isSplitScreenModeActivated() {
    ...
    return topRootTaskInWindowingMode != null
        && rootMainStageTask.getRootTask() == topRootTaskInWindowingMode;
  }
  ...
  public void forAllRootStageTasks(Consumer consumer) {
    Task rootTask =
        getRootTask(
            new Predicate() { // from class:
                              // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda14
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
  ...
  public boolean isMultiSplitVisible() {
    return isMultiSplitActive()
        && (this.mRootCellStageTask.isVisible() || this.mRootCellStageTask.isVisibleRequested());
  }
  ...
  public boolean isSplitScreenVisible() {
    Task rootMainStageTask = getRootMainStageTask();
    Task rootSideStageTask = getRootSideStageTask();
    return (rootMainStageTask != null
            && (rootMainStageTask.isVisible() || rootMainStageTask.isVisibleRequested()))
        || (rootSideStageTask != null
            && (rootSideStageTask.isVisible() || rootSideStageTask.isVisibleRequested()));
  }
  ...
  public boolean isSplitScreenStarting() {
    ...
    Task rootSideStageTask = getRootSideStageTask();
    return ((rootMainStageTask == null
                || !rootMainStageTask.isVisibleRequested()
                || rootMainStageTask.isVisible())
            && (rootSideStageTask == null
                || !rootSideStageTask.isVisibleRequested()
                || rootSideStageTask.isVisible()))
        ? false
        : true;
  }
            ...
            new BiPredicate() { // from class:
              ...
              public final boolean test(Object obj, Object obj2) {
                ...
                isHomeActivityForUser =
                    TaskDisplayArea.isHomeActivityForUser(
                        (ActivityRecord) obj, ((Integer) obj2).intValue());
    ...
    return getRootTask(
        new Predicate() { // from class:
          ...
          public final boolean test(Object obj) {
            ...
            lambda$getBottomMostVisibleRootTask$11 =
                TaskDisplayArea.lambda$getBottomMostVisibleRootTask$11((Task) obj);
  ...
  public void registerRootTaskOrderChangedListener(
      OnRootTaskOrderChangedListener onRootTaskOrderChangedListener) {
  ...
  public void unregisterRootTaskOrderChangedListener(
      OnRootTaskOrderChangedListener onRootTaskOrderChangedListener) {
  ...
  public void onRootTaskOrderChanged(Task task) {
    for (int size = this.mRootTaskOrderChangedCallbacks.size() - 1; size >= 0; size--) {
      ((OnRootTaskOrderChangedListener) this.mRootTaskOrderChangedCallbacks.get(size))
          .onRootTaskOrderChanged(task);
    }
  }
  ...
  public void ensureActivitiesVisible(
    ...
    try {
      forAllRootTasks(
          new Consumer() { // from class:
                           // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
        ...
        if (shouldDestroyContentOnRemove
          ...
          Task launchRootTask =
              defaultTaskDisplayArea.getLaunchRootTask(
                  asTask.getWindowingMode(), asTask.getActivityType(), null, null, 0);
          if (launchRootTask == null) {
  ...
  public boolean canSpecifyOrientation(int i) {
    return this.mDisplayContent.getOrientationRequestingTaskDisplayArea() == this
        && !shouldIgnoreOrientationRequest(i);
  }
  ...
  public int taskIdFromPoint(
      int i, int i2, DisplayContent.TaskIdFromPointSearchResult taskIdFromPointSearchResult) {
  ...
  public final boolean handleOrientationChangeFromSplitScreen() {
    ...
    final Task task =
        getRootMainStageTask() != null ? (Task) getRootMainStageTask().getParent() : null;
    return getRootTask(
            new Predicate() { // from class:
                              // com.android.server.wm.TaskDisplayArea$$ExternalSyntheticLambda11
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$handleOrientationChangeFromSplitScreen$14;
                lambda$handleOrientationChangeFromSplitScreen$14 =
                    TaskDisplayArea.lambda$handleOrientationChangeFromSplitScreen$14(
                        Task.this, (Task) obj);
  ...
  public static /* synthetic */ boolean lambda$handleOrientationChangeFromSplitScreen$14(
  ...
  public boolean needToEnsureLaunchSplitRootTask(
      ActivityRecord activityRecord, ActivityOptions activityOptions, Task task, Task task2) {
    Task topMostTask = getTopMostTask();
    if (!isSplitScreenModeActivated()
        || ((topMostTask != null && topMostTask.inFullscreenWindowingMode())
            || !(activityOptions == null
                || (activityOptions.getLaunchRootTask() == null
                    && activityOptions.getLaunchTaskFragmentToken() == null
                    && ((activityOptions.getRemoteTransition() != null
                            || !activityOptions.freezeRecentTasksReordering()
                            || this.mWmService.getRecentsAnimationController() == null)
                        && !ForceLaunchWindowingModeUtils.shouldDismissSplitBeforeLaunch(
    ...
    return (task == null || !(task.inSplitScreenWindowingMode() || task.inPinnedWindowingMode()))
        ...
        && activityRecord.supportsSplitScreenWindowingMode()
        && activityRecord.supportsMultiWindowInDisplayArea(this)
        && (task2 == null || !task2.isActivityTypeHome());
  }

  public Task ensureLaunchSplitRootTask(
      ActivityRecord activityRecord,
      ActivityOptions activityOptions,
      Task task,
      Task task2,
    ...
    if ((task == null || (task.getResumedActivity() == null && !task.isMinimized()))
        && validateWindowingMode(i3, activityRecord, task) == 0) {
      if (task != null
          && (stageType = task.getWindowConfiguration().getStageType()) != 0
          && (topRootTaskInStageType = getTopRootTaskInStageType(stageType)) != null
          && task.equals(topRootTaskInStageType.getTopMostTask())) {
        return topRootTaskInStageType;
      }
      Task topRootStageTask = getTopRootStageTask();
      if (topRootStageTask != null) {
        if (activityRecord != null
            && activityRecord.isLaunchAdjacent()
            && (activityRecord2 = this.mAtmService.mLastResumedActivity) != null) {
          ...
          if (activityRecord3.finishing
              && componentName != null
              && componentName.equals(activityRecord.mActivityComponent)
              && stageType2 == topRootStageTask.getStageType()
              && topRootStageTask.getAdjacentTaskFragment() != null) {
    ...
    return getOrCreateRootTask(
        activityRecord, activityOptions, task, task2, launchParams, i, i2, z);
  }
  ...
  public void dump(PrintWriter printWriter, String str, boolean z) {
    ...
    if (this.mPreferredTopFocusableRootTask != null) {
      printWriter.println(
          sb2 + "mPreferredTopFocusableRootTask=" + this.mPreferredTopFocusableRootTask);
    }
    ...
    if (this.mLaunchRootTasks.size() > 0) {
      ...
      for (int size = this.mLaunchRootTasks.size() + (-1); size >= 0; size += -1) {
        ...
        printWriter.println(
            str2
                + Arrays.toString(launchRootTaskDef.activityTypes)
                + " "
                + Arrays.toString(launchRootTaskDef.windowingModes)
                + "  task="
                + launchRootTaskDef.task);
      }
    }
