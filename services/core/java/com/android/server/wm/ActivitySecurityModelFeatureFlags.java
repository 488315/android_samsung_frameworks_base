...
public abstract class ActivitySecurityModelFeatureFlags {
    ...
    DeviceConfig.addOnPropertiesChangedListener(
        ...
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.wm.ActivitySecurityModelFeatureFlags$$ExternalSyntheticLambda0
  ...
  public static void updateFromDeviceConfig() {
    ...
    sAsmRestrictionsEnabled =
        DeviceConfig.getInt("window_manager", "ActivitySecurity__asm_restrictions_enabled", 0);
    String string =
        DeviceConfig.getString("window_manager", "ActivitySecurity__asm_exempted_packages", "");
