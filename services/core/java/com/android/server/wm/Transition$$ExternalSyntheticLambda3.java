    ...
    public final void run() {
        ...
        switch (i) {
            case 0:
                ...
                sb.append(
                        TransitionController.Logger.toMsString(
                                logger.mCollectTimeNs - logger.mCreateTimeNs));
                if (logger.mRequestTimeNs != 0) {
                    sb.append(" request-sent=");
                    sb.append(
                            TransitionController.Logger.toMsString(
                                    logger.mRequestTimeNs - logger.mCreateTimeNs));
                }
                sb.append(" started=");
                sb.append(
                        TransitionController.Logger.toMsString(
                                logger.mStartTimeNs - logger.mCreateTimeNs));
                sb.append(" ready=");
                sb.append(
                        TransitionController.Logger.toMsString(
                                logger.mReadyTimeNs - logger.mCreateTimeNs));
                sb.append(" sent=");
                sb.append(
                        TransitionController.Logger.toMsString(
                                logger.mSendTimeNs - logger.mCreateTimeNs));
                sb.append(" finished=");
                sb.append(
                        TransitionController.Logger.toMsString(
                                logger.mFinishTimeNs - logger.mCreateTimeNs));
            ...
            default:
                ...
                WindowManagerGlobalLock windowManagerGlobalLock =
                        transition.mController.mAtm.mGlobalLock;
