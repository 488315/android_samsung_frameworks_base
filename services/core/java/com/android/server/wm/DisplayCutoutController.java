...
public class DisplayCutoutController extends PackagesChangeAsTask {
    ...
    PackageFeatureUserChange.DumpInterface dumpInterface =
        new PackageFeatureUserChange
            .DumpInterface() { // from class:
                               // com.android.server.wm.DisplayCutoutController$$ExternalSyntheticLambda0
  ...
  public void onConfigurationChanged(DisplayContent displayContent, Configuration configuration) {
    ...
    if (displayCutout == null
        || displayPolicy == null
        || displayContent.getDisplayInfo().displayCutout == null) {
    ...
    if (z) {
      if (num == null || num.intValue() != i2) {
        PackagesChange.removeTaskWithoutRemoveFromRecents(
            this.mAtmService, str, i, "setCutoutPolicy");
      }
    }
  }
  ...
  public void adjustAppBoundsIfNeeded(ActivityRecord activityRecord, Configuration configuration) {
    ...
    if (!this.mRemoveCutoutOfConfiguration
        ...
        || task.mCutoutPolicy != 1
        || (appBounds = configuration.windowConfiguration.getAppBounds()) == null
        || appBounds.isEmpty()) {
      return;
    }
  ...
  public static String policyToString(int i) {
    return i != 0
        ? i != 1 ? i != 2 ? Integer.toString(i) : "HideCameraCutout" : "OverlapWithTheCameraCutout"
        : "AppDefault";
  }
}
