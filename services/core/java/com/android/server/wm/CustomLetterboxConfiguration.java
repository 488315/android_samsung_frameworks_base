...
public class CustomLetterboxConfiguration {
  ...
  /* renamed from: -$$Nest$mupdateWallpaperType, reason: not valid java name */
  public static /* bridge */ /* synthetic */ void m13131$$Nest$mupdateWallpaperType(
      CustomLetterboxConfiguration customLetterboxConfiguration) {
  ...
  public static void onConfigurationChanged(int i) {
    ...
    if (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED_AS_CAPTURED_BLUR) {
      ...
      final boolean z = i != 0;
      customLetterboxConfiguration.mWmService.mRoot.forAllDisplays(
          new Consumer() { // from class:
                           // com.android.server.wm.CustomLetterboxConfiguration$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              CustomLetterboxConfiguration.this.applyLetterboxEnhancedIfNeeded(
                  (DisplayContent) obj, true, z);
            }
          });
    }
  }
  ...
  public final void reloadResources() {
    ...
    this.mLetterboxActivityCornersRadius =
        resources.getDimensionPixelSize(R.dimen.config_progressBarCornerRadius);
    this.mLetterboxBackgroundWallpaperBlurRadius =
        resources.getDimensionPixelSize(R.dimen.config_qsTileStrokeWidthActive);
  ...
  public static boolean hasWallpaperBackgroundForLetterbox(ActivityRecord activityRecord) {
    return isCustomLetterboxEnabled(activityRecord)
        && getCustomLetterboxBackgroundType(activityRecord) == 3;
  }
    ...
    if (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED || !isEnabledEnhanced(i)) {
      if (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED_HIDING_WALLPAPER || i != 7) {
        ...
        WindowManagerGlobalLock windowManagerGlobalLock =
            customLetterboxConfiguration.mWmService.mGlobalLock;
  ...
  public static boolean isCustomLetterboxEnabled(ActivityRecord activityRecord) {
    return (getInstance().mMode == 0
            || activityRecord == null
            || !activityRecord.mCompatRecord.isCompatModeEnabled()
            || !activityRecord.mCompatRecord.getController().supportsCustomLetterbox()
            || activityRecord.mCompatRecord.isAboveEmbeddedTaskFragment())
        ? false
        : true;
  }
  ...
  public static boolean isAllowFreezeWallpaper(WindowState windowState) {
    return getInstance().mAllowFreezeWallpaper
        || windowState == null
        || !isCustomLetterboxEnabled(windowState.mActivityRecord);
  }
  ...
  public static float getCustomLetterboxBackgroundWallpaperDarkScrimAlpha(
  ...
  public static boolean hasLetterboxSurface(DisplayContent displayContent) {
    ...
    CustomLetterboxEnhancedController customLetterboxEnhancedController =
        (CustomLetterboxEnhancedController)
            customLetterboxConfiguration.mEnhancedControllers.get(displayContent.getDisplayId());
    return customLetterboxEnhancedController == null
        || customLetterboxEnhancedController.shouldShowLetterboxLocked();
  }

  /* renamed from: com.android.server.wm.CustomLetterboxConfiguration$1 */
  public class C28881 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      WindowManagerService.HandlerC2998H handlerC2998H = this.val$instance.mWmService.f1749mH;
      final CustomLetterboxConfiguration customLetterboxConfiguration = this.val$instance;
      handlerC2998H.post(
          new Runnable() { // from class:
                           // com.android.server.wm.CustomLetterboxConfiguration$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              CustomLetterboxConfiguration.m13131$$Nest$mupdateWallpaperType(
                  CustomLetterboxConfiguration.this);
            }
          });
    }
  }
  ...
  public final void updateWallpaperType() {
    try {
      WallpaperManager wallpaperManager =
          (WallpaperManager) SafetySystemService.getSystemService(WallpaperManager.class);
      ...
      synchronized (windowManagerGlobalLock) {
        try {
          ...
          this.mWmService.mRoot.forAllDisplays(
              new Consumer() { // from class:
                               // com.android.server.wm.CustomLetterboxConfiguration$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  CustomLetterboxConfiguration.this.lambda$updateWallpaperType$2(
                      (DisplayContent) obj);
                }
              });
          WindowManagerService.resetPriorityAfterLockedSection();
  ...
  /* renamed from: applyLetterboxEnhancedIfNeeded, reason: merged with bridge method [inline-methods] */
  ...
  public final void applyLetterboxEnhancedIfNeeded(
      DisplayContent displayContent, boolean z, boolean z2) {
    boolean isEnabledEnhanced = isEnabledEnhanced(this.mMode);
    int displayId = displayContent.getDisplayId();
    CustomLetterboxEnhancedController customLetterboxEnhancedController =
        (CustomLetterboxEnhancedController) this.mEnhancedControllers.get(displayId);
    if (isEnabledEnhanced) {
      if (customLetterboxEnhancedController == null) {
        if (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED_AS_CAPTURED_BLUR) {
          customLetterboxEnhancedController =
              new CustomLetterboxEnhancedController.CapturedBlurWallpaper(displayContent);
        } else {
    ...
    customLetterboxEnhancedController.applyLetterboxEnhancedIfNeededLocked(
        isEnabledEnhanced, this.mHasLiveWallpaper, z, z2);
  }

  public static void performEnhancedControllerIfNonNull(
      DisplayContent displayContent, Consumer consumer) {
    CustomLetterboxEnhancedController customLetterboxEnhancedController;
    if (displayContent == null
        || (customLetterboxEnhancedController =
                (CustomLetterboxEnhancedController)
                    getInstance().mEnhancedControllers.get(displayContent.mDisplayId))
            == null
        || !customLetterboxEnhancedController.isAvailable()) {
      return;
    }
  ...
  public static boolean isWaitingForEnhancedEnabled(DisplayContent displayContent) {
    ...
    return customLetterboxEnhancedController != null
        && customLetterboxEnhancedController.isAvailable()
        && customLetterboxEnhancedController.isWaitingForEnhancedEnabledLocked();
  }
  ...
  public static boolean shouldHideWallpaper(DisplayContent displayContent) {
    ...
    return customLetterboxEnhancedController != null
        && customLetterboxEnhancedController.isAvailable()
        && customLetterboxEnhancedController.shouldHideWallpaper();
  }
  ...
  public final void dump(PrintWriter printWriter, String str, String str2) {
    ...
    if (CoreRune.FW_CUSTOM_LETTERBOX_ENHANCED) {
      ...
      for (int i = 0; i < this.mEnhancedControllers.size(); i++) {
        ((CustomLetterboxEnhancedController) this.mEnhancedControllers.valueAt(i))
            .dumpLocked(printWriter, str, str2);
      }
    }
  }
