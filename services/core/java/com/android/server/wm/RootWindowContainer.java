...
public class RootWindowContainer extends WindowContainer implements DisplayManager.DisplayListener {
  ...
  public class RunnableC29661 implements Runnable {
    ...
    public void run() {
      WindowManagerGlobalLock windowManagerGlobalLock =
          RootWindowContainer.this.mService.mGlobalLock;
      WindowManagerService.boostPriorityForLockedSection();
      synchronized (windowManagerGlobalLock) {
        try {
          try {
            RootWindowContainer.this.mTaskSupervisor.beginDeferResume();
            RootWindowContainer.this.forAllActivities(
                new Consumer() { // from class:
                                 // com.android.server.wm.RootWindowContainer$1$$ExternalSyntheticLambda0
      ...
      synchronized (windowManagerGlobalLock) {
        try {
          try {
            ...
            RootWindowContainer.this.forAllActivities(
                new Consumer() { // from class:
                                 // com.android.server.wm.RootWindowContainer$mDestroyTargetAllActivities$$ExternalSyntheticLambda0
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
                    RootWindowContainer.mDestroyTargetAllActivities.this.lambda$run$0(
                        (ActivityRecord) obj);
                  }
                });
          } finally {
  ...
  public class FindTaskResult implements Predicate {
    ...
    public void process(WindowContainer windowContainer) {
      ...
      if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
        ProtoLogImpl.d(
            ...
            0,
            (String) null,
            new Object[] {String.valueOf(this.mInfo), String.valueOf(windowContainer)});
      }
    ...
    */
    public boolean test(Task task) {
      ...
      if (!ConfigurationContainer.isCompatibleActivityType(
          this.mActivityType, task.getActivityType())) {
        if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
          ProtoLogImpl.d(
              ProtoLogGroup.WM_DEBUG_TASKS,
              -373110070,
      ...
      if (topNonFinishingActivity == null
          || topNonFinishingActivity.finishing
          || topNonFinishingActivity.mUserId != this.userId
          || topNonFinishingActivity.launchMode == 3) {
        if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
          ProtoLogImpl.d(
              ProtoLogGroup.WM_DEBUG_TASKS,
              -1575977269,
              0,
              (String) null,
              new Object[] {String.valueOf(task), String.valueOf(topNonFinishingActivity)});
        }
        return false;
      }
      if (!ConfigurationContainer.isCompatibleActivityType(
          topNonFinishingActivity.getActivityType(), this.mActivityType)) {
        if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
          ProtoLogImpl.d(
              ProtoLogGroup.WM_DEBUG_TASKS,
              -1022146708,
      ...
      if (intent != null && intent.isDocument()) {
        ...
        if (!task.isAliasManaged()
            && (launchTaskIdForAliasManagedTarget =
                    this.mIntent.getLaunchTaskIdForAliasManagedTarget())
                != -1) {
        ...
        launchTaskIdForSingleInstancePerTask =
            this.mIntent.getLaunchTaskIdForSingleInstancePerTask();
        ...
        if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
          ...
          ProtoLogImpl.d(
              ...
              (String) null,
              new Object[] {
                String.valueOf(componentName != null ? componentName.flattenToShortString() : ""),
                String.valueOf(task.rootAffinity),
                String.valueOf(this.mIntent.getComponent().flattenToShortString()),
                String.valueOf(this.mTaskAffinity)
              });
        }
        ComponentName componentName2 = task.realActivity;
        if (componentName2 != null
            && componentName2.compareTo(this.cls) == 0
            && Objects.equals(this.documentData, uri)) {
          if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
            ProtoLogImpl.d(
                ProtoLogGroup.WM_DEBUG_TASKS, 1947936538, 0, (String) null, (Object[]) null);
          }
          if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
            ProtoLogImpl.d(
                ProtoLogGroup.WM_DEBUG_TASKS,
                ...
                (String) null,
                new Object[] {
                  String.valueOf(this.mIntent), String.valueOf(topNonFinishingActivity.intent)
                });
          }
          this.mIdealRecord = topNonFinishingActivity;
          return true;
        ...
        if (intent2 != null
            ...
            && intent2.getComponent().compareTo(this.cls) == 0
            && Objects.equals(this.documentData, uri)) {
          if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
            ProtoLogImpl.d(
                ProtoLogGroup.WM_DEBUG_TASKS, 1947936538, 0, (String) null, (Object[]) null);
        ...
        if (!this.isDocument
            ...
            && this.mIdealRecord == null
            && this.mCandidateRecord == null
            && (str = task.rootAffinity) != null) {
          if (!str.equals(this.mTaskAffinity)
              || !task.isSameRequiredDisplayCategory(this.mInfo)
              || topNonFinishingActivity.mAliasChild) {
            return false;
          }
          if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
            ProtoLogImpl.d(
                ProtoLogGroup.WM_DEBUG_TASKS, 2039056415, 0, (String) null, (Object[]) null);
          }
  ...
  public RootWindowContainer(WindowManagerService windowManagerService) {
    ...
    this.mCloseSystemDialogsConsumer =
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda37
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
    ...
    this.mDisplayOffTokenAcquirer =
        activityTaskManagerService.new SleepTokenAcquirerImpl("Display-off");
    this.mDeviceStateController =
        new DeviceStateController(windowManagerService.mContext, windowManagerService.mGlobalLock);
  ...
  public boolean updateFocusedWindowLocked(int i, boolean z) {
    ...
    if (CoreRune.FW_TSP_STATE_CONTROLLER && z2 && i2 == 0) {
      this.mWmService.mExt.mTspStateController.updateWindowPolicy(
          getDisplayContent(0).mCurrentFocus);
    }
    return z2;
  }
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (this.mWmService.mDisplayWindowSettings.updateSettingsForDisplay(displayContent)) {
        ...
        if (displayContent.isDefaultDisplay) {
          this.mWmService.mAtmService.updateConfigurationLocked(
              this.mWmService.computeNewConfiguration(displayContent.getDisplayId()), null, false);
        }
      }
    }
  }
  ...
  public final void getWindowsByName(final ArrayList arrayList, final String str, final int i) {
    forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda55
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public static /* synthetic */ void lambda$getWindowsByName$1(
      String str, ArrayList arrayList, int i, WindowState windowState) {
    if (str != null) {
  ...
  public ActivityRecord getActivityRecord(IBinder iBinder) {
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      ActivityRecord activityRecord =
          ((DisplayContent) this.mChildren.get(size)).getActivityRecord(iBinder);
  ...
  public void dispatchConfigurationToChild(
      DisplayContent displayContent, Configuration configuration) {
    if (displayContent.isDefaultDisplay) {
  ...
  public void refreshSecureSurfaceState() {
    forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda25
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void updateHiddenWhileSuspendedState(final ArraySet arraySet, final boolean z) {
    forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda33
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$updateHiddenWhileSuspendedState$3(
                arraySet, z, (WindowState) obj);
          }
        },
        false);
  }

  public static /* synthetic */ void lambda$updateHiddenWhileSuspendedState$3(
      ArraySet arraySet, boolean z, WindowState windowState) {
  ...
  public void updateHiddenWhileProfileLockedStateLocked(final int i, final boolean z) {
    forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda34
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$updateHiddenWhileProfileLockedStateLocked$4(
                i, z, (WindowState) obj);
          }
        },
        false);
  ...
  public static /* synthetic */ void lambda$updateHiddenWhileProfileLockedStateLocked$4(
      int i, boolean z, WindowState windowState) {
  ...
  public void updateAppOpsState() {
    forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda52
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public static /* synthetic */ boolean lambda$canShowStrictModeViolation$6(
  ...
  public boolean canShowStrictModeViolation(final int i) {
    return getWindow(
            new Predicate() { // from class:
                              // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda48
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$canShowStrictModeViolation$6;
                lambda$canShowStrictModeViolation$6 =
                    RootWindowContainer.lambda$canShowStrictModeViolation$6(i, (WindowState) obj);
  ...
  public boolean reclaimSomeSurfaceMemory(
      WindowStateAnimator windowStateAnimator, String str, boolean z) {
    boolean z2;
    WindowSurfaceController windowSurfaceController = windowStateAnimator.mSurfaceController;
    EventLogTags.writeWmNoSurfaceMemory(
        windowStateAnimator.mWin.toString(), windowStateAnimator.mSession.mPid, str);
    ...
    try {
      ...
      if (z3) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
          ((DisplayContent) this.mChildren.get(i2))
              .forAllWindows(
                  new Consumer() { // from class:
                                   // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda19
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                      RootWindowContainer.this.lambda$reclaimSomeSurfaceMemory$7(
                          sparseIntArray, (WindowState) obj);
                    }
                  },
                  false);
        ...
        if (windowSurfaceController != null) {
          if (ProtoLogCache.WM_SHOW_SURFACE_ALLOC_enabled) {
            ProtoLogImpl.i(
                ...
                0,
                (String) null,
                new Object[] {String.valueOf(windowStateAnimator.mWin)});
          }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$reclaimSomeSurfaceMemory$7(
      SparseIntArray sparseIntArray, WindowState windowState) {
  ...
  public void performSurfacePlacementNoTrace() {
    ...
    DisplayContent defaultDisplayContentLocked =
        windowManagerService2.getDefaultDisplayContentLocked();
    ...
    try {
      ...
      if (recentsAnimationController != null) {
        recentsAnimationController.checkAnimationReady(
            defaultDisplayContentLocked.mWallpaperController);
      }
      this.mWmService.mAtmService.mBackNavigationController.checkAnimationReady(
          defaultDisplayContentLocked.mWallpaperController);
      for (int i = 0; i < this.mChildren.size(); i++) {
        ...
        if (displayContent.mWallpaperMayChange) {
          if (ProtoLogCache.WM_DEBUG_WALLPAPER_enabled) {
            ProtoLogImpl.v(
                ProtoLogGroup.WM_DEBUG_WALLPAPER, 535103992, 0, (String) null, (Object[]) null);
          }
      ...
      if (this.mWmService.mDisplayFrozen && ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
        ProtoLogImpl.v(
            ...
            3,
            (String) null,
            new Object[] {Boolean.valueOf(this.mOrientationChangeComplete)});
      }
      ...
      if (this.mUpdateRotation) {
        if (ProtoLogCache.WM_DEBUG_ORIENTATION_enabled) {
          ProtoLogImpl.d(
              ProtoLogGroup.WM_DEBUG_ORIENTATION, -1103115659, 0, (String) null, (Object[]) null);
        }
        this.mUpdateRotation = updateRotationUnchecked();
      }
      if (!this.mWmService.mWaitingForDrawnCallbacks.isEmpty()
          || (this.mOrientationChangeComplete && !isLayoutNeeded() && !this.mUpdateRotation)) {
        this.mWmService.checkDrawnWindowsLocked();
      }
      forAllDisplays(
          new Consumer() { // from class:
                           // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda40
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  public static /* synthetic */ void lambda$performSurfacePlacementNoTrace$8(
  ...
  public final void applySurfaceChangesTransaction() {
    ...
    for (int i3 = 0; i3 < size; i3++) {
      ...
      this.mDisplayTransactions.append(
          displayContent2.mDisplayId, displayContent2.getSyncTransaction());
    }
    this.mWmService.mDisplayManagerInternal.performTraversal(
        syncTransaction, this.mDisplayTransactions);
  ...
  */
  public boolean handleNotObscuredLocked(WindowState windowState, boolean z, boolean z2) {
    ...
    if (ProtoLogCache.WM_DEBUG_KEEP_SCREEN_ON_enabled) {
      ProtoLogImpl.d(
          ...
          new Object[] {
            ...
            Boolean.valueOf(windowState.mHasSurface),
            Boolean.valueOf(isOnScreen),
            Boolean.valueOf(windowState.isDisplayed()),
            Long.valueOf(windowState.mAttrs.userActivityTimeout)
          });
    }
    if (windowState.mHasSurface && isOnScreen) {
      if (windowState.getDisplayId() != 2
          || windowState.mAttrs.userActivityTimeout < 0
          || this.mDeXUserActivityTimeout >= 0) {
        if (!z2) {
        ...
        if (CoreRune.SAFE_DEBUG) {
          Slog.d(
              StartingSurfaceController.TAG,
              "mDeXUserActivityTimeout set to " + this.mDeXUserActivityTimeout);
        }
      }
      if (!z2) {
    ...
    if (!z2
        && windowState.mAttrs.screenBrightness >= DisplayPowerController2.RATE_FROM_DOZE_TO_ON
        && Float.isNaN(this.mScreenBrightnessOverride)
    ...
    if (displayContent != null && displayContent.isDefaultDisplay) {
      if (windowState.isDreamWindow() || this.mWmService.mPolicy.isKeyguardShowing()) {
        ...
        || (this.mObscureApplicationContentOnSecondaryDisplays
  ...
  public boolean updateRotationUnchecked() {
    boolean z = false;
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      if (((DisplayContent) this.mChildren.get(size))
          .getDisplayRotation()
  ...
  public final class MyHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      int i = message.what;
      if (i == 1) {
        RootWindowContainer.this.mWmService.mPowerManagerInternal
            .setScreenBrightnessOverrideFromWindowManager(Float.intBitsToFloat(message.arg1));
        return;
      }
      if (i == 2) {
        RootWindowContainer.this.mWmService.mPowerManagerInternal
            .setUserActivityTimeoutOverrideFromWindowManager(((Long) message.obj).longValue());
        return;
      }
      if (i != 3) {
        if (i == 10) {
          RootWindowContainer.this.mWmService.mPowerManagerInternal
              .setUserActivityTimeoutForDexOverrideFromWindowManager(
          ...
          RootWindowContainer.this.mWmService.mPowerManagerInternal
              .setScreenDimDurationOverrideFromWindowManager(((Long) message.obj).longValue());
          return;
        }
      }
      WindowManagerGlobalLock windowManagerGlobalLock =
  ...
  public void dumpWindowsNoHeader(
      final PrintWriter printWriter, final boolean z, final ArrayList arrayList) {
    final int[] iArr = new int[1];
    forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda54
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$dumpWindowsNoHeader$9(
                arrayList, printWriter, iArr, z, (WindowState) obj);
          }
        },
        true);
  }

  public static /* synthetic */ void lambda$dumpWindowsNoHeader$9(
      ArrayList arrayList,
    ...
    if (arrayList == null || arrayList.contains(windowState)) {
      printWriter.println(
          "  Window #" + iArr[0] + " " + windowState + XmlUtils.STRING_ARRAY_SEPARATOR);
  ...
  public void dumpDebug(ProtoOutputStream protoOutputStream, long j, int i) {
    if (i != 2 || isVisible()) {
      ...
      protoOutputStream.write(
          1133871366150L,
          this.mTaskSupervisor.mRecentTasks.isRecentsComponentHomeActivity(this.mCurrentUser));
  ...
  public void getDisplayContextsWithNonToastVisibleWindows(final int i, List list) {
    ...
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      ...
      if (displayContent.getWindow(
              new Predicate() { // from class:
                                // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda38
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$getDisplayContextsWithNonToastVisibleWindows$10;
                  lambda$getDisplayContextsWithNonToastVisibleWindows$10 =
                      RootWindowContainer.lambda$getDisplayContextsWithNonToastVisibleWindows$10(
                          i, (WindowState) obj);
  ...
  public static /* synthetic */ boolean lambda$getDisplayContextsWithNonToastVisibleWindows$10(
      int i, WindowState windowState) {
    return i == windowState.mSession.mPid
  ...
  public void setWindowManager(WindowManagerService windowManagerService) {
    ...
    for (Display display :
        this.mDisplayManager.getDisplays(
            "android.hardware.display.category.ALL_INCLUDING_BUILT_IN")) {
      DisplayContent displayContent =
          new DisplayContent(display, this, this.mDeviceStateController);
  ...
  public void startHomeOnEmptyDisplays(final String str) {
    forAllTaskDisplayAreas(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda31
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$startHomeOnEmptyDisplays$11(
      String str, TaskDisplayArea taskDisplayArea) {
    if (taskDisplayArea.topRunningActivity() == null) {
      startHomeOnTaskDisplayArea(
          this.mWmService.getUserAssignedToDisplay(taskDisplayArea.getDisplayId()),
          str,
          taskDisplayArea,
          false,
          false);
  ...
  public boolean startHomeOnDisplay(
      final int i, final String str, int i2, final boolean z, final boolean z2, final int i3) {
    if (i2 == -1) {
    ...
    return ((Boolean)
            getDisplayContent(i2)
                .reduceOnAllTaskDisplayAreas(
                    new BiFunction() { // from class:
                                       // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda35
                      @Override // java.util.function.BiFunction
                      public final Object apply(Object obj, Object obj2) {
                        Boolean lambda$startHomeOnDisplay$12;
                        lambda$startHomeOnDisplay$12 =
                            RootWindowContainer.this.lambda$startHomeOnDisplay$12(
                                i, str, z, z2, i3, (TaskDisplayArea) obj, (Boolean) obj2);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ Boolean lambda$startHomeOnDisplay$12(
      int i,
      String str,
      boolean z,
      boolean z2,
    ...
    return Boolean.valueOf(
        startHomeOnTaskDisplayArea(i, str, taskDisplayArea, z, z2, 0) | bool.booleanValue());
  }

  public boolean startHomeOnTaskDisplayArea(
      int i, String str, TaskDisplayArea taskDisplayArea, boolean z, boolean z2) {
    return startHomeOnTaskDisplayArea(i, str, taskDisplayArea, z, z2, 0);
  }

  public boolean startHomeOnTaskDisplayArea(
      int i, String str, TaskDisplayArea taskDisplayArea, boolean z, boolean z2, int i2) {
    Intent homeIntent;
    ...
    if (taskDisplayArea == getDefaultTaskDisplayArea()
        || this.mWmService.shouldPlacePrimaryHomeOnDisplay(taskDisplayArea.getDisplayId(), i)) {
    ...
    if (resolveHomeActivity == null
        || homeIntent == null
        || !canStartHomeOnDisplayArea(resolveHomeActivity, taskDisplayArea, z)) {
      return false;
    }
    homeIntent.setComponent(
        new ComponentName(
            resolveHomeActivity.applicationInfo.packageName, resolveHomeActivity.name));
    ...
    if (z2) {
      ...
      if (CoreRune.MW_SA_LOGGING
          && taskDisplayArea.getDisplayId() == 0
          && taskDisplayArea.isSplitScreenModeActivated()) {
    ...
    this.mService
        ...
        .startHomeActivity(
            ...
            str
                ...
                + i
                + XmlUtils.STRING_ARRAY_SEPARATOR
                + UserHandle.getUserId(resolveHomeActivity.applicationInfo.uid)
                + XmlUtils.STRING_ARRAY_SEPARATOR
  ...
  */
  public ActivityInfo resolveHomeActivity(int i, Intent intent) {
    ...
    if (component != null) {
      ...
      ResolveInfo resolveIntent =
          this.mTaskSupervisor.resolveIntent(
              intent,
              intent.resolveTypeIfNeeded(this.mService.mContext.getContentResolver()),
              i,
              1024,
    ...
    if (activityInfo == null) {
      Slogf.wtf(
          StartingSurfaceController.TAG,
          new Exception(),
          "No home screen found for %s and user %d",
          intent,
          Integer.valueOf(i));
      return null;
    }
    ActivityInfo activityInfo2 = new ActivityInfo(activityInfo);
    activityInfo2.applicationInfo =
        this.mService.getAppInfoForUser(activityInfo2.applicationInfo, i);
  ...
  public Pair resolveSecondaryHomeActivity(int i, TaskDisplayArea taskDisplayArea) {
    ...
    if (resolveHomeActivity != null) {
      if (ResolverActivity.class.getName().equals(resolveHomeActivity.name)) {
        ...
        if (this.mWmService.mExt.mExtraDisplayPolicy.hasCoverHome(taskDisplayArea.getDisplayId())) {
          ...
          homeIntent =
              this.mService.getSecondaryHomeIntent(resolveHomeActivity.applicationInfo.packageName);
        }
    ...
    if (resolveHomeActivity != null
        && !canStartHomeOnDisplayArea(resolveHomeActivity, taskDisplayArea, false)) {
      resolveHomeActivity = null;
    }
    if (resolveHomeActivity == null) {
  ...
  public boolean resumeHomeActivity(
      ActivityRecord activityRecord, String str, TaskDisplayArea taskDisplayArea) {
    ...
    return startHomeOnTaskDisplayArea(
        this.mWmService.getUserAssignedToDisplay(taskDisplayArea2.getDisplayId()),
        str2,
        taskDisplayArea2,
        false,
        false);
  ...
  public boolean shouldPlaceSecondaryHomeOnDisplayArea(TaskDisplayArea taskDisplayArea) {
    ...
    if (!this.mWmService.mExt.mExtraDisplayPolicy.hasCoverHome(taskDisplayArea.getDisplayId())) {
      if (!(Settings.Global.getInt(
                  this.mService.mContext.getContentResolver(), "device_provisioned", 0)
              != 0)
          || !StorageManager.isUserKeyUnlocked(this.mCurrentUser)) {
        return false;
      }
    }
    if (taskDisplayArea.getDisplayId() == 2
        && this.mService.mDexController.getDexModeLocked() == 2) {
      return true;
    }
    DisplayContent displayContent = taskDisplayArea.getDisplayContent();
    return (displayContent == null
            || displayContent.isRemoved()
            || !displayContent.supportsSystemDecorations())
        ? false
        : true;
  }

  public boolean canStartHomeOnDisplayArea(
      ActivityInfo activityInfo, TaskDisplayArea taskDisplayArea, boolean z) {
    ActivityTaskManagerService activityTaskManagerService = this.mService;
    if (activityTaskManagerService.mFactoryTest == 1
        && activityTaskManagerService.mTopAction == null) {
      return false;
    }
    WindowProcessController processController =
        activityTaskManagerService.getProcessController(
            activityInfo.processName, activityInfo.applicationInfo.uid);
    ...
    if (displayId != 0
        && (displayId == -1
            || (displayId != this.mService.mVr2dDisplayId
                && !this.mWmService.shouldPlacePrimaryHomeOnDisplay(displayId)))) {
  ...
  public boolean ensureVisibilityAndConfig(
      ActivityRecord activityRecord, int i, boolean z, boolean z2) {
    ...
    DisplayContent displayContent = getDisplayContent(i);
    Configuration updateOrientation =
        displayContent != null ? displayContent.updateOrientation(activityRecord, true) : null;
    if (activityRecord != null) {
      if (i == 1
          && (windowProcessController = activityRecord.app) != null
          && !windowProcessController.isActivityConfigOverrideAllowed()
    ...
    if (displayContent != null) {
      return displayContent.updateDisplayOverrideConfigurationLocked(
          updateOrientation, activityRecord, z2, null);
    }
    return true;
  }
  ...
  public List getTopVisibleActivities() {
    ...
    forAllRootTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda6
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$getTopVisibleActivities$13(
                arrayList2, topDisplayFocusedRootTask, arrayList, (Task) obj);
          }
        });
    return arrayList;
  }

  public static /* synthetic */ void lambda$getTopVisibleActivities$13(
      ArrayList arrayList, Task task, ArrayList arrayList2, Task task2) {
    ActivityRecord topNonFinishingActivity;
    ActivityRecord topNonFinishingActivity2;
    if (!task2.shouldBeVisible(null)
        || (topNonFinishingActivity = task2.getTopNonFinishingActivity()) == null) {
      return;
    }
    arrayList.clear();
    ...
    if (adjacentTask != null
        && (topNonFinishingActivity2 = adjacentTask.getTopNonFinishingActivity()) != null) {
        ...
        ? (ActivityRecord)
            getItemFromTaskDisplayAreas(
                new Function() { // from class:
                                 // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda8
  ...
  public boolean switchUser(final int i, UserState userState) {
    Task topDisplayFocusedRootTask = getTopDisplayFocusedRootTask();
    int rootTaskId =
        topDisplayFocusedRootTask != null ? topDisplayFocusedRootTask.getRootTaskId() : -1;
    ...
    forAllRootTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda9
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void moveRootTaskToTaskDisplayArea(int i, TaskDisplayArea taskDisplayArea, boolean z) {
    ...
    if (displayArea == null) {
      throw new IllegalStateException(
          "moveRootTaskToTaskDisplayArea: rootTask="
              + rootTask
    ...
    if (displayArea == taskDisplayArea) {
      throw new IllegalArgumentException(
          "Trying to move rootTask="
              + rootTask
              + " to its current taskDisplayArea="
              + taskDisplayArea);
    }
  ...
  public void moveActivityToPinnedRootTask(
      ActivityRecord activityRecord, ActivityRecord activityRecord2, String str) {
  ...
  public void moveActivityToPinnedRootTask(
    ...
    try {
      ...
      if (CoreRune.MW_PIP_SHELL_TRANSITION) {
        this.mService.mChangeTransitController.handleEnteringPipIfNeeded(
            activityRecord, transition);
      }
      if (CoreRune.FW_BLUR_WALLPAPER_LETTERBOX) {
        BlurWallpaperLetterbox.onMoveActivityToPinnedRootTask(
            activityRecord.mDisplayContent, task, activityRecord);
      }
      ...
      if (task.getNonFinishingActivityCount() == 1) {
        ...
        task.forAllTaskFragments(
            new Consumer() { // from class:
                             // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda28
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
        ...
        build =
            new Task.Builder(this.mService)
                .setActivityType(activityRecord.getActivityType())
                .setOnTop(true)
                .setActivityInfo(activityRecord.info)
                .setParent(displayArea)
                .setIntent(activityRecord.intent)
        ...
        if (pictureInPictureSurfaceTransaction != null) {
          build.setLastRecentsAnimationTransaction(
              pictureInPictureSurfaceTransaction, task.mLastRecentsAnimationOverlay);
          task.clearLastRecentsAnimationTransaction(false);
        } else {
          task.resetSurfaceControlTransforms();
        }
        if (organizedTaskFragment != null
            && organizedTaskFragment.getNonFinishingActivityCount() == 1
            && organizedTaskFragment.getTopNonFinishingActivity() == activityRecord) {
        ...
        if (topMostActivity != null
            && topMostActivity.isState(ActivityRecord.State.STOPPED)
            && task.getDisplayContent().mAppTransition.containsTransitRequest(4)) {
      ...
      if (organizedTaskFragment != null
          && organizedTaskFragment.mClearedTaskFragmentForPip
          && organizedTaskFragment.isTaskVisibleRequested()) {
        this.mService.mTaskFragmentOrganizerController.dispatchPendingInfoChangedEvent(
  ...
  public static /* synthetic */ void lambda$moveActivityToPinnedRootTask$15(
  ...
  public void notifyActivityPipModeChanged(Task task, ActivityRecord activityRecord) {
    ...
    ((SurfaceControl.Transaction) this.mWmService.mTransactionFactory.get())
        .setTrustedOverlay(task.getSurfaceControl(), z)
        .apply();
    if (z) {
      return;
    }
    task.forAllActivities(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda18
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public ActivityRecord findTask(
      final int i,
      final String str,
      final Intent intent,
    ...
    if (ProtoLogCache.WM_DEBUG_TASKS_enabled) {
      ProtoLogImpl.d(
          ...
          new Object[] {
            ...
            String.valueOf(activityInfo),
            String.valueOf(taskDisplayArea)
          });
    }
      ...
      if (activityRecord4 != null) {
        ...
        activityRecord2 =
            (ActivityRecord)
                getItemFromTaskDisplayAreas(
                    new Function() { // from class:
                                     // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda5
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        ActivityRecord lambda$findTask$17;
                        lambda$findTask$17 =
                            RootWindowContainer.this.lambda$findTask$17(
                                taskDisplayArea,
                                i,
                                str,
                                intent,
        ...
        if (ProtoLogGroup.WM_DEBUG_TASKS.isEnabled()
            && activityRecord == null
            && ProtoLogCache.WM_DEBUG_TASKS_enabled) {
          ProtoLogImpl.d(
              ProtoLogGroup.WM_DEBUG_TASKS, -1376035390, 0, (String) null, (Object[]) null);
        }
        if (activityRecord == null
            && (secIpmManager =
                    (SecIpmManager) this.mService.mContext.getSystemService("PkgPredictorService"))
                != null) {
          ApplicationInfo applicationInfo = activityInfo.applicationInfo;
          secIpmManager.dexFilePreload(
              applicationInfo.uid, activityInfo.packageName, applicationInfo.getCodePath());
        }
        return activityRecord;
      }
    }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ ActivityRecord lambda$findTask$17(
      TaskDisplayArea taskDisplayArea,
      int i,
      String str,
      Intent intent,
  ...
  public int finishTopCrashedActivities(
      final WindowProcessController windowProcessController, final String str) {
    final Task topDisplayFocusedRootTask = getTopDisplayFocusedRootTask();
    final Task[] taskArr = new Task[1];
    forAllTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda14
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$finishTopCrashedActivities$18(
                WindowProcessController.this, str, topDisplayFocusedRootTask, taskArr, (Task) obj);
          }
        });
    Task task = taskArr[0];
    if (task != null) {
  ...
  public static /* synthetic */ void lambda$finishTopCrashedActivities$18(
      WindowProcessController windowProcessController,
      String str,
      Task task,
      Task[] taskArr,
    ...
    Task finishTopCrashedActivityLocked =
        task2.finishTopCrashedActivityLocked(windowProcessController, str);
  ...
  public boolean resumeFocusedTasksTopActivities(
      Task task, ActivityRecord activityRecord, ActivityOptions activityOptions) {
  ...
  public boolean resumeFocusedTasksTopActivities(
    ...
    boolean resumeTopActivityUncheckedLocked =
        (task == null
                || !(task.isTopRootTaskInDisplayArea() || getTopDisplayFocusedRootTask() == task))
            ? false
            : task.resumeTopActivityUncheckedLocked(activityRecord, activityOptions, z);
    for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
      DisplayContent displayContent = (DisplayContent) getChildAt(childCount);
      ...
      displayContent.forAllRootTasks(
          new Consumer() { // from class:
                           // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda15
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              RootWindowContainer.lambda$resumeFocusedTasksTopActivities$19(
                  Task.this, zArr, z2, activityOptions, activityRecord, (Task) obj);
            }
          });
      boolean z3 = zArr[0];
      boolean z4 = resumeTopActivityUncheckedLocked | z3;
      if (!z3
          && ((displayContent.getDisplayId() != 2
                  || this.mService.mDexController.getDexModeLocked() != 0)
              && ((!displayContent.isRemoteAppDisplay()
                      || displayContent.topRunningActivity(false) != null)
        ...
        if (focusedRootTask != null) {
          ...
          if (!z4
              && activityRecord != null
              && activityRecord.mAliasChild
              && activityRecord.isState(ActivityRecord.State.INITIALIZING)
              && !activityRecord.isVisibleRequested()
              && focusedRootTask == task
              && focusedRootTask.inFreeformWindowingMode()
              && focusedRootTask.shouldBeVisible(null)) {
            focusedRootTask.ensureActivitiesVisible(null, 0, true);
          }
        } else if (task == null) {
          resumeTopActivityUncheckedLocked =
              resumeHomeActivity(
                      null, "no-focusable-task", displayContent.getDefaultTaskDisplayArea())
                  | z4;
        }
      }
  ...
  public static /* synthetic */ void lambda$resumeFocusedTasksTopActivities$19(
      Task task,
      boolean[] zArr,
      boolean z,
    ...
    if (task2 == task) {
      zArr[0] = zArr[0] | z;
    } else if (activityRecord2.isState(ActivityRecord.State.RESUMED)
        && activityRecord2 == task2.getDisplayArea().topRunningActivity()) {
  ...
  public void sendSleepTransition(final DisplayContent displayContent) {
    final Transition transition =
        new Transition(12, 0, displayContent.mTransitionController, this.mWmService.mSyncEngine);
    TransitionController.OnStartCollect onStartCollect =
        new TransitionController
            .OnStartCollect() { // from class:
                                // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda47
  ...
  public static /* synthetic */ void lambda$sendSleepTransition$20(
      DisplayContent displayContent, Transition transition, boolean z) {
    if (z
        && !displayContent.shouldSleep()
        && (!CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX || !transition.isInKeyguardTransition())) {
      transition.abort();
    } else {
  ...
  */
    ...
    for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
      ...
      if (shouldSleep != displayContent.isSleeping()) {
        ...
        if (displayContent.mTransitionController.isShellTransitionsEnabled()
            && !z3
            && shouldSleep
            && !displayContent.mAllSleepTokens.isEmpty()) {
          ...
          if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX
              ...
              && displayContent
                  ...
                  .getCollectingTransition()
                  .isInKeyguardTransition()) {
            displayContent
                .mTransitionController
                .getCollectingTransition()
                .setReady(displayContent, true);
          }
          z3 = true;
        }
        if (z) {
          if (!shouldSleep
              && displayContent.mTransitionController.isShellTransitionsEnabled()
              && !displayContent.mTransitionController.isCollecting()) {
            if (!displayContent.getDisplayPolicy().isAwake()) {
              ...
              if (i != 0) {
                ...
                transitionController.requestStartTransition(
                    transitionController.createTransition(i), taskOccludingKeyguard, null, null);
                if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX) {
                  z2 = true;
                  displayContent.forAllRootTasks(
                      new Consumer() { // from class:
                                       // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda12
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                          RootWindowContainer.this.lambda$applySleepTokens$22(
                              shouldSleep, displayContent, (Task) obj);
                        }
                      });
                  if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX && z2) {
                    final Transition collectingTransition =
                        displayContent.mTransitionController.getCollectingTransition();
                    focusedRootTask = displayContent.getFocusedRootTask();
                    if (focusedRootTask == null) {
                      focusedRootTask.forAllActivities(
                          new Consumer() { // from class:
                                           // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda13
                            @Override // java.util.function.Consumer
                            public final void accept(Object obj) {
                              RootWindowContainer.lambda$applySleepTokens$23(
                                  Transition.this, (ActivityRecord) obj);
                            }
                          });
                    }
                  }
          ...
          if (CoreRune.FW_CUSTOM_SHELL_TRANSITION_BUG_FIX) {
            final Transition collectingTransition2 =
                displayContent.mTransitionController.getCollectingTransition();
            focusedRootTask = displayContent.getFocusedRootTask();
            if (focusedRootTask == null) {}
          }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$applySleepTokens$22(
      boolean z, DisplayContent displayContent, Task task) {
    if (z) {
      task.goToSleepIfPossible(false);
      return;
    }
    task.forAllLeafTasksAndLeafTaskFragments(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda42
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
    ...
    if (CoreRune.MW_MULTI_SPLIT_FOLDING_POLICY
        ...
        && this.mWmService.isFolded()
        && this.mService.mMultiWindowFoldController.isHoldingSplitScreen()) {
      this.mService.mMultiWindowFoldController.scheduleWakeUpInFoldingState(false);
    }
    if (task.isFocusedRootTaskOnDisplay()
        && !this.mTaskSupervisor
            .getKeyguardController()
            .isKeyguardOrAodShowing(displayContent.mDisplayId)) {
      task.resumeTopActivityUncheckedLocked(null, null);
    }
    if (!task.mReparenting
        || task.getDisplayArea() == null
        || task.getDisplayId() == task.getDisplayArea().getDisplayId()) {
      task.ensureActivitiesVisible(null, 0, false);
    }
  }

  public static /* synthetic */ void lambda$applySleepTokens$23(
      Transition transition, ActivityRecord activityRecord) {
  ...
  public final ActivityTaskManager.RootTaskInfo getRootTaskInfo(final Task task) {
    ...
    if (displayContent == null) {
      ...
      displayContent.forAllRootTasks(
          new Predicate() { // from class:
                            // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda21
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$getRootTaskInfo$24;
              lambda$getRootTaskInfo$24 =
                  RootWindowContainer.lambda$getRootTaskInfo$24(Task.this, zArr, iArr, (Task) obj);
    ...
    task.forAllLeafTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda22
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public static /* synthetic */ boolean lambda$getRootTaskInfo$24(
      Task task, boolean[] zArr, int[] iArr, Task task2) {
    if (task == task2) {
      zArr[0] = true;
      return true;
    }
  ...
  public static /* synthetic */ void lambda$getRootTaskInfo$25(
      int[] iArr, ActivityTaskManager.RootTaskInfo rootTaskInfo, Task task) {
    String str;
    int i = iArr[0];
      ...
      if (componentName2 != null) {
        ...
        str =
            task.getTopNonFinishingActivity() != null
                ? task.getTopNonFinishingActivity().packageName
                : "unknown";
      }
    }
    strArr[i] = str;
  ...
  public ArrayList getAllRootTaskInfos(int i) {
    ...
    if (i == -1) {
      forAllRootTasks(
          new Consumer() { // from class:
                           // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda29
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    displayContent.forAllRootTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda30
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
      ...
      try {
        ...
        if (this.mService.isBooted() || this.mService.isBooting()) {
          if (i != 0) {
            Slog.d(
                StartingSurfaceController.TAG,
                "onDisplayAdded, displayId=" + i + " display=" + displayContentOrCreate.mDisplay);
          }
          if (i == 2) {
  ...
  public final void startSystemDecorations(DisplayContent displayContent) {
    if (this.mWmService.mExt.mExtraDisplayPolicy.hasCoverHome(displayContent.getDisplayId())
        && this.mCurrentUser != 0) {
  ...
  public void updateDisplayImePolicyCache() {
    ...
    forAllDisplays(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$updateDisplayImePolicyCache$28(
                arrayMap, (DisplayContent) obj);
          }
        });
    this.mWmService.mDisplayImePolicyCache = Collections.unmodifiableMap(arrayMap);
  }

  public static /* synthetic */ void lambda$updateDisplayImePolicyCache$28(
      ArrayMap arrayMap, DisplayContent displayContent) {
    arrayMap.put(
        Integer.valueOf(displayContent.getDisplayId()),
        Integer.valueOf(displayContent.getImePolicy()));
  }
    ...
    if (sleepToken == null) {
      ...
      if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
        ProtoLogImpl.d(
            ...
            4,
            (String) null,
            new Object[] {String.valueOf(str), Long.valueOf(i)});
      }
      return sleepToken2;
    }
  ...
  public void removeSleepToken(SleepToken sleepToken) {
    if (!this.mSleepTokens.contains(sleepToken.mHashKey)) {
      Slog.d(
          StartingSurfaceController.TAG,
          "Remove non-exist sleep token: " + sleepToken + " from " + Debug.getCallers(6));
    }
    ...
    if (displayContent == null) {
      Slog.d(
          StartingSurfaceController.TAG,
          "Remove sleep token for non-existing display: "
              + sleepToken
              + " from "
              + Debug.getCallers(6));
      return;
    ...
    if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
      ProtoLogImpl.d(
          ...
          4,
          (String) null,
          new Object[] {String.valueOf(sleepToken.mTag), Long.valueOf(sleepToken.mDisplayId)});
    }
    ...
    if (displayContent.mAllSleepTokens.isEmpty()) {
      ...
      if ((!this.mTaskSupervisor
                  .getKeyguardController()
                  .isDisplayOccluded(displayContent.mDisplayId)
              && sleepToken.mTag.equals("keyguard"))
          || sleepToken.mTag.equals("Display-off")
          || sleepToken.mTag.equals("cover-virtual")) {
  ...
  public void addStartingWindowsForVisibleActivities() {
    ...
    forAllActivities(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda27
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$addStartingWindowsForVisibleActivities$29(
                arrayList, (ActivityRecord) obj);
          }
        });
  }

  public static /* synthetic */ void lambda$addStartingWindowsForVisibleActivities$29(
      ArrayList arrayList, ActivityRecord activityRecord) {
    Task task = activityRecord.getTask();
    if (activityRecord.isVisibleRequested()
        && activityRecord.mStartingData == null
        && !arrayList.contains(task)) {
  ...
  public void rankTaskLayers() {
    ...
    forAllLeafTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda17
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public /* synthetic */ void lambda$rankTaskLayers$31(Task task) {
    ...
    if (task.mLayerRank != i) {
      task.forAllActivities(
          new Consumer() { // from class:
                           // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda51
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  public void clearOtherAppTimeTrackers(final AppTimeTracker appTimeTracker) {
    forAllActivities(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda10
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$clearOtherAppTimeTrackers$32(
                AppTimeTracker.this, (ActivityRecord) obj);
          }
        });
  }

  public static /* synthetic */ void lambda$clearOtherAppTimeTrackers$32(
      AppTimeTracker appTimeTracker, ActivityRecord activityRecord) {
  ...
  public void scheduleDestroyAllActivities(
  ...
  public boolean putTasksToSleep(final boolean z, final boolean z2) {
    ...
    forAllRootTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda36
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public static /* synthetic */ void lambda$putTasksToSleep$33(
      boolean z, boolean[] zArr, boolean z2, Task task) {
    if (z) {
  ...
  public ActivityRecord findActivity(Intent intent, ActivityInfo activityInfo, boolean z) {
    ...
    PooledPredicate obtainPredicate =
        PooledLambda.obtainPredicate(
            new QuintPredicate() { // from class:
                                   // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda39
              public final boolean test(
                  Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                boolean matchesActivity;
                matchesActivity =
                    RootWindowContainer.matchesActivity(
                        (ActivityRecord) obj,
  ...
  public static boolean matchesActivity(
      ActivityRecord activityRecord, int i, boolean z, Intent intent, ComponentName componentName) {
  ...
  public Task getOrCreateRootTask(
      ActivityRecord activityRecord, ActivityOptions activityOptions, Task task, boolean z) {
  ...
  */
  public Task getOrCreateRootTask(
    ...
    if (activityOptions != null
        && (fromWindowContainerToken =
            ...
            != null
        && canLaunchOnDisplay(activityRecord, fromWindowContainerToken)) {
      ...
      if (activityOptions != null) {
        ...
        taskDisplayArea =
            launchTaskDisplayArea != null
                ...
                : null;
        if (taskDisplayArea == null
            && (launchDisplayId = activityOptions.getLaunchDisplayId()) != -1
            && (displayContent = getDisplayContent(launchDisplayId)) != null) {
    ...
    if (taskDisplayArea != null) {
      if (canLaunchOnDisplay(activityRecord, taskDisplayArea.getDisplayId())) {
        if (MultiWindowCoreState.MW_MULTISTAR_ENSURE_LAUNCH_SPLIT_ENABLED
            && taskDisplayArea.needToEnsureLaunchSplitRootTask(
                activityRecord, activityOptions, task2, task)) {
          return taskDisplayArea.ensureLaunchSplitRootTask(
              activityRecord,
              activityOptions,
              task,
              task2,
        ...
        return taskDisplayArea.getOrCreateRootTask(
            activityRecord, activityOptions, task, task2, launchParams, i, resolveActivityType, z);
      }
      taskDisplayArea = null;
    }
    ...
    if (rootTask != null) {
      ...
      if (taskDisplayArea != null
          && canLaunchOnDisplay(activityRecord, taskDisplayArea.mDisplayContent.mDisplayId)) {
        if (ForceLaunchWindowingModeUtils.shouldApplyForceLaunchWindowingMode(
        ...
        if (rootTask.isCompatible(i2, resolveActivityType)
            || (rootTask.mCreatedByOrganizer && i2 != 5)) {
          return rootTask;
        }
      }
      return (taskDisplayArea2 != null ? getDefaultTaskDisplayArea() : taskDisplayArea2)
          .getOrCreateRootTask(
              activityRecord,
              activityOptions,
              task,
  ...
  public final boolean canLaunchOnDisplay(ActivityRecord activityRecord, int i) {
    ...
    Slog.w(
        StartingSurfaceController.TAG,
        "Not allow to launch " + activityRecord + " on display " + i);
    return false;
  }

  public int resolveActivityType(
      ActivityRecord activityRecord, ActivityOptions activityOptions, Task task) {
  ...
  public Task getNextFocusableRootTask(Task task, boolean z) {
    ...
    for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
      DisplayContent displayContent = (DisplayContent) getChildAt(childCount);
      if (displayContent != displayArea.mDisplayContent
          && (nextFocusableRootTask =
                  displayContent.getDefaultTaskDisplayArea().getNextFocusableRootTask(task, z))
              != null) {
  ...
  public void closeSystemDialogActivities(final String str) {
    forAllActivities(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda24
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.this.lambda$closeSystemDialogActivities$34(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$closeSystemDialogActivities$34(
  ...
  public void closeSystemDialogActivities(final String str, int i) {
    ...
    if (displayContent == null) {
      Slog.e(
          StartingSurfaceController.TAG, "closeSystemDialogActivities: cannot find display #" + i);
      return;
    }
    displayContent.forAllActivities(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda32
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.this.lambda$closeSystemDialogActivities$35(
                str, (ActivityRecord) obj);
          }
        });
  }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$closeSystemDialogActivities$35(
      String str, ActivityRecord activityRecord) {
    if ((activityRecord.info.flags & 256) != 0 || shouldCloseAssistant(activityRecord, str)) {
      activityRecord.finishIfPossible(str, true);
    }
  ...
  public boolean hasVisibleWindowAboveButDoesNotOwnNotificationShade(final int i) {
    ...
    return forAllWindows(
        new ToBooleanFunction() { // from class:
                                  // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda0
          public final boolean apply(Object obj) {
            boolean lambda$hasVisibleWindowAboveButDoesNotOwnNotificationShade$36;
            lambda$hasVisibleWindowAboveButDoesNotOwnNotificationShade$36 =
                RootWindowContainer.lambda$hasVisibleWindowAboveButDoesNotOwnNotificationShade$36(
                    i, zArr, (WindowState) obj);
  ...
  public static /* synthetic */ boolean
      lambda$hasVisibleWindowAboveButDoesNotOwnNotificationShade$36(
          int i, boolean[] zArr, WindowState windowState) {
  ...
  public class FinishDisabledPackageActivitiesHelper implements Predicate {
    ...
    public boolean test(ActivityRecord activityRecord) {
      Set set;
      boolean z =
          (activityRecord.packageName.equals(this.mPackageName)
                  && ((set = this.mFilterByClasses) == null
                      || set.contains(activityRecord.mActivityComponent.getClassName())))
              || (this.mPackageName == null && activityRecord.mUserId == this.mUserId);
      boolean z2 = !activityRecord.hasProcess();
      int i = this.mUserId;
      if ((i == -1 || activityRecord.mUserId == i)
          && ((z || activityRecord.getTask() == this.mLastTask)
              && (z2 || this.mEvenPersistent || !activityRecord.app.isPersistent()))) {
        if (!this.mDoit) {
  ...
  public boolean finishDisabledPackageActivities(
      String str, Set set, boolean z, boolean z2, int i, boolean z3) {
  ...
  public void updateActivityApplicationInfo(final ApplicationInfo applicationInfo) {
    ...
    forAllActivities(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda3
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$updateActivityApplicationInfo$37(
                userId, str, applicationInfo, (ActivityRecord) obj);
          }
        });
  }

  public static /* synthetic */ void lambda$updateActivityApplicationInfo$37(
      int i, String str, ApplicationInfo applicationInfo, ActivityRecord activityRecord) {
  ...
  public void finishVoiceTask(IVoiceInteractionSession iVoiceInteractionSession) {
    ...
    forAllLeafTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda11
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public ActivityRecord topRunningActivity() {
    for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
      ActivityRecord activityRecord =
          ((DisplayContent) getChildAt(childCount)).topRunningActivity();
      if (activityRecord != null) {
        return activityRecord;
      }
    }
  ...
  public boolean allResumedActivitiesIdle() {
    ...
    for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
      ...
      if (!displayContent.isSleeping()
          && (focusedRootTask = displayContent.getFocusedRootTask()) != null
          && focusedRootTask.hasActivity()) {
        ...
        if (topResumedActivity == null || !topResumedActivity.idle) {
          if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
            ProtoLogImpl.d(
                ...
                (String) null,
                new Object[] {
                  Long.valueOf(focusedRootTask.getRootTaskId()), String.valueOf(topResumedActivity)
                });
          }
          return false;
        }
  ...
  public boolean allResumedActivitiesVisible() {
    ...
    if (forAllRootTasks(
        new Predicate() { // from class:
                          // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda23
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$allResumedActivitiesVisible$39;
            lambda$allResumedActivitiesVisible$39 =
                RootWindowContainer.lambda$allResumedActivitiesVisible$39(zArr, (Task) obj);
  ...
  public static /* synthetic */ boolean lambda$allResumedActivitiesVisible$39(
      boolean[] zArr, Task task) {
  ...
  public boolean allPausedActivitiesComplete() {
    ...
    if (forAllLeafTasks(
        new Predicate() { // from class:
                          // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda26
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$allPausedActivitiesComplete$40;
            lambda$allPausedActivitiesComplete$40 =
                RootWindowContainer.lambda$allPausedActivitiesComplete$40(zArr, (Task) obj);
    ...
    if (topPausingActivity != null
      ...
      if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
        ProtoLogImpl.d(
            ...
            (String) null,
            new Object[] {
              String.valueOf(topPausingActivity), String.valueOf(topPausingActivity.getState())
            });
      }
  ...
  public void lockAllProfileTasks(final int i) {
    forAllLeafTasks(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public /* synthetic */ void lambda$lockAllProfileTasks$42(final int i, Task task) {
    ...
    if ((activityRecord == null
            ...
            || !"android.app.action.CONFIRM_DEVICE_CREDENTIAL_WITH_USER"
                .equals(activityRecord.intent.getAction())
            || !activityRecord.packageName.equals(
                this.mService.getSysUiServiceComponentLocked().getPackageName()))
        && task.getActivity(
                new Predicate() { // from class:
                                  // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda50
                  @Override // java.util.function.Predicate
                  public final boolean test(Object obj) {
                    boolean lambda$lockAllProfileTasks$41;
                    lambda$lockAllProfileTasks$41 =
                        RootWindowContainer.lambda$lockAllProfileTasks$41(i, (ActivityRecord) obj);
      ...
      this.mService
          ...
          .notifyTaskProfileLocked(task.getTaskInfo(), i);
    }
  }

  public static /* synthetic */ boolean lambda$lockAllProfileTasks$41(
  ...
  public Task anyTaskForId(int i, int i2, ActivityOptions activityOptions, boolean z) {
    ...
    if (i2 != 2 && activityOptions != null) {
      throw new IllegalArgumentException(
          "Should not specify activity options for non-restore lookup");
    }
    PooledPredicate obtainPredicate =
        PooledLambda.obtainPredicate(
            new AppTransition$$ExternalSyntheticLambda2(),
    ...
    if (task2 != null) {
      if (activityOptions != null
          && (orCreateRootTask = getOrCreateRootTask(null, activityOptions, task2, z)) != null
          && task2.getRootTask() != orCreateRootTask
          && task2.getParent() != orCreateRootTask) {
  ...
  public void getRunningTasks(int i, List list, int i2, int i3, ArraySet arraySet, int i4) {
    ...
    this.mTaskSupervisor
        .getRunningTasks()
        .getTasks(i, list, i2, this.mService.getRecentTasks(), rootWindowContainer, i3, arraySet);
  }
  ...
  public void startPowerModeLaunchIfNeeded(boolean z, final ActivityRecord activityRecord) {
    ...
    if (!z && activityRecord != null && activityRecord.app != null) {
      ...
      forAllTaskDisplayAreas(
          new Consumer() { // from class:
                           // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda16
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              RootWindowContainer.lambda$startPowerModeLaunchIfNeeded$43(
                  zArr, zArr2, activityRecord, (TaskDisplayArea) obj);
            }
          });
      if (!zArr[0] && !zArr2[0]) {
        return;
    ...
    if ((activityRecord != null
            ? activityRecord.isKeyguardLocked()
            : this.mDefaultDisplay.isKeyguardLocked())
        && activityRecord != null
        && !activityRecord.isLaunchSourceType(3)
        && ((options = activityRecord.getOptions()) == null
            || options.getSourceInfo() == null
            || options.getSourceInfo().type != 3)) {
      i = 5;
    }
    this.mService.startLaunchPowerMode(i);
  }

  public static /* synthetic */ void lambda$startPowerModeLaunchIfNeeded$43(
      boolean[] zArr,
      boolean[] zArr2,
      ActivityRecord activityRecord,
      TaskDisplayArea taskDisplayArea) {
    ...
    WindowProcessController windowProcessController =
        focusedActivity == null ? null : focusedActivity.app;
  ...
  public int getTaskToShowPermissionDialogOn(final String str, final int i) {
    final PermissionPolicyInternal permissionPolicyInternal =
        this.mService.getPermissionPolicyInternal();
    ...
    forAllLeafTaskFragments(
        new Predicate() { // from class:
                          // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda7
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getTaskToShowPermissionDialogOn$45;
            lambda$getTaskToShowPermissionDialogOn$45 =
                RootWindowContainer.lambda$getTaskToShowPermissionDialogOn$45(
                    PermissionPolicyInternal.this, i, str, iArr, (TaskFragment) obj);
  ...
  public static /* synthetic */ boolean lambda$getTaskToShowPermissionDialogOn$45(
      final PermissionPolicyInternal permissionPolicyInternal,
      int i,
      String str,
      int[] iArr,
    ...
    ActivityRecord activity =
        taskFragment.getActivity(
            new Predicate() { // from class:
                              // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda49
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$getTaskToShowPermissionDialogOn$44;
                lambda$getTaskToShowPermissionDialogOn$44 =
                    RootWindowContainer.lambda$getTaskToShowPermissionDialogOn$44(
                        PermissionPolicyInternal.this, (ActivityRecord) obj);
                return lambda$getTaskToShowPermissionDialogOn$44;
              }
            });
    if (activity == null
        || !activity.isUid(i)
        || !Objects.equals(str, activity.packageName)
        || !permissionPolicyInternal.shouldShowNotificationDialogForTask(
            activity.getTask().getTaskInfo(),
            str,
  ...
  public static /* synthetic */ boolean lambda$getTaskToShowPermissionDialogOn$44(
      PermissionPolicyInternal permissionPolicyInternal, ActivityRecord activityRecord) {
    return activityRecord.canBeTopRunning()
        && activityRecord.isVisibleRequested()
        && !permissionPolicyInternal.isIntentToPermissionDialog(activityRecord.intent);
  }
  ...
  public void positionChildAt(int i, DisplayContent displayContent, boolean z) {
    ...
    if (i == Integer.MAX_VALUE) {
      if (this.mWmService.mExt.mExtraDisplayPolicy.shouldNotTopDisplay(displayId)) {
        Slog.i(
            StartingSurfaceController.TAG,
            "positionChildAt: can't gain focus display=" + displayContent);
        return;
      }
    } else if (i == Integer.MIN_VALUE
        && (otherDisplayId = this.mWmService.mExt.mExtraDisplayPolicy.getOtherDisplayId(displayId))
            != -1
        && (displayContent2 = this.mWmService.mRoot.getDisplayContent(otherDisplayId)) != null) {
  ...
  public ArrayList getDumpActivities(final String str, final boolean z, boolean z2, final int i) {
    ...
    forAllLeafTasks(
        new Predicate() { // from class:
                          // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda20
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getDumpActivities$46;
            lambda$getDumpActivities$46 =
                RootWindowContainer.lambda$getDumpActivities$46(
                    recentsComponentUid, z, arrayList, str, i, (Task) obj);
  ...
  public static /* synthetic */ boolean lambda$getDumpActivities$46(
      int i, boolean z, ArrayList arrayList, String str, int i2, Task task) {
  ...
  public boolean dumpActivities(
    ...
    for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
      ...
      if (i == -1 || displayContent.mDisplayId == i) {
        ...
        displayContent.forAllRootTasks(
            new Consumer() { // from class:
                             // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda43
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                RootWindowContainer.lambda$dumpActivities$47(
                    zArr2, printWriter, fileDescriptor, z, z2, str, zArr, (Task) obj);
              }
            });
        displayContent.forAllTaskDisplayAreas(
            new Consumer() { // from class:
                             // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda44
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                RootWindowContainer.lambda$dumpActivities$49(
                    zArr, printWriter, str, zArr2, (TaskDisplayArea) obj);
              }
            });
      }
    }
    boolean dumpHistoryList =
        zArr[0]
            | ActivityTaskSupervisor.dumpHistoryList(
                fileDescriptor,
                printWriter,
                this.mTaskSupervisor.mFinishingActivities,
                "  ",
                "Fin",
                false,
                !z,
                ...
                new Runnable() { // from class:
                                 // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda45
                  @Override // java.lang.Runnable
    ...
    boolean dumpHistoryList2 =
        ActivityTaskSupervisor.dumpHistoryList(
                fileDescriptor,
                printWriter,
                this.mTaskSupervisor.mStoppingActivities,
                "  ",
                "Stop",
                false,
                !z,
                ...
                true,
                new Runnable() { // from class:
                                 // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda46
                  @Override // java.lang.Runnable
                  public final void run() {
  ...
  public static /* synthetic */ void lambda$dumpActivities$47(
      boolean[] zArr,
      PrintWriter printWriter,
  ...
  public static /* synthetic */ void lambda$dumpActivities$49(
      boolean[] zArr,
      final PrintWriter printWriter,
      String str,
      boolean[] zArr2,
    ...
    zArr[0] =
        ActivityTaskSupervisor.printThisActivity(
                ...
                "    Resumed: ",
                new Runnable() { // from class:
                                 // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda53
                  @Override // java.lang.Runnable
                  public final void run() {
                    printWriter.println(
  ...
  public ActivityRecord findActivityLockedByPackage(final int i, final String str) {
    final AtomicReference atomicReference = new AtomicReference();
    for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
      ((DisplayContent) getChildAt(childCount))
          .forAllRootTasks(
              new Consumer() { // from class:
                               // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda2
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  RootWindowContainer.lambda$findActivityLockedByPackage$53(
                      str, i, atomicReference, (Task) obj);
                }
              });
    }
  ...
  public static /* synthetic */ void lambda$findActivityLockedByPackage$53(
      final String str, final int i, final AtomicReference atomicReference, Task task) {
    task.forAllActivities(
        new Consumer() { // from class:
                         // com.android.server.wm.RootWindowContainer$$ExternalSyntheticLambda41
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            RootWindowContainer.lambda$findActivityLockedByPackage$52(
                str, i, atomicReference, (ActivityRecord) obj);
          }
        });
  }

  public static /* synthetic */ void lambda$findActivityLockedByPackage$52(
      String str, int i, AtomicReference atomicReference, ActivityRecord activityRecord) {
    if (activityRecord.packageName.equals(str)
        && activityRecord.mUserId == i
        && !activityRecord.isState(ActivityRecord.State.FINISHING)) {
  ...
  public class AttachApplicationHelper implements Consumer, Predicate {
    ...
    public boolean process(WindowProcessController windowProcessController) {
      ...
      for (int childCount = RootWindowContainer.this.getChildCount() - 1;
          childCount >= 0;
          childCount--) {
        ((DisplayContent) RootWindowContainer.this.getChildAt(childCount))
            .forAllRootTasks((Consumer) this);
    ...
    public boolean test(ActivityRecord activityRecord) {
      if (!activityRecord.finishing
          && activityRecord.showToCurrentUser()
          && ((activityRecord.visibleIgnoringKeyguard
                  || (CoreRune.SYSFW_APP_PREL && activityRecord.mIsPrelMode))
              && activityRecord.app == null)) {
        WindowProcessController windowProcessController = this.mApp;
        if (windowProcessController.mUid == activityRecord.info.applicationInfo.uid
            && windowProcessController.mName.equals(activityRecord.processName)) {
          try {
            if (RootWindowContainer.this.mTaskSupervisor.realStartActivityLocked(
                activityRecord,
                this.mApp,
                this.mTop == activityRecord
                    && activityRecord.getTask().canBeResumed(activityRecord),
                true)) {
            ...
            Slog.w(
                StartingSurfaceController.TAG,
                "Exception in new application when starting activity " + this.mTop,
                e);
