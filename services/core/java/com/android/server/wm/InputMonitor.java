...
public final class InputMonitor {
  ...
  public static boolean isTrustedOverlay(int i) {
    return i == 2039 || i == 2011 || i == 2012 || i == 2027 || i == 2000 || i == 2040 || i == 2019
        || i == 2024 || i == 2015 || i == 2034 || i == 2032 || i == 2022 || i == 2031 || i == 2041;
  }
    ...
    public void run() {
      ...
      synchronized (windowManagerGlobalLock) {
        try {
          ...
          InputMonitor.this.mUpdateInputForAllWindowsConsumer.updateInputWindows(
              InputMonitor.this.mService.mDragDropController.dragDropActiveLocked());
          WindowManagerService.resetPriorityAfterLockedSection();
        } catch (Throwable th) {
          WindowManagerService.resetPriorityAfterLockedSection();
          throw th;
  ...
  public void layoutInputConsumers(int i, int i2, boolean z) {
    ...
    try {
      ...
      for (int size = this.mInputConsumers.size() - 1; size >= 0; size--) {
        ((InputConsumerImpl) this.mInputConsumers.valueAt(size))
            .layout(this.mInputTransaction, i, i2);
      }
    } finally {
      Trace.traceEnd(32L);
    }
  ...
  public void createInputConsumer(
    ...
    if (this.mInputConsumers.containsKey(str)) {
      throw new IllegalStateException(
          "Existing input consumer found with name: " + str + ", display: " + this.mDisplayId);
    }
    inputConsumerImpl =
        new InputConsumerImpl(
            this.mService, iBinder, str, inputChannel, i, userHandle, this.mDisplayId);
    str.hashCode();
    switch (str) {
      ...
      default:
        throw new IllegalArgumentException(
            "Illegal input consumer : " + str + ", display: " + this.mDisplayId);
    }
    addInputConsumer(str, inputConsumerImpl);
  }

  public void populateInputWindowHandle(
      InputWindowHandleWrapper inputWindowHandleWrapper, WindowState windowState) {
    TaskFragment taskFragment;
    ActivityRecord activityRecord = windowState.mActivityRecord;
    SurfaceControl surfaceControl = null;
    inputWindowHandleWrapper.setInputApplicationHandle(
        activityRecord != null ? activityRecord.getInputApplicationHandle(false) : null);
    inputWindowHandleWrapper.setToken(windowState.mInputChannelToken);
    inputWindowHandleWrapper.setDispatchingTimeoutMillis(
        windowState.getInputDispatchingTimeoutMillis());
    ...
    inputWindowHandleWrapper.setInputConfigMasked(
        InputConfigAdapter.getInputConfigFromWindowParams(
            layoutParams2.type, i, layoutParams2.inputFeatures),
        InputConfigAdapter.getMask());
    inputWindowHandleWrapper.setFocusable(
        windowState.canReceiveKeys()
            && (this.mDisplayContent.hasOwnFocus() || this.mDisplayContent.isOnTop()));
    inputWindowHandleWrapper.setHasWallpaper(
        this.mDisplayContent.mWallpaperController.isWallpaperTarget(windowState)
            && (!this.mService.mPolicy.isKeyguardShowing()
                || (CoreRune.FW_ALLOW_TOUCH_TO_KEYGUARD_WALLPAPER
                    && this.mDisplayContent.mWallpaperController.getTopVisibleWallpaper() != null
                    && this.mDisplayContent
                        .mWallpaperController
                        .getTopVisibleWallpaper()
                        .getKeyguardWallpaperTouchAllowed()))
            && windowState.mAttrs.areWallpaperTouchEventsEnabled());
    ...
    if (task != null) {
      if (task.isOrganized() && task.getWindowingMode() != 1 && !task.inFreeformWindowingMode()) {
        ...
        if (windowState.mAttrs.isModal()
            && (taskFragment = windowState.getTaskFragment()) != null) {
  ...
  public void setInputFocusLw(WindowState windowState, boolean z) {
    if (ProtoLogCache.WM_DEBUG_FOCUS_LIGHT_enabled) {
      ProtoLogImpl.v(
          ...
          4,
          (String) null,
          new Object[] {String.valueOf(windowState), Long.valueOf(this.mDisplayId)});
    }
  ...
  public final void updateInputFocusRequest(InputConsumerImpl inputConsumerImpl) {
    ...
    if (inputConsumerImpl != null && windowState != null) {
      ...
      if ((recentsAnimationController != null
              && recentsAnimationController.shouldApplyInputConsumer(windowState.mActivityRecord))
          || (getWeak(this.mActiveRecentsActivity) != null
              && windowState.inTransition()
        ...
        if (!this.mDisplayContent.isImeAttachedToApp()) {
          ...
          ActivityRecord activityRecord =
              this.mDisplayContent.getImeInputTarget() != null
                  ? this.mDisplayContent.getImeInputTarget().getActivityRecord()
                  : null;
          if (activityRecord != null) {
            this.mDisplayContent.removeImeSurfaceImmediately();
            if (activityRecord.getTask() != null) {
              this.mDisplayContent.mAtmService.takeTaskSnapshot(
                  activityRecord.getTask().mTaskId, true);
              return;
            }
            return;
          }
    ...
    if (inputConsumerImpl == null
        || (inputWindowHandle = inputConsumerImpl.mWindowHandle) == null
        || this.mInputFocus != inputWindowHandle.token) {
      ...
      if (activityRecord2 != null && this.mInputFocus != null) {
        if (ProtoLogCache.WM_DEBUG_FOCUS_LIGHT_enabled) {
          ProtoLogImpl.v(
              ...
              0,
              (String) null,
              new Object[] {String.valueOf(activityRecord2.getName())});
        }
        EventLog.writeEvent(
            62001, "Requesting to set focus to null window", "reason=UpdateInputWindows");
  ...
  public void setFocusedAppLw(ActivityRecord activityRecord) {
    this.mService.mInputManager.setFocusedApplication(
        this.mDisplayId,
  ...
  public final class UpdateInputForAllWindowsConsumer implements Consumer {
    ...
    public final void updateInputWindows(boolean z) {
      ...
      InputConsumerImpl inputConsumer =
          InputMonitor.this.getInputConsumer("recents_animation_input_consumer");
      ...
      ActivityRecord activityRecord =
          (ActivityRecord) InputMonitor.getWeak(InputMonitor.this.mActiveRecentsActivity);
      if (this.mAddRecentsAnimationInputConsumerHandle
          && activityRecord != null
          && activityRecord.getSurfaceControl() != null) {
        WindowContainer windowContainer =
            (WindowContainer) InputMonitor.getWeak(InputMonitor.this.mActiveRecentsLayerRef);
        ...
        if (windowContainer.getSurfaceControl() != null) {
          ...
          this.mRecentsAnimationInputConsumer.show(
              InputMonitor.this.mInputTransaction, windowContainer);
      ...
      if (!InputMonitor.this.mUpdateInputWindowsImmediately) {
        InputMonitor.this
            ...
            .merge(InputMonitor.this.mInputTransaction);
    ...
    public void accept(WindowState windowState) {
      ...
      if (windowState.mInputChannelToken == null
          ...
          || !windowState.canReceiveTouchInput()) {
        if (windowState.mWinAnimator.hasSurface()) {
          ...
          InputMonitor.setInputWindowInfoIfNeeded(
              InputMonitor.this.mInputTransaction,
      ...
      RecentsAnimationController recentsAnimationController =
          InputMonitor.this.mService.getRecentsAnimationController();
      boolean z =
          recentsAnimationController != null
              && recentsAnimationController.shouldApplyInputConsumer(windowState.mActivityRecord);
      if (this.mAddRecentsAnimationInputConsumerHandle
          && z
          && recentsAnimationController.updateInputConsumerForApp(
              this.mRecentsAnimationInputConsumer.mWindowHandle)
          && (targetAppDisplayArea = recentsAnimationController.getTargetAppDisplayArea())
              != null) {
        this.mRecentsAnimationInputConsumer.reparent(
            InputMonitor.this.mInputTransaction, targetAppDisplayArea);
      ...
      if (windowState.inPinnedWindowingMode() && this.mAddPipInputConsumerHandle) {
        ...
        this.mPipInputConsumer.mWindowHandle.replaceTouchableRegionWithCrop(
      ...
      if (this.mAddWallpaperInputConsumerHandle
          && windowState.mAttrs.type == 2013
          && windowState.isVisible()) {
        this.mWallpaperInputConsumer.mWindowHandle.replaceTouchableRegionWithCrop(
            (SurfaceControl) null);
      ...
      if (this.mInDrag
          ...
          && (windowState.getDisplayContent().isDefaultDisplay
              || windowState.getDisplayContent().isDexMode())) {
        InputMonitor.this.mService.mDragDropController.sendDragStartedIfNeededLocked(
            windowState, true);
      }
      InputMonitor.this.mService.mKeyInterceptionInfoForToken.put(
          windowState.mInputChannelToken, windowState.getKeyInterceptionInfo());
      if (windowState.mWinAnimator.hasSurface()) {
  ...
  public static void populateOverlayInputInfo(
      InputWindowHandleWrapper inputWindowHandleWrapper, WindowState windowState) {
  ...
  public static void populateOverlayInputInfo(InputWindowHandleWrapper inputWindowHandleWrapper) {
    ...
    inputWindowHandleWrapper.setInputConfigMasked(
        InputConfigAdapter.getInputConfigFromWindowParams(2, 16, 1), InputConfigAdapter.getMask());
  ...
  public static void setTrustedOverlayInputInfo(
      SurfaceControl surfaceControl, SurfaceControl.Transaction transaction, int i, String str) {
    InputWindowHandleWrapper inputWindowHandleWrapper =
        new InputWindowHandleWrapper(new InputWindowHandle((InputApplicationHandle) null, i));
