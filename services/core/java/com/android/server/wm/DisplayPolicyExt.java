...
public class DisplayPolicyExt {
    ...
    public void onConfigurationChanged() {
        ...
        this.mNavigationMode = currentUserResources.getInteger(R.integer.config_notificationsBatteryFullARGB);
        this.mNavBarImeBtnAllRotationsAllowed = CoreRune.IS_TABLET_DEVICE || currentUserResources.getBoolean(R.bool.config_letterboxIsPolicyForIgnoringRequestedOrientationEnabled);
    }
