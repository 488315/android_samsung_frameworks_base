...
public class WindowManagerShellCommand extends ShellCommand {
  ...
  public int onCommand(String str) {
    ...
    switch (c) {
      ...
      case 6:
        ...
        if (onShellCommand != 0) {
          outPrintWriter.println(
              "Not handled, please use `adb shell dumpsys activity service SystemUIService WMShell`"
      ...
      case 23:
        ...
        this.mInternal.mExt.mScreenshotController.mWmScreenshotShellCommand.exec(
            strArr, outPrintWriter);
        return 0;
      case 24:
  ...
  public final int runSetBlurDisabled(PrintWriter printWriter) {
    ...
    if (nextArg == null) {
      printWriter.println(
          "Blur supported on device: " + CrossWindowBlurListeners.CROSS_WINDOW_BLUR_SUPPORTED);
  ...
  public final int runSandboxDisplayApis(PrintWriter printWriter) {
    ...
    switch (c) {
      ...
      default:
        getErrPrintWriter()
            .println("Error: expecting true, 1, false, 0, but we get " + nextArgRequired);
        return -1;
    }
  ...
  public final int runFixedToUserRotation(PrintWriter printWriter) {
    ...
    switch (z) {
      ...
      default:
        getErrPrintWriter()
            .println("Error: expecting enabled, disabled or default, but we get " + nextArg);
        return -1;
    }
  ...
  public final int runGetIgnoreOrientationRequest(PrintWriter printWriter) {
    ...
    printWriter.println(
        "ignoreOrientationRequest "
            + this.mInternal.getIgnoreOrientationRequest(parseInt)
            + " for displayId="
            + parseInt);
    return 0;
  }

  public final void dumpLocalWindowAsync(
      final IWindow iWindow, final ParcelFileDescriptor parcelFileDescriptor) {
    IoThread.getExecutor()
        .execute(
            new Runnable() { // from class:
                             // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda10
              @Override // java.lang.Runnable
              public final void run() {
                WindowManagerShellCommand.this.lambda$dumpLocalWindowAsync$0(
                    iWindow, parcelFileDescriptor);
              }
            });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$dumpLocalWindowAsync$0(
      IWindow iWindow, ParcelFileDescriptor parcelFileDescriptor) {
  ...
  public final int runDumpVisibleWindowViews(PrintWriter printWriter) {
    if (!this.mInternal.checkCallingPermission(
        "android.permission.DUMP", "runDumpVisibleWindowViews()")) {
        ...
        synchronized (windowManagerGlobalLock) {
          try {
            ...
            final int recentsComponentUid =
                recentTasks != null ? recentTasks.getRecentsComponentUid() : -1;
            this.mInternal.mRoot.forAllWindows(
                new Consumer() { // from class:
                                 // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda0
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
                    WindowManagerShellCommand.this.lambda$runDumpVisibleWindowViews$1(
                        recentsComponentUid, arrayList, (WindowState) obj);
                  }
                },
                false);
          } catch (Throwable th) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$runDumpVisibleWindowViews$1(
      int i, ArrayList arrayList, WindowState windowState) {
  ...
  public final int runSetLetterboxBackgroundType(PrintWriter printWriter) {
    ...
    try {
      ...
      if (c == 0) {
        ...
        getErrPrintWriter()
            .println(
                "Error: 'solid_color', 'app_color_background' or 'wallpaper' should be provided as"
                    + " an argument");
        return -1;
      }
      WindowManagerGlobalLock windowManagerGlobalLock = this.mInternal.mGlobalLock;
      ...
      getErrPrintWriter()
          .println(
              "Error: 'solid_color', 'app_color_background' or 'wallpaper' should be provided as an"
                  + " argument"
                  + e);
      return -1;
    }
    ...
    try {
      int identifier =
          this.mInternal
              .mContext
              .getResources()
              .getIdentifier(getNextArgRequired(), "color", "com.android.internal");
      WindowManagerGlobalLock windowManagerGlobalLock = this.mInternal.mGlobalLock;
      WindowManagerService.boostPriorityForLockedSection();
      synchronized (windowManagerGlobalLock) {
        try {
      ...
      getErrPrintWriter()
          .println(
              "Error: color in '@android:color/resource_name' format should be provided as an"
                  + " argument "
                  + e);
      return -1;
    }
  ...
  public final int runSetLetterboxBackgroundColor(PrintWriter printWriter) {
    try {
      ...
      getErrPrintWriter()
          .println("Error: color in #RRGGBB format should be provided as an argument " + e);
      return -1;
    }
  }
  ...
  */
  public final int runSetLetterboxDefaultPositionForHorizontalReachability(
    ...
    try {
      ...
      if (hashCode == -1364013995) {
        ...
        if (hashCode == 108511772 && nextArgRequired.equals("right")) {
          ...
          if (c != 0) {
            ...
            getErrPrintWriter()
                .println("Error: 'left', 'center' or 'right' are expected as an argument");
            return -1;
          }
          windowManagerGlobalLock = this.mInternal.mGlobalLock;
          WindowManagerService.boostPriorityForLockedSection();
      ...
      getErrPrintWriter()
          .println("Error: 'left', 'center' or 'right' are expected as an argument" + e);
      return -1;
    }
    getErrPrintWriter()
        .println("Error: 'left', 'center' or 'right' are expected as an argument" + e);
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final int runSetLetterboxDefaultPositionForVerticalReachability(PrintWriter printWriter) {
    char c;
    WindowManagerGlobalLock windowManagerGlobalLock;
    try {
      String nextArgRequired = getNextArgRequired();
      ...
      if (hashCode == -1383228885) {
        ...
        if (hashCode == 115029 && nextArgRequired.equals("top")) {
          ...
          if (c != 0) {
            ...
            getErrPrintWriter()
                .println("Error: 'top', 'center' or 'bottom' are expected as an argument");
            return -1;
          }
          windowManagerGlobalLock = this.mInternal.mGlobalLock;
          WindowManagerService.boostPriorityForLockedSection();
      ...
      getErrPrintWriter()
          .println("Error: 'top', 'center' or 'bottom' are expected as an argument" + e);
      return -1;
    }
    getErrPrintWriter()
        .println("Error: 'top', 'center' or 'bottom' are expected as an argument" + e);
  ...
  */
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final int runSetLetterboxStyle(PrintWriter printWriter) {
    if (peekNextArg() == null) {
            ...
            switch (c) {
              ...
              case 1:
                ...
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda4
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        LetterboxConfiguration.this.setIsEducationEnabled(
              ...
              case 4:
                ...
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda6
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        LetterboxConfiguration.this
              ...
              case 5:
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda8
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
              ...
              case '\t':
                ...
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda5
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        LetterboxConfiguration.this
              ...
              case 11:
                ...
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda1
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        LetterboxConfiguration.this.setIsHorizontalReachabilityEnabled(
                            ((Boolean) obj).booleanValue());
                      }
                    });
                break;
              case '\f':
                ...
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda2
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        LetterboxConfiguration.this.setIsVerticalReachabilityEnabled(
                            ((Boolean) obj).booleanValue());
                      }
                    });
                break;
              ...
              case 14:
                ...
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda7
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        LetterboxConfiguration.this.setTranslucentLetterboxingOverrideEnabled(
                            ((Boolean) obj).booleanValue());
                      }
                    });
                break;
              ...
              case 16:
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda9
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
              ...
              case 20:
                ...
                runSetBooleanFlag(
                    printWriter,
                    new Consumer() { // from class:
                                     // com.android.server.wm.WindowManagerShellCommand$$ExternalSyntheticLambda3
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        LetterboxConfiguration.this.setIsAutomaticReachabilityInBookModeEnabled(
                            ((Boolean) obj).booleanValue());
                      }
                    });
                break;
              default:
                getErrPrintWriter()
                    .println("Error: Unrecognized letterbox style option: " + nextArg);
                return -1;
            }
          }
          c = 65535;
  ...
  public final int runSetSupportsNonResizableMultiWindow() {
    ...
    if (!nextArg.equals("-1") && !nextArg.equals("0") && !nextArg.equals("1")) {
      getErrPrintWriter()
          .println(
              "Error: a config value of [-1, 0, 1] must be provided as an argument for"
  ...
  public final int runResetMultiWindowConfig() {
    int integer =
        this.mInternal.mContext.getResources().getInteger(R.integer.config_undockedHdmiRotation);
    int integer2 =
        this.mInternal
            .mContext
            .getResources()
  ...
  public final int runGetLetterboxStyle(PrintWriter printWriter) {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        printWriter.println(
            "Corner radius: " + this.mLetterboxConfiguration.getLetterboxActivityCornersRadius());
        printWriter.println(
            "Horizontal position multiplier: "
                + this.mLetterboxConfiguration.getLetterboxHorizontalPositionMultiplier(false));
        printWriter.println(
            "Vertical position multiplier: "
                + this.mLetterboxConfiguration.getLetterboxVerticalPositionMultiplier(false));
        printWriter.println(
            "Horizontal position multiplier (book mode): "
                + this.mLetterboxConfiguration.getLetterboxHorizontalPositionMultiplier(true));
        printWriter.println(
            "Vertical position multiplier (tabletop mode): "
                + this.mLetterboxConfiguration.getLetterboxVerticalPositionMultiplier(true));
        printWriter.println(
            "Aspect ratio: "
        ...
        printWriter.println(
            "Is horizontal reachability enabled: "
                + this.mLetterboxConfiguration.getIsHorizontalReachabilityEnabled());
        printWriter.println(
            "Is vertical reachability enabled: "
                + this.mLetterboxConfiguration.getIsVerticalReachabilityEnabled());
        printWriter.println(
        ...
        printWriter.println(
            "Default position for horizontal reachability: "
                + LetterboxConfiguration.letterboxHorizontalReachabilityPositionToString(
                    this.mLetterboxConfiguration.getDefaultPositionForHorizontalReachability()));
        printWriter.println(
            "Default position for vertical reachability: "
                + LetterboxConfiguration.letterboxVerticalReachabilityPositionToString(
                    this.mLetterboxConfiguration.getDefaultPositionForVerticalReachability()));
        printWriter.println(
            ...
            "Current position for vertical reachability:"
                + LetterboxConfiguration.letterboxVerticalReachabilityPositionToString(
                    this.mLetterboxConfiguration.getLetterboxPositionForVerticalReachability(
                        false)));
        printWriter.println(
            "Is education enabled: " + this.mLetterboxConfiguration.getIsEducationEnabled());
        printWriter.println(
        ...
        printWriter.println(
            "    Is activity \"refresh\" in camera compatibility treatment enabled: "
                + this.mLetterboxConfiguration.isCameraCompatRefreshEnabled());
        printWriter.println(
            "    Refresh using \"stopped -> resumed\" cycle: "
                + this.mLetterboxConfiguration.isCameraCompatRefreshCycleThroughStopEnabled());
        printWriter.println(
            "Background type: "
        ...
        printWriter.println(
            "    Background color: "
                + Integer.toHexString(
                    this.mLetterboxConfiguration.getLetterboxBackgroundColor().toArgb()));
        printWriter.println(
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final int runDisplaySizeDensity(PrintWriter printWriter) {
    int parseDimension;
    int parseDimension2;
    String nextArg;
    int i;
    String nextArg2 = getNextArg();
    int displayId = getDisplayId(nextArg2);
    if (nextArg2 == null) {
      printInitialDisplaySize(printWriter, displayId);
    } else if ("-d".equals(nextArg2)) {
      printInitialDisplaySize(printWriter, displayId);
    } else {
      if (!"reset".equals(nextArg2)) {
        int indexOf = nextArg2.indexOf(120);
        if (indexOf <= 0 || indexOf >= nextArg2.length() - 1) {
          getErrPrintWriter().println("Error: bad size " + nextArg2);
          return -1;
        }
        String substring = nextArg2.substring(0, indexOf);
        String substring2 = nextArg2.substring(indexOf + 1);
        try {
          ...
          if (nextArg2 != null) {
            if (parseDimension < 0) {}
            this.mInterface.clearForcedDisplaySizeDensity(displayId);
          }
          return 0;
        } catch (NumberFormatException e) {
          getErrPrintWriter().println("Error: bad number " + e);
      ...
      parseDimension2 = -1;
      parseDimension = parseDimension2;
      nextArg = getNextArg();
      if (nextArg != null && !"reset".equals(nextArg2)) {
        printInitialDisplayDensity(printWriter, displayId);
        i = 0;
      } else if (!"reset".equals(nextArg) || nextArg == null) {
        i = -1;
      } else {
        try {
      ...
      if (nextArg2 != null && (nextArg != null || "reset".equals(nextArg2))) {
        try {
          if (parseDimension < 0 && parseDimension2 >= 0 && i > 0) {
            this.mInterface.setForcedDisplaySizeDensityWithInfo(
                new MultiResolutionChangeRequestInfo.Builder(0)
                    .setWidth(parseDimension)
                    .setHeight(parseDimension2)
                    .setDensity(i)
                    .setSaveToSettings(false)
                    .setForcedHideCutout(-1)
                    .build());
          } else {
            this.mInterface.clearForcedDisplaySizeDensity(displayId);
          }
