...
public class BoundsCompatAlignmentController {
  ...
  public abstract class LazyHolder {
    public static final BoundsCompatAlignmentController sController =
        new BoundsCompatAlignmentController();
  }
  ...
  public static void scheduleRecomputeConfigurationLocked() {
    ...
    if (activityTaskManagerService == null
        || activityTaskManagerService.f1734mH.hasCallbacks(controller.mRecomputeConfiguration)) {
      return;
    }
  ...
  */
  ...
  public static boolean shouldPlayMoveAnimation(WindowState windowState) {
    ...
    return getController().mAnimationEnabled
        && (activityRecord = windowState.mActivityRecord) != null
        && activityRecord.mCompatRecord.mShouldPlayMoveAnimation;
  }

  public BoundsCompatAlignmentController() {
    this.mGlobalAlignment = BoundsCompatUtils.get().getDefaultDisplayAlignment();
    this.mRecomputeConfiguration =
        new Runnable() { // from class:
                         // com.android.server.wm.BoundsCompatAlignmentController$$ExternalSyntheticLambda0
  ...
  public final void recomputeConfiguration() {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        this.mAtmService.mRootWindowContainer.forAllDisplays(
            new Consumer() { // from class:
                             // com.android.server.wm.BoundsCompatAlignmentController$$ExternalSyntheticLambda1
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                BoundsCompatAlignmentController.this.lambda$recomputeConfiguration$1(
                    rect, arrayList, (DisplayContent) obj);
              }
            });
  ...
  public /* synthetic */ void lambda$recomputeConfiguration$1(
      final Rect rect, final List list, DisplayContent displayContent) {
    if (supportsDisplay(displayContent)) {
      displayContent.forAllActivities(
          new Consumer() { // from class:
                           // com.android.server.wm.BoundsCompatAlignmentController$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              BoundsCompatAlignmentController.lambda$recomputeConfiguration$0(
                  rect, list, (ActivityRecord) obj);
            }
          },
          false);
    }
  ...
  public static /* synthetic */ void lambda$recomputeConfiguration$0(
      Rect rect, List list, ActivityRecord activityRecord) {
