...
public class ActivityTaskSupervisor implements RecentTasks.Callbacks {
    ...
    public ComponentName getSystemChooserActivity() {
        if (this.mSystemChooserActivity == null) {
            this.mSystemChooserActivity = ComponentName.unflattenFromString(this.mService.mContext.getResources().getString(R.string.contentServiceSync));
        }
            ...
            if (z || z2) {
                ...
                if ((z && !z3) || (z2 && !z3 && !activityInfo.applicationInfo.isProfileableByShell())) {
                    ...
                    synchronized (windowManagerGlobalLock) {
                        try {
                            this.mService.f1734mH.post(new Runnable() { // from class: com.android.server.wm.ActivityTaskSupervisor$$ExternalSyntheticLambda4
    ...
    */
    public void startSpecificActivity(ActivityRecord activityRecord, boolean z, boolean z2) {
        ...
        boolean z3;
        Handler handler;
        final WindowProcessController processController = this.mService.getProcessController(activityRecord.processName, activityRecord.info.applicationInfo.uid);
        if (processController != null && this.mService.mDexController.shouldKillProcess(processController, activityRecord.getDisplayId())) {
            if (activityRecord.isTaskOverlay() && processController.hasVisibleActivities()) {
                Slog.i("ActivityTaskManager", "Activity " + activityRecord + " is overlay, wpc = " + processController + "has visible activity. So do not kill");
            } else {
                ...
                this.mService.startProcessAsync(activityRecord, z3, z4, z4 ? "top-activity" : "activity", i, activityRecord.getDisplayId());
                ...
                handler.post(new Runnable() { // from class: com.android.server.wm.ActivityTaskSupervisor$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public boolean checkStartAnyActivityPermission(Intent intent, ActivityInfo activityInfo, String str, int i, int i2, int i3, String str2, String str3, boolean z, boolean z2, WindowProcessController windowProcessController, ActivityRecord activityRecord, Task task) {
        ...
        if (z2 && this.mService.mDexController.isPendingStartRecent() && this.mService.f1734mH.getLooper().equals(Looper.myLooper())) {
            return true;
        }
    ...
    public void activityIdleInternal(ActivityRecord activityRecord, boolean z, boolean z2, Configuration configuration) {
        ...
        if (!this.mStartingUsers.isEmpty()) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                Slogf.m96i("ActivityTaskManager", "finishing switch of user %d", Integer.valueOf(userState.mHandle.getIdentifier()));
                this.mService.mAmInternal.finishUserSwitch(userState);
            }
        }
        this.mService.f1734mH.post(new Runnable() { // from class: com.android.server.wm.ActivityTaskSupervisor$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void findTaskToMoveToFront(Task task, int i, ActivityOptions activityOptions, String str, boolean z, boolean z2) {
        boolean z3;
        ...
        try {
            if (task.mTransitionController.isShellTransitionsEnabled() && !task.mTransitionController.isCollecting()) {
                ...
                if (task.isResizeable() || !canUseActivityOptionsLaunchBounds(activityOptions)) {
                    ...
                    str3 = str5;
                    getLaunchParamsController().calculate(task, null, task.getTopNonFinishingActivity(), null, activityOptions, null, 3, launchParams);
                ...
                if (!z4 && activityOptions != null) {
                    ...
                    if (launchDisplayId != -1 && displayId != launchDisplayId && task2.isActivityTypeStandard() && task2.inFullscreenWindowingMode()) {
                        Slog.d("ActivityTaskManager", "findTaskToMoveToFront: move rootTask " + task2 + " to display #" + launchDisplayId);
                        DisplayContent displayContentOrCreate = this.mService.mRootWindowContainer.getDisplayContentOrCreate(launchDisplayId);
                        defaultTaskDisplayArea = displayContentOrCreate == null ? displayContentOrCreate.getDefaultTaskDisplayArea() : null;
                ...
                z3 = false;
                task2.moveTaskToFront(task, false, activityOptions, topNonFinishingActivity != null ? null : topNonFinishingActivity.appTimeTracker, str4);
                handleNonResizableTaskIfNeeded(task, 0, this.mRootWindowContainer.getDefaultTaskDisplayArea(), task2, z);
                if (topNonFinishingActivity != null && ((activityOptions == null || !activityOptions.getDisableStartingWindow()) && !isFreeformForceHidden)) {
                    if (!z2) {
                        topNonFinishingActivity.showStartingWindow(null, false, true, topNonFinishingActivity.isProcessRunning(), false, null, null, true);
                    } else {
        ...
        if (!z4) {
            ...
            if (launchDisplayId != -1) {
                Slog.d("ActivityTaskManager", "findTaskToMoveToFront: move rootTask " + task2 + " to display #" + launchDisplayId);
                DisplayContent displayContentOrCreate2 = this.mService.mRootWindowContainer.getDisplayContentOrCreate(launchDisplayId);
    ...
    public final void cleanUpRemovedTask(Task task, boolean z, boolean z2) {
        ...
        this.mService.f1734mH.sendMessage(PooledLambda.obtainMessage(new QuadConsumer() { // from class: com.android.server.wm.ActivityTaskSupervisor$$ExternalSyntheticLambda8
    ...
    public final void killTaskProcessesIfPossible(Task task) {
        ...
        this.mService.f1734mH.sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.wm.ActivityTaskSupervisor$$ExternalSyntheticLambda12
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public int startActivityFromRecents(int i, int i2, int i3, SafeActivityOptions safeActivityOptions, boolean z) {
            ...
            synchronized (windowManagerGlobalLock) {
                try {
                    ...
                    if (activityOptions != null) {
                        ...
                        if (activityOptions.freezeRecentTasksReordering() && (isCallerRecents || ActivityTaskManagerService.checkPermission("android.permission.MANAGE_ACTIVITY_TASKS", i, i2) == 0)) {
                            this.mRecentTasks.setFreezeTaskListReordering();
                            if (activityOptions.getRemoteTransition() == null && this.mWindowManager.getRecentsAnimationController() != null) {
                                z3 = true;
                    ...
                    if (z3 && anyTaskForId != null && anyTaskForId.inFreeformWindowingMode()) {
                        this.mWindowManager.getRecentsAnimationController().cancelAnimation(2, "startActivityFromRecents-freeformByGesture");
                        z2 = false;
                    }
                    if (anyTaskForId != null) {
                        ...
                        if ((dexModeLocked2 == 1 || (dexModeLocked2 == 2 && launchDisplayId == 2)) && (nonStartableActivityInDexMode = this.mService.mDexController.getNonStartableActivityInDexMode(anyTaskForId)) != null) {
                            this.mService.mDexController.showWarningToastIfNeeded(nonStartableActivityInDexMode.info);
                            WindowManagerService.resetPriorityAfterLockedSection();
                            return 102;
                        }
                    }
                    if (anyTaskForId != null && this.mService.mMultiTaskingController.interceptStartActivityFromRecentsLocked(anyTaskForId, activityOptions, i, i2)) {
                    ...
                    if (anyTaskForId == null || activityOptions == null) {
                        ...
                        if (launchDisplayId2 != -1 && anyTaskForId.getDisplayId() != launchDisplayId2) {
                            ...
                            if (i4 == 0 && z6) {
                                ...
                                } else if (anyTaskForId.getWindowingMode() == 5 && anyTaskForId.topRunningActivity() != null) {
                    ...
                    int windowingMode = (!CoreRune.MW_SA_LOGGING || anyTaskForId == null || (!anyTaskForId.isMinimized() && anyTaskForId.getTopVisibleActivity() == null)) ? 0 : anyTaskForId.getWindowingMode();
                    if (activityOptions != null && activityOptions.getLaunchedFromDnD()) {
                        z2 = false;
                    }
                    if (activityOptions != null && activityOptions.getLaunchInFocusedStageRoot() && defaultTaskDisplayArea.isSplitScreenModeActivated() && (topRootStageTask = defaultTaskDisplayArea.getTopRootStageTask()) != null) {
                        activityOptions.setLaunchRootTask(topRootStageTask.getTaskInfo().token);
                        z2 = false;
                    }
                    if (anyTaskForId != null) {
                        if (activityOptions != null && activityOptions.allowEnterPipWhileLaunching() && activityOptions.getLaunchDisplayId() <= 0 && activityOptions.getLaunchRootTask() == null && activityOptions.getLaunchWindowingMode() == 0 && activityOptions.getForceLaunchWindowingMode() == 0) {
                            ActivityRecord findEnterPipOnTaskSwitchCandidate = Task.findEnterPipOnTaskSwitchCandidate(this.mRootWindowContainer.getDefaultTaskDisplayArea().getTopRootTask());
                            if (findEnterPipOnTaskSwitchCandidate != null && findEnterPipOnTaskSwitchCandidate.getTask() != anyTaskForId) {
                                Task.enableEnterPipOnTaskSwitch(findEnterPipOnTaskSwitchCandidate, anyTaskForId, null, activityOptions);
                    ...
                    try {
                        ...
                        try {
                            z4 = true;
                            Task anyTaskForId2 = this.mRootWindowContainer.anyTaskForId(i3, 2, activityOptions, true);
                            try {
                                if (anyTaskForId2 == null) {
                                    this.mWindowManager.executeAppTransition();
                                    throw new IllegalArgumentException("startActivityFromRecents: Task " + i3 + " not found.");
                                }
                                DisplayContent displayContent = this.mRootWindowContainer.getDisplayContent(anyTaskForId2.getDisplayId());
                                ...
                                if (isSplitScreenModeActivated || fromWindowContainerToken == null || !fromWindowContainerToken.inSplitScreenWindowingMode() || this.mService.mWindowOrganizerController.whileEnterSplitWithSingleStage()) {
                                    z5 = z7;
                                } else {
                                    this.mService.mWindowOrganizerController.onEnterSplitWithSingleStageStarted("recents");
                                    z5 = true;
                                }
                                if (z) {
                                    try {
                                ...
                                try {
                                    try {
                                        if (z2) {
                                            ...
                                            if (anyTaskForId2.inFreeformWindowingMode() && (dexModeLocked = this.mService.mDexController.getDexModeLocked()) != 1) {
                                                i7 = 2;
                                                if (dexModeLocked != 2 || anyTaskForId2.getDisplayId() != 2) {
                                                    this.mService.getTaskChangeNotificationController().notifyTaskMovedToFront(defaultTaskDisplayArea.getRootHomeTask().getTopLeafTask().getTaskInfo());
                                                }
                                                if (!this.mService.mAmInternal.shouldConfirmCredentials(anyTaskForId2.mUserId) || anyTaskForId2.getRootActivity() == null) {
                                                    ...
                                                    WindowManagerService.resetPriorityAfterLockedSection();
                                                    this.mService.mDexDockingController.setOtherTaskIfNeeded(anyTaskForId2, activityOptions);
                                                    ...
                                                    int startActivityInPackage = this.mService.getActivityStartController().startActivityInPackage(i11, i, i2, str, str2, intent, type, null, null, 0, 0, safeActivityOptions, i12, anyTaskForId2, "startActivityFromRecents", false, null, BackgroundStartPrivileges.NONE);
                                                    ...
                                                    synchronized (windowManagerGlobalLock2) {
                                                        try {
                                                            ...
                                                            if (!anyTaskForId2.isAttached() || anyTaskForId2.hasActivity()) {
                                                                ...
                                                                task2 = anyTaskForId2;
                                                                if (!task2.mCreatedByOrganizer && task2.inSplitScreenWindowingMode()) {
                                                                    task2.removeIfPossible("handleStartActivityFromRecents");
                                                                }
                                                            }
                                                            if (z5) {
                                                                this.mService.mWindowOrganizerController.onEnterSplitWithSingleStageFinished("recents");
                                                            }
                                                ...
                                                ActivityRecord topNonFinishingActivity = anyTaskForId2.getTopNonFinishingActivity();
                                                ...
                                                ActivityMetricsLogger.LaunchingState notifyActivityLaunching = activityMetricsLogger.notifyActivityLaunching(intent3, null, i6);
                                                try {
                                                    if (anyTaskForId2.inFreeformWindowingMode() && anyTaskForId2.isFreeformStashed()) {
                                                        if (anyTaskForId2.isVisible() && !anyTaskForId2.isFreeformForceHidden()) {
                                                            z7 = true;
                                                        }
                                                        this.mService.mTaskOrganizerController.resetStashedFreeform(anyTaskForId2, z7);
                                                    }
                                                    if (anyTaskForId2.isDexMode() && anyTaskForId2.inFullscreenWindowingMode() && activityOptions != null && activityOptions.getLaunchBounds() != null && !activityOptions.getLaunchBounds().isEmpty()) {
                                                        anyTaskForId2.setLastNonFullscreenBounds(activityOptions.getLaunchBounds());
                                                        activityOptions.setLaunchWindowingMode(5);
                                                    }
                                                    if (anyTaskForId2.isDexMode() && anyTaskForId2.isDexTaskDocked() && activityOptions != null && activityOptions.getLaunchBounds() != null && !activityOptions.getLaunchBounds().isEmpty()) {
                                                        this.mService.mDexDockingController.clearAllTasks("startActivityFromRecents");
                                                    }
                                                    int i13 = i7;
                                                    try {
                                                        this.mService.moveTaskToFrontLocked(null, null, anyTaskForId2.mTaskId, 0, safeActivityOptions, true);
                                                        if (activityOptions == null || activityOptions.getAnimationType() != 13) {
                                                            activityRecord = topNonFinishingActivity;
                                                        } else {
                                                            activityRecord = topNonFinishingActivity;
                                                            try {
                                                                activityRecord.mPendingRemoteAnimation = activityOptions.getRemoteAnimationAdapter();
                                                            } catch (Throwable th4) {
                                                                th = th4;
                                                                this.mActivityMetricsLogger.notifyActivityLaunched(notifyActivityLaunching, 2, false, activityRecord, activityOptions);
                                                                throw th;
                                                            }
                                                        }
                                                        ...
                                                        this.mActivityMetricsLogger.notifyActivityLaunched(notifyActivityLaunching, 2, false, activityRecord, activityOptions);
                                                        this.mService.mDexDockingController.setOtherTaskIfNeeded(anyTaskForId2, activityOptions);
                                                        this.mService.getActivityStartController().postStartActivityProcessingForLastStarter(anyTaskForId2.getTopNonFinishingActivity(), i13, anyTaskForId2.getRootTask());
                                                        this.mService.resumeAppSwitches();
                                                        if (CoreRune.MW_SA_LOGGING) {
                                                            sendMultiWindowSALogging(anyTaskForId2, windowingMode, activityOptions, i2);
                                                        }
                                                        if (z5) {
                                                            try {
                                                                this.mService.mWindowOrganizerController.onEnterSplitWithSingleStageFinished("recents");
                                        ...
                                        int startActivityInPackage2 = this.mService.getActivityStartController().startActivityInPackage(i11, i, i2, str, str2, intent, type, null, null, 0, 0, safeActivityOptions, i12, anyTaskForId2, "startActivityFromRecents", false, null, BackgroundStartPrivileges.NONE);
                                        threadLocal.set(Boolean.FALSE);
                                        windowManagerGlobalLock2 = this.mService.mGlobalLock;
                                        WindowManagerService.boostPriorityForLockedSection();
                                        synchronized (windowManagerGlobalLock2) {
                                        ...
                                        synchronized (windowManagerGlobalLock3) {
                                            try {
                                                this.mService.continueWindowLayout();
                                                if (task.isAttached() && !task.hasActivity() && !task.mCreatedByOrganizer && task.inSplitScreenWindowingMode()) {
                                    ...
                                    this.mService.mDexDockingController.setOtherTaskIfNeeded(anyTaskForId2, activityOptions);
                                    ThreadLocal threadLocal2 = PackageManagerServiceUtils.DISABLE_ENFORCE_INTENTS_TO_MATCH_INTENT_FILTERS;
    ...
    public void setLongLiveProcessIfNeeded(WindowProcessController windowProcessController) {
        if (CoreRune.FW_DEDICATED_MEMORY && this.mRecentTasks.isDedicatedProcess(windowProcessController.mUserId, windowProcessController.mName)) {
            this.mService.f1734mH.sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.wm.ActivityTaskSupervisor$$ExternalSyntheticLambda13
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
