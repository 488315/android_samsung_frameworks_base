...
public class ActivityMetricsLogger {
  ...
  public HashMap mConvertInt2Str =
      new HashMap() { // from class: com.android.server.wm.ActivityMetricsLogger.1
        {
          put(1, "SPLASH_SCREEN");
          put(2, "WINDOWS_DRAWN");
          put(3, "T_TIMEOUT");
          ...
          put(Integer.valueOf(FrameworkStatsLog.f654xe56e23e8), "run-from-vdex-fallback");
        }
      };
  ...
  public final class TransitionInfo {
    ...
    public static TransitionInfo create(
      ...
      return new TransitionInfo(
          activityRecord, launchingState, activityOptions, i4, z, z2, i, i2, z4);
    }
    ...
    public TransitionInfo(
      ...
      this.mSourceEventDelayMs =
          (int)
              (TimeUnit.NANOSECONDS.toMillis(launchingState.mStartUptimeNs)
                  - sourceInfo.eventTimeMs);
    }
    ...
    public boolean canCoalesce(ActivityRecord activityRecord) {
      ActivityRecord activityRecord2 = this.mLastLaunchedActivity;
      if (activityRecord2.mDisplayContent != activityRecord.mDisplayContent
          || activityRecord2.getWindowingMode() != activityRecord.getWindowingMode()) {
        return false;
      }
  ...
  public final class TransitionInfoSnapshot {
    ...
    public TransitionInfoSnapshot(
        TransitionInfo transitionInfo, ActivityRecord activityRecord, int i) {
      ...
      this.launchedActivityAppRecordRequiredAbi =
          windowProcessController == null ? null : windowProcessController.getRequiredAbi();
    ...
    public PackageOptimizationInfo getPackageOptimizationInfo(
        ArtManagerInternal artManagerInternal) {
      String str;
      ...
      return artManagerInternal.getPackageOptimizationInfo(
          this.applicationInfo, str, this.launchedActivityName);
    }
  }
  ...
  public void logWindowState() {
    ...
    if (this.mWindowState != -1) {
      this.mLoggerHandler.sendMessage(
          PooledLambda.obtainMessage(
              new TriConsumer() { // from class:
                                  // com.android.server.wm.ActivityMetricsLogger$$ExternalSyntheticLambda0
                public final void accept(Object obj, Object obj2, Object obj3) {
                  ((ActivityMetricsLogger) obj)
                      .logWindowState((String) obj2, ((Integer) obj3).intValue());
                }
              },
              this,
              TRON_WINDOW_STATE_VARZ_STRINGS[this.mWindowState],
              Integer.valueOf((int) (elapsedRealtime - this.mLastLogTimeSecs))));
    }
    this.mLastLogTimeSecs = elapsedRealtime;
    this.mWindowState = -1;
    Task topDisplayFocusedRootTask =
        this.mSupervisor.mRootWindowContainer.getTopDisplayFocusedRootTask();
  ...
  public LaunchingState notifyActivityLaunching(
      Intent intent, ActivityRecord activityRecord, int i) {
  ...
  public void notifyActivityLaunched(
    ...
    if (transitionInfo != null && transitionInfo.canCoalesce(activityRecord)) {
      boolean z4 =
          !transitionInfo.mLastLaunchedActivity.packageName.equals(activityRecord.packageName);
      if (z4) {
    ...
    TransitionInfo create =
        TransitionInfo.create(
            ...
            i3,
            z,
            activityRecord.getTask().isVisible(),
            i);
    if (create == null) {
  ...
  public TransitionInfoSnapshot notifyWindowsDrawn(ActivityRecord activityRecord) {
    ...
    TransitionInfoSnapshot transitionInfoSnapshot =
        new TransitionInfoSnapshot(activeTransitionInfo);
    if (activeTransitionInfo.mLoggedTransitionStarting
        || (!activityRecord.mDisplayContent.mOpeningApps.contains(activityRecord)
            && !activityRecord.mTransitionController.isCollecting(activityRecord))) {
  ...
  public void notifyTransitionStarting(ArrayMap arrayMap) {
    ...
    for (int size = arrayMap.size() - 1; size >= 0; size--) {
      ...
      if (activeTransitionInfo != null && !activeTransitionInfo.mLoggedTransitionStarting) {
        activeTransitionInfo.mCurrentTransitionDelayMs =
            activeTransitionInfo.calculateDelay(uptimeNanos);
  ...
  public void notifyActivityRemoved(ActivityRecord activityRecord) {
    ...
    PackageCompatStateInfo packageCompatStateInfo =
        (PackageCompatStateInfo)
            this.mPackageUidToCompatStateInfo.get(activityRecord.info.applicationInfo.uid);
  ...
  public void notifyVisibilityChanged(ActivityRecord activityRecord) {
    ...
    if (activityRecord.isState(ActivityRecord.State.RESUMED)
        && activityRecord.mDisplayContent.isSleeping()) {
      return;
    }
  ...
  public final void scheduleCheckActivityToBeDrawn(ActivityRecord activityRecord, long j) {
    activityRecord.mAtmService.f1734mH.sendMessageDelayed(
        PooledLambda.obtainMessage(
            new TriConsumer() { // from class:
                                // com.android.server.wm.ActivityMetricsLogger$$ExternalSyntheticLambda6
              public final void accept(Object obj, Object obj2, Object obj3) {
                ((ActivityMetricsLogger) obj)
                    .checkActivityToBeDrawn((Task) obj2, (ActivityRecord) obj3);
              }
            },
            this,
            ...
            && task.forAllActivities(
                new Predicate() { // from class:
                  ...
                  public final boolean test(Object obj) {
                    ...
                    lambda$checkActivityToBeDrawn$0 =
                        ActivityMetricsLogger.lambda$checkActivityToBeDrawn$0((ActivityRecord) obj);
  ...
  public static /* synthetic */ boolean lambda$checkActivityToBeDrawn$0(
      ActivityRecord activityRecord) {
    return (!activityRecord.isVisibleRequested()
            || activityRecord.isReportedDrawn()
  ...
  public final AppHibernationManagerInternal getAppHibernationManagerInternal() {
    ...
    if (this.mAppHibernationManagerInternal == null) {
      this.mAppHibernationManagerInternal =
  ...
  public void notifyBeforePackageUnstopped(String str) {
    AppHibernationManagerInternal appHibernationManagerInternal =
        getAppHibernationManagerInternal();
    if (appHibernationManagerInternal != null) {
      this.mLastHibernationStates.put(
          str, Boolean.valueOf(appHibernationManagerInternal.isHibernatingGlobally(str)));
    }
  }
    ...
    for (int size = this.mTransitionInfoList.size() - 1; size >= 0; size--) {
      ...
      if (transitionInfo.mLastLaunchedActivity.info.applicationInfo == applicationInfo) {
        ...
        if (transitionInfo.mProcessRunning) {
          ...
          String str =
              "Process " + transitionInfo.mLastLaunchedActivity.info.processName + " restarted";
  ...
  public final void done(boolean z, TransitionInfo transitionInfo, String str, long j) {
    ...
    Boolean bool =
        (Boolean)
            this.mLastHibernationStates.remove(transitionInfo.mLastLaunchedActivity.packageName);
    if (z) {
      this.mLastTransitionInfo.remove(transitionInfo.mLastLaunchedActivity);
  ...
  public final void logAppTransitionCancel(TransitionInfo transitionInfo) {
    ...
    FrameworkStatsLog.write(
        ...
        getAppStartTransitionType(i, transitionInfo.mRelaunched),
        activityRecord.info.name);
  }

  public final void logAppTransitionFinished(final TransitionInfo transitionInfo, final boolean z) {
    final TransitionInfoSnapshot transitionInfoSnapshot =
        new TransitionInfoSnapshot(transitionInfo);
    ...
    this.mLoggerHandler.post(
        new Runnable() { // from class:
                         // com.android.server.wm.ActivityMetricsLogger$$ExternalSyntheticLambda4
          @Override // java.lang.Runnable
          public final void run() {
            ActivityMetricsLogger.this.lambda$logAppTransitionFinished$1(
                transitionInfo, j, i, transitionInfoSnapshot, z, i2, i3, z2);
          }
        });
  ...
  public /* synthetic */ void lambda$logAppTransitionFinished$1(
  ...
  public final void logAppTransition(
      long j, int i, TransitionInfoSnapshot transitionInfoSnapshot, boolean z, int i2, int i3) {
    boolean z2;
    boolean z3;
    String str;
    ...
    logMaker.addTaggedData(FrameworkStatsLog.f109x9a09c896, Integer.valueOf(i));
    ...
    PackageOptimizationInfo packageOptimizationInfo =
        transitionInfoSnapshot.getPackageOptimizationInfo(getArtManagerInternal());
    ...
    FrameworkStatsLog.write(
        48,
        transitionInfoSnapshot.applicationInfo.uid,
        transitionInfoSnapshot.packageName,
        getAppStartTransitionType(transitionInfoSnapshot.type, transitionInfoSnapshot.relaunched),
        transitionInfoSnapshot.launchedActivityName,
        transitionInfoSnapshot.launchedActivityLaunchedFromPackage,
        isInstantApp,
        0L,
        transitionInfoSnapshot.reason,
        i,
        transitionInfoSnapshot.startingWindowDelayMs,
        transitionInfoSnapshot.bindApplicationDelayMs,
        transitionInfoSnapshot.windowsDrawnDelayMs,
        str2,
        packageOptimizationInfo.getCompilationReason(),
        packageOptimizationInfo.getCompilationFilter(),
        transitionInfoSnapshot.sourceType,
        transitionInfoSnapshot.sourceEventDelayMs,
        z,
        z2,
        z3,
        transitionInfoSnapshot.launchedActivityName.hashCode(),
        timeUnit.toMillis(transitionInfoSnapshot.timestampNs),
        i2,
        i3,
        (transitionInfoSnapshot.applicationInfo.flags & 2097152) != 0 ? 2 : 1);
    EventLog.writeEvent(
        1300100,
        transitionInfoSnapshot.packageName,
        transitionInfoSnapshot.launchedActivityName,
        convertReason(transitionInfoSnapshot.reason),
        Integer.valueOf(i),
        Integer.valueOf(transitionInfoSnapshot.startingWindowDelayMs),
        Integer.valueOf(transitionInfoSnapshot.bindApplicationDelayMs),
        Integer.valueOf(transitionInfoSnapshot.windowsDrawnDelayMs),
        convertTRtype(transitionInfoSnapshot.type),
        convertFilter(packageOptimizationInfo.getCompilationFilter()));
    ChimeraCommonUtil.putAppLaunchInfo(
        transitionInfoSnapshot.packageName, convertTRtype(transitionInfoSnapshot.type));
    PerfLog.d(
        4,
        "["
            + transitionInfoSnapshot.packageName
    ...
    SecIpmManager secIpmManager =
        (SecIpmManager) this.mSupervisor.mService.mContext.getSystemService("PkgPredictorService");
    if (secIpmManager != null) {
      Slog.d("[secipm]", "mSecIpmManager report to nap");
      secIpmManager.reportToNAP(
          transitionInfoSnapshot.applicationInfo.uid,
          transitionInfoSnapshot.packageName,
          transitionInfoSnapshot.launchedActivityName,
          transitionInfoSnapshot.windowsDrawnDelayMs);
    ...
    if (KillPolicyManager.isKPMEnabled()
        && (str = transitionInfoSnapshot.packageName) != null
        && !this.mKillPolicyManager.isSkipPackage(str)
        && this.mKillPolicyManager.isKpmSafe(transitionInfoSnapshot.packageName)) {
      this.mKillPolicyManager.calculateKpmStats(
          transitionInfoSnapshot.packageName,
          transitionInfoSnapshot.processName,
          transitionInfoSnapshot.type);
    }
  ...
  public final boolean isIncrementalLoading(String str, int i) {
    IncrementalStatesInfo incrementalStatesInfo =
        this.mSupervisor
            ...
            .getIncrementalStatesInfo(str, 0, i);
    return incrementalStatesInfo != null && incrementalStatesInfo.isLoading();
  }

  public void logInTaskActivityStart(
      TransitionInfoSnapshot transitionInfoSnapshot, boolean z, int i) {
    FrameworkStatsLog.write(
        FrameworkStatsLog.IN_TASK_ACTIVITY_STARTED,
        transitionInfoSnapshot.applicationInfo.uid,
        getAppStartTransitionType(transitionInfoSnapshot.type, transitionInfoSnapshot.relaunched),
        z,
        i,
        transitionInfoSnapshot.windowsDrawnDelayMs,
        TimeUnit.NANOSECONDS.toMillis(transitionInfoSnapshot.timestampNs));
  }
  ...
  public final void logAppDisplayed(TransitionInfoSnapshot transitionInfoSnapshot) {
    EventLog.writeEvent(
        30009,
        Integer.valueOf(transitionInfoSnapshot.userId),
        Integer.valueOf(transitionInfoSnapshot.activityRecordIdHashCode),
        transitionInfoSnapshot.launchedActivityShortComponentName,
        Integer.valueOf(transitionInfoSnapshot.windowsDrawnDelayMs));
    ...
    Pageboost.gatherLaunchTime(
        transitionInfoSnapshot.packageName,
        transitionInfoSnapshot.windowsDrawnDelayMs,
        transitionInfoSnapshot.processRecord != null
            ? transitionInfoSnapshot.processRecord.getPid()
            : -1);
  }
  ...
  public final void logRecentsAnimationLatency(TransitionInfo transitionInfo) {
    ...
    this.mLoggerHandler.postDelayed(
        new Runnable() { // from class:
                         // com.android.server.wm.ActivityMetricsLogger$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
            ActivityMetricsLogger.lambda$logRecentsAnimationLatency$2(
                j, activityRecord, recentsAnimationController, windowManagerService, i);
          }
        },
        300L);
  }

  public static /* synthetic */ void lambda$logRecentsAnimationLatency$2(
      long j,
      ActivityRecord activityRecord,
      Object obj,
      WindowManagerService windowManagerService,
      int i) {
    if (j == activityRecord.topResumedStateLossTime
        && obj == windowManagerService.getRecentsAnimationController()) {
      windowManagerService.mLatencyTracker.logAction(8, i);
    }
  }

  public TransitionInfoSnapshot notifyFullyDrawn(
      final ActivityRecord activityRecord, final boolean z) {
    long millis;
    final TransitionInfo transitionInfo =
        (TransitionInfo) this.mLastTransitionInfo.get(activityRecord);
    if (transitionInfo == null) {
      return null;
    }
    if (!transitionInfo.mIsDrawn && transitionInfo.mPendingFullyDrawn == null) {
      transitionInfo.mPendingFullyDrawn =
          new Runnable() { // from class:
                           // com.android.server.wm.ActivityMetricsLogger$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              ActivityMetricsLogger.this.lambda$notifyFullyDrawn$3(
                  activityRecord, z, transitionInfo);
            }
          };
      return null;
    }
    ...
    if (transitionInfo.mPendingFullyDrawn != null) {
      ...
      millis =
          TimeUnit.NANOSECONDS.toMillis(
              uptimeNanos - transitionInfo.mLaunchingState.mStartUptimeNs);
    }
    final TransitionInfoSnapshot transitionInfoSnapshot =
        new TransitionInfoSnapshot(transitionInfo, activityRecord, (int) millis);
    if (transitionInfoSnapshot.isInterestedToEventLog()) {
      this.mLoggerHandler.post(
          new Runnable() { // from class:
                           // com.android.server.wm.ActivityMetricsLogger$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    Trace.traceBegin(
        64L,
        "ActivityManager:ReportingFullyDrawn " + transitionInfo.mLastLaunchedActivity.packageName);
    this.mLoggerHandler.post(
        new Runnable() { // from class:
                         // com.android.server.wm.ActivityMetricsLogger$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
            ActivityMetricsLogger.this.lambda$notifyFullyDrawn$5(
                transitionInfoSnapshot, z, transitionInfo);
          }
        });
    Trace.traceEnd(64L);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$notifyFullyDrawn$3(
      ActivityRecord activityRecord, boolean z, TransitionInfo transitionInfo) {
    notifyFullyDrawn(activityRecord, z);
    transitionInfo.mPendingFullyDrawn = null;
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$notifyFullyDrawn$5(
      TransitionInfoSnapshot transitionInfoSnapshot, boolean z, TransitionInfo transitionInfo) {
    logAppFullyDrawnMetrics(transitionInfoSnapshot, z, transitionInfo.mProcessRunning);
  }

  public final void logAppFullyDrawnMetrics(
      TransitionInfoSnapshot transitionInfoSnapshot, boolean z, boolean z2) {
    boolean z3;
    boolean z4;
    ...
    logMaker.addTaggedData(FrameworkStatsLog.f58x60da79b1, Integer.valueOf(z2 ? 1 : 0));
    this.mMetricsLogger.write(logMaker);
    PackageOptimizationInfo packageOptimizationInfo =
        transitionInfoSnapshot.getPackageOptimizationInfo(getArtManagerInternal());
    String codePath = transitionInfoSnapshot.applicationInfo.getCodePath();
    ...
    FrameworkStatsLog.write(
        ...
        transitionInfoSnapshot.launchedActivityName,
        z2,
        transitionInfoSnapshot.windowsFullyDrawnDelayMs,
        packageOptimizationInfo.getCompilationReason(),
        packageOptimizationInfo.getCompilationFilter(),
        transitionInfoSnapshot.sourceType,
        transitionInfoSnapshot.sourceEventDelayMs,
  ...
  public void logAbortedBgActivityStart(
      Intent intent,
    ...
    if (windowProcessController != null) {
      ...
      logMaker.addTaggedData(
          ...
          Integer.valueOf(
              ActivityManager.processStateAmToProto(
                  windowProcessController.getCurrentProcState())));
      logMaker.addTaggedData(
          1531, Integer.valueOf(windowProcessController.hasClientActivities() ? 1 : 0));
      logMaker.addTaggedData(
          1532, Integer.valueOf(windowProcessController.hasForegroundServices() ? 1 : 0));
      logMaker.addTaggedData(
          1533, Integer.valueOf(windowProcessController.hasForegroundActivities() ? 1 : 0));
      ...
      logMaker.addTaggedData(
          ...
          Integer.valueOf(windowProcessController.hasPendingUiClean() ? 1 : 0));
      if (windowProcessController.getInteractionEventTime() != 0) {
        logMaker.addTaggedData(
            1537,
            Long.valueOf(elapsedRealtime - windowProcessController.getInteractionEventTime()));
      }
      if (windowProcessController.getFgInteractionTime() != 0) {
        logMaker.addTaggedData(
            1538, Long.valueOf(elapsedRealtime - windowProcessController.getFgInteractionTime()));
      }
      if (windowProcessController.getWhenUnimportant() != 0) {
        logMaker.addTaggedData(
            1539, Long.valueOf(uptimeMillis - windowProcessController.getWhenUnimportant()));
      }
    }
    this.mMetricsLogger.write(logMaker);
  }
  ...
  public final void logAppStartMemoryStateCapture(TransitionInfoSnapshot transitionInfoSnapshot) {
    ...
    MemoryStatUtil.MemoryStat readMemoryStatFromFilesystem =
        MemoryStatUtil.readMemoryStatFromFilesystem(i, pid);
  ...
  public void logAppCompatState(ActivityRecord activityRecord) {
    ...
    PackageCompatStateInfo packageCompatStateInfo =
        (PackageCompatStateInfo) this.mPackageUidToCompatStateInfo.get(i);
  ...
  public final void findAppCompatStateToLog(PackageCompatStateInfo packageCompatStateInfo, int i) {
    ...
    for (int i4 = 0; i4 < arrayList.size(); i4++) {
      ...
      if (appCompatState == 1) {
        Slog.w(
            "ActivityTaskManager",
            "Visible activity with NOT_VISIBLE App Compat state for package UID: " + i);
  ...
  public final void logAppCompatStateInternal(
      ActivityRecord activityRecord, int i, PackageCompatStateInfo packageCompatStateInfo) {
    packageCompatStateInfo.mLastLoggedState = i;
    packageCompatStateInfo.mLastLoggedActivity = activityRecord;
    FrameworkStatsLog.write(
        FrameworkStatsLog.APP_COMPAT_STATE_CHANGED,
        activityRecord.info.applicationInfo.uid,
        i,
        isAppCompateStateChangedToLetterboxed(i)
            ? activityRecord.mLetterboxUiController.getLetterboxPositionForLogging()
            : 1);
  }
  ...
  public void logLetterboxPositionChange(ActivityRecord activityRecord, int i) {
    ...
    if (this.mPackageUidToCompatStateInfo.contains(i2)) {
      PackageCompatStateInfo packageCompatStateInfo =
          (PackageCompatStateInfo) this.mPackageUidToCompatStateInfo.get(i2);
      if (activityRecord != packageCompatStateInfo.mLastLoggedActivity) {
        return;
      }
      logAppCompatStateInternal(
          activityRecord, activityRecord.getAppCompatState(), packageCompatStateInfo);
    }
  }
  ...
  public void logCameraCompatControlAppearedEventReported(int i, int i2) {
    if (i != 0) {
      ...
      Slog.w(
          "ActivityTaskManager",
          "Unexpected state in logCameraCompatControlAppearedEventReported: " + i);
    }
  }
  ...
  public final ArtManagerInternal getArtManagerInternal() {
    if (this.mArtManagerInternal == null) {
      this.mArtManagerInternal =
          (ArtManagerInternal) LocalServices.getService(ArtManagerInternal.class);
    }
  ...
  public final void stopLaunchTrace(TransitionInfo transitionInfo) {
    UnifiedMemoryReclaimer.notifyAppLaunchFinished(
        transitionInfo.mLastLaunchedActivity.packageName);
  ...
  public final void launchObserverNotifyActivityLaunched(TransitionInfo transitionInfo) {
    ...
    this.mLaunchObserver.onActivityLaunched(
        transitionInfo.mLaunchingState.mStartUptimeNs,
        transitionInfo.mLastLaunchedActivity.mActivityComponent,
        convertTransitionTypeToLaunchObserverTemperature(transitionInfo.mTransitionType));
    Trace.traceEnd(64L);
  }
  ...
  public final void launchObserverNotifyActivityLaunchFinished(
      TransitionInfo transitionInfo, long j) {
    Trace.traceBegin(64L, "MetricsLogger:launchObserverNotifyActivityLaunchFinished");
    this.mLaunchObserver.onActivityLaunchFinished(
        transitionInfo.mLaunchingState.mStartUptimeNs,
        transitionInfo.mLastLaunchedActivity.mActivityComponent,
        j);
    Trace.traceEnd(64L);
