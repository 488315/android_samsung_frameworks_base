...
public class NonAppWindowAnimationAdapter implements AnimationAdapter {
  ...
  public static RemoteAnimationTarget[] startNonAppWindowAnimations(
    ...
    if (shouldStartNonAppWindowAnimationsForKeyguardExit(i)) {
      startNonAppWindowAnimationsForKeyguardExit(
          windowManagerService, j, j2, arrayList2, arrayList);
  ...
  public static boolean shouldAttachNavBarToApp(
    ...
    return (i == 8 || i == 10 || i == 12)
        ...
        && windowManagerService.getRecentsAnimationController() == null
        && displayContent.getAsyncRotationController() == null;
  }

  public static void startNonAppWindowAnimationsForKeyguardExit(
    ...
    windowManagerService.mRoot.forAllWindows(
        new Consumer() { // from class:
          ...
          public final void accept(Object obj) {
            NonAppWindowAnimationAdapter.lambda$startNonAppWindowAnimationsForKeyguardExit$0(
                WindowManagerService.this, j, j2, arrayList2, arrayList, (WindowState) obj);
          }
        },
        true);
  }

  public static /* synthetic */ void lambda$startNonAppWindowAnimationsForKeyguardExit$0(
      WindowManagerService windowManagerService,
      long j,
      long j2,
      ArrayList arrayList,
    ...
    if (windowState.mActivityRecord == null
        ...
        && windowState != windowManagerService.mRoot.getCurrentInputMethodWindow()) {
      NonAppWindowAnimationAdapter nonAppWindowAnimationAdapter =
          new NonAppWindowAnimationAdapter(windowState, j, j2);
      arrayList.add(nonAppWindowAnimationAdapter);
      windowState.startAnimation(
          windowState.getPendingTransaction(), nonAppWindowAnimationAdapter, false, 16);
      arrayList2.add(nonAppWindowAnimationAdapter.createRemoteAnimationTarget());
    }
  }

  public static void startNavigationBarWindowAnimation(
      DisplayContent displayContent, long j, long j2, ArrayList arrayList, ArrayList arrayList2) {
    WindowState navigationBar = displayContent.getDisplayPolicy().getNavigationBar();
    NonAppWindowAnimationAdapter nonAppWindowAnimationAdapter =
        new NonAppWindowAnimationAdapter(navigationBar.mToken, j, j2);
    arrayList2.add(nonAppWindowAnimationAdapter);
    WindowToken windowToken = navigationBar.mToken;
    windowToken.startAnimation(
        windowToken.getPendingTransaction(), nonAppWindowAnimationAdapter, false, 16);
  ...
  public RemoteAnimationTarget createRemoteAnimationTarget() {
    RemoteAnimationTarget remoteAnimationTarget =
        new RemoteAnimationTarget(
            ...
            new Rect(),
            (Rect) null,
            this.mWindowContainer.getPrefixOrderIndex(),
            this.mWindowContainer.getLastSurfacePosition(),
            this.mWindowContainer.getBounds(),
            (Rect) null,
            this.mWindowContainer.getWindowConfiguration(),
            true,
            (SurfaceControl) null,
            (Rect) null,
            (ActivityManager.RunningTaskInfo) null,
            false,
            this.mWindowContainer.getWindowType());
