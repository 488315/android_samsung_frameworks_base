...
public class DisplayWindowPolicyControllerHelper {
      ...
      for (int size = list.size() - 1; size >= 0; size--) {
        ...
        if (str != null) {
          Slog.e(
              ...
              String.format(
                  "Activity with requiredDisplayCategory='%s' cannot be displayed on display %d"
                      + " because that display does not have a matching category",
                  str, Integer.valueOf(this.mDisplayContent.mDisplayId)));
          return false;
        }
      }
      return true;
  ...
  public boolean canActivityBeLaunched(
    ...
    if (displayWindowPolicyController == null) {
      ...
      Slog.e(
          "DisplayWindowPolicyControllerHelper",
          String.format(
              "Activity with requiredDisplayCategory='%s' cannot be launched on display %d because"
                  + " that display does not have a matching category",
              str, Integer.valueOf(this.mDisplayContent.mDisplayId)));
      return false;
    }
  ...
  public boolean keepActivityOnWindowFlagsChanged(
  ...
  public void onRunningActivityChanged() {
    ...
    if (topActivity != this.mTopRunningActivity) {
      ...
      if (topActivity == null) {
        ...
        this.mDisplayWindowPolicyController.onTopActivityChanged(
    ...
    this.mDisplayContent.forAllActivities(
        new Consumer() { // from class:
          ...
          public final void accept(Object obj) {
            DisplayWindowPolicyControllerHelper.lambda$onRunningActivityChanged$0(
                zArr, arraySet, (ActivityRecord) obj);
          }
        });
  ...
  public static /* synthetic */ void lambda$onRunningActivityChanged$0(
      boolean[] zArr, ArraySet arraySet, ActivityRecord activityRecord) {
