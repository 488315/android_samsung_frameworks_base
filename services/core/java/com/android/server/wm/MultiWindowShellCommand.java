...
public class MultiWindowShellCommand extends ShellCommand {
  ...
  public boolean cmdMultiWindowOnAndOff(String[] strArr, PrintWriter printWriter) {
    ...
    if (strArr != null
      ...
      this.mAtm.mMultiWindowEnableController.setMultiWindowEnabledForUser(
          str, str, equals, currentUserId);
      return true;
    }
    ...
    if (activityRecord != null) {
      printWriter.println(
          activityRecord.toString()
              ...
              + MultiWindowManager.getInstance().supportsMultiWindow(activityRecord.token));
      return true;
    }
  ...
  public boolean cmdToggleFreeform(String[] strArr, PrintWriter printWriter) {
    DisplayContent topFocusedDisplayContent =
        this.mAtm.mRootWindowContainer.getTopFocusedDisplayContent();
    ActivityRecord activityRecord =
        topFocusedDisplayContent != null ? topFocusedDisplayContent.mFocusedApp : null;
  ...
  public boolean cmdDismissSplitAndStart(String[] strArr, PrintWriter printWriter) {
    if (strArr != null && strArr.length > 0) {
      Intent launchIntentForPackage =
          this.mAtm.mContext.getPackageManager().getLaunchIntentForPackage(strArr[0]);
  ...
  public boolean cmdSetEmbedActivityPackageEnabled(String[] strArr, PrintWriter printWriter) {
    ...
    if (strArr != null && strArr.length >= 3) {
      ...
      printWriter.println(
          "Error: set-embed-activity-package-enabled  option requires [packageName, enabled,"
              + " userId]");
    }
    return true;
  }
  ...
  public boolean cmdGetEmbedActivityPackageEnabled(String[] strArr, PrintWriter printWriter) {
    ...
    if (strArr != null && strArr.length >= 2) {
      ...
      printWriter.println(
          "Error: get-embed-activity-package-enabled  option requires [packageName, userId]");
    }
    return true;
  }
  ...
  public boolean cmdSetCornerGestureCustomValue(String[] strArr, PrintWriter printWriter) {
    ...
    this.mAtm.mMultiTaskingController.setCornerGestureCustomValue(
        (int)
            ((this.mAtm.mContext.getResources().getDisplayMetrics().density
  ...
  public boolean cmdRemoveFocusedTask(String[] strArr, PrintWriter printWriter) {
    ...
    printWriter.println(
        "Result = " + this.mMultiWindowManager.removeFocusedTask(Integer.parseInt(strArr[0])));
    return true;
  }
  ...
  public boolean cmdGetMultiSplitFlags(String[] strArr, PrintWriter printWriter) {
    printWriter.println(
        "flags = "
            + ((Object)
                MultiWindowManager.multiSplitFlagsToString(
                    this.mMultiWindowManager.getMultiSplitFlags())));
    return true;
  }
  ...
  public boolean cmdSetSizeCompatLaunchPolicy(String[] strArr, PrintWriter printWriter) {
    ...
    printWriter.println(
        "Request: launchPolicy=" + SizeCompatPolicyManager.launchPolicyToString(intValue));
    printWriter.println("Results:");
    int launchPolicy = sizeCompatPolicyManager.getLaunchPolicy();
    printWriter.println(
        "  launchPolicy(old)=" + SizeCompatPolicyManager.launchPolicyToString(launchPolicy));
    ...
    printWriter.println(
        "  launchPolicy(new)="
            + SizeCompatPolicyManager.launchPolicyToString(
                sizeCompatPolicyManager.getLaunchPolicy()));
    return true;
  }
  ...
  public boolean cmdAssistantActivityToSplit(String[] strArr, PrintWriter printWriter) {
    ...
    if (strArr != null
        ...
        && (launchIntentForPackage =
            ...
            != null) {
      launchIntentForPackage.setFlags(268435456);
      int multiWindowModeForAssistantHotKey =
          this.mAtm.mInternal.getMultiWindowModeForAssistantHotKey();
  ...
  private static void printNewDexHelp(PrintWriter printWriter) {
    ...
    printWriter.println(
        "  switch-overlay : switch overlay display device and default display device");
