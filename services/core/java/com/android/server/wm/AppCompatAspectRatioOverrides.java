...
public final class AppCompatAspectRatioOverrides {
    ...
    public AppCompatAspectRatioOverrides(
        ...
        final int i = 0;
        this.mAllowUserAspectRatioOverrideOptProp =
                optPropFactory.create(
                        "android.window.PROPERTY_COMPAT_ALLOW_USER_ASPECT_RATIO_OVERRIDE",
                        new BooleanSupplier() { // from class:
                                                // com.android.server.wm.AppCompatAspectRatioOverrides$$ExternalSyntheticLambda0
                            ...
                            public final boolean getAsBoolean() {
                                ...
                                switch (i2) {
                                    case 0:
                                        return appCompatConfiguration2
        ...
        final int i2 = 1;
        this.mAllowUserAspectRatioFullscreenOverrideOptProp =
                optPropFactory.create(
        ...
        this.mAllowOrientationOverrideOptProp =
                optPropFactory.create("android.window.PROPERTY_COMPAT_ALLOW_ORIENTATION_OVERRIDE");
    }
    ...
    public float getDisplaySizeMinAspectRatio() {
        ...
        return displayArea == null
                ? activityRecord.info.getMinAspectRatio()
                : AppCompatUtils.computeAspectRatio(
                        new Rect(displayArea.getWindowConfiguration().getAppBounds()));
    }
    ...
    public final float getSplitScreenAspectRatio() {
        ...
        int dimensionPixelSize =
                activityRecord
                                ...
                                .mContext
                                .getResources()
                                .getDimensionPixelSize(R.dimen.harmful_app_padding_top)
                        - (activityRecord
                                        .mWmService
                                        .mContext
                                        .getResources()
                                        .getDimensionPixelSize(R.dimen.harmful_app_name_padding_top)
                                * 2);
    ...
    public final float getUserMinAspectRatio() {
        ...
        throw new AssertionError(
                "Unexpected user min aspect ratio override: "
                        + userAspectRatioState.mUserAspectRatio);
    }
    ...
    public final int getUserMinAspectRatioOverrideCode() {
        ...
        try {
            ...
            return AppGlobals.getPackageManager()
                    .getUserMinAspectRatio(activityRecord.packageName, activityRecord.mUserId);
        } catch (RemoteException e) {
            Slog.w(
                    "ActivityTaskManager",
                    "Exception thrown retrieving aspect ratio user override " + this,
                    e);
    ...
    public final boolean isSystemOverrideToFullscreenEnabled() {
        int i;
        return this.mActivityRecord.info.isChangeEnabled(310816437L)
                && !this.mAllowOrientationOverrideOptProp.isFalse()
                && ((i = this.mUserAspectRatioState.mUserAspectRatio) == 0 || i == 6);
    }

    public final boolean shouldApplyUserFullscreenOverride() {
        if (!((this.mAllowUserAspectRatioOverrideOptProp.isFalse()
                        || this.mAllowUserAspectRatioFullscreenOverrideOptProp.isFalse()
                        || !this.mAppCompatConfiguration.isUserAppAspectRatioFullscreenEnabled())
                ? false
                : true)) {
            return false;
        }
    ...
    public final boolean shouldApplyUserMinAspectRatioOverride() {
        ...
        if (CoreRune.MT_APP_COMPAT_ASPECT_RATIO_POLICY
                && this.mAllowMinAspectRatioOverrideOptProp.isFalse()) {
            DeviceIdleController$$ExternalSyntheticOutline0.m(
                    new StringBuilder(),
                    this.mActivityRecord.packageName,
                    " declared PROPERTY_COMPAT_ALLOW_MIN_ASPECT_RATIO_OVERRIDE false. User aspect"
                        + " ratio should not applied because the package is not displayed in user"
                        + " settings.",
                    "ActivityTaskManager");
            return false;
        }
        int userMinAspectRatioOverrideCode = getUserMinAspectRatioOverrideCode();
        this.mUserAspectRatioState.mUserAspectRatio = userMinAspectRatioOverrideCode;
        return (userMinAspectRatioOverrideCode == 0
                        || userMinAspectRatioOverrideCode == 7
                        || userMinAspectRatioOverrideCode == 6)
                ? false
                : true;
    }
    ...
    public final boolean shouldEnableUserAspectRatioSettings() {
        ...
        return !this.mAllowUserAspectRatioOverrideOptProp.isFalse()
                && this.mAppCompatConfiguration.isUserAppAspectRatioSettingsEnabled()
                && (displayContent = this.mActivityRecord.mDisplayContent) != null
