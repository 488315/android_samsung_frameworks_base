...
public class WmDisplayCutout {
  public static final WmDisplayCutout NO_CUTOUT =
      new WmDisplayCutout(DisplayCutout.NO_CUTOUT, null);
  ...
  public static WmDisplayCutout computeSafeInsets(DisplayCutout displayCutout, int i, int i2) {
    ...
    return new WmDisplayCutout(
        displayCutout.replaceSafeInsets(DisplayCutout.computeSafeInsets(i, i2, displayCutout)),
        new Size(i, i2));
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.mInner, wmDisplayCutout.mInner)
        && Objects.equals(this.mFrameSize, wmDisplayCutout.mFrameSize);
  }
