...
public class ChangeTransitionController implements IController {
  ...
  public void initialize() {
    this.f1735mH = new HandlerC2887H(DisplayThread.get().getLooper());
  }
  ...
  public void handleWindowContainerTransaction(
        ...
        asTask.isLeafTask()
            ...
            : asTask.getTask(
                new Predicate() { // from class:
                                  // com.android.server.wm.ChangeTransitionController$$ExternalSyntheticLambda0
                  @Override // java.util.function.Predicate
                  public final boolean test(Object obj) {
                    boolean lambda$handleWindowContainerTransaction$0;
                    lambda$handleWindowContainerTransaction$0 =
                        ChangeTransitionController.lambda$handleWindowContainerTransaction$0(
                            (Task) obj);
  ...
  public void handleTaskSizeChanged(Task task, Rect rect) {
    if (DISABLE_LEGACY_RESIZE_TRANSITION
        || task.isChangeTransitionBlockedByCommonPolicy()
        || !CoreRune.MW_FREEFORM_SHELL_TRANSITION
  ...
  public void handleChangeTransitionRequest(int i) {
    Slog.d(
        "ChangeTransitionController",
        "handleChangeTransitionRequest: "
            + WindowContainerTransaction.changeTransitRequestToString(i));
    if (i == 1) {
  ...
  public void handlePositionTaskBehindHome(Task task) {
    ...
    requestChangeTransition(
        task, 6, task.getWindowingMode(), new Rect(task.getBounds()), "position_behind_home");
  }
  ...
  public final void handleRequestFullscreenToSplitScreen() {
    ...
    Task rootTask =
        defaultTaskDisplayArea.getRootTask(
            new Predicate() { // from class:
                              // com.android.server.wm.ChangeTransitionController$$ExternalSyntheticLambda2
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$handleRequestFullscreenToSplitScreen$1;
                lambda$handleRequestFullscreenToSplitScreen$1 =
                    ChangeTransitionController.lambda$handleRequestFullscreenToSplitScreen$1(
                        (Task) obj);
                return lambda$handleRequestFullscreenToSplitScreen$1;
              }
            });
    if (rootTask == null
        || !rootTask.supportsMultiWindowInDisplayArea(defaultTaskDisplayArea)
        || rootTask.isChangeTransitionBlockedByCommonPolicy()) {
      return;
    }
    Slog.d(
        "ChangeTransitionController", "handleRequestFullscreenToSplitScreen: #" + rootTask.mTaskId);
    ActivityRecord topMostActivity = rootTask.getTopMostActivity();
    if ((topMostActivity == null || topMostActivity.finishing)
        && rootTask.getTopVisibleActivity() == null) {
      requestDisplayChangeTransition(
          defaultTaskDisplayArea.getDisplayId(), "request(full_to_split)");
    } else {
      requestChangeTransition(
          rootTask,
          this.mAtm.mNaturalSwitchingController.isRunning() ? 4 : 1,
          rootTask.getWindowingMode(),
          new Rect(rootTask.getBounds()),
          "request(full_to_split)");
    }
  }
  ...
  public static /* synthetic */ boolean lambda$handleRequestFullscreenToSplitScreen$1(Task task) {
    return task.inFullscreenWindowingMode()
        && task.isActivityTypeStandard()
        && !task.isFullscreenRootForStageTask()
        && task.isVisible();
  }
    ...
    if (findCollectingChangeInfo == null || findCollectingChangeInfo.mChangeLeash == null) {
      Transition createTransition =
          !this.mTransitionController.isCollecting()
              ? this.mTransitionController.createTransition(6)
              : null;
  ...
  public final void addHidingContainerLeashIfNeeded(Task task, int i, int i2) {
    ...
    if (!CoreRune.FW_CUSTOM_LETTERBOX
        || i != 1
        || i2 != 5
        || (collectingTransition = this.mTransitionController.getCollectingTransition()) == null
        || (changeInfo = (Transition.ChangeInfo) collectingTransition.mChanges.get(task)) == null
        || (activity = task.getActivity(new ChangeTransitionController$$ExternalSyntheticLambda1()))
            == null) {
      return;
    }
    Rect letterboxInsets = activity.mLetterboxUiController.getLetterboxInsets();
    if ((letterboxInsets.left == 0
            && letterboxInsets.top == 0
            && letterboxInsets.right == 0
            && letterboxInsets.bottom == 0)
        || (changeInfo2 = (Transition.ChangeInfo) collectingTransition.mChanges.get(activity))
            == null) {
      return;
    }
    if (changeInfo2.mAbsoluteBounds.width() == changeInfo.mAbsoluteBounds.width()
        && changeInfo2.mAbsoluteBounds.height() == changeInfo.mAbsoluteBounds.height()) {
      return;
    }
  ...
  public final void requestChangeTransition(
      Task task, int i, int i2, Rect rect, String str, int i3) {
    String str2;
    Transition.ChangeInfo findCollectingChangeInfo = findCollectingChangeInfo(task);
    if (findCollectingChangeInfo != null && findCollectingChangeInfo.mChangeLeash != null) {
      Slog.d(
          "ChangeTransitionController",
          "requestStartChangeTransition: skip, already collecting, #"
              + task.mTaskId
              + ", reason="
              + str);
      return;
  ...
  public final void updateChangeInfo(
      WindowContainer windowContainer, int i, int i2, Rect rect, String str, int i3) {
    String str2;
    if (!this.mTransitionController.isCollecting()) {
      Slog.w(
          "ChangeTransitionController",
          "updateChangeInfo: failed, collecting false, wc=" + windowContainer);
      return;
    }
    ...
    if (findCollectingChangeInfo == null) {
      Slog.w(
          "ChangeTransitionController",
          "updateChangeInfo: failed, changeInfo is null, wc=" + windowContainer);
      return;
    }
    ...
    if (CoreRune.MW_FREEFORM_SHELL_TRANSITION && z) {
      int stringToFreeformCaptionType =
          (CoreRune.MW_SHELL_FREEFORM_CAPTION_TYPE && i == 3)
              ? MultiWindowManager.stringToFreeformCaptionType(str)
              : -1;
      int freeformThickness = windowContainer.getFreeformThickness();
      findCollectingChangeInfo.mFreezeOutsets.set(
          freeformThickness,
          windowContainer.getCaptionHeight(true, stringToFreeformCaptionType) + freeformThickness,
          freeformThickness,
          freeformThickness);
      if (windowContainer.inSplitScreenWindowingMode()
  ...
  public boolean isInChangeTransition(WindowContainer windowContainer) {
    ...
    return (collectingTransition == null
            || (changeInfo =
                    (Transition.ChangeInfo) collectingTransition.mChanges.get(windowContainer))
                == null
  ...
  public void adjustFreezeBoundsIfNeeded(WindowContainer windowContainer, Rect rect) {
    ...
    if (collectingTransition == null
        || (changeInfo = (Transition.ChangeInfo) collectingTransition.mChanges.get(windowContainer))
            == null
        || !hasFreezeOutsets(changeInfo)) {
      return;
    }
    int i = rect.left;
    ...
    Slog.d(
        "ChangeTransitionController",
        "adjustFreezeBoundsIfNeeded: wc="
            + windowContainer
            + ", freezeBounds="
            + rect
            + ", outset="
            + changeInfo.mFreezeOutsets);
  }
  ...
  public void createChangeLeashIfNeeded(
      WindowContainer windowContainer, SurfaceControl.Transaction transaction, Rect rect) {
    Transition.ChangeInfo findCollectingChangeInfo = findCollectingChangeInfo(windowContainer);
    ...
    if (parent == null
        ...
        || findCollectingChangeInfo.mChangeTransitMode == 0) {
      return;
    }
    ...
    SurfaceControl build =
        windowContainer
            .makeAnimationLeash()
            .setName(getChangeLeashName(windowContainer))
            .setParent(anchorLayer)
            .build();
  ...
  public static float getCornerRadiusForChangeLeash(WindowContainer windowContainer) {
    ...
    if (windowContainer.asActivityRecord() != null
        && windowContainer.asActivityRecord().mPopOverState.isActivated()
        && windowContainer.getDisplayContent() != null) {
      dipToPixel =
          WindowManagerService.dipToPixel(26, windowContainer.mDisplayContent.getDisplayMetrics());
    } else {
      ...
      dipToPixel =
          WindowManagerService.dipToPixel(12, windowContainer.mDisplayContent.getDisplayMetrics());
    }
    return dipToPixel;
  }
  ...
  public void updateChangeOutsetsIfNeeded(
    ...
    if (asTask.inFreeformWindowingMode()) {
      ...
      int freeformThickness = windowContainer.getFreeformThickness();
      change.setChangeEndOutsets(
          new Rect(
              freeformThickness,
              captionHeight + freeformThickness,
              freeformThickness,
              freeformThickness));
    }
    if (change.hasChangeStartOutsets() || change.hasChangeEndOutsets()) {
      Slog.d(
          "ChangeTransitionController",
          "updateChangeOutsetsIfNeeded: s="
              + change.getChangeStartOutsets()
              + ", e="
              + change.getChangeEndOutsets()
              + ", wc="
              + windowContainer);
    }
  }

  public static SurfaceControl getAnchorLayer(
      Transition.ChangeInfo changeInfo, TaskDisplayArea taskDisplayArea) {
    NaturalSwitchingController naturalSwitchingController;
    DisplayArea dragTargetArea;
    if (CoreRune.MW_FREEFORM_SHELL_TRANSITION
        && (changeInfo.mWindowingMode == 5 || (changeInfo.mChangeTransitFlags & 1) != 0)) {
      return taskDisplayArea.mFloatingLeashAnchor;
    }
    if (CoreRune.MW_SPLIT_SHELL_TRANSITION
        && changeInfo.mContainer.getParentSurfaceControl() != null
        && changeInfo.mChangeTransitMode == 6) {
    ...
    if (CoreRune.MW_NATURAL_SWITCHING_PIP
        && asTask != null
        && (dragTargetArea =
                (naturalSwitchingController = asTask.mAtmService.mNaturalSwitchingController)
                    .getDragTargetArea())
            != null
        && dragTargetArea.getSurfaceControl() != null
        && naturalSwitchingController.isNaturalSwitchingPipTask(asTask)) {
  ...
  public static boolean isTransparentSnapshotTarget(Transition.ChangeInfo changeInfo) {
    if (CoreRune.MW_FREEFORM_SHELL_TRANSITION
        && changeInfo.mChangeTransitMode != 0
        && changeInfo.mWindowingMode == 5) {
      return true;
    }
  ...
  public static boolean isWallpaperTargetTask(WindowContainer windowContainer) {
    ...
    return (asTask == null
            || displayContent == null
            || !displayContent.mWallpaperController.isWallpaperVisible()
            || displayContent.mWallpaperController.getWallpaperTarget() == null
            || displayContent.mWallpaperController.getWallpaperTarget().getTask() != asTask)
        ? false
        : true;
  }

  public void collectExcludeLayersFromSnapshot(
      WindowContainer windowContainer, ArrayList arrayList) {
    WindowState window;
    DisplayContent displayContent = windowContainer.getDisplayContent();
    Task asTask = windowContainer.asTask();
    if (asTask == null
        ...
        || (window =
                asTask.getWindow(
                    new Predicate() { // from class:
                                      // com.android.server.wm.ChangeTransitionController$$ExternalSyntheticLambda3
                      @Override // java.util.function.Predicate
                      public final boolean test(Object obj) {
                        boolean lambda$collectExcludeLayersFromSnapshot$2;
                        lambda$collectExcludeLayersFromSnapshot$2 =
                            ChangeTransitionController.lambda$collectExcludeLayersFromSnapshot$2(
                                (WindowState) obj);
                        return lambda$collectExcludeLayersFromSnapshot$2;
                      }
                    }))
            == null
        || arrayList.contains(window.mSurfaceControl)) {
      return;
    }
    arrayList.add(window.mSurfaceControl);
    Slog.d(
        "ChangeTransitionController",
        "collectExcludeLayersFromSnapshot: #" + asTask.mTaskId + ", exclude=" + window);
  }

  public static /* synthetic */ boolean lambda$collectExcludeLayersFromSnapshot$2(
      WindowState windowState) {
    return windowState.isChildWindow() && windowState.isOnScreen() && windowState.mAnimatingExit;
  }

  public void onSnapshotSurfaceCreated(
      WindowContainer windowContainer, Rect rect, Transition.ChangeInfo changeInfo) {
    String str;
    StringBuilder sb = new StringBuilder();
      ...
      if (this.mTransitionToChangingPipTask.containsKey(transition)) {
        Slog.d(
            ...
            "onTransitionAborted: "
                + transition
                + ", changingPipTasks="
                + this.mTransitionToChangingPipTask);
  ...
  public void onActivityLocalRelaunched(ActivityRecord activityRecord) {
    ...
    if (task == null || activityRecord.allDrawn || !isInChangeTransition(task)) {
      Slog.w(
          "ChangeTransitionController", "onActivityLocalRelaunched: failed, r=" + activityRecord);
      return;
    }
  ...
  public void addToSyncDeferredForAllDrawn(ActivityRecord activityRecord, String str) {
    ...
    Slog.d(
        "ChangeTransitionController",
        "addToSyncDeferredForAllDrawn: r="
            + activityRecord
            + ", reason="
            + str
            + ", num_remain="
            + this.mSyncDeferredAllDrawnApps.size());
    if (this.mSyncDeferredAllDrawnApps.size() == 1) {
      this.f1735mH.removeMessages(1);
      this.f1735mH.sendEmptyMessageDelayed(1, 2000L);
    }
  }
  ...
  public void removeFromSyncDeferredForAllDrawn(ActivityRecord activityRecord, String str) {
    if (this.mSyncDeferredAllDrawnApps.contains(activityRecord)) {
      ...
      Slog.d(
          "ChangeTransitionController",
          "removeFromSyncDeferredForAllDrawn: r="
              + activityRecord
              + ", reason="
              + str
              + ", num_remain="
  ...
  public void requestDisplayChangeTransition(int i, String str, boolean z) {
    ...
    if (CoreRune.MW_SHELL_DISPLAY_CHANGE_TRANSITION) {
      ...
      if (displayContent == null) {
        Slog.w(
            "ChangeTransitionController",
            "requestDisplayChangeTransition: cannot find display #" + i);
        return;
      }
      ...
      TransitionRequestInfo.DisplayChange displayChange =
          z2
              ? new TransitionRequestInfo.DisplayChange(
                  displayContent.getDisplayId(), rotation, rotation)
              : null;
      StringBuilder sb = new StringBuilder();
      ...
      if (collectingTransition == null) {
        Slog.e(
            "ChangeTransitionController",
            "requestDisplayChangeTransition: failed, collecting transition is null!");
        return;
      }
  ...
  public static void applyForceChangeIfNeeded(Transition transition) {
    ...
    for (int size = arrayMap.size() - 1; size >= 0; size--) {
      ...
      WindowContainer windowContainer = changeInfo.mContainer;
      Transition.ChangeInfo changeInfo2 =
          (Transition.ChangeInfo) arrayMap.get(windowContainer.getDisplayContent());
      if (changeInfo2 != null
          && (changeInfo2.mFlags & 65536) != 0
          && arrayMap.get(windowContainer.getTaskDisplayArea()) != null) {
  ...
  public static void collectFreeformTasksIfNeeded(final Transition transition) {
    ...
    if (z
        ...
        && windowContainer.getTaskDisplayArea() != null
        && (taskBelow = windowContainer.getTaskDisplayArea().getTaskBelow(windowContainer.asTask()))
            != null
        && taskBelow.inFreeformWindowingMode()) {
    ...
    while (it.hasNext()) {
      ((TaskDisplayArea) it.next())
          .forAllRootTasks(
              new Consumer() { // from class:
                               // com.android.server.wm.ChangeTransitionController$$ExternalSyntheticLambda4
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  ChangeTransitionController.lambda$collectFreeformTasksIfNeeded$3(
                      Transition.this, (Task) obj);
                }
              });
    }
  }

  public static /* synthetic */ void lambda$collectFreeformTasksIfNeeded$3(
      Transition transition, Task task) {
    if (!task.isVisible()
        || !task.isVisibleRequested()
        || !task.inFreeformWindowingMode()
        || transition.mChanges.containsKey(task)
        || transition.mParticipants.contains(task)
  ...
  public static boolean isFreeformChangeTransition(Transition.ChangeInfo changeInfo) {
    ...
    if ((i != 5 && windowingMode != 5)
        || i == windowingMode
        || changeInfo.mChangeLeash == null
        || changeInfo.mChangeTransitMode == 0
        || changeInfo.mContainer.asTask() == null
        || changeInfo.mContainer.getTaskDisplayArea() == null) {
      return false;
    }
    Slog.d(
        "ChangeTransitionController",
        "isFreeformChangeTransition: "
            ...
            + windowingMode
            + "), "
            + MultiWindowManager.changeTransitModeToString(changeInfo.mChangeTransitMode));
    return true;
  }
  ...
  public void handleEnteringPipIfNeeded(ActivityRecord activityRecord, Transition transition) {
    if (!activityRecord.mAutoEnteringPip
        && activityRecord.getState() == ActivityRecord.State.PAUSED
        && transition != null
        && transition.mType == 10
        && activityRecord.getDisplayContent().hasTopFixedRotationLaunchingApp()) {
  ...
  public final void restoreLastParentBeforePip(Transition transition) {
    ...
    if (task != null && task.isAttached() && task.isVisible()) {
      ...
      Task lastParentBeforePip =
          topVisibleActivity != null ? topVisibleActivity.getLastParentBeforePip() : null;
      if (lastParentBeforePip == null
          || !lastParentBeforePip.isAttached()
          || lastParentBeforePip == topVisibleActivity.getTask()) {
        return;
      }
      ...
      if (topRootTaskInStageType == null || !taskDisplayArea.isSplitScreenVisible()) {
        Slog.w(
            "ChangeTransitionController",
            "restoreLastParentBeforePip: invalid stage, "
                + topRootTaskInStageType
                + "r="
                + topVisibleActivity);
        return;
      }
      ...
      try {
        Slog.d(
            "ChangeTransitionController",
            "restoreLastParentBeforePip: r="
                + topVisibleActivity
                + ", lastParent="
                + lastParentBeforePip);
        lastParentBeforePip.reparent(
            topRootTaskInStageType, Integer.MAX_VALUE, false, "restoreLastParentBeforePip");
        topVisibleActivity.reparent(
            lastParentBeforePip, lastParentBeforePip.getChildCount(), "restoreLastParentBeforePip");
  ...
  public final Transition.ChangeInfo findCollectingChangeInfo(WindowContainer windowContainer) {
    if (this.mTransitionController.isCollecting()) {
      return (Transition.ChangeInfo)
          this.mTransitionController.getCollectingTransition().mChanges.get(windowContainer);
    }
    return null;
  }

  public static void restoreFromChangeLeash(
      Transition.ChangeInfo changeInfo, BiFunction biFunction, Function function) {
    WindowContainer windowContainer;
    try {
      if (changeInfo.mChangeLeash != null
          && (windowContainer = changeInfo.mContainer) != null
          && windowContainer.getParent() != null) {
        SurfaceControl.Transaction transaction =
            (SurfaceControl.Transaction) windowContainer.mWmService.mTransactionFactory.get();
        ...
        if (surfaceControl != null && surfaceControl2 != null) {
          ...
          Slog.d(
              "ChangeTransitionController",
              "restoreFromChangeLeash. cause wc is not target for transition.");
        }
      }
    } catch (Exception e) {
      e.printStackTrace();
  ...
  /* renamed from: com.android.server.wm.ChangeTransitionController$H */
  public final class HandlerC2887H extends Handler {
    public HandlerC2887H(Looper looper) {
      super(looper);
    }
        ...
        try {
          Slog.w(
              ...
              "SYNC_ACTIVITY_TIMEOUT!! "
                  + ChangeTransitionController.this.mSyncDeferredAllDrawnApps);
