...
public final class AppTransition implements DumpUtils.Dump {
    ...
    public final AppTransition$$ExternalSyntheticLambda2 mHandleAppTransitionTimeoutRunnable =
            new Runnable() { // from class:
                             // com.android.server.wm.AppTransition$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    AppTransition appTransition = AppTransition.this;
                    WindowManagerGlobalLock windowManagerGlobalLock =
                            appTransition.mService.mGlobalLock;
                        ...
                        try {
                            ...
                            for (int i = 0; i < appTransition.mListeners.size(); i++) {
                                ((WindowManagerInternal.AppTransitionListener)
                                                appTransition.mListeners.get(i))
                            ...
                            if (appTransition.isTransitionSet()
                                ...
                                if (ProtoLogImpl_54989576.Cache.WM_DEBUG_APP_TRANSITIONS_enabled[
                                        1]) {
                                    ProtoLogImpl_54989576.v(
                                            ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS,
                                            5233255302148535928L,
                                            349,
                                            null,
                                            ...
                                            Long.valueOf(
                                                    displayContent.mChangingContainers.size()));
                                }
                                appTransition.mAppTransitionState = 3;
                                appTransition.updateBooster();
                                appTransition.mService.mWindowPlacerLocked.performSurfacePlacement(
                                        false);
                            }
                            WindowManagerService.resetPriorityAfterLockedSection();
                        } catch (Throwable th) {
    ...
    public AppTransition(
        ...
        this.mTransitionAnimation =
                new TransitionAnimation(
                        context,
                        ProtoLogImpl_54989576.isEnabled(
                                ProtoLogGroup.WM_DEBUG_ANIM, LogLevel.DEBUG),
                        "WindowManager");
    ...
    public final void dump(PrintWriter printWriter, String str) {
        ...
        if (this.mNextAppTransitionOverrideRequested || this.mNextAppTransitionType == 1) {
            ...
            ProcessList$$ExternalSyntheticOutline0.m(
                    printWriter, this.mNextAppTransitionPackage, str, "mNextAppTransitionEnter=0x");
        ...
        switch (this.mNextAppTransitionType) {
            case 2:
                ...
                if (appTransitionAnimationSpec == null
                        || (rect = appTransitionAnimationSpec.rect) == null) {
                    Slog.e(
                            "WindowManager",
                ...
                BroadcastStats$$ExternalSyntheticOutline0.m(
                        this.mTmpRect.top, printWriter, str, "mNextAppTransitionStartWidth=");
        ...
        if (this.mLastUsedAppTransition != 0) {
            ...
            ProcessList$$ExternalSyntheticOutline0.m(
                    printWriter, this.mLastOpeningApp, str, "mLastClosingApp=");
            ProcessList$$ExternalSyntheticOutline0.m(
                    printWriter, this.mLastClosingApp, str, "mLastChangingApp=");
    ...
    public final int goodToGo(final int i, ActivityRecord activityRecord) {
        ...
        long statusBarTransitionsStartTime =
                animation != null
                        ? animation.getStatusBarTransitionsStartTime()
                        : SystemClock.uptimeMillis();
        for (int i2 = 0; i2 < this.mListeners.size(); i2++) {
            ((WindowManagerInternal.AppTransitionListener) this.mListeners.get(i2))
                    .onAppTransitionStartingLocked(statusBarTransitionsStartTime);
        }
        ...
        if (remoteAnimationController != null) {
            ...
            if (remoteAnimationController.mCanceled) {
                ...
                remoteAnimationController.mHandler.postDelayed(
                        remoteAnimationController.mTimeoutRunnable,
                        (long)
                                (remoteAnimationController.mService.getCurrentAnimatorScale()
                                        * 10000.0f));
                RemoteAnimationController.FinishedCallback finishedCallback =
                        new RemoteAnimationController.FinishedCallback();
                finishedCallback.mOuter = remoteAnimationController;
                remoteAnimationController.mFinishedCallback = finishedCallback;
                if (zArr[0]) {
                    ProtoLogImpl_54989576.d(
                            ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS,
                            7094394833775573933L,
                            0,
                            null,
                            null);
                }
                ArrayList arrayList2 = new ArrayList();
                for (int size = remoteAnimationController.mPendingAnimations.size() - 1;
                        size >= 0;
                        size--) {
                    RemoteAnimationController.RemoteAnimationRecord remoteAnimationRecord =
                            (RemoteAnimationController.RemoteAnimationRecord)
                                    remoteAnimationController.mPendingAnimations.get(size);
                    RemoteAnimationController.RemoteAnimationAdapterWrapper
                            remoteAnimationAdapterWrapper = remoteAnimationRecord.mAdapter;
                    ...
                    if (remoteAnimationAdapterWrapper == null
                            ...
                            || remoteAnimationAdapterWrapper.mCapturedLeash == null) {
                        remoteAnimationTarget = null;
                    } else {
                        remoteAnimationTarget =
                                windowContainer.createRemoteAnimationTarget(remoteAnimationRecord);
                    ...
                    if (remoteAnimationTarget != null) {
                        ...
                        if (zArr[0]) {
                            ProtoLogImpl_54989576.d(
                                    ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS,
                                    -4411631520586057580L,
                                    0,
                                    null,
                                    String.valueOf(windowContainer));
                        }
                        RemoteAnimationController.RemoteAnimationAdapterWrapper
                                remoteAnimationAdapterWrapper2 = remoteAnimationRecord.mAdapter;
                        if (remoteAnimationAdapterWrapper2 != null
                                && (onAnimationFinishedCallback2 =
                                                remoteAnimationAdapterWrapper2
                                                        .mCapturedFinishCallback)
                                        != null) {
                            onAnimationFinishedCallback2.onAnimationFinished(
                                    remoteAnimationAdapterWrapper2.mAnimationType,
                                    remoteAnimationAdapterWrapper2);
                        }
                        RemoteAnimationController.RemoteAnimationAdapterWrapper
                                remoteAnimationAdapterWrapper3 =
                                        remoteAnimationRecord.mThumbnailAdapter;
                        if (remoteAnimationAdapterWrapper3 != null
                                && (onAnimationFinishedCallback =
                                                remoteAnimationAdapterWrapper3
                                                        .mCapturedFinishCallback)
                                        != null) {
                            onAnimationFinishedCallback.onAnimationFinished(
                                    remoteAnimationAdapterWrapper3.mAnimationType,
                                    remoteAnimationAdapterWrapper3);
                        }
                ...
                if (remoteAnimationTargetArr.length != 0 || i == 22 || i == 33 || i == 23) {
                    ...
                    if (zArr[0]) {
                        ProtoLogImpl_54989576.d(
                                ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS,
                                -7002230949892506736L,
                                0,
                                null,
                                null);
                    }
                    final RemoteAnimationTarget[] startWallpaperAnimations =
                            WallpaperAnimationAdapter.startWallpaperAnimations(
                                    remoteAnimationController.mDisplayContent,
                                    remoteAnimationController.mRemoteAnimationAdapter.getDuration(),
                                    ...
                                    new Consumer() { // from class:
                                        ...
                                        public final void accept(Object obj) {
                                            RemoteAnimationController remoteAnimationController2 =
                                                    RemoteAnimationController.this;
                                            WallpaperAnimationAdapter wallpaperAnimationAdapter =
                                                    (WallpaperAnimationAdapter) obj;
                                            WindowManagerGlobalLock windowManagerGlobalLock =
                                                    remoteAnimationController2.mService.mGlobalLock;
                                            WindowManagerService.boostPriorityForLockedSection();
                                            synchronized (windowManagerGlobalLock) {
                                                try {
                                                    remoteAnimationController2
                                                            .mPendingWallpaperAnimations.remove(
                    ...
                    if (i == 20 || i == 21) {
                        ...
                        windowManagerService.mRoot.forAllWindows(
                                new Consumer() { // from class:
                                                 // com.android.server.wm.NonAppWindowAnimationAdapter$$ExternalSyntheticLambda0
                                    @Override // java.util.function.Consumer
                                    public final void accept(Object obj) {
                                        ...
                                        if (windowState.mActivityRecord == null
                                                && windowState.canBeHiddenByKeyguard()
                                                && windowState.wouldBeVisibleIfPolicyIgnored()
                                                && !windowState.isVisible()
                                                && windowState
                                                        != windowManagerService2.mRoot
                                                                .getCurrentInputMethodWindow()) {
                                            NonAppWindowAnimationAdapter
                                                    nonAppWindowAnimationAdapter =
                                                            new NonAppWindowAnimationAdapter(
                                                                    windowState, j, j2);
                                ...
                                true);
                    } else if (NonAppWindowAnimationAdapter.shouldAttachNavBarToApp(
                            windowManagerService, displayContent, i)) {
                        ...
                        NonAppWindowAnimationAdapter nonAppWindowAnimationAdapter =
                                new NonAppWindowAnimationAdapter(
                                        windowState.mToken, duration, statusBarTransitionDelay);
                    ...
                    final RemoteAnimationTarget[] remoteAnimationTargetArr2 =
                            (RemoteAnimationTarget[])
                                    arrayList.toArray(new RemoteAnimationTarget[arrayList.size()]);
                    remoteAnimationController.mService.mAnimator.addAfterPrepareSurfacesRunnable(
                            new Runnable() { // from class:
                                    ...
                                    try {
                                        if (!remoteAnimationController2.mLinkedToDeathOfRunner) {
                                            remoteAnimationController2
                                                    ...
                                                    .getRunner()
                                                    .asBinder()
                                                    .linkToDeath(remoteAnimationController2, 0);
                                            remoteAnimationController2.mLinkedToDeathOfRunner =
                                                    true;
                                        }
                                        if (zArr2[0]) {
                                            ProtoLogImpl_54989576.d(
                                                    ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS,
                                                    -2525509826755873433L,
                                                    84,
                                                    null,
                                                    String.valueOf(
                                                            AppTransition.appTransitionOldToString(
                                                                    i3)),
                                                    Long.valueOf(remoteAnimationTargetArr3.length),
                                                    Long.valueOf(remoteAnimationTargetArr4.length),
                                                    Long.valueOf(remoteAnimationTargetArr5.length));
                                        }
                                        ArrayList arrayList5 = AppTransition.sFlagToString;
                                        if (i3 == 22 || i3 == 33 || i3 == 23) {
                                            EventLog.writeEvent(
                                                    31008,
                                                    Integer.valueOf(i3 == 23 ? 0 : 1),
                                                    1,
                                                    Integer.valueOf(i3),
                                                    "onAnimationStart");
                                        }
                                        remoteAnimationController2
                                                ...
                                                .onAnimationStart(
                                                        ...
                                                        remoteAnimationTargetArr4,
                                                        remoteAnimationTargetArr5,
                                                        remoteAnimationController2
                                                                .mFinishedCallback);
                                    } catch (RemoteException e) {
                                        Slog.e(
                                                "WindowManager",
                                                "Failed to start remote animation",
                                                e);
                                        remoteAnimationController2.onAnimationFinished();
                                    }
                                    ProtoLogGroup protoLogGroup =
                                            ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS;
                                    if (ProtoLogImpl_54989576.isEnabled(
                                            protoLogGroup, LogLevel.DEBUG)) {
                                        if (zArr2[0]) {
                                            ProtoLogImpl_54989576.d(
                                                    protoLogGroup,
                                                    -1148281153370899511L,
                                                    0,
                                                    null,
                                                    null);
                                        }
                                        ...
                                        PrintWriter fastPrintWriter =
                                                new FastPrintWriter(stringWriter);
                                        for (int size2 =
                                                        remoteAnimationController2
                                        ...
                                        if (zArr2[2]) {
                                            ProtoLogImpl_54989576.i(
                                                    ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS,
                                                    -2676700429940607853L,
                                                    0,
                                                    null,
                                                    String.valueOf(stringWriter.toString()));
                                        }
                                    }
                                }
                            });
                    ...
                    if (zArr[0]) {
                        ProtoLogImpl_54989576.d(
                                ProtoLogGroup.WM_DEBUG_REMOTE_ANIMATIONS,
                                6727618365838540075L,
                                1,
                                null,
                                Long.valueOf(remoteAnimationController.mPendingAnimations.size()));
                    }
                    remoteAnimationController.onAnimationFinished();
                    remoteAnimationController.invokeAnimationCancelled("no_app_targets");
                }
            }
        } else if ((i == 8 || i == 16 || i == 10 || i == 12)
                && animation != null
                && !z
                && this.mDisplayContent.mDisplayPolicy.shouldAttachNavBarToAppDuringTransition()
                && this.mService.mRecentsAnimationController == null) {
            new NavBarFadeAnimationController(this.mDisplayContent)
                    .fadeOutAndInSequentially(
                            animation.getDurationHint(), activityRecord.mSurfaceControl);
        }
        return 0;
    }
    ...
    public final void overridePendingAppTransition(
            String str,
            int i,
            int i2,
            int i3,
    ...
    public final void overridePendingAppTransitionMultiThumb(
        ...
        if (canOverridePendingAppTransition()) {
            ...
            if (appTransitionAnimationSpecArr != null) {
                for (int i = 0; i < appTransitionAnimationSpecArr.length; i++) {
                    AppTransitionAnimationSpec appTransitionAnimationSpec =
                            appTransitionAnimationSpecArr[i];
                    if (appTransitionAnimationSpec != null) {
                        Predicate obtainPredicate =
                                PooledLambda.obtainPredicate(
                                        new AppTransition$$ExternalSyntheticLambda1(),
    ...
    public final void overridePendingAppTransitionMultiThumbFuture(
        ...
        if (canOverridePendingAppTransition()) {
            ...
            if (!isReady()
                    || (iAppTransitionAnimationSpecsFuture2 =
            ...
            this.mDefaultExecutor.execute(
                    new AppTransition$$ExternalSyntheticLambda0(
                            this, iAppTransitionAnimationSpecsFuture2));
        }
    }

    public final void overridePendingAppTransitionRemote(
        ...
        if (ProtoLogImpl_54989576.Cache.WM_DEBUG_APP_TRANSITIONS_enabled[2]) {
            ProtoLogImpl_54989576.i(
                    ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS,
                    6217525691846442213L,
                    3,
                    null,
                    Boolean.valueOf(isTransitionSet()),
                    String.valueOf(remoteAnimationAdapter));
        }
        ...
        if (iRemoteCallback != null) {
            this.mHandler.sendMessage(
                    PooledLambda.obtainMessage(
                            new AppTransition$$ExternalSyntheticLambda3(0), iRemoteCallback));
    ...
    public final void putDefaultNextAppTransitionCoordinates(
        ...
        this.mDefaultNextAppTransitionAnimationSpec =
                new AppTransitionAnimationSpec(
                        -1, hardwareBuffer, new Rect(i, i2, i3 + i, i4 + i2));
    }

    public final void registerListenerLocked(
            WindowManagerInternal.AppTransitionListener appTransitionListener) {
        this.mListeners.add(appTransitionListener);
    }

    public final void setLastAppTransition(
            int i,
    ...
    public final void updateBooster() {
        int i;
        WindowManagerThreadPriorityBooster windowManagerThreadPriorityBooster =
                WindowManagerService.sThreadPriorityBooster;
        boolean z =
                !this.mNextAppTransitionRequests.isEmpty()
            ...
            try {
                if (windowManagerThreadPriorityBooster.mAppTransitionRunning != z) {
                    ...
                    Process.setThreadPriority(
                            windowManagerThreadPriorityBooster.mAnimationThreadId, i2);
                    Process.setThreadPriority(
                            windowManagerThreadPriorityBooster.mSurfaceAnimationThreadId, i2);
                }
            } catch (Throwable th) {
                throw th;
            }
