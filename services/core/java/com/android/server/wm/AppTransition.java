...
public class AppTransition implements DumpUtils.Dump {
  ...
  public final Runnable mHandleAppTransitionTimeoutRunnable =
      new Runnable() { // from class: com.android.server.wm.AppTransition$$ExternalSyntheticLambda3
        @Override // java.lang.Runnable
        public final void run() {
          AppTransition.this.lambda$new$0();
        }
      };
  public final boolean mGridLayoutRecentsEnabled =
      SystemProperties.getBoolean("ro.recents.grid", false);
  ...
  */
  ...
  public void registerKeygaurdExitAnimationStartListener(
      WindowManagerInternal.KeyguardExitAnimationStartListener
          keyguardExitAnimationStartListener) {}

  public AppTransition(
      Context context, WindowManagerService windowManagerService, DisplayContent displayContent) {
    this.mContext = context;
    this.mService = windowManagerService;
    this.mHandler = new Handler(windowManagerService.f1749mH.getLooper());
    this.mDisplayContent = displayContent;
    this.mTransitionAnimation =
        new TransitionAnimation(
            context,
            ProtoLogImpl.isEnabled(ProtoLogGroup.WM_DEBUG_ANIM),
            StartingSurfaceController.TAG);
    TypedArray obtainStyledAttributes =
        context.getTheme().obtainStyledAttributes(R.styleable.Window);
  ...
  public void setLastAppTransition(
      int i,
  ...
  public Animation getNextAppRequestedAnimation(boolean z) {
    Animation loadAppTransitionAnimation =
        this.mTransitionAnimation.loadAppTransitionAnimation(
            this.mNextAppTransitionPackage,
            z ? this.mNextAppTransitionEnter : this.mNextAppTransitionExit);
  ...
  public HardwareBuffer getAppTransitionThumbnailHeader(WindowContainer windowContainer) {
    AppTransitionAnimationSpec appTransitionAnimationSpec =
        (AppTransitionAnimationSpec)
            this.mNextAppTransitionAnimationsSpecs.get(windowContainer.hashCode());
  ...
  public int goodToGo(int i, ActivityRecord activityRecord) {
    ...
    WindowContainer animatingContainer =
        activityRecord != null ? activityRecord.getAnimatingContainer() : null;
    AnimationAdapter animation =
        animatingContainer != null ? animatingContainer.getAnimation() : null;
    if (animation != null) {
    ...
    } else if ((isTaskOpenTransitOld(i) || i == 12)
        && animation != null
        && !z
        && this.mDisplayContent.getDisplayPolicy().shouldAttachNavBarToAppDuringTransition()
        && this.mService.getRecentsAnimationController() == null) {
      new NavBarFadeAnimationController(this.mDisplayContent)
          .fadeOutAndInSequentially(
              animation.getDurationHint(), null, activityRecord.getSurfaceControl());
    }
  ...
  public final boolean needsBoosting() {
    int i;
    return !this.mNextAppTransitionRequests.isEmpty()
        || (i = this.mAppTransitionState) == 1
        || i == 2
        || (this.mService.getRecentsAnimationController() != null);
  }

  public void registerListenerLocked(
  ...
  public void notifyAppTransitionFinishedLocked(IBinder iBinder) {
    for (int i = 0; i < this.mListeners.size(); i++) {
      ((WindowManagerInternal.AppTransitionListener) this.mListeners.get(i))
          .onAppTransitionFinishedLocked(iBinder);
    }
  }
  ...
  public final void notifyAppTransitionCancelledLocked(boolean z) {
    for (int i = 0; i < this.mListeners.size(); i++) {
      ((WindowManagerInternal.AppTransitionListener) this.mListeners.get(i))
          .onAppTransitionCancelledLocked(z);
    }
  }
  ...
  public final int notifyAppTransitionStartingLocked(long j, long j2) {
    ...
    for (int i2 = 0; i2 < this.mListeners.size(); i2++) {
      i |=
          ((WindowManagerInternal.AppTransitionListener) this.mListeners.get(i2))
              .onAppTransitionStartingLocked(j, j2);
    }
    return i;
  }
  ...
  public final void getDefaultNextAppTransitionStartRect(Rect rect) {
    Rect rect2;
    AppTransitionAnimationSpec appTransitionAnimationSpec =
        this.mDefaultNextAppTransitionAnimationSpec;
  ...
  public final void putDefaultNextAppTransitionCoordinates(
      int i, int i2, int i3, int i4, HardwareBuffer hardwareBuffer) {
    this.mDefaultNextAppTransitionAnimationSpec =
        new AppTransitionAnimationSpec(-1, hardwareBuffer, new Rect(i, i2, i3 + i, i4 + i2));
  }
  ...
  public Animation createThumbnailAspectScaleAnimationLocked(
    ...
    AppTransitionAnimationSpec appTransitionAnimationSpec2 =
        this.mDefaultNextAppTransitionAnimationSpec;
    return transitionAnimation.createThumbnailAspectScaleAnimationLocked(
        rect,
        rect2,
        hardwareBuffer,
        i,
        ...
        this.mNextAppTransitionScaleUp);
  }

  public boolean canSkipFirstFrame() {
    int i = this.mNextAppTransitionType;
    return (i == 1
            || this.mNextAppTransitionOverrideRequested
            || i == 7
            || i == 8
            || this.mNextAppTransitionRequests.contains(7))
        ? false
        : true;
  }
  ...
  public Animation loadAnimation(
    ...
    if (this.mService.mExt.mExtraDisplayPolicy.shouldSkipAppTransition(
        this.mDisplayContent.getDisplayId())) {
      return null;
    }
    if (CoreRune.SYSFW_APP_SPEG
        && (windowContainer.getDisplayContent().getDisplayInfo().flags & 32768) != 0) {
    ...
    if (isKeyguardGoingAwayTransitOld(i) && z) {
      animation2 =
          this.mTransitionAnimation.loadKeyguardExitAnimation(
              this.mNextAppTransitionFlags, i == 21);
    } else if (i != 22 && i != 33) {
      if (i == 23 && !z) {
        ...
        if (z2 && (i == 6 || i == 8 || i == 10)) {
          createAspectScaledThumbnailEnterExitAnimationLocked =
              this.mTransitionAnimation.loadVoiceActivityOpenAnimation(z);
          if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
            ProtoLogImpl.v(
                ...
                (String) null,
                new Object[] {
                  String.valueOf(createAspectScaledThumbnailEnterExitAnimationLocked),
                  String.valueOf(appTransitionOldToString(i)),
                  Boolean.valueOf(z),
          ...
          createAspectScaledThumbnailEnterExitAnimationLocked =
              this.mTransitionAnimation.loadVoiceActivityExitAnimation(z);
          if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
            ProtoLogImpl.v(
                ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS_ANIM,
                508887531,
          ...
          createAspectScaledThumbnailEnterExitAnimationLocked =
              transitionAnimation.createRelaunchAnimation(rect, rect6, rect7);
          if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
            ProtoLogImpl.v(
                ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS_ANIM,
                -1800899273,
          ...
          if (i7 == 1) {
            ...
            createAspectScaledThumbnailEnterExitAnimationLocked =
                this.mTransitionAnimation.loadAppTransitionAnimation(
                    this.mNextAppTransitionPackage, this.mNextAppTransitionInPlace);
            if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
              ProtoLogImpl.v(
                  ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS_ANIM,
                  1457990604,
            ...
            AppTransitionAnimationSpec appTransitionAnimationSpec2 =
                this.mDefaultNextAppTransitionAnimationSpec;
            createAspectScaledThumbnailEnterExitAnimationLocked =
                transitionAnimation2.createClipRevealAnimationLockedCompat(
                    i,
                    z,
                    rect,
                    rect2,
            ...
            AppTransitionAnimationSpec appTransitionAnimationSpec3 =
                this.mDefaultNextAppTransitionAnimationSpec;
            createAspectScaledThumbnailEnterExitAnimationLocked =
                transitionAnimation3.createScaleUpAnimationLockedCompat(
                    i,
                    z,
                    rect,
                    appTransitionAnimationSpec3 != null ? appTransitionAnimationSpec3.rect : null);
            if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
              ProtoLogImpl.v(
                  ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS_ANIM,
                  2028163120,
            ...
            if (i7 == 3) {
              ...
              AppTransitionAnimationSpec appTransitionAnimationSpec4 =
                  (AppTransitionAnimationSpec)
                      this.mNextAppTransitionAnimationsSpecs.get(windowContainer.hashCode());
              TransitionAnimation transitionAnimation4 = this.mTransitionAnimation;
              boolean z4 = this.mNextAppTransitionScaleUp;
              Rect rect8 =
                  appTransitionAnimationSpec4 != null ? appTransitionAnimationSpec4.rect : null;
              AppTransitionAnimationSpec appTransitionAnimationSpec5 =
                  this.mDefaultNextAppTransitionAnimationSpec;
              createAspectScaledThumbnailEnterExitAnimationLocked =
                  transitionAnimation4.createAspectScaledThumbnailEnterExitAnimationLocked(
                      z,
                      z4,
                      i3,
                      i,
                      ...
                      z3,
                      rect8,
                      appTransitionAnimationSpec5 != null
                          ? appTransitionAnimationSpec5.rect
                          : null);
              if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
                ProtoLogImpl.v(
                    ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS_ANIM,
              ...
              createAspectScaledThumbnailEnterExitAnimationLocked =
                  this.mTransitionAnimation.loadCrossProfileAppEnterAnimation();
              if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
                ProtoLogImpl.v(
                    ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS_ANIM,
                    1589610525,
              ...
              if (mapOpenCloseTransitTypes != 0) {
                ActivityRecord.CustomAppTransition customAppTransition =
                    getCustomAppTransition(mapOpenCloseTransitTypes, windowContainer);
                if (customAppTransition != null) {
                  ...
                  animation =
                      this.mTransitionAnimation.loadDefaultAnimationAttr(
                          mapOpenCloseTransitTypes, i);
                }
              } else {
                animation = null;
              }
              if (CoreRune.FW_CUSTOM_BASIC_ANIM_WITH_DIM && animation != null) {
                windowContainer.mDimAnimator.createDimAnimationLayerIfNeeded(
                    (i == 6 || i == 8 || i == 10) ? 1 : 0, z, layoutParams);
              }
              if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
                ProtoLogImpl.v(
                    ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS_ANIM,
                    ...
                    new Object[] {
                      ...
                      Long.valueOf(mapOpenCloseTransitTypes),
                      String.valueOf(appTransitionOldToString(i)),
                      Boolean.valueOf(z),
                      Boolean.valueOf(canCustomizeAppTransition),
                      String.valueOf(Debug.getCallers(3))
                    });
              }
            ...
            HardwareBuffer appTransitionThumbnailHeader =
                getAppTransitionThumbnailHeader(windowContainer);
            TransitionAnimation transitionAnimation5 = this.mTransitionAnimation;
            boolean z5 = this.mNextAppTransitionScaleUp;
            AppTransitionAnimationSpec appTransitionAnimationSpec6 =
                this.mDefaultNextAppTransitionAnimationSpec;
            Animation createThumbnailEnterExitAnimationLockedCompat =
                transitionAnimation5.createThumbnailEnterExitAnimationLockedCompat(
                    z,
                    z5,
                    rect,
                    i,
                    appTransitionThumbnailHeader,
                    appTransitionAnimationSpec6 != null ? appTransitionAnimationSpec6.rect : null);
            if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_ANIM_enabled) {
              ProtoLogImpl.v(
                  ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS_ANIM,
                  i5,
                  ...
                  (String) null,
                  new Object[] {
                    String.valueOf(createThumbnailEnterExitAnimationLockedCompat),
                    this.mNextAppTransitionScaleUp
                        ? "ANIM_THUMBNAIL_SCALE_UP"
                        : "ANIM_THUMBNAIL_SCALE_DOWN",
                    String.valueOf(appTransitionOldToString(i)),
                    Boolean.valueOf(z),
                    String.valueOf(Debug.getCallers(i6))
                  });
            }
  ...
  public ActivityRecord.CustomAppTransition getCustomAppTransition(
      int i, WindowContainer windowContainer) {
  ...
  public final Animation loadCustomActivityAnimation(
      ActivityRecord.CustomAppTransition customAppTransition,
      boolean z,
      WindowContainer windowContainer) {
    int i;
    Animation loadAppTransitionAnimation =
        this.mTransitionAnimation.loadAppTransitionAnimation(
            windowContainer.asActivityRecord().packageName,
            z ? customAppTransition.mEnterAnim : customAppTransition.mExitAnim);
  ...
  public int getAppRootTaskClipMode() {
    return (this.mNextAppTransitionRequests.contains(5)
            || this.mNextAppTransitionRequests.contains(7)
      ...
      this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new Consumer() { // from class:
                               // com.android.server.wm.AppTransition$$ExternalSyntheticLambda0
  ...
  public void overridePendingAppTransitionThumb(
      HardwareBuffer hardwareBuffer, int i, int i2, IRemoteCallback iRemoteCallback, boolean z) {
    if (canOverridePendingAppTransition()) {
      clear();
  ...
  public void overridePendingAppTransitionAspectScaledThumb(
      HardwareBuffer hardwareBuffer,
      int i,
      int i2,
      int i3,
          ...
          if (appTransitionAnimationSpec != null) {
            Predicate obtainPredicate =
                PooledLambda.obtainPredicate(
                    ...
                    Integer.valueOf(appTransitionAnimationSpec.taskId));
            Task task = this.mDisplayContent.getTask(obtainPredicate);
            obtainPredicate.recycle();
            if (task != null) {
              this.mNextAppTransitionAnimationsSpecs.put(
                  task.hashCode(), appTransitionAnimationSpec);
              if (i == 0) {
                Rect rect = appTransitionAnimationSpec.rect;
                putDefaultNextAppTransitionCoordinates(
                    rect.left,
                    rect.top,
                    rect.width(),
                    rect.height(),
                    appTransitionAnimationSpec.buffer);
              }
            }
          }
        }
  ...
  public void overridePendingAppTransitionRemote(
      RemoteAnimationAdapter remoteAnimationAdapter, boolean z, boolean z2) {
    if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_enabled) {
      ProtoLogImpl.i(
          ...
          (String) null,
          new Object[] {
            Boolean.valueOf(isTransitionSet()), String.valueOf(remoteAnimationAdapter)
          });
    }
    ...
    this.mRemoteAnimationController =
        new RemoteAnimationController(
            this.mService, this.mDisplayContent, remoteAnimationAdapter, this.mHandler, z2);
  ...
  public final void fetchAppTransitionSpecsFromFuture() {
    final IAppTransitionAnimationSpecsFuture iAppTransitionAnimationSpecsFuture =
        this.mNextAppTransitionAnimationsSpecsFuture;
    if (iAppTransitionAnimationSpecsFuture != null) {
      ...
      this.mDefaultExecutor.execute(
          new Runnable() { // from class:
                           // com.android.server.wm.AppTransition$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              AppTransition.this.lambda$fetchAppTransitionSpecsFromFuture$1(
  ...
  public /* synthetic */ void lambda$fetchAppTransitionSpecsFromFuture$1(
      IAppTransitionAnimationSpecsFuture iAppTransitionAnimationSpecsFuture) {
    AppTransitionAnimationSpec[] appTransitionAnimationSpecArr;
    try {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        overridePendingAppTransitionMultiThumb(
            ...
            this.mNextAppTransitionFutureCallback,
            null,
            this.mNextAppTransitionScaleUp);
  ...
  public String toString() {
    ...
    sb.append("]");
    sb.append(
        ", mNextAppTransitionFlags=" + appTransitionFlagsToString(this.mNextAppTransitionFlags));
    return sb.toString();
  }
  ...
  static {
    ...
    arrayList.add(
        new Pair(512, "TRANSIT_FLAG_KEYGUARD_GOING_AWAY_TO_LAUNCHER_WITH_IN_WINDOW_ANIMATIONS"));
  ...
  public boolean prepareAppTransition(int i, int i2) {
    ...
    if (ProtoLogCache.WM_FORCE_DEBUG_APP_TRANSITIONS_enabled) {
      ProtoLogImpl.w(
          ...
          114209416,
          4,
          "Prepare app transition: %s, displayId: %d Callers=%s",
          new Object[] {
            String.valueOf(this),
            Long.valueOf(this.mDisplayContent.getDisplayId()),
  ...
  public final void lambda$new$0() {
    ...
    synchronized (windowManagerGlobalLock) {
      try {
        ...
        if (isTransitionSet()
            || !displayContent.mOpeningApps.isEmpty()
            || !displayContent.mClosingApps.isEmpty()
            || !displayContent.mChangingContainers.isEmpty()) {
          if (ProtoLogCache.WM_DEBUG_APP_TRANSITIONS_enabled) {
            ProtoLogImpl.v(
                ProtoLogGroup.WM_DEBUG_APP_TRANSITIONS,
                344795667,
                ...
                (String) null,
                new Object[] {
                  Long.valueOf(displayContent.getDisplayId()),
                  Boolean.valueOf(displayContent.mAppTransition.isTransitionSet()),
                  Long.valueOf(displayContent.mOpeningApps.size()),
                  Long.valueOf(displayContent.mClosingApps.size()),
                  Long.valueOf(displayContent.mChangingContainers.size())
                });
          }
          Slog.v(
              StartingSurfaceController.TAG,
              "*** APP TRANSITION TIMEOUT. displayId=" + displayContent.getDisplayId());
          if (isTransitionSet()) {
            Slog.v(
                StartingSurfaceController.TAG,
                "* transit=" + this + " state=" + appStateToString());
          }
            ...
            while (it.hasNext()) {
              ...
              if (!activityRecord.allDrawn) {
                ...
                activityRecord.forAllWindows(
                    new Consumer() { // from class:
                                     // com.android.server.wm.AppTransition$$ExternalSyntheticLambda4
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        AppTransition.lambda$handleAppTransitionTimeout$2(
                            ActivityRecord.this, (WindowState) obj);
                      }
                    },
                    true);
              }
  ...
  public static /* synthetic */ void lambda$handleAppTransitionTimeout$2(
      ActivityRecord activityRecord, WindowState windowState) {
  ...
  public final void setAppTransitionFinishedCallbackIfNeeded(Animation animation) {
    ...
    animation.setAnimationListener(new AnimationAnimationListenerC28801(iRemoteCallback));
  }

  /* renamed from: com.android.server.wm.AppTransition$1 */
  public class AnimationAnimationListenerC28801 implements Animation.AnimationListener {
    ...
    public AnimationAnimationListenerC28801(IRemoteCallback iRemoteCallback) {
      this.val$callback = iRemoteCallback;
    }

    @Override // android.view.animation.Animation.AnimationListener
    public void onAnimationEnd(Animation animation) {
      AppTransition.this.mHandler.sendMessage(
          PooledLambda.obtainMessage(
              new Consumer() { // from class:
                               // com.android.server.wm.AppTransition$1$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  AppTransition.doAnimationCallback((IRemoteCallback) obj);
                }
