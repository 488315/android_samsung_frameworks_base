...
public class DisplayArea extends WindowContainer {
  ...
  public DisplayArea(WindowManagerService windowManagerService, Type type, String str, int i) {
    ...
    this.mOrganizerController =
        windowManagerService.mAtmService.mWindowOrganizerController.mDisplayAreaOrganizerController;
  }
  ...
  public void positionChildAt(int i, WindowContainer windowContainer, boolean z) {
    ...
    super.positionChildAt(
        findPositionForChildDisplayArea(i, windowContainer.asDisplayArea()),
        windowContainer,
        false);
  ...
  public final boolean shouldRespectOrientationRequestDueToPerAppOverride() {
    ...
    return (displayContent == null
            || (activityRecord = displayContent.topRunningActivity(true)) == null
  ...
  public boolean getIgnoreOrientationRequest() {
    return this.mSetIgnoreOrientationRequest
        && !this.mWmService.isIgnoreOrientationRequestDisabled();
  }
  ...
  public final int findPositionForChildDisplayArea(int i, DisplayArea displayArea) {
    ...
    int i2 = 0;
    for (int i3 = findMinPositionForChildDisplayArea;
        i3 <= findMaxPositionForChildDisplayArea;
        i3++) {
    ...
    return Math.max(
        Math.min(i, findMaxPositionForChildDisplayArea), findMinPositionForChildDisplayArea);
  }
    ...
    while (i >= 0 && i < size) {
      ...
      if (windowContainer.asDisplayArea() != null
          && (itemFromTaskDisplayAreas =
                  windowContainer.asDisplayArea().getItemFromTaskDisplayAreas(function, z))
              != null) {
  ...
  public void sendDisplayAreaVanished(IDisplayAreaOrganizer iDisplayAreaOrganizer) {
    ...
    if (this.mOrganizer == null) {
      Slog.w(
          ...
          "sendDisplayAreaVanished: Use pending="
  ...
  public class Tokens extends DisplayArea {
    ...
    @Override // com.android.server.wm.DisplayArea, com.android.server.wm.WindowContainer,
              // com.android.server.wm.SurfaceFreezer.Freezable
    public /* bridge */ /* synthetic */ SurfaceControl getFreezeSnapshotTarget() {
      return super.getFreezeSnapshotTarget();
    }
    ...
    public /* synthetic */ boolean lambda$new$0(WindowState windowState) {
      ...
      if (windowManagerPolicy.isKeyguardHostWindow(windowState.mAttrs)) {
        if (!this.mDisplayContent.isKeyguardLocked()
            && ((this.mDisplayContent.getDisplayPolicy().isAwake()
                    || this.mWmService.mPowerManager.isInteractive())
                && windowManagerPolicy.okToAnimate(true))) {
          return false;
        }
        boolean z =
            this.mDisplayContent.mAppTransition.isUnoccluding()
                && this.mDisplayContent.mUnknownAppVisibilityController.allResolved();
      ...
      this.mWindowComparator =
          Comparator.comparingInt(
              new ToIntFunction() { // from class:
                                    // com.android.server.wm.DisplayArea$Tokens$$ExternalSyntheticLambda0
  ...
  public class Dimmable extends DisplayArea {
    ...
    public void prepareSurfaces() {
      ...
      if (!this.mTransitionController.isShellTransitionsEnabled()
          && forAllTasks(
              new Predicate() { // from class:
                                // com.android.server.wm.DisplayArea$Dimmable$$ExternalSyntheticLambda0
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$prepareSurfaces$0;
                  lambda$prepareSurfaces$0 =
                      DisplayArea.Dimmable.lambda$prepareSurfaces$0((Task) obj);
  ...
  enum Type {
    ...
    public static void checkSiblings(Type type, Type type2) {
      ...
      Preconditions.checkState(
          type == type3 || type2 != type3, type + " must be above BELOW_TASKS");
      Type type4 = ABOVE_TASKS;
      Preconditions.checkState(
          type != type4 || type2 == type4, type2 + " must be below ABOVE_TASKS");
    }

    public static void checkChild(Type type, Type type2) {
      int i = AbstractC28961.$SwitchMap$com$android$server$wm$DisplayArea$Type[type.ordinal()];
      if (i == 1) {
  ...
  public abstract /* synthetic */ class AbstractC28961 {
