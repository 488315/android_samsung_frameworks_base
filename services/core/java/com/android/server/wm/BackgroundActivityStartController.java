...
public class BackgroundActivityStartController {
    ...
    */
    public int checkBackgroundActivityStart(int i, int i2, String str, int i3, int i4, WindowProcessController windowProcessController, PendingIntentRecord pendingIntentRecord, BackgroundStartPrivileges backgroundStartPrivileges, Intent intent, ActivityOptions activityOptions) {
        ...
        boolean z9 = pendingIntentRecord == null || activityOptions == null || activityOptions.getPendingIntentCreatorBackgroundActivityStartMode() != 2;
        if (z9) {
        ...
        boolean z11 = (((balAppSwitchesState == 2 || balAppSwitchesState == 1) || this.mService.mActiveUids.hasNonAppVisibleWindow(i)) && hasActiveVisibleWindow) || z10;
        if (z9 && z11) {
            return logStartAllowedAndReturnCode(4, false, i, i3, intent, "callingUidHasAnyVisibleWindow = " + i + ", isCallingUidPersistentSystemProcess = " + z10);
        }
        ...
        boolean z12 = activityOptions == null || activityOptions.getPendingIntentBackgroundActivityStartMode() == 0;
        boolean z13 = z12 || backgroundStartPrivilegesAllowedByCaller.allowsBackgroundActivityStarts();
        String str4 = backgroundStartPrivilegesAllowedByCaller.allowsBackgroundActivityStarts() ? "Activity start allowed" : "Activity start would be allowed if the sender granted BAL privileges";
        if (i3 == i || !z13) {
            i5 = uidState2;
            z4 = z2;
            z5 = z10;
            ...
            str2 = packageNameIfUnique;
            z8 = true;
            i8 = checkPiBackgroundActivityStart(i, i3, backgroundStartPrivileges, intent, activityOptions, z7, z4, str4);
        }
        ...
        if (windowProcessController2 == null || !z9) {
            ...
            i10 = i7;
            int areBackgroundActivityStartsAllowed = windowProcessController2.areBackgroundActivityStartsAllowed(i10);
            if (areBackgroundActivityStartsAllowed == 0) {
                ...
                if (processes != null) {
                    for (int size = processes.size() - 1; size >= 0; size--) {
                        WindowProcessController windowProcessController3 = (WindowProcessController) processes.valueAt(size);
                        int areBackgroundActivityStartsAllowed2 = windowProcessController3.areBackgroundActivityStartsAllowed(i10);
                        if (windowProcessController3 != windowProcessController2 && areBackgroundActivityStartsAllowed2 != 0) {
                            if (z14) {
                                logStartAllowedAndReturnCode = logStartAllowedAndReturnCode(areBackgroundActivityStartsAllowed2, true, i, i3, intent, "process" + windowProcessController3.getPid() + " from uid " + i9 + " is allowed", str4);
                            } else {
                                return logStartAllowedAndReturnCode(areBackgroundActivityStartsAllowed2, i8, backgroundStartPrivileges2, true, i, i3, intent, "process" + windowProcessController3.getPid() + " from uid " + i9 + " is allowed");
                            }
                        }
                    }
                }
                if (z14) {
                    int i12 = i11;
                    Preconditions.checkState(i12 == 0 ? z8 : false, "balAllowedForCaller = " + i12 + " (should have returned)");
                } else if (i8 != 0 && backgroundStartPrivileges2.allowsBackgroundActivityStarts() && !z12) {
                    return i8;
                }
            } else if (z14) {
                i11 = areBackgroundActivityStartsAllowed;
                logStartAllowedAndReturnCode = logStartAllowedAndReturnCode(areBackgroundActivityStartsAllowed, true, i, i3, intent, "callerApp process (pid = " + windowProcessController2.getPid() + ", uid = " + i9 + ") is allowed", str4);
            } else {
                return logStartAllowedAndReturnCode(areBackgroundActivityStartsAllowed, i8, backgroundStartPrivileges2, true, i, i3, intent, "callerApp process (pid = " + windowProcessController2.getPid() + ", uid = " + i9 + ") is allowed");
            }
        ...
        sb2.append((windowProcessController2 == null || !windowProcessController2.hasActivityInVisibleTask()) ? false : z8);
        sb2.append("]");
        String sb3 = sb2.toString();
        if (i8 != 0) {
            Preconditions.checkState(z17, "resultIfPiSenderAllowsBal = " + balCodeToString(i8) + " at the end but logVerdictChangeByPiDefaultChange = false");
            if (backgroundStartPrivileges3.allowsBackgroundActivityStarts()) {
                Slog.wtf("ActivityTaskManager", "With BAL hardening this activity start would be blocked!" + sb3);
                return i8;
            }
            Slog.wtf("ActivityTaskManager", "Without BAL hardening this activity start would be allowed!" + sb3);
        }
        ...
        if (this.mService.isActivityStartsLoggingEnabled()) {
            this.mSupervisor.getActivityMetricsLogger().logAbortedBgActivityStart(intent, windowProcessController2, i, str, i13, z15, i3, i14, z16, pendingIntentRecord != null ? z8 : false);
        }
        return 0;
    }
