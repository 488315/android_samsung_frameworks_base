...
public class AlertWindowNotification {
    ...
    public void post() {
        this.mService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.AlertWindowNotification$$ExternalSyntheticLambda1
    ...
    public void cancel(final boolean z) {
        this.mService.f1749mH.post(new Runnable() { // from class: com.android.server.wm.AlertWindowNotification$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void onPostNotification() {
        ...
        Notification.Builder contentIntent = new Notification.Builder(context, this.mNotificationTag).setOngoing(true).setContentTitle(context.getString(R.string.bugreport_screenshot_failure_toast, charSequence)).setContentText(string).setSmallIcon(R.drawable.$progress_indeterminate_horizontal_material__40).setColor(context.getColor(R.color.system_notification_accent_color)).setStyle(new Notification.BigTextStyle().bigText(string)).setLocalOnly(true).addExtras(bundle).setContentIntent(getContentIntent(context, this.mPackageName));
    ...
    public final void createNotificationChannel(Context context, String str) {
        if (sChannelGroup == null) {
            NotificationChannelGroup notificationChannelGroup = new NotificationChannelGroup("com.android.server.wm.AlertWindowNotification - ", this.mService.mContext.getString(R.string.bugreport_option_full_title));
