...
public class LaunchParamsController {
  ...
  public void calculate(
    ...
    if (task != null || activityRecord != null) {
      if (i > 0) {
        ...
        if ((task != null && task.isDexMode() && taskDisplayArea == null)
          ...
          if (CoreRune.MT_NEW_DEX_LAUNCH_POLICY
              && (taskDisplayArea3 = launchParams.mPreferredTaskDisplayArea) != null
              && taskDisplayArea3.isNewDexMode()) {
            ...
            if (task != null
                ...
                && launchWindowingMode2 != 5
                && launchParams.mWindowingMode == 5) {
              launchParams.mWindowingMode = 0;
            }
          }
        } else if ((CoreRune.MT_NEW_DEX_PERSIST_BOUNDS
                && task != null
                && task.isNewDexMode()
          ...
          if (CoreRune.MT_NEW_DEX_LAUNCH_POLICY
              ...
              && taskDisplayArea2.isNewDexMode()) {
            int launchWindowingMode3 =
                activityOptions != null ? activityOptions.getLaunchWindowingMode() : 0;
            if (launchWindowingMode3 == 5) {
              NewDexPersistBoundsParams newDexPersistBoundsParams =
                  launchParams.mNewDexPersistBoundsParam;
    ...
    for (int size = this.mModifiers.size() - 1; size >= 0; size--) {
      ...
      int onCalculate =
          ((LaunchParamsModifier) this.mModifiers.get(size))
              .onCalculate(
                  task,
                  windowLayout,
                  activityRecord,
    ...
    if (activityRecord != null && activityRecord.requestedVrComponent != null) {
      launchParams.mPreferredTaskDisplayArea =
          this.mService.mRootWindowContainer.getDefaultTaskDisplayArea();
      return;
    }
  ...
  public boolean layoutTask(
    ...
    try {
      if (this.mTmpParams.mBounds.isEmpty()) {
        if (this.mTmpParams.hasWindowingMode()
            && task.isDexMode()
            && this.mTmpParams.mDexPersistBoundsParam.mDexWindowingMode == 1) {
        ...
        if (CoreRune.MT_NEW_DEX_PERSIST_BOUNDS
            && this.mTmpParams.hasWindowingMode()
            && task.isNewDexMode()) {
        ...
        if (this.mTmpParams.hasWindowingMode()
            ...
            && task.isRootTask()
            && this.mTmpParams.mWindowingMode != task.getWindowingMode()) {
          task.setWindowingMode(
              task.getDisplayArea()
                  .validateWindowingMode(this.mTmpParams.mWindowingMode, activityRecord, task));
        }
  ...
  public class LaunchParams {
    ...
    public final NewDexPersistBoundsParams mNewDexPersistBoundsParam =
        new NewDexPersistBoundsParams();
    ...
    public boolean equals(Object obj) {
      ...
      if (this.mPreferredTaskDisplayArea != launchParams.mPreferredTaskDisplayArea
          || this.mWindowingMode != launchParams.mWindowingMode
          || !this.mFreeformPersistBoundsParam.equals(launchParams.mFreeformPersistBoundsParam)) {
        return false;
      }
    ...
    public int hashCode() {
      ...
      return ((((hashCode + (taskDisplayArea != null ? taskDisplayArea.hashCode() : 0)) * 31)
                  + this.mWindowingMode)
              * 31)
          + this.mFreeformPersistBoundsParam.hashCode();
    }
  }
}
