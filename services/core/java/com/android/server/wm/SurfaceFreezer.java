...
public class SurfaceFreezer {
  ...
  public void freeze(
    ...
    SurfaceControl createAnimationLeash =
        SurfaceAnimator.createAnimationLeash(
            ...
            point.y,
            false,
            this.mWmService.mTransactionFactory);
    ...
    if (surfaceControl != null) {
      ScreenCapture.ScreenshotHardwareBuffer createSnapshotBufferInner =
          createSnapshotBufferInner(surfaceControl, rect);
      HardwareBuffer hardwareBuffer =
          createSnapshotBufferInner == null ? null : createSnapshotBufferInner.getHardwareBuffer();
  ...
  public class Snapshot {
    ...
    public static /* synthetic */ void lambda$startAnimation$0(
    ...
    public Snapshot(
      ...
      GraphicBuffer createFromHardwareBufferInner =
          SurfaceFreezer.this.createFromHardwareBufferInner(screenshotHardwareBuffer);
      SurfaceControl build =
          SurfaceFreezer.this
              .mAnimatable
              .makeAnimationLeash()
              .setName("snapshot anim: " + SurfaceFreezer.this.mAnimatable.toString())
              .setFormat(-3)
              .setParent(surfaceControl)
              .setSecure(screenshotHardwareBuffer.containsSecureLayers())
    ...
    public void startAnimation(
        SurfaceControl.Transaction transaction, AnimationAdapter animationAdapter, int i) {
        ...
        animationAdapter.startAnimation(
            ...
            new SurfaceAnimator
                .OnAnimationFinishedCallback() { // from class:
                                                 // com.android.server.wm.SurfaceFreezer$Snapshot$$ExternalSyntheticLambda0
