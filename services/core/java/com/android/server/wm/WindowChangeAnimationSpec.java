...
public class WindowChangeAnimationSpec implements LocalAnimationAdapter.AnimationSpec {
  ...
  public final ThreadLocal mThreadLocalTmps =
      ThreadLocal.withInitial(
          new Supplier() { // from class:
                           // com.android.server.wm.WindowChangeAnimationSpec$$ExternalSyntheticLambda0
  ...
  public WindowChangeAnimationSpec(
      Rect rect, Rect rect2, DisplayInfo displayInfo, float f, boolean z, boolean z2) {
  ...
  public final void createBoundsInterpolator(long j, DisplayInfo displayInfo) {
    boolean z =
        ((this.mEndBounds.width() - this.mStartBounds.width()) + this.mEndBounds.height())
                - this.mStartBounds.height()
            >= 0;
    long j2 = (long) (j * 0.7f);
    ...
    if (this.mIsThumbnail) {
      ...
      animationSet.initialize(
          this.mStartBounds.width(),
          this.mStartBounds.height(),
          this.mEndBounds.width(),
          this.mEndBounds.height());
      return;
    }
  ...
  public long calculateStatusBarTransitionStartTime() {
    ...
    return Math.max(
        uptimeMillis, (((long) (this.mAnimation.getDuration() * 0.99f)) + uptimeMillis) - 120);
  }
