...
public class DimAnimator {
  ...
  public void createDimAnimationLayerIfNeeded(
      int i, boolean z, WindowManager.LayoutParams layoutParams) {
    if (canCreateDimAnimationLayer(i, z, layoutParams, null)) {
      createDimAnimationLayer();
    }
  }

  public boolean canCreateDimAnimationLayer(
      int i, boolean z, WindowManager.LayoutParams layoutParams, TransitionInfo.Change change) {
    if (this.mContainer.mWmService.getTransitionAnimationScaleLocked()
    ...
    if (layoutParams != null) {
      ...
      if ((f > DisplayPowerController2.RATE_FROM_DOZE_TO_ON && f < 1.0f)
          || !TransitionAnimation.isDefaultPackageAnimRes(layoutParams.windowAnimations)) {
        return false;
      }
    }
    if (this.mContainer.getDisplayContent().isDefaultDisplay) {
      return (i == 1 || i == 3)
          && z
          && !this.mContainer.inMultiWindowMode()
          && this.mContainer.fillsParent()
          && this.mContainer.getActivity(
                  new Predicate() { // from class:
                                    // com.android.server.wm.DimAnimator$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$canCreateDimAnimationLayer$0;
                      lambda$canCreateDimAnimationLayer$0 =
                          DimAnimator.lambda$canCreateDimAnimationLayer$0((ActivityRecord) obj);
  ...
  public static /* synthetic */ boolean lambda$canCreateDimAnimationLayer$0(
      ActivityRecord activityRecord) {
    return activityRecord.isVisibleRequested()
        && (!activityRecord.fillsParent() || activityRecord.showWallpaper());
  }
    ...
    if (this.mDimAnimationLayer == null) {
      this.mDimAnimationLayer =
          this.mContainer
              ...
              .setName("DimAnimationLayer for " + this.mContainer.getName())
              .setColorLayer()
              .setParent(this.mContainer.getDisplayContent().getSurfaceControl())
              .setCallsite("WindowContainer#createAnimatingDimLayer")
              .build();
      if (CoreRune.SAFE_DEBUG) {
        Slog.d(
            StartingSurfaceController.TAG,
            "createDimAnimationLayer, mDimAnimationLayer="
                + this.mDimAnimationLayer
                + ", caller="
                + Debug.getCallers(6));
      }
  ...
  public void startDimAnimation(SurfaceControl.Transaction transaction) {
    ...
    if (CoreRune.SAFE_DEBUG) {
      Slog.d(
          StartingSurfaceController.TAG,
          "startDimAnimation, mDimAnimationLayer="
              + this.mDimAnimationLayer
              + ", caller="
              + Debug.getCallers(6));
    }
    ...
    windowContainer.mWmService.mSurfaceAnimationRunner.startAnimation(
        createDimAnimationSpec,
        this.mDimAnimationLayer,
  ...
  public void finishDimAnimation(int i) {
    ...
    if (CoreRune.SAFE_DEBUG) {
      Slog.d(
          StartingSurfaceController.TAG,
          "finishDimAnimation, mDimAnimationLayer="
              + this.mDimAnimationLayer
              + ", caller="
              + Debug.getCallers(6));
    }
    this.mContainer.mWmService.mSurfaceAnimationRunner.onAnimationCancelled(
        this.mDimAnimationLayer);
    this.mContainer.getSyncTransaction().reparent(this.mDimAnimationLayer, null);
    this.mDimAnimationLayer = null;
    this.mContainer.scheduleAnimation();
    if ((i & 2) != 0) {
      for (WindowContainer parent = this.mContainer.getParent();
          parent != null;
  ...
  public final WindowAnimationSpec createDimAnimationSpec() {
    return new WindowAnimationSpec(
        this.mContainer.getDisplayContent().mAppTransition.mTransitionAnimation.loadDimAnimation(),
        new Point(0, 0),
        false,
        DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
  }
