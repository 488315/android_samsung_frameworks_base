...
public class BackgroundLaunchProcessController {
  ...
  public BackgroundLaunchProcessController(
      IntPredicate intPredicate, BackgroundActivityStartCallback backgroundActivityStartCallback) {
  ...
  public int areBackgroundActivityStartsAllowed(
      int i,
      int i2,
      String str,
      int i3,
    ...
    if (z3) {
      return BackgroundActivityStartController.logStartAllowedAndReturnCode(
          ...
          (Intent) null,
          i,
          "Activity start allowed: process instrumenting with background activity starts"
              + " privileges");
    }
    if (isBackgroundStartAllowedByToken(i2, str, z)) {
      return BackgroundActivityStartController.logStartAllowedAndReturnCode(
          6, true, i2, i2, (Intent) null, i, "Activity start allowed: process allowed by token");
    }
    ...
    if (j2 > j || j3 > j) {
      return BackgroundActivityStartController.logStartAllowedAndReturnCode(
          8, true, i2, i2, (Intent) null, i, "Activity start allowed: within 10000ms grace period");
    }
    return 0;
  }
      ...
      if (arrayMap != null && !arrayMap.isEmpty()) {
        if (z) {
          ...
          while (true) {
            ...
            if (((BackgroundStartPrivileges) this.mBackgroundStartPrivileges.valueAt(i2))
          ...
          while (true) {
            ...
            if (((BackgroundStartPrivileges) this.mBackgroundStartPrivileges.valueAt(i3))
          ...
          return this.mBackgroundActivityStartCallback.isActivityStartAllowed(
              originatingTokensThatAllowBal, i, str);
        }
      }
      return false;
    }
  ...
  public void addOrUpdateAllowBackgroundStartPrivileges(
  ...
  public boolean canCloseSystemDialogsByToken(int i) {
    ...
    synchronized (this) {
      ArrayMap arrayMap = this.mBackgroundStartPrivileges;
      if (arrayMap != null && !arrayMap.isEmpty()) {
        return this.mBackgroundActivityStartCallback.canCloseSystemDialogs(
            getOriginatingTokensThatAllowBal(), i);
      }
      return false;
    }
  }
