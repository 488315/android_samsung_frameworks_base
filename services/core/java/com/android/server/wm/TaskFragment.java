...
public class TaskFragment extends WindowContainer {
  ...
  public TaskFragment(
      ActivityTaskManagerService activityTaskManagerService, IBinder iBinder, boolean z) {
  ...
  public TaskFragment(
    ...
    this.mTaskFragmentOrganizerController =
        activityTaskManagerService.mWindowOrganizerController.mTaskFragmentOrganizerController;
    this.mFragmentToken = iBinder;
    this.mRemoteToken = new WindowContainer.RemoteToken(this);
  }

  public static TaskFragment fromTaskFragmentToken(
      IBinder iBinder, ActivityTaskManagerService activityTaskManagerService) {
    if (iBinder == null) {
      return null;
    }
  ...
  public void setTaskFragmentOrganizer(
      TaskFragmentOrganizerToken taskFragmentOrganizerToken, int i, String str) {
    this.mTaskFragmentOrganizer =
        ITaskFragmentOrganizer.Stub.asInterface(taskFragmentOrganizerToken.asBinder());
  ...
  public boolean hasTaskFragmentOrganizer(ITaskFragmentOrganizer iTaskFragmentOrganizer) {
    return (iTaskFragmentOrganizer == null
            || this.mTaskFragmentOrganizer == null
            || !iTaskFragmentOrganizer.asBinder().equals(this.mTaskFragmentOrganizer.asBinder()))
        ? false
        : true;
  }
  ...
  public final WindowProcessController getOrganizerProcessIfDifferent(
    ...
    if (str.equals(activityRecord.processName)
        && this.mTaskFragmentOrganizerUid == activityRecord.getUid()) {
      return null;
    }
    return this.mAtmService.getProcessController(
        this.mTaskFragmentOrganizerProcessName, this.mTaskFragmentOrganizerUid);
  }
  ...
  public int isAllowedToEmbedActivity(ActivityRecord activityRecord, int i) {
    Bundle bundle;
    if (!isAllowedToEmbedActivityInUntrustedMode(activityRecord)
        && !isAllowedToEmbedActivityInTrustedMode(activityRecord, i)) {
      return 1;
    }
    ...
    return (CoreRune.MW_EMBED_ACTIVITY
            && (bundle = activityRecord.info.metaData) != null
            && bundle.getBoolean(
                "com.samsung.android.multiwindow.embed_activity_not_supported", false))
        ? 10
        : 0;
  }
  ...
  public boolean isAllowedToEmbedActivityInUntrustedMode(ActivityRecord activityRecord) {
    WindowContainer parent = getParent();
    return parent != null
        && parent.getBounds().contains(getBounds())
        && (activityRecord.info.flags & 268435456) == 268435456;
  }
  ...
  public static /* synthetic */ boolean lambda$isFullyTrustedEmbedding$0(
  ...
  public boolean isFullyTrustedEmbedding(final int i) {
    return !forAllActivities(
        new Predicate() { // from class:
                          // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda12
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$isFullyTrustedEmbedding$0;
            lambda$isFullyTrustedEmbedding$0 =
                TaskFragment.lambda$isFullyTrustedEmbedding$0(i, (ActivityRecord) obj);
  ...
  public /* synthetic */ boolean lambda$isAllowedToBeEmbeddedInTrustedMode$1(
      ActivityRecord activityRecord) {
  ...
  public boolean isAllowedToBeEmbeddedInTrustedMode() {
    return !forAllActivities(
        new Predicate() { // from class:
                          // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda9
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$isAllowedToBeEmbeddedInTrustedMode$1;
            lambda$isAllowedToBeEmbeddedInTrustedMode$1 =
                TaskFragment.this.lambda$isAllowedToBeEmbeddedInTrustedMode$1((ActivityRecord) obj);
  ...
  public void onActivityStateChanged(
      ActivityRecord activityRecord, ActivityRecord.State state, String str) {
    ...
    WindowProcessController organizerProcessIfDifferent =
        getOrganizerProcessIfDifferent(activityRecord);
  ...
  */
        ...
        if (!z && containsStoppingActivity()) {
          if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
            ProtoLogImpl.v(
                ...
                1,
                (String) null,
                new Object[] {Long.valueOf(this.mTaskSupervisor.mStoppingActivities.size())});
          }
  ...
  public final boolean containsStoppingActivity() {
    for (int size = this.mTaskSupervisor.mStoppingActivities.size() - 1; size >= 0; size--) {
      if (((ActivityRecord) this.mTaskSupervisor.mStoppingActivities.get(size)).getTaskFragment()
          == this) {
        return true;
      }
    }
  ...
  public boolean isTranslucent(ActivityRecord activityRecord) {
    return !isAttached()
        || isForceHidden()
        || isForceTranslucent()
        || this.mTaskSupervisor.mOpaqueActivityHelper.getVisibleOpaqueActivity(this, activityRecord)
            == null;
  }
  ...
  public boolean isTranslucentForTransition() {
    return !isAttached()
        || isForceHidden()
        || isForceTranslucent()
        || this.mTaskSupervisor.mOpaqueActivityHelper.getOpaqueActivity(this) == null;
  }
  ...
  public static /* synthetic */ boolean lambda$getTopNonFinishingActivity$2(
      ActivityRecord activityRecord) {
  ...
  public ActivityRecord getTopNonFinishingActivity(boolean z) {
    if (z) {
      return getActivity(
          new Predicate() { // from class:
                            // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$getTopNonFinishingActivity$2;
              lambda$getTopNonFinishingActivity$2 =
                  TaskFragment.lambda$getTopNonFinishingActivity$2((ActivityRecord) obj);
    ...
    return getActivity(
        new Predicate() { // from class:
                          // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda3
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getTopNonFinishingActivity$3;
            lambda$getTopNonFinishingActivity$3 =
                TaskFragment.lambda$getTopNonFinishingActivity$3((ActivityRecord) obj);
            return lambda$getTopNonFinishingActivity$3;
          }
        });
  }

  public static /* synthetic */ boolean lambda$getTopNonFinishingActivity$3(
      ActivityRecord activityRecord) {
  ...
  public ActivityRecord topRunningActivity(boolean z) {
    ...
    if (z) {
      return getActivity(
          new Predicate() { // from class:
                            // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda6
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$topRunningActivity$4;
              lambda$topRunningActivity$4 =
                  TaskFragment.lambda$topRunningActivity$4((ActivityRecord) obj);
  ...
  public int getNonFinishingActivityCount() {
    ...
    forAllActivities(
        new Consumer() { // from class: com.android.server.wm.TaskFragment$$ExternalSyntheticLambda0
  ...
  public static /* synthetic */ void lambda$getNonFinishingActivityCount$5(
      int[] iArr, ActivityRecord activityRecord) {
  ...
  */
  public int getVisibility(ActivityRecord activityRecord) {
    ...
    if (asTask != null
        && parent.asTask() == null
        && this.mTransitionController.isTransientHide(asTask)) {
      return 0;
    }
            ...
            if (childAt == this) {
              if (!arrayList.isEmpty() && !z2) {
                ...
                for (int size = arrayList.size() - 1; size >= 0; size--) {
                  ...
                  if (taskFragment3 != this
                      && (!(CoreRune.MW_MULTI_SPLIT_TASK_VISIBILITY
                              && getStageType() == 4
                              && inStageMainOrSide(taskFragment2.getStageType())
                              && inStageMainOrSide(taskFragment3.getStageType()))
                          && (((WindowContainer) this).mTmpRect.intersect(taskFragment2.getBounds())
                              || ((WindowContainer) this)
                                  .mTmpRect.intersect(taskFragment3.getBounds())))) {
                    return 2;
                  }
                }
              }
              if (!hasRunningActivity
                  && ((activityRecord == null || !activityRecord.isDescendantOf(this))
                      && !isActivityTypeHome())) {
                boolean z5 = z;
              }
              ...
              if (windowingMode == 1) {
                Task asTask2 = childAt.asTask();
                TaskDisplayArea taskDisplayArea = getTaskDisplayArea();
                if (asTask2 == null
                    || !asTask2.isFullscreenRootForStageTask()
                    || !this.mAtmService.mWindowOrganizerController.whileEnterSplitWithSingleStage()
                    || (taskDisplayArea.isSplitScreenModeActivated()
                        && taskDisplayArea.hasChildTaskInSideStage())) {
                  if (!isTranslucent(childAt, activityRecord)) {
                    if (asTask() != null
                        && asTask().mIsDragSourceTask
                        && !isActivityTypeHomeOrRecents()
                        && this.mWmService.mDragDropController.dragDropActiveLocked()) {
                      Slog.d("ActivityTaskManager", "[TWODND] Set mHiddenWhileActivatingDrag");
                      this.mWmService.mDragDropController.setUpdateTaskVisibilityAfterDragClosed(
                          true);
                      asTask().mHiddenWhileActivatingDrag = true;
                    } else {
                      if (!CoreRune.MW_MULTI_SPLIT_TASK_VISIBILITY
                          || !inSplitScreenWindowingMode()
                          || childAt.getStageType() != 4
                          || asTask() == null) {
                        break;
                      }
                      z3 = true;
                ...
                if (CoreRune.MW_EMBED_ACTIVITY
                  ...
                  if (CoreRune.MW_EMBED_ACTIVITY
                      && isSplitEmbedded()
                      && childAt.isSplitEmbedded()
                      && childAt.getBounds().equals(getBounds())
                      && !isTranslucent(childAt, activityRecord)) {
                    return 2;
                  }
                  if (windowingMode == 6 && childAt.matchParentBounds()) {
                    if (!isTranslucent(childAt, activityRecord)) {
                      ...
                      Slog.d(
                          "ActivityTaskManager", "[TWODND] Set mHiddenWhileActivatingDrag(split)");
                      this.mWmService.mDragDropController.setUpdateTaskVisibilityAfterDragClosed(
                          true);
                      asTask().mHiddenWhileActivatingDrag = true;
                    }
                  } else if (CoreRune.MW_MULTI_SPLIT_TASK_VISIBILITY
                      && childAt.getStageType() == 4
                      && !z3
                      && asTask() != null) {
                    if (isTranslucent(activityRecord)) {
                      z4 = true;
                    }
                    z3 = !z4;
                    if (getStageType() == 4 && z3) {
                      return 2;
                    }
                  } else {
                    TaskFragment asTaskFragment = childAt.asTaskFragment();
                    if (asTaskFragment != null
                        && (taskFragment = asTaskFragment.mAdjacentTaskFragment) != null) {
                      if (arrayList.contains(taskFragment)) {
                        if (!asTaskFragment.isTranslucent(activityRecord)
                            && !asTaskFragment.mAdjacentTaskFragment.isTranslucent(
                                activityRecord)) {
                          if (!CoreRune.MW_MULTI_SPLIT_TASK_VISIBILITY || getStageType() != 4) {
                            break;
                          }
                        } else {
                          i = 1;
  ...
  public static boolean hasRunningActivity(WindowContainer windowContainer) {
    return windowContainer.asTaskFragment() != null
        ? windowContainer.asTaskFragment().topRunningActivity() != null
        : (windowContainer.asActivityRecord() == null
                || windowContainer.asActivityRecord().finishing)
            ? false
            : true;
  }
  ...
  public final void updateActivityVisibilities(
  ...
  public final boolean resumeTopActivity(
      ActivityRecord activityRecord, ActivityOptions activityOptions, boolean z) {
  ...
  public final boolean resumeTopActivity(
    ...
    boolean startPausing;
    Task task;
    DisplayContent displayContent;
    ActivityRecord activityRecord4;
    ActivityRecord activityRecord5 =
        topRunningActivity(getTask() == null || !getTask().isFreeformStashed());
    if (activityRecord5 == null || !activityRecord5.canResumeByCompat()) {
      return false;
    }
    activityRecord5.delayedResume = false;
    boolean allPausedActivitiesComplete = this.mRootWindowContainer.allPausedActivitiesComplete();
    if (!(CoreRune.MW_EMBED_ACTIVITY
            && !allPausedActivitiesComplete
            && activityRecord5.isSplitEmbedded()
            && getAdjacentTaskFragment() != null
            && getAdjacentTaskFragment().getTopMostActivity() != null
            && getAdjacentTaskFragment().getTopMostActivity().isState(ActivityRecord.State.RESUMED))
        && !allPausedActivitiesComplete) {
      if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
    ...
    TaskDisplayArea displayArea = getDisplayArea();
    if (this.mResumedActivity == activityRecord5
        && activityRecord5.isState(ActivityRecord.State.RESUMED)
        && displayArea.allResumedActivitiesComplete()) {
      displayArea.ensureActivitiesVisible(null, 0, false, true);
      ActivityRecord activityRecord6 = this.mDisplayContent.mFocusedApp;
      if (activityRecord6 != null
          && activityRecord6.getLaunchedFromBubble()
          && this.mDisplayContent.mFocusedApp != activityRecord5) {
        this.mAtmService.setLastResumedActivityUncheckLocked(activityRecord5, "bubble-collapse");
      }
      if (!(getTask() != null ? getTask().inMultiWindowMode() : inMultiWindowMode())
          && activityOptions != null
          && activityOptions.isResumedAffordanceAnimationRequested()) {
        this.mTransitionController.collect(activityRecord5.getTask());
        this.mTransitionController.setResumedAffordance(activityRecord5.getTask());
        Slog.d("ActivityTaskManager", "setResumedAffordance for " + activityRecord5);
      }
      if (getTask() != null
          && this.mAtmService.mMultiTaskingController.isAffordanceTargetTask(getTask())) {
        final Task task2 = activityRecord5.getTask();
        this.mTransitionController.collect(task2);
        this.mTransitionController.setResumedAffordance(task2);
        if (inFreeformWindowingMode()) {
          this.mTransitionController.setAffordanceTargetFreeformTask(task2);
          TaskDisplayArea taskDisplayArea = task2.getTaskDisplayArea();
          if (taskDisplayArea != null) {
            taskDisplayArea.forAllRootTasks(
                new Consumer() { // from class:
                                 // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda10
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
                    TaskFragment.this.lambda$resumeTopActivity$6(task2, (Task) obj);
                  }
                });
          }
        }
        Slog.d("ActivityTaskManager", "setResumedAffordance(multi-window) for " + activityRecord5);
      }
      executeAppTransition(activityOptions);
      if (displayArea.inMultiWindowMode()
          && (displayContent = displayArea.mDisplayContent) != null
          && displayContent.mFocusedApp != activityRecord5
          && !activityRecord5.inSplitScreenWindowingMode()
          && (!CoreRune.MW_EMBED_ACTIVITY
              || (activityRecord4 = displayArea.mDisplayContent.mFocusedApp) == null
              || activityRecord4.getTask() != activityRecord5.getTask()
              || !displayArea.mDisplayContent.mFocusedApp.isEmbedded())) {
        displayArea.mDisplayContent.setFocusedApp(activityRecord5);
      }
      if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
        ProtoLogImpl.d(
            ProtoLogGroup.WM_DEBUG_STATES,
            ...
            0,
            (String) null,
            new Object[] {String.valueOf(activityRecord5)});
      }
      return false;
    }
    if (CoreRune.MT_SUPPORT_SIZE_COMPAT) {
      SizeCompatPolicyManager.get().ensureConfiguration(activityRecord5.getTask());
    }
    if (isDexMode()
        && (task = activityRecord5.getTask()) != null
        && this.mAtmService.mDexCompatController.isOrientationChangedLocked(
            task, activityRecord5)) {
      this.mAtmService.mDexCompatController.rotateDexCompatTaskLocked(activityRecord5);
    }
    if (this.mLastPausedActivity == activityRecord5 && shouldSleepOrShutDownActivities()) {
      executeAppTransition(activityOptions);
      if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
        ProtoLogImpl.d(
            ProtoLogGroup.WM_DEBUG_STATES, -1886145147, 0, (String) null, (Object[]) null);
      }
      return false;
    }
    if (!this.mAtmService.mAmInternal.hasStartedUserState(activityRecord5.mUserId)) {
      Slog.w(
          "ActivityTaskManager",
          "Skipping resume of top activity "
              + activityRecord5
              + ": user "
              + activityRecord5.mUserId
              + " is stopped");
      return false;
    }
    this.mTaskSupervisor.mStoppingActivities.remove(activityRecord5);
    this.mTaskSupervisor.setLaunchSource(activityRecord5.info.applicationInfo.uid);
    Task lastFocusedRootTask = displayArea.getLastFocusedRootTask();
    ActivityRecord topResumedActivity =
        (lastFocusedRootTask == null || lastFocusedRootTask == getRootTaskFragment().asTask())
            ? null
            : lastFocusedRootTask.getTopResumedActivity();
    boolean z3 = !z && displayArea.pauseBackTasks(activityRecord5);
    if (this.mResumedActivity != null) {
      if (this.mTaskSupervisor.mUserLeaving && inSplitScreenWindowingMode()) {
        Slog.d("ActivityTaskManager", "resumeTopActivity: clear userLeaving");
        startPausing = startPausing(false, false, activityRecord5, "resumeTopActivity");
      } else {
        if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
          ProtoLogImpl.d(
              ProtoLogGroup.WM_DEBUG_STATES,
              ...
              0,
              (String) null,
              new Object[] {String.valueOf(this.mResumedActivity)});
        }
        startPausing =
            startPausing(
                this.mTaskSupervisor.mUserLeaving, false, activityRecord5, "resumeTopActivity");
      }
      z3 |= startPausing;
    }
    if (z3) {
      ...
      if (activityRecord5.attachedToProcess()) {
        activityRecord5.app.updateProcessInfo(false, true, false, false);
      } else if (!activityRecord5.isProcessRunning()) {
        boolean z4 = this == displayArea.getFocusedRootTask();
        this.mAtmService.startProcessAsync(
            activityRecord5, false, z4, z4 ? "next-top-activity" : "next-activity");
      }
    ...
    ActivityManagerInternal activityManagerInternal = this.mAtmService.mAmInternal;
    WindowProcessController windowProcessController = activityRecord5.app;
    activityManagerInternal.onPackageResumedFG(
        windowProcessController != null ? windowProcessController.getPackageList() : null,
        activityRecord5.packageName,
        activityRecord5.launchedFromPackage,
        activityRecord5.occludesParent(),
        activityRecord5.intent,
        activityRecord5.mUserId);
    ActivityManagerPerformance activityManagerPerformance = this.mAtmService.mAMBooster;
    if (activityManagerPerformance != null) {
      activityManagerPerformance.onActivityResumeLocked(activityRecord5);
    }
    PerProcessNandswap.getInstance().notifyReentryAppToPPR(activityRecord5.getPid());
    if (shouldSleepActivities()) {
      this.mTaskSupervisor.finishNoHistoryActivitiesIfNeeded(activityRecord5);
    }
    if (activityRecord != null
        && activityRecord != activityRecord5
        && activityRecord5.nowVisible
    ...
    try {
      this.mTaskSupervisor
          ...
          .notifyBeforePackageUnstopped(activityRecord5.packageName);
      this.mAtmService
          .getPackageManager()
          .setPackageStoppedState(activityRecord5.packageName, false, activityRecord5.mUserId);
    } catch (RemoteException unused) {
    } catch (IllegalArgumentException e) {
      Slog.w(
          "ActivityTaskManager",
          "Failed trying to unstop package " + activityRecord5.packageName + ": " + e);
    }
    ...
    if (activityRecord != null) {
      if (activityRecord.finishing) {
        ...
        activityRecord.setVisibility(false);
      } else if (this.mTaskSupervisor.mNoAnimActivities.contains(activityRecord5)) {
        displayContent2.prepareAppTransition(0);
        z2 = false;
      } else {
        displayContent2.prepareAppTransition(1, activityRecord5.mLaunchTaskBehind ? 32 : 0);
        z2 = true;
      }
    } else if (this.mTaskSupervisor.mNoAnimActivities.contains(activityRecord5)) {
      displayContent2.prepareAppTransition(0);
    ...
    if (z2) {
      activityRecord5.applyOptionsAnimation();
    } else {
      activityRecord5.abortAndClearOptionsAnimation();
    }
    this.mTaskSupervisor.mNoAnimActivities.clear();
    if (activityRecord5.attachedToProcess()
        && activityRecord5.getState() != ActivityRecord.State.INITIALIZING) {
      boolean z5 =
          inMultiWindowMode()
              || !((activityRecord3 = this.mLastPausedActivity) == null
                  || activityRecord3.occludesParent());
      if (!activityRecord5.isVisibleRequested() || activityRecord5.mAppStopped || z5) {
        activityRecord5.app.addToPendingTop();
        activityRecord5.setVisibility(true);
      }
      activityRecord5.startLaunchTickingLocked();
      ActivityRecord topResumedActivity2 =
          lastFocusedRootTask == null ? null : lastFocusedRootTask.getTopResumedActivity();
      ActivityRecord.State state = activityRecord5.getState();
      ...
      activityRecord5.setState(ActivityRecord.State.RESUMED, "resumeTopActivity");
      ActivityManagerPerformance.notifyCurTopAct(activityRecord5);
      if (shouldBeVisible(activityRecord5)
          ? !this.mRootWindowContainer.ensureVisibilityAndConfig(
              activityRecord5, getDisplayId(), true, false)
          : true) {
        ActivityRecord activityRecord7 = topRunningActivity();
        if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
          ProtoLogImpl.i(
              ProtoLogGroup.WM_DEBUG_STATES,
              -310337305,
              0,
              (String) null,
              new Object[] {String.valueOf(activityRecord5), String.valueOf(activityRecord7)});
        }
        if (activityRecord7 != activityRecord5) {
          this.mTaskSupervisor.scheduleResumeTopActivities();
        }
        if (!activityRecord5.isVisibleRequested() || activityRecord5.mAppStopped) {
          activityRecord5.setVisibility(true);
        }
        activityRecord5.completeResumeLocked();
        return true;
      }
      try {
        ClientTransaction obtain =
            ClientTransaction.obtain(activityRecord5.app.getThread(), activityRecord5.token);
        ArrayList arrayList = activityRecord5.results;
        if (arrayList != null) {
          int size = arrayList.size();
          if (!activityRecord5.finishing && size > 0) {
            obtain.addCallback(ActivityResultItem.obtain(arrayList));
          }
        }
        ArrayList arrayList2 = activityRecord5.newIntents;
        if (arrayList2 != null) {
          obtain.addCallback(NewIntentItem.obtain(arrayList2, true));
        }
        activityRecord5.notifyAppResumed();
        EventLogTags.writeWmResumeActivity(
            activityRecord5.mUserId,
            System.identityHashCode(activityRecord5),
            activityRecord5.getTask().mTaskId,
            activityRecord5.shortComponentName);
        this.mAtmService.mExt.boostPriority(activityRecord5);
        this.mAtmService.getAppWarningsLocked().onResumeActivity(activityRecord5);
        activityRecord5.app.setPendingUiCleanAndForceProcessStateUpTo(
            this.mAtmService.mTopProcessState);
        activityRecord5.abortAndClearOptionsAnimation();
        obtain.setLifecycleStateRequest(
            ResumeActivityItem.obtain(
                activityRecord5.app.getReportedProcState(),
                displayContent2.isNextTransitionForward(),
                activityRecord5.shouldSendCompatFakeFocus()));
        ...
        try {
          ...
          Slog.w("ActivityTaskManager", "Exception thrown during resume of " + activityRecord5, e2);
          activityRecord5.finishIfPossible("resume-exception", true);
          return true;
        }
        ...
        if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
          ProtoLogImpl.v(
              ...
              0,
              (String) null,
              new Object[] {String.valueOf(state), String.valueOf(activityRecord5)});
        }
        activityRecord5.setState(state, "resumeTopActivityInnerLocked");
        if (topResumedActivity2 != null) {
          topResumedActivity2.setState(
              ActivityRecord.State.RESUMED, "resumeTopActivityInnerLocked");
        }
        Slog.i("ActivityTaskManager", "Restarting because process died: " + activityRecord5);
        if (!activityRecord5.hasBeenLaunched) {
          activityRecord5.hasBeenLaunched = true;
        } else if (lastFocusedRootTask != null
            && lastFocusedRootTask.isTopRootTaskInDisplayArea()) {
          activityRecord5.showStartingWindow(false);
        }
        this.mTaskSupervisor.startSpecificActivity(activityRecord5, true, false);
        return true;
      }
    } else {
      if (!activityRecord5.hasBeenLaunched) {
      ...
      this.mTaskSupervisor.startSpecificActivity(activityRecord5, true, true);
    }
    return true;
  }
  ...
  public boolean canBeResumed(ActivityRecord activityRecord) {
    return (getTask() == null || !getTask().isFreeformStashed())
        ...
        : topRunningActivity() != null && getVisibility(activityRecord) == 0;
  }
  ...
  public boolean startPausing(
    ...
    if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
      ProtoLogImpl.d(
          ...
          0,
          (String) null,
          new Object[] {String.valueOf(this), String.valueOf(this.mResumedActivity)});
    }
    if (this.mPausingActivity != null) {
      Slog.wtf(
          "ActivityTaskManager",
          "Going to pause when pause is already pending for "
              + this.mPausingActivity
              + " state="
              + this.mPausingActivity.getState());
      if (!shouldSleepActivities()) {
    ...
    if (activityRecord3 == activityRecord) {
      Slog.wtf(
          "ActivityTaskManager", "Trying to pause activity that is in process of being resumed");
      return false;
    }
    if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
      ProtoLogImpl.v(
          ...
          0,
          (String) null,
          new Object[] {String.valueOf(activityRecord3)});
    }
    this.mPausingActivity = activityRecord3;
    this.mLastPausedActivity = activityRecord3;
    if (!activityRecord3.finishing
        && activityRecord3.isNoHistory()
        && !this.mTaskSupervisor.mNoHistoryActivities.contains(activityRecord3)) {
    ...
    if (activityRecord != null) {
      boolean z7 =
          activityRecord.occludesParent()
              || this.mAtmService.mAppPairController.shouldAutoPipByAppPair();
      boolean checkEnterPictureInPictureState =
          activityRecord3.checkEnterPictureInPictureState("shouldAutoPipWhilePausing", z);
      if (z
          && z7
          && checkEnterPictureInPictureState
          && activityRecord3.pictureInPictureArgs.isAutoEnterEnabled()) {
        z5 = false;
        z6 = true;
      ...
      if (checkEnterPictureInPictureState && !z6) {
        Slog.d(
            "PipTaskOrganizer",
            "entering autoPip failed, userLeaving="
                + z
                + " resumingOccludesParent="
                + z7
                + " isAutoEnterEnabled="
                + activityRecord3.pictureInPictureArgs.isAutoEnterEnabled());
      }
    ...
    if (!activityRecord3.attachedToProcess()) {
      ...
      boolean enterPictureInPictureMode =
          this.mAtmService.enterPictureInPictureMode(
              activityRecord3, activityRecord3.pictureInPictureArgs, false);
      if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
        ProtoLogImpl.d(
            ProtoLogGroup.WM_DEBUG_STATES,
            -1101551167,
            ...
            (String) null,
            new Object[] {
              String.valueOf(activityRecord3), Boolean.valueOf(enterPictureInPictureMode)
            });
      }
    } else {
      schedulePauseActivity(activityRecord3, z, z3, false, str);
      this.mAtmService.mAmInternal.onPackagePausedBG(
          activityRecord3.info.packageName,
          activityRecord3.launchedFromPackage,
          activityRecord3.occludesParent(),
          activityRecord3.mUserId);
    }
    ...
    if (this.mPausingActivity == null) {
      if (z4
          && activityRecord3.isState(state)
          && activityRecord3.getLastParentBeforePip() == this) {
        activityRecord3.activityPaused(false);
      }
      if (ProtoLogCache.WM_DEBUG_STATES_enabled) {
        ProtoLogImpl.v(
            ProtoLogGroup.WM_DEBUG_STATES, -648891906, 0, (String) null, (Object[]) null);
      }
      if (activityRecord == null) {
        this.mRootWindowContainer.resumeFocusedTasksTopActivities();
      }
          ...
          .scheduleTransaction(
              ...
              (ActivityLifecycleItem)
                  PauseActivityItem.obtain(
                      activityRecord.finishing, z, activityRecord.configChangeFlags, z2, z3));
    } catch (Exception e) {
  ...
  public void completePause(boolean z, ActivityRecord activityRecord) {
    ...
    if (z) {
      ...
      if (topDisplayFocusedRootTask != null
        ...
        this.mRootWindowContainer.resumeFocusedTasksTopActivities(
            topDisplayFocusedRootTask, activityRecord2, null);
      } else {
        ActivityRecord activityRecord3 =
      ...
      if (activityRecord != null && BackNavigationController.isScreenshotEnabled()) {
        if (ProtoLogCache.WM_DEBUG_BACK_PREVIEW_enabled) {
          ProtoLogImpl.v(
              ...
              -134091882,
              0,
              "Screenshotting Activity %s",
              new Object[] {String.valueOf(activityRecord.mActivityComponent.flattenToString())});
        }
        Rect bounds = activityRecord.getBounds();
        this.mBackScreenshots.put(
  ...
  public RemoteAnimationTarget createRemoteAnimationTarget(
    ...
    if (remoteAnimationRecord.getMode() == 0) {
      topMostActivity =
          getActivity(
              new Predicate() { // from class:
                                // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda7
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$createRemoteAnimationTarget$7;
                  lambda$createRemoteAnimationTarget$7 =
                      TaskFragment.lambda$createRemoteAnimationTarget$7((ActivityRecord) obj);
  ...
  public static /* synthetic */ boolean lambda$createRemoteAnimationTarget$7(
      ActivityRecord activityRecord) {
  ...
  public void resolveOverrideConfiguration(Configuration configuration) {
    ...
    if (rect != null && !rect.isEmpty()) {
      resolvedOverrideConfiguration.windowConfiguration.setBounds(
          translateRelativeBoundsToAbsoluteBounds(
              this.mRelativeEmbeddedBounds, configuration.windowConfiguration.getBounds()));
    }
    ...
    if ((!CoreRune.MT_DEX_SIZE_COMPAT_MODE
            || DexSizeCompatController.getInstance().getCompatPolicy(asTask()) == null)
        && !supportsMultiWindow()
        && (!CoreRune.MW_EMBED_ACTIVITY || asTask() != null || !isEmbedded())) {
      int stage = getResolvedOverrideConfiguration().windowConfiguration.getStage();
      if (this.mCreatedByOrganizer
          && asTask() != null
          && windowingMode == 6
          && WindowConfiguration.isSplitScreenWindowingMode(stage)
          && this.mAtmService.mMultiWindowEnableController.deviceSupportsMultiWindow()) {
        Slog.d(
            "ActivityTaskManager",
            "resolveOverrideConfiguration: force allow multi-window, tid #" + asTask().mTaskId);
      } else {
        if (windowingMode != 0) {
          windowingMode2 = windowingMode;
        }
        if (WindowConfiguration.inMultiWindowMode(windowingMode2)
            && windowingMode2 != 2
            && (getTask() == null || !getTask().isDexCompatEnabled())) {
          resolvedOverrideConfiguration.windowConfiguration.setWindowingMode(1);
        }
      }
    }
  ...
  public boolean supportsMultiWindowInDisplayArea(TaskDisplayArea taskDisplayArea, boolean z) {
    ...
    if ((!activityTaskManagerService.mSupportsMultiWindow
            && (!z
                || !activityTaskManagerService.mMultiWindowEnableController
                    .deviceSupportsMultiWindow()))
  ...
  public void computeConfigResourceOverrides(
  ...
  public void computeConfigResourceOverrides(
      Configuration configuration, Configuration configuration2, DisplayInfo displayInfo) {
    if (displayInfo != null) {
  ...
  public void computeConfigResourceOverrides(
      ...
      ActivityRecord.CompatDisplayInsets compatDisplayInsets) {
  ...
  public void computeConfigResourceOverrides(
    ...
    computeConfigResourceOverrides(
        configuration, configuration2, displayInfo, compatDisplayInsets, null);
  }
  ...
  public void computeConfigResourceOverrides(
    ...
    if (!isDexMode()
        && getTask() != null
        && !getTask().mCreatedByOrganizer
        && MultiWindowUtils.needToUpdateDensity(
            windowingMode,
            getActivityType(),
            WindowConfiguration.isSplitScreenWindowingMode(configuration2.windowConfiguration))
        && (scaleDownDensity =
                MultiWindowUtils.getScaleDownDensity(
                    configuration2.smallestScreenWidthDp, configuration2.densityDpi))
            > 0) {
    ...
    if (appBounds2 == null || appBounds2.isEmpty()) {
      ...
      if (!z && windowingMode != 5) {
        if (contains) {
          ...
          TaskDisplayArea displayArea = getDisplayArea();
          appBounds =
              displayArea != null ? displayArea.getWindowConfiguration().getAppBounds() : null;
        }
    ...
    if (configuration.screenWidthDp == 0 || configuration.screenHeightDp == 0) {
      if (!z && WindowConfiguration.isFloating(windowingMode)) {
        ...
        DisplayInfo displayInfo2 =
            displayInfo != null ? displayInfo : getDisplayContent().getDisplayInfo();
        if (MultiWindowCoreState.MW_SPLIT_IMMERSIVE_MODE_ENABLED && inSplitScreenWindowingMode()) {
          this.mTmpNonDecorBounds.set(this.mTmpFullBounds);
          this.mTmpStableBounds.set(this.mTmpFullBounds);
        } else if (MultiWindowCoreState.MW_NAVISTAR_SPLIT_IMMERSIVE_MODE_ENABLED
          ...
          DisplayPolicy.DecorInsets.Info decorInsetsInfo =
              this.mDisplayContent
                  .getDisplayPolicy()
                  .getDecorInsetsInfo(
                      displayInfo2.rotation, displayInfo2.logicalWidth, displayInfo2.logicalHeight);
          intersectWithInsetsIfFits(
              this.mTmpNonDecorBounds, this.mTmpBounds, decorInsetsInfo.mCutoutInsets);
          intersectWithInsetsIfFits(
              this.mTmpStableBounds, this.mTmpBounds, decorInsetsInfo.mExceptNavConfigInsets);
        } else {
          calculateInsetFrames(
              this.mTmpNonDecorBounds, this.mTmpStableBounds, this.mTmpFullBounds, displayInfo2);
        }
      } else {
        ...
        if (CoreRune.MT_SUPPORT_SIZE_COMPAT && sizeCompatPolicy != null && rotation != -1 && z) {
          ...
          intersectWithInsetsIfFits(
              this.mTmpNonDecorBounds, this.mTmpBounds, sizeCompatPolicy.mNonDecorInsets[rotation]);
          intersectWithInsetsIfFits(
              this.mTmpStableBounds, this.mTmpBounds, sizeCompatPolicy.mStableInsets[rotation]);
          ...
          intersectWithInsetsIfFits(
              this.mTmpNonDecorBounds,
              this.mTmpBounds,
              compatDisplayInsets.mNonDecorInsets[rotation]);
          intersectWithInsetsIfFits(
              this.mTmpStableBounds, this.mTmpBounds, compatDisplayInsets.mStableInsets[rotation]);
          appBounds2.set(this.mTmpNonDecorBounds);
        } else {
      ...
      if (configuration.smallestScreenWidthDp == 0) {
        boolean z2 =
            windowingMode == 2
                && !this.mTmpFullBounds.isEmpty()
                && this.mTmpFullBounds.equals(bounds);
        if ((WindowConfiguration.isFloating(windowingMode)
                || configuration.windowConfiguration.isPopOver())
            && !z2) {
          configuration.smallestScreenWidthDp =
              (int)
                  ((Math.min(this.mTmpFullBounds.width(), this.mTmpFullBounds.height()) / f2)
                      + 0.5f);
    ...
    if (configuration.orientation == 0) {
      configuration.orientation =
          configuration.screenWidthDp <= configuration.screenHeightDp ? 1 : 2;
    }
    if (configuration.screenLayout == 0) {
      ...
      configuration.screenLayout =
          WindowContainer.computeScreenLayout(configuration2.screenLayout, width2, height2);
    }
  }
  ...
  public Rect translateRelativeBoundsToAbsoluteBounds(Rect rect, Rect rect2) {
    ...
    if (!isAllowedToBeEmbeddedInTrustedMode()
  ...
  public boolean setClosingChangingStartBoundsIfNeeded() {
    ...
    this.mDisplayContent.mClosingChangingContainers.put(
        this, new Rect(this.mSurfaceFreezer.mFreezeBounds));
    return true;
  }
  ...
  public void sendTaskFragmentParentInfoChanged() {
    ...
    this.mTaskFragmentOrganizerController.onTaskFragmentParentInfoChanged(
        iTaskFragmentOrganizer, asTask);
  }
  ...
  public TaskFragmentInfo getTaskFragmentInfo() {
    ...
    for (int i = 0; i < getChildCount(); i++) {
      ...
      if (this.mTaskFragmentOrganizerUid != -1
          ...
          && ((asActivityRecord.info.processName.equals(this.mTaskFragmentOrganizerProcessName)
                  || (CoreRune.MW_EMBED_ACTIVITY
                      && (applicationInfo = asActivityRecord.info.applicationInfo) != null
    ...
    return new TaskFragmentInfo(
        ...
        arrayList2,
        point,
        this.mClearedTaskForReuse,
        this.mClearedTaskFragmentForPip,
        this.mClearedForReorderActivityToFront,
  ...
  public Point calculateMinDimension() {
    ...
    forAllActivities(
        new Consumer() { // from class: com.android.server.wm.TaskFragment$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public static /* synthetic */ void lambda$calculateMinDimension$8(
      int[] iArr, int[] iArr2, ActivityRecord activityRecord) {
    Point minDimensions;
  ...
  public void clearLastPausedActivity() {
    forAllTaskFragments(
        new Consumer() { // from class: com.android.server.wm.TaskFragment$$ExternalSyntheticLambda8
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void setMinDimensions(int i, int i2) {
    if (asTask() != null) {
      throw new UnsupportedOperationException(
          "This method must not be used to Task. The  minimum dimension of Task should be passed"
              + " from Task constructor.");
    }
    this.mMinWidth = i;
    this.mMinHeight = i2;
  }
  ...
  public final void cleanUpEmbeddedTaskFragment() {
    if (this.mIsEmbedded) {
      ...
      task.forAllLeafTaskFragments(
          new Consumer() { // from class:
                           // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
      ...
      if (CoreRune.MW_EMBED_ACTIVITY && !matchParentBounds()) {
        dimBounds.inset(
            this.mDisplayContent
                ...
                .getRawInsetsState()
                .calculateInsets(this.mTmpBounds, WindowInsets.Type.navigationBars(), false));
      }
  ...
  public boolean dump(
    ...
    Runnable runnable2 =
        new Runnable() { // from class:
                         // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda11
    ...
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      ...
      if (windowContainer.asTaskFragment() != null) {
        z4 =
            windowContainer
                    .asTaskFragment()
                    .dump(str + "  ", fileDescriptor, printWriter, z, z2, str2, z3, runnable2)
                | z4;
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$dump$11(
      boolean z, PrintWriter printWriter, Runnable runnable, String str, boolean z2, String str2) {
    if (z) {
      printWriter.println();
    }
    if (runnable != null) {
  ...
  public void dumpInner(String str, PrintWriter printWriter, boolean z, String str2) {
    ...
    if (baseIntent == null
        || baseIntent.getExtras() == null
        || (size = baseIntent.getExtras().getSize()) <= 20000) {
      return;
    }
  ...
  public void dump(PrintWriter printWriter, String str, boolean z) {
    ...
    for (int size = this.mChildren.size() - 1; size >= 0; size--) {
      ...
      sb3.append("* ");
      sb3.append(
          (Object) (asTaskFragment != null ? asTaskFragment.toFullString() : windowContainer));
  ...
  public static /* synthetic */ boolean lambda$allowEdgeExtension$12(
      ActivityRecord activityRecord) {
  ...
  public boolean allowEdgeExtension() {
    return getActivity(
            new Predicate() { // from class:
                              // com.android.server.wm.TaskFragment$$ExternalSyntheticLambda5
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$allowEdgeExtension$12;
                lambda$allowEdgeExtension$12 =
                    TaskFragment.lambda$allowEdgeExtension$12((ActivityRecord) obj);
