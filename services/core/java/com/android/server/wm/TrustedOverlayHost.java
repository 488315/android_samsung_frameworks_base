...
public class TrustedOverlayHost {
  ...
  public void addOverlay(
      SurfaceControlViewHost.SurfacePackage surfacePackage, SurfaceControl surfaceControl) {
    requireOverlaySurfaceControl();
    this.mOverlays.add(surfacePackage);
    SurfaceControl.Transaction transaction =
        (SurfaceControl.Transaction) this.mWmService.mTransactionFactory.get();
    transaction
        .reparent(surfacePackage.getSurfaceControl(), this.mSurfaceControl)
        .show(surfacePackage.getSurfaceControl());
