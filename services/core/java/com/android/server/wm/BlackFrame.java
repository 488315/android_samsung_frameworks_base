...
public class BlackFrame {
    ...
    public BlackSurface(
      ...
      if (ProtoLogCache.WM_SHOW_SURFACE_ALLOC_enabled) {
        ProtoLogImpl.i(
            ...
            4,
            (String) null,
            new Object[] {String.valueOf(build), Long.valueOf(i)});
      }
    }
  }
  ...
  public BlackFrame(
    ...
    try {
      ...
      if (i2 < i3) {
        blackSurfaceArr[0] =
            new BlackSurface(
                transaction, i, rect.left, i2, rect2.right, i3, displayContent, surfaceControl);
      }
      int i4 = rect.left;
      int i5 = rect2.left;
      if (i4 < i5) {
        blackSurfaceArr[1] =
            new BlackSurface(
                transaction, i, i4, rect2.top, i5, rect.bottom, displayContent, surfaceControl);
      }
      int i6 = rect.bottom;
      int i7 = rect2.bottom;
      if (i6 > i7) {
        blackSurfaceArr[2] =
            new BlackSurface(
                transaction, i, rect2.left, i7, rect.right, i6, displayContent, surfaceControl);
      }
      int i8 = rect.right;
      int i9 = rect2.right;
      if (i8 > i9) {
        blackSurfaceArr[3] =
            new BlackSurface(
                transaction, i, i9, rect.top, i8, rect2.bottom, displayContent, surfaceControl);
      }
    } catch (Throwable th) {
      kill();
      throw th;
  ...
  public void kill() {
    SurfaceControl.Transaction transaction =
        (SurfaceControl.Transaction) this.mTransactionFactory.get();
    int i = 0;
    while (true) {
      BlackSurface[] blackSurfaceArr = this.mBlackSurfaces;
      if (i < blackSurfaceArr.length) {
        ...
        if (blackSurface != null) {
          if (ProtoLogCache.WM_SHOW_SURFACE_ALLOC_enabled) {
            ProtoLogImpl.i(
                ...
                0,
                (String) null,
                new Object[] {String.valueOf(blackSurface.surface)});
          }
