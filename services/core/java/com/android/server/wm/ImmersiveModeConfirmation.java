...
public class ImmersiveModeConfirmation {
  ...
  public final HandlerC2933H mHandler;
  ...
  public final Runnable mConfirm =
      new Runnable() { // from class: com.android.server.wm.ImmersiveModeConfirmation.1
        ...
        public void run() {
          ...
          if (ImmersiveModeConfirmation.this.mCoverManager != null
              && ImmersiveModeConfirmation.this.mListenerRegistered
              && ImmersiveModeConfirmation.sConfirmed
              && ImmersiveModeConfirmation.sConfirmedForGesture) {
            ImmersiveModeConfirmation.this.mCoverManager.unregisterListener(
                ImmersiveModeConfirmation.this.mCoverStateListener);
  ...
  public final CoverManager.StateListener mCoverStateListener =
      new CoverManager
          .StateListener() { // from class: com.android.server.wm.ImmersiveModeConfirmation.2
  ...
  public ImmersiveModeConfirmation(
      Context context, Looper looper, boolean z, boolean z2, DisplayPolicy displayPolicy) {
    ...
    this.mContext =
        display.getDisplayId() != 0
            ...
            : systemUiContext;
    this.mHandler = new HandlerC2933H(looper);
    this.mShowDelayMs =
        context.getResources().getInteger(R.integer.leanback_setup_alpha_activity_out_bkg_duration)
            * 3;
    this.mPanicThresholdMs =
        context.getResources().getInteger(R.integer.config_lidNavigationAccessibility);
    this.mVrModeEnabled = z;
    this.mCanSystemBarsBeShownByUser = z2;
    this.mDisplayPolicy = displayPolicy;
    this.mDisablePackages =
        new ArrayList(Arrays.asList(context.getResources().getStringArray(17236437)));
  }
  ...
  public static void saveSetting(Context context) {
    try {
      Settings.Secure.putStringForUser(
          ...
          sConfirmed ? "confirmed" : null,
          -2);
    } catch (Throwable th) {
      Slog.w(
          "ImmersiveModeConfirmation", "Error saving confirmations, sConfirmed=" + sConfirmed, th);
    }
  }
  ...
  public void immersiveModeChangedLw(
      int i, boolean z, boolean z2, boolean z3, WindowState windowState) {
    this.mHandler.removeMessages(1);
    if (z) {
      if (!this.mDisplayPolicy.mExt.isNavigationGestureMode()
          ? !sConfirmed
          : !sConfirmedForGesture) {
        if (z2
            && !this.mVrModeEnabled
            && this.mCanSystemBarsBeShownByUser
            && !z3
            && !UserManager.isDeviceInDemoMode(this.mContext)
            && this.mLockTaskState != 1
            && isImmersiveModeAvailable(windowState)) {
      ...
      if (this.mCoverManager != null
        ...
        this.mHandler.post(
            new Runnable() { // from class:
                             // com.android.server.wm.ImmersiveModeConfirmation$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
  ...
  public final WindowManager.LayoutParams getClingWindowLayoutParams() {
    ...
    layoutParams.windowAnimations = R.style.Animation.DeviceDefault.Dialog;
  ...
  public class ClingWindowView extends FrameLayout {
    ...
    public ClingWindowView(Context context, Runnable runnable) {
      ...
      this.mUpdateLayoutRunnable =
          new Runnable() { // from class:
                           // com.android.server.wm.ImmersiveModeConfirmation.ClingWindowView.1
            @Override // java.lang.Runnable
            public void run() {
              if (ClingWindowView.this.mClingLayout == null
                  || ClingWindowView.this.mClingLayout.getParent() == null) {
                return;
              }
              ClingWindowView.this.mClingLayout.setLayoutParams(
                  ImmersiveModeConfirmation.this.getBubbleLayoutParams());
            }
          };
          ...
          new ViewTreeObserver
            ...
            public void onComputeInternalInsets(
              ...
              region.set(
                  ...
                  this.mTmpInt2[1] + ClingWindowView.this.mClingLayout.getHeight());
            }
          };
      this.mReceiver =
      ...
      this.SINE_IN_OUT_33 =
          new PathInterpolator(0.33f, DisplayPowerController2.RATE_FROM_DOZE_TO_ON, 0.67f, 1.0f);
    ...
    public void onAttachedToWindow() {
      ...
      ViewGroup viewGroup =
          (ViewGroup) View.inflate(getContext(), R.layout.language_picker_item, null);
      this.mClingLayout = viewGroup;
      this.mLayoutPort = (FrameLayout) viewGroup.findViewById(R.id.input_mode);
      this.mLayoutLand = (FrameLayout) this.mClingLayout.findViewById(R.id.input_minute);
      this.mTextPort = (TextView) this.mClingLayout.findViewById(R.id.runtime);
      this.mTextLand = (TextView) this.mClingLayout.findViewById(R.id.ltr);
      this.mButtonOkPort = (Button) this.mClingLayout.findViewById(R.id.sans);
      this.mButtonOkLand = (Button) this.mClingLayout.findViewById(R.id.map);
      this.mImageArrow0 =
          (ImageView) this.mClingLayout.findViewById(R.id.input_method_nav_center_group);
      this.mImageArrow90 =
          (ImageView) this.mClingLayout.findViewById(R.id.input_method_nav_home_handle);
      this.mImageArrow270 =
          (ImageView) this.mClingLayout.findViewById(R.id.input_method_nav_ends_group);
      this.mButtonOkPort.setOnClickListener(
          new View
              .OnClickListener() { // from class:
                                   // com.android.server.wm.ImmersiveModeConfirmation$ClingWindowView$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
              ImmersiveModeConfirmation.ClingWindowView.this.lambda$onAttachedToWindow$0(view);
            }
          });
      this.mButtonOkLand.setOnClickListener(
          new View
              .OnClickListener() { // from class:
                                   // com.android.server.wm.ImmersiveModeConfirmation$ClingWindowView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
            ...
            new Runnable() { // from class:
              ...
              public void run() {
                viewGroup2
                    .animate()
                    .alpha(1.0f)
                    .translationY(DisplayPowerController2.RATE_FROM_DOZE_TO_ON)
                    .setDuration(250L)
                    .setInterpolator(ClingWindowView.this.mInterpolator)
                    .withLayer()
                    .start();
                ClingWindowView.this.mColorAnim =
                    ValueAnimator.ofObject(new ArgbEvaluator(), 0, Integer.MIN_VALUE);
      ...
      ((FrameLayout) this)
          .mContext.registerReceiver(
              this.mReceiver, new IntentFilter("android.intent.action.CONFIGURATION_CHANGED"));
    }
    ...
    public final void updateTextSize() {
      float dimensionPixelOffset =
          ((FrameLayout) this).mContext.getResources().getDimensionPixelOffset(17105752);
    ...
    public final void startArrowAnimation(int i) {
      ...
      int dimensionPixelOffset =
          ((FrameLayout) this)
              .mContext
              .getResources()
              .getDimensionPixelOffset(i == 4 ? 17105749 : 17105748);
      if (i == 1) {
        translateAnimation =
      ...
      AlphaAnimation alphaAnimation =
          new AlphaAnimation(1.0f, DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
      ...
      animationSet.setAnimationListener(
          new Animation
              .AnimationListener() { // from class:
                                     // com.android.server.wm.ImmersiveModeConfirmation.ClingWindowView.6
    ...
    public final void startButtonAnimation(int i) {
      ...
      AlphaAnimation alphaAnimation =
          new AlphaAnimation(DisplayPowerController2.RATE_FROM_DOZE_TO_ON, 1.0f);
    ...
    public void onConfigurationChanged(Configuration configuration) {
      ...
      boolean navigationBarCanMove =
          ImmersiveModeConfirmation.this.mDisplayPolicy.navigationBarCanMove();
      ...
      this.mClingHandler.post(
          new Runnable() { // from class:
                           // com.android.server.wm.ImmersiveModeConfirmation$ClingWindowView$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public final WindowManager getWindowManager(int i) {
    if (this.mWindowManager == null || this.mWindowContext == null) {
      Context createWindowContext =
          this.mContext.createWindowContext(2017, getOptionsForWindowContext(i));
      this.mWindowContext = createWindowContext;
      WindowManager windowManager =
          (WindowManager) createWindowContext.getSystemService(WindowManager.class);
    ...
    try {
      WindowManagerGlobal.getWindowManagerService()
          .attachWindowContextToDisplayArea(
              this.mWindowContext.getWindowContextToken(),
              2017,
              this.mContext.getDisplayId(),
              optionsForWindowContext);
  ...
  public final class HandlerC2933H extends Handler {
    public HandlerC2933H(Looper looper) {
      super(looper);
    }
  ...
  public final boolean isImmersiveModeAvailable(WindowState windowState) {
    if (this.mClingWindow != null) {
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. clingWindow is not null.");
      return false;
    }
    if (this.mDisablePackages.contains(windowState.getOwningPackage())) {
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. disablePackage="
              + windowState.getOwningPackage());
      return false;
    }
    if (!sConfirmedForGesture
        && sConfirmed
        && "android.server.wm.cts".equals(windowState.getOwningPackage())) {
      return false;
    }
    if (windowState.getAttrs().type < 1 || windowState.getAttrs().type > 99) {
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. appWindow type="
              + windowState.getAttrs().type);
      return false;
    }
    if (!windowState.getAttrs().isFullscreen()) {
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. Not fullscreen.");
      return false;
    }
    if (CoreRune.IS_FACTORY_BINARY
      ...
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. Factory test mode.");
      return false;
    }
    if (!isPreloadInstallComplete()) {
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. Not preloadInstallComplete.");
      return false;
    }
    if (!this.mCoverState) {
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. coverClosed.");
      return false;
    }
    if (Settings.System.getInt(this.mContext.getContentResolver(), "ultra_powersaving_mode", 0)
      ...
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. maxPowerSavingModeEnabled.");
      return false;
    }
    if (getAccessibilityManager().semIsAccessibilityServiceEnabled(16)) {
      Slog.d(
          "ImmersiveModeConfirmation",
          "Do nothing regarding immersiveModeConfirmation. talkBackEnabled.");
      return false;
    }
    ...
    Slog.d(
        "ImmersiveModeConfirmation",
        "Do nothing regarding immersiveModeConfirmation. voiceAssistantEnabled.");
    return false;
  }
  ...
  public void showOkButton() {
    ...
    if (clingWindowView != null) {
      ...
      clingWindowView.mClingHandler.post(
          new Runnable() { // from class:
                           // com.android.server.wm.ImmersiveModeConfirmation$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public static boolean loadGestureSetting(int i, Context context) {
    ...
    try {
      str =
          Settings.Secure.getStringForUser(
              context.getContentResolver(), "gesture_immersive_mode_confirmations", -2);
  ...
  public static void saveGestureSetting(Context context) {
    try {
      Settings.Secure.putStringForUser(
          ...
          sConfirmedForGesture ? "confirmed" : null,
          -2);
    } catch (Throwable th) {
      Slog.w(
          "ImmersiveModeConfirmation",
          "Error saving gesture confirmations, sConfirmedForGesture=" + sConfirmedForGesture,
          th);
    }
  }
