...
public final class AccessibilityWindowsPopulator extends WindowInfosListener {
  ...
  public AccessibilityWindowsPopulator(
      WindowManagerService windowManagerService, AccessibilityController accessibilityController) {
  ...
  public void populateVisibleWindowsOnScreenLocked(int i, List list) {
    ...
    synchronized (this.mLock) {
      ...
      IBinder accessibilityWindowToken =
          shellRoot != null ? shellRoot.getAccessibilityWindowToken() : null;
      Iterator it = list2.iterator();
      while (it.hasNext()) {
        list.add(
            AccessibilityWindow.initializeData(
                this.mService,
                (InputWindowHandle) it.next(),
                matrix,
                accessibilityWindowToken,
                matrix2));
      }
    }
  }
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          ...
          public final void run() {
            AccessibilityWindowsPopulator.this.lambda$onWindowInfosChanged$0(
  ...
  public final void lambda$onWindowInfosChanged$0(
      InputWindowHandle[] inputWindowHandleArr, WindowInfosListener.DisplayInfo[] displayInfoArr) {
    ...
    for (InputWindowHandle inputWindowHandle : inputWindowHandleArr) {
      ...
      boolean z4 =
          (inputWindowHandle.frameBottom == inputWindowHandle.frameTop
                  || inputWindowHandle.frameLeft == inputWindowHandle.frameRight)
              ? false
              : true;
      if (z && z2 && z3 && z4) {
      ...
      try {
        ...
        while (it.hasNext()) {
          ...
          WindowState windowState =
              window != null ? (WindowState) this.mService.mWindowMap.get(window.asBinder()) : null;
  ...
  public void setMagnificationSpec(int i, MagnificationSpec magnificationSpec) {
    synchronized (this.mLock) {
      MagnificationSpec magnificationSpec2 =
          (MagnificationSpec) this.mCurrentMagnificationSpec.get(i);
      if (magnificationSpec2 == null) {
        ...
        MagnificationSpec magnificationSpec4 =
            (MagnificationSpec) this.mPreviousMagnificationSpec.get(i);
  ...
  public static void getDisplaysForWindowsChanged(
      List list, SparseArray sparseArray, SparseArray sparseArray2) {
    for (int i = 0; i < sparseArray.size(); i++) {
      int keyAt = sparseArray.keyAt(i);
    ...
    for (int i = 0; i < sparseArray.size(); i++) {
      ...
      if (magnificationSpec != null) {
        ...
        if (magnificationSpec3 == null) {
          ...
          generateInverseMatrixBasedOnProperMagnificationSpecForDisplay(
              list, magnificationSpec2, magnificationSpec4);
        }
      }
    }
  }

  public final void generateInverseMatrixBasedOnProperMagnificationSpecForDisplay(
      List list, MagnificationSpec magnificationSpec, MagnificationSpec magnificationSpec2) {
    for (int size = list.size() - 1; size >= 0; size--) {
      Matrix matrix = this.mTempMatrix2;
      InputWindowHandle inputWindowHandle = (InputWindowHandle) list.get(size);
      if (getWindowTransformMatrix(
          inputWindowHandle.getWindow() != null ? inputWindowHandle.getWindow().asBinder() : null,
          matrix)) {
        generateMagnificationSpecInverseMatrix(
            inputWindowHandle, magnificationSpec, magnificationSpec2, matrix);
        return;
      }
    }
  }
  ...
  public final void generateMagnificationSpecInverseMatrix(
  ...
  public final void computeIdentityMatrix(
      InputWindowHandle inputWindowHandle,
      MagnificationSpec magnificationSpec,
      Matrix matrix,
      float[] fArr) {
  ...
  public final boolean selectProperMagnificationSpecByComparingIdentityDegree(
      float[] fArr, float[] fArr2) {
    ...
    return Float.compare(abs2, abs) > 0
        || (Float.compare(abs2, abs) == 0
            && Float.compare(
                    Math.abs(fArr3[2] - fArr2[2]) + Math.abs(fArr3[5] - fArr2[5]),
                    abs3 + Math.abs(fArr3[5] - fArr[5]))
                > 0);
  }
  ...
  public static void transformMagnificationSpecToMatrix(
      MagnificationSpec magnificationSpec, Matrix matrix) {
    matrix.reset();
  ...
  public void dump(final PrintWriter printWriter, final String str) {
    ...
    DumpUtils.KeyDumper keyDumper =
        new DumpUtils
            .KeyDumper() { // from class:
                           // com.android.server.wm.AccessibilityWindowsPopulator$$ExternalSyntheticLambda1
          public final void dump(int i, int i2) {
            AccessibilityWindowsPopulator.lambda$dump$1(i, i2);
          }
        };
    DumpUtils.KeyDumper keyDumper2 =
        new DumpUtils
            .KeyDumper() { // from class:
                           // com.android.server.wm.AccessibilityWindowsPopulator$$ExternalSyntheticLambda2
          public final void dump(int i, int i2) {
            AccessibilityWindowsPopulator.lambda$dump$2(printWriter, str, i, i2);
          }
        };
    DumpUtils.ValueDumper valueDumper =
        new DumpUtils
            .ValueDumper() { // from class:
                             // com.android.server.wm.AccessibilityWindowsPopulator$$ExternalSyntheticLambda3
    ...
    DumpUtils.dumpSparseArray(
        ...
        new DumpUtils
            .ValueDumper() { // from class:
                             // com.android.server.wm.AccessibilityWindowsPopulator$$ExternalSyntheticLambda4
          public final void dump(Object obj) {
    ...
    DumpUtils.dumpSparseArray(
        printWriter,
        str2,
        this.mInputWindowHandlesOnDisplays,
        "window handles on display",
        keyDumper2,
        new DumpUtils
            .ValueDumper() { // from class:
                             // com.android.server.wm.AccessibilityWindowsPopulator$$ExternalSyntheticLambda5
          public final void dump(Object obj) {
    ...
    DumpUtils.dumpSparseArray(
        printWriter,
        str2,
        this.mMagnificationSpecInverseMatrix,
        "magnification spec matrix",
        keyDumper,
        new DumpUtils
            .ValueDumper() { // from class:
                             // com.android.server.wm.AccessibilityWindowsPopulator$$ExternalSyntheticLambda6
          public final void dump(Object obj) {
    ...
    DumpUtils.dumpSparseArray(
        ...
        "current magnification spec",
        keyDumper,
        valueDumper);
    DumpUtils.dumpSparseArray(
        printWriter,
        str2,
        this.mPreviousMagnificationSpec,
        "previous magnification spec",
        keyDumper,
        valueDumper);
  }
  ...
  public class MyHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      ...
      if (i == 1) {
        ...
        Slog.w(
            AccessibilityWindowsPopulator.TAG,
            "Windows change within in 2 frames continuously over 500 ms and notify windows changed"
                + " immediately");
  ...
  public class AccessibilityWindow {
    ...
    public static AccessibilityWindow initializeData(
      ...
      WindowState windowState =
          window != null
              ? (WindowState) windowManagerService.mWindowMap.get(window.asBinder())
              : null;
      ...
      accessibilityWindow.mIgnoreDuetoRecentsAnimation =
          (windowState == null
                  ...
                  || !recentsAnimationController.shouldIgnoreForAccessibility(windowState))
              ? false
              : true;
      getTouchableRegionInWindow(
          accessibilityWindow.mShouldMagnify,
          inputWindowHandle.touchableRegion,
          accessibilityWindow.mTouchableRegionInWindow,
          new Rect(
              inputWindowHandle.frameLeft,
              inputWindowHandle.frameTop,
              inputWindowHandle.frameRight,
              inputWindowHandle.frameBottom),
          matrix,
          matrix2);
      getUnMagnifiedTouchableRegion(
          accessibilityWindow.mShouldMagnify,
          inputWindowHandle.touchableRegion,
          accessibilityWindow.mTouchableRegionInScreen,
          matrix,
          matrix2);
      accessibilityWindow.mWindowInfo =
          windowState != null
              ? windowState.getWindowInfo()
              : getWindowInfoForWindowlessWindows(accessibilityWindow);
    ...
    public static void getTouchableRegionInWindow(
        boolean z, Region region, Region region2, Rect rect, Matrix matrix, Matrix matrix2) {
    ...
    public static void getUnMagnifiedTouchableRegion(
        boolean z, Region region, final Region region2, final Matrix matrix, final Matrix matrix2) {
        ...
        RegionUtils.forEachRect(
            ...
            new Consumer() { // from class:
              ...
              public final void accept(Object obj) {
                AccessibilityWindowsPopulator.AccessibilityWindow
                    .lambda$getUnMagnifiedTouchableRegion$0(matrix2, matrix, region2, (Rect) obj);
              }
            });
      }
    }

    public static /* synthetic */ void lambda$getUnMagnifiedTouchableRegion$0(
        Matrix matrix, Matrix matrix2, Region region, Rect rect) {
    ...
    public static WindowInfo getWindowInfoForWindowlessWindows(
    ...
    public String toString() {
      ...
      return "A11yWindow=["
          + (iWindow != null ? iWindow.asBinder().toString() : "(no window token)")
          + ", displayId="
          + this.mDisplayId
          + ", inputConfig=0x"
          + Integer.toHexString(this.mInputConfig)
          + ", type="
          + this.mType
          + ", privateFlag=0x"
          + Integer.toHexString(this.mPrivateFlags)
          + ", focused="
          + this.mIsFocused
          + ", shouldMagnify="
          + this.mShouldMagnify
          + ", ignoreDuetoRecentsAnimation="
          + this.mIgnoreDuetoRecentsAnimation
          + ", isTrustedOverlay="
          + isTrustedOverlay()
          + ", regionInScreen="
          + this.mTouchableRegionInScreen
          + ", touchableRegion="
          + this.mTouchableRegionInWindow
          + ", isPIPMenu="
          + this.mIsPIPMenu
          + ", windowInfo="
          + this.mWindowInfo
