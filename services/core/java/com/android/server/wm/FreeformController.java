...
public class FreeformController implements IController {
  ...
  public void initialize() {
    this.f1741mH = new HandlerC2922H(this.mAtm.f1734mH.getLooper());
  }
  ...
  public void onConfigurationChanged(DisplayContent displayContent) {
    ...
    this.mFreeformCornerRadius.put(
        displayContent.getDisplayId(),
        Integer.valueOf(
            resources.getDimensionPixelSize(R.dimen.harmful_app_message_padding_right)));
  }
  ...
  public void scheduleBindMinimizeContainerService(String str) {
    Message obtainMessage = this.f1741mH.obtainMessage(101);
    obtainMessage.obj = str;
    this.f1741mH.sendMessage(obtainMessage);
  }

  public void scheduleUnbindMinimizeContainerService(String str) {
    Message obtainMessage = this.f1741mH.obtainMessage(102);
    obtainMessage.obj = str;
    this.f1741mH.sendMessage(obtainMessage);
  }

  public void scheduleBindSmartPopupViewService(String str) {
    Message obtainMessage = this.f1741mH.obtainMessage(103);
    obtainMessage.obj = str;
    this.f1741mH.sendMessage(obtainMessage);
  }

  public void scheduleUnbindSmartPopupViewService(String str) {
    Message obtainMessage = this.f1741mH.obtainMessage(104);
    obtainMessage.obj = str;
    this.f1741mH.sendMessage(obtainMessage);
  }
  ...
  public void continueMinimizeStateChangedCallbacks() {
    if (this.mDeferMinimizeCallback) {
      ...
      while (it.hasNext()) {
        ...
        this.f1741mH.sendMessage(message);
  ...
  public void notifyFreeformMinimizeStateChanged(Task task, int i, int i2, boolean z) {
    ...
    obtain.argi4 = i2;
    obtain.argi5 = z ? 1 : 0;
    Message obtainMessage = this.f1741mH.obtainMessage(task.mIsMinimized ? 201 : 202, obtain);
    if (this.mDeferMinimizeCallback) {
  ...
  public void notifyFreeformMinimizeAnimationEnd(Task task) {
    ...
    HandlerC2922H handlerC2922H = this.f1741mH;
    handlerC2922H.sendMessage(handlerC2922H.obtainMessage(203, obtain));
  }
  ...
  public void setFreeformWindowingModeByCornerGestureLocked(int i, int i2, Rect rect) {
    ...
    try {
      ...
      if (anyTaskForId == null) {
        Slog.w(
            "FreeformController",
            "setFreeformWindowingModeByCornerGestureLocked: taskId=" + i + " not found");
      } else if (this.mAtm.getLockTaskController().isTaskLocked(anyTaskForId)) {
        this.mAtm.getLockTaskController().showLockTaskToast();
        Slog.w(
            "FreeformController", "setFreeformWindowingModeByCornerGestureLocked: task is locked");
      } else {
        ...
        if (displayContent == null) {
          ...
          if (anyTaskForId.inSplitScreenWindowingMode()) {
            ...
            if (rootActivity == null) {
              Slog.w(
                  "FreeformController",
                  "setFreeformWindowingModeByCornerGestureLocked: root activity not found");
            } else {
  ...
  /* renamed from: com.android.server.wm.FreeformController$H */
  public final class HandlerC2922H extends Handler {
    public HandlerC2922H(Looper looper) {
      super(looper);
    }
    ...
    public void handleMessage(Message message) {
                ...
                synchronized (FreeformController.this.mCallbacks) {
                  ...
                  while (i2 < beginBroadcast3) {
                    try {
                      ...
                      Slog.e(
                          "FreeformController", "onMinimizeAnimationEnd, RemoteException occurred");
                    }
                    i2++;
                  }
                  FreeformController.this.mCallbacks.finishBroadcast();
      ...
      Toast.makeText(
              new ContextThemeWrapper(
                  FreeformController.this.mAtm.mContext, R.style.Theme.DeviceDefault.Light),
              FreeformController.this
                  .mAtm
                  .mContext
                  .getResources()
                  .getString(R.string.httpErrorRedirectLoop),
              0)
          .show();
    }
  }
  ...
  public void showNotSupportMultiWindowToast(ActivityRecord activityRecord) {
    ...
    this.f1741mH.removeMessages(1);
    this.f1741mH.sendEmptyMessage(1);
  }
  ...
  public void notifyActivityForcedResizableIfNeeded(Task task) {
    ...
    this.mAtm
        ...
        .notifyActivityForcedResizable(
            task.mTaskId, 3, topNonFinishingActivity.info.applicationInfo.packageName);
  }
  ...
  public void minimizeExcessiveVisibleFreeformLocked(TaskDisplayArea taskDisplayArea) {
    ...
    int maxVisibleFreeformCntLocked =
        getMaxVisibleFreeformCntLocked(
            isDesktopModeEnabled, taskDisplayArea.mDisplayContent.getConfiguration().dexMode);
    for (int rootTaskCount = taskDisplayArea.getRootTaskCount() - 1;
        rootTaskCount > rootTaskIndex;
        rootTaskCount--) {
      Task asTask = taskDisplayArea.getChildAt(rootTaskCount).asTask();
      if (asTask != null
          && !asTask.mCreatedByOrganizer
          && isVisibleFreeformRootTaskLocked(asTask)
          && (i = i + 1) > maxVisibleFreeformCntLocked) {
        this.mAtm.mMultiTaskingController.minimizeTaskLocked(asTask, true);
      }
    }
    if (i > maxVisibleFreeformCntLocked) {
      makeMaxCountToastLocked(
          taskDisplayArea.getDisplayContent().getDisplay(),
          isDesktopModeEnabled,
          maxVisibleFreeformCntLocked);
    }
  }
  ...
  public final void makeMaxCountToastLocked(Display display, boolean z, int i) {
    ...
    final Context createDisplayContext =
        new ContextThemeWrapper(this.mAtm.mContext, R.style.Theme.DeviceDefault.Light)
    ...
    if (z) {
      string =
          this.mAtm
              .mContext
              .getResources()
              .getQuantityString(R.plurals.duration_days_shortest_future, i, Integer.valueOf(i));
    } else {
      string =
          this.mAtm
              .mContext
              .getResources()
              .getString(R.string.lockscreen_transport_pause_description, Integer.valueOf(i));
    }
    this.f1741mH.post(
        new Runnable() { // from class:
                         // com.android.server.wm.FreeformController$$ExternalSyntheticLambda0
  ...
  public void setMaxVisibleFreeformCountForDex(int i, int i2) {
    ...
    if (DEBUG) {
      Slog.d(
          "FreeformController",
          "setMaxVisibleFreeformCount: mMaxFreeformOverWrittenCnt="
  ...
  public boolean hasVisibleFreeform(DisplayContent displayContent) {
    Task topRootTaskInWindowingMode =
        displayContent.getDefaultTaskDisplayArea().getTopRootTaskInWindowingMode(5);
  ...
  public void performDisplayOverrideConfigUpdate(
      final int i, int i2, final float f, final float f2, final Rect rect, final Rect rect2) {
    ...
    displayContent.forAllTasks(
        new Consumer() { // from class:
          ...
          public final void accept(Object obj) {
            FreeformController.this.lambda$performDisplayOverrideConfigUpdate$1(
                z, i, displayContent, rect, rect2, hasConfigChangesToResize, f, f2, (Task) obj);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$performDisplayOverrideConfigUpdate$1(
      boolean z,
      int i,
    ...
    if (task.isRootTask() && task.inFreeformWindowingMode()) {
      if (CoreRune.MW_FREEFORM_LARGE_SCREEN_BOUNDS_POLICY
          && canApplyScreenRatioResize(task, i)
          && (!CoreRune.MT_SUPPORT_SIZE_COMPAT
              || !displayContent.isNewDexMode()
              || SizeCompatPolicyManager.get().getCompatPolicy(task) == null)) {
        MultiWindowUtils.adjustBoundsForScreenRatio(
            rect, rect2, task.mLastNonFullscreenBounds, this.mTmpRect);
  ...
  public final boolean canApplyScreenRatioResize(Task task, int i) {
    return ((i & 128) == 0
            ...
            || !task.getDisplayContent().isDefaultDisplay
            || task.getDisplayContent().isDexMode()
    ...
    if (this.mForceHideFreeformRequester != this.mTmpForceHideFreeformRequester) {
      Slog.d(
          ...
          "beginPostLayoutPolicyLw: forceHideRequester changed, old="
              + this.mForceHideFreeformRequester
              + ", new="
              + this.mTmpForceHideFreeformRequester);
    ...
    if (this.mForceHideMinimizeRequester != this.mTmpForceHideMinimizeRequester) {
      Slog.d(
          ...
          "beginPostLayoutPolicyLw: forceHide minimize Requester changed, old="
              + this.mForceHideMinimizeRequester
              + ", new="
              + this.mTmpForceHideMinimizeRequester);
  ...
  public final void computeForceHideRequester(DisplayContent displayContent) {
    ...
    displayContent.forAllWindows(
        new Consumer() { // from class:
                         // com.android.server.wm.FreeformController$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public /* synthetic */ void lambda$computeForceHideRequester$2(WindowState windowState) {
    ...
    if (!(windowState.isVisible()
            || (windowState.isVisibleRequested()
                && (activityRecord2 = windowState.mActivityRecord) != null
                && activityRecord2.isVisibleRequested()))
    ...
    if (windowState.getTask() == null || windowState.getTask().shouldBeVisible(null)) {
      ...
      if ((this.mTmpForceHideFreeformRequester == null && (67108864 & i) != 0)
          || ((activityRecord = windowState.mActivityRecord) != null
              && activityRecord.mRequestFreeformForceHiding)) {
  ...
  public void finishPostLayoutPolicyLw() {
    ...
    Task focusedRootTask =
        defaultTaskDisplayArea != null ? defaultTaskDisplayArea.getFocusedRootTask() : null;
    if (focusedRootTask != null
        && focusedRootTask.isFreeformForceHidden()
        && (task =
                defaultTaskDisplayArea.getTask(
                    new Predicate() { // from class:
                                      // com.android.server.wm.FreeformController$$ExternalSyntheticLambda5
                      @Override // java.util.function.Predicate
                      public final boolean test(Object obj) {
                        boolean lambda$finishPostLayoutPolicyLw$3;
                        lambda$finishPostLayoutPolicyLw$3 =
                            FreeformController.lambda$finishPostLayoutPolicyLw$3((Task) obj);
  ...
  public final boolean isForceHideRequesterHomeOrRecents() {
    ...
    return windowState != null
        && (windowState.isActivityTypeHomeOrRecents()
            || this.mForceHideFreeformRequester.getWindowType() == 2632);
  }
  ...
  public final boolean shouldApplyForceHidePolicyLocked(WindowState windowState, boolean z) {
    ...
    if (this.mBlockToAddForceHideFreeformTasks
        && task != null
        && !this.mForceHiddenFreeformTasks.contains(task)) {
      return false;
    }
    if ((CoreRune.MW_SHELL_CHANGE_TRANSITION
            && task != null
            && this.mAtm.mChangeTransitController.isInChangeTransition(task))
        || (windowState2 = this.mForceHideFreeformRequester) == null
  ...
  public boolean applyForceHidePolicyIfNeededLocked(WindowState windowState) {
    ...
    Task task = windowState.getTask();
    if (((task != null && task.inFreeformWindowingMode()) || z)
        && shouldApplyForceHidePolicyLocked(windowState, z)) {
  ...
  /* renamed from: releaseForceHidePolicyIfNeededLocked, reason: merged with bridge method [inline-methods] */
  ...
  public void updateFreeformBoundsForDisplayDeviceTypeChanged(Task task) {
    ...
    if (lastMinimizedDisplayType == -1
        || lastMinimizedDisplayType == globalConfiguration.semDisplayDeviceType) {
      return;
    }
  ...
  public final void calculateFreeformBoundsForLidStateChanged(
      Task task, Rect rect, Rect rect2, Rect rect3, Rect rect4) {
    int i;
    if (rect3.isEmpty()) {
      return;
    }
    ...
    if (z || z2) {
      ...
      if (z) {
        ...
        int width =
            (int) ((rect2.width() - rect3.width()) * (rect3.left / (rect.width() - rect3.width())));
        rect4.left = width;
        ...
        int height =
            (int)
                ((rect2.height() - rect3.height())
                    * (rect3.top / (rect.height() - rect3.height())));
        rect4.top = height;
      ...
      rect4.offset(
          width2 != rect4.width() ? 0 - ((rect4.width() - width2) / 2) : 0,
          height2 != rect4.height() ? 0 - ((rect4.height() - height2) / 2) : 0);
    } else {
      rect4.set(0, 0, rect3.width(), rect3.height());
      rect4.offset(
          (int) ((rect2.width() - rect3.width()) * (rect3.left / (rect.width() - rect3.width()))),
          (int)
              ((rect2.height() - rect3.height()) * (rect3.top / (rect.height() - rect3.height()))));
    }
    int i3 = rect4.left;
    if (8 > i3) {
      i = 8 - i3;
    ...
    if (task.isFreeformStashed()) {
      ...
      rect4.offsetTo(
          task.isLeftStash() ? stashedBounds.right - rect4.width() : stashedBounds.left, rect4.top);
    }
  }

  public static Animation loadWindowAnimationIfNeeded(
      Animation animation, WindowState windowState, int i) {
    DisplayContent displayContent = windowState.getDisplayContent();
    if (displayContent == null
        || !((i == 1 || i == 2)
            && windowState.inFreeformWindowingMode()
            && windowState.mAttrs.isFullscreen()
            && windowState.mAttrs.type == 2
            && WindowAnimationSpec.findTranslateAnimation(animation) != null)) {
      return null;
    }
    Slog.d("FreeformController", "loadWindowAnimationIfNeeded: " + windowState + ", transit=" + i);
    return displayContent.mAppTransition.mTransitionAnimation.loadDefaultAnimationRes(
        i == 1
            ? R.anim.ft_avd_tooverflow_rectangle_path_1_animation
            : R.anim.ft_avd_tooverflow_rectangle_3_pivot_animation);
  }
  ...
  public int getDecorCaptionHeight(
      Resources resources, WindowContainer windowContainer, boolean z, int i) {
    boolean z2 =
        CoreRune.MW_CAPTION_SHELL_NEW_DEX_CAPTION_TYPE
            && resources.getConfiguration().isNewDexMode();
    if (i == -1) {
    ...
    if (windowContainer.isDexMode()) {
      if (windowContainer.inFreeformWindowingMode() || z) {
        return resources.getDimensionPixelSize(R.dimen.toast_text_size);
      }
      return resources.getDimensionPixelSize(R.dimen.toast_width);
    }
    if (!windowContainer.isNewDexMode()) {
      if (i == 1) {
        return resources.getDimensionPixelSize(R.dimen.timepicker_time_label_size);
      }
      return resources.getDimensionPixelSize(R.dimen.toast_elevation);
    }
    if (CoreRune.MW_CAPTION_SHELL_NEW_DEX_CAPTION_TYPE && i == 0) {
      return resources.getDimensionPixelSize(R.dimen.toast_elevation);
    }
    if (windowContainer.inFreeformWindowingMode() || z) {
      return resources.getDimensionPixelSize(R.dimen.toast_y_offset);
    }
    return resources.getDimensionPixelSize(R.dimen.tooltip_corner_radius);
  }
  ...
  public boolean canApplyDimsLocked(final WindowState windowState) {
    ...
    InsetsState insetsStateWithVisibilityOverride =
        windowState.getInsetsStateWithVisibilityOverride();
    ...
    rect.inset(
        insetsStateWithVisibilityOverride.calculateVisibleInsets(
            rect, i, windowingMode, layoutParams.softInputMode, layoutParams.flags));
    windowState
        .getTask()
        .forAllWindows(
            new ToBooleanFunction() { // from class:
                                      // com.android.server.wm.FreeformController$$ExternalSyntheticLambda1
              public final boolean apply(Object obj) {
                boolean lambda$canApplyDimsLocked$6;
                lambda$canApplyDimsLocked$6 =
                    FreeformController.this.lambda$canApplyDimsLocked$6(
                        windowState, rect, (WindowState) obj);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ boolean lambda$canApplyDimsLocked$6(
      WindowState windowState, Rect rect, WindowState windowState2) {
    ActivityRecord activityRecord = windowState2.mActivityRecord;
    if (activityRecord != windowState.mActivityRecord
        && activityRecord != null
        && (!activityRecord.mVisibleRequested || activityRecord.mIsExiting)) {
      return false;
    }
    ...
    rect.inset(
        insetsStateWithVisibilityOverride.calculateVisibleInsets(
            rect2, i, windowingMode, layoutParams.softInputMode, layoutParams.flags));
    if (!windowState2.mHasSurface
        || (!rect2.contains(rect)
            && (rect2.height() < rect.height() || rect2.width() < rect.width()))) {
      return false;
    }
  ...
  public void dumpLocked(PrintWriter printWriter, String str) {
    ...
    if (!this.mForceHiddenFreeformContainers.isEmpty()) {
      printWriter.println(
          str + "mForceHiddenFreeformWindows=" + this.mForceHiddenFreeformContainers);
    }
    printWriter.println(str + "mMaxFreeformOverWrittenCnt=" + this.mMaxFreeformOverWrittenCnt);
    printWriter.println(
        str + "mMaxDexFreeformOverWrittenCnt=" + this.mMaxDexFreeformOverWrittenCnt);
