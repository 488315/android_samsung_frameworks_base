...
public class ActivitySnapshotController extends AbsAppSnapshotController {
  ...
  public ActivitySnapshotController(
    ...
    BaseAppSnapshotPersister.PersistInfoProvider createPersistInfoProvider =
        createPersistInfoProvider(
            windowManagerService, new ActivitySnapshotController$$ExternalSyntheticLambda0());
    ...
    setSnapshotEnabled(
        (windowManagerService
                    .mContext
                    .getResources()
                    .getBoolean(R.bool.config_closeDialogWhenTouchOutside)
                || !isSnapshotEnabled()
  ...
  public void systemReady() {
    ...
    this.mService.mSnapshotController.registerTransitionStateConsumer(
        1,
        new Consumer() { // from class:
                         // com.android.server.wm.ActivitySnapshotController$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            ActivitySnapshotController.this.handleOpenActivityTransition(
                (SnapshotController.TransitionState) obj);
          }
        });
    this.mService.mSnapshotController.registerTransitionStateConsumer(
        2,
        new Consumer() { // from class:
                         // com.android.server.wm.ActivitySnapshotController$$ExternalSyntheticLambda2
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            ActivitySnapshotController.this.handleCloseActivityTransition(
                (SnapshotController.TransitionState) obj);
          }
        });
    this.mService.mSnapshotController.registerTransitionStateConsumer(
        4,
        new Consumer() { // from class:
                         // com.android.server.wm.ActivitySnapshotController$$ExternalSyntheticLambda3
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            ActivitySnapshotController.this.handleOpenTaskTransition(
                (SnapshotController.TransitionState) obj);
          }
        });
    this.mService.mSnapshotController.registerTransitionStateConsumer(
        8,
        new Consumer() { // from class:
                         // com.android.server.wm.ActivitySnapshotController$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            ActivitySnapshotController.this.handleCloseTaskTransition(
                (SnapshotController.TransitionState) obj);
          }
        });
  }
    ...
    return Math.max(
        Math.min(
            this.mService
                .mContext
                .getResources()
                .getFloat(R.dimen.config_minPercentageMultiWindowSupportWidth),
            1.0f),
        0.1f);
  }
  ...
  public static BaseAppSnapshotPersister.PersistInfoProvider createPersistInfoProvider(
      WindowManagerService windowManagerService,
      BaseAppSnapshotPersister.DirectoryResolver directoryResolver) {
    return new BaseAppSnapshotPersister.PersistInfoProvider(
        directoryResolver,
        "activity_snapshots",
        false,
  ...
  public final void cleanUpUserFiles(final int i) {
    synchronized (this.mSnapshotPersistQueue.getLock()) {
      this.mSnapshotPersistQueue.sendToQueueLocked(
          new SnapshotPersistQueue.WriteQueueItem(
              this
                  .mPersistInfoProvider) { // from class:
                                           // com.android.server.wm.ActivitySnapshotController.1
  ...
  public final void onCommitTransition() {
    ...
    for (int size2 = this.mPendingRemoveActivity.size() - 1; size2 >= 0; size2--) {
      ((ActivitySnapshotCache) this.mCache)
          .onIdRemoved(
              Integer.valueOf(
                  getSystemHashCode((ActivityRecord) this.mPendingRemoveActivity.valueAt(size2))));
    }
    ...
    for (int size4 = this.mPendingLoadActivity.size() - 1; size4 >= 0; size4--) {
      final ActivityRecord activityRecord2 =
          (ActivityRecord) this.mPendingLoadActivity.valueAt(size4);
      final int systemHashCode2 = getSystemHashCode(activityRecord2);
      final int i = activityRecord2.mUserId;
      if (((ActivitySnapshotCache) this.mCache).getSnapshot(Integer.valueOf(systemHashCode2))
              == null
          && containsFile(systemHashCode2, i)) {
        synchronized (this.mSnapshotPersistQueue.getLock()) {
          this.mSnapshotPersistQueue.sendToQueueLocked(
              new SnapshotPersistQueue.WriteQueueItem(
                  this
                      .mPersistInfoProvider) { // from class:
                                               // com.android.server.wm.ActivitySnapshotController.2
                @Override // com.android.server.wm.SnapshotPersistQueue.WriteQueueItem
                public void write() {
                  TaskSnapshot loadTask =
                      ActivitySnapshotController.this.mSnapshotLoader.loadTask(
                          systemHashCode2, i, false);
                    ...
                    if (loadTask != null) {
                      ...
                      if (!activityRecord3.finishing) {
                        ((ActivitySnapshotCache) ActivitySnapshotController.this.mCache)
                            .putSnapshot(activityRecord3, loadTask);
                      }
                    }
                  }
                }
  ...
  public final void recordSnapshot(ActivityRecord activityRecord) {
    ...
    if (recordSnapshotInner != null) {
      addUserSavedFile(
          getSystemHashCode(activityRecord), activityRecord.mUserId, recordSnapshotInner);
    }
  }
  ...
  public void notifyAppVisibilityChanged(ActivityRecord activityRecord, boolean z) {
    ...
    resetTmpFields();
    addBelowTopActivityIfExist(
        activityRecord.getTask(), this.mPendingRemoveActivity, "remove-snapshot");
    onCommitTransition();
  }
  ...
  public final void addBelowTopActivityIfExist(Task task, ArraySet arraySet, String str) {
    ...
    if (topMostActivity == null
        || (activityBelow = task.getActivityBelow(topMostActivity)) == null) {
      return;
    }
  ...
  public final void adjustSavedFileOrder(Task task) {
    ...
    task.forAllActivities(
        new Consumer() { // from class:
                         // com.android.server.wm.ActivitySnapshotController$$ExternalSyntheticLambda5
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public /* synthetic */ void lambda$adjustSavedFileOrder$0(int i, ActivityRecord activityRecord) {
    UserSavedFile userSavedFile =
        (UserSavedFile) getUserFiles(i).get(getSystemHashCode(activityRecord));
  ...
  public final void removeSnapshotFiles(final ArrayList arrayList) {
    synchronized (this.mSnapshotPersistQueue.getLock()) {
      this.mSnapshotPersistQueue.sendToQueueLocked(
          new SnapshotPersistQueue.WriteQueueItem(
              this
                  .mPersistInfoProvider) { // from class:
                                           // com.android.server.wm.ActivitySnapshotController.3
            @Override // com.android.server.wm.SnapshotPersistQueue.WriteQueueItem
            public void write() {
              for (int size = arrayList.size() - 1; size >= 0; size--) {
                UserSavedFile userSavedFile = (UserSavedFile) arrayList.get(size);
                ActivitySnapshotController.this.mSnapshotPersistQueue.deleteSnapshot(
                    userSavedFile.mFileId, userSavedFile.mUserId, this.mPersistInfoProvider);
              }
            }
          });
    }
