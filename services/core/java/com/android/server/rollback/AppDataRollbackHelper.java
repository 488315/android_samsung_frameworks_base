...
public class AppDataRollbackHelper {
  ...
  public boolean restoreAppData(
      int i, PackageRollbackInfo packageRollbackInfo, int i2, int i3, String str) {
    int i4;
    ...
    if (packageRollbackInfo.isApex()) {
      ...
      try {
        ...
        if (rollbackDataPolicy == 0) {
          this.mInstaller.restoreAppDataSnapshot(
              packageRollbackInfo.getPackageName(), i3, str, i, i2, i4);
  ...
  public void destroyAppDataSnapshot(int i, PackageRollbackInfo packageRollbackInfo, int i2) {
    try {
      ...
      Slog.e(
          "RollbackManager",
          "Unable to delete app data snapshot for " + packageRollbackInfo.getPackageName(),
          e);
    }
  }
