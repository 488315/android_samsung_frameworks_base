    ...
    public final void saveInfoHistory() {
        ...
        for (int i = 0; i < this.mBatteryCount; i++) {
            ...
            if (!this.authPaths.isEmpty()) {
                sb.append(
                        " ,authValue:"
                                .concat(BattUtils.readNode((String) this.authPaths.get(i), false)));
            }
            sb.append("    ");
        }
        ...
        for (int i2 = 0; i2 < this.mBatteryCount; i2++) {
            ...
            if (isExist) {
                ...
                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                        new StringBuilder("[setPermissionsEfs]not exist:"),
                        (String) this.efsPaths.get(i2),
                        str);
            }
        }
