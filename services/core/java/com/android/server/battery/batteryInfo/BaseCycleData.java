...
public abstract class BaseCycleData extends BaseData {
    public final void addAndSave(long j) {
        String m =
                DeviceIdleController$$ExternalSyntheticOutline0.m(j, "[addAndSave]addtionalValue:");
        String str = this.TAG;
        Slog.d(str, m);
        for (int i = 0; i < this.mBatteryCount; i++) {
            ((Long[]) this.mCurrentValues)[i] =
                    Long.valueOf(BattUtils.readNodeAsLong((String) this.efsPaths.get(i)) + j);
            BattUtils.writeNode(
                    ((Long[]) this.mCurrentValues)[i].longValue(), (String) this.efsPaths.get(i));
            if (!this.authPaths.isEmpty()) {
                if (this.mAuthentificationResults[i]) {
                    BattUtils.writeNode(
                            ((Long[]) this.mCurrentValues)[i].longValue(),
                            (String) this.authPaths.get(i));
                } else {
                    DeviceIdleController$$ExternalSyntheticOutline0.m(
                            i, "[addAndSave]Authentification false => skip writing_", str);
                }
            }
        }
            ...
            if (!BattUtils.isExist((String) this.efsPaths.get(i))) {
                Slog.w(
                        ...
                        AudioOffloadInfo$$ExternalSyntheticOutline0.m(
                                new StringBuilder("[initializeIfNotExist]create:"),
            ...
            if (z) {
                ...
                if (zArr[i]) {
                    long readNodeAsLong$1 =
                            BattUtils.readNodeAsLong$1((String) this.efsPaths.get(i));
                    long readNodeAsLong$12 =
                            BattUtils.readNodeAsLong$1((String) this.authPaths.get(i));
                    long j2 =
                            (readNodeAsLong$12 == 16777215 || readNodeAsLong$12 <= readNodeAsLong$1)
                                    ? readNodeAsLong$1
                                    : readNodeAsLong$12;
                    StringBuilder m =
                            BatteryService$$ExternalSyntheticOutline0.m(
                                    "[syncAuthAndEfsForAuth]efsValue:",
                                    readNodeAsLong$1,
                                    " ,authValue:");
                ...
                DeviceIdleController$$ExternalSyntheticOutline0.m(
                        i, "[syncAuthAndEfsForAuth]Authentification false => skip_", str);
            }
        }
    }
}
