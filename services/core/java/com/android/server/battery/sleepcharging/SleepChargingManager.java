...
public final class SleepChargingManager {
  ...
  public SleepChargingManager(Context context, Handler handler, int i) {
    ...
    BatteryLogger.writeToFile(
        ...
        "VERSION:231116+ ,elapsedRealtime:" + SystemClock.elapsedRealtime());
    ...
    handlerThread.start();
    makeHandler();
    this.mSleepChargingTimeController =
        new SleepChargingTimeController(this.mContext, this.mWorkerThread, this.mHandler);
  }

  public void end() {
    Slog.i(TAG, "[end]");
    BatteryLogger.writeToFile(
        "/data/log/battery_service/sleep_charging_history", "SleepChargingManager end", "");
  ...
  public void updateChargingInfo(final int i, final long j, final int i2, final long j2) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.battery.sleepcharging.SleepChargingManager.1
          ...
          public void run() {
            ...
            if (!SleepChargingManager.this.mIsSleepCharging
                ? i == 0
                    || SleepChargingManager.this.mIsUserDismissSleepCharging
                    || !SleepChargingManager.this.mSleepChargingTimeController.isActivated()
                : i != 0) {
              z = false;
            }
            if (z) {
              Slog.v(
                  SleepChargingManager.TAG,
  ...
  public void updateDismiss() {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.battery.sleepcharging.SleepChargingManager.2
          @Override // java.lang.Runnable
          public void run() {
              ...
              switch (i) {
                case 27:
                  ...
                  BatteryLogger.writeToFile(
                      "/data/log/battery_service/sleep_charging_history",
                      "Updated & Reset",
                      SleepChargingManager.this.getInfoAll(true));
                  SleepChargingManager.this.processConditions();
                  break;
                case 28:
                  SleepChargingManager.this.processConditions();
  ...
  public final void processConditions() {
    ...
    Slog.d(
        ...
        "[processConditions]charging:"
            ...
            + " ,alarmChagned:"
            + this.mTheNextAlarmChagned);
    if (this.mIsSleepCharging) {
      if (this.mIsCharging
          && !this.mIsUserDismissSleepCharging
          && this.mSleepChargingTimeController.isActivated()
          && this.mSleepChargingTimeController.isNowSleepChargingTime(-1)) {
      ...
      sendResultOff();
      BatteryLogger.writeToFile(
          "/data/log/battery_service/sleep_charging_history", "ON -> OFF", getInfoAll(false));
      return;
    }
    if (this.mIsCharging
        && this.mIsChargingStable
        ...
        && !this.mIsUserDismissSleepCharging
        && this.mSleepChargingTimeController.isActivated()
        && this.mSleepChargingTimeController.isNowSleepChargingTime(this.mMinutesToFullCharge)) {
      ...
      sendResultOn();
      BatteryLogger.writeToFile(
          "/data/log/battery_service/sleep_charging_history", "OFF -> ON", getInfoAll(false));
      return;
    }
  ...
  public final void sendResultOn() {
    ...
    LocalDateTime sleepChargingEndTime =
        this.mSleepChargingTimeController.getSleepChargingEndTime();
    Message obtainMessage = this.mDeliveredHandler.obtainMessage(1);
    obtainMessage.obj =
        SleepChargingTimeController.Util.convertLocalDateTimeToHHmmString(sleepChargingEndTime);
  ...
  public void modifySleepPatternsForTest(
      final String str, final String str2, final String str3, final String str4) {
    Slog.e(TAG, "[modifySleepPatternsForTest]");
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.battery.sleepcharging.SleepChargingManager.4
          @Override // java.lang.Runnable
          public void run() {
            SleepChargingManager.this.mSleepChargingTimeController.modifySleepPatternsForTest(
                str, str2, str3, str4);
          }
        });
  }
  ...
  public String getInfoAll(boolean z) {
    ...
    sb.append(
        "mIsSleepCharging:" + this.mIsSleepCharging + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
    sb.append(
