...
public final class SleepChargingManager {
        ...
        public final void run() {
            ...
            if (i != 0 && sleepChargingManager.mChargeStartTime == 0) {
                ...
                BatteryService$$ExternalSyntheticOutline0.m(
                        new StringBuilder("[updateChargingInfo]Started mChargeStartTime:"),
                        SleepChargingManager.this.mChargeStartTime,
                        "[SS]SleepChargingManager");
            ...
            } else if (this.val$plugType == 0
                    || sleepChargingManager2.mIsUserDismissSleepCharging
                    || !sleepChargingManager2.mSleepChargingTimeController.isActivated()) {
                return;
            }
            Slog.v(
                    "[SS]SleepChargingManager",
                    "[updateChargingInfo]plugType:"
                            + this.val$plugType
                            + " ,batteryLevel:"
                            + this.val$batteryLevel
                            + " ,secondsToFullCharge:"
                            + this.val$secondsToFullCharge);
            removeMessages(11);
            sendEmptyMessage(11);
        }
    }
    ...
    public static void m305$$Nest$mprocessConditions(SleepChargingManager sleepChargingManager) {
        ...
        } else if (sleepChargingManager.mSecondsToFullCharge <= 0
                || sleepChargingManager.mChargeStartTime == 0) {
            sleepChargingManager.mIsChargingStable = false;
        } else {
            sleepChargingManager.mIsChargingStable =
                    SystemClock.elapsedRealtime() - sleepChargingManager.mChargeStartTime >= 3000;
        }
        sleepChargingManager.mIsBatteryLevelHighEnough =
                sleepChargingManager.mBatteryLevel >= sleepChargingManager.THRESHOLD_BATTERY_LEVEL;
        sleepChargingManager.mMinutesToFullCharge =
                (int) ((sleepChargingManager.mSecondsToFullCharge + 59) / 60);
        ...
        AnyMotionDetector$$ExternalSyntheticOutline0.m(
                "[SS]SleepChargingManager", sb, sleepChargingManager.mTheNextAlarmChagned);
        ...
        SleepChargingTimeController sleepChargingTimeController =
                sleepChargingManager.mSleepChargingTimeController;
        if (!z2) {
            if (!sleepChargingManager.mIsCharging
                    || !sleepChargingManager.mIsChargingStable
                    || !sleepChargingManager.mIsBatteryLevelHighEnough
                    || sleepChargingManager.mIsUserDismissSleepCharging
                    || !sleepChargingTimeController.isActivated()
                    || !sleepChargingTimeController.isNowSleepChargingTime(
                            sleepChargingManager.mMinutesToFullCharge)) {
            ...
            sleepChargingTimeController.updateSleepChargingEndTime(
                    sleepChargingManager.mMinutesToFullCharge, true);
            ...
            BatteryLogger.writeToFile(
                    ...
                    "OFF -> ON",
                    sleepChargingManager.getInfoAll(false));
            return;
        }
        if (!sleepChargingManager.mIsCharging
                || sleepChargingManager.mIsUserDismissSleepCharging
                || !sleepChargingTimeController.isActivated()
                || !sleepChargingTimeController.isNowSleepChargingTime(-1)) {
    ...
    public SleepChargingManager(
        ...
        BatteryLogger.writeToFile(
                "/data/log/battery_service/sleep_charging_history",
                "SleepChargingManager Created",
                "VERSION:240902 ,elapsedRealtime:" + SystemClock.elapsedRealtime());
        StringBuilder sb = new StringBuilder("protectionThreshold:");
        sb.append(i);
        BootReceiver$$ExternalSyntheticOutline0.m(
                sb, " ,TIME_TO_CHARGING_STABLE:3000", "[SS]SleepChargingManager");
                ...
                new Handler(
                        this.mWorkerThread
                                .getLooper()) { // from class:
                                                // com.android.server.battery.sleepcharging.SleepChargingManager.3
                    @Override // android.os.Handler
                    public final void handleMessage(Message message) {
                        SystemServiceManager$$ExternalSyntheticOutline0.m(
                                new StringBuilder("[scm_handleMessage]msg:"),
                                message.what,
                                "[SS]SleepChargingManager");
                        int i2 = message.what;
                        SleepChargingManager sleepChargingManager = SleepChargingManager.this;
                        if (i2 == 11) {
                            SleepChargingManager.m305$$Nest$mprocessConditions(
                                    sleepChargingManager);
                        }
                        if (i2 == 12) {
                        ...
                        switch (i2) {
                            case 27:
                                if (sleepChargingManager.mIsSleepCharging) {
                                    Slog.e(
                                            "[SS]SleepChargingManager",
                                            "[scm_handleMessage]ON -> OFF (for reset)");
                                    sleepChargingManager.mIsSleepCharging = false;
                                    sleepChargingManager.sendResultOff();
                                }
                                ...
                                BatteryLogger.writeToFile(
                                        "/data/log/battery_service/sleep_charging_history",
                                        "Updated & Reset",
                                        sleepChargingManager.getInfoAll(true));
                                StringBuilder sb2 =
                                        new StringBuilder("[Updated SleepChargingStatus]");
                                SleepChargingTimeController sleepChargingTimeController =
                                        sleepChargingManager.mSleepChargingTimeController;
        ...
        Slog.d(
                "[SS]SleepChargingTimeController",
                "mRuglarUpdateCheckTime:" + SleepChargingTimeController.mRuglarUpdateCheckTime);
        ...
        sleepChargingTimeController.mHandler =
                new Handler(handlerThread2.getLooper()) { // from class:
                        ...
                        */
                        throw new UnsupportedOperationException(
                                "Method not decompiled:"
                                    + " com.android.server.battery.sleepcharging.SleepChargingTimeController.AnonymousClass1.handleMessage(android.os.Message):void");
                    }
                };
    ...
    public final String getInfoAll(boolean z) {
        ...
        sb.append(
                "mChargeStartTime:"
                        + this.mChargeStartTime
                        + " ,mIsChargingStable:"
                        + this.mIsChargingStable
                        + "\n");
        sb.append(
                "mBatteryLevel:"
                        + this.mBatteryLevel
                        + " ,mIsBatteryLevelHighEnough:"
                        + this.mIsBatteryLevelHighEnough
                        + "\n");
        sb.append(
                "mSecondsToFullCharge:"
                        + this.mSecondsToFullCharge
                        + " ,mMinutesToFullCharge:"
                        + this.mMinutesToFullCharge
                        + "\n");
        sb.append("\n");
        ...
        sb2.append(
                "mSleepPatterns.size():"
                        + sleepChargingTimeController.mSleepPatterns.size()
                        + "\n");
        if (z) {
            Iterator it = sleepChargingTimeController.mSleepPatterns.entrySet().iterator();
            while (it.hasNext()) {
                PersonalPatternManager.SleepPattern sleepPattern =
                        (PersonalPatternManager.SleepPattern) ((Map.Entry) it.next()).getValue();
                StringBuilder sb3 = new StringBuilder();
                sb3.append("[BackupOnOffExceptTime]" + sleepPattern.weekType.substring(0, 3));
                sb3.append(
                        " ,time:"
                                + Instant.ofEpochMilli(sleepPattern.bedTimeMillis)
                                        .atZone(ZoneId.of("UTC"))
                                        .toLocalTime()
                                + " ~ "
                                + Instant.ofEpochMilli(sleepPattern.wakeupTimeMillis)
                                        .atZone(ZoneId.of("UTC"))
                                        .toLocalTime());
        ...
        SleepChargingTimeController.SleepChargingStatus sleepChargingStatus =
                sleepChargingTimeController.mSleepChargingStatus;
        if (sleepChargingStatus == null) {
            ...
            sb5.append(
                    "[SleepChargingStatus]"
                            ...
                            + "("
                            + sleepChargingStatus.matchedDate.getDayOfWeek().toString()
                            + ")\n");
            sb5.append(
                    "sleepTime:"
                            + sleepChargingStatus.bedDateTime
                            + " ~ "
                            + sleepChargingStatus.wakeupDateTime
                            + "\n");
            sb5.append(
                    "confidence:"
                            + sleepChargingStatus.confidence
                            + ",isConfident:"
                            + sleepChargingStatus.isConfident
                            + "\n");
            sb5.append(
                    "sleepChargingStartDateTime:"
                            + sleepChargingStatus.sleepChargingStartDateTime
                            + " ,expectedFullChargeDateTime:"
                            + sleepChargingStatus.expectedFullChargeDateTime
                            + "\n");
        ...
        sb2.append(
                "mIsTodaySleepChargingFinished:"
                        + sleepChargingTimeController.mIsTodaySleepChargingFinished
                        + "\n");
        sb2.append(
                "mNextAlarmDateTimeWithinSleepTime:"
                        + sleepChargingTimeController.mNextAlarmDateTimeWithinSleepTime
                        + "\n");
        sb2.append(
                "mSavedMinutesToFullCharge:"
                        + sleepChargingTimeController.mSavedMinutesToFullCharge
                        + "\n");
        sb2.append(
                "mSleepChargingEndDateTime:"
                        + sleepChargingTimeController.mSleepChargingEndDateTime
                        + "\n");
        sb2.append(
                "mScheduledUpdateTime:" + sleepChargingTimeController.mScheduledUpdateTime + "\n");
        sb2.append(
                "mScheduledSleepChargingStartTime:"
                        + sleepChargingTimeController.mScheduledSleepChargingStartTime
                        + "\n");
        sb2.append(
                "mScheduledSleepChargingEndTime:"
                        + sleepChargingTimeController.mScheduledSleepChargingEndTime
                        + "\n");
        sb2.append(
                "mScheduledWakeupTime:" + sleepChargingTimeController.mScheduledWakeupTime + "\n");
        sb2.append("\n");
    ...
    public final void sendResultOff() {
        ...
        handler.sendMessage(obtainMessage);
        BattLogBuffer.addLog(
                2,
                "[OFF]mIsCharging:"
                        + this.mIsCharging
                        + " ,mIsUserDismissSleepCharging:"
