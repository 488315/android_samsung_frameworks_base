...
public class RCPDumpState {
    ...
    public void dumpStateFileOpsTable(PrintWriter printWriter, int i) {
        Cursor query = this.mContext.getContentResolver().query(Uri.parse("content://" + Integer.toString(i) + "@" + (isSecureFolderId(i) ? "com.samsung.knox.securefolder.rcpcomponents.move.provider.knoxcontentmgrdbprovider" : "com.samsung.android.knox.containercore.rcpcomponents.move.provider.knoxcontentmgrdbprovider") + "/"), null, null, null, null);
        if (query != null) {
    ...
    public void dumpBackupAndRestoreHistory(PrintWriter printWriter, int i) {
        ...
        Cursor query = this.mContentResolver.query(Uri.parse("content://" + Integer.toString(i) + "@com.samsung.knox.securefolder/bnr_logs"), null, null, null, null);
        if (query != null) {
            if (query.moveToFirst()) {
                do {
