...
public abstract class RuleEvaluator {
  public static IntegrityCheckResult evaluateRules(
      List list, final AppInstallMetadata appInstallMetadata) {
    List list2 =
        (List)
            list.stream()
                .filter(
                    new Predicate() { // from class:
                      ...
                      public final boolean test(Object obj) {
                        ...
                        lambda$evaluateRules$0 =
                            RuleEvaluator.lambda$evaluateRules$0(appInstallMetadata, (Rule) obj);
    ...
    List list4 =
        (List)
            list2.stream()
                .filter(
                    new Predicate() { // from class:
                                      // com.android.server.integrity.engine.RuleEvaluator$$ExternalSyntheticLambda2
                      @Override // java.util.function.Predicate
                      public final boolean test(Object obj) {
  ...
  public static /* synthetic */ boolean lambda$evaluateRules$0(
      AppInstallMetadata appInstallMetadata, Rule rule) {
