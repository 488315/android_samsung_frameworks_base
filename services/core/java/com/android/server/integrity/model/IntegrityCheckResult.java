...
public final class IntegrityCheckResult {
  ...
  public boolean isCausedByAppCertRule() {
    return this.mRuleList.stream()
        .anyMatch(
            new Predicate() { // from class:
                              // com.android.server.integrity.model.IntegrityCheckResult$$ExternalSyntheticLambda1
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$isCausedByAppCertRule$0;
                lambda$isCausedByAppCertRule$0 =
                    IntegrityCheckResult.lambda$isCausedByAppCertRule$0((Rule) obj);
        ...
        .anyMatch(
            new Predicate() { // from class:
              ...
              public final boolean test(Object obj) {
                ...
                lambda$isCausedByInstallerRule$1 =
                    IntegrityCheckResult.lambda$isCausedByInstallerRule$1((Rule) obj);
