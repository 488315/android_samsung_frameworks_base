...
public abstract class RuleIndexingDetailsIdentifier {
  ...
  public static RuleIndexingDetails getIndexingDetails(IntegrityFormula integrityFormula) {
    ...
    throw new IllegalArgumentException(
        String.format("Invalid formula tag type: %s", Integer.valueOf(integrityFormula.getTag())));
  }

  public static RuleIndexingDetails getIndexingDetailsForCompoundFormula(
    ...
    if (connector == 0 || connector == 1) {
              ...
              .map(
                  new Function() { // from class:
                    ...
                    public final Object apply(Object obj) {
                      ...
                      indexingDetails =
                          RuleIndexingDetailsIdentifier.getIndexingDetails((IntegrityFormula) obj);
              ...
              .filter(
                  new Predicate() { // from class:
                    ...
                    public final boolean test(Object obj) {
                      ...
                      lambda$getIndexingDetailsForCompoundFormula$1 =
      ...
      Optional findAny2 =
          formulas.stream()
              .map(
                  new Function() { // from class:
                                   // com.android.server.integrity.serializer.RuleIndexingDetailsIdentifier$$ExternalSyntheticLambda2
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                      RuleIndexingDetails indexingDetails;
                      indexingDetails =
              ...
              .filter(
                  new Predicate() { // from class:
                                    // com.android.server.integrity.serializer.RuleIndexingDetailsIdentifier$$ExternalSyntheticLambda3
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$getIndexingDetailsForCompoundFormula$3;
                      lambda$getIndexingDetailsForCompoundFormula$3 =
                          RuleIndexingDetailsIdentifier
                              .lambda$getIndexingDetailsForCompoundFormula$3(
                                  (RuleIndexingDetails) obj);
  ...
  public static /* synthetic */ boolean lambda$getIndexingDetailsForCompoundFormula$1(
      RuleIndexingDetails ruleIndexingDetails) {
    return ruleIndexingDetails.getIndexType() == 1;
  }

  public static /* synthetic */ boolean lambda$getIndexingDetailsForCompoundFormula$3(
      RuleIndexingDetails ruleIndexingDetails) {
    return ruleIndexingDetails.getIndexType() == 2;
  }

  public static RuleIndexingDetails getIndexingDetailsForStringAtomicFormula(
