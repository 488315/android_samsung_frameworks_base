...
public class DeviceStateNotificationController extends BroadcastReceiver {
    ...
    public void showStateActiveNotificationIfNeeded(int i, int i2) {
        ...
        if (applicationLabel != null) {
            showNotification(notificationInfo.name, notificationInfo.activeNotificationTitle, String.format(notificationInfo.activeNotificationContent, applicationLabel), true, R.drawable.ic_dialog_time, PendingIntent.getBroadcast(this.mContext, 0, new Intent(INTENT_ACTION_CANCEL_STATE).setPackage(this.mContext.getPackageName()), 67108864), this.mContext.getString(R.string.foreground_service_app_in_background));
        } else {
    ...
    public void showThermalCriticalNotificationIfNeeded(int i) {
        ...
        showNotification(notificationInfo.name, notificationInfo.thermalCriticalNotificationTitle, notificationInfo.thermalCriticalNotificationContent, false, R.drawable.ic_suggestions_add, null, null);
    }
    ...
    public void showPowerSaveNotificationIfNeeded(int i) {
        ...
        showNotification(notificationInfo.name, notificationInfo.powerSaveModeNotificationTitle, notificationInfo.powerSaveModeNotificationContent, false, R.drawable.ic_suggestions_add, PendingIntent.getActivity(this.mContext, 0, new Intent("android.settings.BATTERY_SAVER_SETTINGS"), 67108864), this.mContext.getString(R.string.force_close));
    }
