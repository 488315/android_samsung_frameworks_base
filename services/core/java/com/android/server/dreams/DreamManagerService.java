...
public final class DreamManagerService extends SystemService {
    ...
    public DreamManagerService(Context context) {
        ...
        this.mDreamUiEventLogger = new DreamUiEventLoggerImpl(context.getResources().getStringArray(R.array.vendor_disallowed_apps_managed_user));
        ...
        this.mDreamsOnlyEnabledForDockUser = context.getResources().getBoolean(R.bool.config_disableTransitionAnimation);
        this.mDismissDreamOnActivityStart = context.getResources().getBoolean(R.bool.config_decoupleStatusBarAndDisplayCutoutFromScreenSize);
        this.mDreamsEnabledByDefaultConfig = context.getResources().getBoolean(R.bool.config_disableMenuKeyInLockScreen);
        this.mDreamsActivatedOnChargeByDefault = context.getResources().getBoolean(R.bool.config_device_wfc_ims_available);
        this.mDreamsActivatedOnDockByDefault = context.getResources().getBoolean(R.bool.config_device_vt_available);
        this.mSettingsObserver = new SettingsObserver(dreamHandler);
        this.mKeepDreamingWhenUnpluggingDefault = context.getResources().getBoolean(R.bool.config_goToSleepOnButtonPressTheaterMode);
        this.mDreamsDisabledByAmbientModeSuppressionConfig = context.getResources().getBoolean(R.bool.config_disableLockscreenByDefault);
    }
