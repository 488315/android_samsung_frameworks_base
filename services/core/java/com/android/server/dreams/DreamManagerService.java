...
public final class DreamManagerService extends SystemService {
  ...
  public DreamManagerService(Context context) {
          ...
          public void onActivityLaunched(
            ...
            synchronized (DreamManagerService.this.mLock) {
              if (DreamManagerService.this.mCurrentDream != null
                  && !DreamManagerService.this.mCurrentDream.isWaking
                  && !DreamManagerService.this.mCurrentDream.isDozing
                  && !z2) {
                z = true;
              }
            }
    ...
    this.mChargingReceiver =
        new BroadcastReceiver() { // from class: com.android.server.dreams.DreamManagerService.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            DreamManagerService.this.mIsCharging =
                "android.os.action.CHARGING".equals(intent.getAction());
          }
        };
    this.mDockStateReceiver =
        new BroadcastReceiver() { // from class: com.android.server.dreams.DreamManagerService.3
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
    ...
    DreamController.Listener listener =
        new DreamController
            .Listener() { // from class: com.android.server.dreams.DreamManagerService.5
          ...
          public void onDreamStopped(Binder binder) {
            synchronized (DreamManagerService.this.mLock) {
              if (DreamManagerService.this.mCurrentDream != null
                  && DreamManagerService.this.mCurrentDream.token == binder) {
    ...
    this.mDozeEnabledObserver =
        new ContentObserver(null) { // from class: com.android.server.dreams.DreamManagerService.6
          @Override // android.database.ContentObserver
    ...
    this.mSystemPropertiesChanged =
        new Runnable() { // from class: com.android.server.dreams.DreamManagerService.7
          @Override // java.lang.Runnable
          public void run() {
            synchronized (DreamManagerService.this.mLock) {
              if (DreamManagerService.this.mCurrentDream != null
                  && DreamManagerService.this.mCurrentDream.name != null
                  && DreamManagerService.this.mCurrentDream.canDoze
                  && !DreamManagerService.this.mCurrentDream.name.equals(
                      DreamManagerService.this.getDozeComponent())) {
                DreamManagerService.this.mPowerManager.wakeUp(
                    SystemClock.uptimeMillis(), "android.server.dreams:SYSPROP");
              }
            }
          }
        };
    ...
    this.mDreamUiEventLogger =
        new DreamUiEventLoggerImpl(
            context.getResources().getStringArray(R.array.vendor_disallowed_apps_managed_user));
    ...
    this.mDreamsOnlyEnabledForDockUser =
        context.getResources().getBoolean(R.bool.config_disableTransitionAnimation);
    ...
    this.mDreamsEnabledByDefaultConfig =
        context.getResources().getBoolean(R.bool.config_disableMenuKeyInLockScreen);
    this.mDreamsActivatedOnChargeByDefault =
        context.getResources().getBoolean(R.bool.config_device_wfc_ims_available);
    this.mDreamsActivatedOnDockByDefault =
        context.getResources().getBoolean(R.bool.config_device_vt_available);
    ...
    this.mDreamsDisabledByAmbientModeSuppressionConfig =
        context.getResources().getBoolean(R.bool.config_disableLockscreenByDefault);
  }
  ...
  public void onBootPhase(int i) {
    if (i == 600) {
      ...
      this.mContext.registerReceiver(
          new BroadcastReceiver() { // from class: com.android.server.dreams.DreamManagerService.4
            @Override // android.content.BroadcastReceiver
      ...
      this.mIsCharging =
          ((BatteryManager) this.mContext.getSystemService(BatteryManager.class)).isCharging();
  ...
  public final void dumpInternal(PrintWriter printWriter) {
    synchronized (this.mLock) {
      ...
      printWriter.println(
          "mDreamsActivatedOnDockByDefault=" + this.mDreamsActivatedOnDockByDefault);
      printWriter.println(
          "mDreamsActivatedOnChargeByDefault=" + this.mDreamsActivatedOnChargeByDefault);
      ...
      printWriter.println(
          "mKeepDreamingWhenUnpluggingDefault=" + this.mKeepDreamingWhenUnpluggingDefault);
      ...
      DumpUtils.dumpAsync(
          ...
          new DumpUtils
              .Dump() { // from class:
                        // com.android.server.dreams.DreamManagerService$$ExternalSyntheticLambda1
  ...
  public final void reportKeepDreamingWhenUnpluggingChanged(final boolean z) {
    notifyDreamStateListeners(
        new Consumer() { // from class:
                         // com.android.server.dreams.DreamManagerService$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            ((DreamManagerInternal.DreamManagerStateListener) obj)
                .onKeepDreamingWhenUnpluggingChanged(z);
          }
        });
  }
  ...
  public final void reportDreamingStarted() {
    notifyDreamStateListeners(
        new Consumer() { // from class:
                         // com.android.server.dreams.DreamManagerService$$ExternalSyntheticLambda7
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public final boolean canStartDreamingInternal(boolean z) {
    synchronized (this.mLock) {
      ...
      if (this.mDreamsDisabledByAmbientModeSuppressionConfig
          && this.mPowerManagerInternal.isAmbientDisplaySuppressed()) {
  ...
  public final ComponentName[] getDreamComponentsForUser(int i) {
    ...
    if (arrayList.isEmpty()
        && (defaultDreamComponentForUser = getDefaultDreamComponentForUser(i)) != null) {
      Slog.w(
          "DreamManagerService", "Falling back to default dream " + defaultDreamComponentForUser);
  ...
  public final void setDreamComponentsForUser(int i, ComponentName[] componentNameArr) {
    Settings.Secure.putStringForUser(
        ...
        componentsToString(componentNameArr),
        i);
  }
  ...
  public final void startDreamLocked(
    ...
    if (!dreamRecord4.name.equals(this.mAmbientDisplayComponent)) {
      ...
      DreamUiEventLogger.DreamUiEventEnum dreamUiEventEnum =
    ...
    this.mHandler.post(
        newWakeLock.wrap(
            new Runnable() { // from class:
                             // com.android.server.dreams.DreamManagerService$$ExternalSyntheticLambda3
              @Override // java.lang.Runnable
              public final void run() {
                DreamManagerService.this.lambda$startDreamLocked$5(
                    componentName, binder, z, z2, i, newWakeLock, str);
              }
            }));
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$startDreamLocked$5(
    ...
    this.mController.startDream(
        binder, componentName, z, z2, i, wakeLock, this.mDreamOverlayServiceName, str);
  }
  ...
  public final void stopDreamLocked(final boolean z, final String str) {
    ...
    if (dreamRecord != null) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.dreams.DreamManagerService$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public final void writePulseGestureEnabled() {
    ((InputManagerInternal) LocalServices.getService(InputManagerInternal.class))
        .setPulseGestureEnabled(validateDream(getDozeComponent()));
  }
  ...
  public final class BinderService extends IDreamManager.Stub {
    ...
    public void testDream(int i, ComponentName componentName) {
      ...
      int handleIncomingUser =
          ActivityManager.handleIncomingUser(
              Binder.getCallingPid(), Binder.getCallingUid(), i, false, true, "testDream", null);
      int currentUser = ActivityManager.getCurrentUser();
      if (handleIncomingUser != currentUser) {
        Slog.w(
            "DreamManagerService",
            "Aborted attempt to start a test dream while a different  user is active: userId="
                + handleIncomingUser
                + ", currentUserId="
                + currentUser);
        return;
  ...
  public final class LocalService extends DreamManagerInternal {
    ...
    public void registerDreamManagerStateListener(
      ...
      dreamManagerStateListener.onKeepDreamingWhenUnpluggingChanged(
          DreamManagerService.this.shouldKeepDreamingWhenUnplugging());
    }

    public void unregisterDreamManagerStateListener(
        DreamManagerInternal.DreamManagerStateListener dreamManagerStateListener) {
  ...
  public final class DreamRecord {
    ...
    public String toString() {
      return "DreamRecord{token="
          ...
          + this.isWaking
          + ", dozeScreenState="
          + this.dozeScreenState
          + ", dozeScreenBrightness="
          + this.dozeScreenBrightness
          + '}';
    }
  }
}
