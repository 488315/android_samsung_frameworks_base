...
public final class DreamController {
  ...
  public DreamController(Context context, Handler handler, Listener listener) {
    ...
    this.mCloseNotificationShadeOptions =
        BroadcastOptions.makeBasic()
            ...
            .setDeliveryGroupMatchingKey("android.intent.action.CLOSE_SYSTEM_DIALOGS", "dream")
            .setDeferralPolicy(2)
            .toBundle();
  ...
  public void startDream(
    ...
    try {
      this.mContext.sendBroadcastAsUser(
          this.mCloseNotificationShadeIntent,
          UserHandle.ALL,
          null,
          this.mCloseNotificationShadeOptions);
      Slog.i(
      ...
      try {
        ...
        MetricsLogger.visible(
            this.mContext,
            this.mCurrentDream.mCanDoze ? FrameworkStatsLog.EXCLUSION_RECT_STATE_CHANGED : 222);
        Intent intent = new Intent("android.service.dreams.DreamService");
        intent.setComponent(componentName);
        intent.addFlags(8388608);
        intent.putExtra(
            "android.service.dream.DreamService.dream_overlay_component", componentName2);
        try {
          if (!this.mContext.bindServiceAsUser(
              intent, this.mCurrentDream, 67108865, new UserHandle(i))) {
  ...
  public final void stopDreamInstance(boolean z, String str, DreamRecord dreamRecord) {
    ...
    MetricsLogger.hidden(
        this.mContext, dreamRecord.mCanDoze ? FrameworkStatsLog.EXCLUSION_RECT_STATE_CHANGED : 222);
    ...
    if (dreamRecord == this.mCurrentDream) {
      ...
      if (this.mSentStartBroadcast) {
        this.mContext.sendBroadcastAsUser(
            this.mDreamingStoppedIntent, UserHandle.ALL, null, this.mDreamingStartedStoppedOptions);
  ...
  public final void attach(IDreamService iDreamService) {
    try {
      ...
      DreamRecord dreamRecord = this.mCurrentDream;
      iDreamService.attach(
          dreamRecord.mToken,
          dreamRecord.mCanDoze,
          dreamRecord.mIsPreviewMode,
          dreamRecord.mDreamingStartedCallback);
      ...
      this.mContext.sendBroadcastAsUser(
          this.mDreamingStartedIntent, UserHandle.ALL, null, this.mDreamingStartedStoppedOptions);
  ...
  public final class DreamRecord implements IBinder.DeathRecipient, ServiceConnection {
    ...
    public final Runnable mStopPreviousDreamsIfNeeded =
    ...
    public DreamRecord(
      ...
      Runnable runnable =
          new Runnable() { // from class:
                           // com.android.server.dreams.DreamController$DreamRecord$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
      ...
      this.mStopUnconnectedDreamRunnable =
          new Runnable() { // from class:
                           // com.android.server.dreams.DreamController$DreamRecord$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
      ...
      this.mStopStubbornDreamRunnable =
          new Runnable() { // from class:
                           // com.android.server.dreams.DreamController$DreamRecord$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
      ...
      this.mDreamingStartedCallback =
          new IRemoteCallback
              .Stub() { // from class: com.android.server.dreams.DreamController.DreamRecord.1
    ...
    public void binderDied() {
      DreamController.this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.dreams.DreamController$DreamRecord$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onServiceConnected(ComponentName componentName, final IBinder iBinder) {
      DreamController.this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.dreams.DreamController$DreamRecord$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onServiceDisconnected(ComponentName componentName) {
      DreamController.this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.dreams.DreamController$DreamRecord$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
