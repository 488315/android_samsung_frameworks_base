...
public final /* synthetic */ class DreamController$DreamRecord$$ExternalSyntheticLambda1
        implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ DreamController.DreamRecord f$0;

    public /* synthetic */ DreamController$DreamRecord$$ExternalSyntheticLambda1(
            DreamController.DreamRecord dreamRecord, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        ...
        switch (i) {
            ...
            case 3:
                ...
                Slog.w(
                        "DreamController",
                        "Stubborn dream did not finish itself in the time allotted");
            ...
            case 4:
                ...
                if (dreamController2.mCurrentDream == dreamRecord) {
                    if (dreamController2.mResetScreenTimeoutOnUnexpectedDreamExit) {
                        ...
                        dreamController2.mPowerManager.userActivity(
                                SystemClock.uptimeMillis(), 0, 1);
                    }
            ...
            default:
                ...
                if (dreamController3.mCurrentDream == dreamRecord) {
                    if (dreamController3.mResetScreenTimeoutOnUnexpectedDreamExit) {
                        Slog.i("DreamController", "Resetting screen timeout");
                        dreamController3.mPowerManager.userActivity(
                                SystemClock.uptimeMillis(), 0, 1);
                    }
