...
public final class MmsServiceBroker extends SystemService {
    ...
    public static final ComponentName MMS_SERVICE_COMPONENT =
    ...
    public final class BinderService extends IMms.Stub {
        ...
        public final Uri addMultimediaMessageDraft(String str, Uri uri) {
            return MmsServiceBroker.m71$$Nest$mgetAppOpsManager(MmsServiceBroker.this)
                                    .noteOp(
                                            15,
                                            ...
                                            (String) null)
                            != 0
                    ? MmsServiceBroker.FAKE_MMS_DRAFT_URI
                    : MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                            .addMultimediaMessageDraft(str, uri);
        }
        ...
        public final Uri addTextMessageDraft(String str, String str2, String str3) {
            return MmsServiceBroker.m71$$Nest$mgetAppOpsManager(MmsServiceBroker.this)
                                    .noteOp(
                                            ...
                                            (String) null)
                            != 0
                    ? MmsServiceBroker.FAKE_SMS_DRAFT_URI
                    : MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                            .addTextMessageDraft(str, str2, str3);
        }
        ...
        public final Uri adjustUriForUserAndGrantPermission(int i, int i2, Uri uri) {
            ...
            try {
                ...
                localService.grantUriPermissionUncheckedFromIntent(
                        ((UriGrantsManagerService.LocalService) uriGrantsManagerInternal)
                                .internalCheckGrantUriPermissionFromIntent(
                                        intent, callingUid, "com.android.phone", 0, null),
                        null);
                Intent intent2 = new Intent("android.service.carrier.CarrierMessagingService");
                TelephonyManager telephonyManager =
                        (TelephonyManager) MmsServiceBroker.this.mContext.getSystemService("phone");
                SubscriptionManager subscriptionManager =
                        (SubscriptionManager)
                                MmsServiceBroker.this.mContext.getSystemService(
                                        "telephony_subscription_service");
                int i3 = -1;
                if (subscriptionManager != null
                        && (activeSubscriptionInfo =
                                        subscriptionManager.getActiveSubscriptionInfo(i2))
                                != null) {
                    i3 = activeSubscriptionInfo.getSimSlotIndex();
                }
                List carrierPackageNamesForIntentAndPhone =
                        telephonyManager.getCarrierPackageNamesForIntentAndPhone(intent2, i3);
                if (carrierPackageNamesForIntentAndPhone != null
                        && carrierPackageNamesForIntentAndPhone.size() == 1) {
                    localService.grantUriPermissionUncheckedFromIntent(
                            ((UriGrantsManagerService.LocalService) uriGrantsManagerInternal)
                                    .internalCheckGrantUriPermissionFromIntent(
                                            intent,
                                            callingUid,
                                            (String) carrierPackageNamesForIntentAndPhone.get(0),
                                            0,
                                            null),
                            null);
                }
        ...
        public final boolean archiveStoredConversation(String str, long j, boolean z) {
            if (MmsServiceBroker.m71$$Nest$mgetAppOpsManager(MmsServiceBroker.this)
                            .noteOp(15, Binder.getCallingUid(), str, (String) null, (String) null)
                    != 0) {
                return false;
            }
            return MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                    .archiveStoredConversation(str, j, z);
        }
        ...
        public final boolean deleteStoredConversation(String str, long j) {
            ...
            return MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                    .deleteStoredConversation(str, j);
        }
        ...
        public final boolean deleteStoredMessage(String str, Uri uri) {
            ...
            return MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                    .deleteStoredMessage(str, uri);
        }

        public final void downloadMessage(
                int i,
                String str,
                String str2,
                Uri uri,
            ...
            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                    "downloadMessage() by ", str, "MmsServiceBroker");
            MmsServiceBroker.this.mContext.enforceCallingPermission(
                    "android.permission.RECEIVE_MMS", "Download MMS message");
            if (MmsServiceBroker.m71$$Nest$mgetAppOpsManager(MmsServiceBroker.this)
                            .noteOp(18, Binder.getCallingUid(), str, str3, (String) null)
                    == 0) {
                MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                        .downloadMessage(
                                i,
                                str,
                                str2,
                                adjustUriForUserAndGrantPermission(3, i, uri),
                                bundle,
                                pendingIntent,
                                j,
                                str3);
        ...
        public final Uri importMultimediaMessage(
                String str, Uri uri, String str2, long j, boolean z, boolean z2) {
            return MmsServiceBroker.m71$$Nest$mgetAppOpsManager(MmsServiceBroker.this)
                                    .noteOp(
                                            15,
                                            Binder.getCallingUid(),
                                            ...
                                            (String) null)
                            != 0
                    ? MmsServiceBroker.FAKE_MMS_SENT_URI
                    : MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                            .importMultimediaMessage(str, uri, str2, j, z, z2);
        }

        public final Uri importTextMessage(
            ...
            return MmsServiceBroker.m71$$Nest$mgetAppOpsManager(MmsServiceBroker.this)
                                    .noteOp(
                                            ...
                                            (String) null)
                            != 0
                    ? MmsServiceBroker.FAKE_SMS_SENT_URI
                    : MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
        ...
        */
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.MmsServiceBroker.BinderService.sendMessage(int,"
                        + " java.lang.String, android.net.Uri, java.lang.String, android.os.Bundle,"
                        + " android.app.PendingIntent, long, java.lang.String):void");
        }

        public final void sendStoredMessage(
                int i, String str, Uri uri, Bundle bundle, PendingIntent pendingIntent) {
            if (MmsServiceBroker.m71$$Nest$mgetAppOpsManager(MmsServiceBroker.this)
                            .noteOp(20, Binder.getCallingUid(), str, (String) null, (String) null)
                    != 0) {
                return;
            }
            MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                    .sendStoredMessage(i, str, uri, bundle, pendingIntent);
        }
        ...
        public final void setAutoPersisting(String str, boolean z) {
            ...
            MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                    .setAutoPersisting(str, z);
        }

        public final boolean updateStoredMessageStatus(
                String str, Uri uri, ContentValues contentValues) {
            if (MmsServiceBroker.m71$$Nest$mgetAppOpsManager(MmsServiceBroker.this)
                            .noteOp(15, Binder.getCallingUid(), str, (String) null, (String) null)
                    != 0) {
                return false;
            ...
            return MmsServiceBroker.m72$$Nest$mgetServiceGuarded(MmsServiceBroker.this)
                    .updateStoredMessageStatus(str, uri, contentValues);
        }
    }
    ...
    public static AppOpsManager m71$$Nest$mgetAppOpsManager(MmsServiceBroker mmsServiceBroker) {
        if (mmsServiceBroker.mAppOpsManager == null) {
            mmsServiceBroker.mAppOpsManager =
                    (AppOpsManager) mmsServiceBroker.mContext.getSystemService("appops");
        }
    ...
    public MmsServiceBroker(Context context) {
        ...
        this.mConnectionHandler =
                new Handler() { // from class: com.android.server.MmsServiceBroker.1
                    ...
                    public final void handleMessage(Message message) {
                        ...
                        synchronized (mmsServiceBroker) {
                            try {
                                ...
                                try {
                                    if (!mmsServiceBroker.mContext.bindService(
                                            intent, mmsServiceBroker.mConnection, 1)) {
                                        Slog.e("MmsServiceBroker", "Failed to bind to MmsService");
                                    }
                                } catch (SecurityException e) {
                                    Slog.e(
                                            "MmsServiceBroker",
                                            "Forbidden to bind to MmsService",
                                            e);
                                }
                            } finally {
                            }
        ...
        this.mConnection =
                new ServiceConnection() { // from class: com.android.server.MmsServiceBroker.2
                    @Override // android.content.ServiceConnection
                    public final void onServiceConnected(
                            ComponentName componentName, IBinder iBinder) {
                        Slog.i("MmsServiceBroker", "MmsService connected");
                        synchronized (MmsServiceBroker.this) {
                            MmsServiceBroker.this.mService =
                                    IMms.Stub.asInterface(Binder.allowBlocking(iBinder));
        ...
        this.mServiceStubForFailure =
                new IMms() { // from class: com.android.server.MmsServiceBroker.3
                    public final Uri addMultimediaMessageDraft(String str, Uri uri) {
                        return null;
                    }
