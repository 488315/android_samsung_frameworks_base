...
public class MmsServiceBroker extends SystemService {
    ...
    this.mConnection =
        new ServiceConnection() { // from class: com.android.server.MmsServiceBroker.2
          ...
          public void onServiceDisconnected(ComponentName componentName) {
            ...
            MmsServiceBroker.this.mConnectionHandler.sendMessageDelayed(
                MmsServiceBroker.this.mConnectionHandler.obtainMessage(1), 3000L);
          }
        };
  ...
  public final class BinderService extends IMms.Stub {
    ...
    public void sendMessage(
      ...
      MmsServiceBroker.this.mContext.enforceCallingPermission(
          "android.permission.SEND_SMS", "Send MMS message");
      if (!TelephonyPermissions.checkSubscriptionAssociatedWithUser(
          MmsServiceBroker.this.mContext, i, Binder.getCallingUserHandle())) {
        TelephonyUtils.showSwitchToManagedProfileDialogIfAppropriate(
            MmsServiceBroker.this.mContext, i, Binder.getCallingUid(), str);
        return;
      }
      if (MmsServiceBroker.this
              .getAppOpsManager()
              .noteOp(20, Binder.getCallingUid(), str, str3, (String) null)
          != 0) {
        Slog.e("MmsServiceBroker", str + " is not allowed to call sendMessage()");
        return;
      }
      MmsServiceBroker.this
          .getServiceGuarded()
          .sendMessage(
              i,
              str,
              adjustUriForUserAndGrantPermission(
                  uri, "android.service.carrier.CarrierMessagingService", 1, i),
              str2,
              bundle,
              pendingIntent,
              j,
    ...
    public void downloadMessage(
      ...
      MmsServiceBroker.this
          ...
          .downloadMessage(
              ...
              str2,
              adjustUriForUserAndGrantPermission(
                  uri, "android.service.carrier.CarrierMessagingService", 3, i),
              bundle,
              pendingIntent,
              j,
              str3);
  ...
  public final int getPhoneIdFromSubId(int i) {
    ...
    if (subscriptionManager == null
        || (activeSubscriptionInfo = subscriptionManager.getActiveSubscriptionInfo(i)) == null) {
      return -1;
    }
