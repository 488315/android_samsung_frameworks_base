...
public class PhoneRestrictionPolicy extends IPhoneRestrictionPolicy.Stub
  ...
  /* renamed from: tm */
  public TelephonyManager f1697tm;
  ...
  public PhoneRestrictionPolicy(Injector injector) {
    ...
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.enterprise.restriction.PhoneRestrictionPolicy.1
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if ("com.samsung.android.knox.intent.action.KNOXFRAMEWORK_SYSTEMUI_UPDATE_INTENT_INTERNAL"
                .equals(intent.getAction())) {
              PhoneRestrictionPolicy.this.updateSystemUIMonitor(
    ...
    BroadcastReceiver broadcastReceiver2 =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.enterprise.restriction.PhoneRestrictionPolicy.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            ...
            } else if ("com.samsung.rcs.framework.instantmessaging.action.RECEIVE_SEND_MESSAGE_RESPONSE"
                    .equals(action)
                && !extras.getBoolean("response_status")) {
    ...
    BroadcastReceiver broadcastReceiver3 =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.enterprise.restriction.PhoneRestrictionPolicy.3
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            int phoneId = SubscriptionManager.getPhoneId(intent.getIntExtra("subscription", -1));
            if (phoneId == 0 || phoneId == 1) {
              boolean isDataAllowedFromSimSlot =
                  PhoneRestrictionPolicy.this.isDataAllowedFromSimSlot(phoneId);
              long clearCallingIdentity = Binder.clearCallingIdentity();
              try {
                if (!isDataAllowedFromSimSlot) {
                  try {
                    SemWifiManager semWifiManager =
                        (SemWifiManager) context.getSystemService("sem_wifi");
                    if (semWifiManager != null) {
                      int wifiApState = semWifiManager.getWifiApState();
                      if (wifiApState == 13 || wifiApState == 12) {
                        semWifiManager.setWifiApEnabled(
                            (SoftApConfiguration) null, isDataAllowedFromSimSlot);
                      }
                    } else {
                ...
                SystemUIAdapter systemUIAdapter =
                    SystemUIAdapter.getInstance(PhoneRestrictionPolicy.this.mContext);
    ...
    BroadcastReceiver broadcastReceiver4 =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.enterprise.restriction.PhoneRestrictionPolicy.5
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
            if (action == null) {
            ...
            if (action.equals("android.intent.action.LOCKED_BOOT_COMPLETED")) {
              PhoneRestrictionPolicy.this.mSmsMmsDeliveryHandler.sendMessage(
                  Message.obtain(PhoneRestrictionPolicy.this.mSmsMmsDeliveryHandler, 2));
            ...
            } else if ("com.samsung.android.knox.intent.action.PHONE_READY_INTERNAL"
                .equals(action)) {
              PhoneRestrictionPolicy.this.mSimPinHandler.postDelayed(
                  PhoneRestrictionPolicy.this.mSimPinBind, 0L);
            }
          }
        };
    ...
    BroadcastReceiver broadcastReceiver5 =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.enterprise.restriction.PhoneRestrictionPolicy.6
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
            Log.d("PhoneRestrictionPolicy", action);
            if ("com.samsung.android.knox.intent.action.PHONE_READY_INTERNAL".equals(action)
    ...
    this.mSimPinBind =
        new Runnable() { // from class:
                         // com.android.server.enterprise.restriction.PhoneRestrictionPolicy.7
          ...
          public void run() {
            ...
            ComponentName componentName =
                new ComponentName(
                    ...
                    "com.sec.enterprise.mdm.services.simpin.EnterpriseSimPin");
            PhoneRestrictionPolicy.this.mSimPinHandler.removeCallbacks(this);
            try {
              PhoneRestrictionPolicy.this.mContext.bindService(
                  new Intent("com.sec.enterprise.SimPinCode").setComponent(componentName),
                  PhoneRestrictionPolicy.this.mSimPinServiceConn,
                  1);
    ...
    this.mSimPinServiceConn =
        new ServiceConnection() { // from class:
                                  // com.android.server.enterprise.restriction.PhoneRestrictionPolicy.8
          ...
          public synchronized void onServiceDisconnected(ComponentName componentName) {
            ...
            PhoneRestrictionPolicy.this.mSimPinHandler.removeCallbacks(
                PhoneRestrictionPolicy.this.mSimPinBind);
            PhoneRestrictionPolicy.this.mSimPinHandler.postDelayed(
                PhoneRestrictionPolicy.this.mSimPinBind, 1000L);
          }
        };
    ...
    this.f1697tm = (TelephonyManager) context.getSystemService("phone");
    ...
    context.registerReceiver(
        broadcastReceiver2, intentFilter3, "com.samsung.rcs.im.READ_PERMISSION", null);
  ...
  public final void sendRcsBroadcast(String str, Bundle bundle) {
    ...
    } else if ("com.samsung.rcs.framework.filetransfer.notification.TRANSFER_INCOMING".equals(str)
        || "com.samsung.rcs.framework.filetransfer.notification.TRANSFER_COMPLETED".equals(str)) {
    ...
    this.mContext.sendBroadcast(
        intent, "com.samsung.android.knox.permission.KNOX_ADVANCED_RESTRICTION");
  }
  ...
  public Bundle getRCSMessage(ContextInfo contextInfo, long j) {
    ...
    getEDM()
        .enforceOwnerOnlyAndActiveAdminPermission(
            contextInfo,
            new ArrayList(
                Arrays.asList("com.samsung.android.knox.permission.KNOX_ADVANCED_RESTRICTION")));
    ...
    try {
      try {
        Cursor query =
            this.mContext.getContentResolver().query(RCS_URI, RCS_PROJ, "_id=?", strArr, null);
        if (query != null) {
          try {
            if (query.moveToFirst()) {
              ...
              bundle2.putString(
                  "sender-alias", query.getString(query.getColumnIndex("sender_alias")));
              bundle2.putString(
                  "content-type", query.getString(query.getColumnIndex("content_type")));
              bundle2.putString("body", query.getString(query.getColumnIndex("body")));
              if (query.getInt(query.getColumnIndex("direction")) == 0) {
                bundle2.putLong(
                    "timestamp", query.getLong(query.getColumnIndex("inserted_timestamp")));
              } else {
              ...
              if (query.getInt(query.getColumnIndex("is_filetransfer")) == 1) {
                ...
                bundle2.putString(
                    "thumbnail-path", query.getString(query.getColumnIndex("thumbnail_path")));
              }
              bundle = bundle2;
            }
          } catch (Throwable th) {
  ...
  public final ContextInfo enforceOwnerOnlyAndPhonePermission(ContextInfo contextInfo) {
    return getEDM()
        .enforceOwnerOnlyAndActiveAdminPermission(
            contextInfo,
            new ArrayList(
                Arrays.asList("com.samsung.android.knox.permission.KNOX_PHONE_RESTRICTION")));
  }
  ...
  public final ContextInfo enforceOwnerOnlyAndSimRestrictionPermission(ContextInfo contextInfo) {
    return getEDM()
        .enforceOwnerOnlyAndActiveAdminPermission(
            contextInfo,
            new ArrayList(
                Arrays.asList("com.samsung.android.knox.permission.KNOX_SIM_RESTRICTION")));
  }
  ...
  public final ContextInfo enforcePhoneAppOrOwnerOnlyAndPhonePermission(ContextInfo contextInfo) {
    ...
    return UserHandle.getAppId(contextInfo.mCallerUid) != 1001
  ...
  public boolean addOutgoingCallRestriction(ContextInfo contextInfo, String str) {
    ...
    return setOutgoingCallRestriction(
        contextInfo, outgoingCallRestriction.concat("|").concat(removeWhiteSpaces(str)));
  }
  ...
  public boolean addIncomingCallRestriction(ContextInfo contextInfo, String str) {
    ...
    return setIncomingCallRestriction(
        contextInfo, incomingCallRestriction.concat("|").concat(removeWhiteSpaces(str)));
  }
  ...
  public boolean canOutgoingCall(String str) {
    ...
    if (isLimitNumberOfCallsEnabled(null)) {
      ...
      try {
        ...
        if ((Integer.parseInt(this.mEdmStorageProvider.getGenericValue("outgoingCallCountDay"))
                    < limitOfOutgoingCalls2
                || limitOfOutgoingCalls2 < 1)
            && (Integer.parseInt(this.mEdmStorageProvider.getGenericValue("outgoingCallCountWeek"))
          ...
          if (Integer.parseInt(this.mEdmStorageProvider.getGenericValue("outgoingCallCountMonth"))
  ...
  public boolean canIncomingCall(String str) {
    ...
    if (this.mTelMgr.isNetworkRoaming()
        && !getEDM().getRoamingPolicy().isRoamingVoiceCallsEnabled()) {
      return false;
    }
    boolean isNumberAllowed =
    ...
    if (isLimitNumberOfCallsEnabled(null)) {
      ...
      try {
        ...
        if ((Integer.parseInt(this.mEdmStorageProvider.getGenericValue("incomingCallCountDay"))
                    < limitOfIncomingCalls2
                || limitOfIncomingCalls2 < 1)
            && (Integer.parseInt(this.mEdmStorageProvider.getGenericValue("incomingCallCountWeek"))
          ...
          if (Integer.parseInt(this.mEdmStorageProvider.getGenericValue("incomingCallCountMonth"))
  ...
  public final boolean isNumberAllowed(String str, String str2, String str3) {
    List<ContentValues> valuesList =
        this.mEdmStorageProvider.getValuesList("PHONERESTRICTION", new String[] {"adminUid", str2});
              ...
              if (compile.matcher(str).matches()) {
                String string =
                    this.mEdmStorageProvider.getString(
                        asInteger.intValue(), "PHONERESTRICTION", str3);
      ...
      if (!z) {
        ...
        if (contextInfo.mParent) {
          return this.mEdmStorageProvider.getBoolean(
              EnterpriseDeviceManagerService.getInstance().getPseudoAdminUid(),
              "PHONERESTRICTION",
              "emergencyCallOnly");
        }
        if (callingUserId != 0
        ...
        z2 =
            this.mEdmStorageProvider.getBoolean(
                contextInfo.mCallerUid, "PHONERESTRICTION", "emergencyCallOnly");
      } else {
        Iterator it =
            this.mEdmStorageProvider
                .getBooleanList("PHONERESTRICTION", "emergencyCallOnly")
                .iterator();
        while (it.hasNext()) {
  ...
  public final String getRestrictionPattern(ContextInfo contextInfo, boolean z, String str) {
    if (!z) {
      return this.mEdmStorageProvider.getString(
          enforceOwnerOnlyAndPhonePermission(contextInfo).mCallerUid, "PHONERESTRICTION", str);
    }
    String str2 = "";
  ...
  public String getOutgoingSmsRestriction(ContextInfo contextInfo, boolean z) {
    ...
    if (this.mTelMgr.isVoiceCapable()) {
      return getRestrictionPattern(
          enforceOwnerOnlyAndPhonePermission, z, "smsRestrictionOutgoingPattern");
    }
    return null;
  }
  ...
  public String getIncomingSmsRestriction(ContextInfo contextInfo, boolean z) {
    ...
    if (this.mTelMgr.isVoiceCapable()) {
      return getRestrictionPattern(
          enforceOwnerOnlyAndPhonePermission, z, "smsRestrictionIncomingPattern");
    }
    return null;
  }
  ...
  public boolean addOutgoingSmsRestriction(ContextInfo contextInfo, String str) {
    ...
    String restrictionPattern =
        getRestrictionPattern(contextInfo, false, "smsRestrictionOutgoingPattern");
    ...
    return setOutgoingSmsRestriction(
        contextInfo, restrictionPattern.concat("|").concat(removeWhiteSpaces(str)));
  }
  ...
  public boolean addIncomingSmsRestriction(ContextInfo contextInfo, String str) {
    ...
    String restrictionPattern =
        getRestrictionPattern(contextInfo, false, "smsRestrictionIncomingPattern");
    if (restrictionPattern == null || restrictionPattern.isEmpty()) {
  ...
  public boolean enableLimitNumberOfSms(ContextInfo contextInfo, boolean z) {
    ...
    if (z && !isLimitNumberOfSmsEnabled(enforceOwnerOnlyAndPhonePermission)) {
      ...
      if (!(this.mEdmStorageProvider.putGenericValue("smsDateDay", String.valueOf(timeInMillis))
              && this.mEdmStorageProvider.putGenericValue(
                  "smsDateWeek", String.valueOf(timeInMillis)))
          || !this.mEdmStorageProvider.putGenericValue(
              "smsDateMonth", String.valueOf(timeInMillis))) {
        z2 = false;
        Log.d("PhoneRestrictionPolicy", "enableLimitNumberOfSMS  >>>>>");
        return z2
            && this.mEdmStorageProvider.putBoolean(
  ...
  public boolean isLimitNumberOfSmsEnabled(ContextInfo contextInfo) {
    ArrayList booleanList =
        this.mEdmStorageProvider.getBooleanList("PHONERESTRICTION", "limitSmsEnable");
  ...
  public boolean setLimitOfIncomingSms(ContextInfo contextInfo, int i, int i2, int i3) {
    ...
    return (this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "incomingSmsByDay", i)
            && this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "incomingSmsByWeek", i2))
        && this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "incomingSmsByMonth", i3);
  }
  ...
  public boolean setLimitOfOutgoingSms(ContextInfo contextInfo, int i, int i2, int i3) {
    ...
    return (this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "outgoingSmsByDay", i)
            && this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "outgoingSmsByWeek", i2))
        && this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "outgoingSmsByMonth", i3);
  }
  ...
  public boolean addNumberOfIncomingSms() {
    ...
    boolean putGenericValue =
        this.mEdmStorageProvider.putGenericValue(
                "incomingSmsCountMonth",
                String.valueOf(
                    Integer.parseInt(
                            this.mEdmStorageProvider.getGenericValue("incomingSmsCountMonth"))
                        + 1))
            & this.mEdmStorageProvider.putGenericValue(
                "incomingSmsCountDay",
                String.valueOf(
                    Integer.parseInt(
                            this.mEdmStorageProvider.getGenericValue("incomingSmsCountDay"))
                        + 1))
            & this.mEdmStorageProvider.putGenericValue(
                "incomingSmsCountWeek",
                String.valueOf(
                    Integer.parseInt(
                            this.mEdmStorageProvider.getGenericValue("incomingSmsCountWeek"))
                        + 1));
    Log.d("PhoneRestrictionPolicy", "SMSRestrictionPolicy.addNumberOfIncomingSMS() >>>");
  ...
  public boolean addNumberOfOutgoingSms() {
    ...
    boolean putGenericValue =
        this.mEdmStorageProvider.putGenericValue(
                ...
                String.valueOf(
                    Integer.parseInt(
                            this.mEdmStorageProvider.getGenericValue("outgoingSmsCountMonth"))
                        + 1))
            & this.mEdmStorageProvider.putGenericValue(
                "outgoingSmsCountDay",
                String.valueOf(
                    Integer.parseInt(
                            this.mEdmStorageProvider.getGenericValue("outgoingSmsCountDay"))
                        + 1))
            & this.mEdmStorageProvider.putGenericValue(
                "outgoingSmsCountWeek",
                String.valueOf(
                    Integer.parseInt(
                            this.mEdmStorageProvider.getGenericValue("outgoingSmsCountWeek"))
                        + 1));
    Log.d("PhoneRestrictionPolicy", "SmsRestrictionPolicy.addNumberOfOutgoingSms >>>");
    return putGenericValue;
  }
  ...
  public boolean canIncomingSms(String str) {
    ...
    boolean isNumberAllowed =
        isNumberAllowed(str, "smsRestrictionIncomingPattern", "incomingSmsExceptionPattern");
    if (isLimitNumberOfSmsEnabled(null)) {
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        ...
        int parseInt =
            Integer.parseInt(this.mEdmStorageProvider.getGenericValue("incomingSmsCountDay"));
        Log.d("PhoneRestrictionPolicy", "canIncomingSms - countDay = " + parseInt);
        if ((parseInt >= limitOfIncomingSms3 && limitOfIncomingSms3 >= 1)
            || ((Integer.parseInt(this.mEdmStorageProvider.getGenericValue("incomingSmsCountWeek"))
                        >= (limitOfIncomingSms = getLimitOfIncomingSms(null, 1))
                    && limitOfIncomingSms >= 1)
                || (Integer.parseInt(
                            this.mEdmStorageProvider.getGenericValue("incomingSmsCountMonth"))
                        >= (limitOfIncomingSms2 = getLimitOfIncomingSms(null, 2))
  ...
  public boolean canOutgoingSms(String str) {
    ...
    boolean isNumberAllowed =
        isNumberAllowed(str, "smsRestrictionOutgoingPattern", "outgoingSmsExceptionPattern");
    if (isLimitNumberOfSmsEnabled(null)) {
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        Log.d("PhoneRestrictionPolicy", "Limit of sms is enabled!!!");
        ...
        int parseInt =
            Integer.parseInt(this.mEdmStorageProvider.getGenericValue("outgoingSmsCountDay"));
        Log.d("PhoneRestrictionPolicy", "canOutgoingSms - countDay = " + parseInt);
        if ((parseInt >= limitOfOutgoingSms3 && limitOfOutgoingSms3 >= 1)
            || ((Integer.parseInt(this.mEdmStorageProvider.getGenericValue("outgoingSmsCountWeek"))
                        >= (limitOfOutgoingSms = getLimitOfOutgoingSms(null, 1))
                    && limitOfOutgoingSms >= 1)
                || (Integer.parseInt(
                            this.mEdmStorageProvider.getGenericValue("outgoingSmsCountMonth"))
                        >= (limitOfOutgoingSms2 = getLimitOfOutgoingSms(null, 2))
  ...
  public final void updateDateAndCountersSms() {
    ...
    calendar2.setTimeInMillis(
        Long.parseLong(this.mEdmStorageProvider.getGenericValue("smsDateDay")));
    Calendar calendar3 = Calendar.getInstance();
    calendar3.setTimeInMillis(
        Long.parseLong(this.mEdmStorageProvider.getGenericValue("smsDateWeek")));
    Calendar calendar4 = Calendar.getInstance();
    calendar4.setTimeInMillis(
        Long.parseLong(this.mEdmStorageProvider.getGenericValue("smsDateMonth")));
    long timeInMillis = calendar.getTimeInMillis();
    ...
    if (calendar.after(calendar2)) {
      ...
      if (calendar3.get(3) != calendar.get(3)
          || (calendar3.get(3) == calendar.get(3) && calendar3.get(1) != calendar.get(1))) {
        this.mEdmStorageProvider.putGenericValue("smsDateWeek", String.valueOf(timeInMillis));
        this.mEdmStorageProvider.putGenericValue("incomingSmsCountWeek", String.valueOf(0));
        this.mEdmStorageProvider.putGenericValue("outgoingSmsCountWeek", String.valueOf(0));
      }
      if (calendar4.get(2) != calendar.get(2)
          || (calendar3.get(2) == calendar.get(2) && calendar3.get(1) != calendar.get(1))) {
  ...
  public boolean enableLimitNumberOfCalls(ContextInfo contextInfo, boolean z) {
    ...
    if (z && !isLimitNumberOfCallsEnabled(enforceOwnerOnlyAndPhonePermission)) {
      ...
      calendar.set(14, 0);
      long timeInMillis = calendar.getTimeInMillis();
      if (!(this.mEdmStorageProvider.putGenericValue("dateDay", String.valueOf(timeInMillis))
  ...
  public boolean isLimitNumberOfCallsEnabled(ContextInfo contextInfo) {
    ...
    ArrayList booleanList =
        this.mEdmStorageProvider.getBooleanList("PHONERESTRICTION", "limitCallEnable");
    if (!booleanList.isEmpty()) {
      Iterator it = booleanList.iterator();
      while (it.hasNext()) {
        if (((Boolean) it.next()).booleanValue()) {
  ...
  public boolean setLimitOfIncomingCalls(ContextInfo contextInfo, int i, int i2, int i3) {
    ...
    if (this.mTelMgr.isVoiceCapable() && i >= 0 && i2 >= 0 && i3 >= 0) {
      return (this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "incomingCallByDay", i)
              && this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "incomingCallByWeek", i2))
          && this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "incomingCallByMonth", i3);
    }
    return false;
  }
  ...
  public boolean setLimitOfOutgoingCalls(ContextInfo contextInfo, int i, int i2, int i3) {
    int i4 = enforceOwnerOnlyAndPhonePermission(contextInfo).mCallerUid;
    if (this.mTelMgr.isVoiceCapable() && i >= 0 && i2 >= 0 && i3 >= 0) {
      return (this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "outgoingCallByDay", i)
              && this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "outgoingCallByWeek", i2))
          && this.mEdmStorageProvider.putInt(i4, "PHONERESTRICTION", "outgoingCallByMonth", i3);
    }
    return false;
  }
  ...
  public boolean addNumberOfIncomingCalls() {
    ...
    if (genericValue == null || genericValue2 == null || genericValue3 == null) {
      ...
      try {
        ...
        boolean putGenericValue =
            this.mEdmStorageProvider.putGenericValue(
                    "incomingCallCountMonth", String.valueOf(i + 1))
                & this.mEdmStorageProvider.putGenericValue(
                    "incomingCallCountDay", String.valueOf(i4 + 1))
                & this.mEdmStorageProvider.putGenericValue(
                    "incomingCallCountWeek", String.valueOf(i2 + 1));
        Log.d("PhoneRestrictionPolicy", "PhoneRestrictionPolicy.addNumberOfIncomingCalls() >>>");
        return putGenericValue;
      }
      int i52 = i4;
    ...
    boolean putGenericValue2 =
        this.mEdmStorageProvider.putGenericValue("incomingCallCountMonth", String.valueOf(i + 1))
            & this.mEdmStorageProvider.putGenericValue(
                "incomingCallCountDay", String.valueOf(i4 + 1))
            & this.mEdmStorageProvider.putGenericValue(
                "incomingCallCountWeek", String.valueOf(i2 + 1));
  ...
  public boolean addNumberOfOutgoingCalls() {
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            boolean putGenericValue =
                this.mEdmStorageProvider.putGenericValue(
                        "outgoingCallCountMonth", String.valueOf(i + 1))
                    & this.mEdmStorageProvider.putGenericValue(
                        "outgoingCallCountDay", String.valueOf(i4 + 1))
                    & this.mEdmStorageProvider.putGenericValue(
                        "outgoingCallCountWeek", String.valueOf(i2 + 1));
            Log.d("PhoneRestrictionPolicy", "PhoneRestrictionPolicy.addNumberOfOutgoingCalls >>>");
            return putGenericValue;
          }
        } catch (NumberFormatException unused2) {
    ...
    boolean putGenericValue2 =
        this.mEdmStorageProvider.putGenericValue("outgoingCallCountMonth", String.valueOf(i + 1))
            & this.mEdmStorageProvider.putGenericValue(
                "outgoingCallCountDay", String.valueOf(i4 + 1))
            & this.mEdmStorageProvider.putGenericValue(
                "outgoingCallCountWeek", String.valueOf(i2 + 1));
  ...
  public boolean resetCallsCount(ContextInfo contextInfo) {
    ...
    return this.mEdmStorageProvider.putGenericValue("outgoingCallCountMonth", String.valueOf(0))
  ...
  public final void updateDateAndCounters() {
    ...
    Calendar calendar4 = Calendar.getInstance();
    calendar4.setTimeInMillis(
        Long.parseLong(this.mEdmStorageProvider.getGenericValue("dateMonth")));
    long timeInMillis = calendar.getTimeInMillis();
    if (calendar.after(calendar2)) {
  ...
  public boolean setDataCallLimitEnabled(ContextInfo contextInfo, boolean z) {
    ...
    if (z && !this.mDataLimitEnabled) {
      ...
      z2 =
          true
              & this.mEdmStorageProvider.putGenericValue(
                  "dataCallDateDay", String.valueOf(timeInMillis))
              & this.mEdmStorageProvider.putGenericValue(
                  "dataCallDateWeek", String.valueOf(timeInMillis))
              & this.mEdmStorageProvider.putGenericValue(
                  "dataCallDateMonth", String.valueOf(timeInMillis));
    }
    boolean putBoolean =
        this.mEdmStorageProvider.putBoolean(
                enforceOwnerOnlyAndPhonePermission.mCallerUid,
  ...
  public boolean getDataCallLimitEnabled(ContextInfo contextInfo) {
    Iterator it =
        this.mEdmStorageProvider
            .getBooleanList("PHONERESTRICTION", "enableLimitDataCall")
            .iterator();
    while (it.hasNext()) {
  ...
  public boolean setLimitOfDataCalls(ContextInfo contextInfo, long j, long j2, long j3) {
    ...
    return this.mEdmStorageProvider.putLong(i, "PHONERESTRICTION", "dataCallByMonth", j3)
        & this.mEdmStorageProvider.putLong(i, "PHONERESTRICTION", "dataCallByDay", j)
        & this.mEdmStorageProvider.putLong(i, "PHONERESTRICTION", "dataCallByWeek", j2);
  }
  ...
  public boolean resetDataCallLimitCounter(ContextInfo contextInfo) {
    enforceOwnerOnlyAndPhonePermission(contextInfo);
    return this.mEdmStorageProvider.putGenericValue("dataCallByteCountByMonth", String.valueOf(0))
  ...
  public boolean checkEnableUseOfPacketData(boolean z) {
    ...
    if (checkDataCallLimit() || !getEDM().getRestrictionPolicy().isCellularDataAllowed()) {
      if (z) {
        RestrictionToastManager.show(R.string.face_name_template);
      }
      z2 = false;
    } else {
      z2 = true;
  ...
  public void updateDateAndDataCallCounters(long j) {
    ...
    if (this.mDataLimitEnabled) {
      ...
      try {
        calendar2.setTimeInMillis(
            Long.parseLong(this.mEdmStorageProvider.getGenericValue("dataCallDateDay")));
      } catch (NumberFormatException unused) {
      }
      Calendar calendar3 = Calendar.getInstance();
      try {
        calendar3.setTimeInMillis(
            Long.parseLong(this.mEdmStorageProvider.getGenericValue("dataCallDateWeek")));
      } catch (NumberFormatException unused2) {
      }
      Calendar calendar4 = Calendar.getInstance();
      try {
        calendar4.setTimeInMillis(
            Long.parseLong(this.mEdmStorageProvider.getGenericValue("dataCallDateMonth")));
      } catch (NumberFormatException unused3) {
      }
      long timeInMillis = calendar.getTimeInMillis();
      if (calendar.after(calendar2)) {
  ...
  public final boolean restorePacketDataNetworkSetting() {
    if (this.mDataCheckboxPreviousState
        && getEDM().getRestrictionPolicy().isCellularDataAllowed()) {
  ...
  public final boolean getDataCheckboxState() {
    return Boolean.parseBoolean(
        this.mEdmStorageProvider.getGenericValue("dataCallPacketDataCheckBox"));
  }

  public final boolean putDataCheckboxState(boolean z) {
    return this.mEdmStorageProvider.putGenericValue(
        "dataCallPacketDataCheckBox", String.valueOf(z));
  }
  ...
  public boolean isCopyContactToSimAllowed(ContextInfo contextInfo) {
    try {
      Iterator it =
          this.mEdmStorageProvider
              .getBooleanList("PHONERESTRICTION", "copyContactToSimEnabled")
              .iterator();
      while (it.hasNext()) {
        boolean booleanValue = ((Boolean) it.next()).booleanValue();
        if (!booleanValue) {
  ...
  public boolean isCopyContactToSimAllowed(int i) {
    ...
    if (!z) {
      if (i == 1) {
        ...
        RestrictionToastManager.show(R.string.biometric_error_canceled);
      } else if (i == 3) {
        Log.d("PhoneRestrictionPolicy", "Access to PB Edit ");
        RestrictionToastManager.show(R.string.importance_from_person);
      } else {
  ...
  public boolean allowCopyContactToSim(ContextInfo contextInfo, boolean z) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    boolean putBoolean =
        this.mEdmStorageProvider.putBoolean(i, "PHONERESTRICTION", "copyContactToSimEnabled", z);
  ...
  public boolean isBlockSmsWithStorageEnabled(ContextInfo contextInfo) {
    return this.mEdmStorageProvider
        .getBooleanList("PHONERESTRICTION", "blockSmsWithStorage")
  ...
  public boolean isBlockMmsWithStorageEnabled(ContextInfo contextInfo) {
    return this.mEdmStorageProvider
        .getBooleanList("PHONERESTRICTION", "blockMmsWithStorage")
        .contains(Boolean.TRUE);
  }
  ...
  public final synchronized void deliveryBlockedMsgs(int i) {
    ...
    List<ContentValues> valuesList =
        this.mEdmStorageProvider.getValuesList("SMSMMSBlockedDelivery", strArr, contentValues);
    ...
    for (ContentValues contentValues2 : valuesList) {
      ...
      if (i == 0) {
        ...
        if (!getEmergencyCallOnly(null, true)
            && isIncomingSmsAllowed(null)
            && canIncomingSms(asString)) {
        ...
        if (!getEmergencyCallOnly(null, true)
            && isIncomingMmsAllowed(null)
            && ((!this.mTelMgr.isNetworkRoaming()
                    || this.mEDM.getRoamingPolicy().isRoamingPushEnabled())
                && this.mEDM.getPhoneRestrictionPolicy().isWapPushAllowed())) {
          intent.putExtra(
      ...
      if (asString2 != null) {
        ...
        this.mContext.sendOrderedBroadcast(
            intent,
            "com.samsung.android.knox.permission.KNOX_RECEIVE_BLOCKED_SMS_MMS_INTERNAL",
            new BroadcastReceiver() { // from class:
                                      // com.android.server.enterprise.restriction.PhoneRestrictionPolicy.4
              @Override // android.content.BroadcastReceiver
  ...
  public final void deleteMessageFromStorageProvider(String str) {
    this.mEdmStorageProvider.deleteDataByFields(
        "SMSMMSBlockedDelivery", new String[] {"smsMmsBlockedRowId"}, new String[] {str});
  }
  ...
  public boolean isWapPushAllowed(ContextInfo contextInfo) {
    boolean z;
    Iterator it =
        this.mEdmStorageProvider.getBooleanList("PHONERESTRICTION", "wapPushEnabled").iterator();
    while (true) {
      if (!it.hasNext()) {
        z = true;
        break;
  ...
  public boolean isCallerIDDisplayAllowed(ContextInfo contextInfo) {
    try {
      Iterator it =
          this.mEdmStorageProvider.getBooleanList("PHONERESTRICTION", "allowCallerID").iterator();
      while (it.hasNext()) {
        boolean booleanValue = ((Boolean) it.next()).booleanValue();
        if (!booleanValue) {
          return booleanValue;
  ...
  public String getOutgoingCallExceptionPatterns(ContextInfo contextInfo) {
    Log.d(
        "PhoneRestrictionPolicy", ">>> PhoneRestrictionPolicy.getOutgoingCallExceptionPatterns()");
    ContextInfo enforceOwnerOnlyAndPhonePermission =
        enforceOwnerOnlyAndPhonePermission(contextInfo);
    if (this.mTelMgr.isVoiceCapable()) {
      return getRestrictionPattern(
          enforceOwnerOnlyAndPhonePermission, true, "outgoingCallExceptionPattern");
    }
    return null;
  }
  ...
  public String getIncomingCallExceptionPatterns(ContextInfo contextInfo) {
    Log.d(
        "PhoneRestrictionPolicy", ">>> PhoneRestrictionPolicy.getIncomingCallExceptionPatterns()");
    ContextInfo enforceOwnerOnlyAndPhonePermission =
        enforceOwnerOnlyAndPhonePermission(contextInfo);
    if (this.mTelMgr.isVoiceCapable()) {
      return getRestrictionPattern(
          enforceOwnerOnlyAndPhonePermission, true, "incomingCallExceptionPattern");
    }
    return null;
  }
  ...
  public boolean addOutgoingCallExceptionPattern(ContextInfo contextInfo, String str) {
    ...
    return setOutgoingCallExceptionPattern(
        contextInfo, outgoingCallExceptionPatterns.concat("|").concat(removeWhiteSpaces(str)));
  }
  ...
  public boolean addIncomingCallExceptionPattern(ContextInfo contextInfo, String str) {
    ...
    return setIncomingCallExceptionPattern(
        contextInfo, incomingCallExceptionPatterns.concat("|").concat(removeWhiteSpaces(str)));
  }
  ...
  public String getOutgoingSmsExceptionPatterns(ContextInfo contextInfo) {
    ...
    if (this.mTelMgr.isVoiceCapable()) {
      return getRestrictionPattern(
          enforceOwnerOnlyAndPhonePermission, true, "outgoingSmsExceptionPattern");
    }
    return null;
  }
  ...
  public String getIncomingSmsExceptionPatterns(ContextInfo contextInfo) {
    ...
    if (this.mTelMgr.isVoiceCapable()) {
      return getRestrictionPattern(
          enforceOwnerOnlyAndPhonePermission, true, "incomingSmsExceptionPattern");
    }
    return null;
  }
  ...
  public boolean removeOutgoingSmsExceptionPattern(ContextInfo contextInfo) {
    Log.d(
        "PhoneRestrictionPolicy", ">>> PhoneRestrictionPolicy.removeOutgoingSmsExceptionPattern()");
  ...
  public boolean removeIncomingSmsExceptionPattern(ContextInfo contextInfo) {
    Log.d(
        "PhoneRestrictionPolicy", ">>> PhoneRestrictionPolicy.removeIncomingSmsExceptionPattern()");
  ...
  public boolean addOutgoingSmsExceptionPattern(ContextInfo contextInfo, String str) {
    ...
    return setOutgoingSmsExceptionPattern(
        contextInfo, outgoingSmsExceptionPatterns.concat("|").concat(removeWhiteSpaces(str)));
  }
  ...
  public boolean addIncomingSmsExceptionPattern(ContextInfo contextInfo, String str) {
    ...
    return setIncomingSmsExceptionPattern(
        contextInfo, incomingSmsExceptionPatterns.concat("|").concat(removeWhiteSpaces(str)));
  }
  ...
  public final void notifySmsPatternCheck() {
    Intent intent =
        new Intent("com.samsung.android.knox.intent.action.REQUEST_SMS_PATTERN_CHECK_INTERNAL");
  ...
  public boolean isSmsPatternCheckRequired() {
    List<ContentValues> valuesList =
        this.mEdmStorageProvider.getValuesList(
            "PHONERESTRICTION", new String[] {"adminUid", "smsRestrictionIncomingPattern"});
    if (valuesList != null && !valuesList.isEmpty()) {
      for (ContentValues contentValues : valuesList) {
        if (contentValues.getAsInteger("adminUid") != null
            && !TextUtils.isEmpty(contentValues.getAsString("smsRestrictionIncomingPattern"))) {
          return true;
        }
      }
    }
    List<ContentValues> valuesList2 =
        this.mEdmStorageProvider.getValuesList(
            "PHONERESTRICTION", new String[] {"adminUid", "smsRestrictionOutgoingPattern"});
    ...
    for (ContentValues contentValues2 : valuesList2) {
      if (contentValues2.getAsInteger("adminUid") != null
          && !TextUtils.isEmpty(contentValues2.getAsString("smsRestrictionOutgoingPattern"))) {
        return true;
      }
    }
    return false;
  ...
  public synchronized int lockUnlockCorporateSimCard(
    ...
    if (TextUtils.isEmpty(str)) {
      SubscriptionInfo activeSubscriptionInfo =
          this.mSubMgr.getActiveSubscriptionInfo(SubscriptionManager.getDefaultSubscriptionId());
  ...
  public final void logError(int i) {
    ...
    switch (i) {
      ...
      case 11:
        Log.e(
            "PhoneRestrictionPolicy", "lockUnlockCorporateSimCard Sim pin already locked by admin");
        break;
      case 12:
        Log.e(
            "PhoneRestrictionPolicy", "lockUnlockCorporateSimCard Sim pin owned by another admin");
        break;
      case 13:
  ...
  */
  public final synchronized void unlockAllSimCards() {
    ...
    if (this.mSimDbProxy.hasAnySimcard()) {
      List<SubscriptionInfo> activeSubscriptionInfoList =
          this.mSubMgr.getActiveSubscriptionInfoList();
      boolean z = false;
      if (activeSubscriptionInfoList != null) {
        ...
        for (SubscriptionInfo subscriptionInfo : activeSubscriptionInfoList) {
          ...
          boolean z3 =
              TelephonyManager.getSimStateForSlotIndex(subscriptionInfo.getSimSlotIndex()) == 2;
          int subscriptionId = subscriptionInfo.getSubscriptionId();
          Log.d(
              "PhoneRestrictionPolicy",
              "unlockAllSimCards Got iccId = " + iccId + " for subscriptionId = " + subscriptionId);
          boolean isSimLockedByAdmin = isSimLockedByAdmin(subscriptionInfo.getIccId());
          if (iccId != null && z3 && isSimLockedByAdmin) {
            String pinCode = getPinCode(iccId);
            if (pinCode != null) {
              supplyPinReportResultForSubscriber(pinCode, subscriptionId);
            }
          }
        }
        z = z2;
      } else {
        Log.d("PhoneRestrictionPolicy", "unlockAllSimCards subInfoList list is null");
      }
      getKeyguardManager();
      if (z
          && (keyguardManager = this.mKeyguardManager) != null
          && !keyguardManager.isKeyguardLocked()) {
        this.mContext.sendBroadcast(
            new Intent("com.samsung.android.knox.intent.action.DO_KEYGUARD_INTERNAL"));
      }
    }
  }
  ...
  public final boolean validatePinCode(String str) {
  ...
  public final void setLockedIccIdsSystemUI(int i) {
    ...
    try {
      SystemUIAdapter.getInstance(this.mContext)
          .setLockedIccIdsAsUser(i, this.mSimDbProxy.getIccIdListByAdmin());
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
  }
  ...
  public boolean setDisclaimerText(ContextInfo contextInfo, String str) {
    ...
    if (str != null && str.length() > 60) {
      Log.d(
          "PhoneRestrictionPolicy",
          ">>> PhoneRestrictionPolicy.setDisclaimerText() was failed - text is over 60 char");
      return false;
    }
    if (disclaimerText != null) {
      ...
      Log.d(
          "PhoneRestrictionPolicy",
          ">>> PhoneRestrictionPolicy.setDisclaimerText() was failed - other admin already set"
              + " text");
      return false;
    }
    return this.mEdmStorageProvider.putString(
        enforceOwnerOnlyAndPhonePermission.mCallerUid, "PHONERESTRICTION", "disclaimerText", str);
  }
  ...
  public String getDisclaimerText(ContextInfo contextInfo) {
    ...
    for (String str :
        this.mEdmStorageProvider.getStringList("PHONERESTRICTION", "disclaimerText")) {
      if (str != null) {
        return str;
      }
    }
  ...
  public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
    if (this.mContext.checkCallingOrSelfPermission("android.permission.DUMP") != 0) {
      printWriter.println(
          "Permission Denial: can't dump " + PhoneRestrictionPolicy.class.getSimpleName());
      return;
    }
    new EnterpriseDumpHelper(this.mContext)
        .dumpTable(printWriter, "SimTable", new String[] {"adminUid", "SimIccId"});
    for (int i = 0; i < 2; i++) {
      printWriter.write(
          "RCSEnabled for sim slot "
              + i
              + ": "
              + isRCSEnabledBySimSlot(null, 1, false, i)
  ...
  public int setRCSEnabledBySimSlot(ContextInfo contextInfo, int i, boolean z, int i2) {
    ...
    if (i2 != 0 && i2 != 1) {
      Log.i(
          "PhoneRestrictionPolicy", "setRCSEnabledBySimSlot(): failed. invalid simSlotId : " + i2);
      return -1;
    }
    return setRcsEnabledInternal(
  ...
  public final int setRcsEnabledInternal(ContextInfo contextInfo, int i, boolean z, String str) {
    ...
    if (!isRCSFeature(i)) {
      Log.i(
          "PhoneRestrictionPolicy", "setRCSEnabledInternal(): failed. not support feature = " + i);
      return -1;
    }
    ...
    try {
      z2 =
          this.mEdmStorageProvider.putInt(
              contextInfo.mCallerUid, "PHONERESTRICTION", str, z ? i | i3 : (~i) & i3);
    } catch (Exception e) {
  ...
  public final boolean isRCSEnabledInternal(int i, boolean z, String str) {
    Log.i(
        "PhoneRestrictionPolicy", "isRCSEnabledInternal(), showMsg: " + z + ", columnName: " + str);
    if (!isRCSFeature(i)) {
      Log.i(
          "PhoneRestrictionPolicy", "isRCSEnabledInternal(): allowed. not support feature = " + i);
      return true;
    }
    if (getEmergencyCallOnly(null, true)) {
      if (z) {
  ...
  public final boolean updateDataSimSlotValueSystemUI(int i, boolean z) {
    ...
    SubscriptionInfo activeSubscriptionInfo =
        this.mSubMgr.getActiveSubscriptionInfo(SubscriptionManager.getDefaultDataSubscriptionId());
    if (activeSubscriptionInfo != null) {
      int callingUserId = UserHandle.getCallingUserId();
  ...
  public final boolean isOperationAllowed(int i, int i2) {
    if (i2 != 0 && i2 != 1) {
      Log.d(
          "PhoneRestrictionPolicy",
          ">>> PhoneRestrictionPolicy.isOperationAllowed() was failed - SlotID is invalid " + i2);
      return true;
    }
    ...
    while (!cursor.isAfterLast()) {
      try {
        try {
          Log.d(
              "PhoneRestrictionPolicy",
              ">>> PhoneRestrictionPolicy.isOperationAllowed() - dB have some valid values");
          boolean z2 = false;
          if (i == 1) {
            Log.d(
                "PhoneRestrictionPolicy",
  ...
  public int allowDataNetworkFromSimSlot(ContextInfo contextInfo, int i, boolean z) {
    int dynamicSimControl =
        setDynamicSimControl(enforceOwnerOnlyAndSimRestrictionPermission(contextInfo), i, 1, z);
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final int setDynamicSimControl(ContextInfo contextInfo, int i, int i2, boolean z) {
    Log.d(
        "PhoneRestrictionPolicy",
        "setDynamicSimControl >>> slotNum: " + i + " function: " + i2 + " state: " + z);
    boolean z2 = true;
    if (i != 0 && i != 1) {
      Log.d(
          "PhoneRestrictionPolicy",
          ">>> PhoneRestrictionPolicy.setDynamicSimControl() was failed - SlotID is invalid");
      return -1;
    }
    TelephonyManager telephonyManager = (TelephonyManager) this.mContext.getSystemService("phone");
    ContentValues contentValues = new ContentValues();
    List<SubscriptionInfo> activeSubscriptionInfoList =
        this.mSubMgr.getActiveSubscriptionInfoList();
    if (activeSubscriptionInfoList == null) {
      Log.d("PhoneRestrictionPolicy", "CurrentSims list is null");
      return -2;
    }
    boolean z3 = true;
    int i3 = 0;
    while (true) {
      ...
      if (simSlotIndex == i) {
        ...
        if (!z
            && SubscriptionManager.getDefaultDataSubscriptionId() == subscriptionId
            && i2 == 1
            && telephonyManager != null
            && telephonyManager.getDataEnabled()) {
          Log.d(
              "PhoneRestrictionPolicy",
              "Current Sim " + simSlotIndex + "is request for Data Block");
          telephonyManager.setDataEnabled(false);
          if (telephonyManager.isNetworkRoaming()) {
            Log.d("PhoneRestrictionPolicy", "Current Sim " + simSlotIndex + " is on roaming.");
        ...
        Log.d(
            ...
            "Current Sim is "
                + simSlotIndex
                + ". Requested block Sim is not present in SlotId"
                + i);
        i3++;
        z3 = false;
      }
    ...
    if (i2 == 1) {
      contentValues.put("allowData", Boolean.valueOf(z));
    }
    if (i2 == 2) {
      contentValues.put("allowIncomingCall", Boolean.valueOf(z));
    }
    if (i2 == 3) {
      contentValues.put("allowOutgoingCall", Boolean.valueOf(z));
    }
    if (i2 == 4) {
      contentValues.put("allowIncomingSMS", Boolean.valueOf(z));
    }
    if (i2 == 5) {
      contentValues.put("allowOutgoingSMS", Boolean.valueOf(z));
    }
    if (i2 == 6) {
      contentValues.put("allowMMS", Boolean.valueOf(z));
    }
    ContentValues contentValues2 = new ContentValues();
    contentValues2.put("adminUid", Integer.valueOf(contextInfo.mCallerUid));
    contentValues2.put("slotId", Integer.valueOf(i));
    if (z3) {
      try {
        if (this.mEdmStorageProvider.put(
            "PHONERESTRICTION_SLOTID", contentValues, contentValues2)) {
          if (i2 == 6) {
            Intent intent = new Intent("com.samsung.knox.action.KNOX_MMS_CONTROL");
            intent.putExtra("setPhoneId", i);
            intent.putExtra("setMmsControlFlag", z);
            this.mContext.sendBroadcast(intent);
            Log.d(
                "PhoneRestrictionPolicy",
                "setDynamicSimControl >>> sendBroadcast: com.samsung.knox.action.KNOX_MMS_CONTROL");
            Log.d("PhoneRestrictionPolicy", "setPhoneId: " + i + ", setMmsControlFlag: " + z);
          }
          return !z2 ? 0 : -2;
        }
      } catch (Exception e) {
        Log.i(
            "PhoneRestrictionPolicy",
            "setDynamicSimControl(): failed. unexpected exception - dB error",
            e);
        return -4;
      }
    }
