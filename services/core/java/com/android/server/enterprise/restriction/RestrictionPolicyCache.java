...
public class RestrictionPolicyCache {
    ...
    if (cursor != null) {
      ...
      try {
        try {
          ...
          Log.e(
              "RestrictionPolicy", "Exception occurred accessing Enterprise db " + e.getMessage());
        }
      } finally {
        this.mLock.writeLock().unlock();
        cursor.close();
  ...
  public void update(String str, long j, boolean z, int i, Integer num, Boolean bool) {
    ...
    Long valueOf;
    Iterator it =
        this.mEdmStorageProvider.getBooleanListAsUser(0, "RESTRICTION", str, i).iterator();
    while (true) {
      if (!it.hasNext()) {
        z2 = z;
        break;
      ...
      try {
        ...
        if (bool != null && num != null) {
          ...
          if (!this.mApplyingAdmins.isAdminInfoPresent(num.intValue())) {
            this.mApplyingAdmins.loadAdminInfo(
                num.intValue(), getPackageNameForUid(num.intValue()));
          }
        }
      } finally {
        this.mLock.writeLock().unlock();
  ...
  public List getAdminAppLabelListAsUserForMask(long j, int i) {
    ...
    for (Integer num :
        (Set)
            ((Map) this.mApplyingAdmins.admins.get(Integer.valueOf(i)))
                .getOrDefault(Long.valueOf(j), null)) {
      ...
      if (str != null) {
        ...
        try {
          try {
                ...
                this.mPackageManager
                    .getApplicationLabel(
                        this.mPackageManager.getApplicationInfoAsUser(
                            str, 0, UserHandle.getUserId(num.intValue())))
                    .toString();
            ...
            Log.e(
                "RestrictionPolicy",
                String.format("Package(%s) name not found for user %d", str, Integer.valueOf(i)));
          } catch (Exception unused2) {
            Log.e(
                "RestrictionPolicy",
                String.format(
                    "Admin(%s) app label not found for user %d", str, Integer.valueOf(i)));
          }
        } finally {
  ...
  public final String getPackageNameForUid(int i) {
    String string;
    if (i == 1000
        || (string = this.mEdmStorageProvider.getString(i, "ADMIN_INFO", "adminName")) == null) {
      return null;
    }
  ...
  public class ApplyingAdmins {
      ...
      this.adminInfoMap
          ...
          .removeIf(
              new Predicate() { // from class:
                                // com.android.server.enterprise.restriction.RestrictionPolicyCache$ApplyingAdmins$$ExternalSyntheticLambda1
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$init$0;
                  lambda$init$0 =
                      RestrictionPolicyCache.ApplyingAdmins.lambda$init$0(i, (Map.Entry) obj);
    ...
    public void remove(final int i) {
      ...
      this.adminInfoMap
          ...
          .removeIf(
              new Predicate() { // from class:
                                // com.android.server.enterprise.restriction.RestrictionPolicyCache$ApplyingAdmins$$ExternalSyntheticLambda0
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$remove$1;
                  lambda$remove$1 =
                      RestrictionPolicyCache.ApplyingAdmins.lambda$remove$1(i, (Map.Entry) obj);
      ...
      if (!((Map) this.admins.get(Integer.valueOf(i))).containsKey(Long.valueOf(j))) {
        Log.d(
            ...
            "No need to update admin cache for mask : "
                + ((String) RestrictionPolicyCache.MASK_AND_COLUMN_NAME.get(Long.valueOf(j)))
                + "("
                + num
                + ")");
        return;
    ...
    public String dump(int i, long j) {
      return (this.admins.containsKey(Integer.valueOf(i))
              && ((Map) this.admins.get(Integer.valueOf(i))).containsKey(Long.valueOf(j)))
          ? ((Set) ((Map) this.admins.get(Integer.valueOf(i))).get(Long.valueOf(j))).toString()
          : "";
    }
