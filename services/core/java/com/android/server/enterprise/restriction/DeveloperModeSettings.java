        ...
        public final Object doInBackground(Object[] objArr) {
            try {
                Log.d(
                        ...
                        "Start System Poker - ServiceManager.listServices()");
    ...
    */
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.enterprise.restriction.DeveloperModeSettings.isShowingScreenUpdateAndReloadSurface():boolean");
    }
    ...
    public final boolean resetMockLocationApps() {
        ...
        List<AppOpsManager.PackageOps> packagesForOps =
                appOpsManager.getPackagesForOps(new int[] {58});
            ...
            if (((AppOpsManager.OpEntry) packageOps.getOps().get(0)).getMode() != 2) {
                ...
                try {
                    appOpsManager.setMode(
                            ...
                            this.mContext
                                    .getPackageManager()
                                    .getApplicationInfo(packageName, 512)
                                    .uid,
                            packageName,
                            2);
