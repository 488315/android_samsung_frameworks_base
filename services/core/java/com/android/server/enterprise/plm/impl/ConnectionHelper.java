...
public class ConnectionHelper extends Handler {
  ...
  /* renamed from: com.android.server.enterprise.plm.impl.ConnectionHelper$1 */
  public class ServiceConnectionC14561 implements ServiceConnection {
    public ServiceConnectionC14561() {}

    @Override // android.content.ServiceConnection
    public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
      ConnectionHelper.this.post(
          new Runnable() { // from class:
                           // com.android.server.enterprise.plm.impl.ConnectionHelper$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              ConnectionHelper.ServiceConnectionC14561.this.lambda$onServiceConnected$2(
    ...
    public /* synthetic */ void lambda$onServiceConnected$2(
        final ComponentName componentName, IBinder iBinder) {
      try {
        ...
        connectionHelper.mProcessId =
            connectionHelper.getPidFromPackageName(connectionHelper.mPackageName);
        if (ConnectionHelper.this.mBinder != null) {
          ...
          ConnectionHelper.this.mBinder.linkToDeath(
              new IBinder
                  .DeathRecipient() { // from class:
                                      // com.android.server.enterprise.plm.impl.ConnectionHelper$1$$ExternalSyntheticLambda2
                @Override // android.os.IBinder.DeathRecipient
                public final void binderDied() {
                  ConnectionHelper.ServiceConnectionC14561.this.lambda$onServiceConnected$1(
                      componentName);
                }
              },
              0);
    ...
    public /* synthetic */ void lambda$onServiceConnected$1(final ComponentName componentName) {
      ConnectionHelper.this.post(
          new Runnable() { // from class:
                           // com.android.server.enterprise.plm.impl.ConnectionHelper$1$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              ConnectionHelper.ServiceConnectionC14561.this.lambda$onServiceConnected$0(
                  componentName);
            }
          });
    }
    ...
    public void onServiceDisconnected(final ComponentName componentName) {
      ConnectionHelper.this.post(
          new Runnable() { // from class:
                           // com.android.server.enterprise.plm.impl.ConnectionHelper$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              ConnectionHelper.ServiceConnectionC14561.this.lambda$onServiceDisconnected$3(
                  componentName);
            }
          });
    }
  ...
  public ConnectionHelper(
      Context context, String str, String str2, ConnectionStateListener connectionStateListener) {
    super(Looper.myLooper());
    this.mConnection = new ServiceConnectionC14561();
    this.mBindRetryRunnable =
        new Runnable() { // from class: com.android.server.enterprise.plm.impl.ConnectionHelper.2
          @Override // java.lang.Runnable
          public void run() {
            Log.i(
                ConnectionHelper.TAG,
                "(*) retry bind to service " + ConnectionHelper.this.mClassName);
            if (ConnectionHelper.this.mBinder == null) {
              ConnectionHelper connectionHelper = ConnectionHelper.this;
              ...
              if (i >= 0) {
                Log.e(
                    ConnectionHelper.TAG,
                    "timeout expired, keep retrying... ("
                        + ConnectionHelper.this.mBindCounter
                        + ")");
            ...
            if (ConnectionHelper.this.mBinder != null) {
              Log.i(
                  ConnectionHelper.TAG,
                  "bind timeout expired, but already bound to service "
                      + ConnectionHelper.this.mClassName);
            } else {
  ...
  public void clear() {
    post(
        new Runnable() { // from class:
                         // com.android.server.enterprise.plm.impl.ConnectionHelper$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final boolean bindService(final boolean z) {
    post(
        new Runnable() { // from class:
                         // com.android.server.enterprise.plm.impl.ConnectionHelper$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
