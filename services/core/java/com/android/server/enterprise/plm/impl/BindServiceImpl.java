...
public class BindServiceImpl extends KeepAliveImpl {
  ...
  public boolean start() {
    if (!Utils.hasService(
        this.mContext,
        this.mProcessContext.getPackageName(),
        this.mProcessContext.getServiceName())) {
    ...
    if (this.mConnectionHelper == null) {
      this.mConnectionHelper =
          new ConnectionHelper(
              ...
              this.mProcessContext.getServiceName(),
              new ConnectionHelper
                  .ConnectionStateListener() { // from class:
                                               // com.android.server.enterprise.plm.impl.BindServiceImpl.1
                ...
                public void onConnect() {
                  if (BindServiceImpl.this.mObserver != null) {
                    BindServiceImpl.this.mObserver.sendEmptyMessage(
                        BindServiceImpl.this.mAliveEvent);
                  }
                }
                ...
                public void onDisconnect() {
                  if (BindServiceImpl.this.mObserver != null) {
                    BindServiceImpl.this.mObserver.sendEmptyMessage(
                        BindServiceImpl.this.mDeathEvent);
                  }
                }
              });
    }
