...
public class BrowserPolicy extends IBrowserPolicy.Stub implements EnterpriseServiceCallback {
    ...
    public static final String[] SBROWSER_PROJECTION = {KnoxCustomManagerService.f1773ID, "url", KnoxCustomManagerService.SHORTCUT_TITLE, "favicon", "editable"};
    ...
    */
    public boolean setHttpProxy(ContextInfo contextInfo, String str) {
        ...
        if (!((HashMap) this.mCache.get(Integer.valueOf(userId))).containsKey(Integer.valueOf(i2))) {
            ((HashMap) this.mCache.get(Integer.valueOf(userId))).put(Integer.valueOf(i2), new BrowserProxyCache(userId, i2));
        }
        try {
            browserProxyCache = (BrowserProxyCache) ((HashMap) this.mCache.get(Integer.valueOf(userId))).get(Integer.valueOf(i2));
        } catch (Exception e) {
    ...
    public final List getUrlBlackList(ContextInfo contextInfo, boolean z) {
        ...
        if (!z) {
            Cursor cursorByAdmin = this.mEdmStorageProvider.getCursorByAdmin("WebFilterTable", i, i2, strArr);
            try {
            ...
            new ArrayList();
            List valuesListAsUser = this.mEdmStorageProvider.getValuesListAsUser(i2, "WebFilterTable", strArr, callingOrCurrentUserId);
            if (valuesListAsUser == null) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean addBookmarkToChrome(ContentResolver contentResolver, String str, String str2) {
        Uri uri;
        Uri uri2;
        boolean z;
        long clearCallingIdentity = Binder.clearCallingIdentity();
                ...
                if (count == 0) {
                    ...
                    if (str != null || str2 == null) {
                        ...
                        try {
                            ...
                            Log.e("BrowserPolicy", " updateBookmarks : insert bookmark items to db. Exception - " + e.getMessage());
                            uri2 = null;
                        }
                    }
                    if (uri2 == null) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean addBookmarkToAndroidBrowser(ContentResolver contentResolver, String str, String str2, Bitmap bitmap) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean removeBookmarkFromAndroidBrowser(ContentResolver contentResolver, String str, String str2) {
        Cursor query;
        long clearCallingIdentity = Binder.clearCallingIdentity();
        Cursor cursor = null;
        try {
            try {
                query = contentResolver.query(Browser.BOOKMARKS_URI, Browser.HISTORY_PROJECTION, "url = ? AND title = ?", new String[]{str, str2}, null);
            } catch (Throwable th) {
                th = th;
            }
        } catch (IllegalArgumentException unused) {
