...
public class RuleParser {
  ...
  public ArrayList getProcessProcList() {
    if (this.mProcessProcList.size() <= 0
        || this.mProcessProcList.size() != this.mProcessProcLength) {
      Log.e(
          TAG,
          "Invalid process proc : " + this.mProcessProcList.size() + "/" + this.mProcessProcList);
      return null;
    }
