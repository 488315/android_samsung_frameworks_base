...
public class LicenseLogService extends Binder implements EnterpriseServiceCallback {
  ...
  public BroadcastReceiver mReceiver =
      new BroadcastReceiver() { // from class:
                                // com.android.server.enterprise.license.LicenseLogService.1
  ...
  public final void _log(String str, int i, boolean z, boolean z2, int i2, boolean z3, int i3) {
    ...
    try {
      ...
      if (service != null && service.isAllowedMamPackage(packageNameForUid)) {
        Log.d(
            "LicenseLogService", "skip _log - caller: " + packageNameForUid + ", apiName: " + str);
        return;
      }
      if (Utils.isPlatformSignedApp(this.mContext, packageNameForUid, i)
          || ((enterpriseLicenseService = mLicenseService) != null
              && enterpriseLicenseService.getLicenseInfoByAdmin(packageNameForUid) != null)) {
    ...
    try {
      ...
      List<ContentValues> valuesList =
          mEdmStorageProvider.getValuesList(
              "LICENSE_LOG", new String[] {"date", "id", "value"}, contentValues);
  ...
  public static boolean deleteLog(String str) {
    return mEdmStorageProvider.deleteDataByFields(
    ...
    public void handleMessage(Message message) {
      if (message != null) {
        ...
        if (i == 1) {
          ...
          LicenseLogService.this._log(
              data.getString("apiName"),
              data.getInt("adminUid"),
              data.getBoolean(EventQueue.API_USAGE_GET_KEY),
              data.getBoolean("isOldNamespace"),
              data.getInt("profileUserId"),
              data.getBoolean("parent"),
              data.getInt("dalessCallerPackage"));
        }
      }
    }
  }
  ...
  public final void handleLicenseLogCleanNotification() {
    ...
    try {
      try {
        ...
        j = timeInMillis + BackupManagerConstants.DEFAULT_FULL_BACKUP_INTERVAL_MILLISECONDS;
      } catch (Exception e) {
