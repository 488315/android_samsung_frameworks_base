...
public class VpnInfoPolicy extends IVpnInfoPolicy.Stub implements EnterpriseServiceCallback {
  ...
  public final ContextInfo enforceVpnPermission(ContextInfo contextInfo) {
    return getEDM()
        .enforceActiveAdminPermissionByContext(
            contextInfo,
            new ArrayList(Arrays.asList("com.samsung.android.knox.permission.KNOX_VPN")));
  }
  ...
  public synchronized boolean setId(ContextInfo contextInfo, String str, String str2) {
    ...
    try {
      if (!TextUtils.isEmpty(str)) {
        ...
        ArrayList retrieveVpnListFromStorage = retrieveVpnListFromStorage();
        if (retrieveVpnListFromStorage != null
            && retrieveVpnListFromStorage.size() > 0
            && (vpnProfile = (VpnProfile) retrieveVpnListFromStorage.get(profileIndexFromName))
                != null
            && !TextUtils.isEmpty(str2)
            && (decode = decode(str2, vpnProfile.encode(true))) != null
            && !checkDuplicateName(decode, profileIndexFromName)) {
          replaceProfile(enforceOwnerOnlyAndVpnPermission, profileIndexFromName, decode);
          contentValues.put(
              "adminUid", Integer.valueOf(enforceOwnerOnlyAndVpnPermission.mCallerUid));
          contentValues.put("VpnID", decode.key);
          return this.mEDMStorageProvider.putDataByFields(
              "VPN",
              new String[] {"adminUid", "VpnID"},
              new String[] {
                String.valueOf(enforceOwnerOnlyAndVpnPermission.mCallerUid), decode.key
              },
              contentValues);
        }
      }
      ...
      if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str)) {
        ...
        if (retrieveVpnListFromStorage != null
          ...
          if (alwaysOnProfile == null
              || !alwaysOnProfile.equals(str)
              || isValidAlwaysOnProfile(vpnProfile)) {
            replaceProfile(enforceOwnerOnlyAndVpnPermission, profileIndexFromName, vpnProfile);
            return true;
          }
        }
      ...
      try {
        ...
        if (retrieveVpnListFromStorage != null
          ...
          return this.mEDMStorageProvider.putDataByFields(
              ...
              new String[] {"adminUid", "VpnID"},
              new String[] {
                String.valueOf(enforceOwnerOnlyAndVpnPermission.mCallerUid), vpnProfile.key
              },
              contentValues);
        }
      } catch (Exception e) {
  ...
  public synchronized String getState(ContextInfo contextInfo, String str) {
    ...
    try {
      ...
      String name =
          legacyVpnInfo != null
              ? getName(enforceOwnerOnlyAndVpnPermission, legacyVpnInfo.key)
              : null;
      ...
      return i != 0
          ? i != 1
              ? i != 2
                  ? i != 3 ? i != 4 ? i != 5 ? "IDLE" : "FAILED" : "TIMEOUT" : "CONNECTED"
                  : "CONNECTING"
              : "INITIALIZING"
          : "DISCONNECTED";
    } catch (Exception e) {
  ...
  public synchronized String getUserName(ContextInfo contextInfo, String str) {
    ...
    enforceOwnerOnlyAndVpnPermission(contextInfo);
    if (!TextUtils.isEmpty(str)
        && (retrieveVpnListFromStorage = retrieveVpnListFromStorage()) != null
        && retrieveVpnListFromStorage.size() > 0) {
      Iterator it = retrieveVpnListFromStorage.iterator();
      while (it.hasNext()) {
        VpnProfile vpnProfile = (VpnProfile) it.next();
  ...
  public synchronized boolean deleteProfile(ContextInfo contextInfo, String str) {
    ArrayList retrieveVpnListFromStorage;
    ContextInfo enforceOwnerOnlyAndKnoxVpnPermission =
  ...
  public synchronized boolean setL2TPSecret(
  ...
  public synchronized boolean setEncryptionEnabledForPPTP(
    ...
    if (retrieveVpnListFromStorage == null
        || retrieveVpnListFromStorage.size() <= 0
        || (vpnProfile = (VpnProfile) retrieveVpnListFromStorage.get(profileIndexFromName)) == null
        || vpnProfile.type != 0) {
      return false;
    }
    vpnProfile.mppe = z;
  ...
  public synchronized boolean createProfile(
    ...
    if (!TextUtils.isEmpty(str)
      ...
      while (true) {
        ...
        if (vpnProfile.name.equals(str)) {
          ...
          try {
            replaceProfile(
                enforceOwnerOnlyAndVpnPermission, getProfileIndexFromName(str), vpnProfile);
            return true;
          } catch (Exception unused) {
  ...
  public boolean isOnlySecureConnectionsAllowed(ContextInfo contextInfo) {
    ...
    return this.mEDMStorageProvider
        .getBooleanList("RESTRICTION", "allowOnlySecureVPN")
  ...
  public boolean checkRacoonSecurity(ContextInfo contextInfo, String[] strArr) {
    ...
    boolean isOnlySecureConnectionsAllowed =
        isOnlySecureConnectionsAllowed(enforceVpnPermission(contextInfo));
    boolean z = true;
    if (isOnlySecureConnectionsAllowed) {
      ...
      if (!z) {
        RestrictionToastManager.show(17043240);
      }
    }
    return z;
  }
  ...
  */
  public boolean setAlwaysOnProfile(ContextInfo contextInfo, String str) {
    boolean releaseAlwaysOnVPNLockdown;
    ...
    if (canChangeAlwaysOn(enforceOwnerOnlyAndVpnPermission)) {
      if (str == null || TextUtils.isEmpty(str)) {
        releaseAlwaysOnVPNLockdown = releaseAlwaysOnVPNLockdown(enforceOwnerOnlyAndVpnPermission);
      } else {
        VpnProfile profileByName = getProfileByName(str);
        if (profileByName != null && isValidAlwaysOnProfile(profileByName)) {
          releaseAlwaysOnVPNLockdown =
              LegacyVpnProfileStore.put("LOCKDOWN_VPN", profileByName.key.getBytes());
          if (releaseAlwaysOnVPNLockdown) {
            ...
            try {
              AuditLog.logAsUser(
                  ...
                  String.format(
                      ...
                      Integer.valueOf(enforceOwnerOnlyAndVpnPermission.mCallerUid), str),
    ...
    try {
      AuditLog.logAsUser(
          ...
          String.format(
              ...
              Integer.valueOf(enforceOwnerOnlyAndAdvancedRestrictionPermission.mCallerUid)),
          UserHandle.getUserId(enforceOwnerOnlyAndAdvancedRestrictionPermission.mCallerUid));
      Binder.restoreCallingIdentity(clearCallingIdentity);
      return this.mEDMStorageProvider.putBoolean(
          enforceOwnerOnlyAndAdvancedRestrictionPermission.mCallerUid,
          "VPN",
  ...
  public boolean isUserSetAlwaysOnAllowed(ContextInfo contextInfo, boolean z) {
    ...
    boolean z2 =
        !this.mEDMStorageProvider
            .getBooleanList("VPN", "allowUserSetAlwaysOn")
  ...
  public boolean isUserChangeProfilesAllowed(ContextInfo contextInfo, boolean z) {
    ...
    boolean z2 =
        !this.mEDMStorageProvider
            .getBooleanList("VPN", "allowUserChangeProfiles")
            .contains(Boolean.FALSE);
    if (z && !z2) {
  ...
  public boolean allowUserAddProfiles(ContextInfo contextInfo, boolean z) {
    ...
    return this.mEDMStorageProvider.putBoolean(
        enforceOwnerOnlyAndVpnPermission(contextInfo).mCallerUid, "VPN", "allowUserAddProfiles", z);
  }
  ...
  public boolean isUserAddProfilesAllowed(ContextInfo contextInfo, boolean z) {
    ...
    boolean z2 =
        !this.mEDMStorageProvider
            .getBooleanList("VPN", "allowUserAddProfiles")
            .contains(Boolean.FALSE);
    if (z && !z2) {
  ...
  public final boolean isValidAlwaysOnProfile(VpnProfile vpnProfile) {
    return (vpnProfile == null || vpnProfile.type == 0 || !vpnProfile.isValidLockdownProfile())
        ? false
        : true;
  }
  ...
  public final boolean canChangeAlwaysOn(ContextInfo contextInfo) {
    String genericValueAsUser =
        this.mEDMStorageProvider.getGenericValueAsUser("vpnAlwaysOnProfile", 0);
    return genericValueAsUser == null
        || TextUtils.isEmpty(genericValueAsUser)
        || String.valueOf(contextInfo.mCallerUid)
            .equals(this.mEDMStorageProvider.getGenericValueAsUser("vpnAlwaysOnOwner", 0));
  }
  ...
  public final boolean saveAlwaysOnProfileToDb(ContextInfo contextInfo, String str) {
    ...
    return this.mEDMStorageProvider.putGenericValueAsUser(
            "vpnAlwaysOnOwner", String.valueOf(contextInfo.mCallerUid), 0)
        & this.mEDMStorageProvider.putGenericValueAsUser("vpnAlwaysOnProfile", str, 0);
  }
