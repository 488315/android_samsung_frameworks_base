...
public class KnoxVpnEngineService extends IKnoxVpnPolicy.Stub implements EnterpriseServiceCallback {
    ...
    public final synchronized void initializeHashtable() {
        ...
        try {
            ...
            if (dataByFields != null && dataByFields.size() > 0) {
                boolean z = DBG;
                if (z) {
                    Log.d("KnoxVpnEngineService", "initializeHashtable : VPN INFO: New Framework is enabled. Set the system property");
                }
                SystemProperties.set("net.vpn.framework", "2.0");
                if (z) {
                ...
                while (it.hasNext()) {
                    ...
                    try {
                        ...
                        Log.e("KnoxVpnEngineService", "profileID exception when DB migration on OS upgrade" + Log.getStackTraceString(e));
                    }
                    ...
                    if (asString != null) {
                        ...
                        if (profileEntry3 != null) {
                            if (z2) {
                                Log.d("KnoxVpnEngineService", "initializeHashtable :  ProfileName found in map. Add to the list.");
                            }
                            ...
                            profileEntry3.setProxyUsername(this.mKnoxVpnHelper.retrieveProfileCredentials(asString, "proxy-username"));
                            profileEntry3.setProxyPassword(this.mKnoxVpnHelper.retrieveProfileCredentials(asString, "proxy-password"));
                            profileEntry3.setPacurl(asString5);
                            profileEntry3.setPacAuthRequired(intValue9);
                            if (profileEntry3.getProxyUsername() != null && profileEntry3.getProxyPassword() != null) {
                            ...
                            String ipChainNameAfterUpgrade = this.mKnoxVpnHelper.getIpChainNameAfterUpgrade(asString);
                            Log.d("KnoxVpnEngineService", "IPChain name is being set as " + ipChainNameAfterUpgrade + " for profile " + asString + " after device upgrade from O to P");
                            ...
                            Log.d("KnoxVpnEngineService", "initializeHashtable :  profileName is not exist in vpnConfig");
                        }
                    }
                    it = it2;
                }
            ...
            Log.e("KnoxVpnEngineService", "init :  Exception when reading Profile DB:" + Log.getStackTraceString(e2));
        }
        try {
            ArrayList dataByFields2 = this.mVpnStorageProvider.getDataByFields("VpnPackageInfo", null, null, null);
            if (dataByFields2 != null) {
                ...
                while (it3.hasNext()) {
                    ...
                    if (DBG) {
                        Log.d("KnoxVpnEngineService", "initializeHashtable :  Cid : " + intValue13 + "Uid:" + intValue12 + " Profile:" + asString7 + " packageName:" + asString8);
                    }
                    if (intValue12 == -2) {
                        if (asString8.equalsIgnoreCase(this.mKnoxVpnHelper.getPersonifiedName(intValue13, "ADD_ALL_PACKAGES")) && (profileEntry = this.vpnConfig.getProfileEntry(asString7)) != null) {
                            profileEntry.addPackageEntry(asString8, intValue12, intValue13);
                        }
                    } else if (intValue12 > -1 && (profileEntry2 = this.vpnConfig.getProfileEntry(asString7)) != null) {
                        if (this.mKnoxVpnHelper.isPackageInstalled(this.mKnoxVpnHelper.getRegularPackageName(asString8), profileEntry2.getPersonaId())) {
            ...
            Log.e("KnoxVpnEngineService", "init2 :  Exception when reading package DB:" + Log.getStackTraceString(e3));
        }
        try {
            ArrayList dataByFields3 = this.mVpnStorageProvider.getDataByFields("VpnNotificationTable", null, null, null);
            if (dataByFields3 != null) {
                Iterator it4 = dataByFields3.iterator();
                while (it4.hasNext()) {
                    ContentValues contentValues3 = (ContentValues) it4.next();
                    this.notificationFlagState.put(Integer.valueOf(contentValues3.getAsInteger("notificationUserId").intValue()), Integer.valueOf(contentValues3.getAsInteger("dismissFlag").intValue()));
                }
            }
        } catch (Exception e4) {
            Log.e("KnoxVpnEngineService", "init2 :  Exception when reading Notification DB:" + Log.getStackTraceString(e4));
        }
        if (DBG) {
            printProfileVpnMap();
        }
        ...
        try {
            for (VpnProfileInfo vpnProfileInfo : this.vpnConfig.getProfileEntries()) {
                ...
                if (getBinderInterfaceForProfile(profileName) == null) {
                    Log.d("KnoxVpnEngineService", "runAllVpnService:binder value is null for the profile " + profileName);
                } else {
                    int vPNTransitionState = getVPNTransitionState(profileName);
                    boolean z = DBG;
                    if (z) {
                        Log.d("KnoxVpnEngineService", "run all vpn : profileName " + profileName + " state : " + vPNTransitionState);
                    }
    ...
    */
    public final synchronized void handleActionClearData(Bundle bundle) {
        ...
        String personifiedName = this.mKnoxVpnHelper.getPersonifiedName(UserHandle.getUserId(i), packageNameForUid);
        ...
        if (profileEntries != null && profileEntries.size() > 0) {
            ...
            while (true) {
                ...
                VpnProfileInfo vpnProfileInfo = (VpnProfileInfo) it.next();
                if (vpnProfileInfo != null && vpnProfileInfo.getVendorPkgName() != null && vpnProfileInfo.getVendorPkgName().equalsIgnoreCase(personifiedName)) {
                    break;
                }
            }
        }
    ...
    */
    public final synchronized void handleActionUsbTethering(Bundle bundle) {
        try {
            ...
            Log.e("KnoxVpnEngineService", "Exception occured while trying to enable usb tethering after the usb cable is attached");
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public synchronized void addVpnUidRanges(String str, int i, String str2, String str3, String str4) {
        int i2;
        int vendorUid;
        Iterator it;
        int i3;
        ...
        if (str3 == null || str4 == null) {
            ...
            for (VpnPackageInfo vpnPackageInfo : profileEntry.getPackageList()) {
                if (this.mKnoxVpnHelper.isPackageForAddAllPackages(vpnPackageInfo)) {
                    int containerIdFromPackageName = this.mKnoxVpnHelper.getContainerIdFromPackageName(vpnPackageInfo.getPackageName());
                    setDnsSystemProperty(str, this.mKnoxVpnHelper.startUid(containerIdFromPackageName), this.mKnoxVpnHelper.stopUid(containerIdFromPackageName), str2, i);
                } else {
                    int uid = vpnPackageInfo.getUid();
                    setDnsSystemProperty(str, uid, uid, str2, i);
                }
            }
            Log.d("KnoxVpnEngineService", "addVpnUidRanges:defaultInterface value to which the virual tunnel is added is " + str8 + " for the profile " + str + " with interface type " + i3 + " netId " + i);
                    ...
                    if (interfaceNameForUsbtethering != null) {
                        if (usbtetherAuth == i4) {
                            if (this.mKnoxVpnTetherAuthentication.getTetherAuthStatus()) {
                                ...
                                this.mFirewallHelper.addRulesForUsbTethering(str2, getVirtualInterfaceType(str), getVpnManagerService().getDnsServerListForInterface(str2), interfaceNameForUsbtethering, this.mKnoxVpnHelper.getNetworkPartWithMask(interfaceNameForUsbtethering));
                            } else {
            ...
            if (profileEntry.getProxyServer() == KnoxVpnConstants.DEFAULT_PROXY_SERVER || profileEntry.getPacurl() != Uri.EMPTY) {
                this.mFirewallHelper.addRulesToAcceptProxyPackets(i3, str2, UserHandle.getUid(profileEntry.getPersonaId(), 1002));
                if (profileEntry.getProxyInfo() != null) {
                    ...
                    this.mFirewallHelper.removeRulesToAllowAccessToLocalHostWithValidMark(null, profileEntry.getProxyInfo().getPort(), i3);
                    this.mFirewallHelper.addRulesToAllowAccessToLocalHostWithValidMark(str2, profileEntry.getProxyInfo().getPort(), i3);
                }
            }
            ...
            KnoxAnalyticsData knoxAnalyticsData = new KnoxAnalyticsData("KNOX_VPN", i4, "API:addVpnUidRanges");
            this.mData = knoxAnalyticsData;
        ...
        Log.d("KnoxVpnEngineService", "addVpnUidRanges:defaultInterface value to which the virual tunnel is added is " + str82 + " for the profile " + str + " with interface type " + i3 + " netId " + i);
        this.mFirewallHelper.addNatRules(str2, i3);
        this.mFirewallHelper.addIpRouteAndPolicyRules(str2, i3);
        ...
        KnoxAnalyticsData knoxAnalyticsData2 = new KnoxAnalyticsData("KNOX_VPN", i4, "API:addVpnUidRanges");
    ...
    public int getChainingEnabledForProfile(int i) {
        ...
        try {
            ...
            while (true) {
                ...
                boolean z = DBG;
                if (z) {
                    Log.d("KnoxVpnEngineService", "getChainingEnabledForProfile: uidOfVendor value is " + vpnProfileInfo.getVendorUid());
                }
                if (vpnProfileInfo.getVendorUid() == i) {
                    if (z) {
    ...
    */
    public final void updateProxyRules(final int i, final String str, final HashMap hashMap) {
        ...
        if (profileEntry != null) {
            ...
            if (i == 0) {
                getKnoxVpnPacProcessor().updatePermissionForAppsToaccessLocalHost(str, 1, profileEntry.getProxyInfo().getPort(), getKnoxVpnHelperInstance().getListOfUid(str));
                profileEntry.setProxyInfo(null);
                clearCallingIdentity = Binder.clearCallingIdentity();
                try {
                    getVpnManagerService().updateLocalProxyInfo(str, UserHandle.getUserId(vendorUid), regularPackageName, (ProxyInfo) null);
                    ...
                    Runnable runnable = new Runnable() { // from class: com.android.server.enterprise.vpn.knoxvpn.KnoxVpnEngineService.4
                        @Override // java.lang.Runnable
                        public void run() {
                            if (KnoxVpnEngineService.DBG) {
                                Log.d("KnoxVpnEngineService", "The pac configuration is being removed for the profile, update AMS" + str);
                            }
                            KnoxVpnEngineService.this.getAMSInstance().updateProxyPacConfigurationForKnoxVpn(hashMap, vendorUid, buildPacProxy, exemptPackageList);
                            if (KnoxVpnEngineService.DBG) {
                                Log.d("KnoxVpnEngineService", "The pac configuration is being removed for the profile, send default broadcast " + str);
                            }
                            KnoxVpnEngineService.this.getKnoxVpnHelperInstance().sendProxyConfigBroadcast(hashMap, vendorUid, exemptPackageList);
                            KnoxVpnEngineService.this.killRunningProcessToApplyProxy(str, hashMap, exemptPackageList);
                        }
                    };
                    KnoxVpnHandler knoxVpnHandler = this.mHandler;
                    if (knoxVpnHandler != null) {
            ...
            if (i == 1) {
                if (profileEntry.getProxyInfo() == null) {
                    ...
                    clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
                        getVpnManagerService().updateLocalProxyInfo(str, UserHandle.getUserId(vendorUid), regularPackageName, buildPacProxy2);
                        Binder.restoreCallingIdentity(clearCallingIdentity);
                    } finally {
                    }
                }
                ...
                Runnable runnable2 = new Runnable() { // from class: com.android.server.enterprise.vpn.knoxvpn.KnoxVpnEngineService.2
                    @Override // java.lang.Runnable
                    public void run() {
                        if (KnoxVpnEngineService.DBG) {
                            Log.d("KnoxVpnEngineService", "The pac configuration is being added for the profile, update AMS" + str);
                        }
                        KnoxVpnEngineService.this.getAMSInstance().updateProxyPacConfigurationForKnoxVpn(hashMap, vendorUid, proxyInfo, exemptPackageList);
                        if (KnoxVpnEngineService.DBG) {
                            Log.d("KnoxVpnEngineService", "The pac configuration is being added for the profile, send pac broadcast " + str);
                        }
                        KnoxVpnEngineService.this.getKnoxVpnHelperInstance().sendProxyConfigBroadcast(hashMap, vendorUid, exemptPackageList);
                        KnoxVpnEngineService.this.checkExistsEmailPackageInProfiles(i, hashMap, exemptPackageList);
                        KnoxVpnEngineService.this.killRunningProcessToApplyProxy(str, hashMap, exemptPackageList);
                    }
                };
            ...
            if (i != 2) {
                ...
                if (profileEntry.getProxyInfo() == null) {
                    ...
                    clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
                        getVpnManagerService().updateLocalProxyInfo(str, UserHandle.getUserId(vendorUid), regularPackageName, buildPacProxy3);
                        Binder.restoreCallingIdentity(clearCallingIdentity);
                    } finally {
                    }
                }
                ...
                Runnable runnable3 = new Runnable() { // from class: com.android.server.enterprise.vpn.knoxvpn.KnoxVpnEngineService.3
                    @Override // java.lang.Runnable
                    public void run() {
                        Log.d("KnoxVpnEngineService", "The pac configuration is being added for the application added to vpn, update AMS " + str);
                        KnoxVpnEngineService.this.getAMSInstance().updateProxyPacConfigurationForKnoxVpn(hashMap, vendorUid, proxyInfo2, exemptPackageList);
                        Log.d("KnoxVpnEngineService", "The pac configuration is being added for the application added to vpn, send pac broadcast " + str);
                        KnoxVpnEngineService.this.getKnoxVpnHelperInstance().sendProxyConfigBroadcast(hashMap, vendorUid, exemptPackageList);
                        KnoxVpnEngineService.this.checkExistsEmailPackageInProfiles(i, hashMap, exemptPackageList);
                        KnoxVpnEngineService.this.killRunningProcessToApplyProxy(str, hashMap, exemptPackageList);
                    }
            ...
            if (profileEntry.getPackageCount() == hashMap.size()) {
                if (DBG) {
                    Log.d("KnoxVpnEngineService", "The admin has removed all the apps from the profile, setting the default PAC proxy configuration");
                }
                getKnoxVpnPacProcessor().updatePermissionForAppsToaccessLocalHost(str, 1, profileEntry.getProxyInfo().getPort(), getKnoxVpnHelperInstance().getListOfUid(str));
                profileEntry.setProxyInfo(null);
                clearCallingIdentity = Binder.clearCallingIdentity();
            ...
            checkExistsEmailPackageInProfiles(i, hashMap, exemptPackageList);
            Runnable runnable4 = new Runnable() { // from class: com.android.server.enterprise.vpn.knoxvpn.KnoxVpnEngineService.5
                @Override // java.lang.Runnable
                public void run() {
                    Log.d("KnoxVpnEngineService", "The pac configuration is being removed for the application added to vpn, update AMS " + str);
                    KnoxVpnEngineService.this.getAMSInstance().updateProxyPacConfigurationForKnoxVpn(hashMap, vendorUid, buildPacProxy4, exemptPackageList);
                    Log.d("KnoxVpnEngineService", "The pac configuration is being removed for the application added to vpn, send default broadcast " + str);
                    KnoxVpnEngineService.this.getKnoxVpnHelperInstance().sendProxyConfigBroadcast(hashMap, vendorUid, exemptPackageList);
                    KnoxVpnEngineService.this.killRunningProcessToApplyProxy(str, hashMap, exemptPackageList);
                }
            };
            ...
            Log.e("KnoxVpnEngineService", "Exception occured while applying the proxy rules at KnoxVpnEngineService " + Log.getStackTraceString(e));
        }
    }
    ...
    public final void logVpnVendor(ComponentName componentName) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(packageName) && !TextUtils.isEmpty(className)) {
                ...
                ArrayList dataByFields = this.mVpnStorageProvider.getDataByFields("vpnVendor", strArr, strArr2, null);
                if (dataByFields != null && !dataByFields.isEmpty()) {
                    ContentValues contentValues = (ContentValues) dataByFields.get(0);
                    try {
