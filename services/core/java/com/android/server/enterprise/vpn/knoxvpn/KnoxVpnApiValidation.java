  ...
  */
  public int createVpnProfileValidation(KnoxVpnContext knoxVpnContext, String str) {
    ...
    Log.d(
        ...
        "createVpnProfileValidation:vpnClientUserId " + personaId + " adminUserId " + userId);
    if (personaId == 0) {
      if (userId != 0) {
        return 114;
      }
      ...
      int mUMContainerOwnerUid =
          mEdmStorageProvider.getMUMContainerOwnerUid(knoxVpnContext.getPersonaId());
      Log.d(
          "KnoxVpnApiValidation",
          "createVpnProfileValidation:containerOwner "
    ...
    if (length >= 1 && length <= 128) {
      ...
      if (jSONObject3.optInt("chaining_enabled", -1) == -1) {
        ...
        int checkIfChainingEnabledForVendor =
            knoxVpnHelper.checkIfChainingEnabledForVendor(
                knoxVpnHelper.getUIDForPackage(i5, str13), true);
        if (checkIfChainingEnabledForVendor == 1 || checkIfChainingEnabledForVendor == 0) {
          return 503;
        }
      } else {
        KnoxVpnHelper knoxVpnHelper2 = this.mKnoxVpnHelper;
        if (knoxVpnHelper2.checkIfChainingEnabledForVendor(
                knoxVpnHelper2.getUIDForPackage(i5, str13), false)
            == -1) {
          return 504;
        }
      }
  ...
  public String getVpnProfileValidation(KnoxVpnContext knoxVpnContext, String str) {
    if (str != null) {
      try {
        ...
        Log.e(
            "KnoxVpnApiValidation",
            "Exception at getVpnProfileValidation API " + Log.getStackTraceString(e));
      }
      if (knoxVpnContext.vendorName != null) {
  ...
  public int removeVpnProfileValidation(KnoxVpnContext knoxVpnContext, String str) {
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at removeVpnProfileValidation API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
  ...
  public int addPackagesToVpnValidation(
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at addPackagesToVpnValidation API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (strArr.length >= 1 && knoxVpnContext.vendorName != null) {
      ...
      for (String str2 : strArr) {
        ...
        if (profileEntry2 != null
            && profileEntry2.getProfileName().equalsIgnoreCase(str)
            && profileEntry2.getAdminId() == knoxVpnContext.adminId) {
          return 135;
        }
        ...
        if (uIDForPackage > 0) {
          ...
          String profileOwningTheUidWithNoInternetPermission =
              this.mKnoxVpnHelper.getProfileOwningTheUidWithNoInternetPermission(uIDForPackage);
          if (profileOwningTheUidWithNoInternetPermission != null
              && !profileOwningTheUidWithNoInternetPermission.equalsIgnoreCase(str)) {
            return 139;
          }
        }
        if (this.mKnoxVpnHelper.checkIfUidIsBlackListed(uIDForPackage, knoxVpnContext.personaId)
      ...
      if (this.mKnoxVpnHelper.isWideVpnExists(knoxVpnContext.personaId)) {
        ...
        String profileOwningThePackage =
            knoxVpnHelper.getProfileOwningThePackage(
                knoxVpnHelper.getPersonifiedName(knoxVpnContext.personaId, "ADD_ALL_PACKAGES"));
        if (profileOwningThePackage != null) {
          if (!profileOwningThePackage.equalsIgnoreCase(str)) {
            return this.mKnoxVpnHelper.checkIfProfileHasChainingFeature(profileOwningThePackage)
                    != 1
                ? 119
                : 100;
          }
          ...
          for (String str3 : strArr) {
            int uIDForPackage2 =
                this.mKnoxVpnHelper.getUIDForPackage(knoxVpnContext.personaId, str3);
            if (uIDForPackage2 != -1
                && exemptPackageList.contains(Integer.valueOf(uIDForPackage2))) {
  ...
  public int removePackagesFromVpnValidation(
      KnoxVpnContext knoxVpnContext, String[] strArr, String str) {
    int i;
    if (str == null || strArr == null) {
      return 104;
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at removePackagesFromVpnValidation API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (strArr.length >= 1 && knoxVpnContext.vendorName != null) {
      VpnProfileInfo profileEntry = this.vpnConfig.getProfileEntry(str);
              ...
              Log.d(
                  ...
                  "user wide vpn was configured "
                      ...
                      + this.mKnoxVpnHelper.addExemptedListToDatabase(
                          str,
                          this.mKnoxVpnHelper.getPersonifiedName(knoxVpnContext.personaId, str3),
                          uIDForPackage2));
              AuditLog.logAsUser(
                  5,
                  5,
      ...
      Log.d(
          "KnoxVpnApiValidation",
          "removePackagesFromVpnValidation : validationResult value is " + i);
      return i;
    }
    return 104;
  }
  ...
  public int activateVpnProfileValidation(KnoxVpnContext knoxVpnContext, String str, boolean z) {
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at activateVpnProfileValidation API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
      ...
      try {
        if (knoxVpnContext.vendorName != null) {
          ...
          if (profileEntry == null) {
            Log.d(
                "KnoxVpnApiValidation",
                "getAllPackagesInVpnProfileValidation: profileInfo value is null");
            return null;
          }
          if (profileEntry.getAdminId() != knoxVpnContext.adminId) {
            Log.d(
                "KnoxVpnApiValidation", "getAllPackagesInVpnProfileValidation: Not the same Admin");
            return null;
          }
          int userId = UserHandle.getUserId(profileEntry.getAdminId());
          int personaId = knoxVpnContext.getPersonaId();
          ...
          Log.d(
              "KnoxVpnApiValidation",
              "getAllPackagesInVpnProfileValidation: profile is of system type");
          return null;
        }
      } catch (Exception e) {
        Log.e(
            "KnoxVpnApiValidation",
            "Exception at getAllPackagesInVpnProfileValidation API " + Log.getStackTraceString(e));
        return null;
      }
    }
    Log.d(
        "KnoxVpnApiValidation", "getAllPackagesInVpnProfileValidation: profileName value is null");
    return null;
  }

  public int addContainerPackagesToVpnValidation(
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at addContainerPackagesToVpnValidation API " + Log.getStackTraceString(e));
      i2 = 101;
    }
    if (strArr.length >= 1 && knoxVpnContext.vendorName != null) {
      VpnProfileInfo profileEntry = this.vpnConfig.getProfileEntry(str);
      ...
      for (String str2 : strArr) {
        ...
        VpnProfileInfo profileEntry2 =
            this.vpnConfig.getProfileEntry(
                this.mKnoxVpnHelper.getProfileOwningThePackage(
                    this.mKnoxVpnHelper.getPersonifiedName(i, str2)));
        if (profileEntry2 != null && !profileEntry2.getProfileName().equalsIgnoreCase(str)) {
          if (profileEntry2.getAdminId() == knoxVpnContext.adminId) {
            return 135;
          }
        ...
        if (this.mKnoxVpnHelper.checkIfUidIsBlackListed(uIDForPackage, i)
            || str2.equalsIgnoreCase("com.knox.vpn.proxyhandler")) {
          return 137;
        }
        if (str2.trim().equals("")) {
      ...
      Log.d(
          "KnoxVpnApiValidation",
          "addContainerPackagesToVpnValidation : validationResult value is " + i2);
      return i2;
    }
    return 104;
  }

  public int removeContainerPackagesFromVpnValidation(
      KnoxVpnContext knoxVpnContext, int i, String[] strArr, String str) {
    int i2;
    if (str == null || strArr == null) {
      return 104;
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at removeContainerPackagesFromVpnValidation API "
    ...
    if (strArr.length >= 1 && knoxVpnContext.vendorName != null) {
        ...
        if (profileOwningThePackage != null) {
          ...
          for (String str3 : strArr) {
            ...
            if (uIDForPackage2 != -1) {
              exemptPackageList.add(Integer.valueOf(uIDForPackage2));
              this.mKnoxVpnHelper.addExemptedListToDatabase(
                  str, this.mKnoxVpnHelper.getPersonifiedName(i, str3), uIDForPackage2);
              Log.d(
                  "KnoxVpnApiValidation",
                  "user wide vpn was configured "
                      + i
      ...
      Log.d(
          "KnoxVpnApiValidation",
          "removeContainerPackagesFromVpnValidation : validationResult value is " + i2);
      return i2;
    }
    return 104;
  }

  public String getAllContainerPackagesInVpnProfileValidation(
      ...
      try {
        if (knoxVpnContext.vendorName != null) {
          ...
          if (profileEntry == null) {
            Log.d(
                "KnoxVpnApiValidation",
                "getAllContainerPackagesInVpnProfileValidation: profileInfo value is null");
            return null;
          }
          if (profileEntry.getAdminId() != knoxVpnContext.adminId) {
            Log.d(
                "KnoxVpnApiValidation",
                "getAllContainerPackagesInVpnProfileValidation: Not the same admin");
            return null;
          }
          int userId = UserHandle.getUserId(profileEntry.getAdminId());
          int personaId = knoxVpnContext.getPersonaId();
          ...
          if (profileEntry.getRouteType() == 0) {
            Log.d(
                "KnoxVpnApiValidation",
                "getAllContainerPackagesInVpnProfileValidation: profile is of system type");
            return null;
          }
          if (!isUserTypeAppSeparation(i)) {
            if (getPersonaManager() != null && !getPersonaManager().exists(i)) {
              Log.d(
                  "KnoxVpnApiValidation",
                  "getAllContainerPackagesInVpnProfileValidation: user id is not valid");
              return null;
            }
            if (UserHandle.getAppId(mEdmStorageProvider.getMUMContainerOwnerUid(i))
                != UserHandle.getAppId(knoxVpnContext.adminId)) {
              Log.d(
                  "KnoxVpnApiValidation",
                  "getAllContainerPackagesInVpnProfileValidation: Admin does not own the"
                      + " container");
              return null;
            }
          }
        ...
        Log.e(
            "KnoxVpnApiValidation",
            "Exception at getAllContainerPackagesInVpnProfileValidation API "
                + Log.getStackTraceString(e));
        return null;
      }
    }
    Log.d(
        "KnoxVpnApiValidation",
        "getAllContainerPackagesInVpnProfileValidation: profileName value is null");
    return null;
  }

  public int addAllContainerPackagesToVpnValidation(
      KnoxVpnContext knoxVpnContext, int i, String str) {
    int i2;
    if (str == null) {
      return 104;
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at addAllContainerPackagesToVpnValidation API " + Log.getStackTraceString(e));
      i2 = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
    ...
    if (userId != 0 && personaId == 0) {
      Log.e(
          "KnoxVpnApiValidation", "EMM present in work profile trying to configure vpn for user 0");
      return 114;
    }
    if (profileEntry.getRouteType() == 0) {
      return 109;
    ...
    if (this.mKnoxVpnHelper.isUsingKnoxPackageExists(i)
        && !this.mKnoxVpnHelper.chainingForAddAll(str, knoxVpnContext.personaId)) {
      return 123;
    }
    if (this.mKnoxVpnHelper.isWideVpnExists(i)) {
    ...
    Log.d(
        "KnoxVpnApiValidation",
        "addAllContainerPackagesToVpnValidation : validationResult value is " + i2);
    return i2;
  }

  public int removeAllContainerPackagesFromVpnValidation(
      KnoxVpnContext knoxVpnContext, int i, String str) {
    int i2;
    if (str == null) {
      return 104;
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at removeAllPackagesFromVpnValidation API " + Log.getStackTraceString(e));
      i2 = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
    ...
    Log.d(
        "KnoxVpnApiValidation",
        "removeAllPackagesFromVpnValidation : validationResult value is " + i2);
    return i2;
  }
  ...
  public int addAllPackagesToVpnValidation(KnoxVpnContext knoxVpnContext, String str) {
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at addAllPackagesToVpnValidation API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
    ...
    if (this.mKnoxVpnHelper.isWideVpnExists(knoxVpnContext.personaId)) {
      return this.mKnoxVpnHelper.getAdminIdForUserVpn(knoxVpnContext.personaId)
              == knoxVpnContext.adminId
          ? 117
          : 118;
    }
  ...
  public int removeAllPackagesFromVpnValidation(KnoxVpnContext knoxVpnContext, String str) {
    ...
    Log.d(
        "KnoxVpnApiValidation",
        "removeAllPackagesFromVpnValidation : validationResult value is " + i);
    return i;
  }
  ...
  public int getStateValidation(KnoxVpnContext knoxVpnContext, String str) {
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at getStateValidation API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
  ...
  public String getErrorStringValidation(KnoxVpnContext knoxVpnContext, String str) {
    if (str != null) {
      try {
        ...
        Log.e(
            "KnoxVpnApiValidation",
            "Exception at getErrorStringValidation API " + Log.getStackTraceString(e));
      }
      if (knoxVpnContext.vendorName != null) {
        VpnProfileInfo profileEntry = this.vpnConfig.getProfileEntry(str);
        if (profileEntry == null) {
  ...
  public int setVpnModeOfOperationValidation(KnoxVpnContext knoxVpnContext, String str, int i) {
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at setVpnModeOfOperationValidation API " + Log.getStackTraceString(e));
      i2 = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
    ...
    Log.d(
        "KnoxVpnApiValidation",
        "setVpnModeOfOperationValidation : validationResult value is " + i2);
    return i2;
  }
  ...
  public int getVpnModeOfOperationValidation(KnoxVpnContext knoxVpnContext, String str) {
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at getVpnModeOfOperationValidation API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
    ...
    i = 100;
    Log.d(
        "KnoxVpnApiValidation", "getVpnModeOfOperationValidation : validationResult value is " + i);
    return i;
  }
  ...
  public int allowUsbTetheringValidation(KnoxVpnContext knoxVpnContext, String str, Bundle bundle) {
    ...
    if (profileEntry.getChainingEnabled() == 0
        ...
        || profileEntry.getUidPidSearchEnabled() == 1) {
      return 901;
    }
    Collection profileEntries = this.vpnConfig.getProfileEntries();
    if (profileEntries != null && profileEntries.size() > 0) {
    ...
    if (bundle != null && !bundle.isEmpty()) {
      if (!this.mKnoxVpnHelper.isPackageInstalled(
          "com.samsung.knox.vpn.tether.auth", knoxVpnContext.personaId)) {
        Log.e("KnoxVpnTetherAuthentication", "knox vpn usb tether auth application not installed");
        return 901;
      }
      if (!this.mKnoxVpnHelper.checkIfPlatformSigned(
          knoxVpnContext.personaId, "com.samsung.knox.vpn.tether.auth")) {
        Log.e(
  ...
  public int disallowUsbTetheringValidation(KnoxVpnContext knoxVpnContext, String str) {
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at enableUsbTethering API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
  ...
  public int isUsbTetheringOverVpnEnabledValidation(KnoxVpnContext knoxVpnContext, String str) {
    ...
    try {
      ...
      Log.e(
          "KnoxVpnApiValidation",
          "Exception at isUsbTetheringOverVpnEnabledValidation API " + Log.getStackTraceString(e));
      i = 101;
    }
    if (knoxVpnContext.vendorName == null) {
      return 104;
    ...
    Log.d(
        "KnoxVpnApiValidation",
        "isUsbTetheringOverVpnEnabledValidation : validationResult value is " + i);
    return i;
  }
}
