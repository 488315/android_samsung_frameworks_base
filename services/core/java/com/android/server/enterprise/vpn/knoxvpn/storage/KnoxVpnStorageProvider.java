    ...
    */
    public int getProfileId() {
        ...
        if (edmStorageProvider != null) {
            Cursor query = edmStorageProvider.mEdmDbHelper.getReadableDatabase().query("VpnAnalyticsTable", new String[]{"profileCount"}, null, null, null, null, null);
            try {
                if (query != null) {
                    try {
                        if (query.getCount() > 0) {
    ...
    public ArrayList getDomainsByProfileName(String str) {
        ...
        Cursor query = mEDM.mEdmDbHelper.getReadableDatabase().query("VpnPackageInfo", new String[]{"packageCid", "packageUid"}, "profileName=?", new String[]{str}, null, null, null);
        if (query != null) {
