...
public class DeviceAccountPolicy extends IDeviceAccountPolicy.Stub
    implements EnterpriseServiceCallback {
  public static String[] mSupportedAccountTypes = {
  ...
  public final boolean checkAccountMatch(Iterator it, String str) {
    while (it.hasNext()) {
      ...
      try {
        ...
        Slog.d(
            "DeviceAccountPolicy",
            "checkAccountMatch() : invalid matched. match = " + str + " ,target =" + str2);
      }
      if (str.matches(str2)) {
        Slog.d(
            "DeviceAccountPolicy",
            "checkAccountMatch() : matched. match = " + str + " ,target =" + str2);
        return true;
      }
      continue;
    }
  ...
  public final boolean addAccountsToBWLInternal(
      ContextInfo contextInfo, String str, List list, String str2) {
      ...
      try {
        ...
        while (it.hasNext()) {
          ...
          boolean putValuesNoUpdate =
              this.mEdmStorageProvider.putValuesNoUpdate("AccountBlackWhiteList", contentValues);
              ...
              getAuditLogService()
                  .AuditLoggerAsUser(
                      ...
                      String.format(
                          ...
                          Integer.valueOf(enforceSecurityPermission.mCallerUid), str3),
  ...
  public final boolean removeAccountsFromBWLInternal(
      ContextInfo contextInfo, String str, List list, String str2) {
    ContextInfo enforceSecurityPermission = enforceSecurityPermission(contextInfo);
        ...
        while (it.hasNext()) {
          ...
          boolean deleteDataByFields =
              this.mEdmStorageProvider.deleteDataByFields(
                  ...
                  new String[] {"adminUid", "type", "name", "listType"},
                  new String[] {String.valueOf(i), str, str3, str2});
  ...
  public final List getAccountsFromBWLInternal(ContextInfo contextInfo, String str, String str2) {
    ...
    Map loadAccounts =
        loadAccounts(Utils.getCallingOrCurrentUserId(enforceSecurityPermission), str, str2);
    if (loadAccounts == null) {
      Log.i(
          "DeviceAccountPolicy",
          "getAccountsFromBWLInternal() : Account list for " + str2 + " is null.");
      return null;
    }
  ...
  public final boolean clearAccountsFromBWLInternal(
    ...
    try {
      ...
      contentValues.put("listType", str2);
      List valuesList =
          this.mEdmStorageProvider.getValuesList("AccountBlackWhiteList", strArr, contentValues);
      if (valuesList != null && !valuesList.isEmpty()) {
        boolean deleteDataByFields =
            this.mEdmStorageProvider.deleteDataByFields("AccountBlackWhiteList", strArr, strArr2);
        if (deleteDataByFields) {
          if (str2.equals("ADDITION_BLACKLIST")) {
            getAuditLogService()
                .AuditLoggerAsUser(
  ...
  public final synchronized Map loadAccounts(int i, String str, String str2) {
    ...
    ArrayList longListAsUser =
        this.mEdmStorageProvider.getLongListAsUser("AccountBlackWhiteList", "adminUid", i);
    ...
    while (it.hasNext()) {
      hashMap.put(
          Integer.valueOf(
              EdmStorageProviderBase.getAdminUidFromLUID(((Long) it.next()).longValue())),
          new TreeSet());
    }
      ...
      for (ContentValues contentValues2 : valuesList) {
        ...
        if (asLong != null) {
          ((Set)
                  hashMap.get(
                      Integer.valueOf(
                          EdmStorageProviderBase.getAdminUidFromLUID(asLong.longValue()))))
              .add(contentValues2.getAsString("name"));
        } else {
  ...
  public boolean removeAccountsFromRemovalBlackList(
      ContextInfo contextInfo, String str, List list) {
  ...
  public boolean isAccountRemovalAllowed(String str, String str2, boolean z) {
    return isAccountRemovalAllowedAsUser(
        str, str2, z, Utils.getCallingOrCurrentUserId(new ContextInfo(Binder.getCallingUid())));
  }
  ...
  public boolean isAccountRemovalAllowedAsUser(String str, String str2, boolean z, int i) {
    ...
    for (Integer num : loadAccounts.keySet()) {
      if (loadAccounts2 != null
          && checkAccountMatch(((Set) loadAccounts2.get(num)).iterator(), str2)) {
        ...
        if (z) {
          RestrictionToastManager.show(R.string.autofill_save_type_payment_card);
        }
        Slog.d(
            "DeviceAccountPolicy",
            "isAccountRemovalAllowedAsUser() : account has blocked. userId = " + num);
        return false;
      }
    }
    return true;
  ...
  public boolean isAccountAdditionAllowed(String str, String str2, boolean z) {
    int callingOrCurrentUserId =
        Utils.getCallingOrCurrentUserId(new ContextInfo(Binder.getCallingUid()));
    ...
    for (Integer num : loadAccounts.keySet()) {
      if (loadAccounts2 == null
        ...
        if (checkAccountMatch(((Set) loadAccounts.get(num)).iterator(), str2)) {
          if (z) {
            RestrictionToastManager.show(R.string.autofill_save_type_password);
          }
          Slog.d(
              "DeviceAccountPolicy",
              "isAccountAdditionAllowed() : account has blocked. userId = " + num);
          return false;
        }
      }
    }
