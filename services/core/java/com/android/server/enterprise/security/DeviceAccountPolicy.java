...
public final class DeviceAccountPolicy extends IDeviceAccountPolicy.Stub
        implements EnterpriseServiceCallback {
    public static final String[] mSupportedAccountTypes = {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                GmsAlarmManager$$ExternalSyntheticOutline0.m(
                        "checkAccountMatch() : invalid matched. match = ",
                        str,
                        " ,target =",
                        str2,
                        "DeviceAccountPolicy");
                        ...
                        if (str2.equals("ADDITION_BLACKLIST")) {
                            getAuditLogService()
                                    .redactedAuditLoggerAsUser(
                                            ...
                                            "DeviceAccountPolicy",
                                            String.format(
                                                    "Admin %d has added account %s to the addition"
                                                        + " blocklist.",
                                                    Integer.valueOf(
                            ...
                            getAuditLogService()
                                    .redactedAuditLoggerAsUser(
                                            ...
                                            "DeviceAccountPolicy",
                                            String.format(
                                                    "Admin %d has added account %s to the removal"
                                                        + " blocklist.",
                                                    Integer.valueOf(
                                                            enforceSecurityPermission.mCallerUid),
                                                    str3),
    ...
    public final boolean addAccountsToRemovalBlackList(
            ContextInfo contextInfo, String str, List list) {
        return addAccountsToBWLInternal(contextInfo, list, str, "REMOVAL_BLACKLIST");
    }

    public final boolean addAccountsToRemovalWhiteList(
            ContextInfo contextInfo, String str, List list) {
            ...
            try {
                ...
                if (((ArrayList)
                                this.mEdmStorageProvider.getValuesList(
                                        "AccountBlackWhiteList", strArr, contentValues))
                        .isEmpty()) {
                ...
                boolean deleteDataByFields =
                        this.mEdmStorageProvider.deleteDataByFields(
                                "AccountBlackWhiteList", strArr, strArr2);
                    ...
                    if (str2.equals("ADDITION_BLACKLIST")) {
                        getAuditLogService()
                                .redactedAuditLoggerAsUser(
                                        ...
                                        "DeviceAccountPolicy",
                                        String.format(
                                                "Admin %d has removed all accounts from addition"
                                                    + " blocklist.",
                                                Integer.valueOf(
                                                        enforceSecurityPermission.mCallerUid)),
                                        null,
                        ...
                        getAuditLogService()
                                .redactedAuditLoggerAsUser(
                                        ...
                                        "DeviceAccountPolicy",
                                        String.format(
                                                "Admin %d has removed all accounts from removal"
                                                    + " blocklist.",
                                                Integer.valueOf(
                                                        enforceSecurityPermission.mCallerUid)),
                                        null,
                ...
                Log.e(
                        "DeviceAccountPolicy",
                        "Handled Exception in clearAccountsFromBWLInternal()",
                        e);
                Binder.restoreCallingIdentity(clearCallingIdentity);
                return false;
            }
    ...
    public final List getAccountsFromBWLInternal(ContextInfo contextInfo, String str, String str2) {
        ...
        if (loadAccounts == null) {
            AudioDeviceInventory$$ExternalSyntheticOutline0.m(
                    "getAccountsFromBWLInternal() : Account list for ",
                    str2,
                    " is null.",
                    "DeviceAccountPolicy");
            return null;
        ...
        for (Integer num : keySet) {
            ...
            accountControlInfo.adminPackageName =
                    this.mEdmStorageProvider.getPackageNameForUid(num.intValue());
    ...
    public final boolean isAccountAdditionAllowed(String str, String str2, boolean z) {
        ...
        for (Integer num : hashMap.keySet()) {
            if (loadAccounts2 == null
                    || !checkAccountMatch(
                            ((Set) ((HashMap) loadAccounts2).get(num)).iterator(), str2)) {
    ...
    public final synchronized Map loadAccounts(int i, String str, String str2) {
        ...
        ArrayList longListAsUser =
                this.mEdmStorageProvider.getLongListAsUser(i, "AccountBlackWhiteList", "adminUid");
        ...
        try {
            ...
            while (it2.hasNext()) {
                ...
                if (asLong != null) {
                    ((Set) hashMap.get(Integer.valueOf((int) asLong.longValue())))
    ...
    public final boolean removeAccountsFromAdditionBlackList(
            ContextInfo contextInfo, String str, List list) {
        return removeAccountsFromBWLInternal(contextInfo, list, str, "ADDITION_BLACKLIST");
    }

    public final boolean removeAccountsFromAdditionWhiteList(
            ContextInfo contextInfo, String str, List list) {
    ...
    public final boolean removeAccountsFromBWLInternal(
        ...
        try {
            try {
                        ...
                        if (str2.equals("ADDITION_BLACKLIST")) {
                            getAuditLogService()
                                    .redactedAuditLoggerAsUser(
                                            ...
                                            "DeviceAccountPolicy",
                                            String.format(
                                                    "Admin %d has removed account %s from addition"
                                                        + " blocklist.",
                                                    Integer.valueOf(
                                                            enforceSecurityPermission.mCallerUid),
                                                    str3),
                            ...
                            getAuditLogService()
                                    .redactedAuditLoggerAsUser(
                                            ...
                                            "DeviceAccountPolicy",
                                            String.format(
                                                    "Admin %d has removed account %s from removal"
                                                        + " blocklist.",
                                                    Integer.valueOf(
                                                            enforceSecurityPermission.mCallerUid),
                                                    str3),
                ...
                Log.e(
                        "DeviceAccountPolicy",
                        "Handled Exception in removeAccountsFromBWLInternal()",
                        e);
                Binder.restoreCallingIdentity(clearCallingIdentity);
                return false;
            }
    ...
    public final boolean removeAccountsFromRemovalBlackList(
            ContextInfo contextInfo, String str, List list) {
        return removeAccountsFromBWLInternal(contextInfo, list, str, "REMOVAL_BLACKLIST");
    }

    public final boolean removeAccountsFromRemovalWhiteList(
            ContextInfo contextInfo, String str, List list) {
