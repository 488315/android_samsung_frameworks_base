...
public class NetworkAnalyticsService extends INetworkAnalytics.Stub
  ...
  public NetworkAnalyticsService(Context context) {
    ...
    try {
      Log.d(
          "NetworkAnalytics:Service",
          "Network Platform analytics Service is going to be added to the ServiceManager list ");
      NetworkAnalyticsStorageHelper networkAnalyticsStorageHelper =
          NetworkAnalyticsStorageHelper.getInstance(this.mContext);
      ...
      NetworkAnalyticsDataDelivery networkAnalyticsDataDelivery =
          NetworkAnalyticsDataDelivery.getInstance();
      this.mDataDelivery = networkAnalyticsDataDelivery;
      this.mDriver =
          NetworkAnalyticsDriver.getInstance(this.mConnectionManager, networkAnalyticsDataDelivery);
      ...
      Log.e(
          "NetworkAnalytics:Service",
          "Error occured while trying to start NPA as a system service",
          th);
    }
  }
  ...
  public int registerNetworkMonitorProfile(ContextInfo contextInfo, String str) {
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "registerNetworkMonitorProfile API caller is " + contextInfo.mCallerUid);
    }
    ContextInfo enforceNetworkAnalyticsPermission = enforceNetworkAnalyticsPermission(contextInfo);
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "registerNetworkMonitorProfile API caller with updated contextInfo is "
              + enforceNetworkAnalyticsPermission.mCallerUid);
    }
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "registerNetworkMonitorProfile: allowUserId: "
              + enforceNetworkAnalyticsPermission.mContainerId
              + " profile:"
              + str);
    }
    try {
    ...
    if (validateJsonContent < 0) {
      Log.d(
          "NetworkAnalytics:Service",
          "registerNetworkMonitorProfile: JSON validation failed:" + validateJsonContent);
      return validateJsonContent;
    }
    i =
        this.mConfigStore.addProfileToDatabase(
            enforceNetworkAnalyticsPermission.mCallerUid,
    ...
    if (i < 0) {
      Log.d(
          "NetworkAnalytics:Service",
          "registerNetworkMonitorProfile: Add profile to database failed:" + i);
      return i;
    }
    if (i == 0
        && (clientProfileNames =
                this.mConfigStore.getClientProfileNames(
                    enforceNetworkAnalyticsPermission.mCallerUid))
            != null
        && clientProfileNames.size() == 1) {
      if (z) {
  ...
  */
  public synchronized int handleNAPClientCall(String str, Bundle bundle, boolean z) {
    int i;
    int callingUid;
    int userId;
    ...
    int i2;
    int i3;
    int updateBindUserIdForProfile;
    int i4 = -1;
    try {
      callingUid = Binder.getCallingUid();
      userId = UserHandle.getUserId(callingUid);
      packageNameForUid = getPackageNameForUid(callingUid);
    } catch (Exception e) {
      Log.e("NetworkAnalytics:Service", "handleNAPClientCall: Exception in doStart:" + z, e);
      i = -1;
    }
    if (str != null && packageNameForUid != null && userId >= 0) {
      int validateNAPClient = validateNAPClient(callingUid, userId, z, str);
      if (validateNAPClient < 0) {
        Log.d(
            "NetworkAnalytics:Service",
            "handleNAPClientCall: Caller validation failed:" + validateNAPClient + " doStart:" + z);
        return validateNAPClient;
      }
      List<NetworkAnalyticsConfigStore.NAPConfigProfile> listOfProfilesForOperation =
          listOfProfilesForOperation(packageNameForUid, str, userId);
      if (listOfProfilesForOperation != null && listOfProfilesForOperation.size() > 0) {
        for (NetworkAnalyticsConfigStore.NAPConfigProfile nAPConfigProfile :
            listOfProfilesForOperation) {
          if (nAPConfigProfile == null) {
            Log.d(
                "NetworkAnalytics:Service",
                "handleNAPClientCall: Profile does not exist for name: " + str);
            i2 = -3;
            if (!"ALL_REGISTERED_PROFILES_FOR_CLIENT".equals(str)) {
              return -3;
            }
          } else if (!nAPConfigProfile.getPackageName().equals(packageNameForUid)) {
            Log.d(
                "NetworkAnalytics:Service",
                "handleNAPClientCall: NAP client activating un-owned profile: " + str);
            if (!"ALL_REGISTERED_PROFILES_FOR_CLIENT".equals(str)) {
              return -18;
            }
            validateNAPClient = -18;
          } else if (z && !isAllowedRecordingForUsers(nAPConfigProfile, userId)) {
            Log.d(
                "NetworkAnalytics:Service",
                "handleNAPClientCall: Client installed in wrong user trying to collect data");
            i2 = -17;
            if (!"ALL_REGISTERED_PROFILES_FOR_CLIENT".equals(str)) {
              return -17;
            }
          } else {
            if (!z && nAPConfigProfile.getUserId() != userId) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "handleNAPClientCall: NAP client failed to stop the connection since not started"
                      + " by same user");
              return -18;
            }
            if (z) {
              if (bundle == null) {
                Log.d(
                    "NetworkAnalytics:Service",
                    "handleNAPClientCall: Client trying to collect data with null bundle flow"
                        + " information");
                return -4;
              }
              int i5 = bundle.getInt("record_type", i4);
              if (i5 >= 0 && i5 <= 2) {
                int i6 = bundle.getInt("interval_value", -999);
                if (i6 != -999 && (i6 < 60 || i6 > 14400)) {
                  Log.d(
                      "NetworkAnalytics:Service",
                      "handleNAPClientCall: Client trying to collect data with Invalid interval"
                          + " information");
                  return -4;
                }
                if (i6 != -999
                    && i6 >= 60
                    && i6 <= 14400
                    && EdmConstants.getEnterpriseKnoxSdkVersion().getInternalVersion() != null) {
                  String internalVersion =
                      EdmConstants.EnterpriseKnoxSdkVersion.KNOX_ENTERPRISE_SDK_VERSION_3_3
                          .getInternalVersion();
                  String internalVersion2 =
                      EdmConstants.getEnterpriseKnoxSdkVersion().getInternalVersion();
                  Log.d(
                      "NetworkAnalytics:Service",
                      "handleNAPClientCall: intermediate flows : current knox version : "
                          + internalVersion2
                          + " supported knox version : "
                          + internalVersion);
                  if (versionCompare(internalVersion2, internalVersion) < 0) {
                    Log.d(
                        "NetworkAnalytics:Service",
                        "handleNAPClientCall: Client trying to collect data not supported in"
                            + " current version");
                    return -4;
                  }
                }
                ...
                if (setActivatedProfiles != null && setActivatedProfiles.size() > 0) {
                  ...
                  while (it.hasNext()) {
                    NetworkAnalyticsConfigStore.NAPProfileActivation activeStateForName =
                        this.mConfigStore.getActiveStateForName((String) it.next());
                    if (activeStateForName != null
                        && 1 == activeStateForName.getActivationState()
                        && (activeStateForName.getActivationFlowType() != i5
                            || activeStateForName.getActivationIntervalValue() != i6)) {
                      Log.d(
                          "NetworkAnalytics:Service",
                          "handleNAPClientCall: Client trying to collect data with wrong flow or"
                              + " interval");
                      return -4;
                    }
                  }
                }
                nAPConfigProfile.setFlowTypeForProfile(i5);
                nAPConfigProfile.setIntervalValueForProfile(i6);
                if (EdmConstants.getEnterpriseKnoxSdkVersion().getInternalVersion() == null) {
                  Log.d(
                      "NetworkAnalytics:Service",
                      "handleNAPClientCall: file descriptor failed for profile:"
                          + nAPConfigProfile.toString()
                          + " doStart:"
                          + z);
                  return -19;
                }
                  ...
                  if (openCharDevice2 < 0) {
                    Log.d(
                        ...
                        "handleNAPClientCall: file descriptor failed for profile:"
                            ...
                            + " doStart:"
                            + z);
                    return openCharDevice2;
                  }
                }
                int checkNcmVersionMismatch = this.mDriver.checkNcmVersionMismatch();
                if (checkNcmVersionMismatch < 0) {
                  Log.d(
                      "NetworkAnalytics:Service",
                      "handleNAPClientCall: ncm version match failed for profile:"
                          + nAPConfigProfile.toString()
                          + " doStart:"
                          + z);
                  return checkNcmVersionMismatch;
                }
              }
              Log.d(
                  "NetworkAnalytics:Service",
                  "handleNAPClientCall: Client trying to collect data with Invalid flow"
                      + " information");
              return -4;
            }
            i3 = 0;
            if (nAPConfigProfile.getUserId() == -999) {
              updateBindUserIdForProfile =
                  this.mConfigStore.updateBindUserIdForProfile(
                      nAPConfigProfile.getProfileName(), nAPConfigProfile.getOpUserId(), userId);
              if (updateBindUserIdForProfile < 0) {
                Log.d(
                    "NetworkAnalytics:Service",
                    "handleNAPClientCall: bind userId updation failed for profile:"
                        + nAPConfigProfile.toString()
                        + " doStart:"
                        + z);
                if (!"ALL_REGISTERED_PROFILES_FOR_CLIENT".equals(str)) {
                  return updateBindUserIdForProfile;
                }
                validateNAPClient = updateBindUserIdForProfile;
                i4 = -1;
              }
              updateBindUserIdForProfile = activateProfile(nAPConfigProfile, !z ? 1 : i3);
              if (updateBindUserIdForProfile >= 0) {
                Log.d(
                    "NetworkAnalytics:Service",
                    "handleNAPClientCall: activation failed for profile:"
                        + nAPConfigProfile.toString()
                        + " doStart:"
                        + z);
                if (!"ALL_REGISTERED_PROFILES_FOR_CLIENT".equals(str)) {
                ...
                asyncHandlerObject.profileName = nAPConfigProfile.getProfileName();
                asyncHandlerObject.packageName = nAPConfigProfile.getPackageName();
                asyncHandlerObject.userId = userId;
                asyncHandlerObject.callback = null;
                if (z) {
                  i3 = 1;
                }
                sendMessageToHandler(1, i3, nAPConfigProfile.getOpUserId(), asyncHandlerObject);
              }
              validateNAPClient = updateBindUserIdForProfile;
              i4 = -1;
            } else {
              if (nAPConfigProfile.getUserId() != -999
                  && this.mConfigStore.isProfileActivatedForUser(
                          nAPConfigProfile.getProfileName(), nAPConfigProfile.getOpUserId())
                      == 0
                  && (updateBindUserIdForProfile =
                          this.mConfigStore.updateBindUserIdForProfile(
                              nAPConfigProfile.getProfileName(),
                              nAPConfigProfile.getOpUserId(),
                              userId))
                      < 0) {
                Log.d(
                    "NetworkAnalytics:Service",
                    "handleNAPClientCall: bind userId updation failed for profile after default"
                        + " check:"
                        + nAPConfigProfile.toString()
                        + " doStart:"
                        + z);
          ...
          validateNAPClient = i2;
        }
      }
      i = validateNAPClient;
      return i;
    }
    Log.d("NetworkAnalytics:Service", "handleNAPClientCall: Invalid parameters. doStart:" + z);
    return -4;
  }
  ...
  public List getNetworkMonitorProfiles(ContextInfo contextInfo) {
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "getNetworkMonitorProfiles API caller is " + contextInfo.mCallerUid);
    }
    ContextInfo enforceNetworkAnalyticsPermission = enforceNetworkAnalyticsPermission(contextInfo);
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "getNetworkMonitorProfiles API caller with updated contextInfo is "
              + enforceNetworkAnalyticsPermission.mCallerUid);
    }
    try {
      return this.mConfigStore.getClientProfiles(
          enforceNetworkAnalyticsPermission.mCallerUid,
          enforceNetworkAnalyticsPermission.mContainerId);
    } catch (Exception e) {
  ...
  public List getProfiles(ContextInfo contextInfo) {
    ...
    if (packageNameForUid == null) {
      Log.d(
          "NetworkAnalytics:Service",
          "getProfiles: NAP client caller cannot be validated. PackageName null");
      return null;
    }
    try {
  ...
  public int isProfileActivatedForUser(ContextInfo contextInfo, String str) {
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "isProfileActivatedForUser API caller is " + contextInfo.mCallerUid);
    }
    ContextInfo enforceNetworkAnalyticsPermission = enforceNetworkAnalyticsPermission(contextInfo);
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "isProfileActivatedForUser API caller with updated contextInfo is "
              + enforceNetworkAnalyticsPermission.mCallerUid);
    }
    ...
    if (doesAdminOwnProfile < 0) {
      Log.d(
          "NetworkAnalytics:Service",
          "isProfileActivatedForUser: Profile "
              + str
              + "is absent or does not belong to adminUid "
              + enforceNetworkAnalyticsPermission.mCallerUid
              + " return="
              + doesAdminOwnProfile);
    ...
    try {
      return this.mConfigStore.isProfileActivatedForUser(
          str, enforceNetworkAnalyticsPermission.mContainerId);
    } catch (Exception e) {
      Log.e(
          "NetworkAnalytics:Service",
          "isProfileActivatedForUser: Remove profile to database falied. Exception",
          e);
      return -1;
    }
  }
  ...
  public int unregisterNetworkMonitorProfile(ContextInfo contextInfo, String str) {
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "unregisterNetworkMonitorProfile API caller is " + contextInfo.mCallerUid);
    }
    ContextInfo enforceNetworkAnalyticsPermission = enforceNetworkAnalyticsPermission(contextInfo);
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "unregisterNetworkMonitorProfile API caller with updated contextInfo is "
              + enforceNetworkAnalyticsPermission.mCallerUid);
    }
  ...
  public synchronized String getNPAVersion() {
    String str;
    try {
      if (this.mDriver.ncmVersion == null
          && EdmConstants.getEnterpriseKnoxSdkVersion().getInternalVersion() != null) {
        String internalVersion =
            EdmConstants.EnterpriseKnoxSdkVersion.KNOX_ENTERPRISE_SDK_VERSION_3_3
                .getInternalVersion();
        ...
        Log.d(
            "TAG",
            "supportedVersion = " + internalVersion + "currentVersion  = " + internalVersion2);
        if (versionCompare(internalVersion2, internalVersion) < 0) {
          int openCharDevice = this.mDriver.openCharDevice(0);
          if (openCharDevice < 0) {
            Log.d(
                "NetworkAnalytics:Service",
                "getNPAVersion: Failed to open char device : " + openCharDevice);
          ...
          if (openCharDevice2 < 0) {
            Log.d(
                "NetworkAnalytics:Service",
                "getNPAVersion: Failed to open char device : " + openCharDevice2);
  ...
  public final boolean isAllowedRecordingForUsers(
      NetworkAnalyticsConfigStore.NAPConfigProfile nAPConfigProfile, int i) {
    if (i == 0) {
      Log.d(
          "NetworkAnalytics:Service",
          "isAllowedRecordingForUsers: App is installed in User 0. Can record for any user.");
      return true;
    }
    if (DBG) {
  ...
  public final int activateProfile(
      NetworkAnalyticsConfigStore.NAPConfigProfile nAPConfigProfile, int i) {
    if (DBG) {
      Log.d(
          "NetworkAnalytics:Service",
          "Called activateProfile: " + nAPConfigProfile.getProfileName());
    }
    try {
      if (this.mConfigStore.isProfileActivatedForUser(
              nAPConfigProfile.getProfileName(), nAPConfigProfile.getOpUserId())
          == i) {
        Log.d(
            "NetworkAnalytics:Service",
            "activateProfile:Profile is already in the activated state for the user.");
        return -8;
      }
      int activateProfile =
          this.mConfigStore.activateProfile(
              nAPConfigProfile.getAdminUid(),
              nAPConfigProfile.getProfileName(),
              nAPConfigProfile.getOpUserId(),
              i);
      ...
      Log.d(
          "NetworkAnalytics:Service",
          "Activate profile config storage returned = " + activateProfile + " for state " + i);
      return activateProfile;
    } catch (Exception e) {
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final int unregisterNetworkMonitorProfile(int i, String str) {
    int i2;
    int i3;
    String str2;
    List clientProfileNames;
    ...
    if (i <= 0 || str == null) {
      Log.d("NetworkAnalytics:Service", "unregisterNetworkMonitorProfile: Invalid parameters");
      return -4;
    }
    int doesAdminOwnProfile = this.mConfigStore.doesAdminOwnProfile(i, str);
    if (doesAdminOwnProfile < 0) {
      Log.d(
          "NetworkAnalytics:Service",
          "unregisterNetworkMonitorProfile: Profile "
              + str
              + "is absent or does not belong to adminUid "
              + i
              + " return="
    ...
    NetworkAnalyticsConfigStore.NAPConfigProfile profileforName =
        this.mConfigStore.getProfileforName(str);
    if (profileforName != null) {
      i2 = profileforName.getOpUserId();
      try {
        str2 = profileforName.getJsonString();
      } catch (Exception e2) {
        e = e2;
        Log.e("NetworkAnalytics:Service", "unregisterNetworkMonitorProfile. Exception", e);
        i3 = -1;
        str2 = str3;
        if (i3 == 0) {}
        return i3;
    ...
    try {
      List allActiveKeysForProfile = this.mConfigStore.getAllActiveKeysForProfile(str);
      if (allActiveKeysForProfile != null && allActiveKeysForProfile.size() > 0) {
        Iterator it = allActiveKeysForProfile.iterator();
        while (it.hasNext()) {
          NetworkAnalyticsConfigStore.NAPConfigProfile profileforName2 =
              this.mConfigStore.getProfileforName(
                  getVendorNameFromTransformedName((String) it.next()));
          if (profileforName2 == null) {
            Log.d(
                "NetworkAnalytics:Service",
                "unregisterNetworkMonitorProfile config profile obj is null for profile: " + str);
            return doesAdminOwnProfile;
          }
          doesAdminOwnProfile = activateProfile(profileforName2, 0);
          if (doesAdminOwnProfile < 0) {
            Log.d(
                "NetworkAnalytics:Service",
                "unregisterNetworkMonitorProfile: deactivation failed for profile:"
                    + profileforName2.toString());
            return doesAdminOwnProfile;
          }
          AsyncHandlerObject asyncHandlerObject = new AsyncHandlerObject();
          asyncHandlerObject.profileName = profileforName2.getProfileName();
          asyncHandlerObject.packageName = profileforName2.getPackageName();
          asyncHandlerObject.userId = profileforName2.getUserId();
          asyncHandlerObject.callback = null;
          sendMessageToHandler(1, 0, profileforName2.getOpUserId(), asyncHandlerObject);
        }
      }
      i3 = this.mConfigStore.removeProfileFromDatabase(i, str);
    } catch (Exception e3) {
      e = e3;
      str3 = str2;
      Log.e("NetworkAnalytics:Service", "unregisterNetworkMonitorProfile. Exception", e);
    ...
    if (i3 < 0) {
      if (DBG) {
        Log.d("NetworkAnalytics:Service", "Remove profile from database falied.");
      }
      return i3;
    }
    if (i3 == 0
        && ((clientProfileNames = this.mConfigStore.getClientProfileNames(i)) == null
            || clientProfileNames.isEmpty())) {
      if (DBG) {
        Log.d("NetworkAnalytics:Service", "The Knox NAP feature has been disabled");
      }
      setFeatureProperty(false);
    }
    if (i3 == 0) {
      if (i2 != 0) {
        constructObjectForBroadcast(1, 0, str2);
      }
      constructObjectForBroadcast(1, i2, str2);
    }
    return i3;
  }
  ...
  public final int isValidAppInstalled(String str, String str2, int i) {
    ...
    if (packageManagerAdapter != null) {
      ...
      if (packageCertForPkgname != null
          && packageCertForPkgname.length() > 0
          && !str2.equals(packageCertForPkgname)) {
        Log.d(
            "NetworkAnalytics:Service",
            "isValidAppInstalled: Monitor app signature is not matched.");
        Binder.restoreCallingIdentity(clearCallingIdentity);
        return -13;
      }
    }
  ...
  public final int validateNAPClient(String str, String str2, int i) {
    ...
    try {
      ...
      Log.d(
          "NetworkAnalytics:Service",
          "validateNAPClient:Valid monitor application is not installed " + isValidAppInstalled);
      return isValidAppInstalled;
    } catch (Exception e) {
      Log.e(
          "NetworkAnalytics:Service",
          "validateNAPClient: Add profile to database failed. Exception",
          e);
      return -1;
    }
  }
  ...
  public final int validateNAPClient(int i, int i2, boolean z, String str) {
    ...
    if (packageNameForUid == null) {
      Log.d(
          "NetworkAnalytics:Service", "validateNAPClient: NAP client caller cannot be validated.");
      return -12;
    }
  ...
  public final int _validateNAPClient(String str, int i, String str2) {
    ...
    if (packageCertForPkgname != null && packageCertForPkgname.length() > 0) {
      if ("ALL_REGISTERED_PROFILES_FOR_CLIENT".equals(str2)) {
        validatePkgSignForSingleProfile =
            this.mConfigStore.validatePkgSignForAllProfiles(str, packageCertForPkgname);
      } else {
        validatePkgSignForSingleProfile =
            this.mConfigStore.validatePkgSignForSingleProfile(str, packageCertForPkgname, str2);
      }
      if (!validatePkgSignForSingleProfile) {
        Log.d(
            "NetworkAnalytics:Service",
            "_validateNAPClient: Package signature could not be matched for profile entry/entries");
        return -13;
      }
    }
    if (!DBG) {
  ...
  public final int _bindToClient(
      NetworkAnalyticsServiceConnection networkAnalyticsServiceConnection) {
    boolean z = false;
    long j = 0;
    try {
      try {
        ...
        if (z2) {
          Log.d(
              "NetworkAnalytics:Service",
              "_bindToClient:handlerObj.profileName = " + handlerObject.toString());
        }
        INetworkAnalyticsService binderForPackage =
            this.mConnectionManager.getBinderForPackage(
                getTransformedVendorName(handlerObject.packageName, handlerObject.userId));
        ...
        if (binderForPackage != null) {
          if (asBinder.isBinderAlive()) {
            if (z2) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "_bindToClient:Binder is already available for package = "
                      + handlerObject.packageName);
            }
            return 0;
          }
        ...
        List<ResolveInfo> queryIntentServicesAsUser =
            this.mContext
                .getPackageManager()
                .queryIntentServicesAsUser(intent, 0, handlerObject.userId);
          ...
          for (ResolveInfo resolveInfo : queryIntentServicesAsUser) {
            if (resolveInfo.serviceInfo.packageName.equalsIgnoreCase(handlerObject.packageName)) {
              ...
              if (z3) {
                Log.d(
                    "NetworkAnalytics:Service",
                    "_bindToClient:resolveInfo.serviceInfo.packageName = "
                        + resolveInfo.serviceInfo.packageName);
              }
              if (z3) {
                Log.d(
                    "NetworkAnalytics:Service",
                    "_bindToClient:resolveInfo.serviceInfo.name = " + resolveInfo.serviceInfo.name);
              }
        ...
        z =
            this.mContext.bindServiceAsUser(
                intent, networkAnalyticsServiceConnection, 1, new UserHandle(handlerObject.userId));
        if (DBG) {
    ...
    try {
      if (asyncHandlerObject.userId == -999) {
        if (DBG) {
          Log.d(
              "NetworkAnalytics:Service",
              "_unbindClient: The profile was never activated. Returning.");
          return;
        }
        return;
      }
      NetworkAnalyticsConfigStore.NAPConfigProfile profileforName =
          this.mConfigStore.getProfileforName(asyncHandlerObject.profileName);
      ...
      NetworkAnalyticsServiceConnection serviceConnectionForPackage =
          this.mConnectionManager.getServiceConnectionForPackage(
              getTransformedVendorName(asyncHandlerObject.packageName, asyncHandlerObject.userId));
  ...
  public final void _cleanUpConnectionDetails(AsyncHandlerObject asyncHandlerObject) {
    ...
    if (DBG) {
      Log.d(
          "NetworkAnalytics:Service",
          "_cleanUpConnectionDetails tableKey = " + transformedVendorName);
    }
    ...
    this.mDataDelivery.removeDataRecipientsForPackage(
        asyncHandlerObject.packageName, asyncHandlerObject.userId);
  }
  ...
  public final boolean _activateNAPClient(AsyncHandlerObject asyncHandlerObject, int i, int i2) {
    ...
    if (binderForPackage == null || jsonString == null) {
      if (z) {
        Log.d(
            "NetworkAnalytics:Service",
            "_activateNAPClient: Null values found. INetworkAnalyticsService = "
                + binderForPackage
                + " or json = "
                + jsonString);
      }
    ...
    try {
      if (1 == i) {
        ...
        if (z) {
          Log.d(
              "NetworkAnalytics:Service",
              "_activateNAPClient: Device unique Key = " + deviceUniqueKey);
        }
    ...
    try {
      if (1 == i2) {
        ...
        if (z3) {
          Log.d(
              "NetworkAnalytics:Service",
              "_bindAndActivate:PROFILE_ACTIVATED: Doing bind and activate.");
        }
        NetworkAnalyticsServiceConnection networkAnalyticsServiceConnection =
            new NetworkAnalyticsServiceConnection(asyncHandlerObject);
        ...
        if (-1 == _bindToClient) {
          if (z3) {
            Log.d(
                "NetworkAnalytics:Service",
                "_bindAndActivate:PROFILE_ACTIVATED: _bindToClient did not succeed");
          }
          if (iStatusCallback != null) {
            iStatusCallback.onCallComplete(-11);
            return;
        ...
        if (_bindToClient == 0) {
          if (this.mConnectionManager.isProfilePresentForPackage(
              getTransformedVendorName(asyncHandlerObject.packageName, asyncHandlerObject.userId),
              getTransformedVendorName(asyncHandlerObject.profileName, i))) {
          ...
          if (z3) {
            Log.d(
                "NetworkAnalytics:Service",
                "_bindAndActivate:PROFILE_ACTIVATED: Honoring previous bind.");
          }
          networkAnalyticsServiceConnection =
              this.mConnectionManager.getServiceConnectionForPackage(
                  getTransformedVendorName(
                      asyncHandlerObject.packageName, asyncHandlerObject.userId));
          await = true;
        } else {
          await =
              networkAnalyticsServiceConnection.countDownLatch.await(3000L, TimeUnit.MILLISECONDS);
        }
        ...
        if (!await || _bindToClient < 0) {
          ...
          if (z3) {
            Log.d(
                "NetworkAnalytics:Service",
                "_bindAndActivate:PROFILE_ACTIVATED: _bindToClient & countdown: "
                    + asyncHandlerObject.toString());
          }
          ...
          Log.d(
              "NetworkAnalytics:Service",
              "_bindAndActivate:PROFILE_ACTIVATED: Adding to data delivery");
          int i4 = asyncHandlerObject.userId;
          if (i4 == 0) {
            allProfilesForUser =
                this.mConfigStore.getAllProfilesForPackage(asyncHandlerObject.packageName);
          } else {
          ...
          if (allProfilesForUser == null) {
            Log.d(
                "NetworkAnalytics:Service",
                "_bindAndActivate: no profile found for user. Not adding profile to recipient list"
                    + " on NetworkAnalyticsDataDelivery");
            return;
          }
          for (NetworkAnalyticsConfigStore.NAPConfigProfile nAPConfigProfile : allProfilesForUser) {
            if (nAPConfigProfile.getPackageName().equalsIgnoreCase(asyncHandlerObject.packageName)
                && nAPConfigProfile.getUserId() == asyncHandlerObject.userId
                && this.mConfigStore.isProfileActivatedForUser(
                        nAPConfigProfile.getProfileName(), nAPConfigProfile.getOpUserId())
                    == 1) {
              DataDeliveryHelper dataDeliveryHelper =
                  new DataDeliveryHelper(
                      nAPConfigProfile,
                      networkAnalyticsServiceConnection,
                      nAPConfigProfile.getOpUserId());
              Log.d(
                  "NetworkAnalytics:Service",
                  "Adding the profile to the delivery list _bindAndActivate "
                      + nAPConfigProfile.getProfileName());
          ...
          if (EdmConstants.getEnterpriseKnoxSdkVersion().getInternalVersion() != null) {
            if (versionCompare(
              ...
              if (this.mDriver.openCharDevice(0) < 0) {
                Log.i(
                    "NetworkAnalytics:Service",
                    "_bindAndActivate:PROFILE_ACTIVATED:Opening of character device failed.");
                return;
              }
            ...
            this.mConnectionManager.addProfileForPackage(
                getTransformedVendorName(asyncHandlerObject.packageName, asyncHandlerObject.userId),
                getTransformedVendorName(asyncHandlerObject.profileName, i));
            NetworkAnalyticsConfigStore.NAPConfigProfile profileforName =
                this.mConfigStore.getProfileforName(asyncHandlerObject.profileName);
            if (profileforName == null) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "_bindAndActivate: no profile found. Not begining to record data");
              return;
            }
            if (this.mDriver.checkNcmVersionMismatch() < 0) {
              if (activateProfile(profileforName, 0) < 0) {
                Log.d(
                    "NetworkAnalytics:Service",
                    "_bindAndActivate: version mismatch deactivation failed for profile : "
                        + asyncHandlerObject.profileName
                        + " but data collection will not happen.");
                return;
              }
              sendMessageToHandler(1, 0, profileforName.getOpUserId(), asyncHandlerObject);
              Log.d(
                  "NetworkAnalytics:Service",
                  "_bindAndActivate:PROFILE_ACTIVATED:Version mismatch between user and kernel"
                      + " space. Deactivated this profile : "
                      + asyncHandlerObject.profileName);
              return;
            }
            NetworkAnalyticsConfigStore.NAPProfileActivation activeStateForName =
                this.mConfigStore.getActiveStateForName(
                    getTransformedVendorName(
                        profileforName.getProfileName(), profileforName.getOpUserId()));
            if (activeStateForName == null) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "_bindAndActivate: no active profile found. Not begining to record data");
              return;
            }
            ...
            if (activationFlowType == 0
                && activationIntervalValue >= 60
                && activationIntervalValue <= 14400
                && this.mDriver.setIntervalValueForFlow(activationIntervalValue) < 0) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "_bindAndActivate: set interval value and deactivation failed for profile : "
                      + asyncHandlerObject.profileName
                      + " but data collection will not happen.");
              return;
            }
        ...
        if (DBG) {
          Log.d(
              "NetworkAnalytics:Service",
              "_bindAndActivate:PROFILE_ACTIVATED: bind and activate complete.");
          return;
        }
        return;
      }
      ...
      if (z4) {
        Log.d(
            "NetworkAnalytics:Service",
            "_bindAndActivate:PROFILE_NOT_ACTIVATED: Doing deactivate and unbind.");
      }
      boolean _activateNAPClient = _activateNAPClient(asyncHandlerObject, 0, i);
      if (!_activateNAPClient && z4) {
        Log.d(
            "NetworkAnalytics:Service",
            "_bindAndActivate:PROFILE_NOT_ACTIVATED: deactivate did not succeed");
      }
      this.mConnectionManager.removeProfileForPackage(
          getTransformedVendorName(asyncHandlerObject.packageName, asyncHandlerObject.userId),
          getTransformedVendorName(asyncHandlerObject.profileName, i));
      ...
      if (this.mConnectionManager.getActiveProfilesNumber() <= 0) {
        if (z4) {
          Log.d(
              "NetworkAnalytics:Service",
              "_bindAndActivate:PROFILE_NOT_ACTIVATED: Will stop data recording.");
        }
      ...
      if (z4) {
        Log.d(
            "NetworkAnalytics:Service",
            "_bindAndActivate:PROFILE_NOT_ACTIVATED: deactivate complete: " + _activateNAPClient);
      }
    } catch (RemoteException e) {
  ...
  public final void _bindAndActivate(String str, boolean z) {
    ...
    if (z2) {
      Log.d(
          "NetworkAnalytics:Service",
          "_bindAndActivate:ACTION_INITIALIZE_NAP: adding profile: " + str);
    }
    NetworkAnalyticsConfigStore.NAPProfileActivation activeStateForName =
        this.mConfigStore.getActiveStateForName(str);
    if (activeStateForName == null) {
      if (z2) {
        Log.d(
            "NetworkAnalytics:Service",
            "_bindAndActivate: ERROR NAPActivationProfile is null for profile: " + str);
        return;
      }
      return;
    }
    if (activeStateForName.getActivationState() == 0) {
      if (z2) {
        Log.d(
            "NetworkAnalytics:Service",
            "_bindAndActivate: ERROR NAPActivationProfile is not activated. No need to bind.");
        return;
      }
      return;
    }
    ...
    if (profile == null) {
      if (z2) {
        Log.d(
            "NetworkAnalytics:Service",
            "_bindAndActivate: ERROR NAPConfigProfile is null for profile: " + str);
        return;
      }
      return;
    }
    if (!z
        || validateNAPClient(
                profile.getPackageName(), profile.getPackageSignature(), profile.getUserId())
            >= 0) {
      AsyncHandlerObject asyncHandlerObject = new AsyncHandlerObject();
    ...
    if (z2) {
      Log.d(
          "NetworkAnalytics:Service",
          "_bindAndActivate: ERROR Valid package has not been installed: "
  ...
  public final void _bindAndActivateOnReboot() {
    ...
    if (DBG) {
      Log.d(
          "NetworkAnalytics:Service",
          "_bindAndActivateOnReboot:ACTION_INITIALIZE_NAP: Found profile sizes "
              + setActivatedProfiles.size());
    }
    setFeatureProperty(true);
    Iterator it = setActivatedProfiles.iterator();
    while (it.hasNext()) {
    ...
    for (String str : setActivatedProfiles) {
      ...
      if (activeStateForName == null) {
        if (DBG) {
          Log.d(
              "NetworkAnalytics:Service",
              "_bindAndActivateOnReboot: ERROR NAPActivationProfile is null for profile: " + str);
        }
      } else {
        NetworkAnalyticsConfigStore.NAPConfigProfile profile = activeStateForName.getProfile();
        if (profile == null) {
          if (DBG) {
            Log.d(
                "NetworkAnalytics:Service",
                "_bindAndActivateOnReboot: ERROR NAPConfigProfile is null for profile: " + str);
          }
  ...
  public final void _unregisterAllProfiles(int i) {
    ...
    if (DBG) {
      Log.d(
          "NetworkAnalytics:Service",
          "_unregisterAllProfiles: Found profile sizes " + clientProfileNames.size());
    }
  ...
  public final void _deactivateAllProfiles() {
    ...
    if (DBG) {
      Log.d(
          "NetworkAnalytics:Service",
          "_deactivateAllProfiles: Found profile sizes " + setActivatedProfiles.size());
    }
    setFeatureProperty(false);
    Iterator it = setActivatedProfiles.iterator();
    while (it.hasNext()) {
  ...
  public final void _deactivateAllProfiles(int i) {
    ...
    if (DBG) {
      Log.d(
          "NetworkAnalytics:Service",
          "_deactivateAllConnections: Found profile sizes " + setActivatedProfiles.size());
    }
    for (String str : setActivatedProfiles) {
      boolean z = DBG;
      if (z) {
        Log.d(
            "NetworkAnalytics:Service",
            "_deactivateAllProfiles:ACTION_INITIALIZE_NAP: adding profile: " + str);
      }
      NetworkAnalyticsConfigStore.NAPProfileActivation activeStateForName =
          this.mConfigStore.getActiveStateForName(str);
      if (activeStateForName == null) {
        if (z) {
          Log.d(
              "NetworkAnalytics:Service",
              "_deactivateAllProfiles: ERROR NAPActivationProfile is null for profile: " + str);
        }
        ...
        if (profile == null) {
          if (z) {
            Log.d(
                "NetworkAnalytics:Service",
                "_deactivateAllProfiles: ERROR NAPConfigProfile is null for profile: " + str);
          }
          ...
          Log.d(
              "NetworkAnalytics:Service",
              "_deactivateAllProfiles: ERROR deactivateProfile for profile: " + str);
        }
      } else if (z) {
        Log.d(
            "NetworkAnalytics:Service",
            "_deactivateAllProfiles: ERROR Not the same adminUid: " + i);
      }
    }
  }
  ...
  public final void _handleNewProfileRegistration(String str) {
    ...
    if (profileforName == null) {
      if (DBG) {
        Log.d(
            "NetworkAnalytics:Service",
            "_handleNewProfileRegistration: profile is null for name:" + str);
        return;
      }
      return;
    }
    ...
    if (this.mConfigStore.isActivatedPackage(packageName)) {
      ...
      if (z) {
        Log.d(
            "NetworkAnalytics:Service", "_handleNewProfileRegistration: profile activated:" + str);
      }
      ...
      if (userIdLocationOfPackage < 0) {
        if (z) {
          Log.d(
              "NetworkAnalytics:Service",
              "_handleNewProfileRegistration: bind userId location fail for:"
                  + profileforName.toString());
          return;
        }
        return;
      }
      if (this.mConfigStore.updateBindUserIdForProfile(
              str, profileforName.getOpUserId(), userIdLocationOfPackage)
          < 0) {
        if (z) {
          Log.d(
              "NetworkAnalytics:Service",
              "_handleNewProfileRegistration: bind userId updation failed for profile:"
                  + profileforName.toString());
          return;
        }
        return;
      ...
      if (activateProfile(profileforName, 1) < 0) {
        if (z) {
          Log.d(
              "NetworkAnalytics:Service",
              "_handleNewProfileRegistration: activation failed for profile:"
                  + profileforName.toString());
          return;
        }
        return;
  ...
  public final void _packageAddedAction(String str, int i) {
    try {
      ...
      if (z) {
        Log.d(
            "NetworkAnalytics:Service",
            "_packageAddedAction activatedProfiles.size() = " + allActiveKeysForPackage.size());
      }
      for (String str2 : allActiveKeysForPackage) {
        NetworkAnalyticsConfigStore.NAPProfileActivation activeStateForName =
            this.mConfigStore.getActiveStateForName(str2);
        if (activeStateForName != null) {
          if (DBG) {
          ...
          if (profile.getUserId() == i) {
            if (this.mConfigStore.validatePkgSignForSingleProfile(
                str, getPackageCertForPkgname(i, str), profile.getProfileName())) {
              AsyncHandlerObject asyncHandlerObject = new AsyncHandlerObject();
              asyncHandlerObject.profileName = profile.getProfileName();
              asyncHandlerObject.packageName = profile.getPackageName();
              asyncHandlerObject.userId = profile.getUserId();
              ...
              Log.d(
                  "NetworkAnalytics:Service",
                  "__packageAddedAction: Package signature could not be matched for profile entry :"
                      + " "
      ...
      for (String str2 : allActiveKeysForPackage) {
        ...
        if (activeStateForName != null) {
          if (DBG) {
            Log.d(
                "NetworkAnalytics:Service",
                "_packageRemovedAction: DEACTIVATING FOR PACKAGE REMOVED.");
          }
          NetworkAnalyticsConfigStore.NAPConfigProfile profile = activeStateForName.getProfile();
          if (profile.getUserId() == i) {
            AsyncHandlerObject asyncHandlerObject = new AsyncHandlerObject();
  ...
  public final ContextInfo enforceNetworkAnalyticsPermission(ContextInfo contextInfo) {
    Log.d(
        "NetworkAnalytics:Service",
        "enforceNetworkAnalyticsPermission: knox version above 3.0. Validating NPA Permission");
    return getEDM()
        .enforceActiveAdminPermissionByContext(
            contextInfo, "com.samsung.android.knox.permission.KNOX_NPA");
  }
  ...
  public final void _userRemovedAction(Bundle bundle) {
    ...
    List<NetworkAnalyticsConfigStore.NAPConfigProfile> allProfilesForUser =
        this.mConfigStore.getAllProfilesForUser(i);
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:Service",
          "_userRemovedAction: List of profiles for removed userId is "
              + allProfilesForUser.size());
    }
    for (NetworkAnalyticsConfigStore.NAPConfigProfile nAPConfigProfile : allProfilesForUser) {
      unregisterNetworkMonitorProfile(
          nAPConfigProfile.getAdminUid(), nAPConfigProfile.getProfileName());
    }
  }
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (action.equalsIgnoreCase("android.intent.action.PACKAGE_REMOVED")) {
        ...
        if (z) {
          Log.d(
              "NetworkAnalytics:Service",
              "ACTION PACKAGE REMOVED packageName : " + schemeSpecificPart + " uid : " + i);
        }
        int userId = UserHandle.getUserId(i);
        NetworkAnalyticsDataDelivery.updateHashCache(i, schemeSpecificPart);
        boolean isActivatedPackage =
            NetworkAnalyticsService.this.mConfigStore.isActivatedPackage(schemeSpecificPart);
        ...
        if (intent.getBooleanExtra("android.intent.extra.REPLACING", false)) {
          Log.d(
              "NetworkAnalytics:Service",
              "The package removal intent has been called before upgrade");
          return;
        }
        AsyncHandlerObject asyncHandlerObject =
            NetworkAnalyticsService.this.new AsyncHandlerObject();
      ...
      if (action.equalsIgnoreCase("android.intent.action.PACKAGE_ADDED")) {
        ...
        if (z) {
          Log.d(
              "NetworkAnalytics:Service",
              "ACTION PACKAGE ADDED packageName : " + schemeSpecificPart);
        }
        int userId2 =
            UserHandle.getUserId(intent.getExtras().getInt("android.intent.extra.UID", 0));
        boolean isActivatedPackage2 =
            NetworkAnalyticsService.this.mConfigStore.isActivatedPackage(schemeSpecificPart);
        if (schemeSpecificPart == null || !isActivatedPackage2) {
          return;
        }
        AsyncHandlerObject asyncHandlerObject2 =
            NetworkAnalyticsService.this.new AsyncHandlerObject();
    ...
    public void handleMessage(Message message) {
      switch (message.what) {
        case 1:
          ...
          if (asyncHandlerObject == null) {
            if (NetworkAnalyticsService.DBG) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "handleMessage:ACTIVATE_MONITOR_CLIENT:handleObj null");
              break;
            }
          } else {
        ...
        case 6:
          ...
          NetworkAnalyticsService.this._packageRemovedAction(
              asyncHandlerObject2.packageName, asyncHandlerObject2.userId);
          break;
        case 7:
          AsyncHandlerObject asyncHandlerObject3 = (AsyncHandlerObject) message.obj;
          NetworkAnalyticsService.this._packageAddedAction(
              asyncHandlerObject3.packageName, asyncHandlerObject3.userId);
          break;
        case 8:
          int i3 = message.arg1;
          if (i3 <= 0) {
            if (NetworkAnalyticsService.DBG) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "handleMessage: ACTION_ON_PRE_ADMIN_REMOVED: Invalid adminUid");
              break;
            }
          } else {
        ...
        case 9:
          ...
          if (i4 <= 0) {
            if (NetworkAnalyticsService.DBG) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "handleMessage: ACTION_ON_ADMIN_REMOVED: Invalid adminUid");
              break;
            }
          } else {
            ...
            if (i5 != 5) {
              if (i5 == 3) {
                if (NetworkAnalyticsService.DBG) {
                  Log.d(
                      "NetworkAnalytics:Service",
                      "handleMessage: ACTION_ULTRA_POWER_SAVING_MODE ON");
                }
              ...
              if (NetworkAnalyticsService.DBG) {
                Log.d(
                    "NetworkAnalytics:Service",
                    "handleMessage: ACTION_ULTRA_POWER_SAVING_MODE OFF");
              }
  ...
  public class NetworkAnalyticsServiceConnection implements ServiceConnection {
    ...
    public synchronized void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      ...
      String transformedVendorName =
          NetworkAnalyticsService.getTransformedVendorName(
              asyncHandlerObject.packageName, asyncHandlerObject.userId);
      ...
      if (this.handleObj.userId == 0) {
        allProfilesForUser =
            NetworkAnalyticsService.this.mConfigStore.getAllProfilesForPackage(
                this.handleObj.packageName);
      } else {
        allProfilesForUser =
            NetworkAnalyticsService.this.mConfigStore.getAllProfilesForUser(this.handleObj.userId);
      }
      if (allProfilesForUser == null) {
        return;
      }
      for (NetworkAnalyticsConfigStore.NAPConfigProfile nAPConfigProfile : allProfilesForUser) {
        if (nAPConfigProfile.getPackageName().equalsIgnoreCase(this.handleObj.packageName)
            && nAPConfigProfile.getUserId() == this.handleObj.userId
            && NetworkAnalyticsService.this.mConfigStore.isProfileActivatedForUser(
                    nAPConfigProfile.getProfileName(), nAPConfigProfile.getOpUserId())
                == 1) {
          DataDeliveryHelper dataDeliveryHelper =
              new DataDeliveryHelper(nAPConfigProfile, this, nAPConfigProfile.getOpUserId());
          Log.d(
              "NetworkAnalytics:Service",
              "Adding the profile to the delivery list onServiceconnected callback "
                  + nAPConfigProfile.getProfileName());
          NetworkAnalyticsService.this.mDataDelivery.addNAPDataRecipient(dataDeliveryHelper);
        }
      }
      NetworkAnalyticsService.this.mConnectionManager.storeBinderForPackage(
          transformedVendorName, this);
    ...
    public synchronized void onServiceDisconnected(ComponentName componentName) {
      ...
      NetworkAnalyticsDataDelivery networkAnalyticsDataDelivery =
          NetworkAnalyticsService.this.mDataDelivery;
      AsyncHandlerObject asyncHandlerObject2 = this.handleObj;
      networkAnalyticsDataDelivery.removeDataRecipientsForPackage(
          asyncHandlerObject2.packageName, asyncHandlerObject2.userId);
    }
    ...
    public synchronized void onBindingDied(ComponentName componentName) {
      ...
      for (NetworkAnalyticsConfigStore.NAPConfigProfile nAPConfigProfile : allProfilesForUser) {
        if (nAPConfigProfile.getPackageName().equalsIgnoreCase(this.handleObj.packageName)
            && nAPConfigProfile.getUserId() == this.handleObj.userId
            && (transformedVendorName =
                    NetworkAnalyticsService.getTransformedVendorName(
                        nAPConfigProfile.getProfileName(), nAPConfigProfile.getOpUserId()))
                != null) {
          Log.d(
              "NetworkAnalytics:Service",
              "Trying to bind again after the onBindingDied for the profile "
                  + transformedVendorName);
  ...
  public final void constructObjectForBroadcast(int i, int i2, String str) {
    try {
      String profileObjectFromJson =
          this.mConfigStore.getProfileObjectFromJson("profile_name", str);
      String profileObjectFromJson2 =
          this.mConfigStore.getProfileObjectFromJson("package_name", str);
      String profileObjectFromJson3 =
          this.mConfigStore.getProfileObjectFromJson("package_signature", str);
      ...
      Log.e(
          "NetworkAnalytics:Service",
          "Error occured while constructing the profile object for broadcast");
    }
  }
  ...
  public final void sendStatusToClient(Bundle bundle) {
    ...
    try {
      try {
        ...
        Log.d(
            "NetworkAnalytics:Service",
            "The System is going to send broadcast of the profile status " + intValue2);
        if (IPackageManager.Stub.asInterface(ServiceManager.getService("package"))
            .isPackageAvailable(str2, intValue)) {
          Log.d(
              "NetworkAnalytics:Service",
              "The package " + str2 + " has been installed in the user space " + intValue);
            ...
            if (DBG) {
              Log.d(
                  ...
                  "The signature of the package "
                      ...
                      + intValue
                      + "confirmed by OS is "
                      + packageCertForPkgname);
            }
            if (packageCertForPkgname.equalsIgnoreCase(str3)) {
              Log.d(
                  "NetworkAnalytics:Service",
                  "The signature mentioned by the admin and the signature of the package present in"
                      + " the device matches");
              Intent intent = new Intent("com.samsung.android.knox.intent.action.NPA_STATUS");
              intent.putExtra(
                  "com.samsung.android.knox.intent.extra.REGISTRATION_STATUS", intValue2);
        ...
        Log.e(
            "NetworkAnalytics:Service",
            "Null pointer exception error occured while trying to send the NPA profile status to"
                + " the client");
      } catch (Exception unused2) {
        Log.e(
            "NetworkAnalytics:Service",
            "Error occured while trying to send the NPA profile status to the client");
      }
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
