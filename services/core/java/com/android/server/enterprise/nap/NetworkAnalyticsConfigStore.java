...
public final class NetworkAnalyticsConfigStore {
    ...
    public static NetworkAnalyticsConfigStore getInstance(
        ...
        if (mInstance == null) {
            NetworkAnalyticsConfigStore networkAnalyticsConfigStore =
                    new NetworkAnalyticsConfigStore();
    ...
    public final int activateProfile(int i, int i2, int i3, String str) {
        ...
        if (1 == i3) {
            contentValues.put(
                    "intervalValue", Integer.valueOf(nAPConfigProfile.intervalValueForProfile));
        } else if (i3 == 0) {
        ...
        i4 =
                NetworkAnalyticsStorageHelper.mEDM.update(
                        "NAPProfileTable", contentValues, contentValues2);
        if (z) {
        ...
        if (i4 > 0) {
            if (this.activationMap.containsKey(transformedVendorName)) {
                ...
                if (1 == i3) {
                    nAPProfileActivation.activationIntervalValue =
                            nAPConfigProfile.intervalValueForProfile;
                } else if (i3 == 0) {
                ...
                if (1 == i3) {
                    nAPProfileActivation2.activationIntervalValue =
                            nAPConfigProfile.intervalValueForProfile;
                } else if (i3 == 0) {
        ...
        if (z) {
            NetworkScorerAppManager$$ExternalSyntheticOutline0.m(
                    i4, "activateProfile: final returnStatus = ", "NetworkAnalytics:ConfigStore");
        }
        return i4;
    }
    ...
    public final int addProfileToDatabase(int i, JSONObject jSONObject, String str, int i2) {
        ...
        ContentValues m =
                AccountManagerService$$ExternalSyntheticOutline0.m("profileName", optString);
        Pageboost$PageboostFileDBHelper$$ExternalSyntheticOutline0.m(
                -999, m, "client_userid", i2, "op_userid");
        KnoxMUMContainerPolicy$$ExternalSyntheticOutline0.m(
                i, m, "adminUid", "pkgName", optString2);
        m.put("pkgSign", optString3);
        m.put("flags", Integer.valueOf(optInt));
        m.put("jsondata", str);
        m.put("activeState", (Integer) 0);
        Pageboost$PageboostFileDBHelper$$ExternalSyntheticOutline0.m(
                -999, m, "flowType", -999, "intervalValue");
        this.mStorageHelper.getClass();
        boolean putDataByFields =
                NetworkAnalyticsStorageHelper.mEDM.putDataByFields(
                        "NAPProfileTable", null, null, m);
        boolean z = DBG;
        if (z) {
            AccessibilityManagerService$$ExternalSyntheticOutline0.m(
                    "addProfileToDatabase: Added to database:",
                    "NetworkAnalytics:ConfigStore",
                    putDataByFields);
        }
        if (putDataByFields) {
        ...
        if (z) {
            NetworkScorerAppManager$$ExternalSyntheticOutline0.m(
                    i3, "addProfileToDatabase: returnValue = ", "NetworkAnalytics:ConfigStore");
        }
        return i3;
    }
    ...
    public final int doesAdminOwnProfile(int i, String str) {
        ...
        if (nAPConfigProfile == null) {
            DualAppManagerService$$ExternalSyntheticOutline0.m(
                    "doesAdminOwnProfile: Profile name not found ",
                    str,
                    "NetworkAnalytics:ConfigStore");
            return -3;
        }
        ...
        NetworkScoreService$$ExternalSyntheticOutline0.m(
                i,
                "doesAdminOwnProfile: Profile ",
                str,
                " does not belong to adminUid ",
                "NetworkAnalytics:ConfigStore");
        return -7;
    }
    ...
    public final NAPProfileActivation getActiveStateForName(String str) {
        ...
        NAPProfileActivation nAPProfileActivation =
                (NAPProfileActivation) this.activationMap.get(str);
    ...
    public final List getAllActiveKeysForPackage(String str) {
        ...
        for (String str2 : keySet) {
            ...
            if (nAPProfileActivation != null
                    && nAPProfileActivation.profile.packageName.equals(str)
                    && 1 == nAPProfileActivation.activationState) {
                if (DBG) {
                    DualAppManagerService$$ExternalSyntheticOutline0.m(
                            "getAllActiveKeysForPackage: Adding active key for profile",
                            str2,
                            "NetworkAnalytics:ConfigStore");
                }
                arrayList.add(str2);
    ...
    public final List getAllActiveKeysForProfile(String str) {
        ...
        ArrayList arrayList = new ArrayList();
        for (String str2 : keySet) {
            if (str2.substring(0, str2.indexOf("__")).equals(str)
                    && (nAPProfileActivation = (NAPProfileActivation) this.activationMap.get(str2))
                            != null
                    && 1 == nAPProfileActivation.activationState) {
                if (DBG) {
                    Log.d(
                            "NetworkAnalytics:ConfigStore",
                            "getAllActiveKeysForProfile: Adding active key for profile"
                                    .concat(str2));
                }
                arrayList.add(str2);
            }
                            ...
                            (NAPProfileActivation)
                                    this.activationMap.get(
                                            NetworkAnalyticsService.getTransformedVendorName(
                                                    i2, nAPConfigProfile.profileName));
                    arrayList.add(
                            new Profile(
                                    nAPProfileActivation == null
                                            ? 0
                                            : nAPProfileActivation.activationState,
                                    nAPConfigProfile.jsonString,
                                    i2));
                }
            }
        }
    ...
    */
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.enterprise.nap.NetworkAnalyticsConfigStore.initializeTables():void");
    }
    ...
    public final boolean isActivatedPackage(String str) {
        ...
        if (keySet != null && keySet.size() > 0) {
            ...
            while (it.hasNext()) {
                ...
                if (nAPProfileActivation != null
                        && (nAPConfigProfile = nAPProfileActivation.profile) != null
    ...
    public final int isProfileActivatedForUser(int i, String str) {
        ...
        if (!this.activationMap.containsKey(transformedVendorName)
                || (nAPProfileActivation =
                                (NAPProfileActivation)
                                        this.activationMap.get(transformedVendorName))
                        == null) {
            return 0;
        }
    ...
    public final int removeProfileFromDatabase(int i, String str) {
        if (this.profileMap.get(str) == null) {
            DualAppManagerService$$ExternalSyntheticOutline0.m(
                    "removeProfileFromDatabase: Profile name not found ",
                    str,
                    "NetworkAnalytics:ConfigStore");
            return -4;
        }
        ...
        boolean deleteDataByFields =
                NetworkAnalyticsStorageHelper.mEDM.deleteDataByFields(
                        "NAPProfileTable", new String[] {"profileName"}, new String[] {str});
        if (DBG) {
            AccessibilityManagerService$$ExternalSyntheticOutline0.m(
                    "removeProfileFromDatabase: deleteDataByFields? ",
                    "NetworkAnalytics:ConfigStore",
                    deleteDataByFields);
        }
    ...
    public final int updateBindUserIdForProfile(int i, int i2, String str) {
        ...
        if (z) {
            NetworkScoreService$$ExternalSyntheticOutline0.m(
                    i2,
                    "updateBindUserIdForProfile updating binduserid for profile:",
                    str,
                    " to:",
                    "NetworkAnalytics:ConfigStore");
        }
        ...
        if (z) {
            NetworkScorerAppManager$$ExternalSyntheticOutline0.m(
                    i3, "updateBindUserIdForProfile returnValue:", "NetworkAnalytics:ConfigStore");
        }
        return i3;
    }
            ...
            if (str2 == null || !str2.equals(str)) {
                ...
                if (z) {
                    VpnManagerService$$ExternalSyntheticOutline0.m(
                            new StringBuilder("updateTablesForProfileRemoval: profile found "),
        ...
        for (String str3 : this.activationMap.keySet()) {
            if (str3.substring(0, str3.indexOf("__")).equals(str)) {
                if (z) {
                    Log.d(
                            "NetworkAnalytics:ConfigStore",
                            "updateTablesForProfileRemoval: removing from activation map "
                                    .concat(str3));
                }
    ...
    public final int validateJsonContent(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            ...
            if (this.profileMap.get(optString) != null) {
                DualAppManagerService$$ExternalSyntheticOutline0.m(
                        "validateJsonContent: Profile name already exists ",
                        optString,
                        "NetworkAnalytics:ConfigStore");
                return -6;
            }
