...
public class NetworkAnalyticsConfigStore {
  ...
  public static NetworkAnalyticsConfigStore getInstance(
  ...
  public int addProfileToDatabase(int i, JSONObject jSONObject, String str, int i2) {
    ...
    boolean putDataByFields =
        this.mStorageHelper.putDataByFields("NAPProfileTable", null, null, contentValues);
    boolean z = DBG;
    if (z) {
      Log.d(
          "NetworkAnalytics:ConfigStore",
          "addProfileToDatabase: Added to database:" + putDataByFields);
    }
    if (putDataByFields) {
      ...
      if (this.adminToProfileMap.get(Integer.valueOf(i)) == null) {
        if (z) {
          Log.d(
              "NetworkAnalytics:ConfigStore",
              "addProfileToDatabase: adminToProfileMap.get(adminUid) = null");
        }
        ...
        if (z) {
          Log.d(
              "NetworkAnalytics:ConfigStore",
              "addProfileToDatabase: adminToProfileMap.get(adminUid) is present");
        }
  ...
  public int validateJsonContent(JSONObject jSONObject) {
    ...
    if (jSONObject != null) {
      ...
      if (this.profileMap.get(optString) != null) {
        Log.d(
            "NetworkAnalytics:ConfigStore",
            "validateJsonContent: Profile name already exists " + optString);
        return -6;
      }
      String optString2 = jSONObject.optString("package_name", null);
      String optString3 = jSONObject.optString("package_signature", null);
      ...
      if (optString2 == null || optString3 == null || optInt < 0) {
        Log.d(
            "NetworkAnalytics:ConfigStore",
            "validateJsonContent: Invalid flags or packageName or signature.");
        return -5;
      }
    }
    return 0;
  ...
  public List getClientProfileNames(int i) {
    if (this.adminToProfileMap.get(Integer.valueOf(i)) == null
        || ((List) this.adminToProfileMap.get(Integer.valueOf(i))).size() <= 0) {
      return null;
    }
    ArrayList arrayList = new ArrayList();
  ...
  public List getClientProfiles(int i, int i2) {
    ...
    ArrayList arrayList = new ArrayList();
    for (NAPConfigProfile nAPConfigProfile :
        (List) this.adminToProfileMap.get(Integer.valueOf(i))) {
  ...
  public List getClientProfiles(String str, int i) {
    ...
    while (it.hasNext()) {
      NAPConfigProfile nAPConfigProfile =
          (NAPConfigProfile) this.profileMap.get((String) it.next());
      if (nAPConfigProfile != null
          && nAPConfigProfile.getPackageName().equals(str)
          && (i == 0 || i == nAPConfigProfile.getOpUserId())) {
        NAPProfileActivation nAPProfileActivation =
            (NAPProfileActivation)
                this.activationMap.get(
                    NetworkAnalyticsService.getTransformedVendorName(
                        nAPConfigProfile.getProfileName(), nAPConfigProfile.getOpUserId()));
        arrayList.add(
            new Profile(
                nAPProfileActivation == null ? 0 : nAPProfileActivation.getActivationState(),
                nAPConfigProfile.getJsonString(),
  ...
  public int removeProfileFromDatabase(int i, String str) {
    if (this.profileMap.get(str) == null) {
      Log.d(
          "NetworkAnalytics:ConfigStore",
          "removeProfileFromDatabase: Profile name not found " + str);
      return -4;
    }
    boolean deleteDataByFields =
        this.mStorageHelper.deleteDataByFields(
            "NAPProfileTable", new String[] {"profileName"}, new String[] {str});
    if (DBG) {
      Log.d(
          "NetworkAnalytics:ConfigStore",
          "removeProfileFromDatabase: deleteDataByFields? " + deleteDataByFields);
    }
  ...
  public void updateTablesForProfileRemoval(int i, String str) {
    ...
    while (true) {
      ...
      if (nAPConfigProfile.getProfileName() == null
          || !nAPConfigProfile.getProfileName().equals(str)) {
        i2++;
      } else {
        if (DBG) {
          Log.d(
              "NetworkAnalytics:ConfigStore",
              "updateTablesForProfileRemoval: profile found " + nAPConfigProfile.getProfileName());
        }
    ...
    for (String str2 : this.activationMap.keySet()) {
      if (NetworkAnalyticsService.getVendorNameFromTransformedName(str2).equals(str)) {
        if (DBG) {
          Log.d(
              "NetworkAnalytics:ConfigStore",
              "updateTablesForProfileRemoval: removing from activation map " + str2);
        }
  ...
  public int activateProfile(int i, String str, int i2, int i3) {
    ...
    if (1 == i3) {
      contentValues.put(
          "intervalValue", Integer.valueOf(nAPConfigProfile.getIntervalValueForProfile()));
    } else if (i3 == 0) {
      contentValues.put("intervalValue", (Integer) (-999));
    }
    ...
    if (i4 > 0) {
      if (this.activationMap.containsKey(transformedVendorName)) {
        NAPProfileActivation nAPProfileActivation =
            (NAPProfileActivation) this.activationMap.get(transformedVendorName);
        ...
        if (1 == i3) {
          nAPProfileActivation.setActivationIntervalValue(
              nAPConfigProfile.getIntervalValueForProfile());
        } else if (i3 == 0) {
          nAPProfileActivation.setActivationIntervalValue(-999);
        }
      } else {
        NAPProfileActivation nAPProfileActivation2 =
            new NAPProfileActivation((NAPConfigProfile) this.profileMap.get(str), i);
        ...
        if (1 == i3) {
          nAPProfileActivation2.setActivationIntervalValue(
              nAPConfigProfile.getIntervalValueForProfile());
        } else if (i3 == 0) {
  ...
  public int updateBindUserIdForProfile(String str, int i, int i2) {
    if (DBG) {
      Log.d(
          "NetworkAnalytics:ConfigStore",
          "updateBindUserIdForProfile updating binduserid for profile:" + str + " to:" + i2);
    }
    int i3 = -1;
    try {
      ContentValues contentValues = new ContentValues();
    ...
    if (i3 < 0) {
      Log.d(
          "NetworkAnalytics:ConfigStore",
          "updateBindUserIdForProfile failed with returnValue:" + i3);
      return i3;
    }
    NAPConfigProfile nAPConfigProfile = (NAPConfigProfile) this.profileMap.get(str);
    if (nAPConfigProfile != null) {
      Log.d(
          "NetworkAnalytics:ConfigStore",
          "updateBindUserIdForProfile: Profile userId updated to " + i2);
  ...
  public List getAllProfilesForPackageinUser(String str, int i) {
    ...
    while (it.hasNext()) {
      ...
      if (nAPConfigProfile != null
          && nAPConfigProfile.getPackageName().equals(str)
          && nAPConfigProfile.getOpUserId() == i) {
        arrayList.add(nAPConfigProfile);
      }
    }
    return arrayList;
  ...
  public List getAllActiveKeysForProfile(String str) {
    ...
    for (String str2 : keySet) {
      if (NetworkAnalyticsService.getVendorNameFromTransformedName(str2).equals(str)
          && (nAPProfileActivation = (NAPProfileActivation) this.activationMap.get(str2)) != null
          && 1 == nAPProfileActivation.getActivationState()) {
        if (DBG) {
          Log.d(
              "NetworkAnalytics:ConfigStore",
              "getAllActiveKeysForProfile: Adding active key for profile" + str2);
        }
        arrayList.add(str2);
      }
    }
  ...
  public List getAllActiveKeysForPackage(String str) {
    ...
    for (String str2 : keySet) {
      NAPProfileActivation nAPProfileActivation =
          (NAPProfileActivation) this.activationMap.get(str2);
      if (nAPProfileActivation != null
          && nAPProfileActivation.getProfile().getPackageName().equals(str)
          && 1 == nAPProfileActivation.getActivationState()) {
        if (DBG) {
          Log.d(
              "NetworkAnalytics:ConfigStore",
              "getAllActiveKeysForPackage: Adding active key for profile" + str2);
        }
        arrayList.add(str2);
      }
    }
  ...
  public boolean isActivatedPackage(String str) {
    ...
    if (keySet != null && keySet.size() > 0) {
      ...
      while (it.hasNext()) {
        NAPProfileActivation nAPProfileActivation =
            (NAPProfileActivation) this.activationMap.get((String) it.next());
        if (nAPProfileActivation != null
            && (profile = nAPProfileActivation.getProfile()) != null
            && profile.getPackageName().equals(str)
            && 1 == nAPProfileActivation.getActivationState()) {
          return true;
        }
      }
  ...
  public boolean validatePkgSignForAllProfiles(String str, String str2) {
    ...
    while (it.hasNext()) {
      ...
      if (nAPConfigProfile != null
          && nAPConfigProfile.getPackageName().equals(str)
          && !nAPConfigProfile.getPackageSignature().equals(str2)) {
        if (!DBG) {
          return false;
        }
        Log.d(
            "NetworkAnalytics:ConfigStore",
            "validatePkgSignForAllProfiles: Signatures Dont match!!! ");
        Log.d(
            "NetworkAnalytics:ConfigStore", "validatePkgSignForAllProfiles: Signatures in profile");
    ...
    Log.d(
        "NetworkAnalytics:ConfigStore",
        "validatePkgSignForAllProfiles: Valid package signature for " + str);
    return true;
  }
  ...
  public boolean validatePkgSignForSingleProfile(String str, String str2, String str3) {
    ...
    for (String str4 : this.profileMap.keySet()) {
      if (str4.equals(str3)
          && (nAPConfigProfile = (NAPConfigProfile) this.profileMap.get(str4)) != null
          && nAPConfigProfile.getPackageName().equals(str)
          && !nAPConfigProfile.getPackageSignature().equals(str2)) {
        if (!DBG) {
          return false;
  ...
  public int doesAdminOwnProfile(int i, String str) {
    ...
    Log.d(
        "NetworkAnalytics:ConfigStore",
        "doesAdminOwnProfile: Profile " + str + " does not belong to adminUid " + i);
    return -7;
  }
  ...
  public final void initializeProfileTable() {
    try {
      ArrayList dataByFields =
          this.mStorageHelper.getDataByFields("NAPProfileTable", null, null, null);
      if (dataByFields != null && dataByFields.size() > 0) {
        if (DBG) {
          Log.d(
              "NetworkAnalytics:ConfigStore",
              "initializeProfileTable: Initializing tables. Cursor present.");
        }
        ...
        while (it.hasNext()) {
          ...
          if (DBG) {
            Log.d(
                "NetworkAnalytics:ConfigStore",
                "initializeProfileTable: Config Profile = " + build);
          }
      ...
      Log.e(
          "NetworkAnalytics:ConfigStore",
          "Error while initialize profile table" + Log.getStackTraceString(e));
    }
  }
    ...
    try {
      ...
      if (dataByFields != null && dataByFields.size() > 0) {
        if (DBG) {
          Log.d(
              "NetworkAnalytics:ConfigStore",
              "initializeActivationTable: Initializing tables. Cursor present.");
        }
        Iterator it = dataByFields.iterator();
        while (it.hasNext()) {
          ContentValues contentValues = (ContentValues) it.next();
          ...
          if (DBG) {
            Log.d(
                "NetworkAnalytics:ConfigStore",
                "initializeActivationTable: Config Profile = " + this.profileMap.get(asString));
          }
          NAPProfileActivation nAPProfileActivation =
              new NAPProfileActivation((NAPConfigProfile) this.profileMap.get(asString), intValue2);
          ...
          this.activationMap.put(
              NetworkAnalyticsService.getTransformedVendorName(asString, intValue),
              nAPProfileActivation);
        }
      }
      if (DBG) {
      ...
      Log.e(
          "NetworkAnalytics:ConfigStore",
          "Error while initialize activation table" + Log.getStackTraceString(e));
    }
  }
  ...
  public class Builder {
    ...
    public NAPConfigProfile build() {
      return NetworkAnalyticsConfigStore.this.new NAPConfigProfile(this);
    }
  }
}
