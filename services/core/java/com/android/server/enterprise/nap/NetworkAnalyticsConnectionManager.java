...
public class NetworkAnalyticsConnectionManager {
  ...
  public void storeBinderForPackage(
      String str,
      NetworkAnalyticsService.NetworkAnalyticsServiceConnection networkAnalyticsServiceConnection) {
  ...
  public INetworkAnalyticsService getBinderForPackage(String str) {
    NetworkAnalyticsService.NetworkAnalyticsServiceConnection networkAnalyticsServiceConnection =
        (NetworkAnalyticsService.NetworkAnalyticsServiceConnection) this.binderMap.get(str);
    ...
    if (DBG) {
      Log.d(
          ...
          "getBinderForPackage: binder is not null for " + str);
    }
    return networkAnalyticsServiceConnection.getBinderObject();
  }

  public NetworkAnalyticsService.NetworkAnalyticsServiceConnection getServiceConnectionForPackage(
      String str) {
    NetworkAnalyticsService.NetworkAnalyticsServiceConnection networkAnalyticsServiceConnection =
        (NetworkAnalyticsService.NetworkAnalyticsServiceConnection) this.binderMap.get(str);
    if (networkAnalyticsServiceConnection != null && DBG) {
      Log.d(
          "NetworkAnalytics:ConnectionManager",
          "getServiceConnectionForPackage: service connection is not null for " + str);
    }
  ...
  public boolean isProfilePresentForPackage(String str, String str2) {
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:ConnectionManager",
          "isProfilePresentForPackage for packageName = " + str);
    }
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:ConnectionManager",
          "isProfilePresentForPackage for packageName is = " + contains);
    }
    return contains;
  }
  ...
  public void removeBinderForPackage(String str) {
    if (DBG) {
      Log.d(
          "NetworkAnalytics:ConnectionManager",
          "removeBinderForPackage completely for packageName = " + str);
    }
    this.binderMap.remove(str);
  }
  ...
  public void removeProfileForPackage(String str, String str2) {
    if (DBG) {
      Log.d(
          "NetworkAnalytics:ConnectionManager", "removeProfileForPackage for packageName = " + str);
    }
    List profilesForPackage = getProfilesForPackage(str);
    ...
    if (DBG) {
      Log.d(
          "NetworkAnalytics:ConnectionManager",
          "removeProfileForPackage for activatedProfileCounter = " + this.activatedProfileCounter);
    }
  }
  ...
  public void removeProfileForPackage(String str) {
    ...
    if (z) {
      Log.d(
          "NetworkAnalytics:ConnectionManager",
          "removeProfileForPackage completely for packageName = " + str);
    }
    List profilesForPackage = getProfilesForPackage(str);
    if (profilesForPackage == null) {
      return;
