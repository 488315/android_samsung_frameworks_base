...
public class KnoxNetworkFilterService extends IKnoxNetworkFilterService.Stub
    ...
    if (iNetd != null) {
      try {
        ...
        Log.e(
            ...
            "Failed to get OemNetd listener " + e.getMessage());
      }
    }
  ...
  public synchronized int registerApplication(
      ContextInfo contextInfo, String str, String str2, Bundle bundle) {
    checkCallingUidPermissionEMM(contextInfo);
    int registerApplicationValidation =
        this.mKnoxNwFilterValidation.registerApplicationValidation(contextInfo, str, str2, bundle);
    if (registerApplicationValidation != 0 && registerApplicationValidation != -6) {
      return registerApplicationValidation;
    }
    if (!this.mKnoxNwFilterHelper.addRegisterInfoToDatabase(
        contextInfo.mCallerUid, str, str2, bundle)) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "registerApplication: inserting info into db failed");
      return -8;
    }
    this.mNwFilterProxyAppUid =
        this.mKnoxNwFilterHelper.getUIDForPackage(
            contextInfo.mContainerId, "com.samsung.android.knox.app.networkfilter");
  ...
  public synchronized int setConfig(String str, String str2) {
    ...
    if (iNetworkFilterProxy == null
        || this.mDefaultTcpProxyInterface == null
        || this.mDefaultUdpProxyInterface == null) {
      return -8;
    }
    try {
    ...
    if (str2 != null && !str2.isEmpty()) {
      if (!this.mKnoxNwFilterHelper.addVendorInfoToStorage(
          str, str2, callingUid, packageNameForUid)) {
        return -8;
      }
  ...
  public synchronized int registerListeners(String str, String str2) {
    checkCallingUidPermission();
    int registerListenersValidation =
        this.mKnoxNwFilterValidation.registerListenersValidation(str, str2);
    if (registerListenersValidation != 0) {
      return registerListenersValidation;
    }
    int i = -8;
    if (this.mDefaultDnsProxyInterface != null
        ...
        && this.mDefaultUdpProxyInterface != null) {
      this.mKnoxNwFilterFw.flushUnAuthorizedPackets();
      int retrieveDnsCacheStatus = this.mKnoxNwFilterHelper.retrieveDnsCacheStatus(str2);
      try {
        if (retrieveDnsCacheStatus == 1) {
          Log.d("knoxNwFilter-KnoxNetworkFilterService", "enable clearing the dns system cache");
          getOemNetdService().setDnsCacheStatus(true);
        } else {
          Log.d("knoxNwFilter-KnoxNetworkFilterService", "disable clearing the dns system cache");
          getOemNetdService().setDnsCacheStatus(false);
        }
      } catch (RemoteException unused) {
      }
      this.mKnoxNwFilterHelper.insertListenersInCache(str, str2, retrieveDnsCacheStatus);
      try {
        this.mDefaultDnsProxyInterface.registerRemoteProxyAddr(str, str2);
        this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            this.mNwFilterProxyAppUid, "dns", this.mDefaultDnsProxyInterface.getListener(str));
      } catch (RemoteException unused2) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:dns:error occured while communicating to remote service");
        registerListenersValidation = -8;
        this.mDefaultTcpProxyInterface.registerRemoteProxyAddr(str, str2);
        this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            this.mNwFilterProxyAppUid, "tcp", this.mDefaultTcpProxyInterface.getListener(str));
        this.mDefaultUdpProxyInterface.registerRemoteProxyAddr(str, str2);
        this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            this.mNwFilterProxyAppUid, "udp", this.mDefaultUdpProxyInterface.getListener(str));
        i = registerListenersValidation;
        return i;
      } catch (IllegalArgumentException unused3) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:dns:IllegalArgumentException");
        registerListenersValidation = -8;
        this.mDefaultTcpProxyInterface.registerRemoteProxyAddr(str, str2);
        this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            this.mNwFilterProxyAppUid, "tcp", this.mDefaultTcpProxyInterface.getListener(str));
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:dns:error occurred since the remote service is null");
        registerListenersValidation = -8;
        this.mDefaultTcpProxyInterface.registerRemoteProxyAddr(str, str2);
        this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            this.mNwFilterProxyAppUid, "tcp", this.mDefaultTcpProxyInterface.getListener(str));
      ...
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:tcp:error occured while communicating to remote service");
        registerListenersValidation = -8;
        this.mDefaultUdpProxyInterface.registerRemoteProxyAddr(str, str2);
        this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            this.mNwFilterProxyAppUid, "udp", this.mDefaultUdpProxyInterface.getListener(str));
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:tcp:IllegalArgumentException");
        registerListenersValidation = -8;
        this.mDefaultUdpProxyInterface.registerRemoteProxyAddr(str, str2);
        this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            this.mNwFilterProxyAppUid, "udp", this.mDefaultUdpProxyInterface.getListener(str));
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:tcp:error occurred since the remote service is null");
        registerListenersValidation = -8;
        this.mDefaultUdpProxyInterface.registerRemoteProxyAddr(str, str2);
        this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            this.mNwFilterProxyAppUid, "udp", this.mDefaultUdpProxyInterface.getListener(str));
      ...
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:udp:error occured while communicating to remote service");
      } catch (IllegalArgumentException unused9) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:udp:IllegalArgumentException");
      } catch (NullPointerException unused10) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "registerListeners:udp:error occurred since the remote service is null");
      }
      return i;
    }
    return -8;
  ...
  public String getTcpV4PortInfo(int i) {
    ...
    try {
      ...
      if (DBG) {
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterService",
            "portInfo value is " + str + " port value is " + i);
      }
      return str;
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public String getPkgNameForTcpV4Port(int i) {
    ...
    try {
      ...
      if (DBG) {
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterService",
            "getPkgNameForTcpV4Port value is " + str + " for uid " + i2 + " port value is " + i);
      }
      return str;
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public String getTcpV6PortInfo(int i) {
    ...
    try {
      ...
      if (DBG) {
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterService",
            "getTcpV6PortInfo value is " + str + " port value is " + i);
      }
      return str;
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public String getPkgNameForTcpV6Port(int i) {
    ...
    try {
      ...
      if (DBG) {
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterService",
            "getPkgNameForTcpV6Port value is " + str + " for uid " + i2 + " port value is " + i);
      }
      return str;
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public String getUdpV6PortInfo(int i) {
    ...
    try {
      ...
      if (DBG) {
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterService",
            "getUdpV6PortInfo value is " + str + " port value is " + i);
      }
      return str;
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public int getKnoxNwFilterHttpProxyPort(int i, String str) {
    ...
    if (!this.mKnoxNwFilterHelper.getProfileList().isEmpty()
        && (profilebyUserId = this.mKnoxNwFilterHelper.getProfilebyUserId(i)) != null
        && (profileEntry = KnoxNetworkFilterProfileInfo.getProfileEntry(profilebyUserId)) != null
        && profileEntry.getDnsCacheStatus() == 1
        && profileEntry.getBrowserAppList().contains(str)) {
      try {
  ...
  public final void registerFilterList() {
    ...
    try {
      ...
      this.mContext.registerReceiverAsUser(
          this.mReceiver, UserHandle.ALL, intentFilter2, null, null);
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
  }
      ...
      switch (message.what) {
        ...
        case 7:
          if (bundle.getInt("reason", 0) == 5) {
            Log.d(
                "knoxNwFilter-KnoxNetworkFilterService",
                "ultra power saving mode has been disabled");
  ...
  public final synchronized void handleUnregisterOperation(Bundle bundle) {
    String[] strArr;
    int i = bundle.getInt("userId");
    String string = bundle.getString("package");
    int uIDForPackage = this.mKnoxNwFilterHelper.getUIDForPackage(i, string);
    int uIDForPackage2 =
        this.mKnoxNwFilterHelper.getUIDForPackage(i, "com.samsung.android.knox.app.networkfilter");
    String profilebyUserId = this.mKnoxNwFilterHelper.getProfilebyUserId(i);
    if (profilebyUserId == null) {
      unbindInternalProxyServices(i);
      return;
    }
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
    ...
    for (String str : KnoxNetworkFilterConstants.NW_FILTER_EXEMPT_LIST) {
      int uIDForPackage3 = this.mKnoxNwFilterHelper.getUIDForPackage(i, str);
      if (uIDForPackage3 != -1) {
    ...
    try {
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:dns:error occured while communicating to remote service");
    } catch (NullPointerException unused4) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:dns:error occured remote service null");
    }
    ...
    try {
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:tcp:error occured while communicating to remote service");
    } catch (NullPointerException unused6) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:tcp:error occured remote service null");
    }
    ...
    try {
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:udp:error occured while communicating to remote service");
    } catch (NullPointerException unused8) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:udp:error occured remote service null");
    }
    ...
    try {
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:dns:v6:error occured while communicating to remote service");
    } catch (NullPointerException unused10) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:dns:v6:error occured remote service null");
    }
    ...
    try {
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:tcp:V6:error occured while communicating to remote service");
    } catch (NullPointerException unused12) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:tcp:V6:error occured remote service null");
    }
    ...
    try {
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:udp:V6:error occured while communicating to remote service");
    } catch (NullPointerException unused14) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:udp:V6:error occured remote service null");
    }
    ...
    try {
      ...
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleUnregisterOperation:tcp:http:error occured while communicating to remote"
                + " service");
        ...
        this.mKnoxNwFilterFw.flushUnAuthorizedPackets();
        this.mKnoxNwFilterHelper.addOrRemoveAppsFromBatteryOptimization(
            string, uIDForPackage, false);
        this.mKnoxNwFilterHelper.addOrRemoveSystemAppFromDataSaverWhitelist(uIDForPackage, false);
        this.mKnoxNwFilterHelper.addOrRemoveAppsFromBatteryOptimization(
            "com.samsung.android.knox.app.networkfilter", uIDForPackage2, false);
        this.mKnoxNwFilterHelper.addOrRemoveSystemAppFromDataSaverWhitelist(uIDForPackage2, false);
        ...
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterService",
            "sending unregister broadcast to package "
                + string
                + " userId "
                + i
                + " success during unregister process");
        sendStatusIntent(i, 4, string, 0);
      } catch (NullPointerException unused16) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleUnregisterOperation:tcp:http:error occured remote service null");
        this.mKnoxNwFilterHelper.applyHttpProxyConfiguration(profilebyUserId, strArr, false, i, -1);
        this.mKnoxNwFilterFw.flushTcpRedirectRulesForCaptivePortal();
        this.mDefaultDnsProxyInterface.setConfig(profilebyUserId, (String) null);
        this.mDefaultTcpProxyInterface.setConfig(profilebyUserId, (String) null);
    ...
    try {
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:setConfig:error occured while communicating to remote"
              + " service");
    } catch (NullPointerException unused20) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleUnregisterOperation:setConfig:error occured remote service null");
    }
    this.mKnoxNwFilterFw.flushUnAuthorizedPackets();
    this.mKnoxNwFilterHelper.addOrRemoveAppsFromBatteryOptimization(string, uIDForPackage, false);
    this.mKnoxNwFilterHelper.addOrRemoveSystemAppFromDataSaverWhitelist(uIDForPackage, false);
    this.mKnoxNwFilterHelper.addOrRemoveAppsFromBatteryOptimization(
        "com.samsung.android.knox.app.networkfilter", uIDForPackage2, false);
    this.mKnoxNwFilterHelper.addOrRemoveSystemAppFromDataSaverWhitelist(uIDForPackage2, false);
  ...
  public final synchronized void handleStartFilteringOperation(Bundle bundle) {
    ...
    if (i2 == -1) {
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleStartFilteringOperation:dns:invalid netId returned");
    ...
    try {
      ...
      if (uIDForPackage != -1
          && this.mKnoxNwFilterHelper.checkIfPlatformSigned(
              userId, "com.samsung.android.knox.app.networkfilter")) {
      ...
      if (profileEntry.isV4DnsConfigured()) {
        try {
          ...
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:dns:error occured while communicating to remote"
                  + " service");
          sendStatusIntent(userId, 1, packageNameForUid, -8);
          return;
          ...
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:dns:error occured remote service null");
          sendStatusIntent(userId, 1, packageNameForUid, -8);
          return;
        }
      }
      if (profileEntry.isV4TcpConfigured()) {
        try {
          try {
            this.mKnoxNwFilterFw.redirectAppGeneratedTcpConn(
                userId, configuredDestIpRange, this.mDefaultTcpProxyInterface.startProxyServer());
            try {
            ...
            Log.e(
                "knoxNwFilter-KnoxNetworkFilterService",
                "handleStartFilteringOperation:tcp:error occured remote service null");
            sendStatusIntent(userId, 1, packageNameForUid, -8);
            return;
          }
        } catch (RemoteException unused5) {
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:tcp:error occured while communicating to remote"
                  + " service");
          sendStatusIntent(userId, 1, packageNameForUid, -8);
          return;
        }
      ...
      if (profileEntry.isV4UdpConfigured()) {
        try {
          ...
          this.mKnoxNwFilterFw.redirectAppGeneratedUdpConn(
              userId, configuredDestIpRange, startProxyServer);
        } catch (RemoteException unused6) {
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:udp:error occured while communicating to remote"
                  + " service");
          sendStatusIntent(userId, 1, packageNameForUid, -8);
          return;
        } catch (NullPointerException unused7) {
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:udp:error occured remote service null");
          sendStatusIntent(userId, 1, packageNameForUid, -8);
          return;
        }
      }
      if (profileEntry.isV6TcpConfigured()) {
        try {
          this.mKnoxNwFilterFw.redirectAppGeneratedV6TcpConn(
              userId, configuredDestIpRange2, this.mDefaultTcpProxyInterface.startV6ProxyServer());
          try {
          ...
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:tcp:V6:error occured while communicating to remote"
                  + " service");
          sendStatusIntent(userId, 1, packageNameForUid, -8);
          return;
        } catch (NullPointerException unused10) {
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:tcp:v6:error occured remote service null");
          sendStatusIntent(userId, 1, packageNameForUid, -8);
          return;
        }
      }
      if (profileEntry.isV6UdpConfigured()) {
        try {
          try {
            ...
            this.mKnoxNwFilterFw.redirectAppGeneratedV6UdpConn(
                userId, configuredDestIpRange2, startV6ProxyServer);
            try {
            ...
            Log.e(
                "knoxNwFilter-KnoxNetworkFilterService",
                "handleStartFilteringOperation:udp:V6:error occured while communicating to remote"
                    + " service");
            sendStatusIntent(userId, 1, packageNameForUid, -8);
            return;
          }
          ...
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:udp:V6:error occured remote service null");
          sendStatusIntent(userId, 1, packageNameForUid, -8);
          return;
        }
      }
      try {
        try {
          ...
          this.mKnoxNwFilterHelper.applyHttpProxyConfiguration(
              string, browserAppList, true, userId, startHttpProxyServer);
          ...
          if (installedVpnClientList != null && !installedVpnClientList.isEmpty()) {
            ...
            while (i3 < length) {
              ...
              if (uIDForPackage3 > 0) {
                this.mKnoxNwFilterFw.applyTcpRedirectRulesForCaptivePortal(
                    uIDForPackage3, startHttpProxyServer);
          ...
          this.mKnoxNwFilterHelper.addOrRemoveAppsFromBatteryOptimization(
              packageNameForUid, i, true);
          this.mKnoxNwFilterHelper.addOrRemoveSystemAppFromDataSaverWhitelist(i, true);
          this.mKnoxNwFilterHelper.addOrRemoveAppsFromBatteryOptimization(
              "com.samsung.android.knox.app.networkfilter", uIDForPackage, true);
          this.mKnoxNwFilterHelper.addOrRemoveSystemAppFromDataSaverWhitelist(uIDForPackage, true);
          ...
          sendEMMStatusIntent(
              userId,
              1,
              this.mKnoxNwFilterHelper.getPackageNameForUid(
                  this.mKnoxNwFilterHelper.getAdminIdForUser(userId)),
              0);
        } catch (RemoteException e) {
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStartFilteringOperation:tcp:http:error occured while communicating to remote"
                  + " service "
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStartFilteringOperation:tcp:http:error occured remote service null"
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleStartFilteringOperation:dns:error occured while communicating to remote oemnetd"
              + " service");
      sendStatusIntent(userId, 1, packageNameForUid, -8);
    }
  }
  ...
  public final synchronized void handleStopFilteringOperation(Bundle bundle) {
    ...
    try {
      ...
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:dns:error occured while communicating to remote service");
      } catch (NullPointerException unused2) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:dns:error occured remote service null");
      }
      this.mKnoxNwFilterFw.flushRedirectDnsQueryRules();
      try {
        this.mDefaultTcpProxyInterface.stopProxyServer();
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:tcp:error occured while communicating to remote service");
      } catch (NullPointerException unused4) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:tcp:error occured remote service null");
      }
      this.mKnoxNwFilterFw.flushAppGeneratedRedirectTcpConnRules();
      try {
        this.mDefaultUdpProxyInterface.stopProxyServer();
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:udp:error occured while communicating to remote service");
      } catch (NullPointerException unused6) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:udp:error occured remote service null");
      }
      this.mKnoxNwFilterFw.flushUdpPacketExemptRules(2);
      this.mKnoxNwFilterFw.flushAppGeneratedRedirectUdpConnRules();
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:dns:v6:error occured while communicating to remote"
                + " service");
      } catch (NullPointerException unused8) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:dns:v6:error occured remote service null");
      }
      this.mKnoxNwFilterFw.flushRedirectV6DnsQueryRules();
      try {
        try {
          ...
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "handleStopFilteringOperation:tcp:V6:error occured remote service null");
        }
      } catch (RemoteException unused10) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:tcp:V6:error occured while communicating to remote"
                + " service");
      }
      this.mKnoxNwFilterFw.flushAppGeneratedRedirectV6TcpConnRules();
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:udp:V6:error occured while communicating to remote"
                + " service");
      } catch (NullPointerException unused12) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:udp:V6:error occured remote service null");
      }
      this.mKnoxNwFilterFw.flushUdpPacketExemptRules(10);
      this.mKnoxNwFilterFw.flushAppGeneratedRedirectV6UdpConnRules();
      String[] strArr = null;
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:tcp:http:error occured while communicating to remote"
                + " service");
      } catch (NullPointerException unused14) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleStopFilteringOperation:tcp:http:error occured remote service null");
      }
      this.mKnoxNwFilterHelper.applyHttpProxyConfiguration(string, strArr, false, userId, -1);
      this.mKnoxNwFilterFw.flushTcpRedirectRulesForCaptivePortal();
      this.mKnoxNwFilterHelper.addOrRemoveAppsFromBatteryOptimization(
          "com.samsung.android.knox.app.networkfilter", uIDForPackage, false);
      this.mKnoxNwFilterHelper.addOrRemoveSystemAppFromDataSaverWhitelist(uIDForPackage, false);
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleStopFilteringOperation:error occured while communicating to remote oemnetd"
              + " service");
  ...
  */
  public final synchronized void handleActionPackageAdded(Bundle bundle) {
    ...
    if (this.mKnoxNwFilterHelper.isUserIdRegistered(userId)) {
      String versionName = this.mKnoxNwFilterHelper.getVersionName(userId, string);
      String signature = this.mKnoxNwFilterHelper.getSignature(userId, string);
      int versionCode = this.mKnoxNwFilterHelper.getVersionCode(userId, string);
      INetworkFilterProxy iNetworkFilterProxy2 = this.mDefaultDnsProxyInterface;
      if (iNetworkFilterProxy2 != null) {
        try {
          iNetworkFilterProxy2.updateApplicationInfo(
              string, i, signature, versionName, versionCode);
        } catch (RemoteException | NullPointerException unused) {
        }
      }
      INetworkFilterProxy iNetworkFilterProxy3 = this.mDefaultTcpProxyInterface;
      if (iNetworkFilterProxy3 != null) {
        ...
        iNetworkFilterProxy = this.mDefaultUdpProxyInterface;
        if (iNetworkFilterProxy != null) {
          try {
        ...
        if (this.mKnoxNwFilterHelper.isVpnClient(userId, string)) {
          Log.d(
              "knoxNwFilter-KnoxNetworkFilterService",
              "vpn client with package name " + string + " and uid " + i + " is installed");
          String profilebyUserId = this.mKnoxNwFilterHelper.getProfilebyUserId(userId);
          if (profilebyUserId != null
              && (profileEntry = KnoxNetworkFilterProfileInfo.getProfileEntry(profilebyUserId))
                  != null
              && strArr2 != null) {
            if (!Arrays.asList(strArr2).contains(string)) {
              profileEntry.addUidToVpnClientList(i);
              exemptUidFromNwFilterRange(i, i);
            } else {
              Log.i(
                  "knoxNwFilter-KnoxNetworkFilterService",
        ...
        if (!z && strArr2 != null && Arrays.asList(strArr2).contains(string)) {
          try {
            this.mKnoxNwFilterFw.applyTcpRedirectRulesForCaptivePortal(
                i, this.mDefaultTcpProxyInterface.getHttpLocalProxyPort());
          } catch (RemoteException | NullPointerException unused4) {
          }
        }
        registeredAppPackage = this.mKnoxNwFilterHelper.getRegisteredAppPackage(userId);
        if (registeredAppPackage != null || registeredAppPackage.equalsIgnoreCase(string)) {
          if (this.mKnoxNwFilterHelper.isAppRegistered(
              userId, string, this.mKnoxNwFilterHelper.getSignature(userId, string))) {
            try {
              Thread.currentThread();
              Thread.sleep(5000L);
            } catch (Exception unused5) {
            }
            this.mKnoxNwFilterHelper.addOrRemoveAppsFromBatteryOptimization(string, i, true);
            this.mKnoxNwFilterHelper.addOrRemoveSystemAppFromDataSaverWhitelist(i, true);
            Log.d(
                "knoxNwFilter-KnoxNetworkFilterService",
                "sending register broadcast to package "
            ...
            sendStatusIntent(userId, 0, string, 0);
          }
        }
        return;
      }
  ...
  public final synchronized void handleActionPackageRemoved(Bundle bundle) {
    ...
    if (this.mKnoxNwFilterHelper.isUserIdRegistered(userId)) {
      ...
      if (profilebyUserId != null
          && (profileEntry = KnoxNetworkFilterProfileInfo.getProfileEntry(profilebyUserId)) != null
          && profileEntry.removeUidFromVpnClientList(i)) {
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterService",
            "vpn client with package name " + string + " and uid " + i + " is uninstalled");
        removeExemptUidFromNwFilterRange(i, i);
      }
      if (!z) {
        try {
        ...
        if (strArr != null && Arrays.asList(strArr).contains(string)) {
          try {
            this.mKnoxNwFilterFw.removeTcpRedirectRulesForCaptivePortal(
                i, this.mDefaultTcpProxyInterface.getHttpLocalProxyPort());
  ...
  public final synchronized void handleActionClearData(Bundle bundle) {
    ...
    if (this.mKnoxNwFilterHelper.isUserIdRegistered(userId)) {
      ...
      if (registeredAppPackage != null
        ...
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterService",
            "clear data action is triggered for package " + packageNameForUid + " with uid " + i);
  ...
  public final ContextInfo checkCallingUidPermissionEMM(ContextInfo contextInfo) {
    return this.mEdm.enforceDoPoOnlyPermissionByContext(
        contextInfo,
        new ArrayList(
            Arrays.asList("com.samsung.android.knox.permission.KNOX_NETWORK_FILTER_MGMT")));
  }
  ...
  public final void bindInternalProxyServices(int i) {
    ...
    if (this.mContext.bindServiceAsUser(intent, defaultDnsConnection, 1073741829, new UserHandle(i))
    ...
    intent2.setClassName(
        "com.samsung.android.knox.app.networkfilter",
        "com.samsung.android.knox.app.networkfilter.dns.VirtualDnsProxyService");
    if (this.mContext.bindServiceAsUser(
            intent2, virtualDnsConnection, 1073741829, new UserHandle(i))
        && virtualDnsConnection.countDownLatch.await(30000L, TimeUnit.MILLISECONDS)) {
      Log.d(
          "knoxNwFilter-KnoxNetworkFilterService",
          "binding to default virtual proxy service is success");
    ...
    if (this.mContext.bindServiceAsUser(
            intent3, defaultTcpConnection, 1073741829, new UserHandle(i))
        && defaultTcpConnection.countDownLatch.await(30000L, TimeUnit.MILLISECONDS)) {
      Log.d(
          "knoxNwFilter-KnoxNetworkFilterService",
    ...
    if (this.mContext.bindServiceAsUser(
            intent4, defaultUdpConnection, 1073741829, new UserHandle(i))
        && defaultUdpConnection.countDownLatch.await(30000L, TimeUnit.MILLISECONDS)) {
      Log.d(
          "knoxNwFilter-KnoxNetworkFilterService",
  ...
  public final void unbindInternalProxyServices(int i) {
    ...
    if (this.mVirtualDnsConnectionList.containsKey(Integer.valueOf(i))) {
      this.mContext.unbindService(
          (ServiceConnection) this.mVirtualDnsConnectionList.get(Integer.valueOf(i)));
  ...
  public class DefaultDnsConnection implements ServiceConnection {
    ...
    public synchronized void onServiceDisconnected(ComponentName componentName) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultDnsConnection:onServiceDisconnected " + System.currentTimeMillis());
    ...
    public synchronized void onBindingDied(ComponentName componentName) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultDnsConnection:onBindingDied " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mDefaultDnsProxyInterface = null;
      if (KnoxNetworkFilterService.this.mDefaultDnsConnectionList.containsKey(
          Integer.valueOf(this.userId))) {
        KnoxNetworkFilterService.this.mContext.unbindService(
            (ServiceConnection)
                KnoxNetworkFilterService.this.mDefaultDnsConnectionList.get(
                    Integer.valueOf(this.userId)));
        KnoxNetworkFilterService.this.mDefaultDnsConnectionList.remove(
            Integer.valueOf(this.userId));
      }
      DefaultDnsConnection defaultDnsConnection =
          KnoxNetworkFilterService.this.new DefaultDnsConnection(this.userId);
      Intent intent = new Intent();
      intent.setClassName(
          "com.samsung.android.knox.app.networkfilter",
          "com.samsung.android.knox.app.networkfilter.dns.DefaultDnsProxyService");
      if (KnoxNetworkFilterService.this.mContext.bindServiceAsUser(
          intent, defaultDnsConnection, 1073741829, new UserHandle(this.userId))) {
        KnoxNetworkFilterService.this.mDefaultDnsConnectionList.put(
            Integer.valueOf(this.userId), defaultDnsConnection);
      } else {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "failed to bind dns process after onBinding died event, clearing up the rules applied");
    ...
    public synchronized void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultDnsConnection:onServiceConnected " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mDefaultDnsProxyInterface =
      ...
      String profilebyUserId =
          KnoxNetworkFilterService.this.mKnoxNwFilterHelper.getProfilebyUserId(this.userId);
      if (profilebyUserId == null) {
        return;
      }
      ...
      try {
        KnoxNetworkFilterService.this.mDefaultDnsProxyInterface.setConfig(
            profilebyUserId,
            KnoxNetworkFilterService.this.mKnoxNwFilterHelper.getRulesConfig(profilebyUserId));
        KnoxNetworkFilterService.this.mDefaultDnsProxyInterface.registerRemoteProxyAddr(
            profilebyUserId,
            KnoxNetworkFilterService.this.mKnoxNwFilterHelper.retrieveListenersFromCache(
                profilebyUserId));
        KnoxNetworkFilterService.this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            KnoxNetworkFilterService.this.mNwFilterProxyAppUid,
            "dns",
            KnoxNetworkFilterService.this.mDefaultDnsProxyInterface.getListener(profilebyUserId));
        if (KnoxNetworkFilterService.this.mKnoxNwFilterHelper.retrieveProfileState(profilebyUserId)
                == 3
            && profileEntry.isV4DnsConfigured()) {
          KnoxNetworkFilterService.this.mKnoxNwFilterFw.redirectDnsQuery(
              KnoxNetworkFilterService.this.mDefaultDnsProxyInterface.startProxyServer());
        }
      } catch (RemoteException | NullPointerException unused) {
      }
    }
  ...
  public class VirtualDnsConnection implements ServiceConnection {
    ...
    public synchronized void onServiceDisconnected(ComponentName componentName) {
      Log.d(
          "knoxNwFilter-KnoxNetworkFilterService",
          "VirtualDnsConnection:onServicedisconnected is reached ");
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "VirtualDnsConnection:onServiceDisconnected " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mVirtualDnsProxyInterface = null;
      try {
        KnoxNetworkFilterService.this.mDefaultDnsProxyInterface.vpnMessengerForDnsQuery(
            (IBinder) null);
      } catch (RemoteException | NullPointerException unused) {
      }
    }
    ...
    public synchronized void onBindingDied(ComponentName componentName) {
      Log.d(
          "knoxNwFilter-KnoxNetworkFilterService",
          "VirtualDnsConnection:onBindingDied is reached ");
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "VirtualDnsConnection:onBindingDied " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mVirtualDnsProxyInterface = null;
      try {
        KnoxNetworkFilterService.this.mDefaultDnsProxyInterface.vpnMessengerForDnsQuery(
            (IBinder) null);
      ...
      if (KnoxNetworkFilterService.this.mVirtualDnsConnectionList.containsKey(
          Integer.valueOf(this.userId))) {
        KnoxNetworkFilterService.this.mContext.unbindService(
            (ServiceConnection)
                KnoxNetworkFilterService.this.mVirtualDnsConnectionList.get(
                    Integer.valueOf(this.userId)));
        KnoxNetworkFilterService.this.mVirtualDnsConnectionList.remove(
            Integer.valueOf(this.userId));
      }
      VirtualDnsConnection virtualDnsConnection =
          KnoxNetworkFilterService.this.new VirtualDnsConnection(this.userId);
      Intent intent = new Intent();
      intent.setClassName(
          "com.samsung.android.knox.app.networkfilter",
          "com.samsung.android.knox.app.networkfilter.dns.VirtualDnsProxyService");
      if (KnoxNetworkFilterService.this.mContext.bindServiceAsUser(
          intent, virtualDnsConnection, 1073741829, new UserHandle(this.userId))) {
        KnoxNetworkFilterService.this.mVirtualDnsConnectionList.put(
            Integer.valueOf(this.userId), virtualDnsConnection);
      } else {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "failed to bind vpn process after onBinding died event");
      }
    }
    ...
    public synchronized void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      Log.d(
          "knoxNwFilter-KnoxNetworkFilterService",
          "VirtualDnsConnection:onServiceConnected is reached ");
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "VirtualDnsConnection:onServiceConnected " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mVirtualDnsProxyInterface =
          INetworkFilterProxy.Stub.asInterface(iBinder);
      CountDownLatch countDownLatch = this.countDownLatch;
      if (countDownLatch != null) {
        countDownLatch.countDown();
  ...
  public class DefaultTcpConnection implements ServiceConnection {
    ...
    public synchronized void onServiceDisconnected(ComponentName componentName) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultTcpConnection:onServiceDisconnected " + System.currentTimeMillis());
    ...
    public synchronized void onBindingDied(ComponentName componentName) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultTcpConnection:onBindingDied " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mDefaultTcpProxyInterface = null;
      if (KnoxNetworkFilterService.this.mDefaultTcpConnectionList.containsKey(
          Integer.valueOf(this.userId))) {
        KnoxNetworkFilterService.this.mContext.unbindService(
            (ServiceConnection)
                KnoxNetworkFilterService.this.mDefaultTcpConnectionList.get(
                    Integer.valueOf(this.userId)));
        KnoxNetworkFilterService.this.mDefaultTcpConnectionList.remove(
            Integer.valueOf(this.userId));
      }
      DefaultTcpConnection defaultTcpConnection =
          KnoxNetworkFilterService.this.new DefaultTcpConnection(this.userId);
      Intent intent = new Intent();
      intent.setClassName(
          "com.samsung.android.knox.app.networkfilter",
          "com.samsung.android.knox.app.networkfilter.tcp.DefaultTcpProxyService");
      if (KnoxNetworkFilterService.this.mContext.bindServiceAsUser(
          intent, defaultTcpConnection, 1073741829, new UserHandle(this.userId))) {
        KnoxNetworkFilterService.this.mDefaultTcpConnectionList.put(
            Integer.valueOf(this.userId), defaultTcpConnection);
      } else {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
    ...
    public synchronized void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultTcpConnection:onServiceConnected " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mDefaultTcpProxyInterface =
          INetworkFilterProxy.Stub.asInterface(iBinder);
      CountDownLatch countDownLatch = this.countDownLatch;
      if (countDownLatch != null) {
        countDownLatch.countDown();
      ...
      String configuredDestIpRange =
          KnoxNetworkFilterService.this.mKnoxNwFilterHelper.getConfiguredDestIpRange(
              profilebyUserId, 2);
      String configuredDestIpRange2 =
          KnoxNetworkFilterService.this.mKnoxNwFilterHelper.getConfiguredDestIpRange(
              profilebyUserId, 10);
      try {
        KnoxNetworkFilterService.this.mDefaultTcpProxyInterface.setConfig(
            profilebyUserId,
            KnoxNetworkFilterService.this.mKnoxNwFilterHelper.getRulesConfig(profilebyUserId));
        KnoxNetworkFilterService.this.mDefaultTcpProxyInterface.registerRemoteProxyAddr(
            profilebyUserId,
            KnoxNetworkFilterService.this.mKnoxNwFilterHelper.retrieveListenersFromCache(
                profilebyUserId));
        KnoxNetworkFilterService.this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            KnoxNetworkFilterService.this.mNwFilterProxyAppUid,
            "tcp",
            KnoxNetworkFilterService.this.mDefaultTcpProxyInterface.getListener(profilebyUserId));
        if (KnoxNetworkFilterService.this.mKnoxNwFilterHelper.retrieveProfileState(profilebyUserId)
            == 3) {
          if (profileEntry.isV4TcpConfigured()) {
            KnoxNetworkFilterService.this.mKnoxNwFilterFw.redirectAppGeneratedTcpConn(
                this.userId,
                configuredDestIpRange,
                KnoxNetworkFilterService.this.mDefaultTcpProxyInterface.startProxyServer());
            KnoxNetworkFilterService.this.getOemNetdService().enablePortInfoEntries(2, 6, true);
          }
          if (profileEntry.isV6TcpConfigured()) {
            KnoxNetworkFilterService.this.mKnoxNwFilterFw.redirectAppGeneratedV6TcpConn(
                this.userId,
                configuredDestIpRange2,
                KnoxNetworkFilterService.this.mDefaultTcpProxyInterface.startV6ProxyServer());
            KnoxNetworkFilterService.this.getOemNetdService().enablePortInfoEntries(10, 6, true);
          }
          int startHttpProxyServer =
              KnoxNetworkFilterService.this.mDefaultTcpProxyInterface.startHttpProxyServer();
          String[] browserAppList =
              KnoxNetworkFilterService.this.mDefaultTcpProxyInterface.getBrowserAppList();
          KnoxNetworkFilterService.this.getOemNetdService().setHttpProxyPort(startHttpProxyServer);
          KnoxNetworkFilterService.this.mKnoxNwFilterHelper.applyHttpProxyConfiguration(
              profilebyUserId, browserAppList, true, this.userId, startHttpProxyServer);
          for (String str : browserAppList) {
            int uIDForPackage =
                KnoxNetworkFilterService.this.mKnoxNwFilterHelper.getUIDForPackage(
                    this.userId, str);
            if (uIDForPackage > 0) {
              KnoxNetworkFilterService.this.mKnoxNwFilterFw.applyTcpRedirectRulesForCaptivePortal(
  ...
  public class DefaultUdpConnection implements ServiceConnection {
    ...
    public synchronized void onServiceDisconnected(ComponentName componentName) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultUdpConnection:onServiceDisconnected " + System.currentTimeMillis());
    ...
    public synchronized void onBindingDied(ComponentName componentName) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultUdpConnection:onBindingDied " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mDefaultUdpProxyInterface = null;
      if (KnoxNetworkFilterService.this.mDefaultUdpConnectionList.containsKey(
          Integer.valueOf(this.userId))) {
        KnoxNetworkFilterService.this.mContext.unbindService(
            (ServiceConnection)
                KnoxNetworkFilterService.this.mDefaultUdpConnectionList.get(
                    Integer.valueOf(this.userId)));
        KnoxNetworkFilterService.this.mDefaultUdpConnectionList.remove(
            Integer.valueOf(this.userId));
      }
      DefaultUdpConnection defaultUdpConnection =
          KnoxNetworkFilterService.this.new DefaultUdpConnection(this.userId);
      Intent intent = new Intent();
      intent.setClassName(
          "com.samsung.android.knox.app.networkfilter",
          "com.samsung.android.knox.app.networkfilter.udp.DefaultUdpProxyService");
      if (KnoxNetworkFilterService.this.mContext.bindServiceAsUser(
          intent, defaultUdpConnection, 1073741829, new UserHandle(this.userId))) {
        KnoxNetworkFilterService.this.mDefaultUdpConnectionList.put(
            Integer.valueOf(this.userId), defaultUdpConnection);
      } else {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
    ...
    public synchronized void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      ...
      KnoxNetworkFilterService.this.mLocalProxyStatus.add(
          "DefaultUdpConnection:onServiceConnected " + System.currentTimeMillis());
      KnoxNetworkFilterService.this.mDefaultUdpProxyInterface =
          INetworkFilterProxy.Stub.asInterface(iBinder);
      CountDownLatch countDownLatch = this.countDownLatch;
      if (countDownLatch != null) {
        countDownLatch.countDown();
      ...
      String configuredDestIpRange2 =
          KnoxNetworkFilterService.this.mKnoxNwFilterHelper.getConfiguredDestIpRange(
              profilebyUserId, 10);
      try {
        KnoxNetworkFilterService.this.mDefaultUdpProxyInterface.setConfig(
            profilebyUserId,
            KnoxNetworkFilterService.this.mKnoxNwFilterHelper.getRulesConfig(profilebyUserId));
        KnoxNetworkFilterService.this.mDefaultUdpProxyInterface.registerRemoteProxyAddr(
            profilebyUserId,
            KnoxNetworkFilterService.this.mKnoxNwFilterHelper.retrieveListenersFromCache(
                profilebyUserId));
        KnoxNetworkFilterService.this.mKnoxNwFilterFw.denyUnAuthorizedPackets(
            KnoxNetworkFilterService.this.mNwFilterProxyAppUid,
            "udp",
            KnoxNetworkFilterService.this.mDefaultUdpProxyInterface.getListener(profilebyUserId));
        if (KnoxNetworkFilterService.this.mKnoxNwFilterHelper.retrieveProfileState(profilebyUserId)
            == 3) {
          if (profileEntry.isV4UdpConfigured()) {
            KnoxNetworkFilterService.this.mKnoxNwFilterFw.redirectAppGeneratedUdpConn(
                this.userId,
                configuredDestIpRange,
                KnoxNetworkFilterService.this.mDefaultUdpProxyInterface.startProxyServer());
          }
          if (profileEntry.isV6UdpConfigured()) {
            KnoxNetworkFilterService.this.mKnoxNwFilterFw.redirectAppGeneratedV6UdpConn(
                this.userId,
                configuredDestIpRange2,
                KnoxNetworkFilterService.this.mDefaultUdpProxyInterface.startV6ProxyServer());
  ...
  public class NetworkCallback extends ConnectivityManager.NetworkCallback {
    ...
    public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
      ...
      while (it.hasNext()) {
        KnoxNetworkFilterService.this.mKnoxNwFilterFw.exemptDnsRulesFromNat(
            ((Integer) it.next()).intValue(), linkProperties.getDnsServers());
      }
    }
    ...
    public void onLost(Network network) {
      Log.d(
          "knoxNwFilter-KnoxNetworkFilterService",
          "onLost being called for netId " + network.getNetId());
  ...
  public final void registerSystemDefaultNetworkCallback() {
    ...
    try {
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "Failed to register system default network callback " + Log.getStackTraceString(e));
  ...
  public final void unregisterSystemDefaultNetworkCallback() {
    ...
    try {
      try {
        ...
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "Failed to unregister system default network callback " + Log.getStackTraceString(e));
      }
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
      ...
      try {
        ...
        try {
          ...
          try {
            Log.d(
                "knoxNwFilter-KnoxNetworkFilterService",
                "setupNetworkDns() - Network created id = " + i);
          } catch (Exception e5) {
            e = e5;
            z = true;
            if (z) {
              Log.e(
                  "knoxNwFilter-KnoxNetworkFilterService",
                  "setupNetworkDns() - Failed to set dns for network " + i,
                  e);
              try {
              ...
              Log.e(
                  "knoxNwFilter-KnoxNetworkFilterService",
                  "setupNetworkDns() - Failed to create new network with id provided.",
                  e);
            }
          ...
          Log.e(
              "knoxNwFilter-KnoxNetworkFilterService",
              "Error creating private network: " + e7.getMessage());
          this.mNetIdManager.releaseNetId(i);
          return -1;
        }
      } finally {
  ...
  public final synchronized void handleVendorPackageUninstall(int i, String str) {
    ...
    this.mKnoxNwFilterHelper.applyHttpProxyConfiguration(
        profilebyUserId, strArr, false, userId, -1);
    this.mKnoxNwFilterFw.flushTcpRedirectRulesForCaptivePortal();
    try {
      releaseNwFilterNetId(getOemNetdService().getNwFilterNetId());
      getOemNetdService().removeUserFromNwFilterRange(userId);
  ...
  public final void handleBindingDiedEvent(int i) {
    ...
    try {
      ...
      Log.e(
          "knoxNwFilter-KnoxNetworkFilterService",
          "handleBindingDiedEvent:error occured while communicating to remote oemnetd service");
    }
    this.mKnoxNwFilterFw.flushUnAuthorizedPackets();
    for (String str : KnoxNetworkFilterConstants.NW_FILTER_EXEMPT_LIST) {
      ...
      try {
        strArr =
            (String[])
                profileEntry
                    .getBrowserAppList()
                    .toArray(new String[profileEntry.getBrowserAppList().size()]);
      } catch (RemoteException unused3) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
            "handleBindingDiedEvent:tcp:http:error occured while communicating to remote service");
      } catch (NullPointerException unused4) {
        Log.e(
            "knoxNwFilter-KnoxNetworkFilterService",
    ...
    sendEMMStatusIntent(
        ...
        2,
        this.mKnoxNwFilterHelper.getPackageNameForUid(
            this.mKnoxNwFilterHelper.getAdminIdForUser(i)),
        -10);
  }
  ...
  public synchronized void dump(
    ...
    if (this.mContext.checkCallingOrSelfPermission("android.permission.DUMP") != 0) {
      printWriter.println(
          "KnoxNetworkFilterProfileInfo: Permission Denial: can't dump PersonaManager from from"
              + " pid="
    ...
    Collection<KnoxNetworkFilterProfileInfo> profileEntries =
        KnoxNetworkFilterProfileInfo.getProfileEntries();
      ...
      for (KnoxNetworkFilterProfileInfo knoxNetworkFilterProfileInfo : profileEntries) {
        printWriter.println(
            "KnoxNetworkFilterProfileInfo: profileName: "
                + knoxNetworkFilterProfileInfo.getProfileName()
                + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
        printWriter.println(
            "KnoxNetworkFilterProfileInfo: RulesConfig: "
                + knoxNetworkFilterProfileInfo.getRulesConfig()
                + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
        printWriter.println(
            "KnoxNetworkFilterProfileInfo: socketConfig "
                + knoxNetworkFilterProfileInfo.getSocketConfig()
                + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
        printWriter.println(
            "KnoxNetworkFilterProfileInfo: packageName "
                + knoxNetworkFilterProfileInfo.getPackageName()
                + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
        printWriter.println(
            "KnoxNetworkFilterProfileInfo: packageUid "
                + knoxNetworkFilterProfileInfo.getPackageUid()
                + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
        printWriter.println(
            "KnoxNetworkFilterProfileInfo: state: "
                + knoxNetworkFilterProfileInfo.getState()
                + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
    ...
    try {
      printWriter.println(
          "KnoxNetworkFilterProfileInfo: netId value is "
              + getOemNetdService().getNwFilterNetId()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
    } catch (RemoteException | NullPointerException unused) {
    }
    ...
    if (processesInErrorState != null) {
      for (ActivityManager.ProcessErrorStateInfo processErrorStateInfo : processesInErrorState) {
        ...
        if (str != null && str.equalsIgnoreCase("com.samsung.android.knox.app.networkfilter")) {
          printWriter.print(
              "KnoxNetworkFilterProfileInfo: local nwfilter proxy apk error condition is "
                  + processErrorStateInfo.condition
                  + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
          printWriter.print(
              "KnoxNetworkFilterProfileInfo: local nwfilter proxy apk error longMsg is "
                  + processErrorStateInfo.longMsg
                  + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
          printWriter.print(
              "KnoxNetworkFilterProfileInfo: local nwfilter proxy apk error shortMsg is "
                  + processErrorStateInfo.shortMsg
                  + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
          printWriter.print(
              "KnoxNetworkFilterProfileInfo: local nwfilter proxy apk error stackTrace is "
          ...
          printWriter.print(
              "KnoxNetworkFilterProfileInfo: local nwfilter proxy apk error pid is "
                  ...
                  + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
          printWriter.print(
              "KnoxNetworkFilterProfileInfo: local nwfilter proxy apk apk error uid is "
    ...
    if (this.mDefaultDnsProxyInterface != null) {
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default DNS proxy server address "
              + this.mDefaultDnsProxyInterface.getLocalProxyAddress()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default DNS proxy server port "
              + this.mDefaultDnsProxyInterface.getLocalProxyPort()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default DNS proxy server thread is active "
              + this.mDefaultDnsProxyInterface.isProxyThreadRunning()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default DNS proxy server thread state "
              + this.mDefaultDnsProxyInterface.getProxythreadStatus()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default DNS proxy server alive "
              + this.mDefaultDnsProxyInterface.isProxyThreadAlive()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default DNS proxy server address "
              + this.mDefaultDnsProxyInterface.getV6LocalProxyAddress()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default DNS proxy server port "
              + this.mDefaultDnsProxyInterface.getV6LocalProxyPort()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default DNS proxy server thread is active "
              + this.mDefaultDnsProxyInterface.isV6ProxyThreadRunning()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default DNS proxy server thread state "
              + this.mDefaultDnsProxyInterface.getV6ProxythreadStatus()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default DNS proxy server alive "
              + this.mDefaultDnsProxyInterface.isV6ProxyThreadAlive()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
    }
    if (this.mDefaultTcpProxyInterface != null) {
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default tcp proxy server address "
              + this.mDefaultTcpProxyInterface.getLocalProxyAddress()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default tcp proxy server port "
              + this.mDefaultTcpProxyInterface.getLocalProxyPort()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default tcp proxy server thread is active "
              + this.mDefaultTcpProxyInterface.isProxyThreadRunning()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default tcp proxy server thread state "
              + this.mDefaultTcpProxyInterface.getProxythreadStatus()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default tcp proxy server alive "
              + this.mDefaultTcpProxyInterface.isProxyThreadAlive()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default tcp proxy server address "
              + this.mDefaultTcpProxyInterface.getV6LocalProxyAddress()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default tcp proxy server port "
              + this.mDefaultTcpProxyInterface.getV6LocalProxyPort()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default tcp proxy server thread is active "
              + this.mDefaultTcpProxyInterface.isV6ProxyThreadRunning()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default tcp proxy server thread state "
              + this.mDefaultTcpProxyInterface.getV6ProxythreadStatus()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default tcp proxy server alive "
              + this.mDefaultTcpProxyInterface.isV6ProxyThreadAlive()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: http:local default tcp proxy server address "
              + this.mDefaultTcpProxyInterface.getHttpLocalProxyAddress()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: http:local default tcp proxy server port "
              + this.mDefaultTcpProxyInterface.getHttpLocalProxyPort()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: http:local default tcp proxy server thread is active "
              + this.mDefaultTcpProxyInterface.isHttpProxyThreadRunning()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: http:local default tcp proxy server thread state "
              + this.mDefaultTcpProxyInterface.getHttpProxythreadStatus()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: http:local default tcp proxy server alive "
              + this.mDefaultTcpProxyInterface.isHttpProxyThreadAlive()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
    }
    if (this.mDefaultUdpProxyInterface != null) {
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default udp proxy server address "
              + this.mDefaultUdpProxyInterface.getLocalProxyAddress()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default udp proxy server port "
              + this.mDefaultUdpProxyInterface.getLocalProxyPort()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default udp proxy server thread is active "
              + this.mDefaultUdpProxyInterface.isProxyThreadRunning()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default udp proxy server thread state "
              + this.mDefaultUdpProxyInterface.getProxythreadStatus()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: local default udp proxy server alive "
              + this.mDefaultUdpProxyInterface.isProxyThreadAlive()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default udp proxy server address "
              + this.mDefaultUdpProxyInterface.getV6LocalProxyAddress()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default udp proxy server port "
              + this.mDefaultUdpProxyInterface.getV6LocalProxyPort()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default udp proxy server thread is active "
              + this.mDefaultUdpProxyInterface.isV6ProxyThreadRunning()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default udp proxy server thread state "
              + this.mDefaultUdpProxyInterface.getV6ProxythreadStatus()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: V6:local default udp proxy server alive "
              + this.mDefaultUdpProxyInterface.isV6ProxyThreadAlive()
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
    }
    Iterator it3 = this.mLocalProxyStatus.iterator();
    while (it3.hasNext()) {
      printWriter.print(
          "KnoxNetworkFilterProfileInfo: "
              + ((String) it3.next())
              + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
    }
    printWriter.print(
