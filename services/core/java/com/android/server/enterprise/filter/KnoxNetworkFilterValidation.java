...
public class KnoxNetworkFilterValidation {
  ...
  public int registerApplicationValidation(
    ...
    if (this.mKnoxNwFilterHelper.isPackageInstalled(userId, str)) {
      return (str2 == null
              || str2.isEmpty()
              || (signature = this.mKnoxNwFilterHelper.getSignature(userId, str)) == null
              || signature.equalsIgnoreCase(str2))
          ? 0
          : -3;
    }
    return -6;
  ...
  public int unregisterApplicationValidation(ContextInfo contextInfo, String str) {
    ...
    return (registeredAppSign == null
            || registeredAppSign.isEmpty()
            || signature == null
            || signature.equalsIgnoreCase(registeredAppSign))
        ? 0
        : -3;
  }
  ...
  public int getInstanceValidation() {
    ...
    return !this.mKnoxNwFilterHelper.isAppRegistered(
            userId,
            packageNameForUid,
  ...
  public int setConfigValidation(String str, String str2) {
    ...
    List profileListByVendor =
        this.mKnoxNwFilterHelper.getProfileListByVendor(Binder.getCallingUid());
  ...
  public int registerListenersValidation(String str, String str2) {
    ...
    List<String> profileListByVendor =
        this.mKnoxNwFilterHelper.getProfileListByVendor(Binder.getCallingUid());
    if (profileListByVendor.isEmpty()) {
      return -2;
    }
