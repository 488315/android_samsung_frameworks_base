...
public class KnoxNetworkFilterFirewall {
  ...
  public static Map createFilterMap() {
    ...
    hashMap.put(
        KnoxVpnFirewallHelper.OUTPUT_CHAIN,
        Arrays.asList(
            "knox_nwfilter_unauth_drop",
            "knox_nwfilter_dot_drop",
            "knox_nwfilter_dns_drop",
            "knox_nwfilter_app_act"));
    return hashMap;
  }
  ...
  public static Map createNatMap() {
    ...
    hashMap.put(
        KnoxVpnFirewallHelper.OUTPUT_CHAIN,
        Arrays.asList(
            "knox_nwfilter_udp_rdt",
            "knox_nwfilter_udp_exempt",
            "knox_nwfilter_dns_rdt",
            "knox_nwfilter_app_rdt",
            "knox_nwfilter_tcp_rdt",
            "knox_nwfilter_cp_rdt",
            "knox_nwfilter_dns_exempt",
            "knox_nwfilter_app_act"));
    return hashMap;
  }
  ...
  public static Map createMangleMapList() {
    ...
    hashMap.put(
        KnoxVpnFirewallHelper.OUTPUT_CHAIN,
        Arrays.asList(
            "knox_nwfilter_tcp_mark",
            "knox_nwfilter_udp_mark",
            "knox_nwfilter_dns_mark",
            "knox_nwfilter_udp_exempt",
            "knox_nwfilter_app_act"));
    hashMap.put(
        KnoxVpnFirewallHelper.PREROUTING_CHAIN,
        Arrays.asList("knox_nwfilter_tcp_rdt", "knox_nwfilter_udp_rdt", "knox_nwfilter_dns_rdt"));
    return hashMap;
  }
  ...
  public final String parseIptablesRestoreCmd(IpRestoreParam ipRestoreParam) {
    ...
    int i = AbstractC14201.f1683xf766e4bb[ipRestoreParam.actionType.ordinal()];
    if (i == 1) {
      sb.append("-A ");
  ...
  /* renamed from: com.android.server.enterprise.filter.KnoxNetworkFilterFirewall$1 */
  public abstract /* synthetic */ class AbstractC14201 {

    /* renamed from: $SwitchMap$com$android$server$enterprise$filter$KnoxNetworkFilterFirewall$IpRestoreActionType */
    public static final /* synthetic */ int[] f1683xf766e4bb;
    ...
    static {
      ...
      try {
        f1683xf766e4bb[IpRestoreActionType.INSERT.ordinal()] = 2;
      } catch (NoSuchFieldError unused2) {
      }
      try {
        f1683xf766e4bb[IpRestoreActionType.DELETE.ordinal()] = 3;
      } catch (NoSuchFieldError unused3) {
      }
      try {
        f1683xf766e4bb[IpRestoreActionType.REMOVE_CHAIN.ordinal()] = 4;
  ...
  public void redirectDnsQuery(int i) {
    ...
    arrayList.add(
        new IpRestoreParam(
            "knox_nwfilter_dns_rdt",
            " -o lo -p udp --dport 53 ",
            "REDIRECT --to-port " + Integer.toString(i),
            "",
            IpRestoreActionType.INSERT));
    insertRules(true, KnoxVpnFirewallHelper.TABLE_NAT, null, arrayList, 4);
  }
      ...
      arrayList.add(
          new IpRestoreParam(
              ...
              " -m owner --uid-owner "
                  ...
                  + str
                  + " -m state --state NEW ",
              "REDIRECT --to-port " + Integer.toString(i2),
              "",
              ipRestoreActionType));
      arrayList.add(
          new IpRestoreParam(
              "knox_nwfilter_tcp_rdt",
              " -m owner --uid-owner " + str2 + " ! -o lo -p tcp -m state --state NEW ",
              "REDIRECT --to-port " + Integer.toString(i2),
              "",
              ipRestoreActionType));
    } else {
  ...
  public void exemptDnsRulesFromNat(int i, List list) {
    ...
    arrayList3.add(
        new IpRestoreParam(
            "knox_nwfilter_dns_drop",
            " -m owner --uid-owner " + str + " -p udp --dport 53 ",
            "DROP",
            "",
            ipRestoreActionType));
    arrayList4.add(
    ...
    while (it.hasNext()) {
      ...
      if (inetAddress instanceof Inet4Address) {
        ...
        arrayList.add(
            new IpRestoreParam(
                "knox_nwfilter_dns_exempt", sb.toString(), "ACCEPT", "", ipRestoreActionType2));
        arrayList3.add(
            new IpRestoreParam(
                "knox_nwfilter_dns_drop",
                " -m owner --uid-owner "
        ...
        arrayList2.add(
            new IpRestoreParam(
                "knox_nwfilter_dns_exempt", sb2.toString(), "ACCEPT", "", ipRestoreActionType3));
        arrayList4.add(
            new IpRestoreParam(
                "knox_nwfilter_dns_drop",
                " -m owner --uid-owner "
  ...
  public void exemptUdpPacketFromNwFilterRange(int i, int i2) {
    ...
    arrayList.add(
        new IpRestoreParam(
            "knox_nwfilter_udp_exempt",
            " -m owner --uid-owner " + str + " -p udp -m pkttype --pkt-type multicast ",
            "ACCEPT",
            "",
            ipRestoreActionType));
    if (i2 == 2) {
  ...
  public void redirectAppGeneratedUdpConn(int i, String str, int i2) {
    ...
    if (IS_CONNBYTE_EXTENSION_PRESENT) {
        ...
        arrayList.add(
            new IpRestoreParam(
                ...
                " -m owner --uid-owner "
                    ...
                    + " -o lo -d "
                    + str
                    + " -p udp -m state --state NEW -m connbytes --connbytes 1:1 --connbytes-dir"
                    + " original --connbytes-mode packets ",
                "CONNMARK --set-mark " + Integer.toString(60),
                "",
                ipRestoreActionType));
        arrayList.add(
            new IpRestoreParam(
                ...
                " -m owner --uid-owner "
                    + str2
                    + " ! -o lo  -p udp -m state --state NEW -m connbytes --connbytes 1:1"
      ...
      arrayList.add(
          new IpRestoreParam(
              "knox_nwfilter_udp_rdt",
              " -m owner --uid-owner " + str2 + " ! -o lo  -p udp -m state --state NEW ",
              "CONNMARK --set-mark " + Integer.toString(60),
              "",
              ipRestoreActionType2));
    } else {
    ...
    arrayList.add(
        new IpRestoreParam(
            "knox_nwfilter_udp_rdt",
            " -p udp -m connmark --mark " + Integer.toString(60),
            "REDIRECT --to-port " + Integer.toString(i2),
            "",
            IpRestoreActionType.APPEND));
    insertRules(true, KnoxVpnFirewallHelper.TABLE_NAT, null, arrayList, 4);
  ...
  public void redirectAppGeneratedV6TcpConn(int i, String str, int i2) {
    ...
    arrayList.add(
        new IpRestoreParam(
            "knox_nwfilter_tcp_mark",
            " -p tcp -m connmark --mark " + Integer.toString(60),
    ...
    arrayList.add(
        new IpRestoreParam(
            "knox_nwfilter_tcp_rdt",
            " -p tcp --syn -i lo -m mark --mark " + Integer.toString(60),
            "TPROXY --on-port " + Integer.toString(i2),
            "",
            ipRestoreActionType));
    insertRules(true, KnoxVpnFirewallHelper.TABLE_MANGLE, null, arrayList, 6);
    StringBuilder sb = new StringBuilder();
    ...
    sb.append(KnoxVpnFirewallHelper.ADD);
    sb.append(
        " from all fwmark " + Integer.toString(60) + " table " + Integer.toString(60) + " prio 10");
    sb.append(KnoxVpnFirewallHelper.DELIMITER);
  ...
  public void redirectAppGeneratedV6UdpConn(int i, String str, int i2) {
    ...
    arrayList.add(
        new IpRestoreParam(
            "knox_nwfilter_udp_rdt",
            " -p udp -i lo -m mark --mark " + Integer.toString(60),
            "TPROXY --on-port " + Integer.toString(i2),
            "",
            ipRestoreActionType));
    insertRules(true, KnoxVpnFirewallHelper.TABLE_MANGLE, null, arrayList, 6);
  ...
  public void applyTcpRedirectRulesForCaptivePortal(int i, int i2) {
    ...
    arrayList.add(
        new IpRestoreParam(
            "knox_nwfilter_cp_rdt",
            " -m owner --uid-owner " + i + " -o lo -p tcp --dport 80 ",
            "REDIRECT --to-port " + Integer.toString(i2),
            "",
            IpRestoreActionType.APPEND));
    insertRules(true, KnoxVpnFirewallHelper.TABLE_NAT, null, arrayList, 4);
  ...
  public final void isIptablesExtensionPresent(String str) {
    ...
    try {
      try {
        ...
        Log.d(
            "knoxNwFilter-KnoxNetworkFilterFirewall",
            "isIptablesExtensionPresent: " + str + " " + isIptablesMatchEnabled);
