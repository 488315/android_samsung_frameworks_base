...
public class EDMProxyService extends IEDMProxy.Stub {
  ...
  public boolean getEmergencyCallOnly(boolean z) {
    PhoneRestrictionPolicy phoneRestrictionPolicy =
        (PhoneRestrictionPolicy) EnterpriseService.getPolicyService("phone_restriction_policy");
  ...
  public boolean isCaCertificateTrustedAsUser(byte[] bArr, boolean z, boolean z2, int i) {
    ...
    boolean z3 = true;
    if (certificatePolicy == null
        || !certificatePolicy.isCertificateTrustedUntrustedEnabledAsUser(i)) {
      return true;
    }
    if (bArr == null) {
      return false;
      ...
      while (it.hasNext()) {
        z3 &=
            certificatePolicy.isCaCertificateTrustedAsUser(
                new CertificateInfo((X509Certificate) it.next()), z, z2, i);
        if (!z3) {
          return false;
        }
      }
  ...
  public int validateCertificateAtInstallAsUser(byte[] bArr, int i) {
    CertificatePolicy certificatePolicy =
        (CertificatePolicy) EnterpriseService.getPolicyService("certificate_policy");
    if (certificatePolicy == null
        || !certificatePolicy.isCertificateValidationAtInstallEnabledAsUser(i)) {
      return -1;
    }
    if (bArr == null) {
      return 7;
    ...
    try {
      ...
      if (arrayList.size() == 1) {
        return certificatePolicy.validateCertificateAtInstallAsUser(
            (CertificateInfo) arrayList.get(0), i);
      }
  ...
  public byte[] ucmGetCertificateChain(String str) {
    ...
    if (credentialManagerService == null
        || (certificateChain = credentialManagerService.getCertificateChain(str)) == null) {
      return null;
    }
  ...
  public byte[] ucmDecrypt(String str, byte[] bArr, String str2, Bundle bundle) {
    ...
    CredentialManagerService credentialManagerService =
        (CredentialManagerService) ServiceManager.getService("com.samsung.ucs.ucsservice");
    if (credentialManagerService == null
        || (decrypt = credentialManagerService.decrypt(str, bArr, str2, bundle)) == null) {
      return null;
    }
  ...
  public byte[] ucmEncrypt(String str, byte[] bArr, String str2, Bundle bundle) {
    ...
    CredentialManagerService credentialManagerService =
        (CredentialManagerService) ServiceManager.getService("com.samsung.ucs.ucsservice");
    if (credentialManagerService == null
        || (encrypt = credentialManagerService.encrypt(str, bArr, str2, bundle)) == null) {
      return null;
    }
  ...
  public byte[] ucmSign(String str, byte[] bArr, String str2) {
    ...
    CredentialManagerService credentialManagerService =
        (CredentialManagerService) ServiceManager.getService("com.samsung.ucs.ucsservice");
    if (credentialManagerService == null
        || (sign = credentialManagerService.sign(str, bArr, str2)) == null) {
      return null;
    }
    return sign.mData;
  }
  ...
  public byte[] ucmMac(String str, byte[] bArr, String str2) {
    ...
    CredentialManagerService credentialManagerService =
        (CredentialManagerService) ServiceManager.getService("com.samsung.ucs.ucsservice");
    if (credentialManagerService == null
        || (mac = credentialManagerService.mac(str, bArr, str2)) == null) {
      return null;
    }
    return mac.mData;
  }
  ...
  public List getELMPermissions(String str) {
    EnterpriseLicenseService enterpriseLicenseService =
        (EnterpriseLicenseService) EnterpriseService.getPolicyService("enterprise_license_policy");
  ...
  public boolean registerSystemUICallback(ISystemUIAdapterCallback iSystemUIAdapterCallback) {
    return SystemUIAdapter.getInstance(this.mContext)
        .registerSystemUICallback(iSystemUIAdapterCallback);
  }
