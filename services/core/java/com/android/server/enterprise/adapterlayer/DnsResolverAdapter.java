...
public class DnsResolverAdapter implements IDnsResolverAdapter {
  ...
  public void updateEnforceDnsUidForNetwork(final int i, final boolean z) {
    ...
    runWithExceptionHandling(
        new CheckedRemoteRequest() { // from class:
                                     // com.android.server.enterprise.adapterlayer.DnsResolverAdapter$$ExternalSyntheticLambda0
  ...
  public static /* synthetic */ void lambda$updateEnforceDnsUidForNetwork$0(
      boolean z, int i, IDnsResolver iDnsResolver) {
  ...
  public void createNetworkCache(final int i) {
    ...
    runWithExceptionHandling(
        new CheckedRemoteRequest() { // from class:
                                     // com.android.server.enterprise.adapterlayer.DnsResolverAdapter$$ExternalSyntheticLambda2
          @Override // com.android.server.enterprise.adapterlayer.DnsResolverAdapter.CheckedRemoteRequest
          public final void execute(IDnsResolver iDnsResolver) {
  ...
  public void flushNetworkCache(final int i) {
    ...
    runWithExceptionHandling(
        new CheckedRemoteRequest() { // from class:
                                     // com.android.server.enterprise.adapterlayer.DnsResolverAdapter$$ExternalSyntheticLambda3
          @Override // com.android.server.enterprise.adapterlayer.DnsResolverAdapter.CheckedRemoteRequest
          public final void execute(IDnsResolver iDnsResolver) {
