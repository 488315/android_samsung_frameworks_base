...
public class SystemUIAdapter implements ISystemUIAdapter {
  ...
  public class SystemUIAdapterCallbackDeathRecipient implements IBinder.DeathRecipient {
    ...
    public void binderDied() {
      ...
      if (SystemUIAdapter.this.mCallbacks.containsKey(Integer.valueOf(this.key))) {
        ((ISystemUIAdapterCallback) SystemUIAdapter.this.mCallbacks.get(Integer.valueOf(this.key)))
            .asBinder()
  ...
  public boolean registerSystemUICallback(ISystemUIAdapterCallback iSystemUIAdapterCallback) {
    ...
    if (!isCalledFromSystemUI()) {
      Log.d(
          "SystemUIAdapter",
          "registerSystemUICallback() has failed because it's only allowed to call by SystemUI ");
      return false;
    }
    ...
    if (callingOrCurrentUserId != 0) {
      Log.d(
          "SystemUIAdapter",
          "registerSystemUICallback() has failed because it's only allowed user_system, but userId"
              + " = "
    ...
    if (iSystemUIAdapterCallback != null) {
      try {
        ...
        iSystemUIAdapterCallback
            .asBinder()
            .linkToDeath(new SystemUIAdapterCallbackDeathRecipient(i), 0);
      ...
      Log.d(
          "SystemUIAdapter",
          "registerSystemUICallback() callback has registered. " + this.mRegisteredCount);
  ...
  public void updateSystemUIMonitor(int i) {
    if (!isCalledFromSystem()) {
      Log.d(
          "SystemUIAdapter",
          "updateSystemUIMonitor() has failed because not system call, userId = " + i);
      return;
    }
    if (i >= 0) {
      if (this.adapterUserId != i) {
        Log.d(
            "SystemUIAdapter",
            "updateSystemUIMonitor() userId has changed. " + this.adapterUserId + " -> " + i);
      }
    ...
    try {
      try {
        if (mContext != null) {
          ...
          intent.putExtra(
              "com.samsung.android.knox.intent.extra.USER_ID_INTERNAL", this.adapterUserId);
  ...
  public final boolean isCalledFromSystem() {
    ...
    Log.e(
        "SystemUIAdapter",
        "isCalledFromSystem() : no permission because non-system : " + Binder.getCallingPid());
    return false;
  }
  ...
  public final String[] getIccIdListByAdmin() {
    List values =
        mEdmStorageProvider.getValues("SimTable", new String[] {"SimIccId"}, new ContentValues());
  ...
  public void setStatusBarHiddenAsUser(int i, boolean z) {
    ...
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        ...
        } else if (getRestrictionPolicy() != null
            && getRestrictionPolicy().isStatusBarExpansionAllowedAsUser(false, 0)) {
    ...
    if (isCalledFromSystem()) {
      ...
      if (i == getCurrentUserId() || !isSeparateProfileChallengeEnabled) {
        try {
          ...
          Log.e(
              "SystemUIAdapter",
              "setMaximumFailedPasswordsForDisable() failed with NullPointerException.");
        } catch (Exception unused2) {
        }
      }
    }
  ...
  public void excludeExternalStorageForFailedPasswordsWipeAsUser(int i, boolean z) {
    Log.d(
        "SystemUIAdapter",
        "excludeExternalStorageForFailedPasswordsWipeAsUser() userId = " + i + ", exclude = " + z);
    if (isCalledFromSystem()) {
      boolean isSeparateProfileChallengeEnabled =
          new LockPatternUtils(mContext).isSeparateProfileChallengeEnabled(i);
      Log.d(
          "SystemUIAdapter",
          "setMultifactorAuthEnabled() excludeExternalStorageForFailedPasswordsWipeAsUser = "
              + isSeparateProfileChallengeEnabled);
      if (i == getCurrentUserId() || !isSeparateProfileChallengeEnabled) {
        try {
          Iterator it = this.mCallbacks.entrySet().iterator();
          ...
          Log.e(
              "SystemUIAdapter",
              "excludeExternalStorageForFailedPasswordsWipe() Failed with RemoteException",
              e);
        } catch (NullPointerException unused) {
          Log.e(
              "SystemUIAdapter",
              "excludeExternalStorageForFailedPasswordsWipe() failed with NullPointerException.");
        } catch (Exception unused2) {
        }
      }
    }
  ...
  public void setPasswordLockDelayAsUser(int i, int i2) {
    ...
    if (isCalledFromSystem()) {
      ...
      Log.d(
          "SystemUIAdapter",
          "setMultifactorAuthEnabled() setPasswordLockDelayAsUser = "
              + isSeparateProfileChallengeEnabled);
      if (i == getCurrentUserId() || !isSeparateProfileChallengeEnabled) {
        try {
          Iterator it = this.mCallbacks.entrySet().iterator();
  ...
  public void setPasswordVisibilityEnabledAsUser(int i, boolean z) {
    Log.d(
        "SystemUIAdapter", "setPasswordVisibilityEnabledAsUser() userId = " + i + ", allow = " + z);
    if (isCalledFromSystem()) {
      boolean isSeparateProfileChallengeEnabled =
          new LockPatternUtils(mContext).isSeparateProfileChallengeEnabled(i);
      Log.d(
          "SystemUIAdapter",
          "setPasswordVisibilityEnabledAsUser() isSeparateProfileChallengeEnabled = "
              + isSeparateProfileChallengeEnabled);
      if (i == getCurrentUserId() || !isSeparateProfileChallengeEnabled) {
        try {
          Iterator it = this.mCallbacks.entrySet().iterator();
          ...
          Log.e(
              "SystemUIAdapter",
              "setPasswordVisibilityEnabled() failed with NullPointerException.");
        } catch (Exception unused2) {
        }
      }
    }
  ...
  public void setAirplaneModeAllowedAsUser(int i, boolean z) {
    ...
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        ...
        Log.e(
            "SystemUIAdapter", "setAirplaneModeAllowedAsUser() failed with NullPointerException.");
      } catch (Exception unused2) {
      }
    }
  }
  ...
  public void setCellularDataAllowedAsUser(int i, boolean z) {
    ...
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        ...
        Log.e(
            "SystemUIAdapter", "setCellularDataAllowedAsUser() failed with NullPointerException.");
      } catch (Exception unused2) {
      }
    }
  }
  ...
  public void setWifiTetheringAllowedAsUser(int i, boolean z) {
    Log.d(
        "SystemUIAdapter", "setWifiTetheringAllowedAsUser() userId = " + i + ", isAllowed = " + z);
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        Iterator it = this.mCallbacks.entrySet().iterator();
        while (it.hasNext()) {
        ...
        Log.e(
            "SystemUIAdapter", "setWifiTetheringAllowedAsUser() failed with NullPointerException.");
      } catch (Exception unused2) {
      }
    }
  }
  ...
  public void setFaceRecognitionEvenCameraBlockedAllowedAsUser(int i, boolean z) {
    Log.d(
        "SystemUIAdapter",
        "setFaceRecognitionEvenCameraBlockedAllowedAsUser() userId = " + i + ", isAllowed = " + z);
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        Iterator it = this.mCallbacks.entrySet().iterator();
        while (it.hasNext()) {
        ...
        Log.e(
            "SystemUIAdapter",
            "setFaceRecognitionEvenCameraBlockedAllowedAsUser() Failed with RemoteException",
            e);
      } catch (NullPointerException unused) {
        Log.e(
            "SystemUIAdapter",
            "setFaceRecognitionEvenCameraBlockedAllowedAsUser() failed with NullPointerException.");
      } catch (Exception unused2) {
      }
    }
  }
  ...
  public void setNFCStateChangeAllowedAsUser(int i, boolean z) {
    Log.d(
        "SystemUIAdapter", "setNFCStateChangeAllowedAsUser() userId = " + i + ", isAllowed = " + z);
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        Iterator it = this.mCallbacks.entrySet().iterator();
        while (it.hasNext()) {
  ...
  public void setWifiStateChangeAllowedAsUser(int i, boolean z) {
    ...
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        ...
        Log.e(
            "SystemUIAdapter", "setWifiStateChangeAllowedAsUser() Failed with RemoteException", e);
      } catch (NullPointerException unused) {
        Log.e(
            "SystemUIAdapter",
  ...
  public void setLocationProviderAllowedAsUser(int i, String str, boolean z) {
    ...
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        ...
        Log.e(
            "SystemUIAdapter", "setLocationProviderAllowedAsUser() Failed with RemoteException", e);
      } catch (NullPointerException unused) {
        Log.e(
            "SystemUIAdapter",
  ...
  public void setGPSStateChangeAllowedAsUser(int i, boolean z) {
    Log.d(
        "SystemUIAdapter", "setGPSStateChangeAllowedAsUser() userId = " + i + ", isAllowed = " + z);
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        Iterator it = this.mCallbacks.entrySet().iterator();
        while (it.hasNext()) {
  ...
  public void setLockscreenWallpaperAsUser(int i, boolean z) {
    ...
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        ...
        Log.e(
            "SystemUIAdapter", "setLockscreenWallpaperAsUser() failed with NullPointerException.");
      } catch (Exception unused2) {
      }
    }
  }
  ...
  public void setApplicationNameControlEnabledAsUser(int i, boolean z) {
    ...
    if (isCalledFromSystem() && i == getCurrentUserId()) {
      try {
        ...
        Log.e(
            "SystemUIAdapter", "setApplicationNameEnabledAsUser() Failed with RemoteException", e);
      } catch (NullPointerException unused) {
        Log.e(
            "SystemUIAdapter",
        ...
        if (statusBarService != null) {
          if (!z) {
            statusBarService.disableForUser(
                0, this.mToken, "knoxmdm_key_statusbar_disable_expansion : " + str, 0);
            statusBarService.disable2ForUser(
                0, this.mToken, "knoxmdm_key_statusbar_disable_expansion : " + str, 0);
          } else {
            statusBarService.disableForUser(
                65536, this.mToken, "knoxmdm_key_statusbar_disable_expansion : " + str, 0);
            statusBarService.disable2ForUser(
                1, this.mToken, "knoxmdm_key_statusbar_disable_expansion : " + str, 0);
          }
        }
      } catch (Exception e) {
