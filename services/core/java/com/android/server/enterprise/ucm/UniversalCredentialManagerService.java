...
public class UniversalCredentialManagerService extends IUniversalCredentialManager.Stub
  ...
  public static final List systemPlugin =
      Arrays.asList(
          "com.samsung.ucs.agent.boot", "com.samsung.ucs.agent.ese", "com.sec.smartcard.manager");
  ...
  public BroadcastReceiver mSystemReceiver =
        ...
        public void onReceive(Context context, Intent intent) {
          ...
          if (action.equals("android.intent.action.USER_REMOVED")) {
            ...
            Log.i(
                ...
                "ACTION_USER_REMOVED UserHandle : " + intExtra);
            Message obtainMessage =
                UniversalCredentialManagerService.this.mUCSMHandler.obtainMessage(1);
            obtainMessage.arg1 = intExtra;
            UniversalCredentialManagerService.this.mUCSMHandler.sendMessage(obtainMessage);
            return;
          }
          if (action.equals("android.intent.action.LOCKED_BOOT_COMPLETED")) {
            UniversalCredentialManagerService.this.mUCSMHandler.sendMessage(
                UniversalCredentialManagerService.this.mUCSMHandler.obtainMessage(6));
          ...
          if (action.equals("android.intent.action.SCREEN_ON")
            ...
            UniversalCredentialManagerService.this.mUCSMHandler.sendMessage(
                UniversalCredentialManagerService.this.mUCSMHandler.obtainMessage(7));
            return;
          }
          if (action.equals("android.intent.action.DEVICE_LOCKED_CHANGED")) {
            ...
            Message obtainMessage2 =
                UniversalCredentialManagerService.this.mUCSMHandler.obtainMessage(9);
  ...
  public BroadcastReceiver mPackageRemovedReceiver =
      new BroadcastReceiver() { // from class:
                                // com.android.server.enterprise.ucm.UniversalCredentialManagerService.3
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
          Message obtainMessage =
              UniversalCredentialManagerService.this.mUCSMHandler.obtainMessage(3);
          int intExtra = intent.getIntExtra("android.intent.extra.UID", -1);
          boolean booleanExtra = intent.getBooleanExtra("android.intent.extra.REPLACING", false);
          obtainMessage.obj = new int[] {intExtra};
          Log.i(
              UniversalCredentialManagerService.TAG,
              "ACTION_PACKAGE_REMOVED : replacingApp -" + booleanExtra);
          if (!booleanExtra) {
            UniversalCredentialManagerService.this.mUCSMHandler.sendMessage(obtainMessage);
          } else {
            Log.i(
                UniversalCredentialManagerService.TAG,
                "ACTION_PACKAGE_REMOVED : No need to cleanup db entries for app update");
          }
        }
      };
  ...
  /* renamed from: com.android.server.enterprise.ucm.UniversalCredentialManagerService$1 */
  public class C14981 extends ISystemPersonaObserver.Stub {
    ...
    public void onStateChange(
        int i, SemPersonaState semPersonaState, SemPersonaState semPersonaState2) {
      Log.i(
          UniversalCredentialManagerService.TAG,
          " inside onstatechange " + i + " new " + semPersonaState2 + " old " + semPersonaState);
      ...
      if (intent.getAction().equals("com.samsung.android.knox.intent.action.UCM_PLUGIN_STATUS")) {
        if (intent.getExtras() != null) {
          ...
          if (extras != null) {
            ...
            Log.i(
                UniversalCredentialManagerService.TAG,
                "UcsReceiver no bundle extras received from plugin");
            return;
          }
        }
        Log.i(
  ...
  public boolean isCallerPackageManaged() {
    ...
    try {
      ...
      Log.i(
          TAG,
          "isCallerPackageManaged, callingUid: " + callingUid + ", packageName: " + nameForUid);
  ...
  public final void notifyUCMConfigStatus(String str, Bundle bundle, UserHandle userHandle) {
    if (notifyUCMConfigStatusByPermission(
            str, bundle, userHandle, "com.samsung.android.knox.permission.KNOX_UCM_ESE_MGMT")
        || notifyUCMConfigStatusByPermission(
            str, bundle, userHandle, "com.samsung.android.knox.permission.KNOX_UCM_OTHER_MGMT")) {
      return;
    }
    notifyUCMConfigStatusByPermission(
        str, bundle, userHandle, "com.samsung.android.knox.permission.KNOX_UCM_MGMT");
  }

  public final boolean notifyUCMConfigStatusByPermission(
      String str, Bundle bundle, UserHandle userHandle, String str2) {
    try {
      if (AppGlobals.getPackageManager().checkPermission(str2, str, userHandle.getIdentifier())
          != 0) {
        return false;
      }
  ...
  public void enforceSecurityPermission(
    ...
    if (contextInfo.mCallerUid != i) {
      Log.i(
          TAG,
          "enforceSecurityPermission : oldCallerId = "
              + i
              + " newCallerId = "
  ...
  public final void registerReceiver() {
    ...
    this.mContext.registerReceiverAsUser(
        this.mSystemReceiver, UserHandle.ALL, intentFilter, null, null);
    IntentFilter intentFilter2 = new IntentFilter();
    intentFilter2.addAction("android.intent.action.PACKAGE_REMOVED");
    intentFilter2.addDataScheme("package");
    this.mContext.registerReceiverAsUser(
        this.mPackageRemovedReceiver, UserHandle.ALL, intentFilter2, null, null);
    ...
    public void handleMessage(Message message) {
      ...
      switch (message.what) {
        case 1:
          ...
          if (ucmService != null) {
            ...
            try {
              ...
              Log.i(
                  UniversalCredentialManagerService.TAG, "The exception occurs " + e.getMessage());
            }
          }
        ...
        case 2:
          ...
          try {
            ...
            if (UniversalCredentialManagerService.this.adminIds != null) {
              ...
              if (UniversalCredentialManagerService.this.adminIds.size() > 0) {
                Log.i(
                    UniversalCredentialManagerService.TAG,
                    "adminIds size- " + UniversalCredentialManagerService.this.adminIds.size());
              }
            }
          } catch (Exception e2) {
          ...
          UniversalCredentialManagerService.this.mUCSMHandler.sendMessage(
              UniversalCredentialManagerService.this.mUCSMHandler.obtainMessage(4));
          break;
        case 3:
          ...
          try {
            ...
            if (iArr != null && iArr.length > 0) {
              for (int i3 : iArr) {
                ...
                if (UniversalCredentialManagerService.this.activePluginsCache.containsKey(
                    valueOf)) {
                  String str =
                      (String)
                          UniversalCredentialManagerService.this.activePluginsCache.get(valueOf);
                  Log.i(
                      UniversalCredentialManagerService.TAG,
                ...
                if (UniversalCredentialManagerService.this.whitelistedAppsCache.containsKey(
                    valueOf)) {
                  String str2 =
                      (String)
                          UniversalCredentialManagerService.this.whitelistedAppsCache.get(valueOf);
                  Log.i(
                      UniversalCredentialManagerService.TAG,
                ...
                if (UniversalCredentialManagerService.this.exemptedAppsCache.containsKey(valueOf)) {
                  String str3 =
                      (String)
                          UniversalCredentialManagerService.this.exemptedAppsCache.get(valueOf);
                  Log.i(
                      UniversalCredentialManagerService.TAG,
                ...
                if (ucmService2 != null) {
                  Log.i(
                      UniversalCredentialManagerService.TAG,
                      "notifyChangeToPlugin is called for package uninstalled...");
                  try {
        ...
        case 4:
          ...
          try {
            ...
            if (!activePlugin.isEmpty()) {
                  ...
                  if (intValue != 1000 && intValue != 0) {
                    try {
                      if (!UniversalCredentialManagerService.this.activePluginsCache.containsKey(
                        ...
                        UniversalCredentialManagerService.this.activePluginsCache.put(
                            Integer.valueOf(intValue), asString);
                        Log.i(
                            UniversalCredentialManagerService.TAG,
                            "Caching plugin app id-" + intValue + ", packageName-" + asString);
                      }
                    } catch (Exception e5) {
                      Log.i(
                          UniversalCredentialManagerService.TAG,
              ...
              for (Map.Entry entry :
                  UniversalCredentialManagerService.this.activePluginsCache.entrySet()) {
                Log.i(
                    UniversalCredentialManagerService.TAG,
                    "Plugin ID = "
          ...
          UniversalCredentialManagerService.this.mUCSMHandler.sendMessage(
              UniversalCredentialManagerService.this.mUCSMHandler.obtainMessage(5));
          break;
        case 5:
          Log.i(
              UniversalCredentialManagerService.TAG,
          ...
          try {
            ArrayList allWhitelistedApps =
                UniversalCredentialManagerService.this.getAllWhitelistedApps();
            if (allWhitelistedApps != null && allWhitelistedApps.size() > 0) {
              Log.i(
                  UniversalCredentialManagerService.TAG,
                  "getAllWhitelistedApps - Size-" + allWhitelistedApps.size());
                ...
                if (asString2 != null && asInteger2 != null) {
                  ...
                  try {
                    if (!asString2.equals("*")
                        && intValue2 != 1000
                        && intValue2 != 0
                        && !UniversalCredentialManagerService.this.whitelistedAppsCache.containsKey(
                            Integer.valueOf(intValue2))) {
                      UniversalCredentialManagerService.this.whitelistedAppsCache.put(
                          Integer.valueOf(intValue2), asString2);
                      Log.i(
                          UniversalCredentialManagerService.TAG,
                          "Caching WhiteList app id-" + intValue2 + ", packageName-" + asString2);
                    }
                  } catch (Exception e7) {
                    Log.i(
                        UniversalCredentialManagerService.TAG,
              ...
              for (Map.Entry entry2 :
                  UniversalCredentialManagerService.this.whitelistedAppsCache.entrySet()) {
                Log.i(
                    UniversalCredentialManagerService.TAG,
                    "WHITELIST App UID = "
            ...
            if (allExemptedApps != null && allExemptedApps.size() > 0) {
              Log.i(
                  UniversalCredentialManagerService.TAG,
                  "getAllExemptedApps - Size-" + allExemptedApps.size());
                  ...
                  if (asString3 != null && asInteger3 != null) {
                    ...
                    try {
                      if (!asString3.equals("com.samsung.knox.virtual.wifi")
                          && intValue3 != 1000
                          && intValue3 != 0
                          && !UniversalCredentialManagerService.this.exemptedAppsCache.containsKey(
                              Integer.valueOf(intValue3))) {
                        UniversalCredentialManagerService.this.exemptedAppsCache.put(
                            Integer.valueOf(intValue3), asString3);
                        Log.i(
                            UniversalCredentialManagerService.TAG,
                            "Caching Exempted app id-" + intValue3 + ", packageName-" + asString3);
                      }
                    } catch (Exception e8) {
                      Log.i(
                          UniversalCredentialManagerService.TAG,
              ...
              for (Map.Entry entry3 :
                  UniversalCredentialManagerService.this.exemptedAppsCache.entrySet()) {
                Log.i(
                    UniversalCredentialManagerService.TAG,
                    "EXEPMT-> App UID = "
        ...
        case 6:
          ...
          try {
            ...
            if (ucmService3 != null) {
              ...
              if (allUsers != null && allUsers.size() > 0) {
                Iterator it4 =
                    ((UserManager)
                            UniversalCredentialManagerService.this.mContext.getSystemService(
                                "user"))
                        .getUsers()
                        .iterator();
                while (it4.hasNext()) {
            ...
            Log.i(
                UniversalCredentialManagerService.TAG, "The exception occurs " + e10.getMessage());
          }
          ...
          try {
            for (Integer num2 : UniversalCredentialManagerService.this.adminIds) {
              ...
              if (UniversalCredentialManagerService.this.mPm.getPackagesForUid(num2.intValue())
                  == null) {
                ...
                if (packageManager.checkUidPermission(
                    ...
                    && packageManager.checkUidPermission(
                        ...
                        != 0
                    && packageManager.checkUidPermission(
                            "com.samsung.android.knox.permission.KNOX_UCM_MGMT", num2.intValue())
                        != 0) {
                  Log.i(
                      UniversalCredentialManagerService.TAG, "  Admin don't has UCS permission...");
            ...
            Log.i(
                UniversalCredentialManagerService.TAG, "The exception occurs " + e11.getMessage());
          }
          try {
            for (Map.Entry entry4 :
              ...
              if (UniversalCredentialManagerService.this.mPm.getPackagesForUid(num3.intValue())
                      == null
                  && !arrayList.contains(num3)) {
                Log.i(
                    UniversalCredentialManagerService.TAG,
            ...
            Log.i(
                UniversalCredentialManagerService.TAG, "The exception occurs " + e12.getMessage());
          }
          try {
            Iterator it5 =
                UniversalCredentialManagerService.this.exemptedAppsCache.entrySet().iterator();
            while (it5.hasNext()) {
              Integer num4 = (Integer) ((Map.Entry) it5.next()).getKey();
              Log.i(
                  UniversalCredentialManagerService.TAG, "MSG_SYNC_UP_DATA exempt app id -" + num4);
              if (UniversalCredentialManagerService.this.mPm.getPackagesForUid(num4.intValue())
                      == null
                  && !arrayList.contains(num4)) {
                Log.i(
                    UniversalCredentialManagerService.TAG,
            ...
            Log.i(
                UniversalCredentialManagerService.TAG, "The exception occurs " + e13.getMessage());
          }
          try {
            Iterator it6 =
                UniversalCredentialManagerService.this.whitelistedAppsCache.entrySet().iterator();
            while (it6.hasNext()) {
              Integer num5 = (Integer) ((Map.Entry) it6.next()).getKey();
              Log.i(
                  UniversalCredentialManagerService.TAG,
                  "MSG_SYNC_UP_DATA Whitelist app id -" + num5);
              if (UniversalCredentialManagerService.this.mPm.getPackagesForUid(num5.intValue())
                      == null
                  && !arrayList.contains(num5)) {
                Log.i(
                    UniversalCredentialManagerService.TAG,
            ...
            Log.i(
                UniversalCredentialManagerService.TAG, "The exception occurs " + e14.getMessage());
          }
          if (arrayList.size() > 0) {
        ...
        case 7:
          ...
          if (ucmService4 != null) {
            ...
            try {
              ...
              Log.i(
                  UniversalCredentialManagerService.TAG,
                  "notifyChangeToPlugin Exception " + e15.getMessage());
            }
          }
          Log.i(
              UniversalCredentialManagerService.TAG, "****MSG_LOCK_STATUS_UPDATE block ended****");
          break;
        case 9:
          ...
          if (ucmService5 != null) {
            ...
            Log.i(
                UniversalCredentialManagerService.TAG,
                "notifyChangeToPlugin is called for container Lock status update containerId-"
                    + i5
                    + ", status-"
                    + i6);
            try {
              ...
              Log.i(
                  UniversalCredentialManagerService.TAG,
                  "The exception occurs " + e16.getMessage());
              return;
            }
          }
          break;
        case 10:
          ...
          try {
            z =
                UniversalCredentialManagerService.this.mEdmStorageProvider.deleteDataByFields(
                    "UniversalCredentialEnforcedLockTypeTable", strArr, strArr2);
          } catch (Exception e17) {
            if (UniversalCredentialManagerService.DBG) {
              Log.i(
                  UniversalCredentialManagerService.TAG,
                  "performPreAdminCleanup - Exception delete locktype" + e17.getMessage());
            }
            z = false;
          }
          Log.i(
              UniversalCredentialManagerService.TAG,
              "performPreAdminCleanup - Enforce Lock Type status- " + z);
          try {
            z2 =
                UniversalCredentialManagerService.this.mEdmStorageProvider.deleteDataByFields(
            ...
            if (UniversalCredentialManagerService.DBG) {
              Log.i(
                  UniversalCredentialManagerService.TAG,
                  "performPreAdminCleanup - Exception delete whitelist" + e18.getMessage());
            }
          }
          Log.i(
              UniversalCredentialManagerService.TAG,
              "performPreAdminCleanup - White List status - " + z2);
          break;
      }
    }
  }
  ...
  public CredentialStorage[] getAvailableCredentialStorages(ContextInfo contextInfo) {
    ...
    if (DBG) {
      Log.i(
          TAG,
          "getAvailableCredentialStorages is called for Caller UID-" + i + " mContainerId " + i2);
    }
    CredentialStorage[] availableCredentialStorageInternal =
    ...
    if (packagesForUid != null && packagesForUid.length > 0) {
        ...
        if (delegatedStorages != null && delegatedStorages.length > 0) {
          for (CredentialStorage credentialStorage : delegatedStorages) {
            if (!arrayList.contains(credentialStorage.name)) {
              ...
              Log.i(
                  TAG,
                  "getAvailableCredentialStorages - Addding whitelisted storage -"
      ...
      for (CredentialStorage credentialStorage2 : availableCredentialStorageInternal) {
        if (arrayList.contains(credentialStorage2.name)) {
          ...
          Log.i(
              TAG,
              "getAvailableCredentialStorages - Final filtered storage -"
      ...
      try {
        if (getUniversalCredentialUtil() != null) {
          ...
          if (managedProviders != null && managedProviders.length > 0) {
            CredentialStorage[] credentialStorageArr =
                new CredentialStorage[managedProviders.length];
            int i = 0;
          ...
          Log.i(
              TAG,
              "getAvailableCredentialStorage - UniversalCredentialUtil service returns no"
                  + " providers... ");
        } else {
          Log.i(
              TAG, "getAvailableCredentialStorage - UniversalCredentialUtil service is null.... ");
        }
      } catch (Exception e) {
        Log.i(TAG, "The exception occurs " + e.getMessage());
      }
  ...
  public final Provider getCredentialStorageProvider(CredentialStorage credentialStorage) {
    try {
      if (getUniversalCredentialUtil() != null) {
        Log.i(
            TAG,
            "getCredentialStorageProperties name-"
                + credentialStorage.name
                + " and pkg-"
        ...
        for (Provider provider : managedProviders) {
          ...
          if (name != null && property != null) {
            if (name.equals(credentialStorage.name)
    ...
    try {
      ...
      if (ucmService != null) {
        if (credentialStorage.name.equalsIgnoreCase(
            ...
            && credentialStorage.packageName.equalsIgnoreCase("com.samsung.ucs.agent.ese")) {
        ...
        Bundle adminConfigureBundleForCs =
            ucmService.setAdminConfigureBundleForCs(i, i2, build, bundle, nextContainerRequestId);
        int i3 =
  ...
  public Bundle getCredentialStoragePluginConfiguration(
    ...
    try {
      KnoxAnalytics.log(
          getKAData("getCredentialStoragePluginConfiguration", credentialStorage.packageName));
    } catch (Exception e) {
    ...
    if (ucmService != null) {
      ...
      return ucmService.getAdminConfigureBundleFromCs(
          i,
          i2,
          new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
              .setResourceId(4)
  ...
  public final int configureCredentialStorageInternal(
      ...
      if (z) {
        ...
        if (ucmService != null) {
          ...
          if (keyguardStorageForCurrentUser != null
            ...
            Log.i(
                TAG,
                "configureCredentialStorageInternal : Keyguard is setup with CS. Can't unmanaged"
                    + " it.");
            Binder.restoreCallingIdentity(clearCallingIdentity);
            return -26;
          }
  ...
  */
  public final int isValidCredentialStorage(CredentialStorage credentialStorage, int i) {
    boolean z;
    String str;
    String str2;
    ...
    UniversalCredentialManagerService universalCredentialManagerService = this;
    try {
      if (DBG) {
        Log.i(
            TAG,
            "UniversalCredentialManagerService.isValidCredentialStorage  cs.name-"
                + credentialStorage.name
                + ",cs.packageName-"
                + credentialStorage.packageName
                + "and callerId-"
      ...
      if (credentialStorageProvider != null) {
        String property = credentialStorageProvider.getProperty("isManageable");
        Log.i(TAG, "isValidCredentialStorage isManageable-" + property);
        if (!"true".equals(property)) {
          return -22;
        }
        String property2 = credentialStorageProvider.getProperty("configuratorList");
        if (DBG) {
          Log.i(TAG, "isValidCredentialStorage configuratorList-" + property2);
        }
        int i3 = 0;
        if (property2 == null || property2.length() <= 0) {
          return 0;
        }
        String[] split = property2.split(XmlUtils.STRING_ARRAY_SEPARATOR);
        String[] packagesForUid = universalCredentialManagerService.mPm.getPackagesForUid(i);
        if (packagesForUid != null) {
          int length = packagesForUid.length;
          int i4 = 0;
          z = false;
          while (i4 < length) {
            ...
            Log.i(TAG, "isValidCredentialStorage callerPkg-" + str3);
            if (split != null && split.length > 0) {
              int length2 = split.length;
              int i5 = i3;
              while (i5 < length2) {
                String[] split2 = split[i5].split("@");
                if (split2 != null && (str = split2[i3]) != null && str.trim().contains(str3)) {
                  if (split2.length == 2 && (str2 = split2[1]) != null && str2.length() > 0) {
                    Log.i(
                        TAG,
                        "isValidCredentialStorage callerPkg-"
                            + str3
                            + " match found. Now Matching signature...");
                    if (DBG) {
                      Log.i(TAG, "isValidCredentialStorage - config sign-" + split2[1]);
                    }
                    Signature[] convertStringToSignature =
                        universalCredentialManagerService.convertStringToSignature(
                            split2[1].trim());
                    if (convertStringToSignature == null) {
                      Log.i(TAG, "isValidCredentialStorage - failed to convert signature from db.");
                    }
                    try {
                      packageInfo =
                          AppGlobals.getPackageManager()
                              .getPackageInfo(str3, 64L, UserHandle.getUserId(i));
                    } catch (RemoteException e) {
                      Log.i(TAG, "The exception occurs " + e.getMessage());
                      packageInfo = null;
                      if (DBG) {
                        ...
                        Log.i(TAG, "isValidCredentialStorage caller sign-" + join);
                      }
                      if (convertStringToSignature == null) {}
                      Log.i(TAG, "isValidCredentialStorage signature didn't matched");
                      i5++;
                      universalCredentialManagerService = this;
                      i3 = 0;
                    } catch (Exception e2) {
                    ...
                    if (DBG
                      ...
                      Log.i(TAG, "isValidCredentialStorage caller sign-" + join2);
                    }
                    if (convertStringToSignature == null
                        && packageInfo != null
                        && compareSignatures(packageInfo.signatures, convertStringToSignature)) {
                      Log.i(TAG, "isValidCredentialStorage signature match found");
                    } else {
                      Log.i(TAG, "isValidCredentialStorage signature didn't matched");
                    }
                  } else {
                    Log.i(
                        ...
                        "isValidCredentialStorage callerPkg-"
                            + str3
                            + " is allowed to configure storage...");
                  }
                  z = true;
                  break;
                }
  ...
  public boolean isCredentialStorageManaged(
    ...
    if (DBG) {
      Log.i(
          TAG, "isCredentialStorageManaged is called for Caller UID-" + i + " mContainerId " + i2);
    }
  ...
  public final boolean lockCredentialStorageInternal(
    ...
    try {
      ...
      if (DBG) {
        Log.i(
            TAG,
            "lockCredentialStorageInternal - Exception lockCredentialStorageInternal"
                + e.getMessage());
      }
    }
        ...
        try {
          z3 =
              this.mEdmStorageProvider.deleteDataByFields(
                  ...
                  new String[] {"adminUid", "userId", "storageName", "storagePackageName"},
                  new String[] {
                    String.valueOf(i),
                    String.valueOf(i2),
                    credentialStorage.name,
  ...
  */
  public int getStorageAuthenticationType(int i, CredentialStorage credentialStorage) {
    checkCallerPermissionFor("getStorageAuthenticationType");
    Log.i(TAG, "getStorageAuthenticationType is called....");
    if (!isValidParam(credentialStorage)) {
      if (!DBG) {
        return -1;
      }
      Log.i(TAG, "getStorageAuthenticationType - Invalid Arguments");
      return -1;
    }
    if (!isPluginActive(credentialStorage)) {
      Log.i(TAG, "Plugin is not active");
      ...
      try {
        ArrayList dataByFields =
            this.mEdmStorageProvider.getDataByFields(
                ...
                new String[] {
                  String.valueOf(i), credentialStorage.name, credentialStorage.packageName
                },
                new String[] {"storageAuthType"});
        if (dataByFields != null && dataByFields.size() > 0) {
          ...
          while (true) {
            ...
            if (contentValues == null) {
              ...
              Integer asInteger = contentValues.getAsInteger("storageAuthType");
              if (asInteger == null) {
          ...
          for (AppIdentity appIdentity : packagesFromWhiteListInternal) {
            ...
            if (Arrays.asList(packagesForUid).contains(appIdentity.getPackageName())) {
              ...
              if (checkDelegatorPermission(
                  i, i3, appIdentity.getPackageName(), credentialStorage)) {
                z = true;
                break;
              }
            }
  ...
  public final boolean checkDelegatorPermission(
      int i, int i2, String str, CredentialStorage credentialStorage) {
    ...
    try {
      ...
      if (credentialStorage != null) {
        ...
        if (str2 != null && str3 != null) {
          if (isSystemStorage(str3)
              && AppGlobals.getPackageManager()
                      .checkUidPermission(
                          "com.samsung.android.knox.permission.KNOX_UCM_ESE_MGMT", delegatorUid)
                  == 0) {
          ...
          if (AppGlobals.getPackageManager()
                  .checkUidPermission(
                      "com.samsung.android.knox.permission.KNOX_UCM_OTHER_MGMT", delegatorUid)
              == 0) {
            Log.i(TAG, "  delegator has valid other permission... Processing further...");
            return true;
          }
        }
      } else if (AppGlobals.getPackageManager()
                  .checkUidPermission(
                      "com.samsung.android.knox.permission.KNOX_UCM_ESE_MGMT", delegatorUid)
              == 0
          || AppGlobals.getPackageManager()
  ...
  public int addPackagesToWhiteList(
      ContextInfo contextInfo, CredentialStorage credentialStorage, List list, Bundle bundle) {
    boolean z;
  ...
  public final int addPackagesToWhiteListMain(
      int i, int i2, CredentialStorage credentialStorage, List list, Bundle bundle, boolean z) {
    String str;
    ...
    try {
      if (isValidParam(credentialStorage) && list != null && bundle != null) {
        if (DBG) {
          Log.i(
              TAG,
              "addPackagesToWhiteListMain is called for Caller UID-" + i + " mContainerId " + i2);
        }
        ...
        if (i3 == 104) {
          ...
          if (TextUtils.isEmpty(string)) {
            if (DBG) {
              Log.i(
                  TAG,
                  "addPackagesToWhiteListMain alias name not provided for Certificate access_type");
            }
            Binder.restoreCallingIdentity(clearCallingIdentity);
            return -16;
          }
          ...
          if (true
              != checkCredentialStorageAliasForAdmin(
                  i, i2, credentialStorage.name, credentialStorage.packageName, string)) {
            if (DBG) {
        ...
        if (z) {
          ...
          while (it.hasNext()) {
            ...
            if (z && isPackageDelegated(appIdentity.getPackageName(), 107)) {
              Log.i(
                  TAG,
                  "addPackagesToWhiteListMain ..app is already delegated by other app.. error");
              return -29;
            }
          }
        }
  ...
  */
  public final int insertOrUpdateWhiteListPackages(
    ...
    String str8 = str;
    if (DBG) {
      Log.i(TAG, "insertOrUpdateWhiteListPackages is called...");
    }
    if (DBG) {
      Log.i(
          TAG,
    ...
    Log.i(TAG, "insertOrUpdateWhiteListPackages access_type-" + i3);
    String packageName = ((AppIdentity) list.get(0)).getPackageName();
    boolean z3 = packageName != null && packageName.equals("*");
    Log.i(TAG, "insertOrUpdateWhiteListPackages - allowAllApp -" + z3);
    String str9 = "storageManufacture";
    String str10 = "UniversalCredentialWhiteListTable";
    String str11 = "The exception occurs ";
    int i7 = -1;
    if (true == z3) {
      Log.i(TAG, "insertOrUpdateWhiteListPackages - inside Allow all packages");
      ContentValues contentValues = new ContentValues();
      contentValues.put("adminUid", Integer.valueOf(i));
      contentValues.put("userId", Integer.valueOf(i2));
      contentValues.put("storageName", credentialStorage2.name);
      contentValues.put("storagePackageName", credentialStorage2.packageName);
      String str12 = credentialStorage2.manufacturer;
      if (str12 != null) {
        contentValues.put("storageManufacture", str12);
      }
      contentValues.put("accessType", Integer.valueOf(i3));
      if (str8 != null) {
        contentValues.put("alias", str8);
      }
      contentValues.put("appPackage", "*");
      ContentValues contentValues2 = new ContentValues();
      contentValues2.put("adminUid", Integer.valueOf(i));
      contentValues2.put("userId", Integer.valueOf(i2));
      contentValues2.put("storageName", credentialStorage2.name);
      contentValues2.put("storagePackageName", credentialStorage2.packageName);
      contentValues2.put("accessType", Integer.valueOf(i3));
      if (str8 != null) {
        contentValues2.put("alias", str8);
      }
      contentValues2.put("appPackage", "*");
      try {
        i7 =
            this.mEdmStorageProvider.putValues(
                    "UniversalCredentialWhiteListTable", contentValues, contentValues2)
                ? 0
                : -1;
      } catch (Exception e) {
        if (DBG) {
          Log.i(
              TAG, "insertOrUpdateWhiteListPackages - Exception allowAllPackages" + e.getMessage());
        }
      }
      str2 = "UniversalCredentialWhiteListTable";
    } else {
      Log.i(TAG, "insertOrUpdateWhiteListPackages - inside else block...");
      Log.i(TAG, "insertOrUpdateWhiteListPackages - WhiteList app size -" + list.size());
      IPackageManager packageManager = AppGlobals.getPackageManager();
      Iterator it = list.iterator();
      i4 = -1;
      while (true) {
        ...
        String str14 = str10;
        sb.append("insertOrUpdateWhiteListPackages - pkg : ");
        ...
        if (appIdentity.getPackageName() == null || appIdentity.getPackageName().length() == 0) {
          ...
          try {
            ...
            packageInfo = null;
            Log.i(TAG, "Package Info: " + packageInfo);
            if (packageInfo == null) {}
            if (!isSignatureInvalid(appIdentity, packageInfo, z)) {}
          }
          Log.i(TAG, "Package Info: " + packageInfo);
          z = packageInfo == null;
          if (!isSignatureInvalid(appIdentity, packageInfo, z)) {
          ...
          contentValues3.put("storageName", credentialStorage2.name);
          contentValues3.put("storagePackageName", credentialStorage2.packageName);
          contentValues3.put("accessType", Integer.valueOf(i3));
          if (str8 != null) {
            contentValues3.put("alias", str8);
          }
          contentValues3.put("appPackage", appIdentity.getPackageName());
          if (z) {
            z2 = z;
            try {
              contentValues3.put("appUid", Integer.valueOf(packageInfo.applicationInfo.uid));
              str5 = str4;
            } catch (Exception e4) {
              String str16 = TAG;
              ...
              str5 = str4;
              sb3.append("insertOrUpdateWhiteListPackages getting appuid - Exception");
          ...
          if (appIdentity.getSignature() != null) {
            contentValues3.put("appSignature", appIdentity.getSignature());
          }
          String str17 = credentialStorage2.manufacturer;
          String str18 = str3;
          if (str17 != null) {
            contentValues3.put(str18, str17);
          }
          ContentValues contentValues4 = new ContentValues();
          contentValues4.put("adminUid", Integer.valueOf(i));
          contentValues4.put("userId", Integer.valueOf(i2));
          contentValues4.put("storageName", credentialStorage2.name);
          contentValues4.put("storagePackageName", credentialStorage2.packageName);
          contentValues4.put("appPackage", appIdentity.getPackageName());
          contentValues4.put("accessType", Integer.valueOf(i3));
          if (str8 != null) {
            contentValues4.put("alias", str8);
          }
          try {
            str2 = str14;
          } catch (Exception e5) {
          ...
          if (!this.mEdmStorageProvider.putValues(str2, contentValues3, contentValues4)) {
            try {
              if (!DBG) {
                break;
              }
              Log.i(TAG, "insertOrUpdateWhiteListPackages - DB operation failed");
              break;
            } catch (Exception e7) {
              e = e7;
              if (DBG) {
            ...
            if (z2) {
              try {
                i6 = packageInfo2.applicationInfo.uid;
                str7 = str18;
              } catch (Exception e8) {
                e = e8;
                str7 = str18;
              ...
              try {
                if (!this.whitelistedAppsCache.containsKey(Integer.valueOf(i6))) {
                  this.whitelistedAppsCache.put(Integer.valueOf(i6), appIdentity.getPackageName());
                  Log.i(
                      TAG,
      ...
      Log.i(TAG, "insertOrUpdateWhiteListPackages retcode-" + i4);
  ...
  public final boolean isSignatureInvalid(
      AppIdentity appIdentity, PackageInfo packageInfo, boolean z) {
    ...
    try {
      try {
        if (DBG) {
          Log.i(
              TAG,
              "removePackagesFromWhiteList is called for Caller UID-" + i2 + " mContainerId " + i3);
        }
        str = credentialStorage.signature;
      } catch (Exception e2) {
        Log.i(TAG, "The exception occurs " + e2.getMessage());
      ...
      if (true
              != isCredentialStorageManagedInternal(
                  i2, i3, credentialStorage.name, credentialStorage.packageName)
          && !z) {
        if (DBG) {
      ...
      if (i4 == 104) {
        ...
        if (TextUtils.isEmpty(string)) {
          if (DBG) {
            Log.i(
                TAG,
                "removePackagesFromWhiteList alias name not provided for Certificate access_type");
          }
          Binder.restoreCallingIdentity(clearCallingIdentity);
          return -16;
        }
        ...
        if (true
            != checkCredentialStorageAliasForAdmin(
                i2, i3, credentialStorage.name, credentialStorage.packageName, str2)) {
          if (DBG) {
  ...
  public List getPackagesFromWhiteList(
      ContextInfo contextInfo, CredentialStorage credentialStorage, Bundle bundle) {
    boolean z;
    String str;
    String str2;
    ...
    try {
      try {
        if (DBG) {
          Log.i(
              TAG,
              "getPackagesFromWhiteList is called for Caller UID-" + i + " mContainerId " + i2);
        }
        str = credentialStorage.signature;
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    if (i3 == 104) {
      ...
      if (TextUtils.isEmpty(string)) {
        if (DBG) {
          Log.i(
              TAG, "getPackagesFromWhiteList alias name not provided for Certificate access_type");
        }
        return null;
      }
      if (true
    ...
    Log.i(
        TAG,
        "getPackagesFromWhiteList cxtInfo.mContainerId-"
            + i2
            + ",name-"
            + credentialStorage.name
            + ",package-"
  ...
  public final ArrayList getAllWhitelistedApps() {
    return this.mEdmStorageProvider.getDataByFields(
        "UniversalCredentialWhiteListTable", null, null, new String[] {"appUid", "appPackage"});
  }

  public final ArrayList getAllExemptedApps() {
    return this.mEdmStorageProvider.getDataByFields(
        "UniversalCredentialExemptTable", null, null, new String[] {"appUid", "appPackage"});
  }

  public final ArrayList getWhitelistedData(
      int i, int i2, CredentialStorage credentialStorage, int i3, String str) {
    if (str == null) {
      return this.mEdmStorageProvider.getDataByFields(
          "UniversalCredentialWhiteListTable",
          new String[] {"adminUid", "userId", "storageName", "storagePackageName", "accessType"},
          new String[] {
            String.valueOf(i),
            String.valueOf(i2),
            credentialStorage.name,
  ...
  public final void processPackagesForPlugin(
    ...
    Log.i(
        TAG,
        "processPackagesForPlugin - adminUid"
            + i
            + ", userId-"
            + i2
            + ", Storage -"
            + credentialStorage.name);
    try {
      List<Integer> adminIdRelatedToStorageAsUser =
        ...
        if (num == null) {
          ...
          if (num.intValue() == i) {
            ...
            ArrayList whitelistedData =
                getWhitelistedData(num.intValue(), i2, credentialStorage, 103, null);
            if (whitelistedData != null && whitelistedData.size() > 0) {
              Iterator it = whitelistedData.iterator();
              while (it.hasNext()) {
                  ...
                  try {
                    ...
                    if (str != null && packageName2 != null && packageName2.equals(str)) {
                      if (signature != null) {
                        ...
                        try {
                          packageInfo =
                              packageManager.getPackageInfo(str, 64L, UserHandle.getUserId(i));
                        } catch (Exception e2) {
                          Log.i(TAG, "The exception occurs " + e2.getMessage());
                          packageInfo = null;
                        }
                        if (convertStringToSignature != null
                          ...
                          Log.i(
                              TAG,
                              "isAccessAllowed signature mismatch happened...Ignoring package");
                        }
                      } else {
  ...
  */
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final int getDelegatorUid(int i, int i2, String str, CredentialStorage credentialStorage) {
    ArrayList dataByFields;
    int i3 = -1;
    try {
      if (credentialStorage != null) {
        dataByFields =
            this.mEdmStorageProvider.getDataByFields(
                "UniversalCredentialWhiteListTable",
                new String[] {
                  "userId", "storageName", "storagePackageName", "accessType", "appPackage"
                },
                new String[] {
                  String.valueOf(i),
                  credentialStorage.name,
        ...
        dataByFields =
            this.mEdmStorageProvider.getDataByFields(
                "UniversalCredentialWhiteListTable",
                new String[] {"userId", "accessType", "appPackage"},
                new String[] {String.valueOf(i), String.valueOf(i2), str},
                new String[] {"adminUid"});
      }
      if (dataByFields != null && dataByFields.size() > 0) {
        Log.i(TAG, "getDelegatorUid - Size-" + dataByFields.size());
        Iterator it = dataByFields.iterator();
        while (true) {
          if (!it.hasNext()) {
            break;
          ...
          if (contentValues == null) {
            ...
            if (asInteger == null) {
              ...
              int intValue = asInteger.intValue();
              Log.i(TAG, "getDelegatorUid adminId -" + intValue);
              if (isAdminLicenseActive(intValue, credentialStorage)) {
                try {
                  ...
                  i3 = intValue;
                  Log.i(TAG, "The exception occurs " + e.getMessage());
                  Log.i(TAG, "getDelegatorUid adminUid - " + i3);
                  return i3;
                }
              }
            }
    ...
    try {
      ...
      if (dataByFields != null && dataByFields.size() > 0) {
        ...
        while (it.hasNext()) {
          ...
          Log.i(
              TAG,
              "getDelegatedStorages storageName -" + asString + ", storagePackage-" + asString2);
          CredentialStorage credentialStorage = new CredentialStorage();
  ...
  public final boolean isPackageDelegated(String str, int i) {
    ...
    try {
      ...
      if (this.mEdmStorageProvider.getCount("UniversalCredentialWhiteListTable", contentValues)
          <= 0) {
        return false;
      }
      if (!DBG) {
        ...
        if (i2 == 104) {
          ...
          if (TextUtils.isEmpty(str)) {
            if (DBG) {
              Log.i(
                  TAG,
                  "getPackagesFromWhiteListInternal alias name not provided for Certificate"
                      + " access_type");
            }
            return null;
          }
        ...
        if (str != null) {
          dataByFields =
              this.mEdmStorageProvider.getDataByFields(
                  "UniversalCredentialWhiteListTable",
                  new String[] {
                    "userId", "storageName", "storagePackageName", "accessType", "alias"
                  },
                  new String[] {
                    String.valueOf(i),
                    credentialStorage.name,
          ...
          dataByFields =
              this.mEdmStorageProvider.getDataByFields(
                  "UniversalCredentialWhiteListTable",
                  new String[] {"userId", "storageName", "storagePackageName", "accessType"},
                  new String[] {
                    String.valueOf(i),
                    credentialStorage.name,
                    credentialStorage.packageName,
  ...
  public final boolean clearWhiteListPackages(
      CredentialStorage credentialStorage, int i, int i2, int i3, String str) {
    if (DBG) {
      ...
      try {
        ArrayList dataByFields =
            this.mEdmStorageProvider.getDataByFields(
                ...
                new String[] {String.valueOf(i), String.valueOf(i2)},
                new String[] {
                  "storageName", "storagePackageName", "storageManufacture", "appPackage"
                });
        if (dataByFields != null && dataByFields.size() > 0) {
          ...
          while (it.hasNext()) {
            ...
            if (asString != null
                && (asString.equalsIgnoreCase(str) || asString.equalsIgnoreCase("*"))) {
  ...
  */
  public String[] getCertificateAliases(int i, CredentialStorage credentialStorage) {
    ...
    checkCallerPermissionFor("getCertificateAliases");
    Log.i(TAG, "getCertificateAliases is called....");
    if (!isValidParam(credentialStorage)) {
      if (DBG) {
        Log.i(TAG, "getCertificateAliases - Invalid Arguments");
      }
      return null;
    }
    int userId = UserHandle.getUserId(i);
    if (DBG) {
      Log.i(TAG, "getCertificateAliases is called for mContainerId " + userId);
    }
    ArrayList arrayList = new ArrayList();
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      try {
        dataByFields =
            this.mEdmStorageProvider.getDataByFields(
                ...
                new String[] {"adminUid", "alias", "appPackage"});
      } catch (Exception e) {
        if (DBG) {
          Log.i(TAG, "The exception occurs " + e.getMessage());
        }
      ...
      if (dataByFields != null && dataByFields.size() > 0) {
        ...
        if (packagesForUid != null) {
          ...
          for (i2 = 0; i2 < length; i2++) {
            ...
            Log.i(TAG, "getCertificateAliases pkgName-" + str2);
            Iterator it = dataByFields.iterator();
            while (it.hasNext()) {
              ContentValues contentValues = (ContentValues) it.next();
              if (contentValues == null) {
                ...
                String str4 = str;
                StringBuilder sb = new StringBuilder();
                ArrayList arrayList2 = dataByFields;
                sb.append("getCertificateAliases dbPackage-");
                sb.append(asString);
                Log.i(str3, sb.toString());
                if (asString != null
                    && (asString.equalsIgnoreCase(str2) || asString.equalsIgnoreCase("*"))) {
                  String asString2 = contentValues.getAsString("alias");
                  Log.i(TAG, "getCertificateAliases alias found alias-" + asString2);
                  Integer asInteger = contentValues.getAsInteger("adminUid");
                  if (asInteger == null) {
                    Log.i(TAG, "parsing error, continue...");
                  } else if (isAdminLicenseActive(asInteger.intValue(), credentialStorage)
                      && !arrayList.contains(asString2)) {
                    arrayList.add(asString2);
                  }
                }
                length = i3;
                str = str4;
                dataByFields = arrayList2;
              }
            }
          }
          strArr = (String[]) arrayList.toArray(new String[arrayList.size()]);
          if (strArr != null) {
            Log.i(TAG, "getCertificateAliases - aliases size -" + strArr.length);
          }
          return strArr;
        }
        Log.i(TAG, "getCertificateAliases no packages related to uid-" + i);
      } else {
        Log.i(TAG, "getCertificateAliases - No record found...");
      }
      strArr = null;
      if (strArr != null) {}
      return strArr;
  ...
  public boolean isCredentialStorageEnabledForLockType(
    ...
    try {
      KnoxAnalytics.log(
          getKAData("isCredentialStorageEnabledForLockType", credentialStorage.packageName));
    } catch (Exception e) {
      Log.e(TAG, "Exception = " + Log.getStackTraceString(e));
    }
    int i = contextInfo.mCallerUid;
    ...
    try {
      try {
        if (isValidParam(credentialStorage)) {
          ...
          Log.i(
              TAG,
              "isCredentialStorageEnabledForLockType Invalid credential storage object passed...");
        }
      } catch (Exception e2) {
        if (DBG) {
          Log.i(TAG, "The exception occurs " + e2.getMessage());
    ...
    try {
      try {
        if (isValidParam(credentialStorage)) {
          ...
          Log.i(
              TAG,
              "isCredentialStorageEnabledForLockTypeAsUser Invalid credential storage object"
                  + " passed...");
        }
      } catch (Exception e) {
        if (DBG) {
    ...
    try {
      ...
      if (!isValidParam(credentialStorage)) {
        if (DBG) {
          Log.i(
              TAG,
              "enableCredentialStorageForLockType Invalid credential storage object passed...");
        }
        return -1;
      }
      if (true
          != isCredentialStorageManagedInternal(
              i2, i, credentialStorage.name, credentialStorage.packageName)) {
        if (DBG) {
      ...
      if (credentialStorageProvider == null) {
        if (DBG) {
          Log.i(
              TAG,
              "enableCredentialStorageForLockType No matching managed Credential Storage found in"
                  + " Provider list");
        }
        return -13;
      }
      ...
      if ("false".equals(property)) {
        if (DBG) {
          Log.i(
              TAG,
              "enableCredentialStorageForLockType Generate Password not supported by Provider");
        }
        Binder.restoreCallingIdentity(clearCallingIdentity);
        return -27;
      }
    ...
    try {
      if (checkCredentialStorageEnabledForLockTypebyAdmin(-1, i2, credentialStorage)) {
        if (checkCredentialStorageEnabledForLockTypebyAdmin(i, i2, credentialStorage)) {
          ...
          Log.i(
              TAG,
              "enableCredentialStorageForLockTypeInternal record already exist for another admin."
                  + " Enabling for current Admin too...");
          ...
          Log.i(
              TAG,
              "enableCredentialStorageForLockTypeInternal Credential storage not enabled as a Lock"
                  + " type by this admin..");
        }
      } else if (z) {
        Log.i(
            TAG,
            "enableCredentialStorageForLockTypeInternal enabling lock type for current Admin ...");
        if (addCredentialStorageLockType(i, i2, credentialStorage)) {
          return 0;
        }
      } else if (DBG) {
  ...
  public final boolean checkCredentialStorageEnabledForLockTypebyAdmin(
      int i, int i2, CredentialStorage credentialStorage) {
    String str = credentialStorage.name;
    String str2 = credentialStorage.packageName;
    try {
      ContentValues contentValues = new ContentValues();
  ...
  public final boolean addCredentialStorageLockType(
    ...
    if (DBG) {
      ...
      Log.i(
          TAG,
          "addCredentialStorageLockType adminUid - "
              + i
              + " ContainerId - "
              + i2
              + ", Storage Name- "
  ...
  public final boolean removeCredentialStorageLockType(
    ...
    if (DBG) {
      ...
      Log.i(
          TAG,
          "removeCredentialStorageLockType adminUid - "
              + i
              + " ContainerId - "
              + i2
              + ", Storage Name- "
  ...
  public int enforceCredentialStorageAsLockType(
    ...
    try {
      KnoxAnalyticsData kAData =
          getKAData("enforceCredentialStorageAsLockType", credentialStorage.packageName);
    ...
    try {
      try {
        if (DBG) {
          Log.i(
              TAG,
              "enforceCredentialStorageAsLockType is called for Caller UID-"
                  + i2
                  + " mContainerId "
                  + i);
        }
        if (isValidParam(credentialStorage)) {
          ...
          if (credentialStorageProvider == null) {
            if (DBG) {
              Log.i(
                  TAG,
                  "enforceCredentialStorageAsLockType No matching managed Credential Storage found"
                      + " in Provider list");
            }
            return -13;
          }
          ...
          if ("false".equals(property)) {
            if (DBG) {
              Log.i(
                  TAG,
                  "enforceCredentialStorageAsLockType Generate Password not supported by Provider");
            }
            Binder.restoreCallingIdentity(clearCallingIdentity);
            return -27;
          }
          if (DBG) {
            Log.i(
                TAG, "enforceCredentialStorageAsLockType Generate Password supported by Provider");
          }
        } else {
          if (credentialStorage != null) {
            if (DBG) {
              Log.i(
                  TAG,
                  "enforceCredentialStorageAsLockType Invalid credential storage object passed...");
            }
            return -1;
          }
          IUcmService ucmService = getUcmService();
          if (ucmService != null) {
            ...
            if (!checkCredentialStorageLockTypeEnforcedForAdmin(i2, i, null, null)) {
              if (DBG) {
                Log.i(
                    TAG,
                    "enforceCredentialStorageAsLockType Admin did not enforce any credential"
                        + " storage as Lock Type for this user");
              }
              return -1;
            }
          }
  ...
  public final int enforceCredentialStorageAsLockTypeInternal(
    ...
    try {
      if (credentialStorage == null) {
        Log.i(
            TAG,
            "enforceCredentialStorageAsLockTypeInternal cs is null so removing admin entry...");
        boolean deleteDataByFields =
            this.mEdmStorageProvider.deleteDataByFields(
                "UniversalCredentialEnforcedLockTypeTable",
                new String[] {"adminUid", "userId"},
      ...
      if (!checkCredentialStorageLockTypeEnforcedForAdmin(i, i2, null, null)) {
        Log.i(
            TAG,
            "enforceCredentialStorageAsLockTypeInternal Credential storage is configured by some"
                + " other admin");
        return -10;
      }
      Log.i(
          TAG,
          "enforceCredentialStorageAsLockTypeInternal Another Credential storage is already"
              + " configured by some other admin");
      return addOrUpdateEnforcedCredentialStorageLockType(i, i2, credentialStorage) ? 0 : -1;
    } catch (Exception e) {
      Log.i(TAG, "The exception occurs " + e.getMessage());
      return -1;
    ...
    try {
      try {
        if (DBG) {
          Log.i(
              TAG,
              "setDefaultInstallStorage is called for Caller UID-" + i2 + " mContainerId " + i);
        }
        if (i >= 10) {
  ...
  public final int setDefaultInstallStorageInternal(
    ...
    try {
      ...
      Log.i(
          TAG,
          "setDefaultInstallStorageInternal Credential storage is configured by some other admin");
      return -10;
    } catch (Exception e) {
      Log.i(TAG, "The exception occurs " + e.getMessage());
      return -1;
  ...
  public final int installCertificateMain(
    ...
    if (isValidParam(credentialStorage) && bArr != null && str != null && (z || str2 != null)) {
      ...
      int installCertificateInProvider =
          installCertificateInProvider(credentialStorage, bArr, str, str2, bundle, i2, i, z, z2);
  ...
  */
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final int installCertificateInProvider(
      CredentialStorage credentialStorage,
      byte[] bArr,
      String str,
      String str2,
    ...
    Log.i(
        TAG,
        "installCertificateInProvider is called for userId-"
            + i
            + " and adminId-"
            + i2
            + ", systemCalling-"
    ...
    Log.i(
        TAG,
        "installCertificateInProvider setting extra values userId-" + i + " and adminId-" + i2);
    bundle.putInt("user_id", i);
    bundle.putInt("admin_id", i2);
    String build =
        new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
            .setResourceId(1)
            .setUid(i2)
    ...
    if (z) {
      if (str2 != null) {
        try {
          ...
          i3 = -1;
          if (!z2) {}
          Log.i(TAG, "status -" + z2 + " and errorCode-" + i3);
          if (z2) {}
        }
      }
      Log.i(TAG, "Inside systemCalling block...");
      if (bArr != null) {
        Log.i(TAG, "Calling installCertificate in UCS");
        bundle.putBoolean("renew", z2);
        byte[] byteArray = bundle.getByteArray("private_key");
        IUcmService ucmService2 = getUcmService();
        if (ucmService2 != null) {
          Bundle installCertificate =
              ucmService2.installCertificate(build, byteArray, bArr, bundle);
          z2 =
              installCertificate != null
                  ? installCertificate.getBoolean("booleanresponse", false)
                  : false;
          if (installCertificate != null) {
            i3 = installCertificate.getInt("errorresponse", -1);
            if (!z2 && i3 == -1) {
              try {
                ucmService = getUcmService();
                if (ucmService != null) {
                  Bundle installCertificateIfSupported =
                      ucmService.installCertificateIfSupported(build, bArr, str2, bundle);
                  boolean z3 =
                      installCertificateIfSupported != null
                          ? installCertificateIfSupported.getBoolean("booleanresponse", false)
                          : false;
                  if (installCertificateIfSupported != null) {
                    try {
                      i4 = installCertificateIfSupported.getInt("errorresponse", -1);
                    } catch (Exception e3) {
                      e = e3;
                      z2 = z3;
                      Log.i(TAG, "The exception occurs " + e.getMessage());
    ...
    while (true) {
      ...
      if (key instanceof PrivateKey) {
        ...
        if (certificateChain != null && certificateChain.length != 0) {
          ...
          IUcmService ucmService3 = getUcmService();
          if (ucmService3 != null) {
            Bundle installCertificate2 =
                ucmService3.installCertificate(build, key.getEncoded(), byteArray2, bundle);
            z2 =
                installCertificate2 != null
                    ? installCertificate2.getBoolean("booleanresponse", false)
                    : false;
            if (installCertificate2 != null) {
              i3 = installCertificate2.getInt("errorresponse", -1);
            }
          }
        }
        Log.i(TAG, "getCertificateChain empty");
        return -1;
      }
    }
    z2 = false;
  ...
  public final boolean insertOrUpdateCertificateProfile(
    ...
    try {
      ...
      if (this.mEdmStorageProvider.getCount("UniversalCredentialCertificateTable", contentValues)
          == 0) {
        contentValues.put("storageManufacture", credentialStorage.manufacturer);
        z2 =
            this.mEdmStorageProvider.putValuesNoUpdate(
  ...
  public final int deleteCertificateMain(
    ...
    try {
      ...
      if (isValidParam(credentialStorage) && str != null && str.length() != 0) {
        ...
        if (true
            != checkCredentialStorageAliasForAdmin(
                i, i2, credentialStorage.name, credentialStorage.packageName, validString)) {
          if (DBG) {
            Log.i(TAG, "- alias not exist for credential storage...");
          }
          Binder.restoreCallingIdentity(clearCallingIdentity);
        ...
        int removeCertificatefromProvider =
            removeCertificatefromProvider(
                credentialStorage.name, credentialStorage.packageName, validString, i2, i);
    ...
    try {
      z =
          this.mEdmStorageProvider.deleteDataByFields(
              ...
              new String[] {"adminUid", "userId", "storageName", "storagePackageName", "alias"},
              new String[] {
                String.valueOf(i),
                String.valueOf(i2),
                credentialStorage.name,
      ...
      if (z) {
        ...
        Log.i(
            TAG, "deleteCertificateUsingAdminId remove whitelist status-" + clearWhiteListPackages);
      }
    } catch (Exception e) {
      if (DBG) {
  ...
  */
  public final int removeCertificatefromProvider(
    ...
    Log.i(
        TAG,
        "removeCertificatefromProvider is called for userId-"
            + i
            + " and adminId-"
            + i2
            + " and alias-"
    ...
    try {
      ...
      ArrayList dataByFields =
          this.mEdmStorageProvider.getDataByFields(
              "UniversalCredentialCertificateTable",
              new String[] {"storageName", "storagePackageName", "alias", "userId", "adminUid"},
              new String[] {str, str2, str3, Integer.toString(i), Integer.toString(i2)},
              new String[] {"wifi"});
      if (dataByFields != null && dataByFields.size() > 0) {
        Iterator it = dataByFields.iterator();
        int i5 = 1;
        while (it.hasNext()) {
          Integer asInteger = ((ContentValues) it.next()).getAsInteger("wifi");
      ...
      IUcmService ucmService = getUcmService();
      if (ucmService != null) {
        Bundle deleteCertificate = ucmService.deleteCertificate(build, i);
        z =
            deleteCertificate != null
                ? deleteCertificate.getBoolean("booleanresponse", false)
                : false;
        if (deleteCertificate != null) {
          try {
            i3 = deleteCertificate.getInt("errorresponse", -1);
          } catch (Exception e) {
            e = e;
            Log.i(TAG, "The exception occurs " + e.getMessage());
            if (z) {}
        ...
        Log.i(TAG, "removeCertificatefromProvider : " + z + "=" + z + "; csUri=" + build);
      } else {
        z = false;
      }
    } catch (Exception e2) {
      ...
      try {
        ArrayList dataByFields =
            this.mEdmStorageProvider.getDataByFields(
                "UniversalCredentialCertificateTable",
                new String[] {"storageName", "storagePackageName"},
                new String[] {credentialStorage.name, credentialStorage.packageName},
                new String[] {"adminUid", "alias"});
        if (dataByFields != null && dataByFields.size() > 0) {
          ArrayList arrayList = new ArrayList();
          Iterator it = dataByFields.iterator();
  ...
  public String[] getSupportedAlgorithms(
    ...
    if (DBG) {
      Log.i(
          TAG,
          "getSupportedAlgorithms is called for Caller UID-"
              + contextInfo.mCallerUid
              + " mContainerId "
      ...
      try {
        if (getUniversalCredentialUtil() != null) {
          ...
          if (managedProviders != null && managedProviders.length > 0) {
            ...
            Log.i(
                TAG,
                "getSupportedAlgorithmsInternal - UniversalCredentialUtil service returns no"
                    + " providers... ");
          }
        } else {
          Log.i(
              TAG, "getSupportedAlgorithmsInternal - UniversalCredentialUtil service is null.... ");
        }
      } catch (Exception e) {
        Log.i(TAG, "The exception occurs " + e.getMessage());
      }
  ...
  public Bundle setCredentialStorageProperty(
    ...
    try {
      ...
      if (DBG) {
        Log.i(
            TAG,
            "setCredentialStorageProperty is called for Caller UID-" + i2 + " mContainerId " + i);
      }
      if (true
          != isCredentialStorageManagedInternal(
              i2, i, credentialStorage.name, credentialStorage.packageName)) {
      ...
      if (ucmService != null) {
        ...
        return ucmService.setCredentialStorageProperty(
            i2,
            new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                .setResourceId(4)
                .setUid(i2)
  ...
  public Bundle getCredentialStorageProperty(
    ...
    try {
      ...
      if (ucmService != null) {
        ...
        return ucmService.getCredentialStorageProperty(
            i2,
            new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                .setResourceId(4)
                .setUid(i2)
  ...
  public int setAuthType(ContextInfo contextInfo, CredentialStorage credentialStorage, int i) {
    ...
    try {
      ...
      if (true
          != isCredentialStorageManagedInternal(
              i3, i2, credentialStorage.name, credentialStorage.packageName)) {
        if (DBG) {
  ...
  public int addPackagesToExemptList(
      ContextInfo contextInfo, CredentialStorage credentialStorage, int i, List list) {
    ...
    try {
      KnoxAnalyticsData kAData =
          getKAData("addPackagesToExemptList", credentialStorage.packageName);
    ...
    try {
      try {
        if (DBG) {
          Log.i(
              TAG,
              "addPackagesToExemptList is called for Caller UID-" + i2 + " mContainerId " + i3);
        }
        String str = credentialStorage.signature;
        if (str != null && !validateSignature(credentialStorage.packageName, str, 0)) {
          Binder.restoreCallingIdentity(clearCallingIdentity);
        ...
        if (z) {
          try {
            ...
            if (!this.exemptedAppsCache.containsKey(Integer.valueOf(i8))) {
              ...
              Log.i(
                  TAG,
                  "Caching Exempt app id-" + i8 + ", packageName-" + appIdentity.getPackageName());
            }
          } catch (Exception e4) {
  ...
  public int removePackagesFromExemptList(
    ...
    try {
      KnoxAnalyticsData kAData =
          getKAData("removePackagesFromExemptList", credentialStorage.packageName);
      kAData.setProperty("authType", i == 106 ? "AUTH" : "OTHER");
      KnoxAnalytics.log(kAData);
    } catch (Exception e) {
      Log.e(TAG, "Exception = " + Log.getStackTraceString(e));
    ...
    try {
      try {
        if (DBG) {
          Log.i(
              TAG,
              "removePackagesFromExemptList is called for Caller UID-"
                  + i2
                  + " mContainerId "
                  + i3);
        }
      ...
      try {
        z =
            this.mEdmStorageProvider.deleteDataByFields(
                "UniversalCredentialExemptTable",
                new String[] {
                  "adminUid", "userId", "storageName", "storagePackageName", "exemptType"
                },
                new String[] {
                  String.valueOf(i),
                  String.valueOf(i2),
  ...
  public List getPackagesFromExemptList(
      ContextInfo contextInfo, CredentialStorage credentialStorage, int i) {
    String str;
  ...
  public final List getPackagesFromExemptListAsUser(
    ...
    try {
      ...
      ArrayList dataByFields =
          this.mEdmStorageProvider.getDataByFields(
              "UniversalCredentialExemptTable",
              new String[] {"userId", "storageName", "storagePackageName", "exemptType"},
              new String[] {
                String.valueOf(i),
                credentialStorage.name,
                credentialStorage.packageName,
    ...
    try {
      try {
        List<AppIdentity> packagesFromExemptListAsUser =
            getPackagesFromExemptListAsUser(UserHandle.getUserId(i), credentialStorage, i2);
                ...
                for (AppIdentity appIdentity : packagesFromExemptListAsUser) {
                  ...
                  if (str != null && packageName != null && packageName.equals(str)) {
                    if (signature != null) {
                      Log.i(
                          TAG,
                          "isPackageFromExemptList package matched. Now matching signature....");
                      Signature[] convertStringToSignature = convertStringToSignature(signature);
                      if (convertStringToSignature == null) {
                        Log.i(
                            TAG, "isPackageFromExemptList - failed to convert signature from db.");
                      }
                      try {
                        packageInfo =
                            packageManager.getPackageInfo(str, 64L, UserHandle.getUserId(i));
                      ...
                      if (convertStringToSignature != null
                          ...
                          && compareSignatures(packageInfo.signatures, convertStringToSignature)) {
                        Log.i(
                            TAG, "isPackageFromExemptList match found with signature matching...");
                      } else {
                        Log.i(
                            TAG,
                            "isPackageFromExemptList signature mismatch happened...Ignoring"
                                + " package");
                      }
                    } else {
      ...
      if (i == 1) {
        ...
        if (ucmService != null) {
          ...
          try {
            ...
            while (it2.hasNext()) {
              ucmService.notifyChangeToPlugin(
          ...
          for (Integer num2 : adminIdRelatedToStorage) {
            ...
            if (packagesForUid2 == null) {
              ...
              while (i5 < length2) {
                ...
                Log.i(TAG, "Sending event update to package " + str2);
                Intent intent =
                    new Intent("com.samsung.android.knox.intent.action.UCM_NOTIFY_EVENT");
                intent.setPackage(str2);
                Bundle bundle2 = new Bundle();
  ...
  public final void processAdminLicenseExpiry(int i) {
    ...
    if (this.expiredAdmins.containsKey(Integer.valueOf(i))
        || storagesRelatedToAdminId.size() <= 0) {
      return;
    }
    ...
    if (ucmService != null) {
      ...
      try {
        ...
        while (it.hasNext()) {
          ucmService.notifyChangeToPlugin(
              new UniversalCredentialUtil.UcmUriBuilder((String) it.next()).build(), 13, bundle);
        }
      } catch (Exception e) {
        Log.i(TAG, "The exception occurs " + e.getMessage());
      }
  ...
  public final List getAllAdmins() {
    ...
    ArrayList dataByFields =
        this.mEdmStorageProvider.getDataByFields(
            "UniversalCredentialInfoTable", null, null, new String[] {"adminUid"});
  ...
  public final List getAllUsers() {
    ...
    try {
      ...
      ArrayList dataByFields4 =
          this.mEdmStorageProvider.getDataByFields(
              "UniversalCredentialExemptTable", null, null, strArr);
  ...
  public final boolean checkDefaultInstallCredentialStorageExists(int i, String str, String str2) {
    ...
    try {
      ...
      contentValues.put("storageName", str);
      contentValues.put("storagePackageName", str2);
      if (this.mEdmStorageProvider.getCount("UniversalCredentialDefaultInstallTable", contentValues)
          <= 0) {
        return false;
      }
      if (!DBG) {
  ...
  public final void performCredentialStorageCleanup(
    ...
    String[] strArr2 = {
      String.valueOf(i), String.valueOf(i2), credentialStorage.name, credentialStorage.packageName
    };
    try {
      z =
          this.mEdmStorageProvider.deleteDataByFields(
  ...
  public int configureCredentialStorageForODESettings(
    ...
    try {
      KnoxAnalytics.log(
          getKAData("configureCredentialStorageForODESettings", credentialStorage.packageName));
    } catch (Exception e) {
      Log.e(TAG, "Exception = " + Log.getStackTraceString(e));
    }
    int i = contextInfo.mContainerId;
    ...
    if (credentialStorage != null) {
      ...
      build =
          new UniversalCredentialUtil.UcmUriBuilder("reset").setResourceId(4).setUid(i2).build();
    }
    IUcmService ucmService = getUcmService();
    if (ucmService != null) {
      Log.i(TAG, "configureCredentialStorageForODESettings is called for plugin unmanaged...");
      return ucmService.configureODESettings(
          build, bundle, credentialStorage != null ? credentialStorage.signature : null);
    }
    return -1;
  }
    ...
    try {
      try {
        if (DBG) {
          Log.i(
              TAG,
              "getODESettingsConfiguration is called for Caller UID-" + i + " mContainerId " + i2);
        }
        IUcmService ucmService = getUcmService();
        if (ucmService != null) {
      ...
      try {
        ...
        if (enforcedCredentialStorageFromDb != null && ucmService != null) {
          if (DBG) {
            Log.i(
                TAG,
                "showEnforcedLockTypeNotificationForAllUser userId: "
                    + i
                    + ", cs.name: "
                    + enforcedCredentialStorageFromDb.name);
          }
          if (!enforcedCredentialStorageFromDb.name.equalsIgnoreCase(
              ucmService.getKeyguardStorageForCurrentUser(i))) {
  ...
  public final void setKeyguardProperty() {
    ...
    try {
      IUcmService ucmService = getUcmService();
      if (ucmService == null
          || (keyguardStorageForCurrentUser = ucmService.getKeyguardStorageForCurrentUser(0))
              == null
          || keyguardStorageForCurrentUser.isEmpty()
          || "none".equalsIgnoreCase(keyguardStorageForCurrentUser)) {
        return;
      }
  ...
  public int setKeyguardPinMaximumRetryCount(
    ...
    try {
      ...
      if (ucmService != null) {
        return getReturnvalue(
            ucmService.setKeyguardPinMaximumRetryCount(
                new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                    .setResourceId(4)
                    .setUid(i3)
                    .build(),
  ...
  public int setKeyguardPinMinimumLength(
    ...
    try {
      if (DBG) {
        Log.i(
            TAG,
            "setKeyguardPinMinimumLength is called for Caller UID-" + i3 + " mContainerId " + i2);
      }
      int checkCS = checkCS(contextInfo, credentialStorage);
      if (checkCS != 0) {
        return checkCS;
      ...
      if (ucmService != null) {
        return getReturnvalue(
            ucmService.setKeyguardPinMinimumLength(
                new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                    .setResourceId(4)
                    .setUid(i3)
                    .build(),
  ...
  public int setKeyguardPinMaximumLength(
    ...
    try {
      if (DBG) {
        Log.i(
            TAG,
            "setKeyguardPinMaximumLength is called for Caller UID-" + i3 + " mContainerId " + i2);
      }
      int checkCS = checkCS(contextInfo, credentialStorage);
      if (checkCS != 0) {
        return checkCS;
      ...
      if (ucmService != null) {
        return getReturnvalue(
            ucmService.setKeyguardPinMaximumLength(
                new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                    .setResourceId(4)
                    .setUid(i3)
                    .build(),
  ...
  public int getKeyguardPinMaximumRetryCount(
    ...
    try {
      ...
      if (ucmService != null) {
        return getReturnvalue(
            ucmService.getKeyguardPinMaximumRetryCount(
                new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                    .setResourceId(4)
                    .setUid(i2)
                    .build()));
  ...
  public int getKeyguardPinCurrentRetryCount(
    ...
    try {
      ...
      if (ucmService != null) {
        return getReturnvalue(
            ucmService.getKeyguardPinCurrentRetryCount(
                new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                    .setResourceId(4)
                    .setUid(i2)
                    .build()));
  ...
  public int getKeyguardPinMinimumLength(
    ...
    try {
      if (DBG) {
        Log.i(
            TAG,
            "getKeyguardPinMinimumLength is called for Caller UID-" + i2 + " mContainerId " + i);
      }
      int checkCS = checkCS(contextInfo, credentialStorage);
      if (checkCS != 0) {
        return checkCS;
      ...
      if (ucmService != null) {
        return getReturnvalue(
            ucmService.getKeyguardPinMinimumLength(
                new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                    .setResourceId(4)
                    .setUid(i2)
                    .build()));
  ...
  public int getKeyguardPinMaximumLength(
    ...
    try {
      if (DBG) {
        Log.i(
            TAG,
            "getKeyguardPinMaximumLength is called for Caller UID-" + i2 + " mContainerId " + i);
      }
      int checkCS = checkCS(contextInfo, credentialStorage);
      if (checkCS != 0) {
        return checkCS;
      ...
      if (ucmService != null) {
        return getReturnvalue(
            ucmService.getKeyguardPinMaximumLength(
                new UniversalCredentialUtil.UcmUriBuilder(credentialStorage.name)
                    .setResourceId(4)
                    .setUid(i2)
                    .build()));
