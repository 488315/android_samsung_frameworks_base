...
public abstract class FirewallUtils {
  public static final String[] PACKAGE_EXCEPTION_KEYWORDS = {
    ".mdm.",
    ".knox.",
    ".elm.",
    ".edm.",
  ...
  public static ContentValues getContentValuesFromRule(FirewallRule firewallRule, int i) {
    ...
    int i2 = AbstractC14341.f1692x6178b957[firewallRule.getRuleType().ordinal()];
    if (i2 == 1) {
  ...
  public static FirewallRule[] getRuleFromContentValues(List list, FirewallRule.RuleType ruleType) {
    ...
    int i = AbstractC14341.f1692x6178b957[ruleType.ordinal()];
    ...
    if (i == 1) {
      ...
      while (it.hasNext()) {
        ...
        FirewallRule firewallRule =
            new FirewallRule(
                FirewallRule.RuleType.ALLOW, convertAddressType(contentValues.getAsString(str6)));
        firewallRule.setIpAddress(contentValues.getAsString("ipAddress"));
        firewallRule.setPortNumber(contentValues.getAsString(str3));
        firewallRule.setPortLocation(
            convertPortLocation(contentValues.getAsString("portLocation")));
        firewallRule.setApplication(
            new AppIdentity(
                contentValues.getAsString("packageName"), contentValues.getAsString("signature")));
        firewallRule.setNetworkInterface(
            convertNetworkInterface(contentValues.getAsString("networkInterface")));
      ...
      while (it2.hasNext()) {
        ...
        FirewallRule firewallRule2 =
            new FirewallRule(
                FirewallRule.RuleType.DENY, convertAddressType(contentValues2.getAsString(str4)));
        ...
        String str9 = str7;
        firewallRule2.setApplication(
            new AppIdentity(
                contentValues2.getAsString(str9), contentValues2.getAsString("signature")));
        firewallRule2.setNetworkInterface(
            convertNetworkInterface(contentValues2.getAsString("networkInterface")));
      ...
      for (Iterator it3 = list.iterator(); it3.hasNext(); it3 = it3) {
        ...
        FirewallRule firewallRule3 =
            new FirewallRule(
                FirewallRule.RuleType.REDIRECT,
                convertAddressType(contentValues3.getAsString("addressType")));
        ...
        firewallRule3.setApplication(
            new AppIdentity(
                contentValues3.getAsString("packageName"),
                contentValues3.getAsString("signature")));
        firewallRule3.setNetworkInterface(
            convertNetworkInterface(contentValues3.getAsString("networkInterface")));
      ...
      for (Iterator it4 = list.iterator(); it4.hasNext(); it4 = it4) {
        ...
        FirewallRule firewallRule4 =
            new FirewallRule(
                FirewallRule.RuleType.REDIRECT_EXCEPTION,
                convertAddressType(contentValues4.getAsString("addressType")));
        ...
        firewallRule4.setApplication(
            new AppIdentity(
                contentValues4.getAsString(str2), contentValues4.getAsString("signature")));
        firewallRule4.setNetworkInterface(
            convertNetworkInterface(contentValues4.getAsString("networkInterface")));
  ...
  public static boolean isRuleEnabled(
      FirewallRule firewallRule, int i, EdmStorageProvider edmStorageProvider) {
    String obj;
    ...
    return (values == null
            || values.isEmpty()
            || (obj = ((ContentValues) values.get(0)).get("status").toString()) == null
            || !obj.equals(FirewallRule.Status.ENABLED.toString()))
        ? false
        : true;
  }

  public static boolean isRuleInDb(
      FirewallRule firewallRule, int i, EdmStorageProvider edmStorageProvider) {
    if (edmStorageProvider == null) {
      return false;
    }
    ContentValues contentValuesFromRule = getContentValuesFromRule(firewallRule, i);
    contentValuesFromRule.remove("status");
    return !edmStorageProvider
        .getValues("FirewallRule", EdmStorageDefs.FIREWALL_RULE_COLUMNS, contentValuesFromRule)
        .isEmpty();
  }
  ...
  */
  public static String filterRulesByUser(int i, String str) {
    ...
    StringTokenizer stringTokenizer =
        new StringTokenizer(str, KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
      ...
      if (indexOf != -1) {
        ...
        try {
          if (trim.contains(PackageManagerShellCommandDataLoader.STDIN_PATH)) {
            ...
            int userId2 = UserHandle.getUserId(Integer.valueOf(split[0]).intValue());
            int indexOf2 = split[1].indexOf(" ");
            if (indexOf2 <= -1) {
              userId = UserHandle.getUserId(Integer.valueOf(split[1]).intValue());
            } else {
              userId =
                  UserHandle.getUserId(Integer.valueOf(split[1].substring(0, indexOf2)).intValue());
            }
            if (i >= userId2 && i <= userId) {}
          }
          z = false;
  ...
  public static boolean validateDomain(String str) {
    ...
    if (!z) {
      for (int i = 0; i < split[0].length(); i++) {
        ...
        if ((charAt >= 'a' && charAt <= 'z')
            || ((charAt >= 'A' && charAt <= 'Z') || (charAt >= '0' && charAt <= '9'))) {
          z3 = true;
          break;
        }
      }
    ...
    for (String str3 : split) {
      if (!str3.matches("^[A-Za-z0-9-]+$")
          || ((str3.charAt(0) == '-' && !z) || (str3.charAt(str3.length() - 1) == '-' && !z2))) {
        return false;
      }
    }
    return true;
  ...
  /* renamed from: com.android.server.enterprise.firewall.FirewallUtils$1 */
  public abstract /* synthetic */ class AbstractC14341 {

    /* renamed from: $SwitchMap$com$android$server$enterprise$firewall$FirewallDefinitions$Table */
    public static final /* synthetic */ int[] f1691xb736b260;

    /* renamed from: $SwitchMap$com$samsung$android$knox$net$firewall$FirewallRule$RuleType */
    public static final /* synthetic */ int[] f1692x6178b957;
    ...
    static {
      ...
      try {
        f1691xb736b260[FirewallDefinitions.Table.NAT.ordinal()] = 2;
      } catch (NoSuchFieldError unused2) {
      }
      int[] iArr2 = new int[FirewallRule.RuleType.values().length];
      f1692x6178b957 = iArr2;
      try {
        iArr2[FirewallRule.RuleType.ALLOW.ordinal()] = 1;
      } catch (NoSuchFieldError unused3) {
      }
      try {
        f1692x6178b957[FirewallRule.RuleType.DENY.ordinal()] = 2;
      } catch (NoSuchFieldError unused4) {
      }
      try {
        f1692x6178b957[FirewallRule.RuleType.REDIRECT.ordinal()] = 3;
      } catch (NoSuchFieldError unused5) {
      }
      try {
        f1692x6178b957[FirewallRule.RuleType.REDIRECT_EXCEPTION.ordinal()] = 4;
  ...
  public static boolean isIpv6SupportedForTable(FirewallDefinitions.Table table) {
    int i = AbstractC14341.f1691xb736b260[table.ordinal()];
    if (i == 1) {
  ...
  public static String getAppOrUserUid(FirewallRule firewallRule, ContextInfo contextInfo) {
    return getAppOrUserUid(
        firewallRule.getPackageName(),
        UserHandle.getUserId(contextInfo.mCallerUid),
        Integer.valueOf(firewallRule.getPackageUid()),
        false);
  }
  ...
  public static String convertNetworkInterfaceForIptables(
    ...
    if (networkInterface.equals(Firewall.NetworkInterface.MOBILE_DATA_ONLY)) {
      return getBestEffortInterfaceName(
          allNetworkInterfaces, Arrays.asList("rmnet", "ccinet"), "net", "rmnet+");
    }
    return networkInterface.equals(Firewall.NetworkInterface.WIFI_DATA_ONLY)
        ? getBestEffortInterfaceName(allNetworkInterfaces, Arrays.asList("wlan"), "lan", "wlan+")
        : "";
  }
    ...
    try {
      ...
      while (it.hasNext()) {
        ...
        if (packageInfo2.applicationInfo.uid >= 10000
            && Utils.isSystemApplication(packageInfo2, packageInfo.signatures)) {
      ...
      while (true) {
        ...
        if (KnoxCustomManagerService.KG_PKG_NAME.equals(packageInfo3.applicationInfo.packageName)
            && isKGExemptRuleRequired()) {
      ...
      Log.e(
          "FirewallUtils",
          "processPackageExceptionList() - failed to retrieve package info for system",
          e);
      return arrayList;
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public static List getListFromDb(
      ContentValues contentValues, String str, EdmStorageProvider edmStorageProvider) {
    ...
    if (asInteger != null) {
      ...
      List values =
          edmStorageProvider.getValues("DomainFilterListTable", (String[]) null, contentValues2);
