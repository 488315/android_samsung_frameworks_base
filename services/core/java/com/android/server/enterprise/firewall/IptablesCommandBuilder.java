            ...
            if (firewallRule.getIpAddress().contains(PackageManagerShellCommandDataLoader.STDIN_PATH)) {
                ...
                if ("*".equals(firewallRule.getPortNumber())) {
                    if (z3) {
                        ...
                        if (firewallRule.getPortLocation().equals(Firewall.PortLocation.ALL) || firewallRule.getPortLocation().equals(Firewall.PortLocation.LOCAL)) {
                            if (firewallRule.getProtocol().equals(Firewall.Protocol.TCP) || firewallRule.getProtocol().equals(Firewall.Protocol.ALL)) {
                                if (z) {
                        ...
                        if (firewallRule.getPortLocation().equals(Firewall.PortLocation.ALL) || firewallRule.getPortLocation().equals(Firewall.PortLocation.REMOTE)) {
                            if (firewallRule.getProtocol().equals(Firewall.Protocol.TCP) || firewallRule.getProtocol().equals(Firewall.Protocol.ALL)) {
                                if (z) {
