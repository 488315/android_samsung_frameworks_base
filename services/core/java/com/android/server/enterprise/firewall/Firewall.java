...
public class Firewall extends IFirewall.Stub implements EnterpriseServiceCallback {
  ...
  public Firewall(Injector injector) {
    ...
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.enterprise.firewall.Firewall.1
    ...
    BroadcastReceiver broadcastReceiver2 =
        new BroadcastReceiver() { // from class: com.android.server.enterprise.firewall.Firewall.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
    ...
    mHasIpv6FilterSupport =
        this.mFirewallRulesApplier.hasIpv6Support(FirewallDefinitions.Table.FILTER);
    ...
    this.mContext.registerReceiverAsUser(
        broadcastReceiver2, UserHandle.ALL, intentFilter2, null, null);
    initializeIpTables();
  }
  ...
  public final void onUserHandle(final Intent intent) {
    new Thread(
            new Runnable() { // from class: com.android.server.enterprise.firewall.Firewall.3
              ...
              public void run() {
                ...
                Log.i(
                    Firewall.TAG,
                    "onUserHandle: Lock acquired. UserID received: "
                        + intExtra
                        + ". Got Action: "
                        + action);
  ...
  public final void initializeIpTables() {
    Thread thread =
        new Thread(
            new Runnable() { // from class: com.android.server.enterprise.firewall.Firewall.4
              @Override // java.lang.Runnable
              public void run() {
    ...
    while (it.hasNext()) {
      ...
      if (intValue != 1000) {
        ...
        if (isFirewallEnabled(contextInfo)) {
          enableOrDisableRuleAsAdmin(
              createDenyAllRule(Firewall.AddressType.IPV4, false), contextInfo, z);
          enableOrDisableRuleAsAdmin(
              createDenyAllRule(Firewall.AddressType.IPV6, false), contextInfo, z);
          if (UserHandle.getUserId(intValue) == 0 && adminHaveSystemRule(contextInfo)) {
            enableOrDisableRuleAsAdmin(
                createDenyAllRule(Firewall.AddressType.IPV4, true), contextInfo, z);
            enableOrDisableRuleAsAdmin(
                createDenyAllRule(Firewall.AddressType.IPV6, true), contextInfo, z);
          }
        }
      }
    }
  ...
  public FirewallRule createPort53DenyRule(
      Firewall.AddressType addressType, AppIdentity appIdentity) {
    ...
    Log.d(
        TAG,
        "createPort53DenyRule(): package = " + String.valueOf(createDenyAllRule.getPackageName()));
    return createDenyAllRule;
  }

  public final void enableOrDisableRuleAsAdmin(
    ...
    for (int i = 0; i < 5; i++) {
      if (z) {
        Log.i(
            TAG,
            "enableOrDisableRuleAsAdmin() - Block the traffic until applying rules process is"
                + " finished");
        disableIpTablesRule =
            this.mFirewallRulesApplier.enableIptablesRule(firewallRule, true, contextInfo, false);
      } else {
        Log.i(
            TAG,
            "enableOrDisableRuleAsAdmin() - Applying rules process is finished. Unblock the"
                + " traffic");
        disableIpTablesRule =
            this.mFirewallRulesApplier.disableIpTablesRule(firewallRule, contextInfo, false);
      }
      if (disableIpTablesRule != null
          && disableIpTablesRule.getResult() == FirewallResponse.Result.SUCCESS) {
      ...
      try {
        for (FirewallRule firewallRule : rules) {
          ApplicationInfo applicationInfo =
              asInterface.getApplicationInfo(
        ...
        try {
          try {
            try {
              ...
              Log.e(TAG, "createIptablesChains(): SecurityException was thrown.", e);
            }
          } catch (NullPointerException e2) {
            Log.e(TAG, "createIptablesChains(): NullPointerException was thrown.", e2);
          }
        } catch (IOException e3) {
          Log.e(TAG, "createIptablesChains(): IOException was thrown.", e3);
        } catch (IllegalArgumentException e4) {
          Log.e(TAG, "createIptablesChains(): IllegalArgumentException was thrown.", e4);
        }
      }
    }
  }
        ...
        try {
          try {
            try {
              ...
              Log.e(TAG, "handleUserChains(): NullPointerException was thrown." + e.getMessage());
            }
          } catch (SecurityException e2) {
            Log.e(TAG, "handleUserChains(): SecurityException was thrown." + e2.getMessage());
          }
        } catch (IOException e3) {
          Log.e(TAG, "handleUserChains(): IOException was thrown." + e3.getMessage());
        }
      } catch (IllegalArgumentException e4) {
        Log.e(TAG, "handleUserChains(): IllegalArgumentException was thrown." + e4.getMessage());
      }
    }
  }

  public final synchronized FirewallResponse addRule(
      ContextInfo contextInfo, FirewallRule firewallRule) {
    ...
    if (!TextUtils.isEmpty(firewallRule.getApplication().getSignature())) {
      Context createContextAsUser =
          Utils.createContextAsUser(this.mContext, "android", 0, UserHandle.getUserId(i));
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        if (!Utils.comparePackageSignature(
            createContextAsUser,
            firewallRule.getApplication().getPackageName(),
            firewallRule.getApplication().getSignature())) {
    ...
    if (Firewall.AddressType.IPV6.equals(firewallRule.getAddressType())) {
      ...
      if ((FirewallRule.RuleType.ALLOW.equals(ruleType)
              || FirewallRule.RuleType.DENY.equals(ruleType))
          && !mHasIpv6FilterSupport) {
      ...
      if ((FirewallRule.RuleType.REDIRECT.equals(ruleType)
              || FirewallRule.RuleType.REDIRECT_EXCEPTION.equals(ruleType))
          && !mHasIpv6NatSupport) {
        Log.i(TAG, "addRule() - IPv6 not supported");
        return new FirewallResponse(
            FirewallResponse.Result.FAILED,
    ...
    long insert =
        this.mEdmStorageProvider.insert(
            "FirewallRule", FirewallUtils.getContentValuesFromRule(firewallRule, i));
    if (insert == -1) {
  ...
  public synchronized FirewallResponse[] addRules(
    ...
    if (firewallRuleArr != null && firewallRuleArr.length != 0) {
      ...
      KnoxAnalyticsData knoxAnalyticsData =
          new KnoxAnalyticsData("KNOX_SECURE_NETWORK", 1, "addRules");
      ...
      if (isFirewallEnabled(enforceFirewallPermission)) {
        ...
        if (UserHandle.getUserId(enforceFirewallPermission.mCallerUid) == 0
            && shouldApplyExemptRules(firewallRuleArr2)) {
          this.mFirewallRulesApplier.addOrRemoveExemptRules(true, enforceFirewallPermission);
        }
        if (UserHandle.getUserId(enforceFirewallPermission.mCallerUid) == 0
            && shouldApplyKGExemptRule(firewallRuleArr2)) {
      ...
      for (int i4 = 0; i4 < arrayList.size(); i4++) {
        if (FirewallResponse.Result.SUCCESS.equals(firewallResponseArr2[i4].getResult())) {
          if (FirewallResponse.ErrorCode.INPUT_CHAIN_NOT_SUPPORTED_ERROR.equals(
              firewallResponseArr2[i4].getErrorCode())) {
            firewallResponseArr3[((Integer) arrayList.get(i4)).intValue()] =
                new FirewallResponse(
                    FirewallResponse.Result.SUCCESS,
                    FirewallResponse.ErrorCode.INPUT_CHAIN_NOT_SUPPORTED_ERROR,
                    "The rule(s) was successfully added/updated. / "
                        + firewallResponseArr2[i4].getMessage());
          } else {
            firewallResponseArr3[((Integer) arrayList.get(i4)).intValue()] =
                new FirewallResponse(
                    FirewallResponse.Result.SUCCESS,
      ...
      for (int i5 = 0; i5 < firewallRuleArr.length; i5++) {
        if (!FirewallResponse.Result.SUCCESS.equals(firewallResponseArr[i5].getResult())) {
          if (FirewallResponse.Result.NO_CHANGES.equals(firewallResponseArr[i5].getResult())) {
            ...
            firewallResponseArr3[i5] =
                new FirewallResponse(
                    FirewallResponse.Result.FAILED,
                    firewallResponseArr[i5].getErrorCode(),
                    "Failed to add/update rule in the database. / "
                        + firewallResponseArr[i5].getMessage());
          }
        }
      }
  ...
  public synchronized FirewallResponse[] clearRules(ContextInfo contextInfo, int i) {
    ...
    firewallResponseArr[0] =
        clearRuleByType(FirewallRule.RuleType.ALLOW, i, enforceFirewallPermission);
    firewallResponseArr[1] =
        clearRuleByType(FirewallRule.RuleType.DENY, i, enforceFirewallPermission);
    firewallResponseArr[2] =
        clearRuleByType(FirewallRule.RuleType.REDIRECT, i, enforceFirewallPermission);
    firewallResponseArr[3] =
        clearRuleByType(FirewallRule.RuleType.REDIRECT_EXCEPTION, i, enforceFirewallPermission);
    return firewallResponseArr;
  }

  public final synchronized FirewallResponse clearRuleByType(
      FirewallRule.RuleType ruleType, int i, ContextInfo contextInfo) {
    int i2;
    ...
    return new FirewallResponse(
        FirewallResponse.Result.NO_CHANGES,
        FirewallResponse.ErrorCode.NO_ERROR,
        "Clear was not requested for this RuleType.");
  }

  public final synchronized FirewallResponse clearFirewallRulesFromDb(
      FirewallRule.RuleType ruleType, ContextInfo contextInfo) {
  ...
  public final synchronized FirewallResponse[] enableFirewallRules(
      ContextInfo contextInfo, FirewallRule[] firewallRuleArr) {
    ContextInfo enforceFirewallPermission = enforceFirewallPermission(contextInfo);
    ...
    for (int i = 0; i < firewallRuleArr.length; i++) {
      if (!FirewallUtils.verifyPackageName(
          firewallRuleArr[i].getApplication().getPackageName(),
          UserHandle.getUserId(enforceFirewallPermission.mCallerUid))) {
        this.mFirewallRulesApplier.updateStatusOnDB(
            firewallRuleArr[i], FirewallRule.Status.DISABLED, enforceFirewallPermission);
      } else {
        arrayList.add(Integer.valueOf(i));
      }
    }
    ...
    Log.i(TAG, "enableFirewallRules()");
    return this.mFirewallRulesApplier.changeRuleStatus(
        firewallRuleArr2, enforceFirewallPermission, true);
  }
  ...
  public boolean isFirewallEnabled(ContextInfo contextInfo) {
    ...
    List values =
        this.mEdmStorageProvider.getValues(
            "FirewallStatus", EdmStorageDefs.FIREWALL_POLICY_STATUS_COLUMNS, contentValues);
  ...
  public final synchronized FirewallResponse enableFirewall(ContextInfo contextInfo) {
    ...
    if (firewallOwner == -1) {
      ...
      if (this.mEdmStorageProvider.insert("FirewallStatus", contentValues) == -1) {
        Log.e(
            TAG,
            "enableFirewall() - Failed! DATABASE_ERROR FAILED_TO_ENABLE_FIREWALL_IN_THE_DATABASE");
        return new FirewallResponse(
            FirewallResponse.Result.FAILED,
            FirewallResponse.ErrorCode.DATABASE_ERROR,
    ...
    if (rules != null && rules.length > 0) {
      ...
      for (int i2 = 0; i2 < enableFirewallRules.length; i2++) {
        if (enableFirewallRules[i2].getResult().equals(FirewallResponse.Result.SUCCESS)) {
          if (FirewallResponse.ErrorCode.INPUT_CHAIN_NOT_SUPPORTED_ERROR.equals(
              enableFirewallRules[i2].getErrorCode())) {
            sb.append(
                "Rule with Id = "
                    + rules[i2].getId()
          ...
          sb.append(
              "Rule with Id =  "
                  ...
                  + enableFirewallRules[i2].getMessage()
                  + KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
          z = true;
        }
      }
      ...
      return new FirewallResponse(
          FirewallResponse.Result.SUCCESS, FirewallResponse.ErrorCode.NO_ERROR, sb.toString());
    }
  ...
  public final synchronized FirewallResponse disableFirewall(ContextInfo contextInfo) {
    ...
    if (this.mEdmStorageProvider.delete("FirewallStatus", contentValues) == 0) {
      Log.e(
          TAG,
          "disableFirewall() - FAILED! DATABASE_ERROR FAIL_TO_DISABLE_FIREWALL_IN_THE_DATABASE");
      return new FirewallResponse(
          FirewallResponse.Result.FAILED,
          FirewallResponse.ErrorCode.DATABASE_ERROR,
    ...
    if (rules != null && rules.length > 0) {
      ...
      for (FirewallRule firewallRule2 : rules) {
        this.mFirewallRulesApplier.updateStatusOnDB(
            firewallRule2, FirewallRule.Status.DISABLED, contextInfo);
      }
  ...
  public int getFirewallOwner(int i) {
    ...
    if (values == null
        || values.isEmpty()
        || (asInteger = ((ContentValues) values.get(0)).getAsInteger("adminUid")) == null) {
      return -1;
    }
  ...
  public FirewallRule[] getRules(ContextInfo contextInfo, int i, String str) {
    int i2;
    ContextInfo enforceFirewallPermission = enforceFirewallPermission(contextInfo);
    FirewallRule[] ruleByType =
        getRuleByType(FirewallRule.RuleType.ALLOW, i, enforceFirewallPermission, str);
    FirewallRule[] ruleByType2 =
        getRuleByType(FirewallRule.RuleType.DENY, i, enforceFirewallPermission, str);
    FirewallRule[] ruleByType3 =
        getRuleByType(FirewallRule.RuleType.REDIRECT, i, enforceFirewallPermission, str);
    FirewallRule[] ruleByType4 =
        getRuleByType(FirewallRule.RuleType.REDIRECT_EXCEPTION, i, enforceFirewallPermission, str);
    int i3 = 0;
  ...
  public final FirewallRule[] getRuleByType(
      FirewallRule.RuleType ruleType, int i, ContextInfo contextInfo, String str) {
    int i2;
    ...
    contentValues.put("ruleType", ruleType.toString());
    return FirewallUtils.getRuleFromContentValues(
        this.mEdmStorageProvider.getValues(
            "FirewallRule", EdmStorageDefs.FIREWALL_RULE_COLUMNS, contentValues),
        ruleType);
  }
  ...
  public synchronized FirewallResponse[] removeRules(
      ContextInfo contextInfo, FirewallRule[] firewallRuleArr) {
    ContextInfo enforceFirewallPermission = enforceFirewallPermission(contextInfo);
    ...
    FirewallResponse[] changeRuleStatus =
        this.mFirewallRulesApplier.changeRuleStatus(
            firewallRuleArr, enforceFirewallPermission, false);
    FirewallResponse[] firewallResponseArr = new FirewallResponse[firewallRuleArr.length];
    for (int i = 0; i < firewallRuleArr.length; i++) {
      FirewallResponse firewallResponse = changeRuleStatus[i];
      if (firewallResponse != null
          && firewallResponse.getResult().equals(FirewallResponse.Result.SUCCESS)) {
  ...
  public final synchronized FirewallResponse removeRule(
    ...
    if (FirewallUtils.isRuleEnabled(firewallRule, i, this.mEdmStorageProvider)) {
      ...
      return new FirewallResponse(
          FirewallResponse.Result.FAILED,
          FirewallResponse.ErrorCode.OPERATION_NOT_PERMITTED_ERROR,
          "Disable the rule before remove it.");
    }
  ...
  public void populateDomainFilterBrokenRules(ContextInfo contextInfo, List list, int i) {
    this.mDomainFilter.populateDomainFilterBrokenRules(
        enforceFirewallPermission(contextInfo), list, i);
  }

  public FirewallResponse[] clearAllDomainFilterRules(ContextInfo contextInfo) {
    return this.mDomainFilter.removeDomainFilterRules(
        enforceFirewallPermission(contextInfo), DomainFilterRule.CLEAR_ALL);
  }
  ...
  public synchronized FirewallResponse enableDomainFilterReport(
  ...
  public synchronized FirewallResponse enableDomainFilterOnIptables(
      ContextInfo contextInfo, boolean z) {
    return this.mDomainFilter.enableDomainFilterOnIptables(
        enforceFirewallPermission(contextInfo), z);
  }

  public boolean isDomainFilterOnIptablesEnabled(ContextInfo contextInfo) {
    return this.mDomainFilter.isDomainFilterOnIptablesEnabled(
  ...
  public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
    ...
    this.mEnterpriseDumpHelper.dumpTable(
        printWriter,
        "DomainFilterTable",
        new String[] {"adminUid", "packageName", "signature", "dns1", "dns2", "networkId"});
    this.mEnterpriseDumpHelper.dumpTable(
        printWriter,
        "DomainFilterListTable",
        new String[] {"adminUid", "packageName", "typeList", "domain"});
  }
  ...
  public boolean shouldApplyExemptRules(FirewallRule[] firewallRuleArr) {
    ...
    for (FirewallRule firewallRule : firewallRuleArr) {
      if (FirewallRule.RuleType.DENY.equals(firewallRule.getRuleType())
          && (("*".equals(firewallRule.getPackageName())
                  || FirewallDefinitions.EXEMPT_PACKAGE_LIST
                      .keySet()
                      .contains(firewallRule.getPackageName()))
              && !FirewallRule.Status.DISABLED.equals(firewallRule.getStatus())
  ...
  public boolean shouldApplyKGExemptRule(FirewallRule[] firewallRuleArr) {
    ...
    for (FirewallRule firewallRule : firewallRuleArr) {
      if (FirewallRule.RuleType.DENY.equals(firewallRule.getRuleType())
          && (("*".equals(firewallRule.getPackageName())
                  || KnoxCustomManagerService.KG_PKG_NAME.equals(firewallRule.getPackageName()))
  ...
  public boolean shouldApplyIcmpAllowRule(FirewallRule firewallRule) {
    if (firewallRule != null
        && FirewallRule.RuleType.DENY.equals(firewallRule.getRuleType())
        && "*".equals(firewallRule.getIpAddress())) {
      return Firewall.Direction.ALL.equals(firewallRule.getDirection())
          || Firewall.Direction.INPUT.equals(firewallRule.getDirection());
    }
    return false;
  }
  ...
  public final int getAddressTypePropertyToLog(Firewall.AddressType addressType) {
    ...
    int i = AbstractC14325.f1684xf6a73711[addressType.ordinal()];
    if (i != 1) {
      return i != 2 ? -1 : 1;
    }
    return 0;
  ...
  public final int getNetworkInterfacePropertyToLog(Firewall.NetworkInterface networkInterface) {
    ...
    int i = AbstractC14325.f1685xc026b6c8[networkInterface.ordinal()];
    if (i == 1) {
      return 0;
    }
    if (i != 2) {
  ...
  public final int getPortLocationPropertyToLog(Firewall.PortLocation portLocation) {
    ...
    int i = AbstractC14325.f1686x28da11f3[portLocation.ordinal()];
    if (i == 1) {
      return 0;
    }
    if (i != 2) {
  ...
  public final int getProtocolPropertyToLog(Firewall.Protocol protocol) {
    ...
    int i = AbstractC14325.f1687x367febb5[protocol.ordinal()];
    if (i == 1) {
      return 0;
    }
    if (i != 2) {
  ...
  /* renamed from: com.android.server.enterprise.firewall.Firewall$5 */
  public abstract /* synthetic */ class AbstractC14325 {

    /* renamed from: $SwitchMap$com$samsung$android$knox$net$firewall$Firewall$AddressType */
    public static final /* synthetic */ int[] f1684xf6a73711;

    /* renamed from: $SwitchMap$com$samsung$android$knox$net$firewall$Firewall$NetworkInterface */
    public static final /* synthetic */ int[] f1685xc026b6c8;

    /* renamed from: $SwitchMap$com$samsung$android$knox$net$firewall$Firewall$PortLocation */
    public static final /* synthetic */ int[] f1686x28da11f3;

    /* renamed from: $SwitchMap$com$samsung$android$knox$net$firewall$Firewall$Protocol */
    public static final /* synthetic */ int[] f1687x367febb5;

    /* renamed from: $SwitchMap$com$samsung$android$knox$net$firewall$FirewallRule$RuleType */
    public static final /* synthetic */ int[] f1688x6178b957;
    ...
    static {
      ...
      try {
        f1688x6178b957[FirewallRule.RuleType.DENY.ordinal()] = 2;
      } catch (NoSuchFieldError unused2) {
      }
      try {
        f1688x6178b957[FirewallRule.RuleType.REDIRECT.ordinal()] = 3;
      } catch (NoSuchFieldError unused3) {
      }
      try {
        f1688x6178b957[FirewallRule.RuleType.REDIRECT_EXCEPTION.ordinal()] = 4;
      } catch (NoSuchFieldError unused4) {
      }
      int[] iArr2 = new int[Firewall.Protocol.values().length];
      f1687x367febb5 = iArr2;
      try {
        iArr2[Firewall.Protocol.ALL.ordinal()] = 1;
      } catch (NoSuchFieldError unused5) {
      }
      try {
        f1687x367febb5[Firewall.Protocol.TCP.ordinal()] = 2;
      } catch (NoSuchFieldError unused6) {
      }
      try {
        f1687x367febb5[Firewall.Protocol.UDP.ordinal()] = 3;
      } catch (NoSuchFieldError unused7) {
      }
      int[] iArr3 = new int[Firewall.PortLocation.values().length];
      f1686x28da11f3 = iArr3;
      try {
        iArr3[Firewall.PortLocation.ALL.ordinal()] = 1;
      } catch (NoSuchFieldError unused8) {
      }
      try {
        f1686x28da11f3[Firewall.PortLocation.LOCAL.ordinal()] = 2;
      } catch (NoSuchFieldError unused9) {
      }
      try {
        f1686x28da11f3[Firewall.PortLocation.REMOTE.ordinal()] = 3;
      } catch (NoSuchFieldError unused10) {
      }
      int[] iArr4 = new int[Firewall.NetworkInterface.values().length];
      f1685xc026b6c8 = iArr4;
      try {
        iArr4[Firewall.NetworkInterface.ALL_NETWORKS.ordinal()] = 1;
      } catch (NoSuchFieldError unused11) {
      }
      try {
        f1685xc026b6c8[Firewall.NetworkInterface.MOBILE_DATA_ONLY.ordinal()] = 2;
      } catch (NoSuchFieldError unused12) {
      }
      try {
        f1685xc026b6c8[Firewall.NetworkInterface.WIFI_DATA_ONLY.ordinal()] = 3;
      } catch (NoSuchFieldError unused13) {
      }
      int[] iArr5 = new int[Firewall.AddressType.values().length];
      f1684xf6a73711 = iArr5;
      try {
        iArr5[Firewall.AddressType.IPV4.ordinal()] = 1;
      } catch (NoSuchFieldError unused14) {
      }
      try {
        f1684xf6a73711[Firewall.AddressType.IPV6.ordinal()] = 2;
  ...
  public final int getRuleTypePropertyToLog(FirewallRule.RuleType ruleType) {
    ...
    int i = AbstractC14325.f1688x6178b957[ruleType.ordinal()];
    if (i == 1) {
      return 0;
    }
    if (i == 2) {
  ...
  public final FirewallRule[] getRulesByAdminUidAndPackage(int i, String str) {
    ...
    for (ContentValues contentValues2 : values) {
      if (contentValues2.containsKey("ruleType")) {
        int i3 =
            AbstractC14325.f1688x6178b957[
                FirewallRule.RuleType.valueOf(contentValues2.getAsString("ruleType")).ordinal()];
        if (i3 == 1) {
    ...
    FirewallRule[] ruleFromContentValues =
        FirewallUtils.getRuleFromContentValues(arrayList, FirewallRule.RuleType.ALLOW);
    int i4 = 0;
    ...
    FirewallRule[] ruleFromContentValues2 =
        FirewallUtils.getRuleFromContentValues(arrayList2, FirewallRule.RuleType.DENY);
    ...
    FirewallRule[] ruleFromContentValues3 =
        FirewallUtils.getRuleFromContentValues(arrayList3, FirewallRule.RuleType.REDIRECT);
    ...
    FirewallRule[] ruleFromContentValues4 =
        FirewallUtils.getRuleFromContentValues(
            arrayList4, FirewallRule.RuleType.REDIRECT_EXCEPTION);
  ...
  public final void packageAdded(Context context, Intent intent) {
    ...
    if (intExtra == -1 || schemeSpecificPart == null) {
      Log.i(
          TAG,
          "packageAdded() - Received invalid user id orpackage name, can't retrieve application"
              + " info");
      return;
    }
    ...
    HashSet hashSet =
        new HashSet(
            this.mEdmStorageProvider.getValues(
                "FirewallRule", new String[] {"adminUid"}, contentValues));
    if (hashSet.isEmpty()) {
      return;
    }
    ...
    while (it.hasNext()) {
      ...
      if (asInteger != null) {
        ...
        FirewallRule[] rulesByAdminUidAndPackage =
            getRulesByAdminUidAndPackage(asInteger.intValue(), schemeSpecificPart);
        ...
        for (FirewallRule firewallRule : rulesByAdminUidAndPackage) {
          ...
          if ((TextUtils.isEmpty(signature)
                  || Utils.comparePackageSignature(
                      ...
                      intExtra))
              && (enableIptablesRule =
                      this.mFirewallRulesApplier.enableIptablesRule(
                          firewallRule, true, contextInfo, false))
                  != null
              && enableIptablesRule.getResult() == FirewallResponse.Result.SUCCESS) {
            this.mFirewallRulesApplier.updateStatusOnDB(
                firewallRule, FirewallRule.Status.ENABLED, contextInfo);
  ...
  public final void packageRemoved(Context context, Intent intent) {
    ...
    if (intExtra == -1 || schemeSpecificPart == null) {
      Log.i(
          TAG,
          "packageRemoved() - Received invalid user id orpackage name, can't retrieve application"
              + " info");
      return;
    }
    String adminLUIDWhereIn = EdmStorageProviderBase.getAdminLUIDWhereIn(0, intExtra);
        ...
        for (FirewallRule firewallRule : rulesByAdminUidAndPackage) {
          ...
          if (TextUtils.isEmpty(signature)
            ...
            if (disableIpTablesRule != null
                && disableIpTablesRule.getResult() == FirewallResponse.Result.SUCCESS) {
              this.mFirewallRulesApplier.updateStatusOnDB(
                  firewallRule, FirewallRule.Status.DISABLED, contextInfo);
  ...
  public boolean shouldBlockDownload(String str, String str2, int i) {
    ...
    try {
      ...
      String[] strArr = {"*"};
      Iterator it =
          this.mEdmStorageProvider.getAdminUidListAsUser(UserHandle.getUserId(i)).iterator();
      while (it.hasNext()) {
        int intValue = ((Integer) it.next()).intValue();
        if (intValue != 1000) {
          DownloadBlockStatus shouldBlockDownloadDomainFilter =
              shouldBlockDownloadDomainFilter(intValue, str, url.getHost());
          if (shouldBlockDownloadDomainFilter.equals(
              DownloadBlockStatus.BLOCKED_BY_BLACKLIST_RULE)) {
            return true;
          }
          if (this.mDomainFilter.isDomainFilterOnIptablesEnabled(new ContextInfo(intValue))
              && shouldBlockDownloadDomainFilter.equals(
                  DownloadBlockStatus.PASSED_BY_WHITELIST_RULE)) {
            return false;
          }
          if (isFirewallEnabled(new ContextInfo(intValue))) {
            ...
            if (enabledFirewallRulesForPackage.isEmpty()) {
              ...
              if (shouldBlockDownloadFirewall(
                      strArr, String.valueOf(port), enabledFirewallRulesForPackage)
                  .equals(DownloadBlockStatus.BLOCKED_BY_BLACKLIST_RULE)) {
                return true;
              }
            }
          } else {
  ...
  public final List getEnabledFirewallRulesForPackage(int i, String str) {
    ...
    return this.mEdmStorageProvider.getValues(
        "FirewallRule", EdmStorageDefs.FIREWALL_RULE_COLUMNS, contentValues);
  }

  public final DownloadBlockStatus shouldBlockDownloadFirewall(
      String[] strArr, String str, List list) {
    for (String str2 : strArr) {
      Firewall.AddressType addressType =
          str2.contains(XmlUtils.STRING_ARRAY_SEPARATOR)
              ? Firewall.AddressType.IPV6
              : Firewall.AddressType.IPV4;
      ...
      while (it.hasNext()) {
        ...
        if (contentValues.getAsString("ruleType").equals(FirewallRule.RuleType.ALLOW.toString())) {
          FirewallRule firewallRule =
              FirewallUtils.getRuleFromContentValues(
                  Arrays.asList(contentValues), FirewallRule.RuleType.ALLOW)[0];
          if (firewallRule.getAddressType() == addressType
              && ("*".equals(firewallRule.getIpAddress())
                  || str2.equals(firewallRule.getIpAddress())
                  || matchIpIntoIpRangeRule(str2, firewallRule))) {
            if ("*".equals(firewallRule.getPortNumber())
                || str.equals(firewallRule.getPortNumber())
                || matchPortIntoPortRangeRule(str, firewallRule)) {
              if (Firewall.Protocol.ALL.equals(firewallRule.getProtocol())
                  || Firewall.Protocol.TCP.equals(firewallRule.getProtocol())) {
      ...
      while (it2.hasNext()) {
        ...
        if (contentValues2.getAsString("ruleType").equals(FirewallRule.RuleType.DENY.toString())) {
          FirewallRule firewallRule2 =
              FirewallUtils.getRuleFromContentValues(
                  Arrays.asList(contentValues2), FirewallRule.RuleType.DENY)[0];
          if (firewallRule2.getAddressType() == addressType
              && ("*".equals(firewallRule2.getIpAddress())
                  || str2.equals(firewallRule2.getIpAddress())
                  || matchIpIntoIpRangeRule(str2, firewallRule2))) {
            if ("*".equals(firewallRule2.getPortNumber())
                || str.equals(firewallRule2.getPortNumber())
                || matchPortIntoPortRangeRule(str, firewallRule2)) {
              if (Firewall.Protocol.ALL.equals(firewallRule2.getProtocol())
                  || Firewall.Protocol.TCP.equals(firewallRule2.getProtocol())) {
  ...
  public final DownloadBlockStatus shouldBlockDownloadDomainFilter(int i, String str, String str2) {
    ...
    try {
      List<DomainFilterRule> domainFilterRules =
          getDomainFilterRules(contextInfo, new ArrayList(Arrays.asList(str)), -1);
      if (domainFilterRules == null) {
        return DownloadBlockStatus.PASSED_NORULE;
      }
      for (DomainFilterRule domainFilterRule : domainFilterRules) {
        if ("*".equals(domainFilterRule.getApplication().getPackageName())
            || str.equals(domainFilterRule.getApplication().getPackageName())) {
  ...
  public final void enforceDownloadProvider() {
    ...
    if (packagesForUid != null && packagesForUid.length > 0) {
      for (int i = 0; i < packagesForUid.length; i++) {
        if (packagesForUid[i].equals("com.android.providers.downloads.ui")
            || packagesForUid[i].equals("com.android.providers.downloads")) {
          return;
        }
      }
    }
  ...
  public final boolean matchPortIntoPortRangeRule(String str, FirewallRule firewallRule) {
    if (firewallRule.getPortNumber().contains(PackageManagerShellCommandDataLoader.STDIN_PATH)) {
      String[] split =
          firewallRule.getPortNumber().split(PackageManagerShellCommandDataLoader.STDIN_PATH);
      if (split.length == 2
          && Integer.valueOf(str).intValue() > Integer.valueOf(split[0]).intValue()
          && Integer.valueOf(str).intValue() < Integer.valueOf(split[1]).intValue()) {
        return true;
      }
    }
    return false;
  ...
  public final boolean matchIpIntoIpRangeRule(String str, FirewallRule firewallRule) {
    Firewall.AddressType addressType =
        str.contains(XmlUtils.STRING_ARRAY_SEPARATOR)
            ? Firewall.AddressType.IPV6
            : Firewall.AddressType.IPV4;
    if (!firewallRule.getIpAddress().contains(PackageManagerShellCommandDataLoader.STDIN_PATH)
        || firewallRule.getAddressType() != addressType) {
      return false;
    }
    String[] split =
        firewallRule.getIpAddress().split(PackageManagerShellCommandDataLoader.STDIN_PATH);
    if (addressType == Firewall.AddressType.IPV4) {
      return compareIpSubdivisions(
          split[0].split("\\."), split[1].split("\\."), str.split("\\."), addressType);
    }
    split[0] = convertToIpv6CompleteForm(split[0]);
    split[1] = convertToIpv6CompleteForm(split[1]);
    return compareIpSubdivisions(
        split[0].split(XmlUtils.STRING_ARRAY_SEPARATOR),
        split[1].split(XmlUtils.STRING_ARRAY_SEPARATOR),
        convertToIpv6CompleteForm(str).split(XmlUtils.STRING_ARRAY_SEPARATOR),
        addressType);
  }
  ...
  public final boolean compareIpSubdivisions(
      String[] strArr, String[] strArr2, String[] strArr3, Firewall.AddressType addressType) {
    boolean z = false;
    boolean z2 = false;
  ...
  public final int convertIpSectionToInt(String str, Firewall.AddressType addressType) {
    return addressType == Firewall.AddressType.IPV4
