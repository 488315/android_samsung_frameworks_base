...
public class BluetoothPolicy extends IBluetoothPolicy.Stub implements EnterpriseServiceCallback {
  ...
  public BluetoothPolicy(Context context) {
    ...
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.enterprise.bluetooth.BluetoothPolicy.1
          ...
          public void onReceive(Context context2, Intent intent) {
            ...
            if (action.equals("android.bluetooth.adapter.action.STATE_CHANGED")) {
              if (intent.getIntExtra("android.bluetooth.adapter.extra.STATE", Integer.MIN_VALUE)
                      == 10
                  && BluetoothPolicy.this.mRestart) {
            ...
            if ("com.samsung.android.knox.intent.action.KNOXFRAMEWORK_SYSTEMUI_UPDATE_INTENT_INTERNAL"
                .equals(action)) {
              BluetoothPolicy.this.updateSystemUIMonitor(
                  intent.getIntExtra("com.samsung.android.knox.intent.extra.USER_ID_INTERNAL", 0));
              return;
            }
            if (!"android.bluetooth.device.action.ACL_CONNECTED".equals(action)
                || BluetoothPolicy.this.isDesktopConnectivityEnabled(false)
                || (bluetoothDevice =
                        (BluetoothDevice)
            ...
            Log.d(
                ...
                "Unpair this bluetooth computer(ACL CONNECTED) : " + bluetoothDevice.getAddress());
  ...
  public boolean isBluetoothEnabled(boolean z) {
    ...
    if (z && !z2) {
      RestrictionToastManager.show(R.string.config_deviceConfiguratorPackageName);
    }
    return z2;
  }
  ...
  public boolean setBluetooth(ContextInfo contextInfo, boolean z) {
    ...
    try {
      ...
      if (z2) {
        setBluetoothAllowedSystemUI(
            callingOrCurrentUserId, isBluetoothEnabled(enforceOwnerOnlyAndBluetoothPermission));
      }
      return z2;
    } catch (Throwable th) {
      Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public boolean allowBluetooth(ContextInfo contextInfo, boolean z) {
    ...
    if (!isBLEAllowed(enforceOwnerOnlyAndBluetoothPermission)
        && getAdminUidForBLE() == enforceOwnerOnlyAndBluetoothPermission.mCallerUid) {
    ...
    boolean putBoolean =
        this.mEdmStorageProvider.putBoolean(
            enforceOwnerOnlyAndBluetoothPermission.mCallerUid, "BLUETOOTH", "bluetoothEnabled", z);
    if (putBoolean) {
      AuditLog.logAsUser(
          5,
          1,
  ...
  public final boolean allowBluetoothForBLE(ContextInfo contextInfo, boolean z) {
    ...
    boolean putBoolean =
        this.mEdmStorageProvider.putBoolean(
            contextInfo.mCallerUid, "BLUETOOTH", "bluetoothEnabled", z);
    if (putBoolean) {
      AuditLog.logAsUser(
          5,
          1,
  ...
  public final void delayedBTOff() {
    new Thread() { // from class: com.android.server.enterprise.bluetooth.BluetoothPolicy.2
      ...
      public void run() {
        ...
        BluetoothAdapter defaultAdapter = BluetoothAdapter.getDefaultAdapter();
        BluetoothPolicy.this.mContext.registerReceiver(
            new BroadcastReceiver() { // from class:
                                      // com.android.server.enterprise.bluetooth.BluetoothPolicy.2.1
              @Override // android.content.BroadcastReceiver
  ...
  public final ContextInfo enforceBluetoothPermission(ContextInfo contextInfo) {
    return getEDM()
        .enforceActiveAdminPermissionByContext(
            contextInfo,
            new ArrayList(Arrays.asList("com.samsung.android.knox.permission.KNOX_BLUETOOTH")));
  }
  ...
  public boolean setAllowBluetoothDataTransfer(ContextInfo contextInfo, boolean z) {
    ...
    return this.mEdmStorageProvider.putBoolean(
        enforceOwnerOnlyAndBluetoothPermission.mCallerUid, "BLUETOOTH", "allowDataTransfer", z);
  }
  ...
  public boolean getAllowBluetoothDataTransfer(ContextInfo contextInfo, boolean z) {
    ...
    ArrayList booleanList =
        this.mEdmStorageProvider.getBooleanList("BLUETOOTH", "allowDataTransfer");
    if (booleanList != null) {
      Iterator it = booleanList.iterator();
      while (it.hasNext()) {
    ...
    z2 = true;
    if (z && !z2) {
      RestrictionToastManager.show(R.string.config_defaultSmartspaceService);
    }
    return z2;
  }
  ...
  public boolean isPairingEnabled(boolean z) {
    ...
    if (z && !z2) {
      RestrictionToastManager.show(R.string.config_defaultWearableSensingService);
    }
    return z2;
  }
  ...
  public boolean isOutgoingCallsAllowed(boolean z) {
    ...
    ArrayList booleanList =
        this.mEdmStorageProvider.getBooleanList("BLUETOOTH", "allowOutgoingCalls");
    if (booleanList != null) {
      Iterator it = booleanList.iterator();
      while (it.hasNext()) {
        z2 = ((Boolean) it.next()).booleanValue();
    ...
    z2 = true;
    if (z && !z2) {
      RestrictionToastManager.show(R.string.config_defaultWearableSensingConsentComponent);
    }
    return z2;
  }
  ...
  public boolean isLimitedDiscoverableEnabled(ContextInfo contextInfo) {
    ...
    ArrayList booleanList =
        this.mEdmStorageProvider.getBooleanList("BLUETOOTH", "limitedDiscoverableEnabled");
    if (booleanList != null) {
      Iterator it = booleanList.iterator();
      while (it.hasNext()) {
    ...
    try {
      ...
      z2 =
          this.mEdmStorageProvider.putInt(
              i3, "BLUETOOTH", "profileSettings", true == z ? i2 | i : i2 & (~i));
      if (z2) {
                ...
                ? i2 != 4
                    ? i2 != 8
                        ? i2 != 16
                            ? i2 != 32
                                ? i2 != 64
                                    ? i2 != 128 ? i2 != 256 ? i2 != 512 ? "" : "BPP" : "SAP" : "SPP"
                                    : "FTP"
                                : "DUN"
                            : "AVRCP"
                        : "A2DP"
  ...
  public final void showProfileBlockedToast(int i) {
    int i2;
    if (i == 1) {
      i2 = R.string.config_defaultWallpaperEffectsGenerationService;
    } else if (i == 2) {
      i2 = R.string.config_defaultTrustAgent;
    } else if (i == 4) {
      i2 = R.string.config_defaultWellbeingPackage;
    } else if (i == 8) {
      i2 = R.string.config_defaultProfcollectReportUploaderApp;
    } else if (i == 16) {
      i2 = R.string.config_defaultRotationResolverService;
    } else if (i == 32) {
      i2 = R.string.config_defaultTextClassifierPackage;
    } else if (i == 64) {
      i2 = R.string.config_defaultTranslationService;
    } else if (i == 128) {
      i2 = R.string.config_deviceSpecificDevicePolicyManagerService;
    } else if (i == 256) {
      i2 = R.string.config_devicePolicyManagementUpdater;
    } else if (i != 512) {
      return;
    } else {
      i2 = R.string.config_defaultSearchSelectorPackageName;
    }
  ...
  public boolean isDiscoverableEnabled(ContextInfo contextInfo) {
    boolean z;
    ArrayList booleanList =
        this.mEdmStorageProvider.getBooleanList("BLUETOOTH", "discoverableModeEnabled");
    if (booleanList != null) {
      Iterator it = booleanList.iterator();
      while (it.hasNext()) {
        z = ((Boolean) it.next()).booleanValue();
      ...
      for (BluetoothDevice bluetoothDevice : defaultAdapter.getBondedDevices()) {
        ...
        if (bluetoothClass != null && bluetoothClass.getMajorDeviceClass() == 256) {
          if (bluetoothDevice.isConnected()) {
            Log.d(
                "BluetoothPolicyService",
                "Unpair this bluetooth computer(connected) : " + bluetoothDevice.getAddress());
            bluetoothDevice.removeBond();
          } else {
            Log.d(
                "BluetoothPolicyService",
                "Keep this bluetooth computer(not connected) : " + bluetoothDevice.getAddress());
          }
        }
      }
    }
  ...
  public boolean isDesktopConnectivityEnabled(boolean z) {
    boolean z2;
    ArrayList booleanList =
        this.mEdmStorageProvider.getBooleanList("BLUETOOTH", "desktopConnectivityEnabled");
    if (booleanList != null) {
      Iterator it = booleanList.iterator();
      while (it.hasNext()) {
        z2 = ((Boolean) it.next()).booleanValue();
    ...
    if (z && !z2) {
      RestrictionToastManager.show(R.string.config_defaultSupervisionProfileOwnerComponent);
    }
    return z2;
  }
  ...
  public boolean setBluetoothLogEnabled(ContextInfo contextInfo, boolean z) {
    ...
    boolean putValues =
        this.mEdmStorageProvider.putValues(
            enforceOwnerOnlyAndBluetoothPermission.mCallerUid, "BLUETOOTH", contentValues);
  ...
  */
  public final boolean getBluetoothLogEnabled(ContextInfo contextInfo, boolean z) {
    Log.d("BluetoothPolicyService", "getBluetoothLogEnabled(" + z + ")");
    int i = !z ? enforceBluetoothPermission(contextInfo).mCallerUid : -1;
    String[] strArr = {"bluetoothLogEnabled"};
    Log.d("BluetoothPolicyService", "getBluetoothLogEnabled - uid: " + i);
    boolean z2 = false;
    if (i > 0) {
      Cursor cursor = null;
      try {
        try {
          cursor = this.mEdmStorageProvider.getCursorByAdmin("BLUETOOTH", i, strArr);
      ...
      List valuesList = this.mEdmStorageProvider.getValuesList("BLUETOOTH", strArr);
      if (valuesList != null) {
        Log.d("BluetoothPolicyService", "getBluetoothLogEnabled - cvList: " + valuesList);
    ...
    Log.d("BluetoothPolicyService", "getBluetoothLogEnabled - ret: " + z2);
    return z2;
  }
      ...
      while (true) {
        try {
          ...
          if (str != null) {
            ...
            if (!BluetoothPolicy.this.mEdmStorageProvider.putValuesNoUpdate(
  ...
  public List getAllBluetoothUUIDsBlackLists(ContextInfo contextInfo) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    List translateList =
        translateList(this.mProfilePolicy.getAllObjectsFromBlackListForAllAdmins());
    Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public List getAllBluetoothUUIDsWhiteLists(ContextInfo contextInfo) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    List translateList =
        translateList(this.mProfilePolicy.getAllObjectsFromWhiteListForAllAdmins());
    Binder.restoreCallingIdentity(clearCallingIdentity);
    return translateList;
  }
  ...
  public boolean isBluetoothDeviceAllowed(String str, boolean z) {
    ...
    if (z && !isObjectAllowed) {
      RestrictionToastManager.show(R.string.config_defaultSystemCaptionsManagerService);
    }
  ...
  public class BluetoothProfilePolicy extends BlackWhiteListPolicy {
    ...
    public boolean isPolicyActive(int i) {
      try {
        return BluetoothPolicy.this.mEdmStorageProvider.getBoolean(
            i, "BLUETOOTH", "profilePolicyEnabled");
      } catch (Exception e) {
  ...
  public class BluetoothDevicePolicy extends BlackWhiteListPolicy {
    ...
    public boolean isPolicyActive(int i) {
      try {
        return BluetoothPolicy.this.mEdmStorageProvider.getBoolean(
            i, "BLUETOOTH", "devicePolicyEnabled");
      } catch (Exception e) {
        Log.d("BluetoothPolicyService", e.toString());
        return false;
      }
  ...
  public boolean isCallerIDDisplayAllowed(ContextInfo contextInfo) {
    try {
      Iterator it =
          this.mEdmStorageProvider.getBooleanList("BLUETOOTH", "allowCallerID").iterator();
      while (it.hasNext()) {
        boolean booleanValue = ((Boolean) it.next()).booleanValue();
        if (!booleanValue) {
          return booleanValue;
  ...
  public boolean allowBLE(ContextInfo contextInfo, boolean z) {
    ...
    if (!z) {
      setBluetoothRestore(
          enforceOwnerOnlyAndAdvancedRestrictionPermission,
          isBluetoothEnabledforAdmin(enforceOwnerOnlyAndAdvancedRestrictionPermission));
    }
  ...
  public int getAdminUidForBLE() {
    int adminByField =
        this.mEdmStorageProvider.getAdminByField("BLUETOOTH", "allowBLE", Integer.toString(0));
  ...
  public final boolean setBluetoothRestore(ContextInfo contextInfo, boolean z) {
    return this.mEdmStorageProvider.putBoolean(
        contextInfo.mCallerUid, "BLUETOOTH", "allowBluetoothRestore", z);
  }

  public final boolean isBluetoothRestore(ContextInfo contextInfo) {
    try {
      return this.mEdmStorageProvider.getBoolean(
          contextInfo.mCallerUid, "BLUETOOTH", "allowBluetoothRestore");
    } catch (Exception e) {
      Log.d("BluetoothPolicyService", e.toString());
      return true;
    }
  ...
  public final boolean isBluetoothEnabledforAdmin(ContextInfo contextInfo) {
    try {
      return this.mEdmStorageProvider.getBoolean(
          contextInfo.mCallerUid, "BLUETOOTH", "bluetoothEnabled");
    } catch (Exception e) {
      Log.d("BluetoothPolicyService", e.toString());
      return true;
    }
  ...
  public final void updateSystemUIMonitor(int i) {
    setBluetoothAllowedSystemUI(
        i, isBluetoothEnabled((ContextInfo) null) && !isBluetoothRestrictedByConstrainedState());
  }
