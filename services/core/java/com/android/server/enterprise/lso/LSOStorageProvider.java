...
public class LSOStorageProvider extends EdmStorageProvider {
  ...
  public int getCount(String str) {
    Cursor rawQuery =
        this.mEdmDbHelper.getWritableDatabase().rawQuery("SELECT COUNT(*) from " + str, null);
    if (rawQuery == null) {
      return 0;
    }
    rawQuery.moveToNext();
  ...
  public boolean updateAdminPref(LSOAttributeSet lSOAttributeSet) {
    ...
    return updateRecord(
            "ADMIN_REF", contentValues, "policyName=?", new String[] {"LOCKSCREEN_OVERLAY"})
        > 0;
  }
  ...
  public final void wipeLayerData(int i) {
    if (i == 0) {
      ...
      deleteDataByFields(
          "LOCKSCREEN_OVERLAY", new String[] {"Item_Layer"}, new String[] {String.valueOf(i)});
    }
    Log.d(
        "LSOStorageProvider",
  ...
  public void resetOverlayData(int i) {
    ...
    Log.d(
        "LSOStorageProvider",
        "resetOverlayData() LOCKSCREEN_OVERLAY - resetted layer : " + LSOConstants.getLayerName(i));
  }
  ...
  */
  ...
  public final int updateRecord(
      String str, ContentValues contentValues, String str2, String[] strArr) {
  ...
  public final boolean setOverlayData(LSOItemData lSOItemData, int i, long j) {
    ...
    if (!z) {
      Log.e(
          "LSOStorageProvider",
          "Failed to store LSOItemData for " + i2 + " with ParendId: " + insertRecord);
    }
    return z;
  }
      ...
      if (i5 == i3) {
        ...
        if (i5 == 128) {
          contentValues.put(
              tblColumns[13],
              Integer.valueOf(
                  lSOItemContainer.getOrientation() == LSOItemContainer.ORIENTATION.VERTICAL
                      ? 0
                      : 1));
        } else if (i5 == 256) {
