...
public class DualDARPolicy extends IDualDARPolicy.Stub implements EnterpriseServiceCallback {
    ...
    public final Bundle getConfigFromDb(int i, int i2) {
        ...
        String str2;
        try {
            DDLog.m33d("DualDARPolicy", "getConfigFromDb adminId : " + i + " userId : " + i2, new Object[0]);
    ...
    public void setClientInfo(ContextInfo contextInfo, String str, String str2, String str3) {
        ...
        if (SemPersonaManager.isDualDARNativeCrypto(enforceDualDARPermission.mContainerId) || str == null) {
            ...
            DDLog.m33d("DualDARPolicy", "setClientInfo CallerUid : " + enforceDualDARPermission.mCallerUid + ", ContainerId = " + enforceDualDARPermission.mContainerId, new Object[0]);
        ...
        if (z) {
            ...
            DDLog.m33d("DualDARPolicy", "Force refresh the in-memory cache, callerUid = " + enforceDualDARPermission.mCallerUid + ", mContainerId = " + enforceDualDARPermission.mContainerId, new Object[0]);
        ...
        DDLog.m33d("DualDARPolicy:DualDARAnalytics", "Final Logging Crypto: pkg Name :" + str + ", clientVersion: " + str3, new Object[0]);
    ...
    public int setConfig(ContextInfo contextInfo, Bundle bundle) {
        ContextInfo enforceDualDARPermission = enforceDualDARPermission(contextInfo);
        DDLog.m33d("DualDARPolicy", "setConfig : callingUid : " + enforceDualDARPermission.mCallerUid, new Object[0]);
        if (!SemPersonaManager.isDarDualEncryptionEnabled(enforceDualDARPermission.mContainerId)) {
            DDLog.m34e("DualDARPolicy", "setConfig : DualDAR not enabled for: " + enforceDualDARPermission.mContainerId, new Object[0]);
            return -1;
        }
    ...
    public boolean isActivePasswordSufficientForInner(ContextInfo contextInfo) {
        ...
        if (z) {
            DDLog.m33d("DualDARPolicy", "Password validation errors: " + validatePasswordMetrics, new Object[0]);
        }
        return !z;
    }
    ...
    public boolean setResetPasswordTokenForInner(ContextInfo contextInfo, byte[] bArr) {
        ContextInfo enforceDualDAROnDOPermission = enforceDualDAROnDOPermission(contextInfo);
        DDLog.m33d("DualDARPolicy", "setResetPasswordTokenForInner: " + enforceDualDAROnDOPermission.mContainerId, new Object[0]);
    ...
    public boolean clearResetPasswordTokenForInner(ContextInfo contextInfo) {
        ContextInfo enforceDualDAROnDOPermission = enforceDualDAROnDOPermission(contextInfo);
        DDLog.m33d("DualDARPolicy", "clearResetPasswordTokenForInner: " + enforceDualDAROnDOPermission.mContainerId, new Object[0]);
        int innerAuthUserId = this.mDualDarAuthUtils.getInnerAuthUserId(UserHandle.getUserId(enforceDualDAROnDOPermission.mCallerUid));
        if (innerAuthUserId < 0) {
            return false;
        }
    ...
    public boolean resetPasswordWithTokenForInner(ContextInfo contextInfo, final String str, final byte[] bArr) {
        ContextInfo enforceDualDAROnDOPermission = enforceDualDAROnDOPermission(contextInfo);
        DDLog.m33d("DualDARPolicy", "resetPasswordWithTokenForInner: " + enforceDualDAROnDOPermission.mContainerId, new Object[0]);
        ...
        if (innerAuthUserId < 0) {
            DDLog.m34e("DualDARPolicy", "resetPasswordWithTokenForInner: Invalid inner auth user : " + innerAuthUserId, new Object[0]);
            return false;
        }
    ...
    public /* synthetic */ Boolean lambda$resetPasswordWithTokenForInner$0(int i, String str, byte[] bArr, int i2) {
        if (!new LockPatternUtils(this.mInjector.getContext()).isSecure(i)) {
            DDLog.m34e("DualDARPolicy", "resetPasswordWithTokenForInner : Not permitted while device insecure", new Object[0]);
        ...
        if (str.isEmpty()) {
            DDLog.m34e("DualDARPolicy", "resetPasswordWithTokenForInner : Not permitted for empty password", new Object[0]);
            return Boolean.FALSE;
        }
        if (passwordMinimumMetrics != null) {
            ...
            if (!validatePassword.isEmpty()) {
                DDLog.m34e("DualDARPolicy", "Failed to reset password due to constraint violation: " + validatePassword.get(0), new Object[0]);
                return Boolean.FALSE;
            }
        }
    ...
    public final void setDefaultWhitelistedApps(ContextInfo contextInfo) {
        ...
        DDLog.m33d("DualDARPolicy", "setDefaultWhitelistedApps called, whitelistAppCount: " + arrayList.size(), new Object[0]);
        ContentValues contentValues = new ContentValues();
        ...
        if (this.edmStorageProvider.putValues(contextInfo.mCallerUid, contextInfo.mContainerId, "DUAL_DAR", contentValues)) {
            ...
            DDLog.m34e("DualDARPolicy", "failed to write new whitelist packages to persistent storage", new Object[0]);
        }
    }
    ...
    public final int setWhitelistPackagesForDataLockedState(ContextInfo contextInfo, Bundle bundle) {
                ...
                if (PersonaServiceHelper.isSystemApp(contextInfo.mContainerId, appIdentity2.getPackageName()) || arrayList4.contains(appIdentity2.getPackageName()) || arrayList6.contains(appIdentity2.getPackageName())) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            appIdentityArr = whitelistedAppsFromStorage;
                            e.printStackTrace();
                            DDLog.m34e("DualDARPolicy", "Exception in clearing user data for: " + appIdentity2.getPackageName() + " installed in: " + contextInfo.mContainerId, new Object[0]);
                            i2++;
        ...
        DDLog.m33d("DualDARPolicy", "setWhitelistPackagesForDataLockedState called, whitelistAppCount: " + arrayList3.size(), new Object[0]);
        ContentValues contentValues = new ContentValues();
        ...
        if (putValues) {
            i = 0;
            DDLog.m33d("DualDARPolicy", "successfully changed whitelist packages for datalock state", new Object[0]);
    ...
    public final int setDataLockTimeout(ContextInfo contextInfo, Bundle bundle) {
        ...
        if ((j >= j2 && j < Long.MAX_VALUE) || j == -1) {
            ...
            if (putValues) {
                ...
                DDLog.m34e("DualDARPolicy", "failed to write new datalock timeout to persistent storage", new Object[0]);
            }
            return putValues ? 0 : -1;
        }
        DDLog.m34e("DualDARPolicy", "setDataLockTimeout Invalid datalock timeout. It should be in range [" + j2 + ", 9223372036854775807] ms", new Object[0]);
        return -1;
    }
    ...
    public final void getClientAndProfileOwnerApps(ContextInfo contextInfo, List list, List list2) {
        ...
        try {
            ...
            DDLog.m33d("DualDARPolicy", "RemoteException in getClientAndProfileOwnerApps while checking permissions " + e.getMessage(), new Object[0]);
            list3 = null;
        }
        if (list3 != null) {
    ...
    public final void logDualDarAnalytics(ContextInfo contextInfo, Bundle bundle, String str) {
        DDLog.m33d("DualDARPolicy:DualDARAnalytics", "logDualDarAnalytics, userID" + contextInfo.mContainerId + ", event: " + str, new Object[0]);
        if (str.equals("datalock_timeout")) {
            ...
            DDLog.m33d("DualDARPolicy:DualDARAnalytics", "EVENT : DATALOCK_TIMEOUT TIME: " + j, new Object[0]);
            DDLog.m33d("DualDARPolicy:DualDARAnalytics", "Payload / " + knoxAnalyticsData.toString(), new Object[0]);
        ...
        if (str.equals("whitelisted_apps")) {
            ...
            DDLog.m33d("DualDARPolicy:DualDARAnalytics", "EVENT:WHITELISTED_APPS, WhiteListed Packages: " + whitelistPkgesFromConfig, new Object[0]);
            DDLog.m33d("DualDARPolicy:DualDARAnalytics", "Payload / " + knoxAnalyticsData2.toString(), new Object[0]);
            KnoxAnalytics.log(knoxAnalyticsData2);
            return;
        }
        if (str.equals("de_access_restriction")) {
            DDLog.m33d("DualDARPolicy:DualDARAnalytics", "DE Restriction Value: " + bundle.getBoolean("dualdar-config-de-restriction"), new Object[0]);
        }
    }
