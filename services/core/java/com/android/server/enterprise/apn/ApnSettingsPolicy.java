...
public class ApnSettingsPolicy extends IApnSettingsPolicy.Stub implements EnterpriseServiceCallback {
    ...
    */
    public synchronized long addUpdateApn(ContextInfo contextInfo, boolean z, ApnSettings apnSettings) {
        String str;
        boolean z2;
        ...
        if (validateString8 != null && validateString9 != null) {
            ...
            try {
                ...
                parseInt = (validateString12.isEmpty() || validateString12.compareTo("*") == 0) ? -1 : Integer.parseInt(validateString12);
            } catch (Exception e) {
                e = e;
                str = validateString12;
            }
            if ((z || 1 <= id) && validateString10 != null && validateString10.length() != 0 && validateString11 != null && validateString11.length() != 0 && validateString8.length() != 0) {
                if (validateString9.length() != 0 && -1 <= port && -1 <= parseInt && -2 <= authType && 3 >= authType) {
                    str = validateString12;
                    z2 = true;
                    if (z2) {
                        try {
                            ...
                            if (validateString10 != null && validateString11 != null) {
                                ...
                                if (str5 != null && str4 != null && str5.equals(validateString11) && str4.equals(validateString10)) {
                                ...
                                if (contentValues.size() > 0) {
                                    ...
                                    if (z) {
                                        Uri insert = this.mContext.getContentResolver().insert(Carriers.CONTENT_URI, contentValues);
                                        if (insert != null) {
        ...
        if (0 < j) {
            ...
            try {
                try {
                    ...
                    String simOperator = ((TelephonyManager) this.mContext.getSystemService("phone")).getSimOperator(defaultDataSubscriptionId);
                    int phoneId = SubscriptionManager.getPhoneId(defaultDataSubscriptionId);
                    String telephonyProperty = TelephonyManager.getTelephonyProperty(phoneId, "ril.simoperator", "ETC");
                    Log.d("ApnSettingsPolicyService", "isValidApnId: simOp = " + telephonyProperty + ", numeric = " + simOperator);
                    if ("CTC".equals(telephonyProperty)) {
                        String telephonyProperty2 = TelephonyManager.getTelephonyProperty(phoneId, "gsm.sim.cdmaoperator.numeric", "");
                        simOperator = TextUtils.isEmpty(telephonyProperty2) ? "46003" : telephonyProperty2;
                        Log.d("ApnSettingsPolicyService", "isValidApnId: CTC card! numeric = " + simOperator + ", cdmaOperator = " + telephonyProperty2);
                    }
                    cursor = this.mContext.getContentResolver().query(ContentUris.withAppendedId(Carriers.CONTENT_URI, j), strArr, null, null, null);
                    if (cursor != null) {
                        Log.w("ApnSettingsPolicyService", "isValidApnId() row count : " + cursor.getCount() + " for apId : " + j);
                    ...
                    if (z) {
                        try {
                            if (cursor.getString(1).equalsIgnoreCase(simOperator) && cursor.getString(2) != null && !cursor.getString(2).equals("dun")) {
                            }
                        } catch (Exception e) {
                            z2 = z;
                            e = e;
    ...
    */
    public final List retrieveApnListFromDatabase() {
        ...
        try {
            ...
            String[] strArr = {KnoxCustomManagerService.f1773ID, "name", "mcc", "mnc", "apn", "user", "server", "password", "proxy", "port", "mmsproxy", "mmsport", "mmsc", "authtype", str9, str8, str7, str6, str4};
            int firstSlotIndex = getFirstSlotIndex();
            String str10 = "authtype";
            String str11 = "mmsc";
            Cursor query = this.mContext.getContentResolver().query(getApnListUri(firstSlotIndex), strArr, getWhereClause(firstSlotIndex), null, null);
            if (query != null) {
                try {
                    if (query.moveToFirst()) {
                        while (true) {
                            ...
                            String str12 = str2;
                            apnSettings.setId(Long.parseLong(getColumnValue(KnoxCustomManagerService.f1773ID, query)));
    ...
    */
    public ApnSettings getApnSettings(ContextInfo contextInfo, long j) {
        ...
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            cursor = this.mContext.getContentResolver().query(ContentUris.withAppendedId(Carriers.CONTENT_URI, j), null, null, null, null);
            if (cursor != null) {
                try {
                    try {
                        if (cursor.moveToFirst()) {
                            ApnSettings apnSettings = new ApnSettings();
                            apnSettings.setId(Long.parseLong(getColumnValue(KnoxCustomManagerService.f1773ID, cursor)));
    ...
    */
    public synchronized ApnSettings getPreferredApn(ContextInfo contextInfo) {
        ...
        try {
            try {
                cursor = this.mContext.getContentResolver().query(Carriers.PREFERAPN_URI, new String[]{KnoxCustomManagerService.f1773ID, "name", "apn"}, null, null, "name ASC");
                if (cursor != null) {
                    try {
                        if (cursor.moveToFirst()) {
                            long j = cursor.getLong(cursor.getColumnIndexOrThrow(KnoxCustomManagerService.f1773ID));
