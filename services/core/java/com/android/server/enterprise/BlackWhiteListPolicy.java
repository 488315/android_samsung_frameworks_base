...
public abstract class BlackWhiteListPolicy {
    ...
    */
    public final void getAllObjectsFromList(int i, String str, List list) {
        ...
        try {
            try {
                cursor = this.mEdmStorageProvider.getCursorByAdminAndField(this.mTable, i, "ListType", str, new String[]{"Object"});
                if (cursor != null) {
                    list.clear();
                ...
                Log.e("BlackWhiteListPolicyService", "Exception occurred accessing Enterprise db " + e.getMessage());
            }
        } finally {
            if (cursor != null) {
                cursor.close();
