...
public class RollbackRefreshOperation {
            ...
            Binder.withCleanCallingIdentity(
                new FunctionalUtils
                    .ThrowingSupplier() { // from class:
                                          // com.android.server.enterprise.certificate.RollbackRefreshOperation$$ExternalSyntheticLambda0
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.enterprise.certificate.RollbackRefreshOperation$$ExternalSyntheticLambda1
  ...
  public /* synthetic */ List lambda$execute$0(List list) {
    return "2.0".equals(getPersonaManagerAdapter().getKnoxInfo().getString("version"))
        ? pruneDeletedContainerProfiles(list)
        : list;
  }
  ...
  public final List pruneDeletedContainerProfiles(List list) {
    ...
    while (i < list.size()) {
      ...
      if (userInfo != null
          && getPersonaManagerAdapter().isValidKnoxId(userInfo.id)
          && !userInfo.isEnabled()) {
        list.remove(i);
        i--;
      }
  ...
  public final void rollbackSystemKeyStoreAsUser(final int i) {
    ...
    final List genericListAsUser2 =
        this.mCertPolicy.getGenericListAsUser("systemPrevDisabledList", i);
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.enterprise.certificate.RollbackRefreshOperation$$ExternalSyntheticLambda2
          public final void runOrThrow() {
            RollbackRefreshOperation.this.lambda$rollbackSystemKeyStoreAsUser$2(
                i,
                genericListAsUser,
                genericListAsUser2,
                arrayList,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$rollbackSystemKeyStoreAsUser$2(
      int i, List list, List list2, List list3, List list4, List list5) {
    String str;
    String str2;
      ...
      if (service != null) {
        ...
        while (it4.hasNext()) {
          ...
          byte[] certificateFromTrustCredential =
              service.getCertificateFromTrustCredential(str3, true);
        ...
        for (Map.Entry entry : this.mUserKeyStore.getCertificates(list4, i).entrySet()) {
          ...
          if (x509Certificate2 != null
              && this.mCertPolicy.verifyCertificateTrustful(x509Certificate2, 3, i)) {
            list4.remove(str4);
            list5.add(str4);
  ...
  public final void rollbackNativeKeyStoreAsUser(int i, int i2) {
    ...
    for (Map.Entry entry : certificates.entrySet()) {
      ...
      if (x509Certificate != null
          && this.mCertPolicy.verifyCertificateTrustful(x509Certificate, 3, i2)) {
  ...
  public final void refreshSystemKeyStoreAsUser(final int i) {
    ...
    final Map certificates =
        this.mUserKeyStore.getCertificates(
            this.mCertPolicy.getGenericListAsUser("userRemovedList", i), i);
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.enterprise.certificate.RollbackRefreshOperation$$ExternalSyntheticLambda3
          public final void runOrThrow() {
            RollbackRefreshOperation.this.lambda$refreshSystemKeyStoreAsUser$3(
                i, genericListAsUser, genericListAsUser2, certificates);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$refreshSystemKeyStoreAsUser$3(
      int i, List list, List list2, Map map) {
    IKeyChainService service;
    byte[] certificateFromTrustCredential;
    try {
      KeyChain.KeyChainConnection bindAsUser =
      ...
      try {
        ...
        for (String str : service.allSystemAliases()) {
          if (!list.contains(str)
              && (certificateFromTrustCredential =
                      service.getCertificateFromTrustCredential(str, true))
                  != null) {
            for (X509Certificate x509Certificate :
                Credentials.convertFromPem(certificateFromTrustCredential)) {
              if (x509Certificate != null
                  && !this.mCertPolicy.verifyCertificateTrustful(x509Certificate, 2, i)) {
                list.add(str);
        ...
        for (String str2 : service.userAliases()) {
          byte[] certificateFromTrustCredential2 =
              service.getCertificateFromTrustCredential(str2, false);
          if (certificateFromTrustCredential2 != null) {
            for (X509Certificate x509Certificate2 :
                Credentials.convertFromPem(certificateFromTrustCredential2)) {
              if (x509Certificate2 != null
                  && !this.mCertPolicy.verifyCertificateTrustful(x509Certificate2, 3, i)) {
  ...
  public class TrustedStoreOperation extends AsyncTask {
                      ...
                      new FunctionalUtils
                        ...
                        public final Object getOrThrow() {
                          ...
                          lambda$doInBackground$0 =
                              RollbackRefreshOperation.TrustedStoreOperation.this
                                  .lambda$doInBackground$0();
    ...
    public /* synthetic */ Boolean lambda$doInBackground$0() {
      try {
        KeyChain.KeyChainConnection bindAsUser =
            KeyChain.bindAsUser(
                RollbackRefreshOperation.this.mContext, new UserHandle(this.mUserId));
          ...
          try {
            try {
              ...
              if (i == 0) {
                ...
                while (it.hasNext()) {
                  service.installCaCertificate(
                      Credentials.convertToPem(new Certificate[] {(X509Certificate) it.next()}));
                }
              } else if (i == 1) {
  ...
  public class NativeKeyStoreOperation extends AsyncTask {
    ...
    public Boolean doInBackground(Integer... numArr) {
      ...
      if (i == 0) {
        synchronized (RollbackRefreshOperation.this.mKeyStoreLock) {
          keyChainCRUD =
              new CertificateUtil.KeyChainCRUD(RollbackRefreshOperation.this.mContext, intValue);
          try {
            for (Map.Entry entry : getPemMap(this.mCerts).entrySet()) {
              String[] splitCertTypeAlias =
                  RollbackRefreshOperation.splitCertTypeAlias((String) entry.getKey());
              if (splitCertTypeAlias != null) {
                reinstallCert(
                    splitCertTypeAlias[0],
                    splitCertTypeAlias[1],
                    (byte[]) entry.getValue(),
                    keyChainCRUD);
              }
            }
        ...
        synchronized (RollbackRefreshOperation.this.mKeyStoreLock) {
          ...
          try {
            ...
            while (it.hasNext()) {
              String[] splitCertTypeAlias2 =
                  RollbackRefreshOperation.splitCertTypeAlias(
                      removeAliasSeparator((String) it.next()));
              if (splitCertTypeAlias2 != null) {
                ...
                if (!"USRCERT_".equals(str) && !keyChainCRUD.isCertificateEntry(str2, i2)) {
                  ...
                  if (bArr == null) {
                    Log.e(
                        ...
                        "NativeKeyStoreOperation - Could not retrieve user certificate from "
                            + str3);
                  } else if (keyChainCRUD.updateKeyPair(str2, bArr, null, i2)) {
                    Log.d(
                        "RollbackRefreshOperation",
                        "NativeKeyStoreOperation - certificate chain deleted successfully - "
                            + str3);
                  } else {
                    Log.e(
                        "RollbackRefreshOperation",
                        "NativeKeyStoreOperation - Could not delete certificate chain - " + str3);
                  }
                }
                ...
                if (keyChainCRUD.deleteEntry(str2, i2)) {
                  Log.d(
                      "RollbackRefreshOperation",
                      "NativeKeyStoreOperation - Entry deleted successfully - " + str4);
                } else {
                  Log.e(
                      "RollbackRefreshOperation",
                      "NativeKeyStoreOperation - Fail to delete entry - " + str4);
                }
              }
            }
            keyChainCRUD.disconnect();
    ...
    public final String removeAliasSeparator(String str) {
      ...
      return (lastIndexOf == -1 || !Utils.isInteger(str.substring(lastIndexOf + 3)))
          ? str
    ...
    public final void reinstallCert(
      ...
      if ("USRCERT_".equals(str)) {
        Log.e(
            "RollbackRefreshOperation",
            "reinstallCert - Could not perform rollback of a user certificate due to keystore2"
                + " changes - "
                + str3);
        return;
      }
      if ("CACERT_".equals(str)) {
        if (keyChainCRUD.contains(str2, i)) {
          ...
          if (bArr2 != null) {
            if (!keyChainCRUD.updateKeyPair(str2, bArr2, bArr, i)) {
              Log.e(
                  "RollbackRefreshOperation",
                  "reinstallCert - Could not reinsert CA cert(s) in key entry - " + str3);
              return;
            }
            Log.d(
                "RollbackRefreshOperation",
                "reinstallCert - CA cert(s) successfully reinserted in key entry - " + str3);
            return;
          }
          Log.e(
              "RollbackRefreshOperation",
              "reinstallCert - Could not find user certificate in this entry - " + str3);
          return;
        }
        ...
        Log.d(
            "RollbackRefreshOperation",
            "reinstallCert - CA cert successfully reinstalled - " + str3);
        return;
      }
      ...
      if ("CACERT_KE_".equals(str)) {
        ...
        Log.e(
            "RollbackRefreshOperation",
            "reinstallCert - CA cert(s) cannot be reinstalled anymore as entry has been deleted - "
                + str3);
      }
    }
  }
