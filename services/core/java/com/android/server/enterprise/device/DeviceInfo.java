...
public class DeviceInfo extends IDeviceInfo.Stub implements EnterpriseServiceCallback {
  ...
  public BroadcastReceiver mDataConnectionStateChangeReceiver =
      new BroadcastReceiver() { // from class: com.android.server.enterprise.device.DeviceInfo.1
  ...
  public BroadcastReceiver mDataStatisticsReceiver =
      new BroadcastReceiver() { // from class: com.android.server.enterprise.device.DeviceInfo.2
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
          ...
          if (intent.getAction().equals("android.intent.action.LOCKED_BOOT_COMPLETED")) {
            ...
            DeviceInfo.this.mDataUsageEventsHandler.removeCallbacks(
                DeviceInfo.this.mDataStatisticsUpdateRun);
            if (DeviceInfo.this.mDataUsageTimerActivated) {
              DeviceInfo.this.mDataUsageEventsHandler.postDelayed(
                  DeviceInfo.this.mDataStatisticsUpdateRun, 0L);
            }
          }
        }
      };
  public Runnable mDataStatisticsUpdateRun =
      new Runnable() { // from class: com.android.server.enterprise.device.DeviceInfo.3
        ...
        public void run() {
          ...
          if (DeviceInfo.this.mDataUsageTimerActivated) {
            DeviceInfo.this.mDataUsageEventsHandler.postDelayed(
                this, DeviceInfo.this.mDataUsageTimer);
          }
        }
      };
  public EnterpriseDeviceManager mEDM = null;
  public BroadcastReceiver mMessagingReceiver =
      new BroadcastReceiver() { // from class: com.android.server.enterprise.device.DeviceInfo.4
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
          boolean z;
          String str;
  ...
  public final boolean isDuplicatedPackage(List list, int i) {
    List<ContentValues> knoxServiceIdData =
        getKnoxServiceIdData(new String[] {"adminUid", "packageList"}, null);
  ...
  public String getKnoxServiceId(ContextInfo contextInfo) {
    ...
    boolean hasKnoxInternalExceptionPermission =
        hasKnoxInternalExceptionPermission(str2, UserHandle.getUserId(callingUid));
    Log.d(
        "DeviceInfo",
        "callingPackage " + str2 + ", isKnoxInternalApp = " + hasKnoxInternalExceptionPermission);
    if (hasKnoxInternalExceptionPermission) {
      ContentValues contentValues = new ContentValues();
      contentValues.put("adminUid", Integer.valueOf(callingUid));
      String string =
          this.mEdmStorageProvider.getString("KnoxServiceIdTable", "serviceId", contentValues);
  ...
  public boolean resetCallsCount(ContextInfo contextInfo) {
    ...
    return this.mEdmStorageProvider.putGenericValue("dropped", "0")
        & this.mEdmStorageProvider.putGenericValue("success", "0")
        & true
        & this.mEdmStorageProvider.putGenericValue("missed", "0");
  }
    ...
    try {
      try {
        ...
        do {
          ...
          processorTypeinLine = getProcessorTypeinLine(readLine);
        } while (processorTypeinLine == null);
        bufferedReader.close();
        return processorTypeinLine;
      } catch (Throwable th2) {
        th = th2;
      }
    } catch (Exception e4) {
  ...
  */
  ...
  public long getTotalRamMemory(ContextInfo contextInfo) {
    long[] jArr = {r0};
    readProcLines("/proc/meminfo", new String[] {"MemTotal:"}, jArr);
    long j = jArr[0] * 1024;
    return j;
  }
  ...
  public boolean getWifiStatisticEnabled(ContextInfo contextInfo) {
    Iterator it =
        this.mEdmStorageProvider.getBooleanList("MISC", "enableWifiDataStatistic").iterator();
    while (it.hasNext()) {
  ...
  public boolean getDataCallStatisticsEnabled(ContextInfo contextInfo) {
    Iterator it =
        this.mEdmStorageProvider
            .getBooleanList("PHONERESTRICTION", "enableWifiDataCallDataStatistic")
            .iterator();
    while (it.hasNext()) {
      boolean booleanValue = ((Boolean) it.next()).booleanValue();
      if (booleanValue) {
  ...
  public int getDataUsageTimer(ContextInfo contextInfo) {
    try {
      return this.mEdmStorageProvider.getInt(
          contextInfo.mCallerUid, "MISC", "miscDataStatisticTimer");
  ...
  public final void dataUsageValuesInit() {
    ...
    ArrayList dataByFields =
        this.mEdmStorageProvider.getDataByFields(
            ...
            null,
            new String[] {
              "deviceWifiSent", "deviceWifiReceived", "deviceNetworkSent", "deviceNetworkReceived"
            });
    if (dataByFields == null
        || dataByFields.isEmpty()
        || (contentValues = (ContentValues) dataByFields.get(0)) == null) {
      return;
    }
    try {
  ...
  public void dataUsageTimerActivation(ContextInfo contextInfo) {
    boolean z =
        this.mWifiStatsEnabled
            ...
            || getEDM().getPhoneRestrictionPolicy().getDataCallLimitEnabled();
  ...
  public boolean getDataCallLoggingEnabled(ContextInfo contextInfo) {
    ...
    Iterator it =
        this.mEdmStorageProvider
            .getBooleanList("PHONERESTRICTION", "enableDataCallLogging")
            .iterator();
    while (it.hasNext()) {
      boolean booleanValue = ((Boolean) it.next()).booleanValue();
      if (booleanValue) {
  ...
  public List getDataCallLog(ContextInfo contextInfo, String str) {
    ...
    List<ContentValues> values =
        this.mEdmStorageProvider.getValues("DATACALLLOG", strArr, contentValues);
    if (values == null) {
      return null;
    }
    ArrayList arrayList = new ArrayList();
    if (!values.isEmpty()) {
      for (ContentValues contentValues2 : values) {
        arrayList.add(
            contentValues2.getAsString("dataCallDate")
                + KnoxVpnFirewallHelper.DELIMITER
                + contentValues2.getAsString("dataCallStatus")
                + KnoxVpnFirewallHelper.DELIMITER
                + contentValues2.getAsString("dataCallNetType")
                + KnoxVpnFirewallHelper.DELIMITER
                + contentValues2.getAsString("dataCallBytes"));
      }
    }
    return arrayList;
  }
  ...
  public final boolean logDataCall(long j) {
    ...
    if (!str.equals(this.mDataCallLogLastStatus)
        || !networkTypeName.equals(this.mDataCallLogLastNetType)) {
      this.mDataCallLogLastTime = 0L;
      this.mDataCallLogLastValue = 0L;
    }
  ...
  public final ContextInfo enforceReadPrivilegedPhoneStatePermission(ContextInfo contextInfo) {
    return getEDM()
        .enforceActiveAdminPermissionByContext(
            contextInfo,
            new ArrayList(Arrays.asList("android.permission.READ_PRIVILEGED_PHONE_STATE")));
  }
  ...
  public final boolean clearLog(int i, String str, String str2, boolean z) {
    try {
      for (ContentValues contentValues :
          this.mEdmStorageProvider.getValues(str, (String[]) null, (ContentValues) null)) {
        if (contentValues.get(str2) != null) {
          String[] split =
              contentValues.get(str2).toString().split(KnoxVpnFirewallHelper.DELIMITER);
  ...
  public List getOutboundSMSCaptured(ContextInfo contextInfo) {
    ...
    try {
      Iterator it =
          this.mEdmStorageProvider
              .getDataByFields("SMS", new String[] {"smsType"}, new String[] {"0"}, null)
              .iterator();
      while (it.hasNext()) {
  ...
  public List getInboundSMSCaptured(ContextInfo contextInfo) {
    ...
    try {
      Iterator it =
          this.mEdmStorageProvider
              .getDataByFields("SMS", new String[] {"smsType"}, new String[] {"1"}, null)
              .iterator();
      while (it.hasNext()) {
        ContentValues contentValues = (ContentValues) it.next();
        if (isCorrectAdmin(
  ...
  public void storeSMS(String str, String str2, String str3, boolean z) {
    ...
    try {
      ...
      Iterator it =
          this.mEdmStorageProvider
              .getValues("MISC", new String[] {"adminUid"}, contentValues2)
              .iterator();
      while (it.hasNext()) {
  ...
  public List getOutgoingCallingCaptured(ContextInfo contextInfo) {
    ...
    try {
      Iterator it =
          this.mEdmStorageProvider
              .getDataByFields("CallingLog", new String[] {"callingType"}, new String[] {"0"}, null)
              .iterator();
      while (it.hasNext()) {
        ContentValues contentValues = (ContentValues) it.next();
        if (isCorrectAdmin(
  ...
  public List getIncomingCallingCaptured(ContextInfo contextInfo) {
    ...
    try {
      Iterator it =
          this.mEdmStorageProvider
              .getDataByFields("CallingLog", new String[] {"callingType"}, new String[] {"1"}, null)
              .iterator();
      while (it.hasNext()) {
        ContentValues contentValues = (ContentValues) it.next();
        if (isCorrectAdmin(
  ...
  public String getCellTowerCID(ContextInfo contextInfo) {
    ...
    return Integer.toHexString(
        (telephonyManager == null
                || (gsmCellLocation = (GsmCellLocation) telephonyManager.getCellLocation()) == null)
            ? -1
  ...
  public List getOutboundMMSCaptured(ContextInfo contextInfo) {
    ...
    try {
      Iterator it =
          this.mEdmStorageProvider
              .getDataByFields("MMS", new String[] {"mmsType"}, new String[] {"0"}, null)
              .iterator();
      while (it.hasNext()) {
        ContentValues contentValues = (ContentValues) it.next();
        if (isCorrectAdmin(
  ...
  public List getInboundMMSCaptured(ContextInfo contextInfo) {
    ...
    try {
      Iterator it =
          this.mEdmStorageProvider
              .getDataByFields("MMS", new String[] {"mmsType"}, new String[] {"1"}, null)
              .iterator();
      while (it.hasNext()) {
        ContentValues contentValues = (ContentValues) it.next();
        if (isCorrectAdmin(
        ...
        if (!"none".equals(str2)) {
          ...
          if ("TMM/UFN/UFU/COB/CHT/SAM/VMT/TGU/SAL/NBS/PBS/EBE/CRM".contains(substring)) {
            try {
              Log.d(
                  "DeviceInfo",
                  "SalesCode : Use product code as customerCode for Movistar single binary(TFG)");
              str = substring;
            } catch (RuntimeException e) {
              e = e;
              str = substring;
