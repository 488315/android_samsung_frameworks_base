...
public class MiscPolicy extends IMiscPolicy.Stub implements EnterpriseServiceCallback {
  ...
  public final ContextInfo enforceOwnerOnlyAndWriteSettingsPermission(ContextInfo contextInfo) {
    return getEDM()
        .enforceOwnerOnlyAndActiveAdminPermission(contextInfo, "android.permission.WRITE_SETTINGS");
  }
  ...
  public final ContextInfo enforceOwnerOnlyAndHwPermission(ContextInfo contextInfo) {
    return getEDM()
        .enforceOwnerOnlyAndActiveAdminPermission(
            contextInfo,
            new ArrayList(Arrays.asList("com.samsung.android.knox.permission.KNOX_HW_CONTROL")));
  }
  ...
  public final ContextInfo enforceOwnerOnlyAndOldSecurityOrNewInventoryPermission(
      ContextInfo contextInfo) {
    return getEDM()
        .enforceOwnerOnlyAndActiveAdminPermission(
            contextInfo,
            new ArrayList(Arrays.asList("com.samsung.android.knox.permission.KNOX_INVENTORY")));
  }
  ...
  public void setRingerBytes(ContextInfo contextInfo, Uri uri, String str, long j, String str2) {
    ...
    if (Utils.isPlatformSignedApp(
      ...
      try {
        enforceOwnerOnlyAndWriteSettingsPermission =
            enforceOwnerOnlyAndSecurityPermission(contextInfo);
      } catch (SecurityException e) {
        Log.d(
            "MiscPolicy",
            "MDM_SECURITY Permission is not granted - Check for WRITE_SETTINGS permission "
                + e.getMessage());
        enforceOwnerOnlyAndWriteSettingsPermission =
            enforceOwnerOnlyAndWriteSettingsPermission(contextInfo);
      }
    } else {
      enforceOwnerOnlyAndWriteSettingsPermission =
          enforceOwnerOnlyAndSecurityPermission(contextInfo);
    ...
    try {
      try {
        ...
        if (-1 != isRingToneEntryExist) {
          ...
          this.mContext
              .getContentResolver()
              .delete(ContentUris.withAppendedId(uri, isRingToneEntryExist), null, null);
        }
  ...
  */
  public final long isRingToneEntryExist(ContextInfo contextInfo, String str, Uri uri) {
    long clearCallingIdentity = Binder.clearCallingIdentity();
    long j = -1;
    Cursor cursor = null;
    try {
      try {
        ...
        Log.d("MiscPolicy", "isRingToneEntryExist : whereClause :" + str2);
        cursor =
            this.mContext
                .getContentResolver()
                .query(uri, new String[] {KnoxCustomManagerService.f1773ID}, str2, null, null);
  ...
  public SimChangeInfo getLastSimChangeInfo(ContextInfo contextInfo) {
    ...
    try {
      ...
      String readPropertyValue =
          Utils.readPropertyValue("SimChangeTime", "/data/system/SimCard.dat");
      String str = "-1";
      ...
      simInfo.countryIso =
          Utils.readPropertyValue("PreviousSimCountryIso", "/data/system/SimCard.dat");
      simChangeInfo.previousSimInfo.operatorName =
          Utils.readPropertyValue("PreviousSimOperatorName", "/data/system/SimCard.dat");
      simChangeInfo.previousSimInfo.operator =
          Utils.readPropertyValue("PreviousSimOperator", "/data/system/SimCard.dat");
      simChangeInfo.previousSimInfo.phoneNumber =
          Utils.readPropertyValue("PreviousSimPhoneNumber", "/data/system/SimCard.dat");
      simChangeInfo.previousSimInfo.serialNumber =
          Utils.readPropertyValue("PreviousSimSerialNumber", "/data/system/SimCard.dat");
      String readPropertyValue2 =
          Utils.readPropertyValue("SimChangeOperation", "/data/system/SimCard.dat");
      ...
      simInfo2.countryIso =
          Utils.readPropertyValue("CurrentSimCountryIso", "/data/system/SimCard.dat");
      simChangeInfo.currentSimInfo.operatorName =
          Utils.readPropertyValue("CurrentSimOperatorName", "/data/system/SimCard.dat");
      simChangeInfo.currentSimInfo.operator =
          Utils.readPropertyValue("CurrentSimOperator", "/data/system/SimCard.dat");
      simChangeInfo.currentSimInfo.phoneNumber =
          Utils.readPropertyValue("CurrentSimPhoneNumber", "/data/system/SimCard.dat");
      simChangeInfo.currentSimInfo.serialNumber =
          Utils.readPropertyValue("CurrentSimSerialNumber", "/data/system/SimCard.dat");
  ...
  public class SIMCardUpdateMonitor {
          ...
          new BroadcastReceiver() { // from class:
            ...
            public void onReceive(Context context2, Intent intent) {
              if ("com.samsung.android.knox.intent.action.KNOXFRAMEWORK_SYSTEMUI_UPDATE_INTENT_INTERNAL"
                ...
                MiscPolicy.this.updateSystemUIMonitor(
                    intent.getIntExtra(
                        "com.samsung.android.knox.intent.extra.USER_ID_INTERNAL", 0));
              }
            }
          };
    ...
    public final void saveSimState() {
      String readPropertyValue =
          Utils.readPropertyValue("CurrentSimSerialNumber", "/data/system/SimCard.dat");
      if (readPropertyValue == null
          || this.mTelephonyManager.getSimSerialNumber() == null
          || !this.mTelephonyManager.getSimSerialNumber().equalsIgnoreCase(readPropertyValue)) {
        ...
        try {
          ...
          if ("android.intent.action.SIM_STATE_CHANGED".equals(action)) {
            ...
            if ("ABSENT".equals(stringExtra)) {
              Log.d(
                  SIMCardUpdateMonitor.this.TAG,
                  " SIM Card State :" + IccCardConstants.State.ABSENT.name());
              Utils.writePropertyValue(
                  "SimChangeTime", System.currentTimeMillis() + "", "/data/system/SimCard.dat");
              ...
              FileUtils.setPermissions(
                  ...
                  -1);
              Intent intent2 =
                  new Intent("com.samsung.android.knox.intent.action.SIM_CARD_CHANGED");
              intent2.putExtra(
                  "com.samsung.android.knox.intent.extra.SIM_CHANGE_INFO",
                  (Parcelable)
                      MiscPolicy.this.getLastSimChangeInfo(
                          new ContextInfo(Binder.getCallingUid())));
              SIMCardUpdateMonitor.this.mCtxt.sendBroadcast(
                  intent2, "com.samsung.android.knox.permission.KNOX_INVENTORY");
              return;
            }
            if ("LOADED".equals(stringExtra)) {
              ...
              String readPropertyValue2 =
                  Utils.readPropertyValue("CurrentSimSerialNumber", "/data/system/SimCard.dat");
              if (readPropertyValue != null
                  && !readPropertyValue.equalsIgnoreCase(readPropertyValue2)) {
              ...
              intent3.putExtra(
                  ...
                  (Parcelable)
                      MiscPolicy.this.getLastSimChangeInfo(
                          new ContextInfo(Binder.getCallingUid())));
              SIMCardUpdateMonitor.this.mCtxt.sendBroadcast(
                  intent3, "com.samsung.android.knox.permission.KNOX_INVENTORY");
            }
          }
        } catch (Exception e) {
  ...
  public String getCurrentLockScreenString(ContextInfo contextInfo) {
    ...
    Log.e(
        "MiscPolicy",
        "getCurrentLockScreenString : currentSetAdminId=" + isAdminLockScreenStringSet);
    String str = null;
    if (isAdminLockScreenStringSet != -1) {
      ...
      try {
        try {
          str =
              getLockSettings()
                  .getString("lock_screen_owner_info", (String) null, callingOrCurrentUserId);
    ...
    try {
      for (ContentValues contentValues :
          this.mEdmStorageProvider.getValuesListAsUser(
              "MISC", new String[] {"adminUid", "lockscreenstring"}, i)) {
        Integer asInteger = contentValues.getAsInteger("lockscreenstring");
        if (asInteger != null && asInteger.intValue() == 1) {
          return EdmStorageProviderBase.getAdminUidFromLUID(
  ...
  public boolean changeLockScreenString(ContextInfo contextInfo, String str) {
    ...
    Context createContextAsUser =
        Utils.createContextAsUser(
            this.mContext, "android", 0, enforceOwnerOnlyAndSecurityPermission.mCallerUid);
    ...
    if (!z) {
      ...
      putInt =
          this.mEdmStorageProvider.putInt(
              enforceOwnerOnlyAndSecurityPermission.mCallerUid, "MISC", "lockscreenstring", 1);
      if (putInt) {
        Log.d("MiscPolicy", "changeLockScreenString(): ret is true set value");
        try {
          getLockSettings()
              .setBoolean("lock_screen_owner_info_enabled", true, callingOrCurrentUserId);
          getLockSettings().setString("lock_screen_owner_info", str4, callingOrCurrentUserId);
          int myPid = Process.myPid();
          Object[] objArr = {
            Integer.valueOf(enforceOwnerOnlyAndSecurityPermission.mCallerUid), str4
          };
          ...
          try {
            AuditLog.logAsUser(
                ...
                myPid,
                "MiscPolicy",
                String.format("Admin %d has changed lock screen string to %s", objArr),
      ...
      putInt =
          this.mEdmStorageProvider.putInt(
              enforceOwnerOnlyAndSecurityPermission.mCallerUid, "MISC", "lockscreenstring", 0);
      try {
        getLockSettings().setString("lock_screen_owner_info", str4, callingOrCurrentUserId);
        AuditLog.logAsUser(
            5,
  ...
  public class SystemFontChanger {
    ...
    public boolean setSystemActiveFont(String str, String str2) {
      ...
      try {
        ...
        ActivityManager activityManager =
            (ActivityManager) MiscPolicy.this.mContext.getSystemService("activity");
    ...
    public final boolean changeFont(String str, String str2) {
      ...
      File createFontDirectory =
          fontWriter.createFontDirectory(
              MiscPolicy.this.mContext,
              findMatchingTypefaceByName
                  .getTypefaceFilename()
                  .replaceAll(".xml", "")
                  .replaceAll(" ", PackageManagerShellCommandDataLoader.STDIN_PATH));
      ...
      for (int i2 = 0; i2 < findMatchingTypefaceByName.mSansFonts.size(); i2++) {
        ...
        try {
          fontWriter.copyFontFile(
              createFontDirectory,
              packageManager
                  .getResourcesForApplication(fontPackageName)
                  .getAssets()
                  .open("fonts/" + typefaceFile.getFileName()),
      ...
      Binder.restoreCallingIdentity(clearCallingIdentity);
      fontWriter.writeLoc(
          MiscPolicy.this.mContext, "sans.loc", createFontDirectory.getAbsolutePath());
    ...
    */
    public int getActiveFontPosition() {
        ...
        try {
          File sharedPrefsFile =
              MiscPolicy.this
                  ...
                  .getSharedPrefsFile("prefs");
          if (sharedPrefsFile.canRead()) {
            bufferedInputStream =
                new BufferedInputStream(new FileInputStream(sharedPrefsFile), 16384);
            try {
      ...
      if (hashMap2 == null && (num = (Integer) hashMap2.get("SavedClickedItem")) != null) {
        return num.intValue();
      }
    }
        ...
        for (int i = 0; i < installedApplications.size(); i++) {
          ...
          if (!str.startsWith("com.monotype.android.font.droidserifitalic")
            ...
            this.mTypefaceFinder.findTypefaces(
                packageManager.getResourcesForApplication(applicationInfo).getAssets(), str);
          }
        }
      ...
      if (supportBigFont(createPackageContext)) {
        identifier =
            resources.getIdentifier(
                "sec_entryvalues_big_font_size", "array", "com.android.settings");
      } else {
        identifier =
            resources.getIdentifier(
                "sec_entryvalues_8_step_font_size", "array", "com.android.settings");
      }
      if (identifier == 0) {
  ...
  public boolean allowNFCStateChange(ContextInfo contextInfo, boolean z) {
    ...
    boolean putBoolean =
        this.mEdmStorageProvider.putBoolean(
            enforceOwnerOnlyAndHwPermission.mCallerUid, "MISC", "nfcStateChangeAllowed", z);
    updateAdminsBlockingNfcStateChange();
    if (putBoolean) {
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        AuditLog.logAsUser(
            ...
            String.format(
                ...
                Integer.valueOf(enforceOwnerOnlyAndHwPermission.mCallerUid), Boolean.valueOf(z)),
            UserHandle.getUserId(enforceOwnerOnlyAndHwPermission.mCallerUid));
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
  ...
  public boolean isNFCStateChangeAllowed() {
    Iterator it =
        this.mEdmStorageProvider.getBooleanList("MISC", "nfcStateChangeAllowed").iterator();
    while (it.hasNext()) {
  ...
  public final void updateAdminsBlockingNfcStateChange() {
    ...
    for (ContentValues contentValues :
        this.mEdmStorageProvider.getValuesList(
            "MISC", new String[] {"nfcStateChangeAllowed", "adminUid"})) {
  ...
  public final void makeStartNFCHistory(ContextInfo contextInfo, boolean z) {
    this.mStartNFCHistoryList.add(
        makeTime() + " callerUid=" + contextInfo.mCallerUid + " value=" + z);
  ...
  public int setGlobalProxyEnforcingSecurityPermission(
    ...
    return setGlobalProxy(
        enforceOwnerOnlyAndOldSecurityOrNewGlobalProxyPermission(contextInfo), proxyProperties);
  }
  ...
  public final boolean validateProxyProperties(ProxyProperties proxyProperties) {
    ...
    if (TextUtils.isEmpty(proxyProperties.getHostname())) {
      return !TextUtils.isEmpty(proxyProperties.getPacFileUrl())
    ...
    return portNumber >= 0
        && portNumber <= 65535
        && (validateIp(hostname) || validateHostName(hostname));
  }
  ...
  public final synchronized int setGlobalProxy(
    ...
    KnoxAnalyticsData knoxAnalyticsData =
        new KnoxAnalyticsData("KNOX_SECURE_NETWORK", 1, "setGlobalProxy");
    knoxAnalyticsData.setProperty(
        "proxyTp", !TextUtils.isEmpty(proxyProperties.getPacFileUrl()) ? 1 : 0);
    knoxAnalyticsData.setProperty(
        "proxyAuth", proxyProperties.isAuthenticationConfigured() ? 0 : 1);
    KnoxAnalytics.log(knoxAnalyticsData);
    if (!validateProxyProperties(proxyProperties)) {
      return 0;
    }
    if (!isGlobalProxyAllowed()
        && !isGlobalProxySetForAdmin(contextInfo.mCallerUid, contextInfo.mContainerId)) {
      return 0;
    }
    ...
    if (TextUtils.isEmpty(proxyProperties.getPacFileUrl())
        && (localProxyInfo = this.mLocalProxyManager.getLocalProxyInfo()) != null) {
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
  ...
  public final boolean setGlobalProxyRestriction(ContextInfo contextInfo, boolean z) {
    return this.mEdmStorageProvider.putBoolean(
        contextInfo.mCallerUid, contextInfo.mContainerId, "RESTRICTION", "globalProxy", z);
  }
    ...
    if (proxyProperties.isAuthenticationConfigured()) {
      ...
      while (it.hasNext()) {
        if (this.mEdmStorageProvider.insert(
                "GlobalProxyAuthTable", convertAuthConfigToContentValues(i, (AuthConfig) it.next()))
            == -1) {
          z = false;
        }
      }
  ...
  public final boolean saveProxyInfoToDb(int i, ProxyInfo proxyInfo) {
    return this.mEdmStorageProvider.insert(
            "GlobalProxyTable", convertProxyInfoToContentValues(i, proxyInfo))
        != -1;
  }
  ...
  public boolean isGlobalProxyAllowed() {
    return !this.mEdmStorageProvider
        .getBooleanList("RESTRICTION", "globalProxy")
    ...
    for (ContentValues contentValues : values) {
      ...
      if (!TextUtils.isEmpty(asString) || !TextUtils.isEmpty(asString3)) {
        if (!TextUtils.isEmpty(asString3)) {
          ...
          buildDirectProxy =
              ProxyInfo.buildDirectProxy(asString, intValue, convertStringToList(asString2));
        }
  ...
  public final synchronized int clearGlobalProxyEnable(ContextInfo contextInfo) {
    try {
      if (!this.mEdmStorageProvider.getBoolean(
          contextInfo.mCallerUid, contextInfo.mContainerId, "RESTRICTION", "globalProxy")) {
        return 0;
      }
      if (getConnectivityManagerService() == null) {
        return 0;
