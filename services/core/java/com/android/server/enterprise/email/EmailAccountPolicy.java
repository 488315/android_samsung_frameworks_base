...
public class EmailAccountPolicy extends IEmailAccountPolicy.Stub
    ...
    ContextInfo enforceActiveAdminPermissionByContext =
        getEDM()
            .enforceActiveAdminPermissionByContext(
                contextInfo,
                new ArrayList(Arrays.asList("com.samsung.android.knox.permission.KNOX_EMAIL")));
  ...
  public long addNewAccount_ex(
    ...
    if (!SettingsUtils.isPackageInstalled(
        SettingsUtils.getEmailPackageName(callingOrCurrentUserId), i3)) {
      Log.i(
          "EmailAccountPolicy",
          "addNewAccount() EX : Error :: Email app is not installed on user " + i3);
      return -1L;
    }
      ...
      try {
        try {
          ...
          try {
            ...
            intent.putExtra(
                "com.samsung.android.knox.intent.extra.SERVICE_INTERNAL", validIncomingProtocol);
            intent.putExtra(
            ...
            intent.putExtra(
                "com.samsung.android.knox.intent.extra.RECEIVE_SECURITY_INTERNAL", str13);
            ...
            intent.putExtra(
                "com.samsung.android.knox.intent.extra.OUTGOING_SENDER_NAME_INTERNAL", validStr4);
    ...
    Slog.d(
        str11,
        "<<<<<<<<<<<<<<<<<\t\taddNewAccount EX : Broadcasting Email + recvSecurityStr " + str13);
    return 0L;
  }
  ...
  public boolean setAccountName(ContextInfo contextInfo, String str, long j) {
    ...
    EnterpriseEmailAccount enterpriseEmailAccount =
        EmailProviderHelper.getEnterpriseEmailAccount(
            this.mContext, enforceEmailAccountPermission, j);
  ...
  public boolean setSyncInterval(ContextInfo contextInfo, int i, long j) {
    AccountMetaData accountDetails =
        SettingsUtils.getAccountDetails(
            enforceEmailAccountPermission(contextInfo), j, this.mContext);
  ...
  public boolean setInComingServerAcceptAllCertificates(
    ...
    if (enterpriseEmailAccount == null) {
      Log.i(
          "EmailAccountPolicy",
          "setInComingServerAcceptAllCertificates_new() : No exist accId : " + j);
      return false;
    }
    enterpriseEmailAccount.mInComingAcceptAllCertificates = z;
    Slog.d(
        "EmailAccountPolicy",
        "setInComingServerAcceptAllCertificates returned  acceptAllCertificates : " + z);
    return EmailProviderHelper.updateEnterpriseEmailAccount(
        this.mContext, enforceEmailAccountPermission, enterpriseEmailAccount);
  }
  ...
  public long setInComingServerLogin(ContextInfo contextInfo, String str, long j) {
    ...
    AccountMetaData accountDetails =
        SettingsUtils.getAccountDetails(enforceEmailAccountPermission, j, this.mContext);
    if (accountDetails == null) {
  ...
  public long setOutGoingServerAddress(ContextInfo contextInfo, String str, long j) {
    ...
    Slog.d(
        "EmailAccountPolicy", "setOutGoingServerAddress() returned  serverAddress : " + validStr);
    if (EmailProviderHelper.updateEnterpriseEmailAccount(
        this.mContext, enforceEmailAccountPermission, enterpriseEmailAccount)) {
      return enterpriseEmailAccount.mId;
    }
  ...
  public boolean setOutGoingServerAcceptAllCertificates(
    ...
    if (enterpriseEmailAccount == null) {
      Log.i(
          "EmailAccountPolicy",
          "setOutGoingServerAcceptAllCertificates_new() : No exist accId : " + j);
      return false;
    }
  ...
  public boolean deleteAccount(ContextInfo contextInfo, long j) {
    ...
    if (!SettingsUtils.isAccountRemovalAllowed(
        enterpriseEmailAccount.mEmailAddress, SettingsUtils.getAccountType(false, 0))) {
      Log.i(
          "EmailAccountPolicy",
          "deleteAccount_new() : MDM DeviceAccountPolicy restriction - cannot delete account : "
              + j);
      return false;
    }
    long clearCallingIdentity = Binder.clearCallingIdentity();
  ...
  public Account[] getAllEmailAccounts(ContextInfo contextInfo) {
    ...
    EnterpriseEmailAccount[] allEnterpriseEmailAccount =
        EmailProviderHelper.getAllEnterpriseEmailAccount(
            this.mContext, enforceEmailAccountPermission);
  ...
  public long addNewAccount_new(ContextInfo contextInfo, EmailAccount emailAccount) {
    ...
    if (!SettingsUtils.isPackageInstalled(
        SettingsUtils.getEmailPackageName(callingOrCurrentUserId), i)) {
      Log.i(
          "EmailAccountPolicy",
          "addNewAccount() EX : Error :: Email app is not installed on user " + i);
      return -1L;
    }
    if (SettingsUtils.getAccountId(
            enforceEmailAccountPermission,
    ...
    try {
      ...
      try {
        try {
          ...
          intent.putExtra(
              "com.samsung.android.knox.intent.extra.OUTGOING_SENDER_NAME_INTERNAL", validStr5);
          intent.putExtra(
              "com.samsung.android.knox.intent.extra.SIGNATURE_INTERNAL", emailAccount.signature);
          intent.putExtra(
              "com.samsung.android.knox.intent.extra.EXTRA_NOTIFY_INTERNAL", emailAccount.isNotify);
          ...
          Slog.d(
              "EmailAccountPolicy",
              " addNewAccount() NEW : sent intent to Email app : " + validStr);
        } catch (Exception e) {
          e = e;
          Log.e("EmailAccountPolicy", "addNewAccount() NEW :  failed. ", e);
          Binder.restoreCallingIdentity(j);
          Log.i(
              "EmailAccountPolicy", "<<<<<<<<<<<<<<<<<\t\taddNewAccount NEW : Broadcasting Email");
          Slog.d(
              "EmailAccountPolicy",
    ...
    Slog.d(
        "EmailAccountPolicy",
        "<<<<<<<<<<<<<<<<<\t\taddNewAccount NEW : Broadcasting Email +  recvSecurityStr " + str2);
    return 0L;
  }
  ...
  public long setSecurityOutGoingServerPassword(ContextInfo contextInfo, String str) {
    getEDM()
        .enforcePermissionByContext(contextInfo, "com.samsung.android.knox.permission.KNOX_EMAIL");
