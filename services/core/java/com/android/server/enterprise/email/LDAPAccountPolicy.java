...
public class LDAPAccountPolicy extends ILDAPAccountPolicy.Stub
  ...
  public class LDAPIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      if (intent
          .getAction()
          .equals("com.samsung.android.knox.intent.action.LDAP_CREATE_ACCT_RESULT_INTERNAL")) {
        Log.i(
            "LDAPAccountPolicyService",
            "LDAPIntentReceiver: Received intent : ACTION_LDAP_CREATE_ACCT_RESULT_INTERNAL");
    ...
    try {
      try {
        long accountEmailPassword =
            setAccountEmailPassword(enforceLDAPPermission, lDAPAccount.password);
        Intent intent =
            new Intent("com.samsung.android.knox.intent.action.CREATE_LDAPACCOUNT_INTERNAL");
        intent.putExtra("com.samsung.android.knox.intent.extra.USER_ID_INTERNAL", lDAPAccount.id);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.USER_NAME_INTERNAL", lDAPAccount.userName);
        intent.putExtra(
        ...
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.IS_ANONYMOUS_INTERNAL", lDAPAccount.isAnonymous);
        intent.putExtra("com.samsung.android.knox.intent.extra.HOST_INTERNAL", lDAPAccount.host);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.BASE_DN_INTERNAL", lDAPAccount.baseDN);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.TRUST_ALL_INTERNAL", lDAPAccount.trustAll);
  ...
  public synchronized boolean deleteLDAPAccount(ContextInfo contextInfo, long j) {
    ...
    if (deviceAccountPolicy != null) {
      if (!deviceAccountPolicy.isAccountRemovalAllowed(
          getAccountLDAPType(), lDAPAccount.userName + "@" + lDAPAccount.host, false)) {
        Log.i(
            "LDAPAccountPolicyService",
            "deleteLDAPAccount() : MDM DeviceAccountPolicy restriction - cannot delete account : "
                + j);
        return false;
      }
    }
        ...
        lDAPAccount =
            SettingsUtils.getLDAPAccountFromEnterpriseLDAPAccount(
                EmailProviderHelper.getEnterpriseLDAPAccount(
                    this.mContext, enforceLDAPPermission, j));
      } catch (Exception e) {
