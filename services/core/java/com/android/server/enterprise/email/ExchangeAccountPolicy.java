...
public class ExchangeAccountPolicy extends IExchangeAccountPolicy.Stub
  ...
  public Handler mHandler =
      new Handler() { // from class: com.android.server.enterprise.email.ExchangeAccountPolicy.2
        ...
        public void handleMessage(Message message) {
          ...
          if (ExchangeAccountPolicy.this.mExchangeServiceDisabled) {
            ...
            ComponentName componentName =
                new ComponentName(
                    SettingsUtils.getEasPackageName(i),
                    ExchangeAccountPolicy.getExchangeServiceName(i));
            Log.i(
                "ExchangeAccountPolicy",
                "Handler / RESTART_EMAIL_APP : Enabling EAS ExchangeService user " + i2);
            ...
            try {
              try {
                ExchangeAccountPolicy.this.mContext.sendBroadcastAsUser(
                    new Intent("com.samsung.android.knox.intent.action.EAS_INTENT_INTERNAL"),
                    new UserHandle(i2),
                    "com.samsung.android.knox.permission.KNOX_EMAIL");
              } catch (Exception e) {
                Log.e(
                    "ExchangeAccountPolicy",
                    "Handler / RESTART_EMAIL_APP : fail to restart ExchangeService. ",
                    e);
              }
            } finally {
  ...
  public ExchangeAccountPolicy(Context context) {
    ...
    try {
      ...
      ComponentName componentName =
          new ComponentName(SettingsUtils.getEasPackageName(0), getExchangeServiceName(0));
    ...
    ContextInfo enforceActiveAdminPermissionByContext =
        getEDM()
            .enforceActiveAdminPermissionByContext(
                contextInfo,
                new ArrayList(Arrays.asList("com.samsung.android.knox.permission.KNOX_EXCHANGE")));
  ...
  public long addNewAccount_ex(
    ...
    if (!SettingsUtils.isPackageInstalled(
            SettingsUtils.getEmailPackageName(callingOrCurrentUserId), i12)
        && !SettingsUtils.isPackageInstalled("com.samsung.android.focus", i12)) {
      Log.i(
          "ExchangeAccountPolicy",
          "addNewAccount() EX : Error :: Email and Focus are not installed on user " + i12);
      return -1L;
    }
    if (true == z2 && true == z3) {
      Log.i(
          "ExchangeAccountPolicy",
          "addNewAccount() EX : Error :: Invalid input parameters. 'emailNotificationVibrateAlways'"
              + " and 'emailNotificationVibrateWhenSilent' only one will be true at a time");
      return -1L;
    }
    ...
    try {
      try {
        ...
        Intent intent =
            new Intent("com.samsung.android.knox.intent.action.CREATE_EMAILACCOUNT_INTERNAL");
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.ACCOUNT_ID_INTERNAL", accountEmailPassword);
        ...
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.EXTRA_USER_NAME_INTERNAL", validStr6);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.USER_PASSWD_ID_INTERNAL", accountEmailPassword);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.SERVER_PATH_PREFIX_INTERNAL", validStr9);
  ...
  public boolean setSSL(ContextInfo contextInfo, boolean z, long j) {
    ...
    EnterpriseExchangeAccount enterpriseExchangeAccount =
        EmailProviderHelper.getEnterpriseExchangeAccount(
            this.mContext, enforceExchangeAccountPermission, j);
  ...
  public boolean setAlwaysVibrateOnEmailNotification(ContextInfo contextInfo, boolean z, long j) {
    ...
    if (enterpriseExchangeAccount == null) {
      Log.i(
          "ExchangeAccountPolicy",
          "setAlwaysVibrateOnEmailNotification_new() : No exist accId : " + j);
      return false;
    }
  ...
  public boolean setPassword(ContextInfo contextInfo, String str, long j) {
    ...
    Log.i(
        "ExchangeAccountPolicy",
        "setPassword() : " + Utils.getCallingOrCurrentUserId(enforceExchangeAccountPermission));
    String validStr = SettingsUtils.getValidStr(str);
    if (validStr == null) {
  ...
  public void setClientAuthCert(ContextInfo contextInfo, byte[] bArr, String str, long j) {
    ...
    try {
      try {
        ...
        Intent intent =
            new Intent("com.samsung.android.knox.intent.action.EMAIL_INSTALL_CERT_INTERNAL");
        long accountCertificatePassword =
  ...
  public long getAccountId(ContextInfo contextInfo, String str, String str2, String str3) {
    ...
    long accountId =
        SettingsUtils.getAccountId(
            enforceExchangeAccountPermission, str, str2, str3, "eas", true, this.mContext);
    Slog.d(
        "ExchangeAccountPolicy",
        "getAccountId() : = "
            + accountId
  ...
  public Account[] getAllEASAccounts(ContextInfo contextInfo) {
    ...
    EnterpriseExchangeAccount[] allEnterpriseExchangeAccount =
        EmailProviderHelper.getAllEnterpriseExchangeAccount(
            this.mContext, enforceExchangeAccountPermission);
    if (allEnterpriseExchangeAccount != null) {
      for (EnterpriseExchangeAccount enterpriseExchangeAccount : allEnterpriseExchangeAccount) {
        if (enterpriseExchangeAccount != null) {
          arrayList.add(
              SettingsUtils.getAccountFromEnterpriseExchangeAccount(enterpriseExchangeAccount));
        }
      }
    } else {
  ...
  public boolean deleteAccount(ContextInfo contextInfo, long j) {
    ...
    if (!SettingsUtils.isAccountRemovalAllowed(str, SettingsUtils.getAccountType(true, 0))) {
      Log.i(
          "ExchangeAccountPolicy",
          "deleteAccount() : MDM DeviceAccountPolicy restriction - cannot delete account : " + j);
      return false;
    }
    int callingOrCurrentUserId = Utils.getCallingOrCurrentUserId(enforceExchangeAccountPermission);
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      ...
      Intent intent =
          new Intent("com.samsung.android.knox.intent.action.DELETE_EMAILACCOUNT_INTERNAL");
      intent.putExtra("com.samsung.android.knox.intent.extra.ACCOUNT_ID_INTERNAL", j);
  ...
  /* JADX WARN: Type inference failed for: r1v4, types: [java.lang.Integer, java.lang.Object] */
  ...
  public String getDeviceId(ContextInfo contextInfo) {
    ...
    if (!SettingsUtils.isPackageInstalled(emailPackageName, callingOrCurrentUserId)) {
      Log.i(
          "ExchangeAccountPolicy",
          "getDeviceId() failed : Email App is not installed. : " + emailPackageName);
      return null;
    }
    if (getEDM() != null
        && !getEDM().getApplicationPolicy().getApplicationStateEnabled(emailPackageName)) {
      Log.i(
          "ExchangeAccountPolicy",
          "getDeviceId() failed : Email App is disabled. : " + emailPackageName);
      return null;
    }
        ...
        try {
          BroadcastReceiver broadcastReceiver =
              new BroadcastReceiver() { // from class:
                                        // com.android.server.enterprise.email.ExchangeAccountPolicy.1
          ...
          this.mContext.registerReceiverAsUser(
              broadcastReceiver, UserHandle.ALL, intentFilter, null, null);
          Intent intent =
              new Intent(
          ...
          try {
            try {
              if (mDeviceId.get(Integer.valueOf(callingOrCurrentUserId)) == null) {
                Log.i(
                    "ExchangeAccountPolicy",
                    "getDeviceId() : Device id is still null, waiting 5 seconds...");
                obj.wait(5000L);
              }
              context = this.mContext;
            } catch (InterruptedException e) {
              Log.e("ExchangeAccountPolicy", "getDeviceId() Inturrupted.", e);
              context = this.mContext;
            }
          ...
          Log.e("ExchangeAccountPolicy", "getDeviceId() : failed. ", e2);
        }
      } finally {
  ...
  public boolean getRequireSignedSMIMEMessages(ContextInfo contextInfo, long j) {
    return getPolicyState(
        contextInfo.mContainerId, j, "ReqSigSmime", Utils.getCallingOrCurrentUserId(contextInfo));
  }
  ...
  public class SMIMEIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (action.endsWith("com.samsung.edm.intent.action.EXCHANGE_SMIME_INSTALL_STATUS")) {
        ...
        long longExtra =
            intent.getLongExtra("com.samsung.android.knox.intent.extra.ACCOUNT_ID", -1L);
        long longExtra2 =
            intent.getLongExtra(
                "com.samsung.android.knox.intent.extra.CERT_RESULT_ID_INTERNAL", -1L);
        ...
        if (intExtra == -1 && longExtra > 0) {
          int intExtra2 =
              intent.getIntExtra("com.samsung.android.knox.intent.extra.SMIME_INSTALL_TYPE", 1);
          ...
          if (intExtra2 == 2 || intExtra2 == 1) {
            z =
                ExchangeAccountPolicy.this.putPolicyState(
                    i, i2, longExtra, true, "ForceSmimeCertForEncryption");
            Slog.d(
                "ExchangeAccountPolicy/Receiver",
                "force SMIME Certificate for Enryption. ret = " + z);
          }
          if (intExtra2 == 3 || intExtra2 == 1) {
            z =
                ExchangeAccountPolicy.this.putPolicyState(
                    i, i2, longExtra, true, "ForceSmimeCertForSigning");
            Slog.d(
                "ExchangeAccountPolicy/Receiver",
                "force SMIME Certificate for Signing. ret = " + z);
          }
          if (z) {
        ...
        Log.i(
            "ExchangeAccountPolicy/Receiver",
            "failed to enforce SMIME. accId = " + longExtra + ", status = " + intExtra);
        return;
      }
      if ("com.samsung.android.knox.intent.action.ENFORCE_SMIME_ALIAS_EMAIL_INTERNAL"
        ...
        try {
          AccountSMIMECertificate sMIMECertificate2 =
              AccountsReceiver.getSMIMECertificate("S" + longExtra4);
            ...
            if (intExtra3 != -1 || longExtra3 <= 0) {
              ...
              if (intExtra4 == 0) {
                if (sMIMECertificate2.mPath == null) {
                  z =
                      ExchangeAccountPolicy.this.resetForcedSMIMECertificateInternal(
                          contextInfo2, longExtra3, i4, 2, true);
                  Slog.d(
                      "ExchangeAccountPolicy/Receiver",
                      "release SMIME Certificate for Enryption (Alias) by null.");
                } else {
                  z =
                      ExchangeAccountPolicy.this.putPolicyState(
                          i3, i4, longExtra3, true, "ForceSmimeCertForEncryption");
                  Slog.d(
                      "ExchangeAccountPolicy/Receiver",
                      "force SMIME Certificate for Enryption (Alias). ret = " + z);
                }
              }
              if (intExtra4 == 1) {
                if (sMIMECertificate2.mPath == null) {
                  z =
                      ExchangeAccountPolicy.this.resetForcedSMIMECertificateInternal(
                          sMIMECertificate2.mCxtInfo, longExtra3, i4, 3, true);
                  Slog.d(
                      "ExchangeAccountPolicy/Receiver",
                      "release SMIME Certificate for Signing (Alias) by null.");
                } else {
                  z =
                      ExchangeAccountPolicy.this.putPolicyState(
                          i3, i4, longExtra3, true, "ForceSmimeCertForSigning");
                  Slog.d(
                      "ExchangeAccountPolicy/Receiver",
                      "force SMIME Certificate for Signing (Alias). ret = " + z);
                }
              }
              if (z) {
                if (sMIMECertificate2.mPath == null) {
                  Log.i(
                      "ExchangeAccountPolicy/Receiver",
                      "success to release SMIME Certificate (Alias) : " + intExtra4);
                } else {
                  Log.i(
                      "ExchangeAccountPolicy/Receiver",
                      "success to SMIME Certificate (Alias) : " + intExtra4);
                }
              } else if (sMIMECertificate2.mPath == null) {
                Log.i(
                    "ExchangeAccountPolicy/Receiver",
                    "failed to release SMIME Certificate (Alias) : " + intExtra4);
              } else {
                Log.i(
                    "ExchangeAccountPolicy/Receiver",
                    "failed to SMIME Certificate (Alias)." + intExtra4);
              }
            }
          } else {
            Log.i(
          ...
          Log.e(
              "ExchangeAccountPolicy/Receiver", "Failed to apply SMIME Alis Policy on success.", e);
        }
  ...
  public final void sendReleaseSMIMECertificate(int i, long j, int i2) {
    Slog.d(
        ...
        "sendReleaseSMIMECertificate() : accId = "
            ...
            + i2);
    Intent intent =
        new Intent("com.samsung.android.knox.intent.action.RELEASE_SMIME_CERTIFICATE_INTERNAL");
  ...
  public final boolean putPolicyState(int i, int i2, long j, boolean z, String str) {
    ...
    boolean putValues =
        this.mEdmStorageProvider.putValues("ExchangeAccountTable", contentValues, contentValues2);
    Slog.d(
        "ExchangeAccountPolicy",
        "putPolicyState: ret = "
            + putValues
  ...
  public final boolean getPolicyState(int i, long j, String str, int i2) {
    ...
    try {
      List<ContentValues> valuesList =
          this.mEdmStorageProvider.getValuesList("ExchangeAccountTable", strArr, contentValues);
  ...
  public final int getPolicyStateasInteger(int i, long j, String str, int i2, boolean z) {
    ...
    try {
      ...
      if (valuesList != null && !valuesList.isEmpty()) {
        ...
        Log.i(
            "ExchangeAccountPolicy",
            "getPolicyStateasInteger() : result = " + defaultValueStateInteger);
      }
  ...
  public void onPreAdminRemoval(int i) {
    ...
    List<ContentValues> valuesList =
        this.mEdmStorageProvider.getValuesList(
            "ExchangeAccountTable", new String[] {"AccountId", "ForceSmimeCert"}, contentValues);
    if (valuesList != null) {
      for (ContentValues contentValues2 : valuesList) {
  ...
  public boolean allowEmailSettingsChange(ContextInfo contextInfo, long j, boolean z) {
    ...
    Slog.d(
        "ExchangeAccountPolicy",
        "allowEmailSettingsChange() : = " + putPolicyState + " , accId  =" + j + " , allow  =" + z);
    return putPolicyState;
  }
  ...
  public boolean setMaxEmailBodyTruncationSize(ContextInfo contextInfo, int i, long j) {
    ...
    if (i < 0) {
      Log.i(
          "ExchangeAccountPolicy", "setMaxEmailBodyTruncationSize() : Error :: invalid parameter.");
      return false;
    }
  ...
  public long addNewAccount_new(ContextInfo contextInfo, ExchangeAccount exchangeAccount) {
    ...
    if (!SettingsUtils.isPackageInstalled(
            SettingsUtils.getEmailPackageName(callingOrCurrentUserId), i2)
        && !SettingsUtils.isPackageInstalled("com.samsung.android.focus", i2)) {
      Log.i(
          "ExchangeAccountPolicy",
          "addNewAccount() EX : Error :: Email and focus are not installed on user " + i2);
      return -1L;
    }
    if (true == z && true == z2) {
      Log.i(
          "ExchangeAccountPolicy",
          "addNewAccount_new : Error :: Invalid input parameters. 'emailNotificationVibrateAlways'"
              + " and 'emailNotificationVibrateWhenSilent' only one will be true at a time");
      return -1L;
    }
    if (SettingsUtils.getAccountId(
      ...
      try {
        ...
        long accountCertificatePassword =
            setAccountCertificatePassword(
                enforceExchangeAccountPermission, exchangeAccount.certificatePassword);
        Intent intent =
            new Intent("com.samsung.android.knox.intent.action.CREATE_EMAILACCOUNT_INTERNAL");
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.ACCOUNT_ID_INTERNAL", accountEmailPassword);
        ...
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.EXTRA_USER_NAME_INTERNAL", validStr4);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.USER_PASSWD_ID_INTERNAL", accountEmailPassword);
        intent.putExtra(
        ...
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.DOMAIN_INTERNAL", exchangeAccount.easDomain);
        intent.putExtra(
        ...
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.PEAK_DAYS_INTERNAL", exchangeAccount.peakDays);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.PEAK_INTERNAL", exchangeAccount.syncInterval);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.OFF_PEAK_INTERNAL", exchangeAccount.offPeak);
        intent.putExtra(
        ...
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.NOTIFY_INTERNAL", exchangeAccount.isNotify);
        intent.putExtra(
        ...
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.SIGNATURE_INTERNAL", exchangeAccount.signature);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.VIBRATE_WHEN_SILENT_INTERNAL",
            exchangeAccount.emailNotificationVibrateAlways ? false : true);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.EXTRA_VIBRATE_INTERNAL",
            exchangeAccount.emailNotificationVibrateAlways);
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.IS_DEFAULT_INTERNAL", exchangeAccount.isDefault);
        intent.putExtra(
        ...
        if (!TextUtils.isEmpty(exchangeAccount.certificateAlias)) {
          ...
          intent.putExtra(
              "com.samsung.android.knox.intent.extra.CERTIFICATE_ALIAS_INTERNAL", convertUcmUri);
          Log.i(
              "ExchangeAccountPolicy", "addNewAccount : alias has added, alias = " + convertUcmUri);
        }
        this.mContext.sendBroadcastAsUser(
            intent,
            new UserHandle(callingOrCurrentUserId),
  ...
  public String getAccountEmailPassword(ContextInfo contextInfo, long j) {
    ...
    String nameForUid =
        this.mContext.getPackageManager().getNameForUid(enforcePermissionByContext.mCallerUid);
    try {
      String str2 = "E#" + j;
  ...
  public boolean setForceSMIMECertificateAlias(
    ...
    Slog.d(
        "ExchangeAccountPolicy",
        "setForceSMIMECertificateAlias() : accId = " + j + ", alias = " + str3 + ", type = " + i);
    if (!TextUtils.isEmpty(str)) {
      Slog.d(
          "ExchangeAccountPolicy",
          "setForceSMIMECertificateAlias() : credential storage name = " + str);
    }
    ...
    if (!adminSatisfiesForceSMIMECertificateRules(
        enforceExchangeAccountPermission.mCallerUid, j, str3 != null, i == 0 ? 2 : 3)) {
      Log.i(
          "ExchangeAccountPolicy",
          "setForceSMIMECertificateAlias() : either a smime certificate has already been enforced"
              + " on this user by other admin or admin "
    ...
    try {
      if (str3 != null) {
        try {
          ...
          if (convertUcmUri == null) {
            Log.i(
                "ExchangeAccountPolicy",
                "setForceSMIMECertificateAlias() : storage name " + str + " does not exist!");
            return false;
          }
          str3 = convertUcmUri;
        } catch (Exception e) {
      ...
      long createIDforAccount = SettingsUtils.createIDforAccount();
      Intent intent =
          new Intent("com.samsung.android.knox.intent.action.ENFORCE_SMIME_ALIAS_INTERNAL");
      intent.putExtra("com.samsung.android.knox.intent.extra.ACCOUNT_ID", j);
      intent.putExtra(
          "com.samsung.android.knox.intent.extra.ENFORCE_SMIME_ALIAS_NAME_INTERNAL", str3);
      intent.putExtra("com.samsung.android.knox.intent.extra.ENFORCE_SMIME_ALIAS_TYPE", i);
      intent.putExtra(
          "com.samsung.android.knox.intent.extra.CERT_RESULT_ID_INTERNAL", createIDforAccount);
      if (!TextUtils.isEmpty(str)) {
        intent.putExtra(
            "com.samsung.android.knox.intent.extra.ENFORCE_SMIME_ALIAS_STORAGE_INTERNAL", str);
      }
      z =
          AccountsReceiver.pushSMIMECertificate(
              "S" + createIDforAccount,
              new AccountSMIMECertificate(enforceExchangeAccountPermission, str3, null, -1));
      if (z) {
        this.mContext.sendBroadcastAsUser(
            intent,
            new UserHandle(callingOrCurrentUserId),
  ...
  public final boolean adminSatisfiesForceSMIMECertificateRules(int i, long j, boolean z, int i2) {
    if (z) {
      ...
      ContentValues contentValues = new ContentValues();
      contentValues.put(
          EdmStorageProviderBase.getAdminLUIDWhereIn(0, UserHandle.getUserId(i)), "#SelectClause#");
      contentValues.put("AccountId", Long.valueOf(j));
      if (i2 == 3) {
      ...
      List values =
          this.mEdmStorageProvider.getValues("ExchangeAccountTable", strArr, contentValues);
      if (values != null
          && !values.isEmpty()
          && ((ContentValues) values.get(0)).getAsInteger("adminUid").intValue() != i) {
        return false;
      }
    } else {
      ContentValues contentValues2 = new ContentValues();
      ...
      List values2 =
          this.mEdmStorageProvider.getValues(
              ...
              new String[] {
                "ForceSmimeCert", "ForceSmimeCertForEncryption", "ForceSmimeCertForSigning"
              },
              contentValues2);
  ...
  public String getSMIMECertificateAlias(ContextInfo contextInfo, long j, int i) {
    ...
    Slog.d(
        "ExchangeAccountPolicy",
        "getSMIMECertificateAlias() : accId = "
            + j
            + ", type = "
            + i
            + ", ret = "
  ...
  public final int setForceSMIMECertificateInternal(
    ...
    if (str3 != null) {
      ...
      if (!adminSatisfiesForceSMIMECertificateRules(i3, j, true, i)) {
        Log.i(
            "ExchangeAccountPolicy",
            "setForceSMIMECertificateInternal() : a smime certificate has already been enforced on"
                + " this user");
        return 0;
      }
      synchronized (this) {
            ...
            boolean pushSMIMECertificate =
                AccountsReceiver.pushSMIMECertificate(
                    ...
                    new AccountSMIMECertificate(
                        ...
                        str,
                        str2,
                        SettingsUtils.getSMIMEModeFromAction(str3)));
            Log.i(
                "ExchangeAccountPolicy",
                "setForceSMIMECertificateInternal() : sendBroadcast success, accId = " + j);
  ...
  public final boolean setReleaseSMIMECertificateInternal(ContextInfo contextInfo, long j, int i) {
    ...
    if (!isValidEASAccountId(enforceExchangeAccountPermission, j)) {
      Log.i(
          "ExchangeAccountPolicy", "setReleaseSMIMECertificateInternal() : No exist accId : " + j);
      return false;
    }
    if (!adminSatisfiesForceSMIMECertificateRules(
        enforceExchangeAccountPermission.mCallerUid, j, false, i)) {
      Log.i(
          "ExchangeAccountPolicy",
    ...
    if (i == 1 || i == 2) {
      ...
      Log.i(
          "ExchangeAccountPolicy",
          "setReleaseSMIMECertificateInternal() : release SMIME Encryption = " + z);
    }
    if (i != 1 && i != 3) {
      return z;
    }
  ...
  public final boolean resetForcedSMIMECertificateInternal(
    ...
    if (i2 == 2) {
      ...
      Log.i(
          "ExchangeAccountPolicy",
          "resetForcedSMIMECertificateInternal() : failed. There is unsupport type requested : "
              + i2);
      return false;
    }
    ContentValues contentValues2 = new ContentValues();
    ...
    contentValues2.put("AccountId", Long.valueOf(j));
    return this.mEdmStorageProvider.update("ExchangeAccountTable", contentValues, contentValues2)
        > 0;
  }

  public final boolean isValidEASAccountId(ContextInfo contextInfo, long j) {
    return j > 0
        && EmailProviderHelper.getEnterpriseExchangeAccount(this.mContext, contextInfo, j) != null;
  }
  ...
  public final void sendSMIMEAliasResultIntent(long j, int i, int i2) {
    ...
    this.mContext.sendBroadcastAsUser(
        intent, UserHandle.ALL, "com.samsung.android.knox.permission.KNOX_EXCHANGE");
  }
