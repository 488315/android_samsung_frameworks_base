...
public class EmailPolicy extends IEmailPolicy.Stub implements EnterpriseServiceCallback {
  ...
  public BroadcastReceiver mUserRemovedReceiver =
      new BroadcastReceiver() { // from class: com.android.server.enterprise.email.EmailPolicy.1
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
          if ("android.intent.action.USER_REMOVED".equals(intent.getAction())) {
            EmailPolicy.this.onUserRemoved(
  ...
  public boolean allowAccountAddition(ContextInfo contextInfo, boolean z) {
    ...
    try {
      ...
      contentValues.put(
          "policyName", SettingsUtils.getEmailPackageName(enforceEmailPermission.mContainerId));
  ...
  public boolean isAccountAdditionAllowed(ContextInfo contextInfo) {
    ...
    try {
      ContentValues contentValues = new ContentValues();
      contentValues.put(
          EdmStorageProviderBase.getAdminLUIDWhereIn(i, callingOrCurrentUserId), "#SelectClause#");
      contentValues.put("policyName", SettingsUtils.getEmailPackageName(i));
      List blobList =
          this.mEdmStorageProvider.getBlobList("ADMIN_REF", "accountObject", contentValues);
      if (blobList != null) {
  ...
  public boolean getAllowHTMLEmail(ContextInfo contextInfo, String str) {
    ...
    Slog.d(
        "EmailPolicyService",
        "getAllowHTMLEmail() = " + policyState + " , emailAddress = " + getSecureAddress(str));
    return policyState;
  }
  ...
  public final boolean putPolicyState(int i, int i2, String str, boolean z, String str2) {
    ...
    boolean putValues =
        this.mEdmStorageProvider.putValues("EmailSettingsTable", contentValues, contentValues2);
  ...
  public final boolean getPolicyState(int i, String str, String str2, int i2) {
    ...
    try {
      List valuesList =
          this.mEdmStorageProvider.getValuesList("EmailSettingsTable", strArr, contentValues);
  ...
  public final boolean getDefaultValueState(String str) {
    if (str != null) {
      r2 =
          str.equals("EmailAllowForward")
              || str.equals("EmailAllowHTML")
              || str.equals("EmailAllowNotificationChange")
              || str.equals("EmailAllowSettingChange");
  ...
  public void systemReady() {
    SecContentProviderUtil.notifyPolicyChangesAllUser(
        this.mContext,
        Uri.parse("content://com.sec.knox.provider2/EmailPolicy/isEmailNotificationsEnabled"));
  }
  ...
  public boolean setEmailNotificationsState(ContextInfo contextInfo, boolean z, long j) {
    ...
    AccountMetaData accountDetails =
        SettingsUtils.getAccountDetails(enforceEmailPermission, j, this.mContext, false);
    ...
    Slog.d(
        "EmailPolicyService",
        "setEmailNotificationsState() = " + z2 + " , enable = " + z + " , accId = " + j);
    if (z2) {
      SecContentProviderUtil.notifyPolicyChangesAllUser(
          this.mContext,
          Uri.parse("content://com.sec.knox.provider2/EmailPolicy/isEmailNotificationsEnabled"));
  ...
  public boolean isEmailNotificationsEnabled(ContextInfo contextInfo, long j) {
    int i = contextInfo.mContainerId;
    AccountMetaData accountDetails =
        SettingsUtils.getAccountDetails(contextInfo, j, this.mContext, false);
    boolean z = true;
    if (accountDetails != null && getEDM() != null) {
      if (accountDetails.mIsEAS) {
        try {
  ...
  public boolean allowEmailSettingsChange(ContextInfo contextInfo, boolean z, long j) {
    ...
    Slog.d(
        "EmailPolicyService",
        "allowEmailSettingsChange() = " + z2 + " , allow = " + z + " , accId = " + j);
    return z2;
  }
  ...
  public final void registerUserRemovedReceiver() {
    ...
    this.mContext.registerReceiverAsUser(
        this.mUserRemovedReceiver, UserHandle.ALL, intentFilter, null, null);
  }
