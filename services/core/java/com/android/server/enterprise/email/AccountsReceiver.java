...
public final class AccountsReceiver {
    ...
    public final class SMIMEThread extends Thread {
        ...
        public final void run() {
            ...
            Log.i(
                    "AccountsReceiver",
                    "SMIME Certificate as Account Creation Time >>>>>>> "
                            + this.mAccId
                            + " , "
                            + i);
            int i2 = 0;
            try {
                ...
                if (asInterface != null) {
                    if (i == 1) {
                        i2 =
                                asInterface.setForceSMIMECertificate(
                        ...
                        i2 =
                                asInterface.setForceSMIMECertificateForSigning(
                                        contextInfo, this.mAccId, str, str2);
                    }
                }
                ...
                Log.e(
                        "AccountsReceiver",
                        "SMIMEThread : Failed talking with exchange account policy",
                        e);
            } catch (Exception e2) {
    ...
    public static void m505$$Nest$msendClientAuthResultIntent(
            AccountsReceiver accountsReceiver, long j, int i) {
        if (j < 0) {
        ...
        accountsReceiver.mContext.sendBroadcastAsUser(
    ...
    public static AccountSMIMECertificate getSMIMECertificate(String str) {
        try {
            ...
            AccountSMIMECertificate accountSMIMECertificate =
                    (AccountSMIMECertificate) ((HashMap) map).get(str);
