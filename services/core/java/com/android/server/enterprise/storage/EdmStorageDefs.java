...
public abstract class EdmStorageDefs {
  public static final Map sAppPackageNameControlMasks =
      Collections.unmodifiableMap(
          new HashMap() { // from class: com.android.server.enterprise.storage.EdmStorageDefs.1
            {
              ...
              put(
                  ...
                  "APP_PKGNAME_REVOCATION_CHECK_MASK");
              ...
              put(
                  ...
                  "APP_PKGNAME_UPDATE_BLOCKLIST_MASK");
  ...
  public static String[] FIREWALL_RULE_COLUMNS = {
    "id",
    "adminUid",
    "ipAddress",
    "portNumber",
