...
public abstract class EdmStorageDefs {
    public static final Map sAppPackageNameControlMasks =
            Collections.unmodifiableMap(
                    new HashMap() { // from class:
                                    // com.android.server.enterprise.storage.EdmStorageDefs.1
                        {
    ...
    public static final String[] FIREWALL_RULE_COLUMNS = {
        "id",
        "adminUid",
        "ipAddress",
        "portNumber",
