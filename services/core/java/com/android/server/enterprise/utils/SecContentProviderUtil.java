...
public abstract class SecContentProviderUtil {
  ...
  public static /* synthetic */ void lambda$notifyPolicyChangesAsUser$0(
      Context context, Uri uri, int i) {
    ...
    try {
      try {
        ...
        Log.e(
            ...
            "notifyPolicyChangesAsUser() : failed to notify. userId = " + i + ", uri = " + uri,
            e);
      }
    } finally {
