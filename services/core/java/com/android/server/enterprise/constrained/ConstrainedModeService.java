...
public class ConstrainedModeService extends ConstrainedModeInternal {
    ...
    public final void showConstrainedStateNotification(String str, String str2, String str3, String str4, boolean z) {
        ...
        if (z) {
            ...
            if (str2.equals("DEFAULT")) {
                ...
                builder.setStyle(new Notification.BigTextStyle().bigText(this.mContext.getString(R.string.font_family_menu_material)));
            } else {
    ...
    */
    public final void updateConstrainedStateData(boolean z) {
        ...
        try {
            try {
                ...
                int i6 = 0;
                int i7 = 1;
                List valuesList = this.mEdmStorageProvider.getValuesList("ConstrainedStateTable", new String[]{"adminUid", "status"}, null);
                            ...
                            if (file2.isFile()) {
                                ...
                                try {
                                    if (fileInputStream.read(bArr2) == 0) {
                                        ...
                                        String str8 = split.get(i6) != null ? new String((byte[]) split.get(i6), i6, ((byte[]) split.get(i6)).length) : null;
                                        if (str8 == null) {
                                            Log.d(str7, "something's wrong // type is null");
                                        } else {
                                            if (!str8.equals("normal") && !str8.equals("normalv2") && !str8.equals("normalv3")) {
                                            ...
                                            if (split.get(i7) == null || ((byte[]) split.get(i7)).length <= 0) {
                                                ...
                                                file = file2;
                                                i = i8;
                                                str4 = new String((byte[]) split.get(i7), 0, ((byte[]) split.get(i7)).length);
                                            }
                                            if (str4 != null) {
                                                if (split.get(2) != null) {
                                                    int i9 = length;
                                                    String str9 = new String((byte[]) split.get(2), 0, ((byte[]) split.get(2)).length);
                                                    byte[] bArr3 = (byte[]) split.get(3);
                                                    if (bArr3 != null) {
                                                        fileArr = listFiles;
                                                        i4 = ((bArr3[0] & 255) << 24) | ((bArr3[1] & 255) << 16) | ((bArr3[2] & 255) << 8) | (bArr3[3] & 255);
                                                    } else {
                                                        fileArr = listFiles;
                                                        i4 = 0;
                                                    }
                                                    if (i4 <= 0) {
                                                        ...
                                                        if (!str8.equals("normalv2") && !str8.equals("normalv3")) {
                                                            str5 = null;
                                                            bArr = null;
                                                            String str10 = !str8.equals("normalv3") ? new String((byte[]) split.get(6), 0, ((byte[]) split.get(6)).length) : null;
                                                            ...
                                                            if (valuesList != null && valuesList.size() > 0) {
                                                                ...
                                                                while (it.hasNext()) {
                                                                    ...
                                                                    str2 = str6;
                                                                    Iterator it2 = it;
                                                                    ComponentName componentName = new ComponentName("com.sds.mobile.mdm.client.MDMService", "com.sds.mobile.mdm.client.MDMService.ui.receiver.DeviceAdminPolicyReceiver");
                                                                    if (intValue == 1000 && devicePolicyManager != null && devicePolicyManager.isAdminActive(componentName)) {
                                                                        Log.d(str7, "Constrained mode is off - sds mdm was activated");
                                                                    } else if (packageNameForUid == null || !packageNameForUid.equals(str4)) {
                                                                        it = it2;
                                                                        str6 = str2;
                                                                    } else {
                                                        ...
                                                        str5 = split.get(4) != null ? new String((byte[]) split.get(4), 0, ((byte[]) split.get(4)).length) : null;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public boolean enableConstrainedState(int i, String str, String str2, String str3, String str4, int i2) {
        Throwable th;
        byte[] bArr;
