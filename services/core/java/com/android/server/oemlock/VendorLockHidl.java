...
public class VendorLockHidl extends OemLock {
  ...
  public String getLockName() {
    ...
    try {
      this.mOemLock.getName(
          new IOemLock
              .getNameCallback() { // from class:
                                   // com.android.server.oemlock.VendorLockHidl$$ExternalSyntheticLambda0
  ...
  public static /* synthetic */ void lambda$getLockName$0(
      Integer[] numArr, String[] strArr, int i, String str) {
  ...
  public boolean isOemUnlockAllowedByCarrier() {
    ...
    try {
      this.mOemLock.isOemUnlockAllowedByCarrier(
          new IOemLock
              .isOemUnlockAllowedByCarrierCallback() { // from class:
                                                       // com.android.server.oemlock.VendorLockHidl$$ExternalSyntheticLambda2
  ...
  public static /* synthetic */ void lambda$isOemUnlockAllowedByCarrier$1(
      Integer[] numArr, Boolean[] boolArr, int i, boolean z) {
    numArr[0] = Integer.valueOf(i);
  ...
  public boolean isOemUnlockAllowedByDevice() {
    ...
    try {
      this.mOemLock.isOemUnlockAllowedByDevice(
          new IOemLock
              .isOemUnlockAllowedByDeviceCallback() { // from class:
                                                      // com.android.server.oemlock.VendorLockHidl$$ExternalSyntheticLambda1
  ...
  public static /* synthetic */ void lambda$isOemUnlockAllowedByDevice$2(
      Integer[] numArr, Boolean[] boolArr, int i, boolean z) {
    numArr[0] = Integer.valueOf(i);
    boolArr[0] = Boolean.valueOf(z);
  }
