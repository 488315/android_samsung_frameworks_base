...
public class OemLockService extends SystemService {
  ...
  public OemLockService(Context context, OemLock oemLock) {
    ...
    UserManagerInternal.UserRestrictionsListener userRestrictionsListener =
        new UserManagerInternal
            .UserRestrictionsListener() { // from class: com.android.server.oemlock.OemLockService.1
    ...
    this.mService =
        new IOemLockService.Stub() { // from class: com.android.server.oemlock.OemLockService.2
            ...
            try {
              boolean z =
                  OemLockService.this.mOemLock.isOemUnlockAllowedByCarrier()
                      && OemLockService.this.mOemLock.isOemUnlockAllowedByDevice();
              OemLockService.this.setPersistentDataBlockOemUnlockAllowedBit(z);
              return z;
            } finally {
              Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public final void setPersistentDataBlockOemUnlockAllowedBit(boolean z) {
    ...
    if (persistentDataBlockManagerInternal == null
        || (this.mOemLock instanceof PersistentDataBlockLock)) {
      return;
    }
