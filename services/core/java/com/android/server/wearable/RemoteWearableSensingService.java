...
final class RemoteWearableSensingService extends ServiceConnector.Impl {
  ...
  public RemoteWearableSensingService(Context context, ComponentName componentName, int i) {
    super(
        ...
        new com.android.server.ambientcontext
            .RemoteWearableSensingService$$ExternalSyntheticLambda1());
    connect();
  }

  public void provideDataStream(
      final ParcelFileDescriptor parcelFileDescriptor, final RemoteCallback remoteCallback) {
    post(
        new ServiceConnector.VoidJob() { // from class:
          // com.android.server.wearable.RemoteWearableSensingService$$ExternalSyntheticLambda1
  ...
  public void provideData(
    ...
    post(
        new ServiceConnector.VoidJob() { // from class:
          // com.android.server.wearable.RemoteWearableSensingService$$ExternalSyntheticLambda0
          public final void runNoResult(Object obj) {
            ((IWearableSensingService) obj)
                .provideData(persistableBundle, sharedMemory, remoteCallback);
          }
        });
  }
}
