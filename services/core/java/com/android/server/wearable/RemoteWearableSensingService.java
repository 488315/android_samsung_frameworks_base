...
final class RemoteWearableSensingService extends ServiceConnector.Impl {
    ...
    public final class SecureWearableConnectionContext {
        ...
        public SecureWearableConnectionContext(
                ParcelFileDescriptor parcelFileDescriptor,
                WearableSensingManagerPerUserService.AnonymousClass3 anonymousClass3,
    ...
    public RemoteWearableSensingService(Context context, ComponentName componentName, int i) {
        super(
                ...
                67112960,
                i,
                new com.android.server.ambientcontext
                        .RemoteWearableSensingService$$ExternalSyntheticLambda0());
    ...
    public final void binderDied() {
        ...
        synchronized (this.mSecureConnectionLock) {
            try {
                SecureWearableConnectionContext secureWearableConnectionContext =
                        this.mNextSecureConnectionContext;
                if (secureWearableConnectionContext != null) {
                    ParcelFileDescriptor parcelFileDescriptor =
                            secureWearableConnectionContext.mSecureConnection;
                    WearableSensingManagerPerUserService.AnonymousClass3 anonymousClass3 =
                            secureWearableConnectionContext.mWearableSensingCallback;
                    ...
                    post(
                            new RemoteWearableSensingService$$ExternalSyntheticLambda0(
                                    parcelFileDescriptor, anonymousClass3, remoteCallback, 1));
                    this.mNextSecureConnectionContext = null;
                } else {
                    this.mSecureConnectionProvided = false;
                    Slog.w(
                            "RemoteWearableSensingService",
                            "Binder died but there is no secure wearable connection to provide.");
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final void provideSecureConnection(
            ParcelFileDescriptor parcelFileDescriptor,
            WearableSensingManagerPerUserService.AnonymousClass3 anonymousClass3,
            RemoteCallback remoteCallback) {
        ...
        synchronized (this.mSecureConnectionLock) {
            try {
                if (this.mNextSecureConnectionContext != null) {
                    Slog.i(
                            "RemoteWearableSensingService",
                            "A new wearable connection is provided before the process restart"
                                + " triggered by the previous connection is complete. Discarding"
                                + " the previous connection.");
                    if (Flags.enableProvideWearableConnectionApi()) {
                        WearableSensingManagerPerUserService.notifyStatusCallback(
                                7, this.mNextSecureConnectionContext.mStatusCallback);
                    }
                    this.mNextSecureConnectionContext =
                            new SecureWearableConnectionContext(
                                    parcelFileDescriptor, anonymousClass3, remoteCallback);
                    return;
                }
