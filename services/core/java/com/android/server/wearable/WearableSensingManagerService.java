...
public class WearableSensingManagerService extends AbstractMasterSystemService {
  ...
  public WearableSensingManagerService(Context context) {
    super(
        ...
        new FrameworkResourcesServiceNameResolver(
            context, R.string.default_audio_route_name_external_device),
        null,
        68);
  ...
  public void onServiceRemoved(
      WearableSensingManagerPerUserService wearableSensingManagerPerUserService, int i) {
  ...
  public final class WearableSensingManagerInternal extends IWearableSensingManager.Stub {
    ...
    public WearableSensingManagerInternal() {
      this.mService =
          (WearableSensingManagerPerUserService)
              WearableSensingManagerService.this.getServiceForUserLocked(
    ...
    public void provideDataStream(
      ...
      Slog.i(
          WearableSensingManagerService.TAG, "WearableSensingManagerInternal provideDataStream.");
      Objects.requireNonNull(parcelFileDescriptor);
      Objects.requireNonNull(remoteCallback);
      WearableSensingManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.MANAGE_WEARABLE_SENSING_SERVICE", WearableSensingManagerService.TAG);
