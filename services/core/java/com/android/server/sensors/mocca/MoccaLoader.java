...
public abstract class MoccaLoader {
    ...
    /* compiled from: qb/89523975 b19e8d3036bb0bb04c0b123e55579fdc5d41bbd9c06260ba21f1b25f8ce00bef */
    public final class InternalServiceBridge extends IInternalServiceBridge.Stub
        ...
        public final void onPointerEvent(MotionEvent motionEvent) {
            if (motionEvent.getAction() == 0) {
                synchronized (this.mListeners) {
                    try {
                        IInternalServiceBridgeListener iInternalServiceBridgeListener =
                                (IInternalServiceBridgeListener)
                                        ((HashMap) this.mListeners).get("touch");
        ...
        public final void setListener(
                String str, IInternalServiceBridgeListener iInternalServiceBridgeListener) {
            synchronized (this.mListeners) {
    ...
    public static IBinder getMoccaService(Context context) {
        Class<?> loadClass =
                context.createPackageContext("com.samsung.android.mocca", 3)
                        .getClassLoader()
                        .loadClass("com.samsung.android.mocca.MoccaSystemService");
        if (loadClass != null) {
    ...
    public static void systemReady(Context context, IBinder iBinder) {
        ...
        if (asInterface != null) {
            try {
                loadClass
                        .getDeclaredMethod("systemReady", IBinder.class)
                        .invoke(asInterface, sServiceBridge);
