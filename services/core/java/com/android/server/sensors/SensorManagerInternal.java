...
public abstract class SensorManagerInternal {
  ...
  public abstract void addProximityActiveListener(
      Executor executor, ProximityActiveListener proximityActiveListener);

  public abstract int createRuntimeSensor(
      int i,
      int i2,
      String str,
      String str2,
      ...
      int i4,
      int i5,
      RuntimeSensorCallback runtimeSensorCallback);
