...
public class SensorService extends SystemService {
  ...
  public static native int registerRuntimeSensorNative(
      ...
      int i4,
      int i5,
      SensorManagerInternal.RuntimeSensorCallback runtimeSensorCallback);

  /* JADX INFO: Access modifiers changed from: private */
  public static native boolean sendRuntimeSensorEventNative(
      long j, int i, int i2, long j2, float[] fArr);

  private static native long startSensorServiceNative(
      SensorManagerInternal.ProximityActiveListener proximityActiveListener);
  ...
  public SensorService(Context context) {
    ...
    synchronized (obj) {
      this.mSensorServiceStart =
          SystemServerInitThreadPool.submit(
              new Runnable() { // from class:
                               // com.android.server.sensors.SensorService$$ExternalSyntheticLambda0
  ...
  public void onBootPhase(int i) {
    if (i == 200) {
      ConcurrentUtils.waitForFutureNoInterrupt(
          this.mSensorServiceStart, START_NATIVE_SENSOR_SERVICE);
      synchronized (this.mLock) {
  ...
  public class LocalService extends SensorManagerInternal {
    ...
    public int createRuntimeSensor(
        int i,
        int i2,
        String str,
        String str2,
    ...
    @Override // com.android.server.sensors.SensorManagerInternal
    public void addProximityActiveListener(
        Executor executor, SensorManagerInternal.ProximityActiveListener proximityActiveListener) {
      Objects.requireNonNull(executor, "executor must not be null");
      Objects.requireNonNull(proximityActiveListener, "listener must not be null");
      ProximityListenerProxy proximityListenerProxy =
          new ProximityListenerProxy(executor, proximityActiveListener);
      synchronized (SensorService.this.mLock) {
  ...
  public class ProximityListenerProxy implements SensorManagerInternal.ProximityActiveListener {
    ...
    public void onProximityActive(final boolean z) {
      this.mExecutor.execute(
          new Runnable() { // from class:
                           // com.android.server.sensors.SensorService$ProximityListenerProxy$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public class ProximityListenerDelegate implements SensorManagerInternal.ProximityActiveListener {
    ...
    public void onProximityActive(boolean z) {
      ...
      synchronized (SensorService.this.mLock) {
        proximityListenerProxyArr =
            (ProximityListenerProxy[])
                SensorService.this
                    .mProximityListeners
                    .values()
                    .toArray(new ProximityListenerProxy[0]);
      }
