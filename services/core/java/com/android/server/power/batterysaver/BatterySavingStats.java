...
public class BatterySavingStats {
  ...
  public class Stat {
    ...
    public String toStringForTest() {
      return "{"
          + totalMinutes()
          + "m,"
          + this.totalBatteryDrain
          + ","
          + String.format("%.2f", Double.valueOf(drainPerHour()))
          + "uA/H,"
          + String.format("%.2f", Double.valueOf(drainPercentPerHour()))
          + "%}";
    }
  }
  ...
  public static String stateToString(int i) {
    ...
    return "BS="
        + BatterySaverState.fromIndex(i)
        + ",I="
        + InteractiveState.fromIndex(i)
        + ",D="
        + DozeState.fromIndex(i)
        + ",P="
        + PlugState.fromIndex(i);
  }
  ...
  public final void endLastStateLocked(long j, int i, int i2) {
    ...
    EventLogTags.writeBatterySavingStats(
        BatterySaverState.fromIndex(this.mCurrentState),
        InteractiveState.fromIndex(this.mCurrentState),
        DozeState.fromIndex(this.mCurrentState),
        j2,
        i4,
        i5,
    ...
    synchronized (this.mLock) {
      ...
      if (this.mLastBatterySaverEnabledTime > 0) {
        ...
        indentingPrintWriter.print(
            simpleDateFormat.format(
                new Date(
                    (currentTimeMillis - injectCurrentTime) + this.mLastBatterySaverEnabledTime)));
        indentingPrintWriter.print(" ");
        TimeUtils.formatDuration(
            this.mLastBatterySaverEnabledTime, injectCurrentTime, indentingPrintWriter);
      ...
      if (this.mLastBatterySaverDisabledTime > 0) {
        ...
        indentingPrintWriter.print(
            simpleDateFormat.format(
                new Date(
                    (currentTimeMillis - injectCurrentTime) + this.mLastBatterySaverDisabledTime)));
        indentingPrintWriter.print(" ");
        TimeUtils.formatDuration(
            this.mLastBatterySaverDisabledTime, injectCurrentTime, indentingPrintWriter);
        indentingPrintWriter.println();
      }
      ...
      if (this.mLastAdaptiveBatterySaverEnabledTime > 0) {
        ...
        indentingPrintWriter.print(
            simpleDateFormat.format(
                new Date(
                    (currentTimeMillis - injectCurrentTime)
                        + this.mLastAdaptiveBatterySaverEnabledTime)));
        indentingPrintWriter.print(" ");
        TimeUtils.formatDuration(
            this.mLastAdaptiveBatterySaverEnabledTime, injectCurrentTime, indentingPrintWriter);
        indentingPrintWriter.println();
      }
      if (this.mLastAdaptiveBatterySaverDisabledTime > 0) {
        ...
        indentingPrintWriter.print(
            simpleDateFormat.format(
                new Date(
                    (currentTimeMillis - injectCurrentTime)
                        + this.mLastAdaptiveBatterySaverDisabledTime)));
        indentingPrintWriter.print(" ");
        TimeUtils.formatDuration(
            this.mLastAdaptiveBatterySaverDisabledTime, injectCurrentTime, indentingPrintWriter);
        indentingPrintWriter.println();
      }
  ...
  public final void dumpLineLocked(
      IndentingPrintWriter indentingPrintWriter, int i, String str, int i2, String str2) {
    ...
    indentingPrintWriter.println(
        String.format(
            "%6dm %6dmAh(%3d%%) %8.1fmAh/h     %6dm %6dmAh(%3d%%) %8.1fmAh/h",
            Long.valueOf(stat.totalMinutes()),
            Integer.valueOf(stat.totalBatteryDrain / 1000),
            Integer.valueOf(stat.totalBatteryDrainPercent),
            Double.valueOf(stat.drainPerHour() / 1000.0d),
            Long.valueOf(stat2.totalMinutes()),
            Integer.valueOf(stat2.totalBatteryDrain / 1000),
            Integer.valueOf(stat2.totalBatteryDrainPercent),
            Double.valueOf(stat2.drainPerHour() / 1000.0d)));
  }
}
