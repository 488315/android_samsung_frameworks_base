...
public class BatterySaverStateMachine {
  ...
  public final ContentObserver mSettingsObserver =
      new ContentObserver(
          null) { // from class: com.android.server.power.batterysaver.BatterySaverStateMachine.1
  ...
  public final Runnable mThresholdChangeLogger =
      new Runnable() { // from class:
                       // com.android.server.power.batterysaver.BatterySaverStateMachine$$ExternalSyntheticLambda1
  ...
  public BatterySaverStateMachine(
    ...
    this.mBatterySaverStickyBehaviourDisabled =
        context.getResources().getBoolean(R.bool.config_automatic_brightness_available);
    this.mDynamicPowerSavingsDefaultDisableThreshold =
        context.getResources().getInteger(R.integer.config_jobSchedulerUserGracePeriod);
  }
  ...
  public void onBootCompleted() {
    runOnBgThread(
        new Runnable() { // from class:
                         // com.android.server.power.batterysaver.BatterySaverStateMachine$$ExternalSyntheticLambda4
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$onBootCompleted$0() {
    ...
    contentResolver.registerContentObserver(
        Settings.Global.getUriFor("low_power"), false, this.mSettingsObserver, 0);
    contentResolver.registerContentObserver(
        Settings.Global.getUriFor("low_power_sticky"), false, this.mSettingsObserver, 0);
    contentResolver.registerContentObserver(
        Settings.Global.getUriFor("low_power_trigger_level"), false, this.mSettingsObserver, 0);
    contentResolver.registerContentObserver(
        Settings.Global.getUriFor("automatic_power_save_mode"), false, this.mSettingsObserver, 0);
    contentResolver.registerContentObserver(
        Settings.Global.getUriFor("dynamic_power_savings_enabled"),
        false,
        this.mSettingsObserver,
        0);
    contentResolver.registerContentObserver(
        Settings.Global.getUriFor("dynamic_power_savings_disable_threshold"),
        false,
        this.mSettingsObserver,
        0);
    contentResolver.registerContentObserver(
        Settings.Global.getUriFor("low_power_sticky_auto_disable_enabled"),
        false,
        this.mSettingsObserver,
        0);
    contentResolver.registerContentObserver(
        Settings.Global.getUriFor("low_power_sticky_auto_disable_level"),
        false,
        this.mSettingsObserver,
        0);
    contentResolver.registerContentObserver(
        Settings.System.getUriFor("emergency_mode"), false, this.mSettingsObserver, 0);
    contentResolver.registerContentObserver(
        Settings.System.getUriFor("ultra_powersaving_mode"), false, this.mSettingsObserver, 0);
  ...
  public final void refreshSettingsLocked() {
    ...
    Slog.m72d(
        ...
        "[api] refreshSettingsLocked: lowPowerModeEnabled: "
            + z
            + " emergencyModeEnabled: "
            + this.mEmergencyModeEnabled
            + " ultraPowerSavingModeEnabled: "
            + this.mUltraPowerSavingModeEnabled
            + " lowPowerModeEnabledSticky: "
            + z2
            + " lowPowerModeTriggerLevel: "
            + globalSetting);
    setSettingsLocked(
        z || this.mEmergencyModeEnabled || this.mUltraPowerSavingModeEnabled,
        z2,
        globalSetting,
        z4,
        globalSetting4,
  ...
  public void setSettingsLocked(
      boolean z, boolean z2, int i, boolean z3, int i2, int i3, boolean z4, int i4) {
  ...
  public boolean setFullBatterySaverPolicy(BatterySaverPolicyConfig batterySaverPolicyConfig) {
    ...
    synchronized (this.mLock) {
      fullPolicyLocked =
          this.mBatterySaverController.setFullPolicyLocked(batterySaverPolicyConfig, 13);
    }
  ...
  public boolean setAdaptiveBatterySaverEnabled(boolean z) {
    ...
    synchronized (this.mLock) {
      ...
      adaptivePolicyEnabledLocked =
          this.mBatterySaverController.setAdaptivePolicyEnabledLocked(z, 11);
    }
  ...
  public boolean setAdaptiveBatterySaverPolicy(BatterySaverPolicyConfig batterySaverPolicyConfig) {
    ...
    synchronized (this.mLock) {
      this.mLastAdaptiveBatterySaverChangedExternallyElapsed = SystemClock.elapsedRealtime();
      adaptivePolicyLocked =
          this.mBatterySaverController.setAdaptivePolicyLocked(batterySaverPolicyConfig, 11);
    }
  ...
  public final void updateStateLocked(boolean z, boolean z2) {
    if (z || (this.mBootCompleted && this.mSettingsLoaded && this.mBatteryStatusSet)) {
      ...
      if (i == 1) {
        if (z) {
          if (!z2) {
            Slog.m74e("BatterySaverStateMachine", "Tried to disable BS when it's already OFF");
            return;
          }
      ...
      if (i == 2) {
        if (z) {
          if (z2) {
            Slog.m74e("BatterySaverStateMachine", "Tried to enable BS when it's already MANUAL_ON");
            return;
          } else {
      ...
      if (i == 3) {
        ...
        if (z) {
          if (z2) {
            Slog.m74e("BatterySaverStateMachine", "Tried to enable BS when it's already AUTO_ON");
            return;
          } else {
            enableBatterySaverLocked(false, true, 3);
            this.mState = 4;
      ...
      if (i == 4) {
        if (z) {
          if (!z2) {
            Slog.m74e(
                "BatterySaverStateMachine", "Tried to disable BS when it's already AUTO_SNOOZED");
            return;
          } else {
            enableBatterySaverLocked(true, true, 2);
            this.mState = 2;
      ...
      if (z) {
        Slog.m74e(
            "BatterySaverStateMachine", "Tried to manually change BS state from PENDING_STICKY_ON");
        return;
      }
      boolean z3 =
          this.mSettingBatterySaverStickyAutoDisableEnabled
              && this.mBatteryLevel >= this.mSettingBatterySaverStickyAutoDisableThreshold;
      if ((this.mBatterySaverStickyBehaviourDisabled || !this.mSettingBatterySaverEnabledSticky)
          || z3) {
        this.mState = 1;
  ...
  public void setBatterySaverEnabledManually(boolean z) {
    Slog.m72d("BatterySaverStateMachine", "setBatterySaverEnabledManually: enabled=" + z);
    synchronized (this.mLock) {
  ...
  public final void enableBatterySaverLocked(boolean z, boolean z2, int i, String str) {
    Slog.m72d(
        "BatterySaverStateMachine",
        "enableBatterySaver: enable=" + z + " manual=" + z2 + " reason=" + str + "(" + i + ")");
  ...
  public void triggerDynamicModeNotification() {
    runOnBgThread(
        new Runnable() { // from class:
                         // com.android.server.power.batterysaver.BatterySaverStateMachine$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$triggerDynamicModeNotification$2() {
    ...
    ensureNotificationChannelExists(
        notificationManager, "dynamic_mode_notification", R.string.ime_action_send);
    notificationManager.notifyAsUser(
        "BatterySaverStateMachine",
        1992,
        buildNotification(
            "dynamic_mode_notification",
            R.string.immersive_cling_description,
            R.string.imei,
  ...
  public void triggerStickyDisabledNotification() {
    runOnBgThread(
        new Runnable() { // from class:
                         // com.android.server.power.batterysaver.BatterySaverStateMachine$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$triggerStickyDisabledNotification$3() {
    ...
    notificationManager.notifyAsUser(
        ...
        buildNotification(
            "battery_saver_channel",
            R.string.config_defaultDisplayCompatHostActivity,
            R.string.config_defaultContextualSearchLegacyEnabled,
            "android.settings.BATTERY_SAVER_SETTINGS",
            STICKY_DISABLED_NOTIFY_TIMEOUT_MS),
        UserHandle.ALL);
  }

  public final void ensureNotificationChannelExists(
      NotificationManager notificationManager, String str, int i) {
    NotificationChannel notificationChannel =
        new NotificationChannel(str, this.mContext.getText(i), 3);
  ...
  public final Notification buildNotification(String str, int i, int i2, String str2, long j) {
    ...
    return new Notification.Builder(this.mContext, str)
        .setSmallIcon(R.drawable.ic_accessibility_magnification)
  ...
  public final void hideNotification(final int i) {
    runOnBgThread(
        new Runnable() { // from class:
                         // com.android.server.power.batterysaver.BatterySaverStateMachine$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$hideNotification$4(int i) {
    ((NotificationManager) this.mContext.getSystemService(NotificationManager.class))
        .cancelAsUser("BatterySaverStateMachine", i, UserHandle.ALL);
  }
  ...
  public void putGlobalSetting(String str, int i) {
    Slog.m72d(
        "BatterySaverStateMachine",
        "putGlobalSetting: " + str + XmlUtils.STRING_ARRAY_SEPARATOR + i);
    ...
    synchronized (this.mLock) {
      ...
      if (this.mBatterySaverController.isAdaptiveEnabled()) {
        ...
        indentingPrintWriter.print(
            this.mBatterySaverController.getBatterySaverPolicy().shouldAdvertiseIsEnabled());
        indentingPrintWriter.print(")");
      }
  ...
  public void dumpProto(ProtoOutputStream protoOutputStream, long j) {
    synchronized (this.mLock) {
      ...
      protoOutputStream.write(
          1112396529681L, this.mLastAdaptiveBatterySaverChangedExternallyElapsed);
