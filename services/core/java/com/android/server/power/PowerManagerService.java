...
public final class PowerManagerService extends SystemService implements Watchdog.Monitor {
    ...
    public final class Constants extends ContentObserver {
        ...
        public final void updateConstants() {
            synchronized (PowerManagerService.this.mLock) {
                ...
                Slog.m72d("PowerManagerService", "[api] updateConstants: NO_CACHED_WAKE_LOCKS: " + this.NO_CACHED_WAKE_LOCKS);
            }
        }
    ...
    public PowerManagerService(Context context, Injector injector) {
                ...
                synchronized (PowerManagerService.this.mLock) {
                    if (PowerManagerService.this.mProximityPositive) {
                        ...
                        if (PowerManagerService.this.mDefaultDisplayState != 2 && ((PowerGroup) PowerManagerService.this.mPowerGroups.get(0)).getWakefulnessLocked() == 1) {
                            Slog.m72d("PowerManagerService", "onProximityNegative: mDisplayDefaultReadyByProximity: false");
                        ...
                        if (PowerManagerUtil.SEC_FEATURE_FLIP_COVER_DISPLAY && PowerManagerService.this.mDualScreenPolicy == 1) {
                            Slog.m72d("PowerManagerService", "onProximityNegative() ignore DefaultDispalyReady cover screen");
            ...
            public void onDefaultDisplayStateChange(int i) {
                synchronized (PowerManagerService.this.mLock) {
                    ...
                    if (!PowerManagerService.this.mDefaultDisplayReadyByProximity && i == 2) {
                        Slog.m72d("PowerManagerService", "onDisplayStateChange: mDefaultDisplayReadyByProximity: true");
                        PowerManagerService.this.mDefaultDisplayReadyByProximity = true;
                    }
                    PowerManagerService.this.mDirty |= 8;
                    PowerManagerService.this.updatePowerStateLocked();
        ...
        this.mUserActivityStateListenerTimeoutRunnable = new Runnable() { // from class: com.android.server.power.PowerManagerService.5
            ...
            public void run() {
                synchronized (PowerManagerService.this.mLock) {
                    ...
                    Slog.m72d("PowerManagerService", "UserActivityStateListenerState: " + PowerManagerService.this.mLastUserActivityStateListenerState);
            ...
            public void onCoverAttachStateChanged(boolean z2) {
                if (PowerManagerService.this.mFeatureCoverSysfs) {
                    try {
                        ...
                        Slog.m72d("PowerManagerService", "onCoverAttachStateChanged: attach: " + z2 + "  mCoverType: " + PowerManagerService.this.mCoverType);
                    } catch (NullPointerException unused) {
                        Slog.m72d("PowerManagerService", "onCoverAttachStateChanged: mCoverManager returns NULL.");
                    }
                ...
                if (sContext.getType() == 46) {
                    ...
                    synchronized (powerManagerService3.mLock) {
                        if (elapsedRealtime - PowerManagerService.this.mPassedWakeupTime < 300) {
                            Slog.m72d("PowerManagerService", "WirelessChargerSContextListener : received move lately");
        ...
        float f2 = context.getResources().getFloat(R.dimen.config_pictureInPictureExpandedVerticalWidth);
        float f3 = context.getResources().getFloat(R.dimen.config_pictureInPictureExpandedHorizontalHeight);
        ...
        this.mScreenExtendedBrightnessMaximum = context.getResources().getInteger(R.integer.config_screenTimeoutOverride);
        if (f == -2.0f || f2 == -2.0f || f3 == -2.0f) {
            this.mScreenBrightnessMinimum = BrightnessSynchronizer.brightnessIntToFloat(context.getResources().getInteger(R.integer.config_screen_rotation_fade_out));
            this.mScreenBrightnessMaximum = BrightnessSynchronizer.brightnessIntToFloat(context.getResources().getInteger(R.integer.config_screen_rotation_fade_in_delay));
            this.mScreenBrightnessDefault = BrightnessSynchronizer.brightnessIntToFloat(context.getResources().getInteger(R.integer.config_screen_rotation_fade_in));
        } else {
        ...
        if (f4 == -2.0f) {
            this.mScreenBrightnessDoze = BrightnessSynchronizer.brightnessIntToFloat(context.getResources().getInteger(R.integer.config_screenBrightnessSettingMinimum));
        } else {
            this.mScreenBrightnessDoze = f4;
        }
        if (f5 == -2.0f) {
            this.mScreenBrightnessDim = BrightnessSynchronizer.brightnessIntToFloat(context.getResources().getInteger(R.integer.config_screenBrightnessSettingMaximum));
        } else {
        ...
        synchronized (this.mLock) {
            ...
            if (this.mContext.getPackageManager().hasSystemFeature("com.sec.feature.sensorhub")) {
                ...
                if (sContextManager != null) {
                    ...
                    Slog.m72d("PowerManagerService", "start : (mWirelessChargerSContextManager != null - mIsWirelessChargerSContextEnabled = " + this.mIsWirelessChargerSContextEnabled);
                }
            }
    ...
    public /* synthetic */ void lambda$systemReady$2(SemDesktopModeState semDesktopModeState) {
        synchronized (this.mLock) {
            ...
            Slog.m72d("PowerManagerService", "Dex display type: " + displayType + ", enabled: " + enabled + ", dual view: " + z + " -> " + this.mIsDualViewMode);
    ...
    public void readConfigurationLocked() {
        ...
        this.mAttentiveTimeoutConfig = resources.getInteger(R.integer.config_bg_current_drain_types_to_bg_restricted);
        this.mAttentiveWarningDurationConfig = resources.getInteger(R.integer.config_bg_current_drain_types_to_restricted_bucket);
        this.mDreamsSupportedConfig = resources.getBoolean(R.bool.config_disable_all_cb_messages);
        this.mDreamsEnabledByDefaultConfig = resources.getBoolean(R.bool.config_disableMenuKeyInLockScreen);
        this.mDreamsActivatedOnSleepByDefaultConfig = resources.getBoolean(R.bool.config_device_wfc_ims_available);
        this.mDreamsActivatedOnDockByDefaultConfig = resources.getBoolean(R.bool.config_device_vt_available);
        this.mDreamsEnabledOnBatteryConfig = resources.getBoolean(R.bool.config_disableTaskSnapshots);
        this.mDreamsBatteryLevelMinimumWhenPoweredConfig = resources.getInteger(R.integer.config_jobSchedulerInactivityIdleThreshold);
        this.mDreamsBatteryLevelMinimumWhenNotPoweredConfig = resources.getInteger(R.integer.config_jobSchedulerIdleWindowSlop);
        this.mDreamsBatteryLevelDrainCutoffConfig = resources.getInteger(R.integer.config_immersive_mode_confirmation_panic);
        this.mDreamsDisabledByAmbientModeSuppressionConfig = resources.getBoolean(R.bool.config_disableLockscreenByDefault);
        this.mDozeAfterScreenOff = resources.getBoolean(R.bool.config_defaultRingtonePickerEnabled);
        this.mMinimumScreenOffTimeoutConfig = resources.getInteger(R.integer.config_nightDisplayColorTemperatureMax);
        ...
        this.mScreenBrightnessForClearCoverConfig = BrightnessSynchronizer.brightnessIntToFloat(resources.getInteger(R.integer.config_screen_magnification_multi_tap_adjustment));
        this.mBrightnessLimitByCoverConfig = resources.getInteger(R.integer.config_datause_polling_period_sec);
    }
    ...
    public final void updateSettingsLocked() {
        ...
        if (z2 != z3 && z3) {
            ...
            Slog.m72d("PowerManagerService", "[api] updateSettingsLocked : Update OutdoorMode enabled time");
        }
    ...
    public final boolean isAcquireCausesWakeupFlagAllowed(String str, int i, int i2) {
        ...
        if (!CompatChanges.isChangeEnabled(216114297L, i) && !this.mPowerPropertiesWrapper.waive_target_sdk_check_for_turn_screen_on()) {
            Slog.m76i("PowerManagerService", "Allowing device wake-up without android.permission.TURN_SCREEN_ON for " + str);
            return true;
        }
        if (this.mPowerPropertiesWrapper.permissionless_turn_screen_on()) {
            Slog.m72d("PowerManagerService", "Device wake-up allowed by debug.power.permissionless_turn_screen_on");
            return true;
        }
    ...
    public final void applyWakeLockFlagsOnAcquireLocked(WakeLock wakeLock, boolean z) {
        ...
        if (PowerManagerUtil.SEC_FEATURE_FLIP_COVER_DISPLAY && i3 >= 10000 && this.mDualScreenPolicy == 1) {
            try {
                if (i3 != this.mContext.getPackageManager().getPackageUidAsUser("com.android.systemui", 0)) {
                    Slog.m73dk("PowerManagerService", "Screen__On : Cancel (not allow 3rd-party app on sub screen : " + str + ")");
                    return;
                }
        ...
        if (i3 >= 10000 && !z) {
            Slog.m72d("PowerManagerService", "Screen__On : Cancel (notifications are disabled : " + str + ")");
            return;
        }
        if (isWakeUpPreventionNeededForEdgeLightingLocked(wakeLock)) {
            Slog.m72d("PowerManagerService", "applyWakeLockFlagsOnAcquireLocked return by isWakeUpPreventionNeededForEdgeLighting");
            return;
        }
    ...
    public final void applyWakeLockFlagsOnReleaseLocked(WakeLock wakeLock) {
        ...
        Slog.m72d("PowerManagerService", "[api] applyWakeLockFlagsOnReleaseLocked : userActivityNoUpdateLocked is called : " + wakeLock);
    ...
    public final void userActivityInternal(int i, long j, int i2, int i3, int i4) {
        if ((i3 & 2) != 0) {
            ...
            Slog.m72d("PowerManagerService", "userActivityInternal PowerManager.USER_ACTIVITY_FLAG_INDIRECT : 2 (event: " + i2 + " flags: " + i3 + ") eventTime = " + j + ", mLastAndroidAutoBoostTime :" + this.mLastAndroidAutoBoostTime);
        ...
        try {
            ...
            if (i == 2 && j > this.mLastUserActivityStateListenerCalledTime) {
                ...
                if (this.mLastUserActivityStateListenerState == 0) {
                    ...
                    Slog.m72d("PowerManagerService", "UserActivityStateListenerState: " + this.mLastUserActivityStateListenerState);
            ...
            if (this.mUserInactiveOverrideFromWindowManager) {
                Slog.m72d("PowerManagerService", "userActivityNoUpdateLocked: mUserInactiveOverrideFromWindowManager : false");
    ...
    public final boolean isWakeUpPreventionNeededForEdgeLightingLocked(WakeLock wakeLock) {
        ...
        if (isGloballyInteractiveInternal()) {
            Slog.m72d("PowerManagerService", "isWakeUpPreventionNeededForEdgeLightingLocked - interactive");
            return false;
        }
        int i = wakeLock.mFlags & GnssNative.GNSS_AIDING_TYPE_ALL;
    ...
    */
    public final void wakePowerGroupLocked(final PowerGroup powerGroup, long j, int i, String str, final int i2, String str2, int i3, boolean z) {
        String str3;
        String str4;
        PowerManagerUtil.ScreenOnProfiler screenOnProfiler;
        String[] split;
        this.mLastWakeUpReason = i;
        if (this.mForceSuspendActive || !this.mSystemReady || j < powerGroup.getLastSleepTimeLocked() || powerGroup.getWakefulnessLocked() == 1) {
            return;
        }
        if (powerGroup.getGroupId() != 2 || this.mIsDualViewMode) {
            if (powerGroup.getGroupId() == 0 && i == 113 && this.mProximityPositive && !this.mInterceptedKeyForProximity) {
            ...
            if (i4 == 2 && !z) {
                if (i2 == 1000) {
                    ...
                    if (str.contains("::") && (split = str.split("::", 2)) != null && split.length == 2 && !split[1].isEmpty()) {
                        str3 = split[1];
                        ...
                        if (screenOnProfiler.isStarted() && !screenOnProfiler.mSaved) {
                            Slog.m72d("PowerManagerService", "detected fast on off , ignore " + (this.mScreenOnOffCount - 1) + " th ON profiler ");
                        }
    ...
    public final boolean dozePowerGroupLocked(final PowerGroup powerGroup, long j, final int i, final int i2) {
        ...
        Slog.m77ik("PowerManagerService", "Screen__Off(d) - " + this.mScreenOnOffCount + " : " + this.mScreenOffReason + " (" + PowerManager.sleepReasonToString(i) + ") groupId=" + powerGroup.getGroupId());
        this.mScreenOnReason = "";
        this.mScreenOffReason = "";
        ...
        if (screenOffProfiler.isStarted() && !screenOffProfiler.mSaved) {
            Slog.m72d("PowerManagerService", "detected fast on off , ignore " + (this.mScreenOnOffCount - 1) + " th OFF profiler ");
        }
        int uptimeMillis = (int) (this.mClock.uptimeMillis() - j);
    ...
    public final boolean sleepPowerGroupLocked(PowerGroup powerGroup, long j, int i, int i2) {
        ...
        Slog.m77ik("PowerManagerService", "Screen__Off(s) - " + this.mScreenOnOffCount + " : " + this.mScreenOffReason + " (" + PowerManager.sleepReasonToString(i) + ") groupId=" + powerGroup.getGroupId());
        this.mScreenOnReason = "";
        this.mScreenOffReason = "";
    ...
    public final void updateGlobalWakefulnessLocked(long j, int i, int i2, int i3, String str, String str2) {
        ...
        if (recalculateGlobalWakefulnessLocked == 0) {
            ...
            Slog.m76i("PowerManagerService", "Waking up from " + PowerManagerInternal.wakefulnessToString(globalWakefulnessLocked) + " (uid=" + i2 + ", reason=" + PowerManager.wakeReasonToString(i) + ", details=" + str2 + ")...");
            ...
            Slog.m76i("PowerManagerService", "Going to sleep due to " + PowerManager.sleepReasonToString(i) + " (uid " + i2 + ", screenOffTimeout=" + this.mScreenOffTimeoutSetting + ", activityTimeoutWM=" + this.mUserActivityTimeoutOverrideFromWindowManager + ", maxDimRatio=" + this.mMaximumScreenDimRatioConfig + ", maxDimDur=" + this.mMaximumScreenDimDurationConfig + ")...");
            this.mLastGlobalSleepTime = j;
            this.mLastGlobalSleepReason = i;
    ...
    public final void updateIsPoweredLocked(int i) {
        if ((i & 256) != 0) {
            ...
            if (z != this.mIsPowered || i2 != this.mPlugType) {
                Slog.m72d("PowerManagerService", "[api] updateIsPoweredLocked : mIsPowered: " + this.mIsPowered + " mPlugType: " + this.mPlugType);
                ...
                if (this.mIsWirelessChargerSContextEnabled && this.mWirelessChargerSContextManager.isAvailableService(46)) {
                    if (this.mPlugType == 4) {
                        if (!this.mIsWirelessChargerSContextRegistered) {
                            ...
                            Slog.m72d("PowerManagerService", "updateIsPoweredLocked : Device is not moved, skip wakeup when connect wireless chager ");
                            z2 = false;
                        }
                    } else if (i2 == 4) {
                        if (this.mIsDeviceMoving) {
                            if (this.mIsWirelessChargerSContextRegistered) {
                                Slog.m72d("PowerManagerService", "updateIsPoweredLocked : Unregister SContextListener");
                                this.mWirelessChargerSContextManager.unregisterListener(this.mWirelessChargerSContextListener, 46);
                                this.mIsWirelessChargerSContextRegistered = false;
                            }
                        } else if (!this.mIsPowered) {
                            Slog.m72d("PowerManagerService", "updateIsPoweredLocked : Device is not moved, skip wakeup when disconnect wireless charger");
        ...
        public void onAbuseWakeLockAdded(final List list) {
            ...
            PowerManagerService.this.mWakeLocks.stream().filter(new Predicate() { // from class: com.android.server.power.PowerManagerService$1$$ExternalSyntheticLambda2
                ...
                public final boolean test(Object obj) {
                    ...
                    lambda$onAbuseWakeLockAdded$0 = PowerManagerService.C23301.lambda$onAbuseWakeLockAdded$0(list, (PowerManagerService.WakeLock) obj);
                ...
                public final void accept(Object obj) {
                    PowerManagerService.C23301.this.lambda$onAbuseWakeLockAdded$1((PowerManagerService.WakeLock) obj);
                }
            });
            PowerManagerService powerManagerService = PowerManagerService.this;
        ...
        public void onAbuseWakeLockRemoved() {
            ...
            PowerManagerService.this.mWakeLocks.stream().filter(new Predicate() { // from class: com.android.server.power.PowerManagerService$1$$ExternalSyntheticLambda0
                ...
                public final boolean test(Object obj) {
                    ...
                    lambda$onAbuseWakeLockRemoved$2 = PowerManagerService.C23301.lambda$onAbuseWakeLockRemoved$2((PowerManagerService.WakeLock) obj);
                ...
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    PowerManagerService.C23301.this.lambda$onAbuseWakeLockRemoved$3((PowerManagerService.WakeLock) obj);
                }
            });
    ...
    */
    public final void updateUserActivitySummaryLocked(long j, int i) {
        ...
        while (i9 < this.mPowerGroups.size()) {
            ...
            if (powerGroup.getWakefulnessLocked() != 0) {
                ...
                z = z3;
                long lastUserActivityTimeNoChangeLightsLocked = powerGroup.getLastUserActivityTimeNoChangeLightsLocked();
                if (lastUserActivityTimeLocked >= powerGroup.getLastWakeTimeLocked()) {
                    ...
                    if (j8 < j11) {
                        j5 = j11;
                        i5 = 1;
                    } else if (j8 < j5 && lastUserActivityTimeLocked >= lastUserActivityTimeNoChangeLightsLocked) {
                        i5 = 2;
                    }
                    if (i5 == 0 && lastUserActivityTimeNoChangeLightsLocked >= powerGroup.getLastWakeTimeLocked()) {
                        j5 = lastUserActivityTimeNoChangeLightsLocked + j10;
                        if (j8 < j5) {
                            if (powerGroup.isPolicyBrightLocked()) {
                                i3 = groupId;
                                z2 = true;
                                powerGroup.setLastUserActivityTimeLocked(lastUserActivityTimeNoChangeLightsLocked, 1);
                                j5 -= j2;
                                i10 = 1;
                            } else {
                                i3 = groupId;
                            ...
                            if (i10 != 0) {
                                ...
                                if (this.mSmartStayEnabledSetting || powerGroup.getGroupId() != 0) {
                                    ...
                                    j7 = j9;
                                    i2 = i9;
                                    j9 = this.mSmartStayController.updateUserActivity(j, j6, i4, powerGroup.getWakeLockSummaryLocked());
                                }
                                z4 |= i4 == 0 ? z2 : false;
                                if (j7 != -1) {
            ...
            if (powerGroup.getUserActivitySummaryLocked() != i4) {
                ...
                Slog.m72d("PowerManagerService", "UserActivityState : " + powerGroup.getUserActivitySummaryLocked() + " -> " + i4 + " groupId=" + i11);
                if (i11 == 0) {
    ...
    public final long getScreenOffTimeoutLocked(long j, long j2) {
        ...
        if (j3 != this.mLastScreenTimeout) {
            Slog.m72d("PowerManagerService", "getScreenOffTimeoutLocked: " + this.mLastScreenTimeout + " -> " + j3);
            ...
            if (this.mPowerGroups.contains(i)) {
                ...
                if (powerGroup.isSandmanSummonedLocked() && powerGroup.isReadyLocked()) {
                    if (!canDreamLocked(powerGroup) && !canDozeLocked(powerGroup)) {
                        z = false;
                        Slog.m72d("PowerManagerService", "handleSandman : startDreaming: " + z + "  (canDreamLocked: " + canDreamLocked(powerGroup) + "  canDozeLocked: " + canDozeLocked(powerGroup) + ")  groupId=" + i);
                        ...
                        if (!powerGroup2.isSandmanSummonedLocked() && powerGroup2.getWakefulnessLocked() == wakefulnessLocked) {
                            ...
                            if (wakefulnessLocked == 2) {
                                if (z2 && canDreamLocked(powerGroup2)) {
                                    ...
                                    Slog.m76i("PowerManagerService", "Stopping dream because the battery appears to be draining faster than it is charging.  Battery level drained while dreaming: " + this.mDreamsBatteryLevelDrain + "%.  Battery level now: " + this.mBatteryLevel + "%.");
                                }
    ...
    public final void setScreenDimDurationOverrideFromWindowManagerInternal(long j) {
        synchronized (this.mLock) {
            if (this.mScreenDimDurationOverrideFromWindowManager != j) {
                Slog.m72d("PowerManagerService", "[api] setScreenDimDurationOverrideFromWindowManagerInternal: timeoutMillis: " + j);
    ...
    */
            ...
            while (i3 < powerManagerService.mPowerGroups.size()) {
                ...
                if (!powerManagerService.mBootCompleted) {
                    ...
                    if (!powerManagerService.mCoverAuthReady) {
                        ...
                        powerManagerService.mlastUpdateCoverStateReason = "isCoverClosedBySysfs called on closed = " + String.valueOf(powerManagerService.mIsCoverClosed);
                    }
                    if (powerManagerService.mCoverType == 8 && powerManagerService.mIsCoverClosed && !powerManagerService.mBatterySaverStateMachine.isUltraPowerSavingModeEnabled()) {
                        f = Float.isNaN(powerManagerService.mScreenBrightnessForClearCoverConfig) ? powerManagerService.mScreenBrightnessForClearCoverConfig : 1.0f;
                    }
                    if (groupId != 0 && powerManagerService.mLastAutoBrightnessLimitTime > powerManagerService.mDisplayManagerInternal.getLastUserSetScreenBrightnessTime()) {
                        displayPowerRequestLocked.autoBrightnessLowerLimit = BrightnessSynchronizer.brightnessIntToFloat(powerManagerService.mAutoBrightnessLowerLimit);
                        displayPowerRequestLocked.autoBrightnessUpperLimit = BrightnessSynchronizer.brightnessIntToFloat(powerManagerService.mAutoBrightnessUpperLimit);
                    ...
                    displayPowerRequestLocked.screenBrightnessScaleFactor = powerManagerService.mScreenBrightnessScaleFactor;
                    ...
                    if (!sensorBlockedByCoverLocked() && brightnessLimitByCoverLocked()) {
                        displayPowerRequestLocked.brightnessLimitByCover = powerManagerService.mBrightnessLimitByCoverConfig;
                    } else {
                    ...
                    if (z5 && powerGroup.isPoweringOnLocked() && (((i2 = displayPowerRequestLocked.policy) == 0 || i2 == z7) && powerManagerService.mClock.elapsedRealtime() - powerManagerService.mLastOutdoorModeEnabledTime > 900000)) {
                        displayPowerRequestLocked.isOutdoorMode = z8;
                        powerManagerService.mHandler.post(new Runnable() { // from class: com.android.server.power.PowerManagerService$$ExternalSyntheticLambda6
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    displayPowerRequestLocked.minBrightness = BrightnessSynchronizer.brightnessIntToFloat(powerManagerService.mMasterBrightnessLowerLimit);
                    displayPowerRequestLocked.maxBrightness = BrightnessSynchronizer.brightnessIntToFloat(powerManagerService.mMasterBrightnessUpperLimit);
                    if (PowerManagerUtil.SEC_FEATURE_SCREEN_CURTAIN && !PowerManagerUtil.SEC_FEATURE_SUPPORT_AOD && (screenCurtainController = powerManagerService.mScreenCurtainController) != null) {
                        displayPowerRequestLocked.screenCurtainEnabled = screenCurtainController.isScreenCurtainEnabledLocked();
                    }
                    boolean z9 = areAllPowerGroupsReadyLocked;
                    int i4 = i3;
                    updateLocked = powerGroup.updateLocked(f, shouldUseProximitySensorLocked(), shouldBoostScreenBrightness(), powerManagerService.mDozeScreenStateOverrideFromDreamManager, powerManagerService.mDozeScreenBrightnessOverrideFromDreamManagerFloat, powerManagerService.mDrawWakeLockOverrideFromSidekick, powerManagerService.mBatterySaverPolicy.getBatterySaverPolicy(7), sQuiescent, powerManagerService.mDozeAfterScreenOff, powerManagerService.mBootCompleted, powerManagerService.mScreenBrightnessBoostInProgress, powerManagerService.mRequestWaitForNegativeProximity, powerManagerService.mScreenDimDurationOverrideFromWindowManager, powerManagerService.mBatterySavingAdjustBrightnessFactor);
                    int wakefulnessLocked = powerGroup.getWakefulnessLocked();
                    if (updateLocked != powerGroup.isReadyLocked()) {
                        Slog.m72d("PowerManagerService", "displayReady: " + updateLocked + " groupId=" + groupId);
                    }
                    ...
                    if (!updateLocked && readyLocked && isPoweringOnLocked) {
                        ...
                        if (wakefulnessLocked == 1) {
                            ...
                            int uptimeMillis = (int) (powerManagerService.mClock.uptimeMillis() - powerGroup.getLastPowerOnTimeLocked());
                            if (uptimeMillis >= 200) {
    ...
    public final void setHalInteractiveModeLocked(boolean z) {
        ...
        if (z != this.mHalInteractiveModeEnabled || this.mForceSetHalInteractiveMode) {
            ...
            if (this.mForceSetHalInteractiveMode) {
                Slog.m72d("PowerManagerService", "setHalInteractiveModeLocked called by dual screen policy change");
            ...
            if (this.mSystemReady && i != -1) {
                ...
                if ((UserHandle.isApp(i2) || appId == 1001) && i3 != -1) {
                    ...
                    if (isInteractive != isInteractive2) {
                        Slog.m72d("PowerManagerService", "isInteractiveInternal(): uid=" + i2 + ", interactive=" + isInteractive + ", interactive(internal)=" + isInteractive2);
                    }
    ...
    public final boolean setLowPowerModeInternal(boolean z) {
        synchronized (this.mLock) {
            Slog.m72d("PowerManagerService", "setLowPowerModeInternal " + z + " mIsPowered=" + this.mIsPowered);
    ...
    public void setMaximumScreenOffTimeoutFromKnoxInternal(int i, long j) {
        ...
        synchronized (this.mLock) {
            ProfilePowerState profilePowerState = (ProfilePowerState) this.mProfilePowerState.get(i);
            if (profilePowerState != null) {
                Slog.m72d("PowerManagerService", "profile timeout changed : " + profilePowerState.mScreenOffTimeoutForUser + " -> " + j);
    ...
    */
    public final boolean setWakeLockDisabledStateLocked(WakeLock wakeLock) {
        ...
        if ((wakeLock.mFlags & GnssNative.GNSS_AIDING_TYPE_ALL) == 1) {
            ...
            if (appId >= 10000) {
                ...
                if (this.mDeviceIdleMode) {
                    ...
                    if (Arrays.binarySearch(this.mDeviceIdleWhitelist, appId) < 0 && Arrays.binarySearch(this.mDeviceIdleTempWhitelist, appId) < 0 && (i4 = uidState2.mProcState) != 20 && i4 > 5) {
                        i2 |= 2;
                        z = true;
                    }
                }
                if (this.mLowPowerStandbyActive) {
                    ...
                    if (Arrays.binarySearch(this.mLowPowerStandbyAllowlist, wakeLock.mOwnerUid) < 0 && (i3 = uidState3.mProcState) != 20 && i3 > 3) {
                        i2 |= 4;
                        z = true;
                    }
                }
            ...
            if (disabled && (65535 & wakeLock.mFlags) == 1) {
                long uptimeMillis = wakeLock.mNotifiedAcquired ? this.mClock.uptimeMillis() - wakeLock.mAcquireTime : 0L;
        ...
        return wakeLock.setDisabled(this.mConstants.NO_CACHED_WAKE_LOCKS && appId2 >= 10000 && !uidState4.mActive && (i = uidState4.mProcState) != 20 && i >= 12, 0);
    }
    ...
    public final void setScreenBrightnessOverrideFromWindowManagerInternal(float f) {
        synchronized (this.mLock) {
            if (!BrightnessSynchronizer.floatEquals(this.mScreenBrightnessOverrideFromWindowManager, f)) {
                Slog.m72d("PowerManagerService", "[api] setScreenBrightnessOverrideFromWindowManagerInternal: brightness: " + PowerManagerUtil.brightnessToString(f));
    ...
    public final void setUserActivityTimeoutOverrideFromWindowManagerInternal(long j) {
        synchronized (this.mLock) {
            if (this.mUserActivityTimeoutOverrideFromWindowManager != j) {
                Slog.m72d("PowerManagerService", "[api] setUserActivityTimeoutOverrideFromWindowManagerInternal: timeoutMillis: " + j);
    ...
    public final void setUserActivityTimeoutForDexOverrideFromWindowManagerInternal(long j) {
        synchronized (this.mLock) {
            if (this.mUserActivityTimeoutForDexOverrideFromWindowManager != j) {
                Slog.m72d("PowerManagerService", "[api] setUserActivityTimeoutForDexOverrideFromWindowManagerInternal: timeoutMillis: " + j);
    ...
    public final void setDrawWakeLockOverrideFromSidekickInternal(boolean z) {
        synchronized (this.mLock) {
            if (this.mDrawWakeLockOverrideFromSidekick != z) {
                Slog.m72d("PowerManagerService", "[api] setDrawWakeLockOverrideFromSidekickInternal()" + PowerManagerUtil.callerInfoToString());
    ...
    public final void setScreenDimDurationOverrideFromSqdInternal(boolean z) {
        synchronized (this.mLock) {
            if (!z) {
                ...
                Slog.m72d("PowerManagerService", "[api] setScreenDimDurationOverrideFromSqdInternal: enabled: " + this.mScreenDimDurationOverrideFromSQD + " = " + ((PowerGroup) this.mPowerGroups.get(0)).getLastUserActivityTimeLocked() + " + " + screenOffTimeoutLocked + " - " + uptimeMillis);
            }
            Slog.m72d("PowerManagerService", "[api] setScreenDimDurationOverrideFromSqdInternal: mScreenDimDurationOverrideFromSQD: " + this.mScreenDimDurationOverrideFromSQD);
            this.mDirty = this.mDirty | 32;
            updatePowerStateLocked();
        }
    }
    ...
    public static void lowLevelShutdown(String str) {
        Slog.m72d("PowerManagerService", "[api] lowLevelShutdown: " + PowerManagerUtil.callerInfoToString(true));
    ...
    public static void lowLevelReboot(String str) {
        Slog.m72d("PowerManagerService", "[api] lowLevelReboot: " + str + PowerManagerUtil.callerInfoToString(true));
        Slog.saveLogAsFile(true);
        if (str == null) {
            str = "";
        }
    ...
    final class UserSwitchedReceiver extends BroadcastReceiver {
        ...
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
            Slog.m72d("PowerManagerService", "[api] UserSwitchedReceiver: onReceive: UserHandle: " + ActivityManager.getCurrentUser() + " -> " + intent.getIntExtra("android.intent.extra.user_handle", 0));
            synchronized (PowerManagerService.this.mLock) {
                PowerManagerService powerManagerService = PowerManagerService.this;
    ...
    public final class DockReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            synchronized (PowerManagerService.this.mLock) {
                ...
                Slog.m72d("PowerManagerService", "[api] DockReceiver: onReceive: DockState: " + PowerManagerService.this.mDockState + " -> " + intExtra);
            ...
            if (call != null) {
                ...
                synchronized (this.mLock) {
                    if (parseInt != this.mScreenOffTimeoutForDex) {
                        Slog.m72d("PowerManagerService", "Dex screen off timeout : " + this.mScreenOffTimeoutForDex + " -> " + parseInt);
                        this.mScreenOffTimeoutForDex = parseInt;
                        this.mDirty = this.mDirty | 4;
                        updatePowerStateLocked();
                    }
                }
                Slog.m72d("PowerManagerService", "timeout for dex is " + string + " = " + this.mScreenOffTimeoutForDex);
            }
    ...
    public final void printWakeLockLocked() {
        ...
        if (!this.mSystemReady || powerGroup.isBrightOrDimLocked()) {
            Slog.m76i("PowerManagerService", "[PWL] On : " + TimeUtils.formatUptime(this.mLastGlobalWakeTime));
            Slog.m76i("PowerManagerService", "[PWL]  mStayOn: " + this.mStayOn + "  mWakeLockSummary & WAKE_LOCK_STAY_AWAKE: " + Integer.toHexString(this.mWakeLockSummary & 32) + "  mUserActivitySummary: 0x" + Integer.toHexString(userActivitySummaryLocked));
        ...
        Slog.m76i("PowerManagerService", "[PWL] Off : " + (timeSinceScreenWasLastOn() / 1000) + "s ago");
        Iterator it2 = this.mSuspendBlockers.iterator();
        while (it2.hasNext()) {
            ...
            if (suspendBlockerImpl.isHeld()) {
                ...
                if (suspendBlockerImpl.equals(this.mWakeLockSuspendBlocker)) {
                    if ((this.mWakeLockSummary & (-17)) != 0) {
                        Slog.m76i("PowerManagerService", "[PWL]     mWakeLockSummary : 0x" + Integer.toHexString(this.mWakeLockSummary));
                    ...
                    if (userActivitySummaryLocked != 0) {
                        Slog.m76i("PowerManagerService", "[PWL]     userActivitySummary : 0x" + Integer.toHexString(userActivitySummaryLocked));
                    }
                    if (displayPowerRequestLocked.policy != 0) {
                        Slog.m76i("PowerManagerService", "[PWL]     displayPowerRequest.policy : " + displayPowerRequestLocked.policy);
                    }
                    if (!isReadyLocked) {
    ...
    final class BinderService extends IPowerManager.Stub {
            ...
            if (PowerManagerService.this.mContext.checkCallingOrSelfPermission("android.permission.DEVICE_POWER") != 0 && PowerManagerService.this.mContext.checkCallingOrSelfPermission("android.permission.USER_ACTIVITY") != 0) {
                synchronized (PowerManagerService.this.mLock) {
                    if (uptimeMillis >= PowerManagerService.this.mLastWarningAboutUserActivityPermission + BackupAgentTimeoutParameters.DEFAULT_FULL_BACKUP_AGENT_TIMEOUT_MILLIS) {
                        ...
                        Slog.m79w("PowerManagerService", "Ignoring call to PowerManager.userActivity() because the caller does not have DEVICE_POWER or USER_ACTIVITY permission.  Please fix your app!   pid=" + Binder.getCallingPid() + " uid=" + Binder.getCallingUid());
                    }
                }
                return;
            }
        ...
        public void wakeUp(long j, int i, String str, String str2) {
            long uptimeMillis = PowerManagerService.this.mClock.uptimeMillis();
            if (j > uptimeMillis) {
                Slog.m74e("PowerManagerService", "Event time " + j + " cannot be newer than " + uptimeMillis);
                throw new IllegalArgumentException("event time must not be in the future");
            }
            Slog.m72d("PowerManagerService", "[api] wakeUp" + PowerManagerUtil.callerInfoToString() + " eventTime = " + j);
            PowerManagerService powerManagerService = PowerManagerService.this;
            StringBuilder sb = new StringBuilder();
            sb.append(" wakeUp: ");
        ...
        public void goToSleep(long j, int i, int i2) {
            Slog.m72d("PowerManagerService", "[api] goToSleep" + PowerManagerUtil.callerInfoToString() + " eventTime = " + j);
        ...
        public void goToSleepWithDisplayId(int i, long j, int i2, int i3) {
            IntArray wrap;
            Slog.m72d("PowerManagerService", "[api] goToSleepWithDisplayId" + PowerManagerUtil.callerInfoToString() + " for displayId = " + i + " eventTime = " + j);
            if (i == -1) {
        ...
        public void nap(long j) {
            ...
            Slog.m72d("PowerManagerService", "[api] nap" + PowerManagerUtil.callerInfoToString(true) + " eventTime = " + j);
            PowerManagerService.this.mContext.enforceCallingOrSelfPermission("android.permission.DEVICE_POWER", null);
            int callingUid = Binder.getCallingUid();
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
        ...
        public boolean areAutoPowerSaveModesEnabled() {
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
                return PowerManagerService.this.mContext.getResources().getBoolean(R.bool.config_dozeAlwaysOnDisplayAvailable);
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        }
        ...
        public boolean setPowerSaveModeEnabled(boolean z) {
            Slog.m72d("PowerManagerService", "[api] setPowerSaveModeEnabled: " + z + PowerManagerUtil.callerInfoToString(true));
        ...
        public void crash(String str) {
            Slog.m72d("PowerManagerService", "[api] crash: " + str + PowerManagerUtil.callerInfoToString(true));
            PowerManagerService.this.mContext.enforceCallingOrSelfPermission("android.permission.REBOOT", null);
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
        ...
        public void setStayOnSetting(int i) {
            Slog.m72d("PowerManagerService", "[api] setStayOnSetting: " + i + PowerManagerUtil.callerInfoToString(true));
            int callingUid = Binder.getCallingUid();
            if (callingUid != 0 && !Settings.checkAndNoteWriteSettingsOperation(PowerManagerService.this.mContext, callingUid, Settings.getPackageNameForUid(PowerManagerService.this.mContext, callingUid), null, true)) {
                Slog.m72d("PowerManagerService", "[api] setStayOnSetting: checkAndNoteWriteSettingsOperation() false");
                return;
            }
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
        ...
        public void setAttentionLight(boolean z, int i) {
            Slog.m72d("PowerManagerService", "[api] setAttentionLight: on: " + z + " color: " + i + PowerManagerUtil.callerInfoToString(true));
            PowerManagerService.this.mContext.enforceCallingOrSelfPermission("android.permission.DEVICE_POWER", null);
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
        ...
        public void setDozeAfterScreenOff(boolean z) {
            Slog.m72d("PowerManagerService", "[api] setDozeAfterScreenOff: " + z + PowerManagerUtil.callerInfoToString());
            PowerManagerService.this.mContext.enforceCallingOrSelfPermission("android.permission.DEVICE_POWER", null);
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
        ...
        public void boostScreenBrightness(long j) {
            long uptimeMillis = PowerManagerService.this.mClock.uptimeMillis();
            Slog.m72d("PowerManagerService", "[api] boostScreenBrightness: " + j + PowerManagerUtil.callerInfoToString(true));
        ...
        public void setAutoBrightnessLimit(int i, int i2, boolean z) {
            ...
            if (i < -1 || i2 < -1 || (i > i2 && i2 >= 0)) {
                Slog.m72d("PowerManagerService", "[api] setAutoBrightnessLimit : invalid Limits : " + i + ", " + i2 + PowerManagerUtil.callerInfoToString(true));
                return;
            }
            synchronized (PowerManagerService.this.mLock) {
                ...
                if (PowerManagerService.this.mAutoBrightnessLowerLimit != i || PowerManagerService.this.mAutoBrightnessUpperLimit != i2) {
                    Slog.m72d("PowerManagerService", "[api] setAutoBrightnessLimit : lowerLimit " + i + "   upperLimit : " + i2 + "   slowChange : " + z + PowerManagerUtil.callerInfoToString(true));
        ...
        public void setLCDFlashMode(boolean z, IBinder iBinder) {
            Slog.m72d("PowerManagerService", "[api] setLCDFlashMode: enable: " + z + PowerManagerUtil.callerInfoToString(true));
            PowerManagerService.this.mContext.enforceCallingOrSelfPermission("android.permission.DEVICE_POWER", null);
        ...
        public void setScreenBrightnessScaleFactor(float f, IBinder iBinder) {
            Slog.m72d("PowerManagerService", "[api] setScreenBrightnessScaleFactor: scaleFactor: " + f + PowerManagerUtil.callerInfoToString());
        ...
        public void setFreezingScreenBrightness(boolean z) {
            Slog.m72d("PowerManagerService", "[api] setFreezingScreenBrightness: freezing: " + z + PowerManagerUtil.callerInfoToString());
            PowerManagerService.this.mContext.enforceCallingOrSelfPermission("android.permission.DEVICE_POWER", null);
            synchronized (PowerManagerService.this.mLock) {
        ...
        public float getCurrentBrightness(boolean z) {
            Slog.m72d("PowerManagerService", "[api] getCurrentBrightness: ratio: " + z + PowerManagerUtil.callerInfoToString());
        ...
        public void setProximityDebounceTime(IBinder iBinder, int i, int i2) {
            Slog.m72d("PowerManagerService", "[api] setProximityDebounceTime: Positive = " + i + ", Negative = " + i2);
            if (iBinder == null) {
                throw new IllegalArgumentException("lock must not be null");
            }
            PowerManagerService.this.mContext.enforceCallingOrSelfPermission("android.permission.WAKE_LOCK", null);
        ...
        public void setScreenCurtainEnabled(IBinder iBinder, boolean z, int i) {
            Slog.m72d("PowerManagerService", "[api] setScreenCurtainEnabled: enable: " + z + " state: " + Display.stateToString(i) + " token: " + iBinder + PowerManagerUtil.callerInfoToString(true));
            PowerManagerService.this.mContext.enforceCallingOrSelfPermission("android.permission.DEVICE_POWER", null);
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
    ...
    final class LocalService extends PowerManagerInternal {
        ...
        public void setDozeOverrideFromDreamManager(int i, int i2) {
            Slog.m72d("PowerManagerService", "[api] setDozeOverrideFromDreamManager: screenState: " + Display.stateToString(i) + " screenBrightness: " + i2);
        ...
        public void setDozeOverrideFromDreamManager(int i, int i2, int i3, boolean z) {
            Slog.m72d("PowerManagerService", "[api] setDozeOverrideFromDreamManager: screenState: " + Display.stateToString(i) + " mode: 0x" + Integer.toHexString(i3) + " screenBrightness: " + i2 + " shouldWait: " + z);
        ...
        public void setUserInactiveOverrideFromWindowManager() {
            Slog.m72d("PowerManagerService", "[api] setUserInactiveOverrideFromWindowManager()" + PowerManagerUtil.callerInfoToString());
        ...
        public void setMaximumScreenOffTimeoutFromDeviceAdmin(int i, long j) {
            Slog.m72d("PowerManagerService", "[api] setMaximumScreenOffTimeoutFromDeviceAdmin: userId: " + i + " timeMs: " + j + PowerManagerUtil.callerInfoToString(true));
        ...
        public void setMaximumScreenOffTimeoutFromKnox(int i, long j) {
            Slog.m72d("PowerManagerService", "[api] setMaximumScreenOffTimeoutFromKnox: userId: " + i + " timeMs: " + j + PowerManagerUtil.callerInfoToString());
        ...
        public void updateProfileActivityTimeFromKnox(int i, long j) {
            Slog.m72d("PowerManagerService", "[api] updateProfileActivityTimeFromKnox: userId: " + i + " timeMs: " + j + PowerManagerUtil.callerInfoToString());
        ...
        public void registerLowPowerModeObserver(PowerManagerInternal.LowPowerModeListener lowPowerModeListener) {
            Slog.m72d("PowerManagerService", "[api] registerLowPowerModeObserver: " + lowPowerModeListener + PowerManagerUtil.callerInfoToString());
        ...
        public boolean setDeviceIdleMode(boolean z) {
            Slog.m72d("PowerManagerService", "[api] setDeviceIdleMode: " + z + PowerManagerUtil.callerInfoToString());
            return PowerManagerService.this.setDeviceIdleModeInternal(z);
        }

        public boolean setLightDeviceIdleMode(boolean z) {
            Slog.m72d("PowerManagerService", "[api] setLightDeviceIdleMode: " + z + PowerManagerUtil.callerInfoToString());
        ...
        public void setGoToSleepPrevention(boolean z) {
            Slog.m72d("PowerManagerService", "[api] setGoToSleepPrevention: enabled: " + z + PowerManagerUtil.callerInfoToString());
            PowerManagerService.this.setGoToSleepPreventionInternal(z);
        }

        public int setWakeLockEnableDisable(int i, boolean z) {
            synchronized (PowerManagerService.this.mLock) {
                Slog.m76i("PowerManagerService", "[PWL] SetWakeLockEnableDisable uid = " + i + " , disable= " + z);
                Iterator it = PowerManagerService.this.mWakeLocks.iterator();
                boolean z2 = false;
                while (it.hasNext()) {
                    WakeLock wakeLock = (WakeLock) it.next();
                    if (wakeLock.mOwnerUid == i && wakeLock.mDisabledByFreecess != z) {
                        ...
                        if (z2) {
                            Slog.m76i("PowerManagerService", "[PWL] find out: " + wakeLock + "  disabled -> " + z);
                        }
                    } else {
                        WorkSource workSource = wakeLock.mWorkSource;
                        if (workSource != null) {
                            ...
                            for (int i2 = 0; i2 < size; i2++) {
                                if (wakeLock.mWorkSource.get(i2) == i && wakeLock.mDisabled != z) {
                                    Slog.m76i("PowerManagerService", "[PWL] find out in ws: " + wakeLock + "  disabled -> " + z);
                                    return 2;
                                }
                            }
                        } else {
        ...
        public void setHbmBlock(boolean z) {
            Slog.m72d("PowerManagerService", "[api] setHbmBlock: enabled: " + z + PowerManagerUtil.callerInfoToString(true));
            PowerManagerService.this.setHbmBlockInternal(z);
        }

        public void setFreezeBrightnessMode(boolean z) {
            Slog.m72d("PowerManagerService", "[api] setFreezeBrightnessMode: enabled: " + z + PowerManagerUtil.callerInfoToString(true));
        ...
        public void registerUserActivityStateListener(PowerManagerInternal.UserActivityStateListener userActivityStateListener) {
            Slog.m72d("PowerManagerService", "registerUserActivityStateListener: " + userActivityStateListener);
        ...
        public void unregisterUserActivityStateListener(PowerManagerInternal.UserActivityStateListener userActivityStateListener) {
            Slog.m72d("PowerManagerService", "unregisterUserActivityStateListener: " + userActivityStateListener);
            if (userActivityStateListener == null) {
                throw new IllegalArgumentException("listener must not be null");
            }
    ...
    public final void setMasterBrightnessLimitInternal(int i, int i2, int i3) {
        synchronized (this.mLock) {
            ...
            Slog.m72d("PowerManagerService", "[api] setMasterBrightnessLimit : lowerLimit : " + i + "  upperLimit : " + i2 + "  mMasterBrightnessLimitPeriod : " + this.mMasterBrightnessLimitPeriod + PowerManagerUtil.callerInfoToString());
    ...
    */
    public final int getStartingLimitationOfBrightness() {
        ...
        int brightnessFloatToInt = brightnessInfo != null ? BrightnessSynchronizer.brightnessFloatToInt(brightnessInfo.adjustedBrightness) : -1;
                ...
                synchronized (PowerManagerService.this.mLock) {
                    if (PowerManagerUtil.SEC_FEATURE_DUAL_DISPLAY) {
                        ...
                        if (PowerManagerService.this.mDualScreenPolicy != i2) {
                            Slog.m72d("PowerManagerService", "onStateChanged: mDualScreenPolicy=" + PowerManagerService.this.mDualScreenPolicy);
