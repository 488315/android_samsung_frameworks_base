...
public final class AdaptiveScreenOffTimeoutController implements Observer {
    ...
    public final void addAdaptiveScreenOffTimeoutConfigLocked(List list) {
        ...
        while (it.hasNext()) {
            PowerManager.AdaptiveScreenOffTimeoutConfig adaptiveScreenOffTimeoutConfig =
                    (PowerManager.AdaptiveScreenOffTimeoutConfig) it.next();
            ...
            Slog.d(
                    "AdaptiveScreenOffTimeoutController",
                    "AdaptiveScreenOffTimeoutConfig: " + packageName + ":" + valueOf);
        ...
        PowerManagerService.this.mHandler.post(
                new PowerManagerService$2$$ExternalSyntheticLambda0(
                        anonymousClass1, !this.mAdaptiveScreenOffTimeoutMap.isEmpty()));
    }
    ...
    public final List getAdaptiveScreenOffTimeoutConfigLocked() {
        ...
        for (Map.Entry entry : this.mAdaptiveScreenOffTimeoutMap.entrySet()) {
            arrayList.add(
                    new PowerManager.AdaptiveScreenOffTimeoutConfig(
    ...
    public final void removeAdaptiveScreenOffTimeoutConfigLocked(List list) {
        ...
        while (it.hasNext()) {
            ...
            Slog.d(
                    "AdaptiveScreenOffTimeoutController",
                    "removeAdaptiveScreenOffTimeoutConfigLocked: " + str);
    ...
    public final void update(Observable observable, Object obj) {
        if (observable instanceof ForegroundPackageObserver) {
            ...
            long longValue =
                    this.mAdaptiveScreenOffTimeoutMap.containsKey(valueOf)
                            ? ((Long) this.mAdaptiveScreenOffTimeoutMap.get(valueOf)).longValue()
                            : -1L;
            if (longValue != this.mAdaptiveScreenOffTimeout) {
                ...
                sb.append(
                        longValue != -1
                                ? XmlUtils$$ExternalSyntheticOutline0.m("(", valueOf, ")")
                                : "");
