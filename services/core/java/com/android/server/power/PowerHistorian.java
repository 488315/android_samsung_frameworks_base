...
public final class PowerHistorian {
  ...
  public List getWakeUpRecords() {
    ...
    return new LinkedList(
        (List)
            ((RecordBuffer) this.mRecordCache.get(1))
                .getBuffer().stream()
                    .filter(
                        new Predicate() { // from class:
                                          // com.android.server.power.PowerHistorian$$ExternalSyntheticLambda0
                    ...
                    .map(
                        new Function() { // from class:
                                         // com.android.server.power.PowerHistorian$$ExternalSyntheticLambda1
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            return (PowerHistorian.WakeUpRecord)
                                cls.cast((PowerHistorian.Record) obj);
                          }
                        })
