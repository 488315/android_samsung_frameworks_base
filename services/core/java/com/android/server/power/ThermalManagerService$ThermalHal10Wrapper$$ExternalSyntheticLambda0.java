...
class ThermalManagerService$ThermalHal10Wrapper$$ExternalSyntheticLambda0
        implements IThermal.getCoolingDevicesCallback {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ boolean f$0;
    public final /* synthetic */ int f$1;
    public final /* synthetic */ List f$2;

    public /* synthetic */ ThermalManagerService$ThermalHal10Wrapper$$ExternalSyntheticLambda0(
            ...
            case 0:
                ...
                if (thermalStatus.code != 0) {
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m$1(
                            new StringBuilder("Couldn't get cooling device because of HAL error: "),
                ...
                if (thermalStatus.code != 0) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (!z2 || i2 == coolingDevice2.type) {
                            list2.add(
                                    new android.os.CoolingDevice(
                                            (long) coolingDevice2.currentValue,
                                            coolingDevice2.type,
                                            coolingDevice2.name));
                        }
                    }
