        ...
        public List getCurrentTemperatures(boolean z, int i) {
            ...
            synchronized (this.mHalLock) {
                ...
                try {
                    ...
                    android.util.Slog.e(ThermalHalWrapper.TAG, "Couldn't getCurrentTemperatures, reconnecting", e2);
                    connectToHal();
                }
        ...
        public List getTemperatureThresholds(boolean z, final int i) {
            ...
            synchronized (this.mHalLock) {
                ...
                try {
                    ...
                    android.util.Slog.e(ThermalHalWrapper.TAG, "Couldn't getTemperatureThresholds due to invalid status", e2);
                    return arrayList;
                }
            }
        }
            ...
            if (thermalStatus.code == 0) {
                ...
                while (it.hasNext()) {
                    ...
                    if (!z || i == coolingDevice.type) {
                        list.add(new CoolingDevice((long) coolingDevice.currentValue, coolingDevice.type, coolingDevice.name));
                    }
                }
                return;
            }
