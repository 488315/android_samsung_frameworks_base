...
public class CameraPowerCalculator extends PowerCalculator {
  ...
  public void calculate(
    ...
    int powerModel =
        PowerCalculator.getPowerModel(cameraEnergyConsumptionUC, batteryUsageStatsQuery);
    ...
    builder
        ...
        .setConsumedPower(3, calculatePower, powerModel);
    builder
  ...
  public void calculateApp(
    ...
    long calculateDuration =
        this.mPowerEstimator.calculateDuration(uid.getCameraTurnedOnTimer(), j, 0);
    if (powerModel == 2) {
      calculatePower = PowerCalculator.uCtoMah(cameraEnergyConsumptionUC);
    } else {
    ...
    builder
        .setUsageDurationMillis(3, calculateDuration)
        .setConsumedPower(3, calculatePower, powerModel);
  }
}
