...
public class AudioPowerCalculator extends PowerCalculator {
  ...
  public void calculate(
    ...
    builder
        ...
        .setUsageDurationMillis(4, powerAndDuration.durationMs)
        .setConsumedPower(4, powerAndDuration.powerMah);
    builder
  ...
  public final void calculateApp(
    ...
    long calculateDuration =
        this.mPowerEstimator.calculateDuration(uid.getAudioTurnedOnTimer(), j, 0);
