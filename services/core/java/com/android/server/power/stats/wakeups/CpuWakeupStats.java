    ...
    */
    public final synchronized void lambda$noteWakeupTimeAndReason$1(Wakeup wakeup) {
        ...
        if (ArrayUtils.isEmpty(wakeup.mDevices)) {
            FrameworkStatsLog.write(FrameworkStatsLog.KERNEL_WAKEUP_ATTRIBUTED, 0, 0, (int[]) null, wakeup.mElapsedMillis, (int[]) null);
        ...
        for (int i = 0; i < sparseArray.size(); i++) {
            ...
            if (sparseIntArray != null && sparseIntArray.size() != 0) {
                ...
                iArr2 = iArr3;
                FrameworkStatsLog.write(FrameworkStatsLog.KERNEL_WAKEUP_ATTRIBUTED, typeToStatsType(wakeup.mType), subsystemToStatsReason(keyAt), iArr, wakeup.mElapsedMillis, iArr2);
