...
public final class BatteryUsageStatsProvider {
    ...
    public final BatteryUsageStats getBatteryUsageStats(
        ...
        if (batteryUsageStatsQuery.getToTimestamp() != 0) {
            ...
            boolean z4 =
                    (batteryUsageStatsQuery.getFlags() & 8) != 0
                            && batteryStatsImpl.isProcessStateDataAvailable();
            double minConsumedPowerThreshold =
                    batteryUsageStatsQuery.getMinConsumedPowerThreshold();
            String[] customEnergyConsumerNames = batteryStatsImpl.getCustomEnergyConsumerNames();
            BatteryUsageStats.Builder builder4 =
                    new BatteryUsageStats.Builder(
                            customEnergyConsumerNames,
                            z3,
                            z4,
                            batteryUsageStatsQuery.isScreenStateDataNeeded(),
                            batteryUsageStatsQuery.isPowerStateDataNeeded(),
            ...
            for (PowerStatsSpan.Metadata metadata : powerStatsStore.getTableOfContents()) {
                if (((ArrayList) metadata.mSections).contains("battery-usage-stats")) {
                    ...
                    boolean z5 = z4;
                    if ((batteryUsageStatsQuery.getFromTimestamp() == 0
                                    || j7 > batteryUsageStatsQuery.getFromTimestamp())
                            && (batteryUsageStatsQuery.getToTimestamp() == 0
                                    || j8 <= batteryUsageStatsQuery.getToTimestamp())) {
                        PowerStatsSpan loadPowerStatsSpan =
                                powerStatsStore.loadPowerStatsSpan(
                                        metadata.mId, "battery-usage-stats");
                        if (loadPowerStatsSpan != null) {
                            Iterator it2 = ((ArrayList) loadPowerStatsSpan.mSections).iterator();
                            while (it2.hasNext()) {
                                BatteryUsageStats batteryUsageStats =
                                        ((BatteryUsageStatsSection)
                                                        ((PowerStatsSpan.Section) it2.next()))
                                                .mBatteryUsageStats;
                                if (!Arrays.equals(
                                        batteryUsageStats.getCustomPowerComponentNames(),
                                        customEnergyConsumerNames)) {
                                    Log.w(
                                            "BatteryUsageStatsProv",
                                            "Ignoring older BatteryUsageStats snapshot, which has"
                                                + " different custom power components: "
                                                    + Arrays.toString(
                                                            batteryUsageStats
                                                                    .getCustomPowerComponentNames()));
                                    ...
                                    Log.w(
                                            "BatteryUsageStatsProv",
                                            "Ignoring older BatteryUsageStats snapshot, which  does"
                                                + " not include process state data");
                                }
                            }
                        }
                    }
        ...
        synchronized (batteryStatsImpl) {
            try {
                ...
                BatteryUsageStats.Builder builder7 =
                        new BatteryUsageStats.Builder(
                                batteryStatsImpl.getCustomEnergyConsumerNames(),
                                z6,
                                z7,
                                batteryUsageStatsQuery.isScreenStateDataNeeded(),
                                batteryUsageStatsQuery.isPowerStateDataNeeded(),
                                minConsumedPowerThreshold2);
                ...
                while (size >= 0) {
                    ...
                    if (z8 || uid2.getUid() != 1090) {
                        z2 = z8;
                        UidBatteryConsumer.Builder timeInProcessStateMs =
                                builder7.getOrCreateUidBatteryConsumerBuilder(uid2)
                                        .setTimeInProcessStateMs(
                                                2,
                                                uid2.getProcessStateTime(3, elapsedRealtime, 0)
                                                        / 1000);
                        BatteryUsageStats.Builder builder8 = builder7;
                        long processStateTime = uid2.getProcessStateTime(0, elapsedRealtime, 0);
                        BatteryStats.Timer foregroundActivityTimer =
                                uid2.getForegroundActivityTimer();
                        if (foregroundActivityTimer != null) {
                            builder3 = builder8;
                            long totalTimeLocked =
                                    foregroundActivityTimer.getTotalTimeLocked(elapsedRealtime, 0);
                            uid = uid2;
                            j6 = totalTimeLocked;
                        } else {
                            builder3 = builder8;
                        ...
                        timeInProcessStateMs
                                .setTimeInProcessStateMs(
                                        1,
                                        (uid3.getProcessStateTime(2, elapsedRealtime, 0)
                                                        + Math.min(processStateTime, j6))
                                                / 1000)
                                .setTimeInProcessStateMs(
                                        3, uid3.getProcessStateTime(1, elapsedRealtime, 0) / 1000);
                    } else {
                        z2 = z8;
                        builder3 = builder7;
                    }
        ...
        if (this.mPowerStatsExporterEnabled.indexOfValue(true) >= 0) {
            ...
            synchronized (powerStatsExporter) {
                try {
                    ...
                    boolean z9 = false;
                    while (size3 >= 0) {
                        PowerStatsSpan.Metadata metadata2 =
                                (PowerStatsSpan.Metadata) tableOfContents.get(size3);
                        if (((ArrayList) metadata2.mSections).contains("aggregated-power-stats")) {
                            ...
                            while (true) {
                                ...
                                PowerStatsSpan.TimeFrame timeFrame2 =
                                        (PowerStatsSpan.TimeFrame) arrayList.get(i6);
                                int i7 = size3;
                                boolean z10 = z9;
                            ...
                            if (j13 >= j2 && j12 < j3) {
                                ...
                                PowerStatsSpan loadPowerStatsSpan2 =
                                        powerStatsExporter.mPowerStatsStore.loadPowerStatsSpan(
                                                metadata4.mId, "aggregated-power-stats");
                                if (loadPowerStatsSpan2 == null) {
                                    Slog.e(
                                            "PowerStatsExporter",
                                            "Could not read PowerStatsStore section " + metadata4);
                                } else {
                                    ...
                                    while (true) {
                                        ...
                                        if (i8 < arrayList2.size()) {
                                            PowerStatsExporter.populateBatteryUsageStatsBuilder(
                                                    builder,
                                                    ((AggregatedPowerStatsSection)
                                                                    ((PowerStatsSpan.Section)
                                                                            arrayList2.get(i8)))
                                                            .mAggregatedPowerStats);
                                            i8++;
                                            z9 = true;
                                        }
                                    }
                    ...
                    if (!z9 || j11 < j3 - powerStatsExporter.mBatterySessionTimeSpanSlackMillis) {
                        powerStatsExporter.mPowerStatsAggregator.aggregatePowerStats(
                                j11,
                                j3,
                                new Consumer() { // from class:
                                                 // com.android.server.power.stats.PowerStatsExporter$$ExternalSyntheticLambda0
                                    @Override // java.util.function.Consumer
                                    public final void accept(Object obj) {
                                        PowerStatsExporter.this.getClass();
                                        PowerStatsExporter.populateBatteryUsageStatsBuilder(
                                                builder, (AggregatedPowerStats) obj);
                                    }
                                });
                    }
                    PowerStatsAggregator powerStatsAggregator =
                            powerStatsExporter.mPowerStatsAggregator;
            ...
            while (true) {
                ...
                while (i10 < i9) {
                    ...
                    double consumedPower =
                            uidBatteryConsumer.getConsumedPower(uidBatteryConsumer.getKey(i11));
                    double d = 0.0d;
                    int i12 = 0;
                    while (i12 < i9) {
                        d +=
                                uidBatteryConsumer.getConsumedPower(
                                        uidBatteryConsumer.getKey(i11, iArr2[i12]));
                        i12++;
                        i9 = 4;
                    }
                    if (d > 2.0d + consumedPower) {
                        String str =
                                "Sum of states exceeds total. UID = "
                                        + uidBatteryConsumer.getUid()
                                        + " "
                                        + BatteryConsumer.powerComponentIdToString(i11)
                                        + " total = "
                                        + consumedPower
                                        + " states = "
                                        + d;
            ...
            try {
                if (this.mPowerCalculators == null) {
                    ...
                    if (!this.mPowerStatsExporterEnabled.get(1)) {
                        this.mPowerCalculators.add(
                                new CpuPowerCalculator(
                                        this.mCpuScalingPolicies, this.mPowerProfile));
                    }
                    ...
                    if (!BatteryStats.checkWifiOnly(this.mContext)) {
                        if (!this.mPowerStatsExporterEnabled.get(8)) {
                            this.mPowerCalculators.add(
                                    new MobileRadioPowerCalculator(this.mPowerProfile));
                        }
                        if (!this.mPowerStatsExporterEnabled.get(14)) {
                            this.mPowerCalculators.add(
                                    new PhonePowerCalculator(this.mPowerProfile));
                        }
                    }
                    ...
                    if (!this.mPowerStatsExporterEnabled.get(2)) {
                        this.mPowerCalculators.add(
                                new BluetoothPowerCalculator(this.mPowerProfile));
                    }
                    this.mPowerCalculators.add(
                            new SensorPowerCalculator(
                                    (SensorManager)
                                            this.mContext.getSystemService(SensorManager.class)));
                    ...
                    if (!this.mPowerStatsExporterEnabled.get(6)) {
                        this.mPowerCalculators.add(
                                new FlashlightPowerCalculator(this.mPowerProfile));
                    }
                    ...
                    this.mPowerCalculators.add(
                            new AmbientDisplayPowerCalculator(this.mPowerProfile));
                    ...
                    if (!Flags.disableSystemServicePowerAttr()) {
                        this.mPowerCalculators.add(
                                new SystemServicePowerCalculator(
                                        this.mCpuScalingPolicies, this.mPowerProfile));
                    }
                }
            } catch (Throwable th) {
