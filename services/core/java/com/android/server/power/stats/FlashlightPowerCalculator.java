...
public class FlashlightPowerCalculator extends PowerCalculator {
  ...
  public void calculate(
    ...
    builder
        ...
        .setConsumedPower(6, calculatePower);
    builder
  ...
  public void calculateApp(
    ...
    long calculateDuration =
        this.mPowerEstimator.calculateDuration(uid.getFlashlightTurnedOnTimer(), j, 0);
    builder
        .setUsageDurationMillis(6, calculateDuration)
        .setConsumedPower(6, this.mPowerEstimator.calculatePower(calculateDuration));
  }
}
