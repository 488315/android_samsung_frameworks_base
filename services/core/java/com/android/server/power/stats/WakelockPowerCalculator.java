...
public class WakelockPowerCalculator extends PowerCalculator {
  ...
  public void calculate(
    ...
    for (int size = uidBatteryConsumerBuilders.size() - 1; size >= 0; size--) {
      ...
      builder3
          .setUsageDurationMillis(12, powerAndDuration.durationMs)
          .setConsumedPower(12, powerAndDuration.powerMah);
    ...
    builder
        ...
        .setUsageDurationMillis(i2, calculateWakeTimeMillis)
        .setConsumedPower(i2, d6 + d5);
    builder
        .getAggregateBatteryConsumerBuilder(1)
        .setUsageDurationMillis(i2, j7)
        .setConsumedPower(i2, d5);
  }

  public final void calculateApp(
      PowerAndDuration powerAndDuration, BatteryStats.Uid uid, long j, int i) {
