...
public class VideoPowerCalculator extends PowerCalculator {
  ...
  public void calculate(
    ...
    builder
        ...
        .setUsageDurationMillis(5, powerAndDuration.durationMs)
        .setConsumedPower(5, powerAndDuration.powerMah);
    builder
  ...
  public final void calculateApp(
    ...
    long calculateDuration =
        this.mPowerEstimator.calculateDuration(uid.getVideoTurnedOnTimer(), j, 0);
