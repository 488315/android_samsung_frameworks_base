...
public class IdlePowerCalculator extends PowerCalculator {
  ...
  public void calculate(
    ...
    if (this.mPowerMah != 0.0d) {
      builder
          ...
          .setConsumedPower(16, this.mPowerMah)
          .setUsageDurationMillis(16, this.mDurationMs);
    }
  }
  ...
  public final void calculatePowerAndDuration(BatteryStats batteryStats, long j, long j2, int i) {
    ...
    this.mPowerMah =
        (computeBatteryRealtime * this.mAveragePowerCpuSuspendMahPerUs)
            + (batteryStats.computeBatteryUptime(j2, i) * this.mAveragePowerCpuIdleMahPerUs);
