...
public class WirelessChargerDetector {
  ...
  public final SensorEventListener mListener =
      new SensorEventListener() { // from class: com.android.server.power.WirelessChargerDetector.1
  ...
  public final Runnable mSensorTimeout =
  ...
  public void dump(PrintWriter printWriter) {
    synchronized (this.mLock) {
      ...
      printWriter.println(
          "  mRestX=" + this.mRestX + ", mRestY=" + this.mRestY + ", mRestZ=" + this.mRestZ);
        ...
        if (this.mTotalSamples < 3) {
          android.util.Slog.w(
              ...
              "Wireless charger detector is broken.  Only received "
                  + this.mTotalSamples
                  + " samples from the gravity sensor but we need at least 3 and we expect to see"
                  + " about 16 on average.");
