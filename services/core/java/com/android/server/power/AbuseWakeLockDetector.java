...
public class AbuseWakeLockDetector {
  ...
  public AbuseWakeLockDetector(
      Object obj, Context context, Callback callback, WindowManagerService windowManagerService) {
                ...
                arrayList.stream()
                    .filter(
                        new Predicate() { // from class:
                                          // com.android.server.power.AbuseWakeLockDetector$$ExternalSyntheticLambda0
                          @Override // java.util.function.Predicate
                          public final boolean test(Object obj) {
                            boolean isScreenLock;
                            isScreenLock =
                                AbuseWakeLockDetector.isScreenLock(
                    ...
                    .map(
                        new Function() { // from class:
                                         // com.android.server.power.AbuseWakeLockDetector$$ExternalSyntheticLambda1
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            AbuseWakeLockDetector.WakeLockInfoPair
                                lambda$handleAbuseWakelockWhenUserActivityChanged$0;
                            lambda$handleAbuseWakelockWhenUserActivityChanged$0 =
                                AbuseWakeLockDetector
                                    .lambda$handleAbuseWakelockWhenUserActivityChanged$0(
                                        (PowerManagerService.WakeLock) obj);
                    ...
                    .filter(
                        new Predicate() { // from class:
                          ...
                          public final boolean test(Object obj) {
                            ...
                            lambda$handleAbuseWakelockWhenUserActivityChanged$1 =
                                AbuseWakeLockDetector.this
                                    .lambda$handleAbuseWakelockWhenUserActivityChanged$1(
                                        visibleWinSurfacePkgList,
                                        (AbuseWakeLockDetector.WakeLockInfoPair) obj);
                            return lambda$handleAbuseWakelockWhenUserActivityChanged$1;
                          }
                        })
                    .map(
                        new Function() { // from class:
                                         // com.android.server.power.AbuseWakeLockDetector$$ExternalSyntheticLambda3
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            String str;
  ...
  public static /* synthetic */ WakeLockInfoPair
      lambda$handleAbuseWakelockWhenUserActivityChanged$0(PowerManagerService.WakeLock wakeLock) {
    return new WakeLockInfoPair(wakeLock.mOwnerUid, wakeLock.mPackageName);
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ boolean lambda$handleAbuseWakelockWhenUserActivityChanged$1(
      ArrayList arrayList, WakeLockInfoPair wakeLockInfoPair) {
    return checkAppIsRunningBackground(
        wakeLockInfoPair.uid, wakeLockInfoPair.packageName, arrayList);
  }
