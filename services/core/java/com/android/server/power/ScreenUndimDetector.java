...
public class ScreenUndimDetector {
  ...
  public void systemReady(Context context) {
    ...
    DeviceConfig.addOnPropertiesChangedListener(
        ...
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.power.ScreenUndimDetector$$ExternalSyntheticLambda0
    ...
    this.mWakeLock =
        ((PowerManager) context.getSystemService(PowerManager.class))
            .newWakeLock(536870922, "UndimDetectorWakeLock");
  }
  ...
  public final int readUndimsRequired() {
    ...
    android.util.Slog.e(
        "ScreenUndimDetector",
        "Provided undimsRequired=" + i + " is not allowed [1, 5]; using the default=2");
    return 2;
  }
