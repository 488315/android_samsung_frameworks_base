...
public abstract class PowerManagerUtil {
  ...
  static {
    ...
    boolean equalsIgnoreCase2 =
        "0x4f4c".equalsIgnoreCase(SystemProperties.get("ro.boot.debug_level"));
    ...
    SEC_FEATURE_BATTERY_SIMULATION =
        (equalsIgnoreCase || equalsIgnoreCase2 || equals) ? false : true;
    SEC_FEATURE_RESTRICTED_DEBUG_LEVEL =
        (equalsIgnoreCase || equalsIgnoreCase2 || equals) ? false : true;
    ...
    SEC_FEATURE_AOD_LOOK_CHARGING_UI_ON_SUB_DISPLAY =
        AODConfig.SUPPORT_SUB_DISPLAY_COVER && !AODConfig.SUPPORT_FRONT_SUB_DISPLAY_WATCHFACE;
    SEC_FEATURE_AOD_BRIGHTNESS_ANIM =
        SemFloatingFeature.getInstance()
                .getInt("SEC_FLOATING_FEATURE_LCD_CONFIG_AOD_BRIGHTNESS_ANIMATION")
            == 1;
    SEC_FEATURE_WA_LCD_FLICKERING_WITH_VRR =
        trim.startsWith("r0")
            || trim.startsWith("g0")
            || trim.startsWith("dm1")
            || trim.startsWith("dm2");
    SEC_FEATURE_LCD_SUPPORT_AMOLED_DISPLAY =
        SemFloatingFeature.getInstance()
            .getBoolean("SEC_FLOATING_FEATURE_LCD_SUPPORT_AMOLED_DISPLAY");
    SEC_FEATURE_USE_AFC =
        SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV");
    SEC_FEATURE_USE_SFC =
        SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_BATTERY_SUPPORT_PD_HV");
    ...
    SEC_FEATURE_PAPAYA_DQE =
        Resources.getSystem().getBoolean(R.bool.config_dozeWakeLockScreenSensorAvailable);
    SEC_FEATURE_DISPLAY_QUALITY = SemDisplayQualityFeature.ENABLED;
    String string =
        SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_COMMON_CONFIG_HOMEHUB");
    ...
    SEC_FEATURE_SUPPORT_HBM =
        Resources.getSystem().getInteger(R.integer.config_brightness_ramp_rate_slow) != -1;
    HBM_LUX = Resources.getSystem().getInteger(R.integer.config_brightness_ramp_rate_slow);
  ...
  public static boolean fileExist(String str) {
    ...
    Slog.m72d("PowerManagerUtil", "fileExist " + str + ": " + z);
    return z;
  }

  public static void fileWriteInt(String str, int i) {
    Slog.m72d("PowerManagerUtil", "fileWriteInt to " + str + ", " + i);
    try {
  ...
  public static void fileWriteString(String str, String str2) {
    Slog.m72d("PowerManagerUtil", "fileWriteString to " + str + ", " + str2);
    try {
      FileOutputStream fileOutputStream = new FileOutputStream(new File(str));
      try {
  ...
  public static String readFromFile(String str) {
    ...
    try {
      ...
      try {
        ...
        Slog.m72d("PowerManagerUtil", "readFromFile " + str + ": " + str2);
    ...
    while (true) {
      if (i < stackTrace.length) {
        if (!stackTrace[i].getClassName().contains("dalvik.system.VMStack")
            ...
            && !stackTrace[i].getClassName().contains("com.android.server.power.PowerManagerUtil")
            && !stackTrace[i]
                .getClassName()
  ...
  public final class StopwatchLogger {
    ...
    /* renamed from: dk */
    public void m69dk(String str, String str2) {
      Slog.m73dk(str, formatTookTime(str2, elapsedTimeMillis()));
    }

    /* renamed from: d */
    public void m68d(String str, String str2) {
      Slog.m72d(str, formatTookTime(str2, elapsedTimeMillis()));
    }
  ...
  public abstract class Country {
    ...
    /* renamed from: US */
    public static final boolean f1720US;

    static {
      String upperCase =
          SystemProperties.get("ro.csc.countryiso_code", "NONE").trim().toUpperCase();
      COUNTRY_CODE = upperCase;
      CHINA = "CN".equals(upperCase);
      f1720US = "US".equals(upperCase);
    }
  }
  ...
  public class ScreenOffProfiler {
    ...
    public String toString(boolean z) {
      ...
      if (z) {
        sb.append(
            String.format(
                "[OFF][%3d][%s][T:%4d]  [Caller:%2d] [Cfp:%3d] [Cfa:%2d] [Panel:%3d]",
  ...
  public class ScreenOnProfiler {
    ...
    public long mDisplayEndTime;
    public long mDisplayStartTime;
    public final Runnable mFrameCheckerRunnable =
        new Runnable() { // from class: com.android.server.power.PowerManagerUtil.ScreenOnProfiler.1
          ...
          public void run() {
            ...
            if (frameTimeFromDriver == ScreenOnProfiler.mFramePrevTime) {
              ...
              Slog.m72d("PowerManagerUtil", "Frame Timeout !!! ");
    ...
    public void noteWakeupEnd() {
      ...
      Slog.m72d("PowerManagerUtil", screenOnProfiler.toString(false));
    ...
    public long getFrameTimeFromDriver() {
      ...
      if (i == 1) {
        ...
        Slog.m72d("PowerManagerUtil", "Display Type err = " + mDisplayType);
        readFromFile = "";
      }
      if (readFromFile == null) {
        Slog.m72d(
            "PowerManagerUtil",
            "null : /sys/class/lcd/panel/display_on or /sys/class/lcd/panel1/display_on");
      } else {
        try {
    ...
    public void disableFrameCheck() {
      CHECK_FRAME = false;
      Slog.m72d("PowerManagerUtil", "disable FrameCheck");
    }
    ...
    public String toString(boolean z) {
      ...
      if (z) {
        sb.append(
            String.format(
                "[%3d][%s][T:%4d]  [Caller:%2d] [WMS:%3d] [DSL:%2d] [Panel:%3d] [Frame:%3d]",
                Integer.valueOf(this.mOrder),
                this.mWakeUpTimeStr,
        ...
        sb.append(
            String.format(
                "[%3d][T:%4d]  [Caller:%2d] [WMS:%3d] [DSL:%2d] [Panel:%3d] [Frame:%3d]",
                Integer.valueOf(this.mOrder),
                Integer.valueOf(this.mWakeUpDuration),
                Integer.valueOf(this.mWakeUpDiff),
                Integer.valueOf(this.mWmsDuration),
