...
public abstract class PowerManagerUtil {
    ...
    static {
        ...
        SEC_FEATURE_PAPAYA_DQE = Resources.getSystem().getBoolean(R.bool.config_dozeWakeLockScreenSensorAvailable);
        ...
        SEC_FEATURE_SUPPORT_HBM = Resources.getSystem().getInteger(R.integer.config_brightness_ramp_rate_slow) != -1;
    ...
    public class ScreenOnProfiler {
        ...
        public long getFrameTimeFromDriver() {
            ...
            if (readFromFile == null) {
                Slog.m72d("PowerManagerUtil", "null : /sys/class/lcd/panel/display_on or /sys/class/lcd/panel1/display_on");
            } else {
                try {
                    return Long.parseLong(readFromFile);
                } catch (NumberFormatException unused) {
                    Slog.m72d("PowerManagerUtil", "/sys/class/lcd/panel/display_on or /sys/class/lcd/panel1/display_on data is " + readFromFile);
                }
            }
            return -1L;
        }
