...
public final /* synthetic */ class BlobStoreManagerService$$ExternalSyntheticLambda12
        implements Consumer {
    ...
    public /* synthetic */ BlobStoreManagerService$$ExternalSyntheticLambda12(
            int i, AtomicLong atomicLong) {
        this.f$1 = i;
        this.f$0 = atomicLong;
    }
                        ...
                        while (true) {
                            ...
                            if (i3 < size) {
                                BlobMetadata.Committer committer =
                                        (BlobMetadata.Committer)
                                                blobMetadata.mCommitters.valueAt(i3);
                                ...
                                protoOutputStream.write(
                                        1120986464259L, committer.blobAccessMode.mAccessType);
                                protoOutputStream.write(
                                        1120986464260L,
                                        committer.blobAccessMode.mAllowedPackages.size());
                                ...
                                buildStatsEvent =
                                        FrameworkStatsLog.buildStatsEvent(
                                                i,
                                                blobMetadata.mBlobId,
                                                blobMetadata.getSize(),
                                                blobMetadata.mBlobHandle.getExpiryTimeMillis(),
                                                bytes,
