...
public class BlobStoreIdleJobService extends JobService {
  ...
  public /* synthetic */ void lambda$onStartJob$0(JobParameters jobParameters) {
    ((BlobStoreManagerInternal) LocalServices.getService(BlobStoreManagerInternal.class))
        .onIdleMaintenance();
  ...
  public static void schedule(Context context) {
    ((JobScheduler) context.getSystemService("jobscheduler"))
        .schedule(
            new JobInfo.Builder(
                    191934935, new ComponentName(context, (Class<?>) BlobStoreIdleJobService.class))
