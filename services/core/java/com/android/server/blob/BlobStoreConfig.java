...
public abstract class BlobStoreConfig {
    ...
    public static long getAppDataBytesLimit() {
        return Math.max(DeviceConfigProperties.TOTAL_BYTES_PER_APP_LIMIT_FLOOR, (long) (Environment.getDataSystemDirectory().getTotalSpace() * DeviceConfigProperties.TOTAL_BYTES_PER_APP_LIMIT_FRACTION));
    }
