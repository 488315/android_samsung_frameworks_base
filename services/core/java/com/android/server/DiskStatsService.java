  ...
  */
  public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
    ...
    if (DumpUtils.checkDumpAndUsageStatsPermission(
        this.mContext, "DiskStatsService", printWriter)) {
      ...
      try {
        ...
        reportFreeSpace(
            Environment.getDataDirectory(), "Data", printWriter3, protoOutputStream2, 0);
        reportFreeSpace(
            Environment.getDownloadCacheDirectory(), "Cache", printWriter3, protoOutputStream2, 1);
        reportFreeSpace(new File("/system"), "System", printWriter3, protoOutputStream2, 2);
        reportFreeSpace(
            Environment.getMetadataDirectory(), "Metadata", printWriter3, protoOutputStream2, 3);
      ...
      reportFreeSpace(
          Environment.getDataDirectory(), "Data", printWriter32, protoOutputStream22, 0);
      reportFreeSpace(
          Environment.getDownloadCacheDirectory(), "Cache", printWriter32, protoOutputStream22, 1);
      reportFreeSpace(new File("/system"), "System", printWriter32, protoOutputStream22, 2);
      reportFreeSpace(
          Environment.getMetadataDirectory(), "Metadata", printWriter32, protoOutputStream22, 3);
  ...
  public final void reportFreeSpace(
      File file, String str, PrintWriter printWriter, ProtoOutputStream protoOutputStream, int i) {
    try {
  ...
  public final void reportCachedValuesProto(ProtoOutputStream protoOutputStream) {
    try {
      ...
      if (length == jSONArray2.length()
        ...
        Slog.wtf(
            "DiskStatsService",
            "Sizes of packageNamesArray, appSizesArray, appDataSizesArray  and cacheSizesArray are"
                + " not the same");
      }
      protoOutputStream.end(start);
    } catch (IOException | JSONException e) {
