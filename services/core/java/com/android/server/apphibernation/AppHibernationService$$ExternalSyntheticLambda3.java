...
public final /* synthetic */ class AppHibernationService$$ExternalSyntheticLambda3
        implements Runnable {
    ...
    public /* synthetic */ AppHibernationService$$ExternalSyntheticLambda3(
            AppHibernationService appHibernationService, Object obj, int i, int i2) {
        this.$r8$classId = i2;
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                HibernationStateDiskStore hibernationStateDiskStore =
                        (HibernationStateDiskStore) this.f$1;
                int i = this.f$2;
                ...
                synchronized (appHibernationService.mLock) {
                    try {
                        if (appHibernationService.mUserManager.isUserUnlockingOrUnlocked(i)) {
                            appHibernationService.initializeUserHibernationStates(
                                    i, readHibernationStates);
                            for (UserLevelState userLevelState :
                                    ((Map) appHibernationService.mUserStates.get(i)).values()) {
                ...
                try {
                    try {
                        if (Flags.appRestrictionsApi()) {
                            int i3 =
                                    appHibernationService2.mIPackageManager.getApplicationInfo(
                                                    str2, 537698816L, i2)
                                            .uid;
                        }
                    ...
                    try {
                        appHibernationService2.mIActivityManager.broadcastIntentWithFeature(
                        ...
                        appHibernationService2.mIActivityManager.broadcastIntentWithFeature(
                                (IApplicationThread) null,
                                (String) null,
                                new Intent("android.intent.action.BOOT_COMPLETED").setPackage(str2),
                                (String) null,
                                (IIntentReceiver) null,
                                -1,
                                (String) null,
