...
public final class AppHibernationService extends SystemService {
  ...
  public AppHibernationService(Injector injector) {
    ...
    UsageStatsManagerInternal.UsageEventListener usageEventListener =
        new UsageStatsManagerInternal
            .UsageEventListener() { // from class:
                                    // com.android.server.apphibernation.AppHibernationService$$ExternalSyntheticLambda5
    ...
    if (i == 1000) {
      this.mBackgroundExecutor.execute(
          new Runnable() { // from class:
                           // com.android.server.apphibernation.AppHibernationService$$ExternalSyntheticLambda6
      ...
      DeviceConfig.addOnPropertiesChangedListener(
          ...
          new DeviceConfig
              .OnPropertiesChangedListener() { // from class:
                                               // com.android.server.apphibernation.AppHibernationService$$ExternalSyntheticLambda7
  ...
  public boolean isHibernatingForUser(String str, int i) {
    ...
    getContext()
        .enforceCallingOrSelfPermission(
            "android.permission.MANAGE_APP_HIBERNATION",
            "Caller did not have permission while calling isHibernatingForUser");
    ...
    synchronized (this.mLock) {
      ...
      UserLevelState userLevelState =
          (UserLevelState) ((Map) this.mUserStates.get(handleIncomingUser)).get(str);
      if (userLevelState != null
          && this.mPackageManagerInternal.canQueryPackage(Binder.getCallingUid(), str)) {
        ...
        if (checkUserStatesExist(handleIncomingUser, "setHibernatingForUser", true)) {
          ...
          if (userLevelState != null
            ...
            if (z) {
              this.mBackgroundExecutor.execute(
                  new Runnable() { // from class:
                                   // com.android.server.apphibernation.AppHibernationService$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                      AppHibernationService.this.lambda$setHibernatingForUser$1(
                          str, handleIncomingUser, userLevelState);
                    }
                  });
            } else {
              this.mBackgroundExecutor.execute(
                  new Runnable() { // from class:
                                   // com.android.server.apphibernation.AppHibernationService$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                      AppHibernationService.this.lambda$setHibernatingForUser$2(
                          str, handleIncomingUser);
                    }
                  });
            ...
            this.mBackgroundExecutor.execute(
                new Runnable() { // from class:
                                 // com.android.server.apphibernation.AppHibernationService$$ExternalSyntheticLambda4
                  @Override // java.lang.Runnable
                  public final void run() {
                    AppHibernationService.lambda$setHibernatingForUser$3(
                        UserLevelState.this, handleIncomingUser);
                  }
                });
            ((HibernationStateDiskStore) this.mUserDiskStores.get(handleIncomingUser))
                .scheduleWriteHibernationStates(
                    new ArrayList(((Map) this.mUserStates.get(handleIncomingUser)).values()));
            return;
          }
          Slog.e(
              "AppHibernationService",
              TextUtils.formatSimple(
                  "Package %s is not installed for user %s",
                  new Object[] {str, Integer.valueOf(handleIncomingUser)}));
        }
      }
    }
  }

  public static /* synthetic */ void lambda$setHibernatingForUser$3(
      UserLevelState userLevelState, int i) {
    FrameworkStatsLog.write(
        FrameworkStatsLog.USER_LEVEL_HIBERNATION_STATE_CHANGED,
        userLevelState.packageName,
        i,
        userLevelState.hibernated);
  }
    ...
    if (sIsServiceEnabled) {
      getContext()
          .enforceCallingOrSelfPermission(
              ...
              "Caller does not have MANAGE_APP_HIBERNATION permission.");
      synchronized (this.mLock) {
        final GlobalLevelState globalLevelState =
            (GlobalLevelState) this.mGlobalHibernationStates.get(str);
        if (globalLevelState != null
            && this.mPackageManagerInternal.canQueryPackage(Binder.getCallingUid(), str)) {
          if (globalLevelState.hibernated != z) {
            ...
            if (z) {
              this.mBackgroundExecutor.execute(
                  new Runnable() { // from class:
                                   // com.android.server.apphibernation.AppHibernationService$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                      AppHibernationService.this.lambda$setHibernatingGlobally$4(
                          str, globalLevelState);
                    }
                  });
            } else {
            ...
            this.mGlobalLevelHibernationDiskStore.scheduleWriteHibernationStates(
                new ArrayList(this.mGlobalHibernationStates.values()));
          }
          return;
        }
        Slog.e(
            "AppHibernationService",
            TextUtils.formatSimple("Package %s is not installed for any user", new Object[] {str}));
      }
    }
  }
  ...
  public List getHibernatingPackagesForUser(int i) {
    ...
    synchronized (this.mLock) {
      ...
      for (UserLevelState userLevelState :
          ((Map) this.mUserStates.get(handleIncomingUser)).values()) {
        if (this.mPackageManagerInternal.canQueryPackage(
                Binder.getCallingUid(), userLevelState.packageName)
            && userLevelState.hibernated) {
      ...
      for (String str : set) {
        if (this.mPackageManagerInternal.canQueryPackage(Binder.getCallingUid(), str)) {
          if (this.mGlobalHibernationStates.containsKey(str) && map.containsKey(str)) {
            arrayMap.put(
                str,
                new HibernationStats(
                    ((GlobalLevelState) this.mGlobalHibernationStates.get(str)).savedByte
                        + ((UserLevelState) map.get(str)).savedByte));
          }
          Slog.w(
              "AppHibernationService",
              TextUtils.formatSimple(
                  "No hibernation state associated with package %s user %d. Maybethe package was"
                      + " uninstalled? ",
                  new Object[] {str, Integer.valueOf(handleIncomingUser)}));
        }
      }
  ...
  public final void lambda$setHibernatingForUser$1(
      String str, int i, UserLevelState userLevelState) {
    ...
    try {
      try {
        try {
          StorageStats queryStatsForPackage =
              this.mStorageStatsManager.queryStatsForPackage(
                  this.mIPackageManager.getApplicationInfo(str, 537698816L, i).storageUuid,
                  str,
                  new UserHandle(i));
          this.mIActivityManager.forceStopPackage(str, i);
          this.mIPackageManager.deleteApplicationCacheFilesAsUser(
              str, i, (IPackageDataObserver) null);
          synchronized (this.mLock) {
        ...
        throw new IllegalStateException(
            "Failed to hibernate due to manager not being available", e3);
      }
    } finally {
  ...
  public final void lambda$setHibernatingForUser$2(String str, int i) {
    ...
    try {
      try {
        ...
        this.mIActivityManager.broadcastIntentWithFeature(
            (IApplicationThread) null,
            (String) null,
            new Intent("android.intent.action.LOCKED_BOOT_COMPLETED").setPackage(str),
            (String) null,
        ...
        this.mIActivityManager.broadcastIntentWithFeature(
            (IApplicationThread) null,
            (String) null,
            new Intent("android.intent.action.BOOT_COMPLETED").setPackage(str),
            (String) null,
            (IIntentReceiver) null,
            -1,
            (String) null,
  ...
  public final void lambda$setHibernatingGlobally$4(String str, GlobalLevelState globalLevelState) {
    ...
    long max =
        this.mOatArtifactDeletionEnabled
            ? Math.max(this.mPackageManagerInternal.deleteOatArtifactsOfPackage(str), 0L)
            : 0L;
    synchronized (this.mLock) {
        ...
        for (int i3 = 0; i3 < size3; i3++) {
          ...
          if (!arraySet.contains(globalLevelState2.packageName)) {
            Slog.w(
                "AppHibernationService",
                TextUtils.formatSimple(
                    "No hibernation state associated with package %s. Maybe the package was"
                        + " uninstalled? ",
                    new Object[] {globalLevelState2.packageName}));
          } else {
  ...
  public void onUserUnlocking(SystemService.TargetUser targetUser) {
    ...
    final HibernationStateDiskStore userLevelDiskStore =
        this.mInjector.getUserLevelDiskStore(userIdentifier);
    this.mUserDiskStores.put(userIdentifier, userLevelDiskStore);
    this.mBackgroundExecutor.execute(
        new Runnable() { // from class:
                         // com.android.server.apphibernation.AppHibernationService$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onUserUnlocking$5(
      HibernationStateDiskStore hibernationStateDiskStore, int i) {
    ...
    synchronized (this.mLock) {
      if (this.mUserManager.isUserUnlockingOrUnlocked(i)) {
        ...
        for (UserLevelState userLevelState : ((Map) this.mUserStates.get(i)).values()) {
          ...
          if (((GlobalLevelState) this.mGlobalHibernationStates.get(str)).hibernated
              && !userLevelState.hibernated) {
  ...
  public final int handleIncomingUser(int i, String str) {
    try {
      return this.mIActivityManager.handleIncomingUser(
          Binder.getCallingPid(), Binder.getCallingUid(), i, false, true, str, (String) null);
    } catch (RemoteException e) {
      throw e.rethrowFromSystemServer();
    }
  }
  ...
  public final boolean checkUserStatesExist(int i, String str, boolean z) {
    ...
    if (z) {
      Slog.w(
          "AppHibernationService",
          TextUtils.formatSimple(
              "Attempt to call %s before states have been read from disk", new Object[] {str}));
    }
    return false;
  }
  ...
  public final void dump(PrintWriter printWriter) {
    if (DumpUtils.checkDumpAndUsageStatsPermission(
        getContext(), "AppHibernationService", printWriter)) {
  ...
  public final class AppHibernationServiceStub extends IAppHibernationService.Stub {
    ...
    public void onShellCommand(
      ...
      new AppHibernationShellCommand(this.mService)
          .exec(
              this,
              fileDescriptor,
              fileDescriptor2,
  ...
  public final class InjectorImpl implements Injector {
    ...
    public final UserLevelHibernationProto mUserLevelHibernationProto =
    ...
    public HibernationStateDiskStore getGlobalLevelDiskStore() {
      return new HibernationStateDiskStore(
          new File(Environment.getDataSystemDirectory(), "hibernation"),
          new GlobalLevelHibernationProto(),
    ...
    public HibernationStateDiskStore getUserLevelDiskStore(int i) {
      return new HibernationStateDiskStore(
          new File(Environment.getDataSystemCeDirectory(i), "hibernation"),
          this.mUserLevelHibernationProto,
          this.mScheduledExecutorService);
    }

    @Override // com.android.server.apphibernation.AppHibernationService.Injector
    public boolean isOatArtifactDeletionEnabled() {
      return this.mContext.getResources().getBoolean(R.bool.config_enhancedConfirmationModeEnabled);
    }
  }
    ...
    public int onPullAtom(int i, List list) {
      ...
      if (i == 10107) {
          ...
          if (AppHibernationService.this.mUserManager.isUserUnlockingOrUnlocked(i4)) {
            list.add(
                FrameworkStatsLog.buildStatsEvent(
                    i, AppHibernationService.this.getHibernatingPackagesForUser(i4).size(), i4));
          }
        }
      } else {
        if (i != 10109) {
        ...
        synchronized (AppHibernationService.this.mLock) {
          j = 0;
          i2 = 0;
          for (GlobalLevelState globalLevelState :
              AppHibernationService.this.mGlobalHibernationStates.values()) {
