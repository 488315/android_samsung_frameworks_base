...
public class SettingRepositoryDefault implements SettingRepository {
  ...
  public SettingRepositoryDefault(SystemRepository systemRepository) {
    ...
    int parseInt =
        Integer.parseInt(systemRepository.getSystemProperty("ro.slmk.dha_cached_max", "16"));
    this.mDefaultCachedMax = parseInt;
    this.mLastCachedMax = parseInt;
    boolean equals =
        this.mSystemRepository
            .getSystemProperty("ro.slmk.use_bg_keeping_policy", "false")
            .equals("true");
  ...
  public void initialize() {
    String systemProperty =
        this.mSystemRepository.getSystemProperty("persist.config.chimera.enable", "false");
    ...
    if (this.mSystemRepository.isPackageInstalled("com.samsung.android.memoryguardian")) {
      ...
      this.mIsPSITrackerEnable =
          Boolean.parseBoolean(
              this.mSystemRepository.getSystemProperty("ro.slmk.psitracker_enable", "true"));
    }
  }
