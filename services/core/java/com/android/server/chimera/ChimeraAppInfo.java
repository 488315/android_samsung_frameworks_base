...
public class ChimeraAppInfo {
          ...
          list.stream()
                  .anyMatch(
                      new Predicate() { // from class:
                                        // com.android.server.chimera.ChimeraAppInfo$$ExternalSyntheticLambda0
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                          boolean lambda$hasRestartService$0;
                          lambda$hasRestartService$0 =
                              ChimeraAppInfo.this.lambda$hasRestartService$0(
                                  systemRepository, (ChimeraAppInfo.ProcessInfo) obj);
  ...
  public /* synthetic */ boolean lambda$hasRestartService$0(
      SystemRepository systemRepository, ProcessInfo processInfo) {
