...
public class GPUMemoryReclaimer {
  ...
  public static final Boolean isEnabledSwapOut() {
    if (__EnabledSwapOut == null) {
      __EnabledSwapOut =
          Boolean.valueOf(
              SystemProperties.getBoolean("ro.sys.kernelmemory.gmr.enabled_swap_out", true));
    }
  ...
  public static final Boolean isEnabledSwapIn() {
    if (__EnabledSwapIn == null) {
      __EnabledSwapIn =
          Boolean.valueOf(
              SystemProperties.getBoolean("ro.sys.kernelmemory.gmr.enabled_swap_in", true));
    }
  ...
  public static final Boolean isAsync() {
    if (__Async == null) {
      __Async =
          Boolean.valueOf(SystemProperties.getBoolean("ro.sys.kernelmemory.gmr.async", false));
    }
    return __Async;
  }
  ...
  public final class SwapInHandler extends Handler {
    ...
    public void swapInAsync(int i, String str) {
      GPUMemoryReclaimer.this.mSwapInHandler.sendMessage(
          GPUMemoryReclaimer.this.mSwapInHandler.obtainMessage(1, i, 0, str));
    }
  ...
  public final class SwapOutHandler extends Handler {
    ...
    public void swapOutAsync(int i, String str) {
      GPUMemoryReclaimer.this.mSwapOutHandler.sendMessage(
          GPUMemoryReclaimer.this.mSwapOutHandler.obtainMessage(1, i, 0, str));
    }
  ...
  public class Dump {
    ...
    public void meminfo(PrintWriter printWriter) {
      ...
      reclaimableTasks.sort(
          new Comparator() { // from class:
                             // com.android.server.chimera.GPUMemoryReclaimer$Dump$$ExternalSyntheticLambda0
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
              int lambda$meminfo$0;
              lambda$meminfo$0 =
                  GPUMemoryReclaimer.Dump.lambda$meminfo$0(
                      (GPUMemoryReclaimer.ReclaimableTask) obj,
                      (GPUMemoryReclaimer.ReclaimableTask) obj2);
      ...
      while (it2.hasNext()) {
        ...
        try {
          processName = this.self.mUtils.getProcessName(pid);
          if (processName == null) {
            processName = "(unknown)";
          }
          meminfoRaw = reclaimableTask.getMeminfoRaw();
          resident = reclaimableTask.getResident();
          reclaimed = reclaimableTask.getReclaimed();
          it = it2;
        } catch (Exception e) {
          e = e;
          it = it2;
          ...
          arrayList.add(
              new ArrayList(
                  Arrays.asList(
                      ...
                      processName,
                      Long.toString(resident),
                      Long.toString(reclaimed),
                      Arrays.toString(meminfoRaw))));
          j += resident;
          j2 += reclaimed;
        } catch (Exception e2) {
          e = e2;
    ...
    public static /* synthetic */ int lambda$meminfo$0(
        ReclaimableTask reclaimableTask, ReclaimableTask reclaimableTask2) {
      ...
      try {
        ...
        printWriter.println(
            Integer.toString(i)
                ...
                + processName
                + " "
                + Long.toString(this.self.mVendorPlugin.calculateResident(meminfoRaw))
                + " "
                + Long.toString(this.self.mVendorPlugin.calculateReclaimed(meminfoRaw))
                + " "
                + Arrays.toString(meminfoRaw));
      } catch (Exception unused) {
    ...
    public final void swapOut(PrintWriter printWriter, int i, String str) {
      ...
      printWriter.println(
          "Triggered swap-out for pid=" + i + " ret=" + this.self.mVendorPlugin.swapOut(i, str));
    }
    ...
    public final void swapIn(PrintWriter printWriter, int i, String str) {
      ...
      printWriter.println(
          "Triggered swap-in for pid=" + i + " ret=" + this.self.mVendorPlugin.swapIn(i, str));
    }
  }
  ...
  public class Utils {
    ...
    public String readFileToString(String str) {
      ...
      BufferedReader bufferedReader =
          new BufferedReader(fileReader, IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES);
    ...
    public void writeStringToFile(String str, String str2) {
      ...
      BufferedWriter bufferedWriter =
          new BufferedWriter(fileWriter, IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES);
  ...
  public class ReclaimableTask {
    ...
    public ReclaimableTask(int i, VendorPlugin vendorPlugin) {
      long j;
      long calculateResident;
      long[] jArr = new long[0];
      long j2 = -1;
      try {
        jArr = vendorPlugin.getMeminfoRaw(i);
        calculateResident = vendorPlugin.calculateResident(jArr);
      } catch (Exception e) {
        e = e;
        j = -1;
      } catch (Throwable th) {
  ...
  public class KGSLPlugin extends VendorPlugin {
    ...
    public KGSLPlugin(GPUMemoryReclaimer gPUMemoryReclaimer) {
      ...
      try {
        FileUtils.stringToFile(
            ...
            String.valueOf(
                GPUMemoryReclaimer.getMaxReclaimSize() / Os.sysconf(OsConstants._SC_PAGESIZE)));
        Slog.i(
            str,
        ...
        Slog.e(
            this.TAG,
            "GMR: Failed to write max recaim limit to /sys/class/kgsl/kgsl/max_reclaim_limit");
      }
    }
    ...
    public long[] getMeminfoRaw(int i) {
      ...
      return new long[] {
        this.self.mUtils.readFileToLong(str + "/gpumem_mapped"),
        this.self.mUtils.readFileToLong(str + "/gpumem_unmapped"),
        this.self.mUtils.readFileToLong(str + "/gpumem_reclaimed")
      };
    }
  ...
  public class SGPUPlugin extends VendorPlugin {
    ...
    public int swapOutImpl(int i, String str) {
      ...
      this.self.mUtils.writeStringToFile(
          "/sys/kernel/gpu/sgpu_swap_ctrl", "" + i + " " + swapFreeKb);
      return 0;
    }
    ...
    public long[] getMeminfoRaw(int i) {
      String[] split =
          this.self.mUtils.readFileToString("/sys/kernel/gpu/proc/" + i + "/summary").split("\\s+");
      return new long[] {
