...
public abstract class UnifiedMemoryReclaimer {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native int createStatusMonitorNative();

  /* JADX INFO: Access modifiers changed from: private */
  public static native void destroyStatusMonitorNative();

  /* JADX INFO: Access modifiers changed from: private */
  public static native long getFreeMemoryNative();
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native int waitForStatusUpdate();
  ...
  public static void staticInitialize() {
    if (DISABLED) {
      KernelMemoryProxy$ReclaimerLog.write(
          "staticInitialize: UnifiedMemoryReclaimer is disabled by config");
      return;
    }
    ...
    ServiceThread serviceThread =
        new ServiceThread(UnifiedMemoryReclaimer.class.getSimpleName(), 10, true);
  ...
  public static void init(ActivityManagerService activityManagerService, Context context) {
    try {
      if (DISABLED) {
        ...
        KernelMemoryProxy$ReclaimerLog.write(
            "init: CORERUNE_UMR_ENABLED = true, MODEL_UMR_ENABLED = " + MODEL_UMR_ENABLED);
        return;
      }
      if (enabled) {
  ...
  public static void destroy() {
    try {
      if (DISABLED) {
        KernelMemoryProxy$ReclaimerLog.write(
            "destroy: UnifiedMemoryReclaimer is disabled by config");
        return;
      }
      if (!enabled) {
  ...
  public static int readAmAppLaunch() {
    ...
    try {
      BufferedReader bufferedReader =
          new BufferedReader(
              new FileReader("/sys/kernel/mm/vmscan/am_app_launch", StandardCharsets.UTF_8));
      try {
    ...
    getReclaimerManager()
        ...
        .forEach(
            new BiConsumer() { // from class:
                               // com.android.server.chimera.umr.UnifiedMemoryReclaimer$$ExternalSyntheticLambda0
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                UnifiedMemoryReclaimer.lambda$enableReclaimers$0(
                    context, (String) obj, (UnifiedMemoryReclaimer.Reclaimer) obj2);
              }
            });
  }

  public static /* synthetic */ void lambda$enableReclaimers$0(
      Context context, String str, Reclaimer reclaimer) {
  ...
  public static void disableReclaimers() {
    ...
    getReclaimerManager()
        ...
        .forEach(
            new BiConsumer() { // from class:
                               // com.android.server.chimera.umr.UnifiedMemoryReclaimer$$ExternalSyntheticLambda3
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
  ...
  public static void dumpInfo(final PrintWriter printWriter, String[] strArr) {
    ...
    try {
      ...
      if (strArr.length == 1) {
        ...
        printWriter.println(
            "- reclaimer_log: "
                + Boolean.toString(KernelMemoryProxy$ReclaimerLog.reclaimerLogSupported()));
        printWriter.println(
            "- psi_cpu_threshold_ms:" + getSystemStatusMonitor().getPsiCpuThresholdMS());
        printWriter.println("- psi_cpu_window_ms:" + getSystemStatusMonitor().getPsiCpuWindowMS());
        printWriter.println(
            "- psi_mem_threshold_ms:" + getSystemStatusMonitor().getPsiMemThresholdMS());
        printWriter.println("- psi_mem_window_ms:" + getSystemStatusMonitor().getPsiMemWindowMS());
        printWriter.println(
            "- mem_avail_low_threshold_kb:" + getSystemStatusMonitor().getMemAvailLowThresholdKB());
        printWriter.println(
            "- mem_free_low_threshold_kb:" + getSystemStatusMonitor().getMemFreeLowThresholdKB());
        ...
        getReclaimerManager()
            ...
            .forEach(
                new BiConsumer() { // from class:
                                   // com.android.server.chimera.umr.UnifiedMemoryReclaimer$$ExternalSyntheticLambda1
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    UnifiedMemoryReclaimer.lambda$dumpInfo$2(
                        printWriter, (String) obj, (UnifiedMemoryReclaimer.Reclaimer) obj2);
                  }
                });
        return;
      }
      ...
      if ("mem_free_low_threshold_kb".equals(strArr[2])) {
        ...
        getReclaimerManager()
            ...
            .forEach(
                new BiConsumer() { // from class:
                                   // com.android.server.chimera.umr.UnifiedMemoryReclaimer$$ExternalSyntheticLambda2
                  @Override // java.util.function.BiConsumer
                  public final void accept(Object obj, Object obj2) {
                    UnifiedMemoryReclaimer.lambda$dumpInfo$3(
                        parseLong, (String) obj, (UnifiedMemoryReclaimer.Reclaimer) obj2);
                  }
                });
        return;
      }
  ...
  public static /* synthetic */ void lambda$dumpInfo$2(
      PrintWriter printWriter, String str, Reclaimer reclaimer) {
  ...
  public abstract class Reclaimer {
    ...
    public void setControlStatus(int i, Context context) {
      try {
        KernelMemoryProxy$ReclaimerLog.write(
            String.format("%s: controlStatus=%s", this.name, CONTROL_STRINGS[i]));
        String reclaimerProperty = getReclaimerProperty("enabled", "false");
        if (!reclaimerProperty.equals("true")) {
          KernelMemoryProxy$ReclaimerLog.write(
              String.format(
                  String.format(
                      "  failed: %s=%s", reclaimerPropertyStr("enabled"), reclaimerProperty),
                  new Object[0]));
          return;
        }
    ...
    public String toString() {
      return String.format(
          "%s: %s, %s, %d",
          this.name,
          CONTROL_STRINGS[this.controlStatus],
          MODE_STRINGS[this.mode],
    ...
    public final void switchMode() {
      ...
      KernelMemoryProxy$ReclaimerLog.write(
          String.format(
              "%s: switchMode: %d -> %d", this.name, Integer.valueOf(i), Integer.valueOf(nextMode)),
  ...
  public final class ReclaimerManager {
    ...
    public final void forEachReclaimersApplyPolicy(final int i) {
      reclaimers.forEach(
          new BiConsumer() { // from class:
                             // com.android.server.chimera.umr.UnifiedMemoryReclaimer$ReclaimerManager$$ExternalSyntheticLambda0
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
              UnifiedMemoryReclaimer.ReclaimerManager.lambda$forEachReclaimersApplyPolicy$0(
                  i, (String) obj, (UnifiedMemoryReclaimer.Reclaimer) obj2);
            }
          });
    }

    public static /* synthetic */ void lambda$forEachReclaimersApplyPolicy$0(
        int i, String str, Reclaimer reclaimer) {
      try {
        reclaimer.setMode(i);
      } catch (Exception e) {
        e.printStackTrace();
    ...
    public synchronized void updateReclaimPolicy() {
      ...
      if (this.enabled && UnifiedMemoryReclaimer.mSystemStatusMonitor != null) {
        ...
        if (i != this.currentReclaimPolicy) {
          KernelMemoryProxy$ReclaimerLog.write(
              String.format(
                  "ReclaimerPolicyManager: update policy %d -> %d",
                  Integer.valueOf(i), Integer.valueOf(this.currentReclaimPolicy)));
          UnifiedMemoryReclaimer.getReclaimerManager()
              .applyReclaimPolicy(this.currentReclaimPolicy);
        }
      }
    }
  }
  ...
  public final class SystemResource {
    ...
    public void setPsiThresholdMS(int i) {
      KernelMemoryProxy$ReclaimerLog.write(
          String.format(
              "SystemResource[%s]: update psiThresholdMS %d -> %d",
              this.name, Integer.valueOf(this.psiThresholdMS), Integer.valueOf(i)));
      this.psiThresholdMS = i;
    }
    ...
    public void setPsiWindowMS(int i) {
      KernelMemoryProxy$ReclaimerLog.write(
          String.format(
              "SystemResource[%s]: update psiWindowMS %d -> %d",
              this.name, Integer.valueOf(this.psiWindowMS), Integer.valueOf(i)));
      this.psiWindowMS = i;
    }
    ...
    public final class ResetResourceStatusTask extends TimerTask {
      ...
      public void run() {
        this.expired = true;
        KernelMemoryProxy$ReclaimerLog.write(
            String.format("SystemResource[%s]: reset status", SystemResource.this.name), false);
    ...
    public final void cancelResetResourceStatusTask() {
      ...
      KernelMemoryProxy$ReclaimerLog.write(
          String.format("SystemResource[%s]: cancel pre-scheduled task", this.name), false);
    ...
    public final void scheduleResetResourceStatusTask(int i) {
      ...
      KernelMemoryProxy$ReclaimerLog.write(
          String.format(
              "SystemResource[%s]: schedule reset in %dms", this.name, Integer.valueOf(i)),
          false);
  ...
  public final class SystemStatusMonitor {
    ...
    public SystemStatusMonitor() {
      ...
      systemResourceArr[0] =
          new SystemResource("cpu", UnifiedMemoryReclaimer.PSI_CPU_THRESHOLD_MS, 1000);
      this.resources[1] =
          new SystemResource("mem", UnifiedMemoryReclaimer.PSI_MEM_THRESHOLD_MS, 1000);
    }

    public void start() {
      UnifiedMemoryReclaimer.createStatusMonitorNative();
      UnifiedMemoryReclaimer.openCpuStatusMonitorNative(
          getPsiCpuThresholdMS(), getPsiCpuWindowMS());
      UnifiedMemoryReclaimer.openMemStatusMonitorNative(
          getPsiMemThresholdMS(), getPsiMemWindowMS());
    ...
    public void resetAppLaunch() {
      if (UnifiedMemoryReclaimer.readAmAppLaunch() <= 0) {
        setAppLaunch(false);
      } else {
    ...
    public final class StatusMonitorThread extends Thread {
      ...
      public void run() {
        int waitForStatusUpdate;
        try {
          KernelMemoryProxy$ReclaimerLog.write("StatusMonitorThread start");
          while (!this.needToExit
              && (waitForStatusUpdate = UnifiedMemoryReclaimer.waitForStatusUpdate()) != -1
              && !this.needToExit) {
            SystemStatusMonitor.this.updatePressureInfo(waitForStatusUpdate);
          }
        } catch (Exception e) {
    ...
    public void setMemAvailLowThresholdKB(long j) {
      KernelMemoryProxy$ReclaimerLog.write(
          String.format(
              "SystemStatusMonitor: set memAvailLowThresholdKB=%d",
              Long.valueOf(this.memAvailLowThresholdKB)));
    ...
    public void setMemFreeLowThresholdKB(long j) {
      KernelMemoryProxy$ReclaimerLog.write(
          String.format(
              "SystemStatusMonitor: set MemFreeLowThresholdKB=%d",
              Long.valueOf(this.memFreeLowThresholdKB)));
      this.memFreeLowThresholdKB = j;
      this.memFreeSafeThresholdKB = j + 512000;
    }

    public boolean isMemFreeLow() {
      long freeMemoryNative = UnifiedMemoryReclaimer.getFreeMemoryNative();
      KernelMemoryProxy$ReclaimerLog.write(
          "isMemFreeLow: " + freeMemoryNative, UnifiedMemoryReclaimer.isDebugEnabled());
      return freeMemoryNative < this.memFreeLowThresholdKB;
    }

    public boolean isMemFreeSafe() {
      long freeMemoryNative = UnifiedMemoryReclaimer.getFreeMemoryNative();
      KernelMemoryProxy$ReclaimerLog.write(
          "isMemFreeSafe: " + freeMemoryNative, UnifiedMemoryReclaimer.isDebugEnabled());
      return freeMemoryNative >= this.memFreeSafeThresholdKB;
    }
  }
            ...
            try {
              outputStreamWriter =
                  new OutputStreamWriter(
                      new FileOutputStream(kswapdModePath), StandardCharsets.UTF_8);
            } catch (Exception e) {
              e = e;
            }
          } catch (Throwable th) {
