...
public final class DamonReclaimer extends UnifiedMemoryReclaimer.Reclaimer {
    ...
    synchronized (this.mUpdateLock) {
      ...
      if (!this.isValuesUpdated) {
        KernelMemoryProxy$ReclaimerLog.write(
            "enableReclaim: values are not yet updated updating values");
      ...
      this.mEnabled = true;
      this.mDebug.mStartReason =
          getSystemEventReciver()
              .getStartReason()
              .replace(KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE, "")
              .replace("\r", "");
  ...
  public final class DamonTuneableWriter {
    ...
    public void setMidHighWmarks(int i) {
      KernelMemoryProxy$ReclaimerLog.write(
          "setMidHighWmarks: " + i, UnifiedMemoryReclaimer.isDebugEnabled());
      this.DAMON_TUNEABLE_WMARKS_HIGH = i;
      this.DAMON_TUNEABLE_WMARKS_MID = i;
    }

    public final void setTuneableLevel(int i) {
      this.DAMON_TUNEABLE_MIN_AGE_US =
          SystemProperties.getInt(
              "ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".min_age", 40000000);
      this.DAMON_TUNEABLE_SAMPLE_INTERVAL_US =
          SystemProperties.getInt(
              "ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".sample_interval", 15000);
      this.DAMON_TUNEABLE_MIN_NR_REGION =
          SystemProperties.getInt(
              "ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".min_nr_regions", 100);
      this.DAMON_TUNEABLE_AGGR_INTERVAL =
          SystemProperties.getInt(
              "ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".aggr_interval", 200000);
      this.DAMON_TUNEABLE_WMARKS_LOW =
          SystemProperties.getInt(
              "ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".wmarks_low", 10);
      this.DAMON_TUNEABLE_QUOTA_MS =
          SystemProperties.getInt("ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".quota_ms", 50);
      this.DAMON_TUNEABLE_QUOTA_SZ =
          SystemProperties.getInt("ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".quota_sz", 64);
      this.DAMON_TUNEABLE_WATERMARK_INTERVAL =
          SystemProperties.getInt(
              "ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".wmarks_interval", 50);
      this.DAMON_TUNEABLE_QUOTA_RESET_INTERVAL =
          SystemProperties.getInt(
              "ro.sys.kernelmemory.umr.reclaimer.damon." + i + ".quota_reset_interval_ms", 50);
      this.DAMON_TUNEABLE_CPUAFFINITY =
          SystemProperties.getInt("ro.sys.kernelmemory.umr.reclaimer.damon.cpu_affinity", 4);
    }
    ...
    public boolean setTuneable(DamonTuneable damonTuneable, String str) {
      return AbstractC09861.f1670x12bd2d50[damonTuneable.ordinal()] != 1
          ? writeTunable(damonTuneable.toString(), str)
          : writeTunable(DamonTuneable.enabled.toString(), str);
    }
    ...
    public final boolean writeDamonTunables() {
      ...
      if (!setTuneable(
          DamonTuneable.sample_interval,
          Integer.toString(this.DAMON_TUNEABLE_SAMPLE_INTERVAL_US))) {
        KernelMemoryProxy$ReclaimerLog.write("unable to set sample interval");
        return false;
      }
      if (!setTuneable(
          DamonTuneable.min_nr_regions, Integer.toString(this.DAMON_TUNEABLE_MIN_NR_REGION))) {
        KernelMemoryProxy$ReclaimerLog.write("unable to set min nr regions");
        return false;
      }
      if (!setTuneable(
          DamonTuneable.aggr_interval, Integer.toString(this.DAMON_TUNEABLE_AGGR_INTERVAL))) {
        KernelMemoryProxy$ReclaimerLog.write("unable to set aggr interval");
        return false;
      }
      if (!setTuneable(
          DamonTuneable.wmarks_low, Integer.toString(this.DAMON_TUNEABLE_WMARKS_LOW))) {
        KernelMemoryProxy$ReclaimerLog.write("unable to set wmarkds low");
        return false;
      }
      if (!setTuneable(
          DamonTuneable.wmarks_high, Integer.toString(this.DAMON_TUNEABLE_WMARKS_HIGH))) {
        KernelMemoryProxy$ReclaimerLog.write("unable to set wmarks high");
        return false;
      }
      if (!setTuneable(
          DamonTuneable.wmarks_mid, Integer.toString(this.DAMON_TUNEABLE_WMARKS_MID))) {
      ...
      if (!setTuneable(
          DamonTuneable.wmarks_interval,
          Integer.toString(this.DAMON_TUNEABLE_WATERMARK_INTERVAL))) {
        KernelMemoryProxy$ReclaimerLog.write("unable to set wateramrk interval");
        return false;
      }
      if (!setTuneable(
          DamonTuneable.quota_reset_interval_ms,
          Integer.toString(this.DAMON_TUNEABLE_QUOTA_RESET_INTERVAL))) {
      ...
      if (setTuneable(
          DamonTuneable.cpu_affinity, Integer.toString(this.DAMON_TUNEABLE_CPUAFFINITY))) {
        return true;
      }
  ...
  public abstract /* synthetic */ class AbstractC09861 {

    /* renamed from: $SwitchMap$com$android$server$chimera$umr$DamonReclaimer$DamonTuneable */
    public static final /* synthetic */ int[] f1670x12bd2d50;
  ...
  public final class DamonStatsReader {
    ...
    public final String readStatsFile(String str) {
      ...
      try {
        BufferedReader bufferedReader =
            new BufferedReader(
                new FileReader(
                    Paths.get(this.mModulePath, str).normalize().toString(),
    ...
    public final String modeToString() {
      ...
      return mode != 0
          ? mode != 1 ? mode != 2 ? "Unhandled" : "Proactive" : "Suppressed"
          : "Default";
    }
    ...
    public void addValue(long j, long j2, long j3, long j4, long j5) {
      try {
        ...
        this.mStats.add(
            "StartTime: "
                ...
                + modeToString()
                + " SystemStatus - : "
                + DamonReclaimer.getSystemEventReciver().getSystemStatus()
                + ", Reclaim: "
                + j
                + " bytes, Runtime: "
                + j2
                + " ms, mNr_reclaim_tried_regions:  "
                + j3
                + ", mBytes_reclaim_tried_regions: "
                + j4
                + ", mNr_reclaimed_regions: "
                + j5);
      } catch (IllegalArgumentException e) {
        KernelMemoryProxy$ReclaimerLog.write(
            "addValue:: illegal argument exception exception " + e.toString());
      ...
      if (j > 0) {
        try {
          ...
          KernelMemoryProxy$ReclaimerLog.write(
              "addValue:: ArithmeticException pg_steal " + e3.toString());
        }
      }
      if (j4 > 0) {
        try {
          ...
          KernelMemoryProxy$ReclaimerLog.write(
              "addValue:: ArithmeticException pg_scan " + e4.toString());
        }
      }
      try {
        ...
        KernelMemoryProxy$ReclaimerLog.write(
            "addValue:: ArithmeticException pg_scan " + e5.toString());
      }
    }
    ...
    public void updateDamonStats() {
      ...
      addValue(
          fetchStats,
          currentTimeMillis,
          fetchStats(DamonStats.nr_reclaim_tried_regions.toString()),
          fetchStats(DamonStats.bytes_reclaim_tried_regions.toString()),
          fetchStats2);
    }
    ...
    public void dumpReclaimStats(PrintWriter printWriter) {
      ...
      printWriter.println(
          "Total PG_scan:"
              + this.mDamonPGScan
              + " PG_scan_count:"
              + ((int) this.mDamonPGScanMaxReached));
      printWriter.println(
          "Total PG_steal:"
              + this.mDamonPGSteal
              + " PG_steal_count:"
              + ((int) this.mDamonPGStealMaxReached));
  ...
  public void updateMemorySafeThreshold(long j) {
    ...
    KernelMemoryProxy$ReclaimerLog.write(
        "updateMemorySafeThreshold: " + j + " HighRAM? " + UnifiedMemoryReclaimer.IS_RAM_HIGHER);
    if (j <= 0 || (damonTuneableWriter = this.mTuneable) == null) {
      return;
    }
    damonTuneableWriter.setMidHighWmarks(
        (int) ((j * 1000) / UnifiedMemoryReclaimer.TOTAL_MEMORY_KB));
  }
  ...
  public static void notifyAppStart(String str) {
    ...
    if (systemEventReciver == null) {
      KernelMemoryProxy$ReclaimerLog.write(
          "notifyAppStart:: eventReceiver is null", UnifiedMemoryReclaimer.isDebugEnabled());
      return;
    }
    ActivityManagerService activityManagerService = UnifiedMemoryReclaimer.mService;
    if (activityManagerService != null
        && (str.contains(activityManagerService.currentLauncherName)
            || str.contains(KnoxCustomManagerService.LAUNCHER_PACKAGE))) {
  ...
  public final class DamonPolicyManager extends BroadcastReceiver {
    public final int PROACTIVE_RECLAIM_BATTERY_THRESHOLD =
        SystemProperties.getInt("ro.sys.kernelmemory.umr.proactive_reclaim_battery_threshold", 70);
    public final int PROACTIVE_RECLAIM_TIMEOUTMS =
        SystemProperties.getInt("ro.sys.kernelmemory.umr.proactive_reclaim_timeoutms", 180000);
    ...
    public synchronized int getDamonEnableTimeout() {
      KernelMemoryProxy$ReclaimerLog.write(
          "getDamonEnableTimeout entry mSystemStatus: " + this.mSystemStatus);
      int i = -1;
      if (!DamonReclaimer.this.isProactive()) {
        KernelMemoryProxy$ReclaimerLog.write(
            "getDamonEnableTimeout: it is not proactive", UnifiedMemoryReclaimer.isDebugEnabled());
        return -1;
      }
        ...
        case 2:
          if (System.currentTimeMillis() - this.mLastCheckTime >= 180000) {
            ...
            if ((intent.getIntExtra("level", -1) / intent.getIntExtra("scale", -1)) * 100.0f
                < this.PROACTIVE_RECLAIM_BATTERY_THRESHOLD) {
              setBits(1);
              break;
            } else {
              unsetBits(1);
      ...
      public void handleMessage(Message message) {
        try {
          ...
          if (i == 1) {
            ...
            KernelMemoryProxy$ReclaimerLog.write(
                "DamonPolicyHandler:handleMessage: timeout " + damonEnableTimeout,
                UnifiedMemoryReclaimer.isDebugEnabled());
            if (damonEnableTimeout > 0) {
              KernelMemoryProxy$ReclaimerLog.write(
                  "DamonPolicyHandler:handleMessage: previous enabled timeout "
                      + this.mPreviousEnableTimeout
                      + " currentTimeout "
                      + damonEnableTimeout,
                  UnifiedMemoryReclaimer.isDebugEnabled());
              if (damonEnableTimeout != this.mPreviousEnableTimeout) {
                DamonReclaimer.this.enableReclaim();
                UnifiedMemoryReclaimer.Reclaimer._sendMessage(
                    DamonPolicyManager.this.mPolicyHandler, 2, damonEnableTimeout);
                this.mPreviousEnableTimeout = damonEnableTimeout;
              }
            } else {
              this.mPreviousEnableTimeout = damonEnableTimeout;
              KernelMemoryProxy$ReclaimerLog.write(
                  "DamonPolicyHandler:handleMessage: disabling damon " + damonEnableTimeout,
                  UnifiedMemoryReclaimer.isDebugEnabled());
            ...
            DamonReclaimer.this.disableReclaim();
            KernelMemoryProxy$ReclaimerLog.write(
                "DamonPolicyHandler:handleMessage: disabling damon",
                UnifiedMemoryReclaimer.isDebugEnabled());
          } else {
            KernelMemoryProxy$ReclaimerLog.write(
                "DamonPolicyHandler: unhandled case", UnifiedMemoryReclaimer.isDebugEnabled());
          }
        } catch (Exception e) {
          KernelMemoryProxy$ReclaimerLog.write(
              "DamonPolicyHandler: failed to handleMessage " + message.what);
          e.printStackTrace();
        }
      }
    }
