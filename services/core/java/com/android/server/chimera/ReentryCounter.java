...
public class ReentryCounter
    implements SystemRepository.ChimeraProcessObserver, SystemRepository.ChimeraUidObserver {
  ...
  public void onUidGone(int i, String str) {
    if (this.mPkgReentryMap.containsKey(str)) {
      ...
      this.mSystemRepository.log(
          "ReentryCounter",
          "app reentry info: app name: " + str + "  reentry count:" + this.mPkgReentryMap.get(str));
