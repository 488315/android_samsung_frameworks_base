...
public final class QuickSwap {
  public static final List GENAI_PROCESSES_LIST =
      Arrays.asList(
  ...
  public final ThreadPoolExecutor mThreadPoolExecutor =
      (ThreadPoolExecutor) Executors.newFixedThreadPool(this.mThreadPoolSize);
  ...
  public void doQuickSwap(int i) {
    try {
      try {
        doQuickSwap(i, -1000, FrameworkStatsLog.f446x58c6c32, new int[] {0, -900});
        synchronized (this.isDoingQuickSwapLock) {
  ...
  public void doQuickSwap(int i, int i2, int i3, int[] iArr) {
    ...
    try {
      ...
      if (freeBytes < 0.1d) {
        Slog.i(
            TAG,
            "storageFreeRatio: "
                + String.format("%.2f", Double.valueOf(freeBytes))
                + " threshold: 0.1");
        z2 = false;
      } else {
        z2 = true;
    ...
    String str19 = "";
    if (this.mPPN.getSwapFreePercentage(memInfoReader)
      ...
      for (Pair pair : reclaimSet) {
        ...
        if (this.mPPN.isAppLaunch()) {
          ...
          final PerProcessNandswap.NandswapRecord nandswapRecord =
              (PerProcessNandswap.NandswapRecord)
                  this.mPPN.mNandswapMap.get(Integer.valueOf(intValue));
          if (nandswapRecord == null) {
            ...
            try {
              arrayList.add(
                  this.mThreadPoolExecutor.submit(
                      new Callable() { // from class:
                                       // com.android.server.chimera.QuickSwap$$ExternalSyntheticLambda0
                        @Override // java.util.concurrent.Callable
                        public final Object call() {
                          Integer lambda$doQuickSwap$0;
                          lambda$doQuickSwap$0 =
                              QuickSwap.this.lambda$doQuickSwap$0(
                                  intValue, nandswapRecord, longValue);
                          return lambda$doQuickSwap$0;
                        }
                      }));
            } catch (RejectedExecutionException unused3) {
              Slog.w(TAG, "QuickSwap Skip: rejected submit " + i8);
              str18 = str15;
              str19 = str13;
              str17 = str14;
              uptimeMillis = j3;
      ...
      while (it2.hasNext()) {
        try {
          i9 += ((Integer) ((Future) it2.next()).get(3L, TimeUnit.SECONDS)).intValue();
        } catch (InterruptedException | ExecutionException | TimeoutException e) {
          Slog.w(TAG, "QuickSwap async task execute with exception! " + e.getMessage());
        }
      }
      if (reclaimSet.size() == i9) {
        str12 = str20 + "PO=comp";
      } else if (z4) {
        str12 = str20 + "PO=laun";
      } else {
      ...
      Slog.w(
          str16,
          "QuickSwap Skip: swap is full (free is "
              + this.mPPN.getSwapFreePercentage(memInfoReader)
              + "%)");
    ...
    if (z && PerProcessNandswap.ZramInfo.isWritebackQuotaAvailable() && this.mIsNandswapOn) {
      ...
      while (it3.hasNext()) {
        ...
        if (this.mPPN.isAppLaunch()) {
          ...
          PerProcessNandswap.NandswapRecord nandswapRecord2 =
              (PerProcessNandswap.NandswapRecord)
                  this.mPPN.mNandswapMap.get(Integer.valueOf(intValue2));
          if (nandswapRecord2 == null) {
            ...
            try {
              try {
                String str23 = nandswapRecord2.processName;
                int i10 = nandswapRecord2.procState;
                int i11 = nandswapRecord2.adj;
                it = it3;
                try {
                  ...
                  try {
                    try {
                      ...
                      if (PerProcessNandswap.isDebugEnabled()) {
                        ...
                        try {
                          sb3.append("QuickSwap WB start for ");
                          sb3.append(str23);
                          sb3.append("(pid ");
                      ...
                      String str24 = str21;
                      try {
                        long compactProcessForWriteback =
                            PerProcessNandswap.compactProcessForWriteback(intValue2, 2);
  ...
  public /* synthetic */ Integer lambda$doQuickSwap$0(
      int i, PerProcessNandswap.NandswapRecord nandswapRecord, long j) {
    try {
      if (this.mPPN.isAppLaunch()) {
        if (PerProcessNandswap.isDebugEnabled()) {
  ...
  public final Set getReclaimSet(int i, int i2, int[] iArr, long j) {
    ...
    Comparator comparator =
        new Comparator() { // from class:
                           // com.android.server.chimera.QuickSwap$$ExternalSyntheticLambda1
    ...
    List nativeProcesses =
        this.mSystemRepository.getNativeProcesses(
            (Set)
                runningAppProcesses.stream()
                    .map(
                        new Function() { // from class:
                                         // com.android.server.chimera.QuickSwap$$ExternalSyntheticLambda2
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            Integer lambda$getReclaimSet$2;
                            lambda$getReclaimSet$2 =
                                QuickSwap.lambda$getReclaimSet$2(
        ...
        if (i3 < i) {
          ...
          if (!z) {
            ...
            if (rss == null || rss.length < 4) {
              ...
              this.mPPN.checkProcessStatusForNandswap(
                  runningAppProcessInfo.processName, runningAppProcessInfo.pid, i3);
            }
            iArr2 = iArr;
            treeSet3 = treeSet;
          }
  ...
  public static /* synthetic */ Integer lambda$getReclaimSet$2(
      SystemRepository.RunningAppProcessInfo runningAppProcessInfo) {
