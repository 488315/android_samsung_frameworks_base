...
public class SystemEventListener extends BroadcastReceiver {
  ...
  public final SystemRepository.ChimeraProcessObserver mProcessObserver =
  ...
  public final void registerBroadcastReceivers(Context context) {
    ...
    context.registerReceiver(
        this, intentFilter2, "com.samsung.android.permission.BROADCAST_PMM_CRITICAL_TRIGGER", null);
    ...
    if (z) {
      if (z2) {
        ...
        this.mHandler.sendMessageDelayed(
            Message.obtain(this.mHandler, 5, Integer.valueOf(i2)), 2000L);
        return;
      }
  ...
  public class AppLaunchIntent extends ActivityMetricsLaunchObserver {
    ...
    public void onIntentStarted(Intent intent, long j) {
      ...
      if (intent.getComponent() != null) {
        ...
        SystemEventListener.this.mSystemRepository.log(
            "SystemEventListener", "Not an effective intent: " + intent);
        return;
      }
      if (str.contains(SystemEventListener.this.mSystemRepository.getCurrentHomePackageName())
      ...
      obtain.obj = str;
      SystemEventListener.this.mSystemRepository.log(
          "SystemEventListener", "appLaunchIntent package name is: " + str);
  ...
  public void addCameraDeviceStateCallback(Context context) {
    ((CameraManager) context.getSystemService("camera"))
        .registerSemCameraDeviceStateCallback(
            this.mSystemRepository.getCameraDeviceStateCallback(), this.mHandler);
  }
  ...
  public void addTimeOrTimeZoneChangedListener(
      TimeOrTimeZoneChangedListener timeOrTimeZoneChangedListener) {
  ...
  public void removeTimeOrTimeZoneChangedListener(
      TimeOrTimeZoneChangedListener timeOrTimeZoneChangedListener) {
      ...
      try {
        switch (message.what) {
          ...
          case 3:
            ...
            while (it3.hasNext()) {
              ((PmmStateChangeListener) it3.next())
                  .onPmmStateChanged(((Integer) message.obj).intValue());
            }
            return;
          case 4:
            Iterator it4 = SystemEventListener.this.mLmkdEventListeners.iterator();
            while (it4.hasNext()) {
              ((LmkdEventListener) it4.next())
                  .onLmkdEventTriggered(
                      message.arg1, message.arg2, ((Integer) message.obj).intValue());
            }
            return;
          case 5:
          ...
          case 9:
            ...
            if (it9.hasNext()) {
              CurrentDeviceManager$$ExternalSyntheticThrowCCEIfNotNull0.m4m(it9.next());
              throw null;
            }
            return;
          case 10:
          ...
          case 14:
            SystemEventListener.this.mSystemRepository.log(
                "SystemEventListener", "MSG_ONE_HOUR_TIMER");
          ...
          case 15:
            ...
            while (it15.hasNext()) {
              ((TimeOrTimeZoneChangedListener) it15.next())
                  .onTimeOrTimeZoneChanged((String) message.obj);
            }
            return;
          case 16:
            Iterator it16 = SystemEventListener.this.mQuotaListeners.iterator();
            while (it16.hasNext()) {
              ((AlwaysRunningQuotaExceedListener) it16.next())
                  .onQuotaExceed((ChimeraQuotaMonitor.QuotaReclaimTarget) message.obj);
            }
            return;
          default:
            return;
        ...
        Log.e(
            SystemRepositoryDefault.convertToChimeraTag("SystemEventListener"),
  ...
  public void removeCameraDeviceStateCallback(Context context) {
    ((CameraManager) context.getSystemService("camera"))
        .unregisterSemCameraDeviceStateCallback(
            this.mSystemRepository.getCameraDeviceStateCallback());
  }
  ...
  public void addAlwaysRunningQuotaExceedListener(
      AlwaysRunningQuotaExceedListener alwaysRunningQuotaExceedListener) {
    this.mQuotaListeners.add(alwaysRunningQuotaExceedListener);
  }

  public void removeAlwaysRunningQuotaExceedListener(
      AlwaysRunningQuotaExceedListener alwaysRunningQuotaExceedListener) {
    ...
    public void run() {
      ...
      try {
        ...
        this.mSystemRepository.log(
            "SystemEventListener", "There is a client is accepted: " + this.mSocket.toString());
        BufferedReader bufferedReader =
            new BufferedReader(new InputStreamReader(this.mSocket.getInputStream()), 256);
        while (true) {
