...
public class AbnormalFgsDetector implements SystemEventListener.OneHourTimerListener {
  ...
  public static boolean isForegroundService(int i, int i2) {
    ...
    return (i2 == 100
            ...
            && (processStatesAndOomScoresForPIDs =
                    systemRepository.getProcessStatesAndOomScoresForPIDs(new int[] {i}))
                != null
  ...
  public void onOneHourTimer() {
    ...
    for (SystemRepository.RunningAppProcessInfo runningAppProcessInfo :
        mSystemRepository.getRunningAppProcesses()) {
  ...
  public void putKillableHeavyApp(final String str, int i, long j) {
    int i2;
    synchronized (this) {
      this.mHeavyApps.removeIf(
          new Predicate() { // from class:
                            // com.android.server.chimera.AbnormalFgsDetector$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$putKillableHeavyApp$0;
              lambda$putKillableHeavyApp$0 =
                  AbnormalFgsDetector.lambda$putKillableHeavyApp$0(
                      str, (AbnormalFgsDetector.HeavyAppItem) obj);
  ...
  public static /* synthetic */ boolean lambda$putKillableHeavyApp$0(
      String str, HeavyAppItem heavyAppItem) {
  ...
  public void addAbnormalHeavyApp(final String str, int i, long j) {
    ...
    synchronized (this) {
      if (!this.mAbnormalHeavyApps.stream()
              .anyMatch(
                  new Predicate() { // from class:
                                    // com.android.server.chimera.AbnormalFgsDetector$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$addAbnormalHeavyApp$1;
                      lambda$addAbnormalHeavyApp$1 =
                          AbnormalFgsDetector.lambda$addAbnormalHeavyApp$1(
                              str, (AbnormalFgsDetector.HeavyAppItem) obj);
          ...
          && !this.mReportedAbnormalHeavyApps.stream()
              .anyMatch(
                  new Predicate() { // from class:
                                    // com.android.server.chimera.AbnormalFgsDetector$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$addAbnormalHeavyApp$2;
                      lambda$addAbnormalHeavyApp$2 =
                          AbnormalFgsDetector.lambda$addAbnormalHeavyApp$2(
                              str, (AbnormalFgsDetector.HeavyAppItem) obj);
  ...
  public static /* synthetic */ boolean lambda$addAbnormalHeavyApp$1(
      String str, HeavyAppItem heavyAppItem) {
    return heavyAppItem.processName.equals(str);
  }

  public static /* synthetic */ boolean lambda$addAbnormalHeavyApp$2(
      String str, HeavyAppItem heavyAppItem) {
    return heavyAppItem.processName.equals(str);
  }
    ...
    if (this.mAbnormalHeavyApps.size() > 0) {
      ...
      mSystemRepository.logDebug(
          ...
          "reported AbnormalHeavyApp : "
              + Arrays.toString(this.mAbnormalHeavyApps.stream().toArray()));
  ...
  public final void printHeavyAppItems(PrintWriter printWriter, List list) {
    ...
    while (it.hasNext()) {
      HeavyAppItem heavyAppItem = (HeavyAppItem) it.next();
      printWriter.print(
          heavyAppItem.processName + " " + heavyAppItem.uid + " " + heavyAppItem.count + " ");
    }
  }
