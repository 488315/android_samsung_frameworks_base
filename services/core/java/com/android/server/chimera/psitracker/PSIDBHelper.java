...
public class PSIDBHelper extends SQLiteOpenHelper {
  ...
  public PSIDBHelper(Context context) {
    ...
    this.CREATE_AVAIL_MEM_TABLE =
        "create table if not exists psi_Available_Mem(id integer primary key autoincrement,availMem"
            + " integer, cached integer, running integer,checkTime integer)";
