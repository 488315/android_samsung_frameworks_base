...
public class ConservativePolicyHandler extends PolicyHandler {
  ...
  public ConservativePolicyHandler(
  ...
  public int executePolicy(ChimeraCommonUtil.TriggerSource triggerSource, int i) {
    if (!prepareForTrigger(triggerSource)) {
      this.mSystemRepository.log(
          "ConservativePolicyHandler", "executePolicy() - prepareForTrigger fails");
      return 0;
    }
  ...
  public void executePolicyInternal(boolean z, ChimeraCommonUtil.TriggerSource triggerSource) {
    this.mSystemRepository.log(
        "ConservativePolicyHandler",
        "executePolicy() :" + this.mTriggerSource + ", killAll : " + z);
    ...
    if (appsToKill == null) {
      this.mSystemRepository.logDebug(
          "ConservativePolicyHandler", "executePolicy() - getAppsToKill return null");
      return;
    }
    ...
    while (true) {
      ...
      if (i < 1) {
        ...
        if (i >= 4) {
          this.mSystemRepository.logDebug(
              "ConservativePolicyHandler", "killing stopped to group 4");
          break;
        }
        ...
        if (create != null && !create.hasCachedProcess()) {
          if (this.mSystemRepository.isOnScreenWindow(chimeraAppInfo.uid)) {
            ...
            if ((chimeraAppInfo.appType & IInstalld.FLAG_CLEAR_APP_DATA_KEEP_ART_PROFILES) != 0) {
              PolicyHandler.ProtectedReason protectedReason =
                  PolicyHandler.ProtectedReason.values()[hasProtectedServices(chimeraAppInfo)];
              if (protectedReason != PolicyHandler.ProtectedReason.NONE
                  && protectedReason != PolicyHandler.ProtectedReason.ACTIVITY_TIME) {
                markSkipReason(
                    chimeraAppInfo, SkipReasonLogger.Reason.SERVICE, " reason: " + protectedReason);
              }
            }
            if (hasImportantAdjWithSystemUid(chimeraAppInfo)) {
              ...
              this.mSystemRepository.log(
                  "ConservativePolicyHandler",
                  "Skipped by Thread Group Leader condition: " + chimeraAppInfo.packageName);
            } else if (isSystemPid(chimeraAppInfo)) {
              this.mSystemRepository.log(
                  "ConservativePolicyHandler", "Skipped by system server process id");
              ...
              if ((Arrays.stream(chimeraAppInfo.statsAndOomScores.mScores)
                          .noneMatch(
                              new IntPredicate() { // from class:
                                                   // com.android.server.chimera.ConservativePolicyHandler$$ExternalSyntheticLambda1
                                @Override // java.util.function.IntPredicate
                                public final boolean test(int i2) {
                                  boolean lambda$executePolicyInternal$1;
                                  lambda$executePolicyInternal$1 =
                                      ConservativePolicyHandler.lambda$executePolicyInternal$1(i2);
                                  return lambda$executePolicyInternal$1;
                                }
                              })
                      ? false
                      : chimeraAppInfo.procList.stream()
                          .anyMatch(
                              new Predicate() { // from class:
                                                // com.android.server.chimera.ConservativePolicyHandler$$ExternalSyntheticLambda0
                                @Override // java.util.function.Predicate
                                public final boolean test(Object obj) {
                                  boolean lambda$executePolicyInternal$0;
                                  lambda$executePolicyInternal$0 =
                                      ConservativePolicyHandler.this.lambda$executePolicyInternal$0(
  ...
  public /* synthetic */ boolean lambda$executePolicyInternal$0(
      ChimeraAppInfo.ProcessInfo processInfo) {
    return this.mAbnormalFgsDetector.isHeavyForegroundService(
  ...
  public void calculateKillGain(ChimeraAppInfo chimeraAppInfo) {
    ...
    this.mSystemRepository.logDebug(
        "ConservativePolicyHandler",
        "PSS gain: "
            + chimeraAppInfo.reclaimGain
            + ", hasRestartService: "
            + chimeraAppInfo.hasRestartService(this.mSystemRepository)
            + ", "
            + chimeraAppInfo);
  }
  ...
  public void killTopProfit(List list) {
    ...
    list.sort(
        new Comparator() { // from class:
                           // com.android.server.chimera.ConservativePolicyHandler$$ExternalSyntheticLambda2
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            int lambda$killTopProfit$2;
            lambda$killTopProfit$2 =
                ConservativePolicyHandler.lambda$killTopProfit$2(
  ...
  public static /* synthetic */ int lambda$killTopProfit$2(
  ...
  public void killApp(ChimeraAppInfo chimeraAppInfo, String str) {
    ...
    if (!isService(chimeraAppInfo) || !chimeraAppInfo.hasRestartService(this.mSystemRepository)) {
      str2 = "Kill : ";
    } else if (FreecessController.getInstance()
        .isFreezedPackage(
            chimeraAppInfo.packageName, this.mSystemRepository.getUserId(chimeraAppInfo.uid))) {
    ...
    this.mSystemRepository.log(
        "ConservativePolicyHandler",
        str2 + chimeraAppInfo.packageName + " Pss : " + chimeraAppInfo.pss);
    updateKillStatistics(chimeraAppInfo, this.mTriggerSource);
    this.mLastKilledTimeMap.put(
        chimeraAppInfo.packageName, Long.valueOf(this.mSystemRepository.currentTimeMillis()));
    for (ChimeraAppInfo.ProcessInfo processInfo : chimeraAppInfo.procList) {
      ...
      this.mSystemRepository.killProcessForChimera(
          processInfo.processName, chimeraAppInfo.uid, "Chimera " + str);
    }
  }
      ...
      if (i < 300) {
        if (i == 200
            && (chimeraAppInfo.packageName.startsWith("com.samsung.android.bixby.ondevice")
                || chimeraAppInfo.packageName.equals("com.sds.emm.sers"))) {
          return true;
        }
        if ((i == 200 && chimeraAppInfo.curStandbyBucket == 10)
            || chimeraAppInfo.curStandbyBucket == 5
            || isPowerWhitelistedApp(chimeraAppInfo.packageName)) {
          return true;
        }
      }
