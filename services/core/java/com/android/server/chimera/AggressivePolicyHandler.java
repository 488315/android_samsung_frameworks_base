...
public class AggressivePolicyHandler extends PolicyHandler {
  ...
  public AggressivePolicyHandler(
    ...
    if (this.mIsHeavyLaunchOn) {
      this.mHeavyLaunchCounter =
          new HeavyLaunchCounter(this.mHeavyLaunchBufferSize, this.mHeavyLaunchPackageLimit);
      this.mSystemRepository.log(
          "AggressivePolicyHandler",
          "Heavy launch param : "
              + this.mHeavyLaunchBufferSize
              + ","
              + this.mHeavyLaunchPackageLimit);
    }
  }

  private void readSystemProperties() {
    String systemProperty =
        this.mSystemRepository.getSystemProperty("ro.slmk.chimera_kill_interval_ms", "");
    ...
    this.mSystemRepository.log(
        "AggressivePolicyHandler", "PKG_KILL_INTERVAL_DEFAULT: " + this.mPkgKillIntervalDefault);
    this.mSystemRepository.log(
        "AggressivePolicyHandler", "PKG_KILL_INTERVAL_HEAVY: " + this.mPkgKillIntervalHeavy);
    int parseInt =
        Integer.parseInt(
            this.mSystemRepository.getSystemProperty(
                "persist.sys.chimera_pkg_kill_interval_ms", this.mPkgKillIntervalDefault + ""));
    this.mCemPkgKillIntervalMs =
        Integer.parseInt(
            this.mSystemRepository.getSystemProperty(
                "ro.slmk.chimera_cem_pkg_kill_interval_ms",
                PolicyHandler.CEM_PKG_KILL_INTERVAL_DEFAULT));
    this.mPkgProtectedParameters =
        new int[][] {
          new int[] {200, 850, parseInt}, new int[] {100, 850, this.mPkgKillIntervalHeavy}
        };
    this.mIsKillBoostModeOnNormal =
        ((Boolean)
                Optional.of(
                        this.mSystemRepository.getSystemProperty(
                            "ro.slmk.chimera_kill_boost_on_normal", ""))
                    .filter(
                        new Predicate() { // from class:
                                          // com.android.server.chimera.AggressivePolicyHandler$$ExternalSyntheticLambda0
                          @Override // java.util.function.Predicate
                          public final boolean test(Object obj) {
                            boolean lambda$readSystemProperties$0;
                            lambda$readSystemProperties$0 =
                                AggressivePolicyHandler.lambda$readSystemProperties$0((String) obj);
                            return lambda$readSystemProperties$0;
                          }
                        })
                    .map(
                        new Function() { // from class:
                                         // com.android.server.chimera.AggressivePolicyHandler$$ExternalSyntheticLambda1
                          @Override // java.util.function.Function
                          public final Object apply(Object obj) {
                            return Boolean.valueOf(Boolean.parseBoolean((String) obj));
                          }
                        })
                    .orElse(Boolean.valueOf(ChimeraCommonUtil.getRamSizeGb() <= 3)))
            .booleanValue();
    this.mIsKillBoostModeOnHeavy =
        ((Boolean)
                Optional.of(
                        this.mSystemRepository.getSystemProperty(
                            "ro.slmk.chimera_kill_boost_on_heavy", ""))
                    .filter(
                        new Predicate() { // from class:
                                          // com.android.server.chimera.AggressivePolicyHandler$$ExternalSyntheticLambda2
                          @Override // java.util.function.Predicate
                          public final boolean test(Object obj) {
                            boolean lambda$readSystemProperties$1;
                            lambda$readSystemProperties$1 =
                                AggressivePolicyHandler.lambda$readSystemProperties$1((String) obj);
    ...
    String systemProperty2 =
        this.mSystemRepository.getSystemProperty("ro.slmk.chimera_adjust_boot_targetfree", "");
    if (!TextUtils.isEmpty(systemProperty2)) {
      ...
      if (split2.length == 2) {
        try {
          ...
          this.mSystemRepository.log(
              "AggressivePolicyHandler",
              "Adjust targetfree : " + parseInt2 + ", " + this.mAdjustTargetFreeFactor);
        ...
        new BigDecimal(Float.toString(1.0f))
            .subtract(
                new BigDecimal(Float.toString(this.mWeightLru))
                    .add(new BigDecimal(Float.toString(this.mWeightStandbyBucket))))
            .floatValue();
  }
  ...
  public int executePolicy(ChimeraCommonUtil.TriggerSource triggerSource, int i) {
    ...
    if (!prepareForTrigger(triggerSource)) {
      this.mSystemRepository.log(
          "AggressivePolicyHandler", "executePolicy() - prepareForTrigger fails");
      return 0;
    }
    this.mSystemRepository.log(
        "AggressivePolicyHandler", "executePolicy() - triggerSource: " + triggerSource);
    ...
    int protectedCountOnLmkdTrigger =
        triggerSource == ChimeraCommonUtil.TriggerSource.TRIGGER_SOURCE_LMKD
            ? this.mChimeraStrategy.getProtectedCountOnLmkdTrigger()
            : this.mChimeraStrategy.getProtectedCountOnHomeTrigger();
    ...
    List appsToKill =
        this.mAppManager.getAppsToKill(
            this.mSkipReasonLogger, protectedCountOnLmkdTrigger, triggerSource);
    ...
    Collections.sort(
        ...
        new Comparator() { // from class:
                           // com.android.server.chimera.AggressivePolicyHandler$$ExternalSyntheticLambda3
          @Override // java.util.Comparator
          public final int compare(Object obj, Object obj2) {
            int lambda$executePolicy$2;
            lambda$executePolicy$2 =
                AggressivePolicyHandler.lambda$executePolicy$2(
    ...
    if (isGcReclaimEnabled()
        && j < 51200
        && triggerSource == ChimeraCommonUtil.TriggerSource.TRIGGER_SOURCE_HOME_IDLE) {
      performGcAndReclaim();
      return 0;
    }
    this.mReleasedMemory = 0L;
    ...
    this.mSystemRepository.log(
        "AggressivePolicyHandler",
        "Processing time(ms) " + (System.currentTimeMillis() - currentTimeMillis));
    return doKill;
  }

  public static /* synthetic */ int lambda$executePolicy$2(
  ...
  public int doKill(List list, long j, long j2, ChimeraCommonUtil.TriggerSource triggerSource) {
    boolean z;
    this.mSystemRepository.log(
        "AggressivePolicyHandler", "Start doKill, protected policy: " + this.mCurProtectLevel);
    if (list == null) {
      return 0;
    }
    ...
    while (true) {
      ...
      if (isAppKillable(chimeraAppInfo)) {
        ...
        while (true) {
          ...
          if (this.mAbnormalFgsDetector.isHeavyForegroundService(
              processInfo.pid, processInfo.pss, processInfo.importance)) {
            this.mAbnormalFgsDetector.putKillableHeavyApp(
                processInfo.processName, chimeraAppInfo.uid, processInfo.pss);
            z = true;
            break;
          }
        }
        if (!Arrays.stream(chimeraAppInfo.statsAndOomScores.mScores)
            .anyMatch(
                new IntPredicate() { // from class:
                                     // com.android.server.chimera.AggressivePolicyHandler$$ExternalSyntheticLambda4
        ...
        if (z || isExpiredKillInterval(chimeraAppInfo)) {
          ...
          for (ChimeraAppInfo.ProcessInfo processInfo2 : chimeraAppInfo.procList) {
            this.mSystemRepository.killProcessForChimera(
                processInfo2.processName,
                chimeraAppInfo.uid,
                "Chimera #" + triggerSource.ordinal());
          }
          i = (int) (i + chimeraAppInfo.pss);
          i2++;
          updateKillStatistics(chimeraAppInfo, triggerSource);
          ProtectLevel protectLevel = this.mCurProtectLevel;
          if ((protectLevel != ProtectLevel.NORMAL || !this.mIsKillBoostModeOnNormal)
              && (protectLevel != ProtectLevel.HEAVY || !this.mIsKillBoostModeOnHeavy)) {
    ...
    this.mSystemRepository.log(
        "AggressivePolicyHandler", "kill complete: killed " + i2 + " apps, freed " + i + " KB");
    return i2;
  }
  ...
  */
  public boolean hasProtectedAdjOrProcState(ChimeraAppInfo chimeraAppInfo) {
    ...
    if (chimeraAppInfo != null && chimeraAppInfo.statsAndOomScores != null) {
      ...
      while (true) {
        ...
        if (processStatsAndOomScores.mScores[i2] > 200
            || (!"com.sds.emm.sers".equals(chimeraAppInfo.packageName)
                && !chimeraAppInfo.packageName.startsWith("com.samsung.android.bixby.ondevice"))) {
          if (chimeraAppInfo.statsAndOomScores.mScores[i2]
                  < this.mPkgProtectedParameters[this.mCurProtectLevel.ordinal()][0]
              && chimeraAppInfo.statsAndOomScores.mScores[i2] >= -1000) {
            return true;
          }
          ...
          if ((!PolicyHandler.mIsBubEnabled && i == PolicyHandler.PICKED_OOM_ADJ)
              || i == 700
              || i == 300) {
            return true;
          }
  ...
  public void dump(PrintWriter printWriter, String[] strArr) {
    ...
    if ("-a".equals(strArr[0])) {
      ...
      if (this.mIsHeavyLaunchOn && this.mHeavyLaunchCounter.isHeavyLaunch()) {
        printWriter.println(
            "HeavyLaunch mode from " + this.mHeavyLaunchCounter.getLastStartedUpTime());
      }
    ...
    if (strArr.length > 0) {
      ...
      if (str.equals("set_normal_kill_interval") && strArr.length > 1) {
        try {
          this.mPkgProtectedParameters[ProtectLevel.NORMAL.ordinal()][2] =
      ...
      if (str.equals("set_heavy_kill_interval") && strArr.length > 1) {
        try {
          this.mPkgProtectedParameters[ProtectLevel.HEAVY.ordinal()][2] =
              Integer.parseInt(strArr[1]) * 1000;
  ...
  public final void dumpInfo(PrintWriter printWriter) {
    ...
    printWriter.println(
        "Heavy kill interval : "
            + toHHmmss((long) this.mPkgProtectedParameters[ProtectLevel.HEAVY.ordinal()][2]));
  ...
  public final void doGcReclaimIfNecessary(
      int i, ChimeraCommonUtil.TriggerSource triggerSource, long j, long j2) {
    if (isGcReclaimEnabled()) {
      if ((i == 0 || !isFreeTargetSatisfied(j, j2))
          && triggerSource == ChimeraCommonUtil.TriggerSource.TRIGGER_SOURCE_HOME_IDLE) {
        performGcAndReclaim();
      }
    }
