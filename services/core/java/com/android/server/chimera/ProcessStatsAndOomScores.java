...
public class ProcessStatsAndOomScores {
  ...
  public static ProcessStatsAndOomScores create(
    ...
    Pair processStatesAndOomScoresForPIDs =
        systemRepository.getProcessStatesAndOomScoresForPIDs(processStatsAndOomScores.mPids);
    ...
    return Arrays.stream(iArr)
        .anyMatch(
            new IntPredicate() { // from class:
                                 // com.android.server.chimera.ProcessStatsAndOomScores$$ExternalSyntheticLambda0
