...
public class SystemRepositoryDefault implements SystemRepository {
  ...
  public final IUidObserver mUidObserver =
      new IUidObserver.Stub() { // from class: com.android.server.chimera.SystemRepositoryDefault.1
  ...
  public final IProcessObserver mProcessObserver =
      new IProcessObserver
          .Stub() { // from class: com.android.server.chimera.SystemRepositoryDefault.2
        ...
        public void onForegroundActivitiesChanged(int i, int i2, boolean z) {
          synchronized (SystemRepositoryDefault.this.mChimeraProcessObservers) {
            ...
            if (packageNameFromUid != null && packageNameFromUid.length != 0) {
              ...
              boolean equals =
                  SystemRepositoryDefault.this
                      .getCurrentHomePackageName()
                      .equals(packageNameFromUid[0]);
              Iterator it = SystemRepositoryDefault.this.mChimeraProcessObservers.iterator();
              while (it.hasNext()) {
                ((SystemRepository.ChimeraProcessObserver) it.next())
                    .onForegroundActivitiesChanged(i, i2, z, userId, packageNameFromUid, equals);
              }
              if (!equals && z) {
                SystemRepositoryDefault.this.mLastForegroundApp =
                    Pair.create(packageNameFromUid[0], Long.valueOf(System.currentTimeMillis()));
              }
            }
          }
        }
  ...
  public final CameraManager.SemCameraDeviceStateCallback mCameraDeviceStateCallback =
      new CameraManager
          .SemCameraDeviceStateCallback() { // from class:
                                            // com.android.server.chimera.SystemRepositoryDefault.3
        public void onCameraDeviceStateChanged(String str, int i, int i2, String str2) {
          ...
          if (MARsPolicyManager.getInstance().isChinaPolicyEnabled()
              && SystemRepositoryDefault.this.mSystemEventListenerHandler != null
          ...
          if (SystemRepositoryDefault.this.mSystemEventListenerHandler != null
              && "com.sec.android.app.camera".equals(str2)) {
            if (i2 == 1) {
              SystemRepositoryDefault.this.mSystemEventListenerHandler.sendEmptyMessageDelayed(
                  12, 1000L);
            } else if (i2 == 3) {
              SystemRepositoryDefault.this.mSystemEventListenerHandler.sendEmptyMessageDelayed(
                  13, 1000L);
          ...
          if (i2 != 1
              || SystemRepositoryDefault.this.mLastForegroundApp == null
              || contains(str2)
              || !TextUtils.equals(
                  (CharSequence) SystemRepositoryDefault.this.mLastForegroundApp.first, str2)
              || System.currentTimeMillis()
                      - ((Long) SystemRepositoryDefault.this.mLastForegroundApp.second).longValue()
                  >= 3000) {
            return;
          }
          update(str2);
  ...
  public final ICollectionCache$BigGameAppsCache mBigGameApps =
      new ICollectionCache$AbstractSharedCollectionCache(
          this) { // from class: com.android.server.chimera.ICollectionCache$BigGameAppsCache
  ...
  public final ICollectionCache$CameraAppsCache mCameraApps =
      new ICollectionCache$AbstractSharedCollectionCache(
          this) { // from class: com.android.server.chimera.ICollectionCache$CameraAppsCache
        @Override // com.android.server.chimera.ICollectionCache$AbstractSharedCollectionCache
        public String getKey() {
  ...
  public class SmartSwitchEventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      Log.i(
          "SystemRepositoryDefault",
          "SmartSwitchEventReceiver() - mOnStart: "
              + this.mOnStart
              + ", mOnTransfer: "
              + this.mOnTransfer);
    }
  ...
  public long getMemmoryOfPid(int i) {
    ...
    try {
      for (int i2 = 0;
          i2 < this.mActivityManager.getProcessMemoryInfo(new int[] {i}).length;
          i2++) {
        j += r5[i2].getTotalPss();
      }
    } catch (Exception e) {
      ...
      if (this.mChimeraUidObservers.size() == 1) {
        try {
          ActivityManagerNative.getDefault()
              .registerUidObserver(this.mUidObserver, 2, -1, (String) null);
  ...
  public String[] getWakeLockPackageList() {
    return (String[])
        Optional.ofNullable((PowerManager) this.mContext.getSystemService("power"))
            .map(
                new Function() { // from class:
                                 // com.android.server.chimera.SystemRepositoryDefault$$ExternalSyntheticLambda3
            ...
            service.linkToDeath(
                new IBinder
                    .DeathRecipient() { // from class:
                                        // com.android.server.chimera.SystemRepositoryDefault$$ExternalSyntheticLambda6
  ...
  public List getFullPowerWhitelist() {
    return (List)
        Optional.ofNullable(getDeviceIdleController())
            .map(
                new Function() { // from class:
                                 // com.android.server.chimera.SystemRepositoryDefault$$ExternalSyntheticLambda4
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
                    String[] lambda$getFullPowerWhitelist$1;
                    lambda$getFullPowerWhitelist$1 =
                        SystemRepositoryDefault.lambda$getFullPowerWhitelist$1(
                            (IDeviceIdleController) obj);
                    return lambda$getFullPowerWhitelist$1;
                  }
                })
            .map(
                new Function() { // from class:
                                 // com.android.server.chimera.SystemRepositoryDefault$$ExternalSyntheticLambda5
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
  ...
  public static /* synthetic */ String[] lambda$getFullPowerWhitelist$1(
  ...
  public List getRunningAppProcesses() {
    ...
    for (ActivityManager.RunningAppProcessInfo runningAppProcessInfo :
        this.mActivityManagerService.getRunningAppProcesses()) {
      SystemRepository.RunningAppProcessInfo runningAppProcessInfo2 =
          new SystemRepository.RunningAppProcessInfo();
  ...
  public String getCurrentHomePackageName() {
    return (String)
        Optional.ofNullable(DefaultAppFilter.getInstance())
            .map(
                new Function() { // from class:
                                 // com.android.server.chimera.SystemRepositoryDefault$$ExternalSyntheticLambda2
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
    ...
    if (this.mSharedPreferences == null) {
      try {
        this.mSharedPreferences =
            this.mContext.getSharedPreferences(convertToChimeraTag("SystemRepositoryDefault"), 0);
      } catch (Exception e) {
  ...
  public List getAccessibilityServicePackages() {
    List<AccessibilityServiceInfo> enabledAccessibilityServiceList =
        AccessibilityManager.getInstance(this.mContext).getEnabledAccessibilityServiceList(-1);
    if (enabledAccessibilityServiceList == null) {
      return Collections.emptyList();
    }
    return (List)
        enabledAccessibilityServiceList.stream()
            .filter(
                new Predicate() { // from class:
                                  // com.android.server.chimera.SystemRepositoryDefault$$ExternalSyntheticLambda0
                  @Override // java.util.function.Predicate
                  public final boolean test(Object obj) {
                    boolean lambda$getAccessibilityServicePackages$2;
                    lambda$getAccessibilityServicePackages$2 =
                        SystemRepositoryDefault.lambda$getAccessibilityServicePackages$2(
                            (AccessibilityServiceInfo) obj);
                    return lambda$getAccessibilityServicePackages$2;
                  }
                })
            .map(
                new Function() { // from class:
                                 // com.android.server.chimera.SystemRepositoryDefault$$ExternalSyntheticLambda1
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
                    String lambda$getAccessibilityServicePackages$3;
                    lambda$getAccessibilityServicePackages$3 =
                        SystemRepositoryDefault.lambda$getAccessibilityServicePackages$3(
                            (AccessibilityServiceInfo) obj);
  ...
  public static /* synthetic */ boolean lambda$getAccessibilityServicePackages$2(
  ...
  public static /* synthetic */ String lambda$getAccessibilityServicePackages$3(
      AccessibilityServiceInfo accessibilityServiceInfo) {
      ...
      log(
          ...
          "sending bigdata : "
              + semHqmManager.sendHWParamToHQM(
                  0, "Sluggish", str, "ph", "1.1", "sec", "", str2, ""));
