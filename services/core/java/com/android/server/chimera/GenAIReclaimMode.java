...
public class GenAIReclaimMode {
  ...
  public static boolean FEATURE_ENABLED =
      SystemProperties.getBoolean("ro.slmk.genai_reclaim_mode", false);
  ...
  public class ModelEventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if ("com.samsung.GEN_AI_RECLAIM".equals(action)
          || "AICORE_BROADCAST_ACTION_MODEL_LOADING".equals(action)) {
        GenAIReclaimMode.this.setModeOn(true);
      } else if ("com.samsung.GEN_AI_RECLAIM_END".equals(action)
