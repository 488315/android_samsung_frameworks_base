...
public class PinnedSliceState {
                    ...
                    .map(
                        new Function() { // from class:
                          ...
                          public final Object apply(Object obj) {
                            ...
                            lambda$mergeSpecs$0 =
                                PinnedSliceState.this.lambda$mergeSpecs$0(
                                    sliceSpecArr, (SliceSpec) obj);
                            return lambda$mergeSpecs$0;
                          }
                        })
                    .filter(
                        new Predicate() { // from class:
                                          // com.android.server.slice.PinnedSliceState$$ExternalSyntheticLambda4
                          @Override // java.util.function.Predicate
                          public final boolean test(Object obj) {
                            boolean lambda$mergeSpecs$1;
                            lambda$mergeSpecs$1 =
                                PinnedSliceState.lambda$mergeSpecs$1((SliceSpec) obj);
                            return lambda$mergeSpecs$1;
                          }
                        })
                    .toArray(
                        new IntFunction() { // from class:
                                            // com.android.server.slice.PinnedSliceState$$ExternalSyntheticLambda5
  ...
  public /* synthetic */ SliceSpec lambda$mergeSpecs$0(
      SliceSpec[] sliceSpecArr, SliceSpec sliceSpec) {
    ...
    synchronized (this.mLock) {
      ...
      if (z) {
        ...
        this.mService
            ...
            .post(
                new Runnable() { // from class:
                                 // com.android.server.slice.PinnedSliceState$$ExternalSyntheticLambda2
                  @Override // java.lang.Runnable
                  public final void run() {
  ...
  public void pin(String str, SliceSpec[] sliceSpecArr, IBinder iBinder) {
    synchronized (this.mLock) {
      this.mListeners.put(
          iBinder,
          new ListenerInfo(iBinder, str, true, Binder.getCallingUid(), Binder.getCallingPid()));
      try {
