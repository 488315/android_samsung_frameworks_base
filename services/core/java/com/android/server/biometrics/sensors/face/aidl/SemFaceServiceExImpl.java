...
public class SemFaceServiceExImpl {
  ...
  public static SemFaceServiceExImpl createInstance(
      Context context, int i, Sensor sensor, FaceProvider faceProvider) {
    if (mSemFaceServiceExImpl == null) {
      mSemFaceServiceExImpl = new SemFaceServiceExImpl();
    }
    ...
    try {
      ...
      Slog.d(
          ...
          "semConnectSession ISehFace = "
              + this.mISehFace
              + ", "
              + this.mISehFace.getInterfaceVersion());
      this.mISehSession =
          this.mISehFace.createSession(this.mSensorId, this.mUserId, this.mISessionCallback);
  ...
  public void semResetConnection() {
    ...
    this.mHandlerMain.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda6
  ...
  public final void init() {
    ...
    this.mOrientationEventListener = new C08652(this.mContext, 3);
    if (Utils.isTablet()) {
      this.mProximitySensorMgr =
          new SemProximitySensorObserver(
              this
                  .mContext) { // from class:
                               // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl.3
            @Override // android.hardware.SensorEventListener
            public void onSensorChanged(SensorEvent sensorEvent) {
              if (!SemFaceServiceExImpl.this.mSensor.getTestHalEnabled()
    ...
    this.mSecurityLevel =
        Utils.propertyStrengthToOemStrength(this.mSensor.getSensorProperties().sensorStrength);
    Slog.w("SemFace", "SL :" + this.mSecurityLevel);
  }

  /* renamed from: com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$2 */
  public class C08652 extends OrientationEventListener {
    public C08652(Context context, int i) {
      super(context, i);
    }
      ...
      try {
        ...
        if (rotation != SemFaceServiceExImpl.this.mLastRotation) {
          ...
          if (SemFaceServiceExImpl.this.mIsOperationStarted) {
            SemFaceServiceExImpl.this.mHandlerMain.post(
                new Runnable() { // from class:
                                 // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$2$$ExternalSyntheticLambda0
                  @Override // java.lang.Runnable
                  public final void run() {
                    SemFaceServiceExImpl.C08652.this.lambda$onOrientationChanged$0();
                  }
                });
          }
        }
  ...
  public synchronized void startOperation(int i) {
    ...
    if (i == 1) {
      ...
      SemBioLoggingManager.get()
          .faceStart(
              this.mScheduler.getCurrentClient().getHashID(),
              "E",
              this.mScheduler.getCurrentClient().getOwnerString());
    } else if (i == 2) {
      int i3 =
    ...
    this.mHandlerMain.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final synchronized void stopOperation() {
    ...
    this.mHandlerMain.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final boolean isBrightnessEnable() {
    return (getCurrentClientUserID() == -10000
  ...
  public final void registerBroadcastEvents() {
    ...
    this.mContext.registerReceiver(new C08674(), intentFilter);
  }

  /* renamed from: com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$4 */
  public class C08674 extends BroadcastReceiver {
    public C08674() {}
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (action.equals("android.intent.action.ACTION_SHUTDOWN")) {
        SemFaceServiceExImpl.this.mHandlerMain.post(
            new Runnable() { // from class:
                             // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$4$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
                SemFaceServiceExImpl.C08674.this.lambda$onReceive$0();
              }
            });
      }
    }
  ...
  public final void onExtended(int i) {
    ...
    if (i != 2) {
      ...
      SemBioLoggingManager.get()
          .faceTimeout(this.mContext, getCurrentClientHashID(), currentTimeMillis, i3, 0);
    ...
    if (semBioAnalyticsManager3 != null) {
      if (z) {
        ...
        semBioAnalyticsManager3.faceOnAuthenticatedFailure(
            getCurrentClientOwnerString(), noMatchReason);
    ...
    SemBioLoggingManager.get()
        .faceNoMatch(this.mContext, getCurrentClientHashID(), currentTimeMillis, noMatchReason, 0);
  ...
  public void onRemovedExt(String str, int i) {
    if (this.mFaceUtils.getBiometricsForUser(this.mContext, getCurrentClientUserID()).size() > 0) {
      sendBroadcast(
          "com.samsung.android.bio.face.intent.action.FACE_REMOVED", i, getCurrentClientUserID());
    } else {
      sendBroadcast(
          "com.samsung.android.bio.face.intent.action.FACE_RESET", -1, getCurrentClientUserID());
    }
    SemBioAnalyticsManager semBioAnalyticsManager = this.mSemAnalyticsManager;
    if (semBioAnalyticsManager != null) {
  ...
  public void onEnrollResult(int i, int i2) {
    ...
    if (i2 == 0) {
      sendBroadcast(
          "com.samsung.android.bio.face.intent.action.FACE_ADDED", i, getCurrentClientUserID());
      SemBioAnalyticsManager semBioAnalyticsManager = this.mSemAnalyticsManager;
      if (semBioAnalyticsManager != null) {
  ...
  public boolean removeSavedFaceIdIfCancelled(int[] iArr) {
    ...
    Slog.i(
        "SemFace",
        "removeSavedFaceIdIfCancelled: remove registered face as enrollment is being cancelled");
    return true;
  }
  ...
  public final void onTimeout() {
    ...
    if (i == 2) {
      if (this.mIsAuthenticateResult) {
        ...
        this.mSensor
            .getSessionForUser(getCurrentClientUserID())
  ...
  public boolean onPreAuthenticationFailed() {
    Slog.d(
        "SemFace",
        "e=" + this.mIsEarlyStop + ", n=" + this.mNoMatchMaxCountNum + ", t=" + this.mIsTimeout);
    if (this.mSensor.getTestHalEnabled()) {
      return false;
    }
    if (!this.mIsOperationStarted) {
  ...
  public void doTemplateSyncForUser(int[] iArr) {
    ...
    List<Face> biometricsForUser =
        this.mFaceUtils.getBiometricsForUser(this.mContext, currentClientUserID);
    int length = iArr.length;
    try {
      Slog.i(
          "SemFace", "doTemplateSyncForUser: FW=" + biometricsForUser.size() + ", HAL=" + length);
      ...
      if (length == 0 || z) {
        if (biometricsForUser.size() > 0) {
          for (Face face : biometricsForUser) {
            this.mFaceUtils.removeBiometricForUser(
                this.mContext, currentClientUserID, face.getBiometricId());
            Slog.i("SemFace", "removing unknown template from fw, " + face.getBiometricId());
          }
          this.mHandlerMain.post(
              new Runnable() { // from class:
                               // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
      ...
      if (length > 0) {
        for (int i2 = 0; i2 < length; i2++) {
          ...
          if (i3 >= 0) {
            ...
            final Face face2 =
                new Face(
                    this.mFaceUtils.getUniqueName(this.mContext, currentClientUserID),
                    iArr[i2],
                    this.mSensorId);
            ...
            this.mHandlerMain.post(
                new Runnable() { // from class:
                                 // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda4
                  @Override // java.lang.Runnable
                  public final void run() {
                    SemFaceServiceExImpl.this.lambda$doTemplateSyncForUser$4(
                        face2, currentClientUserID);
                  }
                });
          }
        }
        for (final Face face3 : biometricsForUser) {
          this.mFaceUtils.removeBiometricForUser(
              this.mContext, currentClientUserID, face3.getBiometricId());
          Slog.i("SemFace", "removing unknown template from fw, " + face3.getBiometricId());
          SemBioLoggingManager.get().faceRemoved("doTemplateSyncForUser", -1);
          this.mHandlerMain.post(
              new Runnable() { // from class:
                               // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                  SemFaceServiceExImpl.this.lambda$doTemplateSyncForUser$5(
                      currentClientUserID, face3);
                }
              });
        }
      }
  ...
  public ICancellationSignal daemonAuthenticate(long j) {
    ...
    if (iSehSession == null) {
      ...
      this.mCancellationSignal =
          iSehSession.authenticateForIssuance(
              j,
              SemFaceUtils.getSecurityMode(getContext()),
              SemFaceUtils.getFidoRequestData(),
              true,
              this.mHwPreviewHandle);
    } else {
      this.mCancellationSignal =
          iSehSession.authenticateExtension(
              j, SemFaceUtils.getSecurityMode(getContext()), SemFaceUtils.getFidoRequestData());
    }
    return this.mCancellationSignal;
  }

  public ICancellationSignal daemonEnroll(
  ...
  public synchronized void daemonCancel(ICancellationSignal iCancellationSignal, boolean z) {
    ...
    if (!z) {
      this.mHandlerMain.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    try {
      ...
      Slog.w(
          ...
          "SetRotation FINISH ("
              + (System.currentTimeMillis() - currentTimeMillis)
              + "ms) RESULT: "
              + this.mISehSession.setRotation(getRotationValue(i)));
    } catch (Exception e) {
  ...
  public void daemonGetFeatures() {
    ...
    try {
      ...
      Slog.w(
          "SemFace",
          "daemonGetFeatures FINISH (" + (System.currentTimeMillis() - currentTimeMillis) + "ms)");
    } catch (RemoteException e) {
  ...
  public void daemonGetWrappedData() {
    ...
    try {
      ...
      Slog.i(
          "SemFace",
          "getWrappedData FINISH (" + (System.currentTimeMillis() - currentTimeMillis) + "ms)");
  ...
  public Bundle daemonGetWrappedDataFromMemory() {
    ...
    Slog.i(
        "SemFace",
        "getWrappedDataFromMemory FINISH ("
            + (System.currentTimeMillis() - currentTimeMillis)
            + "ms)");
    ByteBuffer mapReadOnly =
        SharedMemory.fromFileDescriptor(wrappedDataFromMemory.fd).mapReadOnly();
    if (mapReadOnly == null) {
  ...
  public final int daemonSetFaceTag(int i, byte[] bArr) {
    ...
    try {
      ...
      Slog.i(
          "SemFace",
          "setFaceTag FINISH (" + (System.currentTimeMillis() - currentTimeMillis) + "ms)");
      return 1;
    } catch (RemoteException e) {
  ...
  public void daemonClose() {
    ...
    try {
      ...
      Slog.w(
          "SemFace",
          "ISession.close: FINISH (" + (System.currentTimeMillis() - currentTimeMillis) + "ms)");
      this.mISession = null;
      if (this.mISehSession == null) {
  ...
  public final void sendAcquired(int i, int i2) {
    ...
    if (!(currentClient instanceof AcquisitionClient)) {
      Slog.e(
          "SemFace", "sendAcquired - not AcquisitionClient: " + Utils.getClientName(currentClient));
      return;
    }
  ...
  public final void sendSucceeded(Bundle bundle) {
    ...
    if (!(currentClient instanceof AcquisitionClient)) {
      Slog.e(
          "SemFace", "sendSuccess - not AcquisitionClient: " + Utils.getClientName(currentClient));
      return;
    }
    try {
  ...
  public final void sendFailed() {
    ...
    if (!(currentClient instanceof AcquisitionClient)) {
      Slog.e(
          "SemFace", "sendFailed - not AcquisitionClient: " + Utils.getClientName(currentClient));
      return;
    }
    try {
  ...
  public boolean isUsingSehAPI() {
    return (this.mSensor.getTestHalEnabled()
