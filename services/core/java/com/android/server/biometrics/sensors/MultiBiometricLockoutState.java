...
public class MultiBiometricLockoutState {
    ...
    if (i2 == 15) {
      ...
      if (i2 != 4095) {
        Slog.e(
            ...
            "increaseLockoutTime called for invalid strength : " + i2);
        return;
      }
  ...
  public int getLockoutState(int i, int i2) {
    ...
    if (!authMapForUser.containsKey(Integer.valueOf(i2))) {
      Slog.e(
          "MultiBiometricLockoutState",
          "Error, getLockoutState for unknown strength: " + i2 + " returning LOCKOUT_NONE");
      return 0;
    }
                      ...
                      .entrySet().stream()
                          .map(
                              new Function() { // from class:
                                               // com.android.server.biometrics.sensors.MultiBiometricLockoutState$$ExternalSyntheticLambda0
                                @Override // java.util.function.Function
                                public final Object apply(Object obj) {
                                  String lambda$toString$0;
                                  lambda$toString$0 =
                                      MultiBiometricLockoutState.lambda$toString$0(
                                          millis, (Map.Entry) obj);
  ...
  public class AuthenticatorState {
    ...
    public String toString(long j) {
      return String.format(
          "(%s, permanentLockout=%s, timedLockout=%s)",
          BiometricManager.authenticatorToStr(this.mAuthenticatorType.intValue()),
          this.mPermanentlyLockedOut ? "true" : "false",
          this.mTimedLockout ? "true" : "false");
    }
  }
}
