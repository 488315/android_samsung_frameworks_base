...
public abstract class AidlConversionUtils {
  ...
  public static FaceEnrollFrame toFrameworkEnrollmentFrame(EnrollmentFrame enrollmentFrame) {
    return new FaceEnrollFrame(
        toFrameworkCell(enrollmentFrame.cell),
        toFrameworkEnrollmentStage(enrollmentFrame.stage),
        toFrameworkBaseFrame(enrollmentFrame.data));
  }

  public static FaceDataFrame toFrameworkBaseFrame(BaseFrame baseFrame) {
    return new FaceDataFrame(
        toFrameworkAcquiredInfo(baseFrame.acquiredInfo),
