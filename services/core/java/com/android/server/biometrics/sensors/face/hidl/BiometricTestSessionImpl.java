...
public class BiometricTestSessionImpl extends ITestSession.Stub {
  ...
  public final IFaceServiceReceiver mReceiver =
      new IFaceServiceReceiver
          .Stub() { // from class:
                    // com.android.server.biometrics.sensors.face.hidl.BiometricTestSessionImpl.1
  ...
  public BiometricTestSessionImpl(
      ...
      Face10 face10,
      Face10.HalResultController halResultController) {
  ...
  public void acceptAuthentication(int i) {
    ...
    List biometricsForUser =
        FaceUtils.getLegacyInstance(this.mSensorId).getBiometricsForUser(this.mContext, i);
    if (biometricsForUser.isEmpty()) {
      Slog.w("BiometricTestSessionImpl", "No faces, returning");
      return;
    }
    this.mHalResultController.onAuthenticated(
        0L,
  ...
  public void cleanupInternalState(int i) {
    ...
    this.mFace10.scheduleInternalCleanup(
        this.mSensorId,
        i,
        new ClientMonitorCallback() { // from class:
                                      // com.android.server.biometrics.sensors.face.hidl.BiometricTestSessionImpl.2
