...
public class InvalidationRequesterClient extends BaseClientMonitor {
    ...
    this.mInvalidationCallback =
        new IInvalidationCallback
          ...
          public void onCompleted() {
            InvalidationRequesterClient.this.mUtils.setInvalidationInProgress(
                InvalidationRequesterClient.this.getContext(),
                InvalidationRequesterClient.this.getTargetUserId(),
                false);
            InvalidationRequesterClient invalidationRequesterClient =
                InvalidationRequesterClient.this;
            invalidationRequesterClient.mCallback.onClientFinished(
                invalidationRequesterClient, true);
          }
        };
  ...
  public void start(ClientMonitorCallback clientMonitorCallback) {
    ...
    this.mBiometricManager.invalidateAuthenticatorIds(
        getTargetUserId(), getSensorId(), this.mInvalidationCallback);
  }
}
