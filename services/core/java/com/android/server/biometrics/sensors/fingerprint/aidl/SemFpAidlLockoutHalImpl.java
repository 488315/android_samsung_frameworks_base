...
public class SemFpAidlLockoutHalImpl implements LockoutTracker {
  ...
  public SemFpAidlLockoutHalImpl(
      Context context,
    ...
    context.registerReceiver(
        new BroadcastReceiver() { // from class:
                                  // com.android.server.biometrics.sensors.fingerprint.aidl.SemFpAidlLockoutHalImpl.1
        ...
        new IntentFilter(ACTION_LOCKOUT_RESET),
  ...
  public final PendingIntent getLockoutResetIntentForUser(int i) {
    return PendingIntent.getBroadcast(
        this.mContext,
        i,
        new Intent(ACTION_LOCKOUT_RESET).putExtra(KEY_LOCKOUT_RESET_USER, i),
        201326592);
  }
}
