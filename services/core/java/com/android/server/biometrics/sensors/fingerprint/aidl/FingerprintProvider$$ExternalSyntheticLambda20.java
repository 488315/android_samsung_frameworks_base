...
public final /* synthetic */ class FingerprintProvider$$ExternalSyntheticLambda20
        implements Runnable {
    ...
    public /* synthetic */ FingerprintProvider$$ExternalSyntheticLambda20(
            FingerprintProvider fingerprintProvider, int i, Object obj, Object obj2, int i2) {
        this.$r8$classId = i2;
        ...
        switch (this.$r8$classId) {
            ...
            default:
                ...
                ClientMonitorCallbackConverter clientMonitorCallbackConverter =
                        (ClientMonitorCallbackConverter) this.f$3;
                ...
                SemFpSensorTestClient semFpSensorTestClient =
                        new SemFpSensorTestClient(
                                ...
                                ((Sensor) fingerprintProvider3.mFingerprintSensors.mSensors.get(i5))
                                        .mLazySession,
                                iBinder,
                                clientMonitorCallbackConverter,
                                i5,
                                0,
                                "FingerprintSensorTestClient",
                                true,
                                3,
                                0,
                                null,
                ...
                if (((Sensor) fingerprintProvider3.mFingerprintSensors.mSensors.get(i5)) != null) {
                    ((Sensor) fingerprintProvider3.mFingerprintSensors.mSensors.get(i5))
                            .mScheduler.scheduleClientMonitor(semFpSensorTestClient, null);
                    break;
                }
                break;
        }
