...
public class SemBiometricDisplayStateMonitor extends SemBiometricDisplayMonitor {
  ...
  public void onStart(final int i, final int i2, final int i3) {
    ...
    if (SemBiometricFeature.FP_FEATURE_SUPPORT_LOCAL_HBM
        && i2 != 2
        && (runnable = this.mRunnableLocalHbmOff) != null) {
      runnable.run();
    }
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemBiometricDisplayStateMonitor$$ExternalSyntheticLambda1
  ...
  public void onFinish(final int i, final int i2, final int i3) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemBiometricDisplayStateMonitor$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
