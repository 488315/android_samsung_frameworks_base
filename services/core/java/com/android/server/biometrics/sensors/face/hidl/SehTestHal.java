...
public class SehTestHal extends ISehBiometricsFace.Stub {
  ...
  @Override // vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFace
  public void sehGetFaceTag(
      int i, ISehBiometricsFace.sehGetFaceTagCallback sehgetfacetagcallback) {}

  @Override // vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFace
  public void sehGetFaceTagList(
      ISehBiometricsFace.sehGetFaceTagListCallback sehgetfacetaglistcallback) {}
        ...
        new Handler(
            this.mThread
                .getLooper()) { // from class:
                                // com.android.server.biometrics.sensors.face.hidl.SehTestHal.1
  ...
  public int enroll(ArrayList arrayList, int i, ArrayList arrayList2) {
    ...
    if (this.isEnrollSessionOpen) {
      ...
      this.f1655mH.sendEmptyMessageDelayed(100, action.getDelay());
      Slog.d(
          "face.hidl.SehTestHal",
          "start enroll: " + this.mFaceId + ", action size = " + this.currentActionList.size());
    } else {
  ...
  public final int getEmptyFaceIdForEnroll() {
    List biometricsForUser =
        FaceUtils.getInstance(this.mSensorId).getBiometricsForUser(this.mContext, this.mUserId);
    boolean z = false;
    int i = 1;
    while (!z) {
  ...
  public int remove(int i) {
    ...
    iSehBiometricsFaceClientCallback.onRemoved(
        0L, new ArrayList(Collections.singletonList(Integer.valueOf(i))), this.mUserId);
    return 0;
  }
  ...
  @Override // vendor.samsung.hardware.biometrics.face.V2_0.ISehBiometricsFace
  public void sehGetSecurityLevel(
  ...
  public int sehAuthenticate(long j, int i, ArrayList arrayList) {
    ...
    Slog.d(
        "face.hidl.SehTestHal",
        "start authenticate: " + this.mFaceId + ", action size = " + this.currentActionList.size());
    return 0;
  }
  ...
  public int sehResumeEnrollment() {
    this.f1655mH.sendEmptyMessageDelayed(100, 0L);
    return 0;
  }

  public void postUpdateAction() {
    this.f1655mH.post(new SehTestHal$$ExternalSyntheticLambda0(this));
  }
  ...
  public final void InitTPA(int i) {
    this.mTestHalHelper =
        new SemTestHalHelper(
            8,
            new SemTestHalHelper
                .Callback() { // from class:
                              // com.android.server.biometrics.sensors.face.hidl.SehTestHal.2
              @Override // com.android.server.biometrics.sensors.SemTestHalHelper.Callback
              public void deliverAcquiredEvent(int i2, int i3) {
                try {
                  SehTestHal.this.mCallback.onAcquired(0L, SehTestHal.this.mUserId, i2, i3);
                } catch (Exception e) {
                  e.printStackTrace();
                }
              }
              ...
              public void deliverErrorEvent(int i2, int i3) {
                try {
                  SehTestHal.this.mCallback.onError(0L, SehTestHal.this.mUserId, i2, i3);
                } catch (Exception e) {
                  e.printStackTrace();
                }
              }
              ...
              public void deliverEnrollResult(int i2) {
                try {
                  SehTestHal.this.mCallback.onEnrollResult(
                      0L, SehTestHal.this.mFaceId, SehTestHal.this.mUserId, i2);
                } catch (Exception e) {
                  e.printStackTrace();
                }
              }
              ...
              public void deliverAuthenticationResult(int i2) {
                try {
                  SehTestHal.this.mCallback.onAuthenticated(
                      0L, i2, SehTestHal.this.mUserId, new ArrayList());
                } catch (Exception e) {
                  e.printStackTrace();
                }
              }
  ...
  public final void doAction() {
    ...
    action.run();
    if (this.currentAction.getCallbackType() == SemTestHalHelper.CallbackType.ACQUIRED
        && this.currentAction.getCode() == 22
        && this.currentAction.getVendorCode() == 1016) {
      this.mGlassesOn = true;
    } else if (this.mGlassesOn
        && this.currentAction.getCallbackType() == SemTestHalHelper.CallbackType.ENROLL_RESULT
        && this.currentAction.getValue() == 30) {
    ...
    if (this.currentActionListPos + 1 < this.currentActionList.size()) {
      ...
      this.f1655mH.sendEmptyMessageDelayed(100, action2.getDelay());
    }
  }
}
