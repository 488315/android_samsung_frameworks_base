...
public final /* synthetic */ class AidlResponseHandler$$ExternalSyntheticLambda6
        implements Consumer {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ AidlResponseHandler f$0;
    public final /* synthetic */ long f$1;

    public /* synthetic */ AidlResponseHandler$$ExternalSyntheticLambda6(
            AidlResponseHandler aidlResponseHandler, long j, int i) {
        this.$r8$classId = i;
    ...
    public final void accept(Object obj) {
        switch (this.$r8$classId) {
            case 0:
                ...
                long j = this.f$1;
                FaceGenerateChallengeClient faceGenerateChallengeClient =
                        (FaceGenerateChallengeClient) obj;
                ...
                try {
                    ClientMonitorCallbackConverter clientMonitorCallbackConverter =
                            faceGenerateChallengeClient.mListener;
                    ...
                    faceGenerateChallengeClient.mCallback.onClientFinished(
                            faceGenerateChallengeClient, true);
                    break;
                } catch (RemoteException e) {
                    Slog.e("FaceGenerateChallengeClient", "Unable to send challenge", e);
                    faceGenerateChallengeClient.mCallback.onClientFinished(
                            faceGenerateChallengeClient, false);
                    return;
                }
            default:
                AidlResponseHandler aidlResponseHandler2 = this.f$0;
                long j2 = this.f$1;
                FaceRevokeChallengeClient faceRevokeChallengeClient =
                        (FaceRevokeChallengeClient) obj;
                aidlResponseHandler2.getClass();
                faceRevokeChallengeClient.mCallback.onClientFinished(
                        faceRevokeChallengeClient, j2 == faceRevokeChallengeClient.mChallenge);
                break;
        }
    }
}
