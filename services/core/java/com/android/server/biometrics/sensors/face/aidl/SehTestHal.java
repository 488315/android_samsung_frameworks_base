...
public class SehTestHal extends IFace.Stub {
        ...
        new Handler(
            this.mThread
                .getLooper()) { // from class:
                                // com.android.server.biometrics.sensors.face.aidl.SehTestHal.1
  ...
  public ISession createSession(int i, int i2, final ISessionCallback iSessionCallback) {
    ...
    return new ISession
        .Stub() { // from class: com.android.server.biometrics.sensors.face.aidl.SehTestHal.2
      ...
      public final boolean isEnrolledFace() {
        List biometricsForUser =
            FaceUtils.getInstance(SehTestHal.this.mSensorId)
                .getBiometricsForUser(SehTestHal.this.mContext, SehTestHal.this.mUserId);
      ...
      public ICancellationSignal enroll(
        ...
        if (SehTestHal.this.isEnrollSessionOpen) {
          ...
          sehTestHal3.currentAction =
              (SemTestHalHelper.Action)
                  sehTestHal3.currentActionList.get(sehTestHal3.currentActionListPos);
          SehTestHal.this.f1654mH.sendEmptyMessageDelayed(
              100, SehTestHal.this.currentAction.getDelay());
          Slog.d(
              "face.aidl.SehTestHal",
              "start enroll: "
                  + SehTestHal.this.mFaceId
                  + ", action size = "
                  + SehTestHal.this.currentActionList.size());
        } else {
          Slog.e("face.aidl.SehTestHal", "enroll : generateChallenge not done");
        }
        return new ICancellationSignal
            .Stub() { // from class: com.android.server.biometrics.sensors.face.aidl.SehTestHal.2.1
          public String getInterfaceHash() {
      ...
      public ICancellationSignal authenticate(long j) {
        ...
        Slog.d(
            ...
            "start authenticate: "
                ...
                + SehTestHal.this.currentActionList.size());
        return new ICancellationSignal
            .Stub() { // from class: com.android.server.biometrics.sensors.face.aidl.SehTestHal.2.2
          public String getInterfaceHash() {
            return "a9ebb97f5abea1dc6800b69d821ef61944e80e65";
          }
      ...
      public ICancellationSignal detectInteraction() {
        ...
        return new ICancellationSignal
            .Stub() { // from class: com.android.server.biometrics.sensors.face.aidl.SehTestHal.2.3
          public String getInterfaceHash() {
            return "a9ebb97f5abea1dc6800b69d821ef61944e80e65";
          }
  ...
  public void postUpdateAction() {
    this.f1654mH.post(new SehTestHal$$ExternalSyntheticLambda0(this));
  }
  ...
  public final void InitTPA(int i) {
    this.mTestHalHelper =
        new SemTestHalHelper(
            ...
            new SemTestHalHelper
                .Callback() { // from class:
                              // com.android.server.biometrics.sensors.face.aidl.SehTestHal.3
              ...
              public void deliverAuthenticationResult(int i2) {
                try {
                  if (i2 > 0) {
                    SehTestHal.this.mCallback.onAuthenticationSucceeded(
                        i2, HardwareAuthTokenUtils.toHardwareAuthToken(new byte[69]));
                  } else {
  ...
  public final void doAction() {
    ...
    if (this.currentActionListPos + 1 < this.currentActionList.size()) {
      ...
      this.f1654mH.sendEmptyMessageDelayed(100, action2.getDelay());
    }
  }
}
