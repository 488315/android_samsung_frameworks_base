...
public class BiometricTestSessionImpl extends ITestSession.Stub {
  ...
  public final IFingerprintServiceReceiver mReceiver =
      new IFingerprintServiceReceiver
          .Stub() { // from class:
                    // com.android.server.biometrics.sensors.fingerprint.hidl.BiometricTestSessionImpl.1
  ...
  public BiometricTestSessionImpl(
      ...
      Fingerprint21.HalResultController halResultController) {
  ...
  public void startEnroll(int i) {
    ...
    this.mFingerprint21.scheduleEnroll(
        this.mSensorId,
        new Binder(),
        new byte[69],
        i,
  ...
  public void acceptAuthentication(int i) {
    ...
    List biometricsForUser =
        FingerprintUtils.getLegacyInstance(this.mSensorId).getBiometricsForUser(this.mContext, i);
  ...
  public void cleanupInternalState(int i) {
    ...
    this.mFingerprint21.scheduleInternalCleanup(
        this.mSensorId,
        i,
        new ClientMonitorCallback() { // from class:
                                      // com.android.server.biometrics.sensors.fingerprint.hidl.BiometricTestSessionImpl.2
