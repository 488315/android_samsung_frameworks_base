...
public class SehTestHal extends ISehBiometricsFingerprint.Stub {
  ...
  public void deliverEnrollResult(int i) {
    if (this.mIsTpaMode) {
      try {
        this.mCallback.onEnrollResult(
            this.mDeviceId, this.mCurrentEnrollmentId, this.mCurrentUserID, i);
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
    ...
    if (this.mIsTpaMode) {
      try {
        ...
        this.mCallback.onAuthenticated(
            ...
            i,
            this.mCurrentUserID,
            new ArrayList(Collections.nCopies(69, (byte) 0)));
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
  ...
  public final int enrollTPA(byte[] bArr, int i, int i2) {
    ...
    this.f1664mH.postDelayed(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.hidl.SehTestHal$$ExternalSyntheticLambda2
  ...
  public int cancel() {
    if (this.mIsTpaMode) {
      ...
      this.f1664mH.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.fingerprint.hidl.SehTestHal$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public /* synthetic */ void lambda$authenticateTPA$2(int i) {
    ...
    Slog.d(
        "fingerprint.hidl.SehTestHal",
        "start authenticateTPA: " + i + ", action size = " + authActionList.size());
  ...
  public void postUpdateAction() {
    this.f1664mH.post(new SehTestHal$$ExternalSyntheticLambda1(this));
  }
