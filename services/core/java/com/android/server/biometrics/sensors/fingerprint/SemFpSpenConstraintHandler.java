...
public class SemFpSpenConstraintHandler
    implements SemFpEventListener, SemFpEnrollmentListener, SemFpAuthenticationListener {
  static final String ACTION_FOD_UPDATE =
      "com.samsung.android.fingerprint.action.FINGER_ON_DISPLAY";
  ...
  /* renamed from: mH */
  public final Handler f1659mH = SemFpMainThread.get().getHandler();
  public final Runnable mRunnableHandleTspBlockAction =
      new Runnable() { // from class:
                       // com.android.server.biometrics.sensors.fingerprint.SemFpSpenConstraintHandler$$ExternalSyntheticLambda1
  ...
  public final void startObserveTspBlockEvent() {
    ...
    this.mTspBrReceiver =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.biometrics.sensors.fingerprint.SemFpSpenConstraintHandler.1
          ...
          public void onReceive(Context context, Intent intent) {
            if (SemFpSpenConstraintHandler.ACTION_FOD_UPDATE.equals(intent.getAction())) {
              ...
              if (intExtra == SemFpSpenConstraintHandler.EXTRA_FOD_UPDATE_TSP_BLOCK
                  && !SemFpSpenConstraintHandler.this.mIsTspBlocked) {
                SemFpSpenConstraintHandler.this.mIsTspBlocked = true;
                SemFpSpenConstraintHandler.this.handleTspBlockAction(
                    FrameworkStatsLog.f446x58c6c32);
              } else if (intExtra == SemFpSpenConstraintHandler.EXTRA_FOD_UPDATE_TSP_UNBLOCK
                  && SemFpSpenConstraintHandler.this.mIsTspBlocked) {
    ...
    Utils.registerBroadcastAsUser(
        this.mContext,
        this.mTspBrReceiver,
        new IntentFilter(ACTION_FOD_UPDATE),
        UserHandle.ALL,
        this.f1659mH);
  }

  public void handleTspBlockAction(int i) {
    this.f1659mH.removeCallbacks(this.mRunnableHandleTspBlockAction);
    this.f1659mH.postDelayed(this.mRunnableHandleTspBlockAction, i);
  }
  ...
  public void onEnrollStarted(final int i, int i2) {
    this.f1659mH.postDelayed(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpSpenConstraintHandler$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void onAuthenticationStarted(final int i, int i2) {
    this.f1659mH.postDelayed(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpSpenConstraintHandler$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$onEnrollStarted$1(int i) {
    ((ServiceProvider) this.mProvider.second)
        .semRequest(i, 35, this.mIsTspBlocked ? 1 : 0, null, null);
  }
