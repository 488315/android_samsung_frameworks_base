...
public class SemTestHalHelper {
  ...
  public class Action implements Runnable {
    ...
    public void run() {
      ...
      switch (AbstractC08431.f1653x648fe824[this.callbackType.ordinal()]) {
        case 1:
  ...
  /* renamed from: com.android.server.biometrics.sensors.SemTestHalHelper$1 */
  public abstract /* synthetic */ class AbstractC08431 {

    /* renamed from: $SwitchMap$com$android$server$biometrics$sensors$SemTestHalHelper$CallbackType */
    public static final /* synthetic */ int[] f1653x648fe824;
    ...
    static {
      ...
      try {
        f1653x648fe824[CallbackType.ERROR.ordinal()] = 2;
      } catch (NoSuchFieldError unused2) {
      }
      try {
        f1653x648fe824[CallbackType.ENROLL_RESULT.ordinal()] = 3;
      } catch (NoSuchFieldError unused3) {
      }
      try {
        f1653x648fe824[CallbackType.AUTHENTICATED.ordinal()] = 4;
      } catch (NoSuchFieldError unused4) {
      }
      try {
        f1653x648fe824[CallbackType.TSP_FOD.ordinal()] = 5;
      } catch (NoSuchFieldError unused5) {
      }
      try {
        f1653x648fe824[CallbackType.ENUMERATE.ordinal()] = 6;
  ...
  public final void addDefaultEnrollAction() {
    ...
    if (this.mBiometricType == 2) {
      for (int i = 1; i <= 5; i++) {
        ...
        this.mEnrollActionList.add(
            new Action(CallbackType.ENROLL_RESULT, this.mCallback, 100 - (i * 20)));
  ...
  public final void addFpCaptureFailedAction(List list, int i, int i2) {
    ...
    list.add(
        new Action(callbackType, this.mCallback, 6, FrameworkStatsLog.BLUETOOTH_BYTES_TRANSFER));
  ...
  public final String getActionPath() {
    ...
    return i == 2
        ? "/data/.biometric/fingerprint/tpa.json"
        : i == 8 ? "/data/.biometric/face/tpa.json" : "";
  }
        ...
        if (!jSONObject.has((String) pair.first)) {
          ...
          if (!jSONObject2.has("actionList")) {
            ...
            if (jSONObject2.has("delay")) {
              ...
              Slog.d(
                  "SemTestHalHelper",
                  "makeActionFromJSONObject: key = "
                      + ((String) pair.first)
                      + ", delay = "
                      + this.mDelayAuthAction);
            }
            ...
            for (int i = 0; i < length; i++) {
              ...
              if (i2 == 1) {
                action =
                    new Action(
                        CallbackType.ACQUIRED,
                        this.mCallback,
                        jSONObject3.getInt("acquiredInfo"),
                        jSONObject3.getInt("vendorCode"));
              } else if (i2 == 2) {
                action =
                    new Action(
                        CallbackType.ENROLL_RESULT,
                        this.mCallback,
                        jSONObject3.getInt("remaining"));
              } else if (i2 == 3) {
                action =
                    new Action(
                        CallbackType.AUTHENTICATED, this.mCallback, jSONObject3.getInt("Id"));
              } else if (i2 == 4) {
                action =
                    new Action(
                        CallbackType.ERROR,
                        this.mCallback,
                        jSONObject3.getInt("errorCode"),
                        jSONObject3.getInt("vendorCode"));
              } else {
                action =
                    i2 != 7
                        ? null
                        : new Action(
                            CallbackType.TSP_FOD, this.mCallback, jSONObject3.getInt("TspEvent"));
              }
              if (action != null) {
