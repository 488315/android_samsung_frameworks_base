...
public abstract class InternalEnumerateClient extends HalClientMonitor
  ...
  public final void handleEnumeratedTemplate(BiometricAuthenticator.Identifier identifier) {
    ...
    while (true) {
      ...
      if (((BiometricAuthenticator.Identifier) this.mEnrolledList.get(i)).getBiometricId()
  ...
  public final void doTemplateCleanup() {
    ...
    for (int i = 0; i < this.mEnrolledList.size(); i++) {
      BiometricAuthenticator.Identifier identifier =
          (BiometricAuthenticator.Identifier) this.mEnrolledList.get(i);
      Slog.e(
          "Biometrics/InternalEnumerateClient",
      ...
      this.mUtils.removeBiometricForUser(
          getContext(), getTargetUserId(), identifier.getBiometricId());
