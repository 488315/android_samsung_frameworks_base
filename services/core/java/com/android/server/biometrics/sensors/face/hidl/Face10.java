...
public class Face10 implements IHwBinder.DeathRecipient, ServiceProvider {
    ...
    public Face10(Context context, BiometricStateCallback biometricStateCallback, FaceSensorPropertiesInternal faceSensorPropertiesInternal, LockoutResetDispatcher lockoutResetDispatcher, Handler handler, BiometricScheduler biometricScheduler, BiometricContext biometricContext) {
        SemLockoutFrameworkImpl.LockoutResetCallback lockoutResetCallback = new SemLockoutFrameworkImpl.LockoutResetCallback() { // from class: com.android.server.biometrics.sensors.face.hidl.Face10.1
        ...
        SynchronousUserSwitchObserver synchronousUserSwitchObserver = new SynchronousUserSwitchObserver() { // from class: com.android.server.biometrics.sensors.face.hidl.Face10.2
    ...
    */
    public final synchronized IBiometricsFace getDaemon() {
        ...
        try {
            ...
            if (SemBiometricFeature.FEATURE_JDM_HAL) {
                ...
                j = ((vendor.samsung.hardware.biometrics.face.V3_0.ISehBiometricsFace) this.mDaemon).sehSetCallbackEx(this.mHalResultController).value;
            }
            try {
                Slog.w("Face10", "SetCallback FINISH (" + (System.currentTimeMillis() - currentTimeMillis) + "ms) RESULT(HAL id): " + j);
                long currentTimeMillis2 = System.currentTimeMillis();
                ((ISehBiometricsFace) this.mDaemon).sehGetSecurityLevel(new ISehBiometricsFace.sehGetSecurityLevelCallback() { // from class: com.android.server.biometrics.sensors.face.hidl.Face10$$ExternalSyntheticLambda13
                ...
                Slog.w("Face10", "SecurityLevel FINISH (" + (System.currentTimeMillis() - currentTimeMillis2) + "ms) ");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$scheduleEnroll$6(int i, IBinder iBinder, IFaceServiceReceiver iFaceServiceReceiver, byte[] bArr, final String str, long j, int[] iArr, Surface surface) {
        scheduleUpdateActiveUserWithoutHandler(i);
        BiometricNotificationUtils.cancelReEnrollNotification(this.mContext);
        final FaceEnrollClient faceEnrollClient = new FaceEnrollClient(this.mContext, this.mLazyDaemon, iBinder, new ClientMonitorCallbackConverter(iFaceServiceReceiver), i, bArr, str, j, FaceUtils.getLegacyInstance(this.mSensorId), iArr, 75, surface, this.mSensorId, createLogger(1, 0), this.mBiometricContext) { // from class: com.android.server.biometrics.sensors.face.hidl.Face10.5
        ...
        this.mScheduler.lambda$scheduleClientMonitor$1(faceEnrollClient, new ClientMonitorCallback() { // from class: com.android.server.biometrics.sensors.face.hidl.Face10.6
            @Override // com.android.server.biometrics.sensors.ClientMonitorCallback
            public void onClientStarted(BaseClientMonitor baseClientMonitor) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$scheduleAuthenticate$8(final FaceAuthenticateOptions faceAuthenticateOptions, boolean z, IBinder iBinder, long j, ClientMonitorCallbackConverter clientMonitorCallbackConverter, long j2, boolean z2, int i, int i2) {
        ...
        FaceAuthenticationClient faceAuthenticationClient = new FaceAuthenticationClient(this.mContext, this.mLazyDaemon, iBinder, j, clientMonitorCallbackConverter, j2, z2, faceAuthenticateOptions, i, false, createLogger(2, i2), this.mBiometricContext, isStrongBiometric, this.mLockoutTracker, this.mUsageStats, hasPrivilegedAttr, Utils.getCurrentStrength(this.mSensorId)) { // from class: com.android.server.biometrics.sensors.face.hidl.Face10.7
            @Override // com.android.server.biometrics.sensors.face.hidl.FaceAuthenticationClient
            public void daemonAuthenticate(long j3) {
                SemBioLoggingManager.get().faceStart(getHashID(), "A", faceAuthenticateOptions.getOpPackageName());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$scheduleGetFeature$14(int i, final int i2, IBinder iBinder, ClientMonitorCallbackConverter clientMonitorCallbackConverter, String str, final int i3) {
        List enrolledFaces = getEnrolledFaces(i, i2);
        if (enrolledFaces.isEmpty()) {
    ...
    public final class ProviderExtensionImpl {
        ...
        public final void setCancellationSignal(final FaceAuthenticationClient faceAuthenticationClient, final long j) {
            ...
            cancellationSignal.setOnCancelListener(new CancellationSignal.OnCancelListener() { // from class: com.android.server.biometrics.sensors.face.hidl.Face10.ProviderExtensionImpl.7
                ...
                public void onCancel() {
                    Face10.this.cancelAuthentication(faceAuthenticationClient.getSensorId(), faceAuthenticationClient.getToken(), j);
                }
            });
