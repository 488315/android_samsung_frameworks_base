...
public class SemConcurrentBiometricScheduler extends BiometricScheduler {
  public SemConcurrentBiometricScheduler(
      String str,
      int i,
      Handler handler,
  ...
  public void lambda$startPreparedClient$0(final int i) {
    if (!isRunOnMyThread()) {
      Slog.w(
          getTag(), "startPreparedClient: it's not running on main thread, " + Looper.myLooper());
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.SemConcurrentBiometricScheduler$$ExternalSyntheticLambda3
  ...
  public void lambda$scheduleClientMonitor$1(
      final BaseClientMonitor baseClientMonitor,
      final ClientMonitorCallback clientMonitorCallback) {
    if (!isRunOnMyThread()) {
      Slog.w(
          getTag(), "scheduleClientMonitor: it's not running on main thread, " + Looper.myLooper());
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.SemConcurrentBiometricScheduler$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              SemConcurrentBiometricScheduler.this.lambda$scheduleClientMonitor$1(
                  baseClientMonitor, clientMonitorCallback);
            }
          });
      return;
    }
  ...
  public void lambda$cancelEnrollment$2(final IBinder iBinder, final long j) {
    if (!isRunOnMyThread()) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.SemConcurrentBiometricScheduler$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void lambda$cancelAuthenticationOrDetection$3(final IBinder iBinder, final long j) {
    if (!isRunOnMyThread()) {
      Slog.w(
          getTag(),
          "cancelAuthenticationOrDetection: it's not running on main thread, " + Looper.myLooper());
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.SemConcurrentBiometricScheduler$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
              SemConcurrentBiometricScheduler.this.lambda$cancelAuthenticationOrDetection$3(
                  iBinder, j);
            }
          });
      return;
  ...
  public void reset() {
    if (!isRunOnMyThread()) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.SemConcurrentBiometricScheduler$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
