...
public final /* synthetic */ class AidlResponseHandler$$ExternalSyntheticLambda9
        implements Consumer {
        ...
        switch (this.$r8$classId) {
            ...
            case 3:
                ...
                LockoutResetDispatcher lockoutResetDispatcher =
                        faceResetLockoutClient.mLockoutResetDispatcher;
                ((BiometricContextProvider) faceResetLockoutClient.mBiometricContext)
                        .mAuthSessionCoordinator.resetLockoutFor(
                                i4,
                                faceResetLockoutClient.mBiometricStrength,
                                faceResetLockoutClient.mRequestId);
            ...
            case 5:
                ...
                try {
                    ClientMonitorCallbackConverter clientMonitorCallbackConverter2 =
                            faceSetFeatureClient.mListener;
                    int i5 = faceSetFeatureClient.mFeature;
                    IFaceServiceReceiver iFaceServiceReceiver2 =
                            clientMonitorCallbackConverter2.mFaceServiceReceiver;
