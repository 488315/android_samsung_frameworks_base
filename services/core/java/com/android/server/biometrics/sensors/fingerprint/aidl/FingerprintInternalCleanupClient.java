...
public class FingerprintInternalCleanupClient extends InternalCleanupClient {
  public FingerprintInternalCleanupClient(
      Context context,
      Supplier supplier,
      int i,
      String str,
  ...
  public InternalEnumerateClient getEnumerateClient(
    ...
    return new FingerprintInternalEnumerateClient(
        ...
        biometricUtils,
        i2,
        biometricLogger.swapAction(context, 3),
        biometricContext);
  }
  ...
  public RemovalClient getRemovalClient(
    ...
    return new FingerprintRemovalClient(
        ...
        biometricUtils,
        i3,
        biometricLogger.swapAction(context, 4),
        biometricContext,
        map);
  }
  ...
  public void onAddUnknownTemplate(int i, BiometricAuthenticator.Identifier identifier) {
    FingerprintUtils.getInstance(getSensorId())
        .addBiometricForUser(getContext(), getTargetUserId(), (Fingerprint) identifier);
  }
}
