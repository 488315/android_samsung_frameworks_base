...
public class SemFpGestureManager implements SemFpHalLifecycleListener, SemFpEventListener {
  static final String ACTION_FINGERPRINT_GESTURE_SAMSUNG_PAY =
      "com.samsung.android.spay.gesture.fingerprint";
  static final String ACTION_SCREEN_OFF_BY_PROXIMITY =
      "android.intent.action.ACTION_SCREEN_OFF_BY_PROXIMITY";
  static final String ACTION_SCREEN_ON_BY_PROXIMITY =
  ...
  static final String PERMISSION_SAMSUNG_PAY_SIMPLE_PAY =
  ...
  public class Injector {
    ...
    public void userActivityTouchEvent(Context context) {
      ((PowerManager) context.getSystemService(PowerManager.class))
          .userActivity(SystemClock.uptimeMillis(), 2, 0);
    }
      ...
      try {
        ActivityManager.getService()
            .registerUserSwitchObserver(
                synchronousUserSwitchObserver, "FingerprintService.Gesture");
      } catch (RemoteException unused) {
        Slog.e("FingerprintService.Gesture", "Unable to register user switch observer");
      }
    }

    public void registerContentObserveForAllUser(
        ContentResolver contentResolver, Uri uri, ContentObserver contentObserver) {
    ...
    public SemFpGestureCalibrator createGestureCalibrator(
    ...
    public boolean isEnabledGestureSettingForStatusBar(ContentResolver contentResolver) {
      return Settings.System.getIntForUser(contentResolver, "fingerprint_gesture_quick", 0, -2)
          == 1;
    }
    ...
    public boolean isEnabledGestureSettingForSamsungPay(ContentResolver contentResolver) {
      if (Settings.System.getIntForUser(contentResolver, "fingerprint_gesture_spay", 0, -2) == 1) {
        return !SemBiometricFeature.FP_FEATURE_SUPPORT_GESTURE_CALIBRATION
            || Settings.System.getIntForUser(
                    contentResolver, SemFpGestureManager.DB_SPAY_GESTURE_MENU_VISIBLE, 1, -2)
                == 1;
      }
      return false;
    }
  ...
  public SemFpGestureManager(Context context, ServiceProvider serviceProvider, Injector injector) {
    ...
    this.f1657mH = SemFpMainThread.get().getHandler();
  }
  ...
  public final boolean canHandleGestureEvent(int i) {
    SemFpGestureCalibrator semFpGestureCalibrator = this.mCalibrator;
    if ((semFpGestureCalibrator != null && semFpGestureCalibrator.isCalibrationInProgress())
        || !this.mIsEnabledGestureMainSetting) {
      return false;
    }
    if (!this.mInjector.isInteractive(this.mContext)) {
      Slog.d(
          "FingerprintService.Gesture",
          "handleGestureAction: SKIP gesture action because of interactive status");
      return false;
    }
    if (this.mInjector.isDexMode(this.mContext)) {
      Slog.d(
          "FingerprintService.Gesture",
          "handleGestureAction: SKIP gesture action because of DeX Mode");
      return false;
    }
    ...
    Slog.d(
        "FingerprintService.Gesture",
        "handleGestureAction: SKIP gesture action because of flip folded status");
    return false;
  }
  ...
  public final void handleSwipeUpEvent() {
    ...
    if (this.mIsEnabledGestureForSamsungPay) {
      ...
      this.mContext.sendBroadcastAsUser(
          intent, UserHandle.CURRENT, PERMISSION_SAMSUNG_PAY_SIMPLE_PAY);
  ...
  public final void handleSwipeDownEvent() {
    if (this.mIsEnabledGestureForStatusBar) {
      SemStatusBarManager semStatusBarManager =
          this.mInjector.getSemStatusBarManager(this.mContext);
  ...
  public void start() {
    ...
    if (SemBiometricFeature.FP_FEATURE_SUPPORT_GESTURE_CALIBRATION) {
      SemFpGestureCalibrator createGestureCalibrator =
          this.mInjector.createGestureCalibrator(this.mContext, this.mServiceProvider);
  ...
  public final void registerUserSwitchObserver() {
    ...
    SynchronousUserSwitchObserverC09021 synchronousUserSwitchObserverC09021 =
        new SynchronousUserSwitchObserverC09021();
    this.mUserSwitchObserver = synchronousUserSwitchObserverC09021;
    this.mInjector.registerUserSwitchObserver(synchronousUserSwitchObserverC09021);
  }

  /* renamed from: com.android.server.biometrics.sensors.fingerprint.SemFpGestureManager$1 */
  public class SynchronousUserSwitchObserverC09021 extends SynchronousUserSwitchObserver {
    public SynchronousUserSwitchObserverC09021() {}
    ...
    public void onUserSwitching(int i) {
      SemFpGestureManager.this.f1657mH.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.fingerprint.SemFpGestureManager$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              SemFpGestureManager.SynchronousUserSwitchObserverC09021.this
                  .lambda$onUserSwitching$0();
            }
          });
    }
    ...
    public void onUserSwitchComplete(final int i) {
      SemFpGestureManager.this.f1657mH.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.fingerprint.SemFpGestureManager$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              SemFpGestureManager.SynchronousUserSwitchObserverC09021.this
                  .lambda$onUserSwitchComplete$1(i);
            }
          });
    }
  ...
  public final void registerContentObserver() {
    ...
    this.mContentObserver =
        new ContentObserver(
            this
                .f1657mH) { // from class:
                            // com.android.server.biometrics.sensors.fingerprint.SemFpGestureManager.2
    ...
    try {
      ...
      this.mInjector.registerContentObserveForAllUser(
          contentResolver,
          Settings.System.getUriFor("fingerprint_gesture_quick"),
          this.mContentObserver);
      this.mInjector.registerContentObserveForAllUser(
          contentResolver,
          Settings.System.getUriFor("fingerprint_gesture_spay"),
          this.mContentObserver);
    } catch (RuntimeException e) {
  ...
  public final void handleOnChangeSettingValue() {
    ...
    if (SemBiometricFeature.FP_FEATURE_SUPPORT_GESTURE_CALIBRATION
        && this.mIsEnabledGestureMainSetting
        && (semFpGestureCalibrator = this.mCalibrator) != null
        && !semFpGestureCalibrator.hasCalibrationData()) {
      startCalibration();
  ...
  public final void startCalibration() {
    ...
    semFpGestureCalibrator.setCallback(
        new SemFpGestureCalibrator
            .Callback() { // from class:
                          // com.android.server.biometrics.sensors.fingerprint.SemFpGestureManager.3
          @Override // com.android.server.biometrics.sensors.fingerprint.SemFpGestureCalibrator.Callback
          public void onCalibrationStarted() {
            SemFpGestureManager.this.f1657mH.removeCallbacksAndEqualMessages(null);
          }
  ...
  public final void updateGestureSettingValue() {
    ContentResolver contentResolver = this.mContext.getContentResolver();
    this.mIsEnabledGestureForStatusBar =
        this.mInjector.isEnabledGestureSettingForStatusBar(contentResolver);
    boolean isEnabledGestureSettingForSamsungPay =
        this.mInjector.isEnabledGestureSettingForSamsungPay(contentResolver);
    ...
    Slog.d(
        ...
        "updateGestureSettingValue: "
            + this.mIsEnabledGestureForStatusBar
            + ", "
            + this.mIsEnabledGestureForSamsungPay);
  }
  ...
  public final void registerBroadcast() {
    ...
    this.mBroadCastReceiver =
        new BroadcastReceiver() { // from class:
                                  // com.android.server.biometrics.sensors.fingerprint.SemFpGestureManager.4
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
            if ("android.intent.action.SCREEN_OFF".equals(action)
                || SemFpGestureManager.ACTION_SCREEN_OFF_BY_PROXIMITY.equals(action)) {
              SemFpGestureManager.this.handleScreenOffBroadcast();
            } else if ("android.intent.action.SCREEN_ON".equals(action)
                || SemFpGestureManager.ACTION_SCREEN_ON_BY_PROXIMITY.equals(action)) {
    ...
    Utils.registerBroadcastAsUser(
        this.mContext, this.mBroadCastReceiver, intentFilter, UserHandle.ALL, this.f1657mH);
  }
  ...
  public final void handleScreenOnBroadcast() {
    if (this.mIsEnabledGestureMainSetting
        ...
        && !this.mInjector.isProximityPositive()) {
      ServiceProvider serviceProvider = this.mServiceProvider;
      serviceProvider.semRequest(
          ((FingerprintSensorPropertiesInternal) serviceProvider.getSensorProperties().get(0))
              .sensorId,
