    ...
    new Handler(serviceThread.getLooper())
        .post(
            new Runnable() { // from class:
                             // com.android.server.biometrics.sensors.BiometricServiceRegistry$$ExternalSyntheticLambda0
  ...
  public Pair getSingleProvider() {
    ...
    try {
      if (this.mAllProps.size() > 1) {
        Slog.e(
            "BiometricServiceRegistry",
            "getSingleProvider() called but multiple sensors present: " + this.mAllProps.size());
      }
