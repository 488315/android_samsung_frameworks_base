...
public class SemFaceBrightManager {
  ...
  public Handler mHandlerBg =
      new Handler(
          SemFaceMainThread.get()
              .getLooper()) { // from class:
                              // com.android.server.biometrics.sensors.face.SemFaceBrightManager.1
        ...
        public void handleMessage(Message message) {
          ...
          if (i == 2) {
            Slog.i(
                ...
                "handleMessage: MSG_BRIGHTNESS_LEVEL_UP "
                    + SemFaceBrightManager.this.mScreenFlashBrightnessLevelUpCorrected);
            SemFaceBrightManager semFaceBrightManager = SemFaceBrightManager.this;
            semFaceBrightManager.setBrightness(
                semFaceBrightManager.mScreenFlashBrightnessLevelUpCorrected);
  ...
  public boolean isNeededSetBrightness() {
    return this.mPowerManager.getCurrentBrightness(false)
        < ((float) this.mScreenFlashBrightnessLevelMaxCorrected);
  }
  ...
  public void startBrightness(int i) {
    ...
    try {
      if (Utils.isFlipFolded(this.mContext)) {
        this.mIsScreenAutoBrightnessOn =
            Settings.System.getInt(this.mContext.getContentResolver(), "sub_screen_brightness_mode")
                == 1;
      } else {
        this.mIsScreenAutoBrightnessOn =
  ...
  public final void initBrightness(int i) {
    ...
    Slog.i(
        "SemFaceBrightManager",
        "initBrightness : "
            + this.mScreenFlashBrightnessStartValue
            + ", "
            + this.mScreenFlashBrightnessLevelUp
            + ", "
            + this.mScreenFlashBrightnessLevelMax
            + " : "
            + i
            + ", auto = "
            + this.mIsScreenAutoBrightnessOn
            ...
            + isBlackWallpaper
            + ", guide = "
            + this.mScreenFlashBrightnessGuideLevel);
  }
  ...
  public final boolean isBlackWallpaper() {
    ...
    boolean z =
        (fontColor == 1 || fontColor2 == 1 || fontColor3 == 1 || fontColor4 == 1) ? false : true;
    Slog.i(
        "SemFaceBrightManager",
        "isBlackWallpaper : "
            + fontColor
  ...
  public final void showNotificationIfNeed(int i) {
    ...
    notificationManager.createNotificationChannel(
        new NotificationChannel(
            "FaceServiceScreenFlashNotificationChannel", this.mContext.getString(17042740), 4));
    notificationManager.notifyAsUser(
        "FaceServiceScreenFlash", 1, getNotification(this.mContext, i), UserHandle.of(i));
  }
  ...
  public final Notification getNotification(Context context, int i) {
    return new Notification.Builder(context, "FaceServiceScreenFlashNotificationChannel")
        .setSmallIcon(R.drawable.text_cursor_holo_dark)
        .setSubText(context.getString(17042740))
        .setContentTitle(context.getString(17042742))
        .setContentText(context.getString(17042741))
        .setOnlyAlertOnce(true)
        .setLocalOnly(true)
        .setOngoing(true)
        .setCategory(context.getString(17042740))
        .setContentIntent(getPendingIntentForAction(context, "settings", 1, i))
        .addAction(getCloseNotificationAction(context, i))
        .addAction(getGoToSettingsNotificationAction(context, i))
        .setStyle(new Notification.BigTextStyle().bigText(context.getString(17042741)))
    ...
    if (this.mNotificationActionReceiver == null) {
      this.mNotificationActionReceiver =
          new BroadcastReceiver() { // from class:
                                    // com.android.server.biometrics.sensors.face.SemFaceBrightManager.2
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
              if ("com.samsung.android.server.biometrics.BIOMETRICS_FACE_NOTIFICATION_SCREEN_FLASH"
                ...
                Utils.unregisterBroadcast(
                    SemFaceBrightManager.this.mContext,
                    SemFaceBrightManager.this.mNotificationActionReceiver);
      ...
      Utils.registerBroadcastAsUser(
          ...
          this.mNotificationActionReceiver,
          new IntentFilter(
              "com.samsung.android.server.biometrics.BIOMETRICS_FACE_NOTIFICATION_SCREEN_FLASH"),
          UserHandle.ALL,
  ...
  public final boolean isAlreadyGuided(Context context, int i) {
    return Settings.Secure.getIntForUser(
            context.getContentResolver(), "face_screen_flash_guideline_displayed", -1, i)
        >= 0;
  }

  public final void setFirstGuide(Context context, int i) {
    Settings.Secure.putIntForUser(
        context.getContentResolver(), "face_screen_flash_guideline_displayed", 0, i);
  }

  public final Notification.Action getCloseNotificationAction(Context context, int i) {
    return new Notification.Action.Builder(
            (Icon) null,
            context.getString(17042604),
            getPendingIntentForAction(context, "close", 0, i))
        .build();
  }
  ...
  public final Notification.Action getGoToSettingsNotificationAction(Context context, int i) {
    return new Notification.Action.Builder(
            (Icon) null,
            context.getString(17042605),
            getPendingIntentForAction(context, "settings", 1, i))
        .build();
  }

  public final void cancelNotification(int i) {
    ((NotificationManager) this.mContext.getSystemService("notification"))
        .cancelAsUser("FaceServiceScreenFlash", 1, UserHandle.of(i));
  }
