...
public class SemUdfpsHelper {
  ...
  public final void setFodRect(Context context) {
    ...
    try {
      ((DisplayManagerInternal) LocalServices.getService(DisplayManagerInternal.class))
          .getNonOverrideDisplayInfo(0, new DisplayInfo());
      ...
      Rect rect = new Rect();
      double parseDouble =
          Double.parseDouble(this.mSemSensorActiveArea) * r1.physicalXDpi * 0.03937007859349251d;
      double parseDouble2 =
          Double.parseDouble(this.mSemSensorMarginBottom) * r1.physicalXDpi * 0.03937007859349251d;
      double parseDouble3 =
          Double.parseDouble(this.mSemSensorMarginLeft) * r1.physicalXDpi * 0.03937007859349251d;
      double parseDouble4 =
          Double.parseDouble(this.mSemSensorAreaHeight) * r1.physicalXDpi * 0.03937007859349251d;
  ...
  public Rect getFodSensorAreaRectForKeyguard(Context context) {
      ...
      int applyDimension =
          (((int)
                      TypedValue.applyDimension(
                          5, Float.parseFloat(this.mSemSensorActiveArea), displayMetrics))
                  - ((int)
                      TypedValue.applyDimension(
                          5, Float.parseFloat(this.mSemSensorImageSize), displayMetrics)))
              + ((int)
                  TypedValue.applyDimension(
                      5, Float.parseFloat(this.mSemSensorDraggingArea), displayMetrics));
    ...
    if (DEBUG) {
      Slog.d(
          "FingerprintService",
          "getFodSensorAreaRectForKeyguard: " + fodSensorAreaRect.toShortString());
    }
  ...
  public Rect getFodSensorAreaRect(Context context, int i, Point point) {
    ...
    try {
      ...
      float applyDimension3 =
          TypedValue.applyDimension(5, Float.parseFloat(this.mSemSensorMarginLeft), displayMetrics);
      float applyDimension4 =
          TypedValue.applyDimension(5, Float.parseFloat(this.mSemSensorAreaHeight), displayMetrics);
  ...
  public class BurnInHelper {
    ...
    public final void setMaxMovingSize(Context context) {
      this.mMaxMovingSize =
          (int) TypedValue.applyDimension(1, 10.0f, context.getResources().getDisplayMetrics());
    ...
    public final void updateLocation() {
      ...
      this.f1661mX = (i4 / i2) - (i2 >> 1);
      this.f1662mY = (i4 % i2) - (i2 >> 1);
    }

    public final Bundle getNextPosition(Bundle bundle) {
      updateLocation();
      bundle.putInt("x", this.f1661mX);
      bundle.putInt("y", this.f1662mY);
      Slog.i("FingerprintService", "getNextPosition: " + this.f1661mX + ", " + this.f1662mY);
      return bundle;
    }
  }
}
