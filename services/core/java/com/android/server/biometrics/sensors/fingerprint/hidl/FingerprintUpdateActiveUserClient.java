...
public final class FingerprintUpdateActiveUserClient extends StartUserClient {
    ...
    public FingerprintUpdateActiveUserClient(
            ...
            HidlToAidlSensorAdapter$$ExternalSyntheticLambda3
                    hidlToAidlSensorAdapter$$ExternalSyntheticLambda32,
            boolean z,
            Map map,
            boolean z2,
    ...
    public final void start(ClientMonitorCallback clientMonitorCallback) {
        ...
        if (((Integer) this.mCurrentUserId.get()).intValue() == this.mTargetUserId
        ...
        if (SemBiometricFeature.FP_FEATURE_USE_AOSP_HAL) {
            ...
            File file =
                    new File(
                            i <= 27
                                    ? Environment.getUserSystemDirectory(this.mTargetUserId)
    ...
    public final void startHalOperation() {
        ...
        try {
            if (Utils.DEBUG) {
                Slog.d(
                        "FingerprintUpdateActiveUserClient",
                        "startHalOperation: setActiveGroup, " + this.mTargetUserId);
            }
            ...
            HidlToAidlSessionAdapter hidlToAidlSessionAdapter =
                    (HidlToAidlSessionAdapter) this.mLazyDaemon.get();
            if (((IBiometricsFingerprint) hidlToAidlSessionAdapter.mSession.get()) == null) {
                Slog.e(
                        "FingerprintUpdateActiveUserClient",
                        "Failed to setActiveGroup: HIDL daemon is null.");
                this.mCallback.onClientFinished(this, false);
                return;
            }
            ((IBiometricsFingerprint) hidlToAidlSessionAdapter.mSession.get())
                    .setActiveGroup(i, this.mDirectory.getAbsolutePath());
                                                    ...
                                                    sb.append(
                                                            simpleDateFormat.format(
                                                                    new Date(
                                                                            System
                                                                                    .currentTimeMillis())));
                                                    semBioLoggingManager2.mLastFpAuthenticatorId =
                                                            sb.toString();
                                                } catch (Exception e) {
                                                    Slog.w(
                                                            "BiometricStats",
                                                            "fpSetAuthenticatorId: "
                                                                    + e.getMessage());
                                                }
                                            } catch (Throwable th) {
                                                throw th;
