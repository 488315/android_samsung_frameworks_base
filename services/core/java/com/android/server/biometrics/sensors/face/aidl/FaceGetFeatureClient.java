...
public class FaceGetFeatureClient extends HalClientMonitor implements ErrorConsumer {
  ...
  public void onFeatureGet(boolean z, byte[] bArr) {
    try {
      ...
      for (byte b : bArr) {
        featureMap.put(
            Integer.valueOf(AidlConversionUtils.convertAidlToFrameworkFeature(b)), Boolean.TRUE);
      }
      int i = 0;
      ...
      Slog.d(
          ...
          "Updating attention value for user: " + this.mUserId + " to value: " + booleanValue);
