...
public class FingerprintInternalEnumerateClient extends InternalEnumerateClient {
  ...
  public final boolean canUseEnumerateOperation() {
    return ((AidlSession) getFreshDaemon()).getSehFingerprint() == null
        || new SemFpBaseRequestClient.Builder(
                    getContext(),
                    getBiometricContext(),
                    new Supplier() { // from class:
                                     // com.android.server.biometrics.sensors.fingerprint.aidl.FingerprintInternalEnumerateClient$$ExternalSyntheticLambda0
                      @Override // java.util.function.Supplier
                      public final Object get() {
                        ISehFingerprint lambda$canUseEnumerateOperation$0;
                        lambda$canUseEnumerateOperation$0 =
                            FingerprintInternalEnumerateClient.this
                                .lambda$canUseEnumerateOperation$0();
