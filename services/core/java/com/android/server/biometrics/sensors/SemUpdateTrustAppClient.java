...
public abstract class SemUpdateTrustAppClient extends BaseClientMonitor {
  ...
  public SemUpdateTrustAppClient(
      Context context,
      IBinder iBinder,
    ...
    super(
        ...
        0,
        i,
        new BiometricLogger(context, i2, 0, 0),
        biometricContext);
    ...
    if (Utils.DEBUG) {
      Slog.d(
          "Biometrics/SemUpdateTrustAppClient",
          "SemUpdateTrustAppClient: path = " + str2 + ", " + this.mDataTransmissionUnit);
    }
  }
  ...
  public final void startUpdate() {
    ...
    try {
      ...
      try {
        ...
        Slog.i(
            "Biometrics/SemUpdateTrustAppClient",
            "startUpdate: size = " + fileInputStream2.available());
        ...
        if (this.mDataTransmissionUnit == -1) {
          ...
          for (int i2 = 0; i2 < ceil; i2++) {
            ...
            if (z) {
              Slog.i(
                  "Biometrics/SemUpdateTrustAppClient",
                  "startUpdate: byteBuffer.position() after get()"
                      + allocate.position()
                      + ", byteBuffer.remaining():"
                      + allocate.remaining());
            }
        ...
        try {
          ...
          if (Utils.DEBUG) {
            Slog.w(
                "Biometrics/SemUpdateTrustAppClient",
                "startUpdate: digest:" + sb.toString().trim());
          }
          ...
          Slog.w(
              "Biometrics/SemUpdateTrustAppClient",
              "startUpdate: failure to get MessageDigest instance",
              e);
          handleUpdate(this.mErrorValue);
        }
      } catch (Exception e2) {
