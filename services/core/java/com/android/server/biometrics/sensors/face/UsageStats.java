...
public class UsageStats {
  ...
  public void addEvent(AuthenticationEvent authenticationEvent) {
    ...
    if (authenticationEvent.mAuthenticated) {
      ...
      this.mErrorFrequencyMap.put(
          authenticationEvent.mError,
          this.mErrorFrequencyMap.get(authenticationEvent.mError, 0) + 1);
      this.mErrorLatencyMap.put(
          authenticationEvent.mError,
          this.mErrorLatencyMap.get(authenticationEvent.mError, 0L) + authenticationEvent.mLatency);
    }
  }
  ...
  public void print(PrintWriter printWriter) {
    printWriter.println(
        "Printing most recent events since last reboot("
            + this.mAuthenticationEvents.size()
            + " events)");
