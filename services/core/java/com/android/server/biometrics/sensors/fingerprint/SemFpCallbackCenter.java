...
public class SemFpCallbackCenter implements SemFpHalCallbackEx, ClientMonitorCallback {
  ...
  public final void dispatchChallengeListener(final int i, final int i2, final long j, boolean z) {
    for (SemFpChallengeListener semFpChallengeListener : this.mChallengeListeners) {
      if (z) {
        semFpChallengeListener.onChallengeGenerated(
            i,
            j,
            new Runnable() { // from class:
                             // com.android.server.biometrics.sensors.fingerprint.SemFpCallbackCenter$$ExternalSyntheticLambda1
    ...
    if (baseClientMonitor instanceof AuthenticationClient) {
      ...
      while (it2.hasNext()) {
        ((SemFpEnrollmentListener) it2.next())
            .onEnrollStarted(baseClientMonitor.getSensorId(), baseClientMonitor.getTargetUserId());
      }
    }
  }
  ...
  public void onClientFinished(BaseClientMonitor baseClientMonitor, boolean z) {
    if (baseClientMonitor instanceof AuthenticationClient) {
      ...
      while (it2.hasNext()) {
        ((SemFpEnrollmentListener) it2.next())
            .onEnrollFinished(baseClientMonitor.getSensorId(), baseClientMonitor.getTargetUserId());
      }
    }
  }
  ...
  public void onResetLockout(final int i, final int i2) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpCallbackCenter$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void addChallengeListener(final SemFpChallengeListener semFpChallengeListener) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpCallbackCenter$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$addChallengeListener$2(
      SemFpChallengeListener semFpChallengeListener) {
    if (semFpChallengeListener == null
        || this.mChallengeListeners.contains(semFpChallengeListener)) {
      return;
    }
  ...
  public void addAuthenticationListener(
      final SemFpAuthenticationListener semFpAuthenticationListener) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpCallbackCenter$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
            SemFpCallbackCenter.this.lambda$addAuthenticationListener$4(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$addAuthenticationListener$4(
      SemFpAuthenticationListener semFpAuthenticationListener) {
    if (semFpAuthenticationListener == null
        || this.mAuthenticationListeners.contains(semFpAuthenticationListener)) {
      return;
    }
  ...
  public void addEnrollListener(final SemFpEnrollmentListener semFpEnrollmentListener) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpCallbackCenter$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$addEnrollListener$6(
      SemFpEnrollmentListener semFpEnrollmentListener) {
    if (semFpEnrollmentListener == null
        || this.mEnrollListeners.contains(semFpEnrollmentListener)) {
      return;
    }
  ...
  public void addEventListener(final SemFpEventListener semFpEventListener) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpCallbackCenter$$ExternalSyntheticLambda4
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void removeEventListener(final SemFpEventListener semFpEventListener) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpCallbackCenter$$ExternalSyntheticLambda7
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void addResetLockoutListener(final SemFpResetLockoutListener semFpResetLockoutListener) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.SemFpCallbackCenter$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$addResetLockoutListener$10(
      SemFpResetLockoutListener semFpResetLockoutListener) {
    if (semFpResetLockoutListener == null
        || this.mResetLockoutListeners.contains(semFpResetLockoutListener)) {
      return;
    }
