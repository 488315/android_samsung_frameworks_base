...
public final class FingerprintDetectClient extends AcquisitionClient implements DetectionConsumer {
    ...
    public FingerprintDetectClient(
        ...
        super(
                ...
                fingerprintAuthenticateOptions.getOpPackageName(),
                0,
        ...
        ((BiometricContextProvider) this.mBiometricContext)
                .subscribe(
                        ...
                        new Consumer() { // from class:
                                         // com.android.server.biometrics.sensors.fingerprint.aidl.FingerprintDetectClient$$ExternalSyntheticLambda0
                            @Override // java.util.function.Consumer
                            public final void accept(Object obj) {
                                FingerprintDetectClient fingerprintDetectClient =
                                        FingerprintDetectClient.this;
                                ...
                                try {
                                    fingerprintDetectClient.mCancellationSignal =
                                            aidlSession2.mSession.detectInteractionWithContext(
                                                    operationContext2);
                                } catch (RemoteException e) {
                                    Slog.e(
                                            "FingerprintDetectClient",
                                            "Unable to start detect interaction",
                                            e);
                                    fingerprintDetectClient.mSensorOverlays.hide(
                                            fingerprintDetectClient.mSensorId);
                                    fingerprintDetectClient.mAuthenticationStateListeners
                        ...
                        new Consumer() { // from class:
                                         // com.android.server.biometrics.sensors.fingerprint.aidl.FingerprintDetectClient$$ExternalSyntheticLambda1
                            @Override // java.util.function.Consumer
                            public final void accept(Object obj) {
                                try {
    ...
    public final void startHalOperation() {
        ...
        this.mAuthenticationStateListeners.onAuthenticationStarted(
                new AuthenticationStartedInfo.Builder(BiometricSourceType.FINGERPRINT, 4).build());
        try {
            ...
            this.mAuthenticationStateListeners.onAuthenticationStopped(
                    new AuthenticationStoppedInfo.Builder(BiometricSourceType.FINGERPRINT, 4)
                            .build());
    ...
    public final void stopHalOperation() {
        this.mSensorOverlays.hide(this.mSensorId);
        this.mAuthenticationStateListeners.onAuthenticationStopped(
                new AuthenticationStoppedInfo.Builder(BiometricSourceType.FINGERPRINT, 4).build());
