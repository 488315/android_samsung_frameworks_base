...
public final class HidlToAidlCallbackConverter extends HwBinder
        implements ISehBiometricsFaceClientCallback {
    ...
    public final ArrayList getHashChain() {
        return new ArrayList(
                Arrays.asList(
                        new byte[] {
                            -109, 91, -14, 67, 67, 94, 108, -16, -118, 36, 28, -61, -21, -27, -22,
                            -106, -25, -94, -39, 104, -50, 98, 26, -78, 71, 104, -80, -92, 47, 74,
                            81, -73
                        },
                        new byte[] {
                            7,
    ...
    public final void onAcquired(int i, final int i2, final int i3, long j) {
        ...
        aidlResponseHandler.handleResponse(
                ...
                new Consumer() { // from class:
                                 // com.android.server.biometrics.sensors.face.aidl.AidlResponseHandler$$ExternalSyntheticLambda22
    ...
    public final void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) {
        ...
        switch (i) {
            ...
            case 7:
                ...
                aidlResponseHandler.mScheduler.mHandler.post(
                        new Runnable() { // from class:
                                         // com.android.server.biometrics.sensors.face.aidl.AidlResponseHandler$$ExternalSyntheticLambda23
                            @Override // java.lang.Runnable
                            public final void run() {
                                AidlResponseHandler aidlResponseHandler2 = AidlResponseHandler.this;
                                long j = readInt64;
                                aidlResponseHandler2.getClass();
                                aidlResponseHandler2.mLockoutTracker.setLockoutModeForUser(
                                        aidlResponseHandler2.mUserId,
                                        j == 0 ? 0 : (j == -1 || j == Long.MAX_VALUE) ? 2 : 1);
                                if (j == 0) {
                                    aidlResponseHandler2.mLockoutResetDispatcher
                                            .notifyLockoutResetCallbacks(
                                                    aidlResponseHandler2.mSensorId);
                                }
                            }
                        });
                return;
            case 8:
                ...
                if (!semFaceServiceExImpl.mIsOperationStarted) {
                    ...
                    for (int i4 = 0; i4 < readInt8Vector.size(); i4++) {
                        semFaceServiceExImpl.mHIDLpreviewImage[i4] =
                                ((Byte) readInt8Vector.get(i4)).byteValue();
                    }
                            ...
                            new Runnable() { // from class:
                                ...
                                public final void run() {
                                    SemFaceServiceExImpl semFaceServiceExImpl2 =
                                            SemFaceServiceExImpl.this;
                                    int i5 = readInt32;
                                    int i6 = readInt322;
                                    int i7 = readInt324;
                                    int i8 = readInt323;
                                    BaseClientMonitor currentClient =
                                            semFaceServiceExImpl2.mScheduler.getCurrentClient();
                                    ...
                                    if (!(currentClient instanceof FaceEnrollClient)
                                            && (!(currentClient instanceof FaceAuthenticationClient)
                                                    || !semFaceServiceExImpl2
                                                            .mIsAuthenticationExtOperation)) {
                                        Slog.e(
                                                "SemFace",
                                    ...
                                    try {
                                        if (semFaceServiceExImpl2.mHIDLmemoryFileForPreview
                                                == null) {
                                            semFaceServiceExImpl2.mHIDLmemoryFileForPreview =
                                                    new MemoryFile(
                                                            "face_enroll_preview",
                                                            semFaceServiceExImpl2
                                                                    .mHIDLpreviewImage
                                        ...
                                        if (semFaceServiceExImpl2.mIsAuthenticationExtOperation) {
                                            ...
                                            IFaceServiceReceiver iFaceServiceReceiver =
                                                    ((FaceAuthenticationClient) currentClient)
                                                            .mListener
                                                            .mFaceServiceReceiver;
                                            if (iFaceServiceReceiver != null) {
                                                iFaceServiceReceiver.onSemImageProcessed(
                                                        bArr2, i5, i6, i7, i8, bundle);
                                            }
                                        } else {
                                            ...
                                            if (iFaceServiceReceiver2 != null) {
                                                iFaceServiceReceiver2.onSemImageProcessed(
                                                        bArr3, i5, i6, i7, i8, bundle);
                                            }
                                        }
                                    } catch (Exception e2) {
                                        Log.e(
                                                "SemFace",
                                                "sendImageProcessed onImageProcessed: ",
                                                e2);
                                    }
                                    semFaceServiceExImpl2.mHIDLpreviewImage = null;
                                }
            ...
            case 9:
                ...
                StringBuilder m2 =
                        ArrayUtils$$ExternalSyntheticOutline0.m(
                                readInt326, readInt325, "sehOnAuthenticated: [", "] ", ",");
                ...
                if (readInt8Vector3.size() > 0) {
                    ...
                    while (i3 < readInt8Vector3.size()) {
                        SemFaceUtils.mFidoResultData[i3] =
                                ((Byte) readInt8Vector3.get(i3)).byteValue();
                        i3++;
                    }
                    if (Utils.DEBUG) {
                        Log.i(
                                "SemFace",
                                "fidoResultData("
                                        + readInt8Vector3.size()
                                        + ") = "
                                        + Arrays.toString(SemFaceUtils.mFidoResultData));
                    }
                }
            ...
            case 10:
                ...
                try {
                    ...
                    this.mAidlResponseHandler.getClass();
                    final SemFaceServiceExImpl semFaceServiceExImpl2 =
                            SemFaceServiceExImpl.getInstance();
                    semFaceServiceExImpl2.getClass();
                    StringBuilder m3 =
                            ArrayUtils$$ExternalSyntheticOutline0.m(
                                    readInt327, readInt328, "sehOnPreviewFrame: ", ",", ",");
                    ...
                    if (!semFaceServiceExImpl2.mIsOperationStarted) {
                        ...
                        Slog.d(
                                "SemFace",
                                "sehOnPreviewFrame: previous preview is not processed yet");
                    } else {
                        semFaceServiceExImpl2.mHIDLpreviewImage =
                                HidlMemoryUtil.hidlMemoryToByteArray(dup);
                        semFaceServiceExImpl2.mHandlerMain.post(
                                new Runnable() { // from class:
                                    // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda4
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SemFaceServiceExImpl semFaceServiceExImpl22 =
                                                SemFaceServiceExImpl.this;
                                        int i5 = readInt327;
                                        int i6 = readInt328;
                                        int i7 = readInt3210;
                                        int i8 = readInt329;
                                        BaseClientMonitor currentClient =
                                                semFaceServiceExImpl22.mScheduler
                                                        .getCurrentClient();
                                        if (currentClient == null) {
                                            Slog.d("SemFace", "sendImageProcessed: client is null");
                                            return;
                                        ...
                                        Bundle bundle = new Bundle();
                                        try {
                                            if (semFaceServiceExImpl22.mHIDLmemoryFileForPreview
                                                    == null) {
                                                semFaceServiceExImpl22.mHIDLmemoryFileForPreview =
                                                        new MemoryFile(
                                                                "face_enroll_preview",
                                                                semFaceServiceExImpl22
                                                                        .mHIDLpreviewImage
                                        ...
                                        try {
                                            if (semFaceServiceExImpl22
                                                    .mIsAuthenticationExtOperation) {
                                                byte[] bArr2 =
                                                        semFaceServiceExImpl22.mHIDLpreviewImage;
                                                IFaceServiceReceiver iFaceServiceReceiver =
                                                        ((FaceAuthenticationClient) currentClient)
                                                                .mListener
                                                                .mFaceServiceReceiver;
            ...
            case 11:
                ...
                try {
                    ...
                    this.mAidlResponseHandler.getClass();
                    final SemFaceServiceExImpl semFaceServiceExImpl3 =
                            SemFaceServiceExImpl.getInstance();
                    ...
                    if (!semFaceServiceExImpl3.mIsAuthenticationExtOperation) {
                        ...
                        semFaceServiceExImpl3.mHandlerMain.post(
                                new Runnable() { // from class:
                                    // com.android.server.biometrics.sensors.face.aidl.SemFaceServiceExImpl$$ExternalSyntheticLambda5
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SemFaceServiceExImpl semFaceServiceExImpl4 =
                                                SemFaceServiceExImpl.this;
                                        HidlMemory hidlMemory = dup2;
                                        int i5 = readInt3211;
                                        semFaceServiceExImpl4.getClass();
                                        Bundle bundle = new Bundle();
                                        byte[] hidlMemoryToByteArray =
                                                HidlMemoryUtil.hidlMemoryToByteArray(hidlMemory);
                                        if (hidlMemoryToByteArray == null
                                                || hidlMemoryToByteArray.length <= 0) {
                                            Slog.i(
                                                    "SemFace",
                                                    "sehOnAuthenticatedFromMemory data is null or"
                                                        + " 0");
                                        } else {
                                            SystemServiceManager$$ExternalSyntheticOutline0.m(
                                                    new StringBuilder(
                                                            "sehOnAuthenticatedFromMemory read "),
                                            ...
                                            try {
                                                if (semFaceServiceExImpl4
                                                                .mMemoryFileForAuthPreviewResult
                                                        == null) {
                                                    semFaceServiceExImpl4
                                                                    .mMemoryFileForAuthPreviewResult =
                                                            new MemoryFile(
                                                                    "auth_preview",
                                                                    hidlMemoryToByteArray.length);
                                                ...
                                                semFaceServiceExImpl4
                                                        .mMemoryFileForAuthPreviewResult.writeBytes(
                                                        hidlMemoryToByteArray,
                                                        0,
                                                        0,
                                                        hidlMemoryToByteArray.length);
                                                ...
                                                Log.w(
                                                        "SemFace",
                                                        "Unable to write statistics stream",
                                                        e2);
                                            }
                                        ...
                                        if (i5 > 0) {
                                            ...
                                            Slog.d(
                                                    "SemFace",
                                                    "sehOnAuthenticated: faceId is less than 0");
                                        }
                                    }
                                });
                        return;
    ...
    public final IHwInterface queryLocalInterface(String str) {
        if ("vendor.samsung.hardware.biometrics.face@3.0::ISehBiometricsFaceClientCallback"
                .equals(str)) {
            return this;
        }
        return null;
