...
public class Fingerprint21UdfpsMock extends Fingerprint21 implements TrustManager.TrustListener {
  ...
  public class TestableBiometricScheduler extends BiometricScheduler {
    ...
    public TestableBiometricScheduler(
        String str, Handler handler, GestureAvailabilityDispatcher gestureAvailabilityDispatcher) {
  ...
  public class MockHalResultController extends Fingerprint21.HalResultController {
    ...
    public void onAuthenticated(
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.sensors.fingerprint.hidl.Fingerprint21UdfpsMock$MockHalResultController$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              Fingerprint21UdfpsMock.MockHalResultController.this.lambda$onAuthenticated$0(
                  i, j, i2, arrayList);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onAuthenticated$0(
  ...
  public static Fingerprint21UdfpsMock newInstance(
      Context context,
    ...
    TestableBiometricScheduler testableBiometricScheduler =
        new TestableBiometricScheduler(
            "Fingerprint21UdfpsMock", handler, gestureAvailabilityDispatcher);
    return new Fingerprint21UdfpsMock(
        context,
  ...
  public final class FakeAcceptRunnable extends FakeFingerRunnable {
    ...
    public void run() {
      if (Fingerprint21UdfpsMock.this.mMockHalResultController.mLastAuthArgs == null) {
        ...
        Fingerprint21UdfpsMock.this.mMockHalResultController.sendAuthenticated(
            Fingerprint21UdfpsMock.this.mMockHalResultController.mLastAuthArgs.deviceId,
            Fingerprint21UdfpsMock.this.mMockHalResultController.mLastAuthArgs.fingerId,
            Fingerprint21UdfpsMock.this.mMockHalResultController.mLastAuthArgs.groupId,
            Fingerprint21UdfpsMock.this.mMockHalResultController.mLastAuthArgs.token);
      }
    }
  }
  ...
  public final class RestartAuthRunnable implements Runnable {
    ...
    public RestartAuthRunnable(
        Fingerprint21UdfpsMock fingerprint21UdfpsMock,
        TestableBiometricScheduler testableBiometricScheduler) {
      this.mFingerprint21 = fingerprint21UdfpsMock;
    ...
    public void run() {
      ...
      if (!(currentClient instanceof FingerprintAuthenticationClient)) {
        Slog.e(
            ...
            "Non-FingerprintAuthenticationClient client: " + currentClient);
        return;
      }
      if (currentClient != this.mLastAuthConsumer) {
        Slog.e(
            ...
            "Current client: "
                + currentClient
                + " does not match mLastAuthConsumer: "
                + this.mLastAuthConsumer);
        return;
      }
      ...
      FingerprintAuthenticateOptions build =
          new FingerprintAuthenticateOptions.Builder()
              .setUserId(currentClient.getTargetUserId())
              .setOpPackageName(currentClient.getOwnerString())
              .build();
      this.mScheduler.getInternalCallback().onClientFinished(currentClient, true);
      this.mFingerprint21.scheduleAuthenticate(
          token, operationId, cookie, listener, build, isRestricted, statsClient, isKeyguard);
    }
  }

  /* JADX WARN: Multi-variable type inference failed */
  public Fingerprint21UdfpsMock(
      Context context,
      BiometricStateCallback biometricStateCallback,
      FingerprintSensorPropertiesInternal fingerprintSensorPropertiesInternal,
      TestableBiometricScheduler testableBiometricScheduler,
      Handler handler,
      LockoutResetDispatcher lockoutResetDispatcher,
      MockHalResultController mockHalResultController,
      BiometricContext biometricContext) {
    super(
        context,
        biometricStateCallback,
    ...
    this.mSensorProperties =
        new FingerprintSensorPropertiesInternal(
            ...
            this.mContext.getResources().getInteger(R.integer.config_letterboxBackgroundType),
            fingerprintSensorPropertiesInternal.componentInfo,
            3,
            false,
            false,
            fingerprintSensorPropertiesInternal.getAllLocations());
    ...
    RestartAuthRunnable restartAuthRunnable =
        new RestartAuthRunnable(this, testableBiometricScheduler);
    this.mRestartAuthRunnable = restartAuthRunnable;
  ...
  @Override // com.android.server.biometrics.sensors.fingerprint.hidl.Fingerprint21,
            // com.android.server.biometrics.sensors.BiometricServiceProvider
  ...
  @Override // com.android.server.biometrics.sensors.fingerprint.hidl.Fingerprint21,
            // com.android.server.biometrics.sensors.fingerprint.ServiceProvider
  public void onPointerDown(long j, int i, PointerContext pointerContext) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.hidl.Fingerprint21UdfpsMock$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$onPointerDown$0() {
    ...
    AuthenticationConsumer lastAuthenticatedClient =
        this.mMockHalResultController.getLastAuthenticatedClient();
    BaseClientMonitor currentClient = this.mScheduler.getCurrentClient();
    ...
    if (currentClient instanceof FingerprintAuthenticationClient) {
      z =
          ((FingerprintAuthenticationClient) currentClient).isKeyguard()
              && this.mUserHasTrust.get(currentClient.getTargetUserId(), false);
    }
  ...
  public void onPointerUp(long j, int i, PointerContext pointerContext) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.sensors.fingerprint.hidl.Fingerprint21UdfpsMock$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$onPointerUp$1() {
    ...
    if (this.mHandler.hasCallbacks(this.mFakeRejectRunnable)
        && !this.mFakeRejectRunnable.isImageCaptureComplete()) {
      this.mHandler.removeCallbacks(this.mFakeRejectRunnable);
      this.mMockHalResultController.onAcquired(0L, 5, 0);
    } else {
      if (!this.mHandler.hasCallbacks(this.mFakeAcceptRunnable)
          || this.mFakeAcceptRunnable.isImageCaptureComplete()) {
        return;
      }
      this.mHandler.removeCallbacks(this.mFakeAcceptRunnable);
      this.mMockHalResultController.onAcquired(0L, 5, 0);
