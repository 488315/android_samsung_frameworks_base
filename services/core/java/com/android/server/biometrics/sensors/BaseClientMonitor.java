...
public abstract class BaseClientMonitor implements IBinder.DeathRecipient {
  ...
  public ClientMonitorCallback mCallback =
      new ClientMonitorCallback() { // from class:
                                    // com.android.server.biometrics.sensors.BaseClientMonitor.1
  ...
  public void destroy() {
    ...
    if (iBinder != null) {
      try {
        ...
        Slog.e(
            "BaseClientMonitor",
            "destroy(): " + this + XmlUtils.STRING_ARRAY_SEPARATOR,
            new Exception("here"));
      }
      this.mToken = null;
    }
