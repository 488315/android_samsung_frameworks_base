...
public final /* synthetic */ class FingerprintProvider$$ExternalSyntheticLambda25
        implements Runnable {
    ...
    public /* synthetic */ FingerprintProvider$$ExternalSyntheticLambda25(
    ...
    public final void run() {
        ...
        fingerprintProvider.scheduleForSensor$1(
                i,
                new SemFingerprintEnrollClient(
                        ...
                        fingerprintProvider.createLogger$1(
                                1, 0, fingerprintProvider.mAuthenticationStatsCollector),
                ...
                new ClientMonitorCompositeCallback(
                        ...
                        new ClientMonitorCallback() { // from class:
                            ...
                            public final void onClientFinished(
                                ...
                                FingerprintProvider.this.mCallbackDispatcher.onClientFinished(
                                        baseClientMonitor, z);
                            }

                            @Override // com.android.server.biometrics.sensors.ClientMonitorCallback
                            public final void onClientStarted(BaseClientMonitor baseClientMonitor) {
                                FingerprintProvider.this.mCallbackDispatcher.onClientStarted(
                                        baseClientMonitor);
                            }
                        }));
    }
