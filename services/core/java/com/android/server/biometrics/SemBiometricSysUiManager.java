...
public class SemBiometricSysUiManager
  ...
  public final Runnable mRunnableHandleUnbind =
      new Runnable() { // from class:
                       // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda1
        @Override // java.lang.Runnable
        public final void run() {
          SemBiometricSysUiManager.this.lambda$new$0();
        }
      };
  public final Runnable mRunnableHandleBindTimeout =
      new Runnable() { // from class:
                       // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda2
        @Override // java.lang.Runnable
        public final void run() {
          SemBiometricSysUiManager.this.lambda$new$1();
        }
      };
  public final ISemBiometricSysUiCallback mSysUiServiceReceiver = new C08281();
  ...
  public final void runPendingCommand() {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void binderDied() {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda7
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void show(
    ...
    handleRequest(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$show$4(
      int i, int i2, boolean z, int i3, String str, long j, Bundle bundle, PromptInfo promptInfo) {
    if (Utils.DEBUG) {
      Slog.d(
          "BiometricSysUiManager",
          "show: " + i + ", " + i2 + ", " + z + ", " + i3 + ", " + str + ", " + j);
    }
    ...
    try {
      this.mSysUiService.showBiometricDialog(
          i, i2, bundle, this.mSysUiServiceReceiver, z, i3, str, j, promptInfo);
    } catch (Exception e) {
  ...
  public void hide(final int i, final int i2, final int i3) {
    handleRequest(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void onBiometricHelp(
      final int i, final int i2, final int i3, final int i4, final String str) {
    handleRequest(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda11
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void onBiometricError(
    ...
    handleRequest(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda12
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void sendCommand(final int i, final int i2, final int i3, final Bundle bundle) {
    handleRequest(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda8
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void sendCommand(final int i, final int i2, final Bundle bundle) {
    ...
    handleRequest(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda10
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void sendConnectionError(final int i) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBiometricSysUiManager$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* renamed from: com.android.server.biometrics.SemBiometricSysUiManager$1 */
  public class C08281 extends ISemBiometricSysUiCallback.Stub {
    public C08281() {}
    ...
    public void onError(final int i, final int i2, final int i3) {
      ...
      SemBiometricSysUiManager.this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.SemBiometricSysUiManager$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              SemBiometricSysUiManager.C08281.this.lambda$onError$0(i, i2, i3);
            }
          });
    }
    ...
    public void onSysUiDismissed(final int i, final int i2, final byte[] bArr) {
      ...
      SemBiometricSysUiManager.this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.SemBiometricSysUiManager$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              SemBiometricSysUiManager.C08281.this.lambda$onSysUiDismissed$1(i, i2, bArr);
            }
          });
    }
    ...
    public void onEvent(final int i, final int i2, final int i3) {
      ...
      SemBiometricSysUiManager.this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.SemBiometricSysUiManager$1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              SemBiometricSysUiManager.C08281.this.lambda$onEvent$2(i, i2, i3);
            }
          });
    }
