...
public final class BiometricContextProvider implements BiometricContext {
  ...
  public static String displayStateToString(int i) {
    return i != 0
        ? i != 1
            ? i != 2
                ? i != 3 ? i != 4 ? "" : "DISPLAY_STATE_AOD" : "DISPLAY_STATE_SCREENSAVER"
                : "DISPLAY_STATE_NO_UI"
        ...
        try {
          sInstance =
              new BiometricContextProvider(
                  ...
                  IStatusBarService.Stub.asInterface(ServiceManager.getServiceOrThrow("statusbar")),
  ...
  public final void subscribeBiometricContextListener(IStatusBarService iStatusBarService) {
    try {
      IBiometricContextListener.Stub stub =
          new IBiometricContextListener
              .Stub() { // from class: com.android.server.biometrics.log.BiometricContextProvider.2
            ...
            public void onDisplayStateChanged(int i) {
              Slog.i(
                  ...
                  "onDisplayStateChanged: " + BiometricContextProvider.displayStateToString(i));
      ...
      ISessionListener.Stub stub2 =
          new ISessionListener
              .Stub() { // from class: com.android.server.biometrics.log.BiometricContextProvider.3
            public void onSessionStarted(int i, InstanceId instanceId) {
              if (Utils.DEBUG) {
                Slog.d("BiometricContextProvider", "onSessionStarted: " + i + ", " + instanceId);
              }
              BiometricContextProvider.this.mSession.put(
                  Integer.valueOf(i), new BiometricContextSessionInfo(instanceId));
            }
            ...
            public void onSessionEnded(int i, InstanceId instanceId) {
              ...
              BiometricContextSessionInfo biometricContextSessionInfo =
                  (BiometricContextSessionInfo)
                      BiometricContextProvider.this.mSession.remove(Integer.valueOf(i));
              if (biometricContextSessionInfo == null
                  || instanceId == null
                  || biometricContextSessionInfo.getId() == instanceId.getId()) {
                return;
              }
  ...
  public void subscribe(OperationContextExt operationContextExt, Consumer consumer) {
    ...
    if (operationContextExt.getDisplayState() != getDisplayState()) {
      consumer.accept(
          operationContextExt.update(this, operationContextExt.isCrypto()).toAidlContext());
    }
  }
    ...
    if (handler != null) {
      handler.post(
          new Runnable() { // from class:
                           // com.android.server.biometrics.log.BiometricContextProvider$$ExternalSyntheticLambda0
  ...
  public final void notifySubscribers() {
    this.mSubscribers.forEach(
        new BiConsumer() { // from class:
                           // com.android.server.biometrics.log.BiometricContextProvider$$ExternalSyntheticLambda1
          @Override // java.util.function.BiConsumer
          public final void accept(Object obj, Object obj2) {
            BiometricContextProvider.this.lambda$notifySubscribers$0(
                (OperationContextExt) obj, (Consumer) obj2);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$notifySubscribers$0(
      OperationContextExt operationContextExt, Consumer consumer) {
    consumer.accept(
        operationContextExt.update(this, operationContextExt.isCrypto()).toAidlContext());
  }

  public String toString() {
    return "[keyguard session: "
        + getKeyguardEntrySessionInfo()
        + ", bp session: "
        + getBiometricPromptSessionInfo()
        + ", displayState: "
        + getDisplayState()
        + ", isAwake: "
        + isAwake()
  ...
  @Override // com.android.server.biometrics.log.BiometricContext
  public void ensureBiometricContextListener(
    ...
    try {
      IStatusBarService.Stub.asInterface(ServiceManager.getServiceOrThrow("statusbar"))
          .setBiometicContextListener(this.mIBiometricContextListener);
    } catch (ServiceManager.ServiceNotFoundException | RemoteException e) {
      e.printStackTrace();
    }
    semBiometricDisplayStateMonitor.registerCallback(
        new SemBiometricDisplayMonitor
            .Callback() { // from class:
                          // com.android.server.biometrics.log.BiometricContextProvider.4
