...
public class BiometricLogger {
  ...
  public void logOnAcquired(
    ...
    if (this.mShouldLogMetrics) {
      ...
      this.mSink.acquired(
          ...
          this.mStatsAction,
          this.mStatsClient,
          Utils.isDebugEnabled(context, i3),
          i,
          i2,
          i3);
    }
  ...
  public void logOnAuthenticated(
      Context context,
    ...
    if (this.mShouldLogMetrics) {
      ...
      if (DEBUG) {
        Slog.v(
            ...
            "Authenticated! Modality: "
                ...
                + currentTimeMillis
                + ", Lux: "
                + this.mALSProbe.getMostRecentLux());
      } else {
      ...
      this.mSink.authenticate(
          operationContextExt,
          this.mStatsModality,
          this.mStatsAction,
          this.mStatsClient,
          Utils.isDebugEnabled(context, i),
          currentTimeMillis,
          i2,
          z2,
          i,
