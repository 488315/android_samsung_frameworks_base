...
public class SemBioAnalyticsManager {
  ...
  public static final Singleton sInstance =
      new Singleton() { // from class: com.android.server.biometrics.SemBioAnalyticsManager.1
        /* renamed from: create, reason: merged with bridge method [inline-methods] */
        public SemBioAnalyticsManager m3470create() {
  ...
  public SemBioAnalyticsManager() {
    ...
    this.f1651mH = SemBioFgThread.get().getHandler();
  ...
  public void onBootComplete(final Context context) {
    this.f1651mH.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBioAnalyticsManager$$ExternalSyntheticLambda0
  ...
  public final void fpInsertLog(final EventData eventData) {
    this.f1651mH.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBioAnalyticsManager$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void fpInsertLogSensorStatus(int i) {
    if (i == 100042) {
      if (!this.mIsSensorErrorForDQA) {
        String str =
            "pre:"
                + this.mLatestAuthenticatedForDQA
                + ";gesture:"
                + this.mHasGestureEventForDQA
                + ";first:"
                + this.mIsFirstSensorCheckForDQA;
  ...
  public final void faceInsertLog(final EventData eventData) {
    this.f1651mH.post(
        new Runnable() { // from class:
                         // com.android.server.biometrics.SemBioAnalyticsManager$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void fpHandleData(EventData eventData) {
    ...
    if (SemBiometricFeature.FP_FEATURE_GESTURE_MODE
        && !this.mHasGestureEventForDQA
        && "FPGT".equals(eventData.mFeature)) {
    ...
    if (this.mIsSupportDMA) {
      ...
      if (eventData.mFeature.equals("FPIS")
          ...
          && Utils.isRuneStoneApp(this.mContext, str)) {
  ...
  public class DQAManager {
                ...
                if (action.equals("com.sec.android.intent.action.HQM_UPDATE_REQ")) {
                  ...
                  if (SemBiometricFeature.FP_FEATURE_SUPPORT_FINGERPRINT) {
                    ...
                    dQAManager.writeDqaDataToFile(
                        ...
                        dQAManager.fpGetDqaDataFormatToSave());
                  }
                  if (DQAManager.this.FACE_FEATURE_HAL) {
                    DQAManager dQAManager2 = DQAManager.this;
                    dQAManager2.writeDqaDataToFile(
                        "settings_face_ext_bigdata.xml", dQAManager2.faceGetDqaDataFormatToSave());
                  }
                }
              }
            },
    ...
    public void fpHandleDqaData(EventData eventData) {
      ...
      if (this.mFpBigDataNameMap.containsKey(eventData.mFeature)) {
        this.mFpBigDataNameMap.put(
            eventData.mFeature,
            Integer.valueOf(
                ((Integer) this.mFpBigDataNameMap.get(eventData.mFeature)).intValue() + 1));
    ...
    public void faceHandleDqaData(EventData eventData) {
      if (this.mFaceBigDataNameMap.containsKey(eventData.mFeature)) {
        this.mFaceBigDataNameMap.put(
            eventData.mFeature,
            Integer.valueOf(
                ((Integer) this.mFaceBigDataNameMap.get(eventData.mFeature)).intValue() + 1));
        if (needToSaveBigFeatures()) {
                  ...
                  Integer.valueOf(
                      Integer.parseInt(
                              str.substring(indexOf + 5)
                                  .split(XmlUtils.STRING_ARRAY_SEPARATOR)[0]
                                  .trim())
                          + ((Integer) this.mFpBigDataNameMap.get(str2)).intValue()));
            }
          }
        } catch (Exception e) {
                  ...
                  Integer.valueOf(
                      Integer.parseInt(
                              str.substring(indexOf + 5)
                                  .split(XmlUtils.STRING_ARRAY_SEPARATOR)[0]
                                  .trim())
                          + ((Integer) this.mFaceBigDataNameMap.get(str2)).intValue()));
            }
          }
        } catch (Exception e) {
    ...
    public final void writeDqaDataToFile(final String str, final String str2) {
      SemBioFgThread.get()
          ...
          .post(
              new Runnable() { // from class:
                               // com.android.server.biometrics.SemBioAnalyticsManager$DQAManager$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    */
    public final String readDqaDataFromFile(String str) {
      String str2;
      byte[] readFile = Utils.readFile(new File(Environment.getUserSystemDirectory(0), str));
      if (readFile != null) {
        try {
          str2 = new String(readFile);
        } catch (Exception e) {
          Log.w("BiometricService.AM", "DQAManager.readDqaDataFromFile: " + e.getMessage());
        }
        if (SemBioAnalyticsManager.DEBUG) {
          Log.d("BiometricService.AM", "DQAManager.readDqaDataFromFile: " + str2);
        }
        return str2;
      }
      str2 = null;
    ...
    public final boolean needToSaveBigFeatures() {
      if (this.mPreviousSavedTime != 0
          && System.currentTimeMillis() - this.mPreviousSavedTime
    ...
    public final void sendFingerprintBigData(String str, String str2) {
      ...
      if (SemBioAnalyticsManager.DEBUG) {
        Log.d(
            "BiometricService.AM",
            "DQAManager.sendFingerprintBigData: " + str + XmlUtils.STRING_ARRAY_SEPARATOR + str2);
      }
    ...
    public final void sendFaceBigData(String str, String str2) {
      ...
      if (SemBioAnalyticsManager.DEBUG) {
        Log.d(
            "BiometricService.AM",
            "DQAManager.sendFaceBigData: " + str + XmlUtils.STRING_ARRAY_SEPARATOR + str2);
      }
      if (this.mSemHqmManager == null) {
        this.mSemHqmManager = (SemHqmManager) this.mContext.getSystemService(SemHqmManager.class);
      }
