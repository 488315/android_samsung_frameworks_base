...
public final /* synthetic */ class SemBiometricSysUiManager$$ExternalSyntheticLambda6
        implements Runnable {
    ...
    public /* synthetic */ SemBiometricSysUiManager$$ExternalSyntheticLambda6(
            SemBiometricSysUiManager.AnonymousClass1 anonymousClass1, int i, int i2, byte[] bArr) {
        this.$r8$classId = 2;
    ...
    public /* synthetic */ SemBiometricSysUiManager$$ExternalSyntheticLambda6(
            SemBiometricSysUiManager semBiometricSysUiManager, int i, int i2) {
        this.$r8$classId = 1;
    ...
    public /* synthetic */ SemBiometricSysUiManager$$ExternalSyntheticLambda6(
            SemBiometricSysUiManager semBiometricSysUiManager, int i, int i2, Bundle bundle) {
        this.$r8$classId = 0;
        this.f$0 = semBiometricSysUiManager;
        this.f$1 = i;
        this.f$2 = i2;
            ...
            case 0:
                ...
                try {
                    ...
                    MagnificationConnectionManager$$ExternalSyntheticOutline0.m(
                            e,
                            new StringBuilder("sendCommandIfSessionExist: "),
                            "BiometricSysUiManager");
                    return;
                }
            case 1:
                SemBiometricSysUiManager semBiometricSysUiManager2 =
                        (SemBiometricSysUiManager) this.f$0;
                int i3 = this.f$1;
                int i4 = this.f$2;
                ...
                try {
                    ...
                    MagnificationConnectionManager$$ExternalSyntheticOutline0.m(
                            e2, new StringBuilder("sendCommand: "), "BiometricSysUiManager");
                    return;
                }
            default:
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            if (sysUiListener != null
                                    && (i5 == 0 || i5 == sysUiServiceSession.mId)) {
                                sysUiListener.onDismissed(i6, bArr);
                            }
                        } catch (Exception e3) {
                            Slog.w(
                                    "BiometricSysUiManager",
                                    "notifySysUiDismissedEvent: " + e3.getMessage());
                        }
                    }
                }
                return;
