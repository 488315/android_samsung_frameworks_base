...
public abstract class BiometricSensor {
  ...
  public BiometricSensor(
      Context context, int i, int i2, int i3, IBiometricAuthenticator iBiometricAuthenticator) {
  ...
  public void goToStateWaitingForCookie(
      boolean z,
      IBinder iBinder,
      long j,
      int i,
  ...
  public void goToStateCookieReturnedIfCookieMatches(int i) {
    if (i == this.mCookie) {
      Slog.d("BiometricService/Sensor", "Sensor(" + this.f1650id + ") matched cookie: " + i);
      this.mSensorState = 2;
    }
  }
  ...
  public void goToStoppedStateIfCookieMatches(int i, int i2) {
    if (i == this.mCookie) {
      Slog.d("BiometricService/Sensor", "Sensor(" + this.f1650id + ") now in STATE_STOPPED");
      this.mError = i2;
      this.mSensorState = 5;
    }
  }
    ...
    try {
      i =
          Utils.propertyStrengthToAuthenticatorStrength(
              this.impl.getSensorProperties("BiometricService/Sensor").sensorStrength);
