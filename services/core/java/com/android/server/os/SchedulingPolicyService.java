...
public class SchedulingPolicyService extends ISchedulingPolicyService.Stub {
  ...
  public final IBinder.DeathRecipient mDeathRecipient =
      new IBinder.DeathRecipient() { // from class: com.android.server.os.SchedulingPolicyService.1
  ...
  public /* synthetic */ void lambda$new$0() {
    ...
    synchronized (this.mDeathRecipient) {
      if (this.mBoostedPid == -1
          && (pidsForCommands = Process.getPidsForCommands(MEDIA_PROCESS_NAMES)) != null
  ...
  public final boolean isPermitted() {
    ...
    return Binder.getCallingPid() == Process.myPid()
        || (callingUid = Binder.getCallingUid()) == 1002
        || callingUid == 1041
        || callingUid == 1047;
  }
}
