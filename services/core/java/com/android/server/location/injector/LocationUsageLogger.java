...
public class LocationUsageLogger {
  ...
  */
  public void logLocationApiUsage(
      int i,
      int i2,
      String str,
      String str2,
    ...
    try {
      ...
      int bucketizeDistance =
          z6 ? 0 : bucketizeDistance(locationRequest.getMinUpdateDistanceMeters());
      ...
      if (!z6 && i != 1) {
        ...
        FrameworkStatsLog.write(
            ...
            maxUpdates,
            i3,
            getCallbackType(i4, z5, z4),
            z7 ? 0 : bucketizeRadius(geofence.getRadius()),
            categorizeActivityImportance(z3),
            str2);
      }
      i4 = i2;
      z5 = z;
