...
public class SystemSettingsHelper extends SettingsHelper {
  ...
  public final PackageTagsListSetting mAdasPackageAllowlist =
      new PackageTagsListSetting(
          ...
          new Supplier() { // from class:
                           // com.android.server.location.injector.SystemSettingsHelper$$ExternalSyntheticLambda1
  ...
  public final PackageTagsListSetting mIgnoreSettingsPackageAllowlist =
      new PackageTagsListSetting(
          ...
          new Supplier() { // from class:
                           // com.android.server.location.injector.SystemSettingsHelper$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
  ...
  public SystemSettingsHelper(Context context) {
    ...
    this.mLocationMode =
        new IntegerSecureSetting(context, "location_mode", LocationServiceThread.getHandler());
    this.mBackgroundThrottleIntervalMs =
        new LongGlobalSetting(
            context,
            "location_background_throttle_interval_ms",
            LocationServiceThread.getHandler());
    this.mGnssMeasurementFullTracking =
        new BooleanGlobalSetting(
            context, "enable_gnss_raw_meas_full_tracking", LocationServiceThread.getHandler());
    this.mLocationPackageBlacklist =
        new StringListCachedSecureSetting(
            context, "locationPackagePrefixBlacklist", LocationServiceThread.getHandler());
    this.mLocationPackageWhitelist =
        new StringListCachedSecureSetting(
            context, "locationPackagePrefixWhitelist", LocationServiceThread.getHandler());
  ...
  public void setLocationEnabled(boolean z, int i) {
    ...
    try {
      Settings.Secure.putIntForUser(
          this.mContext.getContentResolver(), "location_mode", z ? 3 : 0, i);
    } finally {
  ...
  @Override // com.android.server.location.injector.SettingsHelper
  public void addOnLocationEnabledChangedListener(
      SettingsHelper.UserSettingChangedListener userSettingChangedListener) {
    this.mLocationMode.addListener(userSettingChangedListener);
  }

  @Override // com.android.server.location.injector.SettingsHelper
  public void removeOnLocationEnabledChangedListener(
      SettingsHelper.UserSettingChangedListener userSettingChangedListener) {
  ...
  public void addOnBackgroundThrottleIntervalChangedListener(
      SettingsHelper.GlobalSettingChangedListener globalSettingChangedListener) {
  ...
  @Override // com.android.server.location.injector.SettingsHelper
  public void addAdasAllowlistChangedListener(
      SettingsHelper.GlobalSettingChangedListener globalSettingChangedListener) {
    this.mAdasPackageAllowlist.addListener(globalSettingChangedListener);
  }

  @Override // com.android.server.location.injector.SettingsHelper
  public void removeAdasAllowlistChangedListener(
      SettingsHelper.GlobalSettingChangedListener globalSettingChangedListener) {
  ...
  public float getCoarseLocationAccuracyM() {
    ...
    try {
      return Settings.Secure.getFloatForUser(
          contentResolver, "locationCoarseAccuracy", 2000.0f, contentResolver.getUserId());
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
  }
    ...
    public int getValueForUser(int i, int i2) {
      ...
      try {
        return Settings.Secure.getIntForUser(
            this.mContext.getContentResolver(), this.mSettingName, i, i2);
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
    ...
    public boolean getValue(boolean z) {
      ...
      try {
        return Settings.Global.getInt(
                this.mContext.getContentResolver(), this.mSettingName, z ? 1 : 0)
            != 0;
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
  ...
  public class StringSetCachedGlobalSetting extends ObservingSetting {
    ...
    public StringSetCachedGlobalSetting(
        Context context, String str, Supplier supplier, Handler handler) {
      super(handler);
      this.mContext = context;
      this.mSettingName = str;
    ...
    public synchronized Set getValue() {
      ...
      if (!this.mValid) {
        ...
        try {
          ...
          String string =
              Settings.Global.getString(this.mContext.getContentResolver(), this.mSettingName);
  ...
  public abstract class DeviceConfigSetting implements DeviceConfig.OnPropertiesChangedListener {
    ...
    public synchronized void register() {
      ...
      DeviceConfig.addOnPropertiesChangedListener(
          "location", LocationServiceThread.getExecutor(), this);
      this.mRegistered = true;
    }
      ...
      if (!this.mValid) {
        ...
        try {
          PackageTagsList.Builder add =
              new PackageTagsList.Builder().add((Map) this.mBaseValuesSupplier.get());
