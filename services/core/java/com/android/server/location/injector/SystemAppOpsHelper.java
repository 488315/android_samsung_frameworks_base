...
public class SystemAppOpsHelper extends AppOpsHelper {
    ...
    public void onSystemReady() {
        ...
        this.mAppOps.startWatchingMode(58, (String) null, 0, (AppOpsManager.OnOpChangedListener) new AppOpsManagerOnOpChangedInternalListenerC18171());
    }
    ...
    public class AppOpsManagerOnOpChangedInternalListenerC18171 extends AppOpsManager.OnOpChangedInternalListener {
        ...
        public void onOpChanged(int i, final String str) {
            LocationServiceThread.getHandler().post(new Runnable() { // from class: com.android.server.location.injector.SystemAppOpsHelper$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SystemAppOpsHelper.AppOpsManagerOnOpChangedInternalListenerC18171.this.lambda$onOpChanged$0(str);
                }
            });
        }
    }
