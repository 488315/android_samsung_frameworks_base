...
public final class SystemAppOpsHelper {
        ...
        public final void onOpChanged(int i, final String str) {
            LocationServiceThread.getHandler()
                    .post(
                            new Runnable(
                                    str) { // from class:
                                           // com.android.server.location.injector.SystemAppOpsHelper$1$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    Iterator it =
                                            SystemAppOpsHelper.this.mMockLocationListeners
                                                    .iterator();
                                    while (it.hasNext()) {
                                        LocationManagerService locationManagerService =
                                                ((LocationManagerService$$ExternalSyntheticLambda2)
                                                                it.next())
                                                        .f$0;
                                        synchronized (locationManagerService.mLock) {
                                            if (!locationManagerService.mMockLocationRecord
                                                    .isEmpty()) {
                                                String str2 =
                                                        (String)
                                                                ((Map.Entry)
                                                                        ...
                                                                        .getValue();
                                                try {
                                                    if (!((LocationManagerService.SystemInjector)
                                                                    locationManagerService
                                                                            .mInjector)
                                                            .mAppOpsHelper.checkMockLocationAccess(
                                                                    locationManagerService
                                                                            .mPackageManager
                                                                            .getPackageUid(str2, 0),
                                                                    str2)) {
                                                        locationManagerService
                                                                .recoverRealProviderLocked(str2);
                                                    }
                                                } catch (
    ...
    public final boolean noteOp(CallerIdentity callerIdentity) {
        ...
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            return this.mAppOps.noteOp(
                            58,
                            callerIdentity.getUid(),
                            callerIdentity.getPackageName(),
                            callerIdentity.getAttributionTag(),
                            callerIdentity.getListenerId())
                    == 0;
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    ...
    public final boolean noteOpNoThrow(int i, CallerIdentity callerIdentity) {
        ...
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            return this.mAppOps.noteOpNoThrow(
                            i,
                            callerIdentity.getUid(),
                            callerIdentity.getPackageName(),
                            callerIdentity.getAttributionTag(),
    ...
    public final void onSystemReady() {
        ...
        appOpsManager.startWatchingMode(
                ...
                (String) null,
                1,
                new AppOpsManager.OnOpChangedListener() { // from class:
                    // com.android.server.location.injector.SystemAppOpsHelper$$ExternalSyntheticLambda0
                        ...
                        LocationServiceThread.getHandler()
                                .post(
                                        new Runnable() { // from class:
                                            // com.android.server.location.injector.SystemAppOpsHelper$$ExternalSyntheticLambda1
                                            @Override // java.lang.Runnable
                                            public final void run() {
                                                SystemAppOpsHelper systemAppOpsHelper2 =
                                                        SystemAppOpsHelper.this;
                                                String str3 = str2;
                                                Iterator it =
                                                        systemAppOpsHelper2.mListeners.iterator();
                                                while (it.hasNext()) {
                                                    SystemLocationPermissionsHelper
                                                            systemLocationPermissionsHelper =
                                                                    ((LocationPermissionsHelper$$ExternalSyntheticLambda0)
                                                                                    it.next())
                                                                            .f$0;
                                                    ...
                                                    if (nSPermissionHelper != null) {
                                                        nSPermissionHelper.mNSConnectionHelper
                                                                .onStateUpdated(
                                                                        LocationConstants.STATE_TYPE
                                                                                .OP_CHANGED,
                                                                        AccountManagerService$$ExternalSyntheticOutline0
                                                                                .m142m(
                                                                                        "packageName",
                                                                                        str3));
                                                    }
                                                    ...
                                                    while (it2.hasNext()) {
                                                        ((LocationPermissionsHelper$LocationPermissionsListener)
                                                                        it2.next())
                                                                .onLocationPermissionsChanged(str3);
                                                    }
                                                }
                                            }
                                        });
        ...
        this.mAppOps.startWatchingMode(
                58, (String) null, 0, (AppOpsManager.OnOpChangedListener) new AnonymousClass1());
    }
