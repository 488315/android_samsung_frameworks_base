...
public abstract class AlarmHelper {
  ...
  public abstract void setDelayedAlarmInternal(
      long j, AlarmManager.OnAlarmListener onAlarmListener, WorkSource workSource);

  public final void setDelayedAlarm(
      long j, AlarmManager.OnAlarmListener onAlarmListener, WorkSource workSource) {
