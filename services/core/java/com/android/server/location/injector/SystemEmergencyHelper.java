...
public class SystemEmergencyHelper extends EmergencyHelper {
              ...
              synchronized (SystemEmergencyHelper.this) {
                try {
                  ...
                  systemEmergencyHelper.mIsInEmergencyCall =
                      systemEmergencyHelper.mTelephonyManager.isEmergencyNumber(
                          intent.getStringExtra("android.intent.extra.PHONE_NUMBER"));
                } catch (IllegalStateException e) {
                  Log.w(
                      "LocationManagerService",
                      "Failed to call TelephonyManager.isEmergencyNumber().",
                      e);
                }
              }
            }
  ...
  */
  ...
  public class EmergencyCallTelephonyCallback extends TelephonyCallback
