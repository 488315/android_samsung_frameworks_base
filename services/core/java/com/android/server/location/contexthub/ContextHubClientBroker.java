...
public class ContextHubClientBroker extends IContextHubClient.Stub
    implements IBinder.DeathRecipient, AppOpsManager.OnOpChangedListener, PendingIntent.OnFinished {
  ...
  public ContextHubClientBroker(
      ...
      short s,
      IContextHubClientCallback iContextHubClientCallback,
      String str,
    ...
    this.mQueryPermsCallback =
        new IContextHubTransactionCallback
            .Stub() { // from class: com.android.server.location.contexthub.ContextHubClientBroker.1
          ...
          public void onQueryResponse(int i, List list) {
            ...
            if (i != 0 && list != null) {
              Log.e(
                  ...
                  "Permissions query failed, but still received nanoapp state");
              return;
            }
            if (list != null) {
              ...
              while (it.hasNext()) {
                ...
                if (ContextHubClientBroker.this.mMessageChannelNanoappIdMap.containsKey(
                    Long.valueOf(nanoAppState.getNanoAppId()))) {
                  ContextHubClientBroker.this.updateNanoAppAuthState(
                      nanoAppState.getNanoAppId(), nanoAppState.getNanoAppPermissions(), false);
                }
              }
            }
          }
    ...
    if (str2 == null) {
      ...
      Log.e(
          "ContextHubClientBroker",
          "createClient: Provided package name null. Using first package name " + str2);
    }
    this.mPackage = str2;
    ...
    PowerManager.WakeLock newWakeLock =
        ((PowerManager) context.getSystemService(PowerManager.class))
            .newWakeLock(1, "ContextHubClientBroker");
  ...
  public int sendMessageToNanoApp(NanoAppMessage nanoAppMessage) {
    ...
    if (isRegistered()) {
      int intValue =
          ((Integer)
                  this.mMessageChannelNanoappIdMap.getOrDefault(
                      Long.valueOf(nanoAppMessage.getNanoAppId()), -1))
              .intValue();
      if (intValue == 0) {
        ...
        throw new SecurityException(
            "Client doesn't have valid permissions to send message to "
      ...
      try {
        i =
            this.mContextHubProxy.sendMessageToContextHub(
                this.mHostEndPointId, this.mAttachedContextHubInfo.getId(), nanoAppMessage);
      } catch (RemoteException e) {
        Log.e(
            "ContextHubClientBroker",
            "RemoteException in sendMessageToNanoApp (target hub ID = "
                + this.mAttachedContextHubInfo.getId()
                + ")",
            e);
        i = 1;
      }
      ContextHubEventLogger.getInstance()
          .logMessageToNanoapp(this.mAttachedContextHubInfo.getId(), nanoAppMessage, i == 0);
      return i;
    }
    Log.e(
        "ContextHubClientBroker",
        String.format(
            ...
            Short.valueOf(this.mHostEndPointId),
            Base64.getEncoder().encodeToString(nanoAppMessage.getMessageBody())));
    return 1;
  }
  ...
  public void sendMessageToClient(final NanoAppMessage nanoAppMessage, List list, List list2) {
    ...
    if (updateNanoAppAuthState != 0) {
      if (notePermissions(list2, "NanoappMessageDelivery " + nanoAppId)) {
        invokeCallback(
            new CallbackConsumer() { // from class:
                                     // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda5
        ...
        sendPendingIntent(
            new Supplier() { // from class:
                             // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda6
              @Override // java.util.function.Supplier
              public final Object get() {
                Intent lambda$sendMessageToClient$1;
                lambda$sendMessageToClient$1 =
                    ContextHubClientBroker.this.lambda$sendMessageToClient$1(
                        nanoAppId, nanoAppMessage);
  ...
  public /* synthetic */ Intent lambda$sendMessageToClient$1(
      long j, NanoAppMessage nanoAppMessage) {
    return createIntent(5, j)
        .putExtra("android.hardware.location.extra.MESSAGE", (Parcelable) nanoAppMessage);
  }
  ...
  public void onNanoAppLoaded(final long j) {
    ...
    invokeCallback(
        new CallbackConsumer() { // from class:
                                 // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda13
          @Override // com.android.server.location.contexthub.ContextHubClientBroker.CallbackConsumer
          public final void accept(IContextHubClientCallback iContextHubClientCallback) {
    ...
    sendPendingIntent(
        new Supplier() { // from class:
                         // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda14
          @Override // java.util.function.Supplier
          public final Object get() {
  ...
  public void onNanoAppUnloaded(final long j) {
    invokeCallback(
        new CallbackConsumer() { // from class:
                                 // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda11
          @Override // com.android.server.location.contexthub.ContextHubClientBroker.CallbackConsumer
          public final void accept(IContextHubClientCallback iContextHubClientCallback) {
    ...
    sendPendingIntent(
        new Supplier() { // from class:
                         // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda12
          @Override // java.util.function.Supplier
          public final Object get() {
  ...
  public void onHubReset() {
    invokeCallback(
        new CallbackConsumer() { // from class:
                                 // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda7
          @Override // com.android.server.location.contexthub.ContextHubClientBroker.CallbackConsumer
          public final void accept(IContextHubClientCallback iContextHubClientCallback) {
    ...
    sendPendingIntent(
        new Supplier() { // from class:
                         // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda8
          @Override // java.util.function.Supplier
          public final Object get() {
  ...
  public void onNanoAppAborted(final long j, final int i) {
    invokeCallback(
        new CallbackConsumer() { // from class:
                                 // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda9
          @Override // com.android.server.location.contexthub.ContextHubClientBroker.CallbackConsumer
          public final void accept(IContextHubClientCallback iContextHubClientCallback) {
    ...
    sendPendingIntent(
        new Supplier() { // from class:
                         // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda10
          @Override // java.util.function.Supplier
          public final Object get() {
  ...
  public boolean notePermissions(List list, String str) {
    ...
    while (it.hasNext()) {
      ...
      if (permissionToOpCode != -1) {
        try {
          if (this.mAppOpsManager.noteOp(
                  permissionToOpCode, this.mUid, this.mPackage, this.mAttributionTag, str)
              != 0) {
            return false;
          }
  ...
  public void handleAuthStateTimerExpiry(long j) {
    ...
    synchronized (this.mMessageChannelNanoappIdMap) {
      authStateDenialTimer =
          (AuthStateDenialTimer) this.mNappToAuthTimerMap.remove(Long.valueOf(j));
    }
  ...
  public final void checkNanoappPermsAsync() {
    ...
    this.mTransactionManager.addTransaction(
        this.mTransactionManager.createQueryTransaction(
            this.mAttachedContextHubInfo.getId(), this.mQueryPermsCallback, this.mPackage));
  }
  ...
  */
  public int updateNanoAppAuthState(long j, List list, boolean z, boolean z2) {
    int intValue;
    int i;
    synchronized (this.mMessageChannelNanoappIdMap) {
      boolean hasPermissions = hasPermissions(list);
      intValue =
          ((Integer) this.mMessageChannelNanoappIdMap.getOrDefault(Long.valueOf(j), -1)).intValue();
      if (intValue == -1) {
          ...
          if (intValue == 1) {
            if (i == 1) {
              AuthStateDenialTimer authStateDenialTimer =
                  (AuthStateDenialTimer) this.mNappToAuthTimerMap.remove(Long.valueOf(j));
              if (authStateDenialTimer != null) {
                authStateDenialTimer.cancel();
              }
            } else if (intValue == 2) {
              AuthStateDenialTimer authStateDenialTimer2 =
                  new AuthStateDenialTimer(this, j, Looper.getMainLooper());
              this.mNappToAuthTimerMap.put(Long.valueOf(j), authStateDenialTimer2);
              authStateDenialTimer2.start();
            }
            if (intValue != i) {
  ...
  public final void sendAuthStateCallback(final long j, final int i) {
    invokeCallback(
        new CallbackConsumer() { // from class:
                                 // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda3
          @Override // com.android.server.location.contexthub.ContextHubClientBroker.CallbackConsumer
          public final void accept(IContextHubClientCallback iContextHubClientCallback) {
    ...
    sendPendingIntent(
        new Supplier() { // from class:
                         // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda4
          @Override // java.util.function.Supplier
          public final Object get() {
            Intent lambda$sendAuthStateCallback$10;
            lambda$sendAuthStateCallback$10 =
                ContextHubClientBroker.this.lambda$sendAuthStateCallback$10(j, i);
  ...
  public /* synthetic */ Intent lambda$sendAuthStateCallback$10(long j, int i) {
    return createIntent(7, j)
        .putExtra("android.hardware.location.extra.CLIENT_AUTHORIZATION_STATE", i);
  }
  ...
  public final Intent createIntent(int i) {
    ...
    intent.putExtra(
        ...
        (Parcelable) this.mAttachedContextHubInfo);
    return intent;
  }
  ...
  public final synchronized void sendPendingIntent(Supplier supplier) {
    if (this.mPendingIntentRequest.hasPendingIntent()) {
      doSendPendingIntent(
          this.mPendingIntentRequest.getPendingIntent(), (Intent) supplier.get(), this);
    }
  }

  public final synchronized void sendPendingIntent(Supplier supplier, long j) {
    if (this.mPendingIntentRequest.hasPendingIntent()
        && this.mPendingIntentRequest.getNanoAppId() == j) {
      doSendPendingIntent(
          this.mPendingIntentRequest.getPendingIntent(), (Intent) supplier.get(), this);
    }
  }

  public void doSendPendingIntent(
      PendingIntent pendingIntent, Intent intent, PendingIntent.OnFinished onFinished) {
    try {
      acquireWakeLock();
      pendingIntent.send(
          this.mContext,
      ...
      Log.w(
          "ContextHubClientBroker",
          "PendingIntent has been canceled, unregistering from client (host endpoint ID "
              + ((int) this.mHostEndPointId)
              + ")");
      close();
    }
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda1
  ...
  public final void releaseWakeLock() {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda2
          public final void runOrThrow() {
  ...
  public final void releaseWakeLockOnExit() {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.contexthub.ContextHubClientBroker$$ExternalSyntheticLambda0
          public final void runOrThrow() {
    ...
    synchronized (this.mWakeLock) {
      ...
      while (this.mWakeLock.isHeld()) {
        try {
          ...
          Log.e(
              "ContextHubClientBroker", "Releasing the wakelock for all acquisitions fails - ", e);
        }
      }
    }
  }
