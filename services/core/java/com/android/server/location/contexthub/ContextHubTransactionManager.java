...
public class ContextHubTransactionManager {
  ...
  public final ConcurrentLinkedEvictingDeque mTransactionRecordDeque =
      new ConcurrentLinkedEvictingDeque(20);
  ...
  public ContextHubServiceTransaction createLoadTransaction(
      final int i,
      final NanoAppBinary nanoAppBinary,
      final IContextHubTransactionCallback iContextHubTransactionCallback,
      String str) {
    return new ContextHubServiceTransaction(
        this.mNextAvailableId.getAndIncrement(),
        0,
        nanoAppBinary.getNanoAppId(),
        str) { // from class: com.android.server.location.contexthub.ContextHubTransactionManager.1
      ...
      public int onTransact() {
        try {
          return ContextHubTransactionManager.this.mContextHubProxy.loadNanoapp(
              i, nanoAppBinary, getTransactionId());
      ...
      public void onTransactionComplete(int i2) {
        ContextHubStatsLog.write(
            ...
            1,
            ContextHubTransactionManager.this.toStatsTransactionResult(i2));
        ...
        if (i2 == 0) {
          ContextHubTransactionManager.this.mNanoAppStateManager.addNanoAppInstance(
              i, nanoAppBinary.getNanoAppId(), nanoAppBinary.getNanoAppVersion());
        }
        try {
          iContextHubTransactionCallback.onTransactionComplete(i2);
          if (i2 == 0) {
            ContextHubTransactionManager.this.mClientManager.onNanoAppLoaded(
                i, nanoAppBinary.getNanoAppId());
          }
        } catch (RemoteException e) {
          Log.e(
              "ContextHubTransactionManager",
  ...
  public ContextHubServiceTransaction createUnloadTransaction(
      final int i,
      final long j,
      final IContextHubTransactionCallback iContextHubTransactionCallback,
      String str) {
    return new ContextHubServiceTransaction(
        ...
        1,
        j,
        str) { // from class: com.android.server.location.contexthub.ContextHubTransactionManager.2
      @Override // com.android.server.location.contexthub.ContextHubServiceTransaction
      public int onTransact() {
        try {
          return ContextHubTransactionManager.this.mContextHubProxy.unloadNanoapp(
              i, j, getTransactionId());
        } catch (RemoteException e) {
          Log.e(
              "ContextHubTransactionManager",
              "RemoteException while trying to unload nanoapp with ID 0x" + Long.toHexString(j),
              e);
          return 1;
        }
      }
      ...
      public void onTransactionComplete(int i2) {
        ContextHubStatsLog.write(
            401, j, 0, 2, ContextHubTransactionManager.this.toStatsTransactionResult(i2));
  ...
  public ContextHubServiceTransaction createEnableTransaction(
      final int i,
      final long j,
      final IContextHubTransactionCallback iContextHubTransactionCallback,
      String str) {
    return new ContextHubServiceTransaction(
        this.mNextAvailableId.getAndIncrement(),
        2,
        str) { // from class: com.android.server.location.contexthub.ContextHubTransactionManager.3
      @Override // com.android.server.location.contexthub.ContextHubServiceTransaction
      public int onTransact() {
        try {
          return ContextHubTransactionManager.this.mContextHubProxy.enableNanoapp(
              i, j, getTransactionId());
        } catch (RemoteException e) {
          Log.e(
              "ContextHubTransactionManager",
              "RemoteException while trying to enable nanoapp with ID 0x" + Long.toHexString(j),
              e);
          return 1;
        }
      }
  ...
  public ContextHubServiceTransaction createDisableTransaction(
      final int i,
      final long j,
      final IContextHubTransactionCallback iContextHubTransactionCallback,
      String str) {
    return new ContextHubServiceTransaction(
        this.mNextAvailableId.getAndIncrement(),
        3,
        str) { // from class: com.android.server.location.contexthub.ContextHubTransactionManager.4
      @Override // com.android.server.location.contexthub.ContextHubServiceTransaction
      public int onTransact() {
        try {
          return ContextHubTransactionManager.this.mContextHubProxy.disableNanoapp(
              i, j, getTransactionId());
        } catch (RemoteException e) {
          Log.e(
              "ContextHubTransactionManager",
              "RemoteException while trying to disable nanoapp with ID 0x" + Long.toHexString(j),
              e);
          return 1;
        }
      }
  ...
  public ContextHubServiceTransaction createQueryTransaction(
      final int i,
      final IContextHubTransactionCallback iContextHubTransactionCallback,
      String str) {
    return new ContextHubServiceTransaction(
        this.mNextAvailableId.getAndIncrement(),
        4,
        str) { // from class: com.android.server.location.contexthub.ContextHubTransactionManager.5
      @Override // com.android.server.location.contexthub.ContextHubServiceTransaction
      public int onTransact() {
        try {
  ...
  public synchronized void onTransactionResponse(int i, boolean z) {
    ...
    if (contextHubServiceTransaction == null) {
      Log.w(
          "ContextHubTransactionManager",
          "Received unexpected transaction response (no transaction pending)");
      return;
    }
    if (contextHubServiceTransaction.getTransactionId() != i) {
      Log.w(
          ...
          "Received unexpected transaction response (expected ID = "
              + contextHubServiceTransaction.getTransactionId()
              + ", received ID = "
              + i
              + ")");
      return;
  ...
  public synchronized void onQueryResponse(List list) {
    ...
    if (contextHubServiceTransaction == null) {
      Log.w(
          "ContextHubTransactionManager",
          "Received unexpected query response (no transaction pending)");
      return;
    }
    if (contextHubServiceTransaction.getTransactionType() != 4) {
      Log.w(
          "ContextHubTransactionManager",
          "Received unexpected query response (expected " + contextHubServiceTransaction + ")");
      return;
    }
        ...
        Runnable runnable =
            new Runnable() { // from class:
              ...
              public final void run() {
                ContextHubTransactionManager.this.lambda$startNextTransaction$0(
        ...
        try {
          this.mTimeoutFuture =
              this.mTimeoutExecutor.schedule(
                  runnable, contextHubServiceTransaction.getTimeout(timeUnit), timeUnit);
        } catch (Exception e) {
  ...
  public /* synthetic */ void lambda$startNextTransaction$0(
      ContextHubServiceTransaction contextHubServiceTransaction) {
    synchronized (this) {
  ...
  public String toString() {
    ...
    for (i = 0; i < contextHubServiceTransactionArr.length; i++) {
      sb.append(
          i
              + ": "
              + contextHubServiceTransactionArr[i]
