  ...
  */
  ...
  public class ContextHubWrapperAidl extends IContextHubWrapper implements IBinder.DeathRecipient {
    ...
    public class ContextHubAidlCallback extends IContextHubCallback.Stub {
      ...
      public void handleNanoappInfo(NanoappInfo[] nanoappInfoArr) {
        final List createNanoAppStateList =
            ContextHubServiceUtil.createNanoAppStateList(nanoappInfoArr);
        ContextHubWrapperAidl.this.mHandler.post(
            new Runnable() { // from class:
              ...
              public final void run() {
                IContextHubWrapper.ContextHubWrapperAidl.ContextHubAidlCallback.this
                    .lambda$handleNanoappInfo$0(createNanoAppStateList);
              }
            });
      }
      ...
      public void handleContextHubMessage(
        ...
        ContextHubWrapperAidl.this.mHandler.post(
            new Runnable() { // from class:
              ...
              public final void run() {
                IContextHubWrapper.ContextHubWrapperAidl.ContextHubAidlCallback.this
                    .lambda$handleContextHubMessage$1(contextHubMessage, strArr);
              }
            });
      }

      /* JADX INFO: Access modifiers changed from: private */
      public /* synthetic */ void lambda$handleContextHubMessage$1(
          ContextHubMessage contextHubMessage, String[] strArr) {
        this.mCallback.handleNanoappMessage(
            (short) contextHubMessage.hostEndPoint,
            ContextHubServiceUtil.createNanoAppMessage(contextHubMessage),
            new ArrayList(Arrays.asList(contextHubMessage.permissions)),
      ...
      public void handleContextHubAsyncEvent(final int i) {
        ContextHubWrapperAidl.this.mHandler.post(
            new Runnable() { // from class:
              ...
              public final void run() {
                IContextHubWrapper.ContextHubWrapperAidl.ContextHubAidlCallback.this
                    .lambda$handleContextHubAsyncEvent$2(i);
              }
            });
      }
      ...
      public void handleTransactionResult(final int i, final boolean z) {
        ContextHubWrapperAidl.this.mHandler.post(
            new Runnable() { // from class:
                             // com.android.server.location.contexthub.IContextHubWrapper$ContextHubWrapperAidl$ContextHubAidlCallback$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
                IContextHubWrapper.ContextHubWrapperAidl.ContextHubAidlCallback.this
                    .lambda$handleTransactionResult$3(i, z);
              }
            });
      }
    ...
    public long[] getPreloadedNanoappIds(int i) {
      ...
      try {
        ...
        Log.e(
            "IContextHubWrapper",
            "Exception while getting preloaded nanoapp IDs: " + e.getMessage());
        return null;
      }
    }
    ...
    public void registerExistingCallback(int i) {
      ...
      ContextHubAidlCallback contextHubAidlCallback =
          (ContextHubAidlCallback) this.mAidlCallbackMap.get(Integer.valueOf(i));
      if (contextHubAidlCallback == null) {
        Log.e(
            "IContextHubWrapper",
            "Could not find existing callback to register for context hub ID = " + i);
        return;
      }
      try {
    ...
    public void registerCallback(int i, final ICallback iCallback) {
      ...
      this.mHandleServiceRestartCallback =
          new Runnable() { // from class:
                           // com.android.server.location.contexthub.IContextHubWrapper$ContextHubWrapperAidl$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public abstract class ContextHubWrapperHidl extends IContextHubWrapper {
    ...
    public class ContextHubWrapperHidlCallback extends IContexthubCallback.Stub {
      ...
      public void handleClientMsg_1_2(
          android.hardware.contexthub.V1_2.ContextHubMsg contextHubMsg, ArrayList arrayList) {
        ICallback iCallback = this.mCallback;
        ContextHubMsg contextHubMsg2 = contextHubMsg.msg_1_0;
        iCallback.handleNanoappMessage(
    ...
    public int sendMessageToContextHub(short s, int i, NanoAppMessage nanoAppMessage) {
      return ContextHubServiceUtil.toTransactionResult(
          this.mHub.sendMessageToHub(
              i, ContextHubServiceUtil.createHidlContextHubMessage(s, nanoAppMessage)));
    }

    @Override // com.android.server.location.contexthub.IContextHubWrapper
    public int loadNanoapp(int i, NanoAppBinary nanoAppBinary, int i2) {
      return ContextHubServiceUtil.toTransactionResult(
          this.mHub.loadNanoApp(
              i, ContextHubServiceUtil.createHidlNanoAppBinary(nanoAppBinary), i2));
    }
    ...
    public void registerCallback(int i, ICallback iCallback) {
      this.mHidlCallbackMap.put(
          Integer.valueOf(i), new ContextHubWrapperHidlCallback(i, iCallback));
      this.mHub.registerCallback(
          i,
          (android.hardware.contexthub.V1_0.IContexthubCallback)
              this.mHidlCallbackMap.get(Integer.valueOf(i)));
    }

    @Override // com.android.server.location.contexthub.IContextHubWrapper
    public void registerExistingCallback(int i) {
      ContextHubWrapperHidlCallback contextHubWrapperHidlCallback =
          (ContextHubWrapperHidlCallback) this.mHidlCallbackMap.get(Integer.valueOf(i));
      if (contextHubWrapperHidlCallback == null) {
        Log.e(
            "IContextHubWrapper",
            "Could not find existing callback for context hub with ID = " + i);
        return;
      }
  ...
  public class ContextHubWrapperV1_2 extends ContextHubWrapperHidl
    ...
    @Override // com.android.server.location.contexthub.IContextHubWrapper.ContextHubWrapperHidl,
              // com.android.server.location.contexthub.IContextHubWrapper
    public void registerCallback(int i, ICallback iCallback) {
      this.mHidlCallbackMap.put(
          Integer.valueOf(i),
          new ContextHubWrapperHidl.ContextHubWrapperHidlCallback(i, iCallback));
      this.mHub.registerCallback_1_2(
          i, (IContexthubCallback) this.mHidlCallbackMap.get(Integer.valueOf(i)));
    }
