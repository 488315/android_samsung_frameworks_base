...
public final class ContextHubShellCommand extends ShellCommand {
    ...
    public final int onCommand(String str) {
        this.mContext.enforceCallingOrSelfPermission(
                "android.permission.ACCESS_CONTEXT_HUB", "ContextHubShellCommand");
        if (!"deny".equals(str)) {
                    ...
                    public final void accept(Object obj) {
                        ...
                        if (contextHubClientBroker.mPackage.equals(str2)) {
                            contextHubClientBroker.updateNanoAppAuthState(
                                    j, Collections.emptyList(), false, true);
                        }
                    }
                });
        return 0;
    ...
    public final void onHelp() {
        ...
        outPrintWriter.println(
                "    Immediately transitions the package's authentication state to denied so");
