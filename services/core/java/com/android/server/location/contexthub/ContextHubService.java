...
public class ContextHubService extends IContextHubService.Stub {
  ...
  public class ContextHubServiceCallback implements IContextHubWrapper.ICallback {
    ...
    public void handleNanoappMessage(
        short s, NanoAppMessage nanoAppMessage, List list, List list2) {
      ContextHubService.this.handleClientMessageCallback(
          this.mContextHubId, s, nanoAppMessage, list, list2);
    }
  ...
  public final IContextHubClientCallback createDefaultClientCallback(final int i) {
    return new IContextHubClientCallback
        .Stub() { // from class: com.android.server.location.contexthub.ContextHubService.1
      public final void finishCallback() {
        try {
          ((IContextHubClient) ContextHubService.this.mDefaultClientMap.get(Integer.valueOf(i)))
              .callbackFinished();
        } catch (RemoteException e) {
          Log.e(
              "ContextHubService",
              "RemoteException while finishing callback for hub (ID = " + i + ")",
              e);
        }
      }

      public void onMessageFromNanoApp(NanoAppMessage nanoAppMessage) {
        ContextHubService.this.onMessageReceiptOldApi(
            nanoAppMessage.getMessageType(),
            i,
            ContextHubService.this.mNanoAppStateManager.getNanoAppHandle(
                i, nanoAppMessage.getNanoAppId()),
            nanoAppMessage.getMessageBody());
        finishCallback();
      }
  ...
  public final boolean initContextHubServiceState(long j) {
    ...
    ContextHubStatsLog.write(
        398, SystemClock.elapsedRealtimeNanos() - j, ((List) pair.first).size());
    this.mContextHubIdToInfoMap =
        Collections.unmodifiableMap(
            ContextHubServiceUtil.createContextHubInfoMap((List) pair.first));
    ...
    ContextHubClientManager contextHubClientManager =
        new ContextHubClientManager(this.mContext, this.mContextHubWrapper);
    this.mClientManager = contextHubClientManager;
    this.mTransactionManager =
        new ContextHubTransactionManager(
            this.mContextHubWrapper, contextHubClientManager, this.mNanoAppStateManager);
    this.mSensorPrivacyManagerInternal =
  ...
  public final void initDefaultClientMap() {
    ...
    for (Map.Entry entry : this.mContextHubIdToInfoMap.entrySet()) {
      ...
      this.mLastRestartTimestampMap.put(
          Integer.valueOf(intValue), new AtomicLong(SystemClock.elapsedRealtimeNanos()));
      try {
        this.mContextHubWrapper.registerCallback(intValue, new ContextHubServiceCallback(intValue));
      } catch (RemoteException e) {
        Log.e(
            "ContextHubService",
            "RemoteException while registering service callback for hub (ID = " + intValue + ")",
            e);
      }
      hashMap.put(
          Integer.valueOf(intValue),
          this.mClientManager.registerClient(
              contextHubInfo,
              createDefaultClientCallback(intValue),
              (String) null,
              this.mTransactionManager,
  ...
  public final void initExistingCallbacks() {
    ...
    while (it.hasNext()) {
      ...
      try {
        ...
        Log.e(
            "ContextHubService",
            "RemoteException while registering existing service callback for hub (ID = "
                + intValue
                + ")",
            e);
      }
  ...
  public final void initLocationSettingNotifications() {
    ...
    this.mContext
        ...
        .registerContentObserver(
            Settings.Secure.getUriFor("location_mode"),
            true,
            new ContentObserver(
                null) { // from class: com.android.server.location.contexthub.ContextHubService.2
  ...
  public final void initWifiSettingNotifications() {
    ...
    this.mContext
        .getContentResolver()
        .registerContentObserver(
            Settings.Global.getUriFor("wifi_scan_always_enabled"),
            true,
            new ContentObserver(
                null) { // from class: com.android.server.location.contexthub.ContextHubService.4
              @Override // android.database.ContentObserver
              public void onChange(boolean z) {
                ContextHubService.this.sendWifiSettingUpdate(false);
              }
  ...
  public final void initAirplaneModeSettingNotifications() {
    IContextHubWrapper iContextHubWrapper = this.mContextHubWrapper;
    if (iContextHubWrapper == null
        || !iContextHubWrapper.supportsAirplaneModeSettingNotifications()) {
      return;
    }
    ...
    this.mContext
        ...
        .registerContentObserver(
            ...
            true,
            new ContentObserver(
                null) { // from class: com.android.server.location.contexthub.ContextHubService.5
              @Override // android.database.ContentObserver
              public void onChange(boolean z) {
  ...
  public final void initMicrophoneSettingNotifications() {
    IContextHubWrapper iContextHubWrapper = this.mContextHubWrapper;
    if (iContextHubWrapper == null
        || !iContextHubWrapper.supportsMicrophoneSettingNotifications()) {
      return;
    }
    ...
    if (sensorPrivacyManagerInternal == null) {
      ...
      sensorPrivacyManagerInternal.addSensorPrivacyListenerForAllUsers(
          1,
          new SensorPrivacyManagerInternal
              .OnUserSensorPrivacyChangedListener() { // from class:
                                                      // com.android.server.location.contexthub.ContextHubService$$ExternalSyntheticLambda4
  ...
  public final void initBtSettingNotifications() {
    ...
    this.mContext
        .getContentResolver()
        .registerContentObserver(
            Settings.Global.getUriFor("ble_scan_always_enabled"),
            false,
            new ContentObserver(
                null) { // from class: com.android.server.location.contexthub.ContextHubService.7
              @Override // android.database.ContentObserver
              public void onChange(boolean z) {
                ContextHubService.this.sendBtSettingUpdate(false);
              }
  ...
  public void onShellCommand(
    ...
    new ContextHubShellCommand(this.mContext, this)
        .exec(
            this,
            fileDescriptor,
            fileDescriptor2,
  ...
  public int registerCallback(IContextHubCallback iContextHubCallback) {
    ...
    Log.d(
        "ContextHubService",
        "Added callback, total callbacks " + this.mCallbacksList.getRegisteredCallbackCount());
    return 0;
  }
  ...
  public final IContextHubTransactionCallback createLoadTransactionCallback(
      final int i, final NanoAppBinary nanoAppBinary) {
    return new IContextHubTransactionCallback
        .Stub() { // from class: com.android.server.location.contexthub.ContextHubService.8
  ...
  public final IContextHubTransactionCallback createUnloadTransactionCallback(final int i) {
    return new IContextHubTransactionCallback
        .Stub() { // from class: com.android.server.location.contexthub.ContextHubService.9
      public void onQueryResponse(int i2, List list) {}
  ...
  public final IContextHubTransactionCallback createQueryTransactionCallback(final int i) {
    return new IContextHubTransactionCallback
        .Stub() { // from class: com.android.server.location.contexthub.ContextHubService.10
      public void onTransactionComplete(int i2) {}
  ...
  public int loadNanoApp(int i, NanoApp nanoApp) {
    ...
    this.mTransactionManager.addTransaction(
        this.mTransactionManager.createLoadTransaction(
            i,
            nanoAppBinary,
            createLoadTransactionCallback(i, nanoAppBinary),
  ...
  public int unloadNanoApp(int i) {
    ...
    this.mTransactionManager.addTransaction(
        this.mTransactionManager.createUnloadTransaction(
            contexthubId,
            nanoAppInstanceInfo.getAppId(),
  ...
  public int[] findNanoAppOnHub(int i, final NanoAppFilter nanoAppFilter) {
    ...
    if (nanoAppFilter != null) {
      this.mNanoAppStateManager.foreachNanoAppInstanceInfo(
          new Consumer() { // from class:
                           // com.android.server.location.contexthub.ContextHubService$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ContextHubService.lambda$findNanoAppOnHub$1(
                  nanoAppFilter, arrayList, (NanoAppInstanceInfo) obj);
            }
          });
    }
  ...
  public static /* synthetic */ void lambda$findNanoAppOnHub$1(
      NanoAppFilter nanoAppFilter, ArrayList arrayList, NanoAppInstanceInfo nanoAppInstanceInfo) {
  ...
  public final boolean queryNanoAppsInternal(int i) {
    ...
    this.mTransactionManager.addTransaction(
        this.mTransactionManager.createQueryTransaction(
            i, createQueryTransactionCallback(i), getCallingPackageName()));
    return true;
  }
  ...
  public int sendMessage(int i, int i2, ContextHubMessage contextHubMessage) {
    ...
    if (i2 == -1) {
      if (contextHubMessage.getMsgType() == 5) {
        ...
        Log.e(
            "ContextHubService",
            "Invalid OS message params of type " + contextHubMessage.getMsgType());
        z = false;
      }
    } else {
      NanoAppInstanceInfo nanoAppInstanceInfo = getNanoAppInstanceInfo(i2);
      if (nanoAppInstanceInfo != null) {
        if (((IContextHubClient) this.mDefaultClientMap.get(Integer.valueOf(i)))
                .sendMessageToNanoApp(
                    NanoAppMessage.createMessageToNanoApp(
                        nanoAppInstanceInfo.getAppId(),
                        contextHubMessage.getMsgType(),
                        contextHubMessage.getData()))
            == 0) {
          z = true;
        }
      } else {
        Log.e(
            "ContextHubService",
            "Failed to send nanoapp message - nanoapp with handle " + i2 + " does not exist.");
      }
      z = false;
    }
    return z ? 0 : -1;
  ...
  public final void handleClientMessageCallback(
      int i, short s, NanoAppMessage nanoAppMessage, List list, List list2) {
  ...
  public final void handleLoadResponseOldApi(int i, int i2, NanoAppBinary nanoAppBinary) {
    ...
    bArr[0] = (byte) i2;
    ByteBuffer.wrap(bArr, 1, 4)
        .order(ByteOrder.nativeOrder())
        .putInt(this.mNanoAppStateManager.getNanoAppHandle(i, nanoAppBinary.getNanoAppId()));
  ...
  public final void handleHubEventCallback(int i, int i2) {
      ...
      ContextHubStatsLog.write(
          ...
          TimeUnit.NANOSECONDS.toMillis(
              elapsedRealtimeNanos
                  - ((AtomicLong) this.mLastRestartTimestampMap.get(Integer.valueOf(i)))
                      .getAndSet(elapsedRealtimeNanos)),
          i);
    ...
    Log.i(
        "ContextHubService", "Received unknown hub event (hub ID = " + i + ", type = " + i2 + ")");
  }
  ...
  public final void handleQueryAppsCallback(int i, List list) {
    if (this.mMetricQueryPendingContextHubIds.contains(Integer.valueOf(i))) {
      ...
      while (it.hasNext()) {
        ...
        ContextHubStatsLog.write(
            400, i, nanoAppState.getNanoAppId(), (int) nanoAppState.getNanoAppVersion());
      }
  ...
  public IContextHubClient createClient(
    ...
    if (isValidContextHubId(i)) {
      ...
      return this.mClientManager.registerClient(
          (ContextHubInfo) this.mContextHubIdToInfoMap.get(Integer.valueOf(i)),
  ...
  public IContextHubClient createPendingIntentClient(
      int i, PendingIntent pendingIntent, long j, String str) {
  ...
  public void loadNanoAppOnHub(
    ...
    if (checkHalProxyAndContextHubId(i, iContextHubTransactionCallback, 0)) {
      if (nanoAppBinary == null) {
        ...
        this.mTransactionManager.addTransaction(
            this.mTransactionManager.createLoadTransaction(
                i, nanoAppBinary, iContextHubTransactionCallback, getCallingPackageName()));
      }
    }
  }
  ...
  public void unloadNanoAppFromHub(
    ...
    if (checkHalProxyAndContextHubId(i, iContextHubTransactionCallback, 1)) {
      this.mTransactionManager.addTransaction(
          this.mTransactionManager.createUnloadTransaction(
              i, j, iContextHubTransactionCallback, getCallingPackageName()));
    }
  }
  ...
  public void enableNanoApp(
    ...
    if (checkHalProxyAndContextHubId(i, iContextHubTransactionCallback, 2)) {
      this.mTransactionManager.addTransaction(
          this.mTransactionManager.createEnableTransaction(
              i, j, iContextHubTransactionCallback, getCallingPackageName()));
    }
  }
  ...
  public void disableNanoApp(
    ...
    if (checkHalProxyAndContextHubId(i, iContextHubTransactionCallback, 3)) {
      this.mTransactionManager.addTransaction(
          this.mTransactionManager.createDisableTransaction(
              i, j, iContextHubTransactionCallback, getCallingPackageName()));
    }
  }
  ...
  public void queryNanoApps(int i, IContextHubTransactionCallback iContextHubTransactionCallback) {
    ...
    if (checkHalProxyAndContextHubId(i, iContextHubTransactionCallback, 4)) {
      this.mTransactionManager.addTransaction(
          this.mTransactionManager.createQueryTransaction(
              i, iContextHubTransactionCallback, getCallingPackageName()));
    }
  }
  ...
  public long[] getPreloadedNanoAppIds(ContextHubInfo contextHubInfo) {
    ...
    long[] preloadedNanoappIds =
        this.mContextHubWrapper.getPreloadedNanoappIds(contextHubInfo.getId());
  ...
  public void dump(FileDescriptor fileDescriptor, final PrintWriter printWriter, String[] strArr) {
    if (DumpUtils.checkDumpPermission(this.mContext, "ContextHubService", printWriter)) {
      ...
      printWriter.println(
          "Supported permissions: " + Arrays.toString(this.mSupportedContextHubPerms.toArray()));
      printWriter.println("");
      printWriter.println("=================== NANOAPPS ====================");
      this.mNanoAppStateManager.foreachNanoAppInstanceInfo(
          new Consumer() { // from class:
                           // com.android.server.location.contexthub.ContextHubService$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  public void denyClientAuthState(int i, final String str, final long j) {
    Log.i(
        "ContextHubService",
        "Denying " + str + " access to " + Long.toHexString(j) + " on context hub # " + i);
    this.mClientManager.forEachClientOfHub(
        i,
        new Consumer() { // from class:
                         // com.android.server.location.contexthub.ContextHubService$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public static /* synthetic */ void lambda$denyClientAuthState$2(
      String str, long j, ContextHubClientBroker contextHubClientBroker) {
  ...
  public final void dump(final ProtoOutputStream protoOutputStream) {
    this.mContextHubIdToInfoMap
        ...
        .forEach(
            new Consumer() { // from class:
                             // com.android.server.location.contexthub.ContextHubService$$ExternalSyntheticLambda5
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
  ...
  public static /* synthetic */ void lambda$dump$3(
      ProtoOutputStream protoOutputStream, ContextHubInfo contextHubInfo) {
  ...
  public final void dumpPreloadedNanoapps(PrintWriter printWriter) {
    ...
    while (it.hasNext()
        && (preloadedNanoappIds =
                this.mContextHubWrapper.getPreloadedNanoappIds(
    ...
    synchronized (this.mCallbacksList) {
      ...
      for (int i4 = 0; i4 < beginBroadcast; i4++) {
        ...
        try {
          ...
          Log.i(
              "ContextHubService",
              "Exception (" + e + ") calling remote callback (" + broadcastItem + ").");
        }
      }
  ...
  public final boolean checkHalProxyAndContextHubId(
      int i, IContextHubTransactionCallback iContextHubTransactionCallback, int i2) {
    if (this.mContextHubWrapper == null) {
      try {
    ...
    Log.e(
        "ContextHubService",
        "Cannot start "
            + ContextHubTransaction.typeToString(i2, false)
  ...
  public final void sendLocationSettingUpdate() {
    this.mContextHubWrapper.onLocationSettingChanged(
  ...
  public final void sendAirplaneModeSettingUpdate() {
    this.mContextHubWrapper.onAirplaneModeSettingChanged(
        Settings.Global.getInt(this.mContext.getContentResolver(), "airplane_mode_on", 0) == 1);
  }
  ...
  public final void sendMicrophoneDisableSettingUpdateForCurrentUser() {
    ...
    sendMicrophoneDisableSettingUpdate(
        sensorPrivacyManagerInternal == null
            ? false
            : sensorPrivacyManagerInternal.isSensorPrivacyEnabled(getCurrentUserId(), 1));
  }
    ...
    try {
      this.mDailyMetricTimer.schedule(
          new Runnable() { // from class:
                           // com.android.server.location.contexthub.ContextHubService$$ExternalSyntheticLambda3
