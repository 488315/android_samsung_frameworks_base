...
public class GeocoderProxy {
    ...
    this.mServiceWatcher =
        ServiceWatcher.create(
            ...
            CurrentUserServiceSupplier.createFromConfig(
                ...
                R.bool.config_dreamsActivatedOnSleepByDefault,
                R.string.display_manager_overlay_display_secure_suffix),
            (ServiceWatcher.ServiceListener) null,
            injector);
  }
  ...
  public GeocoderProxy(Context context, int i, int i2, Injector injector) {
    this.mServiceWatcher =
        ServiceWatcher.create(
            ...
            "GeocoderProxy",
            CurrentUserServiceSupplier.createFromConfig(
                context, "com.android.location.service.GeocodeProvider", i, i2),
            (ServiceWatcher.ServiceListener) null,
            injector);
  }
  ...
  public void getFromLocation(
      ...
      final double d2,
      final int i,
      final GeocoderParams geocoderParams,
      final IGeocodeListener iGeocodeListener) {
    this.mServiceWatcher.runOnBinder(
        new ServiceWatcher
            .BinderOperation() { // from class: com.android.server.location.GeocoderProxy.1
          ...
          public void run(IBinder iBinder) {
            IGeocodeProvider.Stub.asInterface(iBinder)
                .getFromLocation(d, d2, i, geocoderParams, iGeocodeListener);
          }
  ...
  public void getFromLocationName(
    ...
    this.mServiceWatcher.runOnBinder(
        new ServiceWatcher
            .BinderOperation() { // from class: com.android.server.location.GeocoderProxy.2
          @Override // com.android.server.servicewatcher.ServiceWatcher.BinderOperation
          public void run(IBinder iBinder) {
            IGeocodeProvider.Stub.asInterface(iBinder)
                .getFromLocationName(str, d, d2, d3, d4, i, geocoderParams, iGeocodeListener);
          }
