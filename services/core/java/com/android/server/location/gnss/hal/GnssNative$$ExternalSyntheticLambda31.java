...
public final /* synthetic */ class GnssNative$$ExternalSyntheticLambda31
    ...
    public /* synthetic */ GnssNative$$ExternalSyntheticLambda31(
    ...
    public final void runOrThrow() {
        switch (this.$r8$classId) {
            ...
            default:
                ((Executor) this.f$0)
                        .execute(
                                new GnssNative$$ExternalSyntheticLambda24(
                                        0,
                                        (GnssNative.PowerStatsCallback) this.f$1,
                                        (GnssPowerStats) this.f$2));
                break;
        }
    }
}
