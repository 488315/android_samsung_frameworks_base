...
public class GnssPositionMode {
  ...
  public boolean equals(Object obj) {
    ...
    return this.mMode == gnssPositionMode.mMode
        ...
        && this.mPreferredAccuracy == gnssPositionMode.mPreferredAccuracy
        && this.mPreferredTime == gnssPositionMode.mPreferredTime
        && this.mLowPowerMode == gnssPositionMode.mLowPowerMode
        && getClass() == gnssPositionMode.getClass();
  }
  ...
  public int hashCode() {
    return Arrays.hashCode(
        new Object[] {
          ...
          Integer.valueOf(this.mPreferredAccuracy),
          Integer.valueOf(this.mPreferredTime),
