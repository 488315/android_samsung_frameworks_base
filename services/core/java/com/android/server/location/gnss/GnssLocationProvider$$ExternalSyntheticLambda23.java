...
public final /* synthetic */ class GnssLocationProvider$$ExternalSyntheticLambda23
        implements LocationListener {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ GnssLocationProvider f$0;

    public /* synthetic */ GnssLocationProvider$$ExternalSyntheticLambda23(
        ...
        switch (i) {
            case 0:
                ...
                if (!location.isMock()) {
                    ...
                    if (!GnssVendorConfig.isIzatServiceEnabled()
                            && gnssLocationProvider.isEquipmentTestModeEnabled()) {
                        Log.w(
                                "GnssLocationProvider",
                                "skip injectBestLocation in Equipment Test Mode");
                        break;
                    } else {
            ...
            default:
                if (!location.isMock()) {
                    gnssLocationProvider.mGnssVendorConfig.getClass();
                    if (!GnssVendorConfig.isIzatServiceEnabled()
                            || !gnssLocationProvider.mNIHandler.getInEmergency()) {
                        if (!GnssVendorConfig.isIzatServiceEnabled()
                                && gnssLocationProvider.isEquipmentTestModeEnabled()) {
                            Log.w(
                                    "GnssLocationProvider",
                                    "skip injectLocation in Equipment Test Mode");
                            break;
                        } else {
                            gnssLocationProvider.changeNlpAccuracyInForce(location);
