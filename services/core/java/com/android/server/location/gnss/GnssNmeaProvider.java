...
public class GnssNmeaProvider extends GnssListenerMultiplexer
  ...
  public void onReportNmea(long j) {
    deliverToListeners(new C18121(j));
  }

  /* renamed from: com.android.server.location.gnss.GnssNmeaProvider$1 */
  public class C18121 implements Function {
    public String mNmea;
    public final /* synthetic */ long val$timestamp;

    public C18121(long j) {
      this.val$timestamp = j;
    }

    @Override // java.util.function.Function
    public ListenerExecutor.ListenerOperation apply(
        GnssListenerMultiplexer.GnssListenerRegistration gnssListenerRegistration) {
      if (!GnssNmeaProvider.this.mAppOpsHelper.noteOpNoThrow(
          1, gnssListenerRegistration.getIdentity())) {
        return null;
      }
      if (this.mNmea == null) {
        this.mNmea =
            new String(
                GnssNmeaProvider.this.mNmeaBuffer,
                0,
                GnssNmeaProvider.this.mGnssNative.readNmea(
                    GnssNmeaProvider.this.mNmeaBuffer, GnssNmeaProvider.this.mNmeaBuffer.length));
      }
      final long j = this.val$timestamp;
      return new ListenerExecutor
          .ListenerOperation() { // from class:
                                 // com.android.server.location.gnss.GnssNmeaProvider$1$$ExternalSyntheticLambda0
        public final void operate(Object obj) {
          GnssNmeaProvider.C18121.this.lambda$apply$0(j, (IGnssNmeaListener) obj);
        }
      };
    }
