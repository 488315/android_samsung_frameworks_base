...
public class GnssNative {
  ...
  public NavigationMessageCallbacks[] mNavigationMessageCallbacks =
  ...
  public interface BaseCallbacks {
    default void onCapabilitiesChanged(
        GnssCapabilities gnssCapabilities, GnssCapabilities gnssCapabilities2) {}
  ...
  public interface NotificationCallbacks {
    ...
    void onReportNfwNotification(
        String str, byte b, String str2, byte b2, String str3, byte b3, boolean z, boolean z2);

    void onReportNiNotification(
        int i, int i2, int i3, int i4, int i5, String str, String str2, int i6, int i7);
  }
  ...
  public static native boolean native_add_geofence(
  ...
  private static native void native_agps_set_ref_location_cellid(
      int i, int i2, int i3, int i4, int i5, int i6);

  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_agps_set_ref_location_cellid(
      int i, int i2, int i3, int i4, long j, int i5, int i6);

  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_agps_set_ref_location_cellid(
      int i, int i2, int i3, int i4, long j, int i5, int i6, int i7);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native float native_get_seh_gnss_hal_version();
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native boolean native_init_extension_location_off();
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_inject_best_location(
      int i,
      double d,
      double d2,
      double d3,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native boolean native_inject_civic_address(
      String str,
      String str2,
      String str3,
      String str4,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_inject_flp_location(
      int i,
      double d,
      double d2,
      double d3,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_inject_location(
      int i,
      double d,
      double d2,
      double d3,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_inject_lppe_com_ie_capability(
      int i,
      boolean z,
      boolean z2,
      boolean z3,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native boolean native_inject_measurement_corrections(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_inject_ubp_capability(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_inject_wlan_capability(
      int i, int i2, long j, int i3, int i4, int i5);

  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_inject_wlan_error(int i);

  /* JADX INFO: Access modifiers changed from: private */
  public static native void native_inject_wlan_scan_info(
      long[] jArr, int[] iArr, int[] iArr2, int i);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native boolean native_is_seh_gnss_aidl_hal();
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public static native boolean native_set_position_mode(
        ...
        Executors.newSingleThreadExecutor()
            .execute(
                new Runnable() { // from class:
                                 // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda30
  ...
  public static synchronized GnssNative create(
      Context context, Injector injector, GnssConfiguration gnssConfiguration) {
  ...
  public GnssNative(
      Context context, GnssHal gnssHal, Injector injector, GnssConfiguration gnssConfiguration) {
  ...
  public void addBaseCallbacks(BaseCallbacks baseCallbacks) {
    ...
    this.mBaseCallbacks =
        (BaseCallbacks[])
            ArrayUtils.appendElement(BaseCallbacks.class, this.mBaseCallbacks, baseCallbacks);
  }

  public void addStatusCallbacks(StatusCallbacks statusCallbacks) {
    Preconditions.checkState(!this.mRegistered);
    this.mStatusCallbacks =
        (StatusCallbacks[])
            ArrayUtils.appendElement(StatusCallbacks.class, this.mStatusCallbacks, statusCallbacks);
  }

  public void addSvStatusCallbacks(SvStatusCallbacks svStatusCallbacks) {
    Preconditions.checkState(!this.mRegistered);
    this.mSvStatusCallbacks =
        (SvStatusCallbacks[])
            ArrayUtils.appendElement(
                SvStatusCallbacks.class, this.mSvStatusCallbacks, svStatusCallbacks);
  }
  ...
  public void addNmeaCallbacks(NmeaCallbacks nmeaCallbacks) {
    ...
    this.mNmeaCallbacks =
        (NmeaCallbacks[])
            ArrayUtils.appendElement(NmeaCallbacks.class, this.mNmeaCallbacks, nmeaCallbacks);
  }

  public void addLocationCallbacks(LocationCallbacks locationCallbacks) {
    Preconditions.checkState(!this.mRegistered);
    this.mLocationCallbacks =
        (LocationCallbacks[])
            ArrayUtils.appendElement(
                LocationCallbacks.class, this.mLocationCallbacks, locationCallbacks);
  }

  public void addMeasurementCallbacks(MeasurementCallbacks measurementCallbacks) {
    Preconditions.checkState(!this.mRegistered);
    this.mMeasurementCallbacks =
        (MeasurementCallbacks[])
            ArrayUtils.appendElement(
                MeasurementCallbacks.class, this.mMeasurementCallbacks, measurementCallbacks);
  }

  public void addAntennaInfoCallbacks(AntennaInfoCallbacks antennaInfoCallbacks) {
    Preconditions.checkState(!this.mRegistered);
    this.mAntennaInfoCallbacks =
        (AntennaInfoCallbacks[])
            ArrayUtils.appendElement(
                AntennaInfoCallbacks.class, this.mAntennaInfoCallbacks, antennaInfoCallbacks);
  }

  public void addNavigationMessageCallbacks(NavigationMessageCallbacks navigationMessageCallbacks) {
    Preconditions.checkState(!this.mRegistered);
    this.mNavigationMessageCallbacks =
        (NavigationMessageCallbacks[])
            ArrayUtils.appendElement(
                NavigationMessageCallbacks.class,
                this.mNavigationMessageCallbacks,
                navigationMessageCallbacks);
  }
  ...
  public void injectBestLocation(Location location) {
    ...
    long time = location.getTime();
    int i2 = location.hasElapsedRealtimeUncertaintyNanos() ? 2 : 0;
    this.mGnssHal.injectBestLocation(
        i,
        latitude,
        longitude,
        altitude,
  ...
  public boolean injectMeasurementCorrections(
      GnssMeasurementCorrections gnssMeasurementCorrections) {
    Preconditions.checkState(this.mRegistered);
  ...
  public void setAgpsReferenceLocationCellId(
      int i, int i2, int i3, int i4, long j, int i5, int i6, int i7) {
    Preconditions.checkState(this.mRegistered);
  ...
  public void reportGnssServiceDied() {
    ...
    LocationServiceThread.getExecutor()
        .execute(
            new Runnable() { // from class:
                             // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda6
              @Override // java.lang.Runnable
              public final void run() {
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda1
  ...
  public void reportStatus(final int i) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda33
          public final void runOrThrow() {
  ...
  public void reportSvStatus(
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda25
          public final void runOrThrow() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$reportSvStatus$3(
      int i, int[] iArr, float[] fArr, float[] fArr2, float[] fArr3, float[] fArr4, float[] fArr5) {
  ...
  public void reportAGpsStatus(final int i, final int i2, final byte[] bArr) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda22
          public final void runOrThrow() {
  ...
  public void reportNmea(final long j) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda7
          public final void runOrThrow() {
  ...
  public void reportMeasurementData(final GnssMeasurementsEvent gnssMeasurementsEvent) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda35
          public final void runOrThrow() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$reportMeasurementData$7(
      final GnssMeasurementsEvent gnssMeasurementsEvent) {
    if (this.mItarSpeedLimitExceeded) {
      return;
    }
    for (final MeasurementCallbacks measurementCallbacks : this.mMeasurementCallbacks) {
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void reportAntennaInfo(final List list) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda13
          public final void runOrThrow() {
  ...
  public void reportNavigationMessage(final GnssNavigationMessage gnssNavigationMessage) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda3
          public final void runOrThrow() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$reportNavigationMessage$10(
      final GnssNavigationMessage gnssNavigationMessage) {
    if (this.mItarSpeedLimitExceeded) {
      return;
    }
    for (final NavigationMessageCallbacks navigationMessageCallbacks :
        this.mNavigationMessageCallbacks) {
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
              GnssNative.NavigationMessageCallbacks.this.onReportNavigationMessage(
  ...
  public void setSubHalMeasurementCorrectionsCapabilities(int i) {
    GnssCapabilities gnssCapabilities = this.mCapabilities;
    GnssCapabilities withSubHalMeasurementCorrectionsFlags =
        gnssCapabilities.withSubHalMeasurementCorrectionsFlags(i);
  ...
  public final void onCapabilitiesChanged(
      final GnssCapabilities gnssCapabilities, final GnssCapabilities gnssCapabilities2) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda18
          public final void runOrThrow() {
  ...
  public void reportLocationBatch(final Location[] locationArr) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda24
          public final void runOrThrow() {
  ...
  public void psdsDownloadRequest(final int i) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda34
          public final void runOrThrow() {
  ...
  public void reportGeofenceTransition(
      final int i, final Location location, final int i2, final long j) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda0
          public final void runOrThrow() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$reportGeofenceTransition$14(
      int i, Location location, int i2, long j) {
  ...
  public void reportGeofenceStatus(final int i, final Location location) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda19
          public final void runOrThrow() {
  ...
  public void reportGeofenceAddStatus(final int i, final int i2) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda14
          public final void runOrThrow() {
  ...
  public void reportGeofenceRemoveStatus(final int i, final int i2) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda15
          public final void runOrThrow() {
  ...
  public void reportGeofencePauseStatus(final int i, final int i2) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda16
          public final void runOrThrow() {
  ...
  public void reportGeofenceResumeStatus(final int i, final int i2) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda5
          public final void runOrThrow() {
  ...
  public void reportNiNotification(
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda36
          public final void runOrThrow() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$reportNiNotification$20(
      int i, int i2, int i3, int i4, int i5, String str, String str2, int i6, int i7) {
  ...
  public void requestSetID(final int i) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda11
          public final void runOrThrow() {
  ...
  public void requestLocation(final boolean z, final boolean z2) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda28
          public final void runOrThrow() {
  ...
  public void requestUtcTime() {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda4
          public final void runOrThrow() {
  ...
  public void requestRefLocation() {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda12
          public final void runOrThrow() {
  ...
  public void requestRefLocationSec() {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda10
          public final void runOrThrow() {
  ...
  public void reportNfwNotification(
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda9
          public final void runOrThrow() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$reportNfwNotification$26(
      String str, byte b, String str2, byte b2, String str3, byte b3, boolean z, boolean z2) {
  ...
  public boolean isInEmergencySession() {
                ...
                Binder.withCleanCallingIdentity(
                    new FunctionalUtils
                        .ThrowingSupplier() { // from class:
                                              // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda20
                      public final Object getOrThrow() {
                        Boolean lambda$isInEmergencySession$27;
                        lambda$isInEmergencySession$27 =
                            GnssNative.this.lambda$isInEmergencySession$27();
    ...
    return ((Boolean)
            Binder.withCleanCallingIdentity(
                new FunctionalUtils
                    .ThrowingSupplier() { // from class:
                                          // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda21
                  public final Object getOrThrow() {
                    Boolean lambda$isInEmergencySession$28;
                    lambda$isInEmergencySession$28 =
                        GnssNative.this.lambda$isInEmergencySession$28();
  ...
  public /* synthetic */ Boolean lambda$isInEmergencySession$28() {
    return Boolean.valueOf(
        this.mEmergencyHelper.isInEmergency(
            TimeUnit.SECONDS.toMillis(this.mConfiguration.getEsExtensionSec())));
  }
  ...
  public void requestLppeCommonIesCapability() {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda29
          public final void runOrThrow() {
  ...
  public void requestFlpLocation(final int i) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda23
          public final void runOrThrow() {
  ...
  public void requestUbpCapability() {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda2
          public final void runOrThrow() {
  ...
  public void requestUbpInfo(final int i) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda32
          public final void runOrThrow() {
  ...
  public void requestWlanCapability() {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda26
          public final void runOrThrow() {
  ...
  public void requestWlanScanInfo(final int i) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda27
          public final void runOrThrow() {
  ...
  public void requestCivicAddress(final double d, final double d2, final double d3) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.location.gnss.hal.GnssNative$$ExternalSyntheticLambda31
          public final void runOrThrow() {
  ...
  public void injectLppeComIeCapability(
      int i,
      boolean z,
      boolean z2,
      boolean z3,
  ...
  public void injectCivicAddress(
      String str,
      String str2,
      String str3,
      String str4,
      ...
      String str13) {
    Preconditions.checkState(this.mRegistered);
    this.mGnssHal.injectCivicAddress(
  ...
  public class GnssHal {
    ...
    public void injectBestLocation(
        int i,
        double d,
        double d2,
        double d3,
    ...
    public boolean initLocationOff() {
      return GnssNative.native_init_extension_location_off();
    }
    ...
    public float getSehGnssHalVersion() {
      return GnssNative.native_get_seh_gnss_hal_version();
    }

    public boolean isSehGnssAidlHal() {
      return GnssNative.native_is_seh_gnss_aidl_hal();
    }
    ...
    public boolean injectCivicAddress(
        String str,
        String str2,
        String str3,
        String str4,
        ...
        String str12,
        String str13) {
      return GnssNative.native_inject_civic_address(
          str, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, str13);
    }
  }
}
