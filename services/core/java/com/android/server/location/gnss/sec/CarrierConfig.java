...
public class CarrierConfig {
  ...
  public boolean isKoreaLgu() {
    return "LGT".equals(this.mSalesCode)
        || "LUC".equals(this.mSalesCode)
        || "LUO".equals(this.mSalesCode);
  }
  ...
  public boolean isUSAMarket() {
    ...
    Log.d(
        "CarrierConfigForGnss",
        "isUSAMarket : code/country_Code/countryISO_Code = "
            + this.mSalesCode
            + "/"
            + str
            + "/"
  ...
  public boolean isUsaTmbServerCarrier() {
    ...
    return carrier == Carrier.USA_TMO
        || carrier == Carrier.USA_XAA
        || carrier == Carrier.USA_XAG
        || carrier == Carrier.USA_TFN
  ...
  public boolean isUsaCdmaMarket() {
    boolean z =
        "VZW".equals(this.mSalesCode)
            ...
            || "VMU".equals(this.mSalesCode)
            || "XAS".equals(this.mSalesCode)
            || "LRA".equals(this.mSalesCode)
            || "TFNVZW".equals(this.mSalesCode)
            || "ACG".equals(this.mSalesCode);
  ...
  public boolean isSupportSuplNiWithSettingOff() {
    ...
    return carrier == Carrier.KOR_SKT
        || carrier == Carrier.KOR_KTT
        || carrier == Carrier.KOR_LGT
        || carrier == Carrier.USA_ATT
        || carrier == Carrier.USA_TMO
        || carrier == Carrier.USA_XAU
        || carrier == Carrier.USA_XAR
        || carrier == Carrier.USA_XAG
        || carrier == Carrier.USA_XAA
        || carrier == Carrier.USA_AIO
        || carrier == Carrier.USA_TFA
        || carrier == Carrier.USA_TFC
        || carrier == Carrier.USA_TFO
        || carrier == Carrier.USA_TMK
        || carrier == Carrier.USA_DSH
        || carrier == Carrier.USA_DSA
        || carrier == Carrier.USA_SPR
        || carrier == Carrier.ARG_UFN
        || carrier == Carrier.MEX_IUS
        || carrier == Carrier.MEX_MNX
        || carrier == Carrier.MEX_UNE
        || carrier == Carrier.PER_PEO
        || carrier == Carrier.PER_PNT
        || carrier == Carrier.PER_PET
        || carrier == Carrier.JPN_RKT;
  }
  ...
  public boolean isCanadaMarket() {
    ...
    Log.d(
        "CarrierConfigForGnss",
        "isCaMarket : code/country_Code/countryISO_Code = "
            + this.mSalesCode
            + "/"
            + str
            + "/"
  ...
  public final boolean isAttConfigRequired(Carrier carrier) {
    return carrier == Carrier.USA_ATT
        || carrier == Carrier.USA_XAR
        || carrier == Carrier.USA_DSA
  ...
  public final boolean isSprConfigRequired(Carrier carrier) {
    return carrier == Carrier.USA_SPR
  ...
  public boolean isGoogleServerAgpsOnlyRequired() {
    Carrier carrier = getCarrier();
    return isAttConfigRequired(carrier)
        || isSprConfigRequired(carrier)
        || isVzwConfigRequired(carrier)
        || isUscConfigRequired(carrier)
        || isCanadaConfigRequired(carrier);
  }
