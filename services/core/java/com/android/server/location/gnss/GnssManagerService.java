...
public class GnssManagerService {
  ...
  public GnssManagerService(Context context, Injector injector, GnssNative gnssNative) {
    ...
    this.mGnssLocationProvider =
        new GnssLocationProviderSec(createAttributionContext, injector, gnssNative, gnssMetrics);
  ...
  public void enableSLocation() {
    ...
    if (gnssLocationProvider != null) {
      ...
      gnssLocationProvider.setSLocationSvCallback(
          new GnssLocationProvider
              .SvCallback() { // from class:
                              // com.android.server.location.gnss.GnssManagerService$$ExternalSyntheticLambda0
    ...
    if (gnssStatusProvider != null) {
      ...
      gnssStatusProvider.setSLocationStatusCallback(
          new GnssStatusProvider
              .StatusCallback() { // from class:
                                  // com.android.server.location.gnss.GnssManagerService$$ExternalSyntheticLambda1
  ...
  public void registerGnssStatusCallback(
    ...
    this.mGnssStatusProvider.addListener(
        CallerIdentity.fromBinder(this.mContext, str, str2, str3), iGnssStatusListener);
  }
  ...
  public void registerGnssNmeaCallback(
    ...
    this.mContext.enforceCallingOrSelfPermission("android.permission.ACCESS_FINE_LOCATION", null);
    this.mGnssNmeaProvider.addListener(
        CallerIdentity.fromBinder(this.mContext, str, str2, str3), iGnssNmeaListener);
  }
  ...
  public void addGnssMeasurementsListener(
    ...
    this.mGnssMeasurementsProvider.addListener(
        gnssMeasurementRequest,
        CallerIdentity.fromBinder(this.mContext, str, str2, str3),
  ...
  public void addGnssNavigationMessageListener(
      ...
      String str3) {
    this.mContext.enforceCallingOrSelfPermission("android.permission.ACCESS_FINE_LOCATION", null);
    this.mGnssNavigationMessageProvider.addListener(
        CallerIdentity.fromBinder(this.mContext, str, str2, str3), iGnssNavigationMessageListener);
  }
  ...
  public void addGnssAntennaInfoListener(
    ...
    this.mGnssAntennaInfoProvider.addListener(
        CallerIdentity.fromBinder(this.mContext, str, str2, str3), iGnssAntennaInfoListener);
  }
  ...
  public void dump(
    ...
    if (this.mGnssAntennaInfoProvider.isSupported()) {
      ...
      indentingPrintWriter.println(
          "Antenna Infos: " + this.mGnssAntennaInfoProvider.getAntennaInfos());
    ...
    if (powerStats != null) {
      ...
      indentingPrintWriter.increaseIndent();
      powerStats.dump(
          fileDescriptor, indentingPrintWriter, strArr, this.mGnssNative.getCapabilities());
      indentingPrintWriter.decreaseIndent();
    }
  }
  ...
  public class GnssCapabilitiesHalModule implements GnssNative.BaseCallbacks {
    ...
    public void onCapabilitiesChanged(
      ...
      try {
        GnssManagerService.this.mContext.sendBroadcastAsUser(
            new Intent("android.location.action.GNSS_CAPABILITIES_CHANGED")
                .putExtra("android.location.extra.GNSS_CAPABILITIES", gnssCapabilities2)
                .addFlags(1073741824)
                .addFlags(268435456),
            UserHandle.ALL);
      } finally {
  ...
  public class GnssGeofenceHalModule implements GnssNative.GeofenceCallbacks {
    ...
    public final synchronized GeofenceHardwareImpl getGeofenceHardware() {
      if (this.mGeofenceHardwareImpl == null) {
        this.mGeofenceHardwareImpl =
            GeofenceHardwareImpl.getInstance(GnssManagerService.this.mContext);
      }
      return this.mGeofenceHardwareImpl;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onReportGeofenceTransition$0(
        int i, Location location, int i2, long j) {
      getGeofenceHardware()
          .reportGeofenceTransition(
              i, location, i2, j, 0, FusedBatchOptions.SourceTechnologies.GNSS);
    }

    @Override // com.android.server.location.gnss.hal.GnssNative.GeofenceCallbacks
    public void onReportGeofenceTransition(
        final int i, final Location location, final int i2, final long j) {
      LocationServiceThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.location.gnss.GnssManagerService$GnssGeofenceHalModule$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                  GnssManagerService.GnssGeofenceHalModule.this.lambda$onReportGeofenceTransition$0(
                      i, location, i2, j);
                }
              });
    ...
    public void onReportGeofenceStatus(final int i, final Location location) {
      LocationServiceThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.location.gnss.GnssManagerService$GnssGeofenceHalModule$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                  GnssManagerService.GnssGeofenceHalModule.this.lambda$onReportGeofenceStatus$1(
                      i, location);
                }
              });
    }
    ...
    public /* synthetic */ void lambda$onReportGeofenceStatus$1(int i, Location location) {
      getGeofenceHardware()
          .reportGeofenceMonitorStatus(
              0, i == 2 ? 0 : 1, location, FusedBatchOptions.SourceTechnologies.GNSS);
    ...
    public void onReportGeofenceAddStatus(final int i, final int i2) {
      LocationServiceThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.location.gnss.GnssManagerService$GnssGeofenceHalModule$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                  GnssManagerService.GnssGeofenceHalModule.this.lambda$onReportGeofenceAddStatus$2(
                      i, i2);
                }
              });
    ...
    public void onReportGeofenceRemoveStatus(final int i, final int i2) {
      LocationServiceThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.location.gnss.GnssManagerService$GnssGeofenceHalModule$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                  GnssManagerService.GnssGeofenceHalModule.this
                      .lambda$onReportGeofenceRemoveStatus$3(i, i2);
                }
              });
    ...
    public void onReportGeofencePauseStatus(final int i, final int i2) {
      LocationServiceThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.location.gnss.GnssManagerService$GnssGeofenceHalModule$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                  GnssManagerService.GnssGeofenceHalModule.this
                      .lambda$onReportGeofencePauseStatus$4(i, i2);
                }
              });
    ...
    public void onReportGeofenceResumeStatus(final int i, final int i2) {
      LocationServiceThread.getHandler()
          .post(
              new Runnable() { // from class:
                               // com.android.server.location.gnss.GnssManagerService$GnssGeofenceHalModule$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                  GnssManagerService.GnssGeofenceHalModule.this
                      .lambda$onReportGeofenceResumeStatus$5(i, i2);
                }
              });
