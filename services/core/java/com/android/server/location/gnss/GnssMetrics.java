...
public class GnssMetrics {
  ...
  public String dumpGnssMetricsAsProtoString() {
    ...
    if (this.mLocationFailureStatistics.getCount() > 0) {
      ...
      gnssLog.percentageLocationFailure =
          (int) (this.mLocationFailureStatistics.getMean() * 100.0d);
    }
    if (this.mTimeToFirstFixSecStatistics.getCount() > 0) {
      ...
      gnssLog.standardDeviationTimeToFirstFixSecs =
          (int) this.mTimeToFirstFixSecStatistics.getStandardDeviation();
    }
    if (this.mPositionAccuracyMeterStatistics.getCount() > 0) {
      ...
      gnssLog.standardDeviationPositionAccuracyMeters =
          (int) this.mPositionAccuracyMeterStatistics.getStandardDeviation();
    }
    if (this.mTopFourAverageCn0Statistics.getCount() > 0) {
      ...
      gnssLog.standardDeviationTopFourAverageCn0DbHz =
          this.mTopFourAverageCn0Statistics.getStandardDeviation();
    }
    ...
    if (this.mTopFourAverageCn0StatisticsL5.getCount() > 0) {
      ...
      gnssLog.standardDeviationL5TopFourAverageCn0DbHz =
          this.mTopFourAverageCn0StatisticsL5.getStandardDeviation();
    }
    ...
    public int onPullAtom(int i, List list) {
      ...
      if (i == 10101) {
        ...
        if (otherModesEnergyMilliJoule.length < 10) {
          System.arraycopy(
              otherModesEnergyMilliJoule, 0, dArr, 0, otherModesEnergyMilliJoule.length);
        } else {
        ...
        list.add(
            FrameworkStatsLog.buildStatsEvent(
                ...
                (long) (powerStats.getTotalEnergyMilliJoule() * 1000.0d),
                (long) (powerStats.getSinglebandTrackingModeEnergyMilliJoule() * 1000.0d),
                (long) (powerStats.getMultibandTrackingModeEnergyMilliJoule() * 1000.0d),
                (long) (powerStats.getSinglebandAcquisitionModeEnergyMilliJoule() * 1000.0d),
                (long) (powerStats.getMultibandAcquisitionModeEnergyMilliJoule() * 1000.0d),
                (long) (dArr[0] * 1000.0d),
                (long) (dArr[1] * 1000.0d),
                (long) (dArr[2] * 1000.0d),
                (long) (dArr[3] * 1000.0d),
