...
public class GnssAntennaInfoProvider extends ListenerMultiplexer
  ...
  public class AntennaInfoListenerRegistration extends BinderListenerRegistration {
    ...
    public AntennaInfoListenerRegistration(
      ...
      super(
          callerIdentity.isMyProcess() ? FgThread.getExecutor() : ConcurrentUtils.DIRECT_EXECUTOR,
    ...
    public final void updateAntennaListener() {
      GnssAntennaInfoProvider.this.updateGnssDataListener(
          getBinder(),
          isActive(),
  ...
  public void addListener(
    ...
    try {
      putRegistration(
          ...
          new AntennaInfoListenerRegistration(callerIdentity, iGnssAntennaInfoListener));
    } finally {
    ...
    deliverToListeners(
        new ListenerExecutor
            .ListenerOperation() { // from class:
                                   // com.android.server.location.gnss.GnssAntennaInfoProvider$$ExternalSyntheticLambda0
  ...
  public void onRegistrationAdded(IBinder iBinder, ListenerRegistration listenerRegistration) {
    ...
    if (this.mNSLocationProviderHelper == null
        || !(listenerRegistration instanceof AntennaInfoListenerRegistration)) {
      return;
    }
    CallerIdentity identity =
        ((AntennaInfoListenerRegistration) listenerRegistration).getIdentity();
  ...
  public final void updateGnssDataListener(IBinder iBinder, boolean z, String str, int i, int i2) {
    ...
    nSLocationProviderHelper.updateGnssDataListener(
        iBinder, z, str, LocationConstants.LISTENER_TYPE.GNSS_ANTENNA_INFO, i, i2);
  }
}
