...
public class GnssNavigationMessageProvider extends GnssListenerMultiplexer
  ...
  public class GnssNavigationMessageListenerRegistration
      extends GnssListenerMultiplexer.GnssListenerRegistration {
    public GnssNavigationMessageListenerRegistration(
      ...
      executeOperation(
          new ListenerExecutor
              .ListenerOperation() { // from class:
                                     // com.android.server.location.gnss.GnssNavigationMessageProvider$GnssNavigationMessageListenerRegistration$$ExternalSyntheticLambda0
  ...
  public GnssListenerMultiplexer.GnssListenerRegistration createRegistration(
      ...
      CallerIdentity callerIdentity,
      IGnssNavigationMessageListener iGnssNavigationMessageListener) {
    return new GnssNavigationMessageListenerRegistration(
        callerIdentity, iGnssNavigationMessageListener);
  }
  ...
  public void onReportNavigationMessage(final GnssNavigationMessage gnssNavigationMessage) {
    deliverToListeners(
        new Function() { // from class:
                         // com.android.server.location.gnss.GnssNavigationMessageProvider$$ExternalSyntheticLambda0
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            ListenerExecutor.ListenerOperation lambda$onReportNavigationMessage$1;
            lambda$onReportNavigationMessage$1 =
                GnssNavigationMessageProvider.this.lambda$onReportNavigationMessage$1(
                    gnssNavigationMessage, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public /* synthetic */ ListenerExecutor.ListenerOperation lambda$onReportNavigationMessage$1(
    ...
    if (this.mAppOpsHelper.noteOpNoThrow(1, gnssListenerRegistration.getIdentity())) {
      return new ListenerExecutor
          .ListenerOperation() { // from class:
                                 // com.android.server.location.gnss.GnssNavigationMessageProvider$$ExternalSyntheticLambda1
        public final void operate(Object obj) {
          ((IGnssNavigationMessageListener) obj)
