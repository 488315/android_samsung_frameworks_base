...
class GnssNetworkConnectivityHandler {
  ...
  private native void native_update_network_state(
      boolean z, int i, boolean z2, boolean z3, String str, long j, short s);
  ...
  public class NetworkAttributes {
    ...
    public static boolean hasCapabilitiesChanged(
        NetworkCapabilities networkCapabilities, NetworkCapabilities networkCapabilities2) {
      return networkCapabilities == null
          || networkCapabilities2 == null
          || hasCapabilityChanged(networkCapabilities, networkCapabilities2, 18)
          || hasCapabilityChanged(networkCapabilities, networkCapabilities2, 11);
    }

    public static boolean hasCapabilityChanged(
        NetworkCapabilities networkCapabilities, NetworkCapabilities networkCapabilities2, int i) {
  ...
  public GnssNetworkConnectivityHandler(
      Context context,
    ...
    this.mOnSubscriptionsChangeListener =
        new SubscriptionManager.OnSubscriptionsChangedListener(
            handler
                .getLooper()) { // from class:
                                // com.android.server.location.gnss.GnssNetworkConnectivityHandler.1
          ...
          public void onSubscriptionsChanged() {
            ...
            SubscriptionManager subscriptionManager =
                (SubscriptionManager)
                    GnssNetworkConnectivityHandler.this.mContext.getSystemService(
            ...
            if (activeSubscriptionInfoList != null) {
              Log.d(
                  ...
                  "Active Sub List size: " + activeSubscriptionInfoList.size());
              for (SubscriptionInfo subscriptionInfo : activeSubscriptionInfoList) {
                hashSet.add(Integer.valueOf(subscriptionInfo.getSubscriptionId()));
                if (!GnssNetworkConnectivityHandler.this.mPhoneStateListeners.containsKey(
                  ...
                  Log.d(
                      "GnssNetworkConnectivityHandler",
                      "Listener sub" + subscriptionInfo.getSubscriptionId());
                  SubIdPhoneStateListener subIdPhoneStateListener =
                      GnssNetworkConnectivityHandler.this
                      .new SubIdPhoneStateListener(
                          Integer.valueOf(subscriptionInfo.getSubscriptionId()));
                  GnssNetworkConnectivityHandler.this.mPhoneStateListeners.put(
                      Integer.valueOf(subscriptionInfo.getSubscriptionId()),
                      subIdPhoneStateListener);
                  createForSubscriptionId.listen(
                      subIdPhoneStateListener, IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES);
                }
              }
            }
            Iterator it =
                GnssNetworkConnectivityHandler.this.mPhoneStateListeners.entrySet().iterator();
            while (it.hasNext()) {
              Map.Entry entry = (Map.Entry) it.next();
              if (!hashSet.contains(entry.getKey())) {
                TelephonyManager createForSubscriptionId2 =
                    telephonyManager.createForSubscriptionId(((Integer) entry.getKey()).intValue());
                if (createForSubscriptionId2 != null) {
                  Log.d(
                      "GnssNetworkConnectivityHandler",
                      "unregister listener sub " + entry.getKey());
                  createForSubscriptionId2.listen((PhoneStateListener) entry.getValue(), 0);
                  it.remove();
                } else {
                  Log.e(
                      "GnssNetworkConnectivityHandler",
                      "Telephony Manager for Sub " + entry.getKey() + " null");
                }
              }
            }
            if (hashSet.contains(
                Integer.valueOf(GnssNetworkConnectivityHandler.this.mActiveSubId))) {
              return;
            }
    ...
    this.mWakeLock =
        ((PowerManager) context.getSystemService("power"))
            .newWakeLock(1, "GnssNetworkConnectivityHandler");
  ...
  public final class SubIdPhoneStateListener extends PhoneStateListener {
    ...
    public void onPreciseCallStateChanged(PreciseCallState preciseCallState) {
      if (1 == preciseCallState.getForegroundCallState()
          || 3 == preciseCallState.getForegroundCallState()) {
        GnssNetworkConnectivityHandler.this.mActiveSubId = this.mSubId.intValue();
        Log.d(
            "GnssNetworkConnectivityHandler",
            "mActiveSubId: " + GnssNetworkConnectivityHandler.this.mActiveSubId);
      }
    }
  }
  ...
  public void registerNetworkCallbacks() {
    ...
    ConnectivityManager.NetworkCallback createNetworkConnectivityCallback =
        createNetworkConnectivityCallback();
  ...
  public void onReportAGpsStatus(final int i, int i2, final byte[] bArr) {
    Log.d(
        "GnssNetworkConnectivityHandler",
        "AGPS_DATA_CONNECTION: " + agpsDataConnStatusAsString(i2));
    if (i2 == 1) {
      runOnHandler(
    ...
    if (i2 == 2) {
      runOnHandler(
          new Runnable() { // from class:
                           // com.android.server.location.gnss.GnssNetworkConnectivityHandler$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public final ConnectivityManager.NetworkCallback createNetworkConnectivityCallback() {
    return new ConnectivityManager.NetworkCallback() { // from class:
      // com.android.server.location.gnss.GnssNetworkConnectivityHandler.2
      ...
      public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
        if (!NetworkAttributes.hasCapabilitiesChanged(
            (NetworkCapabilities) this.mAvailableNetworkCapabilities.get(network),
            networkCapabilities)) {
          if (GnssNetworkConnectivityHandler.VERBOSE) {
            Log.v(
                "GnssNetworkConnectivityHandler",
                "Relevant network capabilities unchanged. Capabilities: " + networkCapabilities);
          }
          if (GnssNetworkConnectivityHandler.this.mGnssVendorConfig.isLsiGnss()
              && this.isOnLostCallbackReceived) {
            GnssNetworkConnectivityHandler.this.handleUpdateNetworkState(
                network, true, networkCapabilities);
        ...
        Log.d(
            "GnssNetworkConnectivityHandler",
            "Network connected/capabilities updated. Available networks count: "
                + this.mAvailableNetworkCapabilities.size());
      ...
      public void onLost(Network network) {
        if (this.mAvailableNetworkCapabilities.remove(network) == null) {
          Log.w(
              "GnssNetworkConnectivityHandler",
              "Incorrectly received network callback onLost() before onCapabilitiesChanged() for"
                  + " network: "
                  + network);
          return;
        }
        ...
        Log.i(
            "GnssNetworkConnectivityHandler",
            "Network connection lost. Available networks count: "
                + this.mAvailableNetworkCapabilities.size());
  ...
  public final ConnectivityManager.NetworkCallback createSuplConnectivityCallback() {
    return new ConnectivityManager
        .NetworkCallback() { // from class:
                             // com.android.server.location.gnss.GnssNetworkConnectivityHandler.3
      @Override // android.net.ConnectivityManager.NetworkCallback
  ...
  public final ConnectivityManager.NetworkCallback createEmergencyConnectivityCallback() {
    return new ConnectivityManager
        .NetworkCallback() { // from class:
                             // com.android.server.location.gnss.GnssNetworkConnectivityHandler.4
      @Override // android.net.ConnectivityManager.NetworkCallback
  ...
  public final Runnable runEventAndReleaseWakeLock(final Runnable runnable) {
    return new Runnable() { // from class:
                            // com.android.server.location.gnss.GnssNetworkConnectivityHandler$$ExternalSyntheticLambda3
      @Override // java.lang.Runnable
      public final void run() {
  ...
  public final void handleUpdateNetworkState(
      Network network, boolean z, NetworkCapabilities networkCapabilities) {
    ...
    boolean z3 = z2;
    NetworkAttributes updateTrackedNetworksState =
        updateTrackedNetworksState(z, network, networkCapabilities);
    ...
    Log.i(
        ...
        String.format(
            ...
            Integer.valueOf(this.mAvailableNetworkAttributes.size())));
    ...
    if (native_is_agps_ril_supported()) {
      ...
      native_update_network_state(
          ...
          NetworkAttributes.getCapabilityFlags(networkCapabilities2));
    } else {
      Log.d(
          "GnssNetworkConnectivityHandler",
          "Skipped network state update because GPS HAL AGPS-RIL is not  supported");
    }
  ...
  public final NetworkAttributes updateTrackedNetworksState(
      boolean z, Network network, NetworkCapabilities networkCapabilities) {
    if (!z) {
      return (NetworkAttributes) this.mAvailableNetworkAttributes.remove(network);
    }
    NetworkAttributes networkAttributes =
        (NetworkAttributes) this.mAvailableNetworkAttributes.get(network);
  ...
  public final void handleSuplConnectionAvailable(Network network, LinkProperties linkProperties) {
    ...
    Log.d(
        ...
        String.format(
            ...
            agpsDataConnStateAsString(), network, networkInfo));
    if (this.mAGpsDataConnectionState == 1) {
      ...
      if (this.mGnssVendorConfig.isIzatServiceEnabled()
          && this.mCarrierConfig.isUsaTmbServerCarrier()) {
      ...
      Log.d(
          ...
          String.format(
              ...
              extraInfo, Integer.valueOf(linkIpType)));
  ...
  public final void lambda$onReportAGpsStatus$0(int i, byte[] bArr) {
    ...
    if (bArr != null) {
      if (VERBOSE) {
        Log.v(
            "GnssNetworkConnectivityHandler", "Received SUPL IP addr[]: " + Arrays.toString(bArr));
      }
      try {
        this.mAGpsDataConnectionIpAddr = InetAddress.getByAddress(bArr);
        Log.d(
            "GnssNetworkConnectivityHandler",
            "IP address converted to: " + this.mAGpsDataConnectionIpAddr);
    ...
    Log.d(
        ...
        String.format(
            ...
            agpsDataConnStateAsString(), agpsTypeAsString(i), this.mAGpsDataConnectionIpAddr));
    ...
    if (this.mNiHandler.getInEmergency() && this.mActiveSubId >= 0) {
      Log.d(
          "GnssNetworkConnectivityHandler",
          "Adding Network Specifier: " + Integer.toString(this.mActiveSubId));
      ...
      if (SubscriptionManager.isValidSubscriptionId(subIdForSuplNi)) {
        Log.d(
            "GnssNetworkConnectivityHandler",
            "setNetworkSpecifier after DSDS policy. Sim sub id : " + subIdForSuplNi);
        builder.setNetworkSpecifier(
            new TelephonyNetworkSpecifier.Builder().setSubscriptionId(subIdForSuplNi).build());
      }
    }
    NetworkRequest build = builder.build();
    ...
    ConnectivityManager.NetworkCallback createSuplConnectivityCallback =
        createSuplConnectivityCallback();
  ...
  public final void handleReleaseSuplConnection(int i) {
    Log.d(
        ...
        String.format(
            ...
            agpsDataConnStateAsString(), agpsDataConnStatusAsString(i)));
    this.mHandler.removeMessages(100);
    if (this.mAGpsDataConnectionState == 0) {
      return;
    }
  ...
  public final void setRouting() {
    if (!this.mConnMgr.requestRouteToHostAddress(3, this.mAGpsDataConnectionIpAddr)) {
      Log.e(
          "GnssNetworkConnectivityHandler",
          "Error requesting route to host: " + this.mAGpsDataConnectionIpAddr);
      return;
    }
    Log.d(
        "GnssNetworkConnectivityHandler",
        "Successfully requested route to host: " + this.mAGpsDataConnectionIpAddr);
  }
  ...
  public final int getLinkIpTypeSec(String str) {
    ...
    if (this.mNiHandler.getInEmergency()
        && (i = this.mActiveSubId) >= 0
        && (createForSubscriptionId = telephonyManager.createForSubscriptionId(i)) != null) {
      telephonyManager = createForSubscriptionId;
    }
    ServiceState serviceState = telephonyManager.getServiceState();
    String str2 =
        (serviceState == null || !serviceState.getDataRoamingFromRegistration())
            ? "protocol"
            : "roaming_protocol";
    if (telephonyManager.getNetworkType() == 0 && 3 == this.mAGpsType) {
      format =
          String.format("type like '%%emergency%%' and apn = '%s' and carrier_enabled = 1", str);
    } else {
    ...
    try {
      Cursor query =
          this.mContext
              .getContentResolver()
              .query(Telephony.Carriers.CONTENT_URI, new String[] {str2}, format, null, "name ASC");
      if (query != null) {
        try {
  ...
  public final int translateToApnIpTypeSec(String str, String str2) {
    ...
    Log.e(
        "GnssNetworkConnectivityHandler",
        String.format("Unknown IP Protocol: %s, for APN: %s", str, str2));
    return 3;
  }
}
