...
public abstract class GnssListenerMultiplexer extends ListenerMultiplexer {
  ...
  public final UserInfoHelper.UserListener mUserChangedListener =
      new UserInfoHelper
          .UserListener() { // from class:
                            // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda0
  ...
  public final LocationManagerInternal.ProviderEnabledListener mProviderEnabledChangedListener =
      new LocationManagerInternal
          .ProviderEnabledListener() { // from class:
                                       // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda1
      ...
      mBackgroundThrottlePackageWhitelistChangedListener =
          new SettingsHelper
              .GlobalSettingChangedListener() { // from class:
                                                // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda2
  ...
  public final SettingsHelper.UserSettingChangedListener mLocationPackageBlacklistChangedListener =
      new SettingsHelper
          .UserSettingChangedListener() { // from class:
                                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda3
  ...
  public final LocationPermissionsHelper.LocationPermissionsListener mLocationPermissionsListener =
      new LocationPermissionsHelper
          .LocationPermissionsListener() { // from class:
                                           // com.android.server.location.gnss.GnssListenerMultiplexer.1
  ...
  public final AppForegroundHelper.AppForegroundListener mAppForegroundChangedListener =
      new AppForegroundHelper
          .AppForegroundListener() { // from class:
                                     // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda4
  ...
  public final PackageResetHelper.Responder mPackageResetResponder =
      new PackageResetHelper
          .Responder() { // from class: com.android.server.location.gnss.GnssListenerMultiplexer.2
  ...
  public static /* synthetic */ boolean lambda$onBackgroundThrottlePackageWhitelistChanged$3(
      GnssListenerRegistration gnssListenerRegistration) {
    return true;
  }
  ...
  public class GnssListenerRegistration extends BinderListenerRegistration {
    ...
    public void onRegister() {
      super.onRegister();
      this.mPermitted =
          GnssListenerMultiplexer.this.mLocationPermissionsHelper.hasLocationPermissions(
              2, this.mIdentity);
      this.mForeground =
          GnssListenerMultiplexer.this.mAppForegroundHelper.isAppForeground(
    ...
    public final void updateGnssListener() {
      ...
      GnssListenerMultiplexer.this.updateGnssDataListener(
          getBinder(), isActive(), identity.getPackageName(), identity.getUid(), identity.getPid());
    }
  }
  ...
  public void addListener(
      final Object obj, final CallerIdentity callerIdentity, final IInterface iInterface) {
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      checkLimitAndPutRegistration(
          new Runnable() { // from class: com.android.server.location.gnss.GnssListenerMultiplexer.3
            @Override // java.lang.Runnable
            public void run() {
              GnssListenerMultiplexer.this.putRegistration(
                  iInterface.asBinder(),
                  GnssListenerMultiplexer.this.createRegistration(obj, callerIdentity, iInterface));
            }
          },
          callerIdentity);
    } finally {
  ...
  public static /* synthetic */ boolean lambda$getPredicate$0(
      CallerIdentity callerIdentity, GnssListenerRegistration gnssListenerRegistration) {
  ...
  public Predicate getPredicate(final CallerIdentity callerIdentity) {
    return new Predicate() { // from class:
                             // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda5
      @Override // java.util.function.Predicate
      public final boolean test(Object obj) {
        boolean lambda$getPredicate$0;
        lambda$getPredicate$0 =
            GnssListenerMultiplexer.lambda$getPredicate$0(
                callerIdentity, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
        return lambda$getPredicate$0;
      }
    };
  }

  public GnssListenerRegistration createRegistration(
      Object obj, CallerIdentity callerIdentity, IInterface iInterface) {
  ...
  public boolean isActive(GnssListenerRegistration gnssListenerRegistration) {
    ...
    if (gnssListenerRegistration.isPermitted()) {
      return (gnssListenerRegistration.isForeground() || isBackgroundRestrictionExempt(identity))
          && isActive(identity);
    }
    return false;
  }
  ...
  public final boolean isActive(CallerIdentity callerIdentity) {
    return callerIdentity.isSystemServer()
        ? this.mLocationManagerInternal.isProviderEnabledForUser(
            "gps", this.mUserInfoHelper.getCurrentUserId())
        : this.mLocationManagerInternal.isProviderEnabledForUser("gps", callerIdentity.getUserId())
            && this.mUserInfoHelper.isVisibleUserId(callerIdentity.getUserId())
  ...
  public final boolean isBackgroundRestrictionExempt(CallerIdentity callerIdentity) {
    if (callerIdentity.getUid() == 1000
        || this.mSettingsHelper
            ...
            .contains(callerIdentity.getPackageName())
        || this.mSettingsHelper.isBackgroundThrottlingAllowlistByNsflp(
  ...
  public void onRegister() {
    if (isSupported()) {
      ...
      this.mLocationManagerInternal.addProviderEnabledListener(
          "gps", this.mProviderEnabledChangedListener);
  ...
  public void onUnregister() {
    if (isSupported()) {
      ...
      this.mLocationManagerInternal.removeProviderEnabledListener(
          "gps", this.mProviderEnabledChangedListener);
  ...
  public static /* synthetic */ boolean lambda$onUserChanged$1(
      int i, GnssListenerRegistration gnssListenerRegistration) {
    ...
    if (i2 == 1 || i2 == 4) {
      updateRegistrations(
          new Predicate() { // from class:
                            // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda6
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$onUserChanged$1;
              lambda$onUserChanged$1 =
                  GnssListenerMultiplexer.lambda$onUserChanged$1(
                      i, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public final void onProviderEnabledChanged(String str, final int i, boolean z) {
    ...
    updateRegistrations(
        new Predicate() { // from class:
                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda7
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$onProviderEnabledChanged$2;
            lambda$onProviderEnabledChanged$2 =
                GnssListenerMultiplexer.lambda$onProviderEnabledChanged$2(
                    i, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public static /* synthetic */ boolean lambda$onProviderEnabledChanged$2(
      int i, GnssListenerRegistration gnssListenerRegistration) {
    return gnssListenerRegistration.getIdentity().getUserId() == i;
  }
  ...
  public final void onBackgroundThrottlePackageWhitelistChanged() {
    updateRegistrations(
        new Predicate() { // from class:
                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda8
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$onBackgroundThrottlePackageWhitelistChanged$3;
            lambda$onBackgroundThrottlePackageWhitelistChanged$3 =
                GnssListenerMultiplexer.lambda$onBackgroundThrottlePackageWhitelistChanged$3(
                    (GnssListenerMultiplexer.GnssListenerRegistration) obj);
            return lambda$onBackgroundThrottlePackageWhitelistChanged$3;
          }
        });
  }

  public static /* synthetic */ boolean lambda$onLocationPackageBlacklistChanged$4(
      int i, GnssListenerRegistration gnssListenerRegistration) {
    return gnssListenerRegistration.getIdentity().getUserId() == i;
  }
  ...
  public final void onLocationPackageBlacklistChanged(final int i) {
    updateRegistrations(
        new Predicate() { // from class:
                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda9
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$onLocationPackageBlacklistChanged$4;
            lambda$onLocationPackageBlacklistChanged$4 =
                GnssListenerMultiplexer.lambda$onLocationPackageBlacklistChanged$4(
                    i, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public static /* synthetic */ boolean lambda$onLocationPermissionsChanged$5(
      String str, GnssListenerRegistration gnssListenerRegistration) {
  ...
  public final void onLocationPermissionsChanged(final String str) {
    updateRegistrations(
        new Predicate() { // from class:
                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda14
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$onLocationPermissionsChanged$5;
            lambda$onLocationPermissionsChanged$5 =
                GnssListenerMultiplexer.lambda$onLocationPermissionsChanged$5(
                    str, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
            return lambda$onLocationPermissionsChanged$5;
          }
        });
  }

  public static /* synthetic */ boolean lambda$onLocationPermissionsChanged$6(
      int i, GnssListenerRegistration gnssListenerRegistration) {
  ...
  public final void onLocationPermissionsChanged(final int i) {
    updateRegistrations(
        new Predicate() { // from class:
                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda10
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$onLocationPermissionsChanged$6;
            lambda$onLocationPermissionsChanged$6 =
                GnssListenerMultiplexer.lambda$onLocationPermissionsChanged$6(
                    i, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public static /* synthetic */ boolean lambda$onAppForegroundChanged$7(
      int i, boolean z, GnssListenerRegistration gnssListenerRegistration) {
  ...
  public final void onAppForegroundChanged(final int i, final boolean z) {
    updateRegistrations(
        new Predicate() { // from class:
                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda11
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$onAppForegroundChanged$7;
            lambda$onAppForegroundChanged$7 =
                GnssListenerMultiplexer.lambda$onAppForegroundChanged$7(
                    i, z, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public final void onPackageReset(final String str) {
    updateRegistrations(
        new Predicate() { // from class:
                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda12
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$onPackageReset$8;
            lambda$onPackageReset$8 =
                GnssListenerMultiplexer.lambda$onPackageReset$8(
                    str, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public static /* synthetic */ boolean lambda$onPackageReset$8(
      String str, GnssListenerRegistration gnssListenerRegistration) {
  ...
  public final boolean isResetableForPackage(final String str) {
    return findRegistration(
        new Predicate() { // from class:
                          // com.android.server.location.gnss.GnssListenerMultiplexer$$ExternalSyntheticLambda13
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$isResetableForPackage$9;
            lambda$isResetableForPackage$9 =
                GnssListenerMultiplexer.lambda$isResetableForPackage$9(
                    str, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public static /* synthetic */ boolean lambda$isResetableForPackage$9(
      String str, GnssListenerRegistration gnssListenerRegistration) {
  ...
  public final void addGnssDataListener(
      IBinder iBinder, GnssListenerRegistration gnssListenerRegistration) {
    if (this.mNSLocationProviderHelper != null) {
      CallerIdentity identity = gnssListenerRegistration.getIdentity();
      this.mNSLocationProviderHelper.addGnssDataListener(
          iBinder,
          identity.getPackageName(),
          getListenerType(),
          identity.getUid(),
          identity.getPid(),
          gnssListenerRegistration.isPermitted(),
  ...
  public final void removeGnssDataListener(
    ...
    if (this.mNSLocationProviderHelper != null) {
      CallerIdentity identity = gnssListenerRegistration.getIdentity();
      this.mNSLocationProviderHelper.removeGnssDataListener(
          iBinder, getListenerType(), identity.getUid(), identity.getPid());
    }
  }
}
