...
public class SuplInitHandler {
  ...
  public SuplInitHandler(
      Context context, GnssLocationProviderSec gnssLocationProviderSec, GnssNative gnssNative) {
    ...
    this.mEmergencyNetworkConnectivityCallback = networkCallback;
    ...
    if (this.mGnssVendorConfig.isIzatServiceEnabled()
        || !this.mCarrierConfig.isEPDNListenRequired()) {
      return;
    }
    Log.d("SuplInitHandler", "register EmergencyNetworkConnectivityCallback");
    NetworkRequest.Builder builder = new NetworkRequest.Builder();
    builder.addCapability(10);
    this.mConnectivityManager.registerNetworkCallback(builder.build(), networkCallback);
  }
  ...
  public void handleDataSmsReceived(final Intent intent) {
    handleSuplInit(
        new Runnable() { // from class:
                         // com.android.server.location.gnss.sec.SuplInitHandler$$ExternalSyntheticLambda2
    ...
    for (SmsMessage smsMessage : messagesFromIntent) {
      if (smsMessage != null && smsMessage.mWrappedSmsMessage != null) {
        ...
        if (userData != null) {
          Log.d(
              "SuplInitHandler",
              "New NI received, Sim Sub id="
                  + mSubIdForSuplNi
                  + ", SimOperator="
                  + this.mTelephonyManager.getSimOperator(mSubIdForSuplNi));
          this.mCarrierConfig.setSimOperator(
              this.mTelephonyManager.getSimOperator(mSubIdForSuplNi));
  ...
  public void handleWapPushReceived(final Intent intent) {
    handleSuplInit(
        new Runnable() { // from class:
                         // com.android.server.location.gnss.sec.SuplInitHandler$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public boolean isSuplNiAvailable() {
    Log.d(
        "SuplInitHandler",
        "isSuplNiAvailable(), mGpsEnabled = " + this.mGnssProvider.isGpsEnabled());
  ...
  public final void checkAgpsSwitchMode() {
    ...
    if (i != 1) {
      if (i == 2) {
        Log.d(
            "SuplInitHandler", "checkWapSuplInit NI :: agps on for all network. launch NI session");
        return;
      }
    ...
    if (connectivityManager != null) {
      ...
      Log.d(
          "SuplInitHandler",
          "checkWapSuplInit NI : agps on only for home network info.isRoaming() == true ");
      return;
    }
  ...
  public final void setSuplConfiguration() {
    if (this.mCarrierConfig.isKoreaSktSim()) {
      this.mGnssNative.gnssConfigurationUpdateSec(
          convertHashMapToStringBuilder(this.mCarrierConfig.getConfigMap()).toString());
  ...
  public final void checkUDPSuplInit() {
    ...
    new Thread(
            new Runnable() { // from class:
                             // com.android.server.location.gnss.sec.SuplInitHandler$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public final DatagramPacket getDatagramPacket(DatagramSocket datagramSocket) {
    DatagramPacket datagramPacket =
        new DatagramPacket(new byte[NetworkConstants.ETHER_MTU], NetworkConstants.ETHER_MTU);
  ...
  public final void sendUdpSuplInitData(final DatagramPacket datagramPacket) {
    LocationServiceThread.getHandler()
        .post(
            new Runnable() { // from class:
                             // com.android.server.location.gnss.sec.SuplInitHandler$$ExternalSyntheticLambda3
              @Override // java.lang.Runnable
              public final void run() {
