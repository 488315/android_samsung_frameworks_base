...
public class GnssConfiguration {
  ...
  public boolean isLongTermPsdsServerConfigured() {
    return (this.mProperties.getProperty("LONGTERM_PSDS_SERVER_1") == null
            && this.mProperties.getProperty("LONGTERM_PSDS_SERVER_2") == null
            && this.mProperties.getProperty("LONGTERM_PSDS_SERVER_3") == null)
        ? false
        : true;
  }
  ...
  public void reloadGpsProperties(boolean z, int i) {
    if (DEBUG) {
      Log.d(
          "GnssConfiguration",
          "Reset GPS properties, previous size = "
  ...
  public void setEsExtensionSec() {
    ...
    if (native_get_gnss_configuration_version == null
        || !isConfigEsExtensionSecSupported(native_get_gnss_configuration_version)
