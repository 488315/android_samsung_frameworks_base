...
public final class GnssMeasurementsProvider extends GnssListenerMultiplexer
  ...
  public class GnssMeasurementListenerRegistration
    ...
    @Override // com.android.server.location.gnss.GnssListenerMultiplexer.GnssListenerRegistration,
              // com.android.server.location.listeners.BinderListenerRegistration,
      ...
      executeOperation(
          new ListenerExecutor
              .ListenerOperation() { // from class:
                                     // com.android.server.location.gnss.GnssMeasurementsProvider$GnssMeasurementListenerRegistration$$ExternalSyntheticLambda0
  ...
  public void addListener(
      ...
      IGnssMeasurementsListener iGnssMeasurementsListener) {
    super.addListener(
        (Object) gnssMeasurementRequest, callerIdentity, (IInterface) iGnssMeasurementsListener);
  }

  @Override // com.android.server.location.gnss.GnssListenerMultiplexer
  public GnssListenerMultiplexer.GnssListenerRegistration createRegistration(
      GnssMeasurementRequest gnssMeasurementRequest,
      CallerIdentity callerIdentity,
      IGnssMeasurementsListener iGnssMeasurementsListener) {
    return new GnssMeasurementListenerRegistration(
        gnssMeasurementRequest, callerIdentity, iGnssMeasurementsListener);
  }

  @Override // com.android.server.location.listeners.ListenerMultiplexer
  public boolean registerWithService(
      GnssMeasurementRequest gnssMeasurementRequest, Collection collection) {
  ...
  public boolean reregisterWithService(
      GnssMeasurementRequest gnssMeasurementRequest,
      GnssMeasurementRequest gnssMeasurementRequest2,
    ...
    GnssConfiguration.HalInterfaceVersion halInterfaceVersion =
        this.mGnssNative.getConfiguration().getHalInterfaceVersion();
  ...
  public GnssMeasurementRequest mergeRegistrations(Collection collection) {
    boolean isGnssMeasurementsFullTrackingEnabled =
        this.mSettingsHelper.isGnssMeasurementsFullTrackingEnabled();
    ...
    while (it.hasNext()) {
      GnssMeasurementRequest gnssMeasurementRequest =
          (GnssMeasurementRequest)
              ((GnssListenerMultiplexer.GnssListenerRegistration) it.next()).getRequest();
      if (gnssMeasurementRequest.getIntervalMillis() != Integer.MAX_VALUE) {
    ...
    return new GnssMeasurementRequest.Builder()
        .setFullTracking(isGnssMeasurementsFullTrackingEnabled)
  ...
  public void onReportMeasurements(final GnssMeasurementsEvent gnssMeasurementsEvent) {
    deliverToListeners(
        new Function() { // from class:
                         // com.android.server.location.gnss.GnssMeasurementsProvider$$ExternalSyntheticLambda0
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            ListenerExecutor.ListenerOperation lambda$onReportMeasurements$1;
            lambda$onReportMeasurements$1 =
                GnssMeasurementsProvider.this.lambda$onReportMeasurements$1(
                    gnssMeasurementsEvent, (GnssListenerMultiplexer.GnssListenerRegistration) obj);
  ...
  public /* synthetic */ ListenerExecutor.ListenerOperation lambda$onReportMeasurements$1(
    ...
    if (this.mAppOpsHelper.noteOpNoThrow(1, gnssListenerRegistration.getIdentity())) {
      return new ListenerExecutor
          .ListenerOperation() { // from class:
                                 // com.android.server.location.gnss.GnssMeasurementsProvider$$ExternalSyntheticLambda1
        public final void operate(Object obj) {
