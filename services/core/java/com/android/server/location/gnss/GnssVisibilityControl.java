...
class GnssVisibilityControl {
    ...
    public static Notification createEmergencyLocationUserNotification(Context context) {
        ...
        return new Notification.Builder(context, SystemNotificationChannels.NETWORK_STATUS).setSmallIcon(17304265).setWhen(0L).setOngoing(false).setAutoCancel(true).setColor(context.getColor(R.color.system_notification_accent_color)).setDefaults(0).setTicker(string + " (" + string2 + ")").setContentTitle(string).setContentText(string2).build();
    }
