...
public abstract class DelegateLocationProvider extends AbstractLocationProvider
  ...
  public static /* synthetic */ AbstractLocationProvider.State lambda$onStateChanged$1(
      AbstractLocationProvider.State state, AbstractLocationProvider.State state2) {
    return state;
  }

  public DelegateLocationProvider(
      Executor executor, AbstractLocationProvider abstractLocationProvider) {
    ...
    synchronized (this.mInitializationLock) {
      ...
      setState(
          new UnaryOperator() { // from class:
                                // com.android.server.location.provider.DelegateLocationProvider$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
              AbstractLocationProvider.State lambda$initializeDelegate$0;
              lambda$initializeDelegate$0 =
                  DelegateLocationProvider.this.lambda$initializeDelegate$0(
  ...
  public /* synthetic */ AbstractLocationProvider.State lambda$initializeDelegate$0(
  ...
  public void onStateChanged(
      AbstractLocationProvider.State state, final AbstractLocationProvider.State state2) {
    waitForInitialization();
    setState(
        new UnaryOperator() { // from class:
                              // com.android.server.location.provider.DelegateLocationProvider$$ExternalSyntheticLambda1
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            AbstractLocationProvider.State lambda$onStateChanged$1;
            lambda$onStateChanged$1 =
                DelegateLocationProvider.lambda$onStateChanged$1(
                    AbstractLocationProvider.State.this, (AbstractLocationProvider.State) obj);
