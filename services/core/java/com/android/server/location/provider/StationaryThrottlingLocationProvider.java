...
public final class StationaryThrottlingLocationProvider extends DelegateLocationProvider
  ...
  @Override // com.android.server.location.provider.DelegateLocationProvider,
            // com.android.server.location.provider.AbstractLocationProvider.Listener
  public /* bridge */ /* synthetic */ void onStateChanged(
  ...
  public StationaryThrottlingLocationProvider(
      String str, Injector injector, AbstractLocationProvider abstractLocationProvider) {
  ...
  public final void onThrottlingChangedLocked(boolean z) {
    ...
    long max =
        (!this.mDeviceStationary
                ...
                || location.getElapsedRealtimeAgeMillis(this.mDeviceStationaryRealtimeMs) > 30000)
            ? Long.MAX_VALUE
    ...
    if (max != Long.MAX_VALUE) {
      if (j == Long.MAX_VALUE) {
        ...
        LocationEventLog.EVENT_LOG.logProviderStationaryThrottled(
            this.mName, true, this.mOutgoingRequest);
      }
      if (this.mDeliverLastLocationCallback != null) {
        LocationServiceThread.getHandler().removeCallbacks(this.mDeliverLastLocationCallback);
      }
      ...
      if (z) {
        ...
        LocationServiceThread.getHandler()
            .postDelayed(
                ...
                this.mThrottlingIntervalMs - this.mLastLocation.getElapsedRealtimeAgeMillis());
        return;
      }
    }
    if (j != Long.MAX_VALUE) {
      LocationEventLog.EVENT_LOG.logProviderStationaryThrottled(
          this.mName, false, this.mOutgoingRequest);
  ...
  public class DeliverLastLocationRunnable implements Runnable {
    ...
    public void run() {
      synchronized (StationaryThrottlingLocationProvider.this.mLock) {
        ...
        LocationServiceThread.getHandler()
            .postDelayed(this, StationaryThrottlingLocationProvider.this.mThrottlingIntervalMs);
