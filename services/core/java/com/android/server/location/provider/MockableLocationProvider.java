...
public class MockableLocationProvider extends AbstractLocationProvider {
  ...
  public static /* synthetic */ AbstractLocationProvider.State lambda$setProviderLocked$0(
  ...
  public final void setProviderLocked(AbstractLocationProvider abstractLocationProvider) {
    ...
    if (abstractLocationProvider3 != null) {
      state =
          abstractLocationProvider3
              .getController()
              .setListener(new ListenerWrapper(this.mProvider));
      if (this.mStarted) {
    ...
    setState(
        new UnaryOperator() { // from class:
                              // com.android.server.location.provider.MockableLocationProvider$$ExternalSyntheticLambda0
          @Override // java.util.function.Function
          public final Object apply(Object obj) {
            AbstractLocationProvider.State lambda$setProviderLocked$0;
            lambda$setProviderLocked$0 =
                MockableLocationProvider.lambda$setProviderLocked$0(
  ...
  public class ListenerWrapper implements AbstractLocationProvider.Listener {
    ...
    public static /* synthetic */ AbstractLocationProvider.State lambda$onStateChanged$0(
        AbstractLocationProvider.State state, AbstractLocationProvider.State state2) {
      return state;
    }
    ...
    public final void onStateChanged(
      ...
      synchronized (MockableLocationProvider.this.mOwnerLock) {
        ...
        MockableLocationProvider.this.setState(
            new UnaryOperator() { // from class:
                                  // com.android.server.location.provider.MockableLocationProvider$ListenerWrapper$$ExternalSyntheticLambda0
              @Override // java.util.function.Function
              public final Object apply(Object obj) {
                AbstractLocationProvider.State lambda$onStateChanged$0;
                lambda$onStateChanged$0 =
                    MockableLocationProvider.ListenerWrapper.lambda$onStateChanged$0(
                        AbstractLocationProvider.State.this, (AbstractLocationProvider.State) obj);
