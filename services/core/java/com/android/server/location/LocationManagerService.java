...
public class LocationManagerService extends ILocationManager.Stub
  ...
  public class Lifecycle extends SystemService {
    ...
    public void onUserSwitching(
      ...
      this.mUserInfoHelper.onCurrentUserChanged(
  ...
  public LocationManagerService(Context context, Injector injector) {
        ...
        .registerLocationUserSettingsListener(
            new LocationSettings
              ...
              public final void onLocationUserSettingsChanged(
                ...
                LocationManagerService.this.onLocationUserSettingsChanged(
                    i2, locationUserSettings, locationUserSettings2);
              }
            });
    this.mInjector
        .getSettingsHelper()
        .addOnLocationEnabledChangedListener(
            new SettingsHelper
        ...
        .addAdasAllowlistChangedListener(
            new SettingsHelper
                .GlobalSettingChangedListener() { // from class:
                                                  // com.android.server.location.LocationManagerService$$ExternalSyntheticLambda2
    ...
    this.mInjector
        .getSettingsHelper()
        .addIgnoreSettingsAllowlistChangedListener(
            new SettingsHelper
                .GlobalSettingChangedListener() { // from class:
    ...
    PassiveLocationProviderManager passiveLocationProviderManager =
        new PassiveLocationProviderManager(this.mContext, injector);
    this.mPassiveManager = passiveLocationProviderManager;
    addLocationProviderManager(
        passiveLocationProviderManager, new PassiveLocationProvider(this.mContext));
    LegacyPermissionManagerInternal legacyPermissionManagerInternal =
    ...
    if (this.mCarrierConfig.isChinaCarrier()) {
      legacyPermissionManagerInternal.setLocationPackagesProvider(
          new LegacyPermissionManagerInternal
              .PackagesProvider() { // from class:
      ...
      legacyPermissionManagerInternal.setLocationPackagesProvider(
          new LegacyPermissionManagerInternal
              .PackagesProvider() { // from class:
                                    // com.android.server.location.LocationManagerService$$ExternalSyntheticLambda6
            @Override // com.android.server.pm.permission.LegacyPermissionManagerInternal.PackagesProvider
            public final String[] getPackages(int i2) {
              String[] lambda$new$4;
    ...
    legacyPermissionManagerInternal.setLocationExtraPackagesProvider(
        new LegacyPermissionManagerInternal
            .PackagesProvider() { // from class:
  ...
  public /* synthetic */ String[] lambda$new$3(int i) {
    return this.mContext
        .getResources()
        .getStringArray(R.array.vendor_disallowed_apps_managed_profile);
  }
  ...
  public /* synthetic */ String[] lambda$new$4(int i) {
    return this.mContext
        .getResources()
        .getStringArray(R.array.vendor_disallowed_apps_managed_device);
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ String[] lambda$new$5(int i) {
    return this.mContext.getResources().getStringArray(R.array.vendor_cross_profile_apps);
  }
  ...
  public final LocationProviderManager getOrAddLocationProviderManager(String str) {
    synchronized (this.mProviderManagers) {
      ...
      LocationProviderManager locationProviderManager2 =
          new LocationProviderManager(this.mContext, this.mInjector, str, this.mPassiveManager);
  ...
  public void addLocationProviderManager(
    ...
    synchronized (this.mProviderManagers) {
      Preconditions.checkState(
          getLocationProviderManager(locationProviderManager.getName()) == null);
      ...
      if (abstractLocationProvider != null) {
        if (locationProviderManager != this.mPassiveManager) {
          if (Settings.Global.getInt(
                  this.mContext.getContentResolver(), "location_enable_stationary_throttle", 1)
              != 0) {
            abstractLocationProvider =
                new StationaryThrottlingLocationProvider(
                    locationProviderManager.getName(), this.mInjector, abstractLocationProvider);
          }
        }
  ...
  public void onSystemReady() {
      ...
      appOpsManager.startWatchingNoted(
          ...
          new AppOpsManager
            ...
            public final void onOpNoted(
                String str, int i, String str2, String str3, int i2, int i3) {
    ...
    this.mInjector
        ...
        .addMockLocationListener(
            new AppOpsHelper
                .MockLocationAppOpListener() { // from class:
                                               // com.android.server.location.LocationManagerService$$ExternalSyntheticLambda10
          ...
          public void onReceive(Context context, Intent intent) {
            if ("com.samsung.android.location.mock.delete".equals(intent.getAction())) {
              synchronized (LocationManagerService.this.mLock) {
                ...
                if (stringExtra != null
                    && !LocationManagerService.this.mMockLocationRecord.isEmpty()) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onSystemReady$6(
      String str, int i, String str2, String str3, int i2, int i3) {
    ...
    Log.w(
        ...
        "location noteOp with location off - " + CallerIdentity.forTest(i, 0, str2, str3));
  }
  ...
  public void onSystemThirdPartyAppsCanStart() {
    ...
    if (this.mCarrierConfig.isChinaCarrier()) {
      ...
      ProxyLocationProvider create =
          ProxyLocationProvider.create(
              ...
              R.string.duration_years_shortest_future,
              this.mInjector);
      if (create != null) {
        addLocationProviderManager(
            new LocationProviderManager(
                this.mContext, this.mInjector, "network", this.mPassiveManager),
            create);
      } else {
      ...
      Preconditions.checkState(
          !this.mContext
              ...
              .queryIntentServicesAsUser(
                  new Intent("com.android.location.service.FusedLocationProvider"), 1572864, 0)
              .isEmpty(),
      ...
      ProxyLocationProvider create2 =
          ProxyLocationProvider.create(
              ...
              R.bool.config_dreamsActivatedOnDockByDefault,
              R.string.display_manager_overlay_display_name,
              this.mInjector);
      if (create2 != null) {
        addLocationProviderManager(
            new LocationProviderManager(
                this.mContext, this.mInjector, "fused", this.mPassiveManager),
            create2);
      } else {
        Log.wtf("LocationManagerService", "no fused location provider found");
      }
      GeocoderProxy createAndRegister =
          GeocoderProxy.createAndRegister(this.mContext, this.mInjector);
    ...
    boolean hasSystemFeature =
        this.mContext.getPackageManager().hasSystemFeature("android.hardware.location");
    ...
    if (hasSystemFeature && isSupported) {
      GnssNative create3 =
          GnssNative.create(this.mContext, this.mInjector, new GnssConfiguration(this.mContext));
      if (GnssVendorConfig.getInstance().isLsiGnss()) {
      ...
      AbstractLocationProvider create4 =
          this.mContext.getResources().getBoolean(R.bool.config_supportSpeakerNearUltrasound)
              ? null
              : ProxyLocationProvider.create(
                  this.mContext,
                  "gps",
                  "android.location.provider.action.GNSS_PROVIDER",
                  R.bool.config_supportSpeakerNearUltrasound,
      ...
      if (create4 == null) {
        ...
        addLocationProviderManager(
            new LocationProviderManager(
                ...
                this.mInjector,
                "gps_hardware",
                this.mPassiveManager,
                Collections.singletonList("android.permission.LOCATION_HARDWARE")),
            this.mGnssManagerService.getGnssLocationProvider());
      }
      addLocationProviderManager(
          new LocationProviderManager(this.mContext, this.mInjector, "gps", this.mPassiveManager),
          create4);
    }
    ...
    if (this.mGnssManagerService != null
        && GeofenceProxy.createAndBind(
                this.mContext, this.mGnssManagerService.getGnssGeofenceProxy(), this.mInjector)
            == null) {
          ...
          .setMockProvider(
              new MockLocationProvider(
                  new ProviderProperties.Builder()
                      .setHasNetworkRequirement(Boolean.parseBoolean(split[1]))
                      .setHasSatelliteRequirement(Boolean.parseBoolean(split[2]))
                      .setHasCellRequirement(Boolean.parseBoolean(split[3]))
                      .setHasMonetaryCost(Boolean.parseBoolean(split[4]))
                      .setHasAltitudeSupport(Boolean.parseBoolean(split[5]))
                      .setHasSpeedSupport(Boolean.parseBoolean(split[6]))
                      .setHasBearingSupport(Boolean.parseBoolean(split[7]))
  ...
  public final void initializeProviders_chn() {
    ...
    if (create2 != null) {
      addLocationProviderManager(
          new LocationProviderManager(this.mContext, this.mInjector, "fused", this.mPassiveManager),
          create2);
    } else {
      Log.wtf("LocationManagerService", "no fused location provider found");
    }
    GeocoderProxy createAndRegister =
        GeocoderProxy.createAndRegister(
            this.mContext,
            R.bool.config_earcFeatureEnabled_default,
            R.string.display_manager_overlay_display_title,
            this.mInjector);
    this.mGeocodeProvider = createAndRegister;
    if (createAndRegister == null) {
      Log.e("LocationManagerService", "no geocoder provider found");
    ...
    String string =
        this.mContext.getResources().getString(R.string.dynamic_mode_notification_channel_name);
    try {
      this.mInjector
          .getAppOpsHelper()
          .setSystemAlertWindowOpIfNeed(string, this.mPackageManager.getPackageUid(string, 0));
  ...
  public final void setSLocation() {
    ISLocationManager asInterface =
        ISLocationManager.Stub.asInterface(ServiceManager.getService("sec_location"));
    if (asInterface == null) {
    ...
    try {
      asInterface.setSLocationLMSHook(
          new ISLocationLMSHook
              .Stub() { // from class: com.android.server.location.LocationManagerService.3
            ...
            public IGpsGeofenceHardware getHWGeofence() {
              ...
              IGpsGeofenceHardware gnssGeofenceProxy =
                  LocationManagerService.this.mGnssManagerService.getGnssGeofenceProxy();
              LocationManagerService.this.mGnssManagerService.enableSLocation();
              return gnssGeofenceProxy;
            }

            public void updateRequestInfo(
                boolean z, int i, int i2, String str, String str2, boolean z2, int i3) {
              LocationManagerService.this
                  .mInjector
                  .getNSLocationProviderHelper()
                  .updateSLocationRequestInfo(z, i, i2, str, str2, z2, i3);
            }
  ...
  public final void onLocationUserSettingsChanged(
    ...
    if (locationUserSettings.isAdasGnssLocationEnabled()
      ...
      Log.d(
          "LocationManagerService",
          "[u" + i + "] adas gnss location enabled = " + isAdasGnssLocationEnabled);
      LocationEventLog.EVENT_LOG.logAdasLocationEnabled(i, isAdasGnssLocationEnabled);
      this.mContext.sendBroadcastAsUser(
          new Intent("android.location.action.ADAS_GNSS_ENABLED_CHANGED")
              .putExtra("android.location.extra.ADAS_GNSS_ENABLED", isAdasGnssLocationEnabled)
              .addFlags(1073741824)
              .addFlags(268435456),
          UserHandle.of(i));
    }
  ...
  public final void onLocationModeChanged(int i) {
    ...
    this.mContext.sendBroadcastAsUser(
        new Intent("android.location.MODE_CHANGED")
            .putExtra("android.location.extra.LOCATION_ENABLED", isLocationEnabled)
            .addFlags(1073741824)
            .addFlags(268435456),
        UserHandle.of(i));
    refreshAppOpsRestrictions(i);
  ...
  public String getGnssHardwareModelName() {
    return this.mGnssManagerService == null
        ? ""
        : this.mGnssManagerService.getGnssHardwareModelName();
  }
    ...
    synchronized (this.mDeprecatedGnssBatchingLock) {
      ...
      registerLocationListener(
          ...
          new LocationRequest.Builder(millis)
              .setMaxUpdateDelayMillis(millis * this.mGnssManagerService.getGnssBatchSize())
          ...
          if (!z || locationProviderManager.isEnabled(UserHandle.getCallingUserId())) {
            if (criteria == null
                || LocationProvider.propertiesMeetCriteria(
                    name, locationProviderManager.getProperties(), criteria)) {
              arrayList.add(name);
            }
          }
        }
  ...
  public ICancellationSignal getCurrentLocation(
    ...
    LocationRequest validateLocationRequest =
        validateLocationRequest(str, locationRequest, fromBinder);
    ...
    return locationProviderManager.getCurrentLocation(
        validateLocationRequest, fromBinder, permissionLevel, iLocationCallback);
  }
  ...
  public void registerLocationListener(
    ...
    locationProviderManager.registerLocationRequest(
        validateLocationRequest, fromBinder, permissionLevel, iLocationListener);
  }

  public void registerLocationPendingIntent(
      String str,
      LocationRequest locationRequest,
    ...
    CallerIdentity fromBinder =
        CallerIdentity.fromBinder(
            this.mContext, str2, str3, AppOpsManager.toReceiverId(pendingIntent));
    int permissionLevel =
        LocationPermissions.getPermissionLevel(
            this.mContext, fromBinder.getUid(), fromBinder.getPid());
    LocationPermissions.enforceLocationPermission(fromBinder.getUid(), permissionLevel, 1);
    ...
    if (CompatChanges.isChangeEnabled(169887240L, fromBinder.getUid())) {
      if (locationRequest.isLowPower()
          || locationRequest.isHiddenFromAppOps()
          || locationRequest.isLocationSettingsIgnored()
          || !locationRequest.getWorkSource().isEmpty()) {
        throw new SecurityException(
            "PendingIntent location requests may not use system APIs: " + locationRequest);
      }
    }
    LocationRequest validateLocationRequest =
        validateLocationRequest(str, locationRequest, fromBinder);
    ...
    Preconditions.checkArgument(
        locationProviderManager != null, "provider \"" + str + "\" does not exist");
    locationProviderManager.registerLocationRequest(
        validateLocationRequest, fromBinder, permissionLevel, pendingIntent);
  }
  ...
  public final LocationRequest validateLocationRequest(
    ...
    if (!CompatChanges.isChangeEnabled(168936375L, Binder.getCallingUid())
        && this.mContext.checkCallingPermission("android.permission.LOCATION_HARDWARE") != 0) {
  ...
  public Location getLastLocation(
    ...
    LastLocationRequest validateLastLocationRequest =
        validateLastLocationRequest(str, lastLocationRequest, fromBinder);
    LocationProviderManager locationProviderManager = getLocationProviderManager(str);
    if (locationProviderManager == null) {
      return null;
    }
    return locationProviderManager.getLastLocation(
        validateLastLocationRequest, fromBinder, permissionLevel);
  }

  public final LastLocationRequest validateLastLocationRequest(
      String str, LastLocationRequest lastLocationRequest, CallerIdentity callerIdentity) {
  ...
  public void addGnssMeasurementsListener(
      ...
      String str3) {
    if (this.mGnssManagerService != null) {
      this.mGnssManagerService.addGnssMeasurementsListener(
          gnssMeasurementRequest, iGnssMeasurementsListener, str, str2, str3);
    }
  }
  ...
  public void addGnssAntennaInfoListener(
      IGnssAntennaInfoListener iGnssAntennaInfoListener, String str, String str2, String str3) {
    if (this.mGnssManagerService != null) {
      this.mGnssManagerService.addGnssAntennaInfoListener(
          iGnssAntennaInfoListener, str, str2, str3);
    }
  }
  ...
  public GnssCapabilities getGnssCapabilities() {
    return this.mGnssManagerService == null
        ...
        : this.mGnssManagerService.getGnssCapabilities();
  }
  ...
  public void addGnssNavigationMessageListener(
      IGnssNavigationMessageListener iGnssNavigationMessageListener,
      String str,
      String str2,
      String str3) {
    if (this.mGnssManagerService != null) {
      this.mGnssManagerService.addGnssNavigationMessageListener(
          iGnssNavigationMessageListener, str, str2, str3);
    }
  }

  public void removeGnssNavigationMessageListener(
      IGnssNavigationMessageListener iGnssNavigationMessageListener) {
    if (this.mGnssManagerService != null) {
    ...
    while (it.hasNext()) {
      ...
      if (str == null || str.equals(locationProviderManager.getName())) {
        ...
        if (providerIdentity != null
            && providerIdentity.getPackageName().equals(str2)
            && (str3 == null || Objects.equals(providerIdentity.getAttributionTag(), str3))) {
          return true;
        }
      }
    }
    ...
    this.mInjector
        ...
        .updateUserSettings(
            ...
            new Function() { // from class:
                             // com.android.server.location.LocationManagerService$$ExternalSyntheticLambda11
              @Override // java.util.function.Function
              public final Object apply(Object obj) {
                LocationUserSettings lambda$setAdasGnssLocationEnabledForUser$7;
                lambda$setAdasGnssLocationEnabledForUser$7 =
                    LocationManagerService.lambda$setAdasGnssLocationEnabledForUser$7(
                        z, (LocationUserSettings) obj);
                return lambda$setAdasGnssLocationEnabledForUser$7;
              }
            });
  }

  public static /* synthetic */ LocationUserSettings lambda$setAdasGnssLocationEnabledForUser$7(
      boolean z, LocationUserSettings locationUserSettings) {
  ...
  public void getFromLocation(
      ...
      IGeocodeListener iGeocodeListener) {
    Preconditions.checkArgument(
        CallerIdentity.fromBinder(
                    this.mContext,
                    geocoderParams.getClientPackage(),
                    geocoderParams.getClientAttributionTag())
                .getUid()
            == geocoderParams.getClientUid());
  ...
  public final void onMockLocationAppOpChanged() {
    synchronized (this.mLock) {
      if (!this.mMockLocationRecord.isEmpty()) {
        String str =
            (String) ((Map.Entry) this.mMockLocationRecord.entrySet().iterator().next()).getValue();
        try {
          if (!this.mInjector
              .getAppOpsHelper()
              .checkMockLocationAccess(str, this.mPackageManager.getPackageUid(str, 0))) {
            recoverRealProviderLocked(str);
          }
        } catch (PackageManager.NameNotFoundException unused) {
      ...
      try {
        ...
        notificationManager.createNotificationChannel(
            new NotificationChannel(
                ...
                resources.getString(R.string.permlab_startForegroundServicesFromBackground),
                4));
        ...
        applicationIcon.setBounds(
            0, 0, applicationIcon.getIntrinsicWidth(), applicationIcon.getIntrinsicHeight());
        applicationIcon.draw(canvas);
        String string = resources.getString(R.string.permlab_startForegroundServicesFromBackground);
        String string2 = resources.getString(R.string.permlab_setWallpaperHints, applicationLabel);
            ...
            new Notification.Builder(this.mContext, "Mock Location Reminder")
                ...
                .setActions(
                    new Notification.Action.Builder(
                            (Icon) null,
                            resources.getString(R.string.permlab_sim_communication),
                            PendingIntent.getBroadcast(this.mContext, 0, intent, 1275068416))
                        .build())
                .build());
  ...
  public void addTestProvider(
      String str, ProviderProperties providerProperties, List list, String str2, String str3) {
    ...
    if (this.mInjector.getAppOpsHelper().noteOp(58, fromBinderUnsafe)) {
      ...
      getOrAddLocationProviderManager(str)
          .setMockProvider(
              new MockLocationProvider(providerProperties, fromBinderUnsafe, new ArraySet(list)));
      synchronized (this.mLock) {
        if ("gps".equals(str)) {
  ...
  public void setTestProviderLocation(String str, Location location, String str2, String str3) {
    if (this.mInjector.getAppOpsHelper().noteOp(58, CallerIdentity.fromBinderUnsafe(str2, str3))) {
      Preconditions.checkArgument(
          location.isComplete(), "incomplete location object, missing timestamp or accuracy?");
      LocationProviderManager locationProviderManager = getLocationProviderManager(str);
      if (locationProviderManager == null) {
  ...
  public void onStateChanged(
    ...
    if (state.extraAttributionTags.equals(state2.extraAttributionTags)
        && Objects.equals(state.identity, state2.identity)) {
      return;
    }
    synchronized (this.mLock) {
      final LocationManagerInternal.LocationPackageTagsListener locationPackageTagsListener =
          this.mLocationTagsChangedListener;
      if (locationPackageTagsListener != null) {
        ...
        if (uid != -1) {
          final PackageTagsList calculateAppOpsLocationSourceTags =
              calculateAppOpsLocationSourceTags(uid);
          this.mHandler.post(
              new Runnable() { // from class:
                               // com.android.server.location.LocationManagerService$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                  locationPackageTagsListener.onLocationPackageTagsChanged(
                      uid, calculateAppOpsLocationSourceTags);
                }
              });
        }
        if (uid2 != -1 && uid2 != uid) {
          final PackageTagsList calculateAppOpsLocationSourceTags2 =
              calculateAppOpsLocationSourceTags(uid2);
          this.mHandler.post(
              new Runnable() { // from class:
                               // com.android.server.location.LocationManagerService$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
                  locationPackageTagsListener.onLocationPackageTagsChanged(
                      uid2, calculateAppOpsLocationSourceTags2);
                }
              });
        }
      }
    ...
    if (isLocationEnabled) {
      ...
      while (it.hasNext()) {
        CallerIdentity providerIdentity =
            ((LocationProviderManager) it.next()).getProviderIdentity();
        if (providerIdentity != null) {
      ...
      if (callerIdentity != null && callerIdentity.getUid() == i) {
        ...
        if (state.extraAttributionTags.isEmpty() || state.identity.getAttributionTag() != null) {
          ...
          Log.e(
              "LocationManagerService",
              locationProviderManager.getName()
                  + " provider has specified a null attribution tag and a non-empty set of extra"
                  + " attribution tags - dropping the null attribution tag");
        }
      }
    }
  ...
  public class LocalService extends LocationManagerInternal {
    ...
    public void addProviderEnabledListener(
        String str, LocationManagerInternal.ProviderEnabledListener providerEnabledListener) {
      LocationProviderManager locationProviderManager =
          LocationManagerService.this.getLocationProviderManager(str);
    ...
    public void removeProviderEnabledListener(
        String str, LocationManagerInternal.ProviderEnabledListener providerEnabledListener) {
      LocationProviderManager locationProviderManager =
          LocationManagerService.this.getLocationProviderManager(str);
      Objects.requireNonNull(locationProviderManager);
    ...
    public boolean isProvider(String str, CallerIdentity callerIdentity) {
      ...
      while (it.hasNext()) {
        LocationProviderManager locationProviderManager = (LocationProviderManager) it.next();
        if (str == null || str.equals(locationProviderManager.getName())) {
          if (callerIdentity.equals(locationProviderManager.getProviderIdentity())
    ...
    public LocationTime getGnssTimeMillis() {
      ...
      if (locationProviderManager == null
          || (lastLocationUnsafe =
                  locationProviderManager.getLastLocationUnsafe(-1, 2, false, Long.MAX_VALUE))
              == null) {
        return null;
      }
      ...
      synchronized (LocationManagerService.this.mLock) {
        ...
        if (locationPackageTagsListener != null) {
          ...
          while (it2.hasNext()) {
            ...
            final PackageTagsList calculateAppOpsLocationSourceTags =
                LocationManagerService.this.calculateAppOpsLocationSourceTags(intValue);
            if (!calculateAppOpsLocationSourceTags.isEmpty()) {
              LocationManagerService.this.mHandler.post(
                  new Runnable() { // from class:
                                   // com.android.server.location.LocationManagerService$LocalService$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                      locationPackageTagsListener.onLocationPackageTagsChanged(
                          intValue, calculateAppOpsLocationSourceTags);
                    }
                  });
            }
          }
  ...
  public final class SystemInjector implements Injector {
    ...
    public SystemInjector(Context context, SystemUserInfoHelper systemUserInfoHelper) {
      ...
      NSPermissionHelper nSPermissionHelper =
          new NSPermissionHelper(systemUserInfoHelper, nSConnectionHelper);
