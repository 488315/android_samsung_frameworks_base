...
public final class GeofenceProxy implements ServiceWatcher.ServiceListener {
  ...
  public static GeofenceProxy createAndBind(
      Context context, IGpsGeofenceHardware iGpsGeofenceHardware, Injector injector) {
    ...
    this.mServiceWatcher =
        ServiceWatcher.create(
            ...
            CurrentUserServiceSupplier.createFromConfig(
                ...
                R.bool.config_dreamsDisabledByAmbientModeSuppressionConfig,
