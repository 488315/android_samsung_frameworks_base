...
public class ComprehensiveCountryDetector extends CountryDetectorBase {
  ...
  public ComprehensiveCountryDetector(Context context) {
    ...
    this.mLocationBasedCountryDetectionListener =
        new CountryListener() { // from class:
                                // com.android.server.location.countrydetector.ComprehensiveCountryDetector.1
  ...
  public void runAfterDetectionAsync(
      final Country country, final Country country2, final boolean z, final boolean z2) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.location.countrydetector.ComprehensiveCountryDetector.2
  ...
  public void runAfterDetection(Country country, Country country2, boolean z, boolean z2) {
    ...
    if (z2
        && ((country2 == null || country2.getSource() > 1)
            && ((isAirplaneModeOff() || isWifiOn())
                && this.mListener != null
  ...
  public final synchronized void scheduleLocationRefresh() {
    ...
    timer.schedule(
        new TimerTask() { // from class:
                          // com.android.server.location.countrydetector.ComprehensiveCountryDetector.3
    ...
    if (this.mPhoneStateListener == null) {
      PhoneStateListener phoneStateListener =
          new PhoneStateListener() { // from class:
                                     // com.android.server.location.countrydetector.ComprehensiveCountryDetector.4
