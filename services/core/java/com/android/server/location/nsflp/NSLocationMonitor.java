...
public class NSLocationMonitor extends INSLocationCallback.Stub {
  ...
  public final DeviceIdleInternal.StationaryListener mStationaryListener =
  ...
  public final DeviceIdleHelper.DeviceIdleListener mDeviceIdleListener =
      new DeviceIdleHelper
          .DeviceIdleListener() { // from class:
  ...
  public ServiceConnection mMonitorServiceConnection =
      new ServiceConnection() { // from class: com.android.server.location.nsflp.NSLocationMonitor.1
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
          ...
          synchronized (NSLocationMonitor.MONITOR_SERVICE_LOCK) {
            ...
            NSLocationMonitor.this.mNSConnectionHelper.onServiceConnected(
            ...
            synchronized (NSLocationMonitor.this.mNotificationListener) {
              if (!NSLocationMonitor.this.mRegisteredNotificationListener) {
                try {
                  NSLocationMonitor.this.mNotificationListener.registerAsSystemService(
                      NSLocationMonitor.this.mContext,
                      new ComponentName(
                          NSLocationMonitor.this.mContext.getPackageName(),
                          NSLocationMonitor.this.mContext.getClass().getCanonicalName()),
                      ActivityManager.getCurrentUser());
                  NSLocationMonitor.this.mRegisteredNotificationListener = true;
                } catch (RemoteException e) {
                  Log.e(
                      "NSLocationMonitor",
                      "Failed to register notification listener, " + e.toString());
                }
              }
            }
        ...
        public void onServiceDisconnected(ComponentName componentName) {
          ...
          NSLocationMonitor.this.mDisconnectedHistory.add(
          ...
          synchronized (NSLocationMonitor.this.mNotificationListener) {
            if (NSLocationMonitor.this.mRegisteredNotificationListener) {
              try {
                ...
                Log.e(
                    "NSLocationMonitor",
                    "Failed to unregister notification listener, " + e.toString());
              }
            }
          }
            ...
            for (int i = 0; i < NSLocationMonitor.this.mSimCount; i++) {
              ...
              if (subId != null && subId.length != 0) {
                ...
                if (NSLocationMonitor.this.mSimSubId != null) {
                  if (NSLocationMonitor.this.mSimSubId.length == NSLocationMonitor.this.mSimCount
                      && i2 == NSLocationMonitor.this.mSimSubId[i]) {
                    Log.w(
                        "NSLocationMonitor",
                        "SubId[" + i2 + "] for sim[" + i + "] was not changed");
                  } else {
                ...
                TelephonyManager telephonyManager =
                    (TelephonyManager) NSLocationMonitor.this.mContext.getSystemService("phone");
                if (telephonyManager != null) {
                  if (NSLocationMonitor.this.mPhoneStateListener[i] != null) {
                    Log.i(
                        "NSLocationMonitor", "unregister previous PhoneStateListener SimSlot=" + i);
      ...
      new NotificationListenerService() { // from class:
        ...
        public void onNotificationPosted(StatusBarNotification statusBarNotification) {
          ...
          if (statusBarNotification == null
              || (notification = statusBarNotification.getNotification()) == null
              || !NSLocationMonitor.this.isForegroundService(notification)) {
            return;
          }
          String packageName = statusBarNotification.getPackageName();
          if (NSLocationMonitor.this.addForegroundNotification(
              packageName, statusBarNotification.getKey())) {
            Bundle bundle = new Bundle();
            bundle.putString("packageName", packageName);
            NSLocationMonitor.this.mNSConnectionHelper.onStateUpdated(
                LocationConstants.STATE_TYPE.NOTIFICATION_POSTED, bundle);
          }
        }
        ...
        public void onNotificationRemoved(StatusBarNotification statusBarNotification) {
          ...
          String packageName = statusBarNotification.getPackageName();
          if (NSLocationMonitor.this.removeForegroundNotification(
              packageName, statusBarNotification.getKey())) {
            Bundle bundle = new Bundle();
            bundle.putString("packageName", packageName);
            NSLocationMonitor.this.mNSConnectionHelper.onStateUpdated(
                LocationConstants.STATE_TYPE.NOTIFICATION_REMOVED, bundle);
          }
        }
  ...
  public final SemContextListener mSemContextListener =
      new SemContextListener() { // from class:
                                 // com.android.server.location.nsflp.NSLocationMonitor.4
  ...
  enum DEVICE_ACTIVITY_ERROR_CODE {
    SEVICE_DISCONNECT,
    NOT_SUPPORT,
    SENSOR_OUT
  }
  ...
  public void onSystemReady() {
    ...
    if (packageManager.hasSystemFeature("com.sec.feature.nsflp")) {
      int semGetSystemFeatureLevel =
          this.mPackageManager.semGetSystemFeatureLevel("com.sec.feature.nsflp");
      this.mNSConnectionHelper.setFeature(true);
      Log.i(
          "NSLocationMonitor",
          "NS-FLP Feature available, nsFlpFeatureLevel = " + semGetSystemFeatureLevel);
      ...
      this.mContext.bindService(
          ...
          this.mMonitorServiceConnection,
          67108865);
        ...
        if (phoneCount > 0) {
          ...
          for (int i2 = 0; i2 < this.mSimCount; i2++) {
            ...
            if (subId == null) {
              ...
              Log.v(
                  "NSLocationMonitor",
                  "registerPhoneStateListener SimSlot=" + i2 + ", subId=" + i3);
              z2 = true;
            }
          }
          z = z2;
  ...
  public final void deinitNetworkStateListener() {
    ...
    synchronized (this.mNetworkLock) {
      ...
      SubscriptionManager subscriptionManager =
          (SubscriptionManager) this.mContext.getSystemService("telephony_subscription_service");
      if (subscriptionManager != null
          && (onSubscriptionsChangedListener = this.mSubscriptionListener) != null) {
  ...
  public void sendLogToHqm(String str, String str2, String str3) {
    if (this.mSupportHqm == HQM_SUPPORT_STATE.UNKNOWN && this.mHqmManager == null) {
      ISemHqmManager asInterface =
          ISemHqmManager.Stub.asInterface(ServiceManager.getService("HqmManagerService"));
      this.mHqmManager = asInterface;
      this.mSupportHqm =
          asInterface != null ? HQM_SUPPORT_STATE.SUPPORT : HQM_SUPPORT_STATE.NOT_SUPPORT;
    }
  ...
  public final boolean addForegroundNotification(String str, String str2) {
    Set set =
        (Set)
            this.mForegroundNotificationList.computeIfAbsent(
                str,
                new Function() { // from class:
                                 // com.android.server.location.nsflp.NSLocationMonitor$$ExternalSyntheticLambda3
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
                    Set lambda$addForegroundNotification$0;
                    lambda$addForegroundNotification$0 =
                        NSLocationMonitor.lambda$addForegroundNotification$0((String) obj);
    ...
    try {
      if (this.mSemContextManager.registerListener(this.mSemContextListener, 54)) {
        ...
        this.mSemContextManager.changeParameters(
            this.mSemContextListener, 54, new SemContextDeviceActivityDetectorAttribute(i, i2, z));
  ...
  public void unregisterDeviceActivityDetector() {
    ...
    try {
      ...
      Log.e(
          "NSLocationMonitor",
          "Exception is occurred while unregisterDeviceActivityDetector, " + e.toString());
    }
  ...
  public boolean setFeatureDeviceActivity(boolean z) {
    if (z) {
      ...
      Log.i(
          "NSLocationMonitor",
          "setFeatureDeviceActivity, isAvailable, " + this.mEnableFeatureDeviceActivity);
  ...
  public void sendExtraCommandInfo(String str, String str2) {
    ...
    this.mNSConnectionHelper.onStateUpdated(
        LocationConstants.STATE_TYPE.SEND_EXTRA_COMMAND, bundle);
  }
