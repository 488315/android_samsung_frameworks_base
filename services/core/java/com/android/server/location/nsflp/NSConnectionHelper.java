...
public class NSConnectionHelper {
    ...
    if (this.mHasNsflpFeature && (handler = this.mHandler) != null) {
      handler.post(
          new Runnable() { // from class:
                           // com.android.server.location.nsflp.NSConnectionHelper$$ExternalSyntheticLambda0
  ...
  public /* synthetic */ void lambda$onStateUpdated$0(
      LocationConstants.STATE_TYPE state_type, Bundle bundle) {
    try {
  ...
  public void onPassiveLocationReported(final Location location) {
    ...
    handler.post(
        new Runnable() { // from class:
                         // com.android.server.location.nsflp.NSConnectionHelper$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void onGnssEngineStatusUpdated(final boolean z) {
    ...
    if (this.mHasNsflpFeature && (handler = this.mHandler) != null) {
      handler.post(
          new Runnable() { // from class:
                           // com.android.server.location.nsflp.NSConnectionHelper$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void onGnssEventUpdated(final String str) {
    if (this.mHasNsflpFeature) {
      ...
      if (handler != null) {
        handler.post(
            new Runnable() { // from class:
                             // com.android.server.location.nsflp.NSConnectionHelper$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public void onMessageUpdated(final Message message) {
    ...
    if (this.mHasNsflpFeature && (handler = this.mHandler) != null) {
      handler.post(
          new Runnable() { // from class:
                           // com.android.server.location.nsflp.NSConnectionHelper$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
