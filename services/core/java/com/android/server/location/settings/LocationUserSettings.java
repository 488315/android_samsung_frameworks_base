...
public final class LocationUserSettings implements SettingsStore.VersionedSettings {
  ...
  public static LocationUserSettings read(Resources resources, int i, DataInput dataInput) {
    boolean readBoolean;
    if (i != 1) {
      readBoolean = resources.getBoolean(R.bool.config_cecTvSendStandbyOnSleepDisabled_default);
    } else {
  ...
  public boolean equals(Object obj) {
    ...
    return (obj instanceof LocationUserSettings)
        && this.mAdasGnssLocationEnabled == ((LocationUserSettings) obj).mAdasGnssLocationEnabled;
  }
