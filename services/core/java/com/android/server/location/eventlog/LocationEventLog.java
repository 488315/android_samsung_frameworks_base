...
public class LocationEventLog extends LocalEventLog {
  ...
  public void logProviderClientRegistered(
      String str, CallerIdentity callerIdentity, LocationRequest locationRequest) {
  ...
  public void logProviderStationaryThrottled(
      String str, boolean z, ProviderRequest providerRequest) {
  ...
  public void iterate(final Consumer consumer, final String str) {
    ...
    iterate(
        new LocalEventLog
            .LogConsumer() { // from class:
                             // com.android.server.location.eventlog.LocationEventLog$$ExternalSyntheticLambda0
  ...
  public static /* synthetic */ void lambda$iterate$0(
      String str, StringBuilder sb, long j, Consumer consumer, long j2, Object obj) {
    if (str == null
        || ((obj instanceof ProviderEvent) && str.equals(((ProviderEvent) obj).mProvider))) {
      sb.setLength(0);
  ...
  public final class ProviderClientRegisterEvent extends ProviderEvent {
    ...
    public ProviderClientRegisterEvent(
        String str, boolean z, CallerIdentity callerIdentity, LocationRequest locationRequest) {
      super(str);
      this.mRegistered = z;
  ...
  public final class ProviderStationaryThrottledEvent extends ProviderEvent {
    ...
    public ProviderStationaryThrottledEvent(
        String str, boolean z, ProviderRequest providerRequest) {
      super(str);
      ...
      return "location power save mode changed to "
          + (i != 0
              ? i != 1
                  ? i != 2
                      ? i != 3
                          ? i != 4 ? "UNKNOWN" : "THROTTLE_REQUESTS_WHEN_SCREEN_OFF"
                          : "FOREGROUND_ONLY"
  ...
  public final class AggregateStats {
    ...
    public synchronized void markRequestRemoved() {
      ...
      this.mForegroundRequestCount =
          Math.min(this.mAddedRequestCount, this.mForegroundRequestCount);
    }
