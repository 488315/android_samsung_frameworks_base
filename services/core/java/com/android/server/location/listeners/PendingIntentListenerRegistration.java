...
public abstract class PendingIntentListenerRegistration extends RemovableListenerRegistration
  ...
  public void onRegister() {
    super.onRegister();
    if (getPendingIntentFromKey(getKey())
        .addCancelListener(ConcurrentUtils.DIRECT_EXECUTOR, this)) {
      return;
    }
    remove();
  }
