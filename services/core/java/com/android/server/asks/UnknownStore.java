...
public final class UnknownStore {
    ...
    */
    public final void addCertPolicy(
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.asks.UnknownStore.addCertPolicy(java.lang.String, int,"
                    + " int, int, java.lang.String, int, int, java.lang.String, java.lang.String,"
    ...
    public final void addPermission(
        ...
        if (str2 != null && i7 != -1) {
            ...
            if (split != null && split.length == 2) {
                ...
                if (morerules.check_moreRule_RANK
                        || morerules.check_moreRule_RandomPkg
                        || morerules.check_moreRule_Malformed) {
    ...
    public final void checkDomain(String str, RETVALUE retvalue) {
        ...
        if (isDevDevice()) {
            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                    " checkDomain() : ", str, "PackageInformationStore");
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void checkMoreRule(
            com.android.server.asks.PEMINFO r23, com.android.server.asks.RETVALUE r24) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.asks.UnknownStore.checkMoreRule(com.android.server.asks.PEMINFO,"
                    + " com.android.server.asks.RETVALUE):void");
    }
    ...
    */
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void checkPolicyWithPEM(
            java.lang.String[] r19, int r20, boolean r21, com.android.server.asks.RETVALUE r22) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.asks.UnknownStore.checkPolicyWithPEM(java.lang.String[],"
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean checkRegexTarget(
            java.lang.String r12, com.android.server.asks.RETVALUE r13, boolean r14) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.asks.UnknownStore.checkRegexTarget(java.lang.String,"
                    + " com.android.server.asks.RETVALUE, boolean):boolean");
    }
}
