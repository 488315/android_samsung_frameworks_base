...
public final class TwilightState {
  ...
  public LocalDateTime sunrise() {
    return LocalDateTime.ofInstant(
        Instant.ofEpochMilli(this.mSunriseTimeMillis), TimeZone.getDefault().toZoneId());
  }
  ...
  public LocalDateTime sunset() {
    return LocalDateTime.ofInstant(
        Instant.ofEpochMilli(this.mSunsetTimeMillis), TimeZone.getDefault().toZoneId());
  }
