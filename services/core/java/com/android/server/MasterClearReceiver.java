...
public class MasterClearReceiver extends BroadcastReceiver {
  ...
  public void onReceive(final Context context, final Intent intent) {
    ...
    if ("android.intent.action.MASTER_CLEAR".equals(intent.getAction())) {
      Slog.w(
          "MasterClear",
          "The request uses the deprecated Intent#ACTION_MASTER_CLEAR, Intent#ACTION_FACTORY_RESET"
              + " should be used instead.");
    }
    if (intent.hasExtra("android.intent.extra.FORCE_MASTER_CLEAR")) {
      Slog.w(
          "MasterClear",
          "The request uses the deprecated Intent#EXTRA_FORCE_MASTER_CLEAR,"
              + " Intent#EXTRA_FORCE_FACTORY_RESET should be used instead.");
    }
    String string = context.getString(R.string.dismiss_action);
    if ("android.intent.action.FACTORY_RESET".equals(intent.getAction())
    ...
    this.mWipeExternalStorage =
        intent.getBooleanExtra("android.intent.extra.WIPE_EXTERNAL_STORAGE", false);
    this.mWipeEsims = intent.getBooleanExtra("com.android.internal.intent.extra.WIPE_ESIMS", false);
    final boolean z =
        intent.getBooleanExtra("android.intent.extra.FORCE_MASTER_CLEAR", false)
            || intent.getBooleanExtra("android.intent.extra.FORCE_FACTORY_RESET", false);
    if (stringExtra == null) {
      Slog.w(
          "MasterClear",
          "!@[MasterClearReceiver] onReceive: Ignoring FACTORY_RESET request -- reason cannot be"
              + " null.");
      return;
    }
    ...
    Slog.d(
        "MasterClear",
        "!@[MasterClearReceiver] onReceive: mWipeExternalStorage: " + this.mWipeExternalStorage);
    ...
    this.requestedTimeArg =
        intent.getStringExtra("com.android.internal.intent.extra.FDR_REQUEST_TIME");
    Slog.d(
        "MasterClear",
        "!@[MasterClearReceiver] onReceive: requestedTimeArg is [" + this.requestedTimeArg + "]");
    if (this.requestedTimeArg == null) {
      long currentTimeMillis = System.currentTimeMillis();
      this.requestedTimeArg =
          "requested_time="
              + new SimpleDateFormat("yyyy/MM/dd HH:mm:ss.SSS").format(new Date(currentTimeMillis));
    }
    ...
    if (str != null) {
      ...
      Slog.d(
          "MasterClear",
          "!@[MasterClearReceiver] onReceive: requested time is added to extraCmd, extraCmd is ["
              + this.extraCmd
              + "]");
    }
      ...
      if (((Boolean)
              Binder.withCleanCallingIdentity(
                  new FunctionalUtils.ThrowingSupplier() { // from class:
                    // com.android.server.MasterClearReceiver$$ExternalSyntheticLambda0
                    public final Object getOrThrow() {
                      Boolean lambda$onReceive$0;
                      lambda$onReceive$0 =
                          MasterClearReceiver.this.lambda$onReceive$0(
                              context, sendingUserId, stringExtra);
    ...
    Thread thread = new Thread("Reboot") { // from class: com.android.server.MasterClearReceiver.1
          ...
          public void run() {
            try {
              ...
              } else if (!stringExtra.equals("HIDDEN_MENU")
                  && stringExtra.contains("SIMBasedChangeCSC")) {
              ...
              if (intent.hasExtra("CustomWipe")) {
                ...
                RecoverySystem.rebootWipeCustomerPartition(
                    context, str2 + "--locale=" + Locale.getDefault().toString(), stringExtra);
              } else if (intent.hasExtra("WipeCustomerPartiotion")) {
                Slog.w(
                    "MasterClear",
                    "!@[MasterClearReceiver] thr.run: !!!WipeData and WipeCustomerPartiotion!!!");
                RecoverySystem.rebootWipeCustomerPartition(
                    context,
                ...
                Slog.w(
                    "MasterClear",
                    "!@[MasterClearReceiver] thr.run: !!!Just Exit (For Bypass Factory Reset)!!!");
                RecoverySystem.rebootWipeCustomerPartition(
                    context, "--just_exit\n--locale=" + Locale.ROOT.toString(), stringExtra);
              } else if (intent.hasExtra("Download")) {
                Slog.w(
                    "MasterClear",
                    "!@[MasterClearReceiver] thr.run: !!!Enter the Download Mode for Factory"
                        + " Routine!!!");
                RecoverySystem.rebootWipeCustomerPartition(context, "", stringExtra);
              } else {
                Slog.w(
                    "MasterClear",
                    "!@[MasterClearReceiver] thr.run: !!!No hasExtra, just call"
                        + " rebootWipeUserData!!!");
                RecoverySystem.rebootWipeUserData(
                    ...
                    z,
                    false,
                    MasterClearReceiver.this.extraCmd);
              }
              Slog.wtf(
                  "MasterClear",
                  "!@[MasterClearReceiver] thr.run: Still running after master clear?!");
            } catch (FileNotFoundException e) {
              Slog.e(
                  "MasterClear",
                  "!@[MasterClearReceiver] thr.run: Can't perform master clear/factory reset",
                  e);
  ...
  public final boolean wipeUser(Context context, int i, String str) {
    ...
    if (!UserManager.isRemoveResultSuccessful(
        userManager.removeUserWhenPossible(UserHandle.of(i), false))) {
    ...
    if (getCurrentForegroundUserId() == i) {
      try {
        if (!ActivityManager.getService().switchUser(0)) {
          Slogf.m105w(
              "MasterClear",
              "Can't switch from current user %d, user will get removed when it is stopped.",
              Integer.valueOf(i));
        }
  ...
  public final String getWorkProfileDeletedTitle(final Context context) {
    return ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class))
        .getResources()
        .getString(
            "Core.WORK_PROFILE_DELETED_TITLE",
            new Supplier() { // from class:
              // com.android.server.MasterClearReceiver$$ExternalSyntheticLambda1
              @Override // java.util.function.Supplier
              public final Object get() {
                String lambda$getWorkProfileDeletedTitle$1;
                lambda$getWorkProfileDeletedTitle$1 =
                    MasterClearReceiver.lambda$getWorkProfileDeletedTitle$1(context);
  ...
  public class WipeDataTask extends AsyncTask {
    ...
    public WipeDataTask(Context context, Thread thread) {
      ...
      Slog.d(
          "MasterClear",
          "!@[MasterClearReceiver] WipeDataTask: mProgressDialog object will create");
      this.mProgressDialog =
          new ProgressDialog(context, R.style.Theme.Leanback.Settings.Dialog.Alert);
    ...
    public void onPreExecute() {
      ...
      Slog.d(
          "MasterClear",
          "!@[MasterClearReceiver] WipeDataTask onPreExecute: mProgressDialog will show");
      this.mProgressDialog.show();
      Slog.d(
          "MasterClear",
          "!@[MasterClearReceiver] WipeDataTask onPreExecute: mProgressDialog showed");
    }
    ...
    public void onPostExecute(Void r2) {
      Slog.d(
          "MasterClear",
          "!@[MasterClearReceiver] WipeDataTask onPostExecute: mProgressDialog object will"
              + " dismiss");
      this.mProgressDialog.dismiss();
      Slog.d(
          "MasterClear",
          "!@[MasterClearReceiver] WipeDataTask onPostExecute: mProgressDialog object dismissed");
  ...
  public final void removeVZWResetDate() {
    try {
      ...
      if (file.exists()) {
        Slog.d(
            "MasterClear",
            "!@[MasterClearReceiver] removeVZWResetDate: Try to delete VZW Reset Date file");
        file.delete();
      }
    } catch (Exception e) {
      e.printStackTrace();
    ...
    for (int i = 0; i < 2; i++) {
      try {
        BufferedReader bufferedReader =
            new BufferedReader(new FileReader((String) arrayList.get(i)));
        try {
          String readLine = bufferedReader.readLine();
          Slog.i(
              "MasterClear", "!@[MasterClearReceiver]removeFirstUseDate)faiExpiredStr:" + readLine);
          z = "0".equals(readLine);
          try {
            ...
            e = e;
            Slog.w(
                "MasterClear", "!@[MasterClearReceiver]removeFirstUseDate)read or parse Exception");
            e.printStackTrace();
            if (!z) {}
          }
        } catch (Throwable th) {
        ...
        try {
          ...
          try {
            ...
            if (new File((String) arrayList3.get(i)).delete()) {
              Slog.i(
                  "MasterClear",
                  "!@[MasterClearReceiver]removeFirstUseDate)erase FirstUseDate Success");
            }
            fileWriter.close();
          } catch (Throwable th3) {
            try {
