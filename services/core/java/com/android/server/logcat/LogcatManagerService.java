...
public final class LogcatManagerService extends SystemService {
  ...
  public final class BinderService extends ILogcatManagerService.Stub {
    ...
    public void startThread(int i, int i2, int i3, int i4) {
      LogcatManagerService.this.mHandler.sendMessageAtTime(
          LogcatManagerService.this.mHandler.obtainMessage(0, new LogAccessRequest(i, i2, i3, i4)),
          ((Long) LogcatManagerService.this.mClock.get()).longValue());
    }

    public void finishThread(int i, int i2, int i3, int i4) {
      LogcatManagerService.this.mHandler.sendMessageAtTime(
          LogcatManagerService.this.mHandler.obtainMessage(3, new LogAccessRequest(i, i2, i3, i4)),
          ((Long) LogcatManagerService.this.mClock.get()).longValue());
    }
  }
  ...
  public final class LogAccessDialogCallback extends ILogAccessDialogCallback.Stub {
    ...
    public void approveAccessForClient(int i, String str) {
      LogcatManagerService.this.mHandler.sendMessageAtTime(
          LogcatManagerService.this.mHandler.obtainMessage(1, new LogAccessClient(i, str)),
          ((Long) LogcatManagerService.this.mClock.get()).longValue());
    }

    public void declineAccessForClient(int i, String str) {
      LogcatManagerService.this.mHandler.sendMessageAtTime(
          LogcatManagerService.this.mHandler.obtainMessage(2, new LogAccessClient(i, str)),
          ((Long) LogcatManagerService.this.mClock.get()).longValue());
    }
  }
  ...
  public class Injector {
    public Supplier createClock() {
      return new Supplier() { // from class:
                              // com.android.server.logcat.LogcatManagerService$Injector$$ExternalSyntheticLambda0
  ...
  public final void processNewLogAccessRequest(LogAccessClient logAccessClient) {
    boolean z =
        this.mActivityManagerInternal.getInstrumentationSourceUid(logAccessClient.mUid) != -1;
    ...
    handler.sendMessageAtTime(
        handler.obtainMessage(4, logAccessClient),
        ((Long) this.mClock.get()).longValue() + PENDING_CONFIRMATION_TIMEOUT_MILLIS);
    Intent createIntent = createIntent(logAccessClient);
    createIntent.setFlags(268435456);
    createIntent.setComponent(
        new ComponentName(
            "com.android.systemui", "com.android.systemui.logcat.LogAccessDialogActivity"));
  ...
  */
  public final boolean isSmartSwitchApp(LogAccessClient logAccessClient) {
    boolean z;
    PackageManager packageManager;
    if ("com.sec.android.easyMover".equals(logAccessClient.mPackageName)
  ...
  public final void scheduleStatusExpiry(LogAccessClient logAccessClient) {
    ...
    Handler handler = this.mHandler;
    handler.sendMessageAtTime(
        handler.obtainMessage(5, logAccessClient), ((Long) this.mClock.get()).longValue() + 60000);
  }
  ...
  public void onLogAccessFinished(LogAccessRequest logAccessRequest) {
    LogAccessClient clientForRequest = getClientForRequest(logAccessRequest);
    int intValue =
        ((Integer) this.mActiveLogAccessCount.getOrDefault(clientForRequest, 1)).intValue() - 1;
    if (intValue == 0) {
  ...
  public final void approveRequest(
    ...
    try {
      ...
      this.mActiveLogAccessCount.put(
          logAccessClient,
          Integer.valueOf(
              ((Integer) this.mActiveLogAccessCount.getOrDefault(logAccessClient, 0)).intValue()
                  + 1));
