...
public class BootControlHIDL implements IBootControl {
  ...
  public static BootControlHIDL getService() {
    android.hardware.boot.V1_0.IBootControl service =
        android.hardware.boot.V1_0.IBootControl.getService(true);
    return new BootControlHIDL(
        service,
        android.hardware.boot.V1_1.IBootControl.castFrom((IHwInterface) service),
        android.hardware.boot.V1_2.IBootControl.castFrom((IHwInterface) service));
  }
  ...
  public BootControlHIDL(
      ...
      android.hardware.boot.V1_2.IBootControl iBootControl3) {
