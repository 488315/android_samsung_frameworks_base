...
class BlockchainTZNative {
  ...
  public boolean loadTA(Context context, int i, long j, long j2) {
    if (this.mMOPTZNativePtr_ != 0) {
      Log.e(
          "BlockchainTZService",
          "BlockchainTZNative::loadTA called for TA that is already loaded. Call Ignored");
      return true;
    }
  ...
  public void unloadTA() {
    synchronized (BlockchainTZNative.class) {
      ...
      Log.e(
          "BlockchainTZService",
          "BlockchainTZNative::unloadTA called for TA that is not loaded. Call Ignored: ta loaded: "
              + this.mIsLoaded);
    }
  }
  ...
  public TACommandResponse processTACommand(TACommandRequest tACommandRequest) {
    ...
    Log.e(
        "BlockchainTZService",
        "BlockchainTZNative::processTACommand: Error: nativeBlockchainProcessTACommand returned"
            + " failure");
    return null;
  }
}
