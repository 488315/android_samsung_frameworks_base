...
public class PhoneCallStateHandler {
  ...
  public PhoneCallStateHandler(
    ...
    subscriptionManager.addOnSubscriptionsChangedListener(
        ...
        new SubscriptionManager.OnSubscriptionsChangedListener() { // from class:
          // com.android.server.soundtrigger.PhoneCallStateHandler.1
  ...
  public final class MyCallStateListener extends TelephonyCallback
    ...
    public void cleanup() {
      PhoneCallStateHandler.this.mExecutor.execute(
          new Runnable() { // from class:
            // com.android.server.soundtrigger.PhoneCallStateHandler$MyCallStateListener$$ExternalSyntheticLambda0
  ...
  public final boolean checkCallStatus() {
    ...
    return activeSubscriptionInfoList.stream()
        .filter(
            new Predicate() { // from class:
              // com.android.server.soundtrigger.PhoneCallStateHandler$$ExternalSyntheticLambda3
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$checkCallStatus$0;
                lambda$checkCallStatus$0 =
                    PhoneCallStateHandler.lambda$checkCallStatus$0((SubscriptionInfo) obj);
                return lambda$checkCallStatus$0;
              }
            })
        .anyMatch(
            new Predicate() { // from class:
              // com.android.server.soundtrigger.PhoneCallStateHandler$$ExternalSyntheticLambda4
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$checkCallStatus$1;
                lambda$checkCallStatus$1 =
                    PhoneCallStateHandler.this.lambda$checkCallStatus$1((SubscriptionInfo) obj);
                return lambda$checkCallStatus$1;
              }
            });
  }

  public static /* synthetic */ boolean lambda$checkCallStatus$0(
  ...
  public final void updateTelephonyListeners() {
    synchronized (this.mLock) {
      ...
      activeSubscriptionInfoList.stream()
          .filter(
              new Predicate() { // from class:
                // com.android.server.soundtrigger.PhoneCallStateHandler$$ExternalSyntheticLambda0
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$updateTelephonyListeners$2;
                  lambda$updateTelephonyListeners$2 =
                      PhoneCallStateHandler.lambda$updateTelephonyListeners$2(
          ...
          .map(
              new Function() { // from class:
                // com.android.server.soundtrigger.PhoneCallStateHandler$$ExternalSyntheticLambda1
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                  TelephonyManager lambda$updateTelephonyListeners$3;
                  lambda$updateTelephonyListeners$3 =
                      PhoneCallStateHandler.this.lambda$updateTelephonyListeners$3(
                          (SubscriptionInfo) obj);
          ...
          .forEach(
              new Consumer() { // from class:
                // com.android.server.soundtrigger.PhoneCallStateHandler$$ExternalSyntheticLambda2
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  PhoneCallStateHandler.this.lambda$updateTelephonyListeners$4(
  ...
  public static /* synthetic */ boolean lambda$updateTelephonyListeners$2(
      SubscriptionInfo subscriptionInfo) {
    return subscriptionInfo.getSubscriptionId() != -1;
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ TelephonyManager lambda$updateTelephonyListeners$3(
      SubscriptionInfo subscriptionInfo) {
