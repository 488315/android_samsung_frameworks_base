...
public class SoundTriggerHelper implements SoundTrigger.StatusListener {
  ...
  public SoundTriggerHelper(
      Context context, EventLogger eventLogger, Function function, int i, Supplier supplier) {
    this.mModuleId = i;
  ...
  public int startGenericRecognition(
      UUID uuid,
    ...
    if (uuid == null
        ...
        || iRecognitionStatusCallback == null
    ...
    synchronized (this.mLock) {
      ...
      if (orCreateGenericModelDataLocked == null) {
        Slog.w(
            "SoundTriggerHelper", "Irrecoverable error occurred, check UUID / sound model data.");
        return Integer.MIN_VALUE;
      }
      return startRecognition(
          genericSoundModel,
          orCreateGenericModelDataLocked,
  ...
  public int startKeyphraseRecognition(
      int i,
    ...
    synchronized (this.mLock) {
      ...
      if (keyphraseSoundModel != null
        ...
        if (keyphraseModelDataLocked != null
            && !keyphraseModelDataLocked.getModelId().equals(keyphraseSoundModel.getUuid())) {
          int cleanUpExistingKeyphraseModelLocked =
              cleanUpExistingKeyphraseModelLocked(keyphraseModelDataLocked);
        ...
        if (keyphraseModelDataLocked == null) {
          keyphraseModelDataLocked =
              createKeyphraseModelDataLocked(keyphraseSoundModel.getUuid(), i);
        }
        return startRecognition(
            keyphraseSoundModel,
            keyphraseModelDataLocked,
  ...
  public final int cleanUpExistingKeyphraseModelLocked(ModelData modelData) {
    ...
    if (tryStopAndUnloadLocked != 0) {
      Slog.w(
          "SoundTriggerHelper", "Unable to stop or unload previous model: " + modelData.toString());
    }
  ...
  public final int prepareForRecognition(ModelData modelData) {
    ...
    if (!modelData.isModelLoaded()) {
      ...
      if (loadSoundModel != 0) {
        Slog.w(
            "SoundTriggerHelper",
            "prepareForRecognition: loadSoundModel failed with status: " + loadSoundModel);
  ...
  public final int startRecognition(
    ...
    synchronized (this.mLock) {
      ...
      if (modelData.getSoundModel() != null) {
        ...
        if ((z2 || z3)
            && (tryStopAndUnloadLocked = tryStopAndUnloadLocked(modelData, z2, z3)) != 0) {
          Slog.w(
              "SoundTriggerHelper",
        ...
        try {
          this.mEventLogger.enqueue(
              new SoundTriggerEvent.SessionEvent(
                  SoundTriggerEvent.SessionEvent.Type.PAUSE, modelData.getModelId()));
  ...
  public int stopGenericRecognition(
  ...
  public int stopKeyphraseRecognition(
    ...
    synchronized (this.mLock) {
      ...
      if (iRecognitionStatusCallback == null) {
        Slog.e(
            "SoundTriggerHelper",
            "Null callback received for stopKeyphraseRecognition() for keyphraseId:" + i);
        return Integer.MIN_VALUE;
      }
      if (this.mIsDetached) {
        throw new IllegalStateException("SoundTriggerHelper has been detached");
  ...
  public final int stopRecognition(
    ...
    synchronized (this.mLock) {
      ...
      Slog.w(
          "SoundTriggerHelper", "Attempting stopRecognition without a successful startRecognition");
      return Integer.MIN_VALUE;
    }
  }
  ...
  public SoundTrigger.ModuleProperties getModuleProperties() {
    ...
    Slog.e(
        "SoundTriggerHelper",
        "Module properties not found for existing moduleId " + this.mModuleId);
    return null;
  }
    ...
    synchronized (this.mLock) {
      ...
      if (this.mModule != null
        ...
        if (updateRecognitionLocked != 0) {
          Slog.w(
              "SoundTriggerHelper",
              "Stop recognition failed for keyphrase ID:" + updateRecognitionLocked);
        }
      ...
      if (uuid != null && this.mModule != null) {
        ...
        if (modelData != null && modelData.isGenericModel()) {
          ...
          if (modelData.isModelStarted()
              && (stopRecognitionLocked = stopRecognitionLocked(modelData, false)) != 0) {
          ...
          if (unloadSoundModel != 0) {
            Slog.w(
                "SoundTriggerHelper",
                "unloadGenericSoundModel() call failed with " + unloadSoundModel);
            Slog.w(
                "SoundTriggerHelper", "unloadGenericSoundModel() force-marking model as unloaded.");
          }
        ...
        Slog.w(
            "SoundTriggerHelper",
            "Unload error: Attempting unload invalid generic model with id:" + uuid);
        return Integer.MIN_VALUE;
      }
      return Integer.MIN_VALUE;
    }
      ...
      if (uuid != null && this.mModule != null) {
        ...
        if (modelData != null && modelData.isGenericModel()) {
          if (!modelData.isModelLoaded()) {
            Slog.i(
                "SoundTriggerHelper",
                "GetGenericModelState: Given generic model is not loaded:" + uuid);
            return Integer.MIN_VALUE;
          }
          if (!modelData.isModelStarted()) {
            Slog.i(
        ...
        Slog.w(
            "SoundTriggerHelper", "GetGenericModelState error: Invalid generic model id:" + uuid);
        return Integer.MIN_VALUE;
      }
      return Integer.MIN_VALUE;
    }
    ...
    if (i == 0 || i == 3) {
      ...
      if (Objects.equals(genericRecognitionEvent.getToken(), modelDataForLocked.getToken())) {
        ...
        try {
          ...
          SoundTrigger.RecognitionConfig recognitionConfig =
              modelDataForLocked.getRecognitionConfig();
          if (recognitionConfig == null) {
            Slog.w(
                "SoundTriggerHelper",
                "Generic recognition event: Null RecognitionConfig for model handle: "
                    + genericRecognitionEvent.soundModelHandle);
            return;
          }
  ...
  public final void onResourcesAvailableLocked() {
    this.mEventLogger.enqueue(
        new SoundTriggerEvent.SessionEvent(
            SoundTriggerEvent.SessionEvent.Type.RESOURCES_AVAILABLE, null));
    updateAllRecognitionsLocked();
  }
  ...
  public final void onRecognitionAbortLocked(SoundTrigger.RecognitionEvent recognitionEvent) {
    ...
    if (modelDataForLocked != null
        && modelDataForLocked.isModelStarted()
        && Objects.equals(recognitionEvent.getToken(), modelDataForLocked.getToken())) {
      modelDataForLocked.setStopped();
      try {
        IRecognitionStatusCallback callback = modelDataForLocked.getCallback();
        if (callback != null) {
          this.mEventLogger.enqueue(
              new SoundTriggerEvent.SessionEvent(
                  SoundTriggerEvent.SessionEvent.Type.PAUSE, modelDataForLocked.getModelId()));
  ...
  public final int getKeyphraseIdFromEvent(
  ...
  public final void onKeyphraseRecognitionLocked(
    ...
    if (keyphraseModelDataLocked == null || !keyphraseModelDataLocked.isKeyphraseModel()) {
      Slog.e(
          "SoundTriggerHelper",
          "Keyphase model data does not exist for ID:" + keyphraseIdFromEvent);
      return;
    }
    if (Objects.equals(keyphraseRecognitionEvent.getToken(), keyphraseModelDataLocked.getToken())) {
      ...
      try {
        ...
        SoundTrigger.RecognitionConfig recognitionConfig =
            keyphraseModelDataLocked.getRecognitionConfig();
        if (recognitionConfig != null) {
      ...
      for (ModelData modelData : this.mModelDataMap.values()) {
        ...
        if (callback != null) {
          try {
            this.mEventLogger.enqueue(
                new SoundTriggerEvent.SessionEvent(
                        SoundTriggerEvent.SessionEvent.Type.MODULE_DIED, modelData.getModelId())
                    .printLog(2, "SoundTriggerHelper"));
  ...
  public final void stopAndUnloadDeadModelsLocked() {
    ...
    while (it.hasNext()) {
      ...
      if (modelData.isModelLoaded()
          && (modelData.getCallback() == null
              || (modelData.getCallback().asBinder() != null
                  && !modelData.getCallback().asBinder().pingBinder()))) {
        Slog.w(
            "SoundTriggerHelper",
            "Removing model " + modelData.getHandle() + " that has no clients");
  ...
  public final boolean isRecognitionAllowed(ModelData modelData) {
    ...
    if (!this.mIsAppOpPermitted
        || (i = AbstractC25991.f1725x381aeb4f[this.mDeviceState.ordinal()]) == 1) {
      return false;
    }
    if (i == 2) {
  ...
  /* renamed from: com.android.server.soundtrigger.SoundTriggerHelper$1 */
  public abstract /* synthetic */ class AbstractC25991 {

    /* renamed from: $SwitchMap$com$android$server$soundtrigger$DeviceStateHandler$SoundTriggerDeviceState */
    public static final /* synthetic */ int[] f1725x381aeb4f;
    ...
    static {
      ...
      try {
        f1725x381aeb4f[DeviceStateHandler.SoundTriggerDeviceState.CRITICAL.ordinal()] = 2;
      } catch (NoSuchFieldError unused2) {
      }
      try {
        f1725x381aeb4f[DeviceStateHandler.SoundTriggerDeviceState.ENABLE.ordinal()] = 3;
  ...
  public final int startRecognitionLocked(ModelData modelData, boolean z) {
    ...
    try {
      modelData.setToken(
          soundTriggerModule.startRecognitionWithToken(modelData.getHandle(), recognitionConfig));
      handleException = 0;
    } catch (Exception e) {
    ...
    if (handleException != 0) {
        ...
        try {
          this.mEventLogger.enqueue(
              new SoundTriggerEvent.SessionEvent(
                      ...
                      modelData.getModelId(),
                      String.valueOf(handleException))
                  .printLog(2, "SoundTriggerHelper"));
          modelData.setRequested(false);
          ...
          this.mEventLogger.enqueue(
              new SoundTriggerEvent.SessionEvent(
                      SoundTriggerEvent.SessionEvent.Type.RESUME_FAILED,
                      modelData.getModelId(),
                      String.valueOf(handleException) + " - RemoteException")
                  .printLog(2, "SoundTriggerHelper"));
          forceStopAndUnloadModelLocked(modelData, e2);
        }
      }
      ...
      if (z) {
        try {
          this.mEventLogger.enqueue(
              new SoundTriggerEvent.SessionEvent(
                  SoundTriggerEvent.SessionEvent.Type.RESUME, modelData.getModelId()));
  ...
  public class ModelData {
    ...
    public synchronized void setRecognitionConfig(
        SoundTrigger.RecognitionConfig recognitionConfig) {
    ...
    public synchronized String callbackToString() {
      ...
      sb.append(
          iRecognitionStatusCallback != null ? iRecognitionStatusCallback.asBinder() : "null");
      return sb.toString();
    }
