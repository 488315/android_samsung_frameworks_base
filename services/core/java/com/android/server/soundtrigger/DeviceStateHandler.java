...
public class DeviceStateHandler implements PhoneCallStateHandler.Callback {
      ...
      if (!z) {
        NotificationTask notificationTask2 =
            new NotificationTask(
                new Runnable() { // from class: com.android.server.soundtrigger.DeviceStateHandler.1
                  @Override // java.lang.Runnable
                  public void run() {
                    synchronized (DeviceStateHandler.this.mLock) {
                      if (DeviceStateHandler.this.mPhoneStateChangePendingNotify != null
                          && DeviceStateHandler.this.mPhoneStateChangePendingNotify.runnableEquals(
                              this)) {
  ...
  public void registerListener(final DeviceStateListener deviceStateListener) {
    ...
    this.mCallbackExecutor.execute(
        new Runnable() { // from class:
          // com.android.server.soundtrigger.DeviceStateHandler$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
            DeviceStateHandler.DeviceStateListener.this.onSoundTriggerDeviceStateUpdate(
                deviceState);
          }
        });
  ...
  public final void evaluateStateChange() {
    ...
    for (final DeviceStateListener deviceStateListener : this.mCallbackSet) {
      this.mCallbackExecutor.execute(
          new Runnable() { // from class:
            // com.android.server.soundtrigger.DeviceStateHandler$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              DeviceStateHandler.DeviceStateListener.this.onSoundTriggerDeviceStateUpdate(
