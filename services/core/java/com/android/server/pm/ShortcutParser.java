...
public abstract class ShortcutParser {
      ...
      try {
        ...
        for (int i2 = 0; i2 < size; i2++) {
          ...
          if (activityInfo != null
              && (activityInfoWithMetadata =
                      shortcutService.getActivityInfoWithMetadata(
                          activityInfo.getComponentName(), i))
                  != null) {
            list2 =
                parseShortcutsOneFile(
                    shortcutService, activityInfoWithMetadata, str, i, list2, list);
          }
        }
        return list2;
  ...
  */
  public static List parseShortcutsOneFile(
      ...
      if (next == 3 && depth == 2 && "shortcut".equals(name)) {
        if (shortcutInfo != null) {
          if (shortcutInfo.isEnabled()) {
            if (arrayList.size() == 0) {
              Log.e(
                  "ShortcutService",
                  "Shortcut " + shortcutInfo.getId() + " has no intent. Skipping it.");
          ...
          try {
            ...
            Log.e(
                "ShortcutService", "Shortcut's extras contain un-persistable values. Skipping it.");
          }
          componentName = componentName3;
          asAttributeSet = attributeSet2;
          shortcutInfo = null;
        ...
        if (next != 3 || depth != 2 || !"share-target".equals(name)) {
          ...
          if (arraySet != null && !arraySet.isEmpty() && !arrayList2.isEmpty()) {
            ...
            list2.add(
                new ShareTargetInfo(
                    (ShareTargetInfo.TargetData[])
                        arrayList2.toArray(new ShareTargetInfo.TargetData[arrayList2.size()]),
                    shareTargetInfo.mTargetClass,
                    (String[]) arraySet.toArray(new String[arraySet.size()])));
            arrayList2.clear();
            i5 = 2;
        ...
        if (next == i5 && (depth != 1 || !"shortcuts".equals(name))) {
          ...
          if (depth != 2) {
            ...
            list4 = list3;
            shortcutInfo =
                parseShortcutAttributes(shortcutService, attributeSet2, str, componentName3, i, i3);
            if (shortcutInfo != null) {
              if (list4 != null) {
                for (int size = list4.size() - 1; size >= 0; size--) {
                  if (shortcutInfo.getId().equals(((ShortcutInfo) list4.get(size)).getId())) {
          ...
          if (depth == i7 && "share-target".equals(name)) {
            ...
            ShareTargetInfo parseShareTargetAttributes =
                parseShareTargetAttributes(shortcutService2, attributeSet);
            ...
            attributeSet = attributeSet2;
            shortcutService2 = shortcutService;
            if (depth == 3 && KnoxCustomManagerService.INTENT.equals(name)) {
              if (shortcutInfo2 != null && shortcutInfo2.isEnabled()) {
                Intent parseIntent =
                    Intent.parseIntent(
                        shortcutService2.mContext.getResources(), injectXmlMetaData, attributeSet);
                if (TextUtils.isEmpty(parseIntent.getAction())) {
                  Log.e(
                      "ShortcutService",
                      "Shortcut intent action must be provided. activity=" + componentName3);
                  asAttributeSet = attributeSet;
                  componentName = componentName3;
                  list3 = list4;
                  i2 = i4;
              ...
              if (depth != i6 || !"data".equals(name)) {
                ...
                Log.w(
                    "ShortcutService", String.format("Invalid tag '%s' found at depth %d", objArr));
              } else if (shareTargetInfo2 != null) {
                ShareTargetInfo.TargetData parseShareTargetData =
                    parseShareTargetData(shortcutService2, attributeSet);
  ...
  public static String parseCategories(ShortcutService shortcutService, AttributeSet attributeSet) {
    TypedArray obtainAttributes =
        shortcutService
            .mContext
            .getResources()
            .obtainAttributes(attributeSet, R.styleable.ShortcutCategories);
    try {
  ...
  public static ShortcutInfo parseShortcutAttributes(
      ShortcutService shortcutService,
      AttributeSet attributeSet,
      String str,
      ComponentName componentName,
    ...
    TypedArray obtainAttributes =
        shortcutService
            .mContext
            .getResources()
            .obtainAttributes(attributeSet, R.styleable.Shortcut);
    try {
      if (obtainAttributes.getType(2) != 3) {
        Log.w(
            "ShortcutService",
            "android:shortcutId must be string literal. activity=" + componentName);
        return null;
      }
      ...
      String resourceName =
          resourceId5 != 0
              ? shortcutService.mContext.getResources().getResourceName(resourceId5)
              : null;
      ...
      Log.w(
          "ShortcutService",
          "android:shortcutShortLabel must be provided. activity=" + componentName);
      return null;
    } finally {
      obtainAttributes.recycle();
    }
  ...
  public static ShortcutInfo createShortcutFromManifest(
      ShortcutService shortcutService,
      int i,
      String str,
      String str2,
  ...
  public static String parseCategory(ShortcutService shortcutService, AttributeSet attributeSet) {
    TypedArray obtainAttributes =
        shortcutService
            .mContext
            .getResources()
            .obtainAttributes(attributeSet, R.styleable.IntentCategory);
    try {
      if (obtainAttributes.getType(0) != 3) {
  ...
  public static ShareTargetInfo parseShareTargetAttributes(
      ShortcutService shortcutService, AttributeSet attributeSet) {
    TypedArray obtainAttributes =
        shortcutService.mContext.getResources().obtainAttributes(attributeSet, R.styleable.Intent);
    try {
  ...
  public static ShareTargetInfo.TargetData parseShareTargetData(
      ShortcutService shortcutService, AttributeSet attributeSet) {
    TypedArray obtainAttributes =
        shortcutService
            .mContext
            .getResources()
            .obtainAttributes(attributeSet, R.styleable.AndroidManifestData);
    try {
      if (obtainAttributes.getType(0) != 3) {
      ...
      return new ShareTargetInfo.TargetData(
          obtainAttributes.getString(1),
          obtainAttributes.getString(2),
          obtainAttributes.getString(3),
          obtainAttributes.getString(4),
          obtainAttributes.getString(6),
          obtainAttributes.getString(5),
          obtainAttributes.getString(0));
    } finally {
      obtainAttributes.recycle();
    }
  }
