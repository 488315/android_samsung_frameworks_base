...
public abstract class UserTypeFactory {
    ...
    */
    public static void customizeBuilders(
            android.util.ArrayMap r8, android.content.res.XmlResourceParser r9) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.pm.UserTypeFactory.customizeBuilders(android.util.ArrayMap,"
                    + " android.content.res.XmlResourceParser):void");
    }
    ...
    public static ArrayMap getDefaultBuilders() {
        ...
        builder.mBadgeLabels =
                new int[] {
                    R.string.permlab_deliverCompanionMessages,
                    R.string.permlab_detectScreenCapture,
                    R.string.permlab_disableKeyguard
                };
        builder.mBadgeColors =
                new int[] {
                    R.color.system_brand_b_light,
                    R.color.system_brand_c_light,
                    R.color.system_brand_d_light
                };
        builder.mDarkThemeBadgeColors =
                new int[] {
                    R.color.system_brand_c_dark,
                    R.color.system_brand_d_dark,
                    R.color.system_clock_hour_dark
                };
        ...
        DefaultCrossProfileIntentFilter defaultCrossProfileIntentFilter =
                DefaultCrossProfileIntentFiltersUtils.EMERGENCY_CALL_MIME;
        ArrayList arrayList = new ArrayList();
        DefaultCrossProfileIntentFilter defaultCrossProfileIntentFilter2 =
                DefaultCrossProfileIntentFiltersUtils.HOME;
        DefaultCrossProfileIntentFilter defaultCrossProfileIntentFilter3 =
                DefaultCrossProfileIntentFiltersUtils.MOBILE_NETWORK_SETTINGS;
        DefaultCrossProfileIntentFilter defaultCrossProfileIntentFilter4 =
                DefaultCrossProfileIntentFiltersUtils.EMERGENCY_CALL_MIME;
        DefaultCrossProfileIntentFilter defaultCrossProfileIntentFilter5 =
                DefaultCrossProfileIntentFiltersUtils.EMERGENCY_CALL_DATA;
        arrayList.addAll(
                Arrays.asList(
                        defaultCrossProfileIntentFilter4,
                        defaultCrossProfileIntentFilter5,
                        DefaultCrossProfileIntentFiltersUtils.CALL_BUTTON,
                        DefaultCrossProfileIntentFiltersUtils.SET_ALARM,
                        DefaultCrossProfileIntentFiltersUtils.MEDIA_CAPTURE,
                        DefaultCrossProfileIntentFiltersUtils.RECOGNIZE_SPEECH,
                        DefaultCrossProfileIntentFiltersUtils.ACTION_PICK_RAW,
                        DefaultCrossProfileIntentFiltersUtils.ACTION_PICK_DATA,
                        DefaultCrossProfileIntentFiltersUtils.ACTION_PICK_IMAGES,
                        DefaultCrossProfileIntentFiltersUtils.ACTION_PICK_IMAGES_WITH_DATA_TYPES,
                        DefaultCrossProfileIntentFiltersUtils.OPEN_DOCUMENT,
                        DefaultCrossProfileIntentFiltersUtils.GET_CONTENT,
                        DefaultCrossProfileIntentFiltersUtils.USB_DEVICE_ATTACHED,
                        DefaultCrossProfileIntentFiltersUtils.ACTION_SEND,
                        defaultCrossProfileIntentFilter2,
                        defaultCrossProfileIntentFilter3));
        arrayList.addAll(
                DefaultCrossProfileIntentFiltersUtils.getDefaultCrossProfileTelephonyIntentFilters(
                        false));
        builder.mDefaultCrossProfileIntentFilters = arrayList;
        builder.mDefaultUserProperties =
                new UserProperties.Builder()
                        .setStartWithParent(true)
                        .setShowInLauncher(1)
                        .setShowInSettings(1)
                        .setShowInQuietMode(0)
                        .setShowInSharingSurfaces(1)
        ...
        builder8.mDefaultCrossProfileIntentFilters =
                Arrays.asList(
                        DefaultCrossProfileIntentFiltersUtils.PARENT_TO_CLONE_SEND_ACTION,
                        DefaultCrossProfileIntentFiltersUtils.PARENT_TO_CLONE_WEB_VIEW_ACTION,
                        DefaultCrossProfileIntentFiltersUtils.PARENT_TO_CLONE_PICK_INSERT_ACTION,
                        DefaultCrossProfileIntentFiltersUtils.PARENT_TO_CLONE_DIAL_DATA,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_MEDIA_CAPTURE,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_SEND_ACTION,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_WEB_VIEW_ACTION,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_VIEW_ACTION,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_PICK_INSERT_ACTION,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_DIAL_DATA,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_SMS_MMS,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_PHOTOPICKER_SELECTION,
                        DefaultCrossProfileIntentFiltersUtils.CLONE_TO_PARENT_ACTION_PICK_IMAGES,
                        DefaultCrossProfileIntentFiltersUtils
                                .CLONE_TO_PARENT_ACTION_PICK_IMAGES_WITH_DATA_TYPES,
                        DefaultCrossProfileIntentFiltersUtils.PARENT_TO_CLONE_NFC_TAG_DISCOVERED,
                        DefaultCrossProfileIntentFiltersUtils.PARENT_TO_CLONE_NFC_TECH_DISCOVERED,
                        DefaultCrossProfileIntentFiltersUtils.PARENT_TO_CLONE_NFC_NDEF_DISCOVERED);
        builder8.mDefaultSecureSettings =
                AccountManagerService$$ExternalSyntheticOutline0.m142m("user_setup_complete", "1");
        ...
        builder8.mBadgeColors =
                new int[] {R.color.datepicker_default_selected_text_color_material_dark};
        builder8.mDarkThemeBadgeColors =
                new int[] {R.color.datepicker_default_selected_text_color_material_dark};
        builder8.mDefaultUserProperties =
                new UserProperties.Builder()
                        .setStartWithParent(true)
                        .setShowInLauncher(0)
                        .setShowInSettings(0)
                        ...
                        .setShowInQuietMode(2)
                        .setShowInSharingSurfaces(0)
        ...
        builder9.mBadgeLabels =
                new int[] {
                    R.string.permlab_deliverCompanionMessages,
                    R.string.permlab_detectScreenCapture,
                    R.string.permlab_disableKeyguard
                };
        builder9.mBadgeColors =
                new int[] {
                    R.color.system_brand_b_light,
                    R.color.system_brand_c_light,
                    R.color.system_brand_d_light
                };
        builder9.mDarkThemeBadgeColors =
                new int[] {
                    R.color.system_brand_c_dark,
                    R.color.system_brand_d_dark,
                    R.color.system_clock_hour_dark
        ...
        builder9.mDefaultSecureSettings =
                AccountManagerService$$ExternalSyntheticOutline0.m142m("user_setup_complete", "1");
        builder9.mDefaultUserProperties =
                new UserProperties.Builder()
        ...
        builder10.mDefaultCrossProfileIntentFilters =
                Arrays.asList(
                        DefaultCrossProfileIntentFiltersUtils.DIAL_MIME_PRIVATE_PROFILE,
                        DefaultCrossProfileIntentFiltersUtils.DIAL_DATA_PRIVATE_PROFILE,
                        DefaultCrossProfileIntentFiltersUtils.DIAL_RAW_PRIVATE_PROFILE,
                        DefaultCrossProfileIntentFiltersUtils.CALL_PRIVATE_PROFILE,
                        DefaultCrossProfileIntentFiltersUtils.CALL_BUTTON_PRIVATE_PROFILE,
                        defaultCrossProfileIntentFilter5,
                        defaultCrossProfileIntentFilter4,
                        DefaultCrossProfileIntentFiltersUtils.SMS_MMS_PRIVATE_PROFILE);
        builder10.mDefaultUserProperties =
                new UserProperties.Builder()
                        .setStartWithParent(true)
                        .setCredentialShareableWithParent(true)
                        ...
                        .setShowInLauncher(1)
                        .setShowInSettings(1)
                        .setShowInQuietMode(1)
                        .setShowInSharingSurfaces(1)
                        .setCrossProfileIntentFilterAccessControl(10)
                        .setInheritDevicePolicy(1)
                        .setCrossProfileContentSharingStrategy(1)
                        .setProfileApiVisibility(1)
        ...
        if (Build.IS_DEBUGGABLE) {
            ...
            builder12.mBadgeLabels =
                    new int[] {
                        R.string.permlab_deliverCompanionMessages,
                        R.string.permlab_detectScreenCapture,
                        R.string.permlab_disableKeyguard
                    };
            builder12.mBadgeColors =
                    new int[] {
                        R.color.system_brand_b_light,
                        R.color.system_brand_c_light,
                        R.color.system_brand_d_light
                    };
            builder12.mDarkThemeBadgeColors =
                    new int[] {
                        R.color.system_brand_c_dark,
                        R.color.system_brand_d_dark,
                        R.color.system_clock_hour_dark
            ...
            builder12.mDefaultSecureSettings =
        ...
        try {
            ...
            StringBuilder m =
                    InitialConfiguration$$ExternalSyntheticOutline0.m(
                            "Cannot parse value of '", attributeValue, "' for ", str, " in ");
    ...
    public static void setResAttributeArray(
            XmlResourceParser xmlResourceParser, Consumer consumer) {
        ArrayList arrayList = new ArrayList();
        ...
        while (XmlUtils.nextElementWithin(xmlResourceParser, depth)) {
            ...
            if ("item".equals(name)) {
                int attributeResourceValue =
                        xmlResourceParser.getAttributeResourceValue(null, "res", -1);
                ...
                StringBuilder m =
                        DumpUtils$$ExternalSyntheticOutline0.m(
                                "Skipping unknown child element ", name, " in ");
                m.append(xmlResourceParser.getPositionDescription());
