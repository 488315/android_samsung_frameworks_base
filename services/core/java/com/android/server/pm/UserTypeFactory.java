...
public abstract class UserTypeFactory {
    ...
    public static UserTypeDetails.Builder getDefaultTypeFullGuest() {
        return new UserTypeDetails.Builder().setName("android.os.usertype.full.GUEST").setBaseType(1024).setDefaultUserInfoPropertyFlags((Resources.getSystem().getBoolean(R.bool.config_enableWifiDisplay) ? 256 : 0) | 4).setMaxAllowed(1).setDefaultRestrictions(getDefaultGuestUserRestrictions());
    }
