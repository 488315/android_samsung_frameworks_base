...
public class DataLoaderManagerService extends SystemService {
  ...
  public final class DataLoaderManagerBinderService extends IDataLoaderManager.Stub {
    ...
    public boolean bindToDataLoader(
      ...
      synchronized (DataLoaderManagerService.this.mServiceConnections) {
        ...
        ComponentName componentName =
            new ComponentName(dataLoaderParamsParcel.packageName, dataLoaderParamsParcel.className);
        final ComponentName resolveDataLoaderComponentName =
            resolveDataLoaderComponentName(componentName);
        ...
        return DataLoaderManagerService.this.mHandler.postDelayed(
            new Runnable() { // from class:
              ...
              public final void run() {
                DataLoaderManagerService.DataLoaderManagerBinderService.this
                    .lambda$bindToDataLoader$0(
                        intent, dataLoaderServiceConnection, resolveDataLoaderComponentName, i);
              }
            },
            j);
      }
    ...
    public /* synthetic */ void lambda$bindToDataLoader$0(
        Intent intent,
        DataLoaderServiceConnection dataLoaderServiceConnection,
        ComponentName componentName,
        int i) {
      if (DataLoaderManagerService.this.mContext.bindServiceAsUser(
          intent,
          dataLoaderServiceConnection,
          1,
          DataLoaderManagerService.this.mHandler,
    ...
    public final ComponentName resolveDataLoaderComponentName(ComponentName componentName) {
      ...
      List queryIntentServicesAsUser =
          packageManager.queryIntentServicesAsUser(intent, 0, UserHandle.getCallingUserId());
      if (queryIntentServicesAsUser == null || queryIntentServicesAsUser.isEmpty()) {
        Slog.e(
            "DataLoaderManager", "Failed to find data loader service provider in " + componentName);
        return null;
      }
  ...
  public class DataLoaderServiceConnection implements ServiceConnection, IBinder.DeathRecipient {
    ...
    public void onServiceDisconnected(ComponentName componentName) {
      Slog.i(
          "DataLoaderManager", "DataLoader " + this.mId + " disconnected, but will try to recover");
