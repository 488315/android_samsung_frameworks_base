...
public final class DefaultCrossProfileResolver extends CrossProfileResolver {
    ...
    public final CrossProfileDomainInfo createForwardingResolveInfo(
            Computer computer,
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (!resolveInfo2.handleAllWebDataURI
                    && (packageStateInternal =
                                    (PackageStateInternal)
                                            function.apply(resolveInfo2.activityInfo.packageName))
                            != null) {
                i3 =
                        Math.max(
                                i3,
                                ((DomainVerificationService) this.mDomainVerificationManager)
        ...
        if (list != null && !list.isEmpty()) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                CrossProfileDomainInfo crossProfileDomainInfo =
                        (CrossProfileDomainInfo) list.get(i2);
    ...
    */
    public final java.util.List resolveIntent(
            com.android.server.pm.Computer r19,
            ...
            java.util.List r27,
            boolean r28,
            java.util.function.Function r29) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.pm.DefaultCrossProfileResolver.resolveIntent(com.android.server.pm.Computer,"
                    + " android.content.Intent, java.lang.String, int, int, long, java.lang.String,"
                    + " java.util.List, boolean, java.util.function.Function):java.util.List");
    }
}
