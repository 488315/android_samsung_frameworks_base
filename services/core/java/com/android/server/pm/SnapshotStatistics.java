...
public class SnapshotStatistics {
  ...
  public class Stats {
    ...
    public final String durationToString(long j) {
      ...
      if (i6 != 0) {
        return TextUtils.formatSimple(
            "%2d:%02d:%02d:%02d",
            new Object[] {
              Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i5), Integer.valueOf(i3)
            });
      }
      if (i7 != 0) {
        return TextUtils.formatSimple(
            "%2s %02d:%02d:%02d",
            new Object[] {"", Integer.valueOf(i7), Integer.valueOf(i5), Integer.valueOf(i3)});
      }
      return TextUtils.formatSimple(
          "%2s %2s %2d:%02d", new Object[] {"", "", Integer.valueOf(i5), Integer.valueOf(i3)});
    }

    public final void dumpPrefix(
        PrintWriter printWriter, String str, long j, boolean z, String str2) {
    ...
    public final void dumpStats(PrintWriter printWriter, String str, long j, boolean z) {
      ...
      if (z) {
        ...
        printWriter.format(
            ...
            Integer.valueOf(this.mTotalBuilds),
            Integer.valueOf(this.mTotalUsed),
            Integer.valueOf(this.mBigBuilds),
            Integer.valueOf(this.mShortLived),
            Long.valueOf(this.mTotalTimeUs / 1000),
            Integer.valueOf(this.mMaxBuildTimeUs / 1000));
      }
      printWriter.println();
    }
      ...
      if (!z) {
        ...
        while (i < userKeys.length) {
          printWriter.format(
              Locale.US,
              "  %10s",
              TextUtils.formatSimple("<= %dms", new Object[] {Integer.valueOf(userKeys[i])}));
          i++;
        }
        printWriter.format(
            Locale.US,
            ...
            TextUtils.formatSimple(
                "> %dms", new Object[] {Integer.valueOf(userKeys[userKeys.length - 1])}));
      }
      printWriter.println();
    }
      ...
      if (!z) {
        ...
        while (i < userKeys.length) {
          printWriter.format(
              Locale.US,
              "  %10s",
              TextUtils.formatSimple("<= %d", new Object[] {Integer.valueOf(userKeys[i])}));
          i++;
        }
        printWriter.format(
            Locale.US,
            "  %10s",
            TextUtils.formatSimple(
                "> %d", new Object[] {Integer.valueOf(userKeys[userKeys.length - 1])}));
      }
      printWriter.println();
    }
    ...
    public final void logSnapshotStatistics(int i) {
      ...
      FrameworkStatsLog.write(
          ...
          this.mTimes,
          this.mUsed,
          this.mMaxBuildTimeUs,
          this.mMaxUsedCount,
          i2 == 0 ? 0L : this.mTotalTimeUs / i2,
          i2 == 0 ? 0 : this.mTotalUsed / i2,
          i);
    }
  }
  ...
  public SnapshotStatistics() {
    ...
    this.mHandler =
        new Handler(
            Looper.getMainLooper()) { // from class: com.android.server.pm.SnapshotStatistics.1
