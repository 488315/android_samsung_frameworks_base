...
public final class InstallSource {
  public static final InstallSource EMPTY =
      new InstallSource(null, null, null, -1, null, null, false, false, null, 0);
  public static final InstallSource EMPTY_ORPHANED =
      new InstallSource(null, null, null, -1, null, null, true, false, null, 0);
  ...
  public static InstallSource create(
      String str, String str2, String str3, int i, String str4, String str5, int i2) {
  ...
  public static InstallSource create(
    ...
    return createInternal(
        intern(str), intern(str2), intern(str3), i, intern(str4), str5, i2, z, z2, null);
  }

  public static InstallSource createInternal(
      String str,
      String str2,
      String str3,
      int i,
  ...
  public InstallSource setInstallerPackage(String str, int i) {
    return Objects.equals(str, this.mInstallerPackageName)
        ? this
        : createInternal(
            this.mInitiatingPackageName,
            this.mOriginatingPackageName,
            intern(str),
            i,
            this.mUpdateOwnerPackageName,
            this.mInstallerAttributionTag,
            this.mPackageSource,
            this.mIsOrphaned,
            this.mIsInitiatingPackageUninstalled,
            this.mInitiatingPackageSignatures);
  }

  public InstallSource setUpdateOwnerPackageName(String str) {
    return Objects.equals(str, this.mUpdateOwnerPackageName)
        ? this
        : createInternal(
            this.mInitiatingPackageName,
            this.mOriginatingPackageName,
  ...
  public InstallSource setInitiatingPackageSignatures(PackageSignatures packageSignatures) {
    return packageSignatures == this.mInitiatingPackageSignatures
        ? this
        : createInternal(
            this.mInitiatingPackageName,
            this.mOriginatingPackageName,
