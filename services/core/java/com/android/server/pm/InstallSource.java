...
public final class InstallSource {
    public static final InstallSource EMPTY =
            new InstallSource(-1, 0, null, null, null, null, null, null, false, false);
    public static final InstallSource EMPTY_ORPHANED =
            new InstallSource(-1, 0, null, null, null, null, null, null, true, false);
    ...
    public static InstallSource create(
        ...
        return createInternal(
                i, i2, null, intern(str), intern(str2), intern(str3), intern(str4), str5, z, z2);
    }
    ...
    public static InstallSource createInternal(
        ...
        return (str == null
                        ...
                        && !z2
                        && i2 == 0)
                ? z ? EMPTY_ORPHANED : EMPTY
                : new InstallSource(i, i2, packageSignatures, str, str2, str3, str4, str5, z, z2);
    }
