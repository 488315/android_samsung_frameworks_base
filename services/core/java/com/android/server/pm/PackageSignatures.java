...
public class PackageSignatures {
  ...
  public void writeXml(TypedXmlSerializer typedXmlSerializer, String str, ArrayList arrayList) {
    ...
    typedXmlSerializer.attributeInt(
        (String) null, "count", this.mSigningDetails.getSignatures().length);
    typedXmlSerializer.attributeInt(
        (String) null, "schemeVersion", this.mSigningDetails.getSignatureSchemeVersion());
    ...
    if (this.mSigningDetails.getPastSigningCertificates() != null) {
      ...
      typedXmlSerializer.attributeInt(
          (String) null, "count", this.mSigningDetails.getPastSigningCertificates().length);
      writeCertsListXml(
          typedXmlSerializer, arrayList, this.mSigningDetails.getPastSigningCertificates(), true);
      typedXmlSerializer.endTag((String) null, "pastSigs");
    }
    typedXmlSerializer.endTag((String) null, str);
  }

  public final void writeCertsListXml(
    ...
    for (Signature signature : signatureArr) {
      ...
      while (true) {
        ...
        if (signature2.hashCode() == hashCode && signature2.equals(signature)) {
          typedXmlSerializer.attributeInt(
              (String) null, LauncherConfigurationInternal.KEY_INDEX_INT, i);
          break;
        }
        i++;
      }
      if (i >= size) {
        ...
        typedXmlSerializer.attributeInt(
            (String) null, LauncherConfigurationInternal.KEY_INDEX_INT, size);
  ...
  public void readXml(TypedXmlPullParser typedXmlPullParser, ArrayList arrayList) {
    ...
    if (attributeInt == -1) {
      PackageManagerService.reportSettingsProblem(
          5,
          "Error in package manager settings: <sigs> has no count at "
    ...
    int readCertsListXml =
        readCertsListXml(typedXmlPullParser, arrayList, arrayList2, attributeInt, false, builder);
    builder.setSignatures((Signature[]) arrayList2.toArray(new Signature[arrayList2.size()]));
    if (readCertsListXml < attributeInt) {
      PackageManagerService.reportSettingsProblem(
          5,
          "Error in package manager settings: <sigs> count does not match number of  <cert> entries"
              + typedXmlPullParser.getPositionDescription());
    }
    try {
      ...
      PackageManagerService.reportSettingsProblem(
          5,
          "Error in package manager settings: <sigs> unable to convert certificate(s) to public"
              + " key(s).");
      this.mSigningDetails = SigningDetails.UNKNOWN;
    }
  }
  ...
  */
  public final int readCertsListXml(
    ...
    while (true) {
      ...
      if (next != 3 && next != 4) {
        ...
        if (name.equals("cert")) {
          if (i4 < i) {
            int attributeInt =
                typedXmlPullParser2.getAttributeInt(
                    (String) null, LauncherConfigurationInternal.KEY_INDEX_INT, -1);
            if (attributeInt != -1) {
              try {
                attributeBytesHex =
                    typedXmlPullParser2.getAttributeBytesHex((String) null, "key", (byte[]) null);
              } catch (NumberFormatException unused) {
                PackageManagerService.reportSettingsProblem(
                    5,
                    "Error in package manager settings: <cert> index "
                        + attributeInt
                        + " is not a number at "
                        + typedXmlPullParser.getPositionDescription());
              ...
              if (attributeBytesHex == null) {
                if (attributeInt >= 0 && attributeInt < arrayList.size()) {
                  Signature signature = (Signature) arrayList.get(attributeInt);
                  if (signature == null) {
                    PackageManagerService.reportSettingsProblem(
                        5,
                        "Error in package manager settings: <cert> index "
                ...
                if (z) {
                  int attributeInt2 =
                      typedXmlPullParser2.getAttributeInt((String) null, "flags", -1);
                  if (attributeInt2 == -1) {
                    PackageManagerService.reportSettingsProblem(
                        5,
                        "Error in package manager settings: <cert> has no flags at "
                            + typedXmlPullParser.getPositionDescription());
                  } else if (z2) {
                    try {
                      ((Signature) arrayList2.get(arrayList2.size() - 1)).setFlags(attributeInt2);
                    } catch (NumberFormatException unused2) {
                      PackageManagerService.reportSettingsProblem(
                          5,
                          "Error in package manager settings: <cert> flags "
                              + attributeInt2
                              + " is not a number at "
                              + typedXmlPullParser.getPositionDescription());
                    }
                    ...
                    PackageManagerService.reportSettingsProblem(
                        5,
                        "Error in package manager settings: signature not available at index "
                            + i4
                            + " to set flags at "
                            + typedXmlPullParser.getPositionDescription());
                  }
              ...
              PackageManagerService.reportSettingsProblem(
                  5,
                  "Error in package manager settings: <cert> has no index at "
                      + typedXmlPullParser.getPositionDescription());
            }
          } else {
            PackageManagerService.reportSettingsProblem(
                5,
                "Error in package manager settings: too many <cert> tags, expected "
                    + i
                    + " at "
                    + typedXmlPullParser.getPositionDescription());
          }
          ...
          if (!name.equals("pastSigs")) {
            i2 = i4;
            PackageManagerService.reportSettingsProblem(
                5, "Unknown element under <sigs>: " + typedXmlPullParser.getName());
            XmlUtils.skipCurrentTag(typedXmlPullParser);
          } else if (!z) {
            ...
            if (attributeInt3 == -1) {
              PackageManagerService.reportSettingsProblem(
                  5,
                  "Error in package manager settings: <pastSigs> has no count at "
                      + typedXmlPullParser.getPositionDescription());
              XmlUtils.skipCurrentTag(typedXmlPullParser);
            } else {
              try {
              ...
              try {
                int readCertsListXml =
                    readCertsListXml(
                        typedXmlPullParser, arrayList, arrayList3, attributeInt3, true, builder2);
                builder2 =
                    builder2.setPastSigningCertificates(
                        (Signature[]) arrayList3.toArray(new Signature[arrayList3.size()]));
                if (readCertsListXml < attributeInt3) {
                  PackageManagerService.reportSettingsProblem(
                      5,
                      "Error in package manager settings: <pastSigs> count does not match number of"
                          + " <cert> entries "
                          + typedXmlPullParser.getPositionDescription());
                }
                ...
                PackageManagerService.reportSettingsProblem(
                    i3,
                    "Error in package manager settings: <pastSigs> count "
                        + attributeInt3
                        + str
                        + typedXmlPullParser.getPositionDescription());
                i4 = i2;
  ...
  public String toString() {
    ...
    if (this.mSigningDetails.getPastSigningCertificates() != null) {
      for (int i2 = 0; i2 < this.mSigningDetails.getPastSigningCertificates().length; i2++) {
        ...
        sb.append(
            Integer.toHexString(this.mSigningDetails.getPastSigningCertificates()[i2].hashCode()));
        sb.append(" flags: ");
        sb.append(
            Integer.toHexString(this.mSigningDetails.getPastSigningCertificates()[i2].getFlags()));
      }
    }
    sb.append("]}");
    return sb.toString();
