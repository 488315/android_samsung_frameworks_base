...
public final class DeletePackageHelper {
  ...
  */
  public int deletePackageX(String str, long j, int i, int i2, boolean z) {
    ...
    synchronized (this.mPm.mLock) {
      ...
      if (j != -1 && packageLPr2.getVersionCode() != j) {
        Slog.w(
            "PackageManager",
            "Not removing package "
                + str
                + " with versionCode "
                + packageLPr2.getVersionCode()
                + " != "
                + j);
        return -1;
      }
      ...
      if (androidPackage2 != null) {
        if (androidPackage2.getStaticSharedLibraryName() != null) {
          sharedLibraryInfo =
              snapshotComputer.getSharedLibraryInfo(
                  androidPackage2.getStaticSharedLibraryName(),
                  androidPackage2.getStaticSharedLibraryVersion());
        } else {
          sharedLibraryInfo =
              androidPackage2.getSdkLibraryName() != null
                  ? snapshotComputer.getSharedLibraryInfo(
                      androidPackage2.getSdkLibraryName(), androidPackage2.getSdkLibVersionMajor())
                  : null;
        }
      ...
      if (PackageManagerServiceUtils.isUpdatedSystemApp(packageLPr2) && (i2 & 4) == 0) {
        ...
        while (i11 < userIds.length) {
          ...
          sparseArray2.put(
              userIds[i11],
              new TempUserState(
                  readUserState.getEnabledState(),
                  readUserState.getLastDisableAppCaller(),
                  readUserState.isInstalled()));
          i11++;
        ...
        try {
          try {
            ...
            PackageFreezer freezePackageForDelete =
                this.mPm.freezePackageForDelete(str, i3, i2, "deletePackageX", 13);
            try {
              obj = obj2;
              int[] iArr = userIds;
              int i13 = 0;
              try {
                ...
                if (deletePackageLIF && androidPackage3 != null) {
                  ...
                  this.mPm.mInstantAppRegistry.onPackageUninstalled(
                      androidPackage3, packageSetting2, packageRemovedInfo.mRemovedUsers, z4);
                }
                synchronized (this.mPm.mLock) {
                  if (deletePackageLIF) {
                    this.mPm.updateSequenceNumberLP(
                        packageSetting2, packageRemovedInfo.mRemovedUsers);
                ...
                if (deletePackageLIF) {
                  ...
                  if (packageRemovedInfo.mIsExternal) {
                    this.mPm
                        .getAsecInstallHelper()
                        .sendResourcesChangedBroadcast(
                            false,
                            false,
                            new String[] {packageRemovedInfo.mRemovedPackage},
                            new int[] {packageRemovedInfo.mUid});
                  }
                ...
                synchronized (this.mPm.mInstallLock) {
                  ...
                  if (installArgs != null) {
                    this.mRemovePackageHelper.cleanUpResources(
                        installArgs.mCodeFile, installArgs.mInstructionSets);
                  }
                  if (sparseArray != null) {
                    synchronized (this.mPm.mLock) {
                      PackageSetting packageSettingForMutation =
                          this.mPm.getPackageSettingForMutation(str);
                      if (packageSettingForMutation != null) {
                        ...
                        while (true) {
                          ...
                          iArr = iArr2;
                          packageSettingForMutation.setEnabled(
                              i14, iArr2[i13], tempUserState.lastDisableAppCaller);
                        ...
                        Slog.w(
                            "PackageManager",
                            "Missing PackageSetting after uninstalling the update for system app: "
                                + str
                  ...
                  AndroidPackageInternal pkg2 =
                      disabledSystemPkgLPr == null ? null : disabledSystemPkgLPr.getPkg();
                    ...
                    if (packageLPr != null) {
                      if (z2) {
                        if (PackageManagerService.DEBUG_COMPRESSION) {
                          Slog.i(
                              "PackageManager",
                              "Enabling system stub after removal; pkg: " + pkg2.getPackageName());
                        }
                        new InstallPackageHelper(this.mPm)
                            .enableCompressedPackage(pkg2, packageLPr);
                      } else if (PackageManagerService.DEBUG_COMPRESSION) {
                        Slog.i(
                            "PackageManager",
                            "System stub disabled for all users, leaving uncompressed after"
                                + " removal; pkg: "
                                + pkg2.getPackageName());
                      }
                    }
                ...
                if (deletePackageLIF && isInstallerPackage) {
                  this.mPm
                      ...
                      .onInstallerPackageDeleted(packageSetting2.getAppId(), i4);
                }
                if (deletePackageLIF && i == 0) {
                  Slog.d(
                      "AASA_PackageManager_RESTRICTED",
                      "Uninstall : userId = "
                          + i
                          + ", info.mRemovedAppId = "
                          + packageRemovedInfo.mRemovedAppId
                          + ", info.uid = "
                          + packageRemovedInfo.mUid
                          + ", packageName = "
                          + str);
                  try {
                ...
                if (this.mPm.getPersonaService() == null
                    || this.mPm.getPersonaService().getSeparationConfigfromCache() == null) {
                  return i5;
                }
                if ((i != 0 && i != this.mPm.getPersonaService().getAppSeparationId())
                    || !this.mPm.getPersonaService().isAppSeparationApp(str)
                    || this.mPm.getPersonaService().getAppSeparationId() == 0
                    || z5
                    || i6 != 0) {
                  return i5;
                }
                ...
                if (i == 0) {
                  return deletePackageX(
                      str, j, this.mPm.getPersonaService().getAppSeparationId(), i15, true);
                }
  ...
  public final void checkAndInstallLocaleOverlays(PackageRemovedInfo packageRemovedInfo) {
    Slog.i(
        "PackageManager",
        "CheckAndInstallLocaleOverlays() called with: packageName = ["
            + packageRemovedInfo.mRemovedPackage
            + "], isRemovedUpdate = ["
  ...
  public void overlaysInstallComplete(int i) {
    ...
    PackageRemovedInfo packageRemovedInfo =
        (PackageRemovedInfo) this.mRunningOverlayInstalls.get(i);
    this.mRunningOverlayInstalls.delete(i);
    if (packageRemovedInfo != null) {
      Slog.i(
          "PackageManager",
          "overlaysInstallComplete(): Calling sendSystemPackageUpdatedBroadcasts for package: "
              + packageRemovedInfo.mRemovedPackage);
      packageRemovedInfo.sendSystemPackageUpdatedBroadcasts();
    }
  }

  public boolean deletePackageLIF(
      String str,
    ...
    synchronized (this.mPm.mLock) {
      ...
      mayDeletePackageLocked =
          mayDeletePackageLocked(
              packageRemovedInfo,
              packageLPr,
              this.mPm.mSettings.getDisabledSystemPkgLPr(packageLPr),
              i,
              userHandle);
    }
  ...
  public static DeletePackageAction mayDeletePackageLocked(
    ...
    if (PackageManagerServiceUtils.isSystemApp(packageSetting)) {
      ...
      if ((!z2 || z) && packageSetting2 == null) {
        Slog.w(
            "PackageManager",
            "Attempt to delete unknown system package " + packageSetting.getPkg().getPackageName());
        return null;
      }
    }
    return new DeletePackageAction(
        packageSetting, packageSetting2, packageRemovedInfo, i, userHandle);
  }

  public void executeDeletePackage(
      DeletePackageAction deletePackageAction, String str, boolean z, int[] iArr, boolean z2) {
    synchronized (this.mPm.mInstallLock) {
      executeDeletePackageLIF(deletePackageAction, str, z, iArr, z2);
    }
  }

  public final void executeDeletePackageLIF(
      DeletePackageAction deletePackageAction, String str, boolean z, int[] iArr, boolean z2) {
    boolean z3;
    boolean z4;
    ...
    for (int i2 : iArr) {
      sparseBooleanArray.put(
          i2, this.mPm.checkPermission("android.permission.SUSPEND_APPS", str, i2) == 0);
    }
    ...
    if ((isSystemApp && (i & 4) == 0) || identifier == -1) {
      ...
      synchronized (this.mPm.mLock) {
        ...
        if (!isSystemApp) {
          ...
          if (!packageSetting.isAnyInstalled(this.mUserManagerInternal.getUserIds())
              && !shouldKeepUninstalledPackageLPr) {
            if (z
                && AsecInstallHelper.isExternal(packageSetting)
                && !this.mPm.getAsecInstallHelper().shouldAddDexOptOnAsec()) {
    ...
    if (isSystemApp) {
      ...
      new InstallPackageHelper(this.mPm)
          .restoreDisabledSystemPackageLIF(deletePackageAction, iArr, z2);
    } else {
    ...
    if (packageRemovedInfo != null) {
      synchronized (this.mPm.mLock) {
        packageRemovedInfo.mRemovedForAllUsers =
            this.mPm.mPackages.get(packageSetting.getPackageName()) == null ? z3 : false;
      }
    }
  }

  public final void clearPackageStateForUserLIF(
      PackageSetting packageSetting, int i, PackageRemovedInfo packageRemovedInfo, int i2) {
    AndroidPackage androidPackage;
    ...
    List packages =
        sharedUserSettingLPr != null ? sharedUserSettingLPr.getPackages() : Collections.emptyList();
  ...
  public final void deleteInstalledPackageLIF(
      PackageSetting packageSetting,
      boolean z,
      int i,
      int[] iArr,
    ...
    synchronized (this.mPm.mLock) {
      if (packageRemovedInfo != null) {
        ...
        packageRemovedInfo.mBroadcastAllowList =
            packageManagerService.mAppsFilter.getVisibilityAllowList(
                packageManagerService.snapshotComputer(),
                packageSetting,
                iArr,
                this.mPm.mSettings.getPackagesLocked());
      }
    }
    ...
    packageRemovedInfo.mArgs =
        new InstallArgs(
            packageSetting.getPathString(),
            InstructionSets.getAppDexInstructionSets(
                packageSetting.getPrimaryCpuAbiLegacy(),
                packageSetting.getSecondaryCpuAbiLegacy()));
  }

  public final void markPackageUninstalledForUserLPw(
      PackageSetting packageSetting, UserHandle userHandle) {
    int[] userIds;
    if (userHandle == null || userHandle.getIdentifier() == -1) {
    ...
    for (int i : userIds) {
      packageSetting.setUserState(
          i, 0L, 0, false, true, true, false, 0, null, false, false, null, null, null, 0, 0, null,
          null, 0L);
    }
    this.mPm.mSettings.writeKernelMappingLPr(packageSetting);
  }

  public final void deleteInstalledSystemPackage(
      DeletePackageAction deletePackageAction, int[] iArr, boolean z) {
    int i = deletePackageAction.mFlags;
    PackageSetting packageSetting = deletePackageAction.mDeletingPs;
    PackageRemovedInfo packageRemovedInfo = deletePackageAction.mRemovedInfo;
    if (packageRemovedInfo != null) {
    ...
    int i2 =
        (packageSetting2.getVersionCode() < packageSetting.getVersionCode()
                || packageSetting2.getAppId() != packageSetting.getAppId())
            ? i & (-2)
            : i | 1;
    synchronized (this.mPm.mInstallLock) {
  ...
  public void deletePackageVersionedInternal(
      VersionedPackage versionedPackage,
      final IPackageDeleteObserver2 iPackageDeleteObserver2,
      final int i,
      final int i2,
      boolean z) {
    int[] iArr;
    ...
    Preconditions.checkArgumentInRange(
        versionedPackage.getLongVersionCode(), -1L, Long.MAX_VALUE, "versionCode must be >= -1");
    ...
    if (SemSamsungThemeUtils.isThemeCenter(packageName) && i == 0) {
      this.mPm.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              DeletePackageHelper.lambda$deletePackageVersionedInternal$0(
                  packageName, callingUid, iPackageDeleteObserver2);
            }
          });
      return;
    }
    if (this.mPm.mProtectedPackages.isPackageDataProtected(i, packageName)) {
      this.mPm.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              DeletePackageHelper.lambda$deletePackageVersionedInternal$1(
                  packageName, iPackageDeleteObserver2);
            }
          });
      return;
    }
    if (this.mPm.isRequiredSystemPackage(snapshotComputer, packageName, i)) {
      if (!(this.mPm.mSettings.getDisabledSystemPkgLPr(packageName) != null) || (i2 & 4) != 0) {
        this.mPm.mHandler.post(
            new Runnable() { // from class:
              // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
                DeletePackageHelper.lambda$deletePackageVersionedInternal$2(
                    packageName, callingUid, iPackageDeleteObserver2);
              }
            });
        return;
    ...
    try {
      if (((ActivityTaskManagerInternal)
              this.mPm.mInjector.getLocalService(ActivityTaskManagerInternal.class))
    ...
    final String resolveInternalPackageName =
        snapshotComputer.resolveInternalPackageName(packageName, longVersionCode);
    int callingUid2 = Binder.getCallingUid();
    if (!isOrphaned(snapshotComputer, resolveInternalPackageName)
        && !z
        && !isCallerAllowedToSilentlyUninstall(
            snapshotComputer, callingUid2, resolveInternalPackageName, i)) {
      this.mPm.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              DeletePackageHelper.lambda$deletePackageVersionedInternal$3(
                  packageName, iPackageDeleteObserver2);
            }
          });
      return;
    ...
    if (UserHandle.getUserId(callingUid2) != i || (z2 && userIds.length > 1)) {
      ...
      context.enforceCallingOrSelfPermission(
          "android.permission.INTERACT_ACROSS_USERS_FULL", sb.toString());
    } else {
      iArr = userIds;
    }
    if (this.mPm.isUserRestricted(i, "no_uninstall_apps")) {
      this.mPm.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
              DeletePackageHelper.lambda$deletePackageVersionedInternal$4(
                  iPackageDeleteObserver2, packageName);
            }
          });
      return;
    }
    if (!z2 && snapshotComputer.getBlockUninstallForUser(resolveInternalPackageName, i)) {
      this.mPm.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
              DeletePackageHelper.lambda$deletePackageVersionedInternal$5(
                  iPackageDeleteObserver2, packageName);
            }
          });
      return;
    ...
    sb2.append(
        iPackageDeleteObserver2 != null
            ? Integer.valueOf(iPackageDeleteObserver2.hashCode())
            : "null");
    sb2.append("}\npkg{");
    ...
    this.mPm.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
          public final void run() {
            DeletePackageHelper.this.lambda$deletePackageVersionedInternal$6(
  ...
  public static /* synthetic */ void lambda$deletePackageVersionedInternal$0(
      String str, int i, IPackageDeleteObserver2 iPackageDeleteObserver2) {
    try {
      Slog.w(
          "PackageManager",
          "Attempted to delete "
              ...
              + i
              + ", observer.hashCode(): "
              + iPackageDeleteObserver2.hashCode());
      iPackageDeleteObserver2.onPackageDeleted(str, -1, (String) null);
    } catch (RemoteException unused) {
    }
  }

  public static /* synthetic */ void lambda$deletePackageVersionedInternal$1(
      String str, IPackageDeleteObserver2 iPackageDeleteObserver2) {
    try {
  ...
  public static /* synthetic */ void lambda$deletePackageVersionedInternal$2(
      String str, int i, IPackageDeleteObserver2 iPackageDeleteObserver2) {
    try {
      PmLog.logDebugInfoAndLogcat(
          "Attempted to delete system required package: " + str + " callingUid: " + i);
      iPackageDeleteObserver2.onPackageDeleted(str, -1, (String) null);
    } catch (RemoteException unused) {
    }
  }

  public static /* synthetic */ void lambda$deletePackageVersionedInternal$3(
      String str, IPackageDeleteObserver2 iPackageDeleteObserver2) {
    try {
  ...
  public static /* synthetic */ void lambda$deletePackageVersionedInternal$4(
      IPackageDeleteObserver2 iPackageDeleteObserver2, String str) {
    try {
  ...
  public static /* synthetic */ void lambda$deletePackageVersionedInternal$5(
      IPackageDeleteObserver2 iPackageDeleteObserver2, String str) {
    try {
  ...
  public /* synthetic */ void lambda$deletePackageVersionedInternal$6(
      String str,
      int i,
      boolean z,
      boolean z2,
      ...
      if (!z2) {
        ...
        if (i4 == 1 && packageStateInternal != null) {
          ...
          while (i10 < length) {
            ...
            if (i11 != i2
                && this.mUserManagerInternal.getProfileParentId(i11) == i2
                && packageStateInternal.getUserStateOrDefault(i11).isInstalled()
                && (userProperties = this.mUserManagerInternal.getUserProperties(i11)) != null
                && userProperties.getDeleteAppWithParent()) {
              i7 = i10;
              i8 = length;
    ...
    try {
      PmLog.logDebugInfoAndLogcat(
          "result of delete: " + i4 + "{" + iPackageDeleteObserver2.hashCode() + "}");
  ...
  public final boolean isCallerAllowedToSilentlyUninstall(
      final Computer computer, int i, String str, int i2) {
    ...
    return (str4 != null && i == computer.getPackageUid(str4, 0L, userId))
        || this.mSilentUninstallerList.isCallerAllowedSilentlyInstall(
            i,
            new Function() { // from class:
              // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda8
              @Override // java.util.function.Function
              public final Object apply(Object obj) {
                Integer lambda$isCallerAllowedToSilentlyUninstall$7;
                lambda$isCallerAllowedToSilentlyUninstall$7 =
                    DeletePackageHelper.lambda$isCallerAllowedToSilentlyUninstall$7(
                        Computer.this, userId, (String) obj);
                return lambda$isCallerAllowedToSilentlyUninstall$7;
              }
            })
        || computer.checkUidPermission("android.permission.MANAGE_PROFILE_AND_DEVICE_OWNERS", i)
            == 0;
  }

  public static /* synthetic */ Integer lambda$isCallerAllowedToSilentlyUninstall$7(
      Computer computer, int i, String str) {
  ...
  public void removeUnusedPackagesLPw(UserManagerService userManagerService, final int i) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      PackageSetting packageSetting =
          (PackageSetting) this.mPm.mSettings.getPackagesLocked().valueAt(i2);
      if (packageSetting.getPkg() != null) {
        final String packageName = packageSetting.getPkg().getPackageName();
        boolean z = true;
        if ((packageSetting.getFlags() & 1) == 0
            && TextUtils.isEmpty(packageSetting.getPkg().getStaticSharedLibraryName())
            && TextUtils.isEmpty(packageSetting.getPkg().getSdkLibraryName())) {
          boolean shouldKeepUninstalledPackageLPr =
              this.mPm.shouldKeepUninstalledPackageLPr(packageName);
          ...
          if (!z) {
            this.mPm.mHandler.post(
                new Runnable() { // from class:
                  // com.android.server.pm.DeletePackageHelper$$ExternalSyntheticLambda7
                  @Override // java.lang.Runnable
                  public final void run() {
    ...
    synchronized (this.mPm.mLock) {
      PackageSetting packageLPr =
          this.mPm.mSettings.getPackageLPr(
              this.mPm.snapshotComputer().resolveInternalPackageName(packageName, longVersionCode));
      length =
          packageLPr != null
              ? packageLPr.queryInstalledUsers(this.mUserManagerInternal.getUserIds(), true).length
              : 0;
    }
    if (length > 1) {
