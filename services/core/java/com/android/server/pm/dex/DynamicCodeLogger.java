    ...
    */
    public void logDynamicCodeLoading(String str) {
        ...
        for (Map.Entry entry : packageDynamicCodeInfo.mFileUsageMap.entrySet()) {
            ...
            PackageDynamicCodeLoading.DynamicCodeFile dynamicCodeFile = (PackageDynamicCodeLoading.DynamicCodeFile) entry.getValue();
            ...
            if (applicationInfo3 == null) {
                ...
                try {
                    ...
                    try {
                        bArr2 = this.mInstaller.hashSecondaryDexFile(str3, str, applicationInfo3.uid, applicationInfo3.volumeUuid, i);
                    } catch (Installer.InstallerException e) {
                        e = e;
                        Slog.e(str2, "Got InstallerException when hashing file " + str3 + ": " + e.getMessage());
                        bArr = bArr2;
                        if (dynamicCodeFile.mFileType != 'D') {
                        }
                        String computeSha256Digest = PackageUtils.computeSha256Digest(new File(str3).getName().getBytes());
                        if (bArr == null) {
                        }
                ...
                String computeSha256Digest2 = PackageUtils.computeSha256Digest(new File(str3).getName().getBytes());
