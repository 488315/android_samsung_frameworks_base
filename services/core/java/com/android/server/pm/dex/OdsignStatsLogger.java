    ...
    BackgroundThread.getExecutor()
        .execute(
            new Runnable() { // from class:
                             // com.android.server.pm.dex.OdsignStatsLogger$$ExternalSyntheticLambda0
  ...
  public static void writeStats() {
    ...
    try {
      String readFileAsString =
          IoUtils.readFileAsString("/data/misc/odsign/metrics/odsign-metrics.txt");
          ...
          if (hashCode != 890271774) {
            if (hashCode == 1023928721 && str2.equals("comp_os_artifacts_check_record")) {
              ...
              if (c == 0) {
                ...
                ArtStatsLog.write(
                    419, split[1].equals("1"), split[2].equals("1"), split[3].equals("1"));
              }
            }
            c = 65535;
            if (c == 0) {}
