...
public class ArtManagerService extends IArtManager.Stub {
  ...
  public final boolean checkAndroidPermissions(int i, String str) {
    ...
    int noteOp =
        ((AppOpsManager) this.mContext.getSystemService(AppOpsManager.class)).noteOp(43, i, str);
    if (noteOp != 0) {
      if (noteOp != 3) {
        return false;
      }
  ...
  public void snapshotRuntimeProfile(
      ...
      String str,
      String str2,
      ISnapshotRuntimeProfileCallback iSnapshotRuntimeProfileCallback,
      String str3) {
    ...
    if (DEBUG) {
      Slog.d(
          "ArtManagerService",
          "Requested snapshot for " + str + XmlUtils.STRING_ARRAY_SEPARATOR + str2);
    }
    if (z) {
  ...
  public final void snapshotAppProfile(
      String str, String str2, ISnapshotRuntimeProfileCallback iSnapshotRuntimeProfileCallback) {
    PackageInfo packageInfo;
    String str3 = null;
    try {
      packageInfo = getPackageManager().getPackageInfo(str, 0L, 0);
    ...
    if (DexOptHelper.useArtService()) {
      try {
        try {
          ...
          try {
            ParcelFileDescriptor snapshotAppProfile =
                DexOptHelper.getArtManagerLocal()
                    .snapshotAppProfile(withFilteredSnapshot, str, str3);
    ...
    try {
      createProfileSnapshot(
          str, ArtManager.getProfileName(str3), str2, appId, iSnapshotRuntimeProfileCallback);
  ...
  public final void createProfileSnapshot(
      String str,
      String str2,
      String str3,
      int i,
    ...
    try {
      ...
      try {
        ParcelFileDescriptor open =
            ParcelFileDescriptor.open(profileSnapshotFileForName, 268435456);
        ...
        Slog.w(
            "ArtManagerService",
            "Could not open snapshot profile for "
                + str
                + XmlUtils.STRING_ARRAY_SEPARATOR
                + profileSnapshotFileForName,
            e);
        postError(iSnapshotRuntimeProfileCallback, str, 2);
      }
  ...
  public final void destroyProfileSnapshot(String str, String str2) {
    if (DEBUG) {
      Slog.d(
          "ArtManagerService",
          "Destroying profile snapshot for" + str + XmlUtils.STRING_ARRAY_SEPARATOR + str2);
    }
    try {
      ...
      Slog.e(
          "ArtManagerService",
          "Failed to destroy profile snapshot for " + str + XmlUtils.STRING_ARRAY_SEPARATOR + str2,
          e);
    }
  }
  ...
  public final void snapshotBootImageProfile(
      ISnapshotRuntimeProfileCallback iSnapshotRuntimeProfileCallback) {
    if (DexOptHelper.useArtService()) {
      try {
        PackageManagerLocal.FilteredSnapshot withFilteredSnapshot =
            PackageManagerServiceUtils.getPackageManagerLocal().withFilteredSnapshot();
        try {
          ParcelFileDescriptor snapshotBootImageProfile =
              DexOptHelper.getArtManagerLocal().snapshotBootImageProfile(withFilteredSnapshot);
          if (withFilteredSnapshot != null) {
            withFilteredSnapshot.close();
          }
  ...
  public static /* synthetic */ void lambda$postError$0(
      ISnapshotRuntimeProfileCallback iSnapshotRuntimeProfileCallback, int i, String str) {
    try {
  ...
  public final void postSuccess(
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          ...
          @Override // java.lang.Runnable
          public final void run() {
            ArtManagerService.lambda$postSuccess$1(
                parcelFileDescriptor, iSnapshotRuntimeProfileCallback, str);
          }
        });
  }

  public static /* synthetic */ void lambda$postSuccess$1(
    ...
    try {
      try {
        if (parcelFileDescriptor.getFileDescriptor().valid()) {
          ...
          Slog.wtf(
              "ArtManagerService",
              "The snapshot FD became invalid before posting the result for " + str);
          iSnapshotRuntimeProfileCallback.onError(2);
        }
      } catch (RemoteException | RuntimeException e) {
        Slog.w(
            "ArtManagerService", "Failed to call onSuccess after profile snapshot for " + str, e);
      }
    } finally {
  ...
  public void prepareAppProfiles(AndroidPackage androidPackage, int i, boolean z) {
    ...
    try {
      ...
      for (int size = packageProfileNames.size() - 1; size >= 0; size--) {
        ...
        String str3 = null;
        if (z
            && (findDexMetadataForFile = DexMetadataHelper.findDexMetadataForFile(new File(str)))
                != null) {
          str3 = findDexMetadataForFile.getAbsolutePath();
        }
        String str4 = str3;
        synchronized (this.mInstaller) {
          if (!this.mInstaller.prepareAppProfile(
              androidPackage.getPackageName(), i, appId, str2, str, str4)) {
            Slog.e(
                "ArtManagerService",
      ...
      Slog.e(
          "ArtManagerService",
          "Failed to prepare profile for " + androidPackage.getPackageName(),
          e);
    }
  }
  ...
  public void clearAppProfiles(AndroidPackage androidPackage) {
    try {
      ArrayMap packageProfileNames = getPackageProfileNames(androidPackage);
      for (int size = packageProfileNames.size() - 1; size >= 0; size--) {
        this.mInstaller.clearAppProfiles(
            androidPackage.getPackageName(), (String) packageProfileNames.valueAt(size));
      }
    } catch (Installer.InstallerException e) {
  ...
  public void dumpProfiles(AndroidPackage androidPackage, boolean z) {
    ...
    try {
      ArrayMap packageProfileNames = getPackageProfileNames(androidPackage);
      for (int size = packageProfileNames.size() - 1; size >= 0; size--) {
        this.mInstaller.dumpProfiles(
            sharedAppGid,
            androidPackage.getPackageName(),
            (String) packageProfileNames.valueAt(size),
            (String) packageProfileNames.keyAt(size),
            z);
      }
    } catch (Installer.InstallerException e) {
  ...
  public boolean compileLayouts(PackageState packageState, AndroidPackage androidPackage) {
    try {
      ...
      String str =
          PackageInfoUtils.getDataDir(androidPackage, UserHandle.myUserId()).getAbsolutePath()
              + "/code_cache/compiled_view.dex";
      if (!packageState.isPrivileged()
          && !androidPackage.isUseEmbeddedDex()
          && !androidPackage.isDefaultToDeviceProtectedStorage()) {
        Log.i(
            "PackageManager", "Compiling layouts in " + packageName + " (" + path + ") to " + str);
  ...
  public static void verifyTronLoggingConstants() {
    ...
    throw new IllegalArgumentException(
        "Compilation reason not configured for TRON logging: " + str);
  }
      ...
      try {
        DexFile.OptimizationInfo dexFileOptimizationInfo =
            DexFile.getDexFileOptimizationInfo(
                applicationInfo.getBaseCodePath(), VMRuntime.getInstructionSet(str));
        String status = dexFileOptimizationInfo.getStatus();
        str3 = dexFileOptimizationInfo.getReason();
        str4 = status;
      } catch (FileNotFoundException e) {
        Slog.e(
            "ArtManagerInternalImpl",
            "Could not get optimizations status for " + applicationInfo.getBaseCodePath(),
            e);
        str3 = "error";
        if (checkIorapCompiledTrace(
            applicationInfo.packageName, str2, applicationInfo.longVersionCode)) {}
        return new PackageOptimizationInfo(
            ArtManagerService.getCompilationFilterTronValue(str4),
            ArtManagerService.getCompilationReasonTronValue(str3));
      } catch (IllegalArgumentException e2) {
        Slog.wtf(
            "ArtManagerInternalImpl",
            "Requested optimization status for "
                + applicationInfo.getBaseCodePath()
                + " due to an invalid abi "
                + str,
            e2);
        str3 = "error";
        if (checkIorapCompiledTrace(
