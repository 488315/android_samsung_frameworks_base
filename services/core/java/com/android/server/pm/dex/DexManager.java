...
public class DexManager {
    ...
    */
    public void notifyDexLoadInternal(ApplicationInfo applicationInfo, Map map, String str, int i, boolean z) {
        if (map == null) {
            return;
        }
        if (map.isEmpty()) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            if (dexPackage.mOutcome != DEX_SEARCH_NOT_FOUND) {
                ...
                if (!z5 || z4 || isPlatformPackage(dexPackage.mOwningPackageName)) {
                    ...
                    if (str5 != null && VMRuntime.isValidClassLoaderContext(str5) && this.mPackageDexUsage.record(dexPackage.mOwningPackageName, str4, i, str, z5, str3, str5, isPlatformPackage)) {
