    ...
    public final int runSetSystemUserModeEmulation() {
        ...
        while (true) {
            ...
            if (nextOption == null) {
                ...
                Slogf.m88d("UserManagerServiceShellCommand", "Updating system property %s to %s", "persist.debug.user_mode_emulation", nextArgRequired);
                ...
                if (z3) {
                    ...
                    Slogf.m96i("UserManagerServiceShellCommand", "Restarting Android runtime(PID=%d) to finalize changes", Integer.valueOf(myPid));
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                if (!z) {
                    ...
                    outPrintWriter.printf("effective=%b real=%b\n", Boolean.valueOf(isVisibleBackgroundUsersEnabled), Boolean.valueOf(Resources.getSystem().getBoolean(R.bool.config_letterboxIsAutomaticReachabilityInBookModeEnabled)));
                }
                return 0;
            }
        }
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                if (!z) {
                    ...
                    outPrintWriter.printf("effective=%b real=%b\n", Boolean.valueOf(isVisibleBackgroundUsersOnDefaultDisplayEnabled), Boolean.valueOf(Resources.getSystem().getBoolean(R.bool.config_letterboxIsDisplayAspectRatioForFixedOrientationLetterboxEnabled)));
                }
                return 0;
            }
        }
