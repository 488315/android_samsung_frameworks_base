...
public class UserManagerServiceShellCommand extends ShellCommand {
  ...
  public void onHelp() {
    ...
    outPrintWriter.println();
    outPrintWriter.println(
        "  report-system-user-package-whitelist-problems [-v | --verbose] [--critical-only] [--mode"
            + " MODE]");
    outPrintWriter.println(
    ...
    outPrintWriter.println(
        "    Checks whether the device allows users to be start visible on background in the"
            + " default display.");
          ...
          if (z3) {
            ...
            if (devicePolicyManagerInternal != null) {
              ...
              try {
                ...
                str2 =
                    devicePolicyManagerInternal.getProfileOwnerAsUser(i5) != null
                        ? " (profile-owner)"
                        : "";
              } finally {
      ...
      if (nextOption != null) {
        ...
        Slog.d(
            ...
            "runReportPackageAllowlistProblems(): verbose="
                ...
                + z2
                + ", mode="
                + UserSystemPackageInstaller.modeToString(i));
    ...
    while (true) {
      ...
      if (nextOption == null) {
        ...
        if (z3) {
          ...
          UiThread.getHandler()
              .post(
                  new Runnable() { // from class:
                    // com.android.server.pm.UserManagerServiceShellCommand$$ExternalSyntheticLambda0
          ...
          outPrintWriter.println(
              "The restart may trigger a 'Broken pipe' message; this is to be expected.");
          outPrintWriter.flush();
          Process.killProcess(myPid);
        } else {
          outPrintWriter.println(
              "System user mode changed - please reboot (or restart Android runtime) to continue");
          outPrintWriter.println(
              "NOTICE: after restart, some apps might be uninstalled (and their data will be"
                  + " lost)");
        }
        return 0;
      }
  ...
  */
  public final int runIsUserVisible() {
    ...
    while (true) {
      ...
      if (nextOption != null) {
        ...
        outPrintWriter.printf(
            "invalid value (%d) for --user option\n", Integer.valueOf(parseUserArg));
        return -1;
      }
    }
  }
      ...
      if (nextOption != null) {
        ...
        if (!z) {
          ...
          outPrintWriter.printf(
              ...
              Boolean.valueOf(RoSystemProperties.MULTIUSER_HEADLESS_SYSTEM_USER));
        }
        return 0;
      }
    }
    ...
    while (true) {
      ...
      if (nextOption != null) {
        ...
        if (!z) {
          ...
          outPrintWriter.printf(
              "effective=%b real=%b\n",
              Boolean.valueOf(isVisibleBackgroundUsersOnDefaultDisplayEnabled),
              Boolean.valueOf(
                  Resources.getSystem()
                      .getBoolean(
                          R.bool
  ...
  public final UserManager getUserManagerForUser(int i) {
    return (UserManager)
        this.mContext.createContextAsUser(UserHandle.of(i), 0).getSystemService(UserManager.class);
  }
