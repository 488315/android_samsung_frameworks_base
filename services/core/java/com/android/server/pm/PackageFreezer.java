...
public final class PackageFreezer implements AutoCloseable {
  ...
  public PackageFreezer(
      String str, int i, String str2, PackageManagerService packageManagerService, int i2) {
    ...
    synchronized (packageManagerService.mLock) {
      packageManagerService.mFrozenPackages.put(
          str,
          Integer.valueOf(
              ((Integer) packageManagerService.mFrozenPackages.getOrDefault(str, 0)).intValue()
                  + 1));
      packageLPr = packageManagerService.mSettings.getPackageLPr(str);
    }
    if (packageLPr != null) {
      packageManagerService.killApplication(
          packageLPr.getPackageName(), packageLPr.getAppId(), i, str2, i2);
    }
    closeGuard.open("close");
  }
  ...
  public void close() {
    ...
    if (this.mClosed.compareAndSet(false, true)) {
      synchronized (this.mPm.mLock) {
        int intValue =
            ((Integer) this.mPm.mFrozenPackages.getOrDefault(this.mPackageName, 0)).intValue() - 1;
        if (intValue > 0) {
