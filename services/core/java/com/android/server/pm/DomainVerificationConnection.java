...
public final class DomainVerificationConnection
    implements DomainVerificationManagerInternal.Connection,
        DomainVerificationProxyV1.Connection,
  ...
  public DomainVerificationConnection(PackageManagerService packageManagerService) {
    ...
    this.mUmInternal =
        (UserManagerInternal)
            packageManagerService.mInjector.getLocalService(UserManagerInternal.class);
  }
