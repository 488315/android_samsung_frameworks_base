            ...
            if (!TextUtils.isEmpty(str13)) {
                ...
                if (arrayList4.size() > 0 && !isAdbVerificationEnabled(packageInfoLite, identifier, true)) {
                    ...
                    while (true) {
                        ...
                        if (!snapshotComputer.isApplicationEffectivelyEnabled((String) arrayList.get(size), userHandle)) {
                            Slog.w("PackageManager", "Required verifier: " + ((String) arrayList.get(size)) + " is disabled");
                    ...
                    while (true) {
                        ...
                        packageVerificationState.addRequiredVerifierUid(snapshotComputer.getPackageUid((String) it.next(), 268435456L, i2));
                        identifier = i2;
                    }
                    int i5 = i2;
                    ...
                    intent2.addFlags(1);
                    ParceledListSlice queryIntentReceivers = this.mPm.queryIntentReceivers(snapshotComputer, intent2, "application/vnd.android.package-archive", 0L, i5);
                    ...
                    boolean z4 = this.mDataLoaderType == 2 && this.mSigningDetails.getSignatureSchemeVersion() == 4 && getDefaultVerificationResponse() == 1;
                    long verificationTimeout = VerificationUtils.getVerificationTimeout(this.mPm.mContext, z4);
                    String str20 = "android.content.pm.extra.DATA_LOADER_TYPE";
                    String str21 = str2;
                    long verificationTimeoutSamsung = VerificationUtils.getVerificationTimeoutSamsung(this.mPm.mContext, z4);
                    ...
                    List matchVerifiers = matchVerifiers(packageInfoLite, queryIntentReceivers.getList(), packageVerificationState);
                    if (packageInfoLite.isSdkLibrary) {
                        if (matchVerifiers == null) {
                            matchVerifiers = new ArrayList();
                        }
                        matchVerifiers.add(new ComponentName("android", "com.android.server.sdksandbox.SdkSandboxVerifierReceiver"));
                    ...
                    if (matchVerifiers != null) {
                        ...
                        if (size2 == 0) {
                            ...
                            while (i6 < size2) {
                                ...
                                deviceIdleInternal.addPowerSaveTempWhitelistApp(Process.myUid(), componentName.getPackageName(), j, i5, false, 305, "package verifier");
                    ...
                    for (String str22 : arrayList) {
                        ...
                        if (z) {
                            ...
                            if (arrayList.size() == 1) {
                                ...
                                intent4.addFlags(32);
                                intent4.setDataAndType(Uri.fromFile(new File(this.mOriginInfo.mResolvedPath)), str16);
                                ...
                                intent = intent4;
                                str6 = null;
                                deviceIdleInternal.addPowerSaveTempWhitelistApp(Process.myUid(), str22, j, i5, false, 305, "package verifier");
                                PackageVerificationResponse packageVerificationResponse2 = new PackageVerificationResponse(i7, packageUid);
                                if (z2) {
                                    str7 = str4;
                                    str8 = str15;
                                    str9 = str16;
                                ...
                                Slog.d(str, "Sending PACKAGE_NEEDS_VERIFICATION to " + str22 + ", vid: " + i3 + ", sid: " + this.mSessionId);
                                final boolean z5 = z3;
                                final PackageVerificationResponse packageVerificationResponse3 = packageVerificationResponse;
                                final long j3 = j;
                                this.mPm.mContext.sendOrderedBroadcastAsUser(intent, userHandle, str6, -1, makeBasic.toBundle(), new BroadcastReceiver() { // from class: com.android.server.pm.VerifyingSession.2
                                    @Override // android.content.BroadcastReceiver
                                    public void onReceive(Context context, Intent intent5) {
                                        ...
                                        VerifyingSession.this.startVerificationTimeoutCountdown(i, z6, packageVerificationResponse3, j3);
                                    }
                                }, null, 0, null, null);
                                i5 = i5;
                                str = str;
                        ...
                        if (!z) {
                            intent5.setComponent(matchComponentForVerifier(str22, queryIntentReceivers.getList()));
                        } else {
                        ...
                        deviceIdleInternal.addPowerSaveTempWhitelistApp(Process.myUid(), str22, j, i5, false, 305, "package verifier");
                        PackageVerificationResponse packageVerificationResponse22 = new PackageVerificationResponse(i7, packageUid);
                        if (z2) {
                        }
                        Slog.d(str, "Sending PACKAGE_NEEDS_VERIFICATION to " + str22 + ", vid: " + i3 + ", sid: " + this.mSessionId);
                        final boolean z52 = z3;
                        final PackageVerificationResponse packageVerificationResponse32 = packageVerificationResponse;
                        final long j32 = j;
                        this.mPm.mContext.sendOrderedBroadcastAsUser(intent, userHandle, str6, -1, makeBasic.toBundle(), new BroadcastReceiver() { // from class: com.android.server.pm.VerifyingSession.2
                            @Override // android.content.BroadcastReceiver
                            public void onReceive(Context context, Intent intent52) {
                                ...
                                VerifyingSession.this.startVerificationTimeoutCountdown(i, z6, packageVerificationResponse32, j32);
                            }
                        }, null, 0, null, null);
                        i5 = i5;
                        str = str;
