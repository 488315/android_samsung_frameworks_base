...
public class UserJourneyLogger {
  ...
  public UserJourneySession finishAndClearIncompleteUserJourney(int i, int i2) {
    synchronized (this.mLock) {
      ...
      logUserLifecycleJourneyReported(
          userJourneySession, i2, -1, i, getUserTypeForStatsd(""), -1, 2);
  ...
  public UserJourneySession logUserJourneyFinishWithError(
  ...
  public UserJourneySession logDelayedUserJourneyFinishWithError(
      int i, UserInfo userInfo, int i2, int i3) {
    synchronized (this.mLock) {
      int userJourneyKey = getUserJourneyKey(userInfo.id, i2);
      UserJourneySession userJourneySession =
