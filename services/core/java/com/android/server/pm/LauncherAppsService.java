...
public class LauncherAppsService extends SystemService {
  public static final Set WM_TRACE_FILE_PERMISSIONS =
      Set.of(
  ...
  public abstract class LauncherAppsServiceInternal {
    public abstract boolean startShortcut(
        int i,
        int i2,
        String str,
        String str2,
  ...
  class LauncherAppsImpl extends ILauncherApps.Stub {
    ...
    public void addOnAppsChangedListener(
        String str, IOnAppsChangedListener iOnAppsChangedListener) {
      ...
      synchronized (this.mListeners) {
        ...
        this.mListeners.register(
            iOnAppsChangedListener,
            new BroadcastCookie(
                UserHandle.of(getCallingUserId()),
                str,
                injectBinderCallingPid(),
                injectBinderCallingUid()));
        Date date = new Date(System.currentTimeMillis());
        this.mRegisteredListenersForDump.put(
            iOnAppsChangedListener,
            "Package: "
                + str
                + " Pid: "
    ...
    public void registerPackageInstallerCallback(
        String str, IPackageInstallerCallback iPackageInstallerCallback) {
      verifyCallingPackage(str);
      ...
      getPackageInstallerService()
          .registerCallback(
              ...
              new IntPredicate() { // from class:
                // com.android.server.pm.LauncherAppsService$LauncherAppsImpl$$ExternalSyntheticLambda2
                @Override // java.util.function.IntPredicate
                public final boolean test(int i) {
                  boolean lambda$registerPackageInstallerCallback$0;
                  lambda$registerPackageInstallerCallback$0 =
                      LauncherAppsService.LauncherAppsImpl.this
                          .lambda$registerPackageInstallerCallback$0(userHandle, i);
    ...
    public /* synthetic */ boolean lambda$registerPackageInstallerCallback$0(
        UserHandle userHandle, int i) {
      ...
      try {
        ...
        arrayList.removeIf(
            new Predicate() { // from class:
              // com.android.server.pm.LauncherAppsService$LauncherAppsImpl$$ExternalSyntheticLambda4
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$getAllSessions$1;
                lambda$getAllSessions$1 =
                    LauncherAppsService.LauncherAppsImpl.this.lambda$getAllSessions$1(
                        callingUid, (PackageInstaller.SessionInfo) obj);
    ...
    public final boolean lambda$getAllSessions$1(int i, PackageInstaller.SessionInfo sessionInfo) {
      return (sessionInfo == null
              ...
              || this.mPackageManagerInternal.canQueryPackage(i, sessionInfo.getAppPackageName()))
          ? false
          : true;
    }
    ...
    public final void startWatchingPackageBroadcasts() {
      ...
      this.mContext.registerReceiverAsUser(
          this.mPackageRemovedListener, UserHandle.ALL, intentFilter, null, this.mCallbackHandler);
    ...
    public final boolean canAccessProfile(int i, String str) {
      return canAccessProfile(
          injectBinderCallingUid(), injectCallingUserId(), injectBinderCallingPid(), i, str);
    }
    ...
    public final boolean canAccessProfile(int i, int i2, int i3, int i4, String str) {
      ...
      try {
        ...
        if (userInfo != null && userInfo.isProfile()) {
          Slog.w(
              "LauncherAppsService",
              str + " for another profile " + i4 + " from " + i2 + " not allowed");
          return false;
        }
    ...
    public final LauncherActivityInfoInternal getHiddenAppActivityInfo(
        String str, int i, UserHandle userHandle) {
    ...
    public boolean shouldHideFromSuggestions(String str, UserHandle userHandle) {
      ...
      return (!canAccessProfile(identifier, "cannot get shouldHideFromSuggestions")
              || this.mPackageManagerInternal.filterAppAccess(
                  str, Binder.getCallingUid(), identifier)
              || (this.mPackageManagerInternal.getDistractingPackageRestrictions(str, identifier)
                      & 1)
                  == 0)
          ? false
          : true;
    ...
    public ParceledListSlice getLauncherActivities(String str, String str2, UserHandle userHandle) {
      ...
      ParceledListSlice queryActivitiesForUser =
      ...
      if (Settings.Global.getInt(
              this.mContext.getContentResolver(), "show_hidden_icon_apps_enabled", 1)
          == 0) {
      ...
      try {
        if (!this.mUm.getUserInfo(userHandle.getIdentifier()).isManagedProfile()
            && !this.mUm.getUserInfo(userHandle.getIdentifier()).isCloneProfile()) {
          ...
          if (str2 != null) {
            ...
            if (shouldShowSyntheticActivity(
                    userHandle,
                    this.mPackageManagerInternal.getApplicationInfo(
                        str2, 0L, injectBinderCallingUid, userHandle.getIdentifier()))
                && (hiddenAppActivityInfo2 =
                        getHiddenAppActivityInfo(str2, injectBinderCallingUid, userHandle))
                    != null) {
          ...
          for (ApplicationInfo applicationInfo :
              this.mPackageManagerInternal.getInstalledApplications(
                  0L, userHandle.getIdentifier(), injectBinderCallingUid)) {
            if (!hashSet.contains(applicationInfo.packageName)
                && shouldShowSyntheticActivity(userHandle, applicationInfo)
                && (hiddenAppActivityInfo =
                        getHiddenAppActivityInfo(
                            applicationInfo.packageName, injectBinderCallingUid, userHandle))
                    != null) {
    ...
    public final boolean shouldShowSyntheticActivity(
        UserHandle userHandle, ApplicationInfo applicationInfo) {
      AndroidPackage androidPackage;
      return (applicationInfo == null
              || applicationInfo.isSystemApp()
              || applicationInfo.isUpdatedSystemApp()
              || isManagedProfileAdmin(userHandle, applicationInfo.packageName)
              || (androidPackage =
                      this.mPackageManagerInternal.getPackage(applicationInfo.packageName))
                  == null
              || !requestsPermissions(androidPackage)
              || !hasDefaultEnableLauncherActivity(applicationInfo.packageName))
          ? false
          : true;
    }
    ...
    public final boolean hasDefaultEnableLauncherActivity(String str) {
      ...
      List queryIntentActivities =
          this.mPackageManagerInternal.queryIntentActivities(
              intent,
    ...
    public final boolean isManagedProfileAdmin(UserHandle userHandle, String str) {
      ...
      for (int i = 0; i < profiles.size(); i++) {
        ...
        if (userInfo.isManagedProfile()
            && (profileOwnerAsUser = this.mDpm.getProfileOwnerAsUser(userInfo.getUserHandle()))
                != null
            && profileOwnerAsUser.getPackageName().equals(str)) {
          return true;
        }
      }
      return false;
    ...
    public LauncherActivityInfoInternal resolveLauncherActivityInternal(
        String str, ComponentName componentName, UserHandle userHandle) {
      ...
      try {
        ActivityInfo activityInfo =
            this.mPackageManagerInternal.getActivityInfo(
                componentName, 786432L, injectBinderCallingUid, userHandle.getIdentifier());
        if (activityInfo == null) {
          return null;
        }
        if (componentName != null && componentName.getPackageName() != null) {
          IncrementalStatesInfo incrementalStatesInfo =
              this.mPackageManagerInternal.getIncrementalStatesInfo(
    ...
    public ParceledListSlice getShortcutConfigActivities(
        String str, String str2, UserHandle userHandle) {
      return queryActivitiesForUser(
          str, new Intent("android.intent.action.CREATE_SHORTCUT").setPackage(str2), userHandle);
    }

    public final ParceledListSlice queryActivitiesForUser(
        String str, Intent intent, UserHandle userHandle) {
      ...
      try {
        return new ParceledListSlice(
            queryIntentLauncherActivities(intent, injectBinderCallingUid, userHandle));
      } finally {
        injectRestoreCallingIdentity(injectClearCallingIdentity);
      }
    }
      ...
      for (int i2 = 0; i2 < size; i2++) {
        ...
        if (str != null
            && (incrementalStatesInfo =
                    this.mPackageManagerInternal.getIncrementalStatesInfo(
                        str, i, userHandle.getIdentifier()))
                != null) {
          arrayList.add(
              new LauncherActivityInfoInternal(
                  resolveInfo.activityInfo, incrementalStatesInfo, userHandle));
        }
      }
      return arrayList;
    }
    ...
    public IntentSender getShortcutConfigActivityIntent(
        String str, final ComponentName componentName, UserHandle userHandle) {
      ...
      try {
        ...
        if (!this.mPackageManagerInternal
            ...
            .anyMatch(
                new Predicate() { // from class:
                  // com.android.server.pm.LauncherAppsService$LauncherAppsImpl$$ExternalSyntheticLambda0
                  @Override // java.util.function.Predicate
                  public final boolean test(Object obj) {
                    boolean lambda$getShortcutConfigActivityIntent$2;
                    lambda$getShortcutConfigActivityIntent$2 =
                        LauncherAppsService.LauncherAppsImpl
                            .lambda$getShortcutConfigActivityIntent$2(
                                componentName, (ResolveInfo) obj);
        ...
        PendingIntent activityAsUser =
            PendingIntent.getActivityAsUser(
                this.mContext,
                0,
                new Intent("android.intent.action.CREATE_SHORTCUT").setComponent(componentName),
                1409286144,
                null,
                userHandle);
    ...
    public static /* synthetic */ boolean lambda$getShortcutConfigActivityIntent$2(
        ComponentName componentName, ResolveInfo resolveInfo) {
    ...
    public PendingIntent getShortcutIntent(
      ...
      this.mShortcutServiceInternal.createShortcutIntentsAsync(
          getCallingUserId(),
          str,
          str2,
          str3,
          ...
          try {
            return injectCreatePendingIntent(
                ...
                this.mPackageManagerInternal.getPackageUid(
                    str2, 268435456L, userHandle.getIdentifier()));
          } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
          }
        }
    ...
    public boolean isPackageEnabled(String str, String str2, UserHandle userHandle) {
      ...
      try {
        PackageInfo packageInfo =
            this.mPackageManagerInternal.getPackageInfo(
                str2, 537657344L, injectBinderCallingUid, userHandle.getIdentifier());
        if (packageInfo != null) {
    ...
    public Bundle getSuspendedPackageLauncherExtras(String str, UserHandle userHandle) {
      int injectBinderCallingUid = injectBinderCallingUid();
      int identifier = userHandle.getIdentifier();
      if (canAccessProfile(identifier, "Cannot get launcher extras")
          && !this.mPackageManagerInternal.filterAppAccess(
              str, injectBinderCallingUid, identifier)) {
    ...
    public ApplicationInfo getApplicationInfo(
        String str, String str2, int i, UserHandle userHandle) {
      if (!canAccessProfile(userHandle.getIdentifier(), "Cannot check package")) {
        return null;
      }
      int injectBinderCallingUid = injectBinderCallingUid();
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        return this.mPackageManagerInternal.getApplicationInfo(
            str2, i, injectBinderCallingUid, userHandle.getIdentifier());
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
    ...
    public LauncherApps.AppUsageLimit getAppUsageLimit(
      ...
      UsageStatsManagerInternal.AppUsageLimitData appUsageLimit =
          this.mUsageStatsManagerInternal.getAppUsageLimit(str2, userHandle);
      if (appUsageLimit == null) {
        return null;
      }
      return new LauncherApps.AppUsageLimit(
          appUsageLimit.getTotalUsageLimit(), appUsageLimit.getUsageRemaining());
    }
    ...
    public final void ensureShortcutPermission(int i, int i2, String str) {
      ...
      if (!this.mShortcutServiceInternal.hasShortcutHostPermission(
          UserHandle.getUserId(i), str, i2, i)) {
    ...
    public boolean injectHasInteractAcrossUsersFullPermission(int i, int i2) {
      return this.mContext.checkPermission("android.permission.INTERACT_ACROSS_USERS_FULL", i, i2)
          == 0;
    }

    public PendingIntent injectCreatePendingIntent(
        int i, Intent[] intentArr, int i2, Bundle bundle, String str, int i3) {
      return this.mActivityManagerInternal.getPendingIntentActivityAsApp(
          i, intentArr, i2, (Bundle) null, str, i3);
    }
    ...
    public ParceledListSlice getShortcuts(
      ...
      if ((shortcutQueryWrapper.getQueryFlags() & IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES)
          != 0) {
        ensureStrictAccessShortcutsPermission(str);
      }
      return new ParceledListSlice(
          this.mShortcutServiceInternal.getShortcuts(
              getCallingUserId(),
              str,
              changedSince,
              str2,
    ...
    public void getShortcutsAsync(
      ...
      this.mShortcutServiceInternal.getShortcutsAsync(
          getCallingUserId(),
          str,
          changedSince,
          str2,
    ...
    public void registerShortcutChangeCallback(
      ...
      ensureShortcutPermission(str);
      if (shortcutQueryWrapper.getShortcutIds() != null
          && shortcutQueryWrapper.getPackage() == null) {
        throw new IllegalArgumentException(
            "To query by shortcut ID, package name must also be set");
      }
      ...
      if (injectHasInteractAcrossUsersFullPermission(
          injectBinderCallingPid(), injectBinderCallingUid())) {
        of = null;
      }
      this.mShortcutChangeHandler.addShortcutChangeCallback(
          iShortcutChangeCallback, shortcutQueryWrapper, of);
    }

    public void unregisterShortcutChangeCallback(
        String str, IShortcutChangeCallback iShortcutChangeCallback) {
      ensureShortcutPermission(str);
    ...
    public void pinShortcuts(String str, String str2, List list, UserHandle userHandle) {
      ...
      if (canAccessProfile(userHandle.getIdentifier(), "Cannot pin shortcuts")) {
        this.mShortcutServiceInternal.pinShortcuts(
            getCallingUserId(), str, str2, list, userHandle.getIdentifier());
      }
    }
    ...
    public void cacheShortcuts(String str, String str2, List list, UserHandle userHandle, int i) {
      ...
      if (canAccessProfile(userHandle.getIdentifier(), "Cannot cache shortcuts")) {
        this.mShortcutServiceInternal.cacheShortcuts(
            getCallingUserId(),
            str,
            str2,
            list,
            userHandle.getIdentifier(),
            toShortcutsCacheFlags(i));
      }
    }
    ...
    public void uncacheShortcuts(String str, String str2, List list, UserHandle userHandle, int i) {
      ...
      if (canAccessProfile(userHandle.getIdentifier(), "Cannot uncache shortcuts")) {
        this.mShortcutServiceInternal.uncacheShortcuts(
            getCallingUserId(),
            str,
            str2,
            list,
    ...
    public int getShortcutIconResId(String str, String str2, String str3, int i) {
      ...
      if (canAccessProfile(i, "Cannot access shortcuts")) {
        return this.mShortcutServiceInternal.getShortcutIconResId(
            getCallingUserId(), str, str2, str3, i);
      }
      return 0;
    }
    ...
    public ParcelFileDescriptor getShortcutIconFd(String str, String str2, String str3, int i) {
      ...
      AndroidFuture androidFuture = new AndroidFuture();
      this.mShortcutServiceInternal.getShortcutIconFdAsync(
          getCallingUserId(), str, str2, str3, i, androidFuture);
      try {
    ...
    public String getShortcutIconUri(String str, String str2, String str3, int i) {
      ...
      AndroidFuture androidFuture = new AndroidFuture();
      this.mShortcutServiceInternal.getShortcutIconUriAsync(
          getCallingUserId(), str, str2, str3, i, androidFuture);
      try {
    ...
    public boolean hasShortcutHostPermission(String str) {
      verifyCallingPackage(str);
      return this.mShortcutServiceInternal.hasShortcutHostPermission(
          getCallingUserId(), str, injectBinderCallingPid(), injectBinderCallingUid());
    }
    ...
    public Map getActivityOverrides(String str, int i) {
      ...
      try {
        ...
        for (Map.Entry entry :
            DevicePolicyCache.getInstance().getLauncherShortcutOverrides().entrySet()) {
          List queryIntentLauncherActivities =
              queryIntentLauncherActivities(
                  new Intent("android.intent.action.MAIN")
                      .addCategory("android.intent.category.LAUNCHER")
                      .setPackage((String) entry.getValue()),
                  callingUid,
                  managedProfile);
          if (!queryIntentLauncherActivities.isEmpty()) {
            arrayMap.put(
                (String) entry.getKey(),
                (LauncherActivityInfoInternal) queryIntentLauncherActivities.get(0));
          }
        }
        return arrayMap;
      } finally {
    ...
    public final boolean startShortcutInner(
        int i,
        int i2,
        int i3,
        String str,
      ...
      try {
        ...
        if (intentArr != null && intentArr.length != 0) {
          ...
          String shortcutStartingThemeResName =
              this.mShortcutServiceInternal.getShortcutStartingThemeResName(
                  i3, str, str2, str4, i4);
    ...
    public final boolean startShortcutIntentsAsPublisher(
        Intent[] intentArr, String str, String str2, Bundle bundle, int i) {
      int startActivitiesAsPackage;
      try {
        startActivitiesAsPackage =
            this.mActivityTaskManagerInternal.startActivitiesAsPackage(
                str, str2, i, intentArr, getActivityOptionsForLauncher(bundle));
    ...
    public final Bundle getActivityOptionsForLauncher(Bundle bundle) {
      ...
      ActivityOptions fromBundle = ActivityOptions.fromBundle(bundle);
      return fromBundle.getPendingIntentBackgroundActivityStartMode() == 0
          ? fromBundle.setPendingIntentBackgroundActivityStartMode(1).toBundle()
          : bundle;
    }
    ...
    public boolean isActivityEnabled(
      ...
      int componentEnabledSetting =
          this.mPackageManagerInternal.getComponentEnabledSetting(
              componentName, injectBinderCallingUid, userHandle.getIdentifier());
      if (componentEnabledSetting == 1) {
        clearCallingIdentity = Binder.clearCallingIdentity();
        try {
          if (this.mPackageManagerInternal.getActivityInfo(
                  componentName, 786432L, injectBinderCallingUid, userHandle.getIdentifier())
              != null) {
            return true;
          }
      ...
      if (componentEnabledSetting == 2
          || componentEnabledSetting == 3
          || componentEnabledSetting == 4) {
        return false;
      }
      clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        ...
        Intent putExtra =
            new Intent("android.intent.action.VIEW")
                ...
                .putExtra(
                    ...
                    new Uri.Builder().scheme("android-app").authority(str).build());
        putExtra.setSourceBounds(rect);
        this.mActivityTaskManagerInternal.startActivityAsUser(
            iApplicationThread,
            str,
            str2,
            putExtra,
            null,
            268435456,
            getActivityOptionsForLauncher(bundle),
            identifier);
      }
    }
    ...
    public PendingIntent getActivityLaunchIntent(
      ...
      if (mainActivityLaunchIntent == null) {
        throw new SecurityException(
            "Attempt to launch activity without  category Intent.CATEGORY_LAUNCHER "
                + componentName);
      }
      long clearCallingIdentity = Binder.clearCallingIdentity();
      try {
        return PendingIntent.getActivityAsUser(
            this.mContext, 0, mainActivityLaunchIntent, 33554432, null, userHandle);
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
      }
    }
    ...
    */
    public final Intent getMainActivityLaunchIntent(
      ...
      try {
        ...
        while (true) {
          ...
          if (!activityInfo.packageName.equals(componentName.getPackageName())
              || !activityInfo.name.equals(componentName.getClassName())) {
            i++;
          } else {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      ...
      while (beginBroadcast > 0) {
        beginBroadcast--;
        dumpDataToWmTrace(
            ((String) this.mDumpCallbacks.getBroadcastCookie(beginBroadcast))
                + "_"
                + beginBroadcast,
            (IDumpCallback) this.mDumpCallbacks.getBroadcastItem(beginBroadcast));
      }
      this.mDumpCallbacks.finishBroadcast();
      if (DumpUtils.checkDumpAndUsageStatsPermission(
          this.mContext, "LauncherAppsService", printWriter)) {
        synchronized (this.mListeners) {
      ...
      try {
        ...
        try {
          ParcelFileDescriptor.AutoCloseInputStream autoCloseInputStream =
              new ParcelFileDescriptor.AutoCloseInputStream(createPipe[0]);
          try {
    ...
    public void registerDumpCallback(IDumpCallback iDumpCallback) {
      if (PermissionChecker.checkCallingOrSelfPermissionForPreflight(
              this.mContext, "android.permission.READ_FRAME_BUFFER")
          == 0) {
        this.mDumpCallbacks.register(
            iDumpCallback, this.mContext.getPackageManager().getNameForUid(Binder.getCallingUid()));
      } else {
    ...
    public final boolean isEnabledProfileOf(
        UserHandle userHandle, UserHandle userHandle2, String str) {
      return this.mUserManagerInternal.isProfileAccessible(
          userHandle.getIdentifier(), userHandle2.getIdentifier(), str, false);
    }

    public final boolean isPackageVisibleToListener(
        String str, BroadcastCookie broadcastCookie, UserHandle userHandle) {
      return !this.mPackageManagerInternal.filterAppAccess(
          str, broadcastCookie.callingUid, userHandle.getIdentifier(), false);
    }
    ...
    public final String[] getFilteredPackageNames(
        String[] strArr, BroadcastCookie broadcastCookie, UserHandle userHandle) {
      ArrayList arrayList = new ArrayList();
    ...
    public void registerLoadingProgressForIncrementalApps() {
      ...
      for (final UserHandle userHandle : userProfiles) {
        this.mPackageManagerInternal.forEachInstalledPackage(
            new Consumer() { // from class:
              // com.android.server.pm.LauncherAppsService$LauncherAppsImpl$$ExternalSyntheticLambda3
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                LauncherAppsService.LauncherAppsImpl.this
                    .lambda$registerLoadingProgressForIncrementalApps$3(
                        userHandle, (AndroidPackage) obj);
              }
            },
            userHandle.getIdentifier());
      }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$registerLoadingProgressForIncrementalApps$3(
        UserHandle userHandle, AndroidPackage androidPackage) {
      String packageName = androidPackage.getPackageName();
      if (this.mPackageManagerInternal
          .getIncrementalStatesInfo(packageName, Process.myUid(), userHandle.getIdentifier())
          .isLoading()) {
        this.mPackageManagerInternal.registerInstalledLoadingProgressCallback(
            packageName,
            new PackageLoadingProgressCallback(packageName, userHandle),
            userHandle.getIdentifier());
      }
    }
    ...
    public class ShortcutChangeHandler implements LauncherApps.ShortcutChangeCallback {
      ...
      public synchronized void addShortcutChangeCallback(
          IShortcutChangeCallback iShortcutChangeCallback,
          ShortcutQueryWrapper shortcutQueryWrapper,
          UserHandle userHandle) {
        this.mCallbacks.unregister(iShortcutChangeCallback);
        this.mCallbacks.register(
            iShortcutChangeCallback, new Pair(shortcutQueryWrapper, userHandle));
      }
      ...
      public final void onShortcutEvent(String str, List list, UserHandle userHandle, boolean z) {
        ...
        for (int i = 0; i < beginBroadcast; i++) {
          ...
          if (userHandle2 == null || hasUserAccess(userHandle2, userHandle)) {
            List filterShortcutsByQuery =
                filterShortcutsByQuery(str, list, (ShortcutQueryWrapper) pair.first, z);
      ...
      public static List filterShortcutsByQuery(
          String str, List list, ShortcutQueryWrapper shortcutQueryWrapper, boolean z) {
        long changedSince = shortcutQueryWrapper.getChangedSince();
        String str2 = shortcutQueryWrapper.getPackage();
        List shortcutIds = shortcutQueryWrapper.getShortcutIds();
        List locusIds = shortcutQueryWrapper.getLocusIds();
        ...
        int i =
            ((queryFlags & 2) != 0 ? 2 : 0)
                | ((queryFlags & 1) != 0 ? 1 : 0)
                | ((queryFlags & 8) != 0 ? 32 : 0)
                | ((queryFlags & 16) != 0 ? 1610629120 : 0);
        for (int i2 = 0; i2 < list.size(); i2++) {
          ShortcutInfo shortcutInfo = (ShortcutInfo) list.get(i2);
          if ((activity == null || activity.equals(shortcutInfo.getActivity()))
              && ((changedSince == 0 || changedSince <= shortcutInfo.getLastChangedTimestamp())
                  && ((shortcutIds == null || shortcutIds.contains(shortcutInfo.getId()))
                      && ((locusIds == null || locusIds.contains(shortcutInfo.getLocusId()))
                          && (z || (shortcutInfo.getFlags() & i) != 0))))) {
    ...
    public class PackageRemovedListener extends BroadcastReceiver {
      ...
      public void onReceive(Context context, Intent intent) {
        ...
        if ("android.intent.action.PACKAGE_REMOVED_INTERNAL".equals(intent.getAction())) {
          ...
          int[] intArrayExtra =
              intent.getIntArrayExtra("android.intent.extra.VISIBILITY_ALLOW_LIST");
          StringBuilder sb = new StringBuilder();
          ...
          for (int i = 0; i < beginBroadcast; i++) {
            try {
              IOnAppsChangedListener broadcastItem =
                  LauncherAppsImpl.this.mListeners.getBroadcastItem(i);
              BroadcastCookie broadcastCookie =
                  (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i);
              if (!LauncherAppsImpl.this.isEnabledProfileOf(
                  broadcastCookie.user, userHandle, "onPackageRemoved")) {
                Slog.d(
                    "LauncherAppsService",
                    "Skip onPackageRemoved(not enabled): "
                        + packageName
                        + ", listener: "
                        + broadcastCookie.packageName
                        + "("
                        + broadcastCookie.user
                        + ", "
                        + broadcastCookie.callingPid
                        + ", "
                        + broadcastCookie.callingUid
                        + ")");
              } else if (LauncherAppsImpl.isCallingAppIdAllowed(
                  intArrayExtra, UserHandle.getAppId(broadcastCookie.callingUid))) {
                try {
                  Slog.d(
                      "LauncherAppsService",
                      "Calling onPackageRemoved: "
                          + packageName
                          + ", listener: "
                          + broadcastCookie.packageName
                          + "("
                ...
                Slog.d(
                    "LauncherAppsService",
                    "Skip onPackageRemoved(not allowed): "
                        + packageName
                        + ", listener: "
                        + broadcastCookie.packageName
                        + "("
    ...
    public void changePackageIcon(final String str, int i) {
      ...
      this.mCallbackHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.LauncherAppsService$LauncherAppsImpl$$ExternalSyntheticLambda1
    ...
    public class MyPackageMonitor extends PackageMonitor
      ...
      public void onPackageAdded(String str, int i) {
        ...
        for (int i2 = 0; i2 < beginBroadcast; i2++) {
          try {
            IOnAppsChangedListener broadcastItem =
                LauncherAppsImpl.this.mListeners.getBroadcastItem(i2);
            BroadcastCookie broadcastCookie =
                (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i2);
            if (!LauncherAppsImpl.this.isEnabledProfileOf(
                broadcastCookie.user, userHandle, "onPackageAdded")) {
              Slog.d(
                  "LauncherAppsService",
                  "Skip onPackageAdded(not enabled): "
                      + str
                      + ", listener: "
                      + broadcastCookie.packageName
                      + "("
                      ...
                      + broadcastCookie.callingPid
                      + ")");
            } else if (LauncherAppsImpl.this.isPackageVisibleToListener(
                str, broadcastCookie, userHandle)) {
              try {
                Slog.d(
                    "LauncherAppsService",
                    "Calling onPackageAdded: "
                        + str
                        + ", listener: "
                        + broadcastCookie.packageName
                        + "("
              ...
              Slog.d(
                  "LauncherAppsService",
                  "Skip onPackageAdded(not visible): "
                      + str
                      + ", listener: "
                      + broadcastCookie.packageName
                      + "("
        ...
        LauncherAppsImpl.this.mPackageManagerInternal.registerInstalledLoadingProgressCallback(
            str,
            LauncherAppsImpl.this.new PackageLoadingProgressCallback(str, userHandle),
            userHandle.getIdentifier());
      }
        ...
        for (int i = 0; i < beginBroadcast; i++) {
          try {
            ...
            BroadcastCookie broadcastCookie =
                (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i);
            if (LauncherAppsImpl.this.isEnabledProfileOf(
                    broadcastCookie.user, userHandle, "onPackageModified")
                && LauncherAppsImpl.this.isPackageVisibleToListener(
                    str, broadcastCookie, userHandle)) {
              try {
        ...
        for (int i = 0; i < beginBroadcast; i++) {
          try {
            ...
            BroadcastCookie broadcastCookie =
                (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i);
            if (LauncherAppsImpl.this.isEnabledProfileOf(
                broadcastCookie.user, userHandle, "onPackagesAvailable")) {
              String[] filteredPackageNames =
                  LauncherAppsImpl.this.getFilteredPackageNames(
                      strArr, broadcastCookie, userHandle);
              if (!ArrayUtils.isEmpty(filteredPackageNames)) {
                try {
                  broadcastItem.onPackagesAvailable(
                      userHandle, filteredPackageNames, isReplacing());
                } catch (RemoteException e) {
                  Slog.d("LauncherAppsService", "Callback failed ", e);
                }
              }
        ...
        for (int i = 0; i < beginBroadcast; i++) {
          try {
            ...
            BroadcastCookie broadcastCookie =
                (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i);
            if (LauncherAppsImpl.this.isEnabledProfileOf(
                broadcastCookie.user, userHandle, "onPackagesUnavailable")) {
              String[] filteredPackageNames =
                  LauncherAppsImpl.this.getFilteredPackageNames(
                      strArr, broadcastCookie, userHandle);
              if (!ArrayUtils.isEmpty(filteredPackageNames)) {
                try {
                  broadcastItem.onPackagesUnavailable(
                      userHandle, filteredPackageNames, isReplacing());
                } catch (RemoteException e) {
                  Slog.d("LauncherAppsService", "Callback failed ", e);
                }
      ...
      public void onPackagesSuspended(String[] strArr) {
        ...
        for (String str : strArr) {
          Bundle suspendedPackageLauncherExtras =
              LauncherAppsImpl.this.mPackageManagerInternal.getSuspendedPackageLauncherExtras(
                  str, userHandle.getIdentifier());
        ...
        for (int i = 0; i < beginBroadcast; i++) {
          try {
            ...
            BroadcastCookie broadcastCookie =
                (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i);
            if (LauncherAppsImpl.this.isEnabledProfileOf(
                broadcastCookie.user, userHandle, "onPackagesSuspended")) {
              String[] filteredPackageNames =
                  LauncherAppsImpl.this.getFilteredPackageNames(
                      strArr2, broadcastCookie, userHandle);
              try {
                if (!ArrayUtils.isEmpty(filteredPackageNames)) {
                  broadcastItem.onPackagesSuspended(
                      userHandle, filteredPackageNames, (Bundle) null);
                }
                for (int i2 = 0; i2 < arrayList.size(); i2++) {
                  Pair pair = (Pair) arrayList.get(i2);
                  if (LauncherAppsImpl.this.isPackageVisibleToListener(
                      (String) pair.first, broadcastCookie, userHandle)) {
                    broadcastItem.onPackagesSuspended(
                        userHandle, new String[] {(String) pair.first}, (Bundle) pair.second);
                  }
                }
              } catch (RemoteException e) {
                Slog.d("LauncherAppsService", "Callback failed ", e);
        ...
        for (int i = 0; i < beginBroadcast; i++) {
          try {
            ...
            BroadcastCookie broadcastCookie =
                (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i);
            if (LauncherAppsImpl.this.isEnabledProfileOf(
                broadcastCookie.user, userHandle, "onPackagesUnsuspended")) {
              String[] filteredPackageNames =
                  LauncherAppsImpl.this.getFilteredPackageNames(
                      strArr, broadcastCookie, userHandle);
              if (!ArrayUtils.isEmpty(filteredPackageNames)) {
      ...
      public void onShortcutChanged(final String str, final int i) {
        LauncherAppsImpl.this.postToPackageMonitorHandler(
            new Runnable() { // from class:
              // com.android.server.pm.LauncherAppsService$LauncherAppsImpl$MyPackageMonitor$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
                LauncherAppsService.LauncherAppsImpl.MyPackageMonitor.this
                    .lambda$onShortcutChanged$0(str, i);
              }
            });
      }
          ...
          try {
            ...
            while (i4 < beginBroadcast) {
              try {
                try {
                  IOnAppsChangedListener broadcastItem =
                      LauncherAppsImpl.this.mListeners.getBroadcastItem(i4);
                  BroadcastCookie broadcastCookie =
                      (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i4);
                  if (LauncherAppsImpl.this.isEnabledProfileOf(
                          broadcastCookie.user, of, "onShortcutChanged")
                      && LauncherAppsImpl.this.isPackageVisibleToListener(
                          str, broadcastCookie, of)) {
                    int identifier = broadcastCookie.user.getIdentifier();
                    if (LauncherAppsImpl.this.mShortcutServiceInternal.hasShortcutHostPermission(
                        identifier,
                        broadcastCookie.packageName,
                        broadcastCookie.callingPid,
                        broadcastCookie.callingUid)) {
                      ShortcutServiceInternal shortcutServiceInternal =
                          LauncherAppsImpl.this.mShortcutServiceInternal;
                      i2 = i4;
                        ...
                        try {
                          ParceledListSlice parceledListSlice =
                              new ParceledListSlice(
                                  shortcutServiceInternal.getShortcuts(
                                      identifier,
                                      broadcastCookie.packageName,
                                      0L,
                                      str,
    ...
    public class PackageLoadingProgressCallback
        extends PackageManagerInternal.InstalledLoadingProgressCallback {
        ...
        for (int i = 0; i < beginBroadcast; i++) {
          try {
            ...
            BroadcastCookie broadcastCookie =
                (BroadcastCookie) LauncherAppsImpl.this.mListeners.getBroadcastCookie(i);
            if (LauncherAppsImpl.this.isEnabledProfileOf(
                    broadcastCookie.user, this.mUser, "onLoadingProgressChanged")
                && LauncherAppsImpl.this.isPackageVisibleToListener(
                    this.mPackageName, broadcastCookie, this.mUser)) {
              try {
    ...
    public final class LocalService extends LauncherAppsServiceInternal {
      ...
      public boolean startShortcut(
        ...
        return LauncherAppsImpl.this.startShortcutInner(
            i, i2, UserHandle.getUserId(i), str, str2, str3, str4, rect, bundle, i3);
      }
    }
  }
}
