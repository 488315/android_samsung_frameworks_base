...
public final class DistractingPackageHelper {
  ...
  public DistractingPackageHelper(
  ...
  public String[] setDistractingPackageRestrictionsAsUser(
      Computer computer, String[] strArr, final int i, final int i2, int i3) {
    ...
    boolean[] canSuspendPackageForUser =
        i != 0
            ? this.mSuspendPackageHelper.canSuspendPackageForUser(computer, strArr, i2, i3)
            : null;
    for (int i4 = 0; i4 < strArr.length; i4++) {
      String str = strArr[i4];
      PackageStateInternal packageStateForInstalledAndFiltered =
          computer.getPackageStateForInstalledAndFiltered(str, i3, i2);
      if (packageStateForInstalledAndFiltered == null) {
        Slog.w(
            "PackageManager",
            "Could not find package setting for package: " + str + ". Skipping...");
        arrayList2.add(str);
      } else if (canSuspendPackageForUser != null && !canSuspendPackageForUser[i4]) {
        arrayList2.add(str);
      } else if (i
          != packageStateForInstalledAndFiltered.getUserStateOrDefault(i2).getDistractionFlags()) {
        arrayList.add(str);
    ...
    this.mPm.commitPackageStateMutation(
        ...
        new Consumer() { // from class:
          // com.android.server.pm.DistractingPackageHelper$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DistractingPackageHelper.lambda$setDistractingPackageRestrictionsAsUser$0(
                arraySet, i2, i, (PackageStateMutator) obj);
          }
        });
    if (!arrayList.isEmpty()) {
      sendDistractingPackagesChanged(
          (String[]) arrayList.toArray(new String[arrayList.size()]), intArray.toArray(), i2, i);
      this.mPm.scheduleWritePackageRestrictions(i2);
    }
    return (String[]) arrayList2.toArray(new String[0]);
  }

  public static /* synthetic */ void lambda$setDistractingPackageRestrictionsAsUser$0(
      ArraySet arraySet, int i, int i2, PackageStateMutator packageStateMutator) {
    int size = arraySet.size();
    for (int i3 = 0; i3 < size; i3++) {
      packageStateMutator
          .forPackage((String) arraySet.valueAt(i3))
          .userState(i)
          .setDistractionFlags(i2);
    }
  }

  public void removeDistractingPackageRestrictions(
      Computer computer, String[] strArr, final int i) {
    if (ArrayUtils.isEmpty(strArr)) {
      return;
    }
    ...
    for (String str : strArr) {
      ...
      if (packageStateInternal != null
          && packageStateInternal.getUserStateOrDefault(i).getDistractionFlags() != 0) {
    ...
    this.mPm.commitPackageStateMutation(
        null,
        new Consumer() { // from class:
          // com.android.server.pm.DistractingPackageHelper$$ExternalSyntheticLambda0
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DistractingPackageHelper.lambda$removeDistractingPackageRestrictions$1(
                arrayList, i, (PackageStateMutator) obj);
          }
        });
    if (arrayList.isEmpty()) {
      return;
    ...
    sendDistractingPackagesChanged(
        (String[]) arrayList.toArray(new String[arrayList.size()]), intArray.toArray(), i, 0);
    this.mPm.scheduleWritePackageRestrictions(i);
  }

  public static /* synthetic */ void lambda$removeDistractingPackageRestrictions$1(
      List list, int i, PackageStateMutator packageStateMutator) {
    ...
    this.mInjector
        ...
        .post(
            new Runnable() { // from class:
              // com.android.server.pm.DistractingPackageHelper$$ExternalSyntheticLambda2
  ...
  public /* synthetic */ void lambda$sendDistractingPackagesChanged$3(Bundle bundle, int i) {
    this.mBroadcastHelper.sendPackageBroadcast(
        ...
        new BiFunction() { // from class:
          // com.android.server.pm.DistractingPackageHelper$$ExternalSyntheticLambda3
          @Override // java.util.function.BiFunction
          public final Object apply(Object obj, Object obj2) {
            Bundle lambda$sendDistractingPackagesChanged$2;
            lambda$sendDistractingPackagesChanged$2 =
                DistractingPackageHelper.this.lambda$sendDistractingPackagesChanged$2(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ Bundle lambda$sendDistractingPackagesChanged$2(
      Integer num, Bundle bundle) {
