...
public abstract class VerificationUtils {
        ...
        if (packageVerificationState.isVerificationComplete()) {
            ...
            Uri fromFile =
                    verifyingSession != null
                            ...
                            : null;
            boolean z = true;
            if (!((packageVerificationState.mRequiredVerificationComplete
                            && packageVerificationState.mRequiredVerificationPassed)
                    ? packageVerificationState.mSufficientVerificationComplete
                            ? packageVerificationState.mSufficientVerificationPassed
                            : true
                    : false)) {
                i2 = -1;
            }
            ...
            if (packageManagerService != null && verifyingSession != null) {
                broadcastPackageVerified(
                        ...
                        i3,
                        null,
                        verifyingSession.mDataLoaderType,
                        verifyingSession.mUser,
            ...
            if (packageManagerService != null
                    && packageVerificationState.areAllVerificationsComplete()) {
    ...
    public static void processVerificationResponse(
        ...
        processVerificationResponse(
                i, packageVerificationState, i3, "Install not allowed", packageManagerService);
    }
    ...
    public static void processVerificationResponseOnTimeout(
        ...
        processVerificationResponse(
                i, packageVerificationState, i3, "Verification timed out", packageManagerService);
    }
}
