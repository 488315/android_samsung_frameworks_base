...
public class PackageSetting extends SettingBase implements PackageStateInternal {
  ...
  public void dumpDebug(
    ...
    writePackageUserPermissionsProto(
        protoOutputStream, 2246267895820L, list, legacyPermissionDataProvider);
  ...
  public PackageSetting setFirstInstallTimeFromReplaced(
      PackageStateInternal packageStateInternal, int[] iArr) {
  ...
  public boolean setMimeGroup(String str, ArraySet arraySet) {
    ...
    if (set == null) {
      throw new IllegalArgumentException(
          "Unknown MIME group " + str + " for package " + this.mName);
    }
    ...
    for (int i = 0; i < packageSetting.mUserStates.size(); i++) {
      if (z) {
        this.mUserStates.put(
            ...
            ((PackageUserStateImpl) packageSetting.mUserStates.valueAt(i)).snapshot());
      } else {
  ...
  public boolean setOverlayPathsForLibrary(String str, OverlayPaths overlayPaths, int i) {
    boolean sharedLibraryOverlayPaths =
        modifyUserState(i).setSharedLibraryOverlayPaths(str, overlayPaths);
    onChanged();
  ...
  public void setUserState(
    ...
    modifyUserState(i)
        ...
        .setNotLaunched(z3)
        .setHidden(z4)
        .setDistractionFlags(i3)
        .setLastDisableAppCaller(str)
        .setEnabledComponents(arraySet)
        .setDisabledComponents(arraySet2)
        .setInstallReason(i4)
        .setUninstallReason(i5)
        .setInstantApp(z5)
        .setVirtualPreload(z6)
        .setHarmfulAppWarning(str2)
        .setSplashScreenTheme(str3)
        .setFirstInstallTime(j2);
    onChanged();
  }
  ...
  public void setEnabledComponentsCopy(WatchedArraySet watchedArraySet, int i) {
    modifyUserState(i)
        .setEnabledComponents(watchedArraySet != null ? watchedArraySet.untrackedStorage() : null);
    onChanged();
  }

  public void setDisabledComponentsCopy(WatchedArraySet watchedArraySet, int i) {
    modifyUserState(i)
        .setDisabledComponents(watchedArraySet != null ? watchedArraySet.untrackedStorage() : null);
    onChanged();
  }
  ...
  public boolean enableComponentLPw(String str, int i) {
    ...
    boolean add =
        modifyUserStateComponents.getEnabledComponentsNoCopy().add(str)
            | (modifyUserStateComponents.getDisabledComponentsNoCopy() != null
                ? modifyUserStateComponents.getDisabledComponentsNoCopy().remove(str)
                : false);
    if (add) {
      onChanged();
    }
  ...
  public boolean disableComponentLPw(String str, int i) {
    ...
    boolean add =
        modifyUserStateComponents.getDisabledComponentsNoCopy().add(str)
            | (modifyUserStateComponents.getEnabledComponentsNoCopy() != null
                ? modifyUserStateComponents.getEnabledComponentsNoCopy().remove(str)
                : false);
    if (add) {
      onChanged();
    }
  ...
  public int getCurrentEnabledStateLPr(String str, int i) {
    ...
    if (readUserState.getEnabledComponentsNoCopy() == null
        || !readUserState.getEnabledComponentsNoCopy().contains(str)) {
      return (readUserState.getDisabledComponentsNoCopy() == null
              || !readUserState.getDisabledComponentsNoCopy().contains(str))
          ? 0
          : 2;
    }
    return 1;
  ...
  public void writePackageUserPermissionsProto(
      ProtoOutputStream protoOutputStream,
      long j,
      List list,
      LegacyPermissionDataProvider legacyPermissionDataProvider) {
    ...
    while (it.hasNext()) {
      ...
      for (LegacyPermissionState.PermissionState permissionState :
          legacyPermissionDataProvider
              .getLegacyPermissionState(this.mAppId)
              .getPermissionStates(userInfo.id)) {
  ...
  public void writeUsersInfoToProto(ProtoOutputStream protoOutputStream, long j) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      ...
      PackageUserStateInternal packageUserStateInternal =
          (PackageUserStateInternal) this.mUserStates.valueAt(i2);
      ...
      if (packageUserStateInternal.isSuspended()) {
        for (int i3 = 0; i3 < packageUserStateInternal.getSuspendParams().size(); i3++) {
          protoOutputStream.write(
              2237677961225L, (String) packageUserStateInternal.getSuspendParams().keyAt(i3));
        }
      }
  ...
  public PackageUserState getStateForUser(UserHandle userHandle) {
    PackageUserState packageUserState =
        (PackageUserState) getUserStates().get(userHandle.getIdentifier());
