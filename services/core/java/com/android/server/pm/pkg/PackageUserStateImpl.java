...
public class PackageUserStateImpl extends WatchableImpl
  ...
  public final SnapshotCache makeCache() {
    return new SnapshotCache(
        this, this) { // from class: com.android.server.pm.pkg.PackageUserStateImpl.1
      @Override // com.android.server.utils.SnapshotCache
      public PackageUserStateImpl createSnapshot() {
        return new PackageUserStateImpl(
            PackageUserStateImpl.this.mWatchable, (PackageUserStateImpl) this.mSource);
      }
    };
  }
  ...
  public PackageUserStateImpl(Watchable watchable, PackageUserStateImpl packageUserStateImpl) {
    ...
    this.mComponentLabelIconOverrideMap =
        watchedArrayMap3 != null ? watchedArrayMap3.snapshot() : null;
  ...
  public boolean setOverlayPaths(OverlayPaths overlayPaths) {
    ...
    if ((this.mOverlayPaths == null && overlayPaths.isEmpty())
        || (overlayPaths == null && this.mOverlayPaths.isEmpty())) {
      return false;
    }
  ...
  public ArraySet m10013getDisabledComponents() {
  ...
  public ArraySet m10014getEnabledComponents() {
  ...
  public PackageUserStateImpl putSuspendParams(String str, SuspendParams suspendParams) {
    ...
    if (!this.mSuspendParams.containsKey(str)
        || !Objects.equals(this.mSuspendParams.get(str), suspendParams)) {
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(
            this.mDisabledComponentsWatched, packageUserStateImpl.mDisabledComponentsWatched)
        && Objects.equals(
            this.mEnabledComponentsWatched, packageUserStateImpl.mEnabledComponentsWatched)
        && this.mCeDataInode == packageUserStateImpl.mCeDataInode
        && this.mInstalled == packageUserStateImpl.mInstalled
        && this.mStopped == packageUserStateImpl.mStopped
        && this.mNotLaunched == packageUserStateImpl.mNotLaunched
        ...
        && Objects.equals(this.mLastDisableAppCaller, packageUserStateImpl.mLastDisableAppCaller)
        && Objects.equals(this.mOverlayPaths, packageUserStateImpl.mOverlayPaths)
        && Objects.equals(
            this.mSharedLibraryOverlayPaths, packageUserStateImpl.mSharedLibraryOverlayPaths)
        ...
        && this.mFirstInstallTime == packageUserStateImpl.mFirstInstallTime
        && watchableEquals(packageUserStateImpl.mWatchable)
        && snapshotEquals(packageUserStateImpl.mSnapshot);
  }
