...
public final class PackageStateMutator {
    ...
    public final class Result {
        ...
        public static final Result PACKAGES_AND_STATE_CHANGED =
                new Result(false, true, true, false);
        ...
        public final void setInstaller(int i, String str) {
            ...
            if (packageSetting != null) {
                ...
                if (!Objects.equals(str, installSource.mInstallerPackageName)) {
                    ...
                    installSource =
                            InstallSource.createInternal(
                                    i,
                                    i2,
                                    installSource.mInitiatingPackageSignatures,
                                    ...
                                    z,
                                    installSource.mIsInitiatingPackageUninstalled);
                }
        ...
        public final UserStateWriteWrapper userState(int i) {
            ...
            if (packageSetting == null) {
                ...
                PackageUserStateImpl packageUserStateImpl2 =
                        (PackageUserStateImpl) packageSetting.mUserStates.get(i);
