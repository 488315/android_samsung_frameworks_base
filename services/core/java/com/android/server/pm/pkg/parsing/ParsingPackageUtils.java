...
public class ParsingPackageUtils {
    ...
    */
    public final ParseResult parseSplitApplication(ParseInput parseInput, ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser, int i, int i2) {
        boolean z;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static ParseResult parseKeySets(ParseInput parseInput, ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser) {
        char c;
        int depth = xmlResourceParser.getDepth();
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final ParseResult parseUsesPermission(ParseInput parseInput, ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser) {
        boolean z;
        boolean z2;
        char c;
        ...
        try {
            ...
            if (i4 >= parseMinOrMaxSdkVersion && i4 <= parseMinOrMaxSdkVersion2) {
                ...
                while (true) {
                    ...
                    ParsedUsesPermission parsedUsesPermission = (ParsedUsesPermission) usesPermissions.get(i5);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static ParseResult parseUsesSdk(ParseInput parseInput, ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser, int i) {
        boolean z;
        int i2;
        String str;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static ParseResult parseQueries(ParseInput parseInput, ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser) {
        int depth = xmlResourceParser.getDepth();
        while (true) {
            int next = xmlResourceParser.next();
            if (next == 1 || (next == 3 && xmlResourceParser.getDepth() <= depth)) {
            ...
            if (next == 2) {
                if (xmlResourceParser.getName().equals(KnoxCustomManagerService.INTENT)) {
                    ParseResult parseIntentInfo = ParsedIntentInfoUtils.parseIntentInfo(null, parsingPackage, resources, xmlResourceParser, true, true, parseInput);
                    ...
                    try {
                        ...
                        StringTokenizer stringTokenizer = new StringTokenizer(nonConfigurationString2, KnoxVpnFirewallHelper.DELIMITER);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final ParseResult parseBaseApplication(ParseInput parseInput, ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser, int i) {
        int i2;
        boolean z;
        ...
        try {
            ...
            ParseResult buildTaskAffinityName = ComponentParseUtils.buildTaskAffinityName(packageName, packageName, targetSdkVersion >= 8 ? obtainAttributes.getNonConfigurationString(12, 1024) : obtainAttributes.getNonResourceString(12), parseInput);
            ...
            ParseResult buildProcessName = ComponentParseUtils.buildProcessName(packageName, null, targetSdkVersion >= 8 ? obtainAttributes.getNonConfigurationString(11, 1024) : obtainAttributes.getNonResourceString(11), i, this.mSeparateProcesses, parseInput);
            ...
            ParseResult parseKnownActivityEmbeddingCerts = ParsingUtils.parseKnownActivityEmbeddingCerts(obtainAttributes, resources, 72, parseInput);
                        ...
                        switch (c) {
                            ...
                            case 5:
                                ...
                                if (RuntimeManifestUtils.useLegacyRuntimeManifest(parsingPackage.getMetaData())) {
                                    LegacyRuntimeManifestParseUtils.parseOverlayComponentAndModify(parsingPackage.getPackageName(), parsingPackage.getProviders(), resources, xmlResourceParser, parseInput, "<provider-salescode>");
                                }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static ParseResult parseAdditionalCertificates(ParseInput parseInput, Resources resources, XmlResourceParser xmlResourceParser) {
        String[] strArr = EmptyArray.STRING;
        int depth = xmlResourceParser.getDepth();
        while (true) {
            int next = xmlResourceParser.next();
    ...
    public static void readConfigUseRoundIcon(Resources resources) {
        ...
        try {
            ...
            sUseRoundIcon = ResourcesManager.getInstance().getResources((IBinder) null, (String) null, (String[]) null, applicationInfo.resourceDirs, applicationInfo.overlayPaths, applicationInfo.sharedLibraryFiles, (Integer) null, (Configuration) null, system.getCompatibilityInfo(), system.getClassLoader(), (List) null).getBoolean(android.R.bool.config_supportTelephonyTimeZoneFallback);
