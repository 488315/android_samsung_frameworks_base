...
public abstract class ComponentParseUtils {
    ...
    */
    public static ParseResult parseAllMetaData(ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser, String str, ParsedComponentImpl parsedComponentImpl, ParseInput parseInput) {
        ...
        while (true) {
            ...
            if (next == 2) {
                if ("meta-data".equals(xmlResourceParser.getName())) {
                    unknownTag = ParsedComponentUtils.addMetaData(parsedComponentImpl, parsingPackage, resources, xmlResourceParser, parseInput);
                } else {
