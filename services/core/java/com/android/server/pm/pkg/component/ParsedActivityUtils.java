...
public abstract class ParsedActivityUtils {
    ...
    */
    public static ParseResult parseActivityOrAlias(ParsedActivityImpl parsedActivityImpl, ParsingPackage parsingPackage, String str, XmlResourceParser xmlResourceParser, Resources resources, TypedArray typedArray, boolean z, boolean z2, boolean z3, ParseInput parseInput, int i, int i2, int i3) {
        ...
        ParseResult parseKnownActivityEmbeddingCerts = ParsingUtils.parseKnownActivityEmbeddingCerts(typedArray, resources, z2 ? 14 : 61, parseInput);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static ParseResult parseActivityWindowLayout(Resources resources, AttributeSet attributeSet, ParseInput parseInput) {
        float f;
