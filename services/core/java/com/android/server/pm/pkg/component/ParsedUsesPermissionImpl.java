...
public class ParsedUsesPermissionImpl implements ParsedUsesPermission, Parcelable {
  ...
  public ParsedUsesPermissionImpl(String str, int i) {
    ...
    AnnotationValidations.validate(
        ParsedUsesPermission.UsesPermissionFlags.class, (Annotation) null, i);
  }
  ...
  static {
    ...
    CREATOR =
        new Parcelable
            .Creator() { // from class:
                         // com.android.server.pm.pkg.component.ParsedUsesPermissionImpl.1
  ...
  public ParsedUsesPermissionImpl(Parcel parcel) {
    ...
    AnnotationValidations.validate(
        ParsedUsesPermission.UsesPermissionFlags.class, (Annotation) null, readInt);
  }
}
