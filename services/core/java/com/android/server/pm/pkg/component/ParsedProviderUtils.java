...
public abstract class ParsedProviderUtils {
  public static ParseResult parseProvider(
      String[] strArr,
    ...
    TypedArray obtainAttributes =
        resources.obtainAttributes(xmlResourceParser, R.styleable.AndroidManifestProvider);
    try {
      ...
      try {
        ...
        parsedProviderImpl
            .setSyncable(typedArray.getBoolean(11, false))
            .setExported(typedArray.getBoolean(7, targetSdkVersion < 17));
        ...
        parsedProviderImpl
            .setGrantUriPermissions(typedArray.getBoolean(13, false))
            .setForceUriPermissions(typedArray.getBoolean(22, false))
            .setMultiProcess(typedArray.getBoolean(9, false))
            .setInitOrder(typedArray.getInt(12, 0))
            .setFlags(
                parsedProviderImpl.getFlags()
                    | ComponentParseUtils.flag(1073741824, 16, typedArray));
        ...
        if (parsingPackage.isSaveStateDisallowed()
            && Objects.equals(parsedProviderImpl.getProcessName(), packageName)) {
          return parseInput.error(
              "Heavy-weight applications can not have providers in main process");
        }
        ...
        return parseProviderTags(
            parsingPackage, name, resources, xmlResourceParser, z2, parsedProviderImpl, parseInput);
      } catch (Throwable th) {
        th = th;
        typedArray.recycle();
        throw th;
  ...
  */
  public static ParseResult parseProviderTags(
      ParsingPackage parsingPackage,
      String str,
      Resources resources,
      XmlResourceParser xmlResourceParser,
    ...
    while (true) {
      ...
      if (next != 1 && (next != 3 || xmlResourceParser.getDepth() > depth)) {
        if (next == 2) {
          ...
          switch (c) {
            case 0:
              parseGrantUriPermission =
                  parseGrantUriPermission(
                      parsedProviderImpl, parsingPackage, resources, xmlResourceParser, parseInput);
              break;
            case 1:
              parseGrantUriPermission =
            ...
            case 2:
              ...
              if (parseGrantUriPermission.isSuccess()) {
                ParsedIntentInfoImpl parsedIntentInfoImpl =
                    (ParsedIntentInfoImpl) parseGrantUriPermission.getResult();
                parsedProviderImpl.setOrder(
                    Math.max(
                        parsedIntentInfoImpl.getIntentFilter().getOrder(),
                        parsedProviderImpl.getOrder()));
            ...
            default:
              parseGrantUriPermission =
                  ParsingUtils.unknownTag(str, parsingPackage, xmlResourceParser, parseInput);
              break;
          }
  ...
  public static ParseResult parseGrantUriPermission(
      ParsedProviderImpl parsedProviderImpl,
      ParsingPackage parsingPackage,
      Resources resources,
      XmlResourceParser xmlResourceParser,
    ...
    TypedArray obtainAttributes =
        resources.obtainAttributes(
            xmlResourceParser, R.styleable.AndroidManifestGrantUriPermission);
    try {
      String name = xmlResourceParser.getName();
        ...
        if (nonConfigurationString2 != null) {
          ...
          if (nonConfigurationString3 != null) {
            ...
            if (nonConfigurationString4 != null) {
              ...
              patternMatcher =
                  nonConfigurationString5 != null
                      ? new PatternMatcher(nonConfigurationString5, 0)
                      : null;
            }
          }
        }
  ...
  public static ParseResult parsePathPermission(
      ParsedProviderImpl parsedProviderImpl,
      ParsingPackage parsingPackage,
      Resources resources,
      XmlResourceParser xmlResourceParser,
    ...
    TypedArray obtainAttributes =
        resources.obtainAttributes(xmlResourceParser, R.styleable.AndroidManifestPathPermission);
    try {
      String name = xmlResourceParser.getName();
