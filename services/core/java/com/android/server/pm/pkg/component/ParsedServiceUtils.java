...
public abstract class ParsedServiceUtils {
  ...
  public static ParseResult parseService(
      String[] strArr,
    ...
    try {
      ...
      try {
        ...
        if (parsingPackage.isSaveStateDisallowed()
            && Objects.equals(parsedServiceImpl.getProcessName(), packageName)) {
          return parseInput.error(
              "Heavy-weight applications can not have services in main process");
        }
            ...
            if (next == i8) {
              ...
              switch (i9) {
                ...
                case 1:
                  ...
                  if (addMetaData.isSuccess()) {
                    ParsedIntentInfoImpl parsedIntentInfoImpl =
                        (ParsedIntentInfoImpl) addMetaData.getResult();
                ...
                default:
                  ...
                  str3 = str4;
                  addMetaData =
                      ParsingUtils.unknownTag(str3, parsingPackage, xmlResourceParser2, parseInput);
                  str2 = str3;
                  i2 = depth;
                  i3 = i8;
                  i4 = i7;
