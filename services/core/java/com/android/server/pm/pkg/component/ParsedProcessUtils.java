...
public abstract class ParsedProcessUtils {
    ...
    */
    public static ParseResult parseProcesses(String[] strArr, ParsingPackage parsingPackage, Resources resources, XmlResourceParser xmlResourceParser, int i, ParseInput parseInput) {
        ParseResult parseAllowPermission;
