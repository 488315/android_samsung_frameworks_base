...
public class ParsedPermissionImpl extends ParsedComponentImpl implements ParsedPermission {
  ...
  public static final Parcelable.Creator CREATOR =
      new Parcelable
          .Creator() { // from class: com.android.server.pm.pkg.component.ParsedPermissionImpl.1
    ...
    this.parsedPermissionGroup =
        (ParsedPermissionGroup)
            parcel.readParcelable(
                ParsedPermissionGroup.class.getClassLoader(), ParsedPermissionGroupImpl.class);
  ...
  public ParsedPermissionImpl setParsedPermissionGroup(
