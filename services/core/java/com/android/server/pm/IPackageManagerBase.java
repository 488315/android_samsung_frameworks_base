...
public abstract class IPackageManagerBase extends IPackageManager.Stub {
  ...
  public IPackageManagerBase(
      ...
      Context context,
      DexOptHelper dexOptHelper,
      ModuleInfoProvider moduleInfoProvider,
      PreferredActivityHelper preferredActivityHelper,
      ResolveIntentHelper resolveIntentHelper,
  ...
  public final boolean activitySupportsIntentAsUser(
      ComponentName componentName, Intent intent, String str, int i) {
    return snapshot()
        .activitySupportsIntentAsUser(this.mResolveComponentName, componentName, intent, str, i);
  }

  public final void addCrossProfileIntentFilter(
      IntentFilter intentFilter, String str, int i, int i2, int i3) {
    this.mService.addCrossProfileIntentFilter(
        snapshot(), new WatchedIntentFilter(intentFilter), str, i, i2, i3);
  }
  ...
  public final boolean addPermission(PermissionInfo permissionInfo) {
    return ((PermissionManager) this.mContext.getSystemService(PermissionManager.class))
        .addPermission(permissionInfo, false);
  }

  public final boolean addPermissionAsync(PermissionInfo permissionInfo) {
    return ((PermissionManager) this.mContext.getSystemService(PermissionManager.class))
        .addPermission(permissionInfo, true);
  }

  public final void addPersistentPreferredActivity(
      IntentFilter intentFilter, ComponentName componentName, int i) {
    this.mPreferredActivityHelper.addPersistentPreferredActivity(
        new WatchedIntentFilter(intentFilter), componentName, i);
  }

  public final void addPreferredActivity(
      ...
      int i2,
      boolean z) {
    this.mPreferredActivityHelper.addPreferredActivity(
        snapshot(),
        new WatchedIntentFilter(intentFilter),
        i,
        componentNameArr,
        componentName,
        true,
  ...
  public final void deleteExistingPackageAsUser(
  ...
  public final void deletePackageAsUser(
      String str, int i, IPackageDeleteObserver iPackageDeleteObserver, int i2, int i3) {
    deletePackageVersioned(
        new VersionedPackage(str, i),
        new PackageManager.LegacyPackageDeleteObserver(iPackageDeleteObserver).getBinder(),
        i2,
        i3);
  }

  public final void deletePackageVersioned(
  ...
  public final String getAttentionServicePackageName() {
    return this.mService.ensureSystemPackageName(
        snapshot(),
        this.mService.getPackageFromComponentString(
            R.string.data_usage_mobile_limit_snoozed_title));
  }
  ...
  public final int getInstallLocation() {
    return Settings.Global.getInt(
        this.mContext.getContentResolver(), "default_install_location", 0);
  }
  ...
  public final InstrumentationInfo getInstrumentationInfoAsUser(
  ...
  public final PackageInfo getPackageInfoVersioned(
      VersionedPackage versionedPackage, long j, int i) {
    return snapshot()
  ...
  public final void getPackageSizeInfo(
  ...
  public final String[] getPackagesForUid(int i) {
    snapshot()
        .enforceCrossUserOrProfilePermission(
            Binder.getCallingUid(), UserHandle.getUserId(i), false, false, "getPackagesForUid");
  ...
  public final PackageManager.Property getPropertyAsUser(
  ...
  public final String getRotationResolverPackageName() {
    return this.mService.ensureSystemPackageName(
        snapshot(), this.mService.getPackageFromComponentString(R.string.day));
  }
  ...
  public final String getSystemCaptionsServicePackageName() {
    return this.mService.ensureSystemPackageName(
        snapshot(), this.mService.getPackageFromComponentString(R.string.decline));
  }
      ...
      return (String)
          CollectionUtils.firstOrNull(
              ((RoleManager) this.mContext.getSystemService(RoleManager.class))
                  .getRoleHolders("android.app.role.SYSTEM_WELLBEING"));
    } finally {
  ...
  public final void grantRuntimePermission(String str, String str2, int i) {
    ((PermissionManager) this.mContext.getSystemService(PermissionManager.class))
        .grantRuntimePermission(str, str2, UserHandle.of(i));
  }
  ...
  public final boolean performDexOptMode(
  ...
  public final ParceledListSlice queryIntentActivities(Intent intent, String str, long j, int i) {
    ...
    try {
      ...
      List queryIntentActivitiesInternal =
          snapshot().queryIntentActivitiesInternal(intent, str, j, i);
      if (SemPersonaManager.isDoEnabled(i)
          && (semPersonaManager =
                  (SemPersonaManager) this.mContext.getSystemService(SemPersonaManager.class))
              != null
          && semPersonaManager.isAppSeparationPresent()) {
        queryIntentActivitiesInternal =
            semPersonaManager.getUpdatedListWithAppSeparation(queryIntentActivitiesInternal);
      }
  ...
  public final ParceledListSlice queryIntentActivityOptions(
      ComponentName componentName,
      Intent[] intentArr,
      String[] strArr,
      Intent intent,
    ...
    return new ParceledListSlice(
        this.mResolveIntentHelper.queryIntentActivityOptionsInternal(
            snapshot(), componentName, intentArr, strArr, intent, str, j, i));
  }

  public final ParceledListSlice queryIntentContentProviders(
      Intent intent, String str, long j, int i) {
    return new ParceledListSlice(
        this.mResolveIntentHelper.queryIntentContentProvidersInternal(
            snapshot(), intent, str, j, i));
  }
  ...
  public final ParceledListSlice queryIntentReceivers(Intent intent, String str, long j, int i) {
    return new ParceledListSlice(
        this.mResolveIntentHelper.queryIntentReceiversInternal(
            snapshot(), intent, str, j, i, Binder.getCallingUid()));
  }

  public final ParceledListSlice queryIntentServices(Intent intent, String str, long j, int i) {
    return new ParceledListSlice(
        snapshot().queryIntentServicesInternal(intent, str, j, i, Binder.getCallingUid(), false));
  }
  ...
  public final void replacePreferredActivity(
      IntentFilter intentFilter,
      int i,
      ComponentName[] componentNameArr,
      ComponentName componentName,
      int i2) {
    this.mPreferredActivityHelper.replacePreferredActivity(
        snapshot(), new WatchedIntentFilter(intentFilter), i, componentNameArr, componentName, i2);
  }
  ...
  public final ResolveInfo resolveIntent(Intent intent, String str, long j, int i) {
    return this.mResolveIntentHelper.resolveIntentInternal(
        snapshot(), intent, str, j, 0L, i, false, Binder.getCallingUid());
  }

  public final ResolveInfo resolveService(Intent intent, String str, long j, int i) {
    return this.mResolveIntentHelper.resolveServiceInternal(
        snapshot(), intent, str, j, i, Binder.getCallingUid());
  }
  ...
  public final void setLastChosenActivity(
      Intent intent,
      String str,
      int i,
      IntentFilter intentFilter,
      int i2,
      ComponentName componentName) {
    this.mPreferredActivityHelper.setLastChosenActivity(
        snapshot(), intent, str, i, new WatchedIntentFilter(intentFilter), i2, componentName);
  }
  ...
  public final void verifyIntentFilter(int i, int i2, List list) {
    DomainVerificationProxyV1.queueLegacyVerifyResult(
        this.mContext, this.mDomainVerificationConnection, i, i2, list, Binder.getCallingUid());
  }
  ...
  public final boolean isSystemCompressedPackage(String str, int i) {
    ...
    PackageStateInternal packageStateForInstalledAndFiltered =
        snapshot.getPackageStateForInstalledAndFiltered(str, callingUid, i);
    return packageStateForInstalledAndFiltered != null
        && (disabledSystemPackage = snapshot.getDisabledSystemPackage(str)) != null
        && disabledSystemPackage.getPkg().isStub()
        && packageStateForInstalledAndFiltered.getPkg().getLongVersionCode()
            == disabledSystemPackage.getPkg().getLongVersionCode();
  }
}
