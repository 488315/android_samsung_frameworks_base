...
public class PackageManagerLocalImpl implements PackageManagerLocal {
  ...
  public class UnfilteredSnapshotImpl extends BaseSnapshotImpl
    ...
    public Map getDisabledSystemPackageStates() {
      ...
      if (this.mCachedUnmodifiableDisabledSystemPackageStates == null) {
        this.mCachedUnmodifiableDisabledSystemPackageStates =
            Collections.unmodifiableMap(this.mSnapshot.getDisabledSystemPackageStates());
      }
  ...
  public class FilteredSnapshotImpl extends BaseSnapshotImpl
