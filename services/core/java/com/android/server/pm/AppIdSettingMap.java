...
public final class AppIdSettingMap {
  ...
  public AppIdSettingMap() {
    ...
    this.mSystemSettingsSnapshot =
        new SnapshotCache.Auto(
            watchedSparseArray, watchedSparseArray, "AppIdSettingMap.mSystemSettings");
  }
  ...
  public boolean registerExistingAppId(int i, SettingBase settingBase, Object obj) {
    if (i >= 10000) {
      ...
      if (this.mNonSystemSettings.get(i2) != null) {
        PackageManagerService.reportSettingsProblem(
            5, "Adding duplicate app id: " + i + " name=" + obj);
        return false;
      }
    ...
    if (this.mSystemSettings.get(i) != null) {
      PackageManagerService.reportSettingsProblem(
          5, "Adding duplicate shared id: " + i + " name=" + obj);
      return false;
    }
  ...
  public void replaceSetting(int i, SettingBase settingBase) {
    if (i >= 10000) {
      ...
      PackageManagerService.reportSettingsProblem(
          5,
          "Error in package manager settings: calling replaceAppIdLpw to replace SettingBase at"
              + " appId="
              + i
