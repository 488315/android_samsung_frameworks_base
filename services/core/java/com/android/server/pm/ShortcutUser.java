...
public class ShortcutUser {
    ...
    */
    public static ShortcutUser loadFromXml(final ShortcutService shortcutService, TypedXmlPullParser typedXmlPullParser, final int i, final boolean z) {
        char c;
        ...
        try {
            ...
            if (z2) {
                ...
                forMainFilesIn(new File(injectUserDataPath, "packages"), new Consumer() { // from class: com.android.server.pm.ShortcutUser$$ExternalSyntheticLambda0
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        ShortcutUser.lambda$loadFromXml$3(ShortcutService.this, shortcutUser, z, (File) obj);
                    }
                });
                forMainFilesIn(new File(injectUserDataPath, "launchers"), new Consumer() { // from class: com.android.server.pm.ShortcutUser$$ExternalSyntheticLambda1
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
