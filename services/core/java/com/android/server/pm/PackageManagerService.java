...
public class PackageManagerService implements PackageSender, TestUtilityService {
  ...
  public final PackageStateMutator mPackageStateMutator =
      new PackageStateMutator(
          new Function() { // from class:
            // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda1
          ...
          new Function() { // from class:
            // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
  ...
  enum InstallLocaleOverlaysType {
    PACKAGE_INSTALL,
    PACKAGE_UNINSTALL_UPDATES,
    PACKAGE_ENABLE
  }

  public static /* synthetic */ DomainVerificationManagerInternal lambda$main$34(
  ...
  static {
    ...
    SYSTEM_PARTITIONS =
        Collections.unmodifiableList(
            PackagePartitions.getOrderedPartitions(
                new Function() { // from class:
                  // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda11
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
    ...
    BACKGROUND_HANDLER_CALLBACK =
        new Handler.Callback() { // from class: com.android.server.pm.PackageManagerService.2
  ...
  public class Snapshot {
    ...
    public Snapshot(int i) {
      if (i == 2) {
        ...
        this.isolatedOwners =
            (WatchedSparseIntArray) PackageManagerService.this.mIsolatedOwnersSnapshot.snapshot();
        this.packages = (WatchedArrayMap) PackageManagerService.this.mPackagesSnapshot.snapshot();
        this.instrumentation =
            (WatchedArrayMap) PackageManagerService.this.mInstrumentationSnapshot.snapshot();
        ...
        this.instantAppInstallerActivity =
            PackageManagerService.this.mInstantAppInstallerActivity == null
                ? null
                : new ActivityInfo(PackageManagerService.this.mInstantAppInstallerActivity);
        this.instantAppInstallerInfo =
            new ResolveInfo(PackageManagerService.this.mInstantAppInstallerInfo);
        ...
        this.androidApplication =
            PackageManagerService.this.mAndroidApplication != null
                ? new ApplicationInfo(PackageManagerService.this.mAndroidApplication)
                : null;
        ...
        this.frozenPackages =
            (WatchedArrayMap) PackageManagerService.this.mFrozenPackagesSnapshot.snapshot();
  ...
  public final Computer rebuildSnapshot(Computer computer, int i) {
    ...
    if (snapshotStatistics != null) {
      snapshotStatistics.rebuild(
          currentTimeMicro, currentTimeMicro2, used, computerEngine.getPackageStates().size());
    }
    ...
    if (installRequest.getObserver() != null) {
      try {
        PmLog.logDebugInfoAndLogcat(
            "result of install: "
                + installRequest.getReturnCode()
                + "{"
                + installRequest.getObserver().hashCode()
                + "}");
        installRequest
            .getObserver()
            .onPackageInstalled(
                installRequest.getName(),
                installRequest.getReturnCode(),
                installRequest.getReturnMsg(),
                extrasForInstallResult(installRequest));
  ...
  public static long getPruneUnusedSharedLibrariesDelay() {
    return SystemProperties.getLong(
        "debug.pm.prune_unused_shared_libraries_delay", PRUNE_UNUSED_SHARED_LIBRARIES_DELAY);
  }
  ...
  public void requestFileChecksums(
    ...
    backgroundExecutor.execute(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
          public final void run() {
            PackageManagerService.this.lambda$requestFileChecksums$3(
                backgroundHandler,
                arrayList,
                i,
                i2,
  ...
  public /* synthetic */ void lambda$requestFileChecksums$3(
    ...
    ApkChecksums.Injector.Producer producer = new ApkChecksums.Injector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda21
          @Override // com.android.server.pm.ApkChecksums.Injector.Producer
          public final Object produce() {
            Context lambda$requestFileChecksums$0;
            lambda$requestFileChecksums$0 =
                PackageManagerService.this.lambda$requestFileChecksums$0();
            return lambda$requestFileChecksums$0;
          }
        };
    ApkChecksums.Injector.Producer producer2 = new ApkChecksums.Injector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda22
          @Override // com.android.server.pm.ApkChecksums.Injector.Producer
          public final Object produce() {
            Handler lambda$requestFileChecksums$1;
            lambda$requestFileChecksums$1 =
                PackageManagerService.lambda$requestFileChecksums$1(handler);
    ...
    ApkChecksums.getChecksums(
        ...
        new ApkChecksums.Injector(
            producer,
            producer2,
            new PackageManagerService$$ExternalSyntheticLambda15(packageManagerServiceInjector),
            new ApkChecksums.Injector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda23
              @Override // com.android.server.pm.ApkChecksums.Injector.Producer
              public final Object produce() {
                PackageManagerInternal lambda$requestFileChecksums$2;
                lambda$requestFileChecksums$2 =
                    PackageManagerService.this.lambda$requestFileChecksums$2();
  ...
  public void requestChecksumsInternal(
      Computer computer,
      String str,
      boolean z,
      final int i,
    ...
    ApplicationInfo applicationInfoInternal =
        computer.getApplicationInfoInternal(str, 0L, Binder.getCallingUid(), i3);
    ...
    if (z && (strArr = applicationInfoInternal.splitNames) != null) {
      ...
      for (int i4 = 0; i4 < length; i4++) {
        arrayList.add(
            Pair.create(
                applicationInfoInternal.splitNames[i4],
                new File(applicationInfoInternal.splitSourceDirs[i4])));
      }
    }
    final Certificate[] decodeCertificates = list != null ? decodeCertificates(list) : null;
    executor.execute(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
            PackageManagerService.this.lambda$requestChecksumsInternal$7(
                handler, arrayList, i, i2, str2, decodeCertificates, iOnChecksumsReadyListener);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$requestChecksumsInternal$7(
      final Handler handler,
      List list,
      int i,
      int i2,
      ...
      IOnChecksumsReadyListener iOnChecksumsReadyListener) {
    ApkChecksums.Injector.Producer producer = new ApkChecksums.Injector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda13
          @Override // com.android.server.pm.ApkChecksums.Injector.Producer
          public final Object produce() {
            Context lambda$requestChecksumsInternal$4;
            lambda$requestChecksumsInternal$4 =
                PackageManagerService.this.lambda$requestChecksumsInternal$4();
            return lambda$requestChecksumsInternal$4;
          }
        };
    ApkChecksums.Injector.Producer producer2 = new ApkChecksums.Injector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda14
          @Override // com.android.server.pm.ApkChecksums.Injector.Producer
          public final Object produce() {
            Handler lambda$requestChecksumsInternal$5;
            lambda$requestChecksumsInternal$5 =
                PackageManagerService.lambda$requestChecksumsInternal$5(handler);
    ...
    ApkChecksums.getChecksums(
        ...
        new ApkChecksums.Injector(
            ...
            new PackageManagerService$$ExternalSyntheticLambda15(packageManagerServiceInjector),
            new ApkChecksums.Injector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda16
              @Override // com.android.server.pm.ApkChecksums.Injector.Producer
              public final Object produce() {
                PackageManagerInternal lambda$requestChecksumsInternal$6;
                lambda$requestChecksumsInternal$6 =
                    PackageManagerService.this.lambda$requestChecksumsInternal$6();
        ...
        certificateArr[i] =
            (X509Certificate)
                certificateFactory.generateCertificate(
                    new ByteArrayInputStream((byte[]) list.get(i)));
      }
  ...
  public static Bundle extrasForInstallResult(InstallRequest installRequest) {
    ...
    if (returnCode != -112) {
      ...
      bundle.putBoolean(
          ...
          (installRequest.getRemovedInfo() == null
                  || installRequest.getRemovedInfo().mRemovedPackage == null)
              ? false
              : true);
    } else {
      bundle = new Bundle();
      bundle.putString(
          ...
          installRequest.getOrigPermission());
      bundle.putString(
          "android.content.pm.extra.FAILURE_EXISTING_PACKAGE", installRequest.getOrigPackage());
    }
    return bundle;
  }
  ...
  public void writePendingRestrictions() {
    synchronized (this.mLock) {
      ...
      synchronized (this.mDirtyUsers) {
        ...
        Integer[] numArr =
            (Integer[])
                this.mDirtyUsers.toArray(
                    new IntFunction() { // from class:
                      // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda12
                      @Override // java.util.function.IntFunction
                      public final Object apply(int i) {
                        Integer[] lambda$writePendingRestrictions$8;
                        lambda$writePendingRestrictions$8 =
                            PackageManagerService.lambda$writePendingRestrictions$8(i);
  ...
  public static PackageManagerService main(
      ...
      final DomainVerificationService domainVerificationService,
      boolean z) {
    PackageManagerServiceCompilerMapping.checkProperties();
    TimingsTraceAndSlog timingsTraceAndSlog =
        new TimingsTraceAndSlog("PackageManagerTiming", 262144L);
    ...
    PackageManagerServiceInjector.Producer producer =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda26
          ...
          public final Object produce(
            ...
            lambda$main$9 =
                PackageManagerService.lambda$main$9(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$9;
          }
        };
    PackageManagerServiceInjector.Producer producer2 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda37
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$10 =
                PackageManagerService.lambda$main$10(
                    context, packageManagerServiceInjector, packageManagerService);
            return lambda$main$10;
          }
        };
    PackageManagerServiceInjector.Producer producer3 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda48
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$11 =
                PackageManagerService.lambda$main$11(
                    context,
                    installer,
                    obj,
    ...
    PackageManagerServiceInjector.Producer producer4 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda52
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$12 =
                PackageManagerService.lambda$main$12(
    ...
    PackageManagerServiceInjector.Producer producer5 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda53
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$13 =
                PackageManagerService.lambda$main$13(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$13;
          }
        };
    PackageManagerServiceInjector.Producer producer6 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda54
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$14 =
                PackageManagerService.lambda$main$14(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$14;
          }
        };
    PackageManagerServiceInjector.Producer producer7 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda55
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            SystemConfig lambda$main$15;
            lambda$main$15 =
                PackageManagerService.lambda$main$15(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$15;
          }
        };
    PackageManagerServiceInjector.Producer producer8 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda56
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$16 =
                PackageManagerService.lambda$main$16(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$16;
          }
        };
    PackageManagerServiceInjector.Producer producer9 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda57
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$17 =
                PackageManagerService.lambda$main$17(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$17;
          }
        };
    PackageManagerServiceInjector.Producer producer10 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda58
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$18 =
                PackageManagerService.lambda$main$18(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$18;
          }
        };
    PackageManagerServiceInjector.Producer producer11 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda27
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$19 =
                PackageManagerService.lambda$main$19(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$19;
          }
        };
    PackageManagerServiceInjector.Producer producer12 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda28
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ApexManager lambda$main$20;
            lambda$main$20 =
                PackageManagerService.lambda$main$20(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$20;
          }
        };
    PackageManagerServiceInjector.Producer producer13 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda29
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$21 =
                PackageManagerService.lambda$main$21(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$21;
          }
        };
    PackageManagerServiceInjector.Producer producer14 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda30
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$22 =
                PackageManagerService.lambda$main$22(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$22;
          }
        };
    PackageManagerServiceInjector.Producer producer15 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda31
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$25 =
                PackageManagerService.lambda$main$25(
                    context, packageManagerServiceInjector, packageManagerService);
            return lambda$main$25;
          }
        };
    PackageManagerServiceInjector.Producer producer16 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda32
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$26 =
                PackageManagerService.lambda$main$26(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$26;
          }
        };
    PackageManagerServiceInjector.Producer producer17 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda33
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$27 =
                PackageManagerService.lambda$main$27(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$27;
          }
        };
    PackageManagerServiceInjector.Producer producer18 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda34
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$28 =
                PackageManagerService.lambda$main$28(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$28;
          }
        };
    PackageManagerServiceInjector.Producer producer19 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda35
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$29 =
                PackageManagerService.lambda$main$29(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$29;
          }
        };
    PackageManagerServiceInjector.Producer producer20 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda36
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$30 =
                PackageManagerService.lambda$main$30(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$30;
          }
        };
    PackageManagerServiceInjector.ProducerWithArgument producerWithArgument =
        new PackageManagerServiceInjector.ProducerWithArgument() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda38
          ...
          public final Object produce(
            ...
            lambda$main$31 =
                PackageManagerService.lambda$main$31(
                    packageManagerServiceInjector, packageManagerService, (ComponentName) obj2);
            return lambda$main$31;
          }
        };
    PackageManagerServiceInjector.Producer producer21 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda39
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$32 =
                PackageManagerService.lambda$main$32(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$32;
          }
        };
    PackageManagerServiceInjector.Producer producer22 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda40
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$33 =
                PackageManagerService.lambda$main$33(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$33;
          }
        };
    PackageManagerServiceInjector.Producer producer23 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda41
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$34 =
                PackageManagerService.lambda$main$34(
                    DomainVerificationService.this,
                    packageManagerServiceInjector,
                    packageManagerService);
    ...
    PackageManagerServiceInjector.Producer producer24 =
        new PackageManagerServiceInjector.Producer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda42
          @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
          public final Object produce(
              PackageManagerServiceInjector packageManagerServiceInjector,
              PackageManagerService packageManagerService) {
            ...
            lambda$main$35 =
                PackageManagerService.lambda$main$35(
                    packageManagerServiceInjector, packageManagerService);
            return lambda$main$35;
          }
        };
    DefaultSystemWrapper defaultSystemWrapper = new DefaultSystemWrapper();
    PackageManagerServiceInjector.ServiceProducer serviceProducer =
        new PackageManagerServiceInjector.ServiceProducer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda43
    ...
    PackageManagerServiceInjector packageManagerServiceInjector =
        new PackageManagerServiceInjector(
            context,
            packageManagerTracedLock,
            installer,
            obj,
            ...
            serviceProducer,
            new PackageManagerServiceInjector.ServiceProducer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda44
              @Override // com.android.server.pm.PackageManagerServiceInjector.ServiceProducer
              public final Object produce(Class cls) {
            ...
            new PackageManagerServiceInjector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda45
              @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
              public final Object produce(
                ...
                lambda$main$36 =
                    PackageManagerService.lambda$main$36(
                        packageManagerServiceInjector2, packageManagerService);
                return lambda$main$36;
              }
            },
            new PackageManagerServiceInjector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda46
              @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
              public final Object produce(
                  PackageManagerServiceInjector packageManagerServiceInjector2,
                  PackageManagerService packageManagerService) {
                ...
                lambda$main$37 =
                    PackageManagerService.lambda$main$37(
                        packageManagerServiceInjector2, packageManagerService);
                return lambda$main$37;
              }
            },
            new PackageManagerServiceInjector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda47
              @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
              public final Object produce(
                  PackageManagerServiceInjector packageManagerServiceInjector2,
                  PackageManagerService packageManagerService) {
                ...
                lambda$main$38 =
                    PackageManagerService.lambda$main$38(
                        packageManagerServiceInjector2, packageManagerService);
                return lambda$main$38;
              }
            },
            new PackageManagerServiceInjector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda49
              @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
              public final Object produce(
                  PackageManagerServiceInjector packageManagerServiceInjector2,
                  PackageManagerService packageManagerService) {
                ...
                lambda$main$39 =
                    PackageManagerService.lambda$main$39(
                        context, packageManagerServiceInjector2, packageManagerService);
                return lambda$main$39;
              }
            },
            new PackageManagerServiceInjector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda50
              @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
              public final Object produce(
                  PackageManagerServiceInjector packageManagerServiceInjector2,
                  PackageManagerService packageManagerService) {
                ...
                lambda$main$40 =
                    PackageManagerService.lambda$main$40(
                        packageManagerServiceInjector2, packageManagerService);
                return lambda$main$40;
              }
            });
    final PackageManagerService packageManagerService =
    ...
    CompatChange.ChangeListener changeListener = new CompatChange.ChangeListener() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda51
  ...
  public static /* synthetic */ ComponentResolver lambda$main$9(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new ComponentResolver(
        packageManagerServiceInjector.getUserManagerService(),
        packageManagerService.mUserNeedsBadging);
  }

  public static /* synthetic */ PermissionManagerServiceInternal lambda$main$10(
      Context context,
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return PermissionManagerService.create(
        context, packageManagerServiceInjector.getSystemConfig().getAvailableFeatures());
  }

  public static /* synthetic */ UserManagerService lambda$main$11(
      Context context,
      Installer installer,
      Object obj,
    ...
    return new UserManagerService(
        context,
        packageManagerService,
        new UserDataPreparer(installer, obj, context),
        packageManagerTracedLock,
        sPersonaManager);
  }

  public static /* synthetic */ Settings lambda$main$12(
      DomainVerificationService domainVerificationService,
      Handler handler,
      PackageManagerTracedLock packageManagerTracedLock,
      PackageManagerServiceInjector packageManagerServiceInjector,
    ...
    return new Settings(
        ...
        packageManagerServiceInjector.getPermissionManagerServiceInternal(),
        domainVerificationService,
        handler,
        packageManagerTracedLock);
  }

  public static /* synthetic */ AppsFilterImpl lambda$main$13(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return AppsFilterImpl.create(
        packageManagerServiceInjector,
        (PackageManagerInternal)
            packageManagerServiceInjector.getLocalService(PackageManagerInternal.class));
  }

  public static /* synthetic */ PlatformCompat lambda$main$14(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return (PlatformCompat) ServiceManager.getService("platform_compat");
  }

  public static /* synthetic */ SystemConfig lambda$main$15(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return SystemConfig.getInstance();
  }

  public static /* synthetic */ PackageDexOptimizer lambda$main$16(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new PackageDexOptimizer(
        packageManagerServiceInjector.getInstaller(),
        packageManagerServiceInjector.getInstallLock(),
        packageManagerServiceInjector.getContext(),
        "*dexopt*");
  }

  public static /* synthetic */ DexManager lambda$main$17(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new DexManager(
        packageManagerServiceInjector.getContext(),
        packageManagerServiceInjector.getPackageDexOptimizer(),
        packageManagerServiceInjector.getInstaller(),
        packageManagerServiceInjector.getInstallLock(),
        packageManagerServiceInjector.getDynamicCodeLogger());
  }

  public static /* synthetic */ DynamicCodeLogger lambda$main$18(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new DynamicCodeLogger(packageManagerServiceInjector.getInstaller());
  }

  public static /* synthetic */ ArtManagerService lambda$main$19(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new ArtManagerService(
        packageManagerServiceInjector.getContext(),
        packageManagerServiceInjector.getInstaller(),
        packageManagerServiceInjector.getInstallLock());
  }

  public static /* synthetic */ ApexManager lambda$main$20(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return ApexManager.getInstance();
  }

  public static /* synthetic */ ViewCompiler lambda$main$21(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
  ...
  public static /* synthetic */ IncrementalManager lambda$main$22(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return (IncrementalManager)
        packageManagerServiceInjector.getContext().getSystemService("incremental");
  }
  ...
  public static /* synthetic */ DefaultAppProvider lambda$main$25(
      final Context context,
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new DefaultAppProvider(
        new Supplier() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda67
        ...
        new Supplier() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda68
          @Override // java.util.function.Supplier
          public final Object get() {
  ...
  public static /* synthetic */ DisplayMetrics lambda$main$26(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new DisplayMetrics();
  }

  public static /* synthetic */ PackageParser2 lambda$main$27(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new PackageParser2(
        packageManagerService.mSeparateProcesses,
        packageManagerServiceInjector.getDisplayMetrics(),
        packageManagerService.mCacheDir,
        packageManagerService.mPackageParserCallback);
  }

  public static /* synthetic */ PackageParser2 lambda$main$28(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new PackageParser2(
        packageManagerService.mSeparateProcesses,
  ...
  public static /* synthetic */ PackageParser2 lambda$main$29(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new PackageParser2(
        packageManagerService.mSeparateProcesses,
  ...
  public static /* synthetic */ PackageInstallerService lambda$main$30(
      final PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new PackageInstallerService(
        packageManagerServiceInjector.getContext(),
        packageManagerService,
        new Supplier() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda69
          @Override // java.util.function.Supplier
          public final Object get() {
  ...
  public static /* synthetic */ InstantAppResolverConnection lambda$main$31(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService,
      ComponentName componentName) {
    return new InstantAppResolverConnection(
        packageManagerServiceInjector.getContext(),
        componentName,
        "android.intent.action.RESOLVE_INSTANT_APP_PACKAGE");
  }

  public static /* synthetic */ ModuleInfoProvider lambda$main$32(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new ModuleInfoProvider(packageManagerServiceInjector.getContext());
  }

  public static /* synthetic */ LegacyPermissionManagerInternal lambda$main$33(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return LegacyPermissionManagerService.create(packageManagerServiceInjector.getContext());
  }

  public static /* synthetic */ Handler lambda$main$35(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
  ...
  public static /* synthetic */ BackgroundDexOptService lambda$main$36(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    ...
    try {
      return new BackgroundDexOptService(
          packageManagerServiceInjector.getContext(),
          packageManagerServiceInjector.getDexManager(),
          packageManagerService);
  ...
  public static /* synthetic */ IBackupManager lambda$main$37(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return IBackupManager.Stub.asInterface(ServiceManager.getService("backup"));
  }

  public static /* synthetic */ SharedLibrariesImpl lambda$main$38(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new SharedLibrariesImpl(packageManagerService, packageManagerServiceInjector);
  }

  public static /* synthetic */ CrossProfileIntentFilterHelper lambda$main$39(
      Context context,
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new CrossProfileIntentFilterHelper(
        packageManagerServiceInjector.getSettings(),
        packageManagerServiceInjector.getUserManagerService(),
        packageManagerServiceInjector.getLock(),
        packageManagerServiceInjector.getUserManagerInternal(),
        context);
  }

  public static /* synthetic */ UpdateOwnershipHelper lambda$main$40(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    return new UpdateOwnershipHelper();
  }

  public static /* synthetic */ void lambda$main$42(
      PackageManagerService packageManagerService, String str) {
    synchronized (packageManagerService.mInstallLock) {
      ...
      SharedUserApi sharedUser =
          snapshotComputer.getSharedUser(packageStateInternal.getSharedUserAppId());
      String seInfo = packageStateInternal.getSeInfo();
      if (pkg == null) {
        Slog.e("PackageManager", "Failed to find package " + str);
        return;
      }
      final String seInfo2 =
          SELinuxMMAC.getSeInfo(
              packageStateInternal,
              pkg,
              sharedUser,
              packageManagerService.mInjector.getCompatibility());
      if (!seInfo2.equals(seInfo)) {
        Slog.i(
            "PackageManager",
            "Updating seInfo for package " + str + " from: " + seInfo + " to: " + seInfo2);
        packageManagerService.commitPackageStateMutation(
            null,
            str,
            new Consumer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda61
  ...
  public final void installAllowlistedSystemPackages() {
    if (this.mUserManager.installWhitelistedSystemPackages(
        isFirstBoot(), isDeviceUpgrading(), this.mExistingPackages)) {
  ...
  public final void registerObservers(boolean z) {
    ...
    if (z) {
      Watchable.verifyWatchedAttributes(
          this, this.mWatcher, (this.mIsEngBuild || this.mIsUserDebugBuild) ? false : true);
    }
  }

  public PackageManagerService(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerServiceTestParams packageManagerServiceTestParams) {
    WatchedArrayMap watchedArrayMap = new WatchedArrayMap();
    this.mPackages = watchedArrayMap;
    this.mPackagesSnapshot =
        new SnapshotCache.Auto(watchedArrayMap, watchedArrayMap, "PackageManagerService.mPackages");
    WatchedSparseIntArray watchedSparseIntArray = new WatchedSparseIntArray();
    this.mIsolatedOwners = watchedSparseIntArray;
    this.mIsolatedOwnersSnapshot =
        new SnapshotCache.Auto(
            watchedSparseIntArray, watchedSparseIntArray, "PackageManagerService.mIsolatedOwners");
    this.mExistingPackages = null;
    WatchedArrayMap watchedArrayMap2 = new WatchedArrayMap();
    this.mFrozenPackages = watchedArrayMap2;
    this.mFrozenPackagesSnapshot =
        new SnapshotCache.Auto(
            watchedArrayMap2, watchedArrayMap2, "PackageManagerService.mFrozenPackages");
    ...
    this.mInstrumentationSnapshot =
        new SnapshotCache.Auto(
            watchedArrayMap3, watchedArrayMap3, "PackageManagerService.mInstrumentation");
    ...
    this.mWatcher =
        new Watcher() { // from class: com.android.server.pm.PackageManagerService.1
    ...
    this.mDomainVerificationManager =
        packageManagerServiceInjector.getDomainVerificationManagerInternal();
    ...
    SharedLibrariesImpl sharedLibrariesImpl =
        packageManagerServiceInjector.getSharedLibrariesImpl();
    ...
    this.mInstantAppResolverConnection =
        packageManagerServiceTestParams.instantAppResolverConnection;
    this.mInstantAppResolverSettingsComponent =
        packageManagerServiceTestParams.instantAppResolverSettingsComponent;
    ...
    this.mRequiredPermissionControllerPackage =
        packageManagerServiceTestParams.requiredPermissionControllerPackage;
    ...
    this.mDefaultTextClassifierPackage =
        packageManagerServiceTestParams.defaultTextClassifierPackage;
    this.mSystemTextClassifierPackageName =
        packageManagerServiceTestParams.systemTextClassifierPackage;
    ...
    this.mAmbientContextDetectionPackage =
        packageManagerServiceTestParams.ambientContextDetectionPackage;
    ...
    this.mIncidentReportApproverPackage =
        packageManagerServiceTestParams.incidentReportApproverPackage;
    this.mServicesExtensionPackageName =
        packageManagerServiceTestParams.servicesExtensionPackageName;
    this.mSharedSystemSharedLibraryPackageName =
        packageManagerServiceTestParams.sharedSystemSharedLibraryPackageName;
    this.mOverlayConfigSignaturePackage =
        packageManagerServiceTestParams.overlayConfigSignaturePackage;
    ...
    this.mInitialNonStoppedSystemPackages =
        packageManagerServiceTestParams.initialNonStoppedSystemPackages;
    this.mShouldStopSystemPackagesByDefault =
        packageManagerServiceTestParams.shouldStopSystemPackagesByDefault;
    ...
    this.mEmergencyModePackageHandler =
        new EmergencyModePackageHandler(
            context,
            this,
            packageManagerServiceInjector.getUserManagerInternal(),
            protectedPackages);
  ...
  public PackageManagerService(
    ...
    PmCustomInjector pmCustomInjector =
        new PmCustomInjector(
            packageManagerServiceInjector,
            this,
            new PmCustomInjector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda62
              ...
              public final Object produce(
                ...
                lambda$new$46 =
                    PackageManagerService.lambda$new$46(
                        packageManagerServiceInjector2, packageManagerService);
                return lambda$new$46;
              }
            },
            new PmCustomInjector.Producer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda63
              @Override // com.samsung.android.server.pm.lifecycle.PmCustomInjector.Producer
              public final Object produce(
                  PackageManagerServiceInjector packageManagerServiceInjector2,
                  PackageManagerService packageManagerService) {
                ...
                lambda$new$47 =
                    PackageManagerService.lambda$new$47(
                        PackageManagerServiceInjector.this,
    ...
    PmLifecycleImpl pmLifecycleImpl =
        new PmLifecycleImpl(this, packageManagerServiceInjector, pmCustomInjector);
    this.mPmLifecycle = pmLifecycleImpl;
    pmLifecycleImpl.onInstalldStarting();
    this.mTestUtilityService =
        (TestUtilityService) LocalServices.getService(TestUtilityService.class);
    UserManagerService userManagerService = packageManagerServiceInjector.getUserManagerService();
    this.mUserManager = userManagerService;
    ...
    this.mLegacyPermissionManager =
        packageManagerServiceInjector.getLegacyPermissionManagerInternal();
    final PlatformCompat compatibility = packageManagerServiceInjector.getCompatibility();
    this.mPackageParserCallback =
        new PackageParser2.Callback() { // from class: com.android.server.pm.PackageManagerService.3
    ...
    this.mInstantAppRegistry =
        new InstantAppRegistry(
            context,
            permissionManagerServiceInternal,
            packageManagerServiceInjector.getUserManagerInternal(),
            new DeletePackageHelper(this));
    ...
    DomainVerificationConnection domainVerificationConnection =
        new DomainVerificationConnection(this);
    ...
    DeletePackageHelper deletePackageHelper =
        new DeletePackageHelper(this, removePackageHelper, appDataHelper);
    this.mDeletePackageHelper = deletePackageHelper;
    sharedLibrariesImpl.setDeletePackageHelper(deletePackageHelper);
    ...
    this.mResolveIntentHelper =
        new ResolveIntentHelper(
            ...
            new Supplier() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda64
              @Override // java.util.function.Supplier
              public final Object get() {
            ...
            new Supplier() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda65
              @Override // java.util.function.Supplier
              public final Object get() {
    ...
    this.mDistractingPackageHelper =
        new DistractingPackageHelper(
            this, packageManagerServiceInjector, broadcastHelper, suspendPackageHelper);
    AsecInstallHelper asecInstallHelper = new AsecInstallHelper(this);
    this.mAsecInstallHelper = asecInstallHelper;
    this.mStorageEventHelper =
        new StorageEventHelper(this, deletePackageHelper, removePackageHelper, asecInstallHelper);
    synchronized (lock) {
    ...
    synchronized (this.mInstallLock) {
      synchronized (this.mLock) {
        ...
        this.mEmergencyModePackageHandler =
            new EmergencyModePackageHandler(
                this.mContext, this, this.mInjector.getUserManagerInternal(), protectedPackages);
        ...
        for (int i2 = 0; i2 < size; i2++) {
          this.mSharedLibraries.addBuiltInSharedLibraryLPw(
              (SystemConfig.SharedLibraryEntry) sharedLibraries.valueAt(i2));
        }
        for (int i3 = 0; i3 < size; i3++) {
          String str5 = (String) sharedLibraries.keyAt(i3);
          SystemConfig.SharedLibraryEntry sharedLibraryEntry =
              (SystemConfig.SharedLibraryEntry) sharedLibraries.valueAt(i3);
          int length = sharedLibraryEntry.dependencies.length;
          for (int i4 = 0; i4 < length; i4++) {
            SharedLibraryInfo sharedLibraryInfo =
                computerLocked.getSharedLibraryInfo(sharedLibraryEntry.dependencies[i4], -1L);
        ...
        this.mFirstBoot =
            !this.mSettings.readLPw(
                computerLocked,
                this.mInjector.getUserManagerInternal().getUsers(true, false, false),
                this.mCustomInjector.getPackageManagerBackupController());
        timingsTraceAndSlog.traceEnd();
        if (this.mFirstBoot) {
        ...
        String string = Resources.getSystem().getString(R.string.country_selection_title);
        if (!TextUtils.isEmpty(string)) {
          this.mCustomResolverComponentName = ComponentName.unflattenFromString(string);
        }
        synchronized (this.mAvailableFeatures) {
          NfcFeatureManager.updateFeatureAndPackage(
              this.mAvailableFeatures, this.mCustomInjector.getSkippingApks(), this.mFactoryTest);
        }
        ...
        if (z4) {
          PackageManagerServiceUtils.logCriticalInfo(
              4,
              "Upgrading from "
                  + internalVersion.fingerprint
                  + " ("
                  + internalVersion.buildFingerprint
                  + ") to "
                  + PackagePartitions.FINGERPRINT
                  + " ("
                  + Build.FINGERPRINT
        ...
        if (z4 || this.mFirstBoot) {
          PackageManagerServiceUtils.logCriticalInfo(
              5,
              "[PM]Build Info: "
                  + SystemProperties.get("ro.omc.build.id")
                  + PackageManagerShellCommandDataLoader.STDIN_PATH
                  + Build.FINGERPRINT);
          SystemProperties.set("sys.boot.is_upgrade", "1");
        }
        this.mInitAppsHelper =
            new InitAppsHelper(
                this,
                this.mApexManager,
                this.mInstallPackageHelper,
                this.mInjector.getSystemPartitions());
        ...
        if (isDeviceUpgrading()) {
          ...
          this.mInjector
              .getCrossProfileIntentFilterHelper()
              .updateDefaultCrossProfileIntentFilter();
          timingsTraceAndSlog.traceEnd();
        }
        this.mCacheDir =
            PackageManagerServiceUtils.preparePackageParserCache(
                this.mIsEngBuild, this.mIsUserDebugBuild, this.mIncrementalVersion);
        this.mInitialNonStoppedSystemPackages =
            this.mInjector.getSystemConfig().getInitialNonStoppedSystemPackages();
        this.mShouldStopSystemPackagesByDefault =
            this.mContext
                .getResources()
                .getBoolean(R.bool.config_send_satellite_datagram_to_modem_in_demo_mode);
        this.mPmLifecycle.onSystemScanning(this.mCacheDir);
        final int[] userIds = this.mUserManager.getUserIds();
        PackageParser2 scanningCachingPackageParser =
            this.mInjector.getScanningCachingPackageParser();
        this.mOverlayConfig =
            this.mInitAppsHelper.initSystemApps(
                scanningCachingPackageParser, packagesLocked, userIds, uptimeMillis);
        ...
        this.mRequiredVerifierPackages =
            getRequiredButNotReallyRequiredVerifiersLPr(computerLocked);
        ...
        this.mRequiredPermissionControllerPackage =
            getRequiredPermissionControllerLPr(computerLocked);
        ...
        this.mDefaultTextClassifierPackage =
            ensureSystemPackageName(
                computerLocked, this.mContext.getString(R.string.ext_media_move_success_title));
        this.mSystemTextClassifierPackageName =
            ensureSystemPackageName(
                computerLocked, this.mContext.getString(R.string.decline_remote_bugreport_action));
        this.mConfiguratorPackage =
            ensureSystemPackageName(
                computerLocked, this.mContext.getString(R.string.default_browser));
        this.mAppPredictionServicePackage =
            ensureSystemPackageName(
                computerLocked, getPackageFromComponentString(R.string.data_usage_limit_body));
        this.mIncidentReportApproverPackage =
            ensureSystemPackageName(
                computerLocked, this.mContext.getString(R.string.dump_heap_text));
        this.mRetailDemoPackage = getRetailDemoPackageName();
        this.mOverlayConfigSignaturePackage =
            ensureSystemPackageName(
                computerLocked,
                this.mInjector.getSystemConfig().getOverlayConfigSignaturePackage());
        this.mRecentsPackage =
            ensureSystemPackageName(
                computerLocked,
                getPackageFromComponentString(R.string.etws_primary_default_message_test));
        this.mAmbientContextDetectionPackage =
            ensureSystemPackageName(
                computerLocked, getPackageFromComponentString(R.string.data_saver_enable_title));
        this.mWearableSensingPackage =
            ensureSystemPackageName(
                computerLocked,
                getPackageFromComponentString(R.string.default_audio_route_name_external_device));
        this.mSharedLibraries.updateAllSharedLibrariesLPw(
            null, null, Collections.unmodifiableMap(this.mPackages));
        for (SharedUserSetting sharedUserSetting : this.mSettings.getAllSharedUsersLPw()) {
          List applyAdjustedAbiToSharedUser =
              ScanPackageUtils.applyAdjustedAbiToSharedUser(
                  ...
                  this.mInjector
                      .getAbiHelper()
                      .getAdjustedAbiForSharedUser(sharedUserSetting.getPackageStates(), null));
          if (!DexOptHelper.useArtService()
              && applyAdjustedAbiToSharedUser != null
              && applyAdjustedAbiToSharedUser.size() > 0) {
            for (int size2 = applyAdjustedAbiToSharedUser.size() - 1; size2 >= 0; size2--) {
              try {
                this.mInstaller.rmdex(
                    (String) applyAdjustedAbiToSharedUser.get(size2),
                    InstructionSets.getDexCodeInstructionSet(
                        InstructionSets.getPreferredInstructionSet()));
        ...
        Slog.i(
            ...
            "Time to scan packages: "
                + ((SystemClock.uptimeMillis() - uptimeMillis) / 1000.0f)
                + " seconds");
        if (this.mIsUpgrade) {
          Slog.i(
              "PackageManager",
        ...
        this.mPermissionManager.onStorageVolumeMounted(
            StorageManager.UUID_PRIVATE_INTERNAL, this.mIsUpgrade);
        ...
        if (this.mIsUpgrade) {
          ...
          for (int i5 = 0; i5 < packagesLocked.size(); i5++) {
            ...
            if (Objects.equals(
                StorageManager.UUID_PRIVATE_INTERNAL, packageSetting.getVolumeUuid())) {
        ...
        if (this.mIsPreQUpgrade) {
          ...
          for (int i6 = 0; i6 < size3; i6++) {
            ...
            if ((packageSetting2.getFlags() & 1) == 0) {
              packageSetting2.disableComponentLPw(
                  PackageManager.APP_DETAILS_ACTIVITY_CLASS_NAME, 0);
            }
          }
        }
        ...
        ComponentName intentFilterVerifierComponentNameLPr =
            getIntentFilterVerifierComponentNameLPr(computerLocked);
        ComponentName domainVerificationAgentComponentNameLPr =
            getDomainVerificationAgentComponentNameLPr(computerLocked);
        Context context2 = this.mContext;
        DomainVerificationManagerInternal domainVerificationManagerInternal2 =
            this.mDomainVerificationManager;
        this.mDomainVerificationManager.setProxy(
            DomainVerificationProxy.makeProxy(
                intentFilterVerifierComponentNameLPr,
                domainVerificationAgentComponentNameLPr,
                context2,
                domainVerificationManagerInternal2,
                domainVerificationManagerInternal2.getCollector(),
                this.mDomainVerificationConnection));
        this.mServicesExtensionPackageName = getRequiredServicesExtensionPackageLPr(computerLocked);
        this.mSharedSystemSharedLibraryPackageName =
            getRequiredSharedLibrary(computerLocked, "android.ext.shared", -1);
        this.mSettings.setPermissionControllerVersion(
            computerLocked
                .getPackageInfo(this.mRequiredPermissionControllerPackage, 0L, 0)
                .getLongVersionCode());
        ...
        forEachPackageState(
            computerLocked,
            new Consumer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda66
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
        ...
        if (instantAppResolver != null) {
          ...
          this.mInstantAppResolverConnection =
              this.mInjector.getInstantAppResolverConnection(instantAppResolver);
          this.mInstantAppResolverSettingsComponent =
              getInstantAppResolverSettingsLPr(computerLocked, instantAppResolver);
          str3 = null;
        } else {
          str3 = null;
          ...
          for (Map.Entry entry : systemConfig.getAppMetadataFilePaths().entrySet()) {
            ...
            if (disabledSystemPkgLPr == null) {
              ...
              if (packageLPr != null) {
                ...
                Slog.w(
                    "PackageManager",
                    "Cannot set app metadata file for nonexistent package " + str8);
              }
            } else {
  ...
  public static /* synthetic */ MultiUserInstallPolicy lambda$new$46(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerService packageManagerService) {
    Settings settings = packageManagerServiceInjector.getSettings();
    Objects.requireNonNull(settings);
    return new MultiUserInstallPolicy(
        new MultiUserInstallPolicy.PackageSettingsDelegator(
            new PackageManagerService$$ExternalSyntheticLambda71(settings),
            new TriConsumer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda73
              public final void accept(Object obj, Object obj2, Object obj3) {
                PackageManagerService.lambda$new$43(
                    (PackageSetting) obj, (Boolean) obj2, (Integer) obj3);
              }
            },
            new TriConsumer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda74
              public final void accept(Object obj, Object obj2, Object obj3) {
                PackageManagerService.lambda$new$44(
                    (PackageSetting) obj, (Integer) obj2, (Integer) obj3);
              }
            },
            new TriConsumer() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda75
              public final void accept(Object obj, Object obj2, Object obj3) {
                PackageManagerService.lambda$new$45(
                    (PackageSetting) obj, (String) obj2, (Integer) obj3);
              }
            }),
        new MetaDataHelper(),
  ...
  public static /* synthetic */ void lambda$new$43(
      PackageSetting packageSetting, Boolean bool, Integer num) {
    packageSetting.setInstalled(bool.booleanValue(), num.intValue());
  }

  public static /* synthetic */ void lambda$new$44(
      PackageSetting packageSetting, Integer num, Integer num2) {
    packageSetting.setEnabled(num.intValue(), num2.intValue(), null);
  }

  public static /* synthetic */ void lambda$new$45(
      PackageSetting packageSetting, String str, Integer num) {
    packageSetting.addDisabledComponent(str, num.intValue());
  }

  public static /* synthetic */ UnknownSourceAppManager lambda$new$47(
      PackageManagerServiceInjector packageManagerServiceInjector,
      PackageManagerServiceInjector packageManagerServiceInjector2,
      PackageManagerService packageManagerService) {
    Handler handler = packageManagerServiceInjector.getHandler();
    ...
    Objects.requireNonNull(settings);
    return new UnknownSourceAppManager(
        handler,
        new UnknownSourceAppManager.PackageSettingsDelegator(
            new PackageManagerService$$ExternalSyntheticLambda71(settings)));
  }
  ...
  public final String[] getRequiredButNotReallyRequiredVerifiersLPr(Computer computer) {
    List queryIntentReceiversInternal =
        this.mResolveIntentHelper.queryIntentReceiversInternal(
            computer,
            new Intent("android.intent.action.PACKAGE_NEEDS_VERIFICATION"),
    ...
    if (size <= 2) {
      ...
      for (int i = 0; i < size; i++) {
        String str =
            ((ResolveInfo) queryIntentReceiversInternal.get(i)).getComponentInfo().packageName;
        strArr[i] = str;
    ...
    throw new RuntimeException(
        "There must be no more than 2 verifiers; found " + queryIntentReceiversInternal);
  }
  ...
  public final String getRequiredServicesExtensionPackageLPr(Computer computer) {
    String ensureSystemPackageName =
        ensureSystemPackageName(
            computer, this.mContext.getString(R.string.ext_media_move_success_title));
    if (TextUtils.isEmpty(ensureSystemPackageName)) {
      throw new RuntimeException(
          "Required services extension package is missing, check config_servicesExtensionPackage.");
    }
  ...
  public final String getRequiredInstallerLPr(Computer computer) {
    ...
    intent.setDataAndType(
        Uri.parse("content://com.example/foo.apk"), "application/vnd.android.package-archive");
    List queryIntentActivitiesInternal =
        computer.queryIntentActivitiesInternal(
            intent, "application/vnd.android.package-archive", 1835008L, 0);
    if (queryIntentActivitiesInternal.size() == 1) {
      if (!((ResolveInfo) queryIntentActivitiesInternal.get(0))
          .activityInfo.applicationInfo.isPrivilegedApp()) {
    ...
    throw new RuntimeException(
        "There must be exactly one installer; found " + queryIntentActivitiesInternal);
  }
  ...
  public final String getRequiredUninstallerLPr(Computer computer) {
    ...
    ResolveInfo resolveIntentInternal =
        this.mResolveIntentHelper.resolveIntentInternal(
            computer, intent, null, 1835008L, 0L, 0, false, Binder.getCallingUid());
    if (resolveIntentInternal == null
        || this.mResolveActivity.name.equals(resolveIntentInternal.getComponentInfo().name)) {
      throwSystemRequiredPackageState(computer, intent, null);
      throw new RuntimeException(
          "There must be exactly one uninstaller; found " + resolveIntentInternal);
    }
  ...
  public final String getRequiredPermissionControllerLPr(Computer computer) {
    ...
    intent.addCategory("android.intent.category.DEFAULT");
    List queryIntentActivitiesInternal =
        computer.queryIntentActivitiesInternal(intent, null, 1835008L, 0);
    if (queryIntentActivitiesInternal.size() == 1) {
      if (!((ResolveInfo) queryIntentActivitiesInternal.get(0))
          .activityInfo.applicationInfo.isPrivilegedApp()) {
    ...
    throw new RuntimeException(
        "There must be exactly one permissions manager; found " + queryIntentActivitiesInternal);
  }

  public final void throwSystemRequiredPackageState(Computer computer, Intent intent, String str) {
    List queryIntentActivitiesInternal =
        computer.queryIntentActivitiesInternal(intent, str, 1966592L, 0);
    if (queryIntentActivitiesInternal.size() != 0) {
      PackageSetting packageLPr =
          this.mSettings.getPackageLPr(
              ((ResolveInfo) queryIntentActivitiesInternal.get(0)).getComponentInfo().packageName);
      if (packageLPr != null) {
  ...
  public final ComponentName getIntentFilterVerifierComponentNameLPr(Computer computer) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (checkPermission(
                  ...
                  resolveInfo2.getComponentInfo().packageName,
                  0)
              == 0
          && (resolveInfo == null || resolveInfo2.priority > resolveInfo.priority)) {
  ...
  public final ComponentName getDomainVerificationAgentComponentNameLPr(Computer computer) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (checkPermission("android.permission.DOMAIN_VERIFICATION_AGENT", str, 0) != 0) {
        Slog.w(
            "PackageManager",
            "Domain verification agent found but does not hold permission: " + str);
      } else if (resolveInfo == null || resolveInfo2.priority > resolveInfo.priority) {
        if (computer.isComponentEffectivelyEnabled(
            resolveInfo2.getComponentInfo(), UserHandle.SYSTEM)) {
          resolveInfo = resolveInfo2;
        } else {
  ...
  public ComponentName getInstantAppResolver(Computer computer) {
    String[] stringArray =
        this.mContext.getResources().getStringArray(R.array.face_acquired_vendor);
    ...
    List queryIntentServicesInternal =
        computer.queryIntentServicesInternal(
            ...
            null,
            (!Build.IS_DEBUGGABLE ? 1048576 : 0) | 786432,
            0,
            Binder.getCallingUid(),
            false);
      ...
      if (serviceInfo != null) {
        ...
        if (!arraySet.contains(str) && !Build.IS_DEBUGGABLE) {
          if (DEBUG_INSTANT) {
            Slog.d(
                "PackageManager",
                "Ephemeral resolver not in allowed package list; pkg: "
                    + str
                    + ", info:"
                    + resolveInfo);
          }
          ...
          if (DEBUG_INSTANT) {
            Slog.v(
                "PackageManager",
                "Ephemeral resolver found; pkg: " + str + ", info:" + resolveInfo);
          }
  ...
  public final ActivityInfo getInstantAppInstallerLPr() {
    ...
    if (z) {
      strArr =
          new String[] {
            "android.intent.action.INSTALL_INSTANT_APP_PACKAGE_TEST",
    ...
    intent.addCategory("android.intent.category.DEFAULT");
    intent.setDataAndType(
        Uri.fromFile(new File("foo.apk")), "application/vnd.android.package-archive");
    List list = null;
    for (String str : strArr) {
      intent.setAction(str);
      list =
          snapshotComputer.queryIntentActivitiesInternal(
              intent, "application/vnd.android.package-archive", i, 0);
      if (!list.isEmpty()) {
        break;
      }
      if (DEBUG_INSTANT) {
    ...
    while (it.hasNext()) {
      if (checkPermission(
                  ...
                  ((ResolveInfo) it.next()).activityInfo.packageName,
                  0)
              != 0
          && !this.mIsEngBuild) {
        it.remove();
  ...
  public final ComponentName getInstantAppResolverSettingsLPr(
      Computer computer, ComponentName componentName) {
    List queryIntentActivitiesInternal =
        computer.queryIntentActivitiesInternal(
            new Intent("android.intent.action.INSTANT_APP_RESOLVER_SETTINGS")
  ...
  public PermissionGroupInfo getPermissionGroupInfo(String str, int i) {
    return ((PermissionManager) this.mContext.getSystemService(PermissionManager.class))
        .getPermissionGroupInfo(str, i);
  }
  ...
  public void freeStorage(String str, long j, int i) {
    File findPathForUuid =
        ((StorageManager) this.mInjector.getSystemService(StorageManager.class))
            .findPathForUuid(str);
    ...
    if (this.mEnableFreeCacheV2) {
      ...
      boolean z = (i & 1) != 0;
      if (equals
          && (z || SystemProperties.getBoolean("persist.sys.preloads.file_cache_expired", false))) {
      ...
      Computer snapshotComputer = snapshotComputer();
      if (equals
          && this.mSharedLibraries.pruneUnusedStaticSharedLibraries(
              snapshotComputer,
              j,
      ...
      if (equals
          && this.mInstantAppRegistry.pruneInstalledInstantApps(
              snapshotComputer,
              j,
              Settings.Global.getLong(
                  this.mContext.getContentResolver(),
      ...
      synchronized (this.mInstallLock) {
        try {
          this.mInstaller.freeCache(
              str, j, FrameworkStatsLog.APP_STANDBY_BUCKET_CHANGED__MAIN_REASON__MAIN_USAGE);
      ...
      if (equals
          && this.mInstantAppRegistry.pruneUninstalledInstantApps(
              snapshotComputer,
              j,
              Settings.Global.getLong(
                  this.mContext.getContentResolver(),
      ...
      StorageManagerInternal storageManagerInternal =
          (StorageManagerInternal) this.mInjector.getLocalService(StorageManagerInternal.class);
  ...
  public int freeCacheForInstallation(
      int i, PackageLite packageLite, String str, String str2, int i2) {
    int i3;
    long storageLowBytes =
        StorageManager.from(this.mContext).getStorageLowBytes(Environment.getDataDirectory());
          ...
          try {
            ...
            PackageInfoLite minimalPackageInfo =
                PackageManagerServiceUtils.getMinimalPackageInfo(
                    this.mContext, packageLite, str, i2, str2);
  ...
  public boolean hasSystemFeature(String str, int i) {
    if (MaintenanceModeUtils.isMaintenanceModeFeature(str)
        && MaintenanceModeManager.isFeatureDisallowedByPolicy(this.mContext)) {
      return false;
    }
    synchronized (this.mAvailableFeatures) {
  ...
  public void requestInstantAppResolutionPhaseTwo(
    ...
    this.mHandler.sendMessage(
        this.mHandler.obtainMessage(
            ...
            new InstantAppRequest(
                ...
                bundle,
                false,
                auxiliaryResolveInfo.hostDigestPrefixSecure,
                auxiliaryResolveInfo.token)));
  }
  ...
  public ParceledListSlice queryIntentReceivers(
    ...
    return new ParceledListSlice(
        this.mResolveIntentHelper.queryIntentReceiversInternal(
            computer, intent, str, j, i, Binder.getCallingUid()));
  }
  ...
  public static void renameStaticSharedLibraryPackage(ParsedPackage parsedPackage) {
    parsedPackage.setPackageName(
        toStaticSharedLibraryPackageName(
  ...
  */
  public void performFstrimIfNeeded() {
    ...
    try {
      ...
      if (storageManager != null) {
        long j =
            Settings.Global.getLong(
                this.mContext.getContentResolver(), "fstrim_mandatory_interval", 259200000L);
        if (j > 0) {
          long currentTimeMillis = System.currentTimeMillis() - storageManager.lastMaintenance();
          if (currentTimeMillis > j) {
            Slog.w(
                "PackageManager",
                "No disk maintenance in " + currentTimeMillis + "; running immediately");
            z = true;
            if (z) {
              return;
            }
  ...
  public void shutdown() {
    ...
    synchronized (this.mLock) {
      ...
      if (this.mHandler.hasMessages(13)
          || this.mBackgroundHandler.hasMessages(14)
          || this.mHandler.hasMessages(19)) {
        writeSettings(true);
      }
    }
  ...
  public final void setUpInstantAppInstallerActivityLP(ActivityInfo activityInfo) {
    ...
    if (DEBUG_INSTANT) {
      Slog.d(
          "PackageManager", "Set ephemeral installer activity: " + activityInfo.getComponentName());
    }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$sendPackageBroadcast$51(
      String str,
      String str2,
      Bundle bundle,
      int i,
      ...
      Bundle bundle2) {
    this.mBroadcastHelper.sendPackageBroadcast(
        str, str2, bundle, i, str3, iIntentReceiver, iArr, iArr2, sparseArray, null, bundle2);
  }
  ...
  public void sendPackageBroadcast(
      ...
      final int i,
      final String str3,
      final IIntentReceiver iIntentReceiver,
      final int[] iArr,
      final int[] iArr2,
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda24
          @Override // java.lang.Runnable
          public final void run() {
            PackageManagerService.this.lambda$sendPackageBroadcast$51(
                str, str2, bundle, i, str3, iIntentReceiver, iArr, iArr2, sparseArray, bundle2);
          }
        });
  }
  ...
  public void sendPackageAddedForUser(
      Computer computer, String str, PackageStateInternal packageStateInternal, int i, int i2) {
    ...
    sendPackageAddedForNewUsers(
        ...
        isSystem,
        false,
        packageStateInternal.getAppId(),
        isInstantApp ? EMPTY_INT_ARRAY : new int[] {i},
        isInstantApp ? new int[] {i} : EMPTY_INT_ARRAY,
        i2);
  ...
  public void sendPackageAddedForNewUsers(
      Computer computer,
      final String str,
      boolean z,
      final boolean z2,
    ...
    final SparseArray visibilityAllowList =
        this.mAppsFilter.getVisibilityAllowList(
            computer,
            computer.getPackageStateInternal(str, 1000),
            iArr,
            computer.getPackageStates());
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda17
          @Override // java.lang.Runnable
          public final void run() {
            PackageManagerService.this.lambda$sendPackageAddedForNewUsers$52(
                str, i, iArr, iArr2, i2, visibilityAllowList);
          }
        });
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda18
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$sendPackageAddedForNewUsers$52(
      String str, int i, int[] iArr, int[] iArr2, int i2, SparseArray sparseArray) {
    this.mBroadcastHelper.sendPackageAddedForNewUsers(str, i, iArr, iArr2, i2, sparseArray);
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$sendPackageAddedForNewUsers$53(
  ...
  public final void sendApplicationHiddenForUser(
      String str, PackageStateInternal packageStateInternal, int i) {
    PackageRemovedInfo packageRemovedInfo = new PackageRemovedInfo(this);
    packageRemovedInfo.mRemovedPackage = str;
    packageRemovedInfo.mInstallerPackageName =
        packageStateInternal.getInstallSource().mInstallerPackageName;
  ...
  public final void enforceCanSetPackagesSuspendedAsUser(
      Computer computer, String str, int i, int i2, String str2) {
    if (i == 0 || UserHandle.getAppId(i) == 1000) {
      return;
    }
    String deviceOwnerOrProfileOwnerPackage =
        this.mProtectedPackages.getDeviceOwnerOrProfileOwnerPackage(i2);
    if (deviceOwnerOrProfileOwnerPackage == null
        || computer.getPackageUid(deviceOwnerOrProfileOwnerPackage, 0L, i2) != i) {
      ...
      throw new SecurityException(
          "Calling package " + str + " in user " + i2 + " does not belong to calling uid " + i);
    }
  }
  ...
  public void unsuspendForSuspendingPackage(Computer computer, final String str, int i) {
    ...
    suspendPackageHelper.removeSuspensionsBySuspendingPackage(
        ...
        new Predicate() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda19
  ...
  public void removeAllDistractingPackageRestrictions(Computer computer, int i) {
    this.mDistractingPackageHelper.removeDistractingPackageRestrictions(
        computer, computer.getAllAvailablePackageNames(), i);
  }
  ...
  public void notifyFirstLaunch(final String str, final String str2, final int i) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda20
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$notifyFirstLaunch$54(String str, int i, String str2) {
    for (int i2 = 0; i2 < this.mRunningInstalls.size(); i2++) {
      ...
      if (installRequest.getReturnCode() == 1
          && str.equals(installRequest.getPkg().getPackageName())) {
    ...
    this.mBroadcastHelper.sendFirstLaunchBroadcast(
        str,
        str2,
        isInstantAppInternal ? EMPTY_INT_ARRAY : new int[] {i},
        isInstantAppInternal ? new int[] {i} : EMPTY_INT_ARRAY);
  }
  ...
  public void deleteExistingPackageAsUser(
      VersionedPackage versionedPackage, IPackageDeleteObserver2 iPackageDeleteObserver2, int i) {
    this.mDeletePackageHelper.deleteExistingPackageAsUser(
        versionedPackage, iPackageDeleteObserver2, i);
  }
  ...
  public void deletePackageVersioned(
      ...
      int i,
      int i2) {
    this.mDeletePackageHelper.deletePackageVersionedInternal(
        versionedPackage, iPackageDeleteObserver2, i, i2, false);
  }
  ...
  public boolean isPackageDeviceAdminOnAnyUser(Computer computer, String str) {
    ...
    if (computer.getInstantAppPackageName(callingUid) == null
        || computer.isCallerSameApp(str, callingUid)) {
  ...
  public boolean isPackageDeviceAdmin(String str, int i) {
    ...
    DevicePolicyManagerInternal devicePolicyManagerInternal =
        (DevicePolicyManagerInternal)
            this.mInjector.getLocalService(DevicePolicyManagerInternal.class);
    if (devicePolicyManager != null && devicePolicyManagerInternal != null) {
      try {
        ...
        if (str.equals(
            deviceOwnerComponent == null ? null : deviceOwnerComponent.getPackageName())) {
          return true;
        }
        ...
        for (int i3 : userIds) {
          if (isDeviceManagementRoleHolder(str, i3)
    ...
    return (String)
        Binder.withCleanCallingIdentity(
            new FunctionalUtils.ThrowingSupplier() { // from class:
              // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda7
              public final Object getOrThrow() {
                String lambda$getDevicePolicyManagementRoleHolderPackageName$55;
                lambda$getDevicePolicyManagementRoleHolderPackageName$55 =
                    PackageManagerService.this
                        .lambda$getDevicePolicyManagementRoleHolderPackageName$55(i);
  ...
  public /* synthetic */ String lambda$getDevicePolicyManagementRoleHolderPackageName$55(int i) {
    List roleHoldersAsUser =
        ((RoleManager) this.mContext.getSystemService(RoleManager.class))
            .getRoleHoldersAsUser("android.app.role.DEVICE_POLICY_MANAGEMENT", UserHandle.of(i));
  ...
  public boolean clearPackageAfterSpeg(String str, int i) {
    ...
    if (!CoreRune.SYSFW_APP_SPEG
        || (spegService = this.mSpeg) == null
        || !spegService.checkSpegState(str)) {
  ...
  public final boolean clearApplicationUserDataLIF(Computer computer, String str, int i) {
    ...
    this.mAppDataHelper.prepareAppDataContentsLIF(
        androidPackage, computer.getPackageStateInternal(str), i, i2);
    return true;
  }
  ...
  public final void resetComponentEnabledSettingsIfNeededLPw(String str, final int i) {
    ...
    if (androidPackage == null
        ...
        || (packageLPr = this.mSettings.getPackageLPr(str)) == null) {
      return;
    }
    final ArrayList arrayList = new ArrayList();
    Consumer consumer = new Consumer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda59
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            PackageManagerService.lambda$resetComponentEnabledSettingsIfNeededLPw$56(
                PackageSetting.this, i, arrayList, (ParsedMainComponent) obj);
          }
        };
  ...
  public static /* synthetic */ void lambda$resetComponentEnabledSettingsIfNeededLPw$56(
  ...
  public void postPreferredActivityChangedBroadcast(final int i) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda25
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void clearPackagePreferredActivitiesLPw(
  ...
  public void addCrossProfileIntentFilter(
    ...
    this.mContext.enforceCallingOrSelfPermission(
        "android.permission.INTERACT_ACROSS_USERS_FULL", null);
    int callingUid = Binder.getCallingUid();
    ...
    PackageManagerServiceUtils.enforceShellRestriction(
        this.mInjector.getUserManagerInternal(), "no_debugging_features", callingUid, i);
    ...
    synchronized (this.mLock) {
      CrossProfileIntentFilter crossProfileIntentFilter =
          new CrossProfileIntentFilter(
              ...
              i2,
              i3,
              this.mUserManager.getCrossProfileIntentFilterAccessControl(i, i2));
      ...
      if (findFilters != null) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
          if (crossProfileIntentFilter.equalsIgnoreFilter(
              (CrossProfileIntentFilter) findFilters.get(i4))) {
            return;
          }
        }
      }
      editCrossProfileIntentResolverLPw.addFilter(
          (PackageDataSnapshot) snapshotComputer(), (WatchedIntentFilter) crossProfileIntentFilter);
      scheduleWritePackageRestrictions(i);
    }
  }
  ...
  public void sendSessionCommitBroadcast(PackageInstaller.SessionInfo sessionInfo, int i) {
    ...
    this.mBroadcastHelper.sendSessionCommitBroadcast(
        sessionInfo,
        i,
        i2,
        snapshotComputer().getDefaultHomeActivity(i2),
        this.mAppPredictionServicePackage);
  }
  ...
  public final String getSetupWizardPackageNameImpl(Computer computer) {
    ...
    List queryIntentActivitiesInternal =
        computer.queryIntentActivitiesInternal(intent, null, 1835520L, UserHandle.myUserId());
    if (queryIntentActivitiesInternal.size() == 1) {
      return ((ResolveInfo) queryIntentActivitiesInternal.get(0)).getComponentInfo().packageName;
    }
    Slog.e(
        "PackageManager",
        "There should probably be exactly one setup wizard; found "
            + queryIntentActivitiesInternal.size()
            + ": matches="
  ...
  public final String getStorageManagerPackageName(Computer computer) {
    List queryIntentActivitiesInternal =
        computer.queryIntentActivitiesInternal(
            new Intent("android.os.storage.action.MANAGE_STORAGE"),
            null,
            1835520L,
            UserHandle.myUserId());
    if (queryIntentActivitiesInternal.size() == 1) {
    ...
    Slog.w(
        "PackageManager",
        "There should probably be exactly one storage manager; found "
            + queryIntentActivitiesInternal.size()
            + ": matches="
            + queryIntentActivitiesInternal);
    return null;
  ...
  public static String getRequiredSdkSandboxPackageName(Computer computer) {
    List queryIntentServicesInternal =
        computer.queryIntentServicesInternal(
            new Intent("com.android.sdksandbox.SdkSandboxService"),
            null,
            1835008L,
            0,
            Process.myUid(),
    ...
    throw new RuntimeException(
        "There should exactly one sdk sandbox package; found "
            + queryIntentServicesInternal.size()
            + ": matches="
  ...
  public final String getRetailDemoPackageName() {
    ...
    String string = this.mContext.getString(R.string.eventTypeAnniversary);
    String string2 = this.mContext.getString(R.string.eventTypeBirthday);
    if (!TextUtils.isEmpty(string)
        && !TextUtils.isEmpty(string2)
        && (androidPackage = (AndroidPackage) this.mPackages.get(string)) != null
        && (signingDetails = androidPackage.getSigningDetails()) != null
        && signingDetails.getSignatures() != null) {
      try {
        MessageDigest messageDigest = MessageDigest.getInstance("SHA-256");
        for (Signature signature : signingDetails.getSignatures()) {
          if (TextUtils.equals(
              string2,
              HexEncoding.encodeToString(messageDigest.digest(signature.toByteArray()), false))) {
            return string;
          }
        }
  ...
  public String ensureSystemPackageName(Computer computer, String str) {
    ...
    try {
      ...
      if (packageInfo != null) {
        EventLog.writeEvent(
            1397638484, "145981139", Integer.valueOf(packageInfo.applicationInfo.uid), "");
      }
  ...
  public void updateComponentLabelIcon(
      final ComponentName componentName, final String str, final Integer num, final int i) {
    ...
    if (!UserHandle.isSameApp(callingUid, snapshotComputer.getPackageUid(packageName, 0L, i))) {
      throw new SecurityException(
          "The calling UID (" + callingUid + ") does not match the target UID");
    }
    String string = this.mContext.getString(R.string.elapsed_time_short_format_h_mm_ss);
    if (TextUtils.isEmpty(string)) {
      throw new SecurityException(
    ...
    PackageStateInternal packageStateInternal =
        snapshotComputer.getPackageStateInternal(packageName);
    if (packageStateInternal == null
        || packageStateInternal.getPkg() == null
        || (!packageStateInternal.isSystem() && !packageStateInternal.isUpdatedSystemApp())) {
    ...
    Pair overrideLabelIconForComponent =
        packageStateInternal
            .getUserStateOrDefault(i)
            .getOverrideLabelIconForComponent(componentName);
    String str2 =
        overrideLabelIconForComponent == null ? null : (String) overrideLabelIconForComponent.first;
    Integer num2 =
        overrideLabelIconForComponent == null
            ? null
            : (Integer) overrideLabelIconForComponent.second;
    ...
    commitPackageStateMutation(
        ...
        packageName,
        new Consumer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda5
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            PackageManagerService.lambda$updateComponentLabelIcon$58(
                i, componentName, str, num, (PackageStateWrite) obj);
          }
        });
  ...
  public static /* synthetic */ void lambda$updateComponentLabelIcon$58(
      int i,
      ComponentName componentName,
      String str,
      Integer num,
      PackageStateWrite packageStateWrite) {
  ...
  public final Set buildRequiredSystemPackages() {
    ...
    String replaceAll =
        SemCscFeature.getInstance()
            .getString("CscFeature_Framework_ConfigRequiredSystemPackages", "")
            .replaceAll(" ", "");
    if (!replaceAll.isEmpty()) {
      for (String str : replaceAll.split(",")) {
        requiredSystemPackages.add(str);
      }
    }
  ...
  public boolean isRequiredSystemPackage(Computer computer, String str, int i) {
    return this.mRequiredSystemPackages.contains(str)
        && computer.getPackageStateInternal(str).isSystem()
        && i == 0;
  }
  ...
  public final void setEnabledSettings(List list, int i, String str) {
    ...
    String str3 =
        str == null
            ? Integer.toString(Binder.getCallingUid())
                + "/"
                + PmServerUtils.getProcessNameForPid(Binder.getCallingPid())
            : str;
    int i7 = 1;
    ...
    while (i8 < size) {
      ...
      PackageManager.ComponentEnabledSetting componentEnabledSetting =
          (PackageManager.ComponentEnabledSetting) list.get(i8);
      Log.d(
          "PackageManager",
          "setEnabledSetting : userId = "
              + i
              + " packageName = "
              + componentEnabledSetting.getPackageName()
              + " cmp = "
              + componentEnabledSetting.getClassName()
              + " newState = "
              + componentEnabledSetting.getEnabledState()
              + " callingPackage = "
              + str3
              + str4);
      String packageName = ((PackageManager.ComponentEnabledSetting) list.get(i8)).getPackageName();
      ComponentName componentName =
          ((PackageManager.ComponentEnabledSetting) list.get(i8)).getComponentName();
      ...
      if (componentName != null && packageLPr != null && !packageLPr.isSystem()) {
        ...
        i6 = i8;
        Iterator it =
            snapshotComputer.queryIntentActivitiesInternal(intent, null, 512L, i).iterator();
        while (true) {
          if (it.hasNext()) {
            if (((ResolveInfo) it.next()).activityInfo.name.equals(componentName.getClassName())) {
              FrameworkStatsLog.write(
                  FrameworkStatsLog.DETECT_MALICIOUS_ACTION, packageName, "APP_ICON");
              break;
            }
          } else {
            break;
      ...
      String packageName2 =
          ((PackageManager.ComponentEnabledSetting) list.get(i6)).getPackageName();
      if (isRequiredSystemPackage(snapshotComputer, packageName2, i)
          && ((i5 == 2 || i5 == 3 || i5 == 4)
              && !((PackageManager.ComponentEnabledSetting) list.get(i6)).isComponent())) {
        PmLog.logDebugInfoAndLogcat(
            "Cannot disable required package " + packageName2 + " callingPackage: " + str3);
      ...
      if (packageName3 != null
          && (androidPackage = snapshotComputer.getPackage(packageName3)) != null) {
        boolean z =
            SemSamsungThemeUtils.hasSamsungOverlayPermission(
                    androidPackage.getRequestedPermissions())
                && !str3.equalsIgnoreCase("com.samsung.android.themecenter");
        boolean isZippedLocaleOverlay = SemSamsungThemeUtils.isZippedLocaleOverlay(androidPackage);
        boolean z2 =
            callingUid == 2000
                && "com.samsung.android.themestore".equals(packageName3)
                && (((PackageManagerInternal)
                            LocalServices.getService(PackageManagerInternal.class))
                        .isPlatformSigned(packageName3)
                    || packageLPr2.isSystem());
        if ((z
                || isZippedLocaleOverlay
                || z2
                || SamsungThemeConstants.protectedApps.contains(packageName3))
            && i5 > 1) {
    ...
    if (size > i7) {
      ...
      for (int i9 = 0; i9 < size; i9++) {
        PackageManager.ComponentEnabledSetting componentEnabledSetting2 =
            (PackageManager.ComponentEnabledSetting) list.get(i9);
        ...
        if (componentEnabledSetting2.isComponent()) {
          ...
          if (arraySet2.contains(componentName2)) {
            throw new IllegalArgumentException(
                "The component " + componentName2 + " is duplicated");
          }
          ...
          if (num == null) {
            ...
            throw new IllegalArgumentException(
                "A conflict of the DONT_KILL_APP flag between components in the package "
                    + packageName4);
          }
        } else {
    ...
    synchronized (this.mLock) {
      ...
      int i10 = 0;
      while (i10 < size) {
        PackageManager.ComponentEnabledSetting componentEnabledSetting3 =
            (PackageManager.ComponentEnabledSetting) list.get(i10);
        String packageName5 = componentEnabledSetting3.getPackageName();
        if (!arrayMap2.containsKey(packageName5)) {
          boolean contains =
              ArrayUtils.contains(snapshotComputer2.getPackagesForUid(callingUid), packageName5);
          ...
          if (!contains && !z3) {
            ...
            sb.append(
                componentEnabledSetting3.isComponent()
                    ? ", component=" + componentEnabledSetting3.getComponentName()
                    : ", package=" + packageName5);
            throw new SecurityException(sb.toString());
          }
          if (packageLPr3 != null
              && !snapshotComputer2.shouldFilterApplicationIncludingUninstalled(
                  packageLPr3, callingUid, i)) {
            ...
            if (callingUid == 2000 && (packageLPr3.getFlags() & 256) == 0) {
              ...
              throw new SecurityException(
                  "Shell cannot change component state for "
                      + componentEnabledSetting3.getComponentName()
                      + " to "
                      + enabledState2);
            }
            computer = snapshotComputer2;
          ...
          throw new IllegalArgumentException(
              componentEnabledSetting3.isComponent()
                  ? "Unknown component: " + componentEnabledSetting3.getComponentName()
                  : "Unknown package: " + packageName5);
        }
        computer = snapshotComputer2;
        i3 = callingUid;
        i10++;
      ...
      for (int i11 = 0; i11 < size; i11++) {
        if (!PmHook.isUpdateAllowedByMdm(
            (PackageManager.ComponentEnabledSetting) list.get(i11), i, this.mContext)) {
          zArr[i11] = false;
        }
      }
      for (int i12 = 0; i12 < size; i12++) {
        PackageManager.ComponentEnabledSetting componentEnabledSetting4 =
            (PackageManager.ComponentEnabledSetting) list.get(i12);
        if (componentEnabledSetting4.isComponent()) {
          ...
          if (pkg == null || !AndroidPackageUtils.hasComponentClassName(pkg, className)) {
            if (pkg != null && pkg.getTargetSdkVersion() >= 16) {
              throw new IllegalArgumentException(
                  "Component class " + className + " does not exist in " + packageName6);
            }
            Slog.w(
                "PackageManager",
                "Failed setComponentEnabledSetting: component class "
                    + className
                    + " does not exist in "
                    + packageName6);
            zArr[i12] = false;
    ...
    for (int i13 = 0; i13 < size; i13++) {
      PackageManager.ComponentEnabledSetting componentEnabledSetting5 =
          (PackageManager.ComponentEnabledSetting) list.get(i13);
      if (!componentEnabledSetting5.isComponent()) {
        PackageSetting packageSetting =
            (PackageSetting) arrayMap2.get(componentEnabledSetting5.getPackageName());
        ...
        synchronized (this.mLock) {
          if (packageSetting.getEnabled(i) == enabledState3) {
            ...
            if ((pkg2 != null && pkg2.isStub() && packageSetting.isSystem())
                && ((enabledState3 == 0 || enabledState3 == 1)
                    && !this.mInstallPackageHelper.enableCompressedPackage(pkg2, packageSetting))) {
              Slog.w(
                  "PackageManager",
                  "Failed setApplicationEnabledSetting: failed to enable commpressed package "
                      + componentEnabledSetting5.getPackageName());
              zArr[i13] = false;
            }
          }
        }
    ...
    synchronized (this.mLock) {
      ...
      for (int i14 = 0; i14 < size; i14 = i2 + 1) {
        if (zArr[i14]) {
          PackageManager.ComponentEnabledSetting componentEnabledSetting6 =
              (PackageManager.ComponentEnabledSetting) list.get(i14);
          String packageName7 = componentEnabledSetting6.getPackageName();
          i2 = i14;
          if (setEnabledSettingInternalLocked(
              snapshotComputer3,
              (PackageSetting) arrayMap2.get(packageName7),
              componentEnabledSetting6,
              i,
              str3)) {
            ...
            PmHook.enableDisableApplicationLog(
                packageName7,
                componentEnabledSetting6.getClassName(),
                componentEnabledSetting6.getEnabledState(),
                i);
            String className2 =
                componentEnabledSetting6.isComponent()
                    ? componentEnabledSetting6.getClassName()
                    : packageName7;
            if ((componentEnabledSetting6.getEnabledFlags() & 4) != 0) {
              ArrayList arrayList =
                  this.mEmergencyModePackageHandler
                      .getPendingBroadcastsForBurst()
                      .get(i, packageName7);
              ...
              if (z7) {
                this.mEmergencyModePackageHandler
                    .getPendingBroadcastsForBurst()
                    .put(i, packageName7, arrayList);
              }
              this.mEmergencyModePackageHandler
                  .getPendingBroadcastsForBurst()
                  .putNewState(i, packageName7, componentEnabledSetting6.getEnabledState());
      ...
      if (z4) {
        ...
        if (z6 && !this.mHandler.hasMessages(1)) {
          this.mHandler.sendEmptyMessageDelayed(
              1, SystemClock.uptimeMillis() > this.mServiceStartWithDelay ? 1000L : 10000L);
        }
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
          ...
          for (int i15 = 0; i15 < arrayMap3.size(); i15++) {
            ...
            sendPackageChangedBroadcast(
                ...
                str5,
                false,
                (ArrayList) arrayMap3.valueAt(i15),
                UserHandle.getUid(i, ((PackageSetting) arrayMap2.get(str5)).getAppId()),
                null);
          }
        } finally {
          Binder.restoreCallingIdentity(clearCallingIdentity);
  ...
  public final boolean setEnabledSettingInternalLocked(
      Computer computer,
      PackageSetting packageSetting,
      PackageManager.ComponentEnabledSetting componentEnabledSetting,
      int i,
    ...
    if (!componentEnabledSetting.isComponent()) {
      ...
      if ((enabledState == 3 || enabledState == 2)
          && checkPermission("android.permission.SUSPEND_APPS", packageName, i) == 0) {
      ...
      if (enabledState == 0) {
        ...
        Slog.e(
            "PackageManager",
            "Failed setComponentEnabledSetting: component "
                + packageName
                + "/"
                + className
                + " requested an invalid new component state: "
                + enabledState);
  ...
  public void sendPackageChangedBroadcast(
    ...
    final SparseArray visibilityAllowLists =
        isInstantAppInternal ? null : computer.getVisibilityAllowLists(str, iArr);
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda10
          @Override // java.lang.Runnable
          public final void run() {
            PackageManagerService.this.lambda$sendPackageChangedBroadcast$59(
                str, z, arrayList, i, str2, iArr, iArr2, visibilityAllowLists);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$sendPackageChangedBroadcast$59(
      String str,
      boolean z,
      ArrayList arrayList,
      int i,
    ...
    this.mBroadcastHelper.sendPackageChangedBroadcast(
        str, z, arrayList, i, str2, iArr, iArr2, sparseArray);
  }
  ...
  public void systemReady() {
    ...
    if (list != null) {
      for (int size = list.size() - 1; size >= 0; size--) {
        F2fsUtils.releaseCompressedBlocks(
            contentResolver, (File) this.mReleaseOnSystemReady.get(size));
      }
    ...
    ContentObserver contentObserver =
        new ContentObserver(
            this.mHandler) { // from class: com.android.server.pm.PackageManagerService.4
          @Override // android.database.ContentObserver
          public void onChange(boolean z) {
            boolean z2 =
                Settings.Global.getInt(contentResolver, "enable_ephemeral_feature", 1) == 0;
            for (int i : UserManagerService.getInstance().getUserIds()) {
              PackageManagerService.this.mWebInstantAppsDisabled.put(
                  i,
                  z2
                      || Settings.Secure.getIntForUser(
                              contentResolver, "instant_apps_enabled", 1, i)
                          == 0);
            }
          }
        };
    this.mContext
        ...
        .registerContentObserver(
            Settings.Global.getUriFor("enable_ephemeral_feature"), false, contentObserver, -1);
    this.mContext
        .getContentResolver()
        .registerContentObserver(
            Settings.Secure.getUriFor("instant_apps_enabled"), false, contentObserver, -1);
    contentObserver.onChange(true);
    if (CoreRune.SYSFW_APP_SPEG) {
      this.mSpeg = (SpegService) LocalServices.getService(SpegService.class);
      ContentObserver contentObserver2 =
          new ContentObserver(
              this.mHandler) { // from class: com.android.server.pm.PackageManagerService.5
            @Override // android.database.ContentObserver
            public void onChange(boolean z) {
              AppPrelaunchManagerService appPrelaunchManagerService;
              boolean z2 =
                  Settings.Global.getInt(contentResolver, "device_provisioned", 0) == 1
      ...
      this.mContext
          .getContentResolver()
          .registerContentObserver(
              Settings.Global.getUriFor("device_provisioned"), false, contentObserver2, -1);
      this.mContext
          .getContentResolver()
          .registerContentObserver(
              Settings.Secure.getUriFor("user_setup_complete"), false, contentObserver2, -1);
    ...
    CarrierAppUtils.disableCarrierAppsUntilPrivileged(
        this.mContext.getOpPackageName(), 0, this.mContext);
    disableSkuSpecificApps();
    ParsingPackageUtils.setCompatibilityModeEnabled(
        Settings.Global.getInt(this.mContext.getContentResolver(), "compatibility_mode", 1) == 1);
    synchronized (this.mLock) {
    ...
    ((StorageManager) this.mInjector.getSystemService(StorageManager.class))
        .registerListener(this.mStorageEventHelper);
    ...
    this.mStorageEventHelper.reconcileApps(
    ...
    if (CoreRune.SYSFW_APP_SPEG) {
      ...
      this.mContext.registerReceiver(
          new BroadcastReceiver() { // from class: com.android.server.pm.PackageManagerService.6
    ...
    if (this.mInstantAppResolverConnection != null) {
      this.mContext.registerReceiver(
          new BroadcastReceiver() { // from class: com.android.server.pm.PackageManagerService.7
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
    ...
    this.mContext.registerReceiver(
        new BroadcastReceiver() { // from class: com.android.server.pm.PackageManagerService.8
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            Uri data;
            ...
            if (intent == null
                ...
                || (androidPackage =
                        (snapshotComputer = PackageManagerService.this.snapshotComputer())
                            .getPackage(schemeSpecificPart))
                    == null) {
              return;
            }
            PackageManagerService.this.sendPackageChangedBroadcast(
                snapshotComputer,
                androidPackage.getPackageName(),
                true,
                new ArrayList(Collections.singletonList(androidPackage.getPackageName())),
    ...
    DeviceConfig.addOnPropertiesChangedListener(
        ...
        this.mInjector.getBackgroundExecutor(),
        new DeviceConfig.OnPropertiesChangedListener() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda60
    ...
    PackageManagerAppOpPreAllow.appOpPreAllow(
        isFirstBoot(),
        this.mCustomInjector.getOmcInstallHelper().needsOmcOrTssInit(),
        this.mContext);
    if (Settings.Global.getLong(this.mContext.getContentResolver(), "verifier_timeout_samsung", -1L)
        == -1) {
  ...
  public final void disableSkuSpecificApps() {
    String[] stringArray =
        this.mContext.getResources().getStringArray(R.array.config_telephonyHardware);
    String[] stringArray2 =
        this.mContext
            .getResources()
            .getStringArray(R.array.config_telephonyEuiccDeviceCapabilities);
    ...
    try {
      DeviceStorageMonitorInternal deviceStorageMonitorInternal =
          (DeviceStorageMonitorInternal)
              this.mInjector.getLocalService(DeviceStorageMonitorInternal.class);
  ...
  public final void deletePackageIfUnused(Computer computer, final String str) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda4
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void deletePreloadsFileCache() {
    this.mContext.enforceCallingOrSelfPermission(
        "android.permission.CLEAR_APP_CACHE", "deletePreloadsFileCache");
  ...
  public void setSystemAppHiddenUntilInstalled(
      Computer computer, final String str, final boolean z) {
    int callingUid = Binder.getCallingUid();
    boolean z2 = callingUid == 1001 || callingUid == 1000;
    if (!z2) {
      this.mContext.enforceCallingOrSelfPermission(
          "android.permission.SUSPEND_APPS", "setSystemAppHiddenUntilInstalled");
    }
    PackageStateInternal packageStateInternal = computer.getPackageStateInternal(str);
    if (packageStateInternal == null
    ...
    commitPackageStateMutation(
        null,
        new Consumer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda3
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            PackageManagerService.lambda$setSystemAppHiddenUntilInstalled$62(
                str, z, (PackageStateMutator) obj);
          }
        });
  }

  public static /* synthetic */ void lambda$setSystemAppHiddenUntilInstalled$62(
      String str, boolean z, PackageStateMutator packageStateMutator) {
  ...
  public boolean setSystemAppInstallState(Computer computer, String str, boolean z, int i) {
    ...
    try {
      ...
      deletePackageVersioned(
          new VersionedPackage(str, -1),
          new PackageManager.LegacyPackageDeleteObserver((IPackageDeleteObserver) null).getBinder(),
          i,
          4);
      return true;
    } finally {
  ...
  public void setPackageStoppedState(
      Computer computer, final String str, final boolean z, final int i) {
    ...
    if (!(z && asList.contains(str)) && this.mUserManager.exists(i)) {
      ...
      if (computer.getInstantAppPackageName(callingUid) == null) {
        ...
        if (!(this.mContext.checkCallingOrSelfPermission(
                    "android.permission.CHANGE_COMPONENT_ENABLED_STATE")
                == 0)
            && !ArrayUtils.contains(computer.getPackagesForUid(callingUid), str)) {
          throw new SecurityException(
        ...
        PackageStateInternal packageStateForInstalledAndFiltered =
            computer.getPackageStateForInstalledAndFiltered(str, callingUid, i);
        PackageUserStateInternal userStateOrDefault =
            packageStateForInstalledAndFiltered == null
                ? null
                : packageStateForInstalledAndFiltered.getUserStateOrDefault(i);
        if (packageStateForInstalledAndFiltered != null && userStateOrDefault.isStopped() != z) {
          ...
          commitPackageStateMutation(
              ...
              str,
              new Consumer() { // from class:
                // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda8
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  PackageManagerService.this.lambda$setPackageStoppedState$63(
                      i, z, isNotLaunched, str, (PackageStateWrite) obj);
                }
              });
          if (CoreRune.SYSFW_APP_SPEG) {
          ...
          if (isNotLaunched && !z2) {
            String str2 =
                packageStateForInstalledAndFiltered.getInstallSource().mInstallerPackageName;
            if (str2 != null) {
            ...
            if (PMRune.PM_BADGE_ON_MONETIZED_APP_SUPPORTED
                && i == 0
                && str != null
                && this.mMonetizationUtils.isMonetizedPreloadApp(str)) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$setPackageStoppedState$63(
      int i, boolean z, boolean z2, String str, PackageStateWrite packageStateWrite) {
    SpegService spegService;
  ...
  public /* synthetic */ void lambda$setPackageStoppedState$64(String str, int i) {
    AppHibernationManagerInternal appHibernationManagerInternal =
        (AppHibernationManagerInternal)
            this.mInjector.getLocalService(AppHibernationManagerInternal.class);
    if (appHibernationManagerInternal == null
        || !appHibernationManagerInternal.isHibernatingForUser(str, i)) {
      return;
    }
  ...
  public class IPackageManagerImpl extends IPackageManagerBase {
    ...
    public IPackageManagerImpl() {
      super(
          PackageManagerService.this,
          PackageManagerService.this.mContext,
          PackageManagerService.this.mDexOptHelper,
          PackageManagerService.this.mModuleInfoProvider,
          PackageManagerService.this.mPreferredActivityHelper,
          PackageManagerService.this.mResolveIntentHelper,
          ...
          PackageManagerService.this.mPackageProperty,
          PackageManagerService.this.mResolveComponentName,
          PackageManagerService.this.mInstantAppResolverSettingsComponent,
          PackageManagerService.this.mRequiredSdkSandboxPackage,
          PackageManagerService.this.mServicesExtensionPackageName,
    ...
    public void clearApplicationProfileData(String str) {
      ...
      PackageFreezer freezePackage =
          PackageManagerService.this.freezePackage(str, -1, "clearApplicationProfileData", 13);
      try {
    ...
    public void clearApplicationUserData(
        final String str, final IPackageDataObserver iPackageDataObserver, final int i) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.CLEAR_APP_USER_DATA", null);
      int callingUid = Binder.getCallingUid();
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      snapshotComputer.enforceCrossUserPermission(
          callingUid, i, true, false, "clear application data");
      if (snapshotComputer.getPackageStateForInstalledAndFiltered(str, callingUid, i) == null) {
        if (iPackageDataObserver != null) {
          PackageManagerService.this.mHandler.post(
              new Runnable() { // from class:
                // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                  PackageManagerService.IPackageManagerImpl.lambda$clearApplicationUserData$0(
                      iPackageDataObserver, str);
                }
              });
          return;
        }
      ...
      sb.append(
          iPackageDataObserver != null ? Integer.valueOf(iPackageDataObserver.hashCode()) : "null");
      sb.append("}\npkg{");
      sb.append(str);
      sb.append("}\nuser{");
      sb.append(i);
      ...
      PackageManagerService.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService.IPackageManagerImpl.1
            @Override // java.lang.Runnable
            public void run() {
              boolean clearApplicationUserDataLIF;
              PackageManagerService.this.mHandler.removeCallbacks(this);
              PackageFreezer freezePackage =
                  PackageManagerService.this.freezePackage(str, -1, "clearApplicationUserData", 10);
              try {
                synchronized (PackageManagerService.this.mInstallLock) {
                  PackageManagerService packageManagerService = PackageManagerService.this;
                  clearApplicationUserDataLIF =
                      packageManagerService.clearApplicationUserDataLIF(
                          packageManagerService.snapshotComputer(), str, i);
                }
                PackageManagerService.this.mInstantAppRegistry.deleteInstantApplicationMetadata(
                    str, i);
                ...
                if (clearApplicationUserDataLIF) {
                  ...
                  if (IPackageManagerImpl.this.checkPermission(
                          "android.permission.SUSPEND_APPS", str, i)
                      == 0) {
                    Computer snapshotComputer2 = PackageManagerService.this.snapshotComputer();
                    PackageManagerService.this.unsuspendForSuspendingPackage(
                        snapshotComputer2, str, i);
                    PackageManagerService.this.removeAllDistractingPackageRestrictions(
                        snapshotComputer2, i);
                    synchronized (PackageManagerService.this.mLock) {
    ...
    public static /* synthetic */ void lambda$clearApplicationUserData$0(
        IPackageDataObserver iPackageDataObserver, String str) {
      try {
    ...
    public void clearCrossProfileIntentFilters(int i, String str) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.INTERACT_ACROSS_USERS_FULL", null);
      int callingUid = Binder.getCallingUid();
      PackageManagerService.this.enforceOwnerRights(
          PackageManagerService.this.snapshotComputer(), str, callingUid);
      PackageManagerServiceUtils.enforceShellRestriction(
          PackageManagerService.this.mInjector.getUserManagerInternal(),
      ...
      PackageManagerService.this
          .mInjector
          .getCrossProfileIntentFilterHelper()
          .clearCrossProfileIntentFilters(i, str, null);
      PackageManagerService.this.scheduleWritePackageRestrictions(i);
    }

    public boolean removeCrossProfileIntentFilter(
        IntentFilter intentFilter, String str, int i, int i2, int i3) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.INTERACT_ACROSS_USERS_FULL", null);
      int callingUid = Binder.getCallingUid();
      PackageManagerService packageManagerService = PackageManagerService.this;
      packageManagerService.enforceOwnerRights(
          packageManagerService.snapshotComputer(), str, callingUid);
      boolean z = false;
      PackageManagerService.this.mUserManager.enforceCrossProfileIntentFilterAccess(
          i, i2, callingUid, false);
      PackageManagerServiceUtils.enforceShellRestriction(
          PackageManagerService.this.mInjector.getUserManagerInternal(),
          "no_debugging_features",
          callingUid,
      ...
      synchronized (PackageManagerService.this.mLock) {
        CrossProfileIntentResolver editCrossProfileIntentResolverLPw =
            PackageManagerService.this.mSettings.editCrossProfileIntentResolverLPw(i);
        ...
        while (true) {
          ...
          if (IntentFilter.filterEquals(crossProfileIntentFilter.mFilter, intentFilter)
              && crossProfileIntentFilter.getOwnerPackage().equals(str)
              && crossProfileIntentFilter.getTargetUserId() == i2
              && crossProfileIntentFilter.getFlags() == i3) {
    ...
    public final void deleteApplicationCacheFiles(
        String str, IPackageDataObserver iPackageDataObserver) {
    ...
    public void deleteApplicationCacheFilesAsUser(
        final String str, final int i, final IPackageDataObserver iPackageDataObserver) {
      final int callingUid = Binder.getCallingUid();
      if (PackageManagerService.this.mContext.checkCallingOrSelfPermission(
        ...
        if (PackageManagerService.this.mContext.checkCallingOrSelfPermission(
          ...
          Slog.w(
              ...
              "Calling uid "
                  + callingUid
                  + " does not have android.permission.INTERNAL_DELETE_CACHE_FILES, silently"
                  + " ignoring");
          return;
        }
        PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
            "android.permission.INTERNAL_DELETE_CACHE_FILES", null);
      }
      PackageManagerService.this
          .snapshotComputer()
          .enforceCrossUserPermission(callingUid, i, true, false, "delete application cache files");
      final int checkCallingOrSelfPermission =
          PackageManagerService.this.mContext.checkCallingOrSelfPermission(
      ...
      if (asInterface != null) {
        try {
          if (asInterface.isApplicationClearCacheDisabled(str, i, true)) {
            Log.w(
                "PackageManager",
                "Cache cannot be cleared for this app due to EDM policy. packageName = " + str);
            if (iPackageDataObserver != null) {
              try {
                Log.d(
                    "PackageManager",
                    "result of delete cache files: completed{"
      ...
      PackageManagerService.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              PackageManagerService.IPackageManagerImpl.this
                  .lambda$deleteApplicationCacheFilesAsUser$1(
                      str, callingUid, checkCallingOrSelfPermission, i, iPackageDataObserver);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$deleteApplicationCacheFilesAsUser$1(
        String str, int i, int i2, int i3, IPackageDataObserver iPackageDataObserver) {
      PackageStateInternal packageStateInternal =
          PackageManagerService.this.snapshotComputer().getPackageStateInternal(str);
      if (packageStateInternal == null
          || !packageStateInternal.getUserStateOrDefault(UserHandle.getUserId(i)).isInstantApp()
          || i2 == 0) {
        synchronized (PackageManagerService.this.mInstallLock) {
          AndroidPackage androidPackage =
              PackageManagerService.this.snapshotComputer().getPackage(str);
    ...
    public void extendVerificationTimeout(final int i, final int i2, final long j) {
      ...
      PackageManagerService.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
              PackageManagerService.IPackageManagerImpl.this.lambda$extendVerificationTimeout$2(
                  i, callingUid, i2, j);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$extendVerificationTimeout$2(int i, int i2, int i3, long j) {
      ...
      PackageVerificationState packageVerificationState =
          (PackageVerificationState) PackageManagerService.this.mPendingVerification.get(i);
      ...
      PackageVerificationResponse packageVerificationResponse =
          new PackageVerificationResponse(i3, i2);
    ...
    public void flushPackageRestrictionsAsUser(int i) {
      ...
      if (snapshotComputer.getInstantAppPackageName(callingUid) == null
          && PackageManagerService.this.mUserManager.exists(i)) {
        snapshotComputer.enforceCrossUserPermission(
            callingUid, i, false, false, "flushPackageRestrictions");
        synchronized (PackageManagerService.this.mLock) {
          PackageManagerService.this.flushPackageRestrictionsAsUserInternalLocked(i);
        }
      }
    ...
    public void freeStorage(
        final String str, final long j, final int i, final IntentSender intentSender) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.CLEAR_APP_CACHE", "PackageManager");
      PackageManagerService.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
              PackageManagerService.IPackageManagerImpl.this.lambda$freeStorage$3(
                  str, j, i, intentSender);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$freeStorage$3(
        String str, long j, int i, IntentSender intentSender) {
      boolean z;
      try {
    ...
    public void freeStorageAndNotify(
        ...
        final long j,
        final int i,
        final IPackageDataObserver iPackageDataObserver) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.CLEAR_APP_CACHE", null);
      StringBuilder sb = new StringBuilder();
      ...
      PackageManagerService.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              PackageManagerService.IPackageManagerImpl.this.lambda$freeStorageAndNotify$4(
                  str, j, i, iPackageDataObserver);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$freeStorageAndNotify$4(
        String str, long j, int i, IPackageDataObserver iPackageDataObserver) {
      boolean z;
      try {
        PackageManagerService.this.freeStorage(str, j, i);
        z = true;
      ...
      if (iPackageDataObserver != null) {
        try {
          Log.d(
              "PackageManager",
              "result of freeStorageAndNotify: " + z + "{" + iPackageDataObserver.hashCode() + "}");
    ...
    public ChangedPackages getChangedPackages(int i, int i2) {
      ...
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      if (snapshotComputer.getInstantAppPackageName(callingUid) != null
          || !PackageManagerService.this.mUserManager.exists(i2)) {
        return null;
      }
      snapshotComputer.enforceCrossUserPermission(
          callingUid, i2, false, false, "getChangedPackages");
      ChangedPackages changedPackages =
          PackageManagerService.this.mChangedPackagesTracker.getChangedPackages(i, i2);
      if (changedPackages != null) {
        List<String> packageNames = changedPackages.getPackageNames();
        for (int size = packageNames.size() - 1; size >= 0; size--) {
          if (snapshotComputer.shouldFilterApplication(
              snapshotComputer.getPackageStateInternal(packageNames.get(size)), callingUid, i2)) {
    ...
    public byte[] getDomainVerificationBackup(int i) {
      ...
      try {
        ...
        try {
          ...
          PackageManagerService packageManagerService = PackageManagerService.this;
          packageManagerService.mDomainVerificationManager.writeSettings(
              packageManagerService.snapshotComputer(), resolveSerializer, true, i);
    ...
    public IBinder getHoldLockToken() {
      ...
      PackageManagerService.this.mContext.enforceCallingPermission(
          "android.permission.INJECT_EVENTS", "getHoldLockToken requires INJECT_EVENTS permission");
    ...
    public String getInstantAppAndroidId(String str, int i) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.ACCESS_INSTANT_APPS", "getInstantAppAndroidId");
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      snapshotComputer.enforceCrossUserPermission(
          Binder.getCallingUid(), i, true, false, "getInstantAppAndroidId");
    ...
    public byte[] getInstantAppCookie(String str, int i) {
      ...
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      snapshotComputer.enforceCrossUserPermission(
          Binder.getCallingUid(), i, true, false, "getInstantAppCookie");
      if (!snapshotComputer.isCallerSameApp(str, Binder.getCallingUid())
          || (packageStateInternal = snapshotComputer.getPackageStateInternal(str)) == null
          || packageStateInternal.getPkg() == null) {
        return null;
      }
      return PackageManagerService.this.mInstantAppRegistry.getInstantAppCookie(
          packageStateInternal.getPkg(), i);
    }
    ...
    public Bitmap getInstantAppIcon(String str, int i) {
      ...
      if (!snapshotComputer.canViewInstantApps(Binder.getCallingUid(), i)) {
        PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
            "android.permission.ACCESS_INSTANT_APPS", "getInstantAppIcon");
      }
      snapshotComputer.enforceCrossUserPermission(
          Binder.getCallingUid(), i, true, false, "getInstantAppIcon");
    ...
    public ParceledListSlice getInstantApps(int i) {
      ...
      if (!snapshotComputer.canViewInstantApps(Binder.getCallingUid(), i)) {
        PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
            "android.permission.ACCESS_INSTANT_APPS", "getEphemeralApplications");
      }
      snapshotComputer.enforceCrossUserPermission(
          Binder.getCallingUid(), i, true, false, "getEphemeralApplications");
      List instantApps =
          PackageManagerService.this.mInstantAppRegistry.getInstantApps(snapshotComputer, i);
      if (instantApps != null) {
    ...
    public ResolveInfo getLastChosenActivity(Intent intent, String str, int i) {
      return PackageManagerService.this.mPreferredActivityHelper.getLastChosenActivity(
          PackageManagerService.this.snapshotComputer(), intent, str, i);
    }

    public IntentSender getLaunchIntentSenderForPackage(
        String str, String str2, String str3, int i) {
      return PackageManagerService.this.mResolveIntentHelper.getLaunchIntentSenderForPackage(
          PackageManagerService.this.snapshotComputer(), str, str2, str3, i);
    }
    ...
    public int getMoveStatus(int i) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.MOUNT_UNMOUNT_FILESYSTEMS", null);
    ...
    public ParcelFileDescriptor getAppMetadataFd(String str, int i) {
      ...
      PackageStateInternal packageStateForInstalledAndFiltered =
          PackageManagerService.this
              .snapshotComputer()
              .getPackageStateForInstalledAndFiltered(str, Binder.getCallingUid(), i);
    ...
    public String getPermissionControllerPackageName() {
      int callingUid = Binder.getCallingUid();
      if (PackageManagerService.this
              .snapshotComputer()
              .getPackageStateForInstalledAndFiltered(
                  PackageManagerService.this.mRequiredPermissionControllerPackage,
                  callingUid,
    ...
    public int getRuntimePermissionsVersion(int i) {
      ...
      PackageManagerService.this.enforceAdjustRuntimePermissionsPolicyOrUpgradeRuntimePermissions(
    ...
    public String getSplashScreenTheme(String str, int i) {
      ...
      int callingUid = Binder.getCallingUid();
      snapshotComputer.enforceCrossUserPermission(
          callingUid, i, false, false, "getSplashScreenTheme");
      PackageStateInternal packageStateForInstalledAndFiltered =
          snapshotComputer.getPackageStateForInstalledAndFiltered(str, callingUid, i);
      if (packageStateForInstalledAndFiltered == null) {
        return null;
      }
    ...
    public Bundle getSuspendedPackageAppExtras(String str, int i) {
      ...
      if (snapshot.getPackageUid(str, 0L, i) != callingUid) {
        throw new SecurityException(
            "Calling package " + str + " does not belong to calling uid " + callingUid);
      }
      return PackageManagerService.this.mSuspendPackageHelper.getSuspendedPackageAppExtras(
          snapshot, str, i, callingUid);
    }
    ...
    public List getInitialNonStoppedSystemPackages() {
      return PackageManagerService.this.mInitialNonStoppedSystemPackages != null
          ? new ArrayList(PackageManagerService.this.mInitialNonStoppedSystemPackages)
          : new ArrayList();
    }
    ...
    public String[] getUnsuspendablePackagesForUser(String[] strArr, int i) {
      ...
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.SUSPEND_APPS", "getUnsuspendablePackagesForUser");
      int callingUid = Binder.getCallingUid();
      ...
      return PackageManagerService.this.mSuspendPackageHelper.getUnsuspendablePackagesForUser(
          PackageManagerService.this.snapshotComputer(), strArr, i, callingUid);
    }
    ...
    public VerifierDeviceIdentity getVerifierDeviceIdentity() {
      ...
      synchronized (PackageManagerService.this.mLock) {
        PackageManagerService packageManagerService = PackageManagerService.this;
        verifierDeviceIdentityLPw =
            packageManagerService.mSettings.getVerifierDeviceIdentityLPw(
                packageManagerService.mLiveComputer);
      }
    ...
    public void makeProviderVisible(int i, String str) {
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      int userId = UserHandle.getUserId(i);
      ProviderInfo grantImplicitAccessProviderInfo =
          snapshotComputer.getGrantImplicitAccessProviderInfo(i, str);
      if (grantImplicitAccessProviderInfo == null) {
        return;
      }
      PackageManagerService.this.grantImplicitAccess(
          snapshotComputer,
          userId,
          null,
          UserHandle.getAppId(i),
          grantImplicitAccessProviderInfo.applicationInfo.uid,
          false,
          false);
    }
    ...
    public void makeUidVisible(int i, int i2) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.MAKE_UID_VISIBLE", "makeUidVisible");
      int callingUid = Binder.getCallingUid();
      int userId = UserHandle.getUserId(i);
      int userId2 = UserHandle.getUserId(i2);
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      snapshotComputer.enforceCrossUserPermission(
          callingUid, userId, false, false, "makeUidVisible");
      snapshotComputer.enforceCrossUserPermission(
          callingUid, userId2, false, false, "makeUidVisible");
      snapshotComputer.enforceCrossUserPermission(i, userId2, false, false, "makeUidVisible");
      PackageManagerService.this.grantImplicitAccess(
          snapshotComputer, userId, null, UserHandle.getAppId(i), i2, false, false);
    }
    ...
    public int installExistingPackageAsUser(String str, int i, int i2, int i3, List list) {
      return ((Integer)
              PackageManagerService.this.mInstallPackageHelper.installExistingPackageAsUser(
                      str, i, i2, i3, list, null)
                  .first)
          .intValue();
    }
    ...
    public boolean isAutoRevokeWhitelisted(String str) {
      return ((AppOpsManager)
                  PackageManagerService.this.mInjector.getSystemService(AppOpsManager.class))
              .checkOpNoThrow(97, Binder.getCallingUid(), str)
          == 1;
    }
    ...
    public boolean isPackageStateProtected(String str, int i) {
      ...
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      snapshotComputer.enforceCrossUserPermission(
          callingUid, i, false, true, "isPackageStateProtected");
      if (!PackageManagerServiceUtils.isSystemOrRoot(appId)
          && snapshotComputer.checkUidPermission(
                  "android.permission.MANAGE_DEVICE_ADMINS", callingUid)
              != 0) {
        throw new SecurityException(
    ...
    public boolean isProtectedBroadcast(String str) {
      boolean contains;
      if (str != null
          && (str.startsWith("android.net.netmon.lingerExpired")
              || str.startsWith("com.android.server.sip.SipWakeupTimer")
              || str.startsWith("com.android.internal.telephony.data-reconnect")
              || str.startsWith("android.net.netmon.launchCaptivePortalApp"))) {
        return true;
      }
    ...
    public void logAppProcessStartIfNeeded(
      ...
      if (PackageManagerService.this
                  .snapshotComputer()
                  .getInstantAppPackageName(Binder.getCallingUid())
              == null
          && SecurityLog.isLoggingEnabled()) {
        PackageManagerService packageManagerService = PackageManagerService.this;
        packageManagerService.mProcessLoggingHandler.logAppProcessStart(
            packageManagerService.mContext,
            (PackageManagerInternal) LocalServices.getService(PackageManagerInternal.class),
            str4,
            str,
            str2,
    ...
    public int movePackage(final String str, final String str2) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.MOVE_PACKAGE", null);
      ...
      PackageManagerService.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
              PackageManagerService.IPackageManagerImpl.this.lambda$movePackage$5(
                  str, str2, andIncrement, callingUid, userHandle);
            }
          });
      return andIncrement;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$movePackage$5(
        String str, String str2, int i, int i2, UserHandle userHandle) {
      try {
        new MovePackageHelper(PackageManagerService.this)
            .movePackageInternal(str, str2, i, i2, userHandle);
    ...
    public int movePackageToSd(
        String str, String str2, IMemorySaverPackageMoveObserver iMemorySaverPackageMoveObserver) {
      return new MovePackageHelper(PackageManagerService.this)
          .movePackageToSd(str, str2, iMemorySaverPackageMoveObserver);
    }
    ...
    public int movePrimaryStorage(String str) {
      ...
      ((StorageManager) PackageManagerService.this.mInjector.getSystemService(StorageManager.class))
          .setPrimaryStorageUuid(
              str,
              new IPackageMoveObserver.Stub() { // from class:
                // com.android.server.pm.PackageManagerService.IPackageManagerImpl.2
                public void onCreated(int i, Bundle bundle2) {}

                public void onStatusChanged(int i, int i2, long j) {
                  PackageManagerService.this.mMoveCallbacks.notifyStatusChanged(
                      andIncrement, i2, j);
                }
              });
      return andIncrement;
    ...
    public void notifyDexLoad(String str, Map map, String str2) {
      ...
      if (!PackageManagerServiceUtils.isSystemOrRoot()
          && !snapshot.isCallerSameApp(str, callingUid, true)) {
        Slog.w(
            "PackageManager",
            TextUtils.formatSimple(
                "Invalid dex load report. loadingPackageName=%s, uid=%d",
                new Object[] {str, Integer.valueOf(callingUid)}));
        return;
      }
      ...
      if (dexUseManagerLocal != null) {
        PackageManagerLocal.FilteredSnapshot withFilteredSnapshot =
            ((PackageManagerLocal) LocalManagerRegistry.getManager(PackageManagerLocal.class))
                .withFilteredSnapshot(callingUid, callingUserHandle);
        if (str2 != null) {
          try {
      ...
      PackageManagerService.this.mDexManager.notifyDexLoad(
          applicationInfo, map, str2, identifier, Process.isIsolated(callingUid));
    }
    ...
    public void overrideLabelAndIcon(ComponentName componentName, String str, int i, int i2) {
      ...
      PackageManagerService.this.updateComponentLabelIcon(
          componentName, str, Integer.valueOf(i), i2);
    }

    public int performDexOptForADCP(String str, boolean z) {
      int i = z ? 2 : 0;
      Slog.e("dex2oat", "For test new API");
      return PackageManagerService.this.mDexOptHelper.performDexOptWithStatus(
          new DexoptOptions(str, 23, "speed-profile", null, i | 1 | 4));
    }
    ...
    public ParceledListSlice queryProperty(String str, int i) {
      ...
      List queryProperty =
          PackageManagerService.this.mPackageProperty.queryProperty(
              str,
              i,
              new Predicate() { // from class:
                // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda4
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$queryProperty$6;
                  lambda$queryProperty$6 =
                      PackageManagerService.IPackageManagerImpl.lambda$queryProperty$6(
                          Computer.this, callingUid, callingUserId, (String) obj);
    ...
    public static /* synthetic */ boolean lambda$queryProperty$6(
        Computer computer, int i, int i2, String str) {
    ...
    public void registerDexModule(
        ...
        final String str2,
        boolean z,
        final IDexModuleRegisterCallback iDexModuleRegisterCallback) {
      Slog.i(
          "PackageManager",
          "Ignored unsupported registerDexModule call for " + str2 + " in " + str);
      final DexManager.RegisterDexModuleResult registerDexModuleResult =
          new DexManager.RegisterDexModuleResult(
              false, "registerDexModule call not supported since Android U");
      if (iDexModuleRegisterCallback != null) {
        PackageManagerService.this.mHandler.post(
            new Runnable() { // from class:
              // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda15
              @Override // java.lang.Runnable
              public final void run() {
                PackageManagerService.IPackageManagerImpl.lambda$registerDexModule$7(
                    iDexModuleRegisterCallback, str2, registerDexModuleResult);
              }
            });
      }
    }

    public static /* synthetic */ void lambda$registerDexModule$7(
        IDexModuleRegisterCallback iDexModuleRegisterCallback,
        String str,
        DexManager.RegisterDexModuleResult registerDexModuleResult) {
      try {
        iDexModuleRegisterCallback.onDexModuleRegistered(
            str, registerDexModuleResult.success, registerDexModuleResult.message);
    ...
    public void restoreDomainVerification(byte[] bArr, int i) {
      ...
      try {
        ...
        PackageManagerService packageManagerService = PackageManagerService.this;
        packageManagerService.mDomainVerificationManager.restoreSettings(
            packageManagerService.snapshotComputer(), resolvePullParser);
    ...
    public void setApplicationCategoryHint(final String str, final int i, final String str2) {
      FunctionalUtils.ThrowingBiFunction throwingBiFunction =
          new FunctionalUtils.ThrowingBiFunction() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda18
            public final Object applyOrThrow(Object obj, Object obj2) {
              PackageStateMutator.Result lambda$setApplicationCategoryHint$9;
              lambda$setApplicationCategoryHint$9 =
                  PackageManagerService.IPackageManagerImpl.this
                      .lambda$setApplicationCategoryHint$9(
                          str2, str, i, (PackageStateMutator.InitialState) obj, (Computer) obj2);
              return lambda$setApplicationCategoryHint$9;
            }
          };
      PackageStateMutator.Result result =
          (PackageStateMutator.Result)
              throwingBiFunction.apply(
                  PackageManagerService.this.recordInitialState(),
                  PackageManagerService.this.snapshotComputer());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ PackageStateMutator.Result lambda$setApplicationCategoryHint$9(
        String str,
        String str2,
        final int i,
      ...
      ((AppOpsManager) PackageManagerService.this.mInjector.getSystemService(AppOpsManager.class))
          .checkPackage(Binder.getCallingUid(), str);
      PackageStateInternal packageStateForInstalledAndFiltered =
          computer.getPackageStateForInstalledAndFiltered(
              str2, Binder.getCallingUid(), UserHandle.getCallingUserId());
      if (packageStateForInstalledAndFiltered == null) {
        throw new IllegalArgumentException("Unknown target package " + str2);
      }
      if (!isAllowedToSetCategoryHint(packageStateForInstalledAndFiltered, str)
          && !Objects.equals(
              str, packageStateForInstalledAndFiltered.getInstallSource().mInstallerPackageName)) {
        throw new IllegalArgumentException(
            "Calling package " + str + " is not installer for " + str2);
      }
      PmLog.logDebugInfoAndLogcat(
          "setApplicationCategoryHint, pkg: "
              + str2
              + ", oldCategory: "
              + packageStateForInstalledAndFiltered.getCategoryOverride()
              + ", newCategory: "
              + i
              + ", manifestCategory: "
              + (packageStateForInstalledAndFiltered.getPkg() != null
                  ? packageStateForInstalledAndFiltered.getPkg().getCategory()
                  : -1)
              + ", caller: "
              + str
              + "/"
      ...
      if (packageStateForInstalledAndFiltered.getCategoryOverride() != i) {
        return PackageManagerService.this.commitPackageStateMutation(
            initialState,
            str2,
            new Consumer() { // from class:
              // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda21
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
    ...
    public final boolean isAllowedToSetCategoryHint(
        PackageStateInternal packageStateInternal, String str) {
      return (Binder.getCallingUid() == 1000 && Binder.getCallingPid() == Process.myPid())
          || ("com.sec.android.easyMover".equals(str)
              && "com.sec.android.easyMover"
                  .equals(packageStateInternal.getInstallSource().mInitiatingPackageName)
              && ((PackageManagerInternal) LocalServices.getService(PackageManagerInternal.class))
                  .isPlatformSigned(str));
    }
    ...
    */
    public void setApplicationEnabledSetting(String str, int i, int i2, int i3, String str2) {
      ...
      boolean z2 = false;
      if (!"auto_disabler".equals(str2)
          && !"com.sec.android.emergencymode.service".equals(str2)
          && (packageStateInternal =
                  PackageManagerService.this.snapshotComputer().getPackageStateInternal(str))
              != null) {
        PackageUserStateInternal userStateOrDefault =
            packageStateInternal.getUserStateOrDefault(i3);
        if (userStateOrDefault.getEnabledState() == 4
            && "auto_disabler".equals(userStateOrDefault.getLastDisableAppCaller())) {
          z = true;
          PackageManagerService.this.setEnabledSettings(
              List.of(new PackageManager.ComponentEnabledSetting(str, i, i2)), i3, str2);
          if (z) {
            return;
          }
          if ("com.google.android.partnersetup".equals(str2) && (i == 0 || i == 1)) {
            z2 = true;
          }
          PackageStateInternal packageStateInternal2 =
              PackageManagerService.this.snapshotComputer().getPackageStateInternal(str);
          if (packageStateInternal2 == null
              || packageStateInternal2.getUserStateOrDefault(i3).getEnabledState() != i) {
            return;
          }
          PackageManagerService.this.mAutoDisableHandler.sendAutoDisabledAppStateChanged(
              str, i3, z2);
          return;
        }
      }
    ...
    public boolean setApplicationHiddenSettingAsUser(String str, final boolean z, final int i) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.MANAGE_USERS", null);
      int callingUid = Binder.getCallingUid();
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      snapshotComputer.enforceCrossUserPermission(
          callingUid, i, true, true, "setApplicationHiddenSetting for user " + i);
      PmLog.logDebugInfoAndLogcat(
          "setApplicationHiddenSettingAsUser, packageName: "
              + str
              + ", userId: "
              + i
              + ", hidden: "
      ...
      if ("android".equals(str)
          || PackageManagerService.this.isRequiredSystemPackage(snapshotComputer, str, i)) {
      ...
      try {
        ...
        PackageUserStateInternal userStateOrDefault = packageStateInternal.getUserStateOrDefault(i);
        if (userStateOrDefault.isHidden() != z
            && userStateOrDefault.isInstalled()
            && !snapshotComputer.shouldFilterApplication(packageStateInternal, callingUid, i)) {
          AndroidPackageInternal pkg = packageStateInternal.getPkg();
          if (pkg != null) {
          ...
          if (z
              && !UserHandle.isSameApp(callingUid, packageStateInternal.getAppId())
              && PackageManagerService.this.mProtectedPackages.isPackageStateProtected(i, str)) {
          ...
          PackageManagerService.this.commitPackageStateMutation(
              ...
              str,
              new Consumer() { // from class:
                // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda5
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  PackageManagerService.IPackageManagerImpl
                      .lambda$setApplicationHiddenSettingAsUser$10(i, z, (PackageStateWrite) obj);
                }
              });
          Computer snapshotComputer2 = PackageManagerService.this.snapshotComputer();
          PackageStateInternal packageStateInternal2 =
              snapshotComputer2.getPackageStateInternal(str);
          if (z) {
            PackageManagerService.this.killApplication(
                str, packageStateInternal2.getAppId(), i, "hiding pkg", 13);
            ...
            PackageManagerService.this.sendPackageAddedForUser(
                snapshotComputer2, str, packageStateInternal2, i, 0);
          }
          PackageManagerService.this.scheduleWritePackageRestrictions(i);
          Binder.restoreCallingIdentity(clearCallingIdentity);
          return true;
    ...
    public static /* synthetic */ void lambda$setApplicationHiddenSettingAsUser$10(
        int i, boolean z, PackageStateWrite packageStateWrite) {
      packageStateWrite.userState(i).setHidden(z);
    }

    public boolean setBlockUninstallForUser(String str, boolean z, int i) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.DELETE_PACKAGES", null);
      PackageStateInternal packageStateInternal =
          PackageManagerService.this.snapshotComputer().getPackageStateInternal(str);
    ...
    public void setComponentEnabledSetting(
        ComponentName componentName, int i, int i2, int i3, String str) {
      if (PackageManagerService.this.mUserManager.exists(i3)) {
        if (str == null) {
          str = Integer.toString(Binder.getCallingUid());
        }
        PackageManagerService.this.setEnabledSettings(
            List.of(new PackageManager.ComponentEnabledSetting(componentName, i, i2)), i3, str);
      }
    }
    ...
    public String[] setDistractingPackageRestrictionsAsUser(String[] strArr, int i, int i2) {
      int callingUid = Binder.getCallingUid();
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      PackageManagerService.this.enforceCanSetDistractingPackageRestrictionsAsUser(
          callingUid, i2, "setDistractingPackageRestrictionsAsUser");
      Objects.requireNonNull(strArr, "packageNames cannot be null");
      return PackageManagerService.this.mDistractingPackageHelper
          .setDistractingPackageRestrictionsAsUser(snapshotComputer, strArr, i, i2, callingUid);
    }
    ...
    public void setHarmfulAppWarning(String str, final CharSequence charSequence, final int i) {
      ...
      if (!PackageManagerServiceUtils.isSystemOrRoot(appId)
          && snapshotComputer.checkUidPermission(
                  "android.permission.SET_HARMFUL_APP_WARNINGS", callingUid)
              != 0) {
        throw new SecurityException(
      ...
      if (PackageManagerService.this
          .commitPackageStateMutation(
              ...
              str,
              new Consumer() { // from class:
                // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  PackageManagerService.IPackageManagerImpl.lambda$setHarmfulAppWarning$11(
                      i, charSequence, (PackageStateWrite) obj);
                }
              })
    ...
    public static /* synthetic */ void lambda$setHarmfulAppWarning$11(
        int i, CharSequence charSequence, PackageStateWrite packageStateWrite) {
      packageStateWrite
          .userState(i)
          .setHarmfulAppWarning(charSequence == null ? null : charSequence.toString());
    }
    ...
    public boolean setInstallLocation(int i) {
      ...
      Settings.Global.putInt(
          PackageManagerService.this.mContext.getContentResolver(), "default_install_location", i);
      return true;
    }
    ...
    public void setInstallerPackageName(final String str, final String str2) {
      ...
      FunctionalUtils.ThrowingCheckedFunction throwingCheckedFunction =
          new FunctionalUtils.ThrowingCheckedFunction() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda7
            public final Object apply(Object obj) {
              Boolean lambda$setInstallerPackageName$12;
              lambda$setInstallerPackageName$12 =
                  PackageManagerService.IPackageManagerImpl.this.lambda$setInstallerPackageName$12(
                      callingUid, str, userId, str2, (Computer) obj);
              return lambda$setInstallerPackageName$12;
            }
          };
      PackageStateMutator.InitialState recordInitialState =
          PackageManagerService.this.recordInitialState();
      if (((Boolean) throwingCheckedFunction.apply(PackageManagerService.this.snapshotComputer()))
          .booleanValue()) {
        final int packageUid =
            str2 == null
                ? -1
                : PackageManagerService.this.snapshotComputer().getPackageUid(str2, 0L, userId);
        synchronized (PackageManagerService.this.mLock) {
          PackageStateMutator.Result commitPackageStateMutation =
              PackageManagerService.this.commitPackageStateMutation(
                  recordInitialState,
                  str,
                  new Consumer() { // from class:
                    // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda8
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                      ((PackageStateWrite) obj).setInstaller(str2, packageUid);
                    }
                  });
          if (commitPackageStateMutation.isPackagesChanged()
              || commitPackageStateMutation.isStateChanged()) {
            synchronized (PackageManagerService.this.mPackageStateWriteLock) {
              if (!((Boolean)
                      throwingCheckedFunction.apply(PackageManagerService.this.snapshotComputer()))
                  .booleanValue()) {
                return;
              } else {
                PackageManagerService.this.commitPackageStateMutation(
                    ...
                    str,
                    new Consumer() { // from class:
                      // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda9
                      @Override // java.util.function.Consumer
                      public final void accept(Object obj) {
                        ((PackageStateWrite) obj).setInstaller(str2, packageUid);
                      }
          ...
          PackageStateInternal packageStateInternal =
              PackageManagerService.this.snapshotComputer().getPackageStateInternal(str);
          PackageManagerService.this.mSettings.addInstallerPackageNames(
              packageStateInternal.getInstallSource());
          PackageManagerService packageManagerService = PackageManagerService.this;
          packageManagerService.mAppsFilter.addPackage(
              packageManagerService.snapshotComputer(), packageStateInternal);
          PackageManagerService.this.scheduleWriteSettings();
        }
      }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Boolean lambda$setInstallerPackageName$12(
        int i, String str, int i2, String str2, Computer computer) {
      PackageStateInternal packageStateInternal;
      ...
      PackageStateInternal packageStateForInstalledAndFiltered =
          computer.getPackageStateForInstalledAndFiltered(str, i, i2);
      if (packageStateForInstalledAndFiltered == null) {
      ...
      if (packageOrSharedUser != null) {
        ...
        if (obj != null) {
          ...
          signatures =
              ((SharedUserApi) packageOrSharedUser.second).getSigningDetails().getSignatures();
        }
        if (packageStateInternal != null
            && PackageManagerServiceUtils.compareSignatures(
                    signatures, packageStateInternal.getSigningDetails().getSignatures())
                != 0) {
          throw new SecurityException(
              "Caller does not have same cert as new installer package " + str2);
        }
        String str3 = packageStateForInstalledAndFiltered.getInstallSource().mInstallerPackageName;
        PackageStateInternal packageStateInternal2 =
            str3 != null ? computer.getPackageStateInternal(str3) : null;
        if (packageStateInternal2 != null) {
          if (PackageManagerServiceUtils.compareSignatures(
                  signatures, packageStateInternal2.getSigningDetails().getSignatures())
              != 0) {
            throw new SecurityException(
                "Caller does not have same cert as old installer package " + str3);
          }
        } else if (PackageManagerService.this.mContext.checkCallingOrSelfPermission(
                "android.permission.INSTALL_PACKAGES")
            != 0) {
          ...
          try {
            if (PackageManagerService.this
                .mInjector
                .getCompatibility()
                .isChangeEnabledByUid(150857253L, i)) {
              throw new SecurityException(
                  "Neither user "
                      + i
                      + " nor current process has android.permission.INSTALL_PACKAGES");
            }
            return Boolean.FALSE;
          } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public void relinquishUpdateOwnership(String str) {
      ...
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      PackageStateInternal packageStateForInstalledAndFiltered =
          snapshotComputer.getPackageStateForInstalledAndFiltered(str, callingUid, userId);
      if (packageStateForInstalledAndFiltered == null) {
        throw new IllegalArgumentException("Unknown target package: " + str);
      }
      String str2 = packageStateForInstalledAndFiltered.getInstallSource().mUpdateOwnerPackageName;
      PackageStateInternal packageStateInternal =
          str2 == null ? null : snapshotComputer.getPackageStateInternal(str2);
      if (packageStateInternal == null) {
        return;
      }
      int appId = UserHandle.getAppId(callingUid);
      ...
      PackageManagerService.this.commitPackageStateMutation(
          ...
          str,
          new Consumer() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public boolean setInstantAppCookie(String str, byte[] bArr, int i) {
      ...
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      snapshotComputer.enforceCrossUserPermission(
          Binder.getCallingUid(), i, true, true, "setInstantAppCookie");
      if (!snapshotComputer.isCallerSameApp(str, Binder.getCallingUid())
          || (packageStateInternal = snapshotComputer.getPackageStateInternal(str)) == null
          || packageStateInternal.getPkg() == null) {
        return false;
      }
      return PackageManagerService.this.mInstantAppRegistry.setInstantAppCookie(
          packageStateInternal.getPkg(),
          bArr,
          PackageManagerService.this.mContext.getPackageManager().getInstantAppCookieMaxBytes(),
          i);
    }
    ...
    public void setMimeGroup(final String str, final String str2, List list) {
      ...
      if (emptyIfNull.size() > 500) {
        throw new IllegalStateException(
            "Max limit on MIME types for MIME group " + str2 + " exceeded for package " + str);
      }
      ...
      PackageManagerService.this.commitPackageStateMutation(
          ...
          str,
          new Consumer() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda19
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
      ...
      PackageManagerService packageManagerService = PackageManagerService.this;
      if (packageManagerService.mComponentResolver.updateMimeGroup(
          packageManagerService.snapshotComputer(), str, str2)) {
        Binder.withCleanCallingIdentity(
            new FunctionalUtils.ThrowingRunnable() { // from class:
              // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda20
              public final void runOrThrow() {
                PackageManagerService.IPackageManagerImpl.this.lambda$setMimeGroup$17(
                    str, packageStateInternal);
              }
            });
      }
      PackageManagerService.this.scheduleWriteSettings();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setMimeGroup$17(
        String str, PackageStateInternal packageStateInternal) {
      ...
      for (int i = 0; i < resolveUserIds.length; i++) {
        PackageUserStateInternal packageUserStateInternal =
            (PackageUserStateInternal) packageStateInternal.getUserStates().get(resolveUserIds[i]);
        if (packageUserStateInternal != null && packageUserStateInternal.isInstalled()) {
          PackageManagerService.this.sendPackageChangedBroadcast(
              ...
              true,
              arrayList,
              UserHandle.getUid(resolveUserIds[i], appId),
              "The mimeGroup is changed");
        }
      }
    }
    ...
    public void setPackageStoppedState(String str, boolean z, int i) {
      ...
      packageManagerService.setPackageStoppedState(
          packageManagerService.snapshotComputer(), str, z, i);
    }
    ...
    public String[] setPackagesSuspendedAsUser(
      ...
      int callingUid = Binder.getCallingUid();
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      PackageManagerService.this.enforceCanSetPackagesSuspendedAsUser(
          snapshotComputer, str, callingUid, i, "setPackagesSuspendedAsUser");
      PmLog.logDebugInfoAndLogcat(
          "setPackagesSuspendedAsUser, packageName: "
              ...
              + ", callingPackage: "
              + str);
      return PackageManagerService.this.mSuspendPackageHelper.setPackagesSuspended(
          snapshotComputer,
          strArr,
          z,
          persistableBundle,
    ...
    public boolean setRequiredForSystemUser(String str, final boolean z) {
      ...
      if (!PackageManagerService.this
          .commitPackageStateMutation(
              ...
              str,
              new Consumer() { // from class:
                // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda6
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
    ...
    public void setSplashScreenTheme(String str, final String str2, final int i) {
      ...
      Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
      snapshotComputer.enforceCrossUserPermission(
          callingUid, i, false, false, "setSplashScreenTheme");
      ...
      PackageManagerService.this.commitPackageStateMutation(
          ...
          str,
          new Consumer() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda10
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PackageManagerService.IPackageManagerImpl.lambda$setSplashScreenTheme$19(
                  i, str2, (PackageStateWrite) obj);
            }
          });
    }

    public static /* synthetic */ void lambda$setSplashScreenTheme$19(
        int i, String str, PackageStateWrite packageStateWrite) {
      packageStateWrite.userState(i).setSplashScreenTheme(str);
    }

    public void setUpdateAvailable(String str, final boolean z) {
      PackageManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.INSTALL_PACKAGES", null);
      PackageManagerService.this.commitPackageStateMutation(
          null,
          str,
          new Consumer() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda16
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void verifyPendingInstall(final int i, final int i2) {
      ...
      PackageManagerService.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
              PackageManagerService.IPackageManagerImpl.this.lambda$verifyPendingInstall$21(
                  i, callingUid, i2);
            }
          });
      Slog.d(
          "PackageManager",
          "verifyPendingInstall vid: " + i + ", vcode: " + i2 + ", callingUid: " + callingUid);
    }
    ...
    public /* synthetic */ void lambda$verifyPendingInstall$21(int i, int i2, int i3) {
      ...
      if (packageVerificationState.checkRequiredVerifierUid(i2)
          || packageVerificationState.checkSufficientVerifierUid(i2)) {
        Message obtainMessage = PackageManagerService.this.mHandler.obtainMessage(15);
        PackageVerificationResponse packageVerificationResponse =
            new PackageVerificationResponse(i3, i2);
        obtainMessage.arg1 = i;
    ...
    public void requestPackageChecksums(
        ...
        int i3) {
      PackageManagerService packageManagerService = PackageManagerService.this;
      packageManagerService.requestChecksumsInternal(
          ...
          iOnChecksumsReadyListener,
          i3,
          PackageManagerService.this.mInjector.getBackgroundExecutor(),
          PackageManagerService.this.mInjector.getBackgroundHandler());
    }

    public void notifyPackagesReplacedReceived(String[] strArr) {
      ArraySet notifyPackagesForReplacedReceived =
          PackageManagerService.this
              .snapshotComputer()
              .getNotifyPackagesForReplacedReceived(strArr);
      for (int i = 0; i < notifyPackagesForReplacedReceived.size(); i++) {
        PackageManagerService.this.notifyInstallObserver(
            (String) notifyPackagesForReplacedReceived.valueAt(i), false);
      }
    }
    ...
    public boolean waitForHandler(long j, boolean z) {
      ...
      if (z) {
        PackageManagerService.this.mBackgroundHandler.post(
            new SettingsStore$$ExternalSyntheticLambda1(countDownLatch));
      } else {
        PackageManagerService.this.mHandler.post(
            new SettingsStore$$ExternalSyntheticLambda1(countDownLatch));
      }
    ...
    public void onShellCommand(
      ...
      new PackageManagerShellCommand(
              this,
              packageManagerService.mContext,
              packageManagerService.mDomainVerificationManager.getShell())
          .exec(
              this,
              fileDescriptor,
              fileDescriptor2,
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      ...
      if (DumpUtils.checkDumpAndUsageStatsPermission(
          PackageManagerService.this.mContext, "PackageManager", printWriter)) {
        if (CoreRune.BAIDU_CARLIFE
            && BaiduCarlifeADBConnectUtils.isCarlifeForceConnect()
            && (strArr.length == 0 || BaiduCarlifeADBConnectUtils.isBaiduCarlifePkg(strArr[0]))) {
        ...
        KnownPackages knownPackages =
            new KnownPackages(
                defaultAppProvider,
                packageManagerService.mRequiredInstallerPackage,
                packageManagerService.mRequiredUninstallerPackage,
                packageManagerService.mSetupWizardPackage,
                packageManagerService.mRequiredVerifierPackages,
                packageManagerService.mDefaultTextClassifierPackage,
                packageManagerService.mSystemTextClassifierPackageName,
                packageManagerService.mRequiredPermissionControllerPackage,
                packageManagerService.mConfiguratorPackage,
                packageManagerService.mIncidentReportApproverPackage,
                packageManagerService.mAmbientContextDetectionPackage,
                packageManagerService.mWearableSensingPackage,
                packageManagerService.mAppPredictionServicePackage,
                "com.android.companiondevicemanager",
                packageManagerService.mRetailDemoPackage,
                packageManagerService.mOverlayConfigSignaturePackage,
                packageManagerService.mRecentsPackage);
        synchronized (PackageManagerService.this.mAvailableFeatures) {
        ...
        PermissionManagerServiceInternal permissionManagerServiceInternal =
            packageManagerService2.mPermissionManager;
        ...
        new DumpHelper(
                permissionManagerServiceInternal,
                storageEventHelper,
                packageManagerService3.mDomainVerificationManager,
                packageManagerService3.mInstallerService,
                packageManagerService3.mRequiredVerifierPackages,
                knownPackages,
                packageManagerService3.mChangedPackagesTracker,
                arrayMap,
                arraySet,
                packageManagerService3.getPerUidReadTimeouts(snapshotComputer),
                PackageManagerService.this.mSnapshotStatistics)
            .doDump(snapshotComputer, fileDescriptor, printWriter, strArr);
        PackageManagerService.this.mPmLifecycle.onDump(snapshotComputer, printWriter, strArr);
        if (PMRune.PM_BADGE_ON_MONETIZED_APP_SUPPORTED) {
          PackageManagerService.this.mMonetizationUtils.dumpMonetizationBadgeState(
              printWriter, strArr);
        }
    ...
    public final void dumpHeimdAllFSState(PrintWriter printWriter, String str) {
      ...
      HeimdAllFsService heimdAllFsService =
          new HeimdAllFsService(PackageManagerService.this.mContext);
      HashMap hashMap = new HashMap();
      synchronized (PackageManagerService.this.mLock) {
        if (str != null) {
          try {
            arrayList.add(
                PackageManagerService.this.mContext.getPackageManager().getPackageInfo(str, 0));
          } catch (PackageManager.NameNotFoundException unused) {
            return;
          }
        } else {
          arrayList =
              PackageManagerService.this.mContext.getPackageManager().getInstalledPackages(0);
        }
        if (arrayList != null && arrayList.size() != 0) {
          ...
          for (String str3 : hashMap.keySet()) {
            ...
            while (it.hasNext()) {
              long[] dumpPackageState =
                  heimdAllFsService.dumpPackageState(indentingPrintWriter, (String) it.next());
    ...
    public boolean getMetadataForIconTray(String str, String str2, int i, List list) {
      ...
      if (PackageManagerService.this.mUserManager.exists(i)
        ...
        Computer snapshotComputer = PackageManagerService.this.snapshotComputer();
        snapshotComputer.enforceCrossUserPermission(
            Binder.getCallingUid(), i, false, false, "get application info");
        int callingUid = Binder.getCallingUid();
        PackageStateInternal packageStateInternal = snapshotComputer.getPackageStateInternal(str);
        if (packageStateInternal == null
            || packageStateInternal.getPkg() == null
            || snapshotComputer.shouldFilterApplication(packageStateInternal, callingUid, i)
            || (metaData = packageStateInternal.getPkg().getMetaData()) == null) {
          return false;
        }
        boolean z = metaData.getBoolean(str2);
        CharSequence charSequence =
            metaData.getCharSequence("com.samsung.android.icon_container.feature_appicon");
    ...
    public boolean isPackageAutoDisabled(String str, int i) {
      ...
      if (str != null
          && (packageStateInternal =
              ...
              != null) {
        PackageUserStateInternal userStateOrDefault =
            packageStateInternal.getUserStateOrDefault(userId);
        if (userStateOrDefault.getEnabledState() == 4
            && "auto_disabler".equals(userStateOrDefault.getLastDisableAppCaller())) {
          return true;
        }
    ...
    public boolean semIsPermissionRevokedByUserFixed(String str, String str2, int i) {
      if (UserHandle.getCallingUserId() != i) {
        PackageManagerService.this.mContext.enforceCallingPermission(
            "android.permission.INTERACT_ACROSS_USERS_FULL",
            "semIsPermissionRevokedByUserFixed for user " + i);
      }
      ...
      try {
        return (((PermissionManager)
                        PackageManagerService.this.mContext.getSystemService(
                            PermissionManager.class))
                    .getPermissionFlags(str2, str, UserHandle.of(i))
                & 2)
            != 0;
      } finally {
        Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public void setApplicationEnabledSettingWithList(
        List list, int i, int i2, boolean z, boolean z2, int i3, String str) {
      PackageManagerService.this.mEmergencyModePackageHandler.setApplicationEnabledSettingWithList(
          list, i, i2, z, z2, i3, str);
    }

    public int getProgressionOfPackageChanged() {
      return PackageManagerService.this.mEmergencyModePackageHandler
          .getProgressionOfPackageChanged();
    }

    public void cancelEMPHandlerSendPendingBroadcast() {
      PackageManagerService.this.mEmergencyModePackageHandler
    ...
    public List getRequestedRuntimePermissionsForMDM(String str) {
      ...
      return PackageManagerService.this.mPermissionManager.getRequestedRuntimePermissionsForMDM(
          str);
    }
    ...
    public boolean applyRuntimePermissionsForMDM(String str, List list, int i, int i2) {
      return PackageManagerService.this.mPermissionManager.applyRuntimePermissionsForMDM(
          str, list, i, i2);
    }
    ...
    public int setLicensePermissionsForMDM(String str) {
      ...
      synchronized (PackageManagerService.this.mLock) {
        licensePermissionsForMDM =
            PackageManagerService.this.mPermissionManager.setLicensePermissionsForMDM(str, keySet);
        PackageManagerService packageManagerService = PackageManagerService.this;
    ...
    public List getPackageGrantedPermissionsForMDM(String str) {
      ...
      if (callingUid != 0 && callingUid != 1000) {
        throw new SecurityException(
            "getPackageGrantedPermissionsForMDM can only be called by the system");
      }
    ...
    public void clearPackagePreferredActivitiesAsUserForMDM(String str, int i) {
      ...
      if (callingUid != 0 && callingUid != 1000) {
        throw new SecurityException(
            "clearPackagePreferredActivitiesAsUserForMDM can only be called by the system");
      }
      long currentTimeMillis = System.currentTimeMillis();
      ...
      try {
        ...
        if (currentTimeMillis2 > 100) {
          Log.d(
              "PackageManager",
              "clearPackagePreferredActivitiesAsUserForMDM - Execution time: "
                  + currentTimeMillis2
                  + " ms");
        }
      }
    ...
    public List getGrantedPermissionsForMDM(String str) {
      ...
      Collection<LegacyPermissionState.PermissionState> permissionStates =
          legacyPermissionState.getPermissionStates(-1);
      Collection<LegacyPermissionState.PermissionState> permissionStates2 =
          packageStateInternal.getPkg().getTargetSdkVersion() > 22
              ? legacyPermissionState.getPermissionStates(0)
              : null;
    ...
    public ParceledListSlice getUnknownSourcePackagesAsUser(long j, int i) {
      ArrayList arrayList = new ArrayList();
      UnknownSourceAppManager unknownSourceAppManager =
          PackageManagerService.this.mCustomInjector.getUnknownSourceAppManager();
    ...
    public boolean isUnknownSourcePackage(String str) {
      UnknownSourceAppManager unknownSourceAppManager =
          PackageManagerService.this.mCustomInjector.getUnknownSourceAppManager();
      return (unknownSourceAppManager == null
              || !unknownSourceAppManager.isUnknownSourcePackage(str)
              || snapshot().getPackageStateInternal(str) == null)
          ? false
          : true;
    }
  ...
  public class PackageManagerInternalImpl extends PackageManagerInternalBase {
    ...
    public boolean isPlatformSigned(String str) {
      ...
      return signingDetails.hasAncestorOrSelf(
              PackageManagerService.this.mPlatformPackage.getSigningDetails())
          || PackageManagerService.this
              .mPlatformPackage
              .getSigningDetails()
    ...
    public boolean hasSignatureCapability(int i, int i2, int i3) {
      ...
      return signingDetails.checkCapability(signingDetails2, i3)
    ...
    public PackageList getPackageList(
      ...
      PackageManagerService.this.forEachPackageState(
          snapshot(),
          new Consumer() { // from class:
            // com.android.server.pm.PackageManagerService$PackageManagerInternalImpl$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PackageManagerService.PackageManagerInternalImpl.lambda$getPackageList$0(
                  arrayList, (PackageStateInternal) obj);
            }
          });
    ...
    public static /* synthetic */ void lambda$getPackageList$0(
        ArrayList arrayList, PackageStateInternal packageStateInternal) {
      AndroidPackageInternal pkg = packageStateInternal.getPkg();
      if (pkg != null) {
    ...
    public void removeAllNonSystemPackageSuspensions(int i) {
      ...
      PackageManagerService.this.mSuspendPackageHelper.removeSuspensionsBySuspendingPackage(
          snapshotComputer,
          snapshotComputer.getAllAvailablePackageNames(),
          new Predicate() { // from class:
            // com.android.server.pm.PackageManagerService$PackageManagerInternalImpl$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$removeAllNonSystemPackageSuspensions$1;
              lambda$removeAllNonSystemPackageSuspensions$1 =
                  PackageManagerService.PackageManagerInternalImpl
                      .lambda$removeAllNonSystemPackageSuspensions$1((String) obj);
    ...
    public static /* synthetic */ boolean lambda$removeAllNonSystemPackageSuspensions$1(
        String str) {
    ...
    public boolean isPackagePersistent(String str) {
      ...
      return packageStateInternal != null
          && (pkg = packageStateInternal.getPkg()) != null
          && packageStateInternal.isSystem()
          && pkg.isPersistent();
    }
    ...
    public List getTargetPackageNames(int i) {
      ...
      PackageManagerService.this.forEachPackageState(
          snapshot(),
          new Consumer() { // from class:
            // com.android.server.pm.PackageManagerService$PackageManagerInternalImpl$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PackageManagerService.PackageManagerInternalImpl.lambda$getTargetPackageNames$2(
                  arrayList, (PackageStateInternal) obj);
            }
          });
      return arrayList;
    ...
    public static /* synthetic */ void lambda$getTargetPackageNames$2(
        List list, PackageStateInternal packageStateInternal) {
      AndroidPackageInternal pkg = packageStateInternal.getPkg();
    ...
    public String removeLegacyDefaultBrowserPackageName(int i) {
      ...
      synchronized (PackageManagerService.this.mLock) {
        removeDefaultBrowserPackageNameLPw =
            PackageManagerService.this.mSettings.removeDefaultBrowserPackageNameLPw(i);
      }
    ...
    public void uninstallApex(String str, long j, int i, IntentSender intentSender, int i2) {
      ...
      PackageInstallerService.PackageDeleteObserverAdapter packageDeleteObserverAdapter =
          new PackageInstallerService.PackageDeleteObserverAdapter(
              PackageManagerService.this.mContext, intentSender, str, false, i);
      if ((i2 & 2) == 0) {
        packageDeleteObserverAdapter.onPackageDeleted(
            str, -5, "Can't uninstall an apex for a single user");
        return;
      }
      ...
      if (j != -1 && packageInfo.getLongVersionCode() != j) {
        packageDeleteObserverAdapter.onPackageDeleted(
            str,
            -5,
            "Active version " + packageInfo.getLongVersionCode() + " is not equal to " + j + "]");
        return;
      }
    ...
    public void legacyReconcileSecondaryDexFiles(String str) {
      ...
      if (snapshotComputer.getInstantAppPackageName(Binder.getCallingUid()) == null
          && !snapshotComputer.isInstantAppInternal(str, UserHandle.getCallingUserId(), 1000)) {
    ...
    public boolean registerInstalledLoadingProgressCallback(
      ...
      return incrementalManager.registerLoadingProgressCallback(
          packageStateForInstalledAndFiltered.getPathString(),
    ...
    public IncrementalStatesInfo getIncrementalStatesInfo(String str, int i, int i2) {
      PackageStateInternal packageStateForInstalledAndFiltered =
          PackageManagerService.this
              .snapshotComputer()
              .getPackageStateForInstalledAndFiltered(str, i, i2);
      if (packageStateForInstalledAndFiltered == null) {
        return null;
      }
      return new IncrementalStatesInfo(
          packageStateForInstalledAndFiltered.isLoading(),
          packageStateForInstalledAndFiltered.getLoadingProgress(),
    ...
    public void onPackageProcessKilledForUninstall(final String str) {
      PackageManagerService.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.pm.PackageManagerService$PackageManagerInternalImpl$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              PackageManagerService.PackageManagerInternalImpl.this
                  .lambda$onPackageProcessKilledForUninstall$3(str);
            }
          });
    }
  }

  public final void setEnabledOverlayPackages(
      final int i, final ArrayMap arrayMap, final Set set, Set set2) {
    int i2;
    String str;
    ...
    synchronized (this.mOverlayPathsLock) {
      ...
      while (true) {
        ...
        if (str2 != null && pkg != null) {
          if (Objects.equals(
              packageStateInternal.getUserStateOrDefault(i).getOverlayPaths(), overlayPaths)) {
            i2 = i3;
          } else {
            if (pkg.getLibraryNames() != null) {
              for (String str3 : pkg.getLibraryNames()) {
                int i4 = i3;
                SharedLibraryInfo sharedLibraryInfo =
                    snapshotComputer.getSharedLibraryInfo(str3, -1L);
                if (sharedLibraryInfo == null) {
                  i3 = i4;
                } else {
                  String str4 = str3;
                  ...
                  if (packagesUsingSharedLibrary == null) {
                    ...
                    for (VersionedPackage versionedPackage : packagesUsingSharedLibrary) {
                      PackageStateInternal packageStateInternal3 =
                          snapshotComputer.getPackageStateInternal(
      ...
      commitPackageStateMutation(
          null,
          new Consumer() { // from class:
            // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda72
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PackageManagerService.lambda$setEnabledOverlayPackages$65(
                  size, arrayMap, set, i, arrayMap3, (PackageStateMutator) obj);
            }
          });
    }
    if (i == 0) {
  ...
  public static /* synthetic */ void lambda$setEnabledOverlayPackages$65(
      int i,
      ArrayMap arrayMap,
      Set set,
      int i2,
      ArrayMap arrayMap2,
      PackageStateMutator packageStateMutator) {
        ...
        if (arrayMap3 != null) {
          for (int i4 = 0; i4 < arrayMap3.size(); i4++) {
            ...
            for (int i5 = 0; i5 < arraySet.size(); i5++) {
              packageStateMutator
                  .forPackage((String) arraySet.valueAt(i5))
                  .userState(i2)
                  .setOverlayPathsForLibrary(str2, overlayPaths);
            }
          }
        }
      }
  ...
  public final boolean canSetOverlayPaths(OverlayPaths overlayPaths, OverlayPaths overlayPaths2) {
    ...
    return ((overlayPaths == null && overlayPaths2.isEmpty())
            || (overlayPaths2 == null && overlayPaths.isEmpty()))
        ? false
        : true;
  }
  ...
  public final void maybeUpdateSystemOverlays(String str, OverlayPaths overlayPaths) {
    if (!this.mResolverReplaced) {
      if (str.equals("android")) {
        if (overlayPaths == null) {
          ...
          this.mPlatformPackageOverlayPaths =
              (String[]) overlayPaths.getOverlayPaths().toArray(new String[0]);
          this.mPlatformPackageOverlayResourceDirs =
              (String[]) overlayPaths.getResourceDirs().toArray(new String[0]);
        }
    ...
    if (str.equals(this.mResolveActivity.applicationInfo.packageName)) {
      if (overlayPaths == null) {
        ...
        this.mReplacedResolverPackageOverlayPaths =
            (String[]) overlayPaths.getOverlayPaths().toArray(new String[0]);
        this.mReplacedResolverPackageOverlayResourceDirs =
            (String[]) overlayPaths.getResourceDirs().toArray(new String[0]);
      }
      applyUpdatedSystemOverlayPaths();
    }
  ...
  public final void enforceAdjustRuntimePermissionsPolicyOrUpgradeRuntimePermissions(String str) {
    ...
    throw new SecurityException(
        str
            + " requires android.permission.ADJUST_RUNTIME_PERMISSIONS_POLICY or"
            + " android.permission.UPGRADE_RUNTIME_PERMISSIONS");
  }
  ...
  public void forEachInstalledPackage(Computer computer, final Consumer consumer, final int i) {
    forEachPackageState(
        computer.getPackageStates(),
        new Consumer() { // from class:
          // com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda70
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            PackageManagerService.lambda$forEachInstalledPackage$66(
                i, consumer, (PackageStateInternal) obj);
          }
        });
  }

  public static /* synthetic */ void lambda$forEachInstalledPackage$66(
      int i, Consumer consumer, PackageStateInternal packageStateInternal) {
    if (packageStateInternal.getPkg() == null
        || !packageStateInternal.getUserStateOrDefault(i).isInstalled()) {
      return;
    }
  ...
  public void grantImplicitAccess(
      Computer computer, int i, Intent intent, int i2, int i3, boolean z, boolean z2) {
    ...
    if (!computer.isInstantAppInternal(androidPackage.getPackageName(), i, i3)) {
      ...
      grantImplicitAccess =
          this.mInstantAppRegistry.grantInstantAccess(i, intent, i2, UserHandle.getAppId(i3));
    }
  ...
  public long deleteOatArtifactsOfPackage(Computer computer, String str) {
          ...
          try {
            long freedBytes =
                DexOptHelper.getArtManagerLocal()
                    .deleteDexoptArtifacts(withFilteredSnapshot, str)
                    .getFreedBytes();
            if (withFilteredSnapshot != null) {
              withFilteredSnapshot.close();
            }
    ...
    try {
      return this.mDexManager.deleteOptimizedFiles(
          ArtUtils.createArtPackageInfo(packageStateInternal.getPkg(), packageStateInternal));
  ...
  public static boolean isPreapprovalRequestAvailable() {
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      if (Resources.getSystem().getBoolean(R.bool.config_fold_lock_behavior)) {
  ...
  public static boolean isUpdateOwnershipEnforcementAvailable() {
    ...
    try {
      return DeviceConfig.getBoolean(
          "package_manager_service", "is_update_ownership_enforcement_available", true);
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
  }
  ...
  public final PerUidReadTimeouts[] parsePerUidReadTimeouts(Computer computer) {
    List parseDigestersList =
        PerPackageReadTimeouts.parseDigestersList(getDefaultTimeouts(), getKnownDigestersList());
    ...
    for (int i = 0; i < size; i++) {
      PerPackageReadTimeouts perPackageReadTimeouts =
          (PerPackageReadTimeouts) parseDigestersList.get(i);
      PackageStateInternal packageStateInternal =
          computer.getPackageStateInternal(perPackageReadTimeouts.packageName);
      if (packageStateInternal != null && packageStateInternal.getAppId() >= 10000) {
        ...
        if (pkg.getLongVersionCode() >= perPackageReadTimeouts.versionCodes.minVersionCode
            && pkg.getLongVersionCode() <= perPackageReadTimeouts.versionCodes.maxVersionCode
            && (perPackageReadTimeouts.sha256certificate == null
                || pkg.getSigningDetails()
                    .hasSha256Certificate(perPackageReadTimeouts.sha256certificate))) {
          for (int i2 : userIds) {
  ...
  public void addInstrumentation(
      ComponentName componentName, ParsedInstrumentation parsedInstrumentation) {
  ...
  public String[] getKnownPackageNamesInternal(Computer computer, int i, int i2) {
    return new KnownPackages(
            this.mDefaultAppProvider,
            this.mRequiredInstallerPackage,
            this.mRequiredUninstallerPackage,
            this.mSetupWizardPackage,
            this.mRequiredVerifierPackages,
            this.mDefaultTextClassifierPackage,
            this.mSystemTextClassifierPackageName,
            this.mRequiredPermissionControllerPackage,
            ...
            this.mAppPredictionServicePackage,
            "com.android.companiondevicemanager",
            this.mRetailDemoPackage,
            this.mOverlayConfigSignaturePackage,
            this.mRecentsPackage)
        .getKnownPackageNames(computer, i, i2);
  }
  ...
  public boolean setActiveLauncherPackage(String str, int i, Consumer consumer) {
    return this.mDefaultAppProvider.setDefaultHome(
        str, i, this.mContext.getMainExecutor(), consumer);
  }
  ...
  public void setUpCustomResolverActivity(
      AndroidPackage androidPackage, PackageSetting packageSetting) {
    synchronized (this.mLock) {
      this.mResolverReplaced = true;
      ApplicationInfo generateApplicationInfo =
          PackageInfoUtils.generateApplicationInfo(
              androidPackage, 0L, PackageUserStateInternal.DEFAULT, 0, packageSetting);
      ...
      Slog.i(
          "PackageManager",
          "Replacing default ResolverActivity with custom activity: " + this.mResolveComponentName);
    }
  }
  ...
  public void setPlatformPackage(AndroidPackage androidPackage, PackageSetting packageSetting) {
    synchronized (this.mLock) {
      ...
      if (!this.mResolverReplaced) {
        ...
        resolveInfo.preferredOrder = 0;
        resolveInfo.match = 0;
        this.mResolveComponentName =
            new ComponentName(this.mAndroidApplication.packageName, this.mResolveActivity.name);
      }
      onChanged();
    }
    applyUpdatedSystemOverlayPaths();
  ...
  public int getSystemPackageScanFlags(File file) {
    ...
    return scanPartition.containsPrivApp(file)
  ...
  public PackageStateMutator.Result commitPackageStateMutation(
      PackageStateMutator.InitialState initialState, Consumer consumer) {
    synchronized (this.mPackageStateWriteLock) {
      PackageStateMutator.Result generateResult =
          this.mPackageStateMutator.generateResult(
              initialState, this.mChangedPackagesTracker.getSequenceNumber());
  ...
  public PackageStateMutator.Result commitPackageStateMutation(
      PackageStateMutator.InitialState initialState, String str, Consumer consumer) {
    PackageStateMutator.Result result =
        Thread.holdsLock(this.mPackageStateWriteLock) ? PackageStateMutator.Result.SUCCESS : null;
    synchronized (this.mPackageStateWriteLock) {
      if (result == null) {
        result =
            this.mPackageStateMutator.generateResult(
  ...
  public void deletePackageAsUserAndPersona(
      String str, IPackageDeleteObserver iPackageDeleteObserver, int i, int i2) {
    PersonaServiceHelper.deletePackageAsUserAndPersona(
        str,
      ...
      if (packageSetting != null) {
        try {
          if (packageSetting.getPkg() != null
              && !asInterface.isApplicationInstallationEnabled(
                  str,
                  packageSetting.getPkg().getSigningDetails().getSignatures(),
                  packageSetting.getPkg().getRequestedPermissions(),
                  i)) {
      ...
      synchronized (this.mLock) {
        ...
        if (packageSetting2 != null) {
          if (packageSetting2.getInstalled(i)) {
            ...
            this.mSettings.writePackageRestrictionsLPr(i);
            bundle.putInt(
                "android.intent.extra.UID", UserHandle.getUid(i, packageSetting2.getAppId()));
            z = true;
          }
          if (z) {
            i2 = 1;
          ...
          if (PersonaServiceHelper.isSpfKnoxSupported()) {
            ...
            if (sPersonaManager.getSeparationConfigfromCache() != null
                && sPersonaManager.processAppSeparationInstallation(str) != i2) {
              return -110;
            }
          }
          return i2;
  ...
  public int deletePackageXForKnox(String str, int i, int i2) {
    PmLog.logDebugInfoAndLogcat(
        "deletePackageXForKnox: pkg{" + str + "}, user{" + i + "}, flags{" + i2 + "}");
  ...
  */
  public List getPackageListForDualDarPolicy(String str) {
    ...
    packageStates = snapshotComputer().getPackageStates();
    arrayList = new ArrayList();
    size = packageStates.size();
    str.hashCode();
    i = 0;
    switch (str) {
      case "pkg_not_system":
        while (i < size) {
          ...
          if (packageStateInternal.getPkg() != null
              && packageStateInternal.getPackageName() != null
              && !packageStateInternal.isSystem()) {
        ...
        break;
      case "pkg_not_clearable_system":
        while (i < size) {
          PackageStateInternal packageStateInternal2 =
              (PackageStateInternal) packageStates.valueAt(i);
          if (packageStateInternal2.getPkg() != null
              && packageStateInternal2.getPackageName() != null
              && packageStateInternal2.isSystem()
              && (androidPackage =
                      (AndroidPackage) this.mPackages.get(packageStateInternal2.getPackageName()))
                  != null
      ...
      case "pkg_sys":
        while (i < size) {
          PackageStateInternal packageStateInternal3 =
              (PackageStateInternal) packageStates.valueAt(i);
          if (packageStateInternal3.getPkg() != null
              && packageStateInternal3.getPackageName() != null
              && packageStateInternal3.isSystem()) {
            arrayList.add(packageStateInternal3.getPackageName());
          }
          i++;
        }
        break;
      case "pkg_clearable_system":
        while (i < size) {
          PackageStateInternal packageStateInternal4 =
              (PackageStateInternal) packageStates.valueAt(i);
          if (packageStateInternal4.getPkg() != null
              && packageStateInternal4.getPackageName() != null
              && packageStateInternal4.isSystem()
              && (androidPackage2 =
                      (AndroidPackage) this.mPackages.get(packageStateInternal4.getPackageName()))
                  != null
              && androidPackage2.isClearUserDataAllowed()) {
  ...
  public void overlaysInstallComplete(
      int i, int i2, InstallLocaleOverlaysType installLocaleOverlaysType, int i3, String str) {
  ...
  public void overlaysInstallComplete(
      int i,
      int i2,
      InstallLocaleOverlaysType installLocaleOverlaysType,
      int i3,
      String str,
      Runnable runnable) {
    if (runnable != null) {
    ...
    Slog.d(
        "PackageManager",
        "overlaysInstallComplete() called with: token = ["
            + i
            + "], didLaunch = ["
            + i2
            + "], type = ["
            + installLocaleOverlaysType
            + "], userId = ["
            + i3
            + "], targetPackage = ["
            + str
            ...
            + runnable
            + "]");
    int i4 = AbstractC21499.f1719x9b3a765e[installLocaleOverlaysType.ordinal()];
    if (i4 == 1) {
      ...
      sendPackageAddedForUser(
          snapshotComputer, str, snapshotComputer.getPackageStateInternal(str), i3, 0);
    }
  }

  /* renamed from: com.android.server.pm.PackageManagerService$9 */
  public abstract /* synthetic */ class AbstractC21499 {

    /* renamed from: $SwitchMap$com$android$server$pm$PackageManagerService$InstallLocaleOverlaysType */
    public static final /* synthetic */ int[] f1719x9b3a765e;
    ...
    static {
      ...
      try {
        f1719x9b3a765e[InstallLocaleOverlaysType.PACKAGE_UNINSTALL_UPDATES.ordinal()] = 2;
      } catch (NoSuchFieldError unused2) {
      }
      try {
        f1719x9b3a765e[InstallLocaleOverlaysType.PACKAGE_ENABLE.ordinal()] = 3;
  ...
  public void updateLocaleOverlaysForUpdateRemovedPackage(int i, String str) {
    updateLocaleOverlaysForPackage(
        i, 0, InstallLocaleOverlaysType.PACKAGE_UNINSTALL_UPDATES, -1, str);
  }

  public void updateLocaleOverlaysForPackage(Message message) {
    Slog.d(
        "PackageManager", "updateLocaleOverlaysForPackage() called with: msg = [" + message + "]");
    int i = message.arg1;
    int i2 = message.arg2;
    ...
    if (installRequest == null) {
      ...
      updateLocaleOverlaysForPackage(
          i, i2, InstallLocaleOverlaysType.PACKAGE_INSTALL, -1, installRequest.getName());
    }
  }

  public final void updateLocaleOverlaysForPackage(
      int i, int i2, InstallLocaleOverlaysType installLocaleOverlaysType, int i3, String str) {
    if (str == null) {
    ...
    try {
      OverlayChangeObserverImpl overlayChangeObserverImpl =
          new OverlayChangeObserverImpl(i, i2, installLocaleOverlaysType, i3, str, this);
  ...
  public boolean isLocaleOptimizedPackage(String str, int i) {
    ...
    if (applicationInfo != null
        ...
        && bundle.getBoolean("com.samsung.android.hasZippedOverlays")) {
      return true;
    }
    Slog.d(
        "PackageManager",
        "isLocaleOptimizedPackage() -  Non optimized app: "
            + str
