...
public class PackageManagerService implements PackageSender, TestUtilityService {
    ...
    public PackageManagerService(final PackageManagerServiceInjector packageManagerServiceInjector, boolean z, String str, boolean z2, boolean z3, int i, String str2) {
        ...
        synchronized (this.mInstallLock) {
            synchronized (this.mLock) {
                ...
                this.mShouldStopSystemPackagesByDefault = this.mContext.getResources().getBoolean(R.bool.config_send_satellite_datagram_to_modem_in_demo_mode);
                ...
                this.mDefaultTextClassifierPackage = ensureSystemPackageName(computerLocked, this.mContext.getString(R.string.ext_media_move_success_title));
                this.mSystemTextClassifierPackageName = ensureSystemPackageName(computerLocked, this.mContext.getString(R.string.decline_remote_bugreport_action));
                this.mConfiguratorPackage = ensureSystemPackageName(computerLocked, this.mContext.getString(R.string.default_browser));
                this.mAppPredictionServicePackage = ensureSystemPackageName(computerLocked, getPackageFromComponentString(R.string.data_usage_limit_body));
                this.mIncidentReportApproverPackage = ensureSystemPackageName(computerLocked, this.mContext.getString(R.string.dump_heap_text));
                ...
                this.mRecentsPackage = ensureSystemPackageName(computerLocked, getPackageFromComponentString(R.string.etws_primary_default_message_test));
                this.mAmbientContextDetectionPackage = ensureSystemPackageName(computerLocked, getPackageFromComponentString(R.string.data_saver_enable_title));
                this.mWearableSensingPackage = ensureSystemPackageName(computerLocked, getPackageFromComponentString(R.string.default_audio_route_name_external_device));
    ...
    public final String getRequiredServicesExtensionPackageLPr(Computer computer) {
        String ensureSystemPackageName = ensureSystemPackageName(computer, this.mContext.getString(R.string.ext_media_move_success_title));
    ...
    public ComponentName getInstantAppResolver(Computer computer) {
        String[] stringArray = this.mContext.getResources().getStringArray(R.array.face_acquired_vendor);
    ...
    */
    ...
    public void systemReady() {
        ...
        if (CoreRune.SYSFW_APP_SPEG) {
            this.mSpeg = (SpegService) LocalServices.getService(SpegService.class);
            ContentObserver contentObserver2 = new ContentObserver(this.mHandler) { // from class: com.android.server.pm.PackageManagerService.5
                @Override // android.database.ContentObserver
                public void onChange(boolean z) {
                    AppPrelaunchManagerService appPrelaunchManagerService;
                    boolean z2 = Settings.Global.getInt(contentResolver, "device_provisioned", 0) == 1 || Settings.Secure.getInt(contentResolver, "user_setup_complete", 0) == 1;
            ...
            this.mContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor("device_provisioned"), false, contentObserver2, -1);
            this.mContext.getContentResolver().registerContentObserver(Settings.Secure.getUriFor("user_setup_complete"), false, contentObserver2, -1);
    ...
    public final void disableSkuSpecificApps() {
        String[] stringArray = this.mContext.getResources().getStringArray(R.array.config_telephonyHardware);
        String[] stringArray2 = this.mContext.getResources().getStringArray(R.array.config_telephonyEuiccDeviceCapabilities);
    ...
    public class IPackageManagerImpl extends IPackageManagerBase {
        ...
        */
        public void setApplicationEnabledSetting(String str, int i, int i2, int i3, String str2) {
            ...
            boolean z2 = false;
            if (!"auto_disabler".equals(str2) && !"com.sec.android.emergencymode.service".equals(str2) && (packageStateInternal = PackageManagerService.this.snapshotComputer().getPackageStateInternal(str)) != null) {
                PackageUserStateInternal userStateOrDefault = packageStateInternal.getUserStateOrDefault(i3);
                if (userStateOrDefault.getEnabledState() == 4 && "auto_disabler".equals(userStateOrDefault.getLastDisableAppCaller())) {
                    ...
                    PackageStateInternal packageStateInternal2 = PackageManagerService.this.snapshotComputer().getPackageStateInternal(str);
                    if (packageStateInternal2 == null || packageStateInternal2.getUserStateOrDefault(i3).getEnabledState() != i) {
                        return;
                    }
                    PackageManagerService.this.mAutoDisableHandler.sendAutoDisabledAppStateChanged(str, i3, z2);
                    return;
                }
            }
            z = false;
