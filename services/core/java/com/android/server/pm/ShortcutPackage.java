...
public class ShortcutPackage extends ShortcutPackageItem {
        ...
        if (findShortcutById == null || !findShortcutById.isDynamic()) {
            ...
            if (arrayList != null && arrayList.size() == maxActivityShortcuts) {
                ...
                if (deleteDynamicWithId(shortcutInfo2.getId(), true, true) != null) {
                    ...
                    if (isAppSearchEnabled()) {
                        runAsSystem(new Runnable() { // from class: com.android.server.pm.ShortcutPackage$$ExternalSyntheticLambda10
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static ShortcutInfo parseShortcut(TypedXmlPullParser typedXmlPullParser, String str, int i, boolean z) {
        int i2;
        String str2;
        int i3;
        int i4;
        ...
        String parseStringAttribute2 = ShortcutService.parseStringAttribute(typedXmlPullParser, KnoxCustomManagerService.SHORTCUT_TITLE);
        ...
        Intent parseIntentAttributeNoDefault = ShortcutService.parseIntentAttributeNoDefault(typedXmlPullParser, KnoxCustomManagerService.INTENT);
    ...
    public /* synthetic */ void lambda$getShortcutByIdsAsync$43(Set set, Consumer consumer, AppSearchSession appSearchSession) {
        appSearchSession.getByDocumentId(new GetByDocumentIdRequest.Builder(getPackageName()).addIds(set).build(), this.mShortcutUser.mExecutor, new C21901(consumer));
    }
        ...
        public void onResult(AppSearchBatchResult appSearchBatchResult) {
            this.val$cb.accept((List) appSearchBatchResult.getSuccesses().values().stream().map(new Function() { // from class: com.android.server.pm.ShortcutPackage$1$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    ...
                    lambda$onResult$0 = ShortcutPackage.C21901.this.lambda$onResult$0((GenericDocument) obj);
