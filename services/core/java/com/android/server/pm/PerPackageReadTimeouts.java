...
public class PerPackageReadTimeouts {
  ...
  public class Timeouts {
    ...
    public static Timeouts parse(String str) {
      ...
      return (0 > tryParseLong || tryParseLong > tryParseLong2 || tryParseLong2 > tryParseLong3)
          ? timeouts
          : new Timeouts(tryParseLong, tryParseLong2, tryParseLong3);
    }
  }
  ...
  public class VersionCodes {
    ...
    public static VersionCodes parse(String str) {
      ...
      if (length == 2) {
        ...
        long tryParseLong2 =
            PerPackageReadTimeouts.tryParseLong(split[1], versionCodes.maxVersionCode);
  ...
  public static PerPackageReadTimeouts parse(
      String str, VersionCodes versionCodes, Timeouts timeouts) {
    byte[] bArr;
