    ...
    synchronized (this.mLock) {
      ...
      for (int i = 0; i < this.mUidMap.size(); i++) {
        ...
        for (int i2 = 0; i2 < arrayMap.size(); i2++) {
          arrayMap2.put(
              (String) arrayMap.keyAt(i2), new ArrayList((Collection) arrayMap.valueAt(i2)));
        }
          ...
          (ArrayList)
              arrayMap.computeIfAbsent(
                  ...
                  new Function() { // from class:
                    // com.android.server.pm.PendingPackageBroadcasts$$ExternalSyntheticLambda0
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                      ArrayList lambda$getOrAllocate$0;
                      lambda$getOrAllocate$0 =
                          PendingPackageBroadcasts.lambda$getOrAllocate$0((String) obj);
