...
public final class PackageRemovedInfo {
  ...
  public final void sendSystemPackageUpdatedBroadcastsInternal() {
    ...
    this.mPackageSender.sendPackageBroadcast(
        "android.intent.action.PACKAGE_ADDED",
        this.mRemovedPackage,
        bundle,
        0,
        null,
        null,
    ...
    this.mPackageSender.sendPackageBroadcast(
        ...
        null,
        null,
        getTemporaryAppAllowlistBroadcastOptions(311).toBundle());
  }
  ...
  public final void sendPackageRemovedBroadcastInternal(boolean z, boolean z2) {
    ...
    bundle.putBoolean(
        "android.intent.extra.SYSTEM_UPDATE_UNINSTALL", this.mIsRemovedPackageSystemUpdate);
    ...
    if (str2 != null && (str = this.mInstallerPackageName) != null) {
      this.mPackageSender.sendPackageBroadcast(
          ...
          str,
          null,
          this.mBroadcastUsers,
          this.mInstantUserIds,
          null,
          null);
    }
