...
public final class SharedUserSetting extends SettingBase implements SharedUserApi {
  ...
  public SharedUserSetting(String str, int i, int i2) {
    ...
    this.mPackagesSnapshot =
        new SnapshotCache.Auto(watchedArraySet, watchedArraySet, "SharedUserSetting.packages");
    ...
    this.mDisabledPackagesSnapshot =
        new SnapshotCache.Auto(
            watchedArraySet2, watchedArraySet2, "SharedUserSetting.mDisabledPackages");
  ...
  public void fixSeInfoLocked() {
    ...
    for (int i = 0; i < this.mPackages.size(); i++) {
      ...
      if (packageSetting != null
          ...
          && packageSetting.getPkg().getTargetSdkVersion() < this.seInfoTargetSdkVersion) {
        this.seInfoTargetSdkVersion = packageSetting.getPkg().getTargetSdkVersion();
        onChanged();
      }
    }
