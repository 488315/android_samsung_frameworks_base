...
public final class SuspendPackageHelper {
  ...
  public String[] setPackagesSuspended(
    ...
    final SuspendParams suspendParams2 =
        new SuspendParams(suspendDialogInfo, persistableBundle, persistableBundle2);
    ...
    boolean[] canSuspendPackageForUser =
        (!z || z2) ? null : canSuspendPackageForUser(computer2, strArr2, i, i4);
    int i5 = 0;
    while (i5 < strArr2.length) {
      ...
      if (str.equals(str2)) {
        ...
        if (packageStateInternal == null
            ...
            || computer2.shouldFilterApplication(packageStateInternal, i4, i)) {
          ...
          WatchedArrayMap suspendParams3 =
              packageStateInternal.getUserStateOrDefault(i).getSuspendParams();
          zArr = canSuspendPackageForUser;
          boolean z3 =
              !Objects.equals(
                  suspendParams3 == null ? null : (SuspendParams) suspendParams3.get(str2),
                  suspendParams2);
          if (z && !z3) {
            arrayList2.add(str2);
            ...
            suspendParams = suspendParams2;
            boolean z4 =
                !z && CollectionUtils.size(suspendParams3) == 1 && suspendParams3.containsKey(str);
            if (z || z4) {
              arrayList2.add(str2);
              intArray3.add(UserHandle.getUid(i, packageStateInternal.getAppId()));
            }
    ...
    this.mPm.commitPackageStateMutation(
        null,
        new Consumer() { // from class:
          // com.android.server.pm.SuspendPackageHelper$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            SuspendPackageHelper.lambda$setPackagesSuspended$0(
                arraySet, i, z, str, suspendParams2, (PackageStateMutator) obj);
          }
        });
  ...
  public static /* synthetic */ void lambda$setPackagesSuspended$0(
      ArraySet arraySet,
      int i,
      boolean z,
      String str,
    ...
    for (int i2 = 0; i2 < size; i2++) {
      PackageUserStateWrite userState =
          packageStateMutator.forPackage((String) arraySet.valueAt(i2)).userState(i);
      if (z) {
  ...
  public String[] getUnsuspendablePackagesForUser(
  ...
  public Bundle getSuspendedPackageAppExtras(Computer computer, String str, int i, int i2) {
    ...
    if (userStateOrDefault.isSuspended()) {
      for (int i3 = 0; i3 < userStateOrDefault.getSuspendParams().size(); i3++) {
        SuspendParams suspendParams =
            (SuspendParams) userStateOrDefault.getSuspendParams().valueAt(i3);
  ...
  public void removeSuspensionsBySuspendingPackage(
    ...
    while (true) {
      ...
      PackageUserStateInternal userStateOrDefault =
          packageStateInternal != null ? packageStateInternal.getUserStateOrDefault(i) : null;
    ...
    this.mPm.commitPackageStateMutation(
        ...
        new Consumer() { // from class:
          ...
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            SuspendPackageHelper.lambda$removeSuspensionsBySuspendingPackage$1(
                arrayMap, i, (PackageStateMutator) obj);
          }
        });
    this.mPm.scheduleWritePackageRestrictions(i);
    ...
    sendPackagesSuspendedForUser(
        "android.intent.action.PACKAGES_UNSUSPENDED", strArr3, intArray.toArray(), i);
  }

  public static /* synthetic */ void lambda$removeSuspensionsBySuspendingPackage$1(
      ArrayMap arrayMap, int i, PackageStateMutator packageStateMutator) {
  ...
  public boolean isPackageSuspended(Computer computer, String str, int i, int i2) {
    ...
    return packageStateInternal != null
        && packageStateInternal.getUserStateOrDefault(i).isSuspended();
  }
  ...
  public SuspendDialogInfo getSuspendedDialogInfo(
      Computer computer, String str, String str2, int i, int i2) {
    ...
    PackageUserStateInternal userStateOrDefault = packageStateInternal.getUserStateOrDefault(i);
    if (!userStateOrDefault.isSuspended()
        || (suspendParams = userStateOrDefault.getSuspendParams()) == null
        || (suspendParams2 = (SuspendParams) suspendParams.get(str2)) == null) {
      return null;
    }
  ...
  public boolean isSuspendAllowedForUser(Computer computer, int i, int i2) {
    ...
    return isCallerDeviceOrProfileOwner(computer, i, i2)
  ...
  public boolean[] canSuspendPackageForUser(Computer computer, String[] strArr, int i, int i2) {
    ...
    boolean isCallerDeviceOrProfileOwner =
        suspendPackageHelper.isCallerDeviceOrProfileOwner(computer, i, i2);
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      DefaultAppProvider defaultAppProvider =
          suspendPackageHelper.mInjector.getDefaultAppProvider();
      ...
      AppOpsManager appOpsManager =
          (AppOpsManager) suspendPackageHelper.mInjector.getSystemService(AppOpsManager.class);
      j = clearCallingIdentity;
      try {
        boolean z =
            DeviceConfig.getBoolean(
                "package_manager_service", "system_exempt_from_suspension", true);
        int i3 = 0;
        while (i3 < strArr2.length) {
          ...
          if (suspendPackageHelper.mPm.isPackageDeviceAdmin(str, i)) {
            Slog.w(
                "PackageManager",
                "Cannot suspend package \"" + str + "\": has an active device admin");
          } else if (str.equals(defaultHome)) {
            Slog.w(
                "PackageManager",
                "Cannot suspend package \"" + str + "\": contains the active launcher");
          } else if (str.equals(knownPackageName)) {
            Slog.w(
                "PackageManager",
                "Cannot suspend package \"" + str + "\": required for package installation");
          } else if (str.equals(knownPackageName2)) {
            Slog.w(
                "PackageManager",
                "Cannot suspend package \"" + str + "\": required for package uninstallation");
          } else if (str.equals(knownPackageName3)) {
            Slog.w(
                "PackageManager",
                "Cannot suspend package \"" + str + "\": required for package verification");
          } else if (str.equals(defaultDialer)) {
            Slog.w(
                "PackageManager", "Cannot suspend package \"" + str + "\": is the default dialer");
          } else if (str.equals(knownPackageName4)) {
            Slog.w(
                "PackageManager",
                "Cannot suspend package \"" + str + "\": required for permissions management");
            ...
            PmLog.logDebugInfoAndLogcat(
                "Cannot suspend package \"" + str + "\": required system package");
          } else {
            PackageStateInternal packageStateInternal = computer.getPackageStateInternal(str);
  ...
  public void sendPackagesSuspendedForUser(
      final String str, String[] strArr, int[] iArr, final int i) {
    ...
    handler.post(
        new Runnable() { // from class:
          // com.android.server.pm.SuspendPackageHelper$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
            SuspendPackageHelper.this.lambda$sendPackagesSuspendedForUser$3(
                str, bundle, i, bundle2);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$sendPackagesSuspendedForUser$3(
      String str, Bundle bundle, int i, Bundle bundle2) {
    this.mBroadcastHelper.sendPackageBroadcast(
        ...
        new BiFunction() { // from class:
          // com.android.server.pm.SuspendPackageHelper$$ExternalSyntheticLambda3
          @Override // java.util.function.BiFunction
          public final Object apply(Object obj, Object obj2) {
            Bundle lambda$sendPackagesSuspendedForUser$2;
            lambda$sendPackagesSuspendedForUser$2 =
                SuspendPackageHelper.this.lambda$sendPackagesSuspendedForUser$2(
                    (Integer) obj, (Bundle) obj2);
  ...
  public /* synthetic */ Bundle lambda$sendPackagesSuspendedForUser$2(Integer num, Bundle bundle) {
    return BroadcastHelper.filterExtrasChangedPackageList(
        this.mPm.snapshotComputer(), num.intValue(), bundle);
  }
  ...
  */
  public String[] setPackagesSuspendedByAdmin(
      Computer computer, int i, String[] strArr, boolean z) {
    ...
    if (this.mUserManager.isQuietModeEnabled(i)) {
      ...
      if (!packagesToSuspendInQuietMode.isEmpty()) {
        Slog.i(
            "PackageManager",
            "Ignoring quiet packages: " + String.join(", ", packagesToSuspendInQuietMode));
        ...
        return (String[])
            list.toArray(
                new IntFunction() { // from class:
                  // com.android.server.pm.SuspendPackageHelper$$ExternalSyntheticLambda5
                  @Override // java.util.function.IntFunction
                  public final Object apply(int i2) {
                    String[] lambda$setPackagesSuspendedByAdmin$4;
                    lambda$setPackagesSuspendedByAdmin$4 =
                        SuspendPackageHelper.lambda$setPackagesSuspendedByAdmin$4(i2);
  ...
  public final List getUnsuspendablePackages(Computer computer, int i, Set set) {
    String[] strArr =
        (String[])
            set.toArray(
                new IntFunction() { // from class:
                  // com.android.server.pm.SuspendPackageHelper$$ExternalSyntheticLambda6
                  @Override // java.util.function.IntFunction
                  public final Object apply(int i2) {
                    String[] lambda$getUnsuspendablePackages$5;
                    lambda$getUnsuspendablePackages$5 =
                        SuspendPackageHelper.lambda$getUnsuspendablePackages$5(i2);
  ...
  public void setPackagesSuspendedForQuietMode(Computer computer, int i, boolean z) {
    ...
    if (!z) {
      ...
      if (devicePolicyManagerInternal != null) {
        packagesToSuspendInQuietMode.removeAll(
            devicePolicyManagerInternal.getPackagesSuspendedByAdmin(i));
      } else {
        Slog.wtf(
            "PackageManager",
    ...
    setPackagesSuspended(
        computer,
        (String[]) packagesToSuspendInQuietMode.toArray(new String[0]),
        z,
        null,
        null,
        null,
  ...
  public final boolean isCallerDeviceOrProfileOwner(Computer computer, int i, int i2) {
    ...
    String deviceOwnerOrProfileOwnerPackage =
        this.mProtectedPackages.getDeviceOwnerOrProfileOwnerPackage(i);
    return deviceOwnerOrProfileOwnerPackage != null
        && i2 == computer.getPackageUidInternal(deviceOwnerOrProfileOwnerPackage, 0L, i, i2);
  }

  public final void sendMyPackageSuspendedOrUnsuspended(
      final String[] strArr, final boolean z, final int i) {
    Handler handler = this.mInjector.getHandler();
    final String str =
        z
    ...
    handler.post(
        new Runnable() { // from class:
          // com.android.server.pm.SuspendPackageHelper$$ExternalSyntheticLambda4
          @Override // java.lang.Runnable
          public final void run() {
            SuspendPackageHelper.this.lambda$sendMyPackageSuspendedOrUnsuspended$6(
                z, i, strArr, str);
          }
        });
  }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$sendMyPackageSuspendedOrUnsuspended$6(
      boolean z, int i, String[] strArr, String str) {
