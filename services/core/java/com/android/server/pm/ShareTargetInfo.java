...
public class ShareTargetInfo {
  ...
  public void saveToXml(TypedXmlSerializer typedXmlSerializer) {
    ...
    for (int i = 0; i < this.mTargetData.length; i++) {
      ...
      ShortcutService.writeAttr(
          typedXmlSerializer, "pathPattern", this.mTargetData[i].mPathPattern);
  ...
  public static ShareTargetInfo loadFromXml(TypedXmlPullParser typedXmlPullParser) {
    String parseStringAttribute =
        ShortcutService.parseStringAttribute(typedXmlPullParser, "targetClass");
  ...
  public static TargetData parseTargetData(TypedXmlPullParser typedXmlPullParser) {
    return new TargetData(
        ShortcutService.parseStringAttribute(typedXmlPullParser, "scheme"),
        ShortcutService.parseStringAttribute(typedXmlPullParser, "host"),
        ShortcutService.parseStringAttribute(typedXmlPullParser, "port"),
        ShortcutService.parseStringAttribute(typedXmlPullParser, "path"),
        ShortcutService.parseStringAttribute(typedXmlPullParser, "pathPattern"),
        ShortcutService.parseStringAttribute(typedXmlPullParser, "pathPrefix"),
        ShortcutService.parseStringAttribute(typedXmlPullParser, "mimeType"));
  }
}
