...
public final class PackageManagerNative extends IPackageManagerNative.Stub {
  ...
  public boolean isPackageDebuggable(String str) {
    ApplicationInfo applicationInfo =
        this.mPm.snapshotComputer().getApplicationInfo(str, 0L, UserHandle.getCallingUserId());
  ...
  public void unregisterStagedApexObserver(IStagedApexObserver iStagedApexObserver) {
    this.mPm
        .mInstallerService
        .getStagingManager()
        .unregisterStagedApexObserver(iStagedApexObserver);
  }
