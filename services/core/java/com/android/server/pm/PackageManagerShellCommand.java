...
import com.samsung.android.server.p025pm.cmd.ShellRestrictionsHelper;
        ...
        while (true) {
            try {
                ...
                if (nextArg != null) {
                    ...
                    Collections.sort(list, new Comparator() { // from class: com.android.server.pm.PackageManagerShellCommand.2
                        @Override // java.util.Comparator
        ...
        while (true) {
            try {
                ...
                if (nextOption != null) {
                    ...
                    String nextArg = getNextArg();
                    if (CoreRune.BAIDU_CARLIFE && BaiduCarlifeADBConnectUtils.isCarlifeForceConnect() && (BaiduCarlifeADBConnectUtils.isBaiduCarlifePkg(nextArg) || "carlife".equals(nextArg) || nextArg == null)) {
                        BaiduCarlifeADBConnectUtils.printCarlifePkgName(outPrintWriter);
                        return 0;
                    }
                    int[] userIds = i4 == -1 ? ((UserManagerInternal) LocalServices.getService(UserManagerInternal.class)).getUserIds() : new int[]{i4};
                    if (z2) {
                        i3 |= 67108864;
                    }
    ...
    public final int runCompile() {
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                PackageManagerServiceUtils.logCriticalInfo(4, "finish runCompile by cmdline (failed cnt): " + arrayList.size() + "/" + singletonList.size());
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                try {
                    ...
                    String hasRestrictedPackage = this.shellRestrictionsHelper.hasRestrictedPackage(remainingArgs);
