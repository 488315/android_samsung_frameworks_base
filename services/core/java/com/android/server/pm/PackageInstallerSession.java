...
public class PackageInstallerSession extends IPackageInstallerSession.Stub {
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final PackageLite validateApkInstallLocked() {
        int i;
        File parentFile;
        File file;
        boolean z;
        ...
        List removedFilesLocked = getRemovedFilesLocked();
        ArrayList<String> arrayList = new ArrayList();
        if (!removedFilesLocked.isEmpty()) {
            Iterator it2 = removedFilesLocked.iterator();
            while (it2.hasNext()) {
                arrayList.add(((File) it2.next()).getName().substring(0, r9.length() - 8));
            }
        }
        List addedApksLocked = getAddedApksLocked();
        if (addedApksLocked.isEmpty() && (arrayList.size() == 0 || getStagedAppMetadataFile() != null)) {
            ...
            objArr[1] = PMRune.PM_INSTALL_TO_SDCARD ? this.mResolvedStageDir.getAbsolutePath() : this.stageDir.getAbsolutePath();
            throw new PackageManagerException(-2, TextUtils.formatSimple("Session: %d. No packages staged in %s", objArr));
        }
        ...
        for (Iterator it3 = addedApksLocked.iterator(); it3.hasNext(); it3 = it) {
            File file4 = (File) it3.next();
            ParseResult parseApkLite = ApkLiteParseUtils.parseApkLite(forDefaultParsing.reset(), file4, 32);
            if (parseApkLite.isError()) {
                throw new PackageManagerException(parseApkLite.getErrorCode(), parseApkLite.getErrorMessage(), parseApkLite.getException());
            }
            ...
            assertApkConsistentLocked(String.valueOf(file4), apkLite2);
            ...
            File file5 = new File(PMRune.PM_INSTALL_TO_SDCARD ? this.mResolvedStageDir : this.stageDir, splitNameToFileName);
            resolveAndStageFileLocked(file4, file5, apkLite2.getSplitName());
        ...
        if (isIncrementalInstallation()) {
            ...
            if (tmpAppMetadataFile.exists()) {
                try {
                    try {
                        getIncrementalFileStorages().makeFile("app.metadata", Files.readAllBytes(tmpAppMetadataFile.toPath()), FrameworkStatsLog.DISPLAY_HBM_STATE_CHANGED);
                    } catch (IOException e2) {
                        Slog.e("PackageInstallerSession", "Failed to write app metadata to incremental storage", e2);
                    }
                } finally {
        ...
        if (this.params.mode == 1) {
            ...
            ParseResult composePackageLiteFromApks = ApkLiteParseUtils.composePackageLiteFromApks(forDefaultParsing.reset(), PMRune.PM_INSTALL_TO_SDCARD ? this.mResolvedStageDir : this.stageDir, apkLite, arrayMap, true);
                            ...
                            while (i5 < length2) {
                                ...
                                if (file10.isDirectory()) {
                                    ...
                                    try {
                                        ...
                                        file2 = parentFile;
                                        Slog.e("PackageInstallerSession", "Skipping linking of native library directory!", e3);
                                        arrayList2.clear();
                                        arrayList3.clear();
                                    }
                                } else {
    ...
    public final void maybeStageDigestsLocked(File file, File file2, String str) {
        ...
        try {
            ...
            throw new PackageManagerException(-4, "Failed to store digests for " + this.mPackageName, e3);
        }
    }
    ...
    */
    ...
    public static String getDeviceOwnerInstalledPackageMsg(final Context context, boolean z) {
        ...
        if (z) {
            return devicePolicyManager.getResources().getString("Core.PACKAGE_UPDATED_BY_DO", new Supplier() { // from class: com.android.server.pm.PackageInstallerSession$$ExternalSyntheticLambda7
                ...
                public final Object get() {
                    String lambda$getDeviceOwnerInstalledPackageMsg$9;
                    lambda$getDeviceOwnerInstalledPackageMsg$9 = PackageInstallerSession.lambda$getDeviceOwnerInstalledPackageMsg$9(context);
                    return lambda$getDeviceOwnerInstalledPackageMsg$9;
                }
            });
        }
        return devicePolicyManager.getResources().getString("Core.PACKAGE_INSTALLED_BY_DO", new Supplier() { // from class: com.android.server.pm.PackageInstallerSession$$ExternalSyntheticLambda8
            @Override // java.util.function.Supplier
            public final Object get() {
                String lambda$getDeviceOwnerInstalledPackageMsg$10;
                lambda$getDeviceOwnerInstalledPackageMsg$10 = PackageInstallerSession.lambda$getDeviceOwnerInstalledPackageMsg$10(context);
                return lambda$getDeviceOwnerInstalledPackageMsg$10;
            }
        });
    }

    public static /* synthetic */ String lambda$getDeviceOwnerInstalledPackageMsg$9(Context context) {
        return context.getString(R.string.roamingText6);
    }

    public static /* synthetic */ String lambda$getDeviceOwnerInstalledPackageMsg$10(Context context) {
        return context.getString(R.string.roamingText12);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void write(TypedXmlSerializer typedXmlSerializer, File file) {
        ?? r1;
        ...
        synchronized (this.mLock) {
            if (!this.mDestroyed || this.params.isStaged) {
                ...
                typedXmlSerializer.attributeInt((String) null, "sessionFlags", this.params.sessionFlags);
                ...
                size = this.mChecksums.size();
                for (i = 0; i < size; i++) {
                    String str2 = (String) this.mChecksums.keyAt(i);
                    for (Checksum checksum : ((PerFileChecksum) this.mChecksums.valueAt(i)).getChecksums()) {
                        typedXmlSerializer.startTag((String) null, "sessionChecksum");
                        com.android.internal.util.XmlUtils.writeStringAttribute(typedXmlSerializer, "name", str2);
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    String str3 = (String) this.mChecksums.keyAt(i3);
                    byte[] signature = ((PerFileChecksum) this.mChecksums.valueAt(i3)).getSignature();
                    if (signature != null && signature.length != 0) {
                        typedXmlSerializer.startTag((String) null, "sessionChecksumSignature");
                        com.android.internal.util.XmlUtils.writeStringAttribute(typedXmlSerializer, "name", str3);
