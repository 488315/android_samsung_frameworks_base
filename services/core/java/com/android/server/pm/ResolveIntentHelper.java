...
public final class ResolveIntentHelper {
    ...
    */
    public List queryIntentReceiversInternal(Computer computer, Intent intent, String str, long j, int i, int i2, boolean z) {
        Intent intent2;
        Intent intent3;
        List queryReceivers;
        ...
        boolean z2 = false;
        int i3 = ("com.sec.android.app.dictionary.SEARCH".equals(intent.getAction()) && SemDualAppManager.isDualAppId(i)) ? 0 : i;
        int i4 = z ? 1000 : i2;
        int i5 = i3;
        ...
        long updateFlagsForResolve = computer.updateFlagsForResolve(j, i3, i4, false, computer.isImplicitImageCaptureIntentAndNotSetByDpc(intent, i5, str, j));
        ...
        if (component != null) {
            ...
            if (str2 == null && (queryReceivers2 = componentResolver.queryReceivers(computer, intent2, str, updateFlagsForResolve, i3)) != null) {
                emptyList = queryReceivers2;
            }
            AndroidPackage androidPackage = computer.getPackage(str2);
            if (androidPackage != null) {
                queryReceivers = componentResolver.queryReceivers(computer, intent2, str, updateFlagsForResolve, androidPackage.getReceivers(), i3);
            }
        }
        queryReceivers = emptyList;
        if (intent3 != null) {
            PackageManagerServiceUtils.applyEnforceIntentFilterMatching(this.mPlatformCompat, componentResolver, queryReceivers, true, intent3, str, i2);
        }
        return computer.applyPostResolutionFilter(queryReceivers, instantAppPackageName, false, i4, false, i3, intent2);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public List queryIntentActivityOptionsInternal(Computer computer, ComponentName componentName, Intent[] intentArr, String[] strArr, Intent intent, String str, long j, int i) {
        List list;
        String str2;
        int i2;
        ...
        List queryIntentActivitiesInternal = computer.queryIntentActivitiesInternal(intent, str, updateFlagsForResolve | 64, i);
        String str6 = null;
        if (intentArr2 != null) {
            int i7 = 0;
            i2 = 0;
            while (i7 < intentArr2.length) {
                ...
                if (intent2 == null) {
                    ...
                    if (component == null) {
                        ...
                        list2 = queryIntentActivitiesInternal;
                        str4 = action;
                        resolveInfo = resolveIntentInternal(computer, intent2, strArr != null ? strArr[i7] : str6, updateFlagsForResolve, 0L, i, false, Binder.getCallingUid());
                        if (resolveInfo != null) {
