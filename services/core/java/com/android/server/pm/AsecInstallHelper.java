...
public class AsecInstallHelper {
    ...
    public final void unloadMediaPackages(ArrayMap arrayMap, int[] iArr, boolean z) {
        ...
        if (arrayList.size() > 0) {
            ...
            PackageManagerService packageManagerService = this.mPm;
            Objects.requireNonNull(packageManagerService);
            broadcastHelper.sendResourcesChangedBroadcast(new AsecInstallHelper$$ExternalSyntheticLambda0(packageManagerService), false, false, (String[]) arrayList.toArray(new String[arrayList.size()]), iArr, new C20813(z, keySet));
