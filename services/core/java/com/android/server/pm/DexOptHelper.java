...
public final class DexOptHelper {
  public static final boolean LOW_DEBUG =
  ...
  public static /* synthetic */ boolean lambda$getPackagesForDexopt$8(
      PackageStateInternal packageStateInternal) {
    return true;
  }

  public static /* synthetic */ boolean lambda$getPackagesForDexopt$9(
      PackageStateInternal packageStateInternal) {
    return true;
  }
  ...
  */
  public int[] performDexOptUpgrade(List list, int i, boolean z) {
    boolean z2;
    ...
    while (it.hasNext()) {
      ...
      if ((this.mPm.isFirstBoot() || this.mPm.isDeviceUpgrading())
        ...
        if (file.exists()) {
          try {
            if (!this.mPm.mInstaller.copySystemProfile(
                file.getAbsolutePath(),
                androidPackage.getUid(),
                androidPackage.getPackageName(),
                ArtManager.getProfileName((String) null))) {
          ...
          PackageSetting disabledSystemPkgLPr =
              this.mPm.mSettings.getDisabledSystemPkgLPr(androidPackage.getPackageName());
          if (disabledSystemPkgLPr != null && disabledSystemPkgLPr.getPkg().isStub()) {
            File file2 =
                new File(
                    getPrebuildProfilePath(disabledSystemPkgLPr.getPkg()).replace("-Stub", ""));
            if (file2.exists()) {
              try {
              } catch (Installer.InstallerException | RuntimeException e2) {
                Log.e(
                    "PackageManager",
                    "Failed to copy profile " + file2.getAbsolutePath() + " ",
                    e2);
              }
              if (!this.mPm.mInstaller.copySystemProfile(
                ...
                if (this.mPm.mPackageDexOptimizer.canOptimizePackage(androidPackage)) {
                  ...
                  if (SystemProperties.getBoolean("pm.precompile_layouts", false)) {
                    this.mPm.mArtManagerService.compileLayouts(
                        packageStateInternal, androidPackage);
                  }
                  int i6 = z ? 4 : 0;
                  String compilerFilterForReason =
                      PackageManagerServiceCompilerMapping.getCompilerFilterForReason(i5);
                  ...
                  int performDexOptTraced =
                      performDexOptTraced(
                          new DexoptOptions(
                              androidPackage.getPackageName(),
                              i5,
                              compilerFilterForReason,
                              null,
                              i6));
                  if (performDexOptTraced == -1) {
                    ...
                    if (performDexOptTraced == 1) {
                      ...
                      Log.e(
                          "PackageManager", "Unexpected dexopt return code " + performDexOptTraced);
                    }
                  }
                }
                i3++;
  ...
  */
    ...
    */
    throw new UnsupportedOperationException(
        "Method not decompiled:"
            + " com.android.server.pm.DexOptHelper.checkAndDexOptSystemUi(int):void");
  }

  public final void dexoptLauncher(int i) {
    Computer snapshotComputer = this.mPm.snapshotComputer();
    for (String str :
        ((RoleManager) this.mPm.mContext.getSystemService(RoleManager.class))
  ...
  public final void performDexoptPackage(String str, int i, String str2) {
    Installer.checkLegacyDexoptDisabled();
    performDexOptTraced(
        new DexoptOptions(str, i, str2, null, DexFile.isProfileGuidedCompilerFilter(str2) ? 1 : 0));
  }
  ...
  public void performPackageDexOptUpgradeIfNeeded() {
    ...
    Log.i(
        "PackageManager",
        "Starting boot dexopt for reason " + DexoptOptions.convertToArtServiceDexoptReason(i));
    long nanoTime = System.nanoTime();
    if (useArtService()) {
      this.mBootDexoptStartTime = nanoTime;
      getArtManagerLocal()
          .onBoot(
              DexoptOptions.convertToArtServiceDexoptReason(i),
              Executors.newSingleThreadExecutor(),
              new Consumer() { // from class:
                // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda11
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  DexOptHelper.this.lambda$performPackageDexOptUpgradeIfNeeded$0(
                      (OperationProgress) obj);
                }
              });
      if (i == 1) {
        PackageManagerServiceUtils.logCriticalInfo(
            4, "DEXOPT to compile designatedPkgs for boot-after-ota");
          ...
          try {
            getArtManagerLocal()
                .dexoptPackage(
                    ...
                    str,
                    new DexoptParams.Builder("boot-after-ota")
      ...
      try {
        ...
        int[] performDexOptUpgrade =
            performDexOptUpgrade(
                getPackagesForDexopt(
                    this.mPm.snapshotComputer().getPackageStates().values(), this.mPm),
                i,
                false);
        reportBootDexopt(
            nanoTime, performDexOptUpgrade[0], performDexOptUpgrade[1], performDexOptUpgrade[2]);
  ...
  public /* synthetic */ void lambda$performPackageDexOptUpgradeIfNeeded$0(
      OperationProgress operationProgress) {
    ((WindowManagerInternal) this.mPm.mInjector.getLocalService(WindowManagerInternal.class))
        .showBootDialog(operationProgress.getPercentage());
  }
  ...
  public final void reportBootDexopt(long j, int i, int i2, int i3) {
    ...
    MetricsLogger.histogram(
        this.mPm.mContext, "opt_dialog_num_total", getOptimizablePackages(snapshotComputer).size());
  ...
  public List getOptimizablePackages(Computer computer) {
    ...
    this.mPm.forEachPackageState(
        computer,
        new Consumer() { // from class: com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda0
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DexOptHelper.this.lambda$getOptimizablePackages$1(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$getOptimizablePackages$1(
  ...
  public boolean performDexOpt(DexoptOptions dexoptOptions) {
    ...
    if (snapshotComputer.getInstantAppPackageName(Binder.getCallingUid()) != null
        || snapshotComputer.isInstantApp(
            dexoptOptions.getPackageName(), UserHandle.getCallingUserId())) {
      return false;
    }
  ...
  public final int performDexOptInternal(DexoptOptions dexoptOptions) {
    ...
    synchronized (this.mPm.mLock) {
      AndroidPackage androidPackage =
          (AndroidPackage) this.mPm.mPackages.get(dexoptOptions.getPackageName());
        ...
        try {
          try {
            return performDexOptInternalWithDependenciesLI(
                androidPackage, packageLPr, dexoptOptions);
          } catch (Installer.LegacyDexoptDisabledException e) {
            throw new RuntimeException(e);
          }
        } finally {
  ...
  public final int performDexOptWithArtService(DexoptOptions dexoptOptions, int i) {
    ...
    try {
      PackageState packageState =
          withFilteredSnapshot.getPackageState(dexoptOptions.getPackageName());
      if (packageState != null) {
        if (packageState.getAndroidPackage() != null) {
          int convertToDexOptResult =
              convertToDexOptResult(
                  getArtManagerLocal()
                      .dexoptPackage(
                          withFilteredSnapshot,
                          dexoptOptions.getPackageName(),
                          dexoptOptions.convertToDexoptParams(i)));
          withFilteredSnapshot.close();
  ...
  public final int performDexOptInternalWithDependenciesLI(
      AndroidPackage androidPackage,
      PackageStateInternal packageStateInternal,
    ...
    if (dexoptOptions.isForce()) {
      packageDexOptimizer =
          new PackageDexOptimizer.ForcedUpdatePackageDexOptimizer(this.mPm.mPackageDexOptimizer);
    } else {
      packageDexOptimizer = this.mPm.mPackageDexOptimizer;
    }
    List<SharedLibraryInfo> findSharedLibraries =
        SharedLibraryUtils.findSharedLibraries(packageStateInternal);
    String[] appDexInstructionSets =
        InstructionSets.getAppDexInstructionSets(
            packageStateInternal.getPrimaryCpuAbi(), packageStateInternal.getSecondaryCpuAbi());
    if (!findSharedLibraries.isEmpty()) {
      DexoptOptions dexoptOptions2 =
          new DexoptOptions(
              dexoptOptions.getPackageName(),
              dexoptOptions.getCompilationReason(),
              dexoptOptions.getCompilerFilter(),
              dexoptOptions.getSplitName(),
              dexoptOptions.getFlags() | 64);
      for (SharedLibraryInfo sharedLibraryInfo : findSharedLibraries) {
        Computer snapshotComputer = this.mPm.snapshotComputer();
        AndroidPackage androidPackage2 =
            snapshotComputer.getPackage(sharedLibraryInfo.getPackageName());
        PackageStateInternal packageStateInternal2 =
            snapshotComputer.getPackageStateInternal(sharedLibraryInfo.getPackageName());
        if (androidPackage2 != null && packageStateInternal2 != null) {
          packageDexOptimizer.performDexOpt(
              androidPackage2,
              packageStateInternal2,
              appDexInstructionSets,
              this.mPm.getOrCreateCompilerPackageStats(androidPackage2),
              this.mPm.getDexManager().getPackageUseInfoOrDefault(androidPackage2.getPackageName()),
              dexoptOptions2);
        }
      }
    }
    return packageDexOptimizer.performDexOpt(
        androidPackage,
        packageStateInternal,
        appDexInstructionSets,
        this.mPm.getOrCreateCompilerPackageStats(androidPackage),
        this.mPm.getDexManager().getPackageUseInfoOrDefault(androidPackage.getPackageName()),
        dexoptOptions);
  }
  ...
  public void forceDexOpt(Computer computer, String str) {
    ...
    int performDexOptInternalWithDependenciesLI =
        performDexOptInternalWithDependenciesLI(
            ...
            packageStateInternal,
            new DexoptOptions(
                str, 12, PackageManagerServiceCompilerMapping.getDefaultCompilerFilter(), null, 6));
    Trace.traceEnd(16384L);
  ...
  public boolean performDexOptMode(
      Computer computer, String str, String str2, boolean z, boolean z2, String str3) {
    if (!PackageManagerServiceUtils.isSystemOrRootOrShell()
        && !isCallerInstallerForPackage(computer, str)) {
  ...
  public final boolean isCallerInstallerForPackage(Computer computer, String str) {
    ...
    return (packageStateInternal2 == null
            || (packageStateInternal =
                    computer.getPackageStateInternal(
                        packageStateInternal2.getInstallSource().mInstallerPackageName))
                == null
            || packageStateInternal.getPkg().getUid() != Binder.getCallingUid())
        ? false
        : true;
  }
  ...
  public static List getPackagesForDexopt(
      Collection collection, PackageManagerService packageManagerService) {
    return getPackagesForDexopt(collection, packageManagerService, false);
  }

  public static List getPackagesForDexopt(
      Collection collection, PackageManagerService packageManagerService, boolean z) {
    Predicate predicate;
    ...
    applyPackageFilter(
        ...
        new Predicate() { // from class:
          // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda1
    ...
    applyPackageFilter(
        snapshotComputer,
        new Predicate() { // from class:
          // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda2
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getPackagesForDexopt$3;
            lambda$getPackagesForDexopt$3 =
                DexOptHelper.lambda$getPackagesForDexopt$3((PackageStateInternal) obj);
        ...
        arrayList3,
        packageManagerService);
    final ArraySet packageNamesForIntent =
        getPackageNamesForIntent(new Intent("android.intent.action.PRE_BOOT_COMPLETED"), 0);
    applyPackageFilter(
        snapshotComputer,
        new Predicate() { // from class:
          // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda3
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getPackagesForDexopt$4;
            lambda$getPackagesForDexopt$4 =
                DexOptHelper.lambda$getPackagesForDexopt$4(
                    packageNamesForIntent, (PackageStateInternal) obj);
    ...
    applyPackageFilter(
        snapshotComputer,
        new Predicate() { // from class:
          // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda4
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getPackagesForDexopt$5;
            lambda$getPackagesForDexopt$5 =
                DexOptHelper.lambda$getPackagesForDexopt$5(
                    DexManager.this, (PackageStateInternal) obj);
    ...
    if (!arrayList2.isEmpty() && packageManagerService.isHistoricalPackageUsageAvailable()) {
              ...
              Collections.max(
                  ...
                  Comparator.comparingLong(
                      new ToLongFunction() { // from class:
                        // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda5
                        @Override // java.util.function.ToLongFunction
                        public final long applyAsLong(Object obj) {
                          long lambda$getPackagesForDexopt$6;
                          lambda$getPackagesForDexopt$6 =
                              DexOptHelper.lambda$getPackagesForDexopt$6(
      ...
      if (latestForegroundPackageUseTimeInMills != 0) {
        ...
        predicate2 =
            new Predicate() { // from class:
              // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda6
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$getPackagesForDexopt$7;
                lambda$getPackagesForDexopt$7 =
                    DexOptHelper.lambda$getPackagesForDexopt$7(j, (PackageStateInternal) obj);
        ...
        predicate2 =
            new Predicate() { // from class:
              // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda7
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$getPackagesForDexopt$8;
                lambda$getPackagesForDexopt$8 =
                    DexOptHelper.lambda$getPackagesForDexopt$8((PackageStateInternal) obj);
      ...
      predicate =
          new Predicate() { // from class:
            // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda8
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$getPackagesForDexopt$9;
              lambda$getPackagesForDexopt$9 =
                  DexOptHelper.lambda$getPackagesForDexopt$9((PackageStateInternal) obj);
              return lambda$getPackagesForDexopt$9;
            }
          };
    }
    applyPackageFilter(
        snapshotComputer, predicate, arrayList, arrayList2, arrayList3, packageManagerService);
    arrayList.removeIf(
        new Predicate() { // from class:
          // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda9
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
            boolean lambda$getPackagesForDexopt$10;
            lambda$getPackagesForDexopt$10 =
                DexOptHelper.lambda$getPackagesForDexopt$10((PackageStateInternal) obj);
  ...
  public static /* synthetic */ boolean lambda$getPackagesForDexopt$3(
      PackageStateInternal packageStateInternal) {
    return packageStateInternal.getPkg().isCoreApp();
  }

  public static /* synthetic */ boolean lambda$getPackagesForDexopt$4(
      ArraySet arraySet, PackageStateInternal packageStateInternal) {
    return arraySet.contains(packageStateInternal.getPackageName());
  }

  public static /* synthetic */ boolean lambda$getPackagesForDexopt$5(
      DexManager dexManager, PackageStateInternal packageStateInternal) {
    return dexManager
        .getPackageUseInfoOrDefault(packageStateInternal.getPackageName())
        .isAnyCodePathUsedByOtherApps();
  }

  public static /* synthetic */ long lambda$getPackagesForDexopt$6(
      PackageStateInternal packageStateInternal) {
    return packageStateInternal.getTransientState().getLatestForegroundPackageUseTimeInMills();
  }

  public static /* synthetic */ boolean lambda$getPackagesForDexopt$7(
      long j, PackageStateInternal packageStateInternal) {
    return packageStateInternal.getTransientState().getLatestForegroundPackageUseTimeInMills() >= j;
  }

  public static /* synthetic */ boolean lambda$getPackagesForDexopt$10(
      PackageStateInternal packageStateInternal) {
    return "android".equals(packageStateInternal.getPackageName());
  }

  public static void applyPackageFilter(
      Computer computer,
      Predicate predicate,
    ...
    while (it2.hasNext()) {
      ...
      List findSharedNonSystemLibraries =
          computer.findSharedNonSystemLibraries(packageStateInternal2);
  ...
  public static void sortPackagesByUsageDate(
      List list, PackageManagerService packageManagerService) {
    if (packageManagerService.isHistoricalPackageUsageAvailable()) {
      Collections.sort(
          list,
          new Comparator() { // from class:
            // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda10
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
              int lambda$sortPackagesByUsageDate$11;
              lambda$sortPackagesByUsageDate$11 =
                  DexOptHelper.lambda$sortPackagesByUsageDate$11(
                      (PackageStateInternal) obj, (PackageStateInternal) obj2);
  ...
  public static /* synthetic */ int lambda$sortPackagesByUsageDate$11(
      PackageStateInternal packageStateInternal, PackageStateInternal packageStateInternal2) {
    return Long.compare(
        packageStateInternal2.getTransientState().getLatestForegroundPackageUseTimeInMills(),
        packageStateInternal.getTransientState().getLatestForegroundPackageUseTimeInMills());
  }
    ...
    try {
      list =
          AppGlobals.getPackageManager()
              .queryIntentReceivers(intent, (String) null, 0L, i)
              .getList();
  ...
  public static boolean hasBcpApexesChanged() {
    ...
    for (ApexManager.ActiveApexInfo activeApexInfo :
        ApexManager.getInstance().getActiveApexInfos()) {
  ...
  public class DexoptDoneHandler implements ArtManagerLocal.DexoptDoneCallback {
    ...
    public void onDexoptDone(DexoptResult dexoptResult) {
      ...
      for (DexoptResult.PackageDexoptResult packageDexoptResult :
          dexoptResult.getPackageDexoptResults()) {
        CompilerStats.PackageStats orCreateCompilerPackageStats =
            DexOptHelper.this.mPm.getOrCreateCompilerPackageStats(
                packageDexoptResult.getPackageName());
        for (DexoptResult.DexContainerFileDexoptResult dexContainerFileDexoptResult :
            packageDexoptResult.getDexContainerFileDexoptResults()) {
          orCreateCompilerPackageStats.setCompileTime(
              dexContainerFileDexoptResult.getDexContainerFile(),
              dexContainerFileDexoptResult.getDex2oatWallTimeMillis());
        }
      }
      synchronized (DexOptHelper.this.mPm.mLock) {
        DexOptHelper.this
            .mPm
            .getPackageUsage()
            .maybeWriteAsync(DexOptHelper.this.mPm.mSettings.getPackagesLocked());
        DexOptHelper.this.mPm.mCompilerStats.maybeWriteAsync();
      }
      if (dexoptResult.getReason().equals("inactive")) {
        for (DexoptResult.PackageDexoptResult packageDexoptResult2 :
            dexoptResult.getPackageDexoptResults()) {
          if (packageDexoptResult2.getStatus() == 20) {
            long j = 0;
            long j2 = 0;
            for (DexoptResult.DexContainerFileDexoptResult dexContainerFileDexoptResult2 :
                packageDexoptResult2.getDexContainerFileDexoptResults()) {
      ...
      ArraySet arraySet = new ArraySet();
      for (DexoptResult.PackageDexoptResult packageDexoptResult3 :
          dexoptResult.getPackageDexoptResults()) {
  ...
  public static void initializeArtManagerLocal(
      final Context context, final PackageManagerService packageManagerService) {
    if (useArtService()) {
      final ArtManagerLocal artManagerLocal = new ArtManagerLocal(context);
      SystemServerInitThreadPool$$ExternalSyntheticLambda1
          systemServerInitThreadPool$$ExternalSyntheticLambda1 =
      ...
      artManagerLocal.addDexoptDoneCallback(
          false, systemServerInitThreadPool$$ExternalSyntheticLambda1, new DexoptDoneHandler());
      if (!LOW_DEBUG) {
        artManagerLocal.addDexoptDoneCallback(
            false,
            new SystemServerInitThreadPool$$ExternalSyntheticLambda1(),
            new ArtManagerLocal.DexoptDoneCallback() { // from class:
              // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda12
      ...
      artManagerLocal.addDexoptDoneCallback(
          ...
          new SystemServerInitThreadPool$$ExternalSyntheticLambda1(),
          new ArtManagerLocal.DexoptDoneCallback() { // from class:
            // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda13
            public final void onDexoptDone(DexoptResult dexoptResult) {
      ...
      artManagerLocal.setBatchDexoptStartCallback(
          new SystemServerInitThreadPool$$ExternalSyntheticLambda1(),
          new ArtManagerLocal.BatchDexoptStartCallback() { // from class:
            // com.android.server.pm.DexOptHelper$$ExternalSyntheticLambda14
            public final void onBatchDexoptStart(
                PackageManagerLocal.FilteredSnapshot filteredSnapshot,
                String str,
                List list,
                BatchDexoptParams.Builder builder,
                CancellationSignal cancellationSignal) {
              DexOptHelper.lambda$initializeArtManagerLocal$14(
                  context,
                  packageManagerService,
                  artManagerLocal,
                  filteredSnapshot,
      ...
      context.registerReceiver(
          new BroadcastReceiver() { // from class: com.android.server.pm.DexOptHelper.1
  ...
  public static /* synthetic */ void lambda$initializeArtManagerLocal$12(
  ...
  public static /* synthetic */ void lambda$initializeArtManagerLocal$13(
      DexoptResult dexoptResult) {
    ...
    if (dexoptResult.getReason().equals("install") && dexoptResult.getFinalStatus() == 30) {
      PackageManagerServiceUtils.logCriticalInfo(
          4,
          "[INSTALL] Dexopt for "
              + ((DexoptResult.PackageDexoptResult) dexoptResult.getPackageDexoptResults().get(0))
                  .getPackageName()
              + " failed");
    }
  }

  public static /* synthetic */ void lambda$initializeArtManagerLocal$14(
      Context context,
      PackageManagerService packageManagerService,
    ...
    if (str.equals("bg-dexopt")) {
      ...
      BgDexOptHelper bgDexOptHelper =
          new BgDexOptHelper(
              context, packageManagerService.mInjector.getHandler(), artManagerLocal);
      if (!bgDexOptHelper.canRunBgDexOpt()) {
        cancellationSignal.cancel();
      } else {
        List reorderPkgListBasedOnPriority =
            reorderPkgListBasedOnPriority(packageManagerService, bgDexOptHelper, list);
        builder
            .setPackages(reorderPkgListBasedOnPriority)
            .setDexoptParams(new DexoptParams.Builder("bg-dexopt").build());
    ...
    if (str.equals("boot-after-mainline-update")) {
      ...
      DexoptParams build =
          new DexoptParams.Builder("boot-after-mainline-update")
              .setCompilerFilter("speed-profile")
              .build();
  ...
  public static List reorderPkgListBasedOnPriority(
      PackageManagerService packageManagerService, BgDexOptHelper bgDexOptHelper, List list) {
    ArrayList arrayList = new ArrayList();
    Computer snapshotComputer = packageManagerService.snapshotComputer();
    Slog.d("PackageManager", "Reordering packages based on priority");
    if (bgDexOptHelper.getBatteryLevel() <= 80) {
      PackageManagerServiceUtils.logCriticalInfo(
          4, "Not fully charged. Optimize top-priority packages only");
      BgDexOptHelper.initSurfaceTemperature();
      BgDexOptHelper.setTemperaturePolicy(true);
      BgDexOptHelper.toggleBatteryLevelPolicy();
      arrayList.addAll(
          snapshotComputer.getTopPriorityPackages(
              TimeUnit.DAYS.toMillis(3L),
              BgDexOptHelper.getInitialSurfaceTemperature() > 390 ? 5 : -1));
      PackageManagerServiceUtils.logCriticalInfo(
          4, "Target Packages (size : " + arrayList.size() + ") " + String.join(",", arrayList));
      return arrayList;
    }
    ...
    for (ResolveInfo resolveInfo :
        packageManagerService
            .getIPackageManager()
            .queryIntentActivities(intent, intent.getType(), 0L, 0)
            .getList()) {
    ...
    Slog.d(
        "PackageManager",
        "Optimizable Packages(size : " + list.size() + ") " + String.join(",", list));
    Slog.d(
        "PackageManager",
        "Recently used Packages(size : " + arrayList3.size() + ") " + String.join(",", arrayList3));
    Slog.d(
        "PackageManager",
        "Executable Packages(size : " + arrayList4.size() + ") " + String.join(",", arrayList4));
    Slog.d(
        "PackageManager",
        "Remaining Packages(size : " + arrayList5.size() + ") " + String.join(",", arrayList5));
    return arrayList;
  }
  ...
  public class BgDexOptHelper implements ArtManagerLocal.DexoptDoneCallback {
    ...
    public void startObserveThermal() {
      ...
      this.mArtManager.addDexoptDoneCallback(
          false, new SystemServerInitThreadPool$$ExternalSyntheticLambda1(), this);
    }
    ...
    public final int getBatteryLevel() {
      return ((BatteryManagerInternal) LocalServices.getService(BatteryManagerInternal.class))
          .getBatteryLevel();
    }
    ...
    public boolean canRunBgDexOpt() {
      if (!isBatteryFullyCharged()) {
        PackageManagerServiceUtils.logCriticalInfo(
            4,
            "Can't run bg dexopt by not fully charged: "
                + getBatteryLevel()
                + " abortCount: "
                + getAbortCount());
    ...
    public final boolean reachedToThermalThrottleLevel() {
      ...
      if (z) {
        PackageManagerServiceUtils.logCriticalInfo(
            4, "Current temperature: " + temperature + ", criteria: " + i + ", reached: " + z);
      }
      return z;
    }
    ...
    public final class MyHandler extends Handler {
      ...
      public void handleMessage(Message message) {
        if (BgDexOptHelper.this.reachedToThermalThrottleLevel()) {
          PackageManagerServiceUtils.logCriticalInfo(
              4, "Canceling bg dexopt by thermal throttling");
  ...
  public static void saveDexOptLog() {
    ...
    try {
      Runtime.getRuntime()
          .exec("logcat -v raw -b main,system -t 3000 -f /data/log/dexoptfail_log")
          .waitFor();
