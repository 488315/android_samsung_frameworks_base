...
public class DomainVerificationService extends SystemService
    ...
    synchronized (this.mLock) {
      ...
      for (int i = 0; i < size; i++) {
        DomainVerificationPkgState domainVerificationPkgState =
            (DomainVerificationPkgState) this.mAttachedPkgStates.valueAt(i);
  ...
  public UUID getDomainVerificationInfoId(String str) {
    synchronized (this.mLock) {
      DomainVerificationPkgState domainVerificationPkgState =
          (DomainVerificationPkgState) this.mAttachedPkgStates.get(str);
  ...
  public int setDomainVerificationStatusInternal(int i, UUID uuid, Set set, int i2) {
    ...
    synchronized (this.mLock) {
      ...
      GetAttachedResult andValidateAttachedLocked =
          getAndValidateAttachedLocked(uuid, set, true, i, null, snapshot);
      ...
      while (it.hasNext()) {
        ...
        if (num == null
            || (num.intValue() != i2 && DomainVerificationState.isModifiable(num.intValue()))) {
          if (DomainVerificationState.isVerified(i2)
              && (num == null || !DomainVerificationState.isVerified(num.intValue()))) {
            arrayList.add(str);
          }
  ...
  public void setDomainVerificationStatusInternal(String str, int i, ArraySet arraySet) {
    ...
    if (str == null) {
      ...
      synchronized (this.mLock) {
        ...
        while (i2 < size) {
          DomainVerificationPkgState domainVerificationPkgState =
              (DomainVerificationPkgState) this.mAttachedPkgStates.valueAt(i2);
          PackageStateInternal packageStateInternal =
              snapshot.getPackageStateInternal(domainVerificationPkgState.getPackageName());
          if (packageStateInternal != null && packageStateInternal.getPkg() != null) {
            ...
            ArraySet collectValidAutoVerifyDomains =
                this.mCollector.collectValidAutoVerifyDomains(pkg);
            if (arraySet == null) {
  ...
  public final void setDomainVerificationStatusInternal(
      DomainVerificationPkgState domainVerificationPkgState, int i, ArraySet arraySet) {
  ...
  public final void removeUserStatesForDomain(
    ...
    synchronized (this.mLock) {
      int size = this.mAttachedPkgStates.size();
      for (int i = 0; i < size; i++) {
        SparseArray userStates2 =
            ((DomainVerificationPkgState) this.mAttachedPkgStates.valueAt(i)).getUserStates();
        int size2 = userStates2.size();
        for (int i2 = 0; i2 < size2; i2++) {
          DomainVerificationInternalUserState domainVerificationInternalUserState =
              (DomainVerificationInternalUserState) userStates.get(userStates2.keyAt(i2));
          if (domainVerificationInternalUserState == null
              || domainVerificationInternalUserState.isLinkHandlingAllowed()) {
  ...
  public void setDomainVerificationLinkHandlingAllowed(String str, boolean z, int i) {
    if (!this.mEnforcer.assertApprovedUserSelector(
        this.mConnection.getCallingUid(), this.mConnection.getCallingUserId(), str, i)) {
      throw DomainVerificationUtils.throwPackageUnavailable(str);
    }
    synchronized (this.mLock) {
      DomainVerificationPkgState domainVerificationPkgState =
  ...
  public int setDomainVerificationUserSelection(UUID uuid, Set set, boolean z, int i) {
    ...
    if (!this.mEnforcer.assertApprovedUserSelector(
        callingUid, this.mConnection.getCallingUserId(), null, i)) {
      return 1;
    }
    Computer snapshot = this.mConnection.snapshot();
    synchronized (this.mLock) {
      GetAttachedResult andValidateAttachedLocked =
          getAndValidateAttachedLocked(uuid, set, false, callingUid, Integer.valueOf(i), snapshot);
      if (andValidateAttachedLocked.isError()) {
        return andValidateAttachedLocked.getErrorCode();
      }
      DomainVerificationInternalUserState orCreateUserState =
          andValidateAttachedLocked.getPkgState().getOrCreateUserState(i);
      if (z
          && (revokeOtherUserSelectionsLocked =
                  revokeOtherUserSelectionsLocked(orCreateUserState, i, set, snapshot))
              != 0) {
  ...
  @Override // com.android.server.pm.verify.domain.DomainVerificationShell.Callback
  public void setDomainVerificationUserSelectionInternal(
  ...
  public final int revokeOtherUserSelectionsLocked(
    ...
    for (int i2 = 0; i2 < size; i2++) {
      ...
      for (int i3 = 0; i3 < size2; i3++) {
        DomainVerificationPkgState domainVerificationPkgState =
            (DomainVerificationPkgState) this.mAttachedPkgStates.get((String) list.get(i3));
        if (domainVerificationPkgState != null
            && (userState = domainVerificationPkgState.getUserState(i)) != null) {
  ...
  public DomainVerificationUserState getDomainVerificationUserState(String str, int i) {
    boolean z;
    if (!this.mEnforcer.assertApprovedUserStateQuerent(
        this.mConnection.getCallingUid(), this.mConnection.getCallingUserId(), str, i)) {
      throw DomainVerificationUtils.throwPackageUnavailable(str);
    }
    Computer snapshot = this.mConnection.snapshot();
    synchronized (this.mLock) {
      ...
      return new DomainVerificationUserState(
          domainVerificationPkgState.getId(), str, UserHandle.of(i), z, arrayMap);
    }
  }

  public List getOwnersForDomain(String str, int i) {
    Objects.requireNonNull(str);
    this.mEnforcer.assertOwnerQuerent(
        this.mConnection.getCallingUid(), this.mConnection.getCallingUserId(), i);
    SparseArray ownersForDomainInternal =
        getOwnersForDomainInternal(str, false, i, this.mConnection.snapshot());
  ...
  public final SparseArray getOwnersForDomainInternal(
      String str, boolean z, final int i, final Computer computer) {
    int i2;
    ...
    synchronized (this.mLock) {
      ...
      for (int i3 = 0; i3 < size; i3++) {
        String packageName =
            ((DomainVerificationPkgState) this.mAttachedPkgStates.valueAt(i3)).getPackageName();
      ...
      ((List) sparseArray.valueAt(i2))
          .sort(
              new Comparator() { // from class:
                                 // com.android.server.pm.verify.domain.DomainVerificationService$$ExternalSyntheticLambda1
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                  int lambda$getOwnersForDomainInternal$0;
                  lambda$getOwnersForDomainInternal$0 =
                      DomainVerificationService.lambda$getOwnersForDomainInternal$0(
                          Computer.this, i, (String) obj, (String) obj2);
  ...
  public static /* synthetic */ int lambda$getOwnersForDomainInternal$0(
      Computer computer, int i, String str, String str2) {
    ...
    long firstInstallTimeMillis =
        packageStateInternal == null
            ? -1L
            : packageStateInternal.getUserStateOrDefault(i).getFirstInstallTimeMillis();
    long firstInstallTimeMillis2 =
        packageStateInternal2 != null
            ? packageStateInternal2.getUserStateOrDefault(i).getFirstInstallTimeMillis()
            : -1L;
    return firstInstallTimeMillis != firstInstallTimeMillis2
        ? (int) (firstInstallTimeMillis - firstInstallTimeMillis2)
  ...
  public void migrateState(
    ...
    synchronized (this.mLock) {
      ...
      DomainVerificationPkgState domainVerificationPkgState =
          (DomainVerificationPkgState) this.mAttachedPkgStates.remove(domainSetId);
      AndroidPackageInternal pkg = packageStateInternal.getPkg();
      AndroidPackageInternal pkg2 = packageStateInternal2.getPkg();
      ArrayMap arrayMap = new ArrayMap();
      SparseArray sparseArray = new SparseArray();
      if (domainVerificationPkgState != null && pkg != null && pkg2 != null) {
        ArrayMap stateMap = domainVerificationPkgState.getStateMap();
        ArraySet collectValidAutoVerifyDomains =
            this.mCollector.collectValidAutoVerifyDomains(pkg2);
        int size = collectValidAutoVerifyDomains.size();
        for (int i = 0; i < size; i++) {
        ...
        if (size2 > 0) {
          ...
          while (i2 < size2) {
            ...
            DomainVerificationInternalUserState domainVerificationInternalUserState =
                (DomainVerificationInternalUserState) userStates.valueAt(i2);
            ...
            sparseArray.put(
                ...
                new DomainVerificationInternalUserState(
                    keyAt, arraySet, domainVerificationInternalUserState.isLinkHandlingAllowed()));
            i2++;
        ...
        boolean z2 =
            z
                && applyImmutableState(
                    packageStateInternal2, arrayMap, collectValidAutoVerifyDomains);
        this.mAttachedPkgStates.put(
            packageName,
            domainSetId2,
            new DomainVerificationPkgState(
                packageName, domainSetId2, z, arrayMap, sparseArray, null));
        if (z2) {
      ...
      this.mAttachedPkgStates.put(
          ...
          domainSetId2,
          new DomainVerificationPkgState(
              packageName, domainSetId2, true, arrayMap, sparseArray, null));
    }
  }
  ...
  public void addPackage(PackageStateInternal packageStateInternal) {
    ...
    if (removePendingState != null) {
      ...
      if (removePendingState != null
          && !Objects.equals(
              removePendingState.getBackupSignatureHash(),
    ...
    if (z3) {
      domainVerificationPkgState =
          new DomainVerificationPkgState(removePendingState, domainSetId, z2);
      domainVerificationPkgState.getStateMap().retainAll(collectValidAutoVerifyDomains);
      ArraySet collectAllWebDomains = this.mCollector.collectAllWebDomains(pkg);
      SparseArray userStates = domainVerificationPkgState.getUserStates();
      int size = userStates.size();
      for (int i = 0; i < size; i++) {
        ((DomainVerificationInternalUserState) userStates.valueAt(i))
            .retainHosts(collectAllWebDomains);
      }
    } else {
    ...
    if (applyImmutableState(
            packageStateInternal,
            domainVerificationPkgState.getStateMap(),
            collectValidAutoVerifyDomains)
        && !z3) {
  ...
  public final boolean applyImmutableState(
    ...
    if (packageStateInternal.isSystem()
        && this.mSystemConfig.getLinkedApps().contains(packageStateInternal.getPackageName())) {
      int size = arraySet.size();
      for (int i = 0; i < size; i++) {
  ...
  public void writeSettings(
      final Computer computer, TypedXmlSerializer typedXmlSerializer, boolean z, int i) {
    synchronized (this.mLock) {
      this.mSettings.writeSettings(
          typedXmlSerializer,
          this.mAttachedPkgStates,
          i,
          z
              ? new Function() { // from class:
                ...
                public final Object apply(Object obj) {
                  ...
                  lambda$writeSettings$1 =
                      DomainVerificationService.lambda$writeSettings$1(Computer.this, (String) obj);
  ...
  @Override // com.android.server.pm.verify.domain.DomainVerificationManagerInternal
  public void addLegacySetting(
      String str, IntentFilterVerificationInfo intentFilterVerificationInfo) {
    this.mLegacySettings.add(str, intentFilterVerificationInfo);
  }

  @Override // com.android.server.pm.verify.domain.DomainVerificationManagerInternal
  public boolean setLegacyUserState(String str, int i, int i2) {
    if (!this.mEnforcer.callerIsLegacyUserSelector(
        this.mConnection.getCallingUid(), this.mConnection.getCallingUserId(), str, i)) {
      return false;
    }
  ...
  public int getLegacyState(String str, int i) {
    if (this.mEnforcer.callerIsLegacyUserQuerent(
        this.mConnection.getCallingUid(), this.mConnection.getCallingUserId(), str, i)) {
  ...
  @Override // com.android.server.pm.verify.domain.DomainVerificationShell.Callback
  public void printOwnersForPackage(
        ...
        for (int i = 0; i < size; i++) {
          try {
            printOwnersForPackage(
                ...
                ((DomainVerificationPkgState) this.mAttachedPkgStates.valueAt(i)).getPackageName(),
                num,
                snapshot);
  ...
  public final void printOwnersForPackage(
      IndentingPrintWriter indentingPrintWriter, String str, Integer num, Computer computer) {
    PackageStateInternal packageStateInternal = computer.getPackageStateInternal(str);
    AndroidPackageInternal pkg =
        packageStateInternal == null ? null : packageStateInternal.getPkg();
    if (pkg == null) {
    ...
    for (int i = 0; i < size; i++) {
      printOwnersForDomain(
          indentingPrintWriter, (String) collectAllWebDomains.valueAt(i), num, computer);
    }
    indentingPrintWriter.decreaseIndent();
  }

  @Override // com.android.server.pm.verify.domain.DomainVerificationShell.Callback
  public void printOwnersForDomains(
  ...
  public final void printOwnersForDomain(
    ...
    if (num == null || num.intValue() == -1) {
      ...
      sparseArray.put(
          num.intValue(), getOwnersForDomainInternal(str, true, num.intValue(), computer));
    }
  ...
  public final GetAttachedResult getAndValidateAttachedLocked(
    ...
    DomainVerificationPkgState domainVerificationPkgState =
        (DomainVerificationPkgState) this.mAttachedPkgStates.get(uuid);
    if (domainVerificationPkgState == null) {
  ...
  public void verifyPackages(List list, boolean z) {
    ...
    if (list == null) {
      synchronized (this.mLock) {
        ...
        while (i < size) {
          addIfShouldBroadcastLocked(
              arraySet, (DomainVerificationPkgState) this.mAttachedPkgStates.valueAt(i), z);
          i++;
        }
      }
    } else {
      synchronized (this.mLock) {
        ...
        while (i < size2) {
          DomainVerificationPkgState domainVerificationPkgState =
              (DomainVerificationPkgState) this.mAttachedPkgStates.get((String) list.get(i));
          if (domainVerificationPkgState != null) {
  ...
  public final void addIfShouldBroadcastLocked(
      Collection collection, DomainVerificationPkgState domainVerificationPkgState, boolean z) {
    if ((z && domainVerificationPkgState.isHasAutoVerifyDomains())
        || shouldReBroadcastPackage(domainVerificationPkgState)) {
      collection.add(domainVerificationPkgState.getPackageName());
    }
  }

  public final boolean shouldReBroadcastPackage(
      DomainVerificationPkgState domainVerificationPkgState) {
    if (!domainVerificationPkgState.isHasAutoVerifyDomains()) {
      return false;
    }
  ...
  public final void resetDomainState(ArrayMap arrayMap, PackageStateInternal packageStateInternal) {
    ...
    applyImmutableState(
        packageStateInternal,
        arrayMap,
        this.mCollector.collectValidAutoVerifyDomains(packageStateInternal.getPkg()));
  }
  ...
  public void clearUserStates(List list, int i) {
    ...
    synchronized (this.mLock) {
      ...
      if (list == null) {
        ...
        while (i2 < size2) {
          DomainVerificationPkgState domainVerificationPkgState2 =
              (DomainVerificationPkgState) this.mAttachedPkgStates.get((String) list.get(i2));
          if (i == -1) {
  ...
  public final int fillMapWithApprovalLevels(
      ArrayMap arrayMap, String str, int i, Function function) {
    int size = arrayMap.size();
    int i2 = 0;
    for (int i3 = 0; i3 < size; i3++) {
      if (arrayMap.valueAt(i3) == null) {
        ...
        if (packageStateInternal == null) {
          ...
          int approvalLevelForDomain =
              approvalLevelForDomain(packageStateInternal, str, false, i, false, str);
  ...
  public final void filterToLastFirstInstalled(ArrayMap arrayMap, Function function) {
    ...
    for (int size2 = arrayMap.size() - 1; size2 >= 0; size2--) {
      if (!Objects.equals(
          str, ((ResolveInfo) arrayMap.keyAt(size2)).getComponentInfo().packageName)) {
        arrayMap.removeAt(size2);
      }
    }
  }
  ...
  public final int indexOfIntentFilterEntry(
  ...
  @Override // com.android.server.pm.verify.domain.DomainVerificationManagerInternal
  public int approvalLevelForDomain(
  ...
  public final int approvalLevelForDomain(
      ...
      boolean z2,
      Object obj) {
    int approvalLevelForDomainInternal =
        approvalLevelForDomainInternal(packageStateInternal, str, z, i, z2, obj);
  ...
  */
  public final int approvalLevelForDomainInternal(
      PackageStateInternal packageStateInternal,
      String str,
      boolean z,
      int i,
    ...
    PackageUserStateInternal packageUserStateInternal =
        (PackageUserStateInternal) packageStateInternal.getUserStates().get(i);
    ...
    if (pkg != null
        && !DomainVerificationUtils.isChangeEnabled(this.mPlatformCompat, pkg, 178111421L)) {
    ...
    synchronized (this.mLock) {
      DomainVerificationPkgState domainVerificationPkgState =
          (DomainVerificationPkgState) this.mAttachedPkgStates.get(packageName);
      if (domainVerificationPkgState == null) {
        if (z2) {
      ...
      if (pkg != null
          && packageStateInternal.getUserStateOrDefault(i).isInstantApp()
          && this.mCollector.collectValidAutoVerifyDomains(pkg).contains(str)) {
        return 5;
      }
      ArrayMap stateMap = domainVerificationPkgState.getStateMap();
      Integer num = (Integer) stateMap.get(str);
      ...
      int size = stateMap.size();
      for (int i2 = 0; i2 < size; i2++) {
        if (DomainVerificationState.isVerified(((Integer) stateMap.valueAt(i2)).intValue())) {
          String str2 = (String) stateMap.keyAt(i2);
      ...
      ArraySet enabledHosts = userState2.getEnabledHosts();
      ...
      for (int i3 = 0; i3 < size2; i3++) {
        String str3 = (String) enabledHosts.valueAt(i3);
  ...
  public final Pair getApprovedPackagesLocked(String str, int i, int i2, Computer computer) {
    ...
    for (int i4 = 0; i4 < size; i4++) {
      String packageName =
          ((DomainVerificationPkgState) this.mAttachedPkgStates.valueAt(i4)).getPackageName();
      PackageStateInternal packageStateInternal = computer.getPackageStateInternal(packageName);
      if (packageStateInternal != null
          && (approvalLevelForDomain =
                  approvalLevelForDomain(packageStateInternal, str, z, i, false, str))
