...
public interface DomainVerificationProxy {
  ...
  static DomainVerificationProxy makeProxy(
      ...
      DomainVerificationProxyV1.Connection connection) {
    ComponentName componentName3 =
        (componentName2 == null
                || componentName == null
                || Objects.equals(componentName2.getPackageName(), componentName.getPackageName()))
            ? componentName
            : null;
    DomainVerificationProxyV1 domainVerificationProxyV1 =
        componentName3 != null
            ? new DomainVerificationProxyV1(
                context,
                ...
                componentName3)
            : null;
    DomainVerificationProxyV2 domainVerificationProxyV2 =
        componentName2 != null
            ? new DomainVerificationProxyV2(
                context, (DomainVerificationProxyV2.Connection) connection, componentName2)
            : null;
    if (domainVerificationProxyV1 == null || domainVerificationProxyV2 == null) {
      return domainVerificationProxyV1 != null
          ? domainVerificationProxyV1
          : domainVerificationProxyV2 != null
              ? domainVerificationProxyV2
              : new DomainVerificationProxyUnavailable();
    }
    return new DomainVerificationProxyCombined(
        domainVerificationProxyV1, domainVerificationProxyV2);
  }
}
