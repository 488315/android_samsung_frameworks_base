...
public class CrossProfileAppsServiceImpl extends ICrossProfileApps.Stub {
  ...
  public void startActivityAsUser(
    ...
    if (!str.equals(componentName.getPackageName())) {
      throw new SecurityException(
          str
              + " attempts to start an activity in other package - "
    ...
    if (z) {
      ...
      if (callingUserId != i) {
        if (!hasInteractAcrossProfilesPermission(str, callingUid, callingPid)
            && !isPermissionGranted(
                "android.permission.START_CROSS_PROFILE_ACTIVITIES", callingUid)) {
          throw new SecurityException(
              "Attempt to launch activity without one of the required"
                  + " android.permission.INTERACT_ACROSS_PROFILES or"
                  + " android.permission.START_CROSS_PROFILE_ACTIVITIES permissions.");
        }
        if (!isSameProfileGroup(callingUserId, i)) {
          throw new SecurityException(
              "Attempt to launch activity when target user is not in the same profile group.");
        }
      }
    ...
    this.mInjector
        ...
        .startActivityAsUser(iApplicationThread, str, str2, intent, iBinder, 0, bundle2, i);
  }
  ...
  public void startActivityAsUserByIntent(
    ...
    if (callingUserId != i && !hasCallerGotInteractAcrossProfilesPermission(str)) {
      throw new SecurityException(
          "Attempt to launch activity without required android.permission.INTERACT_ACROSS_PROFILES"
              + " permission or target user is not in the same profile group.");
    }
    verifyActivityCanHandleIntent(intent2, callingUid, i);
    this.mInjector
        .getActivityTaskManagerInternal()
        .startActivityAsUser(iApplicationThread, str, str2, intent2, iBinder, 0, bundle, i);
    logStartActivityByIntent(str);
  }

  public final void logStartActivityByIntent(String str) {
    DevicePolicyEventLogger.createEvent(150)
        .setStrings(new String[] {str})
  ...
  public final boolean hasRequestedAppOpPermission(String str, String str2, int i) {
    try {
      return ArrayUtils.contains(
          this.mInjector.getIPackageManager().getAppOpPermissionPackages(str, i), str2);
  ...
  public boolean canInteractAcrossProfiles(String str) {
    Objects.requireNonNull(str);
    verifyCallingPackage(str);
    List targetUserProfilesUnchecked =
        getTargetUserProfilesUnchecked(str, this.mInjector.getCallingUserId());
    return !targetUserProfilesUnchecked.isEmpty()
        && hasCallerGotInteractAcrossProfilesPermission(str)
        && haveProfilesGotInteractAcrossProfilesPermission(str, targetUserProfilesUnchecked);
  }

  public final boolean hasCallerGotInteractAcrossProfilesPermission(String str) {
    return hasInteractAcrossProfilesPermission(
        str, this.mInjector.getCallingUid(), this.mInjector.getCallingPid());
  }

  public final boolean haveProfilesGotInteractAcrossProfilesPermission(
      final String str, List list) {
          ...
          ((Integer)
                  this.mInjector.withCleanCallingIdentity(
                      new FunctionalUtils.ThrowingSupplier() { // from class:
                        // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda4
                        public final Object getOrThrow() {
                          Integer lambda$haveProfilesGotInteractAcrossProfilesPermission$0;
                          lambda$haveProfilesGotInteractAcrossProfilesPermission$0 =
                              CrossProfileAppsServiceImpl.this
                                  .lambda$haveProfilesGotInteractAcrossProfilesPermission$0(
                                      str, userHandle);
  ...
  public /* synthetic */ Integer lambda$haveProfilesGotInteractAcrossProfilesPermission$0(
      String str, UserHandle userHandle) {
    try {
      return Integer.valueOf(
          this.mInjector
              .getPackageManager()
              .getPackageUidAsUser(str, 0, userHandle.getIdentifier()));
  ...
  public final boolean isCrossProfilePackageAllowlisted(final String str) {
    ...
    return ((Boolean)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda1
                  public final Object getOrThrow() {
                    Boolean lambda$isCrossProfilePackageAllowlisted$1;
                    lambda$isCrossProfilePackageAllowlisted$1 =
                        CrossProfileAppsServiceImpl.this.lambda$isCrossProfilePackageAllowlisted$1(
                            callingUserId, str);
  ...
  public final boolean isCrossProfilePackageAllowlistedByDefault(final String str) {
    return ((Boolean)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda5
                  public final Object getOrThrow() {
                    Boolean lambda$isCrossProfilePackageAllowlistedByDefault$2;
                    lambda$isCrossProfilePackageAllowlistedByDefault$2 =
                        CrossProfileAppsServiceImpl.this
                            .lambda$isCrossProfilePackageAllowlistedByDefault$2(str);
  ...
  public final List getTargetUserProfilesUnchecked(final String str, final int i) {
    return (List)
        this.mInjector.withCleanCallingIdentity(
            new FunctionalUtils.ThrowingSupplier() { // from class:
              // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda9
              public final Object getOrThrow() {
                List lambda$getTargetUserProfilesUnchecked$3;
                lambda$getTargetUserProfilesUnchecked$3 =
                    CrossProfileAppsServiceImpl.this.lambda$getTargetUserProfilesUnchecked$3(
                        i, str);
  ...
  public final boolean isPackageEnabled(final String str, final int i) {
    ...
    return ((Boolean)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda16
                  public final Object getOrThrow() {
                    Boolean lambda$isPackageEnabled$4;
                    lambda$isPackageEnabled$4 =
                        CrossProfileAppsServiceImpl.this.lambda$isPackageEnabled$4(
                            str, callingUid, i);
  ...
  public /* synthetic */ Boolean lambda$isPackageEnabled$4(String str, int i, int i2) {
    PackageInfo packageInfo =
        this.mInjector.getPackageManagerInternal().getPackageInfo(str, 786432L, i, i2);
  ...
  public final void verifyActivityCanHandleIntent(final Intent intent, final int i, final int i2) {
    this.mInjector.withCleanCallingIdentity(
        new FunctionalUtils.ThrowingRunnable() { // from class:
          // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda8
  ...
  public /* synthetic */ void lambda$verifyActivityCanHandleIntent$5(Intent intent, int i, int i2) {
    if (this.mInjector
        ...
        .queryIntentActivities(
            intent, intent.resolveTypeIfNeeded(this.mContext.getContentResolver()), 786432L, i, i2)
        .isEmpty()) {
      throw new SecurityException("Activity cannot handle intent");
    }
  }

  public final void verifyActivityCanHandleIntentAndExported(
      final Intent intent, final ComponentName componentName, final int i, final int i2) {
    this.mInjector.withCleanCallingIdentity(
        new FunctionalUtils.ThrowingRunnable() { // from class:
          // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda2
          public final void runOrThrow() {
            CrossProfileAppsServiceImpl.this.lambda$verifyActivityCanHandleIntentAndExported$6(
                intent, i, i2, componentName);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$verifyActivityCanHandleIntentAndExported$6(
      Intent intent, int i, int i2, ComponentName componentName) {
    ...
    for (int i3 = 0; i3 < size; i3++) {
      ...
      if (TextUtils.equals(activityInfo.packageName, componentName.getPackageName())
          && TextUtils.equals(activityInfo.name, componentName.getClassName())
          && activityInfo.exported) {
        return;
      }
    }
    throw new SecurityException(
        "Attempt to launch activity without  category Intent.CATEGORY_LAUNCHER or activity is not"
            + " exported"
            + componentName);
  }
  ...
  public final void setInteractAcrossProfilesAppOp(String str, int i, int i2) {
    int callingUid = this.mInjector.getCallingUid();
    if (!isPermissionGranted("android.permission.INTERACT_ACROSS_USERS_FULL", callingUid)
        && !isPermissionGranted("android.permission.INTERACT_ACROSS_USERS", callingUid)) {
      throw new SecurityException(
          "INTERACT_ACROSS_USERS or INTERACT_ACROSS_USERS_FULL is required to set the app-op for"
              + " interacting across profiles.");
    }
    if (!isPermissionGranted("android.permission.MANAGE_APP_OPS_MODES", callingUid)
        && !isPermissionGranted(
            "android.permission.CONFIGURE_INTERACT_ACROSS_PROFILES", callingUid)) {
      throw new SecurityException(
          "MANAGE_APP_OPS_MODES or CONFIGURE_INTERACT_ACROSS_PROFILES is required to set the app-op"
              + " for interacting across profiles.");
    }
  ...
  public final void setInteractAcrossProfilesAppOpUnchecked(String str, int i, int i2) {
    if (i == 0 && !canConfigureInteractAcrossProfiles(str, i2)) {
      Slog.e(
          ...
          "Tried to turn on the appop for interacting across profiles for invalid app " + str);
      return;
    }
  ...
  public final boolean isPackageInstalled(final String str, final int i) {
    return ((Boolean)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda0
                  public final Object getOrThrow() {
                    Boolean lambda$isPackageInstalled$7;
                    lambda$isPackageInstalled$7 =
                        CrossProfileAppsServiceImpl.this.lambda$isPackageInstalled$7(str, i);
  ...
  public /* synthetic */ Boolean lambda$isPackageInstalled$7(String str, int i) {
    return Boolean.valueOf(
        this.mInjector
                .getPackageManagerInternal()
                .getPackageInfo(str, 786432L, this.mInjector.getCallingUid(), i)
            != null);
  }
  ...
  public final void setInteractAcrossProfilesAppOpForProfileOrThrow(
      String str, final int i, int i2, boolean z) {
    ...
    if (currentModeEquals(i, str, packageUidAsUser)) {
      Slog.i(
          "CrossProfileAppsService",
          "Attempt to set mode to existing value of "
              + i
              + " for "
              + str
              + " on profile user ID "
    ...
    boolean hasInteractAcrossProfilesPermission =
        hasInteractAcrossProfilesPermission(str, packageUidAsUser, -1);
    if (isPermissionGranted(
        "android.permission.CONFIGURE_INTERACT_ACROSS_PROFILES", this.mInjector.getCallingUid())) {
      this.mInjector.withCleanCallingIdentity(
          new FunctionalUtils.ThrowingRunnable() { // from class:
            // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda11
            public final void runOrThrow() {
              CrossProfileAppsServiceImpl.this
                  .lambda$setInteractAcrossProfilesAppOpForProfileOrThrow$8(packageUidAsUser, i);
            }
          });
    } else {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$setInteractAcrossProfilesAppOpForProfileOrThrow$8(
      int i, int i2) {
  ...
  public final void maybeLogSetInteractAcrossProfilesAppOp(String str, int i, boolean z) {
    if (z) {
      DevicePolicyEventLogger.createEvent(139)
          .setStrings(new String[] {str})
          .setInt(i)
          .setBoolean(appDeclaresCrossProfileAttribute(str))
          .write();
    }
  }

  public final boolean currentModeEquals(final int i, final String str, final int i2) {
    final String permissionToOp =
        AppOpsManager.permissionToOp("android.permission.INTERACT_ACROSS_PROFILES");
    return ((Boolean)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda14
                  public final Object getOrThrow() {
                    Boolean lambda$currentModeEquals$9;
                    lambda$currentModeEquals$9 =
                        CrossProfileAppsServiceImpl.this.lambda$currentModeEquals$9(
                            i, permissionToOp, i2, str);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ Boolean lambda$currentModeEquals$9(
      int i, String str, int i2, String str2) {
    return Boolean.valueOf(
        i == this.mInjector.getAppOpsManager().unsafeCheckOpNoThrow(str, i2, str2));
  }

  public final void sendCanInteractAcrossProfilesChangedBroadcast(
      String str, UserHandle userHandle) {
    Intent intent =
        new Intent("android.content.pm.action.CAN_INTERACT_ACROSS_PROFILES_CHANGED")
            .setPackage(str);
  ...
  public final boolean canConfigureInteractAcrossProfiles(String str, int i) {
    if (canUserAttemptToConfigureInteractAcrossProfiles(str, i)
        && hasOtherProfileWithPackageInstalled(str, i)
        && hasRequestedAppOpPermission(AppOpsManager.opToPermission(93), str, i)) {
  ...
  public final boolean canUserAttemptToConfigureInteractAcrossProfiles(String str, int i) {
    int[] filterWorkProfileIdOnly =
        filterWorkProfileIdOnly(this.mInjector.getUserManager().getProfileIds(i, false));
    if (filterWorkProfileIdOnly.length >= 2
        && !isProfileOwner(str, filterWorkProfileIdOnly)
        && hasRequestedAppOpPermission(AppOpsManager.opToPermission(93), str, i)) {
    ...
    return arrayList.stream()
        .mapToInt(
            new ToIntFunction() { // from class:
              // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda10
  ...
  public final boolean isPlatformSignedAppWithNonUserConfigurablePermission(
      String str, int[] iArr) {
    return !isCrossProfilePackageAllowlistedByDefault(str)
        && isPlatformSignedAppWithAutomaticProfilesPermission(str, iArr);
  }
  ...
  public final boolean isPlatformSignedAppWithAutomaticProfilesPermission(String str, int[] iArr) {
    for (int i : iArr) {
      ...
      if (packageUid != -1
          && isPermissionGranted("android.permission.INTERACT_ACROSS_PROFILES", packageUid)) {
        return true;
      }
    }
    return false;
  ...
  public final boolean hasOtherProfileWithPackageInstalled(final String str, final int i) {
    return ((Boolean)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda12
                  public final Object getOrThrow() {
                    Boolean lambda$hasOtherProfileWithPackageInstalled$11;
                    lambda$hasOtherProfileWithPackageInstalled$11 =
                        CrossProfileAppsServiceImpl.this
                            .lambda$hasOtherProfileWithPackageInstalled$11(i, str);
  ...
  public final void resetInteractAcrossProfilesAppOp(int i, String str) {
    if (canConfigureInteractAcrossProfiles(str, i)) {
      Slog.w(
          "CrossProfileAppsService",
          "Not resetting app-op for package " + str + " since it is still configurable by users.");
      return;
    }
    lambda$clearInteractAcrossProfilesAppOps$12(
        i,
        str,
  ...
  public void clearInteractAcrossProfilesAppOps(final int i) {
    final int opToDefaultMode =
        AppOpsManager.opToDefaultMode(
            AppOpsManager.permissionToOp("android.permission.INTERACT_ACROSS_PROFILES"));
    findAllPackageNames()
        .forEach(
            new Consumer() { // from class:
              // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda7
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                CrossProfileAppsServiceImpl.this.lambda$clearInteractAcrossProfilesAppOps$12(
                    i, opToDefaultMode, (String) obj);
              }
            });
  }
    ...
    return (List)
        this.mInjector
            ...
            .getInstalledApplications(
                0L, this.mInjector.getCallingUserId(), this.mInjector.getCallingUid())
            .stream()
            .map(
                new Function() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda15
  ...
  public final boolean isSameProfileGroup(final int i, final int i2) {
    return ((Boolean)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda3
                  public final Object getOrThrow() {
                    Boolean lambda$isSameProfileGroup$14;
                    lambda$isSameProfileGroup$14 =
                        CrossProfileAppsServiceImpl.this.lambda$isSameProfileGroup$14(i, i2);
  ...
  public final boolean isManagedProfile(final int i) {
    return ((Boolean)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda13
                  public final Object getOrThrow() {
                    Boolean lambda$isManagedProfile$15;
                    lambda$isManagedProfile$15 =
                        CrossProfileAppsServiceImpl.this.lambda$isManagedProfile$15(i);
  ...
  public /* synthetic */ Boolean lambda$isManagedProfile$15(int i) {
    return Boolean.valueOf(
        ((UserManager) this.mContext.getSystemService(UserManager.class)).isManagedProfile(i));
  }

  public final boolean hasInteractAcrossProfilesPermission(String str, int i, int i2) {
    return isPermissionGranted("android.permission.INTERACT_ACROSS_USERS_FULL", i)
        || isPermissionGranted("android.permission.INTERACT_ACROSS_USERS", i)
        || PermissionChecker.checkPermissionForPreflight(
                this.mContext, "android.permission.INTERACT_ACROSS_PROFILES", i2, i, str)
            == 0;
  }
  ...
  public final boolean isProfileOwner(String str, final int i) {
    ComponentName componentName =
        (ComponentName)
            this.mInjector.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.pm.CrossProfileAppsServiceImpl$$ExternalSyntheticLambda6
                  public final Object getOrThrow() {
                    ComponentName lambda$isProfileOwner$16;
                    lambda$isProfileOwner$16 =
                        CrossProfileAppsServiceImpl.this.lambda$isProfileOwner$16(i);
  ...
  public class InjectorImpl implements Injector {
    ...
    @Override // com.android.server.pm.CrossProfileAppsServiceImpl.Injector
    public final Object withCleanCallingIdentity(
    ...
    public DevicePolicyManagerInternal getDevicePolicyManagerInternal() {
      return (DevicePolicyManagerInternal)
    ...
    public void killUid(int i) {
      PermissionManagerService.killUid(
          UserHandle.getAppId(i), UserHandle.getUserId(i), "permissions revoked");
    }
  }
  ...
  public class LocalService extends CrossProfileAppsInternal {
    ...
    public boolean verifyPackageHasInteractAcrossProfilePermission(String str, int i) {
      PackageManager packageManager =
          CrossProfileAppsServiceImpl.this.mInjector.getPackageManager();
      Objects.requireNonNull(str);
