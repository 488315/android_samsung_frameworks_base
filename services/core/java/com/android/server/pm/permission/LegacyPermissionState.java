...
public final class LegacyPermissionState {
  ...
  public void copyFrom(LegacyPermissionState legacyPermissionState) {
    ...
    for (int i2 = 0; i2 < size2; i2++) {
      this.mMissing.put(
          legacyPermissionState.mMissing.keyAt(i2), legacyPermissionState.mMissing.valueAt(i2));
    }
  }
    ...
    public UserState(UserState userState) {
      ...
      for (int i = 0; i < size; i++) {
        this.mPermissionStates.put(
            ...
            new PermissionState((PermissionState) userState.mPermissionStates.valueAt(i)));
      }
    }
