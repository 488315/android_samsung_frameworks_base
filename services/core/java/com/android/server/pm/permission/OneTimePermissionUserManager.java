...
public class OneTimePermissionUserManager {
  ...
  public final BroadcastReceiver mUninstallListener =
      new BroadcastReceiver() { // from class:
                                // com.android.server.pm.permission.OneTimePermissionUserManager.1
          ...
          if ("android.intent.action.UID_REMOVED".equals(intent.getAction())) {
            ...
            PackageInactivityListener packageInactivityListener =
                (PackageInactivityListener)
                    OneTimePermissionUserManager.this.mListeners.get(intExtra);
  ...
  public OneTimePermissionUserManager(Context context) {
    ...
    this.mPermissionControllerManager =
        new PermissionControllerManager(context, PermissionThread.getHandler());
  ...
  public void registerUninstallListener() {
    this.mContext.registerReceiver(
        this.mUninstallListener, new IntentFilter("android.intent.action.UID_REMOVED"));
  }
  ...
  public class PackageInactivityListener implements AlarmManager.OnAlarmListener {
    ...
    public PackageInactivityListener(int i, String str, long j, long j2) {
      ...
      UidObserver uidObserver =
          new UidObserver() { // from class:
                              // com.android.server.pm.permission.OneTimePermissionUserManager.PackageInactivityListener.1
      ...
      Log.i(
          OneTimePermissionUserManager.LOG_TAG,
          "Start tracking " + str + ". uid=" + i + " timeout=" + j + " killedDelay=" + j2);
      this.mUid = i;
      this.mPackageName = str;
      this.mTimeout = j;
      this.mRevokeAfterKilledDelay =
          j2 == -1
              ? DeviceConfig.getLong(
                  "permissions", "one_time_permissions_killed_delay_millis", 5000L)
              : j2;
      try {
        OneTimePermissionUserManager.this.mIActivityManager.registerUidObserver(
            uidObserver, 3, 4, (String) null);
    ...
    public final int getCurrentState() {
      return getStateFromProcState(
          OneTimePermissionUserManager.this.mActivityManagerInternal.getUidProcessState(this.mUid));
    }
    ...
    public final void updateUidState(int i) {
      Log.v(
          OneTimePermissionUserManager.LOG_TAG,
          "Updating state for " + this.mPackageName + " (" + this.mUid + "). state=" + i);
      synchronized (this.mInnerLock) {
          ...
          if (this.mRevokeAfterKilledDelay == 0) {
            ...
            OneTimePermissionUserManager.this.mHandler.postDelayed(
                new Runnable() { // from class:
                                 // com.android.server.pm.permission.OneTimePermissionUserManager$PackageInactivityListener$$ExternalSyntheticLambda1
                  @Override // java.lang.Runnable
                  public final void run() {
                    OneTimePermissionUserManager.PackageInactivityListener.this
                        .lambda$updateUidState$0();
                  }
                },
                this.mToken,
                this.mRevokeAfterKilledDelay);
    ...
    public final void setAlarmLocked() {
      ...
      if (j > System.currentTimeMillis()) {
        OneTimePermissionUserManager.this.mAlarmManager.setExact(
            0,
            j,
            OneTimePermissionUserManager.LOG_TAG,
            this,
            OneTimePermissionUserManager.this.mHandler);
    ...
    public final void onPackageInactiveLocked() {
      ...
      OneTimePermissionUserManager.this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.pm.permission.OneTimePermissionUserManager$PackageInactivityListener$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              OneTimePermissionUserManager.PackageInactivityListener.this
                  .lambda$onPackageInactiveLocked$1();
            }
          });
      try {
        OneTimePermissionUserManager.this.mIActivityManager.unregisterUidObserver(this.mObserver);
    ...
    public /* synthetic */ void lambda$onPackageInactiveLocked$1() {
      Log.i(
          OneTimePermissionUserManager.LOG_TAG,
          "One time session expired for " + this.mPackageName + " (" + this.mUid + ").");
      OneTimePermissionUserManager.this.mPermissionControllerManager
          .notifyOneTimePermissionSessionTimeout(this.mPackageName);
    }
