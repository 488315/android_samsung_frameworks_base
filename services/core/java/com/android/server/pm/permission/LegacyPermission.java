...
public final class LegacyPermission {
  ...
  public static boolean read(Map map, TypedXmlPullParser typedXmlPullParser) {
    ...
    if (legacyPermission == null || legacyPermission.mType != 1) {
      legacyPermission =
          new LegacyPermission(attributeValue.intern(), attributeValue2, equals ? 2 : 0);
    }
    legacyPermission.mPermissionInfo.protectionLevel =
        readInt(typedXmlPullParser, null, "protection", 0);
    ...
    if (equals) {
      legacyPermission.mPermissionInfo.icon =
          readInt(typedXmlPullParser, null, KnoxCustomManagerService.ICON, 0);
  ...
  public boolean dump(
      PrintWriter printWriter, String str, Set set, boolean z, boolean z2, DumpState dumpState) {
