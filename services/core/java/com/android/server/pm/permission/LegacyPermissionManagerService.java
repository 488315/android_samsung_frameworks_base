...
public final class LegacyPermissionManagerService extends ILegacyPermissionManager.Stub {
    ...
    public final class Internal {
        ...
        public final void grantDefaultPermissions(int i) {
            ...
            DefaultPermissionGrantPolicy.DelayingPackageManagerCache delayingPackageManagerCache =
                    defaultPermissionGrantPolicy.new DelayingPackageManagerCache();
            DirEncryptService$$ExternalSyntheticOutline0.m(
                    i16,
                    "Granting permissions to platform components for user ",
            ...
            while (it3.hasNext()) {
                ...
                if (packageInfo != null) {
                    delayingPackageManagerCache.mPackageInfos.put(
                            packageInfo.packageName, packageInfo);
                    if (delayingPackageManagerCache.isSysComponentOrPersistentPlatformSignedPrivApp(
                                    packageInfo)
                            && DefaultPermissionGrantPolicy.doesPackageSupportRuntimePermissions(
                                    packageInfo)
                            && !ArrayUtils.isEmpty(packageInfo.requestedPermissions)) {
                        ...
                        if ("com.samsung.android.spayfw".equals(packageInfo.packageName)) {
                            ...
                            while (i18 < length) {
                                ...
                                if (str18.equals(str19)) {
                                    ...
                                    str16 = str18;
                                    str15 = str17;
                                    defaultPermissionGrantPolicy.grantRuntimePermissions(
                                            delayingPackageManagerCache,
                                            packageInfo,
                                            Collections.singleton(str18),
                                            false,
                                            false,
                                            i);
                                } else {
                            ...
                            if ("com.samsung.android.ipsgeofence".equals(packageInfo.packageName)) {
                                ...
                                it = it3;
                                if ("com.samsung.android.networkdiagnostic"
                                    ...
                                    if ("com.samsung.cmh".equals(packageInfo.packageName)) {
                                        ...
                                        while (i21 < length4) {
                                            ...
                                            if (str7.equals(str9)) {
                                                defaultPermissionGrantPolicy
                                                        .grantRuntimePermissions(
                                                                delayingPackageManagerCache,
                                                                packageInfo,
                                                                Collections.singleton(str7),
                                                                false,
                                                                false,
                                                                i);
                                            }
                                            if ("android.permission.READ_MEDIA_IMAGES"
                                                    .equals(str9)) {
                                                defaultPermissionGrantPolicy
                                                        .grantRuntimePermissions(
                                                                delayingPackageManagerCache,
                                            ...
                                            if ("android.permission.READ_MEDIA_VIDEO"
                                                    .equals(str9)) {
                                                defaultPermissionGrantPolicy
                                                        .grantRuntimePermissions(
                                                                delayingPackageManagerCache,
                                            ...
                                            if ("android.permission.ACCESS_MEDIA_LOCATION"
                                                    .equals(str9)) {
                                                defaultPermissionGrantPolicy
                                                        .grantRuntimePermissions(
                                                                delayingPackageManagerCache,
                                        ...
                                        if ("com.samsung.faceservice"
                                            ...
                                            while (i22 < length5) {
                                                ...
                                                if ("android.permission.WRITE_EXTERNAL_STORAGE"
                                                        .equals(str4)) {
                                                    strArr3 = strArr12;
                                                    str5 = str4;
                                                    defaultPermissionGrantPolicy
                                        ...
                                        } else if ("com.samsung.storyservice"
                                                .equals(packageInfo.packageName)) {
                                        ...
                                        } else if (!"com.samsung.android.scloud"
                                                .equals(packageInfo.packageName)) {
                                            i3 = i;
                                            defaultPermissionGrantPolicy
                                                    .grantRuntimePermissionsForSystemPackage(
                                                            ...
                                                            packageInfo,
                                                            null);
                                        } else if (SystemProperties.getInt(
                                            ...
                                            if (systemPackageInfo != null
                                                    && DefaultPermissionGrantPolicy
                                                            .doesPackageSupportRuntimePermissions(
                                                                    systemPackageInfo)) {
                                                for (String str29 :
                                                        systemPackageInfo.requestedPermissions) {
                                                    PermissionInfo permissionInfo =
                                                            delayingPackageManagerCache
                                                                    .getPermissionInfo(str29);
            ...
            for (PackageInfo packageInfo2 : installedPackagesAsUser) {
                if (packageInfo2 != null
                        ...
                        && delayingPackageManagerCache.isGranted(
                                ...
                                UserHandle.of(i))
                        && !delayingPackageManagerCache
                                .isSysComponentOrPersistentPlatformSignedPrivApp(packageInfo2)) {
            ...
            if (PMRune.PM_NAL_GET_APP_LIST) {
                DirEncryptService$$ExternalSyntheticOutline0.m(
                        i25,
                        "Granting GET_APP_LIST to system components for user ",
                        "DefaultPermGrantPolicy");
            ...
            defaultPermissionGrantPolicy.grantDefaultSystemHandlerPermissions(
                    delayingPackageManagerCache, i25);
            Log.i(
                    "DefaultPermGrantPolicy",
                    "Granting Notification permissions to platform signature apps for user " + i25);
            for (PackageInfo packageInfo4 :
                ...
                if (packageInfo4 != null
                        && packageInfo4.applicationInfo.isSystemApp()
                        && packageInfo4.applicationInfo.isSignedWithPlatformKey()) {
                    defaultPermissionGrantPolicy.grantRuntimePermissionsForSystemPackage(
                            delayingPackageManagerCache,
                            i25,
                            packageInfo4,
                            DefaultPermissionGrantPolicy.NOTIFICATION_PERMISSIONS);
                }
            }
            ...
            while (i26 < size) {
                PackageInfo packageInfo5 =
                        delayingPackageManagerCache.getPackageInfo(
                                (String) defaultPermissionGrantPolicy.mGrantExceptions.keyAt(i26));
                List list4 = (List) defaultPermissionGrantPolicy.mGrantExceptions.valueAt(i26);
                int size2 = list4.size();
                ArraySet arraySet3 = arraySet2;
                int i27 = 0;
                while (i27 < size2) {
                    DefaultPermissionGrantPolicy.DefaultPermissionGrant defaultPermissionGrant =
                            (DefaultPermissionGrantPolicy.DefaultPermissionGrant) list4.get(i27);
                    PermissionInfo permissionInfo2 =
                            delayingPackageManagerCache.getPermissionInfo(
                                    defaultPermissionGrant.name);
            ...
            for (int i28 = 0;
                    i28 < delayingPackageManagerCache.mDelayedPermissionState.size();
                    i28++) {
                for (int i29 = 0;
                        i29
                                < ((ArrayMap)
                                                delayingPackageManagerCache.mDelayedPermissionState
                                                        .valueAt(i28))
                                        .size();
                        i29++) {
                    try {
                        ((DefaultPermissionGrantPolicy.DelayingPackageManagerCache.PermissionState)
                                        ((ArrayMap)
                                                        delayingPackageManagerCache
                                                                .mDelayedPermissionState.valueAt(
                                                                i28))
                                                .valueAt(i29))
                                .apply();
                        ...
                        Slog.w(
                                ...
                                "Cannot set permission "
                                        + ((String)
                                                ((ArrayMap)
                                                                delayingPackageManagerCache
                                                                        .mDelayedPermissionState
                                                                        .valueAt(i28))
                                                        .keyAt(i29))
                                        + " of uid "
                                        + delayingPackageManagerCache.mDelayedPermissionState.keyAt(
                                                i28),
                                e);
                    }
                }
    ...
    public final int checkDeviceIdentifierAccess(
            String str, String str2, String str3, int i, int i2) {
        verifyCallerCanCheckAccess(i, i2, str, str2);
        int appId = UserHandle.getAppId(i2);
        if (appId == 1000
                || appId == 0
                || this.mInjector.mContext.checkPermission(
                                "android.permission.READ_PRIVILEGED_PHONE_STATE", i, i2)
                        == 0) {
            return 0;
        }
        if (str == null) {
        ...
        try {
            if (((AppOpsManager) this.mInjector.mContext.getSystemService("appops"))
            ...
            DevicePolicyManager devicePolicyManager =
                    (DevicePolicyManager) this.mInjector.mContext.getSystemService("device_policy");
    ...
    public final int checkPermissionAndAppop(
        ...
        if (str2 == null || this.mInjector.mContext.checkPermission(str2, i, i2) == 0) {
            return ((AppOpsManager) this.mInjector.mContext.getSystemService("appops"))
    ...
    public final int checkPhoneNumberAccess(String str, String str2, String str3, int i, int i2) {
        verifyCallerCanCheckAccess(i, i2, str, str2);
        if (this.mInjector.mContext.checkPermission(
                        "android.permission.READ_PRIVILEGED_PHONE_STATE", i, i2)
                == 0) {
            return 0;
        }
        ...
        try {
            if (this.mInjector
                                    ...
                                    .getApplicationInfoAsUser(
                                            str, 0, UserHandle.getUserHandleForUid(i2))
                                    .targetSdkVersion
                            <= 29
                    && (i3 =
        ...
        int i4 = i3;
        if (checkPermissionAndAppop(str, null, "android:write_sms", i, str3, i2, str2) == 0
                || checkPermissionAndAppop(
                                str,
    ...
    public final void grantDefaultPermissionsToActiveLuiApp(String str, int i) {
        PackageManagerServiceUtils.enforceSystemOrPhoneCaller(
                Binder.getCallingUid(), "grantDefaultPermissionsToActiveLuiApp");
        Binder.withCleanCallingIdentity(
                new LegacyPermissionManagerService$$ExternalSyntheticLambda4(this, str, i, 0));
    }
    ...
    public final void grantDefaultPermissionsToCarrierServiceApp(String str, int i) {
        ...
        Binder.withCleanCallingIdentity(
                new LegacyPermissionManagerService$$ExternalSyntheticLambda4(this, str, i, 1));
    }

    public final void grantDefaultPermissionsToEnabledCarrierApps(String[] strArr, int i) {
        PackageManagerServiceUtils.enforceSystemOrPhoneCaller(
                Binder.getCallingUid(), "grantPermissionsToEnabledCarrierApps");
        Binder.withCleanCallingIdentity(
                new LegacyPermissionManagerService$$ExternalSyntheticLambda0(this, strArr, i, 1));
    }

    public final void grantDefaultPermissionsToEnabledImsServices(String[] strArr, int i) {
        PackageManagerServiceUtils.enforceSystemOrPhoneCaller(
                Binder.getCallingUid(), "grantDefaultPermissionsToEnabledImsServices");
        Binder.withCleanCallingIdentity(
                new LegacyPermissionManagerService$$ExternalSyntheticLambda0(this, strArr, i, 0));
    }

    public final void grantDefaultPermissionsToEnabledTelephonyDataServices(
            String[] strArr, int i) {
        PackageManagerServiceUtils.enforceSystemOrPhoneCaller(
                Binder.getCallingUid(), "grantDefaultPermissionsToEnabledTelephonyDataServices");
        Binder.withCleanCallingIdentity(
                new LegacyPermissionManagerService$$ExternalSyntheticLambda0(this, strArr, i, 3));
    }

    public final void revokeDefaultPermissionsFromDisabledTelephonyDataServices(
            String[] strArr, int i) {
        PackageManagerServiceUtils.enforceSystemOrPhoneCaller(
                Binder.getCallingUid(),
                "revokeDefaultPermissionsFromDisabledTelephonyDataServices");
        Binder.withCleanCallingIdentity(
                new LegacyPermissionManagerService$$ExternalSyntheticLambda0(this, strArr, i, 4));
    }

    public final void revokeDefaultPermissionsFromLuiApps(String[] strArr, int i) {
        PackageManagerServiceUtils.enforceSystemOrPhoneCaller(
                Binder.getCallingUid(), "revokeDefaultPermissionsFromLuiApps");
        Binder.withCleanCallingIdentity(
    ...
    */
    public final void verifyCallerCanCheckAccess(
            int r11, int r12, java.lang.String r13, java.lang.String r14) {
        /*
            r10 = this;
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.pm.permission.LegacyPermissionManagerService.verifyCallerCanCheckAccess(int,"
