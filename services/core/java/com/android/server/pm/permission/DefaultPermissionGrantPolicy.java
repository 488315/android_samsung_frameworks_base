...
public final class DefaultPermissionGrantPolicy {
  ...
  public final PackageManagerWrapper NO_PM_CACHE =
      new PackageManagerWrapper() { // from class:
                                    // com.android.server.pm.permission.DefaultPermissionGrantPolicy.1
        ...
        public int getPermissionFlags(String str, PackageInfo packageInfo, UserHandle userHandle) {
          return DefaultPermissionGrantPolicy.this
              .mContext
              .getPackageManager()
              .getPermissionFlags(str, packageInfo.packageName, userHandle);
        }

        @Override // com.android.server.pm.permission.DefaultPermissionGrantPolicy.PackageManagerWrapper
        public void updatePermissionFlags(
            String str, PackageInfo packageInfo, int i, int i2, UserHandle userHandle) {
          DefaultPermissionGrantPolicy.this
              .mContext
              .getPackageManager()
              .updatePermissionFlags(str, packageInfo.packageName, i, i2, userHandle);
        }
        ...
        public void grantPermission(String str, PackageInfo packageInfo, UserHandle userHandle) {
          DefaultPermissionGrantPolicy.this
              .mContext
              .getPackageManager()
              .grantRuntimePermission(packageInfo.packageName, str, userHandle);
        }
        ...
        public void revokePermission(String str, PackageInfo packageInfo, UserHandle userHandle) {
          DefaultPermissionGrantPolicy.this
              .mContext
              .getPackageManager()
              .revokeRuntimePermission(packageInfo.packageName, str, userHandle);
        }
        ...
        public boolean isGranted(String str, PackageInfo packageInfo, UserHandle userHandle) {
          return DefaultPermissionGrantPolicy.this
                  ...
                  .getPackageManager()
                  .checkPermission(str, packageInfo.packageName)
              == 0;
        }
        ...
        new Handler(
            serviceThread
                .getLooper()) { // from class:
                                // com.android.server.pm.permission.DefaultPermissionGrantPolicy.2
              ...
              synchronized (DefaultPermissionGrantPolicy.this.mLock) {
                if (DefaultPermissionGrantPolicy.this.mGrantExceptions == null) {
                  DefaultPermissionGrantPolicy defaultPermissionGrantPolicy =
                      DefaultPermissionGrantPolicy.this;
                  defaultPermissionGrantPolicy.mGrantExceptions =
                      defaultPermissionGrantPolicy.readDefaultPermissionExceptionsLocked(
  ...
  public void setLocationExtraPackagesProvider(
      LegacyPermissionManagerInternal.PackagesProvider packagesProvider) {
    synchronized (this.mLock) {
  ...
  public void setVoiceInteractionPackagesProvider(
      LegacyPermissionManagerInternal.PackagesProvider packagesProvider) {
    synchronized (this.mLock) {
  ...
  public void setSmsAppPackagesProvider(
      LegacyPermissionManagerInternal.PackagesProvider packagesProvider) {
    synchronized (this.mLock) {
  ...
  public void setDialerAppPackagesProvider(
      LegacyPermissionManagerInternal.PackagesProvider packagesProvider) {
    synchronized (this.mLock) {
  ...
  public void setSimCallManagerPackagesProvider(
      LegacyPermissionManagerInternal.PackagesProvider packagesProvider) {
    synchronized (this.mLock) {
  ...
  public void setUseOpenWifiAppPackagesProvider(
      LegacyPermissionManagerInternal.PackagesProvider packagesProvider) {
    synchronized (this.mLock) {
  ...
  public final void grantGetAppListToSystemApps(
      DelayingPackageManagerCache delayingPackageManagerCache, int i) {
    Log.i("DefaultPermGrantPolicy", "Granting GET_APP_LIST to system components for user " + i);
    for (PackageInfo packageInfo :
        this.mContext.getPackageManager().getInstalledPackagesAsUser(536916096, 0)) {
  ...
  public final void grantSignatureAppsNotificationPermissions(
      PackageManagerWrapper packageManagerWrapper, int i) {
    Log.i(
        "DefaultPermGrantPolicy",
        "Granting Notification permissions to platform signature apps for user " + i);
    for (PackageInfo packageInfo :
        this.mContext.getPackageManager().getInstalledPackagesAsUser(536916096, 0)) {
      if (packageInfo != null
        ...
        grantRuntimePermissionsForSystemPackage(
            packageManagerWrapper, i, packageInfo, NOTIFICATION_PERMISSIONS);
      }
    }
  }

  public final void grantRuntimePermissionsForSystemPackage(
      PackageManagerWrapper packageManagerWrapper, int i, PackageInfo packageInfo) {
    grantRuntimePermissionsForSystemPackage(packageManagerWrapper, i, packageInfo, null);
  }

  public final void grantRuntimePermissionsForSystemPackage(
      PackageManagerWrapper packageManagerWrapper, int i, PackageInfo packageInfo, Set set) {
    ...
    for (String str : packageInfo.requestedPermissions) {
      ...
      if (permissionInfo != null
          && ((set == null || set.contains(str)) && permissionInfo.isRuntime())) {
        arraySet.add(str);
      }
    }
    if (arraySet.isEmpty()) {
  ...
  public final void grantPermissionsToSysComponentsAndPrivApps(
      DelayingPackageManagerCache delayingPackageManagerCache, int i) {
    DefaultPermissionGrantPolicy defaultPermissionGrantPolicy;
    Iterator it;
    List list;
    ...
    List<PackageInfo> installedPackagesAsUser =
        defaultPermissionGrantPolicy2
            .mContext
            .getPackageManager()
            .getInstalledPackagesAsUser(536916096, 0);
    ...
    while (it3.hasNext()) {
      ...
      if (packageInfo != null) {
        ...
        if (!delayingPackageManagerCache3.isSysComponentOrPersistentPlatformSignedPrivApp(
                packageInfo)
            || !doesPackageSupportRuntimePermissions(packageInfo)) {
            ...
            for (int length = strArr.length; i9 < length; length = i6) {
              ...
              if ("android.permission.ACCESS_COARSE_LOCATION".equals(str9)) {
                ...
                grantRuntimePermissions(
                    delayingPackageManagerCache,
                    packageInfo,
                    Collections.singleton("android.permission.ACCESS_COARSE_LOCATION"),
                    false,
                    i);
              } else {
                str8 = str9;
              ...
              if ("android.permission.ACCESS_FINE_LOCATION".equals(str8)) {
                grantRuntimePermissions(
                    delayingPackageManagerCache,
                    packageInfo,
                    Collections.singleton("android.permission.ACCESS_FINE_LOCATION"),
                    false,
                    i);
              }
              i9 = i5 + 1;
            ...
            if ("com.samsung.android.networkdiagnostic".equals(packageInfo.packageName)) {
              ...
              while (i10 < length2) {
                ...
                if ("android.permission.ACCESS_BACKGROUND_LOCATION".equals(str7)) {
                  grantRuntimePermissions(
                      delayingPackageManagerCache,
                      packageInfo,
                      Collections.singleton("android.permission.ACCESS_BACKGROUND_LOCATION"),
                      false,
                      i);
                }
                i10 = i3 + 1;
              ...
              if ("com.samsung.android.scloud".equals(packageInfo.packageName)) {
                if (SystemProperties.getInt("ro.product.first_api_level", 0) >= 31) {
                  defaultPermissionGrantPolicy2.grantRuntimePermissionsForSystemPackage(
                      delayingPackageManagerCache3, i7, packageInfo);
                  PackageInfo systemPackageInfo =
                      delayingPackageManagerCache3.getSystemPackageInfo(
                          "com.samsung.android.scloud");
                  if (systemPackageInfo != null
                      && doesPackageSupportRuntimePermissions(systemPackageInfo)) {
                    for (String str11 : systemPackageInfo.requestedPermissions) {
                      PermissionInfo permissionInfo =
                          delayingPackageManagerCache3.getPermissionInfo(str11);
                      if (permissionInfo != null && permissionInfo.isRuntime()) {
                        delayingPackageManagerCache.updatePermissionFlags(
                            str11, systemPackageInfo, 16, 0, UserHandle.of(i));
                      }
                    }
                  }
                } else {
                ...
                if ("com.samsung.cmh".equals(packageInfo.packageName)) {
                  ...
                  while (i11 < length3) {
                    ...
                    if ("android.permission.READ_CONTACTS".equals(str16)) {
                      ...
                      grantRuntimePermissions(
                          delayingPackageManagerCache,
                          packageInfo,
                          Collections.singleton("android.permission.READ_CONTACTS"),
                          false,
                          i);
                      str5 = str15;
                    } else {
                    ...
                    if ("android.permission.ACCESS_MEDIA_LOCATION".equals(str)) {
                      grantRuntimePermissions(
                          delayingPackageManagerCache,
                          packageInfo,
                          Collections.singleton("android.permission.ACCESS_MEDIA_LOCATION"),
                          false,
                          i);
                    }
                    i11++;
                  ...
                  if ("com.samsung.faceservice".equals(packageInfo.packageName)) {
                    for (String str17 : packageInfo.requestedPermissions) {
                      if ("android.permission.READ_EXTERNAL_STORAGE".equals(str17)) {
                        grantRuntimePermissions(
                            delayingPackageManagerCache,
                            packageInfo,
                            Collections.singleton("android.permission.READ_EXTERNAL_STORAGE"),
                            false,
                            i);
                      }
                      if ("android.permission.WRITE_EXTERNAL_STORAGE".equals(str17)) {
                        grantRuntimePermissions(
                            delayingPackageManagerCache,
                            packageInfo,
                            Collections.singleton("android.permission.WRITE_EXTERNAL_STORAGE"),
                            false,
                            i);
                      }
                      if ("android.permission.READ_MEDIA_IMAGES".equals(str17)) {
                        grantRuntimePermissions(
                            delayingPackageManagerCache,
                            packageInfo,
                            Collections.singleton("android.permission.READ_MEDIA_IMAGES"),
                            false,
                            i);
                      }
                      if ("android.permission.READ_MEDIA_VIDEO".equals(str17)) {
                        grantRuntimePermissions(
                            delayingPackageManagerCache,
                            packageInfo,
                            Collections.singleton("android.permission.READ_MEDIA_VIDEO"),
                            false,
                            i);
                      }
                    }
                    ...
                    i2 = i;
                    defaultPermissionGrantPolicy.grantRuntimePermissionsForSystemPackage(
                        delayingPackageManagerCache2, i2, packageInfo);
                  }
                }
                defaultPermissionGrantPolicy = this;
                delayingPackageManagerCache2 = delayingPackageManagerCache;
    ...
    for (PackageInfo packageInfo2 : installedPackagesAsUser) {
      if (packageInfo2 != null
          && doesPackageSupportRuntimePermissions(packageInfo2)
          && !ArrayUtils.isEmpty(packageInfo2.requestedPermissions)
          && delayingPackageManagerCache4.isGranted(
              "android.permission.READ_PRIVILEGED_PHONE_STATE", packageInfo2, UserHandle.of(i))
          && delayingPackageManagerCache4.isGranted(
              "android.permission.READ_PHONE_STATE", packageInfo2, UserHandle.of(i))
          && !delayingPackageManagerCache4.isSysComponentOrPersistentPlatformSignedPrivApp(
              packageInfo2)) {
        delayingPackageManagerCache.updatePermissionFlags(
            "android.permission.READ_PHONE_STATE", packageInfo2, 16, 0, UserHandle.of(i));
      }
    }
  }

  public final void grantIgnoringSystemPackage(
      PackageManagerWrapper packageManagerWrapper, String str, int i, Set... setArr) {
    grantPermissionsToPackage(packageManagerWrapper, str, i, true, true, setArr);
  }

  public final void grantSystemFixedPermissionsToSystemPackage(
      PackageManagerWrapper packageManagerWrapper, String str, int i, Set... setArr) {
    grantPermissionsToSystemPackage(packageManagerWrapper, str, i, true, setArr);
  }

  public final void grantPermissionsToSystemPackage(
      PackageManagerWrapper packageManagerWrapper, String str, int i, Set... setArr) {
    grantPermissionsToSystemPackage(packageManagerWrapper, str, i, false, setArr);
  }

  public final void grantPermissionsToSystemPackage(
      PackageManagerWrapper packageManagerWrapper, String str, int i, boolean z, Set... setArr) {
    if (packageManagerWrapper.isSystemPackage(str)) {
      grantPermissionsToPackage(
          packageManagerWrapper,
          packageManagerWrapper.getSystemPackageInfo(str),
          i,
          z,
          false,
          true,
  ...
  public final void grantPermissionsToPackage(
      ...
      Set... setArr) {
    grantPermissionsToPackage(
        packageManagerWrapper, packageManagerWrapper.getPackageInfo(str), i, false, z, z2, setArr);
  }
  ...
  */
  public final void grantDefaultSystemHandlerPermissions(
      PackageManagerWrapper packageManagerWrapper, int i) {
    LegacyPermissionManagerInternal.PackagesProvider packagesProvider;
    ...
    Log.i(
        "DefaultPermGrantPolicy",
        "Granting permissions to default platform handlers for user " + i);
    synchronized (this.mLock) {
    ...
    String[] packages8 =
        syncAdapterPackagesProvider != null
            ? syncAdapterPackagesProvider.getPackages("com.android.contacts", i)
            : null;
    String[] packages9 =
        syncAdapterPackagesProvider != null
            ? syncAdapterPackagesProvider.getPackages("com.android.calendar", i)
            : null;
    ...
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, permissionControllerPackageName, i, set4);
    ...
    grantPermissionsToSystemPackage(
        packageManagerWrapper, str4, i, set6, set7, set8, set9, NEARBY_DEVICES_PERMISSIONS);
    grantSystemFixedPermissionsToSystemPackage(packageManagerWrapper, str4, i, set4);
    grantPermissionsToSystemPackage(
        packageManagerWrapper, getDefaultSearchSelectorPackage(), i, set4);
    grantPermissionsToSystemPackage(
        packageManagerWrapper, getDefaultCaptivePortalLoginPackage(), i, set4);
    grantPermissionsToSystemPackage(packageManagerWrapper, getDefaultDockManagerPackage(), i, set4);
    String defaultSystemHandlerActivityPackage =
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper, "android.media.action.IMAGE_CAPTURE", i);
    Set set10 = MICROPHONE_PERMISSIONS;
    grantPermissionsToSystemPackage(
        packageManagerWrapper, defaultSystemHandlerActivityPackage, i, set9, set10, set5);
    PackageInfo packageInfo8 = packageManagerWrapper.getPackageInfo("com.samsung.android.fast");
    if (packageInfo8 == null
        || !doesPackageSupportRuntimePermissions(packageInfo8)
        || "KOREA".equalsIgnoreCase(SystemProperties.get(ActivationMonitor.COUNTRY_CODE_PROPERTY))
        || (packageManager7 = this.mContext.getPackageManager()) == null
        || packageManager7.checkSignatures("com.samsung.android.fast", "android") != 0) {
      set = set5;
      set2 = set4;
      strArr = packages;
      strArr2 = packages2;
    ...
    grantPermissionsToSystemPackage(
        packageManagerWrapper,
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper, "android.provider.MediaStore.RECORD_SOUND", i),
        i,
        set10);
    Set set11 = set2;
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, getDefaultProviderAuthorityPackage("media", i), i, set, set11);
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, getDefaultProviderAuthorityPackage("downloads", i), i, set, set11);
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper,
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper, "android.intent.action.VIEW_DOWNLOADS", i),
        i,
        set);
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper,
        getDefaultProviderAuthorityPackage("com.android.externalstorage.documents", i),
        i,
        set);
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper,
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper, "android.credentials.INSTALL", i),
        i,
        set);
    if (strArr4 == null) {
      grantDefaultPermissionsToDefaultSystemDialerApp(
          packageManagerWrapper,
          getDefaultSystemHandlerActivityPackage(
              packageManagerWrapper, "android.intent.action.DIAL", i),
          i);
    } else {
    ...
    if (strArr3 == null) {
      grantDefaultPermissionsToDefaultSystemSmsApp(
          packageManagerWrapper,
          getDefaultSystemHandlerActivityPackageForCategory(
              packageManagerWrapper, "android.intent.category.APP_MESSAGING", i),
          i);
    } else {
    ...
    String defaultSystemHandlerActivityPackage2 =
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper, "android.provider.Telephony.SMS_CB_RECEIVED", i);
    Set set12 = SMS_PERMISSIONS;
    Set set13 = NEARBY_DEVICES_PERMISSIONS;
    Set set14 = NOTIFICATION_PERMISSIONS;
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, defaultSystemHandlerActivityPackage2, i, set12, set13, set14);
    grantPermissionsToSystemPackage(
        packageManagerWrapper,
        getDefaultSystemHandlerServicePackage(
            packageManagerWrapper, "android.provider.Telephony.SMS_CARRIER_PROVISION", i),
        i,
        set12);
    String defaultSystemHandlerActivityPackageForCategory =
        getDefaultSystemHandlerActivityPackageForCategory(
            packageManagerWrapper, "android.intent.category.APP_CALENDAR", i);
    Set set15 = CALENDAR_PERMISSIONS;
    Set set16 = CONTACTS_PERMISSIONS;
    grantPermissionsToSystemPackage(
        packageManagerWrapper,
        defaultSystemHandlerActivityPackageForCategory,
        i,
        set15,
        set16,
        set14);
    String defaultProviderAuthorityPackage =
        getDefaultProviderAuthorityPackage("com.android.calendar", i);
    Set set17 = STORAGE_PERMISSIONS;
    grantPermissionsToSystemPackage(
        packageManagerWrapper, defaultProviderAuthorityPackage, i, set16, set17);
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, defaultProviderAuthorityPackage, i, set15);
    if (packages9 != null) {
      grantPermissionToEachSystemPackage(
          packageManagerWrapper,
          getHeadlessSyncAdapterPackages(packageManagerWrapper, packages9, i),
          i,
          set15);
    }
    String defaultSystemHandlerActivityPackageForCategory2 =
        getDefaultSystemHandlerActivityPackageForCategory(
            packageManagerWrapper, "android.intent.category.APP_CONTACTS", i);
    Set set18 = PHONE_PERMISSIONS;
    grantPermissionsToSystemPackage(
        packageManagerWrapper, defaultSystemHandlerActivityPackageForCategory2, i, set16, set18);
    if (strArr5 != null) {
      grantPermissionToEachSystemPackage(
          packageManagerWrapper,
          getHeadlessSyncAdapterPackages(packageManagerWrapper, strArr5, i),
          i,
          set16);
    }
    String defaultProviderAuthorityPackage2 =
        getDefaultProviderAuthorityPackage("com.android.contacts", i);
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, defaultProviderAuthorityPackage2, i, set16, set18);
    grantPermissionsToSystemPackage(
        packageManagerWrapper, defaultProviderAuthorityPackage2, i, set17);
    grantPermissionsToSystemPackage(
        packageManagerWrapper,
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper, "android.app.action.PROVISION_MANAGED_DEVICE", i),
        i,
        set16,
        set14);
    if (this.mContext.getPackageManager().hasSystemFeature("android.hardware.type.automotive", 0)) {
      grantPermissionsToSystemPackage(
          packageManagerWrapper,
          getDefaultSystemHandlerActivityPackageForCategory(
              packageManagerWrapper, "android.intent.category.APP_MAPS", i),
          i,
    ...
    grantPermissionsToSystemPackage(
        packageManagerWrapper,
        getDefaultSystemHandlerActivityPackageForCategory(
            packageManagerWrapper, "android.intent.category.APP_EMAIL", i),
        i,
        set16,
        set15);
    ...
    if (str9 == null) {
      str9 =
          getDefaultSystemHandlerActivityPackageForCategory(
              packageManagerWrapper, "android.intent.category.APP_BROWSER", i);
      if (!packageManagerWrapper.isSystemPackage(str9)) {
        str = null;
        grantPermissionsToPackage(
            packageManagerWrapper, str, i, false, true, FOREGROUND_LOCATION_PERMISSIONS);
        if (strArr != null) {
          for (String str10 : strArr) {
            ...
            revokeRuntimePermissions(
                packageManagerWrapper, str10, FINE_LOCATION_PERMISSIONS, false, i);
          }
        }
        if (ActivityManager.isLowRamDeviceStatic()) {
          grantPermissionsToSystemPackage(
              packageManagerWrapper,
              getDefaultSystemHandlerActivityPackage(
                  packageManagerWrapper, "android.search.action.GLOBAL_SEARCH", i),
              i,
              MICROPHONE_PERMISSIONS,
              ALWAYS_LOCATION_PERMISSIONS,
              NOTIFICATION_PERMISSIONS);
        }
        String defaultSystemHandlerServicePackage =
            getDefaultSystemHandlerServicePackage(
                packageManagerWrapper,
        ...
        grantPermissionsToSystemPackage(
            packageManagerWrapper, defaultSystemHandlerServicePackage, i, set19);
        if ("CHINA".equalsIgnoreCase(SystemProperties.get(ActivationMonitor.COUNTRY_CODE_PROPERTY))
            && (packageInfo7 =
                    packageManagerWrapper.getPackageInfo("com.sec.android.easyMover.Agent"))
                != null
            && doesPackageSupportRuntimePermissions(packageInfo7)) {
          ...
          if (packageManager6 != null
              && packageManager6.checkSignatures("com.sec.android.easyMover.Agent", "android")
                  == 0) {
        ...
        if (strArr9 != null) {
          for (String str12 : strArr9) {
            grantPermissionsToSystemPackage(
                ...
                NEARBY_DEVICES_PERMISSIONS);
            grantSystemFixedPermissionsToSystemPackage(
                packageManagerWrapper, str12, i, ACTIVITY_RECOGNITION_PERMISSIONS);
          }
        }
        String defaultSystemHandlerActivityPackage3 =
            getDefaultSystemHandlerActivityPackage(
                packageManagerWrapper,
                new Intent("android.intent.action.VIEW")
                    .addCategory("android.intent.category.DEFAULT")
                    .setDataAndType(Uri.fromFile(new File("foo.mp3")), "audio/mpeg"),
                i);
        Set set20 = STORAGE_PERMISSIONS;
        grantPermissionsToSystemPackage(
            packageManagerWrapper, defaultSystemHandlerActivityPackage3, i, set20);
        String defaultSystemHandlerActivityPackage4 =
            getDefaultSystemHandlerActivityPackage(
                packageManagerWrapper,
        ...
        grantPermissionsToSystemPackage(
            packageManagerWrapper, defaultSystemHandlerActivityPackage4, i, set21, set22);
        if (this.mContext.getPackageManager().hasSystemFeature("android.hardware.type.watch", 0)) {
          String defaultSystemHandlerActivityPackageForCategory3 =
              getDefaultSystemHandlerActivityPackageForCategory(
                  packageManagerWrapper, "android.intent.category.HOME_MAIN", i);
          grantPermissionsToSystemPackage(
              packageManagerWrapper,
              defaultSystemHandlerActivityPackageForCategory3,
              i,
              CONTACTS_PERMISSIONS,
              MICROPHONE_PERMISSIONS,
              set21);
          ...
          if (this.mContext.getResources().getBoolean(R.bool.config_startDreamImmediatelyOnDock)) {
            Log.d(
                "DefaultPermGrantPolicy",
                "Wear: Skipping permission grant for Default fitness tracker app : "
                    + defaultSystemHandlerActivityPackageForCategory3);
          } else {
            grantPermissionsToSystemPackage(
                packageManagerWrapper,
                getDefaultSystemHandlerActivityPackage(
                    packageManagerWrapper, "com.android.fitness.TRACK", i),
                i,
                SENSORS_PERMISSIONS);
          }
        }
        grantSystemFixedPermissionsToSystemPackage(
            packageManagerWrapper, "com.android.printspooler", i, set21, set22);
        String defaultSystemHandlerActivityPackage5 =
            getDefaultSystemHandlerActivityPackage(
                packageManagerWrapper, "android.telephony.action.EMERGENCY_ASSISTANCE", i);
        Set set23 = CONTACTS_PERMISSIONS;
        Set set24 = PHONE_PERMISSIONS;
        grantSystemFixedPermissionsToSystemPackage(
            packageManagerWrapper, defaultSystemHandlerActivityPackage5, i, set23, set24);
        grantPermissionsToSystemPackage(
            packageManagerWrapper,
            getDefaultSystemHandlerActivityPackage(
                packageManagerWrapper,
        ...
        grantSystemFixedPermissionsToSystemPackage(
            packageManagerWrapper,
            getDefaultSystemHandlerActivityPackage(
                packageManagerWrapper, "android.os.storage.action.MANAGE_STORAGE", i),
            i,
            set20);
        grantSystemFixedPermissionsToSystemPackage(
            packageManagerWrapper,
        ...
        grantSystemFixedPermissionsToSystemPackage(
            packageManagerWrapper,
            getDefaultSystemHandlerActivityPackage(
                packageManagerWrapper, "android.intent.action.RINGTONE_PICKER", i),
            i,
            set20);
        ...
        grantSystemFixedPermissionsToSystemPackage(
            packageManagerWrapper, "com.android.sharedstoragebackup", i, set3);
        grantSystemFixedPermissionsToSystemPackage(
            packageManagerWrapper,
        ...
        if (packageInfo != null
            && doesPackageSupportRuntimePermissions(packageInfo)
            && (packageManager5 = this.mContext.getPackageManager()) != null
            && packageManager5.checkSignatures("com.samsung.android.app.reminder", "android")
                == 0) {
          grantRuntimePermissions(
              packageManagerWrapper, packageInfo, NOTIFICATION_PERMISSIONS, false, i);
        }
        packageInfo2 = packageManagerWrapper.getPackageInfo("com.samsung.android.calendar");
        if (packageInfo2 != null
            && doesPackageSupportRuntimePermissions(packageInfo2)
            && (packageManager4 = this.mContext.getPackageManager()) != null
            && packageManager4.checkSignatures("com.samsung.android.calendar", "android") == 0) {
          ArraySet arraySet3 = new ArraySet();
          if (!"CHINA"
              .equalsIgnoreCase(SystemProperties.get(ActivationMonitor.COUNTRY_CODE_PROPERTY))) {
        ...
        if (packageInfo3 != null && doesPackageSupportRuntimePermissions(packageInfo3)) {
          grantRuntimePermissions(
              packageManagerWrapper, packageInfo3, NOTIFICATION_PERMISSIONS, false, i);
        }
        systemPackageInfo =
            packageManagerWrapper.getSystemPackageInfo("com.samsung.android.dck.timesync");
        if (systemPackageInfo != null && doesPackageSupportRuntimePermissions(systemPackageInfo)) {
          ArraySet arraySet4 = new ArraySet();
          packageManagerWrapper.updatePermissionFlags(
              "android.permission.BLUETOOTH_CONNECT", systemPackageInfo, 16, 16, UserHandle.of(i));
          ((AppOpsManager) this.mContext.getSystemService(AppOpsManager.class))
              .setUidMode(111, 1000, 0);
        ...
        systemPackageInfo2 =
            packageManagerWrapper.getSystemPackageInfo("com.samsung.android.bixby.agent");
        if (systemPackageInfo2 != null
            && doesPackageSupportRuntimePermissions(systemPackageInfo2)) {
          String str14 = SemSystemProperties.get("ro.build.characteristics");
          z2 = (str14 == null && str14.contains("tablet")) ? z : false;
          z3 =
              packageManagerWrapper.getSystemPackageInfo("com.samsung.android.dialer") == null
                  ? z
                  : false;
          ...
          Settings.Global.putString(
              ...
              String.join(KnoxVpnFirewallHelper.DELIMITER, arraySet5));
        }
        packageInfo4 =
            packageManagerWrapper.getPackageInfo("com.sec.android.mimage.photoretouching");
        if (packageInfo4 != null
            && doesPackageSupportRuntimePermissions(packageInfo4)
            && (packageManager3 = this.mContext.getPackageManager()) != null
            && packageManager3.checkSignatures("com.sec.android.mimage.photoretouching", "android")
                == 0) {
        ...
        grantPermissionsToSystemPackage(
            packageManagerWrapper,
            getDefaultSystemHandlerServicePackage(
                packageManagerWrapper, "android.adservices.AD_SERVICES_COMMON_SERVICE", i),
            i,
            NOTIFICATION_PERMISSIONS);
        packageInfo5 = packageManagerWrapper.getPackageInfo("com.samsung.android.video");
        if (packageInfo5 != null
            && doesPackageSupportRuntimePermissions(packageInfo5)
            && (packageManager2 = this.mContext.getPackageManager()) != null
            && packageManager2.checkSignatures("com.samsung.android.video", "android") == 0) {
        ...
        if (packageInfo6 != null
            && doesPackageSupportRuntimePermissions(packageInfo6)
            && (packageManager = this.mContext.getPackageManager()) != null
            && packageManager.checkSignatures("com.samsung.app.newtrim", "android") == 0) {
          grantRuntimePermissions(packageManagerWrapper, packageInfo6, set3, false, i);
        }
        systemPackageInfo3 =
            packageManagerWrapper.getSystemPackageInfo("com.sec.android.app.samsungapps");
        if (systemPackageInfo3 != null
            && doesPackageSupportRuntimePermissions(systemPackageInfo3)) {
          ArraySet arraySet6 = new ArraySet();
          if (!ActivationMonitor.CHINA_COUNTRY_CODE.equalsIgnoreCase(
        ...
        PackageInfo systemPackageInfo4 =
            packageManagerWrapper.getSystemPackageInfo("com.sec.location.nfwlocationprivacy");
        if ("KOREA".equalsIgnoreCase(SystemProperties.get(ActivationMonitor.COUNTRY_CODE_PROPERTY))
            || systemPackageInfo4 == null
            || !doesPackageSupportRuntimePermissions(systemPackageInfo4)) {
          return;
        }
        ArraySet arraySet7 = new ArraySet();
    ...
    if (strArr != null) {}
    if (ActivityManager.isLowRamDeviceStatic()) {}
    String defaultSystemHandlerServicePackage2 =
        getDefaultSystemHandlerServicePackage(
            packageManagerWrapper,
            new Intent("android.speech.RecognitionService")
                .addCategory("android.intent.category.DEFAULT"),
    ...
    grantPermissionsToSystemPackage(
        packageManagerWrapper, defaultSystemHandlerServicePackage2, i, set192);
    if ("CHINA".equalsIgnoreCase(SystemProperties.get(ActivationMonitor.COUNTRY_CODE_PROPERTY))) {
      arraySet = new ArraySet();
      arraySet.add("android.permission.BLUETOOTH_SCAN");
      arraySet.add("android.permission.BLUETOOTH_CONNECT");
    ...
    if (strArr2 != null) {}
    if (strArr9 != null) {}
    String defaultSystemHandlerActivityPackage32 =
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper,
            new Intent("android.intent.action.VIEW")
                .addCategory("android.intent.category.DEFAULT")
    ...
    grantPermissionsToSystemPackage(
        packageManagerWrapper, defaultSystemHandlerActivityPackage32, i, set202);
    String defaultSystemHandlerActivityPackage42 =
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper,
            new Intent("android.intent.action.MAIN")
                .addCategory("android.intent.category.HOME")
    ...
    grantPermissionsToSystemPackage(
        packageManagerWrapper, defaultSystemHandlerActivityPackage42, i, set212, set222);
    if (this.mContext.getPackageManager().hasSystemFeature("android.hardware.type.watch", 0)) {}
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, "com.android.printspooler", i, set212, set222);
    String defaultSystemHandlerActivityPackage52 =
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper, "android.telephony.action.EMERGENCY_ASSISTANCE", i);
    Set set232 = CONTACTS_PERMISSIONS;
    Set set242 = PHONE_PERMISSIONS;
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, defaultSystemHandlerActivityPackage52, i, set232, set242);
    grantPermissionsToSystemPackage(
        packageManagerWrapper,
        getDefaultSystemHandlerActivityPackage(
            packageManagerWrapper,
            new Intent("android.intent.action.VIEW").setType("vnd.android.cursor.item/ndef_msg"),
            i),
        i,
        set232,
        set242);
    ...
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, "com.android.sharedstoragebackup", i, set3);
    grantSystemFixedPermissionsToSystemPackage(
        packageManagerWrapper, "com.android.bluetoothmidiservice", i, NEARBY_DEVICES_PERMISSIONS);
    packageInfo = packageManagerWrapper.getPackageInfo("com.samsung.android.app.reminder");
    if (packageInfo != null) {
      grantRuntimePermissions(
          packageManagerWrapper, packageInfo, NOTIFICATION_PERMISSIONS, false, i);
    ...
    if (systemPackageInfo2 != null) {
      ...
      Settings.Global.putString(
          this.mContext.getContentResolver(),
          "bixby_pregranted_permissions",
          String.join(KnoxVpnFirewallHelper.DELIMITER, arraySet52));
    }
    ...
    PackageInfo systemPackageInfo42 =
        packageManagerWrapper.getSystemPackageInfo("com.sec.location.nfwlocationprivacy");
    if ("KOREA".equalsIgnoreCase(SystemProperties.get(ActivationMonitor.COUNTRY_CODE_PROPERTY))) {}
  }

  public final String getDefaultSystemHandlerActivityPackageForCategory(
      PackageManagerWrapper packageManagerWrapper, String str, int i) {
    return getDefaultSystemHandlerActivityPackage(
        packageManagerWrapper, new Intent("android.intent.action.MAIN").addCategory(str), i);
  }
  ...
  public final void grantPermissionToEachSystemPackage(
      PackageManagerWrapper packageManagerWrapper, ArrayList arrayList, int i, Set... setArr) {
    if (arrayList == null) {
      return;
    }
  ...
  public final void grantDefaultPermissionsToDefaultSystemDialerApp(
      PackageManagerWrapper packageManagerWrapper, String str, int i) {
    if (str == null) {
      return;
    }
    if (this.mContext.getPackageManager().hasSystemFeature("android.hardware.type.watch", 0)) {
      grantSystemFixedPermissionsToSystemPackage(
          packageManagerWrapper, str, i, PHONE_PERMISSIONS, NOTIFICATION_PERMISSIONS);
    } else {
  ...
  public final void grantDefaultPermissionsToDefaultSystemSmsApp(
      PackageManagerWrapper packageManagerWrapper, String str, int i) {
    grantPermissionsToSystemPackage(
        packageManagerWrapper,
        str,
  ...
  public final void grantDefaultPermissionsToDefaultSystemUseOpenWifiApp(
      PackageManagerWrapper packageManagerWrapper, String str, int i) {
  ...
  public void grantDefaultPermissionsToDefaultUseOpenWifiApp(String str, int i) {
    Log.i(
        "DefaultPermGrantPolicy",
        "Granting permissions to default Use Open WiFi app for user:" + i);
  ...
  public final void grantDefaultPermissionsToDefaultSimCallManager(
      PackageManagerWrapper packageManagerWrapper, String str, int i) {
    if (str == null) {
      return;
    }
    ...
    grantPermissionsToPackage(
        packageManagerWrapper, str, i, false, true, PHONE_PERMISSIONS, MICROPHONE_PERMISSIONS);
  }

  public final void grantDefaultPermissionsToDefaultSystemSimCallManager(
      PackageManagerWrapper packageManagerWrapper, String str, int i) {
    if (packageManagerWrapper.isSystemPackage(str)) {
  ...
  public void grantDefaultPermissionsToEnabledTelephonyDataServices(String[] strArr, int i) {
    ...
    for (String str : strArr) {
      grantSystemFixedPermissionsToSystemPackage(
          this.NO_PM_CACHE, str, i, PHONE_PERMISSIONS, ALWAYS_LOCATION_PERMISSIONS);
    }
  }

  public void revokeDefaultPermissionsFromDisabledTelephonyDataServices(String[] strArr, int i) {
    Log.i(
        "DefaultPermGrantPolicy", "Revoking permissions from disabled data services for user:" + i);
    if (strArr == null) {
      return;
    }
    for (String str : strArr) {
      PackageInfo systemPackageInfo = this.NO_PM_CACHE.getSystemPackageInfo(str);
      if (this.NO_PM_CACHE.isSystemPackage(systemPackageInfo)
          && doesPackageSupportRuntimePermissions(systemPackageInfo)) {
  ...
  public void grantDefaultPermissionsToActiveLuiApp(String str, int i) {
    ...
    grantSystemFixedPermissionsToSystemPackage(
        this.NO_PM_CACHE, str, i, CAMERA_PERMISSIONS, NOTIFICATION_PERMISSIONS);
  }
  ...
  public void grantDefaultPermissionsToCarrierServiceApp(String str, int i) {
    Log.i(
        "DefaultPermGrantPolicy",
        "Grant permissions to Carrier Service app " + str + " for user:" + i);
    grantPermissionsToPackage(this.NO_PM_CACHE, str, i, false, true, NOTIFICATION_PERMISSIONS);
  }

  public final String getDefaultSystemHandlerActivityPackage(
      PackageManagerWrapper packageManagerWrapper, String str, int i) {
    return getDefaultSystemHandlerActivityPackage(packageManagerWrapper, new Intent(str), i);
  }

  public final String getDefaultSystemHandlerActivityPackage(
      PackageManagerWrapper packageManagerWrapper, Intent intent, int i) {
    ActivityInfo activityInfo;
    ResolveInfo resolveActivityAsUser =
        this.mContext.getPackageManager().resolveActivityAsUser(intent, 794624, i);
    if (resolveActivityAsUser == null
        || (activityInfo = resolveActivityAsUser.activityInfo) == null
        || this.mServiceInternal.isResolveActivityComponent(activityInfo)) {
      return null;
    }
  ...
  public final String getDefaultSystemHandlerServicePackage(
      PackageManagerWrapper packageManagerWrapper, String str, int i) {
  ...
  public final String getDefaultSystemHandlerServicePackage(
    ...
    List queryIntentServicesAsUser =
        this.mContext.getPackageManager().queryIntentServicesAsUser(intent, 794624, i);
  ...
  public final ArrayList getHeadlessSyncAdapterPackages(
      PackageManagerWrapper packageManagerWrapper, String[] strArr, int i) {
    ArrayList arrayList = new ArrayList();
    Intent addCategory =
        new Intent("android.intent.action.MAIN").addCategory("android.intent.category.LAUNCHER");
    for (String str : strArr) {
      addCategory.setPackage(str);
      if (this.mContext.getPackageManager().resolveActivityAsUser(addCategory, 794624, i) == null
          && packageManagerWrapper.isSystemPackage(str)) {
        arrayList.add(str);
      }
    }
    return arrayList;
  ...
  public final String getDefaultProviderAuthorityPackage(String str, int i) {
    ProviderInfo resolveContentProviderAsUser =
        this.mContext.getPackageManager().resolveContentProviderAsUser(str, 794624, i);
  ...
  public final void revokeRuntimePermissions(
      PackageManagerWrapper packageManagerWrapper, String str, Set set, boolean z, int i) {
    ...
    while (it.hasNext()) {
      ...
      if (arraySet.contains(str2)) {
        ...
        int permissionFlags =
            packageManagerWrapper.getPermissionFlags(
                str2, packageManagerWrapper.getPackageInfo(str), of);
        if ((permissionFlags & 32) != 0
            && (permissionFlags & 4) == 0
            && ((permissionFlags & 16) == 0 || z)) {
  ...
  */
  public final void grantRuntimePermissions(
    ...
    String[] strArr3 =
        packageManagerWrapper.getPackageInfo(packageInfo.packageName).requestedPermissions;
        ...
        (String[])
            ArrayUtils.filterNotNull(
                ...
                new IntFunction() { // from class:
                                    // com.android.server.pm.permission.DefaultPermissionGrantPolicy$$ExternalSyntheticLambda0
                  @Override // java.util.function.IntFunction
                  public final Object apply(int i5) {
                    String[] lambda$grantRuntimePermissions$0;
                    lambda$grantRuntimePermissions$0 =
                        DefaultPermissionGrantPolicy.lambda$grantRuntimePermissions$0(i5);
    ...
    for (int i6 = 0; i6 < size; i6++) {
      ...
      if (applicationInfo2 != null
          && applicationInfo2.targetSdkVersion < splitPermissionInfo.getTargetSdk()
          && set.contains(splitPermissionInfo.getSplitPermission())) {
        arraySet2.addAll(splitPermissionInfo.getNewPermissions());
      }
    }
    if (!z2
        && applicationInfo2 != null
        && applicationInfo2.isUpdatedSystemApp()
        && (systemPackageInfo =
                packageManagerWrapper.getSystemPackageInfo(
                    this.mServiceInternal.getDisabledSystemPackageName(packageInfo.packageName)))
            != null) {
          ...
          if ((arraySet == null || arraySet.contains(str4)) && arraySet2.contains(str4)) {
            ...
            if (isFixedOrUserSet(permissionFlags) && !z2 && !z4) {
              ...
              if (z3 && packageManagerWrapper.isPermissionRestricted(str4)) {
                ...
                str = str4;
                packageManagerWrapper.updatePermissionFlags(
                    str4, packageInfo, IInstalld.FLAG_USE_QUOTA, IInstalld.FLAG_USE_QUOTA, of);
              } else {
                i3 = permissionFlags;
                str = str4;
              }
              ...
              if (!"android.uid.system".equals(packageInfo.sharedUserId)
                  && !"android.uid.systemui".equals(packageInfo.sharedUserId)
                  && str5.equals("android.permission.POST_NOTIFICATIONS")
                  && (applicationInfo = packageInfo.applicationInfo) != null) {
                if (this.mNotiBlockableDataByUid.get(Integer.valueOf(applicationInfo.uid)) == null
                    || !((Boolean)
                            this.mNotiBlockableDataByUid.get(
                  ...
                  if (bundle != null
                    ...
                    this.mNotiBlockableDataByUid.put(
                        Integer.valueOf(packageInfo.applicationInfo.uid), Boolean.TRUE);
                  }
                }
                i2 &= -17;
              }
  ...
  public final void grantDefaultPermissionExceptions(
      PackageManagerWrapper packageManagerWrapper, int i) {
    int i2;
    ...
    for (int i3 = 0; i3 < size; i3++) {
      PackageInfo packageInfo =
          packageManagerWrapper.getPackageInfo((String) this.mGrantExceptions.keyAt(i3));
      ...
      while (i4 < size2) {
        ...
        if (packageManagerWrapper.isPermissionDangerous(defaultPermissionGrant.name)) {
          ...
          grantRuntimePermissions(
              ...
              packageInfo,
              arraySet2,
              defaultPermissionGrant.fixed,
              defaultPermissionGrant.whitelisted,
              true,
              i);
          arraySet = arraySet2;
        } else {
          Log.w(
              "DefaultPermGrantPolicy",
              "Ignoring permission " + defaultPermissionGrant.name + " which isn't dangerous");
          i2 = i4;
        }
        i4 = i2 + 1;
      }
  ...
  public final ArrayMap readDefaultPermissionExceptionsLocked(
      PackageManagerWrapper packageManagerWrapper) {
    ...
    for (File file : defaultPermissionFiles) {
      if (!file.getPath().endsWith(".xml")) {
        Slog.i(
            "DefaultPermGrantPolicy",
            "Non-xml file " + file + " in " + file.getParent() + " directory, ignoring");
  ...
  public final void parse(
      PackageManagerWrapper packageManagerWrapper, TypedXmlPullParser typedXmlPullParser, Map map) {
  ...
  public final void parseExceptions(
      PackageManagerWrapper packageManagerWrapper, TypedXmlPullParser typedXmlPullParser, Map map) {
    int depth = typedXmlPullParser.getDepth();
    while (true) {
      int next = typedXmlPullParser.next();
      ...
      if (next != 3 && next != 4) {
        if ("exception".equals(typedXmlPullParser.getName())) {
          ...
          if (list == null) {
            ...
            } else if (!isSystemOrPlatformSignedOrCertificateMatchingPackage(
                packageInfo, attributeValue2)) {
              Log.w(
                  "DefaultPermGrantPolicy",
                  "Not system or platform signed or certificate-matching package: "
                      + attributeValue);
              XmlUtils.skipCurrentTag(typedXmlPullParser);
            } else if (!doesPackageSupportRuntimePermissions(packageInfo)) {
              Log.w(
                  "DefaultPermGrantPolicy",
                  "Skipping non supporting runtime permissions package:" + attributeValue);
              XmlUtils.skipCurrentTag(typedXmlPullParser);
            } else {
              list = new ArrayList();
          ...
          Log.e(
              "DefaultPermGrantPolicy",
              "Unknown tag " + typedXmlPullParser.getName() + "under <exceptions>");
        }
      }
    }
  }
      ...
      if (next != 3 && next != 4) {
        if ("permission".contains(typedXmlPullParser.getName())) {
          ...
          if (attributeValue == null) {
            ...
            list.add(
                new DefaultPermissionGrant(
                    attributeValue,
                    typedXmlPullParser.getAttributeBoolean((String) null, "fixed", false),
                    typedXmlPullParser.getAttributeBoolean((String) null, "whitelisted", false)));
          }
        } else {
          Log.e(
              "DefaultPermGrantPolicy",
              "Unknown tag " + typedXmlPullParser.getName() + "under <exception>");
        }
      }
    }
  }

  public final boolean isSystemOrPlatformSignedOrCertificateMatchingPackage(
      PackageInfo packageInfo, String str) {
    if (str == null) {
      return packageInfo.applicationInfo.isSystemApp()
          || this.mServiceInternal.isPlatformSigned(packageInfo.packageName);
    }
    return this.mContext
        ...
        .hasSigningCertificate(
            ...
            HexEncoding.decode(
                str.replace(com.android.internal.util.jobs.XmlUtils.STRING_ARRAY_SEPARATOR, "")),
            1);
  }
  ...
  public abstract class PackageManagerWrapper {
    ...
    public abstract int getPermissionFlags(
        String str, PackageInfo packageInfo, UserHandle userHandle);
    ...
    public abstract void updatePermissionFlags(
        String str, PackageInfo packageInfo, int i, int i2, UserHandle userHandle);
    ...
    public boolean isSystemPackage(PackageInfo packageInfo) {
      return (packageInfo == null
              || !packageInfo.applicationInfo.isSystemApp()
              || isSysComponentOrPersistentPlatformSignedPrivApp(packageInfo))
          ? false
          : true;
    }
    ...
    public boolean isSysComponentOrPersistentPlatformSignedPrivApp(PackageInfo packageInfo) {
      ...
      PackageInfo systemPackageInfo =
          getSystemPackageInfo(
              DefaultPermissionGrantPolicy.this.mServiceInternal.getDisabledSystemPackageName(
      ...
      return DefaultPermissionGrantPolicy.this.mServiceInternal.isPlatformSigned(
          packageInfo.packageName);
    }
  }
  ...
  public class DelayingPackageManagerCache extends PackageManagerWrapper {
    ...
    public void apply() {
      ...
      for (int i = 0; i < this.mDelayedPermissionState.size(); i++) {
        for (int i2 = 0; i2 < ((ArrayMap) this.mDelayedPermissionState.valueAt(i)).size(); i2++) {
          try {
            ((PermissionState) ((ArrayMap) this.mDelayedPermissionState.valueAt(i)).valueAt(i2))
                .apply();
          } catch (IllegalArgumentException e) {
            Slog.w(
                "DefaultPermGrantPolicy",
                "Cannot set permission "
                    + ((String) ((ArrayMap) this.mDelayedPermissionState.valueAt(i)).keyAt(i2))
                    + " of uid "
                    + this.mDelayedPermissionState.keyAt(i),
                e);
          }
        }
      }
    ...
    public final Context createContextAsUser(UserHandle userHandle) {
      ...
      Context createContextAsUser =
          DefaultPermissionGrantPolicy.this.mContext.createContextAsUser(userHandle, 0);
    ...
    public final PermissionState getPermissionState(
      ...
      int uid =
          UserHandle.getUid(
              userHandle.getIdentifier(), UserHandle.getAppId(packageInfo.applicationInfo.uid));
      ...
      if (indexOfKey2 >= 0) {
        ...
        if (ArrayUtils.contains(permissionState.mPkgRequestingPerm.requestedPermissions, str)
            || !ArrayUtils.contains(packageInfo.requestedPermissions, str)) {
    ...
    public void updatePermissionFlags(
      ...
      PermissionState permissionState = getPermissionState(str, packageInfo, userHandle);
      permissionState.initFlags();
      permissionState.newFlags =
          Integer.valueOf((permissionState.newFlags.intValue() & (~i)) | (i2 & i));
    }
    ...
    public PermissionInfo getPermissionInfo(String str) {
      ...
      PermissionInfo permissionInfo =
          DefaultPermissionGrantPolicy.this.NO_PM_CACHE.getPermissionInfo(str);
    ...
    public class PermissionState {
      ...
      public void apply() {
        ...
        if (i2 != 0) {
          DefaultPermissionGrantPolicy.this.NO_PM_CACHE.updatePermissionFlags(
              this.mPermission, this.mPkgRequestingPerm, i2, 0, this.mUser);
        }
        int i3 = i & 14336;
        if (i3 != 0) {
          DefaultPermissionGrantPolicy.this.NO_PM_CACHE.updatePermissionFlags(
              this.mPermission, this.mPkgRequestingPerm, i3, -1, this.mUser);
        }
        Boolean bool = this.newGranted;
        if (bool != null && !Objects.equals(bool, this.mOriginalGranted)) {
          if (this.newGranted.booleanValue()) {
            DefaultPermissionGrantPolicy.this.NO_PM_CACHE.grantPermission(
                this.mPermission, this.mPkgRequestingPerm, this.mUser);
          } else {
            DefaultPermissionGrantPolicy.this.NO_PM_CACHE.revokePermission(
                this.mPermission, this.mPkgRequestingPerm, this.mUser);
          }
        }
        int i4 = i & (-14337);
        if (i4 != 0) {
          DefaultPermissionGrantPolicy.this.NO_PM_CACHE.updatePermissionFlags(
              this.mPermission, this.mPkgRequestingPerm, i4, -1, this.mUser);
        }
      }
      ...
      public void initFlags() {
        if (this.newFlags == null) {
          Integer valueOf =
              Integer.valueOf(
                  DefaultPermissionGrantPolicy.this.NO_PM_CACHE.getPermissionFlags(
                      this.mPermission, this.mPkgRequestingPerm, this.mUser));
      ...
      public void initGranted() {
        if (this.newGranted == null) {
          Boolean valueOf =
              Boolean.valueOf(
                  DelayingPackageManagerCache.this
                          .createContextAsUser(this.mUser)
                          .getPackageManager()
                          .checkPermission(this.mPermission, this.mPkgRequestingPerm.packageName)
                      == 0);
