...
public final /* synthetic */ class PackageManagerService$$ExternalSyntheticLambda8
        implements Runnable {
    ...
    public /* synthetic */ PackageManagerService$$ExternalSyntheticLambda8(
    ...
    public final void run() {
        ...
        packageManagerService.mBroadcastHelper.sendPackageBroadcast(
                this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8,
                this.f$9, null, this.f$10);
    }
}
