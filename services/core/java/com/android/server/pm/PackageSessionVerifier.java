...
public final class PackageSessionVerifier {
  ...
  public void verify(
      final PackageInstallerSession packageInstallerSession, final Callback callback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageSessionVerifier$$ExternalSyntheticLambda4
  ...
  public /* synthetic */ void lambda$verify$0(
      PackageInstallerSession packageInstallerSession, Callback callback) {
    try {
      ...
      packageInstallerSession.setSessionFailed(
          e.error, PackageManager.installStatusToString(e.error, e.getMessage()));
  ...
  public final SigningDetails getSigningDetails(PackageInfo packageInfo) {
    ...
    if (verify.isError()) {
      throw new PackageManagerException(
          -22,
          "Failed to verify APEX package " + str + " : " + verify.getException(),
          verify.getException());
    }
  ...
  public final void checkApexSignature(PackageInstallerSession packageInstallerSession) {
    if (packageInstallerSession.isApexSession()) {
      ...
      PackageInfo packageInfo =
          this.mPm
              .snapshotComputer()
              .getPackageInfo(packageInstallerSession.getPackageName(), 1073741824L, 0);
      if (packageInfo == null) {
        throw new PackageManagerException(
            -23, "Attempting to install new APEX package " + packageName);
      }
      ...
      if (signingDetails2.checkCapability(signingDetails, 1)
          || signingDetails.checkCapability(signingDetails2, 8)) {
        return;
      }
      throw new PackageManagerException(
          -22,
          "APK container signature of APEX package "
              + packageName
  ...
  public final void verifyAPK(
      final PackageInstallerSession packageInstallerSession, final Callback callback) {
    VerifyingSession createVerifyingSession =
        createVerifyingSession(
            packageInstallerSession,
            new IPackageInstallObserver2
                .Stub() { // from class: com.android.server.pm.PackageSessionVerifier.1
              ...
              public void onPackageInstalled(String str, int i, String str2, Bundle bundle) {
                if (packageInstallerSession.isStaged() && i == 1) {
                  PackageSessionVerifier.this.verifyStaged(
                      packageInstallerSession.mStagedSession, callback);
                  return;
                }
                if (i != 1) {
                  packageInstallerSession.setSessionFailed(
                      i, PackageManager.installStatusToString(i, str2));
  ...
  public final VerifyingSession createVerifyingSession(
    ...
    return new VerifyingSession(
        ...
        packageInstallerSession.getSigningDetails(),
        packageInstallerSession.sessionId,
        packageInstallerSession.getPackageLite(),
        packageInstallerSession.getUserActionRequired(),
        this.mPm);
  }

  public final void verifyStaged(
      final StagingManager.StagedSession stagedSession, final Callback callback) {
    Slog.d(
        "PackageSessionVerifier",
        "Starting preRebootVerification for session " + stagedSession.sessionId());
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageSessionVerifier$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$verifyStaged$1(
      StagingManager.StagedSession stagedSession, Callback callback) {
    try {
      checkActiveSessions();
  ...
  public final void onVerificationFailure(
      StagingManager.StagedSession stagedSession, Callback callback, int i, String str) {
  ...
  public final void dispatchVerifyApex(
      final StagingManager.StagedSession stagedSession, final Callback callback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageSessionVerifier$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$dispatchVerifyApex$2(
      StagingManager.StagedSession stagedSession, Callback callback) {
    try {
  ...
  public final void dispatchEndVerification(
      final StagingManager.StagedSession stagedSession, final Callback callback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.pm.PackageSessionVerifier$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$dispatchEndVerification$3(
      StagingManager.StagedSession stagedSession, Callback callback) {
    try {
  ...
  public final void verifyApex(StagingManager.StagedSession stagedSession) {
    ...
    if ((stagedSession.sessionParams().installFlags & 262144) != 0) {
      try {
        i =
            ((RollbackManagerInternal) LocalServices.getService(RollbackManagerInternal.class))
                .notifyStagedSession(stagedSession.sessionId());
      } catch (RuntimeException e) {
        Slog.e(
            "PackageSessionVerifier",
            "Failed to notifyStagedSession for session: " + stagedSession.sessionId(),
            e);
      }
  ...
  public final void endVerification(StagingManager.StagedSession stagedSession) {
    try {
      ...
      Slog.d(
          "PackageSessionVerifier", "Marking session " + stagedSession.sessionId() + " as ready");
  ...
  public final void submitSessionToApexService(StagingManager.StagedSession stagedSession, int i) {
    ...
    PowerManager.WakeLock newWakeLock =
        ((PowerManager) this.mContext.getSystemService("power"))
            .newWakeLock(1, "PackageSessionVerifier");
    try {
      newWakeLock.acquire();
        ...
        try {
          ...
          try {
            ParsedPackage parsePackage =
                packageParser2.parsePackage(new File(apexInfo.modulePath), 0, false);
            packageParser2.close();
            Bundle metaData = parsePackage.getMetaData();
            if (metaData != null
                && (string = metaData.getString("com.samsung.android.support.targets")) != null) {
              ...
              if (!z) {
                throw new PackageManagerException(
                    ...
                    "Supported targets("
                        + string
                        + ") are specified but no matched one with "
                        + str);
              }
            }
          ...
          throw new PackageManagerException(
              -22, "Failed to parse APEX package " + apexInfo.modulePath + " : " + e, e);
        }
      }
      Slog.d(
          "PackageSessionVerifier",
          "Session " + stagedSession.sessionId() + " has following APEX packages: " + arrayList);
    } catch (Throwable th3) {
      newWakeLock.release();
      throw th3;
    }
  ...
  public static boolean isApexSessionFinalized(ApexSessionInfo apexSessionInfo) {
    return apexSessionInfo.isUnknown
        || apexSessionInfo.isActivationFailed
        || apexSessionInfo.isSuccess
        || apexSessionInfo.isReverted;
  }

  public final boolean ensureActiveApexSessionIsAborted(
      StagingManager.StagedSession stagedSession) {
    int sessionId;
    ApexSessionInfo stagedSessionInfo;
    if (!stagedSession.containsApexSession()
        || (stagedSessionInfo =
                this.mApexManager.getStagedSessionInfo((sessionId = stagedSession.sessionId())))
            == null
        || isApexSessionFinalized(stagedSessionInfo)) {
      return true;
    }
  ...
  public final boolean isApexUpdateAllowed(String str, String str2) {
    if (this.mPm.getModuleInfo(str, 0) != null) {
      String modulesInstallerPackageName =
  ...
  public final void checkApexUpdateAllowed(PackageInstallerSession packageInstallerSession) {
    if (packageInstallerSession.isApexSession()
        && (packageInstallerSession.params.installFlags & 8388608) == 0) {
      String packageName = packageInstallerSession.getPackageName();
      ...
      throw new PackageManagerException(
          -22, "Update of APEX package " + packageName + " is not allowed for " + str);
    }
  }
  ...
  public void checkRebootlessApex(PackageInstallerSession packageInstallerSession) {
    ...
    if (packageName == null) {
      throw new PackageManagerException(
          -22, "Invalid session " + packageInstallerSession.sessionId + " with package name null");
    }
    for (StagingManager.StagedSession stagedSession : this.mStagedSessions) {
      if (!stagedSession.isDestroyed()
          ...
          && stagedSession.sessionContains(
              new Predicate() { // from class:
                // com.android.server.pm.PackageSessionVerifier$$ExternalSyntheticLambda0
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$checkRebootlessApex$4;
                  lambda$checkRebootlessApex$4 =
                      PackageSessionVerifier.lambda$checkRebootlessApex$4(
                          packageName, (StagingManager.StagedSession) obj);
                  return lambda$checkRebootlessApex$4;
                }
              })) {
        throw new PackageManagerException(
            -22,
            "Staged session " + stagedSession.sessionId() + " already contains " + packageName);
      }
    }
  }

  public static /* synthetic */ boolean lambda$checkRebootlessApex$4(
      String str, StagingManager.StagedSession stagedSession) {
  ...
  public void checkActiveSessions(boolean z) {
    ...
    if (!z && i > 1) {
      throw new PackageManagerException(
          -119, "Cannot stage multiple sessions without checkpoint support");
    }
  }
      ...
      if (!stagedSession2.isDestroyed() && !stagedSession2.isInTerminalState()) {
        if (isRollback(stagedSession) && !isRollback(stagedSession2)) {
          if (!ensureActiveApexSessionIsAborted(stagedSession2)) {
            Slog.e(
                "PackageSessionVerifier",
                "Failed to abort apex session " + stagedSession2.sessionId());
          }
          stagedSession2.setSessionFailed(
              -119, "Session was failed by rollback session: " + stagedSession.sessionId());
          Slog.i(
              "PackageSessionVerifier",
              "Session "
                  + stagedSession2.sessionId()
                  + " is marked failed due to rollback session: "
                  + stagedSession.sessionId());
        } else if (!isRollback(stagedSession) && isRollback(stagedSession2)) {
          throw new PackageManagerException(
              -119, "Session was failed by rollback session: " + stagedSession2.sessionId());
        }
      }
    }
  }
  ...
  public void checkOverlaps(
      StagingManager.StagedSession stagedSession, StagingManager.StagedSession stagedSession2) {
    if (stagedSession.isDestroyed() || stagedSession.isInTerminalState()) {
      return;
    }
    ...
    if (packageName == null) {
      throw new PackageManagerException(
          -22, "Cannot stage session " + stagedSession2.sessionId() + " with package name null");
    }
    for (StagingManager.StagedSession stagedSession3 : this.mStagedSessions) {
      if (!stagedSession3.isDestroyed()
          && !stagedSession3.isInTerminalState()
          && stagedSession3.sessionId() != stagedSession.sessionId()
          && stagedSession3.sessionContains(
              new Predicate() { // from class:
                // com.android.server.pm.PackageSessionVerifier$$ExternalSyntheticLambda2
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                  boolean lambda$checkOverlaps$5;
                  lambda$checkOverlaps$5 =
                      PackageSessionVerifier.lambda$checkOverlaps$5(
                          packageName, (StagingManager.StagedSession) obj);
        ...
        if (stagedSession3.getCommittedMillis() < stagedSession.getCommittedMillis()) {
          throw new PackageManagerException(
              ...
              "Package: "
                  ...
                  + stagedSession3.sessionId());
        }
        stagedSession3.setSessionFailed(
            -119,
            "Package: "
                + packageName
                + " in session: "
  ...
  public static /* synthetic */ boolean lambda$checkOverlaps$5(
      String str, StagingManager.StagedSession stagedSession) {
    return str.equals(stagedSession.getPackageName());
  }
}
