...
public final class AppsFilterImpl extends AppsFilterLocked implements Watchable, Snappable {
    ...
    public static AppsFilterImpl create(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerInternal packageManagerInternal) {
        String[] strArr;
        boolean z = packageManagerServiceInjector.getContext().getResources().getBoolean(R.bool.config_enableStylusPointerIcon);
        FeatureConfigImpl featureConfigImpl = new FeatureConfigImpl(packageManagerInternal, packageManagerServiceInjector);
        if (z) {
            strArr = new String[0];
        } else {
            String[] stringArray = packageManagerServiceInjector.getContext().getResources().getStringArray(R.array.non_removable_euicc_slots);
        ...
        if (this.mCacheReady) {
            ...
            if (sharedUser != null) {
                ...
                while (true) {
                    ...
                    PackageStateInternal packageStateInternal2 = (PackageStateInternal) packageStates3.valueAt(size7);
