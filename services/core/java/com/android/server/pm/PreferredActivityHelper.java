...
public final class PreferredActivityHelper {
    ...
    public PreferredActivityHelper(
            PackageManagerService packageManagerService, BroadcastHelper broadcastHelper) {
        this.mPm = packageManagerService;
        this.mBroadcastHelper = broadcastHelper;
    }

    public static boolean isHomeFilter(WatchedIntentFilter watchedIntentFilter) {
        return watchedIntentFilter.mFilter.hasAction("android.intent.action.MAIN")
                && watchedIntentFilter.mFilter.hasCategory("android.intent.category.HOME")
                && watchedIntentFilter.mFilter.hasCategory("android.intent.category.DEFAULT");
    }
    ...
    public static void restoreFromXml(
            ...
            int i,
            String str,
            PreferredActivityHelper$$ExternalSyntheticLambda1
                    preferredActivityHelper$$ExternalSyntheticLambda1) {
        int next;
        do {
            ...
            switch (preferredActivityHelper$$ExternalSyntheticLambda1.$r8$classId) {
                case 0:
                    PreferredActivityHelper preferredActivityHelper =
                            preferredActivityHelper$$ExternalSyntheticLambda1.f$0;
                    ...
                    if (readDefaultApps != null) {
                        PackageSetting packageStateInternal =
                                preferredActivityHelper
                                        .mPm
                                        .snapshotComputer()
                                        .getPackageStateInternal(readDefaultApps);
                        if (packageStateInternal != null
                                && packageStateInternal.getUserStateOrDefault(i).isInstalled()) {
                            preferredActivityHelper.mPm.mDefaultAppProvider.setDefaultBrowser(
                                    i, readDefaultApps);
                            return;
                        }
                        PackageManagerTracedLock packageManagerTracedLock =
                                preferredActivityHelper.mPm.mLock;
                        boolean z = PackageManagerService.DEBUG_COMPRESSION;
                        synchronized (packageManagerTracedLock) {
                            try {
                                preferredActivityHelper.mPm.mSettings.mPendingDefaultBrowser.put(
                                        i, readDefaultApps);
                            } finally {
                            }
                        }
                ...
                default:
                    ...
                    PackageManagerTracedLock packageManagerTracedLock2 =
                            preferredActivityHelper2.mPm.mLock;
                    boolean z2 = PackageManagerService.DEBUG_COMPRESSION;
                    synchronized (packageManagerTracedLock2) {
                        try {
                            preferredActivityHelper2.mPm.mSettings.readPreferredActivitiesLPw(
                                    i, typedXmlPullParser);
                        } finally {
                        }
                    }
                    preferredActivityHelper2.updateDefaultHomeNotLocked(
                            preferredActivityHelper2.mPm.snapshotComputer(), i);
                    return;
            }
        }
    }
        ...
        if (this.mPm.mContext.checkCallingOrSelfPermission(
            ...
            if (computer.getUidTargetSdkVersion(callingUid) < 8) {
                DeviceIdleController$$ExternalSyntheticOutline0.m(
                        callingUid, "Ignoring addPreferredActivity() from uid ", "PackageManager");
                return;
            }
            ...
            try {
                ...
                PreferredActivityLog.logPreferenceChange(
                        new PreferredActivity(
                                watchedIntentFilter, i, componentNameArr, componentName, z),
                        str);
    ...
    public final ResolveInfo findPreferredActivityNotLocked(
            Intent intent, String str, long j, List list, boolean z, boolean z2, int i) {
    ...
    public final ResolveInfo findPreferredActivityNotLocked(
        ...
        boolean z5 =
                Settings.Global.getInt(
                                this.mPm.mContext.getContentResolver(), "device_provisioned", 0)
                        == 1;
        PackageManagerTracedLock packageManagerTracedLock = this.mPm.mLock;
            ...
            try {
                findPreferredActivityInternal2 =
                        this.mPm
                                .snapshotComputer()
                                .findPreferredActivityInternal2(
                                        intent, str, j, list, z, z2, z3, i, z4, z5);
            } catch (Throwable th) {
    ...
    */
    public final void replacePreferredActivity(
            com.android.server.pm.Computer r18,
            com.android.server.pm.WatchedIntentFilter r19,
            int r20,
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.pm.PreferredActivityHelper.replacePreferredActivity(com.android.server.pm.Computer,"
                    + " com.android.server.pm.WatchedIntentFilter, int,"
                    + " android.content.ComponentName[], android.content.ComponentName, int):void");
    }
    ...
    public final void resetNetworkPolicies(int i) {
        NetworkPolicyManagerService.NetworkPolicyManagerInternalImpl
                networkPolicyManagerInternalImpl =
                        (NetworkPolicyManagerService.NetworkPolicyManagerInternalImpl)
                                this.mPm.mInjector.mGetLocalServiceProducer.produce(
                                        NetworkPolicyManagerService.NetworkPolicyManagerInternalImpl
                                                .class);
    ...
    public final void updateDefaultHomeNotLocked(
            Computer computer, SparseBooleanArray sparseBooleanArray) {
        if (Thread.holdsLock(this.mPm.mLock)) {
            Slog.wtf(
                    "PackageManager",
                    "Calling thread " + Thread.currentThread().getName() + " is holding mLock",
    ...
    public final boolean updateDefaultHomeNotLocked(Computer computer, final int i) {
        ...
        String str =
                (findPreferredActivityNotLocked == null
                                || (activityInfo = findPreferredActivityNotLocked.activityInfo)
                                        == null)
                        ? null
        ...
        if ((packagesForUid != null
                        && ArrayUtils.contains(
                                packagesForUid, this.mPm.mRequiredPermissionControllerPackage))
                || str == null) {
            return false;
        }
        ...
        Consumer consumer =
                new Consumer() { // from class:
                    ...
                    public final void accept(Object obj) {
                        PreferredActivityHelper preferredActivityHelper =
                                PreferredActivityHelper.this;
                        int i2 = i;
                        preferredActivityHelper.getClass();
                        if (((Boolean) obj).booleanValue()) {
                            preferredActivityHelper.mBroadcastHelper
                                    .sendPreferredActivityChangedBroadcast(i2);
                        }
                    }
                };
        Executor mainExecutor = packageManagerService.mContext.getMainExecutor();
        RoleManager roleManager =
                (RoleManager) packageManagerService.mDefaultAppProvider.mRoleManagerSupplier.get();
        if (roleManager == null) {
            return false;
        }
        ...
        try {
            roleManager.addRoleHolderAsUser(
                    "android.app.role.HOME", str, 0, UserHandle.of(i), mainExecutor, consumer);
