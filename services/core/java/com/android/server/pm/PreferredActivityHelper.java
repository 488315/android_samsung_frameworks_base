...
public final class PreferredActivityHelper {
    ...
    */
    public void replacePreferredActivity(Computer computer, WatchedIntentFilter watchedIntentFilter, int i, ComponentName[] componentNameArr, ComponentName componentName, int i2) {
        ...
        if (DesktopModeUtils.isHomeFilter(watchedIntentFilter) && DesktopModeUtils.isReplacingPreferredBlockedByDesktopMode(watchedIntentFilter, componentName, DesktopModeFeature.isDesktopMode(this.mPm.mContext), "com.sec.android.app.desktoplauncher")) {
            return;
        }
        int callingUid = Binder.getCallingUid();
